...
{
    internal partial class DeploymentsOperationsGetDeploymentsAsyncCollectionResultOfT : AsyncCollectionResult<AssetDeployment>
    {
        ...
        /// <summary> Initializes a new instance of DeploymentsOperationsGetDeploymentsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DeploymentsOperationsGetDeploymentsAsyncCollectionResultOfT(DeploymentsOperations client, string modelPublisher, string modelName, string deploymentType, string clientRequestId, RequestOptions options)
        {
            _client = client;
