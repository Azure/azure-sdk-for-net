...
namespace Azure.AI.Projects
{
    ...
    public abstract partial class DatasetVersion
    {
        ...
        private protected DatasetVersion(string dataUri, DatasetType @type)
        {
            DataUri = dataUri;
            Type = @type;
        ...
        internal DatasetVersion(string dataUri, DatasetType @type, bool? isReference, string connectionName, string id, string name, string version, string description, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DataUri = dataUri;
            Type = @type;
