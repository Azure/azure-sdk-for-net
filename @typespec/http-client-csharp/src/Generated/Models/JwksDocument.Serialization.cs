...
namespace Microsoft.CodeTransparency
{
    ...
    public partial class JwksDocument : IJsonModel<JwksDocument>
    {
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            {
                case "J":
                    return ModelReaderWriter.Write(this, options, MicrosoftCodeTransparencyContext.Default);
                default:
        ...
        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="JwksDocument"/> from. </param>
        public static explicit operator JwksDocument(ClientResult result)
        {
