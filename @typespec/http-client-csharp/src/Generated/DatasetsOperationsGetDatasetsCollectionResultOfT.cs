...
{
    internal partial class DatasetsOperationsGetDatasetsCollectionResultOfT : CollectionResult<DatasetVersion>
    {
        private readonly DatasetsOperations _client;
        private readonly RequestOptions _options;

        /// <summary> Initializes a new instance of DatasetsOperationsGetDatasetsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The DatasetsOperations client used to send requests. </param>
        /// <param name="options"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public DatasetsOperationsGetDatasetsCollectionResultOfT(DatasetsOperations client, RequestOptions options)
        {
            _client = client;
            _options = options;
        }
