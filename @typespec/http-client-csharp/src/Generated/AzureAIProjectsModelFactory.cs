...
namespace Azure.AI.Projects
{
    ...
    public static partial class AzureAIProjectsModelFactory
    {
        ...
        public static DatasetVersion DatasetVersion(string dataUri = default, string @type = default, bool? isReference = default, string connectionName = default, string id = default, string name = default, string version = default, string description = default, IDictionary<string, string> tags = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        public static FileDatasetVersion FileDatasetVersion(string dataUri = default, bool? isReference = default, string connectionName = default, string id = default, string name = default, string version = default, string description = default, IDictionary<string, string> tags = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        public static FolderDatasetVersion FolderDatasetVersion(string dataUri = default, bool? isReference = default, string connectionName = default, string id = default, string name = default, string version = default, string description = default, IDictionary<string, string> tags = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        public static BlobReference BlobReference(string blobUri = default, string storageAccountArmId = default, BlobReferenceSasCredential credential = default)
        {
        ...
        public static BlobReferenceSasCredential BlobReferenceSasCredential(string sasUri = default, string @type = default)
        {
