//-----------------------------------------------------------------------
// <copyright file="WalkUpgradeDomainInfo.cs" company="Microsoft">
...
// </copyright>
// <summary>
//    Contains code for the WalkUpgradeDomainInfo class.
// </summary>
//-----------------------------------------------------------------------
...
namespace Microsoft.WindowsAzure.ManagementClient.v1_7
{
    ...
    internal class WalkUpgradeDomainInfo : AzureDataContractBase
    {
        ...
        internal static WalkUpgradeDomainInfo Create(int upgradeDomain)
        {
        ...
        [DataMember]
        internal int UpgradeDomain { get; private set; }
    }
}
