...
namespace Microsoft.WindowsAzure {
    ...
    internal class SR {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cannot create Shared Access Signature unless Account Key credentials are used..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to The copy operation has been aborted by the user..
        /// </summary>
        internal static string CopyAborted {
            get {
                return ResourceManager.GetString("CopyAborted", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The copy operation failed with the following error message: {0}.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to No copy with the given ID was found. Either the copy was never started or the copy status was deleted or overwritten by a subsequent copy..
        /// </summary>
        internal static string CopyUnknownId {
            get {
                return ResourceManager.GetString("CopyUnknownId", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Listing snapshots is only supported in flat mode (no delimiter). Consider setting the useFlatBlobListing parameter to true..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Too many &apos;{0}&apos; shared access policy identifiers provided. Server does not support setting more than &apos;{1}&apos; on a single container, queue, or table..
        /// </summary>
