//-----------------------------------------------------------------------
// <copyright file="CloudBlockBlobBase.cs" company="Microsoft">
...
namespace Microsoft.WindowsAzure.Storage.Blob
{
    ...
    public sealed partial class CloudBlockBlob : ICloudBlob
    {
        ...
        public int StreamWriteSizeInBytes
        {
            ...
            set
            {
                CommonUtils.AssertInBounds("StreamWriteSizeInBytes", value, 16 * Constants.KB, Constants.MaxBlockSize);
        ...
        public BlobType BlobType
        {
            get
            {
                return Blob.BlobType.BlockBlob;
            }
        }
