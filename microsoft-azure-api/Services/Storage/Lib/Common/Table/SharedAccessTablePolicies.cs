...
namespace Microsoft.WindowsAzure.Storage.Table
{
    ...
    public sealed class SharedAccessTablePolicies : IDictionary<string, SharedAccessTablePolicy>
    {
        ...
        /// <returns>The <see cref="SharedAccessTablePolicy"/> item associated with the specified key, or <code>null</code> if key is not in the shared access policies collection.</returns>
