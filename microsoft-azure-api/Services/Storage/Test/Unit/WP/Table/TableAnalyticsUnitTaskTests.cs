// -----------------------------------------------------------------------------------------
// <copyright file="TableAnalyticsUnitTaskTests.cs" company="Microsoft">
...
{
    [TestClass]
    public class TableAnalyticsUnitTaskTests : TestBase
    {
        #region Locals + Ctors
        public TableAnalyticsUnitTaskTests()
        {
        }
        ...
        public async Task CloudTableTestAnalyticsRoundTripAsync()
        {
            CloudTableClient client = GenerateCloudTableClient();
        ...
        [TestCategory(SmokeTestCategory.NonSmoke)]
        [TestCategory(TenantTypeCategory.DevFabric), TestCategory(TenantTypeCategory.Cloud)]
        public async Task CloudTableTestAnalyticsDisableAsync()
        {
            CloudTableClient client = GenerateCloudTableClient();
        ...
        [TestCategory(SmokeTestCategory.NonSmoke)]
        [TestCategory(TenantTypeCategory.DevFabric), TestCategory(TenantTypeCategory.Cloud)]
        public async Task CloudTableTestAnalyticsDefaultServiceVersionThrowsAsync()
        {
            CloudTableClient client = GenerateCloudTableClient();
        ...
        [TestCategory(SmokeTestCategory.NonSmoke)]
        [TestCategory(TenantTypeCategory.DevFabric), TestCategory(TenantTypeCategory.Cloud)]
        public async Task CloudTableTestAnalyticsLoggingOperationsAsync()
        {
            CloudTableClient client = GenerateCloudTableClient();
        ...
        [TestCategory(SmokeTestCategory.NonSmoke)]
        [TestCategory(TenantTypeCategory.DevFabric), TestCategory(TenantTypeCategory.Cloud)]
        public async Task CloudTableTestAnalyticsMetricsLevelAsync()
        {
            CloudTableClient client = GenerateCloudTableClient();
        ...
        [TestCategory(SmokeTestCategory.NonSmoke)]
        [TestCategory(TenantTypeCategory.DevFabric), TestCategory(TenantTypeCategory.Cloud)]
        public async Task CloudTableTestAnalyticsRetentionPoliciesAsync()
        {
            CloudTableClient client = GenerateCloudTableClient();
