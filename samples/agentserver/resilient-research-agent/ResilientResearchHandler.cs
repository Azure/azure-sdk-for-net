...
public class ResilientResearchHandler : InvocationHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var registry = request.HttpContext.RequestServices.GetRequiredService<AgentEventStreamRegistry>();
        ...
        int completedPhases)
    {
        ...
        // cancelled, and AgentEventStream.EmitAsync throws OperationCanceledException on a cancelled
    ...
    private static async Task FinishTurnAsync(
        AgentEventStream stream, TaskContext<ResearchRequest> ctx, string invId, CheckpointStore store)
    {
