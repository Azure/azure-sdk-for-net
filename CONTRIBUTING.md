...
- Install [NodeJS](https://nodejs.org/en/) (13.x.x), and run `npm install` in the root directory if you plan to use [C# code generation](https://github.com/Azure/autorest.csharp).
