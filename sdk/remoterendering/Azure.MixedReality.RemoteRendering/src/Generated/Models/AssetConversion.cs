...
namespace Azure.MixedReality.RemoteRendering
{
    ...
    public partial class AssetConversion
    {
        ...
        internal AssetConversion(string conversionId, AssetConversionOptions options, AssetConversionOutput output, RemoteRenderingServiceError error, AssetConversionStatus status, DateTimeOffset createdOn, Dictionary<string, BinaryData> rawData)
        {
            ConversionId = conversionId;
            Options = options;
            Output = output;
