...
namespace Azure.MixedReality.RemoteRendering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetConversion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssetConversion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssetConversion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssetConversion>)} interface");
            }
        ...
        string IPersistableModel<AssetConversion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
