...
namespace Azure.MixedReality.RemoteRendering
{
    public partial class RenderingSession
    {
        internal static RenderingSession DeserializeRenderingSession(JsonElement element)
        {
            ...
            return new RenderingSession(id, Optional.ToNullable(arrInspectorPort), Optional.ToNullable(handshakePort), Optional.ToNullable(elapsedTimeMinutes), hostname.Value, maxLeaseTimeMinutes, size, status, Optional.ToNullable(teraflops), error.Value, creationTime);
        }
    }
}
