...
namespace Azure.MixedReality.RemoteRendering
{
    ...
    public partial class RemoteRenderingServiceError
    {
        ...
        internal RemoteRenderingServiceError(string code, string message, IReadOnlyList<RemoteRenderingServiceError> details, string target, RemoteRenderingServiceError innerError, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Details = details;
