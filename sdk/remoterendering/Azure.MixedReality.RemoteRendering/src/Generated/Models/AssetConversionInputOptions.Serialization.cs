...
namespace Azure.MixedReality.RemoteRendering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetConversionInputOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssetConversionInputOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssetConversionInputOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssetConversionInputOptions>)} interface");
            }
        ...
        string IPersistableModel<AssetConversionInputOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
