...
namespace Azure.MixedReality.RemoteRendering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateSessionOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateSessionOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateSessionOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateSessionOptions>)} interface");
            }
        ...
        string IPersistableModel<UpdateSessionOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
