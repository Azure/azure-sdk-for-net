...
namespace Azure.MixedReality.RemoteRendering
{
    ...
    public partial class AssetConversionOutputOptions
    {
        ...
        internal AssetConversionOutputOptions(Uri storageContainerUri, string storageContainerWriteSas, string blobPrefix, string outputAssetFilename, Dictionary<string, BinaryData> rawData)
        {
            StorageContainerUri = storageContainerUri;
