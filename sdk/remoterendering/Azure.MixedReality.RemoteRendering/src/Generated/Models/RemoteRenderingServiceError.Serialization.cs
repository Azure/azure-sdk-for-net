...
namespace Azure.MixedReality.RemoteRendering
{
    ...
    {
        internal static RemoteRenderingServiceError DeserializeRemoteRenderingServiceError(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
