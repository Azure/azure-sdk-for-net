...
namespace Azure.ResourceManager.ArizeAIObservabilityEval.Models
{
    ...
    public partial class ArizeAIObservabilityEvalOfferDetails : IJsonModel<ArizeAIObservabilityEvalOfferDetails>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ArizeAIObservabilityEvalOfferDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ArizeAIObservabilityEvalOfferDetails IJsonModel<ArizeAIObservabilityEvalOfferDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ArizeAIObservabilityEvalOfferDetails JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ArizeAIObservabilityEvalOfferDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ArizeAIObservabilityEvalOfferDetails DeserializeArizeAIObservabilityEvalOfferDetails(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ArizeAIObservabilityEvalOfferDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ArizeAIObservabilityEvalOfferDetails IPersistableModel<ArizeAIObservabilityEvalOfferDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ArizeAIObservabilityEvalOfferDetails PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ArizeAIObservabilityEvalOfferDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
