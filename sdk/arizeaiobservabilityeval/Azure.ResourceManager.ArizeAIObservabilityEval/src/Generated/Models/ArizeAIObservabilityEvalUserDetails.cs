...
namespace Azure.ResourceManager.ArizeAIObservabilityEval.Models
{
    ...
    public partial class ArizeAIObservabilityEvalUserDetails
    {
        ...
        internal ArizeAIObservabilityEvalUserDetails(string firstName, string lastName, string emailAddress, string upn, string phoneNumber, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            FirstName = firstName;
            LastName = lastName;
