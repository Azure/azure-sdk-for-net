...
namespace Azure.ResourceManager.ArizeAIObservabilityEval.Models
{
    ...
    public partial class ArizeAIObservabilityEvalOfferPartnerProperties : IJsonModel<ArizeAIObservabilityEvalOfferPartnerProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ArizeAIObservabilityEvalOfferPartnerProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ArizeAIObservabilityEvalOfferPartnerProperties IJsonModel<ArizeAIObservabilityEvalOfferPartnerProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ArizeAIObservabilityEvalOfferPartnerProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ArizeAIObservabilityEvalOfferPartnerProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ArizeAIObservabilityEvalOfferPartnerProperties DeserializeArizeAIObservabilityEvalOfferPartnerProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ArizeAIObservabilityEvalOfferPartnerProperties(description, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ArizeAIObservabilityEvalOfferPartnerProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ArizeAIObservabilityEvalOfferPartnerProperties IPersistableModel<ArizeAIObservabilityEvalOfferPartnerProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ArizeAIObservabilityEvalOfferPartnerProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ArizeAIObservabilityEvalOfferPartnerProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
