...
namespace Azure.ResourceManager.ArizeAIObservabilityEval.Models
{
    ...
    public partial class ArizeAIObservabilityEvalMarketplaceDetails
    {
        ...
        internal ArizeAIObservabilityEvalMarketplaceDetails(string subscriptionId, ArizeAIObservabilityEvalMarketplaceSubscriptionStatus? subscriptionStatus, ArizeAIObservabilityEvalOfferDetails offerDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
