...
namespace Azure.ResourceManager.ArizeAIObservabilityEval.Models
{
    ...
    internal partial class OrganizationResourceListResult
    {
        ...
        internal OrganizationResourceListResult(IReadOnlyList<ArizeAIObservabilityEvalOrganizationData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<ArizeAIObservabilityEvalOrganizationData> Value { get; }
