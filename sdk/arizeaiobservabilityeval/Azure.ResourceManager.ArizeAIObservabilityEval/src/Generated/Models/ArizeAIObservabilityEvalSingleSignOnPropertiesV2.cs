...
namespace Azure.ResourceManager.ArizeAIObservabilityEval.Models
{
    ...
    public partial class ArizeAIObservabilityEvalSingleSignOnPropertiesV2
    {
        ...
        internal ArizeAIObservabilityEvalSingleSignOnPropertiesV2(ArizeAIObservabilityEvalSingleSignOnType @type, ArizeAIObservabilityEvalSingleSignOnState? state, string enterpriseAppId, string uri, IList<string> aadDomains, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            State = state;
