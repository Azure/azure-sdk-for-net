...
{
    internal partial class OrganizationsGetBySubscriptionCollectionResultOfT : Pageable<ArizeAIObservabilityEvalOrganizationData>
    {
        ...
        public override IEnumerable<Page<ArizeAIObservabilityEvalOrganizationData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableArizeAIObservabilityEvalSubscriptionResource.GetArizeAIObservabilityEvalOrganizations");
            scope.Start();
            try
            {
