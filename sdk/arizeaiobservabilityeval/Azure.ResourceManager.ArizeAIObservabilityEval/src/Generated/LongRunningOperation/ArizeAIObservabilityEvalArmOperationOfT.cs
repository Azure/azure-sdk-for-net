...
namespace Azure.ResourceManager.ArizeAIObservabilityEval
{
    internal partial class ArizeAIObservabilityEvalArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ArizeAIObservabilityEvalArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
