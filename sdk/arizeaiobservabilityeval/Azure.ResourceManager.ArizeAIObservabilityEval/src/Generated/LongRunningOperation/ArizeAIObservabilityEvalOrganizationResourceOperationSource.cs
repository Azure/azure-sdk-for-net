...
{
    /// <summary></summary>
    internal partial class ArizeAIObservabilityEvalOrganizationResourceOperationSource : IOperationSource<ArizeAIObservabilityEvalOrganizationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ArizeAIObservabilityEvalOrganizationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
