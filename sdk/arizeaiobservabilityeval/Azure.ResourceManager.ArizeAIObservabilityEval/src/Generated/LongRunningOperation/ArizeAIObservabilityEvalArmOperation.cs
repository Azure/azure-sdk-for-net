...
#pragma warning disable SA1649 // File name should match first type name
    internal class ArizeAIObservabilityEvalArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ArizeAIObservabilityEvalArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ArizeAIObservabilityEvalArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ArizeAIObservabilityEvalArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
