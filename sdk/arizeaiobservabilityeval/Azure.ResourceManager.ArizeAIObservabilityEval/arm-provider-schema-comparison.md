# ARM provider schema comparison: Azure.ResourceManager.ArizeAIObservabilityEval
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/ArizeAi.ObservabilityEval/organizations/{organizationname}` | `ArizeAIObservabilityEvalOrganization` | `OrganizationResource` |
