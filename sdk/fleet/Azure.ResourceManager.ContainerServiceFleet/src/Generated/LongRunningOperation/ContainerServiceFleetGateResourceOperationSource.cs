...
{
    /// <summary></summary>
    internal partial class ContainerServiceFleetGateResourceOperationSource : IOperationSource<ContainerServiceFleetGateResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerServiceFleetGateResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
