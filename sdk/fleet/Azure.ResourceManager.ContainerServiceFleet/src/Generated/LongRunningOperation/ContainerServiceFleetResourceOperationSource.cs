...
{
    /// <summary></summary>
    internal partial class ContainerServiceFleetResourceOperationSource : IOperationSource<ContainerServiceFleetResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerServiceFleetResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
