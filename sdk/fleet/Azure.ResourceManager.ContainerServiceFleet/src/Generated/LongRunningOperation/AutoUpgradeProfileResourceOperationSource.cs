...
{
    /// <summary></summary>
    internal partial class AutoUpgradeProfileResourceOperationSource : IOperationSource<AutoUpgradeProfileResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AutoUpgradeProfileResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
