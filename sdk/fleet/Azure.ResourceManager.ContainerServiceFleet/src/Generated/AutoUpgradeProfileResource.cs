...
namespace Azure.ResourceManager.ContainerServiceFleet
{
    ...
    public partial class AutoUpgradeProfileResource : ArmResource
    {
        ...
        internal AutoUpgradeProfileResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _autoUpgradeProfileOperationsRestClient = new AutoUpgradeProfileOperations(_autoUpgradeProfileOperationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, autoUpgradeProfileApiVersion ?? "2026-06-01");
