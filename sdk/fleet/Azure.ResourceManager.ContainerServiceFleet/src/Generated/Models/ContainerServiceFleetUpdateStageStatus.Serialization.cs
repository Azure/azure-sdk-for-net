...
{
    public partial class ContainerServiceFleetUpdateStageStatus : IUtf8JsonSerializable, IJsonModel<ContainerServiceFleetUpdateStageStatus>, IPersistableModel<ContainerServiceFleetUpdateStageStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AfterStageWaitStatus))
            {
                ...
                AppendChildObject(builder, AfterStageWaitStatus, options, 2);
            }
