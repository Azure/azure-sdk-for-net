...
namespace Azure.ResourceManager.ContainerServiceFleet.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServiceFleetUpdateRunListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerServiceFleetUpdateRunListResult)} does not support writing '{format}' format.");
            }
            ...
            {
                ((IJsonModel<ContainerServiceFleetUpdateRunData>)item).Write(writer, options);
            }
        ...
        ContainerServiceFleetUpdateRunListResult IJsonModel<ContainerServiceFleetUpdateRunListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerServiceFleetUpdateRunListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static ContainerServiceFleetUpdateRunListResult DeserializeContainerServiceFleetUpdateRunListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContainerServiceFleetUpdateRunListResult(value, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ContainerServiceFleetUpdateRunListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerServiceFleetUpdateRunListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ContainerServiceFleetUpdateRunListResult IPersistableModel<ContainerServiceFleetUpdateRunListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContainerServiceFleetUpdateRunListResult)} does not support reading '{options.Format}' format.");
            }
        }
