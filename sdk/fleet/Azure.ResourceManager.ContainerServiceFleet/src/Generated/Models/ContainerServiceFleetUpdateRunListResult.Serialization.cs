...
{
    internal partial class ContainerServiceFleetUpdateRunListResult : IUtf8JsonSerializable, IJsonModel<ContainerServiceFleetUpdateRunListResult>, IPersistableModel<ContainerServiceFleetUpdateRunListResult>
    {
        ...
        void IJsonModel<ContainerServiceFleetUpdateRunListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerServiceFleetUpdateRunListResult)} does not support '{format}' format.");
            }
