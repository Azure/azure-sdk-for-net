...
namespace Azure.ResourceManager.ContainerServiceFleet
{
    public partial class ContainerServiceFleetMemberData : IUtf8JsonSerializable
    {
        ...
        internal static ContainerServiceFleetMemberData DeserializeContainerServiceFleetMemberData(JsonElement element)
        {
            ...
            return new ContainerServiceFleetMemberData(id, name, type, systemData.Value, Optional.ToNullable(eTag), clusterResourceId.Value, group.Value, Optional.ToNullable(provisioningState));
        }
    }
}
