...
namespace Azure.ResourceManager.ContainerServiceFleet.Models
{
    ...
    internal partial class FleetListResult
    {
        ...
        internal FleetListResult(IEnumerable<ContainerServiceFleetData> value)
        {
            Value = value.ToList();
        }
        ...
        internal FleetListResult(IList<ContainerServiceFleetData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ContainerServiceFleetData> Value { get; }
