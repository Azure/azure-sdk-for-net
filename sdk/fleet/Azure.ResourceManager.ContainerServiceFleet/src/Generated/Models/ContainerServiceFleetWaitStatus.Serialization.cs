...
{
    public partial class ContainerServiceFleetWaitStatus : IUtf8JsonSerializable, IJsonModel<ContainerServiceFleetWaitStatus>, IPersistableModel<ContainerServiceFleetWaitStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  waitDurationInSeconds:");
                builder.AppendLine($" '{WaitDurationInSeconds.Value.ToString()}'");
            }
