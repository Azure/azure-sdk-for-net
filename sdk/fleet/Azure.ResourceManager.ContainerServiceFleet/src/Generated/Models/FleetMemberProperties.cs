...
namespace Azure.ResourceManager.ContainerServiceFleet.Models
{
    ...
    internal partial class FleetMemberProperties
    {
        ...
        internal FleetMemberProperties(ResourceIdentifier clusterResourceId, string @group, FleetMemberProvisioningState? provisioningState, IDictionary<string, string> labels, ContainerServiceFleetMemberStatus status, MeshProperties meshProperties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ClusterResourceId = clusterResourceId;
            Group = @group;
        ...
        public MeshProperties MeshProperties { get; }
    }
}
