...
{
    public partial class FleetCredentialResults : IUtf8JsonSerializable, IJsonModel<FleetCredentialResults>, IPersistableModel<FleetCredentialResults>
    {
        ...
        void IJsonModel<FleetCredentialResults>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FleetCredentialResults)} does not support '{format}' format.");
            }
