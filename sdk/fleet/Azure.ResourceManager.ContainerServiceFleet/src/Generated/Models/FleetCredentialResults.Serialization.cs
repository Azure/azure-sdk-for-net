...
namespace Azure.ResourceManager.ContainerServiceFleet.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FleetCredentialResults>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FleetCredentialResults>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FleetCredentialResults>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FleetCredentialResults>)} interface");
            }
        ...
        string IPersistableModel<FleetCredentialResults>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
