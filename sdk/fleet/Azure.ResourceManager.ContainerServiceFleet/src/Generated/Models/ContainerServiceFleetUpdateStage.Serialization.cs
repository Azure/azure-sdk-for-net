...
{
    public partial class ContainerServiceFleetUpdateStage : IUtf8JsonSerializable, IJsonModel<ContainerServiceFleetUpdateStage>, IPersistableModel<ContainerServiceFleetUpdateStage>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AfterStageWaitInSeconds))
            {
                ...
                builder.AppendLine($" '{AfterStageWaitInSeconds.Value.ToString()}'");
            }
