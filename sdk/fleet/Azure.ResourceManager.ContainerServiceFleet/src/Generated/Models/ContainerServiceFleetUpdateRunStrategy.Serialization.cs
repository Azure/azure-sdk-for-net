...
namespace Azure.ResourceManager.ContainerServiceFleet.Models
{
    internal partial class ContainerServiceFleetUpdateRunStrategy : IUtf8JsonSerializable, IJsonModel<ContainerServiceFleetUpdateRunStrategy>
    {
        ...
        void IJsonModel<ContainerServiceFleetUpdateRunStrategy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ContainerServiceFleetUpdateRunStrategy)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ContainerServiceFleetUpdateRunStrategy>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ContainerServiceFleetUpdateRunStrategy)} does not support '{options.Format}' format.");
            }
        }
