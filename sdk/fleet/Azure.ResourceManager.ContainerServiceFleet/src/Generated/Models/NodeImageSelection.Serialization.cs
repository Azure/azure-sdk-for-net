...
namespace Azure.ResourceManager.ContainerServiceFleet.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NodeImageSelection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NodeImageSelection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NodeImageSelection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NodeImageSelection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
