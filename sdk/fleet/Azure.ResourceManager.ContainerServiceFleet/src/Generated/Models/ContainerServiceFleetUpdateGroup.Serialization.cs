...
namespace Azure.ResourceManager.ContainerServiceFleet.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServiceFleetUpdateGroup>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerServiceFleetUpdateGroup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerServiceFleetUpdateGroup>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerServiceFleetUpdateGroup>)} interface");
            }
        ...
        string IPersistableModel<ContainerServiceFleetUpdateGroup>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
