...
namespace Azure.ResourceManager.ContainerServiceFleet.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerServiceFleetManagedClusterUpgradeSpec>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ContainerServiceFleetManagedClusterUpgradeSpec IJsonModel<ContainerServiceFleetManagedClusterUpgradeSpec>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ContainerServiceFleetManagedClusterUpgradeSpec>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ContainerServiceFleetManagedClusterUpgradeSpec IModel<ContainerServiceFleetManagedClusterUpgradeSpec>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ContainerServiceFleetManagedClusterUpgradeSpec>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
