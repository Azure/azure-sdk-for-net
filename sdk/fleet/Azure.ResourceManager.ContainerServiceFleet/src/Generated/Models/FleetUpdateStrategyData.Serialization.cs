...
namespace Azure.ResourceManager.ContainerServiceFleet
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FleetUpdateStrategyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FleetUpdateStrategyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FleetUpdateStrategyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FleetUpdateStrategyData>)} interface");
            }
        ...
        string IPersistableModel<FleetUpdateStrategyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
