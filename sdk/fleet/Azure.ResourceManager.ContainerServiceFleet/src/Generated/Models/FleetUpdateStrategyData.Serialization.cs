...
{
    public partial class FleetUpdateStrategyData : IUtf8JsonSerializable, IJsonModel<FleetUpdateStrategyData>, IPersistableModel<FleetUpdateStrategyData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Strategy))
            {
                ...
                AppendChildObject(builder, Strategy, options, 2);
            }
