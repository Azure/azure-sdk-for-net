...
namespace Azure.ResourceManager.ContainerServiceFleet.Mocking
{
    ...
    public partial class ContainerServiceFleetResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ContainerServiceFleetResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ContainerServiceFleetResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerServiceFleetResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerServiceFleetResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
