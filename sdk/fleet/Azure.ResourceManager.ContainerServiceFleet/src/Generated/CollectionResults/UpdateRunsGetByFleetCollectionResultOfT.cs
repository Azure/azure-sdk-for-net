...
{
    internal partial class UpdateRunsGetByFleetCollectionResultOfT : Pageable<ContainerServiceFleetUpdateRunData>
    {
        ...
        public override IEnumerable<Page<ContainerServiceFleetUpdateRunData>> AsPages(string continuationToken, int? pageSizeHint)
        {
