...
namespace Azure.ResourceManager.ContainerServiceFleet
{
    internal partial class UpdateRunsGetByFleetAsyncCollectionResultOfT : AsyncPageable<ContainerServiceFleetUpdateRunData>
    {
        ...
        public UpdateRunsGetByFleetAsyncCollectionResultOfT(UpdateRuns client, Guid subscriptionId, string resourceGroupName, string fleetName, int? maxCount, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
