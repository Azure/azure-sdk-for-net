...
{
    internal partial class UpdateRunsGetByFleetAsyncCollectionResultOfT : AsyncPageable<ContainerServiceFleetUpdateRunData>
    {
        ...
        public UpdateRunsGetByFleetAsyncCollectionResultOfT(UpdateRuns client, Guid subscriptionId, string resourceGroupName, string fleetName, int? maxCount, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<ContainerServiceFleetUpdateRunData>> AsPages(string continuationToken, int? pageSizeHint)
        {
