...
namespace Azure.ResourceManager.ContainerServiceFleet.Models
{
    ...
    public static partial class ArmContainerServiceFleetModelFactory
    {
        ...
        {
            return new AutoUpgradeProfileData(id, name, resourceType, systemData, additionalBinaryDataProperties: null, new AutoUpgradeProfileProperties(provisioningState, updateStrategyId, channel, nodeImageSelection: default, disabled, autoUpgradeProfileStatus, targetKubernetesVersion: default, isLongTermSupport: default, additionalBinaryDataProperties: default), eTag);
        }
    }
}
