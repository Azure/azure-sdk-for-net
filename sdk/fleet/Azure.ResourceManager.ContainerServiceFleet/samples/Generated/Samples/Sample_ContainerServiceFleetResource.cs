...
namespace Azure.ResourceManager.ContainerServiceFleet.Samples
{
    public partial class Sample_ContainerServiceFleetResource
    {
        ...
        public async Task Delete_DeletesAFleetResourceAsynchronouslyWithALongRunningOperation()
        {
            ...
            // invoke the operation
            await containerServiceFleet.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["tier"] = "secure"
            ...
            ArmOperation<ContainerServiceFleetResource> lro = await containerServiceFleet.UpdateAsync(WaitUntil.Completed, patch, ifMatch);
