...
{
    public partial class FleetApiServerAccessProfile : IUtf8JsonSerializable
    {
        ...
        internal static FleetApiServerAccessProfile DeserializeFleetApiServerAccessProfile(JsonElement element)
        {
            ...
            return new FleetApiServerAccessProfile(Optional.ToNullable(enablePrivateCluster), Optional.ToNullable(enableVnetIntegration), subnetId.Value);
        }
    }
}
