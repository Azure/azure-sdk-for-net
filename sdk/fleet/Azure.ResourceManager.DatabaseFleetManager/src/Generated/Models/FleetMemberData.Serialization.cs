...
{
    public partial class FleetMemberData : IUtf8JsonSerializable
    {
        ...
        internal static FleetMemberData DeserializeFleetMemberData(JsonElement element)
        {
            ...
            return new FleetMemberData(id, name, type, systemData.Value, Optional.ToNullable(eTag), clusterResourceId.Value, group.Value, Optional.ToNullable(provisioningState));
        }
    }
}
