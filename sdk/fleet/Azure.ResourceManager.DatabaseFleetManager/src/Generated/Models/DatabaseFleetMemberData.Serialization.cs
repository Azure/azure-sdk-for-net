...
{
    public partial class DatabaseFleetMemberData : IUtf8JsonSerializable
    {
        ...
        internal static DatabaseFleetMemberData DeserializeDatabaseFleetMemberData(JsonElement element)
        {
            ...
            return new DatabaseFleetMemberData(id, name, type, systemData.Value, Optional.ToNullable(eTag), clusterResourceId.Value, group.Value, Optional.ToNullable(provisioningState));
        }
    }
}
