...
{
    /// <summary>
    /// A class representing the FleetMember data model.
    /// A member of the Fleet. It contains a reference to an existing Kubernetes cluster on Azure.
    /// </summary>
    public partial class FleetMemberData : ResourceData
    {
        ...
        internal FleetMemberData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? eTag, ResourceIdentifier clusterResourceId, string group, FleetMemberProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
            ETag = eTag;
