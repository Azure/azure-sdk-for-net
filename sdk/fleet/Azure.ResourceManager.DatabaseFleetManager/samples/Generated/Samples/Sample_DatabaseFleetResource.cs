...
{
    public partial class Sample_DatabaseFleetResource
    {
        ...
        public async Task GetDatabaseFleets_ListsTheFleetResourcesInASubscription()
        {
            ...
            await foreach (DatabaseFleetResource item in subscriptionResource.GetDatabaseFleetsAsync())
            {
...
["tier"] = "secure",
            ...
            ArmOperation<DatabaseFleetResource> lro = await databaseFleet.UpdateAsync(WaitUntil.Completed, patch, ifMatch: ifMatch);
        ...
        public async Task Delete_DeletesAFleetResourceAsynchronouslyWithALongRunningOperation()
        {
            ...
            // invoke the operation
            await databaseFleet.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task GetCredentials_ListsTheUserCredentialsOfAFleet()
        {
            ...
            // invoke the operation
            FleetCredentialResults result = await databaseFleet.GetCredentialsAsync();
