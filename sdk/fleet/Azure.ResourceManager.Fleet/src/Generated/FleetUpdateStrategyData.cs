...
namespace Azure.ResourceManager.Fleet
{
    ...
    public partial class FleetUpdateStrategyData : ResourceData
    {
        ...
        internal FleetUpdateStrategyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? eTag, FleetUpdateStrategyProvisioningState? provisioningState, UpdateRunStrategy strategy) : base(id, name, resourceType, systemData)
        {
            ETag = eTag;
