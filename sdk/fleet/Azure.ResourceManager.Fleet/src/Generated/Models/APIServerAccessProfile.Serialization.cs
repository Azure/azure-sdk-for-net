...
{
    public partial class APIServerAccessProfile : IUtf8JsonSerializable
    {
        ...
        internal static APIServerAccessProfile DeserializeAPIServerAccessProfile(JsonElement element)
        {
            ...
            return new APIServerAccessProfile(Optional.ToNullable(enablePrivateCluster), Optional.ToNullable(enableVnetIntegration), subnetId.Value);
        }
    }
}
