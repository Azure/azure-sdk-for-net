...
namespace Azure.ResourceManager.Fleet
{
    public partial class FleetData : IUtf8JsonSerializable
    {
        ...
        internal static FleetData DeserializeFleetData(JsonElement element)
        {
            ...
            return new FleetData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(eTag), identity, Optional.ToNullable(provisioningState), hubProfile.Value);
        }
    }
}
