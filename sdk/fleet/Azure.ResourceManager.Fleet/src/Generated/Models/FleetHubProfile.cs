...
namespace Azure.ResourceManager.Fleet.Models
{
    ...
    public partial class FleetHubProfile
    {
        ...
        internal FleetHubProfile(string dnsPrefix, APIServerAccessProfile apiServerAccessProfile, AgentProfile agentProfile, string fqdn, string kubernetesVersion, string portalFqdn)
        {
            DnsPrefix = dnsPrefix;
