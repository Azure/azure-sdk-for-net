...
namespace Azure.ResourceManager.Fleet.Models
{
    ...
    public static partial class ArmFleetModelFactory
    {
        ...
        /// <param name="provisioningState"> The status of the last operation. </param>
        /// <returns> A new <see cref="Fleet.FleetMemberData"/> instance for mocking. </returns>
        ...
        /// <returns> A new <see cref="Fleet.UpdateRunData"/> instance for mocking. </returns>
        public static UpdateRunData UpdateRunData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ETag? eTag = null, UpdateRunProvisioningState? provisioningState = null, ResourceIdentifier updateStrategyId = null, IEnumerable<UpdateStage> strategyStages = null, ManagedClusterUpdate managedClusterUpdate = null, UpdateRunStatus status = null)
        {
            ...
            return new UpdateRunData(id, name, resourceType, systemData, eTag, provisioningState, updateStrategyId, strategyStages != null ? new UpdateRunStrategy(strategyStages?.ToList()) : null, managedClusterUpdate, status);
        }
        ...
        /// <returns> A new <see cref="Fleet.FleetUpdateStrategyData"/> instance for mocking. </returns>
        public static FleetUpdateStrategyData FleetUpdateStrategyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ETag? eTag = null, FleetUpdateStrategyProvisioningState? provisioningState = null, IEnumerable<UpdateStage> strategyStages = null)
        {
            ...
            return new FleetUpdateStrategyData(id, name, resourceType, systemData, eTag, provisioningState, strategyStages != null ? new UpdateRunStrategy(strategyStages?.ToList()) : null);
        }
    }
}
