...
namespace Azure.ResourceManager.Fleet
{
    ...
    public partial class FleetResource : ArmResource
    {
        ...
        {
            _fleetClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Fleet", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of FleetUpdateStrategyResources in the Fleet. </summary>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new FleetArmOperation(_fleetClientDiagnostics, Pipeline, _fleetRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ifMatch).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<FleetResource>> UpdateAsync(WaitUntil waitUntil, FleetPatch patch, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new FleetArmOperation<FleetResource>(new FleetOperationSource(Client), _fleetClientDiagnostics, Pipeline, _fleetRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, ifMatch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
