...
namespace Azure.ResourceManager.EdgeUpdates
{
    ...
    public partial class UpdateCollection : ArmCollection, IEnumerable<UpdateResource>, IAsyncEnumerable<UpdateResource>
    {
        ...
        {
            _updateClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EdgeUpdates", UpdateResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<UpdateResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string updateName, UpdateData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new EdgeUpdatesArmOperation<UpdateResource>(new UpdateOperationSource(Client), _updateClientDiagnostics, Pipeline, _updateRestClient.CreateCreateOrModifyRequest(Id, updateName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual AsyncPageable<UpdateResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new UpdateResource(Client, UpdateData.DeserializeUpdateData(e)), _updateClientDiagnostics, Pipeline, "UpdateCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<UpdateResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _updateRestClient.CreateListRequest(Id);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _updateRestClient.CreateListNextPageRequest(nextLink, Id);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new UpdateResource(Client, UpdateData.DeserializeUpdateData(e)), _updateClientDiagnostics, Pipeline, "UpdateCollection.GetAll", "value", "nextLink", cancellationToken);
        }
