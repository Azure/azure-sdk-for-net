...
#pragma warning disable SA1649 // File name should match first type name
    internal class EdgeUpdatesArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of EdgeUpdatesArmOperation for mocking. </summary>
        protected EdgeUpdatesArmOperation()
        {
        }

        internal EdgeUpdatesArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal EdgeUpdatesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "EdgeUpdatesArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
