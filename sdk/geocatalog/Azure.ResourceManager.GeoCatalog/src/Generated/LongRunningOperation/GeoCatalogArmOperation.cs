...
#pragma warning disable SA1649 // File name should match first type name
    internal class GeoCatalogArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal GeoCatalogArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal GeoCatalogArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "GeoCatalogArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
