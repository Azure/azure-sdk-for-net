...
namespace Azure.ResourceManager.GeoCatalog.Mocking
{
    ...
    public partial class MockableGeoCatalogResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableGeoCatalogResourceGroupResource"/> class for mocking. </summary>
        protected MockableGeoCatalogResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableGeoCatalogResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableGeoCatalogResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
