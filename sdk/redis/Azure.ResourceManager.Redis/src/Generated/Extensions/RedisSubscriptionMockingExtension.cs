...
namespace Azure.ResourceManager.Redis.Mocking
{
    ...
    public partial class RedisSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RedisSubscriptionMockingExtension"/> class for mocking. </summary>
        protected RedisSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RedisSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RedisSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response> CheckRedisNameAvailabilityAsync(RedisNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = RedisClientDiagnostics.CreateScope("RedisSubscriptionMockingExtension.CheckRedisNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<RedisResource> GetAllRedisAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new RedisResource(Client, RedisData.DeserializeRedisData(e)), RedisClientDiagnostics, Pipeline, "RedisSubscriptionMockingExtension.GetAllRedis", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<RedisResource> GetAllRedis(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => RedisRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => RedisRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new RedisResource(Client, RedisData.DeserializeRedisData(e)), RedisClientDiagnostics, Pipeline, "RedisSubscriptionMockingExtension.GetAllRedis", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<RedisOperationStatus>> GetAsyncOperationStatusAsync(AzureLocation location, string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = AsyncOperationStatusClientDiagnostics.CreateScope("RedisSubscriptionMockingExtension.GetAsyncOperationStatus");
            scope.Start();
            try
            {
