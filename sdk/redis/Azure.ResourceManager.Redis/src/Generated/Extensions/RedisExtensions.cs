...
namespace Azure.ResourceManager.Redis
{
    ...
    {
        private static RedisResourceExtension GetRedisResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new RedisResourceExtension(client, resource.Id);
            });
        }

        private static RedisResourceExtension GetRedisResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new RedisResourceExtension(client, scope);
            });
        }

        private static RedisResourceGroupResourceExtension GetRedisResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new RedisResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static RedisResourceGroupResourceExtension GetRedisResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new RedisResourceGroupResourceExtension(client, scope);
            });
        }

        private static RedisSubscriptionResourceExtension GetRedisSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new RedisSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static RedisSubscriptionResourceExtension GetRedisSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new RedisSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetRedisResourceGroupResourceExtension(resourceGroupResource).GetAllRedis();
        }
        ...
        public static async Task<Response> CheckRedisNameAvailabilityAsync(this SubscriptionResource subscriptionResource, RedisNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetRedisResourceExtension(subscriptionResource).CheckRedisNameAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response CheckRedisNameAvailability(this SubscriptionResource subscriptionResource, RedisNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetRedisResourceExtension(subscriptionResource).CheckRedisNameAvailability(content, cancellationToken);
        }
        ...
        {
            return GetRedisResourceExtension(subscriptionResource).GetAllRedisAsync(cancellationToken);
        }
        ...
        {
            return GetRedisResourceExtension(subscriptionResource).GetAllRedis(cancellationToken);
        }
        ...
        public static async Task<Response<RedisOperationStatus>> GetAsyncOperationStatusAsync(this SubscriptionResource subscriptionResource, AzureLocation location, string operationId, CancellationToken cancellationToken = default)
        {
            ...
            return await GetRedisSubscriptionResourceExtension(subscriptionResource).GetAsyncOperationStatusAsync(location, operationId, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<RedisOperationStatus> GetAsyncOperationStatus(this SubscriptionResource subscriptionResource, AzureLocation location, string operationId, CancellationToken cancellationToken = default)
        {
            ...
            return GetRedisSubscriptionResourceExtension(subscriptionResource).GetAsyncOperationStatus(location, operationId, cancellationToken);
        }
    }
}
