...
namespace Azure.ResourceManager.Redis.Testing
{
    ...
    public partial class RedisSubscriptionResourceExtension : ArmResource
    {
        ...
        public virtual async Task<Response> CheckRedisNameAvailabilityAsync(RedisNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = RedisClientDiagnostics.CreateScope("RedisSubscriptionResourceExtension.CheckRedisNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<RedisResource> GetAllRedisAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new RedisResource(Client, RedisData.DeserializeRedisData(e)), RedisClientDiagnostics, Pipeline, "RedisSubscriptionResourceExtension.GetAllRedis", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<RedisResource> GetAllRedis(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => RedisRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => RedisRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new RedisResource(Client, RedisData.DeserializeRedisData(e)), RedisClientDiagnostics, Pipeline, "RedisSubscriptionResourceExtension.GetAllRedis", "value", "nextLink", cancellationToken);
        }
