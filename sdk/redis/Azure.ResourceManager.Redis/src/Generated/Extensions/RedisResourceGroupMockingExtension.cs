...
namespace Azure.ResourceManager.Redis.Mocking
{
    ...
    internal partial class RedisResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="RedisResourceGroupMockingExtension"/> class for mocking. </summary>
        protected RedisResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RedisResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RedisResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
