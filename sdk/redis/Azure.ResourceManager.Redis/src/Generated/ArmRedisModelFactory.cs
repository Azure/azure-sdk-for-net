...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public static partial class ArmRedisModelFactory
    {
        ...
        public static RedisUpgradeNotification RedisUpgradeNotification(string name = null, DateTimeOffset? timestamp = null, IReadOnlyDictionary<string, string> upsellNotification = null)
        {
            ...
            return new RedisUpgradeNotification(name, timestamp, upsellNotification, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RedisAccessKeys(primaryKey, secondaryKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RedisInstanceDetails(sslPort, nonSslPort, zone, shardId, isMaster, isPrimary, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RedisPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, redisPrivateLinkServiceConnectionState, redisProvisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RedisForceRebootResult(message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ExportRdbContent(format, prefix, container, preferredDataArchiveAuthMethod, storageSubscriptionId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RedisFirewallRuleData(id, name, resourceType, systemData, startIP, endIP, new Dictionary<string, BinaryData>());
        }
        ...
        public static RedisPatchScheduleData RedisPatchScheduleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation? location = null, IEnumerable<RedisPatchScheduleSetting> scheduleEntries = null)
        {
            ...
            return new RedisPatchScheduleData(id, name, resourceType, systemData, location, scheduleEntries?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RedisLinkedServerWithPropertyCreateOrUpdateContent(linkedRedisCacheId, linkedRedisCacheLocation, serverRole, geoReplicatedPrimaryHostName, primaryHostName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RedisLinkedServerWithPropertyData(id, name, resourceType, systemData, linkedRedisCacheId, linkedRedisCacheLocation, serverRole, geoReplicatedPrimaryHostName, primaryHostName, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static RedisPrivateLinkResource RedisPrivateLinkResource(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new RedisPrivateLinkResource(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static RedisOperationStatus RedisOperationStatus(ResourceIdentifier id = null, string name = null, string status = null, float? percentComplete = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, IEnumerable<OperationStatusResult> operations = null, ResponseError error = null, IReadOnlyDictionary<string, BinaryData> properties = null)
        {
            ...
            return new RedisOperationStatus(id, name, status, percentComplete, startOn, endOn, operations?.ToList(), error, new Dictionary<string, BinaryData>(), properties);
        }
    }
}
