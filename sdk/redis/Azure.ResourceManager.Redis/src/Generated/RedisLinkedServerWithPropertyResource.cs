...
namespace Azure.ResourceManager.Redis
{
    ...
    public partial class RedisLinkedServerWithPropertyResource : ArmResource
    {
        ...
        internal RedisLinkedServerWithPropertyResource(ArmClient client, RedisLinkedServerWithPropertyData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<RedisLinkedServerWithPropertyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RedisLinkedServerWithPropertyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
