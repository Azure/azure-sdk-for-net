...
namespace Azure.ResourceManager.Redis
{
    ...
    public partial class RedisData : TrackedResourceData
    {
        ...
        /// <param name="redisVersion"> Redis version. This should be in the form &apos;major[.minor[.build]]&apos; (only &apos;major&apos; is required) or the value &apos;latest&apos; which refers to the latest stable Redis version that is available. Only the major and minor version are used in a PUT/PATCH request. Supported versions: 4.0, 6.0. </param>
