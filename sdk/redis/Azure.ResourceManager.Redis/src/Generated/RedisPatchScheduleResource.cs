...
namespace Azure.ResourceManager.Redis
{
    ...
    public partial class RedisPatchScheduleResource : ArmResource
    {
        ...
        internal RedisPatchScheduleResource(ArmClient client, RedisPatchScheduleData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<RedisPatchScheduleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RedisPatchScheduleResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<RedisPatchScheduleResource>> UpdateAsync(WaitUntil waitUntil, RedisPatchScheduleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new RedisArmOperation<RedisPatchScheduleResource>(Response.FromValue(new RedisPatchScheduleResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
