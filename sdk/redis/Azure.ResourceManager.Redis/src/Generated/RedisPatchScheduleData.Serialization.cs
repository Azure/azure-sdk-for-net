    ...
    public partial class RedisPatchScheduleData : IUtf8JsonSerializable, IJsonModel<RedisPatchScheduleData>
    {
        ...
        internal static RedisPatchScheduleData DeserializeRedisPatchScheduleData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.Redis.ModelSerializationExtensions.WireOptions, AzureResourceManagerRedisContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerRedisContext.Default)
#endif
;
                    continue;
                }
