...
namespace Azure.ResourceManager.Redis
{
    ...
    public partial class RedisFirewallRuleData : ResourceData
    {
        ...
        internal RedisFirewallRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IPAddress startIP, IPAddress endIP, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            StartIP = startIP;
            EndIP = endIP;
