...
namespace Azure.ResourceManager.Redis
{
    ...
    public partial class RedisPatchScheduleData : ResourceData
    {
        ...
        internal RedisPatchScheduleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, IList<RedisPatchScheduleSetting> scheduleEntries, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Location = location;
