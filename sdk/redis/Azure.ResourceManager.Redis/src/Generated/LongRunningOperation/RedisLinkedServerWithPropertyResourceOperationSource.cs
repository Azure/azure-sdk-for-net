...
{
    /// <summary></summary>
    internal partial class RedisLinkedServerWithPropertyResourceOperationSource : IOperationSource<RedisLinkedServerWithPropertyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal RedisLinkedServerWithPropertyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
