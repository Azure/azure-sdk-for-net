...
{
    /// <summary></summary>
    internal partial class RedisCacheAccessPolicyAssignmentResourceOperationSource : IOperationSource<RedisCacheAccessPolicyAssignmentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal RedisCacheAccessPolicyAssignmentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
