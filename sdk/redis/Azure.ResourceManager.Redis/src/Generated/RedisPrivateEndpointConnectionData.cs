...
namespace Azure.ResourceManager.Redis
{
    ...
    public partial class RedisPrivateEndpointConnectionData : ResourceData
    {
        ...
        internal RedisPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SubResource privateEndpoint, RedisPrivateLinkServiceConnectionState redisPrivateLinkServiceConnectionState, RedisPrivateEndpointConnectionProvisioningState? redisProvisioningState, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
