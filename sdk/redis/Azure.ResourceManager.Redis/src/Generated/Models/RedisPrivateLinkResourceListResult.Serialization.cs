...
{
    internal partial class RedisPrivateLinkResourceListResult : IUtf8JsonSerializable, IJsonModel<RedisPrivateLinkResourceListResult>, IPersistableModel<RedisPrivateLinkResourceListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisPrivateLinkResourceListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RedisPrivateLinkResourceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RedisPrivateLinkResourceListResult)} does not support '{format}' format.");
            }
