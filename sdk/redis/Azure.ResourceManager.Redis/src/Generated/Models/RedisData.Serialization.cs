...
{
    public partial class RedisData : IUtf8JsonSerializable, IJsonModel<RedisData>, IPersistableModel<RedisData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RedisConfiguration))
            {
                ...
                AppendChildObject(builder, RedisConfiguration, options, 2);
            }
            ...
            if (Optional.IsDefined(ReplicasPerMaster))
            {
                ...
                builder.AppendLine($" '{ReplicasPerMaster.Value.ToString()}'");
            }

            if (Optional.IsDefined(ReplicasPerPrimary))
            {
                builder.Append("  replicasPerPrimary:");
                builder.AppendLine($" '{ReplicasPerPrimary.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ShardCount))
            {
                ...
                builder.AppendLine($" '{ShardCount.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(UpdateChannel))
            {
                ...
                builder.AppendLine($" '{UpdateChannel.ToString()}'");
            }
            ...
            if (Optional.IsDefined(AccessKeys))
            {
                ...
                AppendChildObject(builder, AccessKeys, options, 2);
            }
