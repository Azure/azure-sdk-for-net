...
{
    public partial class RedisData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RedisData DeserializeRedisData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
