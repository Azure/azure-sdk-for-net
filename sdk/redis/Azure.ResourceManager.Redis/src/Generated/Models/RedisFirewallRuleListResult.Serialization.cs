...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    {
        internal static RedisFirewallRuleListResult DeserializeRedisFirewallRuleListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
