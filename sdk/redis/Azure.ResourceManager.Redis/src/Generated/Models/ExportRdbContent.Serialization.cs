...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExportRdbContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExportRdbContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExportRdbContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExportRdbContent>)} interface");
            }
        ...
        string IPersistableModel<ExportRdbContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
