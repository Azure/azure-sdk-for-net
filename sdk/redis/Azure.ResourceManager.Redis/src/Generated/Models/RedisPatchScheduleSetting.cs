...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class RedisPatchScheduleSetting
    {
        ...
        internal RedisPatchScheduleSetting(RedisDayOfWeek dayOfWeek, int startHourUtc, TimeSpan? maintenanceWindow, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DayOfWeek = dayOfWeek;
            StartHourUtc = startHourUtc;
