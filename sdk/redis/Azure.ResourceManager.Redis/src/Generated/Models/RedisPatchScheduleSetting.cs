...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class RedisPatchScheduleSetting
    {
        ...
        internal RedisPatchScheduleSetting(RedisDayOfWeek dayOfWeek, int startHourUtc, TimeSpan? maintenanceWindow, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DayOfWeek = dayOfWeek;
            StartHourUtc = startHourUtc;
