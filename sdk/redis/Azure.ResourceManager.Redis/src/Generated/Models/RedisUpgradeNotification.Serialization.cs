...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    {
        internal static RedisUpgradeNotification DeserializeRedisUpgradeNotification(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
