...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisUpgradeNotificationListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisUpgradeNotificationListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisUpgradeNotificationListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisUpgradeNotificationListResponse>)} interface");
            }
        ...
        string IPersistableModel<RedisUpgradeNotificationListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
