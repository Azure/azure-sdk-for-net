...
namespace Azure.ResourceManager.Redis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisLinkedServerWithPropertyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisLinkedServerWithPropertyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisLinkedServerWithPropertyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisLinkedServerWithPropertyData>)} interface");
            }
        ...
        string IPersistableModel<RedisLinkedServerWithPropertyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
