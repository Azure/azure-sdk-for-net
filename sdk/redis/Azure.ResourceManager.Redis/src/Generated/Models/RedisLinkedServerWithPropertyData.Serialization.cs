...
{
    public partial class RedisLinkedServerWithPropertyData : IUtf8JsonSerializable, IJsonModel<RedisLinkedServerWithPropertyData>, IPersistableModel<RedisLinkedServerWithPropertyData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServerRole))
            {
                ...
                builder.AppendLine($" '{ServerRole.ToString()}'");
            }
