...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class RedisInstanceDetails
    {
        ...
        internal RedisInstanceDetails(int? sslPort, int? nonSslPort, string zone, int? shardId, bool? isMaster, bool? isPrimary, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SslPort = sslPort;
