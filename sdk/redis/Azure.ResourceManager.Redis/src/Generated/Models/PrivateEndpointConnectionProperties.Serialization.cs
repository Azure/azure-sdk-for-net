...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    internal partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            RedisPrivateLinkServiceConnectionState redisPrivateLinkServiceConnectionState = default;
            RedisPrivateEndpointConnectionProvisioningState? redisProvisioningState = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    redisPrivateLinkServiceConnectionState = RedisPrivateLinkServiceConnectionState.DeserializeRedisPrivateLinkServiceConnectionState(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    redisProvisioningState = new RedisPrivateEndpointConnectionProvisioningState(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new PrivateEndpointConnectionProperties(groupIds ?? new ChangeTrackingList<string>(), privateEndpoint, redisPrivateLinkServiceConnectionState, redisProvisioningState, additionalBinaryDataProperties);
        }
