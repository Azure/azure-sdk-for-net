...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class RedisPrivateLinkResource : ResourceData, IJsonModel<RedisPrivateLinkResource>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RedisPrivateLinkResource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RedisPrivateLinkResource IJsonModel<RedisPrivateLinkResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RedisPrivateLinkResource)JsonModelCreateCore(ref reader, options);
        ...
        internal static RedisPrivateLinkResource DeserializeRedisPrivateLinkResource(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = RedisPrivateLinkResourceProperties.DeserializeRedisPrivateLinkResourceProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RedisPrivateLinkResource>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RedisPrivateLinkResource IPersistableModel<RedisPrivateLinkResource>.Create(BinaryData data, ModelReaderWriterOptions options) => (RedisPrivateLinkResource)PersistableModelCreateCore(data, options);
