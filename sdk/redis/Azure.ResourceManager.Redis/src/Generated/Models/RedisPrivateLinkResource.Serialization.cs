...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisPrivateLinkResource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisPrivateLinkResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisPrivateLinkResource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisPrivateLinkResource>)} interface");
            }
        ...
        string IPersistableModel<RedisPrivateLinkResource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
