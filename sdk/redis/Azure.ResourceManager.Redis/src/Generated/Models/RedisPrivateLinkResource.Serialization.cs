...
{
    public partial class RedisPrivateLinkResource : IUtf8JsonSerializable, IJsonModel<RedisPrivateLinkResource>, IPersistableModel<RedisPrivateLinkResource>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisPrivateLinkResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RedisPrivateLinkResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RedisPrivateLinkResource)} does not support '{format}' format.");
            }
