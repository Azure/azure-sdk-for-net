...
{
    public partial class RedisPrivateLinkResource : Core.IUtf8JsonSerializable
    {
        ...
        internal static RedisPrivateLinkResource DeserializeRedisPrivateLinkResource(JsonElement element)
        {
            ...
            return new RedisPrivateLinkResource(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
