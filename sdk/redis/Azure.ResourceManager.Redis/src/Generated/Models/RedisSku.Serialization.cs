...
{
    public partial class RedisSku : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RedisSku DeserializeRedisSku(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
