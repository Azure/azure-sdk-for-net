...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisForceRebootResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisForceRebootResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisForceRebootResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisForceRebootResult>)} interface");
            }
        ...
        string IPersistableModel<RedisForceRebootResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
