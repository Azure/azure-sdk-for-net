...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class ImportRdbContent
    {
        ...
        internal ImportRdbContent(string format, IList<string> files, string preferredDataArchiveAuthMethod, string storageSubscriptionId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Format = format;
            Files = files;
