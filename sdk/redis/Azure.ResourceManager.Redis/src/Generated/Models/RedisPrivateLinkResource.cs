...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class RedisPrivateLinkResource : ResourceData
    {
        ...
        internal RedisPrivateLinkResource(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, RedisPrivateLinkResourceProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
