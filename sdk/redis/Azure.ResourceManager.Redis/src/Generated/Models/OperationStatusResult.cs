...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class OperationStatusResult
    {
        ...
        internal OperationStatusResult(ResourceIdentifier id, string name, string status, float? percentComplete, DateTimeOffset? startOn, DateTimeOffset? endOn, IReadOnlyList<ResourceManager.Models.OperationStatusResult> operations, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Status = status;
        ...
        [WirePath("operations")]
        public IReadOnlyList<ResourceManager.Models.OperationStatusResult> Operations { get; }
