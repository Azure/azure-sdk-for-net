...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImportRdbContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImportRdbContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImportRdbContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImportRdbContent>)} interface");
            }
        ...
        string IPersistableModel<ImportRdbContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
