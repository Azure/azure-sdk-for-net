...
namespace Azure.ResourceManager.Redis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisFirewallRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisFirewallRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisFirewallRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisFirewallRuleData>)} interface");
            }
        ...
        string IPersistableModel<RedisFirewallRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
