...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class RedisLinkedServerWithPropertyCreateOrUpdateContent
    {
        ...
        internal RedisLinkedServerWithPropertyCreateOrUpdateContent(ResourceIdentifier linkedRedisCacheId, AzureLocation linkedRedisCacheLocation, RedisLinkedServerRole serverRole, string geoReplicatedPrimaryHostName, string primaryHostName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            LinkedRedisCacheId = linkedRedisCacheId;
            LinkedRedisCacheLocation = linkedRedisCacheLocation;
            ServerRole = serverRole;
