...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisRebootContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisRebootContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisRebootContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RedisRebootContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
