...
namespace Azure.ResourceManager.Redis.Models
{
    public partial class RedisCommonConfiguration : IUtf8JsonSerializable, IJsonModel<RedisCommonConfiguration>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisCommonConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisCommonConfiguration>)} interface");
            }
        ...
        string IPersistableModel<RedisCommonConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
