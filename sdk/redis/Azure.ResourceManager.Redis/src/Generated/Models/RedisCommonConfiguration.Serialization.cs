...
{
    public partial class RedisCommonConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RedisCommonConfiguration DeserializeRedisCommonConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
