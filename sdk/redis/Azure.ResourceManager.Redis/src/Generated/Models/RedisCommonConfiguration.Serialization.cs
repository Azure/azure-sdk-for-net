...
{
    public partial class RedisCommonConfiguration : IUtf8JsonSerializable, IModelJsonSerializable<RedisCommonConfiguration>
    {
        void IModelJsonSerializable<RedisCommonConfiguration>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RedisCommonConfiguration>(this, options.Format);
        ...
        internal static RedisCommonConfiguration DeserializeRedisCommonConfiguration(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        RedisCommonConfiguration IModelJsonSerializable<RedisCommonConfiguration>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RedisCommonConfiguration>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeRedisCommonConfiguration(doc.RootElement, options);
        }

        BinaryData IModelSerializable<RedisCommonConfiguration>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RedisCommonConfiguration>(this, options.Format);
        ...
        RedisCommonConfiguration IModelSerializable<RedisCommonConfiguration>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RedisCommonConfiguration>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="RedisCommonConfiguration"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="RedisCommonConfiguration"/> to convert. </param>
        public static implicit operator RequestContent(RedisCommonConfiguration model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="RedisCommonConfiguration"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator RedisCommonConfiguration(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeRedisCommonConfiguration(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
