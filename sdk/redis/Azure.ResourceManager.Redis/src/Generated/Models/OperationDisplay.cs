...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class OperationDisplay
    {
        ...
        internal OperationDisplay(string provider, string operation, string resource, string description, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Provider = provider;
            Operation = operation;
            Resource = resource;
