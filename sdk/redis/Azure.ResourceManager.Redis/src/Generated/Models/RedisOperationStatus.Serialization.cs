...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RedisOperationStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RedisOperationStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RedisOperationStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RedisOperationStatus>)} interface");
            }
        ...
        string IPersistableModel<RedisOperationStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
