...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    {
        internal static RedisPatchScheduleListResult DeserializeRedisPatchScheduleListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
