...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class RedisPrivateLinkServiceConnectionState
    {
        ...
        internal RedisPrivateLinkServiceConnectionState(RedisPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
