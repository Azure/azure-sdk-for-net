...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class RedisPrivateLinkServiceConnectionState
    {
        ...
        internal RedisPrivateLinkServiceConnectionState(RedisPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
