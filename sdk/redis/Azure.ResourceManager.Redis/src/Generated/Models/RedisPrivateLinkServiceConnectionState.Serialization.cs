...
{
    public partial class RedisPrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static RedisPrivateLinkServiceConnectionState DeserializeRedisPrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            Core.Optional<RedisPrivateEndpointServiceConnectionStatus> status = default;
            ...
            return new RedisPrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
