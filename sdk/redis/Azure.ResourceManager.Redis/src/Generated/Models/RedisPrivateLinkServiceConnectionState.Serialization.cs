...
{
    public partial class RedisPrivateLinkServiceConnectionState : IUtf8JsonSerializable, IJsonModel<RedisPrivateLinkServiceConnectionState>, IPersistableModel<RedisPrivateLinkServiceConnectionState>
    {
        ...
        void IJsonModel<RedisPrivateLinkServiceConnectionState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RedisPrivateLinkServiceConnectionState)} does not support '{format}' format.");
            }
