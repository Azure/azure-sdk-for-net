...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class ExportRdbContent
    {
        ...
        internal ExportRdbContent(string format, string prefix, string container, string preferredDataArchiveAuthMethod, string storageSubscriptionId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Format = format;
            Prefix = prefix;
            Container = container;
