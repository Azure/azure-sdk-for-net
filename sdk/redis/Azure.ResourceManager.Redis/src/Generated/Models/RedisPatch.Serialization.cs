...
{
    public partial class RedisPatch : IUtf8JsonSerializable, IModelJsonSerializable<RedisPatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<RedisPatch>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<RedisPatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RedisPatch>(this, options.Format);
        ...
        internal static RedisPatch DeserializeRedisPatch(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        RedisPatch IModelJsonSerializable<RedisPatch>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RedisPatch>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeRedisPatch(doc.RootElement, options);
        }

        BinaryData IModelSerializable<RedisPatch>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RedisPatch>(this, options.Format);
        ...
        RedisPatch IModelSerializable<RedisPatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<RedisPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="RedisPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="RedisPatch"/> to convert. </param>
        public static implicit operator RequestContent(RedisPatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="RedisPatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator RedisPatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeRedisPatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
