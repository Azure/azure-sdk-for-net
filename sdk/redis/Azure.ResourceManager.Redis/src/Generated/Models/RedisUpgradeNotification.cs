...
namespace Azure.ResourceManager.Redis.Models
{
    ...
    public partial class RedisUpgradeNotification
    {
        ...
        internal RedisUpgradeNotification(string name, DateTimeOffset? timestamp, IReadOnlyDictionary<string, string> upsellNotification, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Timestamp = timestamp;
