...
namespace Azure.ResourceManager.Redis
{
    ...
    public partial class RedisLinkedServerWithPropertiesData : ResourceData
    {
        ...
        internal RedisLinkedServerWithPropertiesData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string linkedRedisCacheId, string linkedRedisCacheLocation, ReplicationRole? serverRole, string provisioningState) : base(id, name, resourceType, systemData)
        {
