...
namespace Microsoft.Azure.Management.Redis
{
    ...
    public static partial class RedisOperationsExtensions
    {
            ...
            /// </param>
            public static NotificationListResponse ListUpgradeNotifications(this IRedisOperations operations, string resourceGroupName, string name, double history)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<NotificationListResponse> ListUpgradeNotificationsAsync(this IRedisOperations operations, string resourceGroupName, string name, double history, CancellationToken cancellationToken = default(CancellationToken))
            {
