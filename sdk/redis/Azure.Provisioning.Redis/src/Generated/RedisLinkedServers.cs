...
namespace Azure.Provisioning.Redis
{
    ...
    public partial class RedisLinkedServers : ProvisionableResource
    {
        ...
        /// <summary> Creates a new RedisLinkedServers. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public RedisLinkedServers(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Cache/redis/linkedServers", resourceVersion ?? "2024-11-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for RedisLinkedServers. </summary>
        ...
        /// <summary> Creates a reference to an existing RedisLinkedServers. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static RedisLinkedServers FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            RedisLinkedServers result = new RedisLinkedServers(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for RedisLinkedServers that are not part of the generated code. </summary>
