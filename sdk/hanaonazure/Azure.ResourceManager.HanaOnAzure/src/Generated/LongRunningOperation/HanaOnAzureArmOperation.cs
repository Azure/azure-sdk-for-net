...
{
    internal partial class HanaOnAzureArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of HanaOnAzureArmOperation for mocking. </summary>
        protected HanaOnAzureArmOperation()
        {
        }
        ...
        internal HanaOnAzureArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal HanaOnAzureArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
