...
{
    internal partial class HanaOnAzureArmOperation<T> : ArmOperation<T>
    {
        ...
        internal HanaOnAzureArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal HanaOnAzureArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
