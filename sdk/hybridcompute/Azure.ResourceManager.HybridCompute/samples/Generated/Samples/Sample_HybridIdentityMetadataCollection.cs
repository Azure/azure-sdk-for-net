...
namespace Azure.ResourceManager.HybridCompute.Samples
{
    public partial class Sample_HybridIdentityMetadataCollection
    {
        ...
        public async Task Get_GetHybridIdentityMetadata()
        {
            ...
            HybridIdentityMetadataCollection collection = hybridComputeMachine.GetAllHybridIdentityMetadata();
        ...
        {
            // Generated from example definition: specification/hybridcompute/resource-manager/Microsoft.HybridCompute/preview/2023-10-03-preview/examples/HybridIdentityMetadata_ListByVirtualMachines.json
            // this example is just showing the usage of "HybridIdentityMetadata_ListByMachines" operation, for the dependent resources, they will have to be created separately.
