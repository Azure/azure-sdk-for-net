...
namespace Azure.ResourceManager.HybridCompute.Samples
{
    public partial class Sample_MachineRunCommandResource
    {
        ...
        {
            // Generated from example definition: specification/hybridcompute/resource-manager/Microsoft.HybridCompute/preview/2023-10-03-preview/examples/runCommand/RunCommands_Update.json
            // this example is just showing the usage of "MachineRunCommands_Update" operation, for the dependent resources, they will have to be created separately.
            ...
            MachineRunCommandPatch patch = new MachineRunCommandPatch()
            {
                Tags =
{
["tag1"] = "value1",
["tag2"] = "value2",
            ...
            ArmOperation<MachineRunCommandResource> lro = await machineRunCommand.UpdateAsync(WaitUntil.Completed, patch);
