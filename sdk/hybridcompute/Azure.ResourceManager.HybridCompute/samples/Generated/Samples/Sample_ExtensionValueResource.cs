...
{
    public partial class Sample_ExtensionValueResource
    {
        ...
        public async Task Get_GETAnExtensionsMetadata()
        {
            ...
            // this example assumes you already have this ExtensionValueResource created on azure
            // for more information of creating ExtensionValueResource, please refer to the document of ExtensionValueResource
            ...
            ResourceIdentifier extensionValueResourceId = ExtensionValueResource.CreateResourceIdentifier(subscriptionId, location, publisher, extensionType, version);
            ExtensionValueResource extensionValue = client.GetExtensionValueResource(extensionValueResourceId);

            // invoke the operation
            ExtensionValueResource result = await extensionValue.GetAsync();
