...
{
    // Backward-compat justification: the GA license profile exposed flattened properties with legacy WirePath values, while the migrated model delegates to the new nested license profile shape.
