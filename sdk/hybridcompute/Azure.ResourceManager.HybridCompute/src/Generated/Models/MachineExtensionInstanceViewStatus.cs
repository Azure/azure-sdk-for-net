...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class MachineExtensionInstanceViewStatus
    {
        ...
        internal MachineExtensionInstanceViewStatus(string code, HybridComputeStatusLevelType? level, string displayStatus, string message, DateTimeOffset? time, Dictionary<string, BinaryData> rawData)
        {
            Code = code;
            Level = level;
