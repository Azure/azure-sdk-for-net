...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridComputeMachinePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HybridComputeMachinePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HybridComputeMachinePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HybridComputeMachinePatch>)} interface");
            }
        ...
        string IPersistableModel<HybridComputeMachinePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
