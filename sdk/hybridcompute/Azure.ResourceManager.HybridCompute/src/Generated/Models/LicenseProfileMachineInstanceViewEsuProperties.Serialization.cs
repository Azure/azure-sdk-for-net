...
{
    public partial class LicenseProfileMachineInstanceViewEsuProperties : IUtf8JsonSerializable, IJsonModel<LicenseProfileMachineInstanceViewEsuProperties>, IPersistableModel<LicenseProfileMachineInstanceViewEsuProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AssignedLicense))
            {
                ...
                AppendChildObject(builder, AssignedLicense, options, 2);
            }

            if (Optional.IsDefined(LicenseAssignmentState))
            {
                builder.Append("  licenseAssignmentState:");
                builder.AppendLine($" '{LicenseAssignmentState.ToString()}'");
            }
