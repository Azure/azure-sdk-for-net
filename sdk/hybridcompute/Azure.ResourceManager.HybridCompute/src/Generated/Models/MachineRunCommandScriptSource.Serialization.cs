...
{
    public partial class MachineRunCommandScriptSource : IUtf8JsonSerializable, IJsonModel<MachineRunCommandScriptSource>, IPersistableModel<MachineRunCommandScriptSource>
    {
        ...
        internal static MachineRunCommandScriptSource DeserializeMachineRunCommandScriptSource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MachineRunCommandScriptSource(script.Value, scriptUri.Value, commandId.Value, scriptUriManagedIdentity.Value, serializedAdditionalRawData);
        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ScriptUriManagedIdentity))
            {
                ...
                AppendChildObject(builder, ScriptUriManagedIdentity, options, 2);
            }
