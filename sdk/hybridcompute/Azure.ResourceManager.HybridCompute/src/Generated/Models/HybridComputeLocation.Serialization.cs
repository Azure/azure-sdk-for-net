...
{
    public partial class HybridComputeLocation : IUtf8JsonSerializable
    {
        ...
        internal static HybridComputeLocation DeserializeHybridComputeLocation(JsonElement element)
        {
            ...
            return new HybridComputeLocation(name, city.Value, district.Value, countryOrRegion.Value);
        }
    }
}
