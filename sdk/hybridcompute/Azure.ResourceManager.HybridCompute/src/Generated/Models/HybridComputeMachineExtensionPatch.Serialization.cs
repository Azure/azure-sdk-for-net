...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridComputeMachineExtensionPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HybridComputeMachineExtensionPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HybridComputeMachineExtensionPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HybridComputeMachineExtensionPatch>)} interface");
            }
        ...
        string IPersistableModel<HybridComputeMachineExtensionPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
