...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    internal partial class AccessRuleProperties : IJsonModel<AccessRuleProperties>
    {
        ...
        internal static AccessRuleProperties DeserializeAccessRuleProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("direction"u8))
                {
                    ...
                    direction = new HybridComputeAccessRuleDirection(prop.Value.GetString());
                    continue;
                }
            ...
            return new AccessRuleProperties(direction, addressPrefixes ?? new ChangeTrackingList<string>(), additionalBinaryDataProperties);
        }
    }
}
