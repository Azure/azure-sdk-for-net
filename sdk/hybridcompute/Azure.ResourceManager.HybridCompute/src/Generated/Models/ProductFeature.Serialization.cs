...
{
    public partial class ProductFeature : IUtf8JsonSerializable
    {
        ...
        internal static ProductFeature DeserializeProductFeature(JsonElement element)
        {
            ...
            return new ProductFeature(name.Value, Optional.ToNullable(subscriptionStatus), Optional.ToNullable(billingStartDate), Optional.ToNullable(enrollmentDate), Optional.ToNullable(disenrollmentDate));
        }
    }
}
