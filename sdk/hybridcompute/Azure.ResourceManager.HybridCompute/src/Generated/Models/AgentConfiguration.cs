...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class AgentConfiguration
    {
        ...
        internal AgentConfiguration(Uri proxyUri, IReadOnlyList<string> incomingConnectionsPorts, IReadOnlyList<ConfigurationExtension> extensionsAllowList, IReadOnlyList<ConfigurationExtension> extensionsBlockList, IReadOnlyList<string> proxyBypass, string extensionsEnabled, string guestConfigurationEnabled, AgentConfigurationMode? configMode, Dictionary<string, BinaryData> rawData)
        {
            ProxyUri = proxyUri;
