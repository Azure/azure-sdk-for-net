...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineExtensionInstanceView>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineExtensionInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineExtensionInstanceView>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineExtensionInstanceView>)} interface");
            }
        ...
        string IPersistableModel<MachineExtensionInstanceView>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
