...
{
    public partial class HybridComputeLicenseData : IUtf8JsonSerializable
    {
        ...
        internal static HybridComputeLicenseData DeserializeHybridComputeLicenseData(JsonElement element)
        {
            ...
            return new HybridComputeLicenseData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(provisioningState), Optional.ToNullable(tenantId), Optional.ToNullable(licenseType), licenseDetails.Value);
        }
    }
}
