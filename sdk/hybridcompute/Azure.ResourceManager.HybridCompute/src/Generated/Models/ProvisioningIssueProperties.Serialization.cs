...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    internal partial class ProvisioningIssueProperties : IJsonModel<ProvisioningIssueProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(SuggestedAccessRules))
            {
                ...
                writer.WriteStartArray();
                foreach (HybridComputeAccessRule item in SuggestedAccessRules)
                {
        ...
        internal static ProvisioningIssueProperties DeserializeProvisioningIssueProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("issueType"u8))
                {
                    ...
                    issueType = new HybridComputeProvisioningIssueType(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("severity"u8))
                {
                    ...
                    severity = new HybridComputeProvisioningIssueSeverity(prop.Value.GetString());
                    continue;
                }
