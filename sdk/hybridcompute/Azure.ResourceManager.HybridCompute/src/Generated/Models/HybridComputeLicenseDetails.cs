...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class HybridComputeLicenseDetails
    {
        ...
        internal HybridComputeLicenseDetails(HybridComputeLicenseState? state, HybridComputeLicenseTarget? target, HybridComputeLicenseEdition? edition, HybridComputeLicenseCoreType? coreType, int? processors, int? assignedLicenses, string immutableId)
        {
            State = state;
            Target = target;
            Edition = edition;
        ...
        public HybridComputeLicenseCoreType? CoreType { get; set; }
