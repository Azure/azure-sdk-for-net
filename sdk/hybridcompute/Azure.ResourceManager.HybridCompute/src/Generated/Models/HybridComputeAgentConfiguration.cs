...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class HybridComputeAgentConfiguration
    {
        /// <summary> Initializes a new instance of <see cref="HybridComputeAgentConfiguration"/>. </summary>
        internal HybridComputeAgentConfiguration()
        {
        ...
        /// <param name="isGuestConfigurationEnabled"> Specified whether the guest configuration service is enabled or disabled. </param>
        ...
        internal HybridComputeAgentConfiguration(Uri proxyUri, IReadOnlyList<string> incomingConnectionsPorts, IReadOnlyList<HybridComputeConfigurationExtension> extensionsAllowList, IReadOnlyList<HybridComputeConfigurationExtension> extensionsBlockList, IReadOnlyList<string> proxyBypass, string extensionsEnabled, string isGuestConfigurationEnabled, AgentConfigurationMode? configMode)
        {
            ProxyUri = proxyUri;
            ...
            IsGuestConfigurationEnabled = isGuestConfigurationEnabled;
        ...
        public string IsGuestConfigurationEnabled { get; }
