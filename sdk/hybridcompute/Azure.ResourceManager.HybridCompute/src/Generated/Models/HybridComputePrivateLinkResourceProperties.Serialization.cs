...
{
    public partial class HybridComputePrivateLinkResourceProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static HybridComputePrivateLinkResourceProperties DeserializeHybridComputePrivateLinkResourceProperties(JsonElement element)
        {
            ...
            return new HybridComputePrivateLinkResourceProperties(groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
