...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class HybridComputeMachinePatch : HybridComputeResourceUpdate
    {
        ...
        internal HybridComputeMachinePatch(IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, ManagedServiceIdentity identity, LocationData locationData, OSProfile osProfile, CloudMetadata cloudMetadata, AgentUpgrade agentUpgrade, ResourceIdentifier parentClusterResourceId, ResourceIdentifier privateLinkScopeResourceId) : base(tags, serializedAdditionalRawData)
        {
            Identity = identity;
