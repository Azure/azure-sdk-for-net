...
namespace Azure.ResourceManager.HybridCompute
{
    public partial class HybridComputePrivateLinkScopeData : IUtf8JsonSerializable, IJsonModel<HybridComputePrivateLinkScopeData>
    {
        ...
        void IJsonModel<HybridComputePrivateLinkScopeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(HybridComputePrivateLinkScopeData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HybridComputePrivateLinkScopeData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(HybridComputePrivateLinkScopeData)} does not support '{options.Format}' format.");
            }
        }
