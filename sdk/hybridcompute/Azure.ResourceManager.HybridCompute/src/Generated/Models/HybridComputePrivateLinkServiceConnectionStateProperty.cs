...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class HybridComputePrivateLinkServiceConnectionStateProperty
    {
        ...
        internal HybridComputePrivateLinkServiceConnectionStateProperty(string status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Description = description;
