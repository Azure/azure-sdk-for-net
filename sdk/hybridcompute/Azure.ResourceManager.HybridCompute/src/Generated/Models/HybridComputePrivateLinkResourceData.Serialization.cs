...
{
    public partial class HybridComputePrivateLinkResourceData : IUtf8JsonSerializable
    {
        ...
        internal static HybridComputePrivateLinkResourceData DeserializeHybridComputePrivateLinkResourceData(JsonElement element)
        {
            ...
            return new HybridComputePrivateLinkResourceData(id, name, type, systemData.Value, properties.Value);
        }
    }
}
