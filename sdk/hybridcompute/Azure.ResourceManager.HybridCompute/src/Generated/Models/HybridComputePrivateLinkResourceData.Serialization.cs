...
{
    public partial class HybridComputePrivateLinkResourceData : IUtf8JsonSerializable, IJsonModel<HybridComputePrivateLinkResourceData>, IPersistableModel<HybridComputePrivateLinkResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridComputePrivateLinkResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<HybridComputePrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HybridComputePrivateLinkResourceData)} does not support '{format}' format.");
            }
