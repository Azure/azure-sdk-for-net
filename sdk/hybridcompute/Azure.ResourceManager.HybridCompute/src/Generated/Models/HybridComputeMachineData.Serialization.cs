...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridComputeMachineData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HybridComputeMachineData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HybridComputeMachineData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HybridComputeMachineData>)} interface");
            }
        ...
        string IPersistableModel<HybridComputeMachineData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
