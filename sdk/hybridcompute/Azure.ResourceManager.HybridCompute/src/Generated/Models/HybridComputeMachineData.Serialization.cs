...
{
    public partial class HybridComputeMachineData : IUtf8JsonSerializable, IJsonModel<HybridComputeMachineData>, IPersistableModel<HybridComputeMachineData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LocationData))
            {
                ...
                AppendChildObject(builder, LocationData, options, 2);
            }
            ...
            if (Optional.IsDefined(ServiceStatuses))
            {
                ...
                AppendChildObject(builder, ServiceStatuses, options, 2);
            }

            if (Optional.IsDefined(CloudMetadata))
            {
                builder.Append("  cloudMetadata:");
                AppendChildObject(builder, CloudMetadata, options, 2);
            }

            if (Optional.IsDefined(AgentUpgrade))
            {
                builder.Append("  agentUpgrade:");
                AppendChildObject(builder, AgentUpgrade, options, 2);
            }
