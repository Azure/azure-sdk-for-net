...
{
    public partial class HybridComputeWindowsConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static HybridComputeWindowsConfiguration DeserializeHybridComputeWindowsConfiguration(JsonElement element)
        {
            ...
            return new HybridComputeWindowsConfiguration(Optional.ToNullable(assessmentMode), Optional.ToNullable(patchMode));
        }
    }
}
