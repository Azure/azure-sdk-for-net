...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class ConnectionDetail
    {
        ...
        internal ConnectionDetail(string id, string privateIPAddress, string linkIdentifier, string groupId, string memberName, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
