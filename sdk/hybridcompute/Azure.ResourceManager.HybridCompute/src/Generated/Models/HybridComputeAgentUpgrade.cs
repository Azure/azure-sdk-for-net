...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class HybridComputeAgentUpgrade
    {
        /// <summary> Initializes a new instance of <see cref="HybridComputeAgentUpgrade"/>. </summary>
        public HybridComputeAgentUpgrade()
        {
        }
        ...
        internal HybridComputeAgentUpgrade(string desiredVersion, Guid? correlationId, bool? enableAutomaticUpgrade, string lastAttemptDesiredVersion, DateTimeOffset? lastAttemptTimestamp, LastAttemptStatusEnum? lastAttemptStatus, string lastAttemptMessage)
        {
