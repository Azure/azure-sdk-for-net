...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class License : TrackedResourceData
    {
        /// <summary> Initializes a new instance of <see cref="License"/>. </summary>
        /// <param name="location"> The location. </param>
        public License(AzureLocation location) : base(location)
        {
        }
        ...
        internal License(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ProvisioningState? provisioningState, Guid? tenantId, LicenseType? licenseType, LicenseDetails licenseDetails) : base(id, name, resourceType, systemData, tags, location)
        {
