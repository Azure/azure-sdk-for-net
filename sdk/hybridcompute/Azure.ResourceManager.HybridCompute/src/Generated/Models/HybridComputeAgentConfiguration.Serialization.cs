...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    {
        internal static HybridComputeAgentConfiguration DeserializeHybridComputeAgentConfiguration(JsonElement element)
        {
            ...
            return new HybridComputeAgentConfiguration(proxyUrl.Value, Optional.ToList(incomingConnectionsPorts), Optional.ToList(extensionsAllowList), Optional.ToList(extensionsBlockList), Optional.ToList(proxyBypass), extensionsEnabled.Value, guestConfigurationEnabled.Value, Optional.ToNullable(configMode));
        }
    }
}
