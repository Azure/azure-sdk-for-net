...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineExtensionUpgrade>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineExtensionUpgrade>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineExtensionUpgrade>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineExtensionUpgrade>)} interface");
            }
        ...
        string IPersistableModel<MachineExtensionUpgrade>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
