...
namespace Azure.ResourceManager.HybridCompute.Models
{
    public partial class FirmwareProfile : IUtf8JsonSerializable, IJsonModel<FirmwareProfile>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(FirmwareProfileType))
            {
                writer.WritePropertyName("type"u8);
                writer.WriteStringValue(FirmwareProfileType);
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(FirmwareProfileType), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  type: ");
                builder.AppendLine(propertyOverride);
            ...
            {
                if (Optional.IsDefined(FirmwareProfileType))
                {
                    builder.Append("  type: ");
                    if (FirmwareProfileType.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{FirmwareProfileType}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{FirmwareProfileType}'");
