...
{
    public partial class EsuKey : IUtf8JsonSerializable, IJsonModel<EsuKey>, IPersistableModel<EsuKey>
    {
        ...
        internal static EsuKey DeserializeEsuKey(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new EsuKey(sku.Value, licenseStatus.Value, serializedAdditionalRawData);
        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LicenseStatus))
            {
                ...
                builder.AppendLine($" '{LicenseStatus}'");
            }
