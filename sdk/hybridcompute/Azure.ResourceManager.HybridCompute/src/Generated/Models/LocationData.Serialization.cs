...
namespace Azure.ResourceManager.HybridCompute.Models
{
    public partial class LocationData : IUtf8JsonSerializable, IJsonModel<LocationData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LocationData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocationData>)} interface");
            }
