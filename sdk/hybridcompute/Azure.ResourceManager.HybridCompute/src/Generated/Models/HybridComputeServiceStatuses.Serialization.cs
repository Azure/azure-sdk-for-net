...
{
    public partial class HybridComputeServiceStatuses : IUtf8JsonSerializable, IJsonModel<HybridComputeServiceStatuses>, IPersistableModel<HybridComputeServiceStatuses>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExtensionService))
            {
                ...
                AppendChildObject(builder, ExtensionService, options, 2);
            }

            if (Optional.IsDefined(GuestConfigurationService))
            {
                builder.Append("  guestConfigurationService:");
                AppendChildObject(builder, GuestConfigurationService, options, 2);
            }
