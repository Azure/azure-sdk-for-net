...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridComputeServiceStatus>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static HybridComputeServiceStatus DeserializeHybridComputeServiceStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new HybridComputeServiceStatus(status, startupType, serializedAdditionalRawData);
        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(StartupType), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  startupType: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  startupType: ");
                    if (StartupType.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{StartupType}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{StartupType}'");
