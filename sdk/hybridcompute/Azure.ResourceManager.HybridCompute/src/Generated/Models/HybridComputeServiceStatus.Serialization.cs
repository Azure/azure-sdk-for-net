...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridComputeServiceStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HybridComputeServiceStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HybridComputeServiceStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HybridComputeServiceStatus>)} interface");
            }
        ...
        string IPersistableModel<HybridComputeServiceStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
