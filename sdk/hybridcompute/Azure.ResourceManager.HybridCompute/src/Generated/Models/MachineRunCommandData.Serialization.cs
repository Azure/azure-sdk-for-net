...
namespace Azure.ResourceManager.HybridCompute
{
    public partial class MachineRunCommandData : IUtf8JsonSerializable
    {
        ...
        internal static MachineRunCommandData DeserializeMachineRunCommandData(JsonElement element)
        {
            ...
            Optional<IList<HybridComputeRunCommandInputParameter>> parameters = default;
            Optional<IList<HybridComputeRunCommandInputParameter>> protectedParameters = default;
            ...
            Optional<HybridComputeRunCommandManagedIdentity> outputBlobManagedIdentity = default;
            Optional<HybridComputeRunCommandManagedIdentity> errorBlobManagedIdentity = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("parameters"u8))
                        {
                            ...
                            List<HybridComputeRunCommandInputParameter> array = new List<HybridComputeRunCommandInputParameter>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(HybridComputeRunCommandInputParameter.DeserializeHybridComputeRunCommandInputParameter(item));
                            }
                            parameters = array;
                            continue;
                        }
                        ...
                        if (property0.NameEquals("outputBlobManagedIdentity"u8))
                        {
                            ...
                            outputBlobManagedIdentity = HybridComputeRunCommandManagedIdentity.DeserializeHybridComputeRunCommandManagedIdentity(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("errorBlobManagedIdentity"u8))
                        {
                            ...
                            errorBlobManagedIdentity = HybridComputeRunCommandManagedIdentity.DeserializeHybridComputeRunCommandManagedIdentity(property0.Value);
                            continue;
                        }
