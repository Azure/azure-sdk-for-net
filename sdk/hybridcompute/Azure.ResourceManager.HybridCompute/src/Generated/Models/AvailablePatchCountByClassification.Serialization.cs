...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailablePatchCountByClassification>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvailablePatchCountByClassification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailablePatchCountByClassification>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AvailablePatchCountByClassification>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
