...
{
    public partial class HybridComputeAgentUpgrade : IUtf8JsonSerializable
    {
        ...
        internal static HybridComputeAgentUpgrade DeserializeHybridComputeAgentUpgrade(JsonElement element)
        {
            ...
            return new HybridComputeAgentUpgrade(desiredVersion.Value, Optional.ToNullable(correlationId), Optional.ToNullable(enableAutomaticUpgrade), lastAttemptDesiredVersion.Value, Optional.ToNullable(lastAttemptTimestamp), Optional.ToNullable(lastAttemptStatus), lastAttemptMessage.Value);
        }
    }
}
