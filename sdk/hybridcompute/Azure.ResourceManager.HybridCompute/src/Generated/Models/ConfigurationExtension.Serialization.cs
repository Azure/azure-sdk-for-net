...
namespace Azure.ResourceManager.HybridCompute.Models
{
    public partial class ConfigurationExtension : IUtf8JsonSerializable, IJsonModel<ConfigurationExtension>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConfigurationExtension>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ConfigurationExtension)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ConfigurationExtension>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ConfigurationExtension)} does not support '{options.Format}' format.");
            }
        }
