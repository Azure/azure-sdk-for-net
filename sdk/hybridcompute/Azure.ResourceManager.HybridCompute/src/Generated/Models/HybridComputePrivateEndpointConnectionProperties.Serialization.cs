...
{
    public partial class HybridComputePrivateEndpointConnectionProperties : IUtf8JsonSerializable
    {
        ...
        internal static HybridComputePrivateEndpointConnectionProperties DeserializeHybridComputePrivateEndpointConnectionProperties(JsonElement element)
        {
            ...
            return new HybridComputePrivateEndpointConnectionProperties(privateEndpoint, privateLinkServiceConnectionState.Value, provisioningState.Value, Optional.ToList(groupIds));
        }
    }
}
