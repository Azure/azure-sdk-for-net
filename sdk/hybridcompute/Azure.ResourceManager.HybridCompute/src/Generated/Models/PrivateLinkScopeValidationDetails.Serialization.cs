...
namespace Azure.ResourceManager.HybridCompute.Models
{
    public partial class PrivateLinkScopeValidationDetails
    {
        internal static PrivateLinkScopeValidationDetails DeserializePrivateLinkScopeValidationDetails(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<PrivateEndpointConnectionDetail>> connectionDetails = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("connectionDetails"u8))
                {
                    ...
                    List<PrivateEndpointConnectionDetail> array = new List<PrivateEndpointConnectionDetail>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(PrivateEndpointConnectionDetail.DeserializePrivateEndpointConnectionDetail(item));
                    }
