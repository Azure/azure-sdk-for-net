...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class HybridComputeRunCommandManagedIdentity
    {
        /// <summary> Initializes a new instance of <see cref="HybridComputeRunCommandManagedIdentity"/>. </summary>
        public HybridComputeRunCommandManagedIdentity()
        {
        }
        ...
        internal HybridComputeRunCommandManagedIdentity(Guid? clientId, Guid? objectId)
        {
            ClientId = clientId;
            ObjectId = objectId;
        }
