...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class PrivateLinkScopeValidationDetails
    {
        ...
        internal PrivateLinkScopeValidationDetails(string id, PublicNetworkAccessType? publicNetworkAccess, IReadOnlyList<ConnectionDetail> connectionDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
