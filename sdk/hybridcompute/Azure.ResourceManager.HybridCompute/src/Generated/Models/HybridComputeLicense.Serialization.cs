...
{
    public partial class HybridComputeLicense : IUtf8JsonSerializable, IJsonModel<HybridComputeLicense>, IPersistableModel<HybridComputeLicense>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LicenseDetails))
            {
                ...
                AppendChildObject(builder, LicenseDetails, options, 2);
            }
