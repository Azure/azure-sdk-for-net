...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class HybridComputeNetworkInterface : IJsonModel<HybridComputeNetworkInterface>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HybridComputeNetworkInterface PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HybridComputeNetworkInterface>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HybridComputeNetworkInterface>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HybridComputeNetworkInterface IPersistableModel<HybridComputeNetworkInterface>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HybridComputeNetworkInterface IJsonModel<HybridComputeNetworkInterface>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HybridComputeNetworkInterface JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HybridComputeNetworkInterface>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HybridComputeNetworkInterface DeserializeHybridComputeNetworkInterface(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new HybridComputeNetworkInterface(macAddress, id, name, ipAddresses ?? new ChangeTrackingList<HybridComputeIPAddress>(), additionalBinaryDataProperties);
        }
    }
}
