...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public partial class MachineRunCommandScriptSource
    {
        ...
        internal MachineRunCommandScriptSource(string script, Uri scriptUri, string commandId, RunCommandManagedIdentity scriptUriManagedIdentity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Script = script;
            ScriptUri = scriptUri;
            CommandId = commandId;
