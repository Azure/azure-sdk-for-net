...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class MachineRunCommandData : TrackedResourceData
    {
        ...
        {
            Parameters = new ChangeTrackingList<HybridComputeRunCommandInputParameter>();
            ProtectedParameters = new ChangeTrackingList<HybridComputeRunCommandInputParameter>();
        }
        ...
        internal MachineRunCommandData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, MachineRunCommandScriptSource source, IList<HybridComputeRunCommandInputParameter> parameters, IList<HybridComputeRunCommandInputParameter> protectedParameters, bool? asyncExecution, string runAsUser, string runAsPassword, int? timeoutInSeconds, Uri outputBlobUri, Uri errorBlobUri, HybridComputeRunCommandManagedIdentity outputBlobManagedIdentity, HybridComputeRunCommandManagedIdentity errorBlobManagedIdentity, string provisioningState, MachineRunCommandInstanceView instanceView) : base(id, name, resourceType, systemData, tags, location)
        {
            Source = source;
        ...
        public IList<HybridComputeRunCommandInputParameter> Parameters { get; }
        /// <summary> The parameters used by the script. </summary>
        public IList<HybridComputeRunCommandInputParameter> ProtectedParameters { get; }
        ...
        public HybridComputeRunCommandManagedIdentity OutputBlobManagedIdentity { get; set; }
        /// <summary> User-assigned managed identity that has access to errorBlobUri storage blob. Use an empty object in case of system-assigned identity. Make sure managed identity has been given access to blob's container with 'Storage Blob Data Contributor' role assignment. In case of user-assigned identity, make sure you add it under VM's identity. For more info on managed identity and Run Command, refer https://aka.ms/ManagedIdentity and https://aka.ms/RunCommandManaged. </summary>
        public HybridComputeRunCommandManagedIdentity ErrorBlobManagedIdentity { get; set; }
