...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    {
        private static IJsonModel<HybridComputeExtensionValueData> s_dataDeserializationInstance;

        private static IJsonModel<HybridComputeExtensionValueData> DataDeserializationInstance => s_dataDeserializationInstance ??= new HybridComputeExtensionValueData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HybridComputeExtensionValueData IJsonModel<HybridComputeExtensionValueData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<HybridComputeExtensionValueData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
