...
namespace Azure.ResourceManager.HybridCompute.Models
{
    ...
    public static partial class ArmHybridComputeModelFactory
    {
        ...
        {
            return new IPAddress(address, ipAddressVersion, subnetAddressPrefix != null ? new Subnet(subnetAddressPrefix, new Dictionary<string, BinaryData>()) : null, serializedAdditionalRawData: null);
        }
