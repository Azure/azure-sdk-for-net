...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class HybridComputeExtensionValueV2Data : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="HybridComputeExtensionValueV2Data"/>. </summary>
        internal HybridComputeExtensionValueV2Data()
        {
        }
        ...
        internal HybridComputeExtensionValueV2Data(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ExtensionValueV2Properties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
