...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class HybridComputePrivateLinkResource : ArmResource
    {
        ...
        internal HybridComputePrivateLinkResource(ArmClient client, HybridComputePrivateLinkResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<HybridComputePrivateLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new HybridComputePrivateLinkResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
