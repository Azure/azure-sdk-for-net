...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class HybridComputePrivateLinkResource : ArmResource
    {
        ...
        internal HybridComputePrivateLinkResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _hybridComputePrivateLinkResourcePrivateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.HybridCompute", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string hybridComputePrivateLinkResourcePrivateLinkResourcesApiVersion);
        ...
        public virtual HybridComputePrivateLinkResourceData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<HybridComputePrivateLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _hybridComputePrivateLinkResourcePrivateLinkResourcesClientDiagnostics.CreateScope("HybridComputePrivateLinkResource.Get");
            scope.Start();
            try
            {
                var response = await _hybridComputePrivateLinkResourcePrivateLinkResourcesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<HybridComputePrivateLinkResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _hybridComputePrivateLinkResourcePrivateLinkResourcesClientDiagnostics.CreateScope("HybridComputePrivateLinkResource.Get");
            scope.Start();
            try
            {
                var response = _hybridComputePrivateLinkResourcePrivateLinkResourcesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new HybridComputePrivateLinkResource(Client, response.Value), response.GetRawResponse());
            }
