...
namespace Azure.ResourceManager.HybridCompute.Testing
{
    /// <summary> A class to add extension methods to ResourceGroupResource. </summary>
    public partial class HybridComputeResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HybridComputeResourceGroupResourceExtension"/> class for mocking. </summary>
        protected HybridComputeResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridComputeResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridComputeResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
