...
namespace Azure.ResourceManager.HybridCompute.Mocking
{
    ...
    internal partial class HybridComputeArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HybridComputeArmClientMockingExtension"/> class for mocking. </summary>
        protected HybridComputeArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridComputeArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridComputeArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal HybridComputeArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
