...
namespace Azure.ResourceManager.HybridCompute.Testing
{
    ...
    public partial class HybridComputeSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HybridComputeSubscriptionResourceExtension"/> class for mocking. </summary>
        protected HybridComputeSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridComputeSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridComputeSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<PrivateLinkScopeValidationDetails>> GetValidationDetailsPrivateLinkScopeAsync(AzureLocation location, string privateLinkScopeId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = HybridComputePrivateLinkScopePrivateLinkScopesClientDiagnostics.CreateScope("HybridComputeSubscriptionResourceExtension.GetValidationDetailsPrivateLinkScope");
            scope.Start();
            try
            {
