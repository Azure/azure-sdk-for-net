...
namespace Azure.ResourceManager.HybridCompute.Mock
{
    ...
    public partial class HybridComputeMachineResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HybridComputeMachineResourceExtension"/> class for mocking. </summary>
        protected HybridComputeMachineResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridComputeMachineResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridComputeMachineResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
