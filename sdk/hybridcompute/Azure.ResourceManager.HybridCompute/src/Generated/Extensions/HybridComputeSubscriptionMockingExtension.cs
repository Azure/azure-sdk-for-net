...
namespace Azure.ResourceManager.HybridCompute.Mocking
{
    ...
    internal partial class HybridComputeSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HybridComputeSubscriptionMockingExtension"/> class for mocking. </summary>
        protected HybridComputeSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridComputeSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridComputeSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = HybridComputePrivateLinkScopePrivateLinkScopesClientDiagnostics.CreateScope("HybridComputeSubscriptionMockingExtension.GetValidationDetailsPrivateLinkScope");
            scope.Start();
            try
            {
