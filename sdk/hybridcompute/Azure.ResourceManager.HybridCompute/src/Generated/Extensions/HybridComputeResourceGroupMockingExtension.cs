...
namespace Azure.ResourceManager.HybridCompute.Mocking
{
    ...
    internal partial class HybridComputeResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HybridComputeResourceGroupMockingExtension"/> class for mocking. </summary>
        protected HybridComputeResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridComputeResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridComputeResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
