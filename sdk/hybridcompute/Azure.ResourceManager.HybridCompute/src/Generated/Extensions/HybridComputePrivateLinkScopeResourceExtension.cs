...
namespace Azure.ResourceManager.HybridCompute.Mock
{
    ...
    public partial class HybridComputePrivateLinkScopeResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HybridComputePrivateLinkScopeResourceExtension"/> class for mocking. </summary>
        protected HybridComputePrivateLinkScopeResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridComputePrivateLinkScopeResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridComputePrivateLinkScopeResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<PrivateLinkScopeValidationDetails>> GetValidationDetailsPrivateLinkScopeAsync(AzureLocation location, string privateLinkScopeId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = HybridComputePrivateLinkScopePrivateLinkScopesClientDiagnostics.CreateScope("HybridComputePrivateLinkScopeResourceExtension.GetValidationDetailsPrivateLinkScope");
            scope.Start();
            try
            {
