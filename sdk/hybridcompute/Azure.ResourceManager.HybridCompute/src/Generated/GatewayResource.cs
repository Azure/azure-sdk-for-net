...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class GatewayResource : ArmResource
    {
        ...
        {
            _gatewayClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.HybridCompute", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new HybridComputeArmOperation(_gatewayClientDiagnostics, Pipeline, _gatewayRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
