...
namespace Azure.ResourceManager.HybridCompute
{
    internal partial class GatewaysGetBySubscriptionCollectionResultOfT : Pageable<ArcGatewayData>
    {
        ...
        /// <summary> Initializes a new instance of GatewaysGetBySubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of GatewaysGetBySubscriptionCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of GatewaysGetBySubscriptionCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ArcGatewayData>> AsPages(string continuationToken, int? pageSizeHint)
        {
