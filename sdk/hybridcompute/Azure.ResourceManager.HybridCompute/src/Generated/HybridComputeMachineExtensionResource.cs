...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class HybridComputeMachineExtensionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _hybridComputeMachineExtensionMachineExtensionsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = await _hybridComputeMachineExtensionMachineExtensionsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new HybridComputeArmOperation(_hybridComputeMachineExtensionMachineExtensionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _hybridComputeMachineExtensionMachineExtensionsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = _hybridComputeMachineExtensionMachineExtensionsRestClient.Delete(message, cancellationToken);
                var operation = new HybridComputeArmOperation(_hybridComputeMachineExtensionMachineExtensionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<HybridComputeMachineExtensionResource>> UpdateAsync(WaitUntil waitUntil, HybridComputeMachineExtensionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _hybridComputeMachineExtensionMachineExtensionsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch);
                var response = await _hybridComputeMachineExtensionMachineExtensionsRestClient.UpdateAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<HybridComputeMachineExtensionResource> Update(WaitUntil waitUntil, HybridComputeMachineExtensionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _hybridComputeMachineExtensionMachineExtensionsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch);
                var response = _hybridComputeMachineExtensionMachineExtensionsRestClient.Update(message, cancellationToken);
                var operation = new HybridComputeArmOperation<HybridComputeMachineExtensionResource>(new HybridComputeMachineExtensionOperationSource(Client), _hybridComputeMachineExtensionMachineExtensionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
