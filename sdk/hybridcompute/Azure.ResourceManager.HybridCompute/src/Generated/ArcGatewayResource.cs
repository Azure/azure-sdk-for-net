...
{
    /// <summary>
    /// A class representing a ArcGateway along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ArcGatewayResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetArcGateways method.
    /// </summary>
    public partial class ArcGatewayResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ArcGatewayResource for mocking. </summary>
        protected ArcGatewayResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ArcGatewayResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/gateways/{gatewayName}";
        ...
        {
            using DiagnosticScope scope = _gatewaysClientDiagnostics.CreateScope("ArcGatewayResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ArcGatewayResource>> UpdateAsync(ArcGatewayPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _gatewaysRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ArcGatewayPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ArcGatewayData> response = Response.FromValue(ArcGatewayData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _gatewaysClientDiagnostics.CreateScope("ArcGatewayResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HybridComputeArmOperation operation = new HybridComputeArmOperation(_gatewaysClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<ArcGatewayResource>> UpdateAsync(WaitUntil waitUntil, ArcGatewayData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _gatewaysRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ArcGatewayData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ArcGatewayResource> Update(WaitUntil waitUntil, ArcGatewayData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<ArcGatewayResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _gatewaysClientDiagnostics.CreateScope("ArcGatewayResource.AddTag");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ArcGatewayResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _gatewaysClientDiagnostics.CreateScope("ArcGatewayResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<ArcGatewayResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _gatewaysClientDiagnostics.CreateScope("ArcGatewayResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
