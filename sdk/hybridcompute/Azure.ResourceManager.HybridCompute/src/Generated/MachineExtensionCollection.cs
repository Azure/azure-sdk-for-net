...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    /// Each <see cref="MachineExtensionResource" /> in the collection will belong to the same instance of <see cref="MachineResource" />.
    /// To get a <see cref="MachineExtensionCollection" /> instance call the GetMachineExtensions method from an instance of <see cref="MachineResource" />.
    /// </summary>
    public partial class MachineExtensionCollection : ArmCollection, IEnumerable<MachineExtensionResource>, IAsyncEnumerable<MachineExtensionResource>
    {
        ...
        {
            _machineExtensionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.HybridCompute", MachineExtensionResource.ResourceType.Namespace, Diagnostics);
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            if (id.ResourceType != MachineResource.ResourceType)
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid resource type {0} expected {1}", id.ResourceType, MachineResource.ResourceType), nameof(id));
        }
