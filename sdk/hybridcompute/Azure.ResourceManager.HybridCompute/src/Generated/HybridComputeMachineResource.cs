...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class HybridComputeMachineResource : ArmResource
    {
        ...
        internal HybridComputeMachineResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _hybridComputeClientRestClient = new HybridComputeClient(_hybridComputeClientClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, hybridComputeMachineApiVersion ?? "2026-07-15");
        ...
        /// <summary>
        /// Updates the HybridComputeMachine.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridCompute/machines/{machineName}. </description>
        ...
        public virtual async Task<ArmOperation<HybridComputeMachineResource>> UpdateAsync(WaitUntil waitUntil, HybridComputeMachineData data, string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _machinesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, HybridComputeMachineData.ToRequestContent(data), expand, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<HybridComputeMachineData> response = Response.FromValue(HybridComputeMachineData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HybridComputeMachineResource> Update(WaitUntil waitUntil, HybridComputeMachineData data, string expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
