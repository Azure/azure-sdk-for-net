...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class HybridComputeMachineResource : ArmResource
    {
        ...
        public virtual async Task<Response<HybridComputeMachineResource>> GetAsync(InstanceViewTypes? expand = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="expand"> The expand expression to apply on the operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<HybridComputeMachineResource> Get(InstanceViewTypes? expand = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _machinesClientDiagnostics.CreateScope("HybridComputeMachineResource.Get");
            scope.Start();
            try
