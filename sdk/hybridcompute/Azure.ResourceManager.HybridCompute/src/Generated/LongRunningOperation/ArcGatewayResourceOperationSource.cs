...
{
    /// <summary></summary>
    internal partial class ArcGatewayResourceOperationSource : IOperationSource<ArcGatewayResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ArcGatewayResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
