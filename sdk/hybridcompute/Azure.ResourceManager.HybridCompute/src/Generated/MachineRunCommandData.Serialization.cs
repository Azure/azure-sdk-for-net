                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("source"u8))
                        {
                            ...
                            source = ModelSerializationExtensions.JsonDeserialize<MachineRunCommandScriptSource>(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("instanceView"u8))
                        {
                            ...
                            instanceView = ModelSerializationExtensions.JsonDeserialize<MachineRunCommandInstanceView>(property0.Value);
                            continue;
                        }
                    }
                    continue;
