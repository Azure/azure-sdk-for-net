...
namespace Azure.ResourceManager.HybridCompute
{
    ...
    public partial class HybridComputeExtensionValueData : ResourceData
    {
        ...
        internal HybridComputeExtensionValueData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ExtensionValueProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
