...
namespace Azure.ResourceManager.DataBox
{
    public partial class DataBoxJobResource
    {
        ...
        public virtual async Task<ArmOperation<DataBoxJobResource>> UpdateAsync(WaitUntil waitUntil, DataBoxJobPatch patch, string ifMatch, CancellationToken cancellationToken = default)
        {
