...
using Azure.ResourceManager.DataBox.Testing;
...
namespace Azure.ResourceManager.DataBox
{
    ...
    public static partial class DataBoxExtensions
    {
        ...
        {
            return GetDataBoxSubscriptionResourceExtension(subscriptionResource).GetDataBoxJobsAsync(skipToken, cancellationToken);
        }
        ...
        {
            return GetDataBoxSubscriptionResourceExtension(subscriptionResource).GetDataBoxJobs(skipToken, cancellationToken);
        }
