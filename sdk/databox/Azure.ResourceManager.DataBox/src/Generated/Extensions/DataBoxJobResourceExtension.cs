...
namespace Azure.ResourceManager.DataBox.Mock
{
    ...
    public partial class DataBoxJobResourceExtension : ArmResource
    {
        private ClientDiagnostics _dataBoxJobJobsClientDiagnostics;
        private JobsRestOperations _dataBoxJobJobsRestClient;

        /// <summary> Initializes a new instance of the <see cref="DataBoxJobResourceExtension"/> class for mocking. </summary>
        protected DataBoxJobResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataBoxJobResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataBoxJobResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DataBoxJobResource> GetDataBoxJobsAsync(string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DataBoxJobResource(Client, DataBoxJobData.DeserializeDataBoxJobData(e)), DataBoxJobJobsClientDiagnostics, Pipeline, "DataBoxJobResourceExtension.GetDataBoxJobs", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DataBoxJobResource> GetDataBoxJobs(string skipToken = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DataBoxJobJobsRestClient.CreateListRequest(Id.SubscriptionId, skipToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DataBoxJobJobsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, skipToken);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DataBoxJobResource(Client, DataBoxJobData.DeserializeDataBoxJobData(e)), DataBoxJobJobsClientDiagnostics, Pipeline, "DataBoxJobResourceExtension.GetDataBoxJobs", "value", "nextLink", cancellationToken);
        }
    }
}
