...
namespace Azure.ResourceManager.DataBox.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class DataBoxSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataBoxSubscriptionResourceExtension"/> class for mocking. </summary>
        protected DataBoxSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataBoxSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataBoxSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DataBoxJobResource> GetDataBoxJobsAsync(string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DataBoxJobResource(Client, DataBoxJobData.DeserializeDataBoxJobData(e)), DataBoxJobJobsClientDiagnostics, Pipeline, "DataBoxSubscriptionResourceExtension.GetDataBoxJobs", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DataBoxJobResource> GetDataBoxJobs(string skipToken = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DataBoxJobJobsRestClient.CreateListRequest(Id.SubscriptionId, skipToken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DataBoxJobJobsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, skipToken);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DataBoxJobResource(Client, DataBoxJobData.DeserializeDataBoxJobData(e)), DataBoxJobJobsClientDiagnostics, Pipeline, "DataBoxSubscriptionResourceExtension.GetDataBoxJobs", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<AddressValidationOutput>> ValidateAddressAsync(AzureLocation location, DataBoxValidateAddressContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ServiceClientDiagnostics.CreateScope("DataBoxSubscriptionResourceExtension.ValidateAddress");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<DataBoxValidationResult>> ValidateInputsAsync(AzureLocation location, DataBoxValidationContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ServiceClientDiagnostics.CreateScope("DataBoxSubscriptionResourceExtension.ValidateInputs");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<RegionConfigurationResult>> GetRegionConfigurationAsync(AzureLocation location, RegionConfigurationContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ServiceClientDiagnostics.CreateScope("DataBoxSubscriptionResourceExtension.GetRegionConfiguration");
            scope.Start();
            try
            {
