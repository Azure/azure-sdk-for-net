...
{
    internal partial class JobResourcesGetCredentialsAsyncCollectionResultOfT : AsyncPageable<UnencryptedCredentials>
    {
        ...
        /// <returns> The pages of JobResourcesGetCredentialsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<UnencryptedCredentials>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<UnencryptedCredentials>.FromValues((IReadOnlyList<UnencryptedCredentials>)result.Value, nextPage?.AbsoluteUri, response);
