...
namespace Azure.ResourceManager.DataBox
{
    ...
    public partial class JobResourceData : TrackedResourceData
    {
        ...
        public JobResourceData(AzureLocation location, TransferType transferType, DataBoxSku sku) : base(location)
        {
            if (sku == null)
            {
