...
namespace Azure.ResourceManager.DataBox
{
    internal partial class DataBoxArmOperation<T> : ArmOperation<T>
    {
        ...
        internal DataBoxArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
