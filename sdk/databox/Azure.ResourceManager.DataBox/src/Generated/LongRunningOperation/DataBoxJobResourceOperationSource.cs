...
{
    /// <summary></summary>
    internal partial class DataBoxJobResourceOperationSource : IOperationSource<DataBoxJobResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataBoxJobResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
