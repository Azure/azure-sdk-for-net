...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public static partial class ArmDataBoxModelFactory
    {
        ...
        {
            return new DataBoxJobStage(stageName, displayName, stageStatus, stageTime, jobStageDetails, default);
        }
        ...
        {
            return new DeviceErasureDetails(deviceErasureStatus, erasureOrDestructionCertificateSasKey, default);
        }
        ...
        public static DataCenterAddressResult DataCenterAddressResult(IEnumerable<string> supportedCarriersForReturnShipment = null, AzureLocation? dataCenterAzureLocation = null)
        {
            ...
            return new UnknownDataCenterAddressResponse(default, supportedCarriersForReturnShipment?.ToList(), dataCenterAzureLocation, default);
        }
        ...
        public static MitigateJobContent MitigateJobContent(CustomerResolutionCode customerResolutionCode = default, IDictionary<string, CustomerResolutionCode> serialNumberCustomerResolutionMap = null)
        {
            ...
            return new MitigateJobContent(customerResolutionCode, serialNumberCustomerResolutionMap, default);
        }
        ...
        public static AvailableSkusContent AvailableSkusContent(DataBoxJobTransferType transferType = default, string country = null, AzureLocation location = default, IEnumerable<DataBoxSkuName> skuNames = null)
        {
            ...
            return new AvailableSkusContent(transferType, country, location, skuNames?.ToList(), default);
        }
        ...
        public static DataBoxSkuInformation DataBoxSkuInformation(DataBoxSku sku = null, bool? isEnabled = null, IEnumerable<DataLocationToServiceLocationMap> dataLocationToServiceLocationMap = null, DataBoxSkuCapacity capacity = null, IEnumerable<DataBoxSkuCost> costs = null, IEnumerable<string> apiVersions = null, SkuDisabledReason? disabledReason = null, string disabledReasonMessage = null, string requiredFeature = null, IEnumerable<string> countriesWithinCommerceBoundary = null)
        {
            ...
            return new DataBoxSkuInformation(sku, isEnabled, dataLocationToServiceLocationMap?.ToList(), capacity, costs?.ToList(), apiVersions?.ToList(), disabledReason, disabledReasonMessage, requiredFeature, countriesWithinCommerceBoundary?.ToList(), default);
        }
        ...
        {
            return new DataBoxSkuCapacity(usable, maximum, default);
        }
        ...
        {
            return new DataBoxValidateAddressContent(DataBoxValidationInputDiscriminator.ValidateAddress, shippingAddress, deviceType, transportPreferences, default);
        }
        ...
        public static AddressValidationResult AddressValidationResult(ResponseError error = null, AddressValidationStatus? validationStatus = null, IEnumerable<DataBoxShippingAddress> alternateAddresses = null)
        {
            ...
            return new AddressValidationResult(DataBoxValidationInputDiscriminator.ValidateAddress, error, validationStatus, alternateAddresses?.ToList(), default);
        }
        ...
        public static DataBoxValidationResult DataBoxValidationResult(OverallValidationStatus? status = null, IEnumerable<DataBoxValidationInputResult> individualResponseDetails = null)
        {
            ...
            return new DataBoxValidationResult(status, individualResponseDetails?.ToList(), default);
        }
        ...
        {
            return new Models.ScheduleAvailabilityContent(storageLocation, default, country, default);
        }
        ...
        public static DataBoxAccountCredentialDetails DataBoxAccountCredentialDetails(string accountName = null, DataAccountType? dataAccountType = null, string accountConnectionString = null, IEnumerable<ShareCredentialDetails> shareCredentialDetails = null)
        {
            ...
            return new DataBoxAccountCredentialDetails(accountName, dataAccountType, accountConnectionString, shareCredentialDetails?.ToList(), default);
        }
        ...
        public static ShareCredentialDetails ShareCredentialDetails(string shareName = null, ShareDestinationFormatType? shareType = null, string userName = null, string password = null, IEnumerable<DataBoxAccessProtocol> supportedAccessProtocols = null)
        {
            ...
            return new ShareCredentialDetails(shareName, shareType, userName, password, supportedAccessProtocols?.ToList(), default);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="DataBoxCustomerDiskCopyProgress"/>. </summary>
        ...
        {
            return new CreateOrderLimitForSubscriptionValidationContent(DataBoxValidationInputDiscriminator.ValidateCreateOrderLimit, deviceType, default);
        }
        ...
        {
            return new CreateOrderLimitForSubscriptionValidationResult(DataBoxValidationInputDiscriminator.ValidateCreateOrderLimit, error, status, default);
        }
        ...
        public static CustomerDiskJobSecrets CustomerDiskJobSecrets(DataCenterAccessSecurityCode dataCenterAccessSecurityCode = null, ResponseError error = null, IEnumerable<DataBoxDiskSecret> diskSecrets = null, string carrierAccountNumber = null)
        {
            ...
            return new CustomerDiskJobSecrets(DataBoxOrderType.DataBoxCustomerDisk, dataCenterAccessSecurityCode, error, diskSecrets?.ToList(), carrierAccountNumber, default);
        }
        ...
        public static DataCenterAddressInstructionResult DataCenterAddressInstructionResult(IEnumerable<string> supportedCarriersForReturnShipment = null, AzureLocation? dataCenterAzureLocation = null, string communicationInstruction = null)
        {
            ...
            return new DataCenterAddressInstructionResult(DataCenterAddressType.DataCenterAddressInstruction, supportedCarriersForReturnShipment?.ToList(), dataCenterAzureLocation, communicationInstruction, default);
        }
        ...
        public static DataCenterAddressLocationResult DataCenterAddressLocationResult(IEnumerable<string> supportedCarriersForReturnShipment = null, AzureLocation? dataCenterAzureLocation = null, string contactPersonName = null, string company = null, string street1 = null, string street2 = null, string street3 = null, string city = null, string state = null, string zip = null, string country = null, string phone = null, string phoneExtension = null, string addressType = null, string additionalShippingInformation = null)
        {
            ...
            return new DataCenterAddressLocationResult(DataCenterAddressType.DataCenterAddressLocation, supportedCarriersForReturnShipment?.ToList(), dataCenterAzureLocation, contactPersonName, company, street1, street2, street3, city, state, zip, country, phone, phoneExtension, addressType, additionalShippingInformation, default);
        }
        ...
        {
            return new DataBoxAccountCopyLogDetails(DataBoxOrderType.DataBox, accountName, copyLogLink, copyVerboseLogLink, default);
        }
        ...
        {
            return new DataBoxCustomerDiskCopyLogDetails(DataBoxOrderType.DataBoxCustomerDisk, serialNumber, errorLogLink, verboseLogLink, default);
        }
        ...
        {
            return new DataBoxDiskCopyLogDetails(DataBoxOrderType.DataBoxDisk, diskSerialNumber, errorLogLink, verboseLogLink, default);
        }
        ...
        {
            return new DataBoxDiskGranularCopyLogDetails(DataBoxOrderType.DataBoxCustomerDisk, serialNumber, accountId, errorLogLink, verboseLogLink, default);
        }
        ...
        public static DataBoxDiskCopyProgress DataBoxDiskCopyProgress(string serialNumber = null, long? bytesCopied = null, int? percentComplete = null, DataBoxCopyStatus? status = null, ResponseError error = null, IEnumerable<CustomerResolutionCode> actions = null)
        {
            ...
            return new DataBoxDiskCopyProgress(serialNumber, bytesCopied, percentComplete, status, error, actions?.ToList(), default);
        }
        ...
        public static DataBoxDiskJobSecrets DataBoxDiskJobSecrets(DataCenterAccessSecurityCode dataCenterAccessSecurityCode = null, ResponseError error = null, IEnumerable<DataBoxDiskSecret> diskSecrets = null, string passkey = null, bool? isPasskeyUserDefined = null)
        {
            ...
            return new DataBoxDiskJobSecrets(DataBoxOrderType.DataBoxDisk, dataCenterAccessSecurityCode, error, diskSecrets?.ToList(), passkey, isPasskeyUserDefined, default);
        }
        ...
        public static DataBoxHeavyAccountCopyLogDetails DataBoxHeavyAccountCopyLogDetails(string accountName = null, IEnumerable<string> copyLogLink = null, IEnumerable<string> copyVerboseLogLink = null)
        {
            ...
            return new DataBoxHeavyAccountCopyLogDetails(DataBoxOrderType.DataBoxHeavy, accountName, copyLogLink?.ToList(), copyVerboseLogLink?.ToList(), default);
        }
        ...
        public static DataBoxHeavyJobSecrets DataBoxHeavyJobSecrets(DataCenterAccessSecurityCode dataCenterAccessSecurityCode = null, ResponseError error = null, IEnumerable<DataBoxHeavySecret> cabinetPodSecrets = null)
        {
            ...
            return new DataBoxHeavyJobSecrets(DataBoxOrderType.DataBoxHeavy, dataCenterAccessSecurityCode, error, cabinetPodSecrets?.ToList(), default);
        }
        ...
        public static DataBoxHeavySecret DataBoxHeavySecret(string deviceSerialNumber = null, string devicePassword = null, IEnumerable<ApplianceNetworkConfiguration> networkConfigurations = null, string encodedValidationCertPubKey = null, IEnumerable<DataBoxAccountCredentialDetails> accountCredentialDetails = null)
        {
            ...
            return new DataBoxHeavySecret(deviceSerialNumber, devicePassword, networkConfigurations?.ToList(), encodedValidationCertPubKey, accountCredentialDetails?.ToList(), default);
        }
        ...
        public static DataboxJobSecrets DataboxJobSecrets(DataCenterAccessSecurityCode dataCenterAccessSecurityCode = null, ResponseError error = null, IEnumerable<DataBoxSecret> podSecrets = null)
        {
            ...
            return new DataboxJobSecrets(DataBoxOrderType.DataBox, dataCenterAccessSecurityCode, error, podSecrets?.ToList(), default);
        }
        ...
        public static DataBoxSecret DataBoxSecret(string deviceSerialNumber = null, string devicePassword = null, IEnumerable<ApplianceNetworkConfiguration> networkConfigurations = null, string encodedValidationCertPubKey = null, IEnumerable<DataBoxAccountCredentialDetails> accountCredentialDetails = null)
        {
            ...
            return new DataBoxSecret(deviceSerialNumber, devicePassword, networkConfigurations?.ToList(), encodedValidationCertPubKey, accountCredentialDetails?.ToList(), default);
        }
        ...
        {
            return new DataBoxScheduleAvailabilityContent(storageLocation, DataBoxSkuName.DataBox, country, default);
        }
        ...
        public static DataTransferDetailsValidationContent DataTransferDetailsValidationContent(IEnumerable<DataExportDetails> dataExportDetails = null, IEnumerable<DataImportDetails> dataImportDetails = null, DataBoxSkuName deviceType = default, DataBoxJobTransferType transferType = default)
        {
            ...
            return new DataTransferDetailsValidationContent(DataBoxValidationInputDiscriminator.ValidateDataTransferDetails, dataExportDetails?.ToList(), dataImportDetails?.ToList(), deviceType, transferType, default);
        }
        ...
        {
            return new DataTransferDetailsValidationResult(DataBoxValidationInputDiscriminator.ValidateDataTransferDetails, error, status, default);
        }
        ...
        {
            return new DiskScheduleAvailabilityContent(storageLocation, DataBoxSkuName.DataBoxDisk, country, expectedDataSizeInTerabytes, default);
        }
        ...
        {
            return new HeavyScheduleAvailabilityContent(storageLocation, DataBoxSkuName.DataBoxHeavy, country, default);
        }
        ...
        {
            return new PreferencesValidationContent(DataBoxValidationInputDiscriminator.ValidatePreferences, preference, deviceType, default);
        }
        ...
        {
            return new PreferencesValidationResult(DataBoxValidationInputDiscriminator.ValidatePreferences, error, status, default);
        }
        ...
        {
            return new SkuAvailabilityValidationContent(DataBoxValidationInputDiscriminator.ValidateSkuAvailability, deviceType, transferType, country, location, default);
        }
        ...
        {
            return new SkuAvailabilityValidationResult(DataBoxValidationInputDiscriminator.ValidateSkuAvailability, error, status, default);
        }
        ...
        {
            return new SubscriptionIsAllowedToCreateJobValidationResult(DataBoxValidationInputDiscriminator.ValidateSubscriptionIsAllowedToCreateJob, error, status, default);
        }
    }
}
