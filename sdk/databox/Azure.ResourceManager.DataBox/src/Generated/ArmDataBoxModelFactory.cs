...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public static partial class ArmDataBoxModelFactory
    {
        ...
        public static DataBoxKeyEncryptionKey DataBoxKeyEncryptionKey(DataBoxKeyEncryptionKeyType kekType = default, string identityType = default, Uri kekUri = default, ResourceIdentifier kekVaultResourceId = default)
        {
            return new DataBoxKeyEncryptionKey(kekType, identityType is null ? default : new DataBoxManagedIdentity(identityType, default, default), kekUri, kekVaultResourceId, default);
        }
        ...
        public static DataBoxKeyEncryptionKey DataBoxKeyEncryptionKey(DataBoxKeyEncryptionKeyType kekType = 0, DataBoxManagedIdentity managedIdentity = default, Uri kekUri = default, ResourceIdentifier kekVaultResourceId = default)
        {
