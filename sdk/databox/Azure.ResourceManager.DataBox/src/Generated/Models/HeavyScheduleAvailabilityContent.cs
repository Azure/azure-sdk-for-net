...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class HeavyScheduleAvailabilityContent : ScheduleAvailabilityContent
    {
        ...
        internal HeavyScheduleAvailabilityContent(AzureLocation storageLocation, DataBoxSkuName skuName, string country, ModelName? model, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(storageLocation, skuName, country, model, serializedAdditionalRawData)
        {
            SkuName = skuName;
        }
