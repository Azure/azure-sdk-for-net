...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class HeavyScheduleAvailabilityContent : ScheduleAvailabilityContent
    {
        ...
        public HeavyScheduleAvailabilityContent(AzureLocation storageLocation) : base(storageLocation, DataBoxSkuName.DataBoxHeavy)
        {
        }
        ...
        internal HeavyScheduleAvailabilityContent(AzureLocation storageLocation, DataBoxSkuName skuName, string country, DeviceModelName? model, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(storageLocation, skuName, country, model, additionalBinaryDataProperties)
        {
        }
    }
}
