...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class HeavyScheduleAvailabilityContent : ScheduleAvailabilityContent
    {
        ...
        internal HeavyScheduleAvailabilityContent(AzureLocation storageLocation, DataBoxSkuName skuName, string country, Dictionary<string, BinaryData> rawData) : base(storageLocation, skuName, country, rawData)
        {
            SkuName = skuName;
        }
