...
{
    public partial class DataBoxDiskCopyLogDetails : IUtf8JsonSerializable, IJsonModel<DataBoxDiskCopyLogDetails>, IPersistableModel<DataBoxDiskCopyLogDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  diskSerialNumber:");
                builder.AppendLine($" '{DiskSerialNumber}'");
            }
