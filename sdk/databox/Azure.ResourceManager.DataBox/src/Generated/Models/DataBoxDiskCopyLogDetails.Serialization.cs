...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxDiskCopyLogDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxDiskCopyLogDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxDiskCopyLogDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataBoxDiskCopyLogDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
