...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxDiskCopyLogDetails : CopyLogDetails
    {
        ...
        internal DataBoxDiskCopyLogDetails(DataBoxOrderType copyLogDetailsType, string diskSerialNumber, string errorLogLink, string verboseLogLink, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(copyLogDetailsType, serializedAdditionalRawData)
        {
