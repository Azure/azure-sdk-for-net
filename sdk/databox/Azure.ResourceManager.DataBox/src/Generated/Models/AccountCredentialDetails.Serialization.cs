...
namespace Azure.ResourceManager.DataBox.Models
{
    public partial class AccountCredentialDetails
    {
        internal static AccountCredentialDetails DeserializeAccountCredentialDetails(JsonElement element)
        {
            ...
            return new AccountCredentialDetails(accountName.Value, Optional.ToNullable(dataAccountType), accountConnectionString.Value, Optional.ToList(shareCredentialDetails));
        }
    }
}
