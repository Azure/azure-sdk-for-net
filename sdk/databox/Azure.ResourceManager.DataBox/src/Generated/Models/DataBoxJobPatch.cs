...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxJobPatch
    {
        ...
        internal DataBoxJobPatch(IDictionary<string, string> tags, ManagedServiceIdentity identity, UpdateJobDetails details, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
            Identity = identity;
            Details = details;
