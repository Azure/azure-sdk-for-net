...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureFileFilterDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureFileFilterDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureFileFilterDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureFileFilterDetails>)} interface");
            }
        ...
        string IPersistableModel<AzureFileFilterDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
