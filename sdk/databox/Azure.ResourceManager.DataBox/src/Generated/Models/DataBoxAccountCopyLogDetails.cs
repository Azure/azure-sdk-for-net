...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxAccountCopyLogDetails : CopyLogDetails
    {
        ...
        internal DataBoxAccountCopyLogDetails(DataBoxOrderType copyLogDetailsType, string accountName, string copyLogLink, string copyVerboseLogLink, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(copyLogDetailsType, serializedAdditionalRawData)
        {
