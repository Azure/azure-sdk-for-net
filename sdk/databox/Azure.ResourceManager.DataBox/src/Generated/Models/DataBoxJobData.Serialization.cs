    ...
    public partial class DataBoxJobData : IUtf8JsonSerializable, IJsonModel<DataBoxJobData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TransferType))
            {
                ...
                builder.AppendLine($" '{TransferType.ToSerialString()}'");
            }
            ...
            if (Optional.IsDefined(ReverseShippingDetailsUpdate))
            {
                ...
                builder.AppendLine($" '{ReverseShippingDetailsUpdate.Value.ToSerialString()}'");
            }

            if (Optional.IsDefined(ReverseTransportPreferenceUpdate))
            {
                builder.Append("    reverseTransportPreferenceUpdate:");
                builder.AppendLine($" '{ReverseTransportPreferenceUpdate.Value.ToSerialString()}'");
            }
            ...
            if (Optional.IsDefined(DeliveryType))
            {
                ...
                builder.AppendLine($" '{DeliveryType.Value.ToSerialString()}'");
            }
