...
namespace Azure.ResourceManager.DataBox
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxJobData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxJobData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxJobData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxJobData>)} interface");
            }
        ...
        string IPersistableModel<DataBoxJobData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
