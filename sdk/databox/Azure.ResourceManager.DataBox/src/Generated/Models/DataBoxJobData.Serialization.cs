...
{
    public partial class DataBoxJobData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DataBoxJobData DeserializeDataBoxJobData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
