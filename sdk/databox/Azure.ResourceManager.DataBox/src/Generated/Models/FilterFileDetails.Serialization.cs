...
{
    public partial class FilterFileDetails : IUtf8JsonSerializable, IJsonModel<FilterFileDetails>, IPersistableModel<FilterFileDetails>
    {
        ...
        void IJsonModel<FilterFileDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FilterFileDetails)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FilterFileType))
            {
                builder.Append("  filterFileType:");
                builder.AppendLine($" '{FilterFileType.ToString()}'");
            }

            if (Optional.IsDefined(FilterFilePath))
            {
                builder.Append("  filterFilePath:");
                builder.AppendLine($" '{FilterFilePath}'");
            }
        ...
        BinaryData IPersistableModel<FilterFileDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FilterFileDetails)} does not support '{options.Format}' format.");
            }
        }
