...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FilterFileDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FilterFileDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FilterFileDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FilterFileDetails>)} interface");
            }
        ...
        string IPersistableModel<FilterFileDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
