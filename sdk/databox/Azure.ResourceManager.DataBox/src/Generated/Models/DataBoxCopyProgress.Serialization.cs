...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxCopyProgress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxCopyProgress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxCopyProgress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxCopyProgress>)} interface");
            }
        ...
        string IPersistableModel<DataBoxCopyProgress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
