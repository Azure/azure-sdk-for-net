...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        internal static ApplianceNetworkConfiguration DeserializeApplianceNetworkConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
