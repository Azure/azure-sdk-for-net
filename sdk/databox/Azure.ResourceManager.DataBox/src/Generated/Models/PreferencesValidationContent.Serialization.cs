...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PreferencesValidationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PreferencesValidationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PreferencesValidationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PreferencesValidationContent>)} interface");
            }
        ...
        string IPersistableModel<PreferencesValidationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
