...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransportAvailabilityRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TransportAvailabilityRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TransportAvailabilityRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TransportAvailabilityRequest>)} interface");
            }
        ...
        string IPersistableModel<TransportAvailabilityRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
