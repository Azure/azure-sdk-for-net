...
{
    internal partial class TransferConfigurationTransferFilterDetails : IUtf8JsonSerializable, IJsonModel<TransferConfigurationTransferFilterDetails>, IPersistableModel<TransferConfigurationTransferFilterDetails>
    {
        ...
        void IJsonModel<TransferConfigurationTransferFilterDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TransferConfigurationTransferFilterDetails)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Include))
            {
                ...
                AppendChildObject(builder, Include, options, 2);
            }
