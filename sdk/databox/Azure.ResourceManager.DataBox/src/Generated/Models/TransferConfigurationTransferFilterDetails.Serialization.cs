...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransferConfigurationTransferFilterDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TransferConfigurationTransferFilterDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TransferConfigurationTransferFilterDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TransferConfigurationTransferFilterDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
