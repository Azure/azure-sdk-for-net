...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxDiskGranularCopyProgress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxDiskGranularCopyProgress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxDiskGranularCopyProgress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxDiskGranularCopyProgress>)} interface");
            }
        ...
        string IPersistableModel<DataBoxDiskGranularCopyProgress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
