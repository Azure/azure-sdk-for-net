...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        internal static TransportAvailabilityDetails DeserializeTransportAvailabilityDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
