...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class PreferencesValidationResult : DataBoxValidationInputResult
    {
        ...
        internal PreferencesValidationResult() : base(DataBoxValidationInputDiscriminator.ValidatePreferences)
        {
        }
        ...
        internal PreferencesValidationResult(DataBoxValidationInputDiscriminator validationType, ResponseError error, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataBoxValidationStatus? status) : base(validationType, error, additionalBinaryDataProperties)
        {
            Status = status;
        }
