...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class PreferencesValidationResult : DataBoxValidationInputResult
    {
        ...
        internal PreferencesValidationResult(DataBoxValidationInputDiscriminator validationType, ResponseError error, DataBoxValidationStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(validationType, error, serializedAdditionalRawData)
        {
            Status = status;
