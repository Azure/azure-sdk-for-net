...
{
    internal partial class UnknownGranularCopyLogDetails : IUtf8JsonSerializable, IJsonModel<GranularCopyLogDetails>
    {
        ...
        void IJsonModel<GranularCopyLogDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GranularCopyLogDetails)} does not support '{format}' format.");
            }
        ...
        internal static UnknownGranularCopyLogDetails DeserializeUnknownGranularCopyLogDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownGranularCopyLogDetails(copyLogDetailsType, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<GranularCopyLogDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GranularCopyLogDetails)} does not support '{options.Format}' format.");
            }
        }
