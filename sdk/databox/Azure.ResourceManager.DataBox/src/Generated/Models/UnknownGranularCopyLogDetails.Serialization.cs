...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        internal static UnknownGranularCopyLogDetails DeserializeUnknownGranularCopyLogDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
