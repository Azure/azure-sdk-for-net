...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LastMitigationActionOnJob>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LastMitigationActionOnJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LastMitigationActionOnJob>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LastMitigationActionOnJob>)} interface");
            }
        ...
        string IPersistableModel<LastMitigationActionOnJob>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
