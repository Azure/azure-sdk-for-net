...
{
    public partial class LastMitigationActionOnJob : IUtf8JsonSerializable, IJsonModel<LastMitigationActionOnJob>, IPersistableModel<LastMitigationActionOnJob>
    {
        ...
        void IJsonModel<LastMitigationActionOnJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LastMitigationActionOnJob)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActionPerformedOn))
            {
                builder.Append("  actionDateTimeInUtc:");
                builder.AppendLine($" '{ActionPerformedOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(IsPerformedByCustomer))
            {
                builder.Append("  isPerformedByCustomer:");
                var boolValue = IsPerformedByCustomer.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(CustomerResolution))
            {
                builder.Append("  customerResolution:");
                builder.AppendLine($" '{CustomerResolution.ToString()}'");
            }
