...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PackageCarrierDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PackageCarrierDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PackageCarrierDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PackageCarrierDetails>)} interface");
            }
        ...
        string IPersistableModel<PackageCarrierDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
