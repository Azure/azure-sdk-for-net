...
namespace Azure.ResourceManager.DataBox.Models
{
    public partial class PackageCarrierDetails : IUtf8JsonSerializable, IModelJsonSerializable<PackageCarrierDetails>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PackageCarrierDetails>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="PackageCarrierDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PackageCarrierDetails"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PackageCarrierDetails"/>. </summary>
