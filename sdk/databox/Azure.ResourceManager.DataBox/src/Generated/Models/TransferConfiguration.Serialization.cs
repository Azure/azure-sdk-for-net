    ...
    public partial class TransferConfiguration : IUtf8JsonSerializable, IJsonModel<TransferConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TransferConfigurationType))
            {
                ...
                builder.AppendLine($" '{TransferConfigurationType.ToSerialString()}'");
            }

            if (Optional.IsDefined(TransferFilterDetails))
            {
                builder.Append("  transferFilterDetails:");
                AppendChildObject(builder, TransferFilterDetails, options, 2, false);
            }

            if (Optional.IsDefined(TransferAllDetails))
            {
                builder.Append("  transferAllDetails:");
                AppendChildObject(builder, TransferAllDetails, options, 2, false);
            }
