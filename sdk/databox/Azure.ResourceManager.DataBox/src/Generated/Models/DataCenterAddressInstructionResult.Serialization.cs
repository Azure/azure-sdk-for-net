...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataCenterAddressInstructionResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataCenterAddressInstructionResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataCenterAddressInstructionResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataCenterAddressInstructionResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
