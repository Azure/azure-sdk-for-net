...
{
    public partial class TransferFilterDetails : IUtf8JsonSerializable, IJsonModel<TransferFilterDetails>, IPersistableModel<TransferFilterDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BlobFilterDetails))
            {
                builder.Append("  blobFilterDetails:");
                AppendChildObject(builder, BlobFilterDetails, options, 2);
            }

            if (Optional.IsDefined(AzureFileFilterDetails))
            {
                builder.Append("  azureFileFilterDetails:");
                AppendChildObject(builder, AzureFileFilterDetails, options, 2);
            }

            if (Optional.IsCollectionDefined(FilterFileDetails))
            {
                builder.Append("  filterFileDetails:");
                builder.AppendLine(" [");
                foreach (var item in FilterFileDetails)
                {
