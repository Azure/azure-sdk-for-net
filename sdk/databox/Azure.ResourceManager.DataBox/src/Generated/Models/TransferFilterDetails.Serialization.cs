...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransferFilterDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TransferFilterDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TransferFilterDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TransferFilterDetails>)} interface");
            }
        ...
        string IPersistableModel<TransferFilterDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
