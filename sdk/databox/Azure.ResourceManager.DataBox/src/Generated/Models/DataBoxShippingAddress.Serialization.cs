...
namespace Azure.ResourceManager.DataBox.Models
{
    public partial class DataBoxShippingAddress : IUtf8JsonSerializable, IModelJsonSerializable<DataBoxShippingAddress>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DataBoxShippingAddress>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="DataBoxShippingAddress"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DataBoxShippingAddress"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DataBoxShippingAddress"/>. </summary>
