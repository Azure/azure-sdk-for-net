...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxShippingAddress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxShippingAddress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxShippingAddress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxShippingAddress>)} interface");
            }
        ...
        string IPersistableModel<DataBoxShippingAddress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
