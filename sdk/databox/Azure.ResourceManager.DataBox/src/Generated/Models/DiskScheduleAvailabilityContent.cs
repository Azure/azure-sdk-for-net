...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DiskScheduleAvailabilityContent : ScheduleAvailabilityContent
    {
        ...
        internal DiskScheduleAvailabilityContent(AzureLocation storageLocation, DataBoxSkuName skuName, string country, int expectedDataSizeInTerabytes, Dictionary<string, BinaryData> rawData) : base(storageLocation, skuName, country, rawData)
        {
            ExpectedDataSizeInTerabytes = expectedDataSizeInTerabytes;
            SkuName = skuName;
        }
