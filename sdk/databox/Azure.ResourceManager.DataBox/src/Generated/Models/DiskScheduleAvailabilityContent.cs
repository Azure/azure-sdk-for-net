...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DiskScheduleAvailabilityContent : ScheduleAvailabilityContent
    {
        ...
        internal DiskScheduleAvailabilityContent(AzureLocation storageLocation, DataBoxSkuName skuName, string country, int expectedDataSizeInTerabytes, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(storageLocation, skuName, country, serializedAdditionalRawData)
        {
            ExpectedDataSizeInTerabytes = expectedDataSizeInTerabytes;
            SkuName = skuName;
        }
