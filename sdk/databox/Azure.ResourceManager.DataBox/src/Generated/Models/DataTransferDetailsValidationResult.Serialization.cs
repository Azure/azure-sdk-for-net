...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataTransferDetailsValidationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataTransferDetailsValidationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataTransferDetailsValidationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataTransferDetailsValidationResult>)} interface");
            }
        ...
        string IPersistableModel<DataTransferDetailsValidationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
