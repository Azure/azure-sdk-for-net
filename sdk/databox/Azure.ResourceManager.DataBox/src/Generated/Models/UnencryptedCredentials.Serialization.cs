...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnencryptedCredentials>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UnencryptedCredentials>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UnencryptedCredentials>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<UnencryptedCredentials>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
