...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxHeavySecret
    {
        ...
        internal DataBoxHeavySecret(string deviceSerialNumber, string devicePassword, IReadOnlyList<ApplianceNetworkConfiguration> networkConfigurations, string encodedValidationCertPubKey, IReadOnlyList<DataBoxAccountCredentialDetails> accountCredentialDetails, Dictionary<string, BinaryData> rawData)
        {
