...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxDiskGranularCopyLogDetails : GranularCopyLogDetails
    {
        ...
        internal DataBoxDiskGranularCopyLogDetails(DataBoxOrderType copyLogDetailsType, string serialNumber, ResourceIdentifier accountId, string errorLogLink, string verboseLogLink, Dictionary<string, BinaryData> rawData) : base(copyLogDetailsType, rawData)
        {
