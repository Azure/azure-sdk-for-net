...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AvailableSkuContent. </summary>
        ...
        public AvailableSkuContent(TransferType transferType, string country, AzureLocation location)
        {
            if (country == null)
            {
