...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataImportDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataImportDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataImportDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataImportDetails>)} interface");
            }
        ...
        string IPersistableModel<DataImportDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
