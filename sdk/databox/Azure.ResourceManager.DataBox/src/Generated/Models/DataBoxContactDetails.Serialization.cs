...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxContactDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxContactDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxContactDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxContactDetails>)} interface");
            }
        ...
        string IPersistableModel<DataBoxContactDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
