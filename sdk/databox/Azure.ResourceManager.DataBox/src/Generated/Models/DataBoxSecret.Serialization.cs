...
namespace Azure.ResourceManager.DataBox.Models
{
    public partial class DataBoxSecret
    {
        internal static DataBoxSecret DeserializeDataBoxSecret(JsonElement element)
        {
            ...
            return new DataBoxSecret(deviceSerialNumber.Value, devicePassword.Value, Core.Optional.ToList(networkConfigurations), encodedValidationCertPubKey.Value, Core.Optional.ToList(accountCredentialDetails));
        }
    }
}
