...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxManagedIdentity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxManagedIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxManagedIdentity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxManagedIdentity>)} interface");
            }
        ...
        string IPersistableModel<DataBoxManagedIdentity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
