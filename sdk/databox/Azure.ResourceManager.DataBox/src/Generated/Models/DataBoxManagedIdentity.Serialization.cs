...
{
    public partial class DataBoxManagedIdentity : IUtf8JsonSerializable, IJsonModel<DataBoxManagedIdentity>, IPersistableModel<DataBoxManagedIdentity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{IdentityType}'");
            }

            if (Optional.IsDefined(UserAssigned))
            {
                builder.Append("  userAssigned:");
                AppendChildObject(builder, UserAssigned, options, 2);
            }
