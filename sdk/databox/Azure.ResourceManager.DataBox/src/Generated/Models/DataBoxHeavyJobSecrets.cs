...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxHeavyJobSecrets : JobSecrets
    {
        ...
        internal DataBoxHeavyJobSecrets(DataBoxOrderType jobSecretsType, DataCenterAccessSecurityCode dataCenterAccessSecurityCode, ResponseError error, IReadOnlyList<DataBoxHeavySecret> cabinetPodSecrets, Dictionary<string, BinaryData> rawData) : base(jobSecretsType, dataCenterAccessSecurityCode, error, rawData)
        {
