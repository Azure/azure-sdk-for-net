...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxStorageAccountDetails : DataAccountDetails
    {
        ...
        internal DataBoxStorageAccountDetails(DataAccountType dataAccountType, string sharePassword, ResourceIdentifier storageAccountId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(dataAccountType, sharePassword, serializedAdditionalRawData)
        {
            StorageAccountId = storageAccountId;
