...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PackageCarrierInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PackageCarrierInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PackageCarrierInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PackageCarrierInfo>)} interface");
            }
        ...
        string IPersistableModel<PackageCarrierInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
