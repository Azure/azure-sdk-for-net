...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class CreateOrderLimitForSubscriptionValidationResult : DataBoxValidationInputResult
    {
        ...
        internal CreateOrderLimitForSubscriptionValidationResult(DataBoxValidationInputDiscriminator validationType, ResponseError error, DataBoxValidationStatus? status, Dictionary<string, BinaryData> rawData) : base(validationType, error, rawData)
        {
            Status = status;
