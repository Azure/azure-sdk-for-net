...
namespace Azure.ResourceManager.DataBox.Models
{
    internal partial class UnknownScheduleAvailabilityRequest : ScheduleAvailabilityContent
    {
        ...
        internal UnknownScheduleAvailabilityRequest(AzureLocation storageLocation, DataBoxSkuName skuName, string country, DeviceModelName? model, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(storageLocation, skuName, country, model, additionalBinaryDataProperties)
        {
        }
    }
}
