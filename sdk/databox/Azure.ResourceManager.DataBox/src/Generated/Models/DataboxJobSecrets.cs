...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataboxJobSecrets : JobSecrets
    {
        ...
        internal DataboxJobSecrets(DataBoxOrderType jobSecretsType, DataCenterAccessSecurityCode dataCenterAccessSecurityCode, ResponseError error, IReadOnlyList<DataBoxSecret> podSecrets, Dictionary<string, BinaryData> rawData) : base(jobSecretsType, dataCenterAccessSecurityCode, error, rawData)
        {
