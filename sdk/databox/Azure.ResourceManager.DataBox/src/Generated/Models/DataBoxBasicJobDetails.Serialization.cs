...
{
    public partial class DataBoxBasicJobDetails : IUtf8JsonSerializable, IModelJsonSerializable<DataBoxBasicJobDetails>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DataBoxBasicJobDetails>(this, options.Format);
        ...
        internal static DataBoxBasicJobDetails DeserializeDataBoxBasicJobDetails(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        /// <summary> Converts a <see cref="DataBoxBasicJobDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DataBoxBasicJobDetails"/> to convert. </param>
        public static implicit operator RequestContent(DataBoxBasicJobDetails model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DataBoxBasicJobDetails"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator DataBoxBasicJobDetails(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeDataBoxBasicJobDetails(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
