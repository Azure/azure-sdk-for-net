...
{
    internal partial class UnencryptedCredentialsList : IUtf8JsonSerializable, IJsonModel<UnencryptedCredentialsList>, IPersistableModel<UnencryptedCredentialsList>
    {
        ...
        void IJsonModel<UnencryptedCredentialsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UnencryptedCredentialsList)} does not support '{format}' format.");
            }
