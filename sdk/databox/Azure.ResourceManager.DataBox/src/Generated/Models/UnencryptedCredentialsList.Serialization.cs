...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnencryptedCredentialsList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UnencryptedCredentialsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UnencryptedCredentialsList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UnencryptedCredentialsList>)} interface");
            }
        ...
        string IPersistableModel<UnencryptedCredentialsList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
