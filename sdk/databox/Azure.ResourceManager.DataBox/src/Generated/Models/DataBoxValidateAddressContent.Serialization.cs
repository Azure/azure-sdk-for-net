...
namespace Azure.ResourceManager.DataBox.Models
{
    public partial class DataBoxValidateAddressContent : IUtf8JsonSerializable, IModelJsonSerializable<DataBoxValidateAddressContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DataBoxValidateAddressContent>(this, options.Format);
        ...
        internal static DataBoxValidateAddressContent DeserializeDataBoxValidateAddressContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DataBoxValidateAddressContent(validationType, shippingAddress, deviceType, transportPreferences.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="DataBoxValidateAddressContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DataBoxValidateAddressContent"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DataBoxValidateAddressContent"/>. </summary>
