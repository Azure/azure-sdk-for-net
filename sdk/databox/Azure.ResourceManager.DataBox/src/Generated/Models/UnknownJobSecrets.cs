...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    internal partial class UnknownJobSecrets : JobSecrets
    {
        ...
        internal UnknownJobSecrets(DataBoxOrderType jobSecretsType, DataCenterAccessSecurityCode dataCenterAccessSecurityCode, ResponseError error, Dictionary<string, BinaryData> rawData) : base(jobSecretsType, dataCenterAccessSecurityCode, error, rawData)
        {
