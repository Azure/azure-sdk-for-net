...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxCustomerDiskCopyProgress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxCustomerDiskCopyProgress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxCustomerDiskCopyProgress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxCustomerDiskCopyProgress>)} interface");
            }
        ...
        string IPersistableModel<DataBoxCustomerDiskCopyProgress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
