...
{
    public partial class DataBoxCustomerDiskCopyProgress : IUtf8JsonSerializable, IJsonModel<DataBoxCustomerDiskCopyProgress>, IPersistableModel<DataBoxCustomerDiskCopyProgress>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CopyStatus))
            {
                ...
                builder.AppendLine($" '{CopyStatus.ToString()}'");
            }
            ...
            if (Optional.IsDefined(TransferType))
            {
                ...
                builder.AppendLine($" '{TransferType.ToString()}'");
            }
