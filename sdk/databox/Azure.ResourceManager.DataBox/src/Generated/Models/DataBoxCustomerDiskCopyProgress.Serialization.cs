...
namespace Azure.ResourceManager.DataBox.Models
{
    public partial class DataBoxCustomerDiskCopyProgress
    {
        internal static DataBoxCustomerDiskCopyProgress DeserializeDataBoxCustomerDiskCopyProgress(JsonElement element)
        {
            ...
            Core.Optional<DataBoxCopyStatus> copyStatus = default;
            ...
            return new DataBoxCustomerDiskCopyProgress(storageAccountName.Value, Core.Optional.ToNullable(transferType), Core.Optional.ToNullable(dataAccountType), accountId.Value, Core.Optional.ToNullable(bytesProcessed), Core.Optional.ToNullable(totalBytesToProcess), Core.Optional.ToNullable(filesProcessed), Core.Optional.ToNullable(totalFilesToProcess), Core.Optional.ToNullable(invalidFilesProcessed), Core.Optional.ToNullable(invalidFileBytesUploaded), Core.Optional.ToNullable(renamedContainerCount), Core.Optional.ToNullable(filesErroredOut), Core.Optional.ToNullable(directoriesErroredOut), Core.Optional.ToNullable(invalidDirectoriesProcessed), Core.Optional.ToNullable(isEnumerationInProgress), error.Value, Core.Optional.ToList(actions), serialNumber.Value, Core.Optional.ToNullable(copyStatus));
        }
    }
}
