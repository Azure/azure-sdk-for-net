...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxCustomerDiskCopyLogDetails : CopyLogDetails
    {
        ...
        internal DataBoxCustomerDiskCopyLogDetails(DataBoxOrderType copyLogDetailsType, string serialNumber, string errorLogLink, string verboseLogLink, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(copyLogDetailsType, serializedAdditionalRawData)
        {
