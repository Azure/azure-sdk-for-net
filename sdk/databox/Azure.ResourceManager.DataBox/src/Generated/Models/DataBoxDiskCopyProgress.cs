...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxDiskCopyProgress
    {
        ...
        internal DataBoxDiskCopyProgress(string serialNumber, long? bytesCopied, int? percentComplete, DataBoxCopyStatus? status, ResponseError error, IReadOnlyList<CustomerResolutionCode> actions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
