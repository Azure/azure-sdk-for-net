...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class ManagedDiskDetails : DataAccountDetails
    {
        ...
        internal ManagedDiskDetails(DataAccountType dataAccountType, string sharePassword, ResourceIdentifier resourceGroupId, ResourceIdentifier stagingStorageAccountId, Dictionary<string, BinaryData> rawData) : base(dataAccountType, sharePassword, rawData)
        {
            ResourceGroupId = resourceGroupId;
            StagingStorageAccountId = stagingStorageAccountId;
