...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    internal partial class UnknownScheduleAvailabilityContent : ScheduleAvailabilityContent
    {
        ...
        internal UnknownScheduleAvailabilityContent(AzureLocation storageLocation, DataBoxSkuName skuName, string country, DeviceModelName? model, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(storageLocation, skuName, country, model, serializedAdditionalRawData)
        {
            SkuName = skuName;
        }
