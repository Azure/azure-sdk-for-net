...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class TransportPreferences : IJsonModel<TransportPreferences>
    {
        ...
        internal static TransportPreferences DeserializeTransportPreferences(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    preferredShipmentType = prop.Value.GetString().ToTransportShipmentType();
                    continue;
                }
            ...
            return new TransportPreferences(preferredShipmentType, isUpdated, additionalBinaryDataProperties);
        }
