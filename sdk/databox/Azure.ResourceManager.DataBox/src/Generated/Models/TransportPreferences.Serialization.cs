...
{
    public partial class TransportPreferences : IUtf8JsonSerializable, IJsonModel<TransportPreferences>, IPersistableModel<TransportPreferences>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PreferredShipmentType))
            {
                ...
                builder.AppendLine($" '{PreferredShipmentType.ToString()}'");
            }
