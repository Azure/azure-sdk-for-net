...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransportPreferences>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TransportPreferences>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TransportPreferences>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TransportPreferences>)} interface");
            }
        ...
        string IPersistableModel<TransportPreferences>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
