...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubscriptionIsAllowedToCreateJobValidationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SubscriptionIsAllowedToCreateJobValidationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SubscriptionIsAllowedToCreateJobValidationContent>)} interface");
            }
        ...
        string IPersistableModel<SubscriptionIsAllowedToCreateJobValidationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
