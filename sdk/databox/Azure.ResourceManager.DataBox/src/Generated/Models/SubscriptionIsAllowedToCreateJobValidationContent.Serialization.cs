...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class SubscriptionIsAllowedToCreateJobValidationContent : DataBoxValidationInputContent, IJsonModel<SubscriptionIsAllowedToCreateJobValidationContent>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SubscriptionIsAllowedToCreateJobValidationContent IJsonModel<SubscriptionIsAllowedToCreateJobValidationContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SubscriptionIsAllowedToCreateJobValidationContent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SubscriptionIsAllowedToCreateJobValidationContent DeserializeSubscriptionIsAllowedToCreateJobValidationContent(JsonElement element, ModelReaderWriterOptions options)
        {
