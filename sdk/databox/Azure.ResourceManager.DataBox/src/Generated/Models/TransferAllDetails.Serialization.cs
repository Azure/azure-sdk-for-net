...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransferAllDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TransferAllDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TransferAllDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TransferAllDetails>)} interface");
            }
        ...
        string IPersistableModel<TransferAllDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
