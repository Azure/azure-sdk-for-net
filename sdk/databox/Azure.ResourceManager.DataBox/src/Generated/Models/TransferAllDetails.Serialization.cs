...
{
    public partial class TransferAllDetails : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TransferAllDetails DeserializeTransferAllDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
