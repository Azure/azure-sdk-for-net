...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GranularCopyProgress>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GranularCopyProgress>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GranularCopyProgress>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GranularCopyProgress>)} interface");
            }
        ...
        string IPersistableModel<GranularCopyProgress>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
