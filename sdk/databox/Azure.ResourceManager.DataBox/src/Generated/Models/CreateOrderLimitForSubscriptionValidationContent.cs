...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class CreateOrderLimitForSubscriptionValidationContent : DataBoxValidationInputContent
    {
        ...
        internal CreateOrderLimitForSubscriptionValidationContent(DataBoxValidationInputDiscriminator validationType, DataBoxSkuName deviceType, Dictionary<string, BinaryData> rawData) : base(validationType, rawData)
        {
            DeviceType = deviceType;
