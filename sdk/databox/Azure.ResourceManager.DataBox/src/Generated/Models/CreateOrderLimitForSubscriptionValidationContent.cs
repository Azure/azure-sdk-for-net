...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class CreateOrderLimitForSubscriptionValidationContent : DataBoxValidationInputContent
    {
        ...
        internal CreateOrderLimitForSubscriptionValidationContent(DataBoxValidationInputDiscriminator validationType, DataBoxSkuName deviceType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(validationType, serializedAdditionalRawData)
        {
            DeviceType = deviceType;
