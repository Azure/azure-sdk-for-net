...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class CreateOrderLimitForSubscriptionValidationContent : DataBoxValidationInputContent
    {
        ...
        public CreateOrderLimitForSubscriptionValidationContent(DataBoxSkuName deviceType) : base(DataBoxValidationInputDiscriminator.ValidateCreateOrderLimit)
        {
        ...
        internal CreateOrderLimitForSubscriptionValidationContent(DataBoxValidationInputDiscriminator validationType, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataBoxSkuName deviceType, DeviceModelName? model) : base(validationType, additionalBinaryDataProperties)
        {
            DeviceType = deviceType;
            Model = model;
        }
