...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        internal static UnknownValidationInputResponse DeserializeUnknownValidationInputResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
