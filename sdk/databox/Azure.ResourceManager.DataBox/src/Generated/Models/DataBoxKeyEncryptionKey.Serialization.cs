...
{
    public partial class DataBoxKeyEncryptionKey : IUtf8JsonSerializable, IJsonModel<DataBoxKeyEncryptionKey>, IPersistableModel<DataBoxKeyEncryptionKey>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KekType))
            {
                builder.Append("  kekType:");
                builder.AppendLine($" '{KekType.ToString()}'");
            }

            if (Optional.IsDefined(ManagedIdentity))
            {
                builder.Append("  identityProperties:");
                AppendChildObject(builder, ManagedIdentity, options, 2);
            }

            if (Optional.IsDefined(KekUri))
            {
                builder.Append("  kekUrl:");
                builder.AppendLine($" '{KekUri.AbsoluteUri}'");
            }

            if (Optional.IsDefined(KekVaultResourceId))
            {
                builder.Append("  kekVaultResourceID:");
                builder.AppendLine($" '{KekVaultResourceId.ToString()}'");
            }
