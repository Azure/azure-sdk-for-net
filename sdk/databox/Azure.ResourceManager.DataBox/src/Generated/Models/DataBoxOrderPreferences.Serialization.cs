...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxOrderPreferences>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxOrderPreferences>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxOrderPreferences>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxOrderPreferences>)} interface");
            }
        ...
        string IPersistableModel<DataBoxOrderPreferences>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
