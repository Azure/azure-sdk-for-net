...
{
    public partial class DataBoxOrderPreferences : IUtf8JsonSerializable, IJsonModel<DataBoxOrderPreferences>, IPersistableModel<DataBoxOrderPreferences>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TransportPreferences))
            {
                ...
                AppendChildObject(builder, TransportPreferences, options, 2);
            }

            if (Optional.IsDefined(ReverseTransportPreferences))
            {
                builder.Append("  reverseTransportPreferences:");
                AppendChildObject(builder, ReverseTransportPreferences, options, 2);
            }

            if (Optional.IsDefined(EncryptionPreferences))
            {
                builder.Append("  encryptionPreferences:");
                AppendChildObject(builder, EncryptionPreferences, options, 2);
            }
