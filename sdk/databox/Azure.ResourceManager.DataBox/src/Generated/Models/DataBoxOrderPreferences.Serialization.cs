...
{
    public partial class DataBoxOrderPreferences : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DataBoxOrderPreferences DeserializeDataBoxOrderPreferences(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
