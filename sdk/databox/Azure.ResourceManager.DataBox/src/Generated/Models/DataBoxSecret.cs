...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxSecret
    {
        ...
        internal DataBoxSecret(string deviceSerialNumber, string devicePassword, IReadOnlyList<ApplianceNetworkConfiguration> networkConfigurations, string encodedValidationCertPubKey, IReadOnlyList<DataBoxAccountCredentialDetails> accountCredentialDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
