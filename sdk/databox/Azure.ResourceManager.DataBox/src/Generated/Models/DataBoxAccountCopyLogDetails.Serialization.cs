...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        internal static DataBoxAccountCopyLogDetails DeserializeDataBoxAccountCopyLogDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
