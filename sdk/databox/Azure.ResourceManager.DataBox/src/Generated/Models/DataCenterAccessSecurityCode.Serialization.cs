...
{
    public partial class DataCenterAccessSecurityCode : IUtf8JsonSerializable, IJsonModel<DataCenterAccessSecurityCode>, IPersistableModel<DataCenterAccessSecurityCode>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReverseDataCenterAccessCode))
            {
                builder.Append("  reverseDCAccessCode:");
                builder.AppendLine($" '{ReverseDataCenterAccessCode}'");
            }

            if (Optional.IsDefined(ForwardDataCenterAccessCode))
            {
                builder.Append("  forwardDCAccessCode:");
                builder.AppendLine($" '{ForwardDataCenterAccessCode}'");
            }
