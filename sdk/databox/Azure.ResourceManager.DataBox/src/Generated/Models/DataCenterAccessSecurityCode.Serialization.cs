...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        internal static DataCenterAccessSecurityCode DeserializeDataCenterAccessSecurityCode(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
