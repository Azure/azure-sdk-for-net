...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataCenterAccessSecurityCode>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataCenterAccessSecurityCode>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataCenterAccessSecurityCode>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataCenterAccessSecurityCode>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
