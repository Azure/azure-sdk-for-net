...
namespace Azure.ResourceManager.DataBox.Models
{
    internal partial class JobDeliveryInfo : IUtf8JsonSerializable, IJsonModel<JobDeliveryInfo>
    {
        ...
        void IJsonModel<JobDeliveryInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(JobDeliveryInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<JobDeliveryInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(JobDeliveryInfo)} does not support '{options.Format}' format.");
            }
        }
