...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxValidateAddressContent : DataBoxValidationInputContent
    {
        ...
        internal DataBoxValidateAddressContent(DataBoxValidationInputDiscriminator validationType, DataBoxShippingAddress shippingAddress, DataBoxSkuName deviceType, TransportPreferences transportPreferences, Dictionary<string, BinaryData> rawData) : base(validationType, rawData)
        {
            ShippingAddress = shippingAddress;
            DeviceType = deviceType;
