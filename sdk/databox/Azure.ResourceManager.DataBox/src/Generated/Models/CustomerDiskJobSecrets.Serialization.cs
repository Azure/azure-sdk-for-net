...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomerDiskJobSecrets>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomerDiskJobSecrets>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomerDiskJobSecrets>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomerDiskJobSecrets>)} interface");
            }
        ...
        string IPersistableModel<CustomerDiskJobSecrets>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
