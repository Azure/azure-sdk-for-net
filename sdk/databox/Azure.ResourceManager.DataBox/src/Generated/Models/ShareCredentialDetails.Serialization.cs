...
{
    public partial class ShareCredentialDetails : IUtf8JsonSerializable, IJsonModel<ShareCredentialDetails>, IPersistableModel<ShareCredentialDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ShareType))
            {
                ...
                builder.AppendLine($" '{ShareType.ToString()}'");
            }
