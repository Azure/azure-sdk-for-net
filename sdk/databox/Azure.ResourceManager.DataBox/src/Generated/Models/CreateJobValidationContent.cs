...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class CreateJobValidationContent : DataBoxValidationContent
    {
        ...
        internal CreateJobValidationContent(DataBoxValidationCategory validationCategory, IList<DataBoxValidationInputContent> individualRequestDetails, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(validationCategory, individualRequestDetails, serializedAdditionalRawData)
        {
