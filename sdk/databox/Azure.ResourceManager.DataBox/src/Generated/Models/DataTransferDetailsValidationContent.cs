...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataTransferDetailsValidationContent : DataBoxValidationInputContent
    {
        ...
        public DataTransferDetailsValidationContent(DataBoxSkuName deviceType, DataBoxJobTransferType transferType) : base(DataBoxValidationInputDiscriminator.ValidateDataTransferDetails)
        {
        ...
        internal DataTransferDetailsValidationContent(DataBoxValidationInputDiscriminator validationType, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<DataExportDetails> dataExportDetails, IList<DataImportDetails> dataImportDetails, DataBoxSkuName deviceType, DataBoxJobTransferType transferType, DeviceModelName? model) : base(validationType, additionalBinaryDataProperties)
        {
