...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxContactDetails
    {
        ...
        internal DataBoxContactDetails(string contactName, string phone, string phoneExtension, string mobile, IList<string> emailList, IList<NotificationPreference> notificationPreference, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ContactName = contactName;
            Phone = phone;
