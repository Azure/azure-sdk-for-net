...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataExportDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataExportDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataExportDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataExportDetails>)} interface");
            }
        ...
        string IPersistableModel<DataExportDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
