...
{
    public partial class DataExportDetails : IUtf8JsonSerializable, IJsonModel<DataExportDetails>, IPersistableModel<DataExportDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TransferConfiguration))
            {
                builder.Append("  transferConfiguration:");
                AppendChildObject(builder, TransferConfiguration, options, 2);
            }
