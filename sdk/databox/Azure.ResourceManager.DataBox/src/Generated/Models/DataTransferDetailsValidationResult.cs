...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataTransferDetailsValidationResult : DataBoxValidationInputResult
    {
        ...
        internal DataTransferDetailsValidationResult(DataBoxValidationInputDiscriminator validationType, ResponseError error, DataBoxValidationStatus? status, Dictionary<string, BinaryData> rawData) : base(validationType, error, rawData)
        {
            Status = status;
