...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataCenterAddressContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataCenterAddressContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataCenterAddressContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataCenterAddressContent>)} interface");
            }
        ...
        string IPersistableModel<DataCenterAddressContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
