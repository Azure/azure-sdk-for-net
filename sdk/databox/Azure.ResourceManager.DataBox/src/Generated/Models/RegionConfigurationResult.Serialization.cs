...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        internal static RegionConfigurationResult DeserializeRegionConfigurationResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
