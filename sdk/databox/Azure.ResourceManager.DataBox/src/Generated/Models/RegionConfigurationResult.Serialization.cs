    ...
    public partial class RegionConfigurationResult : IUtf8JsonSerializable, IJsonModel<RegionConfigurationResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ScheduleAvailabilityResponse))
            {
                ...
                AppendChildObject(builder, ScheduleAvailabilityResponse, options, 2, false);
            }

            if (Optional.IsDefined(TransportAvailabilityResponse))
            {
                builder.Append("  transportAvailabilityResponse:");
                AppendChildObject(builder, TransportAvailabilityResponse, options, 2, false);
            }

            if (Optional.IsDefined(DataCenterAddressResponse))
            {
                builder.Append("  datacenterAddressResponse:");
                AppendChildObject(builder, DataCenterAddressResponse, options, 2, false);
            }
