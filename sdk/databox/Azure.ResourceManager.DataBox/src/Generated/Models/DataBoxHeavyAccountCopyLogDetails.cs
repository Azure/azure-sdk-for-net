...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxHeavyAccountCopyLogDetails : CopyLogDetails
    {
        ...
        internal DataBoxHeavyAccountCopyLogDetails(DataBoxOrderType copyLogDetailsType, string accountName, IReadOnlyList<string> copyLogLink, IReadOnlyList<string> copyVerboseLogLink, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(copyLogDetailsType, serializedAdditionalRawData)
        {
