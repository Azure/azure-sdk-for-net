...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxHeavyAccountCopyLogDetails : CopyLogDetails
    {
        ...
        internal DataBoxHeavyAccountCopyLogDetails() : base(DataBoxOrderType.DataBoxHeavy)
        {
        ...
        internal DataBoxHeavyAccountCopyLogDetails(DataBoxOrderType copyLogDetailsType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string accountName, IReadOnlyList<string> copyLogLink, IReadOnlyList<string> copyVerboseLogLink) : base(copyLogDetailsType, additionalBinaryDataProperties)
        {
