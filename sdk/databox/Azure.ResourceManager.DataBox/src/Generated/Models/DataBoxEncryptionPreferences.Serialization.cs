...
{
    public partial class DataBoxEncryptionPreferences : IUtf8JsonSerializable, IJsonModel<DataBoxEncryptionPreferences>, IPersistableModel<DataBoxEncryptionPreferences>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DoubleEncryption))
            {
                builder.Append("  doubleEncryption:");
                builder.AppendLine($" '{DoubleEncryption.ToString()}'");
            }

            if (Optional.IsDefined(HardwareEncryption))
            {
                builder.Append("  hardwareEncryption:");
                builder.AppendLine($" '{HardwareEncryption.ToString()}'");
            }
