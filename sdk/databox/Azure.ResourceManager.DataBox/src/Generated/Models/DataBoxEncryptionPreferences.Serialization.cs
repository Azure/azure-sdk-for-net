...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxEncryptionPreferences>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxEncryptionPreferences>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxEncryptionPreferences>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxEncryptionPreferences>)} interface");
            }
        ...
        string IPersistableModel<DataBoxEncryptionPreferences>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
