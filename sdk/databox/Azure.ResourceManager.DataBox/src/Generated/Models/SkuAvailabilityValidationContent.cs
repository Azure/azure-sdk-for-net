...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class SkuAvailabilityValidationContent : DataBoxValidationInputContent
    {
        ...
        internal SkuAvailabilityValidationContent(DataBoxValidationInputDiscriminator validationType, DataBoxSkuName deviceType, DataBoxJobTransferType transferType, string country, AzureLocation location, Dictionary<string, BinaryData> rawData) : base(validationType, rawData)
        {
            DeviceType = deviceType;
            TransferType = transferType;
            Country = country;
