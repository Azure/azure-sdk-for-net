...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class AddressValidationResult : DataBoxValidationInputResult
    {
        ...
        internal AddressValidationResult(DataBoxValidationInputDiscriminator validationType, ResponseError error, AddressValidationStatus? validationStatus, IReadOnlyList<DataBoxShippingAddress> alternateAddresses, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(validationType, error, serializedAdditionalRawData)
        {
