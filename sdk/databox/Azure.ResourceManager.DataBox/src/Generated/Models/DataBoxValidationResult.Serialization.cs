...
{
    public partial class DataBoxValidationResult : IUtf8JsonSerializable, IJsonModel<DataBoxValidationResult>, IPersistableModel<DataBoxValidationResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  individualResponseDetails:");
                builder.AppendLine(" [");
                foreach (var item in IndividualResponseDetails)
                {
