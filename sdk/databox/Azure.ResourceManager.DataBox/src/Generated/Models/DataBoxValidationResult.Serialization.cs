...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxValidationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxValidationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxValidationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxValidationResult>)} interface");
            }
        ...
        string IPersistableModel<DataBoxValidationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
