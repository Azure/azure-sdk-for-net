...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        internal static PreferencesValidationResult DeserializePreferencesValidationResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
