...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataCenterAddressInstructionResult : DataCenterAddressResult
    {
        ...
        internal DataCenterAddressInstructionResult(DataCenterAddressType dataCenterAddressType, IReadOnlyList<string> supportedCarriersForReturnShipment, AzureLocation? dataCenterAzureLocation, string communicationInstruction, Dictionary<string, BinaryData> rawData) : base(dataCenterAddressType, supportedCarriersForReturnShipment, dataCenterAzureLocation, rawData)
        {
