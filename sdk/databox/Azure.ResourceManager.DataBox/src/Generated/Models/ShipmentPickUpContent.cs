...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class ShipmentPickUpContent
    {
        ...
        internal ShipmentPickUpContent(DateTimeOffset startOn, DateTimeOffset endOn, string shipmentLocation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartOn = startOn;
            EndOn = endOn;
            ShipmentLocation = shipmentLocation;
