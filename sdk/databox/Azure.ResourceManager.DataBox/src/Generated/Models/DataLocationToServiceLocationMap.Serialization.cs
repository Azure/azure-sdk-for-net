...
{
    public partial class DataLocationToServiceLocationMap : IUtf8JsonSerializable, IJsonModel<DataLocationToServiceLocationMap>, IPersistableModel<DataLocationToServiceLocationMap>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataLocation))
            {
                ...
                builder.AppendLine($" '{DataLocation.Value.ToString()}'");
            }
