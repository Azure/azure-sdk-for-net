...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    /// Please note <see cref="ValidationContent"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="CreateJobValidationContent"/>.
    /// </summary>
    public partial class ValidationContent
    {
        /// <summary> Initializes a new instance of ValidationContent. </summary>
        ...
        public ValidationContent(IEnumerable<ValidationInputContent> individualRequestDetails)
        {
        ...
        /// The available derived classes include <see cref="CreateOrderLimitForSubscriptionValidationContent"/>, <see cref="DataTransferDetailsValidationContent"/>, <see cref="PreferencesValidationContent"/>, <see cref="SkuAvailabilityValidationContent"/>, <see cref="SubscriptionIsAllowedToCreateJobValidationContent"/> and <see cref="ValidateAddressContent"/>.
        /// </summary>
        public IList<ValidationInputContent> IndividualRequestDetails { get; }
    }
}
