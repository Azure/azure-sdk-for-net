...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxScheduleAvailabilityContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxScheduleAvailabilityContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxScheduleAvailabilityContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxScheduleAvailabilityContent>)} interface");
            }
        ...
        string IPersistableModel<DataBoxScheduleAvailabilityContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
