...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxDiskJobSecrets : JobSecrets
    {
        ...
        internal DataBoxDiskJobSecrets(DataBoxOrderType jobSecretsType, DataCenterAccessSecurityCode dataCenterAccessSecurityCode, ResponseError error, IReadOnlyList<DataBoxDiskSecret> diskSecrets, string passkey, bool? isPasskeyUserDefined, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(jobSecretsType, dataCenterAccessSecurityCode, error, serializedAdditionalRawData)
        {
