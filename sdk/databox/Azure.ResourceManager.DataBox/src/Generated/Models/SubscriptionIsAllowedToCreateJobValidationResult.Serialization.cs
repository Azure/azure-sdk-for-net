...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubscriptionIsAllowedToCreateJobValidationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SubscriptionIsAllowedToCreateJobValidationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SubscriptionIsAllowedToCreateJobValidationResult>)} interface");
            }
        ...
        string IPersistableModel<SubscriptionIsAllowedToCreateJobValidationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
