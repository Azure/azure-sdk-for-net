...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownJobSecrets))]
    public abstract partial class JobSecrets
    {
        ...
        internal JobSecrets(DataBoxOrderType jobSecretsType, DataCenterAccessSecurityCode dataCenterAccessSecurityCode, ResponseError error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
