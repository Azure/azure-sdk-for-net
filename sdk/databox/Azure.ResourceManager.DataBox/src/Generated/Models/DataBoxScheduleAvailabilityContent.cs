...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxScheduleAvailabilityContent : ScheduleAvailabilityContent
    {
        ...
        internal DataBoxScheduleAvailabilityContent(AzureLocation storageLocation, DataBoxSkuName skuName, string country, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(storageLocation, skuName, country, serializedAdditionalRawData)
        {
            SkuName = skuName;
        }
