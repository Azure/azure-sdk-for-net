...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxDiskSecret>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxDiskSecret>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxDiskSecret>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxDiskSecret>)} interface");
            }
        ...
        string IPersistableModel<DataBoxDiskSecret>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
