...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailableSkusContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvailableSkusContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailableSkusContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvailableSkusContent>)} interface");
            }
        ...
        string IPersistableModel<AvailableSkusContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
