...
{
    internal partial class UnknownCopyLogDetails : CopyLogDetails, IJsonModel<CopyLogDetails>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownCopyLogDetails DeserializeUnknownCopyLogDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownCopyLogDetails(copyLogDetailsType, additionalBinaryDataProperties);
        }
