...
namespace Azure.ResourceManager.DataBox.Models
{
    public partial class Preferences : IUtf8JsonSerializable
    {
        ...
        internal static Preferences DeserializePreferences(JsonElement element)
        {
            ...
            return new Preferences(Optional.ToList(preferredDataCenterRegion), transportPreferences.Value, encryptionPreferences.Value, Optional.ToList(storageAccountAccessTierPreferences));
        }
    }
}
