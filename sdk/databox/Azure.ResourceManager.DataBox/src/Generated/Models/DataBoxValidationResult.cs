...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class DataBoxValidationResult
    {
        ...
        internal DataBoxValidationResult(OverallValidationStatus? status, IReadOnlyList<DataBoxValidationInputResult> individualResponseDetails, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
