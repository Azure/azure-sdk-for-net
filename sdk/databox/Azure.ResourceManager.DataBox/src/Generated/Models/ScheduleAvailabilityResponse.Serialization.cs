...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduleAvailabilityResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScheduleAvailabilityResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScheduleAvailabilityResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ScheduleAvailabilityResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
