...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SkuAvailabilityValidationResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SkuAvailabilityValidationResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SkuAvailabilityValidationResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SkuAvailabilityValidationResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
