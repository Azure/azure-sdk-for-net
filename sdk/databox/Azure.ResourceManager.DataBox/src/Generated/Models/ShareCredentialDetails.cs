...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class ShareCredentialDetails
    {
        ...
        internal ShareCredentialDetails(string shareName, ShareDestinationFormatType? shareType, string userName, string password, IReadOnlyList<DataBoxAccessProtocol> supportedAccessProtocols, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ShareName = shareName;
            ShareType = shareType;
            UserName = userName;
