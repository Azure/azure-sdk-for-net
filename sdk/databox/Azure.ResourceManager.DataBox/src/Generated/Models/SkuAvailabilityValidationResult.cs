...
namespace Azure.ResourceManager.DataBox.Models
{
    ...
    public partial class SkuAvailabilityValidationResult : DataBoxValidationInputResult
    {
        ...
        internal SkuAvailabilityValidationResult(DataBoxValidationInputDiscriminator validationType, ResponseError error, DataBoxValidationStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(validationType, error, serializedAdditionalRawData)
        {
            Status = status;
