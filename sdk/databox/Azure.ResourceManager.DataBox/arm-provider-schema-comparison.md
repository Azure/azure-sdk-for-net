# ARM provider schema comparison: Azure.ResourceManager.DataBox
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBox/jobs/{jobName}` | `DataBoxJob` | `JobResource` |

### Non-resource method differences

| Operation | Request path | Legacy | `resolveArmResources` |
| --- | --- | --- | --- |
| `Microsoft.DataBox.Operations.list` | `/providers/Microsoft.DataBox/operations` | Missing. | Present. |
