...
This release is the first stable release of the Data Box management library.

### Breaking Changes

Polishing since last public beta release:
- Prepended `DataBox` prefix to all single / simple model names.
...
The package name has been changed from `Microsoft.Azure.Management.DataBox` to `Azure.ResourceManager.DataBox`.
