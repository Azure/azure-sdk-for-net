...
namespace Azure.ResourceManager.DataBox
{
    public partial class Sample_DataBoxJobCollection
    {
        ...
        public async Task CreateOrUpdate_JobsCreate()
        {
            ...
            {
                Details = new DataBoxBasicJobDetails(new DataBoxContactDetails("Public SDK Test", "1234567890", new string[]
            {
"testing@microsoft.com"
                ...
                })
                {
                    ...
                    DataImportDetails =
{
new DataImportDetails(new DataAccountDetails()
{
