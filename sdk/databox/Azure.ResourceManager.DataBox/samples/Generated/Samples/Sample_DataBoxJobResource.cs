...
namespace Azure.ResourceManager.DataBox.Samples
{
    public partial class Sample_DataBoxJobResource
    {
        ...
        public async Task Get_JobsGet()
        {
            ...
            DataBoxJobResource result = await dataBoxJob.GetAsync(expand);
        ...
        public async Task Delete_JobsDelete()
        {
            ...
            // invoke the operation
            await dataBoxJob.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task MarkDevicesShipped_MarkDevicesShipped()
        {
            ...
            await dataBoxJob.MarkDevicesShippedAsync(content).ConfigureAwait(false);
        ...
        public async Task BookShipmentPickUp_BookShipmentPickupPost()
        {
            ...
            // invoke the operation
            ShipmentPickUpContent content = new ShipmentPickUpContent(default, default, "Front desk");
        ...
        public async Task Cancel_JobsCancelPost()
        {
            ...
            await dataBoxJob.CancelAsync(cancellationReason).ConfigureAwait(false);
