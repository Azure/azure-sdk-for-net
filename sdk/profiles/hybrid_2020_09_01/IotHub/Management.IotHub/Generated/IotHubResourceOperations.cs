...
namespace Microsoft.Azure.Management.IotHub
{
    ...
    internal partial class IotHubResourceOperations : IServiceOperations<IotHubClient>, IIotHubResourceOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<JobResponse>> ExportDevicesWithHttpMessagesAsync(string resourceGroupName, string resourceName, string exportBlobContainerUri, bool excludeKeys, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
            ...
            ExportDevicesRequest exportDevicesParameters = new ExportDevicesRequest();
            if (exportBlobContainerUri != null)
            {
                exportDevicesParameters.ExportBlobContainerUri = exportBlobContainerUri;
                exportDevicesParameters.ExcludeKeys = excludeKeys;
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<JobResponse>> ImportDevicesWithHttpMessagesAsync(string resourceGroupName, string resourceName, string inputBlobContainerUri, string outputBlobContainerUri, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
            ...
            ImportDevicesRequest importDevicesParameters = new ImportDevicesRequest();
            if (inputBlobContainerUri != null || outputBlobContainerUri != null)
            {
                importDevicesParameters.InputBlobContainerUri = inputBlobContainerUri;
                importDevicesParameters.OutputBlobContainerUri = outputBlobContainerUri;
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
