...
namespace Microsoft.Azure.Management.IotHub
{
    ...
    public partial interface IResourceProviderCommonOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<UserSubscriptionQuotaListResult>> GetSubscriptionQuotaWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
