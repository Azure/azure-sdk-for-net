...
namespace Microsoft.Azure.Management.IotHub
{
    ...
    public static partial class IotHubResourceOperationsExtensions
    {
            ...
            /// Resource tags
            /// </param>
            public static IotHubDescription Update(this IIotHubResourceOperations operations, string resourceGroupName, string resourceName, IDictionary<string, string> tags = default(IDictionary<string, string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IotHubDescription> UpdateAsync(this IIotHubResourceOperations operations, string resourceGroupName, string resourceName, IDictionary<string, string> tags = default(IDictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static IotHubNameAvailabilityInfo CheckNameAvailability(this IIotHubResourceOperations operations, string name)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IotHubNameAvailabilityInfo> CheckNameAvailabilityAsync(this IIotHubResourceOperations operations, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// </param>
            public static JobResponse ExportDevices(this IIotHubResourceOperations operations, string resourceGroupName, string resourceName, string exportBlobContainerUri, bool excludeKeys)
            {
                return operations.ExportDevicesAsync(resourceGroupName, resourceName, exportBlobContainerUri, excludeKeys).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<JobResponse> ExportDevicesAsync(this IIotHubResourceOperations operations, string resourceGroupName, string resourceName, string exportBlobContainerUri, bool excludeKeys, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ExportDevicesWithHttpMessagesAsync(resourceGroupName, resourceName, exportBlobContainerUri, excludeKeys, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// </param>
            public static JobResponse ImportDevices(this IIotHubResourceOperations operations, string resourceGroupName, string resourceName, string inputBlobContainerUri, string outputBlobContainerUri)
            {
                return operations.ImportDevicesAsync(resourceGroupName, resourceName, inputBlobContainerUri, outputBlobContainerUri).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<JobResponse> ImportDevicesAsync(this IIotHubResourceOperations operations, string resourceGroupName, string resourceName, string inputBlobContainerUri, string outputBlobContainerUri, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.ImportDevicesWithHttpMessagesAsync(resourceGroupName, resourceName, inputBlobContainerUri, outputBlobContainerUri, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// Resource tags
            /// </param>
            public static IotHubDescription BeginUpdate(this IIotHubResourceOperations operations, string resourceGroupName, string resourceName, IDictionary<string, string> tags = default(IDictionary<string, string>))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IotHubDescription> BeginUpdateAsync(this IIotHubResourceOperations operations, string resourceGroupName, string resourceName, IDictionary<string, string> tags = default(IDictionary<string, string>), CancellationToken cancellationToken = default(CancellationToken))
            {
