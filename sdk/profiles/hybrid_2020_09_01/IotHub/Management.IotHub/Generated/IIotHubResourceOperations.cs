...
namespace Microsoft.Azure.Management.IotHub
{
    ...
    public partial interface IIotHubResourceOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<JobResponse>> ExportDevicesWithHttpMessagesAsync(string resourceGroupName, string resourceName, string exportBlobContainerUri, bool excludeKeys, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<JobResponse>> ImportDevicesWithHttpMessagesAsync(string resourceGroupName, string resourceName, string inputBlobContainerUri, string outputBlobContainerUri, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Create or update the metadata of an IoT hub.
        /// </summary>
        /// <remarks>
