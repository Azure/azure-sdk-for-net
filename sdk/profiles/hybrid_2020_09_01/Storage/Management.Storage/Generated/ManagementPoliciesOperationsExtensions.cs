...
namespace Microsoft.Azure.Management.Profiles.hybrid_2020_09_01.Storage
{
    ...
    public static partial class ManagementPoliciesOperationsExtensions
    {
            ...
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, accountName, properties).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ManagementPolicy> CreateOrUpdateAsync(this IManagementPoliciesOperations operations, string resourceGroupName, string accountName, ManagementPolicy properties, CancellationToken cancellationToken = default(CancellationToken))
            {
