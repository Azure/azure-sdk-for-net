...
namespace Microsoft.Azure.Management.Profiles.hybrid_2020_09_01.Storage
{
    ...
    public static partial class StorageAccountsOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<StorageAccountListKeysResult> RegenerateKeyAsync(this IStorageAccountsOperations operations, string resourceGroupName, string accountName, StorageAccountRegenerateKeyParameters regenerateKey, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.RestoreBlobRangesAsync(resourceGroupName, accountName, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BlobRestoreStatus> RestoreBlobRangesAsync(this IStorageAccountsOperations operations, string resourceGroupName, string accountName, BlobRestoreParameters parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            {
                return operations.BeginRestoreBlobRangesAsync(resourceGroupName, accountName, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<BlobRestoreStatus> BeginRestoreBlobRangesAsync(this IStorageAccountsOperations operations, string resourceGroupName, string accountName, BlobRestoreParameters parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
