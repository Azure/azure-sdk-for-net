...
namespace Microsoft.Azure.Management.Profiles.hybrid_2020_09_01.Storage
{
    ...
    internal partial class StorageAccountsOperations : IServiceOperations<StorageManagementClient>, IStorageAccountsOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<BlobRestoreStatus>> RestoreBlobRangesWithHttpMessagesAsync(string resourceGroupName, string accountName, BlobRestoreParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
            AzureOperationResponse<BlobRestoreStatus> _response = await BeginRestoreBlobRangesWithHttpMessagesAsync(resourceGroupName, accountName, parameters, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPostOrDeleteOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<BlobRestoreStatus>> BeginRestoreBlobRangesWithHttpMessagesAsync(string resourceGroupName, string accountName, BlobRestoreParameters parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
