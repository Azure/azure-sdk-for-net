# Azure.ResourceManager.Contoso management client library for .NET
...
Install the Azure.ResourceManager.Contoso management library for .NET with [NuGet](https://www.nuget.org/):
