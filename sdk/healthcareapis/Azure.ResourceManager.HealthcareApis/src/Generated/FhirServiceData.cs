...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    public partial class FhirServiceData : TrackedResourceData
    {
        ...
        internal FhirServiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureLocation location, FhirServiceProperties properties, IDictionary<string, string> tags, ETag? eTag, ManagedServiceIdentity identity, FhirServiceKind? kind) : base(id, name, resourceType, systemData, tags, location)
        {
