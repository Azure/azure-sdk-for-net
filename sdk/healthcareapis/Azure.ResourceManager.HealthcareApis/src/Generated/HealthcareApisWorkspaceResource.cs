...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    public partial class HealthcareApisWorkspaceResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the HealthcareApisWorkspace.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/workspaces/{workspaceName}. </description>
        ...
        public virtual async Task<ArmOperation<HealthcareApisWorkspaceResource>> UpdateAsync(WaitUntil waitUntil, HealthcareApisWorkspaceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _healthcareApisWorkspacesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, HealthcareApisWorkspaceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HealthcareApisArmOperation<HealthcareApisWorkspaceResource> operation = new HealthcareApisArmOperation<HealthcareApisWorkspaceResource>(
                    new HealthcareApisWorkspaceResourceOperationSource(Client),
                    _healthcareApisWorkspacesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HealthcareApisWorkspaceResource> Update(WaitUntil waitUntil, HealthcareApisWorkspaceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
