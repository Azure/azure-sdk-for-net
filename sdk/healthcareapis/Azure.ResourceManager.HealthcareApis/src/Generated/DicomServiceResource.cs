...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="DicomServiceResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="HealthcareApisWorkspaceResource"/> using the GetDicomServices method.
    /// </summary>
    public partial class DicomServiceResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of DicomServiceResource for mocking. </summary>
        protected DicomServiceResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DicomServiceResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/workspaces/{workspaceName}/dicomservices/{dicomServiceName}";
        ...
        {
            using DiagnosticScope scope = _dicomServicesClientDiagnostics.CreateScope("DicomServiceResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _dicomServicesRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> DicomServiceOperationGroup_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-04-01-preview. </description>
        ...
        public virtual async Task<ArmOperation<DicomServiceResource>> UpdateAsync(WaitUntil waitUntil, DicomServicePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dicomServicesClientDiagnostics.CreateScope("DicomServiceResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _dicomServicesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, Id.Parent.Name, DicomServicePatch.ToRequestContent(patch), context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> DicomServiceOperationGroup_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-04-01-preview. </description>
        ...
        {
            using DiagnosticScope scope = _dicomServicesClientDiagnostics.CreateScope("DicomServiceResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _dicomServicesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, Id.Parent.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HealthcareApisArmOperation operation = new HealthcareApisArmOperation(_dicomServicesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        public virtual async Task<ArmOperation<DicomServiceResource>> UpdateAsync(WaitUntil waitUntil, DicomServiceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dicomServicesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, DicomServiceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HealthcareApisArmOperation<DicomServiceResource> operation = new HealthcareApisArmOperation<DicomServiceResource>(
                    new DicomServiceResourceOperationSource(Client),
                    _dicomServicesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DicomServiceResource> Update(WaitUntil waitUntil, DicomServiceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<DicomServiceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dicomServicesClientDiagnostics.CreateScope("DicomServiceResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    DicomServiceData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    ArmOperation<DicomServiceResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DicomServiceResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    DicomServiceData current = Get(cancellationToken: cancellationToken).Value.Data;
                    DicomServicePatch patch = new DicomServicePatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<DicomServiceResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<DicomServiceResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dicomServicesClientDiagnostics.CreateScope("DicomServiceResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<DicomServiceResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _dicomServicesClientDiagnostics.CreateScope("DicomServiceResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
