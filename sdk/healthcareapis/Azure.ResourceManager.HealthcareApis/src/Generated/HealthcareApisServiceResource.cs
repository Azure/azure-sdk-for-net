...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    public partial class HealthcareApisServiceResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the HealthcareApisService.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/services/{resourceName}. </description>
        ...
        public virtual async Task<ArmOperation<HealthcareApisServiceResource>> UpdateAsync(WaitUntil waitUntil, HealthcareApisServiceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _servicesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, HealthcareApisServiceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HealthcareApisArmOperation<HealthcareApisServiceResource> operation = new HealthcareApisArmOperation<HealthcareApisServiceResource>(
                    new HealthcareApisServiceResourceOperationSource(Client),
                    _servicesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HealthcareApisServiceResource> Update(WaitUntil waitUntil, HealthcareApisServiceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
