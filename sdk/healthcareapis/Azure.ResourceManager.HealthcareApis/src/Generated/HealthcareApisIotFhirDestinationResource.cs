...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    public partial class HealthcareApisIotFhirDestinationResource : ArmResource
    {
        ...
        internal HealthcareApisIotFhirDestinationResource(ArmClient client, HealthcareApisIotFhirDestinationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<HealthcareApisIotFhirDestinationResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new HealthcareApisIotFhirDestinationResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
