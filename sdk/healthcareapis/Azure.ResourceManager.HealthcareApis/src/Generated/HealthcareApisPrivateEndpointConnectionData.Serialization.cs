...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    public partial class HealthcareApisPrivateEndpointConnectionData : ResourceData, IJsonModel<HealthcareApisPrivateEndpointConnectionData>
    {
        ...
        /// <param name="healthcareApisPrivateEndpointConnectionData"> The <see cref="HealthcareApisPrivateEndpointConnectionData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(HealthcareApisPrivateEndpointConnectionData healthcareApisPrivateEndpointConnectionData)
        {
            if (healthcareApisPrivateEndpointConnectionData == null)
            {
                return null;
            }
            return RequestContent.Create(healthcareApisPrivateEndpointConnectionData, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="HealthcareApisPrivateEndpointConnectionData"/> from. </param>
        internal static HealthcareApisPrivateEndpointConnectionData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeHealthcareApisPrivateEndpointConnectionData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
