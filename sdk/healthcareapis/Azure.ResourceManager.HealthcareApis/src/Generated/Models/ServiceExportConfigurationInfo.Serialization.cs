...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceExportConfigurationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceExportConfigurationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceExportConfigurationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ServiceExportConfigurationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
