...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class OperationResultsDescription
    {
        ...
        internal OperationResultsDescription(string id, string name, OperationResultStatus? status, string startTime, string endTime, BinaryData properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Status = status;
