...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class DicomServiceAuthenticationConfiguration
    {
        ...
        internal DicomServiceAuthenticationConfiguration(string authority, IReadOnlyList<string> audiences, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Authority = authority;
            Audiences = audiences;
