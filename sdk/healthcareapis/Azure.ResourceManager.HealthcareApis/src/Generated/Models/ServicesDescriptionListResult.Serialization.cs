...
{
    internal partial class ServicesDescriptionListResult : IUtf8JsonSerializable, IJsonModel<ServicesDescriptionListResult>, IPersistableModel<ServicesDescriptionListResult>
    {
        ...
        void IJsonModel<ServicesDescriptionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServicesDescriptionListResult)} does not support '{format}' format.");
            }
