...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class DicomServicePatch : HealthcareApisResourceTags
    {
        ...
        internal DicomServicePatch(IDictionary<string, string> tags, ManagedServiceIdentity identity, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, serializedAdditionalRawData)
        {
            Identity = identity;
        }
