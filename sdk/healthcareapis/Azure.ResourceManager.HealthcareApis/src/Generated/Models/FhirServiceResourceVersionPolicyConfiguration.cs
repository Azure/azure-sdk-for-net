...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class FhirServiceResourceVersionPolicyConfiguration
    {
        ...
        internal FhirServiceResourceVersionPolicyConfiguration(FhirResourceVersionPolicy? @default, IDictionary<string, FhirResourceVersionPolicy> resourceTypeOverrides, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Default = @default;
