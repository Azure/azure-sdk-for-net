...
{
    public partial class IotEventHubIngestionEndpointConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static IotEventHubIngestionEndpointConfiguration DeserializeIotEventHubIngestionEndpointConfiguration(JsonElement element)
        {
            ...
            return new IotEventHubIngestionEndpointConfiguration(eventHubName.Value, consumerGroup.Value, fullyQualifiedEventHubNamespace.Value);
        }
    }
}
