...
{
    public partial class HealthcareApisServiceOciArtifactEntry : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HealthcareApisServiceOciArtifactEntry DeserializeHealthcareApisServiceOciArtifactEntry(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
