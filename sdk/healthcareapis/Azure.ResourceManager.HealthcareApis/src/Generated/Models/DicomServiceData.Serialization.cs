...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DicomServiceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DicomServiceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DicomServiceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DicomServiceData>)} interface");
            }
        ...
        string IPersistableModel<DicomServiceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
