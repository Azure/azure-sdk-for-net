...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareApisServicePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthcareApisServicePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthcareApisServicePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthcareApisServicePatch>)} interface");
            }
        ...
        string IPersistableModel<HealthcareApisServicePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
