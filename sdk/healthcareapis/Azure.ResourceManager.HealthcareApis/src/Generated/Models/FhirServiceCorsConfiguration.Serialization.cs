...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirServiceCorsConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FhirServiceCorsConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FhirServiceCorsConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FhirServiceCorsConfiguration>)} interface");
            }
        ...
        string IPersistableModel<FhirServiceCorsConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
