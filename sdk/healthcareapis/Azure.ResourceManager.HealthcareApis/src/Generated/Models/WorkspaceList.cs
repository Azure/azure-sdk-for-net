...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    internal partial class WorkspaceList
    {
        ...
        internal WorkspaceList(IEnumerable<HealthcareApisWorkspaceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal WorkspaceList(IList<HealthcareApisWorkspaceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<HealthcareApisWorkspaceData> Value { get; }
