...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class HealthcareApisIotConnectorPatch : HealthcareApisResourceTags
    {
        ...
        internal HealthcareApisIotConnectorPatch(IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, ManagedServiceIdentity identity) : base(tags, additionalBinaryDataProperties)
        {
            Identity = identity;
        }
