...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class HealthcareApisIotConnectorPatch : HealthcareApisResourceTags
    {
        ...
        internal HealthcareApisIotConnectorPatch(IDictionary<string, string> tags, ManagedServiceIdentity identity, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
            Identity = identity;
        }
