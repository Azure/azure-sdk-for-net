...
{
    public partial class CorsConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static CorsConfiguration DeserializeCorsConfiguration(JsonElement element)
        {
            ...
            return new CorsConfiguration(Optional.ToList(origins), Optional.ToList(headers), Optional.ToList(methods), Optional.ToNullable(maxAge), Optional.ToNullable(allowCredentials));
        }
    }
}
