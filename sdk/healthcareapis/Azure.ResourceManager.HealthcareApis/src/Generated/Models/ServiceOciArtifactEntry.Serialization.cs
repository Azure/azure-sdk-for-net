...
{
    public partial class ServiceOciArtifactEntry : IUtf8JsonSerializable
    {
        ...
        internal static ServiceOciArtifactEntry DeserializeServiceOciArtifactEntry(JsonElement element)
        {
            ...
            return new ServiceOciArtifactEntry(loginServer.Value, imageName.Value, digest.Value);
        }
    }
}
