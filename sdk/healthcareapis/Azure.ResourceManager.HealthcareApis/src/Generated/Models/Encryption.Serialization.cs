...
{
    internal partial class Encryption : IUtf8JsonSerializable, IJsonModel<Encryption>, IPersistableModel<Encryption>
    {
        ...
        void IJsonModel<Encryption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(Encryption)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CustomerManagedKeyEncryption))
            {
                ...
                AppendChildObject(builder, CustomerManagedKeyEncryption, options, 2);
            }
