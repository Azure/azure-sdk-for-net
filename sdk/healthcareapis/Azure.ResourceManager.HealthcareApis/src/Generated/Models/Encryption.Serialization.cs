...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    internal partial class Encryption : IJsonModel<Encryption>
    {
        ...
        internal static Encryption DeserializeEncryption(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("customerManagedKeyEncryption"u8))
                {
                    ...
                    customerManagedKeyEncryption = EncryptionCustomerManagedKeyEncryption.DeserializeEncryptionCustomerManagedKeyEncryption(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new Encryption(customerManagedKeyEncryption, additionalBinaryDataProperties);
        }
    }
}
