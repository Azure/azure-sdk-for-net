...
{
    public partial class HealthcareApisServiceCosmosDbConfiguration : IUtf8JsonSerializable, IJsonModel<HealthcareApisServiceCosmosDbConfiguration>, IPersistableModel<HealthcareApisServiceCosmosDbConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OfferThroughput))
            {
                ...
                builder.AppendLine($" '{OfferThroughput.Value.ToString()}'");
            }
