...
{
    public partial class HealthcareApisPrivateLinkResourceData : Core.IUtf8JsonSerializable
    {
        ...
        internal static HealthcareApisPrivateLinkResourceData DeserializeHealthcareApisPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new HealthcareApisPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
