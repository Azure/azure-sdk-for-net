...
{
    public partial class HealthcareApisServiceCorsConfiguration : Core.IUtf8JsonSerializable
    {
        ...
        internal static HealthcareApisServiceCorsConfiguration DeserializeHealthcareApisServiceCorsConfiguration(JsonElement element)
        {
            ...
            return new HealthcareApisServiceCorsConfiguration(Core.Optional.ToList(origins), Core.Optional.ToList(headers), Core.Optional.ToList(methods), Core.Optional.ToNullable(maxAge), Core.Optional.ToNullable(allowCredentials));
        }
    }
}
