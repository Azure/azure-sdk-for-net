...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    public partial class HealthcareApisServiceProperties : IUtf8JsonSerializable, IJsonModel<HealthcareApisServiceProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CosmosDbConfiguration))
            {
                builder.Append("  cosmosDbConfiguration:");
                AppendChildObject(builder, CosmosDbConfiguration, options, 2, false);
            }

            if (Optional.IsDefined(AuthenticationConfiguration))
            {
                builder.Append("  authenticationConfiguration:");
                AppendChildObject(builder, AuthenticationConfiguration, options, 2, false);
            }

            if (Optional.IsDefined(CorsConfiguration))
            {
                builder.Append("  corsConfiguration:");
                AppendChildObject(builder, CorsConfiguration, options, 2, false);
            }

            if (Optional.IsDefined(ExportConfiguration))
            {
                builder.Append("  exportConfiguration:");
                AppendChildObject(builder, ExportConfiguration, options, 2, false);
            }
            ...
            if (Optional.IsDefined(AcrConfiguration))
            {
                ...
                AppendChildObject(builder, AcrConfiguration, options, 2, false);
            }

            if (Optional.IsDefined(ImportConfiguration))
            {
                builder.Append("  importConfiguration:");
                AppendChildObject(builder, ImportConfiguration, options, 2, false);
            }
