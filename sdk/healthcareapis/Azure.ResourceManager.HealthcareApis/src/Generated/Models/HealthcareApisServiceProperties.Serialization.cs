...
{
    public partial class HealthcareApisServiceProperties : IUtf8JsonSerializable, IJsonModel<HealthcareApisServiceProperties>, IPersistableModel<HealthcareApisServiceProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CosmosDbConfiguration))
            {
                ...
                AppendChildObject(builder, CosmosDbConfiguration, options, 2);
            }
