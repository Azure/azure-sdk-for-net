...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CorsConfiguration. </summary>
        ...
        internal CorsConfiguration(IList<string> origins, IList<string> headers, IList<string> methods, int? maxAge, bool? allowCredentials)
        {
            Origins = origins;
            Headers = headers;
            Methods = methods;
