...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirServiceAcrConfiguration>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(OciArtifacts))
            {
                ...
                {
                    ((IJsonModel<HealthcareApisServiceOciArtifactEntry>)item).Write(writer, options);
                }
                writer.WriteEndArray();
            }
