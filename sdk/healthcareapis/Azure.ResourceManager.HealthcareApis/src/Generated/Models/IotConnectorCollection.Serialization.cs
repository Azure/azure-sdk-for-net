...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotConnectorCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotConnectorCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotConnectorCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotConnectorCollection>)} interface");
            }
        ...
        string IPersistableModel<IotConnectorCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
