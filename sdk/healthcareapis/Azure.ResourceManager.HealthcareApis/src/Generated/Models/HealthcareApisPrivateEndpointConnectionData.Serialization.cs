...
{
    public partial class HealthcareApisPrivateEndpointConnectionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static HealthcareApisPrivateEndpointConnectionData DeserializeHealthcareApisPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            Core.Optional<HealthcareApisPrivateLinkServiceConnectionState> privateLinkServiceConnectionState = default;
            Core.Optional<HealthcareApisPrivateEndpointConnectionProvisioningState> provisioningState = default;
            ...
            return new HealthcareApisPrivateEndpointConnectionData(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Core.Optional.ToNullable(provisioningState));
        }
    }
}
