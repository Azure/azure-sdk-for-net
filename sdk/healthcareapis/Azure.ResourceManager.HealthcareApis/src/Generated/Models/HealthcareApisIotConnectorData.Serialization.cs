...
{
    public partial class HealthcareApisIotConnectorData : IUtf8JsonSerializable, IJsonModel<HealthcareApisIotConnectorData>, IPersistableModel<HealthcareApisIotConnectorData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IngestionEndpointConfiguration))
            {
                builder.Append("  ingestionEndpointConfiguration:");
                AppendChildObject(builder, IngestionEndpointConfiguration, options, 2);
            }

            if (Optional.IsDefined(DeviceMapping))
            {
                builder.Append("  deviceMapping:");
                AppendChildObject(builder, DeviceMapping, options, 2);
            }
