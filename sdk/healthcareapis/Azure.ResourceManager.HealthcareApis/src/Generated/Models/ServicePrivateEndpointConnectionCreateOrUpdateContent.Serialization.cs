...
{
    public partial class ServicePrivateEndpointConnectionCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static ServicePrivateEndpointConnectionCreateOrUpdateContent DeserializeServicePrivateEndpointConnectionCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new ServicePrivateEndpointConnectionCreateOrUpdateContent(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
