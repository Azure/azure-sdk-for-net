...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class FhirServiceCorsConfiguration
    {
        ...
        internal FhirServiceCorsConfiguration(IList<string> origins, IList<string> headers, IList<string> methods, int? maxAge, bool? allowCredentials, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Origins = origins;
            Headers = headers;
            Methods = methods;
