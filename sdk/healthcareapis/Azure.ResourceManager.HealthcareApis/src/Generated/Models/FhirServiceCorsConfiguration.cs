...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class FhirServiceCorsConfiguration
    {
        ...
        internal FhirServiceCorsConfiguration(IList<string> origins, IList<string> headers, IList<string> methods, int? maxAge, bool? allowCredentials, Dictionary<string, BinaryData> rawData)
        {
            Origins = origins;
            Headers = headers;
            Methods = methods;
