...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirServicePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FhirServicePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FhirServicePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FhirServicePatch>)} interface");
            }
        ...
        string IPersistableModel<FhirServicePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
