    ...
    public partial class FhirServicePatch : IUtf8JsonSerializable, IJsonModel<FhirServicePatch>
    {
        ...
        internal static FhirServicePatch DeserializeFhirServicePatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.ManagedServiceIdentity>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), new global::System.ClientModel.Primitives.ModelReaderWriterOptions("W|v3"), AzureResourceManagerHealthcareApisContext.Default)
#else
                ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), new ModelReaderWriterOptions("W|v3"), AzureResourceManagerHealthcareApisContext.Default)
#endif
;
                    continue;
                }
