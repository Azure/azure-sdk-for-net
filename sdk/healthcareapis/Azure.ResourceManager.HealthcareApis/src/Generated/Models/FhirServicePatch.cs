...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class FhirServicePatch : HealthcareApisResourceTags
    {
        ...
        internal FhirServicePatch(IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, ManagedServiceIdentity identity) : base(tags, additionalBinaryDataProperties)
        {
            Identity = identity;
        }
