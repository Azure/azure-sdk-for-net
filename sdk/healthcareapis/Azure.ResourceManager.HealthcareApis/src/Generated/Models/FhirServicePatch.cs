...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class FhirServicePatch : HealthcareApisResourceTags
    {
        ...
        internal FhirServicePatch(IDictionary<string, string> tags, ManagedServiceIdentity identity, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, serializedAdditionalRawData)
        {
            Identity = identity;
        }
