...
{
    public partial class ResourceVersionPolicyConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static ResourceVersionPolicyConfiguration DeserializeResourceVersionPolicyConfiguration(JsonElement element)
        {
            ...
            return new ResourceVersionPolicyConfiguration(Optional.ToNullable(@default), Optional.ToDictionary(resourceTypeOverrides));
        }
    }
}
