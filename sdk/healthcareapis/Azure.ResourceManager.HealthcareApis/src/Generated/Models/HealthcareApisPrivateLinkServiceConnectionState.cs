...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class HealthcareApisPrivateLinkServiceConnectionState
    {
        ...
        internal HealthcareApisPrivateLinkServiceConnectionState(HealthcareApisPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
