...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class HealthcareApisPrivateLinkServiceConnectionState
    {
        ...
        internal HealthcareApisPrivateLinkServiceConnectionState(HealthcareApisPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
