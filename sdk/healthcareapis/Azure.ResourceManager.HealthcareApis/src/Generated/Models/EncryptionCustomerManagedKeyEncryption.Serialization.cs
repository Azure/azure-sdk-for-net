...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    internal partial class EncryptionCustomerManagedKeyEncryption : IJsonModel<EncryptionCustomerManagedKeyEncryption>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EncryptionCustomerManagedKeyEncryption PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EncryptionCustomerManagedKeyEncryption>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EncryptionCustomerManagedKeyEncryption>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EncryptionCustomerManagedKeyEncryption IPersistableModel<EncryptionCustomerManagedKeyEncryption>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EncryptionCustomerManagedKeyEncryption IJsonModel<EncryptionCustomerManagedKeyEncryption>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EncryptionCustomerManagedKeyEncryption JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EncryptionCustomerManagedKeyEncryption>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static EncryptionCustomerManagedKeyEncryption DeserializeEncryptionCustomerManagedKeyEncryption(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new EncryptionCustomerManagedKeyEncryption(keyEncryptionKeyUri, additionalBinaryDataProperties);
        }
    }
}
