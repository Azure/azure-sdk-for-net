...
{
    public partial class DicomServiceCorsConfiguration : Core.IUtf8JsonSerializable
    {
        ...
        internal static DicomServiceCorsConfiguration DeserializeDicomServiceCorsConfiguration(JsonElement element)
        {
            ...
            return new DicomServiceCorsConfiguration(Core.Optional.ToList(origins), Core.Optional.ToList(headers), Core.Optional.ToList(methods), Core.Optional.ToNullable(maxAge), Core.Optional.ToNullable(allowCredentials));
        }
    }
}
