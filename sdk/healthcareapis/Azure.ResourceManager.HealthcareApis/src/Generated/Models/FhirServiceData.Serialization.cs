...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirServiceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FhirServiceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FhirServiceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FhirServiceData>)} interface");
            }
        ...
        string IPersistableModel<FhirServiceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
