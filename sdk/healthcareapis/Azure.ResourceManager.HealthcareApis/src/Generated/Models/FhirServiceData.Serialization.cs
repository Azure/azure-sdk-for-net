...
{
    public partial class FhirServiceData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FhirServiceData DeserializeFhirServiceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
