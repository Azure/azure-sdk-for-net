...
{
    public partial class FhirServiceData : IUtf8JsonSerializable, IModelJsonSerializable<FhirServiceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<FhirServiceData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<FhirServiceData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FhirServiceData>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(AccessPolicies))
            {
                ...
                foreach (var item in AccessPolicies)
                {
                    ...
                    {
                        ((IModelJsonSerializable<FhirServiceAccessPolicyEntry>)item).Serialize(writer, options);
                    }
                }
            ...
            if (Optional.IsDefined(AcrConfiguration))
            {
                ...
                {
                    ((IModelJsonSerializable<FhirServiceAcrConfiguration>)AcrConfiguration).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(AuthenticationConfiguration))
            {
                ...
                {
                    ((IModelJsonSerializable<FhirServiceAuthenticationConfiguration>)AuthenticationConfiguration).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(CorsConfiguration))
            {
                ...
                {
                    ((IModelJsonSerializable<FhirServiceCorsConfiguration>)CorsConfiguration).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(ExportConfiguration))
            {
                ...
                {
                    ((IModelJsonSerializable<FhirServiceExportConfiguration>)ExportConfiguration).Serialize(writer, options);
                }
            }
            ...
            if (Optional.IsDefined(ResourceVersionPolicyConfiguration))
            {
                ...
                if (ResourceVersionPolicyConfiguration is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<FhirServiceResourceVersionPolicyConfiguration>)ResourceVersionPolicyConfiguration).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(ImportConfiguration))
            {
                ...
                {
                    ((IModelJsonSerializable<FhirServiceImportConfiguration>)ImportConfiguration).Serialize(writer, options);
                }
            }
            writer.WriteEndObject();
        ...
        internal static FhirServiceData DeserializeFhirServiceData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        FhirServiceData IModelJsonSerializable<FhirServiceData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FhirServiceData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeFhirServiceData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<FhirServiceData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FhirServiceData>(this, options.Format);
        ...
        FhirServiceData IModelSerializable<FhirServiceData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<FhirServiceData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="FhirServiceData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FhirServiceData"/> to convert. </param>
        public static implicit operator RequestContent(FhirServiceData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FhirServiceData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator FhirServiceData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeFhirServiceData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
