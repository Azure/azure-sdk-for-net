...
{
    public partial class IotFhirDestinationData : IUtf8JsonSerializable
    {
        ...
        internal static IotFhirDestinationData DeserializeIotFhirDestinationData(JsonElement element)
        {
            ...
            return new IotFhirDestinationData(id, name, type, systemData.Value, Optional.ToNullable(provisioningState), resourceIdentityResolutionType, fhirServiceResourceId, fhirMapping, Optional.ToNullable(location), Optional.ToNullable(etag));
        }
    }
}
