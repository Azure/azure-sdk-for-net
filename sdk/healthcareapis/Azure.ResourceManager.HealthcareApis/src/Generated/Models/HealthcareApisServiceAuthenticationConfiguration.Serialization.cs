...
{
    public partial class HealthcareApisServiceAuthenticationConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HealthcareApisServiceAuthenticationConfiguration DeserializeHealthcareApisServiceAuthenticationConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
