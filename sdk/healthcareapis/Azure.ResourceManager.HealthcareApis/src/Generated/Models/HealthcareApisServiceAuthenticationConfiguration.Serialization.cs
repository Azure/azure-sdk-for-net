...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareApisServiceAuthenticationConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthcareApisServiceAuthenticationConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthcareApisServiceAuthenticationConfiguration>)} interface");
            }
        ...
        string IPersistableModel<HealthcareApisServiceAuthenticationConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
