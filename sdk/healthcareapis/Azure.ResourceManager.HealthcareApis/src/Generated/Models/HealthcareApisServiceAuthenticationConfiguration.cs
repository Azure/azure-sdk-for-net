...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    public partial class HealthcareApisServiceAuthenticationConfiguration
    {
        ...
        internal HealthcareApisServiceAuthenticationConfiguration(string authority, string audience, bool? isSmartProxyEnabled, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Authority = authority;
            Audience = audience;
