...
{
    public partial class HealthcareApisWorkspaceData : IUtf8JsonSerializable, IJsonModel<HealthcareApisWorkspaceData>, IPersistableModel<HealthcareApisWorkspaceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareApisWorkspaceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<HealthcareApisWorkspaceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HealthcareApisWorkspaceData)} does not support '{format}' format.");
            }
