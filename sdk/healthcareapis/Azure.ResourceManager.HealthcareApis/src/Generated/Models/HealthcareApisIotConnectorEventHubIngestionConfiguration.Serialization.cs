...
namespace Azure.ResourceManager.HealthcareApis.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareApisIotConnectorEventHubIngestionConfiguration>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        HealthcareApisIotConnectorEventHubIngestionConfiguration IJsonModel<HealthcareApisIotConnectorEventHubIngestionConfiguration>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<HealthcareApisIotConnectorEventHubIngestionConfiguration>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        HealthcareApisIotConnectorEventHubIngestionConfiguration IModel<HealthcareApisIotConnectorEventHubIngestionConfiguration>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<HealthcareApisIotConnectorEventHubIngestionConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
