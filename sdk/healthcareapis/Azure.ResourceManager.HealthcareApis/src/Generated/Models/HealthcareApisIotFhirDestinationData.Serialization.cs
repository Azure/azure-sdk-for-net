...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthcareApisIotFhirDestinationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthcareApisIotFhirDestinationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthcareApisIotFhirDestinationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthcareApisIotFhirDestinationData>)} interface");
            }
        ...
        string IPersistableModel<HealthcareApisIotFhirDestinationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
