...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    public partial class HealthcareApisIotConnectorResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _healthcareApisIotConnectorIotConnectorsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = await _healthcareApisIotConnectorIotConnectorsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new HealthcareApisArmOperation(_healthcareApisIotConnectorIotConnectorsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _healthcareApisIotConnectorIotConnectorsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = _healthcareApisIotConnectorIotConnectorsRestClient.Delete(message, cancellationToken);
                var operation = new HealthcareApisArmOperation(_healthcareApisIotConnectorIotConnectorsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<HealthcareApisIotConnectorResource>> UpdateAsync(WaitUntil waitUntil, HealthcareApisIotConnectorPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _healthcareApisIotConnectorIotConnectorsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch);
                var response = await _healthcareApisIotConnectorIotConnectorsRestClient.UpdateAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<HealthcareApisIotConnectorResource> Update(WaitUntil waitUntil, HealthcareApisIotConnectorPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _healthcareApisIotConnectorIotConnectorsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch);
                var response = _healthcareApisIotConnectorIotConnectorsRestClient.Update(message, cancellationToken);
                var operation = new HealthcareApisArmOperation<HealthcareApisIotConnectorResource>(new HealthcareApisIotConnectorOperationSource(Client), _healthcareApisIotConnectorIotConnectorsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
