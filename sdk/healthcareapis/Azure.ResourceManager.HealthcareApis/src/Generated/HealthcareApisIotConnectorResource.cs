...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    public partial class HealthcareApisIotConnectorResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the HealthcareApisIotConnector.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/workspaces/{workspaceName}/iotconnectors/{iotConnectorName}. </description>
        ...
        public virtual async Task<ArmOperation<HealthcareApisIotConnectorResource>> UpdateAsync(WaitUntil waitUntil, HealthcareApisIotConnectorData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _healthcareApisIotConnectorsClientDiagnostics.CreateScope("HealthcareApisIotConnectorResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _healthcareApisIotConnectorsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, HealthcareApisIotConnectorData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HealthcareApisArmOperation<HealthcareApisIotConnectorResource> operation = new HealthcareApisArmOperation<HealthcareApisIotConnectorResource>(
                    new HealthcareApisIotConnectorResourceOperationSource(Client),
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HealthcareApisIotConnectorResource> Update(WaitUntil waitUntil, HealthcareApisIotConnectorData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
