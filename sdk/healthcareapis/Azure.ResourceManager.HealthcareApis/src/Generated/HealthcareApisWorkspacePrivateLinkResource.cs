...
namespace Azure.ResourceManager.HealthcareApis
{
    ...
    public partial class HealthcareApisWorkspacePrivateLinkResource : HealthcareApisPrivateLinkResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<HealthcareApisWorkspacePrivateLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<HealthcareApisWorkspacePrivateLinkResource> Get(CancellationToken cancellationToken = default)
        {
