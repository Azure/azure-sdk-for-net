    ...
    public partial class HealthcareApisWorkspacePrivateLinkResource : HealthcareApisPrivateLinkResource
    {
        ...
        protected override async Task<Response<HealthcareApisPrivateLinkResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((HealthcareApisPrivateLinkResource)new HealthcareApisWorkspacePrivateLinkResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<HealthcareApisWorkspacePrivateLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((HealthcareApisWorkspacePrivateLinkResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<HealthcareApisWorkspacePrivateLinkResource> Get(CancellationToken cancellationToken = default)
        {
