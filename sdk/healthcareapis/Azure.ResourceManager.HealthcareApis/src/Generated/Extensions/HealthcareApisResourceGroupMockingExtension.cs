...
namespace Azure.ResourceManager.HealthcareApis.Mocking
{
    ...
    internal partial class HealthcareApisResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HealthcareApisResourceGroupMockingExtension"/> class for mocking. </summary>
        protected HealthcareApisResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HealthcareApisResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HealthcareApisResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
