...
namespace Azure.ResourceManager.HealthcareApis.Mocking
{
    ...
    internal partial class HealthcareApisArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HealthcareApisArmClientMockingExtension"/> class for mocking. </summary>
        protected HealthcareApisArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HealthcareApisArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HealthcareApisArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal HealthcareApisArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
