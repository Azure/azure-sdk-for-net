...
namespace Azure.ResourceManager.HealthcareApis.Mock
{
    ...
    public partial class HealthcareApisServiceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HealthcareApisServiceResourceExtension"/> class for mocking. </summary>
        protected HealthcareApisServiceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HealthcareApisServiceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HealthcareApisServiceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<HealthcareApisNameAvailabilityResult>> CheckHealthcareApisNameAvailabilityAsync(HealthcareApisNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = HealthcareApisServiceServicesClientDiagnostics.CreateScope("HealthcareApisServiceResourceExtension.CheckHealthcareApisNameAvailability");
            scope.Start();
            try
            {
