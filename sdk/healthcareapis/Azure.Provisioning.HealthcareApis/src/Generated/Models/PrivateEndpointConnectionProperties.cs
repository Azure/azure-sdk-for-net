...
namespace Azure.Provisioning.HealthcareApis
{
    ...
    public partial class PrivateEndpointConnectionProperties : ProvisionableConstruct
    {
        ...
        private BicepValue<HealthcareApisPrivateEndpointConnectionProvisioningState> _provisioningState;
        ...
        protected override void DefineProvisionableProperties()
        {
            ...
            _connectionState = DefineModelProperty<HealthcareApisPrivateLinkServiceConnectionState>(nameof(ConnectionState), new string[] { "privateLinkServiceConnectionState" }, isRequired: true);
            _provisioningState = DefineProperty<HealthcareApisPrivateEndpointConnectionProvisioningState>(nameof(ProvisioningState), new string[] { "provisioningState" }, isOutput: true);
