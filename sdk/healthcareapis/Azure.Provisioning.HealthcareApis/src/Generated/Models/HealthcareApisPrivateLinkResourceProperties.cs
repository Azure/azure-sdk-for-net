...
namespace Azure.Provisioning.HealthcareApis
{
    ...
    internal partial class HealthcareApisPrivateLinkResourceProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new HealthcareApisPrivateLinkResourceProperties. </summary>
        public HealthcareApisPrivateLinkResourceProperties()
        {
        }
        ...
        /// <summary> Define all the provisionable properties for HealthcareApisPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for HealthcareApisPrivateLinkResourceProperties that are not part of the generated code. </summary>
