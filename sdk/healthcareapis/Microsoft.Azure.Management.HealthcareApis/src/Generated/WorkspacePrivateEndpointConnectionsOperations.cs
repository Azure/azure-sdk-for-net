...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    /// </summary>
    internal partial class WorkspacePrivateEndpointConnectionsOperations : IServiceOperations<HealthcareApisManagementClient>, IWorkspacePrivateEndpointConnectionsOperations
    {
        /// <summary>
        /// Initializes a new instance of the WorkspacePrivateEndpointConnectionsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal WorkspacePrivateEndpointConnectionsOperations(HealthcareApisManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<PrivateEndpointConnectionDescription>>> ListByWorkspaceWithHttpMessagesAsync(string resourceGroupName, string workspaceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HealthcareApis/workspaces/{workspaceName}/privateEndpointConnections").ToString();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<PrivateEndpointConnectionDescription>> GetWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string privateEndpointConnectionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
        ...
        {
            // Send Request
            AzureOperationResponse<PrivateEndpointConnectionDescription> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, workspaceName, privateEndpointConnectionName, properties, customHeaders, cancellationToken).ConfigureAwait(false);
