...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    public partial class FhirServicesUpdateOperation : Operation<FhirService>, IOperationSource<FhirService>
    {
        private readonly ArmOperationHelpers<FhirService> _operation;
        internal FhirServicesUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<FhirService>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "FhirServicesUpdateOperation");
        }
        /// <inheritdoc />
