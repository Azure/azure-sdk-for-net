...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    public partial class IotConnectorsCreateOrUpdateOperation : Operation<IotConnector>, IOperationSource<IotConnector>
    {
        private readonly ArmOperationHelpers<IotConnector> _operation;
        internal IotConnectorsCreateOrUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<IotConnector>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "IotConnectorsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
