...
using Page = Azure.Page<Microsoft.Azure.Management.HealthcareApis.Models.OperationDetail>;
...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    public partial class Operations
    {
        ...
        internal Operations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint = null, string apiVersion = "2021-11-01")
        {
        ...
        public virtual AsyncPageable<OperationDetail> ListAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Lists all of the available operations supported by Microsoft Healthcare resource provider. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Pageable<OperationDetail> List(CancellationToken cancellationToken = default)
        {
