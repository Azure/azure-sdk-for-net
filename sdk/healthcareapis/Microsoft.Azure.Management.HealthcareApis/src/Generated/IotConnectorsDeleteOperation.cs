...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    public partial class IotConnectorsDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal IotConnectorsDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "IotConnectorsDeleteOperation");
        }
        /// <inheritdoc />
