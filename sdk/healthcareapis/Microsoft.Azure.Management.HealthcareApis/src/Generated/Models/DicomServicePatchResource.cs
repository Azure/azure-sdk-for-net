...
namespace Microsoft.Azure.Management.HealthcareApis.Models
{
    ...
    public partial class DicomServicePatchResource
    {
        ...
        public DicomServicePatchResource(IDictionary<string, string> tags = default(IDictionary<string, string>), ServiceManagedIdentityIdentity identity = default(ServiceManagedIdentityIdentity))
        {
            Tags = tags;
            Identity = identity;
            CustomInit();
