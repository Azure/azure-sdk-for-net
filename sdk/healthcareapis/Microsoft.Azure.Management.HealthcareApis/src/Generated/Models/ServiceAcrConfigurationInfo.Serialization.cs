...
{
    public partial class ServiceAcrConfigurationInfo : IUtf8JsonSerializable
    {
        ...
        internal static ServiceAcrConfigurationInfo DeserializeServiceAcrConfigurationInfo(JsonElement element)
        {
            ...
            return new ServiceAcrConfigurationInfo(Optional.ToList(loginServers), Optional.ToList(ociArtifacts));
        }
    }
}
