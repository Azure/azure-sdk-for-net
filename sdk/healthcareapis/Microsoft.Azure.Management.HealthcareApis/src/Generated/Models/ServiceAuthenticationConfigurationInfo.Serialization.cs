...
{
    public partial class ServiceAuthenticationConfigurationInfo : IUtf8JsonSerializable
    {
        ...
        internal static ServiceAuthenticationConfigurationInfo DeserializeServiceAuthenticationConfigurationInfo(JsonElement element)
        {
            ...
            return new ServiceAuthenticationConfigurationInfo(authority.Value, audience.Value, Optional.ToNullable(smartProxyEnabled));
        }
    }
}
