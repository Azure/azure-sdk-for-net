...
namespace Microsoft.Azure.Management.HealthcareApis
{
    ...
    public partial class IotConnectorFhirDestinationDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;
        internal IotConnectorFhirDestinationDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "IotConnectorFhirDestinationDeleteOperation");
        }
        /// <inheritdoc />
