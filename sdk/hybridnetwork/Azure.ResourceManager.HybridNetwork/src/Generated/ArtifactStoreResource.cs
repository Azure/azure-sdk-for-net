...
namespace Azure.ResourceManager.HybridNetwork
{
    ...
    public partial class ArtifactStoreResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ArtifactStoreResource>> UpdateAsync(WaitUntil waitUntil, ArtifactStoreData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _artifactStoresRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ArtifactStoreData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ArtifactStoreResource> Update(WaitUntil waitUntil, ArtifactStoreData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
