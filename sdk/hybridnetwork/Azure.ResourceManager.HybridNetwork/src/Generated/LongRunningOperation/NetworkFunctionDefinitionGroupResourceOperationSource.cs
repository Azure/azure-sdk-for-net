...
{
    /// <summary></summary>
    internal partial class NetworkFunctionDefinitionGroupResourceOperationSource : IOperationSource<NetworkFunctionDefinitionGroupResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkFunctionDefinitionGroupResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
