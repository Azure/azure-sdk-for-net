...
namespace Azure.ResourceManager.HybridNetwork
{
    ...
    public partial class ConfigurationGroupSchemaResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the ConfigurationGroupSchema.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/publishers/{publisherName}/configurationGroupSchemas/{configurationGroupSchemaName}. </description>
        ...
        public virtual async Task<ArmOperation<ConfigurationGroupSchemaResource>> UpdateAsync(WaitUntil waitUntil, ConfigurationGroupSchemaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _configurationGroupSchemasRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ConfigurationGroupSchemaData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ConfigurationGroupSchemaResource> Update(WaitUntil waitUntil, ConfigurationGroupSchemaData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
