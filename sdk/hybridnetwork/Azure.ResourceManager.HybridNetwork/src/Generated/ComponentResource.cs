...
namespace Azure.ResourceManager.HybridNetwork
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ComponentResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="NetworkFunctionResource"/> using the GetComponents method.
    /// </summary>
    public partial class ComponentResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ComponentResource for mocking. </summary>
        protected ComponentResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ComponentResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridNetwork/networkFunctions/{networkFunctionName}/components/{componentName}";
        ...
        {
            using DiagnosticScope scope = _componentsClientDiagnostics.CreateScope("ComponentResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _componentsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
