...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    public static partial class ArmHybridNetworkModelFactory
    {
        ...
        public static ConfigurationGroupSchemaData ConfigurationGroupSchemaData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ConfigurationGroupSchemaPropertiesFormat properties = null)
        {
            ...
            return new ConfigurationGroupSchemaData(id, name, resourceType, systemData, tags, location, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ConfigurationGroupSchemaPropertiesFormat(provisioningState, versionState, description, schemaDefinition, new Dictionary<string, BinaryData>());
        }
        ...
        public static ConfigurationGroupValueData ConfigurationGroupValueData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ConfigurationGroupValuePropertiesFormat properties = null)
        {
            ...
            return new ConfigurationGroupValueData(id, name, resourceType, systemData, tags, location, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownConfigurationGroupValuePropertiesFormat(provisioningState, publisherName, publisherScope, configurationGroupSchemaName, configurationGroupSchemaOfferingLocation, configurationGroupSchemaResourceReference, configurationType, new Dictionary<string, BinaryData>());
        }
        ...
        public static NetworkFunctionData NetworkFunctionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, NetworkFunctionPropertiesFormat properties = null, ETag? etag = null, ManagedServiceIdentity identity = null)
        {
            ...
            return new NetworkFunctionData(id, name, resourceType, systemData, tags, location, properties, etag, identity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RequestMetadata(relativePath, httpMethod, serializedBody, apiVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComponentData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComponentProperties(provisioningState, deploymentProfile, deploymentStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeploymentStatusProperties(status, resources, nextExpectedUpdateOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static ComponentKubernetesResources ComponentKubernetesResources(IEnumerable<KubernetesDeployment> deployments = null, IEnumerable<KubernetesPod> pods = null, IEnumerable<KubernetesReplicaSet> replicaSets = null, IEnumerable<KubernetesStatefulSet> statefulSets = null, IEnumerable<KubernetesDaemonSet> daemonSets = null)
        {
            ...
            return new ComponentKubernetesResources(deployments?.ToList(), pods?.ToList(), replicaSets?.ToList(), statefulSets?.ToList(), daemonSets?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KubernetesDeployment(name, @namespace, desiredNumberOfPods, readyNumberOfPods, upToDateNumberOfPods, availableNumberOfPods, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static KubernetesPod KubernetesPod(string name = null, string @namespace = null, int? desiredNumberOfContainers = null, int? readyNumberOfContainers = null, PodStatus? status = null, DateTimeOffset? createdOn = null, IEnumerable<PodEvent> events = null)
        {
            ...
            return new KubernetesPod(name, @namespace, desiredNumberOfContainers, readyNumberOfContainers, status, createdOn, events?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PodEvent(eventType, reason, message, lastSeenOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KubernetesReplicaSet(name, @namespace, desiredNumberOfPods, readyNumberOfPods, currentNumberOfPods, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KubernetesStatefulSet(name, @namespace, desiredNumberOfPods, readyNumberOfPods, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KubernetesDaemonSet(name, @namespace, desiredNumberOfPods, currentNumberOfPods, readyNumberOfPods, upToDateNumberOfPods, availableNumberOfPods, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static NetworkFunctionDefinitionGroupData NetworkFunctionDefinitionGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, NetworkFunctionDefinitionGroupPropertiesFormat properties = null)
        {
            ...
            return new NetworkFunctionDefinitionGroupData(id, name, resourceType, systemData, tags, location, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NetworkFunctionDefinitionGroupPropertiesFormat(provisioningState, description, new Dictionary<string, BinaryData>());
        }
        ...
        public static NetworkFunctionDefinitionVersionData NetworkFunctionDefinitionVersionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, NetworkFunctionDefinitionVersionPropertiesFormat properties = null)
        {
            ...
            return new NetworkFunctionDefinitionVersionData(id, name, resourceType, systemData, tags, location, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownNetworkFunctionDefinitionVersionPropertiesFormat(provisioningState, versionState, description, deployParameters, networkFunctionType, new Dictionary<string, BinaryData>());
        }
        ...
        public static NetworkServiceDesignGroupData NetworkServiceDesignGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, NetworkServiceDesignGroupPropertiesFormat properties = null)
        {
            ...
            return new NetworkServiceDesignGroupData(id, name, resourceType, systemData, tags, location, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NetworkServiceDesignGroupPropertiesFormat(provisioningState, description, new Dictionary<string, BinaryData>());
        }
        ...
        public static NetworkServiceDesignVersionData NetworkServiceDesignVersionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, NetworkServiceDesignVersionPropertiesFormat properties = null)
        {
            ...
            return new NetworkServiceDesignVersionData(id, name, resourceType, systemData, tags, location, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static NetworkServiceDesignVersionPropertiesFormat NetworkServiceDesignVersionPropertiesFormat(ProvisioningState? provisioningState = null, VersionState? versionState = null, string description = null, IDictionary<string, WritableSubResource> configurationGroupSchemaReferences = null, IDictionary<string, NfviDetails> nfvisFromSite = null, IEnumerable<ResourceElementTemplate> resourceElementTemplates = null)
        {
            ...
            return new NetworkServiceDesignVersionPropertiesFormat(provisioningState, versionState, description, configurationGroupSchemaReferences, nfvisFromSite, resourceElementTemplates?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static PublisherData PublisherData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, PublisherPropertiesFormat properties = null, ManagedServiceIdentity identity = null)
        {
            ...
            return new PublisherData(id, name, resourceType, systemData, tags, location, properties, identity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PublisherPropertiesFormat(provisioningState, scope, new Dictionary<string, BinaryData>());
        }
        ...
        public static ArtifactStoreData ArtifactStoreData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ArtifactStorePropertiesFormat properties = null)
        {
            ...
            return new ArtifactStoreData(id, name, resourceType, systemData, tags, location, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ArtifactStorePropertiesFormat(provisioningState, storeType, replicationStrategy, managedResourceGroupConfiguration, storageResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        public static ArtifactManifestData ArtifactManifestData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ArtifactManifestPropertiesFormat properties = null)
        {
            ...
            return new ArtifactManifestData(id, name, resourceType, systemData, tags, location, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static ArtifactManifestPropertiesFormat ArtifactManifestPropertiesFormat(ProvisioningState? provisioningState = null, ArtifactManifestState? artifactManifestState = null, IEnumerable<ManifestArtifactFormat> artifacts = null)
        {
            ...
            return new ArtifactManifestPropertiesFormat(provisioningState, artifactManifestState, artifacts?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProxyArtifactListOverview(id, name, resourceType, systemData, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProxyArtifactVersionsListOverview(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProxyArtifactOverviewPropertiesValue(artifactType, artifactVersion, artifactState, new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteData SiteData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SitePropertiesFormat properties = null)
        {
            ...
            return new SiteData(id, name, resourceType, systemData, tags, location, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static SitePropertiesFormat SitePropertiesFormat(ProvisioningState? provisioningState = null, IEnumerable<NFVIs> nfvis = null, IEnumerable<WritableSubResource> siteNetworkServiceReferences = null)
        {
            ...
            return new SitePropertiesFormat(provisioningState, nfvis?.ToList(), siteNetworkServiceReferences?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static SiteNetworkServiceData SiteNetworkServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, SiteNetworkServicePropertiesFormat properties = null, ManagedServiceIdentity identity = null, HybridNetworkSku sku = null)
        {
            ...
            return new SiteNetworkServiceData(id, name, resourceType, systemData, tags, location, properties, identity, sku, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new HybridNetworkSku(name, tier, new Dictionary<string, BinaryData>());
        }
        ...
        public static AzureContainerRegistryScopedTokenCredential AzureContainerRegistryScopedTokenCredential(string username = null, string acrToken = null, Uri acrServerUri = null, IEnumerable<string> repositories = null, DateTimeOffset? expiry = null)
        {
            ...
            return new AzureContainerRegistryScopedTokenCredential(CredentialType.AzureContainerRegistryScopedToken, new Dictionary<string, BinaryData>(), username, acrToken, acrServerUri, repositories?.ToList(), expiry);
        }
        ...
        public static AzureStorageAccountCredential AzureStorageAccountCredential(ResourceIdentifier storageAccountId = null, IEnumerable<AzureStorageAccountContainerCredential> containerCredentials = null, DateTimeOffset? expiry = null)
        {
            ...
            return new AzureStorageAccountCredential(CredentialType.AzureStorageAccountToken, new Dictionary<string, BinaryData>(), storageAccountId, containerCredentials?.ToList(), expiry);
        }
        ...
        {
            return new AzureStorageAccountContainerCredential(containerName, containerSasUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ConfigurationValueWithSecrets(provisioningState, publisherName, publisherScope, configurationGroupSchemaName, configurationGroupSchemaOfferingLocation, configurationGroupSchemaResourceReference, ConfigurationGroupValueConfigurationType.Secret, new Dictionary<string, BinaryData>(), secretConfigurationValue);
        }
        ...
        {
            return new ConfigurationValueWithoutSecrets(provisioningState, publisherName, publisherScope, configurationGroupSchemaName, configurationGroupSchemaOfferingLocation, configurationGroupSchemaResourceReference, ConfigurationGroupValueConfigurationType.Open, new Dictionary<string, BinaryData>(), configurationValue);
        }
        ...
        public static NetworkFunctionValueWithoutSecrets NetworkFunctionValueWithoutSecrets(ProvisioningState? provisioningState = null, string publisherName = null, PublisherScope? publisherScope = null, string networkFunctionDefinitionGroupName = null, string networkFunctionDefinitionVersion = null, string networkFunctionDefinitionOfferingLocation = null, DeploymentResourceIdReference networkFunctionDefinitionVersionResourceReference = null, NfviType? nfviType = null, ResourceIdentifier nfviId = null, bool? allowSoftwareUpdate = null, IEnumerable<string> roleOverrideValues = null, string deploymentValues = null)
        {
            ...
            return new NetworkFunctionValueWithoutSecrets(provisioningState, publisherName, publisherScope, networkFunctionDefinitionGroupName, networkFunctionDefinitionVersion, networkFunctionDefinitionOfferingLocation, networkFunctionDefinitionVersionResourceReference, nfviType, nfviId, allowSoftwareUpdate, NetworkFunctionConfigurationType.Open, roleOverrideValues?.ToList(), new Dictionary<string, BinaryData>(), deploymentValues);
        }
        ...
        {
            return new ContainerizedNetworkFunctionDefinitionVersion(provisioningState, versionState, description, deployParameters, NetworkFunctionType.ContainerizedNetworkFunction, new Dictionary<string, BinaryData>(), networkFunctionTemplate);
        }
        ...
        {
            return new VirtualNetworkFunctionDefinitionVersion(provisioningState, versionState, description, deployParameters, NetworkFunctionType.VirtualNetworkFunction, new Dictionary<string, BinaryData>(), networkFunctionTemplate);
        }
    }
}
