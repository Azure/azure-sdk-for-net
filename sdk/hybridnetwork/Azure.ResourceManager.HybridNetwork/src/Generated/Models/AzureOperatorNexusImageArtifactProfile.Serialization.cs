...
{
    public partial class AzureOperatorNexusImageArtifactProfile : IUtf8JsonSerializable, IJsonModel<AzureOperatorNexusImageArtifactProfile>, IPersistableModel<AzureOperatorNexusImageArtifactProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ImageArtifactProfile))
            {
                ...
                AppendChildObject(builder, ImageArtifactProfile, options, 2);
            }
