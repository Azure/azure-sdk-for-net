...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    public partial class HelmMappingRuleProfile
    {
        ...
        internal HelmMappingRuleProfile(string releaseNamespace, string releaseName, string helmPackageVersion, string values, HelmMappingRuleProfileConfig options, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
