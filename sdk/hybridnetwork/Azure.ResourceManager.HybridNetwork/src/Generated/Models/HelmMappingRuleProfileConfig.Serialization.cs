...
{
    public partial class HelmMappingRuleProfileConfig : IUtf8JsonSerializable, IJsonModel<HelmMappingRuleProfileConfig>, IPersistableModel<HelmMappingRuleProfileConfig>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InstallOptions))
            {
                ...
                AppendChildObject(builder, InstallOptions, options, 2);
            }

            if (Optional.IsDefined(UpgradeOptions))
            {
                builder.Append("  upgradeOptions:");
                AppendChildObject(builder, UpgradeOptions, options, 2);
            }
