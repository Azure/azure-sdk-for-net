...
{
    public partial class NetworkServiceDesignVersionPropertiesFormat : IUtf8JsonSerializable, IJsonModel<NetworkServiceDesignVersionPropertiesFormat>, IPersistableModel<NetworkServiceDesignVersionPropertiesFormat>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ConfigurationGroupSchemaReferences))
            {
                builder.Append("  configurationGroupSchemaReferences:");
                builder.AppendLine(" {");
                foreach (var item in ConfigurationGroupSchemaReferences)
                {
            ...
            if (Optional.IsCollectionDefined(ResourceElementTemplates))
            {
                builder.Append("  resourceElementTemplates:");
                builder.AppendLine(" [");
                foreach (var item in ResourceElementTemplates)
                {
