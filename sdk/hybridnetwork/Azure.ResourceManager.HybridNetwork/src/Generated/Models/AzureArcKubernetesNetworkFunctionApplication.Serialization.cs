...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureArcKubernetesNetworkFunctionApplication>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureArcKubernetesNetworkFunctionApplication>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureArcKubernetesNetworkFunctionApplication>)} interface");
            }
        ...
        string IPersistableModel<AzureArcKubernetesNetworkFunctionApplication>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
