...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureOperatorNexusNetworkFunctionArmTemplateApplication>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureOperatorNexusNetworkFunctionArmTemplateApplication>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureOperatorNexusNetworkFunctionArmTemplateApplication>)} interface");
            }
        ...
        string IPersistableModel<AzureOperatorNexusNetworkFunctionArmTemplateApplication>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
