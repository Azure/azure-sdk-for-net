...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArtifactChangeStateProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArtifactChangeStateProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArtifactChangeStateProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArtifactChangeStateProperties>)} interface");
            }
        ...
        string IPersistableModel<ArtifactChangeStateProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
