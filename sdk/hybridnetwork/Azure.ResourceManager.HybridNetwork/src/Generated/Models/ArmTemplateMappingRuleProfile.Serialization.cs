...
{
    internal partial class ArmTemplateMappingRuleProfile : IUtf8JsonSerializable, IJsonModel<ArmTemplateMappingRuleProfile>, IPersistableModel<ArmTemplateMappingRuleProfile>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmTemplateMappingRuleProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ArmTemplateMappingRuleProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ArmTemplateMappingRuleProfile)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TemplateParameters))
            {
                ...
                builder.AppendLine($" '{TemplateParameters}'");
            }
