...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureCoreArmTemplateDeployMappingRuleProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureCoreArmTemplateDeployMappingRuleProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureCoreArmTemplateDeployMappingRuleProfile>)} interface");
            }
        ...
        string IPersistableModel<AzureCoreArmTemplateDeployMappingRuleProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
