...
{
    public partial class SecretDeploymentResourceReference : IUtf8JsonSerializable, IJsonModel<SecretDeploymentResourceReference>, IPersistableModel<SecretDeploymentResourceReference>
    {
        ...
        void IJsonModel<SecretDeploymentResourceReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SecretDeploymentResourceReference)} does not support '{format}' format.");
            }
