...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OpenDeploymentResourceReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OpenDeploymentResourceReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OpenDeploymentResourceReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OpenDeploymentResourceReference>)} interface");
            }
        ...
        string IPersistableModel<OpenDeploymentResourceReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
