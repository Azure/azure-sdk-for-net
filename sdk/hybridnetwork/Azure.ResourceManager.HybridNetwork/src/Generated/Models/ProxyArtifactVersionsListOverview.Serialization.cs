...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    public partial class ProxyArtifactVersionsListOverview : IUtf8JsonSerializable, IJsonModel<ProxyArtifactVersionsListOverview>
    {
        ...
        void IJsonModel<ProxyArtifactVersionsListOverview>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ProxyArtifactVersionsListOverview)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ProxyArtifactVersionsListOverview>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ProxyArtifactVersionsListOverview)} does not support '{options.Format}' format.");
            }
        }
