...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProxyArtifactVersionsListOverview>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProxyArtifactVersionsListOverview>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProxyArtifactVersionsListOverview>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProxyArtifactVersionsListOverview>)} interface");
            }
        ...
        string IPersistableModel<ProxyArtifactVersionsListOverview>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
