...
{
    public partial class AzureCoreVhdImageArtifactProfile : IUtf8JsonSerializable, IJsonModel<AzureCoreVhdImageArtifactProfile>, IPersistableModel<AzureCoreVhdImageArtifactProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VhdArtifactProfile))
            {
                builder.Append("  vhdArtifactProfile:");
                AppendChildObject(builder, VhdArtifactProfile, options, 2);
            }
