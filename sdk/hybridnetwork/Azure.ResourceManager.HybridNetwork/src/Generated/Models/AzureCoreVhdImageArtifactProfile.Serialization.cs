...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureCoreVhdImageArtifactProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureCoreVhdImageArtifactProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureCoreVhdImageArtifactProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureCoreVhdImageArtifactProfile>)} interface");
            }
        ...
        string IPersistableModel<AzureCoreVhdImageArtifactProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
