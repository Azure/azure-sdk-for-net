...
{
    public partial class NSDArtifactProfile : IUtf8JsonSerializable, IJsonModel<NSDArtifactProfile>, IPersistableModel<NSDArtifactProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ArtifactStoreReference))
            {
                ...
                AppendChildObject(builder, ArtifactStoreReference, options, 2);
            }
