...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NSDArtifactProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NSDArtifactProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NSDArtifactProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NSDArtifactProfile>)} interface");
            }
        ...
        string IPersistableModel<NSDArtifactProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
