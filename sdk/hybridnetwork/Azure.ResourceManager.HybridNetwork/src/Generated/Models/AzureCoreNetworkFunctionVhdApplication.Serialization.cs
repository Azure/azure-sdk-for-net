...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureCoreNetworkFunctionVhdApplication>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureCoreNetworkFunctionVhdApplication>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureCoreNetworkFunctionVhdApplication>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureCoreNetworkFunctionVhdApplication>)} interface");
            }
        ...
        string IPersistableModel<AzureCoreNetworkFunctionVhdApplication>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
