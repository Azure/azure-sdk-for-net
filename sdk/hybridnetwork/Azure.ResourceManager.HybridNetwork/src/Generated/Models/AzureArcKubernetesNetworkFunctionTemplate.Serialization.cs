...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureArcKubernetesNetworkFunctionTemplate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureArcKubernetesNetworkFunctionTemplate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureArcKubernetesNetworkFunctionTemplate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureArcKubernetesNetworkFunctionTemplate>)} interface");
            }
        ...
        string IPersistableModel<AzureArcKubernetesNetworkFunctionTemplate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
