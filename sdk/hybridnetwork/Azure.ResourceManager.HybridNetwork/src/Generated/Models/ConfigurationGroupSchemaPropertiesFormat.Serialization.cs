...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigurationGroupSchemaPropertiesFormat>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConfigurationGroupSchemaPropertiesFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfigurationGroupSchemaPropertiesFormat>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ConfigurationGroupSchemaPropertiesFormat>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
