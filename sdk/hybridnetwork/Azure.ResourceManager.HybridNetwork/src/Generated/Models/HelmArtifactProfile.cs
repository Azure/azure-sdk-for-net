...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    public partial class HelmArtifactProfile
    {
        ...
        internal HelmArtifactProfile(string helmPackageName, string helmPackageVersionRange, IList<string> registryValuesPaths, IList<string> imagePullSecretsValuesPaths, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
