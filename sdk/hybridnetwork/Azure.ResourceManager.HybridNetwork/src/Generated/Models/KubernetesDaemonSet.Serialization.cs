...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KubernetesDaemonSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KubernetesDaemonSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KubernetesDaemonSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KubernetesDaemonSet>)} interface");
            }
        ...
        string IPersistableModel<KubernetesDaemonSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
