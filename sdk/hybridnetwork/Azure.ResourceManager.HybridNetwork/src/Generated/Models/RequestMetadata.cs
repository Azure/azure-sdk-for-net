...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    public partial class RequestMetadata
    {
        ...
        internal RequestMetadata(string relativePath, HttpMethod httpMethod, string serializedBody, string apiVersion, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            RelativePath = relativePath;
            HttpMethod = httpMethod;
            SerializedBody = serializedBody;
