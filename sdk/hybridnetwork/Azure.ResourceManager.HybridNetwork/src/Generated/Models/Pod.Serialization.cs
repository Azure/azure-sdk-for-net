...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        internal static Pod DeserializePod(JsonElement element)
        {
            ...
            return new Pod(name.Value, @namespace.Value, Optional.ToNullable(desired), Optional.ToNullable(ready), Optional.ToNullable(status), Optional.ToNullable(creationTime), Optional.ToList(events));
        }
    }
}
