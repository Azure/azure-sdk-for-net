...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    public partial class ConfigurationValueWithSecrets : ConfigurationGroupValuePropertiesFormat, IJsonModel<ConfigurationValueWithSecrets>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConfigurationValueWithSecrets>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ConfigurationValueWithSecrets>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ConfigurationValueWithSecrets IPersistableModel<ConfigurationValueWithSecrets>.Create(BinaryData data, ModelReaderWriterOptions options) => (ConfigurationValueWithSecrets)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConfigurationValueWithSecrets IJsonModel<ConfigurationValueWithSecrets>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ConfigurationValueWithSecrets)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ConfigurationValueWithSecrets DeserializeConfigurationValueWithSecrets(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("secretConfigurationValue"u8))
                {
                    secretConfigurationValue = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
