...
{
    public partial class ConfigurationValueWithSecrets : IUtf8JsonSerializable, IJsonModel<ConfigurationValueWithSecrets>, IPersistableModel<ConfigurationValueWithSecrets>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SecretConfigurationValue))
            {
                builder.Append("  secretConfigurationValue:");
                builder.AppendLine($" '{SecretConfigurationValue}'");
            }
