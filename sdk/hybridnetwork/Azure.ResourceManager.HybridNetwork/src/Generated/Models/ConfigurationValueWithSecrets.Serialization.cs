...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigurationValueWithSecrets>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConfigurationValueWithSecrets>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfigurationValueWithSecrets>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConfigurationValueWithSecrets>)} interface");
            }
        ...
        string IPersistableModel<ConfigurationValueWithSecrets>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
