...
{
    internal partial class UnknownAzureArcKubernetesNetworkFunctionApplication : AzureArcKubernetesNetworkFunctionApplication, IJsonModel<AzureArcKubernetesNetworkFunctionApplication>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownAzureArcKubernetesNetworkFunctionApplication DeserializeUnknownAzureArcKubernetesNetworkFunctionApplication(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownAzureArcKubernetesNetworkFunctionApplication(name, dependsOnProfile, additionalBinaryDataProperties, artifactType);
        }
    }
}
