...
{
    internal partial class UnknownAzureArcKubernetesNetworkFunctionApplication : IUtf8JsonSerializable
    {
        ...
        internal static UnknownAzureArcKubernetesNetworkFunctionApplication DeserializeUnknownAzureArcKubernetesNetworkFunctionApplication(JsonElement element)
        {
            ...
            return new UnknownAzureArcKubernetesNetworkFunctionApplication(name.Value, dependsOnProfile.Value, artifactType);
        }
    }
}
