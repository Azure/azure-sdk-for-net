...
{
    public partial class AzureStorageAccountContainerCredential : IUtf8JsonSerializable, IJsonModel<AzureStorageAccountContainerCredential>, IPersistableModel<AzureStorageAccountContainerCredential>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ContainerSasUri))
            {
                builder.Append("  containerSasUri:");
                builder.AppendLine($" '{ContainerSasUri.AbsoluteUri}'");
            }
