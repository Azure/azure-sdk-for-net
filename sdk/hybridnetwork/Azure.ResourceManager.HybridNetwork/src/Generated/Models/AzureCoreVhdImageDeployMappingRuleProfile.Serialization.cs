...
{
    public partial class AzureCoreVhdImageDeployMappingRuleProfile : IUtf8JsonSerializable, IJsonModel<AzureCoreVhdImageDeployMappingRuleProfile>, IPersistableModel<AzureCoreVhdImageDeployMappingRuleProfile>
    {
        ...
        void IJsonModel<AzureCoreVhdImageDeployMappingRuleProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureCoreVhdImageDeployMappingRuleProfile)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VhdImageMappingRuleProfile))
            {
                builder.Append("  vhdImageMappingRuleProfile:");
                AppendChildObject(builder, VhdImageMappingRuleProfile, options, 2);
            }
