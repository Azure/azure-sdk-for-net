...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureContainerRegistryScopedTokenCredential>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureContainerRegistryScopedTokenCredential>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureContainerRegistryScopedTokenCredential>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureContainerRegistryScopedTokenCredential>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
