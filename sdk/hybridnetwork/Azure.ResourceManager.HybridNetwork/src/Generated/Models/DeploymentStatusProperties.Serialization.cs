...
{
    public partial class DeploymentStatusProperties : IUtf8JsonSerializable, IJsonModel<DeploymentStatusProperties>, IPersistableModel<DeploymentStatusProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NextExpectedUpdateOn))
            {
                builder.Append("  nextExpectedUpdateAt:");
                builder.AppendLine($" '{NextExpectedUpdateOn.Value.ToString()}'");
            }
