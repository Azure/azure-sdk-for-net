...
{
    public partial class MappingRuleProfile : IUtf8JsonSerializable, IJsonModel<MappingRuleProfile>, IPersistableModel<MappingRuleProfile>
    {
        ...
        void IJsonModel<MappingRuleProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MappingRuleProfile)} does not support '{format}' format.");
            }
