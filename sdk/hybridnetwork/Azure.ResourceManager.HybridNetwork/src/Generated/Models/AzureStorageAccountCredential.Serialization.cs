...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureStorageAccountCredential>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureStorageAccountCredential>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureStorageAccountCredential>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureStorageAccountCredential>)} interface");
            }
        ...
        string IPersistableModel<AzureStorageAccountCredential>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
