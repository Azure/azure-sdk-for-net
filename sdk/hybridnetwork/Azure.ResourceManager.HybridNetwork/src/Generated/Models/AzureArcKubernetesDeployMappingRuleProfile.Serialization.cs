...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureArcKubernetesDeployMappingRuleProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureArcKubernetesDeployMappingRuleProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureArcKubernetesDeployMappingRuleProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureArcKubernetesDeployMappingRuleProfile>)} interface");
            }
        ...
        string IPersistableModel<AzureArcKubernetesDeployMappingRuleProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
