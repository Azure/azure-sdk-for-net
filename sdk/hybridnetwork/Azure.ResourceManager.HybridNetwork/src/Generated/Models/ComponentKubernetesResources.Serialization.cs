...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComponentKubernetesResources>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComponentKubernetesResources>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComponentKubernetesResources>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComponentKubernetesResources>)} interface");
            }
        ...
        string IPersistableModel<ComponentKubernetesResources>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
