...
{
    internal partial class UnknownAzureCoreNetworkFunctionApplication : IUtf8JsonSerializable
    {
        ...
        internal static UnknownAzureCoreNetworkFunctionApplication DeserializeUnknownAzureCoreNetworkFunctionApplication(JsonElement element)
        {
            ...
            return new UnknownAzureCoreNetworkFunctionApplication(name.Value, dependsOnProfile.Value, artifactType);
        }
    }
}
