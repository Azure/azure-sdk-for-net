...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProxyArtifactOverviewListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProxyArtifactOverviewListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProxyArtifactOverviewListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProxyArtifactOverviewListResult>)} interface");
            }
        ...
        string IPersistableModel<ProxyArtifactOverviewListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
