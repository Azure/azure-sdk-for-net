...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HelmArtifactProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HelmArtifactProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HelmArtifactProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HelmArtifactProfile>)} interface");
            }
        ...
        string IPersistableModel<HelmArtifactProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
