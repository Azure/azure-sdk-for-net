...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkFunctionDefinitionResourceElementTemplateDetails>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        NetworkFunctionDefinitionResourceElementTemplateDetails IJsonModel<NetworkFunctionDefinitionResourceElementTemplateDetails>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<NetworkFunctionDefinitionResourceElementTemplateDetails>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        NetworkFunctionDefinitionResourceElementTemplateDetails IModel<NetworkFunctionDefinitionResourceElementTemplateDetails>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<NetworkFunctionDefinitionResourceElementTemplateDetails>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
