...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkServiceDesignGroupListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NetworkServiceDesignGroupListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkServiceDesignGroupListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkServiceDesignGroupListResult>)} interface");
            }
        ...
        string IPersistableModel<NetworkServiceDesignGroupListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
