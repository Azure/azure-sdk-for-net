...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureCoreNetworkFunctionTemplate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureCoreNetworkFunctionTemplate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureCoreNetworkFunctionTemplate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureCoreNetworkFunctionTemplate>)} interface");
            }
        ...
        string IPersistableModel<AzureCoreNetworkFunctionTemplate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
