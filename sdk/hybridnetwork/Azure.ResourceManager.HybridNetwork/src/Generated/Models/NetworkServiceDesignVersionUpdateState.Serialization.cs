...
{
    public partial class NetworkServiceDesignVersionUpdateState : IUtf8JsonSerializable, IJsonModel<NetworkServiceDesignVersionUpdateState>, IPersistableModel<NetworkServiceDesignVersionUpdateState>
    {
        ...
        void IJsonModel<NetworkServiceDesignVersionUpdateState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkServiceDesignVersionUpdateState)} does not support '{format}' format.");
            }
