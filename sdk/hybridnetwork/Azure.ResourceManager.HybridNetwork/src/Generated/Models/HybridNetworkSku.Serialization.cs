...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridNetworkSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HybridNetworkSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HybridNetworkSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HybridNetworkSku>)} interface");
            }
        ...
        string IPersistableModel<HybridNetworkSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
