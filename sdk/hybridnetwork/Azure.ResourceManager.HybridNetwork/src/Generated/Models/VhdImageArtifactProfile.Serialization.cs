...
{
    public partial class VhdImageArtifactProfile : IUtf8JsonSerializable, IJsonModel<VhdImageArtifactProfile>, IPersistableModel<VhdImageArtifactProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VhdVersion))
            {
                builder.Append("  vhdVersion:");
                builder.AppendLine($" '{VhdVersion}'");
            }
