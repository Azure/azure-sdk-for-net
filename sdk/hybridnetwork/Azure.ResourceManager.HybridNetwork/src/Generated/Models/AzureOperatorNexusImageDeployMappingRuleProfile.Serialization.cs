...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureOperatorNexusImageDeployMappingRuleProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureOperatorNexusImageDeployMappingRuleProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureOperatorNexusImageDeployMappingRuleProfile>)} interface");
            }
        ...
        string IPersistableModel<AzureOperatorNexusImageDeployMappingRuleProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
