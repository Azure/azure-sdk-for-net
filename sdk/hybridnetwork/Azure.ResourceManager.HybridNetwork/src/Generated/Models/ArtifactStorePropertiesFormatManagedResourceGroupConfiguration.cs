...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    public partial class ArtifactStorePropertiesFormatManagedResourceGroupConfiguration
    {
        ...
        internal ArtifactStorePropertiesFormatManagedResourceGroupConfiguration(string name, AzureLocation? location, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Location = location;
