...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    public partial class ProxyArtifactVersionsListOverview : ResourceData
    {
        ...
        internal ProxyArtifactVersionsListOverview(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ProxyArtifactOverviewPropertiesValue properties) : base(id, name, resourceType, systemData)
        {
