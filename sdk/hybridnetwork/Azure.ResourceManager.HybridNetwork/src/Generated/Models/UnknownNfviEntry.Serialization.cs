...
{
    internal partial class UnknownNfviEntry : NfviEntry, IJsonModel<NfviEntry>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownNfviEntry"/> for deserialization. </summary>
        internal UnknownNfviEntry()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownNfviEntry DeserializeUnknownNfviEntry(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownNfviEntry(name, nfviType, additionalBinaryDataProperties);
        }
    }
}
