...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KubernetesDeployment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KubernetesDeployment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KubernetesDeployment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KubernetesDeployment>)} interface");
            }
        ...
        string IPersistableModel<KubernetesDeployment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
