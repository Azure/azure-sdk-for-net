...
{
    public partial class ConfigurationValueWithoutSecrets : IUtf8JsonSerializable, IJsonModel<ConfigurationValueWithoutSecrets>, IPersistableModel<ConfigurationValueWithoutSecrets>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConfigurationValue))
            {
                builder.Append("  configurationValue:");
                builder.AppendLine($" '{ConfigurationValue}'");
            }
