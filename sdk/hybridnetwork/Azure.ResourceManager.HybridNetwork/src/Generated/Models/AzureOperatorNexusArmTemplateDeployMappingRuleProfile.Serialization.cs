...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureOperatorNexusArmTemplateDeployMappingRuleProfile>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        AzureOperatorNexusArmTemplateDeployMappingRuleProfile IJsonModel<AzureOperatorNexusArmTemplateDeployMappingRuleProfile>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<AzureOperatorNexusArmTemplateDeployMappingRuleProfile>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AzureOperatorNexusArmTemplateDeployMappingRuleProfile IModel<AzureOperatorNexusArmTemplateDeployMappingRuleProfile>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AzureOperatorNexusArmTemplateDeployMappingRuleProfile>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
