...
{
    public partial class AzureOperatorNexusArmTemplateDeployMappingRuleProfile : IUtf8JsonSerializable, IJsonModel<AzureOperatorNexusArmTemplateDeployMappingRuleProfile>, IPersistableModel<AzureOperatorNexusArmTemplateDeployMappingRuleProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TemplateMappingRuleProfile))
            {
                builder.Append("  templateMappingRuleProfile:");
                AppendChildObject(builder, TemplateMappingRuleProfile, options, 2);
            }
