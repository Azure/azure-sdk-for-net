...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigurationGroupSchemaVersionUpdateState>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConfigurationGroupSchemaVersionUpdateState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfigurationGroupSchemaVersionUpdateState>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ConfigurationGroupSchemaVersionUpdateState>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
