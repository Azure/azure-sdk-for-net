...
{
    internal partial class VhdImageMappingRuleProfile : IUtf8JsonSerializable, IJsonModel<VhdImageMappingRuleProfile>, IPersistableModel<VhdImageMappingRuleProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UserConfiguration))
            {
                ...
                builder.AppendLine($" '{UserConfiguration}'");
            }
