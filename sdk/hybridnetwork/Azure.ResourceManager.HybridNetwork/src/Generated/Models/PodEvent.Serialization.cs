...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PodEvent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PodEvent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PodEvent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PodEvent>)} interface");
            }
        ...
        string IPersistableModel<PodEvent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
