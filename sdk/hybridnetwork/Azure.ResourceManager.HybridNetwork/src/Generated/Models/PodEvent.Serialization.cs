...
{
    public partial class PodEvent : IUtf8JsonSerializable, IJsonModel<PodEvent>, IPersistableModel<PodEvent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastSeenOn))
            {
                builder.Append("  lastSeenTime:");
                builder.AppendLine($" '{LastSeenOn.Value.ToString()}'");
            }
