...
{
    public partial class SitePropertiesFormat : IUtf8JsonSerializable, IJsonModel<SitePropertiesFormat>, IPersistableModel<SitePropertiesFormat>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  siteNetworkServiceReferences:");
                builder.AppendLine(" [");
                foreach (var item in SiteNetworkServiceReferences)
                {
                    AppendChildObject(builder, item, options, 4);
