...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    public partial class PodEvent
    {
        ...
        internal PodEvent(PodEventType? eventType, string reason, string message, DateTimeOffset? lastSeenOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            EventType = eventType;
            Reason = reason;
            Message = message;
