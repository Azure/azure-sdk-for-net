...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArtifactChangeState>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArtifactChangeState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArtifactChangeState>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ArtifactChangeState>)} interface");
            }
        ...
        string IPersistableModel<ArtifactChangeState>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
