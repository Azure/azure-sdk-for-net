...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    internal partial class UnknownArtifactAccessCredential : IUtf8JsonSerializable, IJsonModel<ArtifactAccessCredential>
    {
        ...
        void IJsonModel<ArtifactAccessCredential>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ArtifactAccessCredential)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ArtifactAccessCredential>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ArtifactAccessCredential)} does not support '{options.Format}' format.");
            }
        }
