...
{
    internal partial class UnknownAzureOperatorNexusNetworkFunctionApplication : IUtf8JsonSerializable, IJsonModel<AzureOperatorNexusNetworkFunctionApplication>, IPersistableModel<AzureOperatorNexusNetworkFunctionApplication>
    {
        ...
        AzureOperatorNexusNetworkFunctionApplication IJsonModel<AzureOperatorNexusNetworkFunctionApplication>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownAzureOperatorNexusNetworkFunctionApplication(document.RootElement, options);
        }
