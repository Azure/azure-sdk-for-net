...
{
    internal partial class UnknownAzureOperatorNexusNetworkFunctionApplication : IUtf8JsonSerializable
    {
        ...
        internal static UnknownAzureOperatorNexusNetworkFunctionApplication DeserializeUnknownAzureOperatorNexusNetworkFunctionApplication(JsonElement element)
        {
            ...
            return new UnknownAzureOperatorNexusNetworkFunctionApplication(name.Value, dependsOnProfile.Value, artifactType);
        }
    }
}
