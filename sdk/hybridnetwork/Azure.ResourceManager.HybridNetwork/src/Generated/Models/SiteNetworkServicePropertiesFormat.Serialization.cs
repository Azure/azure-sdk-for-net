...
{
    public partial class SiteNetworkServicePropertiesFormat : IUtf8JsonSerializable, IJsonModel<SiteNetworkServicePropertiesFormat>, IPersistableModel<SiteNetworkServicePropertiesFormat>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SiteReference))
            {
                ...
                AppendChildObject(builder, SiteReference, options, 2);
            }
            ...
            if (Optional.IsDefined(NetworkServiceDesignVersionResourceReference))
            {
                ...
                AppendChildObject(builder, NetworkServiceDesignVersionResourceReference, options, 2);
            }
