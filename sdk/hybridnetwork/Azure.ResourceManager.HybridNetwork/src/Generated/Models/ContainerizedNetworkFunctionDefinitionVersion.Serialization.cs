...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    public partial class ContainerizedNetworkFunctionDefinitionVersion : IUtf8JsonSerializable
    {
        ...
        internal static ContainerizedNetworkFunctionDefinitionVersion DeserializeContainerizedNetworkFunctionDefinitionVersion(JsonElement element)
        {
            ...
            return new ContainerizedNetworkFunctionDefinitionVersion(Optional.ToNullable(provisioningState), Optional.ToNullable(versionState), description.Value, deployParameters.Value, secretDeployParameters.Value, networkFunctionType, networkFunctionTemplate.Value);
        }
    }
}
