...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageArtifactProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageArtifactProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageArtifactProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageArtifactProfile>)} interface");
            }
        ...
        string IPersistableModel<ImageArtifactProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
