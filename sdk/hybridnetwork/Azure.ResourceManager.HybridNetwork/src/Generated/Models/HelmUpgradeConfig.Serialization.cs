...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HelmUpgradeConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HelmUpgradeConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HelmUpgradeConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HelmUpgradeConfig>)} interface");
            }
        ...
        string IPersistableModel<HelmUpgradeConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
