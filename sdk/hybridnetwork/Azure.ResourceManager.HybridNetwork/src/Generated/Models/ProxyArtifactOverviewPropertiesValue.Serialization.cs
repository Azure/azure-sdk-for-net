...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProxyArtifactOverviewPropertiesValue>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProxyArtifactOverviewPropertiesValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProxyArtifactOverviewPropertiesValue>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProxyArtifactOverviewPropertiesValue>)} interface");
            }
        ...
        string IPersistableModel<ProxyArtifactOverviewPropertiesValue>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
