...
{
    public partial class ProxyArtifactOverviewPropertiesValue : IUtf8JsonSerializable, IJsonModel<ProxyArtifactOverviewPropertiesValue>, IPersistableModel<ProxyArtifactOverviewPropertiesValue>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ArtifactState))
            {
                ...
                builder.AppendLine($" '{ArtifactState.ToString()}'");
            }
