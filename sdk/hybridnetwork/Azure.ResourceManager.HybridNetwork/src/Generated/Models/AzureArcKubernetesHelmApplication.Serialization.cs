...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureArcKubernetesHelmApplication>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureArcKubernetesHelmApplication>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureArcKubernetesHelmApplication>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureArcKubernetesHelmApplication>)} interface");
            }
        ...
        string IPersistableModel<AzureArcKubernetesHelmApplication>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
