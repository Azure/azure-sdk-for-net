...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    public partial class AzureArcKubernetesHelmApplication : AzureArcKubernetesNetworkFunctionApplication, IJsonModel<AzureArcKubernetesHelmApplication>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AzureArcKubernetesHelmApplication>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AzureArcKubernetesHelmApplication>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureArcKubernetesHelmApplication IPersistableModel<AzureArcKubernetesHelmApplication>.Create(BinaryData data, ModelReaderWriterOptions options) => (AzureArcKubernetesHelmApplication)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AzureArcKubernetesHelmApplication IJsonModel<AzureArcKubernetesHelmApplication>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AzureArcKubernetesHelmApplication)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AzureArcKubernetesHelmApplication DeserializeAzureArcKubernetesHelmApplication(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    artifactType = new AzureArcKubernetesArtifactType(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("artifactProfile"u8))
                {
                    ...
                    artifactProfile = AzureArcKubernetesArtifactProfile.DeserializeAzureArcKubernetesArtifactProfile(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("deployParametersMappingRuleProfile"u8))
                {
                    ...
                    deployParametersMappingRuleProfile = AzureArcKubernetesDeployMappingRuleProfile.DeserializeAzureArcKubernetesDeployMappingRuleProfile(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
