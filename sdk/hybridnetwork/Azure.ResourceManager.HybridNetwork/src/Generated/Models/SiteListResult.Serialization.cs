...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SiteListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SiteListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SiteListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SiteListResult>)} interface");
            }
        ...
        string IPersistableModel<SiteListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
