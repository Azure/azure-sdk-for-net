...
{
    public partial class KubernetesReplicaSet : IUtf8JsonSerializable, IJsonModel<KubernetesReplicaSet>, IPersistableModel<KubernetesReplicaSet>
    {
        ...
        void IJsonModel<KubernetesReplicaSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(KubernetesReplicaSet)} does not support '{format}' format.");
            }
