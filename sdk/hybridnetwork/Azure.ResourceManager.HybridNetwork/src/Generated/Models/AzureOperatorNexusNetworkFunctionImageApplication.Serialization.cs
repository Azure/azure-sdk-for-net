...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureOperatorNexusNetworkFunctionImageApplication>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        AzureOperatorNexusNetworkFunctionImageApplication IJsonModel<AzureOperatorNexusNetworkFunctionImageApplication>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<AzureOperatorNexusNetworkFunctionImageApplication>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AzureOperatorNexusNetworkFunctionImageApplication IModel<AzureOperatorNexusNetworkFunctionImageApplication>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AzureOperatorNexusNetworkFunctionImageApplication>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
