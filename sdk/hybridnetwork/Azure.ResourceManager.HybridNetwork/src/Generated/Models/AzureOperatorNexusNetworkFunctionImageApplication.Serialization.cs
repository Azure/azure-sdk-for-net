...
{
    public partial class AzureOperatorNexusNetworkFunctionImageApplication : IUtf8JsonSerializable
    {
        ...
        internal static AzureOperatorNexusNetworkFunctionImageApplication DeserializeAzureOperatorNexusNetworkFunctionImageApplication(JsonElement element)
        {
            ...
            return new AzureOperatorNexusNetworkFunctionImageApplication(name.Value, dependsOnProfile.Value, artifactType, artifactProfile.Value, deployParametersMappingRuleProfile.Value);
        }
    }
}
