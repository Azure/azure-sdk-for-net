...
{
    public partial class AzureOperatorNexusNetworkFunctionImageApplication : IUtf8JsonSerializable, IJsonModel<AzureOperatorNexusNetworkFunctionImageApplication>, IPersistableModel<AzureOperatorNexusNetworkFunctionImageApplication>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ArtifactProfile))
            {
                ...
                AppendChildObject(builder, ArtifactProfile, options, 2);
            }

            if (Optional.IsDefined(DeployParametersMappingRuleProfile))
            {
                builder.Append("  deployParametersMappingRuleProfile:");
                AppendChildObject(builder, DeployParametersMappingRuleProfile, options, 2);
            }
