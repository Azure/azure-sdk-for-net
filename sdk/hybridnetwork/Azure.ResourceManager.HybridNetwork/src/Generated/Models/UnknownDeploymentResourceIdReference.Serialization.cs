...
{
    internal partial class UnknownDeploymentResourceIdReference : IUtf8JsonSerializable, IJsonModel<DeploymentResourceIdReference>, IPersistableModel<DeploymentResourceIdReference>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IdType))
            {
                builder.Append("  idType:");
                builder.AppendLine($" '{IdType.ToString()}'");
            }
