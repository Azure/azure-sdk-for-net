...
namespace Azure.ResourceManager.HybridNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureCoreNfviDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureCoreNfviDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureCoreNfviDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureCoreNfviDetails>)} interface");
            }
        ...
        string IPersistableModel<AzureCoreNfviDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
