...
namespace Azure.ResourceManager.HybridNetwork.Samples
{
    public partial class Sample_SiteNetworkServiceResource
    {
        ...
        public async Task Get_GetNetworkSite()
        {
            ...
            SiteNetworkServiceResource result = await siteNetworkService.GetAsync();
        ...
        public async Task Delete_DeleteNetworkSite()
        {
            ...
            // invoke the operation
            await siteNetworkService.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Update_UpdateNetworkSiteTags()
        {
            ...
            // this example is just showing the usage of "SiteNetworkServices_UpdateTags" operation, for the dependent resources, they will have to be created separately.
