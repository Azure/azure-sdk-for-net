...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    public partial class GuestConfigurationVmssVmInfo
    {
        ...
        internal GuestConfigurationVmssVmInfo(string vmId, string vmResourceId, AssignedGuestConfigurationMachineComplianceStatus? complianceStatus, string latestReportId, DateTimeOffset? lastComplianceCheckedOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            VmId = vmId;
