...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    public partial class GuestConfigurationAssignmentReport
    {
        ...
        internal GuestConfigurationAssignmentReport(ResourceIdentifier id, string name, GuestConfigurationAssignmentReportProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
