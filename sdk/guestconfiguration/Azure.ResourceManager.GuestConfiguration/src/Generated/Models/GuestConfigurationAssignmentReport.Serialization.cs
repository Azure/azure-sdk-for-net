...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    public partial class GuestConfigurationAssignmentReport : IJsonModel<GuestConfigurationAssignmentReport>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GuestConfigurationAssignmentReport>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GuestConfigurationAssignmentReport IJsonModel<GuestConfigurationAssignmentReport>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual GuestConfigurationAssignmentReport JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<GuestConfigurationAssignmentReport>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GuestConfigurationAssignmentReport DeserializeGuestConfigurationAssignmentReport(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = GuestConfigurationAssignmentReportProperties.DeserializeGuestConfigurationAssignmentReportProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new GuestConfigurationAssignmentReport(id, name, properties, additionalBinaryDataProperties);
        }
    }
}
