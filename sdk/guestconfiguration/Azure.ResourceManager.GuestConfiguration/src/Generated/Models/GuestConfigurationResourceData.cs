...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    public partial class GuestConfigurationResourceData
    {
        ...
        internal GuestConfigurationResourceData(ResourceIdentifier id, string name, AzureLocation? location, ResourceType? resourceType, SystemData systemData, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Location = location;
