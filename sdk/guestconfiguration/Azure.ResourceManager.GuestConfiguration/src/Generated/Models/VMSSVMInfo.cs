...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    public partial class VMSSVMInfo
    {
        ...
        /// <summary> Initializes a new instance of <see cref="VMSSVMInfo"/>. </summary>
        public VMSSVMInfo()
        {
        }
        ...
        internal VMSSVMInfo(string vmId, string vmResourceId, ComplianceStatus? complianceStatus, string latestReportId, DateTimeOffset? lastComplianceChecked, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            VmId = vmId;
