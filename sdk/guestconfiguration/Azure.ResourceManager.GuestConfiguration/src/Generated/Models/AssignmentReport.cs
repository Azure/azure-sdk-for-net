...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    public partial class AssignmentReport
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AssignmentReport"/>. </summary>
        ...
        internal AssignmentReport(string id, string reportId, AssignmentInfo assignment, VMInfo vm, DateTimeOffset? startOn, DateTimeOffset? endOn, ComplianceStatus? complianceStatus, Type? operationType, IList<AssignmentReportResource> resources, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            ReportId = reportId;
