...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GuestConfigurationNavigation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GuestConfigurationNavigation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GuestConfigurationNavigation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GuestConfigurationNavigation>)} interface");
            }
        ...
        string IPersistableModel<GuestConfigurationNavigation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
