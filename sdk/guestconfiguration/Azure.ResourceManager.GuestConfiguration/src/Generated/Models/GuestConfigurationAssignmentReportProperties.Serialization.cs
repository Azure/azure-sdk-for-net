...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GuestConfigurationAssignmentReportProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<GuestConfigurationAssignmentReportProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GuestConfigurationAssignmentReportProperties>)} interface");
            }
        ...
        string IPersistableModel<GuestConfigurationAssignmentReportProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
