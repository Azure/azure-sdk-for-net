...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GuestConfigurationAssignmentInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GuestConfigurationAssignmentInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GuestConfigurationAssignmentInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GuestConfigurationAssignmentInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
