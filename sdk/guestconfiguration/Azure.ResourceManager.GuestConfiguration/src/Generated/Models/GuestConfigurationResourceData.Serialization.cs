    ...
    public partial class GuestConfigurationResourceData : IUtf8JsonSerializable, IJsonModel<GuestConfigurationResourceData>
    {
        ...
        internal static GuestConfigurationResourceData DeserializeGuestConfigurationResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.GuestConfiguration.ModelSerializationExtensions.WireOptions, AzureResourceManagerGuestConfigurationContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerGuestConfigurationContext.Default)
#endif
;
                    continue;
                }
