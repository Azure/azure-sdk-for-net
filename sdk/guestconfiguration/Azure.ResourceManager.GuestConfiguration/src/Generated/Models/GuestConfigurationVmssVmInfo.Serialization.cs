...
{
    public partial class GuestConfigurationVmssVmInfo : IUtf8JsonSerializable, IJsonModel<GuestConfigurationVmssVmInfo>, IPersistableModel<GuestConfigurationVmssVmInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastComplianceCheckedOn))
            {
                ...
                builder.AppendLine($" '{LastComplianceCheckedOn.Value.ToString()}'");
            }
