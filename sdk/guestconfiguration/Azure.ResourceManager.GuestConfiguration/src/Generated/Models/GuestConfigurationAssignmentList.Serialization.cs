...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GuestConfigurationAssignmentList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GuestConfigurationAssignmentList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GuestConfigurationAssignmentList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GuestConfigurationAssignmentList>)} interface");
            }
        ...
        string IPersistableModel<GuestConfigurationAssignmentList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
