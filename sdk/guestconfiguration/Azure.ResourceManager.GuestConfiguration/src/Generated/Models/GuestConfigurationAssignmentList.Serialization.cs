...
{
    internal partial class GuestConfigurationAssignmentList : IUtf8JsonSerializable, IJsonModel<GuestConfigurationAssignmentList>, IPersistableModel<GuestConfigurationAssignmentList>
    {
        ...
        void IJsonModel<GuestConfigurationAssignmentList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GuestConfigurationAssignmentList)} does not support '{format}' format.");
            }
