...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LcmConfigurationSetting>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LcmConfigurationSetting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LcmConfigurationSetting>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LcmConfigurationSetting>)} interface");
            }
        ...
        string IPersistableModel<LcmConfigurationSetting>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
