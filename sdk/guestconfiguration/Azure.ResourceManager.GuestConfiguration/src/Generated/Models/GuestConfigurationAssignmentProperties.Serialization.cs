...
{
    public partial class GuestConfigurationAssignmentProperties : IUtf8JsonSerializable, IJsonModel<GuestConfigurationAssignmentProperties>, IPersistableModel<GuestConfigurationAssignmentProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GuestConfiguration))
            {
                ...
                AppendChildObject(builder, GuestConfiguration, options, 2);
            }
            ...
            if (Optional.IsDefined(LastComplianceStatusCheckedOn))
            {
                ...
                builder.AppendLine($" '{LastComplianceStatusCheckedOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(LatestAssignmentReport))
            {
                ...
                AppendChildObject(builder, LatestAssignmentReport, options, 2);
            }
