...
{
    internal partial class GuestConfigurationAssignmentReportsVMSSGetReportsAsyncCollectionResultOfT : AsyncPageable<GuestConfigurationAssignmentReport>
    {
        private readonly GuestConfigurationAssignmentReportsVMSS _client;
        ...
        public GuestConfigurationAssignmentReportsVMSSGetReportsAsyncCollectionResultOfT(GuestConfigurationAssignmentReportsVMSS client, string subscriptionId, string resourceGroupName, string vmssName, string name, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of GuestConfigurationAssignmentReportsVMSSGetReportsAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of GuestConfigurationAssignmentReportsVMSSGetReportsAsyncCollectionResultOfT as an enumerable collection. </returns>
