...
{
    internal partial class GuestConfigurationAssignmentReportsVMSSGetReportsCollectionResultOfT : Pageable<GuestConfigurationAssignmentReport>
    {
        ...
        public GuestConfigurationAssignmentReportsVMSSGetReportsCollectionResultOfT(GuestConfigurationAssignmentReportsVMSS client, string subscriptionId, string resourceGroupName, string vmssName, string guestConfigurationAssignmentName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <returns> The pages of GuestConfigurationAssignmentReportsVMSSGetReportsCollectionResultOfT as an enumerable collection. </returns>
