...
namespace Azure.ResourceManager.GuestConfiguration
{
    internal partial class GuestConfigurationConnectedVMwarevSphereAssignmentsGetAllCollectionResultOfT : Pageable<GuestConfigurationAssignment>
    {
        ...
        /// <summary> Initializes a new instance of GuestConfigurationConnectedVMwarevSphereAssignmentsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public GuestConfigurationConnectedVMwarevSphereAssignmentsGetAllCollectionResultOfT(GuestConfigurationConnectedVMwarevSphereAssignments client, string subscriptionId, string resourceGroupName, string vmName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of GuestConfigurationConnectedVMwarevSphereAssignmentsGetAllCollectionResultOfT as an enumerable collection. </summary>
