...
namespace Azure.ResourceManager.GuestConfiguration
{
    internal partial class GuestConfigurationAssignmentsGetGuestConfigurationAssignmentsCollectionResultOfT : Pageable<GuestConfigurationAssignmentData>
    {
        ...
        public GuestConfigurationAssignmentsGetGuestConfigurationAssignmentsCollectionResultOfT(GuestConfigurationAssignments client, string resourceGroupName, string subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
