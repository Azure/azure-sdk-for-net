...
{
    internal partial class GuestConfigurationHCRPAssignmentReportsGetReportsCollectionResultOfT : Pageable<GuestConfigurationAssignmentReport>
    {
        private readonly GuestConfigurationHCRPAssignmentReports _client;
        ...
        /// <returns> The pages of GuestConfigurationHCRPAssignmentReportsGetReportsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<GuestConfigurationAssignmentReport>> AsPages(string continuationToken, int? pageSizeHint)
        {
