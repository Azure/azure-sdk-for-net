...
namespace Azure.ResourceManager.GuestConfiguration
{
    ...
    public static partial class GuestConfigurationExtensions
    {
        private static GuestConfigurationArmClientMockingExtension GetGuestConfigurationArmClientMockingExtension(ArmClient client)
        {
            ...
            {
                return new GuestConfigurationArmClientMockingExtension(client);
            });
        }

        private static GuestConfigurationArmResourceMockingExtension GetGuestConfigurationArmResourceMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new GuestConfigurationArmResourceMockingExtension(client, resource.Id);
            });
        }
        ...
        private static GuestConfigurationResourceGroupMockingExtension GetGuestConfigurationResourceGroupMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new GuestConfigurationResourceGroupMockingExtension(client, resource.Id);
            });
        }
        ...
        private static GuestConfigurationSubscriptionMockingExtension GetGuestConfigurationSubscriptionMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new GuestConfigurationSubscriptionMockingExtension(client, resource.Id);
            });
        }
        ...
        /// <returns> An object representing collection of GuestConfigurationVmAssignmentResources and their operations over a GuestConfigurationVmAssignmentResource. </returns>
        public static GuestConfigurationVmAssignmentCollection GetGuestConfigurationVmAssignments(this ArmResource armResource)
        {
            return GetGuestConfigurationArmResourceMockingExtension(armResource).GetGuestConfigurationVmAssignments();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="guestConfigurationAssignmentName"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<GuestConfigurationVmAssignmentResource>> GetGuestConfigurationVmAssignmentAsync(this ArmResource armResource, string guestConfigurationAssignmentName, CancellationToken cancellationToken = default)
        {
            return await GetGuestConfigurationArmResourceMockingExtension(armResource).GetGuestConfigurationVmAssignmentAsync(guestConfigurationAssignmentName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="guestConfigurationAssignmentName"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<GuestConfigurationVmAssignmentResource> GetGuestConfigurationVmAssignment(this ArmResource armResource, string guestConfigurationAssignmentName, CancellationToken cancellationToken = default)
        {
            return GetGuestConfigurationArmResourceMockingExtension(armResource).GetGuestConfigurationVmAssignment(guestConfigurationAssignmentName, cancellationToken);
        }

        /// <summary> Gets a collection of GuestConfigurationHcrpAssignmentResources in the ArmResource. </summary>
        /// <param name="armResource"> The <see cref="ArmResource" /> instance the method will execute against. </param>
        /// <returns> An object representing collection of GuestConfigurationHcrpAssignmentResources and their operations over a GuestConfigurationHcrpAssignmentResource. </returns>
        public static GuestConfigurationHcrpAssignmentCollection GetGuestConfigurationHcrpAssignments(this ArmResource armResource)
        {
            return GetGuestConfigurationArmResourceMockingExtension(armResource).GetGuestConfigurationHcrpAssignments();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="guestConfigurationAssignmentName"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<GuestConfigurationHcrpAssignmentResource>> GetGuestConfigurationHcrpAssignmentAsync(this ArmResource armResource, string guestConfigurationAssignmentName, CancellationToken cancellationToken = default)
        {
            return await GetGuestConfigurationArmResourceMockingExtension(armResource).GetGuestConfigurationHcrpAssignmentAsync(guestConfigurationAssignmentName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="guestConfigurationAssignmentName"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<GuestConfigurationHcrpAssignmentResource> GetGuestConfigurationHcrpAssignment(this ArmResource armResource, string guestConfigurationAssignmentName, CancellationToken cancellationToken = default)
        {
            return GetGuestConfigurationArmResourceMockingExtension(armResource).GetGuestConfigurationHcrpAssignment(guestConfigurationAssignmentName, cancellationToken);
        }

        /// <summary> Gets a collection of GuestConfigurationVmssAssignmentResources in the ArmResource. </summary>
        /// <param name="armResource"> The <see cref="ArmResource" /> instance the method will execute against. </param>
        /// <returns> An object representing collection of GuestConfigurationVmssAssignmentResources and their operations over a GuestConfigurationVmssAssignmentResource. </returns>
        public static GuestConfigurationVmssAssignmentCollection GetGuestConfigurationVmssAssignments(this ArmResource armResource)
        {
            return GetGuestConfigurationArmResourceMockingExtension(armResource).GetGuestConfigurationVmssAssignments();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<GuestConfigurationVmssAssignmentResource>> GetGuestConfigurationVmssAssignmentAsync(this ArmResource armResource, string name, CancellationToken cancellationToken = default)
        {
            return await GetGuestConfigurationArmResourceMockingExtension(armResource).GetGuestConfigurationVmssAssignmentAsync(name, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<GuestConfigurationVmssAssignmentResource> GetGuestConfigurationVmssAssignment(this ArmResource armResource, string name, CancellationToken cancellationToken = default)
        {
            return GetGuestConfigurationArmResourceMockingExtension(armResource).GetGuestConfigurationVmssAssignment(name, cancellationToken);
        }
    }
}
