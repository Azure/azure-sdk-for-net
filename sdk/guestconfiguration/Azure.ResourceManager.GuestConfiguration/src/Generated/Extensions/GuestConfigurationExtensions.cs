...
using Azure.ResourceManager.GuestConfiguration.Testing;
...
namespace Azure.ResourceManager.GuestConfiguration
{
    ...
    {
        private static GuestConfigurationArmResourceExtension GetGuestConfigurationArmResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new GuestConfigurationArmResourceExtension(client, resource.Id);
            });
        }

        private static GuestConfigurationArmResourceExtension GetGuestConfigurationArmResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new GuestConfigurationArmResourceExtension(client, scope);
            });
        }

        private static GuestConfigurationResourceGroupResourceExtension GetGuestConfigurationResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new GuestConfigurationResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static GuestConfigurationResourceGroupResourceExtension GetGuestConfigurationResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new GuestConfigurationResourceGroupResourceExtension(client, scope);
            });
        }

        private static GuestConfigurationSubscriptionResourceExtension GetGuestConfigurationSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new GuestConfigurationSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static GuestConfigurationSubscriptionResourceExtension GetGuestConfigurationSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new GuestConfigurationSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        public static GuestConfigurationVmAssignmentCollection GetGuestConfigurationVmAssignments(this ArmClient client, ResourceIdentifier scope)
        {
            ...
            return GetGuestConfigurationArmResourceExtension(client, scope).GetGuestConfigurationVmAssignments();
        }
        ...
        public static GuestConfigurationHcrpAssignmentCollection GetGuestConfigurationHcrpAssignments(this ArmClient client, ResourceIdentifier scope)
        {
            ...
            return GetGuestConfigurationArmResourceExtension(client, scope).GetGuestConfigurationHcrpAssignments();
        }
        ...
        public static GuestConfigurationVmssAssignmentCollection GetGuestConfigurationVmssAssignments(this ArmClient client, ResourceIdentifier scope)
        {
            ...
            return GetGuestConfigurationArmResourceExtension(client, scope).GetGuestConfigurationVmssAssignments();
        }
