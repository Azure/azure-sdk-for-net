...
namespace Azure.ResourceManager.GuestConfiguration.Mocking
{
    ...
    internal partial class GuestConfigurationArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="GuestConfigurationArmClientMockingExtension"/> class for mocking. </summary>
        protected GuestConfigurationArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="GuestConfigurationArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal GuestConfigurationArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal GuestConfigurationArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
