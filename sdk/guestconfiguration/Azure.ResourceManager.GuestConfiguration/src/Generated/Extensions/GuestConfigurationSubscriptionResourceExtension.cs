...
namespace Azure.ResourceManager.GuestConfiguration.Testing
{
    ...
    public partial class GuestConfigurationSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="GuestConfigurationSubscriptionResourceExtension"/> class for mocking. </summary>
        protected GuestConfigurationSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="GuestConfigurationSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal GuestConfigurationSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
