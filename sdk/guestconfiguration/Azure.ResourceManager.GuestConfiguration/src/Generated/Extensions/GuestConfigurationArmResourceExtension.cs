...
namespace Azure.ResourceManager.GuestConfiguration.Mock
{
    ...
    public partial class GuestConfigurationArmResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="GuestConfigurationArmResourceExtension"/> class for mocking. </summary>
        protected GuestConfigurationArmResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="GuestConfigurationArmResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal GuestConfigurationArmResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
