...
namespace Azure.ResourceManager.GuestConfiguration.Mock
{
    ...
    public partial class GuestConfigurationVmAssignmentResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="GuestConfigurationVmAssignmentResourceExtension"/> class for mocking. </summary>
        protected GuestConfigurationVmAssignmentResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="GuestConfigurationVmAssignmentResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal GuestConfigurationVmAssignmentResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
