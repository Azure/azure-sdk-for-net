...
namespace Azure.ResourceManager.GuestConfiguration.Models
{
    ...
    public static partial class ArmGuestConfigurationModelFactory
    {
        ...
        public static GuestConfigurationNavigation GuestConfigurationNavigation(GuestConfigurationKind? kind = default, string name = default, string version = default, string contentUri = default, string contentHash = default, string contentManagedIdentity = default, GuestConfigurationAssignmentType? assignmentType = default, string assignmentSource = default, string contentType = default, IEnumerable<GuestConfigurationParameter> configurationParameters = default, IEnumerable<GuestConfigurationParameter> configurationProtectedParameters = default, LcmConfigurationSetting configurationSetting = default)
        {
        ...
        public static GuestConfigurationVmssVmInfo GuestConfigurationVmssVmInfo(string vmId = default, string vmResourceId = default, AssignedGuestConfigurationMachineComplianceStatus? complianceStatus = default, string latestReportId = default, DateTimeOffset? lastComplianceCheckedOn = default)
        {
