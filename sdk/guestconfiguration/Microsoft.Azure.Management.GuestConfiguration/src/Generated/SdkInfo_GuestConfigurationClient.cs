      ...
      public static IEnumerable<Tuple<string, string, string>> ApiInfo_GuestConfigurationClient
      {
          get
          {
              return new Tuple<string, string, string>[]
              {
                ...
                new Tuple<string, string, string>("GuestConfiguration", "GuestConfigurationAssignments", "2021-01-25"),
