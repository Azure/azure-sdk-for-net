...
namespace Microsoft.Azure.Management.GuestConfiguration
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<GuestConfigurationClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(GuestConfigurationClient client)
        {
            if (client == null)
            {
        ...
        /// <summary>
        /// Gets a reference to the GuestConfigurationClient
        /// </summary>
        public GuestConfigurationClient Client { get; private set; }
        ...
        public async Task<AzureOperationResponse<IEnumerable<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.GuestConfiguration/operations").ToString();
