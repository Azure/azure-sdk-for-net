...
{
    internal partial class ManagedApplicationsArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ManagedApplicationsArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ManagedApplicationsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
