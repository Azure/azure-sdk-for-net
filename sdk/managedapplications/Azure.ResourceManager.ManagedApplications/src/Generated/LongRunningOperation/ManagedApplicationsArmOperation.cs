...
{
    internal partial class ManagedApplicationsArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of ManagedApplicationsArmOperation for mocking. </summary>
        protected ManagedApplicationsArmOperation()
        {
        }
        ...
        internal ManagedApplicationsArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ManagedApplicationsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(
                ...
                clientDiagnostics,
                response,
                "ManagedApplicationsArmOperation",
                null,
