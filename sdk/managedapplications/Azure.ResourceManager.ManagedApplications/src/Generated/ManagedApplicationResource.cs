...
namespace Azure.ResourceManager.ManagedApplications
{
    ...
    public partial class ManagedApplicationResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the ManagedApplication.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Solutions/applications/{applicationName}. </description>
        ...
        public virtual async Task<ArmOperation<ManagedApplicationResource>> UpdateAsync(WaitUntil waitUntil, ManagedApplicationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _applicationsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ManagedApplicationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ManagedApplicationsArmOperation<ManagedApplicationResource> operation = new ManagedApplicationsArmOperation<ManagedApplicationResource>(
                    new ManagedApplicationResourceOperationSource(Client),
                    _applicationsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ManagedApplicationResource> Update(WaitUntil waitUntil, ManagedApplicationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
