    ...
    public partial class ApplicationDefinitionCollection : ArmCollection, IEnumerable<ApplicationDefinitionResource>, IAsyncEnumerable<ApplicationDefinitionResource>
    {
        ...
        public virtual async Task<ArmOperation<ApplicationDefinitionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string applicationDefinitionName, ApplicationDefinitionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _applicationDefinitionsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, applicationDefinitionName, ApplicationDefinitionData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<ApplicationDefinitionResource>> GetAsync(string applicationDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _applicationDefinitionsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, applicationDefinitionName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApplicationDefinitionData> response = Response.FromValue(ApplicationDefinitionData.FromResponse(result), result);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ApplicationDefinitionListOperationGroup_ListByResourceGroup. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2023-12-01-preview. </description>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="applicationDefinitionName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="applicationDefinitionName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<NullableResponse<ApplicationDefinitionResource>> GetIfExistsAsync(string applicationDefinitionName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(applicationDefinitionName, nameof(applicationDefinitionName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="applicationDefinitionName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="applicationDefinitionName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual NullableResponse<ApplicationDefinitionResource> GetIfExists(string applicationDefinitionName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(applicationDefinitionName, nameof(applicationDefinitionName));
