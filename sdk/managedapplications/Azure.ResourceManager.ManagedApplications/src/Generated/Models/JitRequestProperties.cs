...
namespace Azure.ResourceManager.ManagedApplications.Models
{
    ...
    internal partial class JitRequestProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="JitRequestProperties"/>. </summary>
        ...
        public JitRequestProperties(ResourceIdentifier applicationResourceId, IEnumerable<JitAuthorizationPolicies> jitAuthorizationPolicies, JitSchedulingPolicy jitSchedulingPolicy)
        {
            ...
            Argument.AssertNotNull(jitSchedulingPolicy, nameof(jitSchedulingPolicy));

            ApplicationResourceId = applicationResourceId;
            JitAuthorizationPolicies = jitAuthorizationPolicies.ToList();
        ...
        public IList<JitAuthorizationPolicies> JitAuthorizationPolicies { get; } = new ChangeTrackingList<JitAuthorizationPolicies>();
