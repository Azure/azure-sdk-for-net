...
namespace Azure.ResourceManager.ManagedApplications.Models
{
    ...
    internal partial class ApplicationListResult
    {
        ...
        internal ApplicationListResult(IEnumerable<ManagedApplicationData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ApplicationListResult(IList<ManagedApplicationData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ManagedApplicationData> Value { get; }
