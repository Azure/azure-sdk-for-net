...
namespace Azure.ResourceManager.ManagedApplications.Models
{
    ...
    internal partial class ApplicationListResult
    {
        ...
        internal ApplicationListResult(IEnumerable<ApplicationData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ApplicationListResult(IList<ApplicationData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
