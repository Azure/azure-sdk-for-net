...
{
    public partial class NetworkAnchorProperties : IUtf8JsonSerializable, IJsonModel<NetworkAnchorProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkAnchorProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkAnchorProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        NetworkAnchorProperties IJsonModel<NetworkAnchorProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkAnchorProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NetworkAnchorProperties DeserializeNetworkAnchorProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            string dnsForwardingRulesUrl = default;
            string dnsListeningEndpointNsgRulesUrl = default;
            string dnsForwardingEndpointNsgRulesUrl = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    dnsForwardingRulesUrl = property.Value.GetString();
                    continue;
                }
                if (property.NameEquals("dnsListeningEndpointNsgRulesUrl"u8))
                {
                    dnsListeningEndpointNsgRulesUrl = property.Value.GetString();
                    continue;
                }
                if (property.NameEquals("dnsForwardingEndpointNsgRulesUrl"u8))
                {
                    dnsForwardingEndpointNsgRulesUrl = property.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        BinaryData IPersistableModel<NetworkAnchorProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkAnchorProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        NetworkAnchorProperties IPersistableModel<NetworkAnchorProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkAnchorProperties>)this).GetFormatFromOptions(options) : options.Format;
