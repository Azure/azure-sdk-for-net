...
namespace Azure.ResourceManager.OracleDatabase.Mocking
{
    ...
    public partial class MockableOracleDatabaseArmClient : ArmResource
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="NetworkAnchorResource"/> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="NetworkAnchorResource.CreateResourceIdentifier" /> to create a <see cref="NetworkAnchorResource"/> <see cref="ResourceIdentifier"/> from its components.
        /// </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        /// <summary>
        /// Gets an object representing a <see cref="ResourceAnchorResource"/> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="ResourceAnchorResource.CreateResourceIdentifier" /> to create a <see cref="ResourceAnchorResource"/> <see cref="ResourceIdentifier"/> from its components.
        /// </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        /// <summary>
        /// Gets an object representing a <see cref="DbSystemResource"/> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="DbSystemResource.CreateResourceIdentifier" /> to create a <see cref="DbSystemResource"/> <see cref="ResourceIdentifier"/> from its components.
        /// </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        /// <summary>
        /// Gets an object representing a <see cref="DbVersionResource"/> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="DbVersionResource.CreateResourceIdentifier" /> to create a <see cref="DbVersionResource"/> <see cref="ResourceIdentifier"/> from its components.
        /// </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
