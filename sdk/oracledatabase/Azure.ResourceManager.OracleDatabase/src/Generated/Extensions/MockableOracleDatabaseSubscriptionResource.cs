...
namespace Azure.ResourceManager.OracleDatabase.Mocking
{
    ...
    public partial class MockableOracleDatabaseSubscriptionResource : ArmResource
    {
        ...
        private ClientDiagnostics _networkAnchorClientDiagnostics;
        private NetworkAnchorsRestOperations _networkAnchorRestClient;
        private ClientDiagnostics _resourceAnchorClientDiagnostics;
        private ResourceAnchorsRestOperations _resourceAnchorRestClient;
        private ClientDiagnostics _dbSystemClientDiagnostics;
        private DbSystemsRestOperations _dbSystemRestClient;
        ...
        private ClientDiagnostics NetworkAnchorClientDiagnostics => _networkAnchorClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.OracleDatabase", NetworkAnchorResource.ResourceType.Namespace, Diagnostics);
        private NetworkAnchorsRestOperations NetworkAnchorRestClient => _networkAnchorRestClient ??= new NetworkAnchorsRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, GetApiVersionOrNull(NetworkAnchorResource.ResourceType));
        private ClientDiagnostics ResourceAnchorClientDiagnostics => _resourceAnchorClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.OracleDatabase", ResourceAnchorResource.ResourceType.Namespace, Diagnostics);
        private ResourceAnchorsRestOperations ResourceAnchorRestClient => _resourceAnchorRestClient ??= new ResourceAnchorsRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, GetApiVersionOrNull(ResourceAnchorResource.ResourceType));
        private ClientDiagnostics DbSystemClientDiagnostics => _dbSystemClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.OracleDatabase", DbSystemResource.ResourceType.Namespace, Diagnostics);
        private DbSystemsRestOperations DbSystemRestClient => _dbSystemRestClient ??= new DbSystemsRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, GetApiVersionOrNull(DbSystemResource.ResourceType));
        ...
        /// <summary> Gets a collection of DbVersionResources in the SubscriptionResource. </summary>
        /// <param name="location"> The name of the Azure region. </param>
        ...
        {
            return new DbVersionCollection(Client, Id, location);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => NetworkAnchorRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => NetworkAnchorRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NetworkAnchorResource(Client, NetworkAnchorData.DeserializeNetworkAnchorData(e)), NetworkAnchorClientDiagnostics, Pipeline, "MockableOracleDatabaseSubscriptionResource.GetNetworkAnchors", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NetworkAnchorResource> GetNetworkAnchors(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => NetworkAnchorRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => NetworkAnchorRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NetworkAnchorResource(Client, NetworkAnchorData.DeserializeNetworkAnchorData(e)), NetworkAnchorClientDiagnostics, Pipeline, "MockableOracleDatabaseSubscriptionResource.GetNetworkAnchors", "value", "nextLink", cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ResourceAnchorRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ResourceAnchorRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ResourceAnchorResource(Client, ResourceAnchorData.DeserializeResourceAnchorData(e)), ResourceAnchorClientDiagnostics, Pipeline, "MockableOracleDatabaseSubscriptionResource.GetResourceAnchors", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ResourceAnchorResource> GetResourceAnchors(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ResourceAnchorRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ResourceAnchorRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ResourceAnchorResource(Client, ResourceAnchorData.DeserializeResourceAnchorData(e)), ResourceAnchorClientDiagnostics, Pipeline, "MockableOracleDatabaseSubscriptionResource.GetResourceAnchors", "value", "nextLink", cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DbSystemRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DbSystemRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DbSystemResource(Client, DbSystemData.DeserializeDbSystemData(e)), DbSystemClientDiagnostics, Pipeline, "MockableOracleDatabaseSubscriptionResource.GetDbSystems", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DbSystemResource> GetDbSystems(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DbSystemRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DbSystemRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DbSystemResource(Client, DbSystemData.DeserializeDbSystemData(e)), DbSystemClientDiagnostics, Pipeline, "MockableOracleDatabaseSubscriptionResource.GetDbSystems", "value", "nextLink", cancellationToken);
        }
    }
}
