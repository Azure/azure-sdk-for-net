...
namespace Azure.ResourceManager.DataShare
{
    ...
    public partial class DataShareInvitationResource : ArmResource
    {
        ...
        internal DataShareInvitationResource(ArmClient client, DataShareInvitationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DataShareInvitationResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DataShareInvitationResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<DataShareInvitationResource>> UpdateAsync(WaitUntil waitUntil, DataShareInvitationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataShareArmOperation<DataShareInvitationResource>(Response.FromValue(new DataShareInvitationResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
