...
namespace Azure.ResourceManager.DataShare
{
    ...
    public partial class ShareDataSetMappingResource : ArmResource
    {
        ...
        internal ShareDataSetMappingResource(ArmClient client, ShareDataSetMappingData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ShareDataSetMappingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ShareDataSetMappingResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<ShareDataSetMappingResource>> UpdateAsync(WaitUntil waitUntil, ShareDataSetMappingData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataShareArmOperation<ShareDataSetMappingResource>(Response.FromValue(new ShareDataSetMappingResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
