...
{
    /// <summary>
    /// A class representing the SynchronizationSetting data model.
    ...
    /// </summary>
    public partial class SynchronizationSettingData : ResourceData
    {
        /// <summary> Initializes a new instance of SynchronizationSettingData. </summary>
        ...
        internal SynchronizationSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, SynchronizationSettingKind kind) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
        }
