...
namespace Azure.ResourceManager.DataShare
{
    ...
    public partial class DataShareResource : ArmResource
    {
        ...
        public virtual AsyncPageable<SynchronizationDetails> GetSynchronizationDetailsAsync(DataShareResourceGetSynchronizationDetailsOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<SynchronizationDetails>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _dataShareSharesRestClient.ListSynchronizationDetailsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.ShareSynchronization, options.SkipToken, options.Filter, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<SynchronizationDetails>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _dataShareSharesRestClient.ListSynchronizationDetailsNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.ShareSynchronization, options.SkipToken, options.Filter, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<SynchronizationDetails> GetSynchronizationDetails(DataShareResourceGetSynchronizationDetailsOptions options, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(options, nameof(options));
            ...
            Page<SynchronizationDetails> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _dataShareSharesRestClient.ListSynchronizationDetails(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.ShareSynchronization, options.SkipToken, options.Filter, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<SynchronizationDetails> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _dataShareSharesRestClient.ListSynchronizationDetailsNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.ShareSynchronization, options.SkipToken, options.Filter, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<ShareSynchronization> GetSynchronizationsAsync(DataShareResourceGetSynchronizationsOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new DataShareResourceGetSynchronizationsOptions();
        ...
        public virtual Pageable<ShareSynchronization> GetSynchronizations(DataShareResourceGetSynchronizationsOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new DataShareResourceGetSynchronizationsOptions();
