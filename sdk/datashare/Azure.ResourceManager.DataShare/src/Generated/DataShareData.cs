...
namespace Azure.ResourceManager.DataShare
{
    ...
    public partial class DataShareData : ResourceData
    {
        ...
        internal DataShareData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? createdOn, string description, DataShareProvisioningState? provisioningState, DataShareKind? shareKind, string terms, string userEmail, string userName, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            CreatedOn = createdOn;
