...
namespace Azure.ResourceManager.DataShare
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataShareSynchronizationSettingData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataShareSynchronizationSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataShareSynchronizationSettingData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataShareSynchronizationSettingData>)} interface");
            }
        ...
        string IPersistableModel<DataShareSynchronizationSettingData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
