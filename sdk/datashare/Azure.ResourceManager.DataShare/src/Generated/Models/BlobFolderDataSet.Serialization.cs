...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobFolderDataSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlobFolderDataSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobFolderDataSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlobFolderDataSet>)} interface");
            }
        ...
        string IPersistableModel<BlobFolderDataSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
