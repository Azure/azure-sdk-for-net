...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    public partial class ScheduledSourceSynchronizationSetting : SourceShareSynchronizationSetting
    {
        ...
        internal ScheduledSourceSynchronizationSetting(SourceShareSynchronizationSettingKind kind, DataShareSynchronizationRecurrenceInterval? recurrenceInterval, DateTimeOffset? synchronizeOn, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
