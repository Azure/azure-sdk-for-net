...
{
    public partial class DataShareEmailRegistration : IUtf8JsonSerializable, IJsonModel<DataShareEmailRegistration>, IPersistableModel<DataShareEmailRegistration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActivationCode))
            {
                ...
                builder.AppendLine($" '{ActivationCode}'");
            }

            if (Optional.IsDefined(ActivationExpireOn))
            {
                builder.Append("  activationExpirationDate:");
                builder.AppendLine($" '{ActivationExpireOn.Value.ToString()}'");
            }
