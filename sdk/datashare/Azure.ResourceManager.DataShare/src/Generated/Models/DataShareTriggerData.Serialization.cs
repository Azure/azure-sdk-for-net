...
namespace Azure.ResourceManager.DataShare
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataShareTriggerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataShareTriggerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataShareTriggerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataShareTriggerData>)} interface");
            }
        ...
        string IPersistableModel<DataShareTriggerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
