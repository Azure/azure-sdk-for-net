...
namespace Azure.ResourceManager.DataShare
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataShareInvitationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataShareInvitationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataShareInvitationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataShareInvitationData>)} interface");
            }
        ...
        string IPersistableModel<DataShareInvitationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
