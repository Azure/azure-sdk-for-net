...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConsumerInvitationList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConsumerInvitationList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConsumerInvitationList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConsumerInvitationList>)} interface");
            }
        ...
        string IPersistableModel<ConsumerInvitationList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
