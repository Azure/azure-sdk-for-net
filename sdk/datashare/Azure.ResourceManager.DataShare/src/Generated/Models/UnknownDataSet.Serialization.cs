...
{
    internal partial class UnknownDataSet : IUtf8JsonSerializable, IJsonModel<ShareDataSetData>, IPersistableModel<ShareDataSetData>
    {
        ...
        internal static UnknownDataSet DeserializeUnknownDataSet(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownDataSet(id, name, type, systemData.Value, kind, serializedAdditionalRawData);
        }
