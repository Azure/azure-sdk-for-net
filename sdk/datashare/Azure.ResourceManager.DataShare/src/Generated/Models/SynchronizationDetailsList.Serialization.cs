...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynchronizationDetailsList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                ((IJsonModel<SynchronizationDetails>)item).Write(writer, options);
            }
        ...
        SynchronizationDetailsList IJsonModel<SynchronizationDetailsList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SynchronizationDetailsList)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynchronizationDetailsList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynchronizationDetailsList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        SynchronizationDetailsList IPersistableModel<SynchronizationDetailsList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SynchronizationDetailsList)} does not support reading '{options.Format}' format.");
            }
        }
