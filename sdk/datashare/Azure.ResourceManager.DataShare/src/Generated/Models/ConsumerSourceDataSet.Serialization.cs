...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConsumerSourceDataSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConsumerSourceDataSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConsumerSourceDataSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConsumerSourceDataSet>)} interface");
            }
        ...
        string IPersistableModel<ConsumerSourceDataSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
