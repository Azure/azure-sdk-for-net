...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynchronizationSettingList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynchronizationSettingList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynchronizationSettingList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynchronizationSettingList>)} interface");
            }
        ...
        string IPersistableModel<SynchronizationSettingList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
