...
{
    public partial class AdlsGen2FileDataSet : IUtf8JsonSerializable, IJsonModel<AdlsGen2FileDataSet>, IPersistableModel<AdlsGen2FileDataSet>
    {
        ...
        void IJsonModel<AdlsGen2FileDataSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdlsGen2FileDataSet)} does not support '{format}' format.");
            }
