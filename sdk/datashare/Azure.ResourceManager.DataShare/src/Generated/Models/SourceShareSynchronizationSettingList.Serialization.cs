...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceShareSynchronizationSettingList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceShareSynchronizationSettingList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceShareSynchronizationSettingList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceShareSynchronizationSettingList>)} interface");
            }
        ...
        string IPersistableModel<SourceShareSynchronizationSettingList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
