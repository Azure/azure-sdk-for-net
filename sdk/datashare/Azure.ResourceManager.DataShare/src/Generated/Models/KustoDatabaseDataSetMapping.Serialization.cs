...
namespace Azure.ResourceManager.DataShare.Models
{
    public partial class KustoDatabaseDataSetMapping : IUtf8JsonSerializable, IModelJsonSerializable<KustoDatabaseDataSetMapping>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<KustoDatabaseDataSetMapping>(this, options.Format);
        ...
        internal static KustoDatabaseDataSetMapping DeserializeKustoDatabaseDataSetMapping(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new KustoDatabaseDataSetMapping(id, name, type, systemData.Value, kind, dataSetId, Optional.ToNullable(dataSetMappingStatus), kustoClusterResourceId, Optional.ToNullable(location), Optional.ToNullable(provisioningState), rawData);
        }
