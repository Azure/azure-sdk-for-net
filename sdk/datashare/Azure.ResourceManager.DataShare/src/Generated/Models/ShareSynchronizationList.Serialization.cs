...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShareSynchronizationList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ShareSynchronizationList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ShareSynchronizationList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ShareSynchronizationList>)} interface");
            }
        ...
        string IPersistableModel<ShareSynchronizationList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
