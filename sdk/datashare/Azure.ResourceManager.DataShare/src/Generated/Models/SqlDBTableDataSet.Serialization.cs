...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlDBTableDataSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlDBTableDataSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlDBTableDataSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlDBTableDataSet>)} interface");
            }
        ...
        string IPersistableModel<SqlDBTableDataSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
