...
namespace Azure.ResourceManager.DataShare.Models
{
    public partial class SqlDBTableDataSet : IUtf8JsonSerializable, IModelJsonSerializable<SqlDBTableDataSet>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SqlDBTableDataSet>(this, options.Format);
        ...
        internal static SqlDBTableDataSet DeserializeSqlDBTableDataSet(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SqlDBTableDataSet(id, name, type, systemData.Value, kind, databaseName.Value, Optional.ToNullable(dataSetId), schemaName.Value, sqlServerResourceId.Value, tableName.Value, serializedAdditionalRawData);
        }
