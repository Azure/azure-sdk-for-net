...
namespace Azure.ResourceManager.DataShare
{
    public partial class ShareDataSetMappingResource : IJsonModel<ShareDataSetMappingData>
    {
        ...
        {
            return ModelReaderWriter.Read<ShareDataSetMappingData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ShareDataSetMappingData>(data, options);
        }
