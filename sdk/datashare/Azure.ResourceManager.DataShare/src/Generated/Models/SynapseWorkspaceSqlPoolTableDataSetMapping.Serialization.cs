...
namespace Azure.ResourceManager.DataShare.Models
{
    public partial class SynapseWorkspaceSqlPoolTableDataSetMapping : IUtf8JsonSerializable, IJsonModel<SynapseWorkspaceSqlPoolTableDataSetMapping>
    {
        ...
        void IJsonModel<SynapseWorkspaceSqlPoolTableDataSetMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SynapseWorkspaceSqlPoolTableDataSetMapping)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SynapseWorkspaceSqlPoolTableDataSetMapping>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SynapseWorkspaceSqlPoolTableDataSetMapping)} does not support '{options.Format}' format.");
            }
        }
