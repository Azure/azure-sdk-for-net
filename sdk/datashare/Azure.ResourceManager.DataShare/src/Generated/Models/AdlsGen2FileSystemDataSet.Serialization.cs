...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdlsGen2FileSystemDataSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdlsGen2FileSystemDataSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdlsGen2FileSystemDataSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdlsGen2FileSystemDataSet>)} interface");
            }
        ...
        string IPersistableModel<AdlsGen2FileSystemDataSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
