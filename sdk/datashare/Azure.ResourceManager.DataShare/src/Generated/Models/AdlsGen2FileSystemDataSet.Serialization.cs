...
{
    public partial class AdlsGen2FileSystemDataSet : Core.IUtf8JsonSerializable
    {
        ...
        internal static AdlsGen2FileSystemDataSet DeserializeAdlsGen2FileSystemDataSet(JsonElement element)
        {
            ...
            return new AdlsGen2FileSystemDataSet(id, name, type, systemData.Value, kind, Core.Optional.ToNullable(dataSetId), fileSystem, resourceGroup, storageAccountName, subscriptionId);
        }
    }
}
