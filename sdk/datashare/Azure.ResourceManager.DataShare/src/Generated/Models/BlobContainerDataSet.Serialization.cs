...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobContainerDataSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlobContainerDataSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobContainerDataSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlobContainerDataSet>)} interface");
            }
        ...
        string IPersistableModel<BlobContainerDataSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
