...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        internal static DataShareOperationResult DeserializeDataShareOperationResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
