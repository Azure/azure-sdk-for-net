...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdlsGen2FileSystemDataSetMapping>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdlsGen2FileSystemDataSetMapping)} does not support writing '{format}' format.");
            }
        ...
        AdlsGen2FileSystemDataSetMapping IJsonModel<AdlsGen2FileSystemDataSetMapping>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdlsGen2FileSystemDataSetMapping)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AdlsGen2FileSystemDataSetMapping>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdlsGen2FileSystemDataSetMapping)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AdlsGen2FileSystemDataSetMapping IPersistableModel<AdlsGen2FileSystemDataSetMapping>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdlsGen2FileSystemDataSetMapping)} does not support reading '{options.Format}' format.");
            }
        }
