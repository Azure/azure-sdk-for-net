...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdlsGen2FileSystemDataSetMapping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdlsGen2FileSystemDataSetMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdlsGen2FileSystemDataSetMapping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdlsGen2FileSystemDataSetMapping>)} interface");
            }
        ...
        string IPersistableModel<AdlsGen2FileSystemDataSetMapping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
