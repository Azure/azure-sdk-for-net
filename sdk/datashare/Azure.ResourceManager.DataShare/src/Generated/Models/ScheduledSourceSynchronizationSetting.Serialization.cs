...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduledSourceSynchronizationSetting>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScheduledSourceSynchronizationSetting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScheduledSourceSynchronizationSetting>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScheduledSourceSynchronizationSetting>)} interface");
            }
        ...
        string IPersistableModel<ScheduledSourceSynchronizationSetting>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
