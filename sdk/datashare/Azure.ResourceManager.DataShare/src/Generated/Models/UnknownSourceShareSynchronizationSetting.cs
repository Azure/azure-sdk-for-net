...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    internal partial class UnknownSourceShareSynchronizationSetting : SourceShareSynchronizationSetting
    {
        ...
        internal UnknownSourceShareSynchronizationSetting(SourceShareSynchronizationSettingKind kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Kind = kind;
        }
