...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        internal static ProviderShareSubscriptionList DeserializeProviderShareSubscriptionList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
