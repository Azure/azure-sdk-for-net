...
namespace Azure.ResourceManager.DataShare.Models
{
    public partial class AdlsGen1FolderDataSet : IUtf8JsonSerializable, IModelJsonSerializable<AdlsGen1FolderDataSet>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AdlsGen1FolderDataSet>(this, options.Format);
        ...
        internal static AdlsGen1FolderDataSet DeserializeAdlsGen1FolderDataSet(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AdlsGen1FolderDataSet(id, name, type, systemData.Value, kind, accountName, Optional.ToNullable(dataSetId), folderPath, resourceGroup, subscriptionId, serializedAdditionalRawData);
        }
