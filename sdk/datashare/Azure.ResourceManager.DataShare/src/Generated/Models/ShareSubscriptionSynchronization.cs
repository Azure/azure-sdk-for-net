...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    public partial class ShareSubscriptionSynchronization
    {
        ...
        internal ShareSubscriptionSynchronization(int? durationInMilliSeconds, DateTimeOffset? endOn, string message, DateTimeOffset? startOn, string status, Guid synchronizationId, SynchronizationMode? synchronizationMode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
