...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    public partial class DataShareOperationResult
    {
        ...
        internal DataShareOperationResult(DateTimeOffset? endOn, ResponseError error, DateTimeOffset? startOn, DataShareOperationStatus status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EndOn = endOn;
            Error = error;
            StartOn = startOn;
