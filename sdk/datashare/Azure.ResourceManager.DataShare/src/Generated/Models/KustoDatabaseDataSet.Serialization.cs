...
{
    public partial class KustoDatabaseDataSet : IUtf8JsonSerializable, IJsonModel<KustoDatabaseDataSet>, IPersistableModel<KustoDatabaseDataSet>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KustoDatabaseResourceId))
            {
                builder.Append("  kustoDatabaseResourceId:");
                builder.AppendLine($" '{KustoDatabaseResourceId.ToString()}'");
            }
