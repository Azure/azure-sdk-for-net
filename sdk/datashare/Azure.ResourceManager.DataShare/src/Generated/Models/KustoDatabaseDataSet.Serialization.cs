...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoDatabaseDataSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoDatabaseDataSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoDatabaseDataSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoDatabaseDataSet>)} interface");
            }
        ...
        string IPersistableModel<KustoDatabaseDataSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
