...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShareSubscriptionList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ShareSubscriptionList)} does not support writing '{format}' format.");
            }
            ...
            {
                ((IJsonModel<ShareSubscriptionData>)item).Write(writer, options);
            }
        ...
        ShareSubscriptionList IJsonModel<ShareSubscriptionList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ShareSubscriptionList)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ShareSubscriptionList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ShareSubscriptionList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ShareSubscriptionList IPersistableModel<ShareSubscriptionList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ShareSubscriptionList)} does not support reading '{options.Format}' format.");
            }
        }
