...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShareSubscriptionList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ShareSubscriptionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ShareSubscriptionList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ShareSubscriptionList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
