...
{
    public partial class DataSetMappingData : IUtf8JsonSerializable
    {
        ...
        internal static DataSetMappingData DeserializeDataSetMappingData(JsonElement element)
        {
            ...
            return new DataSetMappingData(id, name, type, systemData.Value, kind);
        }
    }
}
