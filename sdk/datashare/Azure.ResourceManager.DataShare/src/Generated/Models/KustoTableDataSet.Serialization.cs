...
namespace Azure.ResourceManager.DataShare.Models
{
    public partial class KustoTableDataSet : IUtf8JsonSerializable, IModelJsonSerializable<KustoTableDataSet>
    {
        ...
        internal static KustoTableDataSet DeserializeKustoTableDataSet(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new KustoTableDataSet(id, name, type, systemData.Value, kind, Optional.ToNullable(dataSetId), kustoDatabaseResourceId, Optional.ToNullable(location), Optional.ToNullable(provisioningState), tableLevelSharingProperties, serializedAdditionalRawData);
        }
