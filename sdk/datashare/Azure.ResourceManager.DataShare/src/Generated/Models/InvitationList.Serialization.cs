...
{
    internal partial class InvitationList : IUtf8JsonSerializable, IJsonModel<InvitationList>, IPersistableModel<InvitationList>
    {
        ...
        void IJsonModel<InvitationList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InvitationList)} does not support '{format}' format.");
            }
