...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InvitationList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InvitationList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InvitationList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InvitationList>)} interface");
            }
        ...
        string IPersistableModel<InvitationList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
