...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdlsGen1FileDataSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdlsGen1FileDataSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdlsGen1FileDataSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdlsGen1FileDataSet>)} interface");
            }
        ...
        string IPersistableModel<AdlsGen1FileDataSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
