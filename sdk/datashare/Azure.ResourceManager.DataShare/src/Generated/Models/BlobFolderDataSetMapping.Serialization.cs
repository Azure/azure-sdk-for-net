...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobFolderDataSetMapping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlobFolderDataSetMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobFolderDataSetMapping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BlobFolderDataSetMapping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
