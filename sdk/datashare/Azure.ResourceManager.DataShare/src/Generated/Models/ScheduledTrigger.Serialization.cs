...
{
    public partial class ScheduledTrigger : IUtf8JsonSerializable, IJsonModel<ScheduledTrigger>, IPersistableModel<ScheduledTrigger>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SynchronizeOn))
            {
                ...
                builder.AppendLine($" '{SynchronizeOn.ToString()}'");
            }

            if (Optional.IsDefined(TriggerStatus))
            {
                builder.Append("  triggerStatus:");
                builder.AppendLine($" '{TriggerStatus.ToString()}'");
            }
