...
{
    public partial class ScheduledTrigger : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ScheduledTrigger DeserializeScheduledTrigger(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
