...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShareSynchronization>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ShareSynchronization>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ShareSynchronization>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ShareSynchronization>)} interface");
            }
        ...
        string IPersistableModel<ShareSynchronization>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
