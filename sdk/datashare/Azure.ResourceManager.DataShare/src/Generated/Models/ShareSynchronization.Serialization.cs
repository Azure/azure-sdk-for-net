...
{
    public partial class ShareSynchronization : IUtf8JsonSerializable, IJsonModel<ShareSynchronization>, IPersistableModel<ShareSynchronization>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SynchronizationMode))
            {
                ...
                builder.AppendLine($" '{SynchronizationMode.ToString()}'");
            }
