    ...
    public partial class ShareSynchronization : IUtf8JsonSerializable, IJsonModel<ShareSynchronization>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConsumerEmail))
            {
                ...
                if (ConsumerEmail.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ConsumerName))
            {
                ...
                if (ConsumerName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ConsumerTenantName))
            {
                ...
                if (ConsumerTenantName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(SynchronizationId))
            {
                builder.Append("  synchronizationId:");
                builder.AppendLine($" '{SynchronizationId.Value.ToString()}'");
            }

            if (Optional.IsDefined(SynchronizationMode))
            {
                builder.Append("  synchronizationMode:");
                builder.AppendLine($" '{SynchronizationMode.Value.ToString()}'");
            }
