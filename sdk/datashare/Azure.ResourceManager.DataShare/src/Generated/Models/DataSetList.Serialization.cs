...
{
    internal partial class DataSetList : IUtf8JsonSerializable, IJsonModel<DataSetList>, IPersistableModel<DataSetList>
    {
        ...
        void IJsonModel<DataSetList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataSetList)} does not support '{format}' format.");
            }
