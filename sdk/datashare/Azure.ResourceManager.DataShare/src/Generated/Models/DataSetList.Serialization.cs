...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataSetList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataSetList)} does not support writing '{format}' format.");
            }
            ...
            {
                ((IJsonModel<ShareDataSetData>)item).Write(writer, options);
            }
        ...
        DataSetList IJsonModel<DataSetList>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataSetList)} does not support reading '{format}' format.");
            }
        ...
        internal static DataSetList DeserializeDataSetList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DataSetList(nextLink, value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DataSetList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataSetList)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DataSetList IPersistableModel<DataSetList>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataSetList)} does not support reading '{options.Format}' format.");
            }
        }
