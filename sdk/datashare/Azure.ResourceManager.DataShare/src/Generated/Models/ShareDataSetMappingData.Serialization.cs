...
namespace Azure.ResourceManager.DataShare
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShareDataSetMappingData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ShareDataSetMappingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ShareDataSetMappingData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ShareDataSetMappingData>)} interface");
            }
        ...
        string IPersistableModel<ShareDataSetMappingData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
