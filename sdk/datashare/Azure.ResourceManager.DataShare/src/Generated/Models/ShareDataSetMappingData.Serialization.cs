...
namespace Azure.ResourceManager.DataShare
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShareDataSetMappingData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ShareDataSetMappingData IJsonModel<ShareDataSetMappingData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static ShareDataSetMappingData DeserializeShareDataSetMappingData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ShareDataSetMappingData(id, name, type, systemData.Value, kind, serializedAdditionalRawData);
        }

        BinaryData IModel<ShareDataSetMappingData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ShareDataSetMappingData IModel<ShareDataSetMappingData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ShareDataSetMappingData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
