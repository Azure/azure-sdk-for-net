...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoClusterDataSetMapping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoClusterDataSetMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoClusterDataSetMapping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<KustoClusterDataSetMapping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
