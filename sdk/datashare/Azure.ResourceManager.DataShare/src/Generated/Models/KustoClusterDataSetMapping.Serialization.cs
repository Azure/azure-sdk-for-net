...
{
    public partial class KustoClusterDataSetMapping : IUtf8JsonSerializable, IJsonModel<KustoClusterDataSetMapping>, IPersistableModel<KustoClusterDataSetMapping>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KustoClusterResourceId))
            {
                builder.Append("  kustoClusterResourceId:");
                builder.AppendLine($" '{KustoClusterResourceId.ToString()}'");
            }
