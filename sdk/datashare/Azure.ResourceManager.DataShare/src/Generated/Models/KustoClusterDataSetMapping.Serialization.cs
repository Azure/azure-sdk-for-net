...
{
    public partial class KustoClusterDataSetMapping : Core.IUtf8JsonSerializable
    {
        ...
        internal static KustoClusterDataSetMapping DeserializeKustoClusterDataSetMapping(JsonElement element)
        {
            ...
            return new KustoClusterDataSetMapping(id, name, type, systemData.Value, kind, dataSetId, Core.Optional.ToNullable(dataSetMappingStatus), kustoClusterResourceId, Core.Optional.ToNullable(location), Core.Optional.ToNullable(provisioningState));
        }
    }
}
