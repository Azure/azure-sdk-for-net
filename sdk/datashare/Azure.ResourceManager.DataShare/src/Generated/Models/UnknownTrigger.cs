...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    internal partial class UnknownTrigger : ResourceData
    {
        ...
        internal UnknownTrigger(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TriggerKind kind) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
        }
