...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoClusterDataSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoClusterDataSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoClusterDataSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoClusterDataSet>)} interface");
            }
        ...
        string IPersistableModel<KustoClusterDataSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
