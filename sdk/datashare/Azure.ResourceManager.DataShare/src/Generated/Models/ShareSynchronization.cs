...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    public partial class ShareSynchronization
    {
        ...
        internal ShareSynchronization(string consumerEmail, string consumerName, string consumerTenantName, int? durationInMilliSeconds, DateTimeOffset? endOn, string message, DateTimeOffset? startOn, string status, Guid? synchronizationId, SynchronizationMode? synchronizationMode, Dictionary<string, BinaryData> rawData)
        {
