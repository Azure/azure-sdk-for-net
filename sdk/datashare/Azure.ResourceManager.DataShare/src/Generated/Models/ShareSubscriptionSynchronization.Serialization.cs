...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShareSubscriptionSynchronization>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ShareSubscriptionSynchronization>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ShareSubscriptionSynchronization>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ShareSubscriptionSynchronization>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
