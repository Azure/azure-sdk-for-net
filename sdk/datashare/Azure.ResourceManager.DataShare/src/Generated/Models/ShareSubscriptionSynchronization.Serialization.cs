...
{
    public partial class ShareSubscriptionSynchronization : IUtf8JsonSerializable, IJsonModel<ShareSubscriptionSynchronization>, IPersistableModel<ShareSubscriptionSynchronization>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SynchronizationId))
            {
                ...
                builder.AppendLine($" '{SynchronizationId.ToString()}'");
            }
