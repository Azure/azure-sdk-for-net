...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SynapseWorkspaceSqlPoolTableDataSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SynapseWorkspaceSqlPoolTableDataSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SynapseWorkspaceSqlPoolTableDataSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SynapseWorkspaceSqlPoolTableDataSet>)} interface");
            }
        ...
        string IPersistableModel<SynapseWorkspaceSqlPoolTableDataSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
