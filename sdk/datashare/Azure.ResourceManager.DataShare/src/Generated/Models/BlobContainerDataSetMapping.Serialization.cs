...
{
    public partial class BlobContainerDataSetMapping : Core.IUtf8JsonSerializable
    {
        ...
        internal static BlobContainerDataSetMapping DeserializeBlobContainerDataSetMapping(JsonElement element)
        {
            ...
            return new BlobContainerDataSetMapping(id, name, type, systemData.Value, kind, containerName, dataSetId, Core.Optional.ToNullable(dataSetMappingStatus), Core.Optional.ToNullable(provisioningState), resourceGroup, storageAccountName, subscriptionId);
        }
    }
}
