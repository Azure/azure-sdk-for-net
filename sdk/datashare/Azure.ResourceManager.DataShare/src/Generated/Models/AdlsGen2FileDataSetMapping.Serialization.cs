...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdlsGen2FileDataSetMapping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdlsGen2FileDataSetMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdlsGen2FileDataSetMapping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AdlsGen2FileDataSetMapping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
