...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlDWTableDataSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlDWTableDataSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlDWTableDataSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlDWTableDataSet>)} interface");
            }
        ...
        string IPersistableModel<SqlDWTableDataSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
