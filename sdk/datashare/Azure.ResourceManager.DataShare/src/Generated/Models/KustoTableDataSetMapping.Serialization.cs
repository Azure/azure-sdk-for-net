...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KustoTableDataSetMapping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KustoTableDataSetMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KustoTableDataSetMapping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KustoTableDataSetMapping>)} interface");
            }
        ...
        string IPersistableModel<KustoTableDataSetMapping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
