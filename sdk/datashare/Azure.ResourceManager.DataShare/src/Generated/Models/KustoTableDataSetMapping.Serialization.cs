...
{
    public partial class KustoTableDataSetMapping : IUtf8JsonSerializable, IJsonModel<KustoTableDataSetMapping>, IPersistableModel<KustoTableDataSetMapping>
    {
        ...
        void IJsonModel<KustoTableDataSetMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(KustoTableDataSetMapping)} does not support '{format}' format.");
            }
