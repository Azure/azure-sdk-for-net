...
namespace Azure.ResourceManager.DataShare.Models
{
    public partial class AdlsGen2FolderDataSetMapping : IUtf8JsonSerializable, IModelJsonSerializable<AdlsGen2FolderDataSetMapping>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AdlsGen2FolderDataSetMapping>(this, options.Format);
        ...
        internal static AdlsGen2FolderDataSetMapping DeserializeAdlsGen2FolderDataSetMapping(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AdlsGen2FolderDataSetMapping(id, name, type, systemData.Value, kind, dataSetId, Optional.ToNullable(dataSetMappingStatus), fileSystem, folderPath, Optional.ToNullable(provisioningState), resourceGroup, storageAccountName, subscriptionId, serializedAdditionalRawData);
        }
