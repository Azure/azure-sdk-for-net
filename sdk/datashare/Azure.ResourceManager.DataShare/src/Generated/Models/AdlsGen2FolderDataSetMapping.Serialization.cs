...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdlsGen2FolderDataSetMapping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdlsGen2FolderDataSetMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdlsGen2FolderDataSetMapping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdlsGen2FolderDataSetMapping>)} interface");
            }
        ...
        string IPersistableModel<AdlsGen2FolderDataSetMapping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
