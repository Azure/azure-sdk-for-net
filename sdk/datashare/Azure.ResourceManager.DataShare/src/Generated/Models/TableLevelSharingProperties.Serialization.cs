...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TableLevelSharingProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TableLevelSharingProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TableLevelSharingProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TableLevelSharingProperties>)} interface");
            }
        ...
        string IPersistableModel<TableLevelSharingProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
