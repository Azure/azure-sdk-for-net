...
namespace Azure.ResourceManager.DataShare
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataShareData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataShareData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataShareData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataShareData>)} interface");
            }
        ...
        string IPersistableModel<DataShareData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
