...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    public static partial class ArmDataShareModelFactory
    {
        ...
        public static DataShareAccountData DataShareAccountData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, DateTimeOffset? createdOn = null, DataShareProvisioningState? provisioningState = null, string userEmail = null, string userName = null)
        {
            ...
            return new DataShareAccountData(id, name, resourceType, systemData, tags, location, identity, createdOn, provisioningState, userEmail, userName, default);
        }
        ...
        {
            return new DataShareOperationResult(endOn, error, startOn, status, default);
        }
        ...
        {
            return new DataShareConsumerInvitationData(id, name, resourceType, systemData, dataSetCount, description, expireOn, invitationId, invitationStatus, location, providerEmail, providerName, providerTenantName, respondedOn, sentOn, shareName, termsOfUse, userEmail, userName, default);
        }
        ...
        {
            return new ShareDataSetData(id, name, resourceType, systemData, kind, default);
        }
        ...
        {
            return new ShareDataSetMappingData(id, name, resourceType, systemData, kind, default);
        }
        ...
        {
            return new DataShareEmailRegistration(activationCode, activationExpireOn, email, registrationStatus, tenantId, default);
        }
        ...
        {
            return new DataShareInvitationData(id, name, resourceType, systemData, expireOn, invitationId, invitationStatus, respondedOn, sentOn, targetActiveDirectoryId, targetEmail, targetObjectId, userEmail, userName, default);
        }
        ...
        {
            return new ShareSynchronization(consumerEmail, consumerName, consumerTenantName, durationInMilliSeconds, endOn, message, startOn, status, synchronizationId, synchronizationMode, default);
        }
        ...
        {
            return new SynchronizationDetails(dataSetId, dataSetType, durationInMilliSeconds, endOn, filesRead, filesWritten, message, name, rowsCopied, rowsRead, sizeRead, sizeWritten, startOn, status, vCore, default);
        }
        ...
        {
            return new ProviderShareSubscriptionData(id, name, resourceType, systemData, consumerEmail, consumerName, consumerTenantName, createdOn, expireOn, providerEmail, providerName, sharedOn, shareSubscriptionObjectId, shareSubscriptionStatus, default);
        }
        ...
        {
            return new DataShareData(id, name, resourceType, systemData, createdOn, description, provisioningState, shareKind, terms, userEmail, userName, default);
        }
        ...
        {
            return new ShareSubscriptionSynchronization(durationInMilliSeconds, endOn, message, startOn, status, synchronizationId, synchronizationMode, default);
        }
        ...
        {
            return new ConsumerSourceDataSet(id, name, resourceType, systemData, dataSetId, dataSetLocation, dataSetName, dataSetPath, dataSetType, default);
        }
        ...
        {
            return new ShareSubscriptionData(id, name, resourceType, systemData, createdOn, expireOn, invitationId, providerEmail, providerName, providerTenantName, provisioningState, shareDescription, shareKind, shareName, shareSubscriptionStatus, shareTerms, sourceShareLocation, userEmail, userName, default);
        }
        ...
        {
            return new DataShareSynchronizationSettingData(id, name, resourceType, systemData, kind, default);
        }
        ...
        {
            return new DataShareTriggerData(id, name, resourceType, systemData, kind, default);
        }
        ...
        {
            return new AdlsGen1FileDataSet(id, name, resourceType, systemData, DataSetKind.AdlsGen1File, accountName, dataSetId, fileName, folderPath, resourceGroup, subscriptionId, default);
        }
        ...
        {
            return new AdlsGen1FolderDataSet(id, name, resourceType, systemData, DataSetKind.AdlsGen1Folder, accountName, dataSetId, folderPath, resourceGroup, subscriptionId, default);
        }

        /// <summary> Initializes a new instance of <see cref="AdlsGen2FileDataSet"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new AdlsGen2FileDataSet(id, name, resourceType, systemData, DataSetKind.AdlsGen2File, dataSetId, filePath, fileSystem, resourceGroup, storageAccountName, subscriptionId, default);
        }
        ...
        {
            return new AdlsGen2FileDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.AdlsGen2File, dataSetId, dataSetMappingStatus, filePath, fileSystem, outputType, provisioningState, resourceGroup, storageAccountName, subscriptionId, default);
        }
        ...
        {
            return new AdlsGen2FileSystemDataSet(id, name, resourceType, systemData, DataSetKind.AdlsGen2FileSystem, dataSetId, fileSystem, resourceGroup, storageAccountName, subscriptionId, default);
        }

        /// <summary> Initializes a new instance of <see cref="AdlsGen2FileSystemDataSetMapping"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new AdlsGen2FileSystemDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.AdlsGen2FileSystem, dataSetId, dataSetMappingStatus, fileSystem, provisioningState, resourceGroup, storageAccountName, subscriptionId, default);
        }
        ...
        {
            return new AdlsGen2FolderDataSet(id, name, resourceType, systemData, DataSetKind.AdlsGen2Folder, dataSetId, fileSystem, folderPath, resourceGroup, storageAccountName, subscriptionId, default);
        }
        ...
        {
            return new AdlsGen2FolderDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.AdlsGen2Folder, dataSetId, dataSetMappingStatus, fileSystem, folderPath, provisioningState, resourceGroup, storageAccountName, subscriptionId, default);
        }
        ...
        {
            return new BlobContainerDataSet(id, name, resourceType, systemData, DataSetKind.Container, containerName, dataSetId, resourceGroup, storageAccountName, subscriptionId, default);
        }
        ...
        {
            return new BlobContainerDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.Container, containerName, dataSetId, dataSetMappingStatus, provisioningState, resourceGroup, storageAccountName, subscriptionId, default);
        }
        ...
        {
            return new BlobDataSet(id, name, resourceType, systemData, DataSetKind.Blob, containerName, dataSetId, filePath, resourceGroup, storageAccountName, subscriptionId, default);
        }
        ...
        {
            return new BlobDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.Blob, containerName, dataSetId, dataSetMappingStatus, filePath, outputType, provisioningState, resourceGroup, storageAccountName, subscriptionId, default);
        }
        ...
        {
            return new BlobFolderDataSet(id, name, resourceType, systemData, DataSetKind.BlobFolder, containerName, dataSetId, prefix, resourceGroup, storageAccountName, subscriptionId, default);
        }
        ...
        {
            return new BlobFolderDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.BlobFolder, containerName, dataSetId, dataSetMappingStatus, prefix, provisioningState, resourceGroup, storageAccountName, subscriptionId, default);
        }
        ...
        {
            return new KustoClusterDataSet(id, name, resourceType, systemData, DataSetKind.KustoCluster, dataSetId, kustoClusterResourceId, location, provisioningState, default);
        }
        ...
        {
            return new KustoClusterDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.KustoCluster, dataSetId, dataSetMappingStatus, kustoClusterResourceId, location, provisioningState, default);
        }
        ...
        {
            return new KustoDatabaseDataSet(id, name, resourceType, systemData, DataSetKind.KustoDatabase, dataSetId, kustoDatabaseResourceId, location, provisioningState, default);
        }
        ...
        {
            return new KustoDatabaseDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.KustoDatabase, dataSetId, dataSetMappingStatus, kustoClusterResourceId, location, provisioningState, default);
        }
        ...
        {
            return new KustoTableDataSet(id, name, resourceType, systemData, DataSetKind.KustoTable, dataSetId, kustoDatabaseResourceId, location, provisioningState, tableLevelSharingProperties, default);
        }

        /// <summary> Initializes a new instance of <see cref="KustoTableDataSetMapping"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return new KustoTableDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.KustoTable, dataSetId, dataSetMappingStatus, kustoClusterResourceId, location, provisioningState, default);
        }
        ...
        {
            return new ScheduledSourceSynchronizationSetting(SourceShareSynchronizationSettingKind.ScheduleBased, recurrenceInterval, synchronizeOn, default);
        }
        ...
        {
            return new ScheduledSynchronizationSetting(id, name, resourceType, systemData, SynchronizationSettingKind.ScheduleBased, createdOn, provisioningState, recurrenceInterval, synchronizeOn, userName, default);
        }
        ...
        {
            return new ScheduledTrigger(id, name, resourceType, systemData, TriggerKind.ScheduleBased, createdOn, provisioningState, recurrenceInterval, synchronizationMode, synchronizeOn, triggerStatus, userName, default);
        }
        ...
        {
            return new SqlDBTableDataSet(id, name, resourceType, systemData, DataSetKind.SqlDBTable, databaseName, dataSetId, schemaName, sqlServerResourceId, tableName, default);
        }
        ...
        {
            return new SqlDBTableDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.SqlDBTable, databaseName, dataSetId, dataSetMappingStatus, provisioningState, schemaName, sqlServerResourceId, tableName, default);
        }
        ...
        {
            return new SqlDWTableDataSet(id, name, resourceType, systemData, DataSetKind.SqlDWTable, dataSetId, dataWarehouseName, schemaName, sqlServerResourceId, tableName, default);
        }
        ...
        {
            return new SqlDWTableDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.SqlDWTable, dataSetId, dataSetMappingStatus, dataWarehouseName, provisioningState, schemaName, sqlServerResourceId, tableName, default);
        }
        ...
        {
            return new SynapseWorkspaceSqlPoolTableDataSet(id, name, resourceType, systemData, DataSetKind.SynapseWorkspaceSqlPoolTable, dataSetId, synapseWorkspaceSqlPoolTableResourceId, default);
        }
        ...
        {
            return new SynapseWorkspaceSqlPoolTableDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.SynapseWorkspaceSqlPoolTable, dataSetId, dataSetMappingStatus, provisioningState, synapseWorkspaceSqlPoolTableResourceId, default);
        }
    }
}
