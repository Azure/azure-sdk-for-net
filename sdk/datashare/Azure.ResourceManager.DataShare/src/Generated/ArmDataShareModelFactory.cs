...
namespace Azure.ResourceManager.DataShare.Models
{
    ...
    public static partial class ArmDataShareModelFactory
    {
        ...
        public static DataShareAccountData DataShareAccountData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, DateTimeOffset? createdOn = null, DataShareProvisioningState? provisioningState = null, string userEmail = null, string userName = null)
        {
            ...
            return new DataShareAccountData(id, name, resourceType, systemData, tags, location, identity, createdOn, provisioningState, userEmail, userName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataShareOperationResult(endOn, error, startOn, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataShareConsumerInvitationData(id, name, resourceType, systemData, dataSetCount, description, expireOn, invitationId, invitationStatus, location, providerEmail, providerName, providerTenantName, respondedOn, sentOn, shareName, termsOfUse, userEmail, userName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ShareDataSetData(id, name, resourceType, systemData, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ShareDataSetMappingData(id, name, resourceType, systemData, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataShareEmailRegistration(activationCode, activationExpireOn, email, registrationStatus, tenantId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataShareInvitationData(id, name, resourceType, systemData, expireOn, invitationId, invitationStatus, respondedOn, sentOn, targetActiveDirectoryId, targetEmail, targetObjectId, userEmail, userName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ShareSynchronization(consumerEmail, consumerName, consumerTenantName, durationInMilliSeconds, endOn, message, startOn, status, synchronizationId, synchronizationMode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SynchronizationDetails(dataSetId, dataSetType, durationInMilliSeconds, endOn, filesRead, filesWritten, message, name, rowsCopied, rowsRead, sizeRead, sizeWritten, startOn, status, vCore, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProviderShareSubscriptionData(id, name, resourceType, systemData, consumerEmail, consumerName, consumerTenantName, createdOn, expireOn, providerEmail, providerName, sharedOn, shareSubscriptionObjectId, shareSubscriptionStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataShareData(id, name, resourceType, systemData, createdOn, description, provisioningState, shareKind, terms, userEmail, userName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ShareSubscriptionSynchronization(durationInMilliSeconds, endOn, message, startOn, status, synchronizationId, synchronizationMode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ConsumerSourceDataSet(id, name, resourceType, systemData, dataSetId, dataSetLocation, dataSetName, dataSetPath, dataSetType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataShareSynchronizationSettingData(id, name, resourceType, systemData, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataShareTriggerData(id, name, resourceType, systemData, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AdlsGen1FileDataSet(id, name, resourceType, systemData, DataSetKind.AdlsGen1File, new Dictionary<string, BinaryData>(), accountName, dataSetId, fileName, folderPath, resourceGroup, subscriptionId);
        }
        ...
        {
            return new AdlsGen1FolderDataSet(id, name, resourceType, systemData, DataSetKind.AdlsGen1Folder, new Dictionary<string, BinaryData>(), accountName, dataSetId, folderPath, resourceGroup, subscriptionId);
        }
        ...
        {
            return new AdlsGen2FileDataSet(id, name, resourceType, systemData, DataSetKind.AdlsGen2File, new Dictionary<string, BinaryData>(), dataSetId, filePath, fileSystem, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new AdlsGen2FileDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.AdlsGen2File, new Dictionary<string, BinaryData>(), dataSetId, dataSetMappingStatus, filePath, fileSystem, outputType, provisioningState, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new AdlsGen2FileSystemDataSet(id, name, resourceType, systemData, DataSetKind.AdlsGen2FileSystem, new Dictionary<string, BinaryData>(), dataSetId, fileSystem, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new AdlsGen2FileSystemDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.AdlsGen2FileSystem, new Dictionary<string, BinaryData>(), dataSetId, dataSetMappingStatus, fileSystem, provisioningState, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new AdlsGen2FolderDataSet(id, name, resourceType, systemData, DataSetKind.AdlsGen2Folder, new Dictionary<string, BinaryData>(), dataSetId, fileSystem, folderPath, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new AdlsGen2FolderDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.AdlsGen2Folder, new Dictionary<string, BinaryData>(), dataSetId, dataSetMappingStatus, fileSystem, folderPath, provisioningState, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new BlobContainerDataSet(id, name, resourceType, systemData, DataSetKind.Container, new Dictionary<string, BinaryData>(), containerName, dataSetId, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new BlobContainerDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.Container, new Dictionary<string, BinaryData>(), containerName, dataSetId, dataSetMappingStatus, provisioningState, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new BlobDataSet(id, name, resourceType, systemData, DataSetKind.Blob, new Dictionary<string, BinaryData>(), containerName, dataSetId, filePath, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new BlobDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.Blob, new Dictionary<string, BinaryData>(), containerName, dataSetId, dataSetMappingStatus, filePath, outputType, provisioningState, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new BlobFolderDataSet(id, name, resourceType, systemData, DataSetKind.BlobFolder, new Dictionary<string, BinaryData>(), containerName, dataSetId, prefix, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new BlobFolderDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.BlobFolder, new Dictionary<string, BinaryData>(), containerName, dataSetId, dataSetMappingStatus, prefix, provisioningState, resourceGroup, storageAccountName, subscriptionId);
        }
        ...
        {
            return new KustoClusterDataSet(id, name, resourceType, systemData, DataSetKind.KustoCluster, new Dictionary<string, BinaryData>(), dataSetId, kustoClusterResourceId, location, provisioningState);
        }
        ...
        {
            return new KustoClusterDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.KustoCluster, new Dictionary<string, BinaryData>(), dataSetId, dataSetMappingStatus, kustoClusterResourceId, location, provisioningState);
        }
        ...
        {
            return new KustoDatabaseDataSet(id, name, resourceType, systemData, DataSetKind.KustoDatabase, new Dictionary<string, BinaryData>(), dataSetId, kustoDatabaseResourceId, location, provisioningState);
        }
        ...
        {
            return new KustoDatabaseDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.KustoDatabase, new Dictionary<string, BinaryData>(), dataSetId, dataSetMappingStatus, kustoClusterResourceId, location, provisioningState);
        }
        ...
        {
            return new KustoTableDataSet(id, name, resourceType, systemData, DataSetKind.KustoTable, new Dictionary<string, BinaryData>(), dataSetId, kustoDatabaseResourceId, location, provisioningState, tableLevelSharingProperties);
        }
        ...
        {
            return new KustoTableDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.KustoTable, new Dictionary<string, BinaryData>(), dataSetId, dataSetMappingStatus, kustoClusterResourceId, location, provisioningState);
        }
        ...
        {
            return new ScheduledSourceSynchronizationSetting(SourceShareSynchronizationSettingKind.ScheduleBased, new Dictionary<string, BinaryData>(), recurrenceInterval, synchronizeOn);
        }
        ...
        {
            return new ScheduledSynchronizationSetting(id, name, resourceType, systemData, SynchronizationSettingKind.ScheduleBased, new Dictionary<string, BinaryData>(), createdOn, provisioningState, recurrenceInterval, synchronizeOn, userName);
        }
        ...
        {
            return new ScheduledTrigger(id, name, resourceType, systemData, TriggerKind.ScheduleBased, new Dictionary<string, BinaryData>(), createdOn, provisioningState, recurrenceInterval, synchronizationMode, synchronizeOn, triggerStatus, userName);
        }
        ...
        {
            return new SqlDBTableDataSet(id, name, resourceType, systemData, DataSetKind.SqlDBTable, new Dictionary<string, BinaryData>(), databaseName, dataSetId, schemaName, sqlServerResourceId, tableName);
        }
        ...
        {
            return new SqlDBTableDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.SqlDBTable, new Dictionary<string, BinaryData>(), databaseName, dataSetId, dataSetMappingStatus, provisioningState, schemaName, sqlServerResourceId, tableName);
        }
        ...
        {
            return new SqlDWTableDataSet(id, name, resourceType, systemData, DataSetKind.SqlDWTable, new Dictionary<string, BinaryData>(), dataSetId, dataWarehouseName, schemaName, sqlServerResourceId, tableName);
        }
        ...
        {
            return new SqlDWTableDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.SqlDWTable, new Dictionary<string, BinaryData>(), dataSetId, dataSetMappingStatus, dataWarehouseName, provisioningState, schemaName, sqlServerResourceId, tableName);
        }
        ...
        {
            return new SynapseWorkspaceSqlPoolTableDataSet(id, name, resourceType, systemData, DataSetKind.SynapseWorkspaceSqlPoolTable, new Dictionary<string, BinaryData>(), dataSetId, synapseWorkspaceSqlPoolTableResourceId);
        }
        ...
        {
            return new SynapseWorkspaceSqlPoolTableDataSetMapping(id, name, resourceType, systemData, DataSetMappingKind.SynapseWorkspaceSqlPoolTable, new Dictionary<string, BinaryData>(), dataSetId, dataSetMappingStatus, provisioningState, synapseWorkspaceSqlPoolTableResourceId);
        }
    }
}
