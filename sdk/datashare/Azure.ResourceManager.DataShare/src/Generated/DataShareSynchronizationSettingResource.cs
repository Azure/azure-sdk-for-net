...
namespace Azure.ResourceManager.DataShare
{
    ...
    public partial class DataShareSynchronizationSettingResource : ArmResource
    {
        ...
        internal DataShareSynchronizationSettingResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _dataShareSynchronizationSettingSynchronizationSettingsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataShare", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string dataShareSynchronizationSettingSynchronizationSettingsApiVersion);
        ...
        public virtual DataShareSynchronizationSettingData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<DataShareSynchronizationSettingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _dataShareSynchronizationSettingSynchronizationSettingsClientDiagnostics.CreateScope("DataShareSynchronizationSettingResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DataShareSynchronizationSettingResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _dataShareSynchronizationSettingSynchronizationSettingsClientDiagnostics.CreateScope("DataShareSynchronizationSettingResource.Get");
            scope.Start();
            try
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>SynchronizationSettings_Delete</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using var scope = _dataShareSynchronizationSettingSynchronizationSettingsClientDiagnostics.CreateScope("DataShareSynchronizationSettingResource.Delete");
            scope.Start();
            try
            {
