...
namespace Azure.ResourceManager.DataShare
{
    ...
    public partial class ShareData : ResourceData
    {
        ...
        internal ShareData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? createdOn, string description, ProvisioningState? provisioningState, ShareKind? shareKind, string terms, string userEmail, string userName) : base(id, name, resourceType, systemData)
        {
            CreatedOn = createdOn;
        ...
        public ShareKind? ShareKind { get; set; }
