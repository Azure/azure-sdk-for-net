...
namespace Azure.ResourceManager.DataShare.Mocking
{
    ...
    internal partial class DataShareTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataShareTenantMockingExtension"/> class for mocking. </summary>
        protected DataShareTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataShareTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataShareTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = DataShareConsumerInvitationConsumerInvitationsClientDiagnostics.CreateScope("DataShareTenantMockingExtension.RejectConsumerInvitation");
            scope.Start();
            try
            {
        ...
        {
            using var scope = EmailRegistrationsClientDiagnostics.CreateScope("DataShareTenantMockingExtension.ActivateEmail");
            scope.Start();
            try
            {
        ...
        {
            using var scope = EmailRegistrationsClientDiagnostics.CreateScope("DataShareTenantMockingExtension.RegisterEmail");
            scope.Start();
            try
            {
