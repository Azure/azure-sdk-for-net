...
namespace Azure.ResourceManager.DataShare.Testing
{
    ...
    public partial class DataShareTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataShareTenantResourceExtension"/> class for mocking. </summary>
        protected DataShareTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataShareTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataShareTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<DataShareConsumerInvitationResource>> RejectConsumerInvitationAsync(AzureLocation location, DataShareConsumerInvitationData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DataShareConsumerInvitationConsumerInvitationsClientDiagnostics.CreateScope("DataShareTenantResourceExtension.RejectConsumerInvitation");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<DataShareEmailRegistration>> ActivateEmailAsync(AzureLocation location, DataShareEmailRegistration emailRegistration, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = EmailRegistrationsClientDiagnostics.CreateScope("DataShareTenantResourceExtension.ActivateEmail");
            scope.Start();
            try
            {
        ...
        {
            using var scope = EmailRegistrationsClientDiagnostics.CreateScope("DataShareTenantResourceExtension.RegisterEmail");
            scope.Start();
            try
            {
