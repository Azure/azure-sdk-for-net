...
namespace Azure.ResourceManager.DataShare.Mock
{
    ...
    public partial class DataShareAccountResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataShareAccountResourceExtension"/> class for mocking. </summary>
        protected DataShareAccountResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataShareAccountResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataShareAccountResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DataShareAccountResource> GetDataShareAccountsAsync(string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DataShareAccountResource(Client, DataShareAccountData.DeserializeDataShareAccountData(e)), DataShareAccountAccountsClientDiagnostics, Pipeline, "DataShareAccountResourceExtension.GetDataShareAccounts", "value", "nextLink", cancellationToken);
        }
