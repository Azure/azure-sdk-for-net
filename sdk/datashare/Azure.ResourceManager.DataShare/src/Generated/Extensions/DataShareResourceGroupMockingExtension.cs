...
namespace Azure.ResourceManager.DataShare.Mocking
{
    ...
    internal partial class DataShareResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DataShareResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DataShareResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataShareResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataShareResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
