...
namespace Azure.ResourceManager.DataShare.Mock
{
    ...
    public partial class DataShareConsumerInvitationResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataShareConsumerInvitationResourceExtension"/> class for mocking. </summary>
        protected DataShareConsumerInvitationResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataShareConsumerInvitationResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataShareConsumerInvitationResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<DataShareConsumerInvitationResource>> RejectConsumerInvitationAsync(AzureLocation location, DataShareConsumerInvitationData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DataShareConsumerInvitationConsumerInvitationsClientDiagnostics.CreateScope("DataShareConsumerInvitationResourceExtension.RejectConsumerInvitation");
            scope.Start();
            try
            {
