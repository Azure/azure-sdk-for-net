...
namespace Azure.ResourceManager.DataShare.Mocking
{
    ...
    internal partial class DataShareSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataShareSubscriptionMockingExtension"/> class for mocking. </summary>
        protected DataShareSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataShareSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataShareSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
