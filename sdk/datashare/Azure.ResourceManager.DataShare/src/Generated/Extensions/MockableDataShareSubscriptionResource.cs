...
namespace Azure.ResourceManager.DataShare.Mocking
{
    ...
    public partial class MockableDataShareSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockableDataShareSubscriptionResource"/> class for mocking. </summary>
        protected MockableDataShareSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableDataShareSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableDataShareSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
