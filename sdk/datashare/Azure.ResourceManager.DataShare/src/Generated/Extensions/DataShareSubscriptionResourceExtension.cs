...
namespace Azure.ResourceManager.DataShare.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class DataShareSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataShareSubscriptionResourceExtension"/> class for mocking. </summary>
        protected DataShareSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataShareSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataShareSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
