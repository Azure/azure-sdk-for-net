...
{
    /// <summary>
    /// A class representing the DataSetMapping data model.
    ...
    /// </summary>
    public partial class DataSetMappingData : ResourceData
    {
        /// <summary> Initializes a new instance of DataSetMappingData. </summary>
        ...
        internal DataSetMappingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataSetMappingKind kind) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
        }
