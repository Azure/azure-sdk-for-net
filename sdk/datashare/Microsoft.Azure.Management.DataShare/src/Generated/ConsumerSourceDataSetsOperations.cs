...
namespace Microsoft.Azure.Management.DataShare
{
    ...
    /// </summary>
    internal partial class ConsumerSourceDataSetsOperations : IServiceOperations<DataShareManagementClient>, IConsumerSourceDataSetsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ConsumerSourceDataSetsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ConsumerSourceDataSetsOperations(DataShareManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<ConsumerSourceDataSet>>> ListByShareSubscriptionWithHttpMessagesAsync(string resourceGroupName, string accountName, string shareSubscriptionName, string skipToken = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataShare/accounts/{accountName}/shareSubscriptions/{shareSubscriptionName}/consumerSourceDataSets").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<ConsumerSourceDataSet>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<ConsumerSourceDataSet>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<ConsumerSourceDataSet>>> ListByShareSubscriptionNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
