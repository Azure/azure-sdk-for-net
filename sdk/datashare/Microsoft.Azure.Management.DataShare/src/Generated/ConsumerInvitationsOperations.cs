...
namespace Microsoft.Azure.Management.DataShare
{
    ...
    /// </summary>
    internal partial class ConsumerInvitationsOperations : IServiceOperations<DataShareManagementClient>, IConsumerInvitationsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ConsumerInvitationsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ConsumerInvitationsOperations(DataShareManagementClient client)
        {
            if (client == null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ConsumerInvitation>> GetWithHttpMessagesAsync(string location, string invitationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (location == null)
            {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("invitationId", invitationId);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "Get", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.DataShare/locations/{location}/consumerInvitations/{invitationId}").ToString();
            _url = _url.Replace("{location}", System.Uri.EscapeDataString(location));
            _url = _url.Replace("{invitationId}", System.Uri.EscapeDataString(invitationId));
            List<string> _queryParameters = new List<string>();
            if (Client.ApiVersion != null)
            {
                _queryParameters.Add(string.Format("api-version={0}", System.Uri.EscapeDataString(Client.ApiVersion)));
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<ConsumerInvitation>>> ListInvitationsNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "ListInvitationsNext", tracingParameters);
            }
            // Construct URL
