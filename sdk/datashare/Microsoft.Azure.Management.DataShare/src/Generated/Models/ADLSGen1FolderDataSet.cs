...
namespace Microsoft.Azure.Management.DataShare.Models
{
    ...
    public partial class ADLSGen1FolderDataSet : DataSet
    {
        ...
        /// resource</param>
        public ADLSGen1FolderDataSet(string accountName, string folderPath, string resourceGroup, string subscriptionId, string id = default(string), string name = default(string), SystemData systemData = default(SystemData), string type = default(string), string dataSetId = default(string))
