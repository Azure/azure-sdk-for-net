...
#pragma warning disable SA1649 // File name should match first type name
    internal class ContainerServiceNodeCustomizationArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of ContainerServiceNodeCustomizationArmOperation for mocking. </summary>
        protected ContainerServiceNodeCustomizationArmOperation()
        {
        }

        internal ContainerServiceNodeCustomizationArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ContainerServiceNodeCustomizationArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ContainerServiceNodeCustomizationArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var data = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerContainerServiceNodeCustomizationContext.Default);
