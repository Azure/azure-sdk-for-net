...
namespace Azure.ResourceManager._FileShares.Models
{
    ...
    public partial class FileShareProvisioningRecommendationOutput
    {
        ...
        /// <summary> Initializes a new instance of <see cref="FileShareProvisioningRecommendationOutput"/>. </summary>
        ...
        internal FileShareProvisioningRecommendationOutput(int provisionedIOPerSec, int provisionedThroughputMiBPerSec, IEnumerable<Redundancy> availableRedundancyOptions)
        {
        ...
        internal FileShareProvisioningRecommendationOutput(int provisionedIOPerSec, int provisionedThroughputMiBPerSec, IList<Redundancy> availableRedundancyOptions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ProvisionedIOPerSec = provisionedIOPerSec;
            ProvisionedThroughputMiBPerSec = provisionedThroughputMiBPerSec;
        ...
        public IList<Redundancy> AvailableRedundancyOptions { get; }
    }
}
