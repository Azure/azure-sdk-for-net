...
namespace Azure.ResourceManager._FileShares.Models
{
    ...
    public partial class FileSharesPrivateLinkServiceConnectionState
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="FileSharesPrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal FileSharesPrivateLinkServiceConnectionState(FileSharesPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
