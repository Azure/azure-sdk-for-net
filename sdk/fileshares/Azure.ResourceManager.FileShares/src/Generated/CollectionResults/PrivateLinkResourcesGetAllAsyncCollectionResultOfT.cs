...
namespace Azure.ResourceManager.FileShares
{
    internal partial class PrivateLinkResourcesGetAllAsyncCollectionResultOfT : AsyncPageable<FileSharePrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetAllAsyncCollectionResultOfT(PrivateLinkResources client, Guid subscriptionId, string resourceGroupName, string resourceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
