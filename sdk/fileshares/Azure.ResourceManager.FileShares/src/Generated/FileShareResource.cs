...
namespace Azure.ResourceManager.FileShares
{
    ...
    public partial class FileShareResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FileShareResource>> UpdateAsync(WaitUntil waitUntil, FileShareData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _fileSharesInterfaceRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, FileShareData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                FileSharesArmOperation<FileShareResource> operation = new FileSharesArmOperation<FileShareResource>(
                    new FileShareResourceOperationSource(Client),
                    _fileSharesInterfaceClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<FileShareResource> Update(WaitUntil waitUntil, FileShareData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
