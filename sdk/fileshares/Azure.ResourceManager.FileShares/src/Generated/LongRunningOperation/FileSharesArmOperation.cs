...
{
    internal partial class FileSharesArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of FileSharesArmOperation for mocking. </summary>
        protected FileSharesArmOperation()
        {
        }
        ...
        internal FileSharesArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal FileSharesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
