...
namespace Azure.ResourceManager.FileShares
{
    internal partial class FileSharesArmOperation : ArmOperation
    {
        ...
        internal FileSharesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
