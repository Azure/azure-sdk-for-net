...
namespace Azure.ResourceManager.FileShares
{
    internal partial class FileSharesArmOperation<T> : ArmOperation<T>
    {
        ...
        internal FileSharesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
