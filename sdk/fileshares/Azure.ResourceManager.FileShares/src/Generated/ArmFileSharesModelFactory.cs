...
namespace Azure.ResourceManager.FileShares.Models
{
    ...
    public static partial class ArmFileSharesModelFactory
    {
        ...
        /// <param name="name0"> The resource name of the file share, as seen by the administrator through Azure Resource Manager. </param>
        /// <returns> A new <see cref="FileShares.FileShareData"/> instance for mocking. </returns>
        public static FileShareData FileShareData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, FileShareProperties properties = default, string name0 = default)
        {
