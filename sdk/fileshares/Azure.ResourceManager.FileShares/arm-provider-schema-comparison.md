# ARM provider schema comparison: Azure.ResourceManager.FileShares
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.FileShares/fileShares/{resourceName}/privateLinkResources/{privateLinkResourceName}` | `FileSharePrivateLinkResource` | `PrivateLinkResource` |
