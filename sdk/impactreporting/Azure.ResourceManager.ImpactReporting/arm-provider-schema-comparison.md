...
| --- | --- | --- |
| `/subscriptions/{}/providers/microsoft.impact/connectors/{}` | `ImpactConnector` | `Connector` |
| `/subscriptions/{}/providers/microsoft.impact/workloadimpacts/{}/insights/{}` | `ImpactInsight` | `Insight` |
