...
namespace Azure.ResourceManager.ImpactReporting.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectorListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ConnectorListResult DeserializeConnectorListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ConnectorListResult(value, nextLink, serializedAdditionalRawData);
        }
