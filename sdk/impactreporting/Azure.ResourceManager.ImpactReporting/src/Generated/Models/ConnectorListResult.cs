...
namespace Azure.ResourceManager.ImpactReporting.Models
{
    ...
    internal partial class ConnectorListResult
    {
        ...
        internal ConnectorListResult(IReadOnlyList<ConnectorData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<ConnectorData> Value { get; }
