...
#pragma warning disable SA1649 // File name should match first type name
    internal class ImpactReportingArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of ImpactReportingArmOperation for mocking. </summary>
        protected ImpactReportingArmOperation()
        {
        }

        internal ImpactReportingArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ImpactReportingArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ImpactReportingArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var data = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerImpactReportingContext.Default);
