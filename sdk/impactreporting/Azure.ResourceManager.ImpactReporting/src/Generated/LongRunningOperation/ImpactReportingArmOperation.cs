...
namespace Azure.ResourceManager.ImpactReporting
{
    internal partial class ImpactReportingArmOperation : ArmOperation
    {
        ...
        internal ImpactReportingArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
