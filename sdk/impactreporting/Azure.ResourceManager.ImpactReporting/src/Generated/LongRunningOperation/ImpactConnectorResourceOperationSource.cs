...
{
    /// <summary></summary>
    internal partial class ImpactConnectorResourceOperationSource : IOperationSource<ImpactConnectorResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ImpactConnectorResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
