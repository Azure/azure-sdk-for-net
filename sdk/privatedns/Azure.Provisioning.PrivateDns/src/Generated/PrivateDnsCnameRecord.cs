...
namespace Azure.Provisioning.PrivateDns
{
    ...
    public partial class PrivateDnsCnameRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new PrivateDnsCnameRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public PrivateDnsCnameRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/privateDnsZones/CNAME", resourceVersion ?? "2024-06-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for PrivateDnsCnameRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing PrivateDnsCnameRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static PrivateDnsCnameRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            PrivateDnsCnameRecord result = new PrivateDnsCnameRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for PrivateDnsCnameRecord that are not part of the generated code. </summary>
