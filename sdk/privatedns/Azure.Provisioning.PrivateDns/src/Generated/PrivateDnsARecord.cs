...
namespace Azure.Provisioning.PrivateDns
{
    ...
    public partial class PrivateDnsARecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new PrivateDnsARecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public PrivateDnsARecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/privateDnsZones/A", resourceVersion ?? "2024-06-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for PrivateDnsARecord. </summary>
        ...
        /// <summary> Creates a reference to an existing PrivateDnsARecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static PrivateDnsARecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            PrivateDnsARecord result = new PrivateDnsARecord(bicepIdentifier, resourceVersion);
