...
namespace Azure.Provisioning.PrivateDns
{
    ...
    public partial class PrivateDnsSrvRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new PrivateDnsSrvRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public PrivateDnsSrvRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/privateDnsZones/SRV", resourceVersion ?? "2024-06-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for PrivateDnsSrvRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing PrivateDnsSrvRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static PrivateDnsSrvRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            PrivateDnsSrvRecord result = new PrivateDnsSrvRecord(bicepIdentifier, resourceVersion);
