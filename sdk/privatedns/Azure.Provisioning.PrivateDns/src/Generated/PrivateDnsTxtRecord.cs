...
namespace Azure.Provisioning.PrivateDns
{
    ...
    public partial class PrivateDnsTxtRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new PrivateDnsTxtRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public PrivateDnsTxtRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/privateDnsZones/TXT", resourceVersion ?? "2024-06-01")
        {
        }
        ...
        /// <summary> Creates a reference to an existing PrivateDnsTxtRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static PrivateDnsTxtRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            PrivateDnsTxtRecord result = new PrivateDnsTxtRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for PrivateDnsTxtRecord that are not part of the generated code. </summary>
