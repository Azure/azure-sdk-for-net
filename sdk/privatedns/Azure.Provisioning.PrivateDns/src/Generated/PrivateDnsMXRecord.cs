...
namespace Azure.Provisioning.PrivateDns
{
    ...
    public partial class PrivateDnsMXRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new PrivateDnsMXRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public PrivateDnsMXRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/privateDnsZones/MX", resourceVersion ?? "2024-06-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for PrivateDnsMXRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing PrivateDnsMXRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static PrivateDnsMXRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            PrivateDnsMXRecord result = new PrivateDnsMXRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for PrivateDnsMXRecord that are not part of the generated code. </summary>
