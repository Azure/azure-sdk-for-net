...
public partial class PrivateDnsTxtRecord
{
    ...
    /// <summary> Gets or sets the TXT records in the record set. </summary>
    [CodeGenMember("PrivateDnsTxtRecords")]
    public BicepList<PrivateDnsTxtRecordInfo> TxtRecords
    {
        get => Properties is null ? default : Properties.PrivateDnsTxtRecords;
        set
        {
    ...
    [Obsolete("This property is obsolete and will be removed in a future version. Please use TxtRecords instead.")]
    public BicepList<PrivateDnsTxtRecordInfo> PrivateDnsTxtRecords
    {
        get => TxtRecords;
        set => TxtRecords = value;
    }
