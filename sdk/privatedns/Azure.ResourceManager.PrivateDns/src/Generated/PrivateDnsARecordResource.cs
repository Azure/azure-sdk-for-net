...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsARecordResource : ArmResource
    {
        ...
        {
            TryGetApiVersion(ResourceType, out string privateDnsARecordApiVersion);
        ...
        public virtual async Task<ArmOperation<PrivateDnsARecordResource>> UpdateAsync(WaitUntil waitUntil, PrivateDnsARecordData parameters, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "A", Id.Name, PrivateDnsARecordData.ToRequestContent(parameters), matchConditions, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PrivateDnsARecordData> response = Response.FromValue(PrivateDnsARecordData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PrivateDnsARecordResource> Update(WaitUntil waitUntil, PrivateDnsARecordData parameters, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
