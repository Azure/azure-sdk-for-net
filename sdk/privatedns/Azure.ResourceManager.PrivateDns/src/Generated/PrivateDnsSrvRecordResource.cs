...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsSrvRecordResource : ArmResource
    {
        ...
        internal PrivateDnsSrvRecordResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _recordSetsRestClient = new RecordSets(_recordSetsClientDiagnostics, Pipeline, Endpoint, privateDnsSrvRecordApiVersion ?? "2024-06-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/SRV/{relativeRecordSetName}";
        ...
        public virtual async Task<Response<PrivateDnsSrvRecordResource>> UpdateAsync(PrivateDnsSrvRecordData parameters, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "SRV", Id.Name, PrivateDnsSrvRecordData.ToRequestContent(parameters), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PrivateDnsSrvRecordData> response = Response.FromValue(PrivateDnsSrvRecordData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual Response<PrivateDnsSrvRecordResource> Update(PrivateDnsSrvRecordData parameters, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
