...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public abstract partial class PrivateRecordSetResource : ArmResource
    {
        internal static PrivateRecordSetResource GetResource(ArmClient client, PrivateRecordSetData data)
        {
        ...
        private readonly PrivateRecordSetData _data;

        /// <summary> Initializes a new instance of the <see cref="PrivateRecordSetResource"/> class for mocking. </summary>
        protected PrivateRecordSetResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "PrivateRecordSetResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal PrivateRecordSetResource(ArmClient client, PrivateRecordSetData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal PrivateRecordSetResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual PrivateRecordSetData Data
        {
            get
            {
                if (!HasData)
        ...
        protected abstract Task<Response<PrivateRecordSetResource>> GetCoreAsync(CancellationToken cancellationToken = default);

        /// <summary> The default implementation for operation Get. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public async Task<Response<PrivateRecordSetResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> The core implementation for operation Get. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        protected abstract Response<PrivateRecordSetResource> GetCore(CancellationToken cancellationToken = default);

        /// <summary> The default implementation for operation Get. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public Response<PrivateRecordSetResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        protected abstract Task<Response<PrivateRecordSetResource>> UpdateCoreAsync(PrivateRecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public async Task<Response<PrivateRecordSetResource>> UpdateAsync(PrivateRecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        protected abstract Response<PrivateRecordSetResource> UpdateCore(PrivateRecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public Response<PrivateRecordSetResource> Update(PrivateRecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
