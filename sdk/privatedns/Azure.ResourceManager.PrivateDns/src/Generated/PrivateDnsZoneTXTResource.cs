...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    /// </summary>
    public partial class PrivateDnsZoneTXTResource : ArmResource
    {
        ...
        internal PrivateDnsZoneTXTResource(ArmClient client, RecordSetData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<PrivateDnsZoneTXTResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<PrivateDnsZoneTXTResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _privateDnsZoneTXTRecordSetsClientDiagnostics.CreateScope("PrivateDnsZoneTXTResource.Get");
            scope.Start();
            try
        ...
        public virtual async Task<Response<PrivateDnsZoneTXTResource>> UpdateAsync(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<PrivateDnsZoneTXTResource> Update(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
