...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsZoneTXTResource : RecordSetResource
    {
        ...
        {
            using var scope = _privateDnsZoneTXTRecordSetsClientDiagnostics.CreateScope("PrivateDnsZoneTXTResource.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue((RecordSetResource)new PrivateDnsZoneTXTResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<PrivateDnsZoneTXTResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((PrivateDnsZoneTXTResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<PrivateDnsZoneTXTResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _privateDnsZoneTXTRecordSetsClientDiagnostics.CreateScope("PrivateDnsZoneTXTResource.Delete");
            scope.Start();
            try
            {
        ...
        protected override async Task<Response<RecordSetResource>> UpdateCoreAsync(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _privateDnsZoneTXTRecordSetsClientDiagnostics.CreateScope("PrivateDnsZoneTXTResource.Update");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new async Task<Response<PrivateDnsZoneTXTResource>> UpdateAsync(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new Response<PrivateDnsZoneTXTResource> Update(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
