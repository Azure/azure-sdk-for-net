...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsZoneAResource : RecordSetResource
    {
        ...
        {
            using var scope = _privateDnsZoneARecordSetsClientDiagnostics.CreateScope("PrivateDnsZoneAResource.GetCore");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _privateDnsZoneARecordSetsClientDiagnostics.CreateScope("PrivateDnsZoneAResource.DeleteCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<Response<RecordSetResource>> UpdateCoreAsync(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _privateDnsZoneARecordSetsClientDiagnostics.CreateScope("PrivateDnsZoneAResource.UpdateCore");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new virtual async Task<Response<PrivateDnsZoneAResource>> UpdateAsync(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new virtual Response<PrivateDnsZoneAResource> Update(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
