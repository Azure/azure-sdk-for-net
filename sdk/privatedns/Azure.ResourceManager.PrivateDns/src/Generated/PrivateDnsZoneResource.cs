...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsZoneResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<PrivateDnsZoneResource>> UpdateAsync(WaitUntil waitUntil, PrivateDnsZoneData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _privateZonesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, PrivateDnsZoneData.ToRequestContent(data), matchConditions, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                PrivateDnsArmOperation<PrivateDnsZoneResource> operation = new PrivateDnsArmOperation<PrivateDnsZoneResource>(
                    new PrivateDnsZoneResourceOperationSource(Client),
                    _privateZonesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PrivateDnsZoneResource> Update(WaitUntil waitUntil, PrivateDnsZoneData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<PrivateDnsZoneResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ArmOperation<PrivateDnsZoneResource> result = await this.UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<PrivateDnsZoneResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<PrivateDnsZoneResource> result = this.Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
