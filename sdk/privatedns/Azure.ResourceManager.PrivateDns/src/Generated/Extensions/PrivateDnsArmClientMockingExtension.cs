...
namespace Azure.ResourceManager.PrivateDns.Mocking
{
    ...
    internal partial class PrivateDnsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PrivateDnsArmClientMockingExtension"/> class for mocking. </summary>
        protected PrivateDnsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PrivateDnsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PrivateDnsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal PrivateDnsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
