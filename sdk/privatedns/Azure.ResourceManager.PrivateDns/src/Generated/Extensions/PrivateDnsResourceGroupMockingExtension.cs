...
namespace Azure.ResourceManager.PrivateDns.Mocking
{
    ...
    internal partial class PrivateDnsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PrivateDnsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected PrivateDnsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PrivateDnsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PrivateDnsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
