...
using Azure.ResourceManager.PrivateDns.Testing;
...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public static partial class PrivateDnsExtensions
    {
        ...
        private static PrivateDnsSubscriptionResourceExtension GetPrivateDnsSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new PrivateDnsSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static PrivateDnsSubscriptionResourceExtension GetPrivateDnsSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new PrivateDnsSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetPrivateDnsSubscriptionResourceExtension(subscriptionResource).GetPrivateDnsZonesAsync(top, cancellationToken);
        }
        ...
        {
            return GetPrivateDnsSubscriptionResourceExtension(subscriptionResource).GetPrivateDnsZones(top, cancellationToken);
        }
    }
}
