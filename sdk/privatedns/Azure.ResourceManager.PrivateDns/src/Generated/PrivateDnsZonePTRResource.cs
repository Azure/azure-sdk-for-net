...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsZonePTRResource : RecordSetResource
    {
        ...
        {
            using var scope = _privateDnsZonePTRRecordSetsClientDiagnostics.CreateScope("PrivateDnsZonePTRResource.GetCore");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _privateDnsZonePTRRecordSetsClientDiagnostics.CreateScope("PrivateDnsZonePTRResource.DeleteCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<Response<RecordSetResource>> UpdateCoreAsync(RecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _privateDnsZonePTRRecordSetsClientDiagnostics.CreateScope("PrivateDnsZonePTRResource.UpdateCore");
            scope.Start();
            try
            {
