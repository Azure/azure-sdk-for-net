...
namespace Azure.ResourceManager.PrivateDns.Models
{
    ...
    {
        internal static PrivateDnsRecordListResult DeserializePrivateDnsRecordListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
