...
namespace Azure.ResourceManager.PrivateDns.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateDnsARecordInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateDnsARecordInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateDnsARecordInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateDnsARecordInfo>)} interface");
            }
        ...
        string IPersistableModel<PrivateDnsARecordInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
