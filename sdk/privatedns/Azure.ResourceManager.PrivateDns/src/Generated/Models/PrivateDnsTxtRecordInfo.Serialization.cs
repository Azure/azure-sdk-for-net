...
{
    public partial class PrivateDnsTxtRecordInfo : IUtf8JsonSerializable, IJsonModel<PrivateDnsTxtRecordInfo>, IPersistableModel<PrivateDnsTxtRecordInfo>
    {
        ...
        void IJsonModel<PrivateDnsTxtRecordInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PrivateDnsTxtRecordInfo)} does not support '{format}' format.");
            }
