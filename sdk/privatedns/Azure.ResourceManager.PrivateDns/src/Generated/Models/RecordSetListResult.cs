...
namespace Azure.ResourceManager.PrivateDns.Models
{
    ...
    internal partial class RecordSetListResult
    {
        ...
        internal RecordSetListResult(IEnumerable<PrivateDnsRecordData> value)
        {
            Value = value.ToList();
        }
        ...
        internal RecordSetListResult(IList<PrivateDnsRecordData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<PrivateDnsRecordData> Value { get; }
