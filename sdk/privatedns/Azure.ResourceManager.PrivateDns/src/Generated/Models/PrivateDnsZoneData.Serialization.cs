...
{
    public partial class PrivateDnsZoneData : IUtf8JsonSerializable, IModelJsonSerializable<PrivateDnsZoneData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<PrivateDnsZoneData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<PrivateDnsZoneData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PrivateDnsZoneData>(this, options.Format);
        ...
        internal static PrivateDnsZoneData DeserializePrivateDnsZoneData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        PrivateDnsZoneData IModelSerializable<PrivateDnsZoneData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PrivateDnsZoneData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="PrivateDnsZoneData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PrivateDnsZoneData"/> to convert. </param>
        public static implicit operator RequestContent(PrivateDnsZoneData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PrivateDnsZoneData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator PrivateDnsZoneData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializePrivateDnsZoneData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
