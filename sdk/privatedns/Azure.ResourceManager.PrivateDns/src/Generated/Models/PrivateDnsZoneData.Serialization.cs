...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateDnsZoneData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateDnsZoneData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateDnsZoneData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateDnsZoneData>)} interface");
            }
        ...
        string IPersistableModel<PrivateDnsZoneData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
