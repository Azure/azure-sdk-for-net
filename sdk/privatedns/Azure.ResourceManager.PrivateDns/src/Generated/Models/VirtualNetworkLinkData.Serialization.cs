...
{
    public partial class VirtualNetworkLinkData : IUtf8JsonSerializable, IJsonModel<VirtualNetworkLinkData>, IPersistableModel<VirtualNetworkLinkData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VirtualNetworkLinkState))
            {
                ...
                builder.AppendLine($" '{VirtualNetworkLinkState.ToString()}'");
            }
