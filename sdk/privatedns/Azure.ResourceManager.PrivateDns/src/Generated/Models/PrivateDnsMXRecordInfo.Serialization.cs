...
{
    public partial class PrivateDnsMXRecordInfo : IUtf8JsonSerializable, IJsonModel<PrivateDnsMXRecordInfo>, IPersistableModel<PrivateDnsMXRecordInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Preference))
            {
                ...
                builder.AppendLine($" '{Preference.Value.ToString()}'");
            }
