...
namespace Azure.ResourceManager.PrivateDns.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrivateDnsPtrRecordInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PrivateDnsPtrRecordInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PrivateDnsPtrRecordInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PrivateDnsPtrRecordInfo>)} interface");
            }
        ...
        string IPersistableModel<PrivateDnsPtrRecordInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
