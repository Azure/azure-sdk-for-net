...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class ARecordResource : ArmResource
    {
        ...
        public virtual async Task<Response<ARecordResource>> UpdateAsync(ARecordData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<ARecordResource> Update(ARecordData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
