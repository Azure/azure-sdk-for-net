...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class AaaaRecordData : RecordData
    {
        ...
        internal AaaaRecordData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? etag, IDictionary<string, string> metadata, long? ttl, string fqdn, bool? isAutoRegistered) : base(id, name, resourceType, systemData, etag, metadata, ttl, fqdn, isAutoRegistered)
        {
            AaaaRecords = new ChangeTrackingList<AaaaRecordInfo>();
        }
