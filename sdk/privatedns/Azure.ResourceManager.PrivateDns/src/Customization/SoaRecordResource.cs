...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class SoaRecordResource : ArmResource
    {
        ...
        public virtual async Task<Response<SoaRecordResource>> UpdateAsync(SoaRecordData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<SoaRecordResource> Update(SoaRecordData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
