...
{
    /// <summary>
    /// A class representing a PrivateDnsARecord along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="PrivateDnsARecordResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="PrivateDnsZoneResource"/> using the GetPrivateDnsARecords method.
    /// </summary>
    [CodeGenResourceDataAttribute(typeof(PrivateDnsARecordData))]
    [CodeGenSuppressAttribute("PrivateDnsARecordResource", typeof(ArmClient), typeof(PrivateDnsRecordData))]
    ...
    public partial class PrivateDnsARecordResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of PrivateDnsARecordResource for mocking. </summary>
        protected PrivateDnsARecordResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="PrivateDnsARecordResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string dnsARecordApiVersion);
        ...
        /// <param name="aRecordName"> The aRecordName. </param>
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="PrivateDnsARecordResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsARecordResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "A", Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsARecordResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "A", Id.Name, ifMatch, context);
