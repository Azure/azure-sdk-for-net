...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="PrivateDnsSoaRecordResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="PrivateDnsZoneResource"/> using the GetPrivateDnsSoaRecords method.
    /// </summary>
    [CodeGenResourceDataAttribute(typeof(PrivateDnsSoaRecordData))]
    [CodeGenSuppressAttribute("PrivateDnsSoaRecordResource", typeof(ArmClient), typeof(PrivateDnsRecordData))]
    ...
    public partial class PrivateDnsSoaRecordResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of PrivateDnsSoaRecordResource for mocking. </summary>
        protected PrivateDnsSoaRecordResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="PrivateDnsSoaRecordResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/SOA/{soaRecordName}";
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="PrivateDnsSoaRecordResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsSoaRecordResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "SOA", Id.Name, context);
        ...
        public virtual async Task<Response<PrivateDnsSoaRecordResource>> UpdateAsync(PrivateDnsSoaRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsSoaRecordResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "SOA", Id.Name, PrivateDnsSoaRecordData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PrivateDnsSoaRecordData> response = Response.FromValue(PrivateDnsSoaRecordData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<PrivateDnsSoaRecordResource> Update(PrivateDnsSoaRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsSoaRecordResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "SOA", Id.Name, ifMatch, context);
