...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsSoaRecordData : PrivateDnsBaseRecordData, IJsonModel<PrivateDnsSoaRecordData>
    {
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="PrivateDnsSoaRecordData"/> from. </param>
        internal static new PrivateDnsSoaRecordData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializePrivateDnsSoaRecordData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }

        internal static RequestContent ToRequestContent(PrivateDnsSoaRecordData dnsSoaRecordData)
        ...
        BinaryData IPersistableModel<PrivateDnsSoaRecordData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(this, options, AzureResourceManagerPrivateDnsContext.Default);
