...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="PrivateDnsTxtRecordData"/>. </summary>
        ...
        internal PrivateDnsTxtRecordData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, RecordSetProperties properties, ETag? eTag) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, properties, eTag)
        {
        }

        /// <summary> The list of TXT records in the record set. </summary>
        public IList<PrivateDnsTxtRecordInfo> PrivateDnsTxtRecords
        {
            get
            {
                ...
                return Properties.PrivateDnsTxtRecords;
            }
        }
    }
}
