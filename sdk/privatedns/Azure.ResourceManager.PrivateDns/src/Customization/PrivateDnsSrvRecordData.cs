...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="PrivateDnsSrvRecordData"/>. </summary>
        ...
        internal PrivateDnsSrvRecordData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, RecordSetProperties properties, ETag? eTag) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, properties, eTag)
        {
        }

        /// <summary> The list of SRV records in the record set. </summary>
        public IList<PrivateDnsSrvRecordInfo> PrivateDnsSrvRecords
        {
            get
            {
                ...
                return Properties.PrivateDnsSrvRecords;
            }
        }
    }
}
