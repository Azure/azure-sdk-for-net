...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="PrivateDnsMXRecordData"/>. </summary>
        ...
        internal PrivateDnsMXRecordData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, RecordSetProperties properties, ETag? eTag) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, properties, eTag)
        {
        }

        /// <summary> The list of MX records in the record set. </summary>
        public IList<PrivateDnsMXRecordInfo> PrivateDnsMXRecords
        {
            get
            {
                ...
                return Properties.PrivateDnsMXRecords;
            }
        }
    }
}
