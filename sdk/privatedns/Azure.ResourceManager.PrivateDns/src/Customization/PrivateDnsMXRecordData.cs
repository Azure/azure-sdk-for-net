...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsMXRecordData : PrivateDnsBaseRecordData
    {
        ...
        internal PrivateDnsMXRecordData(ResourceIdentifier id, string name, ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, ETag? etag, IDictionary<string, string> metadata, long? ttl, string fqdn, bool? isAutoRegistered, IList<PrivateDnsMXRecordInfo> mxRecords, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, etag, metadata, ttl, fqdn, isAutoRegistered, serializedAdditionalRawData)
        {
