...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsCnameRecordData : PrivateDnsBaseRecordData, IJsonModel<PrivateDnsCnameRecordData>
    {
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="PrivateDnsCnameRecordData"/> from. </param>
        internal static new PrivateDnsCnameRecordData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializePrivateDnsCnameRecordData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }

        internal static RequestContent ToRequestContent(PrivateDnsCnameRecordData dnsCnameRecordData)
        ...
        BinaryData IPersistableModel<PrivateDnsCnameRecordData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(this, options, AzureResourceManagerPrivateDnsContext.Default);
