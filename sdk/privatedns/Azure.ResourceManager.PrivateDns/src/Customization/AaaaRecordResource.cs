...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class AaaaRecordResource : ArmResource
    {
        ...
        public virtual async Task<Response<AaaaRecordResource>> UpdateAsync(AaaaRecordData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<AaaaRecordResource> Update(AaaaRecordData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
