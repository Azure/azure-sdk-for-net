...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    /// </summary>
    [CodeGenSuppressAttribute("CreateOrUpdateAsync", typeof(WaitUntil), typeof(PrivateDnsRecordType), typeof(string), typeof(PrivateDnsAaaaRecordData), typeof(MatchConditions), typeof(CancellationToken))]
    [CodeGenSuppressAttribute("CreateOrUpdate", typeof(WaitUntil), typeof(PrivateDnsRecordType), typeof(string), typeof(PrivateDnsAaaaRecordData), typeof(MatchConditions), typeof(CancellationToken))]
    ...
    public partial class PrivateDnsAaaaRecordCollection : ArmCollection, IEnumerable<PrivateDnsAaaaRecordResource>, IAsyncEnumerable<PrivateDnsAaaaRecordResource>
    {
        ...
        /// <summary> Initializes a new instance of PrivateDnsAaaaRecordCollection for mocking. </summary>
        protected PrivateDnsAaaaRecordCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="PrivateDnsAaaaRecordCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(PrivateDnsAaaaRecordResource.ResourceType, out string dnsAaaaRecordApiVersion);
            _recordSetsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PrivateDns", PrivateDnsAaaaRecordResource.ResourceType.Namespace, Diagnostics);
            _recordSetsRestClient = new RecordSets(_recordSetsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, dnsAaaaRecordApiVersion ?? "2024-06-01");
        ...
        public virtual async Task<ArmOperation<PrivateDnsAaaaRecordResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string aaaaRecordName, PrivateDnsAaaaRecordData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "AAAA", aaaaRecordName, PrivateDnsAaaaRecordData.ToRequestContent(data), matchConditions, context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="aaaaRecordName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="aaaaRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<PrivateDnsAaaaRecordResource> CreateOrUpdate(WaitUntil waitUntil, string aaaaRecordName, PrivateDnsAaaaRecordData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(aaaaRecordName, nameof(aaaaRecordName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<PrivateDnsAaaaRecordResource>> GetAsync(string aaaaRecordName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, "AAAA", aaaaRecordName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PrivateDnsAaaaRecordData> response = Response.FromValue(PrivateDnsAaaaRecordData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="aaaaRecordName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="aaaaRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<NullableResponse<PrivateDnsAaaaRecordResource>> GetIfExistsAsync(string aaaaRecordName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(aaaaRecordName, nameof(aaaaRecordName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="aaaaRecordName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="aaaaRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual NullableResponse<PrivateDnsAaaaRecordResource> GetIfExists(string aaaaRecordName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(aaaaRecordName, nameof(aaaaRecordName));
