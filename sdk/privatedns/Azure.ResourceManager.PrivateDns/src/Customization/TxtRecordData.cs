...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class TxtRecordData : RecordData
    {
        ...
        internal TxtRecordData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? etag, IDictionary<string, string> metadata, long? ttl, string fqdn, bool? isAutoRegistered) : base(id, name, resourceType, systemData, etag, metadata, ttl, fqdn, isAutoRegistered)
        {
            TxtRecords = new ChangeTrackingList<TxtRecordInfo>();
        }
