...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    [CodeGenSuppressAttribute("PrivateDnsMXRecordResource", typeof(ArmClient), typeof(PrivateDnsRecordData))]
    ...
    public partial class PrivateDnsMXRecordResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of PrivateDnsMXRecordResource for mocking. </summary>
        protected PrivateDnsMXRecordResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="PrivateDnsMXRecordResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/MX/{mxRecordName}";
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="PrivateDnsMXRecordResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsMXRecordResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "MX", Id.Name, context);
        ...
        public virtual async Task<Response<PrivateDnsMXRecordResource>> UpdateAsync(PrivateDnsMXRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsMXRecordResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "MX", Id.Name, PrivateDnsMXRecordData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PrivateDnsMXRecordData> response = Response.FromValue(PrivateDnsMXRecordData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<PrivateDnsMXRecordResource> Update(PrivateDnsMXRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsMXRecordResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "MX", Id.Name, ifMatch, context);
