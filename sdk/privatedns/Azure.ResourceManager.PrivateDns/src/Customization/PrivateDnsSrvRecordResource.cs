...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsSrvRecordResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string resourceGroupName, string PrivateDnsZoneName, string srvRecordName)
        {
            var resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{PrivateDnsZoneName}/SRV/{srvRecordName}";
