...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    /// </summary>
    [CodeGenResourceDataAttribute(typeof(PrivateDnsSrvRecordData))]
    [CodeGenSuppressAttribute("PrivateDnsSrvRecordResource", typeof(ArmClient), typeof(PrivateDnsRecordData))]
    ...
    public partial class PrivateDnsSrvRecordResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of PrivateDnsSrvRecordResource for mocking. </summary>
        protected PrivateDnsSrvRecordResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="PrivateDnsSrvRecordResource"/> class. </summary>
        ...
        /// <param name="srvRecordName"> The srvRecordName. </param>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/SRV/{srvRecordName}";
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="PrivateDnsSrvRecordResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsSrvRecordResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "SRV", Id.Name, context);
        ...
        public virtual async Task<Response<PrivateDnsSrvRecordResource>> UpdateAsync(PrivateDnsSrvRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsSrvRecordResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "SRV", Id.Name, PrivateDnsSrvRecordData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PrivateDnsSrvRecordData> response = Response.FromValue(PrivateDnsSrvRecordData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<PrivateDnsSrvRecordResource> Update(PrivateDnsSrvRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsSrvRecordResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "SRV", Id.Name, ifMatch, context);
