...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="PrivateDnsARecordData"/>. </summary>
        ...
        internal PrivateDnsARecordData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, RecordSetProperties properties, ETag? eTag) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, properties, eTag)
        {
        }

        /// <summary> The list of A records in the record set. </summary>
        public IList<PrivateDnsARecordInfo> PrivateDnsARecords
        {
            get
            {
                ...
                return Properties.PrivateDnsARecords;
            }
        }
    }
}
