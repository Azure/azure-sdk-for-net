...
namespace Azure.ResourceManager.PrivateDns
{
    public partial class PrivateDnsCnameRecordData : IUtf8JsonSerializable, IJsonModel<PrivateDnsCnameRecordData>
    {
        ...
        internal static PrivateDnsCnameRecordData DeserializePrivateDnsCnameRecordData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            PrivateDnsCnameRecordInfo cnameRecordInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<Azure.ResourceManager.Models.SystemData>(BinaryData.FromString(property.Value.GetRawText()), ModelSerializationExtensions.WireOptions, AzureResourceManagerPrivateDnsContext.Default);
                    continue;
                }
            ...
            return new PrivateDnsCnameRecordData(
                id,
                name,
                type,
                systemData,
