...
namespace Azure.ResourceManager.PrivateDns.Models
{
    ...
    internal partial class PrivateDnsSrvRecordListResult
    {
        ...
        internal PrivateDnsSrvRecordListResult(IReadOnlyList<PrivateDnsSrvRecordData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
