...
namespace Azure.ResourceManager.PrivateDns.Models
{
    ...
    internal partial class PrivateDnsAaaaRecordListResult
    {
        ...
        internal PrivateDnsAaaaRecordListResult(IReadOnlyList<PrivateDnsAaaaRecordData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
