...
namespace Azure.ResourceManager.PrivateDns.Models
{
    ...
    internal partial class PrivateDnsMXRecordListResult
    {
        ...
        internal PrivateDnsMXRecordListResult(IReadOnlyList<PrivateDnsMXRecordData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
