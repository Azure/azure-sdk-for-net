...
namespace Azure.ResourceManager.PrivateDns
{
    public partial class PrivateDnsPtrRecordData : IUtf8JsonSerializable, IJsonModel<PrivateDnsPtrRecordData>
    {
        ...
        internal static PrivateDnsPtrRecordData DeserializePrivateDnsPtrRecordData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PrivateDnsPtrRecordData(id, name, type, systemData.Value, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, Optional.ToNullable(isAutoRegistered), Optional.ToList(ptrRecords), serializedAdditionalRawData);
        }
