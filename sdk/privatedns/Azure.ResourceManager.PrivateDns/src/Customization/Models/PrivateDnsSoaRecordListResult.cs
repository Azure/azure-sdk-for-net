...
namespace Azure.ResourceManager.PrivateDns.Models
{
    ...
    internal partial class PrivateDnsSoaRecordListResult
    {
        ...
        internal PrivateDnsSoaRecordListResult(IReadOnlyList<PrivateDnsSoaRecordData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
