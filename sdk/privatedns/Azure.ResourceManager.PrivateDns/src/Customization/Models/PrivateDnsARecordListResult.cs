...
namespace Azure.ResourceManager.PrivateDns.Models
{
    ...
    internal partial class PrivateDnsARecordListResult
    {
        ...
        internal PrivateDnsARecordListResult(IReadOnlyList<PrivateDnsARecordData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
