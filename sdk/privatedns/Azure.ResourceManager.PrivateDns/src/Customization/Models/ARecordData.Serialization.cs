...
namespace Azure.ResourceManager.PrivateDns
{
    public partial class ARecordData : IUtf8JsonSerializable
    {
        ...
        internal static ARecordData DeserializeARecordData(JsonElement element)
        {
            ...
            return new ARecordData(id, name, type, systemData.Value, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, Optional.ToNullable(isAutoRegistered), Optional.ToList(aRecords));
        }
    }
}
