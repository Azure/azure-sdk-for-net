...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="PrivateDnsPtrRecordResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="PrivateDnsZoneResource"/> using the GetPrivateDnsPtrRecords method.
    /// </summary>
    [CodeGenResourceDataAttribute(typeof(PrivateDnsPtrRecordData))]
    [CodeGenSuppressAttribute("PrivateDnsPtrRecordResource", typeof(ArmClient), typeof(PrivateDnsRecordData))]
    ...
    public partial class PrivateDnsPtrRecordResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of PrivateDnsPtrRecordResource for mocking. </summary>
        protected PrivateDnsPtrRecordResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="PrivateDnsPtrRecordResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string dnsPtrRecordApiVersion);
        ...
        /// <param name="ptrRecordName"> The ptrRecordName. </param>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/PTR/{ptrRecordName}";
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="PrivateDnsPtrRecordResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsPtrRecordResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "PTR", Id.Name, context);
        ...
        public virtual async Task<Response<PrivateDnsPtrRecordResource>> UpdateAsync(PrivateDnsPtrRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsPtrRecordResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "PTR", Id.Name, PrivateDnsPtrRecordData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PrivateDnsPtrRecordData> response = Response.FromValue(PrivateDnsPtrRecordData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<PrivateDnsPtrRecordResource> Update(PrivateDnsPtrRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("PrivateDnsPtrRecordResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "PTR", Id.Name, ifMatch, context);
