...
namespace Azure.ResourceManager.PrivateDns
{
    ...
    public partial class PrivateDnsAaaaRecordResource : ArmResource
    {
        ...
        internal PrivateDnsAaaaRecordResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _recordSetsRestClient = new RecordSets(_recordSetsClientDiagnostics, Pipeline, Endpoint, dnsAaaaRecordApiVersion ?? "2024-06-01");
        ...
        /// <param name="aaaaRecordName"> The aaaaRecordName. </param>
