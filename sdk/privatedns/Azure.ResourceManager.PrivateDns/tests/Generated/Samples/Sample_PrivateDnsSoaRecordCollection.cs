...
{
    public partial class Sample_PrivateDnsSoaRecordCollection
    {
        ...
        public async Task CreateOrUpdate_PUTPrivateDNSZoneARecordSet()
        {
            ...
            // get the collection of this PrivateDnsSoaRecordResource
            PrivateDnsSoaRecordCollection collection = privateZone.GetPrivateDnsSoaRecords();
...
IPv4Address = "1.2.3.4",
            ...
            ArmOperation<PrivateDnsSoaRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            PrivateDnsSoaRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GETPrivateDNSZoneARecordSet()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "recordA";
            PrivateDnsSoaRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_GETPrivateDNSZoneARecordSets()
        {
            ...
            await foreach (PrivateDnsSoaRecordResource item in collection.GetAllAsync())
            {
