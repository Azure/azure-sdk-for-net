...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateAssistantFileRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
