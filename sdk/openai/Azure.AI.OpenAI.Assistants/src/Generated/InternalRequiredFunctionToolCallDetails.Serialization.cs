...
{
    internal partial class InternalRequiredFunctionToolCallDetails : IUtf8JsonWriteable, IJsonModel<InternalRequiredFunctionToolCallDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalRequiredFunctionToolCallDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<InternalRequiredFunctionToolCallDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalRequiredFunctionToolCallDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InternalRequiredFunctionToolCallDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalRequiredFunctionToolCallDetails)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static InternalRequiredFunctionToolCallDetails FromResponse(PipelineResponse response)
        {
