...
{
    public partial class RunStepCodeInterpreterImageReference : IUtf8JsonWriteable, IJsonModel<RunStepCodeInterpreterImageReference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepCodeInterpreterImageReference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RunStepCodeInterpreterImageReference FromResponse(PipelineResponse response)
        {
