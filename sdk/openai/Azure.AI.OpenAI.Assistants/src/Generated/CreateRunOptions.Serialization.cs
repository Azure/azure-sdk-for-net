...
{
    public partial class CreateRunOptions : IUtf8JsonWriteable, IJsonModel<CreateRunOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateRunOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CreateRunOptions FromResponse(PipelineResponse response)
        {
