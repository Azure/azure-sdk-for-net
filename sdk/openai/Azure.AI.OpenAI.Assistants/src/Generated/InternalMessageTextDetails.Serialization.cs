...
{
    internal partial class InternalMessageTextDetails : IUtf8JsonWriteable, IJsonModel<InternalMessageTextDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalMessageTextDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<InternalMessageTextDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalMessageTextDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InternalMessageTextDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalMessageTextDetails)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static InternalMessageTextDetails FromResponse(PipelineResponse response)
        {
