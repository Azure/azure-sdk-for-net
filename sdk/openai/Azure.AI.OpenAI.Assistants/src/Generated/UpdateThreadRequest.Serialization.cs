...
{
    internal partial class UpdateThreadRequest : IUtf8JsonWriteable, IJsonModel<UpdateThreadRequest>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateThreadRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static UpdateThreadRequest DeserializeUpdateThreadRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UpdateThreadRequest(metadata ?? new OptionalDictionary<string, string>(), serializedAdditionalRawData);
        }
        ...
        internal static UpdateThreadRequest FromResponse(PipelineResponse response)
        {
