...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class RunStepToolCall : IUtf8JsonWriteable, IJsonModel<RunStepToolCall>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepToolCall>)this).Write(writer, new ModelReaderWriterOptions("W"));
