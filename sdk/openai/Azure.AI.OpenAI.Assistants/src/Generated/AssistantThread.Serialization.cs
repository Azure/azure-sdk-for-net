...
{
    public partial class AssistantThread : IUtf8JsonWriteable, IJsonModel<AssistantThread>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssistantThread>)this).Write(writer, new ModelReaderWriterOptions("W"));
