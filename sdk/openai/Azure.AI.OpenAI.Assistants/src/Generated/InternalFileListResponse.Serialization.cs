...
{
    internal partial class InternalFileListResponse : IUtf8JsonWriteable, IJsonModel<InternalFileListResponse>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalFileListResponse>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static InternalFileListResponse FromResponse(PipelineResponse response)
        {
