...
{
    internal partial class InternalMessageImageFileDetails : IUtf8JsonWriteable, IJsonModel<InternalMessageImageFileDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalMessageImageFileDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static InternalMessageImageFileDetails FromResponse(PipelineResponse response)
        {
