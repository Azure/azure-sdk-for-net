...
{
    public partial class ThreadRun : IUtf8JsonWriteable, IJsonModel<ThreadRun>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThreadRun>)this).Write(writer, new ModelReaderWriterOptions("W"));
