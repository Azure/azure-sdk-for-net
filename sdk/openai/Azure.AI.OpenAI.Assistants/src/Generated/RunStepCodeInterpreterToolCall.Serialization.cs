...
{
    public partial class RunStepCodeInterpreterToolCall : IUtf8JsonWriteable, IJsonModel<RunStepCodeInterpreterToolCall>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepCodeInterpreterToolCall>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new RunStepCodeInterpreterToolCall FromResponse(PipelineResponse response)
        {
