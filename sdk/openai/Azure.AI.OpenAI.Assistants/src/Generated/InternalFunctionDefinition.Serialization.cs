...
{
    internal partial class InternalFunctionDefinition : IUtf8JsonWriteable, IJsonModel<InternalFunctionDefinition>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalFunctionDefinition>)this).Write(writer, new ModelReaderWriterOptions("W"));
