...
{
    internal partial class InternalMessageTextFileCitationDetails : IUtf8JsonWriteable, IJsonModel<InternalMessageTextFileCitationDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalMessageTextFileCitationDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static InternalMessageTextFileCitationDetails FromResponse(PipelineResponse response)
        {
