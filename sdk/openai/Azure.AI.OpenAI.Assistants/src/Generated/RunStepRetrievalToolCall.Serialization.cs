...
{
    public partial class RunStepRetrievalToolCall : IUtf8JsonWriteable, IJsonModel<RunStepRetrievalToolCall>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepRetrievalToolCall>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new RunStepRetrievalToolCall FromResponse(PipelineResponse response)
        {
