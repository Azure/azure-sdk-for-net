...
{
    public partial class AssistantsApiResponseFormatJsonSchema : IUtf8JsonSerializable, IJsonModel<AssistantsApiResponseFormatJsonSchema>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssistantsApiResponseFormatJsonSchema>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AssistantsApiResponseFormatJsonSchema>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonSchema>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AssistantsApiResponseFormatJsonSchema IJsonModel<AssistantsApiResponseFormatJsonSchema>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonSchema>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AssistantsApiResponseFormatJsonSchema>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonSchema>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AssistantsApiResponseFormatJsonSchema IPersistableModel<AssistantsApiResponseFormatJsonSchema>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonSchema>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AssistantsApiResponseFormatJsonSchema>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
