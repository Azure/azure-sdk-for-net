...
{
    internal partial class UnknownRequiredAction : IUtf8JsonWriteable, IJsonModel<RequiredAction>
    {
        ...
        internal static new UnknownRequiredAction FromResponse(PipelineResponse response)
        {
