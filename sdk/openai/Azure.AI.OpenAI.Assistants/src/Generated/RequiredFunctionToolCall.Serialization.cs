...
{
    public partial class RequiredFunctionToolCall : IUtf8JsonWriteable, IJsonModel<RequiredFunctionToolCall>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RequiredFunctionToolCall>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new RequiredFunctionToolCall FromResponse(PipelineResponse response)
        {
