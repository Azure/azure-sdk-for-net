...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class MessageDeltaTextFileCitationAnnotation
    {
        /// <summary>
        ...
        internal MessageDeltaTextFileCitationAnnotation(string fileId, string quote, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileId = fileId;
            Quote = quote;
