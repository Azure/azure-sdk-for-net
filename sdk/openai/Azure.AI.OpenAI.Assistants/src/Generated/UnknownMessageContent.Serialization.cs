...
{
    internal partial class UnknownMessageContent : IUtf8JsonWriteable, IJsonModel<MessageContent>
    {
        ...
        internal static new UnknownMessageContent FromResponse(PipelineResponse response)
        {
