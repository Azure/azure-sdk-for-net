...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    {
        internal static InternalOpenAIPageableListOfRunStep DeserializeInternalOpenAIPageableListOfRunStep(JsonElement element)
        {
            ...
            return new InternalOpenAIPageableListOfRunStep(@object, data, firstId, lastId, hasMore);
        }
