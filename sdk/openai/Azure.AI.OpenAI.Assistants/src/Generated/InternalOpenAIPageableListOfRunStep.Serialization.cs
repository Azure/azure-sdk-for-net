...
{
    internal partial class InternalOpenAIPageableListOfRunStep : IUtf8JsonWriteable, IJsonModel<InternalOpenAIPageableListOfRunStep>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalOpenAIPageableListOfRunStep>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<InternalOpenAIPageableListOfRunStep>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOpenAIPageableListOfRunStep)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InternalOpenAIPageableListOfRunStep>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalOpenAIPageableListOfRunStep)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static InternalOpenAIPageableListOfRunStep FromResponse(PipelineResponse response)
        {
