...
{
    internal partial class UnknownRequiredToolCall : IUtf8JsonWriteable, IJsonModel<RequiredToolCall>
    {
        ...
        internal static new UnknownRequiredToolCall FromResponse(PipelineResponse response)
        {
