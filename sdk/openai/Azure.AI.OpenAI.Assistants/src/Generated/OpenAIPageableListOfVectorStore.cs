...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class OpenAIPageableListOfVectorStore
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfVectorStore"/>. </summary>
        ...
        internal OpenAIPageableListOfVectorStore(IEnumerable<VectorStore> data, string firstId, string lastId, bool hasMore)
        {
        ...
        internal OpenAIPageableListOfVectorStore(OpenAIPageableListOfVectorStoreObject @object, IReadOnlyList<VectorStore> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
        ...
        /// <summary> Initializes a new instance of <see cref="OpenAIPageableListOfVectorStore"/> for deserialization. </summary>
        internal OpenAIPageableListOfVectorStore()
        {
        }

        /// <summary> The object type, which is always list. </summary>
        public OpenAIPageableListOfVectorStoreObject Object { get; } = OpenAIPageableListOfVectorStoreObject.List;
