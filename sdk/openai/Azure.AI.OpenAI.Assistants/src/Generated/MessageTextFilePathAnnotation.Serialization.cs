...
{
    public partial class MessageTextFilePathAnnotation : IUtf8JsonWriteable, IJsonModel<MessageTextFilePathAnnotation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTextFilePathAnnotation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new MessageTextFilePathAnnotation FromResponse(PipelineResponse response)
        {
