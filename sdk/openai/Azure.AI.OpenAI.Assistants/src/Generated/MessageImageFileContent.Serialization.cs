...
{
    public partial class MessageImageFileContent : IUtf8JsonWriteable, IJsonModel<MessageImageFileContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageImageFileContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
