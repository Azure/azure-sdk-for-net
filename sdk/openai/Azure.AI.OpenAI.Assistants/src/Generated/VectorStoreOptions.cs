...
{
    /// <summary> Request object for creating a vector store. </summary>
    public partial class VectorStoreOptions
    {
        ...
        /// <summary> Initializes a new instance of <see cref="VectorStoreOptions"/>. </summary>
        ...
        internal VectorStoreOptions(IList<string> fileIds, string name, VectorStoreExpirationPolicy expiresAfter, VectorStoreChunkingStrategyRequest chunkingStrategy, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileIds = fileIds;
            Name = name;
        ...
        /// The available derived classes include <see cref="VectorStoreAutoChunkingStrategyRequest"/> and <see cref="VectorStoreStaticChunkingStrategyRequest"/>.
        /// </summary>
        public VectorStoreChunkingStrategyRequest ChunkingStrategy { get; set; }
