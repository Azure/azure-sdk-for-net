...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class FileSearchToolCallResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="FileSearchToolCallResult"/>. </summary>
        ...
        internal FileSearchToolCallResult(string fileId, string fileName, double score)
        {
            ...
            FileName = fileName;
            Score = score;
            Content = new ChangeTrackingList<FileSearchToolCallResultContentItem>();
        }
        ...
        internal FileSearchToolCallResult(string fileId, string fileName, double score, IReadOnlyList<FileSearchToolCallResultContentItem> content, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileId = fileId;
            FileName = fileName;
            Score = score;
        ...
        /// <summary> Initializes a new instance of <see cref="FileSearchToolCallResult"/> for deserialization. </summary>
        internal FileSearchToolCallResult()
        {
        }
        ...
        public IReadOnlyList<FileSearchToolCallResultContentItem> Content { get; }
    }
}
