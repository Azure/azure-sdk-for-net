...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class AssistantModificationOptions
    {
        ...
        internal AssistantModificationOptions(string model, string name, string description, string instructions, IList<ToolDefinition> tools, IList<string> fileIds, IDictionary<string, string> metadata)
        {
            Model = model;
            Name = name;
