...
{
    internal partial class InternalCodeInterpreterToolCallDetails : IUtf8JsonWriteable, IJsonModel<InternalCodeInterpreterToolCallDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalCodeInterpreterToolCallDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<InternalCodeInterpreterToolCallDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalCodeInterpreterToolCallDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InternalCodeInterpreterToolCallDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalCodeInterpreterToolCallDetails)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static InternalCodeInterpreterToolCallDetails FromResponse(PipelineResponse response)
        {
