...
{
    public partial class CodeInterpreterToolDefinition : IUtf8JsonWriteable, IJsonModel<CodeInterpreterToolDefinition>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CodeInterpreterToolDefinition>)this).Write(writer, new ModelReaderWriterOptions("W"));
