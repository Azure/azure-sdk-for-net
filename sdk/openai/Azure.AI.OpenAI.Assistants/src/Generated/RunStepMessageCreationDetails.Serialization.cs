...
{
    public partial class RunStepMessageCreationDetails : IUtf8JsonWriteable, IJsonModel<RunStepMessageCreationDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepMessageCreationDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
