...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class VectorStoreChunkingStrategyResponse : IUtf8JsonSerializable, IJsonModel<VectorStoreChunkingStrategyResponse>
    {
        ...
        internal static VectorStoreChunkingStrategyResponse DeserializeVectorStoreChunkingStrategyResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            if (element.TryGetProperty("type", out JsonElement discriminator))
            {
                ...
                {
                    case "other": return VectorStoreAutoChunkingStrategyResponse.DeserializeVectorStoreAutoChunkingStrategyResponse(element, options);
                    case "static": return VectorStoreStaticChunkingStrategyResponse.DeserializeVectorStoreStaticChunkingStrategyResponse(element, options);
                }
            }
        ...
        internal static VectorStoreChunkingStrategyResponse FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeVectorStoreChunkingStrategyResponse(document.RootElement);
        }
