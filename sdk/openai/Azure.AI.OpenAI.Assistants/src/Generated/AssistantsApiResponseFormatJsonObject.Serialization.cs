...
{
    public partial class AssistantsApiResponseFormatJsonObject : IUtf8JsonSerializable, IJsonModel<AssistantsApiResponseFormatJsonObject>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssistantsApiResponseFormatJsonObject>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AssistantsApiResponseFormatJsonObject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonObject>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AssistantsApiResponseFormatJsonObject IJsonModel<AssistantsApiResponseFormatJsonObject>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonObject>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AssistantsApiResponseFormatJsonObject>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonObject>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AssistantsApiResponseFormatJsonObject IPersistableModel<AssistantsApiResponseFormatJsonObject>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonObject>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AssistantsApiResponseFormatJsonObject>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
