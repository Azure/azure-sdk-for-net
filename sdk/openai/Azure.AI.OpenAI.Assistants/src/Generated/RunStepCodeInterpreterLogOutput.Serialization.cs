...
{
    public partial class RunStepCodeInterpreterLogOutput : IUtf8JsonWriteable, IJsonModel<RunStepCodeInterpreterLogOutput>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepCodeInterpreterLogOutput>)this).Write(writer, new ModelReaderWriterOptions("W"));
