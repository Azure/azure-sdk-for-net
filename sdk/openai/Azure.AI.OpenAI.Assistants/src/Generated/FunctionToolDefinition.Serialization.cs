...
{
    public partial class FunctionToolDefinition : IUtf8JsonWriteable, IJsonModel<FunctionToolDefinition>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FunctionToolDefinition>)this).Write(writer, new ModelReaderWriterOptions("W"));
