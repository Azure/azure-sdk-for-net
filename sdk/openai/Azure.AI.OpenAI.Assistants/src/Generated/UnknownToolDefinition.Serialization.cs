...
{
    internal partial class UnknownToolDefinition : IUtf8JsonWriteable, IJsonModel<ToolDefinition>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ToolDefinition>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new UnknownToolDefinition FromResponse(PipelineResponse response)
        {
