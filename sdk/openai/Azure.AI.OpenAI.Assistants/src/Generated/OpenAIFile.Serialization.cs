...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OpenAIFile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static OpenAIFile DeserializeOpenAIFile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new OpenAIFile(@object, id, bytes, filename, createdAt, purpose, serializedAdditionalRawData);
        }
