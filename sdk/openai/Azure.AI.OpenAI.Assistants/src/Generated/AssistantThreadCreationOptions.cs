...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class AssistantThreadCreationOptions
    {
        ...
        internal AssistantThreadCreationOptions(IList<ThreadMessageOptions> messages, CreateToolResourcesOptions toolResources, IDictionary<string, string> metadata, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Messages = messages;
