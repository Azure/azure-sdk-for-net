...
{
    public partial class ThreadMessage : IUtf8JsonWriteable, IJsonModel<ThreadMessage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThreadMessage>)this).Write(writer, new ModelReaderWriterOptions("W"));
