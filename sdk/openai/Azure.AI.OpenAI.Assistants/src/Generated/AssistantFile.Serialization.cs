...
{
    public partial class AssistantFile : IUtf8JsonWriteable, IJsonModel<AssistantFile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssistantFile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AssistantFile FromResponse(PipelineResponse response)
        {
