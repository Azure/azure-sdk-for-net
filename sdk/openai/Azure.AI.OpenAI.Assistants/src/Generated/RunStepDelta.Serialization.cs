...
{
    public partial class RunStepDelta : IUtf8JsonSerializable, IJsonModel<RunStepDelta>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepDelta>)this).Write(writer, ModelSerializationExtensions.WireOptions);
