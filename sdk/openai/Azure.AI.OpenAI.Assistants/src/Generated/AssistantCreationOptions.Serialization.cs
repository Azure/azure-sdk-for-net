...
{
    public partial class AssistantCreationOptions : IUtf8JsonWriteable, IJsonModel<AssistantCreationOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssistantCreationOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
