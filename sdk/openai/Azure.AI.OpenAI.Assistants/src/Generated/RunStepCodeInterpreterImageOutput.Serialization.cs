...
{
    public partial class RunStepCodeInterpreterImageOutput : IUtf8JsonWriteable, IJsonModel<RunStepCodeInterpreterImageOutput>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepCodeInterpreterImageOutput>)this).Write(writer, new ModelReaderWriterOptions("W"));
