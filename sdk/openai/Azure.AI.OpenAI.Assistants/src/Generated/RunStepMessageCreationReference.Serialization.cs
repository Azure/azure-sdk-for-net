...
{
    public partial class RunStepMessageCreationReference : IUtf8JsonWriteable, IJsonModel<RunStepMessageCreationReference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepMessageCreationReference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RunStepMessageCreationReference FromResponse(PipelineResponse response)
        {
