...
{
    internal partial class InternalOpenAIPageableListOfAssistant : IUtf8JsonWriteable, IJsonModel<InternalOpenAIPageableListOfAssistant>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalOpenAIPageableListOfAssistant>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static InternalOpenAIPageableListOfAssistant FromResponse(PipelineResponse response)
        {
