...
{
    public partial class SubmitToolOutputsAction : IUtf8JsonWriteable, IJsonModel<SubmitToolOutputsAction>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubmitToolOutputsAction>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new SubmitToolOutputsAction FromResponse(PipelineResponse response)
        {
