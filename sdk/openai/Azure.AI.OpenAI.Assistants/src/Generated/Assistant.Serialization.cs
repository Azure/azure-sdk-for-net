...
{
    public partial class Assistant : IUtf8JsonWriteable, IJsonModel<Assistant>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<Assistant>)this).Write(writer, new ModelReaderWriterOptions("W"));
