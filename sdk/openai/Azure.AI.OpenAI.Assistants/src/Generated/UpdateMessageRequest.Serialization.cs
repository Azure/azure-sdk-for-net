...
{
    internal partial class UpdateMessageRequest : IUtf8JsonWriteable, IJsonModel<UpdateMessageRequest>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateMessageRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<UpdateMessageRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UpdateMessageRequest)} does not support '{format}' format.");
            }
        ...
        internal static UpdateMessageRequest DeserializeUpdateMessageRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UpdateMessageRequest(metadata ?? new OptionalDictionary<string, string>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<UpdateMessageRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UpdateMessageRequest)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static UpdateMessageRequest FromResponse(PipelineResponse response)
        {
