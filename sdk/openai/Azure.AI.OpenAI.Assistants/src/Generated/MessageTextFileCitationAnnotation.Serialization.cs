...
{
    public partial class MessageTextFileCitationAnnotation : IUtf8JsonWriteable, IJsonModel<MessageTextFileCitationAnnotation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTextFileCitationAnnotation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new MessageTextFileCitationAnnotation FromResponse(PipelineResponse response)
        {
