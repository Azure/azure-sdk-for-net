...
{
    internal partial class InternalMessageTextFilePathDetails : IUtf8JsonWriteable, IJsonModel<InternalMessageTextFilePathDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalMessageTextFilePathDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static InternalMessageTextFilePathDetails FromResponse(PipelineResponse response)
        {
