...
{
    internal partial class UploadFileRequest : IUtf8JsonWriteable, IJsonModel<UploadFileRequest>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<UploadFileRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static UploadFileRequest FromResponse(PipelineResponse response)
        {
