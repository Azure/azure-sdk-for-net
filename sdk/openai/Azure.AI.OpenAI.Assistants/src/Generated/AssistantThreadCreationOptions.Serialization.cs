...
{
    public partial class AssistantThreadCreationOptions : IUtf8JsonWriteable, IJsonModel<AssistantThreadCreationOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssistantThreadCreationOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AssistantThreadCreationOptions DeserializeAssistantThreadCreationOptions(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AssistantThreadCreationOptions(messages ?? new ChangeTrackingList<ThreadInitializationMessage>(), metadata ?? new OptionalDictionary<string, string>(), serializedAdditionalRawData);
        }
        ...
        internal static AssistantThreadCreationOptions FromResponse(PipelineResponse response)
        {
