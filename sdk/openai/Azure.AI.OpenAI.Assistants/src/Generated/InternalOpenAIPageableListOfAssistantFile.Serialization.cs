...
{
    internal partial class InternalOpenAIPageableListOfAssistantFile : IUtf8JsonWriteable, IJsonModel<InternalOpenAIPageableListOfAssistantFile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalOpenAIPageableListOfAssistantFile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static InternalOpenAIPageableListOfAssistantFile FromResponse(PipelineResponse response)
        {
