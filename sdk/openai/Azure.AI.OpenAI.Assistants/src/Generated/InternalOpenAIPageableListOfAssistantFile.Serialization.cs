...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    {
        internal static InternalOpenAIPageableListOfAssistantFile DeserializeInternalOpenAIPageableListOfAssistantFile(JsonElement element)
        {
            ...
            return new InternalOpenAIPageableListOfAssistantFile(@object, data, firstId, lastId, hasMore);
        }
