...
{
    public partial class ThreadInitializationMessage : IUtf8JsonWriteable, IJsonModel<ThreadInitializationMessage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThreadInitializationMessage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ThreadInitializationMessage DeserializeThreadInitializationMessage(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ThreadInitializationMessage(role, content, fileIds ?? new ChangeTrackingList<string>(), metadata ?? new OptionalDictionary<string, string>(), serializedAdditionalRawData);
        }
        ...
        internal static ThreadInitializationMessage FromResponse(PipelineResponse response)
        {
