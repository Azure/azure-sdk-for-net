...
{
    internal partial class CreateMessageRequest : IUtf8JsonWriteable, IJsonModel<CreateMessageRequest>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateMessageRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CreateMessageRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateMessageRequest)} does not support '{format}' format.");
            }
        ...
        internal static CreateMessageRequest DeserializeCreateMessageRequest(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CreateMessageRequest(role, content, fileIds ?? new ChangeTrackingList<string>(), metadata ?? new OptionalDictionary<string, string>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CreateMessageRequest>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateMessageRequest)} does not support '{options.Format}' format.");
            }
        }
