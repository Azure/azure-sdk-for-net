...
{
    internal partial class UnknownMessageTextAnnotation : IUtf8JsonWriteable, IJsonModel<MessageTextAnnotation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTextAnnotation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new UnknownMessageTextAnnotation FromResponse(PipelineResponse response)
        {
