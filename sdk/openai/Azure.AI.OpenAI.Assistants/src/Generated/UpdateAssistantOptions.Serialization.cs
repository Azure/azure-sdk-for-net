...
{
    public partial class UpdateAssistantOptions : IUtf8JsonWriteable, IJsonModel<UpdateAssistantOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateAssistantOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static UpdateAssistantOptions FromResponse(PipelineResponse response)
        {
