...
{
    public partial class CreateAndRunThreadOptions : IUtf8JsonWriteable, IJsonModel<CreateAndRunThreadOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateAndRunThreadOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CreateAndRunThreadOptions FromResponse(PipelineResponse response)
        {
