...
{
    public partial class RunStepToolCallDetails : IUtf8JsonWriteable, IJsonModel<RunStepToolCallDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepToolCallDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RunStepToolCallDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RunStepToolCallDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RunStepToolCallDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RunStepToolCallDetails)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new RunStepToolCallDetails FromResponse(PipelineResponse response)
        {
