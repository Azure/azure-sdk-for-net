...
{
    internal partial class UnknownRunStepDetails : IUtf8JsonWriteable, IJsonModel<RunStepDetails>
    {
        ...
        internal static new UnknownRunStepDetails FromResponse(PipelineResponse response)
        {
