...
{
    internal partial class InternalOpenAIPageableListOfThreadRun : IUtf8JsonWriteable, IJsonModel<InternalOpenAIPageableListOfThreadRun>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalOpenAIPageableListOfThreadRun>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<InternalOpenAIPageableListOfThreadRun>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InternalOpenAIPageableListOfThreadRun)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InternalOpenAIPageableListOfThreadRun>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InternalOpenAIPageableListOfThreadRun)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static InternalOpenAIPageableListOfThreadRun FromResponse(PipelineResponse response)
        {
