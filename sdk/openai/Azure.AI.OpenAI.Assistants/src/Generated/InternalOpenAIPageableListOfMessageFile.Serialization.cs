...
{
    internal partial class InternalOpenAIPageableListOfMessageFile : IUtf8JsonWriteable, IJsonModel<InternalOpenAIPageableListOfMessageFile>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalOpenAIPageableListOfMessageFile>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static InternalOpenAIPageableListOfMessageFile FromResponse(PipelineResponse response)
        {
