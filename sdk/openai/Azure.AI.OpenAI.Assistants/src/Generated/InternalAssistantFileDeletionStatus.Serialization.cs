...
{
    internal partial class InternalAssistantFileDeletionStatus : IUtf8JsonWriteable, IJsonModel<InternalAssistantFileDeletionStatus>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InternalAssistantFileDeletionStatus>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static InternalAssistantFileDeletionStatus FromResponse(PipelineResponse response)
        {
