...
{
    internal partial class UnknownRunStepToolCall : IUtf8JsonWriteable, IJsonModel<RunStepToolCall>
    {
        ...
        internal static new UnknownRunStepToolCall FromResponse(PipelineResponse response)
        {
