...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    public partial class CodeInterpreterToolResource
    {
        ...
        internal CodeInterpreterToolResource(IEnumerable<string> fileIds)
        {
        ...
        internal CodeInterpreterToolResource(IReadOnlyList<string> fileIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FileIds = fileIds;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="CodeInterpreterToolResource"/> for deserialization. </summary>
