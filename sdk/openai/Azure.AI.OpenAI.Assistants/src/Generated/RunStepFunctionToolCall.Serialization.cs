...
{
    public partial class RunStepFunctionToolCall : IUtf8JsonWriteable, IJsonModel<RunStepFunctionToolCall>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RunStepFunctionToolCall>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new RunStepFunctionToolCall FromResponse(PipelineResponse response)
        {
