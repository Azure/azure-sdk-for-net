...
{
    public partial class AssistantsApiResponseFormatJsonSchemaJsonSchema : IUtf8JsonSerializable, IJsonModel<AssistantsApiResponseFormatJsonSchemaJsonSchema>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssistantsApiResponseFormatJsonSchemaJsonSchema>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AssistantsApiResponseFormatJsonSchemaJsonSchema>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonSchemaJsonSchema>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AssistantsApiResponseFormatJsonSchemaJsonSchema IJsonModel<AssistantsApiResponseFormatJsonSchemaJsonSchema>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonSchemaJsonSchema>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AssistantsApiResponseFormatJsonSchemaJsonSchema>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonSchemaJsonSchema>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AssistantsApiResponseFormatJsonSchemaJsonSchema IPersistableModel<AssistantsApiResponseFormatJsonSchemaJsonSchema>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AssistantsApiResponseFormatJsonSchemaJsonSchema>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AssistantsApiResponseFormatJsonSchemaJsonSchema>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
