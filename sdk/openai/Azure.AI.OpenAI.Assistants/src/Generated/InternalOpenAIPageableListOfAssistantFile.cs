...
namespace Azure.AI.OpenAI.Assistants
{
    ...
    internal partial class InternalOpenAIPageableListOfAssistantFile
    {
        ...
        internal InternalOpenAIPageableListOfAssistantFile(OpenAIPageableListOfObject1 @object, IReadOnlyList<AssistantFile> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Object = @object;
            Data = data;
            FirstId = firstId;
