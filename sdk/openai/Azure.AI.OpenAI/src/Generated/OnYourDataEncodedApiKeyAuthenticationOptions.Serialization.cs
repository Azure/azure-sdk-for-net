...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OnYourDataEncodedApiKeyAuthenticationOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
