...
{
    public partial class OnYourDataEncodedApiKeyAuthenticationOptions : IUtf8JsonWriteable, IJsonModel<OnYourDataEncodedApiKeyAuthenticationOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OnYourDataEncodedApiKeyAuthenticationOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<OnYourDataEncodedApiKeyAuthenticationOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OnYourDataEncodedApiKeyAuthenticationOptions)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OnYourDataEncodedApiKeyAuthenticationOptions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OnYourDataEncodedApiKeyAuthenticationOptions)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new OnYourDataEncodedApiKeyAuthenticationOptions FromResponse(PipelineResponse response)
        {
