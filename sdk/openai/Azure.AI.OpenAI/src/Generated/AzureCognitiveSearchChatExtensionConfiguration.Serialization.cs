...
namespace Azure.AI.OpenAI
{
    public partial class AzureCognitiveSearchChatExtensionConfiguration : IUtf8JsonSerializable, IJsonModel<AzureCognitiveSearchChatExtensionConfiguration>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureCognitiveSearchChatExtensionConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureCognitiveSearchChatExtensionConfiguration>)} interface");
            }
        ...
        string IPersistableModel<AzureCognitiveSearchChatExtensionConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AzureCognitiveSearchChatExtensionConfiguration FromResponse(Response response)
        {
            ...
            return DeserializeAzureCognitiveSearchChatExtensionConfiguration(document.RootElement, ModelReaderWriterOptions.Wire);
        }
    }
}
