...
namespace Azure.AI.OpenAI
{
    ...
    public partial class AzureChatGroundingEnhancementConfiguration
    {
        ...
        internal AzureChatGroundingEnhancementConfiguration(bool enabled, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="AzureChatGroundingEnhancementConfiguration"/> for deserialization. </summary>
        internal AzureChatGroundingEnhancementConfiguration()
        {
        }
