...
{
    public partial class ElasticsearchIndexFieldMappingOptions : IUtf8JsonWriteable, IJsonModel<ElasticsearchIndexFieldMappingOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticsearchIndexFieldMappingOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ElasticsearchIndexFieldMappingOptions FromResponse(PipelineResponse response)
        {
