...
namespace Azure.AI.OpenAI
{
    public partial class ElasticsearchIndexFieldMappingOptions : IUtf8JsonSerializable, IJsonModel<ElasticsearchIndexFieldMappingOptions>
    {
        ...
        void IJsonModel<ElasticsearchIndexFieldMappingOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ElasticsearchIndexFieldMappingOptions)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ElasticsearchIndexFieldMappingOptions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ElasticsearchIndexFieldMappingOptions)} does not support '{options.Format}' format.");
            }
        }
