...
namespace Azure.AI.OpenAI
{
    ...
    internal partial class AudioTranslationOptionsPlainText
    {
        /// <summary> Initializes a new instance of AudioTranslationOptionsPlainText. </summary>
        /// <param name="file"> The audio file object to transcribe. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="file"/> is null. </exception>
        public AudioTranslationOptionsPlainText(BinaryData file)
        {
        ...
        internal AudioTranslationOptionsPlainText(BinaryData file, string prompt, float? temperature, string internalNonAzureModelName, AudioTranscriptionFormat? responseFormat)
        {
            File = file;
            Prompt = prompt;
