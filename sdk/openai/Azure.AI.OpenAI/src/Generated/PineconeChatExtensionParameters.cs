...
namespace Azure.AI.OpenAI
{
    ...
    public partial class PineconeChatExtensionParameters
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="environment"/>, <paramref name="indexName"/> or <paramref name="fieldMappingOptions"/> is null. </exception>
        public PineconeChatExtensionParameters(string environment, string indexName, PineconeFieldMappingOptions fieldMappingOptions)
        {
        ...
        internal PineconeChatExtensionParameters(OnYourDataAuthenticationOptions authentication, int? documentCount, bool? shouldRestrictResultScope, int? strictness, string roleInformation, string environment, string indexName, PineconeFieldMappingOptions fieldMappingOptions, OnYourDataEmbeddingDependency embeddingDependency)
        {
