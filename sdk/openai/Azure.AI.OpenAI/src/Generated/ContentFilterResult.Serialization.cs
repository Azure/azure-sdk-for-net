...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentFilterResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContentFilterResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContentFilterResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContentFilterResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ContentFilterResult FromResponse(Response response)
        {
            ...
            return DeserializeContentFilterResult(document.RootElement, ModelReaderWriterOptions.Wire);
        }
