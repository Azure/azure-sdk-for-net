...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatMessage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ChatMessage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ChatMessage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ChatMessage>)} interface");
            }
        ...
        string IPersistableModel<ChatMessage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ChatMessage FromResponse(Response response)
        {
            ...
            return DeserializeChatMessage(document.RootElement, ModelReaderWriterOptions.Wire);
        }
