...
{
    public partial class AudioTranslationOptions : IUtf8JsonWriteable, IJsonModel<AudioTranslationOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranslationOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
