...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranslationOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AudioTranslationOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AudioTranslationOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AudioTranslationOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AudioTranslationOptions FromResponse(Response response)
        {
            ...
            return DeserializeAudioTranslationOptions(document.RootElement, ModelReaderWriterOptions.Wire);
        }
    }
}
