...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ChatCompletionsToolCall : IUtf8JsonWriteable, IJsonModel<ChatCompletionsToolCall>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionsToolCall>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ChatCompletionsToolCall FromResponse(PipelineResponse response)
        {
