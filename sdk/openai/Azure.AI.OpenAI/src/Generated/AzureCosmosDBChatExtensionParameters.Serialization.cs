...
{
    internal partial class AzureCosmosDBChatExtensionParameters : IUtf8JsonWriteable, IJsonModel<AzureCosmosDBChatExtensionParameters>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureCosmosDBChatExtensionParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AzureCosmosDBChatExtensionParameters FromResponse(PipelineResponse response)
        {
