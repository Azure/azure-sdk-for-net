...
{
    internal partial class AzureMachineLearningIndexChatExtensionParameters : IUtf8JsonWriteable, IJsonModel<AzureMachineLearningIndexChatExtensionParameters>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureMachineLearningIndexChatExtensionParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AzureMachineLearningIndexChatExtensionParameters FromResponse(PipelineResponse response)
        {
