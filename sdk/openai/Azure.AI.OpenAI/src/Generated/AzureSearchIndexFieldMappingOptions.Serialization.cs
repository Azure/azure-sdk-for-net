...
{
    public partial class AzureSearchIndexFieldMappingOptions : IUtf8JsonWriteable, IJsonModel<AzureSearchIndexFieldMappingOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureSearchIndexFieldMappingOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AzureSearchIndexFieldMappingOptions FromResponse(PipelineResponse response)
        {
