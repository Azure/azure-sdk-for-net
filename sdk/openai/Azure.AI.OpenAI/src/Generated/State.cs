...
namespace Azure.AI.OpenAI
{
    ...
    public readonly partial struct State : IEquatable<State>
    {
        ...
        public static State NotRunning { get; } = new State(NotRunningValue);
        ...
        public static State Canceled { get; } = new State(CanceledValue);
        ...
        /// <summary> The entity has been deleted but may still be referenced by other entities predating the deletion. </summary>
