...
namespace Azure.AI.OpenAI
{
    internal partial class AzureOpenAIChatError : IJsonModel<AzureOpenAIChatError>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureOpenAIChatError>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AzureOpenAIChatError IJsonModel<AzureOpenAIChatError>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureOpenAIChatError>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AzureOpenAIChatError DeserializeAzureOpenAIChatError(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AzureOpenAIChatError>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureOpenAIChatError>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AzureOpenAIChatError IPersistableModel<AzureOpenAIChatError>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureOpenAIChatError>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static AzureOpenAIChatError FromResponse(PipelineResponse response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeAzureOpenAIChatError(document.RootElement);
        }
