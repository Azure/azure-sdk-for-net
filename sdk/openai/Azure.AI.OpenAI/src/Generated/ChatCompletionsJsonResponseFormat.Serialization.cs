...
{
    internal partial class ChatCompletionsJsonResponseFormat : IUtf8JsonWriteable, IJsonModel<ChatCompletionsJsonResponseFormat>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionsJsonResponseFormat>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ChatCompletionsJsonResponseFormat FromResponse(PipelineResponse response)
        {
