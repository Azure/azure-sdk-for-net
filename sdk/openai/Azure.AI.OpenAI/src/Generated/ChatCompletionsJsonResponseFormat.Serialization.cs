...
{
    public partial class ChatCompletionsJsonResponseFormat : IUtf8JsonSerializable, IJsonModel<ChatCompletionsJsonResponseFormat>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionsJsonResponseFormat>)this).Write(writer, ModelSerializationExtensions.WireOptions);
