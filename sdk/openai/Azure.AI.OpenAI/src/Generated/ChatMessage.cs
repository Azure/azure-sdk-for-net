...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ChatMessage
    {
        ...
        internal ChatMessage(ChatRole role, string content, string name, FunctionCall functionCall, AzureChatExtensionsMessageContext azureExtensionsContext, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Role = role;
            Content = content;
            Name = name;
