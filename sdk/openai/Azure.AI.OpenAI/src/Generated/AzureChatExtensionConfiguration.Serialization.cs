...
namespace Azure.AI.OpenAI
{
    public partial class AzureChatExtensionConfiguration : IUtf8JsonSerializable, IJsonModel<AzureChatExtensionConfiguration>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureChatExtensionConfiguration>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static AzureChatExtensionConfiguration FromResponse(Response response)
        {
            ...
            return DeserializeAzureChatExtensionConfiguration(document.RootElement, new ModelReaderWriterOptions("W"));
        }
