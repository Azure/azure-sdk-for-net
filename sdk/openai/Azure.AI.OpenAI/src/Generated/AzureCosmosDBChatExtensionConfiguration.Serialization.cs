...
{
    public partial class AzureCosmosDBChatExtensionConfiguration : IUtf8JsonWriteable, IJsonModel<AzureCosmosDBChatExtensionConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureCosmosDBChatExtensionConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new AzureCosmosDBChatExtensionConfiguration FromResponse(PipelineResponse response)
        {
