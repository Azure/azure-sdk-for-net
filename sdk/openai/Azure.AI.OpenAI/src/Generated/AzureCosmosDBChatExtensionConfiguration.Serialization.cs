...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureCosmosDBChatExtensionConfiguration>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<AzureCosmosDBChatExtensionConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            writer.WriteObjectValue<AzureCosmosDBChatExtensionParameters>(Parameters, options);
