...
namespace Azure.AI.OpenAI
{
    public partial class EmbeddingsOptions : IUtf8JsonSerializable, IJsonModel<EmbeddingsOptions>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<EmbeddingsOptions>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static EmbeddingsOptions FromResponse(Response response)
        {
            ...
            return DeserializeEmbeddingsOptions(document.RootElement, new ModelReaderWriterOptions("W"));
        }
