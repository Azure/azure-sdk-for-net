...
namespace Azure.AI.OpenAI
{
    internal partial class PineconeChatExtensionParameters : IUtf8JsonSerializable, IJsonModel<PineconeChatExtensionParameters>
    {
        ...
        void IJsonModel<PineconeChatExtensionParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PineconeChatExtensionParameters)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PineconeChatExtensionParameters>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PineconeChatExtensionParameters)} does not support '{options.Format}' format.");
            }
        }
