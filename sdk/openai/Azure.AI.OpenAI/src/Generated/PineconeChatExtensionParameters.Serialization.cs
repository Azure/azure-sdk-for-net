...
{
    internal partial class PineconeChatExtensionParameters : IUtf8JsonWriteable, IJsonModel<PineconeChatExtensionParameters>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<PineconeChatExtensionParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static PineconeChatExtensionParameters FromResponse(PipelineResponse response)
        {
