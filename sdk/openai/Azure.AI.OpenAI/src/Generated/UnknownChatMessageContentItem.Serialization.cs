...
{
    internal partial class UnknownChatMessageContentItem : IUtf8JsonWriteable, IJsonModel<ChatMessageContentItem>
    {
        ...
        internal static new UnknownChatMessageContentItem FromResponse(PipelineResponse response)
        {
