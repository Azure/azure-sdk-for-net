...
{
    public partial class Embeddings : IUtf8JsonWriteable, IJsonModel<Embeddings>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<Embeddings>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static Embeddings FromResponse(PipelineResponse response)
        {
