...
namespace Azure.AI.OpenAI
{
    public partial class Embeddings : IUtf8JsonSerializable, IJsonModel<Embeddings>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<Embeddings>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static Embeddings FromResponse(Response response)
        {
            ...
            return DeserializeEmbeddings(document.RootElement, new ModelReaderWriterOptions("W"));
        }
