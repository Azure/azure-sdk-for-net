...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Embeddings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Embeddings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Embeddings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Embeddings>)} interface");
            }
        ...
        string IPersistableModel<Embeddings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static Embeddings FromResponse(Response response)
        {
            ...
            return DeserializeEmbeddings(document.RootElement, ModelReaderWriterOptions.Wire);
        }
