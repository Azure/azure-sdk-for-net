...
{
    public partial class ChatCompletionsFunctionToolDefinition : IUtf8JsonWriteable, IJsonModel<ChatCompletionsFunctionToolDefinition>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionsFunctionToolDefinition>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ChatCompletionsFunctionToolDefinition FromResponse(PipelineResponse response)
        {
