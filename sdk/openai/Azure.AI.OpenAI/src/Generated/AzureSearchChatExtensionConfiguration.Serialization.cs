...
{
    public partial class AzureSearchChatExtensionConfiguration : IUtf8JsonWriteable, IJsonModel<AzureSearchChatExtensionConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureSearchChatExtensionConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new AzureSearchChatExtensionConfiguration FromResponse(PipelineResponse response)
        {
