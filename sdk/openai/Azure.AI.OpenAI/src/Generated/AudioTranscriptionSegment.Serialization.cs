...
{
    public partial class AudioTranscriptionSegment : IUtf8JsonWriteable, IJsonModel<AudioTranscriptionSegment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranscriptionSegment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AudioTranscriptionSegment FromResponse(PipelineResponse response)
        {
