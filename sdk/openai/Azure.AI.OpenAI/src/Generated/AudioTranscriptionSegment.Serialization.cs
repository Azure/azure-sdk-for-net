...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranscriptionSegment>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        AudioTranscriptionSegment IJsonModel<AudioTranscriptionSegment>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<AudioTranscriptionSegment>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AudioTranscriptionSegment IModel<AudioTranscriptionSegment>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AudioTranscriptionSegment>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static AudioTranscriptionSegment FromResponse(Response response)
        {
            ...
            return DeserializeAudioTranscriptionSegment(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
