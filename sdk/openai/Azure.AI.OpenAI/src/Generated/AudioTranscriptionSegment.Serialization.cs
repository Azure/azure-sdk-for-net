...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranscriptionSegment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AudioTranscriptionSegment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AudioTranscriptionSegment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AudioTranscriptionSegment>)} interface");
            }
        ...
        string IPersistableModel<AudioTranscriptionSegment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AudioTranscriptionSegment FromResponse(Response response)
        {
            ...
            return DeserializeAudioTranscriptionSegment(document.RootElement, ModelReaderWriterOptions.Wire);
        }
