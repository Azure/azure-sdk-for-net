...
namespace Azure.AI.OpenAI
{
    public partial class AudioTranscriptionSegment : IUtf8JsonSerializable, IJsonModel<AudioTranscriptionSegment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AudioTranscriptionSegment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static AudioTranscriptionSegment FromResponse(Response response)
        {
            ...
            return DeserializeAudioTranscriptionSegment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
