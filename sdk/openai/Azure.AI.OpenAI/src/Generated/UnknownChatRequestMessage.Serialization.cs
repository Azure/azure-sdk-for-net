...
namespace Azure.AI.OpenAI
{
    internal partial class UnknownChatRequestMessage : IUtf8JsonSerializable, IJsonModel<ChatRequestMessage>
    {
        ...
        void IJsonModel<ChatRequestMessage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ChatRequestMessage)} does not support '{format}' format.");
            }
        ...
        ChatRequestMessage IJsonModel<ChatRequestMessage>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownChatRequestMessage(document.RootElement, options);
        }
        ...
        BinaryData IPersistableModel<ChatRequestMessage>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ChatRequestMessage)} does not support '{options.Format}' format.");
            }
        }
