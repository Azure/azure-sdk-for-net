...
namespace Azure.AI.OpenAI
{
    public partial class ChatCompletions : IUtf8JsonSerializable, IJsonModel<ChatCompletions>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ChatCompletions>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ChatCompletions FromResponse(Response response)
        {
            ...
            return DeserializeChatCompletions(document.RootElement, new ModelReaderWriterOptions("W"));
        }
