...
{
    public partial class ChatCompletions : IUtf8JsonWriteable, IJsonModel<ChatCompletions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ChatCompletions FromResponse(PipelineResponse response)
        {
