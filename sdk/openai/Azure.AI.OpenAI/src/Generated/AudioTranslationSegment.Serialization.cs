...
namespace Azure.AI.OpenAI
{
    public partial class AudioTranslationSegment : IUtf8JsonSerializable, IJsonModel<AudioTranslationSegment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AudioTranslationSegment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AudioTranslationSegment>)} interface");
            }
        ...
        internal static AudioTranslationSegment FromResponse(Response response)
        {
            ...
            return DeserializeAudioTranslationSegment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
