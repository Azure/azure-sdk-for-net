...
{
    public partial class AudioTranslationSegment : IUtf8JsonWriteable, IJsonModel<AudioTranslationSegment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranslationSegment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AudioTranslationSegment FromResponse(PipelineResponse response)
        {
