...
namespace Azure.AI.OpenAI
{
    public partial class AudioTranslationSegment : IUtf8JsonSerializable, IJsonModel<AudioTranslationSegment>
    {
        ...
        void IJsonModel<AudioTranslationSegment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AudioTranslationSegment)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AudioTranslationSegment>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AudioTranslationSegment)} does not support '{options.Format}' format.");
            }
        }
