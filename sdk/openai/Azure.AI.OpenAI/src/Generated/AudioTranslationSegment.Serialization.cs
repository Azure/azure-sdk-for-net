...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranslationSegment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AudioTranslationSegment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AudioTranslationSegment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AudioTranslationSegment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AudioTranslationSegment FromResponse(Response response)
        {
            ...
            return DeserializeAudioTranslationSegment(document.RootElement, ModelReaderWriterOptions.Wire);
        }
