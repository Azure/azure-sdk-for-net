...
namespace Azure.AI.OpenAI
{
    ...
    internal partial class AudioTranscriptionOptionsSimpleJson
    {
        /// <summary> Initializes a new instance of AudioTranscriptionOptionsSimpleJson. </summary>
        /// <param name="file"> The audio file object to transcribe. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="file"/> is null. </exception>
        public AudioTranscriptionOptionsSimpleJson(BinaryData file)
        {
        ...
        internal AudioTranscriptionOptionsSimpleJson(BinaryData file, string prompt, float? temperature, string internalNonAzureModelName, string language, AudioTranscriptionFormat? responseFormat)
        {
            File = file;
            Prompt = prompt;
