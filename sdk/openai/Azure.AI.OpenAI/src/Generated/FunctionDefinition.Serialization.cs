...
namespace Azure.AI.OpenAI
{
    public partial class FunctionDefinition : IUtf8JsonSerializable, IJsonModel<FunctionDefinition>
    {
        ...
        void IJsonModel<FunctionDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FunctionDefinition)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FunctionDefinition>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FunctionDefinition)} does not support '{options.Format}' format.");
            }
        }
