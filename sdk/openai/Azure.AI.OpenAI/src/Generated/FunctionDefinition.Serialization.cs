...
namespace Azure.AI.OpenAI
{
    public partial class FunctionDefinition : IUtf8JsonSerializable, IJsonModel<FunctionDefinition>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FunctionDefinition>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static FunctionDefinition FromResponse(Response response)
        {
            ...
            return DeserializeFunctionDefinition(document.RootElement, new ModelReaderWriterOptions("W"));
        }
