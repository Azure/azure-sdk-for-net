...
{
    public partial class AudioTranslation : IUtf8JsonWriteable, IJsonModel<AudioTranslation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranslation>)this).Write(writer, new ModelReaderWriterOptions("W"));
