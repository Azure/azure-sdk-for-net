...
{
    public partial class AzureChatExtensionsMessageContext : IUtf8JsonWriteable, IJsonModel<AzureChatExtensionsMessageContext>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatExtensionsMessageContext>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AzureChatExtensionsMessageContext FromResponse(PipelineResponse response)
        {
