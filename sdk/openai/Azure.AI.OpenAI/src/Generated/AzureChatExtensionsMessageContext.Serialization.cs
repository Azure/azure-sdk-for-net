...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatExtensionsMessageContext>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureChatExtensionsMessageContext>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureChatExtensionsMessageContext>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AzureChatExtensionsMessageContext>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AzureChatExtensionsMessageContext FromResponse(Response response)
        {
            ...
            return DeserializeAzureChatExtensionsMessageContext(document.RootElement, ModelReaderWriterOptions.Wire);
        }
