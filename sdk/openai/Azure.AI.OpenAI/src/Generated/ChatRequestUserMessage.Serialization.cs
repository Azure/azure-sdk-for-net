...
{
    public partial class ChatRequestUserMessage : IUtf8JsonWriteable, IJsonModel<ChatRequestUserMessage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatRequestUserMessage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ChatRequestUserMessage FromResponse(PipelineResponse response)
        {
