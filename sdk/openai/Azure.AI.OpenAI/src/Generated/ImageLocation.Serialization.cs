...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageLocation>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ImageLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImageLocation>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ImageLocation)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ImageLocation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ImageLocation)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<ImageLocation>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        internal static ImageLocation FromResponse(Response response)
        {
            ...
            return DeserializeImageLocation(document.RootElement, new ModelReaderWriterOptions("W"));
        }
