...
namespace Azure.AI.OpenAI
{
    public partial class AzureChatEnhancements : IUtf8JsonSerializable, IJsonModel<AzureChatEnhancements>
    {
        ...
        void IJsonModel<AzureChatEnhancements>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AzureChatEnhancements)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureChatEnhancements>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AzureChatEnhancements)} does not support '{options.Format}' format.");
            }
        }
