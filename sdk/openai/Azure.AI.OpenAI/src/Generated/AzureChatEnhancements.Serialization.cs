...
{
    public partial class AzureChatEnhancements : IUtf8JsonWriteable, IJsonModel<AzureChatEnhancements>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatEnhancements>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        AzureChatEnhancements IJsonModel<AzureChatEnhancements>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureChatEnhancements>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AzureChatEnhancements IPersistableModel<AzureChatEnhancements>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AzureChatEnhancements>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AzureChatEnhancements>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The result to deserialize the model from. </param>
        internal static AzureChatEnhancements FromResponse(PipelineResponse response)
        {
