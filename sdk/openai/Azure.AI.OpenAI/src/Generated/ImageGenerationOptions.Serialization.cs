...
{
    public partial class ImageGenerationOptions : IUtf8JsonWriteable, IJsonModel<ImageGenerationOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageGenerationOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
