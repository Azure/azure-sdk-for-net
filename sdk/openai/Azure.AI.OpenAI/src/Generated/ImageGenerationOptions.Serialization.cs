...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageGenerationOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageGenerationOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageGenerationOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageGenerationOptions>)} interface");
            }
        ...
        string IPersistableModel<ImageGenerationOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ImageGenerationOptions FromResponse(Response response)
        {
            ...
            return DeserializeImageGenerationOptions(document.RootElement, ModelReaderWriterOptions.Wire);
        }
