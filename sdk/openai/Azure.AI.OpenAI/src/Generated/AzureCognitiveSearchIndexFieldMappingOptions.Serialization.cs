...
namespace Azure.AI.OpenAI
{
    public partial class AzureCognitiveSearchIndexFieldMappingOptions : IUtf8JsonSerializable, IJsonModel<AzureCognitiveSearchIndexFieldMappingOptions>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureCognitiveSearchIndexFieldMappingOptions>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static AzureCognitiveSearchIndexFieldMappingOptions FromResponse(Response response)
        {
            ...
            return DeserializeAzureCognitiveSearchIndexFieldMappingOptions(document.RootElement, new ModelReaderWriterOptions("W"));
        }
    }
}
