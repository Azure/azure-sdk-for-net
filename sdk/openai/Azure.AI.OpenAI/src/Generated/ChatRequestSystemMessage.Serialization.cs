...
{
    public partial class ChatRequestSystemMessage : IUtf8JsonWriteable, IJsonModel<ChatRequestSystemMessage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatRequestSystemMessage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ChatRequestSystemMessage FromResponse(PipelineResponse response)
        {
