...
{
    public partial class OnYourDataUserAssignedManagedIdentityAuthenticationOptions : IUtf8JsonWriteable, IJsonModel<OnYourDataUserAssignedManagedIdentityAuthenticationOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OnYourDataUserAssignedManagedIdentityAuthenticationOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new OnYourDataUserAssignedManagedIdentityAuthenticationOptions FromResponse(PipelineResponse response)
        {
