...
namespace Azure.AI.OpenAI
{
    internal partial class UnknownOnYourDataAuthenticationOptions : IUtf8JsonSerializable, IJsonModel<OnYourDataAuthenticationOptions>
    {
        ...
        void IJsonModel<OnYourDataAuthenticationOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(OnYourDataAuthenticationOptions)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OnYourDataAuthenticationOptions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(OnYourDataAuthenticationOptions)} does not support '{options.Format}' format.");
            }
        }
