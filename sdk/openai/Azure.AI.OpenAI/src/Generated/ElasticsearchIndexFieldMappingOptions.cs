...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ElasticsearchIndexFieldMappingOptions
    {
        ...
        internal ElasticsearchIndexFieldMappingOptions(string titleFieldName, string urlFieldName, string filepathFieldName, IList<string> contentFieldNames, string contentFieldSeparator, IList<string> vectorFieldNames)
        {
