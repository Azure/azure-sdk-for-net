...
{
    public partial class Completions : IUtf8JsonWriteable, IJsonModel<Completions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<Completions>)this).Write(writer, new ModelReaderWriterOptions("W"));
