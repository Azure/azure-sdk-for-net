...
{
    public partial class ChatMessageTextContentItem : IUtf8JsonWriteable, IJsonModel<ChatMessageTextContentItem>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatMessageTextContentItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ChatMessageTextContentItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChatMessageTextContentItem)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChatMessageTextContentItem>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChatMessageTextContentItem)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new ChatMessageTextContentItem FromResponse(PipelineResponse response)
        {
