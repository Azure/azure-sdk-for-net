...
namespace Azure.AI.OpenAI
{
    internal partial class ChatCompletionsNamedFunctionToolSelection : IUtf8JsonSerializable, IJsonModel<ChatCompletionsNamedFunctionToolSelection>
    {
        ...
        void IJsonModel<ChatCompletionsNamedFunctionToolSelection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ChatCompletionsNamedFunctionToolSelection)} does not support '{format}' format.");
            }
        ...
        internal static ChatCompletionsNamedFunctionToolSelection DeserializeChatCompletionsNamedFunctionToolSelection(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ChatCompletionsNamedFunctionToolSelectionName name = default;
            string type = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    name = new ChatCompletionsNamedFunctionToolSelectionName(property.Value.GetString());
                    continue;
                }
        ...
        BinaryData IPersistableModel<ChatCompletionsNamedFunctionToolSelection>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ChatCompletionsNamedFunctionToolSelection)} does not support '{options.Format}' format.");
            }
        }
