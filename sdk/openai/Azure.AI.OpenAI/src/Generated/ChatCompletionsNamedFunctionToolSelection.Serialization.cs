...
{
    internal partial class ChatCompletionsNamedFunctionToolSelection : IUtf8JsonWriteable, IJsonModel<ChatCompletionsNamedFunctionToolSelection>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionsNamedFunctionToolSelection>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ChatCompletionsNamedFunctionToolSelection FromResponse(PipelineResponse response)
        {
