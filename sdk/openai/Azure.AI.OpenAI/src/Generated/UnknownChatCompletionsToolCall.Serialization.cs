...
{
    internal partial class UnknownChatCompletionsToolCall : IUtf8JsonWriteable, IJsonModel<ChatCompletionsToolCall>
    {
        ...
        internal static new UnknownChatCompletionsToolCall FromResponse(PipelineResponse response)
        {
