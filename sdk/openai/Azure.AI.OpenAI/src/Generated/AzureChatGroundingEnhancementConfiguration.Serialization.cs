...
{
    public partial class AzureChatGroundingEnhancementConfiguration : IUtf8JsonWriteable, IJsonModel<AzureChatGroundingEnhancementConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatGroundingEnhancementConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AzureChatGroundingEnhancementConfiguration FromResponse(PipelineResponse response)
        {
