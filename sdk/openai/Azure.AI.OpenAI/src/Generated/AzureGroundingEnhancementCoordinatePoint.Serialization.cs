...
{
    public partial class AzureGroundingEnhancementCoordinatePoint : IUtf8JsonWriteable, IJsonModel<AzureGroundingEnhancementCoordinatePoint>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureGroundingEnhancementCoordinatePoint>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AzureGroundingEnhancementCoordinatePoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureGroundingEnhancementCoordinatePoint)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureGroundingEnhancementCoordinatePoint>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureGroundingEnhancementCoordinatePoint)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static AzureGroundingEnhancementCoordinatePoint FromResponse(PipelineResponse response)
        {
