...
namespace Azure.AI.OpenAI
{
    internal partial class BatchImageGenerationOperationResponse : IUtf8JsonSerializable, IJsonModel<BatchImageGenerationOperationResponse>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchImageGenerationOperationResponse>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static BatchImageGenerationOperationResponse FromResponse(Response response)
        {
            ...
            return DeserializeBatchImageGenerationOperationResponse(document.RootElement, new ModelReaderWriterOptions("W"));
        }
