...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchImageGenerationOperationResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BatchImageGenerationOperationResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchImageGenerationOperationResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchImageGenerationOperationResponse>)} interface");
            }
        ...
        BatchImageGenerationOperationResponse IJsonModel<BatchImageGenerationOperationResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(BatchImageGenerationOperationResponse)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<BatchImageGenerationOperationResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static BatchImageGenerationOperationResponse FromResponse(Response response)
        {
            ...
            return DeserializeBatchImageGenerationOperationResponse(document.RootElement, ModelReaderWriterOptions.Wire);
        }
