    ...
    internal partial class BatchImageGenerationOperationResponse : IUtf8JsonSerializable, IModelJsonSerializable<BatchImageGenerationOperationResponse>
    {
        ...
        void IModelJsonSerializable<BatchImageGenerationOperationResponse>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            if (Optional.IsDefined(Result))
            {
                ...
                {
                    ((IModelJsonSerializable<ImageGenerations>)Result).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="BatchImageGenerationOperationResponse"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="BatchImageGenerationOperationResponse"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="BatchImageGenerationOperationResponse"/>. </summary>
