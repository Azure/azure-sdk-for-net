...
{
    public partial class AzureChatEnhancementConfiguration : IUtf8JsonWriteable, IJsonModel<AzureChatEnhancementConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureChatEnhancementConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AzureChatEnhancementConfiguration FromResponse(PipelineResponse response)
        {
