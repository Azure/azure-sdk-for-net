...
{
    public partial class ContentFilterCitedDetectionResult : IUtf8JsonWriteable, IJsonModel<ContentFilterCitedDetectionResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentFilterCitedDetectionResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ContentFilterCitedDetectionResult FromResponse(PipelineResponse response)
        {
