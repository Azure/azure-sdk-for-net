...
{
    public partial class ImageGenerationContentFilterResults : IUtf8JsonWriteable, IJsonModel<ImageGenerationContentFilterResults>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageGenerationContentFilterResults>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ImageGenerationContentFilterResults FromResponse(PipelineResponse response)
        {
