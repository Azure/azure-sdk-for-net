...
namespace Azure.AI.OpenAI
{
    ...
    public static partial class AzureOpenAIModelFactory
    {
        ...
        public static ChatChoice ChatChoice(ChatMessage message = null, int index = default, CompletionsFinishReason? finishReason = null, ContentFilterResults contentFilterResults = null)
        {
            return new ChatChoice(message, index, finishReason, internalStreamingDeltaMessage: null, contentFilterResults);
        }
