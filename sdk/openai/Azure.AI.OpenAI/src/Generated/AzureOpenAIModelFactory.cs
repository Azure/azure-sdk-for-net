...
namespace Azure.AI.OpenAI
{
    ...
    public static partial class AzureOpenAIModelFactory
    {
        ...
        /// <returns> A new <see cref="OpenAI.BatchImageGenerationOperationResponse"/> instance for mocking. </returns>
        public static BatchImageGenerationOperationResponse BatchImageGenerationOperationResponse(string id = null, long created = default, long? expires = null, ImageLocationResult result = null, AzureOpenAIOperationState status = default, ResponseError error = null)
        {
            return new BatchImageGenerationOperationResponse(id, created, expires, result, status, error);
        }

        /// <summary> Initializes a new instance of ImageLocationResult. </summary>
        /// <param name="created"> A timestamp when this job or item was created (in unix epochs). </param>
        /// <param name="data"> The images generated by the operator. </param>
        /// <returns> A new <see cref="OpenAI.ImageLocationResult"/> instance for mocking. </returns>
        public static ImageLocationResult ImageLocationResult(long created = default, IEnumerable<ImageLocation> data = null)
        {
            data ??= new List<ImageLocation>();

            return new ImageLocationResult(created, data?.ToList());
        }
