...
namespace Azure.AI.OpenAI
{
    ...
    public static partial class AzureOpenAIModelFactory
    {
        ...
        public static ImageGenerations ImageGenerations(DateTimeOffset created = default, IEnumerable<InternalImageLocation> data = null)
        {
            data ??= new List<InternalImageLocation>();
        ...
        /// <returns> A new <see cref="OpenAI.InternalImageLocation"/> instance for mocking. </returns>
        public static InternalImageLocation InternalImageLocation(Uri url = null)
        {
            if (url == null)
            {
