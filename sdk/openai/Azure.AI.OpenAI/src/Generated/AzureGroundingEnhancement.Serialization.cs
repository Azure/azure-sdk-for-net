...
{
    public partial class AzureGroundingEnhancement : IUtf8JsonSerializable, IJsonModel<AzureGroundingEnhancement>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureGroundingEnhancement>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AzureGroundingEnhancement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureGroundingEnhancement)} does not support writing '{format}' format.");
            }
            ...
            {
                writer.WriteObjectValue<AzureGroundingEnhancementLine>(item, options);
            }
        ...
        AzureGroundingEnhancement IJsonModel<AzureGroundingEnhancement>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureGroundingEnhancement)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AzureGroundingEnhancement>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureGroundingEnhancement)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AzureGroundingEnhancement IPersistableModel<AzureGroundingEnhancement>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureGroundingEnhancement)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<AzureGroundingEnhancement>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
