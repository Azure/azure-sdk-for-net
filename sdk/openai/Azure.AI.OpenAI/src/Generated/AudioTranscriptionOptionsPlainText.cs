...
namespace Azure.AI.OpenAI
{
    ...
    internal partial class AudioTranscriptionOptionsPlainText
    {
        /// <summary> Initializes a new instance of AudioTranscriptionOptionsPlainText. </summary>
        /// <param name="file"> The audio file object to transcribe. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="file"/> is null. </exception>
        public AudioTranscriptionOptionsPlainText(BinaryData file)
        {
        ...
        internal AudioTranscriptionOptionsPlainText(BinaryData file, string prompt, float? temperature, string internalNonAzureModelName, string language, AudioTranscriptionFormat? responseFormat)
        {
            File = file;
            Prompt = prompt;
