...
namespace Azure.AI.OpenAI
{
    ...
    internal partial class BatchImageGenerationOperationResponse
    {
        ...
        internal BatchImageGenerationOperationResponse(string id, DateTimeOffset created, long? expires, ImageGenerations result, AzureOpenAIOperationState status, ResponseError error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Created = created;
            Expires = expires;
