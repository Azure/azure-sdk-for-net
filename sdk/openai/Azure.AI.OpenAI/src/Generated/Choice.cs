...
namespace Azure.AI.OpenAI
{
    ...
    public partial class Choice
    {
        ...
        internal Choice(string text, int index, ContentFilterResults contentFilterResults, CompletionsLogProbabilityModel logProbabilityModel, CompletionsFinishReason? finishReason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Index = index;
