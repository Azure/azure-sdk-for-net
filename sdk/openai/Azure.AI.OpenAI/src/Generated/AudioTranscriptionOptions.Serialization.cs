...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranscriptionOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AudioTranscriptionOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AudioTranscriptionOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AudioTranscriptionOptions>)} interface");
            }
        ...
        string IPersistableModel<AudioTranscriptionOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AudioTranscriptionOptions FromResponse(Response response)
        {
            ...
            return DeserializeAudioTranscriptionOptions(document.RootElement, ModelReaderWriterOptions.Wire);
        }
    }
}
