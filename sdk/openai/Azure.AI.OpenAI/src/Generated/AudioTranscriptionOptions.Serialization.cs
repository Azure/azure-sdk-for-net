...
namespace Azure.AI.OpenAI
{
    public partial class AudioTranscriptionOptions : IUtf8JsonSerializable, IJsonModel<AudioTranscriptionOptions>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AudioTranscriptionOptions>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static AudioTranscriptionOptions FromResponse(Response response)
        {
            ...
            return DeserializeAudioTranscriptionOptions(document.RootElement, new ModelReaderWriterOptions("W"));
        }
    }
}
