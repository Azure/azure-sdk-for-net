...
{
    public partial class AudioTranscriptionOptions : IUtf8JsonWriteable, IJsonModel<AudioTranscriptionOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranscriptionOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
