...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ChatCompletionsToolDefinition : IUtf8JsonWriteable, IJsonModel<ChatCompletionsToolDefinition>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionsToolDefinition>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ChatCompletionsToolDefinition FromResponse(PipelineResponse response)
        {
