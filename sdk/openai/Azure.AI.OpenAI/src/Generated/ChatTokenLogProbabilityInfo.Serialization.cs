...
{
    public partial class ChatTokenLogProbabilityInfo : IUtf8JsonWriteable, IJsonModel<ChatTokenLogProbabilityInfo>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatTokenLogProbabilityInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ChatTokenLogProbabilityInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ChatTokenLogProbabilityInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChatTokenLogProbabilityInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ChatTokenLogProbabilityInfo)} does not support '{options.Format}' format.");
            }
        }
