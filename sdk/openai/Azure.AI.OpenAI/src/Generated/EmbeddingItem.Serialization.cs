...
{
    public partial class EmbeddingItem : IUtf8JsonWriteable, IJsonModel<EmbeddingItem>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmbeddingItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<EmbeddingItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EmbeddingItem)} does not support '{format}' format.");
            }
        ...
        internal static EmbeddingItem FromResponse(PipelineResponse response)
        {
