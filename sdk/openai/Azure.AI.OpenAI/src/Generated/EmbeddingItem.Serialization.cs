...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmbeddingItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EmbeddingItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EmbeddingItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EmbeddingItem>)} interface");
            }
        ...
        string IPersistableModel<EmbeddingItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static EmbeddingItem FromResponse(Response response)
        {
            ...
            return DeserializeEmbeddingItem(document.RootElement, ModelReaderWriterOptions.Wire);
        }
