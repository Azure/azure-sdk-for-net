...
namespace Azure.AI.OpenAI
{
    public partial class EmbeddingItem : IUtf8JsonSerializable, IJsonModel<EmbeddingItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<EmbeddingItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static EmbeddingItem FromResponse(Response response)
        {
            ...
            return DeserializeEmbeddingItem(document.RootElement, new ModelReaderWriterOptions("W"));
        }
