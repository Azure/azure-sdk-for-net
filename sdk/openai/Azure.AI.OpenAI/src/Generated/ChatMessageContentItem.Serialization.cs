...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ChatMessageContentItem : IUtf8JsonWriteable, IJsonModel<ChatMessageContentItem>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatMessageContentItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ChatMessageContentItem FromResponse(PipelineResponse response)
        {
