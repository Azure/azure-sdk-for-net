...
{
    public partial class ContentFilterResultsForChoice : IUtf8JsonWriteable, IJsonModel<ContentFilterResultsForChoice>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentFilterResultsForChoice>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ContentFilterResultsForChoice FromResponse(PipelineResponse response)
        {
