...
{
    public partial class ChatRequestToolMessage : IUtf8JsonWriteable, IJsonModel<ChatRequestToolMessage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatRequestToolMessage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ChatRequestToolMessage FromResponse(PipelineResponse response)
        {
