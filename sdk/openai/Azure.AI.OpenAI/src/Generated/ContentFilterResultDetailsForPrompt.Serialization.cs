...
{
    public partial class ContentFilterResultDetailsForPrompt : IUtf8JsonWriteable, IJsonModel<ContentFilterResultDetailsForPrompt>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentFilterResultDetailsForPrompt>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ContentFilterResultDetailsForPrompt FromResponse(PipelineResponse response)
        {
