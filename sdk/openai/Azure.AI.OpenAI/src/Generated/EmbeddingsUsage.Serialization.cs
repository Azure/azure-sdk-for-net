...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmbeddingsUsage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EmbeddingsUsage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EmbeddingsUsage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EmbeddingsUsage>)} interface");
            }
        ...
        string IPersistableModel<EmbeddingsUsage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static EmbeddingsUsage FromResponse(Response response)
        {
            ...
            return DeserializeEmbeddingsUsage(document.RootElement, ModelReaderWriterOptions.Wire);
        }
