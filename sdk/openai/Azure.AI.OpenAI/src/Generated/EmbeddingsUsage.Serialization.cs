...
namespace Azure.AI.OpenAI
{
    public partial class EmbeddingsUsage : IUtf8JsonSerializable, IJsonModel<EmbeddingsUsage>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<EmbeddingsUsage>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static EmbeddingsUsage FromResponse(Response response)
        {
            ...
            return DeserializeEmbeddingsUsage(document.RootElement, new ModelReaderWriterOptions("W"));
        }
