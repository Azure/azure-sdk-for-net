...
{
    internal partial class ElasticsearchChatExtensionParameters : IUtf8JsonWriteable, IJsonModel<ElasticsearchChatExtensionParameters>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticsearchChatExtensionParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ElasticsearchChatExtensionParameters FromResponse(PipelineResponse response)
        {
