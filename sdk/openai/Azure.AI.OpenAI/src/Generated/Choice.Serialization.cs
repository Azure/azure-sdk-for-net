...
namespace Azure.AI.OpenAI
{
    public partial class Choice : IUtf8JsonSerializable, IJsonModel<Choice>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<Choice>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static Choice FromResponse(Response response)
        {
            ...
            return DeserializeChoice(document.RootElement, new ModelReaderWriterOptions("W"));
        }
