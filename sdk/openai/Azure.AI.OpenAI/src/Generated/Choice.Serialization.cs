...
{
    public partial class Choice : IUtf8JsonWriteable, IJsonModel<Choice>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<Choice>)this).Write(writer, new ModelReaderWriterOptions("W"));
