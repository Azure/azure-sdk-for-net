...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Choice>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Choice>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Choice>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Choice>)} interface");
            }
        ...
        string IPersistableModel<Choice>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static Choice FromResponse(Response response)
        {
            ...
            return DeserializeChoice(document.RootElement, ModelReaderWriterOptions.Wire);
        }
