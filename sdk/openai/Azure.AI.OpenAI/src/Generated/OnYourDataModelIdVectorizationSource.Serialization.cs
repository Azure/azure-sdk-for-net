...
{
    public partial class OnYourDataModelIdVectorizationSource : IUtf8JsonWriteable, IJsonModel<OnYourDataModelIdVectorizationSource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OnYourDataModelIdVectorizationSource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new OnYourDataModelIdVectorizationSource FromResponse(PipelineResponse response)
        {
