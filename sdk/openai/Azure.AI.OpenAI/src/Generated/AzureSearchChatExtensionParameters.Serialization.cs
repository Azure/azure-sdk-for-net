...
{
    internal partial class AzureSearchChatExtensionParameters : IUtf8JsonWriteable, IJsonModel<AzureSearchChatExtensionParameters>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureSearchChatExtensionParameters>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AzureSearchChatExtensionParameters FromResponse(PipelineResponse response)
        {
