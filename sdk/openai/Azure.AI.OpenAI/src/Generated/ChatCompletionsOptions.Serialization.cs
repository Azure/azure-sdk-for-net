...
{
    public partial class ChatCompletionsOptions : IUtf8JsonWriteable, IJsonModel<ChatCompletionsOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionsOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ChatCompletionsOptions FromResponse(PipelineResponse response)
        {
