...
namespace Azure.AI.OpenAI
{
    public partial class ChatCompletionsOptions : IUtf8JsonSerializable, IJsonModel<ChatCompletionsOptions>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ChatCompletionsOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ChatCompletionsOptions>)} interface");
            }
        ...
        string IPersistableModel<ChatCompletionsOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ChatCompletionsOptions FromResponse(Response response)
        {
            ...
            return DeserializeChatCompletionsOptions(document.RootElement, ModelReaderWriterOptions.Wire);
        }
