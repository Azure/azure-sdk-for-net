...
namespace Azure.AI.OpenAI
{
    public partial class ChatCompletionsOptions : IUtf8JsonSerializable, IJsonModel<ChatCompletionsOptions>
    {
        ...
        ChatCompletionsOptions IJsonModel<ChatCompletionsOptions>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ChatCompletionsOptions>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ChatCompletionsOptions IModel<ChatCompletionsOptions>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ChatCompletionsOptions>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static ChatCompletionsOptions FromResponse(Response response)
        {
            ...
            return DeserializeChatCompletionsOptions(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
