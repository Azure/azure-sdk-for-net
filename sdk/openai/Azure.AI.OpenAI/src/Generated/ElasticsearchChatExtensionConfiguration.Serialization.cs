...
{
    public partial class ElasticsearchChatExtensionConfiguration : IUtf8JsonWriteable, IJsonModel<ElasticsearchChatExtensionConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ElasticsearchChatExtensionConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ElasticsearchChatExtensionConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ElasticsearchChatExtensionConfiguration)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ElasticsearchChatExtensionConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ElasticsearchChatExtensionConfiguration)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new ElasticsearchChatExtensionConfiguration FromResponse(PipelineResponse response)
        {
