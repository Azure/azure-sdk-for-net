...
{
    public partial class PineconeFieldMappingOptions : IUtf8JsonWriteable, IJsonModel<PineconeFieldMappingOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<PineconeFieldMappingOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static PineconeFieldMappingOptions FromResponse(PipelineResponse response)
        {
