...
{
    internal partial class ChatCompletionsFunctionToolSelection : IUtf8JsonWriteable, IJsonModel<ChatCompletionsFunctionToolSelection>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatCompletionsFunctionToolSelection>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ChatCompletionsFunctionToolSelection FromResponse(PipelineResponse response)
        {
