...
{
    public partial class MaxTokensFinishDetails : IUtf8JsonWriteable, IJsonModel<MaxTokensFinishDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MaxTokensFinishDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MaxTokensFinishDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MaxTokensFinishDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MaxTokensFinishDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MaxTokensFinishDetails)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new MaxTokensFinishDetails FromResponse(PipelineResponse response)
        {
