...
{
    public partial class ChatMessageImageUrl : IUtf8JsonWriteable, IJsonModel<ChatMessageImageUrl>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatMessageImageUrl>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ChatMessageImageUrl FromResponse(PipelineResponse response)
        {
