...
namespace Azure.AI.OpenAI
{
    public partial class ChatChoice : IUtf8JsonSerializable, IJsonModel<ChatChoice>
    {
        ...
        void IJsonModel<ChatChoice>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ChatChoice)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ChatChoice>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ChatChoice)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static ChatChoice FromResponse(Response response)
        {
            ...
            return DeserializeChatChoice(document.RootElement, new ModelReaderWriterOptions("W"));
        }
