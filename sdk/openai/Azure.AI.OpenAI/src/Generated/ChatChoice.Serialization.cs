...
{
    public partial class ChatChoice : IUtf8JsonWriteable, IJsonModel<ChatChoice>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatChoice>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ChatChoice FromResponse(PipelineResponse response)
        {
