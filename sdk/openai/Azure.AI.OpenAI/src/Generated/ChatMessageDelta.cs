...
{
    /// <summary> A single model delta that allows constructing the response in a streaming chat completions request. </summary>
    public partial class ChatMessageDelta
    {
        ...
        internal ChatMessageDelta(ChatRole? role, string content, string name, FunctionCall functionCall)
        {
            Role = role;
            Content = content;
            Name = name;
