...
{
    public partial class CompletionsOptions : IUtf8JsonWriteable, IJsonModel<CompletionsOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CompletionsOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CompletionsOptions DeserializeCompletionsOptions(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CompletionsOptions(
                ...
                temperature,
                topP,
                logitBias ?? new OptionalDictionary<int, int>(),
                user,
                n,
                logprobs,
                suffix,
        ...
        internal static CompletionsOptions FromResponse(PipelineResponse response)
        {
