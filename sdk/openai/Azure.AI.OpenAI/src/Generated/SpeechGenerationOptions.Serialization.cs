...
{
    public partial class SpeechGenerationOptions : IUtf8JsonWriteable, IJsonModel<SpeechGenerationOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpeechGenerationOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
