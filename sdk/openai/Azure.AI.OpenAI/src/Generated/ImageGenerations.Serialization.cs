...
namespace Azure.AI.OpenAI
{
    public partial class ImageGenerations : IUtf8JsonSerializable, IJsonModel<ImageGenerations>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageGenerations>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ImageGenerations FromResponse(Response response)
        {
            ...
            return DeserializeImageGenerations(document.RootElement, new ModelReaderWriterOptions("W"));
        }
