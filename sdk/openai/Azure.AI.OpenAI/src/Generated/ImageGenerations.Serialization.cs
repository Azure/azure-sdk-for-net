...
{
    public partial class ImageGenerations : IUtf8JsonWriteable, IJsonModel<ImageGenerations>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageGenerations>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ImageGenerations FromResponse(PipelineResponse response)
        {
