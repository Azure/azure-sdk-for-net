...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageGenerations>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageGenerations>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageGenerations>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageGenerations>)} interface");
            }
        ...
        string IPersistableModel<ImageGenerations>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ImageGenerations FromResponse(Response response)
        {
            ...
            return DeserializeImageGenerations(document.RootElement, ModelReaderWriterOptions.Wire);
        }
