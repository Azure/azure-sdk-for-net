...
{
    public partial class ChatRequestFunctionMessage : IUtf8JsonWriteable, IJsonModel<ChatRequestFunctionMessage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatRequestFunctionMessage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ChatRequestFunctionMessage FromResponse(PipelineResponse response)
        {
