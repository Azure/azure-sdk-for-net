...
namespace Azure.AI.OpenAI
{
    ...
    internal partial class AudioTranscriptionOptionsSrt
    {
        /// <summary> Initializes a new instance of AudioTranscriptionOptionsSrt. </summary>
        /// <param name="file"> The audio file object to transcribe. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="file"/> is null. </exception>
        public AudioTranscriptionOptionsSrt(BinaryData file)
        {
        ...
        internal AudioTranscriptionOptionsSrt(BinaryData file, string prompt, float? temperature, string internalNonAzureModelName, string language, AudioTranscriptionFormat? responseFormat)
        {
            File = file;
            Prompt = prompt;
