...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FunctionCall>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FunctionCall>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FunctionCall>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FunctionCall>)} interface");
            }
        ...
        string IPersistableModel<FunctionCall>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static FunctionCall FromResponse(Response response)
        {
            ...
            return DeserializeFunctionCall(document.RootElement, ModelReaderWriterOptions.Wire);
        }
