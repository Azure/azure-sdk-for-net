...
{
    public partial class FunctionCall : IUtf8JsonWriteable, IJsonModel<FunctionCall>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FunctionCall>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FunctionCall>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FunctionCall)} does not support '{format}' format.");
            }
        ...
        internal static FunctionCall FromResponse(PipelineResponse response)
        {
