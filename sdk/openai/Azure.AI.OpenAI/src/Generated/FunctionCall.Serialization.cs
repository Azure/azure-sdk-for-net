...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FunctionCall>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<FunctionCall>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FunctionCall>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static FunctionCall FromResponse(Response response)
        {
            ...
            return DeserializeFunctionCall(document.RootElement, new ModelReaderWriterOptions("W"));
        }
