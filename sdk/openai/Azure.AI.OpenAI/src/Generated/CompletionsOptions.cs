...
namespace Azure.AI.OpenAI
{
    ...
    public partial class CompletionsOptions
    {
        ...
        internal CompletionsOptions(IList<string> prompts, int? maxTokens, float? temperature, float? nucleusSamplingFactor, IDictionary<string, int> tokenSelectionBiases, string user, int? choicesPerPrompt, int? logProbabilityCount, string suffix, bool? echo, IList<string> stopSequences, float? presencePenalty, float? frequencyPenalty, int? generationSampleCount, bool? internalShouldStreamResponse, string deploymentName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Prompts = prompts;
            MaxTokens = maxTokens;
        ...
        /// <summary> Initializes a new instance of <see cref="CompletionsOptions"/> for deserialization. </summary>
