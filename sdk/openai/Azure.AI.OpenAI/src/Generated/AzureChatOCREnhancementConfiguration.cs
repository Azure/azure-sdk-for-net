...
namespace Azure.AI.OpenAI
{
    ...
    public partial class AzureChatOCREnhancementConfiguration
    {
        ...
        internal AzureChatOCREnhancementConfiguration(bool enabled, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Initializes a new instance of <see cref="AzureChatOCREnhancementConfiguration"/> for deserialization. </summary>
        internal AzureChatOCREnhancementConfiguration()
        {
        }
