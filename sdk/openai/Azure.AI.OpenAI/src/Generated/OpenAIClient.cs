...
namespace Azure.AI.OpenAI
{
    ...
    public partial class OpenAIClient
    {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetCompletionsStreamingAsync(string,CompletionsOptions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/OpenAIClient.xml" path="doc/members/member[@name='GetCompletionsStreamingAsync(string,RequestContent,RequestContext)']/*" />
        internal virtual async Task<Response> GetCompletionsStreamingAsync(string deploymentId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(deploymentId, nameof(deploymentId));
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("OpenAIClient.GetCompletionsStreaming");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetCompletionsStreamingRequest(deploymentId, content, context);
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetCompletionsStreaming(string,CompletionsOptions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/OpenAIClient.xml" path="doc/members/member[@name='GetCompletionsStreaming(string,RequestContent,RequestContext)']/*" />
        internal virtual Response GetCompletionsStreaming(string deploymentId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(deploymentId, nameof(deploymentId));
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetChatCompletionsStreamingAsync(string,ChatCompletionsOptions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/OpenAIClient.xml" path="doc/members/member[@name='GetChatCompletionsStreamingAsync(string,RequestContent,RequestContext)']/*" />
        internal virtual async Task<Response> GetChatCompletionsStreamingAsync(string deploymentId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(deploymentId, nameof(deploymentId));
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("OpenAIClient.GetChatCompletionsStreaming");
            scope.Start();
            try
            {
                using HttpMessage message = CreateGetChatCompletionsStreamingRequest(deploymentId, content, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetChatCompletionsStreaming(string,ChatCompletionsOptions,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/OpenAIClient.xml" path="doc/members/member[@name='GetChatCompletionsStreaming(string,RequestContent,RequestContext)']/*" />
        internal virtual Response GetChatCompletionsStreaming(string deploymentId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(deploymentId, nameof(deploymentId));
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal HttpMessage CreateGetCompletionsStreamingRequest(string deploymentId, RequestContent content, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetChatCompletionsStreamingRequest(string deploymentId, RequestContent content, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Post;
