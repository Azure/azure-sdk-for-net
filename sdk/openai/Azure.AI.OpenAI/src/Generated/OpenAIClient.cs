...
namespace Azure.AI.OpenAI
{
    ...
    public partial class OpenAIClient
    {
        ...
        public virtual async Task<Operation<ImageOperationResponse>> StartGenerateImageAsync(WaitUntil waitUntil, ImageGenerationOptions imageGenerationOptions, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Operation<ImageOperationResponse> StartGenerateImage(WaitUntil waitUntil, ImageGenerationOptions imageGenerationOptions, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(imageGenerationOptions, nameof(imageGenerationOptions));
        ...
        public virtual async Task<Operation<BinaryData>> StartGenerateImageAsync(WaitUntil waitUntil, RequestContent content, RequestContext context = null)
        {
        ...
        public virtual Operation<BinaryData> StartGenerateImage(WaitUntil waitUntil, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
