...
{
    public partial class ChatResponseMessage : IUtf8JsonWriteable, IJsonModel<ChatResponseMessage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatResponseMessage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ChatResponseMessage FromResponse(PipelineResponse response)
        {
