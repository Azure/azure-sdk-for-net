...
{
    public partial class OnYourDataAccessTokenAuthenticationOptions : IUtf8JsonWriteable, IJsonModel<OnYourDataAccessTokenAuthenticationOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OnYourDataAccessTokenAuthenticationOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<OnYourDataAccessTokenAuthenticationOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OnYourDataAccessTokenAuthenticationOptions)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OnYourDataAccessTokenAuthenticationOptions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(OnYourDataAccessTokenAuthenticationOptions)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new OnYourDataAccessTokenAuthenticationOptions FromResponse(PipelineResponse response)
        {
