...
{
    public partial class AudioTranscription : IUtf8JsonWriteable, IJsonModel<AudioTranscription>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranscription>)this).Write(writer, new ModelReaderWriterOptions("W"));
