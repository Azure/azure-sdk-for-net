...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioTranscription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AudioTranscription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AudioTranscription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AudioTranscription>)} interface");
            }
        ...
        string IPersistableModel<AudioTranscription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
