...
{
    public partial class CompletionsLogProbabilityModel : IUtf8JsonWriteable, IJsonModel<CompletionsLogProbabilityModel>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CompletionsLogProbabilityModel>)this).Write(writer, new ModelReaderWriterOptions("W"));
