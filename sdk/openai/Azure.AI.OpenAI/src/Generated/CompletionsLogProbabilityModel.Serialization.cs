...
namespace Azure.AI.OpenAI
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CompletionsLogProbabilityModel>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        CompletionsLogProbabilityModel IJsonModel<CompletionsLogProbabilityModel>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<CompletionsLogProbabilityModel>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        CompletionsLogProbabilityModel IModel<CompletionsLogProbabilityModel>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<CompletionsLogProbabilityModel>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static CompletionsLogProbabilityModel FromResponse(Response response)
        {
            ...
            return DeserializeCompletionsLogProbabilityModel(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
