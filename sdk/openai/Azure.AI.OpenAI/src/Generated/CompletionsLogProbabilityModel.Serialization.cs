...
namespace Azure.AI.OpenAI
{
    public partial class CompletionsLogProbabilityModel : IUtf8JsonSerializable, IJsonModel<CompletionsLogProbabilityModel>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CompletionsLogProbabilityModel>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static CompletionsLogProbabilityModel FromResponse(Response response)
        {
            ...
            return DeserializeCompletionsLogProbabilityModel(document.RootElement, new ModelReaderWriterOptions("W"));
        }
