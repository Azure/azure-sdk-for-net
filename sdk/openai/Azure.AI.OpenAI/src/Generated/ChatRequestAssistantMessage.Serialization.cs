...
{
    public partial class ChatRequestAssistantMessage : IUtf8JsonWriteable, IJsonModel<ChatRequestAssistantMessage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatRequestAssistantMessage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ChatRequestAssistantMessage FromResponse(PipelineResponse response)
        {
