...
namespace Azure.AI.OpenAI
{
    ...
    public partial class ImageGenerations
    {
        ...
        internal ImageGenerations(DateTimeOffset created, IEnumerable<InternalImageLocation> data)
        {
        ...
        /// <param name="created"> A timestamp when this job or item was created (in unix epochs). </param>
        /// <param name="data"> The images generated by the operator. </param>
        internal ImageGenerations(DateTimeOffset created, IReadOnlyList<InternalImageLocation> data)
        {
            Created = created;
            Data = data;
        }
