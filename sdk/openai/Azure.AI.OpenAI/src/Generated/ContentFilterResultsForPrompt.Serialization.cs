...
namespace Azure.AI.OpenAI
{
    public partial class ContentFilterResultsForPrompt : IUtf8JsonSerializable, IJsonModel<ContentFilterResultsForPrompt>
    {
        ...
        void IJsonModel<ContentFilterResultsForPrompt>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ContentFilterResultsForPrompt)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ContentFilterResultsForPrompt>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ContentFilterResultsForPrompt)} does not support '{options.Format}' format.");
            }
        }
