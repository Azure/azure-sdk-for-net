...
{
    public partial class ContentFilterResultsForPrompt : IUtf8JsonWriteable, IJsonModel<ContentFilterResultsForPrompt>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentFilterResultsForPrompt>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ContentFilterResultsForPrompt FromResponse(PipelineResponse response)
        {
