...
{
    public partial class AzureCosmosDBFieldMappingOptions : IUtf8JsonWriteable, IJsonModel<AzureCosmosDBFieldMappingOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureCosmosDBFieldMappingOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AzureCosmosDBFieldMappingOptions FromResponse(PipelineResponse response)
        {
