# Azure HybridContainerService Management client library for .NET
...
Install the Azure HybridContainerService management library for .NET with [NuGet](https://www.nuget.org/):
