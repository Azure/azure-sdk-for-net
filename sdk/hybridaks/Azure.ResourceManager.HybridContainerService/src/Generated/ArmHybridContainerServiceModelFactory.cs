...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public static partial class ArmHybridContainerServiceModelFactory
    {
        ...
        /// <param name="linuxSshPublicKeys"> The list of SSH public keys used to authenticate with VMs. A maximum of 1 key may be specified. </param>
        ...
        /// <param name="cloudProviderInfraNetworkVnetSubnetIds"> List of ARM resource Ids (maximum 1) for the infrastructure network object e.g. /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AzureStackHCI/logicalNetworks/{logicalNetworkName}. </param>
        ...
        public static ProvisionedClusterProperties ProvisionedClusterProperties(IEnumerable<LinuxSshPublicKey> linuxSshPublicKeys = default, ProvisionedClusterControlPlaneProfile controlPlane = default, string kubernetesVersion = default, ProvisionedClusterNetworkProfile networkProfile = default, StorageProfile storageProfile = default, SecurityProfile securityProfile = default, string clusterVmAccessAuthorizedIPRanges = default, IEnumerable<HybridContainerServiceNamedAgentPoolProfile> agentPoolProfiles = default, IEnumerable<ResourceIdentifier> cloudProviderInfraNetworkVnetSubnetIds = default, HybridContainerServiceResourceProvisioningState? provisioningState = default, ProvisionedClusterStatus status = default, ProvisionedClusterAzureHybridBenefit? licenseAzureHybridBenefit = default, ProvisionedClusterPropertiesAutoScalerProfile autoScalerProfile = default)
        {
            ...
            return new ProvisionedClusterProperties(
                linuxSshPublicKeys is null ? default : new LinuxProfileProperties(new LinuxSshConfiguration((linuxSshPublicKeys ?? new ChangeTrackingList<LinuxSshPublicKey>()).ToList(), default), default),
                controlPlane,
                kubernetesVersion,
                networkProfile,
                storageProfile,
        ...
        {
            return new ProvisionedClusterControlPlaneProfile(count, vmSize, controlPlaneEndpointHostIP is null ? default : new ControlPlaneProfileControlPlaneEndpoint(controlPlaneEndpointHostIP, default), default);
        }
        ...
        public static SecurityProfile SecurityProfile(IEnumerable<BinaryData> customCATrustCertificates = default, bool? isFipsImageEnabled = default)
        {
            customCATrustCertificates ??= new ChangeTrackingList<BinaryData>();

            return new SecurityProfile((customCATrustCertificates ?? new ChangeTrackingList<BinaryData>()).ToList(), isFipsImageEnabled is null ? default : new SecurityProfileFipsImage(isFipsImageEnabled, default), default);
        }
