...
namespace Azure.ResourceManager.HybridContainerService
{
    ...
    public partial class HybridContainerServiceVirtualNetworkResource : ArmResource
    {
        ...
        internal HybridContainerServiceVirtualNetworkResource(ArmClient client, HybridContainerServiceVirtualNetworkData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<HybridContainerServiceVirtualNetworkResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new HybridContainerServiceVirtualNetworkResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
