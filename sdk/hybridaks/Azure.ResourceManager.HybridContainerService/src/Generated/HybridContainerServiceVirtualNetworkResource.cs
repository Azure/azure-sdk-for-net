...
namespace Azure.ResourceManager.HybridContainerService
{
    ...
    public partial class HybridContainerServiceVirtualNetworkResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the HybridContainerServiceVirtualNetwork.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.HybridContainerService/virtualNetworks/{virtualNetworkName}. </description>
        ...
        public virtual async Task<ArmOperation<HybridContainerServiceVirtualNetworkResource>> UpdateAsync(WaitUntil waitUntil, HybridContainerServiceVirtualNetworkData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _virtualNetworksRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, HybridContainerServiceVirtualNetworkData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HybridContainerServiceArmOperation<HybridContainerServiceVirtualNetworkResource> operation = new HybridContainerServiceArmOperation<HybridContainerServiceVirtualNetworkResource>(
                    new HybridContainerServiceVirtualNetworkResourceOperationSource(Client),
                    _virtualNetworksClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HybridContainerServiceVirtualNetworkResource> Update(WaitUntil waitUntil, HybridContainerServiceVirtualNetworkData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
