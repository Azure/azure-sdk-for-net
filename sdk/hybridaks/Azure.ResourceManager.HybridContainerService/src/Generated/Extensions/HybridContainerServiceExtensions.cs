...
namespace Azure.ResourceManager.HybridContainerService
{
    ...
    {
        private static HybridContainerServiceVirtualNetworkResourceExtensionClient GetHybridContainerServiceVirtualNetworkResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new HybridContainerServiceVirtualNetworkResourceExtensionClient(client, resource.Id);
            });
        }

        private static HybridContainerServiceVirtualNetworkResourceExtensionClient GetHybridContainerServiceVirtualNetworkResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new HybridContainerServiceVirtualNetworkResourceExtensionClient(client, scope);
            });
        }

        private static ProvisionedClusterResourceExtensionClient GetProvisionedClusterResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ProvisionedClusterResourceExtensionClient(client, resource.Id);
            });
        }

        private static ProvisionedClusterResourceExtensionClient GetProvisionedClusterResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ProvisionedClusterResourceExtensionClient(client, scope);
            });
        }
        ...
        private static StorageSpaceResourceExtensionClient GetStorageSpaceResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new StorageSpaceResourceExtensionClient(client, resource.Id);
            });
        }

        private static StorageSpaceResourceExtensionClient GetStorageSpaceResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new StorageSpaceResourceExtensionClient(client, scope);
            });
        }
        ...
        {
            return GetProvisionedClusterResourceExtensionClient(subscriptionResource).GetProvisionedClustersAsync(cancellationToken);
        }
        ...
        {
            return GetProvisionedClusterResourceExtensionClient(subscriptionResource).GetProvisionedClusters(cancellationToken);
        }
        ...
        {
            return GetHybridContainerServiceVirtualNetworkResourceExtensionClient(subscriptionResource).GetHybridContainerServiceVirtualNetworksAsync(cancellationToken);
        }
        ...
        {
            return GetHybridContainerServiceVirtualNetworkResourceExtensionClient(subscriptionResource).GetHybridContainerServiceVirtualNetworks(cancellationToken);
        }
        ...
        {
            return GetStorageSpaceResourceExtensionClient(subscriptionResource).GetStorageSpacesAsync(cancellationToken);
        }
        ...
        {
            return GetStorageSpaceResourceExtensionClient(subscriptionResource).GetStorageSpaces(cancellationToken);
        }
    }
}
