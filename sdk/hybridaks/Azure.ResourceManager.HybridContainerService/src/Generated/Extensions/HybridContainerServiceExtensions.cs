...
namespace Azure.ResourceManager.HybridContainerService
{
    ...
    public static partial class HybridContainerServiceExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetProvisionedClusters();
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetHybridContainerServiceVirtualNetworks();
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetStorageSpaces();
        }
