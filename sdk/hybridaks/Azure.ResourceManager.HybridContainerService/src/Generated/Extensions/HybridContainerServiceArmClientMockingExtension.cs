...
namespace Azure.ResourceManager.HybridContainerService.Mocking
{
    ...
    internal partial class HybridContainerServiceArmClientMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HybridContainerServiceArmClientMockingExtension"/> class for mocking. </summary>
        protected HybridContainerServiceArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridContainerServiceArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridContainerServiceArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal HybridContainerServiceArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
        ...
        {
            using var scope0 = HybridContainerServiceClientDiagnostics.CreateScope("HybridContainerServiceArmClientMockingExtension.GetOrchestratorsHybridContainerService");
            scope0.Start();
            try
            {
        ...
        {
            using var scope0 = HybridContainerServiceClientDiagnostics.CreateScope("HybridContainerServiceArmClientMockingExtension.GetVmSkusHybridContainerService");
            scope0.Start();
            try
            {
