...
namespace Azure.ResourceManager.HybridContainerService.Mock
{
    ...
    public partial class ProvisionedClusterResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ProvisionedClusterResourceExtension"/> class for mocking. </summary>
        protected ProvisionedClusterResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ProvisionedClusterResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ProvisionedClusterResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
