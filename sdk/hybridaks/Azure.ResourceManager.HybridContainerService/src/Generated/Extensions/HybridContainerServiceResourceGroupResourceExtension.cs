...
namespace Azure.ResourceManager.HybridContainerService.Mock
{
    ...
    public partial class HybridContainerServiceResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HybridContainerServiceResourceGroupResourceExtension"/> class for mocking. </summary>
        protected HybridContainerServiceResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridContainerServiceResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridContainerServiceResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
