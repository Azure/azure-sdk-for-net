...
namespace Azure.ResourceManager.HybridContainerService.Testing
{
    ...
    public partial class HybridContainerServiceSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HybridContainerServiceSubscriptionResourceExtension"/> class for mocking. </summary>
        protected HybridContainerServiceSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridContainerServiceSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridContainerServiceSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
