...
namespace Azure.ResourceManager.HybridContainerService.Mock
{
    ...
    public partial class HybridContainerServiceVirtualNetworkResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HybridContainerServiceVirtualNetworkResourceExtension"/> class for mocking. </summary>
        protected HybridContainerServiceVirtualNetworkResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HybridContainerServiceVirtualNetworkResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HybridContainerServiceVirtualNetworkResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
