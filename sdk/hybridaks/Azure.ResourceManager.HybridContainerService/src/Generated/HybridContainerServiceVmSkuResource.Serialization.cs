...
namespace Azure.ResourceManager.HybridContainerService
{
    public partial class HybridContainerServiceVmSkuResource : IJsonModel<HybridContainerServiceVmSkuData>
    {
        ...
        {
            return ModelReaderWriter.Read<HybridContainerServiceVmSkuData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<HybridContainerServiceVmSkuData>(data, options);
        }
