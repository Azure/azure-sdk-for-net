...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class VirtualNetworksPropertiesInfraVnetProfileHci
    {
        ...
        internal VirtualNetworksPropertiesInfraVnetProfileHci(string mocGroup, string mocLocation, string mocVnetName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MocGroup = mocGroup;
