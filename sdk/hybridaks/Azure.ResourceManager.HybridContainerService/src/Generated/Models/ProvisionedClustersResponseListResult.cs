...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    internal partial class ProvisionedClustersResponseListResult
    {
        ...
        {
            Value = new ChangeTrackingList<ProvisionedClustersResponseData>();
        }

        /// <summary> Initializes a new instance of ProvisionedClustersResponseListResult. </summary>
        /// <param name="value"></param>
        /// <param name="nextLink"></param>
        internal ProvisionedClustersResponseListResult(IReadOnlyList<ProvisionedClustersResponseData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<ProvisionedClustersResponseData> Value { get; }
