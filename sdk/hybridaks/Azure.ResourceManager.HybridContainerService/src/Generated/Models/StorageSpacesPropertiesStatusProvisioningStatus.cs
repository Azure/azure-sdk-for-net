...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class StorageSpacesPropertiesStatusProvisioningStatus
    {
        ...
        internal StorageSpacesPropertiesStatusProvisioningStatus(StorageSpacesPropertiesStatusProvisioningStatusError error, string operationId, string phase, string status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Error = error;
