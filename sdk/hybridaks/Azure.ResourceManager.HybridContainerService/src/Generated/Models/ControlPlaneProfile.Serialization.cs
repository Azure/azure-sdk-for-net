...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    public partial class ControlPlaneProfile : IUtf8JsonSerializable, IJsonModel<ControlPlaneProfile>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ControlPlaneProfile>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ControlPlaneProfile)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ControlPlaneProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ControlPlaneProfile)} does not support '{options.Format}' format.");
            }
        }
