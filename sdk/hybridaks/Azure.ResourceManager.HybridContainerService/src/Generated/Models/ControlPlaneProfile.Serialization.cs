...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    public partial class ControlPlaneProfile : IUtf8JsonSerializable
    {
        ...
        internal static ControlPlaneProfile DeserializeControlPlaneProfile(JsonElement element)
        {
            ...
            return new ControlPlaneProfile(Optional.ToList(availabilityZones), Optional.ToNullable(osType), Optional.ToNullable(ossku), nodeImageVersion.Value, Optional.ToNullable(count), vmSize.Value, name.Value, controlPlaneEndpoint.Value, linuxProfile.Value);
        }
    }
}
