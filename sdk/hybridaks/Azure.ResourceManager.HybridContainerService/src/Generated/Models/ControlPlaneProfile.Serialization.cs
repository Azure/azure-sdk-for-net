...
{
    public partial class ControlPlaneProfile : IUtf8JsonSerializable, IJsonModel<ControlPlaneProfile>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ControlPlaneProfile>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ControlPlaneProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ControlPlaneProfile>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ControlPlaneProfile>)} interface");
            }
        ...
        ControlPlaneProfile IJsonModel<ControlPlaneProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ControlPlaneProfile)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeControlPlaneProfile(document.RootElement, options);
        }

        internal static ControlPlaneProfile DeserializeControlPlaneProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ControlPlaneProfile(Optional.ToNullable(count), Optional.ToList(availabilityZones), Optional.ToNullable(maxCount), Optional.ToNullable(maxPods), Optional.ToNullable(minCount), Optional.ToNullable(mode), Optional.ToDictionary(nodeLabels), Optional.ToList(nodeTaints), Optional.ToNullable(osType), nodeImageVersion.Value, vmSize.Value, cloudProviderProfile.Value, serializedAdditionalRawData, name.Value, controlPlaneEndpoint.Value, linuxProfile.Value);
        }

        BinaryData IPersistableModel<ControlPlaneProfile>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        ControlPlaneProfile IPersistableModel<ControlPlaneProfile>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<ControlPlaneProfile>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
