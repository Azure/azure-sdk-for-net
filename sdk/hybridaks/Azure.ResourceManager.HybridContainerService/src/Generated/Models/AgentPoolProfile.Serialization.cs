...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    public partial class AgentPoolProfile : IUtf8JsonSerializable, IJsonModel<AgentPoolProfile>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AgentPoolProfile>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AgentPoolProfile)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AgentPoolProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AgentPoolProfile)} does not support '{options.Format}' format.");
            }
        }
