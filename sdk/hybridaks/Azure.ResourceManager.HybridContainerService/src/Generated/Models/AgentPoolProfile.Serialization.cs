...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentPoolProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AgentPoolProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AgentPoolProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AgentPoolProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
