...
{
    public partial class AgentPoolProfile : Core.IUtf8JsonSerializable
    {
        ...
        internal static AgentPoolProfile DeserializeAgentPoolProfile(JsonElement element)
        {
            ...
            return new AgentPoolProfile(Core.Optional.ToNullable(count), Core.Optional.ToList(availabilityZones), Core.Optional.ToNullable(maxCount), Core.Optional.ToNullable(maxPods), Core.Optional.ToNullable(minCount), Core.Optional.ToNullable(mode), Core.Optional.ToDictionary(nodeLabels), Core.Optional.ToList(nodeTaints), Core.Optional.ToNullable(osType), nodeImageVersion.Value, vmSize.Value, cloudProviderProfile.Value);
        }
    }
}
