...
{
    public partial class HybridContainerServiceCredential : IUtf8JsonSerializable, IJsonModel<HybridContainerServiceCredential>, IPersistableModel<HybridContainerServiceCredential>
    {
        ...
        void IJsonModel<HybridContainerServiceCredential>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HybridContainerServiceCredential)} does not support '{format}' format.");
            }
        ...
        internal static HybridContainerServiceCredential DeserializeHybridContainerServiceCredential(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new HybridContainerServiceCredential(name.Value, value.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<HybridContainerServiceCredential>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HybridContainerServiceCredential)} does not support '{options.Format}' format.");
            }
        }
