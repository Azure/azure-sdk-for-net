...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class VirtualNetworkProperties
    {
        ...
        public VirtualNetworkProperties()
        {
            ...
            VmipPool = new ChangeTrackingList<VirtualNetworkPropertiesVmipPoolItem>();
        ...
        internal VirtualNetworkProperties(VirtualNetworkPropertiesInfraVnetProfile infraVnetProfile, IList<VirtualNetworkPropertiesVipPoolItem> vipPool, IList<VirtualNetworkPropertiesVmipPoolItem> vmipPool, IList<string> dhcpServers, IList<string> dnsServers, string gateway, string ipAddressPrefix, int? vlanId, ProvisioningState? provisioningState, VirtualNetworkPropertiesStatus status)
        {
        ...
        public VirtualNetworkPropertiesInfraVnetProfile InfraVnetProfile { get; set; }
        /// <summary> Virtual IP Pool for Kubernetes. </summary>
        public IList<VirtualNetworkPropertiesVipPoolItem> VipPool { get; }
        /// <summary> IP Pool for Virtual Machines. </summary>
        public IList<VirtualNetworkPropertiesVmipPoolItem> VmipPool { get; }
        ...
        internal VirtualNetworkPropertiesStatus Status { get; }
