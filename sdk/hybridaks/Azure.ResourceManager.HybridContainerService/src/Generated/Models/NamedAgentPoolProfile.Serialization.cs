...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NamedAgentPoolProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NamedAgentPoolProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NamedAgentPoolProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NamedAgentPoolProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
