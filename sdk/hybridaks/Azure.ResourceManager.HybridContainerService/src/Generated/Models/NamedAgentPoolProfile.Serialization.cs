...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    public partial class NamedAgentPoolProfile : IUtf8JsonSerializable
    {
        ...
        internal static NamedAgentPoolProfile DeserializeNamedAgentPoolProfile(JsonElement element)
        {
            ...
            return new NamedAgentPoolProfile(Optional.ToList(availabilityZones), Optional.ToNullable(osType), Optional.ToNullable(ossku), nodeImageVersion.Value, Optional.ToNullable(count), vmSize.Value, name.Value);
        }
    }
}
