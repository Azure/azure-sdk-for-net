...
{
    public partial class KubernetesVersionProfileData : IUtf8JsonSerializable
    {
        ...
        internal static KubernetesVersionProfileData DeserializeKubernetesVersionProfileData(JsonElement element)
        {
            ...
            return new KubernetesVersionProfileData(id, name, type, systemData.Value, extendedLocation.Value, properties.Value);
        }
    }
}
