...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadBalancerProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LoadBalancerProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LoadBalancerProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LoadBalancerProfile>)} interface");
            }
        ...
        string IPersistableModel<LoadBalancerProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
