...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageSpacesPropertiesStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageSpacesPropertiesStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageSpacesPropertiesStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageSpacesPropertiesStatus>)} interface");
            }
        ...
        string IPersistableModel<StorageSpacesPropertiesStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
