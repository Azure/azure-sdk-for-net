...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class HttpProxyConfig : HttpProxyConfigResponse
    {
        ...
        internal HttpProxyConfig(string httpProxy, string httpsProxy, IList<string> noProxy, string trustedCa, string username, string password, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(httpProxy, httpsProxy, noProxy, trustedCa, username, serializedAdditionalRawData)
        {
            Password = password;
        }
