...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    public partial class OrchestratorVersionProfile : IUtf8JsonSerializable, IJsonModel<OrchestratorVersionProfile>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<OrchestratorVersionProfile>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OrchestratorVersionProfile>)} interface");
            }
