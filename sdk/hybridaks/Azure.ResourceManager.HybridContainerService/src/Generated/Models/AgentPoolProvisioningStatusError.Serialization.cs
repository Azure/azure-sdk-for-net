...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentPoolProvisioningStatusError>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AgentPoolProvisioningStatusError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AgentPoolProvisioningStatusError>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AgentPoolProvisioningStatusError)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AgentPoolProvisioningStatusError>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AgentPoolProvisioningStatusError)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<AgentPoolProvisioningStatusError>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
