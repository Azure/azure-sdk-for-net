...
{
    internal partial class ClusterVmAccessProfile : IUtf8JsonSerializable, IJsonModel<ClusterVmAccessProfile>, IPersistableModel<ClusterVmAccessProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AuthorizedIPRanges))
            {
                ...
                builder.AppendLine($" '{AuthorizedIPRanges}'");
            }
