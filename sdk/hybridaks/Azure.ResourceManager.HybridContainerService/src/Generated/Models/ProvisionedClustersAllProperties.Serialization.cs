...
{
    public partial class ProvisionedClustersAllProperties : IUtf8JsonSerializable, IJsonModel<ProvisionedClustersAllProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProvisionedClustersAllProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ProvisionedClustersAllProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProvisionedClustersAllProperties>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProvisionedClustersAllProperties>)} interface");
            }
        ...
        ProvisionedClustersAllProperties IJsonModel<ProvisionedClustersAllProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ProvisionedClustersAllProperties)} does not support '{options.Format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeProvisionedClustersAllProperties(document.RootElement, options);
        }

        internal static ProvisionedClustersAllProperties DeserializeProvisionedClustersAllProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ProvisionedClustersAllProperties>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        ProvisionedClustersAllProperties IPersistableModel<ProvisionedClustersAllProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<ProvisionedClustersAllProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
