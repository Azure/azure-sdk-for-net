...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    public partial class ProvisionedClustersAllProperties : IUtf8JsonSerializable, IJsonModel<ProvisionedClustersAllProperties>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProvisionedClustersAllProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ProvisionedClustersAllProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ProvisionedClustersAllProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ProvisionedClustersAllProperties)} does not support '{options.Format}' format.");
            }
        }
