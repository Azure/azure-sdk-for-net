...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentPoolProvisioningStatusStatusProvisioningStatus>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AgentPoolProvisioningStatusStatusProvisioningStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AgentPoolProvisioningStatusStatusProvisioningStatus)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AgentPoolProvisioningStatusStatusProvisioningStatus>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AgentPoolProvisioningStatusStatusProvisioningStatus)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<AgentPoolProvisioningStatusStatusProvisioningStatus>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
