...
{
    public partial class VirtualNetworkPropertiesInfraVnetProfileHci : IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetworkPropertiesInfraVnetProfileHci DeserializeVirtualNetworkPropertiesInfraVnetProfileHci(JsonElement element)
        {
            ...
            return new VirtualNetworkPropertiesInfraVnetProfileHci(mocGroup.Value, mocLocation.Value, mocVnetName.Value);
        }
    }
}
