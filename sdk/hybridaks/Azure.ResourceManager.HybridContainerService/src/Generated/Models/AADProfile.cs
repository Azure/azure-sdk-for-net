...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class AADProfile : AADProfileSecret
    {
        ...
        internal AADProfile(string serverAppSecret, IList<string> adminGroupObjectIds, string clientAppId, bool? enableAzureRbac, bool? managed, string serverAppId, Guid? tenantId, Dictionary<string, BinaryData> rawData) : base(serverAppSecret, rawData)
        {
