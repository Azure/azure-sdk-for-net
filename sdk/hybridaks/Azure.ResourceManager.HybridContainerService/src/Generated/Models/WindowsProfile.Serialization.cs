...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WindowsProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WindowsProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WindowsProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<WindowsProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
