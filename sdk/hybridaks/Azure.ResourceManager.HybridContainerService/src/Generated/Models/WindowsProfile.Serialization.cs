...
{
    public partial class WindowsProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WindowsProfile DeserializeWindowsProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
