...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    public partial class WindowsProfile : IUtf8JsonSerializable, IJsonModel<WindowsProfile>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<WindowsProfile>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WindowsProfile>)} interface");
            }
