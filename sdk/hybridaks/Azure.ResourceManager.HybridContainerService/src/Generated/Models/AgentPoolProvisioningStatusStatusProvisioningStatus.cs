...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class AgentPoolProvisioningStatusStatusProvisioningStatus
    {
        ...
        internal AgentPoolProvisioningStatusStatusProvisioningStatus(AgentPoolProvisioningStatusError error, string operationId, string phase, string status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Error = error;
