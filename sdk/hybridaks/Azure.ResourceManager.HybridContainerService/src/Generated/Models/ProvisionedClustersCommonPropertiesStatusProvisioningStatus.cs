...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class ProvisionedClustersCommonPropertiesStatusProvisioningStatus
    {
        ...
        internal ProvisionedClustersCommonPropertiesStatusProvisioningStatus(ProvisionedClustersCommonPropertiesStatusProvisioningStatusError error, string operationId, string phase, string status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Error = error;
