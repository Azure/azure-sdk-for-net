...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class ProvisionedClustersCommonPropertiesStatusProvisioningStatus
    {
        ...
        internal ProvisionedClustersCommonPropertiesStatusProvisioningStatus(ProvisionedClustersCommonPropertiesStatusProvisioningStatusError error, string operationId, string phase, string status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Error = error;
