...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class StorageSpacesPropertiesHciStorageProfile
    {
        ...
        internal StorageSpacesPropertiesHciStorageProfile(string mocGroup, string mocLocation, string mocStorageContainer, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MocGroup = mocGroup;
