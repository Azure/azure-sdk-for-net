...
{
    internal partial class ProvisionedClusterCloudProviderProfile : IUtf8JsonSerializable, IJsonModel<ProvisionedClusterCloudProviderProfile>, IPersistableModel<ProvisionedClusterCloudProviderProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InfraNetworkProfile))
            {
                builder.Append("  infraNetworkProfile:");
                AppendChildObject(builder, InfraNetworkProfile, options, 2);
            }
