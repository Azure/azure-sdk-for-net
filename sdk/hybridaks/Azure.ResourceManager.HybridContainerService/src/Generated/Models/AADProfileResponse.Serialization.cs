...
{
    public partial class AADProfileResponse : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AADProfileResponse DeserializeAADProfileResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
