...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class NamedAgentPoolProfile : AgentPoolProfile
    {
        ...
        internal NamedAgentPoolProfile(IList<string> availabilityZones, OSType? osType, Ossku? ossku, string nodeImageVersion, int? count, string vmSize, string name) : base(availabilityZones, osType, ossku, nodeImageVersion)
        {
            Count = count;
            VmSize = vmSize;
            Name = name;
