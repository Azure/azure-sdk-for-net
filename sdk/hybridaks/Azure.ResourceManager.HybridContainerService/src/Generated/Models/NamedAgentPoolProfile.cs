...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class NamedAgentPoolProfile : AgentPoolProfile
    {
        ...
        internal NamedAgentPoolProfile(int? count, IList<string> availabilityZones, int? maxCount, int? maxPods, int? minCount, Mode? mode, IDictionary<string, string> nodeLabels, IList<string> nodeTaints, OSType? osType, string nodeImageVersion, string vmSize, CloudProviderProfile cloudProviderProfile, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(count, availabilityZones, maxCount, maxPods, minCount, mode, nodeLabels, nodeTaints, osType, nodeImageVersion, vmSize, cloudProviderProfile, serializedAdditionalRawData)
        {
            Name = name;
        }
