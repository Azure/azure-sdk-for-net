...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class ControlPlaneProfile : NamedAgentPoolProfile
    {
        ...
        internal ControlPlaneProfile(IList<string> availabilityZones, OSType? osType, Ossku? ossku, string nodeImageVersion, int? count, string vmSize, string name, ControlPlaneEndpointProfileControlPlaneEndpoint controlPlaneEndpoint, LinuxProfileProperties linuxProfile) : base(availabilityZones, osType, ossku, nodeImageVersion, count, vmSize, name)
        {
