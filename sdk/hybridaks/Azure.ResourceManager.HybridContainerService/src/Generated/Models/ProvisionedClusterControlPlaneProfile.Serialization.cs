...
{
    public partial class ProvisionedClusterControlPlaneProfile : IUtf8JsonSerializable, IJsonModel<ProvisionedClusterControlPlaneProfile>, IPersistableModel<ProvisionedClusterControlPlaneProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ControlPlaneEndpoint))
            {
                builder.Append("  controlPlaneEndpoint:");
                AppendChildObject(builder, ControlPlaneEndpoint, options, 2);
            }
