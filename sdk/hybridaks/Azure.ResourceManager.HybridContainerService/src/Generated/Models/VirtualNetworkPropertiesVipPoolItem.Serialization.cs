...
{
    public partial class VirtualNetworkPropertiesVipPoolItem : IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetworkPropertiesVipPoolItem DeserializeVirtualNetworkPropertiesVipPoolItem(JsonElement element)
        {
            ...
            return new VirtualNetworkPropertiesVipPoolItem(endIP.Value, startIP.Value);
        }
    }
}
