...
{
    public partial class AADProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AADProfile DeserializeAADProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
