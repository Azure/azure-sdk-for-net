...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    public partial class AADProfile : IUtf8JsonSerializable, IModelJsonSerializable<AADProfile>
    {
        ...
        internal static AADProfile DeserializeAADProfile(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AADProfile(serverAppSecret.Value, Optional.ToList(adminGroupObjectIds), clientAppId.Value, Optional.ToNullable(enableAzureRbac), Optional.ToNullable(managed), serverAppId.Value, Optional.ToNullable(tenantId), serializedAdditionalRawData);
        }
