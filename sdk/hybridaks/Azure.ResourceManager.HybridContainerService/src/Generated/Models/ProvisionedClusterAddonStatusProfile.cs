...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class ProvisionedClusterAddonStatusProfile
    {
        ...
        internal ProvisionedClusterAddonStatusProfile(string name, ProvisionedClusterAddonPhase? phase, bool? ready, string errorMessage, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Phase = phase;
            Ready = ready;
