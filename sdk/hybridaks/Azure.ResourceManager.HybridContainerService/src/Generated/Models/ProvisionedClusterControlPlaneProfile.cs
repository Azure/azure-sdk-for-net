...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class ProvisionedClusterControlPlaneProfile
    {
        ...
        internal ProvisionedClusterControlPlaneProfile(int? count, string vmSize, ControlPlaneProfileControlPlaneEndpoint controlPlaneEndpoint, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Count = count;
            VmSize = vmSize;
