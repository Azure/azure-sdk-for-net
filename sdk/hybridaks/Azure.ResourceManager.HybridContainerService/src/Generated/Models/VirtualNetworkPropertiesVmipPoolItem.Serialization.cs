...
{
    public partial class VirtualNetworkPropertiesVmipPoolItem : IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetworkPropertiesVmipPoolItem DeserializeVirtualNetworkPropertiesVmipPoolItem(JsonElement element)
        {
            ...
            return new VirtualNetworkPropertiesVmipPoolItem(endIP.Value, startIP.Value);
        }
    }
}
