...
{
    public partial class HybridContainerServiceVirtualNetworkData : Core.IUtf8JsonSerializable
    {
        ...
        internal static HybridContainerServiceVirtualNetworkData DeserializeHybridContainerServiceVirtualNetworkData(JsonElement element)
        {
            ...
            Core.Optional<VirtualNetworksProperties> properties = default;
            Core.Optional<VirtualNetworksExtendedLocation> extendedLocation = default;
            ...
            return new HybridContainerServiceVirtualNetworkData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, properties.Value, extendedLocation.Value);
        }
    }
}
