...
{
    public partial class HttpProxyConfig : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HttpProxyConfig DeserializeHttpProxyConfig(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
