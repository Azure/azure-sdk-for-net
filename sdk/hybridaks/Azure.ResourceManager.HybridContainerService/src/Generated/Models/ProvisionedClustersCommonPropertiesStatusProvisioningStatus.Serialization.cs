...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProvisionedClustersCommonPropertiesStatusProvisioningStatus>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ProvisionedClustersCommonPropertiesStatusProvisioningStatus IJsonModel<ProvisionedClustersCommonPropertiesStatusProvisioningStatus>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ProvisionedClustersCommonPropertiesStatusProvisioningStatus>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ProvisionedClustersCommonPropertiesStatusProvisioningStatus IModel<ProvisionedClustersCommonPropertiesStatusProvisioningStatus>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ProvisionedClustersCommonPropertiesStatusProvisioningStatus>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
