...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class NetworkProfile
    {
        ...
        internal NetworkProfile(LoadBalancerProfile loadBalancerProfile, LoadBalancerSku? loadBalancerSku, string dnsServiceIP, NetworkPolicy? networkPolicy, string podCidr, IList<string> podCidrs, string serviceCidr, IList<string> serviceCidrs, Dictionary<string, BinaryData> rawData)
        {
