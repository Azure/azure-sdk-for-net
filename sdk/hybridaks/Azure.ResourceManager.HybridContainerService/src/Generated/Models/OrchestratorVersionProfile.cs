...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class OrchestratorVersionProfile
    {
        ...
        internal OrchestratorVersionProfile(bool? isPreview, bool? @default, string orchestratorType, string orchestratorVersion, IReadOnlyList<OrchestratorProfile> upgrades, Dictionary<string, BinaryData> rawData)
        {
            IsPreview = isPreview;
            Default = @default;
