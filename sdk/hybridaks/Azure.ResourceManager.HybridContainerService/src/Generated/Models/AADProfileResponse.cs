...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class AADProfileResponse
    {
        ...
        internal AADProfileResponse(IList<string> adminGroupObjectIds, string clientAppId, bool? enableAzureRbac, bool? managed, string serverAppId, Guid? tenantId, Dictionary<string, BinaryData> rawData)
        {
