...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinuxProfileProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinuxProfileProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinuxProfileProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinuxProfileProperties>)} interface");
            }
        ...
        string IPersistableModel<LinuxProfileProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
