...
{
    public partial class StorageProfile : IUtf8JsonSerializable, IJsonModel<StorageProfile>, IPersistableModel<StorageProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SmbCsiDriver))
            {
                builder.Append("  smbCsiDriver:");
                AppendChildObject(builder, SmbCsiDriver, options, 2);
            }

            if (Optional.IsDefined(NfsCsiDriver))
            {
                builder.Append("  nfsCsiDriver:");
                AppendChildObject(builder, NfsCsiDriver, options, 2);
            }
