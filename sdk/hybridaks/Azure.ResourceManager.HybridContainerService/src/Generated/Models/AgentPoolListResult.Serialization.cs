...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgentPoolListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AgentPoolListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AgentPoolListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AgentPoolListResult>)} interface");
            }
        ...
        string IPersistableModel<AgentPoolListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
