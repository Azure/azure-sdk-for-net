...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProvisionedClustersCommonPropertiesStatusFeaturesStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ProvisionedClustersCommonPropertiesStatusFeaturesStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProvisionedClustersCommonPropertiesStatusFeaturesStatus>)} interface");
            }
        ...
        string IPersistableModel<ProvisionedClustersCommonPropertiesStatusFeaturesStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
