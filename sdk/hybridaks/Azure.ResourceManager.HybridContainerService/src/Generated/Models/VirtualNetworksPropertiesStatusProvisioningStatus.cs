...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class VirtualNetworksPropertiesStatusProvisioningStatus
    {
        ...
        internal VirtualNetworksPropertiesStatusProvisioningStatus(VirtualNetworksPropertiesStatusProvisioningStatusError error, string operationId, string phase, string status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Error = error;
