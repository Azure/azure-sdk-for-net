...
{
    public partial class LinuxSshPublicKey : IUtf8JsonSerializable
    {
        ...
        internal static LinuxSshPublicKey DeserializeLinuxSshPublicKey(JsonElement element)
        {
            ...
            return new LinuxSshPublicKey(keyData.Value);
        }
    }
}
