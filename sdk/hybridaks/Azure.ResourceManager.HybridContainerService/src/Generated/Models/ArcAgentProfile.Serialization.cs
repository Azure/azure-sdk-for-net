...
{
    public partial class ArcAgentProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ArcAgentProfile DeserializeArcAgentProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
