...
namespace Azure.ResourceManager.HybridContainerService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProvisionedClusterUpgradeProfileData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProvisionedClusterUpgradeProfileData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProvisionedClusterUpgradeProfileData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProvisionedClusterUpgradeProfileData>)} interface");
            }
        ...
        string IPersistableModel<ProvisionedClusterUpgradeProfileData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
