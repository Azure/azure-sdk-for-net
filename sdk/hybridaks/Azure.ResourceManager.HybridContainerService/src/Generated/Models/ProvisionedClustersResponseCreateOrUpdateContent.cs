...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class ProvisionedClustersResponseCreateOrUpdateContent : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ProvisionedClustersResponseCreateOrUpdateContent. </summary>
        /// <param name="location"> The location. </param>
        public ProvisionedClustersResponseCreateOrUpdateContent(AzureLocation location) : base(location)
        {
        }
