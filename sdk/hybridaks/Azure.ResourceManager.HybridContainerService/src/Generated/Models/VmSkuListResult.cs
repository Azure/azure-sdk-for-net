...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class VmSkuListResult : ResourceData
    {
        ...
        internal VmSkuListResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IReadOnlyList<string> vmSKUs, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            VmSKUs = vmSKUs;
            _rawData = rawData;
        }
