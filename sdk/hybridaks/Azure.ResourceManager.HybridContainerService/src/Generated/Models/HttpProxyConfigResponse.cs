...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class HttpProxyConfigResponse
    {
        ...
        internal HttpProxyConfigResponse(string httpProxy, string httpsProxy, IList<string> noProxy, string trustedCa, string username, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            HttpProxy = httpProxy;
