...
{
    public partial class VirtualMachineIPItem : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineIPItem DeserializeVirtualMachineIPItem(JsonElement element)
        {
            ...
            return new VirtualMachineIPItem(endIP.Value, startIP.Value);
        }
    }
}
