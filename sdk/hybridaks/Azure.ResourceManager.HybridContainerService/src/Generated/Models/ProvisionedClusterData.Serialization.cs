...
{
    public partial class ProvisionedClusterData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ProvisionedClusterData DeserializeProvisionedClusterData(JsonElement element)
        {
            ...
            Core.Optional<ProvisionedClustersResponseProperties> properties = default;
            Core.Optional<ProvisionedClustersResponseExtendedLocation> extendedLocation = default;
            ...
            return new ProvisionedClusterData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, identity, properties.Value, extendedLocation.Value);
        }
    }
}
