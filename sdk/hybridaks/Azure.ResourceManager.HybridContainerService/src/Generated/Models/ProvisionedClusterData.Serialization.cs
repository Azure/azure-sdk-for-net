...
namespace Azure.ResourceManager.HybridContainerService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProvisionedClusterData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProvisionedClusterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProvisionedClusterData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProvisionedClusterData>)} interface");
            }
        ...
        string IPersistableModel<ProvisionedClusterData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
