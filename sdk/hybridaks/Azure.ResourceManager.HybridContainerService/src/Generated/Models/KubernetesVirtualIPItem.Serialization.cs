...
{
    public partial class KubernetesVirtualIPItem : IUtf8JsonSerializable
    {
        ...
        internal static KubernetesVirtualIPItem DeserializeKubernetesVirtualIPItem(JsonElement element)
        {
            ...
            return new KubernetesVirtualIPItem(endIP.Value, startIP.Value);
        }
    }
}
