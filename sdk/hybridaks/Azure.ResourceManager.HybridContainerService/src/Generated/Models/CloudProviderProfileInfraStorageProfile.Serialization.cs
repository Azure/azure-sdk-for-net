...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudProviderProfileInfraStorageProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudProviderProfileInfraStorageProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudProviderProfileInfraStorageProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudProviderProfileInfraStorageProfile>)} interface");
            }
        ...
        string IPersistableModel<CloudProviderProfileInfraStorageProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
