...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudProviderProfileInfraStorageProfile>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        CloudProviderProfileInfraStorageProfile IJsonModel<CloudProviderProfileInfraStorageProfile>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(CloudProviderProfileInfraStorageProfile)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<CloudProviderProfileInfraStorageProfile>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        CloudProviderProfileInfraStorageProfile IModel<CloudProviderProfileInfraStorageProfile>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<CloudProviderProfileInfraStorageProfile>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
