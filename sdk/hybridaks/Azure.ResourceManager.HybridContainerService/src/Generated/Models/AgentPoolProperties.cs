...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    internal partial class AgentPoolProperties
    {
        ...
        internal AgentPoolProperties(HybridContainerServiceOSType? osType, HybridContainerServiceOSSku? osSku, IDictionary<string, string> nodeLabels, IList<string> nodeTaints, int? maxCount, int? minCount, bool? enableAutoScaling, int? maxPods, int? count, string vmSize, string kubernetesVersion, int? gpuCountPerNode, HybridContainerServiceResourceProvisioningState? provisioningState, AgentPoolProvisioningStatus status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            OSType = osType;
            OSSku = osSku;
