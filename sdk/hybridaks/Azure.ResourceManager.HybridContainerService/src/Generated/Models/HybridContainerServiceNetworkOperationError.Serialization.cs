...
{
    public partial class HybridContainerServiceNetworkOperationError : IUtf8JsonSerializable, IJsonModel<HybridContainerServiceNetworkOperationError>, IPersistableModel<HybridContainerServiceNetworkOperationError>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridContainerServiceNetworkOperationError>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<HybridContainerServiceNetworkOperationError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HybridContainerServiceNetworkOperationError)} does not support '{format}' format.");
            }
        ...
        internal static HybridContainerServiceNetworkOperationError DeserializeHybridContainerServiceNetworkOperationError(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new HybridContainerServiceNetworkOperationError(code.Value, message.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<HybridContainerServiceNetworkOperationError>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(HybridContainerServiceNetworkOperationError)} does not support '{options.Format}' format.");
            }
        }
