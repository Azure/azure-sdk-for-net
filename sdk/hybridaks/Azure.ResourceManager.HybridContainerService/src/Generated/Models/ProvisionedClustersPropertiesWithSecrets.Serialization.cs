...
{
    public partial class ProvisionedClustersPropertiesWithSecrets : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ProvisionedClustersPropertiesWithSecrets DeserializeProvisionedClustersPropertiesWithSecrets(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
