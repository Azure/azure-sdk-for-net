...
namespace Azure.ResourceManager.HybridContainerService.Models
{
    ...
    public partial class StorageSpacesPropertiesVmwareStorageProfile
    {
        ...
        internal StorageSpacesPropertiesVmwareStorageProfile(string datacenter, string datastore, string folder, string resourcePool, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
