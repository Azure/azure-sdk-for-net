...
namespace Azure.ResourceManager.HybridContainerService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridContainerServiceAgentPoolData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HybridContainerServiceAgentPoolData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HybridContainerServiceAgentPoolData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HybridContainerServiceAgentPoolData>)} interface");
            }
        ...
        string IPersistableModel<HybridContainerServiceAgentPoolData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
