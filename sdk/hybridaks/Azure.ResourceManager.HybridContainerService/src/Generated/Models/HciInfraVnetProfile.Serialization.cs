...
{
    public partial class HciInfraVnetProfile : IUtf8JsonSerializable, IJsonModel<HciInfraVnetProfile>, IPersistableModel<HciInfraVnetProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MocGroup))
            {
                builder.Append("  mocGroup:");
                builder.AppendLine($" '{MocGroup}'");
            }

            if (Optional.IsDefined(MocLocation))
            {
                builder.Append("  mocLocation:");
                builder.AppendLine($" '{MocLocation}'");
            }

            if (Optional.IsDefined(MocVnetName))
            {
                builder.Append("  mocVnetName:");
                builder.AppendLine($" '{MocVnetName}'");
            }
