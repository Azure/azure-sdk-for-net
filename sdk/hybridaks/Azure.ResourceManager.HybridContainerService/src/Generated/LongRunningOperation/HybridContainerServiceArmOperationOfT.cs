...
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal HybridContainerServiceArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal HybridContainerServiceArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "HybridContainerServiceArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerHybridContainerServiceContext.Default).ToObjectFromJson<Dictionary<string, string>>();
