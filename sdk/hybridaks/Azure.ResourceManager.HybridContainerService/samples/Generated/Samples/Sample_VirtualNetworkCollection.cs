...
namespace Azure.ResourceManager.HybridContainerService.Samples
{
    public partial class Sample_VirtualNetworkCollection
    {
        ...
        {
            // Generated from example definition: specification/hybridaks/resource-manager/Microsoft.HybridContainerService/preview/2023-11-15-preview/examples/PutVirtualNetwork.json
            ...
            // invoke the operation
            string virtualNetworkName = "test-vnet-static";
            VirtualNetworkData data = new VirtualNetworkData(new AzureLocation("westus"))
            {
                Properties = new VirtualNetworkProperties()
                {
                    InfraVnetProfile = new VirtualNetworkPropertiesInfraVnetProfile()
                    {
                        VmwareSegmentName = "test-network",
                    },
                    VipPool =
{
...
"192.168.0.1"
                ...
                ExtendedLocation = new VirtualNetworkExtendedLocation()
                {
                    VirtualNetworkExtendedLocationType = "CustomLocation",
        ...
        {
            // Generated from example definition: specification/hybridaks/resource-manager/Microsoft.HybridContainerService/preview/2023-11-15-preview/examples/ListVirtualNetworkByResourceGroup.json
