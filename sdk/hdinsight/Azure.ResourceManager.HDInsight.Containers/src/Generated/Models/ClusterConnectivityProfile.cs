...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class ClusterConnectivityProfile
    {
        ...
        internal ClusterConnectivityProfile(WebConnectivityEndpoint web, IReadOnlyList<SshConnectivityEndpoint> ssh, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Web = web;
            Ssh = ssh;
