...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    public partial class ClusterResizeContent : IUtf8JsonSerializable, IJsonModel<ClusterResizeContent>
    {
        ...
        void IJsonModel<ClusterResizeContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ClusterResizeContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ClusterResizeContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ClusterResizeContent)} does not support '{options.Format}' format.");
            }
        }
