...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterResizeContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterResizeContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterResizeContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterResizeContent>)} interface");
            }
        ...
        ClusterResizeContent IJsonModel<ClusterResizeContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        ClusterResizeContent IPersistableModel<ClusterResizeContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<ClusterResizeContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
