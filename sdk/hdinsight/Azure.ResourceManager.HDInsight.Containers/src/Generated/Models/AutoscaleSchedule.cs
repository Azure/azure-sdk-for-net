...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class AutoscaleSchedule
    {
        ...
        internal AutoscaleSchedule(DateTimeOffset startOn, DateTimeOffset endOn, int count, IList<AutoscaleScheduleDay> days, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartOn = startOn;
            EndOn = endOn;
            Count = count;
