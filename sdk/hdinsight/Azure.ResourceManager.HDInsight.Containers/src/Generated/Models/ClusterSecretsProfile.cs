...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class ClusterSecretsProfile
    {
        ...
        internal ClusterSecretsProfile(ResourceIdentifier keyVaultResourceId, IList<ClusterSecretReference> secrets, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyVaultResourceId = keyVaultResourceId;
            Secrets = secrets;
