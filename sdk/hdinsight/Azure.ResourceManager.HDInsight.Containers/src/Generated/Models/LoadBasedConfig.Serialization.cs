...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LoadBasedConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LoadBasedConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LoadBasedConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LoadBasedConfig>)} interface");
            }
        ...
        string IPersistableModel<LoadBasedConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
