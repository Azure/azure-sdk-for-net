...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterServiceConfigValueEntity>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<ClusterServiceConfigValueEntity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterServiceConfigValueEntity)} does not support writing '{format}' format.");
            }
        ...
        ClusterServiceConfigValueEntity IJsonModel<ClusterServiceConfigValueEntity>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterServiceConfigValueEntity)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ClusterServiceConfigValueEntity>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterServiceConfigValueEntity)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ClusterServiceConfigValueEntity IPersistableModel<ClusterServiceConfigValueEntity>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterServiceConfigValueEntity)} does not support reading '{options.Format}' format.");
            }
        }
