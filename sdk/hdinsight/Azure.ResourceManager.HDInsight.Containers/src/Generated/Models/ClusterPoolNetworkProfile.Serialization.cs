...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterPoolNetworkProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterPoolNetworkProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterPoolNetworkProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterPoolNetworkProfile>)} interface");
            }
        ...
        string IPersistableModel<ClusterPoolNetworkProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
