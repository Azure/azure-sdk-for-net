...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoscaleSchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutoscaleSchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutoscaleSchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutoscaleSchedule>)} interface");
            }
        ...
        string IPersistableModel<AutoscaleSchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
