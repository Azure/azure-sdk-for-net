...
{
    public partial class TrinoCoordinator : IUtf8JsonSerializable, IJsonModel<TrinoCoordinator>, IPersistableModel<TrinoCoordinator>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrinoCoordinator>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HighAvailabilityEnabled))
            {
                ...
                var boolValue = HighAvailabilityEnabled.Value == true ? "true" : "false";
            ...
            if (Optional.IsDefined(Suspend))
            {
                ...
                var boolValue = Suspend.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
