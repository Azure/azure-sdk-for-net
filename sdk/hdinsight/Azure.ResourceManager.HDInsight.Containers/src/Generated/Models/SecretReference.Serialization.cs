...
{
    public partial class SecretReference : IUtf8JsonSerializable
    {
        ...
        internal static SecretReference DeserializeSecretReference(JsonElement element)
        {
            ...
            return new SecretReference(referenceName, type, version.Value, keyVaultObjectName);
        }
    }
}
