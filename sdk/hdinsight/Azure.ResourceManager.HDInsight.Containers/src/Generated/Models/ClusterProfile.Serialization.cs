...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterProfile>)} interface");
            }
        ...
        string IPersistableModel<ClusterProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
