...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterConfigFile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterConfigFile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterConfigFile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterConfigFile>)} interface");
            }
        ...
        string IPersistableModel<ClusterConfigFile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
