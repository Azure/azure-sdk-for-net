...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterInstanceViewStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterInstanceViewStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterInstanceViewStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterInstanceViewStatus>)} interface");
            }
        ...
        string IPersistableModel<ClusterInstanceViewStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
