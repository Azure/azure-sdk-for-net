...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class SparkMetastoreSpec
    {
        ...
        internal SparkMetastoreSpec(string dbServerHost, string dbName, string dbUserName, string dbPasswordSecretName, string keyVaultId, string thriftUriString, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DBServerHost = dbServerHost;
            DBName = dbName;
            DBUserName = dbUserName;
