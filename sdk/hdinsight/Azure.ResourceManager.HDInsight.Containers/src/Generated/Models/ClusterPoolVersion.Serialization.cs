...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterPoolVersion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterPoolVersion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterPoolVersion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ClusterPoolVersion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
