...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SparkProfile>)} interface");
            }
        ...
        string IPersistableModel<SparkProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
