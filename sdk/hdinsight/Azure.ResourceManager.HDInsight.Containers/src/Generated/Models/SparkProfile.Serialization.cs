...
{
    public partial class SparkProfile : IUtf8JsonSerializable, IJsonModel<SparkProfile>, IPersistableModel<SparkProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MetastoreSpec))
            {
                ...
                AppendChildObject(builder, MetastoreSpec, options, 2);
            }

            if (Optional.IsDefined(UserPluginsSpec))
            {
                builder.Append("  userPluginsSpec:");
                AppendChildObject(builder, UserPluginsSpec, options, 2);
            }
