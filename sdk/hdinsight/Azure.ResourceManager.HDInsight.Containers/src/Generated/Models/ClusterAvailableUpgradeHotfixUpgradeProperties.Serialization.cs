...
{
    public partial class ClusterAvailableUpgradeHotfixUpgradeProperties : IUtf8JsonSerializable, IJsonModel<ClusterAvailableUpgradeHotfixUpgradeProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterAvailableUpgradeHotfixUpgradeProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ClusterAvailableUpgradeHotfixUpgradeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterAvailableUpgradeHotfixUpgradeProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterAvailableUpgradeHotfixUpgradeProperties)} does not support writing '{format}' format.");
            }
        ...
        ClusterAvailableUpgradeHotfixUpgradeProperties IJsonModel<ClusterAvailableUpgradeHotfixUpgradeProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterAvailableUpgradeHotfixUpgradeProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterAvailableUpgradeHotfixUpgradeProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeClusterAvailableUpgradeHotfixUpgradeProperties(document.RootElement, options);
        }

        internal static ClusterAvailableUpgradeHotfixUpgradeProperties DeserializeClusterAvailableUpgradeHotfixUpgradeProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ClusterAvailableUpgradeHotfixUpgradeProperties(
                upgradeType,
        ...
        BinaryData IPersistableModel<ClusterAvailableUpgradeHotfixUpgradeProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterAvailableUpgradeHotfixUpgradeProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterAvailableUpgradeHotfixUpgradeProperties)} does not support writing '{options.Format}' format.");
            }
        }

        ClusterAvailableUpgradeHotfixUpgradeProperties IPersistableModel<ClusterAvailableUpgradeHotfixUpgradeProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ClusterAvailableUpgradeHotfixUpgradeProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterAvailableUpgradeHotfixUpgradeProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ClusterAvailableUpgradeHotfixUpgradeProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
