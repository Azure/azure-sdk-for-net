...
{
    public partial class ScalingRule : IUtf8JsonSerializable, IJsonModel<ScalingRule>, IPersistableModel<ScalingRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EvaluationCount))
            {
                builder.Append("  evaluationCount:");
                builder.AppendLine($" '{EvaluationCount.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ComparisonRule))
            {
                ...
                AppendChildObject(builder, ComparisonRule, options, 2);
            }
