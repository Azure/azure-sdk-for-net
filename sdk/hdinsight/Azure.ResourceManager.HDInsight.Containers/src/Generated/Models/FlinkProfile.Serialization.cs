...
{
    public partial class FlinkProfile : IUtf8JsonSerializable, IJsonModel<FlinkProfile>, IPersistableModel<FlinkProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NumReplicas))
            {
                ...
                builder.AppendLine($" '{NumReplicas.Value.ToString()}'");
            }

            if (Optional.IsDefined(JobManager))
            {
                builder.Append("  jobManager:");
                AppendChildObject(builder, JobManager, options, 2);
            }

            if (Optional.IsDefined(HistoryServer))
            {
                builder.Append("  historyServer:");
                AppendChildObject(builder, HistoryServer, options, 2);
            }

            if (Optional.IsDefined(TaskManager))
            {
                builder.Append("  taskManager:");
                AppendChildObject(builder, TaskManager, options, 2);
            }

            if (Optional.IsDefined(CatalogOptions))
            {
                builder.Append("  catalogOptions:");
                AppendChildObject(builder, CatalogOptions, options, 2);
            }
