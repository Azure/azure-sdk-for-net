...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FlinkProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FlinkProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FlinkProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FlinkProfile>)} interface");
            }
        ...
        string IPersistableModel<FlinkProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
