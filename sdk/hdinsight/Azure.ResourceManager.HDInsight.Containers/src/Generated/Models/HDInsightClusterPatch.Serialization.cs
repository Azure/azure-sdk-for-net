...
{
    public partial class HDInsightClusterPatch : IUtf8JsonSerializable, IJsonModel<HDInsightClusterPatch>, IPersistableModel<HDInsightClusterPatch>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClusterProfile))
            {
                ...
                AppendChildObject(builder, ClusterProfile, options, 2);
            }
