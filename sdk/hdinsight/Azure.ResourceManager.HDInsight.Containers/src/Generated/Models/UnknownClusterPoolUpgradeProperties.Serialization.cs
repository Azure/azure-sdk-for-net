...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    internal partial class UnknownClusterPoolUpgradeProperties : IUtf8JsonSerializable, IJsonModel<ClusterPoolUpgradeProperties>
    {
        ...
        void IJsonModel<ClusterPoolUpgradeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterPoolUpgradeProperties)} does not support '{format}' format.");
            }
        ...
        ClusterPoolUpgradeProperties IJsonModel<ClusterPoolUpgradeProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownClusterPoolUpgradeProperties(document.RootElement, options);
        }
        ...
        BinaryData IPersistableModel<ClusterPoolUpgradeProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ClusterPoolUpgradeProperties)} does not support '{options.Format}' format.");
            }
        }
