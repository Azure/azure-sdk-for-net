...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    public partial class FlinkJobProperties : IUtf8JsonSerializable, IModelJsonSerializable<FlinkJobProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<FlinkJobProperties>(this, options.Format);
        ...
        internal static FlinkJobProperties DeserializeFlinkJobProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new FlinkJobProperties(jobType, jobName, jobJarDirectory.Value, jarName.Value, entryClass.Value, args.Value, savePointName.Value, Optional.ToNullable(action), Optional.ToDictionary(flinkConfiguration), jobId.Value, status.Value, jobOutput.Value, actionResult.Value, lastSavePoint.Value, serializedAdditionalRawData);
        }
