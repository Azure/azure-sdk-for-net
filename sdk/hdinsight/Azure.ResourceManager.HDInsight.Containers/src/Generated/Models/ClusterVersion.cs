...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class ClusterVersion : ResourceData
    {
        /// <summary> Initializes a new instance of ClusterVersion. </summary>
        ...
        /// <param name="clusterVersionValue"> Version with three part. </param>
        ...
        internal ClusterVersion(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string clusterType, string clusterVersionValue, string ossVersion, string clusterPoolVersion, bool? isPreview, IReadOnlyList<ClusterComponentsItem> components) : base(id, name, resourceType, systemData)
        {
            ClusterType = clusterType;
            ClusterVersionValue = clusterVersionValue;
        ...
        public string ClusterVersionValue { get; set; }
        /// <summary> Version with three part. </summary>
