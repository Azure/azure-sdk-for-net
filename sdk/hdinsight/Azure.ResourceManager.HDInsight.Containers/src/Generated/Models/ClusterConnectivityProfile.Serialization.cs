...
{
    public partial class ClusterConnectivityProfile : IUtf8JsonSerializable, IJsonModel<ClusterConnectivityProfile>, IPersistableModel<ClusterConnectivityProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  web:");
                AppendChildObject(builder, Web, options, 2);
            }
