...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class ScriptActionProfile
    {
        ...
        internal ScriptActionProfile(string scriptActionProfileType, string name, string uriString, string parameters, IList<string> services, int? timeoutInMinutes, bool? shouldPersist, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ScriptActionProfileType = scriptActionProfileType;
            Name = name;
            UriString = uriString;
