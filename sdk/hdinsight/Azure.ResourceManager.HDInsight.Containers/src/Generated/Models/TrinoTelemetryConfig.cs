...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class TrinoTelemetryConfig
    {
        ...
        internal TrinoTelemetryConfig(string hivecatalogName, string hivecatalogSchema, int? partitionRetentionInDays, string path, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
