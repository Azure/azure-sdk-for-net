...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    public partial class RangerAdminSpec : IUtf8JsonSerializable, IJsonModel<RangerAdminSpec>
    {
        ...
        void IJsonModel<RangerAdminSpec>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RangerAdminSpec)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RangerAdminSpec>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RangerAdminSpec)} does not support '{options.Format}' format.");
            }
        }
