...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FlinkCatalogOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FlinkCatalogOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FlinkCatalogOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FlinkCatalogOptions>)} interface");
            }
        ...
        string IPersistableModel<FlinkCatalogOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
