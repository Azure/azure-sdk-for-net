...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    public partial class HDInsightClusterVersion : IUtf8JsonSerializable, IJsonModel<HDInsightClusterVersion>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightClusterVersion>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightClusterVersion>)} interface");
            }
