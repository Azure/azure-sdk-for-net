...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CatalogOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CatalogOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CatalogOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CatalogOptions>)} interface");
            }
        ...
        string IPersistableModel<CatalogOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
