...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    internal partial class UnknownClusterJobProperties : IUtf8JsonSerializable, IJsonModel<ClusterJobProperties>
    {
        ...
        void IJsonModel<ClusterJobProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ClusterJobProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ClusterJobProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ClusterJobProperties)} does not support '{options.Format}' format.");
            }
        }
