...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class ClusterServiceConfigResult
    {
        ...
        internal ClusterServiceConfigResult(string serviceName, string fileName, string content, string componentName, string serviceConfigListResultPropertiesType, string path, IReadOnlyDictionary<string, string> customKeys, IReadOnlyDictionary<string, ClusterServiceConfigValueEntity> defaultKeys, Dictionary<string, BinaryData> rawData)
        {
