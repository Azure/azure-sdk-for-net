...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkUserPluginListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkUserPluginListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkUserPluginListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SparkUserPluginListResult>)} interface");
            }
        ...
        string IPersistableModel<SparkUserPluginListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
