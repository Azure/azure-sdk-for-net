...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class ScheduleBasedConfig
    {
        ...
        internal ScheduleBasedConfig(string timeZone, int defaultCount, IList<AutoscaleSchedule> schedules, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TimeZone = timeZone;
            DefaultCount = defaultCount;
            Schedules = schedules;
