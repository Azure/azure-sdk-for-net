...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterSshProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterSshProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterSshProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterSshProfile>)} interface");
            }
        ...
        string IPersistableModel<ClusterSshProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
