...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class ClusterConfigFile
    {
        ...
        internal ClusterConfigFile(string fileName, string content, HDInsightContentEncoding? encoding, string path, IDictionary<string, string> values, Dictionary<string, BinaryData> rawData)
        {
            FileName = fileName;
            Content = content;
            Encoding = encoding;
