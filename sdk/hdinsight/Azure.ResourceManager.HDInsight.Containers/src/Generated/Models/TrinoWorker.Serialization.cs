...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrinoWorker>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrinoWorker>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrinoWorker>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrinoWorker>)} interface");
            }
        ...
        string IPersistableModel<TrinoWorker>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
