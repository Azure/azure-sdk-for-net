...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightClusterListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightClusterListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightClusterListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightClusterListResult>)} interface");
            }
        ...
        string IPersistableModel<HDInsightClusterListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
