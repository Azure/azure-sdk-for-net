...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class ClusterSecretReference
    {
        ...
        internal ClusterSecretReference(string referenceName, KeyVaultObjectType keyVaultObjectType, string version, string keyVaultObjectName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ReferenceName = referenceName;
            KeyVaultObjectType = keyVaultObjectType;
            Version = version;
