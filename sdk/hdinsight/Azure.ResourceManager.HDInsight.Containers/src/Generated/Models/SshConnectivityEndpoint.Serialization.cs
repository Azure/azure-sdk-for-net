...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SshConnectivityEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SshConnectivityEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SshConnectivityEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SshConnectivityEndpoint>)} interface");
            }
        ...
        string IPersistableModel<SshConnectivityEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
