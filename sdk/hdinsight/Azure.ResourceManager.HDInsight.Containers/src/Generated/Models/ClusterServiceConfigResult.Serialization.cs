...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterServiceConfigResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterServiceConfigResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterServiceConfigResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterServiceConfigResult>)} interface");
            }
        ...
        string IPersistableModel<ClusterServiceConfigResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
