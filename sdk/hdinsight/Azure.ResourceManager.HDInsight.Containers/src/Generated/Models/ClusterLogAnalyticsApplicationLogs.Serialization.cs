...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterLogAnalyticsApplicationLogs>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterLogAnalyticsApplicationLogs>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterLogAnalyticsApplicationLogs>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterLogAnalyticsApplicationLogs>)} interface");
            }
        ...
        string IPersistableModel<ClusterLogAnalyticsApplicationLogs>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
