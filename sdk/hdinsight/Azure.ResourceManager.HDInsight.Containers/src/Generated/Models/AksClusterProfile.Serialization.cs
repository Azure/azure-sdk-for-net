...
{
    public partial class AksClusterProfile : IUtf8JsonSerializable, IJsonModel<AksClusterProfile>, IPersistableModel<AksClusterProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AksClusterAgentPoolIdentityProfile))
            {
                ...
                AppendChildObject(builder, AksClusterAgentPoolIdentityProfile, options, 2);
            }
