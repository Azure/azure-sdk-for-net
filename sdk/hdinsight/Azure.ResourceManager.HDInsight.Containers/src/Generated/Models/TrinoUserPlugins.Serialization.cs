...
{
    internal partial class TrinoUserPlugins : IUtf8JsonSerializable
    {
        ...
        internal static TrinoUserPlugins DeserializeTrinoUserPlugins(JsonElement element)
        {
            ...
            return new TrinoUserPlugins(Optional.ToList(plugins));
        }
    }
}
