...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class HiveCatalogOption
    {
        ...
        internal HiveCatalogOption(string catalogName, string metastoreDBConnectionPasswordSecret, string metastoreDBConnectionUriString, string metastoreDBConnectionUserName, string metastoreWarehouseDir, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CatalogName = catalogName;
            MetastoreDBConnectionPasswordSecret = metastoreDBConnectionPasswordSecret;
            MetastoreDBConnectionUriString = metastoreDBConnectionUriString;
