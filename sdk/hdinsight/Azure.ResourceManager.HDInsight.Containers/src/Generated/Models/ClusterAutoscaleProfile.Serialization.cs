...
{
    public partial class ClusterAutoscaleProfile : IUtf8JsonSerializable, IJsonModel<ClusterAutoscaleProfile>, IPersistableModel<ClusterAutoscaleProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GracefulDecommissionTimeout))
            {
                ...
                builder.AppendLine($" '{GracefulDecommissionTimeout.Value.ToString()}'");
            }

            if (Optional.IsDefined(AutoscaleType))
            {
                builder.Append("  autoscaleType:");
                builder.AppendLine($" '{AutoscaleType.ToString()}'");
            }

            if (Optional.IsDefined(ScheduleBasedConfig))
            {
                builder.Append("  scheduleBasedConfig:");
                AppendChildObject(builder, ScheduleBasedConfig, options, 2);
            }

            if (Optional.IsDefined(LoadBasedConfig))
            {
                builder.Append("  loadBasedConfig:");
                AppendChildObject(builder, LoadBasedConfig, options, 2);
            }
