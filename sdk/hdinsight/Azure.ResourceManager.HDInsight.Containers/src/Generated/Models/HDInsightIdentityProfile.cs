...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class HDInsightIdentityProfile
    {
        ...
        internal HDInsightIdentityProfile(ResourceIdentifier msiResourceId, string msiClientId, string msiObjectId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MsiResourceId = msiResourceId;
            MsiClientId = msiClientId;
            MsiObjectId = msiObjectId;
