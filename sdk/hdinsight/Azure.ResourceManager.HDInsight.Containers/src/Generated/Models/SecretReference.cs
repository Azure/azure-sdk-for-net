...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SecretReference. </summary>
        ...
        public SecretReference(string referenceName, KeyVaultObjectType keyVaultObjectType, string keyVaultObjectName)
        {
        ...
        /// <param name="keyVaultObjectName"> Object identifier name of the secret in key vault. </param>
        internal SecretReference(string referenceName, KeyVaultObjectType keyVaultObjectType, string version, string keyVaultObjectName)
        {
            ReferenceName = referenceName;
            KeyVaultObjectType = keyVaultObjectType;
            Version = version;
