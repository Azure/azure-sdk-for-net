...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    internal partial class ComputeProfile : IUtf8JsonSerializable, IJsonModel<ComputeProfile>
    {
        ...
        void IJsonModel<ComputeProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ComputeProfile)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ComputeProfile>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ComputeProfile)} does not support '{options.Format}' format.");
            }
        }
