...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class ClusterInstanceViewResult
    {
        ...
        internal ClusterInstanceViewResult(string name, ClusterInstanceViewStatus status, IReadOnlyList<HDInsightServiceStatus> serviceStatuses, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Status = status;
