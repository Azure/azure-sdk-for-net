...
{
    public partial class TrinoTelemetryConfig : IUtf8JsonSerializable, IJsonModel<TrinoTelemetryConfig>, IPersistableModel<TrinoTelemetryConfig>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PartitionRetentionInDays))
            {
                ...
                builder.AppendLine($" '{PartitionRetentionInDays.Value.ToString()}'");
            }
