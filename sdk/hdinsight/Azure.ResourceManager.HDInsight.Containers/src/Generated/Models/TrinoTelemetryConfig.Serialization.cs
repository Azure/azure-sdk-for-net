...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrinoTelemetryConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrinoTelemetryConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrinoTelemetryConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrinoTelemetryConfig>)} interface");
            }
        ...
        string IPersistableModel<TrinoTelemetryConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
