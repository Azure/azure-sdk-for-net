...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    internal partial class WebConnectivityEndpoint : IUtf8JsonSerializable, IJsonModel<WebConnectivityEndpoint>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<WebConnectivityEndpoint>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<WebConnectivityEndpoint>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
