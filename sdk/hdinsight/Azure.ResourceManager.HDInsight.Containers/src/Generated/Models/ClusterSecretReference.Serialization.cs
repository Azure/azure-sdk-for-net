...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClusterSecretReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClusterSecretReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClusterSecretReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClusterSecretReference>)} interface");
            }
        ...
        string IPersistableModel<ClusterSecretReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
