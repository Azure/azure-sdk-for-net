...
{
    public partial class HDInsightClusterPoolData : IUtf8JsonSerializable, IJsonModel<HDInsightClusterPoolData>, IPersistableModel<HDInsightClusterPoolData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClusterPoolProfile))
            {
                ...
                AppendChildObject(builder, ClusterPoolProfile, options, 2);
            }
            ...
            if (Optional.IsDefined(AksClusterProfile))
            {
                ...
                AppendChildObject(builder, AksClusterProfile, options, 2);
            }
