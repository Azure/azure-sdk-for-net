...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduleBasedConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScheduleBasedConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScheduleBasedConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScheduleBasedConfig>)} interface");
            }
        ...
        string IPersistableModel<ScheduleBasedConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
