...
{
    public partial class ScheduleBasedConfig : IUtf8JsonSerializable, IJsonModel<ScheduleBasedConfig>, IPersistableModel<ScheduleBasedConfig>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DefaultCount))
            {
                builder.Append("  defaultCount:");
                builder.AppendLine($" '{DefaultCount.ToString()}'");
            }
