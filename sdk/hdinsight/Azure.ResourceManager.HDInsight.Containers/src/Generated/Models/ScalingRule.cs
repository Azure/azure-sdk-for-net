...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public partial class ScalingRule
    {
        ...
        internal ScalingRule(ScaleActionType actionType, int evaluationCount, string scalingMetric, HDInsightComparisonRule comparisonRule, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ActionType = actionType;
            EvaluationCount = evaluationCount;
            ScalingMetric = scalingMetric;
