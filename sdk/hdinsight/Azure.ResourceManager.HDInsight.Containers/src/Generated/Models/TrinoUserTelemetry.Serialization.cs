...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    internal partial class TrinoUserTelemetry : IUtf8JsonSerializable, IJsonModel<TrinoUserTelemetry>
    {
        ...
        void IJsonModel<TrinoUserTelemetry>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TrinoUserTelemetry)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TrinoUserTelemetry>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TrinoUserTelemetry)} does not support '{options.Format}' format.");
            }
        }
