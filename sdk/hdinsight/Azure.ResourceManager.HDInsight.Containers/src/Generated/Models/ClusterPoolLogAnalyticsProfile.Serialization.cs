...
{
    public partial class ClusterPoolLogAnalyticsProfile : IUtf8JsonSerializable, IJsonModel<ClusterPoolLogAnalyticsProfile>, IPersistableModel<ClusterPoolLogAnalyticsProfile>
    {
        ...
        void IJsonModel<ClusterPoolLogAnalyticsProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClusterPoolLogAnalyticsProfile)} does not support '{format}' format.");
            }
