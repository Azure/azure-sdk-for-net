...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    internal partial class TrinoUserPluginListResult : IUtf8JsonSerializable, IJsonModel<TrinoUserPluginListResult>
    {
        ...
        void IJsonModel<TrinoUserPluginListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TrinoUserPluginListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TrinoUserPluginListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TrinoUserPluginListResult)} does not support '{options.Format}' format.");
            }
        }
