...
namespace Azure.ResourceManager.HDInsight.Containers.Mocking
{
    ...
    public partial class HDInsightContainersSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="HDInsightContainersSubscriptionMockingExtension"/> class for mocking. </summary>
        protected HDInsightContainersSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HDInsightContainersSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HDInsightContainersSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<HDInsightNameAvailabilityResult>> CheckHDInsightNameAvailabilityAsync(AzureLocation location, HDInsightNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = LocationsClientDiagnostics.CreateScope("HDInsightContainersSubscriptionMockingExtension.CheckHDInsightNameAvailability");
            scope.Start();
            try
            {
