...
namespace Azure.ResourceManager.HDInsight.Containers.Mocking
{
    ...
    public partial class HDInsightContainersArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HDInsightContainersArmClientMockingExtension"/> class for mocking. </summary>
        protected HDInsightContainersArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HDInsightContainersArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HDInsightContainersArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal HDInsightContainersArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
