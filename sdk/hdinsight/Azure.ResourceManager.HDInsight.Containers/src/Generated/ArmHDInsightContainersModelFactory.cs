...
namespace Azure.ResourceManager.HDInsight.Containers.Models
{
    ...
    public static partial class ArmHDInsightContainersModelFactory
    {
        ...
        public static HDInsightClusterPoolData HDInsightClusterPoolData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ClusterPoolResourceProperties properties = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ClusterPoolResourceProperties"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.ClusterPoolResourceProperties"/> instance for mocking. </returns>
        public static ClusterPoolResourceProperties ClusterPoolResourceProperties(HDInsightProvisioningStatus? provisioningState = null, string deploymentId = null, string managedResourceGroupName = null, string aksManagedResourceGroupName = null, string clusterPoolVersion = null, ClusterPoolComputeProfile computeProfile = null, AksClusterProfile aksClusterProfile = null, ClusterPoolNetworkProfile networkProfile = null, ClusterPoolLogAnalyticsProfile logAnalyticsProfile = null, string status = null)
        {
            return new ClusterPoolResourceProperties(
                provisioningState,
                deploymentId,
        ...
        public static HDInsightClusterData HDInsightClusterData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ClusterResourceProperties properties = null)
        {
            tags ??= new Dictionary<string, string>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ClusterResourceProperties"/>. </summary>
        /// <param name="provisioningState"> Provisioning state of the resource. </param>
        ...
        public static ClusterResourceProperties ClusterResourceProperties(HDInsightProvisioningStatus? provisioningState = null, string clusterType = null, string deploymentId = null, ComputeProfile computeProfile = null, ClusterProfile clusterProfile = null, string status = null)
        {
        ...
        public static ClusterServiceConfigResult ClusterServiceConfigResult(ServiceConfigResultProperties properties = null)
        {
            return new ClusterServiceConfigResult(properties, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.ServiceConfigResultProperties"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.ServiceConfigResultProperties"/> instance for mocking. </returns>
        public static ServiceConfigResultProperties ServiceConfigResultProperties(string serviceName = null, string fileName = null, string content = null, string componentName = null, string serviceConfigListResultPropertiesType = null, string path = null, IReadOnlyDictionary<string, string> customKeys = null, IReadOnlyDictionary<string, ClusterServiceConfigValueEntity> defaultKeys = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.ServiceConfigListResultProperties"/>. </summary>
        /// <param name="serviceName"> Service Config Name. </param>
        /// <param name="fileName"> File Name. </param>
        /// <param name="content"> Content in the service config file. </param>
        /// <param name="componentName"> Component Name. </param>
        ...
        /// <param name="customKeys"> The custom keys. </param>
        /// <param name="defaultKeys"> The default keys. </param>
        /// <returns> A new <see cref="Models.ServiceConfigListResultProperties"/> instance for mocking. </returns>
        public static ServiceConfigListResultProperties ServiceConfigListResultProperties(string serviceName = null, string fileName = null, string content = null, string componentName = null, string serviceConfigListResultPropertiesType = null, string path = null, IReadOnlyDictionary<string, string> customKeys = null, IReadOnlyDictionary<string, ClusterServiceConfigValueEntity> defaultKeys = null)
        {
            customKeys ??= new Dictionary<string, string>();
            defaultKeys ??= new Dictionary<string, ClusterServiceConfigValueEntity>();
        ...
        public static ClusterInstanceViewResult ClusterInstanceViewResult(string name = null, ClusterInstanceViewResultProperties properties = null)
        {
            return new ClusterInstanceViewResult(name, properties, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.ClusterInstanceViewResultProperties"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.ClusterInstanceViewResultProperties"/> instance for mocking. </returns>
        public static ClusterInstanceViewResultProperties ClusterInstanceViewResultProperties(ClusterInstanceViewStatus status = null, IEnumerable<HDInsightServiceStatus> serviceStatuses = null)
        {
            serviceStatuses ??= new List<HDInsightServiceStatus>();

            return new ClusterInstanceViewResultProperties(status, serviceStatuses?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        /// The available derived classes include <see cref="Models.MavenLibraryProperties"/> and <see cref="Models.PyPiLibraryProperties"/>.
        /// </param>
        ...
        /// <summary> Initializes a new instance of <see cref="Models.PyPiLibraryProperties"/>. </summary>
        /// <param name="remarks"> Remark of the latest library management operation. </param>
        /// <param name="timestamp"> Timestamp of the latest library management operation. </param>
        /// <param name="status"> Status of the library. </param>
        /// <param name="message"> Error message of the library operation when a failure occurs. </param>
        ...
        /// <returns> A new <see cref="Models.PyPiLibraryProperties"/> instance for mocking. </returns>
        public static PyPiLibraryProperties PyPiLibraryProperties(string remarks = null, DateTimeOffset? timestamp = null, Status? status = null, string message = null, string name = null, string version = null)
        {
            return new PyPiLibraryProperties(
                Type.Pypi,
                remarks,
                timestamp,
                status,
        ...
        /// <summary> Initializes a new instance of <see cref="Models.MavenLibraryProperties"/>. </summary>
        /// <param name="remarks"> Remark of the latest library management operation. </param>
        /// <param name="timestamp"> Timestamp of the latest library management operation. </param>
        /// <param name="status"> Status of the library. </param>
        /// <param name="message"> Error message of the library operation when a failure occurs. </param>
        ...
        /// <returns> A new <see cref="Models.MavenLibraryProperties"/> instance for mocking. </returns>
        public static MavenLibraryProperties MavenLibraryProperties(string remarks = null, DateTimeOffset? timestamp = null, Status? status = null, string message = null, string groupId = null, string name = null, string version = null)
        {
