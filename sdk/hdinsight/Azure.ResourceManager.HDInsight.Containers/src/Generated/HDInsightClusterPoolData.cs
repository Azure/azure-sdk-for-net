...
namespace Azure.ResourceManager.HDInsight.Containers
{
    ...
    public partial class HDInsightClusterPoolData : TrackedResourceData
    {
        ...
        internal ClusterPoolResourcePropertiesClusterPoolProfile ClusterPoolProfile { get; set; }
        ...
        public string ClusterPoolVersion
        {
            ...
            set => ClusterPoolProfile = new ClusterPoolResourcePropertiesClusterPoolProfile(value);
        }

        /// <summary> CLuster pool compute profile. </summary>
        public ClusterPoolResourcePropertiesComputeProfile ComputeProfile { get; set; }
        /// <summary> Properties of underlying AKS cluster. </summary>
        public ClusterPoolResourcePropertiesAksClusterProfile AksClusterProfile { get; }
        /// <summary> Cluster pool network profile. </summary>
        internal ClusterPoolResourcePropertiesNetworkProfile NetworkProfile { get; set; }
        ...
        public ResourceIdentifier NetworkSubnetId
        {
            ...
            set => NetworkProfile = new ClusterPoolResourcePropertiesNetworkProfile(value);
        }

        /// <summary> Cluster pool log analytics profile to enable OMS agent for AKS cluster. </summary>
        public ClusterPoolResourcePropertiesLogAnalyticsProfile LogAnalyticsProfile { get; set; }
