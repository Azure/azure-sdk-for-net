...
{
    internal partial class ClusterLibrariesRestOperations
    {
        ...
        /// <summary> Initializes a new instance of ClusterLibrariesRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public ClusterLibrariesRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        public async Task<Response<ClusterLibraryList>> ListAsync(string subscriptionId, string resourceGroupName, string clusterPoolName, string clusterName, ClusterLibraryCategory category, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateListRequest(subscriptionId, resourceGroupName, clusterPoolName, clusterName, category);
        ...
        internal RequestUriBuilder CreateManageLibrariesRequestUri(string subscriptionId, string resourceGroupName, string clusterPoolName, string clusterName, ClusterLibraryManagementContent content)
        {
            ...
            uri.AppendPath("/clusters/", false);
            uri.AppendPath(clusterName, true);
            uri.AppendPath("/manageLibraries", false);
            uri.AppendQuery("api-version", _apiVersion, true);
            return uri;
        }
        ...
        public async Task<Response<ClusterLibraryList>> ListNextPageAsync(string nextLink, string subscriptionId, string resourceGroupName, string clusterPoolName, string clusterName, ClusterLibraryCategory category, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateListNextPageRequest(nextLink, subscriptionId, resourceGroupName, clusterPoolName, clusterName, category);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
