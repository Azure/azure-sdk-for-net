...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightAutoScaleTimeAndCapacity
    {
        ...
        internal HDInsightAutoScaleTimeAndCapacity(string time, int? minInstanceCount, int? maxInstanceCount, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Time = time;
