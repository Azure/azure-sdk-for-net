...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightAutoScaleTimeAndCapacity
    {
        ...
        internal HDInsightAutoScaleTimeAndCapacity(string time, int? minInstanceCount, int? maxInstanceCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Time = time;
