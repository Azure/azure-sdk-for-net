...
{
    public partial class ApplicationGetEndpoint : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationGetEndpoint DeserializeApplicationGetEndpoint(JsonElement element)
        {
            ...
            return new ApplicationGetEndpoint(Optional.ToNullable(location), Optional.ToNullable(destinationPort), Optional.ToNullable(publicPort), privateIPAddress.Value);
        }
    }
}
