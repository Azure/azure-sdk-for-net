...
{
    internal partial class OSProfile : IUtf8JsonSerializable, IJsonModel<OSProfile>
    {
        ...
        void IJsonModel<OSProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LinuxProfile))
            {
                ...
                writer.WriteObjectValue<HDInsightLinuxOSProfile>(LinuxProfile, options);
            }
        ...
        internal static OSProfile DeserializeOSProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new OSProfile(linuxOperatingSystemProfile, serializedAdditionalRawData);
        }
