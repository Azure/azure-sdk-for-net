...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightApplicationHttpsEndpoint
    {
        ...
        internal HDInsightApplicationHttpsEndpoint(IList<string> accessModes, string endpointLocation, int? destinationPort, int? publicPort, IPAddress privateIPAddress, string subDomainSuffix, bool? disableGatewayAuth, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
