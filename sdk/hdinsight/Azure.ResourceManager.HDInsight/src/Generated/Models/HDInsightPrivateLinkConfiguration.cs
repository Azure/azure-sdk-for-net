...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightPrivateLinkConfiguration
    {
        ...
        internal HDInsightPrivateLinkConfiguration(string id, string name, ResourceType? resourceType, string groupId, HDInsightPrivateLinkConfigurationProvisioningState? provisioningState, IList<HDInsightIPConfiguration> ipConfigurations, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
