...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightAutoScaleRecurrence>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightAutoScaleRecurrence>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightAutoScaleRecurrence>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<HDInsightAutoScaleRecurrence>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
