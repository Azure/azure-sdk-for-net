...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightVersionSpec>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightVersionSpec>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightVersionSpec>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightVersionSpec>)} interface");
            }
        ...
        string IPersistableModel<HDInsightVersionSpec>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
