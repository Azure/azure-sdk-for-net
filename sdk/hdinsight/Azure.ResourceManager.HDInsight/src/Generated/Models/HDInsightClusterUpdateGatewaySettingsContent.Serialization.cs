...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightClusterUpdateGatewaySettingsContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightClusterUpdateGatewaySettingsContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightClusterUpdateGatewaySettingsContent>)} interface");
            }
        ...
        string IPersistableModel<HDInsightClusterUpdateGatewaySettingsContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
