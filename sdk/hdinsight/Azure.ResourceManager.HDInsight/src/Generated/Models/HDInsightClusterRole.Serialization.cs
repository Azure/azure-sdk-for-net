...
{
    public partial class HDInsightClusterRole : IUtf8JsonSerializable, IJsonModel<HDInsightClusterRole>, IPersistableModel<HDInsightClusterRole>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinInstanceCount))
            {
                ...
                builder.AppendLine($" '{MinInstanceCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(TargetInstanceCount))
            {
                builder.Append("  targetInstanceCount:");
                builder.AppendLine($" '{TargetInstanceCount.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(VirtualNetworkProfile))
            {
                ...
                AppendChildObject(builder, VirtualNetworkProfile, options, 2);
            }
