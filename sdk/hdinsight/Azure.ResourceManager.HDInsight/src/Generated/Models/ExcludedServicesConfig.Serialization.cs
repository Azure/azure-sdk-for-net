...
{
    public partial class ExcludedServicesConfig : IUtf8JsonSerializable, IJsonModel<ExcludedServicesConfig>, IPersistableModel<ExcludedServicesConfig>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExcludedServicesConfigId))
            {
                builder.Append("  excludedServicesConfigId:");
                builder.AppendLine($" '{ExcludedServicesConfigId}'");
            }

            if (Optional.IsDefined(ExcludedServicesList))
            {
                builder.Append("  excludedServicesList:");
                builder.AppendLine($" '{ExcludedServicesList}'");
            }
