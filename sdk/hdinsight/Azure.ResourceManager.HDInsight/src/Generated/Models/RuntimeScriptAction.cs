...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class RuntimeScriptAction
    {
        ...
        internal RuntimeScriptAction(string name, Uri uri, string parameters, IList<string> roles, string applicationName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Uri = uri;
