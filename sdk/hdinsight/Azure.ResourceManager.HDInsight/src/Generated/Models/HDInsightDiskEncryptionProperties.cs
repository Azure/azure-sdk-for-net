...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightDiskEncryptionProperties
    {
        ...
        internal HDInsightDiskEncryptionProperties(Uri vaultUri, string keyName, string keyVersion, JsonWebKeyEncryptionAlgorithm? encryptionAlgorithm, ResourceIdentifier msiResourceId, bool? isEncryptionAtHostEnabled, Dictionary<string, BinaryData> rawData)
        {
            VaultUri = vaultUri;
            KeyName = keyName;
