...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    internal partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            HDInsightPrivateLinkServiceConnectionState connectionState = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    connectionState = HDInsightPrivateLinkServiceConnectionState.DeserializeHDInsightPrivateLinkServiceConnectionState(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new HDInsightPrivateEndpointConnectionProvisioningState(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new PrivateEndpointConnectionProperties(privateEndpoint, connectionState, linkIdentifier, provisioningState, additionalBinaryDataProperties);
        }
    }
}
