...
{
    public partial class HDInsightPrivateLinkResourceData : Core.IUtf8JsonSerializable
    {
        ...
        internal static HDInsightPrivateLinkResourceData DeserializeHDInsightPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new HDInsightPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
