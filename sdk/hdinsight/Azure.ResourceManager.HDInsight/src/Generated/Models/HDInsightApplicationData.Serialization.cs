...
namespace Azure.ResourceManager.HDInsight
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightApplicationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightApplicationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightApplicationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightApplicationData>)} interface");
            }
        ...
        string IPersistableModel<HDInsightApplicationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
