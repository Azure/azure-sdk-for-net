        ...
        internal static Role DeserializeRole(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("autoscale"))
                {
                    ...
                    autoscale = Autoscale.DeserializeAutoscale(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("dataDisksGroups"))
                {
                    ...
                    List<DataDisksGroups> array = new List<DataDisksGroups>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(Models.DataDisksGroups.DeserializeDataDisksGroups(item));
                    }
