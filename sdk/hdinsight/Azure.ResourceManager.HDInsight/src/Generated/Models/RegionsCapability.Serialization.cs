...
{
    public partial class RegionsCapability : IUtf8JsonSerializable, IJsonModel<RegionsCapability>, IPersistableModel<RegionsCapability>
    {
        ...
        void IJsonModel<RegionsCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RegionsCapability)} does not support '{format}' format.");
            }
