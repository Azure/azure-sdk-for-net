    ...
    public partial class HDInsightAsyncOperationResult : IUtf8JsonSerializable, IJsonModel<HDInsightAsyncOperationResult>
    {
        ...
        internal static HDInsightAsyncOperationResult DeserializeHDInsightAsyncOperationResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResponseError>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), options, AzureResourceManagerHDInsightContext.Default)
#else
                ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), options, AzureResourceManagerHDInsightContext.Default)
#endif
;
                    continue;
                }
