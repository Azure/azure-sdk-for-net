...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    internal partial class ClusterListResult
    {
        ...
        internal ClusterListResult(IEnumerable<HDInsightClusterData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ClusterListResult(IList<HDInsightClusterData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<HDInsightClusterData> Value { get; }
