...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class ConnectivityEndpoint
    {
        ...
        internal ConnectivityEndpoint(string name, string protocol, string endpointLocation, int? port, IPAddress privateIPAddress, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Protocol = protocol;
