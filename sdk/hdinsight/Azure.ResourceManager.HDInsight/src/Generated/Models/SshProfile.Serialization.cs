...
{
    internal partial class SshProfile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SshProfile DeserializeSshProfile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
