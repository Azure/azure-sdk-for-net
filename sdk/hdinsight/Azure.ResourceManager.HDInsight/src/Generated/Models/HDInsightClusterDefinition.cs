...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightClusterDefinition
    {
        ...
        internal HDInsightClusterDefinition(string blueprint, string kind, IDictionary<string, string> componentVersion, BinaryData configurations, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Blueprint = blueprint;
            Kind = kind;
