...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        internal static ValidationErrorInfo DeserializeValidationErrorInfo(JsonElement element)
        {
            ...
            return new ValidationErrorInfo(code.Value, message.Value, errorResource.Value, Optional.ToList(messageArguments));
        }
    }
}
