...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RuntimeScriptActionDetail>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RuntimeScriptActionDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RuntimeScriptActionDetail>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RuntimeScriptActionDetail>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
