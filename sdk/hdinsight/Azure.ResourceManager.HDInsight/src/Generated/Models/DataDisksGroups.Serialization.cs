...
{
    public partial class DataDisksGroups : IUtf8JsonSerializable
    {
        ...
        internal static DataDisksGroups DeserializeDataDisksGroups(JsonElement element)
        {
            ...
            return new DataDisksGroups(Optional.ToNullable(disksPerNode), storageAccountType.Value, Optional.ToNullable(diskSizeGB));
        }
    }
}
