...
namespace Azure.ResourceManager.HDInsight
{
    public partial class HDInsightClusterData : IUtf8JsonSerializable, IJsonModel<HDInsightClusterData>
    {
        ...
        void IJsonModel<HDInsightClusterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(HDInsightClusterData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<HDInsightClusterData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(HDInsightClusterData)} does not support '{options.Format}' format.");
            }
        }
