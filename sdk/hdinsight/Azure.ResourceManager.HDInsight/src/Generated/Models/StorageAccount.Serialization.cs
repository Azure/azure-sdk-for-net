...
namespace Azure.ResourceManager.HDInsight.Models
{
    public partial class StorageAccount : IUtf8JsonSerializable
    {
        ...
        internal static StorageAccount DeserializeStorageAccount(JsonElement element)
        {
            ...
            return new StorageAccount(name.Value, Optional.ToNullable(isDefault), container.Value, fileSystem.Value, key.Value, resourceId.Value, msiResourceId.Value, saskey.Value, fileshare.Value);
        }
    }
}
