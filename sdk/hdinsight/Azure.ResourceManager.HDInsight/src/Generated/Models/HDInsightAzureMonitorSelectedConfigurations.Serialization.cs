...
{
    public partial class HDInsightAzureMonitorSelectedConfigurations : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HDInsightAzureMonitorSelectedConfigurations DeserializeHDInsightAzureMonitorSelectedConfigurations(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
