...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightApplicationEndpoint
    {
        ...
        internal HDInsightApplicationEndpoint(string endpointLocation, int? destinationPort, int? publicPort, IPAddress privateIPAddress, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
