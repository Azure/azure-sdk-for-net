...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightApplicationEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightApplicationEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightApplicationEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightApplicationEndpoint>)} interface");
            }
        ...
        string IPersistableModel<HDInsightApplicationEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
