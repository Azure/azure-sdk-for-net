...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightClusterUpdateIdentityCertificateContent
    {
        ...
        internal HDInsightClusterUpdateIdentityCertificateContent(string applicationId, string certificate, string certificatePassword, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
