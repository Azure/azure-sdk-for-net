...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RuntimeScriptAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RuntimeScriptAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RuntimeScriptAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RuntimeScriptAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
