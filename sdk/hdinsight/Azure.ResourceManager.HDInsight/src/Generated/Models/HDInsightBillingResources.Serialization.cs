...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightBillingResources>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightBillingResources>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightBillingResources>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightBillingResources>)} interface");
            }
        ...
        string IPersistableModel<HDInsightBillingResources>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
