...
{
    public partial class HDInsightBillingResources : IUtf8JsonSerializable, IJsonModel<HDInsightBillingResources>, IPersistableModel<HDInsightBillingResources>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(DiskBillingMeters))
            {
                builder.Append("  diskBillingMeters:");
                builder.AppendLine(" [");
                foreach (var item in DiskBillingMeters)
                {
                    AppendChildObject(builder, item, options, 4);
