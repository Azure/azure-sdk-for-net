...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        internal static HDInsightBillingResources DeserializeHDInsightBillingResources(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
