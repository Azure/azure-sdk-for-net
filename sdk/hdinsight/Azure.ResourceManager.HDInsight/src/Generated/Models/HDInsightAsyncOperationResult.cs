...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightAsyncOperationResult
    {
        ...
        internal HDInsightAsyncOperationResult(HDInsightAsyncOperationState? status, ResponseError error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Error = error;
