...
{
    public partial class AutoscaleCapacity : IUtf8JsonSerializable
    {
        ...
        internal static AutoscaleCapacity DeserializeAutoscaleCapacity(JsonElement element)
        {
            ...
            return new AutoscaleCapacity(Optional.ToNullable(minInstanceCount), Optional.ToNullable(maxInstanceCount));
        }
    }
}
