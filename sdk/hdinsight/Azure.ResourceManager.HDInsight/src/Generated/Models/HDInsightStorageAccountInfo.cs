...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightStorageAccountInfo
    {
        ...
        internal HDInsightStorageAccountInfo(string name, bool? isDefault, string container, string fileSystem, string key, ResourceIdentifier resourceId, ResourceIdentifier msiResourceId, string sasKey, string fileshare, bool? enableSecureChannel, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            IsDefault = isDefault;
            Container = container;
