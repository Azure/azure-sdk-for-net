...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegionalQuotaCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RegionalQuotaCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RegionalQuotaCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RegionalQuotaCapability>)} interface");
            }
        ...
        string IPersistableModel<RegionalQuotaCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
