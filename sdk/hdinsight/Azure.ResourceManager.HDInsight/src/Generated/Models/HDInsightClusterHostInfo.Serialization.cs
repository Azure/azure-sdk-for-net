...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        internal static HDInsightClusterHostInfo DeserializeHDInsightClusterHostInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
