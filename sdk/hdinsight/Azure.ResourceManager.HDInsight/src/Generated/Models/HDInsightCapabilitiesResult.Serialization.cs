...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        internal static HDInsightCapabilitiesResult DeserializeHDInsightCapabilitiesResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
