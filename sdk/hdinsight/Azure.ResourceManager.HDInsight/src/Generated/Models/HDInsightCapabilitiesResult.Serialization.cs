...
namespace Azure.ResourceManager.HDInsight.Models
{
    public partial class HDInsightCapabilitiesResult : IUtf8JsonSerializable, IModelJsonSerializable<HDInsightCapabilitiesResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<HDInsightCapabilitiesResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Versions))
            {
                ...
                foreach (var item in Versions)
                {
                    ...
                    {
                        ((IModelJsonSerializable<HDInsightVersionsCapability>)item.Value).Serialize(writer, options);
                    }
                }
            ...
            if (Optional.IsCollectionDefined(Regions))
            {
                ...
                foreach (var item in Regions)
                {
                    ...
                    {
                        ((IModelJsonSerializable<RegionsCapability>)item.Value).Serialize(writer, options);
                    }
                }
                writer.WriteEndObject();
            }
        ...
        /// <summary> Converts a <see cref="HDInsightCapabilitiesResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="HDInsightCapabilitiesResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="HDInsightCapabilitiesResult"/>. </summary>
