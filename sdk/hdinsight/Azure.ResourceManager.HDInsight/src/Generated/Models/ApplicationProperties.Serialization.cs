...
namespace Azure.ResourceManager.HDInsight.Models
{
    public partial class ApplicationProperties : IUtf8JsonSerializable
    {
        ...
        internal static ApplicationProperties DeserializeApplicationProperties(JsonElement element)
        {
            ...
            Optional<IList<ApplicationGetHttpsEndpoint>> httpsEndpoints = default;
            Optional<IList<ApplicationGetEndpoint>> sshEndpoints = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("httpsEndpoints"))
                {
                    ...
                    List<ApplicationGetHttpsEndpoint> array = new List<ApplicationGetHttpsEndpoint>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ApplicationGetHttpsEndpoint.DeserializeApplicationGetHttpsEndpoint(item));
                    }
                ...
                if (property.NameEquals("sshEndpoints"))
                {
                    ...
                    List<ApplicationGetEndpoint> array = new List<ApplicationGetEndpoint>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ApplicationGetEndpoint.DeserializeApplicationGetEndpoint(item));
                    }
                    sshEndpoints = array;
                    continue;
                }
            ...
            return new ApplicationProperties(computeProfile.Value, Optional.ToList(installScriptActions), Optional.ToList(uninstallScriptActions), Optional.ToList(httpsEndpoints), Optional.ToList(sshEndpoints), provisioningState.Value, applicationType.Value, applicationState.Value, Optional.ToList(errors), createdDate.Value, marketplaceIdentifier.Value, Optional.ToList(privateLinkConfigurations));
        }
    }
}
