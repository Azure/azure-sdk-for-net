...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightVersionsCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightVersionsCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightVersionsCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightVersionsCapability>)} interface");
            }
        ...
        string IPersistableModel<HDInsightVersionsCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
