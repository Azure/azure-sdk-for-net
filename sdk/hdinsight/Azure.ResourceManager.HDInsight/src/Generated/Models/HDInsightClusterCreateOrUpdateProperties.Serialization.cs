...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightClusterCreateOrUpdateProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightClusterCreateOrUpdateProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightClusterCreateOrUpdateProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightClusterCreateOrUpdateProperties>)} interface");
            }
        ...
        string IPersistableModel<HDInsightClusterCreateOrUpdateProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
