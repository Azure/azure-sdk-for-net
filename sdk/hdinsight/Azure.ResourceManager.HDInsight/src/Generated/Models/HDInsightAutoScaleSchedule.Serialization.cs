...
{
    public partial class HDInsightAutoScaleSchedule : IUtf8JsonSerializable, IJsonModel<HDInsightAutoScaleSchedule>, IPersistableModel<HDInsightAutoScaleSchedule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TimeAndCapacity))
            {
                ...
                AppendChildObject(builder, TimeAndCapacity, options, 2);
            }
