...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightBillingSpecsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightBillingSpecsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightBillingSpecsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightBillingSpecsListResult>)} interface");
            }
        ...
        string IPersistableModel<HDInsightBillingSpecsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
