...
{
    public partial class HDInsightSshPublicKey : IUtf8JsonSerializable, IJsonModel<HDInsightSshPublicKey>, IPersistableModel<HDInsightSshPublicKey>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CertificateData))
            {
                ...
                builder.AppendLine($" '{CertificateData}'");
            }
