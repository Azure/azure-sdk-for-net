...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AutoscaleTimeAndCapacity. </summary>
        ...
        internal AutoscaleTimeAndCapacity(string time, int? minInstanceCount, int? maxInstanceCount)
        {
            Time = time;
