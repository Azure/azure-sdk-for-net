...
{
    public partial class HDInsightClusterCreationValidateResult : IUtf8JsonSerializable, IJsonModel<HDInsightClusterCreationValidateResult>, IPersistableModel<HDInsightClusterCreationValidateResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ValidationWarnings))
            {
                builder.Append("  validationWarnings:");
                builder.AppendLine(" [");
                foreach (var item in ValidationWarnings)
                {
                    AppendChildObject(builder, item, options, 4);
            ...
            if (Optional.IsDefined(EstimatedCreationDuration))
            {
                builder.Append("  estimatedCreationDuration:");
                var formattedTimeSpan = XmlConvert.ToString(EstimatedCreationDuration.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }

            if (Optional.IsCollectionDefined(AaddsResourcesDetails))
            {
                builder.Append("  aaddsResourcesDetails:");
                builder.AppendLine(" [");
                foreach (var item in AaddsResourcesDetails)
                {
                    AppendChildObject(builder, item, options, 4);
