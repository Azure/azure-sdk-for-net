...
{
    public partial class HDInsightBillingMeters : IUtf8JsonSerializable, IJsonModel<HDInsightBillingMeters>, IPersistableModel<HDInsightBillingMeters>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MeterParameter))
            {
                builder.Append("  meterParameter:");
                builder.AppendLine($" '{MeterParameter}'");
            }

            if (Optional.IsDefined(Meter))
            {
                builder.Append("  meter:");
                builder.AppendLine($" '{Meter}'");
            }
