...
{
    public partial class HDInsightAzureMonitorExtensionStatus : IUtf8JsonSerializable, IJsonModel<HDInsightAzureMonitorExtensionStatus>, IPersistableModel<HDInsightAzureMonitorExtensionStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SelectedConfigurations))
            {
                builder.Append("  selectedConfigurations:");
                AppendChildObject(builder, SelectedConfigurations, options, 2);
            }
