...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        internal static ScriptActionExecutionSummary DeserializeScriptActionExecutionSummary(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
