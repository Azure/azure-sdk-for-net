...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightDiskBillingMeters>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightDiskBillingMeters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightDiskBillingMeters>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightDiskBillingMeters>)} interface");
            }
        ...
        string IPersistableModel<HDInsightDiskBillingMeters>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
