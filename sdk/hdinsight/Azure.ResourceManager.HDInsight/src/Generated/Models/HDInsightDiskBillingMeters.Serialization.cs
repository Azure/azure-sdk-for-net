...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        internal static HDInsightDiskBillingMeters DeserializeHDInsightDiskBillingMeters(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
