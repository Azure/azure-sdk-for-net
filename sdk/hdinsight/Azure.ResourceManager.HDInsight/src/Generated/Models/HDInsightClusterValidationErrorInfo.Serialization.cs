...
{
    public partial class HDInsightClusterValidationErrorInfo : IUtf8JsonSerializable, IJsonModel<HDInsightClusterValidationErrorInfo>, IPersistableModel<HDInsightClusterValidationErrorInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ErrorResource))
            {
                builder.Append("  errorResource:");
                builder.AppendLine($" '{ErrorResource}'");
            }

            if (Optional.IsCollectionDefined(MessageArguments))
            {
                builder.Append("  messageArguments:");
                builder.AppendLine(" [");
                foreach (var item in MessageArguments)
                {
                    if (item == null)
