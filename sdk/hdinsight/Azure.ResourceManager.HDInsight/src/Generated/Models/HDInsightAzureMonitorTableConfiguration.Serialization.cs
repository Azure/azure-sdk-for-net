...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightAzureMonitorTableConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightAzureMonitorTableConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightAzureMonitorTableConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightAzureMonitorTableConfiguration>)} interface");
            }
        ...
        string IPersistableModel<HDInsightAzureMonitorTableConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
