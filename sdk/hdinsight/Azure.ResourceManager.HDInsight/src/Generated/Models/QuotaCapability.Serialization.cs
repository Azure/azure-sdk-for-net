...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QuotaCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QuotaCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QuotaCapability>)} interface");
            }
        ...
        string IPersistableModel<QuotaCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
