...
{
    public partial class QuotaCapability : IUtf8JsonSerializable, IJsonModel<QuotaCapability>, IPersistableModel<QuotaCapability>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxCoresAllowed))
            {
                builder.Append("  maxCoresAllowed:");
                builder.AppendLine($" '{MaxCoresAllowed.Value.ToString()}'");
            }

            if (Optional.IsCollectionDefined(RegionalQuotas))
            {
                builder.Append("  regionalQuotas:");
                builder.AppendLine(" [");
                foreach (var item in RegionalQuotas)
                {
