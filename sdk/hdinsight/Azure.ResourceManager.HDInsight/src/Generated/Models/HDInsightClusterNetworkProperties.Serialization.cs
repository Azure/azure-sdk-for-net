...
{
    public partial class HDInsightClusterNetworkProperties : IUtf8JsonSerializable, IJsonModel<HDInsightClusterNetworkProperties>, IPersistableModel<HDInsightClusterNetworkProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResourceProviderConnection))
            {
                builder.Append("  resourceProviderConnection:");
                builder.AppendLine($" '{ResourceProviderConnection.ToString()}'");
            }

            if (Optional.IsDefined(PrivateLink))
            {
                builder.Append("  privateLink:");
                builder.AppendLine($" '{PrivateLink.ToString()}'");
            }
