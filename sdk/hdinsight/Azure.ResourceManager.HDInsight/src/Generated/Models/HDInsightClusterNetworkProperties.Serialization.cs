...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightClusterNetworkProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightClusterNetworkProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightClusterNetworkProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightClusterNetworkProperties>)} interface");
            }
        ...
        string IPersistableModel<HDInsightClusterNetworkProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
