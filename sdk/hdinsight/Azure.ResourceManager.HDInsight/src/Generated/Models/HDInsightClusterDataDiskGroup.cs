...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightClusterDataDiskGroup
    {
        ...
        internal HDInsightClusterDataDiskGroup(int? disksPerNode, string storageAccountType, int? diskSizeInGB, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
