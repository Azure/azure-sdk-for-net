...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightPrivateLinkServiceConnectionState
    {
        ...
        internal HDInsightPrivateLinkServiceConnectionState(HDInsightPrivateLinkServiceConnectionStatus status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
