...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ValidationErrorInfo. </summary>
        ...
        internal ValidationErrorInfo(string code, string message, string errorResource, IReadOnlyList<string> messageArguments)
        {
            Code = code;
            Message = message;
