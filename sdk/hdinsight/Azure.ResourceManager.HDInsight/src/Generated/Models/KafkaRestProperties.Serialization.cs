...
{
    public partial class KafkaRestProperties : IUtf8JsonSerializable, IJsonModel<KafkaRestProperties>, IPersistableModel<KafkaRestProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClientGroupInfo))
            {
                builder.Append("  clientGroupInfo:");
                AppendChildObject(builder, ClientGroupInfo, options, 2);
            }

            if (Optional.IsCollectionDefined(ConfigurationOverride))
            {
                builder.Append("  configurationOverride:");
                builder.AppendLine(" {");
                foreach (var item in ConfigurationOverride)
                {
