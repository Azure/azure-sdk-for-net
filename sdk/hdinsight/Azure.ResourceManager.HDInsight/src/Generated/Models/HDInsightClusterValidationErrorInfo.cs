...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightClusterValidationErrorInfo
    {
        ...
        internal HDInsightClusterValidationErrorInfo(string code, string message, string errorResource, IReadOnlyList<string> messageArguments, Dictionary<string, BinaryData> rawData)
        {
            Code = code;
            Message = message;
