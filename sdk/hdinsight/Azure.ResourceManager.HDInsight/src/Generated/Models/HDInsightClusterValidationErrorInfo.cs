...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightClusterValidationErrorInfo
    {
        ...
        internal HDInsightClusterValidationErrorInfo(string code, string message, string errorResource, IReadOnlyList<string> messageArguments, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
