...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightSecurityProfile
    {
        ...
        internal HDInsightSecurityProfile(AuthenticationDirectoryType? directoryType, string domain, string organizationalUnitDN, IList<Uri> ldapUris, string domainUsername, string domainUserPassword, IList<string> clusterUsersGroupDNs, ResourceIdentifier aaddsResourceId, ResourceIdentifier msiResourceId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
