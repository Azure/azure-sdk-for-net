...
{
    public partial class HDInsightClusterDataDiskGroup : IUtf8JsonSerializable, IJsonModel<HDInsightClusterDataDiskGroup>, IPersistableModel<HDInsightClusterDataDiskGroup>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DisksPerNode))
            {
                builder.Append("  disksPerNode:");
                builder.AppendLine($" '{DisksPerNode.Value.ToString()}'");
            }
