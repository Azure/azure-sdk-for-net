...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightClusterCreateOrUpdateContent
    {
        ...
        internal HDInsightClusterCreateOrUpdateContent(AzureLocation? location, IDictionary<string, string> tags, IList<string> zones, HDInsightClusterCreateOrUpdateProperties properties, ManagedServiceIdentity identity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Tags = tags;
            Zones = zones;
