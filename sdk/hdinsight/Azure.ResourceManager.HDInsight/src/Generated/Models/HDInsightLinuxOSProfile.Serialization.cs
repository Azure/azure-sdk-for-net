...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightLinuxOSProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightLinuxOSProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightLinuxOSProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightLinuxOSProfile>)} interface");
            }
        ...
        string IPersistableModel<HDInsightLinuxOSProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
