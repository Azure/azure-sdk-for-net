...
{
    public partial class HDInsightClusterProperties : IUtf8JsonSerializable, IJsonModel<HDInsightClusterProperties>, IPersistableModel<HDInsightClusterProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClusterDefinition))
            {
                ...
                AppendChildObject(builder, ClusterDefinition, options, 2);
            }

            if (Optional.IsDefined(KafkaRestProperties))
            {
                builder.Append("  kafkaRestProperties:");
                AppendChildObject(builder, KafkaRestProperties, options, 2);
            }
            ...
            if (Optional.IsDefined(QuotaInfo))
            {
                ...
                AppendChildObject(builder, QuotaInfo, options, 2);
            }
            ...
            if (Optional.IsDefined(DiskEncryptionProperties))
            {
                ...
                AppendChildObject(builder, DiskEncryptionProperties, options, 2);
            }

            if (Optional.IsDefined(EncryptionInTransitProperties))
            {
                builder.Append("  encryptionInTransitProperties:");
                AppendChildObject(builder, EncryptionInTransitProperties, options, 2);
            }
            ...
            if (Optional.IsDefined(ExcludedServicesConfig))
            {
                ...
                AppendChildObject(builder, ExcludedServicesConfig, options, 2);
            }

            if (Optional.IsDefined(NetworkProperties))
            {
                builder.Append("  networkProperties:");
                AppendChildObject(builder, NetworkProperties, options, 2);
            }

            if (Optional.IsDefined(ComputeIsolationProperties))
            {
                builder.Append("  computeIsolationProperties:");
                AppendChildObject(builder, ComputeIsolationProperties, options, 2);
            }
