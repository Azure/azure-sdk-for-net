...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightClusterProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightClusterProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightClusterProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightClusterProperties>)} interface");
            }
        ...
        string IPersistableModel<HDInsightClusterProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
