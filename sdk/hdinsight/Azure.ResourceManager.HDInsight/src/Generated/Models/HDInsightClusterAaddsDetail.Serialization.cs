...
{
    public partial class HDInsightClusterAaddsDetail : IUtf8JsonSerializable, IJsonModel<HDInsightClusterAaddsDetail>, IPersistableModel<HDInsightClusterAaddsDetail>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsInitialSyncComplete))
            {
                builder.Append("  initialSyncComplete:");
                var boolValue = IsInitialSyncComplete.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsLdapsEnabled))
            {
                builder.Append("  ldapsEnabled:");
                var boolValue = IsLdapsEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(LdapsPublicCertificateInBase64))
            {
                builder.Append("  ldapsPublicCertificateInBase64:");
                builder.AppendLine($" '{LdapsPublicCertificateInBase64}'");
            }
