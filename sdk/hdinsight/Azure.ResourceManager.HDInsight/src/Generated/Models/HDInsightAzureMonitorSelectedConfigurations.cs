...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightAzureMonitorSelectedConfigurations
    {
        ...
        internal HDInsightAzureMonitorSelectedConfigurations(string configurationVersion, IDictionary<string, string> globalConfigurations, IList<HDInsightAzureMonitorTableConfiguration> tableList, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
