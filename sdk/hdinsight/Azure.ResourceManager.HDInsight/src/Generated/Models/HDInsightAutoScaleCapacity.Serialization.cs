...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightAutoScaleCapacity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HDInsightAutoScaleCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightAutoScaleCapacity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightAutoScaleCapacity>)} interface");
            }
        ...
        string IPersistableModel<HDInsightAutoScaleCapacity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
