...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class QuotaCapability
    {
        ...
        internal QuotaCapability(long? coresUsed, long? maxCoresAllowed, IReadOnlyList<RegionalQuotaCapability> regionalQuotas, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CoresUsed = coresUsed;
