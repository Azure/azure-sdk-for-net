...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightCapabilitiesResult
    {
        ...
        internal HDInsightCapabilitiesResult(IReadOnlyDictionary<string, HDInsightVersionsCapability> versions, IReadOnlyDictionary<string, RegionsCapability> regions, IReadOnlyList<string> features, QuotaCapability quota, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Versions = versions;
            Regions = regions;
            Features = features;
