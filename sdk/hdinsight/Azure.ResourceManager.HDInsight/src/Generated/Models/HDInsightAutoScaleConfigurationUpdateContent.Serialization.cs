...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HDInsightAutoScaleConfigurationUpdateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HDInsightAutoScaleConfigurationUpdateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HDInsightAutoScaleConfigurationUpdateContent>)} interface");
            }
        ...
        string IPersistableModel<HDInsightAutoScaleConfigurationUpdateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
