...
namespace Azure.ResourceManager.HDInsight.Models
{
    public partial class SecurityProfile : IUtf8JsonSerializable
    {
        ...
        internal static SecurityProfile DeserializeSecurityProfile(JsonElement element)
        {
            ...
            return new SecurityProfile(Optional.ToNullable(directoryType), domain.Value, organizationalUnitDN.Value, Optional.ToList(ldapsUrls), domainUsername.Value, domainUserPassword.Value, Optional.ToList(clusterUsersGroupDNs), aaddsResourceId.Value, msiResourceId.Value);
        }
    }
}
