...
namespace Azure.ResourceManager.HDInsight.Models
{
    ...
    public partial class HDInsightApplicationProperties : IJsonModel<HDInsightApplicationProperties>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HDInsightApplicationProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HDInsightApplicationProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HDInsightApplicationProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HDInsightApplicationProperties IPersistableModel<HDInsightApplicationProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(InstallScriptActions))
            {
                ...
                foreach (RuntimeScriptAction item in InstallScriptActions)
                {
            ...
            if (Optional.IsCollectionDefined(UninstallScriptActions))
            {
                ...
                writer.WriteStartArray();
                foreach (RuntimeScriptAction item in UninstallScriptActions)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
            ...
            if (Optional.IsCollectionDefined(HttpsEndpoints))
            {
                ...
                writer.WriteStartArray();
                foreach (HDInsightApplicationHttpsEndpoint item in HttpsEndpoints)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
            ...
            if (Optional.IsCollectionDefined(SshEndpoints))
            {
                ...
                writer.WriteStartArray();
                foreach (HDInsightApplicationEndpoint item in SshEndpoints)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HDInsightApplicationProperties IJsonModel<HDInsightApplicationProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual HDInsightApplicationProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<HDInsightApplicationProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HDInsightApplicationProperties DeserializeHDInsightApplicationProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("installScriptActions"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                ...
                if (prop.NameEquals("uninstallScriptActions"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                ...
                if (prop.NameEquals("httpsEndpoints"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                ...
                if (prop.NameEquals("sshEndpoints"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                ...
                if (prop.NameEquals("applicationState"u8))
                {
                    applicationState = prop.Value.GetString();
                    continue;
                }
                ...
                {
                    marketplaceIdentifier = prop.Value.GetString();
                    continue;
                }
