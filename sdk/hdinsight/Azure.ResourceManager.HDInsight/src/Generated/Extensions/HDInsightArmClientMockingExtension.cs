...
namespace Azure.ResourceManager.HDInsight.Mocking
{
    ...
    internal partial class HDInsightArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HDInsightArmClientMockingExtension"/> class for mocking. </summary>
        protected HDInsightArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HDInsightArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HDInsightArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal HDInsightArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
