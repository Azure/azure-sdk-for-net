...
namespace Azure.ResourceManager.HDInsight
{
    ...
    public static partial class HDInsightExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetHDInsightClusters();
        }
        ...
        {
            return await GetSubscriptionResourceExtension(subscriptionResource).GetHDInsightCapabilitiesAsync(location, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetHDInsightCapabilities(location, cancellationToken);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetHDInsightUsagesAsync(location, cancellationToken);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetHDInsightUsages(location, cancellationToken);
        }
        ...
        {
            return await GetSubscriptionResourceExtension(subscriptionResource).GetHDInsightBillingSpecsAsync(location, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetHDInsightBillingSpecs(location, cancellationToken);
        }
        ...
        public static async Task<Response<HDInsightNameAvailabilityResult>> CheckHDInsightNameAvailabilityAsync(this SubscriptionResource subscriptionResource, AzureLocation location, HDInsightNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetSubscriptionResourceExtension(subscriptionResource).CheckHDInsightNameAvailabilityAsync(location, content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<HDInsightNameAvailabilityResult> CheckHDInsightNameAvailability(this SubscriptionResource subscriptionResource, AzureLocation location, HDInsightNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).CheckHDInsightNameAvailability(location, content, cancellationToken);
        }
        ...
        public static async Task<Response<HDInsightClusterCreationValidateResult>> ValidateHDInsightClusterCreationAsync(this SubscriptionResource subscriptionResource, AzureLocation location, HDInsightClusterCreationValidateContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetSubscriptionResourceExtension(subscriptionResource).ValidateHDInsightClusterCreationAsync(location, content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<HDInsightClusterCreationValidateResult> ValidateHDInsightClusterCreation(this SubscriptionResource subscriptionResource, AzureLocation location, HDInsightClusterCreationValidateContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).ValidateHDInsightClusterCreation(location, content, cancellationToken);
        }
    }
}
