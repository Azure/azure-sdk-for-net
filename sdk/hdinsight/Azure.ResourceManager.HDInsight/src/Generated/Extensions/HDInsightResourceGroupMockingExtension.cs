...
namespace Azure.ResourceManager.HDInsight.Mocking
{
    ...
    internal partial class HDInsightResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HDInsightResourceGroupMockingExtension"/> class for mocking. </summary>
        protected HDInsightResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HDInsightResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HDInsightResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
