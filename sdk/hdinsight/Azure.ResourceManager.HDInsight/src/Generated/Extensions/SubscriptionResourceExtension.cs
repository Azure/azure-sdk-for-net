...
namespace Azure.ResourceManager.HDInsight.Mock
{
    ...
    public partial class SubscriptionResourceExtension : ArmResource
    {
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("SubscriptionResourceExtension.GetHDInsightCapabilities");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<HDInsightUsage> GetHDInsightUsagesAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, HDInsightUsage.DeserializeHDInsightUsage, LocationsClientDiagnostics, Pipeline, "SubscriptionResourceExtension.GetHDInsightUsages", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => LocationsRestClient.CreateListUsagesRequest(Id.SubscriptionId, location);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, HDInsightUsage.DeserializeHDInsightUsage, LocationsClientDiagnostics, Pipeline, "SubscriptionResourceExtension.GetHDInsightUsages", "value", null, cancellationToken);
        }
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("SubscriptionResourceExtension.GetHDInsightBillingSpecs");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<HDInsightNameAvailabilityResult>> CheckHDInsightNameAvailabilityAsync(AzureLocation location, HDInsightNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = LocationsClientDiagnostics.CreateScope("SubscriptionResourceExtension.CheckHDInsightNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<HDInsightClusterCreationValidateResult>> ValidateHDInsightClusterCreationAsync(AzureLocation location, HDInsightClusterCreationValidateContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = LocationsClientDiagnostics.CreateScope("SubscriptionResourceExtension.ValidateHDInsightClusterCreation");
            scope.Start();
            try
            {
