...
{
    /// <summary></summary>
    internal partial class HDInsightPrivateEndpointConnectionResourceOperationSource : IOperationSource<HDInsightPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HDInsightPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
