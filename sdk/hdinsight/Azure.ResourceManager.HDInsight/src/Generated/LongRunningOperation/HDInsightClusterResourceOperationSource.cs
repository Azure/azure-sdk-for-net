...
{
    /// <summary></summary>
    internal partial class HDInsightClusterResourceOperationSource : IOperationSource<HDInsightClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HDInsightClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
