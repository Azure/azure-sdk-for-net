...
namespace Azure.ResourceManager.HDInsight
{
    ...
    public partial class HDInsightClusterResource : ArmResource
    {
        ...
        internal HDInsightClusterResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _extensionsRestClient = new Extensions(_extensionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, hdInsightClusterApiVersion ?? "2025-01-15-preview");
            _scriptActionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.HDInsight", ResourceType.Namespace, Diagnostics);
            _scriptActionsRestClient = new ScriptActions(_scriptActionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, hdInsightClusterApiVersion ?? "2025-01-15-preview");
            ...
            _scriptExecutionHistoryRestClient = new ScriptExecutionHistory(_scriptExecutionHistoryClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, hdInsightClusterApiVersion ?? "2025-01-15-preview");
            ...
            _virtualMachinesRestClient = new VirtualMachines(_virtualMachinesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, hdInsightClusterApiVersion ?? "2025-01-15-preview");
        ...
        public virtual async Task<Response<HDInsightAsyncOperationResult>> GetAsyncOperationStatusAsync(string operationId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _hdInsightClusterRestClient.CreateGetAsyncOperationStatusRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, operationId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation> UpdateConfigurationAsync(WaitUntil waitUntil, string configurationName, IDictionary<string, string> clusterConfiguration, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _configurationsRestClient.CreateUpdateConfigurationRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, configurationName, BinaryContentHelper.FromDictionary(clusterConfiguration), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation> RestartVirtualMachineHostsAsync(WaitUntil waitUntil, IEnumerable<string> content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _virtualMachinesRestClient.CreateRestartVirtualMachineHostsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, BinaryContentHelper.FromEnumerable(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<ArmOperation<HDInsightClusterResource>> UpdateAsync(WaitUntil waitUntil, HDInsightClusterCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                ...
                HttpMessage message = _hdInsightClusterRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, HDInsightClusterCreateOrUpdateContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HDInsightClusterResource> Update(WaitUntil waitUntil, HDInsightClusterCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
