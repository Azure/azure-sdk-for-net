...
{
    internal partial class MicrosoftHDInsightVirtualMachinesListHostsCollectionResultOfT : Pageable<HDInsightClusterHostInfo>
    {
        ...
        /// <summary> Initializes a new instance of MicrosoftHDInsightVirtualMachinesListHostsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MicrosoftHDInsightVirtualMachinesListHostsCollectionResultOfT(VirtualMachines client, string subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MicrosoftHDInsightVirtualMachinesListHostsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MicrosoftHDInsightVirtualMachinesListHostsCollectionResultOfT as an enumerable collection. </returns>
