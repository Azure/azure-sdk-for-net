...
namespace Azure.ResourceManager.HDInsight
{
    internal partial class ClustersGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<HDInsightClusterData>
    {
        ...
        public ClustersGetByResourceGroupAsyncCollectionResultOfT(Clusters client, string subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
