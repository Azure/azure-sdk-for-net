...
namespace Azure.ResourceManager.HDInsight
{
    internal partial class ScriptActionsGetByClusterAsyncCollectionResultOfT : AsyncPageable<RuntimeScriptActionDetail>
    {
        ...
        public ScriptActionsGetByClusterAsyncCollectionResultOfT(ScriptActions client, string subscriptionId, string resourceGroupName, string clusterName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<RuntimeScriptActionDetail>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                ScriptActionsList result = ScriptActionsList.FromResponse(response);
                yield return Page<RuntimeScriptActionDetail>.FromValues((IReadOnlyList<RuntimeScriptActionDetail>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("ClusterResource.GetByCluster");
            scope.Start();
            try
            {
