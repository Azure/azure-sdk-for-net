...
{
    internal partial class PrivateLinkResourcesGetByClusterAsyncCollectionResultOfT : AsyncPageable<HDInsightPrivateLinkResourceData>
    {
        ...
        public PrivateLinkResourcesGetByClusterAsyncCollectionResultOfT(PrivateLinkResources client, string subscriptionId, string resourceGroupName, string clusterName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
