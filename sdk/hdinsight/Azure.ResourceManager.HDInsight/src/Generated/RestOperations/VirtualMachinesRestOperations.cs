...
namespace Azure.ResourceManager.HDInsight
{
    internal partial class VirtualMachinesRestOperations
    {
        ...
        public async Task<Response> RestartHostsAsync(HttpMessage message, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="message"/> is null. </exception>
        public Response RestartHosts(HttpMessage message, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(message, nameof(message));
