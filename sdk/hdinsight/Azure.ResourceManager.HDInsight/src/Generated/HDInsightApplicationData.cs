...
namespace Azure.ResourceManager.HDInsight
{
    ...
    public partial class HDInsightApplicationData : ResourceData
    {
        ...
        internal HDInsightApplicationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? etag, IDictionary<string, string> tags, HDInsightApplicationProperties properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
            Tags = tags;
