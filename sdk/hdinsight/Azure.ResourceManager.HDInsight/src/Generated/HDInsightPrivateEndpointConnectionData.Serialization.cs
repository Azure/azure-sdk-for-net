...
namespace Azure.ResourceManager.HDInsight
{
    public partial class HDInsightPrivateEndpointConnectionData : IUtf8JsonSerializable, IJsonModel<HDInsightPrivateEndpointConnectionData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            ((IJsonModel<HDInsightPrivateLinkServiceConnectionState>)ConnectionState).Write(writer, options);
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            privateLinkServiceConnectionState = ModelSerializationExtensions.JsonDeserialize<HDInsightPrivateLinkServiceConnectionState>(property0.Value);
                            continue;
                        }
