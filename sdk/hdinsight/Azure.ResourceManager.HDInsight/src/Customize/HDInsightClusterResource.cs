...
{
    // These operations were suppressed during TypeSpec migration via @@scope(..., "!csharp")
    // because they use extra path segments (e.g. /configurations/{name}, /extensions/{name},
    // /azureasyncoperations/{id}) that create phantom sub-resources in the generated code.
    // They are re-implemented here as custom code on the partial class for backward compatibility.
