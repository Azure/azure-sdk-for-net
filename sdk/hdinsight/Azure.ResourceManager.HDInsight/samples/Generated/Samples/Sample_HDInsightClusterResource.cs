...
["key2"] = "val2"
        ...
        public async Task Resize_ResizeTheWorkerNodesForAHadoopOnLinuxCluster()
        {
            ...
            await hdInsightCluster.ResizeAsync(WaitUntil.Completed, roleName, content).ConfigureAwait(false);
        ...
        public async Task UpdateAutoScaleConfiguration_DisableAutoscaleForTheHDInsightCluster()
        {
            ...
            await hdInsightCluster.UpdateAutoScaleConfigurationAsync(WaitUntil.Completed, roleName, content).ConfigureAwait(false);
...
MaxInstanceCount = 4,
        ...
        public async Task RotateDiskEncryptionKey_RotateDiskEncryptionKeyOfTheSpecifiedHDInsightCluster()
        {
            ...
            await hdInsightCluster.RotateDiskEncryptionKeyAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task UpdateGatewaySettings_EnableHTTPConnectivity()
        {
            ...
            await hdInsightCluster.UpdateGatewaySettingsAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task UpdateIdentityCertificate_UpdateClusterIdentityCertificate()
        {
            ...
            await hdInsightCluster.UpdateIdentityCertificateAsync(WaitUntil.Completed, content).ConfigureAwait(false);
...
Parameters = "",
            ...
            await hdInsightCluster.ExecuteScriptActionsAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task UpdateConfiguration_DisableHTTPConnectivity()
        {
            ...
            await hdInsightCluster.UpdateConfigurationAsync(WaitUntil.Completed, configurationName, clusterConfiguration).ConfigureAwait(false);
        ...
        public async Task EnableClusterMonitoringExtension_EnableClusterMonitoring()
        {
            ...
            await hdInsightCluster.EnableClusterMonitoringExtensionAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task DisableClusterMonitoringExtension_DisableClusterMonitoring()
        {
            ...
            // invoke the operation
            await hdInsightCluster.DisableClusterMonitoringExtensionAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task EnableAzureMonitorExtension_EnableAzureMonitor()
        {
            ...
            await hdInsightCluster.EnableAzureMonitorExtensionAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task DisableAzureMonitorExtension_DisableAzureMonitor()
        {
            ...
            // invoke the operation
            await hdInsightCluster.DisableAzureMonitorExtensionAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task EnableAzureMonitorAgentExtension_EnableAzureMonitoringAgent()
        {
            ...
            await hdInsightCluster.EnableAzureMonitorAgentExtensionAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task DisableAzureMonitorAgentExtension_DisableAzureMonitorAgent()
        {
            ...
            // invoke the operation
            await hdInsightCluster.DisableAzureMonitorAgentExtensionAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task CreateExtension_CreateAMonitoringExtensionOnHadoopLinuxCluster()
        {
            ...
            await hdInsightCluster.CreateExtensionAsync(WaitUntil.Completed, extensionName, content).ConfigureAwait(false);
        ...
        public async Task DeleteExtension_DeleteAnExtension()
        {
            ...
            // invoke the operation
            string extensionName = "clustermonitoring";
            await hdInsightCluster.DeleteExtensionAsync(WaitUntil.Completed, extensionName).ConfigureAwait(false);
        ...
        public async Task DeleteScriptAction_DeleteAScriptActionOnHDInsightCluster()
        {
            ...
            await hdInsightCluster.DeleteScriptActionAsync(scriptName).ConfigureAwait(false);
        ...
        public async Task PromoteScriptExecutionHistory_PromoteAScriptActionOnHDInsightCluster()
        {
            ...
            // invoke the operation
            string scriptExecutionId = "391145124054712";
            await hdInsightCluster.PromoteScriptExecutionHistoryAsync(scriptExecutionId).ConfigureAwait(false);
        ...
        public async Task RestartVirtualMachineHosts_RestartsTheSpecifiedHDInsightClusterHosts()
        {
            ...
            await hdInsightCluster.RestartVirtualMachineHostsAsync(WaitUntil.Completed, content).ConfigureAwait(false);
