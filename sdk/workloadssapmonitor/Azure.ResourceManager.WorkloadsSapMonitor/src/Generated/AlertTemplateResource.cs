...
namespace Azure.ResourceManager.WorkloadsSapMonitor
{
    ...
    public partial class AlertTemplateResource : ArmResource
    {
        ...
        /// <param name="alertTemplateName"> The alertTemplateName. </param>
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string resourceGroupName, string monitorName, string alertTemplateName)
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Workloads/monitors/{monitorName}/alertTemplates/{alertTemplateName}";
