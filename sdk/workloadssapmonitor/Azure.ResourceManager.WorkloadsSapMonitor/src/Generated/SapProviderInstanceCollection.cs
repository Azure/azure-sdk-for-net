...
namespace Azure.ResourceManager.WorkloadsSapMonitor
{
    ...
    public partial class SapProviderInstanceCollection : ArmCollection, IEnumerable<SapProviderInstanceResource>, IAsyncEnumerable<SapProviderInstanceResource>
    {
        ...
        /// <summary> Initializes a new instance of SapProviderInstanceCollection for mocking. </summary>
        protected SapProviderInstanceCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="SapProviderInstanceCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(SapProviderInstanceResource.ResourceType, out string sapProviderInstanceApiVersion);
            _providerInstancesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.WorkloadsSapMonitor", SapProviderInstanceResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SapProviderInstanceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string providerInstanceName, SapProviderInstanceData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _providerInstancesClientDiagnostics.CreateScope("SapProviderInstanceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _providerInstancesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, providerInstanceName, SapProviderInstanceData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<SapProviderInstanceResource>> GetAsync(string providerInstanceName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _providerInstancesClientDiagnostics.CreateScope("SapProviderInstanceCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _providerInstancesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, providerInstanceName, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ProviderInstances_ListByMonitor. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-02-01-preview. </description>
        ...
        public virtual AsyncPageable<SapProviderInstanceResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SapProviderInstanceData, SapProviderInstanceResource>(new ProviderInstancesGetByMonitorAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "SapProviderInstanceCollection.GetAll"), data => new SapProviderInstanceResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string providerInstanceName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _providerInstancesClientDiagnostics.CreateScope("SapProviderInstanceCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<SapProviderInstanceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(SapProviderInstanceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((SapProviderInstanceData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<SapProviderInstanceResource>> GetIfExistsAsync(string providerInstanceName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _providerInstancesClientDiagnostics.CreateScope("SapProviderInstanceCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
