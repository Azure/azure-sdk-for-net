...
namespace Azure.ResourceManager.WorkloadsSapMonitor.Models
{
    ...
    public partial class HanaDBProviderInstanceProperties : SapProviderInstanceSpecificProperties, IJsonModel<HanaDBProviderInstanceProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HanaDBProviderInstanceProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HanaDBProviderInstanceProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HanaDBProviderInstanceProperties IPersistableModel<HanaDBProviderInstanceProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (HanaDBProviderInstanceProperties)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HanaDBProviderInstanceProperties IJsonModel<HanaDBProviderInstanceProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HanaDBProviderInstanceProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HanaDBProviderInstanceProperties DeserializeHanaDBProviderInstanceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("sqlPort"u8))
                {
                    sqlPort = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("instanceNumber"u8))
                {
                    instanceNumber = prop.Value.GetString();
                    continue;
                }
                ...
                if (prop.NameEquals("sslHostNameInCertificate"u8))
                {
                    sslHostNameInCertificate = prop.Value.GetString();
                    continue;
                }
