...
namespace Azure.ResourceManager.WorkloadsSapMonitor.Models
{
    ...
    public partial class SapNetWeaverProviderInstanceProperties : ProviderSpecificProperties
    {
        ...
        internal SapNetWeaverProviderInstanceProperties(string providerType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string sapSid, string sapHostname, string sapInstanceNr, IList<string> sapHostFileEntries, string sapUsername, string sapPassword, Uri sapPasswordUri, string sapClientId, string sapPortNumber, Uri sslCertificateUri, SapSslPreference? sslPreference) : base(providerType, additionalBinaryDataProperties)
        {
            SapSid = sapSid;
