...
namespace Azure.ResourceManager.WorkloadsSapMonitor.Models
{
    ...
    public partial class MsSqlServerProviderInstanceProperties : ProviderSpecificProperties, IJsonModel<MsSqlServerProviderInstanceProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MsSqlServerProviderInstanceProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MsSqlServerProviderInstanceProperties IPersistableModel<MsSqlServerProviderInstanceProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MsSqlServerProviderInstanceProperties)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MsSqlServerProviderInstanceProperties IJsonModel<MsSqlServerProviderInstanceProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MsSqlServerProviderInstanceProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MsSqlServerProviderInstanceProperties DeserializeMsSqlServerProviderInstanceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string providerType = "MsSqlServer";
