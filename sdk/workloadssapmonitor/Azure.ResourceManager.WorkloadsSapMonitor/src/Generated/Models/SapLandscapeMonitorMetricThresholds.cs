...
namespace Azure.ResourceManager.WorkloadsSapMonitor.Models
{
    ...
    public partial class SapLandscapeMonitorMetricThresholds
    {
        ...
        internal SapLandscapeMonitorMetricThresholds(string name, float? green, float? yellow, float? red, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Green = green;
            Yellow = yellow;
