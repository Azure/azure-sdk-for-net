...
namespace Azure.ResourceManager.WorkloadsSapMonitor.Models
{
    ...
    public partial class DB2ProviderInstanceProperties : SapProviderInstanceSpecificProperties, IJsonModel<DB2ProviderInstanceProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DB2ProviderInstanceProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DB2ProviderInstanceProperties IPersistableModel<DB2ProviderInstanceProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (DB2ProviderInstanceProperties)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DB2ProviderInstanceProperties IJsonModel<DB2ProviderInstanceProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DB2ProviderInstanceProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DB2ProviderInstanceProperties DeserializeDB2ProviderInstanceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            string providerType = "Db2";
