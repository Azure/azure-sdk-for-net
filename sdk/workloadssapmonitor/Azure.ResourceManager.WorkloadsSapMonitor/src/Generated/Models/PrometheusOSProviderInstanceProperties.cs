...
namespace Azure.ResourceManager.WorkloadsSapMonitor.Models
{
    ...
    public partial class PrometheusOSProviderInstanceProperties : SapProviderInstanceSpecificProperties
    {
        ...
        internal PrometheusOSProviderInstanceProperties(string providerType, IDictionary<string, BinaryData> additionalBinaryDataProperties, Uri prometheusUri, SapSslPreference? sslPreference, Uri sslCertificateUri, string sapSid) : base(providerType, additionalBinaryDataProperties)
        {
