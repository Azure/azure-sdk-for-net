...
namespace Azure.ResourceManager.WorkloadsSapMonitor.Models
{
    ...
    public partial class HanaDBProviderInstanceProperties : SapProviderInstanceSpecificProperties
    {
        ...
        internal HanaDBProviderInstanceProperties(string providerType, IDictionary<string, BinaryData> additionalBinaryDataProperties, string hostname, string dbName, string sqlPort, string instanceNumber, string dbUsername, string dbPassword, Uri dbPasswordUri, Uri sslCertificateUri, string sslHostNameInCertificate, SapSslPreference? sslPreference, string sapSid) : base(providerType, additionalBinaryDataProperties)
        {
            Hostname = hostname;
            DBName = dbName;
            SqlPort = sqlPort;
