    ...
    public partial class SapMonitorResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SapMonitorResource>> UpdateAsync(WaitUntil waitUntil, SapMonitorData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _monitorsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, SapMonitorData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                WorkloadsSapMonitorArmOperation<SapMonitorResource> operation = new WorkloadsSapMonitorArmOperation<SapMonitorResource>(
                    new SapMonitorResourceOperationSource(Client),
                    _monitorsClientDiagnostics,
