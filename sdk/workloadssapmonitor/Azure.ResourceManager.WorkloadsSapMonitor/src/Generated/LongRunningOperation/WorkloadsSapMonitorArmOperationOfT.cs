...
{
    internal partial class WorkloadsSapMonitorArmOperation<T> : ArmOperation<T>
    {
        ...
        internal WorkloadsSapMonitorArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WorkloadsSapMonitorArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
