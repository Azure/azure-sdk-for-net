...
{
    internal partial class WorkloadsSapMonitorArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of WorkloadsSapMonitorArmOperation for mocking. </summary>
        protected WorkloadsSapMonitorArmOperation()
        {
        }
        ...
        internal WorkloadsSapMonitorArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal WorkloadsSapMonitorArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(
                ...
                clientDiagnostics,
                response,
                "WorkloadsSapMonitorArmOperation",
                null,
