...
namespace Azure.ResourceManager.StackHCI
{
    public partial class ArcSettingResource : IJsonModel<ArcSettingData>
    {
        ...
        BinaryData IPersistableModel<ArcSettingData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<ArcSettingData>(Data, options, AzureResourceManagerStackHCIContext.Default);

        ArcSettingData IPersistableModel<ArcSettingData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ArcSettingData>(data, options, AzureResourceManagerStackHCIContext.Default);
