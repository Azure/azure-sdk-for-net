...
namespace Azure.ResourceManager.StackHCI
{
    public partial class ExtensionResource : IJsonModel<ExtensionData>
    {
        ...
        BinaryData IPersistableModel<ExtensionData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<ExtensionData>(Data, options, AzureResourceManagerStackHCIContext.Default);

        ExtensionData IPersistableModel<ExtensionData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ExtensionData>(data, options, AzureResourceManagerStackHCIContext.Default);
