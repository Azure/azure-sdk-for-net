...
namespace Azure.ResourceManager.StackHCI
{
    ...
    public partial class OfferResource : ArmResource
    {
        ...
        {
            _offerClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.StackHCI", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of StackHciSkuResources in the Offer. </summary>
        /// <returns> An object representing collection of StackHciSkuResources and their operations over a StackHciSkuResource. </returns>
        public virtual StackHciSkuCollection GetStackHciSkus()
        {
            return GetCachedClient(client => new StackHciSkuCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<StackHciSkuResource>> GetStackHciSkuAsync(string skuName, string expand = null, CancellationToken cancellationToken = default)
        {
            return await GetStackHciSkus().GetAsync(skuName, expand, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="skuName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<StackHciSkuResource> GetStackHciSku(string skuName, string expand = null, CancellationToken cancellationToken = default)
        {
            return GetStackHciSkus().Get(skuName, expand, cancellationToken);
        }
