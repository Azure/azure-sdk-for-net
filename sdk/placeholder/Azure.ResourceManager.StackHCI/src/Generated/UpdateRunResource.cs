...
namespace Azure.ResourceManager.StackHCI
{
    ...
    public partial class UpdateRunResource : ArmResource
    {
        ...
        {
            _updateRunClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.StackHCI", ResourceType.Namespace, Diagnostics);
        ...
        /// <description>UpdateRun_Get</description>
        /// </item>
        /// <item>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>UpdateRun_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-12-01-preview</description>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new StackHCIArmOperation(_updateRunClientDiagnostics, Pipeline, _updateRunRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>UpdateRun_Put</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-12-01-preview</description>
        ...
        public virtual async Task<ArmOperation<UpdateRunResource>> UpdateAsync(WaitUntil waitUntil, UpdateRunData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new StackHCIArmOperation<UpdateRunResource>(Response.FromValue(new UpdateRunResource(Client, response), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
