...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class ArcIdentityResponse
    {
        ...
        internal ArcIdentityResponse(string arcApplicationClientId, string arcApplicationTenantId, string arcServicePrincipalObjectId, string arcApplicationObjectId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
