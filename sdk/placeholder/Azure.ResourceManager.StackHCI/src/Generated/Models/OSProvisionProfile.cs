...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class OSProvisionProfile
    {
        ...
        internal OSProvisionProfile(string osName, string osType, string osVersion, string osImageLocation, string vsrVersion, string imageHash, string gpgPubKey, OSOperationType? operationType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OSName = osName;
            OSType = osType;
            OSVersion = osVersion;
