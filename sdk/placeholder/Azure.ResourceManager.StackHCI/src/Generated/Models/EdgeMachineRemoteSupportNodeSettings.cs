...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class EdgeMachineRemoteSupportNodeSettings
    {
        ...
        internal EdgeMachineRemoteSupportNodeSettings(string state, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string connectionStatus, string connectionErrorMessage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
            CreatedOn = createdOn;
            UpdatedOn = updatedOn;
