...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class PrecheckResultTags
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PrecheckResultTags"/>. </summary>
        ...
        internal PrecheckResultTags(string key, string value, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Key = key;
            Value = value;
