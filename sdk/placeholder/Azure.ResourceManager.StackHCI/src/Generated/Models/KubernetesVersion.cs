...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class KubernetesVersion : ResourceData
    {
        ...
        internal KubernetesVersion(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, KubernetesVersionProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
