...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    internal partial class UpdateSummariesList
    {
        ...
        internal UpdateSummariesList(IEnumerable<UpdateSummaries> value)
        {
        ...
        internal UpdateSummariesList(IReadOnlyList<UpdateSummaries> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<UpdateSummaries> Value { get; }
