...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class HciEdgeDeviceArcExtension
    {
        ...
        internal HciEdgeDeviceArcExtension(string extensionName, ArcExtensionState? state, IReadOnlyList<HciValidationFailureDetail> errorDetails, ResourceIdentifier extensionResourceId, string typeHandlerVersion, ExtensionManagedBy? managedBy, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
