...
{
    public partial class EdgeMachineNicDetail : IUtf8JsonSerializable, IJsonModel<EdgeMachineNicDetail>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeMachineNicDetail>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<EdgeMachineNicDetail>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        EdgeMachineNicDetail IJsonModel<EdgeMachineNicDetail>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EdgeMachineNicDetail>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static EdgeMachineNicDetail DeserializeEdgeMachineNicDetail(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<EdgeMachineNicDetail>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EdgeMachineNicDetail>)this).GetFormatFromOptions(options) : options.Format;
        ...
        EdgeMachineNicDetail IPersistableModel<EdgeMachineNicDetail>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EdgeMachineNicDetail>)this).GetFormatFromOptions(options) : options.Format;
