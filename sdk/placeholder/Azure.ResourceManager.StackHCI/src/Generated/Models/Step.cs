...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class Step
    {
        ...
        internal Step(string name, string description, string errorMessage, string status, DateTimeOffset? startTimeUtc, DateTimeOffset? endTimeUtc, DateTimeOffset? lastUpdatedTimeUtc, string expectedExecutionTime, IList<Step> steps, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
