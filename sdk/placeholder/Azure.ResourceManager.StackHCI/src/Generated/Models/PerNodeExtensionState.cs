...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class PerNodeExtensionState
    {
        ...
        internal PerNodeExtensionState(string name, string extension, string typeHandlerVersion, NodeExtensionState? state, ExtensionInstanceView instanceView, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Extension = extension;
