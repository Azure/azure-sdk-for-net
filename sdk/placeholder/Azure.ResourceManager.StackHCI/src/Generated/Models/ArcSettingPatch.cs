...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class ArcSettingPatch
    {
        ...
        internal ArcSettingPatch(IDictionary<string, string> tags, ArcConnectivityProperties connectivityProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
