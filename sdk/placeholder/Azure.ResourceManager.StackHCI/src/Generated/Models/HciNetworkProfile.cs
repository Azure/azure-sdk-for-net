...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class HciNetworkProfile
    {
        ...
        internal HciNetworkProfile(IReadOnlyList<HciNicDetail> nicDetails, IReadOnlyList<SwitchDetail> switchDetails, HciEdgeDeviceHostNetwork hostNetwork, SdnProperties sdnProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
