...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class InfrastructureNetwork
    {
        ...
        internal InfrastructureNetwork(string subnetMask, string gateway, IList<IPPools> ipPools, DnsServerConfig? dnsServerConfig, IList<DnsZones> dnsZones, IList<string> dnsServers, bool? useDhcp, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
