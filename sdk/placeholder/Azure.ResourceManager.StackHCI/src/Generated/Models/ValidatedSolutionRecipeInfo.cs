...
namespace Azure.ResourceManager.StackHCI.Models
{
    ...
    public partial class ValidatedSolutionRecipeInfo
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="solutionType"/> or <paramref name="version"/> is null. </exception>
        ...
        internal ValidatedSolutionRecipeInfo(string solutionType, string version, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SolutionType = solutionType;
            Version = version;
        ...
        /// <summary> Initializes a new instance of <see cref="ValidatedSolutionRecipeInfo"/> for deserialization. </summary>
