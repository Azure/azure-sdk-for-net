...
{
    internal partial class RawCertificateData : IUtf8JsonSerializable, IJsonModel<RawCertificateData>
    {
        ...
        internal static RawCertificateData DeserializeRawCertificateData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RawCertificateData(certificates ?? new ChangeTrackingList<string>(), serializedAdditionalRawData);
        }
