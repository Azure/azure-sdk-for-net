    ...
    public partial class HciNetworkProfile : IUtf8JsonSerializable, IJsonModel<HciNetworkProfile>
    {
        ...
        internal static HciNetworkProfile DeserializeHciNetworkProfile(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("sdnProperties"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    sdnProperties = SdnProperties.DeserializeSdnProperties(property.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new HciNetworkProfile(nicDetails ?? new ChangeTrackingList<HciNicDetail>(), switchDetails ?? new ChangeTrackingList<SwitchDetail>(), hostNetwork, sdnProperties, serializedAdditionalRawData);
        }
