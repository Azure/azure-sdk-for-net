...
namespace Azure.ResourceManager.StackHCI
{
    ...
    public partial class PublisherCollection : ArmCollection, IEnumerable<PublisherResource>, IAsyncEnumerable<PublisherResource>
    {
        ...
        {
            _publisherClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.StackHCI", PublisherResource.ResourceType.Namespace, Diagnostics);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Publisher_ListByCluster</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-12-01-preview</description>
