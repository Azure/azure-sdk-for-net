...
{
    /// <summary>
    /// A class representing the OSImage data model.
    ...
    public partial class OSImageData : ResourceData
    {
        ...
        internal OSImageData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, OSImageProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
