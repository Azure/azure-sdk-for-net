...
namespace Azure.ResourceManager.StackHCI
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ClusterResource"/> using the GetArcSetting method.
    /// </summary>
    public partial class ArcSettingResource : ArmResource
    {
        ...
        {
            _arcSettingClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.StackHCI", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of ExtensionResources in the ArcSetting. </summary>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>ArcSetting_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-12-01-preview</description>
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>ArcSetting_Update</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-12-01-preview</description>
        ...
        public virtual async Task<ArmOperation<ArcSettingResource>> ReconcileAsync(WaitUntil waitUntil, ReconcileArcSettingsContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _arcSettingClientDiagnostics.CreateScope("ArcSettingResource.Reconcile");
            scope.Start();
            try
            {
                var response = await _arcSettingRestClient.ReconcileAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken).ConfigureAwait(false);
                var operation = new StackHCIArmOperation<ArcSettingResource>(new ArcSettingOperationSource(Client), _arcSettingClientDiagnostics, Pipeline, _arcSettingRestClient.CreateReconcileRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual ArmOperation<ArcSettingResource> Reconcile(WaitUntil waitUntil, ReconcileArcSettingsContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _arcSettingRestClient.Reconcile(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken);
                var operation = new StackHCIArmOperation<ArcSettingResource>(new ArcSettingOperationSource(Client), _arcSettingClientDiagnostics, Pipeline, _arcSettingRestClient.CreateReconcileRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        {
            using var scope = _arcSettingClientDiagnostics.CreateScope("ArcSettingResource.ConsentAndInstallDefaultExtensions");
            scope.Start();
            try
            {
                var response = await _arcSettingRestClient.ConsentAndInstallDefaultExtensionsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new ArcSettingResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<ArcSettingResource> ConsentAndInstallDefaultExtensions(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _arcSettingRestClient.ConsentAndInstallDefaultExtensions(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return Response.FromValue(new ArcSettingResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _arcSettingClientDiagnostics.CreateScope("ArcSettingResource.InitializeDisableProcess");
            scope.Start();
            try
            {
                var response = await _arcSettingRestClient.InitializeDisableProcessAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new StackHCIArmOperation(_arcSettingClientDiagnostics, Pipeline, _arcSettingRestClient.CreateInitializeDisableProcessRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual ArmOperation InitializeDisableProcess(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _arcSettingRestClient.InitializeDisableProcess(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new StackHCIArmOperation(_arcSettingClientDiagnostics, Pipeline, _arcSettingRestClient.CreateInitializeDisableProcessRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
