...
namespace Azure.ResourceManager.StackHCI
{
    public partial class SecuritySettingResource : IJsonModel<SecuritySettingData>
    {
        ...
        BinaryData IPersistableModel<SecuritySettingData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<SecuritySettingData>(Data, options, AzureResourceManagerStackHCIContext.Default);

        SecuritySettingData IPersistableModel<SecuritySettingData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<SecuritySettingData>(data, options, AzureResourceManagerStackHCIContext.Default);
