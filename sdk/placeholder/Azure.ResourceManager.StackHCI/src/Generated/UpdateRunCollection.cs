...
namespace Azure.ResourceManager.StackHCI
{
    ...
    public partial class UpdateRunCollection : ArmCollection, IEnumerable<UpdateRunResource>, IAsyncEnumerable<UpdateRunResource>
    {
        ...
        {
            _updateRunClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.StackHCI", UpdateRunResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<UpdateRunResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string updateRunName, UpdateRunData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _updateRunRestClient.CreatePutRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, updateRunName, data);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>UpdateRun_List</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-12-01-preview</description>
