...
namespace Azure.ResourceManager.StackHCI
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ClusterResource"/> using the GetPublisher method.
    /// </summary>
    public partial class PublisherResource : ArmResource
    {
        ...
        {
            _publisherClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.StackHCI", ResourceType.Namespace, Diagnostics);
