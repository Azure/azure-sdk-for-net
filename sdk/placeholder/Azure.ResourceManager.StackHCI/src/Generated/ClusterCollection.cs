...
namespace Azure.ResourceManager.StackHCI
{
    ...
    public partial class ClusterCollection : ArmCollection, IEnumerable<ClusterResource>, IAsyncEnumerable<ClusterResource>
    {
        ...
        {
            _clusterClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.StackHCI", ClusterResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ClusterResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string clusterName, ClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _clusterRestClient.CreateCreateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, clusterName, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new StackHCIArmOperation<ClusterResource>(Response.FromValue(new ClusterResource(Client, response), response.GetRawResponse()), rehydrationToken);
