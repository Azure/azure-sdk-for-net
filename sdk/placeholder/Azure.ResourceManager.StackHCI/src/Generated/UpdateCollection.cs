...
namespace Azure.ResourceManager.StackHCI
{
    ...
    /// To get an <see cref="UpdateCollection"/> instance call the GetUpdates method from an instance of <see cref="ClusterResource"/>.
    /// </summary>
    public partial class UpdateCollection : ArmCollection, IEnumerable<UpdateResource>, IAsyncEnumerable<UpdateResource>
    {
        ...
        {
            _updateClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.StackHCI", UpdateResource.ResourceType.Namespace, Diagnostics);
        ...
        /// <description>Update_Put</description>
        /// </item>
        /// <item>
        ...
        public virtual async Task<ArmOperation<UpdateResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string updateName, UpdateData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _updateRestClient.CreatePutRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, updateName, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new StackHCIArmOperation<UpdateResource>(Response.FromValue(new UpdateResource(Client, response), response.GetRawResponse()), rehydrationToken);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Update_List</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-12-01-preview</description>
