...
namespace Azure.ResourceManager.StackHCI
{
    ...
    /// To get an <see cref="ArcSettingCollection"/> instance call the GetArcSettings method from an instance of <see cref="ClusterResource"/>.
    /// </summary>
    public partial class ArcSettingCollection : ArmCollection, IEnumerable<ArcSettingResource>, IAsyncEnumerable<ArcSettingResource>
    {
        ...
        {
            _arcSettingClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.StackHCI", ArcSettingResource.ResourceType.Namespace, Diagnostics);
        ...
        /// <description>ArcSetting_Create</description>
        /// </item>
        /// <item>
        ...
        public virtual async Task<ArmOperation<ArcSettingResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string arcSettingName, ArcSettingData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new StackHCIArmOperation<ArcSettingResource>(Response.FromValue(new ArcSettingResource(Client, response), response.GetRawResponse()), rehydrationToken);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>ArcSetting_ListByCluster</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-12-01-preview</description>
