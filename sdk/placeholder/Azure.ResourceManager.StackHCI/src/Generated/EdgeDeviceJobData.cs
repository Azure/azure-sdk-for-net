...
{
    /// <summary>
    /// A class representing the EdgeDeviceJob data model.
    ...
    /// </summary>
    public abstract partial class EdgeDeviceJobData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="EdgeDeviceJobData"/>. </summary>
        ...
        internal EdgeDeviceJobData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, EdgeDeviceKind? kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
