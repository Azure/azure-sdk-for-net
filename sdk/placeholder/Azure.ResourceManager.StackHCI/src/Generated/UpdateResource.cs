...
namespace Azure.ResourceManager.StackHCI
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ClusterResource"/> using the GetUpdate method.
    /// </summary>
    public partial class UpdateResource : ArmResource
    {
        ...
        {
            _updateClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.StackHCI", ResourceType.Namespace, Diagnostics);
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Update_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-12-01-preview</description>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new StackHCIArmOperation(_updateClientDiagnostics, Pipeline, _updateRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual async Task<ArmOperation> PostAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new StackHCIArmOperation(_updateClientDiagnostics, Pipeline, _updateRestClient.CreatePostRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
