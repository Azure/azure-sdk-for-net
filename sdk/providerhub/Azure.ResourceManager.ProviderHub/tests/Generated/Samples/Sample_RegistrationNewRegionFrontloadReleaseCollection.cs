...
{
    public partial class Sample_RegistrationNewRegionFrontloadReleaseCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_NewRegionFrontloadReleaseCreateOrUpdate()
        {
...
SubscriptionId = "e4eae963-2d15-43e6-a097-98bd75b33edd",
        ...
        public async Task Get_NewRegionFrontloadReleaseGet()
        {
            ...
            // invoke the operation
            string releaseName = "2020week10";
            RegistrationNewRegionFrontloadReleaseResource result = await collection.GetAsync(releaseName);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_NewRegionFrontloadReleaseGet()
        {
            // Generated from example definition: specification/providerhub/resource-manager/Microsoft.ProviderHub/stable/2024-09-01/examples/NewRegionFrontloadRelease_Get.json
            // this example is just showing the usage of "NewRegionFrontloadRelease_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string releaseName = "2020week10";
            bool result = await collection.ExistsAsync(releaseName);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_NewRegionFrontloadReleaseGet()
        {
            // Generated from example definition: specification/providerhub/resource-manager/Microsoft.ProviderHub/stable/2024-09-01/examples/NewRegionFrontloadRelease_Get.json
            // this example is just showing the usage of "NewRegionFrontloadRelease_Get" operation, for the dependent resources, they will have to be created separately.
