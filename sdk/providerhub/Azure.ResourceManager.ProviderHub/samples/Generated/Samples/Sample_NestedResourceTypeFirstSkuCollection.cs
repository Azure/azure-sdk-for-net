...
namespace Azure.ResourceManager.ProviderHub.Samples
{
    public partial class Sample_NestedResourceTypeFirstSkuCollection
    {
        ...
        public async Task GetIfExists_SkusGetNestedResourceTypeFirst()
        {
            ...
            // invoke the operation
            string sku = "testSku";
            NullableResponse<NestedResourceTypeFirstSkuResource> response = await collection.GetIfExistsAsync(sku);
            NestedResourceTypeFirstSkuResource result = response.HasValue ? response.Value : null;
...
new ResourceTypeSkuCost("xxx")
        ...
        {
            // Generated from example definition: specification/providerhub/resource-manager/Microsoft.ProviderHub/preview/2023-04-01-preview/examples/Skus_ListByResourceTypeRegistrationsNestedResourceTypeFirst.json
