...
namespace Azure.ResourceManager.ProviderHub
{
    ...
    {
        private readonly ClientDiagnostics _nestedResourceTypeFirstSkuClientDiagnostics;
        private readonly NestedResourceTypeFirstSku _nestedResourceTypeFirstSkuRestClient;
        ...
        internal NestedResourceTypeFirstSkuCollection(ArmClient client, ResourceIdentifier id, string nestedResourceTypeFirst) : base(client, id)
        {
            ...
            _nestedResourceTypeFirstSkuClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ProviderHub", NestedResourceTypeFirstSkuResource.ResourceType.Namespace, Diagnostics);
            _nestedResourceTypeFirstSkuRestClient = new NestedResourceTypeFirstSku(_nestedResourceTypeFirstSkuClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, nestedResourceTypeFirstSkuApiVersion ?? "2024-09-01");
        ...
        public virtual async Task<ArmOperation<NestedResourceTypeFirstSkuResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sku, ResourceTypeSkuData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _nestedResourceTypeFirstSkuClientDiagnostics.CreateScope("NestedResourceTypeFirstSkuCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _nestedResourceTypeFirstSkuRestClient.CreateCreateOrUpdateNestedResourceTypeFirstRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, _nestedResourceTypeFirst, sku, ResourceTypeSkuData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<NestedResourceTypeFirstSkuResource>> GetAsync(string sku, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _nestedResourceTypeFirstSkuClientDiagnostics.CreateScope("NestedResourceTypeFirstSkuCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _nestedResourceTypeFirstSkuRestClient.CreateGetNestedResourceTypeFirstRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, _nestedResourceTypeFirst, sku, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ResourceTypeSkuData> response = Response.FromValue(ResourceTypeSkuData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<NestedResourceTypeFirstSkuResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ResourceTypeSkuData, NestedResourceTypeFirstSkuResource>(new NestedResourceTypeFirstSkuGetByResourceTypeRegistrationsNestedResourceTypeFirstAsyncCollectionResultOfT(
                ...
                context,
                "NestedResourceTypeFirstSkuCollection.GetAll"), data => new NestedResourceTypeFirstSkuResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string sku, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _nestedResourceTypeFirstSkuClientDiagnostics.CreateScope("NestedResourceTypeFirstSkuCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<NestedResourceTypeFirstSkuResource>> GetIfExistsAsync(string sku, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _nestedResourceTypeFirstSkuClientDiagnostics.CreateScope("NestedResourceTypeFirstSkuCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
