...
namespace Azure.ResourceManager.ProviderHub
{
    ...
    public partial class NestedResourceTypeSecondSkuCollection : ArmCollection, IEnumerable<NestedResourceTypeSecondSkuResource>, IAsyncEnumerable<NestedResourceTypeSecondSkuResource>
    {
        ...
        public virtual async Task<ArmOperation<NestedResourceTypeSecondSkuResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sku, ResourceTypeSkuData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _nestedResourceTypeSecondSkuClientDiagnostics.CreateScope("NestedResourceTypeSecondSkuCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _nestedResourceTypeSecondSkuRestClient.CreateCreateOrUpdateNestedResourceTypeSecondRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, _nestedResourceTypeFirst, _nestedResourceTypeSecond, sku, ResourceTypeSkuData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<NestedResourceTypeSecondSkuResource>> GetAsync(string sku, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _nestedResourceTypeSecondSkuClientDiagnostics.CreateScope("NestedResourceTypeSecondSkuCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _nestedResourceTypeSecondSkuRestClient.CreateGetNestedResourceTypeSecondRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, _nestedResourceTypeFirst, _nestedResourceTypeSecond, sku, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ResourceTypeSkuData> response = Response.FromValue(ResourceTypeSkuData.FromResponse(result), result);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string sku, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _nestedResourceTypeSecondSkuClientDiagnostics.CreateScope("NestedResourceTypeSecondSkuCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<NestedResourceTypeSecondSkuResource>> GetIfExistsAsync(string sku, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _nestedResourceTypeSecondSkuClientDiagnostics.CreateScope("NestedResourceTypeSecondSkuCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
