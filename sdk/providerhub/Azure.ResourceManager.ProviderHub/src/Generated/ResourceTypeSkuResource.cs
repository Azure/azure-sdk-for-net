...
namespace Azure.ResourceManager.ProviderHub
{
    ...
    public partial class ResourceTypeSkuResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _resourceTypeSkuClientDiagnostics.CreateScope("ResourceTypeSkuResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _resourceTypeSkuRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _resourceTypeSkuClientDiagnostics.CreateScope("ResourceTypeSkuResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _resourceTypeSkuRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<ResourceTypeSkuResource>> UpdateAsync(WaitUntil waitUntil, ResourceTypeSkuData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _resourceTypeSkuClientDiagnostics.CreateScope("ResourceTypeSkuResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _resourceTypeSkuRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ResourceTypeSkuData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ResourceTypeSkuData> response = Response.FromValue(ResourceTypeSkuData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
