...
namespace Azure.ResourceManager.ProviderHub
{
    ...
    public partial class ResourceTypeRegistrationData : ResourceData
    {
        ...
        internal ResourceTypeRegistrationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceTypeRegistrationProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
