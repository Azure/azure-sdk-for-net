...
namespace Azure.ResourceManager.ProviderHub.Mocking
{
    ...
    internal partial class ProviderHubArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ProviderHubArmClientMockingExtension"/> class for mocking. </summary>
        protected ProviderHubArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ProviderHubArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ProviderHubArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ProviderHubArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
