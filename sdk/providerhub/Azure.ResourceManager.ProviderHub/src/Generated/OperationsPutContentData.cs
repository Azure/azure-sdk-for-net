...
namespace Azure.ResourceManager.ProviderHub
{
    ...
    public partial class OperationsPutContentData : ResourceData
    {
        ...
        internal OperationsPutContentData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, OperationsContentProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
