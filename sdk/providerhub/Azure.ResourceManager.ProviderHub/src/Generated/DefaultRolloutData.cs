...
namespace Azure.ResourceManager.ProviderHub
{
    ...
    public partial class DefaultRolloutData : ResourceData
    {
        ...
        internal DefaultRolloutData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DefaultRolloutProperties properties) : base(id, name, resourceType, systemData)
        {
