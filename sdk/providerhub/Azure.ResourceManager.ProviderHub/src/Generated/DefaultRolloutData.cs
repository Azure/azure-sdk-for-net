...
namespace Azure.ResourceManager.ProviderHub
{
    ...
    public partial class DefaultRolloutData : ResourceData
    {
        ...
        internal DefaultRolloutData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DefaultRolloutProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
