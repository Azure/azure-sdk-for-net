...
namespace Azure.ResourceManager.ProviderHub
{
    ...
    public partial class ResourceTypeSkuData : ResourceData
    {
        ...
        internal ResourceTypeSkuData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceTypeSkuProperties properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
