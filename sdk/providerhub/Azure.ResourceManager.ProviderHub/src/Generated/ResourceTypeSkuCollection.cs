...
namespace Azure.ResourceManager.ProviderHub
{
    ...
    {
        private readonly ClientDiagnostics _resourceTypeSkuClientDiagnostics;
        private readonly ResourceTypeSku _resourceTypeSkuRestClient;
        ...
        internal ResourceTypeSkuCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _resourceTypeSkuClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ProviderHub", ResourceTypeSkuResource.ResourceType.Namespace, Diagnostics);
            _resourceTypeSkuRestClient = new ResourceTypeSku(_resourceTypeSkuClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, resourceTypeSkuApiVersion ?? "2025-10-01");
        ...
        public virtual async Task<ArmOperation<ResourceTypeSkuResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sku, ResourceTypeSkuData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _resourceTypeSkuClientDiagnostics.CreateScope("ResourceTypeSkuCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _resourceTypeSkuRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, sku, ResourceTypeSkuData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<ResourceTypeSkuResource>> GetAsync(string sku, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _resourceTypeSkuClientDiagnostics.CreateScope("ResourceTypeSkuCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _resourceTypeSkuRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.Parent.Name, Id.Name, sku, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ResourceTypeSkuData> response = Response.FromValue(ResourceTypeSkuData.FromResponse(result), result);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string sku, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _resourceTypeSkuClientDiagnostics.CreateScope("ResourceTypeSkuCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ResourceTypeSkuResource>> GetIfExistsAsync(string sku, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _resourceTypeSkuClientDiagnostics.CreateScope("ResourceTypeSkuCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
