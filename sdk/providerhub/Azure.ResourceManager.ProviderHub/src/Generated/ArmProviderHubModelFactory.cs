...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public static partial class ArmProviderHubModelFactory
    {
        ...
        {
            return new CustomRolloutData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProviderRegistrationData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceTypeRegistrationData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TypedErrorInfo(typedErrorInfoType, info, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DefaultRolloutData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static ResourceProviderManifest ResourceProviderManifest(IEnumerable<string> providerAuthenticationAllowedAudiences = null, IEnumerable<ResourceProviderAuthorization> providerAuthorizations = null, string @namespace = null, string providerVersion = null, ResourceProviderType? providerType = null, IEnumerable<string> requiredFeatures = null, FeaturesPolicy? requiredFeaturesPolicy = null, OptInHeaderType? optInHeaders = null, IEnumerable<ProviderResourceType> resourceTypes = null, ResourceProviderManagement management = null, IEnumerable<ResourceProviderCapabilities> capabilities = null, BinaryData metadata = null, IEnumerable<ResourceProviderEndpoint> globalNotificationEndpoints = null, ReRegisterSubscriptionMetadata reRegisterSubscriptionMetadata = null)
        {
            ...
            return new ResourceProviderManifest(providerAuthenticationAllowedAudiences != null ? new ResourceProviderAuthentication(providerAuthenticationAllowedAudiences?.ToList(), new Dictionary<string, BinaryData>()) : null, providerAuthorizations?.ToList(), @namespace, providerVersion, providerType, requiredFeatures?.ToList(), requiredFeaturesPolicy.HasValue ? new FeaturesRule(requiredFeaturesPolicy.Value, new Dictionary<string, BinaryData>()) : null, optInHeaders != null ? new RequestHeaderOptions(optInHeaders, new Dictionary<string, BinaryData>()) : null, resourceTypes?.ToList(), management, capabilities?.ToList(), metadata, globalNotificationEndpoints?.ToList(), reRegisterSubscriptionMetadata, new Dictionary<string, BinaryData>());
        }
        ...
        public static ResourceProviderEndpoint ResourceProviderEndpoint(bool? isEnabled = null, IEnumerable<string> apiVersions = null, Uri endpointUri = null, IEnumerable<AzureLocation> locations = null, IEnumerable<string> requiredFeatures = null, FeaturesPolicy? requiredFeaturesPolicy = null, TimeSpan? timeout = null)
        {
            ...
            return new ResourceProviderEndpoint(isEnabled, apiVersions?.ToList(), endpointUri, locations?.ToList(), requiredFeatures?.ToList(), requiredFeaturesPolicy.HasValue ? new FeaturesRule(requiredFeaturesPolicy.Value, new Dictionary<string, BinaryData>()) : null, timeout, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TemplateDeploymentPolicy(capabilities, preflightOptions, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LinkedOperationRule(linkedOperation, linkedAction, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ReRegisterSubscriptionMetadata(isEnabled, concurrencyLimit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CheckinManifestInfo(isCheckedIn, statusMessage, pullRequest, commitId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NotificationRegistrationData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceTypeSkuData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
    }
}
