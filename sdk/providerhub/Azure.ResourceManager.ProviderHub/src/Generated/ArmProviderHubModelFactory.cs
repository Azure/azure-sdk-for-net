...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public static partial class ArmProviderHubModelFactory
    {
        ...
        {
            return new CustomRolloutData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new ProviderRegistrationData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new ResourceTypeRegistrationData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new DefaultRolloutData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static ResourceProviderEndpoint ResourceProviderEndpoint(bool? isEnabled = null, IEnumerable<string> apiVersions = null, Uri endpointUri = null, IEnumerable<AzureLocation> locations = null, IEnumerable<string> requiredFeatures = null, FeaturesPolicy? requiredFeaturesPolicy = null, TimeSpan? timeout = null)
        {
            ...
            return new ResourceProviderEndpoint(isEnabled, apiVersions?.ToList(), endpointUri, locations?.ToList(), requiredFeatures?.ToList(), requiredFeaturesPolicy.HasValue ? new FeaturesRule(requiredFeaturesPolicy.Value, new Dictionary<string, BinaryData>()) : null, timeout, default);
        }
        ...
        {
            return new TemplateDeploymentPolicy(capabilities, preflightOptions, default);
        }
        ...
        {
            return new LinkedOperationRule(linkedOperation, linkedAction, default);
        }
        ...
        {
            return new NotificationRegistrationData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new ResourceTypeSkuData(id, name, resourceType, systemData, properties, default);
        }
    }
}
