...
{
    internal partial class NestedResourceTypeSecondSkuGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT : Pageable<ResourceTypeSkuData>
    {
        ...
        /// <summary> Initializes a new instance of NestedResourceTypeSecondSkuGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public NestedResourceTypeSecondSkuGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT(NestedResourceTypeSecondSku client, Guid subscriptionId, string providerNamespace, string resourceType, string nestedResourceTypeFirst, string nestedResourceTypeSecond, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of NestedResourceTypeSecondSkuGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of NestedResourceTypeSecondSkuGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT as an enumerable collection. </returns>
