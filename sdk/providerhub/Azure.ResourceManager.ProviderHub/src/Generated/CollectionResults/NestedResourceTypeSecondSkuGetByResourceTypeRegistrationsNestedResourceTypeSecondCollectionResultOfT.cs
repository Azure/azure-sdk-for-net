...
namespace Azure.ResourceManager.ProviderHub
{
    internal partial class NestedResourceTypeSecondSkuGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT : Pageable<ResourceTypeSkuData>
    {
        ...
        public NestedResourceTypeSecondSkuGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT(NestedResourceTypeSecondSku client, Guid subscriptionId, string providerNamespace, string resourceType, string nestedResourceTypeFirst, string nestedResourceTypeSecond, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
