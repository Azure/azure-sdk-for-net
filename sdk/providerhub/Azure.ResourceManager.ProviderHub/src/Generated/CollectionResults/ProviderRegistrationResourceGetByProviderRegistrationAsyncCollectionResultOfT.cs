...
{
    internal partial class ProviderRegistrationResourceGetByProviderRegistrationAsyncCollectionResultOfT : AsyncPageable<OperationsDefinition>
    {
        ...
        /// <summary> Initializes a new instance of ProviderRegistrationResourceGetByProviderRegistrationAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProviderRegistrationResourceGetByProviderRegistrationAsyncCollectionResultOfT(Operations client, Guid subscriptionId, string providerNamespace, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ProviderRegistrationResourceGetByProviderRegistrationAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ProviderRegistrationResourceGetByProviderRegistrationAsyncCollectionResultOfT as an enumerable collection. </returns>
