...
{
    internal partial class SkusGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT : Pageable<ResourceTypeSkuData>
    {
        ...
        /// <summary> Initializes a new instance of SkusGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SkusGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT(Skus client, Guid subscriptionId, string providerNamespace, string resourceType, string nestedResourceTypeFirst, string nestedResourceTypeSecond, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of SkusGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SkusGetByResourceTypeRegistrationsNestedResourceTypeSecondCollectionResultOfT as an enumerable collection. </returns>
