...
{
    internal partial class NestedResourceTypeThirdSkuGetByResourceTypeRegistrationsNestedResourceTypeThirdCollectionResultOfT : Pageable<ResourceTypeSkuData>
    {
        private readonly NestedResourceTypeThirdSku _client;
        ...
        /// <summary> Initializes a new instance of NestedResourceTypeThirdSkuGetByResourceTypeRegistrationsNestedResourceTypeThirdCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The NestedResourceTypeThirdSku client used to send requests. </param>
        ...
        public NestedResourceTypeThirdSkuGetByResourceTypeRegistrationsNestedResourceTypeThirdCollectionResultOfT(NestedResourceTypeThirdSku client, Guid subscriptionId, string providerNamespace, string resourceType, string nestedResourceTypeFirst, string nestedResourceTypeSecond, string nestedResourceTypeThird, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of NestedResourceTypeThirdSkuGetByResourceTypeRegistrationsNestedResourceTypeThirdCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of NestedResourceTypeThirdSkuGetByResourceTypeRegistrationsNestedResourceTypeThirdCollectionResultOfT as an enumerable collection. </returns>
