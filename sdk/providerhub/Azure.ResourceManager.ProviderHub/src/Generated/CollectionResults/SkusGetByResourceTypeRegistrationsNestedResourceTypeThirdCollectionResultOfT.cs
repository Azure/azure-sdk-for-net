...
{
    internal partial class SkusGetByResourceTypeRegistrationsNestedResourceTypeThirdCollectionResultOfT : Pageable<ResourceTypeSkuData>
    {
        ...
        /// <summary> Initializes a new instance of SkusGetByResourceTypeRegistrationsNestedResourceTypeThirdCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SkusGetByResourceTypeRegistrationsNestedResourceTypeThirdCollectionResultOfT(Skus client, Guid subscriptionId, string providerNamespace, string resourceType, string nestedResourceTypeFirst, string nestedResourceTypeSecond, string nestedResourceTypeThird, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of SkusGetByResourceTypeRegistrationsNestedResourceTypeThirdCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SkusGetByResourceTypeRegistrationsNestedResourceTypeThirdCollectionResultOfT as an enumerable collection. </returns>
