...
{
    /// <summary></summary>
    internal partial class ProviderMonitorSettingResourceOperationSource : IOperationSource<ProviderMonitorSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ProviderMonitorSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
