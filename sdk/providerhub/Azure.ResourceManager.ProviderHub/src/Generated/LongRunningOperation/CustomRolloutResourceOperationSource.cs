...
{
    /// <summary></summary>
    internal partial class CustomRolloutResourceOperationSource : IOperationSource<CustomRolloutResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CustomRolloutResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
