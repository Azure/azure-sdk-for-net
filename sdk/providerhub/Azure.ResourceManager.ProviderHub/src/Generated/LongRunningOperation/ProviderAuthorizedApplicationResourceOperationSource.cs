...
{
    /// <summary></summary>
    internal partial class ProviderAuthorizedApplicationResourceOperationSource : IOperationSource<ProviderAuthorizedApplicationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ProviderAuthorizedApplicationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
