...
{
    /// <summary></summary>
    internal partial class DefaultRolloutResourceOperationSource : IOperationSource<DefaultRolloutResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DefaultRolloutResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
