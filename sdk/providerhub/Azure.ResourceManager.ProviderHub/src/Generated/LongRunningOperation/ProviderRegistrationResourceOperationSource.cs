...
{
    /// <summary></summary>
    internal partial class ProviderRegistrationResourceOperationSource : IOperationSource<ProviderRegistrationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ProviderRegistrationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
