    ...
    public partial class LinkedAccessCheck : IUtf8JsonSerializable, IJsonModel<LinkedAccessCheck>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LinkedProperty))
            {
                ...
                if (LinkedProperty.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(LinkedAction))
            {
                ...
                if (LinkedAction.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(LinkedActionVerb))
            {
                ...
                if (LinkedActionVerb.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(LinkedType))
            {
                ...
                if (LinkedType.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
