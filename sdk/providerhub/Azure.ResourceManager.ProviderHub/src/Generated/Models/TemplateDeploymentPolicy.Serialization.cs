...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class TemplateDeploymentPolicy : IJsonModel<TemplateDeploymentPolicy>
    {
        ...
        protected virtual TemplateDeploymentPolicy PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<TemplateDeploymentPolicy>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<TemplateDeploymentPolicy>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        TemplateDeploymentPolicy IPersistableModel<TemplateDeploymentPolicy>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TemplateDeploymentPolicy IJsonModel<TemplateDeploymentPolicy>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual TemplateDeploymentPolicy JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<TemplateDeploymentPolicy>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static TemplateDeploymentPolicy DeserializeTemplateDeploymentPolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    capabilities = new TemplateDeploymentCapability(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("preflightOptions"u8))
                {
                    preflightOptions = new TemplateDeploymentPreflightOption(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("preflightNotifications"u8))
                {
                    ...
                    preflightNotifications = new TemplateDeploymentPreflightNotification(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new TemplateDeploymentPolicy(capabilities, preflightOptions, preflightNotifications, additionalBinaryDataProperties);
        }
    }
}
