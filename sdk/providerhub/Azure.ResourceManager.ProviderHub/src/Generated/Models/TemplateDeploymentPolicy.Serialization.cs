...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        internal static TemplateDeploymentPolicy DeserializeTemplateDeploymentPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
