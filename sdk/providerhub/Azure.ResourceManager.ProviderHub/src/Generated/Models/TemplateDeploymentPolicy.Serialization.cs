...
{
    public partial class TemplateDeploymentPolicy : IUtf8JsonSerializable, IJsonModel<TemplateDeploymentPolicy>, IPersistableModel<TemplateDeploymentPolicy>
    {
        ...
        void IJsonModel<TemplateDeploymentPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TemplateDeploymentPolicy)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Capabilities))
            {
                ...
                builder.AppendLine($" '{Capabilities.ToString()}'");
            }

            if (Optional.IsDefined(PreflightOptions))
            {
                builder.Append("  preflightOptions:");
                builder.AppendLine($" '{PreflightOptions.ToString()}'");
            }
