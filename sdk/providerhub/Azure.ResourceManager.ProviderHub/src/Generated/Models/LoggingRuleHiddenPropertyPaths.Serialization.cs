...
{
    public partial class LoggingRuleHiddenPropertyPaths : IUtf8JsonSerializable
    {
        ...
        internal static LoggingRuleHiddenPropertyPaths DeserializeLoggingRuleHiddenPropertyPaths(JsonElement element)
        {
            ...
            return new LoggingRuleHiddenPropertyPaths(Optional.ToList(hiddenPathsOnRequest), Optional.ToList(hiddenPathsOnResponse));
        }
    }
}
