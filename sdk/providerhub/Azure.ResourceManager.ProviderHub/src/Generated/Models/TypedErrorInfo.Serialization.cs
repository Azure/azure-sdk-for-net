...
{
    public partial class TypedErrorInfo : IUtf8JsonSerializable, IJsonModel<TypedErrorInfo>, IPersistableModel<TypedErrorInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TypedErrorInfoType))
            {
                builder.Append("  type:");
                builder.AppendLine($" '{TypedErrorInfoType}'");
            }
