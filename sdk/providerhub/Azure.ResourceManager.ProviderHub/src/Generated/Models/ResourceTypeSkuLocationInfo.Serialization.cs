...
namespace Azure.ResourceManager.ProviderHub.Models
{
    public partial class ResourceTypeSkuLocationInfo : IUtf8JsonSerializable, IJsonModel<ResourceTypeSkuLocationInfo>
    {
        ...
        void IJsonModel<ResourceTypeSkuLocationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ResourceTypeSkuLocationInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResourceTypeSkuLocationInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ResourceTypeSkuLocationInfo)} does not support '{options.Format}' format.");
            }
        }
