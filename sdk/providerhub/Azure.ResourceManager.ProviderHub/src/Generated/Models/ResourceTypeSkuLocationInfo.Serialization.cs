...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceTypeSkuLocationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceTypeSkuLocationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceTypeSkuLocationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ResourceTypeSkuLocationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
