...
{
    public partial class CheckNameAvailabilitySpecifications : IUtf8JsonSerializable, IJsonModel<CheckNameAvailabilitySpecifications>, IPersistableModel<CheckNameAvailabilitySpecifications>
    {
        ...
        void IJsonModel<CheckNameAvailabilitySpecifications>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CheckNameAvailabilitySpecifications)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsDefaultValidationEnabled))
            {
                builder.Append("  enableDefaultValidation:");
                var boolValue = IsDefaultValidationEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsCollectionDefined(ResourceTypesWithCustomValidation))
            {
                builder.Append("  resourceTypesWithCustomValidation:");
                builder.AppendLine(" [");
                foreach (var item in ResourceTypesWithCustomValidation)
                {
                    if (item == null)
