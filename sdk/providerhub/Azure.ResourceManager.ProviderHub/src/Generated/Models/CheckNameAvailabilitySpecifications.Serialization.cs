...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CheckNameAvailabilitySpecifications>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CheckNameAvailabilitySpecifications>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CheckNameAvailabilitySpecifications>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CheckNameAvailabilitySpecifications>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
