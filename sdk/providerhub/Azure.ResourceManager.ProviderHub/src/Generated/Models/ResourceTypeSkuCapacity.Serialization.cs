...
{
    public partial class ResourceTypeSkuCapacity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ResourceTypeSkuCapacity DeserializeResourceTypeSkuCapacity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
