...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceTypeSkuCost>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceTypeSkuCost>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceTypeSkuCost>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceTypeSkuCost>)} interface");
            }
        ...
        string IPersistableModel<ResourceTypeSkuCost>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
