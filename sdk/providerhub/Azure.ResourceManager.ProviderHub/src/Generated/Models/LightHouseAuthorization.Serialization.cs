...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LightHouseAuthorization>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LightHouseAuthorization>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LightHouseAuthorization>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LightHouseAuthorization>)} interface");
            }
        ...
        string IPersistableModel<LightHouseAuthorization>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
