...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class LightHouseAuthorization : IJsonModel<LightHouseAuthorization>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<LightHouseAuthorization>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LightHouseAuthorization IJsonModel<LightHouseAuthorization>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual LightHouseAuthorization JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<LightHouseAuthorization>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LightHouseAuthorization DeserializeLightHouseAuthorization(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new LightHouseAuthorization(principalId, roleDefinitionId, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<LightHouseAuthorization>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LightHouseAuthorization IPersistableModel<LightHouseAuthorization>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual LightHouseAuthorization PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<LightHouseAuthorization>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
