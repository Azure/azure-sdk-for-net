...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IdentityManagement>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IdentityManagement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IdentityManagement>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IdentityManagement>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
