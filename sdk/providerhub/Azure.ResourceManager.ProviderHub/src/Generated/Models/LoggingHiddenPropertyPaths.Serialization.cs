...
{
    public partial class LoggingHiddenPropertyPaths : IUtf8JsonSerializable, IJsonModel<LoggingHiddenPropertyPaths>, IPersistableModel<LoggingHiddenPropertyPaths>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(HiddenPathsOnRequest))
            {
                builder.Append("  hiddenPathsOnRequest:");
                builder.AppendLine(" [");
                foreach (var item in HiddenPathsOnRequest)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(HiddenPathsOnResponse))
            {
                builder.Append("  hiddenPathsOnResponse:");
                builder.AppendLine(" [");
                foreach (var item in HiddenPathsOnResponse)
                {
                    if (item == null)
