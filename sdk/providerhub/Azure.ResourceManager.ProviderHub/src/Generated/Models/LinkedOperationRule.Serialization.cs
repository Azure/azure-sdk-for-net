...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinkedOperationRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinkedOperationRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkedOperationRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkedOperationRule>)} interface");
            }
        ...
        string IPersistableModel<LinkedOperationRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
