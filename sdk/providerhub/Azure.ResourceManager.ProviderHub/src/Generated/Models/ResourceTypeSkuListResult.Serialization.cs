...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        internal static ResourceTypeSkuListResult DeserializeResourceTypeSkuListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
