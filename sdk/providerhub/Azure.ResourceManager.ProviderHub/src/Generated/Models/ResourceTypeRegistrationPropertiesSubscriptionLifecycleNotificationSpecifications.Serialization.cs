...
{
    public partial class ResourceTypeRegistrationPropertiesSubscriptionLifecycleNotificationSpecifications : IUtf8JsonSerializable
    {
        ...
        internal static ResourceTypeRegistrationPropertiesSubscriptionLifecycleNotificationSpecifications DeserializeResourceTypeRegistrationPropertiesSubscriptionLifecycleNotificationSpecifications(JsonElement element)
        {
            ...
            return new ResourceTypeRegistrationPropertiesSubscriptionLifecycleNotificationSpecifications(Optional.ToList(subscriptionStateOverrideActions), Optional.ToNullable(softDeleteTTL));
        }
    }
}
