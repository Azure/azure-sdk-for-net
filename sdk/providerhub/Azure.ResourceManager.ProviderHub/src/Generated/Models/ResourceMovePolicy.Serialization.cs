...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceMovePolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceMovePolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceMovePolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceMovePolicy>)} interface");
            }
        ...
        string IPersistableModel<ResourceMovePolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
