...
{
    public partial class ResourceMovePolicy : IUtf8JsonSerializable, IJsonModel<ResourceMovePolicy>, IPersistableModel<ResourceMovePolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsValidationRequired))
            {
                ...
                var boolValue = IsValidationRequired.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsCrossResourceGroupMoveEnabled))
            {
                builder.Append("  crossResourceGroupMoveEnabled:");
                var boolValue = IsCrossResourceGroupMoveEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsCrossSubscriptionMoveEnabled))
            {
                builder.Append("  crossSubscriptionMoveEnabled:");
                var boolValue = IsCrossSubscriptionMoveEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
