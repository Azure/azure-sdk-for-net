...
{
    public partial class ResourceMovePolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ResourceMovePolicy DeserializeResourceMovePolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
