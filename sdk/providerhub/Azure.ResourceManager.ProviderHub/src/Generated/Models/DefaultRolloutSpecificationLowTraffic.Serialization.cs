...
{
    public partial class DefaultRolloutSpecificationLowTraffic : IUtf8JsonSerializable
    {
        ...
        internal static DefaultRolloutSpecificationLowTraffic DeserializeDefaultRolloutSpecificationLowTraffic(JsonElement element)
        {
            ...
            return new DefaultRolloutSpecificationLowTraffic(Optional.ToList(regions), Optional.ToNullable(waitDuration));
        }
    }
}
