...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class ResourceTypeSkuLocationInfo
    {
        ...
        internal ResourceTypeSkuLocationInfo(AzureLocation location, IList<string> zones, IList<ResourceTypeSkuZoneDetail> zoneDetails, IList<string> extendedLocations, ProviderExtendedLocationType? locationType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Location = location;
            Zones = zones;
