...
{
    public partial class ProviderRegistrationProperties : IUtf8JsonSerializable, IJsonModel<ProviderRegistrationProperties>, IPersistableModel<ProviderRegistrationProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProviderHubMetadata))
            {
                ...
                AppendChildObject(builder, ProviderHubMetadata, options, 2);
            }
