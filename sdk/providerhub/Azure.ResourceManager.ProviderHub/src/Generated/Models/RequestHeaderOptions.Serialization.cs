...
{
    internal partial class RequestHeaderOptions : IUtf8JsonSerializable, IJsonModel<RequestHeaderOptions>, IPersistableModel<RequestHeaderOptions>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OptInHeaders))
            {
                builder.Append("  optInHeaders:");
                builder.AppendLine($" '{OptInHeaders.ToString()}'");
            }
