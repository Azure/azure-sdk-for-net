...
namespace Azure.ResourceManager.ProviderHub.Models
{
    public partial class DefaultRolloutStatus : IUtf8JsonSerializable, IModelJsonSerializable<DefaultRolloutStatus>
    {
        ...
        internal static DefaultRolloutStatus DeserializeDefaultRolloutStatus(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DefaultRolloutStatus(Optional.ToList(completedRegions), Optional.ToDictionary(failedOrSkippedRegions), Optional.ToNullable(nextTrafficRegion), Optional.ToNullable(nextTrafficRegionScheduledTime), Optional.ToNullable(subscriptionReregistrationResult), serializedAdditionalRawData);
        }
