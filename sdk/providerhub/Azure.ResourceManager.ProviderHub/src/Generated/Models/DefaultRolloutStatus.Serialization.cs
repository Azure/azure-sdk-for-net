...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefaultRolloutStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DefaultRolloutStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DefaultRolloutStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DefaultRolloutStatus>)} interface");
            }
        ...
        string IPersistableModel<DefaultRolloutStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
