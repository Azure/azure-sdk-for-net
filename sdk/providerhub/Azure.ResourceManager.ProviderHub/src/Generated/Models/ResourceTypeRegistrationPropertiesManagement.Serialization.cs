...
{
    public partial class ResourceTypeRegistrationPropertiesManagement : IUtf8JsonSerializable, IJsonModel<ResourceTypeRegistrationPropertiesManagement>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceTypeRegistrationPropertiesManagement>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceTypeRegistrationPropertiesManagement>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ResourceTypeRegistrationPropertiesManagement IJsonModel<ResourceTypeRegistrationPropertiesManagement>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceTypeRegistrationPropertiesManagement>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ResourceTypeRegistrationPropertiesManagement DeserializeResourceTypeRegistrationPropertiesManagement(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ResourceTypeRegistrationPropertiesManagement>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceTypeRegistrationPropertiesManagement>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ResourceTypeRegistrationPropertiesManagement IPersistableModel<ResourceTypeRegistrationPropertiesManagement>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ResourceTypeRegistrationPropertiesManagement>)this).GetFormatFromOptions(options) : options.Format;
