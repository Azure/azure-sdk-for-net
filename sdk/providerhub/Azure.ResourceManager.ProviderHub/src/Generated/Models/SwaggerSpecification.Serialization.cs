...
{
    public partial class SwaggerSpecification : IUtf8JsonSerializable, IJsonModel<SwaggerSpecification>, IPersistableModel<SwaggerSpecification>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SwaggerSpecFolderUri))
            {
                builder.Append("  swaggerSpecFolderUri:");
                builder.AppendLine($" '{SwaggerSpecFolderUri.AbsoluteUri}'");
            }
