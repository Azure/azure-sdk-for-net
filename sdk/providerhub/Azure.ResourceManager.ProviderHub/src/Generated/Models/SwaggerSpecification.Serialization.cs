...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwaggerSpecification>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SwaggerSpecification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SwaggerSpecification>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SwaggerSpecification>)} interface");
            }
        ...
        string IPersistableModel<SwaggerSpecification>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
