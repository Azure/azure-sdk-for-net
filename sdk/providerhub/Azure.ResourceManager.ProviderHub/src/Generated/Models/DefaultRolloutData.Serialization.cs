...
namespace Azure.ResourceManager.ProviderHub
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefaultRolloutData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DefaultRolloutData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DefaultRolloutData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DefaultRolloutData>)} interface");
            }
        ...
        string IPersistableModel<DefaultRolloutData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
