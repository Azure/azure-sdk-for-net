...
{
    public partial class DefaultRolloutData : IUtf8JsonSerializable, IJsonModel<DefaultRolloutData>, IPersistableModel<DefaultRolloutData>
    {
        ...
        void IJsonModel<DefaultRolloutData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DefaultRolloutData)} does not support '{format}' format.");
            }
