...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        internal static ResourceProviderManifest DeserializeResourceProviderManifest(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
