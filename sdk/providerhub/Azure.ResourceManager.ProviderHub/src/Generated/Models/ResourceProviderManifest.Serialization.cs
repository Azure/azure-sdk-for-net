...
{
    public partial class ResourceProviderManifest : IUtf8JsonSerializable, IJsonModel<ResourceProviderManifest>, IPersistableModel<ResourceProviderManifest>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReRegisterSubscriptionMetadata))
            {
                ...
                AppendChildObject(builder, ReRegisterSubscriptionMetadata, options, 2);
            }
