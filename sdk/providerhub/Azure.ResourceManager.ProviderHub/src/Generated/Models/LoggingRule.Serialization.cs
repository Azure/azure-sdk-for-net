...
{
    public partial class LoggingRule : IUtf8JsonSerializable, IJsonModel<LoggingRule>, IPersistableModel<LoggingRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DetailLevel))
            {
                ...
                builder.AppendLine($" '{DetailLevel.ToString()}'");
            }

            if (Optional.IsDefined(HiddenPropertyPaths))
            {
                builder.Append("  hiddenPropertyPaths:");
                AppendChildObject(builder, HiddenPropertyPaths, options, 2);
            }
