...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CanaryTrafficRegionRolloutConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CanaryTrafficRegionRolloutConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CanaryTrafficRegionRolloutConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CanaryTrafficRegionRolloutConfiguration>)} interface");
            }
        ...
        string IPersistableModel<CanaryTrafficRegionRolloutConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
