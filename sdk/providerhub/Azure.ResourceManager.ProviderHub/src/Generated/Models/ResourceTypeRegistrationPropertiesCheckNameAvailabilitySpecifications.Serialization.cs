...
{
    public partial class ResourceTypeRegistrationPropertiesCheckNameAvailabilitySpecifications : IUtf8JsonSerializable
    {
        ...
        internal static ResourceTypeRegistrationPropertiesCheckNameAvailabilitySpecifications DeserializeResourceTypeRegistrationPropertiesCheckNameAvailabilitySpecifications(JsonElement element)
        {
            ...
            return new ResourceTypeRegistrationPropertiesCheckNameAvailabilitySpecifications(Optional.ToNullable(enableDefaultValidation), Optional.ToList(resourceTypesWithCustomValidation));
        }
    }
}
