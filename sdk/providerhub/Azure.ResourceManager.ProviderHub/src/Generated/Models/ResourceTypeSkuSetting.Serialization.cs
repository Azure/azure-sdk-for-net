...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceTypeSkuSetting>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceTypeSkuSetting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceTypeSkuSetting>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceTypeSkuSetting>)} interface");
            }
        ...
        string IPersistableModel<ResourceTypeSkuSetting>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
