...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class ThrottlingRule
    {
        ...
        internal ThrottlingRule(string action, IList<ThrottlingMetric> metrics, IList<string> requiredFeatures, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Action = action;
            Metrics = metrics;
