...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class ProviderRegistrationProperties : ResourceProviderManifestProperties
    {
        ...
        internal ProviderRegistrationProperties(ResourceProviderAuthentication providerAuthentication, IList<ResourceProviderAuthorization> providerAuthorizations, string @namespace, IList<ResourceProviderService> services, string serviceName, string providerVersion, ResourceProviderType? providerType, IList<string> requiredFeatures, ProviderFeaturesRule featuresRule, ProviderRequestHeaderOptions requestHeaderOptions, ResourceProviderManagement management, IList<ResourceProviderCapabilities> capabilities, CrossTenantTokenValidation? crossTenantTokenValidation, BinaryData metadata, TemplateDeploymentOptions templateDeploymentOptions, IList<ResourceProviderEndpoint> globalNotificationEndpoints, bool? enableTenantLinkedNotification, IList<ProviderNotification> notifications, IList<FanoutLinkedNotificationRule> linkedNotificationRules, ResourceProviderAuthorizationRules resourceProviderAuthorizationRules, ProviderNotificationOption? notificationOptions, IList<ResourceHydrationAccount> resourceHydrationAccounts, ResourceProviderManifestNotificationSettings notificationSettings, IList<ResourceProviderEndpoint> managementGroupGlobalNotificationEndpoints, IList<string> optionalFeatures, ResourceProviderManifestResourceGroupLockOptionDuringMove resourceGroupLockOptionDuringMove, ResourceProviderManifestResponseOptions responseOptions, string legacyNamespace, IList<string> legacyRegistrations, string customManifestVersion, IDictionary<string, BinaryData> additionalBinaryDataProperties, ProviderHubMetadata providerHubMetadata, ProviderHubProvisioningState? provisioningState, SubscriptionLifecycleNotificationSpecifications subscriptionLifecycleNotificationSpecifications, PrivateResourceProviderConfiguration privateResourceProviderConfiguration, TokenAuthConfiguration tokenAuthConfiguration, string oboSubscriptionId, bool? enablePresetResourceTypes) : base(providerAuthentication, providerAuthorizations, @namespace, services, serviceName, providerVersion, providerType, requiredFeatures, featuresRule, requestHeaderOptions, management, capabilities, crossTenantTokenValidation, metadata, templateDeploymentOptions, globalNotificationEndpoints, enableTenantLinkedNotification, notifications, linkedNotificationRules, resourceProviderAuthorizationRules, notificationOptions, resourceHydrationAccounts, notificationSettings, managementGroupGlobalNotificationEndpoints, optionalFeatures, resourceGroupLockOptionDuringMove, responseOptions, legacyNamespace, legacyRegistrations, customManifestVersion, additionalBinaryDataProperties)
        {
            ...
            OboSubscriptionId = oboSubscriptionId;
            EnablePresetResourceTypes = enablePresetResourceTypes;
        }
        ...
        /// <summary> The on behalf of subscription id for the resource provider. </summary>
        public string OboSubscriptionId { get; set; }

        /// <summary> Indicates whether automatic registration for the preset resource types is enabled or disabled. </summary>
        public bool? EnablePresetResourceTypes { get; set; }
