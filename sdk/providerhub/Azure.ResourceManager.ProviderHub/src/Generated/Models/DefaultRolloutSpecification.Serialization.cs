...
{
    public partial class DefaultRolloutSpecification : IUtf8JsonSerializable, IJsonModel<DefaultRolloutSpecification>, IPersistableModel<DefaultRolloutSpecification>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LowTraffic))
            {
                ...
                AppendChildObject(builder, LowTraffic, options, 2);
            }

            if (Optional.IsDefined(MediumTraffic))
            {
                builder.Append("  mediumTraffic:");
                AppendChildObject(builder, MediumTraffic, options, 2);
            }

            if (Optional.IsDefined(HighTraffic))
            {
                builder.Append("  highTraffic:");
                AppendChildObject(builder, HighTraffic, options, 2);
            }

            if (Optional.IsDefined(RestOfTheWorldGroupOne))
            {
                builder.Append("  restOfTheWorldGroupOne:");
                AppendChildObject(builder, RestOfTheWorldGroupOne, options, 2);
            }

            if (Optional.IsDefined(RestOfTheWorldGroupTwo))
            {
                builder.Append("  restOfTheWorldGroupTwo:");
                AppendChildObject(builder, RestOfTheWorldGroupTwo, options, 2);
            }
