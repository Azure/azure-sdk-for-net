...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtensionOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExtensionOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtensionOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtensionOptions>)} interface");
            }
        ...
        string IPersistableModel<ExtensionOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
