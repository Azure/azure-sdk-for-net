...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        internal static ResourceProviderEndpoint DeserializeResourceProviderEndpoint(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
