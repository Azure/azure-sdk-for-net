...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceProviderEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceProviderEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceProviderEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceProviderEndpoint>)} interface");
            }
        ...
        string IPersistableModel<ResourceProviderEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
