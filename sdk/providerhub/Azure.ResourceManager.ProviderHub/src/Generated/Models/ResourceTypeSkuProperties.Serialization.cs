...
{
    public partial class ResourceTypeSkuProperties : IUtf8JsonSerializable, IJsonModel<ResourceTypeSkuProperties>, IPersistableModel<ResourceTypeSkuProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(SkuSettings))
            {
                builder.Append("  skuSettings:");
                builder.AppendLine(" [");
                foreach (var item in SkuSettings)
                {
