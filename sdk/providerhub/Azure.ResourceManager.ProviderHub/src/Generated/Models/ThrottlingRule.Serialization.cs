...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ThrottlingRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ThrottlingRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ThrottlingRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ThrottlingRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
