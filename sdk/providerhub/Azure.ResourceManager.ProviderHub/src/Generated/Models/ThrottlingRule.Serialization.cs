...
{
    public partial class ThrottlingRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ThrottlingRule DeserializeThrottlingRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
