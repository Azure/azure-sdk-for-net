...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class ResourceTypeSkuZoneDetail
    {
        ...
        internal ResourceTypeSkuZoneDetail(IList<string> name, IList<ResourceSkuCapability> capabilities, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
