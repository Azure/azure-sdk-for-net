...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceProviderManagement>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceProviderManagement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceProviderManagement>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceProviderManagement>)} interface");
            }
        ...
        string IPersistableModel<ResourceProviderManagement>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
