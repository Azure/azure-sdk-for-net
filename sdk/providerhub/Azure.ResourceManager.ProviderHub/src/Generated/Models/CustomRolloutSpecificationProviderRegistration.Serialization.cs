...
{
    public partial class CustomRolloutSpecificationProviderRegistration : IUtf8JsonSerializable
    {
        ...
        internal static CustomRolloutSpecificationProviderRegistration DeserializeCustomRolloutSpecificationProviderRegistration(JsonElement element)
        {
            ...
            return new CustomRolloutSpecificationProviderRegistration(id, name, type, systemData.Value, properties.Value);
        }
    }
}
