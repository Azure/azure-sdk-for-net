...
{
    public partial class TrafficRegionRolloutConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TrafficRegionRolloutConfiguration DeserializeTrafficRegionRolloutConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
