...
{
    public partial class TrafficRegionRolloutConfiguration : IUtf8JsonSerializable, IJsonModel<TrafficRegionRolloutConfiguration>, IPersistableModel<TrafficRegionRolloutConfiguration>
    {
        ...
        void IJsonModel<TrafficRegionRolloutConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TrafficRegionRolloutConfiguration)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WaitDuration))
            {
                builder.Append("  waitDuration:");
                var formattedTimeSpan = XmlConvert.ToString(WaitDuration.Value);
