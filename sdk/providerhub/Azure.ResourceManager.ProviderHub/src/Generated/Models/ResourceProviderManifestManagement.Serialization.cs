...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class ResourceProviderManifestManagement : ResourceProviderManagement, IJsonModel<ResourceProviderManifestManagement>
    {
        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<ResourceProviderManifestManagement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceProviderManifestManagement>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceProviderManifestManagement)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceProviderManifestManagement IJsonModel<ResourceProviderManifestManagement>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ResourceProviderManifestManagement)JsonModelCreateCore(ref reader, options);
        ...
        protected override ResourceProviderManagement JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceProviderManifestManagement)} does not support reading '{format}' format.");
            }
            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeResourceProviderManifestManagement(document.RootElement, options);
        }

        /// <param name="element"> The JSON element to deserialize. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ResourceProviderManifestManagement DeserializeResourceProviderManifestManagement(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ResourceProviderManifestManagement(
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourceProviderManifestManagement>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceProviderManifestManagement)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceProviderManifestManagement IPersistableModel<ResourceProviderManifestManagement>.Create(BinaryData data, ModelReaderWriterOptions options) => (ResourceProviderManifestManagement)PersistableModelCreateCore(data, options);
        ...
        protected override ResourceProviderManagement PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceProviderManifestManagement)} does not support reading '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ResourceProviderManifestManagement>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
