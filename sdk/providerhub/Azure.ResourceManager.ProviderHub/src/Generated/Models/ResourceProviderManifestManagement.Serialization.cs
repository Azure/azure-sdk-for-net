...
{
    public partial class ResourceProviderManifestManagement : IUtf8JsonSerializable
    {
        ...
        internal static ResourceProviderManifestManagement DeserializeResourceProviderManifestManagement(JsonElement element)
        {
            ...
            return new ResourceProviderManifestManagement(Optional.ToList(schemaOwners), Optional.ToList(manifestOwners), incidentRoutingService.Value, incidentRoutingTeam.Value, incidentContactEmail.Value, Optional.ToList(serviceTreeInfos), Optional.ToNullable(resourceAccessPolicy), Optional.ToList(resourceAccessRoles));
        }
    }
}
