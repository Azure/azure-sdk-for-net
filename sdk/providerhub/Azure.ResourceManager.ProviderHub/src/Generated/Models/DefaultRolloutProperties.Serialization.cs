        ...
        internal static DefaultRolloutProperties DeserializeDefaultRolloutProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("specification"u8))
                {
                    ...
                    specification = ModelSerializationExtensions.JsonDeserialize<DefaultRolloutSpecification>(property.Value);
                    continue;
                }
                if (property.NameEquals("status"u8))
                {
                    ...
                    status = ModelSerializationExtensions.JsonDeserialize<DefaultRolloutStatus>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
