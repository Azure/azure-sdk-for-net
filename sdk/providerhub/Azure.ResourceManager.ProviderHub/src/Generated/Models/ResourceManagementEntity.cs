...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class ResourceManagementEntity
    {
        ...
        internal ResourceManagementEntity(string resourceId, string homeTenantId, AzureLocation? location, string status, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ResourceId = resourceId;
