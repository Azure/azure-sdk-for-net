...
{
    public partial class ResourceTypeEndpoint : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ResourceTypeEndpoint DeserializeResourceTypeEndpoint(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
