...
{
    public partial class ProviderDstsConfiguration : IUtf8JsonSerializable, IJsonModel<ProviderDstsConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProviderDstsConfiguration>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProviderDstsConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ProviderDstsConfiguration IJsonModel<ProviderDstsConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProviderDstsConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ProviderDstsConfiguration DeserializeProviderDstsConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ProviderDstsConfiguration(serviceName, serviceDnsName, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<ProviderDstsConfiguration>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProviderDstsConfiguration>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ProviderDstsConfiguration IPersistableModel<ProviderDstsConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ProviderDstsConfiguration>)this).GetFormatFromOptions(options) : options.Format;
