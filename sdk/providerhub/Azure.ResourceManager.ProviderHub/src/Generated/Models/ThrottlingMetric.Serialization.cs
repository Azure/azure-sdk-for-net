...
{
    public partial class ThrottlingMetric : IUtf8JsonSerializable, IJsonModel<ThrottlingMetric>, IPersistableModel<ThrottlingMetric>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{MetricType.ToString()}'");
            }
