...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceTypeRegistrationProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceTypeRegistrationProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceTypeRegistrationProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceTypeRegistrationProperties>)} interface");
            }
        ...
        string IPersistableModel<ResourceTypeRegistrationProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
