...
{
    public partial class ResourceTypeRegistrationProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ResourceTypeRegistrationProperties DeserializeResourceTypeRegistrationProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
