...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class LoggingRule
    {
        ...
        internal LoggingRule(string action, LoggingDirection direction, LoggingDetail detailLevel, LoggingHiddenPropertyPaths hiddenPropertyPaths, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Action = action;
            Direction = direction;
            DetailLevel = detailLevel;
