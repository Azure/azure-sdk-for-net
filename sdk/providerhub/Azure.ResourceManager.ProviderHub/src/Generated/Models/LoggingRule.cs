...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class LoggingRule
    {
        ...
        internal LoggingRule(string action, LoggingDirection direction, LoggingDetail detailLevel, LoggingHiddenPropertyPaths hiddenPropertyPaths, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Action = action;
            Direction = direction;
            DetailLevel = detailLevel;
