...
namespace Azure.ResourceManager.ProviderHub.Models
{
    public partial class NotificationEndpoint : IUtf8JsonSerializable, IJsonModel<NotificationEndpoint>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NotificationEndpoint>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NotificationEndpoint>)} interface");
            }
