...
namespace Azure.ResourceManager.ProviderHub.Models
{
    public partial class NotificationEndpoint : IUtf8JsonSerializable, IJsonModel<NotificationEndpoint>
    {
        ...
        void IJsonModel<NotificationEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NotificationEndpoint)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NotificationEndpoint>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NotificationEndpoint)} does not support '{options.Format}' format.");
            }
        }
