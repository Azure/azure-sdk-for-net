...
{
    public partial class CustomRolloutSpecification : IUtf8JsonSerializable, IJsonModel<CustomRolloutSpecification>, IPersistableModel<CustomRolloutSpecification>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Canary))
            {
                ...
                AppendChildObject(builder, Canary, options, 2);
            }

            if (Optional.IsDefined(ProviderRegistration))
            {
                builder.Append("  providerRegistration:");
                AppendChildObject(builder, ProviderRegistration, options, 2);
            }
