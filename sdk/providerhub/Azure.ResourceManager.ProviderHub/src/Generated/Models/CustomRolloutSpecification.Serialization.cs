...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomRolloutSpecification>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomRolloutSpecification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomRolloutSpecification>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomRolloutSpecification>)} interface");
            }
        ...
        string IPersistableModel<CustomRolloutSpecification>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
