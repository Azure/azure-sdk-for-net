...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class ResourceTypeExtension
    {
        ...
        internal ResourceTypeExtension(Uri endpointUri, IList<ResourceTypeExtensionCategory> extensionCategories, TimeSpan? timeout, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
