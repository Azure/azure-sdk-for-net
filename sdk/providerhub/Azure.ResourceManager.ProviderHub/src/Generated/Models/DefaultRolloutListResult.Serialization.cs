...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DefaultRolloutListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DefaultRolloutListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DefaultRolloutListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DefaultRolloutListResult>)} interface");
            }
        ...
        string IPersistableModel<DefaultRolloutListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
