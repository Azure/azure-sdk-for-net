...
{
    internal partial class ProviderRegistrationListResult : IUtf8JsonSerializable, IJsonModel<ProviderRegistrationListResult>, IPersistableModel<ProviderRegistrationListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProviderRegistrationListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ProviderRegistrationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProviderRegistrationListResult)} does not support '{format}' format.");
            }
