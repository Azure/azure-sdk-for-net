...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProviderSubscriptionStateRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProviderSubscriptionStateRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProviderSubscriptionStateRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProviderSubscriptionStateRule>)} interface");
            }
        ...
        string IPersistableModel<ProviderSubscriptionStateRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
