...
{
    public partial class ThirdPartyProviderAuthorization : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ThirdPartyProviderAuthorization DeserializeThirdPartyProviderAuthorization(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
