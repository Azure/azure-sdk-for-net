...
{
    public partial class CustomRolloutProperties : IUtf8JsonSerializable, IJsonModel<CustomRolloutProperties>, IPersistableModel<CustomRolloutProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Specification))
            {
                ...
                AppendChildObject(builder, Specification, options, 2);
            }
