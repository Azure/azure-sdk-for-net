...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        internal static ResourceTypeRegistrationListResult DeserializeResourceTypeRegistrationListResult(JsonElement element)
        {
            ...
            return new ResourceTypeRegistrationListResult(Optional.ToList(value), nextLink.Value);
        }
    }
}
