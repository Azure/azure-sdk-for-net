...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class ExtendedErrorInfo
    {
        ...
        internal ExtendedErrorInfo(string code, string target, string message, IList<ExtendedErrorInfo> details, IList<TypedErrorInfo> additionalInfo, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Target = target;
            Message = message;
