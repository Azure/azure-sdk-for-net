...
{
    public partial class NotificationRegistrationProperties : IUtf8JsonSerializable, IJsonModel<NotificationRegistrationProperties>, IPersistableModel<NotificationRegistrationProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NotificationMode))
            {
                ...
                builder.AppendLine($" '{NotificationMode.ToString()}'");
            }

            if (Optional.IsDefined(MessageScope))
            {
                builder.Append("  messageScope:");
                builder.AppendLine($" '{MessageScope.ToString()}'");
            }
