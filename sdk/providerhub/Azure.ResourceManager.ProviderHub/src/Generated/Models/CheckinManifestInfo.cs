...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class CheckinManifestInfo
    {
        ...
        internal CheckinManifestInfo(bool isCheckedIn, string statusMessage, string pullRequest, string commitId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IsCheckedIn = isCheckedIn;
            StatusMessage = statusMessage;
