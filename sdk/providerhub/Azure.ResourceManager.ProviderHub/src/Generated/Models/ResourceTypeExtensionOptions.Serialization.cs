...
{
    internal partial class ResourceTypeExtensionOptions : IUtf8JsonSerializable, IJsonModel<ResourceTypeExtensionOptions>, IPersistableModel<ResourceTypeExtensionOptions>
    {
        ...
        void IJsonModel<ResourceTypeExtensionOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceTypeExtensionOptions)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResourceCreationBegin))
            {
                builder.Append("  resourceCreationBegin:");
                AppendChildObject(builder, ResourceCreationBegin, options, 2);
            }
