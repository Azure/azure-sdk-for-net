...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RolloutStatusBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RolloutStatusBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RolloutStatusBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RolloutStatusBase>)} interface");
            }
        ...
        string IPersistableModel<RolloutStatusBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
