...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class SubscriptionStateOverrideAction
    {
        ...
        internal SubscriptionStateOverrideAction(SubscriptionTransitioningState state, SubscriptionNotificationOperation action, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
            Action = action;
