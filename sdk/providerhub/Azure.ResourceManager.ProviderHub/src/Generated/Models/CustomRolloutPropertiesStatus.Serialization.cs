...
{
    public partial class CustomRolloutPropertiesStatus : IUtf8JsonSerializable
    {
        ...
        internal static CustomRolloutPropertiesStatus DeserializeCustomRolloutPropertiesStatus(JsonElement element)
        {
            ...
            return new CustomRolloutPropertiesStatus(Optional.ToList(completedRegions), Optional.ToDictionary(failedOrSkippedRegions));
        }
    }
}
