...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class ProviderSubscriptionStateRule
    {
        ...
        internal ProviderSubscriptionStateRule(ProviderSubscriptionState? state, IList<string> allowedActions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            State = state;
