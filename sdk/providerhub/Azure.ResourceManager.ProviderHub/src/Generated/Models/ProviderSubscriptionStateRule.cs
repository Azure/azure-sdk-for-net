...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class ProviderSubscriptionStateRule
    {
        ...
        internal ProviderSubscriptionStateRule(ProviderSubscriptionState? state, IList<string> allowedActions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
