...
namespace Azure.ResourceManager.ProviderHub.Models
{
    ...
    public partial class ResourceProviderManifestPropertiesManagement : ResourceProviderManagement, IJsonModel<ResourceProviderManifestPropertiesManagement>
    {
        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<ResourceProviderManifestPropertiesManagement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ResourceProviderManifestPropertiesManagement>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceProviderManifestPropertiesManagement)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceProviderManifestPropertiesManagement IJsonModel<ResourceProviderManifestPropertiesManagement>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ResourceProviderManifestPropertiesManagement)JsonModelCreateCore(ref reader, options);
        ...
        protected override ResourceProviderManagement JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceProviderManifestPropertiesManagement)} does not support reading '{format}' format.");
            }
            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeResourceProviderManifestPropertiesManagement(document.RootElement, options);
        }

        /// <param name="element"> The JSON element to deserialize. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ResourceProviderManifestPropertiesManagement DeserializeResourceProviderManifestPropertiesManagement(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ResourceProviderManifestPropertiesManagement>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceProviderManifestPropertiesManagement)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ResourceProviderManifestPropertiesManagement IPersistableModel<ResourceProviderManifestPropertiesManagement>.Create(BinaryData data, ModelReaderWriterOptions options) => (ResourceProviderManifestPropertiesManagement)PersistableModelCreateCore(data, options);
        ...
        protected override ResourceProviderManagement PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ResourceProviderManifestPropertiesManagement)} does not support reading '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ResourceProviderManifestPropertiesManagement>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
