...
namespace Azure.ResourceManager.ProviderHub
{
    ...
    public partial class NotificationRegistrationResource : ArmResource
    {
        ...
        internal NotificationRegistrationResource(ArmClient client, NotificationRegistrationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<NotificationRegistrationResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new NotificationRegistrationResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<NotificationRegistrationResource>> UpdateAsync(WaitUntil waitUntil, NotificationRegistrationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ProviderHubArmOperation<NotificationRegistrationResource>(Response.FromValue(new NotificationRegistrationResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
