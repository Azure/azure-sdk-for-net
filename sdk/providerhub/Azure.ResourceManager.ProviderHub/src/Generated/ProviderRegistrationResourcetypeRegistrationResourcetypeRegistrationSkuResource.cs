    ...
    public partial class ProviderRegistrationResourcetypeRegistrationResourcetypeRegistrationSkuResource : SkuResource
    {
        ...
        protected override async Task<Response<SkuResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((SkuResource)new ProviderRegistrationResourcetypeRegistrationResourcetypeRegistrationSkuResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        protected override async Task<ArmOperation<SkuResource>> UpdateCoreAsync(WaitUntil waitUntil, SkuResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ProviderHubArmOperation<SkuResource>(Response.FromValue((SkuResource)new ProviderRegistrationResourcetypeRegistrationResourcetypeRegistrationSkuResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
