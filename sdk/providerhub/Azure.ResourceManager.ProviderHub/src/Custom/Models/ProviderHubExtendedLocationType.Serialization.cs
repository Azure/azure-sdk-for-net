    ...
    internal static partial class ProviderHubExtendedLocationTypeExtensions
    {
        ...
        public static ProviderHubExtendedLocationType ToProviderHubExtendedLocationType(this string value)
        {
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "NotSpecified"))
                return ProviderHubExtendedLocationType.NotSpecified;
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "EdgeZone"))
                return ProviderHubExtendedLocationType.EdgeZone;
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "ArcZone"))
                return ProviderHubExtendedLocationType.ArcZone;
            if (StringComparer.OrdinalIgnoreCase.Equals(value, "CustomLocation"))
                return ProviderHubExtendedLocationType.CustomLocation;
