...
namespace Microsoft.Azure.Management.ProviderHub
{
    ...
    public partial class ProviderHubClient : ServiceClient<ProviderHubClient>, IProviderHubClient, IAzureClient
    {
        ...
        /// </summary>
        public virtual ICustomRolloutsOperations CustomRollouts { get; private set; }

        /// <summary>
        /// Gets the IDefaultRolloutsOperations.
        /// </summary>
        public virtual IDefaultRolloutsOperations DefaultRollouts { get; private set; }

        /// <summary>
        /// Gets the INotificationRegistrationsOperations.
        /// </summary>
        public virtual INotificationRegistrationsOperations NotificationRegistrations { get; private set; }
        ...
        /// </summary>
        public virtual IProviderRegistrationsOperations ProviderRegistrations { get; private set; }

        /// <summary>
        /// Gets the IResourceTypeRegistrationsOperations.
        /// </summary>
        public virtual IResourceTypeRegistrationsOperations ResourceTypeRegistrations { get; private set; }
        ...
        /// </return>
        public async Task<AzureOperationResponse<ResourceProviderManifest>> GenerateManifestWithHttpMessagesAsync(string providerNamespace, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                ServiceClientTracing.Enter(_invocationId, this, "GenerateManifest", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.ProviderHub/providerRegistrations/{providerNamespace}/generateManifest").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<ResourceProviderManifest>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<ResourceProviderManifest>(_responseContent, DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<CheckinManifestInfo>> CheckinManifestWithHttpMessagesAsync(string providerNamespace, CheckinManifestParams checkinManifestParams, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.SubscriptionId");
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "checkinManifestParams");
            }
            if (ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.ApiVersion");
            ...
            if (_shouldTrace)
            {
                ...
                Dictionary<string, object> tracingParameters = new Dictionary<string, object>();
                tracingParameters.Add("providerNamespace", providerNamespace);
                tracingParameters.Add("checkinManifestParams", checkinManifestParams);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "CheckinManifest", tracingParameters);
            }
            // Construct URL
            var _baseUrl = BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.ProviderHub/providerRegistrations/{providerNamespace}/checkinManifest").ToString();
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(SubscriptionId));
            _url = _url.Replace("{providerNamespace}", System.Uri.EscapeDataString(providerNamespace));
            List<string> _queryParameters = new List<string>();
            if (ApiVersion != null)
            ...
            if(checkinManifestParams != null)
            {
                _requestContent = SafeJsonConvert.SerializeObject(checkinManifestParams, SerializationSettings);
            ...
            // Create Result
            var _result = new AzureOperationResponse<CheckinManifestInfo>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = SafeJsonConvert.DeserializeObject<CheckinManifestInfo>(_responseContent, DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
