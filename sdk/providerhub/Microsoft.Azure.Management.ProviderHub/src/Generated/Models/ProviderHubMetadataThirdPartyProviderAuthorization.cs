...
namespace Microsoft.Azure.Management.ProviderHub.Models
{
    ...
    public partial class ProviderHubMetadataThirdPartyProviderAuthorization : ThirdPartyProviderAuthorization
    {
        ...
        /// ProviderHubMetadataThirdPartyProviderAuthorization class.
        /// </summary>
        public ProviderHubMetadataThirdPartyProviderAuthorization(IList<LightHouseAuthorization> authorizations = default(IList<LightHouseAuthorization>), string managedByTenantId = default(string))
            : base(authorizations, managedByTenantId)
        {
            CustomInit();
        }
