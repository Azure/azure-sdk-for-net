...
{
    public class ProviderHubMockContext : MockContext
    {
        /// <summary>
        /// Real mock context
        /// </summary>
        ...
        /// Ctor
        /// </summary>
        private ProviderHubMockContext()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public new static ProviderHubMockContext Start(
            Type typeName,
            [System.Runtime.CompilerServices.CallerMemberName]
            string methodName= "testframework_failed")
        {
            var context = new ProviderHubMockContext
            {
