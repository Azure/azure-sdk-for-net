    ...
    internal partial class DependencyOfRelationshipsByServiceGroupGetAllAsyncCollectionResultOfT : AsyncPageable<DependencyOfRelationshipData>
    {
        ...
        public override async IAsyncEnumerable<Page<DependencyOfRelationshipData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                DependencyOfRelationshipListResult result = DependencyOfRelationshipListResult.FromResponse(response);
                nextPage = result.NextLink;
                yield return Page<DependencyOfRelationshipData>.FromValues((IReadOnlyList<DependencyOfRelationshipData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
                if (nextPage == null)
                {
                    yield break;
                }
