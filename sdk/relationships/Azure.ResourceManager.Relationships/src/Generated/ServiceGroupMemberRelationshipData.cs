...
namespace Azure.ResourceManager.Relationships
{
    ...
    public partial class ServiceGroupMemberRelationshipData : ResourceData
    {
        ...
        internal ServiceGroupMemberRelationshipData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ServiceGroupMemberRelationshipProperties properties) : base(id, name, resourceType, systemData)
        {
