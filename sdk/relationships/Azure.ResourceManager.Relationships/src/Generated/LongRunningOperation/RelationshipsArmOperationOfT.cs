...
#pragma warning disable SA1649 // File name should match first type name
    internal class RelationshipsArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of RelationshipsArmOperation for mocking. </summary>
        protected RelationshipsArmOperation()
        {
        }

        internal RelationshipsArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal RelationshipsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "RelationshipsArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var data = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerRelationshipsContext.Default);
