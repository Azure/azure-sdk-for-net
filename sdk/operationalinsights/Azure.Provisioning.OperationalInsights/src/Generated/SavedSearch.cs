...
namespace Azure.Provisioning.OperationalInsights
{
    ...
    public partial class SavedSearch : ProvisionableResource
    {
        ...
        /// <summary> Creates a new SavedSearch. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public SavedSearch(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.OperationalInsights/workspaces/savedSearches", resourceVersion ?? "2025-07-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for SavedSearch. </summary>
        ...
        /// <summary> Creates a reference to an existing SavedSearch. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static SavedSearch FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            SavedSearch result = new SavedSearch(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for SavedSearch that are not part of the generated code. </summary>
