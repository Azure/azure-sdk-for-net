...
namespace Azure.Provisioning.OperationalInsights
{
    ...
    public partial class DataExport : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DataExport. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DataExport(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.OperationalInsights/workspaces/dataExports", resourceVersion ?? "2025-07-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DataExport. </summary>
        ...
        /// <summary> Creates a reference to an existing DataExport. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DataExport FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DataExport result = new DataExport(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DataExport that are not part of the generated code. </summary>
