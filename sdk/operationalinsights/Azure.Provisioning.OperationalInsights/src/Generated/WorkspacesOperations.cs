...
namespace Azure.Provisioning.OperationalInsights
{
    ...
    public partial class WorkspacesOperations : ProvisionableResource
    {
        ...
        /// <summary> Creates a new WorkspacesOperations. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public WorkspacesOperations(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.OperationalInsights/workspaces/operations", resourceVersion ?? "2025-07-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for WorkspacesOperations. </summary>
        ...
        /// <summary> Creates a reference to an existing WorkspacesOperations. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static WorkspacesOperations FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            WorkspacesOperations result = new WorkspacesOperations(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for WorkspacesOperations that are not part of the generated code. </summary>
