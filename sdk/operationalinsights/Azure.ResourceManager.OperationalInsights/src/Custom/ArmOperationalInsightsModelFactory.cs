...
{
    [CodeGenSuppress(
        "OperationalInsightsSummaryLogsData",
        typeof(ResourceIdentifier),
        typeof(string),
        typeof(ResourceType),
        typeof(SystemData),
        typeof(OperationalInsightsSummaryLogsRuleType?),
        typeof(string),
        typeof(string),
        typeof(bool?),
        typeof(OperationalInsightsSummaryLogsStatusCode?),
        typeof(OperationalInsightsSummaryLogsProvisioningState?),
        typeof(OperationalInsightsSummaryRule))]
    public static partial class ArmOperationalInsightsModelFactory
    {
        ...
        /// <returns> A new <see cref="OperationalInsightsSummaryLogsData"/> instance for mocking. </returns>
