...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    public partial class LogAnalyticsQueryData : ResourceData
    {
        ...
        internal LogAnalyticsQueryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Guid? applicationId, string displayName, DateTimeOffset? createdOn, DateTimeOffset? modifiedOn, string author, string description, string body, LogAnalyticsQueryRelatedMetadata related, IDictionary<string, IList<string>> tags, BinaryData properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
