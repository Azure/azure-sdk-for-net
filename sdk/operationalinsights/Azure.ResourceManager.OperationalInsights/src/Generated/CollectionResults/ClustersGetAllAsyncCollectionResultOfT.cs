...
{
    internal partial class ClustersGetAllAsyncCollectionResultOfT : AsyncPageable<OperationalInsightsClusterData>
    {
        ...
        public ClustersGetAllAsyncCollectionResultOfT(Clusters client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<OperationalInsightsClusterData>> AsPages(string continuationToken, int? pageSizeHint)
        {
