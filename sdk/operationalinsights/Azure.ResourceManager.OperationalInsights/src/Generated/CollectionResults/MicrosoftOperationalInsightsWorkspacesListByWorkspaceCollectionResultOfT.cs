...
{
    internal partial class MicrosoftOperationalInsightsWorkspacesListByWorkspaceCollectionResultOfT : Pageable<OperationalInsightsAvailableServiceTier>
    {
        ...
        /// <summary> Initializes a new instance of MicrosoftOperationalInsightsWorkspacesListByWorkspaceCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public MicrosoftOperationalInsightsWorkspacesListByWorkspaceCollectionResultOfT(AvailableServiceTiers client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MicrosoftOperationalInsightsWorkspacesListByWorkspaceCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of MicrosoftOperationalInsightsWorkspacesListByWorkspaceCollectionResultOfT as an enumerable collection. </returns>
