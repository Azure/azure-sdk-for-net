...
namespace Azure.ResourceManager.OperationalInsights
{
    internal partial class SummaryLogsGetByWorkspaceAsyncCollectionResultOfT : AsyncPageable<OperationalInsightsSummaryLogsData>
    {
        ...
        /// <summary> Initializes a new instance of SummaryLogsGetByWorkspaceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SummaryLogsGetByWorkspaceAsyncCollectionResultOfT(SummaryLogs client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of SummaryLogsGetByWorkspaceAsyncCollectionResultOfT as an enumerable collection. </summary>
