...
{
    internal partial class ClustersGetByResourceGroupCollectionResultOfT : Pageable<OperationalInsightsClusterData>
    {
        ...
        public ClustersGetByResourceGroupCollectionResultOfT(Clusters client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
