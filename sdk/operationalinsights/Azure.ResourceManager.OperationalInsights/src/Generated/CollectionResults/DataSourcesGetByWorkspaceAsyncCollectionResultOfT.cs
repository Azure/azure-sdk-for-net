...
{
    internal partial class DataSourcesGetByWorkspaceAsyncCollectionResultOfT : AsyncPageable<OperationalInsightsDataSourceData>
    {
        private readonly DataSources _client;
        ...
        /// <summary> Initializes a new instance of DataSourcesGetByWorkspaceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The DataSources client used to send requests. </param>
        ...
        /// <summary> Gets the pages of DataSourcesGetByWorkspaceAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DataSourcesGetByWorkspaceAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<OperationalInsightsDataSourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
