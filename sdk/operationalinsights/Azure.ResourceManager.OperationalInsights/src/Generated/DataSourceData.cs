...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    public partial class DataSourceData : ResourceData
    {
        ...
        public DataSourceData(BinaryData properties, DataSourceKind kind)
        {
            if (properties == null)
            {
        ...
        internal DataSourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BinaryData properties, ETag? etag, DataSourceKind kind, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
            ETag = etag;
            Kind = kind;
