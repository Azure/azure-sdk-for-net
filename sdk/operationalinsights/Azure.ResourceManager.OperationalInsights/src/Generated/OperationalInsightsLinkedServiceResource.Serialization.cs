...
namespace Azure.ResourceManager.OperationalInsights
{
    public partial class OperationalInsightsLinkedServiceResource : IJsonModel<OperationalInsightsLinkedServiceData>
    {
        ...
        {
            return ModelReaderWriter.Read<OperationalInsightsLinkedServiceData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<OperationalInsightsLinkedServiceData>(data, options);
        }
