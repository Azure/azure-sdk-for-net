...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    public partial class OperationalInsightsTableResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _operationalInsightsTableTablesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = await _operationalInsightsTableTablesRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new OperationalInsightsArmOperation(_operationalInsightsTableTablesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _operationalInsightsTableTablesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = _operationalInsightsTableTablesRestClient.Delete(message, cancellationToken);
                var operation = new OperationalInsightsArmOperation(_operationalInsightsTableTablesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<OperationalInsightsTableResource>> UpdateAsync(WaitUntil waitUntil, OperationalInsightsTableData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _operationalInsightsTableTablesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
                var response = await _operationalInsightsTableTablesRestClient.UpdateAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<OperationalInsightsTableResource> Update(WaitUntil waitUntil, OperationalInsightsTableData data, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _operationalInsightsTableTablesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
                var response = _operationalInsightsTableTablesRestClient.Update(message, cancellationToken);
                var operation = new OperationalInsightsArmOperation<OperationalInsightsTableResource>(new OperationalInsightsTableOperationSource(Client), _operationalInsightsTableTablesClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
