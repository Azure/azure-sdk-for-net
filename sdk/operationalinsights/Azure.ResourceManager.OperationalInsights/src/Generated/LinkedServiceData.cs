...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    public partial class LinkedServiceData : ResourceData
    {
        ...
        internal LinkedServiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, string resourceId, string writeAccessResourceId, LinkedServiceEntityStatus? provisioningState) : base(id, name, resourceType, systemData)
        {
            Tags = tags;
