...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    public partial class SavedSearchData : ResourceData
    {
        ...
        internal SavedSearchData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? etag, string category, string displayName, string query, string functionAlias, string functionParameters, long? version, IList<Tag> tags) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
            Category = category;
            DisplayName = displayName;
