...
namespace Azure.ResourceManager.OperationalInsights.Mocking
{
    ...
    public partial class OperationalInsightsSubscriptionMockingExtension : ArmResource
    {
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DeletedWorkspacesRestClient.CreateListRequest(Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => new OperationalInsightsWorkspaceResource(Client, OperationalInsightsWorkspaceData.DeserializeOperationalInsightsWorkspaceData(e)), DeletedWorkspacesClientDiagnostics, Pipeline, "OperationalInsightsSubscriptionMockingExtension.GetDeletedWorkspaces", "value", null, cancellationToken);
        }
    }
}
