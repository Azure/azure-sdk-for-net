...
namespace Azure.ResourceManager.OperationalInsights.Mocking
{
    ...
    internal partial class OperationalInsightsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="OperationalInsightsArmClientMockingExtension"/> class for mocking. </summary>
        protected OperationalInsightsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="OperationalInsightsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal OperationalInsightsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal OperationalInsightsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
