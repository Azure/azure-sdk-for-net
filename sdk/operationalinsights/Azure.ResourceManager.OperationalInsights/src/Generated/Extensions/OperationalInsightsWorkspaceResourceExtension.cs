...
namespace Azure.ResourceManager.OperationalInsights.Mock
{
    ...
    public partial class OperationalInsightsWorkspaceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="OperationalInsightsWorkspaceResourceExtension"/> class for mocking. </summary>
        protected OperationalInsightsWorkspaceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="OperationalInsightsWorkspaceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal OperationalInsightsWorkspaceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
