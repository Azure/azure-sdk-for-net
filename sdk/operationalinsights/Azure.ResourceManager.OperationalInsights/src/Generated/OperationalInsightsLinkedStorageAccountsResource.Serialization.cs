...
namespace Azure.ResourceManager.OperationalInsights
{
    public partial class OperationalInsightsLinkedStorageAccountsResource : IJsonModel<OperationalInsightsLinkedStorageAccountsData>
    {
        ...
        {
            return ModelReaderWriter.Read<OperationalInsightsLinkedStorageAccountsData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<OperationalInsightsLinkedStorageAccountsData>(data, options);
        }
