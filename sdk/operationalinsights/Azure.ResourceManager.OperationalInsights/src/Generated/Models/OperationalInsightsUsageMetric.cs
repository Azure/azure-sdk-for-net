...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsUsageMetric
    {
        ...
        internal OperationalInsightsUsageMetric(OperationalInsightsMetricName name, string unit, double? currentValue, double? limit, DateTimeOffset? nextResetOn, string quotaPeriod, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Unit = unit;
