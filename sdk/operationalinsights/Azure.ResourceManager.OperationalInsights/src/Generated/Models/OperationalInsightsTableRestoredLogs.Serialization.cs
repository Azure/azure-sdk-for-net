...
{
    public partial class OperationalInsightsTableRestoredLogs : IUtf8JsonSerializable, IJsonModel<OperationalInsightsTableRestoredLogs>, IPersistableModel<OperationalInsightsTableRestoredLogs>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StartRestoreOn))
            {
                ...
                builder.AppendLine($" '{StartRestoreOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(EndRestoreOn))
            {
                builder.Append("  endRestoreTime:");
                builder.AppendLine($" '{EndRestoreOn.Value.ToString()}'");
            }
