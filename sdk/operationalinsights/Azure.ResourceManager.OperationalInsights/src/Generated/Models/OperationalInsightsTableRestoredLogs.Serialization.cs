...
{
    public partial class OperationalInsightsTableRestoredLogs : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OperationalInsightsTableRestoredLogs DeserializeOperationalInsightsTableRestoredLogs(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
