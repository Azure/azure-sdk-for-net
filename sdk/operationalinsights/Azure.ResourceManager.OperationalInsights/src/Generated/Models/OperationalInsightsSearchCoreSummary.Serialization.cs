...
{
    internal partial class OperationalInsightsSearchCoreSummary : IUtf8JsonSerializable, IJsonModel<OperationalInsightsSearchCoreSummary>, IPersistableModel<OperationalInsightsSearchCoreSummary>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NumberOfDocuments))
            {
