...
namespace Azure.ResourceManager.OperationalInsights
{
    public partial class StorageInsightResource : IJsonModel<StorageInsightData>
    {
        ...
        {
            return ModelReaderWriter.Read<StorageInsightData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<StorageInsightData>(data, options);
        }
