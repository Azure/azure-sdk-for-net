...
{
    public partial class OperationalInsightsWorkspaceCapping : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OperationalInsightsWorkspaceCapping DeserializeOperationalInsightsWorkspaceCapping(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
