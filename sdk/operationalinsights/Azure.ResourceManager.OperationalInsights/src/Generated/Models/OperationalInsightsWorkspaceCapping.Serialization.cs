...
{
    public partial class OperationalInsightsWorkspaceCapping : IUtf8JsonSerializable, IJsonModel<OperationalInsightsWorkspaceCapping>, IPersistableModel<OperationalInsightsWorkspaceCapping>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataIngestionStatus))
            {
                ...
                builder.AppendLine($" '{DataIngestionStatus.ToString()}'");
            }
