...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsTableResultStatistics
    {
        ...
        internal OperationalInsightsTableResultStatistics(float? progress, int? ingestedRecords, float? scannedGB, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Progress = progress;
