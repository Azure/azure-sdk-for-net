...
{
    public partial class OperationalInsightsDataExportData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OperationalInsightsDataExportData DeserializeOperationalInsightsDataExportData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
