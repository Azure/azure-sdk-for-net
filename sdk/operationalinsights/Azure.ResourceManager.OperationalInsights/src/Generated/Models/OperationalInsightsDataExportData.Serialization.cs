...
{
    public partial class OperationalInsightsDataExportData : IUtf8JsonSerializable, IJsonModel<OperationalInsightsDataExportData>, IPersistableModel<OperationalInsightsDataExportData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{DestinationType.ToString()}'");
            }
