...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    public partial class LogAnalyticsQuerySearchRelatedMetadata : IUtf8JsonSerializable, IJsonModel<LogAnalyticsQuerySearchRelatedMetadata>
    {
        ...
        void IJsonModel<LogAnalyticsQuerySearchRelatedMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LogAnalyticsQuerySearchRelatedMetadata)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LogAnalyticsQuerySearchRelatedMetadata>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LogAnalyticsQuerySearchRelatedMetadata)} does not support '{options.Format}' format.");
            }
        }
