...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogAnalyticsQuerySearchRelatedMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogAnalyticsQuerySearchRelatedMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogAnalyticsQuerySearchRelatedMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogAnalyticsQuerySearchRelatedMetadata>)} interface");
            }
        ...
        string IPersistableModel<LogAnalyticsQuerySearchRelatedMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
