...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsTableSearchResults
    {
        ...
        internal OperationalInsightsTableSearchResults(string query, string description, int? limit, DateTimeOffset? startSearchOn, DateTimeOffset? endSearchOn, string sourceTable, Guid? azureAsyncOperationId, Dictionary<string, BinaryData> rawData)
        {
            Query = query;
