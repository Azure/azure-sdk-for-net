...
{
    public partial class OperationalInsightsManagementGroup : IUtf8JsonSerializable, IJsonModel<OperationalInsightsManagementGroup>, IPersistableModel<OperationalInsightsManagementGroup>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataReceivedOn))
            {
                ...
                builder.AppendLine($" '{DataReceivedOn.Value.ToString()}'");
            }
