...
{
    public partial class OperationalInsightsWorkspaceFeatures : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OperationalInsightsWorkspaceFeatures DeserializeOperationalInsightsWorkspaceFeatures(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
