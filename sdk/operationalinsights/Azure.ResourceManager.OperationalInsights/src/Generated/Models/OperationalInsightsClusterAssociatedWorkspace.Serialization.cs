...
{
    public partial class OperationalInsightsClusterAssociatedWorkspace : IUtf8JsonSerializable, IJsonModel<OperationalInsightsClusterAssociatedWorkspace>, IPersistableModel<OperationalInsightsClusterAssociatedWorkspace>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AssociatedOn))
            {
                ...
                builder.AppendLine($" '{AssociatedOn.Value.ToString()}'");
            }
