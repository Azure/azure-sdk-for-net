...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchMetadataSchema>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchMetadataSchema>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchMetadataSchema>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchMetadataSchema>)} interface");
            }
        ...
        string IPersistableModel<SearchMetadataSchema>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
