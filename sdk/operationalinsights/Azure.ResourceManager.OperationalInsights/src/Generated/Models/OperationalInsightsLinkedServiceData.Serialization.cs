...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationalInsightsLinkedServiceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OperationalInsightsLinkedServiceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OperationalInsightsLinkedServiceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OperationalInsightsLinkedServiceData>)} interface");
            }
        ...
        string IPersistableModel<OperationalInsightsLinkedServiceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
