...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsKeyVaultProperties
    {
        ...
        internal OperationalInsightsKeyVaultProperties(Uri keyVaultUri, string keyName, string keyVersion, int? keyRsaSize, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
