...
{
    public partial class OperationalInsightsKeyVaultProperties : IUtf8JsonSerializable, IJsonModel<OperationalInsightsKeyVaultProperties>, IPersistableModel<OperationalInsightsKeyVaultProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KeyRsaSize))
            {
                ...
                builder.AppendLine($" '{KeyRsaSize.Value.ToString()}'");
            }
