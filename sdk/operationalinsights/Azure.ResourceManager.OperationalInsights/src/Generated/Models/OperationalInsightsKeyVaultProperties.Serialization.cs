...
{
    public partial class OperationalInsightsKeyVaultProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OperationalInsightsKeyVaultProperties DeserializeOperationalInsightsKeyVaultProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
