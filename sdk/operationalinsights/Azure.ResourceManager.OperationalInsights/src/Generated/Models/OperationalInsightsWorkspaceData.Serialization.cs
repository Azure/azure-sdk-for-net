...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationalInsightsWorkspaceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OperationalInsightsWorkspaceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OperationalInsightsWorkspaceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<OperationalInsightsWorkspaceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
