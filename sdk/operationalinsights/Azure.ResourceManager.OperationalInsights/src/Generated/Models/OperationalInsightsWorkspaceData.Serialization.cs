...
namespace Azure.ResourceManager.OperationalInsights
{
    public partial class OperationalInsightsWorkspaceData : IUtf8JsonSerializable, IJsonModel<OperationalInsightsWorkspaceData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<OperationalInsightsWorkspaceData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OperationalInsightsWorkspaceData>)} interface");
            }
