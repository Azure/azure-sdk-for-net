...
{
    public partial class OperationalInsightsAvailableServiceTier : IUtf8JsonSerializable, IJsonModel<OperationalInsightsAvailableServiceTier>, IPersistableModel<OperationalInsightsAvailableServiceTier>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServiceTier))
            {
                ...
                builder.AppendLine($" '{ServiceTier.ToString()}'");
            }
