...
{
    public partial class OperationalInsightsTableData : IUtf8JsonSerializable, IJsonModel<OperationalInsightsTableData>, IPersistableModel<OperationalInsightsTableData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TotalRetentionInDays))
            {
                ...
                builder.AppendLine($" '{TotalRetentionInDays.Value.ToString()}'");
            }

            if (Optional.IsDefined(ArchiveRetentionInDays))
            {
                builder.Append("  archiveRetentionInDays:");
                builder.AppendLine($" '{ArchiveRetentionInDays.Value.ToString()}'");
            }

            if (Optional.IsDefined(SearchResults))
            {
                builder.Append("  searchResults:");
                AppendChildObject(builder, SearchResults, options, 2);
            }

            if (Optional.IsDefined(RestoredLogs))
            {
                builder.Append("  restoredLogs:");
                AppendChildObject(builder, RestoredLogs, options, 2);
            }

            if (Optional.IsDefined(ResultStatistics))
            {
                builder.Append("  resultStatistics:");
                AppendChildObject(builder, ResultStatistics, options, 2);
            }

            if (Optional.IsDefined(Plan))
            {
                builder.Append("  plan:");
                builder.AppendLine($" '{Plan.ToString()}'");
            }
