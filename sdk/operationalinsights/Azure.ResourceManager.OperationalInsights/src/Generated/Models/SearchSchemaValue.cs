...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class SearchSchemaValue
    {
        ...
        internal SearchSchemaValue(string name, string displayName, string searchSchemaValueType, bool indexed, bool stored, bool facet, IReadOnlyList<string> ownerType)
        {
            Name = name;
