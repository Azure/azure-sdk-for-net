...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsWorkspacePurgeFilter
    {
        ...
        internal OperationalInsightsWorkspacePurgeFilter(string column, string @operator, BinaryData value, string key, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Column = column;
            Operator = @operator;
            Value = value;
