...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsWorkspacePurgeFilter
    {
        ...
        internal OperationalInsightsWorkspacePurgeFilter(string column, string @operator, BinaryData value, string key, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Column = column;
            Operator = @operator;
            Value = value;
