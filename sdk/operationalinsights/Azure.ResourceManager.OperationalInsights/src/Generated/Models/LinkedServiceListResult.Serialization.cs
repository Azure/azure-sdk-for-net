...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinkedServiceListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinkedServiceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkedServiceListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkedServiceListResult>)} interface");
            }
        ...
        string IPersistableModel<LinkedServiceListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
