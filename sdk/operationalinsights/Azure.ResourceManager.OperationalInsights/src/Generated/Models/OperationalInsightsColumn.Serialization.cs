...
{
    public partial class OperationalInsightsColumn : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OperationalInsightsColumn DeserializeOperationalInsightsColumn(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
