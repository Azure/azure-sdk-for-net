...
{
    public partial class OperationalInsightsColumn : IUtf8JsonSerializable, IJsonModel<OperationalInsightsColumn>, IPersistableModel<OperationalInsightsColumn>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataTypeHint))
            {
                ...
                builder.AppendLine($" '{DataTypeHint.ToString()}'");
            }
