...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsWorkspacePurgeContent
    {
        ...
        internal OperationalInsightsWorkspacePurgeContent(string table, IList<OperationalInsightsWorkspacePurgeFilter> filters, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Table = table;
            Filters = filters;
