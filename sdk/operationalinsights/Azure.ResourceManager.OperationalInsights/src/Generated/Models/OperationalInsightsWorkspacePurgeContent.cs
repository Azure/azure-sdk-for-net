...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsWorkspacePurgeContent
    {
        ...
        internal OperationalInsightsWorkspacePurgeContent(string table, IList<OperationalInsightsWorkspacePurgeFilter> filters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Table = table;
            Filters = filters;
