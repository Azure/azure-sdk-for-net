...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    {
        internal static StorageInsightListResult DeserializeStorageInsightListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
