...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageInsightListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageInsightListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageInsightListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageInsightListResult>)} interface");
            }
        ...
        string IPersistableModel<StorageInsightListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
