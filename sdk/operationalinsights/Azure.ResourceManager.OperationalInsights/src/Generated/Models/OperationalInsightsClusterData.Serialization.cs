...
{
    public partial class OperationalInsightsClusterData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OperationalInsightsClusterData DeserializeOperationalInsightsClusterData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
