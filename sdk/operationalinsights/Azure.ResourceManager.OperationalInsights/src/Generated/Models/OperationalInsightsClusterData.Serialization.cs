...
namespace Azure.ResourceManager.OperationalInsights
{
    public partial class OperationalInsightsClusterData : IUtf8JsonSerializable, IModelJsonSerializable<OperationalInsightsClusterData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<OperationalInsightsClusterData>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(AssociatedWorkspaces))
            {
                ...
                foreach (var item in AssociatedWorkspaces)
                {
                    ...
                    {
                        ((IModelJsonSerializable<OperationalInsightsClusterAssociatedWorkspace>)item).Serialize(writer, options);
                    }
                }
            ...
            if (Optional.IsDefined(CapacityReservationProperties))
            {
                ...
                if (CapacityReservationProperties is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<OperationalInsightsCapacityReservationProperties>)CapacityReservationProperties).Serialize(writer, options);
                }
            }
            writer.WriteEndObject();
        ...
        /// <summary> Converts a <see cref="OperationalInsightsClusterData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="OperationalInsightsClusterData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="OperationalInsightsClusterData"/>. </summary>
