...
{
    public partial class OperationalInsightsWorkspaceSku : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OperationalInsightsWorkspaceSku DeserializeOperationalInsightsWorkspaceSku(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
