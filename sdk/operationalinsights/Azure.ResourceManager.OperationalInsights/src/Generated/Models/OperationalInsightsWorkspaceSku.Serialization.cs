...
{
    public partial class OperationalInsightsWorkspaceSku : IUtf8JsonSerializable, IJsonModel<OperationalInsightsWorkspaceSku>, IPersistableModel<OperationalInsightsWorkspaceSku>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CapacityReservationLevel))
            {
                ...
                builder.AppendLine($" '{CapacityReservationLevel.ToString()}'");
            }

            if (Optional.IsDefined(LastSkuUpdatedOn))
            {
                builder.Append("  lastSkuUpdate:");
                builder.AppendLine($" '{LastSkuUpdatedOn.Value.ToString()}'");
            }
