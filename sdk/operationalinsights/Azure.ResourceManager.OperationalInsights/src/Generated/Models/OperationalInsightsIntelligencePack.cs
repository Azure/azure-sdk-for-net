...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsIntelligencePack
    {
        ...
        internal OperationalInsightsIntelligencePack(string name, bool? isEnabled, string displayName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            IsEnabled = isEnabled;
