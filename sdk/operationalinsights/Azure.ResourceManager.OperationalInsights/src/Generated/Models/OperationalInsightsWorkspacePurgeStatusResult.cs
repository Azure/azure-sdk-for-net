...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsWorkspacePurgeStatusResult
    {
        ...
        internal OperationalInsightsWorkspacePurgeStatusResult(OperationalInsightsWorkspacePurgeState status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
