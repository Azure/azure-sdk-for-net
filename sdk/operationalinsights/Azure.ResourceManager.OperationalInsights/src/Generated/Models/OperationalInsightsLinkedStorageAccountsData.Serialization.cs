...
{
    public partial class OperationalInsightsLinkedStorageAccountsData : IUtf8JsonSerializable, IJsonModel<OperationalInsightsLinkedStorageAccountsData>, IPersistableModel<OperationalInsightsLinkedStorageAccountsData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(StorageAccountIds))
            {
                builder.Append("  storageAccountIds:");
                builder.AppendLine(" [");
                foreach (var item in StorageAccountIds)
                {
                    if (item == null)
