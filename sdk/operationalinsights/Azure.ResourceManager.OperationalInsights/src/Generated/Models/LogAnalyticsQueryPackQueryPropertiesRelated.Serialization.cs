...
{
    public partial class LogAnalyticsQueryPackQueryPropertiesRelated : IUtf8JsonSerializable
    {
        ...
        internal static LogAnalyticsQueryPackQueryPropertiesRelated DeserializeLogAnalyticsQueryPackQueryPropertiesRelated(JsonElement element)
        {
            ...
            return new LogAnalyticsQueryPackQueryPropertiesRelated(Optional.ToList(categories), Optional.ToList(resourceTypes), Optional.ToList(solutions));
        }
    }
}
