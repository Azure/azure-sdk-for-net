...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class OperationalInsightsSearchSchemaValue
    {
        ...
        internal OperationalInsightsSearchSchemaValue(string name, string displayName, string searchSchemaValueType, bool indexed, bool stored, bool facet, IReadOnlyList<string> ownerType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
