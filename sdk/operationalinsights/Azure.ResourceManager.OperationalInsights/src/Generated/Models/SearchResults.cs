...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    public partial class SearchResults
    {
        ...
        internal SearchResults(string query, string description, int? limit, DateTimeOffset? startSearchOn, DateTimeOffset? endSearchOn, string sourceTable, string azureAsyncOperationId)
        {
            Query = query;
