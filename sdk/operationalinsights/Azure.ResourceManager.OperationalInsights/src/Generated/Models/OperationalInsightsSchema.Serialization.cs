...
{
    public partial class OperationalInsightsSchema : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static OperationalInsightsSchema DeserializeOperationalInsightsSchema(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
