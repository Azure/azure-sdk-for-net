...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationalInsightsCapacityReservationProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<OperationalInsightsCapacityReservationProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OperationalInsightsCapacityReservationProperties>)} interface");
            }
        ...
        string IPersistableModel<OperationalInsightsCapacityReservationProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
