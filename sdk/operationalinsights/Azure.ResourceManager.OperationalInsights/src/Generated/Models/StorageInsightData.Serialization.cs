...
{
    public partial class StorageInsightData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StorageInsightData DeserializeStorageInsightData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
