...
namespace Azure.ResourceManager.OperationalInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageInsightData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageInsightData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageInsightData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageInsightData>)} interface");
            }
        ...
        string IPersistableModel<StorageInsightData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
