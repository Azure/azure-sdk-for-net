...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    internal partial class WorkspaceListResult : IUtf8JsonSerializable, IModelJsonSerializable<WorkspaceListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<WorkspaceListResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<OperationalInsightsWorkspaceData>)item).Serialize(writer, options);
                    }
                }
