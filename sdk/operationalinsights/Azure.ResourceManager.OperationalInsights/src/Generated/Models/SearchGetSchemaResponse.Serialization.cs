...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SearchGetSchemaResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SearchGetSchemaResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SearchGetSchemaResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SearchGetSchemaResponse>)} interface");
            }
        ...
        string IPersistableModel<SearchGetSchemaResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
