...
{
    public partial class StorageInsightStatus : IUtf8JsonSerializable, IJsonModel<StorageInsightStatus>, IPersistableModel<StorageInsightStatus>
    {
        ...
        void IJsonModel<StorageInsightStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageInsightStatus)} does not support '{format}' format.");
            }
