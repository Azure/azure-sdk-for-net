...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    {
        internal static UsageMetric DeserializeUsageMetric(JsonElement element)
        {
            ...
            return new UsageMetric(name.Value, unit.Value, Optional.ToNullable(currentValue), Optional.ToNullable(limit), Optional.ToNullable(nextResetTime), quotaPeriod.Value);
        }
    }
}
