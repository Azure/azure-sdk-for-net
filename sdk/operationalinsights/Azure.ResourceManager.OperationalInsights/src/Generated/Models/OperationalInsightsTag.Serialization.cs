...
{
    public partial class OperationalInsightsTag : IUtf8JsonSerializable, IJsonModel<OperationalInsightsTag>, IPersistableModel<OperationalInsightsTag>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationalInsightsTag>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<OperationalInsightsTag>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OperationalInsightsTag)} does not support '{format}' format.");
            }
