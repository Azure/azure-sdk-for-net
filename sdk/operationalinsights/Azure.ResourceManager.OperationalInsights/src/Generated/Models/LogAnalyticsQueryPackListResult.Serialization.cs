...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogAnalyticsQueryPackListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogAnalyticsQueryPackListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogAnalyticsQueryPackListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogAnalyticsQueryPackListResult>)} interface");
            }
        ...
        string IPersistableModel<LogAnalyticsQueryPackListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
