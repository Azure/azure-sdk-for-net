...
namespace Azure.ResourceManager.OperationalInsights.Models
{
    internal partial class LogAnalyticsQueryPackListResult : IUtf8JsonSerializable, IModelJsonSerializable<LogAnalyticsQueryPackListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<LogAnalyticsQueryPackListResult>(this, options.Format);
            ...
            foreach (var item in Value)
            {
                ...
                {
                    ((IModelJsonSerializable<LogAnalyticsQueryPackData>)item).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="LogAnalyticsQueryPackListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="LogAnalyticsQueryPackListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="LogAnalyticsQueryPackListResult"/>. </summary>
