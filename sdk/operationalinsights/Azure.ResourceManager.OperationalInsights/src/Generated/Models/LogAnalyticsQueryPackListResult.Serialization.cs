...
{
    internal partial class LogAnalyticsQueryPackListResult : IUtf8JsonSerializable, IJsonModel<LogAnalyticsQueryPackListResult>, IPersistableModel<LogAnalyticsQueryPackListResult>
    {
        ...
        void IJsonModel<LogAnalyticsQueryPackListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LogAnalyticsQueryPackListResult)} does not support '{format}' format.");
            }
