...
{
    public partial class Sample_LogAnalyticsQueryPackQueryResource
    {
        // QueryGet
        ...
        public async Task Get_QueryGet()
        {
            ...
            // this example assumes you already have this LogAnalyticsQueryPackQueryResource created on azure
            // for more information of creating LogAnalyticsQueryPackQueryResource, please refer to the document of LogAnalyticsQueryPackQueryResource
            ...
            ResourceIdentifier logAnalyticsQueryPackQueryResourceId = LogAnalyticsQueryPackQueryResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, queryPackName, id);
            LogAnalyticsQueryPackQueryResource logAnalyticsQueryPackQuery = client.GetLogAnalyticsQueryPackQueryResource(logAnalyticsQueryPackQueryResourceId);

            // invoke the operation
            LogAnalyticsQueryPackQueryResource result = await logAnalyticsQueryPackQuery.GetAsync();
...
"label2"
            ...
            LogAnalyticsQueryPackQueryResource result = await logAnalyticsQueryPackQuery.UpdateAsync(data);
        ...
        public async Task Delete_QueryDelete()
        {
            ...
            // invoke the operation
            await logAnalyticsQueryPackQuery.DeleteAsync(WaitUntil.Completed);
