...
namespace Azure.ResourceManager.OperationalInsights
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        public async Task GetWorkspacesByDeletedWorkspace_WorkspacesSubscriptionList()
        {
            ...
            await foreach (WorkspaceResource item in subscriptionResource.GetWorkspacesByDeletedWorkspaceAsync())
            {
