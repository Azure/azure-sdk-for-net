...
["Tag2"] = "Value2",
        ...
        public async Task SearchQueries_QuerySearch()
        {
            ...
            // invoke the operation and iterate over the result
            LogAnalyticsQueryPackQuerySearchProperties querySearchProperties = new LogAnalyticsQueryPackQuerySearchProperties()
            {
                Related = new LogAnalyticsQueryPackQuerySearchPropertiesRelated()
                {
                    Categories =
{
"other","analytics"
...
"label1"
            ...
            await foreach (LogAnalyticsQueryPackQueryResource item in logAnalyticsQueryPack.SearchQueriesAsync(querySearchProperties, top: top, includeBody: includeBody))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
