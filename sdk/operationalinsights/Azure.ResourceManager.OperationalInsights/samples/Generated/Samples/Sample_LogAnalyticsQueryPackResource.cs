...
namespace Azure.ResourceManager.OperationalInsights.Samples
{
    public partial class Sample_LogAnalyticsQueryPackResource
    {
        ...
        public async Task Delete_QueryPacksDelete()
        {
            ...
            // invoke the operation
            await logAnalyticsQueryPack.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["my-label"] = {"label1"}
            ...
            await foreach (LogAnalyticsQueryResource item in logAnalyticsQueryPack.SearchQueriesAsync(querySearchProperties, top, includeBody))
            {
