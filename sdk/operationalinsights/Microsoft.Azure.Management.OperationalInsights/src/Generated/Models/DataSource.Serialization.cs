    ...
    public partial class DataSource : IUtf8JsonSerializable
    {
        ...
        internal static DataSource DeserializeDataSource(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    kind = new DataSourceKind(property.Value.GetString());
                    continue;
                }
            ...
            return new DataSource(id.Value, name.Value, type.Value, properties, etag.Value, kind, Optional.ToDictionary(tags));
        }
    }
}
