...
namespace OperationalInsightsManagementClient.Models
{
    public partial class Cluster : IUtf8JsonSerializable
    {
        ...
        internal static Cluster DeserializeCluster(JsonElement element)
        {
            ...
            return new Cluster(id.Value, name.Value, type.Value, Optional.ToDictionary(tags), location, identity.Value, sku.Value, clusterId.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(isDoubleEncryptionEnabled), Optional.ToNullable(isAvailabilityZonesEnabled), Optional.ToNullable(billingType), keyVaultProperties.Value, lastModifiedDate.Value, createdDate.Value, Optional.ToList(associatedWorkspaces), capacityReservationProperties.Value);
        }
    }
}
