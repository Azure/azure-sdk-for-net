...
namespace Microsoft.Azure.Management.OperationalInsights
{
    ...
    internal partial class ClustersOperations : IServiceOperations<OperationalInsightsManagementClient>, IClustersOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<Cluster>>> ListByResourceGroupWithHttpMessagesAsync(string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                var ex = new ClusterErrorResponseException(string.Format("Operation returned an invalid status code '{0}'", _statusCode));
                try
                {
                    _responseContent = await _httpResponse.Content.ReadAsStringAsync().ConfigureAwait(false);
                    ClusterErrorResponse _errorBody =  Rest.Serialization.SafeJsonConvert.DeserializeObject<ClusterErrorResponse>(_responseContent, Client.DeserializationSettings);
                    if (_errorBody != null)
                    {
                        ex.Body = _errorBody;
                    }
