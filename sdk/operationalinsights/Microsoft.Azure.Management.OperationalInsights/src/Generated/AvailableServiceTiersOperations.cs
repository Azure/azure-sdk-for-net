...
namespace Microsoft.Azure.Management.OperationalInsights
{
    ...
    /// </summary>
    internal partial class AvailableServiceTiersOperations : IServiceOperations<OperationalInsightsManagementClient>, IAvailableServiceTiersOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IList<AvailableServiceTier>>> ListByWorkspaceWithHttpMessagesAsync(string resourceGroupName, string workspaceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<IList<AvailableServiceTier>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<IList<AvailableServiceTier>>(_responseContent, Client.DeserializationSettings);
                }
