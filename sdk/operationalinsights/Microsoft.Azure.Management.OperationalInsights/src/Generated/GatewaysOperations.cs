...
namespace Microsoft.Azure.Management.OperationalInsights
{
    ...
    /// </summary>
    internal partial class GatewaysOperations : IServiceOperations<OperationalInsightsManagementClient>, IGatewaysOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal GatewaysOperations(OperationalInsightsManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse> DeleteWithHttpMessagesAsync(string resourceGroupName, string workspaceName, string gatewayId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/gateways/{gatewayId}").ToString();
