...
namespace Azure.ResourceManager.Peering
{
    ...
    public partial class PeeringServiceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<PeeringServiceResource>> UpdateAsync(WaitUntil waitUntil, PeeringServiceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _peeringServicesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, PeeringServiceData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PeeringServiceData> response = Response.FromValue(PeeringServiceData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PeeringServiceResource> Update(WaitUntil waitUntil, PeeringServiceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
