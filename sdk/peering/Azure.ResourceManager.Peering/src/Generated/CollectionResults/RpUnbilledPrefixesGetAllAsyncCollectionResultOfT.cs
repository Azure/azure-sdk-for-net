...
namespace Azure.ResourceManager.Peering
{
    internal partial class RpUnbilledPrefixesGetAllAsyncCollectionResultOfT : AsyncPageable<RpUnbilledPrefix>
    {
        ...
        /// <summary> Initializes a new instance of RpUnbilledPrefixesGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RpUnbilledPrefixesGetAllAsyncCollectionResultOfT(RpUnbilledPrefixes client, string subscriptionId, string resourceGroupName, string peeringName, bool? consolidate, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of RpUnbilledPrefixesGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
