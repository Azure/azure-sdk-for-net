...
{
    internal partial class LegacyPeeringsGetAllCollectionResultOfT : Pageable<PeeringData>
    {
        ...
        /// <summary> Initializes a new instance of LegacyPeeringsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public LegacyPeeringsGetAllCollectionResultOfT(LegacyPeerings client, string subscriptionId, string peeringLocation, string kind, int? asn, string directPeeringType, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of LegacyPeeringsGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of LegacyPeeringsGetAllCollectionResultOfT as an enumerable collection. </returns>
