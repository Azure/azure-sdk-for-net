...
namespace Azure.ResourceManager.Peering
{
    internal partial class PeeringServiceCountriesGetPeeringServiceCountriesAsyncCollectionResultOfT : AsyncPageable<PeeringServiceCountry>
    {
        ...
        public PeeringServiceCountriesGetPeeringServiceCountriesAsyncCollectionResultOfT(PeeringServiceCountries client, string subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
