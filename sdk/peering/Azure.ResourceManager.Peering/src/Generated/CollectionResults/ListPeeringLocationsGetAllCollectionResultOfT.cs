...
{
    internal partial class ListPeeringLocationsGetAllCollectionResultOfT : Pageable<PeeringLocation>
    {
        ...
        /// <summary> Initializes a new instance of ListPeeringLocationsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ListPeeringLocationsGetAllCollectionResultOfT(ListPeeringLocations client, string subscriptionId, string kind, string directPeeringType, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ListPeeringLocationsGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ListPeeringLocationsGetAllCollectionResultOfT as an enumerable collection. </returns>
