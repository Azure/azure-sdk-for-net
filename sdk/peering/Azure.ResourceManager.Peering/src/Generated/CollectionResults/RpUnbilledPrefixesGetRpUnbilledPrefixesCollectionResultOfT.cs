...
namespace Azure.ResourceManager.Peering
{
    internal partial class RpUnbilledPrefixesGetRpUnbilledPrefixesCollectionResultOfT : Pageable<RoutingPreferenceUnbilledPrefix>
    {
        ...
        public RpUnbilledPrefixesGetRpUnbilledPrefixesCollectionResultOfT(RpUnbilledPrefixes client, string subscriptionId, string resourceGroupName, string peeringName, bool? consolidate, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
