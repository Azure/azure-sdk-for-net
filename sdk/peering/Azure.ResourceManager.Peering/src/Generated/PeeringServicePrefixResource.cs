...
namespace Azure.ResourceManager.Peering
{
    ...
    public partial class PeeringServicePrefixResource : ArmResource
    {
        ...
        internal PeeringServicePrefixResource(ArmClient client, PeeringServicePrefixData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<PeeringServicePrefixResource>> GetAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new PeeringServicePrefixResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<PeeringServicePrefixResource>> UpdateAsync(WaitUntil waitUntil, PeeringServicePrefixData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PeeringArmOperation<PeeringServicePrefixResource>(Response.FromValue(new PeeringServicePrefixResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
