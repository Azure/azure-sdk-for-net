...
namespace Azure.ResourceManager.Peering.Mocking
{
    ...
    internal partial class PeeringArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PeeringArmClientMockingExtension"/> class for mocking. </summary>
        protected PeeringArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PeeringArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PeeringArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal PeeringArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
