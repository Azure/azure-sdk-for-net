...
namespace Azure.ResourceManager.Peering.Mock
{
    ...
    public partial class PeeringResourceExtension : ArmResource
    {
        private ClientDiagnostics _peeringClientDiagnostics;
        private PeeringsRestOperations _peeringRestClient;

        /// <summary> Initializes a new instance of the <see cref="PeeringResourceExtension"/> class for mocking. </summary>
        protected PeeringResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PeeringResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PeeringResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<PeeringResource> GetPeeringsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new PeeringResource(Client, PeeringData.DeserializePeeringData(e)), PeeringClientDiagnostics, Pipeline, "PeeringResourceExtension.GetPeerings", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<PeeringResource> GetPeerings(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => PeeringRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => PeeringRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new PeeringResource(Client, PeeringData.DeserializePeeringData(e)), PeeringClientDiagnostics, Pipeline, "PeeringResourceExtension.GetPeerings", "value", "nextLink", cancellationToken);
        }
    }
}
