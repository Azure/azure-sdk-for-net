...
namespace Azure.ResourceManager.Peering.Mocking
{
    ...
    internal partial class PeeringResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PeeringResourceGroupMockingExtension"/> class for mocking. </summary>
        protected PeeringResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PeeringResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PeeringResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
