...
namespace Azure.ResourceManager.Peering
{
    ...
    public partial class PeeringRegisteredAsnData : ResourceData
    {
        ...
        internal PeeringRegisteredAsnData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PeeringRegisteredAsnProperties properties) : base(id, name, resourceType, systemData)
        {
