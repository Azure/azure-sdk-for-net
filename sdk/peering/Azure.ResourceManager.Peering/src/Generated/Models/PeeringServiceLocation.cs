...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    public partial class PeeringServiceLocation : ResourceData
    {
        ...
        internal PeeringServiceLocation(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string country, string state, AzureLocation? azureRegion, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Country = country;
            State = state;
