...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    public partial class BgpSession
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BgpSession"/>. </summary>
        public BgpSession()
        {
        }
        ...
        internal BgpSession(string sessionPrefixV4, string sessionPrefixV6, string microsoftSessionIPv4Address, string microsoftSessionIPv6Address, string peerSessionIPv4Address, string peerSessionIPv6Address, SessionStateV4? sessionStateV4, SessionStateV6? sessionStateV6, int? maxPrefixesAdvertisedV4, int? maxPrefixesAdvertisedV6, string md5AuthenticationKey, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
