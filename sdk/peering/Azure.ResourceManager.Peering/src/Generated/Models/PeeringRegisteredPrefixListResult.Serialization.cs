...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeeringRegisteredPrefixListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeeringRegisteredPrefixListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeeringRegisteredPrefixListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeeringRegisteredPrefixListResult>)} interface");
            }
        ...
        string IPersistableModel<PeeringRegisteredPrefixListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
