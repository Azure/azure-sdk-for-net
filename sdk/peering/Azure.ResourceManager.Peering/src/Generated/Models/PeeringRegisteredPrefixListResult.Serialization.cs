...
{
    internal partial class PeeringRegisteredPrefixListResult : IUtf8JsonSerializable, IJsonModel<PeeringRegisteredPrefixListResult>, IPersistableModel<PeeringRegisteredPrefixListResult>
    {
        ...
        void IJsonModel<PeeringRegisteredPrefixListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PeeringRegisteredPrefixListResult)} does not support '{format}' format.");
            }
