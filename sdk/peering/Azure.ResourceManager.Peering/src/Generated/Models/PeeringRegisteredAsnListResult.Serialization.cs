...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        internal static PeeringRegisteredAsnListResult DeserializePeeringRegisteredAsnListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
