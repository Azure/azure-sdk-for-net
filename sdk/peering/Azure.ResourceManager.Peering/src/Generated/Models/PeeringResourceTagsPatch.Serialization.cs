...
namespace Azure.ResourceManager.Peering.Models
{
    public partial class PeeringResourceTagsPatch : IUtf8JsonSerializable, IJsonModel<PeeringResourceTagsPatch>
    {
        ...
        void IJsonModel<PeeringResourceTagsPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PeeringResourceTagsPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PeeringResourceTagsPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PeeringResourceTagsPatch)} does not support '{options.Format}' format.");
            }
        }
