...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        internal static RpUnbilledPrefixListResult DeserializeRpUnbilledPrefixListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
