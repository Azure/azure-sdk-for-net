...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeeringServiceProvider>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeeringServiceProvider>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeeringServiceProvider>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeeringServiceProvider>)} interface");
            }
        ...
        string IPersistableModel<PeeringServiceProvider>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
