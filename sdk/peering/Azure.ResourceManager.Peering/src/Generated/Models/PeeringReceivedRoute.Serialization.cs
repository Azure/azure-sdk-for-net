...
namespace Azure.ResourceManager.Peering.Models
{
    public partial class PeeringReceivedRoute : IUtf8JsonSerializable, IJsonModel<PeeringReceivedRoute>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  originAsValidationState:");
                if (OriginAsValidationState.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{OriginAsValidationState}'''");
                }
                else
                {
                    builder.AppendLine($" '{OriginAsValidationState}'");
            ...
            {
                builder.Append("  rpkiValidationState:");
                if (RpkiValidationState.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{RpkiValidationState}'''");
                }
                else
                {
                    builder.AppendLine($" '{RpkiValidationState}'");
            ...
            {
                builder.Append("  trustAnchor:");
                if (TrustAnchor.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{TrustAnchor}'''");
                }
                else
                {
                    builder.AppendLine($" '{TrustAnchor}'");
            ...
            if (Optional.IsDefined(ReceivedTimestamp))
            {
                ...
                if (ReceivedTimestamp.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ReceivedTimestamp}'''");
                }
                else
                {
                    builder.AppendLine($" '{ReceivedTimestamp}'");
