...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CdnPeeringPrefixListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CdnPeeringPrefixListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CdnPeeringPrefixListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CdnPeeringPrefixListResult>)} interface");
            }
        ...
        string IPersistableModel<CdnPeeringPrefixListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
