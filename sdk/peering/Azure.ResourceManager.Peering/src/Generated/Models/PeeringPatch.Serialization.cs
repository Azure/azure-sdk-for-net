...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeeringPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeeringPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeeringPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeeringPatch>)} interface");
            }
        ...
        string IPersistableModel<PeeringPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
