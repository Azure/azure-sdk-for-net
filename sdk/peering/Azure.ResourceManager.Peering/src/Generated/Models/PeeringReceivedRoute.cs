...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    public partial class PeeringReceivedRoute
    {
        ...
        internal PeeringReceivedRoute(string prefix, string nextHop, string asPath, string originAsValidationState, string rpkiValidationState, string trustAnchor, string receivedTimestamp, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Prefix = prefix;
            NextHop = nextHop;
            AsPath = asPath;
