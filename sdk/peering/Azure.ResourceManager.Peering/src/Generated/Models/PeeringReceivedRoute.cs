...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    public partial class PeeringReceivedRoute
    {
        ...
        internal PeeringReceivedRoute(string prefix, string nextHop, string asPath, string originAsValidationState, string rpkiValidationState, string trustAnchor, string receivedTimestamp, Dictionary<string, BinaryData> rawData)
        {
            Prefix = prefix;
            NextHop = nextHop;
            AsPath = asPath;
