...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    public partial class PeeringServiceCountry : ResourceData
    {
        ...
        internal PeeringServiceCountry(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            _rawData = rawData;
        }
    }
