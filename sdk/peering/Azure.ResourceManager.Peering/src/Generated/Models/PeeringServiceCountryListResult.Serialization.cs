...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeeringServiceCountryListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeeringServiceCountryListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeeringServiceCountryListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeeringServiceCountryListResult>)} interface");
            }
        ...
        string IPersistableModel<PeeringServiceCountryListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
