...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CheckPeeringServiceProviderAvailabilityContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CheckPeeringServiceProviderAvailabilityContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CheckPeeringServiceProviderAvailabilityContent>)} interface");
            }
        ...
        string IPersistableModel<CheckPeeringServiceProviderAvailabilityContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
