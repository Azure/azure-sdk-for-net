...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CheckPeeringServiceProviderAvailabilityContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        CheckPeeringServiceProviderAvailabilityContent IJsonModel<CheckPeeringServiceProviderAvailabilityContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(CheckPeeringServiceProviderAvailabilityContent)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<CheckPeeringServiceProviderAvailabilityContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        CheckPeeringServiceProviderAvailabilityContent IModel<CheckPeeringServiceProviderAvailabilityContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<CheckPeeringServiceProviderAvailabilityContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
