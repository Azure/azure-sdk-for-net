...
namespace Azure.ResourceManager.Peering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeeringServicePrefixData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeeringServicePrefixData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeeringServicePrefixData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeeringServicePrefixData>)} interface");
            }
        ...
        string IPersistableModel<PeeringServicePrefixData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
