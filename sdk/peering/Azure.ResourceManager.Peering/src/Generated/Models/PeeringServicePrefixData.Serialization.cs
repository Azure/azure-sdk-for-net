...
{
    public partial class PeeringServicePrefixData : IUtf8JsonSerializable, IJsonModel<PeeringServicePrefixData>, IPersistableModel<PeeringServicePrefixData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LearnedType))
            {
                ...
                builder.AppendLine($" '{LearnedType.ToString()}'");
            }
