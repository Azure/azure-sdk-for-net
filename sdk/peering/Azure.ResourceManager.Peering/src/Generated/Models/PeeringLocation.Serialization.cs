    ...
    public partial class PeeringLocation : IUtf8JsonSerializable, IJsonModel<PeeringLocation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Direct))
            {
                ...
                AppendChildObject(builder, Direct, options, 4, false);
            }

            if (Optional.IsDefined(Exchange))
            {
                builder.Append("    exchange:");
                AppendChildObject(builder, Exchange, options, 4, false);
            }

            if (Optional.IsDefined(PeeringLocationValue))
            {
                builder.Append("    peeringLocation:");
                if (PeeringLocationValue.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
