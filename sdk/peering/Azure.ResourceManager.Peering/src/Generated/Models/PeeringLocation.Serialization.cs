...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeeringLocation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeeringLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeeringLocation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeeringLocation>)} interface");
            }
        ...
        string IPersistableModel<PeeringLocation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
