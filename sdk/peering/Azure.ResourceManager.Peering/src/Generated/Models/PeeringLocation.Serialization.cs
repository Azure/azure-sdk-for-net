...
{
    public partial class PeeringLocation : IUtf8JsonSerializable, IJsonModel<PeeringLocation>, IPersistableModel<PeeringLocation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Direct))
            {
                ...
                AppendChildObject(builder, Direct, options, 2);
            }

            if (Optional.IsDefined(Exchange))
            {
                builder.Append("  exchange:");
                AppendChildObject(builder, Exchange, options, 2);
            }

            if (Optional.IsDefined(PeeringLocationValue))
            {
                builder.Append("  peeringLocation:");
                builder.AppendLine($" '{PeeringLocationValue}'");
            }
            ...
            if (Optional.IsDefined(AzureRegion))
            {
                ...
                builder.AppendLine($" '{AzureRegion.Value.ToString()}'");
            }
