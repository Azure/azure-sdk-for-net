...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectionMonitorTestListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectionMonitorTestListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectionMonitorTestListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectionMonitorTestListResult>)} interface");
            }
        ...
        string IPersistableModel<ConnectionMonitorTestListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
