...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeeringReceivedRouteListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeeringReceivedRouteListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeeringReceivedRouteListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeeringReceivedRouteListResult>)} interface");
            }
        ...
        string IPersistableModel<PeeringReceivedRouteListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
