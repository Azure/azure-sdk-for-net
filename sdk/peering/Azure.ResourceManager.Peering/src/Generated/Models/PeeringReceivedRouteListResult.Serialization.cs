...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeeringReceivedRouteListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PeeringReceivedRouteListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PeeringReceivedRouteListResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<PeeringReceivedRoute> collection && collection.IsUndefined))
            {
        ...
        internal static PeeringReceivedRouteListResult DeserializePeeringReceivedRouteListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PeeringReceivedRouteListResult(value ?? new ChangeTrackingList<PeeringReceivedRoute>(), nextLink.Value, serializedAdditionalRawData);
        }
