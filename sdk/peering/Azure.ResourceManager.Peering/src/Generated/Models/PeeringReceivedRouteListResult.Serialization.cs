...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        internal static PeeringReceivedRouteListResult DeserializePeeringReceivedRouteListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
