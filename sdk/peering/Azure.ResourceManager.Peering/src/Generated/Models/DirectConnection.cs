...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        /// <summary> Initializes a new instance of DirectConnection. </summary>
        ...
        internal DirectConnection(int? bandwidthInMbps, int? provisionedBandwidthInMbps, SessionAddressProvider? sessionAddressProvider, bool? useForPeeringService, string microsoftTrackingId, int? peeringDBFacilityId, ConnectionState? connectionState, BgpSession bgpSession, string connectionIdentifier, string errorMessage)
        {
