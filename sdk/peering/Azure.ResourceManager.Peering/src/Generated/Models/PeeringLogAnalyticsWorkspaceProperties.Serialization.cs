...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeeringLogAnalyticsWorkspaceProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeeringLogAnalyticsWorkspaceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeeringLogAnalyticsWorkspaceProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeeringLogAnalyticsWorkspaceProperties>)} interface");
            }
        ...
        string IPersistableModel<PeeringLogAnalyticsWorkspaceProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
