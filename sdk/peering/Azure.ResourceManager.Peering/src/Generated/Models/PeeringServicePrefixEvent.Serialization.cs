...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        internal static PeeringServicePrefixEvent DeserializePeeringServicePrefixEvent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
