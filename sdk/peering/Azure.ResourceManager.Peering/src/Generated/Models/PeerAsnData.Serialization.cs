...
{
    public partial class PeerAsnData : IUtf8JsonSerializable, IJsonModel<PeerAsnData>, IPersistableModel<PeerAsnData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(PeerContactDetail))
            {
                builder.Append("  peerContactDetail:");
                builder.AppendLine(" [");
                foreach (var item in PeerContactDetail)
                {
            ...
            if (Optional.IsDefined(PeerName))
            {
                ...
                builder.AppendLine($" '{PeerName}'");
            }

            if (Optional.IsDefined(ValidationState))
            {
                builder.Append("  validationState:");
                builder.AppendLine($" '{ValidationState.ToString()}'");
            }
