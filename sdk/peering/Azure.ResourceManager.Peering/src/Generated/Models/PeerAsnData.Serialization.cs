...
{
    public partial class PeerAsnData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PeerAsnData DeserializePeerAsnData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
