...
namespace Azure.ResourceManager.Peering
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeerAsnData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeerAsnData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeerAsnData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeerAsnData>)} interface");
            }
        ...
        string IPersistableModel<PeerAsnData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
