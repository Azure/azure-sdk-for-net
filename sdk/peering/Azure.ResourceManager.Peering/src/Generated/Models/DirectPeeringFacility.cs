...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    public partial class DirectPeeringFacility
    {
        ...
        internal DirectPeeringFacility(string address, DirectPeeringType? directPeeringType, int? peeringDBFacilityId, string peeringDBFacilityLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Address = address;
