...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    public partial class ExchangePeeringFacility
    {
        ...
        internal ExchangePeeringFacility(string exchangeName, int? bandwidthInMbps, IPAddress microsoftIPv4Address, IPAddress microsoftIPv6Address, string facilityIPv4Prefix, string facilityIPv6Prefix, int? peeringDBFacilityId, string peeringDBFacilityLink, Dictionary<string, BinaryData> rawData)
        {
