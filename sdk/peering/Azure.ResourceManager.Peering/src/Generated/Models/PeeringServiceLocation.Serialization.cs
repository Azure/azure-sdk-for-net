...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeeringServiceLocation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeeringServiceLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeeringServiceLocation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeeringServiceLocation>)} interface");
            }
        ...
        string IPersistableModel<PeeringServiceLocation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
