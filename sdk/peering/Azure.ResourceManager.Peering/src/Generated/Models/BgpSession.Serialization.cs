...
{
    public partial class BgpSession : IUtf8JsonSerializable
    {
        ...
        internal static BgpSession DeserializeBgpSession(JsonElement element)
        {
            ...
            Optional<SessionStateV4> sessionStateV4 = default;
            Optional<SessionStateV6> sessionStateV6 = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("sessionStateV4"))
                {
                    ...
                    sessionStateV4 = new SessionStateV4(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("sessionStateV6"))
                {
                    ...
                    sessionStateV6 = new SessionStateV6(property.Value.GetString());
                    continue;
                }
