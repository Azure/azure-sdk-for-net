...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CdnPeeringPrefix>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        void IJsonModel<CdnPeeringPrefix>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format == ModelReaderWriterFormat.Json)
            {
                if (Optional.IsDefined(AzureService))
                {
            ...
            if (options.Format == ModelReaderWriterFormat.Json)
            {
                if (Optional.IsDefined(IsPrimaryRegion))
                {
            ...
            if (options.Format == ModelReaderWriterFormat.Json)
            {
                if (Optional.IsDefined(BgpCommunity))
                {
        ...
        CdnPeeringPrefix IJsonModel<CdnPeeringPrefix>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<CdnPeeringPrefix>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        CdnPeeringPrefix IModel<CdnPeeringPrefix>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<CdnPeeringPrefix>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
