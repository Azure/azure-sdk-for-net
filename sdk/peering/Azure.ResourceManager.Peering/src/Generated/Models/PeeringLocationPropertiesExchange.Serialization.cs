...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PeeringLocationPropertiesExchange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PeeringLocationPropertiesExchange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PeeringLocationPropertiesExchange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PeeringLocationPropertiesExchange>)} interface");
            }
        ...
        string IPersistableModel<PeeringLocationPropertiesExchange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
