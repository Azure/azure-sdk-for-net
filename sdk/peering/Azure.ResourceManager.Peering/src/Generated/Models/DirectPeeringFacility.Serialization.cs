...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DirectPeeringFacility>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DirectPeeringFacility>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DirectPeeringFacility>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DirectPeeringFacility>)} interface");
            }
        ...
        string IPersistableModel<DirectPeeringFacility>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
