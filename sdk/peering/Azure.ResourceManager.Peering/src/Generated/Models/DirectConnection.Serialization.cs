...
{
    public partial class DirectConnection : IUtf8JsonSerializable
    {
        ...
        internal static DirectConnection DeserializeDirectConnection(JsonElement element)
        {
            Optional<int> bandwidthInMbps = default;
            Optional<int> provisionedBandwidthInMbps = default;
            Optional<SessionAddressProvider> sessionAddressProvider = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("sessionAddressProvider"))
                {
                    ...
                    sessionAddressProvider = new SessionAddressProvider(property.Value.GetString());
                    continue;
                }
            ...
            return new DirectConnection(Optional.ToNullable(bandwidthInMbps), Optional.ToNullable(provisionedBandwidthInMbps), Optional.ToNullable(sessionAddressProvider), Optional.ToNullable(useForPeeringService), microsoftTrackingId.Value, Optional.ToNullable(peeringDBFacilityId), Optional.ToNullable(connectionState), bgpSession.Value, connectionIdentifier.Value, errorMessage.Value);
        }
    }
}
