...
namespace Azure.ResourceManager.Peering
{
    ...
    public partial class PeeringResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<PeeringResource>> UpdateAsync(WaitUntil waitUntil, PeeringData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _peeringsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, PeeringData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PeeringData> response = Response.FromValue(PeeringData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PeeringResource> Update(WaitUntil waitUntil, PeeringData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
