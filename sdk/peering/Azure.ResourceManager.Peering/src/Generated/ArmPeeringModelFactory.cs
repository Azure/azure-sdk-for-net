...
namespace Azure.ResourceManager.Peering.Models
{
    ...
    public static partial class ArmPeeringModelFactory
    {
        ...
        {
            return new CdnPeeringPrefix(id, name, resourceType, systemData, prefix, azureRegion, azureService, isPrimaryRegion, bgpCommunity, new Dictionary<string, BinaryData>());
        }
        ...
        public static PeeringData PeeringData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, PeeringSku sku = null, PeeringKind kind = default, DirectPeeringProperties direct = null, ExchangePeeringProperties exchange = null, string peeringLocation = null, PeeringProvisioningState? provisioningState = null)
        {
            ...
            return new PeeringData(id, name, resourceType, systemData, tags, location, sku, kind, direct, exchange, peeringLocation, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PeeringSku(name, tier, family, size, new Dictionary<string, BinaryData>());
        }
        ...
        public static DirectPeeringProperties DirectPeeringProperties(IEnumerable<PeeringDirectConnection> connections = null, bool? useForPeeringService = null, ResourceIdentifier peerAsnId = null, DirectPeeringType? directPeeringType = null)
        {
            ...
            return new DirectPeeringProperties(connections?.ToList(), useForPeeringService, peerAsnId != null ? ResourceManagerModelFactory.WritableSubResource(peerAsnId) : null, directPeeringType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PeeringDirectConnection(bandwidthInMbps, provisionedBandwidthInMbps, sessionAddressProvider, useForPeeringService, microsoftTrackingId, peeringDBFacilityId, connectionState, bgpSession, connectionIdentifier, errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PeeringBgpSession(sessionPrefixV4, sessionPrefixV6, microsoftSessionIPv4Address, microsoftSessionIPv6Address, peerSessionIPv4Address, peerSessionIPv6Address, sessionStateV4, sessionStateV6, maxPrefixesAdvertisedV4, maxPrefixesAdvertisedV6, md5AuthenticationKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PeeringExchangeConnection(peeringDBFacilityId, connectionState, bgpSession, connectionIdentifier, errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LookingGlassOutput(command, output, new Dictionary<string, BinaryData>());
        }
        ...
        public static PeerAsnData PeerAsnData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, int? peerAsn = null, IEnumerable<PeerAsnContactDetail> peerContactDetail = null, string peerName = null, PeerAsnValidationState? validationState = null, string errorMessage = null)
        {
            ...
            return new PeerAsnData(id, name, resourceType, systemData, peerAsn, peerContactDetail?.ToList(), peerName, validationState, errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        public static PeeringLocation PeeringLocation(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, PeeringKind? kind = null, DirectPeeringLocationProperties direct = null, IEnumerable<ExchangePeeringFacility> exchangePeeringFacilities = null, string peeringLocationValue = null, string country = null, AzureLocation? azureRegion = null)
        {
            ...
            return new PeeringLocation(id, name, resourceType, systemData, kind, direct, exchangePeeringFacilities != null ? new PeeringLocationPropertiesExchange(exchangePeeringFacilities?.ToList(), new Dictionary<string, BinaryData>()) : null, peeringLocationValue, country, azureRegion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PeeringRegisteredAsnData(id, name, resourceType, systemData, asn, peeringServicePrefixKey, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PeeringRegisteredPrefixData(id, name, resourceType, systemData, prefix, prefixValidationState, peeringServicePrefixKey, errorMessage, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PeeringReceivedRoute(prefix, nextHop, asPath, originAsValidationState, rpkiValidationState, trustAnchor, receivedTimestamp, new Dictionary<string, BinaryData>());
        }
        ...
        public static ConnectionMonitorTestData ConnectionMonitorTestData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string sourceAgent = null, string destination = null, int? destinationPort = null, int? testFrequencyInSec = null, bool? isTestSuccessful = null, IEnumerable<string> path = null, PeeringProvisioningState? provisioningState = null)
        {
            ...
            return new ConnectionMonitorTestData(id, name, resourceType, systemData, sourceAgent, destination, destinationPort, testFrequencyInSec, isTestSuccessful, path?.ToList(), provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PeeringServiceCountry(id, name, resourceType, systemData, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PeeringServiceLocation(id, name, resourceType, systemData, country, state, azureRegion, new Dictionary<string, BinaryData>());
        }
        ...
        public static PeeringServicePrefixData PeeringServicePrefixData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string prefix = null, PeeringPrefixValidationState? prefixValidationState = null, PeeringLearnedType? learnedType = null, string errorMessage = null, IEnumerable<PeeringServicePrefixEvent> events = null, string peeringServicePrefixKey = null, PeeringProvisioningState? provisioningState = null)
        {
            ...
            return new PeeringServicePrefixData(id, name, resourceType, systemData, prefix, prefixValidationState, learnedType, errorMessage, events?.ToList(), peeringServicePrefixKey, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PeeringServicePrefixEvent(eventTimestamp, eventType, eventSummary, eventLevel, eventDescription, new Dictionary<string, BinaryData>());
        }
        ...
        public static PeeringServiceProvider PeeringServiceProvider(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string serviceProviderName = null, IEnumerable<string> peeringLocations = null)
        {
            ...
            return new PeeringServiceProvider(id, name, resourceType, systemData, serviceProviderName, peeringLocations?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static PeeringServiceData PeeringServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string skuName = null, string peeringServiceLocation = null, string peeringServiceProvider = null, PeeringProvisioningState? provisioningState = null, string providerPrimaryPeeringLocation = null, string providerBackupPeeringLocation = null, PeeringLogAnalyticsWorkspaceProperties logAnalyticsWorkspaceProperties = null)
        {
            ...
            return new PeeringServiceData(id, name, resourceType, systemData, tags, location, skuName != null ? new PeeringServiceSku(skuName, new Dictionary<string, BinaryData>()) : null, peeringServiceLocation, peeringServiceProvider, provisioningState, providerPrimaryPeeringLocation, providerBackupPeeringLocation, logAnalyticsWorkspaceProperties, new Dictionary<string, BinaryData>());
        }
        ...
        public static PeeringLogAnalyticsWorkspaceProperties PeeringLogAnalyticsWorkspaceProperties(string workspaceId = null, string key = null, IEnumerable<string> connectedAgents = null)
        {
            ...
            return new PeeringLogAnalyticsWorkspaceProperties(workspaceId, key, connectedAgents?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RoutingPreferenceUnbilledPrefix(prefix, azureRegion, peerAsn, new Dictionary<string, BinaryData>());
        }
    }
}
