...
namespace Azure.ResourceManager.Peering
{
    ...
    public partial class ConnectionMonitorTestCollection : ArmCollection, IEnumerable<ConnectionMonitorTestResource>, IAsyncEnumerable<ConnectionMonitorTestResource>
    {
        ...
        {
            async Task<Page<ConnectionMonitorTestResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _connectionMonitorTestClientDiagnostics.CreateScope("ConnectionMonitorTestCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _connectionMonitorTestRestClient.ListByPeeringServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ConnectionMonitorTestResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<ConnectionMonitorTestResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _connectionMonitorTestClientDiagnostics.CreateScope("ConnectionMonitorTestCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _connectionMonitorTestRestClient.ListByPeeringServiceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ConnectionMonitorTestResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<ConnectionMonitorTestResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _connectionMonitorTestClientDiagnostics.CreateScope("ConnectionMonitorTestCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _connectionMonitorTestRestClient.ListByPeeringService(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ConnectionMonitorTestResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<ConnectionMonitorTestResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _connectionMonitorTestClientDiagnostics.CreateScope("ConnectionMonitorTestCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _connectionMonitorTestRestClient.ListByPeeringServiceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ConnectionMonitorTestResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
