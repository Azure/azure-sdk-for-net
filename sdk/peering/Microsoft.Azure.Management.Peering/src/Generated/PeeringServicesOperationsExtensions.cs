...
namespace Microsoft.Azure.Management.Peering
{
    ...
    public static partial class PeeringServicesOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PeeringService> UpdateAsync(this IPeeringServicesOperations operations, string resourceGroupName, string peeringServiceName, ResourceTags tags, CancellationToken cancellationToken = default(CancellationToken))
            {
