...
namespace Microsoft.Azure.Management.Peering
{
    ...
    /// <summary>
    /// Extension methods for PeeringServiceLocationsOperations.
    /// </summary>
    public static partial class PeeringServiceLocationsOperationsExtensions
    {
            ...
            /// </param>
            public static IPage<PeeringServiceLocation> ListNext(this IPeeringServiceLocationsOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<PeeringServiceLocation>> ListNextAsync(this IPeeringServiceLocationsOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
