...
namespace Microsoft.Azure.Management.Peering
{
    ...
    public partial class PeeringManagementClient : ServiceClient<PeeringManagementClient>, IPeeringManagementClient, IAzureClient
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<string>> CheckServiceProviderAvailabilityWithHttpMessagesAsync(CheckServiceProviderAvailabilityInput checkServiceProviderAvailabilityInput, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
