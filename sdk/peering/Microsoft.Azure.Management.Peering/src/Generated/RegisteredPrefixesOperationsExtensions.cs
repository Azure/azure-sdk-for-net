...
namespace Microsoft.Azure.Management.Peering
{
    ...
    public static partial class RegisteredPrefixesOperationsExtensions
    {
            ...
            /// The name of the registered prefix.
            /// </param>
            /// <param name='registeredPrefix'>
            /// The properties needed to create a registered prefix.
            /// </param>
            public static PeeringRegisteredPrefix CreateOrUpdate(this IRegisteredPrefixesOperations operations, string resourceGroupName, string peeringName, string registeredPrefixName, PeeringRegisteredPrefix registeredPrefix)
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, peeringName, registeredPrefixName, registeredPrefix).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<PeeringRegisteredPrefix> CreateOrUpdateAsync(this IRegisteredPrefixesOperations operations, string resourceGroupName, string peeringName, string registeredPrefixName, PeeringRegisteredPrefix registeredPrefix, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, peeringName, registeredPrefixName, registeredPrefix, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
