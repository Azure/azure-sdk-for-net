...
namespace Microsoft.Azure.Management.Peering
{
    ...
    public partial interface IRegisteredPrefixesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<PeeringRegisteredPrefix>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string peeringName, string registeredPrefixName, PeeringRegisteredPrefix registeredPrefix, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
