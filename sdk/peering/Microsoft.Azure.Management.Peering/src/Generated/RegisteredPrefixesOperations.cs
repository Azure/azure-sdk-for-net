...
namespace Microsoft.Azure.Management.Peering
{
    ...
    internal partial class RegisteredPrefixesOperations : IServiceOperations<PeeringManagementClient>, IRegisteredPrefixesOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<PeeringRegisteredPrefix>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string peeringName, string registeredPrefixName, PeeringRegisteredPrefix registeredPrefix, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "registeredPrefix");
            }
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
