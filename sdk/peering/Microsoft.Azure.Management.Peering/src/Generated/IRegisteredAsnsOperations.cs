...
namespace Microsoft.Azure.Management.Peering
{
    ...
    public partial interface IRegisteredAsnsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<PeeringRegisteredAsn>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string peeringName, string registeredAsnName, PeeringRegisteredAsn registeredAsn, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
