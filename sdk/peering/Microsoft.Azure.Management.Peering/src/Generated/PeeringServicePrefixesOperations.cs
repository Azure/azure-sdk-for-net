...
namespace Microsoft.Azure.Management.Peering
{
    ...
    internal partial class PeeringServicePrefixesOperations : IServiceOperations<PeeringManagementClient>, IPeeringServicePrefixesOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<PeeringServicePrefix>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string peeringServiceName, string prefixName, PeeringServicePrefix prefix, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
            ...
            if(prefix != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(prefix, Client.SerializationSettings);
