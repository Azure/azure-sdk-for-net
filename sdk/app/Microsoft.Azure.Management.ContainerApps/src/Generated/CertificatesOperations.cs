...
namespace Microsoft.Azure.Management.ContainerApps
{
    ...
    /// </summary>
    internal partial class CertificatesOperations : IServiceOperations<ContainerAppsAPIClient>, ICertificatesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal CertificatesOperations(ContainerAppsAPIClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<Certificate>> UpdateWithHttpMessagesAsync(string resourceGroupName, string managedEnvironmentName, string name, IDictionary<string, string> tags = default(IDictionary<string, string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            CertificatePatch certificateEnvelope = new CertificatePatch();
            if (tags != null)
            {
                certificateEnvelope.Tags = tags;
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
