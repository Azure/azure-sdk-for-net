...
namespace Microsoft.Azure.Management.ContainerApps
{
    ...
    /// </summary>
    internal partial class NamespacesOperations : IServiceOperations<ContainerAppsAPIClient>, INamespacesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal NamespacesOperations(ContainerAppsAPIClient client)
        {
            if (client == null)
            {
