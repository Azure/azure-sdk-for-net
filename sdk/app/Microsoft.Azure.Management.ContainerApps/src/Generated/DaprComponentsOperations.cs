...
namespace Microsoft.Azure.Management.ContainerApps
{
    ...
    /// </summary>
    internal partial class DaprComponentsOperations : IServiceOperations<ContainerAppsAPIClient>, IDaprComponentsOperations
    {
        /// <summary>
        /// Initializes a new instance of the DaprComponentsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal DaprComponentsOperations(ContainerAppsAPIClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<DaprComponent>>> ListWithHttpMessagesAsync(string resourceGroupName, string environmentName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/daprComponents").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<DaprComponent>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<DaprComponent>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse<DaprComponent>> GetWithHttpMessagesAsync(string resourceGroupName, string environmentName, string name, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<DaprComponent>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<DaprComponent>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        public async Task<AzureOperationResponse<DaprComponent>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string environmentName, string name, DaprComponent daprComponentEnvelope, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "daprComponentEnvelope");
            }
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
            ...
            if(daprComponentEnvelope != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(daprComponentEnvelope, Client.SerializationSettings);
        ...
        public async Task<AzureOperationResponse<DaprSecretsCollection>> ListSecretsWithHttpMessagesAsync(string resourceGroupName, string environmentName, string name, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<DaprSecretsCollection>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<DaprSecretsCollection>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<DaprComponent>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
