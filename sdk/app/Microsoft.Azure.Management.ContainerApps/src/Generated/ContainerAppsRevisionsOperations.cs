...
namespace Microsoft.Azure.Management.ContainerApps
{
    ...
    /// </summary>
    internal partial class ContainerAppsRevisionsOperations : IServiceOperations<ContainerAppsAPIClient>, IContainerAppsRevisionsOperations
    {
        /// <summary>
        /// Initializes a new instance of the ContainerAppsRevisionsOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal ContainerAppsRevisionsOperations(ContainerAppsAPIClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Revision>>> ListRevisionsWithHttpMessagesAsync(string resourceGroupName, string containerAppName, ODataQuery<Revision> odataQuery = default(ODataQuery<Revision>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/revisions").ToString();
