...
namespace Microsoft.Azure.Management.ContainerApps
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<ContainerAppsAPIClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(ContainerAppsAPIClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<OperationDetail>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.App/operations").ToString();
