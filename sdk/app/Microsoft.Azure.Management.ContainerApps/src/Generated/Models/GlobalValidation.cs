...
namespace Microsoft.Azure.Management.ContainerApps.Models
{
    ...
    public partial class GlobalValidation
    {
        ...
        public GlobalValidation(UnauthenticatedClientActionV2? unauthenticatedClientAction = default(UnauthenticatedClientActionV2?), string redirectToProvider = default(string), IList<string> excludedPaths = default(IList<string>))
        {
