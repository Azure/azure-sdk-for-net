...
namespace Microsoft.Azure.Management.ContainerApps.Models
{
    ...
    public partial class ContainerResources
    {
        ...
        /// <param name="ephemeralStorage">Ephemeral Storage, e.g.
        /// "1Gi"</param>
        public ContainerResources(double? cpu = default(double?), string memory = default(string), string ephemeralStorage = default(string))
        {
            Cpu = cpu;
            Memory = memory;
        ...
        /// <summary>
        /// Gets ephemeral Storage, e.g. "1Gi"
        /// </summary>
        [JsonProperty(PropertyName = "ephemeralStorage")]
        public string EphemeralStorage { get; private set; }
