...
namespace Microsoft.Azure.Management.ContainerApps.Models
{
    ...
    public partial class TrafficWeight
    {
        ...
        /// <param name="label">Associates a traffic label with a
        /// revision</param>
        public TrafficWeight(string revisionName = default(string), int? weight = default(int?), bool? latestRevision = default(bool?), string label = default(string))
        {
        ...
        /// <summary>
        /// Gets or sets associates a traffic label with a revision
        /// </summary>
