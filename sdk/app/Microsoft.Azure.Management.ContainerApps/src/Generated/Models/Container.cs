...
namespace Microsoft.Azure.Management.ContainerApps.Models
{
    ...
    public partial class Container
    {
        ...
        public Container(string image = default(string), string name = default(string), IList<string> command = default(IList<string>), IList<string> args = default(IList<string>), IList<EnvironmentVar> env = default(IList<EnvironmentVar>), ContainerResources resources = default(ContainerResources), IList<ContainerAppProbe> probes = default(IList<ContainerAppProbe>), IList<VolumeMount> volumeMounts = default(IList<VolumeMount>))
        {
            Image = image;
            Name = name;
            Command = command;
        ...
        /// <summary>
        /// Gets or sets list of probes for the container.
        /// </summary>
        [JsonProperty(PropertyName = "probes")]
        public IList<ContainerAppProbe> Probes { get; set; }

        /// <summary>
        /// Gets or sets container volume mounts.
        /// </summary>
