...
namespace Azure.ResourceManager.WorkloadMonitor.Models
{
    ...
    public static partial class ArmWorkloadMonitorModelFactory
    {
        ...
        {
            return new HealthMonitorData(id, name, resourceType, systemData, monitorName, monitorType, monitoredObject, parentMonitorName, previousMonitorState, currentMonitorState, evaluationTimestamp, currentStateFirstObservedTimestamp, lastReportedTimestamp, evidence, monitorConfiguration, default);
        }
        ...
        {
            return new HealthMonitorStateChangeData(id, name, resourceType, systemData, monitorName, monitorType, monitoredObject, evaluationTimestamp, currentStateFirstObservedTimestamp, previousMonitorState, currentMonitorState, evidence, monitorConfiguration, default);
        }
    }
}
