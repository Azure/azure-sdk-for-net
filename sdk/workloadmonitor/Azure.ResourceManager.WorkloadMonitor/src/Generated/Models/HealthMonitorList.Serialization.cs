...
{
    internal partial class HealthMonitorList : IUtf8JsonSerializable, IJsonModel<HealthMonitorList>, IPersistableModel<HealthMonitorList>
    {
        ...
        void IJsonModel<HealthMonitorList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HealthMonitorList)} does not support '{format}' format.");
            }
