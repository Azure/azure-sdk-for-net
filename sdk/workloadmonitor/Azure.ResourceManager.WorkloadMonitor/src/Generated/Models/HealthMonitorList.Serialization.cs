...
namespace Azure.ResourceManager.WorkloadMonitor.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthMonitorList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthMonitorList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthMonitorList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthMonitorList>)} interface");
            }
        ...
        string IPersistableModel<HealthMonitorList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
