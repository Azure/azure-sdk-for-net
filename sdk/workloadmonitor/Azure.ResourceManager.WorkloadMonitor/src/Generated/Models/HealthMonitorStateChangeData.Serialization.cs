...
namespace Azure.ResourceManager.WorkloadMonitor
{
    ...
    {
        internal static HealthMonitorStateChangeData DeserializeHealthMonitorStateChangeData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
