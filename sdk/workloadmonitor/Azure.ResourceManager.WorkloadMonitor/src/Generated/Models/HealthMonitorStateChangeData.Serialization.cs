...
namespace Azure.ResourceManager.WorkloadMonitor
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthMonitorStateChangeData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthMonitorStateChangeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthMonitorStateChangeData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthMonitorStateChangeData>)} interface");
            }
        ...
        string IPersistableModel<HealthMonitorStateChangeData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
