    ...
    public partial class HealthMonitorStateChangeData : IUtf8JsonSerializable, IJsonModel<HealthMonitorStateChangeData>
    {
        ...
        internal static HealthMonitorStateChangeData DeserializeHealthMonitorStateChangeData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.WorkloadMonitor.ModelSerializationExtensions.WireOptions, AzureResourceManagerWorkloadMonitorContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerWorkloadMonitorContext.Default)
#endif
;
                    continue;
                }
