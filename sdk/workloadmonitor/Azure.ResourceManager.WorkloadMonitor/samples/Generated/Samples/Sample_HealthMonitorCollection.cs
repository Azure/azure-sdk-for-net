...
namespace Azure.ResourceManager.WorkloadMonitor.Samples
{
    public partial class Sample_HealthMonitorCollection
    {
        ...
        public async Task Get_GetMonitorWithExpandedValues()
        {
            ...
            HealthMonitorResource result = await collection.GetAsync(monitorId, expand);
        ...
        public async Task GetAll_GetMonitorListWithExpandedValues()
        {
            ...
            await foreach (HealthMonitorResource item in collection.GetAllAsync(expand))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                HealthMonitorData resourceData = item.Data;
        ...
        public async Task GetAll_GetMonitorListWithFilteredValues()
        {
            ...
            await foreach (HealthMonitorResource item in collection.GetAllAsync(filter))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                HealthMonitorData resourceData = item.Data;
        ...
        public async Task Exists_GetMonitorWithExpandedValues()
        {
            ...
            string monitorId = "logical-disks|C@3A|free-space";
            string expand = "evidence";
            bool result = await collection.ExistsAsync(monitorId, expand);
        ...
        public async Task GetIfExists_GetMonitorWithExpandedValues()
        {
            ...
            string monitorId = "logical-disks|C@3A|free-space";
            string expand = "evidence";
            NullableResponse<HealthMonitorResource> response = await collection.GetIfExistsAsync(monitorId, expand);
            HealthMonitorResource result = response.HasValue ? response.Value : null;
