...
namespace Azure.Template
{
    ...
    public partial class ConfidentialLedgerIdentityServiceClient
    {
        ...
        public ConfidentialLedgerIdentityServiceClient(Uri ledgerUri, TokenCredential credential) : this(ledgerUri, credential, new ConfidentialLedgerServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="ledgerUri"/> or <paramref name="credential"/> is null. </exception>
        public ConfidentialLedgerIdentityServiceClient(Uri ledgerUri, TokenCredential credential, ConfidentialLedgerServiceClientOptions options)
        {
            Argument.AssertNotNull(ledgerUri, nameof(ledgerUri));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new ConfidentialLedgerServiceClientOptions();
