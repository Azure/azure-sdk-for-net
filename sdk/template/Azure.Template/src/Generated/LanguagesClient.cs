...
{
    /// <summary> The Languages service client. </summary>
    public partial class LanguagesClient
    {
        ...
        /// <summary> Initializes a new instance of LanguagesClient for mocking. </summary>
        protected LanguagesClient()
        {
        }

        /// <summary> Initializes a new instance of LanguagesClient. </summary>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public LanguagesClient(TokenCredential credential) : this(credential, new Uri(""), new TextAnalyticsClientOptions())
        {
        }
        ...
        public LanguagesClient(TokenCredential credential, Uri endpoint, TextAnalyticsClientOptions options)
        {
        ...
        /// Request Body:
        /// 
        /// Schema for <c>LanguageBatchInput</c>:
        /// <code>{
        ///   documents: [
        ///     {
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> DetectAsync(RequestContent content, string modelVersion = null, bool? loggingOptOut = null, string stringIndexType = null, bool? showStats = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("LanguagesClient.Detect");
            scope.Start();
            try
            {
                using HttpMessage message = CreateDetectRequest(content, modelVersion, loggingOptOut, stringIndexType, showStats, context);
        ...
        /// 
        /// </remarks>
        public virtual Response Detect(RequestContent content, string modelVersion = null, bool? loggingOptOut = null, string stringIndexType = null, bool? showStats = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal HttpMessage CreateDetectRequest(RequestContent content, string modelVersion, bool? loggingOptOut, string stringIndexType, bool? showStats, RequestContext context)
        {
