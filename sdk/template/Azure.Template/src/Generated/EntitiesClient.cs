...
namespace Azure.Template
{
    ...
    public partial class EntitiesClient
    {
        ...
        public EntitiesClient(TokenCredential credential) : this(credential, new Uri(""), new TextAnalyticsClientOptions())
        {
        }
        ...
        public EntitiesClient(TokenCredential credential, Uri endpoint, TextAnalyticsClientOptions options)
        {
        ...
        public virtual async Task<Response> RecognizeAsync(RequestContent content, string modelVersion = null, bool? loggingOptOut = null, string stringIndexType = null, bool? showStats = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("EntitiesClient.Recognize");
            scope.Start();
            try
            {
