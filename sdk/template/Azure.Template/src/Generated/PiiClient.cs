...
{
    /// <summary> The Pii service client. </summary>
    public partial class PiiClient
    {
        ...
        /// <summary> Initializes a new instance of PiiClient for mocking. </summary>
        protected PiiClient()
        {
        }

        /// <summary> Initializes a new instance of PiiClient. </summary>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public PiiClient(TokenCredential credential) : this(credential, new Uri(""), new TextAnalyticsClientOptions())
        {
        }
        ...
        public PiiClient(TokenCredential credential, Uri endpoint, TextAnalyticsClientOptions options)
        {
        ...
        /// <param name="domain"> If specified, will set the PII domain to include only a subset of the entity categories. Allowed values: &quot;phi&quot; | &quot;none&quot;. </param>
        /// <param name="piiCategories"> Describes the PII categories to return. </param>
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> RecognizeAsync(RequestContent content, string modelVersion = null, bool? loggingOptOut = null, string stringIndexType = null, string domain = null, IEnumerable<string> piiCategories = null, bool? showStats = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("PiiClient.Recognize");
            scope.Start();
            try
            {
                using HttpMessage message = CreateRecognizeRequest(content, modelVersion, loggingOptOut, stringIndexType, domain, piiCategories, showStats, context);
        ...
        /// 
        /// </remarks>
        public virtual Response Recognize(RequestContent content, string modelVersion = null, bool? loggingOptOut = null, string stringIndexType = null, string domain = null, IEnumerable<string> piiCategories = null, bool? showStats = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal HttpMessage CreateRecognizeRequest(RequestContent content, string modelVersion, bool? loggingOptOut, string stringIndexType, string domain, IEnumerable<string> piiCategories, bool? showStats, RequestContext context)
        {
