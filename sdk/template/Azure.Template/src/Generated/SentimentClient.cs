...
{
    /// <summary> The Sentiment service client. </summary>
    public partial class SentimentClient
    {
        ...
        /// <summary> Initializes a new instance of SentimentClient for mocking. </summary>
        protected SentimentClient()
        {
        }

        /// <summary> Initializes a new instance of SentimentClient. </summary>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public SentimentClient(TokenCredential credential) : this(credential, new Uri(""), new TextAnalyticsClientOptions())
        {
        }
        ...
        public SentimentClient(TokenCredential credential, Uri endpoint, TextAnalyticsClientOptions options)
        {
        ...
        /// Response Body:
        /// 
        /// Schema for <c>SentimentResult</c>:
        /// <code>{
        ///   documents: [
        ///     {
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> AnalyzeAsync(RequestContent content, string modelVersion = null, bool? loggingOptOut = null, string stringIndexType = null, bool? opinionMining = null, bool? showStats = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("SentimentClient.Analyze");
            scope.Start();
            try
            {
                using HttpMessage message = CreateAnalyzeRequest(content, modelVersion, loggingOptOut, stringIndexType, opinionMining, showStats, context);
        ...
        /// 
        /// </remarks>
        public virtual Response Analyze(RequestContent content, string modelVersion = null, bool? loggingOptOut = null, string stringIndexType = null, bool? opinionMining = null, bool? showStats = null, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal HttpMessage CreateAnalyzeRequest(RequestContent content, string modelVersion, bool? loggingOptOut, string stringIndexType, bool? opinionMining, bool? showStats, RequestContext context)
        {
