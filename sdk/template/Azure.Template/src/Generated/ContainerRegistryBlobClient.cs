...
namespace Azure.Template
{
    ...
    public partial class ContainerRegistryBlobClient
    {
        ...
        public ContainerRegistryBlobClient(string url, TokenCredential credential) : this(url, credential, new AzureContainerRegistryClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="url"/> or <paramref name="credential"/> is null. </exception>
        public ContainerRegistryBlobClient(string url, TokenCredential credential, AzureContainerRegistryClientOptions options)
        {
