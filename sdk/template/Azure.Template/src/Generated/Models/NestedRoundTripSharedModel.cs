...
{
    /// <summary> Model to illustrate a nested model that appears as a nested model on input, output, and round-trip models. </summary>
    public partial class NestedRoundTripSharedModel
    {
        /// <summary> Initializes a new instance of NestedRoundTripSharedModel. </summary>
        ...
        /// <param name="requiredStringList"> Required collection of strings, illustrating a collection of reference types. </param>
        /// <param name="requiredIntList"> Required collection of ints, illustrating a collection of value types. </param>
        internal NestedRoundTripSharedModel(string requiredString, int requiredInt, IList<string> requiredStringList, IList<int> requiredIntList)
        {
            RequiredString = requiredString;
            RequiredInt = requiredInt;
