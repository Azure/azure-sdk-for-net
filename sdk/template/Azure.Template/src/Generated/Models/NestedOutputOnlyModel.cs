...
{
    /// <summary> Model to illustrate a nested model that only appears on an output model. </summary>
    public partial class NestedOutputOnlyModel
    {
        ...
        internal NestedOutputOnlyModel(string requiredString, int requiredInt, IEnumerable<string> requiredStringList, IEnumerable<int> requiredIntList)
        {
        ...
        /// <param name="requiredStringList"> Required collection of strings, illustrating a collection of reference types. </param>
        /// <param name="requiredIntList"> Required collection of ints, illustrating a collection of value types. </param>
        internal NestedOutputOnlyModel(string requiredString, int requiredInt, IReadOnlyList<string> requiredStringList, IReadOnlyList<int> requiredIntList)
        {
            RequiredString = requiredString;
            RequiredInt = requiredInt;
