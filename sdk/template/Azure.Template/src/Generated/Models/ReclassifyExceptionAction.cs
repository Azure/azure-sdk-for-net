...
namespace Azure.Communication.JobRouter.Models
{
    ...
    public partial class ReclassifyExceptionAction : ExceptionAction
    {
        ...
        {
            LabelsToUpsert = new ChangeTrackingDictionary<string, object>();
            Kind = "reclassify";
        }
        ...
        /// <summary> (optional) Dictionary containing the labels to update (or add if not existing) in key-value pairs. </summary>
        public IDictionary<string, object> LabelsToUpsert { get; }
    }
}
