...
namespace Azure.Template.Models
{
    ...
    public partial class OutputModel
    {
        ...
        internal OutputModel(string requiredReadonlyString, int requiredReadonlyInt, ReadonlyModel requiredReadonlyModel, IEnumerable<string> readonlyStringList, IEnumerable<int> readonlyIntList)
        {
