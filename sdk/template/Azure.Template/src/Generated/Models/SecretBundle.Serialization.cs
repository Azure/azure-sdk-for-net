...
namespace Azure.Template.Models
{
    public partial class SecretBundle
    {
        internal static SecretBundle DeserializeSecretBundle(JsonElement element)
        {
            ...
            return new SecretBundle(value.HasValue ? value.Value : null, id.HasValue ? id.Value : null, contentType.HasValue ? contentType.Value : null, new ChangeTrackingDictionary<string, string>(tags), kid.HasValue ? kid.Value : null, managed.HasValue ? managed.Value : (bool?)null);
        }
    }
}
