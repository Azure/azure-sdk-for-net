...
{
    internal partial class AzureWidgetsGetWidgetsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        /// <returns> The pages of AzureWidgetsGetWidgetsAsyncCollectionResult as an enumerable collection. </returns>
        public override async IAsyncEnumerable<global::Azure.Page<global::System.BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                {
                    items.Add(global::System.ClientModel.Primitives.ModelReaderWriter.Write(item, global::Azure.Template.ModelSerializationExtensions.WireOptions, global::Azure.Template.AzureTemplateContext.Default));
                }
