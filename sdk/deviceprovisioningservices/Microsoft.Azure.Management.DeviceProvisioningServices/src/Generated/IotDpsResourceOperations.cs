...
namespace Microsoft.Azure.Management.DeviceProvisioningServices
{
    ...
    internal partial class IotDpsResourceOperations : IServiceOperations<IotDpsClient>, IIotDpsResourceOperations
    {
        ...
        {
            // Send Request
            AzureOperationResponse<PrivateEndpointConnection> _response = await BeginCreateOrUpdatePrivateEndpointConnectionWithHttpMessagesAsync(resourceGroupName, resourceName, privateEndpointConnectionName, privateEndpointConnection, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPutOrPatchOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
