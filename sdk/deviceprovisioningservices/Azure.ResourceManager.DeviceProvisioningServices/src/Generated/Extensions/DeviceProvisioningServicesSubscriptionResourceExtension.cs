...
namespace Azure.ResourceManager.DeviceProvisioningServices.Testing
{
    ...
    public partial class DeviceProvisioningServicesSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DeviceProvisioningServicesSubscriptionResourceExtension"/> class for mocking. </summary>
        protected DeviceProvisioningServicesSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DeviceProvisioningServicesSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DeviceProvisioningServicesSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<DeviceProvisioningServicesNameAvailabilityResult>> CheckDeviceProvisioningServicesNameAvailabilityAsync(DeviceProvisioningServicesNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DeviceProvisioningServiceIotDpsResourceClientDiagnostics.CreateScope("DeviceProvisioningServicesSubscriptionResourceExtension.CheckDeviceProvisioningServicesNameAvailability");
            scope.Start();
            try
            {
