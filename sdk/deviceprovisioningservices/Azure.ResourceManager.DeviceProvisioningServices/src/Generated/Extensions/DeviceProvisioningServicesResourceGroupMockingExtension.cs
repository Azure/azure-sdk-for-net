...
namespace Azure.ResourceManager.DeviceProvisioningServices.Mocking
{
    ...
    internal partial class DeviceProvisioningServicesResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DeviceProvisioningServicesResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DeviceProvisioningServicesResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DeviceProvisioningServicesResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DeviceProvisioningServicesResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
