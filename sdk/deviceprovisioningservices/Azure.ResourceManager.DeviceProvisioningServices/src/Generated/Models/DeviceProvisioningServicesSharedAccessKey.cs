...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    public partial class DeviceProvisioningServicesSharedAccessKey
    {
        ...
        internal DeviceProvisioningServicesSharedAccessKey(string keyName, string primaryKey, string secondaryKey, DeviceProvisioningServicesAccessKeyRight rights, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
