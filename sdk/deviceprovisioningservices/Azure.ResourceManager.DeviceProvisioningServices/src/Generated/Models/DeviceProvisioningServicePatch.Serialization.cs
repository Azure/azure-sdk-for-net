...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceProvisioningServicePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceProvisioningServicePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceProvisioningServicePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceProvisioningServicePatch>)} interface");
            }
        ...
        string IPersistableModel<DeviceProvisioningServicePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
