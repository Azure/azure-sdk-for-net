...
namespace Azure.ResourceManager.DeviceProvisioningServices
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceProvisioningServiceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceProvisioningServiceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceProvisioningServiceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceProvisioningServiceData>)} interface");
            }
        ...
        string IPersistableModel<DeviceProvisioningServiceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
