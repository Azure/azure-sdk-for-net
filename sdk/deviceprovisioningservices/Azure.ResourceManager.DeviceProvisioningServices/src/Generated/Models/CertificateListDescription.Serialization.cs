...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    internal partial class CertificateListDescription : IUtf8JsonSerializable, IJsonModel<CertificateListDescription>
    {
        ...
        void IJsonModel<CertificateListDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CertificateListDescription)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CertificateListDescription>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CertificateListDescription)} does not support '{options.Format}' format.");
            }
        }
