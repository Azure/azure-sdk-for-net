    ...
    public partial class DeviceProvisioningServiceProperties : IUtf8JsonSerializable, IJsonModel<DeviceProvisioningServiceProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AllocationPolicy))
            {
                ...
                builder.AppendLine($" '{AllocationPolicy.Value.ToString()}'");
            }

            if (Optional.IsDefined(ServiceOperationsHostName))
            {
                builder.Append("  serviceOperationsHostName:");
                if (ServiceOperationsHostName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(DeviceProvisioningHostName))
            {
                ...
                if (DeviceProvisioningHostName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(IdScope))
            {
                ...
                if (IdScope.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
