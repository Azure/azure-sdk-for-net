...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    public partial class CertificateVerificationCodeProperties
    {
        ...
        internal CertificateVerificationCodeProperties(string verificationCode, string subject, string expiry, string thumbprint, bool? isVerified, byte[] certificate, string created, string updated)
        {
