...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    public partial class DeviceProvisioningServicesSkuInfo
    {
        ...
        internal DeviceProvisioningServicesSkuInfo(DeviceProvisioningServicesSku? name, string tier, long? capacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Capacity = capacity;
