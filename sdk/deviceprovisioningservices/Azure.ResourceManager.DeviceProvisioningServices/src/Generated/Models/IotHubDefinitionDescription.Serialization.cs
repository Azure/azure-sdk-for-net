...
{
    public partial class IotHubDefinitionDescription : IUtf8JsonSerializable, IJsonModel<IotHubDefinitionDescription>, IPersistableModel<IotHubDefinitionDescription>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ApplyAllocationPolicy))
            {
                builder.Append("  applyAllocationPolicy:");
                var boolValue = ApplyAllocationPolicy.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(AllocationWeight))
            {
                builder.Append("  allocationWeight:");
                builder.AppendLine($" '{AllocationWeight.Value.ToString()}'");
            }
