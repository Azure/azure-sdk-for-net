...
{
    public partial class DeviceProvisioningServicesCertificateData : Core.IUtf8JsonSerializable
    {
        ...
        internal static DeviceProvisioningServicesCertificateData DeserializeDeviceProvisioningServicesCertificateData(JsonElement element)
        {
            ...
            Core.Optional<DeviceProvisioningServicesCertificateProperties> properties = default;
            ...
            return new DeviceProvisioningServicesCertificateData(id, name, type, systemData.Value, properties.Value, Core.Optional.ToNullable(etag));
        }
    }
}
