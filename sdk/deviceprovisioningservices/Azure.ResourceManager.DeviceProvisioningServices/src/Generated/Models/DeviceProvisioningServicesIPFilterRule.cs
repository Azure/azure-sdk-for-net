...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    public partial class DeviceProvisioningServicesIPFilterRule
    {
        ...
        internal DeviceProvisioningServicesIPFilterRule(string filterName, DeviceProvisioningServicesIPFilterActionType action, string ipMask, DeviceProvisioningServicesIPFilterTargetType? target, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FilterName = filterName;
            Action = action;
            IPMask = ipMask;
