...
{
    /// <summary> A class representing the query and header parameters in Delete method. </summary>
    public partial class DeviceProvisioningServicesCertificateDeleteOptions
    {
        /// <summary> Initializes a new instance of DeviceProvisioningServicesCertificateDeleteOptions. </summary>
        /// <param name="ifMatch"> ETag of the certificate. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ifMatch"/> is null. </exception>
        public DeviceProvisioningServicesCertificateDeleteOptions(string ifMatch)
        {
