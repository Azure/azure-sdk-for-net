...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceProvisioningServicesIPFilterRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceProvisioningServicesIPFilterRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceProvisioningServicesIPFilterRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceProvisioningServicesIPFilterRule>)} interface");
            }
        ...
        string IPersistableModel<DeviceProvisioningServicesIPFilterRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
