...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CertificateVerificationCodeContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CertificateVerificationCodeContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CertificateVerificationCodeContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CertificateVerificationCodeContent>)} interface");
            }
        ...
        string IPersistableModel<CertificateVerificationCodeContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
