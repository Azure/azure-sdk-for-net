...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceProvisioningServicesCertificateProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceProvisioningServicesCertificateProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceProvisioningServicesCertificateProperties>)} interface");
            }
        ...
        string IPersistableModel<DeviceProvisioningServicesCertificateProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
