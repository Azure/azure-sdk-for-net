...
{
    public partial class DeviceProvisioningServicesPrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static DeviceProvisioningServicesPrivateEndpointConnectionData DeserializeDeviceProvisioningServicesPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new DeviceProvisioningServicesPrivateEndpointConnectionData(id, name, type, systemData.Value, properties);
        }
    }
}
