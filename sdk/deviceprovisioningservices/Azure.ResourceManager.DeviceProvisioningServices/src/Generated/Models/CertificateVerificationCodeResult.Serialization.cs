...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CertificateVerificationCodeResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CertificateVerificationCodeResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CertificateVerificationCodeResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CertificateVerificationCodeResult>)} interface");
            }
        ...
        string IPersistableModel<CertificateVerificationCodeResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
