...
{
    public partial class DeviceProvisioningServicesSharedAccessKey : IUtf8JsonSerializable, IJsonModel<DeviceProvisioningServicesSharedAccessKey>, IPersistableModel<DeviceProvisioningServicesSharedAccessKey>
    {
        ...
        void IJsonModel<DeviceProvisioningServicesSharedAccessKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeviceProvisioningServicesSharedAccessKey)} does not support '{format}' format.");
            }
