...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceProvisioningServicesSharedAccessKey>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        DeviceProvisioningServicesSharedAccessKey IJsonModel<DeviceProvisioningServicesSharedAccessKey>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<DeviceProvisioningServicesSharedAccessKey>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        DeviceProvisioningServicesSharedAccessKey IModel<DeviceProvisioningServicesSharedAccessKey>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<DeviceProvisioningServicesSharedAccessKey>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
