...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    public partial class DeviceProvisioningServicesPrivateLinkResourceProperties
    {
        ...
        internal DeviceProvisioningServicesPrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, IReadOnlyList<string> requiredZoneNames, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            GroupId = groupId;
