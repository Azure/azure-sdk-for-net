...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    public partial class CertificateVerificationCodeResult : ResourceData
    {
        ...
        internal CertificateVerificationCodeResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ETag? eTag, CertificateVerificationCodeProperties properties) : base(id, name, resourceType, systemData)
        {
