...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    public partial class PrivateEndpointConnectionProperties
    {
        ...
        public PrivateEndpointConnectionProperties(DeviceProvisioningServicesPrivateLinkServiceConnectionState connectionState)
        {
        ...
        /// <param name="connectionState"> The current state of a private endpoint connection. </param>
        internal PrivateEndpointConnectionProperties(SubResource privateEndpoint, DeviceProvisioningServicesPrivateLinkServiceConnectionState connectionState)
        {
