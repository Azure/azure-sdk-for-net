...
namespace Azure.ResourceManager.DeviceProvisioningServices
{
    ...
    public partial class DeviceProvisioningServicesCertificateData : ResourceData
    {
        ...
        internal DeviceProvisioningServicesCertificateData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DeviceProvisioningServicesCertificateProperties properties, ETag? eTag, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
