    ...
    internal partial class ProvisioningServiceDescriptionsGetKeysCollectionResultOfT : Pageable<DeviceProvisioningServicesSharedAccessKey>
    {
        ...
        public override IEnumerable<Page<DeviceProvisioningServicesSharedAccessKey>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<DeviceProvisioningServicesSharedAccessKey>.FromValues((IReadOnlyList<DeviceProvisioningServicesSharedAccessKey>)result.Value, nextPage?.AbsoluteUri, response);
