...
namespace Azure.ResourceManager.DeviceProvisioningServices
{
    internal partial class DeviceProvisioningServicesArmOperation<T> : ArmOperation<T>
    {
        ...
        internal DeviceProvisioningServicesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
