...
{
    /// <summary></summary>
    internal partial class DeviceProvisioningServicesPrivateEndpointConnectionResourceOperationSource : IOperationSource<DeviceProvisioningServicesPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DeviceProvisioningServicesPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
