...
{
    /// <summary></summary>
    internal partial class DeviceProvisioningServiceResourceOperationSource : IOperationSource<DeviceProvisioningServiceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DeviceProvisioningServiceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
