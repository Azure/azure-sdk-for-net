...
namespace Azure.ResourceManager.DeviceProvisioningServices.Models
{
    ...
    public static partial class ArmDeviceProvisioningServicesModelFactory
    {
        ...
        {
            return new DeviceProvisioningServicesCertificateData(id, name, resourceType, systemData, properties, etag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceProvisioningServicesCertificateProperties(subject, expireOn, thumbprint, isVerified, certificate, createdOn, updatedOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static DeviceProvisioningServiceData DeviceProvisioningServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ETag? etag = null, DeviceProvisioningServiceProperties properties = null, DeviceProvisioningServicesSkuInfo sku = null)
        {
            ...
            return new DeviceProvisioningServiceData(id, name, resourceType, systemData, tags, location, etag, properties, sku, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceProvisioningServicesPrivateEndpointConnectionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IotHubDefinitionDescription(applyAllocationPolicy, allocationWeight, name, connectionString, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceProvisioningServicesSkuInfo(name, tier, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceProvisioningServicesSkuDefinition(name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CertificateVerificationCodeResult(id, name, resourceType, systemData, etag, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CertificateVerificationCodeProperties(verificationCode, subject, expireOn, thumbprint, isVerified, certificate, createdOn, updatedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceProvisioningServicesNameAvailabilityResult(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeviceProvisioningServicesPrivateLinkResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static DeviceProvisioningServicesPrivateLinkResourceProperties DeviceProvisioningServicesPrivateLinkResourceProperties(string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new DeviceProvisioningServicesPrivateLinkResourceProperties(groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
    }
}
