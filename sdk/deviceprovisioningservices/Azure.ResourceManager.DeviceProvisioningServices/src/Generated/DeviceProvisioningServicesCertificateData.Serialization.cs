...
namespace Azure.ResourceManager.DeviceProvisioningServices
{
    ...
    public partial class DeviceProvisioningServicesCertificateData : ResourceData, IJsonModel<DeviceProvisioningServicesCertificateData>
    {
        ...
        internal static RequestContent ToRequestContent(DeviceProvisioningServicesCertificateData deviceProvisioningServicesCertificateData)
        {
            ...
            return RequestContent.Create(deviceProvisioningServicesCertificateData, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeviceProvisioningServicesCertificateData IJsonModel<DeviceProvisioningServicesCertificateData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DeviceProvisioningServicesCertificateData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DeviceProvisioningServicesCertificateData DeserializeDeviceProvisioningServicesCertificateData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            DeviceProvisioningServicesCertificateProperties properties = default;
            ETag? eTag = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = DeviceProvisioningServicesCertificateProperties.DeserializeDeviceProvisioningServicesCertificateProperties(prop.Value, options);
                    continue;
                }
