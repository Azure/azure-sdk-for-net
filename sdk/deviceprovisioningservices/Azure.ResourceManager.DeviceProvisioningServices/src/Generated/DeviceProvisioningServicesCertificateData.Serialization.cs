...
namespace Azure.ResourceManager.DeviceProvisioningServices
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceProvisioningServicesCertificateData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static DeviceProvisioningServicesCertificateData DeserializeDeviceProvisioningServicesCertificateData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ModelSerializationExtensions.JsonDeserialize<DeviceProvisioningServicesCertificateProperties>(property.Value);
                    continue;
                }
