...
{
    internal partial class EdgeOperatorArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of EdgeOperatorArmOperation for mocking. </summary>
        protected EdgeOperatorArmOperation()
        {
        }
        ...
        internal EdgeOperatorArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal EdgeOperatorArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
