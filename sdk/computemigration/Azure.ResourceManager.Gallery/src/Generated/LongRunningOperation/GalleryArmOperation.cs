...
#pragma warning disable SA1649 // File name should match first type name
    internal class GalleryArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of GalleryArmOperation for mocking. </summary>
        protected GalleryArmOperation()
        {
        }

        internal GalleryArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal GalleryArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "GalleryArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
