...
namespace Azure.ResourceManager.Gallery
{
    ...
    public partial class GalleryApplicationResource : ArmResource
    {
        ...
        {
            _galleryApplicationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Gallery", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new GalleryArmOperation(_galleryApplicationClientDiagnostics, Pipeline, _galleryApplicationRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
