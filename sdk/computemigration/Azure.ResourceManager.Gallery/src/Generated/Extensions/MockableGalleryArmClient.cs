...
namespace Azure.ResourceManager.Gallery.Mocking
{
    ...
    public partial class MockableGalleryArmClient : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableGalleryArmClient"/> class for mocking. </summary>
        protected MockableGalleryArmClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableGalleryArmClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableGalleryArmClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MockableGalleryArmClient(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
