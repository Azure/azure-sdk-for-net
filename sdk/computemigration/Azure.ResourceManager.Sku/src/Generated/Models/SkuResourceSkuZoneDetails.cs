...
namespace Azure.ResourceManager.Sku.Models
{
    ...
    public partial class SkuResourceSkuZoneDetails
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="SkuResourceSkuZoneDetails"/>. </summary>
        ...
        internal SkuResourceSkuZoneDetails(IReadOnlyList<string> name, IReadOnlyList<ComputeResourceSkuCapabilities> capabilities, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
