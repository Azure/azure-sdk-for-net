...
namespace Azure.ResourceManager.Sku.Models
{
    ...
    internal partial class ResourceSkusResult
    {
        ...
        internal ResourceSkusResult(IEnumerable<SkuResourceSku> value)
        {
        ...
        internal ResourceSkusResult(IReadOnlyList<SkuResourceSku> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<SkuResourceSku> Value { get; }
