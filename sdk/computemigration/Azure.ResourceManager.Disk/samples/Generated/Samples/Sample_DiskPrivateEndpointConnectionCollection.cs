...
{
    public partial class Sample_DiskPrivateEndpointConnectionCollection
    {
        ...
        public async Task GetAll_GetInformationAboutAPrivateEndpointConnectionUnderADiskAccessResource()
        {
            ...
            // get the collection of this DiskPrivateEndpointConnectionResource
            DiskPrivateEndpointConnectionCollection collection = diskAccess.GetDiskPrivateEndpointConnections();

            // invoke the operation and iterate over the result
            await foreach (DiskPrivateEndpointConnectionResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DiskPrivateEndpointConnectionData resourceData = item.Data;
        ...
        public async Task Get_GetInformationAboutAPrivateEndpointConnectionUnderADiskAccessResource()
        {
            ...
            DiskPrivateEndpointConnectionResource result = await collection.GetAsync(privateEndpointConnectionName);
        ...
        public async Task GetIfExists_GetInformationAboutAPrivateEndpointConnectionUnderADiskAccessResource()
        {
            ...
            // invoke the operation
            string privateEndpointConnectionName = "myPrivateEndpointConnection";
            NullableResponse<DiskPrivateEndpointConnectionResource> response = await collection.GetIfExistsAsync(privateEndpointConnectionName);
            DiskPrivateEndpointConnectionResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_ApproveAPrivateEndpointConnectionUnderADiskAccessResource()
        {
            ...
            ArmOperation<DiskPrivateEndpointConnectionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, privateEndpointConnectionName, data);
