...
{
    /// <summary> A class representing the QumuloAgent data model. </summary>
    public partial class QumuloAgentData : ResourceData
    {
        ...
        /// <param name="qumuloAgentVersion"> The Agent version. </param>
        /// <param name="arcResourceId"> The fully qualified resource ID of the Hybrid Compute resource for the Agent. </param>
        /// <param name="arcVmUuid"> The VM UUID of the Hybrid Compute resource for the Agent. </param>
        /// <param name="qumuloAgentStatus"> The Agent status. </param>
        ...
        internal QumuloAgentData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, string qumuloAgentVersion, string arcResourceId, string arcVmUuid, QumuloAgentStatus? qumuloAgentStatus, DateTimeOffset? lastStatusUpdate, string localIPAddress, long? memoryInMB, long? numberOfCores, long? uptimeInSeconds, QumuloAgentPropertiesErrorDetails errorDetails, ProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
            Description = description;
            QumuloAgentVersion = qumuloAgentVersion;
            ArcResourceId = arcResourceId;
            ArcVmUuid = arcVmUuid;
            QumuloAgentStatus = qumuloAgentStatus;
        ...
        public string QumuloAgentVersion { get; }
        ...
        public QumuloAgentStatus? QumuloAgentStatus { get; }
