...
namespace Azure.ResourceManager.LiftrQumulo
{
    ...
    public partial class StorageMoverCollection : ArmCollection, IEnumerable<StorageMoverResource>, IAsyncEnumerable<StorageMoverResource>
    {
        ...
        {
            _storageMoverClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.LiftrQumulo", StorageMoverResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<StorageMoverResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string storageMoverName, StorageMoverData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new LiftrQumuloArmOperation<StorageMoverResource>(Response.FromValue(new StorageMoverResource(Client, response), response.GetRawResponse()));
