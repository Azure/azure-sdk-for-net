...
namespace Azure.ResourceManager.LiftrQumulo
{
    ...
    public partial class EndpointResource : ArmResource
    {
        ...
        {
            _endpointClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.LiftrQumulo", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new LiftrQumuloArmOperation(_endpointClientDiagnostics, Pipeline, _endpointRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
