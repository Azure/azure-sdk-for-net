...
namespace Azure.ResourceManager.LiftrQumulo
{
    ...
    public partial class AgentResource : ArmResource
    {
        ...
        {
            _agentClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.LiftrQumulo", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new LiftrQumuloArmOperation(_agentClientDiagnostics, Pipeline, _agentRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
