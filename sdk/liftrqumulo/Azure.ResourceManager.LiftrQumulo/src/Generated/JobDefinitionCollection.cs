...
namespace Azure.ResourceManager.LiftrQumulo
{
    ...
    /// Each <see cref="JobDefinitionResource" /> in the collection will belong to the same instance of <see cref="QumuloProjectResource" />.
    /// To get a <see cref="JobDefinitionCollection" /> instance call the GetJobDefinitions method from an instance of <see cref="QumuloProjectResource" />.
    /// </summary>
    public partial class JobDefinitionCollection : ArmCollection, IEnumerable<JobDefinitionResource>, IAsyncEnumerable<JobDefinitionResource>
    {
        ...
        {
            if (id.ResourceType != QumuloProjectResource.ResourceType)
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid resource type {0} expected {1}", id.ResourceType, QumuloProjectResource.ResourceType), nameof(id));
        }
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageMover/storageMovers/{storageMoverName}/projects/{projectName}/jobDefinitions
        /// Operation Id: JobDefinitions_List
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual AsyncPageable<JobDefinitionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _jobDefinitionClientDiagnostics.CreateScope("JobDefinitionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _jobDefinitionRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<JobDefinitionResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _jobDefinitionRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new JobDefinitionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<JobDefinitionResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<JobDefinitionResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _jobDefinitionRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new JobDefinitionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<JobDefinitionResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _jobDefinitionRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new JobDefinitionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
