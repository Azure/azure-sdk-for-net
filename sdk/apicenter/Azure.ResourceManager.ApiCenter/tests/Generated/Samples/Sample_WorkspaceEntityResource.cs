...
{
    public partial class Sample_WorkspaceEntityResource
    {
        [Test]
        ...
        public async Task Get_WorkspacesGet()
        {
            ...
            WorkspaceEntityResource result = await workspaceEntity.GetAsync();
        ...
        public async Task Delete_WorkspacesDelete()
        {
            ...
            // invoke the operation
            await workspaceEntity.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Update_WorkspacesCreateOrUpdate()
        {
            ...
            ArmOperation<WorkspaceEntityResource> lro = await workspaceEntity.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task Head_WorkspacesHead()
        {
            ...
            // invoke the operation
            bool result = await workspaceEntity.HeadAsync();
