...
{
    public partial class Sample_ApiCenterApiCollection
    {
        [Test]
        ...
        public async Task Get_ApisGet()
        {
            ...
            // invoke the operation
            string apiName = "echo-api";
            ApiCenterApiResource result = await collection.GetAsync(apiName);
        ...
        public async Task GetAll_ApisListByWorkspace()
        {
            ...
            await foreach (ApiCenterApiResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                ApiCenterApiData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
