...
{
    public partial class Sample_ServiceEntityCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_ServicesCreateOrUpdate()
        {
            ...
            // get the collection of this ServiceEntityResource
            ServiceEntityCollection collection = resourceGroupResource.GetServiceEntities();

            // invoke the operation
            string serviceName = "contoso";
            ServiceEntityData data = new ServiceEntityData(new AzureLocation("East US"))
            {
...
[new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/contoso-resources/providers/Microsoft.ManagedIdentity/userAssignedIdentities/contoso-identity")] = new UserAssignedIdentity()
            ...
            ArmOperation<ServiceEntityResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, serviceName, data);
            ServiceEntityResource result = lro.Value;
        ...
        public async Task Get_ServicesGet()
        {
            ...
            // invoke the operation
            string serviceName = "contoso";
            ServiceEntityResource result = await collection.GetAsync(serviceName);
        ...
        public async Task GetAll_ServicesListByResourceGroup()
        {
            ...
            await foreach (ServiceEntityResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_ServicesGet()
        {
            ...
            // invoke the operation
            string serviceName = "contoso";
            NullableResponse<ServiceEntityResource> response = await collection.GetIfExistsAsync(serviceName);
            ServiceEntityResource result = response.HasValue ? response.Value : null;
