...
{
    public partial class Sample_ApiDeploymentEntityResource
    {
        // Deployments_Get
        ...
        public async Task Get_DeploymentsGet()
        {
            ...
            // this example assumes you already have this ApiDeploymentEntityResource created on azure
            // for more information of creating ApiDeploymentEntityResource, please refer to the document of ApiDeploymentEntityResource
            ...
            ResourceIdentifier apiDeploymentEntityResourceId = ApiDeploymentEntityResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, serviceName, workspaceName, apiName, deploymentName);
            ApiDeploymentEntityResource apiDeploymentEntity = client.GetApiDeploymentEntityResource(apiDeploymentEntityResourceId);

            // invoke the operation
            ApiDeploymentEntityResource result = await apiDeploymentEntity.GetAsync();
        ...
        public async Task Update_DeploymentsCreateOrUpdate()
        {
            ...
            ArmOperation<ApiDeploymentEntityResource> lro = await apiDeploymentEntity.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task Delete_DeploymentsDelete()
        {
            ...
            // invoke the operation
            await apiDeploymentEntity.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Head_DeploymentsHead()
        {
            ...
            // invoke the operation
            bool result = await apiDeploymentEntity.HeadAsync();
