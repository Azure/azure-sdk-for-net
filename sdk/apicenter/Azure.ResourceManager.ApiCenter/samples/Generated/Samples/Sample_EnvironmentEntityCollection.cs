...
{
    public partial class Sample_EnvironmentEntityCollection
    {
        ...
        public async Task GetAll_EnvironmentsListByWorkspace()
        {
            ...
            // get the collection of this EnvironmentEntityResource
            EnvironmentEntityCollection collection = workspaceEntity.GetEnvironmentEntities();

            // invoke the operation and iterate over the result
            await foreach (EnvironmentEntityResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                EnvironmentEntityData resourceData = item.Data;
        ...
        public async Task Get_EnvironmentsGet()
        {
            ...
            EnvironmentEntityResource result = await collection.GetAsync(environmentName);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            EnvironmentEntityData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        public async Task GetIfExists_EnvironmentsGet()
        {
            ...
            // invoke the operation
            string environmentName = "public";
            NullableResponse<EnvironmentEntityResource> response = await collection.GetIfExistsAsync(environmentName);
            EnvironmentEntityResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_EnvironmentsCreateOrUpdate()
        {
            ...
            // invoke the operation
            string environmentName = "public";
            EnvironmentEntityData data = new EnvironmentEntityData();
            ArmOperation<EnvironmentEntityResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, environmentName, data);
            EnvironmentEntityResource result = lro.Value;
