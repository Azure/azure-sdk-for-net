...
{
    public partial class Sample_EnvironmentEntityResource
    {
        // Environments_Get
        ...
        public async Task Get_EnvironmentsGet()
        {
            ...
            // this example assumes you already have this EnvironmentEntityResource created on azure
            // for more information of creating EnvironmentEntityResource, please refer to the document of EnvironmentEntityResource
            string subscriptionId = "00000000-0000-0000-0000-000000000000";
            string resourceGroupName = "contoso-resources";
            string serviceName = "contoso";
            string workspaceName = "default";
            string environmentName = "public";
            ResourceIdentifier environmentEntityResourceId = EnvironmentEntityResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, serviceName, workspaceName, environmentName);
            EnvironmentEntityResource environmentEntity = client.GetEnvironmentEntityResource(environmentEntityResourceId);

            // invoke the operation
            EnvironmentEntityResource result = await environmentEntity.GetAsync();
        ...
        public async Task Update_EnvironmentsCreateOrUpdate()
        {
            ...
            ArmOperation<EnvironmentEntityResource> lro = await environmentEntity.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task Delete_EnvironmentsDelete()
        {
            ...
            // invoke the operation
            await environmentEntity.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Head_EnvironmentsHead()
        {
            ...
            // invoke the operation
            bool result = await environmentEntity.HeadAsync();
