...
{
    public partial class Sample_ServiceEntityResource
    {
        ...
        public async Task Get_ServicesGet()
        {
            ...
            ServiceEntityResource result = await serviceEntity.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            ServiceEntityData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        public async Task Update_ServicesUpdate()
        {
            ...
            // invoke the operation
            ServiceEntityPatch patch = new ServiceEntityPatch();
            ServiceEntityResource result = await serviceEntity.UpdateAsync(patch);
        ...
        public async Task Delete_ServicesDelete()
        {
            ...
            // invoke the operation
            await serviceEntity.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task ExportMetadataSchema_ServicesExportMetadataSchema()
        {
            ...
            ArmOperation<MetadataSchemaExportResult> lro = await serviceEntity.ExportMetadataSchemaAsync(WaitUntil.Completed, content);
