    ...
    internal partial class ApiSourcesGetAllCollectionResultOfT : Pageable<ApiSourceData>
    {
        ...
        public override IEnumerable<Page<ApiSourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                ApiSourceListResult result = ApiSourceListResult.FromResponse(response);
                yield return Page<ApiSourceData>.FromValues(result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("ApiSourceCollection.GetAll");
            scope.Start();
            try
            {
