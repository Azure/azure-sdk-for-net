...
{
    internal partial class DeletedServicesGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<ApiCenterDeletedServiceData>
    {
        ...
        public DeletedServicesGetBySubscriptionAsyncCollectionResultOfT(DeletedServices client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
