...
{
    internal partial class ApiCenterDeletedServiceGetBySubscriptionCollectionResultOfT : Pageable<DeletedServiceData>
    {
        private readonly ApiCenterDeletedService _client;
        private readonly Guid _subscriptionId;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of ApiCenterDeletedServiceGetBySubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ApiCenterDeletedServiceGetBySubscriptionCollectionResultOfT(ApiCenterDeletedService client, Guid subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ApiCenterDeletedServiceGetBySubscriptionCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ApiCenterDeletedServiceGetBySubscriptionCollectionResultOfT as an enumerable collection. </returns>
