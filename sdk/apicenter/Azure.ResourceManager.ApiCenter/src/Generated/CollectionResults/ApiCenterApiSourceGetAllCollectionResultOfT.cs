...
namespace Azure.ResourceManager.ApiCenter
{
    internal partial class ApiCenterApiSourceGetAllCollectionResultOfT : Pageable<ApiSourceData>
    {
        ...
        public ApiCenterApiSourceGetAllCollectionResultOfT(ApiCenterApiSource client, Guid subscriptionId, string resourceGroupName, string serviceName, string workspaceName, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
