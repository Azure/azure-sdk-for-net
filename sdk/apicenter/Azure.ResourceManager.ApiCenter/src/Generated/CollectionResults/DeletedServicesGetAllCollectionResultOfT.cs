...
namespace Azure.ResourceManager.ApiCenter
{
    internal partial class DeletedServicesGetAllCollectionResultOfT : Pageable<ApiCenterDeletedServiceData>
    {
        ...
        public DeletedServicesGetAllCollectionResultOfT(DeletedServices client, Guid subscriptionId, string resourceGroupName, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
