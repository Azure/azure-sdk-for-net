...
{
    internal partial class ApiDefinitionsGetAllCollectionResultOfT : Pageable<ApiCenterApiDefinitionData>
    {
        ...
        /// <returns> The pages of ApiDefinitionsGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ApiCenterApiDefinitionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
