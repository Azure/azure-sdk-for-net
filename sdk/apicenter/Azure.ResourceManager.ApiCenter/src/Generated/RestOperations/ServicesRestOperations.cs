...
namespace Azure.ResourceManager.ApiCenter
{
    internal partial class Services
    {
        ...
        internal HttpMessage CreateExportMetadataSchemaRequest(Guid subscriptionId, string resourceGroupName, string serviceName, RequestContent content, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
