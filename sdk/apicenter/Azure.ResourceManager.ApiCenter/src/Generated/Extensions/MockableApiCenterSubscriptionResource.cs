...
namespace Azure.ResourceManager.ApiCenter.Mocking
{
    ...
    public partial class MockableApiCenterSubscriptionResource : ArmResource
    {
        ...
        public virtual AsyncPageable<ApiCenterServiceResource> GetApiCenterServicesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ApiCenterServiceData, ApiCenterServiceResource>(new ServicesGetBySubscriptionAsyncCollectionResultOfT(ServicesRestClient, Guid.Parse(Id.SubscriptionId), context), data => new ApiCenterServiceResource(Client, data));
        }
        ...
        public virtual Pageable<ApiCenterServiceResource> GetApiCenterServices(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ApiCenterServiceData, ApiCenterServiceResource>(new ServicesGetBySubscriptionCollectionResultOfT(ServicesRestClient, Guid.Parse(Id.SubscriptionId), context), data => new ApiCenterServiceResource(Client, data));
        }
        ...
        public virtual AsyncPageable<DeletedServiceResource> GetDeletedServicesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DeletedServiceData, DeletedServiceResource>(new DeletedServicesGetBySubscriptionAsyncCollectionResultOfT(DeletedServicesRestClient, Guid.Parse(Id.SubscriptionId), context), data => new DeletedServiceResource(Client, data));
        }
        ...
        public virtual Pageable<DeletedServiceResource> GetDeletedServices(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<DeletedServiceData, DeletedServiceResource>(new DeletedServicesGetBySubscriptionCollectionResultOfT(DeletedServicesRestClient, Guid.Parse(Id.SubscriptionId), context), data => new DeletedServiceResource(Client, data));
        }
    }
}
