...
namespace Azure.ResourceManager.ApiCenter
{
    ...
    internal partial class SubscriptionResourceExtensionClient : ArmResource
    {
        ...
        public virtual AsyncPageable<ServiceResource> GetServicesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ServiceResource(Client, ServiceData.DeserializeServiceData(e)), ServiceClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetServices", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ServiceResource> GetServices(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ServiceRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ServiceRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ServiceResource(Client, ServiceData.DeserializeServiceData(e)), ServiceClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetServices", "value", "nextLink", cancellationToken);
        }
    }
}
