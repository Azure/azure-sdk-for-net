...
namespace Azure.ResourceManager.ApiCenter
{
    ...
    public partial class ApiCenterServiceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ApiCenterServiceResource>> UpdateAsync(WaitUntil waitUntil, ApiCenterServiceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _servicesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ApiCenterServiceData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiCenterServiceData> response = Response.FromValue(ApiCenterServiceData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ApiCenterServiceResource> Update(WaitUntil waitUntil, ApiCenterServiceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
