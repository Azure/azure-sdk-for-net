...
namespace Azure.ResourceManager.ApiCenter.Models
{
    ...
    internal partial class ApiListResult
    {
        ...
        {
            Value = new ChangeTrackingList<ApiCenterApiData>();
        }
        ...
        internal ApiListResult(IReadOnlyList<ApiCenterApiData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
