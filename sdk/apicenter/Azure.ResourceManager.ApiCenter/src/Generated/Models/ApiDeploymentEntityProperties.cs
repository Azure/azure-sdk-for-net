...
namespace Azure.ResourceManager.ApiCenter.Models
{
    ...
    public partial class ApiDeploymentEntityProperties
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ApiDeploymentEntityProperties"/>. </summary>
        ...
        internal ApiDeploymentEntityProperties(string title, string description, string environmentId, string definitionId, DeploymentState? state, DeploymentServer server, BinaryData customProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
