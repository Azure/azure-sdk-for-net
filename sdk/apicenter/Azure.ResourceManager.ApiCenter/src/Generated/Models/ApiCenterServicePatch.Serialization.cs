...
namespace Azure.ResourceManager.ApiCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiCenterServicePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiCenterServicePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiCenterServicePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiCenterServicePatch>)} interface");
            }
        ...
        string IPersistableModel<ApiCenterServicePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
