...
namespace Azure.ResourceManager.ApiCenter.Models
{
    ...
    public partial class ApiEntityProperties
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ApiEntityProperties"/>. </summary>
        ...
        public ApiEntityProperties(string title, ApiKind kind)
        {
        ...
        internal ApiEntityProperties(string title, ApiKind kind, string description, string summary, LifecycleStage? lifecycleStage, TermsOfService termsOfService, IList<ExternalDocumentation> externalDocumentation, IList<ApiContact> contacts, ApiLicense license, BinaryData customProperties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
            Kind = kind;
        ...
        /// <summary> Initializes a new instance of <see cref="ApiEntityProperties"/> for deserialization. </summary>
        internal ApiEntityProperties()
        {
        }
        ...
        public IList<ApiContact> Contacts { get; }
