...
namespace Azure.ResourceManager.ApiCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkspaceProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static WorkspaceProperties DeserializeWorkspaceProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new WorkspaceProperties(title, description, serializedAdditionalRawData);
        }
