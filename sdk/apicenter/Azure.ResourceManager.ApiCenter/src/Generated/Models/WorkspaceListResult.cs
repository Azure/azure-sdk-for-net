...
namespace Azure.ResourceManager.ApiCenter.Models
{
    ...
    internal partial class WorkspaceListResult
    {
        ...
        {
            Value = new ChangeTrackingList<ApiCenterWorkspaceData>();
        }
        ...
        internal WorkspaceListResult(IReadOnlyList<ApiCenterWorkspaceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
