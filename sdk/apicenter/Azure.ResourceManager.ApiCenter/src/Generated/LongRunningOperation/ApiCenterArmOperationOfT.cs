...
namespace Azure.ResourceManager.ApiCenter
{
    internal partial class ApiCenterArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ApiCenterArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
