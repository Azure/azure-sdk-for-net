...
namespace Azure.ResourceManager.ApiCenter
{
    internal partial class ApiCenterArmOperation : ArmOperation
    {
        ...
        internal ApiCenterArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
