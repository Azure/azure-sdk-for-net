...
{
    /*
     * Backward-compatibility shim for the ApiCenterMetadataSchemaResource.
     *
     ...
     * parent resource (HeadMetadataSchema(string) on ApiCenterServiceResource) and returns
     ...
     */
    public partial class ApiCenterMetadataSchemaResource
    {
        /// <summary>
        ...
        {
            using DiagnosticScope scope = _metadataSchemasClientDiagnostics.CreateScope("ApiCenterMetadataSchemaResource.Head");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _metadataSchemasRestClient.CreateHeadMetadataSchemaRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
