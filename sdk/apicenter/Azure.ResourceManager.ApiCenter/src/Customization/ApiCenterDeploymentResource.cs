...
{
    /*
     * Backward-compatibility shim for the ApiCenterDeploymentResource.
     *
     ...
     * parent resource (HeadDeployment(string) on ApiCenterApiResource) and returns Response
    ...
    public partial class ApiCenterDeploymentResource
    {
        ...
        {
            using DiagnosticScope scope = _deploymentsClientDiagnostics.CreateScope("ApiCenterDeploymentResource.Head");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _deploymentsRestClient.CreateHeadDeploymentRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
