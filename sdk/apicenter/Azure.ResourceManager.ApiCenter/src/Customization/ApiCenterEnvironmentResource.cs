...
namespace Azure.ResourceManager.ApiCenter
{
    ...
    public partial class ApiCenterEnvironmentResource
    {
        ...
        {
            using DiagnosticScope scope = _environmentsClientDiagnostics.CreateScope("ApiCenterEnvironmentResource.Head");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _environmentsRestClient.CreateHeadEnvironmentRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
