...
namespace Microsoft.Azure.Management.ManagedServiceIdentity
{
    ...
    public static partial class UserAssignedIdentitiesOperationsExtensions
    {
            ...
            /// </param>
            public static Identity Update(this IUserAssignedIdentitiesOperations operations, string resourceGroupName, string resourceName, IdentityPatch parameters)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Identity> UpdateAsync(this IUserAssignedIdentitiesOperations operations, string resourceGroupName, string resourceName, IdentityPatch parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
