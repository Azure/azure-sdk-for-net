# ARM provider schema comparison: Azure.ResourceManager.ManagedServiceIdentities
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{resourceName}` | `UserAssignedIdentity` | `Identity` |
