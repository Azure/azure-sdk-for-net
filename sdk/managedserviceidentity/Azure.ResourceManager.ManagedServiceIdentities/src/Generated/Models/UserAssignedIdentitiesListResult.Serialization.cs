...
namespace Azure.ResourceManager.ManagedServiceIdentities.Models
{
    ...
    {
        internal static UserAssignedIdentitiesListResult DeserializeUserAssignedIdentitiesListResult(JsonElement element)
        {
            ...
            return new UserAssignedIdentitiesListResult(Optional.ToList(value), nextLink.Value);
        }
    }
}
