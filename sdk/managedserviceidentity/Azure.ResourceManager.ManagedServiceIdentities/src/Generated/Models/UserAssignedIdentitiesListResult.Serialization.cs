...
namespace Azure.ResourceManager.ManagedServiceIdentities.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserAssignedIdentitiesListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UserAssignedIdentitiesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UserAssignedIdentitiesListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UserAssignedIdentitiesListResult>)} interface");
            }
        ...
        string IPersistableModel<UserAssignedIdentitiesListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
