...
namespace Azure.ResourceManager.ManagedServiceIdentities.Models
{
    internal partial class FederatedIdentityCredentialsListResult : IUtf8JsonSerializable, IJsonModel<FederatedIdentityCredentialsListResult>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<FederatedIdentityCredentialsListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<FederatedIdentityCredentialData>)item).Write(writer, options);
                }
