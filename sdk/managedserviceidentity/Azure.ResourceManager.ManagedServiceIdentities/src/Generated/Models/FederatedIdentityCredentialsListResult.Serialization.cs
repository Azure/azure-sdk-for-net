...
namespace Azure.ResourceManager.ManagedServiceIdentities.Models
{
    internal partial class FederatedIdentityCredentialsListResult : IUtf8JsonSerializable, IJsonModel<FederatedIdentityCredentialsListResult>
    {
        ...
        void IJsonModel<FederatedIdentityCredentialsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FederatedIdentityCredentialsListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FederatedIdentityCredentialsListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FederatedIdentityCredentialsListResult)} does not support '{options.Format}' format.");
            }
        }
