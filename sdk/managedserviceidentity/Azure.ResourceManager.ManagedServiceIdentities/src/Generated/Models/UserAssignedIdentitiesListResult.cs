...
namespace Azure.ResourceManager.ManagedServiceIdentities.Models
{
    ...
    internal partial class UserAssignedIdentitiesListResult
    {
        ...
        internal UserAssignedIdentitiesListResult(IReadOnlyList<UserAssignedIdentityData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
