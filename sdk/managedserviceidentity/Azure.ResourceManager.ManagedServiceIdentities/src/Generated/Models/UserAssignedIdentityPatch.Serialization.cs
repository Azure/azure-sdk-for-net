...
namespace Azure.ResourceManager.ManagedServiceIdentities.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserAssignedIdentityPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UserAssignedIdentityPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UserAssignedIdentityPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UserAssignedIdentityPatch>)} interface");
            }
        ...
        string IPersistableModel<UserAssignedIdentityPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
