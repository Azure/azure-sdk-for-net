...
namespace Azure.ResourceManager.ManagedServiceIdentities
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserAssignedIdentityData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UserAssignedIdentityData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UserAssignedIdentityData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UserAssignedIdentityData>)} interface");
            }
        ...
        string IPersistableModel<UserAssignedIdentityData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
