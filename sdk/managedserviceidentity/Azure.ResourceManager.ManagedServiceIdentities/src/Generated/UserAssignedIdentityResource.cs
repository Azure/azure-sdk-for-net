...
{
    /// <summary>
    /// A class representing a UserAssignedIdentity along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="UserAssignedIdentityResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetUserAssignedIdentities method.
    /// </summary>
    public partial class UserAssignedIdentityResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of UserAssignedIdentityResource for mocking. </summary>
        protected UserAssignedIdentityResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="UserAssignedIdentityResource"/> class. </summary>
        ...
        internal UserAssignedIdentityResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _userAssignedIdentitiesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ManagedServiceIdentities", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{resourceName}";
        ...
        {
            using DiagnosticScope scope = _userAssignedIdentitiesClientDiagnostics.CreateScope("UserAssignedIdentityResource.Get");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Identities_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-05-31-preview. </description>
        ...
        public virtual async Task<Response<UserAssignedIdentityResource>> UpdateAsync(UserAssignedIdentityPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _userAssignedIdentitiesClientDiagnostics.CreateScope("UserAssignedIdentityResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _userAssignedIdentitiesRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, UserAssignedIdentityPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<UserAssignedIdentityData> response = Response.FromValue(UserAssignedIdentityData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Identities_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-05-31-preview. </description>
        ...
        {
            using DiagnosticScope scope = _userAssignedIdentitiesClientDiagnostics.CreateScope("UserAssignedIdentityResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _userAssignedIdentitiesRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        ...
        /// <summary>
        /// Updates the UserAssignedIdentity.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ManagedIdentity/userAssignedIdentities/{resourceName}. </description>
        ...
        public virtual async Task<ArmOperation<UserAssignedIdentityResource>> UpdateAsync(WaitUntil waitUntil, UserAssignedIdentityData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _userAssignedIdentitiesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, UserAssignedIdentityData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<UserAssignedIdentityData> response = Response.FromValue(UserAssignedIdentityData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<UserAssignedIdentityResource> Update(WaitUntil waitUntil, UserAssignedIdentityData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <summary> Gets a collection of FederatedIdentityCredentials in the <see cref="UserAssignedIdentityResource"/>. </summary>
        /// <returns> An object representing collection of FederatedIdentityCredentials and their operations over a FederatedIdentityCredentialResource. </returns>
