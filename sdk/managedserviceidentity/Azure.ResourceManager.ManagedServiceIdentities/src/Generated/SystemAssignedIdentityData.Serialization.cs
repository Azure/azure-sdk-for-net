...
namespace Azure.ResourceManager.ManagedServiceIdentities
{
    ...
    public partial class SystemAssignedIdentityData : TrackedResourceData, IJsonModel<SystemAssignedIdentityData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SystemAssignedIdentityData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SystemAssignedIdentityData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SystemAssignedIdentityData IPersistableModel<SystemAssignedIdentityData>.Create(BinaryData data, ModelReaderWriterOptions options) => (SystemAssignedIdentityData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<SystemAssignedIdentityData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="SystemAssignedIdentityData"/> from. </param>
        internal static SystemAssignedIdentityData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeSystemAssignedIdentityData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SystemAssignedIdentityData IJsonModel<SystemAssignedIdentityData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SystemAssignedIdentityData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SystemAssignedIdentityData DeserializeSystemAssignedIdentityData(JsonElement element, ModelReaderWriterOptions options)
        {
