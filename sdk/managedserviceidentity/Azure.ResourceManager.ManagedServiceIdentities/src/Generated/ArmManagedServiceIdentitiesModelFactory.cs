...
namespace Azure.ResourceManager.ManagedServiceIdentities.Models
{
    ...
    public static partial class ArmManagedServiceIdentitiesModelFactory
    {
        ...
        /// <returns> A new <see cref="Models.IdentityAssociatedResourceData"/> instance for mocking. </returns>
        public static IdentityAssociatedResourceData IdentityAssociatedResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string resourceGroup = null, string subscriptionId = null, string subscriptionDisplayName = null)
        {
            return new IdentityAssociatedResourceData(id, name, resourceType, systemData, resourceGroup, subscriptionId, subscriptionDisplayName);
        }
