...
namespace Azure.ResourceManager.ManagedServiceIdentities
{
    ...
    public static partial class ManagedServiceIdentitiesExtensions
    {
        ...
        private static ManagedServiceIdentitiesArmResourceMockingExtension GetManagedServiceIdentitiesArmResourceMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ManagedServiceIdentitiesArmResourceMockingExtension(client, resource.Id);
            });
        }
        ...
        {
            return GetManagedServiceIdentitiesArmResourceMockingExtension(armResource).GetSystemAssignedIdentity();
        }
