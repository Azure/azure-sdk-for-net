...
namespace Azure.ResourceManager.ManagedServiceIdentities
{
    ...
    public static partial class ManagedServiceIdentitiesExtensions
    {
        ...
        {
            return GetArmResourceExtension(armResource).GetSystemAssignedIdentity();
        }
        ...
        {
            return GetArmResourceExtension(client, scope).GetSystemAssignedIdentity();
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetUserAssignedIdentities();
        }
