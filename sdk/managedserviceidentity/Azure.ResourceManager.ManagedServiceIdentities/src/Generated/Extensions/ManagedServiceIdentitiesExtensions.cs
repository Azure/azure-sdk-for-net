...
using Azure.ResourceManager.ManagedServiceIdentities.Testing;
...
namespace Azure.ResourceManager.ManagedServiceIdentities
{
    ...
    public static partial class ManagedServiceIdentitiesExtensions
    {
        ...
        private static ManagedServiceIdentitiesSubscriptionResourceExtension GetManagedServiceIdentitiesSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ManagedServiceIdentitiesSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static ManagedServiceIdentitiesSubscriptionResourceExtension GetManagedServiceIdentitiesSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ManagedServiceIdentitiesSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetManagedServiceIdentitiesSubscriptionResourceExtension(subscriptionResource).GetUserAssignedIdentitiesAsync(cancellationToken);
        }
        ...
        {
            return GetManagedServiceIdentitiesSubscriptionResourceExtension(subscriptionResource).GetUserAssignedIdentities(cancellationToken);
        }
    }
}
