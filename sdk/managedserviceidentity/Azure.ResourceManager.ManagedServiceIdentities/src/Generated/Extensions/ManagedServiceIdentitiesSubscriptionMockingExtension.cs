...
namespace Azure.ResourceManager.ManagedServiceIdentities.Mocking
{
    ...
    internal partial class ManagedServiceIdentitiesSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ManagedServiceIdentitiesSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ManagedServiceIdentitiesSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedServiceIdentitiesSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagedServiceIdentitiesSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
