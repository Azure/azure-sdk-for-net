...
namespace Azure.ResourceManager.ManagedServiceIdentities.Mocking
{
    ...
    internal partial class ManagedServiceIdentitiesResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ManagedServiceIdentitiesResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ManagedServiceIdentitiesResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedServiceIdentitiesResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagedServiceIdentitiesResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
