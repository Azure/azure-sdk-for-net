...
namespace Azure.ResourceManager.ManagedServiceIdentities.Mock
{
    ...
    public partial class ManagedServiceIdentitiesArmResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ManagedServiceIdentitiesArmResourceExtension"/> class for mocking. </summary>
        protected ManagedServiceIdentitiesArmResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedServiceIdentitiesArmResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagedServiceIdentitiesArmResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
