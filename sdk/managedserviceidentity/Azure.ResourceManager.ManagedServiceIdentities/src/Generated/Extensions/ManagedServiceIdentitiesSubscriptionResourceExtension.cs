...
namespace Azure.ResourceManager.ManagedServiceIdentities.Testing
{
    ...
    public partial class ManagedServiceIdentitiesSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ManagedServiceIdentitiesSubscriptionResourceExtension"/> class for mocking. </summary>
        protected ManagedServiceIdentitiesSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedServiceIdentitiesSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagedServiceIdentitiesSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<UserAssignedIdentityResource> GetUserAssignedIdentitiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new UserAssignedIdentityResource(Client, UserAssignedIdentityData.DeserializeUserAssignedIdentityData(e)), UserAssignedIdentityClientDiagnostics, Pipeline, "ManagedServiceIdentitiesSubscriptionResourceExtension.GetUserAssignedIdentities", "value", "nextLink", cancellationToken);
        }
