...
namespace Azure.ResourceManager.ManagedServiceIdentities.Mock
{
    ...
    public partial class UserAssignedIdentityResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="UserAssignedIdentityResourceExtension"/> class for mocking. </summary>
        protected UserAssignedIdentityResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="UserAssignedIdentityResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal UserAssignedIdentityResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<UserAssignedIdentityResource> GetUserAssignedIdentitiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new UserAssignedIdentityResource(Client, UserAssignedIdentityData.DeserializeUserAssignedIdentityData(e)), UserAssignedIdentityClientDiagnostics, Pipeline, "UserAssignedIdentityResourceExtension.GetUserAssignedIdentities", "value", "nextLink", cancellationToken);
        }
