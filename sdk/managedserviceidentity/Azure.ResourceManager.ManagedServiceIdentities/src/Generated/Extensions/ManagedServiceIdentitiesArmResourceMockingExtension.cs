...
namespace Azure.ResourceManager.ManagedServiceIdentities.Mocking
{
    ...
    internal partial class ManagedServiceIdentitiesArmResourceMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ManagedServiceIdentitiesArmResourceMockingExtension"/> class for mocking. </summary>
        protected ManagedServiceIdentitiesArmResourceMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedServiceIdentitiesArmResourceMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagedServiceIdentitiesArmResourceMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
