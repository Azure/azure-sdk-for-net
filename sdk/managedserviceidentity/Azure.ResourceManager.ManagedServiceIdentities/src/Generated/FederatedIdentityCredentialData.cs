...
namespace Azure.ResourceManager.ManagedServiceIdentities
{
    ...
    public partial class FederatedIdentityCredentialData : ResourceData
    {
        ...
        internal FederatedIdentityCredentialData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, FederatedIdentityCredentialProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
