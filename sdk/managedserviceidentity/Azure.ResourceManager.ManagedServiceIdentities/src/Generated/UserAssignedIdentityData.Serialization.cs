...
{
    public partial class UserAssignedIdentityData : IUtf8JsonSerializable, IJsonModel<UserAssignedIdentityData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserAssignedIdentityData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static UserAssignedIdentityData DeserializeUserAssignedIdentityData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.ManagedServiceIdentities.ModelSerializationExtensions.WireOptions, AzureResourceManagerManagedServiceIdentitiesContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerManagedServiceIdentitiesContext.Default)
#endif
;
                    continue;
                }
