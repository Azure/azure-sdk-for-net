...
namespace Microsoft.Azure.Management.ServiceBus
{
    ...
    /// </summary>
    internal partial class PrivateLinkResourcesOperations : IServiceOperations<ServiceBusManagementClient>, IPrivateLinkResourcesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal PrivateLinkResourcesOperations(ServiceBusManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<PrivateLinkResourcesListResult>> GetWithHttpMessagesAsync(string resourceGroupName, string namespaceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/privateLinkResources").ToString();
