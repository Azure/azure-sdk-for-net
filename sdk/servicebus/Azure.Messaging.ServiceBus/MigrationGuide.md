...
In the case of Service Bus, the modern client library has the package and namespace that begin with `Azure.Messaging.ServiceBus` and were released beginning with version 7. The legacy client library has the package and namespace that begin with `Microsoft.Azure.ServiceBus`.
