...
namespace Azure.Messaging.ServiceBus
{
    ...
    public class ServiceBusMessage
    {
        ...
        {
            AmqpMessageBody amqpBody = new AmqpMessageBody(BodyMemory.From(new ReadOnlyMemory<byte>[] { body }));
        ...
        public ServiceBusMessage(ServiceBusReceivedMessage receivedMessage)
        {
            ...
            AmqpMessageBody body = new AmqpMessageBody(BodyMemory.From(dataBody));
        ...
        public BinaryData Body
        {
            ...
            set
            {
                AmqpMessage.Body = new AmqpMessageBody(BodyMemory.From(new ReadOnlyMemory<byte>[] { value }));
            }
        }
