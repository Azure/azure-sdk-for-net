...
namespace Azure.Messaging.ServiceBus
{
    ...
    public class ServiceBusMessage
    {
        ...
        {
            AmqpMessageBody amqpBody = new AmqpMessageBody(new BodyMemory(new ReadOnlyMemory<byte>[] { body }));
        ...
        public ServiceBusMessage(ServiceBusReceivedMessage receivedMessage)
        {
            ...
            AmqpMessageBody body = new AmqpMessageBody(new BodyMemory(dataBody));
