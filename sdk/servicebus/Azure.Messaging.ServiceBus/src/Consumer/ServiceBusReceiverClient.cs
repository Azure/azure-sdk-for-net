...
namespace Azure.Messaging.ServiceBus.Consumer
{
    ...
    public class ServiceBusReceiverClient : IAsyncDisposable
    {
        ...
        /// </summary>
        ///
        public string EventHubName => Connection.EntityName;
        ...
        public ServiceBusReceiverClient(string connectionString)
            : this(connectionString, default(ServiceBusReceiverClientOptions))
        {
        }
        ...
        /// </remarks>
        ///
        public ServiceBusReceiverClient(string connectionString, string entityName)
        ...
        /// </remarks>
        ///
        /// <seealso cref="ReadMessagesFromPartitionAsync(string, EventPosition, ReadEventOptions, CancellationToken)"/>
        ///
        public virtual IAsyncEnumerable<PartitionMessage> ReadMessagesFromPartitionAsync(string partitionId,
                                                                                     EventPosition startingPosition,
                                                                                     CancellationToken cancellationToken = default) => ReadMessagesFromPartitionAsync(partitionId, startingPosition, null, cancellationToken);
        ...
        /// </remarks>
        ///
        /// <seealso cref="ReadMessagesFromPartitionAsync(string, EventPosition, CancellationToken)"/>
        ///
        public virtual async IAsyncEnumerable<PartitionMessage> ReadMessagesFromPartitionAsync(string partitionId,
                                                                                           EventPosition startingPosition,
                                                                                           ...
                                                                                           [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                eventChannel = CreateMessageChannel((BackgroundPublishReceiveBatchSize * 4));
        ...
        ///
        public virtual IAsyncEnumerable<PartitionMessage> ReadEventsAsync(CancellationToken cancellationToken = default) => ReadEventsAsync(null, cancellationToken);
        ...
        ///
        public virtual IAsyncEnumerable<PartitionMessage> ReadEventsAsync(ReadEventOptions readOptions,
                                                                        CancellationToken cancellationToken = default) => ReceiveMessagesAsync(true, readOptions, cancellationToken);
        ...
        /// <seealso cref="ReadEventsAsync(ReadEventOptions, CancellationToken)"/>
        ///
        public virtual async IAsyncEnumerable<PartitionMessage> ReceiveMessagesAsync(bool startReadingAtEarliestEvent,
                                                                              ...
                                                                              [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                eventChannel = CreateMessageChannel((BackgroundPublishReceiveBatchSize * partitions.Length * 2));
        ...
        private async Task<Func<Task>> PublishPartitionEventsToChannelAsync(string partitionId,
                                                                            ...
                                                                            long? ownerLevel,
                                                                            Channel<PartitionMessage> channel,
                                                                            CancellationTokenSource publishingCancellationSource)
        {
            ...
            try
            {
                ...
                if (!ActiveConsumers.TryAdd(publisherId, transportConsumer))
                {
                    ...
                    throw new ServiceBusException(false, EventHubName, string.Format(CultureInfo.CurrentCulture, Resources1.FailedToCreateReader, EventHubName, partitionId, ConsumerGroup));
                }
        ...
        private Task StartBackgroundChannelPublishingAsync(TransportConsumer transportConsumer,
            ...
            Task.Run(async () =>
            {
                ...
                var receivedItems = default(IEnumerable<ServiceBusMessage>);
                ...
                while (!cancellationToken.IsCancellationRequested)
                {
                    try
                    {
                        ...
                        foreach (ServiceBusMessage item in receivedItems)
                        {
                            await channel.Writer.WriteAsync(new PartitionMessage(partitionContext, item), cancellationToken).ConfigureAwait(false);
                        }
                    ...
                    catch (OperationCanceledException ex)
                    {
                        ...
                        (ex.Reason == ServiceBusException.FailureReason.ConsumerDisconnected
                        || ex.Reason == ServiceBusException.FailureReason.ClientClosed)
                    {
        ...
        ///
        private Channel<PartitionMessage> CreateMessageChannel(int capacity) =>
            Channel.CreateBounded<PartitionMessage>(new BoundedChannelOptions(capacity)
            {
