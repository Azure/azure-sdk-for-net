...
namespace Azure.Messaging.ServiceBus.Consumer
{
    ...
    public class PartitionContext
    {
        ...
        ///// </remarks>
        /////
        ///// <exception cref="ServiceBusException">Occurs when the Event Hubs client needed to read this information is no longer available.</exception>
        ...
        //        Argument.AssertNotClosed(true, Resources1.ClientNeededForThisInformation);
        //    }
