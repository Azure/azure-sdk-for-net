...
namespace Azure.Messaging.ServiceBus
{
    ...
    public sealed class ServiceBusSharedAccessKeyCredential
    {
        ...
        /// <summary>
        ///   Initializes a new instance of the <see cref="ServiceBusSharedAccessKeyCredential"/> class.
        /// </summary>
        ///
        ...
        ///
        public ServiceBusSharedAccessKeyCredential(
        ...
        /// <param name="sharedAccessSignature"> The shared access signature that forms the basis of this security token.</param>
        ///
        public void UpdateSharedAccessSignature(
            ...
            TimeSpan? signatureValidityDuration = default)
        {
            SharedAccessSignatureCredential = string.IsNullOrEmpty(SharedAccessSignature)
                ? new SharedAccessSignatureCredential(new SharedAccessSignature(serviceBusResource, SharedAccessKeyName, SharedAccessKey, signatureValidityDuration))
