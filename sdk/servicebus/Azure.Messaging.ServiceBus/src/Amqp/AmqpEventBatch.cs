...
namespace Azure.Messaging.ServiceBus.Amqp
{
    ...
    internal class AmqpEventBatch : TransportEventBatch
    {
        ...
        /// </summary>
        ///
        private List<ServiceBusMessage> BatchEvents { get; } = new List<ServiceBusMessage>();
        ...
        ///
        public AmqpEventBatch(AmqpMessageConverterNew messageConverter,
        ...
        public override bool TryAdd(ServiceBusMessage message)
        {
            ...
            AmqpMessage eventMessage = MessageConverter.CreateMessageFromEvent(message, Options.PartitionKey);
