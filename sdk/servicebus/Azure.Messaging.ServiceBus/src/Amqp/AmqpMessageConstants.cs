...
namespace Azure.Messaging.ServiceBus.Amqp
{
    ...
    internal class AmqpMessageConstants
    {
        ...
        /// <summary>
        ///  Property key representing dead-letter reason, when a message is received from a dead-letter sub-queue of an entity.
        ...
        /// <summary>
        ///  Property key representing detailed error description, when a message is received from a dead-letter sub-queue of an entity.
        ///  This key and the associated values are stored in the <see cref="ServiceBusReceivedMessage.ApplicationProperties"/> dictionary
        ///  for dead lettered messages.
        /// </summary>
