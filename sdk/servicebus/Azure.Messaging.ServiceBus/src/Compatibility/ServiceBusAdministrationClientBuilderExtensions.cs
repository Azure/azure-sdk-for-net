...
{
    /// <summary>
    ///    The set of extensions to add the Service Bus administration client types to the clients builder
    /// </summary>
    public static class ServiceBusAdministrationClientBuilderExtensions
    {
        /// <summary>
