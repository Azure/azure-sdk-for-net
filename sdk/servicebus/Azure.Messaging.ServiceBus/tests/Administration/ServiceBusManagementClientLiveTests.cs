...
namespace Azure.Messaging.ServiceBus.Tests.Management
{
    ...
    public class ServiceBusManagementClientLiveTests : RecordedTestBase<ServiceBusTestEnvironment>
    {
        ...
        public async Task BasicQueueCrudOperations(bool premium)
        {
            ...
            Assert.That(queueList.Count == 1, Is.True, $"Expected 1 queue but {queueList.Count} queues returned");
        ...
        public async Task BasicTopicCrudOperations(bool premium, bool supportOrdering)
        {
            ...
            Assert.That(topicList.Count == 1, Is.True, $"Expected 1 topic but {topicList.Count} topics returned");
        ...
        public async Task BasicSubscriptionCrudOperations()
        {
            ...
            Assert.That(subscriptionList.Count == 1, Is.True, $"Expected 1 subscription but {subscriptionList.Count} subscriptions returned");
        ...
        public async Task BasicRuleCrudOperations()
        {
            ...
            Assert.That(ruleArr.Length == 3, Is.True);
        ...
        public async Task GetQueueRuntimeInfo()
        {
            ...
            Assert.That(runtimeInfo.UpdatedAt < runtimeInfo.AccessedAt, Is.True);
        ...
        public async Task GetSubscriptionRuntimeInfoTest()
        {
            ...
            Assert.That(topicRuntimeProperties.UpdatedAt < topicRuntimeProperties.AccessedAt, Is.True);
        ...
        public async Task CorrelationFilterProperties()
        {
            ...
            Assert.That(filter.ApplicationProperties.Count == 3, Is.True);
