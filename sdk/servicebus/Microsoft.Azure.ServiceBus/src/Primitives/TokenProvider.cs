...
namespace Microsoft.Azure.ServiceBus.Primitives
{
    ...
    public abstract class TokenCredential : TokenCredential
    {
        ...
        /// <remarks><see cref="TokenCredential.GetTokenAsync(string, TimeSpan)"/> parameters will not be used 
        ...
        /// <returns>A TokenCredential initialized with the provided keyName and key.</returns>
        ...
        /// <returns>The <see cref="Microsoft.ServiceBus.TokenCredential" /> for returning Json web token.</returns>
