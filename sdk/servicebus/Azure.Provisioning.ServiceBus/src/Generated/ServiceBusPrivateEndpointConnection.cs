...
namespace Azure.Provisioning.ServiceBus
{
    ...
    public partial class ServiceBusPrivateEndpointConnection : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ServiceBusPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ServiceBusPrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ServiceBus/namespaces/privateEndpointConnections", resourceVersion ?? "2026-01-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ServiceBusPrivateEndpointConnection. </summary>
        ...
        /// <summary> Creates a reference to an existing ServiceBusPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ServiceBusPrivateEndpointConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ServiceBusPrivateEndpointConnection result = new ServiceBusPrivateEndpointConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ServiceBusPrivateEndpointConnection that are not part of the generated code. </summary>
