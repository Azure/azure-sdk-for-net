...
namespace Azure.Provisioning.ServiceBus
{
    ...
    public partial class ServiceBusRule : ProvisionableResource
    {
        ...
        private Ruleproperties _properties;
        private BicepValue<AzureLocation> _location;
        private ResourceReference<ServiceBusSubscription> _parent;

        /// <summary> Creates a new ServiceBusRule. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ServiceBusRule(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ServiceBus/namespaces/topics/subscriptions/rules", resourceVersion ?? "2026-01-01")
        {
        }
        ...
        internal Ruleproperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for ServiceBusRule. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<Ruleproperties>(nameof(Properties), new string[] { "properties" });
            _location = DefineProperty<AzureLocation>(nameof(Location), new string[] { "location" }, isOutput: true);
            _parent = DefineResource<ServiceBusSubscription>(nameof(Parent), new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing ServiceBusRule. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ServiceBusRule FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ServiceBusRule result = new ServiceBusRule(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ServiceBusRule that are not part of the generated code. </summary>
