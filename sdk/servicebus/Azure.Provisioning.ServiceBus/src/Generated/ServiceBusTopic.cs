...
namespace Azure.Provisioning.ServiceBus
{
    ...
    public partial class ServiceBusTopic : ProvisionableResource
    {
        ...
        private SBTopicProperties _properties;
        private BicepValue<AzureLocation> _location;
        private ResourceReference<ServiceBusNamespace> _parent;

        /// <summary> Creates a new ServiceBusTopic. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ServiceBusTopic(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ServiceBus/namespaces/topics", resourceVersion ?? "2026-01-01")
        {
        }
        ...
        internal SBTopicProperties Properties
        {
            get
            {
                Initialize();
        ...
        public BicepValue<int> SubscriptionCount
        {
            get
            {
                ...
                return Properties.SubscriptionCount;
            }
        }
        ...
        /// <summary> Define all the provisionable properties for ServiceBusTopic. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<SBTopicProperties>(nameof(Properties), new string[] { "properties" });
        ...
        /// <summary> Creates a reference to an existing ServiceBusTopic. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ServiceBusTopic FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ServiceBusTopic result = new ServiceBusTopic(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ServiceBusTopic that are not part of the generated code. </summary>
