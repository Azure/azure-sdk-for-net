...
{
    /// <summary> A class to add extension methods to ServiceBusNamespaceResource. </summary>
    public partial class ServiceBusNamespaceResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ServiceBusNamespaceResourceExtensionClient"/> class for mocking. </summary>
        protected ServiceBusNamespaceResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceBusNamespaceResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceBusNamespaceResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics ServiceBusNamespaceNamespacesClientDiagnostics => _serviceBusNamespaceNamespacesClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.ServiceBus.Mock", ServiceBusNamespaceResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<ServiceBusNamespaceResource> GetServiceBusNamespacesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ServiceBusNamespaceResource(Client, ServiceBusNamespaceData.DeserializeServiceBusNamespaceData(e)), ServiceBusNamespaceNamespacesClientDiagnostics, Pipeline, "ServiceBusNamespaceResourceExtensionClient.GetServiceBusNamespaces", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ServiceBusNamespaceResource> GetServiceBusNamespaces(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ServiceBusNamespaceNamespacesRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ServiceBusNamespaceNamespacesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ServiceBusNamespaceResource(Client, ServiceBusNamespaceData.DeserializeServiceBusNamespaceData(e)), ServiceBusNamespaceNamespacesClientDiagnostics, Pipeline, "ServiceBusNamespaceResourceExtensionClient.GetServiceBusNamespaces", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<ServiceBusNameAvailabilityResult>> CheckServiceBusNamespaceNameAvailabilityAsync(ServiceBusNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ServiceBusNamespaceNamespacesClientDiagnostics.CreateScope("ServiceBusNamespaceResourceExtensionClient.CheckServiceBusNamespaceNameAvailability");
            scope.Start();
            try
            {
