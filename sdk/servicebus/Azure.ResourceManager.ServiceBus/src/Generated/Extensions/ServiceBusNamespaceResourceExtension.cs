...
namespace Azure.ResourceManager.ServiceBus.Mock
{
    ...
    public partial class ServiceBusNamespaceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ServiceBusNamespaceResourceExtension"/> class for mocking. </summary>
        protected ServiceBusNamespaceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceBusNamespaceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceBusNamespaceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ServiceBusNamespaceResource> GetServiceBusNamespacesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ServiceBusNamespaceResource(Client, ServiceBusNamespaceData.DeserializeServiceBusNamespaceData(e)), ServiceBusNamespaceNamespacesClientDiagnostics, Pipeline, "ServiceBusNamespaceResourceExtension.GetServiceBusNamespaces", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ServiceBusNamespaceResource> GetServiceBusNamespaces(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ServiceBusNamespaceNamespacesRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ServiceBusNamespaceNamespacesRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ServiceBusNamespaceResource(Client, ServiceBusNamespaceData.DeserializeServiceBusNamespaceData(e)), ServiceBusNamespaceNamespacesClientDiagnostics, Pipeline, "ServiceBusNamespaceResourceExtension.GetServiceBusNamespaces", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<ServiceBusNameAvailabilityResult>> CheckServiceBusNamespaceNameAvailabilityAsync(ServiceBusNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ServiceBusNamespaceNamespacesClientDiagnostics.CreateScope("ServiceBusNamespaceResourceExtension.CheckServiceBusNamespaceNameAvailability");
            scope.Start();
            try
            {
