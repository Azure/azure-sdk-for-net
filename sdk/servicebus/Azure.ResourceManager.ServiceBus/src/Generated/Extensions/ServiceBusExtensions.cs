...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public static partial class ServiceBusExtensions
    {
        ...
        {
            return client.GetCachedClient(client0 => new MockableServiceBusArmClient(client0, ResourceIdentifier.Root));
        }

        /// <param name="resourceGroupResource"></param>
        private static MockableServiceBusResourceGroupResource GetMockableServiceBusResourceGroupResource(ResourceGroupResource resourceGroupResource)
        {
            return resourceGroupResource.GetCachedClient(client => new MockableServiceBusResourceGroupResource(client, resourceGroupResource.Id));
        }

        /// <param name="subscriptionResource"></param>
        private static MockableServiceBusSubscriptionResource GetMockableServiceBusSubscriptionResource(SubscriptionResource subscriptionResource)
        {
            return subscriptionResource.GetCachedClient(client => new MockableServiceBusSubscriptionResource(client, subscriptionResource.Id));
        }
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableServiceBusArmClient.GetDisasterRecoveryConfigResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        ...
        public static DisasterRecoveryConfigResource GetDisasterRecoveryConfigResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableServiceBusArmClient(client).GetDisasterRecoveryConfigResource(id);
        }
        ...
        /// <summary>
        /// Gets an object representing a <see cref="SBAuthorizationRuleResource"/> along with the instance operations that can be performed on it but with no data.
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableServiceBusArmClient.GetSBAuthorizationRuleResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static SBAuthorizationRuleResource GetSBAuthorizationRuleResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableServiceBusArmClient(client).GetSBAuthorizationRuleResource(id);
        }

        /// <summary>
        /// Gets an object representing a <see cref="QueueResource"/> along with the instance operations that can be performed on it but with no data.
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableServiceBusArmClient.GetQueueResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static QueueResource GetQueueResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableServiceBusArmClient(client).GetQueueResource(id);
        }
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableServiceBusArmClient.GetTopicResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static TopicResource GetTopicResource(this ArmClient client, ResourceIdentifier id)
        {
            ...
            return GetMockableServiceBusArmClient(client).GetTopicResource(id);
        }
        ...
        /// <summary>
        /// Gets an object representing a <see cref="ServiceBusNetworkSecurityPerimeterConfigurationResource"/> along with the instance operations that can be performed on it but with no data.
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableServiceBusArmClient.GetServiceBusNetworkSecurityPerimeterConfigurationResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static ServiceBusNetworkSecurityPerimeterConfigurationResource GetServiceBusNetworkSecurityPerimeterConfigurationResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableServiceBusArmClient(client).GetServiceBusNetworkSecurityPerimeterConfigurationResource(id);
        }
        ...
        /// <summary>
        /// Gets a collection of ServiceBusNamespaces in the <see cref="ResourceGroupResource"/>
        /// <item>
        /// <term> Mocking. </term>
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableServiceBusSubscriptionResource.GetServiceBusNamespacesAsync(CancellationToken)"/> instead. </description>
        /// </item>
        /// </summary>
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableServiceBusSubscriptionResource.CheckServiceBusNamespaceNameAvailabilityAsync(ServiceBusNameAvailabilityContent, CancellationToken)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="subscriptionResource"> The <see cref="SubscriptionResource"/> the method will execute against. </param>
