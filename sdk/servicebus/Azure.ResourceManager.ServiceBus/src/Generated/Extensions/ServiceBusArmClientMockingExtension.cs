...
namespace Azure.ResourceManager.ServiceBus.Mocking
{
    ...
    internal partial class ServiceBusArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ServiceBusArmClientMockingExtension"/> class for mocking. </summary>
        protected ServiceBusArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceBusArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceBusArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ServiceBusArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
