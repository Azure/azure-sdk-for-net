...
namespace Azure.ResourceManager.ServiceBus.Mocking
{
    ...
    internal partial class ServiceBusResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ServiceBusResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ServiceBusResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceBusResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceBusResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
