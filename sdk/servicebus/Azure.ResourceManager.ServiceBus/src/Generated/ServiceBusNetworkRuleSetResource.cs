...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class ServiceBusNetworkRuleSetResource : ArmResource
    {
        ...
        internal ServiceBusNetworkRuleSetResource(ArmClient client, ServiceBusNetworkRuleSetData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ServiceBusNetworkRuleSetResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ServiceBusNetworkRuleSetResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<ServiceBusNetworkRuleSetResource>> CreateOrUpdateAsync(WaitUntil waitUntil, ServiceBusNetworkRuleSetData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceBusArmOperation<ServiceBusNetworkRuleSetResource>(Response.FromValue(new ServiceBusNetworkRuleSetResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
