...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class ServiceBusQueue : ArmResource
    {
        ...
        internal ServiceBusQueue(ArmClient armClient, ServiceBusQueueData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServiceBusQueue(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string serviceBusQueueQueuesApiVersion);
