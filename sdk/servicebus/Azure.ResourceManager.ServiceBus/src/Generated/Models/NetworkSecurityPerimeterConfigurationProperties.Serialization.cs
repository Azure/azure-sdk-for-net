    ...
    internal partial class NetworkSecurityPerimeterConfigurationProperties : IJsonModel<NetworkSecurityPerimeterConfigurationProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ProvisioningIssues))
            {
                ...
                foreach (ServiceBusNspConfigurationProvisioningIssue item in ProvisioningIssues)
                {
        ...
        internal static NetworkSecurityPerimeterConfigurationProperties DeserializeNetworkSecurityPerimeterConfigurationProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new ServiceBusNetworkSecurityPerimeterConfigurationProvisioningState(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("networkSecurityPerimeter"u8))
                {
                    ...
                    networkSecurityPerimeter = ServiceBusNetworkSecurityPerimeter.DeserializeServiceBusNetworkSecurityPerimeter(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("resourceAssociation"u8))
                {
                    ...
                    resourceAssociation = ServiceBusNetworkSecurityPerimeterConfigurationPropertiesResourceAssociation.DeserializeServiceBusNetworkSecurityPerimeterConfigurationPropertiesResourceAssociation(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("profile"u8))
                {
                    ...
                    profile = ServiceBusNetworkSecurityPerimeterConfigurationPropertiesProfile.DeserializeServiceBusNetworkSecurityPerimeterConfigurationPropertiesProfile(prop.Value, options);
                    continue;
                }
