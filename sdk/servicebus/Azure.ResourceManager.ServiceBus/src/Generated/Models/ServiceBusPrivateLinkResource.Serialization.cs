...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceBusPrivateLinkResource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceBusPrivateLinkResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceBusPrivateLinkResource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceBusPrivateLinkResource>)} interface");
            }
        ...
        string IPersistableModel<ServiceBusPrivateLinkResource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
