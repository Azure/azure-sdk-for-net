...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    public partial class ServiceBusNameAvailabilityResult
    {
        ...
        internal ServiceBusNameAvailabilityResult(string message, bool? isNameAvailable, ServiceBusNameUnavailableReason? reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Message = message;
