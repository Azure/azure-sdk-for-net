...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    public partial class ServiceBusKeyVaultProperties
    {
        ...
        internal ServiceBusKeyVaultProperties(string keyName, Uri keyVaultUri, string keyVersion, UserAssignedIdentityProperties identity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
