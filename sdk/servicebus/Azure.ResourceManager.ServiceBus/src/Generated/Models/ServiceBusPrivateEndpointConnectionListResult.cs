...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    internal partial class ServiceBusPrivateEndpointConnectionListResult
    {
        ...
        internal ServiceBusPrivateEndpointConnectionListResult(IReadOnlyList<ServiceBusPrivateEndpointConnectionData> value, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            NextLink = nextLink;
            _rawData = rawData;
