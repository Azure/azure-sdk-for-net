...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    internal partial class SBQueueListResult
    {
        ...
        {
            Value = new ChangeTrackingList<SBQueueData>();
        }
        ...
        internal SBQueueListResult(IReadOnlyList<SBQueueData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SBQueueData> Value { get; }
