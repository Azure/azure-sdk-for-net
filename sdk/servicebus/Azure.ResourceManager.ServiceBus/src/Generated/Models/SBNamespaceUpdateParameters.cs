...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    public partial class SBNamespaceUpdateParameters : TrackedResource
    {
        /// <summary> Initializes a new instance of SBNamespaceUpdateParameters. </summary>
        /// <param name="location"> The location. </param>
        public SBNamespaceUpdateParameters(Location location) : base(location)
        {
        ...
        internal SBNamespaceUpdateParameters(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, SBSku sku, Identity identity, string provisioningState, string status, DateTimeOffset? createdAt, DateTimeOffset? updatedAt, string serviceBusEndpoint, string metricId, bool? zoneRedundant, Encryption encryption, IList<PrivateEndpointConnectionData> privateEndpointConnections, bool? disableLocalAuth) : base(id, name, type, tags, location)
        {
            Sku = sku;
            Identity = identity;
