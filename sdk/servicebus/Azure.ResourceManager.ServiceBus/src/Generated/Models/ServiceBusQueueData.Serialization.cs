...
{
    public partial class ServiceBusQueueData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceBusQueueData DeserializeServiceBusQueueData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
