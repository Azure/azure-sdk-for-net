...
{
    public partial class ServiceBusTopicData : IUtf8JsonSerializable, IJsonModel<ServiceBusTopicData>, IPersistableModel<ServiceBusTopicData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SubscriptionCount))
            {
                ...
                builder.AppendLine($" '{SubscriptionCount.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(MaxSizeInMegabytes))
            {
                ...
                builder.AppendLine($" '{MaxSizeInMegabytes.Value.ToString()}'");
            }
