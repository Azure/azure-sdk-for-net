...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceBusTopicData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceBusTopicData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceBusTopicData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceBusTopicData>)} interface");
            }
        ...
        string IPersistableModel<ServiceBusTopicData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
