...
{
    public partial class ServiceBusSubscriptionData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceBusSubscriptionData DeserializeServiceBusSubscriptionData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
