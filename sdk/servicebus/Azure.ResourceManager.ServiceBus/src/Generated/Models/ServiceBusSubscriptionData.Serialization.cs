...
{
    public partial class ServiceBusSubscriptionData : IUtf8JsonSerializable, IModelJsonSerializable<ServiceBusSubscriptionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ServiceBusSubscriptionData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ServiceBusSubscriptionData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ServiceBusSubscriptionData>(this, options.Format);
            ...
            if (Optional.IsDefined(ClientAffineProperties))
            {
                ...
                {
                    ((IModelJsonSerializable<ServiceBusClientAffineProperties>)ClientAffineProperties).Serialize(writer, options);
                }
            }
        ...
        internal static ServiceBusSubscriptionData DeserializeServiceBusSubscriptionData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ServiceBusSubscriptionData(id, name, type, systemData.Value, Optional.ToNullable(messageCount), Optional.ToNullable(createdAt), Optional.ToNullable(accessedAt), Optional.ToNullable(updatedAt), countDetails.Value, Optional.ToNullable(lockDuration), Optional.ToNullable(requiresSession), Optional.ToNullable(defaultMessageTimeToLive), Optional.ToNullable(deadLetteringOnFilterEvaluationExceptions), Optional.ToNullable(deadLetteringOnMessageExpiration), Optional.ToNullable(duplicateDetectionHistoryTimeWindow), Optional.ToNullable(maxDeliveryCount), Optional.ToNullable(status), Optional.ToNullable(enableBatchedOperations), Optional.ToNullable(autoDeleteOnIdle), forwardTo.Value, forwardDeadLetteredMessagesTo.Value, Optional.ToNullable(isClientAffine), clientAffineProperties.Value, Optional.ToNullable(location), rawData);
        }

        ServiceBusSubscriptionData IModelJsonSerializable<ServiceBusSubscriptionData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ServiceBusSubscriptionData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeServiceBusSubscriptionData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<ServiceBusSubscriptionData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ServiceBusSubscriptionData>(this, options.Format);
        ...
        ServiceBusSubscriptionData IModelSerializable<ServiceBusSubscriptionData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ServiceBusSubscriptionData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ServiceBusSubscriptionData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ServiceBusSubscriptionData"/> to convert. </param>
        public static implicit operator RequestContent(ServiceBusSubscriptionData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ServiceBusSubscriptionData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ServiceBusSubscriptionData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeServiceBusSubscriptionData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
