...
{
    public partial class ServiceBusCorrelationFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceBusCorrelationFilter DeserializeServiceBusCorrelationFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
