...
{
    public partial class ServiceBusNamespacePatch : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceBusNamespacePatch DeserializeServiceBusNamespacePatch(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
