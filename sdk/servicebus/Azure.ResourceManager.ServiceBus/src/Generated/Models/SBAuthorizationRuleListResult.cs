...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    internal partial class SBAuthorizationRuleListResult
    {
        ...
        {
            Value = new ChangeTrackingList<SBAuthorizationRuleData>();
        }
        ...
        internal SBAuthorizationRuleListResult(IReadOnlyList<SBAuthorizationRuleData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SBAuthorizationRuleData> Value { get; }
