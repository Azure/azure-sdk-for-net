...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    public partial class ServiceBusAccessKeys
    {
        ...
        internal ServiceBusAccessKeys(string primaryConnectionString, string secondaryConnectionString, string aliasPrimaryConnectionString, string aliasSecondaryConnectionString, string primaryKey, string secondaryKey, string keyName, Dictionary<string, BinaryData> rawData)
        {
