...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceBusDisasterRecoveryData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceBusDisasterRecoveryData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceBusDisasterRecoveryData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceBusDisasterRecoveryData>)} interface");
            }
        ...
        string IPersistableModel<ServiceBusDisasterRecoveryData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
