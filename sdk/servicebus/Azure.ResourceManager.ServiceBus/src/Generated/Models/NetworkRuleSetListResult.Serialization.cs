...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    {
        internal static NetworkRuleSetListResult DeserializeNetworkRuleSetListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
