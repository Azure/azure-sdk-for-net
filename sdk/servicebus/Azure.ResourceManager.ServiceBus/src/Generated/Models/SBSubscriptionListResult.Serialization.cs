...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    {
        internal static SBSubscriptionListResult DeserializeSBSubscriptionListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
