...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SBQueueListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SBQueueListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SBQueueListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SBQueueListResult>)} interface");
            }
        ...
        string IPersistableModel<SBQueueListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
