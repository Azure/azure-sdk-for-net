...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    {
        internal static SBAuthorizationRuleListResult DeserializeSBAuthorizationRuleListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
