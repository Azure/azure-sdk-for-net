...
{
    public partial class SBSku : IUtf8JsonSerializable
    {
        ...
        internal static SBSku DeserializeSBSku(JsonElement element)
        {
            ...
            return new SBSku(name, Optional.ToNullable(tier), Optional.ToNullable(capacity));
        }
    }
}
