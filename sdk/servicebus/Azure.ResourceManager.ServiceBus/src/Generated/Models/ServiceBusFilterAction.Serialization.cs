...
{
    public partial class ServiceBusFilterAction : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceBusFilterAction DeserializeServiceBusFilterAction(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
