...
{
    public partial class ServiceBusSqlFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceBusSqlFilter DeserializeServiceBusSqlFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
