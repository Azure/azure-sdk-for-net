...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    public partial class PatchableServiceBusNamespaceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of PatchableServiceBusNamespaceData. </summary>
        /// <param name="location"> The location. </param>
        public PatchableServiceBusNamespaceData(AzureLocation location) : base(location)
        {
