...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    {
        internal static MigrationConfigListResult DeserializeMigrationConfigListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
