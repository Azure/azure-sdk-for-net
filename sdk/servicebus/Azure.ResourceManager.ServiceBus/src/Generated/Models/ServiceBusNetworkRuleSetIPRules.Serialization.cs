...
{
    public partial class ServiceBusNetworkRuleSetIPRules : IUtf8JsonSerializable, IJsonModel<ServiceBusNetworkRuleSetIPRules>, IPersistableModel<ServiceBusNetworkRuleSetIPRules>
    {
        ...
        void IJsonModel<ServiceBusNetworkRuleSetIPRules>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServiceBusNetworkRuleSetIPRules)} does not support '{format}' format.");
            }
