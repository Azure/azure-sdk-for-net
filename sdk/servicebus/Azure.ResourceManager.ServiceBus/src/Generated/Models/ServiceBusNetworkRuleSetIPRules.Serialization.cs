...
namespace Azure.ResourceManager.ServiceBus.Models
{
    public partial class ServiceBusNetworkRuleSetIPRules : IUtf8JsonSerializable, IJsonModel<ServiceBusNetworkRuleSetIPRules>
    {
        ...
        void IJsonModel<ServiceBusNetworkRuleSetIPRules>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ServiceBusNetworkRuleSetIPRules)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ServiceBusNetworkRuleSetIPRules>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ServiceBusNetworkRuleSetIPRules)} does not support '{options.Format}' format.");
            }
        }
