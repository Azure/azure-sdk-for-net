...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceBusNetworkRuleSetIPRules>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceBusNetworkRuleSetIPRules>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceBusNetworkRuleSetIPRules>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceBusNetworkRuleSetIPRules>)} interface");
            }
        ...
        string IPersistableModel<ServiceBusNetworkRuleSetIPRules>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
