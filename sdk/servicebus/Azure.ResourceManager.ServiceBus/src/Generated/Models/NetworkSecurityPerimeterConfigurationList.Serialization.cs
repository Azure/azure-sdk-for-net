...
namespace Azure.ResourceManager.ServiceBus.Models
{
    internal partial class NetworkSecurityPerimeterConfigurationList : IUtf8JsonSerializable, IJsonModel<NetworkSecurityPerimeterConfigurationList>
    {
        ...
        internal static NetworkSecurityPerimeterConfigurationList DeserializeNetworkSecurityPerimeterConfigurationList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<ServiceBusNetworkSecurityPerimeterConfiguration> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<ServiceBusNetworkSecurityPerimeterConfiguration> array = new List<ServiceBusNetworkSecurityPerimeterConfiguration>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ServiceBusNetworkSecurityPerimeterConfiguration.DeserializeServiceBusNetworkSecurityPerimeterConfiguration(item, options));
                    }
                    value = array;
                    continue;
                }
