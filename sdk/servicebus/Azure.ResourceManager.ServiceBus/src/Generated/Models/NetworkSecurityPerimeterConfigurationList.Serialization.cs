...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    internal partial class NetworkSecurityPerimeterConfigurationList : IJsonModel<NetworkSecurityPerimeterConfigurationList>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (ServiceBusNetworkSecurityPerimeterConfigurationData item in Value)
            {
        ...
        internal static NetworkSecurityPerimeterConfigurationList DeserializeNetworkSecurityPerimeterConfigurationList(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<ServiceBusNetworkSecurityPerimeterConfigurationData> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<ServiceBusNetworkSecurityPerimeterConfigurationData> array = new List<ServiceBusNetworkSecurityPerimeterConfigurationData>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(ServiceBusNetworkSecurityPerimeterConfigurationData.DeserializeServiceBusNetworkSecurityPerimeterConfigurationData(item, options));
                    }
                    value = array;
                    continue;
                }
