...
{
    public partial class SBNamespaceData : IUtf8JsonSerializable
    {
        ...
        internal static SBNamespaceData DeserializeSBNamespaceData(JsonElement element)
        {
            Optional<SBSku> sku = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("sku"))
                {
                    ...
                    sku = SBSku.DeserializeSBSku(property.Value);
                    continue;
                }
