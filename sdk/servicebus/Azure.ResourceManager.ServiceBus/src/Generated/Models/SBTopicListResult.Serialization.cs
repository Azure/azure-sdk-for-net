...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SBTopicListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SBTopicListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SBTopicListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SBTopicListResult>)} interface");
            }
        ...
        string IPersistableModel<SBTopicListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
