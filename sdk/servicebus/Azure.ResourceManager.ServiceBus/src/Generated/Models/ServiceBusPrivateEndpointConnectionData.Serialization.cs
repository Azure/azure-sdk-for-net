...
{
    public partial class ServiceBusPrivateEndpointConnectionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ServiceBusPrivateEndpointConnectionData DeserializeServiceBusPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            Core.Optional<ServiceBusPrivateLinkServiceConnectionState> privateLinkServiceConnectionState = default;
            Core.Optional<ServiceBusPrivateEndpointConnectionProvisioningState> provisioningState = default;
            ...
            return new ServiceBusPrivateEndpointConnectionData(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Core.Optional.ToNullable(provisioningState), Core.Optional.ToNullable(location));
        }
    }
}
