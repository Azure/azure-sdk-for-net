...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class ServiceBusSubscriptionResource : ArmResource
    {
        ...
        internal ServiceBusSubscriptionResource(ArmClient client, ServiceBusSubscriptionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ServiceBusSubscriptionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ServiceBusSubscriptionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<ServiceBusSubscriptionResource>> UpdateAsync(WaitUntil waitUntil, ServiceBusSubscriptionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ServiceBusArmOperation<ServiceBusSubscriptionResource>(Response.FromValue(new ServiceBusSubscriptionResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
