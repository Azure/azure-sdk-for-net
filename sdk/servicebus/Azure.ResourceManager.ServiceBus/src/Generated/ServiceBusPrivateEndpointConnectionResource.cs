...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class ServiceBusPrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal ServiceBusPrivateEndpointConnectionResource(ArmClient client, ServiceBusPrivateEndpointConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
