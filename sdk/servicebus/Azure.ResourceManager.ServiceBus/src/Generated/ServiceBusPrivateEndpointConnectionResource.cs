...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ServiceBusPrivateEndpointConnectionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ServiceBusNamespaceResource"/> using the GetServiceBusPrivateEndpointConnections method.
    /// </summary>
    public partial class ServiceBusPrivateEndpointConnectionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ServiceBusPrivateEndpointConnectionResource for mocking. </summary>
        protected ServiceBusPrivateEndpointConnectionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ServiceBusPrivateEndpointConnectionResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string serviceBusPrivateEndpointConnectionApiVersion);
            _privateEndpointConnectionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ServiceBus", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/privateEndpointConnections/{privateEndpointConnectionName}";
        ...
        {
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("ServiceBusPrivateEndpointConnectionResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("ServiceBusPrivateEndpointConnectionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                ServiceBusArmOperation operation = new ServiceBusArmOperation(_privateEndpointConnectionsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        /// <summary>
        /// Update a ServiceBusPrivateEndpointConnection.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/privateEndpointConnections/{privateEndpointConnectionName}. </description>
        ...
        public virtual async Task<ArmOperation<ServiceBusPrivateEndpointConnectionResource>> UpdateAsync(WaitUntil waitUntil, ServiceBusPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("ServiceBusPrivateEndpointConnectionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _privateEndpointConnectionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ServiceBusPrivateEndpointConnectionData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ServiceBusPrivateEndpointConnectionData> response = Response.FromValue(ServiceBusPrivateEndpointConnectionData.FromResponse(result), result);
