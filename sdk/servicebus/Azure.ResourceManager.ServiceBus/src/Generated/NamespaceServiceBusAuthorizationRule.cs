...
{
    /// <summary> A Class representing a NamespaceServiceBusAuthorizationRule along with the instance operations that can be performed on it. </summary>
    public partial class NamespaceServiceBusAuthorizationRule : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NamespaceServiceBusAuthorizationRule"/> class for mocking. </summary>
        protected NamespaceServiceBusAuthorizationRule()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "NamespaceServiceBusAuthorizationRule"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="resource"> The resource that is the target of operations. </param>
        internal NamespaceServiceBusAuthorizationRule(ArmResource options, ServiceBusAuthorizationRuleData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal NamespaceServiceBusAuthorizationRule(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new NamespaceAuthorizationRulesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NamespaceServiceBusAuthorizationRule(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new NamespaceAuthorizationRulesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<NamespaceServiceBusAuthorizationRule>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("NamespaceServiceBusAuthorizationRule.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new NamespaceServiceBusAuthorizationRule(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Gets an authorization rule for a namespace by rule name. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<NamespaceServiceBusAuthorizationRule> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("NamespaceServiceBusAuthorizationRule.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NamespaceServiceBusAuthorizationRule.Delete");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NamespaceServiceBusAuthorizationRule.GetKeys");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<AccessKeys>> RegenerateKeysAsync(RegenerateAccessKeyParameters parameters, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("NamespaceServiceBusAuthorizationRule.RegenerateKeys");
            scope.Start();
            try
            {
