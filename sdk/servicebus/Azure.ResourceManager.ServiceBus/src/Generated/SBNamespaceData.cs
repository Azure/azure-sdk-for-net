...
{
    /// <summary> A class representing the SBNamespace data model. </summary>
    public partial class SBNamespaceData : TrackedResource
    {
        /// <summary> Initializes a new instance of SBNamespaceData. </summary>
        /// <param name="location"> The location. </param>
        public SBNamespaceData(Location location) : base(location)
        {
        ...
        internal SBNamespaceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, SBSku sku, Identity identity, SystemData systemData, string provisioningState, string status, DateTimeOffset? createdAt, DateTimeOffset? updatedAt, string serviceBusEndpoint, string metricId, bool? zoneRedundant, Encryption encryption, IList<PrivateEndpointConnectionData> privateEndpointConnections, bool? disableLocalAuth) : base(id, name, type, tags, location)
        {
            Sku = sku;
            Identity = identity;
