...
{
    /// <summary> A Class representing a SBTopic along with the instance operations that can be performed on it. </summary>
    public partial class SBTopic : ArmResource
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly TopicsRestOperations _restClient;
        private readonly SBTopicData _data;

        /// <summary> Initializes a new instance of the <see cref="SBTopic"/> class for mocking. </summary>
        protected SBTopic()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "SBTopic"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="resource"> The resource that is the target of operations. </param>
        internal SBTopic(ArmResource options, SBTopicData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal SBTopic(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new TopicsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SBTopic(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new TopicsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual SBTopicData Data
        {
            get
            {
                if (!HasData)
        ...
        public async virtual Task<Response<SBTopic>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SBTopic.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new SBTopic(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Returns a description for the specified topic. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SBTopic> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SBTopic.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("SBTopic.Delete");
            scope.Start();
            try
            {
