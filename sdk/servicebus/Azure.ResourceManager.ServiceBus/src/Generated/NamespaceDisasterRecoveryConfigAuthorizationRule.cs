...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class NamespaceDisasterRecoveryConfigAuthorizationRule : ArmResource
    {
        ...
        internal NamespaceDisasterRecoveryConfigAuthorizationRule(ArmResource options, ServiceBusAuthorizationRuleData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("NamespaceDisasterRecoveryConfigAuthorizationRule.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        /// ContextualPath: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/disasterRecoveryConfigs/{alias}/authorizationRules/{authorizationRuleName}
        /// OperationId: DisasterRecoveryConfigAuthorizationRules_ListKeys
