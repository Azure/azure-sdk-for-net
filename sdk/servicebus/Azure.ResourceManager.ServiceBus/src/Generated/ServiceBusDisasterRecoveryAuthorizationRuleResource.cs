...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    /// </summary>
    public partial class ServiceBusDisasterRecoveryAuthorizationRuleResource : ServiceBusAuthorizationRuleResource
    {
        ...
        internal ServiceBusDisasterRecoveryAuthorizationRuleResource(ArmClient client, ServiceBusAuthorizationRuleData data) : base(client, data)
        {
        ...
        protected override async Task<Response<ServiceBusAuthorizationRuleResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((ServiceBusAuthorizationRuleResource)new ServiceBusDisasterRecoveryAuthorizationRuleResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<ServiceBusDisasterRecoveryAuthorizationRuleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((ServiceBusDisasterRecoveryAuthorizationRuleResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<ServiceBusDisasterRecoveryAuthorizationRuleResource> Get(CancellationToken cancellationToken = default)
        {
