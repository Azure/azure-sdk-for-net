...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class ServiceBusAuthorizationRuleData : ProxyResource
    {
        ...
        internal ServiceBusAuthorizationRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, IList<AccessRights> rights) : base(id, name, resourceType, systemData, location)
        {
            Rights = rights;
        }
