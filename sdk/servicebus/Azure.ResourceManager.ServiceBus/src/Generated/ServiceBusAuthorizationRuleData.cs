...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class ServiceBusAuthorizationRuleData : ResourceData
    {
        ...
        internal ServiceBusAuthorizationRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, IList<ServiceBusAccessRight> rights, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Rights = rights;
