...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class ServiceBusNamespaceAuthorizationRuleResource : ArmResource
    {
        ...
        internal ServiceBusNamespaceAuthorizationRuleResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _sbAuthorizationRulesRestClient = new SBAuthorizationRules(_sbAuthorizationRulesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, serviceBusNamespaceAuthorizationRuleApiVersion ?? "2026-07-01-preview");
