...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ServiceBusRuleResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ServiceBusSubscriptionResource"/> using the GetServiceBusRules method.
    /// </summary>
    public partial class ServiceBusRuleResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ServiceBusRuleResource for mocking. </summary>
        protected ServiceBusRuleResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ServiceBusRuleResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string serviceBusRuleApiVersion);
            _rulesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ServiceBus", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceBus/namespaces/{namespaceName}/topics/{topicName}/subscriptions/{subscriptionName}/rules/{ruleName}";
        ...
        {
            using DiagnosticScope scope = _rulesClientDiagnostics.CreateScope("ServiceBusRuleResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _rulesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _rulesClientDiagnostics.CreateScope("ServiceBusRuleResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _rulesRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<ServiceBusRuleResource>> UpdateAsync(WaitUntil waitUntil, ServiceBusRuleData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _rulesClientDiagnostics.CreateScope("ServiceBusRuleResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _rulesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ServiceBusRuleData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ServiceBusRuleData> response = Response.FromValue(ServiceBusRuleData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
