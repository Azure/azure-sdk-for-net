...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class SBQueueCollection : ArmCollection, IEnumerable<SBQueue>, IAsyncEnumerable<SBQueue>
    {
        ...
        public virtual QueueCreateOrUpdateOperation CreateOrUpdate(string queueName, SBQueueData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (queueName == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="queueName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<QueueCreateOrUpdateOperation> CreateOrUpdateAsync(string queueName, SBQueueData parameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (queueName == null)
            {
                throw new ArgumentNullException(nameof(queueName));
        ...
        public virtual Response<SBQueue> Get(string queueName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new SBQueue(Parent, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Response<SBQueue> GetIfExists(string queueName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return response.Value == null
                    ? Response.FromValue<SBQueue>(null, response.GetRawResponse())
                    : Response.FromValue(new SBQueue(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="SBQueue" /> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<SBQueue> GetAll(int? skip = null, int? top = null, CancellationToken cancellationToken = default)
        {
            Page<SBQueue> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new SBQueue(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        /// <param name="top"> May be used to limit the number of results to the most recent N usageDetails. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="SBQueue" /> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<SBQueue> GetAllAsync(int? skip = null, int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        // Builders.
        // public ArmBuilder<ResourceIdentifier, SBQueue, SBQueueData> Construct() { }
    }
}
