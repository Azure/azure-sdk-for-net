...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class ServiceBusRuleData : ProxyResource
    {
        ...
        internal ServiceBusRuleData(ResourceIdentifier id, string name, ResourceType type, string location, SystemData systemData, FilterAction action, FilterType? filterType, SqlFilter sqlFilter, CorrelationFilter correlationFilter) : base(id, name, type, location)
        {
