...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceBusAuthorizationRuleData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            builder.AppendLine(" {");
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(Rights), out propertyOverride);
            if (Optional.IsCollectionDefined(Rights) || hasPropertyOverride)
            {
                if (Rights.Any() || hasPropertyOverride)
                {
