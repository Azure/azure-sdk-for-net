...
{
    internal partial class NamespacesGetAuthorizationRulesCollectionResultOfT : Pageable<ServiceBusAuthorizationRuleData>
    {
        ...
        public NamespacesGetAuthorizationRulesCollectionResultOfT(Namespaces client, Guid subscriptionId, string resourceGroupName, string namespaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
