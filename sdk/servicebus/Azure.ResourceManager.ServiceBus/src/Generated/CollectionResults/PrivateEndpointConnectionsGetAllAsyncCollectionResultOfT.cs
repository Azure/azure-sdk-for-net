...
{
    internal partial class PrivateEndpointConnectionsGetAllAsyncCollectionResultOfT : AsyncPageable<ServiceBusPrivateEndpointConnectionData>
    {
        ...
        public override async IAsyncEnumerable<Page<ServiceBusPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
