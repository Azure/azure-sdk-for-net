...
{
    internal partial class PrivateLinkResourcesGetPrivateLinkResourcesAsyncCollectionResultOfT : AsyncPageable<ServiceBusPrivateLinkResource>
    {
        ...
        public override async IAsyncEnumerable<Page<ServiceBusPrivateLinkResource>> AsPages(string continuationToken, int? pageSizeHint)
        {
            Response response = await GetNextResponseAsync(pageSizeHint, null).ConfigureAwait(false);
            PrivateLinkResourcesListResult result = PrivateLinkResourcesListResult.FromResponse(response);
            yield return Page<ServiceBusPrivateLinkResource>.FromValues((IReadOnlyList<ServiceBusPrivateLinkResource>)result.Value, null, response);
        }
