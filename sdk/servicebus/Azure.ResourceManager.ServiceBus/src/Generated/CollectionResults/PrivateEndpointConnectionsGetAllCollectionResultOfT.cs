...
namespace Azure.ResourceManager.ServiceBus
{
    internal partial class PrivateEndpointConnectionsGetAllCollectionResultOfT : Pageable<ServiceBusPrivateEndpointConnectionData>
    {
        ...
        public PrivateEndpointConnectionsGetAllCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string namespaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
