...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    public partial class MigrationConfigCreateAndStartMigrationOperation : Operation<MigrationConfigProperties>, IOperationSource<MigrationConfigProperties>
    {
        private readonly OperationInternals<MigrationConfigProperties> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of MigrationConfigCreateAndStartMigrationOperation for mocking. </summary>
        protected MigrationConfigCreateAndStartMigrationOperation()
        {
        }

        internal MigrationConfigCreateAndStartMigrationOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<MigrationConfigProperties>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MigrationConfigCreateAndStartMigrationOperation");
