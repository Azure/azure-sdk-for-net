...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    public partial class ServiceBusQueueCreateOrUpdateOperation : Operation<ServiceBusQueue>
    {
        private readonly OperationOrResponseInternals<ServiceBusQueue> _operation;

        /// <summary> Initializes a new instance of ServiceBusQueueCreateOrUpdateOperation for mocking. </summary>
        protected ServiceBusQueueCreateOrUpdateOperation()
        {
        }

        internal ServiceBusQueueCreateOrUpdateOperation(ArmClient armClient, Response<ServiceBusQueueData> response)
        {
            _operation = new OperationOrResponseInternals<ServiceBusQueue>(Response.FromValue(new ServiceBusQueue(armClient, response.Value), response.GetRawResponse()));
        }
