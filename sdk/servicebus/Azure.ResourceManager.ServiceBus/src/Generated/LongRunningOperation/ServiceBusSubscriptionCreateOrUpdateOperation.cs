...
namespace Azure.ResourceManager.ServiceBus.Models
{
    ...
    public partial class ServiceBusSubscriptionCreateOrUpdateOperation : Operation<ServiceBusSubscription>
    {
        private readonly OperationOrResponseInternals<ServiceBusSubscription> _operation;

        /// <summary> Initializes a new instance of ServiceBusSubscriptionCreateOrUpdateOperation for mocking. </summary>
        protected ServiceBusSubscriptionCreateOrUpdateOperation()
        {
        }

        internal ServiceBusSubscriptionCreateOrUpdateOperation(ArmClient armClient, Response<ServiceBusSubscriptionData> response)
        {
            _operation = new OperationOrResponseInternals<ServiceBusSubscription>(Response.FromValue(new ServiceBusSubscription(armClient, response.Value), response.GetRawResponse()));
        }
