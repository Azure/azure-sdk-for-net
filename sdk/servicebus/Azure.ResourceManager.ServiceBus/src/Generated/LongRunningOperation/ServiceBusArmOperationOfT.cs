...
{
    internal partial class ServiceBusArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ServiceBusArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ServiceBusArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
