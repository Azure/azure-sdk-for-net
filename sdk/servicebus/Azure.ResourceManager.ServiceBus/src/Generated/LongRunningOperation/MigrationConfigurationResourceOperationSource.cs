...
{
    /// <summary></summary>
    internal partial class MigrationConfigurationResourceOperationSource : IOperationSource<MigrationConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MigrationConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
