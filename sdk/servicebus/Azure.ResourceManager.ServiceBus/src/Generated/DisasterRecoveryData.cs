...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class DisasterRecoveryData : Resource
    {
        ...
        internal DisasterRecoveryData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, ProvisioningStateDisasterRecovery? provisioningState, long? pendingReplicationOperationsCount, string partnerNamespace, string alternateName, RoleDisasterRecovery? role) : base(id, name, type)
        {
