...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class DisasterRecoveryData : ProxyResource
    {
        ...
        internal DisasterRecoveryData(ResourceIdentifier id, string name, ResourceType type, string location, SystemData systemData, ProvisioningStateDR? provisioningState, long? pendingReplicationOperationsCount, string partnerNamespace, string alternateName, RoleDisasterRecovery? role) : base(id, name, type, location)
        {
