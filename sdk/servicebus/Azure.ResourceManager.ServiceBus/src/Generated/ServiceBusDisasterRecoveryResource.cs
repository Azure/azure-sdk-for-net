...
namespace Azure.ResourceManager.ServiceBus
{
    ...
    public partial class ServiceBusDisasterRecoveryResource : ArmResource
    {
        ...
        internal ServiceBusDisasterRecoveryResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _disasterRecoveryConfigsRestClient = new DisasterRecoveryConfigs(_disasterRecoveryConfigsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, serviceBusDisasterRecoveryApiVersion ?? "2026-07-01-preview");
