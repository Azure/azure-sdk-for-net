    ...
    public partial class ServiceBusQueueAuthorizationRuleResource : ServiceBusAuthorizationRuleResource
    {
        ...
        protected override async Task<Response<ServiceBusAuthorizationRuleResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((ServiceBusAuthorizationRuleResource)new ServiceBusQueueAuthorizationRuleResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<ServiceBusQueueAuthorizationRuleResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((ServiceBusQueueAuthorizationRuleResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<ServiceBusQueueAuthorizationRuleResource> Get(CancellationToken cancellationToken = default)
        {
