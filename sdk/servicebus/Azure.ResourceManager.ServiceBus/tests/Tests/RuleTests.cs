...
namespace Azure.ResourceManager.ServiceBus.Tests
{
    public class RuleTests : ServiceBusTestBase
    {
        ...
        public async Task CreateGetUpdateDeleteRule()
        {
            ...
            ServiceBusRule rule2 = (await ruleCollection.CreateOrUpdateAsync(WaitUntil.Completed, ruleName2, new ServiceBusRuleData(){FilterType = FilterType.CorrelationFilter})).Value;
