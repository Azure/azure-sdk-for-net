...
namespace Azure.ResourceManager.ServiceBus.Samples
{
    public partial class Sample_NetworkSecurityPerimeterConfigurationResource
    {
        ...
        public async Task Get_NetworkSecurityPerimeterConfigurationassociationProxyName()
        {
            ...
            ResourceIdentifier networkSecurityPerimeterConfigurationResourceId = NetworkSecurityPerimeterConfigurationResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, namespaceName, resourceAssociationName);
        ...
        {
            // Generated from example definition: specification/servicebus/resource-manager/Microsoft.ServiceBus/preview/2025-05-01-preview/examples/NameSpaces/NetworkSecurityPerimeterConfigurationReconcile.json
            ...
            // invoke the operation
            await networkSecurityPerimeterConfiguration.ReconcileAsync();
