...
{
    public partial class Sample_ArmDisasterRecoveryCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_SBAliasCreate()
        {
            ...
            // get the collection of this ArmDisasterRecoveryResource
            ArmDisasterRecoveryCollection collection = sbNamespace.GetArmDisasterRecoveries();
            ...
            ArmOperation<ArmDisasterRecoveryResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, @alias, data);
        ...
        public async Task Get_SBAliasGet()
        {
            ...
            ArmDisasterRecoveryResource result = await collection.GetAsync(@alias);
        ...
        public async Task GetAll_SBAliasList()
        {
            ...
            await foreach (ArmDisasterRecoveryResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                ArmDisasterRecoveryData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_SBAliasGet()
        {
            ...
            // invoke the operation
            string @alias = "sdk-DisasterRecovery-3814";
            NullableResponse<ArmDisasterRecoveryResource> response = await collection.GetIfExistsAsync(@alias);
            ArmDisasterRecoveryResource result = response.HasValue ? response.Value : null;
