...
namespace Azure.ResourceManager.ServiceBus.Samples
{
    public partial class Sample_SBNamespaceCollection
    {
        ...
        public async Task CreateOrUpdate_NameSpaceCreate()
        {
            ...
            // get the collection of this SBNamespaceResource
            SBNamespaceCollection collection = resourceGroupResource.GetSBNamespaces();

            // invoke the operation
            string namespaceName = "sdk-Namespace2924";
            SBNamespaceData data = new SBNamespaceData(new AzureLocation("South Central US"))
            {
                Sku = new SBSku(ServiceBusSkuName.Premium)
                {
...
["tag2"] = "value2"
            ...
            ArmOperation<SBNamespaceResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, namespaceName, data);
        ...
        public async Task Get_NameSpaceGet()
        {
            ...
            SBNamespaceResource result = await collection.GetAsync(namespaceName);
        ...
        public async Task GetAll_NameSpaceListByResourceGroup()
        {
            ...
            await foreach (SBNamespaceResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                SBNamespaceData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_NameSpaceGet()
        {
            ...
            // invoke the operation
            string namespaceName = "sdk-Namespace-2924";
            NullableResponse<SBNamespaceResource> response = await collection.GetIfExistsAsync(namespaceName);
            SBNamespaceResource result = response.HasValue ? response.Value : null;
