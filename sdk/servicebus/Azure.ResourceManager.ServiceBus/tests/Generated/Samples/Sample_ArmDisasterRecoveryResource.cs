...
namespace Azure.ResourceManager.ServiceBus.Samples
{
    public partial class Sample_ArmDisasterRecoveryResource
    {
        ...
        public async Task Get_SBAliasGet()
        {
            ...
            // this example assumes you already have this ArmDisasterRecoveryResource created on azure
            // for more information of creating ArmDisasterRecoveryResource, please refer to the document of ArmDisasterRecoveryResource
            ...
            ResourceIdentifier armDisasterRecoveryResourceId = ArmDisasterRecoveryResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, namespaceName, @alias);
            ArmDisasterRecoveryResource armDisasterRecovery = client.GetArmDisasterRecoveryResource(armDisasterRecoveryResourceId);

            // invoke the operation
            ArmDisasterRecoveryResource result = await armDisasterRecovery.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            ArmDisasterRecoveryData resourceData = result.Data;
        ...
        public async Task Update_SBAliasCreate()
        {
            ...
            // invoke the operation
            ArmDisasterRecoveryData data = new ArmDisasterRecoveryData
            {
                PartnerNamespace = "sdk-Namespace-37",
                AlternateName = "alternameforAlias-Namespace-8860",
            };
            ArmOperation<ArmDisasterRecoveryResource> lro = await armDisasterRecovery.UpdateAsync(WaitUntil.Completed, data);
            ArmDisasterRecoveryResource result = lro.Value;
