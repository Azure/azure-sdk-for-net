...
{
    public partial class Sample_SBSubscriptionResource
    {
        [Test]
        ...
        public async Task Get_SubscriptionGet()
        {
            ...
            SBSubscriptionResource result = await sbSubscription.GetAsync();
        ...
        public async Task Delete_SubscriptionDelete()
        {
            ...
            // invoke the operation
            await sbSubscription.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Update_SubscriptionCreate()
        {
            ...
            ArmOperation<SBSubscriptionResource> lro = await sbSubscription.UpdateAsync(WaitUntil.Completed, data);
