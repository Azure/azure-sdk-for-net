...
namespace Azure.AI.Discovery
{
    ...
    public partial class KnowledgeBase
    {
        ...
        internal KnowledgeBase(string description, string copilotInstruction)
        {
        ...
        internal KnowledgeBase(string name, string id, string version, string bookshelfName, IList<StorageAssetReference> storageAssetReferences, string knowledgeBaseUrl, DiscoveryProvisioningState? provisioningState, DateTimeOffset? createdAt, string createdBy, ByType? createdByType, DateTimeOffset? lastModifiedAt, string lastModifiedBy, ByType? lastModifiedByType, IList<DiscoveryTag> tags, string description, string copilotInstruction, IndexingStatus? status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Id = id;
            Version = version;
        ...
        public string CopilotInstruction { get; }
