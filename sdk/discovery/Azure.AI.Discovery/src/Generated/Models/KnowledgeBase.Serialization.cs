...
namespace Azure.AI.Discovery
{
    ...
    public partial class KnowledgeBase : IJsonModel<KnowledgeBase>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsDefined(CreatedByApiVersion))
            {
                writer.WritePropertyName("createdByApiVersion"u8);
                writer.WriteStringValue(CreatedByApiVersion);
            }
            if (options.Format != "W" && Optional.IsDefined(LastIndexingRun))
            {
        ...
        internal static KnowledgeBase DeserializeKnowledgeBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("createdByApiVersion"u8))
                {
                    createdByApiVersion = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("lastIndexingRun"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    lastIndexingRun = LastIndexingRun.DeserializeLastIndexingRun(prop.Value, options);
                    continue;
                }
