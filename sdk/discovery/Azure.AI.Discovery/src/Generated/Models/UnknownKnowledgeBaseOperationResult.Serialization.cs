...
{
    internal partial class UnknownKnowledgeBaseOperationResult : KnowledgeBaseOperationResult, IJsonModel<KnowledgeBaseOperationResult>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownKnowledgeBaseOperationResult"/> for deserialization. </summary>
        internal UnknownKnowledgeBaseOperationResult()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownKnowledgeBaseOperationResult DeserializeUnknownKnowledgeBaseOperationResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownKnowledgeBaseOperationResult(id, status, error, operationType, additionalBinaryDataProperties);
        }
    }
}
