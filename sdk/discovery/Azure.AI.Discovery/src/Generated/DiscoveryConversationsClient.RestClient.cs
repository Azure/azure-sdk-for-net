...
namespace Azure.AI.Discovery
{
    ...
    public partial class DiscoveryConversationsClient
    {
        ...
        internal HttpMessage CreateStableUpdateRequest(string conversationName, RequestContent content, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/conversations/", false);
        ...
        internal HttpMessage CreateGetAllRequest(string investigationName, string projectName, DateTimeOffset? createdSince, int? top, int? skip, int? maxpagesize, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/conversations", false);
