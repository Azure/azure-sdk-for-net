...
namespace Azure.AI.Discovery
{
    ...
    public partial class ResourceOperationStatusInvestigationInvestigationError
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ResourceOperationStatusInvestigationInvestigationError"/>. </summary>
        /// <param name="id"> The unique ID of the operation. </param>
        /// <param name="status"> The status of the operation. </param>
        internal ResourceOperationStatusInvestigationInvestigationError(string id, OperationState status)
        {
            Id = id;
            Status = status;
        }
        ...
        internal ResourceOperationStatusInvestigationInvestigationError(string id, OperationState status, ResponseError error, DiscoveryInvestigation result, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Status = status;
            Error = error;
