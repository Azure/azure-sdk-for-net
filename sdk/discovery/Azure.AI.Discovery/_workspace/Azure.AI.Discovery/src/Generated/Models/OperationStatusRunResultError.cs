...
namespace Azure.AI.Discovery
{
    ...
    public partial class OperationStatusRunResultError
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="OperationStatusRunResultError"/>. </summary>
        /// <param name="id"> The unique ID of the operation. </param>
        /// <param name="status"> The status of the operation. </param>
        internal OperationStatusRunResultError(string id, OperationState status)
        {
            Id = id;
            Status = status;
        }
        ...
        internal OperationStatusRunResultError(string id, OperationState status, ResponseError error, RunResult result, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Status = status;
            Error = error;
