...
namespace Azure.ResourceManager.Discovery
{
    ...
    public partial class BookshelfData : TrackedResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BookshelfData"/>. </summary>
        ...
        internal BookshelfData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, BookshelfProperties properties) : base(id, name, resourceType, systemData, tags, location)
        {
