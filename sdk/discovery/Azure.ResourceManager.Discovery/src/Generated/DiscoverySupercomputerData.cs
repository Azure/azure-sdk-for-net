...
namespace Azure.ResourceManager.Discovery
{
    ...
    public partial class DiscoverySupercomputerData : TrackedResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DiscoverySupercomputerData"/>. </summary>
        /// <param name="location"> The geo-location where the resource lives. </param>
        public DiscoverySupercomputerData(AzureLocation location) : base(location)
        {
        }
