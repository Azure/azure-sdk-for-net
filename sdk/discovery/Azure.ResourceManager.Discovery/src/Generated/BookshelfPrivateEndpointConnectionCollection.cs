...
namespace Azure.ResourceManager.Discovery
{
    ...
    public partial class BookshelfPrivateEndpointConnectionCollection : ArmCollection, IEnumerable<BookshelfPrivateEndpointConnectionResource>, IAsyncEnumerable<BookshelfPrivateEndpointConnectionResource>
    {
        ...
        internal BookshelfPrivateEndpointConnectionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _bookshelfPrivateEndpointConnectionsRestClient = new BookshelfPrivateEndpointConnections(_bookshelfPrivateEndpointConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, bookshelfPrivateEndpointConnectionApiVersion ?? "2026-06-01");
        ...
        public virtual async Task<ArmOperation<BookshelfPrivateEndpointConnectionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string privateEndpointConnectionName, BookshelfPrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                DiscoveryArmOperation<BookshelfPrivateEndpointConnectionResource> operation = new DiscoveryArmOperation<BookshelfPrivateEndpointConnectionResource>(
                    new BookshelfPrivateEndpointConnectionResourceOperationSource(Client),
