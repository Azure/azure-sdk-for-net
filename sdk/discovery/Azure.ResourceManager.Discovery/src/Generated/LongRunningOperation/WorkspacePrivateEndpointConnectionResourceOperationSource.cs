...
{
    /// <summary></summary>
    internal partial class WorkspacePrivateEndpointConnectionResourceOperationSource : IOperationSource<WorkspacePrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal WorkspacePrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
