...
{
    internal partial class DiscoveryArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of DiscoveryArmOperation for mocking. </summary>
        protected DiscoveryArmOperation()
        {
        }
        ...
        internal DiscoveryArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DiscoveryArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
