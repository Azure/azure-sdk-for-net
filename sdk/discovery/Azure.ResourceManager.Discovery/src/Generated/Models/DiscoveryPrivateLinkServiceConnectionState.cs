...
namespace Azure.ResourceManager.Discovery.Models
{
    ...
    public partial class DiscoveryPrivateLinkServiceConnectionState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DiscoveryPrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal DiscoveryPrivateLinkServiceConnectionState(DiscoveryPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
        ...
        public DiscoveryPrivateEndpointServiceConnectionStatus? Status { get; set; }
