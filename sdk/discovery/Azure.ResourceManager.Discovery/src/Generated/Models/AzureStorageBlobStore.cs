...
namespace Azure.ResourceManager.Discovery.Models
{
    ...
    public partial class AzureStorageBlobStore : DiscoveryStorageStore
    {
        ...
        /// <param name="storageAccountId"> The associated Azure Storage Account ID. </param>
        internal AzureStorageBlobStore(StorageStoreType kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, BlobStorageMountProtocol? mountProtocol, ResourceIdentifier storageAccountId) : base(kind, additionalBinaryDataProperties)
        {
        ...
        public BlobStorageMountProtocol? MountProtocol { get; set; }
