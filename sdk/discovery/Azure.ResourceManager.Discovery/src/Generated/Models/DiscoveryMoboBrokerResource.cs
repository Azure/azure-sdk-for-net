...
namespace Azure.ResourceManager.Discovery.Models
{
    ...
    public partial class DiscoveryMoboBrokerResource
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DiscoveryMoboBrokerResource"/>. </summary>
        ...
        internal DiscoveryMoboBrokerResource(ResourceIdentifier id, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
