...
namespace Azure.ResourceManager.Discovery.Models
{
    ...
    public partial class DiscoveryProjectProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DiscoveryProjectProperties"/>. </summary>
        ...
        internal DiscoveryProjectProperties(DiscoveryProvisioningState? provisioningState, Uri foundryProjectEndpoint, IList<ResourceIdentifier> storageContainerIds, ProjectSettings settings, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
