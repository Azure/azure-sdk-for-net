...
namespace Azure.ResourceManager.Discovery.Models
{
    ...
    public partial class DiscoveryPrivateEndpointConnectionProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DiscoveryPrivateEndpointConnectionProperties"/>. </summary>
        ...
        public DiscoveryPrivateEndpointConnectionProperties(DiscoveryPrivateLinkServiceConnectionState privateLinkServiceConnectionState)
        {
        ...
        internal DiscoveryPrivateEndpointConnectionProperties(IReadOnlyList<string> groupIds, PrivateEndpoint privateEndpoint, DiscoveryPrivateLinkServiceConnectionState privateLinkServiceConnectionState, DiscoveryPrivateEndpointConnectionProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            GroupIds = groupIds;
        ...
        public DiscoveryPrivateLinkServiceConnectionState PrivateLinkServiceConnectionState { get; set; }

        /// <summary> The provisioning state of the private endpoint connection resource. </summary>
        public DiscoveryPrivateEndpointConnectionProvisioningState? ProvisioningState { get; }
