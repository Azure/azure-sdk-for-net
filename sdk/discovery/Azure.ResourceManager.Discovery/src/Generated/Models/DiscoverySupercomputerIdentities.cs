...
namespace Azure.ResourceManager.Discovery.Models
{
    ...
    public partial class DiscoverySupercomputerIdentities
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DiscoverySupercomputerIdentities"/>. </summary>
        ...
        public DiscoverySupercomputerIdentities(DiscoveryManagedIdentityReference clusterIdentity, DiscoveryManagedIdentityReference kubeletIdentity)
        {
        ...
        internal DiscoverySupercomputerIdentities(DiscoveryManagedIdentityReference clusterIdentity, DiscoveryManagedIdentityReference kubeletIdentity, IDictionary<string, UserAssignedIdentity> workloadIdentities, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ClusterIdentity = clusterIdentity;
            KubeletIdentity = kubeletIdentity;
