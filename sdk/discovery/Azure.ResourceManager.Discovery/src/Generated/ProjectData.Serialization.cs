...
namespace Azure.ResourceManager.Discovery
{
    ...
    public partial class ProjectData : TrackedResourceData, IJsonModel<ProjectData>
    {
        ...
        internal static RequestContent ToRequestContent(ProjectData projectData)
        {
            ...
            content.JsonWriter.WriteObjectValue(projectData, ModelSerializationExtensions.WireOptions);
            return content;
        }
