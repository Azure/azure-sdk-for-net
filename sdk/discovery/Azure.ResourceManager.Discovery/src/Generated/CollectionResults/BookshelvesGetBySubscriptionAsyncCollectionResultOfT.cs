...
namespace Azure.ResourceManager.Discovery
{
    internal partial class BookshelvesGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<BookshelfData>
    {
        ...
        /// <summary> Initializes a new instance of BookshelvesGetBySubscriptionAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BookshelvesGetBySubscriptionAsyncCollectionResultOfT(Bookshelves client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BookshelvesGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </summary>
