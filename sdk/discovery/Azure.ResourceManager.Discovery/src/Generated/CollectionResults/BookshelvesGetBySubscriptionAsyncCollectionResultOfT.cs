...
namespace Azure.ResourceManager.Discovery
{
    internal partial class BookshelvesGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<BookshelfData>
    {
        ...
        public BookshelvesGetBySubscriptionAsyncCollectionResultOfT(Bookshelves client, Guid subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
