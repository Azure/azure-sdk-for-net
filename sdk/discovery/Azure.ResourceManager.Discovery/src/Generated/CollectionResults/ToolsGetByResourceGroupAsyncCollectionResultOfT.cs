...
namespace Azure.ResourceManager.Discovery
{
    internal partial class ToolsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ToolData>
    {
        ...
        public ToolsGetByResourceGroupAsyncCollectionResultOfT(Tools client, Guid subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
