...
namespace Azure.ResourceManager.Discovery
{
    internal partial class ToolsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ToolData>
    {
        ...
        /// <summary> Initializes a new instance of ToolsGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ToolsGetByResourceGroupAsyncCollectionResultOfT(Tools client, Guid subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ToolsGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
