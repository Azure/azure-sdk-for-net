...
{
    internal partial class ProjectsGetByWorkspaceCollectionResultOfT : Pageable<ProjectData>
    {
        ...
        public ProjectsGetByWorkspaceCollectionResultOfT(Projects client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("ProjectCollection.GetAll");
            scope.Start();
            try
            {
