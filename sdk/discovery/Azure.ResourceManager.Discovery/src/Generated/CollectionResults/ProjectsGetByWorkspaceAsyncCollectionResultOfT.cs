...
namespace Azure.ResourceManager.Discovery
{
    internal partial class ProjectsGetByWorkspaceAsyncCollectionResultOfT : AsyncPageable<ProjectData>
    {
        ...
        /// <summary> Initializes a new instance of ProjectsGetByWorkspaceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ProjectsGetByWorkspaceAsyncCollectionResultOfT(Projects client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ProjectsGetByWorkspaceAsyncCollectionResultOfT as an enumerable collection. </summary>
