...
namespace Azure.ResourceManager.Discovery
{
    internal partial class ProjectsGetByWorkspaceAsyncCollectionResultOfT : AsyncPageable<ProjectData>
    {
        ...
        public ProjectsGetByWorkspaceAsyncCollectionResultOfT(Projects client, Guid subscriptionId, string resourceGroupName, string workspaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
