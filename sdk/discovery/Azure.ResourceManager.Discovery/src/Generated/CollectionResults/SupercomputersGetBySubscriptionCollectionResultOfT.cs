...
namespace Azure.ResourceManager.Discovery
{
    internal partial class SupercomputersGetBySubscriptionCollectionResultOfT : Pageable<SupercomputerData>
    {
        ...
        public SupercomputersGetBySubscriptionCollectionResultOfT(Supercomputers client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
