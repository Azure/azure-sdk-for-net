...
namespace Azure.ResourceManager.Discovery
{
    internal partial class StorageContainersGetBySubscriptionCollectionResultOfT : Pageable<StorageContainerData>
    {
        ...
        /// <summary> Initializes a new instance of StorageContainersGetBySubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The StorageContainers client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public StorageContainersGetBySubscriptionCollectionResultOfT(StorageContainers client, Guid subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of StorageContainersGetBySubscriptionCollectionResultOfT as an enumerable collection. </summary>
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableDiscoverySubscriptionResource.GetStorageContainers");
            scope.Start();
            try
            {
