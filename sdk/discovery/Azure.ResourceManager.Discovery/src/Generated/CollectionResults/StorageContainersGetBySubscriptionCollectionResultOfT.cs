...
namespace Azure.ResourceManager.Discovery
{
    internal partial class StorageContainersGetBySubscriptionCollectionResultOfT : Pageable<StorageContainerData>
    {
        ...
        public StorageContainersGetBySubscriptionCollectionResultOfT(StorageContainers client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
