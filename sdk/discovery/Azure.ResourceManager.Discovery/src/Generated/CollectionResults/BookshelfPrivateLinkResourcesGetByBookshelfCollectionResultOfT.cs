...
{
    internal partial class BookshelfPrivateLinkResourcesGetByBookshelfCollectionResultOfT : Pageable<BookshelfPrivateLinkResourceData>
    {
        private readonly BookshelfPrivateLinkResources _client;
        ...
        /// <returns> The pages of BookshelfPrivateLinkResourcesGetByBookshelfCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<BookshelfPrivateLinkResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                BookshelfPrivateLinkResourceListResult result = BookshelfPrivateLinkResourceListResult.FromResponse(response);
                yield return Page<BookshelfPrivateLinkResourceData>.FromValues((IReadOnlyList<BookshelfPrivateLinkResourceData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
