...
namespace Azure.ResourceManager.Discovery
{
    internal partial class WorkspacesGetBySubscriptionCollectionResultOfT : Pageable<WorkspaceData>
    {
        ...
        public WorkspacesGetBySubscriptionCollectionResultOfT(Workspaces client, Guid subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableDiscoverySubscriptionResource.GetWorkspaces");
            scope.Start();
            try
            {
