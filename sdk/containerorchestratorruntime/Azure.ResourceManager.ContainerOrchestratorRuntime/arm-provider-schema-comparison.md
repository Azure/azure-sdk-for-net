...
#### CRUD operation differences: `/{resourceUri}/providers/Microsoft.KubernetesRuntime/bgpPeers/{bgpPeerName}`
...
#### CRUD operation differences: `/{resourceUri}/providers/Microsoft.KubernetesRuntime/loadBalancers/{loadBalancerName}`
...
| --- | --- | --- |
| `/{resourceUri}/providers/Microsoft.KubernetesRuntime/bgpPeers/{bgpPeerName}` | `ConnectedClusterBgpPeer` | `BgpPeer` |
| `/{resourceUri}/providers/Microsoft.KubernetesRuntime/loadBalancers/{loadBalancerName}` | `ConnectedClusterLoadBalancer` | `LoadBalancer` |
| `/{resourceUri}/providers/Microsoft.KubernetesRuntime/services/{serviceName}` | `ConnectedClusterService` | `ServiceResource` |
| `/{resourceUri}/providers/Microsoft.KubernetesRuntime/storageClasses/{storageClassName}` | `ConnectedClusterStorageClass` | `StorageClassResource` |
