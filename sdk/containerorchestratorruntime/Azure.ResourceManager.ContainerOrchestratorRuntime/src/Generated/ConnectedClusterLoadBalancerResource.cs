...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ConnectedClusterLoadBalancerResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ArmResource"/> using the GetConnectedClusterLoadBalancers method.
    /// </summary>
    public partial class ConnectedClusterLoadBalancerResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ConnectedClusterLoadBalancerResource for mocking. </summary>
        protected ConnectedClusterLoadBalancerResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ConnectedClusterLoadBalancerResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string connectedClusterLoadBalancerApiVersion);
            _loadBalancersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerOrchestratorRuntime", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"{resourceUri}/providers/Microsoft.KubernetesRuntime/loadBalancers/{loadBalancerName}";
        ...
        {
            using DiagnosticScope scope = _loadBalancersClientDiagnostics.CreateScope("ConnectedClusterLoadBalancerResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _loadBalancersRestClient.CreateGetRequest(Id.Parent, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _loadBalancersClientDiagnostics.CreateScope("ConnectedClusterLoadBalancerResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _loadBalancersRestClient.CreateDeleteRequest(Id.Parent, Id.Name, context);
        ...
        public virtual async Task<ArmOperation<ConnectedClusterLoadBalancerResource>> UpdateAsync(WaitUntil waitUntil, ConnectedClusterLoadBalancerData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _loadBalancersClientDiagnostics.CreateScope("ConnectedClusterLoadBalancerResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _loadBalancersRestClient.CreateCreateOrUpdateRequest(Id.Parent, Id.Name, ConnectedClusterLoadBalancerData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
