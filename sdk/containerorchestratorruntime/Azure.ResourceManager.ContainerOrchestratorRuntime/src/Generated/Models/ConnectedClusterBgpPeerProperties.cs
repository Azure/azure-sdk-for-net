...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime.Models
{
    ...
    public partial class ConnectedClusterBgpPeerProperties
    {
        ...
        internal ConnectedClusterBgpPeerProperties(int myAsn, int peerAsn, string peerAddress, ContainerOrchestratorProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MyAsn = myAsn;
            PeerAsn = peerAsn;
            PeerAddress = peerAddress;
