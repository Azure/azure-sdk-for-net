...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime.Models
{
    ...
    internal partial class LoadBalancerListResult
    {
        ...
        internal LoadBalancerListResult(IList<ConnectedClusterLoadBalancerData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ConnectedClusterLoadBalancerData> Value { get; }
