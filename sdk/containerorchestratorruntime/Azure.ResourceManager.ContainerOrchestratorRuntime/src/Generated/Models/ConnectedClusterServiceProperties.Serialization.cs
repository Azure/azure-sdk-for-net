...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime.Models
{
    ...
    public partial class ConnectedClusterServiceProperties : IJsonModel<ConnectedClusterServiceProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConnectedClusterServiceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConnectedClusterServiceProperties IJsonModel<ConnectedClusterServiceProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ConnectedClusterServiceProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConnectedClusterServiceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ConnectedClusterServiceProperties DeserializeConnectedClusterServiceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("rpObjectId"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rpObjectId = new Guid(prop.Value.GetString());
                    continue;
                }
            ...
            return new ConnectedClusterServiceProperties(rpObjectId, provisioningState, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ConnectedClusterServiceProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConnectedClusterServiceProperties IPersistableModel<ConnectedClusterServiceProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ConnectedClusterServiceProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ConnectedClusterServiceProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
