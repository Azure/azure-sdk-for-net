...
{
    /// <summary>
    /// A class representing the BgpPeer data model.
    /// A BgpPeer resource for an Arc connected cluster (Microsoft.Kubernetes/connectedClusters)
    /// </summary>
    public partial class BgpPeerData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="BgpPeerData"/>. </summary>
        public BgpPeerData()
        {
        }
        ...
        internal BgpPeerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, int? myAsn, int? peerAsn, string peerAddress, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            MyAsn = myAsn;
            PeerAsn = peerAsn;
