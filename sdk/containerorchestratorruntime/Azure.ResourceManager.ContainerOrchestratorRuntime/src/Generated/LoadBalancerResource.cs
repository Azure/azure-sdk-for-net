...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ArmResource"/> using the GetLoadBalancer method.
    /// </summary>
    public partial class LoadBalancerResource : ArmResource
    {
        ...
        {
            _loadBalancerClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ContainerOrchestratorRuntime", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<LoadBalancerResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _loadBalancerRestClient.GetAsync(Id.Parent, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<LoadBalancerResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _loadBalancerRestClient.Get(Id.Parent, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new LoadBalancerResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _loadBalancerRestClient.DeleteAsync(Id.Parent, Id.Name, cancellationToken).ConfigureAwait(false);
                var uri = _loadBalancerRestClient.CreateDeleteRequestUri(Id.Parent, Id.Name);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _loadBalancerRestClient.Delete(Id.Parent, Id.Name, cancellationToken);
                var uri = _loadBalancerRestClient.CreateDeleteRequestUri(Id.Parent, Id.Name);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Delete, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new ContainerOrchestratorRuntimeArmOperation(response, rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<LoadBalancerResource>> UpdateAsync(WaitUntil waitUntil, LoadBalancerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _loadBalancerRestClient.CreateOrUpdateAsync(Id.Parent, Id.Name, data, cancellationToken).ConfigureAwait(false);
                var operation = new ContainerOrchestratorRuntimeArmOperation<LoadBalancerResource>(new LoadBalancerOperationSource(Client), _loadBalancerClientDiagnostics, Pipeline, _loadBalancerRestClient.CreateCreateOrUpdateRequest(Id.Parent, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<LoadBalancerResource> Update(WaitUntil waitUntil, LoadBalancerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _loadBalancerRestClient.CreateOrUpdate(Id.Parent, Id.Name, data, cancellationToken);
                var operation = new ContainerOrchestratorRuntimeArmOperation<LoadBalancerResource>(new LoadBalancerOperationSource(Client), _loadBalancerClientDiagnostics, Pipeline, _loadBalancerRestClient.CreateCreateOrUpdateRequest(Id.Parent, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
