...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime
{
    ...
    public partial class ConnectedClusterStorageClassData : ResourceData
    {
        ...
        internal ConnectedClusterStorageClassData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ConnectedClusterStorageClassProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
