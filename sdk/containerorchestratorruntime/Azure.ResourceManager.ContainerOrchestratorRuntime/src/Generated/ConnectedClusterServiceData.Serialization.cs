...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime
{
    ...
    public partial class ConnectedClusterServiceData : ResourceData, IJsonModel<ConnectedClusterServiceData>
    {
        ...
        internal static RequestContent ToRequestContent(ConnectedClusterServiceData connectedClusterServiceData)
        {
            ...
            return RequestContent.Create(connectedClusterServiceData, ModelSerializationExtensions.WireOptions);
        }
        ...
        internal static ConnectedClusterServiceData FromResponse(Response response)
        {
            ...
            return DeserializeConnectedClusterServiceData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConnectedClusterServiceData IJsonModel<ConnectedClusterServiceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ConnectedClusterServiceData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ConnectedClusterServiceData DeserializeConnectedClusterServiceData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ConnectedClusterServiceProperties.DeserializeConnectedClusterServiceProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
