...
{
    public partial class StorageClassResourceData : IUtf8JsonSerializable, IJsonModel<StorageClassResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageClassResourceData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<StorageClassResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StorageClassResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageClassResourceData)} does not support writing '{format}' format.");
            }
        ...
        StorageClassResourceData IJsonModel<StorageClassResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StorageClassResourceData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageClassResourceData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeStorageClassResourceData(document.RootElement, options);
        }

        internal static StorageClassResourceData DeserializeStorageClassResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<StorageClassResourceData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StorageClassResourceData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StorageClassResourceData)} does not support writing '{options.Format}' format.");
            }
        }

        StorageClassResourceData IPersistableModel<StorageClassResourceData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StorageClassResourceData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StorageClassResourceData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<StorageClassResourceData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
