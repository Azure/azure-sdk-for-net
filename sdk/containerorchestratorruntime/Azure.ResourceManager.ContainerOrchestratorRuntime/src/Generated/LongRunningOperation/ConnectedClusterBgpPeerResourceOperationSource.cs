...
{
    /// <summary></summary>
    internal partial class ConnectedClusterBgpPeerResourceOperationSource : IOperationSource<ConnectedClusterBgpPeerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ConnectedClusterBgpPeerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
