...
{
    /// <summary></summary>
    internal partial class ConnectedClusterLoadBalancerResourceOperationSource : IOperationSource<ConnectedClusterLoadBalancerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ConnectedClusterLoadBalancerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
