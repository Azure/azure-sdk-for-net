...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime
{
    internal partial class ContainerOrchestratorRuntimeArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ContainerOrchestratorRuntimeArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
