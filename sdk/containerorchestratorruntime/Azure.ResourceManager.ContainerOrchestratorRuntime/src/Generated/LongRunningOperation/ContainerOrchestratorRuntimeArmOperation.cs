...
#pragma warning disable SA1649 // File name should match first type name
    internal class ContainerOrchestratorRuntimeArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ContainerOrchestratorRuntimeArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ContainerOrchestratorRuntimeArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ContainerOrchestratorRuntimeArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
