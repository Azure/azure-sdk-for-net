...
{
    /// <summary></summary>
    internal partial class ConnectedClusterStorageClassResourceOperationSource : IOperationSource<ConnectedClusterStorageClassResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ConnectedClusterStorageClassResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
