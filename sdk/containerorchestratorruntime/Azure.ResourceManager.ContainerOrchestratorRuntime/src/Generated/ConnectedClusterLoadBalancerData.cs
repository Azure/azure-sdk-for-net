...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime
{
    ...
    public partial class ConnectedClusterLoadBalancerData : ResourceData
    {
        ...
        internal ConnectedClusterLoadBalancerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ConnectedClusterLoadBalancerProperties properties) : base(id, name, resourceType, systemData)
        {
