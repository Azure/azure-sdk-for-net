...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime
{
    internal partial class ServicesGetAllCollectionResultOfT : Pageable<ConnectedClusterServiceData>
    {
        ...
        public ServicesGetAllCollectionResultOfT(Services client, string resourceUri, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
