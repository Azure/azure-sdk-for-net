...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime
{
    internal partial class ServicesGetAllAsyncCollectionResultOfT : AsyncPageable<ConnectedClusterServiceData>
    {
        ...
        public ServicesGetAllAsyncCollectionResultOfT(Services client, string resourceUri, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
