...
rename-mapping:
  ...
  AdvertiseMode.ARP: Arp
  AdvertiseMode.BGP: Bgp
  BgpPeer: ConnectedClusterBgpPeer
  LoadBalancer: ConnectedClusterLoadBalancer
  ServiceResource: ConnectedClusterService
  ServiceResource.properties.rpObjectId: -|uuid
  StorageClassResource: ConnectedClusterStorageClass
  ProvisioningState: ContainerOrchestratorProvisioningState
  SCType: StorageClassType
  SCType.RWX: Rwx
  SCType.NFS: Nfs
  SCType.SMB: Smb
