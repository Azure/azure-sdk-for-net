...
namespace Azure.ResourceManager.ContainerOrchestratorRuntime.Models
{
    ...
    {
        public static Azure.ResourceManager.ContainerOrchestratorRuntime.BgpPeerData BgpPeerData(Azure.Core.ResourceIdentifier id = null, string name = null, Azure.Core.ResourceType resourceType = default(Azure.Core.ResourceType), Azure.ResourceManager.Models.SystemData systemData = null, int? myAsn = default(int?), int? peerAsn = default(int?), string peerAddress = null, Azure.ResourceManager.ContainerOrchestratorRuntime.Models.ContainerOrchestratorProvisioningState? provisioningState = default(Azure.ResourceManager.ContainerOrchestratorRuntime.Models.ContainerOrchestratorProvisioningState?)) { throw null; }
