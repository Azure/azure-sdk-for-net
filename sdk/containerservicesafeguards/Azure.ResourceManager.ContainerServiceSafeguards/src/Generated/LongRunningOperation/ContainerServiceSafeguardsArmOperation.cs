...
{
    internal partial class ContainerServiceSafeguardsArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of ContainerServiceSafeguardsArmOperation for mocking. </summary>
        protected ContainerServiceSafeguardsArmOperation()
        {
        }
        ...
        internal ContainerServiceSafeguardsArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ContainerServiceSafeguardsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(
                ...
                clientDiagnostics,
                response,
                "ContainerServiceSafeguardsArmOperation",
                null,
