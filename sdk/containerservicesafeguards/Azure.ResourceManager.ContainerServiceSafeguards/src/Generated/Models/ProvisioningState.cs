...
namespace Azure.ResourceManager.ContainerServiceSafeguards.Models
{
    ...
    public readonly partial struct ProvisioningState : IEquatable<ProvisioningState>
    {
        ...
        /// <summary> The provisioning state of DeploymentSafeguards being created. </summary>
        private const string CreatingValue = "Creating";
        /// <summary> The provisioning state of DeploymentSafeguards being updated. </summary>
        private const string UpdatingValue = "Updating";
        /// <summary> The provisioning state of DeploymentSafeguards being deleted. </summary>
