...
namespace Azure.Storage.Blobs.DataMovement
{
    ...
    public class BlockBlobStorageResourceOptions
    {
        ...
        /// <summary>
        /// When calling for <see cref="BlockBlobStorageResource.WriteStreamToOffsetAsync(long, long, System.IO.Stream, Storage.DataMovement.Models.WriteToOffsetOptions, System.Threading.CancellationToken)"/>
        ///
