...
{
    internal class PartitionedFolderUploader<TServiceSpecificData, TCompleteUploadReturn>
    {
        #region Definitions
        // delegate for getting a partition from a stream based on the selected data management stragegy
        ...
        /// <summary>
        /// The maximum number of simultaneous workers at a time
        /// </summary>
        ...
        public PartitionedFolderUploader(
            Behaviors behaviors,
        ...
        public async Task<Response<TCompleteUploadReturn>> UploadInternal(
            ...
            TServiceSpecificData args,
            IProgress<BlobFolderUploadProgress> progressHandler,
            bool async,
            CancellationToken cancellationToken = default)
        {
            ...
            AggregatingUploadFolderProgress singleProgressHandler = default;
            ...
            {
                // create progress handler to only update the bytes
                if (progressHandler != null)
                {
                    singleProgressHandler = new AggregatingUploadFolderProgress(progressHandler);
                }
            ...
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                    ...
                    cancellationToken).ConfigureAwait(false))
                {
                    ...
                    // Add the block to our thread pool
