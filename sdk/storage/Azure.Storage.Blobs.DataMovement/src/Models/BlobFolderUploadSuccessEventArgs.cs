...
namespace Azure.Storage.Blobs.DataMovement.Models
{
    ...
    /// </summary>
    internal class BlobFolderUploadSuccessEventArgs : StorageTransferEventArgs
    {
        /// <summary>
        ...
        /// e.g <see cref="BlobFolderUploadSuccessEventArgs"/>

        /// <summary>
        /// Initializes a new instance of the <see cref="BlobFolderUploadSuccessEventArgs"/>.
        /// </summary>
        ...
        /// </exception>
        public BlobFolderUploadSuccessEventArgs(
            string transferId,
            string sourcePath,
