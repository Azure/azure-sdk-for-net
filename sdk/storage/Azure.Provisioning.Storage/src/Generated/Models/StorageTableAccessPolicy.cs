...
namespace Azure.Provisioning.Storage
{
    ...
    public partial class StorageTableAccessPolicy : ProvisionableConstruct
    {
        ...
        /// <summary> Creates a new StorageTableAccessPolicy. </summary>
        ...
        /// <summary> Define all the provisionable properties for StorageTableAccessPolicy. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _permission = DefineProperty<string>(nameof(Permission), new string[] { "permission" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Define additional provisionable properties for StorageTableAccessPolicy that are not part of the generated code. </summary>
