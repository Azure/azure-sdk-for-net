...
namespace Azure.Storage.Files.Test
{
    public class FileUriBuilderTests : FileTestBase
    {
        ...
        public void FileUriBuilder_SasTest()
        {
            ...
            Assert.AreEqual(default(AccountSasResourceTypes), fileUriBuilder.Sas.ResourceTypes);
            Assert.AreEqual(default(AccountSasServices), fileUriBuilder.Sas.Services);
