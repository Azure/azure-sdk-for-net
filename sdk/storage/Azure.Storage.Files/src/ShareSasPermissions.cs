...
namespace Azure.Storage.Files
{
    ...
    public struct ShareSasPermissions : IEquatable<ShareSasPermissions>
    {
        ...
        {
            var p = new ShareSasPermissions(); // Clear the flags
            foreach (var c in s)
            {
                switch (c)
                {
        ...
        /// <returns>True if they're equal, false otherwise.</returns>
        public static bool operator ==(ShareSasPermissions left, ShareSasPermissions right) => left.Equals(right);
        ...
        public static bool operator !=(ShareSasPermissions left, ShareSasPermissions right) => !(left == right);
