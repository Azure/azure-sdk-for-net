...
namespace Azure.ResourceManager.Storage.Tests.Samples
{
    public class Sample2_ManagingFileShares
    {
        ...
        public async Task createStorageAccountAndGetFileShareCollection()
        {
            ...
            StorageAccountCreateOperation accountCreateOperation = await accountCollection.CreateOrUpdateAsync(false, accountName, parameters);
        ...
        public async Task CreateOrUpdate()
        {
            ...
            FileShareCreateOperation fileShareCreateOperation = await fileShareCollection.CreateOrUpdateAsync(false, fileShareName, fileShareData);
