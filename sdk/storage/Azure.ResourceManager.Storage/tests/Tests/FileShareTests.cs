...
namespace Azure.ResourceManager.Storage.Tests
{
    public class FileShareTests : StorageManagementTestBase
    {
        ...
        public async Task FileShareAccessPolicy()
        {
            ...
            {
                Id = "testSig1",
                AccessPolicy = new StorageServiceAccessPolicy() { StartOn = start1, ExpiryOn = end1, Permission = "rw" }
            };
            var sig2 = new StorageSignedIdentifier()
            {
                Id = "testSig2",
                AccessPolicy = new StorageServiceAccessPolicy() { StartOn = start2, ExpiryOn = end2, Permission = "rwdl" }
            };
