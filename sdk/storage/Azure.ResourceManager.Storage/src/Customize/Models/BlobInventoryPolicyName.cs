...
// Backward-compat: The old GA SDK exposed BlobInventoryPolicyName as a public extensible enum.
// The new generator no longer emits it (the name is always "default"). This custom type preserves
// the old API surface for binary compatibility.
