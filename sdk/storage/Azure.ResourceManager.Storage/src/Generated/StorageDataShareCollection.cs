...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class StorageDataShareCollection : ArmCollection, IEnumerable<StorageDataShareResource>, IAsyncEnumerable<StorageDataShareResource>
    {
        ...
        internal StorageDataShareCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _dataSharesRestClient = new DataShares(_dataSharesClientDiagnostics, Pipeline, Endpoint, storageDataShareApiVersion ?? "2026-04-01");
        ...
        public virtual AsyncPageable<StorageDataShareResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<StorageDataShareData, StorageDataShareResource>(new DataSharesGetByStorageAccountAsyncCollectionResultOfT(
                _dataSharesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
                context,
                "StorageDataShareCollection.GetAll"), data => new StorageDataShareResource(Client, data));
        }
        ...
        public virtual Pageable<StorageDataShareResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<StorageDataShareData, StorageDataShareResource>(new DataSharesGetByStorageAccountCollectionResultOfT(
                _dataSharesRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
