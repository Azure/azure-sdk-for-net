...
namespace Azure.ResourceManager.Storage
{
    ...
    public class Table : TableOperations
    {
        ...
        internal Table(ResourceOperations options, TableData resource) : base(options, resource.Id)
        {
            Data = resource;
        }

        /// <summary> Gets or sets the TableData. </summary>
        public virtual TableData Data { get; private set; }
    }
}
