...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class StorageAccountManagementPolicyResource : ArmResource
    {
        ...
        internal StorageAccountManagementPolicyResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _managementPoliciesRestClient = new ManagementPolicies(_managementPoliciesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, storageAccountManagementPolicyApiVersion ?? "2025-08-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/managementPolicies/default";
        ...
        public virtual async Task<ArmOperation<StorageAccountManagementPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, StorageAccountManagementPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _managementPoliciesClientDiagnostics.CreateScope("StorageAccountManagementPolicyResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _managementPoliciesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, "default", StorageAccountManagementPolicyData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<StorageAccountManagementPolicyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _managementPoliciesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, "default", context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<StorageAccountManagementPolicyData> response = Response.FromValue(StorageAccountManagementPolicyData.FromResponse(result), result);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _managementPoliciesRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, "default", context);
