...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class TableData : ResourceData
    {
        ...
        internal TableData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string tableName, IList<StorageTableSignedIdentifier> signedIdentifiers, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            TableName = tableName;
