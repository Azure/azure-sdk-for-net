...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class FileShareResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FileShareResource>> UpdateAsync(WaitUntil waitUntil, FileShareData data, string expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _fileSharesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, FileShareData.ToRequestContent(data), expand, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<FileShareData> response = Response.FromValue(FileShareData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<FileShareResource> Update(WaitUntil waitUntil, FileShareData data, string expand = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
