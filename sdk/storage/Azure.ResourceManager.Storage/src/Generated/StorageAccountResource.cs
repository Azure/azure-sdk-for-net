...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class StorageAccountResource : ArmResource
    {
        ...
        public virtual AsyncPageable<StorageTaskReportInstance> GetStorageTaskAssignmentsInstancesReportsAsync(string maxpagesize = null, string filter = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Pageable<StorageTaskReportInstance> GetStorageTaskAssignmentsInstancesReports(string maxpagesize = null, string filter = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _storageTaskAssignmentsInstancesReportRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, maxpagesize, filter);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _storageTaskAssignmentsInstancesReportRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, maxpagesize, filter);
