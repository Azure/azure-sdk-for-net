...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class TableContainer : ResourceContainer
    {
        ...
        internal TableContainer(ResourceOperations parent) : base(parent)
        {
        ...
        private TableRestOperations _restClient => new TableRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);

        /// <summary> Gets the valid resource type for this object. </summary>
        protected override ResourceType ValidResourceType => TableServiceOperations.ResourceType;
        ...
        public virtual TableCreateOperation StartCreateOrUpdate(string tableName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.Create(Id.ResourceGroupName, Id.Name, tableName, cancellationToken);
        ...
        public async virtual Task<TableCreateOperation> StartCreateOrUpdateAsync(string tableName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restClient.CreateAsync(Id.ResourceGroupName, Id.Name, tableName, cancellationToken).ConfigureAwait(false);
                return new TableCreateOperation(Parent, response);
            }
            catch (Exception e)
            {
        ...
        public virtual Response<Table> Get(string tableName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var response = _restClient.Get(Id.ResourceGroupName, Id.Name, tableName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<Table>> GetAsync(string tableName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var response = await _restClient.GetAsync(Id.ResourceGroupName, Id.Name, tableName, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public Pageable<Table> GetAll(CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<Table> GetAllAsync(CancellationToken cancellationToken = default)
        {
        ...
        public Pageable<GenericResourceExpanded> GetAllAsGenericResources(string nameFilter, string expand = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var filters = new ResourceFilterCollection(TableOperations.ResourceType);
