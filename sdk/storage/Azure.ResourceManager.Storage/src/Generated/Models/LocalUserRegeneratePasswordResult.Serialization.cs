...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalUserRegeneratePasswordResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LocalUserRegeneratePasswordResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LocalUserRegeneratePasswordResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocalUserRegeneratePasswordResult>)} interface");
            }
        ...
        string IPersistableModel<LocalUserRegeneratePasswordResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
