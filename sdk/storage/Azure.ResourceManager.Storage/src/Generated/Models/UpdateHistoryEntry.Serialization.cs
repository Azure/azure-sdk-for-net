...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateHistoryEntry>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateHistoryEntry>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateHistoryEntry>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateHistoryEntry>)} interface");
            }
        ...
        string IPersistableModel<UpdateHistoryEntry>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
