...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class StorageAccountEncryptionServices
    {
        ...
        internal StorageAccountEncryptionServices(StorageEncryptionService blob, StorageEncryptionService file, StorageEncryptionService table, StorageEncryptionService queue, Dictionary<string, BinaryData> rawData)
        {
            Blob = blob;
            File = file;
            Table = table;
