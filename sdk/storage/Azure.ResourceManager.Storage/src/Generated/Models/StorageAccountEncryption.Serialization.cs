...
{
    public partial class StorageAccountEncryption : IUtf8JsonSerializable, IJsonModel<StorageAccountEncryption>, IPersistableModel<StorageAccountEncryption>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Services))
            {
                ...
                AppendChildObject(builder, Services, options, 2);
            }
