...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FilesIdentityBasedAuthentication>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FilesIdentityBasedAuthentication>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FilesIdentityBasedAuthentication>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FilesIdentityBasedAuthentication>)} interface");
            }
        ...
        string IPersistableModel<FilesIdentityBasedAuthentication>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
