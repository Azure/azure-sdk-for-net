...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageAccountEncryptionIdentity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageAccountEncryptionIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageAccountEncryptionIdentity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StorageAccountEncryptionIdentity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
