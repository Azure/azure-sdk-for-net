...
namespace Azure.ResourceManager.Storage
{
    public partial class TableServiceData : IUtf8JsonSerializable, IJsonModel<TableServiceData>
    {
        ...
        void IJsonModel<TableServiceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TableServiceData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TableServiceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TableServiceData)} does not support '{options.Format}' format.");
            }
        }
