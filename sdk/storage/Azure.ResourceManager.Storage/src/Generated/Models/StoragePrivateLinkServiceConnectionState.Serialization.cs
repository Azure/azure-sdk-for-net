...
{
    public partial class StoragePrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static StoragePrivateLinkServiceConnectionState DeserializeStoragePrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            Core.Optional<StoragePrivateEndpointServiceConnectionStatus> status = default;
            ...
            return new StoragePrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionRequired.Value);
        }
    }
}
