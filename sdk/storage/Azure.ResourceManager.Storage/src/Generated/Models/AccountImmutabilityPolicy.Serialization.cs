...
{
    public partial class AccountImmutabilityPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AccountImmutabilityPolicy DeserializeAccountImmutabilityPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
