...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AccountImmutabilityPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AccountImmutabilityPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AccountImmutabilityPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AccountImmutabilityPolicy>)} interface");
            }
        ...
        string IPersistableModel<AccountImmutabilityPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
