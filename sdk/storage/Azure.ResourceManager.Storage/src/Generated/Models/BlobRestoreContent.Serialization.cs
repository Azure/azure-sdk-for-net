...
{
    public partial class BlobRestoreContent : IUtf8JsonSerializable, IJsonModel<BlobRestoreContent>, IPersistableModel<BlobRestoreContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TimeToRestore))
            {
                builder.Append("  timetoRestore:");
                builder.AppendLine($" '{TimeToRestore.ToString()}'");
            }
