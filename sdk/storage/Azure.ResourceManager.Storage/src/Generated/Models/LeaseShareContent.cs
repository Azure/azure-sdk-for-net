...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class LeaseShareContent
    {
        ...
        internal LeaseShareContent(LeaseShareAction action, string leaseId, int? breakPeriod, int? leaseDuration, string proposedLeaseId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Action = action;
            LeaseId = leaseId;
