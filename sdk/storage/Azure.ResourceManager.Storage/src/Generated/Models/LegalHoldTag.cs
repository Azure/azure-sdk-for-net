...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class LegalHoldTag
    {
        ...
        internal LegalHoldTag(string tag, DateTimeOffset? timestamp, string objectIdentifier, Guid? tenantId, string upn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tag = tag;
            Timestamp = timestamp;
