...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class StorageSkuRestriction
    {
        ...
        internal StorageSkuRestriction(string restrictionType, IReadOnlyList<string> values, StorageRestrictionReasonCode? reasonCode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
