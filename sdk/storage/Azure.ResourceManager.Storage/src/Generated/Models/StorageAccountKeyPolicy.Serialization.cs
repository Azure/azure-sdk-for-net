...
{
    internal partial class StorageAccountKeyPolicy : IUtf8JsonSerializable, IJsonModel<StorageAccountKeyPolicy>, IPersistableModel<StorageAccountKeyPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KeyExpirationPeriodInDays))
            {
                builder.Append("  keyExpirationPeriodInDays:");
                builder.AppendLine($" '{KeyExpirationPeriodInDays.ToString()}'");
            }
