...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class LeaseContainerContent
    {
        ...
        internal LeaseContainerContent(LeaseContainerAction action, string leaseId, int? breakPeriod, int? leaseDuration, string proposedLeaseId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Action = action;
            LeaseId = leaseId;
