    ...
    public partial class NspAccessRuleProperties : IUtf8JsonSerializable, IJsonModel<NspAccessRuleProperties>
    {
        ...
        internal static NspAccessRuleProperties DeserializeNspAccessRuleProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Resources.Models.SubResource>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(item).ToArray()), options, AzureResourceManagerStorageContext.Default)
#else
                ModelReaderWriter.Read<SubResource>(new BinaryData(Encoding.UTF8.GetBytes(item.GetRawText())), options, AzureResourceManagerStorageContext.Default)
#endif
);
                    }
                    subscriptions = array;
