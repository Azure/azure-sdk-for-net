...
{
    public partial class SmbSetting : IUtf8JsonSerializable, IJsonModel<SmbSetting>, IPersistableModel<SmbSetting>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Multichannel))
            {
                ...
                AppendChildObject(builder, Multichannel, options, 2);
            }
