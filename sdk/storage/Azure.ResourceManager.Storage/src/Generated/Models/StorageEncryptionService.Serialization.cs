...
{
    public partial class StorageEncryptionService : IUtf8JsonSerializable, IJsonModel<StorageEncryptionService>, IPersistableModel<StorageEncryptionService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastEnabledOn))
            {
                ...
                builder.AppendLine($" '{LastEnabledOn.Value.ToString()}'");
            }
