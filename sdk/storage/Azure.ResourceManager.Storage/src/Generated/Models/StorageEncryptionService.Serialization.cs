...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageEncryptionService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageEncryptionService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageEncryptionService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageEncryptionService>)} interface");
            }
        ...
        string IPersistableModel<StorageEncryptionService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
