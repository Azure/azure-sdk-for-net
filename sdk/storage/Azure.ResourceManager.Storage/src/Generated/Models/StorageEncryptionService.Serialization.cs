...
{
    public partial class StorageEncryptionService : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StorageEncryptionService DeserializeStorageEncryptionService(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
