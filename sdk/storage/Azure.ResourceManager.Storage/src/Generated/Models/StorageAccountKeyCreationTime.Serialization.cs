...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageAccountKeyCreationTime>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageAccountKeyCreationTime>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageAccountKeyCreationTime>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageAccountKeyCreationTime>)} interface");
            }
        ...
        string IPersistableModel<StorageAccountKeyCreationTime>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
