...
{
    public partial class StorageAccountKeyCreationTime : IUtf8JsonSerializable, IJsonModel<StorageAccountKeyCreationTime>, IPersistableModel<StorageAccountKeyCreationTime>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  key1:");
                builder.AppendLine($" '{Key1.Value.ToString()}'");
            }

            if (Optional.IsDefined(Key2))
            {
                builder.Append("  key2:");
                builder.AppendLine($" '{Key2.Value.ToString()}'");
            }
