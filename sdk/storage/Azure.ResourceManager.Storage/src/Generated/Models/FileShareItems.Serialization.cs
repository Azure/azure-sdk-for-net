...
{
    internal partial class FileShareItems : IUtf8JsonSerializable, IJsonModel<FileShareItems>, IPersistableModel<FileShareItems>
    {
        ...
        void IJsonModel<FileShareItems>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FileShareItems)} does not support '{format}' format.");
            }
