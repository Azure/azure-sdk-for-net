...
{
    internal partial class StorageAccountGetKeysResult : IUtf8JsonSerializable, IJsonModel<StorageAccountGetKeysResult>, IPersistableModel<StorageAccountGetKeysResult>
    {
        ...
        void IJsonModel<StorageAccountGetKeysResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageAccountGetKeysResult)} does not support '{format}' format.");
            }
