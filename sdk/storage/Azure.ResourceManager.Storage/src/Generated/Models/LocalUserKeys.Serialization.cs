...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalUserKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LocalUserKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LocalUserKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocalUserKeys>)} interface");
            }
        ...
        string IPersistableModel<LocalUserKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
