...
{
    public partial class LastAccessTimeTrackingPolicy : IUtf8JsonSerializable, IJsonModel<LastAccessTimeTrackingPolicy>, IPersistableModel<LastAccessTimeTrackingPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TrackingGranularityInDays))
            {
                ...
                builder.AppendLine($" '{TrackingGranularityInDays.Value.ToString()}'");
            }
