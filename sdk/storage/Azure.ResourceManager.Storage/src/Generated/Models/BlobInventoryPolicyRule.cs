...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class BlobInventoryPolicyRule
    {
        ...
        internal BlobInventoryPolicyRule(bool isEnabled, string name, string destination, BlobInventoryPolicyDefinition definition, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IsEnabled = isEnabled;
            Name = name;
            Destination = destination;
