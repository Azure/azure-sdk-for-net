...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobContainerImmutabilityPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlobContainerImmutabilityPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobContainerImmutabilityPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlobContainerImmutabilityPolicy>)} interface");
            }
        ...
        string IPersistableModel<BlobContainerImmutabilityPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
