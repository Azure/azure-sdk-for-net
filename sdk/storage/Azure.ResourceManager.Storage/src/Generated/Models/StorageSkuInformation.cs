...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class StorageSkuInformation
    {
        ...
        internal StorageSkuInformation(StorageSkuName name, StorageSkuTier? tier, string resourceType, StorageKind? kind, IReadOnlyList<string> locations, IReadOnlyList<StorageSkuCapability> capabilities, IReadOnlyList<StorageSkuRestriction> restrictions, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Tier = tier;
