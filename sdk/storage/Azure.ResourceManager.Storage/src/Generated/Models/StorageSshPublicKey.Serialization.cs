...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageSshPublicKey>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageSshPublicKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageSshPublicKey>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageSshPublicKey>)} interface");
            }
        ...
        string IPersistableModel<StorageSshPublicKey>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
