...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListTableServices>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListTableServices>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListTableServices>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListTableServices>)} interface");
            }
        ...
        string IPersistableModel<ListTableServices>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
