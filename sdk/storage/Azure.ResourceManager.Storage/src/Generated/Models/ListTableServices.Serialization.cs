...
{
    internal partial class ListTableServices : IUtf8JsonSerializable, IJsonModel<ListTableServices>, IPersistableModel<ListTableServices>
    {
        ...
        void IJsonModel<ListTableServices>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListTableServices)} does not support '{format}' format.");
            }
