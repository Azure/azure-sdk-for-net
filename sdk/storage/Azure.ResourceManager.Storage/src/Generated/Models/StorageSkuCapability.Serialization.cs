...
{
    public partial class StorageSkuCapability : IUtf8JsonSerializable, IJsonModel<StorageSkuCapability>, IPersistableModel<StorageSkuCapability>
    {
        ...
        void IJsonModel<StorageSkuCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageSkuCapability)} does not support '{format}' format.");
            }
