...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class StorageAccountVirtualNetworkRule
    {
        ...
        internal StorageAccountVirtualNetworkRule(ResourceIdentifier virtualNetworkResourceId, StorageAccountNetworkRuleAction? action, StorageAccountNetworkRuleState? state, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VirtualNetworkResourceId = virtualNetworkResourceId;
            Action = action;
            State = state;
