...
{
    public partial class LegalHold : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LegalHold DeserializeLegalHold(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
