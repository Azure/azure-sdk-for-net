...
namespace Azure.ResourceManager.Storage
{
    public partial class StorageAccountLocalUserData : IUtf8JsonSerializable, IModelJsonSerializable<StorageAccountLocalUserData>
    {
        ...
        internal static StorageAccountLocalUserData DeserializeStorageAccountLocalUserData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new StorageAccountLocalUserData(id, name, type, systemData.Value, Optional.ToList(permissionScopes), homeDirectory.Value, Optional.ToList(sshAuthorizedKeys), sid.Value, Optional.ToNullable(hasSharedKey), Optional.ToNullable(hasSshKey), Optional.ToNullable(hasSshPassword), rawData);
        }
