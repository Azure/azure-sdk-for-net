...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class StoragePrivateLinkResourceData : ResourceData, IJsonModel<StoragePrivateLinkResourceData>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<StoragePrivateLinkResourceData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StoragePrivateLinkResourceData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        StoragePrivateLinkResourceData IPersistableModel<StoragePrivateLinkResourceData>.Create(BinaryData data, ModelReaderWriterOptions options) => (StoragePrivateLinkResourceData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StoragePrivateLinkResourceData IJsonModel<StoragePrivateLinkResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (StoragePrivateLinkResourceData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StoragePrivateLinkResourceData DeserializeStoragePrivateLinkResourceData(JsonElement element, ModelReaderWriterOptions options)
        {
