...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LegalHoldTag>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LegalHoldTag>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LegalHoldTag>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LegalHoldTag>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
