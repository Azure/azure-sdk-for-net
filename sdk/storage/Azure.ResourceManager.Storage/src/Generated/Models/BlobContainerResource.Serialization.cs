...
namespace Azure.ResourceManager.Storage
{
    public partial class BlobContainerResource : IJsonModel<BlobContainerData>
    {
        ...
        {
            return ModelReaderWriter.Read<BlobContainerData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<BlobContainerData>(data, options);
        }
