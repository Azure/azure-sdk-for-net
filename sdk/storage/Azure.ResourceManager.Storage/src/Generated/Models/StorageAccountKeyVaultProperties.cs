...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class StorageAccountKeyVaultProperties
    {
        ...
        internal StorageAccountKeyVaultProperties(string keyName, string keyVersion, Uri keyVaultUri, string currentVersionedKeyIdentifier, DateTimeOffset? lastKeyRotationTimestamp, DateTimeOffset? currentVersionedKeyExpirationTimestamp, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
