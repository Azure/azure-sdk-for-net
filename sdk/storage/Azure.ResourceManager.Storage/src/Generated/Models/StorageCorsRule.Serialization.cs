...
{
    public partial class StorageCorsRule : IUtf8JsonSerializable, IJsonModel<StorageCorsRule>, IPersistableModel<StorageCorsRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxAgeInSeconds))
            {
                ...
                builder.AppendLine($" '{MaxAgeInSeconds.ToString()}'");
            }
