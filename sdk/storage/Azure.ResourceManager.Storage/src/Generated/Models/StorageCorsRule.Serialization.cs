...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageCorsRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageCorsRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageCorsRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageCorsRule>)} interface");
            }
        ...
        string IPersistableModel<StorageCorsRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
