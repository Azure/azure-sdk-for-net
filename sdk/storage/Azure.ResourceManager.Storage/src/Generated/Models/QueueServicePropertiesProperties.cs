...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    internal partial class QueueServicePropertiesProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="QueueServicePropertiesProperties"/>. </summary>
        ...
        internal QueueServicePropertiesProperties(StorageCorsRules cors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Cors = cors;
