...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class BlobInventoryPolicySchema
    {
        ...
        public BlobInventoryPolicySchema(bool enabled, InventoryRuleType ruleType, IEnumerable<BlobInventoryPolicyRule> rules)
        {
            if (rules == null)
            {
        ...
        /// <param name="ruleType"> The valid value is Inventory. </param>
        /// <param name="rules"> The storage account blob inventory policy rules. The rule is applied when it is enabled. </param>
        internal BlobInventoryPolicySchema(bool enabled, InventoryRuleType ruleType, IList<BlobInventoryPolicyRule> rules)
        {
            Enabled = enabled;
            RuleType = ruleType;
            Rules = rules;
        ...
        public InventoryRuleType RuleType { get; set; }
