...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalUsers>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LocalUsers>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LocalUsers>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocalUsers>)} interface");
            }
        ...
        string IPersistableModel<LocalUsers>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
