...
{
    public partial class TableData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TableData DeserializeTableData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
