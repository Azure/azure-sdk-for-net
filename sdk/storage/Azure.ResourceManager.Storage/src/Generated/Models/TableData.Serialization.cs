...
namespace Azure.ResourceManager.Storage
{
    public partial class TableData : IUtf8JsonSerializable, IModelJsonSerializable<TableData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<TableData>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(SignedIdentifiers))
            {
                ...
                foreach (var item in SignedIdentifiers)
                {
                    ...
                    {
                        ((IModelJsonSerializable<StorageTableSignedIdentifier>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="TableData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="TableData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="TableData"/>. </summary>
