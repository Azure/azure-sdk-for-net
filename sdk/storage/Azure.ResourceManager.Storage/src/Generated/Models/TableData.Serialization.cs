...
namespace Azure.ResourceManager.Storage
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TableData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TableData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TableData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TableData>)} interface");
            }
        ...
        string IPersistableModel<TableData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
