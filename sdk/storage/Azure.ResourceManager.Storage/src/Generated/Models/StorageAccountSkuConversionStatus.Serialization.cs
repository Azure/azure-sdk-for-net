...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageAccountSkuConversionStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageAccountSkuConversionStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageAccountSkuConversionStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageAccountSkuConversionStatus>)} interface");
            }
        ...
        string IPersistableModel<StorageAccountSkuConversionStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
