    ...
    public partial class StorageAccountCreateOrUpdateContent : IUtf8JsonSerializable, IJsonModel<StorageAccountCreateOrUpdateContent>
    {
        ...
        void IJsonModel<StorageAccountCreateOrUpdateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SasPolicy))
            {
                ...
                BinaryData data0 = ModelReaderWriter.Write(SasPolicy, options);
#if NET6_0_OR_GREATER
            ...
            if (Optional.IsDefined(KeyPolicy))
            {
                ...
                BinaryData data0 = ModelReaderWriter.Write(KeyPolicy, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data0);
#else
                using (JsonDocument document = JsonDocument.Parse(data0))
            ...
            if (Optional.IsDefined(CustomDomain))
            {
                ...
                BinaryData data0 = ModelReaderWriter.Write(CustomDomain, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data0);
#else
                using (JsonDocument document = JsonDocument.Parse(data0))
            ...
            if (Optional.IsDefined(AzureFilesIdentityBasedAuthentication))
            {
                ...
                BinaryData data0 = ModelReaderWriter.Write(AzureFilesIdentityBasedAuthentication, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data0);
#else
                using (JsonDocument document = JsonDocument.Parse(data0))
            ...
            if (Optional.IsDefined(RoutingPreference))
            {
                ...
                BinaryData data0 = ModelReaderWriter.Write(RoutingPreference, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data0);
#else
                using (JsonDocument document = JsonDocument.Parse(data0))
            ...
            if (Optional.IsDefined(ImmutableStorageWithVersioning))
            {
                ...
                BinaryData data0 = ModelReaderWriter.Write(ImmutableStorageWithVersioning, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data0);
#else
                using (JsonDocument document = JsonDocument.Parse(data0))
