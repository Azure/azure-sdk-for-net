...
{
    public partial class StoragePrivateEndpointConnectionData : IUtf8JsonSerializable, IJsonModel<StoragePrivateEndpointConnectionData>, IPersistableModel<StoragePrivateEndpointConnectionData>
    {
        ...
        void IJsonModel<StoragePrivateEndpointConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StoragePrivateEndpointConnectionData)} does not support '{format}' format.");
            }
