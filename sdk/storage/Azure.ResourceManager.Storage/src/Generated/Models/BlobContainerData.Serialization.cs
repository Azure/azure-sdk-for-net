...
{
    public partial class BlobContainerData : IUtf8JsonSerializable, IJsonModel<BlobContainerData>, IPersistableModel<BlobContainerData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PublicAccess))
            {
                ...
                builder.AppendLine($" '{PublicAccess.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ImmutabilityPolicy))
            {
                ...
                AppendChildObject(builder, ImmutabilityPolicy, options, 2);
            }

            if (Optional.IsDefined(LegalHold))
            {
                builder.Append("  legalHold:");
                AppendChildObject(builder, LegalHold, options, 2);
            }
            ...
            if (Optional.IsDefined(ImmutableStorageWithVersioning))
            {
                ...
                AppendChildObject(builder, ImmutableStorageWithVersioning, options, 2);
            }
