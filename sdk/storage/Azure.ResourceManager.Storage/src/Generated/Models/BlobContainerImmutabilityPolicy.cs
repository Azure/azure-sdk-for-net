...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class BlobContainerImmutabilityPolicy
    {
        ...
        internal BlobContainerImmutabilityPolicy(ETag? etag, IReadOnlyList<UpdateHistoryEntry> updateHistory, int? immutabilityPeriodSinceCreationInDays, ImmutabilityPolicyState? state, bool? allowProtectedAppendWrites, bool? allowProtectedAppendWritesAll, Dictionary<string, BinaryData> rawData)
        {
            ETag = etag;
