...
namespace Azure.ResourceManager.Storage.Models
{
    internal partial class StorageCorsRules : IUtf8JsonSerializable, IJsonModel<StorageCorsRules>
    {
        ...
        void IJsonModel<StorageCorsRules>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(StorageCorsRules)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StorageCorsRules>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(StorageCorsRules)} does not support '{options.Format}' format.");
            }
        }
