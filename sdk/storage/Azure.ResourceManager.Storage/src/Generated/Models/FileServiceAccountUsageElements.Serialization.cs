...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class FileServiceAccountUsageElements : IJsonModel<FileServiceAccountUsageElements>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual FileServiceAccountUsageElements PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<FileServiceAccountUsageElements>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FileServiceAccountUsageElements>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        FileServiceAccountUsageElements IPersistableModel<FileServiceAccountUsageElements>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FileServiceAccountUsageElements IJsonModel<FileServiceAccountUsageElements>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual FileServiceAccountUsageElements JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<FileServiceAccountUsageElements>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FileServiceAccountUsageElements DeserializeFileServiceAccountUsageElements(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("fileShareCount"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    fileShareCount = prop.Value.GetInt32();
                    continue;
                }
                ...
                if (prop.NameEquals("provisionedBandwidthMiBPerSec"u8))
                {
                    ...
                    provisionedBandwidthMiBPerSec = prop.Value.GetInt32();
                    continue;
                }
                if (options.Format != "W")
                {
