...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LeaseContainerContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LeaseContainerContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LeaseContainerContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LeaseContainerContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LeaseContainerContent)} does not support '{options.Format}' format.");
            }
        }
