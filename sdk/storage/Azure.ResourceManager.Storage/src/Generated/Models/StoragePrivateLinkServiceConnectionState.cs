...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class StoragePrivateLinkServiceConnectionState
    {
        ...
        internal StoragePrivateLinkServiceConnectionState(StoragePrivateEndpointServiceConnectionStatus? status, string description, string actionRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
