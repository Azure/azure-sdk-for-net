...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageSignedIdentifier>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageSignedIdentifier>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageSignedIdentifier>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageSignedIdentifier>)} interface");
            }
        ...
        string IPersistableModel<StorageSignedIdentifier>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
