...
{
    public partial class StorageAccountData : IUtf8JsonSerializable, IJsonModel<StorageAccountData>, IPersistableModel<StorageAccountData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PrimaryEndpoints))
            {
                ...
                AppendChildObject(builder, PrimaryEndpoints, options, 2);
            }
            ...
            if (Optional.IsDefined(StatusOfPrimary))
            {
                ...
                builder.AppendLine($" '{StatusOfPrimary.ToString()}'");
            }

            if (Optional.IsDefined(LastGeoFailoverOn))
            {
                builder.Append("  lastGeoFailoverTime:");
                builder.AppendLine($" '{LastGeoFailoverOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(StatusOfSecondary))
            {
                ...
                builder.AppendLine($" '{StatusOfSecondary.ToString()}'");
            }
            ...
            if (Optional.IsDefined(AzureFilesIdentityBasedAuthentication))
            {
                ...
                AppendChildObject(builder, AzureFilesIdentityBasedAuthentication, options, 2);
            }
            ...
            if (Optional.IsDefined(GeoReplicationStats))
            {
                ...
                AppendChildObject(builder, GeoReplicationStats, options, 2);
            }
            ...
            if (Optional.IsDefined(LargeFileSharesState))
            {
                ...
                builder.AppendLine($" '{LargeFileSharesState.ToString()}'");
            }
            ...
            if (Optional.IsDefined(RoutingPreference))
            {
                ...
                AppendChildObject(builder, RoutingPreference, options, 2);
            }

            if (Optional.IsDefined(BlobRestoreStatus))
            {
                builder.Append("  blobRestoreStatus:");
                AppendChildObject(builder, BlobRestoreStatus, options, 2);
            }
            ...
            if (Optional.IsDefined(AllowedCopyScope))
            {
                ...
                builder.AppendLine($" '{AllowedCopyScope.ToString()}'");
            }

            if (Optional.IsDefined(StorageAccountSkuConversionStatus))
            {
                builder.Append("  storageAccountSkuConversionStatus:");
                AppendChildObject(builder, StorageAccountSkuConversionStatus, options, 2);
            }

            if (Optional.IsDefined(DnsEndpointType))
            {
                builder.Append("  dnsEndpointType:");
                builder.AppendLine($" '{DnsEndpointType.ToString()}'");
            }
