...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class StorageAccountKey
    {
        ...
        internal StorageAccountKey(string keyName, string value, StorageAccountKeyPermission? permissions, DateTimeOffset? createdOn, Dictionary<string, BinaryData> rawData)
        {
            KeyName = keyName;
            Value = value;
