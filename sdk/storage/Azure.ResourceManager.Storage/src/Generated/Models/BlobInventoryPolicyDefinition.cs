...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class BlobInventoryPolicyDefinition
    {
        ...
        internal BlobInventoryPolicyDefinition(BlobInventoryPolicyFilter filters, BlobInventoryPolicyFormat format, BlobInventoryPolicySchedule schedule, BlobInventoryPolicyObjectType objectType, IList<string> schemaFields, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Filters = filters;
            Format = format;
            Schedule = schedule;
