...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListBlobInventoryPolicy>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListBlobInventoryPolicy>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<BlobInventoryPolicyData>)item).Write(writer, options);
                }
        ...
        internal static ListBlobInventoryPolicy DeserializeListBlobInventoryPolicy(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ListBlobInventoryPolicy(value ?? new ChangeTrackingList<BlobInventoryPolicyData>(), serializedAdditionalRawData);
        }
