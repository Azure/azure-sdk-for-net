...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public static partial class ArmStorageModelFactory
    {
        ...
        public static StorageSkuInformation StorageSkuInformation(StorageSkuName name = default, StorageSkuTier? tier = null, string resourceType = null, StorageKind? kind = null, IEnumerable<string> locations = null, IEnumerable<StorageSkuCapability> capabilities = null, IEnumerable<StorageSkuRestriction> restrictions = null)
        {
            ...
            return new StorageSkuInformation(name, tier, resourceType, kind, locations?.ToList(), capabilities?.ToList(), restrictions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageSkuCapability(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageSkuRestriction StorageSkuRestriction(string restrictionType = null, IEnumerable<string> values = null, StorageRestrictionReasonCode? reasonCode = null)
        {
            ...
            return new StorageSkuRestriction(restrictionType, values?.ToList(), reasonCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageAccountNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageAccountNameAvailabilityResult(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageAccountCreateOrUpdateContent StorageAccountCreateOrUpdateContent(StorageSku sku = null, StorageKind kind = default, AzureLocation location = default, ExtendedLocation extendedLocation = null, IDictionary<string, string> tags = null, ManagedServiceIdentity identity = null, AllowedCopyScope? allowedCopyScope = null, StoragePublicNetworkAccess? publicNetworkAccess = null, StorageAccountSasPolicy sasPolicy = null, int? keyExpirationPeriodInDays = null, StorageCustomDomain customDomain = null, StorageAccountEncryption encryption = null, StorageAccountNetworkRuleSet networkRuleSet = null, StorageAccountAccessTier? accessTier = null, FilesIdentityBasedAuthentication azureFilesIdentityBasedAuthentication = null, bool? enableHttpsTrafficOnly = null, bool? isSftpEnabled = null, bool? isLocalUserEnabled = null, bool? isHnsEnabled = null, LargeFileSharesState? largeFileSharesState = null, StorageRoutingPreference routingPreference = null, bool? allowBlobPublicAccess = null, StorageMinimumTlsVersion? minimumTlsVersion = null, bool? allowSharedKeyAccess = null, bool? isNfsV3Enabled = null, bool? allowCrossTenantReplication = null, bool? isDefaultToOAuthAuthentication = null, ImmutableStorageAccount immutableStorageWithVersioning = null, StorageDnsEndpointType? dnsEndpointType = null)
        {
            ...
            return new StorageAccountCreateOrUpdateContent(sku, kind, location, extendedLocation, tags, identity, allowedCopyScope, publicNetworkAccess, sasPolicy, keyExpirationPeriodInDays.HasValue ? new StorageAccountKeyPolicy(keyExpirationPeriodInDays.Value, new Dictionary<string, BinaryData>()) : null, customDomain, encryption, networkRuleSet, accessTier, azureFilesIdentityBasedAuthentication, enableHttpsTrafficOnly, isSftpEnabled, isLocalUserEnabled, isHnsEnabled, largeFileSharesState, routingPreference, allowBlobPublicAccess, minimumTlsVersion, allowSharedKeyAccess, isNfsV3Enabled, allowCrossTenantReplication, isDefaultToOAuthAuthentication, immutableStorageWithVersioning, dnsEndpointType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageSku(name, tier, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageEncryptionService(isEnabled, lastEnabledOn, keyType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageAccountKeyVaultProperties(keyName, keyVersion, keyVaultUri, currentVersionedKeyIdentifier, lastKeyRotationTimestamp, currentVersionedKeyExpirationTimestamp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageAccountEndpoints(blobUri, queueUri, tableUri, fileUri, webUri, dfsUri, microsoftEndpoints, internetEndpoints, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageAccountMicrosoftEndpoints(blobUri, queueUri, tableUri, fileUri, webUri, dfsUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageAccountInternetEndpoints(blobUri, fileUri, webUri, dfsUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageAccountKeyCreationTime(key1, key2, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GeoReplicationStatistics(status, lastSyncOn, canFailover, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StoragePrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BlobRestoreStatus(status, failureReason, restoreId, parameters, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageAccountSkuConversionStatus(skuConversionStatus, targetSkuName, startOn, endOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeletedAccountData(id, name, resourceType, systemData, storageAccountResourceId, location, restoreReference, createdOn, deletedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageAccountKey(keyName, value, permissions, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageUsage(unit, currentValue, limit, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageUsageName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AccountSasContent(services, resourceTypes, permissions, ipAddressOrRange, protocols, sharedAccessStartOn, sharedAccessExpireOn, keyToSign, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GetAccountSasResult(accountSasToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceSasContent(canonicalizedResource, resource, permissions, ipAddressOrRange, protocols, sharedAccessStartOn, sharedAccessExpiryOn, identifier, partitionKeyStart, partitionKeyEnd, rowKeyStart, rowKeyEnd, keyToSign, cacheControl, contentDisposition, contentEncoding, contentLanguage, contentType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GetServiceSasResult(serviceSasToken, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageAccountManagementPolicyData StorageAccountManagementPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? lastModifiedOn = null, IEnumerable<ManagementPolicyRule> rules = null)
        {
            ...
            return new StorageAccountManagementPolicyData(id, name, resourceType, systemData, lastModifiedOn, rules != null ? new ManagementPolicySchema(rules?.ToList(), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BlobInventoryPolicyData(id, name, resourceType, systemData, lastModifiedOn, policySchema, new Dictionary<string, BinaryData>());
        }
        ...
        public static BlobInventoryPolicySchema BlobInventoryPolicySchema(bool isEnabled = default, string destination = null, BlobInventoryRuleType ruleType = default, IEnumerable<BlobInventoryPolicyRule> rules = null)
        {
            ...
            return new BlobInventoryPolicySchema(isEnabled, destination, ruleType, rules?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static StoragePrivateLinkResourceData StoragePrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new StoragePrivateLinkResourceData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ObjectReplicationPolicyData ObjectReplicationPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string policyId = null, DateTimeOffset? enabledOn = null, string sourceAccount = null, string destinationAccount = null, IEnumerable<ObjectReplicationPolicyRule> rules = null)
        {
            ...
            return new ObjectReplicationPolicyData(id, name, resourceType, systemData, policyId, enabledOn, sourceAccount, destinationAccount, rules?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageAccountLocalUserData StorageAccountLocalUserData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<StoragePermissionScope> permissionScopes = null, string homeDirectory = null, IEnumerable<StorageSshPublicKey> sshAuthorizedKeys = null, string sid = null, bool? hasSharedKey = null, bool? hasSshKey = null, bool? hasSshPassword = null)
        {
            ...
            return new StorageAccountLocalUserData(id, name, resourceType, systemData, permissionScopes?.ToList(), homeDirectory, sshAuthorizedKeys?.ToList(), sid, hasSharedKey, hasSshKey, hasSshPassword, new Dictionary<string, BinaryData>());
        }
        ...
        public static LocalUserKeys LocalUserKeys(IEnumerable<StorageSshPublicKey> sshAuthorizedKeys = null, string sharedKey = null)
        {
            ...
            return new LocalUserKeys(sshAuthorizedKeys?.ToList(), sharedKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LocalUserRegeneratePasswordResult(sshPassword, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EncryptionScopeData(id, name, resourceType, systemData, source, state, createdOn, lastModifiedOn, keyVaultProperties, requireInfrastructureEncryption, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EncryptionScopeKeyVaultProperties(keyUri, currentVersionedKeyIdentifier, lastKeyRotationTimestamp, new Dictionary<string, BinaryData>());
        }
        ...
        public static BlobServiceData BlobServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, StorageSku sku = null, IEnumerable<StorageCorsRule> corsRules = null, string defaultServiceVersion = null, DeleteRetentionPolicy deleteRetentionPolicy = null, bool? isVersioningEnabled = null, bool? isAutomaticSnapshotPolicyEnabled = null, BlobServiceChangeFeed changeFeed = null, RestorePolicy restorePolicy = null, DeleteRetentionPolicy containerDeleteRetentionPolicy = null, LastAccessTimeTrackingPolicy lastAccessTimeTrackingPolicy = null)
        {
            ...
            return new BlobServiceData(id, name, resourceType, systemData, sku, corsRules != null ? new StorageCorsRules(corsRules?.ToList(), new Dictionary<string, BinaryData>()) : null, defaultServiceVersion, deleteRetentionPolicy, isVersioningEnabled, isAutomaticSnapshotPolicyEnabled, changeFeed, restorePolicy, containerDeleteRetentionPolicy, lastAccessTimeTrackingPolicy, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RestorePolicy(isEnabled, days, lastEnabledOn, minRestoreOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static BlobContainerData BlobContainerData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string version = null, bool? isDeleted = null, DateTimeOffset? deletedOn = null, int? remainingRetentionDays = null, string defaultEncryptionScope = null, bool? preventEncryptionScopeOverride = null, StoragePublicAccessType? publicAccess = null, DateTimeOffset? lastModifiedOn = null, StorageLeaseStatus? leaseStatus = null, StorageLeaseState? leaseState = null, StorageLeaseDurationType? leaseDuration = null, IDictionary<string, string> metadata = null, BlobContainerImmutabilityPolicy immutabilityPolicy = null, LegalHoldProperties legalHold = null, bool? hasLegalHold = null, bool? hasImmutabilityPolicy = null, ImmutableStorageWithVersioning immutableStorageWithVersioning = null, bool? enableNfsV3RootSquash = null, bool? enableNfsV3AllSquash = null, ETag? etag = null)
        {
            ...
            return new BlobContainerData(id, name, resourceType, systemData, version, isDeleted, deletedOn, remainingRetentionDays, defaultEncryptionScope, preventEncryptionScopeOverride, publicAccess, lastModifiedOn, leaseStatus, leaseState, leaseDuration, metadata, immutabilityPolicy, legalHold, hasLegalHold, hasImmutabilityPolicy, immutableStorageWithVersioning, enableNfsV3RootSquash, enableNfsV3AllSquash, etag, new Dictionary<string, BinaryData>());
        }
        ...
        public static BlobContainerImmutabilityPolicy BlobContainerImmutabilityPolicy(ETag? etag = null, IEnumerable<UpdateHistoryEntry> updateHistory = null, int? immutabilityPeriodSinceCreationInDays = null, ImmutabilityPolicyState? state = null, bool? allowProtectedAppendWrites = null, bool? allowProtectedAppendWritesAll = null)
        {
            ...
            return new BlobContainerImmutabilityPolicy(etag, updateHistory?.ToList(), immutabilityPeriodSinceCreationInDays, state, allowProtectedAppendWrites, allowProtectedAppendWritesAll, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UpdateHistoryEntry(updateType, immutabilityPeriodSinceCreationInDays, timestamp, objectIdentifier, tenantId, upn, allowProtectedAppendWrites, allowProtectedAppendWritesAll, new Dictionary<string, BinaryData>());
        }
        ...
        public static LegalHoldProperties LegalHoldProperties(bool? hasLegalHold = null, IEnumerable<LegalHoldTag> tags = null, ProtectedAppendWritesHistory protectedAppendWritesHistory = null)
        {
            ...
            return new LegalHoldProperties(hasLegalHold, tags?.ToList(), protectedAppendWritesHistory, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LegalHoldTag(tag, timestamp, objectIdentifier, tenantId, upn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProtectedAppendWritesHistory(allowProtectedAppendWritesAll, timestamp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ImmutableStorageWithVersioning(isEnabled, timeStamp, migrationState, new Dictionary<string, BinaryData>());
        }
        ...
        public static LegalHold LegalHold(bool? hasLegalHold = null, IEnumerable<string> tags = null, bool? allowProtectedAppendWritesAll = null)
        {
            ...
            return new LegalHold(hasLegalHold, tags?.ToList(), allowProtectedAppendWritesAll, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ImmutabilityPolicyData(id, name, resourceType, systemData, immutabilityPeriodSinceCreationInDays, state, allowProtectedAppendWrites, allowProtectedAppendWritesAll, etag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LeaseContainerContent(action, leaseId, breakPeriod, leaseDuration, proposedLeaseId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LeaseContainerResponse(leaseId, leaseTimeSeconds, new Dictionary<string, BinaryData>());
        }
        ...
        public static FileServiceData FileServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, StorageSku sku = null, IEnumerable<StorageCorsRule> corsRules = null, DeleteRetentionPolicy shareDeleteRetentionPolicy = null, SmbSetting protocolSmbSetting = null)
        {
            ...
            return new FileServiceData(id, name, resourceType, systemData, sku, corsRules != null ? new StorageCorsRules(corsRules?.ToList(), new Dictionary<string, BinaryData>()) : null, shareDeleteRetentionPolicy, protocolSmbSetting != null ? new ProtocolSettings(protocolSmbSetting, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LeaseShareContent(action, leaseId, breakPeriod, leaseDuration, proposedLeaseId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LeaseShareResponse(leaseId, leaseTimeSeconds, new Dictionary<string, BinaryData>());
        }
        ...
        public static QueueServiceData QueueServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<StorageCorsRule> corsRules = null)
        {
            ...
            return new QueueServiceData(id, name, resourceType, systemData, corsRules != null ? new StorageCorsRules(corsRules?.ToList(), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageQueueData StorageQueueData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> metadata = null, int? approximateMessageCount = null)
        {
            ...
            return new StorageQueueData(id, name, resourceType, systemData, metadata, approximateMessageCount, new Dictionary<string, BinaryData>());
        }
        ...
        public static TableServiceData TableServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<StorageCorsRule> corsRules = null)
        {
            ...
            return new TableServiceData(id, name, resourceType, systemData, corsRules != null ? new StorageCorsRules(corsRules?.ToList(), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static TableData TableData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string tableName = null, IEnumerable<StorageTableSignedIdentifier> signedIdentifiers = null)
        {
            ...
            return new TableData(id, name, resourceType, systemData, tableName, signedIdentifiers?.ToList(), new Dictionary<string, BinaryData>());
        }
    }
}
