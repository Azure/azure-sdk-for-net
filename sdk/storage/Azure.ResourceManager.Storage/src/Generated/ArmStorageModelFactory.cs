...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public static partial class ArmStorageModelFactory
    {
        ...
        {
            return StorageAccountData(id, name, resourceType, systemData, tags, location, provisioningState, primaryEndpoints, primaryLocation, statusOfPrimary, lastGeoFailoverOn, secondaryLocation, statusOfSecondary, createdOn, customDomain, sasPolicy, keyCreationTime, secondaryEndpoints, encryption, accessTier, azureFilesIdentityBasedAuthentication, enableHttpsTrafficOnly, networkRuleSet, isSftpEnabled, isLocalUserEnabled, isExtendedGroupEnabled, isHnsEnabled, geoReplicationStats, isFailoverInProgress, largeFileSharesState, privateEndpointConnections, routingPreference, blobRestoreStatus, allowBlobPublicAccess, minimumTlsVersion, allowSharedKeyAccess, isNfsV3Enabled, allowCrossTenantReplication, isDefaultToOAuthAuthentication, publicNetworkAccess, immutableStorageWithVersioning, allowedCopyScope, storageAccountSkuConversionStatus, dnsEndpointType, isSkuConversionBlocked, isAccountMigrationInProgress, allowSharedKeyAccessForServices: default, dataCollaborationPolicyProperties: default, keyExpirationPeriodInDays, isIPv6EndpointToBePublished, isBlobEnabled, sku, kind, identity, extendedLocation, zones, zonePlacementPolicy);
        }
        ...
        {
            return StorageAccountPatch(sku, tags, identity, customDomain, encryption, sasPolicy, accessTier, azureFilesIdentityBasedAuthentication, enableHttpsTrafficOnly, isSftpEnabled, isLocalUserEnabled, isExtendedGroupEnabled, networkRuleSet, largeFileSharesState, routingPreference, allowBlobPublicAccess, minimumTlsVersion, allowSharedKeyAccess, allowCrossTenantReplication, isDefaultToOAuthAuthentication, publicNetworkAccess, immutableStorageWithVersioning, allowedCopyScope, dnsEndpointType, allowSharedKeyAccessForServices: default, dataCollaborationPolicyProperties: default, keyExpirationPeriodInDays, isIPv6EndpointToBePublished, isBlobEnabled, kind, zones, zonePlacementPolicy);
        }
