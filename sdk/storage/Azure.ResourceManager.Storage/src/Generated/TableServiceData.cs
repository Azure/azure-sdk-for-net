...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class TableServiceData : ResourceData
    {
        ...
        internal TableServiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, StorageCorsRules cors, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Cors = cors;
