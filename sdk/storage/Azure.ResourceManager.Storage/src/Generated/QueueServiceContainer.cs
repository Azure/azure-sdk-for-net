...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class QueueServiceContainer : ResourceContainer
    {
        ...
        internal QueueServiceContainer(ResourceOperations parent) : base(parent)
        {
        ...
        private QueueServicesRestOperations _restClient => new QueueServicesRestOperations(_clientDiagnostics, Pipeline, Id.SubscriptionId, BaseUri);
        ...
        public Pageable<GenericResourceExpanded> GetAllAsGenericResources(string nameFilter, string expand = null, int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var filters = new ResourceFilterCollection(QueueServiceOperations.ResourceType);
