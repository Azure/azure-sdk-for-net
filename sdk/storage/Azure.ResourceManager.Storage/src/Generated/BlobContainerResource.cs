...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class BlobContainerResource : ArmResource
    {
        ...
        internal BlobContainerResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _blobContainersRestClient = new BlobContainers(_blobContainersClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, blobContainerApiVersion ?? "2025-08-01");
        ...
        public virtual async Task<ArmOperation<BlobContainerResource>> UpdateAsync(WaitUntil waitUntil, BlobContainerData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _blobContainersRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, BlobContainerData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BlobContainerData> response = Response.FromValue(BlobContainerData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
                RehydrationToken rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                StorageArmOperation<BlobContainerResource> operation = new StorageArmOperation<BlobContainerResource>(Response.FromValue(new BlobContainerResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<BlobContainerResource> Update(WaitUntil waitUntil, BlobContainerData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
