...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class QueueServiceData : ResourceData
    {
        ...
        internal QueueServiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, StorageCorsRules cors, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Cors = cors;
            _rawData = rawData;
        }
