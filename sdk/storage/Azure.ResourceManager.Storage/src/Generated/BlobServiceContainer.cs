...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class BlobServiceContainer : ResourceContainer
    {
        ...
        internal BlobServiceContainer(ResourceOperations parent) : base(parent)
        {
        ...
        public Pageable<BlobService> GetAll(CancellationToken cancellationToken = default)
        {
        ...
        public AsyncPageable<BlobService> GetAllAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Filters the list of <see cref="BlobService" /> for this resource group represented as generic resources. </summary>
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("BlobServiceContainer.GetAllAsGenericResources");
            scope.Start();
            try
            {
