...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class FileShare : ArmResource
    {
        ...
        public async virtual Task<Response<FileShare>> GetAsync(string expand = null, string xMsSnapshot = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _fileSharesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, expand, xMsSnapshot, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<FileShare> Get(string expand = null, string xMsSnapshot = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fileSharesRestClient.Get(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, expand, xMsSnapshot, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<FileShareDeleteOperation> DeleteAsync(string xMsSnapshot = null, string include = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _fileSharesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, xMsSnapshot, include, cancellationToken).ConfigureAwait(false);
        ...
        public virtual FileShareDeleteOperation Delete(string xMsSnapshot = null, string include = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fileSharesRestClient.Delete(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, xMsSnapshot, include, cancellationToken);
                var operation = new FileShareDeleteOperation(response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<FileShare>> UpdateAsync(FileShareData fileShare, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _fileSharesRestClient.UpdateAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, fileShare, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new FileShare(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<FileShare> Update(FileShareData fileShare, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fileSharesRestClient.Update(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, fileShare, cancellationToken);
                return Response.FromValue(new FileShare(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<Response> RestoreAsync(DeletedShare deletedShare, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _fileSharesRestClient.RestoreAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, deletedShare, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response Restore(DeletedShare deletedShare, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fileSharesRestClient.Restore(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, deletedShare, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<Response<LeaseShareResponse>> LeaseAsync(string xMsSnapshot = null, LeaseShareRequest parameters = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _fileSharesRestClient.LeaseAsync(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, xMsSnapshot, parameters, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<LeaseShareResponse> Lease(string xMsSnapshot = null, LeaseShareRequest parameters = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fileSharesRestClient.Lease(Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, xMsSnapshot, parameters, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
