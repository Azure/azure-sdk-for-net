...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class QueueServiceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<QueueServiceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, QueueServiceData parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual ArmOperation<QueueServiceResource> CreateOrUpdate(WaitUntil waitUntil, QueueServiceData parameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
