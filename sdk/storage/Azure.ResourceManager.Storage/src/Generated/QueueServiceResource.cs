...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class QueueServiceResource : ArmResource
    {
        ...
        public virtual AsyncPageable<ListQueue> GetAllAsync(string maxpagesize = default, string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ListQueue"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ListQueue> GetAll(string maxpagesize = default, string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
