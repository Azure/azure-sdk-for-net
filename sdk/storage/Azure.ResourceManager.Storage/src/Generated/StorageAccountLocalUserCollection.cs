...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class StorageAccountLocalUserCollection : ArmCollection, IEnumerable<StorageAccountLocalUserResource>, IAsyncEnumerable<StorageAccountLocalUserResource>
    {
        ...
        /// <summary> Initializes a new instance of StorageAccountLocalUserCollection for mocking. </summary>
        protected StorageAccountLocalUserCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="StorageAccountLocalUserCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(StorageAccountLocalUserResource.ResourceType, out string storageAccountLocalUserApiVersion);
            _localUsersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Storage", StorageAccountLocalUserResource.ResourceType.Namespace, Diagnostics);
            _localUsersRestClient = new LocalUsers(_localUsersClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, storageAccountLocalUserApiVersion ?? "2025-08-01");
        ...
        public virtual async Task<ArmOperation<StorageAccountLocalUserResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string username, StorageAccountLocalUserData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _localUsersClientDiagnostics.CreateScope("StorageAccountLocalUserCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _localUsersRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, username, StorageAccountLocalUserData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<StorageAccountLocalUserResource>> GetAsync(string username, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _localUsersClientDiagnostics.CreateScope("StorageAccountLocalUserCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _localUsersRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, username, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<StorageAccountLocalUserData> response = Response.FromValue(StorageAccountLocalUserData.FromResponse(result), result);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> LocalUserOperationGroup_List. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-08-01. </description>
        ...
        public virtual AsyncPageable<StorageAccountLocalUserResource> GetAllAsync(int? maxpagesize = default, string filter = default, ListLocalUserIncludeParam? include = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="StorageAccountLocalUserResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<StorageAccountLocalUserResource> GetAll(int? maxpagesize = default, string filter = default, ListLocalUserIncludeParam? include = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string username, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _localUsersClientDiagnostics.CreateScope("StorageAccountLocalUserCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<StorageAccountLocalUserData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(StorageAccountLocalUserData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((StorageAccountLocalUserData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<StorageAccountLocalUserResource>> GetIfExistsAsync(string username, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _localUsersClientDiagnostics.CreateScope("StorageAccountLocalUserCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
