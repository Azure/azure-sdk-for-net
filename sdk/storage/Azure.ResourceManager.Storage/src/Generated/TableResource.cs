    ...
    public partial class TableResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<TableResource>> UpdateAsync(WaitUntil waitUntil, TableData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _tableRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Name, TableData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<TableData> response = Response.FromValue(TableData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
