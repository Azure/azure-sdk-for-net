...
namespace Azure.ResourceManager.Storage
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="BlobInventoryPolicyResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    ...
    public partial class BlobInventoryPolicyResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of BlobInventoryPolicyResource for mocking. </summary>
        protected BlobInventoryPolicyResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="BlobInventoryPolicyResource"/> class. </summary>
        ...
        internal BlobInventoryPolicyResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _blobInventoryPoliciesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Storage", ResourceType.Namespace, Diagnostics);
            _blobInventoryPoliciesRestClient = new BlobInventoryPolicies(_blobInventoryPoliciesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, blobInventoryPolicyApiVersion ?? "2025-08-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/inventoryPolicies/default";
        ...
        public virtual async Task<ArmOperation<BlobInventoryPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, BlobInventoryPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _blobInventoryPoliciesClientDiagnostics.CreateScope("BlobInventoryPolicyResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _blobInventoryPoliciesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, "default", BlobInventoryPolicyData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _blobInventoryPoliciesClientDiagnostics.CreateScope("BlobInventoryPolicyResource.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _blobInventoryPoliciesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, "default", context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BlobInventoryPolicyData> response = Response.FromValue(BlobInventoryPolicyData.FromResponse(result), result);
        ...
        {
            using DiagnosticScope scope = _blobInventoryPoliciesClientDiagnostics.CreateScope("BlobInventoryPolicyResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _blobInventoryPoliciesRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, "default", context);
