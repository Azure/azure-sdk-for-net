...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class StorageConnectorCollection : ArmCollection, IEnumerable<StorageConnectorResource>, IAsyncEnumerable<StorageConnectorResource>
    {
        ...
        internal StorageConnectorCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _connectorsRestClient = new Connectors(_connectorsClientDiagnostics, Pipeline, Endpoint, storageConnectorApiVersion ?? "2026-04-01");
        ...
        public virtual AsyncPageable<StorageConnectorResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<StorageConnectorData, StorageConnectorResource>(new ConnectorsGetByStorageAccountAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "StorageConnectorCollection.GetAll"), data => new StorageConnectorResource(Client, data));
        }
