...
{
    /// <summary> A Class representing a TableServiceResource along with the instance operations that can be performed on it. </summary>
    public partial class TableServiceResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<TableServiceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, TableServiceData parameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual ArmOperation<TableServiceResource> CreateOrUpdate(WaitUntil waitUntil, TableServiceData parameters, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
