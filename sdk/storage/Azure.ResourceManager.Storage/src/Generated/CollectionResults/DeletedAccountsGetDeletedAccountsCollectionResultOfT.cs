...
{
    internal partial class DeletedAccountsGetDeletedAccountsCollectionResultOfT : Pageable<DeletedAccountData>
    {
        ...
        public DeletedAccountsGetDeletedAccountsCollectionResultOfT(DeletedAccounts client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<DeletedAccountData>> AsPages(string continuationToken, int? pageSizeHint)
        {
