...
{
    internal partial class QueueServicesListAsyncCollectionResultOfT : AsyncPageable<StorageQueueData>
    {
        ...
        /// <summary> Initializes a new instance of QueueServicesListAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public QueueServicesListAsyncCollectionResultOfT(QueueServices client, Guid subscriptionId, string resourceGroupName, string accountName, string maxpagesize, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of QueueServicesListAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of QueueServicesListAsyncCollectionResultOfT as an enumerable collection. </returns>
