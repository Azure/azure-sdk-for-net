...
{
    internal partial class QueueGetAllAsyncCollectionResultOfT : AsyncPageable<ListQueue>
    {
        ...
        /// <summary> Initializes a new instance of QueueGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public QueueGetAllAsyncCollectionResultOfT(Queue client, Guid subscriptionId, string resourceGroupName, string accountName, string maxpagesize, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of QueueGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of QueueGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
