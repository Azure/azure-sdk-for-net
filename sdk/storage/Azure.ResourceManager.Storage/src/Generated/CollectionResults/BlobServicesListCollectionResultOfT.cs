...
namespace Azure.ResourceManager.Storage
{
    internal partial class BlobServicesListCollectionResultOfT : Pageable<BlobContainerData>
    {
        ...
        /// <summary> Initializes a new instance of BlobServicesListCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The BlobServices client used to send requests. </param>
        ...
        public BlobServicesListCollectionResultOfT(BlobServices client, Guid subscriptionId, string resourceGroupName, string accountName, string maxpagesize, string filter, string include, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BlobServicesListCollectionResultOfT as an enumerable collection. </summary>
