...
{
    internal partial class QueueServicesGetAllAsyncCollectionResultOfT : AsyncPageable<ListQueue>
    {
        ...
        public override async IAsyncEnumerable<Page<ListQueue>> AsPages(string continuationToken, int? pageSizeHint)
        {
