...
namespace Azure.ResourceManager.Storage
{
    internal partial class QueueServicesGetAllAsyncCollectionResultOfT : AsyncPageable<StorageQueueData>
    {
        ...
        public QueueServicesGetAllAsyncCollectionResultOfT(QueueServices client, Guid subscriptionId, string resourceGroupName, string accountName, string maxpagesize, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
