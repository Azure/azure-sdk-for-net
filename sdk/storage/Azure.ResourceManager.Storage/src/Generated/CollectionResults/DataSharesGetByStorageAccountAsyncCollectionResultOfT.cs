...
namespace Azure.ResourceManager.Storage
{
    internal partial class DataSharesGetByStorageAccountAsyncCollectionResultOfT : AsyncPageable<StorageDataShareData>
    {
        ...
        /// <summary> Initializes a new instance of DataSharesGetByStorageAccountAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DataSharesGetByStorageAccountAsyncCollectionResultOfT(DataShares client, Guid subscriptionId, string resourceGroupName, string accountName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DataSharesGetByStorageAccountAsyncCollectionResultOfT as an enumerable collection. </summary>
