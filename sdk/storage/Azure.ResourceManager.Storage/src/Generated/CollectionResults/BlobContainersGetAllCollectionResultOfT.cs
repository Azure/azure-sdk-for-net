...
{
    internal partial class BlobContainersGetAllCollectionResultOfT : Pageable<ListContainerItem>
    {
        ...
        /// <summary> Initializes a new instance of BlobContainersGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public BlobContainersGetAllCollectionResultOfT(BlobContainers client, Guid subscriptionId, string resourceGroupName, string accountName, string maxpagesize, string filter, string include, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of BlobContainersGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of BlobContainersGetAllCollectionResultOfT as an enumerable collection. </returns>
