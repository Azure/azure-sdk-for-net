...
{
    internal partial class DeletedAccountsGetDeletedAccountsAsyncCollectionResultOfT : AsyncPageable<DeletedAccountData>
    {
        ...
        public DeletedAccountsGetDeletedAccountsAsyncCollectionResultOfT(DeletedAccounts client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<DeletedAccountData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                DeletedAccountListResult result = DeletedAccountListResult.FromResponse(response);
                yield return Page<DeletedAccountData>.FromValues((IReadOnlyList<DeletedAccountData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
