...
namespace Azure.ResourceManager.Storage
{
    internal partial class NetworkSecurityPerimeterConfigurationsGetAllCollectionResultOfT : Pageable<NetworkSecurityPerimeterConfigurationData>
    {
        ...
        public NetworkSecurityPerimeterConfigurationsGetAllCollectionResultOfT(NetworkSecurityPerimeterConfigurations client, Guid subscriptionId, string resourceGroupName, string accountName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
