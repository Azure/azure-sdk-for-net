...
{
    /// <summary></summary>
    internal partial class StorageConnectorResourceOperationSource : IOperationSource<StorageConnectorResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StorageConnectorResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
