...
{
    /// <summary></summary>
    internal partial class StorageDataShareResourceOperationSource : IOperationSource<StorageDataShareResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StorageDataShareResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
