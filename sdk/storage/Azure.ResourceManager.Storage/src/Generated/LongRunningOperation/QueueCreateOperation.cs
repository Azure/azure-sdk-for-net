...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class QueueCreateOperation : Operation<StorageQueue>
    {
        private readonly OperationOrResponseInternals<StorageQueue> _operation;

        /// <summary> Initializes a new instance of QueueCreateOperation for mocking. </summary>
        protected QueueCreateOperation()
        {
        }

        internal QueueCreateOperation(ResourceOperations operationsBase, Response<StorageQueueData> response)
        {
