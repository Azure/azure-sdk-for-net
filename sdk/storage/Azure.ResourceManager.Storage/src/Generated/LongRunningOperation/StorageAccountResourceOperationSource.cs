...
{
    /// <summary></summary>
    internal partial class StorageAccountResourceOperationSource : IOperationSource<StorageAccountResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StorageAccountResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
