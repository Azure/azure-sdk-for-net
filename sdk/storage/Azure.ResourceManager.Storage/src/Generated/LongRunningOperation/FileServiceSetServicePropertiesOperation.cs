...
namespace Azure.ResourceManager.Storage.Models
{
    ...
    public partial class FileServiceSetServicePropertiesOperation : Operation<FileService>
    {
        private readonly OperationOrResponseInternals<FileService> _operation;

        /// <summary> Initializes a new instance of FileServiceSetServicePropertiesOperation for mocking. </summary>
        protected FileServiceSetServicePropertiesOperation()
        {
        }

        internal FileServiceSetServicePropertiesOperation(ResourceOperations operationsBase, Response<FileServiceData> response)
        {
