...
{
    /// <summary></summary>
    internal partial class StorageTaskAssignmentResourceOperationSource : IOperationSource<StorageTaskAssignmentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StorageTaskAssignmentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        StorageTaskAssignmentResource IOperationSource<StorageTaskAssignmentResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            StorageTaskAssignmentData data = StorageTaskAssignmentData.DeserializeStorageTaskAssignmentData(document.RootElement, ModelSerializationExtensions.WireOptions);
