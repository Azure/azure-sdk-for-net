...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class StorageQueueData : ResourceData
    {
        ...
        internal StorageQueueData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> metadata, int? approximateMessageCount, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Metadata = metadata;
