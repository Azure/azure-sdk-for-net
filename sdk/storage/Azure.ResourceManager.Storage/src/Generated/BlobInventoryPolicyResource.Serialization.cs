...
namespace Azure.ResourceManager.Storage
{
    ...
    {
        private static IJsonModel<BlobInventoryPolicyData> s_dataDeserializationInstance;

        private static IJsonModel<BlobInventoryPolicyData> DataDeserializationInstance => s_dataDeserializationInstance ??= new BlobInventoryPolicyData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BlobInventoryPolicyData IJsonModel<BlobInventoryPolicyData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<BlobInventoryPolicyData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
