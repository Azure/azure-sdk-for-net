...
namespace Azure.ResourceManager.Storage
{
    public partial class BlobInventoryPolicyResource : IJsonModel<BlobInventoryPolicyData>
    {
        ...
        {
            return ModelReaderWriter.Read<BlobInventoryPolicyData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<BlobInventoryPolicyData>(data, options);
        }
