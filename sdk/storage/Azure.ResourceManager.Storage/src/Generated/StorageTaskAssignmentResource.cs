...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class StorageTaskAssignmentResource : ArmResource
    {
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/storageTaskAssignments/{storageTaskAssignmentName}/stopAssignment. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> StorageTaskAssignments_StopAssignment. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-08-01. </description>
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> StopAssignmentAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _storageTaskAssignmentsClientDiagnostics.CreateScope("StorageTaskAssignmentResource.StopAssignment");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation StopAssignment(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _storageTaskAssignmentsClientDiagnostics.CreateScope("StorageTaskAssignmentResource.StopAssignment");
            scope.Start();
            try
        ...
        /// <summary>
        /// Updates the StorageTaskAssignment.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/storageTaskAssignments/{storageTaskAssignmentName}. </description>
        ...
        public virtual async Task<ArmOperation<StorageTaskAssignmentResource>> UpdateAsync(WaitUntil waitUntil, StorageTaskAssignmentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _storageTaskAssignmentsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, StorageTaskAssignmentData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                StorageArmOperation<StorageTaskAssignmentResource> operation = new StorageArmOperation<StorageTaskAssignmentResource>(
                    new StorageTaskAssignmentResourceOperationSource(Client),
                    _storageTaskAssignmentsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<StorageTaskAssignmentResource> Update(WaitUntil waitUntil, StorageTaskAssignmentData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
