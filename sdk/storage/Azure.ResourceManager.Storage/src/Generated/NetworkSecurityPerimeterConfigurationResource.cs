...
namespace Azure.ResourceManager.Storage
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="StorageAccountResource"/> using the GetNetworkSecurityPerimeterConfigurations method.
    /// </summary>
    public partial class NetworkSecurityPerimeterConfigurationResource : ArmResource
    {
        ...
        public static readonly ResourceType ResourceType = "Microsoft.Storage/storageAccounts/networkSecurityPerimeterConfigurations";
        ...
        internal NetworkSecurityPerimeterConfigurationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _networkSecurityPerimeterConfigurationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Storage", ResourceType.Namespace, Diagnostics);
            _networkSecurityPerimeterConfigurationsRestClient = new NetworkSecurityPerimeterConfigurations(_networkSecurityPerimeterConfigurationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, networkSecurityPerimeterConfigurationApiVersion ?? "2025-08-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/networkSecurityPerimeterConfigurations/{networkSecurityPerimeterConfigurationName}";
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/networkSecurityPerimeterConfigurations/{networkSecurityPerimeterConfigurationName}/reconcile. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        ...
        public virtual async Task<ArmOperation> ReconcileAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                StorageArmOperation operation = new StorageArmOperation(_networkSecurityPerimeterConfigurationsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
