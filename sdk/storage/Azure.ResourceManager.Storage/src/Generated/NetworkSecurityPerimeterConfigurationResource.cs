...
namespace Azure.ResourceManager.Storage
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="StorageAccountResource"/> using the GetNetworkSecurityPerimeterConfiguration method.
    /// </summary>
    public partial class NetworkSecurityPerimeterConfigurationResource : ArmResource
    {
        ...
        {
            var resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Storage/storageAccounts/{accountName}/networkSecurityPerimeterConfigurations/{networkSecurityPerimeterConfigurationName}";
        ...
        {
            _networkSecurityPerimeterConfigurationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Storage", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> ReconcileAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new StorageArmOperation(_networkSecurityPerimeterConfigurationClientDiagnostics, Pipeline, _networkSecurityPerimeterConfigurationRestClient.CreateReconcileRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
