    ...
    public partial class EncryptionScopeResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<EncryptionScopeResource>> UpdateAsync(WaitUntil waitUntil, EncryptionScopeData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _encryptionScopesRestClient.CreatePutRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, EncryptionScopeData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<EncryptionScopeData> response = Response.FromValue(EncryptionScopeData.FromResponse(result), result);
