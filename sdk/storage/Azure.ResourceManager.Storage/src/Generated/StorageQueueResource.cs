...
namespace Azure.ResourceManager.Storage
{
    ...
    public partial class StorageQueueResource : ArmResource
    {
        ...
        internal StorageQueueResource(ArmClient client, StorageQueueData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<StorageQueueResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new StorageQueueResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
