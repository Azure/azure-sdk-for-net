...
StorageAccountCreateOrUpdateInfo parameters = new StorageAccountCreateOrUpdateInfo(new StorageSku(StorageSkuName.StandardGRS), StorageKind.Storage, AzureLocation.WestUS);
