...
namespace Azure.ResourceManager.Storage.Samples
{
    public partial class Sample_FileShareResource
    {
        ...
        public async Task Get_GetShareStats()
        {
            ...
            string expand = "stats";
            FileShareResource result = await fileShare.GetAsync(expand);
        ...
        public async Task Delete_DeleteShares()
        {
            ...
            // invoke the operation
            await fileShare.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["type"] = "image"
        ...
        public async Task Restore_RestoreShares()
        {
            ...
            await fileShare.RestoreAsync(deletedShare).ConfigureAwait(false);
        ...
        public async Task Lease_AcquireALeaseOnAShare()
        {
            ...
            LeaseShareResponse result = await fileShare.LeaseAsync(content);
