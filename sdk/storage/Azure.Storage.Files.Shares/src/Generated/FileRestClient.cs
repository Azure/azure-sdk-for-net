...
namespace Azure.Storage.Files.Shares
{
    internal partial class FileRestClient
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/>, <paramref name="url"/>, <paramref name="version"/> or <paramref name="fileRangeWriteFromUrl"/> is null. </exception>
        public FileRestClient(HttpPipeline pipeline, string url, string version = "2021-04-10", string fileRangeWriteFromUrl = "update")
        {
