...
namespace Azure.Storage.Files.Shares
{
    internal partial class FileRestClient
    {
        ...
        /// <param name="version"> Specifies the version of the operation to use for this request. The default is "2023-01-03". </param>
        /// <param name="fileRangeWriteFromUrl"> Only update is supported: - Update: Writes the bytes downloaded from the source url into the specified range. The default is "update". </param>
