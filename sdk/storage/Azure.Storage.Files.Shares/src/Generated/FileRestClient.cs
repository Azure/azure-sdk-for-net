...
namespace Azure.Storage.Files.Shares
{
    internal partial class FileRestClient
    {
        ...
        public FileRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string url, string path, string version = "2020-10-02", string fileRangeWriteFromUrl = "update")
        {
            if (url == null)
            {
