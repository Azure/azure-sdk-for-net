...
namespace Azure.Storage.Files.Shares.Models
{
    ...
    internal partial class DirectoryItem
    {
        ...
        internal DirectoryItem(StringEncoded name, string fileId, FileProperty properties, string attributes, string permissionKey, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            FileId = fileId;
