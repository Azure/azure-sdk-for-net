...
namespace Azure.Storage.Files.Shares.Models
{
    ...
    internal partial class SymLinkItem
    {
        ...
        /// <param name="properties"> File properties. </param>
        /// <param name="linkCount"> The link count of the symbolic link. </param>
        /// <param name="linkText"> The path to the original file, the symbolic link is pointing to. </param>
        ...
        /// <summary> The link count of the symbolic link. </summary>
        public long? LinkCount { get; }

        /// <summary> The path to the original file, the symbolic link is pointing to. </summary>
