...
namespace Azure.Storage.Files.Shares.Models
{
    internal partial class DirectoryItem : IXmlSerializable, IModelSerializable<DirectoryItem>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DirectoryItem>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="DirectoryItem"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DirectoryItem"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DirectoryItem"/>. </summary>
