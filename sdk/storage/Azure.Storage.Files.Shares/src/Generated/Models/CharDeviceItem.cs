...
namespace Azure.Storage.Files.Shares.Models
{
    ...
    internal partial class CharDeviceItem
    {
        ...
        /// <param name="properties"> File properties. </param>
        /// <param name="linkCount"> The link count of the character device. </param>
        /// <param name="deviceMajor"> The major device number of the character device. </param>
        /// <param name="deviceMinor"> The minor device number of the character device. </param>
        ...
        /// <summary> The link count of the character device. </summary>
        public long? LinkCount { get; }

        /// <summary> The major device number of the character device. </summary>
        public long? DeviceMajor { get; }

        /// <summary> The minor device number of the character device. </summary>
