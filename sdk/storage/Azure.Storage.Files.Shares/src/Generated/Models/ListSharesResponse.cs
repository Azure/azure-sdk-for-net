...
namespace Azure.Storage.Files.Shares.Models
{
    ...
    internal partial class ListSharesResponse
    {
        ...
        internal ListSharesResponse(string serviceEndpoint, string prefix, string marker, int? maxResults, IReadOnlyList<ShareItemInternal> shareItems, string nextMarker, Dictionary<string, BinaryData> rawData)
        {
            ServiceEndpoint = serviceEndpoint;
            Prefix = prefix;
            Marker = marker;
