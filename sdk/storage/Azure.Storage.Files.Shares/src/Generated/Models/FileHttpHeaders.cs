...
namespace Azure.Storage.Files.Shares.Models
{
    ...
    internal partial class FileHttpHeaders
    {
        ...
        internal FileHttpHeaders(string fileContentType, string fileContentEncoding, string fileContentLanguage, string fileCacheControl, byte[] fileContentMD5, string fileContentDisposition, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
