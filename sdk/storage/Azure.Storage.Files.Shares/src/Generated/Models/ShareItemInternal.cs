...
namespace Azure.Storage.Files.Shares.Models
{
    ...
    internal partial class ShareItemInternal
    {
        ...
        internal ShareItemInternal(string name, string snapshot, bool? deleted, string version, SharePropertiesInternal properties, IReadOnlyDictionary<string, string> metadata, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Snapshot = snapshot;
            Deleted = deleted;
