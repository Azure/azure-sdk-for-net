...
namespace Azure.Storage.Files.Shares.Models
{
    ...
    public partial class ShareCorsRule
    {
        ...
        internal ShareCorsRule(string allowedOrigins, string allowedMethods, string allowedHeaders, string exposedHeaders, int maxAgeInSeconds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
