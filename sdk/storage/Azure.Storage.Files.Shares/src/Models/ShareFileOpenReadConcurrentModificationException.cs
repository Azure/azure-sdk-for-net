...
namespace Azure.Storage.Files.Shares.Models
{
    ...
    /// </summary>
    [Serializable]
    public class ShareFileOpenReadConcurrentModificationException : Exception, ISerializable
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new instance of <see cref="ShareFileOpenReadConcurrentModificationException"/>.
        /// </summary>
        ...
        public ShareFileOpenReadConcurrentModificationException(
            string message,
            Uri resurceUri,
            ETag expectedETag,
            ETag actualEtag,
        ...
        /// <inheritdoc />
        protected ShareFileOpenReadConcurrentModificationException(SerializationInfo info, StreamingContext streamingContext)
        {
