...
namespace Azure.Storage.Files.Shares.Models
{
    ...
    /// </summary>
    public readonly partial struct ShareAudience : IEquatable<ShareAudience>
    {
        private readonly string _value;

        /// <summary>
        /// Intializes new instance of <see cref="ShareAudience"/>.
        /// </summary>
        /// <param name="value">
        ...
        /// </summary>
        public static ShareAudience DefaultAudience { get; } = new(Constants.DefaultAudience);
        ...
        /// <summary> Determines if two <see cref="ShareAudience"/> values are not the same. </summary>
        public static bool operator !=(ShareAudience left, ShareAudience right) => !left.Equals(right);
        /// <summary> Converts a string to a <see cref="ShareAudience"/>. </summary>
        public static implicit operator ShareAudience(string value) => new ShareAudience(value);

        /// <inheritdoc />
        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object obj) => obj is ShareAudience other && Equals(other);
        /// <inheritdoc />
        public bool Equals(ShareAudience other) => string.Equals(_value, other._value, StringComparison.InvariantCultureIgnoreCase);
