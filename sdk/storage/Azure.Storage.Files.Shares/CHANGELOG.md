...
- Added new overload to ShareFileClient.Upload() taking ShareFileUploadOptions, allowing the customer to specify StorageTransferOptions.MaximumTransferSize.
