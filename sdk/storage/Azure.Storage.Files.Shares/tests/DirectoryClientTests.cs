...
namespace Azure.Storage.Files.Shares.Tests
{
    public class DirectoryClientTests : FileTestBase
    {
        ...
        public async Task GetFilesAndDirectoriesAsync_NFS()
        {
            ...
            Assert.AreEqual(FileType.Regular, fileItem.FileType);
            ...
            Assert.AreEqual(FileType.Directory, dirItem.FileType);
            ...
            Assert.AreEqual(FileType.SymLink, symlinkItem.FileType);
        ...
        public async Task GetFilesAndDirectoriesAsync_NFS_AllItemTypes_Mocked()
        {
            ...
            // Directory
            ShareFileItem dir = items.Single(i => i.FileType == FileType.Directory);
            ...
            List<ShareFileItem> files = items
                .Where(i => !i.IsDirectory && i.FileType == FileType.Regular)
                .OrderBy(i => i.Name)
                .ToList();
            ...
            // SymLink
            ShareFileItem symlink = items.Single(i => i.FileType == FileType.SymLink);
