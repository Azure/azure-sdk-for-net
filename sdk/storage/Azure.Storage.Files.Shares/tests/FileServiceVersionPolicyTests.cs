    ...
    public class FileServiceVersionPolicyTests : FileTestBase
    {
        ...
        public async Task FileCopyTest()
        {
            ...
            await TestHelper.AssertExpectedExceptionAsync<ArgumentException>(
                ...
                e => Assert.AreEqual($"x-ms-file-permission is not supported for {nameof(ShareFileClient)}.{nameof(ShareFileClient.StartCopy)} in service version 2019-02-02", e.Message));

            await TestHelper.AssertExpectedExceptionAsync<ArgumentException>(
                oldVersionFileClient.StartCopyAsync(fileClient.Uri, filePermissionCopyMode: PermissionCopyModeType.Override),
                e => Assert.AreEqual($"x-ms-file-permission-copy-mode is not supported for {nameof(ShareFileClient)}.{nameof(ShareFileClient.StartCopy)} in service version 2019-02-02", e.Message));

            await TestHelper.AssertExpectedExceptionAsync<ArgumentException>(
                oldVersionFileClient.StartCopyAsync(fileClient.Uri, ignoreReadOnly: true),
                e => Assert.AreEqual($"x-ms-file-copy-ignore-read-only is not supported for {nameof(ShareFileClient)}.{nameof(ShareFileClient.StartCopy)} in service version 2019-02-02", e.Message));

            await TestHelper.AssertExpectedExceptionAsync<ArgumentException>(
                oldVersionFileClient.StartCopyAsync(fileClient.Uri, setArchiveAttribute: true),
                e => Assert.AreEqual($"x-ms-file-copy-set-archive is not supported for {nameof(ShareFileClient)}.{nameof(ShareFileClient.StartCopy)} in service version 2019-02-02", e.Message));
            ...
            await TestHelper.AssertExpectedExceptionAsync<ArgumentException>(
                ...
                e => Assert.AreEqual($"x-ms-file-permission-key is not supported for {nameof(ShareFileClient)}.{nameof(ShareFileClient.StartCopy)} in service version 2019-02-02", e.Message));
            ...
            await TestHelper.AssertExpectedExceptionAsync<ArgumentException>(
                oldVersionFileClient.StartCopyAsync(fileClient.Uri, smbProperties: smbProperties),
                e => Assert.AreEqual($"x-ms-file-attributes is not supported for {nameof(ShareFileClient)}.{nameof(ShareFileClient.StartCopy)} in service version 2019-02-02", e.Message));
            ...
            await TestHelper.AssertExpectedExceptionAsync<ArgumentException>(
                oldVersionFileClient.StartCopyAsync(fileClient.Uri, smbProperties: smbProperties),
                e => Assert.AreEqual($"x-ms-file-creation-time is not supported for {nameof(ShareFileClient)}.{nameof(ShareFileClient.StartCopy)} in service version 2019-02-02", e.Message));
            ...
            await TestHelper.AssertExpectedExceptionAsync<ArgumentException>(
                oldVersionFileClient.StartCopyAsync(fileClient.Uri, smbProperties: smbProperties),
                e => Assert.AreEqual($"x-ms-file-last-write-time is not supported for {nameof(ShareFileClient)}.{nameof(ShareFileClient.StartCopy)} in service version 2019-02-02", e.Message));
        }
    }
}
