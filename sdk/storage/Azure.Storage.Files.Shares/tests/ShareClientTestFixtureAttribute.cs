...
namespace Azure.Storage.Files.Shares.Tests
{
    ...
    public class ShareClientTestFixtureAttribute : ClientTestFixtureAttribute
    {
        public ShareClientTestFixtureAttribute(params object[] additionalParameters)
            : base(
                serviceVersions: new object[]
                {
                    ...
                    ShareClientOptions.ServiceVersion.V2026_10_06,
                    ShareClientOptions.ServiceVersion.V2026_12_06,
                    ShareClientOptions.ServiceVersion.V2027_03_07,
                ...
                additionalParameters: additionalParameters)
        {
            ...
            LiveServiceVersions = new object[] { ShareClientOptions.ServiceVersion.V2027_03_07 };
        }
    }
}
