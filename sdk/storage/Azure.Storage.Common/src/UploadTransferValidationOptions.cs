...
namespace Azure.Storage
{
    ...
    public class UploadTransferValidationOptions
    {
        ...
        /// <summary>
        /// Optional. An existing checksum of the data to be uploaded. Not all upload APIs
        /// can use this value, and will throw if one is provided. Please check documentation
        /// on specific APIs for whether this can be used.
        /// </summary>
