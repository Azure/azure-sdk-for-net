...
namespace Azure.Storage.Shared
{
    ...
    /// </summary>
    internal class WindowStream : StreamSlice
    {
        ...
        /// Offset of the stream where this window begins.
        /// </param>
        /// <param name="windowLength">
        /// Maximum size of this window.
        /// </param>
        public WindowStream(Stream stream, long streamLength, long streamPosition, long windowLength)
        {
            InnerStream = stream;
            AbsolutePosition = streamPosition;
            Length = Math.Min(windowLength, streamLength - streamPosition);
        }
