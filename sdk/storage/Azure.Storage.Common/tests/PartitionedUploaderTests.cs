    ...
    public class PartitionedUploaderTests
    {
        ...
        private Mock<PartitionedUploader<object, object>.CreateScope> GetMockCreateScope()
        {
            ...
            mock.Setup(del => del(s_operationName))
                .Returns(new Core.Pipeline.DiagnosticScope("Azure.Storage.Tests", s_operationName, new DiagnosticListener("Azure.Storage.Tests"), DiagnosticScope.ActivityKind.Client, true));
            return mock;
        }
