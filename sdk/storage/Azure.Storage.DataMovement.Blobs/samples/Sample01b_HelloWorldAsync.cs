    ...
    public class Sample01b_HelloWorldAsync : SampleTest
    {
        ...
        public async Task UploadSingle_ConnectionStringAsync()
        {
            ...
            try
            {
                ...
                TransferOperation transferOperation = await transferManager.StartTransferAsync(
                    ...
                    destinationResource: await blobs.FromBlob(destinationBlobUri));
        ...
        public async Task DownloadSingle_SharedKeyAuthAsync()
        {
            ...
            try
            {
                ...
                TransferOperation transferOperation = await transferManager.StartTransferAsync(
                    sourceResource: await blobs.FromBlob(sourceBlobUri),
        ...
        public async Task UploadDirectory_SasAsync()
        {
            ...
            try
            {
                ...
                TransferOperation transferOperation = await transferManager.StartTransferAsync(
                    ...
                    destinationResource: await blobs.FromContainer(
                        blobContainerUri,
        ...
        public async Task DownloadDirectory_EventHandler_ActiveDirectoryAuthAsync()
        {
            ...
            try
            {
                ...
                TransferOperation transferOperation = await transferManager.StartTransferAsync(
                    sourceResource: await blobs.FromContainer(
                        blobContainerUri,
                        new BlobStorageResourceContainerOptions()
                        {
        ...
        public async Task CopySingle_ConnectionStringAsync()
        {
            ...
            try
            {
                ...
                TransferOperation transferOperation = await transferManager.StartTransferAsync(
                    sourceResource: await blobs.FromBlob(sourceBlobUri),
                    destinationResource: await blobs.FromBlob(destinationBlobUri, new AppendBlobStorageResourceOptions()));
                await transferOperation.WaitForCompletionAsync();
                #endregion
