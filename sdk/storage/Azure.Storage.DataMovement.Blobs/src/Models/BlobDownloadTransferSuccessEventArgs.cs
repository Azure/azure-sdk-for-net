...
namespace Azure.Storage.DataMovement.Blobs.Models
{
    ...
    /// </summary>
    public class BlobDownloadTransferSuccessEventArgs : StorageTransferEventArgs
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BlobDownloadTransferSuccessEventArgs"/>.
        /// </summary>
        ...
        /// </exception>
        public BlobDownloadTransferSuccessEventArgs(
            string jobId,
