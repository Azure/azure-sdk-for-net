...
namespace Azure.Storage.DataMovement.Blobs.Models
{
    ...
    /// </summary>
    public class BlobUploadDirectoryTransferSuccessEventArgs : StorageTransferEventArgs
    {
        /// <summary>
        ...
        /// e.g <see cref="BlobUploadTransferSuccessEventArgs"/>

        /// <summary>
        /// Initializes a new instance of the <see cref="BlobUploadDirectoryTransferSuccessEventArgs"/>.
        /// </summary>
