...
namespace Azure.Storage.DataMovement.Blobs.Models
{
    ...
    /// </summary>
    public class BlobCopyTransferSkippedEventArgs : StorageTransferEventArgs
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BlobCopyTransferSkippedEventArgs"/>.
        /// </summary>
        ...
        /// Thrown if <paramref name="sourceUri"/> is empty or null.
        /// </exception>
