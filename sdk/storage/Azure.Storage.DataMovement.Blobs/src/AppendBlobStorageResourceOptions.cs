...
namespace Azure.Storage.DataMovement.Blobs
{
    ...
    public class AppendBlobStorageResourceOptions
    {
        ...
        /// <summary>
        /// When calling <see cref="AppendBlobStorageResource.WriteFromStreamAsync(System.IO.Stream, long, long?, StorageResourceWriteToOffsetOptions, System.Threading.CancellationToken)"/>,
