...
internal class Processor
{
    ...
    /// <summary>The <see cref="BlockBlobConfiguration" /> used to configure the instance of this role.</summary>
    private BlockBlobConfiguration _processorConfiguration;
    ...
    public Processor(TestParameters testParameters,
                     BlockBlobConfiguration processorConfiguration,
                     Metrics metrics)
    {
