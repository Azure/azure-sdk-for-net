...
public static class EnvironmentVariables
{
    ...
    /// </summary>
    ///
    public const string StorageConnectionString = "STRESS_STORAGE_NAMESPACE_CONNECTION_STRING";

    /// <summary>
    ///   The name of the environment variable that holds the name of the Storage Blob Container Name
    ///   for each test.
    /// </summary>
    ///
    public const string StorageBlobContainer = "STRESS_STORAGE_BLOBCONTAINER";
