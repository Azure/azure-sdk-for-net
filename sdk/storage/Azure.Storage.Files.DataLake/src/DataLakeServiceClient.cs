...
namespace Azure.Storage.Files.DataLake
{
    ...
    public class DataLakeServiceClient
    {
        ...
        public virtual Response<DataLakeServiceProperties> GetProperties(
            CancellationToken cancellationToken = default)
        {
            DiagnosticScope scope = ClientDiagnostics.CreateScope($"{nameof(DataLakeServiceClient)}.{nameof(GetProperties)}");
            try
            {
                scope.Start();
        ...
        public virtual Response SetProperties(
            ...
            CancellationToken cancellationToken = default)
        {
            DiagnosticScope scope = ClientDiagnostics.CreateScope($"{nameof(DataLakeServiceClient)}.{nameof(SetProperties)}");
            try
            {
                scope.Start();
