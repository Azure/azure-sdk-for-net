...
namespace Azure.Storage.Files.DataLake
{
    internal partial class FileSystemRestClient
    {
        ...
        internal HttpMessage CreateListBlobHierarchySegmentRequest(string delimiter, string prefix, string marker, int? maxResults, IEnumerable<ListBlobsIncludeItem> include, int? timeout)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<ResponseWithHeaders<ListBlobsHierarchySegmentResponse, FileSystemListBlobHierarchySegmentHeaders>> ListBlobHierarchySegmentAsync(string delimiter, string prefix = null, string marker = null, int? maxResults = null, IEnumerable<ListBlobsIncludeItem> include = null, int? timeout = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateListBlobHierarchySegmentRequest(delimiter, prefix, marker, maxResults, include, timeout);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        internal HttpMessage CreateListBlobHierarchySegmentNextPageRequest(string nextLink, string delimiter, string prefix, string marker, int? maxResults, IEnumerable<ListBlobsIncludeItem> include, int? timeout)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        /// <param name="timeout"> The timeout parameter is expressed in seconds. For more information, see &lt;a href=&quot;https://docs.microsoft.com/en-us/rest/api/storageservices/fileservices/setting-timeouts-for-blob-service-operations&quot;&gt;Setting Timeouts for Blob Service Operations.&lt;/a&gt;. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="nextLink"/> or <paramref name="delimiter"/> is null. </exception>
        public async Task<ResponseWithHeaders<ListBlobsHierarchySegmentResponse, FileSystemListBlobHierarchySegmentHeaders>> ListBlobHierarchySegmentNextPageAsync(string nextLink, string delimiter, string prefix = null, string marker = null, int? maxResults = null, IEnumerable<ListBlobsIncludeItem> include = null, int? timeout = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateListBlobHierarchySegmentNextPageRequest(nextLink, delimiter, prefix, marker, maxResults, include, timeout);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            var headers = new FileSystemListBlobHierarchySegmentHeaders(message.Response);
            switch (message.Response.Status)
            {
