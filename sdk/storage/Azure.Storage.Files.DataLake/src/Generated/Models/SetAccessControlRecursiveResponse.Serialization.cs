...
namespace Azure.Storage.Files.DataLake.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SetAccessControlRecursiveResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SetAccessControlRecursiveResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SetAccessControlRecursiveResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SetAccessControlRecursiveResponse>)} interface");
            }
        ...
        string IPersistableModel<SetAccessControlRecursiveResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
