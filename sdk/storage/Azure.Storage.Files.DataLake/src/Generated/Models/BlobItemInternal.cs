...
namespace Azure.Storage.Files.DataLake.Models
{
    ...
    internal partial class BlobItemInternal
    {
        ...
        internal BlobItemInternal(string name, bool deleted, string snapshot, string versionId, bool? isCurrentVersion, BlobPropertiesInternal properties, string deletionId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Deleted = deleted;
            Snapshot = snapshot;
