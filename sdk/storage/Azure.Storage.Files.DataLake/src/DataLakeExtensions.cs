...
namespace Azure.Storage.Files.DataLake
{
    internal static partial class DataLakeExtensions
    {
        ...
        /// </returns>
        internal static string TryCreateServiceAudience(string accountName = default)
            => string.IsNullOrWhiteSpace(accountName) ? default : $"https://{accountName}.blob.core.windows.net{Constants.DefaultScope}";
    }
}
