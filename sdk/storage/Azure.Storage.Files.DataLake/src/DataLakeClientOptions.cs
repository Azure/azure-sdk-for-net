...
namespace Azure.Storage.Files.DataLake
{
    ...
    /// </summary>
    public partial class DataLakeClientOptions : ClientOptions, ISupportsTenantIdChallenges
    {
        /// <summary>
...
#pragma warning restore CA1707 // Identifiers should not contain underscores
        ...
        internal DataLakeClientOptions(IConfigurationSection section) : base(section, null)
        {
            ...
            {
                CustomerProvidedKey = new DataLakeCustomerProvidedKey(customerProvidedKey);
            }
            ...
            {
                Audience = new DataLakeAudience(audience);
            }
            this.Initialize();
            AddHeadersAndQueryParameters();
        }
