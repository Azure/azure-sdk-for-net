...
<td>Pass in an offset equal to the current file length.  Also note that Gen 2 does not handle concurrency, so in multi-writer scenarios, the customer application needs to coordinate writes to an individial file.</td>
</tr>
<tr>
