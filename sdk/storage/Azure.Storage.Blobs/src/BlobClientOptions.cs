...
#pragma warning restore AZC0010 // ClientOptions constructors should default ServiceVersion to latest supported service version
        ...
        {
            return this.Build(authentication, GeoRedundantSecondaryUri, serviceVersionPolicy: new BlobServiceVersionPolicy());
        }
        ...
        {
            return this.Build(credentials, GeoRedundantSecondaryUri, serviceVersionPolicy: new BlobServiceVersionPolicy());
        }
    }
}
