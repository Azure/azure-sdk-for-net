...
namespace Azure.Storage.Blobs
{
    internal partial class BlockBlobRestClient
    {
        ...
        public BlockBlobRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string url, string containerName, string blob, string version = "2020-10-02")
        {
            if (url == null)
            {
