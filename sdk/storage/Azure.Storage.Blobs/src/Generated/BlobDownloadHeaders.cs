...
namespace Azure.Storage.Blobs
{
    internal partial class BlobDownloadHeaders
    {
        ...
        /// <summary> Indicates the download hint for the blob. </summary>
        public DownloadHint? DownloadHint => _response.Headers.TryGetValue("x-ms-download-hint", out string value) ? new DownloadHint(value) : (DownloadHint?)null;
