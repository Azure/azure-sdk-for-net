...
{
    internal partial class AppendBlobAppendBlockFromUrlHeaders
    {
        ...
        public string BlobAppendOffset => _response.Headers.TryGetValue("x-ms-blob-append-offset", out string value) ? value : null;
