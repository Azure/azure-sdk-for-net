...
namespace Azure.Storage.Blobs
{
    internal partial class BlobGetPropertiesHeaders
    {
        ...
        /// <summary> UTC date/time value generated by the service that indicates the time at which the blob immutability policy with expire. </summary>
        ...
        public string ImmutabilityPolicyMode => _response.Headers.TryGetValue("x-ms-immutability-policy-mode", out string value) ? value : null;
