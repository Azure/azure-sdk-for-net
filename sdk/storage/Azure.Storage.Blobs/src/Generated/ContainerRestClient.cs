...
namespace Azure.Storage.Blobs
{
    internal partial class ContainerRestClient
    {
        ...
        public ContainerRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string url, string version = "2021-04-10")
        {
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> GetPropertiesAsync(int? timeout = null, string leaseId = null, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ContainerClient.GetProperties");
            scope.Start();
            try
            {
        ...
        /// 
        /// </remarks>
        public virtual Response GetProperties(int? timeout = null, string leaseId = null, RequestContext context = null)
        {
            using var scope = ClientDiagnostics.CreateScope("ContainerClient.GetProperties");
            scope.Start();
            try
