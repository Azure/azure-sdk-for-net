...
namespace Azure.Storage.Blobs
{
    internal partial class ContainerRestClient
    {
        ...
        internal HttpMessage CreateAcquireLeaseRequest(int? timeout, long? duration, string proposedLeaseId, DateTimeOffset? ifModifiedSince, DateTimeOffset? ifUnmodifiedSince, RequestContext context)
        {
        ...
        public async Task<ResponseWithHeaders<ContainerAcquireLeaseHeaders>> AcquireLeaseAsync(int? timeout = null, long? duration = null, string proposedLeaseId = null, DateTimeOffset? ifModifiedSince = null, DateTimeOffset? ifUnmodifiedSince = null, CancellationToken cancellationToken = default)
        {
            ...
            Response response = await AcquireLeaseAsync(timeout, duration, proposedLeaseId, ifModifiedSince, ifUnmodifiedSince, context).ConfigureAwait(false);
            var headers = new ContainerAcquireLeaseHeaders(response);
        ...
        {
            RequestContext context = cancellationToken.CanBeCanceled ? new RequestContext { CancellationToken = cancellationToken } : null;
            Response response = AcquireLease(timeout, duration, proposedLeaseId, ifModifiedSince, ifUnmodifiedSince, context);
            var headers = new ContainerAcquireLeaseHeaders(response);
            switch (response.Status)
            {
                case 201:
        ...
        public virtual async Task<Response> AcquireLeaseAsync(int? timeout, long? duration, string proposedLeaseId, DateTimeOffset? ifModifiedSince, DateTimeOffset? ifUnmodifiedSince, RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("ContainerClient.AcquireLease");
            scope.Start();
            try
            {
                using HttpMessage message = CreateAcquireLeaseRequest(timeout, duration, proposedLeaseId, ifModifiedSince, ifUnmodifiedSince, context);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual Response AcquireLease(int? timeout, long? duration, string proposedLeaseId, DateTimeOffset? ifModifiedSince, DateTimeOffset? ifUnmodifiedSince, RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("ContainerClient.AcquireLease");
            scope.Start();
            try
