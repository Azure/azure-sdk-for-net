...
namespace Azure.Storage.Blobs.Models
{
    internal partial class ArrowFieldInternal : IXmlSerializable, IModelSerializable<ArrowFieldInternal>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ArrowFieldInternal>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ArrowFieldInternal"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ArrowFieldInternal"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ArrowFieldInternal"/>. </summary>
