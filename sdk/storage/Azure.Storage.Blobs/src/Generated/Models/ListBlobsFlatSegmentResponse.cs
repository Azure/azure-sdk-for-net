...
namespace Azure.Storage.Blobs.Models
{
    ...
    internal partial class ListBlobsFlatSegmentResponse
    {
        ...
        internal ListBlobsFlatSegmentResponse(string serviceEndpoint, string containerName, string prefix, string marker, int? maxResults, BlobFlatListSegment segment, string nextMarker, Dictionary<string, BinaryData> rawData)
        {
            ServiceEndpoint = serviceEndpoint;
            ContainerName = containerName;
            Prefix = prefix;
