...
namespace Azure.Storage.Blobs.Models
{
    internal partial class ListBlobsFlatSegmentResponse : IXmlSerializable, IPersistableModel<ListBlobsFlatSegmentResponse>
    {
        ...
        internal static ListBlobsFlatSegmentResponse DeserializeListBlobsFlatSegmentResponse(XElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ListBlobsFlatSegmentResponse(serviceEndpoint, containerName, prefix, marker, maxResults, segment, nextMarker, serializedAdditionalRawData: null);
        }

        BinaryData IPersistableModel<ListBlobsFlatSegmentResponse>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ListBlobsFlatSegmentResponse>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ListBlobsFlatSegmentResponse)} does not support '{options.Format}' format.");
            }
        }
