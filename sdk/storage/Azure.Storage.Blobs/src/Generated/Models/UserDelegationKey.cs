...
namespace Azure.Storage.Blobs.Models
{
    ...
    public partial class UserDelegationKey
    {
        ...
        internal UserDelegationKey(string signedObjectId, string signedTenantId, DateTimeOffset signedStartsOn, DateTimeOffset signedExpiresOn, string signedService, string signedVersion, string value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SignedObjectId = signedObjectId;
            SignedTenantId = signedTenantId;
            SignedStartsOn = signedStartsOn;
