...
namespace Azure.Storage.Blobs.Models
{
    internal partial class BlockLookupList : IXmlSerializable, IModelSerializable<BlockLookupList>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<BlockLookupList>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="BlockLookupList"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="BlockLookupList"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="BlockLookupList"/>. </summary>
