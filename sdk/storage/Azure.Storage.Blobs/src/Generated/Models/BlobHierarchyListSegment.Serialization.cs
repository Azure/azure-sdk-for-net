...
{
    internal partial class BlobHierarchyListSegment : IXmlSerializable, IModel<BlobHierarchyListSegment>
    {
        ...
        BinaryData IModel<BlobHierarchyListSegment>.Write(ModelReaderWriterOptions options)
        {
        ...
        BlobHierarchyListSegment IModel<BlobHierarchyListSegment>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        ModelReaderWriterFormat IModel<BlobHierarchyListSegment>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Xml;
    }
}
