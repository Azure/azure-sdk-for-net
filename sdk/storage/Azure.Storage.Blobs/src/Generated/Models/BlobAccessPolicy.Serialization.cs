...
{
    public partial class BlobAccessPolicy : IXmlSerializable, IPersistableModel<BlobAccessPolicy>
    {
        ...
        internal static BlobAccessPolicy DeserializeBlobAccessPolicy(XElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new BlobAccessPolicy(policyStartsOn, policyExpiresOn, permissions, serializedAdditionalRawData: null);
        }

        BinaryData IPersistableModel<BlobAccessPolicy>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BlobAccessPolicy>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BlobAccessPolicy)} does not support '{options.Format}' format.");
            }
        }

        BlobAccessPolicy IPersistableModel<BlobAccessPolicy>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<BlobAccessPolicy>)this).GetFormatFromOptions(options) : options.Format;
