...
namespace Azure.Storage.Blobs.Models
{
    ...
    {
        /// <summary> Initializes a new instance of BlobCorsRule. </summary>
        ...
        public BlobCorsRule(string allowedOrigins, string allowedMethods, string allowedHeaders, string exposedHeaders, int maxAgeInSeconds)
        {
