...
namespace Azure.Storage.Blobs.Models
{
    ...
    public partial class BlobCorsRule
    {
        ...
        internal BlobCorsRule(string allowedOrigins, string allowedMethods, string allowedHeaders, string exposedHeaders, int maxAgeInSeconds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
