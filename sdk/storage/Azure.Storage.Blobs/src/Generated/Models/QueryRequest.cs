...
namespace Azure.Storage.Blobs.Models
{
    ...
    internal partial class QueryRequest
    {
        ...
        internal QueryRequest(string queryType, string expression, QuerySerialization inputSerialization, QuerySerialization outputSerialization, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            QueryType = queryType;
            Expression = expression;
