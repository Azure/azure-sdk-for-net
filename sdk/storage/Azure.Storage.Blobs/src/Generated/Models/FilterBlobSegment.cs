...
namespace Azure.Storage.Blobs.Models
{
    ...
    internal partial class FilterBlobSegment
    {
        ...
        internal FilterBlobSegment(string serviceEndpoint, string @where, IReadOnlyList<FilterBlobItem> blobs, string nextMarker, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ServiceEndpoint = serviceEndpoint;
            Where = @where;
            Blobs = blobs;
