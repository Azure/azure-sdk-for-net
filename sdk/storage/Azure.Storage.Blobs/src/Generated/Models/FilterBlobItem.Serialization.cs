...
namespace Azure.Storage.Blobs.Models
{
    internal partial class FilterBlobItem : IXmlSerializable, IModelSerializable<FilterBlobItem>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<FilterBlobItem>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="FilterBlobItem"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FilterBlobItem"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FilterBlobItem"/>. </summary>
