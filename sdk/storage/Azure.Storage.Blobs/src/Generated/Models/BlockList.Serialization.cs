...
namespace Azure.Storage.Blobs.Models
{
    public partial class BlockList : IXmlSerializable, IModelSerializable<BlockList>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<BlockList>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="BlockList"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="BlockList"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="BlockList"/>. </summary>
