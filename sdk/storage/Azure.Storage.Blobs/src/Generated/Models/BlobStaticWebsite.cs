...
namespace Azure.Storage.Blobs.Models
{
    ...
    public partial class BlobStaticWebsite
    {
        ...
        internal BlobStaticWebsite(bool enabled, string indexDocument, string errorDocument404Path, string defaultIndexDocumentPath, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
