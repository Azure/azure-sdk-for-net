...
namespace Azure.Storage.Blobs.Models
{
    public partial struct BlobBlock : IXmlSerializable, IPersistableModel<BlobBlock>
    {
        ...
        string IPersistableModel<BlobBlock>.GetWireFormat(ModelReaderWriterOptions options) => "X";
        ...
        string IPersistableModel<object>.GetWireFormat(ModelReaderWriterOptions options) => ((IPersistableModel<BlobBlock>)this).GetWireFormat(options);
    }
}
