...
{
    internal partial class BlobTags : IXmlSerializable, IModel<BlobTags>
    {
        ...
        BinaryData IModel<BlobTags>.Write(ModelReaderWriterOptions options)
        {
        ...
        BlobTags IModel<BlobTags>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        ModelReaderWriterFormat IModel<BlobTags>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Xml;
    }
}
