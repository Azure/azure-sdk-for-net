...
namespace Azure.Storage.Blobs.Specialized
{
    ...
    public class PageBlobClient : BlobBaseClient
    {
        ...
        /// <see cref="BlobBaseClient.StartCopyFromUri(Uri, Metadata, AccessTier?, BlobAccessConditions?, BlobAccessConditions?, CancellationToken)"/>
        ...
        /// <see cref="BlobBaseClient.StartCopyFromUriAsync(Uri, Metadata, AccessTier?, BlobAccessConditions?, BlobAccessConditions?, CancellationToken)"/>
        ...
        /// or  <see cref="BlobBaseClient.StartCopyFromUriAsync(Uri, Metadata, AccessTier?, BlobAccessConditions?, BlobAccessConditions?, CancellationToken)"/>
        /// then <see cref="StartCopyIncrementalAsync(Uri, String, PageBlobAccessConditions?, CancellationToken)"/>
        /// on new snapshots will fail.
        ///
        /// The additional storage space consumed by the copied snapshot is
