...
#pragma warning restore AZC0002 // Client method should have cancellationToken as the last optional parameter
        ...
        /// <summary>
        /// The <see cref="StartCopyFromUri(Uri, Metadata, BlobAccessConditions?, BlobAccessConditions?, RehydratePriority?, CancellationToken)"/>
            ...
            using (this.Pipeline.BeginLoggingScope(nameof(BlobBaseClient)))
            {
                ...
                try
                {
                    return await BlobRestClient.Blob.SetTierAsync(
                        ...
                        leaseId: leaseAccessConditions?.LeaseId,
                        async: async,
                        operationName: Constants.Blob.Base.SetTierOperationName,
                        cancellationToken: cancellationToken)
                        .ConfigureAwait(false);
                }
                catch (Exception ex)
