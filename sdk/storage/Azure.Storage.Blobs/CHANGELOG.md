...
- Added ability to retrieve blob versions with BlobServiceClient.FindBlobsByTag(), .FindBlobsByTagAsync(), BlobContainerClient.FindBlobsByTag(), and .FindBlobsByTagAsync().
