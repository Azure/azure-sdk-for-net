...
namespace Azure.Storage.Blobs.Test
{
    public class BlobUriBuilderTests : BlobTestBase
    {
        ...
        public void BlobUriBuilder_RegularUrl_SasTest()
        {
            ...
            Assert.AreEqual(default(AccountSasResourceTypes), blobUriBuilder.Sas.ResourceTypes);
            Assert.AreEqual(default(AccountSasServices), blobUriBuilder.Sas.Services);
