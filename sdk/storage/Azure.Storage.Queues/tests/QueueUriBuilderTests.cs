...
namespace Azure.Storage.Queues.Test
{
    public class QueueUriBuilderTests : QueueTestBase
    {
        ...
        public void QueueUriBuilder_RegularUrl_SasTest()
        {
            ...
            Assert.AreEqual(default(AccountSasResourceTypes), queueUriBuilder.Sas.ResourceTypes);
            Assert.AreEqual(default(AccountSasServices), queueUriBuilder.Sas.Services);
