...
namespace Azure.Storage.Queues.Models
{
    ...
    public partial class QueueCorsRule
    {
        ...
        internal QueueCorsRule(string allowedOrigins, string allowedMethods, string allowedHeaders, string exposedHeaders, int maxAgeInSeconds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
