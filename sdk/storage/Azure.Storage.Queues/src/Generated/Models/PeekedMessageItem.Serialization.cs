...
namespace Azure.Storage.Queues.Models
{
    internal partial class PeekedMessageItem : IXmlSerializable, IModelSerializable<PeekedMessageItem>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PeekedMessageItem>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="PeekedMessageItem"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PeekedMessageItem"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PeekedMessageItem"/>. </summary>
