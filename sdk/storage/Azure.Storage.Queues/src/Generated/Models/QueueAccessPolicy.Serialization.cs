...
namespace Azure.Storage.Queues.Models
{
    public partial class QueueAccessPolicy : IXmlSerializable, IModelSerializable<QueueAccessPolicy>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<QueueAccessPolicy>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="QueueAccessPolicy"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="QueueAccessPolicy"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="QueueAccessPolicy"/>. </summary>
