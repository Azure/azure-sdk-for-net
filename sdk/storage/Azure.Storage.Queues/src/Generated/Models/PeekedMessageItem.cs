...
namespace Azure.Storage.Queues.Models
{
    ...
    internal partial class PeekedMessageItem
    {
        ...
        internal PeekedMessageItem(string messageId, DateTimeOffset insertionTime, DateTimeOffset expirationTime, long dequeueCount, string messageText, Dictionary<string, BinaryData> rawData)
        {
            MessageId = messageId;
            InsertionTime = insertionTime;
            ExpirationTime = expirationTime;
