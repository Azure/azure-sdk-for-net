...
{
    public partial class QueueServiceProperties : IXmlSerializable, IModel<QueueServiceProperties>
    {
        ...
        BinaryData IModel<QueueServiceProperties>.Write(ModelReaderWriterOptions options)
        {
        ...
        QueueServiceProperties IModel<QueueServiceProperties>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        ModelReaderWriterFormat IModel<QueueServiceProperties>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Xml;
    }
}
