...
namespace Azure.Storage.Queues.Models
{
    ...
    public partial class QueueMetrics
    {
        ...
        internal QueueMetrics(string version, bool enabled, bool? includeApis, QueueRetentionPolicy retentionPolicy, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Version = version;
            Enabled = enabled;
