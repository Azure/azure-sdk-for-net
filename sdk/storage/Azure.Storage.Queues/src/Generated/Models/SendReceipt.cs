...
namespace Azure.Storage.Queues.Models
{
    ...
    public partial class SendReceipt
    {
        ...
        internal SendReceipt(string messageId, DateTimeOffset insertionTime, DateTimeOffset expirationTime, string popReceipt, DateTimeOffset timeNextVisible, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MessageId = messageId;
            InsertionTime = insertionTime;
            ExpirationTime = expirationTime;
