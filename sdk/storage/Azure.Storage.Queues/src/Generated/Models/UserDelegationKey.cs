...
namespace Azure.Storage.Queues.Models
{
    ...
    public partial class UserDelegationKey
    {
        ...
        internal UserDelegationKey(string signedOid, string signedTid, DateTimeOffset signedStart, DateTimeOffset signedExpiry, string signedService, string signedVersion, string value, string signedDelegatedUserTid)
        {
            SignedOid = signedOid;
            SignedTid = signedTid;
            SignedStart = signedStart;
        ...
        /// <summary> String, return if DelegatedUserTid is specified. The delegated user tenant ID in Entra ID. </summary>
        public string SignedDelegatedUserTid { get; }
    }
}
