...
namespace Azure.Storage.Queues
{
    internal partial class QueueRestClient
    {
        ...
        internal HttpMessage CreateCreateRequest(string queueName, int? timeout, string metadata)
        {
        ...
        public async Task<ResponseWithHeaders<QueueCreateHeaders>> CreateAsync(string queueName, int? timeout = null, string metadata = null, CancellationToken cancellationToken = default)
        {
            if (queueName == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="queueName"/> is null. </exception>
        public ResponseWithHeaders<QueueCreateHeaders> Create(string queueName, int? timeout = null, string metadata = null, CancellationToken cancellationToken = default)
        {
            if (queueName == null)
            {
                throw new ArgumentNullException(nameof(queueName));
        ...
        internal HttpMessage CreateSetMetadataRequest(string queueName, int? timeout, string metadata)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Put;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="queueName"/> is null. </exception>
        public async Task<ResponseWithHeaders<QueueSetMetadataHeaders>> SetMetadataAsync(string queueName, int? timeout = null, string metadata = null, CancellationToken cancellationToken = default)
        {
            if (queueName == null)
            {
                throw new ArgumentNullException(nameof(queueName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="queueName"/> is null. </exception>
        public ResponseWithHeaders<QueueSetMetadataHeaders> SetMetadata(string queueName, int? timeout = null, string metadata = null, CancellationToken cancellationToken = default)
        {
            if (queueName == null)
            {
                throw new ArgumentNullException(nameof(queueName));
