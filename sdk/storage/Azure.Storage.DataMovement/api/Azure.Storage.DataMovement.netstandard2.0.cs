namespace Azure.Storage.DataMovement
{
    public partial class StorageTransferManager
    {
        ...
        public System.Threading.Tasks.Task<Azure.Storage.DataMovement.StorageTransferResults> ScheduleUploadAsync(string sourceLocalPath, Azure.Storage.Blobs.BlobClient destinationClient, Azure.Storage.StorageTransferOptions transferOptions = default(Azure.Storage.StorageTransferOptions), Azure.Storage.Blobs.Models.BlobUploadOptions uploadOptions = null, System.IProgress<Azure.Storage.StorageTransferStatus> progressTracker = null, System.Threading.CancellationToken token = default(System.Threading.CancellationToken)) { throw null; }
        public System.Threading.Tasks.Task<Azure.Storage.DataMovement.StorageTransferResults> ScheduleUploadDirectoryAsync(string sourceLocalPath, Azure.Storage.Blobs.Specialized.BlobDirectoryClient destinationClient, Azure.Storage.StorageTransferOptions transferOptions = default(Azure.Storage.StorageTransferOptions), Azure.Storage.Blobs.Models.BlobUploadOptions uploadOptions = null, System.IProgress<Azure.Storage.StorageTransferStatus> progressTracker = null, System.Threading.CancellationToken token = default(System.Threading.CancellationToken)) { throw null; }
    }
