...
namespace Azure.Storage.DataMovement.JobPlan
{
    ...
    internal enum JobPartFailureType
    {
        ...
        /// <summary>
        /// If the storage resource already exists and <see cref="StorageResourceCreationMode.OverwriteIfExists"/>
        /// or <see cref="StorageResourceCreationMode.SkipIfExists"/> was not enabled, then it's a failure caused
