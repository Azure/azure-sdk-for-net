...
- [BREAKING CHANGE] Combined both `TransferManager.StartTransfer` methods into one that accepts single or container resources. All existing calls should continue to work due to inheritence.
