...
{
    public class DataMovementBlobClientTestFixtureAttribute : ClientTestFixtureAttribute
    {
        public DataMovementBlobClientTestFixtureAttribute(params object[] additionalParameters)
            : base(
