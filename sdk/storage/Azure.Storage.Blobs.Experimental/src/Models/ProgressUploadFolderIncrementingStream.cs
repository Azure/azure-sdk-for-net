...
namespace Azure.Storage.Blobs.Experimental.Models
{
    ...
    /// </summary>
    internal class ProgressUploadFolderIncrementingStream : Stream
    {
        private readonly Stream _innerStream;
        private readonly AggregatingUploadFolderProgress _incrementer;

        public ProgressUploadFolderIncrementingStream(Stream stream, AggregatingUploadFolderProgress incrementer)
        {
