...
namespace Azure.Storage.Blobs.Experimental.Models
{
    ...
    /// </summary>
    public class BlobUploadSkippedEventArgs : StorageTransferEventArgs
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BlobUploadSkippedEventArgs"/>.
        /// </summary>
        ...
        /// </exception>
        public BlobUploadSkippedEventArgs(
            string transferId,
            string sourcePath,
