...
namespace Azure.Storage.Blobs.Batch
{
    internal partial class ContainerRestClient
    {
        ...
        public ContainerRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string url, Enum1 version)
        {
        ...
        internal HttpMessage CreateSubmitBatchRequest(Enum2 restype, Enum0 comp, string containerName, long contentLength, string multipartContentType, Stream body, int? timeout)
        {
        ...
        /// <param name="restype"> The Enum2 to use. </param>
        /// <param name="comp"> The Enum0 to use. </param>
        ...
        public async Task<ResponseWithHeaders<Stream, ContainerSubmitBatchHeaders>> SubmitBatchAsync(Enum2 restype, Enum0 comp, string containerName, long contentLength, string multipartContentType, Stream body, int? timeout = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateSubmitBatchRequest(restype, comp, containerName, contentLength, multipartContentType, body, timeout);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/>, <paramref name="multipartContentType"/>, or <paramref name="body"/> is null. </exception>
        public ResponseWithHeaders<Stream, ContainerSubmitBatchHeaders> SubmitBatch(Enum2 restype, Enum0 comp, string containerName, long contentLength, string multipartContentType, Stream body, int? timeout = null, CancellationToken cancellationToken = default)
        {
            if (containerName == null)
            {
                throw new ArgumentNullException(nameof(containerName));
