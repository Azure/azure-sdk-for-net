...
namespace Azure.Storage.Blobs.Batch.Models
{
    ...
    internal partial class CorsRule
    {
        ...
        internal CorsRule(string allowedOrigins, string allowedMethods, string allowedHeaders, string exposedHeaders, int maxAgeInSeconds)
        {
