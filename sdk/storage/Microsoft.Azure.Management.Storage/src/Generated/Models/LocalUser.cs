...
namespace Microsoft.Azure.Management.Storage.Models
{
    ...
    public partial class LocalUser : Resource
    {
        ...
        public LocalUser(string id = default(string), string name = default(string), string type = default(string), IList<PermissionScope> permissionScopes = default(IList<PermissionScope>), string homeDirectory = default(string), IList<SshPublicKey> sshAuthorizedKeys = default(IList<SshPublicKey>), string sid = default(string), string sharedKey = default(string), string sshPassword = default(string), bool? hasSharedKey = default(bool?), bool? hasSshKey = default(bool?), bool? hasSshPassword = default(bool?), SystemData systemData = default(SystemData))
            : base(id, name, type)
        {
        ...
        /// </summary>
        [JsonProperty(PropertyName = "properties.sshPassword")]
