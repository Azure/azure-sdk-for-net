...
namespace Microsoft.Azure.Management.Storage.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the LeaseContainerRequest1 class.
        /// </summary>
        ...
        public LeaseContainerRequest1(string action, string leaseId = default(string), int? breakPeriod = default(int?), int? leaseDuration = default(int?), string proposedLeaseId = default(string))
        {
            Action = action;
            LeaseId = leaseId;
