...
namespace Microsoft.Azure.Management.Storage
{
    ...
    public partial interface IFileSharesOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<LeaseShareResponse,FileSharesLeaseHeaders>> LeaseWithHttpMessagesAsync(string resourceGroupName, string accountName, string shareName, LeaseShareRequest parameters = default(LeaseShareRequest), string xMsSnapshot = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Lists all shares.
        /// </summary>
