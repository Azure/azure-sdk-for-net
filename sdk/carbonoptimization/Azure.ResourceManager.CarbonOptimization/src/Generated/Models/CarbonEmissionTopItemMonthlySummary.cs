...
namespace Azure.ResourceManager.CarbonOptimization.Models
{
    ...
    public partial class CarbonEmissionTopItemMonthlySummary : CarbonEmission
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="itemName"/>, <paramref name="itemType"/> or <paramref name="date"/> is null. </exception>
        internal CarbonEmissionTopItemMonthlySummary(double latestMonthEmissions, double previousMonthEmissions, string itemName, string itemType, CategoryTypeEnum categoryType, string date) : base(latestMonthEmissions, previousMonthEmissions)
        {
            Argument.AssertNotNull(itemName, nameof(itemName));
            Argument.AssertNotNull(itemType, nameof(itemType));
        ...
        /// <param name="categoryType"> Item category, see supported type value defined in CategoryTypeEnum. </param>
        /// <param name="date"> The date, representing the month, for which the emissions data is reported, formatted as yyyy-MM-dd (e.g., 2024-03-01). </param>
        internal CarbonEmissionTopItemMonthlySummary(ResponseDataTypeEnum dataType, double latestMonthEmissions, double previousMonthEmissions, double? monthOverMonthEmissionsChangeRatio, double? monthlyEmissionsChangeValue, IDictionary<string, BinaryData> serializedAdditionalRawData, string itemName, string itemType, CategoryTypeEnum categoryType, string date) : base(dataType, latestMonthEmissions, previousMonthEmissions, monthOverMonthEmissionsChangeRatio, monthlyEmissionsChangeValue, serializedAdditionalRawData)
        {
            ItemName = itemName;
            ItemType = itemType;
            CategoryType = categoryType;
