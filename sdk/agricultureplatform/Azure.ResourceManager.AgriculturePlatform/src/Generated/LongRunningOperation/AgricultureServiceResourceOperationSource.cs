...
{
    /// <summary></summary>
    internal partial class AgricultureServiceResourceOperationSource : IOperationSource<AgricultureServiceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AgricultureServiceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
