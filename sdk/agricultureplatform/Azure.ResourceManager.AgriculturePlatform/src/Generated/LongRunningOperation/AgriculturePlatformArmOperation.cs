...
namespace Azure.ResourceManager.AgriculturePlatform
{
    internal partial class AgriculturePlatformArmOperation : ArmOperation
    {
        ...
        internal AgriculturePlatformArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
