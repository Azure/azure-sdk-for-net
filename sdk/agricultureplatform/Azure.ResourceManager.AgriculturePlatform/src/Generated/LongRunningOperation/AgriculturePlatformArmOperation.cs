...
#pragma warning disable SA1649 // File name should match first type name
    internal class AgriculturePlatformArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal AgriculturePlatformArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal AgriculturePlatformArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "AgriculturePlatformArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
