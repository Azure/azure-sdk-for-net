...
namespace Azure.ResourceManager.AgriculturePlatform
{
    internal partial class AgriculturePlatformArmOperation<T> : ArmOperation<T>
    {
        ...
        internal AgriculturePlatformArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
