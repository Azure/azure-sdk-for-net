...
namespace Azure.ResourceManager.AgriculturePlatform
{
    ...
    public partial class AgricultureServiceData : TrackedResourceData, IJsonModel<AgricultureServiceData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AgricultureServiceData IJsonModel<AgricultureServiceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AgricultureServiceData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AgricultureServiceData DeserializeAgricultureServiceData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerAgriculturePlatformContext.Default);
                    continue;
                }
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = AgricultureServiceProperties.DeserializeAgricultureServiceProperties(prop.Value, options);
                    continue;
                }
