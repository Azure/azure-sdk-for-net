...
namespace Azure.ResourceManager.AgriculturePlatform.Models
{
    ...
    public partial class InstalledSolutionMap : IJsonModel<InstalledSolutionMap>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<InstalledSolutionMap>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InstalledSolutionMap IJsonModel<InstalledSolutionMap>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InstalledSolutionMap JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InstalledSolutionMap>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InstalledSolutionMap DeserializeInstalledSolutionMap(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    value = AgricultureSolution.DeserializeAgricultureSolution(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new InstalledSolutionMap(key, value, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InstalledSolutionMap>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InstalledSolutionMap IPersistableModel<InstalledSolutionMap>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InstalledSolutionMap PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InstalledSolutionMap>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
