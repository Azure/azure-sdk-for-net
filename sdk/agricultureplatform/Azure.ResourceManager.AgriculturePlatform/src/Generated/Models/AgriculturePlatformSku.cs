...
namespace Azure.ResourceManager.AgriculturePlatform.Models
{
    ...
    public partial class AgriculturePlatformSku
    {
        ...
        internal AgriculturePlatformSku(string name, AgriculturePlatformSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
