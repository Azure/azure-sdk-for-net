            ...
            if (element.TryGetProperty("kind"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    case "ApplicationInsights":
                        return ApplicationInsightsTelemetryEndpoint.DeserializeApplicationInsightsTelemetryEndpoint(element, options);
                    case "LogAnalyticsLegacy":
                        return LogAnalyticsLegacyTelemetryEndpoint.DeserializeLogAnalyticsLegacyTelemetryEndpoint(element, options);
                    case "LogAnalytics":
                        return LogAnalyticsTelemetryEndpoint.DeserializeLogAnalyticsTelemetryEndpoint(element, options);
                    case "OTLP":
