...
namespace Azure.Containers.Apps.Sandbox
{
    ...
    public partial class SandboxGroupConnections
    {
        ...
        internal HttpMessage CreateGetConnectionsRequest(bool? includeSandboxIds, string labels, string skipToken, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateNextGetConnectionsRequest(Uri nextPage, bool? includeSandboxIds, string labels, string skipToken, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
