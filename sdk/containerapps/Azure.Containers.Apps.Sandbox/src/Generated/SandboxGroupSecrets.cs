...
namespace Azure.Containers.Apps.Sandbox
{
    ...
    public partial class SandboxGroupSecrets
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual Pageable<BinaryData> GetSecrets(string skipToken, RequestContext context)
        {
            return new SandboxGroupSecretsGetSecretsCollectionResult(this, skipToken, context, "SandboxGroupSecrets.GetSecrets");
        }
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual AsyncPageable<BinaryData> GetSecretsAsync(string skipToken, RequestContext context)
        {
            return new SandboxGroupSecretsGetSecretsAsyncCollectionResult(this, skipToken, context, "SandboxGroupSecrets.GetSecrets");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Pageable<SandboxSecret> GetSecrets(string skipToken = default, CancellationToken cancellationToken = default)
        {
            return new SandboxGroupSecretsGetSecretsCollectionResultOfT(this, skipToken, cancellationToken.ToRequestContext(), "SandboxGroupSecrets.GetSecrets");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual AsyncPageable<SandboxSecret> GetSecretsAsync(string skipToken = default, CancellationToken cancellationToken = default)
        {
            return new SandboxGroupSecretsGetSecretsAsyncCollectionResultOfT(this, skipToken, cancellationToken.ToRequestContext(), "SandboxGroupSecrets.GetSecrets");
        }
