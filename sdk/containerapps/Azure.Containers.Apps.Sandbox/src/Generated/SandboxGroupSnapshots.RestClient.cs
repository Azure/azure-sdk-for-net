...
namespace Azure.Containers.Apps.Sandbox
{
    ...
    public partial class SandboxGroupSnapshots
    {
        ...
        internal HttpMessage CreateGetSnapshotsRequest(string skipToken, string labels, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateNextGetSnapshotsRequest(Uri nextPage, string skipToken, string labels, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
