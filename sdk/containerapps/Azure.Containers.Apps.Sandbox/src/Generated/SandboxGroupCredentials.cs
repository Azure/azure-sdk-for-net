...
namespace Azure.Containers.Apps.Sandbox
{
    ...
    public partial class SandboxGroupCredentials
    {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual Pageable<BinaryData> GetCredentials(string skipToken, RequestContext context)
        {
            return new SandboxGroupCredentialsGetCredentialsCollectionResult(this, skipToken, context, "SandboxGroupCredentials.GetCredentials");
        }
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual AsyncPageable<BinaryData> GetCredentialsAsync(string skipToken, RequestContext context)
        {
            return new SandboxGroupCredentialsGetCredentialsAsyncCollectionResult(this, skipToken, context, "SandboxGroupCredentials.GetCredentials");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Pageable<SandboxGroupCredential> GetCredentials(string skipToken = default, CancellationToken cancellationToken = default)
        {
            return new SandboxGroupCredentialsGetCredentialsCollectionResultOfT(this, skipToken, cancellationToken.ToRequestContext(), "SandboxGroupCredentials.GetCredentials");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token that can be used to cancel the operation. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual AsyncPageable<SandboxGroupCredential> GetCredentialsAsync(string skipToken = default, CancellationToken cancellationToken = default)
        {
            return new SandboxGroupCredentialsGetCredentialsAsyncCollectionResultOfT(this, skipToken, cancellationToken.ToRequestContext(), "SandboxGroupCredentials.GetCredentials");
        }
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("SandboxGroupCredentials.SetCredential");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(credentialName, nameof(credentialName));
