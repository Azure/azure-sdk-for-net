...
namespace Azure.Containers.Apps.Sandbox
{
    ...
    public partial class SandboxGroupContentPackages
    {
        ...
        internal HttpMessage CreateGetContentPackagesRequest(string skipToken, string labels, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateNextGetContentPackagesRequest(Uri nextPage, string skipToken, string labels, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
