...
namespace Azure.Provisioning.AppContainers
{
    ...
    public partial class ContainerAppHttpRequestInfo : ProvisionableConstruct
    {
        ...
        /// <summary> Creates a new ContainerAppHttpRequestInfo. </summary>
        ...
        /// <summary> Define all the provisionable properties for ContainerAppHttpRequestInfo. </summary>
        protected override void DefineProvisionableProperties()
        {
            base.DefineProvisionableProperties();
            _host = DefineProperty<string>(nameof(Host), new string[] { "host" });
            _httpHeaders = DefineListProperty<ContainerAppHttpHeaderInfo>(nameof(HttpHeaders), new string[] { "httpHeaders" });
        ...
        /// <summary> Define additional provisionable properties for ContainerAppHttpRequestInfo that are not part of the generated code. </summary>
