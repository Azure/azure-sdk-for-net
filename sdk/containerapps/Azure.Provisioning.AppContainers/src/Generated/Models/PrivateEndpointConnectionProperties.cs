...
namespace Azure.Provisioning.AppContainers
{
    ...
    internal partial class PrivateEndpointConnectionProperties : ProvisionableConstruct
    {
        ...
        protected override void DefineProvisionableProperties()
        {
            ...
            _connectionState = DefineModelProperty<ContainerAppPrivateLinkServiceConnectionState>(nameof(ConnectionState), new string[] { "privateLinkServiceConnectionState" }, isRequired: true);
            _provisioningState = DefineProperty<ContainerAppPrivateEndpointConnectionProvisioningState>(nameof(ProvisioningState), new string[] { "provisioningState" }, isOutput: true);
