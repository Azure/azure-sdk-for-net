...
namespace Azure.Provisioning.AppContainers
{
    ...
    public partial class ContainerAppPrivateLinkServiceConnectionState : ProvisionableConstruct
    {
        ...
        /// <summary> Creates a new ContainerAppPrivateLinkServiceConnectionState. </summary>
        ...
        /// <summary> Define all the provisionable properties for ContainerAppPrivateLinkServiceConnectionState. </summary>
        protected override void DefineProvisionableProperties()
        {
            base.DefineProvisionableProperties();
            _status = DefineProperty<ContainerAppPrivateEndpointServiceConnectionStatus>(nameof(Status), new string[] { "status" });
        ...
        /// <summary> Define additional provisionable properties for ContainerAppPrivateLinkServiceConnectionState that are not part of the generated code. </summary>
