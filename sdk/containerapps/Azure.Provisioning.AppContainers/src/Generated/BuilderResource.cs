...
namespace Azure.Provisioning.AppContainers
{
    ...
    public partial class BuilderResource : ProvisionableResource
    {
        ...
        /// <summary> Creates a new BuilderResource. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public BuilderResource(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.App/builders", resourceVersion ?? "2025-10-02-preview")
        {
        }
        ...
        internal BuilderProperties Properties
        {
            get
            {
                Initialize();
        ...
        public BicepList<ContainerRegistry> ContainerRegistries
        {
            get
            {
                return Properties is null ? default : Properties.ContainerRegistries;
            }
            set
            {
                if (Properties is null)
                ...
                Properties.ContainerRegistries = value;
            }
        }

        /// <summary> Define all the provisionable properties for BuilderResource. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<BuilderProperties>(nameof(Properties), new string[] { "properties" });
            _identity = DefineModelProperty<ManagedServiceIdentity>(nameof(Identity), new string[] { "identity" });
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing BuilderResource. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static BuilderResource FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            BuilderResource result = new BuilderResource(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for BuilderResource that are not part of the generated code. </summary>
        partial void DefineAdditionalProperties();

        /// <summary> Get the requirements for naming this resource. </summary>
        /// <returns> Naming requirements. </returns>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public override ResourceNameRequirements GetResourceNameRequirements() => new ResourceNameRequirements(2, 32, ResourceNameCharacters.LowercaseLetters | ResourceNameCharacters.UppercaseLetters | ResourceNameCharacters.Numbers | ResourceNameCharacters.Hyphen | ResourceNameCharacters.Underscore | ResourceNameCharacters.Period | ResourceNameCharacters.Parentheses);
