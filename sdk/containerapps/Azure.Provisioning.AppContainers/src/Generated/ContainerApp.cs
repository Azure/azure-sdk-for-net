...
namespace Azure.Provisioning.AppContainers
{
    ...
    public partial class ContainerApp : ProvisionableResource
    {
        ...
        public ContainerApp(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.App/containerApps", resourceVersion ?? "2026-07-01")
        {
        }
        ...
        /// <summary> Creates a reference to an existing ContainerApp. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ContainerApp FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ContainerApp result = new ContainerApp(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ContainerApp that are not part of the generated code. </summary>
