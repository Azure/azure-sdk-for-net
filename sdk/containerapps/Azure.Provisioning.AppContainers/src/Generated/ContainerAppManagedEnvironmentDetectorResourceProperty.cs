...
namespace Azure.Provisioning.AppContainers
{
    ...
    public partial class ContainerAppManagedEnvironmentDetectorResourceProperty : ProvisionableResource
    {
        ...
        public ContainerAppManagedEnvironmentDetectorResourceProperty(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.App/managedEnvironments/detectorProperties", resourceVersion ?? "2026-01-01")
        {
        }
        ...
        /// <summary> Creates a reference to an existing ContainerAppManagedEnvironmentDetectorResourceProperty. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ContainerAppManagedEnvironmentDetectorResourceProperty FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ContainerAppManagedEnvironmentDetectorResourceProperty result = new ContainerAppManagedEnvironmentDetectorResourceProperty(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ContainerAppManagedEnvironmentDetectorResourceProperty that are not part of the generated code. </summary>
        ...
        /// <summary> Creates a role assignment for a user-assigned identity that grants access to this ContainerAppManagedEnvironmentDetectorResourceProperty. </summary>
        ...
        /// <summary> Creates a role assignment for a principal that grants access to this ContainerAppManagedEnvironmentDetectorResourceProperty. </summary>
        /// <param name="role"> The role to grant. </param>
