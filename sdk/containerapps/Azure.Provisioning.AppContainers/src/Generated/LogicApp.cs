...
namespace Azure.Provisioning.AppContainers
{
    ...
    public partial class LogicApp : ProvisionableResource
    {
        ...
        public LogicApp(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.App/logicApps", resourceVersion ?? "2026-07-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for LogicApp. </summary>
        ...
        /// <summary> Creates a reference to an existing LogicApp. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static LogicApp FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            LogicApp result = new LogicApp(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for LogicApp that are not part of the generated code. </summary>
