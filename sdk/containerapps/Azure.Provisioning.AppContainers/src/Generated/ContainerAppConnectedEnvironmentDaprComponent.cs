...
namespace Azure.Provisioning.AppContainers
{
    ...
    public partial class ContainerAppConnectedEnvironmentDaprComponent : ProvisionableResource
    {
        ...
        public ContainerAppConnectedEnvironmentDaprComponent(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.App/connectedEnvironments/daprComponents", resourceVersion ?? "2026-07-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ContainerAppConnectedEnvironmentDaprComponent. </summary>
        ...
        /// <summary> Creates a reference to an existing ContainerAppConnectedEnvironmentDaprComponent. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ContainerAppConnectedEnvironmentDaprComponent FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ContainerAppConnectedEnvironmentDaprComponent result = new ContainerAppConnectedEnvironmentDaprComponent(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ContainerAppConnectedEnvironmentDaprComponent that are not part of the generated code. </summary>
