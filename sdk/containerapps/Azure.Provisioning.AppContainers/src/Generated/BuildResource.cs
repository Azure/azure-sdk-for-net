...
namespace Azure.Provisioning.AppContainers
{
    ...
    public partial class BuildResource : ProvisionableResource
    {
        private BicepValue<ResourceIdentifier> _id;
        private BicepValue<string> _name;
        private SystemData _systemData;
        private BuildProperties _properties;
        private ResourceReference<BuilderResource> _parent;

        /// <summary> Creates a new BuildResource. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public BuildResource(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.App/builders/builds", resourceVersion ?? "2025-10-02-preview")
        {
        }
        ...
        internal BuildProperties Properties
        {
            get
            {
                Initialize();
        ...
        public BicepValue<string> UploadEndpoint
        {
            get
            {
                ...
                return Properties.UploadEndpoint;
            }
        }
        ...
        public BicepValue<string> TokenEndpoint
        {
            get
            {
                ...
                return Properties.TokenEndpoint;
            }
        }

        /// <summary> Define all the provisionable properties for BuildResource. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<BuildProperties>(nameof(Properties), new string[] { "properties" });
            _parent = DefineResource<BuilderResource>(nameof(Parent), new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing BuildResource. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static BuildResource FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            BuildResource result = new BuildResource(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for BuildResource that are not part of the generated code. </summary>
