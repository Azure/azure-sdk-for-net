...
namespace Azure.Provisioning.AppContainers
{
    ...
    public partial class ContainerAppJob : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ContainerAppJob. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ContainerAppJob(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.App/jobs", resourceVersion ?? "2025-10-02-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ContainerAppJob. </summary>
        ...
        /// <summary> Creates a reference to an existing ContainerAppJob. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ContainerAppJob FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ContainerAppJob result = new ContainerAppJob(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ContainerAppJob that are not part of the generated code. </summary>
