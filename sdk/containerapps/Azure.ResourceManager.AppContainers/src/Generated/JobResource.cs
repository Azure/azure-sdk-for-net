...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class JobResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of JobDetectorPropertyResources in the Job. </summary>
        /// <returns> An object representing collection of JobDetectorPropertyResources and their operations over a JobDetectorPropertyResource. </returns>
        public virtual JobDetectorPropertyCollection GetJobDetectorProperties()
        {
            return GetCachedClient(Client => new JobDetectorPropertyCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<JobDetectorPropertyResource>> GetJobDetectorPropertyAsync(string apiName, CancellationToken cancellationToken = default)
        {
            return await GetJobDetectorProperties().GetAsync(apiName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="apiName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<JobDetectorPropertyResource> GetJobDetectorProperty(string apiName, CancellationToken cancellationToken = default)
        {
            return GetJobDetectorProperties().Get(apiName, cancellationToken);
        }
        ...
        public virtual AsyncPageable<ContainerAppWritableSecret> GetSecretsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, ContainerAppWritableSecret.DeserializeContainerAppWritableSecret, _jobClientDiagnostics, Pipeline, "JobResource.GetSecrets", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _jobRestClient.CreateListSecretsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, ContainerAppWritableSecret.DeserializeContainerAppWritableSecret, _jobClientDiagnostics, Pipeline, "JobResource.GetSecrets", "value", null, cancellationToken);
        }
