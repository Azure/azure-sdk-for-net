...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppManagedEnvironmentDetectorResourcePropertyResource : ArmResource
    {
        ...
        internal ContainerAppManagedEnvironmentDetectorResourcePropertyResource(ArmClient client, ContainerAppManagedEnvironmentData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ContainerAppManagedEnvironmentDetectorResourcePropertyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ContainerAppManagedEnvironmentDetectorResourcePropertyResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
