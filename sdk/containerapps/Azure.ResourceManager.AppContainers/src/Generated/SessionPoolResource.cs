...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class SessionPoolResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<SessionPoolResource>> UpdateAsync(WaitUntil waitUntil, SessionPoolData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _containerAppsSessionPoolsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, SessionPoolData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppContainersArmOperation<SessionPoolResource> operation = new AppContainersArmOperation<SessionPoolResource>(
                    new SessionPoolResourceOperationSource(Client),
                    _containerAppsSessionPoolsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<SessionPoolResource> Update(WaitUntil waitUntil, SessionPoolData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
