...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ConnectedEnvironmentDaprComponentResource : ArmResource
    {
        ...
        public virtual AsyncPageable<AppSecret> GetSecretsAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _connectedEnvironmentDaprComponentConnectedEnvironmentsDaprComponentsClientDiagnostics.CreateScope("ConnectedEnvironmentDaprComponentResource.GetSecrets");
                scope.Start();
                try
                {
                    var response = await _connectedEnvironmentDaprComponentConnectedEnvironmentsDaprComponentsRestClient.ListSecretsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<AppSecret> GetSecrets(CancellationToken cancellationToken = default)
        {
            Page<AppSecret> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _connectedEnvironmentDaprComponentConnectedEnvironmentsDaprComponentsRestClient.ListSecrets(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
