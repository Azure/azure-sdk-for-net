...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppDiagnosticData : ResourceData
    {
        ...
        internal ContainerAppDiagnosticData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ContainerAppDiagnosticsProperties properties) : base(id, name, resourceType, systemData)
        {
