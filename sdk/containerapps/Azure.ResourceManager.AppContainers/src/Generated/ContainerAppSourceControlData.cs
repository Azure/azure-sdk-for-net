...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppSourceControlData : ResourceData
    {
        ...
        internal ContainerAppSourceControlData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SourceControlProperties properties) : base(id, name, resourceType, systemData)
        {
