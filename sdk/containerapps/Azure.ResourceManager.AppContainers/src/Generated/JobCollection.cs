...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class JobCollection : ArmCollection, IEnumerable<JobResource>, IAsyncEnumerable<JobResource>
    {
        ...
        public virtual async Task<ArmOperation<JobResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string jobName, ContainerAppJobData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="jobName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="jobName"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<JobResource> CreateOrUpdate(WaitUntil waitUntil, string jobName, ContainerAppJobData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(jobName, nameof(jobName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<JobResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new JobResource(Client, ContainerAppJobData.DeserializeContainerAppJobData(e)), _jobClientDiagnostics, Pipeline, "JobCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<JobResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _jobRestClient.CreateListByResourceGroupRequest(Id.SubscriptionId, Id.ResourceGroupName);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _jobRestClient.CreateListByResourceGroupNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new JobResource(Client, ContainerAppJobData.DeserializeContainerAppJobData(e)), _jobClientDiagnostics, Pipeline, "JobCollection.GetAll", "value", "nextLink", cancellationToken);
        }
