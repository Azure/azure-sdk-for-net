...
namespace Azure.ResourceManager.AppContainers
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ContainerAppJobDetectorPropertyResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ContainerAppJobResource"/> using the GetContainerAppJobDetectorProperties method.
    /// </summary>
    public partial class ContainerAppJobDetectorPropertyResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ContainerAppJobDetectorPropertyResource for mocking. </summary>
        protected ContainerAppJobDetectorPropertyResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ContainerAppJobDetectorPropertyResource"/> class. </summary>
        ...
        internal ContainerAppJobDetectorPropertyResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _containerAppJobDetectorPropertiesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AppContainers", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/jobs/{jobName}/detectorProperties/{apiName}";
        ...
        {
            using DiagnosticScope scope = _containerAppJobDetectorPropertiesClientDiagnostics.CreateScope("ContainerAppJobDetectorPropertyResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _containerAppJobDetectorPropertiesRestClient.CreateProxyGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
