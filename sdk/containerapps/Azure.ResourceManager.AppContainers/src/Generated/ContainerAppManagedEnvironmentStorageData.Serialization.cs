...
namespace Azure.ResourceManager.AppContainers
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppManagedEnvironmentStorageData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static ContainerAppManagedEnvironmentStorageData DeserializeContainerAppManagedEnvironmentStorageData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ManagedEnvironmentStorageProperties.DeserializeManagedEnvironmentStorageProperties(property.Value, options);
                    continue;
                }
