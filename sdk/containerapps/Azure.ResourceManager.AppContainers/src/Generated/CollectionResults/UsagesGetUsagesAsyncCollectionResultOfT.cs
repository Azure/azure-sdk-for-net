...
{
    internal partial class UsagesGetUsagesAsyncCollectionResultOfT : AsyncPageable<ContainerAppUsage>
    {
        ...
        public UsagesGetUsagesAsyncCollectionResultOfT(Usages client, Guid subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<ContainerAppUsage>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ContainerAppUsage>.FromValues((IReadOnlyList<ContainerAppUsage>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
                if (nextPage == null)
                {
                    yield break;
                }
