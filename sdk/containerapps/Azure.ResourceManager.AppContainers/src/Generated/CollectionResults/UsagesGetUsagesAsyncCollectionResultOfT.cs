...
namespace Azure.ResourceManager.AppContainers
{
    internal partial class UsagesGetUsagesAsyncCollectionResultOfT : AsyncPageable<ContainerAppUsage>
    {
        ...
        public UsagesGetUsagesAsyncCollectionResultOfT(Usages client, Guid subscriptionId, string location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
