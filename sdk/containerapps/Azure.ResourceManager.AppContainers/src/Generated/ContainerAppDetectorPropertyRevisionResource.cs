...
namespace Azure.ResourceManager.AppContainers
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ContainerAppDetectorPropertyRevisionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ContainerAppResource"/> using the GetContainerAppDetectorPropertyRevisions method.
    /// </summary>
    public partial class ContainerAppDetectorPropertyRevisionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ContainerAppDetectorPropertyRevisionResource for mocking. </summary>
        protected ContainerAppDetectorPropertyRevisionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ContainerAppDetectorPropertyRevisionResource"/> class. </summary>
        ...
        internal ContainerAppDetectorPropertyRevisionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _containerAppsDiagnosticsRestClient = new ContainerAppsDiagnostics(_containerAppsDiagnosticsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, containerAppDetectorPropertyRevisionApiVersion ?? "2025-10-02-preview");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/detectorProperties/revisionsApi/revisions/{revisionName}";
