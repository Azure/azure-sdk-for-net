...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppDetectorPropertyRevisionResource : ArmResource
    {
        ...
        internal ContainerAppDetectorPropertyRevisionResource(ArmClient client, ContainerAppRevisionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ContainerAppDetectorPropertyRevisionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ContainerAppDetectorPropertyRevisionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
