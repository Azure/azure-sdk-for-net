...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppConnectedEnvironmentStorageData : ResourceData
    {
        ...
        internal ContainerAppConnectedEnvironmentStorageData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ConnectedEnvironmentStorageProperties properties) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties")]
        public ConnectedEnvironmentStorageProperties Properties { get; set; }
    }
}
