...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppManagedEnvironmentCertificateResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _certificatesClientDiagnostics.CreateScope("ContainerAppManagedEnvironmentCertificateResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ContainerAppManagedEnvironmentCertificateResource>> UpdateAsync(ContainerAppCertificatePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _certificatesClientDiagnostics.CreateScope("ContainerAppManagedEnvironmentCertificateResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _certificatesRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ContainerAppCertificatePatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ContainerAppCertificateData> response = Response.FromValue(ContainerAppCertificateData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _certificatesClientDiagnostics.CreateScope("ContainerAppManagedEnvironmentCertificateResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _certificatesRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        /// <summary>
        /// Updates the ContainerAppManagedEnvironmentCertificate.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/certificates/{certificateName}. </description>
        ...
        public virtual async Task<ArmOperation<ContainerAppManagedEnvironmentCertificateResource>> UpdateAsync(WaitUntil waitUntil, ContainerAppCertificateData data, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _certificatesClientDiagnostics.CreateScope("ContainerAppManagedEnvironmentCertificateResource.Update");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _certificatesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ContainerAppCertificateData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ContainerAppCertificateData> response = Response.FromValue(ContainerAppCertificateData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ContainerAppManagedEnvironmentCertificateResource> Update(WaitUntil waitUntil, ContainerAppCertificateData data, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _certificatesClientDiagnostics.CreateScope("ContainerAppManagedEnvironmentCertificateResource.Update");
            scope.Start();
            try
        ...
        public virtual async Task<Response<ContainerAppManagedEnvironmentCertificateResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _certificatesClientDiagnostics.CreateScope("ContainerAppManagedEnvironmentCertificateResource.AddTag");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ContainerAppManagedEnvironmentCertificateResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _certificatesClientDiagnostics.CreateScope("ContainerAppManagedEnvironmentCertificateResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<ContainerAppManagedEnvironmentCertificateResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _certificatesClientDiagnostics.CreateScope("ContainerAppManagedEnvironmentCertificateResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
