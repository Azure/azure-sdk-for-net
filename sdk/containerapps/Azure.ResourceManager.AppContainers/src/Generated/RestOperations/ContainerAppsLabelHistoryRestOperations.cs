...
{
    internal partial class ContainerAppsLabelHistory
    {
        ...
        internal HttpMessage CreateGetLabelHistoryRequest(Guid subscriptionId, string resourceGroupName, string containerAppName, string labelName, RequestContext context)
        {
        ...
        internal HttpMessage CreateDeleteLabelHistoryRequest(Guid subscriptionId, string resourceGroupName, string containerAppName, string labelName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
