...
namespace Azure.ResourceManager.AppContainers
{
    internal partial class ManagedEnvironmentsDiagnostics
    {
        ...
        internal ManagedEnvironmentsDiagnostics(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ManagedEnvironmentsDiagnostics).Assembly, applicationId);
        }
