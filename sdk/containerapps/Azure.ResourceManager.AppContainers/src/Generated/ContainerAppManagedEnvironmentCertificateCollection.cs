    ...
    public partial class ContainerAppManagedEnvironmentCertificateCollection : ArmCollection, IEnumerable<ContainerAppManagedEnvironmentCertificateResource>, IAsyncEnumerable<ContainerAppManagedEnvironmentCertificateResource>
    {
        ...
        public virtual async Task<ArmOperation<ContainerAppManagedEnvironmentCertificateResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string certificateName, ContainerAppCertificateData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppContainersArmOperation<ContainerAppManagedEnvironmentCertificateResource>(Response.FromValue(new ContainerAppManagedEnvironmentCertificateResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
        ...
        public virtual AsyncPageable<ContainerAppManagedEnvironmentCertificateResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => { var data = ContainerAppCertificateData.DeserializeContainerAppCertificateData(e); return new ContainerAppManagedEnvironmentCertificateResource(Client, data, data.Id); }, _containerAppManagedEnvironmentCertificateCertificatesClientDiagnostics, Pipeline, "ContainerAppManagedEnvironmentCertificateCollection.GetAll", "value", "nextLink", cancellationToken);
        }
