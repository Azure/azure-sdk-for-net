...
namespace Azure.ResourceManager.AppContainers
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ContainerAppDetectorResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ContainerAppResource"/> using the GetContainerAppDetectors method.
    /// </summary>
    public partial class ContainerAppDetectorResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ContainerAppDetectorResource for mocking. </summary>
        protected ContainerAppDetectorResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ContainerAppDetectorResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string containerAppDetectorApiVersion);
            ...
            _containerAppsDiagnosticsRestClient = new ContainerAppsDiagnostics(_containerAppsDiagnosticsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, containerAppDetectorApiVersion ?? "2025-10-02-preview");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/detectors/{detectorName}";
        ...
        {
            using DiagnosticScope scope = _containerAppsDiagnosticsClientDiagnostics.CreateScope("ContainerAppDetectorResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _containerAppsDiagnosticsRestClient.CreateGetDetectorRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
