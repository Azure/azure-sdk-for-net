...
{
    /// <summary></summary>
    internal partial class ContainerAppResourceOperationSource : IOperationSource<ContainerAppResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerAppResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
