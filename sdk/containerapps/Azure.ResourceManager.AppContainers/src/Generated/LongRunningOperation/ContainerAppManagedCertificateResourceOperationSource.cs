...
{
    /// <summary></summary>
    internal partial class ContainerAppManagedCertificateResourceOperationSource : IOperationSource<ContainerAppManagedCertificateResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerAppManagedCertificateResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
