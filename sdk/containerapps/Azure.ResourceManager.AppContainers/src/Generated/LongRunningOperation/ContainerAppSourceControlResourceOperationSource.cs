...
{
    /// <summary></summary>
    internal partial class ContainerAppSourceControlResourceOperationSource : IOperationSource<ContainerAppSourceControlResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ContainerAppSourceControlResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
