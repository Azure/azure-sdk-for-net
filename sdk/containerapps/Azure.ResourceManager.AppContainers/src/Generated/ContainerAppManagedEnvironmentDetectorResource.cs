...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppManagedEnvironmentDetectorResource : ArmResource
    {
        ...
        internal ContainerAppManagedEnvironmentDetectorResource(ArmClient client, ContainerAppDiagnosticData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ContainerAppManagedEnvironmentDetectorResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ContainerAppManagedEnvironmentDetectorResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
