...
namespace Azure.ResourceManager.AppContainers
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ContainerAppManagedEnvironmentDetectorResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ContainerAppManagedEnvironmentResource"/> using the GetContainerAppManagedEnvironmentDetectors method.
    /// </summary>
    public partial class ContainerAppManagedEnvironmentDetectorResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ContainerAppManagedEnvironmentDetectorResource for mocking. </summary>
        protected ContainerAppManagedEnvironmentDetectorResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ContainerAppManagedEnvironmentDetectorResource"/> class. </summary>
        ...
        internal ContainerAppManagedEnvironmentDetectorResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _managedEnvironmentDiagnosticsRestClient = new ManagedEnvironmentDiagnostics(_managedEnvironmentDiagnosticsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, containerAppManagedEnvironmentDetectorApiVersion ?? "2025-10-02-preview");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/managedEnvironments/{environmentName}/detectors/{detectorName}";
