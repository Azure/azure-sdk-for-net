...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public static partial class ArmAppContainersModelFactory
    {
        ...
        {
            return new ContainerAppConnectedEnvironmentStorageData(id, name, resourceType, systemData, connectedEnvironmentStorageAzureFile != null ? new ConnectedEnvironmentStorageProperties(connectedEnvironmentStorageAzureFile, new Dictionary<string, BinaryData>()) : null, serializedAdditionalRawData: null);
        }
        ...
        {
            return new ContainerAppManagedEnvironmentStorageData(id, name, resourceType, systemData, managedEnvironmentStorageAzureFile != null ? new ManagedEnvironmentStorageProperties(managedEnvironmentStorageAzureFile, new Dictionary<string, BinaryData>()) : null, serializedAdditionalRawData: null);
        }
