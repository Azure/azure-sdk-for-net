...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public static partial class ArmAppContainersModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="T:Azure.ResourceManager.AppContainers.ContainerAppManagedEnvironmentData" />. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        {
            return ContainerAppJobExecutionData(id: id, name: name, resourceType: resourceType, systemData: systemData, status: status, startOn: startOn, endOn: endOn, template: template, detailedStatusReplicas: default);
        }
