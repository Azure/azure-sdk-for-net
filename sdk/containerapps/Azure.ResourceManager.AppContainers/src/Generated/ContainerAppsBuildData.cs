...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppsBuildData : ResourceData
    {
        ...
        internal ContainerAppsBuildData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ContainerAppsBuildProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
