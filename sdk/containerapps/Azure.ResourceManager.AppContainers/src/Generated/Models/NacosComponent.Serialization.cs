...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NacosComponent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NacosComponent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Ingress))
            {
                ...
                writer.WriteObjectValue<JavaComponentIngress>(Ingress, options);
            }
            ...
            if (Optional.IsCollectionDefined(Configurations))
            {
                ...
                {
                    writer.WriteObjectValue<JavaComponentConfigurationProperty>(item, options);
                }
            ...
            if (Optional.IsCollectionDefined(ServiceBinds))
            {
                ...
                {
                    writer.WriteObjectValue<JavaComponentServiceBind>(item, options);
                }
                writer.WriteEndArray();
            }
