...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class NacosComponent : JavaComponentProperties, IJsonModel<NacosComponent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NacosComponent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NacosComponent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NacosComponent IPersistableModel<NacosComponent>.Create(BinaryData data, ModelReaderWriterOptions options) => (NacosComponent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NacosComponent IJsonModel<NacosComponent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NacosComponent)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NacosComponent DeserializeNacosComponent(JsonElement element, ModelReaderWriterOptions options)
        {
