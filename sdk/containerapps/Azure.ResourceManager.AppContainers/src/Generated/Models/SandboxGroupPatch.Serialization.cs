...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class SandboxGroupPatch : IJsonModel<SandboxGroupPatch>
    {
        ...
        internal static SandboxGroupPatch DeserializeSandboxGroupPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SandboxGroupPatchProperties properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = SandboxGroupPatchProperties.DeserializeSandboxGroupPatchProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new SandboxGroupPatch(tags ?? new ChangeTrackingDictionary<string, string>(), properties, additionalBinaryDataProperties);
        }
    }
}
