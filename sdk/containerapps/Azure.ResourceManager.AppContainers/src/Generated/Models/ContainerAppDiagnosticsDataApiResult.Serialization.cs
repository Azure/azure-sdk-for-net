...
{
    public partial class ContainerAppDiagnosticsDataApiResult : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerAppDiagnosticsDataApiResult DeserializeContainerAppDiagnosticsDataApiResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
