...
namespace Azure.ResourceManager.AppContainers
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppAuthConfigData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppAuthConfigData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppAuthConfigData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppAuthConfigData>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppAuthConfigData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
