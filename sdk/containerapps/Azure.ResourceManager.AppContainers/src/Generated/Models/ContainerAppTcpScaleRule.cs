...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppTcpScaleRule
    {
        ...
        internal ContainerAppTcpScaleRule(IDictionary<string, string> metadata, IList<ContainerAppScaleRuleAuth> auth, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Metadata = metadata;
            Auth = auth;
