...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppCustomScaleRule
    {
        ...
        internal ContainerAppCustomScaleRule(string customScaleRuleType, IDictionary<string, string> metadata, IList<ContainerAppScaleRuleAuth> auth, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
