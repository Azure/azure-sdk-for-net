...
{
    public partial class CustomScaleRule : IUtf8JsonSerializable
    {
        ...
        internal static CustomScaleRule DeserializeCustomScaleRule(JsonElement element)
        {
            ...
            return new CustomScaleRule(type.Value, Optional.ToDictionary(metadata), Optional.ToList(auth));
        }
    }
}
