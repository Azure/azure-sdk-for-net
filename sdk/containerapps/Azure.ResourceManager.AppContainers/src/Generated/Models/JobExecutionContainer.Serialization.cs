...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JobExecutionContainer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JobExecutionContainer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JobExecutionContainer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JobExecutionContainer>)} interface");
            }
        ...
        string IPersistableModel<JobExecutionContainer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
