...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ManagedCertificateProperties
    {
        ...
        internal ManagedCertificateProperties(ContainerAppCertificateProvisioningState? provisioningState, string subjectName, string error, ManagedCertificateDomainControlValidation? domainControlValidation, string validationToken, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
