...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppDiagnosticsDataApiResult
    {
        ...
        internal ContainerAppDiagnosticsDataApiResult(ContainerAppDiagnosticDataTableResult table, ContainerAppDiagnosticRendering renderingProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Table = table;
