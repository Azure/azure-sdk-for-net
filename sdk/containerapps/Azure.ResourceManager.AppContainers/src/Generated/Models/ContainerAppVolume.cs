...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppVolume
    {
        ...
        internal ContainerAppVolume(string name, ContainerAppStorageType? storageType, string storageName, IList<SecretVolumeItem> secrets, string mountOptions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
