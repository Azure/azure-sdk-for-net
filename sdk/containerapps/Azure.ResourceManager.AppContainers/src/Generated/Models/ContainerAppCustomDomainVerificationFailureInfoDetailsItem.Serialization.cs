...
namespace Azure.ResourceManager.AppContainers.Models
{
    public partial class ContainerAppCustomDomainVerificationFailureInfoDetailsItem : IUtf8JsonSerializable, IJsonModel<ContainerAppCustomDomainVerificationFailureInfoDetailsItem>
    {
        ...
        void IJsonModel<ContainerAppCustomDomainVerificationFailureInfoDetailsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ContainerAppCustomDomainVerificationFailureInfoDetailsItem)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ContainerAppCustomDomainVerificationFailureInfoDetailsItem>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ContainerAppCustomDomainVerificationFailureInfoDetailsItem)} does not support '{options.Format}' format.");
            }
        }
