...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppCertificateProperties
    {
        ...
        internal ContainerAppCertificateProperties(ContainerAppCertificateProvisioningState? provisioningState, string deploymentErrors, CertificateKeyVaultProperties certificateKeyVaultProperties, string password, string subjectName, IReadOnlyList<string> subjectAlternativeNames, byte[] value, string issuer, DateTimeOffset? issueOn, DateTimeOffset? expireOn, string thumbprint, bool? isValid, string publicKeyHash, CertificateType? certificateType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
