...
{
    public partial class ContainerAppWorkloadProfileStateProperties : IUtf8JsonSerializable, IJsonModel<ContainerAppWorkloadProfileStateProperties>, IPersistableModel<ContainerAppWorkloadProfileStateProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinimumCount))
            {
                ...
                builder.AppendLine($" '{MinimumCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaximumCount))
            {
                builder.Append("  maximumCount:");
                builder.AppendLine($" '{MaximumCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(CurrentCount))
            {
                builder.Append("  currentCount:");
                builder.AppendLine($" '{CurrentCount.Value.ToString()}'");
            }
