...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppEnvironmentAuthToken>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppEnvironmentAuthToken>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppEnvironmentAuthToken>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContainerAppEnvironmentAuthToken>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
