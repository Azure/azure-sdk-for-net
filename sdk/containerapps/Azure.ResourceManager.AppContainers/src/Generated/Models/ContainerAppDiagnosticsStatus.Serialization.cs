...
{
    public partial class ContainerAppDiagnosticsStatus : IUtf8JsonSerializable, IJsonModel<ContainerAppDiagnosticsStatus>, IPersistableModel<ContainerAppDiagnosticsStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StatusId))
            {
                ...
                builder.AppendLine($" '{StatusId.Value.ToString()}'");
            }
