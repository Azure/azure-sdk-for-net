...
{
    public partial class ContainerAppDiagnosticsStatus : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerAppDiagnosticsStatus DeserializeContainerAppDiagnosticsStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
