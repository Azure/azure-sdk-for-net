...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppDiagnosticsStatus>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ContainerAppDiagnosticsStatus IJsonModel<ContainerAppDiagnosticsStatus>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static ContainerAppDiagnosticsStatus DeserializeContainerAppDiagnosticsStatus(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContainerAppDiagnosticsStatus(message.Value, Optional.ToNullable(statusId), serializedAdditionalRawData);
        }

        BinaryData IModel<ContainerAppDiagnosticsStatus>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ContainerAppDiagnosticsStatus IModel<ContainerAppDiagnosticsStatus>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ContainerAppDiagnosticsStatus>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
