...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppDiagnosticsStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppDiagnosticsStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppDiagnosticsStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppDiagnosticsStatus>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppDiagnosticsStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
