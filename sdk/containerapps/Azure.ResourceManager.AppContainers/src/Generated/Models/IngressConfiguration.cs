...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class IngressConfiguration
    {
        ...
        internal IngressConfiguration(string workloadProfileName, IngressConfigurationScale scale, int? terminationGracePeriodSeconds, int? headerCountLimit, int? requestIdleTimeout, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
