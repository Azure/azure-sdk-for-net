...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppAppleRegistrationConfiguration
    {
        ...
        internal ContainerAppAppleRegistrationConfiguration(string clientId, string clientSecretSettingName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ClientId = clientId;
