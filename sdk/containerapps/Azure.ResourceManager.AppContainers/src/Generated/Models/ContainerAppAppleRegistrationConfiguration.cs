...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppAppleRegistrationConfiguration
    {
        ...
        internal ContainerAppAppleRegistrationConfiguration(string clientId, string clientSecretSettingName, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ClientId = clientId;
