...
{
    public partial class WorkloadProfileStatesProperties : IUtf8JsonSerializable
    {
        ...
        internal static WorkloadProfileStatesProperties DeserializeWorkloadProfileStatesProperties(JsonElement element)
        {
            ...
            return new WorkloadProfileStatesProperties(Optional.ToNullable(minimumCount), Optional.ToNullable(maximumCount), Optional.ToNullable(currentCount));
        }
    }
}
