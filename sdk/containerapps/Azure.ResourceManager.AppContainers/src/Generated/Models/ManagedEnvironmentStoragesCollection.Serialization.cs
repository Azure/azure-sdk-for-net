...
{
    internal partial class ManagedEnvironmentStoragesCollection : IUtf8JsonSerializable, IJsonModel<ManagedEnvironmentStoragesCollection>, IPersistableModel<ManagedEnvironmentStoragesCollection>
    {
        ...
        void IJsonModel<ManagedEnvironmentStoragesCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedEnvironmentStoragesCollection)} does not support '{format}' format.");
            }
