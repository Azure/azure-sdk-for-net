...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppDefaultAuthorizationPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppDefaultAuthorizationPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppDefaultAuthorizationPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppDefaultAuthorizationPolicy>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppDefaultAuthorizationPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
