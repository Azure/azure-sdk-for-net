...
{
    public partial class ManagedCertificateProperties : IUtf8JsonSerializable, IJsonModel<ManagedCertificateProperties>, IPersistableModel<ManagedCertificateProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DomainControlValidation))
            {
                ...
                builder.AppendLine($" '{DomainControlValidation.ToString()}'");
            }
