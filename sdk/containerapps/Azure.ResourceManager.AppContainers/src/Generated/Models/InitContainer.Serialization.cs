...
{
    public partial class InitContainer : IUtf8JsonSerializable
    {
        ...
        internal static InitContainer DeserializeInitContainer(JsonElement element)
        {
            ...
            return new InitContainer(image.Value, name.Value, Optional.ToList(command), Optional.ToList(args), Optional.ToList(env), resources.Value, Optional.ToList(volumeMounts));
        }
    }
}
