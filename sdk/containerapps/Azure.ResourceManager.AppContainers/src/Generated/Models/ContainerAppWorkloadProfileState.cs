...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppWorkloadProfileState : ResourceData
    {
        ...
        internal ContainerAppWorkloadProfileState(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ContainerAppWorkloadProfileStateProperties properties) : base(id, name, resourceType, systemData)
        {
