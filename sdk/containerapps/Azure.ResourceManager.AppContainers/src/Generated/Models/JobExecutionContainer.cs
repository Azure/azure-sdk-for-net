...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class JobExecutionContainer
    {
        ...
        internal JobExecutionContainer(string image, string name, IList<string> command, IList<string> args, IList<ContainerAppEnvironmentVariable> env, AppContainerResources resources, Dictionary<string, BinaryData> rawData)
        {
            Image = image;
            Name = name;
            Command = command;
