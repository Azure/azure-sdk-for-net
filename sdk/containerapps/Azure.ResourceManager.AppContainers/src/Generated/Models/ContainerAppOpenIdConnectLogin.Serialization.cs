...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppOpenIdConnectLogin>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppOpenIdConnectLogin>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppOpenIdConnectLogin>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppOpenIdConnectLogin>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppOpenIdConnectLogin>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
