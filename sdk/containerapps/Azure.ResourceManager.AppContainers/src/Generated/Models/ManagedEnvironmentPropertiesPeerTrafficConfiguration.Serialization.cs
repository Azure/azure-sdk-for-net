...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedEnvironmentPropertiesPeerTrafficConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ManagedEnvironmentPropertiesPeerTrafficConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Encryption))
            {
                ...
                writer.WriteObjectValue<ManagedEnvironmentPropertiesPeerTrafficConfigurationEncryption>(Encryption, options);
            }
