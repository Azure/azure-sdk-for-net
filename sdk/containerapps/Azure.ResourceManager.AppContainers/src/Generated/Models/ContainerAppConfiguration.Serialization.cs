...
{
    public partial class ContainerAppConfiguration : IUtf8JsonSerializable, IJsonModel<ContainerAppConfiguration>, IPersistableModel<ContainerAppConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActiveRevisionsMode))
            {
                ...
                builder.AppendLine($" '{ActiveRevisionsMode.ToString()}'");
            }

            if (Optional.IsDefined(Ingress))
            {
                builder.Append("  ingress:");
                AppendChildObject(builder, Ingress, options, 2);
            }
            ...
            {
                builder.Append("  dapr:");
                AppendChildObject(builder, Dapr, options, 2);
            }

            if (Optional.IsDefined(MaxInactiveRevisions))
            {
                builder.Append("  maxInactiveRevisions:");
                builder.AppendLine($" '{MaxInactiveRevisions.Value.ToString()}'");
            }

            if (Optional.IsDefined(Service))
            {
                builder.Append("  service:");
                AppendChildObject(builder, Service, options, 2);
            }
