...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class EncryptionSettings : IJsonModel<EncryptionSettings>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EncryptionSettings PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EncryptionSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EncryptionSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EncryptionSettings IPersistableModel<EncryptionSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EncryptionSettings IJsonModel<EncryptionSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EncryptionSettings JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EncryptionSettings>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static EncryptionSettings DeserializeEncryptionSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("containerAppAuthEncryptionSecretName"u8))
                {
                    containerAppAuthEncryptionSecretName = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("containerAppAuthSigningSecretName"u8))
                {
                    containerAppAuthSigningSecretName = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new EncryptionSettings(containerAppAuthEncryptionSecretName, containerAppAuthSigningSecretName, additionalBinaryDataProperties);
        }
    }
}
