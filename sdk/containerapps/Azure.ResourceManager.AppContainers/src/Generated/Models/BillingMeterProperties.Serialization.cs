...
{
    public partial class BillingMeterProperties : IUtf8JsonSerializable
    {
        ...
        internal static BillingMeterProperties DeserializeBillingMeterProperties(JsonElement element)
        {
            ...
            return new BillingMeterProperties(Optional.ToNullable(category), meterType.Value, displayName.Value);
        }
    }
}
