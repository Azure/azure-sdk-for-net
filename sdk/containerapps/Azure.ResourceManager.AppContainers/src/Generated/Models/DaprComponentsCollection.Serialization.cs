...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DaprComponentsCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DaprComponentsCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DaprComponentsCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DaprComponentsCollection>)} interface");
            }
        ...
        string IPersistableModel<DaprComponentsCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
