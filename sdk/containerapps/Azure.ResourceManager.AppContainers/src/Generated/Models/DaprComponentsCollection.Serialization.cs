...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        internal static DaprComponentsCollection DeserializeDaprComponentsCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
