...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceControlCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceControlCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceControlCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceControlCollection>)} interface");
            }
        ...
        string IPersistableModel<SourceControlCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
