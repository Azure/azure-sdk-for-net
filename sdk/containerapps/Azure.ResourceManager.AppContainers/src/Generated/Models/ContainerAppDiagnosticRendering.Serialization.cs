...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppDiagnosticRendering>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppDiagnosticRendering>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppDiagnosticRendering>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppDiagnosticRendering>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppDiagnosticRendering>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
