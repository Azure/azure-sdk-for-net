...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppSecret>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppSecret>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppSecret>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppSecret>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppSecret>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
