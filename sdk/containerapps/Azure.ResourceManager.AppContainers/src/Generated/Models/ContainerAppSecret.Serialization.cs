...
namespace Azure.ResourceManager.AppContainers.Models
{
    public partial class ContainerAppSecret : IUtf8JsonSerializable, IJsonModel<ContainerAppSecret>
    {
        ...
        void IJsonModel<ContainerAppSecret>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ContainerAppSecret)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ContainerAppSecret>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ContainerAppSecret)} does not support '{options.Format}' format.");
            }
        }
