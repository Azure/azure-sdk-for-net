...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JobSecretsCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JobSecretsCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JobSecretsCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JobSecretsCollection>)} interface");
            }
        ...
        string IPersistableModel<JobSecretsCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
