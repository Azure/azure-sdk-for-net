...
{
    public partial class DiagnosticDataTableResponseColumn : IUtf8JsonSerializable
    {
        ...
        internal static DiagnosticDataTableResponseColumn DeserializeDiagnosticDataTableResponseColumn(JsonElement element)
        {
            ...
            return new DiagnosticDataTableResponseColumn(columnName.Value, dataType.Value, columnType.Value);
        }
    }
}
