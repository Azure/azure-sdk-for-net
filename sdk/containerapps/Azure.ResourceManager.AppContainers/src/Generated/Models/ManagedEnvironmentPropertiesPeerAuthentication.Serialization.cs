...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedEnvironmentPropertiesPeerAuthentication>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedEnvironmentPropertiesPeerAuthentication>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedEnvironmentPropertiesPeerAuthentication>)} interface");
            }
        ...
        string IPersistableModel<ManagedEnvironmentPropertiesPeerAuthentication>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
