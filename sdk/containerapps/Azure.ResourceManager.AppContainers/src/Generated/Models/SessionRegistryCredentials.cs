...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class SessionRegistryCredentials
    {
        ...
        internal SessionRegistryCredentials(string server, string username, string passwordSecretRef, string identity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Server = server;
            Username = username;
