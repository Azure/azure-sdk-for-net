...
namespace Azure.ResourceManager.AppContainers.Models
{
    internal partial class AvailableWorkloadProfilesCollection : IUtf8JsonSerializable, IJsonModel<AvailableWorkloadProfilesCollection>
    {
        ...
        void IJsonModel<AvailableWorkloadProfilesCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AvailableWorkloadProfilesCollection)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AvailableWorkloadProfilesCollection>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AvailableWorkloadProfilesCollection)} does not support '{options.Format}' format.");
            }
        }
