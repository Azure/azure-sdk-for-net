...
{
    public partial class HttpScaleRule : IUtf8JsonSerializable
    {
        ...
        internal static HttpScaleRule DeserializeHttpScaleRule(JsonElement element)
        {
            ...
            return new HttpScaleRule(Optional.ToDictionary(metadata), Optional.ToList(auth));
        }
    }
}
