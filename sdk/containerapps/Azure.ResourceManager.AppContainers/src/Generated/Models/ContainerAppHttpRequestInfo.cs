...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppHttpRequestInfo
    {
        ...
        internal ContainerAppHttpRequestInfo(string host, IList<ContainerAppHttpHeaderInfo> httpHeaders, string path, int port, ContainerAppHttpScheme? scheme, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Host = host;
