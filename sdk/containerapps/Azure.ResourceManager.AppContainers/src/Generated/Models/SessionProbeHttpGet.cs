...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class SessionProbeHttpGet
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SessionProbeHttpGet"/>. </summary>
        ...
        public SessionProbeHttpGet(int port)
        {
        ...
        internal SessionProbeHttpGet(string host, IList<SessionProbeHttpGetHttpHeadersItem> httpHeaders, string path, int port, ContainerAppHttpScheme? scheme, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Host = host;
        ...
        public IList<SessionProbeHttpGetHttpHeadersItem> HttpHeaders { get; }
