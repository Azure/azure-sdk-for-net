...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class SessionProbeHttpGet
    {
        ...
        internal SessionProbeHttpGet(string host, IList<SessionProbeHttpGetHttpHeadersItem> httpHeaders, string path, int port, ContainerAppHttpScheme? scheme, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Host = host;
