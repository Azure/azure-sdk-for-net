...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppOpenTelemetryMetricsConfiguration
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ContainerAppOpenTelemetryMetricsConfiguration"/>. </summary>
        ...
        internal ContainerAppOpenTelemetryMetricsConfiguration(bool? isKedaIncluded, IList<string> destinations, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
