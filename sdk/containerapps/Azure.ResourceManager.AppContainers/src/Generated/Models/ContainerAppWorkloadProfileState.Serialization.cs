...
{
    public partial class ContainerAppWorkloadProfileState : IUtf8JsonSerializable
    {
        ...
        internal static ContainerAppWorkloadProfileState DeserializeContainerAppWorkloadProfileState(JsonElement element)
        {
            ...
            return new ContainerAppWorkloadProfileState(id, name, type, systemData.Value, properties.Value);
        }
    }
}
