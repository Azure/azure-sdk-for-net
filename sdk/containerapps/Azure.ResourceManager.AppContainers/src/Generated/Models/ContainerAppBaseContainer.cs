...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppBaseContainer
    {
        ...
        internal ContainerAppBaseContainer(string image, string name, IList<string> command, IList<string> args, IList<ContainerAppEnvironmentVariable> env, AppContainerResources resources, IList<ContainerAppVolumeMount> volumeMounts, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Image = image;
            Name = name;
            Command = command;
