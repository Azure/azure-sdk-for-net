...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DaprComponentResiliencyPolicyConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DaprComponentResiliencyPolicyConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HttpRetryPolicy))
            {
                ...
                writer.WriteObjectValue<DaprComponentResiliencyPolicyHttpRetryPolicyConfiguration>(HttpRetryPolicy, options);
            }
            if (Optional.IsDefined(TimeoutPolicy))
            {
                writer.WritePropertyName("timeoutPolicy"u8);
                writer.WriteObjectValue<DaprComponentResiliencyPolicyTimeoutPolicyConfiguration>(TimeoutPolicy, options);
            }
            if (Optional.IsDefined(CircuitBreakerPolicy))
            {
                writer.WritePropertyName("circuitBreakerPolicy"u8);
                writer.WriteObjectValue<DaprComponentResiliencyPolicyCircuitBreakerPolicyConfiguration>(CircuitBreakerPolicy, options);
            }
