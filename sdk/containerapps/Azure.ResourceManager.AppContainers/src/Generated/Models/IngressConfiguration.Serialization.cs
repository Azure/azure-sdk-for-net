...
{
    public partial class IngressConfiguration : IUtf8JsonSerializable, IJsonModel<IngressConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IngressConfiguration>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<IngressConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<IngressConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IngressConfiguration)} does not support writing '{format}' format.");
            }
        ...
        IngressConfiguration IJsonModel<IngressConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IngressConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IngressConfiguration)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeIngressConfiguration(document.RootElement, options);
        }

        internal static IngressConfiguration DeserializeIngressConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new IngressConfiguration(workloadProfileName, terminationGracePeriodSeconds, headerCountLimit, requestIdleTimeout, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<IngressConfiguration>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IngressConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IngressConfiguration)} does not support writing '{options.Format}' format.");
            }
        }

        IngressConfiguration IPersistableModel<IngressConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IngressConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IngressConfiguration)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<IngressConfiguration>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
