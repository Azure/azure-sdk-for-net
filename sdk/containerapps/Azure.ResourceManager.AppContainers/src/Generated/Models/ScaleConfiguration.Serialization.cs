...
namespace Azure.ResourceManager.AppContainers.Models
{
    public partial class ScaleConfiguration : IUtf8JsonSerializable, IJsonModel<ScaleConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(MaxConcurrentSessions), out propertyOverride);
            ...
            else
            {
                ...
                {
                    builder.Append("  maxConcurrentSessions: ");
                    builder.AppendLine($"{MaxConcurrentSessions.Value}");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ReadySessionInstances), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  readySessionInstances: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  readySessionInstances: ");
                    builder.AppendLine($"{ReadySessionInstances.Value}");
                }
            }
