...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppRevisionTrafficWeight
    {
        ...
        internal ContainerAppRevisionTrafficWeight(string revisionName, int? weight, bool? isLatestRevision, string label, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
