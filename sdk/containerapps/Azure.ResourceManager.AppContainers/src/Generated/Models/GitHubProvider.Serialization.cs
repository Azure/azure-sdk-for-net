...
{
    public partial class GitHubProvider : IUtf8JsonSerializable
    {
        ...
        internal static GitHubProvider DeserializeGitHubProvider(JsonElement element)
        {
            ...
            return new GitHubProvider(Optional.ToNullable(enabled), registration.Value, login.Value);
        }
    }
}
