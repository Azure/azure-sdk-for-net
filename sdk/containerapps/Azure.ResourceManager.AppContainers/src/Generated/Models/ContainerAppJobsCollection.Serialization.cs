...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        internal static ContainerAppJobsCollection DeserializeContainerAppJobsCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
