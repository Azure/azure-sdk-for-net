...
{
    public partial class ContainerAppEnvironmentVariable : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerAppEnvironmentVariable DeserializeContainerAppEnvironmentVariable(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
