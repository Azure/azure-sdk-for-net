...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppBlobStorageTokenStore
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ContainerAppBlobStorageTokenStore"/>. </summary>
        public ContainerAppBlobStorageTokenStore()
        {
        }
        ...
        internal ContainerAppBlobStorageTokenStore(string sasUrlSettingName, Uri blobContainerUri, string clientId, string managedIdentityResourceId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
