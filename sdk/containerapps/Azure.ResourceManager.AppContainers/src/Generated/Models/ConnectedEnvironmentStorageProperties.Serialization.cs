...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectedEnvironmentStorageProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectedEnvironmentStorageProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectedEnvironmentStorageProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectedEnvironmentStorageProperties>)} interface");
            }
        ...
        string IPersistableModel<ConnectedEnvironmentStorageProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
