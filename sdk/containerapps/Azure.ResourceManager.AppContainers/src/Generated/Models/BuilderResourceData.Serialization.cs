...
namespace Azure.ResourceManager.AppContainers
{
    public partial class BuilderResourceData : IUtf8JsonSerializable
    {
        ...
        internal static BuilderResourceData DeserializeBuilderResourceData(JsonElement element)
        {
            ...
            return new BuilderResourceData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, Optional.ToNullable(provisioningState), environmentId.Value, Optional.ToList(containerRegistries));
        }
    }
}
