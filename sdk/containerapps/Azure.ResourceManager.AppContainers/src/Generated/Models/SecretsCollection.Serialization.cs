...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecretsCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecretsCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecretsCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecretsCollection>)} interface");
            }
        ...
        string IPersistableModel<SecretsCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
