...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppDiagnosticRendering
    {
        ...
        internal ContainerAppDiagnosticRendering(int? diagnosticRenderingType, string title, string description, bool? isVisible, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
