...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class WorkflowEnvelopeProperties
    {
        ...
        internal WorkflowEnvelopeProperties(BinaryData files, WorkflowState? flowState, WorkflowHealth health, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Files = files;
            FlowState = flowState;
            Health = health;
