...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppDiagnosticDataTableResult
    {
        ...
        internal ContainerAppDiagnosticDataTableResult(string tableName, IList<ContainerAppDiagnosticDataColumn> columns, IList<BinaryData> rows, Dictionary<string, BinaryData> rawData)
        {
            TableName = tableName;
            Columns = columns;
            Rows = rows;
