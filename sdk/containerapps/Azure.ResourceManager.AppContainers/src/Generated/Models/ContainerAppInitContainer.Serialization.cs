...
{
    public partial class ContainerAppInitContainer : IUtf8JsonSerializable, IJsonModel<ContainerAppInitContainer>, IPersistableModel<ContainerAppInitContainer>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppInitContainer>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContainerAppInitContainer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerAppInitContainer)} does not support '{format}' format.");
            }
