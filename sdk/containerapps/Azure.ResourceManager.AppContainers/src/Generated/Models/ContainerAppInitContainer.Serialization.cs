...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppInitContainer : ContainerAppBaseContainer, IJsonModel<ContainerAppInitContainer>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ContainerAppInitContainer>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ContainerAppInitContainer>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ContainerAppInitContainer IPersistableModel<ContainerAppInitContainer>.Create(BinaryData data, ModelReaderWriterOptions options) => (ContainerAppInitContainer)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ContainerAppInitContainer IJsonModel<ContainerAppInitContainer>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ContainerAppInitContainer)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ContainerAppInitContainer DeserializeContainerAppInitContainer(JsonElement element, ModelReaderWriterOptions options)
        {
