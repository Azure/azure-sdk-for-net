...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppDiagnosticsProperties
    {
        ...
        internal ContainerAppDiagnosticsProperties(ContainerAppDiagnosticsMetadata metadata, IList<ContainerAppDiagnosticsDataApiResult> dataset, ContainerAppDiagnosticsStatus status, ContainerAppDiagnosticDataProviderMetadata dataProviderMetadata, Dictionary<string, BinaryData> rawData)
        {
            Metadata = metadata;
            Dataset = dataset;
            Status = status;
