...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppDiagnosticsProperties
    {
        ...
        internal ContainerAppDiagnosticsProperties(ContainerAppDiagnosticsMetadata metadata, IList<ContainerAppDiagnosticsDataApiResult> dataset, ContainerAppDiagnosticsStatus status, ContainerAppDiagnosticDataProviderMetadata dataProviderMetadata, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Metadata = metadata;
            Dataset = dataset;
            Status = status;
