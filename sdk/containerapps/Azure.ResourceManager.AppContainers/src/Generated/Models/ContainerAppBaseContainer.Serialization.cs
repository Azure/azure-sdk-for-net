...
{
    public partial class ContainerAppBaseContainer : Core.IUtf8JsonSerializable
    {
        ...
        internal static ContainerAppBaseContainer DeserializeContainerAppBaseContainer(JsonElement element)
        {
            ...
            return new ContainerAppBaseContainer(image.Value, name.Value, Core.Optional.ToList(command), Core.Optional.ToList(args), Core.Optional.ToList(env), resources.Value, Core.Optional.ToList(volumeMounts));
        }
    }
}
