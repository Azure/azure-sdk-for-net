...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppBaseContainer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppBaseContainer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppBaseContainer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppBaseContainer>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppBaseContainer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
