...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppBaseContainer : IJsonModel<ContainerAppBaseContainer>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ContainerAppBaseContainer PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ContainerAppBaseContainer>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ContainerAppBaseContainer>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ContainerAppBaseContainer IPersistableModel<ContainerAppBaseContainer>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(VolumeMounts))
            {
                ...
                writer.WriteStartArray();
                foreach (ContainerAppVolumeMount item in VolumeMounts)
                {
                    writer.WriteObjectValue(item, options);
                }
                writer.WriteEndArray();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ContainerAppBaseContainer IJsonModel<ContainerAppBaseContainer>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ContainerAppBaseContainer JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ContainerAppBaseContainer>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ContainerAppBaseContainer DeserializeContainerAppBaseContainer(JsonElement element, ModelReaderWriterOptions options)
        {
