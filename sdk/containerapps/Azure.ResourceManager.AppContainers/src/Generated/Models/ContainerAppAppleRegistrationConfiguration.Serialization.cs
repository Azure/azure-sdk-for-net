...
{
    public partial class ContainerAppAppleRegistrationConfiguration : IUtf8JsonSerializable, IJsonModel<ContainerAppAppleRegistrationConfiguration>, IPersistableModel<ContainerAppAppleRegistrationConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppAppleRegistrationConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContainerAppAppleRegistrationConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerAppAppleRegistrationConfiguration)} does not support '{format}' format.");
            }
