...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpringCloudConfigComponent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static SpringCloudConfigComponent DeserializeSpringCloudConfigComponent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new SpringCloudConfigComponent(componentType, provisioningState, configurations ?? new ChangeTrackingList<JavaComponentConfigurationProperty>(), serviceBinds ?? new ChangeTrackingList<JavaComponentServiceBind>(), serializedAdditionalRawData);
        }
