...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RevisionCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RevisionCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RevisionCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RevisionCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
