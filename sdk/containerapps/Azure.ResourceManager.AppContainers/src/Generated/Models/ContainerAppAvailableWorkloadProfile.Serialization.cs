...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppAvailableWorkloadProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppAvailableWorkloadProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppAvailableWorkloadProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContainerAppAvailableWorkloadProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
