...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppAvailableWorkloadProfile : ResourceData, IJsonModel<ContainerAppAvailableWorkloadProfile>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ContainerAppAvailableWorkloadProfile>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ContainerAppAvailableWorkloadProfile>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ContainerAppAvailableWorkloadProfile IPersistableModel<ContainerAppAvailableWorkloadProfile>.Create(BinaryData data, ModelReaderWriterOptions options) => (ContainerAppAvailableWorkloadProfile)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ContainerAppAvailableWorkloadProfile IJsonModel<ContainerAppAvailableWorkloadProfile>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ContainerAppAvailableWorkloadProfile)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ContainerAppAvailableWorkloadProfile DeserializeContainerAppAvailableWorkloadProfile(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ContainerAppAvailableWorkloadProfileProperties.DeserializeContainerAppAvailableWorkloadProfileProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
