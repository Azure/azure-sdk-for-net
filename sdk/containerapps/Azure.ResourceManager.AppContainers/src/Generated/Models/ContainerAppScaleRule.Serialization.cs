...
{
    public partial class ContainerAppScaleRule : IUtf8JsonSerializable, IJsonModel<ContainerAppScaleRule>, IPersistableModel<ContainerAppScaleRule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AzureQueue))
            {
                ...
                AppendChildObject(builder, AzureQueue, options, 2);
            }

            if (Optional.IsDefined(Custom))
            {
                builder.Append("  custom:");
                AppendChildObject(builder, Custom, options, 2);
            }

            if (Optional.IsDefined(Http))
            {
                builder.Append("  http:");
                AppendChildObject(builder, Http, options, 2);
            }

            if (Optional.IsDefined(Tcp))
            {
                builder.Append("  tcp:");
                AppendChildObject(builder, Tcp, options, 2);
            }
