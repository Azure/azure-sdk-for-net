...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppDiagnosticDataTableResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppDiagnosticDataTableResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppDiagnosticDataTableResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppDiagnosticDataTableResult>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppDiagnosticDataTableResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
