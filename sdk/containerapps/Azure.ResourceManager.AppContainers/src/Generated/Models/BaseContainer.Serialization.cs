...
{
    public partial class BaseContainer : IUtf8JsonSerializable
    {
        ...
        internal static BaseContainer DeserializeBaseContainer(JsonElement element)
        {
            ...
            return new BaseContainer(image.Value, name.Value, Optional.ToList(command), Optional.ToList(args), Optional.ToList(env), resources.Value, Optional.ToList(volumeMounts));
        }
    }
}
