...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppCustomDomainVerificationFailureInfo
    {
        ...
        internal ContainerAppCustomDomainVerificationFailureInfo(string code, string message, string target, IReadOnlyList<ContainerAppCustomDomainVerificationFailureInfoDetailsItem> details, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
