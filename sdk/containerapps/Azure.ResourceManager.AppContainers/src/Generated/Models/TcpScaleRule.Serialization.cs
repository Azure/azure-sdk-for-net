...
{
    public partial class TcpScaleRule : IUtf8JsonSerializable
    {
        ...
        internal static TcpScaleRule DeserializeTcpScaleRule(JsonElement element)
        {
            ...
            return new TcpScaleRule(Optional.ToDictionary(metadata), Optional.ToList(auth));
        }
    }
}
