...
{
    public partial class ContainerAppGitHubActionConfiguration : IUtf8JsonSerializable, IJsonModel<ContainerAppGitHubActionConfiguration>, IPersistableModel<ContainerAppGitHubActionConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RegistryInfo))
            {
                ...
                AppendChildObject(builder, RegistryInfo, options, 2);
            }

            if (Optional.IsDefined(AzureCredentials))
            {
                builder.Append("  azureCredentials:");
                AppendChildObject(builder, AzureCredentials, options, 2);
            }
