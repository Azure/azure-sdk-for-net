...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppAzureActiveDirectoryLoginConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppAzureActiveDirectoryLoginConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppAzureActiveDirectoryLoginConfiguration>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppAzureActiveDirectoryLoginConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
