...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppJobScale>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppJobScale>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppJobScale>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContainerAppJobScale>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
