...
{
    public partial class ContainerAppJobScale : IUtf8JsonSerializable, IJsonModel<ContainerAppJobScale>, IPersistableModel<ContainerAppJobScale>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PollingIntervalInSeconds))
            {
                ...
                builder.AppendLine($" '{PollingIntervalInSeconds.Value.ToString()}'");
            }

            if (Optional.IsDefined(MinExecutions))
            {
                builder.Append("  minExecutions:");
                builder.AppendLine($" '{MinExecutions.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxExecutions))
            {
                builder.Append("  maxExecutions:");
                builder.AppendLine($" '{MaxExecutions.Value.ToString()}'");
            }
