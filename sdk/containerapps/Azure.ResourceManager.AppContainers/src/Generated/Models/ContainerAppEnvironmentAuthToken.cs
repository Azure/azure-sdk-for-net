...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppEnvironmentAuthToken : TrackedResourceData
    {
        ...
        internal ContainerAppEnvironmentAuthToken(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string token, DateTimeOffset? expires) : base(id, name, resourceType, systemData, tags, location)
        {
            Token = token;
            Expires = expires;
        }
