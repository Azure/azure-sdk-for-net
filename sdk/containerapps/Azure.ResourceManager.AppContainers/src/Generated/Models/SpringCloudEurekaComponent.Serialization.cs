...
{
    public partial class SpringCloudEurekaComponent : IUtf8JsonSerializable, IJsonModel<SpringCloudEurekaComponent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpringCloudEurekaComponent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SpringCloudEurekaComponent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        SpringCloudEurekaComponent IJsonModel<SpringCloudEurekaComponent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SpringCloudEurekaComponent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static SpringCloudEurekaComponent DeserializeSpringCloudEurekaComponent(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<SpringCloudEurekaComponent>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SpringCloudEurekaComponent>)this).GetFormatFromOptions(options) : options.Format;
        ...
        SpringCloudEurekaComponent IPersistableModel<SpringCloudEurekaComponent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SpringCloudEurekaComponent>)this).GetFormatFromOptions(options) : options.Format;
