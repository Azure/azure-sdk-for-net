...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppRevisionTrafficWeight>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppRevisionTrafficWeight>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppRevisionTrafficWeight>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppRevisionTrafficWeight>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppRevisionTrafficWeight>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
