...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class CustomDomainConfiguration
    {
        ...
        internal CustomDomainConfiguration(string customDomainVerificationId, string dnsSuffix, byte[] certificateValue, byte[] certificatePassword, DateTimeOffset? expireOn, string thumbprint, string subjectName)
        {
