...
{
    internal partial class ReplicaCollection : IUtf8JsonSerializable, IJsonModel<ReplicaCollection>, IPersistableModel<ReplicaCollection>
    {
        ...
        void IJsonModel<ReplicaCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReplicaCollection)} does not support '{format}' format.");
            }
