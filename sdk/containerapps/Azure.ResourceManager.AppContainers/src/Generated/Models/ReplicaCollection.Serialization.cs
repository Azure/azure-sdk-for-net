...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplicaCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReplicaCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReplicaCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReplicaCollection>)} interface");
            }
        ...
        string IPersistableModel<ReplicaCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
