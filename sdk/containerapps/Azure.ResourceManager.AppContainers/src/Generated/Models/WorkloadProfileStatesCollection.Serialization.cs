...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkloadProfileStatesCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkloadProfileStatesCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkloadProfileStatesCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkloadProfileStatesCollection>)} interface");
            }
        ...
        string IPersistableModel<WorkloadProfileStatesCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
