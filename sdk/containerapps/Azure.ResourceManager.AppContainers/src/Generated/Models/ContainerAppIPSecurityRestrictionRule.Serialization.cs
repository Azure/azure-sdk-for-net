...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppIPSecurityRestrictionRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppIPSecurityRestrictionRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppIPSecurityRestrictionRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppIPSecurityRestrictionRule>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppIPSecurityRestrictionRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
