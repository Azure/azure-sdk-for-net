...
{
    internal partial class UnknownJavaComponentProperties : IUtf8JsonSerializable, IJsonModel<JavaComponentProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JavaComponentProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static UnknownJavaComponentProperties DeserializeUnknownJavaComponentProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            JavaComponentType componentType = "Unknown";
            ...
            return new UnknownJavaComponentProperties(componentType, provisioningState, configurations ?? new ChangeTrackingList<JavaComponentConfigurationProperty>(), serviceBinds ?? new ChangeTrackingList<JavaComponentServiceBind>(), serializedAdditionalRawData);
        }
