...
{
    internal partial class UnknownJavaComponentProperties : JavaComponentProperties, IJsonModel<JavaComponentProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownJavaComponentProperties DeserializeUnknownJavaComponentProperties(JsonElement element, ModelReaderWriterOptions options)
        {
