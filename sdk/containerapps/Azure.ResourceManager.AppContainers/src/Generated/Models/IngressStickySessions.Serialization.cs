...
{
    internal partial class IngressStickySessions : IUtf8JsonSerializable, IJsonModel<IngressStickySessions>, IPersistableModel<IngressStickySessions>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Affinity))
            {
                ...
                builder.AppendLine($" '{Affinity.ToString()}'");
            }
