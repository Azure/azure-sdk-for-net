...
{
    public partial class ContainerAppAppleConfiguration : Core.IUtf8JsonSerializable
    {
        ...
        internal static ContainerAppAppleConfiguration DeserializeContainerAppAppleConfiguration(JsonElement element)
        {
            ...
            Core.Optional<ContainerAppAppleRegistrationConfiguration> registration = default;
            ...
            return new ContainerAppAppleConfiguration(Core.Optional.ToNullable(enabled), registration.Value, login.Value);
        }
    }
}
