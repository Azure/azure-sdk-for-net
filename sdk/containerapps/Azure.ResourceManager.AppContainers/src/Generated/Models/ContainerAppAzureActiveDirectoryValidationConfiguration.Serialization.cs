...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppAzureActiveDirectoryValidationConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppAzureActiveDirectoryValidationConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppAzureActiveDirectoryValidationConfiguration>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppAzureActiveDirectoryValidationConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
