...
{
    public partial class ContainerAppJobConfiguration : IUtf8JsonSerializable, IJsonModel<ContainerAppJobConfiguration>, IPersistableModel<ContainerAppJobConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReplicaTimeout))
            {
                ...
                builder.AppendLine($" '{ReplicaTimeout.ToString()}'");
            }

            if (Optional.IsDefined(ReplicaRetryLimit))
            {
                builder.Append("  replicaRetryLimit:");
                builder.AppendLine($" '{ReplicaRetryLimit.Value.ToString()}'");
            }

            if (Optional.IsDefined(ManualTriggerConfig))
            {
                builder.Append("  manualTriggerConfig:");
                AppendChildObject(builder, ManualTriggerConfig, options, 2);
            }

            if (Optional.IsDefined(ScheduleTriggerConfig))
            {
                builder.Append("  scheduleTriggerConfig:");
                AppendChildObject(builder, ScheduleTriggerConfig, options, 2);
            }

            if (Optional.IsDefined(EventTriggerConfig))
            {
                builder.Append("  eventTriggerConfig:");
                AppendChildObject(builder, EventTriggerConfig, options, 2);
            }
