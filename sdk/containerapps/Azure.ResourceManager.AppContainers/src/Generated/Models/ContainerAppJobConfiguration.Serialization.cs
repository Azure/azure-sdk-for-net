...
{
    public partial class ContainerAppJobConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ContainerAppJobConfiguration DeserializeContainerAppJobConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
