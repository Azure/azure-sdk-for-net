...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class VnetConfiguration
    {
        ...
        internal VnetConfiguration(bool? @internal, string infrastructureSubnetId, string runtimeSubnetId, string dockerBridgeCidr, string platformReservedCidr, string platformReservedDnsIP, ManagedEnvironmentOutboundSettings outboundSettings)
        {
            Internal = @internal;
        ...
        public ManagedEnvironmentOutboundSettings OutboundSettings { get; set; }
    }
}
