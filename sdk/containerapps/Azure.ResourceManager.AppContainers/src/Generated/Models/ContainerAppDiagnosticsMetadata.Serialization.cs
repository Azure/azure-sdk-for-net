...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppDiagnosticsMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppDiagnosticsMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppDiagnosticsMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppDiagnosticsMetadata>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppDiagnosticsMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
