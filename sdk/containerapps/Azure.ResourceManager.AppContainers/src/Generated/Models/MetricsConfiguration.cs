...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class MetricsConfiguration
    {
        ...
        /// <summary> Initializes a new instance of <see cref="MetricsConfiguration"/>. </summary>
        /// <param name="includeKeda"> Boolean indicating if including keda metrics. </param>
        /// <param name="destinations"> Open telemetry metrics destinations. </param>
        /// <param name="serializedAdditionalRawData"> Keeps track of any properties unknown to the library. </param>
        internal MetricsConfiguration(bool? includeKeda, IList<string> destinations, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public bool? IncludeKeda { get; set; }
