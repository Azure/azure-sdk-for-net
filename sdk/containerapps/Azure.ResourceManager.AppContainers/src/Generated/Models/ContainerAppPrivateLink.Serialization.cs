...
{
    public partial class ContainerAppPrivateLink : IUtf8JsonSerializable, IJsonModel<ContainerAppPrivateLink>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppPrivateLink>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerAppPrivateLink>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ContainerAppPrivateLink IJsonModel<ContainerAppPrivateLink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerAppPrivateLink>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ContainerAppPrivateLink DeserializeContainerAppPrivateLink(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ContainerAppPrivateLink>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerAppPrivateLink>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ContainerAppPrivateLink IPersistableModel<ContainerAppPrivateLink>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ContainerAppPrivateLink>)this).GetFormatFromOptions(options) : options.Format;
