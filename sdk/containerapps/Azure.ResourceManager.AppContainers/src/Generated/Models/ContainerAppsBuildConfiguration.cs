...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppsBuildConfiguration
    {
        ...
        internal ContainerAppsBuildConfiguration(string baseOs, string platform, string platformVersion, IReadOnlyList<EnvironmentVariable> environmentVariables, IReadOnlyList<PreBuildStep> preBuildSteps, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            BaseOs = baseOs;
            Platform = platform;
