...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    internal partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ContainerAppPrivateLinkServiceConnectionState connectionState = default;
            ContainerAppPrivateEndpointConnectionProvisioningState? provisioningState = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    connectionState = ContainerAppPrivateLinkServiceConnectionState.DeserializeContainerAppPrivateLinkServiceConnectionState(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new ContainerAppPrivateEndpointConnectionProvisioningState(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
