...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Runtime>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<Runtime>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Java))
            {
                ...
                writer.WriteObjectValue<RuntimeJava>(Java, options);
            }
            if (Optional.IsDefined(Dotnet))
            {
                writer.WritePropertyName("dotnet"u8);
                writer.WriteObjectValue<RuntimeDotnet>(Dotnet, options);
            }
