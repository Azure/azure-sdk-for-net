...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        internal static ContainerAppJobExecution DeserializeContainerAppJobExecution(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
