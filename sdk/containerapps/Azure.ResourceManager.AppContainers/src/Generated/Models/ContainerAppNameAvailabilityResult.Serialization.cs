...
namespace Azure.ResourceManager.AppContainers.Models
{
    public partial class ContainerAppNameAvailabilityResult
    {
        internal static ContainerAppNameAvailabilityResult DeserializeContainerAppNameAvailabilityResult(JsonElement element)
        {
            ...
            Core.Optional<ContainerAppNameUnavailableReason> reason = default;
            ...
            return new ContainerAppNameAvailabilityResult(Core.Optional.ToNullable(nameAvailable), Core.Optional.ToNullable(reason), message.Value);
        }
    }
}
