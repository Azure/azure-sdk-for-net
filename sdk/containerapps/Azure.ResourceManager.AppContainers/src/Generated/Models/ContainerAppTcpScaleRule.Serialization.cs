...
{
    public partial class ContainerAppTcpScaleRule : IUtf8JsonSerializable
    {
        ...
        internal static ContainerAppTcpScaleRule DeserializeContainerAppTcpScaleRule(JsonElement element)
        {
            ...
            return new ContainerAppTcpScaleRule(Optional.ToDictionary(metadata), Optional.ToList(auth));
        }
    }
}
