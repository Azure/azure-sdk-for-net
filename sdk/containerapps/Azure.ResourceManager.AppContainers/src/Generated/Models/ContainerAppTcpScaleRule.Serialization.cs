...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppTcpScaleRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppTcpScaleRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppTcpScaleRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppTcpScaleRule>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppTcpScaleRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
