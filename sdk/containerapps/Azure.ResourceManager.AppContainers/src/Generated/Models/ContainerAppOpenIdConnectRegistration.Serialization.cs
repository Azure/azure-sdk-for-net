...
{
    public partial class ContainerAppOpenIdConnectRegistration : IUtf8JsonSerializable, IJsonModel<ContainerAppOpenIdConnectRegistration>, IPersistableModel<ContainerAppOpenIdConnectRegistration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClientCredential))
            {
                ...
                AppendChildObject(builder, ClientCredential, options, 2);
            }

            if (Optional.IsDefined(OpenIdConnectConfiguration))
            {
                builder.Append("  openIdConnectConfiguration:");
                AppendChildObject(builder, OpenIdConnectConfiguration, options, 2);
            }
