...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class IngressPortMapping : IJsonModel<IngressPortMapping>
    {
        ...
        protected virtual IngressPortMapping PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<IngressPortMapping>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<IngressPortMapping>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        IngressPortMapping IPersistableModel<IngressPortMapping>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        IngressPortMapping IJsonModel<IngressPortMapping>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual IngressPortMapping JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<IngressPortMapping>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static IngressPortMapping DeserializeIngressPortMapping(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new IngressPortMapping(external, targetPort, exposedPort, additionalBinaryDataProperties);
        }
    }
}
