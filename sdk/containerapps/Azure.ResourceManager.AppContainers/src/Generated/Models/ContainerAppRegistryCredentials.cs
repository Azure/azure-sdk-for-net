...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppRegistryCredentials
    {
        ...
        internal ContainerAppRegistryCredentials(string server, string username, string passwordSecretRef, string identity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Server = server;
            Username = username;
