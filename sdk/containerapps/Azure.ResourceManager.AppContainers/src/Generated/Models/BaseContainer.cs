...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class BaseContainer
    {
        ...
        internal BaseContainer(string image, string name, IList<string> command, IList<string> args, IList<EnvironmentVar> env, ContainerResources resources, IList<ContainerAppVolumeMount> volumeMounts)
        {
            Image = image;
            Name = name;
            Command = command;
