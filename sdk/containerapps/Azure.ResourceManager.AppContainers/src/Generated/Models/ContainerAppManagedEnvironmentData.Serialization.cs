...
namespace Azure.ResourceManager.AppContainers
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppManagedEnvironmentData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppManagedEnvironmentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppManagedEnvironmentData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppManagedEnvironmentData>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppManagedEnvironmentData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
