...
{
    public partial class AllowedPrincipals : IUtf8JsonSerializable
    {
        ...
        internal static AllowedPrincipals DeserializeAllowedPrincipals(JsonElement element)
        {
            ...
            return new AllowedPrincipals(Optional.ToList(groups), Optional.ToList(identities));
        }
    }
}
