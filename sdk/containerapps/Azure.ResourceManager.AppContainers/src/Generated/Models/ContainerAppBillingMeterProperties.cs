...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppBillingMeterProperties
    {
        ...
        internal ContainerAppBillingMeterProperties(string workloadProfileCategory, string meterType, string displayName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
