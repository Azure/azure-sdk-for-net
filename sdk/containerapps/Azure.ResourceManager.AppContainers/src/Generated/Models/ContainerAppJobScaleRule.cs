...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppJobScaleRule
    {
        ...
        internal ContainerAppJobScaleRule(string name, string jobScaleRuleType, BinaryData metadata, IList<ContainerAppScaleRuleAuth> auth, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
