...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppJobScaleRule
    {
        ...
        internal ContainerAppJobScaleRule(string name, string jobScaleRuleType, BinaryData metadata, IList<ContainerAppScaleRuleAuth> auth, string identity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
