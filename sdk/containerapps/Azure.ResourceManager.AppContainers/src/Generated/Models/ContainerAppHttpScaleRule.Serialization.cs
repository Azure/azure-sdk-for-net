...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppHttpScaleRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppHttpScaleRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppHttpScaleRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppHttpScaleRule>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppHttpScaleRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
