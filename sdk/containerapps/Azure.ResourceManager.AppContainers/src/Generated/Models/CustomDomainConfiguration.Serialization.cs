...
{
    public partial class CustomDomainConfiguration : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(CertificatePassword))
            {
                ...
                writer.WriteBase64StringValue(CertificatePassword, "D");
            }
            writer.WriteEndObject();
        }

        internal static CustomDomainConfiguration DeserializeCustomDomainConfiguration(JsonElement element)
        {
            ...
            Optional<byte[]> certificatePassword = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("certificatePassword"))
                {
                    ...
                    certificatePassword = property.Value.GetBytesFromBase64("D");
                    continue;
                }
            ...
            return new CustomDomainConfiguration(customDomainVerificationId.Value, dnsSuffix.Value, certificateValue.Value, certificatePassword.Value, Optional.ToNullable(expirationDate), thumbprint.Value, subjectName.Value);
        }
    }
}
