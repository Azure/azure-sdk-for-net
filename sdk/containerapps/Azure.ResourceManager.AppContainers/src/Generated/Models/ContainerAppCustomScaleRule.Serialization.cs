...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppCustomScaleRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppCustomScaleRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppCustomScaleRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppCustomScaleRule>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppCustomScaleRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
