...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppRegistryCredentials>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppRegistryCredentials>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppRegistryCredentials>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppRegistryCredentials>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppRegistryCredentials>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
