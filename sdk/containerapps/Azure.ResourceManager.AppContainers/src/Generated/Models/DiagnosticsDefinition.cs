...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class DiagnosticsDefinition : ResourceData
    {
        /// <summary> Initializes a new instance of DiagnosticsDefinition. </summary>
        public DiagnosticsDefinition()
        {
            SupportTopicList = new ChangeTrackingList<DiagnosticSupportTopic>();
        ...
        internal DiagnosticsDefinition(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, string author, string category, IList<DiagnosticSupportTopic> supportTopicList, IList<string> analysisTypes, float? score) : base(id, name, resourceType, systemData)
        {
        ...
        public IList<DiagnosticSupportTopic> SupportTopicList { get; }
