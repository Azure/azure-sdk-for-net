...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedEnvironmentsCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedEnvironmentsCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedEnvironmentsCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedEnvironmentsCollection>)} interface");
            }
        ...
        string IPersistableModel<ManagedEnvironmentsCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
