...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class DiagnosticDataTableResponseObject
    {
        ...
        {
            Columns = new ChangeTrackingList<DiagnosticDataTableResponseColumn>();
        ...
        internal DiagnosticDataTableResponseObject(string tableName, IList<DiagnosticDataTableResponseColumn> columns, IList<BinaryData> rows)
        {
            TableName = tableName;
            Columns = columns;
            Rows = rows;
        ...
        public IList<DiagnosticDataTableResponseColumn> Columns { get; }
        /// <summary>
        /// Rows in the table
        /// <para>
