...
namespace Azure.ResourceManager.AppContainers
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppManagedEnvironmentStorageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppManagedEnvironmentStorageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppManagedEnvironmentStorageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContainerAppManagedEnvironmentStorageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
