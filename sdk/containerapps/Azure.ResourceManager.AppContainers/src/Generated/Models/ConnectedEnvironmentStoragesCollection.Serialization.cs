...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectedEnvironmentStoragesCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectedEnvironmentStoragesCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectedEnvironmentStoragesCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ConnectedEnvironmentStoragesCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
