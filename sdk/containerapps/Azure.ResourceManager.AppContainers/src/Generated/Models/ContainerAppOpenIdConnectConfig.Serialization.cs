...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppOpenIdConnectConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppOpenIdConnectConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppOpenIdConnectConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContainerAppOpenIdConnectConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
