...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppScaleRule
    {
        ...
        internal ContainerAppScaleRule(string name, ContainerAppQueueScaleRule azureQueue, ContainerAppCustomScaleRule custom, ContainerAppHttpScaleRule http, ContainerAppTcpScaleRule tcp, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
