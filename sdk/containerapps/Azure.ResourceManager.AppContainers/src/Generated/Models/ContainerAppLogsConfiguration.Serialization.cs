...
{
    public partial class ContainerAppLogsConfiguration : IUtf8JsonSerializable, IJsonModel<ContainerAppLogsConfiguration>, IPersistableModel<ContainerAppLogsConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LogAnalyticsConfiguration))
            {
                ...
                AppendChildObject(builder, LogAnalyticsConfiguration, options, 2);
            }
