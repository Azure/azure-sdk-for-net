...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TokenStore>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TokenStore>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AzureBlobStorage))
            {
                ...
                writer.WriteObjectValue<BlobStorageTokenStore>(AzureBlobStorage, options);
            }
