...
{
    public partial class ContainerAppCustomDomainVerificationFailureInfo : IUtf8JsonSerializable, IJsonModel<ContainerAppCustomDomainVerificationFailureInfo>, IPersistableModel<ContainerAppCustomDomainVerificationFailureInfo>
    {
        ...
        void IJsonModel<ContainerAppCustomDomainVerificationFailureInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerAppCustomDomainVerificationFailureInfo)} does not support '{format}' format.");
            }
