...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppCustomDomainVerificationFailureInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppCustomDomainVerificationFailureInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppCustomDomainVerificationFailureInfo>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppCustomDomainVerificationFailureInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
