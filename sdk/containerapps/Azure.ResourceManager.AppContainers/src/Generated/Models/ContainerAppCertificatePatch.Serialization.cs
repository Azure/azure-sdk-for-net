...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppCertificatePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContainerAppCertificatePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContainerAppCertificatePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContainerAppCertificatePatch>)} interface");
            }
        ...
        string IPersistableModel<ContainerAppCertificatePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
