...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppHttpScaleRule
    {
        ...
        internal ContainerAppHttpScaleRule(IDictionary<string, string> metadata, IList<ContainerAppScaleRuleAuth> auth, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Metadata = metadata;
            Auth = auth;
