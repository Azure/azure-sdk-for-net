...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class JobConfigurationScheduleTriggerConfig
    {
        ...
        internal JobConfigurationScheduleTriggerConfig(int? replicaCompletionCount, string cronExpression, int? parallelism, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
