...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppCustomDomainConfiguration
    {
        ...
        internal ContainerAppCustomDomainConfiguration(string customDomainVerificationId, string dnsSuffix, byte[] certificateValue, string certificatePassword, DateTimeOffset? expireOn, string thumbprint, string subjectName, Dictionary<string, BinaryData> rawData)
        {
