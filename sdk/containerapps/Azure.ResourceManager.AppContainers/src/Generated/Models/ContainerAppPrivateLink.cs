...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppPrivateLink : ResourceData
    {
        ...
        internal ContainerAppPrivateLink(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AppContainersPrivateLinkResourceProperties properties) : base(id, name, resourceType, systemData)
        {
