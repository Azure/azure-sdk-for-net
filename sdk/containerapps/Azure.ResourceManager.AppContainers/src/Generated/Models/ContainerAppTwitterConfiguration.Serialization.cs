...
{
    public partial class ContainerAppTwitterConfiguration : IUtf8JsonSerializable, IJsonModel<ContainerAppTwitterConfiguration>, IPersistableModel<ContainerAppTwitterConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerAppTwitterConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContainerAppTwitterConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerAppTwitterConfiguration)} does not support '{format}' format.");
            }
