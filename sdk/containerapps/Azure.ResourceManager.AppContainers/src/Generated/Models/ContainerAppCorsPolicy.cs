...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    public partial class ContainerAppCorsPolicy
    {
        ...
        internal ContainerAppCorsPolicy(IList<string> allowedOrigins, IList<string> allowedMethods, IList<string> allowedHeaders, IList<string> exposeHeaders, int? maxAge, bool? allowCredentials, Dictionary<string, BinaryData> rawData)
        {
