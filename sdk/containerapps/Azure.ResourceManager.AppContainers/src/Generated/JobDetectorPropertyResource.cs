...
namespace Azure.ResourceManager.AppContainers
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="JobResource"/> using the GetJobDetectorProperty method.
    /// </summary>
    public partial class JobDetectorPropertyResource : ArmResource
    {
        ...
        {
            var resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/jobs/{jobName}/detectorProperties/rootApi";
        ...
        public virtual async Task<Response<JobDetectorPropertyResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _jobDetectorPropertyJobsRestClient.ProxyGetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<JobDetectorPropertyResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _jobDetectorPropertyJobsRestClient.ProxyGet(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new JobDetectorPropertyResource(Client, response.Value), response.GetRawResponse());
            }
