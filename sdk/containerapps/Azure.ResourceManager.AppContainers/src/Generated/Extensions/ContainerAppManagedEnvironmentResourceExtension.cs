...
namespace Azure.ResourceManager.AppContainers.Mock
{
    ...
    public partial class ContainerAppManagedEnvironmentResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ContainerAppManagedEnvironmentResourceExtension"/> class for mocking. </summary>
        protected ContainerAppManagedEnvironmentResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerAppManagedEnvironmentResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerAppManagedEnvironmentResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ContainerAppManagedEnvironmentResource> GetContainerAppManagedEnvironmentsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ContainerAppManagedEnvironmentResource(Client, ContainerAppManagedEnvironmentData.DeserializeContainerAppManagedEnvironmentData(e)), ContainerAppManagedEnvironmentManagedEnvironmentsClientDiagnostics, Pipeline, "ContainerAppManagedEnvironmentResourceExtension.GetContainerAppManagedEnvironments", "value", "nextLink", cancellationToken);
        }
