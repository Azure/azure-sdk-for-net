...
namespace Azure.ResourceManager.AppContainers
{
    ...
    {
        private static ContainerAppConnectedEnvironmentResourceExtensionClient GetContainerAppConnectedEnvironmentResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ContainerAppConnectedEnvironmentResourceExtensionClient(client, resource.Id);
            });
        }

        private static ContainerAppConnectedEnvironmentResourceExtensionClient GetContainerAppConnectedEnvironmentResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ContainerAppConnectedEnvironmentResourceExtensionClient(client, scope);
            });
        }

        private static ContainerAppManagedEnvironmentResourceExtensionClient GetContainerAppManagedEnvironmentResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ContainerAppManagedEnvironmentResourceExtensionClient(client, resource.Id);
            });
        }

        private static ContainerAppManagedEnvironmentResourceExtensionClient GetContainerAppManagedEnvironmentResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ContainerAppManagedEnvironmentResourceExtensionClient(client, scope);
            });
        }

        private static ContainerAppResourceExtensionClient GetContainerAppResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ContainerAppResourceExtensionClient(client, resource.Id);
            });
        }

        private static ContainerAppResourceExtensionClient GetContainerAppResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new ContainerAppResourceExtensionClient(client, scope);
            });
        }
        ...
        {
            return GetContainerAppConnectedEnvironmentResourceExtensionClient(subscriptionResource).GetContainerAppConnectedEnvironmentsAsync(cancellationToken);
        }
        ...
        {
            return GetContainerAppConnectedEnvironmentResourceExtensionClient(subscriptionResource).GetContainerAppConnectedEnvironments(cancellationToken);
        }
        ...
        {
            return GetContainerAppResourceExtensionClient(subscriptionResource).GetContainerAppsAsync(cancellationToken);
        }
        ...
        {
            return GetContainerAppResourceExtensionClient(subscriptionResource).GetContainerApps(cancellationToken);
        }
        ...
        {
            return GetContainerAppManagedEnvironmentResourceExtensionClient(subscriptionResource).GetContainerAppManagedEnvironmentsAsync(cancellationToken);
        }
        ...
        {
            return GetContainerAppManagedEnvironmentResourceExtensionClient(subscriptionResource).GetContainerAppManagedEnvironments(cancellationToken);
        }
    }
}
