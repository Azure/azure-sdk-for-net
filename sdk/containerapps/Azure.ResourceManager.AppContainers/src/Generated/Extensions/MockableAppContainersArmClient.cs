...
namespace Azure.ResourceManager.AppContainers.Mocking
{
    ...
    public partial class MockableAppContainersArmClient : ArmResource
    {
        ...
        public virtual AppContainersPrivateEndpointConnectionResource GetAppContainersPrivateEndpointConnectionResource(ResourceIdentifier id)
        {
            AppContainersPrivateEndpointConnectionResource.ValidateResourceId(id);
            return new AppContainersPrivateEndpointConnectionResource(Client, id);
        }
