...
namespace Azure.ResourceManager.AppContainers.Mock
{
    ...
    public partial class ContainerAppResourceExtension : ArmResource
    {
        private ClientDiagnostics _containerAppClientDiagnostics;
        private ContainerAppsRestOperations _containerAppRestClient;

        /// <summary> Initializes a new instance of the <see cref="ContainerAppResourceExtension"/> class for mocking. </summary>
        protected ContainerAppResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ContainerAppResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ContainerAppResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ContainerAppResource> GetContainerAppsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ContainerAppResource(Client, ContainerAppData.DeserializeContainerAppData(e)), ContainerAppClientDiagnostics, Pipeline, "ContainerAppResourceExtension.GetContainerApps", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ContainerAppResource> GetContainerApps(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ContainerAppRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ContainerAppRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ContainerAppResource(Client, ContainerAppData.DeserializeContainerAppData(e)), ContainerAppClientDiagnostics, Pipeline, "ContainerAppResourceExtension.GetContainerApps", "value", "nextLink", cancellationToken);
        }
    }
}
