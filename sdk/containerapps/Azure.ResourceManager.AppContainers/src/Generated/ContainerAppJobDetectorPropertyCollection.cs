...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppJobDetectorPropertyCollection : ArmCollection
    {
        ...
        public virtual async Task<Response<ContainerAppJobDetectorPropertyResource>> GetAsync(string apiName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _containerAppJobsClientDiagnostics.CreateScope("ContainerAppJobDetectorPropertyCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _containerAppJobsRestClient.CreateProxyGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, apiName, context);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string apiName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _containerAppJobsClientDiagnostics.CreateScope("ContainerAppJobDetectorPropertyCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ContainerAppJobDetectorPropertyResource>> GetIfExistsAsync(string apiName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _containerAppJobsClientDiagnostics.CreateScope("ContainerAppJobDetectorPropertyCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
