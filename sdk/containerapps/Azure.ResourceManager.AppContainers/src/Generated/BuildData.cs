...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class BuildData : ResourceData
    {
        ...
        internal BuildData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BuildProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
