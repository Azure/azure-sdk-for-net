...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class WorkflowEnvelopeData : ResourceData
    {
        ...
        internal WorkflowEnvelopeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, WorkflowKind? kind, WorkflowEnvelopeProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
