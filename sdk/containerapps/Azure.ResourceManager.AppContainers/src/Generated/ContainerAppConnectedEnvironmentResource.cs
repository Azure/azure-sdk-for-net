...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppConnectedEnvironmentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _containerAppConnectedEnvironmentConnectedEnvironmentsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = await _containerAppConnectedEnvironmentConnectedEnvironmentsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new AppContainersArmOperation(_containerAppConnectedEnvironmentConnectedEnvironmentsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _containerAppConnectedEnvironmentConnectedEnvironmentsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = _containerAppConnectedEnvironmentConnectedEnvironmentsRestClient.Delete(message, cancellationToken);
                var operation = new AppContainersArmOperation(_containerAppConnectedEnvironmentConnectedEnvironmentsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
