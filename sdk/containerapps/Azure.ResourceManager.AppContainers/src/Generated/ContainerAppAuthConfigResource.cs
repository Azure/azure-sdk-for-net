...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppAuthConfigResource : ArmResource
    {
        ...
        internal ContainerAppAuthConfigResource(ArmClient client, ContainerAppAuthConfigData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ContainerAppAuthConfigResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ContainerAppAuthConfigResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<ContainerAppAuthConfigResource>> UpdateAsync(WaitUntil waitUntil, ContainerAppAuthConfigData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AppContainersArmOperation<ContainerAppAuthConfigResource>(Response.FromValue(new ContainerAppAuthConfigResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
