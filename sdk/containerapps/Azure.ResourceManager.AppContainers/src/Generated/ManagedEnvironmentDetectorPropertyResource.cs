...
{
    /// <summary>
    /// A Class representing a ManagedEnvironmentDetectorProperty along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="ManagedEnvironmentDetectorPropertyResource" />
    ...
    public partial class ManagedEnvironmentDetectorPropertyResource : ArmResource
    {
        ...
        internal ManagedEnvironmentDetectorPropertyResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
