...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppManagedEnvironmentDaprComponentResource : ArmResource
    {
        ...
        {
            async Task<Page<ContainerAppDaprSecret>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _containerAppManagedEnvironmentDaprComponentDaprComponentsClientDiagnostics.CreateScope("ContainerAppManagedEnvironmentDaprComponentResource.GetSecrets");
                scope.Start();
                try
                {
                    var response = await _containerAppManagedEnvironmentDaprComponentDaprComponentsRestClient.ListSecretsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        {
            Page<ContainerAppDaprSecret> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _containerAppManagedEnvironmentDaprComponentDaprComponentsClientDiagnostics.CreateScope("ContainerAppManagedEnvironmentDaprComponentResource.GetSecrets");
                scope.Start();
                try
                {
                    var response = _containerAppManagedEnvironmentDaprComponentDaprComponentsRestClient.ListSecrets(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
