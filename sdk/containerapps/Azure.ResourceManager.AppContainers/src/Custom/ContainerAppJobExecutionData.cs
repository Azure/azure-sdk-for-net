...
namespace Azure.ResourceManager.AppContainers
{
    ...
    public partial class ContainerAppJobExecutionData : ResourceData
    {
        ...
        internal ContainerAppJobExecutionData(ResourceIdentifier id, string name, ResourceType resourceType, ResourceManager.Models.SystemData systemData, JobExecutionRunningState? status, DateTimeOffset? startOn, DateTimeOffset? endOn, ContainerAppJobExecutionTemplate template) : base(id, name, resourceType, systemData)
        {
            Status = status;
            StartOn = startOn;
            EndOn = endOn;
        ...
        [CodeGenMemberSerialization("properties", "status")]
        public JobExecutionRunningState? Status { get; }
        /// <summary> Job execution start time. </summary>
        [CodeGenMemberSerialization("properties", "startOn")]
        public DateTimeOffset? StartOn { get; }
        /// <summary> Job execution end time. </summary>
        [CodeGenMemberSerialization("properties", "endOn")]
        public DateTimeOffset? EndOn { get; }
        /// <summary> Job's execution container. </summary>
        [CodeGenMemberSerialization("properties", "template")]
