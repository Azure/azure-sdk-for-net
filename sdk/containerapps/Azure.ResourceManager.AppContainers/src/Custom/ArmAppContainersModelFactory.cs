...
namespace Azure.ResourceManager.AppContainers.Models
{
    ...
    [CodeGenSuppress("ContainerAppConfiguration", typeof(IEnumerable<ContainerAppWritableSecret>), typeof(ContainerAppActiveRevisionsMode?), typeof(ContainerAppIngressConfiguration), typeof(IEnumerable<ContainerAppRegistryCredentials>), typeof(ContainerAppDaprConfiguration), typeof(bool?), typeof(int?), typeof(string), typeof(IEnumerable<ContainerAppIdentitySettings>))]
