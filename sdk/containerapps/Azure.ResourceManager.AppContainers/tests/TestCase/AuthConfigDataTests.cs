...
namespace Azure.ResourceManager.AppContainers.Tests
{
    public class AuthConfigDataTests : AppContainersManagementTestBase
    {
        ...
        public async Task AppContainerTest()
        {
            ...
            string name = "current";
            //string name2 = Recording.GenerateAssetName("authconfig");
            //string name3 = Recording.GenerateAssetName("authconfig");
            ...
            ResourceDataHelpers.AssertContainerAppAuthConfigData(resource.Data, resource2.Value.Data);
            //3.GetAll
            ...
            ResourceDataHelpers.AssertContainerAppAuthConfigData(resource.Data, resource3.Value.Data);
            //6.Delete
