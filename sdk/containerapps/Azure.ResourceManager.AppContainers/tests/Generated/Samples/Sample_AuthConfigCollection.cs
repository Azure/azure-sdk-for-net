...
{
    public partial class Sample_AuthConfigCollection
    {
        ...
        {
            // Generated from example definition: specification/app/resource-manager/Microsoft.App/preview/2022-06-01-preview/examples/AuthConfigs_ListByContainer.json
            ...
            // get the collection of this AuthConfigResource
            AuthConfigCollection collection = containerApp.GetAuthConfigs();

            // invoke the operation and iterate over the result
            await foreach (AuthConfigResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                AuthConfigData resourceData = item.Data;
        ...
        public async Task Get_GetContainerAppSAuthConfig()
        {
            ...
            AuthConfigResource result = await collection.GetAsync(authConfigName);
        ...
        public async Task CreateOrUpdate_CreateOrUpdateContainerAppAuthConfig()
        {
            ...
            ArmOperation<AuthConfigResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, authConfigName, data);
