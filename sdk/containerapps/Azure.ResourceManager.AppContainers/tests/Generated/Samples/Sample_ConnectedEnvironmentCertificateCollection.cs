...
{
    public partial class Sample_ConnectedEnvironmentCertificateCollection
    {
        ...
        {
            // Generated from example definition: specification/app/resource-manager/Microsoft.App/preview/2022-06-01-preview/examples/ConnectedEnvironmentsCertificates_ListByConnectedEnvironment.json
            ...
            // get the collection of this ConnectedEnvironmentCertificateResource
            ConnectedEnvironmentCertificateCollection collection = connectedEnvironment.GetConnectedEnvironmentCertificates();

            // invoke the operation and iterate over the result
            await foreach (ConnectedEnvironmentCertificateResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetCertificate()
        {
            ...
            ConnectedEnvironmentCertificateResource result = await collection.GetAsync(certificateName);
        ...
        {
            // Generated from example definition: specification/app/resource-manager/Microsoft.App/preview/2022-06-01-preview/examples/ConnectedEnvironmentsCertificate_CreateOrUpdate.json
            ...
            ArmOperation<ConnectedEnvironmentCertificateResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, certificateName, data);
            ConnectedEnvironmentCertificateResource result = lro.Value;
