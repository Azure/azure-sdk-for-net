...
namespace Azure.ResourceManager.Applications.Containers
{
    ...
    /// Each <see cref="CertificateResource" /> in the collection will belong to the same instance of <see cref="ManagedEnvironmentResource" />.
    /// To get a <see cref="CertificateCollection" /> instance call the GetCertificates method from an instance of <see cref="ManagedEnvironmentResource" />.
    /// </summary>
    public partial class CertificateCollection : ArmCollection, IEnumerable<CertificateResource>, IAsyncEnumerable<CertificateResource>
    {
        ...
        {
            _certificateClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Applications.Containers", CertificateResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<CertificateResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, CertificateData data = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _certificateRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, data, cancellationToken).ConfigureAwait(false);
                var operation = new ContainersArmOperation<CertificateResource>(Response.FromValue(new CertificateResource(Client, response), response.GetRawResponse()));
        ...
        /// <exception cref="ArgumentException"> <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        public virtual ArmOperation<CertificateResource> CreateOrUpdate(WaitUntil waitUntil, string name, CertificateData data = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            ...
            try
            {
                var response = _certificateRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, data, cancellationToken);
                var operation = new ContainersArmOperation<CertificateResource>(Response.FromValue(new CertificateResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<CertificateResource>> GetAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _certificateRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CertificateResource> Get(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _certificateRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new CertificateResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual AsyncPageable<CertificateResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<CertificateResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _certificateRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<CertificateResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _certificateRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new CertificateResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<CertificateResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<CertificateResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _certificateRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new CertificateResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<CertificateResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _certificateRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new CertificateResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _certificateRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _certificateRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
