...
namespace Azure.ResourceManager.Applications.Containers
{
    ...
    public partial class AuthConfigResource : ArmResource
    {
        ...
        {
            var resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.App/containerApps/{containerAppName}/authConfigs/{name}";
        ...
        {
            _authConfigContainerAppsAuthConfigsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Applications.Containers", ResourceType.Namespace, Diagnostics);
