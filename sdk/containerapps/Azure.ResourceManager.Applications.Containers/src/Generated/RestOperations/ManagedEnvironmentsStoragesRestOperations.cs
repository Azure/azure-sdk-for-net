...
namespace Azure.ResourceManager.Applications.Containers
{
    internal partial class ManagedEnvironmentsStoragesRestOperations
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ManagedEnvironmentsStoragesRestOperations" />. </summary>
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string environmentName, string storageName, ManagedEnvironmentStorageData data)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
