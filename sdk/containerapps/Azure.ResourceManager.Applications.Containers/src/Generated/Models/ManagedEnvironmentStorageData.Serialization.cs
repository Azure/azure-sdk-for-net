...
{
    public partial class ManagedEnvironmentStorageData : IUtf8JsonSerializable
    {
        ...
        internal static ManagedEnvironmentStorageData DeserializeManagedEnvironmentStorageData(JsonElement element)
        {
            ...
            return new ManagedEnvironmentStorageData(id, name, type, systemData.Value, properties.Value);
        }
    }
}
