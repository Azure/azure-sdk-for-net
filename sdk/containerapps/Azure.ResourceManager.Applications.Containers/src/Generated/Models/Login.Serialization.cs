...
namespace Azure.ResourceManager.Applications.Containers.Models
{
    public partial class Login : IUtf8JsonSerializable
    {
        ...
        internal static Login DeserializeLogin(JsonElement element)
        {
            ...
            return new Login(routes.Value, Optional.ToNullable(preserveUrlFragmentsForLogins), Optional.ToList(allowedExternalRedirectUrls), cookieExpiration.Value, nonce.Value);
        }
    }
}
