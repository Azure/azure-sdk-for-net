...
{
    public partial class FacebookProvider : IUtf8JsonSerializable
    {
        ...
        internal static FacebookProvider DeserializeFacebookProvider(JsonElement element)
        {
            ...
            return new FacebookProvider(Optional.ToNullable(enabled), registration.Value, graphApiVersion.Value, login.Value);
        }
    }
}
