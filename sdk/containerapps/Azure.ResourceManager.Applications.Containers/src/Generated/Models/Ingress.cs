...
namespace Azure.ResourceManager.Applications.Containers.Models
{
    ...
    public partial class Ingress
    {
        ...
        internal Ingress(string fqdn, bool? external, int? targetPort, IngressTransportMethod? transport, IList<TrafficWeight> traffic, IList<CustomDomain> customDomains, bool? allowInsecure)
        {
            Fqdn = fqdn;
            External = external;
