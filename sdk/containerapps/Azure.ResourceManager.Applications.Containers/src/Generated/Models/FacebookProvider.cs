...
namespace Azure.ResourceManager.Applications.Containers.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="FacebookProvider"/>. </summary>
        ...
        internal FacebookProvider(bool? enabled, AppRegistration registration, string graphApiVersion, LoginScopes login)
        {
            Enabled = enabled;
