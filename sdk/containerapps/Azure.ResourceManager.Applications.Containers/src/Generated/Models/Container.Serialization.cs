...
namespace Azure.ResourceManager.Applications.Containers.Models
{
    public partial class Container : IUtf8JsonSerializable
    {
        ...
        internal static Container DeserializeContainer(JsonElement element)
        {
            ...
            return new Container(image.Value, name.Value, Optional.ToList(command), Optional.ToList(args), Optional.ToList(env), resources.Value, Optional.ToList(probes), Optional.ToList(volumeMounts));
        }
    }
}
