...
{
    public partial class GoogleProvider : IUtf8JsonSerializable
    {
        ...
        internal static GoogleProvider DeserializeGoogleProvider(JsonElement element)
        {
            ...
            return new GoogleProvider(Optional.ToNullable(enabled), registration.Value, login.Value, validation.Value);
        }
    }
}
