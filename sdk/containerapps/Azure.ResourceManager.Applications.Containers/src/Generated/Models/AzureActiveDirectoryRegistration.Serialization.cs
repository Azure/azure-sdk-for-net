...
namespace Azure.ResourceManager.Applications.Containers.Models
{
    public partial class AzureActiveDirectoryRegistration : IUtf8JsonSerializable
    {
        ...
        internal static AzureActiveDirectoryRegistration DeserializeAzureActiveDirectoryRegistration(JsonElement element)
        {
            ...
            return new AzureActiveDirectoryRegistration(openIdIssuer.Value, clientId.Value, clientSecretSettingName.Value, clientSecretCertificateThumbprint.Value, clientSecretCertificateSubjectAlternativeName.Value, clientSecretCertificateIssuer.Value);
        }
    }
}
