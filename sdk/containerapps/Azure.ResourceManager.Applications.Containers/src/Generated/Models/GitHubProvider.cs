...
namespace Azure.ResourceManager.Applications.Containers.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="GitHubProvider"/>. </summary>
        ...
        internal GitHubProvider(bool? enabled, ClientRegistration registration, LoginScopes login)
        {
            Enabled = enabled;
