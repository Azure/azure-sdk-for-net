...
namespace Azure.ResourceManager.Applications.Containers
{
    public partial class RevisionData : IUtf8JsonSerializable
    {
        ...
        internal static RevisionData DeserializeRevisionData(JsonElement element)
        {
            ...
            return new RevisionData(id, name, type, systemData, Optional.ToNullable(createdTime), fqdn.Value, template.Value, Optional.ToNullable(active), Optional.ToNullable(replicas), Optional.ToNullable(trafficWeight), provisioningError.Value, Optional.ToNullable(healthState), Optional.ToNullable(provisioningState));
        }
    }
}
