...
namespace Azure.ResourceManager.Applications.Containers.Models
{
    public partial class Ingress : IUtf8JsonSerializable
    {
        ...
        internal static Ingress DeserializeIngress(JsonElement element)
        {
            ...
            return new Ingress(fqdn.Value, Optional.ToNullable(external), Optional.ToNullable(targetPort), Optional.ToNullable(transport), Optional.ToList(traffic), Optional.ToList(customDomains), Optional.ToNullable(allowInsecure));
        }
    }
}
