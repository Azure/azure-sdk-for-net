...
{
    public partial class ScaleRuleAuth : IUtf8JsonSerializable
    {
        ...
        internal static ScaleRuleAuth DeserializeScaleRuleAuth(JsonElement element)
        {
            ...
            return new ScaleRuleAuth(secretRef.Value, triggerParameter.Value);
        }
    }
}
