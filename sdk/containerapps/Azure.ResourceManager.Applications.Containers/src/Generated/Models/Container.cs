...
namespace Azure.ResourceManager.Applications.Containers.Models
{
    ...
    public partial class Container
    {
        ...
        internal Container(string image, string name, IList<string> command, IList<string> args, IList<EnvironmentVar> env, ContainerResources resources, IList<ContainerAppProbe> probes, IList<VolumeMount> volumeMounts)
        {
            Image = image;
            Name = name;
            Command = command;
