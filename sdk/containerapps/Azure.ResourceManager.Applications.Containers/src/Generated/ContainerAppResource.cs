...
namespace Azure.ResourceManager.Applications.Containers
{
    ...
    public partial class ContainerAppResource : ArmResource
    {
        ...
        {
            _containerAppClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Applications.Containers", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ContainersArmOperation(_containerAppClientDiagnostics, Pipeline, _containerAppRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
