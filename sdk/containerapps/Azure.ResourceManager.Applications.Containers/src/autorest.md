...
rename-rules:
  ...
  SSO: Sso
  URI: Uri
  ContainerAppProbeHttpGetHttpHeadersItem: HttpHeaderData  # This is a workaroud to short the long name which is generated by m4 and the directive can't rename it
directive:
  ...
  - from: CommonDefinitions.json
    ...
    transform: >
      ...
      $.ContainerAppProbe.properties.httpGet.properties.host['x-ms-client-name'] = 'HttpHost';
      $.ContainerAppProbe.properties.httpGet.properties.port['x-ms-client-name'] = 'HttpPort';
      $.ContainerAppProbe.properties.httpGet['x-ms-client-flatten'] = true;
