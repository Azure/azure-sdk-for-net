# Azure.Containers.ContainerApps.Sandbox client library for .NET

Azure.Containers.ContainerApps.Sandbox is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Azure.Containers.ContainerApps.Sandbox --prerelease
```
