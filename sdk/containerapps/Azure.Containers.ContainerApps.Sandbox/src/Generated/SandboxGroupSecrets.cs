...
namespace Azure.Containers.ContainerApps.Sandbox
{
    ...
    public partial class SandboxGroupSecrets
    {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("SandboxGroupSecrets.PeekSecret");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(secretId, nameof(secretId));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("SandboxGroupSecrets.SetSecret");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(secretId, nameof(secretId));
        ...
        /// <exception cref="ArgumentException"> <paramref name="secretId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<SandboxSecret> SetSecret(string secretId, CreateSecretContent body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(secretId, nameof(secretId));
        ...
        /// <exception cref="ArgumentException"> <paramref name="secretId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<SandboxSecret>> SetSecretAsync(string secretId, CreateSecretContent body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(secretId, nameof(secretId));
            Argument.AssertNotNull(body, nameof(body));
