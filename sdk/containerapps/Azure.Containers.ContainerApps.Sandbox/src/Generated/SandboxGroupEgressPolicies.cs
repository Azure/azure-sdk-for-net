...
namespace Azure.Containers.ContainerApps.Sandbox
{
    ...
    public partial class SandboxGroupEgressPolicies
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="policyId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<NamedEgressPolicy> SetEgressPolicy(string policyId, NamedEgressPolicy body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(policyId, nameof(policyId));
            Argument.AssertNotNull(body, nameof(body));

            Response result = SetEgressPolicy(policyId, body, cancellationToken.ToRequestContext());
            return Response.FromValue((NamedEgressPolicy)result, result);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="policyId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<Response<NamedEgressPolicy>> SetEgressPolicyAsync(string policyId, NamedEgressPolicy body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(policyId, nameof(policyId));
            Argument.AssertNotNull(body, nameof(body));

            Response result = await SetEgressPolicyAsync(policyId, body, cancellationToken.ToRequestContext()).ConfigureAwait(false);
            return Response.FromValue((NamedEgressPolicy)result, result);
        }
    }
}
