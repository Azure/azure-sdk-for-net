...
namespace Azure.Containers.ContainerApps.Sandbox
{
    ...
    public partial class ContainerProbe : IJsonModel<ContainerProbe>
    {
        ...
        internal static ContainerProbe DeserializeContainerProbe(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ProbeHttpGetAction httpGet = default;
            ProbeExecAction exec = default;
            ProbeTcpSocketAction tcpSocket = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("httpGet"u8))
                {
                    ...
                    httpGet = ProbeHttpGetAction.DeserializeProbeHttpGetAction(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("exec"u8))
                {
                    ...
                    exec = ProbeExecAction.DeserializeProbeExecAction(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("tcpSocket"u8))
                {
                    ...
                    tcpSocket = ProbeTcpSocketAction.DeserializeProbeTcpSocketAction(prop.Value, options);
                    continue;
                }
