...
namespace Azure.Containers.ContainerApps.Sandbox
{
    ...
    public partial class TelemetryConfig : IJsonModel<TelemetryConfig>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (BinaryData item in Endpoints)
            {
                if (item == null)
                {
            ...
            if (Optional.IsDefined(MetricsIntervalSeconds))
            {
                writer.WritePropertyName("metricsIntervalSeconds"u8);
                writer.WriteNumberValue(MetricsIntervalSeconds.Value);
            }
        ...
        internal static TelemetryConfig DeserializeTelemetryConfig(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<BinaryData> endpoints = default;
            int? metricsIntervalSeconds = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("metricsIntervalSeconds"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    metricsIntervalSeconds = prop.Value.GetInt32();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new TelemetryConfig(endpoints, metricsIntervalSeconds, additionalBinaryDataProperties);
        }
    }
}
