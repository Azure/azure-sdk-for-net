...
{
    internal partial class VoiceServicesCommunicationsGatewayListResult : IUtf8JsonSerializable, IJsonModel<VoiceServicesCommunicationsGatewayListResult>, IPersistableModel<VoiceServicesCommunicationsGatewayListResult>
    {
        ...
        void IJsonModel<VoiceServicesCommunicationsGatewayListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceServicesCommunicationsGatewayListResult)} does not support '{format}' format.");
            }
