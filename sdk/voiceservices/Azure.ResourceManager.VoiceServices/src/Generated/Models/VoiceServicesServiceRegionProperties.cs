...
namespace Azure.ResourceManager.VoiceServices.Models
{
    ...
    public partial class VoiceServicesServiceRegionProperties
    {
        ...
        internal VoiceServicesServiceRegionProperties(string name, VoiceServicesPrimaryRegionProperties primaryRegionProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            PrimaryRegionProperties = primaryRegionProperties;
