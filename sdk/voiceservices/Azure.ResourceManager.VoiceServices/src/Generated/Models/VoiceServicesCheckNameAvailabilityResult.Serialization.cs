...
namespace Azure.ResourceManager.VoiceServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VoiceServicesCheckNameAvailabilityResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceServicesCheckNameAvailabilityResult)} does not support writing '{format}' format.");
            }
        ...
        VoiceServicesCheckNameAvailabilityResult IJsonModel<VoiceServicesCheckNameAvailabilityResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VoiceServicesCheckNameAvailabilityResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VoiceServicesCheckNameAvailabilityResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VoiceServicesCheckNameAvailabilityResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        VoiceServicesCheckNameAvailabilityResult IPersistableModel<VoiceServicesCheckNameAvailabilityResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VoiceServicesCheckNameAvailabilityResult)} does not support reading '{options.Format}' format.");
            }
        }
