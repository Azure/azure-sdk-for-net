...
{
    public partial class VoiceServicesCommunicationsGatewayData : IUtf8JsonSerializable, IJsonModel<VoiceServicesCommunicationsGatewayData>, IPersistableModel<VoiceServicesCommunicationsGatewayData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Connectivity))
            {
                ...
                builder.AppendLine($" '{Connectivity.ToString()}'");
            }
            ...
            if (Optional.IsDefined(E911Type))
            {
                builder.Append("  e911Type:");
                builder.AppendLine($" '{E911Type.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ApiBridge))
            {
                builder.Append("  apiBridge:");
                builder.AppendLine($" '{ApiBridge.ToString()}'");
            }
            ...
            {
                builder.Append("  autoGeneratedDomainNameLabel:");
                builder.AppendLine($" '{AutoGeneratedDomainNameLabel}'");
            }

            if (Optional.IsDefined(TeamsVoicemailPilotNumber))
            {
                builder.Append("  teamsVoicemailPilotNumber:");
                builder.AppendLine($" '{TeamsVoicemailPilotNumber}'");
            }

            if (Optional.IsDefined(IsOnPremMcpEnabled))
            {
                builder.Append("  onPremMcpEnabled:");
                var boolValue = IsOnPremMcpEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsCollectionDefined(EmergencyDialStrings))
            {
                builder.Append("  emergencyDialStrings:");
                builder.AppendLine(" [");
                foreach (var item in EmergencyDialStrings)
                {
                    if (item == null)
