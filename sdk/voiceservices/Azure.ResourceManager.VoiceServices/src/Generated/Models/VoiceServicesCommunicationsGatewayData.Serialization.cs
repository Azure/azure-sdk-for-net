...
namespace Azure.ResourceManager.VoiceServices
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VoiceServicesCommunicationsGatewayData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VoiceServicesCommunicationsGatewayData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VoiceServicesCommunicationsGatewayData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VoiceServicesCommunicationsGatewayData>)} interface");
            }
        ...
        string IPersistableModel<VoiceServicesCommunicationsGatewayData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
