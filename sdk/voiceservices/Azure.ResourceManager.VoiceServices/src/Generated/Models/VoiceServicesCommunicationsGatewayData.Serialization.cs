    ...
    public partial class VoiceServicesCommunicationsGatewayData : IUtf8JsonSerializable, IJsonModel<VoiceServicesCommunicationsGatewayData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Connectivity))
            {
                ...
                builder.AppendLine($" '{Connectivity.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(E911Type))
            {
                ...
                builder.AppendLine($" '{E911Type.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(AutoGeneratedDomainNameLabel))
            {
                ...
                if (AutoGeneratedDomainNameLabel.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(TeamsVoicemailPilotNumber))
            {
                ...
                if (TeamsVoicemailPilotNumber.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
