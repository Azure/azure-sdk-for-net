...
{
    public partial class VoiceServicesServiceRegionProperties : IUtf8JsonSerializable, IJsonModel<VoiceServicesServiceRegionProperties>, IPersistableModel<VoiceServicesServiceRegionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PrimaryRegionProperties))
            {
                ...
                AppendChildObject(builder, PrimaryRegionProperties, options, 2);
            }
