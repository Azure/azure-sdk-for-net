...
namespace Azure.ResourceManager.VoiceServices
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VoiceServicesTestLineData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VoiceServicesTestLineData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VoiceServicesTestLineData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VoiceServicesTestLineData>)} interface");
            }
        ...
        string IPersistableModel<VoiceServicesTestLineData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
