...
namespace Azure.ResourceManager.VoiceServices.Models
{
    ...
    internal partial class VoiceServicesTestLineListResult
    {
        ...
        internal VoiceServicesTestLineListResult(IReadOnlyList<VoiceServicesTestLineData> value, Uri nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
