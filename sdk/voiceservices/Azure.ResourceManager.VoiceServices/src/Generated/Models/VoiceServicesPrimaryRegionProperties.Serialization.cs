...
namespace Azure.ResourceManager.VoiceServices.Models
{
    public partial class VoiceServicesPrimaryRegionProperties : IUtf8JsonSerializable
    {
        ...
        internal static VoiceServicesPrimaryRegionProperties DeserializeVoiceServicesPrimaryRegionProperties(JsonElement element, SerializableOptions options = default)
        {
