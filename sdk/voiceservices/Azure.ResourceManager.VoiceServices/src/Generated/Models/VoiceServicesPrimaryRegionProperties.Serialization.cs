...
{
    public partial class VoiceServicesPrimaryRegionProperties : IUtf8JsonSerializable, IJsonModel<VoiceServicesPrimaryRegionProperties>, IPersistableModel<VoiceServicesPrimaryRegionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(OperatorAddresses))
            {
                builder.Append("  operatorAddresses:");
                builder.AppendLine(" [");
                foreach (var item in OperatorAddresses)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(AllowedSignalingSourceAddressPrefixes))
            {
                builder.Append("  allowedSignalingSourceAddressPrefixes:");
                builder.AppendLine(" [");
                foreach (var item in AllowedSignalingSourceAddressPrefixes)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(AllowedMediaSourceAddressPrefixes))
            {
                builder.Append("  allowedMediaSourceAddressPrefixes:");
                builder.AppendLine(" [");
                foreach (var item in AllowedMediaSourceAddressPrefixes)
                {
                    if (item == null)
