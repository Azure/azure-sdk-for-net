...
namespace Azure.ResourceManager.VoiceServices.Models
{
    ...
    public partial class VoiceServicesPrimaryRegionProperties
    {
        ...
        internal VoiceServicesPrimaryRegionProperties(IList<string> operatorAddresses, IList<string> esrpAddresses, IList<string> allowedSignalingSourceAddressPrefixes, IList<string> allowedMediaSourceAddressPrefixes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
