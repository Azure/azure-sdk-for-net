...
namespace Azure.ResourceManager.VoiceServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VoiceServicesTestLineListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VoiceServicesTestLineListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VoiceServicesTestLineListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VoiceServicesTestLineListResult>)} interface");
            }
        ...
        string IPersistableModel<VoiceServicesTestLineListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
