...
namespace Azure.ResourceManager.VoiceServices.Models
{
    internal partial class VoiceServicesTestLineListResult : IUtf8JsonSerializable, IJsonModel<VoiceServicesTestLineListResult>
    {
        ...
        void IJsonModel<VoiceServicesTestLineListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VoiceServicesTestLineListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VoiceServicesTestLineListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VoiceServicesTestLineListResult)} does not support '{options.Format}' format.");
            }
        }
