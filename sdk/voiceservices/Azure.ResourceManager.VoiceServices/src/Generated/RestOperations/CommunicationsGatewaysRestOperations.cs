...
namespace Azure.ResourceManager.VoiceServices
{
    internal partial class CommunicationsGatewaysRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string communicationsGatewayName, VoiceServicesCommunicationsGatewayData data)
        {
            ...
            content.JsonWriter.WriteObjectValue<VoiceServicesCommunicationsGatewayData>(data, new ModelReaderWriterOptions("W"));
        ...
        internal HttpMessage CreateUpdateRequest(string subscriptionId, string resourceGroupName, string communicationsGatewayName, VoiceServicesCommunicationsGatewayPatch patch)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            content.JsonWriter.WriteObjectValue<VoiceServicesCommunicationsGatewayPatch>(patch, new ModelReaderWriterOptions("W"));
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
