...
namespace Azure.ResourceManager.VoiceServices.Mocking
{
    ...
    internal partial class VoiceServicesSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="VoiceServicesSubscriptionMockingExtension"/> class for mocking. </summary>
        protected VoiceServicesSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VoiceServicesSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal VoiceServicesSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = NameAvailabilityClientDiagnostics.CreateScope("VoiceServicesSubscriptionMockingExtension.CheckVoiceServicesNameAvailability");
            scope.Start();
            try
            {
