...
namespace Azure.ResourceManager.VoiceServices.Mocking
{
    ...
    internal partial class VoiceServicesResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="VoiceServicesResourceGroupMockingExtension"/> class for mocking. </summary>
        protected VoiceServicesResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VoiceServicesResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal VoiceServicesResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
