...
namespace Azure.ResourceManager.VoiceServices.Mock
{
    ...
    public partial class VoiceServicesResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="VoiceServicesResourceGroupResourceExtension"/> class for mocking. </summary>
        protected VoiceServicesResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VoiceServicesResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal VoiceServicesResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
