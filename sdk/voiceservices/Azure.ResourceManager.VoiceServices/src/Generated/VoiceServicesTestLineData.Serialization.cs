    ...
    public partial class VoiceServicesTestLineData : IUtf8JsonSerializable, IJsonModel<VoiceServicesTestLineData>
    {
        ...
        internal static VoiceServicesTestLineData DeserializeVoiceServicesTestLineData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.VoiceServices.ModelSerializationExtensions.WireOptions, AzureResourceManagerVoiceServicesContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerVoiceServicesContext.Default)
#endif
;
                    continue;
                }
