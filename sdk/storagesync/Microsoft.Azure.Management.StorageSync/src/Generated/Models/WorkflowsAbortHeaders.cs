...
namespace Microsoft.Azure.Management.StorageSync.Models
{
    ...
    /// </summary>
    public partial class WorkflowsAbortHeaders
    {
        /// <summary>
        /// Initializes a new instance of the WorkflowsAbortHeaders class.
        /// </summary>
        public WorkflowsAbortHeaders()
        {
            CustomInit();
        }
        ...
        /// id.</param>
        public WorkflowsAbortHeaders(string xMsRequestId = default(string), string xMsCorrelationRequestId = default(string))
        {
