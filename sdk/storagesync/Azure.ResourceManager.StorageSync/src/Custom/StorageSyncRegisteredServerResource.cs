...
namespace Azure.ResourceManager.StorageSync
{
    ...
    public partial class StorageSyncRegisteredServerResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<StorageSyncRegisteredServerResource>> UpdateAsync(WaitUntil waitUntil, StorageSyncRegisteredServerCreateOrUpdateContent content, CancellationToken cancellationToken = default)
            => await UpdateAsync(waitUntil, new StorageSyncRegisteredServerPatch(content.Id, content.Name, content.ResourceType, content.SystemData, new RegisteredServerUpdateProperties(content.UseIdentity, content.ApplicationId, null), additionalBinaryDataProperties: null), cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<StorageSyncRegisteredServerResource> Update(WaitUntil waitUntil, StorageSyncRegisteredServerCreateOrUpdateContent content, CancellationToken cancellationToken = default)
            => Update(waitUntil, new StorageSyncRegisteredServerPatch(content.Id, content.Name, content.ResourceType, content.SystemData, new RegisteredServerUpdateProperties(content.UseIdentity, content.ApplicationId, null), additionalBinaryDataProperties: null), cancellationToken);
    }
}
