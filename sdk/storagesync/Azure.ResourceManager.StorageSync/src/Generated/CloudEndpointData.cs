...
namespace Azure.ResourceManager.StorageSync
{
    ...
    public partial class CloudEndpointData : ResourceData
    {
        ...
        internal CloudEndpointData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceIdentifier storageAccountResourceId, string azureFileShareName, Guid? storageAccountTenantId, string partnershipId, string friendlyName, string isBackupEnabled, string provisioningState, string lastWorkflowId, string lastOperationName, CloudEndpointChangeEnumerationStatus changeEnumerationStatus, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
