...
namespace Azure.ResourceManager.StorageSync.Mocking
{
    ...
    internal partial class StorageSyncArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="StorageSyncArmClientMockingExtension"/> class for mocking. </summary>
        protected StorageSyncArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="StorageSyncArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StorageSyncArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal StorageSyncArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
