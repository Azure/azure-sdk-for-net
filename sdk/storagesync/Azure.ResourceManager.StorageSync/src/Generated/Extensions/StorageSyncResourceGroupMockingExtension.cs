...
namespace Azure.ResourceManager.StorageSync.Mocking
{
    ...
    internal partial class StorageSyncResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="StorageSyncResourceGroupMockingExtension"/> class for mocking. </summary>
        protected StorageSyncResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="StorageSyncResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StorageSyncResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
