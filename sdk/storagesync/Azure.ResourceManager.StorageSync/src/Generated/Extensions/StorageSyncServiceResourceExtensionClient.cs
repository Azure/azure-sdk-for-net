...
{
    /// <summary> A class to add extension methods to StorageSyncServiceResource. </summary>
    public partial class StorageSyncServiceResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="StorageSyncServiceResourceExtensionClient"/> class for mocking. </summary>
        protected StorageSyncServiceResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="StorageSyncServiceResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StorageSyncServiceResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics StorageSyncServiceClientDiagnostics => _storageSyncServiceClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.StorageSync.Mock", StorageSyncServiceResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<StorageSyncNameAvailabilityResult>> CheckStorageSyncNameAvailabilityAsync(string locationName, StorageSyncNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = StorageSyncServiceClientDiagnostics.CreateScope("StorageSyncServiceResourceExtensionClient.CheckStorageSyncNameAvailability");
            scope.Start();
            try
            {
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => StorageSyncServiceRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new StorageSyncServiceResource(Client, StorageSyncServiceData.DeserializeStorageSyncServiceData(e)), StorageSyncServiceClientDiagnostics, Pipeline, "StorageSyncServiceResourceExtensionClient.GetStorageSyncServices", "value", null, cancellationToken);
        }
    }
}
