...
namespace Azure.ResourceManager.StorageSync
{
    ...
    internal partial class SubscriptionResourceExtensionClient : ArmResource
    {
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => StorageSyncServiceRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => { var data = StorageSyncServiceData.DeserializeStorageSyncServiceData(e); return new StorageSyncServiceResource(Client, data, data.Id); }, StorageSyncServiceClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetStorageSyncServices", "value", null, cancellationToken);
        }
    }
}
