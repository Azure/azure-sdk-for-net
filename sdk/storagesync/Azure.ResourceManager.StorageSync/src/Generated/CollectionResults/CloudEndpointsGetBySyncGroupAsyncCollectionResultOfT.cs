...
{
    internal partial class CloudEndpointsGetBySyncGroupAsyncCollectionResultOfT : AsyncPageable<CloudEndpointData>
    {
        private readonly CloudEndpoints _client;
        ...
        /// <returns> The pages of CloudEndpointsGetBySyncGroupAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<CloudEndpointData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                CloudEndpointArray result = CloudEndpointArray.FromResponse(response);
                yield return Page<CloudEndpointData>.FromValues((IReadOnlyList<CloudEndpointData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
