...
namespace Azure.ResourceManager.StorageSync
{
    internal partial class PrivateEndpointConnectionsGetByStorageSyncServiceAsyncCollectionResultOfT : AsyncPageable<StorageSyncPrivateEndpointConnectionData>
    {
        ...
        public PrivateEndpointConnectionsGetByStorageSyncServiceAsyncCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string storageSyncServiceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
