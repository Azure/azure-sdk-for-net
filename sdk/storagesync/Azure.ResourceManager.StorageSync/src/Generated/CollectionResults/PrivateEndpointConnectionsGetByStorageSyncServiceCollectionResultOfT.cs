...
{
    internal partial class PrivateEndpointConnectionsGetByStorageSyncServiceCollectionResultOfT : Pageable<StorageSyncPrivateEndpointConnectionData>
    {
        ...
        /// <returns> The pages of PrivateEndpointConnectionsGetByStorageSyncServiceCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<StorageSyncPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<StorageSyncPrivateEndpointConnectionData>.FromValues((IReadOnlyList<StorageSyncPrivateEndpointConnectionData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
