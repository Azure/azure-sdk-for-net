...
namespace Azure.ResourceManager.StorageSync
{
    ...
    public partial class StorageSyncGroupData : ResourceData
    {
        ...
        internal StorageSyncGroupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Guid? uniqueId, string syncGroupStatus, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            UniqueId = uniqueId;
