...
namespace Azure.ResourceManager.StorageSync
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="StorageSyncServerEndpointResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="StorageSyncGroupResource"/> using the GetStorageSyncServerEndpoints method.
    /// </summary>
    public partial class StorageSyncServerEndpointResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of StorageSyncServerEndpointResource for mocking. </summary>
        protected StorageSyncServerEndpointResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="StorageSyncServerEndpointResource"/> class. </summary>
        ...
        internal StorageSyncServerEndpointResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _serverEndpointsRestClient = new ServerEndpoints(_serverEndpointsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, storageSyncServerEndpointApiVersion ?? "2025-12-01");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/syncGroups/{syncGroupName}/serverEndpoints/{serverEndpointName}";
        ...
        {
            using DiagnosticScope scope = _serverEndpointsClientDiagnostics.CreateScope("StorageSyncServerEndpointResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _serverEndpointsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _serverEndpointsClientDiagnostics.CreateScope("StorageSyncServerEndpointResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _serverEndpointsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                StorageSyncArmOperation operation = new StorageSyncArmOperation(_serverEndpointsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        public virtual async Task<ArmOperation> RecallActionAsync(WaitUntil waitUntil, RecallActionContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serverEndpointsClientDiagnostics.CreateScope("StorageSyncServerEndpointResource.RecallAction");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _serverEndpointsRestClient.CreateRecallActionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, RecallActionContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                StorageSyncArmOperation operation = new StorageSyncArmOperation(_serverEndpointsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <summary>
        /// Updates the StorageSyncServerEndpoint.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}/syncGroups/{syncGroupName}/serverEndpoints/{serverEndpointName}. </description>
        ...
        public virtual async Task<ArmOperation<StorageSyncServerEndpointResource>> UpdateAsync(WaitUntil waitUntil, StorageSyncServerEndpointCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                ...
                HttpMessage message = _serverEndpointsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, StorageSyncServerEndpointCreateOrUpdateContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                StorageSyncArmOperation<StorageSyncServerEndpointResource> operation = new StorageSyncArmOperation<StorageSyncServerEndpointResource>(
                    new StorageSyncServerEndpointResourceOperationSource(Client),
                    _serverEndpointsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<StorageSyncServerEndpointResource> Update(WaitUntil waitUntil, StorageSyncServerEndpointCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
