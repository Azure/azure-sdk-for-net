...
namespace Azure.ResourceManager.StorageSync
{
    ...
    public partial class StorageSyncServerEndpointResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _storageSyncServerEndpointServerEndpointsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = await _storageSyncServerEndpointServerEndpointsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new StorageSyncArmOperation(_storageSyncServerEndpointServerEndpointsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _storageSyncServerEndpointServerEndpointsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = _storageSyncServerEndpointServerEndpointsRestClient.Delete(message, cancellationToken);
                var operation = new StorageSyncArmOperation(_storageSyncServerEndpointServerEndpointsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<StorageSyncServerEndpointResource>> UpdateAsync(WaitUntil waitUntil, StorageSyncServerEndpointPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _storageSyncServerEndpointServerEndpointsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch);
                var response = await _storageSyncServerEndpointServerEndpointsRestClient.UpdateAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new StorageSyncArmOperation<StorageSyncServerEndpointResource>(new StorageSyncServerEndpointOperationSource(Client), _storageSyncServerEndpointServerEndpointsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<StorageSyncServerEndpointResource> Update(WaitUntil waitUntil, StorageSyncServerEndpointPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _storageSyncServerEndpointServerEndpointsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch);
                var response = _storageSyncServerEndpointServerEndpointsRestClient.Update(message, cancellationToken);
                var operation = new StorageSyncArmOperation<StorageSyncServerEndpointResource>(new StorageSyncServerEndpointOperationSource(Client), _storageSyncServerEndpointServerEndpointsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation> RecallActionAsync(WaitUntil waitUntil, RecallActionContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _storageSyncServerEndpointServerEndpointsRestClient.CreateRecallActionRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, content);
                var response = await _storageSyncServerEndpointServerEndpointsRestClient.RecallActionAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new StorageSyncArmOperation(_storageSyncServerEndpointServerEndpointsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
        ...
        public virtual ArmOperation RecallAction(WaitUntil waitUntil, RecallActionContent content, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _storageSyncServerEndpointServerEndpointsRestClient.CreateRecallActionRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, content);
                var response = _storageSyncServerEndpointServerEndpointsRestClient.RecallAction(message, cancellationToken);
                var operation = new StorageSyncArmOperation(_storageSyncServerEndpointServerEndpointsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
