...
{
    public partial class StorageSyncPrivateEndpointConnectionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static StorageSyncPrivateEndpointConnectionData DeserializeStorageSyncPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            Core.Optional<StorageSyncPrivateLinkServiceConnectionState> privateLinkServiceConnectionState = default;
            Core.Optional<StorageSyncPrivateEndpointConnectionProvisioningState> provisioningState = default;
            ...
            return new StorageSyncPrivateEndpointConnectionData(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Core.Optional.ToNullable(provisioningState));
        }
    }
}
