...
namespace Azure.ResourceManager.StorageSync
{
    public partial class StorageSyncPrivateEndpointConnectionData : IUtf8JsonSerializable, IJsonModel<StorageSyncPrivateEndpointConnectionData>
    {
        ...
        void IJsonModel<StorageSyncPrivateEndpointConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(StorageSyncPrivateEndpointConnectionData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StorageSyncPrivateEndpointConnectionData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(StorageSyncPrivateEndpointConnectionData)} does not support '{options.Format}' format.");
            }
        }
