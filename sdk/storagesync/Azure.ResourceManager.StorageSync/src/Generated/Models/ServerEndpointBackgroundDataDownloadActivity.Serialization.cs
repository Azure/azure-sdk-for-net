...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerEndpointBackgroundDataDownloadActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerEndpointBackgroundDataDownloadActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServerEndpointBackgroundDataDownloadActivity>)} interface");
            }
        ...
        string IPersistableModel<ServerEndpointBackgroundDataDownloadActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
