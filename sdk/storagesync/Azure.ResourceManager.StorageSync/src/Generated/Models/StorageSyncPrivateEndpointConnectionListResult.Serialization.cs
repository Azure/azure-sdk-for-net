...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageSyncPrivateEndpointConnectionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageSyncPrivateEndpointConnectionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageSyncPrivateEndpointConnectionListResult>)} interface");
            }
        ...
        string IPersistableModel<StorageSyncPrivateEndpointConnectionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
