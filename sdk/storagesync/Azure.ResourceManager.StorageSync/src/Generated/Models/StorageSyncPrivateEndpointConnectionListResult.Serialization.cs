...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageSyncPrivateEndpointConnectionListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static StorageSyncPrivateEndpointConnectionListResult DeserializeStorageSyncPrivateEndpointConnectionListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new StorageSyncPrivateEndpointConnectionListResult(value ?? new ChangeTrackingList<StorageSyncPrivateEndpointConnectionData>(), nextLink, serializedAdditionalRawData);
        }
