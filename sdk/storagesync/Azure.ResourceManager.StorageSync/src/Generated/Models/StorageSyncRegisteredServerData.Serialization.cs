...
namespace Azure.ResourceManager.StorageSync
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageSyncRegisteredServerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageSyncRegisteredServerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageSyncRegisteredServerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageSyncRegisteredServerData>)} interface");
            }
        ...
        string IPersistableModel<StorageSyncRegisteredServerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
