...
{
    public partial class StorageSyncRegisteredServerData : IUtf8JsonSerializable, IJsonModel<StorageSyncRegisteredServerData>, IPersistableModel<StorageSyncRegisteredServerData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AgentVersionExpireOn))
            {
                ...
                builder.AppendLine($" '{AgentVersionExpireOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ServerManagementErrorCode))
            {
                ...
                builder.AppendLine($" '{ServerManagementErrorCode.Value.ToString()}'");
            }
