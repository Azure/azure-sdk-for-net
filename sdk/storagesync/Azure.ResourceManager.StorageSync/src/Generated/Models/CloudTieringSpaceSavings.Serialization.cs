...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        internal static CloudTieringSpaceSavings DeserializeCloudTieringSpaceSavings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
