...
{
    public partial class CloudTieringDatePolicyStatus : IUtf8JsonSerializable, IJsonModel<CloudTieringDatePolicyStatus>, IPersistableModel<CloudTieringDatePolicyStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TieredFilesMostRecentAccessTimestamp))
            {
                ...
                builder.AppendLine($" '{TieredFilesMostRecentAccessTimestamp.Value.ToString()}'");
            }
