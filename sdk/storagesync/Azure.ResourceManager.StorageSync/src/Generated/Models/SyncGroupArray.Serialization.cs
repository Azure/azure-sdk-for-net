...
{
    internal partial class SyncGroupArray : IUtf8JsonSerializable, IJsonModel<SyncGroupArray>, IPersistableModel<SyncGroupArray>
    {
        ...
        void IJsonModel<SyncGroupArray>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SyncGroupArray)} does not support '{format}' format.");
            }
