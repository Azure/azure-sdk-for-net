...
{
    public partial class CloudEndpointChangeEnumerationStatus : IUtf8JsonSerializable, IJsonModel<CloudEndpointChangeEnumerationStatus>, IPersistableModel<CloudEndpointChangeEnumerationStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  lastEnumerationStatus:");
                AppendChildObject(builder, LastEnumerationStatus, options, 2);
            }

            if (Optional.IsDefined(Activity))
            {
                builder.Append("  activity:");
                AppendChildObject(builder, Activity, options, 2);
            }
