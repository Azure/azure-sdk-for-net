...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    public partial class StorageSyncRegisteredServerPatch : ResourceData
    {
        ...
        internal StorageSyncRegisteredServerPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, RegisteredServerUpdateProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
