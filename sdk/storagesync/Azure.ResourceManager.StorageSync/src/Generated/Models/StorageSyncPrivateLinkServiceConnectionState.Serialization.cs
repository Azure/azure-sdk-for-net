...
{
    public partial class StorageSyncPrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static StorageSyncPrivateLinkServiceConnectionState DeserializeStorageSyncPrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            Core.Optional<StorageSyncPrivateEndpointServiceConnectionStatus> status = default;
            ...
            return new StorageSyncPrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
