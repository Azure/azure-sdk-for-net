...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkflowArray>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<StorageSyncWorkflowData>)item).Write(writer, options);
                }
        ...
        internal static WorkflowArray DeserializeWorkflowArray(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<StorageSyncWorkflowData> value = default;
            ...
            return new WorkflowArray(value ?? new ChangeTrackingList<StorageSyncWorkflowData>(), serializedAdditionalRawData);
        }
