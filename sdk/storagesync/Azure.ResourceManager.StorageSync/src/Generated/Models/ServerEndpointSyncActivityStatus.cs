...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    public partial class ServerEndpointSyncActivityStatus
    {
        ...
        internal ServerEndpointSyncActivityStatus(DateTimeOffset? timestamp, long? perItemErrorCount, long? appliedItemCount, long? totalItemCount, long? appliedBytes, long? totalBytes, ServerEndpointSyncMode? syncMode, int? sessionMinutesRemaining, Dictionary<string, BinaryData> rawData)
        {
            Timestamp = timestamp;
