...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestoreFileSpec>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestoreFileSpec>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestoreFileSpec>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestoreFileSpec>)} interface");
            }
        ...
        string IPersistableModel<RestoreFileSpec>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
