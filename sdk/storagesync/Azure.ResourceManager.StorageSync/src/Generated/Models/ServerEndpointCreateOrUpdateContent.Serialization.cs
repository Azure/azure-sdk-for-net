...
{
    public partial class ServerEndpointCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static ServerEndpointCreateOrUpdateContent DeserializeServerEndpointCreateOrUpdateContent(JsonElement element)
        {
