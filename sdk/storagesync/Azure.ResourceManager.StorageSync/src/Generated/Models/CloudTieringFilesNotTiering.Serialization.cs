...
{
    public partial class CloudTieringFilesNotTiering : IUtf8JsonSerializable, IJsonModel<CloudTieringFilesNotTiering>, IPersistableModel<CloudTieringFilesNotTiering>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TotalFileCount))
            {
                ...
                builder.AppendLine($" '{TotalFileCount.Value.ToString()}'");
            }
