...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudTieringFilesNotTiering>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudTieringFilesNotTiering>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudTieringFilesNotTiering>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudTieringFilesNotTiering>)} interface");
            }
        ...
        string IPersistableModel<CloudTieringFilesNotTiering>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
