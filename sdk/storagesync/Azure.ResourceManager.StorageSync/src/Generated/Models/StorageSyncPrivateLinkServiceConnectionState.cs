...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    public partial class StorageSyncPrivateLinkServiceConnectionState
    {
        ...
        internal StorageSyncPrivateLinkServiceConnectionState(StorageSyncPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
