...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    public partial class StorageSyncPrivateLinkServiceConnectionState
    {
        ...
        internal StorageSyncPrivateLinkServiceConnectionState(StorageSyncPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
