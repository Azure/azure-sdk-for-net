...
{
    public partial class ServerEndpointFilesNotSyncingError : IUtf8JsonSerializable, IJsonModel<ServerEndpointFilesNotSyncingError>, IPersistableModel<ServerEndpointFilesNotSyncingError>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  persistentCount:");
                builder.AppendLine($" '{PersistentCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(TransientCount))
            {
                builder.Append("  transientCount:");
                builder.AppendLine($" '{TransientCount.Value.ToString()}'");
            }
