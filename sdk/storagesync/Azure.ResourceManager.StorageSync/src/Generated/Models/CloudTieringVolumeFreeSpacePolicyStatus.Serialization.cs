...
{
    public partial class CloudTieringVolumeFreeSpacePolicyStatus : IUtf8JsonSerializable, IJsonModel<CloudTieringVolumeFreeSpacePolicyStatus>, IPersistableModel<CloudTieringVolumeFreeSpacePolicyStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EffectiveVolumeFreeSpacePolicy))
            {
                ...
                builder.AppendLine($" '{EffectiveVolumeFreeSpacePolicy.Value.ToString()}'");
            }

            if (Optional.IsDefined(CurrentVolumeFreeSpacePercent))
            {
                builder.Append("  currentVolumeFreeSpacePercent:");
                builder.AppendLine($" '{CurrentVolumeFreeSpacePercent.Value.ToString()}'");
            }
