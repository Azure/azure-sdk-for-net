...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        internal static ServerEndpointRecallError DeserializeServerEndpointRecallError(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
