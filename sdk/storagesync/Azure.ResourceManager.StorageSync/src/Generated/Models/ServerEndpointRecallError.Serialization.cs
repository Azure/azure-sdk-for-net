...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerEndpointRecallError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServerEndpointRecallError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServerEndpointRecallError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServerEndpointRecallError>)} interface");
            }
        ...
        string IPersistableModel<ServerEndpointRecallError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
