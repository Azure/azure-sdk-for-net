...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageSyncServerEndpointPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageSyncServerEndpointPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageSyncServerEndpointPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageSyncServerEndpointPatch>)} interface");
            }
        ...
        string IPersistableModel<StorageSyncServerEndpointPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
