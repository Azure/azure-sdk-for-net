...
namespace Azure.ResourceManager.StorageSync
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageSyncServiceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageSyncServiceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageSyncServiceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageSyncServiceData>)} interface");
            }
        ...
        string IPersistableModel<StorageSyncServiceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
