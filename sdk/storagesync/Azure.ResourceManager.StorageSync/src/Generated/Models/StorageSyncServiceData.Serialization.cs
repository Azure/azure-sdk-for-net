...
{
    public partial class StorageSyncServiceData : IUtf8JsonSerializable, IJsonModel<StorageSyncServiceData>, IPersistableModel<StorageSyncServiceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StorageSyncServiceStatus))
            {
                ...
                builder.AppendLine($" '{StorageSyncServiceStatus.Value.ToString()}'");
            }
