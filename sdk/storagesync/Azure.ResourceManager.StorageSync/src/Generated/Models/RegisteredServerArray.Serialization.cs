...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegisteredServerArray>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RegisteredServerArray>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RegisteredServerArray>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RegisteredServerArray>)} interface");
            }
        ...
        string IPersistableModel<RegisteredServerArray>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
