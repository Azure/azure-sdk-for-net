...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    public partial class ServerEndpointRecallStatus : IJsonModel<ServerEndpointRecallStatus>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ServerEndpointRecallStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(RecallErrors))
            {
                ...
                foreach (ServerEndpointRecallError item in RecallErrors)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ServerEndpointRecallStatus IJsonModel<ServerEndpointRecallStatus>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ServerEndpointRecallStatus JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ServerEndpointRecallStatus>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ServerEndpointRecallStatus DeserializeServerEndpointRecallStatus(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("totalRecallErrorsCount"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    totalRecallErrorsCount = prop.Value.GetInt64();
                    continue;
                }
                if (prop.NameEquals("recallErrors"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
            ...
            return new ServerEndpointRecallStatus(lastUpdatedOn, totalRecallErrorsCount, recallErrors ?? new ChangeTrackingList<ServerEndpointRecallError>(), additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ServerEndpointRecallStatus>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ServerEndpointRecallStatus IPersistableModel<ServerEndpointRecallStatus>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ServerEndpointRecallStatus PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ServerEndpointRecallStatus>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
