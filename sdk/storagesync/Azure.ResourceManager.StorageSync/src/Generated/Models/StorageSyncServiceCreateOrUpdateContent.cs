...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    public partial class StorageSyncServiceCreateOrUpdateContent
    {
        ...
        internal StorageSyncServiceCreateOrUpdateContent(AzureLocation location, IDictionary<string, string> tags, IncomingTrafficPolicy? incomingTrafficPolicy, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Tags = tags;
