...
namespace Azure.ResourceManager.StorageSync.Models
{
    public partial class StorageSyncGroupCreateOrUpdateContent : IUtf8JsonSerializable, IModelJsonSerializable<StorageSyncGroupCreateOrUpdateContent>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<StorageSyncGroupCreateOrUpdateContent>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="StorageSyncGroupCreateOrUpdateContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StorageSyncGroupCreateOrUpdateContent"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StorageSyncGroupCreateOrUpdateContent"/>. </summary>
