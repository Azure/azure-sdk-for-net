...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudEndpointChangeEnumerationActivity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudEndpointChangeEnumerationActivity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudEndpointChangeEnumerationActivity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudEndpointChangeEnumerationActivity>)} interface");
            }
        ...
        string IPersistableModel<CloudEndpointChangeEnumerationActivity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
