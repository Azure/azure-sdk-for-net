...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    public partial class ServerEndpointProvisioningStepStatus
    {
        ...
        internal ServerEndpointProvisioningStepStatus(string name, string status, DateTimeOffset? startOn, int? minutesLeft, int? progressPercentage, DateTimeOffset? endOn, int? errorCode, IReadOnlyDictionary<string, string> additionalInformation)
        {
            Name = name;
            Status = status;
            StartOn = startOn;
