...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        internal static CloudTieringCachePerformance DeserializeCloudTieringCachePerformance(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
