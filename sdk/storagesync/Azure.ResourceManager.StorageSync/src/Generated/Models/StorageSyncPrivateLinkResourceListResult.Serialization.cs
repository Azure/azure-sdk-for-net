...
namespace Azure.ResourceManager.StorageSync.Models
{
    internal partial class StorageSyncPrivateLinkResourceListResult : IUtf8JsonSerializable, IModelJsonSerializable<StorageSyncPrivateLinkResourceListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<StorageSyncPrivateLinkResourceListResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<StorageSyncPrivateLinkResource>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="StorageSyncPrivateLinkResourceListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StorageSyncPrivateLinkResourceListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StorageSyncPrivateLinkResourceListResult"/>. </summary>
