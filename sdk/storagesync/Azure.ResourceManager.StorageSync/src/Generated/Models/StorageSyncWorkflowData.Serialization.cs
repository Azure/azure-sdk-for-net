    ...
    public partial class StorageSyncWorkflowData : IUtf8JsonSerializable, IJsonModel<StorageSyncWorkflowData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastStepName))
            {
                ...
                if (LastStepName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(Operation))
            {
                ...
                builder.AppendLine($" '{Operation.Value.ToString()}'");
            }

            if (Optional.IsDefined(Steps))
            {
                builder.Append("    steps:");
                if (Steps.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(CommandName))
            {
                ...
                if (CommandName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(LastStatusUpdatedOn))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(LastStatusUpdatedOn.Value, "o");
                builder.AppendLine($" '{formattedDateTimeString}'");
            }
