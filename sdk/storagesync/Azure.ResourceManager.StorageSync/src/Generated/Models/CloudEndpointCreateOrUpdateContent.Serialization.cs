...
{
    public partial class CloudEndpointCreateOrUpdateContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CloudEndpointCreateOrUpdateContent DeserializeCloudEndpointCreateOrUpdateContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
