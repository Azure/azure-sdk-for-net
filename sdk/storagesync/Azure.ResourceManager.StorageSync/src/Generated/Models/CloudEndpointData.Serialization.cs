...
{
    public partial class CloudEndpointData : IUtf8JsonSerializable, IJsonModel<CloudEndpointData>, IPersistableModel<CloudEndpointData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ChangeEnumerationStatus))
            {
                ...
                AppendChildObject(builder, ChangeEnumerationStatus, options, 2);
            }
