...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    public partial class TriggerChangeDetectionContent
    {
        ...
        internal TriggerChangeDetectionContent(string directoryPath, ChangeDetectionMode? changeDetectionMode, IList<string> paths, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
