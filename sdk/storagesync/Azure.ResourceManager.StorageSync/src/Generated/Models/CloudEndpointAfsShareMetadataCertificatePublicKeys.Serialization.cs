...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudEndpointAfsShareMetadataCertificatePublicKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudEndpointAfsShareMetadataCertificatePublicKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudEndpointAfsShareMetadataCertificatePublicKeys>)} interface");
            }
        ...
        string IPersistableModel<CloudEndpointAfsShareMetadataCertificatePublicKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
