...
{
    /// <summary></summary>
    internal partial class StorageSyncRegisteredServerResourceOperationSource : IOperationSource<StorageSyncRegisteredServerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StorageSyncRegisteredServerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
