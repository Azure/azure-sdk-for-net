...
namespace Azure.ResourceManager.StorageSync
{
    internal partial class StorageSyncArmOperation<T> : ArmOperation<T>
    {
        ...
        internal StorageSyncArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
