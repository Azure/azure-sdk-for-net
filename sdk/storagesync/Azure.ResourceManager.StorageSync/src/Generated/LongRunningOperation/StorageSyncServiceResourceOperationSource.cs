...
{
    /// <summary></summary>
    internal partial class StorageSyncServiceResourceOperationSource : IOperationSource<StorageSyncServiceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StorageSyncServiceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
