...
{
    /// <summary></summary>
    internal partial class CloudEndpointResourceOperationSource : IOperationSource<CloudEndpointResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CloudEndpointResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
