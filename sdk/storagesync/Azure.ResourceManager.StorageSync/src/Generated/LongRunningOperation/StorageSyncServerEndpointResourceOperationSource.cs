...
{
    /// <summary></summary>
    internal partial class StorageSyncServerEndpointResourceOperationSource : IOperationSource<StorageSyncServerEndpointResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StorageSyncServerEndpointResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
