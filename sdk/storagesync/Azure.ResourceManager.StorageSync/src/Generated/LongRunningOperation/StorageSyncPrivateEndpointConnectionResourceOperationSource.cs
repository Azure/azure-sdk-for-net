...
{
    /// <summary></summary>
    internal partial class StorageSyncPrivateEndpointConnectionResourceOperationSource : IOperationSource<StorageSyncPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal StorageSyncPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
