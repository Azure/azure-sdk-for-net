...
namespace Azure.ResourceManager.StorageSync
{
    ...
    public partial class StorageSyncServiceResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the StorageSyncService.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/storageSyncServices/{storageSyncServiceName}. </description>
        ...
        public virtual async Task<ArmOperation<StorageSyncServiceResource>> UpdateAsync(WaitUntil waitUntil, StorageSyncServiceCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _storageSyncServicesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, StorageSyncServiceCreateOrUpdateContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                StorageSyncArmOperation<StorageSyncServiceResource> operation = new StorageSyncArmOperation<StorageSyncServiceResource>(
                    new StorageSyncServiceResourceOperationSource(Client),
                    _storageSyncServicesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<StorageSyncServiceResource> Update(WaitUntil waitUntil, StorageSyncServiceCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
