...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    public static partial class ArmStorageSyncModelFactory
    {
        ...
        {
            return new StorageSyncNameAvailabilityContent(name, resourceType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageSyncNameAvailabilityResult(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageSyncServiceCreateOrUpdateContent StorageSyncServiceCreateOrUpdateContent(AzureLocation location = default, IDictionary<string, string> tags = null, IncomingTrafficPolicy? incomingTrafficPolicy = null)
        {
            ...
            return new StorageSyncServiceCreateOrUpdateContent(location, tags, incomingTrafficPolicy, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageSyncServiceData StorageSyncServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, IncomingTrafficPolicy? incomingTrafficPolicy = null, int? storageSyncServiceStatus = null, Guid? storageSyncServiceUid = null, string provisioningState = null, string lastWorkflowId = null, string lastOperationName = null, IEnumerable<StorageSyncPrivateEndpointConnectionData> privateEndpointConnections = null)
        {
            ...
            return new StorageSyncServiceData(id, name, resourceType, systemData, tags, location, incomingTrafficPolicy, storageSyncServiceStatus, storageSyncServiceUid, provisioningState, lastWorkflowId, lastOperationName, privateEndpointConnections?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageSyncPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageSyncPrivateLinkResource StorageSyncPrivateLinkResource(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new StorageSyncPrivateLinkResource(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageSyncGroupData(id, name, resourceType, systemData, uniqueId, syncGroupStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageSyncGroupCreateOrUpdateContent(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudEndpointCreateOrUpdateContent(id, name, resourceType, systemData, storageAccountResourceId, azureFileShareName, storageAccountTenantId, friendlyName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudEndpointData(id, name, resourceType, systemData, storageAccountResourceId, azureFileShareName, storageAccountTenantId, partnershipId, friendlyName, isBackupEnabled, provisioningState, lastWorkflowId, lastOperationName, changeEnumerationStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudEndpointChangeEnumerationStatus(lastUpdatedOn, lastEnumerationStatus, activity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudEndpointLastChangeEnumerationStatus(startedOn, completedOn, namespaceFilesCount, namespaceDirectoriesCount, namespaceSizeInBytes, nextRunTimestamp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudEndpointPostBackupResult(cloudEndpointName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudEndpointAfsShareMetadataCertificatePublicKeys(firstKey, secondKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageSyncServerEndpointCreateOrUpdateContent(id, name, resourceType, systemData, serverLocalPath, cloudTiering, volumeFreeSpacePercent, tierFilesOlderThanDays, friendlyName, serverResourceId, offlineDataTransfer, offlineDataTransferShareName, initialDownloadPolicy, localCacheMode, initialUploadPolicy, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerEndpointSyncStatus(downloadHealth, uploadHealth, combinedHealth, syncActivity, totalPersistentFilesNotSyncingCount, lastUpdatedOn, uploadStatus, downloadStatus, uploadActivity, downloadActivity, offlineDataTransferStatus, backgroundDataDownloadActivity, new Dictionary<string, BinaryData>());
        }
        ...
        public static ServerEndpointSyncSessionStatus ServerEndpointSyncSessionStatus(int? lastSyncResult = null, DateTimeOffset? lastSyncTimestamp = null, DateTimeOffset? lastSyncSuccessTimestamp = null, long? lastSyncPerItemErrorCount = null, long? persistentFilesNotSyncingCount = null, long? transientFilesNotSyncingCount = null, IEnumerable<ServerEndpointFilesNotSyncingError> filesNotSyncingErrors = null, ServerEndpointSyncMode? lastSyncMode = null)
        {
            ...
            return new ServerEndpointSyncSessionStatus(lastSyncResult, lastSyncTimestamp, lastSyncSuccessTimestamp, lastSyncPerItemErrorCount, persistentFilesNotSyncingCount, transientFilesNotSyncingCount, filesNotSyncingErrors?.ToList(), lastSyncMode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerEndpointFilesNotSyncingError(errorCode, persistentCount, transientCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerEndpointSyncActivityStatus(timestamp, perItemErrorCount, appliedItemCount, totalItemCount, appliedBytes, totalBytes, syncMode, sessionMinutesRemaining, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerEndpointBackgroundDataDownloadActivity(timestamp, startedOn, percentProgress, downloadedBytes, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerEndpointCloudTieringStatus(lastUpdatedOn, health, healthLastUpdatedOn, lastCloudTieringResult, lastSuccessTimestamp, spaceSavings, cachePerformance, filesNotTiering, volumeFreeSpacePolicyStatus, datePolicyStatus, lowDiskMode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudTieringSpaceSavings(lastUpdatedOn, volumeSizeInBytes, cloudTotalSizeInBytes, cachedSizeInBytes, spaceSavingsPercent, spaceSavingsInBytes, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudTieringCachePerformance(lastUpdatedOn, cacheHitBytes, cacheMissBytes, cacheHitBytesPercent, new Dictionary<string, BinaryData>());
        }
        ...
        public static CloudTieringFilesNotTiering CloudTieringFilesNotTiering(DateTimeOffset? lastUpdatedOn = null, long? totalFileCount = null, IEnumerable<FilesNotTieringError> errors = null)
        {
            ...
            return new CloudTieringFilesNotTiering(lastUpdatedOn, totalFileCount, errors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FilesNotTieringError(errorCode, fileCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudTieringVolumeFreeSpacePolicyStatus(lastUpdatedOn, effectiveVolumeFreeSpacePolicy, currentVolumeFreeSpacePercent, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudTieringDatePolicyStatus(lastUpdatedOn, tieredFilesMostRecentAccessTimestamp, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CloudTieringLowDiskMode(lastUpdatedOn, state, new Dictionary<string, BinaryData>());
        }
        ...
        public static ServerEndpointRecallStatus ServerEndpointRecallStatus(DateTimeOffset? lastUpdatedOn = null, long? totalRecallErrorsCount = null, IEnumerable<ServerEndpointRecallError> recallErrors = null)
        {
            ...
            return new ServerEndpointRecallStatus(lastUpdatedOn, totalRecallErrorsCount, recallErrors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServerEndpointRecallError(errorCode, count, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageSyncRegisteredServerCreateOrUpdateContent(id, name, resourceType, systemData, serverCertificate, agentVersion, serverOSVersion, lastHeartbeat, serverRole, clusterId, clusterName, serverId, friendlyName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageSyncWorkflowData(id, name, resourceType, systemData, lastStepName, status, operation, steps, lastOperationId, commandName, createdOn, lastStatusUpdatedOn, new Dictionary<string, BinaryData>());
        }
    }
}
