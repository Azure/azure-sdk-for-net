...
namespace Azure.ResourceManager.StorageSync.Models
{
    ...
    public static partial class ArmStorageSyncModelFactory
    {
        ...
        public static StorageSyncServiceCreateOrUpdateContent StorageSyncServiceCreateOrUpdateContent(AzureLocation location = default, IDictionary<string, string> tags = null, IncomingTrafficPolicy? incomingTrafficPolicy = null)
        {
            ...
            return new StorageSyncServiceCreateOrUpdateContent(location, tags, incomingTrafficPolicy, default);
        }
        ...
        public static StorageSyncServiceData StorageSyncServiceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, IncomingTrafficPolicy? incomingTrafficPolicy = null, int? storageSyncServiceStatus = null, Guid? storageSyncServiceUid = null, string provisioningState = null, string lastWorkflowId = null, string lastOperationName = null, IEnumerable<StorageSyncPrivateEndpointConnectionData> privateEndpointConnections = null)
        {
            ...
            return new StorageSyncServiceData(id, name, resourceType, systemData, tags, location, incomingTrafficPolicy, storageSyncServiceStatus, storageSyncServiceUid, provisioningState, lastWorkflowId, lastOperationName, privateEndpointConnections?.ToList(), default);
        }
        ...
        {
            return new StorageSyncPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, default);
        }
        ...
        public static StorageSyncPrivateLinkResource StorageSyncPrivateLinkResource(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new StorageSyncPrivateLinkResource(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), default);
        }
        ...
        {
            return new StorageSyncGroupData(id, name, resourceType, systemData, uniqueId, syncGroupStatus, default);
        }
        ...
        {
            return new StorageSyncGroupCreateOrUpdateContent(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new CloudEndpointCreateOrUpdateContent(id, name, resourceType, systemData, storageAccountResourceId, azureFileShareName, storageAccountTenantId, friendlyName, default);
        }
        ...
        {
            return new CloudEndpointData(id, name, resourceType, systemData, storageAccountResourceId, azureFileShareName, storageAccountTenantId, partnershipId, friendlyName, isBackupEnabled, provisioningState, lastWorkflowId, lastOperationName, changeEnumerationStatus, default);
        }
        ...
        {
            return new CloudEndpointLastChangeEnumerationStatus(startedOn, completedOn, namespaceFilesCount, namespaceDirectoriesCount, namespaceSizeInBytes, nextRunTimestamp, default);
        }
        ...
        {
            return new CloudEndpointChangeEnumerationActivity(lastUpdatedOn, operationState, statusCode, startedOn, processedFilesCount, processedDirectoriesCount, totalFilesCount, totalDirectoriesCount, totalSizeInBytes, progressPercent, minutesRemaining, totalCountsState, deletesProgressPercent, default);
        }
        ...
        {
            return new CloudEndpointPostBackupResult(cloudEndpointName, default);
        }
        ...
        {
            return new StorageSyncServerEndpointCreateOrUpdateContent(id, name, resourceType, systemData, serverLocalPath, cloudTiering, volumeFreeSpacePercent, tierFilesOlderThanDays, friendlyName, serverResourceId, offlineDataTransfer, offlineDataTransferShareName, initialDownloadPolicy, localCacheMode, initialUploadPolicy, default);
        }
        ...
        {
            return new ServerEndpointSyncStatus(downloadHealth, uploadHealth, combinedHealth, syncActivity, totalPersistentFilesNotSyncingCount, lastUpdatedOn, uploadStatus, downloadStatus, uploadActivity, downloadActivity, offlineDataTransferStatus, backgroundDataDownloadActivity, default);
        }
        ...
        public static ServerEndpointSyncSessionStatus ServerEndpointSyncSessionStatus(int? lastSyncResult = null, DateTimeOffset? lastSyncTimestamp = null, DateTimeOffset? lastSyncSuccessTimestamp = null, long? lastSyncPerItemErrorCount = null, long? persistentFilesNotSyncingCount = null, long? transientFilesNotSyncingCount = null, IEnumerable<ServerEndpointFilesNotSyncingError> filesNotSyncingErrors = null, ServerEndpointSyncMode? lastSyncMode = null)
        {
            ...
            return new ServerEndpointSyncSessionStatus(lastSyncResult, lastSyncTimestamp, lastSyncSuccessTimestamp, lastSyncPerItemErrorCount, persistentFilesNotSyncingCount, transientFilesNotSyncingCount, filesNotSyncingErrors?.ToList(), lastSyncMode, default);
        }
        ...
        {
            return new ServerEndpointSyncActivityStatus(timestamp, perItemErrorCount, appliedItemCount, totalItemCount, appliedBytes, totalBytes, syncMode, sessionMinutesRemaining, default);
        }
        ...
        {
            return new ServerEndpointCloudTieringStatus(lastUpdatedOn, health, healthLastUpdatedOn, lastCloudTieringResult, lastSuccessTimestamp, spaceSavings, cachePerformance, filesNotTiering, volumeFreeSpacePolicyStatus, datePolicyStatus, lowDiskMode, default);
        }
        ...
        {
            return new CloudTieringSpaceSavings(lastUpdatedOn, volumeSizeInBytes, cloudTotalSizeInBytes, cachedSizeInBytes, spaceSavingsPercent, spaceSavingsInBytes, default);
        }
        ...
        public static CloudTieringFilesNotTiering CloudTieringFilesNotTiering(DateTimeOffset? lastUpdatedOn = null, long? totalFileCount = null, IEnumerable<FilesNotTieringError> errors = null)
        {
            ...
            return new CloudTieringFilesNotTiering(lastUpdatedOn, totalFileCount, errors?.ToList(), default);
        }
        ...
        public static ServerEndpointRecallStatus ServerEndpointRecallStatus(DateTimeOffset? lastUpdatedOn = null, long? totalRecallErrorsCount = null, IEnumerable<ServerEndpointRecallError> recallErrors = null)
        {
            ...
            return new ServerEndpointRecallStatus(lastUpdatedOn, totalRecallErrorsCount, recallErrors?.ToList(), default);
        }
        ...
        {
            return new StorageSyncRegisteredServerCreateOrUpdateContent(id, name, resourceType, systemData, serverCertificate, agentVersion, serverOSVersion, lastHeartbeat, serverRole, clusterId, clusterName, serverId, friendlyName, default);
        }
        ...
        {
            return new StorageSyncWorkflowData(id, name, resourceType, systemData, lastStepName, status, operation, steps, lastOperationId, commandName, createdOn, lastStatusUpdatedOn, default);
        }
    }
}
