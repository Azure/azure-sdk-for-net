...
namespace Azure.ResourceManager.PaloAltoNetworks
{
    ...
    public partial class PreRulesResource : ArmResource
    {
        ...
        {
            _preRulesResourcePreRulesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.PaloAltoNetworks", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PaloAltoNetworksArmOperation(_preRulesResourcePreRulesClientDiagnostics, Pipeline, _preRulesResourcePreRulesRestClient.CreateDeleteRequest(Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual async Task<ArmOperation<PreRulesResource>> UpdateAsync(WaitUntil waitUntil, PreRulesResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new PaloAltoNetworksArmOperation<PreRulesResource>(new PreRulesResourceOperationSource(Client), _preRulesResourcePreRulesClientDiagnostics, Pipeline, _preRulesResourcePreRulesRestClient.CreateCreateOrUpdateRequest(Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
