...
namespace Azure.ResourceManager.PaloAltoNetworks.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SecurityServices. </summary>
        ...
        internal SecurityServices(string vulnerabilityProfile, string antiSpywareProfile, string antiVirusProfile, string urlFilteringProfile, string fileBlockingProfile, string dnsSubscription, string outboundUnTrustCertificate, string outboundTrustCertificate)
        {
