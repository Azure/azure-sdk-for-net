...
namespace Azure.ResourceManager.PaloAltoNetworks
{
    public partial class LocalRulestackResourceData : IUtf8JsonSerializable
    {
        ...
        internal static LocalRulestackResourceData DeserializeLocalRulestackResourceData(JsonElement element)
        {
            ...
            return new LocalRulestackResourceData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity.Value, panETag.Value, panLocation.Value, Optional.ToNullable(scope), Optional.ToList(associatedSubscriptions), description.Value, Optional.ToNullable(defaultMode), minAppIdVersion.Value, Optional.ToNullable(provisioningState), securityServices.Value);
        }
    }
}
