...
{
    public partial class CertificateObjectLocalRulestackResourceData : IUtf8JsonSerializable
    {
        ...
        internal static CertificateObjectLocalRulestackResourceData DeserializeCertificateObjectLocalRulestackResourceData(JsonElement element)
        {
            ...
            BooleanEnum certificateSelfSigned = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            certificateSelfSigned = new BooleanEnum(property0.Value.GetString());
                            continue;
                        }
            ...
            return new CertificateObjectLocalRulestackResourceData(id, name, type, systemData.Value, certificateSignerResourceId.Value, certificateSelfSigned, auditComment.Value, description.Value, Optional.ToNullable(etag), Optional.ToNullable(provisioningState));
        }
    }
}
