...
#pragma warning disable SA1649 // File name should match first type name
    internal class PaloAltoNetworksArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal<T> _operation;

        /// <summary> Initializes a new instance of PaloAltoNetworksArmOperation for mocking. </summary>
        protected PaloAltoNetworksArmOperation()
        {
        }

        internal PaloAltoNetworksArmOperation(Response<T> response)
        {
            _operation = OperationInternal<T>.Succeeded(response.GetRawResponse(), response.Value);
        }

        internal PaloAltoNetworksArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal<T>(clientDiagnostics, nextLinkOperation, response, "PaloAltoNetworksArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
