...
#pragma warning disable SA1649 // File name should match first type name
    internal class PaloAltoNetworksArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal PaloAltoNetworksArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal PaloAltoNetworksArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "PaloAltoNetworksArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
