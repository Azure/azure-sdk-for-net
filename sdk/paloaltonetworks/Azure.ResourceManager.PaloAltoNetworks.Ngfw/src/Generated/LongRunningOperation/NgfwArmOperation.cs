...
#pragma warning disable SA1649 // File name should match first type name
    internal class NgfwArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of NgfwArmOperation for mocking. </summary>
        protected NgfwArmOperation()
        {
        }
        ...
        internal NgfwArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "NgfwArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
