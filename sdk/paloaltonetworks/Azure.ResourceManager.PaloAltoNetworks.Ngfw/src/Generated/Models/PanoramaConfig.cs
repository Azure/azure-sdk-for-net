...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class PanoramaConfig
    {
        ...
        internal PanoramaConfig(string configString, string vmAuthKey, string panoramaServer, string panoramaServer2, string dgName, string tplName, string cgName, string hostName)
        {
            ConfigString = configString;
            VmAuthKey = vmAuthKey;
