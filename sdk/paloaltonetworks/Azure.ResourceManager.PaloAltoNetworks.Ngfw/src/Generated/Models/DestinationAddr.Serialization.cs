...
{
    public partial class DestinationAddr : IUtf8JsonSerializable
    {
        ...
        internal static DestinationAddr DeserializeDestinationAddr(JsonElement element)
        {
            ...
            return new DestinationAddr(Optional.ToList(cidrs), Optional.ToList(countries), Optional.ToList(feeds), Optional.ToList(prefixLists), Optional.ToList(fqdnLists));
        }
    }
}
