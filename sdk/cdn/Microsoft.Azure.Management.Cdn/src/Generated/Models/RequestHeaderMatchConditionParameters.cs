...
namespace Microsoft.Azure.Management.Cdn.Models
{
    ...
    public partial class RequestHeaderMatchConditionParameters
    {
        ...
        public RequestHeaderMatchConditionParameters(string operatorProperty, string selector = default(string), bool? negateCondition = default(bool?), IList<string> matchValues = default(IList<string>), IList<string> transforms = default(IList<string>))
        {
            Selector = selector;
