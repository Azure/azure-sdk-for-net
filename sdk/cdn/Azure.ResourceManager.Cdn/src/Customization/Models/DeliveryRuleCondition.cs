...
{
    // Customization: This file adds a parameterless constructor to the DeliveryRuleCondition abstract base class for backward API compatibility with the previous SDK.
