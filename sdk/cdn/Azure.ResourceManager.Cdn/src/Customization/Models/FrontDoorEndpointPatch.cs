...
{
    // Customization: Renames the generator-produced FrontDoorEndpointUpdateParameters back to the shipped name FrontDoorEndpointPatch.
    // Reason: A csharp-scoped @@clientName override in the spec (AFDEndpointUpdateParameters -> "FrontDoorEndpointUpdateParameters")
    ...
    [CodeGenType("FrontDoorEndpointUpdateParameters")]
