...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    // parameter, but after the TypeSpec migration, the generated parameterless constructor uses ResourceReference
    // (an internal type) instead. The old constructor (WritableSubResource) is preserved here to avoid breaking
    // user code, internally converting WritableSubResource to ResourceReference.
