...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    // Reason: The TypeSpec generator removes separators from TLS version numbers to produce member names (e.g., TLS10, TLS12),
    // but the old SDK used underscore-separated readable names (e.g., Tls1_0, Tls1_2).
