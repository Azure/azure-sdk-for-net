...
{
    // Customization: This file adds a parameterless constructor to the CertificateSourceProperties abstract base class for backward API compatibility with the previous SDK.
