...
{
    public partial class FrontDoorSecretData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FrontDoorSecretData DeserializeFrontDoorSecretData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
