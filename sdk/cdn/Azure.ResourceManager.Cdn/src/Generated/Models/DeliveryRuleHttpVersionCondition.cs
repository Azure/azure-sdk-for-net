...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleHttpVersionCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleHttpVersionCondition(MatchVariable name, HttpVersionMatchCondition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
