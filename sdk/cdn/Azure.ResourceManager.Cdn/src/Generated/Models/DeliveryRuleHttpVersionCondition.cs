...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleHttpVersionCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleHttpVersionCondition(HttpVersionMatchCondition parameters)
        {
            if (parameters == null)
            {
        ...
        /// <param name="parameters"> Defines the parameters for the condition. </param>
        internal DeliveryRuleHttpVersionCondition(MatchVariable name, HttpVersionMatchCondition parameters) : base(name)
        {
            Parameters = parameters;
            Name = name;
        }
