...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleHttpVersionCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleHttpVersionCondition(MatchVariable name, HttpVersionMatchCondition properties, Dictionary<string, BinaryData> rawData) : base(name, rawData)
        {
            Properties = properties;
            Name = name;
        }
