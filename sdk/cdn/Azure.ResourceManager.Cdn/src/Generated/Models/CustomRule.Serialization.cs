...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomRule>)} interface");
            }
        ...
        string IPersistableModel<CustomRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
