...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class SharedPrivateLinkResourceProperties
    {
        ...
        internal SharedPrivateLinkResourceProperties(WritableSubResource privateLink, string privateLinkLocation, string groupId, string requestMessage, SharedPrivateLinkResourceStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
