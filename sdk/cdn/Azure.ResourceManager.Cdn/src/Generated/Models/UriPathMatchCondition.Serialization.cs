...
{
    public partial class UriPathMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static UriPathMatchCondition DeserializeUriPathMatchCondition(JsonElement element)
        {
            ...
            return new UriPathMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
