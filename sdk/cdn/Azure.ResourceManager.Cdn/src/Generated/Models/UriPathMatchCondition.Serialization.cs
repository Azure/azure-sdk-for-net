...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriPathMatchCondition : DeliveryRuleConditionProperties, IJsonModel<UriPathMatchCondition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<UriPathMatchCondition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<UriPathMatchCondition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        UriPathMatchCondition IPersistableModel<UriPathMatchCondition>.Create(BinaryData data, ModelReaderWriterOptions options) => (UriPathMatchCondition)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        UriPathMatchCondition IJsonModel<UriPathMatchCondition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UriPathMatchCondition)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UriPathMatchCondition DeserializeUriPathMatchCondition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            UriPathOperator uriPathOperator = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    uriPathOperator = new UriPathOperator(prop.Value.GetString());
                    continue;
                }
