...
{
    public partial class UriPathMatchCondition : IUtf8JsonSerializable, IJsonModel<UriPathMatchCondition>, IPersistableModel<UriPathMatchCondition>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UriPathMatchCondition>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<UriPathMatchCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UriPathMatchCondition)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UriPathOperator))
            {
                builder.Append("  operator:");
                builder.AppendLine($" '{UriPathOperator.ToString()}'");
            }
