...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorActivatedResourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontDoorActivatedResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorActivatedResourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontDoorActivatedResourceInfo>)} interface");
            }
        ...
        string IPersistableModel<FrontDoorActivatedResourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
