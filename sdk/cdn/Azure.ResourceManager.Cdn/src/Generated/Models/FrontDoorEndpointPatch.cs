...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class FrontDoorEndpointPatch
    {
        ...
        internal FrontDoorEndpointPatch(IDictionary<string, string> tags, string profileName, EnabledState? enabledState, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
