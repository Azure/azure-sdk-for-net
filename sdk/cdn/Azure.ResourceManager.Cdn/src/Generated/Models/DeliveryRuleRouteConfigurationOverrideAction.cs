...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRouteConfigurationOverrideAction : DeliveryRuleAction
    {
        ...
        public DeliveryRuleRouteConfigurationOverrideAction(RouteConfigurationOverrideActionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the action. </param>
        internal DeliveryRuleRouteConfigurationOverrideAction(DeliveryRuleActionType name, IDictionary<string, BinaryData> serializedAdditionalRawData, RouteConfigurationOverrideActionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public RouteConfigurationOverrideActionParameters Properties { get; set; }
    }
}
