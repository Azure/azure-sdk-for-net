...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static FrontDoorCustomDomainListResult DeserializeFrontDoorCustomDomainListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
