...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class ResourcesResponseEndpointsItem
    {
        ...
        internal ResourcesResponseEndpointsItem(string id, string name, bool? history, IReadOnlyList<ResourcesResponseEndpointsPropertiesItemsItem> customDomains, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Name = name;
            History = history;
