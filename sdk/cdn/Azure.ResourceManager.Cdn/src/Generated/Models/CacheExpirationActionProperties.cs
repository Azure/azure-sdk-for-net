...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CacheExpirationActionProperties
    {
        ...
        public CacheExpirationActionProperties(CacheExpirationActionType actionType, CacheBehaviorSettings cacheBehavior, CacheLevel cacheType)
        {
        ...
        internal CacheExpirationActionProperties(CacheExpirationActionType actionType, CacheBehaviorSettings cacheBehavior, CacheLevel cacheType, TimeSpan? cacheDuration)
        {
            ActionType = actionType;
            CacheBehavior = cacheBehavior;
            CacheType = cacheType;
