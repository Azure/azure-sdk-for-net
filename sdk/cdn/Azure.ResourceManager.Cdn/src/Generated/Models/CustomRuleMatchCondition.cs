...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CustomRuleMatchCondition
    {
        ...
        internal CustomRuleMatchCondition(WafMatchVariable matchVariable, string selector, MatchOperator matchOperator, bool? negateCondition, IList<string> matchValue, IList<TransformType> transforms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MatchVariable = matchVariable;
            Selector = selector;
            MatchOperator = matchOperator;
