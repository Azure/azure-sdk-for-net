...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CustomRuleMatchCondition
    {
        ...
        public CustomRuleMatchCondition(WafMatchVariable matchVariable, Operator matchOperator, IEnumerable<string> matchValue)
        {
        ...
        internal CustomRuleMatchCondition(WafMatchVariable matchVariable, string selector, Operator matchOperator, bool? negateCondition, IList<string> matchValue, IList<TransformType> transforms, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            MatchVariable = matchVariable;
            Selector = selector;
            MatchOperator = matchOperator;
