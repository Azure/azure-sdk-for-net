...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UrlRedirectActionParameters : DeliveryRuleActionProperties
    {
        ...
        public UrlRedirectActionParameters(RedirectType redirectType) : base(DeliveryRuleActionParametersType.DeliveryRuleUrlRedirectActionParameters)
        {
        ...
        internal UrlRedirectActionParameters(DeliveryRuleActionParametersType typeName, IDictionary<string, BinaryData> additionalBinaryDataProperties, RedirectType redirectType, DestinationProtocol? destinationProtocol, string customPath, string customHostname, string customQueryString, string customFragment) : base(typeName, additionalBinaryDataProperties)
        {
            RedirectType = redirectType;
