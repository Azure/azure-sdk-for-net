...
{
    public partial class DeepCreatedOrigin : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DeepCreatedOrigin DeserializeDeepCreatedOrigin(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
