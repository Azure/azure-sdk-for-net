...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeepCreatedOrigin>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeepCreatedOrigin>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeepCreatedOrigin>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeepCreatedOrigin>)} interface");
            }
        ...
        string IPersistableModel<DeepCreatedOrigin>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
