...
{
    public partial class SecurityPolicyProperties : IUtf8JsonSerializable, IModelJsonSerializable<SecurityPolicyProperties>
    {
        ...
        internal static SecurityPolicyProperties DeserializeSecurityPolicyProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownSecurityPolicyProperties(type, rawData);
        }
        ...
        /// <summary> Converts a <see cref="SecurityPolicyProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="SecurityPolicyProperties"/> to convert. </param>
        public static implicit operator RequestContent(SecurityPolicyProperties model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="SecurityPolicyProperties"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator SecurityPolicyProperties(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeSecurityPolicyProperties(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
