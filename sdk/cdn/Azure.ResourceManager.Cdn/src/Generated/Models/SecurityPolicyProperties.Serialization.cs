...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class SecurityPolicyProperties : IUtf8JsonSerializable, IJsonModel<SecurityPolicyProperties>
    {
        ...
        void IJsonModel<SecurityPolicyProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SecurityPolicyProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SecurityPolicyProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SecurityPolicyProperties)} does not support '{options.Format}' format.");
            }
        }
