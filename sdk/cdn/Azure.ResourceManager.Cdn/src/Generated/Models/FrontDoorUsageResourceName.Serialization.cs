...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorUsageResourceName>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontDoorUsageResourceName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorUsageResourceName>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontDoorUsageResourceName>)} interface");
            }
        ...
        string IPersistableModel<FrontDoorUsageResourceName>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
