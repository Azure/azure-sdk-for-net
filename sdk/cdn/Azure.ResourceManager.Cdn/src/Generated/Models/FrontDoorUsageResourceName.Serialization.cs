...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static FrontDoorUsageResourceName DeserializeFrontDoorUsageResourceName(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
