...
{
    internal partial class UnknownDeliveryRuleActionProperties : DeliveryRuleActionProperties, IJsonModel<DeliveryRuleActionProperties>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownDeliveryRuleActionProperties"/> for deserialization. </summary>
        internal UnknownDeliveryRuleActionProperties()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDeliveryRuleActionProperties DeserializeUnknownDeliveryRuleActionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDeliveryRuleActionProperties(typeName, additionalBinaryDataProperties);
        }
    }
}
