...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class ServerPortMatchConditionParameters : DeliveryRuleConditionProperties
    {
        /// <summary> Initializes a new instance of <see cref="ServerPortMatchConditionParameters"/>. </summary>
        /// <param name="operator"> Describes operator to be matched. </param>
        public ServerPortMatchConditionParameters(ServerPortOperator @operator) : base(DeliveryRuleConditionParametersType.DeliveryRuleServerPortConditionParameters)
        {
            Operator = @operator;
