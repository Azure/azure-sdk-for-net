...
{
    public partial class CookiesMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static CookiesMatchConditionDefinition DeserializeCookiesMatchConditionDefinition(JsonElement element)
        {
            ...
            return new CookiesMatchConditionDefinition(typeName, selector.Value, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
