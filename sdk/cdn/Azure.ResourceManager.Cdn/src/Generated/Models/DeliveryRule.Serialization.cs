...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeliveryRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeliveryRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeliveryRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeliveryRule>)} interface");
            }
        ...
        string IPersistableModel<DeliveryRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
