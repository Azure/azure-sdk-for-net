...
{
    public partial class RateLimitRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RateLimitRule DeserializeRateLimitRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
