...
{
    public partial class UriSigningKey : IUtf8JsonSerializable, IJsonModel<UriSigningKey>, IPersistableModel<UriSigningKey>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KeySourceParameters))
            {
                ...
                AppendChildObject(builder, KeySourceParameters, options, 2);
            }
