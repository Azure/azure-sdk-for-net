...
{
    public partial class UriSigningKey : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static UriSigningKey DeserializeUriSigningKey(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
