...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRequestSchemeCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleRequestSchemeCondition(RequestSchemeMatchCondition properties) : base(DeliveryRuleMatchVariable.RequestScheme)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleRequestSchemeCondition(DeliveryRuleMatchVariable name, IDictionary<string, BinaryData> additionalBinaryDataProperties, RequestSchemeMatchCondition properties) : base(name, additionalBinaryDataProperties)
        {
            Properties = properties;
        }
