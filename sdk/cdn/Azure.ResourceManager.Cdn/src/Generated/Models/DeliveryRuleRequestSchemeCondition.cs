...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRequestSchemeCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleRequestSchemeCondition(MatchVariable name, RequestSchemeMatchCondition properties, Dictionary<string, BinaryData> rawData) : base(name, rawData)
        {
            Properties = properties;
            Name = name;
        }
