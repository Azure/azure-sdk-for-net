...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorRoutePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontDoorRoutePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorRoutePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontDoorRoutePatch>)} interface");
            }
        ...
        string IPersistableModel<FrontDoorRoutePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
