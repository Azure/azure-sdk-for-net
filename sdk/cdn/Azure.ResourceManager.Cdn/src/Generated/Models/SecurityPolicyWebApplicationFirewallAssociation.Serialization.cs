...
{
    public partial class SecurityPolicyWebApplicationFirewallAssociation : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityPolicyWebApplicationFirewallAssociation DeserializeSecurityPolicyWebApplicationFirewallAssociation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
