...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityPolicyWebApplicationFirewallAssociation>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityPolicyWebApplicationFirewallAssociation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityPolicyWebApplicationFirewallAssociation>)} interface");
            }
        ...
        string IPersistableModel<SecurityPolicyWebApplicationFirewallAssociation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
