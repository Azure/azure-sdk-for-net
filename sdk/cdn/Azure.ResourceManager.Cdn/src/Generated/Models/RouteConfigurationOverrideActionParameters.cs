...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RouteConfigurationOverrideActionParameters : DeliveryRuleActionProperties
    {
        /// <summary> Initializes a new instance of <see cref="RouteConfigurationOverrideActionParameters"/>. </summary>
        public RouteConfigurationOverrideActionParameters() : base(DeliveryRuleActionParametersType.DeliveryRuleRouteConfigurationOverrideActionParameters)
        {
        }
        ...
        internal RouteConfigurationOverrideActionParameters(DeliveryRuleActionParametersType typeName, IDictionary<string, BinaryData> additionalBinaryDataProperties, OriginGroupOverride originGroupOverride, CacheConfiguration cacheConfiguration) : base(typeName, additionalBinaryDataProperties)
        {
