...
{
    public partial class DeliveryRuleHostNameCondition : IUtf8JsonSerializable, IJsonModel<DeliveryRuleHostNameCondition>, IPersistableModel<DeliveryRuleHostNameCondition>
    {
        ...
        void IJsonModel<DeliveryRuleHostNameCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeliveryRuleHostNameCondition)} does not support '{format}' format.");
            }
