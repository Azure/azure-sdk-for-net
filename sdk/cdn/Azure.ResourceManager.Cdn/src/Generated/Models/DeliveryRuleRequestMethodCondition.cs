...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRequestMethodCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleRequestMethodCondition(RequestMethodMatchConditionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleRequestMethodCondition(MatchVariable name, IDictionary<string, BinaryData> serializedAdditionalRawData, RequestMethodMatchConditionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public RequestMethodMatchConditionParameters Properties { get; set; }
    }
}
