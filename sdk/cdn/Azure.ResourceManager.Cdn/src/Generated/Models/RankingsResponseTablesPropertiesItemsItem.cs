...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RankingsResponseTablesPropertiesItemsItem
    {
        ...
        internal RankingsResponseTablesPropertiesItemsItem(string name, IReadOnlyList<RankingsResponseTablesPropertiesItemsMetricsItem> metrics, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Metrics = metrics;
