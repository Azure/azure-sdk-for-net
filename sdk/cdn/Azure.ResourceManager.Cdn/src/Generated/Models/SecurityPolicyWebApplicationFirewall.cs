...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class SecurityPolicyWebApplicationFirewall : SecurityPolicyProperties
    {
        ...
        internal SecurityPolicyWebApplicationFirewall(SecurityPolicyType policyType, WritableSubResource wafPolicy, IList<SecurityPolicyWebApplicationFirewallAssociation> associations, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(policyType, serializedAdditionalRawData)
        {
            WafPolicy = wafPolicy;
