...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeNode>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeNode>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeNode>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeNode>)} interface");
            }
        ...
        string IPersistableModel<EdgeNode>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
