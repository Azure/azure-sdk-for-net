...
{
    public partial class EdgeNode : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static EdgeNode DeserializeEdgeNode(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
