...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class ClientPortMatchConditionDefinition
    {
        ...
        internal ClientPortMatchConditionDefinition(ClientPortMatchConditionType typeDefinition, ClientPortOperator @operator, bool? negateCondition, IList<string> matchValues, IList<TransformCategory> transforms)
        {
            TypeDefinition = typeDefinition;
            Operator = @operator;
