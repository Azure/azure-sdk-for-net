...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RemoteAddressMatchConditionParameters : DeliveryRuleConditionProperties
    {
        /// <summary> Initializes a new instance of <see cref="RemoteAddressMatchConditionParameters"/>. </summary>
        /// <param name="operator"> Describes operator to be matched. </param>
        public RemoteAddressMatchConditionParameters(RemoteAddressOperator @operator) : base(DeliveryRuleConditionParametersType.DeliveryRuleRemoteAddressConditionParameters)
        {
            Operator = @operator;
