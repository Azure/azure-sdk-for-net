...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RemoteAddressMatchConditionParameters
    {
        ...
        internal RemoteAddressMatchConditionParameters(RemoteAddressMatchConditionParametersTypeName typeName, RemoteAddressOperator @operator, bool? negateCondition, IList<string> matchValues, IList<TransformCategory> transforms)
        {
            TypeName = typeName;
            Operator = @operator;
