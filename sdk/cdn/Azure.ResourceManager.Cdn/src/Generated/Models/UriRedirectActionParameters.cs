...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriRedirectActionParameters : DeliveryRuleActionParameters
    {
        /// <summary> Initializes a new instance of <see cref="UriRedirectActionParameters"/>. </summary>
        /// <param name="redirectType"> The redirect type the rule will use when redirecting traffic. </param>
        public UriRedirectActionParameters(RedirectType redirectType)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="UriRedirectActionParameters"/> for deserialization. </summary>
        internal UriRedirectActionParameters()
        {
        }
