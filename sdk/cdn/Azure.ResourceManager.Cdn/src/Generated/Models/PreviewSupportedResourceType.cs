...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    internal readonly partial struct PreviewSupportedResourceType : IEquatable<PreviewSupportedResourceType>
    {
        ...
        private const string MicrosoftCdnProfilesAfdEndpointsRouteValue = "Microsoft.Cdn/profiles/afdEndpoints/routes";
        ...
        /// <summary> Gets the MicrosoftCdnProfilesAfdEndpointsRoute. </summary>
        public static PreviewSupportedResourceType MicrosoftCdnProfilesAfdEndpointsRoute { get; } = new PreviewSupportedResourceType(MicrosoftCdnProfilesAfdEndpointsRouteValue);

        /// <summary> Gets the MicrosoftCdnProfilesOriginGroups. </summary>
        ...
        /// <summary> Gets the MicrosoftCdnProfilesOriginGroupsOrigins. </summary>
        ...
        /// <summary> Gets the MicrosoftCdnProfilesRuleSets. </summary>
        ...
        /// <summary> Gets the MicrosoftCdnProfilesRuleSetsRules. </summary>
        ...
        /// <summary> Gets the MicrosoftCdnProfilesSecurityPolicies. </summary>
        ...
        /// <summary> Converts a string to a <see cref="PreviewSupportedResourceType"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator PreviewSupportedResourceType(string value) => new PreviewSupportedResourceType(value);

        /// <summary> Converts a string to a <see cref="PreviewSupportedResourceType"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator PreviewSupportedResourceType?(string value) => value == null ? null : new PreviewSupportedResourceType(value);
