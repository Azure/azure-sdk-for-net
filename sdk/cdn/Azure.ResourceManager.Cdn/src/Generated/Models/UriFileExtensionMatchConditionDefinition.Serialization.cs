...
{
    public partial class UriFileExtensionMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static UriFileExtensionMatchConditionDefinition DeserializeUriFileExtensionMatchConditionDefinition(JsonElement element)
        {
            ...
            return new UriFileExtensionMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
