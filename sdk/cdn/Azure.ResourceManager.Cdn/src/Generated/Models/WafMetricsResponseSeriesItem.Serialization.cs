...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static WafMetricsResponseSeriesItem DeserializeWafMetricsResponseSeriesItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
