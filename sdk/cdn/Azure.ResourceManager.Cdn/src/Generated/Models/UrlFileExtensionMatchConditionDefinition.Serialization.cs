...
{
    public partial class UrlFileExtensionMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static UrlFileExtensionMatchConditionDefinition DeserializeUrlFileExtensionMatchConditionDefinition(JsonElement element)
        {
            UrlFileExtensionMatchConditionType typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new UrlFileExtensionMatchConditionType(property.Value.GetString());
                    continue;
                }
            ...
            return new UrlFileExtensionMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
