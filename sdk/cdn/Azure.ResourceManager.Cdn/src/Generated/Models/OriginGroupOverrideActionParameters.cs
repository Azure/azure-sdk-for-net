...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class OriginGroupOverrideActionParameters : DeliveryRuleActionParameters
    {
        ...
        public OriginGroupOverrideActionParameters(WritableSubResource originGroup)
        {
        ...
        /// <param name="originGroup"> defines the OriginGroup that would override the DefaultOriginGroup. </param>
        internal OriginGroupOverrideActionParameters(DeliveryRuleActionParametersType typeName, IDictionary<string, BinaryData> serializedAdditionalRawData, WritableSubResource originGroup) : base(typeName, serializedAdditionalRawData)
        {
            OriginGroup = originGroup;
            TypeName = typeName;
        }
