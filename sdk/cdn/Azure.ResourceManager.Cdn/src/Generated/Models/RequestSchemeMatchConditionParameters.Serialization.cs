...
namespace Azure.ResourceManager.Cdn.Models
{
    public partial class RequestSchemeMatchConditionParameters : IUtf8JsonSerializable
    {
        ...
        {
            RequestSchemeMatchConditionParametersTypeName typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new RequestSchemeMatchConditionParametersTypeName(property.Value.GetString());
                    continue;
                }
            ...
            return new RequestSchemeMatchConditionParameters(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(transforms), Optional.ToList(matchValues));
        }
    }
}
