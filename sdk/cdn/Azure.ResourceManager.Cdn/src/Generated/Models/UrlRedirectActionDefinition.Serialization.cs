...
{
    public partial class UrlRedirectActionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static UrlRedirectActionDefinition DeserializeUrlRedirectActionDefinition(JsonElement element)
        {
            UrlRedirectActionType typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new UrlRedirectActionType(property.Value.GetString());
                    continue;
                }
            ...
            return new UrlRedirectActionDefinition(typeName, redirectType, Optional.ToNullable(destinationProtocol), customPath.Value, customHostname.Value, customQueryString.Value, customFragment.Value);
        }
    }
}
