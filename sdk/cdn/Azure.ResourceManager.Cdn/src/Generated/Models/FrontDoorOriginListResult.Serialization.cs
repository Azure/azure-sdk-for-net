...
{
    internal partial class FrontDoorOriginListResult : IUtf8JsonSerializable, IJsonModel<FrontDoorOriginListResult>, IPersistableModel<FrontDoorOriginListResult>
    {
        ...
        void IJsonModel<FrontDoorOriginListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FrontDoorOriginListResult)} does not support '{format}' format.");
            }
