...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static FrontDoorOriginListResult DeserializeFrontDoorOriginListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
