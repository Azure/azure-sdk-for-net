...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorOriginListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontDoorOriginListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorOriginListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontDoorOriginListResult>)} interface");
            }
        ...
        string IPersistableModel<FrontDoorOriginListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
