...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class QueryStringMatchCondition
    {
        ...
        internal QueryStringMatchCondition(QueryStringMatchConditionType conditionType, QueryStringOperator queryStringOperator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConditionType = conditionType;
            QueryStringOperator = queryStringOperator;
