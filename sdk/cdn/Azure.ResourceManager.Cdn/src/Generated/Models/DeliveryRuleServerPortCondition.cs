...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleServerPortCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleServerPortCondition(ServerPortMatchCondition properties) : base(MatchVariable.ServerPort)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleServerPortCondition(MatchVariable name, IDictionary<string, BinaryData> additionalBinaryDataProperties, ServerPortMatchCondition properties) : base(name, additionalBinaryDataProperties)
        {
            Properties = properties;
        }
