...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleServerPortCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleServerPortCondition(ServerPortMatchConditionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleServerPortCondition(MatchVariable name, IDictionary<string, BinaryData> serializedAdditionalRawData, ServerPortMatchConditionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public ServerPortMatchConditionParameters Properties { get; set; }
    }
}
