...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleServerPortCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleServerPortCondition(ServerPortMatchCondition parameters)
        {
            if (parameters == null)
            {
        ...
        /// <param name="parameters"> Defines the parameters for the condition. </param>
        internal DeliveryRuleServerPortCondition(MatchVariable name, ServerPortMatchCondition parameters) : base(name)
        {
            Parameters = parameters;
            Name = name;
        }
