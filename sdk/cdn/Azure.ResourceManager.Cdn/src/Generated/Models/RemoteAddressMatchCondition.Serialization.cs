...
{
    public partial class RemoteAddressMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static RemoteAddressMatchCondition DeserializeRemoteAddressMatchCondition(JsonElement element)
        {
            ...
            return new RemoteAddressMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
