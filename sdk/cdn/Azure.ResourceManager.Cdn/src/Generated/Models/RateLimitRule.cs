...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RateLimitRule : CustomRule
    {
        ...
        internal RateLimitRule(string name, CustomRuleEnabledState? enabledState, int priority, IList<CustomRuleMatchCondition> matchConditions, OverrideActionType action, int rateLimitThreshold, int rateLimitDurationInMinutes, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, enabledState, priority, matchConditions, action, serializedAdditionalRawData)
        {
            RateLimitThreshold = rateLimitThreshold;
            RateLimitDurationInMinutes = rateLimitDurationInMinutes;
        }
