...
{
    public partial class IsDeviceMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static IsDeviceMatchConditionDefinition DeserializeIsDeviceMatchConditionDefinition(JsonElement element)
        {
            ...
            return new IsDeviceMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
