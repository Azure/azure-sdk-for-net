...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationWebApplicationFirewallMapping>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MigrationWebApplicationFirewallMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrationWebApplicationFirewallMapping)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MigrationWebApplicationFirewallMapping>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrationWebApplicationFirewallMapping)} does not support '{options.Format}' format.");
            }
        }
