...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRule
    {
        ...
        internal DeliveryRule(string name, int order, IList<DeliveryRuleCondition> conditions, IList<DeliveryRuleAction> actions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Order = order;
