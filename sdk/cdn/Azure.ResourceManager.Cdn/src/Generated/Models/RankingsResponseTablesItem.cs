...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RankingsResponseTablesItem
    {
        ...
        internal RankingsResponseTablesItem(string ranking, IReadOnlyList<RankingsResponseTablesPropertiesItemsItem> data, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Ranking = ranking;
            Data = data;
