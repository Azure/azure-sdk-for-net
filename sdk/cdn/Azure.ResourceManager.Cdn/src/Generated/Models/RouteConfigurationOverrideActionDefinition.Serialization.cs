...
{
    public partial class RouteConfigurationOverrideActionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static RouteConfigurationOverrideActionDefinition DeserializeRouteConfigurationOverrideActionDefinition(JsonElement element)
        {
            ...
            return new RouteConfigurationOverrideActionDefinition(typeName, originGroupOverride.Value, cacheConfiguration.Value);
        }
    }
}
