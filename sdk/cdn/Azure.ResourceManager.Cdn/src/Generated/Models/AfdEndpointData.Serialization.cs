...
namespace Azure.ResourceManager.Cdn
{
    public partial class AfdEndpointData : IUtf8JsonSerializable
    {
        ...
        internal static AfdEndpointData DeserializeAfdEndpointData(JsonElement element)
        {
            ...
            return new AfdEndpointData(id, name, type, systemData, tags, location, profileName.Value, Optional.ToNullable(enabledState), Optional.ToNullable(provisioningState), Optional.ToNullable(deploymentStatus), hostName.Value, Optional.ToNullable(autoGeneratedDomainNameLabelScope));
        }
    }
}
