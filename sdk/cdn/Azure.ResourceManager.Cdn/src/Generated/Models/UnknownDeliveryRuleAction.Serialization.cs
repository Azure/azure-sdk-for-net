...
{
    internal partial class UnknownDeliveryRuleAction : DeliveryRuleAction, IJsonModel<DeliveryRuleAction>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDeliveryRuleAction DeserializeUnknownDeliveryRuleAction(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDeliveryRuleAction(name, additionalBinaryDataProperties);
        }
    }
}
