...
{
    public partial class DeliveryRuleServerPortCondition : IUtf8JsonSerializable, IJsonModel<DeliveryRuleServerPortCondition>, IPersistableModel<DeliveryRuleServerPortCondition>
    {
        ...
        void IJsonModel<DeliveryRuleServerPortCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeliveryRuleServerPortCondition)} does not support '{format}' format.");
            }
