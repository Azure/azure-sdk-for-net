...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleServerPortCondition : DeliveryRuleCondition, IJsonModel<DeliveryRuleServerPortCondition>
    {
        ...
        internal static DeliveryRuleServerPortCondition DeserializeDeliveryRuleServerPortCondition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ServerPortMatchConditionParameters parameters = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    parameters = ServerPortMatchConditionParameters.DeserializeServerPortMatchConditionParameters(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new DeliveryRuleServerPortCondition(name, additionalBinaryDataProperties, parameters);
        }
    }
}
