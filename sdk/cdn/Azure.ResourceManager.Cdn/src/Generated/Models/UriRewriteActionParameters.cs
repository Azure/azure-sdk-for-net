...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriRewriteActionParameters : DeliveryRuleActionParameters
    {
        /// <summary> Initializes a new instance of <see cref="UriRewriteActionParameters"/>. </summary>
        ...
        public UriRewriteActionParameters(string sourcePattern, string destination)
        {
        ...
        internal UriRewriteActionParameters(DeliveryRuleActionParametersType typeName, IDictionary<string, BinaryData> serializedAdditionalRawData, string sourcePattern, string destination, bool? preserveUnmatchedPath) : base(typeName, serializedAdditionalRawData)
        {
            SourcePattern = sourcePattern;
            Destination = destination;
        ...
        /// <summary> Initializes a new instance of <see cref="UriRewriteActionParameters"/> for deserialization. </summary>
        internal UriRewriteActionParameters()
        {
        }
