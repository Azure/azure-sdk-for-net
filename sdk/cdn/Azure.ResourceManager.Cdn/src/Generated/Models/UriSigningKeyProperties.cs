...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriSigningKeyProperties : FrontDoorSecretProperties
    {
        ...
        internal UriSigningKeyProperties(SecretType secretType, string keyId, WritableSubResource secretSource, string secretVersion, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(secretType, serializedAdditionalRawData)
        {
            KeyId = keyId;
            SecretSource = secretSource;
