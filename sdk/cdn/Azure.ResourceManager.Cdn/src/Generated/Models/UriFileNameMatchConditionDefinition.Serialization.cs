...
{
    public partial class UriFileNameMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static UriFileNameMatchConditionDefinition DeserializeUriFileNameMatchConditionDefinition(JsonElement element)
        {
            ...
            return new UriFileNameMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
