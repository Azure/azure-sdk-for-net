...
{
    public partial class ProfileData : IUtf8JsonSerializable, IJsonModel<ProfileData>, IPersistableModel<ProfileData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OriginResponseTimeoutSeconds))
            {
                ...
                builder.AppendLine($" '{OriginResponseTimeoutSeconds.Value.ToString()}'");
            }
