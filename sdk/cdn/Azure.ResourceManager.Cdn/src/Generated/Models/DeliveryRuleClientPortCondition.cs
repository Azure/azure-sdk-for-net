...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleClientPortCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleClientPortCondition(ClientPortMatchConditionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleClientPortCondition(MatchVariable name, IDictionary<string, BinaryData> serializedAdditionalRawData, ClientPortMatchConditionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public ClientPortMatchConditionParameters Properties { get; set; }
    }
}
