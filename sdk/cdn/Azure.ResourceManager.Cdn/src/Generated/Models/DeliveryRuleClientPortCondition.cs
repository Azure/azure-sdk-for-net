...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleClientPortCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleClientPortCondition(MatchVariable name, ClientPortMatchCondition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
