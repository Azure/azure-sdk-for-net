...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RouteConfigurationOverrideActionParameters : DeliveryRuleActionProperties, IJsonModel<RouteConfigurationOverrideActionParameters>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RouteConfigurationOverrideActionParameters>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RouteConfigurationOverrideActionParameters>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RouteConfigurationOverrideActionParameters IPersistableModel<RouteConfigurationOverrideActionParameters>.Create(BinaryData data, ModelReaderWriterOptions options) => (RouteConfigurationOverrideActionParameters)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RouteConfigurationOverrideActionParameters IJsonModel<RouteConfigurationOverrideActionParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RouteConfigurationOverrideActionParameters)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RouteConfigurationOverrideActionParameters DeserializeRouteConfigurationOverrideActionParameters(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new RouteConfigurationOverrideActionParameters(typeName, additionalBinaryDataProperties, originGroupOverride, cacheConfiguration);
        }
    }
}
