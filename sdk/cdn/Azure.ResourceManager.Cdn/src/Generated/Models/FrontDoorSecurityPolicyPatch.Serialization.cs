...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorSecurityPolicyPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
