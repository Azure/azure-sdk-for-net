...
namespace Azure.ResourceManager.Cdn.Models
{
    public partial class DeliveryRuleRequestMethodCondition : IUtf8JsonSerializable
    {
        ...
        {
            RequestMethodMatchConditionDefinition parameters = default;
            MatchVariable name = default;
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("parameters"))
                {
                    parameters = RequestMethodMatchConditionDefinition.DeserializeRequestMethodMatchConditionDefinition(property.Value);
                    continue;
                }
