    ...
    public partial class DeliveryRuleRequestMethodCondition : DeliveryRuleCondition, IJsonModel<DeliveryRuleRequestMethodCondition>
    {
        ...
        internal static DeliveryRuleRequestMethodCondition DeserializeDeliveryRuleRequestMethodCondition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    parameters = RequestMethodMatchConditionParameters.DeserializeRequestMethodMatchConditionParameters(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new DeliveryRuleRequestMethodCondition(name, additionalBinaryDataProperties, parameters);
        }
    }
}
