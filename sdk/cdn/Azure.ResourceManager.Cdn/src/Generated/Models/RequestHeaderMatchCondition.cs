...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RequestHeaderMatchCondition
    {
        ...
        internal RequestHeaderMatchCondition(RequestHeaderMatchConditionType conditionType, string selector, RequestHeaderOperator requestHeaderOperator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms, Dictionary<string, BinaryData> rawData)
        {
            ConditionType = conditionType;
            Selector = selector;
            RequestHeaderOperator = requestHeaderOperator;
