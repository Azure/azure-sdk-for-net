...
{
    public partial class FrontDoorOriginData : IUtf8JsonSerializable, IJsonModel<FrontDoorOriginData>, IPersistableModel<FrontDoorOriginData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Origin))
            {
                ...
                AppendChildObject(builder, Origin, options, 2);
            }
            ...
            if (Optional.IsDefined(SharedPrivateLinkResource))
            {
                ...
                AppendChildObject(builder, SharedPrivateLinkResource, options, 2);
            }
