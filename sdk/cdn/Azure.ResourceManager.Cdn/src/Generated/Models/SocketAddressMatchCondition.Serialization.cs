...
{
    public partial class SocketAddressMatchCondition : IUtf8JsonSerializable, IJsonModel<SocketAddressMatchCondition>, IPersistableModel<SocketAddressMatchCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SocketAddressOperator))
            {
                builder.Append("  operator:");
                builder.AppendLine($" '{SocketAddressOperator.ToString()}'");
            }
