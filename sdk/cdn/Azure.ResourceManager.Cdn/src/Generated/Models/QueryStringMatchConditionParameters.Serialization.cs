...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class QueryStringMatchConditionParameters : DeliveryRuleConditionProperties, IJsonModel<QueryStringMatchConditionParameters>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<QueryStringMatchConditionParameters>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<QueryStringMatchConditionParameters>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        QueryStringMatchConditionParameters IPersistableModel<QueryStringMatchConditionParameters>.Create(BinaryData data, ModelReaderWriterOptions options) => (QueryStringMatchConditionParameters)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        QueryStringMatchConditionParameters IJsonModel<QueryStringMatchConditionParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (QueryStringMatchConditionParameters)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static QueryStringMatchConditionParameters DeserializeQueryStringMatchConditionParameters(JsonElement element, ModelReaderWriterOptions options)
        {
