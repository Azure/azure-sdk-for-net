...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRequestBodyCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleRequestBodyCondition(RequestBodyMatchCondition parameters)
        {
            if (parameters == null)
            {
        ...
        /// <param name="parameters"> Defines the parameters for the condition. </param>
        internal DeliveryRuleRequestBodyCondition(MatchVariable name, RequestBodyMatchCondition parameters) : base(name)
        {
            Parameters = parameters;
            Name = name;
        }
