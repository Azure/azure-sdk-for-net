...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRequestBodyCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleRequestBodyCondition(MatchVariable name, RequestBodyMatchCondition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
