...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRequestBodyCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleRequestBodyCondition(RequestBodyMatchCondition properties) : base(MatchVariable.RequestBody)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleRequestBodyCondition(MatchVariable name, IDictionary<string, BinaryData> additionalBinaryDataProperties, RequestBodyMatchCondition properties) : base(name, additionalBinaryDataProperties)
        {
            Properties = properties;
        }
