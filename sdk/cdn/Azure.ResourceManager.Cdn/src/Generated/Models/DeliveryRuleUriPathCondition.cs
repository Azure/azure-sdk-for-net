...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleUriPathCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleUriPathCondition(MatchVariable name, UriPathMatchCondition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
