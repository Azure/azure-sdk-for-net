...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleUriPathCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleUriPathCondition(UriPathMatchConditionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleUriPathCondition(MatchVariable name, IDictionary<string, BinaryData> serializedAdditionalRawData, UriPathMatchConditionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public UriPathMatchConditionParameters Properties { get; set; }
    }
}
