...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static DomainValidationProperties DeserializeDomainValidationProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
