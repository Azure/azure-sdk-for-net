...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CdnCertificateSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CdnCertificateSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CdnCertificateSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CdnCertificateSource>)} interface");
            }
        ...
        string IPersistableModel<CdnCertificateSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
