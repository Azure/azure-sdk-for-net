...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CdnCertificateSource>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<CdnCertificateSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CdnCertificateSource>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
