...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MetricsResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MetricsResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MetricsResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MetricsResponse>)} interface");
            }
        ...
        string IPersistableModel<MetricsResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
