...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class PostArgsMatchCondition
    {
        ...
        internal PostArgsMatchCondition(PostArgsMatchConditionType conditionType, string selector, PostArgsOperator postArgsOperator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConditionType = conditionType;
            Selector = selector;
            PostArgsOperator = postArgsOperator;
