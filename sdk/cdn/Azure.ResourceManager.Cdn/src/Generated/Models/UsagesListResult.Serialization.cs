...
namespace Azure.ResourceManager.Cdn.Models
{
    internal partial class UsagesListResult : IUtf8JsonSerializable, IJsonModel<UsagesListResult>
    {
        ...
        void IJsonModel<UsagesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UsagesListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UsagesListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UsagesListResult)} does not support '{options.Format}' format.");
            }
        }
