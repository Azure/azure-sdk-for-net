...
{
    public partial class HttpVersionMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static HttpVersionMatchConditionDefinition DeserializeHttpVersionMatchConditionDefinition(JsonElement element)
        {
            ...
            return new HttpVersionMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
