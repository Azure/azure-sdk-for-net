...
{
    public partial class CacheKeyQueryStringActionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static CacheKeyQueryStringActionDefinition DeserializeCacheKeyQueryStringActionDefinition(JsonElement element)
        {
            ...
            return new CacheKeyQueryStringActionDefinition(typeName, queryStringBehavior, queryParameters.Value);
        }
    }
}
