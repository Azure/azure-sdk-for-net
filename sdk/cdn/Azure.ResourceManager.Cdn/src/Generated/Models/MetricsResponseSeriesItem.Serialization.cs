...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static MetricsResponseSeriesItem DeserializeMetricsResponseSeriesItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
