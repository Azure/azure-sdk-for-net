...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeepCreatedOriginGroup
    {
        ...
        internal DeepCreatedOriginGroup(string name, HealthProbeSettings healthProbeSettings, IList<WritableSubResource> origins, int? trafficRestorationTimeToHealedOrNewEndpointsInMinutes, ResponseBasedOriginErrorDetectionSettings responseBasedOriginErrorDetectionSettings, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
