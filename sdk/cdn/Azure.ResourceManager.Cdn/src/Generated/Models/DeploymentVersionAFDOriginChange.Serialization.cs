        ...
        internal static DeploymentVersionAFDOriginChange DeserializeDeploymentVersionAFDOriginChange(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("previousProperties"u8))
                {
                    ...
                    previousProperties = FrontDoorOriginProperties.DeserializeFrontDoorOriginProperties(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("currentProperties"u8))
                {
                    ...
                    currentProperties = FrontDoorOriginProperties.DeserializeFrontDoorOriginProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
