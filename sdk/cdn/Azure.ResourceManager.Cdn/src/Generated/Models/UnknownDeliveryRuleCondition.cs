...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    internal partial class UnknownDeliveryRuleCondition : DeliveryRuleCondition
    {
        ...
        internal UnknownDeliveryRuleCondition(MatchVariable name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Name = name;
        }
