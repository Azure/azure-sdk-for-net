...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UrlRedirectActionDefinition
    {
        ...
        public UrlRedirectActionDefinition(UrlRedirectActionType typeName, RedirectType redirectType)
        {
            TypeName = typeName;
        ...
        internal UrlRedirectActionDefinition(UrlRedirectActionType typeName, RedirectType redirectType, DestinationProtocol? destinationProtocol, string customPath, string customHostname, string customQueryString, string customFragment)
        {
            TypeName = typeName;
            RedirectType = redirectType;
        ...
        public UrlRedirectActionType TypeName { get; set; }
