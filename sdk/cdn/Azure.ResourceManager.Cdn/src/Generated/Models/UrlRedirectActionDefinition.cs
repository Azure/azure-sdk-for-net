...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UrlRedirectActionDefinition
    {
        /// <summary> Initializes a new instance of UrlRedirectActionDefinition. </summary>
        /// <param name="typeDefinition"></param>
        /// <param name="redirectType"> The redirect type the rule will use when redirecting traffic. </param>
        public UrlRedirectActionDefinition(UrlRedirectActionType typeDefinition, RedirectType redirectType)
        {
        ...
        internal UrlRedirectActionDefinition(UrlRedirectActionType typeDefinition, RedirectType redirectType, DestinationProtocol? destinationProtocol, string customPath, string customHostname, string customQueryString, string customFragment)
        {
            TypeDefinition = typeDefinition;
            RedirectType = redirectType;
        ...
        public UrlRedirectActionType TypeDefinition { get; set; }
