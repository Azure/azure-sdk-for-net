...
{
    public partial class PostArgsMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static PostArgsMatchConditionDefinition DeserializePostArgsMatchConditionDefinition(JsonElement element)
        {
            ...
            return new PostArgsMatchConditionDefinition(typeName, selector.Value, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
