...
{
    public partial class SecurityPolicyWebApplicationFirewall : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityPolicyWebApplicationFirewall DeserializeSecurityPolicyWebApplicationFirewall(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
