...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityPolicyWebApplicationFirewall>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityPolicyWebApplicationFirewall>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityPolicyWebApplicationFirewall>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityPolicyWebApplicationFirewall>)} interface");
            }
        ...
        string IPersistableModel<SecurityPolicyWebApplicationFirewall>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
