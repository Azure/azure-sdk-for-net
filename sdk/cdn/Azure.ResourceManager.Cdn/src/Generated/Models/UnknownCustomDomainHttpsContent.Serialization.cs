...
{
    internal partial class UnknownCustomDomainHttpsContent : CustomDomainHttpsContent, IJsonModel<CustomDomainHttpsContent>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownCustomDomainHttpsContent"/> for deserialization. </summary>
        internal UnknownCustomDomainHttpsContent()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownCustomDomainHttpsContent DeserializeUnknownCustomDomainHttpsContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownCustomDomainHttpsContent(certificateSource, protocolType, minimumTlsVersion, additionalBinaryDataProperties);
        }
    }
}
