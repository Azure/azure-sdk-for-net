...
{
    public partial class FrontDoorRouteCacheConfiguration : IUtf8JsonSerializable, IJsonModel<FrontDoorRouteCacheConfiguration>, IPersistableModel<FrontDoorRouteCacheConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CompressionSettings))
            {
                ...
                AppendChildObject(builder, CompressionSettings, options, 2);
            }
