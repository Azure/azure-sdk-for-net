...
{
    public partial class FrontDoorRouteCacheConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FrontDoorRouteCacheConfiguration DeserializeFrontDoorRouteCacheConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
