...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleIsDeviceCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleIsDeviceCondition(MatchVariable name, IsDeviceMatchCondition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
