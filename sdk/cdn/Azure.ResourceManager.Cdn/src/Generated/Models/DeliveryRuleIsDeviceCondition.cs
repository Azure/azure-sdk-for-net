...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleIsDeviceCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleIsDeviceCondition(IsDeviceMatchConditionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleIsDeviceCondition(MatchVariable name, IDictionary<string, BinaryData> serializedAdditionalRawData, IsDeviceMatchConditionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public IsDeviceMatchConditionParameters Properties { get; set; }
    }
}
