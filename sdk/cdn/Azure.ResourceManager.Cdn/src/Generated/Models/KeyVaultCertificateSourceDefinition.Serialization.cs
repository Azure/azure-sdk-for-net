...
{
    public partial class KeyVaultCertificateSourceDefinition : IUtf8JsonSerializable
    {
        ...
        internal static KeyVaultCertificateSourceDefinition DeserializeKeyVaultCertificateSourceDefinition(JsonElement element)
        {
            ...
            return new KeyVaultCertificateSourceDefinition(typeName, subscriptionId, resourceGroupName, vaultName, secretName, secretVersion.Value, updateRule, deleteRule);
        }
    }
}
