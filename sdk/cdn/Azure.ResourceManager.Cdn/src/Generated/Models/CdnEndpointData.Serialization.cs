...
namespace Azure.ResourceManager.Cdn
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CdnEndpointData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CdnEndpointData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CdnEndpointData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CdnEndpointData>)} interface");
            }
        ...
        string IPersistableModel<CdnEndpointData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
