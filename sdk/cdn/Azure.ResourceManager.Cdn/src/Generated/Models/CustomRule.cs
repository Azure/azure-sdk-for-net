...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CustomRule
    {
        ...
        internal CustomRule(string name, CustomRuleEnabledState? enabledState, int priority, IList<CustomRuleMatchCondition> matchConditions, OverrideActionType action, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
