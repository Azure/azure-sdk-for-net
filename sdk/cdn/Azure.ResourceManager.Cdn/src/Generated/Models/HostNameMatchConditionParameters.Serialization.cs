...
{
    public partial class HostNameMatchConditionParameters : IUtf8JsonSerializable
    {
        ...
        internal static HostNameMatchConditionParameters DeserializeHostNameMatchConditionParameters(JsonElement element)
        {
            HostNameMatchConditionParametersTypeName typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new HostNameMatchConditionParametersTypeName(property.Value.GetString());
                    continue;
                }
            ...
            return new HostNameMatchConditionParameters(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
