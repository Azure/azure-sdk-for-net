...
{
    public partial class CustomerCertificateProperties : IUtf8JsonSerializable, IJsonModel<CustomerCertificateProperties>, IPersistableModel<CustomerCertificateProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SecretSource))
            {
                ...
                AppendChildObject(builder, SecretSource, options, 2);
            }
