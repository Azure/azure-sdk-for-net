...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MigrationErrorType>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MigrationErrorType>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MigrationErrorType)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && NextSteps != null)
            {
        ...
        BinaryData IPersistableModel<MigrationErrorType>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MigrationErrorType)} does not support '{options.Format}' format.");
            }
        }
