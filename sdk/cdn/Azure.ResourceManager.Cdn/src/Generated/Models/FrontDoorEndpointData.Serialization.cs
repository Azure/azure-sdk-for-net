...
namespace Azure.ResourceManager.Cdn
{
    public partial class FrontDoorEndpointData : IUtf8JsonSerializable
    {
        ...
        internal static FrontDoorEndpointData DeserializeFrontDoorEndpointData(JsonElement element)
        {
            ...
            return new FrontDoorEndpointData(id, name, type, systemData, tags, location, profileName.Value, Optional.ToNullable(enabledState), Optional.ToNullable(provisioningState), Optional.ToNullable(deploymentStatus), hostName.Value, Optional.ToNullable(autoGeneratedDomainNameLabelScope));
        }
    }
}
