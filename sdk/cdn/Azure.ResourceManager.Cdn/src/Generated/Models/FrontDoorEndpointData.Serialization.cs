...
namespace Azure.ResourceManager.Cdn
{
    public partial class FrontDoorEndpointData : IUtf8JsonSerializable, IJsonModel<FrontDoorEndpointData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorEndpointData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontDoorEndpointData>)} interface");
            }
