...
namespace Azure.ResourceManager.Cdn
{
    public partial class FrontDoorEndpointData : IUtf8JsonSerializable, IJsonModel<FrontDoorEndpointData>
    {
        ...
        void IJsonModel<FrontDoorEndpointData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FrontDoorEndpointData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FrontDoorEndpointData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FrontDoorEndpointData)} does not support '{options.Format}' format.");
            }
        }
