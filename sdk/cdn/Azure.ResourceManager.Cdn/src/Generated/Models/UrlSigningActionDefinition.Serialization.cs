...
{
    public partial class UrlSigningActionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static UrlSigningActionDefinition DeserializeUrlSigningActionDefinition(JsonElement element)
        {
            UrlSigningActionType typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new UrlSigningActionType(property.Value.GetString());
                    continue;
                }
            ...
            return new UrlSigningActionDefinition(typeName, Optional.ToNullable(algorithm), Optional.ToList(parameterNameOverride));
        }
    }
}
