...
namespace Azure.ResourceManager.Cdn
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CdnCustomDomainData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CdnCustomDomainData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CdnCustomDomainData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CdnCustomDomainData>)} interface");
            }
        ...
        string IPersistableModel<CdnCustomDomainData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
