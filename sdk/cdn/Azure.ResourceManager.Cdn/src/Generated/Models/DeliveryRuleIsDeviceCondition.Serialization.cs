...
namespace Azure.ResourceManager.Cdn.Models
{
    public partial class DeliveryRuleIsDeviceCondition : IUtf8JsonSerializable, IModelJsonSerializable<DeliveryRuleIsDeviceCondition>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DeliveryRuleIsDeviceCondition>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<IsDeviceMatchCondition>)Properties).Serialize(writer, options);
            }
        ...
        internal static DeliveryRuleIsDeviceCondition DeserializeDeliveryRuleIsDeviceCondition(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new DeliveryRuleIsDeviceCondition(name, parameters, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="DeliveryRuleIsDeviceCondition"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DeliveryRuleIsDeviceCondition"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DeliveryRuleIsDeviceCondition"/>. </summary>
