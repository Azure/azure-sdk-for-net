...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CookiesMatchConditionDefinition
    {
        ...
        internal CookiesMatchConditionDefinition(CookiesMatchConditionType typeDefinition, string selector, CookiesOperator @operator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms)
        {
            TypeDefinition = typeDefinition;
            Selector = selector;
            Operator = @operator;
