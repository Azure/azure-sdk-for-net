...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class ServerPortMatchCondition : DeliveryRuleConditionProperties, IJsonModel<ServerPortMatchCondition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ServerPortMatchCondition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ServerPortMatchCondition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ServerPortMatchCondition IPersistableModel<ServerPortMatchCondition>.Create(BinaryData data, ModelReaderWriterOptions options) => (ServerPortMatchCondition)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ServerPortMatchCondition IJsonModel<ServerPortMatchCondition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ServerPortMatchCondition)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ServerPortMatchCondition DeserializeServerPortMatchCondition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ServerPortOperator serverPortOperator = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    serverPortOperator = new ServerPortOperator(prop.Value.GetString());
                    continue;
                }
