...
{
    public partial class ServerPortMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static ServerPortMatchCondition DeserializeServerPortMatchCondition(JsonElement element)
        {
            ...
            return new ServerPortMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
