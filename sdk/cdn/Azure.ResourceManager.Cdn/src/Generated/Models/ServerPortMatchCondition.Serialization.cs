...
{
    public partial class ServerPortMatchCondition : IUtf8JsonSerializable, IJsonModel<ServerPortMatchCondition>, IPersistableModel<ServerPortMatchCondition>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerPortMatchCondition>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ServerPortMatchCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServerPortMatchCondition)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServerPortOperator))
            {
