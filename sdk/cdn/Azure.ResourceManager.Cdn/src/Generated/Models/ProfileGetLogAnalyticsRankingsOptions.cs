...
{
    /// <summary> A class representing the query and header parameters in GetLogAnalyticsRankings method. </summary>
    public partial class ProfileGetLogAnalyticsRankingsOptions
    {
        /// <summary> Initializes a new instance of ProfileGetLogAnalyticsRankingsOptions. </summary>
        ...
        public ProfileGetLogAnalyticsRankingsOptions(IEnumerable<LogRanking> rankings, IEnumerable<LogRankingMetric> metrics, int maxRanking, DateTimeOffset dateTimeBegin, DateTimeOffset dateTimeEnd)
        {
