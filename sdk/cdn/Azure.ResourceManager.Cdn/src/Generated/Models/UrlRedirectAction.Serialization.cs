...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UrlRedirectAction : DeliveryRuleAction, IJsonModel<UrlRedirectAction>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<UrlRedirectAction>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<UrlRedirectAction>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        UrlRedirectAction IPersistableModel<UrlRedirectAction>.Create(BinaryData data, ModelReaderWriterOptions options) => (UrlRedirectAction)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        UrlRedirectAction IJsonModel<UrlRedirectAction>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UrlRedirectAction)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UrlRedirectAction DeserializeUrlRedirectAction(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    parameters = UrlRedirectActionParameters.DeserializeUrlRedirectActionParameters(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new UrlRedirectAction(name, additionalBinaryDataProperties, parameters);
        }
    }
}
