...
{
    internal partial class UnknownDeliveryRuleConditionProperties : DeliveryRuleConditionProperties, IJsonModel<DeliveryRuleConditionProperties>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownDeliveryRuleConditionProperties"/> for deserialization. </summary>
        internal UnknownDeliveryRuleConditionProperties()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDeliveryRuleConditionProperties DeserializeUnknownDeliveryRuleConditionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDeliveryRuleConditionProperties(typeName, additionalBinaryDataProperties);
        }
    }
}
