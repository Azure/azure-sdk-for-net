...
{
    public partial class UriFileExtensionMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static UriFileExtensionMatchCondition DeserializeUriFileExtensionMatchCondition(JsonElement element)
        {
            ...
            return new UriFileExtensionMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
