...
{
    public partial class HttpErrorRange : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HttpErrorRange DeserializeHttpErrorRange(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
