...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HttpErrorRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HttpErrorRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HttpErrorRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HttpErrorRange>)} interface");
            }
        ...
        string IPersistableModel<HttpErrorRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
