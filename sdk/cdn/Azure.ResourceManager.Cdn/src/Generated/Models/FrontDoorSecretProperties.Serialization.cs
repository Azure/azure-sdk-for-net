...
{
    public partial class FrontDoorSecretProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FrontDoorSecretProperties DeserializeFrontDoorSecretProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
