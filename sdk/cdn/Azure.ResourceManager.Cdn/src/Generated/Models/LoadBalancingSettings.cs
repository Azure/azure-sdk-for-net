...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class LoadBalancingSettings
    {
        ...
        internal LoadBalancingSettings(int? sampleSize, int? successfulSamplesRequired, int? additionalLatencyInMilliseconds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
