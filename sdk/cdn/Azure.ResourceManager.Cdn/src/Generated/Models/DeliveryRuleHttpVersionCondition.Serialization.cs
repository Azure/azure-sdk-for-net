...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeliveryRuleHttpVersionCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeliveryRuleHttpVersionCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeliveryRuleHttpVersionCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeliveryRuleHttpVersionCondition>)} interface");
            }
        ...
        string IPersistableModel<DeliveryRuleHttpVersionCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
