...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RemoteAddressMatchCondition
    {
        ...
        internal RemoteAddressMatchCondition(RemoteAddressMatchConditionType conditionType, RemoteAddressOperator remoteAddressOperator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConditionType = conditionType;
            RemoteAddressOperator = remoteAddressOperator;
