...
namespace Azure.ResourceManager.Cdn.Models
{
    internal partial class CustomDomainListResult : IUtf8JsonSerializable, IJsonModel<CustomDomainListResult>
    {
        ...
        void IJsonModel<CustomDomainListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomDomainListResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (options.Format != "W" && !(Value is ChangeTrackingList<CdnCustomDomainData> collection && collection.IsUndefined))
            {
        ...
        internal static CustomDomainListResult DeserializeCustomDomainListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CustomDomainListResult(value ?? new ChangeTrackingList<CdnCustomDomainData>(), nextLink.Value, serializedAdditionalRawData);
        }
