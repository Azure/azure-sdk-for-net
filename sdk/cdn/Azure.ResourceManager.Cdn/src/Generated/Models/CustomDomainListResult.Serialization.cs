...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomDomainListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomDomainListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomDomainListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomDomainListResult>)} interface");
            }
        ...
        string IPersistableModel<CustomDomainListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
