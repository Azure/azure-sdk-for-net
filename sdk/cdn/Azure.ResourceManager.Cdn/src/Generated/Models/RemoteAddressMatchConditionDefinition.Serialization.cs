...
{
    public partial class RemoteAddressMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static RemoteAddressMatchConditionDefinition DeserializeRemoteAddressMatchConditionDefinition(JsonElement element)
        {
            ...
            return new RemoteAddressMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
