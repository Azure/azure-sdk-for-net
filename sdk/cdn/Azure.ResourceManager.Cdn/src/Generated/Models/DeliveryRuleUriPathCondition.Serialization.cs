...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeliveryRuleUriPathCondition>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static DeliveryRuleUriPathCondition DeserializeDeliveryRuleUriPathCondition(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            UriPathMatchConditionParameters parameters = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    parameters = UriPathMatchConditionParameters.DeserializeUriPathMatchConditionParameters(property.Value, options);
                    continue;
                }
