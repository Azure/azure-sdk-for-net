...
{
    public partial class DeliveryRuleRequestSchemeCondition : IUtf8JsonSerializable, IJsonModel<DeliveryRuleRequestSchemeCondition>, IPersistableModel<DeliveryRuleRequestSchemeCondition>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeliveryRuleRequestSchemeCondition>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DeliveryRuleRequestSchemeCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeliveryRuleRequestSchemeCondition)} does not support '{format}' format.");
            }
