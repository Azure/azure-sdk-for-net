...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRequestSchemeCondition : DeliveryRuleCondition, IJsonModel<DeliveryRuleRequestSchemeCondition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DeliveryRuleRequestSchemeCondition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DeliveryRuleRequestSchemeCondition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DeliveryRuleRequestSchemeCondition IPersistableModel<DeliveryRuleRequestSchemeCondition>.Create(BinaryData data, ModelReaderWriterOptions options) => (DeliveryRuleRequestSchemeCondition)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeliveryRuleRequestSchemeCondition IJsonModel<DeliveryRuleRequestSchemeCondition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DeliveryRuleRequestSchemeCondition)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DeliveryRuleRequestSchemeCondition DeserializeDeliveryRuleRequestSchemeCondition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    parameters = RequestSchemeMatchConditionParameters.DeserializeRequestSchemeMatchConditionParameters(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new DeliveryRuleRequestSchemeCondition(name, additionalBinaryDataProperties, parameters);
        }
    }
}
