...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CookiesMatchCondition : DeliveryRuleConditionProperties, IJsonModel<CookiesMatchCondition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CookiesMatchCondition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CookiesMatchCondition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CookiesMatchCondition IPersistableModel<CookiesMatchCondition>.Create(BinaryData data, ModelReaderWriterOptions options) => (CookiesMatchCondition)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CookiesMatchCondition IJsonModel<CookiesMatchCondition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CookiesMatchCondition)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CookiesMatchCondition DeserializeCookiesMatchCondition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            CookiesOperator cookiesOperator = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    cookiesOperator = new CookiesOperator(prop.Value.GetString());
                    continue;
                }
