...
{
    public partial class CookiesMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static CookiesMatchCondition DeserializeCookiesMatchCondition(JsonElement element)
        {
            ...
            return new CookiesMatchCondition(typeName, selector.Value, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
