...
{
    internal partial class UnknownSecretProperties : FrontDoorSecretProperties, IJsonModel<FrontDoorSecretProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSecretProperties DeserializeUnknownSecretProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSecretProperties(secretType, additionalBinaryDataProperties);
        }
    }
}
