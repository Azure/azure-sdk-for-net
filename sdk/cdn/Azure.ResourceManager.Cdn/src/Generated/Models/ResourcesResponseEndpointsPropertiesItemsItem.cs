...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class ResourcesResponseEndpointsPropertiesItemsItem
    {
        ...
        internal ResourcesResponseEndpointsPropertiesItemsItem(string id, string name, string endpointId, bool? history, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
