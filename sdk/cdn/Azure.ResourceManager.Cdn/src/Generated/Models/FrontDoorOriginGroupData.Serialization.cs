...
{
    public partial class FrontDoorOriginGroupData : IUtf8JsonSerializable, IJsonModel<FrontDoorOriginGroupData>, IPersistableModel<FrontDoorOriginGroupData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LoadBalancingSettings))
            {
                ...
                AppendChildObject(builder, LoadBalancingSettings, options, 2);
            }
            ...
            if (Optional.IsDefined(TrafficRestorationTimeInMinutes))
            {
                ...
                builder.AppendLine($" '{TrafficRestorationTimeInMinutes.Value.ToString()}'");
            }

            if (Optional.IsDefined(SessionAffinityState))
            {
                builder.Append("  sessionAffinityState:");
                builder.AppendLine($" '{SessionAffinityState.ToString()}'");
            }
