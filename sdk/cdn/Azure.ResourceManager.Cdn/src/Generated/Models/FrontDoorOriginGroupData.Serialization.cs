...
namespace Azure.ResourceManager.Cdn
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorOriginGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontDoorOriginGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorOriginGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontDoorOriginGroupData>)} interface");
            }
        ...
        string IPersistableModel<FrontDoorOriginGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
