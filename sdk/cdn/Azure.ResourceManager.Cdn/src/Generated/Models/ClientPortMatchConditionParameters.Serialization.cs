...
{
    public partial class ClientPortMatchConditionParameters : IUtf8JsonSerializable
    {
        ...
        internal static ClientPortMatchConditionParameters DeserializeClientPortMatchConditionParameters(JsonElement element)
        {
            ClientPortMatchConditionParametersTypeName typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new ClientPortMatchConditionParametersTypeName(property.Value.GetString());
                    continue;
                }
            ...
            return new ClientPortMatchConditionParameters(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
