...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UriSigningParamIdentifier>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UriSigningParamIdentifier>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UriSigningParamIdentifier>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UriSigningParamIdentifier>)} interface");
            }
        ...
        string IPersistableModel<UriSigningParamIdentifier>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
