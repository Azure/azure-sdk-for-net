...
{
    public partial class PolicySettingsAutoGenerated : IUtf8JsonSerializable, IJsonModel<PolicySettingsAutoGenerated>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicySettingsAutoGenerated>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<PolicySettingsAutoGenerated>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicySettingsAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PolicySettingsAutoGenerated)} does not support writing '{format}' format.");
            }
        ...
        PolicySettingsAutoGenerated IJsonModel<PolicySettingsAutoGenerated>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicySettingsAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PolicySettingsAutoGenerated)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializePolicySettingsAutoGenerated(document.RootElement, options);
        }

        internal static PolicySettingsAutoGenerated DeserializePolicySettingsAutoGenerated(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PolicySettingsAutoGenerated(
                enabledState,
                mode,
                redirectUri,
        ...
        BinaryData IPersistableModel<PolicySettingsAutoGenerated>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicySettingsAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PolicySettingsAutoGenerated)} does not support writing '{options.Format}' format.");
            }
        }

        PolicySettingsAutoGenerated IPersistableModel<PolicySettingsAutoGenerated>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<PolicySettingsAutoGenerated>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PolicySettingsAutoGenerated)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<PolicySettingsAutoGenerated>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
