...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static WafRankingsResponseDataItem DeserializeWafRankingsResponseDataItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
