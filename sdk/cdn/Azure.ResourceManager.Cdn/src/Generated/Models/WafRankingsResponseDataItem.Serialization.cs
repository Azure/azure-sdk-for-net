...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WafRankingsResponseDataItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WafRankingsResponseDataItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WafRankingsResponseDataItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WafRankingsResponseDataItem>)} interface");
            }
        ...
        string IPersistableModel<WafRankingsResponseDataItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
