...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriSigningActionParameters : DeliveryRuleActionParameters
    {
        /// <summary> Initializes a new instance of <see cref="UriSigningActionParameters"/>. </summary>
        public UriSigningActionParameters()
        {
        ...
        internal UriSigningActionParameters(DeliveryRuleActionParametersType typeName, IDictionary<string, BinaryData> serializedAdditionalRawData, UriSigningAlgorithm? algorithm, IList<UriSigningParamIdentifier> parameterNameOverride) : base(typeName, serializedAdditionalRawData)
        {
            Algorithm = algorithm;
