...
{
    public partial class UrlRewriteActionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static UrlRewriteActionDefinition DeserializeUrlRewriteActionDefinition(JsonElement element)
        {
            UrlRewriteActionType typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new UrlRewriteActionType(property.Value.GetString());
                    continue;
                }
            ...
            return new UrlRewriteActionDefinition(typeName, sourcePattern, destination, Optional.ToNullable(preserveUnmatchedPath));
        }
    }
}
