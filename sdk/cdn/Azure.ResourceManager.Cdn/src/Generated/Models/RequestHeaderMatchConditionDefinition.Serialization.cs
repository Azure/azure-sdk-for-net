...
{
    public partial class RequestHeaderMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static RequestHeaderMatchConditionDefinition DeserializeRequestHeaderMatchConditionDefinition(JsonElement element)
        {
            ...
            return new RequestHeaderMatchConditionDefinition(typeName, selector.Value, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
