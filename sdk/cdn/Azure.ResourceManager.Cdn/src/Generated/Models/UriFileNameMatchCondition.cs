...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriFileNameMatchCondition
    {
        ...
        internal UriFileNameMatchCondition(UriFileNameMatchConditionType conditionType, UriFileNameOperator uriFileNameOperator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConditionType = conditionType;
            UriFileNameOperator = uriFileNameOperator;
