...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProfileUpgradeContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ProfileUpgradeContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProfileUpgradeContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ProfileUpgradeContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ProfileUpgradeContent)} does not support '{options.Format}' format.");
            }
        }
