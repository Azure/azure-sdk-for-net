...
{
    public partial class HostNameMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static HostNameMatchConditionDefinition DeserializeHostNameMatchConditionDefinition(JsonElement element)
        {
            ...
            return new HostNameMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
