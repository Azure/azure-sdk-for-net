...
{
    public partial class CdnManagedHttpsContent : IUtf8JsonSerializable, IJsonModel<CdnManagedHttpsContent>, IPersistableModel<CdnManagedHttpsContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CertificateSourceParameters))
            {
                ...
                AppendChildObject(builder, CertificateSourceParameters, options, 2);
            }
