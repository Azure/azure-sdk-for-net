...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CdnManagedHttpsContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CdnManagedHttpsContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CdnManagedHttpsContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CdnManagedHttpsContent>)} interface");
            }
        ...
        string IPersistableModel<CdnManagedHttpsContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
