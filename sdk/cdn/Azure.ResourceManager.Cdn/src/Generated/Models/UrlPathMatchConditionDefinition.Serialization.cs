...
{
    public partial class UrlPathMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static UrlPathMatchConditionDefinition DeserializeUrlPathMatchConditionDefinition(JsonElement element)
        {
            UrlPathMatchConditionType typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new UrlPathMatchConditionType(property.Value.GetString());
                    continue;
                }
            ...
            return new UrlPathMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
