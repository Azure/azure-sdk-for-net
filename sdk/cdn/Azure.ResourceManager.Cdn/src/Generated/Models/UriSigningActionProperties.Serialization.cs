...
{
    public partial class UriSigningActionProperties : IUtf8JsonSerializable, IJsonModel<UriSigningActionProperties>, IPersistableModel<UriSigningActionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Algorithm))
            {
                ...
                builder.AppendLine($" '{Algorithm.ToString()}'");
            }
