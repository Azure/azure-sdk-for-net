...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleQueryStringCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleQueryStringCondition(QueryStringMatchConditionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleQueryStringCondition(MatchVariable name, IDictionary<string, BinaryData> serializedAdditionalRawData, QueryStringMatchConditionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public QueryStringMatchConditionParameters Properties { get; set; }
    }
}
