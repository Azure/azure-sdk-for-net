...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleQueryStringCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleQueryStringCondition(MatchVariable name, QueryStringMatchCondition properties, Dictionary<string, BinaryData> rawData) : base(name, rawData)
        {
            Properties = properties;
            Name = name;
        }
