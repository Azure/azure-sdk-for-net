...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleQueryStringCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleQueryStringCondition(MatchVariable name, QueryStringMatchCondition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
