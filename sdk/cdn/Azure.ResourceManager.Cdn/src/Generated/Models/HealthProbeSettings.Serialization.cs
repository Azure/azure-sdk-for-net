...
{
    public partial class HealthProbeSettings : IUtf8JsonSerializable, IJsonModel<HealthProbeSettings>, IPersistableModel<HealthProbeSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProbeRequestType))
            {
                ...
                builder.AppendLine($" '{ProbeRequestType.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ProbeIntervalInSeconds))
            {
                ...
                builder.AppendLine($" '{ProbeIntervalInSeconds.Value.ToString()}'");
            }
