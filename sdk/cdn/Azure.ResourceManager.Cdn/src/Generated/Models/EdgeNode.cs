...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class EdgeNode : ResourceData
    {
        ...
        internal EdgeNode(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<IPAddressGroup> ipAddressGroups, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
