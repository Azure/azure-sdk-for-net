...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class KeyVaultSigningKey
    {
        ...
        internal KeyVaultSigningKey(KeyVaultSigningKeyType keyType, string subscriptionId, string resourceGroupName, string vaultName, string secretName, string secretVersion, Dictionary<string, BinaryData> rawData)
        {
            KeyType = keyType;
            SubscriptionId = subscriptionId;
            ResourceGroupName = resourceGroupName;
