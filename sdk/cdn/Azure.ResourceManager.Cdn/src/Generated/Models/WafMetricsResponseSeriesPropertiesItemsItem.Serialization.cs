...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WafMetricsResponseSeriesPropertiesItemsItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WafMetricsResponseSeriesPropertiesItemsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WafMetricsResponseSeriesPropertiesItemsItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WafMetricsResponseSeriesPropertiesItemsItem>)} interface");
            }
        ...
        string IPersistableModel<WafMetricsResponseSeriesPropertiesItemsItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
