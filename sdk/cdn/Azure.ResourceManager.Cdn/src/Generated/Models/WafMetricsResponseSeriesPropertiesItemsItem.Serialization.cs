...
{
    public partial class WafMetricsResponseSeriesPropertiesItemsItem : IUtf8JsonSerializable, IJsonModel<WafMetricsResponseSeriesPropertiesItemsItem>, IPersistableModel<WafMetricsResponseSeriesPropertiesItemsItem>
    {
        ...
        void IJsonModel<WafMetricsResponseSeriesPropertiesItemsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WafMetricsResponseSeriesPropertiesItemsItem)} does not support '{format}' format.");
            }
