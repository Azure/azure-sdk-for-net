...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRulePostArgsCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRulePostArgsCondition(MatchVariable name, PostArgsMatchCondition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
