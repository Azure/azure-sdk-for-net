...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRulePostArgsCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRulePostArgsCondition(PostArgsMatchConditionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRulePostArgsCondition(MatchVariable name, IDictionary<string, BinaryData> serializedAdditionalRawData, PostArgsMatchConditionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public PostArgsMatchConditionParameters Properties { get; set; }
    }
}
