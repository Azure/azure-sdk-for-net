...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRulePostArgsCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRulePostArgsCondition(PostArgsMatchCondition properties) : base(MatchVariable.PostArgs)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRulePostArgsCondition(MatchVariable name, IDictionary<string, BinaryData> additionalBinaryDataProperties, PostArgsMatchCondition properties) : base(name, additionalBinaryDataProperties)
        {
            Properties = properties;
        }
