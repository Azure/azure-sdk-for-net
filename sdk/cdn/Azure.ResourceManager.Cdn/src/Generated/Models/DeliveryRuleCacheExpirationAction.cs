...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleCacheExpirationAction : DeliveryRuleAction
    {
        ...
        internal DeliveryRuleCacheExpirationAction(DeliveryRuleActionType name, CacheExpirationActionProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
