...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleCacheExpirationAction : DeliveryRuleAction
    {
        ...
        internal DeliveryRuleCacheExpirationAction(DeliveryRuleActionType name, CacheExpirationActionProperties properties, Dictionary<string, BinaryData> rawData) : base(name, rawData)
        {
            Properties = properties;
            Name = name;
        }
