...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WafMetricsResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WafMetricsResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WafMetricsResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WafMetricsResponse>)} interface");
            }
        ...
        string IPersistableModel<WafMetricsResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
