...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ValidateCustomDomainContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ValidateCustomDomainContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ValidateCustomDomainContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ValidateCustomDomainContent>)} interface");
            }
        ...
        string IPersistableModel<ValidateCustomDomainContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
