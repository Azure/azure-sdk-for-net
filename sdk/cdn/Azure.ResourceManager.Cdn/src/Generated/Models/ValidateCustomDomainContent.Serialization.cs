...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ValidateCustomDomainContent>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ValidateCustomDomainContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ValidateCustomDomainContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
