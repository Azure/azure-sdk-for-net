...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class ManagedCertificateProperties : FrontDoorSecretProperties
    {
        ...
        internal ManagedCertificateProperties(SecretType secretType, string subject, DateTimeOffset? expiresOn, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(secretType, serializedAdditionalRawData)
        {
            Subject = subject;
            ExpiresOn = expiresOn;
