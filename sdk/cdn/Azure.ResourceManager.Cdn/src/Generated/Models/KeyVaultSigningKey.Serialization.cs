...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultSigningKey>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyVaultSigningKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultSigningKey>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyVaultSigningKey>)} interface");
            }
        ...
        string IPersistableModel<KeyVaultSigningKey>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
