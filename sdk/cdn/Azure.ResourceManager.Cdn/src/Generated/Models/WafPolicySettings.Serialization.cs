...
namespace Azure.ResourceManager.Cdn.Models
{
    public partial class WafPolicySettings : IUtf8JsonSerializable, IJsonModel<WafPolicySettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DefaultRedirectUri), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  defaultRedirectUrl: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  defaultRedirectUrl: ");
                    builder.AppendLine($"'{DefaultRedirectUri.AbsoluteUri}'");
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DefaultCustomBlockResponseStatusCode), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  defaultCustomBlockResponseStatusCode: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  defaultCustomBlockResponseStatusCode: ");
                    builder.AppendLine(DefaultCustomBlockResponseStatusCode.Value.ToString());
                }
            }

            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(DefaultCustomBlockResponseBody), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  defaultCustomBlockResponseBody: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  defaultCustomBlockResponseBody: ");
                    builder.AppendLine($"'{DefaultCustomBlockResponseBody.ToString()}'");
                }
            }
