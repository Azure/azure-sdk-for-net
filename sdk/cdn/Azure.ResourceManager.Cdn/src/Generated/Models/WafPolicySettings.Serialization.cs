...
{
    public partial class WafPolicySettings : IUtf8JsonSerializable, IJsonModel<WafPolicySettings>, IPersistableModel<WafPolicySettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DefaultCustomBlockResponseStatusCode))
            {
                ...
                builder.AppendLine($" '{DefaultCustomBlockResponseStatusCode.ToString()}'");
            }
