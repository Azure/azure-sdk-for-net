...
{
    public partial class RouteUpdatePropertiesParameters : IUtf8JsonSerializable, IJsonModel<RouteUpdatePropertiesParameters>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteUpdatePropertiesParameters>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<RouteUpdatePropertiesParameters>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        RouteUpdatePropertiesParameters IJsonModel<RouteUpdatePropertiesParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RouteUpdatePropertiesParameters>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static RouteUpdatePropertiesParameters DeserializeRouteUpdatePropertiesParameters(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<RouteUpdatePropertiesParameters>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RouteUpdatePropertiesParameters>)this).GetFormatFromOptions(options) : options.Format;
        ...
        RouteUpdatePropertiesParameters IPersistableModel<RouteUpdatePropertiesParameters>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RouteUpdatePropertiesParameters>)this).GetFormatFromOptions(options) : options.Format;
