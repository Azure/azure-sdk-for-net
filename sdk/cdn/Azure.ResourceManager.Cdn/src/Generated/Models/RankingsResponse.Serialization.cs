...
{
    public partial class RankingsResponse : IUtf8JsonSerializable, IJsonModel<RankingsResponse>, IPersistableModel<RankingsResponse>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DateTimeBegin))
            {
                ...
                builder.AppendLine($" '{DateTimeBegin.Value.ToString()}'");
            }

            if (Optional.IsDefined(DateTimeEnd))
            {
                builder.Append("  dateTimeEnd:");
                builder.AppendLine($" '{DateTimeEnd.Value.ToString()}'");
            }
