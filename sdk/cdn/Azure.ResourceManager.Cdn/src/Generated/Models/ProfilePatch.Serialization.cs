...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProfilePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProfilePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProfilePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProfilePatch>)} interface");
            }
        ...
        string IPersistableModel<ProfilePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
