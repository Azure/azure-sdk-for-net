...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleSslProtocolCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleSslProtocolCondition(SslProtocolMatchCondition parameters)
        {
            if (parameters == null)
            {
        ...
        /// <param name="parameters"> Defines the parameters for the condition. </param>
        internal DeliveryRuleSslProtocolCondition(MatchVariable name, SslProtocolMatchCondition parameters) : base(name)
        {
            Parameters = parameters;
            Name = name;
        }
        ...
        public SslProtocolMatchCondition Parameters { get; set; }
    }
}
