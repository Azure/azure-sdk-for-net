...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleSslProtocolCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleSslProtocolCondition(MatchVariable name, DeliveryRuleSslProtocolMatchCondition properties, Dictionary<string, BinaryData> rawData) : base(name, rawData)
        {
            Properties = properties;
            Name = name;
        }
