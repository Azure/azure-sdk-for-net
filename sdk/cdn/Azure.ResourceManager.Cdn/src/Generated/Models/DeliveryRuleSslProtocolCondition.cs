...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleSslProtocolCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleSslProtocolCondition(SslProtocolMatchConditionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleSslProtocolCondition(MatchVariable name, IDictionary<string, BinaryData> serializedAdditionalRawData, SslProtocolMatchConditionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public SslProtocolMatchConditionParameters Properties { get; set; }
    }
}
