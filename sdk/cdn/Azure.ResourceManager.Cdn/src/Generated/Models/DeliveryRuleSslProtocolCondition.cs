...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleSslProtocolCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleSslProtocolCondition(DeliveryRuleSslProtocolMatchCondition properties) : base(MatchVariable.SslProtocol)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleSslProtocolCondition(MatchVariable name, IDictionary<string, BinaryData> additionalBinaryDataProperties, DeliveryRuleSslProtocolMatchCondition properties) : base(name, additionalBinaryDataProperties)
        {
            Properties = properties;
        }
