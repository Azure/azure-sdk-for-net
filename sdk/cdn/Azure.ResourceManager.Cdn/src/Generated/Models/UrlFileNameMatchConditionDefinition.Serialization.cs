...
{
    public partial class UrlFileNameMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static UrlFileNameMatchConditionDefinition DeserializeUrlFileNameMatchConditionDefinition(JsonElement element)
        {
            UrlFileNameMatchConditionType typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new UrlFileNameMatchConditionType(property.Value.GetString());
                    continue;
                }
            ...
            return new UrlFileNameMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
