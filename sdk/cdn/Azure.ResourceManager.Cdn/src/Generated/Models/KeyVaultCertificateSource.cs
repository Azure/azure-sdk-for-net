...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class KeyVaultCertificateSource
    {
        ...
        internal KeyVaultCertificateSource(KeyVaultCertificateSourceType sourceType, string subscriptionId, string resourceGroupName, string vaultName, string secretName, string secretVersion, CertificateUpdateAction updateRule, CertificateDeleteAction deleteRule, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SourceType = sourceType;
            SubscriptionId = subscriptionId;
            ResourceGroupName = resourceGroupName;
