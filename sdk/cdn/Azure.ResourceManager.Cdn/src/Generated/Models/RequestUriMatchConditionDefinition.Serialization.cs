...
{
    public partial class RequestUriMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static RequestUriMatchConditionDefinition DeserializeRequestUriMatchConditionDefinition(JsonElement element)
        {
            ...
            return new RequestUriMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
