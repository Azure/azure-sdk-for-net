...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriRewriteActionDefinition
    {
        /// <summary> Initializes a new instance of UriRewriteActionDefinition. </summary>
        ...
        public UriRewriteActionDefinition(UriRewriteActionType typeDefinition, string sourcePattern, string destination)
        {
        ...
        internal UriRewriteActionDefinition(UriRewriteActionType typeDefinition, string sourcePattern, string destination, bool? preserveUnmatchedPath)
        {
            TypeDefinition = typeDefinition;
            SourcePattern = sourcePattern;
            Destination = destination;
        ...
        public UriRewriteActionType TypeDefinition { get; set; }
