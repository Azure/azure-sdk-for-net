...
namespace Azure.ResourceManager.Cdn.Models
{
    public partial class UriSigningKeyProperties : IUtf8JsonSerializable, IModelJsonSerializable<UriSigningKeyProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<UriSigningKeyProperties>(this, options.Format);
        ...
        internal static UriSigningKeyProperties DeserializeUriSigningKeyProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UriSigningKeyProperties(type, keyId, secretSource, secretVersion.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="UriSigningKeyProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="UriSigningKeyProperties"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="UriSigningKeyProperties"/>. </summary>
