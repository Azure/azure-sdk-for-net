...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RequestMethodMatchConditionParameters : DeliveryRuleConditionProperties, IJsonModel<RequestMethodMatchConditionParameters>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RequestMethodMatchConditionParameters>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RequestMethodMatchConditionParameters>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RequestMethodMatchConditionParameters IPersistableModel<RequestMethodMatchConditionParameters>.Create(BinaryData data, ModelReaderWriterOptions options) => (RequestMethodMatchConditionParameters)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RequestMethodMatchConditionParameters IJsonModel<RequestMethodMatchConditionParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RequestMethodMatchConditionParameters)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RequestMethodMatchConditionParameters DeserializeRequestMethodMatchConditionParameters(JsonElement element, ModelReaderWriterOptions options)
        {
