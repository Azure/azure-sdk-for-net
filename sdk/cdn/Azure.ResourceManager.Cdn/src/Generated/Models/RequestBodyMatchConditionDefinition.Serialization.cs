...
{
    public partial class RequestBodyMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static RequestBodyMatchConditionDefinition DeserializeRequestBodyMatchConditionDefinition(JsonElement element)
        {
            ...
            return new RequestBodyMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
