...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourcesResponseEndpointsItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourcesResponseEndpointsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourcesResponseEndpointsItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourcesResponseEndpointsItem>)} interface");
            }
        ...
        string IPersistableModel<ResourcesResponseEndpointsItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
