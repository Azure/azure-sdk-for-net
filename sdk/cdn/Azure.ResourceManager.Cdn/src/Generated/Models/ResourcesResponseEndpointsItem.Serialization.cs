...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static ResourcesResponseEndpointsItem DeserializeResourcesResponseEndpointsItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
