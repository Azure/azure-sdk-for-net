...
{
    public partial class ServerPortMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static ServerPortMatchConditionDefinition DeserializeServerPortMatchConditionDefinition(JsonElement element)
        {
            ...
            return new ServerPortMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
