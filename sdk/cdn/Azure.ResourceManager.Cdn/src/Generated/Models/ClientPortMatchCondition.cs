...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class ClientPortMatchCondition
    {
        ...
        public ClientPortMatchCondition(ClientPortMatchConditionType conditionType, ClientPortOperator @operator)
        {
        ...
        internal ClientPortMatchCondition(ClientPortMatchConditionType conditionType, ClientPortOperator @operator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms)
        {
            ConditionType = conditionType;
            Operator = @operator;
