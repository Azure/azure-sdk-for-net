...
namespace Azure.ResourceManager.Cdn
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CdnWebApplicationFirewallPolicyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CdnWebApplicationFirewallPolicyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CdnWebApplicationFirewallPolicyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CdnWebApplicationFirewallPolicyData>)} interface");
            }
        ...
        string IPersistableModel<CdnWebApplicationFirewallPolicyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
