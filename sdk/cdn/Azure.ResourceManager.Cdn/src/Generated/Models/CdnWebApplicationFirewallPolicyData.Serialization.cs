...
{
    public partial class CdnWebApplicationFirewallPolicyData : IUtf8JsonSerializable, IJsonModel<CdnWebApplicationFirewallPolicyData>, IPersistableModel<CdnWebApplicationFirewallPolicyData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RateLimitSettings))
            {
                ...
                AppendChildObject(builder, RateLimitSettings, options, 2);
            }

            if (Optional.IsDefined(CustomSettings))
            {
                builder.Append("  customRules:");
                AppendChildObject(builder, CustomSettings, options, 2);
            }
