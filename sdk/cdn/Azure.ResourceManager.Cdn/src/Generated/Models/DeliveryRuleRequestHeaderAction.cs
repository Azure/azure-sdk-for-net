...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRequestHeaderAction : DeliveryRuleAction
    {
        ...
        public DeliveryRuleRequestHeaderAction(HeaderActionProperties parameters)
        {
            if (parameters == null)
            {
        ...
        /// <param name="parameters"> Defines the parameters for the action. </param>
        internal DeliveryRuleRequestHeaderAction(DeliveryRuleActionType name, HeaderActionProperties parameters) : base(name)
        {
            Parameters = parameters;
            Name = name;
        }
