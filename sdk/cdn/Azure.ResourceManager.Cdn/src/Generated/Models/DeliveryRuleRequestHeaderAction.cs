...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRequestHeaderAction : DeliveryRuleAction
    {
        ...
        internal DeliveryRuleRequestHeaderAction(DeliveryRuleActionType name, HeaderActionProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
