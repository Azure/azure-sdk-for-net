...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeliveryRuleCookiesCondition>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static DeliveryRuleCookiesCondition DeserializeDeliveryRuleCookiesCondition(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    parameters = CookiesMatchCondition.DeserializeCookiesMatchCondition(property.Value, options);
                    continue;
                }
