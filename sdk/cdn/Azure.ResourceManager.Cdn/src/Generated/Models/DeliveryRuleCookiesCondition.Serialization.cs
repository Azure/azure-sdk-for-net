...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeliveryRuleCookiesCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeliveryRuleCookiesCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeliveryRuleCookiesCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeliveryRuleCookiesCondition>)} interface");
            }
        ...
        string IPersistableModel<DeliveryRuleCookiesCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
