...
{
    public partial class DeliveryRuleCookiesCondition : IUtf8JsonSerializable, IJsonModel<DeliveryRuleCookiesCondition>, IPersistableModel<DeliveryRuleCookiesCondition>
    {
        ...
        void IJsonModel<DeliveryRuleCookiesCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeliveryRuleCookiesCondition)} does not support '{format}' format.");
            }
