...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeepCreatedOriginGroup>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeepCreatedOriginGroup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeepCreatedOriginGroup>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeepCreatedOriginGroup>)} interface");
            }
        ...
        string IPersistableModel<DeepCreatedOriginGroup>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
