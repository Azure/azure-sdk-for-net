...
namespace Azure.ResourceManager.Cdn
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FrontDoorCustomDomainData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FrontDoorCustomDomainData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FrontDoorCustomDomainData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FrontDoorCustomDomainData>)} interface");
            }
        ...
        string IPersistableModel<FrontDoorCustomDomainData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
