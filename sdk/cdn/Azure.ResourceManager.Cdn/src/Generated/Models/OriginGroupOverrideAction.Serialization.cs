...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class OriginGroupOverrideAction : DeliveryRuleAction, IJsonModel<OriginGroupOverrideAction>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<OriginGroupOverrideAction>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OriginGroupOverrideAction>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OriginGroupOverrideAction IPersistableModel<OriginGroupOverrideAction>.Create(BinaryData data, ModelReaderWriterOptions options) => (OriginGroupOverrideAction)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OriginGroupOverrideAction IJsonModel<OriginGroupOverrideAction>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OriginGroupOverrideAction)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OriginGroupOverrideAction DeserializeOriginGroupOverrideAction(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            OriginGroupOverrideActionProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    properties = OriginGroupOverrideActionProperties.DeserializeOriginGroupOverrideActionProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new OriginGroupOverrideAction(name, additionalBinaryDataProperties, properties);
        }
    }
}
