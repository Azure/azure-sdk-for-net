    ...
    public partial class OriginGroupOverrideAction : DeliveryRuleAction, IJsonModel<OriginGroupOverrideAction>
    {
        ...
        internal static OriginGroupOverrideAction DeserializeOriginGroupOverrideAction(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    parameters = OriginGroupOverrideActionParameters.DeserializeOriginGroupOverrideActionParameters(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new OriginGroupOverrideAction(name, additionalBinaryDataProperties, parameters);
        }
    }
}
