...
{
    public partial class WafPolicyManagedRuleSet : IUtf8JsonSerializable, IJsonModel<WafPolicyManagedRuleSet>, IPersistableModel<WafPolicyManagedRuleSet>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AnomalyScore))
            {
                ...
                builder.AppendLine($" '{AnomalyScore.Value.ToString()}'");
            }
