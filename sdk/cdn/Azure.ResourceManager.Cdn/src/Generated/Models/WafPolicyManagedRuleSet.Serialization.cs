...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WafPolicyManagedRuleSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WafPolicyManagedRuleSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WafPolicyManagedRuleSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WafPolicyManagedRuleSet>)} interface");
            }
        ...
        string IPersistableModel<WafPolicyManagedRuleSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
