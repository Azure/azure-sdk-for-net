...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class WafPolicyManagedRuleSet : IJsonModel<WafPolicyManagedRuleSet>
    {
        ...
        protected virtual WafPolicyManagedRuleSet PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<WafPolicyManagedRuleSet>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WafPolicyManagedRuleSet>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WafPolicyManagedRuleSet IPersistableModel<WafPolicyManagedRuleSet>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(RuleGroupOverrides))
            {
                ...
                foreach (ManagedRuleGroupOverrideSetting item in RuleGroupOverrides)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WafPolicyManagedRuleSet IJsonModel<WafPolicyManagedRuleSet>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual WafPolicyManagedRuleSet JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<WafPolicyManagedRuleSet>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WafPolicyManagedRuleSet DeserializeWafPolicyManagedRuleSet(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("anomalyScore"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    anomalyScore = prop.Value.GetInt32();
                    continue;
                }
            ...
            return new WafPolicyManagedRuleSet(ruleSetType, ruleSetVersion, anomalyScore, ruleGroupOverrides ?? new ChangeTrackingList<ManagedRuleGroupOverrideSetting>(), additionalBinaryDataProperties);
        }
    }
}
