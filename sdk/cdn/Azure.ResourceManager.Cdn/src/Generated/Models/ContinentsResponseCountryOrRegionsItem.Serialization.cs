...
{
    public partial class ContinentsResponseCountryOrRegionsItem : IUtf8JsonSerializable, IJsonModel<ContinentsResponseCountryOrRegionsItem>, IPersistableModel<ContinentsResponseCountryOrRegionsItem>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ContinentId))
            {
                builder.Append("  continentId:");
                builder.AppendLine($" '{ContinentId}'");
            }
