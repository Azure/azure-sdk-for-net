...
namespace Azure.ResourceManager.Cdn.Models
{
    public partial class ContinentsResponseCountryOrRegionsItem : IUtf8JsonSerializable, IJsonModel<ContinentsResponseCountryOrRegionsItem>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(ContinentId), out propertyOverride);
            if (hasPropertyOverride)
            {
            ...
            else
            {
                ...
                {
                    builder.Append("  continentId: ");
                    if (ContinentId.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
