...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContinentsResponseCountryOrRegionsItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContinentsResponseCountryOrRegionsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContinentsResponseCountryOrRegionsItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContinentsResponseCountryOrRegionsItem>)} interface");
            }
        ...
        string IPersistableModel<ContinentsResponseCountryOrRegionsItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
