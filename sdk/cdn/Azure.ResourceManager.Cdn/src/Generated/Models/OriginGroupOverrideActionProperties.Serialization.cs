...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OriginGroupOverrideActionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OriginGroupOverrideActionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OriginGroupOverrideActionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OriginGroupOverrideActionProperties>)} interface");
            }
        ...
        string IPersistableModel<OriginGroupOverrideActionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
