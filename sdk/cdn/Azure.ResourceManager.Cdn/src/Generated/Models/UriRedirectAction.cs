...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriRedirectAction : DeliveryRuleAction
    {
        ...
        internal UriRedirectAction(DeliveryRuleActionType name, UriRedirectActionProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
