...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriRedirectAction : DeliveryRuleAction
    {
        ...
        public UriRedirectAction(UriRedirectActionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the action. </param>
        internal UriRedirectAction(DeliveryRuleActionType name, IDictionary<string, BinaryData> serializedAdditionalRawData, UriRedirectActionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public UriRedirectActionParameters Properties { get; set; }
    }
}
