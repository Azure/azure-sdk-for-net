...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRemoteAddressCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleRemoteAddressCondition(RemoteAddressMatchConditionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleRemoteAddressCondition(MatchVariable name, IDictionary<string, BinaryData> serializedAdditionalRawData, RemoteAddressMatchConditionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public RemoteAddressMatchConditionParameters Properties { get; set; }
    }
}
