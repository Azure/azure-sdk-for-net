...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRemoteAddressCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleRemoteAddressCondition(RemoteAddressMatchCondition parameters)
        {
            if (parameters == null)
            {
        ...
        /// <param name="parameters"> Defines the parameters for the condition. </param>
        internal DeliveryRuleRemoteAddressCondition(MatchVariable name, RemoteAddressMatchCondition parameters) : base(name)
        {
            Parameters = parameters;
            Name = name;
        }
