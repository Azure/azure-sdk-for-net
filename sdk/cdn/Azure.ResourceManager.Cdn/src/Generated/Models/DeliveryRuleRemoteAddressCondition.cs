...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRemoteAddressCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleRemoteAddressCondition(RemoteAddressMatchCondition properties) : base(MatchVariable.RemoteAddress)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleRemoteAddressCondition(MatchVariable name, IDictionary<string, BinaryData> additionalBinaryDataProperties, RemoteAddressMatchCondition properties) : base(name, additionalBinaryDataProperties)
        {
            Properties = properties;
        }
