...
{
    public partial class RequestBodyMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static RequestBodyMatchCondition DeserializeRequestBodyMatchCondition(JsonElement element)
        {
            ...
            return new RequestBodyMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
