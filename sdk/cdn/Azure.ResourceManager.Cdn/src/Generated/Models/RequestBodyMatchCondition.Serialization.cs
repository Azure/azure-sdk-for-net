...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RequestBodyMatchCondition : DeliveryRuleConditionProperties, IJsonModel<RequestBodyMatchCondition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RequestBodyMatchCondition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(RequestBodyMatchCondition)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RequestBodyMatchCondition)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RequestBodyMatchCondition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RequestBodyMatchCondition IPersistableModel<RequestBodyMatchCondition>.Create(BinaryData data, ModelReaderWriterOptions options) => (RequestBodyMatchCondition)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RequestBodyMatchCondition)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RequestBodyMatchCondition IJsonModel<RequestBodyMatchCondition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RequestBodyMatchCondition)JsonModelCreateCore(ref reader, options);
        ...
        protected override DeliveryRuleConditionProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RequestBodyMatchCondition)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RequestBodyMatchCondition DeserializeRequestBodyMatchCondition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            RequestBodyOperator requestBodyOperator = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    requestBodyOperator = new RequestBodyOperator(prop.Value.GetString());
                    continue;
                }
