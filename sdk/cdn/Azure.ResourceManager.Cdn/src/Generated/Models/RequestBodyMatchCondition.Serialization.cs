...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RequestBodyMatchCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RequestBodyMatchCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RequestBodyMatchCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RequestBodyMatchCondition>)} interface");
            }
        ...
        string IPersistableModel<RequestBodyMatchCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
