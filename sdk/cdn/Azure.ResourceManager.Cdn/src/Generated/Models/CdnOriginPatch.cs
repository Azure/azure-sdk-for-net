...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CdnOriginPatch
    {
        ...
        internal CdnOriginPatch(string hostName, int? httpPort, int? httpsPort, string originHostHeader, int? priority, int? weight, bool? enabled, string privateLinkAlias, ResourceIdentifier privateLinkResourceId, string privateLinkLocation, string privateLinkApprovalMessage, Dictionary<string, BinaryData> rawData)
        {
            HostName = hostName;
            HttpPort = httpPort;
            HttpsPort = httpsPort;
