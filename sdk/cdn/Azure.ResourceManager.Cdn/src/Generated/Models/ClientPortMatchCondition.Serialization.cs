...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClientPortMatchCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClientPortMatchCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClientPortMatchCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClientPortMatchCondition>)} interface");
            }
        ...
        ClientPortMatchCondition IPersistableModel<ClientPortMatchCondition>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<ClientPortMatchCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
