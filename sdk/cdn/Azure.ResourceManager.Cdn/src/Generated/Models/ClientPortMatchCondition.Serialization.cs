...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class ClientPortMatchCondition : DeliveryRuleConditionProperties, IJsonModel<ClientPortMatchCondition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ClientPortMatchCondition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ClientPortMatchCondition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ClientPortMatchCondition IPersistableModel<ClientPortMatchCondition>.Create(BinaryData data, ModelReaderWriterOptions options) => (ClientPortMatchCondition)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ClientPortMatchCondition>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ClientPortMatchCondition IJsonModel<ClientPortMatchCondition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ClientPortMatchCondition)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ClientPortMatchCondition DeserializeClientPortMatchCondition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ClientPortOperator clientPortOperator = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    clientPortOperator = new ClientPortOperator(prop.Value.GetString());
                    continue;
                }
