...
{
    public partial class ClientPortMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static ClientPortMatchCondition DeserializeClientPortMatchCondition(JsonElement element)
        {
            ...
            return new ClientPortMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
