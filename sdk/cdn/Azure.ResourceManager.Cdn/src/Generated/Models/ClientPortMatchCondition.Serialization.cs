...
{
    public partial class ClientPortMatchCondition : IUtf8JsonSerializable, IJsonModel<ClientPortMatchCondition>, IPersistableModel<ClientPortMatchCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClientPortOperator))
            {
                builder.Append("  operator:");
                builder.AppendLine($" '{ClientPortOperator.ToString()}'");
            }
