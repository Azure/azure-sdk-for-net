...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CookiesMatchCondition
    {
        ...
        internal CookiesMatchCondition(CookiesMatchConditionType conditionType, string selector, CookiesOperator cookiesOperator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConditionType = conditionType;
            Selector = selector;
            CookiesOperator = cookiesOperator;
