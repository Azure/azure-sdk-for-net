...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CookiesMatchCondition
    {
        ...
        public CookiesMatchCondition(CookiesMatchConditionType conditionType, CookiesOperator op)
        {
        ...
        internal CookiesMatchCondition(CookiesMatchConditionType conditionType, string selector, CookiesOperator op, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms)
        {
            ConditionType = conditionType;
            Selector = selector;
            Op = op;
        ...
        public CookiesOperator Op { get; set; }
