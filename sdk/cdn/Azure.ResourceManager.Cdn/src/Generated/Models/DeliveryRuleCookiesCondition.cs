...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleCookiesCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleCookiesCondition(MatchVariable name, CookiesMatchCondition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
