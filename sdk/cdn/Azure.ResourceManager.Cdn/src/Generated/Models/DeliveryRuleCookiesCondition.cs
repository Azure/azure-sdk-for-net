...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleCookiesCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleCookiesCondition(CookiesMatchCondition properties) : base(MatchVariable.Cookies)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleCookiesCondition(MatchVariable name, IDictionary<string, BinaryData> additionalBinaryDataProperties, CookiesMatchCondition properties) : base(name, additionalBinaryDataProperties)
        {
            Properties = properties;
        }
