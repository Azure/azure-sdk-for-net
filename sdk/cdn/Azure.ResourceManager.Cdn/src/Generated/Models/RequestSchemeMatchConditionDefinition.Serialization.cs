...
{
    public partial class RequestSchemeMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static RequestSchemeMatchConditionDefinition DeserializeRequestSchemeMatchConditionDefinition(JsonElement element)
        {
            ...
            return new RequestSchemeMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(transforms), Optional.ToList(matchValues));
        }
    }
}
