...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleCacheKeyQueryStringAction : DeliveryRuleAction
    {
        ...
        internal DeliveryRuleCacheKeyQueryStringAction(DeliveryRuleActionType name, CacheKeyQueryStringActionProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
