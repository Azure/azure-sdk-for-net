...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleCacheKeyQueryStringAction : DeliveryRuleAction
    {
        ...
        public DeliveryRuleCacheKeyQueryStringAction(CacheKeyQueryStringActionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the action. </param>
        internal DeliveryRuleCacheKeyQueryStringAction(DeliveryRuleActionType name, IDictionary<string, BinaryData> serializedAdditionalRawData, CacheKeyQueryStringActionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public CacheKeyQueryStringActionParameters Properties { get; set; }
    }
}
