...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CacheKeyQueryStringActionParameters : DeliveryRuleActionProperties, IJsonModel<CacheKeyQueryStringActionParameters>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CacheKeyQueryStringActionParameters>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CacheKeyQueryStringActionParameters>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CacheKeyQueryStringActionParameters IPersistableModel<CacheKeyQueryStringActionParameters>.Create(BinaryData data, ModelReaderWriterOptions options) => (CacheKeyQueryStringActionParameters)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CacheKeyQueryStringActionParameters IJsonModel<CacheKeyQueryStringActionParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CacheKeyQueryStringActionParameters)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CacheKeyQueryStringActionParameters DeserializeCacheKeyQueryStringActionParameters(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new CacheKeyQueryStringActionParameters(typeName, additionalBinaryDataProperties, queryStringBehavior, queryParameters);
        }
    }
}
