...
{
    public partial class QueryStringMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static QueryStringMatchConditionDefinition DeserializeQueryStringMatchConditionDefinition(JsonElement element)
        {
            ...
            return new QueryStringMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
