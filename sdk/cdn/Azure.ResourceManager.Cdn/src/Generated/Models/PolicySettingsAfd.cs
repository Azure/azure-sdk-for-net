...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class PolicySettingsAfd
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PolicySettingsAfd"/>. </summary>
        ...
        internal PolicySettingsAfd(PolicyEnabledState? enabledState, PolicyMode? mode, string redirectUri, int? customBlockResponseStatusCode, string customBlockResponseBody, PolicyRequestBodyCheck? requestBodyCheck, int? javascriptChallengeExpirationInMinutes, int? captchaExpirationInMinutes, PolicySettingsLogScrubbing logScrubbing, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
