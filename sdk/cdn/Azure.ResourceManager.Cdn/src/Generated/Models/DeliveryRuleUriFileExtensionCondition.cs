...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleUriFileExtensionCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleUriFileExtensionCondition(UriFileExtensionMatchConditionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleUriFileExtensionCondition(MatchVariable name, IDictionary<string, BinaryData> serializedAdditionalRawData, UriFileExtensionMatchConditionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public UriFileExtensionMatchConditionParameters Properties { get; set; }
    }
}
