...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink>)} interface");
            }
        ...
        string IPersistableModel<EndpointPropertiesUpdateParametersWebApplicationFirewallPolicyLink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
