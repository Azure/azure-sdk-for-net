...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UrlRedirectActionParameters : DeliveryRuleActionProperties, IJsonModel<UrlRedirectActionParameters>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<UrlRedirectActionParameters>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<UrlRedirectActionParameters>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        UrlRedirectActionParameters IPersistableModel<UrlRedirectActionParameters>.Create(BinaryData data, ModelReaderWriterOptions options) => (UrlRedirectActionParameters)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        UrlRedirectActionParameters IJsonModel<UrlRedirectActionParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UrlRedirectActionParameters)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UrlRedirectActionParameters DeserializeUrlRedirectActionParameters(JsonElement element, ModelReaderWriterOptions options)
        {
