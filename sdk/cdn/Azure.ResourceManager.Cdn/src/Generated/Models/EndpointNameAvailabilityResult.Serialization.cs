...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static EndpointNameAvailabilityResult DeserializeEndpointNameAvailabilityResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
