...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRequestHeaderCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleRequestHeaderCondition(RequestHeaderMatchCondition parameters)
        {
            if (parameters == null)
            {
        ...
        /// <param name="parameters"> Defines the parameters for the condition. </param>
        internal DeliveryRuleRequestHeaderCondition(MatchVariable name, RequestHeaderMatchCondition parameters) : base(name)
        {
            Parameters = parameters;
            Name = name;
        }
