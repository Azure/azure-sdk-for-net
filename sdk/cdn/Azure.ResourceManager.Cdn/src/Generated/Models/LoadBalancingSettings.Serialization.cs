...
{
    public partial class LoadBalancingSettings : IUtf8JsonSerializable, IJsonModel<LoadBalancingSettings>, IPersistableModel<LoadBalancingSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SampleSize))
            {
                ...
                builder.AppendLine($" '{SampleSize.Value.ToString()}'");
            }

            if (Optional.IsDefined(SuccessfulSamplesRequired))
            {
                builder.Append("  successfulSamplesRequired:");
                builder.AppendLine($" '{SuccessfulSamplesRequired.Value.ToString()}'");
            }

            if (Optional.IsDefined(AdditionalLatencyInMilliseconds))
            {
                builder.Append("  additionalLatencyInMilliseconds:");
                builder.AppendLine($" '{AdditionalLatencyInMilliseconds.Value.ToString()}'");
            }
