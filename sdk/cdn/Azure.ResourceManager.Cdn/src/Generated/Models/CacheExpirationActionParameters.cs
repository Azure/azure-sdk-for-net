...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CacheExpirationActionParameters : DeliveryRuleActionProperties
    {
        ...
        public CacheExpirationActionParameters(CacheBehaviorSetting cacheBehavior, CdnCacheLevel cacheType) : base(DeliveryRuleActionParametersType.DeliveryRuleCacheExpirationActionParameters)
        {
        ...
        internal CacheExpirationActionParameters(DeliveryRuleActionParametersType typeName, IDictionary<string, BinaryData> additionalBinaryDataProperties, CacheBehaviorSetting cacheBehavior, CdnCacheLevel cacheType, string cacheDuration) : base(typeName, additionalBinaryDataProperties)
        {
            CacheBehavior = cacheBehavior;
            CacheType = cacheType;
