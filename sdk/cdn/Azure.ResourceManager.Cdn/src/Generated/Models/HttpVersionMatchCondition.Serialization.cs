...
{
    public partial class HttpVersionMatchCondition : IUtf8JsonSerializable, IJsonModel<HttpVersionMatchCondition>, IPersistableModel<HttpVersionMatchCondition>
    {
        ...
        void IJsonModel<HttpVersionMatchCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HttpVersionMatchCondition)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HttpVersionOperator))
            {
                builder.Append("  operator:");
                builder.AppendLine($" '{HttpVersionOperator.ToString()}'");
            }
