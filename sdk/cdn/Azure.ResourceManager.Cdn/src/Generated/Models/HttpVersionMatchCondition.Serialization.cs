...
{
    public partial class HttpVersionMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static HttpVersionMatchCondition DeserializeHttpVersionMatchCondition(JsonElement element)
        {
            ...
            return new HttpVersionMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
