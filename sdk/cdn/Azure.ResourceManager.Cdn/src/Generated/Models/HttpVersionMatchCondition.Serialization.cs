...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class HttpVersionMatchCondition : DeliveryRuleConditionProperties, IJsonModel<HttpVersionMatchCondition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HttpVersionMatchCondition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HttpVersionMatchCondition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HttpVersionMatchCondition IPersistableModel<HttpVersionMatchCondition>.Create(BinaryData data, ModelReaderWriterOptions options) => (HttpVersionMatchCondition)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HttpVersionMatchCondition IJsonModel<HttpVersionMatchCondition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HttpVersionMatchCondition)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HttpVersionMatchCondition DeserializeHttpVersionMatchCondition(JsonElement element, ModelReaderWriterOptions options)
        {
