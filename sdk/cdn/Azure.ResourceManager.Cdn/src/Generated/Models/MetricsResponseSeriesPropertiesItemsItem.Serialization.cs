...
{
    public partial class MetricsResponseSeriesPropertiesItemsItem : IUtf8JsonSerializable, IJsonModel<MetricsResponseSeriesPropertiesItemsItem>, IPersistableModel<MetricsResponseSeriesPropertiesItemsItem>
    {
        ...
        void IJsonModel<MetricsResponseSeriesPropertiesItemsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MetricsResponseSeriesPropertiesItemsItem)} does not support '{format}' format.");
            }
