...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriFileExtensionMatchCondition
    {
        ...
        internal UriFileExtensionMatchCondition(UriFileExtensionMatchConditionType conditionType, UriFileExtensionOperator uriFileExtensionOperator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConditionType = conditionType;
            UriFileExtensionOperator = uriFileExtensionOperator;
