...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownSecretProperties))]
    public abstract partial class FrontDoorSecretProperties
    {
        ...
        internal FrontDoorSecretProperties(SecretType secretType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
