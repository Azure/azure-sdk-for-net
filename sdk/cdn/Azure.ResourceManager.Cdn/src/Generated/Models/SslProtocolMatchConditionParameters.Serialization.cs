...
{
    public partial class SslProtocolMatchConditionParameters : IUtf8JsonSerializable
    {
        ...
        internal static SslProtocolMatchConditionParameters DeserializeSslProtocolMatchConditionParameters(JsonElement element)
        {
            SslProtocolMatchConditionParametersTypeName typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new SslProtocolMatchConditionParametersTypeName(property.Value.GetString());
                    continue;
                }
            ...
            return new SslProtocolMatchConditionParameters(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
