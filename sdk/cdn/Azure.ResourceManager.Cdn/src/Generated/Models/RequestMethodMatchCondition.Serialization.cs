...
{
    public partial class RequestMethodMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static RequestMethodMatchCondition DeserializeRequestMethodMatchCondition(JsonElement element)
        {
            ...
            Core.Optional<IList<RequestMethodMatchConditionMatchValue>> matchValues = default;
            ...
            return new RequestMethodMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(transforms), Core.Optional.ToList(matchValues));
        }
    }
}
