...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleHostNameCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleHostNameCondition(HostNameMatchCondition properties) : base(DeliveryRuleMatchVariable.HostName)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleHostNameCondition(DeliveryRuleMatchVariable name, IDictionary<string, BinaryData> additionalBinaryDataProperties, HostNameMatchCondition properties) : base(name, additionalBinaryDataProperties)
        {
            Properties = properties;
        }
