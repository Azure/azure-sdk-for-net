...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleHostNameCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleHostNameCondition(MatchVariable name, HostNameMatchCondition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
