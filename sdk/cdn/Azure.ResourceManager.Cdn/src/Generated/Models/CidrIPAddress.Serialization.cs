...
{
    public partial class CidrIPAddress : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CidrIPAddress DeserializeCidrIPAddress(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
