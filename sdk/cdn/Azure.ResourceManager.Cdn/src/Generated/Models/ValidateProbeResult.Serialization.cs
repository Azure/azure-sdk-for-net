...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ValidateProbeResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ValidateProbeResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ValidateProbeResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ValidateProbeResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
