...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CustomerCertificateProperties : SecretProperties
    {
        ...
        internal CustomerCertificateProperties(SecretType secretType, WritableSubResource secretSource, string secretVersion, bool? useLatestVersion, string subject, DateTimeOffset? expirationOn, string certificateAuthority, IList<string> subjectAlternativeNames, string thumbprint) : base(secretType)
        {
            SecretSource = secretSource;
