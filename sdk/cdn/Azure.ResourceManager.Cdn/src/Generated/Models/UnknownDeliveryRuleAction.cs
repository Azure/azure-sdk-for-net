...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    internal partial class UnknownDeliveryRuleAction : DeliveryRuleAction
    {
        ...
        internal UnknownDeliveryRuleAction(DeliveryRuleActionType name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Name = name;
        }
