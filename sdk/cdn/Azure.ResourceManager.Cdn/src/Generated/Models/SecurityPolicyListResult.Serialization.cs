...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static SecurityPolicyListResult DeserializeSecurityPolicyListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
