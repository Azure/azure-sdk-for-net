...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecurityPolicyListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecurityPolicyListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecurityPolicyListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecurityPolicyListResult>)} interface");
            }
        ...
        string IPersistableModel<SecurityPolicyListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
