...
namespace Azure.ResourceManager.Cdn.Models
{
    public partial class ResourcesResponse : IUtf8JsonSerializable, IJsonModel<ResourcesResponse>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourcesResponse>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourcesResponse>)} interface");
            }
