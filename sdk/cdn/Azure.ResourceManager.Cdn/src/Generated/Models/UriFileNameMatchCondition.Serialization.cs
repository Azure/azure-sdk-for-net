...
{
    public partial class UriFileNameMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static UriFileNameMatchCondition DeserializeUriFileNameMatchCondition(JsonElement element)
        {
            ...
            return new UriFileNameMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
