...
namespace Azure.ResourceManager.Cdn.Models
{
    public partial class UriFileNameMatchCondition : IUtf8JsonSerializable, IJsonModel<UriFileNameMatchCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(UriFileNameOperator), out propertyOverride);
            ...
            {
                builder.Append("  operator: ");
                builder.AppendLine($"'{UriFileNameOperator.ToString()}'");
            }
