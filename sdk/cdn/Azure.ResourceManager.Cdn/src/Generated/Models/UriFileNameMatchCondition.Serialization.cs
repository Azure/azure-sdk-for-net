...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UriFileNameMatchCondition>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        UriFileNameMatchCondition IJsonModel<UriFileNameMatchCondition>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static UriFileNameMatchCondition DeserializeUriFileNameMatchCondition(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UriFileNameMatchCondition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms), serializedAdditionalRawData);
        }

        BinaryData IModel<UriFileNameMatchCondition>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        UriFileNameMatchCondition IModel<UriFileNameMatchCondition>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<UriFileNameMatchCondition>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
