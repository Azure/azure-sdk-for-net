...
{
    public partial class UriFileNameMatchCondition : IUtf8JsonSerializable
    {
        ...
        internal static UriFileNameMatchCondition DeserializeUriFileNameMatchCondition(JsonElement element)
        {
            ...
            return new UriFileNameMatchCondition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
