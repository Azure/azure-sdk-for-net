...
{
    public partial class ResourcesResponseCustomDomainsItem : IUtf8JsonSerializable, IJsonModel<ResourcesResponseCustomDomainsItem>, IPersistableModel<ResourcesResponseCustomDomainsItem>
    {
        ...
        void IJsonModel<ResourcesResponseCustomDomainsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourcesResponseCustomDomainsItem)} does not support '{format}' format.");
            }
