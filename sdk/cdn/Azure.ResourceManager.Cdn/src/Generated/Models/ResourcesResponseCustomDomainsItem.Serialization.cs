...
namespace Azure.ResourceManager.Cdn.Models
{
    public partial class ResourcesResponseCustomDomainsItem : IUtf8JsonSerializable, IJsonModel<ResourcesResponseCustomDomainsItem>
    {
        ...
        void IJsonModel<ResourcesResponseCustomDomainsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ResourcesResponseCustomDomainsItem)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ResourcesResponseCustomDomainsItem>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ResourcesResponseCustomDomainsItem)} does not support '{options.Format}' format.");
            }
        }
