...
{
    public partial class UriSigningActionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static UriSigningActionDefinition DeserializeUriSigningActionDefinition(JsonElement element)
        {
            ...
            return new UriSigningActionDefinition(typeName, Optional.ToNullable(algorithm), Optional.ToList(parameterNameOverride));
        }
    }
}
