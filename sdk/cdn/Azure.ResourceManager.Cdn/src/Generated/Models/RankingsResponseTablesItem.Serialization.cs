...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static RankingsResponseTablesItem DeserializeRankingsResponseTablesItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
