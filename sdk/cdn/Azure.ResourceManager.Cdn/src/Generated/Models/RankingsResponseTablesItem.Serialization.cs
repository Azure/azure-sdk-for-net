...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RankingsResponseTablesItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RankingsResponseTablesItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RankingsResponseTablesItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RankingsResponseTablesItem>)} interface");
            }
        ...
        string IPersistableModel<RankingsResponseTablesItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
