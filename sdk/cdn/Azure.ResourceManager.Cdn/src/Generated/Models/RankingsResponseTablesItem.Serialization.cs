...
{
    public partial class RankingsResponseTablesItem : IUtf8JsonSerializable, IJsonModel<RankingsResponseTablesItem>, IPersistableModel<RankingsResponseTablesItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RankingsResponseTablesItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RankingsResponseTablesItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RankingsResponseTablesItem)} does not support '{format}' format.");
            }
