...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class SocketAddressMatchCondition : DeliveryRuleConditionProperties
    {
        ...
        public SocketAddressMatchCondition(SocketAddressOperator @operator) : base(DeliveryRuleConditionParametersType.DeliveryRuleSocketAddrConditionParameters)
        {
            Operator = @operator;
        ...
        internal SocketAddressMatchCondition(DeliveryRuleConditionParametersType typeName, IDictionary<string, BinaryData> additionalBinaryDataProperties, SocketAddressOperator @operator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms) : base(typeName, additionalBinaryDataProperties)
        {
            Operator = @operator;
