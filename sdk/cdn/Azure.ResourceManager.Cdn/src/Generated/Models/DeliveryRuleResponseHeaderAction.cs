...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleResponseHeaderAction : DeliveryRuleAction
    {
        ...
        internal DeliveryRuleResponseHeaderAction(DeliveryRuleActionType name, HeaderActionProperties properties, Dictionary<string, BinaryData> rawData) : base(name, rawData)
        {
            Properties = properties;
            Name = name;
        }
