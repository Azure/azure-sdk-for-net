...
{
    public partial class DeliveryRuleSslProtocolMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static DeliveryRuleSslProtocolMatchCondition DeserializeDeliveryRuleSslProtocolMatchCondition(JsonElement element)
        {
            ...
            Core.Optional<IList<DeliveryRuleSslProtocol>> matchValues = default;
            ...
            return new DeliveryRuleSslProtocolMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
