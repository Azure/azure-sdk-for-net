...
{
    public partial class DeliveryRuleSslProtocolMatchCondition : IUtf8JsonSerializable, IJsonModel<DeliveryRuleSslProtocolMatchCondition>, IPersistableModel<DeliveryRuleSslProtocolMatchCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SslProtocolMatchConditionType))
            {
                builder.Append("  typeName:");
                builder.AppendLine($" '{SslProtocolMatchConditionType.ToString()}'");
            }

            if (Optional.IsDefined(SslProtocolOperator))
            {
                builder.Append("  operator:");
                builder.AppendLine($" '{SslProtocolOperator.ToString()}'");
            }
