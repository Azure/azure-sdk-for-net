...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleSslProtocolMatchCondition : DeliveryRuleConditionProperties, IJsonModel<DeliveryRuleSslProtocolMatchCondition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DeliveryRuleSslProtocolMatchCondition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DeliveryRuleSslProtocolMatchCondition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DeliveryRuleSslProtocolMatchCondition IPersistableModel<DeliveryRuleSslProtocolMatchCondition>.Create(BinaryData data, ModelReaderWriterOptions options) => (DeliveryRuleSslProtocolMatchCondition)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeliveryRuleSslProtocolMatchCondition IJsonModel<DeliveryRuleSslProtocolMatchCondition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DeliveryRuleSslProtocolMatchCondition)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DeliveryRuleSslProtocolMatchCondition DeserializeDeliveryRuleSslProtocolMatchCondition(JsonElement element, ModelReaderWriterOptions options)
        {
