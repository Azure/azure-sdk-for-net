...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class MatchCondition
    {
        ...
        public MatchCondition(WafMatchVariable matchVariable, MatchOperator op, IEnumerable<string> matchValue)
        {
            if (matchValue == null)
            {
        ...
        internal MatchCondition(WafMatchVariable matchVariable, string selector, MatchOperator op, bool? negateCondition, IList<string> matchValue, IList<TransformType> transforms)
        {
            MatchVariable = matchVariable;
            Selector = selector;
            Op = op;
        ...
        public MatchOperator Op { get; set; }
