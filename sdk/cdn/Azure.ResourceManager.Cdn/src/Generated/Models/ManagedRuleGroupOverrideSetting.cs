...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class ManagedRuleGroupOverrideSetting
    {
        ...
        internal ManagedRuleGroupOverrideSetting(string ruleGroupName, IList<ManagedRuleOverrideSetting> rules, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RuleGroupName = ruleGroupName;
            Rules = rules;
