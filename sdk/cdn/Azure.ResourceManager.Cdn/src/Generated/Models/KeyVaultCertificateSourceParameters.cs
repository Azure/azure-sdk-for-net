...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class KeyVaultCertificateSourceParameters : CertificateSourceProperties
    {
        ...
        public KeyVaultCertificateSourceParameters(string subscriptionId, string resourceGroupName, string vaultName, string secretName, CertificateUpdateAction updateRule, CertificateDeleteAction deleteRule) : base(CertificateSourceParametersType.KeyVaultCertificateSourceParameters)
        {
        ...
        /// <param name="updateRule"> Describes the action that shall be taken when the certificate is updated in Key Vault. </param>
        /// <param name="deleteRule"> Describes the action that shall be taken when the certificate is removed from Key Vault. </param>
        internal KeyVaultCertificateSourceParameters(CertificateSourceParametersType typeName, IDictionary<string, BinaryData> additionalBinaryDataProperties, string subscriptionId, string resourceGroupName, string vaultName, string secretName, string secretVersion, CertificateUpdateAction updateRule, CertificateDeleteAction deleteRule) : base(typeName, additionalBinaryDataProperties)
        {
            SubscriptionId = subscriptionId;
            ResourceGroupName = resourceGroupName;
            VaultName = vaultName;
