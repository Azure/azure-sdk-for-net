...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UrlRewriteAction : DeliveryRuleAction, IJsonModel<UrlRewriteAction>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<UrlRewriteAction>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<UrlRewriteAction>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        UrlRewriteAction IPersistableModel<UrlRewriteAction>.Create(BinaryData data, ModelReaderWriterOptions options) => (UrlRewriteAction)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        UrlRewriteAction IJsonModel<UrlRewriteAction>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (UrlRewriteAction)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UrlRewriteAction DeserializeUrlRewriteAction(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    parameters = UrlRewriteActionParameters.DeserializeUrlRewriteActionParameters(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new UrlRewriteAction(name, additionalBinaryDataProperties, parameters);
        }
    }
}
