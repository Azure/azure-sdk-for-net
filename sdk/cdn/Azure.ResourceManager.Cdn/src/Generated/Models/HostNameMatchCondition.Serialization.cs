...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class HostNameMatchCondition : DeliveryRuleConditionProperties, IJsonModel<HostNameMatchCondition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HostNameMatchCondition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HostNameMatchCondition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HostNameMatchCondition IPersistableModel<HostNameMatchCondition>.Create(BinaryData data, ModelReaderWriterOptions options) => (HostNameMatchCondition)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HostNameMatchCondition IJsonModel<HostNameMatchCondition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HostNameMatchCondition)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HostNameMatchCondition DeserializeHostNameMatchCondition(JsonElement element, ModelReaderWriterOptions options)
        {
