...
{
    public partial class HostNameMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static HostNameMatchCondition DeserializeHostNameMatchCondition(JsonElement element)
        {
            ...
            return new HostNameMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
