...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HostNameMatchCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HostNameMatchCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HostNameMatchCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HostNameMatchCondition>)} interface");
            }
        ...
        string IPersistableModel<HostNameMatchCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
