...
{
    public partial class HostNameMatchCondition : IUtf8JsonSerializable, IJsonModel<HostNameMatchCondition>, IPersistableModel<HostNameMatchCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HostNameOperator))
            {
                builder.Append("  operator:");
                builder.AppendLine($" '{HostNameOperator.ToString()}'");
            }
