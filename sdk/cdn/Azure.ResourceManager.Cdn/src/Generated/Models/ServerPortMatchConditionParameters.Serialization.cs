...
{
    public partial class ServerPortMatchConditionParameters : IUtf8JsonSerializable
    {
        ...
        internal static ServerPortMatchConditionParameters DeserializeServerPortMatchConditionParameters(JsonElement element)
        {
            ServerPortMatchConditionParametersTypeName typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new ServerPortMatchConditionParametersTypeName(property.Value.GetString());
                    continue;
                }
            ...
            return new ServerPortMatchConditionParameters(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
