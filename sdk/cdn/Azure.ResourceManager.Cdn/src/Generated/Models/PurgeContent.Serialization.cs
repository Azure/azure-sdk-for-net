...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PurgeContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PurgeContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PurgeContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PurgeContent>)} interface");
            }
        ...
        string IPersistableModel<PurgeContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
