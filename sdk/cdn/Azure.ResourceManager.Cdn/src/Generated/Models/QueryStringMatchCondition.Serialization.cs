...
{
    public partial class QueryStringMatchCondition : IUtf8JsonSerializable, IJsonModel<QueryStringMatchCondition>, IPersistableModel<QueryStringMatchCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(QueryStringOperator))
            {
                builder.Append("  operator:");
                builder.AppendLine($" '{QueryStringOperator.ToString()}'");
            }
