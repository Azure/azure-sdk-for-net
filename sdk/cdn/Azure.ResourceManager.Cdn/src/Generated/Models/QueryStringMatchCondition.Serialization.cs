...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class QueryStringMatchCondition : DeliveryRuleConditionProperties, IJsonModel<QueryStringMatchCondition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<QueryStringMatchCondition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<QueryStringMatchCondition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        QueryStringMatchCondition IPersistableModel<QueryStringMatchCondition>.Create(BinaryData data, ModelReaderWriterOptions options) => (QueryStringMatchCondition)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        QueryStringMatchCondition IJsonModel<QueryStringMatchCondition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (QueryStringMatchCondition)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static QueryStringMatchCondition DeserializeQueryStringMatchCondition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            QueryStringOperator queryStringOperator = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    queryStringOperator = new QueryStringOperator(prop.Value.GetString());
                    continue;
                }
