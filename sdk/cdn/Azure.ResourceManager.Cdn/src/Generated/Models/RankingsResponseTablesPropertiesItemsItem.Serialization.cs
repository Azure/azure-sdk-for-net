...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RankingsResponseTablesPropertiesItemsItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RankingsResponseTablesPropertiesItemsItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RankingsResponseTablesPropertiesItemsItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RankingsResponseTablesPropertiesItemsItem>)} interface");
            }
        ...
        string IPersistableModel<RankingsResponseTablesPropertiesItemsItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
