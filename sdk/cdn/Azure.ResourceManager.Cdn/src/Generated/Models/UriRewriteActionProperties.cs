...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriRewriteActionProperties
    {
        ...
        internal UriRewriteActionProperties(UriRewriteActionType actionType, string sourcePattern, string destination, bool? preserveUnmatchedPath, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ActionType = actionType;
            SourcePattern = sourcePattern;
            Destination = destination;
