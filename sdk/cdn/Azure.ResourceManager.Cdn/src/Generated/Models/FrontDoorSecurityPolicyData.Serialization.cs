...
{
    public partial class FrontDoorSecurityPolicyData : Core.IUtf8JsonSerializable
    {
        ...
        internal static FrontDoorSecurityPolicyData DeserializeFrontDoorSecurityPolicyData(JsonElement element)
        {
            ...
            Core.Optional<SecurityPolicyProperties> parameters = default;
            ...
            return new FrontDoorSecurityPolicyData(id, name, type, systemData.Value, Core.Optional.ToNullable(provisioningState), Core.Optional.ToNullable(deploymentStatus), profileName.Value, parameters.Value);
        }
    }
}
