...
{
    public partial class FrontDoorSecurityPolicyData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FrontDoorSecurityPolicyData DeserializeFrontDoorSecurityPolicyData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
