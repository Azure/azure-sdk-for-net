...
{
    public partial class UriPathMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static UriPathMatchConditionDefinition DeserializeUriPathMatchConditionDefinition(JsonElement element)
        {
            ...
            return new UriPathMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
