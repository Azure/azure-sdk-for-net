...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class OriginGroupOverrideActionParameters : DeliveryRuleActionProperties, IJsonModel<OriginGroupOverrideActionParameters>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<OriginGroupOverrideActionParameters>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OriginGroupOverrideActionParameters>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OriginGroupOverrideActionParameters IPersistableModel<OriginGroupOverrideActionParameters>.Create(BinaryData data, ModelReaderWriterOptions options) => (OriginGroupOverrideActionParameters)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OriginGroupOverrideActionParameters IJsonModel<OriginGroupOverrideActionParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OriginGroupOverrideActionParameters)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OriginGroupOverrideActionParameters DeserializeOriginGroupOverrideActionParameters(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new OriginGroupOverrideActionParameters(typeName, additionalBinaryDataProperties, originGroup);
        }
    }
}
