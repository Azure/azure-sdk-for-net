...
{
    public partial class GeoFilter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GeoFilter DeserializeGeoFilter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
