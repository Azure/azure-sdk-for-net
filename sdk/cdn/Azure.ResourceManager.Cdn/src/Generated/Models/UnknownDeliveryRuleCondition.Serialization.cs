...
{
    internal partial class UnknownDeliveryRuleCondition : DeliveryRuleCondition, IJsonModel<DeliveryRuleCondition>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDeliveryRuleCondition DeserializeUnknownDeliveryRuleCondition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDeliveryRuleCondition(name, additionalBinaryDataProperties);
        }
    }
}
