...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class HeaderActionParameters : DeliveryRuleActionProperties, IJsonModel<HeaderActionParameters>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<HeaderActionParameters>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<HeaderActionParameters>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        HeaderActionParameters IPersistableModel<HeaderActionParameters>.Create(BinaryData data, ModelReaderWriterOptions options) => (HeaderActionParameters)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        HeaderActionParameters IJsonModel<HeaderActionParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (HeaderActionParameters)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static HeaderActionParameters DeserializeHeaderActionParameters(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new HeaderActionParameters(typeName, additionalBinaryDataProperties, headerAction, headerName, value);
        }
    }
}
