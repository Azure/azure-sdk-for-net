...
{
    public partial class SslProtocolMatchConditionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static SslProtocolMatchConditionDefinition DeserializeSslProtocolMatchConditionDefinition(JsonElement element)
        {
            ...
            return new SslProtocolMatchConditionDefinition(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
