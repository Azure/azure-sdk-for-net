...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriSigningAction : DeliveryRuleAction
    {
        ...
        public UriSigningAction(UriSigningActionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the action. </param>
        internal UriSigningAction(DeliveryRuleActionType name, IDictionary<string, BinaryData> serializedAdditionalRawData, UriSigningActionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public UriSigningActionParameters Properties { get; set; }
    }
}
