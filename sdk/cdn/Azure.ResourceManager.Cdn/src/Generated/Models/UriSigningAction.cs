...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriSigningAction : DeliveryRuleAction
    {
        ...
        internal UriSigningAction(DeliveryRuleActionType name, UriSigningActionProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
