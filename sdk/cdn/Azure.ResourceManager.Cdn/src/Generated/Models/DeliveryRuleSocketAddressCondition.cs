...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleSocketAddressCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleSocketAddressCondition(MatchVariable name, SocketAddressMatchCondition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
