...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleSocketAddressCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleSocketAddressCondition(SocketAddressMatchCondition parameters)
        {
            if (parameters == null)
            {
        ...
        /// <param name="parameters"> Defines the parameters for the condition. </param>
        internal DeliveryRuleSocketAddressCondition(MatchVariable name, SocketAddressMatchCondition parameters) : base(name)
        {
            Parameters = parameters;
            Name = name;
        }
