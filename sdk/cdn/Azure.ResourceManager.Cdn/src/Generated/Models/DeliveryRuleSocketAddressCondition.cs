...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleSocketAddressCondition : DeliveryRuleCondition
    {
        ...
        public DeliveryRuleSocketAddressCondition(SocketAddrMatchConditionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the condition. </param>
        internal DeliveryRuleSocketAddressCondition(MatchVariable name, IDictionary<string, BinaryData> serializedAdditionalRawData, SocketAddrMatchConditionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public SocketAddrMatchConditionParameters Properties { get; set; }
    }
}
