...
{
    public partial class IsDeviceMatchCondition : Core.IUtf8JsonSerializable
    {
        ...
        internal static IsDeviceMatchCondition DeserializeIsDeviceMatchCondition(JsonElement element)
        {
            ...
            Core.Optional<IList<IsDeviceMatchConditionMatchValue>> matchValues = default;
            ...
            return new IsDeviceMatchCondition(typeName, @operator, Core.Optional.ToNullable(negateCondition), Core.Optional.ToList(matchValues), Core.Optional.ToList(transforms));
        }
    }
}
