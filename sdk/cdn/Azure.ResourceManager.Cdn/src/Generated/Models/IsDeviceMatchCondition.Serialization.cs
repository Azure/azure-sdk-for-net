...
{
    public partial class IsDeviceMatchCondition : IUtf8JsonSerializable, IJsonModel<IsDeviceMatchCondition>, IPersistableModel<IsDeviceMatchCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsDeviceOperator))
            {
                builder.Append("  operator:");
                builder.AppendLine($" '{IsDeviceOperator.ToString()}'");
            }
