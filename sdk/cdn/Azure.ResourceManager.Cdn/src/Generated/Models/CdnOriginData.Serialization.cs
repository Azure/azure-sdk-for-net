...
{
    public partial class CdnOriginData : IUtf8JsonSerializable, IModelJsonSerializable<CdnOriginData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<CdnOriginData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<CdnOriginData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CdnOriginData>(this, options.Format);
        ...
        internal static CdnOriginData DeserializeCdnOriginData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CdnOriginData(id, name, type, systemData.Value, hostName.Value, Optional.ToNullable(httpPort), Optional.ToNullable(httpsPort), originHostHeader.Value, Optional.ToNullable(priority), Optional.ToNullable(weight), Optional.ToNullable(enabled), privateLinkAlias.Value, privateLinkResourceId.Value, privateLinkLocation.Value, privateLinkApprovalMessage.Value, Optional.ToNullable(resourceState), Optional.ToNullable(provisioningState), Optional.ToNullable(privateEndpointStatus), rawData);
        }

        CdnOriginData IModelJsonSerializable<CdnOriginData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CdnOriginData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeCdnOriginData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<CdnOriginData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CdnOriginData>(this, options.Format);
        ...
        CdnOriginData IModelSerializable<CdnOriginData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<CdnOriginData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="CdnOriginData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CdnOriginData"/> to convert. </param>
        public static implicit operator RequestContent(CdnOriginData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CdnOriginData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator CdnOriginData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeCdnOriginData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
