...
{
    public partial class CdnOriginData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CdnOriginData DeserializeCdnOriginData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
