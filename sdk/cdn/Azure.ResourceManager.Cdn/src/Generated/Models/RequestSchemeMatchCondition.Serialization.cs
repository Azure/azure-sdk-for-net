...
{
    public partial class RequestSchemeMatchCondition : IUtf8JsonSerializable, IJsonModel<RequestSchemeMatchCondition>, IPersistableModel<RequestSchemeMatchCondition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RequestSchemeOperator))
            {
                builder.Append("  operator:");
                builder.AppendLine($" '{RequestSchemeOperator.ToString()}'");
            }
