...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeliveryRuleRemoteAddressCondition>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        DeliveryRuleRemoteAddressCondition IJsonModel<DeliveryRuleRemoteAddressCondition>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static DeliveryRuleRemoteAddressCondition DeserializeDeliveryRuleRemoteAddressCondition(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DeliveryRuleRemoteAddressCondition(name, serializedAdditionalRawData, parameters);
        }

        BinaryData IModel<DeliveryRuleRemoteAddressCondition>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        DeliveryRuleRemoteAddressCondition IModel<DeliveryRuleRemoteAddressCondition>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<DeliveryRuleRemoteAddressCondition>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
