...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRemoteAddressCondition : DeliveryRuleCondition, IJsonModel<DeliveryRuleRemoteAddressCondition>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DeliveryRuleRemoteAddressCondition>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DeliveryRuleRemoteAddressCondition>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DeliveryRuleRemoteAddressCondition IPersistableModel<DeliveryRuleRemoteAddressCondition>.Create(BinaryData data, ModelReaderWriterOptions options) => (DeliveryRuleRemoteAddressCondition)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeliveryRuleRemoteAddressCondition IJsonModel<DeliveryRuleRemoteAddressCondition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DeliveryRuleRemoteAddressCondition)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DeliveryRuleRemoteAddressCondition DeserializeDeliveryRuleRemoteAddressCondition(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            RemoteAddressMatchCondition properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    properties = RemoteAddressMatchCondition.DeserializeRemoteAddressMatchCondition(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new DeliveryRuleRemoteAddressCondition(name, additionalBinaryDataProperties, properties);
        }
    }
}
