...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class ManagedRuleOverrideAfd
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ManagedRuleOverrideAfd"/>. </summary>
        /// <param name="ruleId"> Identifier for the managed rule. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ruleId"/> is null. </exception>
        public ManagedRuleOverrideAfd(string ruleId)
        {
        ...
        internal ManagedRuleOverrideAfd(string ruleId, ManagedRuleSetupState? enabledState, OverrideActionType? action, IList<ManagedRuleExclusion> exclusions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            RuleId = ruleId;
