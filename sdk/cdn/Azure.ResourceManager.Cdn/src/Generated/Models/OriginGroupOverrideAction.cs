...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class OriginGroupOverrideAction : DeliveryRuleAction
    {
        ...
        public OriginGroupOverrideAction(OriginGroupOverrideActionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the action. </param>
        internal OriginGroupOverrideAction(DeliveryRuleActionType name, IDictionary<string, BinaryData> serializedAdditionalRawData, OriginGroupOverrideActionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public OriginGroupOverrideActionParameters Properties { get; set; }
    }
}
