...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class OriginGroupOverrideAction : DeliveryRuleAction
    {
        ...
        public OriginGroupOverrideAction(OriginGroupOverrideActionProperties properties) : base(DeliveryRuleActionName.OriginGroupOverride)
        {
        ...
        /// <param name="properties"> Defines the parameters for the action. </param>
        internal OriginGroupOverrideAction(DeliveryRuleActionName name, IDictionary<string, BinaryData> additionalBinaryDataProperties, OriginGroupOverrideActionProperties properties) : base(name, additionalBinaryDataProperties)
        {
            Properties = properties;
        }
