...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class OriginGroupOverrideAction : DeliveryRuleAction
    {
        ...
        internal OriginGroupOverrideAction(DeliveryRuleActionType name, OriginGroupOverrideActionProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
