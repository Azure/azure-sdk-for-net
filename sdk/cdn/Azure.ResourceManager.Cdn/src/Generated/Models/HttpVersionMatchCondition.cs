...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class HttpVersionMatchCondition
    {
        ...
        internal HttpVersionMatchCondition(HttpVersionMatchConditionType conditionType, HttpVersionOperator httpVersionOperator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ConditionType = conditionType;
            HttpVersionOperator = httpVersionOperator;
