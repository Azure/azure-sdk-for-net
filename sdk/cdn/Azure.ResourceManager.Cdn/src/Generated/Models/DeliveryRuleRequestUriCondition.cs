...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class DeliveryRuleRequestUriCondition : DeliveryRuleCondition
    {
        ...
        internal DeliveryRuleRequestUriCondition(MatchVariable name, RequestUriMatchCondition properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
