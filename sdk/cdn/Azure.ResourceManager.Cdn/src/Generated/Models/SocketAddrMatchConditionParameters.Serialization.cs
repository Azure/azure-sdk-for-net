...
{
    public partial class SocketAddrMatchConditionParameters : IUtf8JsonSerializable
    {
        ...
        internal static SocketAddrMatchConditionParameters DeserializeSocketAddrMatchConditionParameters(JsonElement element)
        {
            SocketAddrMatchConditionParametersTypeName typeName = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    typeName = new SocketAddrMatchConditionParametersTypeName(property.Value.GetString());
                    continue;
                }
            ...
            return new SocketAddrMatchConditionParameters(typeName, @operator, Optional.ToNullable(negateCondition), Optional.ToList(matchValues), Optional.ToList(transforms));
        }
    }
}
