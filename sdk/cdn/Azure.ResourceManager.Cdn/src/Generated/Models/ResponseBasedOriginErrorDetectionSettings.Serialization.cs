...
{
    public partial class ResponseBasedOriginErrorDetectionSettings : IUtf8JsonSerializable, IJsonModel<ResponseBasedOriginErrorDetectionSettings>, IPersistableModel<ResponseBasedOriginErrorDetectionSettings>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResponseBasedOriginErrorDetectionSettings>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResponseBasedDetectedErrorType))
            {
                ...
                builder.AppendLine($" '{ResponseBasedDetectedErrorType.ToString()}'");
            }

            if (Optional.IsDefined(ResponseBasedFailoverThresholdPercentage))
            {
                builder.Append("  responseBasedFailoverThresholdPercentage:");
                builder.AppendLine($" '{ResponseBasedFailoverThresholdPercentage.Value.ToString()}'");
            }
