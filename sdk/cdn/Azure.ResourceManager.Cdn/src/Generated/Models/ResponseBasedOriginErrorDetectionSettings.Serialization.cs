...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResponseBasedOriginErrorDetectionSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResponseBasedOriginErrorDetectionSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResponseBasedOriginErrorDetectionSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResponseBasedOriginErrorDetectionSettings>)} interface");
            }
        ...
        string IPersistableModel<ResponseBasedOriginErrorDetectionSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
