...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriRewriteAction : DeliveryRuleAction
    {
        ...
        internal UriRewriteAction(DeliveryRuleActionType name, UriRewriteActionProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
