...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriRewriteAction : DeliveryRuleAction
    {
        ...
        public UriRewriteAction(UriRewriteActionProperties properties) : base(DeliveryRuleActionName.UrlRewrite)
        {
        ...
        /// <param name="properties"> Defines the parameters for the action. </param>
        internal UriRewriteAction(DeliveryRuleActionName name, IDictionary<string, BinaryData> additionalBinaryDataProperties, UriRewriteActionProperties properties) : base(name, additionalBinaryDataProperties)
        {
            Properties = properties;
        }
