...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UriRewriteAction : DeliveryRuleAction
    {
        ...
        public UriRewriteAction(UriRewriteActionParameters properties)
        {
        ...
        /// <param name="properties"> Defines the parameters for the action. </param>
        internal UriRewriteAction(DeliveryRuleActionType name, IDictionary<string, BinaryData> serializedAdditionalRawData, UriRewriteActionParameters properties) : base(name, serializedAdditionalRawData)
        {
            Properties = properties;
            Name = name;
        }
        ...
        public UriRewriteActionParameters Properties { get; set; }
    }
}
