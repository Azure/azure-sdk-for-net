...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouteConfigurationOverrideActionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RouteConfigurationOverrideActionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RouteConfigurationOverrideActionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RouteConfigurationOverrideActionProperties>)} interface");
            }
        ...
        string IPersistableModel<RouteConfigurationOverrideActionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
