...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class UrlFileNameMatchConditionDefinition
    {
        ...
        internal UrlFileNameMatchConditionDefinition(UrlFileNameMatchConditionType typeDefinition, UrlFileNameOperator @operator, bool? negateCondition, IList<string> matchValues, IList<PreTransformCategory> transforms)
        {
            TypeDefinition = typeDefinition;
            Operator = @operator;
