...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static ManagedRuleGroupDefinition DeserializeManagedRuleGroupDefinition(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
