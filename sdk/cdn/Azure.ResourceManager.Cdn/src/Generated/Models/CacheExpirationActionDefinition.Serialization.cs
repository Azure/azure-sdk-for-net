...
{
    public partial class CacheExpirationActionDefinition : IUtf8JsonSerializable
    {
        ...
        internal static CacheExpirationActionDefinition DeserializeCacheExpirationActionDefinition(JsonElement element)
        {
            ...
            return new CacheExpirationActionDefinition(typeName, cacheBehavior, cacheType, Optional.ToNullable(cacheDuration));
        }
    }
}
