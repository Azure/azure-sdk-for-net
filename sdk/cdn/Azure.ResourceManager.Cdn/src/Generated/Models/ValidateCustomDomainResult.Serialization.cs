...
namespace Azure.ResourceManager.Cdn.Models
{
    public partial class ValidateCustomDomainResult : IUtf8JsonSerializable, IJsonModel<ValidateCustomDomainResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(IsCustomDomainValid), out propertyOverride);
            ...
            {
                if (Optional.IsDefined(IsCustomDomainValid))
                {
                    builder.Append("  customDomainValidated: ");
                    var boolValue = IsCustomDomainValid.Value == true ? "true" : "false";
