...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ValidateCustomDomainResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ValidateCustomDomainResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ValidateCustomDomainResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ValidateCustomDomainResult>)} interface");
            }
        ...
        string IPersistableModel<ValidateCustomDomainResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
