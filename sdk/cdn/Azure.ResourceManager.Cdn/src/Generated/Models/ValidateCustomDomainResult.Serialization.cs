...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        internal static ValidateCustomDomainResult DeserializeValidateCustomDomainResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
