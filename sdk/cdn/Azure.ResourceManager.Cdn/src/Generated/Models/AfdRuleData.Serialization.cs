...
namespace Azure.ResourceManager.Cdn
{
    public partial class AfdRuleData : IUtf8JsonSerializable
    {
        ...
        internal static AfdRuleData DeserializeAfdRuleData(JsonElement element)
        {
            ...
            return new AfdRuleData(id, name, type, systemData.Value, ruleSetName.Value, Optional.ToNullable(order), Optional.ToList(conditions), Optional.ToList(actions), Optional.ToNullable(matchProcessingBehavior), Optional.ToNullable(provisioningState), Optional.ToNullable(deploymentStatus));
        }
    }
}
