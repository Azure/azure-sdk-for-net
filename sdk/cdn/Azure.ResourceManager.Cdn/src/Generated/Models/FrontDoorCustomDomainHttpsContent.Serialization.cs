...
{
    public partial class FrontDoorCustomDomainHttpsContent : IUtf8JsonSerializable, IJsonModel<FrontDoorCustomDomainHttpsContent>, IPersistableModel<FrontDoorCustomDomainHttpsContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Secret))
            {
                ...
                AppendChildObject(builder, Secret, options, 2);
            }
