...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class RemoteAddressMatchConditionParameters : DeliveryRuleConditionProperties, IJsonModel<RemoteAddressMatchConditionParameters>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RemoteAddressMatchConditionParameters>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RemoteAddressMatchConditionParameters>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RemoteAddressMatchConditionParameters IPersistableModel<RemoteAddressMatchConditionParameters>.Create(BinaryData data, ModelReaderWriterOptions options) => (RemoteAddressMatchConditionParameters)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RemoteAddressMatchConditionParameters IJsonModel<RemoteAddressMatchConditionParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RemoteAddressMatchConditionParameters)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RemoteAddressMatchConditionParameters DeserializeRemoteAddressMatchConditionParameters(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    @operator = new RemoteAddressOperator(prop.Value.GetString());
                    continue;
                }
