...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class HeaderActionProperties
    {
        ...
        internal HeaderActionProperties(HeaderActionType actionType, HeaderAction headerAction, string headerName, string value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ActionType = actionType;
            HeaderAction = headerAction;
            HeaderName = headerName;
