...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPAddressGroup>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPAddressGroup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPAddressGroup>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPAddressGroup>)} interface");
            }
        ...
        string IPersistableModel<IPAddressGroup>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
