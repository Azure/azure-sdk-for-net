...
namespace Azure.ResourceManager.Cdn
{
    ...
    {
        private readonly ClientDiagnostics _afdOriginGroupsClientDiagnostics;
        private readonly AFDOriginGroups _afdOriginGroupsRestClient;
        ...
        internal FrontDoorOriginGroupCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _afdOriginGroupsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Cdn", FrontDoorOriginGroupResource.ResourceType.Namespace, Diagnostics);
            _afdOriginGroupsRestClient = new AFDOriginGroups(_afdOriginGroupsClientDiagnostics, Pipeline, Endpoint, frontDoorOriginGroupApiVersion ?? "2025-09-01-preview");
        ...
        public virtual async Task<ArmOperation<FrontDoorOriginGroupResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string originGroupName, FrontDoorOriginGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _afdOriginGroupsClientDiagnostics.CreateScope("FrontDoorOriginGroupCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _afdOriginGroupsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, originGroupName, FrontDoorOriginGroupData.ToRequestContent(data), context);
                ...
                CdnArmOperation<FrontDoorOriginGroupResource> operation = new CdnArmOperation<FrontDoorOriginGroupResource>(
                    ...
                    _afdOriginGroupsClientDiagnostics,
                    Pipeline,
                    message.Request,
                    response,
        ...
        public virtual async Task<Response<FrontDoorOriginGroupResource>> GetAsync(string originGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _afdOriginGroupsClientDiagnostics.CreateScope("FrontDoorOriginGroupCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _afdOriginGroupsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, originGroupName, context);
        ...
        public virtual AsyncPageable<FrontDoorOriginGroupResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<FrontDoorOriginGroupData, FrontDoorOriginGroupResource>(new AFDOriginGroupsGetByProfileAsyncCollectionResultOfT(_afdOriginGroupsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new FrontDoorOriginGroupResource(Client, data));
        }
        ...
        public virtual Pageable<FrontDoorOriginGroupResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<FrontDoorOriginGroupData, FrontDoorOriginGroupResource>(new AFDOriginGroupsGetByProfileCollectionResultOfT(_afdOriginGroupsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new FrontDoorOriginGroupResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string originGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _afdOriginGroupsClientDiagnostics.CreateScope("FrontDoorOriginGroupCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<FrontDoorOriginGroupResource>> GetIfExistsAsync(string originGroupName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _afdOriginGroupsClientDiagnostics.CreateScope("FrontDoorOriginGroupCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
