...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class AfdOriginGroupResource : ArmResource
    {
        ...
        public virtual AsyncPageable<CdnUsage> GetResourceUsageUnderAfdOriginGroupAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<CdnUsage>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _afdOriginGroupClientDiagnostics.CreateScope("AfdOriginGroupResource.GetResourceUsageUnderAfdOriginGroup");
                scope.Start();
                try
                {
        ...
        public virtual Pageable<CdnUsage> GetResourceUsageUnderAfdOriginGroup(CancellationToken cancellationToken = default)
        {
