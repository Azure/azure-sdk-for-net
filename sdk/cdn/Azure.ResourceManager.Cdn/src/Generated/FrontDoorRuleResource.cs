...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class FrontDoorRuleResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FrontDoorRuleResource>> UpdateAsync(WaitUntil waitUntil, FrontDoorRuleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _rulesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, FrontDoorRuleData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CdnArmOperation<FrontDoorRuleResource> operation = new CdnArmOperation<FrontDoorRuleResource>(
                    new FrontDoorRuleResourceOperationSource(Client),
                    _rulesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<FrontDoorRuleResource> Update(WaitUntil waitUntil, FrontDoorRuleData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
