...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class AfdRouteResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AfdRouteResource>> UpdateAsync(WaitUntil waitUntil, PatchableAfdRouteData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CdnArmOperation<AfdRouteResource>(new AfdRouteOperationSource(Client), _afdRouteClientDiagnostics, Pipeline, _afdRouteRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<AfdRouteResource> Update(WaitUntil waitUntil, PatchableAfdRouteData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
