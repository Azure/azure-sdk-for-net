...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class CdnWebAgentKnowledgeSourceData : ResourceData
    {
        ...
        internal CdnWebAgentKnowledgeSourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, KnowledgeSourceProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
