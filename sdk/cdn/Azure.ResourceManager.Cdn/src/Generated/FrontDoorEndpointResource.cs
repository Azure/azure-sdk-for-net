...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class FrontDoorEndpointResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FrontDoorEndpointResource>> UpdateAsync(WaitUntil waitUntil, FrontDoorEndpointPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                CdnArmOperation<FrontDoorEndpointResource> operation = new CdnArmOperation<FrontDoorEndpointResource>(
                    new FrontDoorEndpointResourceOperationSource(Client),
        ...
        public virtual async Task<ArmOperation<FrontDoorEndpointResource>> UpdateAsync(WaitUntil waitUntil, FrontDoorEndpointData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _frontDoorEndpointsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, FrontDoorEndpointData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CdnArmOperation<FrontDoorEndpointResource> operation = new CdnArmOperation<FrontDoorEndpointResource>(
                    new FrontDoorEndpointResourceOperationSource(Client),
                    _frontDoorEndpointsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<FrontDoorEndpointResource> Update(WaitUntil waitUntil, FrontDoorEndpointData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
