...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class ProfileData : TrackedResourceData, IJsonModel<ProfileData>
    {
        ...
        internal static RequestContent ToRequestContent(ProfileData profileData)
        {
            ...
            content.JsonWriter.WriteObjectValue(profileData, ModelSerializationExtensions.WireOptions);
            return content;
        }
        ...
        internal static ProfileData DeserializeProfileData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("identity"u8))
                {
                    ...
                    identity = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerCdnContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
