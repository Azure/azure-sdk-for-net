...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class FrontDoorRuleSetCollection : ArmCollection, IEnumerable<FrontDoorRuleSetResource>, IAsyncEnumerable<FrontDoorRuleSetResource>
    {
        ...
        public virtual AsyncPageable<FrontDoorRuleSetResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<FrontDoorRuleSetData, FrontDoorRuleSetResource>(new RuleSetsGetByProfileAsyncCollectionResultOfT(_ruleSetsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new FrontDoorRuleSetResource(Client, data));
        }
        ...
        public virtual Pageable<FrontDoorRuleSetResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<FrontDoorRuleSetData, FrontDoorRuleSetResource>(new RuleSetsGetByProfileCollectionResultOfT(_ruleSetsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new FrontDoorRuleSetResource(Client, data));
        }
