...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class CdnCustomDomainResource : ArmResource
    {
        ...
        internal CdnCustomDomainResource(ArmClient client, CdnCustomDomainData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CdnCustomDomainResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CdnCustomDomainResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
