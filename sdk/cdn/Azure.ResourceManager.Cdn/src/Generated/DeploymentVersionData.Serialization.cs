...
{
    public partial class DeploymentVersionData : IUtf8JsonSerializable, IJsonModel<DeploymentVersionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeploymentVersionData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeploymentVersionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        DeploymentVersionData IJsonModel<DeploymentVersionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeploymentVersionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static DeploymentVersionData DeserializeDeploymentVersionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("approvedAt"u8))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            }
                            approvedAt = property0.Value.GetDateTimeOffset("O");
                            continue;
                        }
                        if (property0.NameEquals("approvalStatus"u8))
                        {
                            if (property0.Value.ValueKind == JsonValueKind.Null)
                            {
                                continue;
                            }
                            approvalStatus = new ApprovalStatus(property0.Value.GetString());
                            continue;
                        }
                        if (property0.NameEquals("stages"u8))
                        {
                            ...
                            stages = DeploymentStages.DeserializeDeploymentStages(property0.Value, options);
                            continue;
                        }
                    }
                    continue;
        ...
        BinaryData IPersistableModel<DeploymentVersionData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeploymentVersionData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        DeploymentVersionData IPersistableModel<DeploymentVersionData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeploymentVersionData>)this).GetFormatFromOptions(options) : options.Format;
