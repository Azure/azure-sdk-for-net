...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public static partial class ArmCdnModelFactory
    {
        ...
        /// <param name="enabledState"> Whether to enable use of this rule. Permitted values are 'Enabled' or 'Disabled'. </param>
        /// <param name="enforceMtls"> Set to Disabled by default. If set to Enabled, only custom domains with mTLS enabled can be added to child Route resources. </param>
        /// <returns> A new <see cref="Models.FrontDoorEndpointUpdateParameters"/> instance for mocking. </returns>
        public static FrontDoorEndpointUpdateParameters FrontDoorEndpointUpdateParameters(IDictionary<string, string> tags = default, string profileName = default, EnabledState? enabledState = default, EnforceMtlsEnabledState? enforceMtls = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();

            return new FrontDoorEndpointUpdateParameters(tags, profileName is null && enabledState is null && enforceMtls is null ? default : new FrontDoorEndpointPropertiesUpdateParameters(profileName, enabledState, enforceMtls, null), additionalBinaryDataProperties: null);
        }
