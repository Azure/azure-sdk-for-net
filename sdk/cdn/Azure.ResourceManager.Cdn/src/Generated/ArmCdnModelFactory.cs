...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public static partial class ArmCdnModelFactory
    {
        ...
        {
            return new EndpointNameAvailabilityContent(name, resourceType, autoGeneratedDomainNameLabelScope);
        }
        ...
        public static FrontDoorEndpointPatch FrontDoorEndpointPatch(IDictionary<string, string> tags = null, string profileName = null, EnabledState? enabledState = null)
        {
            ...
            return new FrontDoorEndpointPatch(tags, profileName, enabledState);
        }
        ...
        {
            return new FrontDoorOriginGroupPatch(profileName, loadBalancingSettings, healthProbeSettings, trafficRestorationTimeInMinutes, sessionAffinityState);
        }
        ...
        {
            return new FrontDoorOriginPatch(originGroupName, originId != null ? ResourceManagerModelFactory.WritableSubResource(originId) : null, hostName, httpPort, httpsPort, originHostHeader, priority, weight, sharedPrivateLinkResource, enabledState, enforceCertificateNameCheck);
        }
        ...
        public static FrontDoorRulePatch FrontDoorRulePatch(string ruleSetName = null, int? order = null, IEnumerable<DeliveryRuleCondition> conditions = null, IEnumerable<DeliveryRuleAction> actions = null, MatchProcessingBehavior? matchProcessingBehavior = null)
        {
            ...
            return new FrontDoorRulePatch(ruleSetName, order, conditions?.ToList(), actions?.ToList(), matchProcessingBehavior);
        }
