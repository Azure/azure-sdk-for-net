...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public static partial class ArmCdnModelFactory
    {
        ...
        {
            return new EndpointNameAvailabilityContent(name, resourceType, autoGeneratedDomainNameLabelScope, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EndpointNameAvailabilityResult(nameAvailable, availableHostname, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FrontDoorUsage(id, unit, currentValue, limit, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FrontDoorUsageResourceName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CdnNameAvailabilityResult(nameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DomainValidationProperties(validationToken, expiresOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static FrontDoorEndpointData FrontDoorEndpointData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string profileName = null, EnabledState? enabledState = null, FrontDoorProvisioningState? provisioningState = null, FrontDoorDeploymentStatus? deploymentStatus = null, string hostName = null, DomainNameLabelScope? autoGeneratedDomainNameLabelScope = null)
        {
            ...
            return new FrontDoorEndpointData(id, name, resourceType, systemData, tags, location, profileName, enabledState, provisioningState, deploymentStatus, hostName, autoGeneratedDomainNameLabelScope, new Dictionary<string, BinaryData>());
        }
        ...
        public static FrontDoorEndpointPatch FrontDoorEndpointPatch(IDictionary<string, string> tags = null, string profileName = null, EnabledState? enabledState = null)
        {
            ...
            return new FrontDoorEndpointPatch(tags, profileName, enabledState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ValidateCustomDomainResult(isCustomDomainValid, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FrontDoorOriginGroupData(id, name, resourceType, systemData, profileName, loadBalancingSettings, healthProbeSettings, trafficRestorationTimeInMinutes, sessionAffinityState, provisioningState, deploymentStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FrontDoorOriginGroupPatch(profileName, loadBalancingSettings, healthProbeSettings, trafficRestorationTimeInMinutes, sessionAffinityState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FrontDoorOriginPatch(originGroupName, originId != null ? ResourceManagerModelFactory.WritableSubResource(originId) : null, hostName, httpPort, httpsPort, originHostHeader, priority, weight, sharedPrivateLinkResource, enabledState, enforceCertificateNameCheck, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FrontDoorActivatedResourceInfo(id, isActive, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FrontDoorRuleSetData(id, name, resourceType, systemData, provisioningState, deploymentStatus, profileName, new Dictionary<string, BinaryData>());
        }
        ...
        public static FrontDoorRuleData FrontDoorRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string ruleSetName = null, int? order = null, IEnumerable<DeliveryRuleCondition> conditions = null, IEnumerable<DeliveryRuleAction> actions = null, MatchProcessingBehavior? matchProcessingBehavior = null, FrontDoorProvisioningState? provisioningState = null, FrontDoorDeploymentStatus? deploymentStatus = null)
        {
            ...
            return new FrontDoorRuleData(id, name, resourceType, systemData, ruleSetName, order, conditions?.ToList(), actions?.ToList(), matchProcessingBehavior, provisioningState, deploymentStatus, new Dictionary<string, BinaryData>());
        }
        ...
        public static FrontDoorRulePatch FrontDoorRulePatch(string ruleSetName = null, int? order = null, IEnumerable<DeliveryRuleCondition> conditions = null, IEnumerable<DeliveryRuleAction> actions = null, MatchProcessingBehavior? matchProcessingBehavior = null)
        {
            ...
            return new FrontDoorRulePatch(ruleSetName, order, conditions?.ToList(), actions?.ToList(), matchProcessingBehavior, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FrontDoorSecurityPolicyData(id, name, resourceType, systemData, provisioningState, deploymentStatus, profileName, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FrontDoorSecretData(id, name, resourceType, systemData, provisioningState, deploymentStatus, profileName, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MetricsResponse MetricsResponse(DateTimeOffset? dateTimeBegin = null, DateTimeOffset? dateTimeEnd = null, MetricsResponseGranularity? granularity = null, IEnumerable<MetricsResponseSeriesItem> series = null)
        {
            ...
            return new MetricsResponse(dateTimeBegin, dateTimeEnd, granularity, series?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MetricsResponseSeriesItem MetricsResponseSeriesItem(string metric = null, MetricsResponseSeriesItemUnit? unit = null, IEnumerable<MetricsResponseSeriesPropertiesItemsItem> groups = null, IEnumerable<Components1Gs0LlpSchemasMetricsresponsePropertiesSeriesItemsPropertiesDataItems> data = null)
        {
            ...
            return new MetricsResponseSeriesItem(metric, unit, groups?.ToList(), data?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MetricsResponseSeriesPropertiesItemsItem(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new Components1Gs0LlpSchemasMetricsresponsePropertiesSeriesItemsPropertiesDataItems(dateOn, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static RankingsResponse RankingsResponse(DateTimeOffset? dateTimeBegin = null, DateTimeOffset? dateTimeEnd = null, IEnumerable<RankingsResponseTablesItem> tables = null)
        {
            ...
            return new RankingsResponse(dateTimeBegin, dateTimeEnd, tables?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static RankingsResponseTablesItem RankingsResponseTablesItem(string ranking = null, IEnumerable<RankingsResponseTablesPropertiesItemsItem> data = null)
        {
            ...
            return new RankingsResponseTablesItem(ranking, data?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static RankingsResponseTablesPropertiesItemsItem RankingsResponseTablesPropertiesItemsItem(string name = null, IEnumerable<RankingsResponseTablesPropertiesItemsMetricsItem> metrics = null)
        {
            ...
            return new RankingsResponseTablesPropertiesItemsItem(name, metrics?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RankingsResponseTablesPropertiesItemsMetricsItem(metric, value, percentage, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContinentsResponse ContinentsResponse(IEnumerable<ContinentsResponseContinentsItem> continents = null, IEnumerable<ContinentsResponseCountryOrRegionsItem> countryOrRegions = null)
        {
            ...
            return new ContinentsResponse(continents?.ToList(), countryOrRegions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContinentsResponseContinentsItem(id, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContinentsResponseCountryOrRegionsItem(id, continentId, new Dictionary<string, BinaryData>());
        }
        ...
        public static ResourcesResponse ResourcesResponse(IEnumerable<ResourcesResponseEndpointsItem> endpoints = null, IEnumerable<ResourcesResponseCustomDomainsItem> customDomains = null)
        {
            ...
            return new ResourcesResponse(endpoints?.ToList(), customDomains?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ResourcesResponseEndpointsItem ResourcesResponseEndpointsItem(string id = null, string name = null, bool? history = null, IEnumerable<ResourcesResponseEndpointsPropertiesItemsItem> customDomains = null)
        {
            ...
            return new ResourcesResponseEndpointsItem(id, name, history, customDomains?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourcesResponseEndpointsPropertiesItemsItem(id, name, endpointId, history, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourcesResponseCustomDomainsItem(id, name, endpointId, history, new Dictionary<string, BinaryData>());
        }
        ...
        public static WafMetricsResponse WafMetricsResponse(DateTimeOffset? dateTimeBegin = null, DateTimeOffset? dateTimeEnd = null, WafMetricsResponseGranularity? granularity = null, IEnumerable<WafMetricsResponseSeriesItem> series = null)
        {
            ...
            return new WafMetricsResponse(dateTimeBegin, dateTimeEnd, granularity, series?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static WafMetricsResponseSeriesItem WafMetricsResponseSeriesItem(string metric = null, WafMetricsResponseSeriesItemUnit? unit = null, IEnumerable<WafMetricsResponseSeriesPropertiesItemsItem> groups = null, IEnumerable<Components18OrqelSchemasWafmetricsresponsePropertiesSeriesItemsPropertiesDataItems> data = null)
        {
            ...
            return new WafMetricsResponseSeriesItem(metric, unit, groups?.ToList(), data?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new WafMetricsResponseSeriesPropertiesItemsItem(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new Components18OrqelSchemasWafmetricsresponsePropertiesSeriesItemsPropertiesDataItems(dateOn, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static WafRankingsResponse WafRankingsResponse(DateTimeOffset? dateTimeBegin = null, DateTimeOffset? dateTimeEnd = null, IEnumerable<string> groups = null, IEnumerable<WafRankingsResponseDataItem> data = null)
        {
            ...
            return new WafRankingsResponse(dateTimeBegin, dateTimeEnd, groups?.ToList(), data?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static WafRankingsResponseDataItem WafRankingsResponseDataItem(IEnumerable<string> groupValues = null, IEnumerable<ComponentsKpo1PjSchemasWafrankingsresponsePropertiesDataItemsPropertiesMetricsItems> metrics = null)
        {
            ...
            return new WafRankingsResponseDataItem(groupValues?.ToList(), metrics?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ComponentsKpo1PjSchemasWafrankingsresponsePropertiesDataItemsPropertiesMetricsItems(metric, value, percentage, new Dictionary<string, BinaryData>());
        }
        ...
        public static ProfileData ProfileData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, CdnSkuName? skuName = null, string kind = null, ProfileResourceState? resourceState = null, ProfileProvisioningState? provisioningState = null, Guid? frontDoorId = null, int? originResponseTimeoutSeconds = null)
        {
            ...
            return new ProfileData(id, name, resourceType, systemData, tags, location, skuName != null ? new CdnSku(skuName, new Dictionary<string, BinaryData>()) : null, kind, resourceState, provisioningState, frontDoorId, originResponseTimeoutSeconds, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SsoUri(availableSsoUri, new Dictionary<string, BinaryData>());
        }
        ...
        public static SupportedOptimizationTypesListResult SupportedOptimizationTypesListResult(IEnumerable<OptimizationType> supportedOptimizationTypes = null)
        {
            ...
            return new SupportedOptimizationTypesListResult(supportedOptimizationTypes?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CdnUsage(resourceType, unit, currentValue, limit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DeepCreatedOrigin(name, hostName, httpPort, httpsPort, originHostHeader, priority, weight, enabled, privateLinkAlias, privateLinkResourceId, privateLinkLocation, privateLinkApprovalMessage, privateEndpointStatus, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CdnCustomDomainData(id, name, resourceType, systemData, hostName, resourceState, customHttpsProvisioningState, customHttpsAvailabilityState, customDomainHttpsContent, validationData, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CdnOriginData(id, name, resourceType, systemData, hostName, httpPort, httpsPort, originHostHeader, priority, weight, enabled, privateLinkAlias, privateLinkResourceId, privateLinkLocation, privateLinkApprovalMessage, resourceState, provisioningState, privateEndpointStatus, new Dictionary<string, BinaryData>());
        }
        ...
        public static CdnOriginGroupData CdnOriginGroupData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, HealthProbeSettings healthProbeSettings = null, IEnumerable<WritableSubResource> origins = null, int? trafficRestorationTimeToHealedOrNewEndpointsInMinutes = null, ResponseBasedOriginErrorDetectionSettings responseBasedOriginErrorDetectionSettings = null, OriginGroupResourceState? resourceState = null, OriginGroupProvisioningState? provisioningState = null)
        {
            ...
            return new CdnOriginGroupData(id, name, resourceType, systemData, healthProbeSettings, origins?.ToList(), trafficRestorationTimeToHealedOrNewEndpointsInMinutes, responseBasedOriginErrorDetectionSettings, resourceState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ValidateProbeResult(isValid, errorCode, message, new Dictionary<string, BinaryData>());
        }
        ...
        public static EdgeNode EdgeNode(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<IPAddressGroup> ipAddressGroups = null)
        {
            ...
            return new EdgeNode(id, name, resourceType, systemData, ipAddressGroups?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static CdnWebApplicationFirewallPolicyData CdnWebApplicationFirewallPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ETag? etag = null, CdnSkuName? skuName = null, WafPolicySettings policySettings = null, IEnumerable<RateLimitRule> rateLimitRules = null, IEnumerable<CustomRule> customRules = null, IEnumerable<WafPolicyManagedRuleSet> managedRuleSets = null, IEnumerable<SubResource> endpointLinks = null, WebApplicationFirewallPolicyProvisioningState? provisioningState = null, PolicyResourceState? resourceState = null)
        {
            ...
            return new CdnWebApplicationFirewallPolicyData(id, name, resourceType, systemData, tags, location, etag, skuName != null ? new CdnSku(skuName, new Dictionary<string, BinaryData>()) : null, policySettings, rateLimitRules != null ? new RateLimitRuleList(rateLimitRules?.ToList(), new Dictionary<string, BinaryData>()) : null, customRules != null ? new CustomRuleList(customRules?.ToList(), new Dictionary<string, BinaryData>()) : null, managedRuleSets != null ? new ManagedRuleSetList(managedRuleSets?.ToList(), new Dictionary<string, BinaryData>()) : null, endpointLinks?.ToList(), provisioningState, resourceState, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedRuleSetDefinition ManagedRuleSetDefinition(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, CdnSkuName? skuName = null, string provisioningState = null, string ruleSetType = null, string ruleSetVersion = null, IEnumerable<ManagedRuleGroupDefinition> ruleGroups = null)
        {
            ...
            return new ManagedRuleSetDefinition(id, name, resourceType, systemData, skuName != null ? new CdnSku(skuName, new Dictionary<string, BinaryData>()) : null, provisioningState, ruleSetType, ruleSetVersion, ruleGroups?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedRuleDefinition(ruleId, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ManagedCertificateProperties(SecretType.ManagedCertificate, new Dictionary<string, BinaryData>(), subject, expiresOn);
        }
        ...
        public static CustomerCertificateProperties CustomerCertificateProperties(ResourceIdentifier secretSourceId = null, string secretVersion = null, bool? useLatestVersion = null, string subject = null, DateTimeOffset? expiresOn = null, string certificateAuthority = null, IEnumerable<string> subjectAlternativeNames = null, string thumbprint = null)
        {
            ...
            return new CustomerCertificateProperties(SecretType.CustomerCertificate, new Dictionary<string, BinaryData>(), secretSourceId != null ? ResourceManagerModelFactory.WritableSubResource(secretSourceId) : null, secretVersion, useLatestVersion, subject, expiresOn, certificateAuthority, subjectAlternativeNames?.ToList(), thumbprint);
        }
    }
}
