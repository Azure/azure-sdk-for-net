...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class FrontDoorOriginCollection : ArmCollection, IEnumerable<FrontDoorOriginResource>, IAsyncEnumerable<FrontDoorOriginResource>
    {
        ...
        public virtual async Task<ArmOperation<FrontDoorOriginResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string originName, FrontDoorOriginData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _frontDoorOriginRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, originName, data);
                var response = await _frontDoorOriginRestClient.CreateAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<FrontDoorOriginResource> CreateOrUpdate(WaitUntil waitUntil, string originName, FrontDoorOriginData data, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _frontDoorOriginRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, originName, data);
                var response = _frontDoorOriginRestClient.Create(message, cancellationToken);
                var operation = new CdnArmOperation<FrontDoorOriginResource>(new FrontDoorOriginOperationSource(Client), _frontDoorOriginClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
