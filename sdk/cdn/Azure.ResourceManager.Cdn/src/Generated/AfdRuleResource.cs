...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class AfdRuleResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AfdRuleResource>> UpdateAsync(WaitUntil waitUntil, AfdRulePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _afdRuleRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
