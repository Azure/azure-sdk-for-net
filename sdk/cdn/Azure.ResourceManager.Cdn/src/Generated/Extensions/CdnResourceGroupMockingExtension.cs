...
namespace Azure.ResourceManager.Cdn.Mocking
{
    ...
    internal partial class CdnResourceGroupMockingExtension : ArmResource
    {
        private ClientDiagnostics _defaultClientDiagnostics;
        private CdnManagementRestOperations _defaultRestClient;

        /// <summary> Initializes a new instance of the <see cref="CdnResourceGroupMockingExtension"/> class for mocking. </summary>
        protected CdnResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CdnResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CdnResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("CdnResourceGroupMockingExtension.CheckEndpointNameAvailability");
            scope.Start();
            try
            {
