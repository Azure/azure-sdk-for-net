...
namespace Azure.ResourceManager.Cdn.Mock
{
    ...
    public partial class CdnTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CdnTenantResourceExtension"/> class for mocking. </summary>
        protected CdnTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CdnTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CdnTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<CdnNameAvailabilityResult>> CheckCdnNameAvailabilityAsync(CdnNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DefaultClientDiagnostics.CreateScope("CdnTenantResourceExtension.CheckCdnNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<EdgeNode> GetEdgeNodesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, EdgeNode.DeserializeEdgeNode, EdgeNodesClientDiagnostics, Pipeline, "CdnTenantResourceExtension.GetEdgeNodes", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<EdgeNode> GetEdgeNodes(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => EdgeNodesRestClient.CreateListRequest();
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => EdgeNodesRestClient.CreateListNextPageRequest(nextLink);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, EdgeNode.DeserializeEdgeNode, EdgeNodesClientDiagnostics, Pipeline, "CdnTenantResourceExtension.GetEdgeNodes", "value", "nextLink", cancellationToken);
        }
    }
}
