...
namespace Azure.ResourceManager.Cdn.Mock
{
    ...
    public partial class TenantResourceExtension : ArmResource
    {
        ...
        private ClientDiagnostics EdgeNodesClientDiagnostics => _edgeNodesClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Cdn.Mock", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual async Task<Response<CdnNameAvailabilityResult>> CheckCdnNameAvailabilityAsync(CdnNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DefaultClientDiagnostics.CreateScope("TenantResourceExtension.CheckCdnNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<EdgeNode> GetEdgeNodesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, EdgeNode.DeserializeEdgeNode, EdgeNodesClientDiagnostics, Pipeline, "TenantResourceExtension.GetEdgeNodes", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<EdgeNode> GetEdgeNodes(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => EdgeNodesRestClient.CreateListRequest();
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => EdgeNodesRestClient.CreateListNextPageRequest(nextLink);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, EdgeNode.DeserializeEdgeNode, EdgeNodesClientDiagnostics, Pipeline, "TenantResourceExtension.GetEdgeNodes", "value", "nextLink", cancellationToken);
        }
    }
}
