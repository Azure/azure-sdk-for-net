...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class FrontDoorEndpointCollection : ArmCollection, IEnumerable<FrontDoorEndpointResource>, IAsyncEnumerable<FrontDoorEndpointResource>
    {
        ...
        internal FrontDoorEndpointCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _afdEndpointsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Cdn", FrontDoorEndpointResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<FrontDoorEndpointResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string endpointName, FrontDoorEndpointData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _afdEndpointsClientDiagnostics.CreateScope("FrontDoorEndpointCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _afdEndpointsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, endpointName, FrontDoorEndpointData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<FrontDoorEndpointResource>> GetAsync(string endpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _afdEndpointsClientDiagnostics.CreateScope("FrontDoorEndpointCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _afdEndpointsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, endpointName, context);
        ...
        public virtual AsyncPageable<FrontDoorEndpointResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<FrontDoorEndpointData, FrontDoorEndpointResource>(new AFDEndpointsGetByProfileAsyncCollectionResultOfT(_afdEndpointsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new FrontDoorEndpointResource(Client, data));
        }
        ...
        public virtual Pageable<FrontDoorEndpointResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<FrontDoorEndpointData, FrontDoorEndpointResource>(new AFDEndpointsGetByProfileCollectionResultOfT(_afdEndpointsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new FrontDoorEndpointResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string endpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _afdEndpointsClientDiagnostics.CreateScope("FrontDoorEndpointCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<FrontDoorEndpointResource>> GetIfExistsAsync(string endpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _afdEndpointsClientDiagnostics.CreateScope("FrontDoorEndpointCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
