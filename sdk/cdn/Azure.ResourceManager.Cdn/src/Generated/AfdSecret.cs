...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class AfdSecret : ArmResource
    {
        ...
        internal AfdSecret(ArmResource options, AfdSecretData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        public static readonly Azure.Core.ResourceType ResourceType = "Microsoft.Cdn/profiles/secrets";
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("AfdSecret.GetAvailableLocations");
            scope.Start();
            try
            {
