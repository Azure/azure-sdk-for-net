...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class AfdSecret : ArmResource
    {
        ...
        internal AfdSecret(ArmResource options, AfdSecretData resource) : base(options, resource.Id)
        {
            ...
            _secretsRestClient = new SecretsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<AfdSecret>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _secretsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AfdSecret> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _secretsRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<SecretDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _secretsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new SecretDeleteOperation(_clientDiagnostics, Pipeline, _secretsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual SecretDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _secretsRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new SecretDeleteOperation(_clientDiagnostics, Pipeline, _secretsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
