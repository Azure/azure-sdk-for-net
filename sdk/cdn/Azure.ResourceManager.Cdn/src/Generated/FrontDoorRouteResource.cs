...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class FrontDoorRouteResource : ArmResource
    {
        ...
        internal FrontDoorRouteResource(ArmClient client, FrontDoorRouteData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<FrontDoorRouteResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new FrontDoorRouteResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
