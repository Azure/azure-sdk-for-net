...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class FrontDoorRouteResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<FrontDoorRouteResource>> UpdateAsync(WaitUntil waitUntil, FrontDoorRoutePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                CdnArmOperation<FrontDoorRouteResource> operation = new CdnArmOperation<FrontDoorRouteResource>(
                    new FrontDoorRouteResourceOperationSource(Client),
        ...
        public virtual async Task<ArmOperation<FrontDoorRouteResource>> UpdateAsync(WaitUntil waitUntil, FrontDoorRouteData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _routesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, FrontDoorRouteData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CdnArmOperation<FrontDoorRouteResource> operation = new CdnArmOperation<FrontDoorRouteResource>(
                    new FrontDoorRouteResourceOperationSource(Client),
                    _routesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<FrontDoorRouteResource> Update(WaitUntil waitUntil, FrontDoorRouteData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
