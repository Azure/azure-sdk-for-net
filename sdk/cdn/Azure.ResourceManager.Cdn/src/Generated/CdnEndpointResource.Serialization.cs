...
namespace Azure.ResourceManager.Cdn
{
    ...
    {
        private static IJsonModel<CdnEndpointData> s_dataDeserializationInstance;

        private static IJsonModel<CdnEndpointData> DataDeserializationInstance => s_dataDeserializationInstance ??= new CdnEndpointData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CdnEndpointData IJsonModel<CdnEndpointData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<CdnEndpointData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
