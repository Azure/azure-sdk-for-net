...
namespace Azure.ResourceManager.Cdn
{
...

    {
        ...
        public virtual SecretCreateOperation CreateOrUpdate(string secretName, AfdSecretData secret, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (secretName == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="secretName"/> or <paramref name="secret"/> is null. </exception>
        public async virtual Task<SecretCreateOperation> CreateOrUpdateAsync(string secretName, AfdSecretData secret, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (secretName == null)
            {
                throw new ArgumentNullException(nameof(secretName));
