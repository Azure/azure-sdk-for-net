...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class AfdRuleSetResource : ArmResource
    {
        ...
        public virtual AsyncPageable<CdnUsage> GetResourceUsageUnderAfdRuleSetAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<CdnUsage>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _afdRuleSetClientDiagnostics.CreateScope("AfdRuleSetResource.GetResourceUsageUnderAfdRuleSet");
                scope.Start();
                try
                {
        ...
        public virtual Pageable<CdnUsage> GetResourceUsageUnderAfdRuleSet(CancellationToken cancellationToken = default)
        {
