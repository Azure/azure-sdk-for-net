...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class ProfileResource : ArmResource
    {
        ...
        internal ProfileResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _logAnalyticsRestClient = new LogAnalytics(_logAnalyticsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, profileApiVersion ?? "2025-09-01-preview");
        ...
        public virtual async Task<ArmOperation<ProfileResource>> UpdateAsync(WaitUntil waitUntil, ProfileData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _profilesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ProfileData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CdnArmOperation<ProfileResource> operation = new CdnArmOperation<ProfileResource>(
                    new ProfileResourceOperationSource(Client),
                    _profilesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ProfileResource> Update(WaitUntil waitUntil, ProfileData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
