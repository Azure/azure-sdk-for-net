...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class CdnOriginResource : ArmResource
    {
        ...
        internal CdnOriginResource(ArmClient client, CdnOriginData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CdnOriginResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CdnOriginResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
