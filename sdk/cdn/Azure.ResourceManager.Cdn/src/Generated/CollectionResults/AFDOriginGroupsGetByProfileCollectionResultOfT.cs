...
namespace Azure.ResourceManager.Cdn
{
    internal partial class AFDOriginGroupsGetByProfileCollectionResultOfT : Pageable<FrontDoorOriginGroupData>
    {
        ...
        public AFDOriginGroupsGetByProfileCollectionResultOfT(AFDOriginGroups client, Guid subscriptionId, string resourceGroupName, string profileName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("FrontDoorOriginGroupCollection.GetAll");
            scope.Start();
            try
            {
