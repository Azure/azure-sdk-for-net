...
namespace Azure.ResourceManager.Cdn
{
    internal partial class ManagedRuleSetsGetManagedRuleSetsCollectionResultOfT : Pageable<ManagedRuleSetDefinition>
    {
        ...
        public ManagedRuleSetsGetManagedRuleSetsCollectionResultOfT(ManagedRuleSets client, Guid subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<ManagedRuleSetDefinition>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ManagedRuleSetDefinition>.FromValues((IReadOnlyList<ManagedRuleSetDefinition>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableCdnSubscriptionResource.GetManagedRuleSets");
            scope.Start();
            try
            {
