...
{
    internal partial class RuleSetsGetResourceUsagesAsyncCollectionResultOfT : AsyncPageable<FrontDoorUsage>
    {
        ...
        /// <summary> Initializes a new instance of RuleSetsGetResourceUsagesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RuleSetsGetResourceUsagesAsyncCollectionResultOfT(RuleSets client, Guid subscriptionId, string resourceGroupName, string profileName, string ruleSetName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of RuleSetsGetResourceUsagesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of RuleSetsGetResourceUsagesAsyncCollectionResultOfT as an enumerable collection. </returns>
