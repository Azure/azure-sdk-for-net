...
namespace Azure.ResourceManager.Cdn
{
    internal partial class RuleSetsGetResourceUsagesAsyncCollectionResultOfT : AsyncPageable<FrontDoorUsage>
    {
        ...
        public RuleSetsGetResourceUsagesAsyncCollectionResultOfT(RuleSets client, Guid subscriptionId, string resourceGroupName, string profileName, string ruleSetName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
