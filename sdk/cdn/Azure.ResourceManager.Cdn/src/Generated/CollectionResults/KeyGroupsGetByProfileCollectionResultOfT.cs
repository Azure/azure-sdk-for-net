...
namespace Azure.ResourceManager.Cdn
{
    internal partial class KeyGroupsGetByProfileCollectionResultOfT : Pageable<CdnKeyGroupData>
    {
        ...
        /// <summary> Initializes a new instance of KeyGroupsGetByProfileCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public KeyGroupsGetByProfileCollectionResultOfT(KeyGroups client, Guid subscriptionId, string resourceGroupName, string profileName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of KeyGroupsGetByProfileCollectionResultOfT as an enumerable collection. </summary>
