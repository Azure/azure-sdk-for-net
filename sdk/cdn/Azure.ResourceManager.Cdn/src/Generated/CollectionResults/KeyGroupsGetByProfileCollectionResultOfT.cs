...
namespace Azure.ResourceManager.Cdn
{
    internal partial class KeyGroupsGetByProfileCollectionResultOfT : Pageable<KeyGroupData>
    {
        ...
        public KeyGroupsGetByProfileCollectionResultOfT(KeyGroups client, Guid subscriptionId, string resourceGroupName, string profileName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
