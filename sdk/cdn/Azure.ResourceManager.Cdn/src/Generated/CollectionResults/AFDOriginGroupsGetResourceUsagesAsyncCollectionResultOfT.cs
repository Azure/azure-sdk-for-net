...
namespace Azure.ResourceManager.Cdn
{
    internal partial class AFDOriginGroupsGetResourceUsagesAsyncCollectionResultOfT : AsyncPageable<FrontDoorUsage>
    {
        ...
        public AFDOriginGroupsGetResourceUsagesAsyncCollectionResultOfT(AFDOriginGroups client, Guid subscriptionId, string resourceGroupName, string profileName, string originGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
