...
namespace Azure.ResourceManager.Cdn
{
    internal partial class AFDEndpointsGetResourceUsagesCollectionResultOfT : Pageable<FrontDoorUsage>
    {
        ...
        public AFDEndpointsGetResourceUsagesCollectionResultOfT(AFDEndpoints client, Guid subscriptionId, string resourceGroupName, string profileName, string endpointName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
