...
{
    internal partial class AFDEndpointsGetResourceUsagesCollectionResultOfT : Pageable<FrontDoorUsage>
    {
        ...
        /// <summary> Initializes a new instance of AFDEndpointsGetResourceUsagesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AFDEndpointsGetResourceUsagesCollectionResultOfT(AFDEndpoints client, Guid subscriptionId, string resourceGroupName, string profileName, string endpointName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AFDEndpointsGetResourceUsagesCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AFDEndpointsGetResourceUsagesCollectionResultOfT as an enumerable collection. </returns>
