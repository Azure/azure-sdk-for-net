...
namespace Azure.ResourceManager.Cdn
{
    internal partial class OriginGroupsGetByEndpointAsyncCollectionResultOfT : AsyncPageable<CdnOriginGroupData>
    {
        ...
        public OriginGroupsGetByEndpointAsyncCollectionResultOfT(OriginGroups client, Guid subscriptionId, string resourceGroupName, string profileName, string endpointName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
