...
namespace Azure.ResourceManager.Cdn
{
    internal partial class AFDEndpointsGetResourceUsagesAsyncCollectionResultOfT : AsyncPageable<FrontDoorUsage>
    {
        ...
        public AFDEndpointsGetResourceUsagesAsyncCollectionResultOfT(AFDEndpoints client, Guid subscriptionId, string resourceGroupName, string profileName, string endpointName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("FrontDoorEndpointResource.GetResourceUsages");
            scope.Start();
            try
            {
