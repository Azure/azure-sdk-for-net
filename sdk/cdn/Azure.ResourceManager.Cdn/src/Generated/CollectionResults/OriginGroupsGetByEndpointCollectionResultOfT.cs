...
{
    internal partial class OriginGroupsGetByEndpointCollectionResultOfT : Pageable<CdnOriginGroupData>
    {
        ...
        /// <returns> The pages of OriginGroupsGetByEndpointCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<CdnOriginGroupData>> AsPages(string continuationToken, int? pageSizeHint)
        {
