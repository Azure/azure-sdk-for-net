...
{
    /// <summary></summary>
    internal partial class FrontDoorCustomDomainResourceOperationSource : IOperationSource<FrontDoorCustomDomainResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal FrontDoorCustomDomainResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
