...
{
    /// <summary></summary>
    internal partial class FrontDoorRuleResourceOperationSource : IOperationSource<FrontDoorRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal FrontDoorRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
