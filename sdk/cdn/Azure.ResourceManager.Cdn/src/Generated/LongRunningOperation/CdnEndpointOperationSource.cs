...
{
    /// <summary></summary>
    internal partial class CdnEndpointOperationSource : IOperationSource<CdnEndpointResource>
    {
        ...
        CdnEndpointResource IOperationSource<CdnEndpointResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CdnEndpointData data = CdnEndpointData.DeserializeCdnEndpointData(document.RootElement, ModelSerializationExtensions.WireOptions);
