...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class AfdSecurityPolicyCreateOperation : Operation<AfdSecurityPolicy>, IOperationSource<AfdSecurityPolicy>
    {
        private readonly OperationInternals<AfdSecurityPolicy> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of AfdSecurityPolicyCreateOperation for mocking. </summary>
        protected AfdSecurityPolicyCreateOperation()
        {
        }

        internal AfdSecurityPolicyCreateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<AfdSecurityPolicy>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "AfdSecurityPolicyCreateOperation");
