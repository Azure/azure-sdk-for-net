...
#pragma warning disable SA1649 // File name should match first type name
    internal class CdnArmInterimOperation<T> : CdnArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal CdnArmInterimOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia) : base(source, clientDiagnostics, pipeline, request, response, finalStateVia)
        {
