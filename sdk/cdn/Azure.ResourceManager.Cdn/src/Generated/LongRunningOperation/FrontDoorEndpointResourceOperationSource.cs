...
{
    /// <summary></summary>
    internal partial class FrontDoorEndpointResourceOperationSource : IOperationSource<FrontDoorEndpointResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal FrontDoorEndpointResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
