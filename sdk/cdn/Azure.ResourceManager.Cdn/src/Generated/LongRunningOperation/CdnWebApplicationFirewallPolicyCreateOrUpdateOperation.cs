...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class CdnWebApplicationFirewallPolicyCreateOrUpdateOperation : Operation<CdnWebApplicationFirewallPolicy>, IOperationSource<CdnWebApplicationFirewallPolicy>
    {
        private readonly OperationInternals<CdnWebApplicationFirewallPolicy> _operation;

        private readonly ArmClient _armClient;

        /// <summary> Initializes a new instance of CdnWebApplicationFirewallPolicyCreateOrUpdateOperation for mocking. </summary>
        protected CdnWebApplicationFirewallPolicyCreateOrUpdateOperation()
        {
        }

        internal CdnWebApplicationFirewallPolicyCreateOrUpdateOperation(ArmClient armClient, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<CdnWebApplicationFirewallPolicy>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CdnWebApplicationFirewallPolicyCreateOrUpdateOperation");
        ...
        CdnWebApplicationFirewallPolicy IOperationSource<CdnWebApplicationFirewallPolicy>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new CdnWebApplicationFirewallPolicy(_armClient, data);
        }
