...
{
    /// <summary></summary>
    internal partial class CdnWebApplicationFirewallPolicyResourceOperationSource : IOperationSource<CdnWebApplicationFirewallPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CdnWebApplicationFirewallPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
