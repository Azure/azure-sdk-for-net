...
{
    /// <summary></summary>
    internal partial class FrontDoorRouteResourceOperationSource : IOperationSource<FrontDoorRouteResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal FrontDoorRouteResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
