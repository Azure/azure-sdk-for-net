...
namespace Azure.ResourceManager.Cdn.Models
{
    ...
    public partial class AfdRuleSetCreateOrUpdateOperation : Operation<AfdRuleSet>
    {
        ...
        internal AfdRuleSetCreateOrUpdateOperation(ArmClient armClient, Response<AfdRuleSetData> response)
        {
            _operation = new OperationOrResponseInternals<AfdRuleSet>(Response.FromValue(new AfdRuleSet(armClient, response.Value), response.GetRawResponse()));
        }
