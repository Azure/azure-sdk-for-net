...
{
    /// <summary></summary>
    internal partial class CdnCustomDomainResourceOperationSource : IOperationSource<CdnCustomDomainResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CdnCustomDomainResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
