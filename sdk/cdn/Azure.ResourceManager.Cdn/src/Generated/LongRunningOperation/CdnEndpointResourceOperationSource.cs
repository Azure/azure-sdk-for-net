...
{
    /// <summary></summary>
    internal partial class CdnEndpointResourceOperationSource : IOperationSource<CdnEndpointResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CdnEndpointResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
