...
namespace Azure.ResourceManager.Cdn
{
...

    {
        ...
        internal AfdRouteCollection(ArmResource parent) : base(parent)
        {
            ...
            _afdRoutesRestClient = new AfdRoutesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual AfdRouteCreateOperation CreateOrUpdate(string routeName, AfdRouteData route, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _afdRoutesRestClient.Create(Id.ResourceGroupName, Id.Parent.Name, Id.Name, routeName, route, cancellationToken);
                var operation = new AfdRouteCreateOperation(Parent, _clientDiagnostics, Pipeline, _afdRoutesRestClient.CreateCreateRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name, routeName, route).Request, response);
        ...
        public async virtual Task<AfdRouteCreateOperation> CreateOrUpdateAsync(string routeName, AfdRouteData route, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _afdRoutesRestClient.CreateAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, routeName, route, cancellationToken).ConfigureAwait(false);
                var operation = new AfdRouteCreateOperation(Parent, _clientDiagnostics, Pipeline, _afdRoutesRestClient.CreateCreateRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name, routeName, route).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<AfdRoute> Get(string routeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _afdRoutesRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, routeName, cancellationToken);
        ...
        public async virtual Task<Response<AfdRoute>> GetAsync(string routeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _afdRoutesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, routeName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<AfdRoute> GetIfExists(string routeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _afdRoutesRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, routeName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<AfdRoute>> GetIfExistsAsync(string routeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _afdRoutesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, routeName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<AfdRoute>(null, response.GetRawResponse())
                    : Response.FromValue(new AfdRoute(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Pageable<AfdRoute> GetAll(CancellationToken cancellationToken = default)
        {
            Page<AfdRoute> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _afdRoutesRestClient.ListByEndpoint(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<AfdRoute> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _afdRoutesRestClient.ListByEndpointNextPage(nextLink, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AfdRoute(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<AfdRoute> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<AfdRoute>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _afdRoutesRestClient.ListByEndpointAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AfdRoute(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<AfdRoute>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _afdRoutesRestClient.ListByEndpointNextPageAsync(nextLink, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AfdRoute(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
