...
namespace Azure.ResourceManager.Cdn
{
...

    {
        ...
        public virtual RouteCreateOperation CreateOrUpdate(string routeName, AfdRouteData route, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (routeName == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="routeName"/> or <paramref name="route"/> is null. </exception>
        public async virtual Task<RouteCreateOperation> CreateOrUpdateAsync(string routeName, AfdRouteData route, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (routeName == null)
            {
                throw new ArgumentNullException(nameof(routeName));
