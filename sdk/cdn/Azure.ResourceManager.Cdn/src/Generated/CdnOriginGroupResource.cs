...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class CdnOriginGroupResource : ArmResource
    {
        ...
        internal CdnOriginGroupResource(ArmClient client, CdnOriginGroupData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CdnOriginGroupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CdnOriginGroupResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
