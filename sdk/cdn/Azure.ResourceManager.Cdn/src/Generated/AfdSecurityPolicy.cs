...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class AfdSecurityPolicy : ArmResource
    {
        ...
        public async virtual Task<AfdSecurityPolicyUpdateOperation> UpdateAsync(bool waitForCompletion, SecurityPolicyUpdateOptions securityPolicyUpdateProperties, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _afdSecurityPoliciesRestClient.PatchAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, securityPolicyUpdateProperties, cancellationToken).ConfigureAwait(false);
                var operation = new AfdSecurityPolicyUpdateOperation(this, _clientDiagnostics, Pipeline, _afdSecurityPoliciesRestClient.CreatePatchRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, securityPolicyUpdateProperties).Request, response);
                if (waitForCompletion)
        ...
        public virtual AfdSecurityPolicyUpdateOperation Update(bool waitForCompletion, SecurityPolicyUpdateOptions securityPolicyUpdateProperties, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _afdSecurityPoliciesRestClient.Patch(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, securityPolicyUpdateProperties, cancellationToken);
                var operation = new AfdSecurityPolicyUpdateOperation(this, _clientDiagnostics, Pipeline, _afdSecurityPoliciesRestClient.CreatePatchRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, securityPolicyUpdateProperties).Request, response);
                if (waitForCompletion)
