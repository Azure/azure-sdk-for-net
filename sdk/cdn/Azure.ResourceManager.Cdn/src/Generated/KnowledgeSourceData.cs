...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class KnowledgeSourceData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="KnowledgeSourceData"/>. </summary>
        public KnowledgeSourceData()
        {
        }
        ...
        internal KnowledgeSourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, KnowledgeSourceProperties properties) : base(id, name, resourceType, systemData)
        {
