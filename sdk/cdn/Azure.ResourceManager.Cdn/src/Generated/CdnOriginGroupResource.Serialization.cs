...
namespace Azure.ResourceManager.Cdn
{
    public partial class CdnOriginGroupResource : IJsonModel<CdnOriginGroupData>
    {
        ...
        {
            return ModelReaderWriter.Read<CdnOriginGroupData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<CdnOriginGroupData>(data, options);
        }
