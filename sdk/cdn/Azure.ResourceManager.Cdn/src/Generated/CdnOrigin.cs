...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class CdnOrigin : ArmResource
    {
        ...
        public async virtual Task<CdnOriginUpdateOperation> UpdateAsync(bool waitForCompletion, CdnOriginUpdateOptions options, CancellationToken cancellationToken = default)
        {
            if (options == null)
            {
            ...
            try
            {
                ...
                var operation = new CdnOriginUpdateOperation(Client, _cdnOriginClientDiagnostics, Pipeline, _cdnOriginRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, options).Request, response);
                if (waitForCompletion)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="options"/> is null. </exception>
        public virtual CdnOriginUpdateOperation Update(bool waitForCompletion, CdnOriginUpdateOptions options, CancellationToken cancellationToken = default)
        {
            if (options == null)
            {
                throw new ArgumentNullException(nameof(options));
