...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class CdnWebApplicationFirewallPolicy : ArmResource
    {
        ...
        internal CdnWebApplicationFirewallPolicy(ArmResource options, CdnWebApplicationFirewallPolicyData resource) : base(options, resource.Id)
        {
            ...
            _policiesRestClient = new PoliciesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public async virtual Task<Response<CdnWebApplicationFirewallPolicy>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _policiesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CdnWebApplicationFirewallPolicy> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _policiesRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<PolicyDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _policiesRestClient.DeleteAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual PolicyDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _policiesRestClient.Delete(Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new PolicyDeleteOperation(response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<CdnWebApplicationFirewallPolicy>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = await _policiesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CdnWebApplicationFirewallPolicy> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _policiesRestClient.Get(Id.ResourceGroupName, Id.Name, cancellationToken);
                return Response.FromValue(new CdnWebApplicationFirewallPolicy(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public async virtual Task<PolicyUpdateOperation> UpdateAsync(CdnWebApplicationFirewallPolicyPatchParameters cdnWebApplicationFirewallPolicyPatchParameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _policiesRestClient.UpdateAsync(Id.ResourceGroupName, Id.Name, cdnWebApplicationFirewallPolicyPatchParameters, cancellationToken).ConfigureAwait(false);
                var operation = new PolicyUpdateOperation(this, _clientDiagnostics, Pipeline, _policiesRestClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Name, cdnWebApplicationFirewallPolicyPatchParameters).Request, response);
                if (waitForCompletion)
        ...
        public virtual PolicyUpdateOperation Update(CdnWebApplicationFirewallPolicyPatchParameters cdnWebApplicationFirewallPolicyPatchParameters, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _policiesRestClient.Update(Id.ResourceGroupName, Id.Name, cdnWebApplicationFirewallPolicyPatchParameters, cancellationToken);
                var operation = new PolicyUpdateOperation(this, _clientDiagnostics, Pipeline, _policiesRestClient.CreateUpdateRequest(Id.ResourceGroupName, Id.Name, cdnWebApplicationFirewallPolicyPatchParameters).Request, response);
                if (waitForCompletion)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
