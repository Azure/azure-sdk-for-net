...
namespace Azure.ResourceManager.Cdn
{
...

    {
        ...
        internal AfdRuleCollection(ArmResource parent) : base(parent)
        {
            ...
            _afdRulesRestClient = new AfdRulesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual AfdRuleCreateOperation CreateOrUpdate(string ruleName, AfdRuleData rule, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _afdRulesRestClient.Create(Id.ResourceGroupName, Id.Parent.Name, Id.Name, ruleName, rule, cancellationToken);
                var operation = new AfdRuleCreateOperation(Parent, _clientDiagnostics, Pipeline, _afdRulesRestClient.CreateCreateRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name, ruleName, rule).Request, response);
        ...
        public async virtual Task<AfdRuleCreateOperation> CreateOrUpdateAsync(string ruleName, AfdRuleData rule, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _afdRulesRestClient.CreateAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, ruleName, rule, cancellationToken).ConfigureAwait(false);
                var operation = new AfdRuleCreateOperation(Parent, _clientDiagnostics, Pipeline, _afdRulesRestClient.CreateCreateRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name, ruleName, rule).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<AfdRule> Get(string ruleName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _afdRulesRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, ruleName, cancellationToken);
        ...
        public async virtual Task<Response<AfdRule>> GetAsync(string ruleName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _afdRulesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, ruleName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<AfdRule> GetIfExists(string ruleName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _afdRulesRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, ruleName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<AfdRule>> GetIfExistsAsync(string ruleName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _afdRulesRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, ruleName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<AfdRule>(null, response.GetRawResponse())
                    : Response.FromValue(new AfdRule(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Pageable<AfdRule> GetAll(CancellationToken cancellationToken = default)
        {
            Page<AfdRule> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _afdRulesRestClient.ListByRuleSet(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<AfdRule> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _afdRulesRestClient.ListByRuleSetNextPage(nextLink, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AfdRule(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<AfdRule> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<AfdRule>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _afdRulesRestClient.ListByRuleSetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AfdRule(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<AfdRule>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _afdRulesRestClient.ListByRuleSetNextPageAsync(nextLink, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AfdRule(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
