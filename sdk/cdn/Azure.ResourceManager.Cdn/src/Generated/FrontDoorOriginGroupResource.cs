...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class FrontDoorOriginGroupResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _frontDoorOriginGroupRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = await _frontDoorOriginGroupRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new CdnArmOperation(_frontDoorOriginGroupClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _frontDoorOriginGroupRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = _frontDoorOriginGroupRestClient.Delete(message, cancellationToken);
                var operation = new CdnArmOperation(_frontDoorOriginGroupClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<FrontDoorOriginGroupResource>> UpdateAsync(WaitUntil waitUntil, FrontDoorOriginGroupPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _frontDoorOriginGroupRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch);
                var response = await _frontDoorOriginGroupRestClient.UpdateAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<FrontDoorOriginGroupResource> Update(WaitUntil waitUntil, FrontDoorOriginGroupPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _frontDoorOriginGroupRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch);
                var response = _frontDoorOriginGroupRestClient.Update(message, cancellationToken);
                var operation = new CdnArmOperation<FrontDoorOriginGroupResource>(new FrontDoorOriginGroupOperationSource(Client), _frontDoorOriginGroupClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
