...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class AfdSecretData : ResourceData
    {
        ...
        internal AfdSecretData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AfdProvisioningState? provisioningState, AfdDeploymentStatus? deploymentStatus, string profileName, SecretProperties parameters) : base(id, name, resourceType, systemData)
        {
        ...
        public SecretProperties Parameters { get; set; }
    }
}
