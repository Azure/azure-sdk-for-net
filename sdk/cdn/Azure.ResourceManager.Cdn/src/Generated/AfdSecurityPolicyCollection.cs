...
namespace Azure.ResourceManager.Cdn
{
...

    {
        ...
        public virtual SecurityPolicyCreateOperation CreateOrUpdate(string securityPolicyName, AfdSecurityPolicyData securityPolicy, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="securityPolicyName"/> or <paramref name="securityPolicy"/> is null. </exception>
        public async virtual Task<SecurityPolicyCreateOperation> CreateOrUpdateAsync(string securityPolicyName, AfdSecurityPolicyData securityPolicy, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (securityPolicyName == null)
            {
                throw new ArgumentNullException(nameof(securityPolicyName));
