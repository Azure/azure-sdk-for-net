...
namespace Azure.ResourceManager.Cdn
{
...

    {
        ...
        internal AfdSecurityPolicyCollection(ArmResource parent) : base(parent)
        {
            ...
            _afdSecurityPoliciesRestClient = new AfdSecurityPoliciesRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual AfdSecurityPolicyCreateOperation CreateOrUpdate(string securityPolicyName, AfdSecurityPolicyData securityPolicy, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _afdSecurityPoliciesRestClient.Create(Id.ResourceGroupName, Id.Name, securityPolicyName, securityPolicy, cancellationToken);
                var operation = new AfdSecurityPolicyCreateOperation(Parent, _clientDiagnostics, Pipeline, _afdSecurityPoliciesRestClient.CreateCreateRequest(Id.ResourceGroupName, Id.Name, securityPolicyName, securityPolicy).Request, response);
        ...
        public async virtual Task<AfdSecurityPolicyCreateOperation> CreateOrUpdateAsync(string securityPolicyName, AfdSecurityPolicyData securityPolicy, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _afdSecurityPoliciesRestClient.CreateAsync(Id.ResourceGroupName, Id.Name, securityPolicyName, securityPolicy, cancellationToken).ConfigureAwait(false);
                var operation = new AfdSecurityPolicyCreateOperation(Parent, _clientDiagnostics, Pipeline, _afdSecurityPoliciesRestClient.CreateCreateRequest(Id.ResourceGroupName, Id.Name, securityPolicyName, securityPolicy).Request, response);
                if (waitForCompletion)
        ...
        public virtual Response<AfdSecurityPolicy> Get(string securityPolicyName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _afdSecurityPoliciesRestClient.Get(Id.ResourceGroupName, Id.Name, securityPolicyName, cancellationToken);
        ...
        public async virtual Task<Response<AfdSecurityPolicy>> GetAsync(string securityPolicyName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _afdSecurityPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, securityPolicyName, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
        ...
        public virtual Response<AfdSecurityPolicy> GetIfExists(string securityPolicyName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _afdSecurityPoliciesRestClient.Get(Id.ResourceGroupName, Id.Name, securityPolicyName, cancellationToken: cancellationToken);
        ...
        public async virtual Task<Response<AfdSecurityPolicy>> GetIfExistsAsync(string securityPolicyName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _afdSecurityPoliciesRestClient.GetAsync(Id.ResourceGroupName, Id.Name, securityPolicyName, cancellationToken: cancellationToken).ConfigureAwait(false);
                return response.Value == null
                    ? Response.FromValue<AfdSecurityPolicy>(null, response.GetRawResponse())
                    : Response.FromValue(new AfdSecurityPolicy(this, response.Value), response.GetRawResponse());
            }
        ...
        public virtual Pageable<AfdSecurityPolicy> GetAll(CancellationToken cancellationToken = default)
        {
            Page<AfdSecurityPolicy> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _afdSecurityPoliciesRestClient.ListByProfile(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
            ...
            Page<AfdSecurityPolicy> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _afdSecurityPoliciesRestClient.ListByProfileNextPage(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AfdSecurityPolicy(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual AsyncPageable<AfdSecurityPolicy> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<AfdSecurityPolicy>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _afdSecurityPoliciesRestClient.ListByProfileAsync(Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AfdSecurityPolicy(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            async Task<Page<AfdSecurityPolicy>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _afdSecurityPoliciesRestClient.ListByProfileNextPageAsync(nextLink, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AfdSecurityPolicy(Parent, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
