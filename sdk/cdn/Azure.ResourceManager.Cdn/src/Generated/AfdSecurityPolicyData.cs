...
namespace Azure.ResourceManager.Cdn
{
    ...
    public partial class AfdSecurityPolicyData : ResourceData
    {
        ...
        internal AfdSecurityPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AfdProvisioningState? provisioningState, AfdDeploymentStatus? deploymentStatus, string profileName, SecurityPolicyProperties parameters) : base(id, name, resourceType, systemData)
        {
