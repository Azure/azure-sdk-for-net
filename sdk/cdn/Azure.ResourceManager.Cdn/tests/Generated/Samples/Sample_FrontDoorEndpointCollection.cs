...
namespace Azure.ResourceManager.Cdn.Samples
{
    public partial class Sample_FrontDoorEndpointCollection
    {
        ...
        public async Task CreateOrUpdate_AFDEndpointsCreate()
        {
            ...
            // this example is just showing the usage of "AFDEndpoints_Create" operation, for the dependent resources, they will have to be created separately.
            ...
            FrontDoorEndpointData data = new FrontDoorEndpointData(new AzureLocation("global"))
            {
        ...
        public async Task GetAll_AFDEndpointsListByProfile()
        {
            ...
            // this example is just showing the usage of "AFDEndpoints_ListByProfile" operation, for the dependent resources, they will have to be created separately.
