...
namespace Azure.ResourceManager.Cdn.Samples
{
    public partial class Sample_FrontDoorOriginGroupCollection
    {
        ...
        public async Task CreateOrUpdate_AFDOriginGroupsCreate()
        {
            ...
            // this example is just showing the usage of "AFDOriginGroups_Create" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/cdn/resource-manager/Microsoft.Cdn/stable/2025-06-01/examples/AFDOriginGroups_ListByProfile.json
            // this example is just showing the usage of "AFDOriginGroups_ListByProfile" operation, for the dependent resources, they will have to be created separately.
