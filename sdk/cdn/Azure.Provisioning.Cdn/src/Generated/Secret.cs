...
namespace Azure.Provisioning.Cdn
{
    ...
    public partial class Secret : ProvisionableResource
    {
        ...
        public Secret(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Cdn/profiles/secrets", resourceVersion ?? "2025-06-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Secret. </summary>
        ...
        /// <summary> Creates a reference to an existing Secret. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Secret FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Secret result = new Secret(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Secret that are not part of the generated code. </summary>
