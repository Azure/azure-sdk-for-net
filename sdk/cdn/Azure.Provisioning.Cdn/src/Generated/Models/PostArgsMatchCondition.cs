...
namespace Azure.Provisioning.Cdn
{
    ...
    public partial class PostArgsMatchCondition : DeliveryRuleConditionProperties
    {
        ...
        /// <summary> Gets or sets the PostArgsOperator. </summary>
        public BicepValue<PostArgsOperator> PostArgsOperator
        {
            get
            {
                Initialize();
                return _postArgsOperator;
            }
            set
            {
                Initialize();
                _postArgsOperator.Assign(value);
            }
        }
        ...
        /// <summary> Define all the provisionable properties for PostArgsMatchCondition. </summary>
        ...
        /// <summary> Define additional provisionable properties for PostArgsMatchCondition that are not part of the generated code. </summary>
