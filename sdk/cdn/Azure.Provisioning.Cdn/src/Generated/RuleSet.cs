...
namespace Azure.Provisioning.Cdn
{
    ...
    public partial class RuleSet : ProvisionableResource
    {
        private BicepValue<ResourceIdentifier> _id;
        private BicepValue<string> _name;
        private SystemData _systemData;
        private CdnRuleSetProperties _properties;
        private ResourceReference<CdnProfile> _parent;

        /// <summary> Creates a new RuleSet. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public RuleSet(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Cdn/profiles/ruleSets", resourceVersion ?? "2025-06-01")
        {
        }
        ...
        internal CdnRuleSetProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for RuleSet. </summary>
        ...
        /// <summary> Creates a reference to an existing RuleSet. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static RuleSet FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            RuleSet result = new RuleSet(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for RuleSet that are not part of the generated code. </summary>
