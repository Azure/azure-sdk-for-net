...
namespace Azure.Provisioning.Cdn
{
    ...
    public partial class AFDOrigin : ProvisionableResource
    {
        private BicepValue<ResourceIdentifier> _id;
        private BicepValue<string> _name;
        private SystemData _systemData;
        private FrontDoorOriginProperties _properties;
        private ResourceReference<AFDOriginGroup> _parent;

        /// <summary> Creates a new AFDOrigin. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public AFDOrigin(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Cdn/profiles/originGroups/origins", resourceVersion ?? "2025-06-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for AFDOrigin. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _parent = DefineResource<AFDOriginGroup>("Parent", new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing AFDOrigin. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static AFDOrigin FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            AFDOrigin result = new AFDOrigin(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for AFDOrigin that are not part of the generated code. </summary>
