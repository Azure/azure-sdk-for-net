...
namespace Azure.Provisioning.Cdn
{
    ...
    public partial class CdnOrigin : ProvisionableResource
    {
        ...
        /// <summary> Creates a new CdnOrigin. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public CdnOrigin(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Cdn/profiles/endpoints/origins", resourceVersion ?? "2025-06-01")
        {
        }
        ...
        /// <summary> Creates a reference to an existing CdnOrigin. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static CdnOrigin FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            CdnOrigin result = new CdnOrigin(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for CdnOrigin that are not part of the generated code. </summary>
