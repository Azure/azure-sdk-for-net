...
namespace Azure.Provisioning.Cdn
{
    ...
    public partial class OriginGroup : ProvisionableResource
    {
        ...
        /// <summary> Creates a new OriginGroup. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public OriginGroup(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Cdn/profiles/endpoints/originGroups", resourceVersion ?? "2025-06-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for OriginGroup. </summary>
        ...
        /// <summary> Creates a reference to an existing OriginGroup. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static OriginGroup FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            OriginGroup result = new OriginGroup(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for OriginGroup that are not part of the generated code. </summary>
