...
namespace Azure.Provisioning.Cdn
{
    ...
    public partial class AFDDomain : ProvisionableResource
    {
        ...
        /// <summary> Creates a new AFDDomain. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public AFDDomain(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Cdn/profiles/customDomains", resourceVersion ?? "2025-06-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for AFDDomain. </summary>
        ...
        /// <summary> Creates a reference to an existing AFDDomain. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static AFDDomain FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            AFDDomain result = new AFDDomain(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for AFDDomain that are not part of the generated code. </summary>
