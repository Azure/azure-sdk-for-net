...
namespace Azure.Provisioning.Cdn
{
    ...
    public partial class AFDOriginGroup : ProvisionableResource
    {
        ...
        /// <summary> Creates a new AFDOriginGroup. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public AFDOriginGroup(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Cdn/profiles/originGroups", resourceVersion ?? "2025-06-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for AFDOriginGroup. </summary>
        ...
        /// <summary> Creates a reference to an existing AFDOriginGroup. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static AFDOriginGroup FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            AFDOriginGroup result = new AFDOriginGroup(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for AFDOriginGroup that are not part of the generated code. </summary>
