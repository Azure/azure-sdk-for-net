...
namespace Azure.Provisioning.Cdn
{
    ...
    public partial class FrontDoorRuleSet : ProvisionableResource
    {
        ...
        /// <summary> Creates a new FrontDoorRuleSet. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public FrontDoorRuleSet(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Cdn/profiles/ruleSets", resourceVersion ?? "2025-06-01")
        {
        }
        ...
        /// <summary> Creates a reference to an existing FrontDoorRuleSet. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static FrontDoorRuleSet FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            FrontDoorRuleSet result = new FrontDoorRuleSet(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for FrontDoorRuleSet that are not part of the generated code. </summary>
