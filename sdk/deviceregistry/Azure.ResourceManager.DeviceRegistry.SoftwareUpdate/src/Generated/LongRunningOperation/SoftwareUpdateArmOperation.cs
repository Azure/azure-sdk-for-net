...
{
    internal partial class SoftwareUpdateArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of SoftwareUpdateArmOperation for mocking. </summary>
        protected SoftwareUpdateArmOperation()
        {
        }
        ...
        internal SoftwareUpdateArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SoftwareUpdateArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
