...
{
    internal partial class SoftwareUpdateArmOperation<T> : ArmOperation<T>
    {
        ...
        internal SoftwareUpdateArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SoftwareUpdateArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
