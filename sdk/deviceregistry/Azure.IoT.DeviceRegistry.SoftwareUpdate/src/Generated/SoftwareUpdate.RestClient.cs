...
namespace Azure.IoT.DeviceRegistry._SoftwareUpdate
{
    ...
    public partial class SoftwareUpdate
    {
        ...
        internal HttpMessage CreateGetOperationStatusesRequest(string filter, int? maxPageSize, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
        ...
        internal HttpMessage CreateNextGetOperationStatusesRequest(Uri nextPage, string filter, int? maxPageSize, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            if (nextPage.IsAbsoluteUri)
            {
