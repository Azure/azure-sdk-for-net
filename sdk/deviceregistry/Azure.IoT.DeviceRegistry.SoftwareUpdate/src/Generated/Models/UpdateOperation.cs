...
namespace Azure.IoT.DeviceRegistry._SoftwareUpdate
{
    ...
    public partial class UpdateOperation
    {
        ...
        internal UpdateOperation(string operationId, OperationState status, DateTimeOffset lastActionOn, DateTimeOffset createdOn)
        {
        ...
        internal UpdateOperation(string operationId, OperationState status, UpdateInfo update, string resourceLocation, ResponseError error, string traceId, DateTimeOffset lastActionOn, DateTimeOffset createdOn, ETag? etag, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            OperationId = operationId;
            Status = status;
            Update = update;
