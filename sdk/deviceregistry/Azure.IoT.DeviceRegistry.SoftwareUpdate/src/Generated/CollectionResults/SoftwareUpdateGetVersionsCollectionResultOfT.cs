...
{
    internal partial class SoftwareUpdateGetVersionsCollectionResultOfT : Pageable<string>
    {
        ...
        /// <summary> Initializes a new instance of SoftwareUpdateGetVersionsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SoftwareUpdateGetVersionsCollectionResultOfT(SoftwareUpdate client, string provider, string name, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _provider = provider;
            _name = name;
        ...
        /// <summary> Gets the pages of SoftwareUpdateGetVersionsCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SoftwareUpdateGetVersionsCollectionResultOfT as an enumerable collection. </returns>
