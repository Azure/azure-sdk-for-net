...
{
    internal partial class SoftwareUpdateGetUpdatesCollectionResultOfT : Pageable<Update>
    {
        ...
        /// <summary> Initializes a new instance of SoftwareUpdateGetUpdatesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SoftwareUpdateGetUpdatesCollectionResultOfT(SoftwareUpdate client, string search, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _search = search;
            _filter = filter;
        ...
        /// <summary> Gets the pages of SoftwareUpdateGetUpdatesCollectionResultOfT as an enumerable collection. </summary>
