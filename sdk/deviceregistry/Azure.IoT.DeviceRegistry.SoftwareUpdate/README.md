# Azure.IoT.DeviceRegistry.SoftwareUpdate client library for .NET

Azure.IoT.DeviceRegistry.SoftwareUpdate is a client library for developing .NET applications with rich experience.
