...
namespace Azure.ResourceManager.DeviceRegistry.Tests.Scenario
{
    public class DeviceRegistryDiscoveredAssetEndpointProfilesOperationsTest : DeviceRegistryManagementTestBase
    {
        ...
        private readonly string _assetNamePrefix = "deviceregistry-test-discoveredassetendpointprofile-sdk";
        ...
        {
            var discoveredAssetEndpointProfileName = Recording.GenerateAssetName(_assetNamePrefix);
