...
{
    public partial class Sample_SchemaVersionCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetAll_ListSchemaVersionsSchema()
        {
            // Generated from example definition: specification/deviceregistry/resource-manager/Microsoft.DeviceRegistry/preview/2024-09-01-preview/examples/List_SchemaVersions_Schema.json
            ...
            // get the collection of this SchemaVersionResource
            SchemaVersionCollection collection = schema.GetSchemaVersions();

            // invoke the operation and iterate over the result
            await foreach (SchemaVersionResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                SchemaVersionData resourceData = item.Data;
        ...
        public async Task Get_GetSchemaVersion()
        {
            ...
            SchemaVersionResource result = await collection.GetAsync(schemaVersionName);
        ...
        public async Task GetIfExists_GetSchemaVersion()
        {
            ...
            // invoke the operation
            string schemaVersionName = "1";
            NullableResponse<SchemaVersionResource> response = await collection.GetIfExistsAsync(schemaVersionName);
            SchemaVersionResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_CreateSchemaVersion()
        {
            ...
            ArmOperation<SchemaVersionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, schemaVersionName, data);
