...
namespace Azure.ResourceManager.DeviceRegistry.Samples
{
    public partial class Sample_AssetCollection
    {
        ...
        public async Task CreateOrUpdate_CreateAnAssetWithExternalAssetId()
        {
            ...
            AssetData data = new AssetData(new AzureLocation("West Europe"), new AssetExtendedLocation()
            {
                AssetExtendedLocationType = "CustomLocation",
            ...
            })
            {
                Properties = new AssetProperties()
                {
                    ...
                    DataPoints =
{
new AssetPropertiesDataPointsItem("nsu=http://microsoft.com/Opc/OpcPlc/;s=FastUInt1")
{
...
},new AssetPropertiesDataPointsItem("nsu=http://microsoft.com/Opc/OpcPlc/;s=FastUInt2")
{
...
DataPointConfiguration = "{\"publishingInterval\":4,\"samplingInterval\":4,\"queueSize\":7}",
                    ...
                    Events =
{
new AssetPropertiesEventsItem("nsu=http://microsoft.com/Opc/OpcPlc/;s=FastUInt3")
{
CapabilityId = "dtmi:com:example:Thermostat:__temperature;1",
ObservabilityMode = EventsObservabilityMode.None,
EventConfiguration = "{\"publishingInterval\":7,\"samplingInterval\":1,\"queueSize\":8}",
},new AssetPropertiesEventsItem("nsu=http://microsoft.com/Opc/OpcPlc/;s=FastUInt4")
{
CapabilityId = "dtmi:com:example:Thermostat:__pressure;1",
