...
{
    public partial class Sample_DiscoveredAssetResource
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetDiscoveredAssets_ListDiscoveredAssetsSubscription()
        {
            ...
            await foreach (DiscoveredAssetResource item in subscriptionResource.GetDiscoveredAssetsAsync())
            {
        ...
        public async Task Get_GetDiscoveredAsset()
        {
            ...
            // this example assumes you already have this DiscoveredAssetResource created on azure
            // for more information of creating DiscoveredAssetResource, please refer to the document of DiscoveredAssetResource
            string subscriptionId = "00000000-0000-0000-0000-000000000000";
            string resourceGroupName = "myResourceGroup";
            string discoveredAssetName = "my-discoveredasset";
            ResourceIdentifier discoveredAssetResourceId = DiscoveredAssetResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, discoveredAssetName);
            DiscoveredAssetResource discoveredAsset = client.GetDiscoveredAssetResource(discoveredAssetResourceId);

            // invoke the operation
            DiscoveredAssetResource result = await discoveredAsset.GetAsync();
        ...
        public async Task Update_UpdateDiscoveredAsset()
        {
            ...
            // invoke the operation
            DiscoveredAssetPatch patch = new DiscoveredAssetPatch()
            {
            ...
            ArmOperation<DiscoveredAssetResource> lro = await discoveredAsset.UpdateAsync(WaitUntil.Completed, patch);
        ...
        public async Task Delete_DeleteDiscoveredAsset()
        {
            ...
            // invoke the operation
            await discoveredAsset.DeleteAsync(WaitUntil.Completed);
