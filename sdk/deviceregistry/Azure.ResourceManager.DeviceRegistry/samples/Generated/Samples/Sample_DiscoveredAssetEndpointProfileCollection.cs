...
namespace Azure.ResourceManager.DeviceRegistry.Samples
{
    public partial class Sample_DiscoveredAssetEndpointProfileCollection
    {
        ...
        public async Task CreateOrUpdate_CreateDiscoveredAssetEndpointProfile()
        {
            ...
            DiscoveredAssetEndpointProfileData data = new DiscoveredAssetEndpointProfileData(new AzureLocation("West Europe"), new ExtendedLocation("CustomLocation", "/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myResourceGroup/providers/microsoft.extendedlocation/customlocations/location1"))
            {
