...
{
    public partial class Sample_BillingContainerCollection
    {
        [Test]
        ...
        public async Task Get_GetBillingContainer()
        {
            ...
            // get the collection of this BillingContainerResource
            BillingContainerCollection collection = subscriptionResource.GetBillingContainers();

            // invoke the operation
            string billingContainerName = "my-billingContainer";
            BillingContainerResource result = await collection.GetAsync(billingContainerName);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            BillingContainerData resourceData = result.Data;
        ...
        public async Task GetAll_ListBillingContainersSubscription()
        {
            ...
            await foreach (BillingContainerResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                BillingContainerData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_GetBillingContainer()
        {
            ...
            // invoke the operation
            string billingContainerName = "my-billingContainer";
            NullableResponse<BillingContainerResource> response = await collection.GetIfExistsAsync(billingContainerName);
            BillingContainerResource result = response.HasValue ? response.Value : null;
