...
{
    /// <summary></summary>
    internal partial class DeviceRegistryAssetEndpointProfileResourceOperationSource : IOperationSource<DeviceRegistryAssetEndpointProfileResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DeviceRegistryAssetEndpointProfileResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
