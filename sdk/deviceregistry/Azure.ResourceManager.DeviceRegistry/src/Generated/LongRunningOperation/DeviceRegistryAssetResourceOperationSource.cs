...
{
    /// <summary></summary>
    internal partial class DeviceRegistryAssetResourceOperationSource : IOperationSource<DeviceRegistryAssetResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DeviceRegistryAssetResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
