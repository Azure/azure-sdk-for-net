...
{
    /// <summary></summary>
    internal partial class DeviceRegistryNamespaceDiscoveredAssetResourceOperationSource : IOperationSource<DeviceRegistryNamespaceDiscoveredAssetResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DeviceRegistryNamespaceDiscoveredAssetResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
