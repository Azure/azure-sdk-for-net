...
#pragma warning disable SA1649 // File name should match first type name
    internal class DeviceRegistryArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal DeviceRegistryArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DeviceRegistryArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DeviceRegistryArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
