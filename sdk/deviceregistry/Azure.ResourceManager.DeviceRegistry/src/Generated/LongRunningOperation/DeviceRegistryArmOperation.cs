...
namespace Azure.ResourceManager.DeviceRegistry
{
    internal partial class DeviceRegistryArmOperation : ArmOperation
    {
        ...
        internal DeviceRegistryArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
