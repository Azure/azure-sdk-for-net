...
namespace Azure.ResourceManager.DeviceRegistry
{
    ...
    public partial class DeviceRegistryAssetEndpointProfileResource : ArmResource
    {
        ...
        internal DeviceRegistryAssetEndpointProfileResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _assetEndpointProfilesRestClient = new AssetEndpointProfiles(_assetEndpointProfilesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, deviceRegistryAssetEndpointProfileApiVersion ?? "2026-11-01");
