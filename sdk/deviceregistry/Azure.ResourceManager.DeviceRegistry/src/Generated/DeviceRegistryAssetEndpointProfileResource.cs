...
namespace Azure.ResourceManager.DeviceRegistry
{
    ...
    public partial class DeviceRegistryAssetEndpointProfileResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the DeviceRegistryAssetEndpointProfile.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/assetEndpointProfiles/{assetEndpointProfileName}. </description>
        ...
        public virtual async Task<ArmOperation<DeviceRegistryAssetEndpointProfileResource>> UpdateAsync(WaitUntil waitUntil, DeviceRegistryAssetEndpointProfileData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _assetEndpointProfilesRestClient.CreateCreateOrReplaceRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DeviceRegistryAssetEndpointProfileData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DeviceRegistryArmOperation<DeviceRegistryAssetEndpointProfileResource> operation = new DeviceRegistryArmOperation<DeviceRegistryAssetEndpointProfileResource>(
                    new DeviceRegistryAssetEndpointProfileResourceOperationSource(Client),
                    _assetEndpointProfilesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DeviceRegistryAssetEndpointProfileResource> Update(WaitUntil waitUntil, DeviceRegistryAssetEndpointProfileData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<DeviceRegistryAssetEndpointProfileResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ArmOperation<DeviceRegistryAssetEndpointProfileResource> result = await UpdateAsync(WaitUntil.Completed, patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DeviceRegistryAssetEndpointProfileResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    patch.Tags[key] = value;
                    ArmOperation<DeviceRegistryAssetEndpointProfileResource> result = Update(WaitUntil.Completed, patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
