...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class AssetEndpointProfilePropertiesUserAuthentication
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AssetEndpointProfilePropertiesUserAuthentication"/>. </summary>
        /// <param name="mode"> Defines the mode to authenticate the user of the client at the server. </param>
        public AssetEndpointProfilePropertiesUserAuthentication(Mode mode)
        {
            Mode = mode;
        }
        ...
        internal AssetEndpointProfilePropertiesUserAuthentication(Mode mode, AssetEndpointProfilePropertiesUserAuthenticationUsernamePasswordCredentials usernamePasswordCredentials, AssetEndpointProfilePropertiesUserAuthenticationX509Credentials x509Credentials, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Mode = mode;
        ...
        /// <summary> Initializes a new instance of <see cref="AssetEndpointProfilePropertiesUserAuthentication"/> for deserialization. </summary>
        internal AssetEndpointProfilePropertiesUserAuthentication()
        {
        }
        ...
        public AssetEndpointProfilePropertiesUserAuthenticationUsernamePasswordCredentials UsernamePasswordCredentials { get; set; }
        /// <summary> Defines the certificate reference when Certificate user authentication mode is selected. </summary>
        internal AssetEndpointProfilePropertiesUserAuthenticationX509Credentials X509Credentials { get; set; }
        ...
        public string X509CredentialsCertificateReference
        {
            ...
            set => X509Credentials = new AssetEndpointProfilePropertiesUserAuthenticationX509Credentials(value);
        }
    }
}
