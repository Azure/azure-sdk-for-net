...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class PolicyPatch : IJsonModel<PolicyPatch>
    {
        ...
        internal static PolicyPatch DeserializePolicyPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new PolicyPatch(tags ?? new ChangeTrackingDictionary<string, string>(), properties, additionalBinaryDataProperties);
        }
        ...
        /// <param name="patch"> The <see cref="PolicyPatch"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(PolicyPatch patch)
        {
            if (patch == null)
            {
                return null;
