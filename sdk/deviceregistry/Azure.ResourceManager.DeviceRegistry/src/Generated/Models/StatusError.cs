...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class StatusError
    {
        ...
        /// <summary> Initializes a new instance of <see cref="StatusError"/>. </summary>
        ...
        internal StatusError(string code, string message, IReadOnlyList<ErrorDetails> details, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Details = details;
