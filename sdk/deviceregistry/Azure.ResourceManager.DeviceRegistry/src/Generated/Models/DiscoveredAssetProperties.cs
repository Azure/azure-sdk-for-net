...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class DiscoveredAssetProperties
    {
        ...
        internal DiscoveredAssetProperties(string assetEndpointProfileRef, string discoveryId, long version, string manufacturer, Uri manufacturerUri, string model, string productCode, string hardwareRevision, string softwareRevision, Uri documentationUri, string serialNumber, string defaultDatasetsConfiguration, string defaultEventsConfiguration, Topic defaultTopic, IList<DiscoveredDataset> datasets, IList<DiscoveredEvent> events, DeviceRegistryProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AssetEndpointProfileRef = assetEndpointProfileRef;
            DiscoveryId = discoveryId;
            Version = version;
