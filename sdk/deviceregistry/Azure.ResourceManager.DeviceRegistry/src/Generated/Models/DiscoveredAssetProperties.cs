...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class DiscoveredAssetProperties
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="DiscoveredAssetProperties"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="assetEndpointProfileRef"/> or <paramref name="discoveryId"/> is null. </exception>
        ...
        internal DiscoveredAssetProperties(string assetEndpointProfileRef, string discoveryId, long version, string manufacturer, string manufacturerUri, string model, string productCode, string hardwareRevision, string softwareRevision, string documentationUri, string serialNumber, string defaultDatasetsConfiguration, string defaultEventsConfiguration, Topic defaultTopic, IList<DiscoveredDataset> datasets, IList<DiscoveredEvent> events, DeviceRegistryProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AssetEndpointProfileRef = assetEndpointProfileRef;
            DiscoveryId = discoveryId;
            Version = version;
        ...
        /// <summary> Initializes a new instance of <see cref="DiscoveredAssetProperties"/> for deserialization. </summary>
        internal DiscoveredAssetProperties()
        {
        }
