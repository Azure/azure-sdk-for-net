...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class SchemaProperties
    {
        ...
        public SchemaProperties(Format format, SchemaType schemaType)
        {
            Format = format;
        ...
        internal SchemaProperties(string uuid, string displayName, string description, Format format, SchemaType schemaType, DeviceRegistryProvisioningState? provisioningState, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uuid = uuid;
