...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class DeviceRegistrySchemaRegistryProperties
    {
        ...
        public DeviceRegistrySchemaRegistryProperties(string @namespace, string storageAccountContainerUri)
        {
        ...
        internal DeviceRegistrySchemaRegistryProperties(string uuid, string @namespace, string displayName, string description, string storageAccountContainerUri, DeviceRegistryProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uuid = uuid;
            Namespace = @namespace;
