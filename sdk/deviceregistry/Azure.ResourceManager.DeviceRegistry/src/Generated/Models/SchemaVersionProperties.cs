...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class SchemaVersionProperties
    {
        ...
        internal SchemaVersionProperties(string uuid, string description, string schemaContent, string hash, DeviceRegistryProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uuid = uuid;
