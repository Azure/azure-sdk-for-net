...
{
    public partial class AdrAssetProperties : IUtf8JsonSerializable, IJsonModel<AdrAssetProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdrAssetProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AdrAssetProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdrAssetProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AdrAssetProperties)} does not support '{format}' format.");
            }
        ...
        AdrAssetProperties IJsonModel<AdrAssetProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdrAssetProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            return DeserializeAdrAssetProperties(document.RootElement, options);
        }

        internal static AdrAssetProperties DeserializeAdrAssetProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AdrAssetProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AdrAssetProperties)} does not support '{options.Format}' format.");
            }
        }

        AdrAssetProperties IPersistableModel<AdrAssetProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AdrAssetProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AdrAssetProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
