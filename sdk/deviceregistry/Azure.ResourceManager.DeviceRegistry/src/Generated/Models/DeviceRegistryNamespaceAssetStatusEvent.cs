...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class DeviceRegistryNamespaceAssetStatusEvent
    {
        ...
        internal DeviceRegistryNamespaceAssetStatusEvent(string name, DeviceRegistryNamespaceMessageSchemaReference messageSchemaReference, DeviceRegistryStatusError error, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
