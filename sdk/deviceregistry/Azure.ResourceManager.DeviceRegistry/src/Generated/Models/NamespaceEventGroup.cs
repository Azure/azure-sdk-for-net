...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class NamespaceEventGroup
    {
        ...
        internal NamespaceEventGroup(string name, string dataSource, string eventGroupConfiguration, IList<EventDestination> defaultDestinations, string typeRef, IList<NamespaceEvent> events, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
