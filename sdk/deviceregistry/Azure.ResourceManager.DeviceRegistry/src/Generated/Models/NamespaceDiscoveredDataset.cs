...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class NamespaceDiscoveredDataset
    {
        ...
        internal NamespaceDiscoveredDataset(string name, string dataSource, string typeRef, string datasetConfiguration, IList<DatasetDestination> destinations, IList<NamespaceDiscoveredDatasetDataPoint> dataPoints, DateTimeOffset? lastUpdatedOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
