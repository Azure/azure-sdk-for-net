...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class DeviceRegistryNamespaceDiscoveredDevicePatch : IJsonModel<DeviceRegistryNamespaceDiscoveredDevicePatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeviceRegistryNamespaceDiscoveredDevicePatch IJsonModel<DeviceRegistryNamespaceDiscoveredDevicePatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DeviceRegistryNamespaceDiscoveredDevicePatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DeviceRegistryNamespaceDiscoveredDevicePatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DeviceRegistryNamespaceDiscoveredDevicePatch DeserializeDeviceRegistryNamespaceDiscoveredDevicePatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = NamespaceDiscoveredDeviceUpdateProperties.DeserializeNamespaceDiscoveredDeviceUpdateProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="patch"> The <see cref="DeviceRegistryNamespaceDiscoveredDevicePatch"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(DeviceRegistryNamespaceDiscoveredDevicePatch patch)
        {
            if (patch == null)
            {
                return null;
