...
{
    public partial class DeviceRegistryNamespaceDiscoveredDeviceProperties : IUtf8JsonSerializable, IJsonModel<DeviceRegistryNamespaceDiscoveredDeviceProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceRegistryNamespaceDiscoveredDeviceProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeviceRegistryNamespaceDiscoveredDeviceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        DeviceRegistryNamespaceDiscoveredDeviceProperties IJsonModel<DeviceRegistryNamespaceDiscoveredDeviceProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeviceRegistryNamespaceDiscoveredDeviceProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static DeviceRegistryNamespaceDiscoveredDeviceProperties DeserializeDeviceRegistryNamespaceDiscoveredDeviceProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<DeviceRegistryNamespaceDiscoveredDeviceProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeviceRegistryNamespaceDiscoveredDeviceProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        DeviceRegistryNamespaceDiscoveredDeviceProperties IPersistableModel<DeviceRegistryNamespaceDiscoveredDeviceProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeviceRegistryNamespaceDiscoveredDeviceProperties>)this).GetFormatFromOptions(options) : options.Format;
