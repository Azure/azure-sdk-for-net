...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class DiscoveredAssetUpdateProperties
    {
        ...
        internal DiscoveredAssetUpdateProperties(string discoveryId, long? version, string manufacturer, string manufacturerUri, string model, string productCode, string hardwareRevision, string softwareRevision, string documentationUri, string serialNumber, string defaultDatasetsConfiguration, string defaultEventsConfiguration, TopicUpdate defaultTopic, IList<DiscoveredDataset> datasets, IList<DiscoveredEvent> events, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
