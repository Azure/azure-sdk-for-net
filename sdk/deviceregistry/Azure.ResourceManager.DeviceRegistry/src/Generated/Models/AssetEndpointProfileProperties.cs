...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class AssetEndpointProfileProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AssetEndpointProfileProperties"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="targetAddress"/> is null. </exception>
        public AssetEndpointProfileProperties(Uri targetAddress)
        {
        ...
        internal AssetEndpointProfileProperties(string uuid, Uri targetAddress, AssetEndpointProfilePropertiesUserAuthentication userAuthentication, AssetEndpointProfilePropertiesTransportAuthentication transportAuthentication, string additionalConfiguration, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uuid = uuid;
            TargetAddress = targetAddress;
        ...
        /// <summary> Initializes a new instance of <see cref="AssetEndpointProfileProperties"/> for deserialization. </summary>
        internal AssetEndpointProfileProperties()
        {
        }
        ...
        public AssetEndpointProfilePropertiesUserAuthentication UserAuthentication { get; set; }
        /// <summary> Defines the authentication mechanism for the southbound connector connecting to the shop floor/OT device. </summary>
        internal AssetEndpointProfilePropertiesTransportAuthentication TransportAuthentication { get; set; }
        ...
        public IList<AssetEndpointProfilePropertiesTransportAuthenticationOwnCertificatesItem> TransportAuthenticationOwnCertificates
        {
            get => TransportAuthentication is null ? default : TransportAuthentication.OwnCertificates;
            set => TransportAuthentication = new AssetEndpointProfilePropertiesTransportAuthentication(value);
        }
