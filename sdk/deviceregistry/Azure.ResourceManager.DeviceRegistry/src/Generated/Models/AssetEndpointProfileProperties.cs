...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class AssetEndpointProfileProperties
    {
        ...
        public AssetEndpointProfileProperties(Uri targetAddress, string endpointProfileType)
        {
        ...
        internal AssetEndpointProfileProperties(string uuid, Uri targetAddress, string endpointProfileType, Authentication authentication, string additionalConfiguration, string discoveredAssetEndpointProfileRef, AssetEndpointProfileStatus status, DeviceRegistryProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uuid = uuid;
            TargetAddress = targetAddress;
            EndpointProfileType = endpointProfileType;
