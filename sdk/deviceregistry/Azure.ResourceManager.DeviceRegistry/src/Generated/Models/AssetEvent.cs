...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class AssetEvent : EventBase
    {
        ...
        public AssetEvent(string name, string eventNotifier) : base(name, eventNotifier)
        {
        ...
        internal AssetEvent(string name, string eventNotifier, string eventConfiguration, Topic topic, IDictionary<string, BinaryData> serializedAdditionalRawData, EventObservabilityMode? observabilityMode) : base(name, eventNotifier, eventConfiguration, topic, serializedAdditionalRawData)
        {
