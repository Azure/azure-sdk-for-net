...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class Event : EventBase
    {
        ...
        public Event(string name, string eventNotifier) : base(name, eventNotifier)
        {
        ...
        internal Event(string name, string eventNotifier, string eventConfiguration, Topic topic, IDictionary<string, BinaryData> serializedAdditionalRawData, EventObservabilityMode? observabilityMode) : base(name, eventNotifier, eventConfiguration, topic, serializedAdditionalRawData)
        {
