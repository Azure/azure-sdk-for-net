...
{
    /// <summary> The AssetPropertiesEventsItem. </summary>
    public partial class AssetPropertiesEventsItem
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AssetPropertiesEventsItem"/>. </summary>
        ...
        public AssetPropertiesEventsItem(string eventNotifier)
        {
        ...
        internal AssetPropertiesEventsItem(string name, string eventNotifier, string capabilityId, EventsObservabilityMode? observabilityMode, string eventConfiguration, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            EventNotifier = eventNotifier;
        ...
        /// <summary> Initializes a new instance of <see cref="AssetPropertiesEventsItem"/> for deserialization. </summary>
        internal AssetPropertiesEventsItem()
        {
        }
