...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class DatasetMqttDestination : DatasetDestination, IJsonModel<DatasetMqttDestination>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DatasetMqttDestination IJsonModel<DatasetMqttDestination>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DatasetMqttDestination)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DatasetMqttDestination DeserializeDatasetMqttDestination(JsonElement element, ModelReaderWriterOptions options)
        {
