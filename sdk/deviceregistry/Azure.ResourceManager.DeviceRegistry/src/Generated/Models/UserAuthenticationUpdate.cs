...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class UserAuthenticationUpdate
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="UserAuthenticationUpdate"/>. </summary>
        ...
        internal UserAuthenticationUpdate(UserAuthenticationMode? mode, UsernamePasswordCredentialsUpdate usernamePasswordCredentials, X509CredentialsUpdate x509Credentials, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Mode = mode;
        ...
        public UsernamePasswordCredentialsUpdate UsernamePasswordCredentials { get; set; }
        /// <summary> Defines the certificate reference when Certificate user authentication mode is selected. </summary>
        internal X509CredentialsUpdate X509Credentials { get; set; }
        ...
        public string X509CredentialsCertificateReference
        {
            ...
            set
            {
                if (X509Credentials is null)
                    X509Credentials = new X509CredentialsUpdate();
                X509Credentials.CertificateReference = value;
            }
        }
    }
}
