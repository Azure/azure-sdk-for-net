...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class HealthState
    {
        ...
        internal HealthState(HealthStatus? status, string lastTransitionTime, string lastUpdateTime, string message, string reasonCode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
