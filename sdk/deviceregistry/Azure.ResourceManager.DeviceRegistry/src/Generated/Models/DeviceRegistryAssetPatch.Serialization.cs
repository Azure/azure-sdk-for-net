    ...
    public partial class DeviceRegistryAssetPatch : IUtf8JsonSerializable, IJsonModel<DeviceRegistryAssetPatch>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                ((IJsonModel<AssetUpdateProperties>)Properties).Write(writer, options);
            }
        ...
        internal static DeviceRegistryAssetPatch DeserializeDeviceRegistryAssetPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ModelSerializationExtensions.JsonDeserialize<AssetUpdateProperties>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new DeviceRegistryAssetPatch(tags ?? new ChangeTrackingDictionary<string, string>(), properties, serializedAdditionalRawData);
        }
