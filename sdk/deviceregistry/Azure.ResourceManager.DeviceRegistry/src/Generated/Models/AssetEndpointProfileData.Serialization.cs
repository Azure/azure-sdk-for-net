...
namespace Azure.ResourceManager.DeviceRegistry
{
    public partial class AssetEndpointProfileData : IUtf8JsonSerializable, IJsonModel<AssetEndpointProfileData>
    {
        ...
        internal static AssetEndpointProfileData DeserializeAssetEndpointProfileData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<AssetEndpointProfileProperties> properties = default;
            AssetEndpointProfileExtendedLocation extendedLocation = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = AssetEndpointProfileProperties.DeserializeAssetEndpointProfileProperties(property.Value);
                    continue;
                }
                if (property.NameEquals("extendedLocation"u8))
                {
                    extendedLocation = AssetEndpointProfileExtendedLocation.DeserializeAssetEndpointProfileExtendedLocation(property.Value);
                    continue;
                }
            ...
            return new AssetEndpointProfileData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties.Value, extendedLocation, serializedAdditionalRawData);
        }
