...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class DiscoveredDataset
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="DiscoveredDataset"/>. </summary>
        ...
        public DiscoveredDataset(string name)
        {
            ...
            Name = name;
            DataPoints = new ChangeTrackingList<DiscoveredDataPoint>();
        }
        ...
        internal DiscoveredDataset(string name, string datasetConfiguration, DeviceRegistryMqttTopic topic, IList<DiscoveredDataPoint> dataPoints, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
        ...
        /// <summary> Initializes a new instance of <see cref="DiscoveredDataset"/> for deserialization. </summary>
        internal DiscoveredDataset()
        {
        }
        ...
        public IList<DiscoveredDataPoint> DataPoints { get; }
    }
}
