...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class DiscoveredDataset
    {
        ...
        internal DiscoveredDataset(string name, string datasetConfiguration, DeviceRegistryTopic topic, IList<DiscoveredDataPoint> dataPoints, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
