...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class NamespaceDiscoveredEvent
    {
        ...
        internal NamespaceDiscoveredEvent(string name, string dataSource, string eventConfiguration, IList<EventDestination> destinations, string typeRef, DateTimeOffset? lastUpdatedOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
