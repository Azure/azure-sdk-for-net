...
namespace Azure.ResourceManager.DeviceRegistry
{
    public partial class AssetData : IUtf8JsonSerializable, IJsonModel<AssetData>
    {
        ...
        internal static AssetData DeserializeAssetData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<AssetProperties> properties = default;
            AssetExtendedLocation extendedLocation = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = AssetProperties.DeserializeAssetProperties(property.Value);
                    continue;
                }
                if (property.NameEquals("extendedLocation"u8))
                {
                    extendedLocation = AssetExtendedLocation.DeserializeAssetExtendedLocation(property.Value);
                    continue;
                }
            ...
            return new AssetData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties.Value, extendedLocation, serializedAdditionalRawData);
        }
