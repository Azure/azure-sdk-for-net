...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class NamespaceEvent
    {
        ...
        internal NamespaceEvent(string name, string dataSource, string eventConfiguration, IList<EventDestination> destinations, string typeRef, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
