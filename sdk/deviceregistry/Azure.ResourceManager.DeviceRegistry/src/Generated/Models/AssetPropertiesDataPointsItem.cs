...
{
    /// <summary> The AssetPropertiesDataPointsItem. </summary>
    public partial class AssetPropertiesDataPointsItem
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="AssetPropertiesDataPointsItem"/>. </summary>
        ...
        public AssetPropertiesDataPointsItem(string dataSource)
        {
        ...
        internal AssetPropertiesDataPointsItem(string name, string dataSource, string capabilityId, DataPointsObservabilityMode? observabilityMode, string dataPointConfiguration, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            DataSource = dataSource;
        ...
        /// <summary> Initializes a new instance of <see cref="AssetPropertiesDataPointsItem"/> for deserialization. </summary>
        internal AssetPropertiesDataPointsItem()
        {
        }
