...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class Dataset
    {
        ...
        internal Dataset(string name, string datasetConfiguration, Topic topic, IList<DataPoint> dataPoints, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
