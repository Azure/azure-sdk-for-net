...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetEndpointProfileListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                ((IJsonModel<DeviceRegistryAssetEndpointProfileData>)item).Write(writer, options);
            }
        ...
        internal static AssetEndpointProfileListResult DeserializeAssetEndpointProfileListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<DeviceRegistryAssetEndpointProfileData> value = default;
            ...
            return new AssetEndpointProfileListResult(value, nextLink, serializedAdditionalRawData);
        }
