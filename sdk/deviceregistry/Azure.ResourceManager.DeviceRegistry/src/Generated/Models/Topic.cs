...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class Topic
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Topic"/>. </summary>
        ...
        internal Topic(string path, TopicRetainType? retain, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Path = path;
            Retain = retain;
        ...
        /// <summary> Initializes a new instance of <see cref="Topic"/> for deserialization. </summary>
        internal Topic()
        {
        }
