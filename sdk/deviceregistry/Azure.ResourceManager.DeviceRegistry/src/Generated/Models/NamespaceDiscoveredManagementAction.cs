...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class NamespaceDiscoveredManagementAction
    {
        ...
        internal NamespaceDiscoveredManagementAction(string name, string actionConfiguration, string targetUri, string typeRef, string topic, NamespaceDiscoveredManagementActionType? actionType, int? timeoutInSeconds, DateTimeOffset? lastUpdatedOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
