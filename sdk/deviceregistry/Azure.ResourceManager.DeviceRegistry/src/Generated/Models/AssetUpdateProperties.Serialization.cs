        ...
        internal static AssetUpdateProperties DeserializeAssetUpdateProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("manufacturerUri"u8))
                {
                    ...
                    manufacturerUri = string.IsNullOrEmpty(prop.Value.GetString()) ? null : new Uri(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("documentationUri"u8))
                {
                    ...
                    documentationUri = string.IsNullOrEmpty(prop.Value.GetString()) ? null : new Uri(prop.Value.GetString());
                    continue;
                }
