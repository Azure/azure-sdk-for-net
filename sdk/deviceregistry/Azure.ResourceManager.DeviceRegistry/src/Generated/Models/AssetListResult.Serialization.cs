...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AssetListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssetListResult)} does not support '{format}' format.");
            }
        ...
        internal static AssetListResult DeserializeAssetListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<AssetData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(AssetData.DeserializeAssetData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new AssetListResult(value, nextLink.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AssetListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AssetListResult)} does not support '{options.Format}' format.");
            }
        }
