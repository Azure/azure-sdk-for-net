...
{
    public partial class DeviceRegistryNamespaceDiscoveredAssetProperties : IUtf8JsonSerializable, IJsonModel<DeviceRegistryNamespaceDiscoveredAssetProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceRegistryNamespaceDiscoveredAssetProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeviceRegistryNamespaceDiscoveredAssetProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        DeviceRegistryNamespaceDiscoveredAssetProperties IJsonModel<DeviceRegistryNamespaceDiscoveredAssetProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeviceRegistryNamespaceDiscoveredAssetProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static DeviceRegistryNamespaceDiscoveredAssetProperties DeserializeDeviceRegistryNamespaceDiscoveredAssetProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<DeviceRegistryNamespaceDiscoveredAssetProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeviceRegistryNamespaceDiscoveredAssetProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        DeviceRegistryNamespaceDiscoveredAssetProperties IPersistableModel<DeviceRegistryNamespaceDiscoveredAssetProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DeviceRegistryNamespaceDiscoveredAssetProperties>)this).GetFormatFromOptions(options) : options.Format;
