...
{
    /// <summary> The AssetEndpointProfilePropertiesTransportAuthenticationOwnCertificatesItem. </summary>
    public partial class AssetEndpointProfilePropertiesTransportAuthenticationOwnCertificatesItem
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AssetEndpointProfilePropertiesTransportAuthenticationOwnCertificatesItem"/>. </summary>
        ...
        internal AssetEndpointProfilePropertiesTransportAuthenticationOwnCertificatesItem(string certThumbprint, string certSecretReference, string certPasswordReference, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
