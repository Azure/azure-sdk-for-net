...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    public partial class AssetPatch : IUtf8JsonSerializable, IJsonModel<AssetPatch>
    {
        ...
        internal static AssetPatch DeserializeAssetPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<AdrAssetProperties> properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = AdrAssetProperties.DeserializeAdrAssetProperties(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new AssetPatch(Optional.ToDictionary(tags), properties.Value, serializedAdditionalRawData);
        }
