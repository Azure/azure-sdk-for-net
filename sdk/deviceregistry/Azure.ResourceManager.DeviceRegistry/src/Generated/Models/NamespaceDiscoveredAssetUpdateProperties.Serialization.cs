...
{
    public partial class NamespaceDiscoveredAssetUpdateProperties : IUtf8JsonSerializable, IJsonModel<NamespaceDiscoveredAssetUpdateProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NamespaceDiscoveredAssetUpdateProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NamespaceDiscoveredAssetUpdateProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        NamespaceDiscoveredAssetUpdateProperties IJsonModel<NamespaceDiscoveredAssetUpdateProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NamespaceDiscoveredAssetUpdateProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static NamespaceDiscoveredAssetUpdateProperties DeserializeNamespaceDiscoveredAssetUpdateProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<NamespaceDiscoveredAssetUpdateProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NamespaceDiscoveredAssetUpdateProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        NamespaceDiscoveredAssetUpdateProperties IPersistableModel<NamespaceDiscoveredAssetUpdateProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NamespaceDiscoveredAssetUpdateProperties>)this).GetFormatFromOptions(options) : options.Format;
