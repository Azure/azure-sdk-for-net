...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class DeviceRegistryNamespaceProperties
    {
        ...
        internal DeviceRegistryNamespaceProperties(string uuid, Messaging messaging, DeviceRegistryProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Uuid = uuid;
            Messaging = messaging;
