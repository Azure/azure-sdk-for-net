...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class DataPoint : DataPointBase
    {
        ...
        public DataPoint(string name, string dataSource) : base(name, dataSource)
        {
        ...
        internal DataPoint(string name, string dataSource, string dataPointConfiguration, IDictionary<string, BinaryData> serializedAdditionalRawData, DataPointObservabilityMode? observabilityMode) : base(name, dataSource, dataPointConfiguration, serializedAdditionalRawData)
        {
