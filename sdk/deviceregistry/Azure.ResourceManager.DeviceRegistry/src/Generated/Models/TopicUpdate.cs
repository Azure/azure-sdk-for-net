...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class TopicUpdate
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TopicUpdate"/>. </summary>
        public TopicUpdate()
        {
        }
        ...
        internal TopicUpdate(string path, TopicRetainType? retain, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Path = path;
            Retain = retain;
        ...
        public TopicRetainType? Retain { get; set; }
    }
}
