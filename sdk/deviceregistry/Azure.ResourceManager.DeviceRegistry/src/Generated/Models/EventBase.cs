...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class EventBase
    {
        ...
        /// <summary> Initializes a new instance of <see cref="EventBase"/>. </summary>
        ...
        internal EventBase(string name, string eventNotifier, string eventConfiguration, Topic topic, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            EventNotifier = eventNotifier;
        ...
        /// <summary> Initializes a new instance of <see cref="EventBase"/> for deserialization. </summary>
        internal EventBase()
        {
        }
