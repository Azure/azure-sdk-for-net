...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public partial class AssetEndpointProfileStatusError
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AssetEndpointProfileStatusError"/>. </summary>
        ...
        internal AssetEndpointProfileStatusError(int? code, string message, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Message = message;
        ...
        /// <summary> Human readable helpful error message to provide additional context for error (ex: “targetAddress 'foo' is not a valid url”). </summary>
