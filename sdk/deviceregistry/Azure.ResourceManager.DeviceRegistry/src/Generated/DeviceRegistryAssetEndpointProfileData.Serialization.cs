    ...
    public partial class DeviceRegistryAssetEndpointProfileData : IUtf8JsonSerializable, IJsonModel<DeviceRegistryAssetEndpointProfileData>
    {
        ...
        internal static DeviceRegistryAssetEndpointProfileData DeserializeDeviceRegistryAssetEndpointProfileData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.DeviceRegistry.ModelSerializationExtensions.WireOptions, AzureResourceManagerDeviceRegistryContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerDeviceRegistryContext.Default)
#endif
;
                    continue;
                }
