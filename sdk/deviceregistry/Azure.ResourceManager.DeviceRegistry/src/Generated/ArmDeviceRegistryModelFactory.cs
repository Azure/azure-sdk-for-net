...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public static partial class ArmDeviceRegistryModelFactory
    {
        ...
        {
            return new ActivateBringYourOwnRootRequest(certificateChain, default);
        }
        ...
        /// <returns> A new <see cref="Models.DeviceCredentialsRevokeRequest"/> instance for mocking. </returns>
        public static DeviceCredentialsRevokeRequest DeviceCredentialsRevokeRequest(bool? disable = default)
        {
            return new DeviceCredentialsRevokeRequest(disable, default);
        }
