...
namespace Azure.ResourceManager.DeviceRegistry.Models
{
    ...
    public static partial class ArmDeviceRegistryModelFactory
    {
        ...
        public static AssetData AssetData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, AssetProperties properties = null, AssetExtendedLocation extendedLocation = null)
        {
            tags ??= new Dictionary<string, string>();

            return new AssetData(id, name, resourceType, systemData, tags, location, properties, extendedLocation, serializedAdditionalRawData: null);
        }
        ...
        public static AssetProperties AssetProperties(string uuid = null, string assetType = null, bool? enabled = null, string externalAssetId = null, string displayName = null, string description = null, Uri assetEndpointProfileUri = null, int? version = null, string manufacturer = null, Uri manufacturerUri = null, string model = null, string productCode = null, string hardwareRevision = null, string softwareRevision = null, Uri documentationUri = null, string serialNumber = null, IDictionary<string, BinaryData> attributes = null, string defaultDataPointsConfiguration = null, string defaultEventsConfiguration = null, IEnumerable<AssetPropertiesDataPointsItem> dataPoints = null, IEnumerable<AssetPropertiesEventsItem> events = null, AssetPropertiesStatus status = null, ProvisioningState? provisioningState = null)
        {
            attributes ??= new Dictionary<string, BinaryData>();
            dataPoints ??= new List<AssetPropertiesDataPointsItem>();
            events ??= new List<AssetPropertiesEventsItem>();

            return new AssetProperties(uuid, assetType, enabled, externalAssetId, displayName, description, assetEndpointProfileUri, version, manufacturer, manufacturerUri, model, productCode, hardwareRevision, softwareRevision, documentationUri, serialNumber, attributes, defaultDataPointsConfiguration, defaultEventsConfiguration, dataPoints?.ToList(), events?.ToList(), status, provisioningState, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.AdrAssetProperties"/>. </summary>
        /// <param name="uuid"> Globally unique, immutable, non-reusable id. </param>
        /// <param name="assetType"> Resource path to asset type (model) definition. </param>
        /// <param name="enabled"> Enabled/Disabled status of the asset. </param>
        /// <param name="externalAssetId"> Asset id provided by the customer. </param>
        ...
        /// <param name="status"> Read only object to reflect changes that have occurred on the Edge. Similar to Kubernetes status property for custom resources. </param>
        /// <param name="provisioningState"> Provisioning state of the resource. </param>
        /// <returns> A new <see cref="Models.AdrAssetProperties"/> instance for mocking. </returns>
        public static AdrAssetProperties AdrAssetProperties(string uuid = null, string assetType = null, bool? enabled = null, string externalAssetId = null, string displayName = null, string description = null, Uri assetEndpointProfileUri = null, int? version = null, string manufacturer = null, Uri manufacturerUri = null, string model = null, string productCode = null, string hardwareRevision = null, string softwareRevision = null, Uri documentationUri = null, string serialNumber = null, IDictionary<string, BinaryData> attributes = null, string defaultDataPointsConfiguration = null, string defaultEventsConfiguration = null, IEnumerable<AssetPropertiesDataPointsItem> dataPoints = null, IEnumerable<AssetPropertiesEventsItem> events = null, AssetPropertiesStatus status = null, ProvisioningState? provisioningState = null)
        {
            attributes ??= new Dictionary<string, BinaryData>();
            dataPoints ??= new List<AssetPropertiesDataPointsItem>();
            events ??= new List<AssetPropertiesEventsItem>();

            return new AdrAssetProperties(uuid, assetType, enabled, externalAssetId, displayName, description, assetEndpointProfileUri, version, manufacturer, manufacturerUri, model, productCode, hardwareRevision, softwareRevision, documentationUri, serialNumber, attributes, defaultDataPointsConfiguration, defaultEventsConfiguration, dataPoints?.ToList(), events?.ToList(), status, provisioningState, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.AssetPropertiesStatus"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.AssetPropertiesStatus"/> instance for mocking. </returns>
        public static AssetPropertiesStatus AssetPropertiesStatus(IEnumerable<AssetPropertiesStatusErrorsItem> errors = null, int? version = null)
        {
            errors ??= new List<AssetPropertiesStatusErrorsItem>();

            return new AssetPropertiesStatus(errors?.ToList(), version, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.AssetPropertiesStatusErrorsItem"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.AssetPropertiesStatusErrorsItem"/> instance for mocking. </returns>
        public static AssetPropertiesStatusErrorsItem AssetPropertiesStatusErrorsItem(int? code = null, string message = null)
        {
            return new AssetPropertiesStatusErrorsItem(code, message, serializedAdditionalRawData: null);
        }
        ...
        public static AssetEndpointProfileData AssetEndpointProfileData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, AssetEndpointProfileProperties properties = null, AssetEndpointProfileExtendedLocation extendedLocation = null)
        {
            tags ??= new Dictionary<string, string>();

            return new AssetEndpointProfileData(id, name, resourceType, systemData, tags, location, properties, extendedLocation, serializedAdditionalRawData: null);
        }
        ...
        public static AssetEndpointProfileProperties AssetEndpointProfileProperties(string uuid = null, Uri targetAddress = null, AssetEndpointProfilePropertiesUserAuthentication userAuthentication = null, IEnumerable<AssetEndpointProfilePropertiesTransportAuthenticationOwnCertificatesItem> transportAuthenticationOwnCertificates = null, string additionalConfiguration = null, ProvisioningState? provisioningState = null)
        {
            transportAuthenticationOwnCertificates ??= new List<AssetEndpointProfilePropertiesTransportAuthenticationOwnCertificatesItem>();

            return new AssetEndpointProfileProperties(uuid, targetAddress, userAuthentication, transportAuthenticationOwnCertificates != null ? new AssetEndpointProfilePropertiesTransportAuthentication(transportAuthenticationOwnCertificates?.ToList(), serializedAdditionalRawData: null) : null, additionalConfiguration, provisioningState, serializedAdditionalRawData: null);
        }
    }
}
