    ...
    public partial class PolicyCollection : ArmCollection, IEnumerable<PolicyResource>, IAsyncEnumerable<PolicyResource>
    {
        ...
        public virtual async Task<Response<PolicyResource>> GetAsync(string policyName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _policiesRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, policyName, context);
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/namespaces/{namespaceName}/credentials/default/policies. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> Policies_ListByResourceGroup. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-11-01-preview. </description>
