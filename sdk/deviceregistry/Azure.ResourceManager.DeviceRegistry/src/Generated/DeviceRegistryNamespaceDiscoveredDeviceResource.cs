...
namespace Azure.ResourceManager.DeviceRegistry
{
    ...
    public partial class DeviceRegistryNamespaceDiscoveredDeviceResource : ArmResource
    {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> NamespaceDiscoveredDevices_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-01-preview. </description>
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> NamespaceDiscoveredDevices_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-03-01-preview. </description>
        ...
        /// <summary>
        /// Updates the DeviceRegistryNamespaceDiscoveredDevice.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeviceRegistry/namespaces/{namespaceName}/discoveredDevices/{discoveredDeviceName}. </description>
        ...
        public virtual async Task<ArmOperation<DeviceRegistryNamespaceDiscoveredDeviceResource>> UpdateAsync(WaitUntil waitUntil, DeviceRegistryNamespaceDiscoveredDeviceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _namespaceDiscoveredDevicesRestClient.CreateCreateOrReplaceRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, DeviceRegistryNamespaceDiscoveredDeviceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DeviceRegistryArmOperation<DeviceRegistryNamespaceDiscoveredDeviceResource> operation = new DeviceRegistryArmOperation<DeviceRegistryNamespaceDiscoveredDeviceResource>(
                    new DeviceRegistryNamespaceDiscoveredDeviceResourceOperationSource(Client),
                    _namespaceDiscoveredDevicesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DeviceRegistryNamespaceDiscoveredDeviceResource> Update(WaitUntil waitUntil, DeviceRegistryNamespaceDiscoveredDeviceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
