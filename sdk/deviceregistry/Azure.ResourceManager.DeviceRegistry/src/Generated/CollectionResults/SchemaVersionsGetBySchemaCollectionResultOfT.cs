...
{
    internal partial class SchemaVersionsGetBySchemaCollectionResultOfT : Pageable<DeviceRegistrySchemaVersionData>
    {
        ...
        public override IEnumerable<Page<DeviceRegistrySchemaVersionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
