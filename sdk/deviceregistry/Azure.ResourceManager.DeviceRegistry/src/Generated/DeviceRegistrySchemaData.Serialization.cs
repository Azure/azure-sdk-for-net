...
namespace Azure.ResourceManager.DeviceRegistry
{
    ...
    public partial class DeviceRegistrySchemaData : ResourceData, IJsonModel<DeviceRegistrySchemaData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeviceRegistrySchemaData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeviceRegistrySchemaData IJsonModel<DeviceRegistrySchemaData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DeviceRegistrySchemaData)JsonModelCreateCore(ref reader, options);
        ...
        protected virtual ResourceData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeviceRegistrySchemaData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DeviceRegistrySchemaData DeserializeDeviceRegistrySchemaData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = DeviceRegistrySchemaProperties.DeserializeDeviceRegistrySchemaProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DeviceRegistrySchemaData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DeviceRegistrySchemaData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        /// <param name="deviceRegistrySchemaData"> The <see cref="DeviceRegistrySchemaData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(DeviceRegistrySchemaData deviceRegistrySchemaData)
        {
            if (deviceRegistrySchemaData == null)
            {
                return null;
            }
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="DeviceRegistrySchemaData"/> from. </param>
        internal static DeviceRegistrySchemaData FromResponse(Response result)
        {
