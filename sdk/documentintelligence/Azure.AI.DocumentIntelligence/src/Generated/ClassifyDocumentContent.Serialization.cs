...
{
    public partial class ClassifyDocumentContent : IUtf8JsonWriteable, IJsonModel<ClassifyDocumentContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClassifyDocumentContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ClassifyDocumentContent FromResponse(PipelineResponse response)
        {
