...
namespace Azure.AI.DocumentIntelligence
{
    public partial class ClassifyDocumentContent : IUtf8JsonSerializable, IJsonModel<ClassifyDocumentContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ClassifyDocumentContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ClassifyDocumentContent FromResponse(Response response)
        {
            ...
            return DeserializeClassifyDocumentContent(document.RootElement, new ModelReaderWriterOptions("W"));
        }
