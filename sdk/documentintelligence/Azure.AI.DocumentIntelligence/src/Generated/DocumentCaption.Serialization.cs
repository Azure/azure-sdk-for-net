...
{
    public partial class DocumentCaption : IUtf8JsonWriteable, IJsonModel<DocumentCaption>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentCaption>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentCaption FromResponse(PipelineResponse response)
        {
