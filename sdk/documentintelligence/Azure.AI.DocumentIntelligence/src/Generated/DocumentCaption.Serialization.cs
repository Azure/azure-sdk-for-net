...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentCaption : IUtf8JsonSerializable, IJsonModel<DocumentCaption>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentCaption>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DocumentCaption FromResponse(Response response)
        {
            ...
            return DeserializeDocumentCaption(document.RootElement, new ModelReaderWriterOptions("W"));
        }
