...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentCaption>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentCaption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentCaption>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentCaption>)} interface");
            }
        ...
        string IPersistableModel<DocumentCaption>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DocumentCaption FromResponse(Response response)
        {
            ...
            return DeserializeDocumentCaption(document.RootElement, ModelReaderWriterOptions.Wire);
        }
