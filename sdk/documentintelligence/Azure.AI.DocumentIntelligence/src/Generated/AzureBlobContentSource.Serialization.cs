...
{
    public partial class AzureBlobContentSource : IUtf8JsonWriteable, IJsonModel<AzureBlobContentSource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureBlobContentSource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AzureBlobContentSource FromResponse(PipelineResponse response)
        {
