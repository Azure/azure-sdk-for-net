...
namespace Azure.AI.DocumentIntelligence
{
    public partial class AzureBlobFileListContentSource : IUtf8JsonSerializable, IJsonModel<AzureBlobFileListContentSource>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureBlobFileListContentSource>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static AzureBlobFileListContentSource FromResponse(Response response)
        {
            ...
            return DeserializeAzureBlobFileListContentSource(document.RootElement, new ModelReaderWriterOptions("W"));
        }
