...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureBlobFileListContentSource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureBlobFileListContentSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureBlobFileListContentSource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureBlobFileListContentSource>)} interface");
            }
        ...
        string IPersistableModel<AzureBlobFileListContentSource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AzureBlobFileListContentSource FromResponse(Response response)
        {
            ...
            return DeserializeAzureBlobFileListContentSource(document.RootElement, ModelReaderWriterOptions.Wire);
        }
