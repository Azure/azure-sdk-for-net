...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public abstract partial class DocumentIntelligenceOperationDetails : IJsonModel<DocumentIntelligenceOperationDetails>
    {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="DocumentIntelligenceOperationDetails"/> from. </param>
        public static explicit operator DocumentIntelligenceOperationDetails(Response result)
        {
