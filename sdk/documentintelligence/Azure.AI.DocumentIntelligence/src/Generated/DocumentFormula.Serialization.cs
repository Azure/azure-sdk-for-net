...
{
    public partial class DocumentFormula : IUtf8JsonWriteable, IJsonModel<DocumentFormula>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentFormula>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentFormula FromResponse(PipelineResponse response)
        {
