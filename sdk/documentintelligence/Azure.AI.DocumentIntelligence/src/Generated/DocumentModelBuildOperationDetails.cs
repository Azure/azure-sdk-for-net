...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentModelBuildOperationDetails : OperationDetails
    {
        ...
        internal DocumentModelBuildOperationDetails(OperationStatus status, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, Uri resourceLocation) : base(status, createdDateTime, lastUpdatedDateTime, resourceLocation)
        {
