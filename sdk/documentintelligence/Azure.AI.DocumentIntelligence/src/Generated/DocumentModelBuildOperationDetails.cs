...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentModelBuildOperationDetails : OperationDetails
    {
        ...
        internal DocumentModelBuildOperationDetails(OperationStatus status, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, Uri resourceLocation, OperationKind kind) : base(status, createdOn, lastUpdatedOn, resourceLocation)
        {
