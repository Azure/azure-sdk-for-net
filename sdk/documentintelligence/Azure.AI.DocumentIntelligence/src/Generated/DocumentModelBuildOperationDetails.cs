...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentModelBuildOperationDetails : OperationDetails
    {
        ...
        internal DocumentModelBuildOperationDetails(Guid operationId, OperationStatus status, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, Uri resourceLocation) : base(operationId, status, createdDateTime, lastUpdatedDateTime, resourceLocation)
        {
