...
{
    public partial class DocumentClassifierDetails : IUtf8JsonWriteable, IJsonModel<DocumentClassifierDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentClassifierDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentClassifierDetails FromResponse(PipelineResponse response)
        {
