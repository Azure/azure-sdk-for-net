...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentModelComposeOperationDetails : IUtf8JsonSerializable, IJsonModel<DocumentModelComposeOperationDetails>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentModelComposeOperationDetails>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new DocumentModelComposeOperationDetails FromResponse(Response response)
        {
            ...
            return DeserializeDocumentModelComposeOperationDetails(document.RootElement, new ModelReaderWriterOptions("W"));
        }
