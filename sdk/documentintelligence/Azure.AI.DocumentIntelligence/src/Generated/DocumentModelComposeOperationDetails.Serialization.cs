...
{
    public partial class DocumentModelComposeOperationDetails : IUtf8JsonWriteable, IJsonModel<DocumentModelComposeOperationDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentModelComposeOperationDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new DocumentModelComposeOperationDetails FromResponse(PipelineResponse response)
        {
