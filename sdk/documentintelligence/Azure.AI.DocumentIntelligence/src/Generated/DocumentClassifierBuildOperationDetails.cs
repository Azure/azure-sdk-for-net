...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentClassifierBuildOperationDetails : OperationDetails
    {
        ...
        internal DocumentClassifierBuildOperationDetails(string operationId, OperationStatus status, int? percentCompleted, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, OperationKind kind, Uri resourceLocation, string apiVersion, IReadOnlyDictionary<string, string> tags, DocumentIntelligenceError error, DocumentClassifierDetails result) : base(operationId, status, percentCompleted, createdDateTime, lastUpdatedDateTime, kind, resourceLocation, apiVersion, tags, error)
        {
            Result = result;
        }
