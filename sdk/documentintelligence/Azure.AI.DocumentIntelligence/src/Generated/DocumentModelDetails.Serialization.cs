...
{
    public partial class DocumentModelDetails : IUtf8JsonWriteable, IJsonModel<DocumentModelDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentModelDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentModelDetails FromResponse(PipelineResponse response)
        {
