...
namespace Azure.AI.DocumentIntelligence
{
    public partial class AddressValue : IUtf8JsonSerializable, IJsonModel<AddressValue>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AddressValue>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static AddressValue FromResponse(Response response)
        {
            ...
            return DeserializeAddressValue(document.RootElement, new ModelReaderWriterOptions("W"));
        }
