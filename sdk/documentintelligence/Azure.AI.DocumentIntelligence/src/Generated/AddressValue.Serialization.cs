...
{
    public partial class AddressValue : IUtf8JsonWriteable, IJsonModel<AddressValue>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddressValue>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AddressValue FromResponse(PipelineResponse response)
        {
