...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddressValue>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AddressValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AddressValue>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AddressValue>)} interface");
            }
        ...
        string IPersistableModel<AddressValue>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AddressValue FromResponse(Response response)
        {
            ...
            return DeserializeAddressValue(document.RootElement, ModelReaderWriterOptions.Wire);
        }
