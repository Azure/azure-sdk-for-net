...
{
    internal partial class UnknownOperationDetails : IUtf8JsonWriteable, IJsonModel<OperationDetails>
    {
        ...
        internal static new UnknownOperationDetails FromResponse(PipelineResponse response)
        {
