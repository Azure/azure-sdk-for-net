...
{
    public partial class DocumentModelCopyToOperationDetails : IUtf8JsonWriteable, IJsonModel<DocumentModelCopyToOperationDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentModelCopyToOperationDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new DocumentModelCopyToOperationDetails FromResponse(PipelineResponse response)
        {
