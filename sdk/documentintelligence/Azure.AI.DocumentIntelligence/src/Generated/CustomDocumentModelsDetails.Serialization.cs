...
{
    public partial class CustomDocumentModelsDetails : IUtf8JsonWriteable, IJsonModel<CustomDocumentModelsDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomDocumentModelsDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CustomDocumentModelsDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomDocumentModelsDetails)} does not support '{format}' format.");
            }
        ...
        internal static CustomDocumentModelsDetails FromResponse(PipelineResponse response)
        {
