...
{
    public partial class DocumentTableCell : IUtf8JsonWriteable, IJsonModel<DocumentTableCell>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentTableCell>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentTableCell FromResponse(PipelineResponse response)
        {
