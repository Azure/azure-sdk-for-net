...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentTableCell
    {
        internal static DocumentTableCell DeserializeDocumentTableCell(JsonElement element)
        {
            ...
            return new DocumentTableCell(Optional.ToNullable(kind), rowIndex, columnIndex, Optional.ToNullable(rowSpan), Optional.ToNullable(columnSpan), content, Optional.ToList(boundingRegions), spans, Optional.ToList(elements));
        }
