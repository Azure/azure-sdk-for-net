...
{
    public partial class DocumentLanguage : IUtf8JsonWriteable, IJsonModel<DocumentLanguage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentLanguage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentLanguage FromResponse(PipelineResponse response)
        {
