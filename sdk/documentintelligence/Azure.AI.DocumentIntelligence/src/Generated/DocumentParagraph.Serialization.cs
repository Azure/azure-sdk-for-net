...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentParagraph>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentParagraph>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentParagraph>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentParagraph>)} interface");
            }
        ...
        string IPersistableModel<DocumentParagraph>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DocumentParagraph FromResponse(Response response)
        {
            ...
            return DeserializeDocumentParagraph(document.RootElement, ModelReaderWriterOptions.Wire);
        }
