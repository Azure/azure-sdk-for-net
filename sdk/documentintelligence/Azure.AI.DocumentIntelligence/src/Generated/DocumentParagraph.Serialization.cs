...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentParagraph : IUtf8JsonSerializable, IJsonModel<DocumentParagraph>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentParagraph>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DocumentParagraph FromResponse(Response response)
        {
            ...
            return DeserializeDocumentParagraph(document.RootElement, new ModelReaderWriterOptions("W"));
        }
