...
{
    public partial class DocumentParagraph : IUtf8JsonWriteable, IJsonModel<DocumentParagraph>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentParagraph>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentParagraph FromResponse(PipelineResponse response)
        {
