...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QuotaDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QuotaDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QuotaDetails>)} interface");
            }
        ...
        string IPersistableModel<QuotaDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static QuotaDetails FromResponse(Response response)
        {
            ...
            return DeserializeQuotaDetails(document.RootElement, ModelReaderWriterOptions.Wire);
        }
