...
namespace Azure.AI.DocumentIntelligence
{
    public partial class QuotaDetails : IUtf8JsonSerializable, IJsonModel<QuotaDetails>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<QuotaDetails>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static QuotaDetails FromResponse(Response response)
        {
            ...
            return DeserializeQuotaDetails(document.RootElement, new ModelReaderWriterOptions("W"));
        }
