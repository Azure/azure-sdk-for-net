...
{
    public partial class QuotaDetails : IUtf8JsonWriteable, IJsonModel<QuotaDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static QuotaDetails FromResponse(PipelineResponse response)
        {
