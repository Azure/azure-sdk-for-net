...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public static partial class DocumentIntelligenceModelFactory
    {
        ...
        public static AnalyzedDocument AnalyzedDocument(string documentType, IEnumerable<BoundingRegion> boundingRegions, IEnumerable<DocumentSpan> spans, IReadOnlyDictionary<string, DocumentField> fieldsPrivate, float confidence = default)
        {
            boundingRegions ??= new ChangeTrackingList<BoundingRegion>();
            spans ??= new ChangeTrackingList<DocumentSpan>();
