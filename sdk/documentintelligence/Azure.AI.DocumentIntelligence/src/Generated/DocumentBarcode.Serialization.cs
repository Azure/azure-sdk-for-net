...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentBarcode>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentBarcode>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentBarcode>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentBarcode>)} interface");
            }
        ...
        string IPersistableModel<DocumentBarcode>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DocumentBarcode FromResponse(Response response)
        {
            ...
            return DeserializeDocumentBarcode(document.RootElement, ModelReaderWriterOptions.Wire);
        }
