...
{
    public partial class DocumentBarcode : IUtf8JsonWriteable, IJsonModel<DocumentBarcode>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentBarcode>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentBarcode FromResponse(PipelineResponse response)
        {
