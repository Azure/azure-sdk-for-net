...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentBarcode : IUtf8JsonSerializable, IJsonModel<DocumentBarcode>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentBarcode>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DocumentBarcode FromResponse(Response response)
        {
            ...
            return DeserializeDocumentBarcode(document.RootElement, new ModelReaderWriterOptions("W"));
        }
