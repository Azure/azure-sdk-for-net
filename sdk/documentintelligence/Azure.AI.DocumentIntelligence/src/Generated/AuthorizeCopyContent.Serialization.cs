...
namespace Azure.AI.DocumentIntelligence
{
    public partial class AuthorizeCopyContent : IUtf8JsonSerializable, IJsonModel<AuthorizeCopyContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AuthorizeCopyContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static AuthorizeCopyContent FromResponse(Response response)
        {
            ...
            return DeserializeAuthorizeCopyContent(document.RootElement, new ModelReaderWriterOptions("W"));
        }
