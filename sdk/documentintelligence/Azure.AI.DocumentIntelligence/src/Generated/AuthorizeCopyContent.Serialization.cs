...
{
    public partial class AuthorizeCopyContent : IUtf8JsonWriteable, IJsonModel<AuthorizeCopyContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuthorizeCopyContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AuthorizeCopyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AuthorizeCopyContent)} does not support '{format}' format.");
            }
        ...
        internal static AuthorizeCopyContent DeserializeAuthorizeCopyContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AuthorizeCopyContent(modelId, description, tags ?? new OptionalDictionary<string, string>(), serializedAdditionalRawData);
        }
        ...
        internal static AuthorizeCopyContent FromResponse(PipelineResponse response)
        {
