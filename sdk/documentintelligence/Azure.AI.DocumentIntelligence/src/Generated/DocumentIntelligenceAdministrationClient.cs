...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentIntelligenceAdministrationClient
    {
        ...
        /// <remarks> Authorize model copy. </remarks>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <remarks> Get resource info. </remarks>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="authorizeCopyRequest"/> is null. </exception>
        /// <remarks> Authorize classifier copy. </remarks>
        ...
        /// <remarks> Get classifier. </remarks>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <remarks> List operations. </remarks>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <remarks> List classifiers. </remarks>
        ...
        /// <remarks> Build document model. </remarks>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="buildRequest"/> is null. </exception>
        /// <remarks> Build classifier. </remarks>
        ...
        /// <exception cref="ArgumentException"> <paramref name="classifierId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <remarks> Copy classifier to. </remarks>
        ...
        /// <include file="Docs/DocumentIntelligenceAdministrationClient.xml" path="doc/members/member[@name='CopyClassifierToAsync(WaitUntil,string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Operation<BinaryData>> CopyClassifierToAsync(WaitUntil waitUntil, string classifierId, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "DocumentIntelligenceAdministrationClient.CopyClassifierTo", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        /// <include file="Docs/DocumentIntelligenceAdministrationClient.xml" path="doc/members/member[@name='CopyClassifierTo(WaitUntil,string,RequestContent,RequestContext)']/*" />
        public virtual Operation<BinaryData> CopyClassifierTo(WaitUntil waitUntil, string classifierId, RequestContent content, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateCopyClassifierToRequest(classifierId, content, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "DocumentIntelligenceAdministrationClient.CopyClassifierTo", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
