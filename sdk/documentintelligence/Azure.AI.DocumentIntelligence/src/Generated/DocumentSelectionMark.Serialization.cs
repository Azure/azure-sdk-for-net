...
{
    public partial class DocumentSelectionMark : IUtf8JsonWriteable, IJsonModel<DocumentSelectionMark>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentSelectionMark>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentSelectionMark FromResponse(PipelineResponse response)
        {
