...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentSelectionMark>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentSelectionMark>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentSelectionMark>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentSelectionMark>)} interface");
            }
        ...
        string IPersistableModel<DocumentSelectionMark>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DocumentSelectionMark FromResponse(Response response)
        {
            ...
            return DeserializeDocumentSelectionMark(document.RootElement, ModelReaderWriterOptions.Wire);
        }
