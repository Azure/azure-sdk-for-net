...
{
    public partial class ResourceDetails : IUtf8JsonWriteable, IJsonModel<ResourceDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ResourceDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceDetails)} does not support '{format}' format.");
            }
        ...
        internal static ResourceDetails FromResponse(PipelineResponse response)
        {
