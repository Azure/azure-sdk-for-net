...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ResourceDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ResourceDetails FromResponse(Response response)
        {
            ...
            return DeserializeResourceDetails(document.RootElement, ModelReaderWriterOptions.Wire);
        }
