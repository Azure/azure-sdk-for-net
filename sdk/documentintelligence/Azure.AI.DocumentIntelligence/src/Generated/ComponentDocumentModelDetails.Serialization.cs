...
{
    public partial class ComponentDocumentModelDetails : IUtf8JsonWriteable, IJsonModel<ComponentDocumentModelDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComponentDocumentModelDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ComponentDocumentModelDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ComponentDocumentModelDetails)} does not support '{format}' format.");
            }
        ...
        internal static ComponentDocumentModelDetails FromResponse(PipelineResponse response)
        {
