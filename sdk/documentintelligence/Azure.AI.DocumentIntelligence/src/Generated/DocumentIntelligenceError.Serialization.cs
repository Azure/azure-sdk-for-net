...
{
    public partial class DocumentIntelligenceError : IUtf8JsonWriteable, IJsonModel<DocumentIntelligenceError>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentIntelligenceError>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentIntelligenceError FromResponse(PipelineResponse response)
        {
