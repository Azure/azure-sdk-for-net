...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentIntelligenceError : IUtf8JsonSerializable, IJsonModel<DocumentIntelligenceError>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentIntelligenceError>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DocumentIntelligenceError FromResponse(Response response)
        {
            ...
            return DeserializeDocumentIntelligenceError(document.RootElement, new ModelReaderWriterOptions("W"));
        }
