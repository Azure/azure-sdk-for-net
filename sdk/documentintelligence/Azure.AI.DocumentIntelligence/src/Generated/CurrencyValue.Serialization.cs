...
{
    public partial class CurrencyValue : IUtf8JsonWriteable, IJsonModel<CurrencyValue>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CurrencyValue>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CurrencyValue FromResponse(PipelineResponse response)
        {
