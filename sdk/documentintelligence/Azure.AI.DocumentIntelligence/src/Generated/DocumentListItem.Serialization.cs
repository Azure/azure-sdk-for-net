...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentListItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentListItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentListItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentListItem>)} interface");
            }
        ...
        string IPersistableModel<DocumentListItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DocumentListItem FromResponse(Response response)
        {
            ...
            return DeserializeDocumentListItem(document.RootElement, ModelReaderWriterOptions.Wire);
        }
