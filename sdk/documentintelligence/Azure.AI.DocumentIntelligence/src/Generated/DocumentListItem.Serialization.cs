...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentListItem : IUtf8JsonSerializable, IJsonModel<DocumentListItem>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentListItem>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DocumentListItem FromResponse(Response response)
        {
            ...
            return DeserializeDocumentListItem(document.RootElement, new ModelReaderWriterOptions("W"));
        }
