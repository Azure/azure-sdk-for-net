...
{
    public partial class DocumentListItem : IUtf8JsonWriteable, IJsonModel<DocumentListItem>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentListItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentListItem FromResponse(PipelineResponse response)
        {
