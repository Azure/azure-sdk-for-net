...
{
    public partial class AnalyzedDocument : IUtf8JsonWriteable, IJsonModel<AnalyzedDocument>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalyzedDocument>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AnalyzedDocument DeserializeAnalyzedDocument(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AnalyzedDocument(
                ...
                spans,
                fields ?? new OptionalDictionary<string, DocumentField>(),
                confidence,
        ...
        internal static AnalyzedDocument FromResponse(PipelineResponse response)
        {
