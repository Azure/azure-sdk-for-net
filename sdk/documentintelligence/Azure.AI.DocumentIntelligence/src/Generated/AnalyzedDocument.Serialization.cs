...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalyzedDocument>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnalyzedDocument>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnalyzedDocument>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AnalyzedDocument>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AnalyzedDocument FromResponse(Response response)
        {
            ...
            return DeserializeAnalyzedDocument(document.RootElement, ModelReaderWriterOptions.Wire);
        }
