...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class ChatIndexBuildOperationDetails : OperationDetails
    {
        ...
        internal ChatIndexBuildOperationDetails(OperationStatus status, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, Uri resourceLocation) : base(status, createdDateTime, lastUpdatedDateTime, resourceLocation)
        {
            Argument.AssertNotNull(resourceLocation, nameof(resourceLocation));

            Kind = OperationKind.ChatBuild;
        }
        ...
        internal ChatIndexBuildOperationDetails(Guid operationId, OperationStatus status, int? percentCompleted, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, OperationKind kind, Uri resourceLocation, string apiVersion, IReadOnlyDictionary<string, string> tags, DocumentIntelligenceError error, ChatIndexDetails result) : base(operationId, status, percentCompleted, createdDateTime, lastUpdatedDateTime, kind, resourceLocation, apiVersion, tags, error)
        {
            Result = result;
        }

        /// <summary> Operation result upon success. </summary>
        public ChatIndexDetails Result { get; }
    }
}
