...
{
    public partial class DocumentKeyValuePair : IUtf8JsonWriteable, IJsonModel<DocumentKeyValuePair>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentKeyValuePair>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentKeyValuePair FromResponse(PipelineResponse response)
        {
