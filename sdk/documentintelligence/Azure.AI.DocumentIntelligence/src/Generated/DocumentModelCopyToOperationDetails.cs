...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentModelCopyToOperationDetails : OperationDetails
    {
        ...
        internal DocumentModelCopyToOperationDetails(OperationStatus status, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, Uri resourceLocation) : base(status, createdOn, lastUpdatedOn, resourceLocation)
        {
