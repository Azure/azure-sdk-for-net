...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentModelCopyToOperationDetails : OperationDetails
    {
        ...
        internal DocumentModelCopyToOperationDetails(OperationStatus status, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, Uri resourceLocation) : base(status, createdDateTime, lastUpdatedDateTime, resourceLocation)
        {
