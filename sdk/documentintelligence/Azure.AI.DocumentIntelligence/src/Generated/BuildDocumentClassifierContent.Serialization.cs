...
namespace Azure.AI.DocumentIntelligence
{
    public partial class BuildDocumentClassifierContent : IUtf8JsonSerializable, IJsonModel<BuildDocumentClassifierContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BuildDocumentClassifierContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static BuildDocumentClassifierContent FromResponse(Response response)
        {
            ...
            return DeserializeBuildDocumentClassifierContent(document.RootElement, new ModelReaderWriterOptions("W"));
        }
