...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BuildDocumentClassifierContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BuildDocumentClassifierContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BuildDocumentClassifierContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BuildDocumentClassifierContent>)} interface");
            }
        ...
        string IPersistableModel<BuildDocumentClassifierContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static BuildDocumentClassifierContent FromResponse(Response response)
        {
            ...
            return DeserializeBuildDocumentClassifierContent(document.RootElement, ModelReaderWriterOptions.Wire);
        }
