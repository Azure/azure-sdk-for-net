...
{
    public partial class BuildDocumentClassifierContent : IUtf8JsonWriteable, IJsonModel<BuildDocumentClassifierContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<BuildDocumentClassifierContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static BuildDocumentClassifierContent FromResponse(PipelineResponse response)
        {
