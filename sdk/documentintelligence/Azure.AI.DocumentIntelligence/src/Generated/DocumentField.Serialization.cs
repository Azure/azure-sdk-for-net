...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentField>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentField>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentField>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DocumentField>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DocumentField FromResponse(Response response)
        {
            ...
            return DeserializeDocumentField(document.RootElement, ModelReaderWriterOptions.Wire);
        }
