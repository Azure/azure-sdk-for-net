...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentField : IUtf8JsonSerializable, IJsonModel<DocumentField>
    {
        ...
        void IJsonModel<DocumentField>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DocumentField)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DocumentField>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DocumentField)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static DocumentField FromResponse(Response response)
        {
            ...
            return DeserializeDocumentField(document.RootElement, new ModelReaderWriterOptions("W"));
        }
