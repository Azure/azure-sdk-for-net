...
{
    public partial class DocumentField : IUtf8JsonWriteable, IJsonModel<DocumentField>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentField>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentField DeserializeDocumentField(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DocumentField(
                ...
                valueObject ?? new OptionalDictionary<string, DocumentField>(),
                valueCurrency,
                valueAddress,
                valueBoolean,
        ...
        internal static DocumentField FromResponse(PipelineResponse response)
        {
