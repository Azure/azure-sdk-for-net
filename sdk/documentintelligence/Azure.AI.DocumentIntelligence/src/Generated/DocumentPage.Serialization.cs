...
{
    public partial class DocumentPage : IUtf8JsonWriteable, IJsonModel<DocumentPage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentPage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentPage FromResponse(PipelineResponse response)
        {
