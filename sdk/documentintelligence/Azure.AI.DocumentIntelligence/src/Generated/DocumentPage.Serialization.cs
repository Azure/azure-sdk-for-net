...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentPage : IUtf8JsonSerializable, IJsonModel<DocumentPage>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentPage>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DocumentPage FromResponse(Response response)
        {
            ...
            return DeserializeDocumentPage(document.RootElement, new ModelReaderWriterOptions("W"));
        }
