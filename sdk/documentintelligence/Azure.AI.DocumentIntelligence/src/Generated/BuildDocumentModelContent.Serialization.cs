...
{
    public partial class BuildDocumentModelContent : IUtf8JsonWriteable, IJsonModel<BuildDocumentModelContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<BuildDocumentModelContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static BuildDocumentModelContent FromResponse(PipelineResponse response)
        {
