...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BuildDocumentModelContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BuildDocumentModelContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BuildDocumentModelContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BuildDocumentModelContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static BuildDocumentModelContent FromResponse(Response response)
        {
            ...
            return DeserializeBuildDocumentModelContent(document.RootElement, ModelReaderWriterOptions.Wire);
        }
