...
{
    public partial class DocumentFieldSchema : IUtf8JsonWriteable, IJsonModel<DocumentFieldSchema>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentFieldSchema>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentFieldSchema FromResponse(PipelineResponse response)
        {
