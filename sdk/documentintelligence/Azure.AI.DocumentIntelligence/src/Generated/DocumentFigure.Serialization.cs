...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentFigure : IUtf8JsonSerializable, IJsonModel<DocumentFigure>
    {
        ...
        void IJsonModel<DocumentFigure>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DocumentFigure)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DocumentFigure>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DocumentFigure)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static DocumentFigure FromResponse(Response response)
        {
            ...
            return DeserializeDocumentFigure(document.RootElement, new ModelReaderWriterOptions("W"));
        }
