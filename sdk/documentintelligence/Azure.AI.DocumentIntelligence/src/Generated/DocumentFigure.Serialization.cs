...
{
    public partial class DocumentFigure : IUtf8JsonWriteable, IJsonModel<DocumentFigure>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentFigure>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentFigure FromResponse(PipelineResponse response)
        {
