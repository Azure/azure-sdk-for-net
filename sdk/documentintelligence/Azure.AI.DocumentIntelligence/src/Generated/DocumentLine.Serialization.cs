...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentLine : IUtf8JsonSerializable, IJsonModel<DocumentLine>
    {
        ...
        void IJsonModel<DocumentLine>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DocumentLine)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DocumentLine>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DocumentLine)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static DocumentLine FromResponse(Response response)
        {
            ...
            return DeserializeDocumentLine(document.RootElement, new ModelReaderWriterOptions("W"));
        }
