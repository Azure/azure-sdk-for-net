...
{
    public partial class DocumentSection : IUtf8JsonWriteable, IJsonModel<DocumentSection>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentSection>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentSection FromResponse(PipelineResponse response)
        {
