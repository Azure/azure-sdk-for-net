...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentSection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentSection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentSection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentSection>)} interface");
            }
        ...
        string IPersistableModel<DocumentSection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DocumentSection FromResponse(Response response)
        {
            ...
            return DeserializeDocumentSection(document.RootElement, ModelReaderWriterOptions.Wire);
        }
