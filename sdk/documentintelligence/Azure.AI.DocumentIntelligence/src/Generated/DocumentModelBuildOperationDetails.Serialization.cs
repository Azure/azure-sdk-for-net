...
{
    public partial class DocumentModelBuildOperationDetails : IUtf8JsonWriteable, IJsonModel<DocumentModelBuildOperationDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentModelBuildOperationDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new DocumentModelBuildOperationDetails FromResponse(PipelineResponse response)
        {
