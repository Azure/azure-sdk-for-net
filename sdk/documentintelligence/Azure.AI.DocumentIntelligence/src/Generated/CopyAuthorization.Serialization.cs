...
{
    public partial class CopyAuthorization : IUtf8JsonWriteable, IJsonModel<CopyAuthorization>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CopyAuthorization>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CopyAuthorization FromResponse(PipelineResponse response)
        {
