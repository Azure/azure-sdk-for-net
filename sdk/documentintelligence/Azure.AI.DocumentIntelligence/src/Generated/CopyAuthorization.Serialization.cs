...
namespace Azure.AI.DocumentIntelligence
{
    public partial class CopyAuthorization : IUtf8JsonSerializable, IJsonModel<CopyAuthorization>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CopyAuthorization>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static CopyAuthorization FromResponse(Response response)
        {
            ...
            return DeserializeCopyAuthorization(document.RootElement, new ModelReaderWriterOptions("W"));
        }
