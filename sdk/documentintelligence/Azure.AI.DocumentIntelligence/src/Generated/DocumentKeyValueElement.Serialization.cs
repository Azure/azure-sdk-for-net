...
{
    public partial class DocumentKeyValueElement : IUtf8JsonWriteable, IJsonModel<DocumentKeyValueElement>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentKeyValueElement>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentKeyValueElement FromResponse(PipelineResponse response)
        {
