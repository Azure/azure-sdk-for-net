...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentKeyValueElement>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentKeyValueElement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentKeyValueElement>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentKeyValueElement>)} interface");
            }
        ...
        internal static DocumentKeyValueElement DeserializeDocumentKeyValueElement(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DocumentKeyValueElement(content, Optional.ToList(boundingRegions), spans, serializedAdditionalRawData);
        }
        ...
        string IPersistableModel<DocumentKeyValueElement>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DocumentKeyValueElement FromResponse(Response response)
        {
            ...
            return DeserializeDocumentKeyValueElement(document.RootElement, ModelReaderWriterOptions.Wire);
        }
