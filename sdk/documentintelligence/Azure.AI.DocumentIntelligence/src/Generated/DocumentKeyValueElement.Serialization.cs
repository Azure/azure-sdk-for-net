...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentKeyValueElement : IUtf8JsonSerializable, IJsonModel<DocumentKeyValueElement>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentKeyValueElement>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DocumentKeyValueElement FromResponse(Response response)
        {
            ...
            return DeserializeDocumentKeyValueElement(document.RootElement, new ModelReaderWriterOptions("W"));
        }
