...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class OperationDetails : IUtf8JsonWriteable, IJsonModel<OperationDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static OperationDetails FromResponse(PipelineResponse response)
        {
