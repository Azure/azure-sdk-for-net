...
namespace Azure.AI.DocumentIntelligence
{
    public partial class BoundingRegion : IUtf8JsonSerializable, IJsonModel<BoundingRegion>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BoundingRegion>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static BoundingRegion FromResponse(Response response)
        {
            ...
            return DeserializeBoundingRegion(document.RootElement, new ModelReaderWriterOptions("W"));
        }
