...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BoundingRegion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BoundingRegion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BoundingRegion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BoundingRegion>)} interface");
            }
        ...
        string IPersistableModel<BoundingRegion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static BoundingRegion FromResponse(Response response)
        {
            ...
            return DeserializeBoundingRegion(document.RootElement, ModelReaderWriterOptions.Wire);
        }
