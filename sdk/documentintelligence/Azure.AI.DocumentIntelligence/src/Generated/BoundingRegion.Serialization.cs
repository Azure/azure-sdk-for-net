...
{
    public partial class BoundingRegion : IUtf8JsonWriteable, IJsonModel<BoundingRegion>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<BoundingRegion>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static BoundingRegion FromResponse(PipelineResponse response)
        {
