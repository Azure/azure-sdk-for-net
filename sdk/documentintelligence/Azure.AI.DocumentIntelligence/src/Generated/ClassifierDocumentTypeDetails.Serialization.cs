...
namespace Azure.AI.DocumentIntelligence
{
    public partial class ClassifierDocumentTypeDetails : IUtf8JsonSerializable, IJsonModel<ClassifierDocumentTypeDetails>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ClassifierDocumentTypeDetails>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ClassifierDocumentTypeDetails FromResponse(Response response)
        {
            ...
            return DeserializeClassifierDocumentTypeDetails(document.RootElement, new ModelReaderWriterOptions("W"));
        }
