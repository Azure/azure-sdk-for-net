...
{
    public partial class ClassifierDocumentTypeDetails : IUtf8JsonWriteable, IJsonModel<ClassifierDocumentTypeDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClassifierDocumentTypeDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ClassifierDocumentTypeDetails FromResponse(PipelineResponse response)
        {
