...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentField
    {
        ...
        internal DocumentField(DocumentFieldType fieldType, string valueString, DateTimeOffset? valueDate, TimeSpan? valueTime, string valuePhoneNumber, double? valueDouble, long? valueInt64, DocumentSelectionMarkState? valueSelectionMark, DocumentSignatureType? valueSignature, string valueCountryRegion, IList<DocumentField> valueList, IReadOnlyDictionary<string, DocumentField> valueObject, CurrencyValue valueCurrency, AddressValue valueAddress, bool? valueBoolean, IList<string> valueSelectionGroup, string content, IList<BoundingRegion> boundingRegions, IList<DocumentSpan> spans, float? confidence, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            FieldType = fieldType;
