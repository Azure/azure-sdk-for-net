...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentModelCopyToOperationDetails : DocumentIntelligenceOperationDetails
    {
        ...
        internal DocumentModelCopyToOperationDetails(string operationId, DocumentIntelligenceOperationStatus status, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, Uri resourceLocation) : base(operationId, status, createdOn, lastUpdatedOn, OperationKind.DocumentModelCopyTo, resourceLocation)
        {
        }
