...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentKeyValueElement
    {
        ...
        internal DocumentKeyValueElement(string content, IList<BoundingRegion> boundingRegions, IList<DocumentSpan> spans, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Content = content;
