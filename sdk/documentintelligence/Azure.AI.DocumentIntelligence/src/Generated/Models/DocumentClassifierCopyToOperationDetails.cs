...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentClassifierCopyToOperationDetails : DocumentIntelligenceOperationDetails
    {
        ...
        internal DocumentClassifierCopyToOperationDetails(string operationId, DocumentIntelligenceOperationStatus status, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, Uri resourceLocation) : base(operationId, status, createdOn, lastUpdatedOn, OperationKind.DocumentClassifierCopyTo, resourceLocation)
        {
        }
