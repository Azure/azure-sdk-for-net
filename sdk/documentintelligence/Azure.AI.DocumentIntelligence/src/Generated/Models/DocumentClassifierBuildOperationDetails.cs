...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentClassifierBuildOperationDetails : DocumentIntelligenceOperationDetails
    {
        ...
        internal DocumentClassifierBuildOperationDetails(string operationId, DocumentIntelligenceOperationStatus status, DateTimeOffset createdOn, DateTimeOffset lastUpdatedOn, Uri resourceLocation) : base(operationId, status, createdOn, lastUpdatedOn, OperationKind.DocumentClassifierBuild, resourceLocation)
        {
        }
