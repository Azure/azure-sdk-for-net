...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public readonly partial struct DocumentBarcodeKind : IEquatable<global::Azure.AI.DocumentIntelligence.DocumentBarcodeKind>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.DocumentIntelligence.DocumentBarcodeKind"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.AI.DocumentIntelligence.DocumentBarcodeKind"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(DocumentBarcodeKind left, DocumentBarcodeKind right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.AI.DocumentIntelligence.DocumentBarcodeKind"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(DocumentBarcodeKind left, DocumentBarcodeKind right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.AI.DocumentIntelligence.DocumentBarcodeKind"/>. </summary>
        /// <param name="value"> The value. </param>
