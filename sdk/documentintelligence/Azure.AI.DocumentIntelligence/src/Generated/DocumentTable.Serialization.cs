...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentTable : IUtf8JsonSerializable, IJsonModel<DocumentTable>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentTable>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DocumentTable FromResponse(Response response)
        {
            ...
            return DeserializeDocumentTable(document.RootElement, new ModelReaderWriterOptions("W"));
        }
