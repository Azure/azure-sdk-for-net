...
{
    public partial class ComposeDocumentModelContent : IUtf8JsonWriteable, IJsonModel<ComposeDocumentModelContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComposeDocumentModelContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ComposeDocumentModelContent DeserializeComposeDocumentModelContent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ComposeDocumentModelContent(modelId, description, componentModels, tags ?? new OptionalDictionary<string, string>(), serializedAdditionalRawData);
        }
        ...
        internal static ComposeDocumentModelContent FromResponse(PipelineResponse response)
        {
