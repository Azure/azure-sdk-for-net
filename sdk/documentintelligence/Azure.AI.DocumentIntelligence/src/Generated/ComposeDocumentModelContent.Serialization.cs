...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComposeDocumentModelContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComposeDocumentModelContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComposeDocumentModelContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComposeDocumentModelContent>)} interface");
            }
        ...
        string IPersistableModel<ComposeDocumentModelContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ComposeDocumentModelContent FromResponse(Response response)
        {
            ...
            return DeserializeComposeDocumentModelContent(document.RootElement, ModelReaderWriterOptions.Wire);
        }
