...
namespace Azure.AI.DocumentIntelligence
{
    public partial class ComposeDocumentModelContent : IUtf8JsonSerializable, IJsonModel<ComposeDocumentModelContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ComposeDocumentModelContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ComposeDocumentModelContent FromResponse(Response response)
        {
            ...
            return DeserializeComposeDocumentModelContent(document.RootElement, new ModelReaderWriterOptions("W"));
        }
