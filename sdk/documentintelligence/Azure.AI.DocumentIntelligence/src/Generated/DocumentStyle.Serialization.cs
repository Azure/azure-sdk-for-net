...
namespace Azure.AI.DocumentIntelligence
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentStyle>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentStyle>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentStyle>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentStyle>)} interface");
            }
        ...
        string IPersistableModel<DocumentStyle>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DocumentStyle FromResponse(Response response)
        {
            ...
            return DeserializeDocumentStyle(document.RootElement, ModelReaderWriterOptions.Wire);
        }
