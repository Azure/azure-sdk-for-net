...
{
    public partial class DocumentStyle : IUtf8JsonWriteable, IJsonModel<DocumentStyle>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentStyle>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentStyle FromResponse(PipelineResponse response)
        {
