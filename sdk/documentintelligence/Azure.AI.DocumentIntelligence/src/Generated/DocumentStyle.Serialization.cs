...
namespace Azure.AI.DocumentIntelligence
{
    public partial class DocumentStyle : IUtf8JsonSerializable, IJsonModel<DocumentStyle>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentStyle>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DocumentStyle FromResponse(Response response)
        {
            ...
            return DeserializeDocumentStyle(document.RootElement, new ModelReaderWriterOptions("W"));
        }
