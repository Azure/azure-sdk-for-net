...
namespace Azure.AI.DocumentIntelligence
{
    ...
    public partial class DocumentModelComposeOperationDetails : OperationDetails
    {
        ...
        internal DocumentModelComposeOperationDetails(OperationStatus status, DateTimeOffset createdDateTime, DateTimeOffset lastUpdatedDateTime, Uri resourceLocation) : base(status, createdDateTime, lastUpdatedDateTime, resourceLocation)
        {
