...
namespace Azure.AI.Speech.Transcription
{
    internal partial class MultiPartFormDataBinaryContent : BinaryContent
    {
        ...
        {
            _multipartContent = new MultipartFormDataContent(global::Azure.AI.Speech.Transcription.MultiPartFormDataBinaryContent.CreateBoundary());
        }
        ...
        {
            global::Azure.AI.Speech.Transcription.Argument.AssertNotNull(content, nameof(content));
            global::Azure.AI.Speech.Transcription.Argument.AssertNotNullOrEmpty(name, nameof(name));
        ...
        private void Add(HttpContent content, string name, string filename, string contentType)
        {
            if ((contentType != null))
            {
                global::Azure.AI.Speech.Transcription.Argument.AssertNotNullOrEmpty(contentType, nameof(contentType));
                global::Azure.AI.Speech.Transcription.MultiPartFormDataBinaryContent.AddContentTypeHeader(content, contentType);
            }
            if ((filename != null))
            {
                global::Azure.AI.Speech.Transcription.Argument.AssertNotNullOrEmpty(filename, nameof(filename));
