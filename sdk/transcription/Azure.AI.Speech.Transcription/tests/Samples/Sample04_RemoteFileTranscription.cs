    ...
    public partial class Sample04_RemoteFileTranscription : TranscriptionSampleBase
    {
        ...
        public async Task TranscribeWithUrlFallback()
        {
            ...
            catch (RequestFailedException ex) when (ex.Status == 400)
            {
                ...
                TranscriptionOptions streamOptions = new TranscriptionOptions(audioStream);

                ClientResult<TranscriptionResult> response = await client.TranscribeAsync(streamOptions);
                TranscriptionResult result = response.Value;
        ...
        public async Task TranscribeMultipleRemoteFiles()
        {
            ...
            Task<ClientResult<TranscriptionResult>>[] transcriptionTasks = audioUrls
                .Select(url =>
                {
            ...
            ClientResult<TranscriptionResult>[] responses = await Task.WhenAll(transcriptionTasks);
