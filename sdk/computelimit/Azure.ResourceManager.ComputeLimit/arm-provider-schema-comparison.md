...
#### List and action operations differences: `/subscriptions/{subscriptionId}/providers/Microsoft.ComputeLimit/locations/{location}/features/{featureName}`
...
| --- | --- | --- |
| `/subscriptions/{}/providers/microsoft.computelimit/locations/{}/features/{}` | `ComputeLimitFeature` | `Feature` |
| `/subscriptions/{}/providers/microsoft.computelimit/locations/{}/guestsubscriptions/{}` | `ComputeLimitGuestSubscription` | `GuestSubscription` |
| `/subscriptions/{}/providers/microsoft.computelimit/locations/{}/sharedlimits/{}` | `ComputeLimitSharedLimit` | `SharedLimit` |
| `/subscriptions/{}/providers/microsoft.computelimit/locations/{}/vmfamilies/{}` | `ComputeLimitVmFamily` | `VmFamily` |
