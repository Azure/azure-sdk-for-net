...
namespace Azure.ResourceManager.ComputeLimit.Models
{
    ...
    public partial class ComputeLimitLimitName : IJsonModel<ComputeLimitLimitName>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeLimitLimitName>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ComputeLimitLimitName IJsonModel<ComputeLimitLimitName>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ComputeLimitLimitName JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeLimitLimitName>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ComputeLimitLimitName DeserializeComputeLimitLimitName(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ComputeLimitLimitName(value, localizedValue, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ComputeLimitLimitName>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ComputeLimitLimitName IPersistableModel<ComputeLimitLimitName>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ComputeLimitLimitName PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ComputeLimitLimitName>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
