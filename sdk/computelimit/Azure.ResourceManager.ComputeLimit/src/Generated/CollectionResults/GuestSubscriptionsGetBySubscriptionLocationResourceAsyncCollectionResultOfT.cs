...
{
    internal partial class GuestSubscriptionsGetBySubscriptionLocationResourceAsyncCollectionResultOfT : AsyncPageable<ComputeLimitGuestSubscriptionData>
    {
        private readonly GuestSubscriptions _client;
        ...
        /// <returns> The pages of GuestSubscriptionsGetBySubscriptionLocationResourceAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<ComputeLimitGuestSubscriptionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ComputeLimitGuestSubscriptionData>.FromValues((IReadOnlyList<ComputeLimitGuestSubscriptionData>)result.Value, nextPage?.AbsoluteUri, response);
