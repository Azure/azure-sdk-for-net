...
namespace Azure.ResourceManager.ComputeLimit
{
    internal partial class FeaturesGetBySubscriptionLocationResourceAsyncCollectionResultOfT : AsyncPageable<ComputeLimitFeatureData>
    {
        ...
        public FeaturesGetBySubscriptionLocationResourceAsyncCollectionResultOfT(Features client, Guid subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
