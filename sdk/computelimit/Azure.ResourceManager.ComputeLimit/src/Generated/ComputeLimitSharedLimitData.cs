...
namespace Azure.ResourceManager.ComputeLimit
{
    ...
    public partial class ComputeLimitSharedLimitData : ResourceData
    {
        ...
        internal ComputeLimitSharedLimitData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ComputeLimitSharedLimitProperties properties) : base(id, name, resourceType, systemData)
        {
