...
namespace Azure.ResourceManager.ComputeLimit
{
    internal partial class ComputeLimitArmOperation : ArmOperation
    {
        ...
        internal ComputeLimitArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
