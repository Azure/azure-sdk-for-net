...
#pragma warning disable SA1649 // File name should match first type name
    internal class ComputeLimitArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal ComputeLimitArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ComputeLimitArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ComputeLimitArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
