...
namespace Azure.ResourceManager.ComputeLimit
{
    internal partial class ComputeLimitArmOperation<T> : ArmOperation<T>
    {
        ...
        internal ComputeLimitArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
