...
namespace Azure.ResourceManager.ComputeLimit
{
    ...
    public partial class ComputeLimitSharedLimitData : ResourceData, IJsonModel<ComputeLimitSharedLimitData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ComputeLimitSharedLimitData IJsonModel<ComputeLimitSharedLimitData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ComputeLimitSharedLimitData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ComputeLimitSharedLimitData DeserializeComputeLimitSharedLimitData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ComputeLimitSharedLimitProperties.DeserializeComputeLimitSharedLimitProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="ComputeLimitSharedLimitData"/> from. </param>
        internal static ComputeLimitSharedLimitData FromResponse(Response result)
        {
