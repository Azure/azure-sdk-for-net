...
namespace Azure.ResourceManager.ComputeLimit
{
    ...
    public partial class ComputeLimitFeatureData : ResourceData
    {
        ...
        internal ComputeLimitFeatureData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ComputeLimitFeatureProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
