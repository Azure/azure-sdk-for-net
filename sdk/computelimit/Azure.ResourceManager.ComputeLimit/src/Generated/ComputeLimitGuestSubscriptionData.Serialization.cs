        ...
        internal static ComputeLimitGuestSubscriptionData DeserializeComputeLimitGuestSubscriptionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = GuestSubscriptionProperties.DeserializeGuestSubscriptionProperties(property.Value, options);
                    continue;
                }
                ...
                if (property.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerComputeLimitContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
