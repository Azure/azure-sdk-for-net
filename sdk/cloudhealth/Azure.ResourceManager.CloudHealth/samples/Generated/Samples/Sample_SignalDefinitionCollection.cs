...
["key4788"] = "ixfvzsfnpvkkbrce"
            ...
            ArmOperation<SignalDefinitionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, signalDefinitionName, data);
        ...
        public async Task GetIfExists_SignalDefinitionsGet()
        {
            ...
            // invoke the operation
            string signalDefinitionName = "sig1";
            NullableResponse<SignalDefinitionResource> response = await collection.GetIfExistsAsync(signalDefinitionName);
