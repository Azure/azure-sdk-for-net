...
["key1376"] = "ixfvzsfnpvkkbrce"
            ...
            ArmOperation<EntityResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, entityName, data);
        ...
        public async Task GetIfExists_EntitiesGet()
        {
            ...
            // invoke the operation
            string entityName = "entity1";
            NullableResponse<EntityResource> response = await collection.GetIfExistsAsync(entityName);
