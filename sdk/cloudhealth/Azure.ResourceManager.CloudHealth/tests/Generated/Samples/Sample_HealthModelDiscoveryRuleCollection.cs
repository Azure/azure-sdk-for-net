...
namespace Azure.ResourceManager.CloudHealth.Samples
{
    public partial class Sample_HealthModelDiscoveryRuleCollection
    {
        ...
        public async Task CreateOrUpdate_DiscoveryRulesCreateOrUpdate()
        {
            ...
            {
                Properties = new HealthModelDiscoveryRuleProperties("resources | where subscriptionId == '7ddfffd7-9b32-40df-1234-828cbd55d6f4' | where resourceGroup == 'my-rg'", DiscoveryRuleRelationshipDiscoveryBehavior.Enabled, DiscoveryRuleRecommendedSignalsBehavior.Enabled, new ResourceGraphQuerySpecification())
                {
