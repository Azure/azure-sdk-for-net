...
namespace Azure.ResourceManager.CloudHealth
{
    ...
    public partial class HealthModelResource : ArmResource
    {
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> HealthModels_Create. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-09-01-preview. </description>
        ...
        public virtual async Task<ArmOperation<HealthModelResource>> UpdateAsync(WaitUntil waitUntil, HealthModelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _healthModelsRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, HealthModelData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CloudHealthArmOperation<HealthModelResource> operation = new CloudHealthArmOperation<HealthModelResource>(
                    new HealthModelResourceOperationSource(Client),
                    _healthModelsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<HealthModelResource> Update(WaitUntil waitUntil, HealthModelData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
