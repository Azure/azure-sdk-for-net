...
{
    /// <summary>
    /// A class representing the HealthModelSignalDefinition data model.
    /// A signal definition in a health model
    /// </summary>
    public partial class HealthModelSignalDefinitionData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="HealthModelSignalDefinitionData"/>. </summary>
        ...
        internal HealthModelSignalDefinitionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, HealthModelSignalDefinitionProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        /// The available derived classes include <see cref="ResourceMetricSignalDefinitionProperties"/>, <see cref="LogAnalyticsQuerySignalDefinitionProperties"/> and <see cref="PrometheusMetricsSignalDefinitionProperties"/>.
        /// </summary>
        public HealthModelSignalDefinitionProperties Properties { get; set; }
    }
}
