...
{
    public partial class DiscoveryRuleData : IUtf8JsonSerializable, IJsonModel<DiscoveryRuleData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiscoveryRuleData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<DiscoveryRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DiscoveryRuleData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        DiscoveryRuleData IJsonModel<DiscoveryRuleData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DiscoveryRuleData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<DiscoveryRuleData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DiscoveryRuleData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        DiscoveryRuleData IPersistableModel<DiscoveryRuleData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DiscoveryRuleData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<DiscoveryRuleData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
