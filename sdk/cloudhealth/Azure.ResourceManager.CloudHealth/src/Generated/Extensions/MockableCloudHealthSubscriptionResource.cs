...
namespace Azure.ResourceManager.CloudHealth.Mocking
{
    ...
    public partial class MockableCloudHealthSubscriptionResource : ArmResource
    {
        ...
        private HealthModels HealthModelsRestClient => _healthModelsRestClient ??= new HealthModels(HealthModelsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-10-01-preview");
