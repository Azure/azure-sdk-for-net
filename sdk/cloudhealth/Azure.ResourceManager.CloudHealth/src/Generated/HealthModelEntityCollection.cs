...
namespace Azure.ResourceManager.CloudHealth
{
    ...
    public partial class HealthModelEntityCollection : ArmCollection, IEnumerable<HealthModelEntityResource>, IAsyncEnumerable<HealthModelEntityResource>
    {
        ...
        internal HealthModelEntityCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _entitiesRestClient = new Entities(_entitiesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, healthModelEntityApiVersion ?? "2026-05-01-preview");
        ...
        public virtual AsyncPageable<HealthModelEntityResource> GetAllAsync(DateTimeOffset? @on = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="HealthModelEntityResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<HealthModelEntityResource> GetAll(DateTimeOffset? @on = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
