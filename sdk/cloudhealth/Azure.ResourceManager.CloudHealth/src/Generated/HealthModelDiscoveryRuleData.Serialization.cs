    ...
    public partial class HealthModelDiscoveryRuleData : IUtf8JsonSerializable, IJsonModel<HealthModelDiscoveryRuleData>
    {
        ...
        internal static HealthModelDiscoveryRuleData DeserializeHealthModelDiscoveryRuleData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.CloudHealth.ModelSerializationExtensions.WireOptions, AzureResourceManagerCloudHealthContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerCloudHealthContext.Default)
#endif
;
                    continue;
                }
