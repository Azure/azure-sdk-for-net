...
namespace Azure.ResourceManager.CloudHealth
{
    ...
    public partial class DiscoveryRuleData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DiscoveryRuleData"/>. </summary>
        ...
        internal DiscoveryRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DiscoveryRuleProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
