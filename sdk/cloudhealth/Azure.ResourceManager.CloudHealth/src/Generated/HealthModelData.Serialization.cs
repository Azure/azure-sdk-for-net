...
{
    public partial class HealthModelData : IUtf8JsonSerializable, IJsonModel<HealthModelData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthModelData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        HealthModelData IJsonModel<HealthModelData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthModelData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<HealthModelData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthModelData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        HealthModelData IPersistableModel<HealthModelData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<HealthModelData>)this).GetFormatFromOptions(options) : options.Format;
