...
namespace Azure.ResourceManager.CloudHealth
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="HealthModelResource"/> using the GetEntity method.
    /// </summary>
    public partial class EntityResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Entity_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2025-05-01-preview</description>
        ...
        public virtual async Task<ArmOperation<EntityResource>> UpdateAsync(WaitUntil waitUntil, EntityData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<EntityResource> Update(WaitUntil waitUntil, EntityData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
