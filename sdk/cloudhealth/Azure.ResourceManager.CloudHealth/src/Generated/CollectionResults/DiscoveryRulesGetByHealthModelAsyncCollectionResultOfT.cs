...
namespace Azure.ResourceManager.CloudHealth
{
    internal partial class DiscoveryRulesGetByHealthModelAsyncCollectionResultOfT : AsyncPageable<HealthModelDiscoveryRuleData>
    {
        ...
        public DiscoveryRulesGetByHealthModelAsyncCollectionResultOfT(DiscoveryRules client, Guid subscriptionId, string resourceGroupName, string healthModelName, DateTimeOffset? @on, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
