...
{
    /// <summary></summary>
    internal partial class HealthModelResourceOperationSource : IOperationSource<HealthModelResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal HealthModelResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
