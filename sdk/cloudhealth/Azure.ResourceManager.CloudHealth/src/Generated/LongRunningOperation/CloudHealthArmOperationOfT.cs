...
namespace Azure.ResourceManager.CloudHealth
{
    internal partial class CloudHealthArmOperation<T> : ArmOperation<T>
    {
        ...
        internal CloudHealthArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
