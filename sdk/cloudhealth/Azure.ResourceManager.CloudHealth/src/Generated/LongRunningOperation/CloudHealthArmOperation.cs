...
#pragma warning disable SA1649 // File name should match first type name
    internal class CloudHealthArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal CloudHealthArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal CloudHealthArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "CloudHealthArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
