...
namespace Azure.ResourceManager.CloudHealth
{
    internal partial class CloudHealthArmOperation : ArmOperation
    {
        ...
        internal CloudHealthArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
