...
namespace Azure.ResourceManager.CloudHealth
{
    ...
    /// Each <see cref="EntityResource"/> in the collection will belong to the same instance of <see cref="HealthModelResource"/>.
    /// To get an <see cref="EntityCollection"/> instance call the GetEntities method from an instance of <see cref="HealthModelResource"/>.
    /// </summary>
    public partial class EntityCollection : ArmCollection, IEnumerable<EntityResource>, IAsyncEnumerable<EntityResource>
    {
        ...
        public virtual async Task<ArmOperation<EntityResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string entityName, EntityData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CloudHealthArmOperation<EntityResource>(Response.FromValue(new EntityResource(Client, response), response.GetRawResponse()), rehydrationToken);
        ...
        /// <exception cref="ArgumentException"> <paramref name="entityName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="entityName"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<EntityResource> CreateOrUpdate(WaitUntil waitUntil, string entityName, EntityData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(entityName, nameof(entityName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<EntityResource>> GetAsync(string entityName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(entityName, nameof(entityName));
        ...
        /// <exception cref="ArgumentException"> <paramref name="entityName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="entityName"/> is null. </exception>
        public virtual Response<EntityResource> Get(string entityName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(entityName, nameof(entityName));
        ...
        public virtual AsyncPageable<EntityResource> GetAllAsync(DateTimeOffset? timestamp = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual Pageable<EntityResource> GetAll(DateTimeOffset? timestamp = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _entityRestClient.CreateListByHealthModelRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, timestamp);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _entityRestClient.CreateListByHealthModelNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, timestamp);
        ...
        /// <exception cref="ArgumentException"> <paramref name="entityName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="entityName"/> is null. </exception>
        public virtual async Task<NullableResponse<EntityResource>> GetIfExistsAsync(string entityName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(entityName, nameof(entityName));
            ...
            try
            {
                var response = await _entityRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, entityName, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    return new NoValueResponse<EntityResource>(response.GetRawResponse());
                return Response.FromValue(new EntityResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="entityName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="entityName"/> is null. </exception>
        public virtual NullableResponse<EntityResource> GetIfExists(string entityName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(entityName, nameof(entityName));
