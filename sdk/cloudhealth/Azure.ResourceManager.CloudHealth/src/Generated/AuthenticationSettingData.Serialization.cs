...
{
    public partial class AuthenticationSettingData : IUtf8JsonSerializable, IJsonModel<AuthenticationSettingData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuthenticationSettingData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AuthenticationSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AuthenticationSettingData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AuthenticationSettingData IJsonModel<AuthenticationSettingData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AuthenticationSettingData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AuthenticationSettingData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AuthenticationSettingData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AuthenticationSettingData IPersistableModel<AuthenticationSettingData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AuthenticationSettingData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AuthenticationSettingData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
