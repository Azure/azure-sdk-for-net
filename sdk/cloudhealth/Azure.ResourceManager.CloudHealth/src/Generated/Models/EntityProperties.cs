...
namespace Azure.ResourceManager.CloudHealth.Models
{
    ...
    public partial class EntityProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="EntityProperties"/>. </summary>
        ...
        internal EntityProperties(HealthModelProvisioningState? provisioningState, string displayName, string kind, EntityCoordinates canvasPosition, IconDefinition icon, float? healthObjective, EntityImpact? impact, IDictionary<string, string> labels, SignalGroup signals, string discoveredBy, DateTimeOffset? deletedOn, HealthState? healthState, EntityAlerts alerts, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        public SignalGroup Signals { get; set; }
