...
namespace Azure.ResourceManager.CloudHealth.Models
{
    ...
    public partial class AlertConfiguration
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AlertConfiguration"/>. </summary>
        /// <param name="severity"> The severity of triggered alert. </param>
        public AlertConfiguration(AlertSeverity severity)
        {
            Severity = severity;
        ...
        internal AlertConfiguration(AlertSeverity severity, string description, IList<ResourceIdentifier> actionGroupIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Severity = severity;
        ...
        /// <summary> Initializes a new instance of <see cref="AlertConfiguration"/> for deserialization. </summary>
        internal AlertConfiguration()
        {
        }
