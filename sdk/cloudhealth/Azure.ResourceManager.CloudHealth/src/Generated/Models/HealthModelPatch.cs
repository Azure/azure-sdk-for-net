...
namespace Azure.ResourceManager.CloudHealth.Models
{
    ...
    public partial class HealthModelPatch
    {
        ...
        internal HealthModelPatch(ManagedServiceIdentity identity, IDictionary<string, string> tags, HealthModelUpdateProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Identity = identity;
            Tags = tags;
        ...
        {
            get => Properties is null ? default : Properties.Discovery;
            set
            {
