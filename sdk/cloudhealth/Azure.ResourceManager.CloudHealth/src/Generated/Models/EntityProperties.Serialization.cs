...
{
    public partial class EntityProperties : IUtf8JsonSerializable, IJsonModel<EntityProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EntityProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<EntityProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<EntityProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EntityProperties)} does not support writing '{format}' format.");
            }
        ...
        EntityProperties IJsonModel<EntityProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EntityProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EntityProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeEntityProperties(document.RootElement, options);
        }

        internal static EntityProperties DeserializeEntityProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("icon"u8))
                {
                    ...
                    icon = IconDefinition.DeserializeIconDefinition(property.Value, options);
                    continue;
                }
                ...
                if (property.NameEquals("signals"u8))
                {
                    ...
                    signals = SignalGroup.DeserializeSignalGroup(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<EntityProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EntityProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EntityProperties)} does not support writing '{options.Format}' format.");
            }
        }

        EntityProperties IPersistableModel<EntityProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<EntityProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(EntityProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<EntityProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
