...
{
    internal partial class VerifiedIdArmOperation<T> : ArmOperation<T>
    {
        ...
        internal VerifiedIdArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal VerifiedIdArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
