...
{
    internal partial class VerifiedIdArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of VerifiedIdArmOperation for mocking. </summary>
        protected VerifiedIdArmOperation()
        {
        }
        ...
        internal VerifiedIdArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal VerifiedIdArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
