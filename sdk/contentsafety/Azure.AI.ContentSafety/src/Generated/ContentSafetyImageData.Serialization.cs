...
namespace Azure.AI.ContentSafety
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentSafetyImageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContentSafetyImageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContentSafetyImageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContentSafetyImageData>)} interface");
            }
        ...
        string IPersistableModel<ContentSafetyImageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ContentSafetyImageData FromResponse(Response response)
        {
            ...
            return DeserializeContentSafetyImageData(document.RootElement, ModelReaderWriterOptions.Wire);
        }
