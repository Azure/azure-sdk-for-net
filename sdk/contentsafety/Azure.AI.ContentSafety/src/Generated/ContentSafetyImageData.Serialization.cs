...
namespace Azure.AI.ContentSafety
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentSafetyImageData>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ContentSafetyImageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContentSafetyImageData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ContentSafetyImageData FromResponse(Response response)
        {
            ...
            return DeserializeContentSafetyImageData(document.RootElement, new ModelReaderWriterOptions("W"));
        }
