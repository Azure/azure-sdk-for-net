...
{
    public partial class ContentSafetyImageData : IUtf8JsonWriteable, IJsonModel<ContentSafetyImageData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentSafetyImageData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContentSafetyImageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContentSafetyImageData)} does not support '{format}' format.");
            }
        ...
        internal static ContentSafetyImageData FromResponse(PipelineResponse response)
        {
