...
namespace Azure.AI.ContentSafety
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentSafetyImageData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ContentSafetyImageData IJsonModel<ContentSafetyImageData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ContentSafetyImageData)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<ContentSafetyImageData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ContentSafetyImageData IModel<ContentSafetyImageData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ContentSafetyImageData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static ContentSafetyImageData FromResponse(Response response)
        {
            ...
            return DeserializeContentSafetyImageData(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
