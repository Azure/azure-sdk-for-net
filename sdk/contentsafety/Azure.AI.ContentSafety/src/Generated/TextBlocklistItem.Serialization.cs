...
namespace Azure.AI.ContentSafety
{
    public partial class TextBlocklistItem : IUtf8JsonSerializable, IJsonModel<TextBlocklistItem>
    {
        ...
        void IJsonModel<TextBlocklistItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TextBlocklistItem)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TextBlocklistItem>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TextBlocklistItem)} does not support '{options.Format}' format.");
            }
        }
