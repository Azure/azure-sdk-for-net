...
{
    public partial class TextBlocklist : IUtf8JsonWriteable, IJsonModel<TextBlocklist>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TextBlocklist>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TextBlocklist FromResponse(PipelineResponse response)
        {
