...
namespace Azure.AI.ContentSafety
{
    ...
    public partial class TextCategoriesAnalysis : IJsonModel<TextCategoriesAnalysis>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<TextCategoriesAnalysis>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TextCategoriesAnalysis IJsonModel<TextCategoriesAnalysis>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
