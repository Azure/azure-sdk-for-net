...
namespace Azure.AI.ContentSafety
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalyzeTextResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnalyzeTextResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnalyzeTextResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AnalyzeTextResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AnalyzeTextResult FromResponse(Response response)
        {
            ...
            return DeserializeAnalyzeTextResult(document.RootElement, ModelReaderWriterOptions.Wire);
        }
