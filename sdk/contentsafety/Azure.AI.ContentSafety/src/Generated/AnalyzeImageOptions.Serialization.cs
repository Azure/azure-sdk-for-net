...
{
    public partial class AnalyzeImageOptions : IUtf8JsonWriteable, IJsonModel<AnalyzeImageOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalyzeImageOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AnalyzeImageOptions FromResponse(PipelineResponse response)
        {
