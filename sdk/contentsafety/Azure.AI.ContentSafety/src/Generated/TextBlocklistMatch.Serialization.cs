...
{
    public partial class TextBlocklistMatch : IUtf8JsonWriteable, IJsonModel<TextBlocklistMatch>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TextBlocklistMatch>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TextBlocklistMatch FromResponse(PipelineResponse response)
        {
