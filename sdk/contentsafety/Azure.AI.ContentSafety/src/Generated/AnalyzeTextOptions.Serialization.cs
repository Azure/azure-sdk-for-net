...
namespace Azure.AI.ContentSafety
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalyzeTextOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnalyzeTextOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnalyzeTextOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AnalyzeTextOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AnalyzeTextOptions FromResponse(Response response)
        {
            ...
            return DeserializeAnalyzeTextOptions(document.RootElement, ModelReaderWriterOptions.Wire);
        }
