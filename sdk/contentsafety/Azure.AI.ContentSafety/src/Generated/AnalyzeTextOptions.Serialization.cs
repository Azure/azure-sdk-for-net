...
{
    public partial class AnalyzeTextOptions : IUtf8JsonWriteable, IJsonModel<AnalyzeTextOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalyzeTextOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AnalyzeTextOptions FromResponse(PipelineResponse response)
        {
