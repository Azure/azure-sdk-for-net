...
namespace Azure.AI.ContentSafety
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AnalyzeImageResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AnalyzeImageResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AnalyzeImageResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AnalyzeImageResult>)} interface");
            }
        ...
        string IPersistableModel<AnalyzeImageResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AnalyzeImageResult FromResponse(Response response)
        {
            ...
            return DeserializeAnalyzeImageResult(document.RootElement, ModelReaderWriterOptions.Wire);
        }
