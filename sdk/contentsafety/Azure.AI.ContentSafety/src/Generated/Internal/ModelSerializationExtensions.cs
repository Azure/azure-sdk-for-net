...
namespace Azure.AI.ContentSafety
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureAIContentSafetyContext.Default) } };
