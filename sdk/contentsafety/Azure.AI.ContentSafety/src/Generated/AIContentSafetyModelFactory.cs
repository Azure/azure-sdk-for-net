...
namespace Azure.AI.ContentSafety
{
    ...
    public static partial class AIContentSafetyModelFactory
    {
        ...
        public static AnalyzeTextOptions AnalyzeTextOptions(string text = null, IEnumerable<TextCategory> categories = null, IEnumerable<string> blocklistNames = null, bool? breakByBlocklists = null)
        {
            ...
            return new AnalyzeTextOptions(text, categories?.ToList(), blocklistNames?.ToList(), breakByBlocklists, new Dictionary<string, BinaryData>());
        }
        ...
        public static AnalyzeTextResult AnalyzeTextResult(IEnumerable<TextBlocklistMatchResult> blocklistsMatchResults = null, TextAnalyzeSeverityResult hateResult = null, TextAnalyzeSeverityResult selfHarmResult = null, TextAnalyzeSeverityResult sexualResult = null, TextAnalyzeSeverityResult violenceResult = null)
        {
            ...
            return new AnalyzeTextResult(blocklistsMatchResults?.ToList(), hateResult, selfHarmResult, sexualResult, violenceResult, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TextBlocklistMatchResult(blocklistName, blockItemId, blockItemText, offset, length, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TextAnalyzeSeverityResult(category, severity, new Dictionary<string, BinaryData>());
        }
        ...
        public static AnalyzeImageOptions AnalyzeImageOptions(ContentSafetyImageData image = null, IEnumerable<ImageCategory> categories = null)
        {
            ...
            return new AnalyzeImageOptions(image, categories?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AnalyzeImageResult(hateResult, selfHarmResult, sexualResult, violenceResult, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ImageAnalyzeSeverityResult(category, severity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TextBlockItemInfo(description, text, new Dictionary<string, BinaryData>());
        }
        ...
        public static AddBlockItemsResult AddBlockItemsResult(IEnumerable<TextBlockItem> value = null)
        {
            ...
            return new AddBlockItemsResult(value?.ToList(), new Dictionary<string, BinaryData>());
        }
