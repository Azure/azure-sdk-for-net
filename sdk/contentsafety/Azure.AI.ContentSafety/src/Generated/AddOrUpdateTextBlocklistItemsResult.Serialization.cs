...
{
    public partial class AddOrUpdateTextBlocklistItemsResult : IUtf8JsonWriteable, IJsonModel<AddOrUpdateTextBlocklistItemsResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddOrUpdateTextBlocklistItemsResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AddOrUpdateTextBlocklistItemsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AddOrUpdateTextBlocklistItemsResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AddOrUpdateTextBlocklistItemsResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AddOrUpdateTextBlocklistItemsResult)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static AddOrUpdateTextBlocklistItemsResult FromResponse(PipelineResponse response)
        {
