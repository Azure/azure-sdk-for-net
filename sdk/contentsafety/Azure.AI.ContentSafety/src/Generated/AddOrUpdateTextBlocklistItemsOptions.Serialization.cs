...
{
    public partial class AddOrUpdateTextBlocklistItemsOptions : IUtf8JsonWriteable, IJsonModel<AddOrUpdateTextBlocklistItemsOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddOrUpdateTextBlocklistItemsOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AddOrUpdateTextBlocklistItemsOptions FromResponse(PipelineResponse response)
        {
