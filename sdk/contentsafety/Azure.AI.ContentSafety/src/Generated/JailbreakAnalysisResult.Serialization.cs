...
namespace Azure.AI.ContentSafety
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JailbreakAnalysisResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<JailbreakAnalysisResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JailbreakAnalysisResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<JailbreakAnalysisResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(JailbreakAnalysisResult)} does not support '{options.Format}' format.");
            }
        }
