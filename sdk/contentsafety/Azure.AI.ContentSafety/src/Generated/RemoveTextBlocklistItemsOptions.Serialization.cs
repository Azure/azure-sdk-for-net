...
{
    public partial class RemoveTextBlocklistItemsOptions : IUtf8JsonWriteable, IJsonModel<RemoveTextBlocklistItemsOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RemoveTextBlocklistItemsOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RemoveTextBlocklistItemsOptions FromResponse(PipelineResponse response)
        {
