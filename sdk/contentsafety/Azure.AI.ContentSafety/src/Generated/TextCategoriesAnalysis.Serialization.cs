...
{
    public partial class TextCategoriesAnalysis : IUtf8JsonWriteable, IJsonModel<TextCategoriesAnalysis>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TextCategoriesAnalysis>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TextCategoriesAnalysis FromResponse(PipelineResponse response)
        {
