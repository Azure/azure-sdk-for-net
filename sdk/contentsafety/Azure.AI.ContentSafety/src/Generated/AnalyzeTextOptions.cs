...
namespace Azure.AI.ContentSafety
{
    ...
    public partial class AnalyzeTextOptions
    {
        ...
        internal AnalyzeTextOptions(string text, IList<TextCategory> categories, IList<string> blocklistNames, bool? breakByBlocklists, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
