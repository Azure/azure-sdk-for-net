...
namespace Azure.AI.ContentSafety
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddBlockItemsOptions>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        AddBlockItemsOptions IJsonModel<AddBlockItemsOptions>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<AddBlockItemsOptions>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AddBlockItemsOptions IModel<AddBlockItemsOptions>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AddBlockItemsOptions>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static AddBlockItemsOptions FromResponse(Response response)
        {
            ...
            return DeserializeAddBlockItemsOptions(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
