...
namespace Azure.AI.ContentSafety
{
    public partial class AddBlockItemsOptions : IUtf8JsonSerializable, IJsonModel<AddBlockItemsOptions>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AddBlockItemsOptions>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AddBlockItemsOptions)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AddBlockItemsOptions>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AddBlockItemsOptions)} does not support '{options.Format}' format.");
            }
        }
