...
{
    public partial class ImageCategoriesAnalysis : IUtf8JsonWriteable, IJsonModel<ImageCategoriesAnalysis>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageCategoriesAnalysis>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ImageCategoriesAnalysis FromResponse(PipelineResponse response)
        {
