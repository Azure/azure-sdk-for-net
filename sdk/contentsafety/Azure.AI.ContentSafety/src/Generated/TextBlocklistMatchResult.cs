...
namespace Azure.AI.ContentSafety
{
    ...
    public partial class TextBlocklistMatchResult
    {
        ...
        internal TextBlocklistMatchResult(string blocklistName, string blockItemId, string blockItemText, int offset, int length, Dictionary<string, BinaryData> rawData)
        {
            BlocklistName = blocklistName;
            BlockItemId = blockItemId;
            BlockItemText = blockItemText;
