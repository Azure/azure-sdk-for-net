...
namespace Azure.ResourceManager.DeploymentManager
{
    ...
    public partial class ArtifactSourceResource : ArmResource
    {
        ...
        internal ArtifactSourceResource(ArmClient client, ArtifactSourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ArtifactSourceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ArtifactSourceResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
