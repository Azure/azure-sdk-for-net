...
namespace Azure.ResourceManager.DeploymentManager
{
    ...
    public partial class StepResourceData : TrackedResourceData
    {
        ...
        internal StepResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, StepProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Properties = properties;
