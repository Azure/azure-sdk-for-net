...
namespace Azure.ResourceManager.DeploymentManager
{
    ...
    public static partial class DeploymentManagerExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetServiceTopologyResources();
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetStepResources();
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetRollouts();
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetArtifactSources();
        }
