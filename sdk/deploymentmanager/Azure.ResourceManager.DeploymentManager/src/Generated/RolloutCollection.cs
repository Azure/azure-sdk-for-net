...
namespace Azure.ResourceManager.DeploymentManager
{
    ...
    public partial class RolloutCollection : ArmCollection, IEnumerable<RolloutResource>, IAsyncEnumerable<RolloutResource>
    {
        ...
        public virtual AsyncPageable<RolloutResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => { var data = RolloutData.DeserializeRolloutData(e); return new RolloutResource(Client, data, data.Id); }, _rolloutClientDiagnostics, Pipeline, "RolloutCollection.GetAll", "", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _rolloutRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => { var data = RolloutData.DeserializeRolloutData(e); return new RolloutResource(Client, data, data.Id); }, _rolloutClientDiagnostics, Pipeline, "RolloutCollection.GetAll", "", null, cancellationToken);
        }
