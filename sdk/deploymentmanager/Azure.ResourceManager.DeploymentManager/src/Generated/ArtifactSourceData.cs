...
namespace Azure.ResourceManager.DeploymentManager
{
    ...
    public partial class ArtifactSourceData : TrackedResourceData
    {
        ...
        internal ArtifactSourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string sourceType, string artifactRoot, Authentication authentication, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="ArtifactSourceData"/> for deserialization. </summary>
        internal ArtifactSourceData()
        {
        }
