...
namespace Azure.ResourceManager.DeploymentManager
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ServiceTopologyResource" /> using the GetServiceResource method.
    /// </summary>
    public partial class ServiceResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string resourceGroupName, string serviceTopologyName, string serviceName)
        {
            var resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DeploymentManager/serviceTopologies/{serviceTopologyName}/services/{serviceName}";
        ...
        {
            _serviceResourceServicesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DeploymentManager", ResourceType.Namespace, Diagnostics);
        ...
        public static readonly ResourceType ResourceType = "Microsoft.DeploymentManager/serviceTopologies/services";
        ...
        /// <summary> Gets a collection of ServiceUnitResources in the ServiceResource. </summary>
        /// <returns> An object representing collection of ServiceUnitResources and their operations over a ServiceUnitResource. </returns>
        public virtual ServiceUnitResourceCollection GetServiceUnitResources()
        {
            return GetCachedClient(Client => new ServiceUnitResourceCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ServiceUnitResource>> GetServiceUnitResourceAsync(string serviceUnitName, CancellationToken cancellationToken = default)
        {
            return await GetServiceUnitResources().GetAsync(serviceUnitName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="serviceUnitName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<ServiceUnitResource> GetServiceUnitResource(string serviceUnitName, CancellationToken cancellationToken = default)
        {
            return GetServiceUnitResources().Get(serviceUnitName, cancellationToken);
        }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _serviceResourceServicesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceResourceServicesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new DeploymentManagerArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
