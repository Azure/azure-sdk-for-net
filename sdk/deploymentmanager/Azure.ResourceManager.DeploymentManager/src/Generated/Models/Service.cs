...
namespace Azure.ResourceManager.DeploymentManager.Models
{
    ...
    public partial class Service : ServiceProperties
    {
        ...
        internal Service(string targetLocation, string targetSubscriptionId, string name, IReadOnlyList<ServiceUnit> serviceUnits, Dictionary<string, BinaryData> rawData) : base(targetLocation, targetSubscriptionId, rawData)
        {
            Name = name;
