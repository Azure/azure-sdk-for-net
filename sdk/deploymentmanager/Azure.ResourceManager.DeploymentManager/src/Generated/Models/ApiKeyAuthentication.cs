...
namespace Azure.ResourceManager.DeploymentManager.Models
{
    ...
    public partial class ApiKeyAuthentication : RestRequestAuthentication
    {
        ...
        internal ApiKeyAuthentication(RestAuthType authType, string name, RestAuthLocation @in, string value, Dictionary<string, BinaryData> rawData) : base(authType, rawData)
        {
            Name = name;
            In = @in;
            Value = value;
