...
namespace Azure.ResourceManager.DeploymentManager.Models
{
    public partial class StepOperationInfo : IUtf8JsonSerializable, IModelJsonSerializable<StepOperationInfo>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<StepOperationInfo>(this, options.Format);
        ...
        internal static StepOperationInfo DeserializeStepOperationInfo(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new StepOperationInfo(deploymentName.Value, correlationId.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), Optional.ToNullable(lastUpdatedTime), error.Value, serializedAdditionalRawData);
        }
