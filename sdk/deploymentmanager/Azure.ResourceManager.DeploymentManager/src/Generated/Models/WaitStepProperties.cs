...
namespace Azure.ResourceManager.DeploymentManager.Models
{
    ...
    public partial class WaitStepProperties : StepProperties
    {
        ...
        internal WaitStepProperties(StepType stepType, WaitStepAttributes attributes, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(stepType, serializedAdditionalRawData)
        {
            Attributes = attributes;
            StepType = stepType;
        }
