...
{
    public partial class RestResponseRegex : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RestResponseRegex DeserializeRestResponseRegex(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
