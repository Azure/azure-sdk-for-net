...
namespace Azure.ResourceManager.DeploymentManager.Models
{
    ...
    public partial class ResourceOperation
    {
        ...
        internal ResourceOperation(string resourceName, string operationId, string resourceType, string provisioningState, string statusMessage, string statusCode, Dictionary<string, BinaryData> rawData)
        {
