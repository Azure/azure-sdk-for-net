...
{
    public partial class StepGroup : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StepGroup DeserializeStepGroup(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
