...
namespace Azure.ResourceManager.DeploymentManager.Models
{
    ...
    public partial class ServiceUnit : ServiceUnitProperties
    {
        ...
        internal ServiceUnit(string targetResourceGroup, DeploymentMode deploymentMode, ServiceUnitArtifacts artifacts, string name, IReadOnlyList<RolloutStep> steps, Dictionary<string, BinaryData> rawData) : base(targetResourceGroup, deploymentMode, artifacts, rawData)
        {
            Name = name;
            Steps = steps;
        }
