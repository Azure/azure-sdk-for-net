...
namespace Azure.ResourceManager.DeploymentManager.Models
{
    ...
    public partial class StepGroup
    {
        ...
        internal StepGroup(string name, IList<string> dependsOnStepGroups, IList<PrePostStep> preDeploymentSteps, string deploymentTargetId, IList<PrePostStep> postDeploymentSteps, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
