...
{
    public partial class RolloutData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RolloutData DeserializeRolloutData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
