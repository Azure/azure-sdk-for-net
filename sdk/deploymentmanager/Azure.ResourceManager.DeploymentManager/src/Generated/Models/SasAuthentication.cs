...
namespace Azure.ResourceManager.DeploymentManager.Models
{
    ...
    public partial class SasAuthentication : Authentication
    {
        ...
        internal SasAuthentication(string authenticationType, Uri sasUri, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(authenticationType, serializedAdditionalRawData)
        {
            SasUri = sasUri;
