...
{
    public partial class RestRequest : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RestRequest DeserializeRestRequest(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
