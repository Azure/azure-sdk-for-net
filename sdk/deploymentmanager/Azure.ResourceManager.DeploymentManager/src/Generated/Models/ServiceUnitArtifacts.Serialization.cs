...
{
    public partial class ServiceUnitArtifacts : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceUnitArtifacts DeserializeServiceUnitArtifacts(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
