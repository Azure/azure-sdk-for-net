# Azure Deployment Manager Management client library for .NET
...
Install the Azure Deployment Manager management library for .NET with [NuGet](https://www.nuget.org/):
