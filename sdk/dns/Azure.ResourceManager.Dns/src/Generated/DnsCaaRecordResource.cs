...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsCaaRecordResource : ArmResource
    {
        ...
        /// <param name="caaRecordName"> The relativeRecordSetName. </param>
        ...
        public virtual async Task<ArmOperation<DnsCaaRecordResource>> UpdateAsync(WaitUntil waitUntil, DnsCaaRecordData parameters, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "CAA", DnsCaaRecordData.ToRequestContent(parameters), matchConditions, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsCaaRecordData> response = Response.FromValue(DnsCaaRecordData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DnsCaaRecordResource> Update(WaitUntil waitUntil, DnsCaaRecordData parameters, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
