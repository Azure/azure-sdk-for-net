...
namespace Azure.ResourceManager.Dns
{
    ...
    /// Each <see cref="RecordSetCaaResource" /> in the collection will belong to the same instance of <see cref="DnsZoneResource" />.
    /// To get a <see cref="RecordSetCaaCollection" /> instance call the GetRecordSetCaas method from an instance of <see cref="DnsZoneResource" />.
    /// </summary>
    public partial class RecordSetCaaCollection : ArmCollection, IEnumerable<RecordSetCaaResource>, IAsyncEnumerable<RecordSetCaaResource>
    {
        ...
        {
            _recordSetCaaRecordSetsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Dns", RecordSetCaaResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<RecordSetCaaResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string relativeRecordSetName, RecordSetData data, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DnsArmOperation<RecordSetCaaResource>(Response.FromValue(new RecordSetCaaResource(Client, response), response.GetRawResponse()));
