...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsZoneTLSAResource : ArmResource
    {
        ...
        {
            _dnsZoneTlsDnsARecordInfoSetsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Dns", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string dnsZoneTlsDnsARecordInfoSetsApiVersion);
        ...
        {
            using var scope = _dnsZoneTlsDnsARecordInfoSetsClientDiagnostics.CreateScope("DnsZoneTLSAResource.Get");
            scope.Start();
            try
            {
                var response = await _dnsZoneTlsDnsARecordInfoSetsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "TLSA".ToDnsRecordType(), Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DnsZoneTLSAResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dnsZoneTlsDnsARecordInfoSetsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "TLSA".ToDnsRecordType(), Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DnsZoneTLSAResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _dnsZoneTlsDnsARecordInfoSetsClientDiagnostics.CreateScope("DnsZoneTLSAResource.Delete");
            scope.Start();
            try
            {
                var response = await _dnsZoneTlsDnsARecordInfoSetsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "TLSA".ToDnsRecordType(), Id.Name, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dnsZoneTlsDnsARecordInfoSetsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "TLSA".ToDnsRecordType(), Id.Name, ifMatch, cancellationToken);
                var operation = new DnsArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<DnsZoneTLSAResource>> UpdateAsync(DnsRecordData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _dnsZoneTlsDnsARecordInfoSetsClientDiagnostics.CreateScope("DnsZoneTLSAResource.Update");
            scope.Start();
            try
            {
                var response = await _dnsZoneTlsDnsARecordInfoSetsRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "TLSA".ToDnsRecordType(), Id.Name, data, ifMatch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new DnsZoneTLSAResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<DnsZoneTLSAResource> Update(DnsRecordData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dnsZoneTlsDnsARecordInfoSetsRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, "TLSA".ToDnsRecordType(), Id.Name, data, ifMatch, cancellationToken);
                return Response.FromValue(new DnsZoneTLSAResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
