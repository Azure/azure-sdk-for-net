...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class RecordSetPtr : ArmResource
    {
        ...
        internal RecordSetPtr(ArmResource options, RecordSetData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal RecordSetPtr(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _recordSetsRestClient = new RecordSetsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecordSetPtr(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _recordSetsRestClient = new RecordSetsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RecordSetPtr.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new RecordSetPtr(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public async virtual Task<Response<RecordSetPtr>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RecordSetPtr.Update");
            scope.Start();
            try
            {
