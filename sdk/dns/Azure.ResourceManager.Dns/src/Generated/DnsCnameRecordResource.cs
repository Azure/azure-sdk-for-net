...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsCnameRecordResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DnsCnameRecordResource>> UpdateAsync(WaitUntil waitUntil, DnsCnameRecordData parameters, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "CNAME", DnsCnameRecordData.ToRequestContent(parameters), matchConditions, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsCnameRecordData> response = Response.FromValue(DnsCnameRecordData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DnsCnameRecordResource> Update(WaitUntil waitUntil, DnsCnameRecordData parameters, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
