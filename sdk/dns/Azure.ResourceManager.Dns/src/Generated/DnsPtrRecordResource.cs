...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsPtrRecordResource : ArmResource
    {
        ...
        internal DnsPtrRecordResource(ArmClient client, DnsRecordData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsZones/{zoneName}/PTR/{relativeRecordSetName}";
        ...
        public virtual async Task<Response<DnsPtrRecordResource>> UpdateAsync(DnsRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "PTR", DnsRecordData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsRecordData> response = Response.FromValue(DnsRecordData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<DnsPtrRecordResource> Update(DnsRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
