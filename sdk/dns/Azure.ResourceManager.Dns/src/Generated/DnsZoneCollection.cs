...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsZoneCollection : ArmCollection, IEnumerable<DnsZone>, IAsyncEnumerable<DnsZone>
    {
        ...
        public virtual ZoneCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string zoneName, DnsZoneData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (zoneName == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="zoneName"/> or <paramref name="parameters"/> is null. </exception>
        public async virtual Task<ZoneCreateOrUpdateOperation> CreateOrUpdateAsync(bool waitForCompletion, string zoneName, DnsZoneData parameters, string ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            if (zoneName == null)
            {
                throw new ArgumentNullException(nameof(zoneName));
        ...
        public virtual Response<DnsZone> GetIfExists(string zoneName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (response.Value == null)
                    return Response.FromValue<DnsZone>(null, response.GetRawResponse());
