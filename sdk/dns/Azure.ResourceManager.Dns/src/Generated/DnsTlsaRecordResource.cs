...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsTlsaRecordResource : ArmResource
    {
        ...
        public virtual async Task<Response<DnsTlsaRecordResource>> UpdateAsync(DnsTlsaRecordData parameters, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "TLSA", DnsTlsaRecordData.ToRequestContent(parameters), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsTlsaRecordData> response = Response.FromValue(DnsTlsaRecordData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual Response<DnsTlsaRecordResource> Update(DnsTlsaRecordData parameters, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
