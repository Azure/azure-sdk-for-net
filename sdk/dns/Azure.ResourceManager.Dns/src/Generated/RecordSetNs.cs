...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class RecordSetNs : ArmResource
    {
        ...
        internal RecordSetNs(ArmResource options, RecordSetData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal RecordSetNs(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _recordSetsRestClient = new RecordSetsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RecordSetNs(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _recordSetsRestClient = new RecordSetsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RecordSetNs.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RecordSetNs.Delete");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<RecordSetNs>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RecordSetNs.Update");
            scope.Start();
            try
            {
