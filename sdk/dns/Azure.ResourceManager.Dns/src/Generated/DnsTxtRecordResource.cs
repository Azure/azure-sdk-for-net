...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsTxtRecordResource : ArmResource
    {
        ...
        public virtual async Task<Response<DnsTxtRecordResource>> UpdateAsync(DnsTxtRecordData parameters, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "TXT", DnsTxtRecordData.ToRequestContent(parameters), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsTxtRecordData> response = Response.FromValue(DnsTxtRecordData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual Response<DnsTxtRecordResource> Update(DnsTxtRecordData parameters, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
