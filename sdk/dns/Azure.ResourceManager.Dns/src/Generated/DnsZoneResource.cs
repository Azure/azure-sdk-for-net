...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsZoneResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DnsZoneResource>> UpdateAsync(WaitUntil waitUntil, DnsZoneData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _zonesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, DnsZoneData.ToRequestContent(data), matchConditions, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsZoneData> response = Response.FromValue(DnsZoneData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DnsZoneResource> Update(WaitUntil waitUntil, DnsZoneData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
