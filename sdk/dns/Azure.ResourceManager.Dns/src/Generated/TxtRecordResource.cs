...
namespace Azure.ResourceManager.Dns
{
    ...
    /// </summary>
    public partial class TxtRecordResource : RecordResource
    {
        ...
        internal TxtRecordResource(ArmClient client, RecordData data) : base(client, data)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new async Task<Response<TxtRecordResource>> UpdateAsync(RecordData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new Response<TxtRecordResource> Update(RecordData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
