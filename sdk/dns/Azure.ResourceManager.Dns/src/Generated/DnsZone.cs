...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsZone : ArmResource
    {
        ...
        internal DnsZone(ArmResource options, DnsZoneData data) : base(options, data.Id)
        {
            HasData = true;
            _data = data;
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("DnsZone.GetAvailableLocations");
            scope.Start();
            try
            {
