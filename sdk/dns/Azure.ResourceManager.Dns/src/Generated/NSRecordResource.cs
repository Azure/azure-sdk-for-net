...
namespace Azure.ResourceManager.Dns
{
    ...
    /// </summary>
    public partial class NSRecordResource : RecordSetResource
    {
        ...
        internal NSRecordResource(ArmClient client, RecordSetData data) : base(client, data)
        {
        ...
        {
            using var scope = _nsRecordRecordSetsClientDiagnostics.CreateScope("NSRecordResource.GetCore");
            scope.Start();
            try
            {
                var response = await _nsRecordRecordSetsRestClient.GetAsync("NS".ToDnsRecordType(), Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual async Task<Response<NSRecordResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var value = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((NSRecordResource)value.Value, value.GetRawResponse());
        }
        ...
        protected override Response<RecordSetResource> GetCore(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _nsRecordRecordSetsRestClient.Get("NS".ToDnsRecordType(), Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(GetResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual Response<NSRecordResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        {
            using var scope = _nsRecordRecordSetsClientDiagnostics.CreateScope("NSRecordResource.DeleteCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<Response<RecordSetResource>> UpdateCoreAsync(RecordSetData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _nsRecordRecordSetsClientDiagnostics.CreateScope("NSRecordResource.UpdateCore");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new virtual async Task<Response<NSRecordResource>> UpdateAsync(RecordSetData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new virtual Response<NSRecordResource> Update(RecordSetData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
