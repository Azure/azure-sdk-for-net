...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsNSRecordResource : ArmResource
    {
        ...
        internal DnsNSRecordResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _recordSetsRestClient = new RecordSets(_recordSetsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, dnsNSRecordApiVersion ?? "2023-07-01-preview");
        ...
        /// <param name="nsRecordName"> The relativeRecordSetName. </param>
        ...
        public virtual async Task<ArmOperation<DnsNSRecordResource>> UpdateAsync(WaitUntil waitUntil, DnsNSRecordData parameters, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "NS", DnsNSRecordData.ToRequestContent(parameters), matchConditions, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsNSRecordData> response = Response.FromValue(DnsNSRecordData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DnsNSRecordResource> Update(WaitUntil waitUntil, DnsNSRecordData parameters, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
