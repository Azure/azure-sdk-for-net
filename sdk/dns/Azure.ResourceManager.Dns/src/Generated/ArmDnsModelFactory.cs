...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    public static partial class ArmDnsModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="Models.SigningKey"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.SigningKey"/> instance for mocking. </returns>
        public static SigningKey SigningKey(IEnumerable<DelegationSignerInfo> delegationSignerInfo = null, int? flags = null, int? keyTag = null, int? protocol = null, string publicKey = null, int? securityAlgorithmType = null)
        {
            delegationSignerInfo ??= new List<DelegationSignerInfo>();

            return new SigningKey(delegationSignerInfo?.ToList(), flags, keyTag, protocol, publicKey, securityAlgorithmType);
        }
