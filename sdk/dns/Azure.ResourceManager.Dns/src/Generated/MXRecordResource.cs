...
namespace Azure.ResourceManager.Dns
{
    ...
    /// </summary>
    public partial class MXRecordResource : RecordSetResource
    {
        ...
        internal MXRecordResource(ArmClient client, RecordSetData data) : base(client, data)
        {
        ...
        {
            using var scope = _mxRecordRecordSetsClientDiagnostics.CreateScope("MXRecordResource.GetCore");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _mxRecordRecordSetsClientDiagnostics.CreateScope("MXRecordResource.DeleteCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<Response<RecordSetResource>> UpdateCoreAsync(RecordSetData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _mxRecordRecordSetsClientDiagnostics.CreateScope("MXRecordResource.UpdateCore");
            scope.Start();
            try
            {
