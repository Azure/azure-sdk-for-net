...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    public partial class DnsTlsaRecordInfo
    {
        ...
        internal DnsTlsaRecordInfo(int? usage, int? selector, int? matchingType, string certAssociationData, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Usage = usage;
            Selector = selector;
