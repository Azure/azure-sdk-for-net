...
{
    public partial class DnsPtrRecordInfo : IUtf8JsonSerializable, IJsonModel<DnsPtrRecordInfo>, IPersistableModel<DnsPtrRecordInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DnsPtrDomainName))
            {
                ...
                builder.AppendLine($" '{DnsPtrDomainName}'");
            }
