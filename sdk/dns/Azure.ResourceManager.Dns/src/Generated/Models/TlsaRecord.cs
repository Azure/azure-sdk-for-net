...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="TlsaRecord"/>. </summary>
        public TlsaRecord()
        {
        }
        ...
        internal TlsaRecord(int? usage, int? selector, int? matchingType, string certAssociationData)
        {
            Usage = usage;
            Selector = selector;
