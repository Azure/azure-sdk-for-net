...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsMXRecordInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsMXRecordInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsMXRecordInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DnsMXRecordInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
