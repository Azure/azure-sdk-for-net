...
{
    public partial class DnsMXRecordInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DnsMXRecordInfo DeserializeDnsMXRecordInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
