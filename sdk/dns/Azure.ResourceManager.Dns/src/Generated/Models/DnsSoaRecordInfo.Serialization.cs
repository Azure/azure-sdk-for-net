...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsSoaRecordInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsSoaRecordInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsSoaRecordInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DnsSoaRecordInfo>)} interface");
            }
        ...
        string IPersistableModel<DnsSoaRecordInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
