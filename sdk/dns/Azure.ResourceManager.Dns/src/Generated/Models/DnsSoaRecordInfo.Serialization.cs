...
namespace Azure.ResourceManager.Dns.Models
{
    public partial class DnsSoaRecordInfo : IUtf8JsonSerializable, IModelJsonSerializable<DnsSoaRecordInfo>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DnsSoaRecordInfo>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="DnsSoaRecordInfo"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DnsSoaRecordInfo"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DnsSoaRecordInfo"/>. </summary>
