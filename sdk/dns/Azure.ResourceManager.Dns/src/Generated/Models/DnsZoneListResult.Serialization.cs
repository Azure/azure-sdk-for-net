...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsZoneListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsZoneListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsZoneListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DnsZoneListResult>)} interface");
            }
        ...
        string IPersistableModel<DnsZoneListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
