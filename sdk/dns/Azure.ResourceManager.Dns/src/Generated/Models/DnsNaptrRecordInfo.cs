...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    public partial class DnsNaptrRecordInfo
    {
        ...
        internal DnsNaptrRecordInfo(int? order, int? preference, string flags, string services, string regexp, string replacement, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Order = order;
