...
{
    public partial class DnsZoneData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DnsZoneData DeserializeDnsZoneData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
