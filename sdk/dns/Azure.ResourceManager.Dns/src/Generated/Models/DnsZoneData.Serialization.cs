...
namespace Azure.ResourceManager.Dns
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsZoneData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsZoneData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsZoneData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DnsZoneData>)} interface");
            }
        ...
        string IPersistableModel<DnsZoneData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
