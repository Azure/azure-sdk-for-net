...
{
    public partial class DnsNSRecordInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DnsNSRecordInfo DeserializeDnsNSRecordInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
