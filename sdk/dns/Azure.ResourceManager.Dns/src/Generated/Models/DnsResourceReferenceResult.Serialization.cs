...
{
    public partial class DnsResourceReferenceResult : IUtf8JsonSerializable, IJsonModel<DnsResourceReferenceResult>, IPersistableModel<DnsResourceReferenceResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(DnsResourceReferences))
            {
                builder.Append("  dnsResourceReferences:");
                builder.AppendLine(" [");
                foreach (var item in DnsResourceReferences)
                {
