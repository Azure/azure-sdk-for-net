...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    {
        internal static DnsResourceReferenceResult DeserializeDnsResourceReferenceResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
