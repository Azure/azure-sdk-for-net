...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsAaaaRecordInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsAaaaRecordInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsAaaaRecordInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DnsAaaaRecordInfo>)} interface");
            }
        ...
        string IPersistableModel<DnsAaaaRecordInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
