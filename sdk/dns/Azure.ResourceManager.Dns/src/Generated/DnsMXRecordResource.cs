...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsMXRecordResource : ArmResource
    {
        ...
        internal DnsMXRecordResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _recordSetsRestClient = new RecordSets(_recordSetsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, dnsMXRecordApiVersion ?? "2023-07-01-preview");
        ...
        /// <param name="mxRecordName"> The relativeRecordSetName. </param>
        ...
        public virtual async Task<ArmOperation<DnsMXRecordResource>> UpdateAsync(WaitUntil waitUntil, DnsMXRecordData parameters, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "MX", DnsMXRecordData.ToRequestContent(parameters), matchConditions, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsMXRecordData> response = Response.FromValue(DnsMXRecordData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DnsMXRecordResource> Update(WaitUntil waitUntil, DnsMXRecordData parameters, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
