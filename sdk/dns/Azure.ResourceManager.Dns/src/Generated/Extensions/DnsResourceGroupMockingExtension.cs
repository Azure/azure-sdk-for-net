...
namespace Azure.ResourceManager.Dns.Mocking
{
    ...
    internal partial class DnsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DnsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DnsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DnsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DnsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
