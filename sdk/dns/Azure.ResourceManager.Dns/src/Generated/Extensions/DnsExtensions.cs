...
using Azure.ResourceManager.Dns.Testing;
...
namespace Azure.ResourceManager.Dns
{
    ...
    public static partial class DnsExtensions
    {
        ...
        {
            return GetDnsSubscriptionResourceExtension(subscriptionResource).GetDnsZonesAsync(top, cancellationToken);
        }
        ...
        {
            return GetDnsSubscriptionResourceExtension(subscriptionResource).GetDnsZones(top, cancellationToken);
        }
