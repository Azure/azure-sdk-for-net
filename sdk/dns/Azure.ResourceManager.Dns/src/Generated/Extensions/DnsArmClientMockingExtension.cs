...
namespace Azure.ResourceManager.Dns.Mocking
{
    ...
    internal partial class DnsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DnsArmClientMockingExtension"/> class for mocking. </summary>
        protected DnsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DnsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DnsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DnsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
