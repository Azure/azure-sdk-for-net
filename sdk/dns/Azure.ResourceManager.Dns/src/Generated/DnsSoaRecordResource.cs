...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsSoaRecordResource : ArmResource
    {
        ...
        public virtual async Task<Response<DnsSoaRecordResource>> UpdateAsync(DnsSoaRecordData parameters, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "SOA", DnsSoaRecordData.ToRequestContent(parameters), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsSoaRecordData> response = Response.FromValue(DnsSoaRecordData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual Response<DnsSoaRecordResource> Update(DnsSoaRecordData parameters, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(parameters, nameof(parameters));
