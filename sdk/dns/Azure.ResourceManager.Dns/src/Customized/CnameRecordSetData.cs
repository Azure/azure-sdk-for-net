...
{
    /// <summary> A class representing the RecordSet CNAME data model. </summary>
    public partial class CnameRecordSetData : Resource
    {
        ...
        internal CnameRecordSetData(ResourceIdentifier id, string name, ResourceType type, string etag, IDictionary<string, string> metadata, long? tTL, string fqdn, string provisioningState, WritableSubResource targetResource, CnameRecord cnameRecord) : base(id, name, type)
        {
            Etag = etag;
            Metadata = metadata;
            TTL = tTL;
