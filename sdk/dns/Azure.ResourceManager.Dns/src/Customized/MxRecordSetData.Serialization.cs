...
namespace Azure.ResourceManager.Dns
{
    public partial class MxRecordSetData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(MxRecord))
            {
                writer.WritePropertyName("MXRecords");
                writer.WriteStartArray();
                writer.WriteObjectValue(MxRecord);
        ...
        internal static MxRecordSetData DeserializeMxRecordSetData(JsonElement element)
        {
            ...
            Optional<MxRecord> mXRecord = default;
            ...
            return new MxRecordSetData(id, name, type, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(tTL), fqdn.Value, provisioningState.Value, targetResource, mXRecord);
        }
    }
}
