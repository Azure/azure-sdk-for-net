...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class RecordSetAaaa : ArmResource
    {
        ...
        private readonly AaaaRecordSetData _data;
        ...
        internal RecordSetAaaa(ArmResource options, AaaaRecordSetData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public virtual AaaaRecordSetData Data
        {
            get
            {
                if (!HasData)
        ...
        public async virtual Task<Response<RecordSetAaaa>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recordSetsRestClient.GetAaaaRecordAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<RecordSetAaaa> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recordSetsRestClient.GetAaaaRecord(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<RecordSetAaaa>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recordSetsRestClient.UpdateAaaaRecordAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, ifMatch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new RecordSetAaaa(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<RecordSetAaaa> Update(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recordSetsRestClient.UpdateAaaaRecord(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, ifMatch, cancellationToken);
                return Response.FromValue(new RecordSetAaaa(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
