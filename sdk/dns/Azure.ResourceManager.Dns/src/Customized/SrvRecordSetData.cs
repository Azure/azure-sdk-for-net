...
{
    /// <summary> A class representing the RecordSet SRV data model. </summary>
    public partial class SrvRecordSetData : Resource
    {
        ...
        /// <param name="sRVRecord"> The SRV record in the record set. </param>
        internal SrvRecordSetData(ResourceIdentifier id, string name, ResourceType type, string etag, IDictionary<string, string> metadata, long? tTL, string fqdn, string provisioningState, WritableSubResource targetResource, SrvRecord sRVRecord) : base(id, name, type)
        {
            Etag = etag;
            Metadata = metadata;
            TTL = tTL;
        ...
        /// <summary> The SRV record in the record set. </summary>
