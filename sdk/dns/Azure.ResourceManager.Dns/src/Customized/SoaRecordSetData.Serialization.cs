...
{
    public partial class SoaRecordSetData : IUtf8JsonSerializable
    {
        ...
        internal static SoaRecordSetData DeserializeSoaRecordSetData(JsonElement element)
        {
            ...
            return new SoaRecordSetData(id, name, type, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(tTL), fqdn.Value, provisioningState.Value, targetResource, sOARecord);
        }
    }
}
