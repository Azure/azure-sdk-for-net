...
namespace Azure.ResourceManager.Dns
{
    public partial class NsRecordSetData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(NsRecord))
            {
                writer.WritePropertyName("NSRecords");
                writer.WriteStartArray();
                writer.WriteObjectValue(NsRecord);
        ...
        internal static NsRecordSetData DeserializeNsRecordSetData(JsonElement element)
        {
            ...
            Optional<NsRecord> nSRecord = default;
            ...
            return new NsRecordSetData(id, name, type, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(tTL), fqdn.Value, provisioningState.Value, targetResource, nSRecord);
        }
    }
}
