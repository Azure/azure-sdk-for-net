...
namespace Azure.ResourceManager.Dns
{
    public partial class TxtRecordSetData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(TxtRecord))
            {
                writer.WritePropertyName("TXTRecords");
                writer.WriteStartArray();
                writer.WriteObjectValue(TxtRecord);
        ...
        internal static TxtRecordSetData DeserializeTxtRecordSetData(JsonElement element)
        {
            ...
            Optional<TxtRecord> tXTRecord = default;
            ...
            return new TxtRecordSetData(id, name, type, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(tTL), fqdn.Value, provisioningState.Value, targetResource, tXTRecord);
        }
    }
}
