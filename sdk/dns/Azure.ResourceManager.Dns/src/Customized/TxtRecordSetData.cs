...
{
    /// <summary> A class representing the RecordSet TXT data model. </summary>
    public partial class TxtRecordSetData : Resource
    {
        ...
        /// <param name="tXTRecord"> The TXT record in the record set. </param>
        internal TxtRecordSetData(ResourceIdentifier id, string name, ResourceType type, string etag, IDictionary<string, string> metadata, long? tTL, string fqdn, string provisioningState, WritableSubResource targetResource, TxtRecord tXTRecord) : base(id, name, type)
        {
            Etag = etag;
            Metadata = metadata;
            TTL = tTL;
        ...
        /// <summary> The TXT record in the record set. </summary>
        public TxtRecord TxtRecord { get; set; }
    }
}
