...
{
    public partial class ARecordSetData : IUtf8JsonSerializable
    {
        ...
        internal static ARecordSetData DeserializeARecordSetData(JsonElement element)
        {
            ...
            return new ARecordSetData(id, name, type, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(tTL), fqdn.Value, provisioningState.Value, targetResource, aRecord);
        }
    }
}
