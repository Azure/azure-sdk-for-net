...
namespace Azure.ResourceManager.Dns
{
    public partial class SrvRecordSetData : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(SrvRecord))
            {
                writer.WritePropertyName("SRVRecords");
                writer.WriteStartArray();
                writer.WriteObjectValue(SrvRecord);
        ...
        internal static SrvRecordSetData DeserializeSrvRecordSetData(JsonElement element)
        {
            ...
            Optional<SrvRecord> sRVRecord = default;
            ...
            return new SrvRecordSetData(id, name, type, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(tTL), fqdn.Value, provisioningState.Value, targetResource, sRVRecord);
        }
    }
}
