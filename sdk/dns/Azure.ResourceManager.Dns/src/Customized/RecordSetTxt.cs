...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class RecordSetTxt : ArmResource
    {
        ...
        internal RecordSetTxt(ArmResource options, TxtRecordSetData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        public async virtual Task<Response<RecordSetTxt>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recordSetsRestClient.GetTxtRecordAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<RecordSetTxt> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recordSetsRestClient.GetTxtRecord(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<Response<RecordSetTxt>> UpdateAsync(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _recordSetsRestClient.UpdateTxtRecordAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, ifMatch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new RecordSetTxt(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<RecordSetTxt> Update(RecordSetData parameters, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _recordSetsRestClient.UpdateTxtRecord(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, parameters, ifMatch, cancellationToken);
                return Response.FromValue(new RecordSetTxt(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
