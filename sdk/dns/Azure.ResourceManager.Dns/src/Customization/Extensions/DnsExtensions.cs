...
[assembly: CodeGenSuppressType("DnsExtensions")]
...
namespace Azure.ResourceManager.Dns
{
    ...
    public static partial class DnsExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="ARecordResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="ARecordResource.CreateResourceIdentifier" /> to create a <see cref="ARecordResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// </summary>
        ...
        /// <summary>
        /// Gets an object representing a <see cref="AaaaRecordResource" /> along with the instance operations that can be performed on it but with no data.
        /// You can use <see cref="AaaaRecordResource.CreateResourceIdentifier" /> to create a <see cref="AaaaRecordResource" /> <see cref="ResourceIdentifier" /> from its components.
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient" /> instance the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
