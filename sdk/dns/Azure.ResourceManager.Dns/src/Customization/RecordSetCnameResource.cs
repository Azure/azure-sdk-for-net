...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class RecordSetCnameResource : ArmResource
    {
        ...
        public virtual async Task<Response<RecordSetCnameResource>> UpdateAsync(CnameRecordSetData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<RecordSetCnameResource> Update(CnameRecordSetData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
