...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class CnameRecordCollection : ArmCollection, IEnumerable<CnameRecordResource>, IAsyncEnumerable<CnameRecordResource>
    {
        ...
        public virtual async Task<ArmOperation<CnameRecordResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string cnameRecordName, CnameRecordData data, ETag? ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _cnameRecordInfoRecordSetsRestClient.CreateOrUpdateAsync("CNAME".ToDnsRecordType(), Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cnameRecordName, data, ifMatch, ifNoneMatch, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<CnameRecordResource> CreateOrUpdate(WaitUntil waitUntil, string cnameRecordName, CnameRecordData data, ETag? ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _cnameRecordInfoRecordSetsRestClient.CreateOrUpdate("CNAME".ToDnsRecordType(), Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cnameRecordName, data, ifMatch, ifNoneMatch, cancellationToken);
                var operation = new DnsArmOperation<CnameRecordResource>(Response.FromValue(new CnameRecordResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<CnameRecordResource>> GetAsync(string cnameRecordName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _cnameRecordInfoRecordSetsRestClient.GetCnameRecordAsync("CNAME".ToDnsRecordType(), Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cnameRecordName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CnameRecordResource> Get(string cnameRecordName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _cnameRecordInfoRecordSetsRestClient.GetCnameRecord("CNAME".ToDnsRecordType(), Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cnameRecordName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new CnameRecordResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual AsyncPageable<CnameRecordResource> GetAllAsync(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<CnameRecordResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _cnameRecordInfoRecordSetsRestClient.ListCnameRecordAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, recordsetnamesuffix, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<CnameRecordResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _cnameRecordInfoRecordSetsRestClient.ListCnameRecordNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, recordsetnamesuffix, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new CnameRecordResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<CnameRecordResource> GetAll(int? top = null, string recordsetnamesuffix = null, CancellationToken cancellationToken = default)
        {
            Page<CnameRecordResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _cnameRecordInfoRecordSetsRestClient.ListCnameRecord(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, recordsetnamesuffix, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new CnameRecordResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<CnameRecordResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _cnameRecordInfoRecordSetsRestClient.ListCnameRecordNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, recordsetnamesuffix, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new CnameRecordResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string cnameRecordName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _cnameRecordInfoRecordSetsRestClient.GetCnameRecordAsync("CNAME".ToDnsRecordType(), Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cnameRecordName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string cnameRecordName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _cnameRecordInfoRecordSetsRestClient.GetCnameRecord("CNAME".ToDnsRecordType(), Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cnameRecordName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
