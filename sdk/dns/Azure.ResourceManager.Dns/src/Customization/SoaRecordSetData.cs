...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class SoaRecordSetData : ResourceData
    {
        ...
        internal SoaRecordSetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? etag, IDictionary<string, string> metadata, long? ttl, string fqdn, string provisioningState, WritableSubResource targetResource,SoaRecordInfo soaRecord) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
            Metadata = metadata;
            TtlInSeconds = ttl;
