...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class SoaRecordSetData : ResourceData
    {
        /// <summary> Initializes a new instance of SoaRecordSetData. </summary>
        ...
        internal SoaRecordSetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string etag, IDictionary<string, string> metadata, long? ttl, string fqdn, string provisioningState, WritableSubResource targetResource,SoaRecordInfo soaRecord) : base(id, name, resourceType, systemData)
        {
            Etag = etag;
            Metadata = metadata;
            TtlInSeconds = ttl;
