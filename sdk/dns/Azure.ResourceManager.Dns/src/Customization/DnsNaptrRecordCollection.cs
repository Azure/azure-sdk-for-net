...
namespace Azure.ResourceManager.Dns
{
    ...
    /// </summary>
    [CodeGenSuppressAttribute("CreateOrUpdateAsync", typeof(WaitUntil), typeof(string), typeof(DnsRecordType), typeof(DnsNaptrRecordData), typeof(MatchConditions), typeof(CancellationToken))]
    [CodeGenSuppressAttribute("CreateOrUpdate", typeof(WaitUntil), typeof(string), typeof(DnsRecordType), typeof(DnsNaptrRecordData), typeof(MatchConditions), typeof(CancellationToken))]
    ...
    public partial class DnsNaptrRecordCollection : ArmCollection, IEnumerable<DnsNaptrRecordResource>, IAsyncEnumerable<DnsNaptrRecordResource>
    {
        ...
        public virtual async Task<ArmOperation<DnsNaptrRecordResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string naptrRecordName, DnsNaptrRecordData data, ETag? ifMatch, string ifNoneMatch = null, CancellationToken cancellationToken = default)
            => await CreateOrUpdateAsync(waitUntil, naptrRecordName, data, new MatchConditions() { IfMatch = ifMatch, IfNoneMatch = new ETag(ifNoneMatch) }, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<DnsNaptrRecordResource> CreateOrUpdate(WaitUntil waitUntil, string naptrRecordName, DnsNaptrRecordData data, ETag? ifMatch, string ifNoneMatch = null, CancellationToken cancellationToken = default)
            => CreateOrUpdate(waitUntil, naptrRecordName, data, new MatchConditions() { IfMatch = ifMatch, IfNoneMatch = new ETag(ifNoneMatch) }, cancellationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="naptrRecordName"/> or <paramref name="data"/> is null. </exception>
        ...
        public virtual async Task<ArmOperation<DnsNaptrRecordResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string naptrRecordName, DnsNaptrRecordData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(naptrRecordName, nameof(naptrRecordName));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsNaptrRecordCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, naptrRecordName, "NAPTR", DnsNaptrRecordData.ToRequestContent(data), matchConditions, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsNaptrRecordData> response = Response.FromValue(DnsNaptrRecordData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
                RehydrationToken rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                DnsArmOperation<DnsNaptrRecordResource> operation = new DnsArmOperation<DnsNaptrRecordResource>(Response.FromValue(new DnsNaptrRecordResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="naptrRecordName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="naptrRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<DnsNaptrRecordResource> CreateOrUpdate(WaitUntil waitUntil, string naptrRecordName, DnsNaptrRecordData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(naptrRecordName, nameof(naptrRecordName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <exception cref="ArgumentException"> <paramref name="naptrRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response<DnsNaptrRecordResource>> GetAsync(string naptrRecordName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(naptrRecordName, nameof(naptrRecordName));

            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsNaptrRecordCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, naptrRecordName, "NAPTR", context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsNaptrRecordData> response = Response.FromValue(DnsNaptrRecordData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="naptrRecordName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="naptrRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<DnsNaptrRecordResource> Get(string naptrRecordName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(naptrRecordName, nameof(naptrRecordName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="naptrRecordName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="naptrRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response<bool>> ExistsAsync(string naptrRecordName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(naptrRecordName, nameof(naptrRecordName));

            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsNaptrRecordCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<DnsNaptrRecordData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(DnsNaptrRecordData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((DnsNaptrRecordData)null, result);
                        break;
                    default:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="naptrRecordName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="naptrRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<bool> Exists(string naptrRecordName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(naptrRecordName, nameof(naptrRecordName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="naptrRecordName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="naptrRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<NullableResponse<DnsNaptrRecordResource>> GetIfExistsAsync(string naptrRecordName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(naptrRecordName, nameof(naptrRecordName));

            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsNaptrRecordCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                if (response.Value == null)
                {
                    return new NoValueResponse<DnsNaptrRecordResource>(response.GetRawResponse());
                }
                return Response.FromValue(new DnsNaptrRecordResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="naptrRecordName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="naptrRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual NullableResponse<DnsNaptrRecordResource> GetIfExists(string naptrRecordName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(naptrRecordName, nameof(naptrRecordName));
