...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class DnsMXRecordResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of DnsMXRecordResource for mocking. </summary>
        protected DnsMXRecordResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DnsMXRecordResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string dnsMXRecordApiVersion);
        ...
        /// <param name="mxRecordName"> The mxRecordName. </param>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsZones/{zoneName}/MX/{mxRecordName}";
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="DnsMXRecordResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsMXRecordResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "MX", context);
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsMXRecordResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "MX", ifMatch, context);
