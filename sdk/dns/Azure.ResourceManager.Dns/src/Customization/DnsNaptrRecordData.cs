...
namespace Azure.ResourceManager.Dns
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="DnsNaptrRecordData"/>. </summary>
        ...
        internal DnsNaptrRecordData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DnsRecordSetProperties properties, ETag? eTag) : base(id, name, resourceType, systemData, additionalBinaryDataProperties, properties, eTag)
        {
        }
