...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class CnameRecordSetData : ResourceData
    {
        ...
        internal CnameRecordSetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? etag, IDictionary<string, string> metadata, long? ttl, string fqdn, string provisioningState, WritableSubResource targetResource, CnameRecordInfo cnameRecord) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
            Metadata = metadata;
            TtlInSeconds = ttl;
