...
namespace Azure.ResourceManager.Dns
{
    public partial class AaaaRecordSetData : IUtf8JsonSerializable
    {
        ...
        internal static AaaaRecordSetData DeserializeAaaaRecordSetData(JsonElement element)
        {
            ...
            return new AaaaRecordSetData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource,  Optional.ToList(aaaaRecords));
        }
    }
}
