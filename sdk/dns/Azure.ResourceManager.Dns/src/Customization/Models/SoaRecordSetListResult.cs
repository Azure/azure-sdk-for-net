...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    internal partial class SoaRecordSetListResult
    {
        /// <summary> Initializes a new instance of SoaRecordSetListResult. </summary>
        internal SoaRecordSetListResult()
        {
            Value = new ChangeTrackingList<SoaRecordSetData>();
        }

        /// <summary> Initializes a new instance of SoaRecordSetListResult. </summary>
        /// <param name="value"> Information about the record sets in the response. </param>
        /// <param name="nextLink"> The continuation token for the next page of results. </param>
        internal SoaRecordSetListResult(IReadOnlyList<SoaRecordSetData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<SoaRecordSetData> Value { get; }
