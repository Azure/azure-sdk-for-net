...
namespace Azure.ResourceManager.Dns
{
    public partial class SoaRecordSetData : IUtf8JsonSerializable
    {
        ...
        internal static SoaRecordSetData DeserializeSoaRecordSetData(JsonElement element)
        {
            ...
            return new SoaRecordSetData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, soaRecord.Value);
        }
    }
}
