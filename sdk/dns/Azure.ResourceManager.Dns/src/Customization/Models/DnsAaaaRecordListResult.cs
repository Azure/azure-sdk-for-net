...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    internal partial class DnsAaaaRecordListResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DnsAaaaRecordListResult"/>. </summary>
        ...
        internal DnsAaaaRecordListResult(IReadOnlyList<DnsAaaaRecordData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
