...
namespace Azure.ResourceManager.Dns
{
    public partial class PtrRecordSetData : IUtf8JsonSerializable
    {
        ...
        internal static PtrRecordSetData DeserializePtrRecordSetData(JsonElement element)
        {
            ...
            return new PtrRecordSetData(id, name, type, systemData, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, Optional.ToList(ptrRecords));
        }
    }
}
