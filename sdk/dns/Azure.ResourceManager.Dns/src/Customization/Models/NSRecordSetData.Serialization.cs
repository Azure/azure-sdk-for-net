...
namespace Azure.ResourceManager.Dns
{
    public partial class NSRecordSetData : IUtf8JsonSerializable
    {
        ...
        internal static NSRecordSetData DeserializeNSRecordSetData(JsonElement element)
        {
            ...
            return new NSRecordSetData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, Optional.ToList(nsRecords));
        }
    }
}
