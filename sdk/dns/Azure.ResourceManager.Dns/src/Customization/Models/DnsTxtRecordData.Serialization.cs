...
namespace Azure.ResourceManager.Dns
{
    public partial class DnsTxtRecordData : IUtf8JsonSerializable
    {
        ...
        internal static DnsTxtRecordData DeserializeDnsTxtRecordData(JsonElement element)
        {
            ...
            return new DnsTxtRecordData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, trafficManagementProfile, Optional.ToList(txtRecords));
        }
    }
}
