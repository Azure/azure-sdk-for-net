...
namespace Azure.ResourceManager.Dns
{
    public partial class CaaRecordSetData : IUtf8JsonSerializable
    {
        ...
        internal static CaaRecordSetData DeserializeCaaRecordSetData(JsonElement element)
        {
            ...
            return new CaaRecordSetData(id, name, type, systemData, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, Optional.ToList(aRecords), Optional.ToList(aaaaRecords), Optional.ToList(mxRecords), Optional.ToList(nsRecords), Optional.ToList(ptrRecords), Optional.ToList(srvRecords), Optional.ToList(txtRecords), cnameRecord.Value, soaRecord.Value, Optional.ToList(caaRecords));
        }
    }
}
