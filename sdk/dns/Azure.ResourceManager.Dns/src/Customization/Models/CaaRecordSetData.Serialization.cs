...
namespace Azure.ResourceManager.Dns
{
    public partial class CaaRecordSetData : IUtf8JsonSerializable
    {
        ...
        internal static CaaRecordSetData DeserializeCaaRecordSetData(JsonElement element)
        {
            ...
            return new CaaRecordSetData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, Optional.ToList(caaRecords));
        }
    }
}
