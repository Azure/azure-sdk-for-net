...
namespace Azure.ResourceManager.Dns
{
    public partial class ARecordSetData : IUtf8JsonSerializable
    {
        ...
        internal static ARecordSetData DeserializeARecordSetData(JsonElement element)
        {
            ...
            return new ARecordSetData(id, name, type, systemData, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, Optional.ToList(aRecords));
        }
    }
}
