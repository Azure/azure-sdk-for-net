...
{
    public partial class RecordSetDataA : IUtf8JsonSerializable
    {
        ...
        internal static RecordSetDataA DeserializeRecordSetData(JsonElement element)
        {
            ...
            return new RecordSetDataA(id, name, type, systemData, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, Optional.ToList(aRecords) );
        }
    }
}
