...
{
    public partial class DnsPtrRecordData : IUtf8JsonSerializable
    {
        ...
        internal static DnsPtrRecordData DeserializeDnsPtrRecordData(JsonElement element)
        {
            ...
            return new DnsPtrRecordData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, trafficManagementProfile, Optional.ToList(ptrRecords));
        }
    }
}
