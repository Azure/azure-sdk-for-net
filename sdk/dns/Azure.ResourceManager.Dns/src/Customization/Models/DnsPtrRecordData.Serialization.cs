...
namespace Azure.ResourceManager.Dns
{
    public partial class DnsPtrRecordData : IUtf8JsonSerializable, IJsonModel<DnsPtrRecordData>
    {
        ...
        internal static DnsPtrRecordData DeserializeDnsPtrRecordData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DnsPtrRecordData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, Optional.ToList(ptrRecords), serializedAdditionalRawData);
        }
