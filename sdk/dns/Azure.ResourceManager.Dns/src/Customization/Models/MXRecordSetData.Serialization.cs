...
namespace Azure.ResourceManager.Dns
{
    public partial class MXRecordSetData : IUtf8JsonSerializable
    {
        ...
        internal static MXRecordSetData DeserializeMXRecordSetData(JsonElement element)
        {
            ...
            return new MXRecordSetData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, Optional.ToList(mxRecords));
        }
    }
}
