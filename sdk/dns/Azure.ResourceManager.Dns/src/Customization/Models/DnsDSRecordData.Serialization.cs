...
namespace Azure.ResourceManager.Dns
{
    public partial class DnsDSRecordData : IUtf8JsonSerializable
    {
        ...
        internal static DnsDSRecordData DeserializeDnsDSRecordData(JsonElement element)
        {
            ...
            return new DnsDSRecordData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, Optional.ToList(DSRecords));
        }
    }
}
