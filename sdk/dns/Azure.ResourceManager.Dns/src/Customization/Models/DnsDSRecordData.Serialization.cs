...
{
    public partial class DnsDSRecordData : IUtf8JsonSerializable, IJsonModel<DnsDSRecordData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsDSRecordData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DnsDSRecordData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DnsDSRecordData)} does not support '{format}' format.");
            }
        ...
        internal static DnsDSRecordData DeserializeDnsDSRecordData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<DnsDSRecordData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DnsDSRecordData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DnsDSRecordData)} does not support '{options.Format}' format.");
            }
        }
