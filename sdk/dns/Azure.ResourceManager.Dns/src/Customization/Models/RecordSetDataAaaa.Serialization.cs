...
{
    public partial class RecordSetDataAaaa : IUtf8JsonSerializable
    {
        ...
        internal static RecordSetDataAaaa DeserializeRecordSetData(JsonElement element)
        {
            ...
            return new RecordSetDataAaaa(id, name, type, systemData, etag.Value, Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, Optional.ToList(aaaaRecords));
        }
    }
}
