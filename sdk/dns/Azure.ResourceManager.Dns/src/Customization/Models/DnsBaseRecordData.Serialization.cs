...
{
    public partial class DnsBaseRecordData : IUtf8JsonSerializable
    {
        ...
        internal static DnsBaseRecordData DeserializeBaseRecordData(JsonElement element)
        {
            ...
            return new DnsBaseRecordData(id, name, type, systemData.Value, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, trafficManagementProfile);
        }
    }
}
