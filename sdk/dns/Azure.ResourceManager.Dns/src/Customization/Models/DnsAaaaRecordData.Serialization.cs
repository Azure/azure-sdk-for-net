...
namespace Azure.ResourceManager.Dns
{
    public partial class DnsAaaaRecordData : IUtf8JsonSerializable
    {
        ...
        internal static DnsAaaaRecordData DeserializeDnsAaaaRecordData(JsonElement element)
        {
            ...
            return new DnsAaaaRecordData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource, trafficManagementProfile,  Optional.ToList(aaaaRecords));
        }
    }
}
