...
namespace Azure.ResourceManager.Dns
{
    public partial class DnsNaptrRecordData : IUtf8JsonSerializable
    {
        ...
        internal static DnsNaptrRecordData DeserializeDnsNaptrRecordData(JsonElement element)
        {
            ...
            return new DnsNaptrRecordData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource,  Optional.ToList(NaptrRecords));
        }
    }
}
