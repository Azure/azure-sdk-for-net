...
{
    public partial class DnsCnameRecordData : IUtf8JsonSerializable, IJsonModel<DnsCnameRecordData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsCnameRecordData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DnsCnameRecordData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DnsCnameRecordData)} does not support '{format}' format.");
            }
        ...
        internal static DnsCnameRecordData DeserializeDnsCnameRecordData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DnsCnameRecordData(id, name, type, systemData, Optional.ToNullable(etag), Optional.ToDictionary(metadata), Optional.ToNullable(ttl), fqdn.Value, provisioningState.Value, targetResource,  cnameRecord.Value, serializedAdditionalRawData);
        }
        BinaryData IPersistableModel<DnsCnameRecordData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DnsCnameRecordData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DnsCnameRecordData)} does not support '{options.Format}' format.");
            }
        }
