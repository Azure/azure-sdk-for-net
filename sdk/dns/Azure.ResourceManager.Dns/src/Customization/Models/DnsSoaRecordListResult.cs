...
namespace Azure.ResourceManager.Dns.Models
{
    ...
    internal partial class DnsSoaRecordListResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DnsSoaRecordListResult"/>. </summary>
        ...
        internal DnsSoaRecordListResult(IReadOnlyList<DnsSoaRecordData> value, string nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
