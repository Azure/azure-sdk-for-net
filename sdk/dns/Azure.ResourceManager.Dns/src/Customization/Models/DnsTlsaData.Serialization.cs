...
{
    public partial class DnsTlsaRecordData : IUtf8JsonSerializable, IJsonModel<DnsTlsaRecordData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsTlsaRecordData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DnsTlsaRecordData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DnsTlsaRecordData)} does not support '{format}' format.");
            }
        ...
        internal static DnsTlsaRecordData DeserializeDnsTlsaRecordData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<DnsTlsaRecordData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DnsTlsaRecordData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DnsTlsaRecordData)} does not support '{options.Format}' format.");
            }
        }
