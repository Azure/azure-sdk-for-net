...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class ARecordSetData : ResourceData
    {
        ...
        internal ARecordSetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? etag, IDictionary<string, string> metadata, long? ttl, string fqdn, string provisioningState, WritableSubResource targetResource, IList<ARecord> aRecords) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
            Metadata = metadata;
            Ttl = ttl;
