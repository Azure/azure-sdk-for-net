...
namespace Azure.ResourceManager.Dns
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="DnsCaaRecordResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="DnsZoneResource"/> using the GetDnsCaaRecords method.
    /// </summary>
    [CodeGenResourceDataAttribute(typeof(DnsCaaRecordData))]
    [CodeGenSuppressAttribute("DnsCaaRecordResource", typeof(ArmClient), typeof(DnsRecordData))]
    ...
    public partial class DnsCaaRecordResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of DnsCaaRecordResource for mocking. </summary>
        protected DnsCaaRecordResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DnsCaaRecordResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string dnsCaaRecordApiVersion);
        ...
        /// <param name="caaRecordName"> The caaRecordName. </param>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsZones/{zoneName}/CAA/{caaRecordName}";
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="DnsCaaRecordResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsCaaRecordResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "CAA", context);
        ...
        public virtual async Task<Response<DnsCaaRecordResource>> UpdateAsync(DnsCaaRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsCaaRecordResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "CAA", DnsCaaRecordData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsCaaRecordData> response = Response.FromValue(DnsCaaRecordData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<DnsCaaRecordResource> Update(DnsCaaRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsCaaRecordResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "CAA", ifMatch, context);
