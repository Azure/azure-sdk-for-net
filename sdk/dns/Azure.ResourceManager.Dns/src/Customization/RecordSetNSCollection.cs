...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class RecordSetNSCollection : ArmCollection, IEnumerable<RecordSetNSResource>, IAsyncEnumerable<RecordSetNSResource>
    {
        ...
        public virtual async Task<ArmOperation<RecordSetNSResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string relativeRecordSetName, NSRecordSetData data, ETag? ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<RecordSetNSResource> CreateOrUpdate(WaitUntil waitUntil, string relativeRecordSetName, NSRecordSetData data, ETag? ifMatch = null, string ifNoneMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(relativeRecordSetName, nameof(relativeRecordSetName));
            Argument.AssertNotNull(data, nameof(data));
