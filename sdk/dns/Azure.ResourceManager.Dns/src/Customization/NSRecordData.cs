...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class NSRecordData : ResourceData
    {
        ...
        internal NSRecordData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? etag, IDictionary<string, string> metadata, long? ttl, string fqdn, string provisioningState, WritableSubResource targetResource,IList<NSRecordInfo> nsRecords) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
            Metadata = metadata;
            TtlInSeconds = ttl;
