...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class SrvRecordResource : ArmResource
    {
        ...
        {
            using var scope = _recordSetSrvRecordSetsClientDiagnostics.CreateScope("SrvRecordResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _recordSetSrvRecordSetsClientDiagnostics.CreateScope("SrvRecordResource.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<SrvRecordResource>> UpdateAsync(SrvRecordData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _recordSetSrvRecordSetsClientDiagnostics.CreateScope("SrvRecordResource.Update");
            scope.Start();
            try
            {
