...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class MXRecordSetData : ResourceData
    {
        ...
        internal MXRecordSetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ETag? etag, IDictionary<string, string> metadata, long? ttl, string fqdn, string provisioningState, WritableSubResource targetResource, IList<MXRecordInfo> mxRecords) : base(id, name, resourceType, systemData)
        {
            ETag = etag;
            Metadata = metadata;
            TtlInSeconds = ttl;
