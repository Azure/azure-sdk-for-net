...
namespace Azure.ResourceManager.Dns
{
    ...
    [CodeGenSuppressAttribute("DnsDSRecordResource", typeof(ArmClient), typeof(DnsRecordData))]
    ...
    public partial class DnsDSRecordResource : ArmResource
    {
        ...
        /// <param name="dsRecordName"> The dsRecordName. </param>
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string resourceGroupName, string zoneName, string dsRecordName)
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsZones/{zoneName}/DS/{dsRecordName}";
