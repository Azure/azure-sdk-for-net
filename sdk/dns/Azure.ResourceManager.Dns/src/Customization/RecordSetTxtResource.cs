...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class RecordSetTxtResource : ArmResource
    {
        ...
        public virtual async Task<Response<RecordSetTxtResource>> UpdateAsync(TxtRecordSetData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<RecordSetTxtResource> Update(TxtRecordSetData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
