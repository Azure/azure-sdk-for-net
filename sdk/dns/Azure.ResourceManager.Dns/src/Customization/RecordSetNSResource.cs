...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class RecordSetNSResource : ArmResource
    {
        ...
        internal RecordSetNSResource(ArmClient client, NSRecordData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<RecordSetNSResource>> UpdateAsync(NSRecordData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<RecordSetNSResource> Update(NSRecordData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
