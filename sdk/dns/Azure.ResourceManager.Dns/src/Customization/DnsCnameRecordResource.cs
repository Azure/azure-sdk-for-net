...
namespace Azure.ResourceManager.Dns
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="DnsCnameRecordResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="DnsZoneResource"/> using the GetDnsCnameRecords method.
    /// </summary>
    [CodeGenResourceDataAttribute(typeof(DnsCnameRecordData))]
    [CodeGenSuppressAttribute("DnsCnameRecordResource", typeof(ArmClient), typeof(DnsRecordData))]
    ...
    public partial class DnsCnameRecordResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of DnsCnameRecordResource for mocking. </summary>
        protected DnsCnameRecordResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DnsCnameRecordResource"/> class. </summary>
        ...
        /// <param name="cnameRecordName"> The cnameRecordName. </param>
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="DnsCnameRecordResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsCnameRecordResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "CNAME", context);
        ...
        public virtual async Task<Response<DnsCnameRecordResource>> UpdateAsync(DnsCnameRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsCnameRecordResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "CNAME", DnsCnameRecordData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsCnameRecordData> response = Response.FromValue(DnsCnameRecordData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<DnsCnameRecordResource> Update(DnsCnameRecordData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        {
            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsCnameRecordResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _recordSetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, "CNAME", ifMatch, context);
