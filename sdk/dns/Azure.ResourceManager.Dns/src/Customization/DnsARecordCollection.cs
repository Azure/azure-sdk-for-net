...
namespace Azure.ResourceManager.Dns
{
    ...
    /// </summary>
    [CodeGenSuppressAttribute("CreateOrUpdateAsync", typeof(WaitUntil), typeof(string), typeof(DnsRecordType), typeof(DnsARecordData), typeof(MatchConditions), typeof(CancellationToken))]
    [CodeGenSuppressAttribute("CreateOrUpdate", typeof(WaitUntil), typeof(string), typeof(DnsRecordType), typeof(DnsARecordData), typeof(MatchConditions), typeof(CancellationToken))]
    ...
    public partial class DnsARecordCollection : ArmCollection
    {
        ...
        /// <summary> Initializes a new instance of DnsARecordCollection for mocking. </summary>
        protected DnsARecordCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DnsARecordCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DnsARecordCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            TryGetApiVersion(DnsARecordResource.ResourceType, out string dnsARecordApiVersion);
            _recordSetsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Dns", DnsARecordResource.ResourceType.Namespace, Diagnostics);
            _recordSetsRestClient = new RecordSets(_recordSetsClientDiagnostics, Pipeline, Endpoint, dnsARecordApiVersion ?? "2023-07-01-preview");
        ...
        public virtual async Task<ArmOperation<DnsARecordResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string relativeRecordSetName, DnsARecordData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(relativeRecordSetName, nameof(relativeRecordSetName));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _recordSetsClientDiagnostics.CreateScope("DnsARecordCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, relativeRecordSetName, "A", DnsARecordData.ToRequestContent(data), matchConditions, context);
                ...
                DnsArmOperation<DnsARecordResource> operation = new DnsArmOperation<DnsARecordResource>(Response.FromValue(new DnsARecordResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="relativeRecordSetName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="relativeRecordSetName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<DnsARecordResource> CreateOrUpdate(WaitUntil waitUntil, string relativeRecordSetName, DnsARecordData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(relativeRecordSetName, nameof(relativeRecordSetName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    case 200:
                        response = Response.FromValue(DnsARecordData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((DnsARecordData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<DnsARecordResource>> GetIfExistsAsync(string relativeRecordSetName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                if (response.Value == null)
                {
                    return new NoValueResponse<DnsARecordResource>(response.GetRawResponse());
                }
                return Response.FromValue(new DnsARecordResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
