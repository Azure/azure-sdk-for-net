...
namespace Azure.ResourceManager.Dns
{
    ...
    /// </summary>
    [CodeGenSuppressAttribute("CreateOrUpdateAsync", typeof(WaitUntil), typeof(string), typeof(DnsRecordType), typeof(DnsSoaRecordData), typeof(MatchConditions), typeof(CancellationToken))]
    [CodeGenSuppressAttribute("CreateOrUpdate", typeof(WaitUntil), typeof(string), typeof(DnsRecordType), typeof(DnsSoaRecordData), typeof(MatchConditions), typeof(CancellationToken))]
    ...
    public partial class DnsSoaRecordCollection : ArmCollection, IEnumerable<DnsSoaRecordResource>, IAsyncEnumerable<DnsSoaRecordResource>
    {
        ...
        internal DnsSoaRecordCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _recordSetsRestClient = new RecordSets(_recordSetsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, dnsSoaRecordApiVersion ?? "2023-07-01-preview");
        ...
        public virtual async Task<ArmOperation<DnsSoaRecordResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string soaRecordName, DnsSoaRecordData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, soaRecordName, "SOA", DnsSoaRecordData.ToRequestContent(data), matchConditions, context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="soaRecordName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="soaRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<DnsSoaRecordResource> CreateOrUpdate(WaitUntil waitUntil, string soaRecordName, DnsSoaRecordData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(soaRecordName, nameof(soaRecordName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<DnsSoaRecordResource>> GetAsync(string soaRecordName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _recordSetsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, soaRecordName, "SOA", context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DnsSoaRecordData> response = Response.FromValue(DnsSoaRecordData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="soaRecordName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="soaRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<NullableResponse<DnsSoaRecordResource>> GetIfExistsAsync(string soaRecordName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(soaRecordName, nameof(soaRecordName));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="soaRecordName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="soaRecordName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual NullableResponse<DnsSoaRecordResource> GetIfExists(string soaRecordName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(soaRecordName, nameof(soaRecordName));
