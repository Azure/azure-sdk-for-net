...
namespace Azure.ResourceManager.Dns
{
    ...
    public partial class RecordSetAResource : ArmResource
    {
        ...
        public virtual async Task<Response<RecordSetAResource>> UpdateAsync(ARecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<RecordSetAResource> Update(ARecordSetData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
