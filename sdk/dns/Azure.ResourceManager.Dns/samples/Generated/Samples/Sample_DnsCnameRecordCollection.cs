...
{
    public partial class Sample_DnsCnameRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this DnsCnameRecordResource
            DnsCnameRecordCollection collection = dnsZone.GetDnsCnameRecords();
...
IPv4Address = IPAddress.Parse("127.0.0.1"),
            ...
            ArmOperation<DnsCnameRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            DnsCnameRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            DnsCnameRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (DnsCnameRecordResource item in collection.GetAllAsync())
            {
