...
{
    public partial class Sample_ARecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this ARecordResource created on azure
            // for more information of creating ARecordResource, please refer to the document of ARecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier aRecordInfoResourceId = ARecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            ARecordResource aRecordInfo = client.GetARecordResource(aRecordInfoResourceId);
...
["key2"] = "value2",
            ...
            ARecordResource result = await aRecordInfo.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await aRecordInfo.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            ARecordResource result = await aRecordInfo.GetAsync();
