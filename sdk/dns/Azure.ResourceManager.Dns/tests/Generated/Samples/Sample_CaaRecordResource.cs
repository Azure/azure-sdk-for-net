...
{
    public partial class Sample_CaaRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this CaaRecordResource created on azure
            // for more information of creating CaaRecordResource, please refer to the document of CaaRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier caaRecordInfoResourceId = CaaRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            CaaRecordResource caaRecordInfo = client.GetCaaRecordResource(caaRecordInfoResourceId);
...
["key2"] = "value2",
            ...
            CaaRecordResource result = await caaRecordInfo.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await caaRecordInfo.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            CaaRecordResource result = await caaRecordInfo.GetAsync();
