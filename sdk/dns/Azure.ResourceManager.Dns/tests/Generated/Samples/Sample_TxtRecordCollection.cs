...
{
    public partial class Sample_TxtRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this TxtRecordResource
            TxtRecordCollection collection = dnsZone.GetTxtRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<TxtRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            TxtRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            TxtRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (TxtRecordResource item in collection.GetAllAsync())
            {
