...
{
    public partial class Sample_NSRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this NSRecordResource created on azure
            // for more information of creating NSRecordResource, please refer to the document of NSRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier nsRecordResourceId = NSRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            NSRecordResource nsRecord = client.GetNSRecordResource(nsRecordResourceId);
...
["key2"] = "value2",
            ...
            NSRecordResource result = await nsRecord.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await nsRecord.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            NSRecordResource result = await nsRecord.GetAsync();
