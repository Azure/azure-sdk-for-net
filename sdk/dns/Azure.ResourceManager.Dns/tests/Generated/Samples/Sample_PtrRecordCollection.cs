...
{
    public partial class Sample_PtrRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this PtrRecordResource
            PtrRecordCollection collection = dnsZone.GetPtrRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<PtrRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            PtrRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            PtrRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (PtrRecordResource item in collection.GetAllAsync())
            {
