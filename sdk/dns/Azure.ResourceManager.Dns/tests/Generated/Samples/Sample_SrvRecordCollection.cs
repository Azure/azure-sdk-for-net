...
{
    public partial class Sample_SrvRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this SrvRecordResource
            SrvRecordCollection collection = dnsZone.GetSrvRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<SrvRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            SrvRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            SrvRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (SrvRecordResource item in collection.GetAllAsync())
            {
