...
{
    public partial class Sample_AaaaRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this AaaaRecordResource
            AaaaRecordCollection collection = dnsZone.GetAaaaRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<AaaaRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            AaaaRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            AaaaRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (AaaaRecordResource item in collection.GetAllAsync())
            {
