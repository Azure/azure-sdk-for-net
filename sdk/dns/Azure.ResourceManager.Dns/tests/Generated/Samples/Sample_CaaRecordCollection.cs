...
{
    public partial class Sample_CaaRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this CaaRecordResource
            CaaRecordCollection collection = dnsZone.GetCaaRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<CaaRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            CaaRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            CaaRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (CaaRecordResource item in collection.GetAllAsync())
            {
