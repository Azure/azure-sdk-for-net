...
{
    public partial class Sample_MXRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this MXRecordResource created on azure
            // for more information of creating MXRecordResource, please refer to the document of MXRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier mxRecordResourceId = MXRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            MXRecordResource mxRecord = client.GetMXRecordResource(mxRecordResourceId);
...
["key2"] = "value2",
            ...
            MXRecordResource result = await mxRecord.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await mxRecord.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            MXRecordResource result = await mxRecord.GetAsync();
