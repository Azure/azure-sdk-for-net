...
{
    public partial class Sample_AaaaRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this AaaaRecordResource created on azure
            // for more information of creating AaaaRecordResource, please refer to the document of AaaaRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier aaaaRecordInfoResourceId = AaaaRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            AaaaRecordResource aaaaRecordInfo = client.GetAaaaRecordResource(aaaaRecordInfoResourceId);
...
["key2"] = "value2",
            ...
            AaaaRecordResource result = await aaaaRecordInfo.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await aaaaRecordInfo.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            AaaaRecordResource result = await aaaaRecordInfo.GetAsync();
