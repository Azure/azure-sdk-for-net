...
{
    public partial class Sample_PtrRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this PtrRecordResource created on azure
            // for more information of creating PtrRecordResource, please refer to the document of PtrRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier ptrRecordInfoResourceId = PtrRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            PtrRecordResource ptrRecordInfo = client.GetPtrRecordResource(ptrRecordInfoResourceId);
...
["key2"] = "value2",
            ...
            PtrRecordResource result = await ptrRecordInfo.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await ptrRecordInfo.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            PtrRecordResource result = await ptrRecordInfo.GetAsync();
