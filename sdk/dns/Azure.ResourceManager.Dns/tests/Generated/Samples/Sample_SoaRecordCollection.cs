...
{
    public partial class Sample_SoaRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this SoaRecordResource
            SoaRecordCollection collection = dnsZone.GetSoaRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<SoaRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            SoaRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            SoaRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (SoaRecordResource item in collection.GetAllAsync())
            {
