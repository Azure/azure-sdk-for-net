...
{
    public partial class Sample_SrvRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this SrvRecordResource created on azure
            // for more information of creating SrvRecordResource, please refer to the document of SrvRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier srvRecordInfoResourceId = SrvRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            SrvRecordResource srvRecordInfo = client.GetSrvRecordResource(srvRecordInfoResourceId);
...
["key2"] = "value2",
            ...
            SrvRecordResource result = await srvRecordInfo.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await srvRecordInfo.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            SrvRecordResource result = await srvRecordInfo.GetAsync();
