...
{
    public partial class Sample_TxtRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this TxtRecordResource created on azure
            // for more information of creating TxtRecordResource, please refer to the document of TxtRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier txtRecordInfoResourceId = TxtRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            TxtRecordResource txtRecordInfo = client.GetTxtRecordResource(txtRecordInfoResourceId);
...
["key2"] = "value2",
            ...
            TxtRecordResource result = await txtRecordInfo.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await txtRecordInfo.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            TxtRecordResource result = await txtRecordInfo.GetAsync();
