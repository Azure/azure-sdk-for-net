...
{
    public partial class Sample_CnameRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this CnameRecordResource created on azure
            // for more information of creating CnameRecordResource, please refer to the document of CnameRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier cnameRecordInfoResourceId = CnameRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            CnameRecordResource cnameRecordInfo = client.GetCnameRecordResource(cnameRecordInfoResourceId);
...
["key2"] = "value2",
            ...
            CnameRecordResource result = await cnameRecordInfo.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await cnameRecordInfo.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            CnameRecordResource result = await cnameRecordInfo.GetAsync();
