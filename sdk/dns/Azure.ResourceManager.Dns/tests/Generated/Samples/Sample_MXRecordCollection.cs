...
{
    public partial class Sample_MXRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this MXRecordResource
            MXRecordCollection collection = dnsZone.GetMXRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<MXRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            MXRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            MXRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (MXRecordResource item in collection.GetAllAsync())
            {
