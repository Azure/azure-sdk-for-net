...
{
    public partial class Sample_SoaRecordResource
    {
        // Patch A recordset
        ...
        public async Task Update_PatchARecordset()
        {
            ...
            // this example assumes you already have this SoaRecordResource created on azure
            // for more information of creating SoaRecordResource, please refer to the document of SoaRecordResource
            string subscriptionId = "subid";
            string resourceGroupName = "rg1";
            string zoneName = "zone1";
            string relativeRecordSetName = "record1";
            ResourceIdentifier soaRecordInfoResourceId = SoaRecordResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, zoneName, relativeRecordSetName);
            SoaRecordResource soaRecordInfo = client.GetSoaRecordResource(soaRecordInfoResourceId);
...
["key2"] = "value2",
            ...
            SoaRecordResource result = await soaRecordInfo.UpdateAsync(data);
...
["key2"] = "value2",
        ...
        public async Task Delete_DeleteARecordset()
        {
            ...
            // invoke the operation
            await soaRecordInfo.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            SoaRecordResource result = await soaRecordInfo.GetAsync();
