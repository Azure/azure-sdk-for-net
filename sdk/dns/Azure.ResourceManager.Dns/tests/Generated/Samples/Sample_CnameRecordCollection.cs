...
{
    public partial class Sample_CnameRecordCollection
    {
        // Create A recordset
        ...
        public async Task CreateOrUpdate_CreateARecordset()
        {
            ...
            // get the collection of this CnameRecordResource
            CnameRecordCollection collection = dnsZone.GetCnameRecords();
...
IPv4Address = "127.0.0.1",
            ...
            ArmOperation<CnameRecordResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, relativeRecordSetName, data);
            CnameRecordResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Get_GetARecordset()
        {
            ...
            // invoke the operation
            string relativeRecordSetName = "record1";
            CnameRecordResource result = await collection.GetAsync(relativeRecordSetName);
        ...
        public async Task GetAll_ListARecordsets()
        {
            ...
            await foreach (CnameRecordResource item in collection.GetAllAsync())
            {
