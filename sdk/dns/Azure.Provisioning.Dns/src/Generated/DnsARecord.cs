...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsARecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsARecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsARecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/A", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsARecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsARecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsARecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsARecord result = new DnsARecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsARecord that are not part of the generated code. </summary>
