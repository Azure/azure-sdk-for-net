...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsSoaRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsSoaRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsSoaRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/SOA", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsSoaRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsSoaRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsSoaRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsSoaRecord result = new DnsSoaRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsSoaRecord that are not part of the generated code. </summary>
