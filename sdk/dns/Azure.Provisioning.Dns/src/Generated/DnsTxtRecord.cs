...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsTxtRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsTxtRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsTxtRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/TXT", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsTxtRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsTxtRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsTxtRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsTxtRecord result = new DnsTxtRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsTxtRecord that are not part of the generated code. </summary>
