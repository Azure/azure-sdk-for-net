...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsDSRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsDSRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsDSRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/DS", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsDSRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsDSRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsDSRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsDSRecord result = new DnsDSRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsDSRecord that are not part of the generated code. </summary>
