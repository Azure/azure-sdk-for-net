...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsPtrRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsPtrRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsPtrRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/PTR", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsPtrRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsPtrRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsPtrRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsPtrRecord result = new DnsPtrRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsPtrRecord that are not part of the generated code. </summary>
