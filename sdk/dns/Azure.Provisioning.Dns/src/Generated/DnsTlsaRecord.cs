...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsTlsaRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsTlsaRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsTlsaRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/TLSA", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsTlsaRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsTlsaRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsTlsaRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsTlsaRecord result = new DnsTlsaRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsTlsaRecord that are not part of the generated code. </summary>
