...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsCnameRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsCnameRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsCnameRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/CNAME", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsCnameRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsCnameRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsCnameRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsCnameRecord result = new DnsCnameRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsCnameRecord that are not part of the generated code. </summary>
