...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsNSRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsNSRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsNSRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/NS", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsNSRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsNSRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsNSRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsNSRecord result = new DnsNSRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsNSRecord that are not part of the generated code. </summary>
