...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsMXRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsMXRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsMXRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/MX", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsMXRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsMXRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsMXRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsMXRecord result = new DnsMXRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsMXRecord that are not part of the generated code. </summary>
