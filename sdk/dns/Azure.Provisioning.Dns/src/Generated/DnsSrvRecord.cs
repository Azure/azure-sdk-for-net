...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsSrvRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsSrvRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsSrvRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/SRV", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsSrvRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsSrvRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsSrvRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsSrvRecord result = new DnsSrvRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsSrvRecord that are not part of the generated code. </summary>
