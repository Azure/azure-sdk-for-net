...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsCaaRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsCaaRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsCaaRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/CAA", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsCaaRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsCaaRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsCaaRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsCaaRecord result = new DnsCaaRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsCaaRecord that are not part of the generated code. </summary>
