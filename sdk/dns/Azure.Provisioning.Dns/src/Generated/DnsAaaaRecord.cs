...
namespace Azure.Provisioning.Dns
{
    ...
    public partial class DnsAaaaRecord : ProvisionableResource
    {
        ...
        /// <summary> Creates a new DnsAaaaRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public DnsAaaaRecord(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.Network/dnsZones/AAAA", resourceVersion ?? "2023-07-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for DnsAaaaRecord. </summary>
        ...
        /// <summary> Creates a reference to an existing DnsAaaaRecord. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static DnsAaaaRecord FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            DnsAaaaRecord result = new DnsAaaaRecord(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for DnsAaaaRecord that are not part of the generated code. </summary>
