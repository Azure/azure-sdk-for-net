...
{
    /// <summary> The AAAA record data in the record set. </summary>
    [CodeGenMember("DnsAaaaRecords")]
    public BicepList<DnsAaaaRecordInfo> AaaaRecords
    {
        get => Properties is null ? default : Properties.DnsAaaaRecords;
        set
        {
            ...
            Properties.DnsAaaaRecords = value;
        }
    }

    /// <summary> Supported DnsAaaaRecord resource versions. </summary>
