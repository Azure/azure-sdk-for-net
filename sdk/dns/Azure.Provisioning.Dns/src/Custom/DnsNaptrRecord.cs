...
// The shared properties model includes every record kind; expose only NAPTR records on this resource.
...
public partial class DnsNaptrRecord
{
    ...
    {
        get => Properties is null ? default : Properties.DnsNaptrRecords;
        set
        {
            ...
            Properties.DnsNaptrRecords = value;
        }
    }

    /// <summary> Supported DnsNaptrRecord resource versions. </summary>
