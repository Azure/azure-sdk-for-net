...
{
    /// <summary> The MX record data in the record set. </summary>
    [CodeGenMember("DnsMXRecords")]
    public BicepList<DnsMXRecordInfo> MxRecords
    {
        get => Properties is null ? default : Properties.DnsMXRecords;
        set
        {
            ...
            Properties.DnsMXRecords = value;
        }
    }

    /// <summary> Supported DnsMXRecord resource versions. </summary>
