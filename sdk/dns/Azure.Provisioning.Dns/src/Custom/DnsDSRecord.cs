...
// The shared properties model includes every record kind; expose only DS records on this resource.
...
public partial class DnsDSRecord
{
    ...
    {
        get => Properties is null ? default : Properties.DnsDSRecords;
        set
        {
            ...
            Properties.DnsDSRecords = value;
        }
    }

    /// <summary> Supported DnsDSRecord resource versions. </summary>
