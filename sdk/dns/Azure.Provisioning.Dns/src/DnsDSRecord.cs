...
/// DnsDSRecord.
/// </summary>
public partial class DnsDSRecord : ProvisionableResource
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new DnsDSRecord.
    /// </summary>
    /// <param name="bicepIdentifier">
    /// The the Bicep identifier name of the DnsDSRecord resource.  This can be
    /// used to refer to the resource in expressions, but is not the Azure
    /// name of the resource.  This value can contain letters, numbers, and
    /// underscores.
    /// </param>
    /// <param name="resourceVersion">Version of the DnsDSRecord.</param>
    public DnsDSRecord(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.Network/dnsZones/DS", resourceVersion ?? "2018-05-01")
    {
    }

    /// <summary>
    /// Define all the provisionable properties of DnsDSRecord.
    /// </summary>
    ...
    /// <summary>
    /// Supported DnsDSRecord resource versions.
    /// </summary>
    ...
    /// <summary>
    /// Creates a reference to an existing DnsDSRecord.
    /// </summary>
    /// <param name="bicepIdentifier">
    /// The the Bicep identifier name of the DnsDSRecord resource.  This can be
    /// used to refer to the resource in expressions, but is not the Azure
    ...
    /// </param>
    /// <param name="resourceVersion">Version of the DnsDSRecord.</param>
    /// <returns>The existing DnsDSRecord resource.</returns>
    public static DnsDSRecord FromExisting(string bicepIdentifier, string? resourceVersion = default) =>
