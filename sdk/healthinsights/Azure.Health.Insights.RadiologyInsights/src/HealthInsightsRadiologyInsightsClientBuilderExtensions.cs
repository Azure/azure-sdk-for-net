...
{
    /// <summary> Extension methods to add <see cref="RadiologyInsightsClient"/> to client builder. </summary>
    public static partial class HealthInsightsRadiologyInsightsClientBuilderExtensions
    {
        ...
        public static IAzureClientBuilder<RadiologyInsightsClient, RadiologyInsightsClientOptions> AddRadiologyInsightsClient<TBuilder>(this TBuilder builder, Uri endpoint, AzureKeyCredential credential)
        where TBuilder : IAzureClientFactoryBuilder
        {
            return builder.RegisterClientFactory<RadiologyInsightsClient, RadiologyInsightsClientOptions>((options) => new RadiologyInsightsClient(endpoint, credential, options));
        }
        ...
        {
            return builder.RegisterClientFactory<RadiologyInsightsClient, RadiologyInsightsClientOptions>(configuration);
        }
    }
}
