...
{
    public partial class FhirR4Identifier : IUtf8JsonWriteable, IJsonModel<FhirR4Identifier>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4Identifier>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FhirR4Identifier FromResponse(PipelineResponse response)
        {
