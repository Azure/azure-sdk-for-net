...
namespace Azure.Health.Insights.RadiologyInsights
{
    public partial class FhirR4Identifier : IUtf8JsonSerializable, IJsonModel<FhirR4Identifier>
    {
        ...
        void IJsonModel<FhirR4Identifier>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FhirR4Identifier)} does not support '{format}' format.");
            }
        ...
        internal static FhirR4Identifier DeserializeFhirR4Identifier(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<FhirR4Reference> assigner = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("assigner"u8))
                {
                    ...
                    assigner = FhirR4Reference.DeserializeFhirR4Reference(property.Value);
                    continue;
                }
            ...
            return new FhirR4Identifier(id.Value, Optional.ToList(extension), serializedAdditionalRawData, use.Value, type.Value, system.Value, value.Value, period.Value, assigner.Value);
        }
        ...
        BinaryData IPersistableModel<FhirR4Identifier>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FhirR4Identifier)} does not support '{options.Format}' format.");
            }
        }
