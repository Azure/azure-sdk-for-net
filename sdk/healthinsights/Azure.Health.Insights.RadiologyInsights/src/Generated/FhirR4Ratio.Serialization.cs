...
{
    public partial class FhirR4Ratio : IUtf8JsonWriteable, IJsonModel<FhirR4Ratio>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4Ratio>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FhirR4Ratio FromResponse(PipelineResponse response)
        {
