...
{
    public partial class RadiologyCodeWithTypes : IUtf8JsonWriteable, IJsonModel<RadiologyCodeWithTypes>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RadiologyCodeWithTypes>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RadiologyCodeWithTypes FromResponse(PipelineResponse response)
        {
