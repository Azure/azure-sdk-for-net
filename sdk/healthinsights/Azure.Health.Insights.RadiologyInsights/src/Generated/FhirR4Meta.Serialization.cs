...
{
    public partial class FhirR4Meta : IUtf8JsonWriteable, IJsonModel<FhirR4Meta>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4Meta>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static FhirR4Meta FromResponse(PipelineResponse response)
        {
