...
{
    public partial class AgeMismatchInference
    {
        internal static AgeMismatchInference DeserializeAgeMismatchInference(JsonElement element)
        {
            ...
            return new AgeMismatchInference(Optional.ToList(extension), kind);
        }
