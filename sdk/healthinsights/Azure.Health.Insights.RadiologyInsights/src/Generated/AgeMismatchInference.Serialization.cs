...
{
    public partial class AgeMismatchInference : IUtf8JsonWriteable, IJsonModel<AgeMismatchInference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AgeMismatchInference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new AgeMismatchInference FromResponse(PipelineResponse response)
        {
