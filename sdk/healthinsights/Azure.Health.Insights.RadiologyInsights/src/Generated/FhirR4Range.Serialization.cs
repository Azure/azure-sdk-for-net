...
{
    public partial class FhirR4Range : IUtf8JsonWriteable, IJsonModel<FhirR4Range>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4Range>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FhirR4Range FromResponse(PipelineResponse response)
        {
