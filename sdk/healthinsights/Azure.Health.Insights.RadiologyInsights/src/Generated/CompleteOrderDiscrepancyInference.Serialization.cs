...
{
    public partial class CompleteOrderDiscrepancyInference : IUtf8JsonWriteable, IJsonModel<CompleteOrderDiscrepancyInference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CompleteOrderDiscrepancyInference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new CompleteOrderDiscrepancyInference FromResponse(PipelineResponse response)
        {
