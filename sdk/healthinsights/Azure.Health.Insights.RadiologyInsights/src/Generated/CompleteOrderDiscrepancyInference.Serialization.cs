...
namespace Azure.Health.Insights.RadiologyInsights
{
    public partial class CompleteOrderDiscrepancyInference : IUtf8JsonSerializable, IJsonModel<CompleteOrderDiscrepancyInference>
    {
        ...
        internal static CompleteOrderDiscrepancyInference DeserializeCompleteOrderDiscrepancyInference(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IList<FhirR4CodeableConcept>> missingBodyParts = default;
            Optional<IList<FhirR4CodeableConcept>> missingBodyPartMeasurements = default;
            string kind = default;
            ...
            return new CompleteOrderDiscrepancyInference(kind, Optional.ToList(extension), serializedAdditionalRawData, orderType, Optional.ToList(missingBodyParts), Optional.ToList(missingBodyPartMeasurements));
        }
