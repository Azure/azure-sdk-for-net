...
{
    public partial class DocumentAdministrativeMetadata : IUtf8JsonWriteable, IJsonModel<DocumentAdministrativeMetadata>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentAdministrativeMetadata>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentAdministrativeMetadata FromResponse(PipelineResponse response)
        {
