...
namespace Azure.Health.Insights.RadiologyInsights
{
    public partial class PatientDocument : IUtf8JsonSerializable, IJsonModel<PatientDocument>
    {
        ...
        internal static PatientDocument DeserializePatientDocument(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PatientDocument(type, Optional.ToNullable(clinicalType), id, language.Value, Optional.ToNullable(createdAt), Optional.ToList(authors), Optional.ToNullable(specialtyType), administrativeMetadata.Value, content, serializedAdditionalRawData);
        }
