...
{
    public partial class PatientDocument : IUtf8JsonWriteable, IJsonModel<PatientDocument>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<PatientDocument>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static PatientDocument FromResponse(PipelineResponse response)
        {
