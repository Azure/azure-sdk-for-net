...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class RadiologyInsightsJob
    {
        ...
        internal RadiologyInsightsJob(RadiologyInsightsData jobData, RadiologyInsightsInferenceResult result, JobStatus status, DateTimeOffset? createdAt, DateTimeOffset? expiresAt, DateTimeOffset? updatedAt, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobData = jobData;
            Result = result;
            Status = status;
