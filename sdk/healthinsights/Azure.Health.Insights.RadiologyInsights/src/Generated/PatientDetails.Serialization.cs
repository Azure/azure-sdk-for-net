...
{
    public partial class PatientDetails : IUtf8JsonWriteable, IJsonModel<PatientDetails>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<PatientDetails>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static PatientDetails FromResponse(PipelineResponse response)
        {
