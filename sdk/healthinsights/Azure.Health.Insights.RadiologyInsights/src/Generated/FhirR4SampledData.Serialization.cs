...
namespace Azure.Health.Insights.RadiologyInsights
{
    public partial class FhirR4SampledData : IUtf8JsonSerializable, IJsonModel<FhirR4SampledData>
    {
        ...
        internal static FhirR4SampledData DeserializeFhirR4SampledData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FhirR4SampledData(id.Value, Optional.ToList(extension), serializedAdditionalRawData, origin, period, Optional.ToNullable(factor), Optional.ToNullable(lowerLimit), Optional.ToNullable(upperLimit), dimensions, data.Value);
        }
