...
{
    public partial class FhirR4SampledData : IUtf8JsonWriteable, IJsonModel<FhirR4SampledData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4SampledData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FhirR4SampledData FromResponse(PipelineResponse response)
        {
