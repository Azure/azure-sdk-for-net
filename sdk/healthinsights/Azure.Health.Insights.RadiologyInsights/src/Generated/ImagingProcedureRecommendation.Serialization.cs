...
{
    public partial class ImagingProcedureRecommendation : IUtf8JsonWriteable, IJsonModel<ImagingProcedureRecommendation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImagingProcedureRecommendation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ImagingProcedureRecommendation FromResponse(PipelineResponse response)
        {
