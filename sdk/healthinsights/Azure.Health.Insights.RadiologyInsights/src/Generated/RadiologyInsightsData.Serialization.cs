...
{
    public partial class RadiologyInsightsData : IUtf8JsonWriteable, IJsonModel<RadiologyInsightsData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RadiologyInsightsData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RadiologyInsightsData FromResponse(PipelineResponse response)
        {
