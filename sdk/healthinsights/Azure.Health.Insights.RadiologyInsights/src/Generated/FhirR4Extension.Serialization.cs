...
namespace Azure.Health.Insights.RadiologyInsights
{
    public partial class FhirR4Extension : IUtf8JsonSerializable, IJsonModel<FhirR4Extension>
    {
        ...
        internal static FhirR4Extension DeserializeFhirR4Extension(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FhirR4Extension(id.Value, Optional.ToList(extension), serializedAdditionalRawData, url, valueQuantity.Value, valueCodeableConcept.Value, valueString.Value, Optional.ToNullable(valueBoolean), Optional.ToNullable(valueInteger), valueRange.Value, valueRatio.Value, valueSampledData.Value, Optional.ToNullable(valueTime), valueDateTime.Value, valuePeriod.Value, valueReference.Value);
        }
