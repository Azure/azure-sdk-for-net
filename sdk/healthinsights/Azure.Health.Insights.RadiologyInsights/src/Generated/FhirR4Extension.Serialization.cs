...
{
    public partial class FhirR4Extension : IUtf8JsonWriteable, IJsonModel<FhirR4Extension>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4Extension>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FhirR4Extension>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FhirR4Extension)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FhirR4Extension>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FhirR4Extension)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new FhirR4Extension FromResponse(PipelineResponse response)
        {
