...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class ObservationReferenceRange
    {
        ...
        internal ObservationReferenceRange(Quantity low, Quantity high, CodeableConcept type, IList<CodeableConcept> appliesTo, Range age, string text, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Low = low;
            High = high;
            Type = type;
