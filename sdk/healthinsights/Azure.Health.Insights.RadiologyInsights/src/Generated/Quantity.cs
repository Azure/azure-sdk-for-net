...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="Quantity"/>. </summary>
        public Quantity()
        {
        }
        ...
        internal Quantity(string id, IReadOnlyList<Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData, double? value, string comparator, string unit, string system, string code) : base(id, extension, serializedAdditionalRawData)
        {
            Value = value;
