    ...
    public partial class RadiologyInsightsJob : IUtf8JsonSerializable, IJsonModel<RadiologyInsightsJob>
    {
        ...
        internal static RadiologyInsightsJob DeserializeRadiologyInsightsJob(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResponseError>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), options, AzureHealthInsightsRadiologyInsightsContext.Default)
#else
                ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), options, AzureHealthInsightsRadiologyInsightsContext.Default)
#endif
;
                    continue;
                }
