...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class RadiologyInsightsClient
    {
        ...
        public RadiologyInsightsClient(Uri endpoint, KeyCredential credential) : this(endpoint, credential, new RadiologyInsightsClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public RadiologyInsightsClient(Uri endpoint, KeyCredential credential, RadiologyInsightsClientOptions options)
        {
        ...
        public virtual async Task<Operation<RadiologyInsightsInferenceResult>> InferRadiologyInsightsAsync(WaitUntil waitUntil, RadiologyInsightsData radiologyInsightsData, CancellationToken cancellationToken = default)
        {
            ...
            using RequestBody content = radiologyInsightsData.ToRequestBody();
            Operation<BinaryData> result = await InferRadiologyInsightsAsync(waitUntil, content, context).ConfigureAwait(false);
            return ProtocolOperationHelpers.Convert(result, FetchRadiologyInsightsInferenceResultFromRadiologyInsightsResult, ClientDiagnostics, "RadiologyInsightsClient.InferRadiologyInsights");
        }
        ...
        public virtual Operation<RadiologyInsightsInferenceResult> InferRadiologyInsights(WaitUntil waitUntil, RadiologyInsightsData radiologyInsightsData, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using RequestBody content = radiologyInsightsData.ToRequestBody();
            Operation<BinaryData> result = InferRadiologyInsights(waitUntil, content, context);
            return ProtocolOperationHelpers.Convert(result, FetchRadiologyInsightsInferenceResultFromRadiologyInsightsResult, ClientDiagnostics, "RadiologyInsightsClient.InferRadiologyInsights");
        }
        ...
        public virtual async Task<Operation<BinaryData>> InferRadiologyInsightsAsync(WaitUntil waitUntil, RequestBody content, RequestOptions context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateSpan("RadiologyInsightsClient.InferRadiologyInsights");
            scope.Start();
            try
            {
                using PipelineMessage message = CreateInferRadiologyInsightsRequest(content, context);
        ...
        /// <exception cref="MessageFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        public virtual Operation<BinaryData> InferRadiologyInsights(WaitUntil waitUntil, RequestBody content, RequestOptions context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal PipelineMessage CreateInferRadiologyInsightsRequest(RequestBody content, RequestOptions context)
        {
        ...
        private RadiologyInsightsInferenceResult FetchRadiologyInsightsInferenceResultFromRadiologyInsightsResult(Result response)
        {
