...
{
    public partial class FhirR4Resource : IUtf8JsonWriteable, IJsonModel<FhirR4Resource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4Resource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static FhirR4Resource FromResponse(PipelineResponse response)
        {
