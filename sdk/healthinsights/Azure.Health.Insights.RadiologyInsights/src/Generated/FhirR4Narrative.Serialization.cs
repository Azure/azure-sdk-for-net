...
{
    public partial class FhirR4Narrative : IUtf8JsonWriteable, IJsonModel<FhirR4Narrative>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4Narrative>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FhirR4Narrative FromResponse(PipelineResponse response)
        {
