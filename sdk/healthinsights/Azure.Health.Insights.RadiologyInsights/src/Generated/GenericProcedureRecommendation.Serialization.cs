...
{
    public partial class GenericProcedureRecommendation : IUtf8JsonWriteable, IJsonModel<GenericProcedureRecommendation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<GenericProcedureRecommendation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new GenericProcedureRecommendation FromResponse(PipelineResponse response)
        {
