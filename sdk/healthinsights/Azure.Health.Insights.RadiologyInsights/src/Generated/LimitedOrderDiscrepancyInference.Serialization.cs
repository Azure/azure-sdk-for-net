...
{
    public partial class LimitedOrderDiscrepancyInference : IUtf8JsonWriteable, IJsonModel<LimitedOrderDiscrepancyInference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<LimitedOrderDiscrepancyInference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new LimitedOrderDiscrepancyInference FromResponse(PipelineResponse response)
        {
