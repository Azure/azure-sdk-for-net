...
{
    public partial class FhirR4Coding : IUtf8JsonWriteable, IJsonModel<FhirR4Coding>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4Coding>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FhirR4Coding FromResponse(PipelineResponse response)
        {
