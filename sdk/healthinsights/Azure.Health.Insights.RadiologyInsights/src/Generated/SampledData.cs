...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class SampledData : Element
    {
        ...
        public SampledData(Quantity origin, double period, int dimensions)
        {
        ...
        internal SampledData(string id, IReadOnlyList<Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData, Quantity origin, double period, double? factor, double? lowerLimit, double? upperLimit, int dimensions, string data) : base(id, extension, serializedAdditionalRawData)
        {
            Origin = origin;
            Period = period;
            Factor = factor;
        ...
        /// <summary> Initializes a new instance of <see cref="SampledData"/> for deserialization. </summary>
