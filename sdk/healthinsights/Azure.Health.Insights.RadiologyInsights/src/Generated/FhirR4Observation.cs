...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class FhirR4Observation : FhirR4DomainResource
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="resourceType"/> or <paramref name="code"/> is null. </exception>
        internal FhirR4Observation(string resourceType, ObservationStatusCodeType status, FhirR4CodeableConcept code) : base(resourceType)
        {
