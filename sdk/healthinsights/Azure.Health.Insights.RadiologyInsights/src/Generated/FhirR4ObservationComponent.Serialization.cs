...
namespace Azure.Health.Insights.RadiologyInsights
{
    internal partial class FhirR4ObservationComponent : IUtf8JsonSerializable, IJsonModel<FhirR4ObservationComponent>
    {
        ...
        internal static FhirR4ObservationComponent DeserializeFhirR4ObservationComponent(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FhirR4ObservationComponent(id.Value, Optional.ToList(extension), serializedAdditionalRawData, code, valueQuantity.Value, valueCodeableConcept.Value, valueString.Value, Optional.ToNullable(valueBoolean), Optional.ToNullable(valueInteger), valueRange.Value, valueRatio.Value, valueSampledData.Value, Optional.ToNullable(valueTime), valueDateTime.Value, valuePeriod.Value, valueReference.Value, dataAbsentReason.Value, Optional.ToList(interpretation), Optional.ToList(referenceRange));
        }
