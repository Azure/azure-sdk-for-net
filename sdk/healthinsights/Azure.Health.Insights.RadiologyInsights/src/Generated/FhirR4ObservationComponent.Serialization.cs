...
namespace Azure.Health.Insights.RadiologyInsights
{
    internal partial class FhirR4ObservationComponent : IUtf8JsonSerializable, IJsonModel<FhirR4ObservationComponent>
    {
        ...
        void IJsonModel<FhirR4ObservationComponent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (!(Interpretation is ChangeTrackingList<FhirR4CodeableConcept> collection && collection.IsUndefined))
            {
            ...
            if (!(ReferenceRange is ChangeTrackingList<FhirR4ObservationReferenceRange> collection0 && collection0.IsUndefined))
            {
