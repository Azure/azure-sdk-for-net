...
{
    public partial class FhirR4ObservationComponent : IUtf8JsonWriteable, IJsonModel<FhirR4ObservationComponent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4ObservationComponent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FhirR4ObservationComponent FromResponse(PipelineResponse response)
        {
