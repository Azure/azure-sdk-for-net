...
{
    public partial class SexMismatchInference : IUtf8JsonWriteable, IJsonModel<SexMismatchInference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SexMismatchInference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new SexMismatchInference FromResponse(PipelineResponse response)
        {
