...
{
    public partial class FollowupCommunicationInference : IUtf8JsonWriteable, IJsonModel<FollowupCommunicationInference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FollowupCommunicationInference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FollowupCommunicationInference FromResponse(PipelineResponse response)
        {
