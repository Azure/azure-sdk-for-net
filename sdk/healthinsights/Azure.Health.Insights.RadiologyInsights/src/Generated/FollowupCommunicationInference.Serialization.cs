...
namespace Azure.Health.Insights.RadiologyInsights
{
    public partial class FollowupCommunicationInference : IUtf8JsonSerializable, IJsonModel<FollowupCommunicationInference>
    {
        ...
        internal static FollowupCommunicationInference DeserializeFollowupCommunicationInference(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IList<DateTimeOffset>> communicatedAt = default;
            Optional<IList<MedicalProfessionalType>> recipient = default;
            ...
            return new FollowupCommunicationInference(kind, Optional.ToList(extension), serializedAdditionalRawData, Optional.ToList(communicatedAt), Optional.ToList(recipient), wasAcknowledged);
        }
