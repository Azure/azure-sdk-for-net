...
{
    public partial class PatientRecord : IUtf8JsonWriteable, IJsonModel<PatientRecord>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<PatientRecord>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static PatientRecord FromResponse(PipelineResponse response)
        {
