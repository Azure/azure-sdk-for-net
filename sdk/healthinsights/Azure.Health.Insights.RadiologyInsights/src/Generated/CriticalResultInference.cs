...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class CriticalResultInference : RadiologyInsightsInference
    {
        ...
        /// <param name="result"> The complete Critical Result, as outlined below, will be reused for the recommendation. </param>
        internal CriticalResultInference(IReadOnlyList<FhirR4Extension> extension, RadiologyInsightsInferenceType kind, IDictionary<string, BinaryData> serializedAdditionalRawData, CriticalResult result) : base(extension, kind, serializedAdditionalRawData)
        {
            Result = result;
        }
