...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class Meta
    {
        ...
        internal Meta(string versionId, string lastUpdated, string source, IList<string> profile, IList<Coding> security, IList<Coding> tag, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VersionId = versionId;
