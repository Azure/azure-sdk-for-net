...
{
    public partial class RadiologyInsightsInferenceResult : IUtf8JsonWriteable, IJsonModel<RadiologyInsightsInferenceResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RadiologyInsightsInferenceResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RadiologyInsightsInferenceResult FromResponse(PipelineResponse response)
        {
