...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class Annotation : Element
    {
        ...
        /// <param name="text"> The annotation - text content (as markdown). </param>
        internal Annotation(string id, IReadOnlyList<Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData, string authorString, string time, string text) : base(id, extension, serializedAdditionalRawData)
        {
