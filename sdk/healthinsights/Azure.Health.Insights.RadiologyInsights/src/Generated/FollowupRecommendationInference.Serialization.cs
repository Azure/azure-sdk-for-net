...
namespace Azure.Health.Insights.RadiologyInsights
{
    public partial class FollowupRecommendationInference : IUtf8JsonSerializable, IJsonModel<FollowupRecommendationInference>
    {
        ...
        internal static FollowupRecommendationInference DeserializeFollowupRecommendationInference(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<string> effectiveAt = default;
            Optional<FhirR4Period> effectivePeriod = default;
            Optional<IList<RecommendationFinding>> findings = default;
            ...
            return new FollowupRecommendationInference(kind, Optional.ToList(extension), serializedAdditionalRawData, effectiveAt.Value, effectivePeriod.Value, Optional.ToList(findings), isConditional, isOption, isGuideline, isHedging, recommendedProcedure);
        }
