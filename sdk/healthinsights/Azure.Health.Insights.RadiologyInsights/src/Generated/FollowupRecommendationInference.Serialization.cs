...
{
    public partial class FollowupRecommendationInference : IUtf8JsonWriteable, IJsonModel<FollowupRecommendationInference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FollowupRecommendationInference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FollowupRecommendationInference FromResponse(PipelineResponse response)
        {
