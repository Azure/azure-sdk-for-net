...
{
    public partial class FindingOptions : IUtf8JsonWriteable, IJsonModel<FindingOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FindingOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static FindingOptions FromResponse(PipelineResponse response)
        {
