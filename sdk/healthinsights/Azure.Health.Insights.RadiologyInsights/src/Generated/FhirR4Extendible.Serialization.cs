...
{
    public partial class FhirR4Extendible : IUtf8JsonWriteable, IJsonModel<FhirR4Extendible>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4Extendible>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static FhirR4Extendible FromResponse(PipelineResponse response)
        {
