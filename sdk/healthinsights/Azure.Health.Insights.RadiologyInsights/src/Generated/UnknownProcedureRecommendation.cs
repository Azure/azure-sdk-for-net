...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    internal partial class UnknownProcedureRecommendation : ProcedureRecommendation
    {
        ...
        internal UnknownProcedureRecommendation(string kind, IList<FhirR4Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, extension, serializedAdditionalRawData)
        {
        }
