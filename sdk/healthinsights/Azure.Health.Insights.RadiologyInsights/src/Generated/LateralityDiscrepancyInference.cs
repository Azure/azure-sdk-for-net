...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class LateralityDiscrepancyInference : RadiologyInsightsInference
    {
        ...
        /// <param name="discrepancyType"> Mismatch type : orderLateralityMismatch, textLateralityContradiction, textLateralityMissing. </param>
        internal LateralityDiscrepancyInference(IReadOnlyList<FhirR4Extension> extension, RadiologyInsightsInferenceType kind, IDictionary<string, BinaryData> serializedAdditionalRawData, FhirR4CodeableConcept lateralityIndication, LateralityDiscrepancyType discrepancyType) : base(extension, kind, serializedAdditionalRawData)
        {
