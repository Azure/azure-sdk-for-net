...
{
    public partial class FhirR4ObservationReferenceRange : IUtf8JsonWriteable, IJsonModel<FhirR4ObservationReferenceRange>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4ObservationReferenceRange>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static FhirR4ObservationReferenceRange FromResponse(PipelineResponse response)
        {
