...
{
    internal partial class FhirR4Annotation : IUtf8JsonSerializable, IJsonModel<FhirR4Annotation>
    {
        ...
        void IJsonModel<FhirR4Annotation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FhirR4Annotation)} does not support '{format}' format.");
            }
        ...
        internal static FhirR4Annotation DeserializeFhirR4Annotation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FhirR4Annotation(id.Value, Optional.ToList(extension), serializedAdditionalRawData, authorString.Value, time.Value, text);
        }
        ...
        BinaryData IPersistableModel<FhirR4Annotation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FhirR4Annotation)} does not support '{options.Format}' format.");
            }
        }
