...
{
    public partial class FhirR4Annotation : IUtf8JsonWriteable, IJsonModel<FhirR4Annotation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4Annotation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FhirR4Annotation FromResponse(PipelineResponse response)
        {
