...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class FindingInference : RadiologyInsightsInference
    {
        ...
        /// <param name="finding"> Finding data : contains extensions, fields and components linked with the finding. </param>
        internal FindingInference(IReadOnlyList<FhirR4Extension> extension, RadiologyInsightsInferenceType kind, IDictionary<string, BinaryData> serializedAdditionalRawData, FhirR4Observation finding) : base(extension, kind, serializedAdditionalRawData)
        {
            Finding = finding;
        }
