...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class SexMismatchInference : RadiologyInsightsInference
    {
        ...
        /// <param name="sexIndication"> Sex indication : SNOMED CT code for gender finding. </param>
        internal SexMismatchInference(string kind, IList<FhirR4Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData, FhirR4CodeableConcept sexIndication) : base(kind, extension, serializedAdditionalRawData)
        {
            SexIndication = sexIndication;
        }
