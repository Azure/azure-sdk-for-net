...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class SexMismatchInference : RadiologyInsightsInference
    {
        ...
        /// <param name="sexIndication"> Sex indication : SNOMED CT code for gender finding. </param>
        internal SexMismatchInference(IReadOnlyList<FhirR4Extension> extension, RadiologyInsightsInferenceType kind, IDictionary<string, BinaryData> serializedAdditionalRawData, FhirR4CodeableConcept sexIndication) : base(extension, kind, serializedAdditionalRawData)
        {
            SexIndication = sexIndication;
        }
