...
{
    public partial class Encounter : IUtf8JsonWriteable, IJsonModel<Encounter>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<Encounter>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static Encounter FromResponse(PipelineResponse response)
        {
