...
{
    public partial class RadiologyProcedureInference : IUtf8JsonWriteable, IJsonModel<RadiologyProcedureInference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RadiologyProcedureInference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new RadiologyProcedureInference FromResponse(PipelineResponse response)
        {
