...
{
    public partial class RadiologyInsightsInferenceOptions : IUtf8JsonWriteable, IJsonModel<RadiologyInsightsInferenceOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RadiologyInsightsInferenceOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RadiologyInsightsInferenceOptions FromResponse(PipelineResponse response)
        {
