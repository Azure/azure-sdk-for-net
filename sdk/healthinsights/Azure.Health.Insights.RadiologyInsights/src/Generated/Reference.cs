...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class Reference : Element
    {
        ...
        internal Reference(string id, IReadOnlyList<Extension> extension, string referenceProperty, string type, Identifier identifier, string display) : base(id, extension)
        {
