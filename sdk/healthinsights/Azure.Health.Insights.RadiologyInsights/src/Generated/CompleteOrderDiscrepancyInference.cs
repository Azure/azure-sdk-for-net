...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class CompleteOrderDiscrepancyInference : RadiologyInsightsInference
    {
        ...
        internal CompleteOrderDiscrepancyInference(IReadOnlyList<FhirR4Extension> extension, RadiologyInsightsInferenceType kind, IDictionary<string, BinaryData> serializedAdditionalRawData, FhirR4CodeableConcept orderType, IReadOnlyList<FhirR4CodeableConcept> missingBodyParts, IReadOnlyList<FhirR4CodeableConcept> missingBodyPartMeasurements) : base(extension, kind, serializedAdditionalRawData)
        {
            OrderType = orderType;
