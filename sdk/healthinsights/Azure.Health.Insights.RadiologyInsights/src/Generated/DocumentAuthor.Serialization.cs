...
{
    public partial class DocumentAuthor : IUtf8JsonWriteable, IJsonModel<DocumentAuthor>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentAuthor>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentAuthor FromResponse(PipelineResponse response)
        {
