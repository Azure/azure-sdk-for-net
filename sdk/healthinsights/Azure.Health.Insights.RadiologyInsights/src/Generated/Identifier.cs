...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class Identifier : Element
    {
        ...
        internal Identifier(string id, IReadOnlyList<Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData, string use, CodeableConcept type, string system, string value, Period period, Reference assigner) : base(id, extension, serializedAdditionalRawData)
        {
            Use = use;
            Type = type;
            System = system;
