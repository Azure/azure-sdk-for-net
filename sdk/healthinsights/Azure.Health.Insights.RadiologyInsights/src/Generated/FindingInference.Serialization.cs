...
{
    public partial class FindingInference : IUtf8JsonWriteable, IJsonModel<FindingInference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FindingInference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FindingInference FromResponse(PipelineResponse response)
        {
