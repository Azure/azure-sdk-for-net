...
{
    public partial class FindingInference
    {
        internal static FindingInference DeserializeFindingInference(JsonElement element)
        {
            ...
            return new FindingInference(Optional.ToList(extension), kind, finding);
        }
