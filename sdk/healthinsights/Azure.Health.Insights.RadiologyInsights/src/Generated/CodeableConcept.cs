...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class CodeableConcept : Element
    {
        ...
        internal CodeableConcept(string id, IReadOnlyList<Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData, IList<Coding> coding, string text) : base(id, extension, serializedAdditionalRawData)
        {
            Coding = coding;
            Text = text;
        }
