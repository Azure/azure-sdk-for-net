...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="Coding"/>. </summary>
        public Coding()
        {
        }
        ...
        internal Coding(string id, IReadOnlyList<Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData, string system, string version, string code, string display) : base(id, extension, serializedAdditionalRawData)
        {
            System = system;
            Version = version;
            Code = code;
