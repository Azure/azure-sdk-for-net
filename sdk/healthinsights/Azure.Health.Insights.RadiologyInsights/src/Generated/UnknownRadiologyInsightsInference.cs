...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    internal partial class UnknownRadiologyInsightsInference : RadiologyInsightsInference
    {
        ...
        internal UnknownRadiologyInsightsInference(RadiologyInsightsInferenceType kind, IList<FhirR4Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, extension, serializedAdditionalRawData)
        {
        }
