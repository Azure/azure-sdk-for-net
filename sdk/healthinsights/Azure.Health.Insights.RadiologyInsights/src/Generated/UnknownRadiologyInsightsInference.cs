...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    internal partial class UnknownRadiologyInsightsInference : RadiologyInsightsInference
    {
        ...
        internal UnknownRadiologyInsightsInference(string kind, IReadOnlyList<Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, extension, serializedAdditionalRawData)
        {
        }
