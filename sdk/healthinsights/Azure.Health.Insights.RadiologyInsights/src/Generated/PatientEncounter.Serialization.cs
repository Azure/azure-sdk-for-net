...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PatientEncounter>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PatientEncounter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PatientEncounter)} does not support '{format}' format.");
            }
        ...
        internal static PatientEncounter DeserializePatientEncounter(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PatientEncounter(id, period.Value, Optional.ToNullable(@class), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<PatientEncounter>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PatientEncounter)} does not support '{options.Format}' format.");
            }
        }
