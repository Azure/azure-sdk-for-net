...
{
    public partial class FhirR4Observation : IUtf8JsonWriteable, IJsonModel<FhirR4Observation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4Observation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FhirR4Observation FromResponse(PipelineResponse response)
        {
