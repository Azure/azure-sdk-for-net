...
{
    internal partial class UnknownFhirR4DomainResource : IUtf8JsonWriteable, IJsonModel<FhirR4DomainResource>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4DomainResource>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new UnknownFhirR4DomainResource FromResponse(PipelineResponse response)
        {
