...
{
    public partial class FhirR4CodeableConcept : IUtf8JsonWriteable, IJsonModel<FhirR4CodeableConcept>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FhirR4CodeableConcept>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<FhirR4CodeableConcept>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FhirR4CodeableConcept)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FhirR4CodeableConcept>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(FhirR4CodeableConcept)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new FhirR4CodeableConcept FromResponse(PipelineResponse response)
        {
