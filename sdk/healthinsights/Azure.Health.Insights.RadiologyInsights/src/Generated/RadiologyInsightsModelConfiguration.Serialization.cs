...
{
    public partial class RadiologyInsightsModelConfiguration : IUtf8JsonWriteable, IJsonModel<RadiologyInsightsModelConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RadiologyInsightsModelConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RadiologyInsightsModelConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RadiologyInsightsModelConfiguration)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RadiologyInsightsModelConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RadiologyInsightsModelConfiguration)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static RadiologyInsightsModelConfiguration FromResponse(PipelineResponse response)
        {
