...
{
    public partial class LateralityDiscrepancyInference : IUtf8JsonWriteable, IJsonModel<LateralityDiscrepancyInference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<LateralityDiscrepancyInference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new LateralityDiscrepancyInference FromResponse(PipelineResponse response)
        {
