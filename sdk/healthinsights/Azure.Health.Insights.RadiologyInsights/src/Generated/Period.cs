...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class Period : Element
    {
        ...
        internal Period(string id, IReadOnlyList<Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData, string start, string end) : base(id, extension, serializedAdditionalRawData)
        {
            Start = start;
            End = end;
        }
