...
namespace Azure.Health.Insights.RadiologyInsights
{
    ...
    public partial class Ratio : Element
    {
        ...
        internal Ratio(string id, IReadOnlyList<Extension> extension, IDictionary<string, BinaryData> serializedAdditionalRawData, Quantity numerator, Quantity denominator) : base(id, extension, serializedAdditionalRawData)
        {
            Numerator = numerator;
