...
```C# Snippet:Followup_Communication_Async_Tests_Samples_CreatePatientRecord
...
```C# Snippet:Followup_Communication_Async_Tests_Samples_Doc_Content
...
```C# Snippet:Followup_Communication_Async_Tests_Samples_CreateDocumentAdministrativeMetadata
...
```C# Snippet:Followup_Communication_Async_Tests_Samples_CreateModelConfiguration
...
```C# Snippet:Followup_Communication_Async_Tests_Samples_CreateRadiologyInsightsInferenceOptions
...
```C# Snippet:Followup_Communication_Async_Tests_Samples_AddRecordAndConfiguration
...
```C# Snippet:Followup_Communication_Async_Tests_Samples_CreateClient
...
```C# Snippet:Followup_Communication_Async_Tests_Samples_synccall
