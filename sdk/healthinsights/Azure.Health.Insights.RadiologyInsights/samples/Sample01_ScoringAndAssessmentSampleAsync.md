# How to extract a Scoring and Assessment inference using an asynchronous call
...
```C# Snippet:Scoring_And_Assessment_Async_Tests_Samples_CreatePatientRecord
...
```C# Snippet:Scoring_And_Assessment_Async_Tests_Samples_Doc_Content
...
```C# Snippet:Scoring_And_Assessment_Async_Tests_Samples_CreateDocumentAdministrativeMetadata
...
```C# Snippet:Scoring_And_Assessment_Async_Tests_Samples_CreateModelConfiguration
...
```C# Snippet:Scoring_And_Assessment_Async_Tests_Samples_CreateRadiologyInsightsInferenceOptions
...
```C# Snippet:Scoring_And_Assessment_Async_Tests_Samples_AddRecordAndConfiguration
...
```C# Snippet:Scoring_And_Assessment_Async_Tests_Samples_TokenCredential
...
```C# Snippet:Scoring_And_Assessment_Async_Tests_Samples_Asynccall
...
```C# Snippet:Scoring_And_Assessment_Async_Tests_Samples_ScoringAndAssessment
...
```C# Snippet:Scoring_And_Assessment_Async_Tests_Samples_DisplayValueRange
