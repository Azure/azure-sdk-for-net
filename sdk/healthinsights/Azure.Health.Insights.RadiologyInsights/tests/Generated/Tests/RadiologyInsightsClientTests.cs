...
{
    public partial class RadiologyInsightsClientTests : HealthInsightsRadiologyInsightsTestBase
    {
        public RadiologyInsightsClientTests(bool isAsync) : base(isAsync)
        {
        }

        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task RadiologyInsightsJob_InferRadiologyInsights_ShortVersion()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            RadiologyInsightsClient client = CreateRadiologyInsightsClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task RadiologyInsightsJob_InferRadiologyInsights_ShortVersion_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            RadiologyInsightsClient client = CreateRadiologyInsightsClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task RadiologyInsightsJob_InferRadiologyInsights_AllParameters()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            RadiologyInsightsClient client = CreateRadiologyInsightsClient(endpoint, credential);
...
"ageMismatch"
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task RadiologyInsightsJob_InferRadiologyInsights_AllParameters_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            RadiologyInsightsClient client = CreateRadiologyInsightsClient(endpoint, credential);
