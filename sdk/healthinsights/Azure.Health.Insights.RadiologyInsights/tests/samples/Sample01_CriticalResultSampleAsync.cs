...
namespace Azure.Health.Insights.RadiologyInsights.Tests
{
    ...
    {
        #region Snippet:Critical_Result_Async_Tests_Samples_Doc_Content
        ...
        public async Task RadiologyInsightsCriticalResultScenario()
        {
            ...
            #region Snippet:Critical_Result_Async_Tests_Samples_CreateClient
        ...
        private static RadiologyInsightsData GetRadiologyInsightsData()
        {
            ...
            #region Snippet:Critical_Result_Async_Tests_Samples_AddRecordAndConfiguration
        ...
        private static RadiologyInsightsModelConfiguration CreateConfiguration()
        {
            ...
            #region Snippet:Critical_Result_Async_Tests_Samples_CreateModelConfiguration
        ...
        {
            #region Snippet:Critical_Result_Async_Tests_Samples_CreateRadiologyInsightsInferenceOptions
        ...
        {
            #region Snippet:Critical_Result_Async_Tests_Samples_CreatePatientRecord
        ...
        {
            #region Snippet:Critical_Result_Async_Tests_Samples_CreateDocumentAdministrativeMetadata
