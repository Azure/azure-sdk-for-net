...
namespace Azure.Health.Insights.RadiologyInsights.Tests
{
    ...
    {
        #region Snippet:Finding_Async_Tests_Samples_Doc_Content
        ...
        public async Task RadiologyInsightsFindingScenario()
        {
            ...
            #region Snippet:Finding_Async_Tests_Samples_CreateClient
            Uri endpointUri = new Uri(endpoint);
            TokenCredential cred = new DefaultAzureCredential();
            RadiologyInsightsClient client = new RadiologyInsightsClient(endpointUri, cred);
            #endregion
            #region Snippet:Finding_Async_Tests_Samples_synccall
            ...
            foreach (RadiologyInsightsInference inference in inferences)
            {
                ...
                {
                    #region Snippet:Finding_Async_Tests_Samples_FindingInference
        ...
        private static void displaySectionInfo(FindingInference findingInference)
        {
            ...
            {
                #region Snippet:Finding_Async_Tests_Samples_DisplaySectionInfo
        ...
        private static void DisplayCodes(FhirR4CodeableConcept codeableConcept, int indentation)
        {
            ...
            {
                #region Snippet:Finding_Async_Tests_Samples_DisplayCodes
        ...
        private static RadiologyInsightsData GetRadiologyInsightsData()
        {
            ...
            #region Snippet:Finding_Async_Tests_Samples_AddRecordAndConfiguration
        ...
        private static RadiologyInsightsModelConfiguration CreateConfiguration()
        {
            ...
            #region Snippet:Finding_Async_Tests_Samples_CreateModelConfiguration
        ...
        {
            #region Snippet:Finding_Async_Tests_Samples_CreateRadiologyInsightsInferenceOptions
        ...
        {
            #region Snippet:Finding_Async_Tests_Samples_CreatePatientRecord
        ...
        {
            #region Snippet:Finding_Async_Tests_Samples_CreateDocumentAdministrativeMetadata
