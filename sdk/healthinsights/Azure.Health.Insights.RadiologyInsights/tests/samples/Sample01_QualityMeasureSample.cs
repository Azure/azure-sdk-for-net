...
{
    internal class Sample01_QualityMeasureSample : SamplesBase<HealthInsightsTestEnvironment>
    {
        #region Snippet:Quality_Measure_Sync_Tests_Samples_Doc_Content
        ...
        [Test]
        public void RadiologyInsightsQualityMeasureScenario()
        {
            // Read endpoint
            string endpoint = TestEnvironment.Endpoint;
            #region Snippet:Quality_Measure_Sync_Tests_Samples_TokenCredential
            Uri endpointUri = new Uri(endpoint);
            TokenCredential cred = new DefaultAzureCredential();
            RadiologyInsightsClient client = new RadiologyInsightsClient(endpointUri, cred);
            #endregion
            #region Snippet:Quality_Measure_Sync_Tests_Samples_synccall
            ...
            #endregion
            #region Snippet:Quality_Measure_Sync_Tests_Samples_Quality_Measure_Inference
        ...
        private static RadiologyInsightsData GetRadiologyInsightsData()
        {
            ...
            #region Snippet:Quality_Measure_Sync_Tests_Samples_AddRecordAndConfiguration
        ...
        private static RadiologyInsightsModelConfiguration CreateConfiguration()
        {
            ...
            #region Snippet:Quality_Measure_Sync_Tests_Samples_CreateModelConfiguration
        ...
        {
            #region Snippet:Quality_Measure_Sync_Tests_Samples_CreateRadiologyInsightsInferenceOptions
        ...
        {
            #region Snippet:Quality_Measure_Sync_Tests_Samples_CreatePatientRecord
        ...
        {
            #region Snippet:Quality_Measure_Sync_Tests_Samples_CreateDocumentAdministrativeMetadata
