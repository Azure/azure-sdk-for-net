...
{
    internal class Sample01_CompleteOrderDiscrepancySampleAsync : SamplesBase<HealthInsightsTestEnvironment>
    {
        #region Snippet:Complete_Order_Discrepancy_Async_Tests_Samples_Doc_Content
        ...
        #endregion
        [Test]
        public async Task RadiologyInsightsCompleteOrderDiscrepancyScenario()
        {
            // Read endpoint
            string endpoint = TestEnvironment.Endpoint;
            #region Snippet:Complete_Order_Discrepancy_Async_Tests_Samples_CreateClient
        ...
        private static void DisplayCodes(FhirR4CodeableConcept codeableConcept, int indentation)
        {
            ...
            {
                #region Snippet:Complete_Order_Discrepancy_Async_Tests_Samples_DisplayCodes
        ...
        private static RadiologyInsightsData GetRadiologyInsightsData()
        {
            ...
            #region Snippet:Complete_Order_Discrepancy_Async_Tests_Samples_AddRecordAndConfiguration
        ...
        private static RadiologyInsightsModelConfiguration CreateConfiguration()
        {
            ...
            #region Snippet:Complete_Order_Discrepancy_Async_Tests_Samples_CreateModelConfiguration
        ...
        {
            #region Snippet:Complete_Order_Discrepancy_Async_Tests_Samples_CreateRadiologyInsightsInferenceOptions
        ...
        {
            #region Snippet:Complete_Order_Discrepancy_Async_Tests_Samples_CreatePatientRecord
        ...
        {
            #region Snippet:Complete_Order_Discrepancy_Async_Tests_Samples_CreateDocumentAdministrativeMetadata
