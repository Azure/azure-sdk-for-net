...
{
    internal class Sample01_SexMismatchSampleAsync : SamplesBase<HealthInsightsTestEnvironment>
    {
        #region Snippet:Sex_Mismatch_Async_Tests_Samples_Doc_Content
        ...
        private static RadiologyInsightsData GetRadiologyInsightsData()
        {
            ...
            #region Snippet:Sex_Mismatch_Async_Tests_Samples_AddRecordAndConfiguration
        ...
        private static RadiologyInsightsModelConfiguration CreateConfiguration()
        {
            ...
            #region Snippet:Sex_Mismatch_Async_Tests_Samples_CreateModelConfiguration
        ...
        {
            #region Snippet:Sex_Mismatch_Async_Tests_Samples_CreateRadiologyInsightsInferenceOptions
        ...
        {
            #region Snippet:Sex_Mismatch_Async_Tests_Samples_CreatePatientRecord
        ...
        {
            #region Snippet:Sex_Mismatch_Async_Tests_Samples_CreateDocumentAdministrativeMetadata
