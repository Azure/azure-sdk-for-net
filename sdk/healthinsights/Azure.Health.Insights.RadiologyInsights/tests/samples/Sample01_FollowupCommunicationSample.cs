...
{
    internal class Sample01_FollowupCommunicationSample : SamplesBase<HealthInsightsTestEnvironment>
    {
        #region Snippet:Followup_Communication_Sync_Tests_Samples_Doc_Content
        ...
        public void RadiologyInsightsFollowupRecommendationScenario()
        {
            ...
            foreach (RadiologyInsightsInference inference in inferences)
            {
                ...
                {
                    #region Snippet:Followup_Communication_Sync_Tests_Samples_FollowupCommunicationInference
        ...
        private static RadiologyInsightsData GetRadiologyInsightsData()
        {
            ...
            #region Snippet:Followup_Communication_Sync_Tests_Samples_AddRecordAndConfiguration
        ...
        private static RadiologyInsightsModelConfiguration CreateConfiguration()
        {
            ...
            #region Snippet:Followup_Communication_Sync_Tests_Samples_CreateModelConfiguration
        ...
        {
            #region Snippet:Followup_Communication_Sync_Tests_Samples_CreateRadiologyInsightsInferenceOptions
        ...
        {
            #region Snippet:Followup_Communication_Sync_Tests_Samples_CreatePatientRecord
        ...
        {
            #region Snippet:Followup_Communication_Sync_Tests_Samples_CreateDocumentAdministrativeMetadata
