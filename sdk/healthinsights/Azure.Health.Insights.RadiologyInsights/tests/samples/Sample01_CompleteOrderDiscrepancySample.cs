...
{
    internal class Sample01_CompleteOrderDiscrepancySample : SamplesBase<HealthInsightsTestEnvironment>
    {
        #region Snippet:Complete_Order_Discrepancy_Sync_Tests_Samples_Doc_Content
        ...
        public void RadiologyInsightsCompleteOrderDiscrepancyScenario()
        {
            ...
            #region Snippet:Complete_Order_Discrepancy_Sync_Tests_Samples_CreateClient
            Uri endpointUri = new Uri(endpoint);
            TokenCredential cred = new DefaultAzureCredential();
            RadiologyInsightsClient client = new RadiologyInsightsClient(endpointUri, cred);
            #endregion
            #region Snippet:Complete_Order_Discrepancy_Sync_Tests_Samples_synccall
            ...
            #endregion
            #region Snippet:Complete_Order_Discrepancy_Sync_Tests_Samples_CompleteOrderDiscrepancyInference
        ...
        private static void DisplayCodes(FhirR4CodeableConcept codeableConcept, int indentation)
        {
            ...
            {
                #region Snippet:Complete_Order_Discrepancy_Sync_Tests_Samples_DisplayCodes
        ...
        private static RadiologyInsightsData GetRadiologyInsightsData()
        {
            ...
            #region Snippet:Complete_Order_Discrepancy_Sync_Tests_Samples_AddRecordAndConfiguration
        ...
        private static RadiologyInsightsModelConfiguration CreateConfiguration()
        {
            ...
            #region Snippet:Complete_Order_Discrepancy_Sync_Tests_Samples_CreateModelConfiguration
        ...
        {
            #region Snippet:Complete_Order_Discrepancy_Sync_Tests_Samples_CreateRadiologyInsightsInferenceOptions
        ...
        {
            #region Snippet:Complete_Order_Discrepancy_Sync_Tests_Samples_CreatePatientRecord
        ...
        {
            #region Snippet:Complete_Order_Discrepancy_Sync_Tests_Samples_CreateDocumentAdministrativeMetadata
