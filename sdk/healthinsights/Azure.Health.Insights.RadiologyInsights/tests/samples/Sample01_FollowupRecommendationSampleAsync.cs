...
{
    internal class Sample01_FollowupRecommendationSampleAsync : SamplesBase<HealthInsightsTestEnvironment>
    {
        #region Snippet:Followup_Recommendation_Async_Tests_Samples_Doc_Content
        ...
        public async Task RadiologyInsightsFollowupRecommendationScenario()
        {
            ...
            #region Snippet:Followup_Recommendation_Async_Tests_Samples_CreateClient
        ...
        private static void DisplayCodes(FhirR4CodeableConcept codeableConcept, int indentation)
        {
            ...
            {
                #region Snippet:Followup_Recommendation_Async_Tests_Samples_DisplayCodes
        ...
        private static String extractEvidenceToken(IList<FhirR4Extension> subExtensions)
        {
            ...
            int offset = -1;
            int length = -1;
            #region Snippet:Followup_Recommendation_Async_Tests_Samples_ExtractEvidenceToken
        ...
        private static RadiologyInsightsData GetRadiologyInsightsData()
        {
            ...
            #region Snippet:Followup_Recommendation_Async_Tests_Samples_AddRecordAndConfiguration
        ...
        private static RadiologyInsightsModelConfiguration CreateConfiguration()
        {
            ...
            #region Snippet:Followup_Recommendation_Async_Tests_Samples_CreateModelConfiguration
        ...
        {
            #region Snippet:Followup_Recommendation_Async_Tests_Samples_CreateRadiologyInsightsInferenceOptions
        ...
        {
            #region Snippet:Followup_Recommendation_Async_Tests_Samples_CreatePatientRecord
        ...
        {
            #region Snippet:Followup_Recommendation_Async_Tests_Samples_CreateDocumentAdministrativeMetadata
