...
{
    internal class Sample01_ScoringAndAssessmentInferenceSample : SamplesBase<HealthInsightsTestEnvironment>
    {
        #region Snippet:Scoring_And_Assessment_Sync_Tests_Samples_Doc_Content
        ...
        [Test]
        public void RadiologyInsightsScoringAndAssessmentScenario()
        {
            // Read endpoint
            string endpoint = TestEnvironment.Endpoint;
            #region Snippet:Scoring_And_Assessment_Sync_Tests_Samples_TokenCredential
            Uri endpointUri = new Uri(endpoint);
            TokenCredential cred = new DefaultAzureCredential();
            RadiologyInsightsClient client = new RadiologyInsightsClient(endpointUri, cred);
            #endregion
            #region Snippet:Scoring_And_Assessment_Sync_Tests_Samples_synccall
            ...
            #endregion
            #region Snippet:Scoring_And_Assessment_Sync_Tests_Samples_ScoringAndAssessment
        ...
        {
            #region Snippet:Scoring_And_Assessment_Sync_Tests_Samples_DisplayValueRange
        ...
        private static RadiologyInsightsData GetRadiologyInsightsData()
        {
            ...
            #region Snippet:Scoring_And_Assessment_Sync_Tests_Samples_AddRecordAndConfiguration
        ...
        private static RadiologyInsightsModelConfiguration CreateConfiguration()
        {
            ...
            #region Snippet:Scoring_And_Assessment_Sync_Tests_Samples_CreateModelConfiguration
        ...
        {
            #region Snippet:Scoring_And_Assessment_Sync_Tests_Samples_CreateRadiologyInsightsInferenceOptions
        ...
        {
            #region Snippet:Scoring_And_Assessment_Sync_Tests_Samples_CreatePatientRecord
        ...
        {
            #region Snippet:Scoring_And_Assessment_Sync_Tests_Samples_CreateDocumentAdministrativeMetadata
