...
namespace Azure.Health.Insights.CancerProfiling
{
    ...
    public partial class PatientDocument
    {
        ...
        internal PatientDocument(DocumentType type, ClinicalDocumentType? clinicalType, string id, string language, DateTimeOffset? createdDateTime, DocumentContent content, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Type = type;
