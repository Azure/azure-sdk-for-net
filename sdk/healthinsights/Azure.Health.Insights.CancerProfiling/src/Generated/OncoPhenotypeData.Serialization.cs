...
{
    public partial class OncoPhenotypeData : IUtf8JsonWriteable, IJsonModel<OncoPhenotypeData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OncoPhenotypeData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static OncoPhenotypeData FromResponse(PipelineResponse response)
        {
