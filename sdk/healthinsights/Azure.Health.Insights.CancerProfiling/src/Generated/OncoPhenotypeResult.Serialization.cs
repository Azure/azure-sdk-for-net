...
namespace Azure.Health.Insights.CancerProfiling
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OncoPhenotypeResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OncoPhenotypeResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OncoPhenotypeResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OncoPhenotypeResult>)} interface");
            }
        ...
        string IPersistableModel<OncoPhenotypeResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static OncoPhenotypeResult FromResponse(Response response)
        {
            ...
            return DeserializeOncoPhenotypeResult(document.RootElement, ModelReaderWriterOptions.Wire);
        }
