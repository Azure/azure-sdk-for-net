...
namespace Azure.Health.Insights.CancerProfiling
{
    public partial class OncoPhenotypeResult : IUtf8JsonSerializable, IJsonModel<OncoPhenotypeResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<OncoPhenotypeResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static OncoPhenotypeResult FromResponse(Response response)
        {
            ...
            return DeserializeOncoPhenotypeResult(document.RootElement, new ModelReaderWriterOptions("W"));
        }
