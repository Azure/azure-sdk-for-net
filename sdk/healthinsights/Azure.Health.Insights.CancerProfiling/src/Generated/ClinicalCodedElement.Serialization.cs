...
namespace Azure.Health.Insights.CancerProfiling
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalCodedElement>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClinicalCodedElement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClinicalCodedElement>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ClinicalCodedElement>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ClinicalCodedElement FromResponse(Response response)
        {
            ...
            return DeserializeClinicalCodedElement(document.RootElement, ModelReaderWriterOptions.Wire);
        }
