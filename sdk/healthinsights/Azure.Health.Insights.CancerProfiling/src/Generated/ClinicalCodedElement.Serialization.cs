...
{
    public partial class ClinicalCodedElement : IUtf8JsonWriteable, IJsonModel<ClinicalCodedElement>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalCodedElement>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ClinicalCodedElement FromResponse(PipelineResponse response)
        {
