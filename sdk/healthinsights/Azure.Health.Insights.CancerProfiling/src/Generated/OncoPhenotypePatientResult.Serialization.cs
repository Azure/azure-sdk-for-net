...
{
    public partial class OncoPhenotypePatientResult : IUtf8JsonWriteable, IJsonModel<OncoPhenotypePatientResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OncoPhenotypePatientResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static OncoPhenotypePatientResult FromResponse(PipelineResponse response)
        {
