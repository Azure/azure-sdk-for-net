...
namespace Azure.Health.Insights.CancerProfiling
{
    public partial class OncoPhenotypePatientResult : IUtf8JsonSerializable, IJsonModel<OncoPhenotypePatientResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<OncoPhenotypePatientResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static OncoPhenotypePatientResult FromResponse(Response response)
        {
            ...
            return DeserializeOncoPhenotypePatientResult(document.RootElement, new ModelReaderWriterOptions("W"));
        }
