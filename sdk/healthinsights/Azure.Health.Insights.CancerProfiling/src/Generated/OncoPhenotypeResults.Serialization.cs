...
namespace Azure.Health.Insights.CancerProfiling
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OncoPhenotypeResults>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        OncoPhenotypeResults IJsonModel<OncoPhenotypeResults>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<OncoPhenotypeResults>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        OncoPhenotypeResults IModel<OncoPhenotypeResults>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<OncoPhenotypeResults>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static OncoPhenotypeResults FromResponse(Response response)
        {
            ...
            return DeserializeOncoPhenotypeResults(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
