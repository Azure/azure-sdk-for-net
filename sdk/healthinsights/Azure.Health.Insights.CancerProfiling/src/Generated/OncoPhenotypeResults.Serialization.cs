...
{
    public partial class OncoPhenotypeResults : IUtf8JsonWriteable, IJsonModel<OncoPhenotypeResults>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OncoPhenotypeResults>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static OncoPhenotypeResults FromResponse(PipelineResponse response)
        {
