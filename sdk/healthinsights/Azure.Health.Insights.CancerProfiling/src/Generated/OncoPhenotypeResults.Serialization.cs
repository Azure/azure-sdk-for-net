...
namespace Azure.Health.Insights.CancerProfiling
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OncoPhenotypeResults>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OncoPhenotypeResults>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OncoPhenotypeResults>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<OncoPhenotypeResults>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static OncoPhenotypeResults FromResponse(Response response)
        {
            ...
            return DeserializeOncoPhenotypeResults(document.RootElement, ModelReaderWriterOptions.Wire);
        }
