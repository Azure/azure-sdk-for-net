...
{
    public partial class OncoPhenotypeInference : IUtf8JsonWriteable, IJsonModel<OncoPhenotypeInference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OncoPhenotypeInference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static OncoPhenotypeInference FromResponse(PipelineResponse response)
        {
