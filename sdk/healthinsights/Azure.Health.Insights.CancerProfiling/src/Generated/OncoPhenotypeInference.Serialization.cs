...
namespace Azure.Health.Insights.CancerProfiling
{
    public partial class OncoPhenotypeInference : IUtf8JsonSerializable, IJsonModel<OncoPhenotypeInference>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<OncoPhenotypeInference>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static OncoPhenotypeInference FromResponse(Response response)
        {
            ...
            return DeserializeOncoPhenotypeInference(document.RootElement, new ModelReaderWriterOptions("W"));
        }
