...
namespace Azure.Health.Insights.CancerProfiling
{
    ...
    public partial class OncoPhenotypeInferenceResult
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="OncoPhenotypeInferenceResult"/>. </summary>
        ...
        internal OncoPhenotypeInferenceResult(IEnumerable<OncoPhenotypePatientResult> patientResults, string modelVersion)
        {
        ...
        internal OncoPhenotypeInferenceResult(IReadOnlyList<OncoPhenotypePatientResult> patientResults, string modelVersion, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="OncoPhenotypeInferenceResult"/> for deserialization. </summary>
        internal OncoPhenotypeInferenceResult()
        {
        }

        /// <summary> Results for the patients given in the request. </summary>
        public IReadOnlyList<OncoPhenotypePatientResult> PatientResults { get; }
