...
{
    public partial class InferenceEvidence : IUtf8JsonWriteable, IJsonModel<InferenceEvidence>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<InferenceEvidence>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static InferenceEvidence FromResponse(PipelineResponse response)
        {
