...
namespace Azure.Health.Insights.CancerProfiling
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InferenceEvidence>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InferenceEvidence>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InferenceEvidence>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<InferenceEvidence>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static InferenceEvidence FromResponse(Response response)
        {
            ...
            return DeserializeInferenceEvidence(document.RootElement, ModelReaderWriterOptions.Wire);
        }
