...
namespace Azure.Health.Insights.CancerProfiling
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InferenceEvidence>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        InferenceEvidence IJsonModel<InferenceEvidence>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<InferenceEvidence>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        InferenceEvidence IModel<InferenceEvidence>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<InferenceEvidence>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static InferenceEvidence FromResponse(Response response)
        {
            ...
            return DeserializeInferenceEvidence(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
