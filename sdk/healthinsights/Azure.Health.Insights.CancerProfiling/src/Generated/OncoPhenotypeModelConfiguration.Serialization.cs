...
{
    public partial class OncoPhenotypeModelConfiguration : IUtf8JsonWriteable, IJsonModel<OncoPhenotypeModelConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OncoPhenotypeModelConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static OncoPhenotypeModelConfiguration FromResponse(PipelineResponse response)
        {
