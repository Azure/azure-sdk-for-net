...
namespace Azure.Health.Insights.CancerProfiling
{
    public partial class OncoPhenotypeModelConfiguration : IUtf8JsonSerializable, IJsonModel<OncoPhenotypeModelConfiguration>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<OncoPhenotypeModelConfiguration>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static OncoPhenotypeModelConfiguration FromResponse(Response response)
        {
            ...
            return DeserializeOncoPhenotypeModelConfiguration(document.RootElement, new ModelReaderWriterOptions("W"));
        }
