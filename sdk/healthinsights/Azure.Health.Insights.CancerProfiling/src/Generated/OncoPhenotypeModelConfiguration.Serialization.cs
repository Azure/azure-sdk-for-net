...
namespace Azure.Health.Insights.CancerProfiling
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OncoPhenotypeModelConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OncoPhenotypeModelConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OncoPhenotypeModelConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OncoPhenotypeModelConfiguration>)} interface");
            }
        ...
        string IPersistableModel<OncoPhenotypeModelConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static OncoPhenotypeModelConfiguration FromResponse(Response response)
        {
            ...
            return DeserializeOncoPhenotypeModelConfiguration(document.RootElement, ModelReaderWriterOptions.Wire);
        }
