...
namespace Azure.Health.Insights.CancerProfiling
{
    ...
    public partial class CancerProfilingClient
    {
        ...
        public CancerProfilingClient(Uri endpoint, KeyCredential credential) : this(endpoint, credential, new CancerProfilingClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public CancerProfilingClient(Uri endpoint, KeyCredential credential, CancerProfilingClientOptions options)
        {
        ...
        public virtual async Task<Operation<OncoPhenotypeResults>> InferCancerProfileAsync(WaitUntil waitUntil, OncoPhenotypeData oncoPhenotypeData, CancellationToken cancellationToken = default)
        {
            ...
            using RequestBody content = oncoPhenotypeData.ToRequestBody();
            Operation<BinaryData> result = await InferCancerProfileAsync(waitUntil, content, context).ConfigureAwait(false);
            return ProtocolOperationHelpers.Convert(result, FetchOncoPhenotypeResultsFromOncoPhenotypeResult, ClientDiagnostics, "CancerProfilingClient.InferCancerProfile");
        }
        ...
        public virtual Operation<OncoPhenotypeResults> InferCancerProfile(WaitUntil waitUntil, OncoPhenotypeData oncoPhenotypeData, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using RequestBody content = oncoPhenotypeData.ToRequestBody();
            Operation<BinaryData> result = InferCancerProfile(waitUntil, content, context);
            return ProtocolOperationHelpers.Convert(result, FetchOncoPhenotypeResultsFromOncoPhenotypeResult, ClientDiagnostics, "CancerProfilingClient.InferCancerProfile");
        }
        ...
        public virtual async Task<Operation<BinaryData>> InferCancerProfileAsync(WaitUntil waitUntil, RequestBody content, RequestOptions context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateSpan("CancerProfilingClient.InferCancerProfile");
            scope.Start();
            try
            {
                using PipelineMessage message = CreateInferCancerProfileRequest(content, context);
        ...
        /// <exception cref="MessageFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        public virtual Operation<BinaryData> InferCancerProfile(WaitUntil waitUntil, RequestBody content, RequestOptions context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal PipelineMessage CreateInferCancerProfileRequest(RequestBody content, RequestOptions context)
        {
            var message = _pipeline.CreateMessage(context, ResponseErrorClassifier200202);
        ...
        private static ResponseErrorClassifier _responseErrorClassifier200202;
        private static ResponseErrorClassifier ResponseErrorClassifier200202 => _responseErrorClassifier200202 ??= new StatusResponseClassifier(stackalloc ushort[] { 200, 202 });

        private OncoPhenotypeResults FetchOncoPhenotypeResultsFromOncoPhenotypeResult(Result response)
        {
