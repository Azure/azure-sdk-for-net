...
["value"] = "<value>",
                ...
                ["configuration"] = new Dictionary<string, object>()
                {
                    ...
                    ["clinicalTrials"] = new Dictionary<string, object>()
                    {
...
{
["acceptedSex"] = "all",
["acceptedAgeRange"] = new Dictionary<string, object>()
{
["minimumAge"] = new Dictionary<string, object>()
{
["unit"] = "years",
["value"] = 123.45F,
},
...
{
MinimumAge = new AcceptedAge(AgeUnit.Years,(float)123.45F),
MaximumAge = null,
},
},
}
...
{
(float)123.45F
}),new AreaProperties(GeoJsonPropertiesSubType.Circle,(double)123.45))
},
}
},
                })
