...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class GeographicArea : IUtf8JsonSerializable, IJsonModel<GeographicArea>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<GeographicArea>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static GeographicArea FromResponse(Response response)
        {
            ...
            return DeserializeGeographicArea(document.RootElement, new ModelReaderWriterOptions("W"));
        }
