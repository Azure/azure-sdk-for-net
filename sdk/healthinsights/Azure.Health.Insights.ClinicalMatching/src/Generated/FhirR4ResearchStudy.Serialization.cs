    ...
    public partial class FhirR4ResearchStudy : IUtf8JsonSerializable, IJsonModel<FhirR4ResearchStudy>
    {
        ...
        void IJsonModel<FhirR4ResearchStudy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PrimaryPurposeType))
            {
                ...
                writer.WriteObjectValue<FhirR4CodeableConcept>(PrimaryPurposeType, options);
            }
            if (Optional.IsDefined(Phase))
            {
                writer.WritePropertyName("phase"u8);
                writer.WriteObjectValue<FhirR4CodeableConcept>(Phase, options);
            }
            ...
            if (Optional.IsCollectionDefined(Contact))
            {
                ...
                {
                    writer.WriteObjectValue<FhirR4ContactDetail>(item, options);
                }
                writer.WriteEndArray();
            }
            ...
            if (Optional.IsDefined(Sponsor))
            {
                ...
                writer.WriteObjectValue<FhirR4Reference>(Sponsor, options);
            }
            if (Optional.IsDefined(PrincipalInvestigator))
            {
                writer.WritePropertyName("principalInvestigator"u8);
                writer.WriteObjectValue<FhirR4Reference>(PrincipalInvestigator, options);
            }
            ...
            if (Optional.IsDefined(ReasonStopped))
            {
                ...
                writer.WriteObjectValue<FhirR4CodeableConcept>(ReasonStopped, options);
            }
            ...
            if (Optional.IsCollectionDefined(Arm))
            {
                ...
                {
                    writer.WriteObjectValue<ResearchStudyArm>(item, options);
                }
                writer.WriteEndArray();
            }
            if (Optional.IsCollectionDefined(Objective))
            {
                ...
                {
                    writer.WriteObjectValue<ResearchStudyObjective>(item, options);
                }
                writer.WriteEndArray();
            }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<FhirR4ResearchStudy>(this, new ModelReaderWriterOptions("W"));
            return content;
        }
    }
}
