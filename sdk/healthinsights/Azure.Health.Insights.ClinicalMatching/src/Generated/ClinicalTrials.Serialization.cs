...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class ClinicalTrials : IUtf8JsonSerializable, IJsonModel<ClinicalTrials>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ClinicalTrials>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ClinicalTrials FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrials(document.RootElement, new ModelReaderWriterOptions("W"));
        }
