...
{
    public partial class ClinicalTrials : IUtf8JsonWriteable, IJsonModel<ClinicalTrials>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalTrials>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ClinicalTrials FromResponse(PipelineResponse response)
        {
