...
{
    public partial class ContactDetails : IUtf8JsonSerializable, IModelSerializable
    {
        ...
        internal static ContactDetails DeserializeContactDetails(JsonElement element, SerializableOptions options = default)
        {
