...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class ContactDetails : IUtf8JsonSerializable, IJsonModel<ContactDetails>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ContactDetails>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ContactDetails FromResponse(Response response)
        {
            ...
            return DeserializeContactDetails(document.RootElement, new ModelReaderWriterOptions("W"));
        }
