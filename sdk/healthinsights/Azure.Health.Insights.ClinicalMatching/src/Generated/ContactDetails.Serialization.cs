...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContactDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContactDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContactDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContactDetails>)} interface");
            }
        ...
        string IPersistableModel<ContactDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ContactDetails FromResponse(Response response)
        {
            ...
            return DeserializeContactDetails(document.RootElement, ModelReaderWriterOptions.Wire);
        }
