...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class TrialMatcherInferenceEvidence : IUtf8JsonSerializable, IJsonModel<TrialMatcherInferenceEvidence>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TrialMatcherInferenceEvidence>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static TrialMatcherInferenceEvidence FromResponse(Response response)
        {
            ...
            return DeserializeTrialMatcherInferenceEvidence(document.RootElement, new ModelReaderWriterOptions("W"));
        }
