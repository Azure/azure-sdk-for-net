...
{
    public partial class TrialMatcherInferenceEvidence : IUtf8JsonWriteable, IJsonModel<TrialMatcherInferenceEvidence>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrialMatcherInferenceEvidence>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TrialMatcherInferenceEvidence FromResponse(PipelineResponse response)
        {
