...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    public partial class TrialMatcherData
    {
        ...
        internal TrialMatcherData(IList<PatientRecord> patients, TrialMatcherModelConfiguration configuration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Patients = patients;
