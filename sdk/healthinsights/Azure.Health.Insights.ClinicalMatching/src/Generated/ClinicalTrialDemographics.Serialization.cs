...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class ClinicalTrialDemographics : IUtf8JsonSerializable, IJsonModel<ClinicalTrialDemographics>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ClinicalTrialDemographics>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ClinicalTrialDemographics FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrialDemographics(document.RootElement, new ModelReaderWriterOptions("W"));
        }
