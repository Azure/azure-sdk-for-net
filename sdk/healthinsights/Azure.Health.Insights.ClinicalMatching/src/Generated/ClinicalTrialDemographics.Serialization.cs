...
{
    public partial class ClinicalTrialDemographics : IUtf8JsonWriteable, IJsonModel<ClinicalTrialDemographics>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalTrialDemographics>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ClinicalTrialDemographics FromResponse(PipelineResponse response)
        {
