...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class GeographicLocation : IUtf8JsonSerializable, IJsonModel<GeographicLocation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<GeographicLocation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static GeographicLocation FromResponse(Response response)
        {
            ...
            return DeserializeGeographicLocation(document.RootElement, new ModelReaderWriterOptions("W"));
        }
