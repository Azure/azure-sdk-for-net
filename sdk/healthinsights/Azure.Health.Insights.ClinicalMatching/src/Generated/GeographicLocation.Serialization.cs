...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GeographicLocation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GeographicLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GeographicLocation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GeographicLocation>)} interface");
            }
        ...
        string IPersistableModel<GeographicLocation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static GeographicLocation FromResponse(Response response)
        {
            ...
            return DeserializeGeographicLocation(document.RootElement, ModelReaderWriterOptions.Wire);
        }
