...
{
    public partial class GeographicLocation : IUtf8JsonWriteable, IJsonModel<GeographicLocation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<GeographicLocation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static GeographicLocation FromResponse(PipelineResponse response)
        {
