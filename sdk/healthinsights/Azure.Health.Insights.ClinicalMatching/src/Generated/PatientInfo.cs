...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    public partial class PatientInfo
    {
        ...
        internal PatientInfo(PatientInfoSex? sex, DateTimeOffset? birthDate, IList<ClinicalCodedElement> clinicalInfo, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Sex = sex;
            BirthDate = birthDate;
