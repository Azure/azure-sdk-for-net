...
{
    public partial class TrialMatcherInference : IUtf8JsonWriteable, IJsonModel<TrialMatcherInference>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrialMatcherInference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TrialMatcherInference FromResponse(PipelineResponse response)
        {
