...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class TrialMatcherInference : IUtf8JsonSerializable, IJsonModel<TrialMatcherInference>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TrialMatcherInference>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static TrialMatcherInference FromResponse(Response response)
        {
            ...
            return DeserializeTrialMatcherInference(document.RootElement, new ModelReaderWriterOptions("W"));
        }
