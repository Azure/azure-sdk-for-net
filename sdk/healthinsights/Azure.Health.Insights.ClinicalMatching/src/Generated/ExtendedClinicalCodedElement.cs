...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    public partial class ExtendedClinicalCodedElement
    {
        ...
        internal ExtendedClinicalCodedElement(string system, string code, string name, string value, string semanticType, string category, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            System = system;
            Code = code;
            Name = name;
