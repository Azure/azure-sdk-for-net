...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class PatientInfo : IUtf8JsonSerializable, IJsonModel<PatientInfo>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PatientInfo>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static PatientInfo FromResponse(Response response)
        {
            ...
            return DeserializePatientInfo(document.RootElement, new ModelReaderWriterOptions("W"));
        }
