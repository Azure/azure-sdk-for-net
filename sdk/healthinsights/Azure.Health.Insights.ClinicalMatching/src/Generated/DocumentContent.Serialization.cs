...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DocumentContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DocumentContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DocumentContent>)} interface");
            }
        ...
        string IPersistableModel<DocumentContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static DocumentContent FromResponse(Response response)
        {
            ...
            return DeserializeDocumentContent(document.RootElement, ModelReaderWriterOptions.Wire);
        }
