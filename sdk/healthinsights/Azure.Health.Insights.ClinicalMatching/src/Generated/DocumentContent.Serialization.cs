...
{
    public partial class DocumentContent : IUtf8JsonWriteable, IJsonModel<DocumentContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DocumentContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DocumentContent FromResponse(PipelineResponse response)
        {
