...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    public partial class TrialMatcherResult
    {
        ...
        internal TrialMatcherResult(Guid jobId, DateTimeOffset createdDateTime, DateTimeOffset expirationDateTime, DateTimeOffset lastUpdateDateTime, JobStatus status, IReadOnlyList<ResponseError> errors, TrialMatcherResults results, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            JobId = jobId;
