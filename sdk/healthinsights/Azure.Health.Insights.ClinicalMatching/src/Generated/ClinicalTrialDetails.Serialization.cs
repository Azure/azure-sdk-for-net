    ...
    public partial class ClinicalTrialDetails : IUtf8JsonSerializable, IJsonModel<ClinicalTrialDetails>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Demographics))
            {
                ...
                ((IJsonModel<ClinicalTrialDemographics>)Demographics).Write(writer, options);
            }
        ...
        internal static ClinicalTrialDetails DeserializeClinicalTrialDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("demographics"u8))
                {
                    ...
                    demographics = ModelSerializationExtensions.JsonDeserialize<ClinicalTrialDemographics>(property.Value);
                    continue;
                }
