...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class ClinicalTrialDetails : IUtf8JsonSerializable, IJsonModel<ClinicalTrialDetails>
    {
        ...
        void IJsonModel<ClinicalTrialDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ClinicalTrialDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ClinicalTrialDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ClinicalTrialDetails)} does not support '{options.Format}' format.");
            }
        }
