...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalTrialDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClinicalTrialDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClinicalTrialDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClinicalTrialDetails>)} interface");
            }
        ...
        string IPersistableModel<ClinicalTrialDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ClinicalTrialDetails FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrialDetails(document.RootElement, ModelReaderWriterOptions.Wire);
        }
