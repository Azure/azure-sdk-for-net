...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class ClinicalTrialDetails : IUtf8JsonSerializable, IJsonModel<ClinicalTrialDetails>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ClinicalTrialDetails>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ClinicalTrialDetails FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrialDetails(document.RootElement, new ModelReaderWriterOptions("W"));
        }
