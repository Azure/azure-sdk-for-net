...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class ClinicalTrialResearchFacility : IUtf8JsonSerializable, IJsonModel<ClinicalTrialResearchFacility>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ClinicalTrialResearchFacility>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ClinicalTrialResearchFacility FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrialResearchFacility(document.RootElement, new ModelReaderWriterOptions("W"));
        }
