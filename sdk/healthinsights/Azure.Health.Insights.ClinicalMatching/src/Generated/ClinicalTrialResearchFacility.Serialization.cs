...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalTrialResearchFacility>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClinicalTrialResearchFacility>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClinicalTrialResearchFacility>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClinicalTrialResearchFacility>)} interface");
            }
        ...
        string IPersistableModel<ClinicalTrialResearchFacility>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ClinicalTrialResearchFacility FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrialResearchFacility(document.RootElement, ModelReaderWriterOptions.Wire);
        }
