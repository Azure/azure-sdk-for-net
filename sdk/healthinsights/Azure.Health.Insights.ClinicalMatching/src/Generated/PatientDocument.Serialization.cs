...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PatientDocument>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PatientDocument>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PatientDocument>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PatientDocument>)} interface");
            }
        ...
        string IPersistableModel<PatientDocument>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static PatientDocument FromResponse(Response response)
        {
            ...
            return DeserializePatientDocument(document.RootElement, ModelReaderWriterOptions.Wire);
        }
