...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class PatientDocument : IUtf8JsonSerializable, IJsonModel<PatientDocument>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PatientDocument>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static PatientDocument FromResponse(Response response)
        {
            ...
            return DeserializePatientDocument(document.RootElement, new ModelReaderWriterOptions("W"));
        }
