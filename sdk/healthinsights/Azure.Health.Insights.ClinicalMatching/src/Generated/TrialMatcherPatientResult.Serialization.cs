...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class TrialMatcherPatientResult : IUtf8JsonSerializable, IJsonModel<TrialMatcherPatientResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TrialMatcherPatientResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static TrialMatcherPatientResult FromResponse(Response response)
        {
            ...
            return DeserializeTrialMatcherPatientResult(document.RootElement, new ModelReaderWriterOptions("W"));
        }
