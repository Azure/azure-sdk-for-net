...
{
    public partial class TrialMatcherPatientResult : IUtf8JsonWriteable, IJsonModel<TrialMatcherPatientResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrialMatcherPatientResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TrialMatcherPatientResult FromResponse(PipelineResponse response)
        {
