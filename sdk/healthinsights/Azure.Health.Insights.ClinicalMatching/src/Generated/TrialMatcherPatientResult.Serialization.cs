...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrialMatcherPatientResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrialMatcherPatientResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrialMatcherPatientResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrialMatcherPatientResult>)} interface");
            }
        ...
        string IPersistableModel<TrialMatcherPatientResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static TrialMatcherPatientResult FromResponse(Response response)
        {
            ...
            return DeserializeTrialMatcherPatientResult(document.RootElement, ModelReaderWriterOptions.Wire);
        }
