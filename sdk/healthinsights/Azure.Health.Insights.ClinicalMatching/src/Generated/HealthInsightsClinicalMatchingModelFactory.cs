...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    public static partial class HealthInsightsClinicalMatchingModelFactory
    {
        ...
        public static PatientRecord PatientRecord(string id = null, PatientInfo info = null, IEnumerable<PatientDocument> data = null)
        {
            ...
            return new PatientRecord(id, info, data?.ToList(), default);
        }
        ...
        {
            return new PatientDocument(type, clinicalType, id, language, createdDateTime, content, default);
        }
        ...
        {
            return new TrialMatcherModelConfiguration(verbose, includeEvidence, clinicalTrials, default);
        }
        ...
        {
            return new ClinicalTrialDetails(id, eligibilityCriteriaText, demographics, metadata, default);
        }
        ...
        {
            return new GeographicLocation(city, state, countryOrRegion, default);
        }
        ...
        public static TrialMatcherResult TrialMatcherResult(Guid jobId = default, DateTimeOffset createdDateTime = default, DateTimeOffset expirationDateTime = default, DateTimeOffset lastUpdateDateTime = default, JobStatus status = default, IEnumerable<ResponseError> errors = null, TrialMatcherResults results = null)
        {
            ...
            return new TrialMatcherResult(jobId, createdDateTime, expirationDateTime, lastUpdateDateTime, status, errors?.ToList(), results, default);
        }
        ...
        public static TrialMatcherResults TrialMatcherResults(IEnumerable<TrialMatcherPatientResult> patients = null, string modelVersion = null, DateTimeOffset? knowledgeGraphLastUpdateDate = null)
        {
            ...
            return new TrialMatcherResults(patients?.ToList(), modelVersion, knowledgeGraphLastUpdateDate, default);
        }
        ...
        public static TrialMatcherPatientResult TrialMatcherPatientResult(string id = null, IEnumerable<TrialMatcherInference> inferences = null, IEnumerable<ExtendedClinicalCodedElement> neededClinicalInfo = null)
        {
            ...
            return new TrialMatcherPatientResult(id, inferences?.ToList(), neededClinicalInfo?.ToList(), default);
        }
        ...
        public static TrialMatcherInference TrialMatcherInference(TrialMatcherInferenceType type = default, string value = null, string description = null, float? confidenceScore = null, IEnumerable<TrialMatcherInferenceEvidence> evidence = null, string id = null, ClinicalTrialSource? source = null, ClinicalTrialMetadata metadata = null)
        {
            ...
            return new TrialMatcherInference(type, value, description, confidenceScore, evidence?.ToList(), id, source, metadata, default);
        }
        ...
        {
            return new TrialMatcherInferenceEvidence(eligibilityCriteriaEvidence, patientDataEvidence, patientInfoEvidence, importance, default);
        }
        ...
        {
            return new ClinicalNoteEvidence(id, text, offset, length, default);
        }
        ...
        {
            return new ExtendedClinicalCodedElement(system, code, name, value, semanticType, category, default);
        }
    }
}
