...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    public partial class TrialMatcherPatientResult
    {
        ...
        internal TrialMatcherPatientResult(string patientId, IEnumerable<TrialMatcherInference> inferences)
        {
        ...
        internal TrialMatcherPatientResult(string patientId, IReadOnlyList<TrialMatcherInference> inferences, IReadOnlyList<ExtendedClinicalCodedElement> neededClinicalInfo, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PatientId = patientId;
        ...
        /// <summary> The inference results for the patient. </summary>
