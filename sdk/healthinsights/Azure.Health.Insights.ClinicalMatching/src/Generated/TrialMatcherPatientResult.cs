...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    public partial class TrialMatcherPatientResult
    {
        ...
        internal TrialMatcherPatientResult(string id, IReadOnlyList<TrialMatcherInference> inferences, IReadOnlyList<ExtendedClinicalCodedElement> neededClinicalInfo, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
