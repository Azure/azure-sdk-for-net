...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    public partial class ClinicalMatchingClient
    {
        ...
        public ClinicalMatchingClient(Uri endpoint, KeyCredential credential) : this(endpoint, credential, new ClinicalMatchingClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ClinicalMatchingClient(Uri endpoint, KeyCredential credential, ClinicalMatchingClientOptions options)
        {
        ...
        public virtual async Task<Operation<TrialMatcherResults>> MatchTrialsAsync(WaitUntil waitUntil, TrialMatcherData trialMatcherData, CancellationToken cancellationToken = default)
        {
            ...
            using RequestBody content = trialMatcherData.ToRequestBody();
            Operation<BinaryData> result = await MatchTrialsAsync(waitUntil, content, context).ConfigureAwait(false);
            return ProtocolOperationHelpers.Convert(result, FetchTrialMatcherResultsFromTrialMatcherResult, ClientDiagnostics, "ClinicalMatchingClient.MatchTrials");
        }
        ...
        public virtual Operation<TrialMatcherResults> MatchTrials(WaitUntil waitUntil, TrialMatcherData trialMatcherData, CancellationToken cancellationToken = default)
        {
            ...
            RequestOptions context = FromCancellationToken(cancellationToken);
            using RequestBody content = trialMatcherData.ToRequestBody();
            Operation<BinaryData> result = MatchTrials(waitUntil, content, context);
            return ProtocolOperationHelpers.Convert(result, FetchTrialMatcherResultsFromTrialMatcherResult, ClientDiagnostics, "ClinicalMatchingClient.MatchTrials");
        }
        ...
        public virtual async Task<Operation<BinaryData>> MatchTrialsAsync(WaitUntil waitUntil, RequestBody content, RequestOptions context = null)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateSpan("ClinicalMatchingClient.MatchTrials");
            scope.Start();
            try
            {
                using PipelineMessage message = CreateMatchTrialsRequest(content, context);
        ...
        /// <exception cref="MessageFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        public virtual Operation<BinaryData> MatchTrials(WaitUntil waitUntil, RequestBody content, RequestOptions context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        internal PipelineMessage CreateMatchTrialsRequest(RequestBody content, RequestOptions context)
        {
        ...
        private TrialMatcherResults FetchTrialMatcherResultsFromTrialMatcherResult(Result response)
        {
