...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcceptedAgeRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcceptedAgeRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcceptedAgeRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcceptedAgeRange>)} interface");
            }
        ...
        string IPersistableModel<AcceptedAgeRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static AcceptedAgeRange FromResponse(Response response)
        {
            ...
            return DeserializeAcceptedAgeRange(document.RootElement, ModelReaderWriterOptions.Wire);
        }
