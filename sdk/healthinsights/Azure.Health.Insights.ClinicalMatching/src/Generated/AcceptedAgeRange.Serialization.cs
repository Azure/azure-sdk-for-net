...
{
    public partial class AcceptedAgeRange : IUtf8JsonWriteable, IJsonModel<AcceptedAgeRange>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcceptedAgeRange>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AcceptedAgeRange FromResponse(PipelineResponse response)
        {
