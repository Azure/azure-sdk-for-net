...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class AcceptedAgeRange : IUtf8JsonSerializable, IJsonModel<AcceptedAgeRange>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AcceptedAgeRange>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static AcceptedAgeRange FromResponse(Response response)
        {
            ...
            return DeserializeAcceptedAgeRange(document.RootElement, new ModelReaderWriterOptions("W"));
        }
