...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcceptedAgeRange>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        AcceptedAgeRange IJsonModel<AcceptedAgeRange>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<AcceptedAgeRange>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AcceptedAgeRange IModel<AcceptedAgeRange>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AcceptedAgeRange>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static AcceptedAgeRange FromResponse(Response response)
        {
            ...
            return DeserializeAcceptedAgeRange(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
