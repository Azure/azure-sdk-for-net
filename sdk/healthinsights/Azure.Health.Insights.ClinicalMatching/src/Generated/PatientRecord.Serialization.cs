...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PatientRecord>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PatientRecord>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PatientRecord>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PatientRecord>)} interface");
            }
        ...
        string IPersistableModel<PatientRecord>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static PatientRecord FromResponse(Response response)
        {
            ...
            return DeserializePatientRecord(document.RootElement, ModelReaderWriterOptions.Wire);
        }
