...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class PatientRecord : IUtf8JsonSerializable, IJsonModel<PatientRecord>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PatientRecord>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static PatientRecord FromResponse(Response response)
        {
            ...
            return DeserializePatientRecord(document.RootElement, new ModelReaderWriterOptions("W"));
        }
