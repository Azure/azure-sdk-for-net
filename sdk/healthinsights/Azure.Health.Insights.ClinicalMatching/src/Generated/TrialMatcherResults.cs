...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    public partial class TrialMatcherResults
    {
        ...
        internal TrialMatcherResults(IReadOnlyList<TrialMatcherPatientResult> patients, string modelVersion, DateTimeOffset? knowledgeGraphLastUpdateDate, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Patients = patients;
            ModelVersion = modelVersion;
