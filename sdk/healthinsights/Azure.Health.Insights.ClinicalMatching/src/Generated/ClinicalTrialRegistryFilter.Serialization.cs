...
{
    public partial class ClinicalTrialRegistryFilter : IUtf8JsonWriteable, IJsonModel<ClinicalTrialRegistryFilter>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalTrialRegistryFilter>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ClinicalTrialRegistryFilter FromResponse(PipelineResponse response)
        {
