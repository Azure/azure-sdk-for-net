...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class ClinicalTrialRegistryFilter : IUtf8JsonSerializable, IJsonModel<ClinicalTrialRegistryFilter>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ClinicalTrialRegistryFilter>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ClinicalTrialRegistryFilter FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrialRegistryFilter(document.RootElement, new ModelReaderWriterOptions("W"));
        }
