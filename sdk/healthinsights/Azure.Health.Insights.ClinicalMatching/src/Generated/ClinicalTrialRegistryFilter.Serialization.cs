...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalTrialRegistryFilter>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ClinicalTrialRegistryFilter IJsonModel<ClinicalTrialRegistryFilter>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ClinicalTrialRegistryFilter>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ClinicalTrialRegistryFilter IModel<ClinicalTrialRegistryFilter>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ClinicalTrialRegistryFilter>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static ClinicalTrialRegistryFilter FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrialRegistryFilter(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
