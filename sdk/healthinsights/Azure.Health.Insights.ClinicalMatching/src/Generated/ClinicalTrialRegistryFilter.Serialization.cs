...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalTrialRegistryFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClinicalTrialRegistryFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClinicalTrialRegistryFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClinicalTrialRegistryFilter>)} interface");
            }
        ...
        string IPersistableModel<ClinicalTrialRegistryFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ClinicalTrialRegistryFilter FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrialRegistryFilter(document.RootElement, ModelReaderWriterOptions.Wire);
        }
