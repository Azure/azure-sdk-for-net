...
{
    public partial class TrialMatcherModelConfiguration : IUtf8JsonWriteable, IJsonModel<TrialMatcherModelConfiguration>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrialMatcherModelConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TrialMatcherModelConfiguration FromResponse(PipelineResponse response)
        {
