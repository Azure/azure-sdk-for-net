...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class TrialMatcherModelConfiguration : IUtf8JsonSerializable, IJsonModel<TrialMatcherModelConfiguration>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TrialMatcherModelConfiguration>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static TrialMatcherModelConfiguration FromResponse(Response response)
        {
            ...
            return DeserializeTrialMatcherModelConfiguration(document.RootElement, new ModelReaderWriterOptions("W"));
        }
