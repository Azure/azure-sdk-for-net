...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrialMatcherModelConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrialMatcherModelConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrialMatcherModelConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrialMatcherModelConfiguration>)} interface");
            }
        ...
        string IPersistableModel<TrialMatcherModelConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static TrialMatcherModelConfiguration FromResponse(Response response)
        {
            ...
            return DeserializeTrialMatcherModelConfiguration(document.RootElement, ModelReaderWriterOptions.Wire);
        }
