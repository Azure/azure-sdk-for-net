...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class AcceptedAge : IUtf8JsonSerializable, IJsonModel<AcceptedAge>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AcceptedAge>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static AcceptedAge FromResponse(Response response)
        {
            ...
            return DeserializeAcceptedAge(document.RootElement, new ModelReaderWriterOptions("W"));
        }
