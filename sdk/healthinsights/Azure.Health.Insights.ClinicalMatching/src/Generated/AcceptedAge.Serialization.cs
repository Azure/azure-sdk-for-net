...
{
    public partial class AcceptedAge : IUtf8JsonWriteable, IJsonModel<AcceptedAge>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcceptedAge>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static AcceptedAge FromResponse(PipelineResponse response)
        {
