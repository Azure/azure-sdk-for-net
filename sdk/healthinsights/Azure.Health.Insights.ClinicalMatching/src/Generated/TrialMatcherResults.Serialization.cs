...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class TrialMatcherResults : IUtf8JsonSerializable, IJsonModel<TrialMatcherResults>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TrialMatcherResults>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static TrialMatcherResults FromResponse(Response response)
        {
            ...
            return DeserializeTrialMatcherResults(document.RootElement, new ModelReaderWriterOptions("W"));
        }
