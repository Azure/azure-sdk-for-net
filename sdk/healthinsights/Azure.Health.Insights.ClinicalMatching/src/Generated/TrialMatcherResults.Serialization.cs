...
{
    public partial class TrialMatcherResults : IUtf8JsonWriteable, IJsonModel<TrialMatcherResults>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrialMatcherResults>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TrialMatcherResults FromResponse(PipelineResponse response)
        {
