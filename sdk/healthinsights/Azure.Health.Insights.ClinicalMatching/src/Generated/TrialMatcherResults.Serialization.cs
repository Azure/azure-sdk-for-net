...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrialMatcherResults>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        TrialMatcherResults IJsonModel<TrialMatcherResults>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<TrialMatcherResults>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        TrialMatcherResults IModel<TrialMatcherResults>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<TrialMatcherResults>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static TrialMatcherResults FromResponse(Response response)
        {
            ...
            return DeserializeTrialMatcherResults(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
