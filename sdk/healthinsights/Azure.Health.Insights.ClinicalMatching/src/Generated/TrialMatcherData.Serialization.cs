...
{
    public partial class TrialMatcherData : IUtf8JsonWriteable, IJsonModel<TrialMatcherData>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrialMatcherData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static TrialMatcherData FromResponse(PipelineResponse response)
        {
