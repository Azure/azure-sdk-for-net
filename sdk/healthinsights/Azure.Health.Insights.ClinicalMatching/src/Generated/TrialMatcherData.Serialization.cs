...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrialMatcherData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrialMatcherData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrialMatcherData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TrialMatcherData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static TrialMatcherData FromResponse(Response response)
        {
            ...
            return DeserializeTrialMatcherData(document.RootElement, ModelReaderWriterOptions.Wire);
        }
