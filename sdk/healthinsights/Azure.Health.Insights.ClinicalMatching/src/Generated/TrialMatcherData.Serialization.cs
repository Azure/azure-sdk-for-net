    ...
    public partial class TrialMatcherData : IUtf8JsonSerializable, IJsonModel<TrialMatcherData>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Configuration))
            {
                ...
                ((IJsonModel<TrialMatcherModelConfiguration>)Configuration).Write(writer, options);
            }
        ...
        internal static TrialMatcherData DeserializeTrialMatcherData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("configuration"u8))
                {
                    ...
                    configuration = ModelSerializationExtensions.JsonDeserialize<TrialMatcherModelConfiguration>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
