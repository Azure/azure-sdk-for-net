...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    public partial class ClinicalTrialDetails
    {
        ...
        internal ClinicalTrialDetails(string id, string eligibilityCriteriaText, ClinicalTrialDemographics demographics, ClinicalTrialMetadata metadata, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
