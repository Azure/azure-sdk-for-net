...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalTrialMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClinicalTrialMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClinicalTrialMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClinicalTrialMetadata>)} interface");
            }
        ...
        string IPersistableModel<ClinicalTrialMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ClinicalTrialMetadata FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrialMetadata(document.RootElement, ModelReaderWriterOptions.Wire);
        }
