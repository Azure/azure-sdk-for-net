...
{
    public partial class ClinicalTrialMetadata : IUtf8JsonWriteable, IJsonModel<ClinicalTrialMetadata>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalTrialMetadata>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ClinicalTrialMetadata FromResponse(PipelineResponse response)
        {
