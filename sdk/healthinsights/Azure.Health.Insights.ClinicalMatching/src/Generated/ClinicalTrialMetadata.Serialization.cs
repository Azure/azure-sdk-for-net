...
namespace Azure.Health.Insights.ClinicalMatching
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClinicalTrialMetadata>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ClinicalTrialMetadata IJsonModel<ClinicalTrialMetadata>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ClinicalTrialMetadata>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ClinicalTrialMetadata IModel<ClinicalTrialMetadata>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ClinicalTrialMetadata>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static ClinicalTrialMetadata FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrialMetadata(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
