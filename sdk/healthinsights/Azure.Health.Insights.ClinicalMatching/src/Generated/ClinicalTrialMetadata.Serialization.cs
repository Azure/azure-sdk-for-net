...
namespace Azure.Health.Insights.ClinicalMatching
{
    public partial class ClinicalTrialMetadata : IUtf8JsonSerializable, IJsonModel<ClinicalTrialMetadata>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ClinicalTrialMetadata>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ClinicalTrialMetadata FromResponse(Response response)
        {
            ...
            return DeserializeClinicalTrialMetadata(document.RootElement, new ModelReaderWriterOptions("W"));
        }
