...
namespace Microsoft.Azure.Management.ConnectedVMwarevSphere
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AzureArcVMwareManagementServiceAPIClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AzureArcVMwareManagementServiceAPIClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.ConnectedVMwarevSphere/operations").ToString();
