...
namespace Microsoft.Azure.Management.ConnectedVMwarevSphere.Models
{
    ...
    public partial class VirtualDisk
    {
        ...
        /// disk.</param>
        /// <param name="label">Gets or sets the label of the virtual disk in
        /// vCenter.</param>
        ...
        public VirtualDisk(string name = default(string), string label = default(string), string diskObjectId = default(string), int? diskSizeGB = default(int?), int? deviceKey = default(int?), string diskMode = default(string), int? controllerKey = default(int?), int? unitNumber = default(int?), string deviceName = default(string), string diskType = default(string))
        {
            Name = name;
            Label = label;
        ...
        /// </summary>
        [JsonProperty(PropertyName = "diskObjectId")]
        public string DiskObjectId { get; private set; }
