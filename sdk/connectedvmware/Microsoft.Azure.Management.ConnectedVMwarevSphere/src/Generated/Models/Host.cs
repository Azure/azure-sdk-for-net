...
namespace Microsoft.Azure.Management.ConnectedVMwarevSphere.Models
{
    ...
    public partial class Host : IResource
    {
        /// <summary>
        ...
        /// resource in which this host resides.</param>
        /// <param name="moRefId">Gets or sets the vCenter MoRef (Managed
        /// Object Reference) ID for the host.</param>
        ...
        public Host(string location, string uuid = default(string), string vCenterId = default(string), string moRefId = default(string), string inventoryItemId = default(string), string moName = default(string), IList<ResourceStatus> statuses = default(IList<ResourceStatus>), string customResourceName = default(string), string provisioningState = default(string), ExtendedLocation extendedLocation = default(ExtendedLocation), SystemData systemData = default(SystemData), IDictionary<string, string> tags = default(IDictionary<string, string>), string name = default(string), string id = default(string), string type = default(string), string kind = default(string))
        {
            Uuid = uuid;
            VCenterId = vCenterId;
            MoRefId = moRefId;
