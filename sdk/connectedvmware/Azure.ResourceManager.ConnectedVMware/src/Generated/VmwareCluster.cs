...
namespace Azure.ResourceManager.ConnectedVMware
{
    ...
    public partial class VmwareCluster : ArmResource
    {
        ...
        internal VmwareCluster(ArmResource options, VmwareClusterData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<ClusterDeleteOperation> DeleteAsync(bool? force = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ClusterDeleteOperation(_clientDiagnostics, Pipeline, _clustersRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, force).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ClusterDeleteOperation Delete(bool? force = null, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("VmwareCluster.Delete");
            scope.Start();
            try
