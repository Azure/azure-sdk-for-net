...
namespace Azure.ResourceManager.ConnectedVmware
{
    public partial class VirtualNetworkData : IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetworkData DeserializeVirtualNetworkData(JsonElement element)
        {
            ...
            return new VirtualNetworkData(id, name, type, tags, location, extendedLocation, systemData, kind.Value, uuid.Value, vCenterId.Value, moRefId.Value, inventoryItemId.Value, moName.Value, customResourceName.Value, Optional.ToList(statuses), provisioningState.Value);
        }
    }
}
