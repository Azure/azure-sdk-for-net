...
#pragma warning disable SA1649 // File name should match first type name
    internal class AutomanageArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal<T> _operation;

        /// <summary> Initializes a new instance of AutomanageArmOperation for mocking. </summary>
        protected AutomanageArmOperation()
        {
        }
        ...
        internal AutomanageArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(nextLinkOperation, clientDiagnostics, response, "AutomanageArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
