...
namespace Azure.ResourceManager.Automanage.Models
{
    ...
    {
        internal static ConfigurationProfileList DeserializeConfigurationProfileList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
