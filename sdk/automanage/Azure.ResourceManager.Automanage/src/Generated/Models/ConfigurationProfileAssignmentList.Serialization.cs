...
{
    internal partial class ConfigurationProfileAssignmentList : IUtf8JsonSerializable, IJsonModel<ConfigurationProfileAssignmentList>, IPersistableModel<ConfigurationProfileAssignmentList>
    {
        ...
        void IJsonModel<ConfigurationProfileAssignmentList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConfigurationProfileAssignmentList)} does not support '{format}' format.");
            }
