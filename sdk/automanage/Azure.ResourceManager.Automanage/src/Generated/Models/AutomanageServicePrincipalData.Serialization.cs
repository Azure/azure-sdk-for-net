...
namespace Azure.ResourceManager.Automanage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomanageServicePrincipalData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomanageServicePrincipalData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomanageServicePrincipalData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomanageServicePrincipalData>)} interface");
            }
        ...
        string IPersistableModel<AutomanageServicePrincipalData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
