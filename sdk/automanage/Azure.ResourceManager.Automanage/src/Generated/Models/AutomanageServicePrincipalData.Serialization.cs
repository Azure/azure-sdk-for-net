...
{
    public partial class AutomanageServicePrincipalData : IUtf8JsonSerializable, IJsonModel<AutomanageServicePrincipalData>, IPersistableModel<AutomanageServicePrincipalData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServicePrincipalId))
            {
                ...
                builder.AppendLine($" '{ServicePrincipalId}'");
            }

            if (Optional.IsDefined(IsAuthorizationSet))
            {
                builder.Append("  authorizationSet:");
                var boolValue = IsAuthorizationSet.Value == true ? "true" : "false";
