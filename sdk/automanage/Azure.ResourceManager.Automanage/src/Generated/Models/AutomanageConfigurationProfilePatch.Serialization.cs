...
namespace Azure.ResourceManager.Automanage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomanageConfigurationProfilePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomanageConfigurationProfilePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomanageConfigurationProfilePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomanageConfigurationProfilePatch>)} interface");
            }
        ...
        string IPersistableModel<AutomanageConfigurationProfilePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
