...
namespace Azure.ResourceManager.Automanage
{
    ...
    {
        internal static AutomanageBestPracticeData DeserializeAutomanageBestPracticeData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
