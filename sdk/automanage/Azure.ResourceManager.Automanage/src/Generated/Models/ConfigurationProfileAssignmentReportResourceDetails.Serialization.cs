    ...
    public partial class ConfigurationProfileAssignmentReportResourceDetails : IUtf8JsonSerializable, IJsonModel<ConfigurationProfileAssignmentReportResourceDetails>
    {
        ...
        internal static ConfigurationProfileAssignmentReportResourceDetails DeserializeConfigurationProfileAssignmentReportResourceDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResponseError>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), options, AzureResourceManagerAutomanageContext.Default)
#else
                ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), options, AzureResourceManagerAutomanageContext.Default)
#endif
;
                    continue;
                }
