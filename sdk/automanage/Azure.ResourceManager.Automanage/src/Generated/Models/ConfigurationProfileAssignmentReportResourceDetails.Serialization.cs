...
namespace Azure.ResourceManager.Automanage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigurationProfileAssignmentReportResourceDetails>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ConfigurationProfileAssignmentReportResourceDetails IJsonModel<ConfigurationProfileAssignmentReportResourceDetails>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ConfigurationProfileAssignmentReportResourceDetails>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ConfigurationProfileAssignmentReportResourceDetails IModel<ConfigurationProfileAssignmentReportResourceDetails>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ConfigurationProfileAssignmentReportResourceDetails>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
