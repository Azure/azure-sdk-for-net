...
namespace Azure.ResourceManager.Automanage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConfigurationProfileAssignmentReportResourceDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ConfigurationProfileAssignmentReportResourceDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConfigurationProfileAssignmentReportResourceDetails>)} interface");
            }
        ...
        string IPersistableModel<ConfigurationProfileAssignmentReportResourceDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
