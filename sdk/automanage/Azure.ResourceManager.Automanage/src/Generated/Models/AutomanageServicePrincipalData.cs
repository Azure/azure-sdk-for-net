...
namespace Azure.ResourceManager.Automanage.Models
{
    ...
    public partial class AutomanageServicePrincipalData : ResourceData
    {
        ...
        internal AutomanageServicePrincipalData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string servicePrincipalId, bool? isAuthorizationSet, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
