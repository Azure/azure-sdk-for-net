...
namespace Azure.ResourceManager.Automanage.Models
{
    ...
    public partial class ConfigurationProfileAssignmentReportResourceDetails : ResourceData
    {
        ...
        internal ConfigurationProfileAssignmentReportResourceDetails(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string status, ResponseError error, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Status = status;
            Error = error;
