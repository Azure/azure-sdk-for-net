...
namespace Azure.ResourceManager.Automanage.Models
{
    internal partial class ReportList : IUtf8JsonSerializable, IJsonModel<ReportList>
    {
        ...
        void IJsonModel<ReportList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReportList)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<AutomanageConfigurationProfileAssignmentReportData> collection && collection.IsUndefined))
            {
