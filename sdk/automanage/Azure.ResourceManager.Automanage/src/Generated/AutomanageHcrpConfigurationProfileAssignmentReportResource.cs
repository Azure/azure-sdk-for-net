...
namespace Azure.ResourceManager.Automanage
{
    ...
    public partial class AutomanageHcrpConfigurationProfileAssignmentReportResource : ArmResource
    {
        ...
        internal AutomanageHcrpConfigurationProfileAssignmentReportResource(ArmClient client, AutomanageConfigurationProfileAssignmentReportData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AutomanageHcrpConfigurationProfileAssignmentReportResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new AutomanageHcrpConfigurationProfileAssignmentReportResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
