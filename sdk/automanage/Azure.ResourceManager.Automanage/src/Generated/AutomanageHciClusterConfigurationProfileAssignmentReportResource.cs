...
namespace Azure.ResourceManager.Automanage
{
    ...
    public partial class AutomanageHciClusterConfigurationProfileAssignmentReportResource : ArmResource
    {
        ...
        internal AutomanageHciClusterConfigurationProfileAssignmentReportResource(ArmClient client, AutomanageConfigurationProfileAssignmentReportData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
