...
namespace Azure.ResourceManager.Automanage.Models
{
    ...
    public static partial class ArmAutomanageModelFactory
    {
        ...
        {
            return new AutomanageBestPracticeData(id, name, resourceType, systemData, configuration, new Dictionary<string, BinaryData>());
        }
        ...
        public static AutomanageConfigurationProfileData AutomanageConfigurationProfileData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, BinaryData configuration = null)
        {
            ...
            return new AutomanageConfigurationProfileData(id, name, resourceType, systemData, tags, location, configuration != null ? new ConfigurationProfileProperties(configuration, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AutomanageConfigurationProfileAssignmentData(id, name, resourceType, systemData, properties, managedBy, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AutomanageConfigurationProfileAssignmentProperties(configurationProfile, targetId, status, new Dictionary<string, BinaryData>());
        }
        ...
        public static AutomanageConfigurationProfileAssignmentReportData AutomanageConfigurationProfileAssignmentReportData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, DateTimeOffset? lastModifiedOn = null, TimeSpan? duration = null, string configurationProfileAssignmentProcessingType = null, string status = null, string configurationProfile = null, IEnumerable<ConfigurationProfileAssignmentReportResourceDetails> resources = null, ResponseError error = null, string reportFormatVersion = null)
        {
            ...
            return new AutomanageConfigurationProfileAssignmentReportData(id, name, resourceType, systemData, startOn, endOn, lastModifiedOn, duration, configurationProfileAssignmentProcessingType, status, configurationProfile, resources?.ToList(), error, reportFormatVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ConfigurationProfileAssignmentReportResourceDetails(id, name, resourceType, systemData, status, error, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AutomanageServicePrincipalData(id, name, resourceType, systemData, servicePrincipalId, isAuthorizationSet, new Dictionary<string, BinaryData>());
        }
    }
}
