...
namespace Azure.ResourceManager.Automanage
{
    ...
    public partial class AutomanageConfigurationProfileVersionResource : ArmResource
    {
        ...
        internal AutomanageConfigurationProfileVersionResource(ArmClient client, AutomanageConfigurationProfileData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<AutomanageConfigurationProfileVersionResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new AutomanageConfigurationProfileVersionResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
