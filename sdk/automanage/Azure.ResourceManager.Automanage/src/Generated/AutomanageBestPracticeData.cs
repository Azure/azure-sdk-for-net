...
namespace Azure.ResourceManager.Automanage
{
    ...
    public partial class AutomanageBestPracticeData : ResourceData
    {
        ...
        internal AutomanageBestPracticeData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, BinaryData configuration, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
