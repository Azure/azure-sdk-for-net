...
namespace Azure.ResourceManager.Automanage.Mock
{
    ...
    public partial class AutomanageConfigurationProfileResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AutomanageConfigurationProfileResourceExtension"/> class for mocking. </summary>
        protected AutomanageConfigurationProfileResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AutomanageConfigurationProfileResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AutomanageConfigurationProfileResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
