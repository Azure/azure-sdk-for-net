...
namespace Azure.ResourceManager.Automanage.Testing
{
    ...
    public partial class AutomanageSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AutomanageSubscriptionResourceExtension"/> class for mocking. </summary>
        protected AutomanageSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AutomanageSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AutomanageSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AutomanageServicePrincipalData> GetServicePrincipalsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, AutomanageServicePrincipalData.DeserializeAutomanageServicePrincipalData, ServicePrincipalsClientDiagnostics, Pipeline, "AutomanageSubscriptionResourceExtension.GetServicePrincipals", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ServicePrincipalsRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, AutomanageServicePrincipalData.DeserializeAutomanageServicePrincipalData, ServicePrincipalsClientDiagnostics, Pipeline, "AutomanageSubscriptionResourceExtension.GetServicePrincipals", "value", null, cancellationToken);
        }
        ...
        {
            using var scope = ServicePrincipalsClientDiagnostics.CreateScope("AutomanageSubscriptionResourceExtension.GetServicePrincipal");
            scope.Start();
            try
            {
