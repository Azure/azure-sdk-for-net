...
namespace Azure.ResourceManager.Automanage.Mocking
{
    ...
    internal partial class AutomanageTenantMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AutomanageTenantMockingExtension"/> class for mocking. </summary>
        protected AutomanageTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AutomanageTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AutomanageTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
