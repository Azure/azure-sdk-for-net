...
namespace Azure.ResourceManager.Automanage.Mocking
{
    ...
    internal partial class AutomanageResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AutomanageResourceGroupMockingExtension"/> class for mocking. </summary>
        protected AutomanageResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AutomanageResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AutomanageResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
