...
namespace Azure.ResourceManager.Automanage.Testing
{
    /// <summary> A class to add extension methods to ArmResource. </summary>
    public partial class AutomanageArmResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AutomanageArmResourceExtension"/> class for mocking. </summary>
        protected AutomanageArmResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AutomanageArmResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AutomanageArmResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
