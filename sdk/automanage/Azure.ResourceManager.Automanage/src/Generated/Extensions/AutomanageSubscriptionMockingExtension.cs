...
namespace Azure.ResourceManager.Automanage.Mocking
{
    ...
    public partial class AutomanageSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AutomanageSubscriptionMockingExtension"/> class for mocking. </summary>
        protected AutomanageSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AutomanageSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AutomanageSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AutomanageServicePrincipalData> GetServicePrincipalsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, AutomanageServicePrincipalData.DeserializeAutomanageServicePrincipalData, ServicePrincipalsClientDiagnostics, Pipeline, "AutomanageSubscriptionMockingExtension.GetServicePrincipals", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ServicePrincipalsRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, AutomanageServicePrincipalData.DeserializeAutomanageServicePrincipalData, ServicePrincipalsClientDiagnostics, Pipeline, "AutomanageSubscriptionMockingExtension.GetServicePrincipals", "value", null, cancellationToken);
        }
        ...
        {
            using var scope = ServicePrincipalsClientDiagnostics.CreateScope("AutomanageSubscriptionMockingExtension.GetServicePrincipal");
            scope.Start();
            try
            {
