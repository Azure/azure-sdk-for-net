...
namespace Azure.ResourceManager.Automanage
{
    ...
    public static partial class AutomanageExtensions
    {
        ...
        public static AutomanageVmConfigurationProfileAssignmentCollection GetAutomanageVmConfigurationProfileAssignments(this ArmClient client, ResourceIdentifier scope)
        {
            ...
            return GetArmResourceExtension(client, scope).GetAutomanageVmConfigurationProfileAssignments();
        }
        ...
        public static AutomanageHcrpConfigurationProfileAssignmentCollection GetAutomanageHcrpConfigurationProfileAssignments(this ArmClient client, ResourceIdentifier scope)
        {
            ...
            return GetArmResourceExtension(client, scope).GetAutomanageHcrpConfigurationProfileAssignments();
        }
        ...
        public static AutomanageHciClusterConfigurationProfileAssignmentCollection GetAutomanageHciClusterConfigurationProfileAssignments(this ArmClient client, ResourceIdentifier scope)
        {
            ...
            return GetArmResourceExtension(client, scope).GetAutomanageHciClusterConfigurationProfileAssignments();
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetAutomanageConfigurationProfiles();
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetServicePrincipalsAsync(cancellationToken);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetServicePrincipals(cancellationToken);
        }
        ...
        {
            return await GetSubscriptionResourceExtension(subscriptionResource).GetServicePrincipalAsync(cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetServicePrincipal(cancellationToken);
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetAutomanageBestPractices();
        }
