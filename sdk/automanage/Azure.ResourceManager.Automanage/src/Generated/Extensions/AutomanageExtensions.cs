...
using Azure.ResourceManager.Automanage.Testing;
...
namespace Azure.ResourceManager.Automanage
{
    ...
    public static partial class AutomanageExtensions
    {
        ...
        {
            return GetAutomanageSubscriptionResourceExtension(subscriptionResource).GetAutomanageConfigurationProfilesAsync(cancellationToken);
        }
        ...
        {
            return GetAutomanageSubscriptionResourceExtension(subscriptionResource).GetAutomanageConfigurationProfiles(cancellationToken);
        }
