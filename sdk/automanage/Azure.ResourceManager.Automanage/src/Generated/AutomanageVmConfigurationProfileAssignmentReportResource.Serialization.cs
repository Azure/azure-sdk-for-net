...
namespace Azure.ResourceManager.Automanage
{
    public partial class AutomanageVmConfigurationProfileAssignmentReportResource : IJsonModel<AutomanageConfigurationProfileAssignmentReportData>
    {
        ...
        {
            return ModelReaderWriter.Read<AutomanageConfigurationProfileAssignmentReportData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AutomanageConfigurationProfileAssignmentReportData>(data, options);
        }
