...
namespace Microsoft.Azure.Management.Automanage
{
    ...
    /// </summary>
    internal partial class BestPracticesVersionsOperations : IServiceOperations<AutomanageClient>, IBestPracticesVersionsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<BestPractice>> GetWithHttpMessagesAsync(string bestPracticeName, string versionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<BestPractice>>> ListByTenantWithHttpMessagesAsync(string bestPracticeName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (bestPracticeName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "bestPracticeName");
