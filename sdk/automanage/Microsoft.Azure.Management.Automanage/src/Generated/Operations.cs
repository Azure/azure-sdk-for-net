...
namespace Microsoft.Azure.Management.Automanage
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AutomanageClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AutomanageClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IEnumerable<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Automanage/operations").ToString();
