...
namespace Microsoft.Azure.Management.Automanage
{
    ...
    /// </summary>
    internal partial class ConfigurationProfilesVersionsOperations : IServiceOperations<AutomanageClient>, IConfigurationProfilesVersionsOperations
    {
        /// <summary>
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<ConfigurationProfile>> GetWithHttpMessagesAsync(string configurationProfileName, string versionName, string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (configurationProfileName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "configurationProfileName");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> DeleteWithHttpMessagesAsync(string resourceGroupName, string configurationProfileName, string versionName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IEnumerable<ConfigurationProfile>>> ListChildResourcesWithHttpMessagesAsync(string configurationProfileName, string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (configurationProfileName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "configurationProfileName");
