...
#pragma warning disable SA1649 // File name should match first type name
    internal class StoreArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of StoreArmOperation for mocking. </summary>
        protected StoreArmOperation()
        {
        }

        internal StoreArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal StoreArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "StoreArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
