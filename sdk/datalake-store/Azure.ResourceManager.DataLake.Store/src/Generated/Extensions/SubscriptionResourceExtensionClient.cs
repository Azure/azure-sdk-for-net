...
namespace Azure.ResourceManager.DataLake.Store
{
    ...
    internal partial class SubscriptionResourceExtensionClient : ArmResource
    {
        ...
        private ClientDiagnostics DataLakeStoreAccountAccountsClientDiagnostics => _dataLakeStoreAccountAccountsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.DataLake.Store", DataLakeStoreAccountResource.ResourceType.Namespace, Diagnostics);
        ...
        private ClientDiagnostics LocationsClientDiagnostics => _locationsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.DataLake.Store", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        public virtual AsyncPageable<StoreUsage> GetUsageLocationsAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            async Task<Page<StoreUsage>> FirstPageFunc(int? pageSizeHint)
            {
        ...
        public virtual Pageable<StoreUsage> GetUsageLocations(AzureLocation location, CancellationToken cancellationToken = default)
        {
            Page<StoreUsage> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = LocationsClientDiagnostics.CreateScope("SubscriptionResourceExtensionClient.GetUsageLocations");
                scope.Start();
                try
