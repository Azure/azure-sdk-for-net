...
namespace Azure.ResourceManager.DataLake.Store.Models
{
    ...
    {
        internal static StoreUsage DeserializeStoreUsage(JsonElement element)
        {
            ...
            return new StoreUsage(Optional.ToNullable(unit), id.Value, Optional.ToNullable(currentValue), Optional.ToNullable(limit), name.Value);
        }
    }
}
