...
namespace Azure.ResourceManager.DataLakeStore
{
    ...
    public partial class VirtualNetworkRuleCollection : ArmCollection, IEnumerable<VirtualNetworkRuleResource>, IAsyncEnumerable<VirtualNetworkRuleResource>
    {
        ...
        {
            _virtualNetworkRuleClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataLakeStore", VirtualNetworkRuleResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<VirtualNetworkRuleResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string virtualNetworkRuleName, VirtualNetworkRuleCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataLakeStoreArmOperation<VirtualNetworkRuleResource>(Response.FromValue(new VirtualNetworkRuleResource(Client, response), response.GetRawResponse()));
