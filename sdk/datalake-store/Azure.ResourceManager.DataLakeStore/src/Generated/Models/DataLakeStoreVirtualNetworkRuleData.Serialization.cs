...
namespace Azure.ResourceManager.DataLakeStore
{
    public partial class DataLakeStoreVirtualNetworkRuleData : IUtf8JsonSerializable, IJsonModel<DataLakeStoreVirtualNetworkRuleData>
    {
        ...
        void IJsonModel<DataLakeStoreVirtualNetworkRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DataLakeStoreVirtualNetworkRuleData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataLakeStoreVirtualNetworkRuleData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DataLakeStoreVirtualNetworkRuleData)} does not support '{options.Format}' format.");
            }
        }
