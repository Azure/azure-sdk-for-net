...
{
    public partial class DataLakeStoreVirtualNetworkRuleData : IUtf8JsonSerializable, IJsonModel<DataLakeStoreVirtualNetworkRuleData>, IPersistableModel<DataLakeStoreVirtualNetworkRuleData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeStoreVirtualNetworkRuleData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataLakeStoreVirtualNetworkRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataLakeStoreVirtualNetworkRuleData)} does not support '{format}' format.");
            }
