...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    public partial class DataLakeStoreAccountCreateOrUpdateContent
    {
        ...
        internal DataLakeStoreAccountCreateOrUpdateContent(AzureLocation location, IDictionary<string, string> tags, ManagedServiceIdentity identity, string defaultGroup, DataLakeStoreAccountEncryptionConfig encryptionConfig, DataLakeStoreEncryptionState? encryptionState, IList<FirewallRuleForDataLakeStoreAccountCreateOrUpdateContent> firewallRules, IList<VirtualNetworkRuleForDataLakeStoreAccountCreateOrUpdateContent> virtualNetworkRules, DataLakeStoreFirewallState? firewallState, DataLakeStoreFirewallAllowAzureIPsState? firewallAllowAzureIPs, IList<TrustedIdProviderForDataLakeStoreAccountCreateOrUpdateContent> trustedIdProviders, DataLakeStoreTrustedIdProviderState? trustedIdProviderState, DataLakeStoreCommitmentTierType? newTier, Dictionary<string, BinaryData> rawData)
        {
            Location = location;
            Tags = tags;
            Identity = identity;
