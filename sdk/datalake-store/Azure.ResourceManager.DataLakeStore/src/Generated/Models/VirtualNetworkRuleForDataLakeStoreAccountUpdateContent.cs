...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    public partial class VirtualNetworkRuleForDataLakeStoreAccountUpdateContent
    {
        ...
        internal VirtualNetworkRuleForDataLakeStoreAccountUpdateContent(string name, ResourceIdentifier subnetId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            SubnetId = subnetId;
