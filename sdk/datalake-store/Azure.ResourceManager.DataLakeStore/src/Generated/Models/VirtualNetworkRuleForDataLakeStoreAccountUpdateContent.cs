...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    public partial class VirtualNetworkRuleForDataLakeStoreAccountUpdateContent
    {
        ...
        internal VirtualNetworkRuleForDataLakeStoreAccountUpdateContent(string name, ResourceIdentifier subnetId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            SubnetId = subnetId;
