...
namespace Azure.ResourceManager.DataLakeStore
{
    ...
    {
        internal static DataLakeStoreAccountData DeserializeDataLakeStoreAccountData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
