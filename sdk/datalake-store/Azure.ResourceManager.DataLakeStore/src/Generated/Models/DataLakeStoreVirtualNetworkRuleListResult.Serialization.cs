...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    internal partial class DataLakeStoreVirtualNetworkRuleListResult : IUtf8JsonSerializable, IJsonModel<DataLakeStoreVirtualNetworkRuleListResult>
    {
        ...
        void IJsonModel<DataLakeStoreVirtualNetworkRuleListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DataLakeStoreVirtualNetworkRuleListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataLakeStoreVirtualNetworkRuleListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DataLakeStoreVirtualNetworkRuleListResult)} does not support '{options.Format}' format.");
            }
        }
