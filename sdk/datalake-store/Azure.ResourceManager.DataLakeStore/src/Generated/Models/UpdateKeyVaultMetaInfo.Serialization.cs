...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateKeyVaultMetaInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateKeyVaultMetaInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateKeyVaultMetaInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateKeyVaultMetaInfo>)} interface");
            }
        ...
        string IPersistableModel<UpdateKeyVaultMetaInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
