...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrustedIdProviderForDataLakeStoreAccountUpdateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TrustedIdProviderForDataLakeStoreAccountUpdateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrustedIdProviderForDataLakeStoreAccountUpdateContent>)} interface");
            }
        ...
        string IPersistableModel<TrustedIdProviderForDataLakeStoreAccountUpdateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
