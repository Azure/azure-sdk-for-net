...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeStoreTrustedIdProviderPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataLakeStoreTrustedIdProviderPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataLakeStoreTrustedIdProviderPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataLakeStoreTrustedIdProviderPatch>)} interface");
            }
        ...
        string IPersistableModel<DataLakeStoreTrustedIdProviderPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
