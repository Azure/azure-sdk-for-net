...
{
    public partial class DataLakeStoreTrustedIdProviderData : IUtf8JsonSerializable, IJsonModel<DataLakeStoreTrustedIdProviderData>, IPersistableModel<DataLakeStoreTrustedIdProviderData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IdProvider))
            {
                ...
                builder.AppendLine($" '{IdProvider.AbsoluteUri}'");
            }
