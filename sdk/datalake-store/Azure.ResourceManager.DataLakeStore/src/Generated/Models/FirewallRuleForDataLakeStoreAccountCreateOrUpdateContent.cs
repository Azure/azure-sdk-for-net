...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    public partial class FirewallRuleForDataLakeStoreAccountCreateOrUpdateContent
    {
        ...
        internal FirewallRuleForDataLakeStoreAccountCreateOrUpdateContent(string name, IPAddress startIPAddress, IPAddress endIPAddress, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            StartIPAddress = startIPAddress;
            EndIPAddress = endIPAddress;
