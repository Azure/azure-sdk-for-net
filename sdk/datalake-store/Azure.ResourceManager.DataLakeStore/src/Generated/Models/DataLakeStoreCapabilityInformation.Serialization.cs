...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeStoreCapabilityInformation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataLakeStoreCapabilityInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataLakeStoreCapabilityInformation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataLakeStoreCapabilityInformation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
