...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    public partial class DataLakeStoreCapabilityInformation : IUtf8JsonSerializable, IJsonModel<DataLakeStoreCapabilityInformation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DataLakeStoreCapabilityInformation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataLakeStoreCapabilityInformation>)} interface");
            }
