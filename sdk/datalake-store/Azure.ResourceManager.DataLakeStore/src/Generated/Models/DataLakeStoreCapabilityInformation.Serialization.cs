...
{
    public partial class DataLakeStoreCapabilityInformation : IUtf8JsonSerializable, IJsonModel<DataLakeStoreCapabilityInformation>, IPersistableModel<DataLakeStoreCapabilityInformation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxAccountCount))
            {
                ...
                builder.AppendLine($" '{MaxAccountCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(AccountCount))
            {
                builder.Append("  accountCount:");
                builder.AppendLine($" '{AccountCount.Value.ToString()}'");
            }
