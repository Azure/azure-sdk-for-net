...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirewallRuleForDataLakeStoreAccountUpdateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FirewallRuleForDataLakeStoreAccountUpdateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirewallRuleForDataLakeStoreAccountUpdateContent>)} interface");
            }
        ...
        string IPersistableModel<FirewallRuleForDataLakeStoreAccountUpdateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
