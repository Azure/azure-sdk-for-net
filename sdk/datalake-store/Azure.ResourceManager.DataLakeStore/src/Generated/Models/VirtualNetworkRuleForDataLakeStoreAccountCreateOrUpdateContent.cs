...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    public partial class VirtualNetworkRuleForDataLakeStoreAccountCreateOrUpdateContent
    {
        ...
        internal VirtualNetworkRuleForDataLakeStoreAccountCreateOrUpdateContent(string name, ResourceIdentifier subnetId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            SubnetId = subnetId;
