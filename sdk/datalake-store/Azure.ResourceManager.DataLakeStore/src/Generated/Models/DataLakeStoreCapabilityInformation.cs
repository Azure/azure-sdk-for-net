...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    public partial class DataLakeStoreCapabilityInformation
    {
        ...
        internal DataLakeStoreCapabilityInformation(Guid? subscriptionId, DataLakeStoreSubscriptionState? state, int? maxAccountCount, int? accountCount, bool? isUnderMigrationState, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
