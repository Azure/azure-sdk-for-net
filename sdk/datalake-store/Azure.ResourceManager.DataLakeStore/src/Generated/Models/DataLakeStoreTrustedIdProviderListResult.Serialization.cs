...
{
    internal partial class DataLakeStoreTrustedIdProviderListResult : IUtf8JsonSerializable, IJsonModel<DataLakeStoreTrustedIdProviderListResult>, IPersistableModel<DataLakeStoreTrustedIdProviderListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeStoreTrustedIdProviderListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataLakeStoreTrustedIdProviderListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataLakeStoreTrustedIdProviderListResult)} does not support '{format}' format.");
            }
