...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    public partial class DataLakeStoreUsage
    {
        ...
        internal DataLakeStoreUsage(DataLakeStoreUsageUnit? unit, ResourceIdentifier id, int? currentValue, int? limit, DataLakeStoreUsageName name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Unit = unit;
            Id = id;
