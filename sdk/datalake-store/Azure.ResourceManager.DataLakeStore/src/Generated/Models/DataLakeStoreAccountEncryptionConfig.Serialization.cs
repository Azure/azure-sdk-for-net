...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeStoreAccountEncryptionConfig>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        DataLakeStoreAccountEncryptionConfig IJsonModel<DataLakeStoreAccountEncryptionConfig>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<DataLakeStoreAccountEncryptionConfig>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        DataLakeStoreAccountEncryptionConfig IModel<DataLakeStoreAccountEncryptionConfig>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<DataLakeStoreAccountEncryptionConfig>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
