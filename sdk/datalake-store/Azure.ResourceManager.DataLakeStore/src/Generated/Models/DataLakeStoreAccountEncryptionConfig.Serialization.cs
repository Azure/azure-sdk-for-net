...
{
    public partial class DataLakeStoreAccountEncryptionConfig : IUtf8JsonSerializable, IJsonModel<DataLakeStoreAccountEncryptionConfig>, IPersistableModel<DataLakeStoreAccountEncryptionConfig>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConfigType))
            {
                builder.Append("  type:");
                builder.AppendLine($" '{ConfigType.ToString()}'");
            }

            if (Optional.IsDefined(KeyVaultMetaInfo))
            {
                builder.Append("  keyVaultMetaInfo:");
                AppendChildObject(builder, KeyVaultMetaInfo, options, 2);
            }
