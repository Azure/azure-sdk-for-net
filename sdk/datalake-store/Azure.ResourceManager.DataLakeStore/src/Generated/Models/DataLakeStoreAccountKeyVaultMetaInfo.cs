...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    public partial class DataLakeStoreAccountKeyVaultMetaInfo
    {
        ...
        internal DataLakeStoreAccountKeyVaultMetaInfo(string keyVaultResourceId, string encryptionKeyName, string encryptionKeyVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyVaultResourceId = keyVaultResourceId;
            EncryptionKeyName = encryptionKeyName;
            EncryptionKeyVersion = encryptionKeyVersion;
