...
namespace Azure.ResourceManager.DataLakeStore.Mock
{
    ...
    public partial class SubscriptionResourceExtension : ArmResource
    {
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("SubscriptionResourceExtension.GetCapabilityByLocation");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<DataLakeStoreUsage> GetUsagesByLocationAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, DataLakeStoreUsage.DeserializeDataLakeStoreUsage, LocationsClientDiagnostics, Pipeline, "SubscriptionResourceExtension.GetUsagesByLocation", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => LocationsRestClient.CreateGetUsageRequest(Id.SubscriptionId, location);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, DataLakeStoreUsage.DeserializeDataLakeStoreUsage, LocationsClientDiagnostics, Pipeline, "SubscriptionResourceExtension.GetUsagesByLocation", "value", null, cancellationToken);
        }
    }
}
