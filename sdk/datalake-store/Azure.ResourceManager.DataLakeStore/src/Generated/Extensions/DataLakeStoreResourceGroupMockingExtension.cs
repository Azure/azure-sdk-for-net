...
namespace Azure.ResourceManager.DataLakeStore.Mocking
{
    ...
    internal partial class DataLakeStoreResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DataLakeStoreResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DataLakeStoreResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataLakeStoreResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataLakeStoreResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
