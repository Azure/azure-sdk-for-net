...
namespace Azure.ResourceManager.DataLakeStore.Testing
{
    ...
    public partial class DataLakeStoreSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataLakeStoreSubscriptionResourceExtension"/> class for mocking. </summary>
        protected DataLakeStoreSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataLakeStoreSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataLakeStoreSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DataLakeStoreAccountBasicData> GetAccountsAsync(SubscriptionResourceGetAccountsOptions options, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, DataLakeStoreAccountBasicData.DeserializeDataLakeStoreAccountBasicData, DataLakeStoreAccountAccountsClientDiagnostics, Pipeline, "DataLakeStoreSubscriptionResourceExtension.GetAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DataLakeStoreAccountBasicData> GetAccounts(SubscriptionResourceGetAccountsOptions options, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => DataLakeStoreAccountAccountsRestClient.CreateListRequest(Id.SubscriptionId, options.Filter, options.Top, options.Skip, options.Select, options.OrderBy, options.Count);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DataLakeStoreAccountAccountsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, options.Filter, options.Top, options.Skip, options.Select, options.OrderBy, options.Count);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, DataLakeStoreAccountBasicData.DeserializeDataLakeStoreAccountBasicData, DataLakeStoreAccountAccountsClientDiagnostics, Pipeline, "DataLakeStoreSubscriptionResourceExtension.GetAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<DataLakeStoreAccountNameAvailabilityResult>> CheckDataLakeStoreAccountNameAvailabilityAsync(AzureLocation location, DataLakeStoreAccountNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DataLakeStoreAccountAccountsClientDiagnostics.CreateScope("DataLakeStoreSubscriptionResourceExtension.CheckDataLakeStoreAccountNameAvailability");
            scope.Start();
            try
            {
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("DataLakeStoreSubscriptionResourceExtension.GetCapabilityByLocation");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<DataLakeStoreUsage> GetUsagesByLocationAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, DataLakeStoreUsage.DeserializeDataLakeStoreUsage, LocationsClientDiagnostics, Pipeline, "DataLakeStoreSubscriptionResourceExtension.GetUsagesByLocation", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => LocationsRestClient.CreateGetUsageRequest(Id.SubscriptionId, location);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, DataLakeStoreUsage.DeserializeDataLakeStoreUsage, LocationsClientDiagnostics, Pipeline, "DataLakeStoreSubscriptionResourceExtension.GetUsagesByLocation", "value", null, cancellationToken);
        }
    }
}
