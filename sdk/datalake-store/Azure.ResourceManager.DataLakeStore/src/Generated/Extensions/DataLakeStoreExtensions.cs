...
namespace Azure.ResourceManager.DataLakeStore
{
    ...
    public static partial class DataLakeStoreExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetDataLakeStoreAccounts();
        }
        ...
        {
            return await GetSubscriptionResourceExtension(subscriptionResource).GetCapabilityByLocationAsync(location, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetCapabilityByLocation(location, cancellationToken);
        }
