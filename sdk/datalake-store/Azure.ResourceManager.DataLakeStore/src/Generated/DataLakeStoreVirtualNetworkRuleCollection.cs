...
namespace Azure.ResourceManager.DataLakeStore
{
    ...
    public partial class DataLakeStoreVirtualNetworkRuleCollection : ArmCollection, IEnumerable<DataLakeStoreVirtualNetworkRuleResource>, IAsyncEnumerable<DataLakeStoreVirtualNetworkRuleResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataLakeStoreVirtualNetworkRuleCollection"/> class for mocking. </summary>
        protected DataLakeStoreVirtualNetworkRuleCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataLakeStoreVirtualNetworkRuleCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the parent resource that is the target of operations. </param>
        internal DataLakeStoreVirtualNetworkRuleCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _dataLakeStoreVirtualNetworkRuleVirtualNetworkRulesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataLakeStore", DataLakeStoreVirtualNetworkRuleResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(DataLakeStoreVirtualNetworkRuleResource.ResourceType, out string dataLakeStoreVirtualNetworkRuleVirtualNetworkRulesApiVersion);
        ...
        public virtual async Task<Response<DataLakeStoreVirtualNetworkRuleResource>> GetAsync(string virtualNetworkRuleName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _dataLakeStoreVirtualNetworkRuleVirtualNetworkRulesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, virtualNetworkRuleName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DataLakeStoreVirtualNetworkRuleResource> Get(string virtualNetworkRuleName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dataLakeStoreVirtualNetworkRuleVirtualNetworkRulesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, virtualNetworkRuleName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DataLakeStoreVirtualNetworkRuleResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataLakeStore/accounts/{accountName}/virtualNetworkRules</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        IEnumerator<DataLakeStoreVirtualNetworkRuleResource> IEnumerable<DataLakeStoreVirtualNetworkRuleResource>.GetEnumerator()
        {
        ...
        IAsyncEnumerator<DataLakeStoreVirtualNetworkRuleResource> IAsyncEnumerable<DataLakeStoreVirtualNetworkRuleResource>.GetAsyncEnumerator(CancellationToken cancellationToken)
        {
