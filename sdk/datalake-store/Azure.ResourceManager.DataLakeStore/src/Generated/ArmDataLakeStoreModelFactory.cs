...
namespace Azure.ResourceManager.DataLakeStore.Models
{
    ...
    public static partial class ArmDataLakeStoreModelFactory
    {
        ...
        public static DataLakeStoreAccountBasicData DataLakeStoreAccountBasicData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, Guid? accountId = null, DataLakeStoreAccountStatus? provisioningState = null, DataLakeStoreAccountState? state = null, DateTimeOffset? createdOn = null, DateTimeOffset? lastModifiedOn = null, string endpoint = null, AzureLocation? location = null, IReadOnlyDictionary<string, string> tags = null)
        {
            ...
            return new DataLakeStoreAccountBasicData(id, name, resourceType, systemData, accountId, provisioningState, state, createdOn, lastModifiedOn, endpoint, location, tags, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataLakeStoreAccountCreateOrUpdateContent DataLakeStoreAccountCreateOrUpdateContent(AzureLocation location = default, IDictionary<string, string> tags = null, ManagedServiceIdentity identity = null, string defaultGroup = null, DataLakeStoreAccountEncryptionConfig encryptionConfig = null, DataLakeStoreEncryptionState? encryptionState = null, IEnumerable<FirewallRuleForDataLakeStoreAccountCreateOrUpdateContent> firewallRules = null, IEnumerable<VirtualNetworkRuleForDataLakeStoreAccountCreateOrUpdateContent> virtualNetworkRules = null, DataLakeStoreFirewallState? firewallState = null, DataLakeStoreFirewallAllowAzureIPsState? firewallAllowAzureIPs = null, IEnumerable<TrustedIdProviderForDataLakeStoreAccountCreateOrUpdateContent> trustedIdProviders = null, DataLakeStoreTrustedIdProviderState? trustedIdProviderState = null, DataLakeStoreCommitmentTierType? newTier = null)
        {
            ...
            return new DataLakeStoreAccountCreateOrUpdateContent(location, tags, identity, defaultGroup, encryptionConfig, encryptionState, firewallRules?.ToList(), virtualNetworkRules?.ToList(), firewallState, firewallAllowAzureIPs, trustedIdProviders?.ToList(), trustedIdProviderState, newTier, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataLakeStoreFirewallRuleData(id, name, resourceType, systemData, startIPAddress, endIPAddress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataLakeStoreVirtualNetworkRuleData(id, name, resourceType, systemData, subnetId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataLakeStoreTrustedIdProviderData(id, name, resourceType, systemData, idProvider, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirewallRuleForDataLakeStoreAccountUpdateContent(name, startIPAddress, endIPAddress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VirtualNetworkRuleForDataLakeStoreAccountUpdateContent(name, subnetId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TrustedIdProviderForDataLakeStoreAccountUpdateContent(name, idProvider, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataLakeStoreCapabilityInformation(subscriptionId, state, maxAccountCount, accountCount, isUnderMigrationState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataLakeStoreUsage(unit, id, currentValue, limit, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataLakeStoreUsageName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataLakeStoreAccountNameAvailabilityResult(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
    }
}
