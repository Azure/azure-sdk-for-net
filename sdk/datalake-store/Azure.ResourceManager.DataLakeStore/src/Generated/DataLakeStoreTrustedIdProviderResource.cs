...
namespace Azure.ResourceManager.DataLakeStore
{
    ...
    public partial class DataLakeStoreTrustedIdProviderResource : ArmResource
    {
        ...
        internal DataLakeStoreTrustedIdProviderResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _dataLakeStoreTrustedIdProviderTrustedIdProvidersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataLakeStore", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string dataLakeStoreTrustedIdProviderTrustedIdProvidersApiVersion);
        ...
        public virtual DataLakeStoreTrustedIdProviderData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<DataLakeStoreTrustedIdProviderResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _dataLakeStoreTrustedIdProviderTrustedIdProvidersClientDiagnostics.CreateScope("DataLakeStoreTrustedIdProviderResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DataLakeStoreTrustedIdProviderResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _dataLakeStoreTrustedIdProviderTrustedIdProvidersClientDiagnostics.CreateScope("DataLakeStoreTrustedIdProviderResource.Get");
            scope.Start();
            try
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>TrustedIdProviders_Delete</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using var scope = _dataLakeStoreTrustedIdProviderTrustedIdProvidersClientDiagnostics.CreateScope("DataLakeStoreTrustedIdProviderResource.Delete");
            scope.Start();
            try
            {
                var response = await _dataLakeStoreTrustedIdProviderTrustedIdProvidersRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _dataLakeStoreTrustedIdProviderTrustedIdProvidersRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new DataLakeStoreArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>TrustedIdProviders_Update</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response<DataLakeStoreTrustedIdProviderResource>> UpdateAsync(DataLakeStoreTrustedIdProviderPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));

            using var scope = _dataLakeStoreTrustedIdProviderTrustedIdProvidersClientDiagnostics.CreateScope("DataLakeStoreTrustedIdProviderResource.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Response<DataLakeStoreTrustedIdProviderResource> Update(DataLakeStoreTrustedIdProviderPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
