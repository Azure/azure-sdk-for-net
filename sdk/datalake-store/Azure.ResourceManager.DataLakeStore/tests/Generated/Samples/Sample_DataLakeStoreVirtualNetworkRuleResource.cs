...
{
    public partial class Sample_DataLakeStoreVirtualNetworkRuleResource
    {
        ...
        public async Task Get_GetsTheSpecifiedDataLakeStoreVirtualNetworkRule()
        {
            ...
            // this example assumes you already have this DataLakeStoreVirtualNetworkRuleResource created on azure
            // for more information of creating DataLakeStoreVirtualNetworkRuleResource, please refer to the document of DataLakeStoreVirtualNetworkRuleResource
            string subscriptionId = "34adfa4f-cedf-4dc0-ba29-b6d1a69ab345";
            string resourceGroupName = "contosorg";
            string accountName = "contosoadla";
            string virtualNetworkRuleName = "test_virtual_network_rules_name";
            ResourceIdentifier dataLakeStoreVirtualNetworkRuleResourceId = DataLakeStoreVirtualNetworkRuleResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, accountName, virtualNetworkRuleName);
            DataLakeStoreVirtualNetworkRuleResource dataLakeStoreVirtualNetworkRule = client.GetDataLakeStoreVirtualNetworkRuleResource(dataLakeStoreVirtualNetworkRuleResourceId);

            // invoke the operation
            DataLakeStoreVirtualNetworkRuleResource result = await dataLakeStoreVirtualNetworkRule.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            DataLakeStoreVirtualNetworkRuleData resourceData = result.Data;
        ...
        public async Task Update_UpdatesTheSpecifiedVirtualNetworkRule()
        {
            ...
            // invoke the operation
            DataLakeStoreVirtualNetworkRulePatch patch = new DataLakeStoreVirtualNetworkRulePatch()
            {
                SubnetId = new ResourceIdentifier("test_subnetId"),
            };
            DataLakeStoreVirtualNetworkRuleResource result = await dataLakeStoreVirtualNetworkRule.UpdateAsync(patch);
        ...
        public async Task Delete_DeletesTheSpecifiedVirtualNetworkRuleFromTheSpecifiedDataLakeStoreAccount()
        {
            ...
            // invoke the operation
            await dataLakeStoreVirtualNetworkRule.DeleteAsync(WaitUntil.Completed);
