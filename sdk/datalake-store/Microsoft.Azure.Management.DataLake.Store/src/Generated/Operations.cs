...
namespace Microsoft.Azure.Management.DataLake.Store
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<DataLakeStoreAccountManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(DataLakeStoreAccountManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<OperationListResult>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.DataLakeStore/operations").ToString();
