...
namespace Microsoft.Azure.Management.DataLake.Store
{
    ...
    internal class MultipleSegmentDownloader
    {
        ...
        public MultipleSegmentDownloader(TransferMetadata downloadMetadata, int maxThreadCount, IFrontEndAdapter frontEnd, IProgress<SegmentTransferProgress> progressTracker = null) :
        ...
        /// <param name="progressTracker">(Optional)A tracker that reports progress on each segment.</param>
        public MultipleSegmentDownloader(TransferMetadata downloadMetadata, int maxThreadCount, IFrontEndAdapter frontEnd, CancellationToken token, IProgress<SegmentTransferProgress> progressTracker = null)
        {
        ...
        private void DownloadSegment(int segmentNumber, TransferMetadata metadata)
        {
        ...
        /// <param name="metadata">The metadata.</param>
        /// <returns></returns>
        private static Queue<SegmentQueueItem> GetPendingSegmentsToDownload(TransferMetadata metadata)
        {
