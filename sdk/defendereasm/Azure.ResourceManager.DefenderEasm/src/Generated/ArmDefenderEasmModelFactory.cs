...
namespace Azure.ResourceManager.DefenderEasm.Models
{
    ...
    public static partial class ArmDefenderEasmModelFactory
    {
        ...
        public static EasmWorkspaceData EasmWorkspaceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, EasmResourceProvisioningState? provisioningState = null, string dataPlaneEndpoint = null)
        {
            ...
            return new EasmWorkspaceData(id, name, resourceType, systemData, tags, location, provisioningState, dataPlaneEndpoint, new Dictionary<string, BinaryData>());
        }
        ...
        public static EasmWorkspacePatch EasmWorkspacePatch(IDictionary<string, string> tags = null, SystemData systemData = null)
        {
            ...
            return new EasmWorkspacePatch(tags, systemData, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EasmLabelData(id, name, resourceType, systemData, provisioningState, displayName, color, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EasmLabelPatch(id, name, resourceType, systemData, provisioningState, displayName, color, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EasmTask(id, name, resourceType, systemData, provisioningState, startedAt, completedAt, lastPolledAt, state, phase, reason, metadata, new Dictionary<string, BinaryData>());
        }
    }
}
