...
#pragma warning disable SA1649 // File name should match first type name
    internal class DefenderEasmArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of DefenderEasmArmOperation for mocking. </summary>
        protected DefenderEasmArmOperation()
        {
        }

        internal DefenderEasmArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DefenderEasmArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DefenderEasmArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerDefenderEasmContext.Default).ToObjectFromJson<Dictionary<string, string>>();
