...
namespace Azure.ResourceManager.DefenderEasm.Mocking
{
    ...
    public partial class MockableDefenderEasmSubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MockableDefenderEasmSubscriptionResource"/> class for mocking. </summary>
        protected MockableDefenderEasmSubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableDefenderEasmSubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableDefenderEasmSubscriptionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual Pageable<EasmWorkspaceResource> GetEasmWorkspaces(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => EasmWorkspaceWorkspacesRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => EasmWorkspaceWorkspacesRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, (e, o) => new EasmWorkspaceResource(Client, EasmWorkspaceData.DeserializeEasmWorkspaceData(e)), EasmWorkspaceWorkspacesClientDiagnostics, Pipeline, "MockableDefenderEasmSubscriptionResource.GetEasmWorkspaces", "value", "nextLink", cancellationToken);
        }
    }
}
