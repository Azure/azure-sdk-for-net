...
namespace Azure.ResourceManager.DefenderEasm.Mocking
{
    ...
    public partial class DefenderEasmArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DefenderEasmArmClientMockingExtension"/> class for mocking. </summary>
        protected DefenderEasmArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DefenderEasmArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DefenderEasmArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DefenderEasmArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
