...
namespace Azure.ResourceManager.DefenderEasm
{
    ...
    public partial class EasmWorkspaceResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Easm/workspaces/{workspaceName}/tasks/{taskId}</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        public virtual async Task<Response<EasmTask>> GetTaskByWorkspaceAsync(string taskId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _tasksRestClient.GetByWorkspaceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, taskId, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<EasmTask> GetTaskByWorkspace(string taskId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _tasksRestClient.GetByWorkspace(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, taskId, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
