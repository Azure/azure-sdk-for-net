...
namespace Azure.ResourceManager.DefenderEasm.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EasmLabelListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EasmLabelListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EasmLabelListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EasmLabelListResult>)} interface");
            }
        ...
        string IPersistableModel<EasmLabelListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
