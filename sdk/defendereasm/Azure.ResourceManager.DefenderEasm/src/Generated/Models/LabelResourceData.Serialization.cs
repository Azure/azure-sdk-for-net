...
{
    public partial class LabelResourceData : IUtf8JsonSerializable
    {
        ...
        internal static LabelResourceData DeserializeLabelResourceData(JsonElement element)
        {
            ...
            return new LabelResourceData(id, name, type, systemData.Value, Optional.ToNullable(provisioningState), displayName.Value, color.Value);
        }
    }
}
