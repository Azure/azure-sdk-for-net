...
namespace Azure.ResourceManager.DefenderEasm.Models
{
    ...
    public partial class EasmLabelPatch : ResourceData
    {
        ...
        internal EasmLabelPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, EasmResourceProvisioningState? provisioningState, string displayName, string color, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
