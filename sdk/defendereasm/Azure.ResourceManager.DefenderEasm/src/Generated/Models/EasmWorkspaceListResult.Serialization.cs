...
namespace Azure.ResourceManager.DefenderEasm.Models
{
    internal partial class EasmWorkspaceListResult : IUtf8JsonSerializable, IJsonModel<EasmWorkspaceListResult>
    {
        ...
        void IJsonModel<EasmWorkspaceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EasmWorkspaceListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EasmWorkspaceListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EasmWorkspaceListResult)} does not support '{options.Format}' format.");
            }
        }
