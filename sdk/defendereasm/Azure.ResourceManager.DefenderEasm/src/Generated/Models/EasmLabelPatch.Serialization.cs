...
namespace Azure.ResourceManager.DefenderEasm.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EasmLabelPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EasmLabelPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EasmLabelPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EasmLabelPatch>)} interface");
            }
        ...
        string IPersistableModel<EasmLabelPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
