...
{
    public partial class EasmWorkspaceData : IUtf8JsonSerializable, IJsonModel<EasmWorkspaceData>, IPersistableModel<EasmWorkspaceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataPlaneEndpoint))
            {
                ...
                builder.AppendLine($" '{DataPlaneEndpoint}'");
            }
