...
namespace Azure.ResourceManager.DefenderEasm
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EasmWorkspaceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EasmWorkspaceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EasmWorkspaceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EasmWorkspaceData>)} interface");
            }
        ...
        string IPersistableModel<EasmWorkspaceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
