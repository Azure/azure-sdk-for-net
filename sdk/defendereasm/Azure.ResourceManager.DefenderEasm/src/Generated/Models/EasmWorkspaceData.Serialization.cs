...
{
    public partial class EasmWorkspaceData : IUtf8JsonSerializable
    {
        ...
        internal static EasmWorkspaceData DeserializeEasmWorkspaceData(JsonElement element)
        {
            ...
            return new EasmWorkspaceData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(provisioningState), dataPlaneEndpoint.Value);
        }
    }
}
