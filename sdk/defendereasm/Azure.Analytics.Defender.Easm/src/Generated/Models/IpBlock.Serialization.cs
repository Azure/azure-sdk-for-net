...
namespace Azure.Analytics.Defender.Easm.Models
{
    ...
    {
        internal static IpBlock DeserializeIpBlock(JsonElement element)
        {
            ...
            return new IpBlock(ipBlock.Value, Optional.ToList(sources), Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), Optional.ToNullable(recent));
        }
