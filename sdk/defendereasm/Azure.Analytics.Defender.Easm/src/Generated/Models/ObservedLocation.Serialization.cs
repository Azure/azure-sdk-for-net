...
{
    public partial class ObservedLocation
    {
        internal static ObservedLocation DeserializeObservedLocation(JsonElement element)
        {
            ...
            return new ObservedLocation(Optional.ToNullable(firstSeen), Optional.ToNullable(lastSeen), Optional.ToNullable(count), Optional.ToNullable(recent), value.Value, Optional.ToList(sources));
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static ObservedLocation FromResponse(Response response)
        {
