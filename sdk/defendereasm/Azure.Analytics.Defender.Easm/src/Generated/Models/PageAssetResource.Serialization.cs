...
{
    public partial class PageAssetResource
    {
        internal static PageAssetResource DeserializePageAssetResource(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    asset = PageAsset.DeserializePageAsset(property.Value);
                    continue;
                }
