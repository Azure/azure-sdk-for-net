...
namespace Azure.Analytics.Defender.Easm.Models
{
    ...
    public partial class TaskResource
    {
        ...
        internal TaskResource(string id, DateTimeOffset? startedAt, DateTimeOffset? completedAt, DateTimeOffset? lastPolledAt, TaskState? state, TaskPhase? phase, string reason, IReadOnlyDictionary<string, BinaryData> metadata)
        {
            Id = id;
            StartedAt = startedAt;
