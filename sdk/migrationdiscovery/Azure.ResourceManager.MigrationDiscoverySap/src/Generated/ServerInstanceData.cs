...
{
    /// <summary>
    /// A class representing the ServerInstance data model.
    /// Define the Server Instance resource.
    /// </summary>
    public partial class ServerInstanceData : ResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ServerInstanceData"/>. </summary>
        ...
        internal ServerInstanceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string serverName, SapInstanceType? sapInstanceType, string instanceSid, string sapProduct, string sapProductVersion, Models.OperatingSystem? operatingSystem, ConfigurationDetail configurationData, PerformanceDetail performanceData, ProvisioningState? provisioningState, SAPMigrateError errors, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
        ...
        public Models.OperatingSystem? OperatingSystem { get; }
