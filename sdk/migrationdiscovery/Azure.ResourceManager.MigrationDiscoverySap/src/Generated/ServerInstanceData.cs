...
namespace Azure.ResourceManager.MigrationDiscoverySap
{
    ...
    public partial class ServerInstanceData : ResourceData
    {
        ...
        internal ServerInstanceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string serverName, SapInstanceType? sapInstanceType, string instanceSid, string sapProduct, string sapProductVersion, Models.OperatingSystem? operatingSystem, ConfigurationData configurationData, PerformanceData performanceData, ProvisioningState? provisioningState, SAPMigrateError errors, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
