...
namespace Azure.ResourceManager.MigrationDiscoverySap
{
    ...
    public partial class SAPDiscoverySiteData : TrackedResourceData
    {
        ...
        internal SAPDiscoverySiteData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ExtendedLocation extendedLocation, string masterSiteId, string migrateProjectId, ProvisioningState? provisioningState, SAPMigrateError errors, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
