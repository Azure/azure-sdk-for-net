...
{
    public partial class Sample_ServerInstanceResource
    {
        ...
        public async Task Get_GETAServerInstanceResource()
        {
            ...
            // this example assumes you already have this ServerInstanceResource created on azure
            // for more information of creating ServerInstanceResource, please refer to the document of ServerInstanceResource
            ...
            ResourceIdentifier serverInstanceResourceId = ServerInstanceResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, sapDiscoverySiteName, sapInstanceName, serverInstanceName);
            ServerInstanceResource serverInstance = client.GetServerInstanceResource(serverInstanceResourceId);

            // invoke the operation
            ServerInstanceResource result = await serverInstance.GetAsync();
        ...
        public async Task Update_UpdatesTheServerInstanceResource()
        {
            ...
            // invoke the operation
            ServerInstancePatch patch = new ServerInstancePatch()
            {
                Properties = new ServerInstanceProperties(),
            };
            ServerInstanceResource result = await serverInstance.UpdateAsync(patch);
        ...
        public async Task Delete_DeletesTheServerInstanceResource()
        {
            ...
            // invoke the operation
            await serverInstance.DeleteAsync(WaitUntil.Completed);
