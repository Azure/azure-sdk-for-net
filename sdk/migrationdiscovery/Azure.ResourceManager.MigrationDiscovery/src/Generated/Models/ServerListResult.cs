...
namespace Azure.ResourceManager.MigrationDiscovery.Models
{
    ...
    internal partial class ServerListResult
    {
        ...
        internal ServerListResult(IEnumerable<ServerData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ServerListResult(IList<ServerData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<ServerData> Value { get; }
