...
namespace Azure.ResourceManager.MigrationDiscovery.Models
{
    ...
    public partial class DependencyMapDiscovery
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="DependencyMapDiscovery"/>. </summary>
        internal DependencyMapDiscovery()
        {
        ...
        internal DependencyMapDiscovery(DependencyMapDiscoveryScopeStatus? discoveryScopeStatus, IReadOnlyList<HealthErrorDetails> errors, string hydratedRunAsAccountId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public DependencyMapDiscoveryScopeStatus? DiscoveryScopeStatus { get; }
