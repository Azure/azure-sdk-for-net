...
namespace Azure.ResourceManager.MigrationDiscovery
{
    ...
    /// Each <see cref="PrivateLinkResource"/> in the collection will belong to the same instance of <see cref="MasterSiteResource"/>.
    /// To get a <see cref="PrivateLinkResourceCollection"/> instance call the GetPrivateLinkResources method from an instance of <see cref="MasterSiteResource"/>.
    /// </summary>
    ...
    {
        private readonly ClientDiagnostics _privateLinkResourcesControllerClientDiagnostics;
        private readonly PrivateLinkResourcesController _privateLinkResourcesControllerRestClient;
        ...
        internal PrivateLinkResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateLinkResourcesControllerClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MigrationDiscovery", PrivateLinkResource.ResourceType.Namespace, Diagnostics);
            _privateLinkResourcesControllerRestClient = new PrivateLinkResourcesController(_privateLinkResourcesControllerClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, privateLinkResourceApiVersion ?? "2024-12-01-preview");
        ...
        public virtual async Task<Response<PrivateLinkResource>> GetAsync(string privateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateLinkResourcesControllerClientDiagnostics.CreateScope("PrivateLinkResourceCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _privateLinkResourcesControllerRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, privateLinkResourceName, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<MigrationDiscoveryPrivateLinkResourceData> response = Response.FromValue(MigrationDiscoveryPrivateLinkResourceData.FromResponse(result), result);
        ...
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.OffAzure/masterSites/{siteName}/privateLinkResources. </description>
        /// </item>
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> PrivateLinkResources_ListByMasterSite. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2024-12-01-preview. </description>
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateLinkResourcesControllerClientDiagnostics.CreateScope("PrivateLinkResourceCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<MigrationDiscoveryPrivateLinkResourceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(MigrationDiscoveryPrivateLinkResourceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((MigrationDiscoveryPrivateLinkResourceData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<PrivateLinkResource>> GetIfExistsAsync(string privateLinkResourceName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateLinkResourcesControllerClientDiagnostics.CreateScope("PrivateLinkResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
