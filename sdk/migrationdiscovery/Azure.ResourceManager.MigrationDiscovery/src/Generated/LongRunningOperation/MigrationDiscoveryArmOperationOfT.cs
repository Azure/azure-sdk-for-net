...
{
    internal partial class MigrationDiscoveryArmOperation<T> : ArmOperation<T>
    {
        ...
        internal MigrationDiscoveryArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MigrationDiscoveryArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
