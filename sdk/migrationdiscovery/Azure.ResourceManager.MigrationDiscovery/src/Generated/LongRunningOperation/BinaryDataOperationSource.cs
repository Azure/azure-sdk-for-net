...
namespace Azure.ResourceManager.MigrationDiscovery
{
    ...
    internal partial class BinaryDataOperationSource : IOperationSource<BinaryData>
    {
        ...
        BinaryData IOperationSource<BinaryData>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return ModelReaderWriter.Read<BinaryData>(new BinaryData(Encoding.UTF8.GetBytes(document.RootElement.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerMigrationDiscoveryContext.Default);
        }
