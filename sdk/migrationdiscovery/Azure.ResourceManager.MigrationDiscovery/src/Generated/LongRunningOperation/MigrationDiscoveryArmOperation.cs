...
{
    internal partial class MigrationDiscoveryArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of MigrationDiscoveryArmOperation for mocking. </summary>
        protected MigrationDiscoveryArmOperation()
        {
        }
        ...
        internal MigrationDiscoveryArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal MigrationDiscoveryArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(
                ...
                clientDiagnostics,
                response,
                "MigrationDiscoveryArmOperation",
                null,
