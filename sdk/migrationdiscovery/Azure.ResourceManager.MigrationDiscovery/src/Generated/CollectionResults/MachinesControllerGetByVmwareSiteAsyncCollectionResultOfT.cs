...
namespace Azure.ResourceManager.MigrationDiscovery
{
    internal partial class MachinesControllerGetByVmwareSiteAsyncCollectionResultOfT : AsyncPageable<MachineResourceData>
    {
        ...
        /// <summary> Initializes a new instance of MachinesControllerGetByVmwareSiteAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The MachinesController client used to send requests. </param>
        ...
        /// <summary> Gets the pages of MachinesControllerGetByVmwareSiteAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByVmwareSiteRequest(nextLink, _subscriptionId, _resourceGroupName, _siteName, _filter, _maxCount, _continuationToken, _totalRecordCount, _context) : _client.CreateGetByVmwareSiteRequest(_subscriptionId, _resourceGroupName, _siteName, _filter, _maxCount, _continuationToken, _totalRecordCount, _context);
