...
namespace Azure.Provisioning.DurableTask
{
    ...
    public partial class SchedulerPrivateLinkResource : ProvisionableResource
    {
        ...
        public DurableTaskPrivateLinkResourceProperties Properties
        {
            get
            {
                Initialize();
        ...
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<DurableTaskPrivateLinkResourceProperties>(nameof(Properties), new string[] { "properties" });
