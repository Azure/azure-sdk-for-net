...
namespace Azure.Provisioning.DurableTask
{
    ...
    public partial class DurableTaskPrivateEndpointConnectionProperties : ProvisionableConstruct
    {
        ...
        public DurableTaskPrivateLinkServiceConnectionState PrivateLinkServiceConnectionState
        {
            get
            {
                Initialize();
        ...
        public BicepValue<DurableTaskPrivateEndpointConnectionProvisioningState> ProvisioningState
        {
            get
            {
                Initialize();
