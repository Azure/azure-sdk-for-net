# Azure Provisioning DurableTask client library for .NET
...
```dotnetcli
dotnet add package Azure.Provisioning.DurableTask --prerelease
```
...
### Create a Durable Task Scheduler

This example demonstrates how to create a Durable Task Scheduler resource.

```C# Snippet:DurableTaskSchedulerBasic
