...
{
    public partial class Sample_SchedulerTaskHubCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_TaskHubsCreateOrUpdate()
        {
            ...
            // get the collection of this SchedulerTaskHubResource
            ...
            ArmOperation<SchedulerTaskHubResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, taskHubName, data);
        ...
        public async Task Get_TaskHubsGet()
        {
            ...
            // invoke the operation
            string taskHubName = "testtaskhub";
            SchedulerTaskHubResource result = await collection.GetAsync(taskHubName);
        ...
        public async Task GetAll_TaskHubsListByScheduler()
        {
            ...
            await foreach (SchedulerTaskHubResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                SchedulerTaskHubData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_TaskHubsGet()
        {
            ...
            // invoke the operation
            string taskHubName = "testtaskhub";
            NullableResponse<SchedulerTaskHubResource> response = await collection.GetIfExistsAsync(taskHubName);
            SchedulerTaskHubResource result = response.HasValue ? response.Value : null;
