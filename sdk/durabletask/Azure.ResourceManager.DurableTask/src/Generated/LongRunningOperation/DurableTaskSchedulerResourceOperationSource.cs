...
{
    /// <summary></summary>
    internal partial class DurableTaskSchedulerResourceOperationSource : IOperationSource<DurableTaskSchedulerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DurableTaskSchedulerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
