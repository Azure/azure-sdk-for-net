...
{
    /// <summary></summary>
    internal partial class DurableTaskPrivateEndpointConnectionResourceOperationSource : IOperationSource<DurableTaskPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DurableTaskPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
