...
{
    /// <summary></summary>
    internal partial class DurableTaskHubResourceOperationSource : IOperationSource<DurableTaskHubResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DurableTaskHubResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
