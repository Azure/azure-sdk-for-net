...
namespace Azure.ResourceManager.DurableTask
{
    internal partial class DurableTaskArmOperation : ArmOperation
    {
        ...
        internal DurableTaskArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
