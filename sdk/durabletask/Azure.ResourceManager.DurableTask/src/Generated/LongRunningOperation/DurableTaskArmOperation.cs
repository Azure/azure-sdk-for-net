...
#pragma warning disable SA1649 // File name should match first type name
    internal class DurableTaskArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of DurableTaskArmOperation for mocking. </summary>
        protected DurableTaskArmOperation()
        {
        }

        internal DurableTaskArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal DurableTaskArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "DurableTaskArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerDurableTaskContext.Default).ToObjectFromJson<Dictionary<string, string>>();
