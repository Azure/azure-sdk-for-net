...
{
    /// <summary></summary>
    internal partial class DurableTaskRetentionPolicyResourceOperationSource : IOperationSource<DurableTaskRetentionPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DurableTaskRetentionPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
