...
namespace Azure.ResourceManager.DurableTask.Models
{
    ...
    public partial class DurableTaskPrivateLinkServiceConnectionState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DurableTaskPrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal DurableTaskPrivateLinkServiceConnectionState(DurableTaskPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
        ...
        public DurableTaskPrivateEndpointServiceConnectionStatus? Status { get; set; }
