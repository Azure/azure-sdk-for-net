...
{
    public partial class DurableTaskSchedulerPatchProperties : IUtf8JsonSerializable, IJsonModel<DurableTaskSchedulerPatchProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DurableTaskSchedulerPatchProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DurableTaskSchedulerPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        DurableTaskSchedulerPatchProperties IJsonModel<DurableTaskSchedulerPatchProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DurableTaskSchedulerPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static DurableTaskSchedulerPatchProperties DeserializeDurableTaskSchedulerPatchProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DurableTaskSchedulerPatchProperties(provisioningState, endpoint, ipAllowlist ?? new ChangeTrackingList<string>(), sku, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<DurableTaskSchedulerPatchProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DurableTaskSchedulerPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        DurableTaskSchedulerPatchProperties IPersistableModel<DurableTaskSchedulerPatchProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DurableTaskSchedulerPatchProperties>)this).GetFormatFromOptions(options) : options.Format;
