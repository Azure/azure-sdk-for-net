...
namespace Azure.ResourceManager.DurableTask.Models
{
    ...
    public partial class SchedulerPropertiesUpdate
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SchedulerPropertiesUpdate"/>. </summary>
        ...
        internal SchedulerPropertiesUpdate(ProvisioningState? provisioningState, string endpoint, IList<string> ipAllowlist, SchedulerSkuUpdate sku, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
