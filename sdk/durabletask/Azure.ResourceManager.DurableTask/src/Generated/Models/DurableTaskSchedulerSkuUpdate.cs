...
namespace Azure.ResourceManager.DurableTask.Models
{
    ...
    public partial class DurableTaskSchedulerSkuUpdate
    {
        ...
        internal DurableTaskSchedulerSkuUpdate(DurableTaskSchedulerSkuName? name, int? capacity, DurableTaskResourceRedundancyState? redundancyState, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Capacity = capacity;
