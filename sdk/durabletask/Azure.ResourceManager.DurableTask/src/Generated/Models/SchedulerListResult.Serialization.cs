...
namespace Azure.ResourceManager.DurableTask.Models
{
    ...
    internal partial class SchedulerListResult : IJsonModel<SchedulerListResult>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SchedulerListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            foreach (DurableTaskSchedulerData item in Value)
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SchedulerListResult IJsonModel<SchedulerListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SchedulerListResult JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SchedulerListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SchedulerListResult DeserializeSchedulerListResult(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            IList<DurableTaskSchedulerData> value = default;
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SchedulerListResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SchedulerListResult IPersistableModel<SchedulerListResult>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SchedulerListResult PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SchedulerListResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="SchedulerListResult"/> from. </param>
        internal static SchedulerListResult FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeSchedulerListResult(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
