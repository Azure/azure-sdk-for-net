...
namespace Azure.ResourceManager.DurableTask.Models
{
    ...
    internal partial class TaskHubListResult
    {
        ...
        internal TaskHubListResult(IEnumerable<TaskHubData> value)
        {
        ...
        internal TaskHubListResult(IReadOnlyList<TaskHubData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<TaskHubData> Value { get; }
