...
namespace Azure.ResourceManager.DurableTask.Models
{
    ...
    internal partial class TaskHubListResult
    {
        ...
        internal TaskHubListResult(IReadOnlyList<DurableTaskHubData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<DurableTaskHubData> Value { get; }
