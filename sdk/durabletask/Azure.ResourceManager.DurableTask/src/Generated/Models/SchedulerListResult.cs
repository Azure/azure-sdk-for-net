...
namespace Azure.ResourceManager.DurableTask.Models
{
    ...
    internal partial class SchedulerListResult
    {
        ...
        internal SchedulerListResult(IList<DurableTaskSchedulerData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<DurableTaskSchedulerData> Value { get; }
