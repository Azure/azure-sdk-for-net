...
namespace Azure.ResourceManager.DurableTask.Models
{
    ...
    public partial class DurableTaskSchedulerProperties
    {
        ...
        internal DurableTaskSchedulerProperties(DurableTaskProvisioningState? provisioningState, string endpoint, IList<string> ipAllowlist, DurableTaskSchedulerSku sku, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
