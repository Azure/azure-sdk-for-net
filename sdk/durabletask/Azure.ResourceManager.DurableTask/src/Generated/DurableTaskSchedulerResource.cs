...
namespace Azure.ResourceManager.DurableTask
{
    ...
    public partial class DurableTaskSchedulerResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the DurableTaskScheduler.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DurableTask/schedulers/{schedulerName}. </description>
        ...
        public virtual async Task<ArmOperation<DurableTaskSchedulerResource>> UpdateAsync(WaitUntil waitUntil, DurableTaskSchedulerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _schedulersRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DurableTaskSchedulerData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DurableTaskArmOperation<DurableTaskSchedulerResource> operation = new DurableTaskArmOperation<DurableTaskSchedulerResource>(
                    new DurableTaskSchedulerResourceOperationSource(Client),
                    _schedulersClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DurableTaskSchedulerResource> Update(WaitUntil waitUntil, DurableTaskSchedulerData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
