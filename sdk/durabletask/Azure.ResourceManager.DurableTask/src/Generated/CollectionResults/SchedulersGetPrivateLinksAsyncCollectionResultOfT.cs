...
namespace Azure.ResourceManager.DurableTask
{
    internal partial class SchedulersGetPrivateLinksAsyncCollectionResultOfT : AsyncPageable<DurableTaskSchedulerPrivateLinkResourceData>
    {
        ...
        public SchedulersGetPrivateLinksAsyncCollectionResultOfT(Schedulers client, Guid subscriptionId, string resourceGroupName, string schedulerName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
