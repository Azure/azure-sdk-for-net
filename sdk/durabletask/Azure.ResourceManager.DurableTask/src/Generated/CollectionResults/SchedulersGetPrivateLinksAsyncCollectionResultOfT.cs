...
namespace Azure.ResourceManager.DurableTask
{
    internal partial class SchedulersGetPrivateLinksAsyncCollectionResultOfT : AsyncPageable<DurableTaskSchedulerPrivateLinkResourceData>
    {
        ...
        /// <summary> Initializes a new instance of SchedulersGetPrivateLinksAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SchedulersGetPrivateLinksAsyncCollectionResultOfT(Schedulers client, Guid subscriptionId, string resourceGroupName, string schedulerName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of SchedulersGetPrivateLinksAsyncCollectionResultOfT as an enumerable collection. </summary>
