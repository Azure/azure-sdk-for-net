...
namespace Azure.ResourceManager.DurableTask.Models
{
    ...
    public static partial class ArmDurableTaskModelFactory
    {
        ...
        public static DurableTaskSchedulerData DurableTaskSchedulerData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, DurableTaskSchedulerProperties properties = default, string name0 = default)
        {
