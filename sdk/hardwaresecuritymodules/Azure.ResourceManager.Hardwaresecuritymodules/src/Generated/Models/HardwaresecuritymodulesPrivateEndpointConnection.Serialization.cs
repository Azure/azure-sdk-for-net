...
{
    public partial class HardwaresecuritymodulesPrivateEndpointConnection : IUtf8JsonSerializable
    {
        ...
        internal static HardwaresecuritymodulesPrivateEndpointConnection DeserializeHardwaresecuritymodulesPrivateEndpointConnection(JsonElement element)
        {
            ...
            return new HardwaresecuritymodulesPrivateEndpointConnection(id, name, type, systemData.Value, Optional.ToNullable(etag), privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState), Optional.ToList(groupIds));
        }
    }
}
