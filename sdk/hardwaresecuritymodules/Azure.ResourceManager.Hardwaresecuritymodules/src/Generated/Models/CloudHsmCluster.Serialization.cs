...
{
    public partial class CloudHsmCluster : IUtf8JsonSerializable
    {
        ...
        internal static CloudHsmCluster DeserializeCloudHsmCluster(JsonElement element)
        {
            ...
            Optional<IList<HardwaresecuritymodulesPrivateEndpointConnection>> privateEndpointConnections = default;
            ...
            return new CloudHsmCluster(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(provisioningState), autoGeneratedDomainNameLabelScope.Value, securityDomain.Value, Optional.ToList(hsms), publicNetworkAccess.Value, Optional.ToList(privateEndpointConnections), sku.Value);
        }
    }
}
