...
namespace Azure.ResourceManager.Hardwaresecuritymodules
{
    ...
    internal partial class SubscriptionResourceExtensionClient : ArmResource
    {
        ...
        public virtual AsyncPageable<CloudHsmCluster> GetCloudHsmClustersBySubscriptionAsync(string skiptoken = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CloudHsmClustersRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId, skiptoken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CloudHsmClustersRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId, skiptoken);
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, CloudHsmCluster.DeserializeCloudHsmCluster, CloudHsmClustersClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetCloudHsmClustersBySubscription", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<CloudHsmCluster> GetCloudHsmClustersBySubscription(string skiptoken = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CloudHsmClustersRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId, skiptoken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CloudHsmClustersRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId, skiptoken);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, CloudHsmCluster.DeserializeCloudHsmCluster, CloudHsmClustersClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetCloudHsmClustersBySubscription", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<DedicatedHsmResource> GetDedicatedHsmsAsync(int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DedicatedHsmResource(Client, DedicatedHsmData.DeserializeDedicatedHsmData(e)), DedicatedHsmClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetDedicatedHsms", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DedicatedHsmResource> GetDedicatedHsms(int? top = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DedicatedHsmRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId, top);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DedicatedHsmRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId, top);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DedicatedHsmResource(Client, DedicatedHsmData.DeserializeDedicatedHsmData(e)), DedicatedHsmClientDiagnostics, Pipeline, "SubscriptionResourceExtensionClient.GetDedicatedHsms", "value", "nextLink", cancellationToken);
        }
    }
}
