...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    ...
    public partial class PaymentHsmClusterResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<PaymentHsmClusterResource>> UpdateAsync(WaitUntil waitUntil, PaymentHsmClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _paymentHsmClustersRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, PaymentHsmClusterData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HardwareSecurityModulesArmOperation<PaymentHsmClusterResource> operation = new HardwareSecurityModulesArmOperation<PaymentHsmClusterResource>(
                    new PaymentHsmClusterResourceOperationSource(Client),
                    _paymentHsmClustersClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PaymentHsmClusterResource> Update(WaitUntil waitUntil, PaymentHsmClusterData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
