...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    ...
    public partial class CloudHsmClusterResource : ArmResource
    {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="HardwareSecurityModulesHardwareSecurityModulesPrivateLinkData"/> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<HardwareSecurityModulesHardwareSecurityModulesPrivateLinkData> GetCloudHsmClusterPrivateLinkResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => HardwareSecurityModulesHardwareSecurityModulesPrivateLinkData.DeserializeHardwareSecurityModulesHardwareSecurityModulesPrivateLinkData(e), _cloudHsmClusterPrivateLinkResourcesClientDiagnostics, Pipeline, "CloudHsmClusterResource.GetCloudHsmClusterPrivateLinkResources", "value", null, cancellationToken);
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="HardwareSecurityModulesHardwareSecurityModulesPrivateLinkData"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<HardwareSecurityModulesHardwareSecurityModulesPrivateLinkData> GetCloudHsmClusterPrivateLinkResources(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _cloudHsmClusterPrivateLinkResourcesRestClient.CreateListByCloudHsmClusterRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => HardwareSecurityModulesHardwareSecurityModulesPrivateLinkData.DeserializeHardwareSecurityModulesHardwareSecurityModulesPrivateLinkData(e), _cloudHsmClusterPrivateLinkResourcesClientDiagnostics, Pipeline, "CloudHsmClusterResource.GetCloudHsmClusterPrivateLinkResources", "value", null, cancellationToken);
        }
