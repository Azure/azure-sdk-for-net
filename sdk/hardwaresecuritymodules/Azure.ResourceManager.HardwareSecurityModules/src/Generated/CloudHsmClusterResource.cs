...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    ...
    public partial class CloudHsmClusterResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<CloudHsmClusterResource>> UpdateAsync(WaitUntil waitUntil, CloudHsmClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _cloudHsmClustersRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CloudHsmClusterData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HardwareSecurityModulesArmOperation<CloudHsmClusterResource> operation = new HardwareSecurityModulesArmOperation<CloudHsmClusterResource>(
                    new CloudHsmClusterResourceOperationSource(Client),
                    _cloudHsmClustersClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<CloudHsmClusterResource> Update(WaitUntil waitUntil, CloudHsmClusterData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
