...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    ...
    public partial class CloudHsmClusterResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<CloudHsmClusterBackupResult>> ValidateBackupPropertiesAsync(WaitUntil waitUntil, CloudHsmClusterBackupContent backupRequestProperties = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _cloudHsmClustersRestClient.CreateValidateBackupPropertiesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CloudHsmClusterBackupContent.ToRequestContent(backupRequestProperties), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="backupRequestProperties"> Backup Operation Required properties. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<CloudHsmClusterBackupResult> ValidateBackupProperties(WaitUntil waitUntil, CloudHsmClusterBackupContent backupRequestProperties = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _cloudHsmClustersClientDiagnostics.CreateScope("CloudHsmClusterResource.ValidateBackupProperties");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<CloudHsmClusterBackupResult>> BackupAsync(WaitUntil waitUntil, CloudHsmClusterBackupContent backupRequestProperties = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _cloudHsmClustersRestClient.CreateBackupRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CloudHsmClusterBackupContent.ToRequestContent(backupRequestProperties), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HardwareSecurityModulesArmOperation<CloudHsmClusterBackupResult> operation = new HardwareSecurityModulesArmOperation<CloudHsmClusterBackupResult>(
                    new CloudHsmClusterBackupResultOperationSource(),
                    _cloudHsmClustersClientDiagnostics,
        ...
        /// <param name="backupRequestProperties"> Azure storage Resource Uri. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<CloudHsmClusterBackupResult> Backup(WaitUntil waitUntil, CloudHsmClusterBackupContent backupRequestProperties = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _cloudHsmClustersClientDiagnostics.CreateScope("CloudHsmClusterResource.Backup");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<CloudHsmClusterRestoreResult>> ValidateRestorePropertiesAsync(WaitUntil waitUntil, CloudHsmClusterRestoreContent restoreRequestProperties = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _cloudHsmClustersRestClient.CreateValidateRestorePropertiesRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CloudHsmClusterRestoreContent.ToRequestContent(restoreRequestProperties), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="restoreRequestProperties"> Optional Parameters to validate prior performing a restore operation. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<CloudHsmClusterRestoreResult> ValidateRestoreProperties(WaitUntil waitUntil, CloudHsmClusterRestoreContent restoreRequestProperties = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _cloudHsmClustersClientDiagnostics.CreateScope("CloudHsmClusterResource.ValidateRestoreProperties");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<CloudHsmClusterPrivateLinkData> GetByCloudHsmClusterAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new CloudHsmClusterPrivateLinkResourcesGetByCloudHsmClusterAsyncCollectionResultOfT(_cloudHsmClusterPrivateLinkResourcesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="CloudHsmClusterPrivateLinkData"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<CloudHsmClusterPrivateLinkData> GetByCloudHsmCluster(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new CloudHsmClusterPrivateLinkResourcesGetByCloudHsmClusterCollectionResultOfT(_cloudHsmClusterPrivateLinkResourcesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context);
        }
