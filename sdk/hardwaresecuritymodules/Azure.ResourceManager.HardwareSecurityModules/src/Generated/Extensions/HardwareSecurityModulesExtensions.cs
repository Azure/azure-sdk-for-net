...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    ...
    public static partial class HardwareSecurityModulesExtensions
    {
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableHardwareSecurityModulesResourceGroupResource.GetCloudHsmClusterBackupStatusAsync(string, string, CancellationToken)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource"/> the method will execute against. </param>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupResource"/> is null. </exception>
        public static async Task<Response<CloudHsmClusterBackupResult>> GetCloudHsmClusterBackupStatusAsync(this ResourceGroupResource resourceGroupResource, string cloudHsmClusterName, string jobId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceGroupResource, nameof(resourceGroupResource));

            return await GetMockableHardwareSecurityModulesResourceGroupResource(resourceGroupResource).GetCloudHsmClusterBackupStatusAsync(cloudHsmClusterName, jobId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableHardwareSecurityModulesResourceGroupResource.GetCloudHsmClusterBackupStatus(string, string, CancellationToken)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource"/> the method will execute against. </param>
        /// <param name="cloudHsmClusterName"></param>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupResource"/> is null. </exception>
        public static Response<CloudHsmClusterBackupResult> GetCloudHsmClusterBackupStatus(this ResourceGroupResource resourceGroupResource, string cloudHsmClusterName, string jobId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceGroupResource, nameof(resourceGroupResource));

            return GetMockableHardwareSecurityModulesResourceGroupResource(resourceGroupResource).GetCloudHsmClusterBackupStatus(cloudHsmClusterName, jobId, cancellationToken);
        }
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableHardwareSecurityModulesResourceGroupResource.GetCloudHsmClusterRestoreStatusAsync(string, string, CancellationToken)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource"/> the method will execute against. </param>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupResource"/> is null. </exception>
        public static async Task<Response<CloudHsmClusterRestoreResult>> GetCloudHsmClusterRestoreStatusAsync(this ResourceGroupResource resourceGroupResource, string cloudHsmClusterName, string jobId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceGroupResource, nameof(resourceGroupResource));

            return await GetMockableHardwareSecurityModulesResourceGroupResource(resourceGroupResource).GetCloudHsmClusterRestoreStatusAsync(cloudHsmClusterName, jobId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableHardwareSecurityModulesResourceGroupResource.GetCloudHsmClusterRestoreStatus(string, string, CancellationToken)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="resourceGroupResource"> The <see cref="ResourceGroupResource"/> the method will execute against. </param>
        /// <param name="cloudHsmClusterName"> Name of the Cloud HSM Cluster. </param>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupResource"/> is null. </exception>
        public static Response<CloudHsmClusterRestoreResult> GetCloudHsmClusterRestoreStatus(this ResourceGroupResource resourceGroupResource, string cloudHsmClusterName, string jobId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(resourceGroupResource, nameof(resourceGroupResource));

            return GetMockableHardwareSecurityModulesResourceGroupResource(resourceGroupResource).GetCloudHsmClusterRestoreStatus(cloudHsmClusterName, jobId, cancellationToken);
        }
