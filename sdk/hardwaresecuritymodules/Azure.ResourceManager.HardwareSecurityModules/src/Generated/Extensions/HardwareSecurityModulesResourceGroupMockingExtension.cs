...
namespace Azure.ResourceManager.HardwareSecurityModules.Mocking
{
    ...
    public partial class HardwareSecurityModulesResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="HardwareSecurityModulesResourceGroupMockingExtension"/> class for mocking. </summary>
        protected HardwareSecurityModulesResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="HardwareSecurityModulesResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal HardwareSecurityModulesResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
