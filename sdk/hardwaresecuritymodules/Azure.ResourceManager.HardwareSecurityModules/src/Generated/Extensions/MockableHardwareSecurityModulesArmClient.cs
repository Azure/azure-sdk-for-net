...
namespace Azure.ResourceManager.HardwareSecurityModules.Mocking
{
    ...
    {
        /// <summary> Initializes a new instance of MockableHardwareSecurityModulesArmClient for mocking. </summary>
        protected MockableHardwareSecurityModulesArmClient()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableHardwareSecurityModulesArmClient"/> class. </summary>
        ...
        /// <summary> Gets an object representing a <see cref="CloudHsmClusterResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        ...
        /// <summary> Gets an object representing a <see cref="CloudHsmClusterPrivateEndpointConnectionResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        /// <summary> Gets an object representing a <see cref="DedicatedHsmResource"/> along with the instance operations that can be performed on it but with no data. </summary>
        /// <param name="id"> The resource ID of the resource to get. </param>
