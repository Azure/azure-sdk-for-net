...
{
    internal partial class HardwareSecurityModulesArmOperation<T> : ArmOperation<T>
    {
        ...
        internal HardwareSecurityModulesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "HardwareSecurityModulesArmOperation",
                null,
