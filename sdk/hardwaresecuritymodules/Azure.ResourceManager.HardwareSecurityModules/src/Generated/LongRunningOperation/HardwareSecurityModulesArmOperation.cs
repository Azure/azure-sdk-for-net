...
#pragma warning disable SA1649 // File name should match first type name
    internal class HardwareSecurityModulesArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal HardwareSecurityModulesArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal HardwareSecurityModulesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "HardwareSecurityModulesArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
