...
{
    /// <summary></summary>
    internal partial class CloudHsmClusterResourceOperationSource : IOperationSource<CloudHsmClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CloudHsmClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
