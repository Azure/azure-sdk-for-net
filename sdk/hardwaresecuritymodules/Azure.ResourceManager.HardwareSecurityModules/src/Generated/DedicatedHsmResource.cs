...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    ...
    public partial class DedicatedHsmResource : ArmResource
    {
        ...
        /// <param name="dedicatedHsmPatch"> Parameters to patch the dedicated HSM. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="dedicatedHsmPatch"/> is null. </exception>
        public virtual async Task<ArmOperation<DedicatedHsmResource>> UpdateAsync(WaitUntil waitUntil, DedicatedHsmPatch dedicatedHsmPatch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(dedicatedHsmPatch, nameof(dedicatedHsmPatch));
            ...
            try
            {
                ...
                HttpMessage message = _dedicatedHsmsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DedicatedHsmPatch.ToRequestContent(dedicatedHsmPatch), context);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="dedicatedHsmPatch"/> is null. </exception>
        public virtual ArmOperation<DedicatedHsmResource> Update(WaitUntil waitUntil, DedicatedHsmPatch dedicatedHsmPatch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(dedicatedHsmPatch, nameof(dedicatedHsmPatch));
