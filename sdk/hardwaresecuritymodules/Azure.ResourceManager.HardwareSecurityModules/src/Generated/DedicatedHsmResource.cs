...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    ...
    public partial class DedicatedHsmResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DedicatedHsmResource>> UpdateAsync(WaitUntil waitUntil, DedicatedHsmData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dedicatedHsmsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DedicatedHsmData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                HardwareSecurityModulesArmOperation<DedicatedHsmResource> operation = new HardwareSecurityModulesArmOperation<DedicatedHsmResource>(
                    new DedicatedHsmResourceOperationSource(Client),
                    _dedicatedHsmsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DedicatedHsmResource> Update(WaitUntil waitUntil, DedicatedHsmData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
