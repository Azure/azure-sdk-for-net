...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    public static partial class ArmHardwareSecurityModulesModelFactory
    {
        ...
        public static CloudHsmClusterProperties CloudHsmClusterProperties(SecurityDomainActivationState? activationState = null, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope = null, IEnumerable<CloudHsmProperties> hsms = null, IEnumerable<CloudHsmClusterPrivateEndpointConnection> privateEndpointConnections = null, CloudHsmClusterProvisioningState? provisioningState = null, CloudHsmClusterPublicNetworkAccess? publicNetworkAccess = null, string statusMessage = null)
        {
            hsms ??= new List<CloudHsmProperties>();
            privateEndpointConnections ??= new List<CloudHsmClusterPrivateEndpointConnection>();
        ...
        /// <summary> Initializes a new instance of <see cref="Models.CloudHsmClusterPrivateEndpointConnection"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="Models.CloudHsmClusterPrivateEndpointConnection"/> instance for mocking. </returns>
        public static CloudHsmClusterPrivateEndpointConnection CloudHsmClusterPrivateEndpointConnection(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, CloudHsmClusterPrivateEndpointConnectionProperties properties = null, ETag? etag = null)
        {
