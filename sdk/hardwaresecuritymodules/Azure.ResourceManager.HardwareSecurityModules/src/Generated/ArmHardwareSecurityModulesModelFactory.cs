    ...
    public static partial class ArmHardwareSecurityModulesModelFactory
    {
        ...
        public static CloudHsmClusterProperties CloudHsmClusterProperties(SecurityDomainActivationState? activationState = default, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope = default, IEnumerable<CloudHsmProperties> hsms = default, IEnumerable<CloudHsmClusterPrivateEndpointConnectionData> privateEndpointConnections = default, CloudHsmClusterProvisioningState? provisioningState = default, CloudHsmClusterPublicNetworkAccess? publicNetworkAccess = default, string statusMessage = default)
        {
            ...
            return new CloudHsmClusterProperties(
                ...
                (hsms ?? new ChangeTrackingList<CloudHsmProperties>()).ToList(),
                (privateEndpointConnections ?? new ChangeTrackingList<CloudHsmClusterPrivateEndpointConnectionData>()).ToList(),
                provisioningState,
                publicNetworkAccess,
                statusMessage,
                default);
        ...
        {
            return new CloudHsmProperties(fqdn, state, stateMessage, default);
        }
        ...
        public static CloudHsmClusterPrivateEndpointConnectionProperties CloudHsmClusterPrivateEndpointConnectionProperties(ResourceIdentifier privateEndpointId = default, CloudHsmClusterPrivateLinkServiceConnectionState connectionState = default, CloudHsmClusterPrivateEndpointConnectionProvisioningState? provisioningState = default, IEnumerable<string> groupIds = default)
        {
            ...
            return new CloudHsmClusterPrivateEndpointConnectionProperties(privateEndpointId is null ? default : new PrivateEndpoint(privateEndpointId, default), connectionState, provisioningState, (groupIds ?? new ChangeTrackingList<string>()).ToList(), default);
        }
        ...
        /// <returns> A new <see cref="Models.CloudHsmClusterPrivateLinkServiceConnectionState"/> instance for mocking. </returns>
        public static CloudHsmClusterPrivateLinkServiceConnectionState CloudHsmClusterPrivateLinkServiceConnectionState(CloudHsmClusterPrivateEndpointServiceConnectionStatus? status = default, string description = default, string actionsRequired = default)
        {
            return new CloudHsmClusterPrivateLinkServiceConnectionState(status, description, actionsRequired, default);
        }
        ...
        /// <returns> A new <see cref="Models.CloudHsmClusterSku"/> instance for mocking. </returns>
        public static CloudHsmClusterSku CloudHsmClusterSku(CloudHsmClusterSkuFamily family = default, CloudHsmClusterSkuName name = default, int? capacity = default)
        {
            return new CloudHsmClusterSku(family, name, capacity, default);
        }
        ...
        public static CloudHsmClusterPatch CloudHsmClusterPatch(IDictionary<string, string> tags = default, ManagedServiceIdentity identity = default)
        {
            ...
            return new CloudHsmClusterPatch(tags ?? new ChangeTrackingDictionary<string, string>(), identity, default);
        }
        ...
        {
            return new CloudHsmClusterBackupContent(azureStorageBlobContainerUri, token, default);
        }
        ...
        {
            return new BackupRestoreRequestBaseProperties(azureStorageBlobContainerUri, token, default);
        }
        ...
        {
            return new CloudHsmClusterBackupResult(properties, default);
        }
        ...
        {
            return new CloudHsmClusterRestoreContent(azureStorageBlobContainerUri, token, default, backupId);
        }
        ...
        {
            return new CloudHsmClusterRestoreResult(properties, default);
        }
        ...
        public static DedicatedHsmData DedicatedHsmData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, DedicatedHsmProperties properties = default, DedicatedHsmSkuName? skuName = default, IEnumerable<string> zones = default)
        {
            ...
            return new DedicatedHsmData(
                ...
                location,
                properties,
                skuName is null ? default : new DedicatedHsmSku(skuName, default),
        ...
        public static DedicatedHsmNetworkProfile DedicatedHsmNetworkProfile(ResourceIdentifier subnetResourceId = default, IEnumerable<DedicatedHsmNetworkInterface> networkInterfaces = default)
        {
            ...
            return new DedicatedHsmNetworkProfile(subnetResourceId is null ? default : new ApiEntityReference(subnetResourceId, default), (networkInterfaces ?? new ChangeTrackingList<DedicatedHsmNetworkInterface>()).ToList(), default);
        }
        ...
        {
            return new DedicatedHsmNetworkInterface(resourceId, privateIPAddress, default);
        }

        /// <summary> SKU of the dedicated HSM. </summary>
        /// <param name="name"> SKU of the dedicated HSM. </param>
        /// <returns> A new <see cref="Models.DedicatedHsmSku"/> instance for mocking. </returns>
        public static DedicatedHsmSku DedicatedHsmSku(DedicatedHsmSkuName? name = default)
        {
            return new DedicatedHsmSku(name, default);
        }
        ...
        public static DedicatedHsmPatch DedicatedHsmPatch(IDictionary<string, string> tags = default)
        {
            ...
            return new DedicatedHsmPatch(tags ?? new ChangeTrackingDictionary<string, string>(), default);
        }
        ...
        public static DedicatedHsmEgressEndpoint DedicatedHsmEgressEndpoint(string category = default, IEnumerable<DedicatedHsmEndpointDependency> endpoints = default)
        {
            ...
            return new DedicatedHsmEgressEndpoint(category, (endpoints ?? new ChangeTrackingList<DedicatedHsmEndpointDependency>()).ToList(), default);
        }
        ...
        public static DedicatedHsmEndpointDependency DedicatedHsmEndpointDependency(string domainName = default, IEnumerable<DedicatedHsmEndpointDetail> endpointDetails = default)
        {
            ...
            return new DedicatedHsmEndpointDependency(domainName, (endpointDetails ?? new ChangeTrackingList<DedicatedHsmEndpointDetail>()).ToList(), default);
        }
        ...
        {
            return new DedicatedHsmEndpointDetail(ipAddress, port, protocol, description, default);
        }
        ...
        /// <param name="sku"> SKU details. </param>
        /// <returns> A new <see cref="HardwareSecurityModules.PaymentHsmClusterData"/> instance for mocking. </returns>
        public static PaymentHsmClusterData PaymentHsmClusterData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, PaymentHsmClusterProperties properties = default, PaymentHsmClusterSku sku = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        /// <returns> A new <see cref="Models.PaymentHsmClusterProperties"/> instance for mocking. </returns>
        public static PaymentHsmClusterProperties PaymentHsmClusterProperties(SecurityDomainActivationState? activationState = default, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope = default, IEnumerable<PaymentHsmProperties> hsms = default, IEnumerable<PaymentHsmClusterPrivateEndpointConnectionData> privateEndpointConnections = default, CloudHsmClusterProvisioningState? provisioningState = default, CloudHsmClusterPublicNetworkAccess? publicNetworkAccess = default, string statusMessage = default, string applicationTrustedIssuer = default, string managementTrustedIssuer = default)
        {
            ...
            return new PaymentHsmClusterProperties(
                activationState,
                autoGeneratedDomainNameLabelScope,
                (hsms ?? new ChangeTrackingList<PaymentHsmProperties>()).ToList(),
                (privateEndpointConnections ?? new ChangeTrackingList<PaymentHsmClusterPrivateEndpointConnectionData>()).ToList(),
                provisioningState,
                publicNetworkAccess,
                statusMessage,
        ...
        /// <param name="capacity"> Sku capacity. </param>
        /// <returns> A new <see cref="Models.PaymentHsmClusterSku"/> instance for mocking. </returns>
        public static PaymentHsmClusterSku PaymentHsmClusterSku(PaymentHsmClusterSkuFamily family = default, PaymentHsmClusterSkuName name = default, int? capacity = default)
        {
            return new PaymentHsmClusterSku(family, name, capacity, default);
        }

        /// <summary> Patchable properties of the Payment HSM Cluster. </summary>
        /// <param name="tags"> Resource tags. </param>
        /// <returns> A new <see cref="Models.PaymentHsmClusterPatch"/> instance for mocking. </returns>
        public static PaymentHsmClusterPatch PaymentHsmClusterPatch(IDictionary<string, string> tags = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();

            return new PaymentHsmClusterPatch(tags ?? new ChangeTrackingDictionary<string, string>(), default);
        }
