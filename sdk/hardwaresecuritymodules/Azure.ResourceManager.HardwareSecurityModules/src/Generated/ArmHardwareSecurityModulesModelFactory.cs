...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    public static partial class ArmHardwareSecurityModulesModelFactory
    {
        ...
        public static CloudHsmClusterProperties CloudHsmClusterProperties(ActivationState? activationState = null, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope = null, bool? fipsApprovedMode = null, IEnumerable<CloudHsmProperties> hsms = null, IEnumerable<HardwareSecurityModulesPrivateEndpointConnectionData> privateEndpointConnections = null, ProvisioningState? provisioningState = null, PublicNetworkAccess? publicNetworkAccess = null, string statusMessage = null)
        {
        ...
        public static BackupResult BackupResult(BackupResultProperties properties = null)
        {
            return new BackupResult(properties, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Models.BackupResultProperties"/>. </summary>
        ...
        /// <returns> A new <see cref="Models.BackupResultProperties"/> instance for mocking. </returns>
        public static BackupResultProperties BackupResultProperties(BackupRestoreOperationStatus? status = null, string statusDetails = null, ResponseError error = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, string jobId = null, Uri azureStorageBlobContainerUri = null, string backupId = null)
        {
