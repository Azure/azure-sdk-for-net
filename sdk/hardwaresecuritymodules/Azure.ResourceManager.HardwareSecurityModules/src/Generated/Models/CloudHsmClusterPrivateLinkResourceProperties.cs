...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    public partial class CloudHsmClusterPrivateLinkResourceProperties
    {
        ...
        internal CloudHsmClusterPrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, IList<string> requiredZoneNames, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            GroupId = groupId;
