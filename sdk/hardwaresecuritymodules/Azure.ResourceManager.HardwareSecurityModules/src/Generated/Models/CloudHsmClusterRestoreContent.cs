...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    public partial class CloudHsmClusterRestoreContent : BackupRestoreRequestBaseProperties
    {
        ...
        /// <param name="backupId"> An autogenerated unique string ID for labeling the backup. It contains both a UUID and a date timestamp. </param>
        internal CloudHsmClusterRestoreContent(Uri azureStorageBlobContainerUri, string token, IDictionary<string, BinaryData> additionalBinaryDataProperties, string backupId) : base(azureStorageBlobContainerUri, token, additionalBinaryDataProperties)
        {
            BackupId = backupId;
        }
