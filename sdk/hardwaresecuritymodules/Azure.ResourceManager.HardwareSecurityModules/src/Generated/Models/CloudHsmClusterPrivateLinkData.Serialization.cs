    ...
    public partial class CloudHsmClusterPrivateLinkData : IUtf8JsonSerializable, IJsonModel<CloudHsmClusterPrivateLinkData>
    {
        ...
        internal static CloudHsmClusterPrivateLinkData DeserializeCloudHsmClusterPrivateLinkData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.HardwareSecurityModules.ModelSerializationExtensions.WireOptions, AzureResourceManagerHardwareSecurityModulesContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerHardwareSecurityModulesContext.Default)
#endif
;
                    continue;
                }
