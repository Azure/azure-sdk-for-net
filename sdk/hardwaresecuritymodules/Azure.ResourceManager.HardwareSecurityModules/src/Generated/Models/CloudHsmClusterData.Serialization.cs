...
{
    public partial class CloudHsmClusterData : IUtf8JsonSerializable, IJsonModel<CloudHsmClusterData>, IPersistableModel<CloudHsmClusterData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AutoGeneratedDomainNameLabelScope))
            {
                ...
                builder.AppendLine($" '{AutoGeneratedDomainNameLabelScope}'");
            }

            if (Optional.IsDefined(SecurityDomain))
            {
                builder.Append("  securityDomain:");
                AppendChildObject(builder, SecurityDomain, options, 2);
            }
            ...
            if (Optional.IsDefined(RestoreProperties))
            {
                builder.Append("  restoreProperties:");
                AppendChildObject(builder, RestoreProperties, options, 2);
            }

            if (Optional.IsDefined(BackupProperties))
            {
                builder.Append("  backupProperties:");
                AppendChildObject(builder, BackupProperties, options, 2);
            }
