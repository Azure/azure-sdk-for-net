...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudHsmClusterData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudHsmClusterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudHsmClusterData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudHsmClusterData>)} interface");
            }
        ...
        string IPersistableModel<CloudHsmClusterData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
