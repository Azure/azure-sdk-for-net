    ...
    public partial class CloudHsmClusterData : IUtf8JsonSerializable, IJsonModel<CloudHsmClusterData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AutoGeneratedDomainNameLabelScope))
            {
                ...
                if (AutoGeneratedDomainNameLabelScope.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(SecurityDomain))
            {
                ...
                AppendChildObject(builder, SecurityDomain, options, 4, false);
            }
            ...
            if (Optional.IsDefined(RestoreProperties))
            {
                ...
                AppendChildObject(builder, RestoreProperties, options, 4, false);
            }

            if (Optional.IsDefined(BackupProperties))
            {
                builder.Append("    backupProperties:");
                AppendChildObject(builder, BackupProperties, options, 4, false);
            }
