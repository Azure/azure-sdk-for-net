...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    public partial class CloudHsmClusterProperties
    {
        ...
        internal CloudHsmClusterProperties(ActivationState? activationState, string autoGeneratedDomainNameLabelScope, bool? fipsApprovedMode, IReadOnlyList<CloudHsmProperties> hsms, IReadOnlyList<HardwareSecurityModulesPrivateEndpointConnectionData> privateEndpointConnections, ProvisioningState? provisioningState, string publicNetworkAccess, string statusMessage, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
        ...
        /// <summary> False: Non-FIPS Mode with single-factor authentication. True: FIPS Approved Mode with single-factor authentication. </summary>
