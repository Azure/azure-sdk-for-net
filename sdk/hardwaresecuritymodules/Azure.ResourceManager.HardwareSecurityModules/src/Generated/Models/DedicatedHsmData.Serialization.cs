...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHsmData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DedicatedHsmData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DedicatedHsmData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DedicatedHsmData>)} interface");
            }
        ...
        string IPersistableModel<DedicatedHsmData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
