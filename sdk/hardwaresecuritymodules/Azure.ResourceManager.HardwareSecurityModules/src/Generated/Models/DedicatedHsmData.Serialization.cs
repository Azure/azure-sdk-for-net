...
{
    public partial class DedicatedHsmData : IUtf8JsonSerializable, IJsonModel<DedicatedHsmData>, IPersistableModel<DedicatedHsmData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ManagementNetworkProfile))
            {
                ...
                AppendChildObject(builder, ManagementNetworkProfile, options, 2);
            }
