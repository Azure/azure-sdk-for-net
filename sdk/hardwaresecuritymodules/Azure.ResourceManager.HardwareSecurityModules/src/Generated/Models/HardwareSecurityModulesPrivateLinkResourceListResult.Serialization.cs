...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HardwareSecurityModulesPrivateLinkResourceListResult>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        HardwareSecurityModulesPrivateLinkResourceListResult IJsonModel<HardwareSecurityModulesPrivateLinkResourceListResult>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<HardwareSecurityModulesPrivateLinkResourceListResult>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        HardwareSecurityModulesPrivateLinkResourceListResult IModel<HardwareSecurityModulesPrivateLinkResourceListResult>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<HardwareSecurityModulesPrivateLinkResourceListResult>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
