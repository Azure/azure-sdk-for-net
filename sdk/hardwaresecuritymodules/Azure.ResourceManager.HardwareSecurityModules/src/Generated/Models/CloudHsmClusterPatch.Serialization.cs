...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudHsmClusterPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudHsmClusterPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudHsmClusterPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudHsmClusterPatch>)} interface");
            }
        ...
        string IPersistableModel<CloudHsmClusterPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
