...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHsmListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static DedicatedHsmListResult DeserializeDedicatedHsmListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<DedicatedHsm> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<DedicatedHsm> array = new List<DedicatedHsm>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(DedicatedHsm.DeserializeDedicatedHsm(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new DedicatedHsmListResult(value, nextLink, serializedAdditionalRawData);
        }
