...
namespace Azure.ResourceManager.Hardwaresecuritymodules.Models
{
    ...
    public partial class BackupRequestProperties : BackupRestoreRequestBaseProperties
    {
        ...
        public BackupRequestProperties(Uri azureStorageBlobContainerUri) : base(azureStorageBlobContainerUri)
        {
        ...
        internal BackupRequestProperties(Uri azureStorageBlobContainerUri, string token, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(azureStorageBlobContainerUri, token, serializedAdditionalRawData)
        {
        }
