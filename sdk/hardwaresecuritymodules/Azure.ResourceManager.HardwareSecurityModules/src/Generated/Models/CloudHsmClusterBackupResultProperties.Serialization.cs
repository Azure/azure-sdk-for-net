    ...
    public partial class CloudHsmClusterBackupResultProperties : IUtf8JsonSerializable, IJsonModel<CloudHsmClusterBackupResultProperties>
    {
        ...
        internal static CloudHsmClusterBackupResultProperties DeserializeCloudHsmClusterBackupResultProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResponseError>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), options, AzureResourceManagerHardwareSecurityModulesContext.Default)
#else
                ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), options, AzureResourceManagerHardwareSecurityModulesContext.Default)
#endif
;
                    continue;
                }
