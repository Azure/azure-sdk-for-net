...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    public partial class CloudHsmClusterSku
    {
        ...
        internal CloudHsmClusterSku(CloudHsmClusterSkuFamily family, CloudHsmClusterSkuName name, int? capacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Family = family;
            Name = name;
            Capacity = capacity;
