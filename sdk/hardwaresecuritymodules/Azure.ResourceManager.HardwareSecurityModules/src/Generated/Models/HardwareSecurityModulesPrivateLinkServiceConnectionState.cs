...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    public partial class HardwareSecurityModulesPrivateLinkServiceConnectionState
    {
        ...
        internal HardwareSecurityModulesPrivateLinkServiceConnectionState(HardwareSecurityModulesPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
        ...
        public HardwareSecurityModulesPrivateEndpointServiceConnectionStatus? Status { get; set; }
