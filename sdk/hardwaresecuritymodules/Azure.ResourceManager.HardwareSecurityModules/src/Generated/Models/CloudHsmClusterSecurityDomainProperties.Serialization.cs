...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudHsmClusterSecurityDomainProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudHsmClusterSecurityDomainProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudHsmClusterSecurityDomainProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CloudHsmClusterSecurityDomainProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
