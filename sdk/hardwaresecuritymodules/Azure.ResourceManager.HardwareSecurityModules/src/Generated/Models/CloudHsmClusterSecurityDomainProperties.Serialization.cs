...
{
    public partial class CloudHsmClusterSecurityDomainProperties : IUtf8JsonSerializable, IJsonModel<CloudHsmClusterSecurityDomainProperties>, IPersistableModel<CloudHsmClusterSecurityDomainProperties>
    {
        ...
        void IJsonModel<CloudHsmClusterSecurityDomainProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CloudHsmClusterSecurityDomainProperties)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FipsState))
            {
                builder.Append("  fipsState:");
                builder.AppendLine($" '{FipsState.Value.ToString()}'");
            }

            if (Optional.IsDefined(ActivationStatus))
            {
                builder.Append("  activationStatus:");
                builder.AppendLine($" '{ActivationStatus}'");
            }
