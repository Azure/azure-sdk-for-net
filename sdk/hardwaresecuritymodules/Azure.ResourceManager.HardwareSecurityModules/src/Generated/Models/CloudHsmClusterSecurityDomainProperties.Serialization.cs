...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    public partial class CloudHsmClusterSecurityDomainProperties : IUtf8JsonSerializable, IJsonModel<CloudHsmClusterSecurityDomainProperties>
    {
        ...
        void IJsonModel<CloudHsmClusterSecurityDomainProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CloudHsmClusterSecurityDomainProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CloudHsmClusterSecurityDomainProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CloudHsmClusterSecurityDomainProperties)} does not support '{options.Format}' format.");
            }
        }
