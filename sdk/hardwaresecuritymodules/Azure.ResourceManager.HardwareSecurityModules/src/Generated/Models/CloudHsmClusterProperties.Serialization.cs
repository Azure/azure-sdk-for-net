...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    public partial class CloudHsmClusterProperties : IUtf8JsonSerializable, IJsonModel<CloudHsmClusterProperties>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FipsApprovedMode))
            {
                writer.WritePropertyName("fipsApprovedMode"u8);
                writer.WriteBooleanValue(FipsApprovedMode.Value);
            }
        ...
        internal static CloudHsmClusterProperties DeserializeCloudHsmClusterProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("fipsApprovedMode"u8))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    fipsApprovedMode = property.Value.GetBoolean();
                    continue;
                }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(FipsApprovedMode), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  fipsApprovedMode: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                ...
                {
                    builder.Append("  fipsApprovedMode: ");
                    var boolValue = FipsApprovedMode.Value == true ? "true" : "false";
