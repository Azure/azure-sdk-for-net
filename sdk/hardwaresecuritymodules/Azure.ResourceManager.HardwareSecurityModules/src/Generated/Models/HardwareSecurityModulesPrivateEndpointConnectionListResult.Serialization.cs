...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HardwareSecurityModulesPrivateEndpointConnectionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<HardwareSecurityModulesPrivateEndpointConnectionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HardwareSecurityModulesPrivateEndpointConnectionListResult>)} interface");
            }
        ...
        string IPersistableModel<HardwareSecurityModulesPrivateEndpointConnectionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
