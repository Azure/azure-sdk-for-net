...
namespace Azure.ResourceManager.HardwareSecurityModules.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DedicatedHsmPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DedicatedHsmPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DedicatedHsmPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DedicatedHsmPatch>)} interface");
            }
        ...
        string IPersistableModel<DedicatedHsmPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
