...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    public partial class CloudHsmClusterData : IUtf8JsonSerializable, IJsonModel<CloudHsmClusterData>
    {
        ...
        internal static CloudHsmClusterData DeserializeCloudHsmClusterData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<CloudHsmProperties> hsms = default;
            Optional<string> publicNetworkAccess = default;
            IList<HardwareSecurityModulesPrivateEndpointConnectionData> privateEndpointConnections = default;
            ...
            return new CloudHsmClusterData(id, name, type, systemData.Value, tags ?? new ChangeTrackingDictionary<string, string>(), location, Optional.ToNullable(provisioningState), autoGeneratedDomainNameLabelScope.Value, securityDomain.Value, hsms ?? new ChangeTrackingList<CloudHsmProperties>(), publicNetworkAccess.Value, privateEndpointConnections ?? new ChangeTrackingList<HardwareSecurityModulesPrivateEndpointConnectionData>(), statusMessage.Value, restoreProperties.Value, backupProperties.Value, sku.Value, identity, serializedAdditionalRawData);
        }
