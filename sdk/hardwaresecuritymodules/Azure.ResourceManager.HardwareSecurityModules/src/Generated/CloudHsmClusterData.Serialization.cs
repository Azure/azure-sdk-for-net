...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    public partial class CloudHsmClusterData : IUtf8JsonSerializable, IJsonModel<CloudHsmClusterData>
    {
        ...
        internal static CloudHsmClusterData DeserializeCloudHsmClusterData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CloudHsmClusterData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(provisioningState), autoGeneratedDomainNameLabelScope.Value, securityDomain.Value, hsms ?? new ChangeTrackingList<CloudHsmProperties>(), publicNetworkAccess.Value, privateEndpointConnections ?? new ChangeTrackingList<HardwareSecurityModulesPrivateEndpointConnectionData>(), statusMessage.Value, restoreProperties.Value, backupProperties.Value, sku.Value, identity, serializedAdditionalRawData);
        }
