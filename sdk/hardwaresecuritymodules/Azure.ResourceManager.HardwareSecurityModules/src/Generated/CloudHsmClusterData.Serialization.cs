...
namespace Azure.ResourceManager.HardwareSecurityModules
{
    ...
    public partial class CloudHsmClusterData : TrackedResourceData, IJsonModel<CloudHsmClusterData>
    {
        ...
        internal static RequestContent ToRequestContent(CloudHsmClusterData cloudHsmClusterData)
        {
            ...
            return RequestContent.Create(cloudHsmClusterData, ModelSerializationExtensions.WireOptions);
        }
        ...
        internal static CloudHsmClusterData FromResponse(Response response)
        {
            ...
            return DeserializeCloudHsmClusterData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CloudHsmClusterData IJsonModel<CloudHsmClusterData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CloudHsmClusterData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CloudHsmClusterData DeserializeCloudHsmClusterData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            CloudHsmClusterProperties properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CloudHsmClusterProperties.DeserializeCloudHsmClusterProperties(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("identity"u8))
                {
                    ...
                    identity = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), new ModelReaderWriterOptions(options.Format + "|v3"), AzureResourceManagerHardwareSecurityModulesContext.Default);
                    continue;
                }
                if (prop.NameEquals("sku"u8))
                {
                    ...
                    sku = CloudHsmClusterSku.DeserializeCloudHsmClusterSku(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
