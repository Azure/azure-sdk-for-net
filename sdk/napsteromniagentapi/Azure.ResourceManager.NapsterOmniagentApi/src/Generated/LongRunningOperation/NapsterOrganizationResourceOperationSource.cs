...
{
    /// <summary></summary>
    internal partial class NapsterOrganizationResourceOperationSource : IOperationSource<NapsterOrganizationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NapsterOrganizationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
