...
{
    internal partial class NapsterOmniagentApiArmOperation : ArmOperation
    {
        ...
        internal NapsterOmniagentApiArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal NapsterOmniagentApiArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
