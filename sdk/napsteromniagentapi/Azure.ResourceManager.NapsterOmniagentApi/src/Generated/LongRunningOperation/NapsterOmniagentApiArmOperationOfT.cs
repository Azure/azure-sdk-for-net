...
{
    internal partial class NapsterOmniagentApiArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of NapsterOmniagentApiArmOperation for mocking. </summary>
        protected NapsterOmniagentApiArmOperation()
        {
        }
        ...
        internal NapsterOmniagentApiArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal NapsterOmniagentApiArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "NapsterOmniagentApiArmOperation",
                null,
