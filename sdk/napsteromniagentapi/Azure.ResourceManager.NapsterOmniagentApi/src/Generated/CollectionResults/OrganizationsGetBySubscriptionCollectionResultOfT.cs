...
{
    internal partial class OrganizationsGetBySubscriptionCollectionResultOfT : Pageable<OrganizationResourceData>
    {
        ...
        public OrganizationsGetBySubscriptionCollectionResultOfT(Organizations client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<OrganizationResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
