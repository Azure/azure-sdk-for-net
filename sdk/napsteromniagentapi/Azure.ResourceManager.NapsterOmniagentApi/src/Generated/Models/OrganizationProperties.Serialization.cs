...
namespace Azure.ResourceManager.NapsterOmniagentApi.Models
{
    ...
    public partial class OrganizationProperties : IJsonModel<OrganizationProperties>
    {
        ...
        internal static OrganizationProperties DeserializeOrganizationProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    partnerProperties = PartnerProperties.DeserializePartnerProperties(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("singleSignOnProperties"u8))
                {
                    ...
                    singleSignOnProperties = SingleSignOnPropertiesV2.DeserializeSingleSignOnPropertiesV2(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
