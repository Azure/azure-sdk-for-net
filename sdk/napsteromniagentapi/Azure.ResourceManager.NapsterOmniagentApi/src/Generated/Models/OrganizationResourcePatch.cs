...
namespace Azure.ResourceManager.NapsterOmniagentApi.Models
{
    ...
    public partial class OrganizationResourcePatch
    {
        ...
        internal OrganizationResourcePatch(IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Tags = tags;
            Identity = identity;
