...
namespace Azure.ResourceManager.NapsterOmniagentApi.Models
{
    ...
    public partial class SingleSignOnPropertiesV2 : IJsonModel<SingleSignOnPropertiesV2>
    {
        ...
        protected virtual SingleSignOnPropertiesV2 PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SingleSignOnPropertiesV2>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SingleSignOnPropertiesV2>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SingleSignOnPropertiesV2 IPersistableModel<SingleSignOnPropertiesV2>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SingleSignOnPropertiesV2 IJsonModel<SingleSignOnPropertiesV2>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SingleSignOnPropertiesV2 JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SingleSignOnPropertiesV2>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SingleSignOnPropertiesV2 DeserializeSingleSignOnPropertiesV2(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            SingleSignOnStates? state = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    @type = new SingleSignOnType(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("state"u8))
                {
                    ...
                    state = new SingleSignOnStates(prop.Value.GetString());
                    continue;
                }
