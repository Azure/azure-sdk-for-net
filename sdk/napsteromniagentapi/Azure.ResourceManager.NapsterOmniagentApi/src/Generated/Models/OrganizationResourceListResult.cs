...
namespace Azure.ResourceManager.NapsterOmniagentApi.Models
{
    ...
    internal partial class OrganizationResourceListResult
    {
        ...
        internal OrganizationResourceListResult(IEnumerable<OrganizationResourceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal OrganizationResourceListResult(IList<OrganizationResourceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<OrganizationResourceData> Value { get; }
