...
namespace Azure.ResourceManager.NapsterOmniagentApi.Models
{
    ...
    internal partial class OrganizationResourceListResult
    {
        ...
        internal OrganizationResourceListResult(IEnumerable<NapsterOrganizationResourceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal OrganizationResourceListResult(IList<NapsterOrganizationResourceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<NapsterOrganizationResourceData> Value { get; }
