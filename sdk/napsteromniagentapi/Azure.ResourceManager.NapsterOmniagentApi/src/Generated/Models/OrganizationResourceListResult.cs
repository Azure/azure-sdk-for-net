...
namespace Azure.ResourceManager.NapsterOmniagentApi.Models
{
    ...
    internal partial class OrganizationResourceListResult
    {
        ...
        internal OrganizationResourceListResult(IEnumerable<NapsterOrganizationData> value)
        {
            Value = value.ToList();
        }
        ...
        internal OrganizationResourceListResult(IList<NapsterOrganizationData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<NapsterOrganizationData> Value { get; }
