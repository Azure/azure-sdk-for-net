...
namespace Azure.ResourceManager.NapsterOmniagentApi.Models
{
    ...
    public partial class SingleSignOnPropertiesV2
    {
        ...
        internal SingleSignOnPropertiesV2(SingleSignOnType @type, SingleSignOnStates? state, string enterpriseAppId, string uri, IList<string> aadDomains, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            State = state;
        ...
        public SingleSignOnStates? State { get; set; }
