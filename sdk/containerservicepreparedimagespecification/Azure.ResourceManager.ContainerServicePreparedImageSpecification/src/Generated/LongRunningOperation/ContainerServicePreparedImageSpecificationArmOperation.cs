...
{
    internal partial class ContainerServicePreparedImageSpecificationArmOperation : ArmOperation
    {
        ...
        internal ContainerServicePreparedImageSpecificationArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ContainerServicePreparedImageSpecificationArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
