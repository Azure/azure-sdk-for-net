...
{
    internal partial class ContainerServicePreparedImageSpecificationArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of ContainerServicePreparedImageSpecificationArmOperation for mocking. </summary>
        protected ContainerServicePreparedImageSpecificationArmOperation()
        {
        }
        ...
        internal ContainerServicePreparedImageSpecificationArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ContainerServicePreparedImageSpecificationArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "ContainerServicePreparedImageSpecificationArmOperation",
                null,
