# Azure.ContainerApps.Sandbox client library for .NET

Azure.ContainerApps.Sandbox is a client library for developing .NET applications with rich experience.
...
```dotnetcli
dotnet add package Azure.ContainerApps.Sandbox --prerelease
```
