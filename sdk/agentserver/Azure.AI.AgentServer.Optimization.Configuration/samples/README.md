...
`IOptionsMonitor<OptimizationOptions>` and reload semantics, the
**`Azure.AI.AgentServer.Optimization.Configuration`** package (the parent of
this samples directory) registers the loader as an `IConfigurationSource`. See
the package [README](../README.md) for the DI snippet.
...
[loader]: ../../Azure.AI.AgentServer.Optimization/src/OptimizationOptionsLoader.cs
