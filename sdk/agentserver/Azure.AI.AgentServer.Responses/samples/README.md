...
- [Streaming OpenAI Proxy](https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/agentserver/Azure.AI.AgentServer.Responses/samples/Sample10_StreamingOpenAIProxy.md) — Forward to upstream OpenAI-compatible server with streaming
- [Non-Streaming OpenAI Proxy](https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/agentserver/Azure.AI.AgentServer.Responses/samples/Sample11_NonStreamingOpenAIProxy.md) — Call upstream OpenAI-compatible server and build event stream
