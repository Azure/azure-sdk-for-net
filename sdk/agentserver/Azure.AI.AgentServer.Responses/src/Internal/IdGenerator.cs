...
internal static class IdGenerator
{
    ...
    public static string? NewItemId(Item item, string? partitionKeyHint = "")
    {
        return item switch
        {
            ItemMessage => NewMessageItemId(partitionKeyHint),
            ItemFunctionToolCall => NewFunctionCallItemId(partitionKeyHint),
            ItemFunctionToolCallOutput => NewFunctionCallOutputItemId(partitionKeyHint),
            ItemReasoningItem => NewReasoningItemId(partitionKeyHint),
            ItemFileSearchToolCall => NewFileSearchCallItemId(partitionKeyHint),
            OutputItemCodeInterpreterToolCall => NewCodeInterpreterCallItemId(partitionKeyHint),
            OutputItemComputerToolCall => NewComputerCallItemId(partitionKeyHint),
            OutputItemComputerToolCallOutput => NewComputerCallOutputItemId(partitionKeyHint),
            OutputItemImageGenToolCall => NewImageGenCallItemId(partitionKeyHint),
            OutputItemMcpApprovalRequest => NewMcpApprovalRequestItemId(partitionKeyHint),
            OutputItemMcpApprovalResponseResource => NewMcpApprovalResponseItemId(partitionKeyHint),
            OutputItemMcpListTools => NewMcpListToolsItemId(partitionKeyHint),
            OutputItemMcpToolCall => NewMcpCallItemId(partitionKeyHint),
            OutputItemWebSearchToolCall => NewWebSearchCallItemId(partitionKeyHint),
            OutputItemApplyPatchToolCall => NewApplyPatchCallItemId(partitionKeyHint),
            OutputItemApplyPatchToolCallOutput => NewApplyPatchCallOutputItemId(partitionKeyHint),
            OutputItemLocalShellToolCall => NewLocalShellCallItemId(partitionKeyHint),
            OutputItemLocalShellToolCallOutput => NewLocalShellCallOutputItemId(partitionKeyHint),
            OutputItemFunctionShellCall => NewFunctionShellCallItemId(partitionKeyHint),
            OutputItemFunctionShellCallOutput => NewFunctionShellCallOutputItemId(partitionKeyHint),
            OutputItemCompactionBody => NewCompactionItemId(partitionKeyHint),
            StructuredOutputsOutputItem => NewStructuredOutputItemId(partitionKeyHint),
            WorkflowActionOutputItem => NewWorkflowActionItemId(partitionKeyHint),
            _ => NewGenericItemId(partitionKeyHint),
        };
    }
