...
/// </summary>
internal static partial class ComputerCallOutputItemParamValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        if (element.TryGetProperty("acknowledged_safety_checks", out var acknowledgedSafetyChecksProp) && acknowledgedSafetyChecksProp.ValueKind != JsonValueKind.Null)
        {
