...
/// </summary>
internal static partial class ProceduralMemoryItemValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        else
        {
            ...
            else if (kindProp.GetString() is not ("procedural"))
                errors.Add(new ValidationError("$.kind", $"Value '{kindProp.GetString()}' is not valid. Allowed: procedural"));
        }
