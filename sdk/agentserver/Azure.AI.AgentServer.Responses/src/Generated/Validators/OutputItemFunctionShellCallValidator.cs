...
/// </summary>
internal static partial class OutputItemFunctionShellCallValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        {
            var actionResult = FunctionShellActionValidator.Validate(actionProp);
        ...
        else if (environmentProp.ValueKind != JsonValueKind.Null)
        {
            var environmentResult = FunctionShellCallEnvironmentValidator.Validate(environmentProp);
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("shell_call"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: shell_call"));
        }
