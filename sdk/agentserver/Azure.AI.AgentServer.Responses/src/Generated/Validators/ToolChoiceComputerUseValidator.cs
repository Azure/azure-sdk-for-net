...
/// </summary>
internal static partial class ToolChoiceComputerUseValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("computer_use"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: computer_use"));
        }
