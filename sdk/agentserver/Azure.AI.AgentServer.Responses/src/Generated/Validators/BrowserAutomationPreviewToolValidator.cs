...
/// </summary>
internal static partial class BrowserAutomationPreviewToolValidator
{
    /// <summary>
        ...
        else
        {
            ...
            if (!browserAutomationPreviewResult.IsValid)
            {
                foreach (var e in browserAutomationPreviewResult.Errors)
                    errors.Add(new ValidationError("$.browser_automation_preview" + e.Path.Substring(1), e.Message));
            }
        }
