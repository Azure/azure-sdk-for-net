...
/// </summary>
internal static partial class FabricDataAgentToolCallValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        else
        {
            ...
            else if (statusProp.GetString() is not ("in_progress" or "completed" or "incomplete" or "failed"))
                errors.Add(new ValidationError("$.status", $"Value '{statusProp.GetString()}' is not valid. Allowed: in_progress, completed, incomplete, failed"));
        }
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("fabric_dataagent_preview_call"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: fabric_dataagent_preview_call"));
        }
