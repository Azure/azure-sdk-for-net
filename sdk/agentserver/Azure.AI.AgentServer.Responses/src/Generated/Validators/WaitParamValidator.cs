...
/// </summary>
internal static partial class WaitParamValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("wait"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: wait"));
        }
