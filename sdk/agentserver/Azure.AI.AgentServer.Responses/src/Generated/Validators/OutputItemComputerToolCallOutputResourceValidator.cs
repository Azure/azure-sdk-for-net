...
/// </summary>
internal static partial class OutputItemComputerToolCallOutputResourceValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        {
            var outputResult = ComputerScreenshotImageValidator.Validate(outputProp);
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("computer_call_output"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: computer_call_output"));
        }
