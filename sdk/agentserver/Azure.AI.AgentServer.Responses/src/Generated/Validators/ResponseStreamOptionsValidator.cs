...
/// </summary>
internal static partial class ResponseStreamOptionsValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        if (element.TryGetProperty("include_obfuscation", out var includeObfuscationProp))
        {
            if (includeObfuscationProp.ValueKind != JsonValueKind.True && includeObfuscationProp.ValueKind != JsonValueKind.False)
                errors.Add(new ValidationError("$.include_obfuscation", $"Expected boolean, got {includeObfuscationProp.ValueKind}"));
        }
