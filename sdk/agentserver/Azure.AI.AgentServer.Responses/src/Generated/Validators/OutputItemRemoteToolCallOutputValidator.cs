...
/// </summary>
internal static partial class OutputItemRemoteToolCallOutputValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        if (element.TryGetProperty("label", out var labelProp))
        {
            if (labelProp.ValueKind != JsonValueKind.String)
                errors.Add(new ValidationError("$.label", $"Expected string, got {labelProp.ValueKind}"));
        }
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("remote_function_call_output"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: remote_function_call_output"));
        }
