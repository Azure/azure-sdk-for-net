...
/// </summary>
internal static partial class CaptureStructuredOutputsToolValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        {
            var outputsResult = StructuredOutputDefinitionValidator.Validate(outputsProp);
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("capture_structured_outputs"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: capture_structured_outputs"));
        }
