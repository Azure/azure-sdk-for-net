...
/// </summary>
internal static partial class WebSearchActionOpenPageValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("open_page"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: open_page"));
        }

        // Optional: url
        if (element.TryGetProperty("url", out var urlProp) && urlProp.ValueKind != JsonValueKind.Null)
        {
