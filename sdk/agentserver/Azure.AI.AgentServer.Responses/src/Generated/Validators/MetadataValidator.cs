...
internal static partial class MetadataValidator
{
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        {
            if (kvp.Value.ValueKind != JsonValueKind.String && kvp.Value.ValueKind != JsonValueKind.Null)
                errors.Add(new ValidationError($"$.{kvp.Name}", $"Expected string, got {kvp.Value.ValueKind}"));
        }
