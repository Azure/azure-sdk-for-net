...
/// </summary>
internal static partial class OutputMessageContentRefusalContentValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        // Required: refusal
        if (!element.TryGetProperty("refusal", out var refusalProp))
            errors.Add(new ValidationError("$.refusal", "Required property 'refusal' is missing"));
        else
        {
            if (refusalProp.ValueKind != JsonValueKind.String)
                errors.Add(new ValidationError("$.refusal", $"Expected string, got {refusalProp.ValueKind}"));
        }
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("refusal"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: refusal"));
        }
