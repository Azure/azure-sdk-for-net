...
/// </summary>
internal static partial class MemorySearchOptionsValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        // Optional: max_memories
        if (element.TryGetProperty("max_memories", out var maxMemoriesProp))
        {
            if (maxMemoriesProp.ValueKind != JsonValueKind.Number)
                errors.Add(new ValidationError("$.max_memories", $"Expected integer, got {maxMemoriesProp.ValueKind}"));
        }
