...
/// </summary>
internal static partial class TextResponseFormatConfigurationResponseFormatJsonObjectValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("json_object"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: json_object"));
        }
