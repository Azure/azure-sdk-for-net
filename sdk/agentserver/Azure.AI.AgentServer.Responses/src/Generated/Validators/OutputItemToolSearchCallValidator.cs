...
/// </summary>
internal static partial class OutputItemToolSearchCallValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        else if (callIdProp.ValueKind != JsonValueKind.Null)
        {
        ...
        if (!element.TryGetProperty("execution", out var executionProp))
            errors.Add(new ValidationError("$.execution", "Required property 'execution' is missing"));
        else
        {
