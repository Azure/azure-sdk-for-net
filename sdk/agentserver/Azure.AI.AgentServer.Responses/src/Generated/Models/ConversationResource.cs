...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class ConversationResource
    {
        ...
        internal ConversationResource(string id, Metadata metadata, DateTimeOffset createdAt)
        {
            Id = id;
            Metadata = metadata;
            CreatedAt = createdAt;
        ...
        internal ConversationResource(string id, string @object, Metadata metadata, DateTimeOffset createdAt, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Object = @object;
            Metadata = metadata;
