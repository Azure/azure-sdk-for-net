...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class SharepointGroundingToolCall : OutputItem
    {
        ...
        internal SharepointGroundingToolCall(string callId, string arguments, ToolCallStatus status) : base(OutputItemType.SharepointGroundingPreviewCall)
        {
            CallId = callId;
            Arguments = arguments;
            Status = status;
