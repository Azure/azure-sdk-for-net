...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class AgentsPagedResultMemoryStoreObject
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultMemoryStoreObject"/>. </summary>
        ...
        internal AgentsPagedResultMemoryStoreObject(IEnumerable<MemoryStoreObject> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultMemoryStoreObject(IList<MemoryStoreObject> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<MemoryStoreObject> Data { get; }
