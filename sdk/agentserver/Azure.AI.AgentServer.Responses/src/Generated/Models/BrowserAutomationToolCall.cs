...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class BrowserAutomationToolCall : OutputItem
    {
        ...
        internal BrowserAutomationToolCall(string callId, string arguments, ToolCallStatus status) : base(OutputItemType.BrowserAutomationPreviewCall)
        {
            CallId = callId;
            Arguments = arguments;
            Status = status;
