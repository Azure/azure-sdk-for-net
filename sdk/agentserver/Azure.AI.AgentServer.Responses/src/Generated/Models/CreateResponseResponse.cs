...
namespace Azure.AI.Agents.Contracts.V2
{
    ...
    public partial class CreateResponseResponse
    {
        ...
        internal CreateResponseResponse(string id, DateTimeOffset createdAt, ResponseError error, ResponseIncompleteDetails incompleteDetails, IEnumerable<OutputItem> output, BinaryData instructions, bool parallelToolCalls, AgentReference agentReference)
        {
