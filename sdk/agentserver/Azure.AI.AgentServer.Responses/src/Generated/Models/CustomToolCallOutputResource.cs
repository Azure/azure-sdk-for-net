...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class CustomToolCallOutputResource : OutputItem
    {
        /// <summary> Initializes a new instance of <see cref="CustomToolCallOutputResource"/>. </summary>
        ...
        /// </param>
        internal CustomToolCallOutputResource(string callId, BinaryData output, FunctionCallOutputStatusEnum status) : base(OutputItemType.CustomToolCallOutput)
        {
            CallId = callId;
            Output = output;
            Status = status;
        ...
        internal CustomToolCallOutputResource(OutputItemType @type, AgentReference agentReference, string responseId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string callId, BinaryData output, FunctionCallOutputStatusEnum status, string createdBy) : base(@type, id, createdBy, agentReference, responseId, additionalBinaryDataProperties)
        {
            CallId = callId;
            Output = output;
            Status = status;
