...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class StructuredInputDefinition
    {
        ...
        /// <param name="required"> Whether the input property is required when the agent is invoked. The service defaults to `false` if a value is not specified by the caller. </param>
        ...
        /// <summary> Whether the input property is required when the agent is invoked. The service defaults to `false` if a value is not specified by the caller. </summary>
