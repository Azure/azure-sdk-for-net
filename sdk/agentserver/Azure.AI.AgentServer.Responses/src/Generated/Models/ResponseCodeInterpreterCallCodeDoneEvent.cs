...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class ResponseCodeInterpreterCallCodeDoneEvent : ResponseStreamEvent
    {
        ...
        internal ResponseCodeInterpreterCallCodeDoneEvent(long outputIndex, string itemId, string code, long sequenceNumber) : base(ResponseStreamEventType.ResponseCodeInterpreterCallCodeDone, sequenceNumber)
        {
        ...
        /// <param name="code"> The final code snippet output by the code interpreter. </param>
        /// <param name="sequenceNumber"> The sequence number of this event, used to order streaming events. </param>
        internal ResponseCodeInterpreterCallCodeDoneEvent(ResponseStreamEventType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, long outputIndex, string itemId, string code, long sequenceNumber) : base(@type, sequenceNumber, additionalBinaryDataProperties)
        {
            OutputIndex = outputIndex;
            ItemId = itemId;
            Code = code;
