...
namespace Azure.AI.AgentServer.Responses
{
    ...
    public partial class SearchMemoriesRequest
    {
        ...
        internal SearchMemoriesRequest(string scope)
        {
            Scope = scope;
        ...
        internal SearchMemoriesRequest(string scope, IList<ResponseItem> items, string previousSearchId, MemorySearchOptions options, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Scope = scope;
            Items = items;
