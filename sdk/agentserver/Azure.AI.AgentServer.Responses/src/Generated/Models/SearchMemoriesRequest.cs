...
namespace Azure.AI.Agents.Contracts.V2
{
    ...
    public partial class SearchMemoriesRequest
    {
        ...
        internal SearchMemoriesRequest(string scope, IList<Item> items, string previousSearchId, MemorySearchOptions options, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Scope = scope;
            Items = items;
