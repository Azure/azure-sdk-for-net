...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class WebSearchToolboxTool : ToolboxTool
    {
        ...
        /// </param>
        internal WebSearchToolboxTool(ToolboxToolType @type, string name, string description, IDictionary<string, ToolConfig> toolConfigs, IDictionary<string, BinaryData> additionalBinaryDataProperties, WebSearchToolFilters filters, WebSearchApproximateLocation userLocation, WebSearchToolSearchContextSize? searchContextSize, WebSearchConfiguration customSearchConfiguration) : base(@type, name, description, toolConfigs, additionalBinaryDataProperties)
        {
            Filters = filters;
