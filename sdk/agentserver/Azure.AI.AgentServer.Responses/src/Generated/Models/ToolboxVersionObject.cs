...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class ToolboxVersionObject
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ToolboxVersionObject"/>. </summary>
        /// <param name="metadata">
        ...
        internal ToolboxVersionObject(IDictionary<string, string> metadata, string id, string name, string version, DateTimeOffset createdAt, IEnumerable<ToolboxTool> tools)
        {
            Metadata = metadata;
            Id = id;
            Name = name;
        ...
        internal ToolboxVersionObject(IDictionary<string, string> metadata, string id, string name, string version, string description, DateTimeOffset createdAt, IList<ToolboxTool> tools, IList<ToolboxSkill> skills, ToolboxPolicies policies, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Metadata = metadata;
            Id = id;
            Name = name;
