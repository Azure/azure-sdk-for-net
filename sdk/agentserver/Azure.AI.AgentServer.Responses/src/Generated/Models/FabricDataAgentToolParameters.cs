...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class FabricDataAgentToolParameters
    {
        ...
        internal FabricDataAgentToolParameters(string name, string description, IList<ToolProjectConnection> projectConnections, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
