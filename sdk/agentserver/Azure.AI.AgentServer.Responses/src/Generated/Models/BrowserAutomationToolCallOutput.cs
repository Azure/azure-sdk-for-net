...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class BrowserAutomationToolCallOutput : OutputItem
    {
        ...
        internal BrowserAutomationToolCallOutput(string callId, ToolCallStatus status) : base(OutputItemType.BrowserAutomationPreviewCallOutput)
        {
            CallId = callId;
            Status = status;
        }
