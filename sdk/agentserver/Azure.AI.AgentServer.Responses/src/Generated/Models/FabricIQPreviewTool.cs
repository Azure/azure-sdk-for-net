...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class FabricIQPreviewTool : ResponseTool
    {
        ...
        internal FabricIQPreviewTool(ResponseToolKind @type, string projectConnectionId, string serverLabel, Uri serverUrl, BinaryData requireApproval, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type)
        {
            ProjectConnectionId = projectConnectionId;
