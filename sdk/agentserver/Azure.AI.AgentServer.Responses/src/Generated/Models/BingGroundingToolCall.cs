...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class BingGroundingToolCall : OutputItem
    {
        ...
        internal BingGroundingToolCall(string callId, string arguments, ToolCallStatus status) : base(OutputItemType.BingGroundingCall)
        {
            CallId = callId;
            Arguments = arguments;
            Status = status;
