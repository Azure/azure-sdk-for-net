...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class ItemCustomToolCall : ResponseItem
    {
        ...
        internal ItemCustomToolCall(string callId, string name, string input) : base(ItemType.CustomToolCall)
        {
            CallId = callId;
            Name = name;
            Input = input;
        ...
        internal ItemCustomToolCall(ItemType @type, string id, string callId, string @namespace, string name, string input, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type)
        {
            Id = id;
            CallId = callId;
            Namespace = @namespace;
