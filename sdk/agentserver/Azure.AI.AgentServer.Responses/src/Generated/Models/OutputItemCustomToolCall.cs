...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class OutputItemCustomToolCall : OutputItem
    {
        ...
        public OutputItemCustomToolCall(string callId, string name, string input) : base(OutputItemType.CustomToolCall)
        {
        ...
        /// <param name="name"> The name of the custom tool being called. </param>
        /// <param name="input"> The input for the custom tool call generated by the model. </param>
        internal OutputItemCustomToolCall(OutputItemType @type, BinaryData createdBy, AgentReference agentReference, string responseId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string callId, string name, string input) : base(@type, createdBy, agentReference, responseId, additionalBinaryDataProperties)
        {
            Id = id;
            CallId = callId;
            Name = name;
