...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class OpenApiToolCallOutput : OutputItem
    {
        ...
        internal OpenApiToolCallOutput(string callId, string name, ToolCallStatus status) : base(OutputItemType.OpenapiCallOutput)
        {
            CallId = callId;
            Name = name;
            Status = status;
