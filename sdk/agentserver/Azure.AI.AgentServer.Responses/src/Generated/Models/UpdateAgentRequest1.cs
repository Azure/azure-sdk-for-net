...
namespace Azure.AI.AgentServer.Responses
{
    ...
    public partial class UpdateAgentRequest1
    {
        ...
        internal UpdateAgentRequest1(AgentDefinition definition)
        {
        ...
        internal UpdateAgentRequest1(IDictionary<string, string> metadata, string description, AgentDefinition definition, AgentBlueprintReference blueprintReference, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Metadata = metadata;
