...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class ResponseMCPListToolsFailedEvent : ResponseStreamEvent
    {
        ...
        internal ResponseMCPListToolsFailedEvent(string itemId, long outputIndex, long sequenceNumber) : base(ResponseStreamEventType.ResponseMcpListToolsFailed, sequenceNumber)
        {
            ItemId = itemId;
        ...
        /// <param name="outputIndex"> The index of the output item that failed. </param>
        /// <param name="sequenceNumber"> The sequence number of this event. </param>
        internal ResponseMCPListToolsFailedEvent(ResponseStreamEventType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string itemId, long outputIndex, long sequenceNumber) : base(@type, sequenceNumber, additionalBinaryDataProperties)
        {
            ItemId = itemId;
            OutputIndex = outputIndex;
        }
