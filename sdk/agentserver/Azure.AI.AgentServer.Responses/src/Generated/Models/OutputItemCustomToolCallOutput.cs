...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class OutputItemCustomToolCallOutput : Item
    {
        ...
        public OutputItemCustomToolCallOutput(string callId, BinaryData output) : base(ItemType.CustomToolCallOutput)
        {
        ...
        ///   Can be a string or an list of output content.
        /// </param>
        internal OutputItemCustomToolCallOutput(ItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string callId, BinaryData output) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            CallId = callId;
            Output = output;
