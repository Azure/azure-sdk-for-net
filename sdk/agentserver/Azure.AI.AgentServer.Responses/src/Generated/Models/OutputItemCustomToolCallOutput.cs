...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class OutputItemCustomToolCallOutput : ResponseItem
    {
        ...
        internal OutputItemCustomToolCallOutput(ItemType @type, string id, string callId, BinaryData output, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(@type)
        {
            Id = id;
            CallId = callId;
            Output = output;
