...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class ToolChoiceFunction : ToolChoiceParam, IJsonModel<ToolChoiceFunction>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ToolChoiceFunction>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ToolChoiceFunction IJsonModel<ToolChoiceFunction>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ToolChoiceFunction)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ToolChoiceFunction DeserializeToolChoiceFunction(JsonElement element, ModelReaderWriterOptions options)
        {
