...
namespace Azure.AI.AgentServer.Responses
{
    ...
    public partial class CreateAgentVersionRequest1
    {
        ...
        internal CreateAgentVersionRequest1(AgentDefinition definition)
        {
        ...
        internal CreateAgentVersionRequest1(IDictionary<string, string> metadata, string description, AgentDefinition definition, AgentBlueprintReference blueprintReference, bool? draft, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Metadata = metadata;
