...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class AzureAISearchToolCall : OutputItem
    {
        ...
        internal AzureAISearchToolCall(string callId, string arguments, ToolCallStatus status) : base(OutputItemType.AzureAiSearchCall)
        {
            CallId = callId;
            Arguments = arguments;
            Status = status;
