...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class BingCustomSearchToolCallOutput : OutputItem
    {
        ...
        internal BingCustomSearchToolCallOutput(string callId, ToolCallStatus status) : base(OutputItemType.BingCustomSearchPreviewCallOutput)
        {
            CallId = callId;
            Status = status;
        }
