...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class BingCustomSearchToolCallOutput : OutputItem
    {
        ...
        public BingCustomSearchToolCallOutput(string callId, ToolCallStatus status, string id) : base(OutputItemType.BingCustomSearchPreviewCallOutput)
        {
