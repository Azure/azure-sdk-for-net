...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class AgentsPagedResultToolboxVersionObject
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultToolboxVersionObject"/>. </summary>
        ...
        internal AgentsPagedResultToolboxVersionObject(IEnumerable<ToolboxVersionObject> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultToolboxVersionObject(IList<ToolboxVersionObject> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<ToolboxVersionObject> Data { get; }
