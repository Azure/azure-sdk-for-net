...
namespace Azure.AI.AgentServer.Responses
{
    ...
    public partial class CreateResponseResponse : IJsonModel<CreateResponseResponse>
    {
        /// <summary> Initializes a new instance of <see cref="CreateResponseResponse"/> for deserialization. </summary>
        ...
        protected virtual CreateResponseResponse PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<CreateResponseResponse>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeCreateResponseResponse(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(CreateResponseResponse)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CreateResponseResponse)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CreateResponseResponse>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CreateResponseResponse IPersistableModel<CreateResponseResponse>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<CreateResponseResponse>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="result"> The <see cref="ClientResult"/> to deserialize the <see cref="CreateResponseResponse"/> from. </param>
        public static explicit operator CreateResponseResponse(ClientResult result)
        {
            PipelineResponse response = result.GetRawResponse();
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeCreateResponseResponse(document.RootElement, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<CreateResponseResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateResponseResponse)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsDefined(ModelSelectionDetails))
            {
                writer.WritePropertyName("model_selection_details"u8);
                writer.WriteObjectValue(ModelSelectionDetails, options);
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CreateResponseResponse IJsonModel<CreateResponseResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual CreateResponseResponse JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<CreateResponseResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CreateResponseResponse)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CreateResponseResponse DeserializeCreateResponseResponse(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ModelSelectionDetails modelSelectionDetails = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("error"u8))
                {
                    ...
                    error = ModelReaderWriter.Read<ResponseError>(prop.Value.GetUtf8Bytes(), ModelSerializationExtensions.WireOptions, AzureAIAgentServerResponsesContext.Default);
                    continue;
                }
                ...
                if (prop.NameEquals("model_selection_details"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    modelSelectionDetails = ModelSelectionDetails.DeserializeModelSelectionDetails(prop.Value, options);
                    continue;
                }
