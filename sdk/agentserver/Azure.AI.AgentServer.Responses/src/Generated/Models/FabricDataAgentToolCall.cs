...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class FabricDataAgentToolCall : OutputItem
    {
        ...
        internal FabricDataAgentToolCall(string callId, string arguments, ToolCallStatus status) : base(OutputItemType.FabricDataagentPreviewCall)
        {
            CallId = callId;
            Arguments = arguments;
            Status = status;
