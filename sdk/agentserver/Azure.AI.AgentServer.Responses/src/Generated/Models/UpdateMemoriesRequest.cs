...
namespace Azure.AI.AgentServer.Responses
{
    ...
    public partial class UpdateMemoriesRequest
    {
        ...
        internal UpdateMemoriesRequest(string scope)
        {
            Scope = scope;
        ...
        internal UpdateMemoriesRequest(string scope, IList<ResponseItem> items, string previousUpdateId, int? updateDelay, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Scope = scope;
            Items = items;
