...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class SharepointGroundingToolCallOutput : OutputItem
    {
        ...
        internal SharepointGroundingToolCallOutput(string callId, ToolCallStatus status) : base(OutputItemType.SharepointGroundingPreviewCallOutput)
        {
            CallId = callId;
            Status = status;
        }
