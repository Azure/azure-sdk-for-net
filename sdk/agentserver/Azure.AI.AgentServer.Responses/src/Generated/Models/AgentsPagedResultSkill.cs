...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class AgentsPagedResultSkill
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultSkill"/>. </summary>
        ...
        internal AgentsPagedResultSkill(IEnumerable<Skill> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultSkill(IList<Skill> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
