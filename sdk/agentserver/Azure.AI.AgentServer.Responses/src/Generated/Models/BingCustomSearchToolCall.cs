...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class BingCustomSearchToolCall : OutputItem
    {
        ...
        internal BingCustomSearchToolCall(string callId, string arguments, ToolCallStatus status) : base(OutputItemType.BingCustomSearchPreviewCall)
        {
            CallId = callId;
            Arguments = arguments;
            Status = status;
