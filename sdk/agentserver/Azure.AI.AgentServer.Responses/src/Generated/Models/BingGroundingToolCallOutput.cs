...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class BingGroundingToolCallOutput : OutputItem
    {
        ...
        internal BingGroundingToolCallOutput(string callId, ToolCallStatus status) : base(OutputItemType.BingGroundingCallOutput)
        {
            CallId = callId;
            Status = status;
        }
