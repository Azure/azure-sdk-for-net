...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class CodeInterpreterTool : Tool
    {
        ...
        /// </param>
        internal CodeInterpreterTool(ToolType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name, string description, IDictionary<string, ToolConfig> toolConfigs, BinaryData container) : base(@type, additionalBinaryDataProperties)
        {
            Name = name;
