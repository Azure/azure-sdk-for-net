...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class AgentsPagedResultConversationResource
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultConversationResource"/>. </summary>
        ...
        internal AgentsPagedResultConversationResource(IEnumerable<ConversationResource> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultConversationResource(IList<ConversationResource> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<ConversationResource> Data { get; }
