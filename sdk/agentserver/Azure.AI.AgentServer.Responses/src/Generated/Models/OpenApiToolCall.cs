...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class OpenApiToolCall : OutputItem
    {
        ...
        internal OpenApiToolCall(string callId, string name, string arguments, ToolCallStatus status) : base(OutputItemType.OpenapiCall)
        {
            CallId = callId;
            Name = name;
            Arguments = arguments;
