...
namespace Azure.AI.AgentServer.Responses
{
    ...
    public partial class CreateAgentRequest1
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CreateAgentRequest1"/>. </summary>
        /// <param name="name">
        ...
        internal CreateAgentRequest1(string name, AgentDefinition definition)
        {
            Name = name;
