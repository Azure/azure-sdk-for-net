...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class ToolChoiceWebSearchPreview20250311 : ToolChoiceParam, IJsonModel<ToolChoiceWebSearchPreview20250311>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ToolChoiceWebSearchPreview20250311 IJsonModel<ToolChoiceWebSearchPreview20250311>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ToolChoiceWebSearchPreview20250311)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ToolChoiceWebSearchPreview20250311 DeserializeToolChoiceWebSearchPreview20250311(JsonElement element, ModelReaderWriterOptions options)
        {
