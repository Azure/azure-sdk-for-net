...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class AgentsPagedResultAgentContainerOperationObject
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AgentsPagedResultAgentContainerOperationObject"/>. </summary>
        ...
        internal AgentsPagedResultAgentContainerOperationObject(IEnumerable<AgentContainerOperationObject> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultAgentContainerOperationObject(IList<AgentContainerOperationObject> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<AgentContainerOperationObject> Data { get; }
