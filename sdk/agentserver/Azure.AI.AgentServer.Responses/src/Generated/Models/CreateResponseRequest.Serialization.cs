...
namespace Azure.AI.Agents.Contracts.V2
{
    ...
    public partial class CreateResponseRequest : IJsonModel<CreateResponseRequest>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual CreateResponseRequest PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<CreateResponseRequest>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CreateResponseRequest>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CreateResponseRequest IPersistableModel<CreateResponseRequest>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<CreateResponseRequest>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="createResponseRequest"> The <see cref="CreateResponseRequest"/> to serialize into <see cref="BinaryContent"/>. </param>
        public static implicit operator BinaryContent(CreateResponseRequest createResponseRequest)
        {
            if (createResponseRequest == null)
            {
                return null;
            }
            return BinaryContent.Create(createResponseRequest, ModelSerializationExtensions.WireOptions);
        }
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RaiConfig))
            {
                ...
                writer.WriteStringValue(RaiConfig);
            }
            if (Optional.IsDefined(InternalMetadata))
            {
                writer.WritePropertyName("internal_metadata"u8);
                writer.WriteObjectValue(InternalMetadata, options);
            }
            if (Optional.IsDefined(ResolvedAgentVersion))
            {
                writer.WritePropertyName("resolved_agent_version"u8);
                writer.WriteObjectValue(ResolvedAgentVersion, options);
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CreateResponseRequest IJsonModel<CreateResponseRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual CreateResponseRequest JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<CreateResponseRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CreateResponseRequest DeserializeCreateResponseRequest(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            string raiConfig = default;
            CreateResponseRequestInternalMetadata internalMetadata = default;
            AgentVersionObject resolvedAgentVersion = default;
            AgentReference agent = default;
            string agentSessionId = default;
            AgentReference agentReference = default;
            IDictionary<string, BinaryData> structuredInputs = default;
            AzureUserSecurityContext userSecurityContext = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    raiConfig = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("internal_metadata"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    internalMetadata = CreateResponseRequestInternalMetadata.DeserializeCreateResponseRequestInternalMetadata(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("resolved_agent_version"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    resolvedAgentVersion = AgentVersionObject.DeserializeAgentVersionObject(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("user_security_context"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    userSecurityContext = AzureUserSecurityContext.DeserializeAzureUserSecurityContext(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
