...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class AgentObject
    {
        ...
        internal AgentObject(AgentObjectType @object, string id, string name, AgentState state, AgentStateSource? stateSource, AgentObjectVersions versions, AgentEndpointConfig agentEndpoint, AgentIdentity instanceIdentity, AgentIdentity blueprint, AgentBlueprintReference blueprintReference, AgentCard agentCard, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Object = @object;
            Id = id;
            Name = name;
