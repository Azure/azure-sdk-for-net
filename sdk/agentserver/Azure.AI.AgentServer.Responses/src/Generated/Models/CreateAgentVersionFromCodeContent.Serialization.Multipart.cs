...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class CreateAgentVersionFromCodeContent
    {
        ...
        internal MultiPartFormContent ToMultipartFormContent()
        {
            ...
            content.Add<CreateAgentVersionFromCodeMetadata>("metadata", Metadata, AzureAIAgentsContractsV2Context.Default, ModelSerializationExtensions.WireOptions, "application/json");
