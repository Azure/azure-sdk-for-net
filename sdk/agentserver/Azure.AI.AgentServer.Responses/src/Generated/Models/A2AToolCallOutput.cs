...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class A2AToolCallOutput : OutputItem
    {
        ...
        /// <param name="id"></param>
        /// <exception cref="ArgumentNullException"> <paramref name="callId"/>, <paramref name="name"/> or <paramref name="id"/> is null. </exception>
        public A2AToolCallOutput(string callId, string name, ToolCallStatus status, string id) : base(OutputItemType.A2aPreviewCallOutput)
        {
