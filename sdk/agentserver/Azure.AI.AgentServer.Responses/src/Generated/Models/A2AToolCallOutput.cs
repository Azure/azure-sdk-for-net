...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class A2AToolCallOutput : OutputItem
    {
        ...
        internal A2AToolCallOutput(string callId, string name, ToolCallStatus status) : base(OutputItemType.A2aPreviewCallOutput)
        {
            CallId = callId;
            Name = name;
            Status = status;
