...
namespace Azure.AI.Agents.Contracts.V2.Models
{
    ...
    public partial class AzureFunctionToolCall : OutputItem
    {
        ...
        internal AzureFunctionToolCall(string callId, string name, string arguments, ToolCallStatus status) : base(OutputItemType.AzureFunctionCall)
        {
            CallId = callId;
            Name = name;
            Arguments = arguments;
