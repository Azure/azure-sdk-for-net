...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class ItemCustomToolCallOutput : Item
    {
        /// <summary> Initializes a new instance of <see cref="ItemCustomToolCallOutput"/>. </summary>
        ...
        public ItemCustomToolCallOutput(string callId, BinaryData output) : base(ItemType.CustomToolCallOutput)
        {
        ...
        ///   Can be a string or an list of output content.
        /// </param>
        internal ItemCustomToolCallOutput(ItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string callId, BinaryData output) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            CallId = callId;
            Output = output;
