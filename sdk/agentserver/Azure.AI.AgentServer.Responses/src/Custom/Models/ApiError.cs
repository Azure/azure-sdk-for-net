...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class ApiError
    {
        ...
        internal ApiError(string code, string message, string @param, string @type, IList<ApiError> details, IDictionary<string, BinaryData> additionalInfo, IDictionary<string, BinaryData> debugInfo, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Message = message;
            Param = @param;
        ...
        public IList<ApiError> Details { get; }
