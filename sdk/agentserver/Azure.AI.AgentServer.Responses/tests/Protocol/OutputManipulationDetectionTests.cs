...
/// <summary>
/// E2E protocol tests for detecting direct Models.ResponseObject.OutputItems manipulation (B30/S-033).
/// Validates that the SDK detects when a handler directly adds/removes items from
/// Models.ResponseObject.OutputItems without emitting corresponding output_item.* builder events.
/// </summary>
public class OutputManipulationDetectionTests : ProtocolTestBase
{
    ...
    {
        // Handler directly adds an item to Models.ResponseObject.OutputItems without emitting output_item.added
        ...
        [EnumeratorCancellation] CancellationToken ct = default)
    {
        ...
        stream.Response.OutputItems.Add(TestModels.OutputItemMessage(
            "fake-item-id",
