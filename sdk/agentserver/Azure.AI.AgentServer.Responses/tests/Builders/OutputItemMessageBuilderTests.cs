...
public class OutputItemMessageBuilderTests
{
    ...
    [Test]
    public void AddMessage_ReturnsOutputItemMessageBuilder()
    {
    ...
    [Test]
    public void OutputItemMessageBuilder_SharesSequenceNumberWithStream()
    {
        var stream = CreateStream();
