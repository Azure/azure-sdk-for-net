...
public class MultiOutputTests
{
    ...
    public void TwoMessages_HaveDistinctOutputIndicesAndItemIds()
    {
        ...
        var content0 = XAssert.IsContentPart(done0.Content[0], OpenAI.Responses.ResponseContentPartKind.OutputText);
        var content1 = XAssert.IsContentPart(done1.Content[0], OpenAI.Responses.ResponseContentPartKind.OutputText);
