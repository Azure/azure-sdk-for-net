...
public class WebSearchCallBuilderTests
{
    ...
    [Test]
    public void AddWebSearchCall_ReturnsWebSearchCallBuilder()
    {
    ...
    public void EmitAdded_ContainsInProgressWebSearchItem()
    {
        ...
        Assert.That(item.Status, Is.EqualTo(WebSearchCallStatus.InProgress));
    }
    ...
    public void EmitDone_ContainsCompletedWebSearchItem()
    {
        ...
        var item = XAssert.IsType<OutputItemWebSearchToolCall>(evt.Item);
        Assert.That(item.Id, Is.EqualTo(builder.ItemId));
        Assert.That(item.Status, Is.EqualTo(WebSearchCallStatus.Completed));
    }
