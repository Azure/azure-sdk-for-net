...
public class OutputItemBuilderTests
{
    ...
    {
        var stream = CreateStream();
        var item = new MCPApprovalResponse("req_1", true) { Id = "apr_1" };
        var builder = new OutputItemBuilder<MCPApprovalResponse>(stream, 2, "apr_test");
    ...
    {
        var stream = CreateStream();
        var item = new MCPApprovalResponse("req_1", false) { Id = "apr_1" };
        var builder = new OutputItemBuilder<MCPApprovalResponse>(stream, 0, "apr_test");
