...
public class OutputItemBuilderTests
{
    ...
    {
        var stream = CreateStream();
        var item = new OutputItemFunctionToolCall { CallId = "call_1", FunctionName = "myFunc", FunctionArguments = "{}" };
    ...
    {
        var stream = CreateStream();
        var addedItem = new OutputItemFunctionToolCall { CallId = "call_1", FunctionName = "myFunc", FunctionArguments = "" };
        var doneItem = new OutputItemFunctionToolCall { CallId = "call_1", FunctionName = "myFunc", FunctionArguments = "{\"result\":1}" };
        var builder = new OutputItemBuilder<OutputItemFunctionToolCall>(stream, 0, "fc_test");
    ...
    public void EmitAdded_ThenEmitDone_SequenceNumbersIncrement()
    {
        var stream = CreateStream();
        var addedItem = new OutputItemFunctionToolCall { CallId = "call_1", FunctionName = "myFunc", FunctionArguments = "{}" };
        var doneItem = new OutputItemFunctionToolCall { CallId = "call_1", FunctionName = "myFunc", FunctionArguments = "{}" };
        var builder = new OutputItemBuilder<OutputItemFunctionToolCall>(stream, 0, "fc_test");
