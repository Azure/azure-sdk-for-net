...
public class ReasoningItemBuilderTests
{
    ...
    public void EmitDone_ContainsAccumulatedSummaries()
    {
        ...
        Assert.That(((OpenAI.Responses.ReasoningSummaryTextPart)item.SummaryParts[0]).Text, Is.EqualTo("First summary"));
        Assert.That(((OpenAI.Responses.ReasoningSummaryTextPart)item.SummaryParts[1]).Text, Is.EqualTo("Second summary"));
    }
