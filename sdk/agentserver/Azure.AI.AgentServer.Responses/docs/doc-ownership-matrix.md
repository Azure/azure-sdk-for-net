...
| Topic | Canonical Document | Section | Audience |
|-------|-------------------|---------|----------|
| Design docs overview | [design/OVERVIEW.md](https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/agentserver/Azure.AI.AgentServer.Responses/docs/design/OVERVIEW.md) | (index) | .NET SDK contributors |
