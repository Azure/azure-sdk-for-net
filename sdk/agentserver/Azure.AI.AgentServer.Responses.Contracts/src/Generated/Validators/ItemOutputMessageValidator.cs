...
/// </summary>
public static partial class ItemOutputMessageValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        {
            var contentResult = OutputMessageContentValidator.Validate(contentProp);
            if (!contentResult.IsValid)
            {
                foreach (var e in contentResult.Errors)
                    errors.Add(e with { Path = "$.content" + e.Path[1..] });
            }
        }
