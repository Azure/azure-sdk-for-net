...
/// </summary>
public static partial class FunctionShellCallOutputExitOutcomeParamValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        // Required: exit_code
        if (!element.TryGetProperty("exit_code", out var exitCodeProp))
            errors.Add(new ValidationError("$.exit_code", "Required property 'exit_code' is missing"));
        else
        {
            if (exitCodeProp.ValueKind != JsonValueKind.Number)
                errors.Add(new ValidationError("$.exit_code", $"Expected integer, got {exitCodeProp.ValueKind}"));
        }
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("exit"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: exit"));
        }
