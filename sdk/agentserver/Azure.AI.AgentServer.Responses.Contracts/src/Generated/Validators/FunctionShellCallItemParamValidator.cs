...
/// </summary>
public static partial class FunctionShellCallItemParamValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        {
            var actionResult = FunctionShellActionParamValidator.Validate(actionProp);
        ...
        {
            var environmentResult = FunctionShellCallItemParamEnvironmentValidator.Validate(environmentProp);
