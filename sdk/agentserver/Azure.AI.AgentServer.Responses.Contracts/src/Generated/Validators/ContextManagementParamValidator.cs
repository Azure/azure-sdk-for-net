...
/// </summary>
public static partial class ContextManagementParamValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        // Optional: compact_threshold
        if (element.TryGetProperty("compact_threshold", out var compactThresholdProp) && compactThresholdProp.ValueKind != JsonValueKind.Null)
        {
            if (compactThresholdProp.ValueKind != JsonValueKind.Number)
                errors.Add(new ValidationError("$.compact_threshold", $"Expected integer, got {compactThresholdProp.ValueKind}"));
        }
