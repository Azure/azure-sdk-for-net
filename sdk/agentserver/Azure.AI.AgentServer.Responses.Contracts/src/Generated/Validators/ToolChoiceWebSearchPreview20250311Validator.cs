...
/// </summary>
public static partial class ToolChoiceWebSearchPreview20250311Validator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("web_search_preview_2025_03_11"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: web_search_preview_2025_03_11"));
        }
