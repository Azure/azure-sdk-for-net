...
/// </summary>
public static partial class BingCustomSearchToolCallValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("bing_custom_search_preview_call"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: bing_custom_search_preview_call"));
        }
