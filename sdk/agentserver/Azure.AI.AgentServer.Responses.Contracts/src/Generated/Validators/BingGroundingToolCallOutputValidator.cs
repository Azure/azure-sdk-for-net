...
/// </summary>
public static partial class BingGroundingToolCallOutputValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        else
        {
            ...
            else if (typeValProp.GetString() is not ("bing_grounding_call_output"))
                errors.Add(new ValidationError("$.type", $"Value '{typeValProp.GetString()}' is not valid. Allowed: bing_grounding_call_output"));
        }
