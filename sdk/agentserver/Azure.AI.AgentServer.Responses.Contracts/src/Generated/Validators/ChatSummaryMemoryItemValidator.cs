...
/// </summary>
public static partial class ChatSummaryMemoryItemValidator
{
    /// <summary>
    ...
    public static ValidationResult Validate(JsonElement element)
    {
        ...
        else
        {
            ...
            else if (kindProp.GetString() is not ("chat_summary"))
                errors.Add(new ValidationError("$.kind", $"Value '{kindProp.GetString()}' is not valid. Allowed: chat_summary"));
        }
