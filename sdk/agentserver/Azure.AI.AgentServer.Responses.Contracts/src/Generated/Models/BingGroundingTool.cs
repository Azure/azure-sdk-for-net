...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class BingGroundingTool : Tool
    {
        ...
        /// <param name="bingGrounding"> The bing grounding search tool parameters. </param>
        internal BingGroundingTool(ToolType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, BingGroundingSearchToolParameters bingGrounding) : base(@type, additionalBinaryDataProperties)
        {
            BingGrounding = bingGrounding;
        }
