...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class SharepointGroundingToolCall : OutputItem
    {
        ...
        public SharepointGroundingToolCall(string callId, string arguments, ToolCallStatus status) : base(OutputItemType.SharepointGroundingPreviewCall)
        {
