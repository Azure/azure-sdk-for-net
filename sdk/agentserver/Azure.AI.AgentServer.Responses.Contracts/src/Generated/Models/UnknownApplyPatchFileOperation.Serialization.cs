...
{
    internal partial class UnknownApplyPatchFileOperation : ApplyPatchFileOperation, IJsonModel<ApplyPatchFileOperation>
    {
        /// <summary> Initializes a new instance of <see cref="UnknownApplyPatchFileOperation"/> for deserialization. </summary>
        internal UnknownApplyPatchFileOperation()
        {
        }

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override ApplyPatchFileOperation PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override ApplyPatchFileOperation JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApplyPatchFileOperation>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownApplyPatchFileOperation DeserializeUnknownApplyPatchFileOperation(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownApplyPatchFileOperation(@type, additionalBinaryDataProperties);
        }
    }
}
