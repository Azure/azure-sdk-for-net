...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class AgentsPagedResultResponse
    {
        ...
        internal AgentsPagedResultResponse(IEnumerable<Response> data, bool hasMore)
        {
            Data = data.ToList();
            HasMore = hasMore;
        }
        ...
        internal AgentsPagedResultResponse(IList<Response> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        public IList<Response> Data { get; }
