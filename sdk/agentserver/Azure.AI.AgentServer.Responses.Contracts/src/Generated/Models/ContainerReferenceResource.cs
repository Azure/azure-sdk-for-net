...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class ContainerReferenceResource : FunctionShellCallEnvironment
    {
        ...
        /// <param name="containerId"></param>
        internal ContainerReferenceResource(FunctionShellCallEnvironmentType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string containerId) : base(@type, additionalBinaryDataProperties)
        {
            ContainerId = containerId;
        }
