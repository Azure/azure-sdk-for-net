...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class ItemCustomToolCall : Item
    {
        /// <summary> Initializes a new instance of <see cref="ItemCustomToolCall"/>. </summary>
        ...
        public ItemCustomToolCall(string callId, string name, string input) : base(ItemType.CustomToolCall)
        {
        ...
        /// <param name="name"> The name of the custom tool being called. </param>
        /// <param name="input"> The input for the custom tool call generated by the model. </param>
        internal ItemCustomToolCall(ItemType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string callId, string name, string input) : base(@type, additionalBinaryDataProperties)
        {
            Id = id;
            CallId = callId;
            Name = name;
