...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class OutputItemComputerToolCall : OutputItem
    {
        ...
        public OutputItemComputerToolCall(string id, string callId, ComputerAction action, IEnumerable<ComputerCallSafetyCheckParam> pendingSafetyChecks, OutputItemComputerToolCallStatus status) : base(OutputItemType.ComputerCall)
        {
        ...
        ///   `incomplete`. Populated when items are returned via API.
        /// </param>
        internal OutputItemComputerToolCall(OutputItemType @type, BinaryData createdBy, AgentReference agentReference, string responseId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string callId, ComputerAction action, IList<ComputerCallSafetyCheckParam> pendingSafetyChecks, OutputItemComputerToolCallStatus status) : base(@type, createdBy, agentReference, responseId, additionalBinaryDataProperties)
        {
            Id = id;
            CallId = callId;
            Action = action;
