...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class ApplyPatchCreateFileOperationParam : ApplyPatchOperationParam, IJsonModel<ApplyPatchCreateFileOperationParam>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApplyPatchCreateFileOperationParam>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeApplyPatchCreateFileOperationParam(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(ApplyPatchCreateFileOperationParam)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApplyPatchCreateFileOperationParam)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApplyPatchCreateFileOperationParam)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApplyPatchCreateFileOperationParam IJsonModel<ApplyPatchCreateFileOperationParam>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ApplyPatchCreateFileOperationParam)JsonModelCreateCore(ref reader, options);
        ...
        protected override ApplyPatchOperationParam JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApplyPatchCreateFileOperationParam)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ApplyPatchCreateFileOperationParam DeserializeApplyPatchCreateFileOperationParam(JsonElement element, ModelReaderWriterOptions options)
        {
