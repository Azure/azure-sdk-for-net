...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class LogProb
    {
        ...
        internal LogProb(string token, double logprob, IList<long> bytes, IList<TopLogProb> topLogprobs, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Token = token;
            Logprob = logprob;
            Bytes = bytes;
