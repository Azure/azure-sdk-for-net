...
{
    internal partial class UnknownResponseStreamEvent : ResponseStreamEvent, IJsonModel<ResponseStreamEvent>
    {
        ...
        internal static UnknownResponseStreamEvent DeserializeUnknownResponseStreamEvent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownResponseStreamEvent(@type, sequenceNumber, additionalBinaryDataProperties);
        }
    }
}
