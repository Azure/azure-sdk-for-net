...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class FabricDataAgentToolCall : OutputItem
    {
        ...
        public FabricDataAgentToolCall(string callId, string arguments, ToolCallStatus status) : base(OutputItemType.FabricDataagentPreviewCall)
        {
