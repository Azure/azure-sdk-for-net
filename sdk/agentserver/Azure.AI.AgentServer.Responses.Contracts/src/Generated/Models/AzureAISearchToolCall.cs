...
namespace Azure.AI.AgentServer.Responses.Models
{
    ...
    public partial class AzureAISearchToolCall : OutputItem
    {
        ...
        public AzureAISearchToolCall(string callId, string arguments, ToolCallStatus status) : base(OutputItemType.AzureAiSearchCall)
        {
