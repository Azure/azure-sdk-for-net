...
/// <summary>
/// Extension methods for creating immutable snapshots of <see cref="Response"/> objects.
/// </summary>
public static class ResponseSnapshotExtensions
{
    /// <summary>
    /// Creates an immutable deep copy of the <see cref="Response"/> via
    /// <see cref="ModelReaderWriter"/> round-trip serialization.
    /// </summary>
    /// <param name="response">The source response to snapshot.</param>
    /// <returns>
    /// A new <see cref="Response"/> instance that is fully independent of the original.
    ...
    /// <summary>
    /// If the event is a lifecycle event that embeds a <see cref="Response"/> reference,
    ...
    /// The mutable accumulator <see cref="Response"/> that has been updated by
    ...
    /// </remarks>
    public static void SnapshotEmbeddedResponse(this ResponseStreamEvent evt, Response accumulator)
    {
        switch (evt)
        {
