...
/// <summary>
/// Extension methods for <see cref="Response"/> that provide typed access
/// to BinaryData properties like <see cref="Response.ToolChoice"/> and
/// <see cref="Response.Instructions"/>.
/// </summary>
public static class ResponseExtensions
{
    /// <summary>
    /// Expands the <see cref="Response.ToolChoice"/> BinaryData into a typed
    ...
    /// <summary>
    /// Sets the <see cref="Response.ToolChoice"/> property from a typed
    ...
    /// <summary>
    /// Sets the <see cref="Response.ToolChoice"/> property from a
    ...
    /// <summary>
    /// Expands the <see cref="Response.Instructions"/> BinaryData into a typed list of
    ...
    /// <summary>
    /// Sets the <see cref="Response.Instructions"/> property from a plain text string.
    /// </summary>
    /// <param name="response">The response.</param>
    ...
    /// <summary>
    /// Sets the <see cref="Response.Instructions"/> property from a list of
