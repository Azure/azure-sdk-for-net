...
{
    /// <summary>Creates a <see cref="Models.Response"/> instance for mocking.</summary>
    ...
    /// <returns>A new <see cref="Models.Response"/> instance.</returns>
    ...
    /// <summary>Creates a <see cref="Models.ResponseError"/> instance for mocking.</summary>
    /// <param name="code">The error code.</param>
    /// <param name="message">The error message.</param>
    /// <returns>A new <see cref="Models.ResponseError"/> instance.</returns>
