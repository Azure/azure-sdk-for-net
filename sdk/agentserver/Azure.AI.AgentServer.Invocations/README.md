...
| `SessionId` | `string` | Resolved multi-turn session identifier (extracted from `agent_session_id` query parameter, `FOUNDRY_AGENT_SESSION_ID` env var, or a generated UUID — in that order). |
