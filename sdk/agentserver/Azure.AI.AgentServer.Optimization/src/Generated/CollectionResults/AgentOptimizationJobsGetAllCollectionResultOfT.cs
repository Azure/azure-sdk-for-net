...
namespace Azure.AI.AgentServer.Optimization
{
    internal partial class AgentOptimizationJobsGetAllCollectionResultOfT : Pageable<OptimizationJob>
    {
        ...
        /// <summary> Gets the pages of AgentOptimizationJobsGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AgentOptimizationJobsGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<OptimizationJob>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                AgentsPagedResultOptimizationJob result = (AgentsPagedResultOptimizationJob)response;
                yield return Page<OptimizationJob>.FromValues((IReadOnlyList<OptimizationJob>)result.Data, nextPage, response);
        ...
        {
            HttpMessage message = _client.CreateGetAllRequest(_foundryFeatures, _limit, _order, continuationToken, _before, _status, _agentName, _context);
