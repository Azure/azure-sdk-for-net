...
namespace Azure.AI.AgentServer.Optimization
{
    ...
    internal partial class AgentsPagedResultOptimizationCandidate : IJsonModel<AgentsPagedResultOptimizationCandidate>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="AgentsPagedResultOptimizationCandidate"/> from. </param>
        public static explicit operator AgentsPagedResultOptimizationCandidate(Response response)
        {
