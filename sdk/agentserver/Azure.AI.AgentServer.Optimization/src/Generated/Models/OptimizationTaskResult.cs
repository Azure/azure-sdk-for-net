...
namespace Azure.AI.AgentServer.Optimization
{
    ...
    internal partial class OptimizationTaskResult
    {
        ...
        internal OptimizationTaskResult(string taskName, IDictionary<string, double> scores, double compositeScore, int tokens, double durationSeconds, bool passed)
        {
            TaskName = taskName;
            Scores = scores;
        ...
        internal OptimizationTaskResult(string taskName, string query, IDictionary<string, double> scores, double compositeScore, int tokens, double durationSeconds, bool passed, string errorMessage, IDictionary<string, string> rationales, string response, string runId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TaskName = taskName;
            Query = query;
            Scores = scores;
