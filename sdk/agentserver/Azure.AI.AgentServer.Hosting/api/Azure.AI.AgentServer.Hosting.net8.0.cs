namespace Azure.AI.AgentServer.Hosting
{
    ...
    public sealed partial class AgentHostBuilder
    {
        ...
        public Azure.AI.AgentServer.Hosting.AgentHostApp Build() { throw null; }
        public Azure.AI.AgentServer.Hosting.AgentHostBuilder Configure(System.Action<Azure.AI.AgentServer.Hosting.AgentHostOptions> configure) { throw null; }
        public Azure.AI.AgentServer.Hosting.AgentHostBuilder ConfigureHealth(System.Action<Microsoft.Extensions.DependencyInjection.IHealthChecksBuilder> configure) { throw null; }
        public Azure.AI.AgentServer.Hosting.AgentHostBuilder ConfigureShutdown(System.TimeSpan timeout) { throw null; }
        public Azure.AI.AgentServer.Hosting.AgentHostBuilder ConfigureTracing(System.Action<OpenTelemetry.Trace.TracerProviderBuilder> configure) { throw null; }
