...
namespace Azure.AI.AgentServer.Contracts.Generated.Common
{
    public static class Optional
    {
        ...
        {
            return (collection != null) && !(collection is ChangeTrackingList<T> changeTrackingList && changeTrackingList.IsUndefined);
        }

        public static bool IsCollectionDefined<TKey, TValue>(IDictionary<TKey, TValue> collection)
        {
            return (collection != null) && !(collection is ChangeTrackingDictionary<TKey, TValue> changeTrackingDictionary && changeTrackingDictionary.IsUndefined);
        }
