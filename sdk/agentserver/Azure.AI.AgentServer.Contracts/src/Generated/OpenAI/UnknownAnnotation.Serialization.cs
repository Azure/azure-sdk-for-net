...
{
    public partial class UnknownAnnotation : IUtf8JsonSerializable, IJsonModel<Annotation>
    {
        ...
        public static UnknownAnnotation DeserializeUnknownAnnotation(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownAnnotation(type, serializedAdditionalRawData);
        }
        ...
        public static new UnknownAnnotation FromResponse(Azure.Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeUnknownAnnotation(document.RootElement);
        }
        ...
        public override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<Annotation>(this, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
