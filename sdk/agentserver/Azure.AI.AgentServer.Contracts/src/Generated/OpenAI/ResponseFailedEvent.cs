...
namespace Azure.AI.AgentServer.Contracts.Generated.OpenAI
{
    ...
    public partial class ResponseFailedEvent : ResponseStreamEvent
    {
        ...
        public ResponseFailedEvent(int sequenceNumber, Responses.Response response) : base(sequenceNumber)
        {
        ...
        /// <param name="response"> The response that failed. </param>
        public ResponseFailedEvent(ResponseStreamEventType type, int sequenceNumber, IDictionary<string, BinaryData> serializedAdditionalRawData, Responses.Response response) : base(type, sequenceNumber, serializedAdditionalRawData)
        {
            Response = response;
        }
