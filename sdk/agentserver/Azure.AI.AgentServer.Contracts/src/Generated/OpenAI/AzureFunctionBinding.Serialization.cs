...
namespace Azure.AI.AgentServer.Contracts.Generated.OpenAI
{
    public partial class AzureFunctionBinding : IUtf8JsonSerializable, IJsonModel<AzureFunctionBinding>
    {
        ...
        public static AzureFunctionBinding DeserializeAzureFunctionBinding(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        public static AzureFunctionBinding FromResponse(Azure.Response response)
        {
