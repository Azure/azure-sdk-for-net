...
namespace Azure.AI.AgentServer.Contracts.Generated.OpenAI
{
    ...
    public partial class ComputerToolCallItemParam : ItemParam
    {
        ...
        /// </param>
        /// <param name="pendingSafetyChecks"> The pending safety checks for the computer call. </param>
        public ComputerToolCallItemParam(ItemType type, IDictionary<string, BinaryData> serializedAdditionalRawData, string callId, ComputerAction action, IList<ComputerToolCallSafetyCheck> pendingSafetyChecks) : base(type, serializedAdditionalRawData)
        {
            CallId = callId;
            Action = action;
