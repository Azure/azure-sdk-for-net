...
{
    public partial class UnknownItemResource : IUtf8JsonSerializable, IJsonModel<ItemResource>
    {
        ...
        public static UnknownItemResource DeserializeUnknownItemResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownItemResource(type, id, createdBy, serializedAdditionalRawData);
        }
        ...
        public static new UnknownItemResource FromResponse(Azure.Response response)
        {
        ...
        public override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<ItemResource>(this, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
