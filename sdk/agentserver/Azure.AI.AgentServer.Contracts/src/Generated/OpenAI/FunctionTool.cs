...
namespace Azure.AI.AgentServer.Contracts.Generated.OpenAI
{
    ...
    public partial class FunctionTool : Tool
    {
        ...
        /// <param name="parameters"> A JSON schema object describing the parameters of the function. </param>
        /// <param name="strict"> Whether to enforce strict parameter validation. Default `true`. </param>
        public FunctionTool(ToolType type, IDictionary<string, BinaryData> serializedAdditionalRawData, string name, string description, BinaryData parameters, bool? strict) : base(type, serializedAdditionalRawData)
        {
            Name = name;
