...
namespace Azure.AI.AgentServer.Contracts.Generated.OpenAI
{
    ...
    public partial class ResponsesDeveloperMessageItemResource : ResponsesMessageItemResource
    {
        ...
        public ResponsesDeveloperMessageItemResource(string id, ResponsesMessageItemResourceStatus status, IEnumerable<ItemContent> content, CreatedBy createdBy = null) : base(ItemType.Message, id, createdBy, null, status, ResponsesMessageRole.Developer)
        {
