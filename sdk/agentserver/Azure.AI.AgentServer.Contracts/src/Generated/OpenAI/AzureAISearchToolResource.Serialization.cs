...
namespace Azure.AI.AgentServer.Contracts.Generated.OpenAI
{
    public partial class AzureAISearchToolResource : IUtf8JsonSerializable, IJsonModel<AzureAISearchToolResource>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                writer.WritePropertyName("indexList"u8);
        ...
        public static AzureAISearchToolResource DeserializeAzureAISearchToolResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IList<AISearchIndexResource> indexList = default;
            IDictionary<string, BinaryData> serializedAdditionalRawData = default;
            Dictionary<string, BinaryData> rawDataDictionary = new Dictionary<string, BinaryData>();
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("indexList"u8))
                {
            ...
            return new AzureAISearchToolResource(indexList ?? new ChangeTrackingList<AISearchIndexResource>(), serializedAdditionalRawData);
        }
        ...
        public static AzureAISearchToolResource FromResponse(Azure.Response response)
        {
