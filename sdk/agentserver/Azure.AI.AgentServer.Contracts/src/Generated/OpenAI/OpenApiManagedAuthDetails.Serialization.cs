...
namespace Azure.AI.AgentServer.Contracts.Generated.OpenAI
{
    public partial class OpenApiManagedAuthDetails : IUtf8JsonSerializable, IJsonModel<OpenApiManagedAuthDetails>
    {
        ...
        public static OpenApiManagedAuthDetails DeserializeOpenApiManagedAuthDetails(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        public static new OpenApiManagedAuthDetails FromResponse(Azure.Response response)
        {
