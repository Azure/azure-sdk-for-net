...
{
    public partial class ComputerToolCallOutputItemResource : IUtf8JsonSerializable, IJsonModel<ComputerToolCallOutputItemResource>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputerToolCallOutputItemResource>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        public static ComputerToolCallOutputItemResource DeserializeComputerToolCallOutputItemResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        public static new ComputerToolCallOutputItemResource FromResponse(Azure.Response response)
        {
