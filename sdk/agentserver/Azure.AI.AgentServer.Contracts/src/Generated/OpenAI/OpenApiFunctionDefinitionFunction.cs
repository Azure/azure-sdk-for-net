...
namespace Azure.AI.AgentServer.Contracts.Generated.OpenAI
{
    ...
    public partial class OpenApiFunctionDefinitionFunction
    {
        ...
        public OpenApiFunctionDefinitionFunction(string name, string description, BinaryData parameters, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
