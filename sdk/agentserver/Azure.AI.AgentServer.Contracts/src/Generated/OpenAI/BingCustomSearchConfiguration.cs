...
namespace Azure.AI.AgentServer.Contracts.Generated.OpenAI
{
    ...
    public partial class BingCustomSearchConfiguration
    {
        ...
        public BingCustomSearchConfiguration(string projectConnectionId, string instanceName, string market, string setLang, long? count, string freshness, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectConnectionId = projectConnectionId;
            InstanceName = instanceName;
            Market = market;
