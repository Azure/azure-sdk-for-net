...
namespace Azure.AI.AgentServer.Contracts.Generated.OpenAI
{
    public partial class AzureFunctionDefinition : IUtf8JsonSerializable, IJsonModel<AzureFunctionDefinition>
    {
        ...
        public static AzureFunctionDefinition DeserializeAzureFunctionDefinition(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        public static AzureFunctionDefinition FromResponse(Azure.Response response)
        {
