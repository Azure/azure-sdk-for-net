...
namespace Azure.AI.AgentServer.Contracts.Generated.OpenAI
{
    ...
    public partial class BingGroundingSearchConfiguration
    {
        ...
        public BingGroundingSearchConfiguration(string projectConnectionId, string market, string setLang, long? count, string freshness, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProjectConnectionId = projectConnectionId;
            Market = market;
            SetLang = setLang;
