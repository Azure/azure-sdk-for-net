...
namespace Azure.AI.AgentServer.Contracts.Generated.MemoryStore
{
    ...
    public partial class UserProfileMemoryItem : MemoryItem
    {
        ...
        public UserProfileMemoryItem(string memoryId, DateTimeOffset updatedAt, string scope, string content) : base(memoryId, updatedAt, scope, content)
        {
        ...
        public UserProfileMemoryItem(string memoryId, DateTimeOffset updatedAt, string scope, string content, MemoryItemKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(memoryId, updatedAt, scope, content, kind, serializedAdditionalRawData)
        {
        }
