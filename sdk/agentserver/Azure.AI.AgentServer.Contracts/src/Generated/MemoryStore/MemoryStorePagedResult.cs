...
namespace Azure.AI.AgentServer.Contracts.Generated.MemoryStore
{
    ...
    public partial class MemoryStorePagedResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="MemoryStorePagedResult"/>. </summary>
        ...
        public MemoryStorePagedResult(IEnumerable<MemoryStoreObject> data, bool hasMore)
        {
        ...
        public MemoryStorePagedResult(IReadOnlyList<MemoryStoreObject> data, string firstId, string lastId, bool hasMore, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Data = data;
            FirstId = firstId;
            LastId = lastId;
        ...
        /// <summary> Initializes a new instance of <see cref="MemoryStorePagedResult"/> for deserialization. </summary>
        public MemoryStorePagedResult()
        {
        }

        /// <summary> The requested list of items. </summary>
        public IReadOnlyList<MemoryStoreObject> Data { get; }
