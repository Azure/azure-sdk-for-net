...
namespace Azure.AI.AgentServer.Contracts.Generated.Agents.WorkflowAgents
{
    ...
    public partial class InvokeAzureAgentWorkflowActionOutputItemResource : WorkflowActionOutputItemResource
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="id"/>, <paramref name="actionId"/>, <paramref name="agent"/> or <paramref name="responseId"/> is null. </exception>
        public InvokeAzureAgentWorkflowActionOutputItemResource(string id, string actionId, WorkflowActionOutputItemResourceStatus status, AgentId agent, string responseId) : base(id, actionId, status)
        {
        ...
        /// <param name="responseId"> The response id for the agent invocation. </param>
        public InvokeAzureAgentWorkflowActionOutputItemResource(ItemType type, string id, CreatedBy createdBy, IDictionary<string, BinaryData> serializedAdditionalRawData, string kind, string actionId, string parentActionId, string previousActionId, WorkflowActionOutputItemResourceStatus status, AgentId agent, string conversationId, string responseId) : base(type, id, createdBy, serializedAdditionalRawData, kind, actionId, parentActionId, previousActionId, status)
        {
            Agent = agent;
