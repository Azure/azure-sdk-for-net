...
{
    internal partial class ContainerServiceAIManagerArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of ContainerServiceAIManagerArmOperation for mocking. </summary>
        protected ContainerServiceAIManagerArmOperation()
        {
        }
        ...
        internal ContainerServiceAIManagerArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal ContainerServiceAIManagerArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "ContainerServiceAIManagerArmOperation",
                null,
