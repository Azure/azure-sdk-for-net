...
namespace Azure.ResourceManager.ContainerServiceAIManager.Models
{
    ...
    public static partial class ArmContainerServiceAIManagerModelFactory
    {
        ...
        public static AIManagerProperties AIManagerProperties(AIManagerProvisioningState? provisioningState = default, DeletePolicy? deletePolicy = default, string managedResourceGroupName = default, ResourceIdentifier clusterResourceId = default)
        {
        ...
        public static ModelSourceProperties ModelSourceProperties(ResourceProvisioningState? provisioningState = default, ModelSourceType sourceType = default, string description = default, CredentialValue credential = default, ResourceIdentifier microsoftFoundryProjectResourceId = default)
        {
        ...
        public static CustomAIModelData CustomAIModelData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, CustomAIModelProperties properties = default, string eTag = default)
        {
