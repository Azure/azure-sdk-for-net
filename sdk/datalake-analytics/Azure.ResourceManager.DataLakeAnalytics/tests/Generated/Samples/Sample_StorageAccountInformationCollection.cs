...
{
    public partial class Sample_StorageAccountInformationCollection
    {
        ...
        {
            // Generated from example definition: specification/datalake-analytics/resource-manager/Microsoft.DataLakeAnalytics/preview/2019-11-01-preview/examples/StorageAccounts_ListByAccount.json
            ...
            // get the collection of this StorageAccountInformationResource
            StorageAccountInformationCollection collection = dataLakeAnalyticsAccount.GetAllStorageAccountInformation();
            ...
            bool? count = false;
            await foreach (StorageAccountInformationResource item in collection.GetAllAsync(filter: filter, top: top, skip: skip, select: select, orderby: orderby, count: count))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                StorageAccountInformationData resourceData = item.Data;
        ...
        {
            // Generated from example definition: specification/datalake-analytics/resource-manager/Microsoft.DataLakeAnalytics/preview/2019-11-01-preview/examples/StorageAccounts_Add.json
            ...
            StorageAccountInformationCreateOrUpdateContent content = new StorageAccountInformationCreateOrUpdateContent("34adfa4f-cedf-4dc0-ba29-b6d1a69ab346")
            {
                Suffix = "test_suffix",
            };
        ...
        public async Task Get_GetsTheSpecifiedAzureStorageAccount()
        {
            ...
            // invoke the operation
            string storageAccountName = "test_storage";
            StorageAccountInformationResource result = await collection.GetAsync(storageAccountName);
