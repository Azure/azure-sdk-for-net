    ...
    public partial class DataLakeStoreAccountInformationCollection : ArmCollection, IEnumerable<DataLakeStoreAccountInformationResource>, IAsyncEnumerable<DataLakeStoreAccountInformationResource>
    {
        ...
        public virtual AsyncPageable<DataLakeStoreAccountInformationResource> GetAllAsync(DataLakeStoreAccountInformationCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<DataLakeStoreAccountInformationResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _dataLakeStoreAccountInformationDataLakeStoreAccountsRestClient.ListByAccountAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, options.Select, options.Orderby, options.Count, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<DataLakeStoreAccountInformationResource> GetAll(DataLakeStoreAccountInformationCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            Page<DataLakeStoreAccountInformationResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _dataLakeStoreAccountInformationDataLakeStoreAccountsRestClient.ListByAccount(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, options.Select, options.Orderby, options.Count, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DataLakeStoreAccountInformationResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<DataLakeStoreAccountInformationResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _dataLakeStoreAccountInformationDataLakeStoreAccountsRestClient.ListByAccountNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, options.Select, options.Orderby, options.Count, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DataLakeStoreAccountInformationResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
