...
namespace Azure.ResourceManager.DataLakeAnalytics
{
    public partial class DataLakeAnalyticsAccountResource : IJsonModel<DataLakeAnalyticsAccountData>
    {
        ...
        BinaryData IPersistableModel<DataLakeAnalyticsAccountData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        DataLakeAnalyticsAccountData IPersistableModel<DataLakeAnalyticsAccountData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<DataLakeAnalyticsAccountData>(data, options);
