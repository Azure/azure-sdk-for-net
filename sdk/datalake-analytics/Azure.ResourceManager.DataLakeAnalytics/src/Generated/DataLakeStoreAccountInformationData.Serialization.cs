...
namespace Azure.ResourceManager.DataLakeAnalytics
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeStoreAccountInformationData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        DataLakeStoreAccountInformationData IJsonModel<DataLakeStoreAccountInformationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataLakeStoreAccountInformationData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataLakeStoreAccountInformationData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataLakeStoreAccountInformationData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DataLakeStoreAccountInformationData IPersistableModel<DataLakeStoreAccountInformationData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataLakeStoreAccountInformationData)} does not support reading '{options.Format}' format.");
            }
        }
