...
namespace Azure.ResourceManager.DataLakeAnalytics
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeAnalyticsFirewallRuleData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        DataLakeAnalyticsFirewallRuleData IJsonModel<DataLakeAnalyticsFirewallRuleData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataLakeAnalyticsFirewallRuleData)} does not support reading '{format}' format.");
            }
        ...
        DataLakeAnalyticsFirewallRuleData IPersistableModel<DataLakeAnalyticsFirewallRuleData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataLakeAnalyticsFirewallRuleData)} does not support reading '{options.Format}' format.");
            }
        }
