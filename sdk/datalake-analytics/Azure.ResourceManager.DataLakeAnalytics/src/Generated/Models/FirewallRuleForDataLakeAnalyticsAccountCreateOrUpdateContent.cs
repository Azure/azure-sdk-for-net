...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    public partial class FirewallRuleForDataLakeAnalyticsAccountCreateOrUpdateContent
    {
        ...
        internal FirewallRuleForDataLakeAnalyticsAccountCreateOrUpdateContent(string name, IPAddress startIPAddress, IPAddress endIPAddress, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            StartIPAddress = startIPAddress;
            EndIPAddress = endIPAddress;
