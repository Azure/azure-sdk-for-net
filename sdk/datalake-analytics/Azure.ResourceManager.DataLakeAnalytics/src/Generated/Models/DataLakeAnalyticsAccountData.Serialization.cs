...
namespace Azure.ResourceManager.DataLakeAnalytics
{
    ...
    {
        internal static DataLakeAnalyticsAccountData DeserializeDataLakeAnalyticsAccountData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
