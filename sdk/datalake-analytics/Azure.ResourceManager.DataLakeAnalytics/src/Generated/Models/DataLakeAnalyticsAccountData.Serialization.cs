...
namespace Azure.ResourceManager.DataLakeAnalytics
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeAnalyticsAccountData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataLakeAnalyticsAccountData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataLakeAnalyticsAccountData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataLakeAnalyticsAccountData>)} interface");
            }
        ...
        string IPersistableModel<DataLakeAnalyticsAccountData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
