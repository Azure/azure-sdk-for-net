...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeAnalyticsSasTokenInformationListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<DataLakeAnalyticsSasTokenInformation>)item).Write(writer, options);
                }
        ...
        DataLakeAnalyticsSasTokenInformationListResult IJsonModel<DataLakeAnalyticsSasTokenInformationListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataLakeAnalyticsSasTokenInformationListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static DataLakeAnalyticsSasTokenInformationListResult DeserializeDataLakeAnalyticsSasTokenInformationListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DataLakeAnalyticsSasTokenInformationListResult(value ?? new ChangeTrackingList<DataLakeAnalyticsSasTokenInformation>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<DataLakeAnalyticsSasTokenInformationListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataLakeAnalyticsSasTokenInformationListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DataLakeAnalyticsSasTokenInformationListResult IPersistableModel<DataLakeAnalyticsSasTokenInformationListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataLakeAnalyticsSasTokenInformationListResult)} does not support reading '{options.Format}' format.");
            }
        }
