...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputePolicyForDataLakeAnalyticsAccountUpdateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputePolicyForDataLakeAnalyticsAccountUpdateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComputePolicyForDataLakeAnalyticsAccountUpdateContent>)} interface");
            }
        ...
        string IPersistableModel<ComputePolicyForDataLakeAnalyticsAccountUpdateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
