...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeAnalyticsVirtualNetworkRule>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        DataLakeAnalyticsVirtualNetworkRule IJsonModel<DataLakeAnalyticsVirtualNetworkRule>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<DataLakeAnalyticsVirtualNetworkRule>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        DataLakeAnalyticsVirtualNetworkRule IModel<DataLakeAnalyticsVirtualNetworkRule>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<DataLakeAnalyticsVirtualNetworkRule>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
