...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeAnalyticsStorageAccountInformationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DataLakeAnalyticsStorageAccountInformationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataLakeAnalyticsStorageAccountInformationListResult>)} interface");
            }
        ...
        string IPersistableModel<DataLakeAnalyticsStorageAccountInformationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
