...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    internal partial class DataLakeAnalyticsStorageAccountInformationListResult
    {
        internal static DataLakeAnalyticsStorageAccountInformationListResult DeserializeDataLakeAnalyticsStorageAccountInformationListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<DataLakeAnalyticsStorageAccountInformationData>> value = default;
            ...
            return new DataLakeAnalyticsStorageAccountInformationListResult(Core.Optional.ToList(value), nextLink.Value);
        }
    }
}
