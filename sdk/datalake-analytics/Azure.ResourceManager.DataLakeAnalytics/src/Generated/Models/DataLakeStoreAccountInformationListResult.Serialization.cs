...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeStoreAccountInformationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataLakeStoreAccountInformationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataLakeStoreAccountInformationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataLakeStoreAccountInformationListResult>)} interface");
            }
        ...
        string IPersistableModel<DataLakeStoreAccountInformationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
