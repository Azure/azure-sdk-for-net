...
{
    internal partial class DataLakeStoreAccountInformationListResult : IUtf8JsonSerializable, IJsonModel<DataLakeStoreAccountInformationListResult>, IPersistableModel<DataLakeStoreAccountInformationListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeStoreAccountInformationListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataLakeStoreAccountInformationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataLakeStoreAccountInformationListResult)} does not support '{format}' format.");
            }
