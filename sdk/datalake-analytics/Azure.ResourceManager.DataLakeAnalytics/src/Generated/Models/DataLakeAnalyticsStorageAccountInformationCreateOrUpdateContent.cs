...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    public partial class DataLakeAnalyticsStorageAccountInformationCreateOrUpdateContent
    {
        ...
        internal DataLakeAnalyticsStorageAccountInformationCreateOrUpdateContent(string accessKey, string suffix, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AccessKey = accessKey;
            Suffix = suffix;
