...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    public partial class FirewallRuleForDataLakeAnalyticsAccountUpdateContent
    {
        ...
        internal FirewallRuleForDataLakeAnalyticsAccountUpdateContent(string name, IPAddress startIPAddress, IPAddress endIPAddress, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
