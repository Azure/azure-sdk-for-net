...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    public partial class StorageAccountForDataLakeAnalyticsAccountUpdateContent
    {
        ...
        internal StorageAccountForDataLakeAnalyticsAccountUpdateContent(string name, string accessKey, string suffix, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            AccessKey = accessKey;
            Suffix = suffix;
