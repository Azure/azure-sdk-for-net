...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirewallRuleForDataLakeAnalyticsAccountUpdateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FirewallRuleForDataLakeAnalyticsAccountUpdateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirewallRuleForDataLakeAnalyticsAccountUpdateContent>)} interface");
            }
        ...
        string IPersistableModel<FirewallRuleForDataLakeAnalyticsAccountUpdateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
