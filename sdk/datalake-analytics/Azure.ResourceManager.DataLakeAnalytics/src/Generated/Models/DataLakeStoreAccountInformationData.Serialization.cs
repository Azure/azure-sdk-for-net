...
namespace Azure.ResourceManager.DataLakeAnalytics
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeStoreAccountInformationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataLakeStoreAccountInformationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataLakeStoreAccountInformationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataLakeStoreAccountInformationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
