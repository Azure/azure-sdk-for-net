...
{
    public partial class DataLakeAnalyticsFirewallRuleData : IUtf8JsonSerializable, IJsonModel<DataLakeAnalyticsFirewallRuleData>, IPersistableModel<DataLakeAnalyticsFirewallRuleData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeAnalyticsFirewallRuleData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataLakeAnalyticsFirewallRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataLakeAnalyticsFirewallRuleData)} does not support '{format}' format.");
            }
