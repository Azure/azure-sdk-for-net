...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    public partial class DataLakeAnalyticsStorageAccountInformationPatch : IUtf8JsonSerializable, IJsonModel<DataLakeAnalyticsStorageAccountInformationPatch>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DataLakeAnalyticsStorageAccountInformationPatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataLakeAnalyticsStorageAccountInformationPatch>)} interface");
            }
