...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    public partial class DataLakeAnalyticsStorageAccountInformationPatch : IUtf8JsonSerializable, IJsonModel<DataLakeAnalyticsStorageAccountInformationPatch>
    {
        ...
        void IJsonModel<DataLakeAnalyticsStorageAccountInformationPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DataLakeAnalyticsStorageAccountInformationPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataLakeAnalyticsStorageAccountInformationPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DataLakeAnalyticsStorageAccountInformationPatch)} does not support '{options.Format}' format.");
            }
        }
