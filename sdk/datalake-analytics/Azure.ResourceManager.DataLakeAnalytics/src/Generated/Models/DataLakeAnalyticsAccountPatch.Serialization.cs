...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeAnalyticsAccountPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataLakeAnalyticsAccountPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataLakeAnalyticsAccountPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataLakeAnalyticsAccountPatch>)} interface");
            }
        ...
        string IPersistableModel<DataLakeAnalyticsAccountPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
