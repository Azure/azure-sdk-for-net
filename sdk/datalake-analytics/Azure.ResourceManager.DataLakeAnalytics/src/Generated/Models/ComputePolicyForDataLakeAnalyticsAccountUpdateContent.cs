...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    public partial class ComputePolicyForDataLakeAnalyticsAccountUpdateContent
    {
        ...
        internal ComputePolicyForDataLakeAnalyticsAccountUpdateContent(string name, Guid? objectId, AadObjectIdentifierType? objectType, int? maxDegreeOfParallelismPerJob, int? minPriorityPerJob, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            ObjectId = objectId;
