...
namespace Azure.ResourceManager.DataLakeAnalytics.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataLakeAnalyticsComputePolicyPatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        DataLakeAnalyticsComputePolicyPatch IJsonModel<DataLakeAnalyticsComputePolicyPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataLakeAnalyticsComputePolicyPatch)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataLakeAnalyticsComputePolicyPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataLakeAnalyticsComputePolicyPatch)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DataLakeAnalyticsComputePolicyPatch IPersistableModel<DataLakeAnalyticsComputePolicyPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DataLakeAnalyticsComputePolicyPatch)} does not support reading '{options.Format}' format.");
            }
        }
