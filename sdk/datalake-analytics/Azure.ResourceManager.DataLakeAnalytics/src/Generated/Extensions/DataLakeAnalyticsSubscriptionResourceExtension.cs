...
namespace Azure.ResourceManager.DataLakeAnalytics.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class DataLakeAnalyticsSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataLakeAnalyticsSubscriptionResourceExtension"/> class for mocking. </summary>
        protected DataLakeAnalyticsSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataLakeAnalyticsSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataLakeAnalyticsSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DataLakeAnalyticsAccountBasic> GetAccountsAsync(SubscriptionResourceGetAccountsOptions options, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, DataLakeAnalyticsAccountBasic.DeserializeDataLakeAnalyticsAccountBasic, DataLakeAnalyticsAccountAccountsClientDiagnostics, Pipeline, "DataLakeAnalyticsSubscriptionResourceExtension.GetAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DataLakeAnalyticsAccountBasic> GetAccounts(SubscriptionResourceGetAccountsOptions options, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => DataLakeAnalyticsAccountAccountsRestClient.CreateListRequest(Id.SubscriptionId, options.Filter, options.Top, options.Skip, options.Select, options.Orderby, options.Count);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DataLakeAnalyticsAccountAccountsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, options.Filter, options.Top, options.Skip, options.Select, options.Orderby, options.Count);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, DataLakeAnalyticsAccountBasic.DeserializeDataLakeAnalyticsAccountBasic, DataLakeAnalyticsAccountAccountsClientDiagnostics, Pipeline, "DataLakeAnalyticsSubscriptionResourceExtension.GetAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<DataLakeAnalyticsAccountNameAvailabilityResult>> CheckDataLakeAnalyticsAccountNameAvailabilityAsync(AzureLocation location, DataLakeAnalyticsAccountNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DataLakeAnalyticsAccountAccountsClientDiagnostics.CreateScope("DataLakeAnalyticsSubscriptionResourceExtension.CheckDataLakeAnalyticsAccountNameAvailability");
            scope.Start();
            try
            {
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("DataLakeAnalyticsSubscriptionResourceExtension.GetCapabilityLocation");
            scope.Start();
            try
            {
