...
namespace Azure.ResourceManager.DataLakeAnalytics.Mocking
{
    ...
    internal partial class DataLakeAnalyticsSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataLakeAnalyticsSubscriptionMockingExtension"/> class for mocking. </summary>
        protected DataLakeAnalyticsSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataLakeAnalyticsSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataLakeAnalyticsSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DataLakeAnalyticsAccountBasic> GetAccountsAsync(SubscriptionResourceGetAccountsOptions options, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, DataLakeAnalyticsAccountBasic.DeserializeDataLakeAnalyticsAccountBasic, DataLakeAnalyticsAccountAccountsClientDiagnostics, Pipeline, "DataLakeAnalyticsSubscriptionMockingExtension.GetAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DataLakeAnalyticsAccountBasic> GetAccounts(SubscriptionResourceGetAccountsOptions options, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DataLakeAnalyticsAccountAccountsRestClient.CreateListRequest(Id.SubscriptionId, options.Filter, options.Top, options.Skip, options.Select, options.Orderby, options.Count);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DataLakeAnalyticsAccountAccountsRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, options.Filter, options.Top, options.Skip, options.Select, options.Orderby, options.Count);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, DataLakeAnalyticsAccountBasic.DeserializeDataLakeAnalyticsAccountBasic, DataLakeAnalyticsAccountAccountsClientDiagnostics, Pipeline, "DataLakeAnalyticsSubscriptionMockingExtension.GetAccounts", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = DataLakeAnalyticsAccountAccountsClientDiagnostics.CreateScope("DataLakeAnalyticsSubscriptionMockingExtension.CheckDataLakeAnalyticsAccountNameAvailability");
            scope.Start();
            try
            {
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("DataLakeAnalyticsSubscriptionMockingExtension.GetCapabilityLocation");
            scope.Start();
            try
            {
