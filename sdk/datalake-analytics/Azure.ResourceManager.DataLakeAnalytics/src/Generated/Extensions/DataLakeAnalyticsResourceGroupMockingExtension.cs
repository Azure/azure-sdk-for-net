...
namespace Azure.ResourceManager.DataLakeAnalytics.Mocking
{
    ...
    internal partial class DataLakeAnalyticsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DataLakeAnalyticsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DataLakeAnalyticsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataLakeAnalyticsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataLakeAnalyticsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            return await GetDataLakeAnalyticsAccounts().GetAsync(accountName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetDataLakeAnalyticsAccounts().Get(accountName, cancellationToken);
        }
    }
}
