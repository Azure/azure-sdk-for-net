...
namespace Azure.ResourceManager.DataLakeAnalytics
{
    ...
    public static partial class DataLakeAnalyticsExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetDataLakeAnalyticsAccounts();
        }
        ...
        {
            return await GetSubscriptionResourceExtension(subscriptionResource).GetCapabilityLocationAsync(location, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetCapabilityLocation(location, cancellationToken);
        }
    }
}
