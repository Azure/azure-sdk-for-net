...
namespace Azure.ResourceManager.DataLake.Analytics
{
    ...
    public partial class ComputePolicyResource : ArmResource
    {
        ...
        {
            _computePolicyClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataLake.Analytics", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AnalyticsArmOperation(response);
