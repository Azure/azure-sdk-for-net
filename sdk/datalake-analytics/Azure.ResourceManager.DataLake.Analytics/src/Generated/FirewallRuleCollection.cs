...
namespace Azure.ResourceManager.DataLake.Analytics
{
    ...
    public partial class FirewallRuleCollection : ArmCollection, IEnumerable<FirewallRuleResource>, IAsyncEnumerable<FirewallRuleResource>
    {
        ...
        {
            _firewallRuleClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataLake.Analytics", FirewallRuleResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<FirewallRuleResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string firewallRuleName, FirewallRuleCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new AnalyticsArmOperation<FirewallRuleResource>(Response.FromValue(new FirewallRuleResource(Client, response), response.GetRawResponse()));
