...
namespace Azure.ResourceManager.DataLake.Analytics
{
    ...
    public partial class StorageContainerCollection : ArmCollection, IEnumerable<StorageContainerResource>, IAsyncEnumerable<StorageContainerResource>
    {
        ...
        {
            _storageContainerStorageAccountsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataLake.Analytics", StorageContainerResource.ResourceType.Namespace, Diagnostics);
