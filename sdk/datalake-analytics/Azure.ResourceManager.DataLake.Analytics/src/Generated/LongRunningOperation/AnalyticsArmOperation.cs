...
#pragma warning disable SA1649 // File name should match first type name
    internal class AnalyticsArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of AnalyticsArmOperation for mocking. </summary>
        protected AnalyticsArmOperation()
        {
        }

        internal AnalyticsArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal AnalyticsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia)
        {
            ...
            _operation = new OperationInternal(clientDiagnostics, nextLinkOperation, response, "AnalyticsArmOperation", fallbackStrategy: new ExponentialDelayStrategy());
        }
