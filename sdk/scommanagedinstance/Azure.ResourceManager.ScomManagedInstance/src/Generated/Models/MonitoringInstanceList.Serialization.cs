...
namespace Azure.ResourceManager.ScomManagedInstance.Models
{
    ...
    {
        internal static MonitoringInstanceList DeserializeMonitoringInstanceList(JsonElement element)
        {
            ...
            return new MonitoringInstanceList(Optional.ToList(value), nextLink.Value);
        }
    }
}
