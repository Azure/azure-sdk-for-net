...
namespace Azure.ResourceManager.CosmosDBForPostgreSql
{
    public partial class CosmosDBForPostgreSqlPrivateLinkResource : IJsonModel<CosmosDBForPostgreSqlPrivateLinkResourceData>
    {
        ...
        {
            return ModelReaderWriter.Read<CosmosDBForPostgreSqlPrivateLinkResourceData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<CosmosDBForPostgreSqlPrivateLinkResourceData>(data, options);
        }
