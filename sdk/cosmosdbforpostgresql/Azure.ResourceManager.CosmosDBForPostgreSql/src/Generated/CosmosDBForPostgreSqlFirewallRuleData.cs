...
namespace Azure.ResourceManager.CosmosDBForPostgreSql
{
    ...
    public partial class CosmosDBForPostgreSqlFirewallRuleData : ResourceData
    {
        ...
        internal CosmosDBForPostgreSqlFirewallRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, FirewallRuleProperties properties) : base(id, name, resourceType, systemData)
        {
