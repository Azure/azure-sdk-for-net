...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Mocking
{
    ...
    internal partial class CosmosDBForPostgreSqlArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="CosmosDBForPostgreSqlArmClientMockingExtension"/> class for mocking. </summary>
        protected CosmosDBForPostgreSqlArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CosmosDBForPostgreSqlArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CosmosDBForPostgreSqlArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal CosmosDBForPostgreSqlArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
