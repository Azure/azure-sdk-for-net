...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Mocking
{
    ...
    internal partial class CosmosDBForPostgreSqlResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="CosmosDBForPostgreSqlResourceGroupMockingExtension"/> class for mocking. </summary>
        protected CosmosDBForPostgreSqlResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CosmosDBForPostgreSqlResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CosmosDBForPostgreSqlResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
