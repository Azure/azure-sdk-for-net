...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Testing
{
    ...
    public partial class CosmosDBForPostgreSqlSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CosmosDBForPostgreSqlSubscriptionResourceExtension"/> class for mocking. </summary>
        protected CosmosDBForPostgreSqlSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CosmosDBForPostgreSqlSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CosmosDBForPostgreSqlSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<CosmosDBForPostgreSqlClusterNameAvailabilityResult>> CheckCosmosDBForPostgreSqlClusterNameAvailabilityAsync(CosmosDBForPostgreSqlClusterNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CosmosDBForPostgreSqlClusterClustersClientDiagnostics.CreateScope("CosmosDBForPostgreSqlSubscriptionResourceExtension.CheckCosmosDBForPostgreSqlClusterNameAvailability");
            scope.Start();
            try
            {
