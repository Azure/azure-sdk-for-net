...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Mocking
{
    ...
    internal partial class CosmosDBForPostgreSqlSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CosmosDBForPostgreSqlSubscriptionMockingExtension"/> class for mocking. </summary>
        protected CosmosDBForPostgreSqlSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CosmosDBForPostgreSqlSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CosmosDBForPostgreSqlSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = CosmosDBForPostgreSqlClusterClustersClientDiagnostics.CreateScope("CosmosDBForPostgreSqlSubscriptionMockingExtension.CheckCosmosDBForPostgreSqlClusterNameAvailability");
            scope.Start();
            try
            {
