...
namespace Azure.ResourceManager.CosmosDBForPostgreSql
{
    ...
    public partial class FirewallRuleData : ResourceData
    {
        ...
        internal FirewallRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string startIPAddress, string endIPAddress, ProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
            StartIPAddress = startIPAddress;
            EndIPAddress = endIPAddress;
