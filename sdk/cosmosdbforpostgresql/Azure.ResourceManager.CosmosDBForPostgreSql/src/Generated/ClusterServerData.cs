...
{
    /// <summary>
    /// A class representing the ClusterServer data model.
    /// Represents a server in a cluster.
    /// </summary>
    public partial class ClusterServerData : ResourceData
    {
        ...
        internal ClusterServerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string serverEdition, int? storageQuotaInMb, int? vCores, bool? enableHa, bool? enablePublicIPAccess, bool? isReadOnly, string administratorLogin, string fullyQualifiedDomainName, ServerRole? role, string state, string haState, string availabilityZone, string postgresqlVersion, string citusVersion) : base(id, name, resourceType, systemData)
        {
