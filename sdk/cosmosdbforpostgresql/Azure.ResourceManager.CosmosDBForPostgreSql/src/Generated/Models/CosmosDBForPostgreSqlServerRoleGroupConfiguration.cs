...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Models
{
    ...
    public partial class CosmosDBForPostgreSqlServerRoleGroupConfiguration
    {
        ...
        internal CosmosDBForPostgreSqlServerRoleGroupConfiguration(CosmosDBForPostgreSqlServerRole role, string value, string defaultValue, string source, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Role = role;
            Value = value;
