...
{
    public partial class CosmosDBForPostgreSqlConfigurationData : IUtf8JsonSerializable, IJsonModel<CosmosDBForPostgreSqlConfigurationData>, IPersistableModel<CosmosDBForPostgreSqlConfigurationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(ServerRoleGroupConfigurations))
            {
                builder.Append("  serverRoleGroupConfigurations:");
                builder.AppendLine(" [");
                foreach (var item in ServerRoleGroupConfigurations)
                {
