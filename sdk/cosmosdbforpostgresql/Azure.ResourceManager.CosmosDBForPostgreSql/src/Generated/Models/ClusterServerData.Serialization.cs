...
{
    public partial class ClusterServerData : IUtf8JsonSerializable
    {
        ...
        internal static ClusterServerData DeserializeClusterServerData(JsonElement element)
        {
            ...
            Optional<ServerRole> role = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("role"u8))
                        {
                            ...
                            role = new ServerRole(property0.Value.GetString());
                            continue;
                        }
