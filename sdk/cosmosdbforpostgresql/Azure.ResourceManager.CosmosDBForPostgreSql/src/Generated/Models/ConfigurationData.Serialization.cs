...
namespace Azure.ResourceManager.CosmosDBForPostgreSql
{
    public partial class ConfigurationData : IUtf8JsonSerializable
    {
        ...
        internal static ConfigurationData DeserializeConfigurationData(JsonElement element)
        {
            ...
            Optional<IList<ServerRoleGroupConfiguration>> serverRoleGroupConfigurations = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("serverRoleGroupConfigurations"u8))
                        {
                            ...
                            List<ServerRoleGroupConfiguration> array = new List<ServerRoleGroupConfiguration>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(ServerRoleGroupConfiguration.DeserializeServerRoleGroupConfiguration(item));
                            }
            ...
            return new ConfigurationData(id, name, type, systemData.Value, description.Value, Optional.ToNullable(dataType), allowedValues.Value, Optional.ToNullable(requiresRestart), Optional.ToList(serverRoleGroupConfigurations), Optional.ToNullable(provisioningState));
        }
    }
}
