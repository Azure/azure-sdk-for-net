...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBForPostgreSqlPrivateLinkResourceListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBForPostgreSqlPrivateLinkResourceListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBForPostgreSqlPrivateLinkResourceListResult>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBForPostgreSqlPrivateLinkResourceListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
