...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Models
{
    ...
    public partial class CosmosDBForPostgreSqlPrivateLinkServiceConnectionState
    {
        ...
        internal CosmosDBForPostgreSqlPrivateLinkServiceConnectionState(CosmosDBForPostgreSqlPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired)
        {
            Status = status;
        ...
        public CosmosDBForPostgreSqlPrivateEndpointServiceConnectionStatus? Status { get; set; }
