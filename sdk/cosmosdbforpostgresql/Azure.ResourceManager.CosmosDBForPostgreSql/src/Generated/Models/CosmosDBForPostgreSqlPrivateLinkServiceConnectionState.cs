...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Models
{
    ...
    public partial class CosmosDBForPostgreSqlPrivateLinkServiceConnectionState
    {
        ...
        internal CosmosDBForPostgreSqlPrivateLinkServiceConnectionState(CosmosDBForPostgreSqlPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
