...
{
    internal partial class CosmosDBForPostgreSqlFirewallRuleListResult : IUtf8JsonSerializable, IJsonModel<CosmosDBForPostgreSqlFirewallRuleListResult>, IPersistableModel<CosmosDBForPostgreSqlFirewallRuleListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBForPostgreSqlFirewallRuleListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CosmosDBForPostgreSqlFirewallRuleListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBForPostgreSqlFirewallRuleListResult)} does not support '{format}' format.");
            }
