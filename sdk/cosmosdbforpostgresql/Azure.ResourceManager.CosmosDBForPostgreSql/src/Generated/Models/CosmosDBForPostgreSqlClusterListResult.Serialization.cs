...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBForPostgreSqlClusterListResult>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        CosmosDBForPostgreSqlClusterListResult IJsonModel<CosmosDBForPostgreSqlClusterListResult>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(CosmosDBForPostgreSqlClusterListResult)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<CosmosDBForPostgreSqlClusterListResult>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        CosmosDBForPostgreSqlClusterListResult IModel<CosmosDBForPostgreSqlClusterListResult>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<CosmosDBForPostgreSqlClusterListResult>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
