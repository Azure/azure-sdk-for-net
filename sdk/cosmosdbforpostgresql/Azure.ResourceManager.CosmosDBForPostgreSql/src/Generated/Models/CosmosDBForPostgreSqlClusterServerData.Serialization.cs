...
namespace Azure.ResourceManager.CosmosDBForPostgreSql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBForPostgreSqlClusterServerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBForPostgreSqlClusterServerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBForPostgreSqlClusterServerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBForPostgreSqlClusterServerData>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBForPostgreSqlClusterServerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
