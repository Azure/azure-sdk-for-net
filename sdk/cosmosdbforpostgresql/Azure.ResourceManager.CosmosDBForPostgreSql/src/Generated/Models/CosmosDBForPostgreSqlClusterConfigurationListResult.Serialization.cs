...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBForPostgreSqlClusterConfigurationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBForPostgreSqlClusterConfigurationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBForPostgreSqlClusterConfigurationListResult>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBForPostgreSqlClusterConfigurationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
