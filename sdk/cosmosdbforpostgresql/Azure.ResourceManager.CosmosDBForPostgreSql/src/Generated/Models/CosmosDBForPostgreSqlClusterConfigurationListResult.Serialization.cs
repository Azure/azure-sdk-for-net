...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Models
{
    internal partial class CosmosDBForPostgreSqlClusterConfigurationListResult : IUtf8JsonSerializable, IModelJsonSerializable<CosmosDBForPostgreSqlClusterConfigurationListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CosmosDBForPostgreSqlClusterConfigurationListResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<CosmosDBForPostgreSqlConfigurationData>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="CosmosDBForPostgreSqlClusterConfigurationListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CosmosDBForPostgreSqlClusterConfigurationListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CosmosDBForPostgreSqlClusterConfigurationListResult"/>. </summary>
