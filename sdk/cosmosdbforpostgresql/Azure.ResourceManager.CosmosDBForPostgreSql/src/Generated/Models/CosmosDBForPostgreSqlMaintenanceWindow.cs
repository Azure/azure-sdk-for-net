...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Models
{
    ...
    public partial class CosmosDBForPostgreSqlMaintenanceWindow
    {
        ...
        internal CosmosDBForPostgreSqlMaintenanceWindow(string customWindow, int? startHour, int? startMinute, int? dayOfWeek, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
