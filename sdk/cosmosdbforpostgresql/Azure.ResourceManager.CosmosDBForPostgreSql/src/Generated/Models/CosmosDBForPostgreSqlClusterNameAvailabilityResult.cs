...
namespace Azure.ResourceManager.CosmosDBForPostgreSql.Models
{
    ...
    public partial class CosmosDBForPostgreSqlClusterNameAvailabilityResult
    {
        ...
        internal CosmosDBForPostgreSqlClusterNameAvailabilityResult(string message, bool? isNameAvailable, string name, ResourceType? resourceType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Message = message;
