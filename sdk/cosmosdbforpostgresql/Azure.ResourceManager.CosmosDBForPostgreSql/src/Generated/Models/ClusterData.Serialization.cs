...
namespace Azure.ResourceManager.CosmosDBForPostgreSql
{
    public partial class ClusterData : IUtf8JsonSerializable
    {
        ...
        internal static ClusterData DeserializeClusterData(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<SimplePrivateEndpointConnection>> privateEndpointConnections = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("privateEndpointConnections"u8))
                        {
                            ...
                            List<SimplePrivateEndpointConnection> array = new List<SimplePrivateEndpointConnection>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(SimplePrivateEndpointConnection.DeserializeSimplePrivateEndpointConnection(item));
                            }
