...
{
    public partial class CosmosDBForPostgreSqlClusterData : IUtf8JsonSerializable, IJsonModel<CosmosDBForPostgreSqlClusterData>, IPersistableModel<CosmosDBForPostgreSqlClusterData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CoordinatorStorageQuotaInMb))
            {
                ...
                builder.AppendLine($" '{CoordinatorStorageQuotaInMb.Value.ToString()}'");
            }

            if (Optional.IsDefined(CoordinatorVCores))
            {
                builder.Append("  coordinatorVCores:");
                builder.AppendLine($" '{CoordinatorVCores.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(NodeStorageQuotaInMb))
            {
                ...
                builder.AppendLine($" '{NodeStorageQuotaInMb.Value.ToString()}'");
            }

            if (Optional.IsDefined(NodeVCores))
            {
                builder.Append("  nodeVCores:");
                builder.AppendLine($" '{NodeVCores.Value.ToString()}'");
            }
