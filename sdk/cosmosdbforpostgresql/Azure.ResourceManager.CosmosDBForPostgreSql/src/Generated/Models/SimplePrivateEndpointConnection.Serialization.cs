...
{
    public partial class SimplePrivateEndpointConnection : IUtf8JsonSerializable
    {
        ...
        internal static SimplePrivateEndpointConnection DeserializeSimplePrivateEndpointConnection(JsonElement element)
        {
            ...
            return new SimplePrivateEndpointConnection(id, name, type, systemData.Value, privateEndpoint, Optional.ToList(groupIds), privateLinkServiceConnectionState.Value);
        }
    }
}
