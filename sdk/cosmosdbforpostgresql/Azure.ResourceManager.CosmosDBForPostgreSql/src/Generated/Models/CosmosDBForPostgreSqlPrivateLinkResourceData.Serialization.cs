...
namespace Azure.ResourceManager.CosmosDBForPostgreSql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBForPostgreSqlPrivateLinkResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBForPostgreSqlPrivateLinkResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBForPostgreSqlPrivateLinkResourceData>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBForPostgreSqlPrivateLinkResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
