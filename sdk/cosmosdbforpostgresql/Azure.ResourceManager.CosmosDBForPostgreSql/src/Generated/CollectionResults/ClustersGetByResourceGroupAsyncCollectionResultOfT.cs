...
{
    internal partial class ClustersGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<CosmosDBForPostgreSqlClusterData>
    {
        ...
        public override async IAsyncEnumerable<Page<CosmosDBForPostgreSqlClusterData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<CosmosDBForPostgreSqlClusterData>.FromValues((IReadOnlyList<CosmosDBForPostgreSqlClusterData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("CosmosDBForPostgreSqlClusterCollection.GetAll");
            scope.Start();
            try
            {
