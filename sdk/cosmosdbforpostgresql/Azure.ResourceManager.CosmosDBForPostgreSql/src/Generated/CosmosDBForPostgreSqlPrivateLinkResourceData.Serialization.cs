...
namespace Azure.ResourceManager.CosmosDBForPostgreSql
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBForPostgreSqlPrivateLinkResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CosmosDBForPostgreSqlPrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBForPostgreSqlPrivateLinkResourceData)} does not support '{format}' format.");
            }
        ...
        internal static CosmosDBForPostgreSqlPrivateLinkResourceData DeserializeCosmosDBForPostgreSqlPrivateLinkResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CosmosDBForPostgreSqlPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, requiredMembers ?? new ChangeTrackingList<string>(), requiredZoneNames ?? new ChangeTrackingList<string>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<CosmosDBForPostgreSqlPrivateLinkResourceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CosmosDBForPostgreSqlPrivateLinkResourceData)} does not support '{options.Format}' format.");
            }
        }
