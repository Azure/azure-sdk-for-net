...
namespace Azure.ResourceManager.CosmosDBForPostgreSql
{
    ...
    public partial class CosmosDBForPostgreSqlClusterResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the CosmosDBForPostgreSqlCluster.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforPostgreSQL/serverGroupsv2/{clusterName}. </description>
        ...
        public virtual async Task<ArmOperation<CosmosDBForPostgreSqlClusterResource>> UpdateAsync(WaitUntil waitUntil, CosmosDBForPostgreSqlClusterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _clustersRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CosmosDBForPostgreSqlClusterData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CosmosDBForPostgreSqlArmOperation<CosmosDBForPostgreSqlClusterResource> operation = new CosmosDBForPostgreSqlArmOperation<CosmosDBForPostgreSqlClusterResource>(
                    new CosmosDBForPostgreSqlClusterResourceOperationSource(Client),
                    _clustersClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<CosmosDBForPostgreSqlClusterResource> Update(WaitUntil waitUntil, CosmosDBForPostgreSqlClusterData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
