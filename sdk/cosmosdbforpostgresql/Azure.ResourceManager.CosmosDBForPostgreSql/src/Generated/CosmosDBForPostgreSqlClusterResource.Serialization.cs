...
namespace Azure.ResourceManager.CosmosDBForPostgreSql
{
    public partial class CosmosDBForPostgreSqlClusterResource : IJsonModel<CosmosDBForPostgreSqlClusterData>
    {
        ...
        {
            return ModelReaderWriter.Read<CosmosDBForPostgreSqlClusterData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<CosmosDBForPostgreSqlClusterData>(data, options);
        }
