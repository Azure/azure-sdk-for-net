...
{
    /// <summary></summary>
    internal partial class CosmosDBForPostgreSqlCoordinatorConfigurationResourceOperationSource : IOperationSource<CosmosDBForPostgreSqlCoordinatorConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBForPostgreSqlCoordinatorConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
