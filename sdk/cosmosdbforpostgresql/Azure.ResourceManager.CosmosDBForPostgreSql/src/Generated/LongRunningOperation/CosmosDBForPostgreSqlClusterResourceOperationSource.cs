...
{
    /// <summary></summary>
    internal partial class CosmosDBForPostgreSqlClusterResourceOperationSource : IOperationSource<CosmosDBForPostgreSqlClusterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBForPostgreSqlClusterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
