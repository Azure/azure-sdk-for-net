...
{
    /// <summary></summary>
    internal partial class CosmosDBForPostgreSqlNodeConfigurationResourceOperationSource : IOperationSource<CosmosDBForPostgreSqlNodeConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBForPostgreSqlNodeConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
