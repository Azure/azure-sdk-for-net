...
{
    /// <summary></summary>
    internal partial class CosmosDBForPostgreSqlFirewallRuleResourceOperationSource : IOperationSource<CosmosDBForPostgreSqlFirewallRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBForPostgreSqlFirewallRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
