...
namespace Azure.ResourceManager.CosmosDBForPostgreSql
{
    internal partial class CosmosDBForPostgreSqlArmOperation<T> : ArmOperation<T>
    {
        ...
        internal CosmosDBForPostgreSqlArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
