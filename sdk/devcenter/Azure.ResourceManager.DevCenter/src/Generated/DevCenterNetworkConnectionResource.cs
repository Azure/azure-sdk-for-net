...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class DevCenterNetworkConnectionResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the DevCenterNetworkConnection.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevCenter/networkConnections/{networkConnectionName}. </description>
        ...
        public virtual async Task<ArmOperation<DevCenterNetworkConnectionResource>> UpdateAsync(WaitUntil waitUntil, DevCenterNetworkConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _networkConnectionsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DevCenterNetworkConnectionData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DevCenterArmOperation<DevCenterNetworkConnectionResource> operation = new DevCenterArmOperation<DevCenterNetworkConnectionResource>(
                    new DevCenterNetworkConnectionResourceOperationSource(Client),
                    _networkConnectionsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DevCenterNetworkConnectionResource> Update(WaitUntil waitUntil, DevCenterNetworkConnectionData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
