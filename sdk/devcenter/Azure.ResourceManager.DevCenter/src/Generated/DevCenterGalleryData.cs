...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class DevCenterGalleryData : ResourceData
    {
        ...
        internal DevCenterGalleryData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DevCenterProvisioningState? provisioningState, ResourceIdentifier galleryResourceId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
