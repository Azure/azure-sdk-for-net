...
namespace Azure.ResourceManager.DevCenter
{
    ...
    /// Each <see cref="ProjectCatalogResource"/> in the collection will belong to the same instance of <see cref="ProjectResource"/>.
    /// To get a <see cref="ProjectCatalogCollection"/> instance call the GetProjectCatalogs method from an instance of <see cref="ProjectResource"/>.
    /// </summary>
    public partial class ProjectCatalogCollection : ArmCollection, IEnumerable<ProjectCatalogResource>, IAsyncEnumerable<ProjectCatalogResource>
    {
        ...
        public virtual async Task<ArmOperation<ProjectCatalogResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string catalogName, CatalogData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _projectCatalogsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, catalogName, CatalogData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="catalogName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="catalogName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ProjectCatalogResource> CreateOrUpdate(WaitUntil waitUntil, string catalogName, CatalogData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(catalogName, nameof(catalogName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<ProjectCatalogResource> GetAllAsync(int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<CatalogData, ProjectCatalogResource>(new ProjectCatalogsGetAllAsyncCollectionResultOfT(
        ...
        public virtual Pageable<ProjectCatalogResource> GetAll(int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<CatalogData, ProjectCatalogResource>(new ProjectCatalogsGetAllCollectionResultOfT(
                _projectCatalogsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
