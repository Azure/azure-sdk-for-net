...
namespace Azure.ResourceManager.DevCenter
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ImageResource"/> using the GetImageVersions method.
    /// </summary>
    public partial class ImageVersionResource : ArmResource
    {
        ...
        {
            this.TryGetApiVersion(ResourceType, out string imageVersionApiVersion);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevCenter/projects/{projectName}/images/{imageName}/versions/{versionName}";
        ...
        public virtual async Task<Response<ImageVersionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _imageVersionsRestClient.CreateGetByProjectRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
