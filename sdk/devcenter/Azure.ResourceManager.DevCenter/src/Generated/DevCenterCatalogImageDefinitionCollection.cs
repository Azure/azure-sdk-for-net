...
namespace Azure.ResourceManager.DevCenter
{
    ...
    /// Each <see cref="DevCenterCatalogImageDefinitionResource"/> in the collection will belong to the same instance of <see cref="CatalogResource"/>.
    /// To get a <see cref="DevCenterCatalogImageDefinitionCollection"/> instance call the GetDevCenterCatalogImageDefinitions method from an instance of <see cref="CatalogResource"/>.
    /// </summary>
    public partial class DevCenterCatalogImageDefinitionCollection : ArmCollection, IEnumerable<DevCenterCatalogImageDefinitionResource>, IAsyncEnumerable<DevCenterCatalogImageDefinitionResource>
    {
        ...
        /// <summary> Initializes a new instance of DevCenterCatalogImageDefinitionCollection for mocking. </summary>
        protected DevCenterCatalogImageDefinitionCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DevCenterCatalogImageDefinitionCollection"/> class. </summary>
        ...
        public virtual async Task<Response<DevCenterCatalogImageDefinitionResource>> GetAsync(string imageDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _devCenterCatalogImageDefinitionsClientDiagnostics.CreateScope("DevCenterCatalogImageDefinitionCollection.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _devCenterCatalogImageDefinitionsRestClient.CreateGetByDevCenterCatalogRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, imageDefinitionName, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ImageDefinitions_ListByDevCenterCatalog. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2026-01-01-preview. </description>
        ...
        public virtual AsyncPageable<DevCenterCatalogImageDefinitionResource> GetAllAsync(int? top = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<ImageDefinitionData, DevCenterCatalogImageDefinitionResource>(new DevCenterCatalogImageDefinitionsGetByDevCenterCatalogAsyncCollectionResultOfT(
                ...
                Id.Name,
                top,
                context), data => new DevCenterCatalogImageDefinitionResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="DevCenterCatalogImageDefinitionResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<DevCenterCatalogImageDefinitionResource> GetAll(int? top = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string imageDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _devCenterCatalogImageDefinitionsClientDiagnostics.CreateScope("DevCenterCatalogImageDefinitionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<DevCenterCatalogImageDefinitionResource>> GetIfExistsAsync(string imageDefinitionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _devCenterCatalogImageDefinitionsClientDiagnostics.CreateScope("DevCenterCatalogImageDefinitionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
