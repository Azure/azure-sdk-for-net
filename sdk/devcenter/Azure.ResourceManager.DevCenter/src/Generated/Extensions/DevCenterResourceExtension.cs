...
namespace Azure.ResourceManager.DevCenter.Mock
{
    ...
    public partial class DevCenterResourceExtension : ArmResource
    {
        private ClientDiagnostics _devCenterClientDiagnostics;
        private DevCentersRestOperations _devCenterRestClient;

        /// <summary> Initializes a new instance of the <see cref="DevCenterResourceExtension"/> class for mocking. </summary>
        protected DevCenterResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DevCenterResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DevCenterResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DevCenterResource> GetDevCentersAsync(int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DevCenterResource(Client, DevCenterData.DeserializeDevCenterData(e)), DevCenterClientDiagnostics, Pipeline, "DevCenterResourceExtension.GetDevCenters", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DevCenterResource> GetDevCenters(int? top = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DevCenterRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId, top);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DevCenterRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId, top);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DevCenterResource(Client, DevCenterData.DeserializeDevCenterData(e)), DevCenterClientDiagnostics, Pipeline, "DevCenterResourceExtension.GetDevCenters", "value", "nextLink", cancellationToken);
        }
    }
}
