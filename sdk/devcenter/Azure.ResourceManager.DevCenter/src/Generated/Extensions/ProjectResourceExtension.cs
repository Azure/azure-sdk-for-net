...
namespace Azure.ResourceManager.DevCenter.Mock
{
    ...
    public partial class ProjectResourceExtension : ArmResource
    {
        private ClientDiagnostics _projectClientDiagnostics;
        private ProjectsRestOperations _projectRestClient;

        /// <summary> Initializes a new instance of the <see cref="ProjectResourceExtension"/> class for mocking. </summary>
        protected ProjectResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ProjectResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ProjectResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ProjectResource> GetProjectsAsync(int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ProjectResource(Client, ProjectData.DeserializeProjectData(e)), ProjectClientDiagnostics, Pipeline, "ProjectResourceExtension.GetProjects", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ProjectResource> GetProjects(int? top = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ProjectRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId, top);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ProjectRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId, top);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ProjectResource(Client, ProjectData.DeserializeProjectData(e)), ProjectClientDiagnostics, Pipeline, "ProjectResourceExtension.GetProjects", "value", "nextLink", cancellationToken);
        }
    }
}
