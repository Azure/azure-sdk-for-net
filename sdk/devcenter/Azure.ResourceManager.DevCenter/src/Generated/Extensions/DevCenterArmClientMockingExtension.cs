...
namespace Azure.ResourceManager.DevCenter.Mocking
{
    ...
    internal partial class DevCenterArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DevCenterArmClientMockingExtension"/> class for mocking. </summary>
        protected DevCenterArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DevCenterArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DevCenterArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DevCenterArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
