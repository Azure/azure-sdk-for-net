...
namespace Azure.ResourceManager.DevCenter
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="CatalogResource"/> using the GetEnvironmentDefinitions method.
    /// </summary>
    public partial class EnvironmentDefinitionResource : ArmResource
    {
        ...
        {
            this.TryGetApiVersion(ResourceType, out string environmentDefinitionApiVersion);
        ...
        public virtual async Task<Response<EnvironmentDefinitionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _environmentDefinitionsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _environmentDefinitionsClientDiagnostics.CreateScope("EnvironmentDefinitionResource.GetErrorDetails");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _environmentDefinitionsRestClient.CreateGetErrorDetailsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
