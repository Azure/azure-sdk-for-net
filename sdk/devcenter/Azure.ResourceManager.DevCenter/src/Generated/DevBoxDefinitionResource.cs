...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class DevBoxDefinitionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _devBoxDefinitionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = await _devBoxDefinitionRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new DevCenterArmOperation(_devBoxDefinitionClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _devBoxDefinitionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var response = _devBoxDefinitionRestClient.Delete(message, cancellationToken);
                var operation = new DevCenterArmOperation(_devBoxDefinitionClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<DevBoxDefinitionResource>> UpdateAsync(WaitUntil waitUntil, DevBoxDefinitionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _devBoxDefinitionRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch);
                var response = await _devBoxDefinitionRestClient.UpdateAsync(message, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<DevBoxDefinitionResource> Update(WaitUntil waitUntil, DevBoxDefinitionPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _devBoxDefinitionRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, patch);
                var response = _devBoxDefinitionRestClient.Update(message, cancellationToken);
                var operation = new DevCenterArmOperation<DevBoxDefinitionResource>(new DevBoxDefinitionOperationSource(Client), _devBoxDefinitionClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
