...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class DevCenterProjectImageResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of DevCenterProjectImageVersionResources in the DevCenterProjectImage. </summary>
        /// <returns> An object representing collection of DevCenterProjectImageVersionResources and their operations over a DevCenterProjectImageVersionResource. </returns>
        public virtual DevCenterProjectImageVersionCollection GetDevCenterProjectImageVersions()
        {
            return GetCachedClient(client => new DevCenterProjectImageVersionCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<DevCenterProjectImageVersionResource>> GetDevCenterProjectImageVersionAsync(string versionName, CancellationToken cancellationToken = default)
        {
            return await GetDevCenterProjectImageVersions().GetAsync(versionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="versionName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<DevCenterProjectImageVersionResource> GetDevCenterProjectImageVersion(string versionName, CancellationToken cancellationToken = default)
        {
            return GetDevCenterProjectImageVersions().Get(versionName, cancellationToken);
        }
