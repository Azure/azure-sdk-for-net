...
namespace Azure.ResourceManager.DevCenter
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ProjectAttachedNetworkConnectionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="DevCenterProjectResource"/> using the GetProjectAttachedNetworkConnections method.
    /// </summary>
    public partial class ProjectAttachedNetworkConnectionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ProjectAttachedNetworkConnectionResource for mocking. </summary>
        protected ProjectAttachedNetworkConnectionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ProjectAttachedNetworkConnectionResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string projectAttachedNetworkConnectionApiVersion);
        ...
        {
            using DiagnosticScope scope = _attachedNetworkConnectionsClientDiagnostics.CreateScope("ProjectAttachedNetworkConnectionResource.Get");
            scope.Start();
            try
            {
