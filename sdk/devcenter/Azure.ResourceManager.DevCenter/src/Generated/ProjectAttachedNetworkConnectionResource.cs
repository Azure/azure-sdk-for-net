    ...
    public partial class ProjectAttachedNetworkConnectionResource : BaseAttachedNetworkConnectionResource
    {
        ...
        protected override async Task<Response<BaseAttachedNetworkConnectionResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((BaseAttachedNetworkConnectionResource)new ProjectAttachedNetworkConnectionResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
