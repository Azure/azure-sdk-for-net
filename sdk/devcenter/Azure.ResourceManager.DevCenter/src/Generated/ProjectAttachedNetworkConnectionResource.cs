...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class ProjectAttachedNetworkConnectionResource : ArmResource
    {
        ...
        internal ProjectAttachedNetworkConnectionResource(ArmClient client, AttachedNetworkConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ProjectAttachedNetworkConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ProjectAttachedNetworkConnectionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
