...
{
    internal partial class UsagesGetByLocationCollectionResultOfT : Pageable<DevCenterUsage>
    {
        ...
        public override IEnumerable<Page<DevCenterUsage>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<DevCenterUsage>.FromValues(result.Value, nextPage?.AbsoluteUri, response);
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableDevCenterSubscriptionResource.GetByLocation");
            scope.Start();
            try
            {
