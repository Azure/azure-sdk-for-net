...
{
    internal partial class NetworkConnectionsGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<NetworkConnectionData>
    {
        ...
        /// <returns> The pages of NetworkConnectionsGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<NetworkConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                NetworkConnectionListResult result = NetworkConnectionListResult.FromResponse(response);
                yield return Page<NetworkConnectionData>.FromValues(result.Value, nextPage?.AbsoluteUri, response);
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableDevCenterSubscriptionResource.GetNetworkConnections");
            scope.Start();
            try
            {
