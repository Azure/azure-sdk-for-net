...
{
    internal partial class NetworkConnectionsGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<DevCenterNetworkConnectionData>
    {
        ...
        public override async IAsyncEnumerable<Page<DevCenterNetworkConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<DevCenterNetworkConnectionData>.FromValues(result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
