...
{
    internal partial class ProjectsGetByResourceGroupCollectionResultOfT : Pageable<ProjectData>
    {
        ...
        public override IEnumerable<Page<ProjectData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ProjectData>.FromValues(result.Value, nextPage?.AbsoluteUri, response);
