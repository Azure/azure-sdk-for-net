...
{
    internal partial class ImagesGetImagesCollectionResultOfT : Pageable<DevCenterImageData>
    {
        ...
        /// <returns> The pages of ImagesGetImagesCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<DevCenterImageData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                DevCenterImageListResult result = DevCenterImageListResult.FromResponse(response);
                yield return Page<DevCenterImageData>.FromValues(result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
