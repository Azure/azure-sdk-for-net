...
namespace Azure.ResourceManager.DevCenter
{
    internal partial class ProjectPoliciesGetByDevCenterAsyncCollectionResultOfT : AsyncPageable<ProjectPolicyData>
    {
        ...
        /// <summary> Initializes a new instance of ProjectPoliciesGetByDevCenterAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The ProjectPolicies client used to send requests. </param>
        ...
        public ProjectPoliciesGetByDevCenterAsyncCollectionResultOfT(ProjectPolicies client, Guid subscriptionId, string resourceGroupName, string devCenterName, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ProjectPoliciesGetByDevCenterAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override async IAsyncEnumerable<Page<ProjectPolicyData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<ProjectPolicyData>.FromValues(result.Value, nextPage?.AbsoluteUri, response);
