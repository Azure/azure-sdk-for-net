...
namespace Azure.ResourceManager.DevCenter
{
    internal partial class ProjectPoliciesGetByDevCenterAsyncCollectionResultOfT : AsyncPageable<DevCenterProjectPolicyData>
    {
        ...
        public ProjectPoliciesGetByDevCenterAsyncCollectionResultOfT(ProjectPolicies client, Guid subscriptionId, string resourceGroupName, string devCenterName, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
