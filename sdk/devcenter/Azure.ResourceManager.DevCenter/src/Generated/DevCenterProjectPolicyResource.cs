...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class DevCenterProjectPolicyResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the DevCenterProjectPolicy.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevCenter/devcenters/{devCenterName}/projectPolicies/{projectPolicyName}. </description>
        ...
        public virtual async Task<ArmOperation<DevCenterProjectPolicyResource>> UpdateAsync(WaitUntil waitUntil, DevCenterProjectPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _projectPoliciesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, DevCenterProjectPolicyData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DevCenterArmOperation<DevCenterProjectPolicyResource> operation = new DevCenterArmOperation<DevCenterProjectPolicyResource>(
                    new DevCenterProjectPolicyResourceOperationSource(Client),
                    _projectPoliciesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DevCenterProjectPolicyResource> Update(WaitUntil waitUntil, DevCenterProjectPolicyData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
