...
namespace Azure.ResourceManager.DevCenter
{
    internal partial class CheckNameAvailabilityRestOperations
    {
        ...
        internal HttpMessage CreateExecuteRequest(string subscriptionId, CheckNameAvailabilityContent content)
        {
        ...
        public async Task<Response<CheckNameAvailabilityResponse>> ExecuteAsync(string subscriptionId, CheckNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<CheckNameAvailabilityResponse> Execute(string subscriptionId, CheckNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(content, nameof(content));
