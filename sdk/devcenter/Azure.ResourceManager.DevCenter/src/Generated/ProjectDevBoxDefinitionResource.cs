...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class ProjectDevBoxDefinitionResource : ArmResource
    {
        ...
        internal ProjectDevBoxDefinitionResource(ArmClient client, DevBoxDefinitionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ProjectDevBoxDefinitionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ProjectDevBoxDefinitionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
