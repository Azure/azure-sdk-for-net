...
namespace Azure.ResourceManager.DevCenter
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="DevCenterGalleryResource"/> using the GetImages method.
    /// </summary>
    public partial class ImageResource : ArmResource
    {
        ...
        internal ImageResource(ArmClient client, DevCenterImageData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        /// <summary> Gets a collection of ImageVersions in the <see cref="ImageResource"/>. </summary>
