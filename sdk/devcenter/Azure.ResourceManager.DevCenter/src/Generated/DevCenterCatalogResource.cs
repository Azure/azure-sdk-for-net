...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class DevCenterCatalogResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DevCenterCatalogResource>> UpdateAsync(WaitUntil waitUntil, DevCenterCatalogData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _catalogsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, DevCenterCatalogData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DevCenterArmOperation<DevCenterCatalogResource> operation = new DevCenterArmOperation<DevCenterCatalogResource>(
                    new DevCenterCatalogResourceOperationSource(Client),
                    _catalogsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DevCenterCatalogResource> Update(WaitUntil waitUntil, DevCenterCatalogData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
