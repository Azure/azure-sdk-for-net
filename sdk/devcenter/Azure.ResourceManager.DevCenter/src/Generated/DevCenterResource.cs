...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class DevCenterResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DevCenterResource>> UpdateAsync(WaitUntil waitUntil, DevCenterData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _devCentersRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DevCenterData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DevCenterArmOperation<DevCenterResource> operation = new DevCenterArmOperation<DevCenterResource>(
                    new DevCenterResourceOperationSource(Client),
                    _devCentersClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DevCenterResource> Update(WaitUntil waitUntil, DevCenterData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
