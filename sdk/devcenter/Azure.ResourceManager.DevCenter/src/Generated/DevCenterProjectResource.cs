...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class DevCenterProjectResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DevCenterProjectResource>> UpdateAsync(WaitUntil waitUntil, DevCenterProjectData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _projectsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DevCenterProjectData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DevCenterArmOperation<DevCenterProjectResource> operation = new DevCenterArmOperation<DevCenterProjectResource>(
                    new DevCenterProjectResourceOperationSource(Client),
                    _projectsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DevCenterProjectResource> Update(WaitUntil waitUntil, DevCenterProjectData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
