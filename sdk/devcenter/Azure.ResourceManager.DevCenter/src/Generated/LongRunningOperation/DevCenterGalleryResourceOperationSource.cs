...
{
    /// <summary></summary>
    internal partial class DevCenterGalleryResourceOperationSource : IOperationSource<DevCenterGalleryResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevCenterGalleryResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
