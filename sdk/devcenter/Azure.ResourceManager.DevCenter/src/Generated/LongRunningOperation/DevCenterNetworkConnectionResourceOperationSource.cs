...
{
    /// <summary></summary>
    internal partial class DevCenterNetworkConnectionResourceOperationSource : IOperationSource<DevCenterNetworkConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevCenterNetworkConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
