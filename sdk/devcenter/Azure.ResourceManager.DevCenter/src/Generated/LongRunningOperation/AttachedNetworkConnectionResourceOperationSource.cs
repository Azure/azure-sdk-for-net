...
{
    /// <summary></summary>
    internal partial class AttachedNetworkConnectionResourceOperationSource : IOperationSource<AttachedNetworkConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal AttachedNetworkConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
