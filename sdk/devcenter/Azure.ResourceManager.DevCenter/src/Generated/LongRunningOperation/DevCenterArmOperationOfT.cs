...
namespace Azure.ResourceManager.DevCenter
{
    internal partial class DevCenterArmOperation<T> : ArmOperation<T>
    {
        ...
        internal DevCenterArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
