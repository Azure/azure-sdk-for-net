...
{
    /// <summary></summary>
    internal partial class DevCenterCatalogResourceOperationSource : IOperationSource<DevCenterCatalogResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevCenterCatalogResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
