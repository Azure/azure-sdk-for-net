...
{
    /// <summary></summary>
    internal partial class DevBoxDefinitionResourceOperationSource : IOperationSource<DevBoxDefinitionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevBoxDefinitionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
