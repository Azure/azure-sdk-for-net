...
{
    /// <summary></summary>
    internal partial class DevCenterProjectPolicyResourceOperationSource : IOperationSource<DevCenterProjectPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevCenterProjectPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
