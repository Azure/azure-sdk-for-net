...
{
    /// <summary></summary>
    internal partial class DevCenterScheduleResourceOperationSource : IOperationSource<DevCenterScheduleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevCenterScheduleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
