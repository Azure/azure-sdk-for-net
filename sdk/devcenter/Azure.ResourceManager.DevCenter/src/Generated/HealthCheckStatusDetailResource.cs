...
namespace Azure.ResourceManager.DevCenter
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="NetworkConnectionResource" /> using the GetHealthCheckStatusDetail method.
    /// </summary>
    public partial class HealthCheckStatusDetailResource : ArmResource
    {
        ...
        internal HealthCheckStatusDetailResource(ArmClient client, HealthCheckStatusDetailData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<HealthCheckStatusDetailResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new HealthCheckStatusDetailResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
