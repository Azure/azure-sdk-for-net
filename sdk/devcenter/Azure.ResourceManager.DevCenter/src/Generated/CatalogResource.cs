...
namespace Azure.ResourceManager.DevCenter
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="DevCenterResource"/> using the GetCatalogs method.
    /// </summary>
    public partial class CatalogResource : ArmResource
    {
        ...
        internal CatalogResource(ArmClient client, DevCenterCatalogData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<ArmOperation<CatalogResource>> UpdateAsync(WaitUntil waitUntil, DevCenterCatalogPatch patch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<CatalogResource> Update(WaitUntil waitUntil, DevCenterCatalogPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
        ...
        /// <summary> Gets a collection of EnvironmentDefinitionOperationGroups in the <see cref="CatalogResource"/>. </summary>
        ...
        /// <summary> Gets a collection of DevCenterCatalogTasks in the <see cref="CatalogResource"/>. </summary>
