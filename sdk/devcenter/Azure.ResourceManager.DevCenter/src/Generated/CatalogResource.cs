...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class CatalogResource : ArmResource
    {
        ...
        internal CatalogResource(ArmClient client, CatalogData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CatalogResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CatalogResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
