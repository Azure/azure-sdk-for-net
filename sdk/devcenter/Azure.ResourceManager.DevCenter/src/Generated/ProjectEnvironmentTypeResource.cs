...
namespace Azure.ResourceManager.DevCenter
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ProjectResource" /> using the GetProjectEnvironmentType method.
    /// </summary>
    public partial class ProjectEnvironmentTypeResource : ArmResource
    {
        ...
        internal ProjectEnvironmentTypeResource(ArmClient client, ProjectEnvironmentTypeData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ProjectEnvironmentTypeResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ProjectEnvironmentTypeResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
