...
namespace Azure.ResourceManager.DevCenter
{
    ...
    public partial class DevCenterCatalogTaskData : ResourceData
    {
        ...
        internal DevCenterCatalogTaskData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, CustomizationTaskProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
