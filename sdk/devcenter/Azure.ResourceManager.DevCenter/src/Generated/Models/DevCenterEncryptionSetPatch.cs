...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class DevCenterEncryptionSetPatch
    {
        ...
        internal DevCenterEncryptionSetPatch(IDictionary<string, string> tags, string location, DevCenterEncryptionSetUpdateProperties properties, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Tags = tags;
            Location = location;
        ...
        public KeyEncryptionKeyIdentity1 KeyEncryptionKeyIdentity
        {
            get
            {
