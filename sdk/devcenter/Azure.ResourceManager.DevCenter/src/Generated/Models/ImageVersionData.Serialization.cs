...
namespace Azure.ResourceManager.DevCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageVersionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageVersionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageVersionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageVersionData>)} interface");
            }
        ...
        string IPersistableModel<ImageVersionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
