...
{
    public partial class ImageVersionData : IUtf8JsonSerializable, IJsonModel<ImageVersionData>, IPersistableModel<ImageVersionData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  osDiskImageSizeInGb:");
                builder.AppendLine($" '{OSDiskImageSizeInGB.Value.ToString()}'");
            }
