...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterTrackedResourceUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterTrackedResourceUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterTrackedResourceUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterTrackedResourceUpdate>)} interface");
            }
        ...
        string IPersistableModel<DevCenterTrackedResourceUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
