...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterUserRoleAssignments>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterUserRoleAssignments>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterUserRoleAssignments>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterUserRoleAssignments>)} interface");
            }
        ...
        string IPersistableModel<DevCenterUserRoleAssignments>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
