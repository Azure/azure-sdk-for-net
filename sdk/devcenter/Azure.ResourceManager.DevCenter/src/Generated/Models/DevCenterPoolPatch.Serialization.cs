...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterPoolPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterPoolPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterPoolPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterPoolPatch>)} interface");
            }
        ...
        string IPersistableModel<DevCenterPoolPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
