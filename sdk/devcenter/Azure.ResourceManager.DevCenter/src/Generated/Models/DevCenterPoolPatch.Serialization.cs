...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterPoolPatch>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        DevCenterPoolPatch IJsonModel<DevCenterPoolPatch>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static DevCenterPoolPatch DeserializeDevCenterPoolPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DevCenterPoolPatch(Optional.ToDictionary(tags), Optional.ToNullable(location), serializedAdditionalRawData, devBoxDefinitionName.Value, networkConnectionName.Value, Optional.ToNullable(licenseType), Optional.ToNullable(localAdministrator), stopOnDisconnect.Value);
        }

        BinaryData IModel<DevCenterPoolPatch>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        DevCenterPoolPatch IModel<DevCenterPoolPatch>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<DevCenterPoolPatch>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
