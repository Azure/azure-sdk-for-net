...
{
    internal partial class ImageVersionListResult : IUtf8JsonSerializable, IJsonModel<ImageVersionListResult>, IPersistableModel<ImageVersionListResult>
    {
        ...
        void IJsonModel<ImageVersionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImageVersionListResult)} does not support '{format}' format.");
            }
