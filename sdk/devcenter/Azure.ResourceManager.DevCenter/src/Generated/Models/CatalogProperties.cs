...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class CatalogProperties : CatalogUpdateProperties
    {
        ...
        internal CatalogProperties(GitCatalog gitHub, GitCatalog adoGit, CatalogSyncType? syncType, CatalogAutoImageBuildEnableStatus? autoImageBuildEnableStatus, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties, ProvisioningState? provisioningState, CatalogSyncState? syncState, SyncStats lastSyncStats, CatalogConnectionState? connectionState, DateTimeOffset? lastConnectionOn, DateTimeOffset? lastSyncOn) : base(gitHub, adoGit, syncType, autoImageBuildEnableStatus, tags, additionalBinaryDataProperties)
        {
