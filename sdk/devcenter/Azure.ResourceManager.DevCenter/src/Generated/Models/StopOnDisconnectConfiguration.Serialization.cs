...
{
    public partial class StopOnDisconnectConfiguration : IUtf8JsonSerializable, IJsonModel<StopOnDisconnectConfiguration>, IPersistableModel<StopOnDisconnectConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GracePeriodMinutes))
            {
                builder.Append("  gracePeriodMinutes:");
                builder.AppendLine($" '{GracePeriodMinutes.Value.ToString()}'");
            }
