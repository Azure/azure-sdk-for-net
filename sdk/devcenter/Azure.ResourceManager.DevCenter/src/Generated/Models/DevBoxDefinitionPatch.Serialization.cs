...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class DevBoxDefinitionPatch : IJsonModel<DevBoxDefinitionPatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DevBoxDefinitionPatch IJsonModel<DevBoxDefinitionPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DevBoxDefinitionPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DevBoxDefinitionPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static DevBoxDefinitionPatch DeserializeDevBoxDefinitionPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new DevBoxDefinitionPatch(tags ?? new ChangeTrackingDictionary<string, string>(), location, properties, additionalBinaryDataProperties);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DevBoxDefinitionPatch IPersistableModel<DevBoxDefinitionPatch>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DevBoxDefinitionPatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DevBoxDefinitionPatch>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
        ...
        internal static RequestContent ToRequestContent(DevBoxDefinitionPatch devBoxDefinitionPatch)
        {
            ...
            content.JsonWriter.WriteObjectValue(devBoxDefinitionPatch, ModelSerializationExtensions.WireOptions);
            return content;
        }
    }
}
