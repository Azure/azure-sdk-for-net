...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevBoxDefinitionPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevBoxDefinitionPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevBoxDefinitionPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevBoxDefinitionPatch>)} interface");
            }
        ...
        string IPersistableModel<DevBoxDefinitionPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
