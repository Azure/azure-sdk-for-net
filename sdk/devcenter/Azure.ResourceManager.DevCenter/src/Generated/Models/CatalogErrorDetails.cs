...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class CatalogErrorDetails
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CatalogErrorDetails"/>. </summary>
        ...
        internal CatalogErrorDetails(string code, string message, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Message = message;
