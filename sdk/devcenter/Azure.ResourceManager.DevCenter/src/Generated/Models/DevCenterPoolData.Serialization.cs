...
{
    public partial class DevCenterPoolData : IUtf8JsonSerializable, IJsonModel<DevCenterPoolData>, IPersistableModel<DevCenterPoolData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LocalAdministrator))
            {
                ...
                builder.AppendLine($" '{LocalAdministrator.ToString()}'");
            }

            if (Optional.IsDefined(StopOnDisconnect))
            {
                builder.Append("  stopOnDisconnect:");
                AppendChildObject(builder, StopOnDisconnect, options, 2);
            }
