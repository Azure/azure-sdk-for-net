...
{
    public partial class DevCenterGitCatalog : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DevCenterGitCatalog DeserializeDevCenterGitCatalog(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
