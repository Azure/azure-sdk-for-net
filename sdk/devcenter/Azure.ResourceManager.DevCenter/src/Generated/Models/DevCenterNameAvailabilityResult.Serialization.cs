...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterNameAvailabilityResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterNameAvailabilityResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterNameAvailabilityResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DevCenterNameAvailabilityResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
