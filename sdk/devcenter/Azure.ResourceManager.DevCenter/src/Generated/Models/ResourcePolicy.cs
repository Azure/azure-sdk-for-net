...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class ResourcePolicy
    {
        ...
        internal ResourcePolicy(string resources, string filter, PolicyAction? action, DevCenterResourceType? resourceType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Resources = resources;
            Filter = filter;
            Action = action;
