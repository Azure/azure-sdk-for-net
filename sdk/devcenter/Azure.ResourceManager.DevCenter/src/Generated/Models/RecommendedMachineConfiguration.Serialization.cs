...
{
    public partial class RecommendedMachineConfiguration : IUtf8JsonSerializable, IJsonModel<RecommendedMachineConfiguration>, IPersistableModel<RecommendedMachineConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Memory))
            {
                ...
                AppendChildObject(builder, Memory, options, 2);
            }

            if (Optional.IsDefined(VCpus))
            {
                builder.Append("  vCPUs:");
                AppendChildObject(builder, VCpus, options, 2);
            }
