...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class SyncStats
    {
        ...
        internal SyncStats(int? added, int? updated, int? unchanged, int? removed, int? validationErrors, int? synchronizationErrors, IList<CatalogItemType> syncedCatalogItemTypes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Added = added;
            Updated = updated;
            Unchanged = unchanged;
        ...
        public IList<CatalogItemType> SyncedCatalogItemTypes { get; }
    }
}
