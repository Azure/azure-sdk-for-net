...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class ImageDefinitionBuildTaskGroup
    {
        ...
        internal ImageDefinitionBuildTaskGroup(string name, ImageDefinitionBuildStatus? status, DateTimeOffset? startOn, DateTimeOffset? endOn, IReadOnlyList<ImageDefinitionBuildTask> tasks, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Status = status;
            StartOn = startOn;
