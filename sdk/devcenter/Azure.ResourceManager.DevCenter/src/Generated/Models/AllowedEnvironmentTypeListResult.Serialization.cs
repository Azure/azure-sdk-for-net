...
namespace Azure.ResourceManager.DevCenter.Models
{
    internal partial class AllowedEnvironmentTypeListResult : IUtf8JsonSerializable, IJsonModel<AllowedEnvironmentTypeListResult>
    {
        ...
        void IJsonModel<AllowedEnvironmentTypeListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AllowedEnvironmentTypeListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AllowedEnvironmentTypeListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AllowedEnvironmentTypeListResult)} does not support '{options.Format}' format.");
            }
        }
