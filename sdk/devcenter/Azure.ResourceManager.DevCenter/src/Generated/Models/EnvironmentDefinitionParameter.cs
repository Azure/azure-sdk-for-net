...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class EnvironmentDefinitionParameter
    {
        ...
        internal EnvironmentDefinitionParameter(string id, string name, string description, ParameterType? @type, bool? readOnly, bool? @required, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
