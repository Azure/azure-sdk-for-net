...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterProjectPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterProjectPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterProjectPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterProjectPatch>)} interface");
            }
        ...
        string IPersistableModel<DevCenterProjectPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
