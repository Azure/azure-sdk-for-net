...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class DevCenterOperationStatus : OperationStatusResult
    {
        ...
        internal DevCenterOperationStatus(ResourceIdentifier id, string name, string status, float? percentComplete, DateTimeOffset? startOn, DateTimeOffset? endOn, IReadOnlyList<OperationStatusResult> operations, ResponseError error, ResourceIdentifier resourceId, BinaryData properties, Dictionary<string, BinaryData> rawData) : base(id, name, status, percentComplete, startOn, endOn, operations, error, rawData)
        {
