...
namespace Azure.ResourceManager.DevCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterNetworkConnectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterNetworkConnectionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterNetworkConnectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterNetworkConnectionData>)} interface");
            }
        ...
        string IPersistableModel<DevCenterNetworkConnectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
