...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        internal static AttachedNetworkListResult DeserializeAttachedNetworkListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
