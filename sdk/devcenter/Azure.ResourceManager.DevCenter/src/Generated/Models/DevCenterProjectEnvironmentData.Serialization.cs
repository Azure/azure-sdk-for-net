...
{
    public partial class DevCenterProjectEnvironmentData : IUtf8JsonSerializable, IJsonModel<DevCenterProjectEnvironmentData>, IPersistableModel<DevCenterProjectEnvironmentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeploymentTargetId))
            {
                builder.Append("  deploymentTargetId:");
                builder.AppendLine($" '{DeploymentTargetId.ToString()}'");
            }
            ...
            if (Optional.IsDefined(CreatorRoleAssignment))
            {
                builder.Append("  creatorRoleAssignment:");
                AppendChildObject(builder, CreatorRoleAssignment, options, 2);
            }

            if (Optional.IsCollectionDefined(UserRoleAssignments))
            {
                builder.Append("  userRoleAssignments:");
                builder.AppendLine(" {");
                foreach (var item in UserRoleAssignments)
                {
