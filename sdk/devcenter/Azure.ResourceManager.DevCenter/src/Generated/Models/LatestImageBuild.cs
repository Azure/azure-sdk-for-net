...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class LatestImageBuild
    {
        ...
        internal LatestImageBuild(string name, DateTimeOffset? startOn, DateTimeOffset? endOn, ImageDefinitionBuildStatus? status, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            StartOn = startOn;
            EndOn = endOn;
