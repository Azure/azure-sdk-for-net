...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class ImageDefinitionBuildTask
    {
        ...
        internal ImageDefinitionBuildTask(string name, IList<ImageDefinitionBuildTaskParametersItem> parameters, string displayName, string id, DateTimeOffset? startOn, DateTimeOffset? endOn, ImageDefinitionBuildStatus? status, Uri logUri, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
