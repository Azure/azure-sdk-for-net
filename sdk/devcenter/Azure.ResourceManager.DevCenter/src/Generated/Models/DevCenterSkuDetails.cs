...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class DevCenterSkuDetails : DevCenterSku
    {
        ...
        internal DevCenterSkuDetails(string name, DevCenterSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> additionalBinaryDataProperties, ResourceType? resourceType, IReadOnlyList<string> locations, IReadOnlyList<DevCenterCapability> capabilities) : base(name, tier, size, family, capacity, additionalBinaryDataProperties)
        {
