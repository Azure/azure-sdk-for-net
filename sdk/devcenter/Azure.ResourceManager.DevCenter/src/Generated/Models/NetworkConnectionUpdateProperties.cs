...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class NetworkConnectionUpdateProperties
    {
        ...
        internal NetworkConnectionUpdateProperties(string subnetId, string domainName, string organizationUnit, string domainUsername, string domainPassword, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SubnetId = subnetId;
