...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class EnvironmentRole
    {
        ...
        /// <summary> Initializes a new instance of <see cref="EnvironmentRole"/>. </summary>
        ...
        internal EnvironmentRole(string roleName, string description, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            RoleName = roleName;
