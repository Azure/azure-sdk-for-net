...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class GitCatalog
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GitCatalog"/>. </summary>
        public GitCatalog()
        {
        }
        ...
        internal GitCatalog(string uri, string branch, string secretIdentifier, string path, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Uri = uri;
            Branch = branch;
