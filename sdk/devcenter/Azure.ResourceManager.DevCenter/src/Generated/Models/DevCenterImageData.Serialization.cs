...
namespace Azure.ResourceManager.DevCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterImageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterImageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterImageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterImageData>)} interface");
            }
        ...
        string IPersistableModel<DevCenterImageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
