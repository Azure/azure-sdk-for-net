...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class DevCenterPatch : DevCenterTrackedResourceUpdate
    {
        ...
        internal DevCenterPatch(IDictionary<string, string> tags, AzureLocation? location, ManagedServiceIdentity identity, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, location, serializedAdditionalRawData)
        {
            Identity = identity;
        }
