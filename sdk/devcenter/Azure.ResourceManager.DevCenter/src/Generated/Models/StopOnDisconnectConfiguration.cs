...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class StopOnDisconnectConfiguration
    {
        ...
        internal StopOnDisconnectConfiguration(StopOnDisconnectEnableStatus? status, int? gracePeriodMinutes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
