...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class StopOnDisconnectConfiguration
    {
        ...
        internal StopOnDisconnectConfiguration(StopOnDisconnectEnableStatus? status, int? gracePeriodMinutes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
