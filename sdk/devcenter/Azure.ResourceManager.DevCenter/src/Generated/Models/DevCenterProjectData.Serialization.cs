...
namespace Azure.ResourceManager.DevCenter
{
    public partial class DevCenterProjectData : IUtf8JsonSerializable, IJsonModel<DevCenterProjectData>
    {
        ...
        void IJsonModel<DevCenterProjectData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DevCenterProjectData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DevCenterProjectData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DevCenterProjectData)} does not support '{options.Format}' format.");
            }
        }
