...
namespace Azure.ResourceManager.DevCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterProjectData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterProjectData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterProjectData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterProjectData>)} interface");
            }
        ...
        string IPersistableModel<DevCenterProjectData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
