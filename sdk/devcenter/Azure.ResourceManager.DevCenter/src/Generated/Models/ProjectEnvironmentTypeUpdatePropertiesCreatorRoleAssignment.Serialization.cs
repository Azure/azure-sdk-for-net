...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignment>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignment>)} interface");
            }
        ...
        string IPersistableModel<ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
