...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class DevCenterNetworkConnectionPatch : DevCenterTrackedResourceUpdate
    {
        ...
        internal DevCenterNetworkConnectionPatch(IDictionary<string, string> tags, AzureLocation? location, ResourceIdentifier subnetId, string domainName, string organizationUnit, string domainUsername, string domainPassword, Dictionary<string, BinaryData> rawData) : base(tags, location, rawData)
        {
            SubnetId = subnetId;
