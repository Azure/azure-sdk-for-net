...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class ProjectEnvironmentTypeProperties : ProjectEnvironmentTypeUpdateProperties
    {
        ...
        internal ProjectEnvironmentTypeProperties(string deploymentTargetId, string displayName, EnvironmentTypeEnableStatus? status, ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignment creatorRoleAssignment, IDictionary<string, UserRoleAssignmentValue> userRoleAssignments, IDictionary<string, BinaryData> additionalBinaryDataProperties, ProvisioningState? provisioningState, int? environmentCount) : base(deploymentTargetId, displayName, status, creatorRoleAssignment, userRoleAssignments, additionalBinaryDataProperties)
        {
