...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        internal static NetworkConnectionListResult DeserializeNetworkConnectionListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
