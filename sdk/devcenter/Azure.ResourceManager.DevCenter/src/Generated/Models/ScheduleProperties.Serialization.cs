...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class ScheduleProperties : ScheduleUpdateProperties, IJsonModel<ScheduleProperties>
    {
        ...
        internal static ScheduleProperties DeserializeScheduleProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ScheduleEnableStatus? state = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("type"u8))
                {
                    ...
                    @type = new ScheduledType(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("frequency"u8))
                {
                    ...
                    frequency = new ScheduledFrequency(prop.Value.GetString());
                    continue;
                }
                ...
                if (prop.NameEquals("state"u8))
                {
                    ...
                    state = new ScheduleEnableStatus(prop.Value.GetString());
                    continue;
                }
