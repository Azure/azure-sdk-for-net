...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    internal partial class ScheduleProperties : ScheduleUpdatePropertiesReplacement, IJsonModel<ScheduleProperties>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override ScheduleUpdatePropertiesReplacement PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected override ScheduleUpdatePropertiesReplacement JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ScheduleProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
