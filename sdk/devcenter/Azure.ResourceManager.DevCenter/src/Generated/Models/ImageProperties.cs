...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class ImageProperties
    {
        ...
        internal ImageProperties(string description, string publisher, string offer, string sku, RecommendedMachineConfiguration recommendedMachineConfiguration, ProvisioningState? provisioningState, HibernateSupport? hibernateSupport, ArchitectureType? architecture, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
