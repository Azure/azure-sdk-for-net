...
namespace Azure.ResourceManager.DevCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterEnvironmentTypeData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterEnvironmentTypeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterEnvironmentTypeData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterEnvironmentTypeData>)} interface");
            }
        ...
        string IPersistableModel<DevCenterEnvironmentTypeData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
