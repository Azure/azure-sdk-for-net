...
namespace Azure.ResourceManager.DevCenter
{
    public partial class DevCenterEnvironmentTypeData : IUtf8JsonSerializable, IJsonModel<DevCenterEnvironmentTypeData>
    {
        ...
        void IJsonModel<DevCenterEnvironmentTypeData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DevCenterEnvironmentTypeData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DevCenterEnvironmentTypeData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DevCenterEnvironmentTypeData)} does not support '{options.Format}' format.");
            }
        }
