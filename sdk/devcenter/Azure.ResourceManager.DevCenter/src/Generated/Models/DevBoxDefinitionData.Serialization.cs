...
namespace Azure.ResourceManager.DevCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevBoxDefinitionData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevBoxDefinitionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevBoxDefinitionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevBoxDefinitionData>)} interface");
            }
        ...
        string IPersistableModel<DevBoxDefinitionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
