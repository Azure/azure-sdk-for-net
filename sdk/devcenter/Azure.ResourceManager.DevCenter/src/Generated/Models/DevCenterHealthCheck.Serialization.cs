...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterHealthCheck>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterHealthCheck>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterHealthCheck>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterHealthCheck>)} interface");
            }
        ...
        string IPersistableModel<DevCenterHealthCheck>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
