...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class HealthStatusDetail
    {
        ...
        /// <summary> Initializes a new instance of <see cref="HealthStatusDetail"/>. </summary>
        ...
        internal HealthStatusDetail(string code, string message, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Message = message;
