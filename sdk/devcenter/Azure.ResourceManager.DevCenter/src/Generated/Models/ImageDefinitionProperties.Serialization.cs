...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class ImageDefinitionProperties : IJsonModel<ImageDefinitionProperties>
    {
        ...
        internal static ImageDefinitionProperties DeserializeImageDefinitionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            ImageReference activeImageReference = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("activeImageReference"u8))
                {
                    ...
                    activeImageReference = ImageReference.DeserializeImageReference(prop.Value, options);
                    continue;
                }
