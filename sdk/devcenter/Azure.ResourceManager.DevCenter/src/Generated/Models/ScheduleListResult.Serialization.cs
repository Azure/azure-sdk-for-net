...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduleListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScheduleListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScheduleListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScheduleListResult>)} interface");
            }
        ...
        string IPersistableModel<ScheduleListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
