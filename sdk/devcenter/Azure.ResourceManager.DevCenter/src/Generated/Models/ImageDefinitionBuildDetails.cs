...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class ImageDefinitionBuildDetails : ResourceData
    {
        ...
        internal ImageDefinitionBuildDetails(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ImageReference imageReference, ImageDefinitionBuildStatus? status, DateTimeOffset? startOn, DateTimeOffset? endOn, ImageCreationErrorDetails errorDetails, IReadOnlyList<ImageDefinitionBuildTaskGroup> taskGroups) : base(id, name, resourceType, systemData)
        {
