...
{
    public partial class DevCenterEndpointDetail : IUtf8JsonSerializable, IJsonModel<DevCenterEndpointDetail>, IPersistableModel<DevCenterEndpointDetail>
    {
        ...
        void IJsonModel<DevCenterEndpointDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DevCenterEndpointDetail)} does not support '{format}' format.");
            }
