...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterEndpointDetail>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterEndpointDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterEndpointDetail>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterEndpointDetail>)} interface");
            }
        ...
        string IPersistableModel<DevCenterEndpointDetail>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
