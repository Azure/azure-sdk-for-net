...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterSchedulePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterSchedulePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterSchedulePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterSchedulePatch>)} interface");
            }
        ...
        string IPersistableModel<DevCenterSchedulePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
