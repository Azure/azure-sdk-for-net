...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterProjectEnvironmentPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterProjectEnvironmentPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterProjectEnvironmentPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterProjectEnvironmentPatch>)} interface");
            }
        ...
        string IPersistableModel<DevCenterProjectEnvironmentPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
