    ...
    public partial class EndpointDependency : IJsonModel<EndpointDependency>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(EndpointDetails))
            {
                ...
                foreach (EndpointDetail item in EndpointDetails)
                {
        ...
        internal static EndpointDependency DeserializeEndpointDependency(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new EndpointDependency(domainName, description, endpointDetails ?? new ChangeTrackingList<EndpointDetail>(), additionalBinaryDataProperties);
        }
