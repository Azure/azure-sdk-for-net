...
namespace Azure.ResourceManager.DevCenter
{
    public partial class DevCenterScheduleData : IUtf8JsonSerializable, IJsonModel<DevCenterScheduleData>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterScheduleData>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterScheduleData>)} interface");
            }
