...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class DevCenterHealthCheck
    {
        ...
        internal DevCenterHealthCheck(DevCenterHealthCheckStatus? status, string displayName, DateTimeOffset? startOn, DateTimeOffset? endOn, string errorType, string recommendedAction, string additionalDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
