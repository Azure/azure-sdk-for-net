...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class NetworkProperties : NetworkConnectionUpdateProperties
    {
        ...
        /// <param name="domainJoinType"> AAD Join type. </param>
        internal NetworkProperties(string subnetId, string domainName, string organizationUnit, string domainUsername, string domainPassword, IDictionary<string, BinaryData> additionalBinaryDataProperties, ProvisioningState? provisioningState, HealthCheckStatus? healthCheckStatus, string networkingResourceGroupName, DomainJoinType domainJoinType) : base(subnetId, domainName, organizationUnit, domainUsername, domainPassword, additionalBinaryDataProperties)
        {
