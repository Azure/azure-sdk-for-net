...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class HealthCheck
    {
        ...
        internal HealthCheck(HealthCheckStatus? status, string displayName, DateTimeOffset? startOn, DateTimeOffset? endOn, string errorType, string recommendedAction, string additionalDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
