...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class DevCenterProjectPatch : DevCenterTrackedResourceUpdate
    {
        ...
        internal DevCenterProjectPatch(IDictionary<string, string> tags, AzureLocation? location, ResourceIdentifier devCenterId, string description, int? maxDevBoxesPerUser, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, location, serializedAdditionalRawData)
        {
