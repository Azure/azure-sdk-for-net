...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class DevCenterSku
    {
        ...
        internal DevCenterSku(string name, DevCenterSkuTier? tier, string size, string family, int? capacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
