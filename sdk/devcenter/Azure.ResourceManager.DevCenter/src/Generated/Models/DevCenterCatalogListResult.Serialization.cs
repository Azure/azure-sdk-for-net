...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        internal static DevCenterCatalogListResult DeserializeDevCenterCatalogListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
