...
namespace Azure.ResourceManager.DevCenter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HealthCheckStatusDetailData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HealthCheckStatusDetailData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HealthCheckStatusDetailData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HealthCheckStatusDetailData>)} interface");
            }
        ...
        string IPersistableModel<HealthCheckStatusDetailData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
