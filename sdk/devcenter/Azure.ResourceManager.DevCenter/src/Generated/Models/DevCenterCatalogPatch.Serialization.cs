...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevCenterCatalogPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevCenterCatalogPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevCenterCatalogPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevCenterCatalogPatch>)} interface");
            }
        ...
        string IPersistableModel<DevCenterCatalogPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
