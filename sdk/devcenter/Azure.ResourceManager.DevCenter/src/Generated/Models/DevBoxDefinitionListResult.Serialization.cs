...
{
    internal partial class DevBoxDefinitionListResult : IUtf8JsonSerializable, IJsonModel<DevBoxDefinitionListResult>, IPersistableModel<DevBoxDefinitionListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevBoxDefinitionListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DevBoxDefinitionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DevBoxDefinitionListResult)} does not support '{format}' format.");
            }
