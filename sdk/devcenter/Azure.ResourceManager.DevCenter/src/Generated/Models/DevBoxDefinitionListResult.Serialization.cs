...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevBoxDefinitionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevBoxDefinitionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevBoxDefinitionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevBoxDefinitionListResult>)} interface");
            }
        ...
        string IPersistableModel<DevBoxDefinitionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
