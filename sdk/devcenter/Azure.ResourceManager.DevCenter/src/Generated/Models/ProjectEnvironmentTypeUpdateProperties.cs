...
namespace Azure.ResourceManager.DevCenter.Models
{
    ...
    public partial class ProjectEnvironmentTypeUpdateProperties
    {
        ...
        internal ProjectEnvironmentTypeUpdateProperties(string deploymentTargetId, string displayName, EnvironmentTypeEnableStatus? status, ProjectEnvironmentTypeUpdatePropertiesCreatorRoleAssignment creatorRoleAssignment, IDictionary<string, UserRoleAssignmentValue> userRoleAssignments, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IDictionary<string, UserRoleAssignmentValue> UserRoleAssignments { get; } = new ChangeTrackingDictionary<string, UserRoleAssignmentValue>();

        /// <summary> A map of roles to assign to the environment creator. </summary>
        public IDictionary<string, EnvironmentRole> CreatorRoleAssignmentRoles
        {
            get
            {
