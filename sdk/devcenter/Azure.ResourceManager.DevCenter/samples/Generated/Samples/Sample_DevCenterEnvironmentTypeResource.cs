...
{
    public partial class Sample_DevCenterEnvironmentTypeResource
    {
        ...
        public async Task Get_EnvironmentTypesGet()
        {
            ...
            DevCenterEnvironmentTypeResource result = await devCenterEnvironmentType.GetAsync();
...
["Owner"] = "superuser",
        ...
        public async Task Delete_EnvironmentTypesDelete()
        {
            ...
            // invoke the operation
            await devCenterEnvironmentType.DeleteAsync(WaitUntil.Completed);
