...
namespace Azure.ResourceManager.DevCenter.Samples
{
    public partial class Sample_DevCenterProjectResource
    {
        ...
        {
            // Generated from example definition: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2025-07-01-preview/examples/Projects_Get.json
        ...
        {
            // Generated from example definition: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2025-07-01-preview/examples/Projects_Delete.json
        ...
        {
            // Generated from example definition: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2025-07-01-preview/examples/Projects_Patch.json
...
["CostCenter"] = "R&D"
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetInheritedSettings_ProjectsGetInheritedSettings()
        {
            // Generated from example definition: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2025-07-01-preview/examples/Projects_GetInheritedSettings.json
            // this example is just showing the usage of "Projects_GetInheritedSettings" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            InheritedSettingsForProject result = await devCenterProject.GetInheritedSettingsAsync();
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetSkus_SkusListByProject()
        {
            // Generated from example definition: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2025-07-01-preview/examples/Skus_ListByProject.json
            // this example is just showing the usage of "Skus_ListByProject" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (DevCenterSkuDetails item in devCenterProject.GetSkusAsync())
            {
