...
{
    public partial class Sample_DevCenterImageVersionCollection
    {
        [Test]
        ...
        public async Task Get_VersionsGet()
        {
            ...
            // get the collection of this DevCenterImageVersionResource
            DevCenterImageVersionCollection collection = devCenterImage.GetDevCenterImageVersions();

            // invoke the operation
            string versionName = "1.0.0";
            DevCenterImageVersionResource result = await collection.GetAsync(versionName);
        ...
        public async Task GetAll_ImageVersionsListByImage()
        {
            ...
            await foreach (DevCenterImageVersionResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_VersionsGet()
        {
            ...
            // invoke the operation
            string versionName = "1.0.0";
            NullableResponse<DevCenterImageVersionResource> response = await collection.GetIfExistsAsync(versionName);
            DevCenterImageVersionResource result = response.HasValue ? response.Value : null;
