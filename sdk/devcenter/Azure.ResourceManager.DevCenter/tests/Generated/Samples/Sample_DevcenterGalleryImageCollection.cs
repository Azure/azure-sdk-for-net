...
{
    public partial class Sample_DevcenterGalleryImageCollection
    {
        [Test]
        ...
        public async Task Get_ImagesGet()
        {
            ...
            // get the collection of this DevcenterGalleryImageResource
            DevcenterGalleryImageCollection collection = devCenterGallery.GetDevcenterGalleryImages();

            // invoke the operation
            string imageName = "ContosoBaseImage";
            DevcenterGalleryImageResource result = await collection.GetAsync(imageName);
        ...
        public async Task GetAll_ImagesListByGallery()
        {
            ...
            await foreach (DevcenterGalleryImageResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_ImagesGet()
        {
            ...
            // invoke the operation
            string imageName = "ContosoBaseImage";
            NullableResponse<DevcenterGalleryImageResource> response = await collection.GetIfExistsAsync(imageName);
            DevcenterGalleryImageResource result = response.HasValue ? response.Value : null;
