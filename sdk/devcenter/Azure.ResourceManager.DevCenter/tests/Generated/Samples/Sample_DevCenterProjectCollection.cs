...
namespace Azure.ResourceManager.DevCenter.Samples
{
    public partial class Sample_DevCenterProjectCollection
    {
        ...
        {
            // Generated from example definition: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2025-07-01-preview/examples/Projects_Put.json
...
["CostCenter"] = "R&D"
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_ProjectsCreateOrUpdateWithCustomizationSettings()
        {
            // Generated from example definition: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2025-07-01-preview/examples/Projects_PutWithCustomizationSettings.json
            // this example is just showing the usage of "Projects_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
...
[new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/identityGroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/testidentity1")] = new UserAssignedIdentity()
                ...
                DevCenterId = new ResourceIdentifier("/subscriptions/0ac520ee-14c0-480f-b6c9-0a90c58ffff/resourceGroups/rg1/providers/Microsoft.DevCenter/devcenters/Contoso"),
                Description = "This is my first project.",
                CustomizationSettings = new ProjectCustomizationSettings
                {
                    Identities = {new ProjectCustomizationManagedIdentity
{
IdentityType = ProjectCustomizationIdentityType.UserAssignedIdentity,
IdentityResourceId = new ResourceIdentifier("/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/identityGroup/providers/Microsoft.ManagedIdentity/userAssignedIdentities/testidentity1"),
}},
                },
                Tags =
{
["CostCenter"] = "R&D"
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_ProjectsCreateOrUpdateWithCustomizationSettingsSystemIdentity()
        {
            // Generated from example definition: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2025-07-01-preview/examples/Projects_PutWithCustomizationSettings_SystemIdentity.json
            // this example is just showing the usage of "Projects_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
...
["CostCenter"] = "R&D"
        ...
        {
            // Generated from example definition: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2025-07-01-preview/examples/Projects_PutWithMaxDevBoxPerUser.json
            // this example is just showing the usage of "Projects_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
...
["CostCenter"] = "R&D"
        ...
        public async Task Get_ProjectsGet()
        {
            ...
            // invoke the operation
            string projectName = "DevProject";
            DevCenterProjectResource result = await collection.GetAsync(projectName);
        ...
        {
            // Generated from example definition: specification/devcenter/resource-manager/Microsoft.DevCenter/preview/2025-07-01-preview/examples/Projects_ListByResourceGroup.json
        ...
        public async Task GetIfExists_ProjectsGet()
        {
            ...
            // invoke the operation
            string projectName = "DevProject";
            NullableResponse<DevCenterProjectResource> response = await collection.GetIfExistsAsync(projectName);
            DevCenterProjectResource result = response.HasValue ? response.Value : null;
