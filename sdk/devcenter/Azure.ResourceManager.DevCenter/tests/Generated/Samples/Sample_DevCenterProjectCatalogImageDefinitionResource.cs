...
{
    public partial class Sample_DevCenterProjectCatalogImageDefinitionResource
    {
        [Test]
        ...
        public async Task Get_ImageDefinitionsGetByProjectCatalog()
        {
            ...
            // this example assumes you already have this DevCenterProjectCatalogImageDefinitionResource created on azure
            // for more information of creating DevCenterProjectCatalogImageDefinitionResource, please refer to the document of DevCenterProjectCatalogImageDefinitionResource
            ...
            ResourceIdentifier devCenterProjectCatalogImageDefinitionResourceId = DevCenterProjectCatalogImageDefinitionResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, projectName, catalogName, imageDefinitionName);
            DevCenterProjectCatalogImageDefinitionResource devCenterProjectCatalogImageDefinition = client.GetDevCenterProjectCatalogImageDefinitionResource(devCenterProjectCatalogImageDefinitionResourceId);

            // invoke the operation
            DevCenterProjectCatalogImageDefinitionResource result = await devCenterProjectCatalogImageDefinition.GetAsync();
        ...
        public async Task BuildImage_ProjectCatalogImageDefinitionsBuildImage()
        {
            ...
            // invoke the operation
            await devCenterProjectCatalogImageDefinition.BuildImageAsync(WaitUntil.Completed);
        ...
        public async Task GetErrorDetails_ProjectCatalogImageDefinitionsGetErrorDetails()
        {
            ...
            // invoke the operation
            CatalogResourceValidationErrorDetails result = await devCenterProjectCatalogImageDefinition.GetErrorDetailsAsync();
