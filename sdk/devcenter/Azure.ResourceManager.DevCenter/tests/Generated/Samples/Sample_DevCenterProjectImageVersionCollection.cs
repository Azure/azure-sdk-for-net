...
{
    public partial class Sample_DevCenterProjectImageVersionCollection
    {
        [Test]
        ...
        public async Task Get_ImageVersionsGetByProject()
        {
            ...
            // get the collection of this DevCenterProjectImageVersionResource
            DevCenterProjectImageVersionCollection collection = devCenterProjectImage.GetDevCenterProjectImageVersions();

            // invoke the operation
            string versionName = "1.0.0";
            DevCenterProjectImageVersionResource result = await collection.GetAsync(versionName);
        ...
        public async Task GetAll_ImageVersionsListByProject()
        {
            ...
            await foreach (DevCenterProjectImageVersionResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_ImageVersionsGetByProject()
        {
            ...
            // invoke the operation
            string versionName = "1.0.0";
            NullableResponse<DevCenterProjectImageVersionResource> response = await collection.GetIfExistsAsync(versionName);
            DevCenterProjectImageVersionResource result = response.HasValue ? response.Value : null;
