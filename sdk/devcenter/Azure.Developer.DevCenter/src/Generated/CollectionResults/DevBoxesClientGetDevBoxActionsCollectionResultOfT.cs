...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientGetDevBoxActionsCollectionResultOfT : Pageable<DevBoxAction>
    {
        ...
        /// <summary> Initializes a new instance of DevBoxesClientGetDevBoxActionsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DevBoxesClientGetDevBoxActionsCollectionResultOfT(DevBoxesClient client, string projectName, string userId, string devBoxName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DevBoxesClientGetDevBoxActionsCollectionResultOfT as an enumerable collection. </summary>
