...
{
    internal partial class DevBoxesClientGetAllDevBoxesByUserAsyncCollectionResultOfT : AsyncPageable<global::Azure.Developer.DevCenter.Models.DevBox>
    {
        ...
        /// <summary> Initializes a new instance of DevBoxesClientGetAllDevBoxesByUserAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DevBoxesClientGetAllDevBoxesByUserAsyncCollectionResultOfT(DevBoxesClient client, string userId, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _userId = userId;
            _context = context;
        ...
        /// <summary> Gets the pages of DevBoxesClientGetAllDevBoxesByUserAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Developer.DevCenter.Models.DevBox>> AsPages(string continuationToken, int? pageSizeHint)
        {
