...
{
    internal partial class DeploymentEnvironmentsClientGetEnvironmentsCollectionResultOfT : Pageable<global::Azure.Developer.DevCenter.Models.DevCenterEnvironment>
    {
        ...
        public DeploymentEnvironmentsClientGetEnvironmentsCollectionResultOfT(DeploymentEnvironmentsClient client, string projectName, string userId, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Developer.DevCenter.Models.DevCenterEnvironment>> AsPages(string continuationToken, int? pageSizeHint)
        {
