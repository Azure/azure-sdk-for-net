...
{
    internal partial class DevBoxesClientGetDevBoxActionsAsyncCollectionResultOfT : AsyncPageable<global::Azure.Developer.DevCenter.Models.DevBoxAction>
    {
        ...
        public DevBoxesClientGetDevBoxActionsAsyncCollectionResultOfT(DevBoxesClient client, string projectName, string userId, string devBoxName, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Developer.DevCenter.Models.DevBoxAction>> AsPages(string continuationToken, int? pageSizeHint)
        {
