...
{
    internal partial class DeploymentEnvironmentsClientGetAllEnvironmentsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public DeploymentEnvironmentsClientGetAllEnvironmentsAsyncCollectionResult(DeploymentEnvironmentsClient client, string projectName, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
