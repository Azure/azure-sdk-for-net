...
{
    internal partial class DevBoxesClientDelayAllActionsAsyncCollectionResultOfT : AsyncPageable<global::Azure.Developer.DevCenter.Models.DevBoxActionDelayResult>
    {
        ...
        /// <summary> Initializes a new instance of DevBoxesClientDelayAllActionsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DevBoxesClientDelayAllActionsAsyncCollectionResultOfT(DevBoxesClient client, string projectName, string userId, string devBoxName, DateTimeOffset delayUntil, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DevBoxesClientDelayAllActionsAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Developer.DevCenter.Models.DevBoxActionDelayResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
