...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientDelayAllActionsAsyncCollectionResultOfT : AsyncPageable<DevBoxActionDelayResult>
    {
        ...
        public DevBoxesClientDelayAllActionsAsyncCollectionResultOfT(DevBoxesClient client, string projectName, string userId, string devBoxName, DateTimeOffset delayUntil, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
