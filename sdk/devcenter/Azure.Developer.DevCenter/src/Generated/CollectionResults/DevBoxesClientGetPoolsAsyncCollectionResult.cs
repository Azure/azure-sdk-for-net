...
{
    internal partial class DevBoxesClientGetPoolsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public DevBoxesClientGetPoolsAsyncCollectionResult(DevBoxesClient client, string projectName, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
