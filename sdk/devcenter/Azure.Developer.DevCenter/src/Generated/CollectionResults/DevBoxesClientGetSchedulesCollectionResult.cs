...
{
    internal partial class DevBoxesClientGetSchedulesCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public DevBoxesClientGetSchedulesCollectionResult(DevBoxesClient client, string projectName, string poolName, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
