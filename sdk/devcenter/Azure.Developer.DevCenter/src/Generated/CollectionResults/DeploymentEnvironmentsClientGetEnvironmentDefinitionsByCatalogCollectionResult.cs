...
{
    internal partial class DeploymentEnvironmentsClientGetEnvironmentDefinitionsByCatalogCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public DeploymentEnvironmentsClientGetEnvironmentDefinitionsByCatalogCollectionResult(DeploymentEnvironmentsClient client, string projectName, string catalogName, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
