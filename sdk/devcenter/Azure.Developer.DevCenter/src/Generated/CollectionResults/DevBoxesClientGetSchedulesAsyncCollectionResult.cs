...
{
    internal partial class DevBoxesClientGetSchedulesAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public DevBoxesClientGetSchedulesAsyncCollectionResult(DevBoxesClient client, string projectName, string poolName, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
