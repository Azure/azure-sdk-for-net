...
namespace Azure.Developer.DevCenter
{
    internal partial class DevBoxesClientGetSchedulesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public DevBoxesClientGetSchedulesAsyncCollectionResult(DevBoxesClient client, string projectName, string poolName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
