...
{
    internal partial class DevBoxesClientGetDevBoxActionsCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public DevBoxesClientGetDevBoxActionsCollectionResult(DevBoxesClient client, string projectName, string userId, string devBoxName, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
