...
{
    internal partial class DeploymentEnvironmentsClientGetEnvironmentDefinitionsCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public DeploymentEnvironmentsClientGetEnvironmentDefinitionsCollectionResult(DeploymentEnvironmentsClient client, string projectName, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
