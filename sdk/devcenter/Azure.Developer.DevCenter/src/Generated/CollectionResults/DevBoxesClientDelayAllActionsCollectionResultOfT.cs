...
{
    internal partial class DevBoxesClientDelayAllActionsCollectionResultOfT : Pageable<global::Azure.Developer.DevCenter.Models.DevBoxActionDelayResult>
    {
        ...
        /// <summary> Initializes a new instance of DevBoxesClientDelayAllActionsCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DevBoxesClientDelayAllActionsCollectionResultOfT(DevBoxesClient client, string projectName, string userId, string devBoxName, DateTimeOffset delayUntil, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DevBoxesClientDelayAllActionsCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Developer.DevCenter.Models.DevBoxActionDelayResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<DevBoxActionDelayResult>.FromValues(((IReadOnlyList<global::Azure.Developer.DevCenter.Models.DevBoxActionDelayResult>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
