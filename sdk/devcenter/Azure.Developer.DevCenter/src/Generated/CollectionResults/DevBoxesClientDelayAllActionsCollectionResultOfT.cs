...
{
    internal partial class DevBoxesClientDelayAllActionsCollectionResultOfT : Pageable<DevBoxActionDelayResult>
    {
        ...
        public DevBoxesClientDelayAllActionsCollectionResultOfT(DevBoxesClient client, string projectName, string userId, string devBoxName, DateTimeOffset delayUntil, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<DevBoxActionDelayResult>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<DevBoxActionDelayResult>.FromValues((IReadOnlyList<DevBoxActionDelayResult>)result.Value, nextPage?.AbsoluteUri, response);
