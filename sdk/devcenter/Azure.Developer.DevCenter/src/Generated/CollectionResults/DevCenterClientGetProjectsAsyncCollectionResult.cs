...
{
    internal partial class DevCenterClientGetProjectsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public DevCenterClientGetProjectsAsyncCollectionResult(DevCenterClient client, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _context = context;
