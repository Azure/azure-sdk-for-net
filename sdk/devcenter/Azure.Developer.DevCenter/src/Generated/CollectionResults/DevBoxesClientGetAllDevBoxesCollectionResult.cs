...
{
    internal partial class DevBoxesClientGetAllDevBoxesCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public DevBoxesClientGetAllDevBoxesCollectionResult(DevBoxesClient client, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _context = context;
