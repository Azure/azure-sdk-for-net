...
{
    internal partial class DevBoxesClientGetDevBoxesCollectionResultOfT : Pageable<global::Azure.Developer.DevCenter.Models.DevBox>
    {
        ...
        public DevBoxesClientGetDevBoxesCollectionResultOfT(DevBoxesClient client, string projectName, string userId, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
