...
{
    internal partial class DeploymentEnvironmentsClientGetCatalogsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public DeploymentEnvironmentsClientGetCatalogsAsyncCollectionResult(DeploymentEnvironmentsClient client, string projectName, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
