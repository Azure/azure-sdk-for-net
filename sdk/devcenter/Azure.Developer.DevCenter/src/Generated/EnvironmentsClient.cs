...
namespace Azure.Developer.DevCenter
{
    ...
    public partial class EnvironmentsClient
    {
        ...
        public virtual async Task<Response> GetEnvironmentByUserAsync(string environmentName, string userId, RequestContext context)
        {
        ...
        public virtual Response GetEnvironmentByUser(string environmentName, string userId, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(environmentName, nameof(environmentName));
            Argument.AssertNotNullOrEmpty(userId, nameof(userId));
