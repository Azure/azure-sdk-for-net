    ...
    public partial class DevBoxActionDelayResult : IUtf8JsonSerializable, IJsonModel<DevBoxActionDelayResult>
    {
        ...
        internal static DevBoxActionDelayResult DeserializeDevBoxActionDelayResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResponseError>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), options, AzureDeveloperDevCenterContext.Default)
#else
                ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), options, AzureDeveloperDevCenterContext.Default)
#endif
;
                    continue;
                }
