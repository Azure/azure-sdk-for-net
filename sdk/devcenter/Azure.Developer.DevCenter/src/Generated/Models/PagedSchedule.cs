...
namespace Azure.Developer.DevCenter.Models
{
    ...
    internal partial class PagedSchedule
    {
        ...
        internal PagedSchedule(IEnumerable<DevBoxSchedule> value)
        {
            Value = value.ToList();
        }
        ...
        internal PagedSchedule(IList<DevBoxSchedule> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<DevBoxSchedule> Value { get; }
