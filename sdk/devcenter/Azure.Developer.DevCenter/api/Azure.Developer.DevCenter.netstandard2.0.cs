namespace Azure.Developer.DevCenter
{
    public partial class DevBoxClient
    {
        ...
        public DevBoxClient(string tenantId, string devCenter, string projectName, Azure.Core.TokenCredential credential) { }
        public DevBoxClient(string tenantId, string devCenter, string projectName, Azure.Core.TokenCredential credential, string devCenterDnsSuffix, Azure.Developer.DevCenter.DevCenterClientOptions options) { }
        public virtual Azure.Core.Pipeline.HttpPipeline Pipeline { get { throw null; } }
        public virtual Azure.Operation<System.BinaryData> Stop(Azure.WaitUntil waitUntil, string devBoxName, string userId = "me", string stopType = null, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Operation<System.BinaryData>> StopAsync(Azure.WaitUntil waitUntil, string devBoxName, string userId = "me", string stopType = null, Azure.RequestContext context = null) { throw null; }
    }
    ...
    public partial class DevCenterClient
    {
        ...
        public DevCenterClient(string tenantId, string devCenter, string projectName, Azure.Core.TokenCredential credential) { }
        public DevCenterClient(string tenantId, string devCenter, string projectName, Azure.Core.TokenCredential credential, string devCenterDnsSuffix, Azure.Developer.DevCenter.DevCenterClientOptions options) { }
        public virtual Azure.Core.Pipeline.HttpPipeline Pipeline { get { throw null; } }
        public virtual Azure.Response CreateNotificationSettings(string userId, Azure.Core.RequestContent content, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Response> CreateNotificationSettingsAsync(string userId, Azure.Core.RequestContent content, Azure.RequestContext context = null) { throw null; }
        ...
        public virtual Azure.Response GetNotificationSettings(string userId, Azure.RequestContext context = null) { throw null; }
        public virtual Azure.Response GetNotificationSettingsAllowedCultures(string userId, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Response> GetNotificationSettingsAllowedCulturesAsync(string userId, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Response> GetNotificationSettingsAsync(string userId, Azure.RequestContext context = null) { throw null; }
    ...
    public partial class EnvironmentsClient
    {
        ...
        public virtual Azure.Operation DeleteEnvironmentAction(Azure.WaitUntil waitUntil, string userId, string environmentName, Azure.Core.RequestContent content, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Operation> DeleteEnvironmentActionAsync(Azure.WaitUntil waitUntil, string userId, string environmentName, Azure.Core.RequestContent content, Azure.RequestContext context = null) { throw null; }
        ...
        public virtual Azure.Pageable<System.BinaryData> GetArtifactsByEnvironment(string userId, string environmentName, Azure.RequestContext context = null) { throw null; }
        public virtual Azure.Pageable<System.BinaryData> GetArtifactsByEnvironmentAndPath(string userId, string environmentName, string artifactPath, Azure.RequestContext context = null) { throw null; }
        public virtual Azure.AsyncPageable<System.BinaryData> GetArtifactsByEnvironmentAndPathAsync(string userId, string environmentName, string artifactPath, Azure.RequestContext context = null) { throw null; }
        public virtual Azure.AsyncPageable<System.BinaryData> GetArtifactsByEnvironmentAsync(string userId, string environmentName, Azure.RequestContext context = null) { throw null; }
