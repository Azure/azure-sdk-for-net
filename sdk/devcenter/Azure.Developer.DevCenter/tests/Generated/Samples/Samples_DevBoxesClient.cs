...
namespace Azure.Developer.DevCenter.Samples
{
    public class Samples_DevBoxesClient
    {
        ...
        public void Example_CreateDevBox()
        {
            ...
            var operation = client.CreateDevBox(WaitUntil.Completed, "<projectName>", "<userId>", "<devBoxName>", RequestContent.Create(data));
        ...
        public async Task Example_CreateDevBox_Async()
        {
            ...
            var operation = await client.CreateDevBoxAsync(WaitUntil.Completed, "<projectName>", "<userId>", "<devBoxName>", RequestContent.Create(data));
