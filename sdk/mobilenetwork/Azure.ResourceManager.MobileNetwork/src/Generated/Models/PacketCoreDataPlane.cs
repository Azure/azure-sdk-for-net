...
{
    /// <summary> Packet core data plane resource. Must be created in the same location as its parent packet core control plane. </summary>
    public partial class PacketCoreDataPlane : TrackedResourceData
    {
        ...
        public PacketCoreDataPlane(AzureLocation location, InterfaceProperties userPlaneAccessInterface) : base(location)
        {
        ...
        /// <param name="userPlaneAccessInterface"> The user plane interface on the access network. For 5G networks, this is the N3 interface. For 4G networks, this is the S1-U interface. </param>
        internal PacketCoreDataPlane(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ProvisioningState? provisioningState, InterfaceProperties userPlaneAccessInterface) : base(id, name, resourceType, systemData, tags, location)
        {
