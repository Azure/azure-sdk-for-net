...
{
    public partial class Ambr : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Ambr DeserializeAmbr(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
