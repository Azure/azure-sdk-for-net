...
{
    public partial class MobileNetworkLocalDiagnosticsAccessConfiguration : IUtf8JsonSerializable, IJsonModel<MobileNetworkLocalDiagnosticsAccessConfiguration>, IPersistableModel<MobileNetworkLocalDiagnosticsAccessConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HttpsServerCertificate))
            {
                ...
                AppendChildObject(builder, HttpsServerCertificate, options, 2);
            }
