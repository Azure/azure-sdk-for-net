...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PacketCoreControlPlaneData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PacketCoreControlPlaneData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PacketCoreControlPlaneData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PacketCoreControlPlaneData>)} interface");
            }
        ...
        string IPersistableModel<PacketCoreControlPlaneData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
