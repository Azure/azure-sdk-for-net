...
{
    public partial class QosPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static QosPolicy DeserializeQosPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
