...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    public partial class AsyncOperationStatus
    {
        ...
        internal AsyncOperationStatus(string id, string name, string status, string resourceId, DateTimeOffset? startOn, DateTimeOffset? endOn, double? percentComplete, BinaryData properties, ResponseError error, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Name = name;
            Status = status;
