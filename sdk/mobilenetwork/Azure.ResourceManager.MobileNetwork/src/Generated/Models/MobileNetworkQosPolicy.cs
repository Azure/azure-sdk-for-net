...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    public partial class MobileNetworkQosPolicy
    {
        ...
        internal MobileNetworkQosPolicy(int? fiveQi, int? allocationAndRetentionPriorityLevel, MobileNetworkPreemptionCapability? preemptionCapability, MobileNetworkPreemptionVulnerability? preemptionVulnerability, Ambr maximumBitRate, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FiveQi = fiveQi;
