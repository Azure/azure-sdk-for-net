...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    public partial class EncryptedSimUploadList
    {
        ...
        internal EncryptedSimUploadList(int version, int azureKeyIdentifier, string vendorKeyFingerprint, string encryptedTransportKey, string signedTransportKey, IList<SimNameAndEncryptedProperties> sims, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Version = version;
            AzureKeyIdentifier = azureKeyIdentifier;
            VendorKeyFingerprint = vendorKeyFingerprint;
