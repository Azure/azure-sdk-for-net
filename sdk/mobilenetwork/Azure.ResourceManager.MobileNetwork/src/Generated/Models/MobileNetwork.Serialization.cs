...
{
    public partial class MobileNetwork : IUtf8JsonSerializable
    {
        ...
        internal static MobileNetwork DeserializeMobileNetwork(JsonElement element)
        {
            ...
            return new MobileNetwork(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(provisioningState), publicLandMobileNetworkIdentifier, serviceKey.Value);
        }
    }
}
