...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PccRuleConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PccRuleConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PccRuleConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PccRuleConfiguration>)} interface");
            }
        ...
        string IPersistableModel<PccRuleConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
