...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    public partial class PccRuleConfiguration
    {
        ...
        internal PccRuleConfiguration(string ruleName, int rulePrecedence, PccRuleQosPolicy ruleQosPolicy, MobileNetworkTrafficControlPermission? trafficControl, IList<MobileNetworkServiceDataFlowTemplate> serviceDataFlowTemplates, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RuleName = ruleName;
            RulePrecedence = rulePrecedence;
