...
{
    /// <summary> Service resource. Must be created in the same location as its parent mobile network. </summary>
    public partial class Service : TrackedResourceData
    {
        ...
        public Service(AzureLocation location, int servicePrecedence, IEnumerable<PccRuleConfiguration> pccRules) : base(location)
        {
