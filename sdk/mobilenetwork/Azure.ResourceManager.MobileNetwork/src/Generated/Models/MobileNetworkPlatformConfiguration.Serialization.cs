...
{
    public partial class MobileNetworkPlatformConfiguration : IUtf8JsonSerializable, IJsonModel<MobileNetworkPlatformConfiguration>, IPersistableModel<MobileNetworkPlatformConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AzureStackEdgeDevice))
            {
                ...
                AppendChildObject(builder, AzureStackEdgeDevice, options, 2);
            }
            ...
            if (Optional.IsDefined(AzureStackHciCluster))
            {
                ...
                AppendChildObject(builder, AzureStackHciCluster, options, 2);
            }

            if (Optional.IsDefined(ConnectedCluster))
            {
                builder.Append("  connectedCluster:");
                AppendChildObject(builder, ConnectedCluster, options, 2);
            }

            if (Optional.IsDefined(CustomLocation))
            {
                builder.Append("  customLocation:");
                AppendChildObject(builder, CustomLocation, options, 2);
            }
