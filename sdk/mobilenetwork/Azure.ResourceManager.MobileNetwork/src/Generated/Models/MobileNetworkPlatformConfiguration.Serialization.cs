        ...
        internal static MobileNetworkPlatformConfiguration DeserializeMobileNetworkPlatformConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("azureStackEdgeDevice"u8))
                {
                    ...
                    azureStackEdgeDevice = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property.Value.GetRawText(), ModelSerializationExtensions.Options);
                    continue;
                }
                ...
                if (property.NameEquals("azureStackHciCluster"u8))
                {
                    ...
                    azureStackHciCluster = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property.Value.GetRawText(), ModelSerializationExtensions.Options);
                    continue;
                }
                if (property.NameEquals("connectedCluster"u8))
                {
                    ...
                    connectedCluster = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property.Value.GetRawText(), ModelSerializationExtensions.Options);
                    continue;
                }
                if (property.NameEquals("customLocation"u8))
                {
                    ...
                    customLocation = ModelSerializationExtensions.JsonDeserialize<WritableSubResource>(property.Value.GetRawText(), ModelSerializationExtensions.Options);
                    continue;
                }
                if (options.Format != "W")
                {
