...
{
    public partial class PortRange : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PortRange DeserializePortRange(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
