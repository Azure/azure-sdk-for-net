...
{
    public partial class MobileNetworkServiceData : IUtf8JsonSerializable, IJsonModel<MobileNetworkServiceData>, IPersistableModel<MobileNetworkServiceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServicePrecedence))
            {
                builder.Append("  servicePrecedence:");
                builder.AppendLine($" '{ServicePrecedence.ToString()}'");
            }

            if (Optional.IsDefined(ServiceQosPolicy))
            {
                builder.Append("  serviceQosPolicy:");
                AppendChildObject(builder, ServiceQosPolicy, options, 2);
            }
