...
{
    internal partial class AttachedDataNetworkListResult : IUtf8JsonSerializable, IJsonModel<AttachedDataNetworkListResult>, IPersistableModel<AttachedDataNetworkListResult>
    {
        ...
        void IJsonModel<AttachedDataNetworkListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AttachedDataNetworkListResult)} does not support '{format}' format.");
            }
