...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SimNameAndEncryptedProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SimNameAndEncryptedProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SimNameAndEncryptedProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SimNameAndEncryptedProperties>)} interface");
            }
        ...
        string IPersistableModel<SimNameAndEncryptedProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
