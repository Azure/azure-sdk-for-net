...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    public partial class SimNameAndEncryptedProperties : IUtf8JsonSerializable, IModelJsonSerializable<SimNameAndEncryptedProperties>
    {
        ...
        internal static SimNameAndEncryptedProperties DeserializeSimNameAndEncryptedProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SimNameAndEncryptedProperties(name, Optional.ToNullable(provisioningState), Optional.ToNullable(simState), Optional.ToDictionary(siteProvisioningState), internationalMobileSubscriberIdentity, integratedCircuitCardIdentifier.Value, deviceType.Value, simPolicy, Optional.ToList(staticIPConfiguration), vendorName.Value, vendorKeyFingerprint.Value, encryptedCredentials.Value, rawData);
        }
