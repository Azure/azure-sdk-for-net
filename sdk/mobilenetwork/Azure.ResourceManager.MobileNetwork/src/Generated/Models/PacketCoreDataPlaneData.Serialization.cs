...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PacketCoreDataPlaneData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PacketCoreDataPlaneData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PacketCoreDataPlaneData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PacketCoreDataPlaneData>)} interface");
            }
        ...
        string IPersistableModel<PacketCoreDataPlaneData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
