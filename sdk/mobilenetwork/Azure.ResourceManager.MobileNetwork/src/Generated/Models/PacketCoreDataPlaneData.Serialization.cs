...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PacketCoreDataPlaneData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        PacketCoreDataPlaneData IJsonModel<PacketCoreDataPlaneData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(PacketCoreDataPlaneData)} does not support '{options.Format}' format.");
            }
        ...
        internal static PacketCoreDataPlaneData DeserializePacketCoreDataPlaneData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new PacketCoreDataPlaneData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(provisioningState), userPlaneAccessInterface, Optional.ToList(userPlaneAccessVirtualIPv4Addresses), serializedAdditionalRawData);
        }

        BinaryData IModel<PacketCoreDataPlaneData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        PacketCoreDataPlaneData IModel<PacketCoreDataPlaneData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<PacketCoreDataPlaneData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
