...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SimNameAndProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SimNameAndProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SimNameAndProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SimNameAndProperties>)} interface");
            }
        ...
        string IPersistableModel<SimNameAndProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
