...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MobileNetworkCertificateProvisioning>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MobileNetworkCertificateProvisioning>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MobileNetworkCertificateProvisioning>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MobileNetworkCertificateProvisioning>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
