...
{
    public partial class DiagnosticsPackageData : IUtf8JsonSerializable
    {
        ...
        internal static DiagnosticsPackageData DeserializeDiagnosticsPackageData(JsonElement element)
        {
            ...
            return new DiagnosticsPackageData(id, name, type, systemData.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(status), reason.Value);
        }
    }
}
