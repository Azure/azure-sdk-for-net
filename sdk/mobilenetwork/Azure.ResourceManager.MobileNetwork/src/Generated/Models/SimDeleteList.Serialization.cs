...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SimDeleteList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SimDeleteList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SimDeleteList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SimDeleteList>)} interface");
            }
        ...
        string IPersistableModel<SimDeleteList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
