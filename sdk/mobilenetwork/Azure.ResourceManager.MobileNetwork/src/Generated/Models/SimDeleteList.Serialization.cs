...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    public partial class SimDeleteList : IUtf8JsonSerializable, IJsonModel<SimDeleteList>
    {
        ...
        void IJsonModel<SimDeleteList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SimDeleteList)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SimDeleteList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SimDeleteList)} does not support '{options.Format}' format.");
            }
        }
