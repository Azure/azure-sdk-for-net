...
namespace Azure.ResourceManager.MobileNetwork
{
    public partial class SimGroupData : IUtf8JsonSerializable
    {
        ...
        internal static SimGroupData DeserializeSimGroupData(JsonElement element)
        {
            ...
            return new SimGroupData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity.Value, Optional.ToNullable(provisioningState), encryptionKey.Value, mobileNetwork);
        }
    }
}
