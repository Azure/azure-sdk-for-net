...
{
    public partial class Platform : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Platform DeserializePlatform(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
