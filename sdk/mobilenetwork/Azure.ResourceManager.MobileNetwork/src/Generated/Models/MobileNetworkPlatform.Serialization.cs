...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MobileNetworkPlatform>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MobileNetworkPlatform>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MobileNetworkPlatform>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MobileNetworkPlatform>)} interface");
            }
        ...
        string IPersistableModel<MobileNetworkPlatform>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
