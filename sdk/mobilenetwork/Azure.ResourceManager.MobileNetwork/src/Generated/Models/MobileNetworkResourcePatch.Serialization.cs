...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MobileNetworkResourcePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MobileNetworkResourcePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MobileNetworkResourcePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MobileNetworkResourcePatch>)} interface");
            }
        ...
        string IPersistableModel<MobileNetworkResourcePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
