...
{
    /// <summary> Site resource. Must be created in the same location as its parent mobile network. </summary>
    public partial class Site : TrackedResourceData
    {
        /// <summary> Initializes a new instance of Site. </summary>
        /// <param name="location"> The location. </param>
        public Site(AzureLocation location) : base(location)
        {
        ...
        internal Site(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ProvisioningState? provisioningState, IReadOnlyList<SubResource> networkFunctions) : base(id, name, resourceType, systemData, tags, location)
        {
