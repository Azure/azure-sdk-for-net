...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    public partial class NaptConfiguration
    {
        ...
        internal NaptConfiguration(NaptState? enabled, MobileNetworkPortRange portRange, MobileNetworkPortReuseHoldTimes portReuseHoldTime, int? pinholeLimits, PinholeTimeouts pinholeTimeouts, Dictionary<string, BinaryData> rawData)
        {
            Enabled = enabled;
            PortRange = portRange;
