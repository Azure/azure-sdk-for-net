...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MobileNetworkHttpsServerCertificate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MobileNetworkHttpsServerCertificate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MobileNetworkHttpsServerCertificate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MobileNetworkHttpsServerCertificate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
