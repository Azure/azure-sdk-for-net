...
{
    public partial class MobileNetworkHttpsServerCertificate : IUtf8JsonSerializable, IJsonModel<MobileNetworkHttpsServerCertificate>, IPersistableModel<MobileNetworkHttpsServerCertificate>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Provisioning))
            {
                ...
                AppendChildObject(builder, Provisioning, options, 2);
            }
