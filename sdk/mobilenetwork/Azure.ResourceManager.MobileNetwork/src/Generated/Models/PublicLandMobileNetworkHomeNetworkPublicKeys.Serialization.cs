...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    public partial class PublicLandMobileNetworkHomeNetworkPublicKeys : IUtf8JsonSerializable, IJsonModel<PublicLandMobileNetworkHomeNetworkPublicKeys>
    {
        ...
        void IJsonModel<PublicLandMobileNetworkHomeNetworkPublicKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PublicLandMobileNetworkHomeNetworkPublicKeys)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(ProfileA is ChangeTrackingList<HomeNetworkPublicKey> collection && collection.IsUndefined))
            {
            ...
            if (!(ProfileB is ChangeTrackingList<HomeNetworkPublicKey> collection0 && collection0.IsUndefined))
            {
        ...
        BinaryData IPersistableModel<PublicLandMobileNetworkHomeNetworkPublicKeys>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PublicLandMobileNetworkHomeNetworkPublicKeys)} does not support '{options.Format}' format.");
            }
        }
