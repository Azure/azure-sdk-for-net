...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MobileNetworkDiagnosticsPackageData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MobileNetworkDiagnosticsPackageData IJsonModel<MobileNetworkDiagnosticsPackageData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<MobileNetworkDiagnosticsPackageData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MobileNetworkDiagnosticsPackageData IModel<MobileNetworkDiagnosticsPackageData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MobileNetworkDiagnosticsPackageData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
