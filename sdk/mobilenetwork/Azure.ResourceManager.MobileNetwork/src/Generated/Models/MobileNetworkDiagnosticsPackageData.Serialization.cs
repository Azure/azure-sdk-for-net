...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MobileNetworkDiagnosticsPackageData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MobileNetworkDiagnosticsPackageData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MobileNetworkDiagnosticsPackageData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MobileNetworkDiagnosticsPackageData>)} interface");
            }
        ...
        string IPersistableModel<MobileNetworkDiagnosticsPackageData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
