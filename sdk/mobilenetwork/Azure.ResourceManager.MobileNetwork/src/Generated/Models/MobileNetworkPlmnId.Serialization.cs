...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MobileNetworkPlmnId>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MobileNetworkPlmnId>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MobileNetworkPlmnId>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MobileNetworkPlmnId>)} interface");
            }
        ...
        string IPersistableModel<MobileNetworkPlmnId>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
