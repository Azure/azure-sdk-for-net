...
{
    public partial class SimData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SimData DeserializeSimData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
