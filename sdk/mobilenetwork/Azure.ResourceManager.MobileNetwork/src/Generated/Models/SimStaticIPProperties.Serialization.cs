...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SimStaticIPProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SimStaticIPProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SimStaticIPProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SimStaticIPProperties>)} interface");
            }
        ...
        string IPersistableModel<SimStaticIPProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
