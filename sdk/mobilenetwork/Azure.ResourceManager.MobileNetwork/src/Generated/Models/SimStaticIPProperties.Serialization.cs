...
{
    public partial class SimStaticIPProperties : IUtf8JsonSerializable, IJsonModel<SimStaticIPProperties>, IPersistableModel<SimStaticIPProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AttachedDataNetwork))
            {
                ...
                AppendChildObject(builder, AttachedDataNetwork, options, 2);
            }
            ...
            if (Optional.IsDefined(StaticIP))
            {
                ...
                AppendChildObject(builder, StaticIP, options, 2);
            }
