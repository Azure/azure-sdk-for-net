...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    public partial class PccRuleQosPolicy : MobileNetworkQosPolicy
    {
        ...
        internal PccRuleQosPolicy(int? fiveQi, int? allocationAndRetentionPriorityLevel, MobileNetworkPreemptionCapability? preemptionCapability, MobileNetworkPreemptionVulnerability? preemptionVulnerability, Ambr maximumBitRate, Ambr guaranteedBitRate, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(fiveQi, allocationAndRetentionPriorityLevel, preemptionCapability, preemptionVulnerability, maximumBitRate, serializedAdditionalRawData)
        {
