...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    public partial class Service : IUtf8JsonSerializable
    {
        ...
        internal static Service DeserializeService(JsonElement element)
        {
            ...
            return new Service(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, Optional.ToNullable(provisioningState), servicePrecedence, serviceQosPolicy.Value, pccRules);
        }
    }
}
