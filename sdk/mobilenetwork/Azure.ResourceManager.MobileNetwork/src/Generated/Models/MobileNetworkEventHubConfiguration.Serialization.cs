...
{
    public partial class MobileNetworkEventHubConfiguration : IUtf8JsonSerializable, IJsonModel<MobileNetworkEventHubConfiguration>, IPersistableModel<MobileNetworkEventHubConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReportingInterval))
            {
                ...
                builder.AppendLine($" '{ReportingInterval.Value.ToString()}'");
            }
