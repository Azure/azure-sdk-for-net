...
{
    public partial class MobileAttachedDataNetworkData : IUtf8JsonSerializable, IJsonModel<MobileAttachedDataNetworkData>, IPersistableModel<MobileAttachedDataNetworkData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UserPlaneDataInterface))
            {
                ...
                AppendChildObject(builder, UserPlaneDataInterface, options, 2);
            }
            ...
            if (Optional.IsDefined(NaptConfiguration))
            {
                ...
                AppendChildObject(builder, NaptConfiguration, options, 2);
            }
