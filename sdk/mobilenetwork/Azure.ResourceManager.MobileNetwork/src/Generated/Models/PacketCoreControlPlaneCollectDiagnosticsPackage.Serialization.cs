...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PacketCoreControlPlaneCollectDiagnosticsPackage>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        PacketCoreControlPlaneCollectDiagnosticsPackage IJsonModel<PacketCoreControlPlaneCollectDiagnosticsPackage>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<PacketCoreControlPlaneCollectDiagnosticsPackage>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        PacketCoreControlPlaneCollectDiagnosticsPackage IModel<PacketCoreControlPlaneCollectDiagnosticsPackage>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<PacketCoreControlPlaneCollectDiagnosticsPackage>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
