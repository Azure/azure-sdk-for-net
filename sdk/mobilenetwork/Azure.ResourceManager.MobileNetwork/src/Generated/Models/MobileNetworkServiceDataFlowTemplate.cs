...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    public partial class MobileNetworkServiceDataFlowTemplate
    {
        ...
        internal MobileNetworkServiceDataFlowTemplate(string templateName, MobileNetworkSdfDirectionS direction, IList<string> protocol, IList<string> remoteIPList, IList<string> ports, Dictionary<string, BinaryData> rawData)
        {
            TemplateName = templateName;
            Direction = direction;
            Protocol = protocol;
