...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    public partial class MobileNetworkInterfaceProperties
    {
        ...
        internal MobileNetworkInterfaceProperties(string name, string ipv4Address, string ipv4Subnet, string ipv4Gateway, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
