...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SimUploadList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SimUploadList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SimUploadList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SimUploadList>)} interface");
            }
        ...
        string IPersistableModel<SimUploadList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
