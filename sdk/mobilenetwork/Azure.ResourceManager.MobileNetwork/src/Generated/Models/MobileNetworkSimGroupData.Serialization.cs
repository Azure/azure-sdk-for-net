...
{
    public partial class MobileNetworkSimGroupData : IUtf8JsonSerializable, IJsonModel<MobileNetworkSimGroupData>, IPersistableModel<MobileNetworkSimGroupData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EncryptionKey))
            {
                ...
                AppendChildObject(builder, EncryptionKey, options, 2);
            }

            if (Optional.IsDefined(MobileNetwork))
            {
                builder.Append("  mobileNetwork:");
                AppendChildObject(builder, MobileNetwork, options, 2);
            }
