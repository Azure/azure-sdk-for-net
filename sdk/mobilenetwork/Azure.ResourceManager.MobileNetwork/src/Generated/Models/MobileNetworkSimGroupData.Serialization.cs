...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MobileNetworkSimGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MobileNetworkSimGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MobileNetworkSimGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MobileNetworkSimGroupData>)} interface");
            }
        ...
        string IPersistableModel<MobileNetworkSimGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
