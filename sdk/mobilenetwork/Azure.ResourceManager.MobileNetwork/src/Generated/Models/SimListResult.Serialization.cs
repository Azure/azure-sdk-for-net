...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SimListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SimListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SimListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SimListResult>)} interface");
            }
        ...
        string IPersistableModel<SimListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
