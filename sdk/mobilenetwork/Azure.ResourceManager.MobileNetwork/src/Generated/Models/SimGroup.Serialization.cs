...
{
    public partial class SimGroup : IUtf8JsonSerializable
    {
        ...
        internal static SimGroup DeserializeSimGroup(JsonElement element)
        {
            ...
            return new SimGroup(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity.Value, Optional.ToNullable(provisioningState), encryptionKey.Value, mobileNetwork);
        }
    }
}
