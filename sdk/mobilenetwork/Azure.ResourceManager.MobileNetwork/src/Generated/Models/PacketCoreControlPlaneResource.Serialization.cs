...
namespace Azure.ResourceManager.MobileNetwork
{
    public partial class PacketCoreControlPlaneResource : IJsonModel<PacketCoreControlPlaneData>
    {
        ...
        {
            return ModelReaderWriter.Read<PacketCoreControlPlaneData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<PacketCoreControlPlaneData>(data, options);
        }
