...
{
    public partial class MobileNetworkPortRange : IUtf8JsonSerializable, IJsonModel<MobileNetworkPortRange>, IPersistableModel<MobileNetworkPortRange>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinPort))
            {
                ...
                builder.AppendLine($" '{MinPort.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxPort))
            {
                builder.Append("  maxPort:");
                builder.AppendLine($" '{MaxPort.Value.ToString()}'");
            }
