...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MobileNetworkPortRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MobileNetworkPortRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MobileNetworkPortRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MobileNetworkPortRange>)} interface");
            }
        ...
        string IPersistableModel<MobileNetworkPortRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
