...
{
    /// <summary> Network slice resource. Must be created in the same location as its parent mobile network. </summary>
    public partial class Slice : TrackedResourceData
    {
        ...
        public Slice(AzureLocation location, Snssai snssai) : base(location)
        {
        ...
        internal Slice(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ProvisioningState? provisioningState, Snssai snssai, string description) : base(id, name, resourceType, systemData, tags, location)
        {
