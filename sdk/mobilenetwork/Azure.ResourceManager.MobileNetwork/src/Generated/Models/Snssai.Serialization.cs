...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Snssai>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Snssai>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Snssai>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Snssai>)} interface");
            }
        ...
        string IPersistableModel<Snssai>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
