...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    public partial class MobileNetworkCertificateProvisioning
    {
        ...
        internal MobileNetworkCertificateProvisioning(CertificateProvisioningState? state, string reason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
            Reason = reason;
