...
{
    /// <summary> Attached data network resource. Must be created in the same location as its parent packet core data plane. </summary>
    public partial class AttachedDataNetwork : TrackedResourceData
    {
        ...
        public AttachedDataNetwork(AzureLocation location, InterfaceProperties userPlaneDataInterface, IEnumerable<string> dnsAddresses) : base(location)
        {
