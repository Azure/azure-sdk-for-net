...
{
    public partial class MobileNetworkSliceConfiguration : IUtf8JsonSerializable, IJsonModel<MobileNetworkSliceConfiguration>, IPersistableModel<MobileNetworkSliceConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Slice))
            {
                ...
                AppendChildObject(builder, Slice, options, 2);
            }

            if (Optional.IsDefined(DefaultDataNetwork))
            {
                builder.Append("  defaultDataNetwork:");
                AppendChildObject(builder, DefaultDataNetwork, options, 2);
            }
