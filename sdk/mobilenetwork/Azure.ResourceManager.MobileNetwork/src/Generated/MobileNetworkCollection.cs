...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    public partial class MobileNetworkCollection : ArmCollection, IEnumerable<MobileNetworkResource>, IAsyncEnumerable<MobileNetworkResource>
    {
        ...
        /// Operation Id: MobileNetworks_CreateOrUpdate
        /// </summary>
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MobileNetwork/mobileNetworks
        /// Operation Id: MobileNetworks_ListByResourceGroup
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual AsyncPageable<MobileNetworkResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _mobileNetworkClientDiagnostics.CreateScope("MobileNetworkCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _mobileNetworkRestClient.ListByResourceGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<MobileNetworkResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _mobileNetworkRestClient.ListByResourceGroupNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MobileNetworkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<MobileNetworkResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<MobileNetworkResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _mobileNetworkRestClient.ListByResourceGroup(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MobileNetworkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<MobileNetworkResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _mobileNetworkRestClient.ListByResourceGroupNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MobileNetworkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
