...
namespace Azure.ResourceManager.MobileNetwork
{
    public partial class MobileNetworkDiagnosticsPackageResource : IJsonModel<MobileNetworkDiagnosticsPackageData>
    {
        ...
        {
            return ModelReaderWriter.Read<MobileNetworkDiagnosticsPackageData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<MobileNetworkDiagnosticsPackageData>(data, options);
        }
