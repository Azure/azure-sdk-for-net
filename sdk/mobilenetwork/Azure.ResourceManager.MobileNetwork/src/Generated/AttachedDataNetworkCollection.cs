...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    public partial class AttachedDataNetworkCollection : ArmCollection, IEnumerable<AttachedDataNetworkResource>, IAsyncEnumerable<AttachedDataNetworkResource>
    {
        ...
        /// Operation Id: AttachedDataNetworks_CreateOrUpdate
        /// </summary>
        ...
        {
            async Task<Page<AttachedDataNetworkResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _attachedDataNetworkClientDiagnostics.CreateScope("AttachedDataNetworkCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _attachedDataNetworkRestClient.ListByPacketCoreDataPlaneAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AttachedDataNetworkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<AttachedDataNetworkResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _attachedDataNetworkClientDiagnostics.CreateScope("AttachedDataNetworkCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _attachedDataNetworkRestClient.ListByPacketCoreDataPlaneNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AttachedDataNetworkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<AttachedDataNetworkResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _attachedDataNetworkClientDiagnostics.CreateScope("AttachedDataNetworkCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _attachedDataNetworkRestClient.ListByPacketCoreDataPlane(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AttachedDataNetworkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<AttachedDataNetworkResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _attachedDataNetworkClientDiagnostics.CreateScope("AttachedDataNetworkCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _attachedDataNetworkRestClient.ListByPacketCoreDataPlaneNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AttachedDataNetworkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
