...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    public partial class MobileNetworkSimPolicyResource : ArmResource
    {
        ...
        /// <param name="simPolicyName"> The simPolicyName. </param>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MobileNetworkArmOperation(_mobileNetworkSimPolicySimPoliciesClientDiagnostics, Pipeline, _mobileNetworkSimPolicySimPoliciesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
