...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    public partial class SimGroupData : TrackedResourceData
    {
        ...
        public SimGroupData(AzureLocation location) : base(location)
        {
        }
        ...
        internal SimGroupData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ManagedServiceIdentity identity, ProvisioningState? provisioningState, KeyVaultKey encryptionKey, WritableSubResource mobileNetwork) : base(id, name, resourceType, systemData, tags, location)
        {
            Identity = identity;
