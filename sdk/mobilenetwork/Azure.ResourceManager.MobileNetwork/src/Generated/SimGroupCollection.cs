...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    public partial class SimGroupCollection : ArmCollection, IEnumerable<SimGroupResource>, IAsyncEnumerable<SimGroupResource>
    {
        ...
        public virtual async Task<ArmOperation<SimGroupResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string simGroupName, SimGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _simGroupRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, simGroupName, data);
                var response = await _simGroupRestClient.CreateOrUpdateAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new MobileNetworkArmOperation<SimGroupResource>(new SimGroupOperationSource(Client), _simGroupClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation<SimGroupResource> CreateOrUpdate(WaitUntil waitUntil, string simGroupName, SimGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _simGroupRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, simGroupName, data);
                var response = _simGroupRestClient.CreateOrUpdate(message, cancellationToken);
                var operation = new MobileNetworkArmOperation<SimGroupResource>(new SimGroupOperationSource(Client), _simGroupClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
