    ...
    public partial class MobileNetworkPacketCaptureResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MobileNetworkArmOperation(_mobileNetworkPacketCapturePacketCapturesClientDiagnostics, Pipeline, _mobileNetworkPacketCapturePacketCapturesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, Core.OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<MobileNetworkPacketCaptureResource>> UpdateAsync(WaitUntil waitUntil, MobileNetworkPacketCaptureData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MobileNetworkArmOperation<MobileNetworkPacketCaptureResource>(new MobileNetworkPacketCaptureOperationSource(Client), _mobileNetworkPacketCapturePacketCapturesClientDiagnostics, Pipeline, _mobileNetworkPacketCapturePacketCapturesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, Core.OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
