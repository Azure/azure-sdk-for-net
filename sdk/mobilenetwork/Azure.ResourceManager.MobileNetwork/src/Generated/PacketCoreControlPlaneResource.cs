...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    public partial class PacketCoreControlPlaneResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _packetCoreControlPlaneRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = await _packetCoreControlPlaneRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new MobileNetworkArmOperation(_packetCoreControlPlaneClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _packetCoreControlPlaneRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = _packetCoreControlPlaneRestClient.Delete(message, cancellationToken);
                var operation = new MobileNetworkArmOperation(_packetCoreControlPlaneClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<AsyncOperationStatus>> RollbackAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _packetCoreControlPlaneRestClient.CreateRollbackRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = await _packetCoreControlPlaneRestClient.RollbackAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new MobileNetworkArmOperation<AsyncOperationStatus>(new AsyncOperationStatusOperationSource(), _packetCoreControlPlaneClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<AsyncOperationStatus> Rollback(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _packetCoreControlPlaneRestClient.CreateRollbackRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = _packetCoreControlPlaneRestClient.Rollback(message, cancellationToken);
                var operation = new MobileNetworkArmOperation<AsyncOperationStatus>(new AsyncOperationStatusOperationSource(), _packetCoreControlPlaneClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<AsyncOperationStatus>> ReinstallAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _packetCoreControlPlaneRestClient.CreateReinstallRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = await _packetCoreControlPlaneRestClient.ReinstallAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new MobileNetworkArmOperation<AsyncOperationStatus>(new AsyncOperationStatusOperationSource(), _packetCoreControlPlaneClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
        ...
        public virtual ArmOperation<AsyncOperationStatus> Reinstall(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _packetCoreControlPlaneRestClient.CreateReinstallRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
                var response = _packetCoreControlPlaneRestClient.Reinstall(message, cancellationToken);
                var operation = new MobileNetworkArmOperation<AsyncOperationStatus>(new AsyncOperationStatusOperationSource(), _packetCoreControlPlaneClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
        ...
        public virtual async Task<ArmOperation<AsyncOperationStatus>> CollectDiagnosticsPackageAsync(WaitUntil waitUntil, PacketCoreControlPlaneCollectDiagnosticsPackage packetCoreControlPlaneCollectDiagnosticsPackage, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _packetCoreControlPlaneRestClient.CreateCollectDiagnosticsPackageRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, packetCoreControlPlaneCollectDiagnosticsPackage);
                var response = await _packetCoreControlPlaneRestClient.CollectDiagnosticsPackageAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new MobileNetworkArmOperation<AsyncOperationStatus>(new AsyncOperationStatusOperationSource(), _packetCoreControlPlaneClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
        ...
        public virtual ArmOperation<AsyncOperationStatus> CollectDiagnosticsPackage(WaitUntil waitUntil, PacketCoreControlPlaneCollectDiagnosticsPackage packetCoreControlPlaneCollectDiagnosticsPackage, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _packetCoreControlPlaneRestClient.CreateCollectDiagnosticsPackageRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, packetCoreControlPlaneCollectDiagnosticsPackage);
                var response = _packetCoreControlPlaneRestClient.CollectDiagnosticsPackage(message, cancellationToken);
                var operation = new MobileNetworkArmOperation<AsyncOperationStatus>(new AsyncOperationStatusOperationSource(), _packetCoreControlPlaneClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletion(cancellationToken);
                return operation;
