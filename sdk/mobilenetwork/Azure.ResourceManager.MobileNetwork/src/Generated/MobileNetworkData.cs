...
namespace Azure.ResourceManager.MobileNetwork
{
    ...
    public partial class MobileNetworkData : TrackedResourceData
    {
        ...
        public MobileNetworkData(AzureLocation location, PlmnId publicLandMobileNetworkIdentifier) : base(location)
        {
        ...
        internal MobileNetworkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ProvisioningState? provisioningState, PlmnId publicLandMobileNetworkIdentifier, string serviceKey) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public PlmnId PublicLandMobileNetworkIdentifier { get; set; }
