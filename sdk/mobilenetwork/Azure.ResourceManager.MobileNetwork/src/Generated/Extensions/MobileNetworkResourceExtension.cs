...
namespace Azure.ResourceManager.MobileNetwork.Mock
{
    ...
    public partial class MobileNetworkResourceExtension : ArmResource
    {
        private ClientDiagnostics _mobileNetworkClientDiagnostics;
        private MobileNetworksRestOperations _mobileNetworkRestClient;

        /// <summary> Initializes a new instance of the <see cref="MobileNetworkResourceExtension"/> class for mocking. </summary>
        protected MobileNetworkResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MobileNetworkResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MobileNetworkResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<MobileNetworkResource> GetMobileNetworksAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new MobileNetworkResource(Client, MobileNetworkData.DeserializeMobileNetworkData(e)), MobileNetworkClientDiagnostics, Pipeline, "MobileNetworkResourceExtension.GetMobileNetworks", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<MobileNetworkResource> GetMobileNetworks(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => MobileNetworkRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => MobileNetworkRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new MobileNetworkResource(Client, MobileNetworkData.DeserializeMobileNetworkData(e)), MobileNetworkClientDiagnostics, Pipeline, "MobileNetworkResourceExtension.GetMobileNetworks", "value", "nextLink", cancellationToken);
        }
    }
}
