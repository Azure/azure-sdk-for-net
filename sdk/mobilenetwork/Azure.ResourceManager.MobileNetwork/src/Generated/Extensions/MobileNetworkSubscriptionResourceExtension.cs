...
namespace Azure.ResourceManager.MobileNetwork.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class MobileNetworkSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MobileNetworkSubscriptionResourceExtension"/> class for mocking. </summary>
        protected MobileNetworkSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MobileNetworkSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MobileNetworkSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<MobileNetworkResource> GetMobileNetworksAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new MobileNetworkResource(Client, MobileNetworkData.DeserializeMobileNetworkData(e)), MobileNetworkClientDiagnostics, Pipeline, "MobileNetworkSubscriptionResourceExtension.GetMobileNetworks", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<MobileNetworkResource> GetMobileNetworks(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => MobileNetworkRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => MobileNetworkRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new MobileNetworkResource(Client, MobileNetworkData.DeserializeMobileNetworkData(e)), MobileNetworkClientDiagnostics, Pipeline, "MobileNetworkSubscriptionResourceExtension.GetMobileNetworks", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<SimGroupResource> GetSimGroupsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new SimGroupResource(Client, SimGroupData.DeserializeSimGroupData(e)), SimGroupClientDiagnostics, Pipeline, "MobileNetworkSubscriptionResourceExtension.GetSimGroups", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<SimGroupResource> GetSimGroups(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => SimGroupRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => SimGroupRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new SimGroupResource(Client, SimGroupData.DeserializeSimGroupData(e)), SimGroupClientDiagnostics, Pipeline, "MobileNetworkSubscriptionResourceExtension.GetSimGroups", "value", "nextLink", cancellationToken);
        }
    }
}
