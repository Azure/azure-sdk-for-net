...
namespace Azure.ResourceManager.MobileNetwork.Mock
{
    ...
    public partial class PacketCoreControlPlaneResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="PacketCoreControlPlaneResourceExtension"/> class for mocking. </summary>
        protected PacketCoreControlPlaneResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PacketCoreControlPlaneResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PacketCoreControlPlaneResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
