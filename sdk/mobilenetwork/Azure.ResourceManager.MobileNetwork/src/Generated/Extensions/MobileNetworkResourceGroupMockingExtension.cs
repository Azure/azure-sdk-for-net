...
namespace Azure.ResourceManager.MobileNetwork.Mocking
{
    ...
    internal partial class MobileNetworkResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MobileNetworkResourceGroupMockingExtension"/> class for mocking. </summary>
        protected MobileNetworkResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MobileNetworkResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MobileNetworkResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
