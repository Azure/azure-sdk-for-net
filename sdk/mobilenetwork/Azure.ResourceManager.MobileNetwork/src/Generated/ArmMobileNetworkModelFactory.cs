...
namespace Azure.ResourceManager.MobileNetwork.Models
{
    ...
    public static partial class ArmMobileNetworkModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="MobileNetwork.RoutingInfoModelData"/>. </summary>
        /// <param name="id"> The id. </param>
        /// <param name="name"> The name. </param>
        /// <param name="resourceType"> The resourceType. </param>
        /// <param name="systemData"> The systemData. </param>
        ...
        /// <returns> A new <see cref="MobileNetwork.RoutingInfoModelData"/> instance for mocking. </returns>
        public static RoutingInfoModelData RoutingInfoModelData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<IPv4Route> controlPlaneAccessRoutes = null, IEnumerable<IPv4Route> userPlaneAccessRoutes = null, IEnumerable<UserPlaneDataRoutesItem> userPlaneDataRoutes = null)
        {
            controlPlaneAccessRoutes ??= new List<IPv4Route>();
            userPlaneAccessRoutes ??= new List<IPv4Route>();
