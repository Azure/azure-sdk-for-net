...
namespace Azure.ResourceManager.MobileNetwork.Samples
{
    public partial class Sample_RoutingInfoModelResource
    {
        ...
        public async Task Get_GetRoutingInformationForThePacketCore()
        {
            // Generated from example definition: specification/mobilenetwork/resource-manager/Microsoft.MobileNetwork/stable/2024-04-01/examples/RoutingInfoPacketCoreControlPlane.json
            // this example is just showing the usage of "RoutingInfo_Get" operation, for the dependent resources, they will have to be created separately.
