...
namespace Azure.ResourceManager.Grafana
{
    ...
    public partial class ManagedGrafanaResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ManagedGrafanaResource>> UpdateAsync(WaitUntil waitUntil, ManagedGrafanaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _managedGrafanasRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, ManagedGrafanaData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                GrafanaArmOperation<ManagedGrafanaResource> operation = new GrafanaArmOperation<ManagedGrafanaResource>(
                    new ManagedGrafanaResourceOperationSource(Client),
                    _managedGrafanasClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ManagedGrafanaResource> Update(WaitUntil waitUntil, ManagedGrafanaData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
