...
namespace Azure.ResourceManager.Grafana
{
    ...
    public partial class ManagedGrafanaResource : ArmResource
    {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<GrafanaAvailablePluginListResponse>> FetchAvailablePluginsAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _managedGrafanasClientDiagnostics.CreateScope("ManagedGrafanaResource.FetchAvailablePlugins");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _managedGrafanasRestClient.CreateFetchAvailablePluginsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<GrafanaAvailablePluginListResponse> response = Response.FromValue(GrafanaAvailablePluginListResponse.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<GrafanaAvailablePluginListResponse> FetchAvailablePlugins(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _managedGrafanasClientDiagnostics.CreateScope("ManagedGrafanaResource.FetchAvailablePlugins");
            scope.Start();
            try
