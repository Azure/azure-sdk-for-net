...
namespace Azure.ResourceManager.Grafana
{
    ...
    public partial class DashboardDefinitionData : ResourceData, IJsonModel<DashboardDefinitionData>
    {
        ...
        internal static RequestContent ToRequestContent(DashboardDefinitionData dashboardDefinitionData)
        {
            ...
            return RequestContent.Create(dashboardDefinitionData, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<DashboardDefinitionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DashboardDefinitionData IJsonModel<DashboardDefinitionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DashboardDefinitionData)JsonModelCreateCore(ref reader, options);
