    ...
    public static partial class ArmGrafanaModelFactory
    {
        ...
        public static ManagedGrafanaProperties ManagedGrafanaProperties(GrafanaProvisioningState? provisioningState = default, string grafanaVersion = default, string endpoint = default, GrafanaPublicNetworkAccess? publicNetworkAccess = default, GrafanaZoneRedundancy? zoneRedundancy = default, GrafanaApiKey? apiKey = default, GrafanaCreatorCanAdmin? creatorCanAdmin = default, DeterministicOutboundIP? deterministicOutboundIP = default, IEnumerable<string> outboundIPs = default, IEnumerable<GrafanaPrivateEndpointConnectionData> privateEndpointConnections = default, AutoGeneratedDomainNameLabelScope? autoGeneratedDomainNameLabelScope = default, IEnumerable<MonitorWorkspaceIntegration> monitorWorkspaceIntegrations = default, EnterpriseConfigurations enterpriseConfigurations = default, GrafanaConfigurations grafanaConfigurations = default, IDictionary<string, GrafanaPlugin> grafanaPlugins = default, string grafanaMajorVersion = default)
        {
            ...
            return new ManagedGrafanaProperties(
                ...
                (outboundIPs ?? new ChangeTrackingList<string>()).ToList(),
                (privateEndpointConnections ?? new ChangeTrackingList<GrafanaPrivateEndpointConnectionData>()).ToList(),
                autoGeneratedDomainNameLabelScope,
                monitorWorkspaceIntegrations is null ? default : new GrafanaIntegrations((monitorWorkspaceIntegrations ?? new ChangeTrackingList<MonitorWorkspaceIntegration>()).ToList(), default),
        ...
        public static GrafanaPrivateLinkServiceConnectionState GrafanaPrivateLinkServiceConnectionState(GrafanaPrivateEndpointServiceConnectionStatus? status = default, string description = default, string actionsRequired = default)
        {
        ...
        public static EnterpriseConfigurations EnterpriseConfigurations(string marketplacePlanId = default, MarketplaceAutoRenew? marketplaceAutoRenew = default)
        {
            return new EnterpriseConfigurations(marketplacePlanId, marketplaceAutoRenew, default);
        }
        ...
        public static ManagedGrafanaSku ManagedGrafanaSku(string name = default, GrafanaSize? size = default)
        {
        ...
        public static ManagedGrafanaPatch ManagedGrafanaPatch(ManagedGrafanaSku sku = default, ManagedServiceIdentity identity = default, IDictionary<string, string> tags = default, ManagedGrafanaPatchProperties properties = default)
        {
            ...
            return new ManagedGrafanaPatch(sku, identity, tags ?? new ChangeTrackingDictionary<string, string>(), properties, default);
        }
        ...
        {
            return new GrafanaAvailablePlugin(pluginId, name, @type, author, default);
        }
        ...
        public static GrafanaPrivateLinkResourceData GrafanaPrivateLinkResourceData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, GrafanaProvisioningState? provisioningState = default, string groupId = default, IEnumerable<string> requiredMembers = default, IEnumerable<string> requiredZoneNames = default)
        {
            return new GrafanaPrivateLinkResourceData(
                ...
                resourceType,
                systemData,
                provisioningState is null && groupId is null && requiredMembers is null && requiredZoneNames is null ? default : new GrafanaPrivateLinkResourceProperties(provisioningState, groupId, (requiredMembers ?? new ChangeTrackingList<string>()).ToList(), (requiredZoneNames ?? new ChangeTrackingList<string>()).ToList(), default),
                default);
        }
        ...
        public static GrafanaIntegrationFabricPatch GrafanaIntegrationFabricPatch(IDictionary<string, string> tags = default, IEnumerable<string> integrationFabricPropertiesUpdateParametersScenarios = default)
        {
            ...
            return new GrafanaIntegrationFabricPatch(tags ?? new ChangeTrackingDictionary<string, string>(), integrationFabricPropertiesUpdateParametersScenarios is null ? default : new IntegrationFabricPropertiesUpdateParameters((integrationFabricPropertiesUpdateParametersScenarios ?? new ChangeTrackingList<string>()).ToList(), default), default);
        }
        ...
        public static ManagedDashboardData ManagedDashboardData(ResourceIdentifier id = default, string name = default, ResourceType resourceType = default, SystemData systemData = default, IDictionary<string, string> tags = default, AzureLocation location = default, GrafanaProvisioningState? provisioningState = default)
        {
            ...
            return new ManagedDashboardData(
                ...
                tags ?? new ChangeTrackingDictionary<string, string>(),
                location,
                provisioningState is null ? default : new ManagedDashboardProperties(provisioningState, default),
                default);
        }
