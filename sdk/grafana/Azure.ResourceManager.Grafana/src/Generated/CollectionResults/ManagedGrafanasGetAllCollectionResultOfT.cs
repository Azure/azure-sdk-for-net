...
{
    internal partial class ManagedGrafanasGetAllCollectionResultOfT : Pageable<ManagedGrafanaData>
    {
        ...
        /// <summary> Initializes a new instance of ManagedGrafanasGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ManagedGrafanasGetAllCollectionResultOfT(ManagedGrafanas client, string subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ManagedGrafanasGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ManagedGrafanasGetAllCollectionResultOfT as an enumerable collection. </returns>
