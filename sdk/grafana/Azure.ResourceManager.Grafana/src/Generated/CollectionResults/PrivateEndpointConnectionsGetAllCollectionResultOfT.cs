...
{
    internal partial class PrivateEndpointConnectionsGetAllCollectionResultOfT : Pageable<GrafanaPrivateEndpointConnectionData>
    {
        ...
        public override IEnumerable<Page<GrafanaPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
