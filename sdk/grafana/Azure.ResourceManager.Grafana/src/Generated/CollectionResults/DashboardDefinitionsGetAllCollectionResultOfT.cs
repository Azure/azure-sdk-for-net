...
{
    internal partial class DashboardDefinitionsGetAllCollectionResultOfT : Pageable<DashboardDefinitionData>
    {
        ...
        /// <summary> Initializes a new instance of DashboardDefinitionsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DashboardDefinitionsGetAllCollectionResultOfT(DashboardDefinitions client, string subscriptionId, string resourceGroupName, string dashboardName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DashboardDefinitionsGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DashboardDefinitionsGetAllCollectionResultOfT as an enumerable collection. </returns>
