...
namespace Azure.ResourceManager.Grafana
{
    ...
    public partial class GrafanaPrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal GrafanaPrivateEndpointConnectionResource(ArmClient client, GrafanaPrivateEndpointConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<GrafanaPrivateEndpointConnectionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new GrafanaPrivateEndpointConnectionResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
