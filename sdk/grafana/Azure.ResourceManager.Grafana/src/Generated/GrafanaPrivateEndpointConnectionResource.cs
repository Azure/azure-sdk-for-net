...
namespace Azure.ResourceManager.Grafana
{
    ...
    public partial class GrafanaPrivateEndpointConnectionResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<GrafanaPrivateEndpointConnectionResource>> UpdateAsync(WaitUntil waitUntil, GrafanaPrivateEndpointConnectionData data = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="data"> The GrafanaPrivateEndpointConnection to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<GrafanaPrivateEndpointConnectionResource> Update(WaitUntil waitUntil, GrafanaPrivateEndpointConnectionData data = null, CancellationToken cancellationToken = default)
        {
            using var scope = _grafanaPrivateEndpointConnectionPrivateEndpointConnectionsClientDiagnostics.CreateScope("GrafanaPrivateEndpointConnectionResource.Update");
            scope.Start();
            try
