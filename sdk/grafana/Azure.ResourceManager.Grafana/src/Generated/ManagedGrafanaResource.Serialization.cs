...
namespace Azure.ResourceManager.Grafana
{
    public partial class ManagedGrafanaResource : IJsonModel<ManagedGrafanaData>
    {
        ...
        {
            return ModelReaderWriter.Read<ManagedGrafanaData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ManagedGrafanaData>(data, options);
        }
