...
namespace Azure.ResourceManager.Grafana.Models
{
    ...
    public partial class ManagedGrafanaPatch
    {
        ...
        internal ManagedGrafanaPatch(ManagedServiceIdentity identity, IDictionary<string, string> tags, ManagedGrafanaPatchProperties properties, Dictionary<string, BinaryData> rawData)
        {
            Identity = identity;
            Tags = tags;
