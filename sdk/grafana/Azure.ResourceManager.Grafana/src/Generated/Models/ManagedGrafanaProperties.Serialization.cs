...
{
    public partial class ManagedGrafanaProperties : IUtf8JsonSerializable, IJsonModel<ManagedGrafanaProperties>, IPersistableModel<ManagedGrafanaProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ApiKey))
            {
                ...
                builder.AppendLine($" '{ApiKey.ToString()}'");
            }

            if (Optional.IsDefined(DeterministicOutboundIP))
            {
                builder.Append("  deterministicOutboundIP:");
                builder.AppendLine($" '{DeterministicOutboundIP.ToString()}'");
            }
            ...
            if (Optional.IsDefined(GrafanaIntegrations))
            {
                ...
                AppendChildObject(builder, GrafanaIntegrations, options, 2);
            }

            if (Optional.IsDefined(EnterpriseConfigurations))
            {
                builder.Append("  enterpriseConfigurations:");
                AppendChildObject(builder, EnterpriseConfigurations, options, 2);
            }

            if (Optional.IsDefined(GrafanaConfigurations))
            {
                builder.Append("  grafanaConfigurations:");
                AppendChildObject(builder, GrafanaConfigurations, options, 2);
            }
