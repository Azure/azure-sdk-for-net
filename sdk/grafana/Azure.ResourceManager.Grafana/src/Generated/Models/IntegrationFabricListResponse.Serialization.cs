...
{
    internal partial class IntegrationFabricListResponse : IUtf8JsonSerializable, IJsonModel<IntegrationFabricListResponse>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationFabricListResponse>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<IntegrationFabricListResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        IntegrationFabricListResponse IJsonModel<IntegrationFabricListResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IntegrationFabricListResponse>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static IntegrationFabricListResponse DeserializeIntegrationFabricListResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new IntegrationFabricListResponse(value ?? new ChangeTrackingList<IntegrationFabricData>(), nextLink, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<IntegrationFabricListResponse>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IntegrationFabricListResponse>)this).GetFormatFromOptions(options) : options.Format;
        ...
        IntegrationFabricListResponse IPersistableModel<IntegrationFabricListResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<IntegrationFabricListResponse>)this).GetFormatFromOptions(options) : options.Format;
