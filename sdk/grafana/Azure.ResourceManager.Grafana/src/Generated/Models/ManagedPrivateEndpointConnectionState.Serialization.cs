...
{
    public partial class ManagedPrivateEndpointConnectionState : IUtf8JsonSerializable, IJsonModel<ManagedPrivateEndpointConnectionState>, IPersistableModel<ManagedPrivateEndpointConnectionState>
    {
        ...
        void IJsonModel<ManagedPrivateEndpointConnectionState>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedPrivateEndpointConnectionState)} does not support '{format}' format.");
            }
