...
namespace Azure.ResourceManager.Grafana.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GrafanaIntegrations>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GrafanaIntegrations>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GrafanaIntegrations>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GrafanaIntegrations>)} interface");
            }
        ...
        string IPersistableModel<GrafanaIntegrations>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
