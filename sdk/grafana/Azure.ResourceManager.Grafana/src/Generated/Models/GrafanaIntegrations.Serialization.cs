...
{
    internal partial class GrafanaIntegrations : IUtf8JsonSerializable, IJsonModel<GrafanaIntegrations>, IPersistableModel<GrafanaIntegrations>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(MonitorWorkspaceIntegrations))
            {
                builder.Append("  azureMonitorWorkspaceIntegrations:");
                builder.AppendLine(" [");
                foreach (var item in MonitorWorkspaceIntegrations)
                {
