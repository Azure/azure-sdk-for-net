...
{
    public partial class MarketplaceTrialQuota : IUtf8JsonSerializable, IJsonModel<MarketplaceTrialQuota>, IPersistableModel<MarketplaceTrialQuota>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AvailablePromotion))
            {
                builder.Append("  availablePromotion:");
                builder.AppendLine($" '{AvailablePromotion.ToString()}'");
            }

            if (Optional.IsDefined(GrafanaResourceId))
            {
                builder.Append("  grafanaResourceId:");
                builder.AppendLine($" '{GrafanaResourceId.ToString()}'");
            }

            if (Optional.IsDefined(TrialStartOn))
            {
                builder.Append("  trialStartAt:");
                builder.AppendLine($" '{TrialStartOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(TrialEndOn))
            {
                builder.Append("  trialEndAt:");
                builder.AppendLine($" '{TrialEndOn.Value.ToString()}'");
            }
