...
{
    public partial class GrafanaUserSettings : IUtf8JsonSerializable, IJsonModel<GrafanaUserSettings>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GrafanaUserSettings>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<GrafanaUserSettings>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        GrafanaUserSettings IJsonModel<GrafanaUserSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GrafanaUserSettings>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static GrafanaUserSettings DeserializeGrafanaUserSettings(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new GrafanaUserSettings(viewersCanEdit, editorsCanAdmin, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<GrafanaUserSettings>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GrafanaUserSettings>)this).GetFormatFromOptions(options) : options.Format;
        ...
        GrafanaUserSettings IPersistableModel<GrafanaUserSettings>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GrafanaUserSettings>)this).GetFormatFromOptions(options) : options.Format;
