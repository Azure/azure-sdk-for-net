...
namespace Azure.ResourceManager.Grafana.Models
{
    ...
    internal partial class DashboardDefinitionListResponse : IJsonModel<DashboardDefinitionListResponse>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (DashboardDefinitionData item in Value)
            {
        ...
        internal static DashboardDefinitionListResponse DeserializeDashboardDefinitionListResponse(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<DashboardDefinitionData> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    List<DashboardDefinitionData> array = new List<DashboardDefinitionData>();
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        array.Add(DashboardDefinitionData.DeserializeDashboardDefinitionData(item, options));
                    }
                    value = array;
                    continue;
                }
