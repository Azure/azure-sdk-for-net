...
namespace Azure.ResourceManager.Grafana.Models
{
    ...
    {
        internal static ManagedGrafanaListResponse DeserializeManagedGrafanaListResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
