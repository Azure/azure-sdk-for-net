...
{
    internal partial class GrafanaConfigurations : IUtf8JsonSerializable, IJsonModel<GrafanaConfigurations>, IPersistableModel<GrafanaConfigurations>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  smtp:");
                AppendChildObject(builder, Smtp, options, 2);
            }
