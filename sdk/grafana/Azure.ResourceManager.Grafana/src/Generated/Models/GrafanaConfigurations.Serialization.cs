...
namespace Azure.ResourceManager.Grafana.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GrafanaConfigurations>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GrafanaConfigurations>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GrafanaConfigurations>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GrafanaConfigurations>)} interface");
            }
        ...
        string IPersistableModel<GrafanaConfigurations>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
