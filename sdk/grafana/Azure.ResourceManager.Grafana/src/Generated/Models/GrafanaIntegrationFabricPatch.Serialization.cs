...
namespace Azure.ResourceManager.Grafana.Models
{
    ...
    public partial class GrafanaIntegrationFabricPatch : IJsonModel<GrafanaIntegrationFabricPatch>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual GrafanaIntegrationFabricPatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        internal static RequestContent ToRequestContent(GrafanaIntegrationFabricPatch grafanaIntegrationFabricPatch)
        {
            ...
            return RequestContent.Create(grafanaIntegrationFabricPatch, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GrafanaIntegrationFabricPatch IJsonModel<GrafanaIntegrationFabricPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual GrafanaIntegrationFabricPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<GrafanaIntegrationFabricPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GrafanaIntegrationFabricPatch DeserializeGrafanaIntegrationFabricPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = IntegrationFabricPropertiesUpdateParameters.DeserializeIntegrationFabricPropertiesUpdateParameters(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
