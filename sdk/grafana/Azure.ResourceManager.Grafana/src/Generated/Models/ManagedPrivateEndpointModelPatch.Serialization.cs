...
namespace Azure.ResourceManager.Grafana.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedPrivateEndpointModelPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedPrivateEndpointModelPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedPrivateEndpointModelPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedPrivateEndpointModelPatch>)} interface");
            }
        ...
        internal static ManagedPrivateEndpointModelPatch DeserializeManagedPrivateEndpointModelPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ManagedPrivateEndpointModelPatch(Optional.ToDictionary(tags), serializedAdditionalRawData);
        }
        ...
        string IPersistableModel<ManagedPrivateEndpointModelPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
