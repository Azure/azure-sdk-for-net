...
namespace Azure.ResourceManager.Grafana.Models
{
    ...
    public partial class GrafanaPrivateLinkServiceConnectionState
    {
        ...
        internal GrafanaPrivateLinkServiceConnectionState(GrafanaPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
