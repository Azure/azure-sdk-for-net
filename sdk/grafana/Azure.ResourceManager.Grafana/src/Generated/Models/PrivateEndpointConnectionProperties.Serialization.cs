...
namespace Azure.ResourceManager.Grafana.Models
{
    ...
    internal partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            GrafanaPrivateLinkServiceConnectionState connectionState = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    connectionState = GrafanaPrivateLinkServiceConnectionState.DeserializeGrafanaPrivateLinkServiceConnectionState(prop.Value, options);
                    continue;
                }
                ...
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new GrafanaPrivateEndpointConnectionProvisioningState(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new PrivateEndpointConnectionProperties(privateEndpoint, connectionState, groupIds ?? new ChangeTrackingList<string>(), provisioningState, additionalBinaryDataProperties);
        }
