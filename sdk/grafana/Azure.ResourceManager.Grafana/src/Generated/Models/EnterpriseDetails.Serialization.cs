...
{
    public partial class EnterpriseDetails : IUtf8JsonSerializable, IJsonModel<EnterpriseDetails>, IPersistableModel<EnterpriseDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SaasSubscriptionDetails))
            {
                builder.Append("  saasSubscriptionDetails:");
                AppendChildObject(builder, SaasSubscriptionDetails, options, 2);
            }

            if (Optional.IsDefined(MarketplaceTrialQuota))
            {
                builder.Append("  marketplaceTrialQuota:");
                AppendChildObject(builder, MarketplaceTrialQuota, options, 2);
            }
