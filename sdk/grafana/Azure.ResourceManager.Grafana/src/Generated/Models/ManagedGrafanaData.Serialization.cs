...
namespace Azure.ResourceManager.Grafana
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedGrafanaData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedGrafanaData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedGrafanaData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedGrafanaData>)} interface");
            }
        ...
        string IPersistableModel<ManagedGrafanaData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
