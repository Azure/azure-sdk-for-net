...
{
    public partial class EnterpriseConfigurations : IUtf8JsonSerializable, IJsonModel<EnterpriseConfigurations>, IPersistableModel<EnterpriseConfigurations>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MarketplacePlanId))
            {
                builder.Append("  marketplacePlanId:");
                builder.AppendLine($" '{MarketplacePlanId}'");
            }

            if (Optional.IsDefined(MarketplaceAutoRenew))
            {
                builder.Append("  marketplaceAutoRenew:");
                builder.AppendLine($" '{MarketplaceAutoRenew.ToString()}'");
            }
