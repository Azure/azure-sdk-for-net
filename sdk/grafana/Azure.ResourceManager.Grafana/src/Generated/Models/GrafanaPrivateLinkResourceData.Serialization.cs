...
{
    public partial class GrafanaPrivateLinkResourceData : IUtf8JsonSerializable, IJsonModel<GrafanaPrivateLinkResourceData>, IPersistableModel<GrafanaPrivateLinkResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GrafanaPrivateLinkResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<GrafanaPrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GrafanaPrivateLinkResourceData)} does not support '{format}' format.");
            }
