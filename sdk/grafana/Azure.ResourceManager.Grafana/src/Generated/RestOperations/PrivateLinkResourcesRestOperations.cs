...
namespace Azure.ResourceManager.Grafana
{
    internal partial class PrivateLinkResources
    {
        ...
        internal HttpMessage CreateGetRequest(string subscriptionId, string resourceGroupName, string workspaceName, string privateLinkResourceName, RequestContext context)
        {
