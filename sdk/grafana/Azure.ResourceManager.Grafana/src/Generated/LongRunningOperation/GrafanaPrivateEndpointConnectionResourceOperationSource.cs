...
{
    /// <summary></summary>
    internal partial class GrafanaPrivateEndpointConnectionResourceOperationSource : IOperationSource<GrafanaPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal GrafanaPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
