...
namespace Azure.ResourceManager.Grafana
{
    internal partial class GrafanaArmOperation<T> : ArmOperation<T>
    {
        ...
        internal GrafanaArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
