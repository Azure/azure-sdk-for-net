...
{
    /// <summary></summary>
    internal partial class ManagedDashboardResourceOperationSource : IOperationSource<ManagedDashboardResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedDashboardResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
