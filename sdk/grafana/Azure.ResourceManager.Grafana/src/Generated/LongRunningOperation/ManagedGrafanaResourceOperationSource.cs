...
{
    /// <summary></summary>
    internal partial class ManagedGrafanaResourceOperationSource : IOperationSource<ManagedGrafanaResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedGrafanaResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
