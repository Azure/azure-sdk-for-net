...
{
    /// <summary></summary>
    internal partial class ManagedPrivateEndpointModelResourceOperationSource : IOperationSource<ManagedPrivateEndpointModelResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedPrivateEndpointModelResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
