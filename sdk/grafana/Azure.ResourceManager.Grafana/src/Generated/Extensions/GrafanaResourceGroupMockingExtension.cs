...
namespace Azure.ResourceManager.Grafana.Mocking
{
    ...
    internal partial class GrafanaResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="GrafanaResourceGroupMockingExtension"/> class for mocking. </summary>
        protected GrafanaResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="GrafanaResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal GrafanaResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
