...
namespace Azure.ResourceManager.Grafana.Mocking
{
    ...
    internal partial class GrafanaArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="GrafanaArmClientMockingExtension"/> class for mocking. </summary>
        protected GrafanaArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="GrafanaArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal GrafanaArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal GrafanaArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
