...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public partial interface IVirtualMachineSizesOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<VirtualMachineSizeListResult>> ListWithHttpMessagesAsync(string location, string computeType = default(string), bool? recommended = default(bool?), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
