...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    /// </summary>
    internal partial class UsagesOperations : IServiceOperations<AzureMachineLearningWorkspacesClient>, IUsagesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal UsagesOperations(AzureMachineLearningWorkspacesClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Usage>>> ListWithHttpMessagesAsync(string location, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.MachineLearningServices/locations/{location}/usages").ToString();
