...
namespace Microsoft.Azure.Management.MachineLearningServices
{
    ...
    public static partial class PrivateLinkResourcesOperationsExtensions
    {
            ...
            /// </param>
            public static PrivateLinkResourceListResult List(this IPrivateLinkResourcesOperations operations, string resourceGroupName, string workspaceName)
            {
            ...
            /// </param>
            public static async Task<PrivateLinkResourceListResult> ListAsync(this IPrivateLinkResourcesOperations operations, string resourceGroupName, string workspaceName, CancellationToken cancellationToken = default(CancellationToken))
            {
