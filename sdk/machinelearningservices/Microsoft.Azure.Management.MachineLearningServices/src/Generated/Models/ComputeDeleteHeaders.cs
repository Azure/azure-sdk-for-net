...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    /// </summary>
    public partial class ComputeDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ComputeDeleteHeaders class.
        /// </summary>
        public ComputeDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// result.</param>
        public ComputeDeleteHeaders(string azureAsyncOperation = default(string), string location = default(string))
        {
