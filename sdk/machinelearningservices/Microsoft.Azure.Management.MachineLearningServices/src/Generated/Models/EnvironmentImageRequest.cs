...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class EnvironmentImageRequest
    {
        ...
        public EnvironmentImageRequest(string driverProgram = default(string), IList<ImageAsset> assets = default(IList<ImageAsset>), IList<string> modelIds = default(IList<string>), IList<Model> modelsProperty = default(IList<Model>), EnvironmentImageRequestEnvironment environment = default(EnvironmentImageRequestEnvironment), EnvironmentImageRequestEnvironmentReference environmentReference = default(EnvironmentImageRequestEnvironmentReference))
        {
