...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class PartialBatchDeploymentPartialTrackedResource
    {
        ...
        /// PartialBatchDeploymentPartialTrackedResource class.
        /// </summary>
        ...
        /// entity.</param>
        public PartialBatchDeploymentPartialTrackedResource(ResourceIdentity identity = default(ResourceIdentity), string kind = default(string), string location = default(string), PartialBatchDeployment properties = default(PartialBatchDeployment), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Identity = identity;
            Kind = kind;
            Location = location;
