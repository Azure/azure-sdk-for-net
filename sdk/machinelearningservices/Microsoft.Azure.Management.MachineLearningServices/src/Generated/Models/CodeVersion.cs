...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the CodeVersion class.
        /// </summary>
        public CodeVersion()
        {
            CustomInit();
        ...
        /// updated.</param>
        public CodeVersion(string path, string datastoreId = default(string), string description = default(string), bool? isAnonymous = default(bool?), IDictionary<string, string> properties = default(IDictionary<string, string>), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
