...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class SslConfiguration
    {
        ...
        /// <param name="leafDomainLabel">Leaf domain label of public
        /// endpoint</param>
        /// <param name="overwriteExistingDomain">Indicates whether to
        /// overwrite existing domain label.</param>
        ...
        /// <summary>
        /// Gets or sets leaf domain label of public endpoint
        /// </summary>
        [JsonProperty(PropertyName = "leafDomainLabel")]
        public string LeafDomainLabel { get; set; }

        /// <summary>
        /// Gets or sets indicates whether to overwrite existing domain label.
        /// </summary>
