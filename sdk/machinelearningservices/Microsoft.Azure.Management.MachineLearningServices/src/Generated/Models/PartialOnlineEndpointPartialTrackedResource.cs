...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class PartialOnlineEndpointPartialTrackedResource
    {
        ...
        /// entity.</param>
        public PartialOnlineEndpointPartialTrackedResource(ResourceIdentity identity = default(ResourceIdentity), string kind = default(string), string location = default(string), PartialOnlineEndpoint properties = default(PartialOnlineEndpoint), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Identity = identity;
            Kind = kind;
            Location = location;
