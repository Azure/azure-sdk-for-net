...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AzurePostgreSqlContents class.
        /// </summary>
        public AzurePostgreSqlContents()
        {
            CustomInit();
        }
        ...
        /// requires SSL.</param>
        public AzurePostgreSqlContents(DatastoreCredentials credentials, string databaseName, string endpoint, int portNumber, string serverName, bool? enableSSL = default(bool?))
        {
