...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class ComputeInstanceProperties
    {
        ...
        /// 'Running', 'Restarting', 'RestartFailed', 'JobRunning',
        /// 'SettingUp', 'Starting', 'StartFailed', 'StopFailed', 'Stopped',
        /// 'Stopping', 'UserSettingUp', 'Unknown', 'Unusable'</param>
        public ComputeInstanceProperties(string vmSize = default(string), ResourceId subnet = default(ResourceId), string applicationSharingPolicy = default(string), ComputeInstanceSshSettings sshSettings = default(ComputeInstanceSshSettings), ComputeInstanceConnectivityEndpoints connectivityEndpoints = default(ComputeInstanceConnectivityEndpoints), IList<ComputeInstanceApplication> applications = default(IList<ComputeInstanceApplication>), ComputeInstanceCreatedBy createdBy = default(ComputeInstanceCreatedBy), IList<MachineLearningServiceError> errors = default(IList<MachineLearningServiceError>), string state = default(string))
        {
            VmSize = vmSize;
            Subnet = subnet;
        ...
        /// 'Restarting', 'RestartFailed', 'JobRunning', 'SettingUp',
        /// 'Starting', 'StartFailed', 'StopFailed', 'Stopped', 'Stopping',
        /// 'UserSettingUp', 'Unknown', 'Unusable'
        /// </summary>
