...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class ACIServiceResponseEnvironmentImageRequest : EnvironmentImageResponse
    {
        ...
        /// ACIServiceResponseEnvironmentImageRequest class.
        /// </summary>
        ...
        public ACIServiceResponseEnvironmentImageRequest(string driverProgram = default(string), IList<ImageAsset> assets = default(IList<ImageAsset>), IList<string> modelIds = default(IList<string>), IList<Model> modelsProperty = default(IList<Model>), EnvironmentImageResponseEnvironment environment = default(EnvironmentImageResponseEnvironment), EnvironmentImageResponseEnvironmentReference environmentReference = default(EnvironmentImageResponseEnvironmentReference))
