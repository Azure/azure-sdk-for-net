...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    /// </summary>
    public partial class LabelingJobResource : Resource
    {
        /// <summary>
        ...
        /// provider</param>
        public LabelingJobResource(LabelingJob properties, string id = default(string), string name = default(string), string type = default(string), SystemData systemData = default(SystemData))
            : base(id, name, type)
        {
