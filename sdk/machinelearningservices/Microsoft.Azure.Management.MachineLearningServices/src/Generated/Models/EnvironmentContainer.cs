...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the EnvironmentContainer class.
        /// </summary>
        ...
        /// updated.</param>
        public EnvironmentContainer(string description = default(string), IDictionary<string, string> properties = default(IDictionary<string, string>), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
