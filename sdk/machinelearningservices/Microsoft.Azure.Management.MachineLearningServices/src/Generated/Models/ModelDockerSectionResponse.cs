...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ModelDockerSectionResponse class.
        /// </summary>
        ...
        /// base image.</param>
        public ModelDockerSectionResponse(string baseImage = default(string), string baseDockerfile = default(string), ModelDockerSectionResponseBaseImageRegistry baseImageRegistry = default(ModelDockerSectionResponseBaseImageRegistry))
        {
            BaseImage = baseImage;
