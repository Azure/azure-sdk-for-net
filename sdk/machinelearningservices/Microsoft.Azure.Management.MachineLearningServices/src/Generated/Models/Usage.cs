...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class Usage
    {
        ...
        /// <param name="amlWorkspaceLocation">Region of the AML workspace in
        /// the id.</param>
        ...
        public Usage(string id = default(string), string amlWorkspaceLocation = default(string), string type = default(string), string unit = default(string), long? currentValue = default(long?), long? limit = default(long?), UsageName name = default(UsageName))
        {
            Id = id;
        ...
        /// </summary>
        [JsonProperty(PropertyName = "amlWorkspaceLocation")]
        public string AmlWorkspaceLocation { get; private set; }
