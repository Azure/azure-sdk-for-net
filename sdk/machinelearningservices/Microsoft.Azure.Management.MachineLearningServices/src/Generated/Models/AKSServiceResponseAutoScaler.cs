...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AKSServiceResponseAutoScaler
        /// class.
        /// </summary>
        ...
        public AKSServiceResponseAutoScaler(bool? autoscaleEnabled = default(bool?), int? minReplicas = default(int?), int? maxReplicas = default(int?), int? targetUtilization = default(int?), int? refreshPeriodInSeconds = default(int?))
