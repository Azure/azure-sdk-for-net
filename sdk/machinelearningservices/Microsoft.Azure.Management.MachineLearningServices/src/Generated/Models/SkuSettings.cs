...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    /// </summary>
    public partial class SkuSettings
    {
        /// <summary>
        /// Initializes a new instance of the SkuSettings class.
        /// </summary>
        public SkuSettings()
        {
            CustomInit();
        ...
        public SkuSettings(IList<string> locations = default(IList<string>), IList<ResourceSkuLocationInfo> locationInfo = default(IList<ResourceSkuLocationInfo>), string tier = default(string), string resourceType = default(string), string name = default(string), IList<SKUCapability> capabilities = default(IList<SKUCapability>), IList<Restriction> restrictions = default(IList<Restriction>))
        {
            Locations = locations;
