...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class ErrorResponse
    {
        ...
        public ErrorResponse(string code = default(string), string message = default(string), string target = default(string), IList<ErrorDetail> details = default(IList<ErrorDetail>))
        {
            Code = code;
            Message = message;
            Target = target;
