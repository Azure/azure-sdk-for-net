...
namespace Microsoft.Azure.Management.MachineLearningServices.Models
{
    ...
    public partial class PartialBatchEndpointPartialTrackedResource
    {
        ...
        /// PartialBatchEndpointPartialTrackedResource class.
        /// </summary>
        ...
        /// entity.</param>
        public PartialBatchEndpointPartialTrackedResource(ResourceIdentity identity = default(ResourceIdentity), string kind = default(string), string location = default(string), PartialBatchEndpoint properties = default(PartialBatchEndpoint), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Identity = identity;
            Kind = kind;
            Location = location;
