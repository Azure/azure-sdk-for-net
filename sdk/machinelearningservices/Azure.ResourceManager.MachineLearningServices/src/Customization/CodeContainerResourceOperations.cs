...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class CodeContainerResourceOperations : ArmResource
    {
        ...
        internal virtual Task<Response<CodeContainerResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Get container. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual Response<CodeContainerResource> Get(CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
        ...
        /// <summary> Delete container. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual Task<CodeContainerDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
        ...
        /// <summary> Delete container. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        internal virtual CodeContainerDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            throw new NotImplementedException();
        }
    }
