...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class LabelingJobResourceContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, LabelingJobResource, LabelingJobResourceData>
    {
        ...
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public Response<LabelingJobResource> Get(string workspaceName, bool? includeJobInstructions = null, bool? includeLabelCategories = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="includeLabelCategories"> Boolean value to indicate Whether to include LabelCategories in response. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<Response<LabelingJobResource>> GetAsync(string workspaceName, bool? includeJobInstructions = null, bool? includeLabelCategories = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("LabelingJobResourceContainer.Get");
            scope.Start();
            try
