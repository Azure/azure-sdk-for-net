...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class OnlineDeploymentTrackedResourceOperations : ResourceOperations
    {
        ...
        protected internal OnlineDeploymentTrackedResourceOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
