...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class OnlineEndpointTrackedResourceData : Resources.Models.TrackedResource
    {
        ...
        internal OnlineEndpointTrackedResourceData(ResourceIdentifier id, string name, ResourceType type, Location location, IDictionary<string, string> tags, Models.ResourceIdentity identity, string kind, OnlineEndpoint properties, SystemData systemData) : base(id, name, type, location, tags)
        {
            Identity = identity;
            Kind = kind;
            Properties = properties;
