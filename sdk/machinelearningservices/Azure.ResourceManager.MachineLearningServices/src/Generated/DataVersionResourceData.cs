...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class DataVersionResourceData : Resources.Models.Resource
    {
        ...
        internal DataVersionResourceData(ResourceIdentifier id, string name, ResourceType type, DataVersion properties, SystemData systemData) : base(id, name, type)
        {
            Properties = properties;
