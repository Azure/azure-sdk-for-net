...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    {
        /// <summary> Initializes a new instance of EnvironmentContainerResource. </summary>
        /// <param name="properties"> . </param>
        /// <exception cref="ArgumentNullException"> <paramref name="properties"/> is null. </exception>
        public EnvironmentContainerResource(EnvironmentContainer properties)
        {
            if (properties == null)
            {
        ...
        internal EnvironmentContainerResource(string id, string name, string type, EnvironmentContainer properties, SystemData systemData)
        {
            Id = id;
            Name = name;
            Type = type;
