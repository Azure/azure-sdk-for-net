...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CodeContainerResource. </summary>
        /// <param name="properties"> . </param>
        /// <exception cref="ArgumentNullException"> <paramref name="properties"/> is null. </exception>
        public CodeContainerResource(CodeContainer properties)
        {
            if (properties == null)
            {
        ...
        internal CodeContainerResource(string id, string name, string type, CodeContainer properties, SystemData systemData)
        {
            Id = id;
            Name = name;
            Type = type;
