...
{
    public partial class AKSServiceCreateRequestAutoScaler : IUtf8JsonSerializable
    {
        ...
        internal static AKSServiceCreateRequestAutoScaler DeserializeAKSServiceCreateRequestAutoScaler(JsonElement element)
        {
            ...
            return new AKSServiceCreateRequestAutoScaler(Optional.ToNullable(autoscaleEnabled), Optional.ToNullable(minReplicas), Optional.ToNullable(maxReplicas), Optional.ToNullable(targetUtilization), Optional.ToNullable(refreshPeriodInSeconds));
        }
    }
}
