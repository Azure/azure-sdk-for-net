...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    public partial class Job : IUtf8JsonSerializable
    {
        ...
        internal static Job DeserializeJob(JsonElement element)
        {
            ...
            return new Job(computeId.Value, description.Value, displayName.Value, experimentName.Value, jobType, parentJobName.Value, Optional.ToDictionary(properties), Optional.ToDictionary(services), Optional.ToNullable(status), Optional.ToDictionary(tags));
        }
    }
}
