...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class CodeContainerResourceData : Resource<ResourceGroupResourceIdentifier>
    {
        ...
        internal CodeContainerResourceData(ResourceGroupResourceIdentifier id, string name, ResourceType type, CodeContainer properties, SystemData systemData) : base(id, name, type)
        {
            Properties = properties;
