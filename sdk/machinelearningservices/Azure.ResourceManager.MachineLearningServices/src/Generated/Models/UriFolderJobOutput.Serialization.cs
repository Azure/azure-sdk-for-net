...
{
    public partial class UriFolderJobOutput : IUtf8JsonSerializable
    {
        ...
        internal static UriFolderJobOutput DeserializeUriFolderJobOutput(JsonElement element)
        {
            ...
            return new UriFolderJobOutput(description.Value, jobOutputType, Optional.ToNullable(mode), uri);
        }
    }
}
