...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class JobBaseResourceData : Resource<ResourceGroupResourceIdentifier>
    {
        ...
        internal JobBaseResourceData(ResourceGroupResourceIdentifier id, string name, ResourceType type, JobBase properties, SystemData systemData) : base(id, name, type)
        {
            Properties = properties;
