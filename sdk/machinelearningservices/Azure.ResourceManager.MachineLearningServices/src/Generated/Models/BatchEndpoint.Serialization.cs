...
namespace Azure.ResourceManager.MachineLearningServices
{
    public partial class BatchEndpoint : IUtf8JsonSerializable
    {
        ...
        internal static BatchEndpoint DeserializeBatchEndpoint(JsonElement element)
        {
            ...
            return new BatchEndpoint(Optional.ToNullable(authMode), description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(traffic), scoringUri.Value, swaggerUri.Value, keys.Value);
        }
    }
}
