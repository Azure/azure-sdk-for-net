    ...
    public partial class BatchEndpoint : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(AuthMode))
            {
                ...
                writer.WriteStringValue(AuthMode.Value.ToSerialString());
            }
        ...
        {
            Optional<EndpointAuthModeType> authMode = default;
            ...
            return new BatchEndpoint(Optional.ToNullable(authMode), description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(trafficRules), computeConfiguration.Value, Optional.ToNullable(provisioningState), endpoint.Value, swaggerEndpoint.Value, keys.Value, error.Value);
        }
    }
}
