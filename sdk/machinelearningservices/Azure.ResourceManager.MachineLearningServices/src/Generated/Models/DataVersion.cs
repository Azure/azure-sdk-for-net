...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class DataVersion
    {
        ...
        internal DataVersion(DatasetType? datasetType, string datastoreId, string path, bool? isAnonymous, string description, IDictionary<string, string> tags, IDictionary<string, string> properties)
        {
