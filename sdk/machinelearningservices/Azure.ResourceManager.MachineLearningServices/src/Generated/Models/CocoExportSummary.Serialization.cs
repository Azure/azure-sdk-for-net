...
namespace Azure.ResourceManager.MachineLearningServices
{
    public partial class CocoExportSummary : IUtf8JsonSerializable
    {
        ...
        internal static CocoExportSummary DeserializeCocoExportSummary(JsonElement element)
        {
            ...
            return new CocoExportSummary(format, labelingJobId.Value, Optional.ToNullable(exportedRowCount), Optional.ToNullable(startTimeUtc), Optional.ToNullable(endTimeUtc), snapshotPath.Value, containerName.Value);
        }
    }
}
