...
{
    internal partial class ImageClassificationBase : IUtf8JsonSerializable
    {
        ...
        internal static ImageClassificationBase DeserializeImageClassificationBase(JsonElement element)
        {
            ...
            return new ImageClassificationBase(dataSettings, limitSettings, sweepSettings.Value, modelSettings.Value, Optional.ToList(searchSpace));
        }
    }
}
