...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class CertificateDatastoreCredentials : DatastoreCredentials
    {
        ...
        public CertificateDatastoreCredentials(Guid tenantId, Guid clientId, string thumbprint)
        {
            if (thumbprint == null)
            {
        ...
        internal CertificateDatastoreCredentials(CredentialsType credentialsType, string authorityUrl, string resourceUri, Guid tenantId, Guid clientId, string thumbprint, CertificateDatastoreSecrets secrets) : base(credentialsType)
        {
