...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    public partial class PrivateEndpointConnection : IUtf8JsonSerializable
    {
        ...
        internal static PrivateEndpointConnection DeserializePrivateEndpointConnection(JsonElement element)
        {
            ...
            return new PrivateEndpointConnection(id.Value, name.Value, type.Value, identity.Value, location.Value, Optional.ToDictionary(tags), sku.Value, systemData.Value, privateEndpoint.Value, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
