...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class AzureDataLakeGen2Contents : DatastoreContents
    {
        ...
        /// <param name="endpoint"> Azure cloud endpoint for the storage account. </param>
        /// <param name="protocol"> Protocol used to communicate with the storage account. </param>
        internal AzureDataLakeGen2Contents(ContentsType contentsType, string accountName, string containerName, DatastoreCredentials credentials, string endpoint, string protocol) : base(contentsType)
        {
            AccountName = accountName;
            ContainerName = containerName;
            Credentials = credentials;
