...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    public partial class PipelineJob : IUtf8JsonSerializable
    {
        ...
        internal static PipelineJob DeserializePipelineJob(JsonElement element)
        {
            ...
            return new PipelineJob(computeId.Value, description.Value, displayName.Value, experimentName.Value, jobType, parentJobName.Value, Optional.ToDictionary(properties), Optional.ToDictionary(services), Optional.ToNullable(status), Optional.ToDictionary(tags), Optional.ToList(bindings), Optional.ToDictionary(componentJobs), Optional.ToDictionary(inputs), Optional.ToDictionary(outputs), settings.Value);
        }
    }
}
