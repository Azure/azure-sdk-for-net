...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ExportSummaryResource. </summary>
        /// <param name="properties"> . </param>
        /// <exception cref="ArgumentNullException"> <paramref name="properties"/> is null. </exception>
        internal ExportSummaryResource(ExportSummary properties)
        {
            if (properties == null)
            {
        ...
        internal ExportSummaryResource(string id, string name, string type, ExportSummary properties, SystemData systemData)
        {
            Id = id;
            Name = name;
            Type = type;
        ...
        public ExportSummary Properties { get; }
