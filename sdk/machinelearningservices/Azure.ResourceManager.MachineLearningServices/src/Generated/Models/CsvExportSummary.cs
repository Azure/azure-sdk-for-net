...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class CsvExportSummary : ExportSummary
    {
        ...
        internal CsvExportSummary(ExportFormatType format, string labelingJobId, long? exportedRowCount, DateTimeOffset? startTimeUtc, DateTimeOffset? endTimeUtc, string snapshotPath, string containerName) : base(format, labelingJobId, exportedRowCount, startTimeUtc, endTimeUtc)
        {
