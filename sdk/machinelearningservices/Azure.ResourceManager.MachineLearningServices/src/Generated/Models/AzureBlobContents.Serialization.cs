...
{
    public partial class AzureBlobContents : IUtf8JsonSerializable
    {
        ...
        internal static AzureBlobContents DeserializeAzureBlobContents(JsonElement element)
        {
            ...
            return new AzureBlobContents(contentsType, accountName, containerName, credentials, endpoint, protocol);
        }
    }
}
