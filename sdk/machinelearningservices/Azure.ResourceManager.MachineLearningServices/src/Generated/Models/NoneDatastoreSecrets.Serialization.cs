...
{
    public partial class NoneDatastoreSecrets : IUtf8JsonSerializable
    {
        ...
        internal static NoneDatastoreSecrets DeserializeNoneDatastoreSecrets(JsonElement element)
        {
            ...
            return new NoneDatastoreSecrets(secretsType);
        }
    }
}
