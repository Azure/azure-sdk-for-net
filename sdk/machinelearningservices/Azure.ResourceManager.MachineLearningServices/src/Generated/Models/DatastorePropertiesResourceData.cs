...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class DatastorePropertiesResourceData : Resource<ResourceGroupResourceIdentifier>
    {
        ...
        internal DatastorePropertiesResourceData(ResourceGroupResourceIdentifier id, string name, ResourceType type, DatastoreProperties properties, SystemData systemData) : base(id, name, type)
        {
            Properties = properties;
