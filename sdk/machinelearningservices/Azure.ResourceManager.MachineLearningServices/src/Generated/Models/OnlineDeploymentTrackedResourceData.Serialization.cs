    ...
    public partial class OnlineDeploymentTrackedResourceData : IUtf8JsonSerializable
    {
        ...
        internal static OnlineDeploymentTrackedResourceData DeserializeOnlineDeploymentTrackedResourceData(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    properties = OnlineDeployment.DeserializeOnlineDeployment(property.Value);
                    continue;
                }
            ...
            return new OnlineDeploymentTrackedResourceData(id, name, type, tags, location, identity.Value, kind.Value, properties, sku.Value, systemData);
        }
    }
}
