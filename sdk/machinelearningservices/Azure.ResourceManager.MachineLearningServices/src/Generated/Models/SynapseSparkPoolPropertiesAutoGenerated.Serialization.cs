...
{
    public partial class SynapseSparkPoolPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static SynapseSparkPoolPropertiesAutoGenerated DeserializeSynapseSparkPoolPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new SynapseSparkPoolPropertiesAutoGenerated(autoScaleProperties.Value, autoPauseProperties.Value, sparkVersion.Value, Optional.ToNullable(nodeCount), nodeSize.Value, nodeSizeFamily.Value, subscriptionId.Value, resourceGroup.Value, workspaceName.Value, poolName.Value);
        }
    }
}
