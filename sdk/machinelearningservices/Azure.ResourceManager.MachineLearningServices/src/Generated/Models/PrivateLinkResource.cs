...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class PrivateLinkResource : Resource<TenantResourceIdentifier>
    {
        ...
        internal PrivateLinkResource(TenantResourceIdentifier id, string name, ResourceType type, Identity identity, string location, IDictionary<string, string> tags, Sku sku, SystemData systemData, string groupId, IReadOnlyList<string> requiredMembers, IList<string> requiredZoneNames) : base(id, name, type)
        {
            Identity = identity;
            Location = location;
            Tags = tags;
