...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    internal partial class DatastoreResourceArmPaginatedResult
    {
        ...
        {
            Value = new ChangeTrackingList<DatastoreResourceData>();
        }
        ...
        internal DatastoreResourceArmPaginatedResult(string nextLink, IReadOnlyList<DatastoreResourceData> value)
        {
            NextLink = nextLink;
            Value = value;
        }
        ...
        public IReadOnlyList<DatastoreResourceData> Value { get; }
    }
}
