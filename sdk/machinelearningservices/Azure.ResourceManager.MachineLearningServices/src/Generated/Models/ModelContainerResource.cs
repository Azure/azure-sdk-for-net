...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ModelContainerResource. </summary>
        /// <param name="properties"> . </param>
        /// <exception cref="ArgumentNullException"> <paramref name="properties"/> is null. </exception>
        public ModelContainerResource(ModelContainer properties)
        {
            if (properties == null)
            {
        ...
        internal ModelContainerResource(string id, string name, string type, ModelContainer properties, SystemData systemData)
        {
            Id = id;
            Name = name;
            Type = type;
