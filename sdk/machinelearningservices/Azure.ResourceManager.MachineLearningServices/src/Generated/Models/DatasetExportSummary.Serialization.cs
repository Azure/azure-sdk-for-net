...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    public partial class DatasetExportSummary : IUtf8JsonSerializable
    {
        ...
        internal static DatasetExportSummary DeserializeDatasetExportSummary(JsonElement element)
        {
            ...
            return new DatasetExportSummary(Optional.ToNullable(endTimeUtc), Optional.ToNullable(exportedRowCount), format, labelingJobId.Value, Optional.ToNullable(startTimeUtc), labeledAssetName.Value);
        }
    }
}
