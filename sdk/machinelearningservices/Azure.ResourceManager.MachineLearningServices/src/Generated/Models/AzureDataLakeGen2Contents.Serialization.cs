...
{
    public partial class AzureDataLakeGen2Contents : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataLakeGen2Contents DeserializeAzureDataLakeGen2Contents(JsonElement element)
        {
            ...
            return new AzureDataLakeGen2Contents(contentsType, accountName, containerName, credentials, endpoint, protocol);
        }
    }
}
