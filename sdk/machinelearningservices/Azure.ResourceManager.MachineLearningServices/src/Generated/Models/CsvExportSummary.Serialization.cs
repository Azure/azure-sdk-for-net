...
namespace Azure.ResourceManager.MachineLearningServices
{
    public partial class CsvExportSummary : IUtf8JsonSerializable
    {
        ...
        internal static CsvExportSummary DeserializeCsvExportSummary(JsonElement element)
        {
            ...
            return new CsvExportSummary(format, labelingJobId.Value, Optional.ToNullable(exportedRowCount), Optional.ToNullable(startTimeUtc), Optional.ToNullable(endTimeUtc), snapshotPath.Value, containerName.Value);
        }
    }
}
