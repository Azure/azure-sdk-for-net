...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    public partial class AzureDataLakeGen1Datastore : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataLakeGen1Datastore DeserializeAzureDataLakeGen1Datastore(JsonElement element)
        {
            ...
            return new AzureDataLakeGen1Datastore(credentials, datastoreType, description.Value, Optional.ToNullable(isDefault), Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(serviceDataAccessAuthIdentity), storeName);
        }
    }
}
