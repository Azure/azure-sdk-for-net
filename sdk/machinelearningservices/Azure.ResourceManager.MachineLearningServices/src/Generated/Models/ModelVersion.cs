...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class ModelVersion
    {
        ...
        internal ModelVersion(IDictionary<string, FlavorData> flavors, string datastoreId, string path, bool? isAnonymous, string description, IDictionary<string, string> tags, IDictionary<string, string> properties)
        {
            Flavors = flavors;
