...
namespace Azure.ResourceManager.MachineLearningServices
{
    public partial class TrialComponent : IUtf8JsonSerializable
    {
        ...
        internal static TrialComponent DeserializeTrialComponent(JsonElement element)
        {
            ...
            return new TrialComponent(Optional.ToNullable(timeout), codeId.Value, command, environmentId.Value, Optional.ToDictionary(inputDataBindings), Optional.ToDictionary(outputDataBindings), Optional.ToDictionary(environmentVariables), distribution.Value);
        }
    }
}
