...
{
    public partial class UriFileJobOutput : IUtf8JsonSerializable
    {
        ...
        internal static UriFileJobOutput DeserializeUriFileJobOutput(JsonElement element)
        {
            ...
            return new UriFileJobOutput(description.Value, jobOutputType, Optional.ToNullable(mode), uri);
        }
    }
}
