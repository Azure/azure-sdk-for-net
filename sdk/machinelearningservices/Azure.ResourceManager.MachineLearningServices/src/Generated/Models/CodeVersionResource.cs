...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CodeVersionResource. </summary>
        /// <param name="properties"> Details of an RegisteredCode. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="properties"/> is null. </exception>
        public CodeVersionResource(CodeVersion properties)
        {
            if (properties == null)
            {
        ...
        internal CodeVersionResource(string id, string name, string type, CodeVersion properties, SystemData systemData)
        {
            Id = id;
            Name = name;
            Type = type;
