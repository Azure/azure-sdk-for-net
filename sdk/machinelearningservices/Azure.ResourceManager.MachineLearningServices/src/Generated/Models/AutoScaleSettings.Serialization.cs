...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    public partial class AutoScaleSettings : IUtf8JsonSerializable
    {
        ...
        internal static AutoScaleSettings DeserializeAutoScaleSettings(JsonElement element)
        {
            ...
            return new AutoScaleSettings(Optional.ToNullable(maxInstances), Optional.ToNullable(minInstances), scaleType, Optional.ToNullable(pollingInterval), Optional.ToNullable(targetUtilizationPercentage));
        }
    }
}
