        ...
        internal static ResourceIdentity DeserializeResourceIdentity(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("type"))
                {
                    ...
                    type = new ResourceIdentityAssignment(property.Value.GetString());
                    continue;
                }
            ...
            return new ResourceIdentity(principalId.Value, tenantId.Value, Optional.ToNullable(type), Optional.ToDictionary(userAssignedIdentities));
        }
    }
}
