...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    public partial class WorkspaceSku
    {
        internal static WorkspaceSku DeserializeWorkspaceSku(JsonElement element)
        {
            ...
            return new WorkspaceSku(Optional.ToList(locations), Optional.ToList(locationInfo), tier.Value, resourceType.Value, name.Value, Optional.ToList(capabilities), Optional.ToList(restrictions));
        }
    }
}
