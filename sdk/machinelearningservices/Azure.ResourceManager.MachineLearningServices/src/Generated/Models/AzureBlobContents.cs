...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    {
        /// <summary> Initializes a new instance of AzureBlobContents. </summary>
        ...
        public AzureBlobContents(string accountName, string containerName, string endpoint, string protocol, DatastoreCredentials credentials)
        {
            if (accountName == null)
            {
            ...
            ContentsType = ContentsType.AzureBlob;
        }
        ...
        /// <param name="protocol"> Protocol used to communicate with the storage account. </param>
        /// <param name="credentials"> Account credentials. </param>
        internal AzureBlobContents(ContentsType contentsType, string accountName, string containerName, string endpoint, string protocol, DatastoreCredentials credentials) : base(contentsType)
        {
            AccountName = accountName;
            ContainerName = containerName;
            Endpoint = endpoint;
