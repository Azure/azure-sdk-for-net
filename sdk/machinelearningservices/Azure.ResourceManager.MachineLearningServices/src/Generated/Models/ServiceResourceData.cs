...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class ServiceResourceData : Resource<ResourceGroupResourceIdentifier>
    {
        ...
        internal ServiceResourceData(ResourceGroupResourceIdentifier id, string name, ResourceType type, Identity identity, string location, IDictionary<string, string> tags, Sku sku, SystemData systemData, ServiceResponseBase properties) : base(id, name, type)
        {
            Identity = identity;
            Location = location;
            Tags = tags;
