...
{
    public partial class AzurePostgreSqlContents : IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlContents DeserializeAzurePostgreSqlContents(JsonElement element)
        {
            ...
            return new AzurePostgreSqlContents(contentsType, credentials, databaseName, Optional.ToNullable(enableSSL), endpoint, portNumber, serverName);
        }
    }
}
