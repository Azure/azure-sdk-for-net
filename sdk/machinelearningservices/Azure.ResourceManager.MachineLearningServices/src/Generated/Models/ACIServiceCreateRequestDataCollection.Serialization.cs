...
{
    public partial class ACIServiceCreateRequestDataCollection : IUtf8JsonSerializable
    {
        ...
        internal static ACIServiceCreateRequestDataCollection DeserializeACIServiceCreateRequestDataCollection(JsonElement element)
        {
            ...
            return new ACIServiceCreateRequestDataCollection(Optional.ToNullable(eventHubEnabled), Optional.ToNullable(storageEnabled));
        }
    }
}
