...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    internal partial class OnlineDeploymentTrackedResourceArmPaginatedResult
    {
        ...
        {
            Value = new ChangeTrackingList<OnlineDeploymentTrackedResourceData>();
        }

        /// <summary> Initializes a new instance of OnlineDeploymentTrackedResourceArmPaginatedResult. </summary>
        /// <param name="value"> An array of objects of type OnlineDeployment. </param>
        /// <param name="nextLink"> . </param>
        internal OnlineDeploymentTrackedResourceArmPaginatedResult(IReadOnlyList<OnlineDeploymentTrackedResourceData> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<OnlineDeploymentTrackedResourceData> Value { get; }
