...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class AzureBlobDatastore : Datastore
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credentials"/>, <paramref name="accountName"/>, or <paramref name="containerName"/> is null. </exception>
        public AzureBlobDatastore(DatastoreCredentials credentials, string accountName, string containerName) : base(credentials)
        {
            if (credentials == null)
            {
