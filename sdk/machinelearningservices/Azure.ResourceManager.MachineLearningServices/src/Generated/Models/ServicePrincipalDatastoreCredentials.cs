...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class ServicePrincipalDatastoreCredentials : DatastoreCredentials
    {
        ...
        public ServicePrincipalDatastoreCredentials(Guid tenantId, Guid clientId)
        {
            TenantId = tenantId;
            ClientId = clientId;
        ...
        internal ServicePrincipalDatastoreCredentials(CredentialsType credentialsType, string authorityUrl, string resourceUri, Guid tenantId, Guid clientId, ServicePrincipalDatastoreSecrets secrets) : base(credentialsType)
        {
