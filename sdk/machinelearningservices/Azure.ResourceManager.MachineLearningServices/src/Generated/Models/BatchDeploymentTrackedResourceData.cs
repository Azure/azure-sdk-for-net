...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class BatchDeploymentTrackedResourceData : TrackedResource<ResourceGroupResourceIdentifier>
    {
        ...
        internal BatchDeploymentTrackedResourceData(ResourceGroupResourceIdentifier id, string name, ResourceType type, LocationData location, IDictionary<string, string> tags, string kind, ResourceIdentity identity, BatchDeployment properties, SystemData systemData) : base(id, name, type, location, tags)
        {
            Kind = kind;
            Identity = identity;
            Properties = properties;
