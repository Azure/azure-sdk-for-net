...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class CodeVersionResourceData : Resource<ResourceGroupResourceIdentifier>
    {
        ...
        internal CodeVersionResourceData(ResourceGroupResourceIdentifier id, string name, ResourceType type, CodeVersion properties, SystemData systemData) : base(id, name, type)
        {
            Properties = properties;
