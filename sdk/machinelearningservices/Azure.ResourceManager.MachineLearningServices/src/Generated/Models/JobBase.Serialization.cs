...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    public partial class JobBase : IUtf8JsonSerializable
    {
        ...
        internal static JobBase DeserializeJobBase(JsonElement element)
        {
            ...
            return new JobBase(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), computeId.Value, displayName.Value, experimentName.Value, jobType, parentJobName.Value, Optional.ToDictionary(services), Optional.ToNullable(status));
        }
    }
}
