...
{
    public partial class ModelVersionDetails : IUtf8JsonSerializable
    {
        ...
        internal static ModelVersionDetails DeserializeModelVersionDetails(JsonElement element)
        {
            ...
            return new ModelVersionDetails(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), Optional.ToDictionary(flavors), jobName.Value, Optional.ToNullable(modelType), modelUri.Value);
        }
    }
}
