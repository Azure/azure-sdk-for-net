...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class JobBaseDetails : ResourceBase
    {
        /// <summary> Initializes a new instance of JobBaseDetails. </summary>
        ...
        internal JobBaseDetails(string description, IDictionary<string, string> properties, IDictionary<string, string> tags, string computeId, string displayName, string experimentName, IdentityConfiguration identity, bool? isArchived, JobType jobType, ScheduleBase schedule, IDictionary<string, JobService> services, JobStatus? status) : base(description, properties, tags)
        {
            ComputeId = computeId;
