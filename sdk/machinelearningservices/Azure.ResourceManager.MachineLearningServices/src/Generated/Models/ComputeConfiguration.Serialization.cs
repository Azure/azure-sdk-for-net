...
namespace Azure.ResourceManager.MachineLearningServices
{
    public partial class ComputeConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static ComputeConfiguration DeserializeComputeConfiguration(JsonElement element)
        {
            ...
            return new ComputeConfiguration(target.Value, Optional.ToNullable(instanceCount), Optional.ToNullable(isLocal), location.Value, instanceType.Value, Optional.ToDictionary(properties));
        }
    }
}
