...
namespace Azure.ResourceManager.MachineLearningServices
{
    internal partial class VirtualMachineSizesRestOperations
    {
        ...
        public VirtualMachineSizesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-10-01")
        {
