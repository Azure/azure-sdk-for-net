...
namespace Azure.ResourceManager.MachineLearningServices
{
    internal partial class EnvironmentVersionsRestOperations
    {
        ...
        public EnvironmentVersionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-10-01")
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, <paramref name="name"/>, or <paramref name="version"/> is null. </exception>
        public async Task<Response<EnvironmentVersionResourceData>> GetAsync(string resourceGroupName, string workspaceName, string name, string version, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        EnvironmentVersionResourceData value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = EnvironmentVersionResourceData.DeserializeEnvironmentVersionResourceData(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                case 404:
                    return Response.FromValue((EnvironmentVersionResourceData)null, message.Response);
                default:
                    throw await _clientDiagnostics.CreateRequestFailedExceptionAsync(message.Response).ConfigureAwait(false);
            }
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, <paramref name="name"/>, or <paramref name="version"/> is null. </exception>
        public Response<EnvironmentVersionResourceData> Get(string resourceGroupName, string workspaceName, string name, string version, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string resourceGroupName, string workspaceName, string name, string version, EnvironmentVersion properties)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            ...
            var model = new EnvironmentVersionResourceData(properties);
        ...
        /// <param name="resourceGroupName"> The name of the resource group. The name is case insensitive. </param>
        /// <param name="workspaceName"> Name of Azure Machine Learning workspace. </param>
        /// <param name="name"> Name of EnvironmentVersion. </param>
        ...
        public async Task<Response<EnvironmentVersionResourceData>> CreateOrUpdateAsync(string resourceGroupName, string workspaceName, string name, string version, EnvironmentVersion properties, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, <paramref name="name"/>, <paramref name="version"/>, or <paramref name="properties"/> is null. </exception>
        public Response<EnvironmentVersionResourceData> CreateOrUpdate(string resourceGroupName, string workspaceName, string name, string version, EnvironmentVersion properties, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
