...
namespace Azure.ResourceManager.MachineLearningServices
{
    internal partial class MachineLearningServicesRestOperations
    {
        ...
        public MachineLearningServicesRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-03-01-preview")
        {
        ...
        internal HttpMessage CreateListByWorkspaceRequest(string resourceGroupName, string workspaceName, string skip, string modelId, string modelName, string tag, string tags, string properties, string runId, bool? expand, OrderString? orderby)
        {
        ...
        public async Task<Response<PaginatedServiceList>> ListByWorkspaceAsync(string resourceGroupName, string workspaceName, string skip = null, string modelId = null, string modelName = null, string tag = null, string tags = null, string properties = null, string runId = null, bool? expand = null, OrderString? orderby = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateListByWorkspaceRequest(resourceGroupName, workspaceName, skip, modelId, modelName, tag, tags, properties, runId, expand, orderby);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="workspaceName"/> is null. </exception>
        public Response<PaginatedServiceList> ListByWorkspace(string resourceGroupName, string workspaceName, string skip = null, string modelId = null, string modelName = null, string tag = null, string tags = null, string properties = null, string runId = null, bool? expand = null, OrderString? orderby = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        public async Task<Response<ServiceResourceData>> GetAsync(string resourceGroupName, string workspaceName, string serviceName, bool? expand = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="workspaceName"/>, or <paramref name="serviceName"/> is null. </exception>
        public Response<ServiceResourceData> Get(string resourceGroupName, string workspaceName, string serviceName, bool? expand = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
        ...
        internal HttpMessage CreateListByWorkspaceNextPageRequest(string nextLink, string resourceGroupName, string workspaceName, string skip, string modelId, string modelName, string tag, string tags, string properties, string runId, bool? expand, OrderString? orderby)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
        ...
        public async Task<Response<PaginatedServiceList>> ListByWorkspaceNextPageAsync(string nextLink, string resourceGroupName, string workspaceName, string skip = null, string modelId = null, string modelName = null, string tag = null, string tags = null, string properties = null, string runId = null, bool? expand = null, OrderString? orderby = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateListByWorkspaceNextPageRequest(nextLink, resourceGroupName, workspaceName, skip, modelId, modelName, tag, tags, properties, runId, expand, orderby);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
