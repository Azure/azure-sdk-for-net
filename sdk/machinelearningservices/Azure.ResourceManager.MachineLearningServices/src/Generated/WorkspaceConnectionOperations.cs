...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class WorkspaceConnectionOperations : ResourceOperations
    {
        ...
        protected internal WorkspaceConnectionOperations(ResourceOperations options, ResourceIdentifier id) : base(options, id)
        {
        ...
        /// <summary> Delete a workspace connection. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<WorkspaceConnectionDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new WorkspaceConnectionDeleteOperation(response);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Delete a workspace connection. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual WorkspaceConnectionDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("WorkspaceConnectionOperations.StartDelete");
            scope.Start();
            try
