...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class MachineLearningComputeDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of MachineLearningComputeDeleteOperation for mocking. </summary>
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MachineLearningComputeDeleteOperation");
        }
        /// <inheritdoc />
