...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class DataVersionCreateOrUpdateOperation : Operation<DataVersionResource>
    {
        private readonly OperationOrResponseInternals<DataVersionResource> _operation;

        /// <summary> Initializes a new instance of DataVersionCreateOrUpdateOperation for mocking. </summary>
        protected DataVersionCreateOrUpdateOperation()
        {
        }

        internal DataVersionCreateOrUpdateOperation(ResourceOperations operationsBase, Response<DataVersionResourceData> response)
        {
