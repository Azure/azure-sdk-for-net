...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class EnvironmentContainersCreateOrUpdateOperation : Operation<EnvironmentContainerResource>
    {
        private readonly OperationOrResponseInternals<EnvironmentContainerResource> _operation;

        /// <summary> Initializes a new instance of EnvironmentContainersCreateOrUpdateOperation for mocking. </summary>
        protected EnvironmentContainersCreateOrUpdateOperation()
        {
        }

        internal EnvironmentContainersCreateOrUpdateOperation(ResourceOperations operationsBase, Response<EnvironmentContainerResourceData> response)
        {
