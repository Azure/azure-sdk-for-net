...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class BatchEndpointsCreateOrUpdateOperation : Operation<BatchEndpointTrackedResource>
    {
        private readonly OperationOrResponseInternals<BatchEndpointTrackedResource> _operation;

        /// <summary> Initializes a new instance of BatchEndpointsCreateOrUpdateOperation for mocking. </summary>
        protected BatchEndpointsCreateOrUpdateOperation()
        {
        }

        internal BatchEndpointsCreateOrUpdateOperation(ResourceOperations operationsBase, Response<BatchEndpointTrackedResourceData> response)
        {
