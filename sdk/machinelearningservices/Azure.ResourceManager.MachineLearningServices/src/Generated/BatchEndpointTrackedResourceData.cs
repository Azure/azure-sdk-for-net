...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class BatchEndpointTrackedResourceData : TrackedResource
    {
        ...
        internal BatchEndpointTrackedResourceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, Models.ResourceIdentity identity, string kind, BatchEndpoint properties, Models.Sku sku, SystemData systemData) : base(id, name, type, tags, location)
        {
            Identity = identity;
            Kind = kind;
            Properties = properties;
