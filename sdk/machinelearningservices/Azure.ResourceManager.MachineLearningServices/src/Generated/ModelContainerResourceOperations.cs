...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class ModelContainerResourceOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, ModelContainerResource>
    {
        ...
        /// <summary> Delete container. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<ModelContainersDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Delete container. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public ModelContainersDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ModelContainerResourceOperations.StartDelete");
            scope.Start();
            try
