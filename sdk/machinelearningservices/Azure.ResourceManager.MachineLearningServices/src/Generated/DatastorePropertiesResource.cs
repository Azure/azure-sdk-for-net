...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public class DatastorePropertiesResource : DatastorePropertiesResourceOperations
    {
        ...
        internal DatastorePropertiesResource(ResourceOperationsBase options, DatastorePropertiesResourceData resource) : base(options, resource.Id)
        {
            Data = resource;
        }
        ...
        /// <inheritdoc />
        protected override DatastorePropertiesResource GetResource(CancellationToken cancellation = default)
        {
            return this;
        }

        /// <inheritdoc />
        protected override Task<DatastorePropertiesResource> GetResourceAsync(CancellationToken cancellation = default)
        {
