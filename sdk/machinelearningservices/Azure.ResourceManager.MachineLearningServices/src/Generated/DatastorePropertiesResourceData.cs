...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class DatastorePropertiesResourceData : Resource
    {
        ...
        public DatastorePropertiesResourceData(DatastoreProperties properties)
        {
            if (properties == null)
            {
        ...
        internal DatastorePropertiesResourceData(ResourceIdentifier id, string name, ResourceType type, DatastoreProperties properties, SystemData systemData) : base(id, name, type)
        {
            Properties = properties;
