...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class DataContainerResourceOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, DataContainerResource>
    {
        ...
        protected internal DataContainerResourceOperations(OperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        ...
        /// <inheritdoc />
        public async override Task<Response<DataContainerResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public override Response<DataContainerResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DataContainerResourceOperations.Get");
            scope.Start();
            try
        ...
        /// <summary> Delete container. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<DataContainersDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Delete container. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public DataContainersDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DataContainerResourceOperations.StartDelete");
            scope.Start();
            try
