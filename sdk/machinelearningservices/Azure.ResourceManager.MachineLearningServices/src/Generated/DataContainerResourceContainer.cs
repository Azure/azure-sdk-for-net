...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class DataContainerResourceContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, DataContainerResource, DataContainerResourceData>
    {
        ...
        private DataContainersRestOperations _restClient => new DataContainersRestOperations(_clientDiagnostics, _pipeline, Id.SubscriptionId);
        ...
        /// <summary> Filters the list of <see cref="DataContainerResource" /> for this resource group. </summary>
        ...
        public Pageable<DataContainerResource> List(int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Filters the list of <see cref="DataContainerResource" /> for this resource group. Makes an additional network call to retrieve the full data model for each resource group. </summary>
        /// <param name="nameFilter"> The filter used in this operation. </param>
        /// <param name="top"> The number of results to return. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        /// <returns> A collection of <see cref="DataContainerResource" /> that may take multiple service requests to iterate over. </returns>
        public Pageable<DataContainerResource> List(string nameFilter, int? top = null, CancellationToken cancellationToken = default)
        {
            var results = ListAsGenericResource(null, top, cancellationToken);
            return new PhWrappingPageable<GenericResource, DataContainerResource>(results, genericResource => new DataContainerResourceOperations(genericResource, genericResource.Id as ResourceGroupResourceIdentifier).Get().Value);
        }
        ...
        public AsyncPageable<DataContainerResource> ListAsync(int? top = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="P:System.Threading.CancellationToken.None" />. </param>
        /// <returns> An async collection of <see cref="DataContainerResource" /> that may take multiple service requests to iterate over. </returns>
        public AsyncPageable<DataContainerResource> ListAsync(string nameFilter, int? top = null, CancellationToken cancellationToken = default)
        {
            var results = ListAsGenericResourceAsync(null, top, cancellationToken);
            return new PhWrappingAsyncPageable<GenericResource, DataContainerResource>(results, genericResource => new DataContainerResourceOperations(genericResource, genericResource.Id as ResourceGroupResourceIdentifier).Get().Value);
        }
