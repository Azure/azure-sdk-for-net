...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class ComputeDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of ComputeDeleteOperation for mocking. </summary>
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ComputeDeleteOperation");
        }
        /// <inheritdoc />
