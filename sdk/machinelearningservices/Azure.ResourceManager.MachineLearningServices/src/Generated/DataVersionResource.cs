...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class DataVersionResource : ArmResource
    {
        ...
        private readonly DataVersionResourceData _data;
        ...
        internal DataVersionResource(ArmResource options, DataVersionResourceData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal DataVersionResource(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _restClient = new DataVersionsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
        ...
        public virtual DataVersionResourceData Data
        {
            get
            {
                if (!HasData)
        ...
        public async virtual Task<Response<DataVersionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DataVersionResource.Get");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<DataVersionDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DataVersionResource.Delete");
            scope.Start();
            try
            {
                ...
                var operation = new DataVersionDeleteOperation(response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual DataVersionDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DataVersionResource.Delete");
            scope.Start();
            try
