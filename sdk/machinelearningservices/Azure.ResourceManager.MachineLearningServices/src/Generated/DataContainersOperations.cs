...
{
    /// <summary> The DataContainers service client. </summary>
    public partial class DataContainersOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly HttpPipeline _pipeline;
        internal DataContainersRestOperations RestClient { get; }
        /// <summary> Initializes a new instance of DataContainersOperations for mocking. </summary>
        protected DataContainersOperations()
        {
        }
        /// <summary> Initializes a new instance of DataContainersOperations. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> Azure subscription identifier. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        internal DataContainersOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-12-01-preview")
        {
        ...
        public virtual async Task<Response<DataContainerResource>> CreateOrUpdateAsync(string name, string resourceGroupName, string workspaceName, DataContainerResource body = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="body"> Container entity to create or update. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DataContainerResource> CreateOrUpdate(string name, string resourceGroupName, string workspaceName, DataContainerResource body = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DataContainersOperations.CreateOrUpdate");
            scope.Start();
            try
        ...
        /// <param name="workspaceName"> Name of Azure Machine Learning workspace. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<DataContainerResource>> GetAsync(string name, string resourceGroupName, string workspaceName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="workspaceName"> Name of Azure Machine Learning workspace. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DataContainerResource> Get(string name, string resourceGroupName, string workspaceName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DataContainersOperations.Get");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<DataContainerResource> ListAsync(string resourceGroupName, string workspaceName, string skiptoken = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/> or <paramref name="workspaceName"/> is null. </exception>
        public virtual Pageable<DataContainerResource> List(string resourceGroupName, string workspaceName, string skiptoken = null, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
