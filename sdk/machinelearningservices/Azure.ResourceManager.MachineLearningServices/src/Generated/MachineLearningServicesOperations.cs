...
{
    /// <summary> The MachineLearningServices service client. </summary>
    public partial class MachineLearningServicesOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly HttpPipeline _pipeline;
        internal MachineLearningServicesRestOperations RestClient { get; }
        /// <summary> Initializes a new instance of MachineLearningServicesOperations for mocking. </summary>
        protected MachineLearningServicesOperations()
        {
        }
        /// <summary> Initializes a new instance of MachineLearningServicesOperations. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> Azure subscription identifier. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        internal MachineLearningServicesOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2020-09-01-preview")
        {
            RestClient = new MachineLearningServicesRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
        ...
        public virtual AsyncPageable<WorkspaceSku> ListSkusAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("MachineLearningServicesOperations.ListSkus");
                scope.Start();
                try
                {
