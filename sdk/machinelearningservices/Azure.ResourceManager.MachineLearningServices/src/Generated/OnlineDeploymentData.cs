...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class OnlineDeploymentData : ArmResource
    {
        ...
        public virtual OnlineDeploymentDataData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual AsyncPageable<SkuResource> GetSkusAsync(int? count = null, string skip = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<SkuResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _onlineDeploymentDataOnlineDeploymentsRestClient.ListSkusAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, count, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<SkuResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _onlineDeploymentDataOnlineDeploymentsRestClient.ListSkusNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, count, skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<SkuResource> GetSkus(int? count = null, string skip = null, CancellationToken cancellationToken = default)
        {
            Page<SkuResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _onlineDeploymentDataOnlineDeploymentsRestClient.ListSkus(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, count, skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<SkuResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _onlineDeploymentDataOnlineDeploymentsRestClient.ListSkusNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, count, skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
