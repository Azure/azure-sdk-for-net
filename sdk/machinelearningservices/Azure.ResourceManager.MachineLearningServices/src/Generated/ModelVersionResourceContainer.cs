...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class ModelVersionResourceContainer : ResourceContainerBase<ResourceGroupResourceIdentifier, ModelVersionResource, ModelVersionResourceData>
    {
        ...
        /// <param name="workspaceName"> Name of Azure Machine Learning workspace. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public Response<ModelVersionResource> Get(string workspaceName, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="workspaceName"> Name of Azure Machine Learning workspace. </param>
        /// <param name="cancellationToken"> A token to allow the caller to cancel the call to the service. The default value is <see cref="CancellationToken.None" />. </param>
        public async Task<Response<ModelVersionResource>> GetAsync(string workspaceName, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ModelVersionResourceContainer.Get");
            scope.Start();
            try
