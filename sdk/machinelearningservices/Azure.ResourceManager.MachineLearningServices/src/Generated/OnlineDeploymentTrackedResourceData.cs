...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class OnlineDeploymentTrackedResourceData : TrackedResource
    {
        ...
        internal OnlineDeploymentTrackedResourceData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, Models.ResourceIdentity identity, string kind, OnlineDeployment properties, Models.Sku sku, SystemData systemData) : base(id, name, type, tags, location)
        {
            Identity = identity;
            Kind = kind;
            Properties = properties;
