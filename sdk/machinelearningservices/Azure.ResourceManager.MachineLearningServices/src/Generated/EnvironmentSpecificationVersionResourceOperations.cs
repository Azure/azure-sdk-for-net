...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class EnvironmentSpecificationVersionResourceOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, EnvironmentSpecificationVersionResource>
    {
        ...
        /// <summary> Delete version. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<EnvironmentSpecificationVersionsDeleteOperation> StartDeleteAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Delete version. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public EnvironmentSpecificationVersionsDeleteOperation StartDelete(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("EnvironmentSpecificationVersionResourceOperations.StartDelete");
            scope.Start();
            try
