...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class ComponentContainerDataResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ComponentContainerDataResource>> UpdateAsync(WaitUntil waitUntil, ComponentContainerDataData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _componentContainerDataComponentContainersClientDiagnostics.CreateScope("ComponentContainerDataResource.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ComponentContainerDataResource> Update(WaitUntil waitUntil, ComponentContainerDataData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
