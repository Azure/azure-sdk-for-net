...
{
    public partial class ComputeResourceContainerTests : MachineLearningServicesManagerTestBase
    {
        ...
        public async Task CheckIfExists()
        {
            ...
            Assert.DoesNotThrowAsync(async () => _ = await (await ws.GetComputeResources().StartCreateOrUpdateAsync(
                _resourceName,
                DataHelper.GenerateComputeResourceData())).WaitForCompletionAsync());
