...
{
    public partial class Sample_RegistryModelResource
    {
        ...
        public async Task Delete_DeleteRegistryModelContainer()
        {
            ...
            await registryModel.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetRegistryModelContainer()
        {
            ...
            // invoke the operation
            RegistryModelResource result = await registryModel.GetAsync();
...
["tag2"] = "value2",
            ...
            ArmOperation<RegistryModelResource> lro = await registryModel.UpdateAsync(WaitUntil.Completed, data);
