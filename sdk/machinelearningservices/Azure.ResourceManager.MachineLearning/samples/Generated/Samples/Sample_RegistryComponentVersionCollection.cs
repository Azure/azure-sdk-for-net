...
{
    public partial class Sample_RegistryComponentVersionCollection
    {
        ...
        public async Task GetAll_ListRegistryComponentVersion()
        {
            ...
            // get the collection of this RegistryComponentVersionResource
            RegistryComponentVersionCollection collection = registryComponent.GetRegistryComponentVersions();

            // invoke the operation and iterate over the result
            string orderBy = "string";
            int? top = 1;
            await foreach (RegistryComponentVersionResource item in collection.GetAllAsync(orderBy: orderBy, top: top))
            {
        ...
        public async Task Get_GetRegistryComponentVersion()
        {
            ...
            RegistryComponentVersionResource result = await collection.GetAsync(version);
        ...
        public async Task GetIfExists_GetRegistryComponentVersion()
        {
            ...
            // invoke the operation
            string version = "string";
            NullableResponse<RegistryComponentVersionResource> response = await collection.GetIfExistsAsync(version);
            RegistryComponentVersionResource result = response.HasValue ? response.Value : null;
...
["string"] = "string",
            ...
            ArmOperation<RegistryComponentVersionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, version, data);
