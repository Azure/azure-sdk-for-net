...
{
    public partial class Sample_RegistryCollection
    {
        ...
        {
            // Generated from example definition: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/preview/2023-06-01-preview/examples/Registries/list-SystemCreated.json
            ...
            // get the collection of this RegistryResource
            RegistryCollection collection = resourceGroupResource.GetRegistries();

            // invoke the operation and iterate over the result
            await foreach (RegistryResource item in collection.GetAllAsync())
            {
        ...
        {
            // Generated from example definition: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/preview/2023-06-01-preview/examples/Registries/list-UserCreated.json
            // this example is just showing the usage of "Registries_List" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task Get_GetRegistryWithSystemCreatedAccounts()
        {
            ...
            RegistryResource result = await collection.GetAsync(registryName);
        ...
        public async Task GetIfExists_GetRegistryWithSystemCreatedAccounts()
        {
            ...
            // invoke the operation
            string registryName = "string";
            NullableResponse<RegistryResource> response = await collection.GetIfExistsAsync(registryName);
            RegistryResource result = response.HasValue ? response.Value : null;
        ...
        {
            // Generated from example definition: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/preview/2023-06-01-preview/examples/Registries/createOrUpdate-SystemCreated.json
                ...
                Tags =
{
            ...
            ArmOperation<RegistryResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, registryName, data);
        ...
        {
            // Generated from example definition: specification/machinelearningservices/resource-manager/Microsoft.MachineLearningServices/preview/2023-06-01-preview/examples/Registries/createOrUpdate-UserCreated.json
            // this example is just showing the usage of "Registries_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
