...
namespace Azure.ResourceManager.MachineLearning.Samples
{
    public partial class Sample_OutboundRuleBasicResourceCollection
    {
        ...
        public async Task GetIfExists_GetManagedNetworkSettingsRule()
        {
            ...
            // invoke the operation
            string ruleName = "some_string";
            NullableResponse<OutboundRuleBasicResource> response = await collection.GetIfExistsAsync(ruleName);
            OutboundRuleBasicResource result = response.HasValue ? response.Value : null;
