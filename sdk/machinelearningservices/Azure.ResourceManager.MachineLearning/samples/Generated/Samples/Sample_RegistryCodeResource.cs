...
{
    public partial class Sample_RegistryCodeResource
    {
        ...
        public async Task Delete_DeleteRegistryCodeContainer()
        {
            ...
            await registryCode.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetRegistryCodeContainer()
        {
            ...
            // invoke the operation
            RegistryCodeResource result = await registryCode.GetAsync();
...
["tag2"] = "value2",
            ...
            ArmOperation<RegistryCodeResource> lro = await registryCode.UpdateAsync(WaitUntil.Completed, data);
