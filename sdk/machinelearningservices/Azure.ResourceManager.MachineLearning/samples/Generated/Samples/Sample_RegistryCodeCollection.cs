...
{
    public partial class Sample_RegistryCodeCollection
    {
        ...
        public async Task GetAll_ListRegistryCodeContainer()
        {
            ...
            // get the collection of this RegistryCodeResource
            RegistryCodeCollection collection = registry.GetRegistryCodes();

            // invoke the operation and iterate over the result
            await foreach (RegistryCodeResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetRegistryCodeContainer()
        {
            ...
            RegistryCodeResource result = await collection.GetAsync(codeName);
        ...
        public async Task GetIfExists_GetRegistryCodeContainer()
        {
            ...
            // invoke the operation
            string codeName = "testContainer";
            NullableResponse<RegistryCodeResource> response = await collection.GetIfExistsAsync(codeName);
            RegistryCodeResource result = response.HasValue ? response.Value : null;
...
["tag2"] = "value2",
            ...
            ArmOperation<RegistryCodeResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, codeName, data);
            RegistryCodeResource result = lro.Value;
