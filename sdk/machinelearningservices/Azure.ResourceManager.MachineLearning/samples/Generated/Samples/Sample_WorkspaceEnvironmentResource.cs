...
{
    public partial class Sample_WorkspaceEnvironmentResource
    {
        ...
        public async Task Delete_DeleteWorkspaceEnvironmentContainer()
        {
            ...
            await workspaceEnvironment.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetWorkspaceEnvironmentContainer()
        {
            ...
            // invoke the operation
            WorkspaceEnvironmentResource result = await workspaceEnvironment.GetAsync();
...
["additionalProp3"] = "string",
            ...
            ArmOperation<WorkspaceEnvironmentResource> lro = await workspaceEnvironment.UpdateAsync(WaitUntil.Completed, data);
