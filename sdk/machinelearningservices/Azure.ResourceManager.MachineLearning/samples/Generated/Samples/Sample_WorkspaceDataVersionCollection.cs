...
{
    public partial class Sample_WorkspaceDataVersionCollection
    {
        ...
        public async Task GetAll_ListWorkspaceDataVersionBase()
        {
            ...
            // this example assumes you already have this WorkspaceDataResource created on azure
            // for more information of creating WorkspaceDataResource, please refer to the document of WorkspaceDataResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "test-rg";
            string workspaceName = "my-aml-workspace";
            string name = "string";
            ResourceIdentifier workspaceDataResourceId = WorkspaceDataResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, name);
            WorkspaceDataResource workspaceData = client.GetWorkspaceDataResource(workspaceDataResourceId);

            // get the collection of this WorkspaceDataVersionResource
            WorkspaceDataVersionCollection collection = workspaceData.GetWorkspaceDataVersions();

            // invoke the operation and iterate over the result
            WorkspaceDataVersionCollectionGetAllOptions options = new WorkspaceDataVersionCollectionGetAllOptions() { OrderBy = "string", Top = 1, Tags = "string" };
            await foreach (WorkspaceDataVersionResource item in collection.GetAllAsync(options))
            {
        ...
        public async Task Get_GetWorkspaceDataVersionBase()
        {
            ...
            WorkspaceDataVersionResource result = await collection.GetAsync(version);
        ...
        public async Task GetIfExists_GetWorkspaceDataVersionBase()
        {
            ...
            // invoke the operation
            string version = "string";
            NullableResponse<WorkspaceDataVersionResource> response = await collection.GetIfExistsAsync(version);
            WorkspaceDataVersionResource result = response.HasValue ? response.Value : null;
...
["string"] = "string",
            ...
            ArmOperation<WorkspaceDataVersionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, version, data);
            WorkspaceDataVersionResource result = lro.Value;
