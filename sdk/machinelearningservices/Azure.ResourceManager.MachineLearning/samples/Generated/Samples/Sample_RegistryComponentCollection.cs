...
namespace Azure.ResourceManager.MachineLearning.Samples
{
    public partial class Sample_RegistryComponentCollection
    {
        ...
        public async Task GetIfExists_GetRegistryComponentContainer()
        {
            ...
            // invoke the operation
            string componentName = "string";
            NullableResponse<RegistryComponentResource> response = await collection.GetIfExistsAsync(componentName);
            RegistryComponentResource result = response.HasValue ? response.Value : null;
