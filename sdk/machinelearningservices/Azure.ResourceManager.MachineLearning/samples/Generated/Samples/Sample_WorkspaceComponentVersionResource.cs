...
{
    public partial class Sample_WorkspaceComponentVersionResource
    {
        ...
        public async Task Delete_DeleteWorkspaceComponentVersion()
        {
            ...
            // this example assumes you already have this WorkspaceComponentVersionResource created on azure
            // for more information of creating WorkspaceComponentVersionResource, please refer to the document of WorkspaceComponentVersionResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "test-rg";
            string workspaceName = "my-aml-workspace";
            string name = "string";
            string version = "string";
            ResourceIdentifier workspaceComponentVersionResourceId = WorkspaceComponentVersionResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, name, version);
            WorkspaceComponentVersionResource workspaceComponentVersion = client.GetWorkspaceComponentVersionResource(workspaceComponentVersionResourceId);

            // invoke the operation
            await workspaceComponentVersion.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetWorkspaceComponentVersion()
        {
            ...
            // invoke the operation
            WorkspaceComponentVersionResource result = await workspaceComponentVersion.GetAsync();
...
["string"] = "string",
            ...
            ArmOperation<WorkspaceComponentVersionResource> lro = await workspaceComponentVersion.UpdateAsync(WaitUntil.Completed, data);
            WorkspaceComponentVersionResource result = lro.Value;
