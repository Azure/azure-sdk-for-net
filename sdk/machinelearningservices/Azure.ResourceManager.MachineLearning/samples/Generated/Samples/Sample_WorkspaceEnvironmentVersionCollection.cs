...
{
    public partial class Sample_WorkspaceEnvironmentVersionCollection
    {
        ...
        public async Task GetAll_ListWorkspaceEnvironmentVersion()
        {
            ...
            // this example assumes you already have this WorkspaceEnvironmentResource created on azure
            // for more information of creating WorkspaceEnvironmentResource, please refer to the document of WorkspaceEnvironmentResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "test-rg";
            string workspaceName = "my-aml-workspace";
            string name = "string";
            ResourceIdentifier workspaceEnvironmentResourceId = WorkspaceEnvironmentResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, name);
            WorkspaceEnvironmentResource workspaceEnvironment = client.GetWorkspaceEnvironmentResource(workspaceEnvironmentResourceId);

            // get the collection of this WorkspaceEnvironmentVersionResource
            WorkspaceEnvironmentVersionCollection collection = workspaceEnvironment.GetWorkspaceEnvironmentVersions();

            // invoke the operation and iterate over the result
            string orderBy = "string";
            int? top = 1;
            await foreach (WorkspaceEnvironmentVersionResource item in collection.GetAllAsync(orderBy: orderBy, top: top))
            {
        ...
        public async Task Get_GetWorkspaceEnvironmentVersion()
        {
            ...
            WorkspaceEnvironmentVersionResource result = await collection.GetAsync(version);
        ...
        public async Task GetIfExists_GetWorkspaceEnvironmentVersion()
        {
            ...
            // invoke the operation
            string version = "string";
            NullableResponse<WorkspaceEnvironmentVersionResource> response = await collection.GetIfExistsAsync(version);
            WorkspaceEnvironmentVersionResource result = response.HasValue ? response.Value : null;
...
["string"] = "string",
            ...
            ArmOperation<WorkspaceEnvironmentVersionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, version, data);
