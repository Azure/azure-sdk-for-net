...
{
    public partial class Sample_WorkspaceModelVersionResource
    {
        ...
        public async Task Delete_DeleteWorkspaceModelVersion()
        {
            ...
            // this example assumes you already have this WorkspaceModelVersionResource created on azure
            // for more information of creating WorkspaceModelVersionResource, please refer to the document of WorkspaceModelVersionResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "test-rg";
            string workspaceName = "my-aml-workspace";
            string name = "string";
            string version = "string";
            ResourceIdentifier workspaceModelVersionResourceId = WorkspaceModelVersionResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, name, version);
            WorkspaceModelVersionResource workspaceModelVersion = client.GetWorkspaceModelVersionResource(workspaceModelVersionResourceId);

            // invoke the operation
            await workspaceModelVersion.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetWorkspaceModelVersion()
        {
            ...
            // invoke the operation
            WorkspaceModelVersionResource result = await workspaceModelVersion.GetAsync();
...
["string"] = "string",
            ...
            ArmOperation<WorkspaceModelVersionResource> lro = await workspaceModelVersion.UpdateAsync(WaitUntil.Completed, data);
            WorkspaceModelVersionResource result = lro.Value;
...
["string"] = "string",
            ...
            ArmOperation<PackageResponse> lro = await workspaceModelVersion.PackageAsync(WaitUntil.Completed, body);
