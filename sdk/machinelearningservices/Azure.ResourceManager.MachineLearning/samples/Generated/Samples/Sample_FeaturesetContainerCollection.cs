...
{
    public partial class Sample_FeaturesetContainerCollection
    {
        ...
        public async Task GetAll_ListWorkspaceFeaturesetContainer()
        {
            ...
            // get the collection of this FeaturesetContainerResource
            FeaturesetContainerCollection collection = machineLearningWorkspace.GetFeaturesetContainers();

            // invoke the operation and iterate over the result
            FeaturesetContainerCollectionGetAllOptions options = new FeaturesetContainerCollectionGetAllOptions() { Tags = "string", ListViewType = MachineLearningListViewType.ArchivedOnly };
            await foreach (FeaturesetContainerResource item in collection.GetAllAsync(options))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                FeaturesetContainerData resourceData = item.Data;
        ...
        public async Task Get_GetEntityWorkspaceFeaturesetContainer()
        {
            ...
            string name = "string";
            FeaturesetContainerResource result = await collection.GetAsync(name);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            FeaturesetContainerData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        public async Task GetIfExists_GetEntityWorkspaceFeaturesetContainer()
        {
            ...
            // invoke the operation
            string name = "string";
            NullableResponse<FeaturesetContainerResource> response = await collection.GetIfExistsAsync(name);
            FeaturesetContainerResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_CreateOrUpdateWorkspaceFeaturesetContainer()
        {
            ...
            // invoke the operation
            string name = "string";
            FeaturesetContainerData data = new FeaturesetContainerData(new FeaturesetContainerProperties()
            {
                IsArchived = false,
                Description = "string",
                Properties =
...
["string"] = "string",
            ...
            ArmOperation<FeaturesetContainerResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
            FeaturesetContainerResource result = lro.Value;
