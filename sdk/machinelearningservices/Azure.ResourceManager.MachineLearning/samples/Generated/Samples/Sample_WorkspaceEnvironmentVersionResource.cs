...
{
    public partial class Sample_WorkspaceEnvironmentVersionResource
    {
        ...
        public async Task Delete_DeleteWorkspaceEnvironmentVersion()
        {
            ...
            // this example assumes you already have this WorkspaceEnvironmentVersionResource created on azure
            // for more information of creating WorkspaceEnvironmentVersionResource, please refer to the document of WorkspaceEnvironmentVersionResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "test-rg";
            string workspaceName = "my-aml-workspace";
            string name = "string";
            string version = "string";
            ResourceIdentifier workspaceEnvironmentVersionResourceId = WorkspaceEnvironmentVersionResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, name, version);
            WorkspaceEnvironmentVersionResource workspaceEnvironmentVersion = client.GetWorkspaceEnvironmentVersionResource(workspaceEnvironmentVersionResourceId);

            // invoke the operation
            await workspaceEnvironmentVersion.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetWorkspaceEnvironmentVersion()
        {
            ...
            // invoke the operation
            WorkspaceEnvironmentVersionResource result = await workspaceEnvironmentVersion.GetAsync();
...
["string"] = "string",
            ...
            ArmOperation<WorkspaceEnvironmentVersionResource> lro = await workspaceEnvironmentVersion.UpdateAsync(WaitUntil.Completed, data);
            WorkspaceEnvironmentVersionResource result = lro.Value;
