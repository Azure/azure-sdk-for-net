...
{
    public partial class Sample_RegistryDataCollection
    {
        ...
        public async Task GetAll_RegistryListRegistryDataContainer()
        {
            ...
            // get the collection of this RegistryDataResource
            RegistryDataCollection collection = registry.GetAllRegistryData();

            // invoke the operation and iterate over the result
            MachineLearningListViewType? listViewType = MachineLearningListViewType.All;
            await foreach (RegistryDataResource item in collection.GetAllAsync(listViewType: listViewType))
            {
        ...
        public async Task Get_GetRegistryDataContainer()
        {
            ...
            string name = "string";
            RegistryDataResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_GetRegistryDataContainer()
        {
            ...
            // invoke the operation
            string name = "string";
            NullableResponse<RegistryDataResource> response = await collection.GetIfExistsAsync(name);
            RegistryDataResource result = response.HasValue ? response.Value : null;
...
["string"] = "string",
            ...
            ArmOperation<RegistryDataResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
