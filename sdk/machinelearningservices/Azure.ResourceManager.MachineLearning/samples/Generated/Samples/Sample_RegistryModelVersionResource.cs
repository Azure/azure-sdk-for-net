...
{
    public partial class Sample_RegistryModelVersionResource
    {
        ...
        public async Task Delete_DeleteRegistryModelVersion()
        {
            ...
            // this example assumes you already have this RegistryModelVersionResource created on azure
            // for more information of creating RegistryModelVersionResource, please refer to the document of RegistryModelVersionResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "test-rg";
            string registryName = "my-aml-registry";
            string modelName = "string";
            string version = "string";
            ResourceIdentifier registryModelVersionResourceId = RegistryModelVersionResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, registryName, modelName, version);
            RegistryModelVersionResource registryModelVersion = client.GetRegistryModelVersionResource(registryModelVersionResourceId);

            // invoke the operation
            await registryModelVersion.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetRegistryModelVersion()
        {
            ...
            // invoke the operation
            RegistryModelVersionResource result = await registryModelVersion.GetAsync();
...
["string"] = "string",
            ...
            ArmOperation<RegistryModelVersionResource> lro = await registryModelVersion.UpdateAsync(WaitUntil.Completed, data);
...
["string"] = "string",
            ...
            ArmOperation<PackageResponse> lro = await registryModelVersion.PackageAsync(WaitUntil.Completed, body);
        ...
        public async Task CreateOrGetStartPendingUpload_CreateOrGetStartPendingUploadRegistryModelVersion()
        {
            ...
            PendingUploadResponseDto result = await registryModelVersion.CreateOrGetStartPendingUploadAsync(body);
