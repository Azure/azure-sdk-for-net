...
{
    public partial class Sample_RegistryDataResource
    {
        ...
        public async Task Delete_DeleteRegistryDataContainer()
        {
            ...
            await registryData.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetRegistryDataContainer()
        {
            ...
            // invoke the operation
            RegistryDataResource result = await registryData.GetAsync();
...
["string"] = "string",
            ...
            ArmOperation<RegistryDataResource> lro = await registryData.UpdateAsync(WaitUntil.Completed, data);
            RegistryDataResource result = lro.Value;
