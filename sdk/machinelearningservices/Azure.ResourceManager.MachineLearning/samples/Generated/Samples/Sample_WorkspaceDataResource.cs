...
{
    public partial class Sample_WorkspaceDataResource
    {
        ...
        public async Task Delete_DeleteWorkspaceDataContainer()
        {
            ...
            await workspaceData.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetWorkspaceDataContainer()
        {
            ...
            // invoke the operation
            WorkspaceDataResource result = await workspaceData.GetAsync();
...
["tag2"] = "value2",
            ...
            ArmOperation<WorkspaceDataResource> lro = await workspaceData.UpdateAsync(WaitUntil.Completed, data);
