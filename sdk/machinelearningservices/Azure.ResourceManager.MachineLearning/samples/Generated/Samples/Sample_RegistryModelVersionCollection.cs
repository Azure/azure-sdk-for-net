...
namespace Azure.ResourceManager.MachineLearning.Samples
{
    public partial class Sample_RegistryModelVersionCollection
    {
        ...
        public async Task GetIfExists_GetRegistryModelVersion()
        {
            ...
            // invoke the operation
            string version = "string";
            NullableResponse<RegistryModelVersionResource> response = await collection.GetIfExistsAsync(version);
            RegistryModelVersionResource result = response.HasValue ? response.Value : null;
