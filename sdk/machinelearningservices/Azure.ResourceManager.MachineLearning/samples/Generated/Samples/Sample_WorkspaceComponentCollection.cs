...
namespace Azure.ResourceManager.MachineLearning.Samples
{
    public partial class Sample_WorkspaceComponentCollection
    {
        ...
        public async Task GetIfExists_GetWorkspaceComponentContainer()
        {
            ...
            // invoke the operation
            string name = "string";
            NullableResponse<WorkspaceComponentResource> response = await collection.GetIfExistsAsync(name);
            WorkspaceComponentResource result = response.HasValue ? response.Value : null;
