...
{
    public partial class Sample_FeaturestoreEntityContainerCollection
    {
        ...
        public async Task GetAll_ListWorkspaceFeaturestoreEntityContainer()
        {
            ...
            // get the collection of this FeaturestoreEntityContainerResource
            FeaturestoreEntityContainerCollection collection = machineLearningWorkspace.GetFeaturestoreEntityContainers();

            // invoke the operation and iterate over the result
            FeaturestoreEntityContainerCollectionGetAllOptions options = new FeaturestoreEntityContainerCollectionGetAllOptions() { Tags = "string", ListViewType = MachineLearningListViewType.All };
            await foreach (FeaturestoreEntityContainerResource item in collection.GetAllAsync(options))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                FeaturestoreEntityContainerData resourceData = item.Data;
        ...
        public async Task Get_GetEntityWorkspaceFeaturestoreEntityContainer()
        {
            ...
            string name = "string";
            FeaturestoreEntityContainerResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_GetEntityWorkspaceFeaturestoreEntityContainer()
        {
            ...
            // invoke the operation
            string name = "string";
            NullableResponse<FeaturestoreEntityContainerResource> response = await collection.GetIfExistsAsync(name);
            FeaturestoreEntityContainerResource result = response.HasValue ? response.Value : null;
...
["string"] = "string",
            ...
            ArmOperation<FeaturestoreEntityContainerResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
