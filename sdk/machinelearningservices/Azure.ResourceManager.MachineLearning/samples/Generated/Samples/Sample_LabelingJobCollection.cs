...
{
    public partial class Sample_LabelingJobCollection
    {
        // List Labeling Job.
        ...
        public async Task GetAll_ListLabelingJob()
        {
            ...
            // get the collection of this LabelingJobResource
            LabelingJobCollection collection = machineLearningWorkspace.GetLabelingJobs();

            // invoke the operation and iterate over the result
            await foreach (LabelingJobResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                LabelingJobData resourceData = item.Data;
        ...
        public async Task Get_GetLabelingJob()
        {
            ...
            LabelingJobResource result = await collection.GetAsync(id, includeJobInstructions: includeJobInstructions, includeLabelCategories: includeLabelCategories);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            LabelingJobData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        public async Task GetIfExists_GetLabelingJob()
        {
            ...
            bool? includeJobInstructions = true;
            bool? includeLabelCategories = true;
            NullableResponse<LabelingJobResource> response = await collection.GetIfExistsAsync(id, includeJobInstructions: includeJobInstructions, includeLabelCategories: includeLabelCategories);
            LabelingJobResource result = response.HasValue ? response.Value : null;
        ...
        public async Task CreateOrUpdate_CreateOrUpdateLabelingJob()
        {
            ...
            // invoke the operation
            string id = "testLabelingJob";
            LabelingJobData data = new LabelingJobData(new LabelingJobProperties()
            {
...
["additionalProp3"] = "string",
            ...
            ArmOperation<LabelingJobResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, id, data);
            LabelingJobResource result = lro.Value;
