...
{
    public partial class Sample_WorkspaceModelResource
    {
        ...
        public async Task Delete_DeleteWorkspaceModelContainer()
        {
            ...
            // this example assumes you already have this WorkspaceModelResource created on azure
            // for more information of creating WorkspaceModelResource, please refer to the document of WorkspaceModelResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "testrg123";
            string workspaceName = "workspace123";
            string name = "testContainer";
            ResourceIdentifier workspaceModelResourceId = WorkspaceModelResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, name);
            WorkspaceModelResource workspaceModel = client.GetWorkspaceModelResource(workspaceModelResourceId);

            // invoke the operation
            await workspaceModel.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetWorkspaceModelContainer()
        {
            ...
            // invoke the operation
            WorkspaceModelResource result = await workspaceModel.GetAsync();
...
["tag2"] = "value2",
            ...
            ArmOperation<WorkspaceModelResource> lro = await workspaceModel.UpdateAsync(WaitUntil.Completed, data);
            WorkspaceModelResource result = lro.Value;
