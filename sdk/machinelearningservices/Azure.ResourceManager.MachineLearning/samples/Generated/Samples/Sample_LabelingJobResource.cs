...
{
    public partial class Sample_LabelingJobResource
    {
        // Delete Labeling Job.
        ...
        public async Task Delete_DeleteLabelingJob()
        {
            ...
            // this example assumes you already have this LabelingJobResource created on azure
            // for more information of creating LabelingJobResource, please refer to the document of LabelingJobResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "workspace-1234";
            string workspaceName = "testworkspace";
            string id = "testLabelingJob";
            ResourceIdentifier labelingJobResourceId = LabelingJobResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, id);
            LabelingJobResource labelingJob = client.GetLabelingJobResource(labelingJobResourceId);

            // invoke the operation
            await labelingJob.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetLabelingJob()
        {
            ...
            LabelingJobResource result = await labelingJob.GetAsync(includeJobInstructions: includeJobInstructions, includeLabelCategories: includeLabelCategories);
...
["additionalProp3"] = "string",
            ...
            ArmOperation<LabelingJobResource> lro = await labelingJob.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task ExportLabels_ExportLabelsLabelingJob()
        {
            ...
            ArmOperation<ExportSummary> lro = await labelingJob.ExportLabelsAsync(WaitUntil.Completed, body);
        ...
        public async Task Resume_ResumeLabelingJob()
        {
            ...
            // invoke the operation
            await labelingJob.ResumeAsync(WaitUntil.Completed);
