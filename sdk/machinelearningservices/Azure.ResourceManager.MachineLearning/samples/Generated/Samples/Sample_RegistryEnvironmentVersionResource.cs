...
{
    public partial class Sample_RegistryEnvironmentVersionResource
    {
        ...
        public async Task Delete_DeleteRegistryEnvironmentVersion()
        {
            ...
            // this example assumes you already have this RegistryEnvironmentVersionResource created on azure
            // for more information of creating RegistryEnvironmentVersionResource, please refer to the document of RegistryEnvironmentVersionResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "test-rg";
            string registryName = "my-aml-registry";
            string environmentName = "string";
            string version = "string";
            ResourceIdentifier registryEnvironmentVersionResourceId = RegistryEnvironmentVersionResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, registryName, environmentName, version);
            RegistryEnvironmentVersionResource registryEnvironmentVersion = client.GetRegistryEnvironmentVersionResource(registryEnvironmentVersionResourceId);

            // invoke the operation
            await registryEnvironmentVersion.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetRegistryEnvironmentVersion()
        {
            ...
            // invoke the operation
            RegistryEnvironmentVersionResource result = await registryEnvironmentVersion.GetAsync();
...
["string"] = "string",
            ...
            ArmOperation<RegistryEnvironmentVersionResource> lro = await registryEnvironmentVersion.UpdateAsync(WaitUntil.Completed, data);
