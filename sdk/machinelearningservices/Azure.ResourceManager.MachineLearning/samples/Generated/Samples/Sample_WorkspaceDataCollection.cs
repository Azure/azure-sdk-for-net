...
{
    public partial class Sample_WorkspaceDataCollection
    {
        ...
        public async Task GetAll_ListWorkspaceDataContainer()
        {
            ...
            // get the collection of this WorkspaceDataResource
            WorkspaceDataCollection collection = machineLearningWorkspace.GetAllWorkspaceData();

            // invoke the operation and iterate over the result
            await foreach (WorkspaceDataResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetWorkspaceDataContainer()
        {
            ...
            WorkspaceDataResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_GetWorkspaceDataContainer()
        {
            ...
            // invoke the operation
            string name = "datacontainer123";
            NullableResponse<WorkspaceDataResource> response = await collection.GetIfExistsAsync(name);
            WorkspaceDataResource result = response.HasValue ? response.Value : null;
...
["tag2"] = "value2",
            ...
            ArmOperation<WorkspaceDataResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
            WorkspaceDataResource result = lro.Value;
