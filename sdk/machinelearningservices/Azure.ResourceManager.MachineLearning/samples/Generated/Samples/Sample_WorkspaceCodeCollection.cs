...
{
    public partial class Sample_WorkspaceCodeCollection
    {
        ...
        public async Task GetAll_ListWorkspaceCodeContainer()
        {
            ...
            // get the collection of this WorkspaceCodeResource
            WorkspaceCodeCollection collection = machineLearningWorkspace.GetWorkspaceCodes();

            // invoke the operation and iterate over the result
            await foreach (WorkspaceCodeResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetWorkspaceCodeContainer()
        {
            ...
            WorkspaceCodeResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_GetWorkspaceCodeContainer()
        {
            ...
            // invoke the operation
            string name = "testContainer";
            NullableResponse<WorkspaceCodeResource> response = await collection.GetIfExistsAsync(name);
            WorkspaceCodeResource result = response.HasValue ? response.Value : null;
...
["tag2"] = "value2",
            ...
            ArmOperation<WorkspaceCodeResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
            WorkspaceCodeResource result = lro.Value;
