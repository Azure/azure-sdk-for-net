...
{
    public partial class Sample_WorkspaceCodeResource
    {
        ...
        public async Task Delete_DeleteWorkspaceCodeContainer()
        {
            ...
            await workspaceCode.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetWorkspaceCodeContainer()
        {
            ...
            // invoke the operation
            WorkspaceCodeResource result = await workspaceCode.GetAsync();
...
["tag2"] = "value2",
            ...
            ArmOperation<WorkspaceCodeResource> lro = await workspaceCode.UpdateAsync(WaitUntil.Completed, data);
