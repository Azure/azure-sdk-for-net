...
namespace Azure.ResourceManager.MachineLearning.Samples
{
    public partial class Sample_RegistryEnvironmentCollection
    {
        ...
        public async Task GetIfExists_GetRegistryEnvironmentContainer()
        {
            ...
            // invoke the operation
            string environmentName = "testEnvironment";
            NullableResponse<RegistryEnvironmentResource> response = await collection.GetIfExistsAsync(environmentName);
            RegistryEnvironmentResource result = response.HasValue ? response.Value : null;
