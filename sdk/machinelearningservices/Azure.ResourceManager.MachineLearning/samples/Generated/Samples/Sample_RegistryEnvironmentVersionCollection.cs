...
{
    public partial class Sample_RegistryEnvironmentVersionCollection
    {
        ...
        public async Task GetAll_ListRegistryEnvironmentVersion()
        {
            ...
            // get the collection of this RegistryEnvironmentVersionResource
            RegistryEnvironmentVersionCollection collection = registryEnvironment.GetRegistryEnvironmentVersions();

            // invoke the operation and iterate over the result
            string orderBy = "string";
            int? top = 1;
            await foreach (RegistryEnvironmentVersionResource item in collection.GetAllAsync(orderBy: orderBy, top: top))
            {
        ...
        public async Task Get_GetRegistryEnvironmentVersion()
        {
            ...
            RegistryEnvironmentVersionResource result = await collection.GetAsync(version);
        ...
        public async Task GetIfExists_GetRegistryEnvironmentVersion()
        {
            ...
            // invoke the operation
            string version = "string";
            NullableResponse<RegistryEnvironmentVersionResource> response = await collection.GetIfExistsAsync(version);
            RegistryEnvironmentVersionResource result = response.HasValue ? response.Value : null;
...
["string"] = "string",
            ...
            ArmOperation<RegistryEnvironmentVersionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, version, data);
            RegistryEnvironmentVersionResource result = lro.Value;
