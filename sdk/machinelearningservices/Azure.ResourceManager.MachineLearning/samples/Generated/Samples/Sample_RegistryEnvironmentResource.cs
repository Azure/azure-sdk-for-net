...
{
    public partial class Sample_RegistryEnvironmentResource
    {
        ...
        public async Task Delete_DeleteRegistryEnvironmentContainer()
        {
            ...
            // this example assumes you already have this RegistryEnvironmentResource created on azure
            // for more information of creating RegistryEnvironmentResource, please refer to the document of RegistryEnvironmentResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "testrg123";
            string registryName = "testregistry";
            string environmentName = "testContainer";
            ResourceIdentifier registryEnvironmentResourceId = RegistryEnvironmentResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, registryName, environmentName);
            RegistryEnvironmentResource registryEnvironment = client.GetRegistryEnvironmentResource(registryEnvironmentResourceId);

            // invoke the operation
            await registryEnvironment.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetRegistryEnvironmentContainer()
        {
            ...
            // invoke the operation
            RegistryEnvironmentResource result = await registryEnvironment.GetAsync();
...
["additionalProp3"] = "string",
            ...
            ArmOperation<RegistryEnvironmentResource> lro = await registryEnvironment.UpdateAsync(WaitUntil.Completed, data);
