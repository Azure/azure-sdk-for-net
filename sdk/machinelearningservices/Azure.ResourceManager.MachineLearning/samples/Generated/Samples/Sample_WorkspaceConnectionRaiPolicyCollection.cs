...
namespace Azure.ResourceManager.MachineLearning.Samples
{
    public partial class Sample_WorkspaceConnectionRaiPolicyCollection
    {
        ...
        public async Task GetIfExists_GetRaiPolicy()
        {
            ...
            // invoke the operation
            string raiPolicyName = "raiPolicyName";
            NullableResponse<WorkspaceConnectionRaiPolicyResource> response = await collection.GetIfExistsAsync(raiPolicyName);
...
BlocklistName = "blocklistName",
            ...
            ArmOperation<WorkspaceConnectionRaiPolicyResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, raiPolicyName, data);
