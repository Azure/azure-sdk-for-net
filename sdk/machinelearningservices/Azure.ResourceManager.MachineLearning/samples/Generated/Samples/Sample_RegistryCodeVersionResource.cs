...
{
    public partial class Sample_RegistryCodeVersionResource
    {
        ...
        public async Task Delete_DeleteRegistryCodeVersion()
        {
            ...
            // this example assumes you already have this RegistryCodeVersionResource created on azure
            // for more information of creating RegistryCodeVersionResource, please refer to the document of RegistryCodeVersionResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "test-rg";
            string registryName = "my-aml-registry";
            string codeName = "string";
            string version = "string";
            ResourceIdentifier registryCodeVersionResourceId = RegistryCodeVersionResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, registryName, codeName, version);
            RegistryCodeVersionResource registryCodeVersion = client.GetRegistryCodeVersionResource(registryCodeVersionResourceId);

            // invoke the operation
            await registryCodeVersion.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetRegistryCodeVersion()
        {
            ...
            // invoke the operation
            RegistryCodeVersionResource result = await registryCodeVersion.GetAsync();
...
["string"] = "string",
            ...
            ArmOperation<RegistryCodeVersionResource> lro = await registryCodeVersion.UpdateAsync(WaitUntil.Completed, data);
        ...
        public async Task CreateOrGetStartPendingUpload_CreateOrGetStartPendingUploadRegistryCodeVersion()
        {
            ...
            PendingUploadResponseDto result = await registryCodeVersion.CreateOrGetStartPendingUploadAsync(body);
