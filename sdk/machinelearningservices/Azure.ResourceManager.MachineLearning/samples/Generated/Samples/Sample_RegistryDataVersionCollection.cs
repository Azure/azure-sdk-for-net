...
{
    public partial class Sample_RegistryDataVersionCollection
    {
        ...
        public async Task GetAll_RegistryListRegistryDataVersionBase()
        {
            ...
            await foreach (RegistryDataVersionResource item in collection.GetAllAsync(orderBy: orderBy, top: top, tags: tags, listViewType: listViewType))
            {
        ...
        public async Task Get_GetRegistryDataVersionBase()
        {
            ...
            RegistryDataVersionResource result = await collection.GetAsync(version);
...
["string"] = "string",
            ...
            ArmOperation<RegistryDataVersionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, version, data);
