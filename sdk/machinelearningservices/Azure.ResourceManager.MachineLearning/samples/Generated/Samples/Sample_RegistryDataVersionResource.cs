...
{
    public partial class Sample_RegistryDataVersionResource
    {
        ...
        public async Task Delete_DeleteRegistryDataVersionBase()
        {
            ...
            // this example assumes you already have this RegistryDataVersionResource created on azure
            // for more information of creating RegistryDataVersionResource, please refer to the document of RegistryDataVersionResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "test-rg";
            string registryName = "registryName";
            string name = "string";
            string version = "string";
            ResourceIdentifier registryDataVersionResourceId = RegistryDataVersionResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, registryName, name, version);
            RegistryDataVersionResource registryDataVersion = client.GetRegistryDataVersionResource(registryDataVersionResourceId);

            // invoke the operation
            await registryDataVersion.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetRegistryDataVersionBase()
        {
            ...
            // invoke the operation
            RegistryDataVersionResource result = await registryDataVersion.GetAsync();
...
["string"] = "string",
            ...
            ArmOperation<RegistryDataVersionResource> lro = await registryDataVersion.UpdateAsync(WaitUntil.Completed, data);
            RegistryDataVersionResource result = lro.Value;
        ...
        public async Task CreateOrGetStartPendingUpload_CreateOrGetStartPendingUploadRegistryDataVersionBase()
        {
            ...
            PendingUploadResponseDto result = await registryDataVersion.CreateOrGetStartPendingUploadAsync(body);
