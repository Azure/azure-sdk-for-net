...
{
    public partial class Sample_FeaturesetContainerResource
    {
        ...
        public async Task Delete_DeleteWorkspaceFeaturesetContainer()
        {
            ...
            await featuresetContainer.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetEntityWorkspaceFeaturesetContainer()
        {
            ...
            // invoke the operation
            FeaturesetContainerResource result = await featuresetContainer.GetAsync();
...
["string"] = "string",
            ...
            ArmOperation<FeaturesetContainerResource> lro = await featuresetContainer.UpdateAsync(WaitUntil.Completed, data);
