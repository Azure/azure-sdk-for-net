...
{
    public partial class Sample_WorkspaceModelCollection
    {
        ...
        public async Task GetAll_ListWorkspaceModelContainer()
        {
            ...
            // get the collection of this WorkspaceModelResource
            WorkspaceModelCollection collection = machineLearningWorkspace.GetWorkspaceModels();

            // invoke the operation and iterate over the result
            await foreach (WorkspaceModelResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_GetWorkspaceModelContainer()
        {
            ...
            WorkspaceModelResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_GetWorkspaceModelContainer()
        {
            ...
            // invoke the operation
            string name = "testContainer";
            NullableResponse<WorkspaceModelResource> response = await collection.GetIfExistsAsync(name);
            WorkspaceModelResource result = response.HasValue ? response.Value : null;
...
["tag2"] = "value2",
            ...
            ArmOperation<WorkspaceModelResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
