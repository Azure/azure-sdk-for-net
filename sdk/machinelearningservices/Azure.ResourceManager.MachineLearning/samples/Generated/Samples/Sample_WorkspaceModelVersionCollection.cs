...
{
    public partial class Sample_WorkspaceModelVersionCollection
    {
        ...
        public async Task GetAll_ListWorkspaceModelVersion()
        {
            ...
            // get the collection of this WorkspaceModelVersionResource
            WorkspaceModelVersionCollection collection = workspaceModel.GetWorkspaceModelVersions();

            // invoke the operation and iterate over the result
            WorkspaceModelVersionCollectionGetAllOptions options = new WorkspaceModelVersionCollectionGetAllOptions() { OrderBy = "string", Top = 1, Version = "string", Description = "string", Offset = 1, Tags = "string", Properties = "string" };
            await foreach (WorkspaceModelVersionResource item in collection.GetAllAsync(options))
            {
        ...
        public async Task Get_GetWorkspaceModelVersion()
        {
            ...
            WorkspaceModelVersionResource result = await collection.GetAsync(version);
        ...
        public async Task GetIfExists_GetWorkspaceModelVersion()
        {
            ...
            // invoke the operation
            string version = "string";
            NullableResponse<WorkspaceModelVersionResource> response = await collection.GetIfExistsAsync(version);
            WorkspaceModelVersionResource result = response.HasValue ? response.Value : null;
...
["string"] = "string",
            ...
            ArmOperation<WorkspaceModelVersionResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, version, data);
