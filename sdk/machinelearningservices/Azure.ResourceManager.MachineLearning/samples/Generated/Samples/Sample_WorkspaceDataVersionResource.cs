...
{
    public partial class Sample_WorkspaceDataVersionResource
    {
        ...
        public async Task Delete_DeleteWorkspaceDataVersionBase()
        {
            ...
            // this example assumes you already have this WorkspaceDataVersionResource created on azure
            // for more information of creating WorkspaceDataVersionResource, please refer to the document of WorkspaceDataVersionResource
            string subscriptionId = "00000000-1111-2222-3333-444444444444";
            string resourceGroupName = "test-rg";
            string workspaceName = "my-aml-workspace";
            string name = "string";
            string version = "string";
            ResourceIdentifier workspaceDataVersionResourceId = WorkspaceDataVersionResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, workspaceName, name, version);
            WorkspaceDataVersionResource workspaceDataVersion = client.GetWorkspaceDataVersionResource(workspaceDataVersionResourceId);

            // invoke the operation
            await workspaceDataVersion.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Get_GetWorkspaceDataVersionBase()
        {
            ...
            // invoke the operation
            WorkspaceDataVersionResource result = await workspaceDataVersion.GetAsync();
...
["string"] = "string",
            ...
            ArmOperation<WorkspaceDataVersionResource> lro = await workspaceDataVersion.UpdateAsync(WaitUntil.Completed, data);
