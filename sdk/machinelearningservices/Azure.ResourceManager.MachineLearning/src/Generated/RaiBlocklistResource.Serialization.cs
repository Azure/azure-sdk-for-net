...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class RaiBlocklistResource : IJsonModel<RaiBlocklistData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RaiBlocklistData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<RaiBlocklistData>(Data, options, AzureResourceManagerMachineLearningContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RaiBlocklistData IPersistableModel<RaiBlocklistData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<RaiBlocklistData>(data, options, AzureResourceManagerMachineLearningContext.Default);
