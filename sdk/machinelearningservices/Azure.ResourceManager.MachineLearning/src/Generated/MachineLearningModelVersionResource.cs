...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningModelVersionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> PublishAsync(WaitUntil waitUntil, DestinationAsset body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _machineLearningModelVersionModelVersionsRestClient.PublishAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, body, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Publish(WaitUntil waitUntil, DestinationAsset body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _machineLearningModelVersionModelVersionsRestClient.Publish(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, body, cancellationToken);
                var operation = new MachineLearningArmOperation(_machineLearningModelVersionModelVersionsClientDiagnostics, Pipeline, _machineLearningModelVersionModelVersionsRestClient.CreatePublishRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, body).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
