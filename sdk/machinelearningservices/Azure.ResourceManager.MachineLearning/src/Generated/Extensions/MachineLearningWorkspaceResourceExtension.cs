...
namespace Azure.ResourceManager.MachineLearning.Mock
{
    ...
    public partial class MachineLearningWorkspaceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MachineLearningWorkspaceResourceExtension"/> class for mocking. </summary>
        protected MachineLearningWorkspaceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MachineLearningWorkspaceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MachineLearningWorkspaceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
