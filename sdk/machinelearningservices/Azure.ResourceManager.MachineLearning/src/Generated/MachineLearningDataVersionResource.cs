    ...
    public partial class MachineLearningDataVersionResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<MachineLearningDataVersionResource>> UpdateAsync(WaitUntil waitUntil, MachineLearningDataVersionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MachineLearningArmOperation<MachineLearningDataVersionResource>(Response.FromValue(new MachineLearningDataVersionResource(Client, response), response.GetRawResponse()), operationId);
                if (waitUntil == WaitUntil.Completed)
