...
namespace Azure.ResourceManager.MachineLearningServices
{
    ...
    public partial class DataContainerDataCollection : ArmCollection, IEnumerable<DataContainerDataResource>, IAsyncEnumerable<DataContainerDataResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataContainerDataCollection"/> class for mocking. </summary>
        protected DataContainerDataCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataContainerDataCollection"/> class. </summary>
        ...
        public virtual async Task<ArmOperation<DataContainerDataResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, DataContainerDataData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _dataContainerDataDataContainersClientDiagnostics.CreateScope("DataContainerDataCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<DataContainerDataResource> CreateOrUpdate(WaitUntil waitUntil, string name, DataContainerDataData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<DataContainerDataResource>> GetAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _dataContainerDataDataContainersClientDiagnostics.CreateScope("DataContainerDataCollection.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _dataContainerDataDataContainersClientDiagnostics.CreateScope("DataContainerDataCollection.Exists");
            scope.Start();
            try
            {
