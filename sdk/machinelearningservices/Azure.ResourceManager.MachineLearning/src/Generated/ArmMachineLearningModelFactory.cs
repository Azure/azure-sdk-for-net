...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public static partial class ArmMachineLearningModelFactory
    {
        ...
        {
            return new MachineLearningUsage(id, amlWorkspaceLocation, usageType, unit, currentValue, limit, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningUsageName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningError(error, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningVmSize MachineLearningVmSize(string name = null, string family = null, int? vCpus = null, int? gpus = null, int? osVhdSizeMB = null, int? maxResourceVolumeMB = null, double? memoryGB = null, bool? lowPriorityCapable = null, bool? isPremiumIOSupported = null, MachineLearningEstimatedVmPrices estimatedVmPrices = null, IEnumerable<string> supportedComputeTypes = null)
        {
            ...
            return new MachineLearningVmSize(name, family, vCpus, gpus, osVhdSizeMB, maxResourceVolumeMB, memoryGB, lowPriorityCapable, isPremiumIOSupported, estimatedVmPrices, supportedComputeTypes?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningEstimatedVmPrices MachineLearningEstimatedVmPrices(MachineLearningBillingCurrency billingCurrency = default, MachineLearningUnitOfMeasure unitOfMeasure = default, IEnumerable<MachineLearningEstimatedVmPrice> values = null)
        {
            ...
            return new MachineLearningEstimatedVmPrices(billingCurrency, unitOfMeasure, values?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningEstimatedVmPrice(retailPrice, osType, vmTier, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningWorkspaceQuotaUpdate(id, updateWorkspaceQuotasType, limit, unit, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningResourceQuota(id, amlWorkspaceLocation, resourceQuotaType, name, limit, unit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningResourceName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningComputeData MachineLearningComputeData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, MachineLearningSku sku = null, MachineLearningComputeProperties properties = null)
        {
            ...
            return new MachineLearningComputeData(id, name, resourceType, systemData, tags, location, identity, sku, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningComputeProperties MachineLearningComputeProperties(string computeType = "Unknown", string computeLocation = null, MachineLearningProvisioningState? provisioningState = null, string description = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, ResourceIdentifier resourceId = null, IEnumerable<MachineLearningError> provisioningErrors = null, bool? isAttachedCompute = null, bool? disableLocalAuth = null)
        {
            ...
            return new UnknownCompute(computeType, computeLocation, provisioningState, description, createdOn, modifiedOn, resourceId, provisioningErrors?.ToList(), isAttachedCompute, disableLocalAuth, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AmlComputeNodeInformation(nodeId, privateIPAddress, publicIPAddress, port, nodeState, runId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningCodeContainerData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningCodeContainerProperties MachineLearningCodeContainerProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, bool? isArchived = null, string latestVersion = null, string nextVersion = null, RegistryAssetProvisioningState? provisioningState = null)
        {
            ...
            return new MachineLearningCodeContainerProperties(description, properties, tags, new Dictionary<string, BinaryData>(), isArchived, latestVersion, nextVersion, provisioningState);
        }
        ...
        public static MachineLearningAssetContainer MachineLearningAssetContainer(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, bool? isArchived = null, string latestVersion = null, string nextVersion = null)
        {
            ...
            return new MachineLearningAssetContainer(description, properties, tags, new Dictionary<string, BinaryData>(), isArchived, latestVersion, nextVersion);
        }
        ...
        {
            return new MachineLearningCodeVersionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningCodeVersionProperties MachineLearningCodeVersionProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, AutoDeleteSetting autoDeleteSetting = null, bool? isAnonymous = null, bool? isArchived = null, Uri codeUri = null, RegistryAssetProvisioningState? provisioningState = null)
        {
            ...
            return new MachineLearningCodeVersionProperties(description, properties, tags, new Dictionary<string, BinaryData>(), autoDeleteSetting, isAnonymous, isArchived, codeUri, provisioningState);
        }
        ...
        {
            return new PendingUploadResponseDto(blobReferenceForConsumption, pendingUploadId, pendingUploadType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BlobReferenceForConsumptionDto(blobUri, credential, storageAccountArmId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningComponentContainerData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningComponentContainerProperties MachineLearningComponentContainerProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, bool? isArchived = null, string latestVersion = null, string nextVersion = null, RegistryAssetProvisioningState? provisioningState = null)
        {
            ...
            return new MachineLearningComponentContainerProperties(description, properties, tags, new Dictionary<string, BinaryData>(), isArchived, latestVersion, nextVersion, provisioningState);
        }
        ...
        {
            return new MachineLearningComponentVersionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningComponentVersionProperties MachineLearningComponentVersionProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, AutoDeleteSetting autoDeleteSetting = null, bool? isAnonymous = null, bool? isArchived = null, BinaryData componentSpec = null, RegistryAssetProvisioningState? provisioningState = null, string stage = null)
        {
            ...
            return new MachineLearningComponentVersionProperties(description, properties, tags, new Dictionary<string, BinaryData>(), autoDeleteSetting, isAnonymous, isArchived, componentSpec, provisioningState, stage);
        }
        ...
        {
            return new MachineLearningDataContainerData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningDataContainerProperties MachineLearningDataContainerProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, bool? isArchived = null, string latestVersion = null, string nextVersion = null, MachineLearningDataType dataType = default)
        {
            ...
            return new MachineLearningDataContainerProperties(description, properties, tags, new Dictionary<string, BinaryData>(), isArchived, latestVersion, nextVersion, dataType);
        }
        ...
        {
            return new MachineLearningDataVersionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningEnvironmentContainerData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningEnvironmentContainerProperties MachineLearningEnvironmentContainerProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, bool? isArchived = null, string latestVersion = null, string nextVersion = null, RegistryAssetProvisioningState? provisioningState = null)
        {
            ...
            return new MachineLearningEnvironmentContainerProperties(description, properties, tags, new Dictionary<string, BinaryData>(), isArchived, latestVersion, nextVersion, provisioningState);
        }
        ...
        {
            return new MachineLearningEnvironmentVersionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningEnvironmentVersionProperties MachineLearningEnvironmentVersionProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, AutoDeleteSetting autoDeleteSetting = null, bool? isAnonymous = null, bool? isArchived = null, AutoRebuildSetting? autoRebuild = null, MachineLearningBuildContext build = null, string condaFile = null, MachineLearningEnvironmentType? environmentType = null, string image = null, MachineLearningInferenceContainerProperties inferenceConfig = null, IntellectualProperty intellectualProperty = null, MachineLearningOperatingSystemType? osType = null, RegistryAssetProvisioningState? provisioningState = null, string stage = null)
        {
            ...
            return new MachineLearningEnvironmentVersionProperties(description, properties, tags, new Dictionary<string, BinaryData>(), autoDeleteSetting, isAnonymous, isArchived, autoRebuild, build, condaFile, environmentType, image, inferenceConfig, intellectualProperty, osType, provisioningState, stage);
        }
        ...
        {
            return new MachineLearningModelContainerData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningModelContainerProperties MachineLearningModelContainerProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, bool? isArchived = null, string latestVersion = null, string nextVersion = null, RegistryAssetProvisioningState? provisioningState = null)
        {
            ...
            return new MachineLearningModelContainerProperties(description, properties, tags, new Dictionary<string, BinaryData>(), isArchived, latestVersion, nextVersion, provisioningState);
        }
        ...
        {
            return new MachineLearningModelVersionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningModelVersionProperties MachineLearningModelVersionProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, AutoDeleteSetting autoDeleteSetting = null, bool? isAnonymous = null, bool? isArchived = null, IDictionary<string, MachineLearningFlavorData> flavors = null, IntellectualProperty intellectualProperty = null, string jobName = null, string modelType = null, Uri modelUri = null, RegistryAssetProvisioningState? provisioningState = null, string stage = null)
        {
            ...
            return new MachineLearningModelVersionProperties(description, properties, tags, new Dictionary<string, BinaryData>(), autoDeleteSetting, isAnonymous, isArchived, flavors, intellectualProperty, jobName, modelType, modelUri, provisioningState, stage);
        }
        ...
        public static ModelPackageContent ModelPackageContent(BaseEnvironmentSource baseEnvironmentSource = null, IDictionary<string, string> environmentVariables = null, InferencingServer inferencingServer = null, IEnumerable<ModelPackageInput> inputs = null, ModelConfiguration modelConfiguration = null, IDictionary<string, string> tags = null, string targetEnvironmentId = null)
        {
            ...
            return new ModelPackageContent(baseEnvironmentSource, environmentVariables, inferencingServer, inputs?.ToList(), modelConfiguration, tags, targetEnvironmentId, new Dictionary<string, BinaryData>());
        }
        ...
        public static ModelPackageResult ModelPackageResult(BaseEnvironmentSource baseEnvironmentSource = null, string buildId = null, PackageBuildState? buildState = null, IReadOnlyDictionary<string, string> environmentVariables = null, InferencingServer inferencingServer = null, IEnumerable<ModelPackageInput> inputs = null, Uri logUri = null, ModelConfiguration modelConfiguration = null, IReadOnlyDictionary<string, string> tags = null, string targetEnvironmentId = null)
        {
            ...
            return new ModelPackageResult(baseEnvironmentSource, buildId, buildState, environmentVariables, inferencingServer, inputs?.ToList(), logUri, modelConfiguration, tags, targetEnvironmentId, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningBatchEndpointData MachineLearningBatchEndpointData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, string kind = null, MachineLearningBatchEndpointProperties properties = null, MachineLearningSku sku = null)
        {
            ...
            return new MachineLearningBatchEndpointData(id, name, resourceType, systemData, tags, location, identity, kind, properties, sku, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningBatchEndpointProperties MachineLearningBatchEndpointProperties(MachineLearningEndpointAuthMode authMode = default, string description = null, MachineLearningEndpointAuthKeys keys = null, IDictionary<string, string> properties = null, Uri scoringUri = null, Uri swaggerUri = null, string defaultsDeploymentName = null, MachineLearningEndpointProvisioningState? provisioningState = null)
        {
            ...
            return new MachineLearningBatchEndpointProperties(authMode, description, keys, properties, scoringUri, swaggerUri, new Dictionary<string, BinaryData>(), defaultsDeploymentName != null ? new BatchEndpointDefaults(defaultsDeploymentName, new Dictionary<string, BinaryData>()) : null, provisioningState);
        }
        ...
        public static MachineLearningEndpointProperties MachineLearningEndpointProperties(MachineLearningEndpointAuthMode authMode = default, string description = null, MachineLearningEndpointAuthKeys keys = null, IDictionary<string, string> properties = null, Uri scoringUri = null, Uri swaggerUri = null)
        {
            ...
            return new MachineLearningEndpointProperties(authMode, description, keys, properties, scoringUri, swaggerUri, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningBatchDeploymentData MachineLearningBatchDeploymentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, string kind = null, MachineLearningBatchDeploymentProperties properties = null, MachineLearningSku sku = null)
        {
            ...
            return new MachineLearningBatchDeploymentData(id, name, resourceType, systemData, tags, location, identity, kind, properties, sku, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningDatastoreData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningDatastoreProperties MachineLearningDatastoreProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, MachineLearningDatastoreCredentials credentials = null, string datastoreType = "Unknown", IntellectualProperty intellectualProperty = null, bool? isDefault = null)
        {
            ...
            return new MachineLearningDatastoreProperties(description, properties, tags, new Dictionary<string, BinaryData>(), credentials, datastoreType, intellectualProperty, isDefault);
        }
        ...
        {
            return new MachineLearningFeatureSetContainerData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningFeatureSetContainerProperties MachineLearningFeatureSetContainerProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, bool? isArchived = null, string latestVersion = null, string nextVersion = null, RegistryAssetProvisioningState? provisioningState = null)
        {
            ...
            return new MachineLearningFeatureSetContainerProperties(description, properties, tags, new Dictionary<string, BinaryData>(), isArchived, latestVersion, nextVersion, provisioningState);
        }
        ...
        {
            return new MachineLearningFeatureData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningFeatureSetVersionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningFeatureSetVersionProperties MachineLearningFeatureSetVersionProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, AutoDeleteSetting autoDeleteSetting = null, bool? isAnonymous = null, bool? isArchived = null, IEnumerable<string> entities = null, MaterializationSettings materializationSettings = null, RegistryAssetProvisioningState? provisioningState = null, string specificationPath = null, string stage = null)
        {
            ...
            return new MachineLearningFeatureSetVersionProperties(description, properties, tags, new Dictionary<string, BinaryData>(), autoDeleteSetting, isAnonymous, isArchived, entities?.ToList(), materializationSettings, provisioningState, specificationPath != null ? new FeaturesetSpecification(specificationPath, new Dictionary<string, BinaryData>()) : null, stage);
        }
        ...
        public static MachineLearningFeatureSetJob MachineLearningFeatureSetJob(DateTimeOffset? createdOn = null, string displayName = null, TimeSpan? duration = null, string experimentId = null, FeatureWindow featureWindow = null, string jobId = null, MachineLearningJobStatus? status = null, IReadOnlyDictionary<string, string> tags = null, FeatureStoreJobType? featureStoreJobType = null)
        {
            ...
            return new MachineLearningFeatureSetJob(createdOn, displayName, duration, experimentId, featureWindow, jobId, status, tags, featureStoreJobType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningFeatureStoreEntityContainerData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningFeatureStoreEntityContainerProperties MachineLearningFeatureStoreEntityContainerProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, bool? isArchived = null, string latestVersion = null, string nextVersion = null, RegistryAssetProvisioningState? provisioningState = null)
        {
            ...
            return new MachineLearningFeatureStoreEntityContainerProperties(description, properties, tags, new Dictionary<string, BinaryData>(), isArchived, latestVersion, nextVersion, provisioningState);
        }
        ...
        {
            return new MachineLearningFeaturestoreEntityVersionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningFeatureStoreEntityVersionProperties MachineLearningFeatureStoreEntityVersionProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, AutoDeleteSetting autoDeleteSetting = null, bool? isAnonymous = null, bool? isArchived = null, IEnumerable<IndexColumn> indexColumns = null, RegistryAssetProvisioningState? provisioningState = null, string stage = null)
        {
            ...
            return new MachineLearningFeatureStoreEntityVersionProperties(description, properties, tags, new Dictionary<string, BinaryData>(), autoDeleteSetting, isAnonymous, isArchived, indexColumns?.ToList(), provisioningState, stage);
        }
        ...
        {
            return new MachineLearningJobData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningJobProperties MachineLearningJobProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, ResourceIdentifier componentId = null, ResourceIdentifier computeId = null, string displayName = null, string experimentName = null, MachineLearningIdentityConfiguration identity = null, bool? isArchived = null, string jobType = "Unknown", NotificationSetting notificationSetting = null, IDictionary<string, SecretConfiguration> secretsConfiguration = null, IDictionary<string, MachineLearningJobService> services = null, MachineLearningJobStatus? status = null)
        {
            ...
            return new MachineLearningJobProperties(description, properties, tags, new Dictionary<string, BinaryData>(), componentId, computeId, displayName, experimentName, identity, isArchived, jobType, notificationSetting, secretsConfiguration, services, status);
        }
        ...
        public static MachineLearningJobService MachineLearningJobService(string endpoint = null, string errorMessage = null, string jobServiceType = null, JobNodes nodes = null, int? port = null, IDictionary<string, string> properties = null, string status = null)
        {
            ...
            return new MachineLearningJobService(endpoint, errorMessage, jobServiceType, nodes, port, properties, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningLabelingJobData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProgressMetrics(completedDatapointCount, incrementalDataLastRefreshOn, skippedDatapointCount, totalDatapointCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new JobStatusMessage(code, createdOn, level, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownExportSummary(endOn, exportedRowCount, format, labelingJobId, startOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningOnlineEndpointData MachineLearningOnlineEndpointData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, string kind = null, MachineLearningOnlineEndpointProperties properties = null, MachineLearningSku sku = null)
        {
            ...
            return new MachineLearningOnlineEndpointData(id, name, resourceType, systemData, tags, location, identity, kind, properties, sku, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningOnlineEndpointProperties MachineLearningOnlineEndpointProperties(MachineLearningEndpointAuthMode authMode = default, string description = null, MachineLearningEndpointAuthKeys keys = null, IDictionary<string, string> properties = null, Uri scoringUri = null, Uri swaggerUri = null, string compute = null, IDictionary<string, int> mirrorTraffic = null, MachineLearningEndpointProvisioningState? provisioningState = null, MachineLearningPublicNetworkAccessType? publicNetworkAccess = null, IDictionary<string, int> traffic = null)
        {
            ...
            return new MachineLearningOnlineEndpointProperties(authMode, description, keys, properties, scoringUri, swaggerUri, new Dictionary<string, BinaryData>(), compute, mirrorTraffic, provisioningState, publicNetworkAccess, traffic);
        }
        ...
        public static MachineLearningOnlineDeploymentData MachineLearningOnlineDeploymentData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, string kind = null, MachineLearningOnlineDeploymentProperties properties = null, MachineLearningSku sku = null)
        {
            ...
            return new MachineLearningOnlineDeploymentData(id, name, resourceType, systemData, tags, location, identity, kind, properties, sku, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningOnlineDeploymentProperties MachineLearningOnlineDeploymentProperties(MachineLearningCodeConfiguration codeConfiguration = null, string description = null, string environmentId = null, IDictionary<string, string> environmentVariables = null, IDictionary<string, string> properties = null, bool? appInsightsEnabled = null, DataCollector dataCollector = null, MachineLearningEgressPublicNetworkAccessType? egressPublicNetworkAccess = null, string endpointComputeType = "Unknown", string instanceType = null, MachineLearningProbeSettings livenessProbe = null, string model = null, string modelMountPath = null, MachineLearningDeploymentProvisioningState? provisioningState = null, MachineLearningProbeSettings readinessProbe = null, MachineLearningOnlineRequestSettings requestSettings = null, MachineLearningOnlineScaleSettings scaleSettings = null)
        {
            ...
            return new MachineLearningOnlineDeploymentProperties(codeConfiguration, description, environmentId, environmentVariables, properties, new Dictionary<string, BinaryData>(), appInsightsEnabled, dataCollector, egressPublicNetworkAccess, endpointComputeType, instanceType, livenessProbe, model, modelMountPath, provisioningState, readinessProbe, requestSettings, scaleSettings);
        }
        ...
        {
            return new MachineLearningDeploymentLogs(content, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningSkuDetail(capacity, resourceType, sku, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningSkuCapacity(@default, maximum, minimum, scaleType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningSkuSetting(name, tier, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningEndpointKeyRegenerateContent(keyType, keyValue, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningEndpointAuthToken(accessToken, expireOn, refreshOn, tokenType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningScheduleData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningScheduleProperties MachineLearningScheduleProperties(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, MachineLearningScheduleAction action = null, string displayName = null, bool? isEnabled = null, MachineLearningScheduleProvisioningStatus? provisioningState = null, MachineLearningTriggerBase trigger = null)
        {
            ...
            return new MachineLearningScheduleProperties(description, properties, tags, new Dictionary<string, BinaryData>(), action, displayName, isEnabled, provisioningState, trigger);
        }
        ...
        public static MachineLearningRegistryData MachineLearningRegistryData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, string kind = null, MachineLearningSku sku = null, Uri discoveryUri = null, string intellectualPropertyPublisher = null, ResourceIdentifier managedResourceId = null, Uri mlFlowRegistryUri = null, IEnumerable<RegistryPrivateEndpointConnection> privateEndpointConnections = null, string publicNetworkAccess = null, IEnumerable<RegistryRegionArmDetails> regionDetails = null)
        {
            ...
            return new MachineLearningRegistryData(id, name, resourceType, systemData, tags, location, identity, kind, sku, discoveryUri, intellectualPropertyPublisher, managedResourceId != null ? new ArmResourceId(managedResourceId, new Dictionary<string, BinaryData>()) : null, mlFlowRegistryUri, privateEndpointConnections?.ToList(), publicNetworkAccess, regionDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RegistryPrivateEndpoint(id, new Dictionary<string, BinaryData>(), subnetArmId);
        }
        ...
        {
            return new PrivateEndpointBase(id, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningUserFeature(id, displayName, description, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningWorkspaceData MachineLearningWorkspaceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, string kind = null, MachineLearningSku sku = null, bool? allowPublicAccessWhenBehindVnet = null, string applicationInsights = null, IEnumerable<string> associatedWorkspaces = null, IEnumerable<string> containerRegistries = null, string containerRegistry = null, string description = null, Uri discoveryUri = null, bool? enableDataIsolation = null, MachineLearningEncryptionSetting encryption = null, IEnumerable<string> existingWorkspaces = null, FeatureStoreSettings featureStoreSettings = null, string friendlyName = null, bool? isHbiWorkspace = null, ResourceIdentifier hubResourceId = null, string imageBuildCompute = null, string keyVault = null, IEnumerable<string> keyVaults = null, ManagedNetworkSettings managedNetwork = null, Uri mlFlowTrackingUri = null, MachineLearningNotebookResourceInfo notebookInfo = null, string primaryUserAssignedIdentity = null, IEnumerable<MachineLearningPrivateEndpointConnectionData> privateEndpointConnections = null, int? privateLinkCount = null, MachineLearningProvisioningState? provisioningState = null, MachineLearningPublicNetworkAccessType? publicNetworkAccessType = null, int? cosmosDbCollectionsThroughput = null, string serviceProvisionedResourceGroup = null, IEnumerable<MachineLearningSharedPrivateLinkResource> sharedPrivateLinkResources = null, int? softDeleteRetentionInDays = null, string storageAccount = null, IEnumerable<string> storageAccounts = null, bool? isStorageHnsEnabled = null, string systemDatastoresAuthMode = null, Guid? tenantId = null, bool? isV1LegacyMode = null, WorkspaceHubConfig workspaceHubConfig = null, string workspaceId = null)
        {
            ...
            return new MachineLearningWorkspaceData(id, name, resourceType, systemData, tags, location, identity, kind, sku, allowPublicAccessWhenBehindVnet, applicationInsights, associatedWorkspaces?.ToList(), containerRegistries?.ToList(), containerRegistry, description, discoveryUri, enableDataIsolation, encryption, existingWorkspaces?.ToList(), featureStoreSettings, friendlyName, isHbiWorkspace, hubResourceId, imageBuildCompute, keyVault, keyVaults?.ToList(), managedNetwork, mlFlowTrackingUri, notebookInfo, primaryUserAssignedIdentity, privateEndpointConnections?.ToList(), privateLinkCount, provisioningState, publicNetworkAccessType, cosmosDbCollectionsThroughput != null ? new ServiceManagedResourcesSettings(new CosmosDbSettings(cosmosDbCollectionsThroughput, new Dictionary<string, BinaryData>()), new Dictionary<string, BinaryData>()) : null, serviceProvisionedResourceGroup, sharedPrivateLinkResources?.ToList(), softDeleteRetentionInDays, storageAccount, storageAccounts?.ToList(), isStorageHnsEnabled, systemDatastoresAuthMode, tenantId, isV1LegacyMode, workspaceHubConfig, workspaceId, new Dictionary<string, BinaryData>());
        }
        ...
        public static ManagedNetworkSettings ManagedNetworkSettings(IsolationMode? isolationMode = null, string networkId = null, IDictionary<string, MachineLearningOutboundRule> outboundRules = null, ManagedNetworkProvisionStatus status = null)
        {
            ...
            return new ManagedNetworkSettings(isolationMode, networkId, outboundRules, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningNotebookResourceInfo(fqdn, isPrivateLinkEnabled, notebookPreparationError, resourceId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningNotebookPreparationError(errorMessage, statusCode, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningPrivateEndpointConnectionData MachineLearningPrivateEndpointConnectionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, MachineLearningSku sku = null, MachineLearningPrivateEndpoint privateEndpoint = null, MachineLearningPrivateLinkServiceConnectionState connectionState = null, MachineLearningPrivateEndpointConnectionProvisioningState? provisioningState = null)
        {
            ...
            return new MachineLearningPrivateEndpointConnectionData(id, name, resourceType, systemData, tags, location, identity, sku, privateEndpoint, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningPrivateEndpoint(id, subnetArmId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningWorkspaceConnectionData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningWorkspaceDiagnoseResult(value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningDiagnoseResult(code, level, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningWorkspaceGetKeysResult(appInsightsInstrumentationKey, containerRegistryCredentials, notebookAccessKeys, userStorageResourceId, userStorageKey, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningContainerRegistryCredentials MachineLearningContainerRegistryCredentials(AzureLocation? location = null, IEnumerable<MachineLearningPasswordDetail> passwords = null, string username = null)
        {
            ...
            return new MachineLearningContainerRegistryCredentials(location, passwords?.ToList(), username, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningPasswordDetail(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningWorkspaceGetNotebookKeysResult(primaryAccessKey, secondaryAccessKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningWorkspaceNotebookAccessTokenResult(accessToken, expiresIn, hostName, notebookResourceId, publicDns, refreshToken, scope, tokenType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningWorkspaceGetStorageAccountKeysResult(userStorageKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningFqdnEndpoints(properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningFqdnEndpointsProperties MachineLearningFqdnEndpointsProperties(string category = null, IEnumerable<MachineLearningFqdnEndpoint> endpoints = null)
        {
            ...
            return new MachineLearningFqdnEndpointsProperties(category, endpoints?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningFqdnEndpoint MachineLearningFqdnEndpoint(string domainName = null, IEnumerable<MachineLearningFqdnEndpointDetail> endpointDetails = null)
        {
            ...
            return new MachineLearningFqdnEndpoint(domainName, endpointDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningFqdnEndpointDetail(port, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningOutboundRuleBasicData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningPrivateLinkResource MachineLearningPrivateLinkResource(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, MachineLearningSku sku = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new MachineLearningPrivateLinkResource(id, name, resourceType, systemData, tags, location, identity, sku, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningAksCompute MachineLearningAksCompute(string computeLocation = null, MachineLearningProvisioningState? provisioningState = null, string description = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, ResourceIdentifier resourceId = null, IEnumerable<MachineLearningError> provisioningErrors = null, bool? isAttachedCompute = null, bool? disableLocalAuth = null, MachineLearningAksComputeProperties properties = null)
        {
            ...
            return new MachineLearningAksCompute(ComputeType.Aks, computeLocation, provisioningState, description, createdOn, modifiedOn, resourceId, provisioningErrors?.ToList(), isAttachedCompute, disableLocalAuth, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        public static MachineLearningAksComputeProperties MachineLearningAksComputeProperties(string clusterFqdn = null, IEnumerable<MachineLearningComputeSystemService> systemServices = null, int? agentCount = null, string agentVmSize = null, MachineLearningClusterPurpose? clusterPurpose = null, MachineLearningSslConfiguration sslConfiguration = null, MachineLearningAksNetworkingConfiguration aksNetworkingConfiguration = null, MachineLearningLoadBalancerType? loadBalancerType = null, string loadBalancerSubnet = null)
        {
            ...
            return new MachineLearningAksComputeProperties(clusterFqdn, systemServices?.ToList(), agentCount, agentVmSize, clusterPurpose, sslConfiguration, aksNetworkingConfiguration, loadBalancerType, loadBalancerSubnet, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningComputeSystemService(systemServiceType, publicIPAddress, version, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningKubernetesCompute MachineLearningKubernetesCompute(string computeLocation = null, MachineLearningProvisioningState? provisioningState = null, string description = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, ResourceIdentifier resourceId = null, IEnumerable<MachineLearningError> provisioningErrors = null, bool? isAttachedCompute = null, bool? disableLocalAuth = null, MachineLearningKubernetesProperties properties = null)
        {
            ...
            return new MachineLearningKubernetesCompute(ComputeType.Kubernetes, computeLocation, provisioningState, description, createdOn, modifiedOn, resourceId, provisioningErrors?.ToList(), isAttachedCompute, disableLocalAuth, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        public static AmlComputeProperties AmlComputeProperties(MachineLearningOSType? osType = null, string vmSize = null, MachineLearningVmPriority? vmPriority = null, string virtualMachineImageId = null, bool? isolatedNetwork = null, AmlComputeScaleSettings scaleSettings = null, MachineLearningUserAccountCredentials userAccountCredentials = null, ResourceIdentifier subnetId = null, MachineLearningRemoteLoginPortPublicAccess? remoteLoginPortPublicAccess = null, MachineLearningAllocationState? allocationState = null, DateTimeOffset? allocationStateTransitionOn = null, IEnumerable<MachineLearningError> errors = null, int? currentNodeCount = null, int? targetNodeCount = null, MachineLearningNodeStateCounts nodeStateCounts = null, bool? enableNodePublicIP = null, BinaryData propertyBag = null)
        {
            ...
            return new AmlComputeProperties(osType, vmSize, vmPriority, virtualMachineImageId != null ? new VirtualMachineImage(virtualMachineImageId, new Dictionary<string, BinaryData>()) : null, isolatedNetwork, scaleSettings, userAccountCredentials, subnetId != null ? new ResourceId(subnetId, new Dictionary<string, BinaryData>()) : null, remoteLoginPortPublicAccess, allocationState, allocationStateTransitionOn, errors?.ToList(), currentNodeCount, targetNodeCount, nodeStateCounts, enableNodePublicIP, propertyBag, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningNodeStateCounts(idleNodeCount, runningNodeCount, preparingNodeCount, unusableNodeCount, leavingNodeCount, preemptedNodeCount, new Dictionary<string, BinaryData>());
        }
        ...
        public static AmlCompute AmlCompute(string computeLocation = null, MachineLearningProvisioningState? provisioningState = null, string description = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, ResourceIdentifier resourceId = null, IEnumerable<MachineLearningError> provisioningErrors = null, bool? isAttachedCompute = null, bool? disableLocalAuth = null, AmlComputeProperties properties = null)
        {
            ...
            return new AmlCompute(ComputeType.AmlCompute, computeLocation, provisioningState, description, createdOn, modifiedOn, resourceId, provisioningErrors?.ToList(), isAttachedCompute, disableLocalAuth, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new MachineLearningComputeInstanceSshSettings(sshPublicAccess, adminUserName, sshPort, adminPublicKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ImageMetadata(currentImageVersion, latestImageVersion, isLatestOSImageVersion, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningComputeInstanceConnectivityEndpoints(publicIPAddress, privateIPAddress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningComputeInstanceApplication(displayName, endpointUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningComputeInstanceCreatedBy(userName, userOrgId, userId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningComputeInstanceLastOperation(operationName, operationOn, operationStatus, operationTrigger, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningComputeStartStopSchedule(id, provisioningStatus, status, action, triggerType, recurrenceSchedule, cronSchedule, schedule, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningComputeInstanceContainer MachineLearningComputeInstanceContainer(string name = null, MachineLearningComputeInstanceAutosave? autosave = null, string gpu = null, MachineLearningNetwork? network = null, MachineLearningComputeInstanceEnvironmentInfo environment = null, IEnumerable<BinaryData> services = null)
        {
            ...
            return new MachineLearningComputeInstanceContainer(name, autosave, gpu, network, environment, services?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningComputeInstanceEnvironmentInfo(name, version, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningComputeInstanceDataDisk(caching, diskSizeGB, lun, storageAccountType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MachineLearningComputeInstanceDataMount(source, sourceType, mountName, mountAction, createdBy, mountPath, mountState, mountedOn, error, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningComputeInstance MachineLearningComputeInstance(string computeLocation = null, MachineLearningProvisioningState? provisioningState = null, string description = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, ResourceIdentifier resourceId = null, IEnumerable<MachineLearningError> provisioningErrors = null, bool? isAttachedCompute = null, bool? disableLocalAuth = null, MachineLearningComputeInstanceProperties properties = null)
        {
            ...
            return new MachineLearningComputeInstance(ComputeType.ComputeInstance, computeLocation, provisioningState, description, createdOn, modifiedOn, resourceId, provisioningErrors?.ToList(), isAttachedCompute, disableLocalAuth, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        public static MachineLearningVirtualMachineCompute MachineLearningVirtualMachineCompute(string computeLocation = null, MachineLearningProvisioningState? provisioningState = null, string description = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, ResourceIdentifier resourceId = null, IEnumerable<MachineLearningError> provisioningErrors = null, bool? isAttachedCompute = null, bool? disableLocalAuth = null, MachineLearningVirtualMachineProperties properties = null)
        {
            ...
            return new MachineLearningVirtualMachineCompute(ComputeType.VirtualMachine, computeLocation, provisioningState, description, createdOn, modifiedOn, resourceId, provisioningErrors?.ToList(), isAttachedCompute, disableLocalAuth, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        public static MachineLearningHDInsightCompute MachineLearningHDInsightCompute(string computeLocation = null, MachineLearningProvisioningState? provisioningState = null, string description = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, ResourceIdentifier resourceId = null, IEnumerable<MachineLearningError> provisioningErrors = null, bool? isAttachedCompute = null, bool? disableLocalAuth = null, MachineLearningHDInsightProperties properties = null)
        {
            ...
            return new MachineLearningHDInsightCompute(ComputeType.HDInsight, computeLocation, provisioningState, description, createdOn, modifiedOn, resourceId, provisioningErrors?.ToList(), isAttachedCompute, disableLocalAuth, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        public static MachineLearningDataFactoryCompute MachineLearningDataFactoryCompute(string computeLocation = null, MachineLearningProvisioningState? provisioningState = null, string description = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, ResourceIdentifier resourceId = null, IEnumerable<MachineLearningError> provisioningErrors = null, bool? isAttachedCompute = null, bool? disableLocalAuth = null)
        {
            ...
            return new MachineLearningDataFactoryCompute(ComputeType.DataFactory, computeLocation, provisioningState, description, createdOn, modifiedOn, resourceId, provisioningErrors?.ToList(), isAttachedCompute, disableLocalAuth, new Dictionary<string, BinaryData>());
        }
        ...
        public static MachineLearningDatabricksCompute MachineLearningDatabricksCompute(string computeLocation = null, MachineLearningProvisioningState? provisioningState = null, string description = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, ResourceIdentifier resourceId = null, IEnumerable<MachineLearningError> provisioningErrors = null, bool? isAttachedCompute = null, bool? disableLocalAuth = null, MachineLearningDatabricksProperties properties = null)
        {
            ...
            return new MachineLearningDatabricksCompute(ComputeType.Databricks, computeLocation, provisioningState, description, createdOn, modifiedOn, resourceId, provisioningErrors?.ToList(), isAttachedCompute, disableLocalAuth, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        public static MachineLearningSynapseSpark MachineLearningSynapseSpark(string computeLocation = null, MachineLearningProvisioningState? provisioningState = null, string description = null, DateTimeOffset? createdOn = null, DateTimeOffset? modifiedOn = null, ResourceIdentifier resourceId = null, IEnumerable<MachineLearningError> provisioningErrors = null, bool? isAttachedCompute = null, bool? disableLocalAuth = null, MachineLearningSynapseSparkProperties properties = null)
        {
            ...
            return new MachineLearningSynapseSpark(ComputeType.SynapseSpark, computeLocation, provisioningState, description, createdOn, modifiedOn, resourceId, provisioningErrors?.ToList(), isAttachedCompute, disableLocalAuth, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new MachineLearningAksComputeSecrets(ComputeType.Aks, new Dictionary<string, BinaryData>(), userKubeConfig, adminKubeConfig, imagePullSecretName);
        }
        ...
        {
            return new MachineLearningVirtualMachineSecrets(ComputeType.VirtualMachine, new Dictionary<string, BinaryData>(), administratorAccount);
        }
        ...
        {
            return new MachineLearningDatabricksComputeSecrets(ComputeType.Databricks, new Dictionary<string, BinaryData>(), databricksAccessToken);
        }
        ...
        public static MachineLearningAzureBlobDatastore MachineLearningAzureBlobDatastore(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, MachineLearningDatastoreCredentials credentials = null, IntellectualProperty intellectualProperty = null, bool? isDefault = null, string accountName = null, string containerName = null, string endpoint = null, string protocol = null, MachineLearningServiceDataAccessAuthIdentity? serviceDataAccessAuthIdentity = null, string resourceGroup = null, string subscriptionId = null)
        {
            ...
            return new MachineLearningAzureBlobDatastore(description, properties, tags, new Dictionary<string, BinaryData>(), credentials, DatastoreType.AzureBlob, intellectualProperty, isDefault, accountName, containerName, endpoint, protocol, serviceDataAccessAuthIdentity, resourceGroup, subscriptionId);
        }
        ...
        public static MachineLearningAzureDataLakeGen1Datastore MachineLearningAzureDataLakeGen1Datastore(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, MachineLearningDatastoreCredentials credentials = null, IntellectualProperty intellectualProperty = null, bool? isDefault = null, MachineLearningServiceDataAccessAuthIdentity? serviceDataAccessAuthIdentity = null, string storeName = null, string resourceGroup = null, string subscriptionId = null)
        {
            ...
            return new MachineLearningAzureDataLakeGen1Datastore(description, properties, tags, new Dictionary<string, BinaryData>(), credentials, DatastoreType.AzureDataLakeGen1, intellectualProperty, isDefault, serviceDataAccessAuthIdentity, storeName, resourceGroup, subscriptionId);
        }
        ...
        public static MachineLearningAzureDataLakeGen2Datastore MachineLearningAzureDataLakeGen2Datastore(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, MachineLearningDatastoreCredentials credentials = null, IntellectualProperty intellectualProperty = null, bool? isDefault = null, string accountName = null, string endpoint = null, string filesystem = null, string protocol = null, MachineLearningServiceDataAccessAuthIdentity? serviceDataAccessAuthIdentity = null, string resourceGroup = null, string subscriptionId = null)
        {
            ...
            return new MachineLearningAzureDataLakeGen2Datastore(description, properties, tags, new Dictionary<string, BinaryData>(), credentials, DatastoreType.AzureDataLakeGen2, intellectualProperty, isDefault, accountName, endpoint, filesystem, protocol, serviceDataAccessAuthIdentity, resourceGroup, subscriptionId);
        }
        ...
        public static MachineLearningAzureFileDatastore MachineLearningAzureFileDatastore(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, MachineLearningDatastoreCredentials credentials = null, IntellectualProperty intellectualProperty = null, bool? isDefault = null, string accountName = null, string endpoint = null, string fileShareName = null, string protocol = null, MachineLearningServiceDataAccessAuthIdentity? serviceDataAccessAuthIdentity = null, string resourceGroup = null, string subscriptionId = null)
        {
            ...
            return new MachineLearningAzureFileDatastore(description, properties, tags, new Dictionary<string, BinaryData>(), credentials, DatastoreType.AzureFile, intellectualProperty, isDefault, accountName, endpoint, fileShareName, protocol, serviceDataAccessAuthIdentity, resourceGroup, subscriptionId);
        }
        ...
        {
            return new CocoExportSummary(endOn, exportedRowCount, ExportFormatType.Coco, labelingJobId, startOn, new Dictionary<string, BinaryData>(), containerName, snapshotPath);
        }
        ...
        public static MachineLearningCommandJob MachineLearningCommandJob(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, ResourceIdentifier componentId = null, ResourceIdentifier computeId = null, string displayName = null, string experimentName = null, MachineLearningIdentityConfiguration identity = null, bool? isArchived = null, NotificationSetting notificationSetting = null, IDictionary<string, SecretConfiguration> secretsConfiguration = null, IDictionary<string, MachineLearningJobService> services = null, MachineLearningJobStatus? status = null, MachineLearningFlowAutoLoggerState? mlflowAutologger = null, ResourceIdentifier codeId = null, string command = null, MachineLearningDistributionConfiguration distribution = null, ResourceIdentifier environmentId = null, IDictionary<string, string> environmentVariables = null, IDictionary<string, MachineLearningJobInput> inputs = null, MachineLearningCommandJobLimits limits = null, IDictionary<string, MachineLearningJobOutput> outputs = null, BinaryData parameters = null, JobQueueSettings queueSettings = null, MachineLearningJobResourceConfiguration resources = null)
        {
            ...
            return new MachineLearningCommandJob(description, properties, tags, new Dictionary<string, BinaryData>(), componentId, computeId, displayName, experimentName, identity, isArchived, JobType.Command, notificationSetting, secretsConfiguration, services, status, mlflowAutologger.HasValue ? new AutologgerSettings(mlflowAutologger.Value, new Dictionary<string, BinaryData>()) : null, codeId, command, distribution, environmentId, environmentVariables, inputs, limits, outputs, parameters, queueSettings, resources);
        }
        ...
        {
            return new CsvExportSummary(endOn, exportedRowCount, ExportFormatType.CSV, labelingJobId, startOn, new Dictionary<string, BinaryData>(), containerName, snapshotPath);
        }
        ...
        {
            return new DatasetExportSummary(endOn, exportedRowCount, ExportFormatType.Dataset, labelingJobId, startOn, new Dictionary<string, BinaryData>(), labeledAssetName);
        }
        ...
        public static HdfsDatastore HdfsDatastore(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, MachineLearningDatastoreCredentials credentials = null, IntellectualProperty intellectualProperty = null, bool? isDefault = null, string hdfsServerCertificate = null, string nameNodeAddress = null, string protocol = null)
        {
            ...
            return new HdfsDatastore(description, properties, tags, new Dictionary<string, BinaryData>(), credentials, DatastoreType.Hdfs, intellectualProperty, isDefault, hdfsServerCertificate, nameNodeAddress, protocol);
        }
        ...
        public static MachineLearningManagedOnlineDeployment MachineLearningManagedOnlineDeployment(MachineLearningCodeConfiguration codeConfiguration = null, string description = null, string environmentId = null, IDictionary<string, string> environmentVariables = null, IDictionary<string, string> properties = null, bool? appInsightsEnabled = null, DataCollector dataCollector = null, MachineLearningEgressPublicNetworkAccessType? egressPublicNetworkAccess = null, string instanceType = null, MachineLearningProbeSettings livenessProbe = null, string model = null, string modelMountPath = null, MachineLearningDeploymentProvisioningState? provisioningState = null, MachineLearningProbeSettings readinessProbe = null, MachineLearningOnlineRequestSettings requestSettings = null, MachineLearningOnlineScaleSettings scaleSettings = null)
        {
            ...
            return new MachineLearningManagedOnlineDeployment(codeConfiguration, description, environmentId, environmentVariables, properties, new Dictionary<string, BinaryData>(), appInsightsEnabled, dataCollector, egressPublicNetworkAccess, MachineLearningEndpointComputeType.Managed, instanceType, livenessProbe, model, modelMountPath, provisioningState, readinessProbe, requestSettings, scaleSettings);
        }
        ...
        public static OneLakeDatastore OneLakeDatastore(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, MachineLearningDatastoreCredentials credentials = null, IntellectualProperty intellectualProperty = null, bool? isDefault = null, OneLakeArtifact artifact = null, string endpoint = null, string oneLakeWorkspaceName = null, MachineLearningServiceDataAccessAuthIdentity? serviceDataAccessAuthIdentity = null)
        {
            ...
            return new OneLakeDatastore(description, properties, tags, new Dictionary<string, BinaryData>(), credentials, DatastoreType.OneLake, intellectualProperty, isDefault, artifact, endpoint, oneLakeWorkspaceName, serviceDataAccessAuthIdentity);
        }
        ...
        public static MachineLearningPipelineJob MachineLearningPipelineJob(string description = null, IDictionary<string, string> properties = null, IDictionary<string, string> tags = null, ResourceIdentifier componentId = null, ResourceIdentifier computeId = null, string displayName = null, string experimentName = null, MachineLearningIdentityConfiguration identity = null, bool? isArchived = null, NotificationSetting notificationSetting = null, IDictionary<string, SecretConfiguration> secretsConfiguration = null, IDictionary<string, MachineLearningJobService> services = null, MachineLearningJobStatus? status = null, IDictionary<string, MachineLearningJobInput> inputs = null, IDictionary<string, BinaryData> jobs = null, IDictionary<string, MachineLearningJobOutput> outputs = null, BinaryData settings = null, ResourceIdentifier sourceJobId = null)
        {
            ...
            return new MachineLearningPipelineJob(description, properties, tags, new Dictionary<string, BinaryData>(), componentId, computeId, displayName, experimentName, identity, isArchived, JobType.Pipeline, notificationSetting, secretsConfiguration, services, status, inputs, jobs, outputs, settings, sourceJobId);
        }
        ...
        {
            return new SasCredentialDto(PendingUploadCredentialType.Sas, new Dictionary<string, BinaryData>(), sasUri);
        }
        ...
        public static TextClassificationMultilabel TextClassificationMultilabel(MachineLearningLogVerbosity? logVerbosity = null, string targetColumnName = null, MachineLearningTableJobInput trainingData = null, ClassificationMultilabelPrimaryMetric? primaryMetric = null, string featurizationDatasetLanguage = null, NlpFixedParameters fixedParameters = null, NlpVerticalLimitSettings limitSettings = null, IEnumerable<NlpParameterSubspace> searchSpace = null, NlpSweepSettings sweepSettings = null, MachineLearningTableJobInput validationData = null)
        {
            ...
            return new TextClassificationMultilabel(logVerbosity, targetColumnName, TaskType.TextClassificationMultilabel, trainingData, new Dictionary<string, BinaryData>(), primaryMetric, featurizationDatasetLanguage != null ? new NlpVerticalFeaturizationSettings(featurizationDatasetLanguage, new Dictionary<string, BinaryData>()) : null, fixedParameters, limitSettings, searchSpace?.ToList(), sweepSettings, validationData);
        }
        ...
        public static TextNer TextNer(MachineLearningLogVerbosity? logVerbosity = null, string targetColumnName = null, MachineLearningTableJobInput trainingData = null, ClassificationPrimaryMetric? primaryMetric = null, string featurizationDatasetLanguage = null, NlpFixedParameters fixedParameters = null, NlpVerticalLimitSettings limitSettings = null, IEnumerable<NlpParameterSubspace> searchSpace = null, NlpSweepSettings sweepSettings = null, MachineLearningTableJobInput validationData = null)
        {
            ...
            return new TextNer(logVerbosity, targetColumnName, TaskType.TextNER, trainingData, new Dictionary<string, BinaryData>(), primaryMetric, featurizationDatasetLanguage != null ? new NlpVerticalFeaturizationSettings(featurizationDatasetLanguage, new Dictionary<string, BinaryData>()) : null, fixedParameters, limitSettings, searchSpace?.ToList(), sweepSettings, validationData);
        }
        ...
        public static ServiceTagDestination ServiceTagDestination(NetworkingRuleAction? action = null, IEnumerable<string> addressPrefixes = null, string portRanges = null, string protocol = null, string serviceTag = null)
        {
            ...
            return new ServiceTagDestination(action, addressPrefixes?.ToList(), portRanges, protocol, serviceTag, new Dictionary<string, BinaryData>());
        }
    }
}
