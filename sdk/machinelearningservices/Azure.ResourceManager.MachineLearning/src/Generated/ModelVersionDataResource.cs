...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class ModelVersionDataResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ModelVersionDataResource>> UpdateAsync(WaitUntil waitUntil, ModelVersionDataData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _modelVersionDataModelVersionsClientDiagnostics.CreateScope("ModelVersionDataResource.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ModelVersionDataResource> Update(WaitUntil waitUntil, ModelVersionDataData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
