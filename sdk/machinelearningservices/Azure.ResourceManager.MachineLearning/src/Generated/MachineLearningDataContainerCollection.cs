...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningDataContainerCollection : ArmCollection, IEnumerable<MachineLearningDataContainerResource>, IAsyncEnumerable<MachineLearningDataContainerResource>
    {
        ...
        public virtual AsyncPageable<MachineLearningDataContainerResource> GetAllAsync(string skip = null, ListViewType? listViewType = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<MachineLearningDataContainerResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _machineLearningDataContainerDataContainersClientDiagnostics.CreateScope("MachineLearningDataContainerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _machineLearningDataContainerDataContainersRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, skip, listViewType, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningDataContainerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<MachineLearningDataContainerResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _machineLearningDataContainerDataContainersClientDiagnostics.CreateScope("MachineLearningDataContainerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _machineLearningDataContainerDataContainersRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, skip, listViewType, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningDataContainerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<MachineLearningDataContainerResource> GetAll(string skip = null, ListViewType? listViewType = null, CancellationToken cancellationToken = default)
        {
            Page<MachineLearningDataContainerResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _machineLearningDataContainerDataContainersClientDiagnostics.CreateScope("MachineLearningDataContainerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _machineLearningDataContainerDataContainersRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, skip, listViewType, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningDataContainerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<MachineLearningDataContainerResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _machineLearningDataContainerDataContainersClientDiagnostics.CreateScope("MachineLearningDataContainerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _machineLearningDataContainerDataContainersRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, skip, listViewType, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningDataContainerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
