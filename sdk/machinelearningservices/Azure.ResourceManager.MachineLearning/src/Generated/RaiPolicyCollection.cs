...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class RaiPolicyCollection : ArmCollection, IEnumerable<RaiPolicyResource>, IAsyncEnumerable<RaiPolicyResource>
    {
        ...
        internal RaiPolicyCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _raiPoliciesRestClient = new RaiPolicies(_raiPoliciesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, raiPolicyApiVersion ?? "2026-03-15-preview");
        ...
        public virtual async Task<ArmOperation<RaiPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string raiPolicyName, RaiPolicyData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _raiPolicyRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, raiPolicyName, RaiPolicyData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<RaiPolicyResource>> GetAsync(string raiPolicyName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _raiPolicyRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, raiPolicyName, context);
