...
namespace Azure.ResourceManager.MachineLearning
{
    internal partial class ManagedNetworkSettingsGetAllAsyncCollectionResultOfT : AsyncPageable<MachineLearningManagedNetworkSettingsData>
    {
        ...
        public ManagedNetworkSettingsGetAllAsyncCollectionResultOfT(ManagedNetworkSettings client, string subscriptionId, string resourceGroupName, string workspaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
