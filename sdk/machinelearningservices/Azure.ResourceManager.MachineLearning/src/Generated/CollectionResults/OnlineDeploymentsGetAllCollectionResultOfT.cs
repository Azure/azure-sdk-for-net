...
namespace Azure.ResourceManager.MachineLearning
{
    internal partial class OnlineDeploymentsGetAllCollectionResultOfT : Pageable<MachineLearningOnlineDeploymentData>
    {
        ...
        /// <summary> Initializes a new instance of OnlineDeploymentsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of OnlineDeploymentsGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of OnlineDeploymentsGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<MachineLearningOnlineDeploymentData>> AsPages(string continuationToken, int? pageSizeHint)
        {
