...
namespace Azure.ResourceManager.MachineLearning
{
    internal partial class DatastoresGetAllCollectionResultOfT : Pageable<MachineLearningDatastoreData>
    {
        ...
        public override IEnumerable<Page<MachineLearningDatastoreData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetAllRequest(nextLink, _subscriptionId, _resourceGroupName, _workspaceName, _skip, _count, _isDefault, _names, _searchText, _orderBy, _orderByAsc, _context) : _client.CreateGetAllRequest(_subscriptionId, _resourceGroupName, _workspaceName, _skip, _count, _isDefault, _names, _searchText, _orderBy, _orderByAsc, _context);
