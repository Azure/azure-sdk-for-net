...
namespace Azure.ResourceManager.MachineLearning
{
    internal partial class ManagedNetworkSettingsRuleGetAllAsyncCollectionResultOfT : AsyncPageable<MachineLearningOutboundRuleBasicData>
    {
        ...
        /// <summary> Initializes a new instance of ManagedNetworkSettingsRuleGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of ManagedNetworkSettingsRuleGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ManagedNetworkSettingsRuleGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<MachineLearningOutboundRuleBasicData>> AsPages(string continuationToken, int? pageSizeHint)
        {
