...
namespace Azure.ResourceManager.MachineLearning
{
    internal partial class EndpointDeploymentGetInWorkspaceCollectionResultOfT : Pageable<EndpointDeploymentResourcePropertiesBasicResourceData>
    {
        ...
        /// <summary> Initializes a new instance of EndpointDeploymentGetInWorkspaceCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of EndpointDeploymentGetInWorkspaceCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetInWorkspaceRequest(nextLink, _subscriptionId, _resourceGroupName, _workspaceName, _endpointType, _skip, _context) : _client.CreateGetInWorkspaceRequest(_subscriptionId, _resourceGroupName, _workspaceName, _endpointType, _skip, _context);
