...
namespace Azure.ResourceManager.MachineLearning
{
    internal partial class WorkspaceConnectionsGetAllCollectionResultOfT : Pageable<MachineLearningWorkspaceConnectionData>
    {
        ...
        /// <summary> Initializes a new instance of WorkspaceConnectionsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The WorkspaceConnections client used to send requests. </param>
        ...
        /// <summary> Gets the pages of WorkspaceConnectionsGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of WorkspaceConnectionsGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<MachineLearningWorkspaceConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetAllRequest(nextLink, _subscriptionId, _resourceGroupName, _workspaceName, _target, _category, _includeAll, _context) : _client.CreateGetAllRequest(_subscriptionId, _resourceGroupName, _workspaceName, _target, _category, _includeAll, _context);
