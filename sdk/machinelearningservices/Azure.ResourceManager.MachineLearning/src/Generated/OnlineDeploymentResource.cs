    ...
    public partial class OnlineDeploymentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MachineLearningArmOperation(_onlineDeploymentClientDiagnostics, Pipeline, _onlineDeploymentRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.NotSpecified);
        ...
        public virtual async Task<ArmOperation<OnlineDeploymentResource>> UpdateAsync(WaitUntil waitUntil, OnlineDeploymentPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MachineLearningArmOperation<OnlineDeploymentResource>(new OnlineDeploymentOperationSource(Client), _onlineDeploymentClientDiagnostics, Pipeline, _onlineDeploymentRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.NotSpecified);
                if (waitUntil == WaitUntil.Completed)
