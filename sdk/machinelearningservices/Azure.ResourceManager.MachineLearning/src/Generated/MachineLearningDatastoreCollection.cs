...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningDatastoreCollection : ArmCollection, IEnumerable<MachineLearningDatastoreResource>, IAsyncEnumerable<MachineLearningDatastoreResource>
    {
        ...
        internal MachineLearningDatastoreCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _datastoresRestClient = new Datastores(_datastoresClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, machineLearningDatastoreApiVersion ?? "2026-07-01");
        ...
        public virtual async Task<ArmOperation<MachineLearningDatastoreResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, MachineLearningDatastoreData data, bool? skipValidation = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _datastoresRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, MachineLearningDatastoreData.ToRequestContent(data), skipValidation, context);
        ...
        public virtual async Task<Response<MachineLearningDatastoreResource>> GetAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _datastoresRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<MachineLearningDatastoreData> response = Response.FromValue(MachineLearningDatastoreData.FromResponse(result), result);
