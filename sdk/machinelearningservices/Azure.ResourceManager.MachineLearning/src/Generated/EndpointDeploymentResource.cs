...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="EndpointResourcePropertiesBasicResource"/> using the GetEndpointDeployments method.
    /// </summary>
    public partial class EndpointDeploymentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _endpointDeploymentRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
