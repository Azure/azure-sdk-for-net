...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningComponentContainerCollection : ArmCollection, IEnumerable<MachineLearningComponentContainerResource>, IAsyncEnumerable<MachineLearningComponentContainerResource>
    {
        ...
        public virtual AsyncPageable<MachineLearningComponentContainerResource> GetAllAsync(string skip = null, ListViewType? listViewType = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<MachineLearningComponentContainerResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _machineLearningComponentContainerComponentContainersClientDiagnostics.CreateScope("MachineLearningComponentContainerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _machineLearningComponentContainerComponentContainersRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, skip, listViewType, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningComponentContainerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<MachineLearningComponentContainerResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _machineLearningComponentContainerComponentContainersClientDiagnostics.CreateScope("MachineLearningComponentContainerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _machineLearningComponentContainerComponentContainersRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, skip, listViewType, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningComponentContainerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<MachineLearningComponentContainerResource> GetAll(string skip = null, ListViewType? listViewType = null, CancellationToken cancellationToken = default)
        {
            Page<MachineLearningComponentContainerResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _machineLearningComponentContainerComponentContainersClientDiagnostics.CreateScope("MachineLearningComponentContainerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _machineLearningComponentContainerComponentContainersRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, skip, listViewType, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningComponentContainerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<MachineLearningComponentContainerResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _machineLearningComponentContainerComponentContainersClientDiagnostics.CreateScope("MachineLearningComponentContainerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _machineLearningComponentContainerComponentContainersRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, skip, listViewType, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningComponentContainerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
