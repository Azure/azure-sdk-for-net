...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class RaiBlocklistItemCollection : ArmCollection, IEnumerable<RaiBlocklistItemResource>, IAsyncEnumerable<RaiBlocklistItemResource>
    {
        ...
        internal RaiBlocklistItemCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _connectionRaiBlocklistItemRestClient = new ConnectionRaiBlocklistItem(_connectionRaiBlocklistItemClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, raiBlocklistItemApiVersion ?? "2026-03-15-preview");
            ...
            _connectionRaiBlocklistItemsRestClient = new ConnectionRaiBlocklistItems(_connectionRaiBlocklistItemsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, raiBlocklistItemApiVersion ?? "2026-03-15-preview");
        ...
        public virtual async Task<ArmOperation<RaiBlocklistItemResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string raiBlocklistItemName, RaiBlocklistItemData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _connectionRaiBlocklistItemRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, raiBlocklistItemName, RaiBlocklistItemData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<RaiBlocklistItemResource>> GetAsync(string raiBlocklistItemName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _connectionRaiBlocklistItemRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, raiBlocklistItemName, context);
