    ...
    public partial class MachineLearningJobCollection : ArmCollection, IEnumerable<MachineLearningJobResource>, IAsyncEnumerable<MachineLearningJobResource>
    {
        ...
        public virtual AsyncPageable<MachineLearningJobResource> GetAllAsync(MachineLearningJobCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<MachineLearningJobResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _machineLearningJobJobsRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Skip, options.JobType, options.Tag, options.ListViewType, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<MachineLearningJobResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _machineLearningJobJobsRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Skip, options.JobType, options.Tag, options.ListViewType, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningJobResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<MachineLearningJobResource> GetAll(MachineLearningJobCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            Page<MachineLearningJobResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _machineLearningJobJobsRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Skip, options.JobType, options.Tag, options.ListViewType, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningJobResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<MachineLearningJobResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _machineLearningJobJobsRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Skip, options.JobType, options.Tag, options.ListViewType, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningJobResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
