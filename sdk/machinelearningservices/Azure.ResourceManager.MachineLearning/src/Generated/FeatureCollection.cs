...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    /// Each <see cref="FeatureResource" /> in the collection will belong to the same instance of <see cref="FeaturesetVersionResource" />.
    /// To get a <see cref="FeatureCollection" /> instance call the GetFeatures method from an instance of <see cref="FeaturesetVersionResource" />.
    /// </summary>
    public partial class FeatureCollection : ArmCollection, IEnumerable<FeatureResource>, IAsyncEnumerable<FeatureResource>
    {
        ...
        {
            _featureClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MachineLearning", FeatureResource.ResourceType.Namespace, Diagnostics);
        ...
        {
            if (id.ResourceType != FeaturesetVersionResource.ResourceType)
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid resource type {0} expected {1}", id.ResourceType, FeaturesetVersionResource.ResourceType), nameof(id));
        }
        ...
        public virtual async Task<Response<FeatureResource>> GetAsync(string featureName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _featureRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, featureName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<FeatureResource> Get(string featureName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _featureRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, featureName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new FeatureResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual AsyncPageable<FeatureResource> GetAllAsync(string skip = null, string tags = null, string featureName = null, string description = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _featureRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, skip, tags, featureName, description);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _featureRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, skip, tags, featureName, description);
        ...
        public virtual Pageable<FeatureResource> GetAll(string skip = null, string tags = null, string featureName = null, string description = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _featureRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, skip, tags, featureName, description);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _featureRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, skip, tags, featureName, description);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string featureName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _featureRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, featureName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string featureName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _featureRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, featureName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
