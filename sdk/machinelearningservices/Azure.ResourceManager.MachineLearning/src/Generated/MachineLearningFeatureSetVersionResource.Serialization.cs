...
namespace Azure.ResourceManager.MachineLearning
{
    public partial class MachineLearningFeatureSetVersionResource : IJsonModel<MachineLearningFeatureSetVersionData>
    {
        ...
        BinaryData IPersistableModel<MachineLearningFeatureSetVersionData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        MachineLearningFeatureSetVersionData IPersistableModel<MachineLearningFeatureSetVersionData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<MachineLearningFeatureSetVersionData>(data, options);
