...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningOnlineEndpointCollection : ArmCollection, IEnumerable<MachineLearningOnlineEndpointResource>, IAsyncEnumerable<MachineLearningOnlineEndpointResource>
    {
        ...
        /// <summary> Initializes a new instance of MachineLearningOnlineEndpointCollection for mocking. </summary>
        protected MachineLearningOnlineEndpointCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MachineLearningOnlineEndpointCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(MachineLearningOnlineEndpointResource.ResourceType, out string machineLearningOnlineEndpointApiVersion);
            _onlineEndpointsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MachineLearning", MachineLearningOnlineEndpointResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<MachineLearningOnlineEndpointResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string endpointName, MachineLearningOnlineEndpointData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _onlineEndpointsClientDiagnostics.CreateScope("MachineLearningOnlineEndpointCollection.CreateOrUpdate");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<MachineLearningOnlineEndpointResource>> GetAsync(string endpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _onlineEndpointsClientDiagnostics.CreateScope("MachineLearningOnlineEndpointCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<MachineLearningOnlineEndpointResource> GetAllAsync(string name = default, int? count = default, MachineLearningEndpointComputeType? computeType = default, string skip = default, string tags = default, string properties = default, MachineLearningOrderString? orderBy = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<MachineLearningOnlineEndpointData, MachineLearningOnlineEndpointResource>(new OnlineEndpointsGetAllAsyncCollectionResultOfT(
                ...
                orderBy?.ToString(),
                context,
                "MachineLearningOnlineEndpointCollection.GetAll"), data => new MachineLearningOnlineEndpointResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="MachineLearningOnlineEndpointResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<MachineLearningOnlineEndpointResource> GetAll(string name = default, int? count = default, MachineLearningEndpointComputeType? computeType = default, string skip = default, string tags = default, string properties = default, MachineLearningOrderString? orderBy = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string endpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _onlineEndpointsClientDiagnostics.CreateScope("MachineLearningOnlineEndpointCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                {
                    case 200:
                        response = Response.FromValue(MachineLearningOnlineEndpointData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((MachineLearningOnlineEndpointData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<MachineLearningOnlineEndpointResource>> GetIfExistsAsync(string endpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _onlineEndpointsClientDiagnostics.CreateScope("MachineLearningOnlineEndpointCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
