...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class DataVersionCollection : ArmCollection, IEnumerable<DataVersionResource>, IAsyncEnumerable<DataVersionResource>
    {
        ...
        public virtual AsyncPageable<DataVersionResource> GetAllAsync(DataVersionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<DataVersionResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _dataVersionRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.OrderBy, options.Top, options.Skip, options.Tags, options.ListViewType, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<DataVersionResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _dataVersionRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.OrderBy, options.Top, options.Skip, options.Tags, options.ListViewType, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DataVersionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<DataVersionResource> GetAll(DataVersionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new DataVersionGetAllOptions();
            ...
            Page<DataVersionResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _dataVersionRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.OrderBy, options.Top, options.Skip, options.Tags, options.ListViewType, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DataVersionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<DataVersionResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _dataVersionRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.OrderBy, options.Top, options.Skip, options.Tags, options.ListViewType, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DataVersionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
