...
{
    /// <summary></summary>
    internal partial class MachineLearningRegistryResourceOperationSource : IOperationSource<MachineLearningRegistryResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningRegistryResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        MachineLearningRegistryResource IOperationSource<MachineLearningRegistryResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MachineLearningRegistryData data = MachineLearningRegistryData.DeserializeMachineLearningRegistryData(document.RootElement, ModelSerializationExtensions.WireOptions);
