...
{
    /// <summary></summary>
    internal partial class MachineLearningRegistryDataContainerResourceOperationSource : IOperationSource<MachineLearningRegistryDataContainerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningRegistryDataContainerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        MachineLearningRegistryDataContainerResource IOperationSource<MachineLearningRegistryDataContainerResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MachineLearningDataContainerData data = MachineLearningDataContainerData.DeserializeMachineLearningDataContainerData(document.RootElement, ModelSerializationExtensions.WireOptions);
