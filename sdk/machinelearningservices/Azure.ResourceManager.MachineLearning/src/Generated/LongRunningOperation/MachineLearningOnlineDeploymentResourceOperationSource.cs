...
{
    /// <summary></summary>
    internal partial class MachineLearningOnlineDeploymentResourceOperationSource : IOperationSource<MachineLearningOnlineDeploymentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningOnlineDeploymentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        MachineLearningOnlineDeploymentResource IOperationSource<MachineLearningOnlineDeploymentResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MachineLearningOnlineDeploymentData data = MachineLearningOnlineDeploymentData.DeserializeMachineLearningOnlineDeploymentData(document.RootElement, ModelSerializationExtensions.WireOptions);
