...
{
    /// <summary></summary>
    internal partial class MachineLearningBatchEndpointResourceOperationSource : IOperationSource<MachineLearningBatchEndpointResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningBatchEndpointResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        MachineLearningBatchEndpointResource IOperationSource<MachineLearningBatchEndpointResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MachineLearningBatchEndpointData data = MachineLearningBatchEndpointData.DeserializeMachineLearningBatchEndpointData(document.RootElement, ModelSerializationExtensions.WireOptions);
