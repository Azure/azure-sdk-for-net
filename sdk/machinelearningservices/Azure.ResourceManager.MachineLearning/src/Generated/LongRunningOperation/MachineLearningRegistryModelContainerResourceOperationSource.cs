...
{
    /// <summary></summary>
    internal partial class MachineLearningRegistryModelContainerResourceOperationSource : IOperationSource<MachineLearningRegistryModelContainerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningRegistryModelContainerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        MachineLearningRegistryModelContainerResource IOperationSource<MachineLearningRegistryModelContainerResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MachineLearningModelContainerData data = MachineLearningModelContainerData.DeserializeMachineLearningModelContainerData(document.RootElement, ModelSerializationExtensions.WireOptions);
