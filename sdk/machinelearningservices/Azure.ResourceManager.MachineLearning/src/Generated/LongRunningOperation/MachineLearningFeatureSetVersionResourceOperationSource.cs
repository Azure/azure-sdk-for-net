...
{
    /// <summary></summary>
    internal partial class MachineLearningFeatureSetVersionResourceOperationSource : IOperationSource<MachineLearningFeatureSetVersionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningFeatureSetVersionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        MachineLearningFeatureSetVersionResource IOperationSource<MachineLearningFeatureSetVersionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MachineLearningFeatureSetVersionData data = MachineLearningFeatureSetVersionData.DeserializeMachineLearningFeatureSetVersionData(document.RootElement, ModelSerializationExtensions.WireOptions);
