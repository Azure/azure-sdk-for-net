...
{
    /// <summary></summary>
    internal partial class MachineLearningOutboundRuleBasicResourceOperationSource : IOperationSource<MachineLearningOutboundRuleBasicResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningOutboundRuleBasicResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
