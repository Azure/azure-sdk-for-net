...
{
    /// <summary></summary>
    internal partial class MachineLearningFeaturestoreEntityVersionResourceOperationSource : IOperationSource<MachineLearningFeaturestoreEntityVersionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningFeaturestoreEntityVersionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        MachineLearningFeaturestoreEntityVersionResource IOperationSource<MachineLearningFeaturestoreEntityVersionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MachineLearningFeaturestoreEntityVersionData data = MachineLearningFeaturestoreEntityVersionData.DeserializeMachineLearningFeaturestoreEntityVersionData(document.RootElement, ModelSerializationExtensions.WireOptions);
