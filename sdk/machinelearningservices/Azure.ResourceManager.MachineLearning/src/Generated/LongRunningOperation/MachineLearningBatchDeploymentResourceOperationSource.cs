...
{
    /// <summary></summary>
    internal partial class MachineLearningBatchDeploymentResourceOperationSource : IOperationSource<MachineLearningBatchDeploymentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningBatchDeploymentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        MachineLearningBatchDeploymentResource IOperationSource<MachineLearningBatchDeploymentResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MachineLearningBatchDeploymentData data = MachineLearningBatchDeploymentData.DeserializeMachineLearningBatchDeploymentData(document.RootElement, ModelSerializationExtensions.WireOptions);
