...
{
    /// <summary></summary>
    internal partial class ManagedNetworkOutboundRuleBasicResourceOperationSource : IOperationSource<ManagedNetworkOutboundRuleBasicResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedNetworkOutboundRuleBasicResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
