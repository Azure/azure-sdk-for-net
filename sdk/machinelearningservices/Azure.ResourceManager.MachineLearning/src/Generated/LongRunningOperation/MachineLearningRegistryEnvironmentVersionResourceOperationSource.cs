...
{
    /// <summary></summary>
    internal partial class MachineLearningRegistryEnvironmentVersionResourceOperationSource : IOperationSource<MachineLearningRegistryEnvironmentVersionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningRegistryEnvironmentVersionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        MachineLearningRegistryEnvironmentVersionResource IOperationSource<MachineLearningRegistryEnvironmentVersionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MachineLearningEnvironmentVersionData data = MachineLearningEnvironmentVersionData.DeserializeMachineLearningEnvironmentVersionData(document.RootElement, ModelSerializationExtensions.WireOptions);
