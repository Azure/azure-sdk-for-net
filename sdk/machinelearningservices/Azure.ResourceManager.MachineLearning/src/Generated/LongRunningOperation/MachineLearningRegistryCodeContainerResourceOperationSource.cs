...
{
    /// <summary></summary>
    internal partial class MachineLearningRegistryCodeContainerResourceOperationSource : IOperationSource<MachineLearningRegistryCodeContainerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningRegistryCodeContainerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        MachineLearningRegistryCodeContainerResource IOperationSource<MachineLearningRegistryCodeContainerResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MachineLearningCodeContainerData data = MachineLearningCodeContainerData.DeserializeMachineLearningCodeContainerData(document.RootElement, ModelSerializationExtensions.WireOptions);
