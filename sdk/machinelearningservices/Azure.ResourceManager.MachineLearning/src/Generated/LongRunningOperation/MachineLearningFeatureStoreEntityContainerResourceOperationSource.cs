...
{
    /// <summary></summary>
    internal partial class MachineLearningFeatureStoreEntityContainerResourceOperationSource : IOperationSource<MachineLearningFeatureStoreEntityContainerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MachineLearningFeatureStoreEntityContainerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        MachineLearningFeatureStoreEntityContainerResource IOperationSource<MachineLearningFeatureStoreEntityContainerResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MachineLearningFeatureStoreEntityContainerData data = MachineLearningFeatureStoreEntityContainerData.DeserializeMachineLearningFeatureStoreEntityContainerData(document.RootElement, ModelSerializationExtensions.WireOptions);
