...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="EndpointResourcePropertiesBasicResource"/> using the GetRaiPolicies method.
    /// </summary>
    public partial class RaiPolicyResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _raiPolicyRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
