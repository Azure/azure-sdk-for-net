...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningServerlessEndpointCollection : ArmCollection, IEnumerable<MachineLearningServerlessEndpointResource>, IAsyncEnumerable<MachineLearningServerlessEndpointResource>
    {
        ...
        /// <summary> Initializes a new instance of MachineLearningServerlessEndpointCollection for mocking. </summary>
        protected MachineLearningServerlessEndpointCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MachineLearningServerlessEndpointCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(MachineLearningServerlessEndpointResource.ResourceType, out string machineLearningServerlessEndpointApiVersion);
            _serverlessEndpointsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MachineLearning", MachineLearningServerlessEndpointResource.ResourceType.Namespace, Diagnostics);
            _serverlessEndpointsRestClient = new ServerlessEndpoints(_serverlessEndpointsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, machineLearningServerlessEndpointApiVersion ?? "2026-07-01");
        ...
        public virtual async Task<ArmOperation<MachineLearningServerlessEndpointResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, MachineLearningServerlessEndpointData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serverlessEndpointsClientDiagnostics.CreateScope("MachineLearningServerlessEndpointCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _serverlessEndpointsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, MachineLearningServerlessEndpointData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<MachineLearningServerlessEndpointResource>> GetAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serverlessEndpointsClientDiagnostics.CreateScope("MachineLearningServerlessEndpointCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _serverlessEndpointsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, context);
        ...
        public virtual AsyncPageable<MachineLearningServerlessEndpointResource> GetAllAsync(string skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<MachineLearningServerlessEndpointData, MachineLearningServerlessEndpointResource>(new ServerlessEndpointsGetAllAsyncCollectionResultOfT(
                ...
                skip,
                context,
                "MachineLearningServerlessEndpointCollection.GetAll"), data => new MachineLearningServerlessEndpointResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="MachineLearningServerlessEndpointResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<MachineLearningServerlessEndpointResource> GetAll(string skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serverlessEndpointsClientDiagnostics.CreateScope("MachineLearningServerlessEndpointCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<MachineLearningServerlessEndpointData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(MachineLearningServerlessEndpointData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((MachineLearningServerlessEndpointData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<MachineLearningServerlessEndpointResource>> GetIfExistsAsync(string name, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serverlessEndpointsClientDiagnostics.CreateScope("MachineLearningServerlessEndpointCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
