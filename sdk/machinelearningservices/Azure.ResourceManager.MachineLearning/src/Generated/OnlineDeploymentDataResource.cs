...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class OnlineDeploymentDataResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<OnlineDeploymentDataResource>> UpdateAsync(WaitUntil waitUntil, OnlineDeploymentDataPatch patch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<OnlineDeploymentDataResource> Update(WaitUntil waitUntil, OnlineDeploymentDataPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
