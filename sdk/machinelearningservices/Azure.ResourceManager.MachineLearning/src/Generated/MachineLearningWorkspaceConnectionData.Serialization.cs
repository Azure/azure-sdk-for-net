...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningWorkspaceConnectionData : ResourceData, IJsonModel<MachineLearningWorkspaceConnectionData>
    {
        ...
        /// <param name="machineLearningWorkspaceConnectionData"> The <see cref="MachineLearningWorkspaceConnectionData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(MachineLearningWorkspaceConnectionData machineLearningWorkspaceConnectionData)
        {
            if (machineLearningWorkspaceConnectionData == null)
            {
                return null;
            }
            return RequestContent.Create(machineLearningWorkspaceConnectionData, ModelSerializationExtensions.WireOptions);
        }
