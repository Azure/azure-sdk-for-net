...
{
    public partial class MachineLearningWorkspaceConnectionData : IUtf8JsonSerializable, IJsonModel<MachineLearningWorkspaceConnectionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningWorkspaceConnectionData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<MachineLearningWorkspaceConnectionData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static MachineLearningWorkspaceConnectionData DeserializeMachineLearningWorkspaceConnectionData(JsonElement element, ModelReaderWriterOptions options = null)
        {
