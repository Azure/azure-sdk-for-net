...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningEnvironmentVersionCollection : ArmCollection, IEnumerable<MachineLearningEnvironmentVersionResource>, IAsyncEnumerable<MachineLearningEnvironmentVersionResource>
    {
        ...
        public virtual AsyncPageable<MachineLearningEnvironmentVersionResource> GetAllAsync(MachineLearningEnvironmentVersionCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new MachineLearningEnvironmentVersionCollectionGetAllOptions();

            async Task<Page<MachineLearningEnvironmentVersionResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _machineLearningEnvironmentVersionEnvironmentVersionsClientDiagnostics.CreateScope("MachineLearningEnvironmentVersionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _machineLearningEnvironmentVersionEnvironmentVersionsRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.OrderBy, options.Top, options.Skip, options.ListViewType, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningEnvironmentVersionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<MachineLearningEnvironmentVersionResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _machineLearningEnvironmentVersionEnvironmentVersionsClientDiagnostics.CreateScope("MachineLearningEnvironmentVersionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _machineLearningEnvironmentVersionEnvironmentVersionsRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.OrderBy, options.Top, options.Skip, options.ListViewType, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningEnvironmentVersionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<MachineLearningEnvironmentVersionResource> GetAll(MachineLearningEnvironmentVersionCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new MachineLearningEnvironmentVersionCollectionGetAllOptions();

            Page<MachineLearningEnvironmentVersionResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _machineLearningEnvironmentVersionEnvironmentVersionsClientDiagnostics.CreateScope("MachineLearningEnvironmentVersionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _machineLearningEnvironmentVersionEnvironmentVersionsRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.OrderBy, options.Top, options.Skip, options.ListViewType, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningEnvironmentVersionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<MachineLearningEnvironmentVersionResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _machineLearningEnvironmentVersionEnvironmentVersionsClientDiagnostics.CreateScope("MachineLearningEnvironmentVersionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _machineLearningEnvironmentVersionEnvironmentVersionsRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.OrderBy, options.Top, options.Skip, options.ListViewType, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MachineLearningEnvironmentVersionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
