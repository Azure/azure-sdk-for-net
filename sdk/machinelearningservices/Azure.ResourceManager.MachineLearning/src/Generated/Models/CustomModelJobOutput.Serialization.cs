...
{
    public partial class CustomModelJobOutput : IUtf8JsonSerializable
    {
        ...
        internal static CustomModelJobOutput DeserializeCustomModelJobOutput(JsonElement element)
        {
            ...
            return new CustomModelJobOutput(description.Value, jobOutputType, Optional.ToNullable(mode), uri.Value);
        }
    }
}
