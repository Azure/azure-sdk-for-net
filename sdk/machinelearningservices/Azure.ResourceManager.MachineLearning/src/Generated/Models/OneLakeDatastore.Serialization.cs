...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OneLakeDatastore>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OneLakeDatastore>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OneLakeDatastore>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OneLakeDatastore>)} interface");
            }
        ...
        string IPersistableModel<OneLakeDatastore>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
