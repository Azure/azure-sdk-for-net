...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class CocoExportSummary : IUtf8JsonSerializable, IJsonModel<CocoExportSummary>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CocoExportSummary>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CocoExportSummary>)} interface");
            }
