...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class CocoExportSummary : IUtf8JsonSerializable, IJsonModel<CocoExportSummary>
    {
        ...
        void IJsonModel<CocoExportSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CocoExportSummary)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CocoExportSummary>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CocoExportSummary)} does not support '{options.Format}' format.");
            }
        }
