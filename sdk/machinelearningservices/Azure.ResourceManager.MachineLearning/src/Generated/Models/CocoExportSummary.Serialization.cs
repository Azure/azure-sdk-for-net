...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class CocoExportSummary : IUtf8JsonSerializable
    {
        ...
        internal static CocoExportSummary DeserializeCocoExportSummary(JsonElement element)
        {
            ...
            return new CocoExportSummary(Optional.ToNullable(endDateTime), Optional.ToNullable(exportedRowCount), format, labelingJobId.Value, Optional.ToNullable(startDateTime), containerName.Value, snapshotPath.Value);
        }
    }
}
