    ...
    public partial class OnlineInferenceConfiguration : IUtf8JsonSerializable, IJsonModel<OnlineInferenceConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EntryScript))
            {
                ...
                if (EntryScript.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(LivenessRoute))
            {
                ...
                AppendChildObject(builder, LivenessRoute, options, 2, false);
            }

            if (Optional.IsDefined(ReadinessRoute))
            {
                builder.Append("  readinessRoute:");
                AppendChildObject(builder, ReadinessRoute, options, 2, false);
            }

            if (Optional.IsDefined(ScoringRoute))
            {
                builder.Append("  scoringRoute:");
                AppendChildObject(builder, ScoringRoute, options, 2, false);
            }
