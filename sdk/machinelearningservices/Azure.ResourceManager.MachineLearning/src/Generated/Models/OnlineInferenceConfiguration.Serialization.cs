...
{
    public partial class OnlineInferenceConfiguration : IUtf8JsonSerializable, IJsonModel<OnlineInferenceConfiguration>, IPersistableModel<OnlineInferenceConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EntryScript))
            {
                builder.Append("  entryScript:");
                builder.AppendLine($" '{EntryScript}'");
            }

            if (Optional.IsDefined(LivenessRoute))
            {
                builder.Append("  livenessRoute:");
                AppendChildObject(builder, LivenessRoute, options, 2);
            }

            if (Optional.IsDefined(ReadinessRoute))
            {
                builder.Append("  readinessRoute:");
                AppendChildObject(builder, ReadinessRoute, options, 2);
            }

            if (Optional.IsDefined(ScoringRoute))
            {
                builder.Append("  scoringRoute:");
                AppendChildObject(builder, ScoringRoute, options, 2);
            }
