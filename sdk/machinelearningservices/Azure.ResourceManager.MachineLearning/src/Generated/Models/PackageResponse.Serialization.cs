...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        internal static PackageResponse DeserializePackageResponse(JsonElement element)
        {
            ...
            return new PackageResponse(baseEnvironmentSource.Value, buildId.Value, Optional.ToNullable(buildState), Optional.ToDictionary(environmentVariables), inferencingServer.Value, Optional.ToList(inputs), logUrl.Value, modelConfiguration.Value, Optional.ToDictionary(tags), targetEnvironmentId.Value);
        }
    }
}
