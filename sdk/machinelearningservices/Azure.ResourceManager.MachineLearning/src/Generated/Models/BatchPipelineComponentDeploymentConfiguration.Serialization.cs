...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchPipelineComponentDeploymentConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchPipelineComponentDeploymentConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchPipelineComponentDeploymentConfiguration>)} interface");
            }
        ...
        string IPersistableModel<BatchPipelineComponentDeploymentConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
