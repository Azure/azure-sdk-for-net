...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningUserAccountCredentials
    {
        ...
        internal MachineLearningUserAccountCredentials(string adminUserName, string adminUserSshPublicKey, string adminUserPassword, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AdminUserName = adminUserName;
