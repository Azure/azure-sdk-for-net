...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningUsage : IUtf8JsonSerializable, IJsonModel<MachineLearningUsage>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningUsage>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningUsage>)} interface");
            }
