...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PendingUploadResponseDto>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PendingUploadResponseDto>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PendingUploadResponseDto>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PendingUploadResponseDto>)} interface");
            }
        ...
        string IPersistableModel<PendingUploadResponseDto>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
