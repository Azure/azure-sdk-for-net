...
{
    public partial class PendingUploadResponseDto : IUtf8JsonSerializable, IJsonModel<PendingUploadResponseDto>, IPersistableModel<PendingUploadResponseDto>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BlobReferenceForConsumption))
            {
                ...
                AppendChildObject(builder, BlobReferenceForConsumption, options, 2);
            }
            ...
            if (Optional.IsDefined(PendingUploadType))
            {
                ...
                builder.AppendLine($" '{PendingUploadType.ToString()}'");
            }
