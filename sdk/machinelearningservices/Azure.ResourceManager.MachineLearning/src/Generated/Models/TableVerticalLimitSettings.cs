...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class TableVerticalLimitSettings
    {
        ...
        internal TableVerticalLimitSettings(bool? enableEarlyTermination, double? exitScore, int? maxConcurrentTrials, int? maxCoresPerTrial, int? maxTrials, TimeSpan? timeout, TimeSpan? trialTimeout, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
