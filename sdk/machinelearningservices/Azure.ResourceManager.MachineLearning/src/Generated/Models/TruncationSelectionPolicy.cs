...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class TruncationSelectionPolicy : MachineLearningEarlyTerminationPolicy
    {
        ...
        internal TruncationSelectionPolicy(int? delayEvaluation, int? evaluationInterval, EarlyTerminationPolicyType policyType, int? truncationPercentage, Dictionary<string, BinaryData> rawData) : base(delayEvaluation, evaluationInterval, policyType, rawData)
        {
