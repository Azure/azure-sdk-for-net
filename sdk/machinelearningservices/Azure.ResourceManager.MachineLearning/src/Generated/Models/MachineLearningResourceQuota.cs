...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningResourceQuota
    {
        ...
        internal MachineLearningResourceQuota(string id, string amlWorkspaceLocation, string resourceQuotaType, MachineLearningResourceName name, long? limit, MachineLearningQuotaUnit? unit, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
