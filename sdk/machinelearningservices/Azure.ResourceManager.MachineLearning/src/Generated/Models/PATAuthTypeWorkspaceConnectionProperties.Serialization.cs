...
{
    public partial class PATAuthTypeWorkspaceConnectionProperties : IUtf8JsonSerializable
    {
        ...
        internal static PATAuthTypeWorkspaceConnectionProperties DeserializePATAuthTypeWorkspaceConnectionProperties(JsonElement element)
        {
            ...
            return new PATAuthTypeWorkspaceConnectionProperties(authType, Optional.ToNullable(category), target.Value, value.Value, Optional.ToNullable(valueFormat), credentials.Value);
        }
    }
}
