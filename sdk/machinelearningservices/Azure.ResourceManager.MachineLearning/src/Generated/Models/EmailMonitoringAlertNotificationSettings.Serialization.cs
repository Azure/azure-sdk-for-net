...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmailMonitoringAlertNotificationSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EmailMonitoringAlertNotificationSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EmailMonitoringAlertNotificationSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EmailMonitoringAlertNotificationSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
