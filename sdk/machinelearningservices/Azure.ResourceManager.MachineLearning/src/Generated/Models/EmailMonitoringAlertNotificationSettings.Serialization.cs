...
{
    public partial class EmailMonitoringAlertNotificationSettings : IUtf8JsonSerializable, IJsonModel<EmailMonitoringAlertNotificationSettings>, IPersistableModel<EmailMonitoringAlertNotificationSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EmailNotificationSetting))
            {
                builder.Append("  emailNotificationSetting:");
                AppendChildObject(builder, EmailNotificationSetting, options, 2);
            }
