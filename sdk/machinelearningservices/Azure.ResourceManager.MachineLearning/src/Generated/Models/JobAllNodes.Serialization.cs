...
{
    public partial class JobAllNodes : IUtf8JsonSerializable, IJsonModel<JobAllNodes>, IPersistableModel<JobAllNodes>
    {
        ...
        void IJsonModel<JobAllNodes>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JobAllNodes)} does not support '{format}' format.");
            }
