...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedNetworkProvisionContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedNetworkProvisionContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedNetworkProvisionContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedNetworkProvisionContent>)} interface");
            }
        ...
        string IPersistableModel<ManagedNetworkProvisionContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
