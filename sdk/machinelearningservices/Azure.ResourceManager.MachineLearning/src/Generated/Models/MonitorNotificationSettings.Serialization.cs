...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class MonitorNotificationSettings : IUtf8JsonSerializable, IJsonModel<MonitorNotificationSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  emailNotificationSettings: ");
                builder.AppendLine("{");
            ...
            else
            {
                ...
                {
                    builder.Append("  emailNotificationSettings: ");
                    BicepSerializationHelpers.AppendChildObject(builder, EmailNotificationSettings, options, 2, false, "  emailNotificationSettings: ");
                }
            }
