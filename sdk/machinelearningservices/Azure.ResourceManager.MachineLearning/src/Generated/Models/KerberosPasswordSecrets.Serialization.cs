...
{
    public partial class KerberosPasswordSecrets : IUtf8JsonSerializable, IJsonModel<KerberosPasswordSecrets>, IPersistableModel<KerberosPasswordSecrets>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KerberosPassword))
            {
                builder.Append("  kerberosPassword:");
                builder.AppendLine($" '{KerberosPassword}'");
            }
