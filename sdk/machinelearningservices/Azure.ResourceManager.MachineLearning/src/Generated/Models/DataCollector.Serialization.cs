...
{
    public partial class DataCollector : IUtf8JsonSerializable, IJsonModel<DataCollector>, IPersistableModel<DataCollector>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RequestLogging))
            {
                ...
                AppendChildObject(builder, RequestLogging, options, 2);
            }

            if (Optional.IsDefined(RollingRate))
            {
                builder.Append("  rollingRate:");
                builder.AppendLine($" '{RollingRate.ToString()}'");
            }
