...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class DataCollector : IJsonModel<DataCollector>
    {
        ...
        protected virtual DataCollector PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataCollector>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DataCollector>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DataCollector IPersistableModel<DataCollector>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataCollector IJsonModel<DataCollector>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DataCollector JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataCollector>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DataCollector DeserializeDataCollector(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("collections"u8))
                {
                    ...
                    {
                        dictionary.Add(prop0.Name, DataCollectionConfiguration.DeserializeDataCollectionConfiguration(prop0.Value, options));
                    }
                ...
                if (prop.NameEquals("requestLogging"u8))
                {
                    ...
                    requestLogging = RequestLogging.DeserializeRequestLogging(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("rollingRate"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    rollingRate = new RollingRateType(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
