...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClassificationTrainingSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClassificationTrainingSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClassificationTrainingSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClassificationTrainingSettings>)} interface");
            }
        ...
        string IPersistableModel<ClassificationTrainingSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
