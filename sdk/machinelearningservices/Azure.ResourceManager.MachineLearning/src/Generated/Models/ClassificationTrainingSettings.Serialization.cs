...
{
    public partial class ClassificationTrainingSettings : Core.IUtf8JsonSerializable
    {
        ...
        internal static ClassificationTrainingSettings DeserializeClassificationTrainingSettings(JsonElement element)
        {
            ...
            Core.Optional<IList<ClassificationModel>> allowedTrainingAlgorithms = default;
            Core.Optional<IList<ClassificationModel>> blockedTrainingAlgorithms = default;
            ...
            return new ClassificationTrainingSettings(Core.Optional.ToNullable(enableDnnTraining), Core.Optional.ToNullable(enableModelExplainability), Core.Optional.ToNullable(enableOnnxCompatibleModels), Core.Optional.ToNullable(enableStackEnsemble), Core.Optional.ToNullable(enableVoteEnsemble), Core.Optional.ToNullable(ensembleModelDownloadTimeout), stackEnsembleSettings.Value, Core.Optional.ToList(allowedTrainingAlgorithms), Core.Optional.ToList(blockedTrainingAlgorithms));
        }
    }
}
