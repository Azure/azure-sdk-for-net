...
{
    internal partial class UnknownMonitoringSignalBase : MonitoringSignalBase, IJsonModel<MonitoringSignalBase>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMonitoringSignalBase DeserializeUnknownMonitoringSignalBase(JsonElement element, ModelReaderWriterOptions options)
        {
