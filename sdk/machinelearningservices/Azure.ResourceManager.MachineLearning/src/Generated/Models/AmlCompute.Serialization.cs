...
{
    public partial class AmlCompute : Core.IUtf8JsonSerializable
    {
        ...
        internal static AmlCompute DeserializeAmlCompute(JsonElement element)
        {
            ...
            Core.Optional<AmlComputeProperties> properties = default;
            ...
            return new AmlCompute(computeType, computeLocation.Value, Core.Optional.ToNullable(provisioningState), description.Value, Core.Optional.ToNullable(createdOn), Core.Optional.ToNullable(modifiedOn), resourceId.Value, Core.Optional.ToList(provisioningErrors), Core.Optional.ToNullable(isAttachedCompute), Core.Optional.ToNullable(disableLocalAuth), properties.Value);
        }
    }
}
