...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkJobPythonEntry>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkJobPythonEntry>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkJobPythonEntry>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SparkJobPythonEntry>)} interface");
            }
        ...
        string IPersistableModel<SparkJobPythonEntry>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
