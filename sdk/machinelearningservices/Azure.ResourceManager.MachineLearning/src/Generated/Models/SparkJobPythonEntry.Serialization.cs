...
{
    public partial class SparkJobPythonEntry : IUtf8JsonSerializable, IJsonModel<SparkJobPythonEntry>, IPersistableModel<SparkJobPythonEntry>
    {
        ...
        void IJsonModel<SparkJobPythonEntry>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SparkJobPythonEntry)} does not support '{format}' format.");
            }
