...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningPrivateLinkServiceConnectionState
    {
        ...
        internal MachineLearningPrivateLinkServiceConnectionState(MachineLearningPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
