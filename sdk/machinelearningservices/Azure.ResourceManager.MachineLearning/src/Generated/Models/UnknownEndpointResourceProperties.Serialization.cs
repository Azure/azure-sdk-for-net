...
{
    internal partial class UnknownEndpointResourceProperties : EndpointResourceProperties, IJsonModel<EndpointResourceProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownEndpointResourceProperties DeserializeUnknownEndpointResourceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
