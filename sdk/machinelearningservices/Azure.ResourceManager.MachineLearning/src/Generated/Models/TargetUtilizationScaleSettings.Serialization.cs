...
{
    public partial class TargetUtilizationScaleSettings : IUtf8JsonSerializable
    {
        ...
        internal static TargetUtilizationScaleSettings DeserializeTargetUtilizationScaleSettings(JsonElement element)
        {
            ...
            return new TargetUtilizationScaleSettings(scaleType, Optional.ToNullable(maxInstances), Optional.ToNullable(minInstances), Optional.ToNullable(pollingInterval), Optional.ToNullable(targetUtilizationPercentage));
        }
    }
}
