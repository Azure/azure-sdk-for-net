...
{
    public partial class MachineLearningUriFileDataVersion : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningUriFileDataVersion DeserializeMachineLearningUriFileDataVersion(JsonElement element)
        {
            ...
            return new MachineLearningUriFileDataVersion(description.Value, Core.Optional.ToDictionary(properties), Core.Optional.ToDictionary(tags), Core.Optional.ToNullable(isAnonymous), Core.Optional.ToNullable(isArchived), dataType, dataUri);
        }
    }
}
