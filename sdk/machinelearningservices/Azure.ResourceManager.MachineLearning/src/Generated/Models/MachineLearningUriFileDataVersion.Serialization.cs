...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningUriFileDataVersion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningUriFileDataVersion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningUriFileDataVersion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningUriFileDataVersion>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningUriFileDataVersion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
