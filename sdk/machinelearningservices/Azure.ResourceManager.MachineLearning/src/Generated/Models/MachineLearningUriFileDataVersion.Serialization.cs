...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningUriFileDataVersion : MachineLearningDataVersionProperties, IJsonModel<MachineLearningUriFileDataVersion>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningUriFileDataVersion>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningUriFileDataVersion>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningUriFileDataVersion IPersistableModel<MachineLearningUriFileDataVersion>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningUriFileDataVersion)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningUriFileDataVersion IJsonModel<MachineLearningUriFileDataVersion>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningUriFileDataVersion)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningUriFileDataVersion DeserializeMachineLearningUriFileDataVersion(JsonElement element, ModelReaderWriterOptions options)
        {
