...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownWorkspaceConnectionPropertiesV2))]
    public abstract partial class MachineLearningWorkspaceConnectionProperties
    {
        ...
        internal MachineLearningWorkspaceConnectionProperties(MachineLearningConnectionAuthType authType, MachineLearningConnectionCategory? category, string target, string value, MachineLearningValueFormat? valueFormat, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AuthType = authType;
            Category = category;
            Target = target;
