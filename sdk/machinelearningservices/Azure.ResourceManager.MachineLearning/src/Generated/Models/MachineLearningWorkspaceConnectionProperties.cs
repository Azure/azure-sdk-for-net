...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public abstract partial class MachineLearningWorkspaceConnectionProperties
    {
        ...
        /// </param>
        internal MachineLearningWorkspaceConnectionProperties(ConnectionAuthType authType, MachineLearningConnectionCategory? category, string target, string value, ValueFormat? valueFormat)
        {
            AuthType = authType;
            Category = category;
            Target = target;
