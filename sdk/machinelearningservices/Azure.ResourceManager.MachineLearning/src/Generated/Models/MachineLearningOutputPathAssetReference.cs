...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningOutputPathAssetReference : MachineLearningAssetReferenceBase
    {
        ...
        internal MachineLearningOutputPathAssetReference(ReferenceType referenceType, ResourceIdentifier jobId, string path, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(referenceType, serializedAdditionalRawData)
        {
            JobId = jobId;
            Path = path;
