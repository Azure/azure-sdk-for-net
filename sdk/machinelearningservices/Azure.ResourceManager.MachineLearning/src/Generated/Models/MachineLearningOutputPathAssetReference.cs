...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningOutputPathAssetReference : MachineLearningAssetReferenceBase
    {
        ...
        internal MachineLearningOutputPathAssetReference(ReferenceType referenceType, ResourceIdentifier jobId, string path, Dictionary<string, BinaryData> rawData) : base(referenceType, rawData)
        {
            JobId = jobId;
            Path = path;
