...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class PackageInputPathId : IUtf8JsonSerializable, IJsonModel<PackageInputPathId>
    {
        ...
        void IJsonModel<PackageInputPathId>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PackageInputPathId)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PackageInputPathId>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PackageInputPathId)} does not support '{options.Format}' format.");
            }
        }
