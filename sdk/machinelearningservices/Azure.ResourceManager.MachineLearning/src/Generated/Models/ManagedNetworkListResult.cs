...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    internal partial class ManagedNetworkListResult
    {
        ...
        internal ManagedNetworkListResult(IEnumerable<ManagedNetworkSettingsPropertiesBasicResourceData> value)
        {
            Value = value.ToList();
        }
        ...
        internal ManagedNetworkListResult(IList<ManagedNetworkSettingsPropertiesBasicResourceData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
