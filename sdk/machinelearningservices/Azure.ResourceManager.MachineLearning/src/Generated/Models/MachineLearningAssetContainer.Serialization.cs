...
{
    public partial class MachineLearningAssetContainer : IUtf8JsonSerializable, IJsonModel<MachineLearningAssetContainer>, IPersistableModel<MachineLearningAssetContainer>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningAssetContainer>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MachineLearningAssetContainer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningAssetContainer)} does not support '{format}' format.");
            }
