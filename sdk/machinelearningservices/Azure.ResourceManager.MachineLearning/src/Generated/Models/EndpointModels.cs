...
{
    /// <summary> The EndpointModels. </summary>
    internal partial class EndpointModels
    {
        /// <summary>
        ...
        internal EndpointModels(string nextLink, IReadOnlyList<EndpointModelProperties> value, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            NextLink = nextLink;
            Value = value;
