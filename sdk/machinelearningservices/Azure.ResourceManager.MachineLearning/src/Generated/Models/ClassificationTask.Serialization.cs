...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class ClassificationTask : AutoMLVertical, IJsonModel<ClassificationTask>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ClassificationTask>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ClassificationTask>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ClassificationTask IPersistableModel<ClassificationTask>.Create(BinaryData data, ModelReaderWriterOptions options) => (ClassificationTask)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ClassificationTask IJsonModel<ClassificationTask>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ClassificationTask)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ClassificationTask DeserializeClassificationTask(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("positiveLabel"u8))
                {
                    ...
                    positiveLabel = prop.Value.GetString();
                    continue;
                }
                ...
                if (prop.NameEquals("trainingSettings"u8))
                {
                    ...
                    trainingSettings = ClassificationTrainingSettings.DeserializeClassificationTrainingSettings(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
