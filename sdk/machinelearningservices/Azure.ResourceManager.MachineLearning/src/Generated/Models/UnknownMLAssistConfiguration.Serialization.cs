...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class UnknownMLAssistConfiguration : IUtf8JsonSerializable, IJsonModel<MachineLearningAssistConfiguration>
    {
        ...
        void IJsonModel<MachineLearningAssistConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MachineLearningAssistConfiguration)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MachineLearningAssistConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MachineLearningAssistConfiguration)} does not support '{options.Format}' format.");
            }
        }
