...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownTargetRollingWindowSize))]
    public abstract partial class TargetRollingWindowSize
    {
        ...
        internal TargetRollingWindowSize(TargetRollingWindowSizeMode mode, Dictionary<string, BinaryData> rawData)
        {
            Mode = mode;
            _rawData = rawData;
        }
