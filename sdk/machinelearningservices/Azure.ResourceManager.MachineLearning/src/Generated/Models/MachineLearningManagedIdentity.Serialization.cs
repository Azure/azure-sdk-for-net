...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningManagedIdentity : IUtf8JsonSerializable, IModelJsonSerializable<MachineLearningManagedIdentity>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MachineLearningManagedIdentity>(this, options.Format);
        ...
        internal static MachineLearningManagedIdentity DeserializeMachineLearningManagedIdentity(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MachineLearningManagedIdentity(identityType, Optional.ToNullable(clientId), Optional.ToNullable(objectId), resourceId.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="MachineLearningManagedIdentity"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MachineLearningManagedIdentity"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MachineLearningManagedIdentity"/>. </summary>
