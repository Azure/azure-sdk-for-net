...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class ImageClassificationMultilabel : AutoMLVertical
    {
        ...
        public ImageClassificationMultilabel(MLTableJobInput trainingData, ImageLimitSettings limitSettings) : base(trainingData)
        {
        ...
        /// </param>
        internal ImageClassificationMultilabel(LogVerbosity? logVerbosity, string targetColumnName, TaskType taskType, MLTableJobInput trainingData, ClassificationMultilabelPrimaryMetric? primaryMetric, ImageModelSettingsClassification modelSettings, IList<ImageModelDistributionSettingsClassification> searchSpace, ImageLimitSettings limitSettings, ImageSweepSettings sweepSettings, MLTableJobInput validationData, double? validationDataSize) : base(logVerbosity, targetColumnName, taskType, trainingData)
        {
