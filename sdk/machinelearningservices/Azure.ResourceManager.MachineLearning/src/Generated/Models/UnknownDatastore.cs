...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    internal partial class UnknownDatastore : MachineLearningDatastoreProperties
    {
        ...
        internal UnknownDatastore(string description, IDictionary<string, string> properties, IDictionary<string, string> tags, MachineLearningDatastoreCredentials credentials, DatastoreType datastoreType, IntellectualProperty intellectualProperty, bool? isDefault) : base(description, properties, tags, credentials, datastoreType, intellectualProperty, isDefault)
        {
