...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MonitoringAlertNotificationSettingsBase : IUtf8JsonSerializable, IJsonModel<MonitoringAlertNotificationSettingsBase>, IPersistableModel<MonitoringAlertNotificationSettingsBase>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AlertNotificationType))
            {
                builder.Append("  alertNotificationType:");
                builder.AppendLine($" '{AlertNotificationType.ToString()}'");
            }
