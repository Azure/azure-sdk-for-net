...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MonitoringAlertNotificationSettingsBase : IUtf8JsonSerializable, IJsonModel<MonitoringAlertNotificationSettingsBase>
    {
        ...
        void IJsonModel<MonitoringAlertNotificationSettingsBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MonitoringAlertNotificationSettingsBase)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MonitoringAlertNotificationSettingsBase>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MonitoringAlertNotificationSettingsBase)} does not support '{options.Format}' format.");
            }
        }
