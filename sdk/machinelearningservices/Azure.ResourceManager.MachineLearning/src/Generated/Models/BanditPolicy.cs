...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class BanditPolicy : MachineLearningEarlyTerminationPolicy
    {
        ...
        internal BanditPolicy(int? delayEvaluation, int? evaluationInterval, EarlyTerminationPolicyType policyType, float? slackAmount, float? slackFactor, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(delayEvaluation, evaluationInterval, policyType, serializedAdditionalRawData)
        {
