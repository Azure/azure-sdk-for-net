...
{
    public partial class StaticInputData : IUtf8JsonSerializable, IJsonModel<StaticInputData>, IPersistableModel<StaticInputData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WindowEnd))
            {
                builder.Append("  windowEnd:");
                builder.AppendLine($" '{WindowEnd.ToString()}'");
            }

            if (Optional.IsDefined(WindowStart))
            {
                builder.Append("  windowStart:");
                builder.AppendLine($" '{WindowStart.ToString()}'");
            }
