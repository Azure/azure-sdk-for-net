...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticInputData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StaticInputData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticInputData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StaticInputData>)} interface");
            }
        ...
        string IPersistableModel<StaticInputData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
