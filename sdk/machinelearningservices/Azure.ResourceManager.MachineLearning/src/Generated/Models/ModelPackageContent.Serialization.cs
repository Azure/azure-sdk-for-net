...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ModelPackageContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ModelPackageContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ModelPackageContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ModelPackageContent>)} interface");
            }
        ...
        string IPersistableModel<ModelPackageContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
