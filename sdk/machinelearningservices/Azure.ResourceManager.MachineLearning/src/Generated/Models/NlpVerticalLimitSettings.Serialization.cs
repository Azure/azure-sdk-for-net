...
{
    public partial class NlpVerticalLimitSettings : IUtf8JsonSerializable, IJsonModel<NlpVerticalLimitSettings>, IPersistableModel<NlpVerticalLimitSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxConcurrentTrials))
            {
                ...
                builder.AppendLine($" '{MaxConcurrentTrials.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxNodes))
            {
                builder.Append("  maxNodes:");
                builder.AppendLine($" '{MaxNodes.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxTrials))
            {
                builder.Append("  maxTrials:");
                builder.AppendLine($" '{MaxTrials.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(TrialTimeout))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(TrialTimeout.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
