...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class AutoNCrossValidations : NCrossValidations
    {
        ...
        internal AutoNCrossValidations(NCrossValidationsMode mode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(mode, serializedAdditionalRawData)
        {
            Mode = mode;
        }
    }
