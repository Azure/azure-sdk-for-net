...
{
    public partial class MachineLearningDataFactoryCompute : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningDataFactoryCompute DeserializeMachineLearningDataFactoryCompute(JsonElement element)
        {
            ...
            return new MachineLearningDataFactoryCompute(computeType, computeLocation.Value, Core.Optional.ToNullable(provisioningState), description.Value, Core.Optional.ToNullable(createdOn), Core.Optional.ToNullable(modifiedOn), resourceId.Value, Core.Optional.ToList(provisioningErrors), Core.Optional.ToNullable(isAttachedCompute), Core.Optional.ToNullable(disableLocalAuth));
        }
    }
}
