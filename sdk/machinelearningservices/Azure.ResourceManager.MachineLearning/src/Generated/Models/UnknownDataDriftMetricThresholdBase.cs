...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class UnknownDataDriftMetricThresholdBase : DataDriftMetricThresholdBase
    {
        ...
        internal UnknownDataDriftMetricThresholdBase(MonitoringFeatureDataType dataType, MonitoringThreshold threshold, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(dataType != default ? dataType : "unknown", threshold, additionalBinaryDataProperties)
        {
        }
    }
}
