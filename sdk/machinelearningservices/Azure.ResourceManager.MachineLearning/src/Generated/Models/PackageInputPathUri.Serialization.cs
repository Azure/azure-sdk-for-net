...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PackageInputPathUri>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PackageInputPathUri>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PackageInputPathUri>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PackageInputPathUri>)} interface");
            }
        ...
        string IPersistableModel<PackageInputPathUri>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
