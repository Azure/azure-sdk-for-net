...
{
    internal partial class DataLakeAnalyticsSchemaProperties : IUtf8JsonSerializable
    {
        ...
        internal static DataLakeAnalyticsSchemaProperties DeserializeDataLakeAnalyticsSchemaProperties(JsonElement element)
        {
            ...
            return new DataLakeAnalyticsSchemaProperties(dataLakeStoreAccountName.Value);
        }
    }
}
