...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoSeasonality>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<AutoSeasonality>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutoSeasonality>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
