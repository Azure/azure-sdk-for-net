...
{
    public partial class AutoSeasonality : IUtf8JsonSerializable, IJsonModel<AutoSeasonality>, IPersistableModel<AutoSeasonality>
    {
        ...
        void IJsonModel<AutoSeasonality>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutoSeasonality)} does not support '{format}' format.");
            }
