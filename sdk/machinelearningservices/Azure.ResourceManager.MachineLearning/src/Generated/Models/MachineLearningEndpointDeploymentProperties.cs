...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningEndpointDeploymentProperties
    {
        ...
        internal MachineLearningEndpointDeploymentProperties(MachineLearningCodeConfiguration codeConfiguration, string description, string environmentId, IDictionary<string, string> environmentVariables, IDictionary<string, string> properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
