...
{
    public partial class MachineLearningForecasting : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            if (Core.Optional.IsDefined(ForecastingSettings))
            {
        ...
        internal static MachineLearningForecasting DeserializeMachineLearningForecasting(JsonElement element)
        {
            ...
            Core.Optional<ForecastingSettings> forecastingSettings = default;
            Core.Optional<ForecastingPrimaryMetric> primaryMetric = default;
            Core.Optional<ForecastingTrainingSettings> trainingSettings = default;
            ...
            return new MachineLearningForecasting(Core.Optional.ToNullable(logVerbosity), targetColumnName.Value, taskType, trainingData, forecastingSettings.Value, Core.Optional.ToNullable(primaryMetric), trainingSettings.Value, Core.Optional.ToList(cvSplitColumnNames), featurizationSettings.Value, limitSettings.Value, nCrossValidations.Value, testData.Value, Core.Optional.ToNullable(testDataSize), validationData.Value, Core.Optional.ToNullable(validationDataSize), weightColumnName.Value);
        }
    }
}
