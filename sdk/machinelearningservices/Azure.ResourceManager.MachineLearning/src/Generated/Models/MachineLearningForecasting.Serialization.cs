...
{
    public partial class MachineLearningForecasting : IUtf8JsonSerializable, IJsonModel<MachineLearningForecasting>, IPersistableModel<MachineLearningForecasting>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ForecastingSettings))
            {
                ...
                AppendChildObject(builder, ForecastingSettings, options, 2);
            }
