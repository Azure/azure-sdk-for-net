        ...
        void IJsonModel<MachineLearningForecasting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ForecastingSettings))
            {
                if (ForecastingSettings != null)
                {
                    ...
                    BinaryData data = ModelReaderWriter.Write(ForecastingSettings, options);
            ...
            if (Optional.IsDefined(TrainingSettings))
            {
                if (TrainingSettings != null)
                {
                    ...
                    BinaryData data = ModelReaderWriter.Write(TrainingSettings, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data);
#else
                    using (JsonDocument document = JsonDocument.Parse(data))
            ...
            if (Optional.IsDefined(FeaturizationSettings))
            {
                if (FeaturizationSettings != null)
                {
                    ...
                    BinaryData data = ModelReaderWriter.Write(FeaturizationSettings, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data);
#else
                    using (JsonDocument document = JsonDocument.Parse(data))
            ...
            if (Optional.IsDefined(FixedParameters))
            {
                if (FixedParameters != null)
                {
                    ...
                    BinaryData data = ModelReaderWriter.Write(FixedParameters, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data);
#else
                    using (JsonDocument document = JsonDocument.Parse(data))
            ...
            if (Optional.IsDefined(LimitSettings))
            {
                if (LimitSettings != null)
                {
                    ...
                    BinaryData data = ModelReaderWriter.Write(LimitSettings, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data);
#else
                    using (JsonDocument document = JsonDocument.Parse(data))
            ...
            if (Optional.IsDefined(NCrossValidations))
            {
                if (NCrossValidations != null)
                {
                    ...
                    BinaryData data = ModelReaderWriter.Write(NCrossValidations, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data);
#else
                    using (JsonDocument document = JsonDocument.Parse(data))
            ...
            if (Optional.IsDefined(SweepSettings))
            {
                if (SweepSettings != null)
                {
                    ...
                    BinaryData data = ModelReaderWriter.Write(SweepSettings, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data);
#else
                    using (JsonDocument document = JsonDocument.Parse(data))
            ...
            if (Optional.IsDefined(TestData))
            {
                if (TestData != null)
                {
                    ...
                    BinaryData data = ModelReaderWriter.Write(TestData, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data);
#else
                    using (JsonDocument document = JsonDocument.Parse(data))
            ...
            if (Optional.IsDefined(ValidationData))
            {
                if (ValidationData != null)
                {
                    ...
                    BinaryData data = ModelReaderWriter.Write(ValidationData, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data);
#else
                    using (JsonDocument document = JsonDocument.Parse(data))
            ...
            BinaryData data0 = ModelReaderWriter.Write(TrainingData, options);
#if NET6_0_OR_GREATER
