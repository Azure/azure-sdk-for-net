...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningForecasting : AutoMLVertical, IJsonModel<MachineLearningForecasting>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningForecasting>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningForecasting>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningForecasting IPersistableModel<MachineLearningForecasting>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningForecasting)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningForecasting IJsonModel<MachineLearningForecasting>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningForecasting)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningForecasting DeserializeMachineLearningForecasting(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("forecastingSettings"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                    ...
                    forecastingSettings = ForecastingSettings.DeserializeForecastingSettings(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("primaryMetric"u8))
                {
                    ...
                    primaryMetric = new ForecastingPrimaryMetric(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("trainingSettings"u8))
                {
                    ...
                    trainingSettings = ForecastingTrainingSettings.DeserializeForecastingTrainingSettings(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
