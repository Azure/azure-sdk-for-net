        ...
        void IJsonModel<MachineLearningForecasting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ForecastingSettings))
            {
                if (ForecastingSettings != null)
                {
                    ...
                    ((IJsonModel<ForecastingSettings>)ForecastingSettings).Write(writer, options);
                }
                else
                {
            ...
            if (Optional.IsDefined(TrainingSettings))
            {
                if (TrainingSettings != null)
                {
                    ...
                    ((IJsonModel<ForecastingTrainingSettings>)TrainingSettings).Write(writer, options);
                }
                else
                {
            ...
            if (Optional.IsDefined(FixedParameters))
            {
                if (FixedParameters != null)
                {
                    ...
                    ((IJsonModel<TableFixedParameters>)FixedParameters).Write(writer, options);
                }
                else
                {
            ...
            if (Optional.IsCollectionDefined(SearchSpace))
            {
                if (SearchSpace != null)
                {
                    ...
                    foreach (var item in SearchSpace)
                    {
                        if (item != null)
                        {
                            ((IJsonModel<TableParameterSubspace>)item).Write(writer, options);
                        }
                        else
                        {
            ...
            if (Optional.IsDefined(SweepSettings))
            {
                if (SweepSettings != null)
                {
                    ...
                    ((IJsonModel<TableSweepSettings>)SweepSettings).Write(writer, options);
                }
                else
                {
