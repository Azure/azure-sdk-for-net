...
namespace Azure.ResourceManager.MachineLearning
{
    public partial class MachineLearningOnlineDeploymentData : IUtf8JsonSerializable, IJsonModel<MachineLearningOnlineDeploymentData>
    {
        ...
        void IJsonModel<MachineLearningOnlineDeploymentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MachineLearningOnlineDeploymentData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MachineLearningOnlineDeploymentData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MachineLearningOnlineDeploymentData)} does not support '{options.Format}' format.");
            }
        }
