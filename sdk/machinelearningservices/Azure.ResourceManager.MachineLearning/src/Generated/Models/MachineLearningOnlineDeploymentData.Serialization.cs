...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningOnlineDeploymentData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningOnlineDeploymentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningOnlineDeploymentData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningOnlineDeploymentData>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningOnlineDeploymentData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
