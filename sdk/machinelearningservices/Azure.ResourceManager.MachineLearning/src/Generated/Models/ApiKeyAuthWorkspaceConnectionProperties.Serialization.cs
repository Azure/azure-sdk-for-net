...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    /// </summary>
    public partial class ApiKeyAuthWorkspaceConnectionProperties : MachineLearningWorkspaceConnectionProperties, IJsonModel<ApiKeyAuthWorkspaceConnectionProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApiKeyAuthWorkspaceConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ApiKeyAuthWorkspaceConnectionProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiKeyAuthWorkspaceConnectionProperties IPersistableModel<ApiKeyAuthWorkspaceConnectionProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (ApiKeyAuthWorkspaceConnectionProperties)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiKeyAuthWorkspaceConnectionProperties IJsonModel<ApiKeyAuthWorkspaceConnectionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ApiKeyAuthWorkspaceConnectionProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ApiKeyAuthWorkspaceConnectionProperties DeserializeApiKeyAuthWorkspaceConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("credentials"u8))
                {
                    ...
                    credentials = WorkspaceConnectionApiKey.DeserializeWorkspaceConnectionApiKey(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
