...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceTagOutboundRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceTagOutboundRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceTagOutboundRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceTagOutboundRule>)} interface");
            }
        ...
        string IPersistableModel<ServiceTagOutboundRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
