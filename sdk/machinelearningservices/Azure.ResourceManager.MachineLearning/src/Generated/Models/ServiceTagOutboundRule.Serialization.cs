...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class ServiceTagOutboundRule : MachineLearningOutboundRule, IJsonModel<ServiceTagOutboundRule>
    {
        ...
        internal static ServiceTagOutboundRule DeserializeServiceTagOutboundRule(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("destination"u8))
                {
                    ...
                    destination = ServiceTagDestination.DeserializeServiceTagDestination(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
