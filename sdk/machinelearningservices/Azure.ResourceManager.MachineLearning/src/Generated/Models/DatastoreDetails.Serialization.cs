...
{
    public partial class DatastoreDetails : IUtf8JsonSerializable
    {
        ...
        internal static DatastoreDetails DeserializeDatastoreDetails(JsonElement element)
        {
            ...
            return new DatastoreDetails(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), credentials, datastoreType, Optional.ToNullable(isDefault));
        }
    }
}
