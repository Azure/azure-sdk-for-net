...
{
    public partial class MachineLearningTrainingSettings : IUtf8JsonSerializable, IJsonModel<MachineLearningTrainingSettings>, IPersistableModel<MachineLearningTrainingSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EnsembleModelDownloadTimeout))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(EnsembleModelDownloadTimeout.Value);
            ...
            if (Optional.IsDefined(StackEnsembleSettings))
            {
                ...
                AppendChildObject(builder, StackEnsembleSettings, options, 2);
            }

            if (Optional.IsDefined(TrainingMode))
            {
                builder.Append("  trainingMode:");
                builder.AppendLine($" '{TrainingMode.ToString()}'");
            }
