...
{
    public partial class MachineLearningTableJobInput : IUtf8JsonSerializable, IJsonModel<MachineLearningTableJobInput>, IPersistableModel<MachineLearningTableJobInput>
    {
        ...
        void IJsonModel<MachineLearningTableJobInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningTableJobInput)} does not support '{format}' format.");
            }
