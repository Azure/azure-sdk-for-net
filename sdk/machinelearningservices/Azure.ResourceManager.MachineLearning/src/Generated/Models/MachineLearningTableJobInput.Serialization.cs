...
{
    public partial class MachineLearningTableJobInput : IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningTableJobInput DeserializeMachineLearningTableJobInput(JsonElement element)
        {
            ...
            return new MachineLearningTableJobInput(description.Value, jobInputType, Optional.ToNullable(mode), uri);
        }
    }
}
