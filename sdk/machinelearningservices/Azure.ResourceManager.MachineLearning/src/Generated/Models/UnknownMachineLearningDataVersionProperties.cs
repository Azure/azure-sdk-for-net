...
{
    /// <summary> Unknown version of MachineLearningDataVersionProperties. </summary>
    internal partial class UnknownMachineLearningDataVersionProperties : MachineLearningDataVersionProperties
    {
        /// <summary> Initializes a new instance of <see cref="UnknownMachineLearningDataVersionProperties"/>. </summary>
        ...
        internal UnknownMachineLearningDataVersionProperties(string description, IDictionary<string, string> properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData, AutoDeleteSetting autoDeleteSetting, bool? isAnonymous, bool? isArchived, MachineLearningDataType dataType, Uri dataUri, IntellectualProperty intellectualProperty, string stage) : base(description, properties, tags, serializedAdditionalRawData, autoDeleteSetting, isAnonymous, isArchived, dataType, dataUri, intellectualProperty, stage)
        {
            DataType = dataType;
        }

        /// <summary> Initializes a new instance of <see cref="UnknownMachineLearningDataVersionProperties"/> for deserialization. </summary>
        internal UnknownMachineLearningDataVersionProperties()
        {
        }
    }
}
