...
{
    public partial class TrailingInputData : IUtf8JsonSerializable, IJsonModel<TrailingInputData>, IPersistableModel<TrailingInputData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WindowOffset))
            {
                builder.Append("  windowOffset:");
                var formattedTimeSpan = XmlConvert.ToString(WindowOffset);
