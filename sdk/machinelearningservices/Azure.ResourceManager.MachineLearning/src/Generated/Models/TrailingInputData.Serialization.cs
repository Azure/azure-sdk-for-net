...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrailingInputData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrailingInputData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrailingInputData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrailingInputData>)} interface");
            }
        ...
        string IPersistableModel<TrailingInputData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
