...
{
    public partial class MachineLearningModelContainerProperties : IUtf8JsonSerializable, IJsonModel<MachineLearningModelContainerProperties>, IPersistableModel<MachineLearningModelContainerProperties>
    {
        ...
        void IJsonModel<MachineLearningModelContainerProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningModelContainerProperties)} does not support '{format}' format.");
            }
