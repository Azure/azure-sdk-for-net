...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class TableVerticalFeaturizationSettings : MachineLearningFeaturizationSettings
    {
        ...
        internal TableVerticalFeaturizationSettings(string datasetLanguage, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<BlockedTransformer> blockedTransformers, IDictionary<string, string> columnNameAndTypes, bool? enableDnnFeaturization, MachineLearningFeaturizationMode? mode, IDictionary<string, IList<ColumnTransformer>> transformerParams) : base(datasetLanguage, additionalBinaryDataProperties)
        {
