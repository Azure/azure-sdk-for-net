...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningWorkspaceNotebookAccessTokenResult
    {
        ...
        internal MachineLearningWorkspaceNotebookAccessTokenResult(string notebookResourceId, string hostName, string publicDns, string accessToken, string tokenType, int? expiresIn, string refreshToken, string scope, Dictionary<string, BinaryData> rawData)
        {
