...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningUsage
    {
        ...
        internal MachineLearningUsage(string id, string amlWorkspaceLocation, string usageType, MachineLearningUsageUnit? unit, long? currentValue, long? limit, MachineLearningUsageName name, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
