...
{
    [ModelReaderProxy(typeof(UnknownMonitorComputeConfigurationBase))]
    public partial class MonitorComputeConfigurationBase : IUtf8JsonSerializable, IJsonModel<MonitorComputeConfigurationBase>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorComputeConfigurationBase>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MonitorComputeConfigurationBase IJsonModel<MonitorComputeConfigurationBase>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<MonitorComputeConfigurationBase>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MonitorComputeConfigurationBase IModel<MonitorComputeConfigurationBase>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MonitorComputeConfigurationBase>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
