...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningContainerRegistryCredentials>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningContainerRegistryCredentials>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningContainerRegistryCredentials>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningContainerRegistryCredentials>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningContainerRegistryCredentials>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
