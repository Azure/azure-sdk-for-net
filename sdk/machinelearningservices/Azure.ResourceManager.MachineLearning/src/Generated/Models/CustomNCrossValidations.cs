...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class CustomNCrossValidations : NCrossValidations
    {
        ...
        internal CustomNCrossValidations(NCrossValidationsMode mode, int value, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(mode, serializedAdditionalRawData)
        {
            Value = value;
            Mode = mode;
        }
