...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class CustomTargetRollingWindowSize : TargetRollingWindowSize
    {
        ...
        internal CustomTargetRollingWindowSize(TargetRollingWindowSizeMode mode, int value, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(mode, serializedAdditionalRawData)
        {
            Value = value;
            Mode = mode;
        }
