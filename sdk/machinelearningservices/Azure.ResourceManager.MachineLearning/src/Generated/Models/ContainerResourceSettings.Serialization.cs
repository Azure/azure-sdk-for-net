...
{
    public partial class ContainerResourceSettings : IUtf8JsonSerializable
    {
        ...
        internal static ContainerResourceSettings DeserializeContainerResourceSettings(JsonElement element)
        {
            ...
            return new ContainerResourceSettings(cpu.Value, gpu.Value, memory.Value);
        }
    }
}
