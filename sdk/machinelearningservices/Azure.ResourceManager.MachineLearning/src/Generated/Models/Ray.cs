...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        /// <summary> Initializes a new instance of Ray. </summary>
        public Ray()
        {
        ...
        internal Ray(DistributionType distributionType, string address, int? dashboardPort, string headNodeAdditionalArgs, bool? includeDashboard, int? port, string workerNodeAdditionalArgs) : base(distributionType)
        {
            Address = address;
