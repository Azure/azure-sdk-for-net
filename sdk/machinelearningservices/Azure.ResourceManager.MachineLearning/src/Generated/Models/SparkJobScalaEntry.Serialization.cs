...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SparkJobScalaEntry>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SparkJobScalaEntry>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SparkJobScalaEntry>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SparkJobScalaEntry>)} interface");
            }
        ...
        string IPersistableModel<SparkJobScalaEntry>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
