...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputeStartStopRecurrenceSchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComputeStartStopRecurrenceSchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputeStartStopRecurrenceSchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ComputeStartStopRecurrenceSchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
