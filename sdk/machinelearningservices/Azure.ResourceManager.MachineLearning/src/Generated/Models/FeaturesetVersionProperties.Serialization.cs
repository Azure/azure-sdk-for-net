...
{
    public partial class FeaturesetVersionProperties : IUtf8JsonSerializable
    {
        ...
        internal static FeaturesetVersionProperties DeserializeFeaturesetVersionProperties(JsonElement element)
        {
            ...
            return new FeaturesetVersionProperties(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), autoDeleteSetting.Value, Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), Optional.ToList(entities), materializationSettings.Value, Optional.ToNullable(provisioningState), specification.Value, stage.Value);
        }
    }
}
