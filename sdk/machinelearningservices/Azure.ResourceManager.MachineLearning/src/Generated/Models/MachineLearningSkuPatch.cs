...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningSkuPatch
    {
        ...
        internal MachineLearningSkuPatch(int? capacity, string family, string name, string size, MachineLearningSkuTier? tier, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Capacity = capacity;
            Family = family;
            Name = name;
