...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProgressMetrics>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProgressMetrics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProgressMetrics>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProgressMetrics>)} interface");
            }
        ...
        string IPersistableModel<ProgressMetrics>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
