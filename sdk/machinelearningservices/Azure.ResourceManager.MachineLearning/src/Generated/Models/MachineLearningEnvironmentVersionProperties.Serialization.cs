...
{
    public partial class MachineLearningEnvironmentVersionProperties : IUtf8JsonSerializable, IJsonModel<MachineLearningEnvironmentVersionProperties>, IPersistableModel<MachineLearningEnvironmentVersionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AutoRebuild))
            {
                ...
                builder.AppendLine($" '{AutoRebuild.ToString()}'");
            }

            if (Optional.IsDefined(Build))
            {
                builder.Append("  build:");
                AppendChildObject(builder, Build, options, 2);
            }
            ...
            if (Optional.IsDefined(InferenceConfig))
            {
                ...
                AppendChildObject(builder, InferenceConfig, options, 2);
            }
