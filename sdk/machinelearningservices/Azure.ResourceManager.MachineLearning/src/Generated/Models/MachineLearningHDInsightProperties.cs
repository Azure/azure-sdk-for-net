...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningHDInsightProperties
    {
        ...
        internal MachineLearningHDInsightProperties(int? sshPort, IPAddress address, MachineLearningVmSshCredentials administratorAccount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SshPort = sshPort;
            Address = address;
