...
{
    public partial class JobService : IUtf8JsonSerializable
    {
        ...
        internal static JobService DeserializeJobService(JsonElement element)
        {
            ...
            return new JobService(endpoint.Value, errorMessage.Value, jobServiceType.Value, Optional.ToNullable(port), Optional.ToDictionary(properties), status.Value);
        }
    }
}
