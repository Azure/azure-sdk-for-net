...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomKeys>)} interface");
            }
        ...
        string IPersistableModel<CustomKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
