...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class FixedInputData : MonitoringInputDataBase, IJsonModel<FixedInputData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<FixedInputData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FixedInputData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        FixedInputData IPersistableModel<FixedInputData>.Create(BinaryData data, ModelReaderWriterOptions options) => (FixedInputData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FixedInputData IJsonModel<FixedInputData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (FixedInputData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FixedInputData DeserializeFixedInputData(JsonElement element, ModelReaderWriterOptions options)
        {
