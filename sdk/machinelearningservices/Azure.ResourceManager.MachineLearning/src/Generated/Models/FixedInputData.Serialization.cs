...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FixedInputData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FixedInputData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FixedInputData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FixedInputData>)} interface");
            }
        ...
        string IPersistableModel<FixedInputData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
