...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RandomSamplingAlgorithm>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RandomSamplingAlgorithm>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RandomSamplingAlgorithm>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RandomSamplingAlgorithm>)} interface");
            }
        ...
        string IPersistableModel<RandomSamplingAlgorithm>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
