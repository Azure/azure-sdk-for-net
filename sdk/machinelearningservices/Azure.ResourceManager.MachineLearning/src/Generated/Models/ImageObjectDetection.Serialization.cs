...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class ImageObjectDetection : IUtf8JsonSerializable, IModelJsonSerializable<ImageObjectDetection>
    {
        ...
        internal static ImageObjectDetection DeserializeImageObjectDetection(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ImageObjectDetection(Optional.ToNullable(logVerbosity), targetColumnName.Value, taskType, trainingData, Optional.ToNullable(primaryMetric), modelSettings.Value, Optional.ToList(searchSpace), limitSettings, sweepSettings.Value, validationData.Value, Optional.ToNullable(validationDataSize), serializedAdditionalRawData);
        }
