...
{
    public partial class ImageObjectDetection : IUtf8JsonSerializable, IJsonModel<ImageObjectDetection>, IPersistableModel<ImageObjectDetection>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ModelSettings))
            {
                ...
                AppendChildObject(builder, ModelSettings, options, 2);
            }
