...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageObjectDetection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageObjectDetection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageObjectDetection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageObjectDetection>)} interface");
            }
        ...
        string IPersistableModel<ImageObjectDetection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
