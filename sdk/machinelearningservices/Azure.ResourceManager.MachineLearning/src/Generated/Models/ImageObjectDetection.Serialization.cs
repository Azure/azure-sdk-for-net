...
{
    public partial class ImageObjectDetection : Core.IUtf8JsonSerializable
    {
        ...
        internal static ImageObjectDetection DeserializeImageObjectDetection(JsonElement element)
        {
            ...
            Core.Optional<ObjectDetectionPrimaryMetric> primaryMetric = default;
            Core.Optional<ImageModelSettingsObjectDetection> modelSettings = default;
            Core.Optional<IList<ImageModelDistributionSettingsObjectDetection>> searchSpace = default;
            ...
            return new ImageObjectDetection(Core.Optional.ToNullable(logVerbosity), targetColumnName.Value, taskType, trainingData, Core.Optional.ToNullable(primaryMetric), modelSettings.Value, Core.Optional.ToList(searchSpace), limitSettings, sweepSettings.Value, validationData.Value, Core.Optional.ToNullable(validationDataSize));
        }
    }
}
