...
{
    public partial class ImageObjectDetection : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ImageObjectDetection DeserializeImageObjectDetection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
