...
{
    public partial class MachineLearningJobService : IUtf8JsonSerializable, IJsonModel<MachineLearningJobService>, IPersistableModel<MachineLearningJobService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Nodes))
            {
                ...
                AppendChildObject(builder, Nodes, options, 2);
            }
