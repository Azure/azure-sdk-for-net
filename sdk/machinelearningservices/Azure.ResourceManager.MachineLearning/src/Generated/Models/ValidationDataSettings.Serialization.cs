...
{
    public partial class ValidationDataSettings : IUtf8JsonSerializable
    {
        ...
        internal static ValidationDataSettings DeserializeValidationDataSettings(JsonElement element)
        {
            ...
            return new ValidationDataSettings(data.Value, Optional.ToNullable(validationDataSize));
        }
    }
}
