...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClassificationModelPerformanceMetricThreshold>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ClassificationModelPerformanceMetricThreshold IJsonModel<ClassificationModelPerformanceMetricThreshold>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ClassificationModelPerformanceMetricThreshold>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ClassificationModelPerformanceMetricThreshold IModel<ClassificationModelPerformanceMetricThreshold>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ClassificationModelPerformanceMetricThreshold>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
