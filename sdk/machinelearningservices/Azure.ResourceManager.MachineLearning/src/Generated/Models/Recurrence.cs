...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class Recurrence
    {
        ...
        internal Recurrence(MachineLearningRecurrenceFrequency? frequency, int? interval, string startTime, string timeZone, MachineLearningRecurrenceSchedule schedule)
        {
            Frequency = frequency;
            Interval = interval;
            StartTime = startTime;
