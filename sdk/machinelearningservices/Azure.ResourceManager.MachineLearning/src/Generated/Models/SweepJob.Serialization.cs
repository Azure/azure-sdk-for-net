...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class SweepJob : MachineLearningJobProperties, IJsonModel<SweepJob>
    {
        /// <summary> Initializes a new instance of <see cref="SweepJob"/> for deserialization. </summary>
        internal SweepJob()
        {
        }
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SweepJob>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeSweepJob(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(SweepJob)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SweepJob)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SweepJob>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SweepJob IPersistableModel<SweepJob>.Create(BinaryData data, ModelReaderWriterOptions options) => (SweepJob)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<SweepJob>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<SweepJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SweepJob)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SweepJob IJsonModel<SweepJob>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SweepJob)JsonModelCreateCore(ref reader, options);
        ...
        protected override MachineLearningResourceBase JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SweepJob)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SweepJob DeserializeSweepJob(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    objective = Objective.DeserializeObjective(prop.Value, options);
                    continue;
                }
