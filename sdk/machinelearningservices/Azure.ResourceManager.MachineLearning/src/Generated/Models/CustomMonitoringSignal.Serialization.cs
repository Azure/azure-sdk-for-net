...
{
    public partial class CustomMonitoringSignal : IUtf8JsonSerializable, IJsonModel<CustomMonitoringSignal>, IPersistableModel<CustomMonitoringSignal>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WorkspaceConnection))
            {
                builder.Append("  workspaceConnection:");
                AppendChildObject(builder, WorkspaceConnection, options, 2);
            }
