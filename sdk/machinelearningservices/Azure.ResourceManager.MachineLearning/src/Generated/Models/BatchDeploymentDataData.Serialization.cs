...
{
    public partial class BatchDeploymentDataData : IUtf8JsonSerializable
    {
        ...
        internal static BatchDeploymentDataData DeserializeBatchDeploymentDataData(JsonElement element)
        {
            ...
            return new BatchDeploymentDataData(id, name, type, systemData, tags, location, identity, kind.Value, properties, sku.Value);
        }
    }
}
