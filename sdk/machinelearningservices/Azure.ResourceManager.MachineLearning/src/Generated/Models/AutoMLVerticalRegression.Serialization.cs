...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class AutoMLVerticalRegression : IUtf8JsonSerializable, IModelJsonSerializable<AutoMLVerticalRegression>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AutoMLVerticalRegression>(this, options.Format);
        ...
        internal static AutoMLVerticalRegression DeserializeAutoMLVerticalRegression(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AutoMLVerticalRegression(Optional.ToNullable(logVerbosity), targetColumnName.Value, taskType, trainingData, Optional.ToNullable(primaryMetric), trainingSettings.Value, Optional.ToList(cvSplitColumnNames), featurizationSettings.Value, limitSettings.Value, nCrossValidations.Value, testData.Value, Optional.ToNullable(testDataSize), validationData.Value, Optional.ToNullable(validationDataSize), weightColumnName.Value, serializedAdditionalRawData);
        }
