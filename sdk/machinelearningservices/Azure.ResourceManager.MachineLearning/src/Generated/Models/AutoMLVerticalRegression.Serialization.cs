...
{
    public partial class AutoMLVerticalRegression : Core.IUtf8JsonSerializable
    {
        ...
        internal static AutoMLVerticalRegression DeserializeAutoMLVerticalRegression(JsonElement element)
        {
            ...
            Core.Optional<AutoMLVerticalRegressionPrimaryMetric> primaryMetric = default;
            Core.Optional<RegressionTrainingSettings> trainingSettings = default;
            ...
            return new AutoMLVerticalRegression(Core.Optional.ToNullable(logVerbosity), targetColumnName.Value, taskType, trainingData, Core.Optional.ToNullable(primaryMetric), trainingSettings.Value, Core.Optional.ToList(cvSplitColumnNames), featurizationSettings.Value, limitSettings.Value, nCrossValidations.Value, testData.Value, Core.Optional.ToNullable(testDataSize), validationData.Value, Core.Optional.ToNullable(validationDataSize), weightColumnName.Value);
        }
    }
}
