...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoMLVerticalRegression>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutoMLVerticalRegression>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutoMLVerticalRegression>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutoMLVerticalRegression>)} interface");
            }
        ...
        string IPersistableModel<AutoMLVerticalRegression>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
