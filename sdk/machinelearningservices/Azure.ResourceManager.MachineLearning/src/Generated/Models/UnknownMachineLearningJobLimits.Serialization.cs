...
{
    internal partial class UnknownMachineLearningJobLimits : IUtf8JsonSerializable, IJsonModel<MachineLearningJobLimits>
    {
        ...
        internal static UnknownMachineLearningJobLimits DeserializeUnknownMachineLearningJobLimits(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownMachineLearningJobLimits(jobLimitsType, timeout, serializedAdditionalRawData);
        }
