...
{
    public partial class MLFlowModelJobInput : IUtf8JsonSerializable
    {
        ...
        internal static MLFlowModelJobInput DeserializeMLFlowModelJobInput(JsonElement element)
        {
            ...
            return new MLFlowModelJobInput(description.Value, jobInputType, Optional.ToNullable(mode), uri);
        }
    }
}
