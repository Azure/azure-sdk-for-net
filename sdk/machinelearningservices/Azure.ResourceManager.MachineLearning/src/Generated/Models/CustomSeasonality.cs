...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class CustomSeasonality : ForecastingSeasonality
    {
        ...
        internal CustomSeasonality(SeasonalityMode mode, int value, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(mode, serializedAdditionalRawData)
        {
            Value = value;
            Mode = mode;
        }
