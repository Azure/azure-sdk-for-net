...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        internal static MachineLearningSkuSetting DeserializeMachineLearningSkuSetting(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
