...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageModelSettingsObjectDetection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageModelSettingsObjectDetection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageModelSettingsObjectDetection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageModelSettingsObjectDetection>)} interface");
            }
        ...
        string IPersistableModel<ImageModelSettingsObjectDetection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
