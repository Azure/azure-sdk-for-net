...
{
    public partial class UsernamePasswordAuthTypeWorkspaceConnectionProperties : IUtf8JsonSerializable
    {
        ...
        internal static UsernamePasswordAuthTypeWorkspaceConnectionProperties DeserializeUsernamePasswordAuthTypeWorkspaceConnectionProperties(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credentials"))
                {
                    ...
                    credentials = WorkspaceConnectionUsernamePassword.DeserializeWorkspaceConnectionUsernamePassword(property.Value);
                    continue;
                }
            ...
            return new UsernamePasswordAuthTypeWorkspaceConnectionProperties(authType, Optional.ToNullable(category), target.Value, value.Value, Optional.ToNullable(valueFormat), credentials.Value);
        }
    }
}
