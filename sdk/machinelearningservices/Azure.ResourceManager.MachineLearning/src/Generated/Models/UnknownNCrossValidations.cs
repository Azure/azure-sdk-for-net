...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    internal partial class UnknownNCrossValidations : NCrossValidations
    {
        ...
        internal UnknownNCrossValidations(NCrossValidationsMode mode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(mode, serializedAdditionalRawData)
        {
            Mode = mode;
        }
