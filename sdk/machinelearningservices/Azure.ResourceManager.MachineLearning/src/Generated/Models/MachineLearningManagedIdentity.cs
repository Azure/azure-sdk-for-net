...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningManagedIdentity : MachineLearningIdentityConfiguration
    {
        ...
        internal MachineLearningManagedIdentity(IdentityConfigurationType identityType, Guid? clientId, Guid? objectId, ResourceIdentifier resourceId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(identityType, serializedAdditionalRawData)
        {
            ClientId = clientId;
            ObjectId = objectId;
