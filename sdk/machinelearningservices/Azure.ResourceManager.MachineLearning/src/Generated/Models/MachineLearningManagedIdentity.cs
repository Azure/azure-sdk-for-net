...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningManagedIdentity : MachineLearningIdentityConfiguration
    {
        ...
        internal MachineLearningManagedIdentity(IdentityConfigurationType identityType, Guid? clientId, Guid? objectId, ResourceIdentifier resourceId, Dictionary<string, BinaryData> rawData) : base(identityType, rawData)
        {
            ClientId = clientId;
            ObjectId = objectId;
