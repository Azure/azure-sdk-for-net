...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HdfsDatastore>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HdfsDatastore>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HdfsDatastore>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HdfsDatastore>)} interface");
            }
        ...
        string IPersistableModel<HdfsDatastore>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
