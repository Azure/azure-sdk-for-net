...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SystemCreatedAcrAccount>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SystemCreatedAcrAccount>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SystemCreatedAcrAccount>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SystemCreatedAcrAccount>)} interface");
            }
        ...
        string IPersistableModel<SystemCreatedAcrAccount>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
