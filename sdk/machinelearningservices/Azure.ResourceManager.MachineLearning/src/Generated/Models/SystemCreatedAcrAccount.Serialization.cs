...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class SystemCreatedAcrAccount : IJsonModel<SystemCreatedAcrAccount>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SystemCreatedAcrAccount PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SystemCreatedAcrAccount>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SystemCreatedAcrAccount>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SystemCreatedAcrAccount IPersistableModel<SystemCreatedAcrAccount>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SystemCreatedAcrAccount IJsonModel<SystemCreatedAcrAccount>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SystemCreatedAcrAccount JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SystemCreatedAcrAccount>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SystemCreatedAcrAccount DeserializeSystemCreatedAcrAccount(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("acrAccountName"u8))
                {
                    ...
                    acrAccountName = prop.Value.GetString();
                    continue;
                }
                if (prop.NameEquals("acrAccountSku"u8))
                {
                    ...
                    acrAccountSku = prop.Value.GetString();
                    continue;
                }
