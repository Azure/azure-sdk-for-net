...
{
    public partial class MachineLearningStackEnsembleSettings : IUtf8JsonSerializable, IJsonModel<MachineLearningStackEnsembleSettings>, IPersistableModel<MachineLearningStackEnsembleSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StackMetaLearnerType))
            {
                ...
                builder.AppendLine($" '{StackMetaLearnerType.ToString()}'");
            }
