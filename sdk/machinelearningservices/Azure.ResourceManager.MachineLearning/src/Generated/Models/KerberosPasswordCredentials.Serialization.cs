...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KerberosPasswordCredentials>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KerberosPasswordCredentials>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KerberosPasswordCredentials>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KerberosPasswordCredentials>)} interface");
            }
        ...
        string IPersistableModel<KerberosPasswordCredentials>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
