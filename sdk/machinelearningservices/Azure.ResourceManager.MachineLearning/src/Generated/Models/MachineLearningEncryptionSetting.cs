...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningEncryptionSetting
    {
        ...
        internal MachineLearningEncryptionSetting(MachineLearningEncryptionStatus status, MachineLearningCmkIdentity identity, MachineLearningEncryptionKeyVaultProperties keyVaultProperties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Identity = identity;
            KeyVaultProperties = keyVaultProperties;
