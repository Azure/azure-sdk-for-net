...
{
    public partial class SynapseSparkCompute : IUtf8JsonSerializable
    {
        ...
        internal static SynapseSparkCompute DeserializeSynapseSparkCompute(JsonElement element)
        {
            Optional<SynapseSparkProperties> properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"))
                {
                    ...
                    properties = SynapseSparkProperties.DeserializeSynapseSparkProperties(property.Value);
                    continue;
                }
