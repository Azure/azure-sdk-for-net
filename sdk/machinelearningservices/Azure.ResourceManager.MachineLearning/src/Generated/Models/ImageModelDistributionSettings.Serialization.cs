...
{
    public partial class ImageModelDistributionSettings : IUtf8JsonSerializable, IModelJsonSerializable<ImageModelDistributionSettings>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ImageModelDistributionSettings>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ImageModelDistributionSettings>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ImageModelDistributionSettings>(this, options.Format);
        ...
        internal static ImageModelDistributionSettings DeserializeImageModelDistributionSettings(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ImageModelDistributionSettings(amsGradient.Value, augmentations.Value, beta1.Value, beta2.Value, distributed.Value, earlyStopping.Value, earlyStoppingDelay.Value, earlyStoppingPatience.Value, enableOnnxNormalization.Value, evaluationFrequency.Value, gradientAccumulationStep.Value, layersToFreeze.Value, learningRate.Value, learningRateScheduler.Value, modelName.Value, momentum.Value, nesterov.Value, numberOfEpochs.Value, numberOfWorkers.Value, optimizer.Value, randomSeed.Value, stepLRGamma.Value, stepLRStepSize.Value, trainingBatchSize.Value, validationBatchSize.Value, warmupCosineLRCycles.Value, warmupCosineLRWarmupEpochs.Value, weightDecay.Value, rawData);
        }

        ImageModelDistributionSettings IModelJsonSerializable<ImageModelDistributionSettings>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ImageModelDistributionSettings>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeImageModelDistributionSettings(doc.RootElement, options);
        }

        BinaryData IModelSerializable<ImageModelDistributionSettings>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ImageModelDistributionSettings>(this, options.Format);
        ...
        ImageModelDistributionSettings IModelSerializable<ImageModelDistributionSettings>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ImageModelDistributionSettings>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ImageModelDistributionSettings"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ImageModelDistributionSettings"/> to convert. </param>
        public static implicit operator RequestContent(ImageModelDistributionSettings model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ImageModelDistributionSettings"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ImageModelDistributionSettings(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeImageModelDistributionSettings(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
