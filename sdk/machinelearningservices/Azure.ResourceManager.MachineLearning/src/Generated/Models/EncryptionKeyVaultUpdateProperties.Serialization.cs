...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EncryptionKeyVaultUpdateProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EncryptionKeyVaultUpdateProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EncryptionKeyVaultUpdateProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EncryptionKeyVaultUpdateProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
