...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkspaceConnectionServicePrincipal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkspaceConnectionServicePrincipal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkspaceConnectionServicePrincipal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<WorkspaceConnectionServicePrincipal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
