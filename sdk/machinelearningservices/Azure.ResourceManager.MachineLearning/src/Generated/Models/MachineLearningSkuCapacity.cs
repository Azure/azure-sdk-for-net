...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningSkuCapacity
    {
        ...
        internal MachineLearningSkuCapacity(int? @default, int? maximum, int? minimum, MachineLearningSkuScaleType? scaleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Default = @default;
            Maximum = maximum;
            Minimum = minimum;
