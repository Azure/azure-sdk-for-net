...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningAccountKeyDatastoreCredentials : MachineLearningDatastoreCredentials
    {
        ...
        internal MachineLearningAccountKeyDatastoreCredentials(CredentialsType credentialsType, MachineLearningAccountKeyDatastoreSecrets secrets, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(credentialsType, serializedAdditionalRawData)
        {
            Secrets = secrets;
