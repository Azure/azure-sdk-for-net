...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TextClassificationMultilabel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TextClassificationMultilabel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TextClassificationMultilabel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TextClassificationMultilabel>)} interface");
            }
        ...
        string IPersistableModel<TextClassificationMultilabel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
