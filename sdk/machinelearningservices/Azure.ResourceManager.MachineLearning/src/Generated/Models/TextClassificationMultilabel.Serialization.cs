...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class TextClassificationMultilabel : IUtf8JsonSerializable, IModelJsonSerializable<TextClassificationMultilabel>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<TextClassificationMultilabel>(this, options.Format);
        ...
        internal static TextClassificationMultilabel DeserializeTextClassificationMultilabel(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new TextClassificationMultilabel(Optional.ToNullable(logVerbosity), targetColumnName.Value, taskType, trainingData, Optional.ToNullable(primaryMetric), featurizationSettings.Value, limitSettings.Value, validationData.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="TextClassificationMultilabel"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="TextClassificationMultilabel"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="TextClassificationMultilabel"/>. </summary>
