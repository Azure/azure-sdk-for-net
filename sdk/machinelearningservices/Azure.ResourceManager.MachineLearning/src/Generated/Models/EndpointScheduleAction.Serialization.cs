...
{
    public partial class EndpointScheduleAction : IUtf8JsonSerializable
    {
        ...
        internal static EndpointScheduleAction DeserializeEndpointScheduleAction(JsonElement element)
        {
            ...
            return new EndpointScheduleAction(actionType, endpointInvocationDefinition);
        }
    }
}
