...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningLiteralJobInput : MachineLearningJobInput
    {
        ...
        internal MachineLearningLiteralJobInput(string description, JobInputType jobInputType, string value, Dictionary<string, BinaryData> rawData) : base(description, jobInputType, rawData)
        {
            Value = value;
