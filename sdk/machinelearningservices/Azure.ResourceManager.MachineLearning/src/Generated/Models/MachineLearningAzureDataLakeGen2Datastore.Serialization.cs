...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningAzureDataLakeGen2Datastore : MachineLearningDatastoreProperties, IJsonModel<MachineLearningAzureDataLakeGen2Datastore>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningAzureDataLakeGen2Datastore>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningAzureDataLakeGen2Datastore>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningAzureDataLakeGen2Datastore IPersistableModel<MachineLearningAzureDataLakeGen2Datastore>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningAzureDataLakeGen2Datastore)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningAzureDataLakeGen2Datastore IJsonModel<MachineLearningAzureDataLakeGen2Datastore>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningAzureDataLakeGen2Datastore)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningAzureDataLakeGen2Datastore DeserializeMachineLearningAzureDataLakeGen2Datastore(JsonElement element, ModelReaderWriterOptions options)
        {
