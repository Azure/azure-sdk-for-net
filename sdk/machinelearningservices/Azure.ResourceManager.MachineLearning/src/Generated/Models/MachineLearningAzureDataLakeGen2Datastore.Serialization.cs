...
{
    public partial class MachineLearningAzureDataLakeGen2Datastore : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningAzureDataLakeGen2Datastore DeserializeMachineLearningAzureDataLakeGen2Datastore(JsonElement element)
        {
            ...
            return new MachineLearningAzureDataLakeGen2Datastore(description.Value, Core.Optional.ToDictionary(properties), Core.Optional.ToDictionary(tags), credentials, datastoreType, Core.Optional.ToNullable(isDefault), accountName, endpoint.Value, filesystem, protocol.Value, Core.Optional.ToNullable(serviceDataAccessAuthIdentity));
        }
    }
}
