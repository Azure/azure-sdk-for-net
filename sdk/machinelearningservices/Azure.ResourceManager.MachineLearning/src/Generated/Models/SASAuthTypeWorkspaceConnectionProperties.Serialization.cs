...
{
    public partial class SASAuthTypeWorkspaceConnectionProperties : IUtf8JsonSerializable
    {
        ...
        internal static SASAuthTypeWorkspaceConnectionProperties DeserializeSASAuthTypeWorkspaceConnectionProperties(JsonElement element)
        {
            ...
            return new SASAuthTypeWorkspaceConnectionProperties(authType, Optional.ToNullable(category), target.Value, value.Value, Optional.ToNullable(valueFormat), credentials.Value);
        }
    }
}
