...
{
    public partial class MachineLearningFeatureSetJob : IUtf8JsonSerializable, IJsonModel<MachineLearningFeatureSetJob>, IPersistableModel<MachineLearningFeatureSetJob>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExperimentId))
            {
                ...
                builder.AppendLine($" '{ExperimentId}'");
            }

            if (Optional.IsDefined(FeatureWindow))
            {
                builder.Append("  featureWindow:");
                AppendChildObject(builder, FeatureWindow, options, 2);
            }
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{FeatureStoreJobType.ToString()}'");
            }
