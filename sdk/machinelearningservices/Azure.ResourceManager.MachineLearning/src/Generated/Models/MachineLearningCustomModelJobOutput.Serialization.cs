...
{
    public partial class MachineLearningCustomModelJobOutput : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningCustomModelJobOutput DeserializeMachineLearningCustomModelJobOutput(JsonElement element)
        {
            ...
            return new MachineLearningCustomModelJobOutput(description.Value, jobOutputType, Core.Optional.ToNullable(mode), uri.Value);
        }
    }
}
