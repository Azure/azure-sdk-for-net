...
{
    public partial class MachineLearningDefaultScaleSettings : IUtf8JsonSerializable, IJsonModel<MachineLearningDefaultScaleSettings>, IPersistableModel<MachineLearningDefaultScaleSettings>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningDefaultScaleSettings>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MachineLearningDefaultScaleSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningDefaultScaleSettings)} does not support '{format}' format.");
            }
