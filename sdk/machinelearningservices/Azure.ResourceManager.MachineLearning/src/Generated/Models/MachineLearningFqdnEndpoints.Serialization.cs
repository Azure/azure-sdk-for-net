...
{
    public partial class MachineLearningFqdnEndpoints : IUtf8JsonSerializable, IJsonModel<MachineLearningFqdnEndpoints>, IPersistableModel<MachineLearningFqdnEndpoints>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningFqdnEndpoints>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MachineLearningFqdnEndpoints>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningFqdnEndpoints)} does not support '{format}' format.");
            }
