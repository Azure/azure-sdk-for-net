...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataDriftMonitoringSignal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataDriftMonitoringSignal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataDriftMonitoringSignal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataDriftMonitoringSignal>)} interface");
            }
        ...
        string IPersistableModel<DataDriftMonitoringSignal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
