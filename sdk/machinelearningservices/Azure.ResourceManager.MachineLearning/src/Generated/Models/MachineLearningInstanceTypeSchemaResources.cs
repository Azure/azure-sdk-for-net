...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningInstanceTypeSchemaResources
    {
        ...
        internal MachineLearningInstanceTypeSchemaResources(IDictionary<string, string> requests, IDictionary<string, string> limits, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Requests = requests;
            Limits = limits;
