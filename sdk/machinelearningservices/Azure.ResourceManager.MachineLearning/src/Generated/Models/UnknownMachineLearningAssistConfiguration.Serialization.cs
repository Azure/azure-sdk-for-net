...
{
    internal partial class UnknownMachineLearningAssistConfiguration : IUtf8JsonSerializable, IJsonModel<MachineLearningAssistConfiguration>
    {
        ...
        void IJsonModel<MachineLearningAssistConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningAssistConfiguration)} does not support writing '{format}' format.");
            }
        ...
        MachineLearningAssistConfiguration IJsonModel<MachineLearningAssistConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningAssistConfiguration)} does not support reading '{format}' format.");
            }
        ...
        internal static UnknownMachineLearningAssistConfiguration DeserializeUnknownMachineLearningAssistConfiguration(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownMachineLearningAssistConfiguration(mlAssist, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MachineLearningAssistConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MachineLearningAssistConfiguration)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MachineLearningAssistConfiguration IPersistableModel<MachineLearningAssistConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MachineLearningAssistConfiguration)} does not support reading '{options.Format}' format.");
            }
        }
