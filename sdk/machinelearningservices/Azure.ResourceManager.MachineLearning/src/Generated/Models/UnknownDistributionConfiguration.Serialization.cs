...
{
    internal partial class UnknownDistributionConfiguration : MachineLearningDistributionConfiguration, IJsonModel<MachineLearningDistributionConfiguration>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDistributionConfiguration DeserializeUnknownDistributionConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDistributionConfiguration(distributionType, additionalBinaryDataProperties);
        }
    }
}
