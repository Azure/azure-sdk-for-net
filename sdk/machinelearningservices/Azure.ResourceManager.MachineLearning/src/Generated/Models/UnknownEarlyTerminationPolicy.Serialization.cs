...
{
    internal partial class UnknownEarlyTerminationPolicy : MachineLearningEarlyTerminationPolicy, IJsonModel<MachineLearningEarlyTerminationPolicy>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownEarlyTerminationPolicy DeserializeUnknownEarlyTerminationPolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownEarlyTerminationPolicy(delayEvaluation, evaluationInterval, policyType, additionalBinaryDataProperties);
        }
    }
}
