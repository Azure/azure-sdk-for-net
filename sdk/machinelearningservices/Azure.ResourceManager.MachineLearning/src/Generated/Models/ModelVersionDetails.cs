...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    public partial class ModelVersionDetails : AssetBase
    {
        /// <summary> Initializes a new instance of ModelVersionDetails. </summary>
        ...
        internal ModelVersionDetails(string description, IDictionary<string, string> properties, IDictionary<string, string> tags, bool? isAnonymous, bool? isArchived, IDictionary<string, FlavorData> flavors, string jobName, ModelType? modelType, Uri modelUri) : base(description, properties, tags, isAnonymous, isArchived)
        {
            Flavors = flavors;
            JobName = jobName;
            ModelType = modelType;
