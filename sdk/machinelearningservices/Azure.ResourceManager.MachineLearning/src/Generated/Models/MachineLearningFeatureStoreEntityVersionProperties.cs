...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningFeatureStoreEntityVersionProperties : MachineLearningAssetBase
    {
        ...
        internal MachineLearningFeatureStoreEntityVersionProperties(string description, IDictionary<string, string> properties, IDictionary<string, string> tags, AutoDeleteSetting autoDeleteSetting, bool? isAnonymous, bool? isArchived, IList<IndexColumn> indexColumns, RegistryAssetProvisioningState? provisioningState, string stage) : base(description, properties, tags, autoDeleteSetting, isAnonymous, isArchived)
        {
