...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningSasAuthTypeWorkspaceConnection : MachineLearningWorkspaceConnectionProperties, IJsonModel<MachineLearningSasAuthTypeWorkspaceConnection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningSasAuthTypeWorkspaceConnection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningSasAuthTypeWorkspaceConnection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningSasAuthTypeWorkspaceConnection IPersistableModel<MachineLearningSasAuthTypeWorkspaceConnection>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningSasAuthTypeWorkspaceConnection)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningSasAuthTypeWorkspaceConnection IJsonModel<MachineLearningSasAuthTypeWorkspaceConnection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningSasAuthTypeWorkspaceConnection)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningSasAuthTypeWorkspaceConnection DeserializeMachineLearningSasAuthTypeWorkspaceConnection(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("credentials"u8))
                {
                    ...
                    credentials = WorkspaceConnectionSharedAccessSignature.DeserializeWorkspaceConnectionSharedAccessSignature(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
