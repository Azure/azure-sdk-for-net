...
{
    public partial class MachineLearningSasAuthTypeWorkspaceConnection : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningSasAuthTypeWorkspaceConnection DeserializeMachineLearningSasAuthTypeWorkspaceConnection(JsonElement element)
        {
            ...
            Core.Optional<WorkspaceConnectionSharedAccessSignature> credentials = default;
            ...
            return new MachineLearningSasAuthTypeWorkspaceConnection(authType, Core.Optional.ToNullable(category), target.Value, value.Value, Core.Optional.ToNullable(valueFormat), credentials.Value);
        }
    }
}
