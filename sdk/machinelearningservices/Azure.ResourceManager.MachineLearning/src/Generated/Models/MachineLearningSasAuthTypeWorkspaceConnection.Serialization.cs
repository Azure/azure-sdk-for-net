...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningSasAuthTypeWorkspaceConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningSasAuthTypeWorkspaceConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningSasAuthTypeWorkspaceConnection>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningSasAuthTypeWorkspaceConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
