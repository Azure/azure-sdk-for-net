...
{
    public partial class MachineLearningFeatureSetContainerProperties : IUtf8JsonSerializable, IJsonModel<MachineLearningFeatureSetContainerProperties>, IPersistableModel<MachineLearningFeatureSetContainerProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningFeatureSetContainerProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MachineLearningFeatureSetContainerProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningFeatureSetContainerProperties)} does not support '{format}' format.");
            }
