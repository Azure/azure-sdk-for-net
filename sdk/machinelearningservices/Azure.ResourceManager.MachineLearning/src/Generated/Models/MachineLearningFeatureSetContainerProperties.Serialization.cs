...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningFeatureSetContainerProperties>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MachineLearningFeatureSetContainerProperties IJsonModel<MachineLearningFeatureSetContainerProperties>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(MachineLearningFeatureSetContainerProperties)} does not support '{options.Format}' format.");
            }
        ...
        internal static MachineLearningFeatureSetContainerProperties DeserializeMachineLearningFeatureSetContainerProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MachineLearningFeatureSetContainerProperties(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), serializedAdditionalRawData, Optional.ToNullable(isArchived), latestVersion.Value, nextVersion.Value, Optional.ToNullable(provisioningState));
        }

        BinaryData IModel<MachineLearningFeatureSetContainerProperties>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MachineLearningFeatureSetContainerProperties IModel<MachineLearningFeatureSetContainerProperties>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MachineLearningFeatureSetContainerProperties>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
