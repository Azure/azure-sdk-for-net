...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningFeatureSetContainerProperties : MachineLearningAssetContainer, IJsonModel<MachineLearningFeatureSetContainerProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningFeatureSetContainerProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningFeatureSetContainerProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningFeatureSetContainerProperties IPersistableModel<MachineLearningFeatureSetContainerProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningFeatureSetContainerProperties)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningFeatureSetContainerProperties IJsonModel<MachineLearningFeatureSetContainerProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningFeatureSetContainerProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningFeatureSetContainerProperties DeserializeMachineLearningFeatureSetContainerProperties(JsonElement element, ModelReaderWriterOptions options)
        {
