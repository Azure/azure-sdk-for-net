...
{
    public partial class Ray : IUtf8JsonSerializable
    {
        ...
        internal static Ray DeserializeRay(JsonElement element)
        {
            ...
            return new Ray(distributionType, address.Value, Optional.ToNullable(dashboardPort), headNodeAdditionalArgs.Value, Optional.ToNullable(includeDashboard), Optional.ToNullable(port), workerNodeAdditionalArgs.Value);
        }
    }
}
