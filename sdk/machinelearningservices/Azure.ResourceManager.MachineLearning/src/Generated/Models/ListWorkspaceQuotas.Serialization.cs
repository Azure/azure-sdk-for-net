...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class ListWorkspaceQuotas : IUtf8JsonSerializable, IJsonModel<ListWorkspaceQuotas>
    {
        ...
        void IJsonModel<ListWorkspaceQuotas>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ListWorkspaceQuotas)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (options.Format != "W" && !(Value is ChangeTrackingList<MachineLearningResourceQuota> collection && collection.IsUndefined))
            {
        ...
        internal static ListWorkspaceQuotas DeserializeListWorkspaceQuotas(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ListWorkspaceQuotas(value ?? new ChangeTrackingList<MachineLearningResourceQuota>(), nextLink.Value, serializedAdditionalRawData);
        }
