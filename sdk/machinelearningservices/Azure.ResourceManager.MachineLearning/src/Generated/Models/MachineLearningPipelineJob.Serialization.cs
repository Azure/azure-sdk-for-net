...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningPipelineJob>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningPipelineJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningPipelineJob>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningPipelineJob>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningPipelineJob>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
