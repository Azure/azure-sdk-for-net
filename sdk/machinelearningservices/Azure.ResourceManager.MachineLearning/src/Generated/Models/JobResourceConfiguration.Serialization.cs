...
{
    public partial class JobResourceConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static JobResourceConfiguration DeserializeJobResourceConfiguration(JsonElement element)
        {
            ...
            return new JobResourceConfiguration(Optional.ToNullable(instanceCount), instanceType.Value, Optional.ToDictionary(properties), dockerArgs.Value, shmSize.Value);
        }
    }
}
