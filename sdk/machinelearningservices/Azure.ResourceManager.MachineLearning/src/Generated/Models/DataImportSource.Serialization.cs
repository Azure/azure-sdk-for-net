...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class DataImportSource : IUtf8JsonSerializable, IJsonModel<DataImportSource>
    {
        ...
        void IJsonModel<DataImportSource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DataImportSource)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataImportSource>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DataImportSource)} does not support '{options.Format}' format.");
            }
        }
