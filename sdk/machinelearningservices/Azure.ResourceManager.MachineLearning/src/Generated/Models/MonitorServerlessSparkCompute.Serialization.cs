...
{
    public partial class MonitorServerlessSparkCompute : IUtf8JsonSerializable, IJsonModel<MonitorServerlessSparkCompute>, IPersistableModel<MonitorServerlessSparkCompute>
    {
        ...
        void IJsonModel<MonitorServerlessSparkCompute>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MonitorServerlessSparkCompute)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ComputeIdentity))
            {
                ...
                AppendChildObject(builder, ComputeIdentity, options, 2);
            }
