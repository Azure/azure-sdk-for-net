...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorServerlessSparkCompute>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorServerlessSparkCompute>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorServerlessSparkCompute>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MonitorServerlessSparkCompute>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
