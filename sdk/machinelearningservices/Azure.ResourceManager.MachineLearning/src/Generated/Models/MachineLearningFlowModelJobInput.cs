...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningFlowModelJobInput : MachineLearningJobInput
    {
        ...
        internal MachineLearningFlowModelJobInput(string description, JobInputType jobInputType, MachineLearningInputDeliveryMode? mode, Uri uri, Dictionary<string, BinaryData> rawData) : base(description, jobInputType, rawData)
        {
            Mode = mode;
            Uri = uri;
