...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningSharedPrivateLinkResource
    {
        ...
        internal MachineLearningSharedPrivateLinkResource(string name, ResourceIdentifier privateLinkResourceId, string groupId, string requestMessage, MachineLearningPrivateEndpointServiceConnectionStatus? status, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
