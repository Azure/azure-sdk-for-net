...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartialJobBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartialJobBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartialJobBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartialJobBase>)} interface");
            }
        ...
        string IPersistableModel<PartialJobBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
