...
{
    internal partial class UnknownMachineLearningOnlineDeploymentProperties : MachineLearningOnlineDeploymentProperties, IJsonModel<MachineLearningOnlineDeploymentProperties>
    {
        ...
        {
            return (MachineLearningOnlineDeploymentProperties)PersistableModelCreateCore(data, options);
        }
        ...
        {
            return (MachineLearningOnlineDeploymentProperties)JsonModelCreateCore(ref reader, options);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningOnlineDeploymentProperties DeserializeUnknownMachineLearningOnlineDeploymentProperties(JsonElement element, ModelReaderWriterOptions options)
        {
