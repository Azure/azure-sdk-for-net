...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningTableJobInput : MachineLearningJobInput
    {
        ...
        internal MachineLearningTableJobInput(string description, JobInputType jobInputType, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(description, jobInputType, serializedAdditionalRawData)
        {
