...
{
    internal partial class UnknownIdentityConfiguration : MachineLearningIdentityConfiguration, IJsonModel<MachineLearningIdentityConfiguration>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningIdentityConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningIdentityConfiguration>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownIdentityConfiguration DeserializeUnknownIdentityConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownIdentityConfiguration(identityType, additionalBinaryDataProperties);
        }
    }
}
