...
{
    public partial class MachineLearningEndpointAuthToken : IUtf8JsonSerializable, IJsonModel<MachineLearningEndpointAuthToken>, IPersistableModel<MachineLearningEndpointAuthToken>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RefreshOn))
            {
                ...
                builder.AppendLine($" '{RefreshOn.Value.ToString()}'");
            }
