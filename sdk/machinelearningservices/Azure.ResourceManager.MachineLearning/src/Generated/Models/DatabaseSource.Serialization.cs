...
{
    public partial class DatabaseSource : IUtf8JsonSerializable, IJsonModel<DatabaseSource>, IPersistableModel<DatabaseSource>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StoredProcedure))
            {
                ...
                builder.AppendLine($" '{StoredProcedure}'");
            }

            if (Optional.IsCollectionDefined(StoredProcedureParams))
            {
                builder.Append("  storedProcedureParams:");
                builder.AppendLine(" [");
                foreach (var item in StoredProcedureParams)
                {
                    if (item == null)
