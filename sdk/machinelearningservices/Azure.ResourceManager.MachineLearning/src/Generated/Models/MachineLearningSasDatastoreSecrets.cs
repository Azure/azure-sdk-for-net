...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningSasDatastoreSecrets : MachineLearningDatastoreSecrets
    {
        ...
        internal MachineLearningSasDatastoreSecrets(SecretsType secretsType, string sasToken, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(secretsType, serializedAdditionalRawData)
        {
            SasToken = sasToken;
