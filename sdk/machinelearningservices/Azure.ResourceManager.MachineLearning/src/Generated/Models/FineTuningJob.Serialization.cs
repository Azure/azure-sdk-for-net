...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class FineTuningJob : MachineLearningJobProperties, IJsonModel<FineTuningJob>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        FineTuningJob IPersistableModel<FineTuningJob>.Create(BinaryData data, ModelReaderWriterOptions options) => (FineTuningJob)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FineTuningJob IJsonModel<FineTuningJob>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (FineTuningJob)JsonModelCreateCore(ref reader, options);
        ...
        internal static FineTuningJob DeserializeFineTuningJob(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    fineTuningDetails = FineTuningVertical.DeserializeFineTuningVertical(prop.Value, options);
                    continue;
                }
