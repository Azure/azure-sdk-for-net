...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningSweepJob : IUtf8JsonSerializable, IJsonModel<MachineLearningSweepJob>
    {
        ...
        void IJsonModel<MachineLearningSweepJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            BinaryData data0 = ModelReaderWriter.Write(Objective, options);
#if NET6_0_OR_GREATER
            ...
            if (Optional.IsDefined(QueueSettings))
            {
                if (QueueSettings != null)
                {
                    ...
                    BinaryData data = ModelReaderWriter.Write(QueueSettings, options);
#if NET6_0_OR_GREATER
				writer.WriteRawValue(data);
#else
                    using (JsonDocument document = JsonDocument.Parse(data))
            ...
            BinaryData data1 = ModelReaderWriter.Write(SamplingAlgorithm, options);
#if NET6_0_OR_GREATER
            ...
            BinaryData data2 = ModelReaderWriter.Write(Trial, options);
#if NET6_0_OR_GREATER
