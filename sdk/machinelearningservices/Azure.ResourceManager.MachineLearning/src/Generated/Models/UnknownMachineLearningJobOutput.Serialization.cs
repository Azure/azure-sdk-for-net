...
{
    internal partial class UnknownMachineLearningJobOutput : IUtf8JsonSerializable, IJsonModel<MachineLearningJobOutput>
    {
        ...
        internal static UnknownMachineLearningJobOutput DeserializeUnknownMachineLearningJobOutput(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownMachineLearningJobOutput(description, jobOutputType, serializedAdditionalRawData);
        }
