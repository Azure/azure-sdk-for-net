...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MachineLearningUsernamePasswordAuthTypeWorkspaceConnection IJsonModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(MachineLearningUsernamePasswordAuthTypeWorkspaceConnection)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MachineLearningUsernamePasswordAuthTypeWorkspaceConnection IModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
