...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningUsernamePasswordAuthTypeWorkspaceConnection : MachineLearningWorkspaceConnectionProperties, IJsonModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningUsernamePasswordAuthTypeWorkspaceConnection IPersistableModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningUsernamePasswordAuthTypeWorkspaceConnection)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningUsernamePasswordAuthTypeWorkspaceConnection IJsonModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningUsernamePasswordAuthTypeWorkspaceConnection)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningUsernamePasswordAuthTypeWorkspaceConnection DeserializeMachineLearningUsernamePasswordAuthTypeWorkspaceConnection(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("credentials"u8))
                {
                    ...
                    credentials = MachineLearningWorkspaceConnectionUsernamePassword.DeserializeMachineLearningWorkspaceConnectionUsernamePassword(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
