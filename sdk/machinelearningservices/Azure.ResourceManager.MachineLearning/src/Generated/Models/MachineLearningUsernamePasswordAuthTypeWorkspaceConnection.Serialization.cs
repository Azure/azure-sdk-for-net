...
{
    public partial class MachineLearningUsernamePasswordAuthTypeWorkspaceConnection : IUtf8JsonSerializable, IJsonModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>, IPersistableModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningUsernamePasswordAuthTypeWorkspaceConnection)} does not support '{format}' format.");
            }
