...
{
    public partial class MachineLearningUsernamePasswordAuthTypeWorkspaceConnection : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningUsernamePasswordAuthTypeWorkspaceConnection DeserializeMachineLearningUsernamePasswordAuthTypeWorkspaceConnection(JsonElement element)
        {
            ...
            Core.Optional<MachineLearningWorkspaceConnectionUsernamePassword> credentials = default;
            ...
            return new MachineLearningUsernamePasswordAuthTypeWorkspaceConnection(authType, Core.Optional.ToNullable(category), target.Value, value.Value, Core.Optional.ToNullable(valueFormat), credentials.Value);
        }
    }
}
