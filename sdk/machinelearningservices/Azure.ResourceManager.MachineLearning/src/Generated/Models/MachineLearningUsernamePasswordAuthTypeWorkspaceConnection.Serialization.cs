...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningUsernamePasswordAuthTypeWorkspaceConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
