...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningOnlineDeploymentPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningOnlineDeploymentPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningOnlineDeploymentPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningOnlineDeploymentPatch>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningOnlineDeploymentPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
