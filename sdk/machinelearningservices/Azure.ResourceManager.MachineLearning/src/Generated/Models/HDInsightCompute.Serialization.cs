...
{
    public partial class HDInsightCompute : IUtf8JsonSerializable
    {
        ...
        internal static HDInsightCompute DeserializeHDInsightCompute(JsonElement element)
        {
            ...
            return new HDInsightCompute(computeType, computeLocation.Value, Optional.ToNullable(provisioningState), description.Value, Optional.ToNullable(createdOn), Optional.ToNullable(modifiedOn), resourceId.Value, Optional.ToList(provisioningErrors), Optional.ToNullable(isAttachedCompute), Optional.ToNullable(disableLocalAuth), properties.Value);
        }
    }
}
