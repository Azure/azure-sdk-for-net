...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomKeysWorkspaceConnectionProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomKeysWorkspaceConnectionProperties)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsDefined(Credentials))
            {
                ...
                ((IJsonModel<CustomKeys>)Credentials).Write(writer, options);
            }
        }
        ...
        CustomKeysWorkspaceConnectionProperties IJsonModel<CustomKeysWorkspaceConnectionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CustomKeysWorkspaceConnectionProperties)} does not support reading '{format}' format.");
            }
        ...
        internal static CustomKeysWorkspaceConnectionProperties DeserializeCustomKeysWorkspaceConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            CustomKeys credentials = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credentials"u8))
                {
                    ...
                    credentials = ModelSerializationExtensions.JsonDeserialize<CustomKeys>(property.Value);
                    continue;
                }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue("CredentialsKeys", out propertyOverride);
        ...
        BinaryData IPersistableModel<CustomKeysWorkspaceConnectionProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CustomKeysWorkspaceConnectionProperties)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CustomKeysWorkspaceConnectionProperties IPersistableModel<CustomKeysWorkspaceConnectionProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CustomKeysWorkspaceConnectionProperties)} does not support reading '{options.Format}' format.");
            }
        }
