...
{
    internal partial class UnknownDataReferenceCredential : DataReferenceCredential, IJsonModel<DataReferenceCredential>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataReferenceCredential DeserializeUnknownDataReferenceCredential(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDataReferenceCredential(credentialType, additionalBinaryDataProperties);
        }
    }
}
