...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class NumericalDataDriftMetricThreshold : DataDriftMetricThresholdBase
    {
        ...
        public NumericalDataDriftMetricThreshold(NumericalDataDriftMetric metric) : base(MonitoringFeatureDataType.Numerical)
        {
            Metric = metric;
        }
        ...
        /// <param name="metric"> [Required] The numerical data drift metric to calculate. </param>
        internal NumericalDataDriftMetricThreshold(MonitoringFeatureDataType dataType, MonitoringThreshold threshold, IDictionary<string, BinaryData> additionalBinaryDataProperties, NumericalDataDriftMetric metric) : base(dataType, threshold, additionalBinaryDataProperties)
        {
            Metric = metric;
        }
