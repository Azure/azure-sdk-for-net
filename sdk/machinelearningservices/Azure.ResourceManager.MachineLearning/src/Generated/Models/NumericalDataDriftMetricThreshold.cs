...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        /// <summary> Initializes a new instance of NumericalDataDriftMetricThreshold. </summary>
        ...
        /// <param name="metric"> [Required] The numerical data drift metric to calculate. </param>
        internal NumericalDataDriftMetricThreshold(MonitoringFeatureDataType dataType, MonitoringThreshold threshold, NumericalDataDriftMetric metric) : base(dataType, threshold)
        {
            Metric = metric;
            DataType = dataType;
        }
