...
{
    public partial class BatchEndpointData : IUtf8JsonSerializable
    {
        ...
        internal static BatchEndpointData DeserializeBatchEndpointData(JsonElement element)
        {
            ...
            return new BatchEndpointData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, kind.Value, properties, sku.Value);
        }
    }
}
