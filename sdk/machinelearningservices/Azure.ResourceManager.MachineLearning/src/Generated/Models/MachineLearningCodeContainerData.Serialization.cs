...
{
    public partial class MachineLearningCodeContainerData : IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningCodeContainerData DeserializeMachineLearningCodeContainerData(JsonElement element)
        {
            ...
            return new MachineLearningCodeContainerData(id, name, type, systemData.Value, properties);
        }
    }
}
