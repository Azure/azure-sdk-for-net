...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataVersionBaseResourceArmPaginatedResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<MachineLearningDataVersionData>)item).Write(writer, options);
                }
        ...
        internal static DataVersionBaseResourceArmPaginatedResult DeserializeDataVersionBaseResourceArmPaginatedResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DataVersionBaseResourceArmPaginatedResult(value ?? new ChangeTrackingList<MachineLearningDataVersionData>(), nextLink, serializedAdditionalRawData);
        }
