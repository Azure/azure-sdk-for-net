...
{
    public partial class FeaturizationSettings : IUtf8JsonSerializable
    {
        ...
        internal static FeaturizationSettings DeserializeFeaturizationSettings(JsonElement element)
        {
            ...
            return new FeaturizationSettings(datasetLanguage.Value);
        }
    }
}
