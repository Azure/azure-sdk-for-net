...
{
    public partial class KubernetesCompute : IUtf8JsonSerializable
    {
        ...
        internal static KubernetesCompute DeserializeKubernetesCompute(JsonElement element)
        {
            ...
            return new KubernetesCompute(computeType, computeLocation.Value, Optional.ToNullable(provisioningState), description.Value, Optional.ToNullable(createdOn), Optional.ToNullable(modifiedOn), resourceId.Value, Optional.ToList(provisioningErrors), Optional.ToNullable(isAttachedCompute), Optional.ToNullable(disableLocalAuth), properties.Value);
        }
    }
}
