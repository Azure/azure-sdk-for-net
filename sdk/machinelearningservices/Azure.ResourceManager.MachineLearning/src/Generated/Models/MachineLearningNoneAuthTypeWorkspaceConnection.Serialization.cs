...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningNoneAuthTypeWorkspaceConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningNoneAuthTypeWorkspaceConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningNoneAuthTypeWorkspaceConnection>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningNoneAuthTypeWorkspaceConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
