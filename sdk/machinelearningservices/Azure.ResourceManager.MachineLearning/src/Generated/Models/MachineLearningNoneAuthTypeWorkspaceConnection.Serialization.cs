...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningNoneAuthTypeWorkspaceConnection : MachineLearningWorkspaceConnectionProperties, IJsonModel<MachineLearningNoneAuthTypeWorkspaceConnection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningNoneAuthTypeWorkspaceConnection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningNoneAuthTypeWorkspaceConnection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningNoneAuthTypeWorkspaceConnection IPersistableModel<MachineLearningNoneAuthTypeWorkspaceConnection>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningNoneAuthTypeWorkspaceConnection)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningNoneAuthTypeWorkspaceConnection IJsonModel<MachineLearningNoneAuthTypeWorkspaceConnection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningNoneAuthTypeWorkspaceConnection)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningNoneAuthTypeWorkspaceConnection DeserializeMachineLearningNoneAuthTypeWorkspaceConnection(JsonElement element, ModelReaderWriterOptions options)
        {
