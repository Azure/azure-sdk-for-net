...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningNoneAuthTypeWorkspaceConnection : IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningNoneAuthTypeWorkspaceConnection DeserializeMachineLearningNoneAuthTypeWorkspaceConnection(JsonElement element)
        {
            ...
            return new MachineLearningNoneAuthTypeWorkspaceConnection(authType, Optional.ToNullable(category), Optional.ToNullable(expiryTime), metadata.Value, target.Value);
        }
    }
}
