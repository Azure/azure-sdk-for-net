...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningWorkspaceDiagnoseContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningWorkspaceDiagnoseContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningWorkspaceDiagnoseContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningWorkspaceDiagnoseContent>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningWorkspaceDiagnoseContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
