...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningComputeInstanceCreatedBy
    {
        ...
        internal MachineLearningComputeInstanceCreatedBy(string userName, string userOrgId, string userId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UserName = userName;
            UserOrgId = userOrgId;
            UserId = userId;
