...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitorDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitorDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitorDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitorDefinition>)} interface");
            }
        ...
        string IPersistableModel<MonitorDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
