...
{
    public partial class DataDriftMetricThresholdBase : IUtf8JsonSerializable
    {
        ...
        internal static DataDriftMetricThresholdBase DeserializeDataDriftMetricThresholdBase(JsonElement element)
        {
