...
{
    public partial class EnvironmentVersionDetails : IUtf8JsonSerializable
    {
        ...
        internal static EnvironmentVersionDetails DeserializeEnvironmentVersionDetails(JsonElement element)
        {
            ...
            return new EnvironmentVersionDetails(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), build.Value, condaFile.Value, Optional.ToNullable(environmentType), image.Value, inferenceConfig.Value, Optional.ToNullable(osType));
        }
    }
}
