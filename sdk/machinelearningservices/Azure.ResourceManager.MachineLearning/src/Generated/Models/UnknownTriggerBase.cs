...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class UnknownTriggerBase : MachineLearningTriggerBase
    {
        ...
        internal UnknownTriggerBase(string endTime, string startTime, string timeZone, MachineLearningTriggerType triggerType, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(endTime, startTime, timeZone, triggerType != default ? triggerType : "unknown", additionalBinaryDataProperties)
        {
        }
    }
}
