...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningKubernetesProperties
    {
        ...
        internal MachineLearningKubernetesProperties(string relayConnectionString, string serviceBusConnectionString, string extensionPrincipalId, string extensionInstanceReleaseTrain, string vcName, string @namespace, string defaultInstanceType, IDictionary<string, MachineLearningInstanceTypeSchema> instanceTypes, Dictionary<string, BinaryData> rawData)
        {
