...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningComputeRecurrenceSchedule
    {
        ...
        internal MachineLearningComputeRecurrenceSchedule(IList<int> hours, IList<int> minutes, IList<int> monthDays, IList<MachineLearningComputeWeekDay> weekDays, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Hours = hours;
            Minutes = minutes;
            MonthDays = monthDays;
