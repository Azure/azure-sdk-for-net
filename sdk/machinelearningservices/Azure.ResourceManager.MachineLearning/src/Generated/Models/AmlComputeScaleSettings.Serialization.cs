...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class AmlComputeScaleSettings : IJsonModel<AmlComputeScaleSettings>
    {
        ...
        protected virtual AmlComputeScaleSettings PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AmlComputeScaleSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AmlComputeScaleSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AmlComputeScaleSettings IPersistableModel<AmlComputeScaleSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AmlComputeScaleSettings IJsonModel<AmlComputeScaleSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual AmlComputeScaleSettings JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<AmlComputeScaleSettings>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AmlComputeScaleSettings DeserializeAmlComputeScaleSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("nodeIdleTimeBeforeScaleDown"u8))
                {
                    if (prop.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    nodeIdleTimeBeforeScaleDown = prop.Value.GetTimeSpan("P");
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new AmlComputeScaleSettings(maxNodeCount, minNodeCount, nodeIdleTimeBeforeScaleDown, additionalBinaryDataProperties);
        }
    }
}
