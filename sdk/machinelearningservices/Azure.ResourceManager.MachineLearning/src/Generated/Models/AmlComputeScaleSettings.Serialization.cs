...
{
    public partial class AmlComputeScaleSettings : IUtf8JsonSerializable, IJsonModel<AmlComputeScaleSettings>, IPersistableModel<AmlComputeScaleSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxNodeCount))
            {
                ...
                builder.AppendLine($" '{MaxNodeCount.ToString()}'");
            }
            ...
            if (Optional.IsDefined(NodeIdleTimeBeforeScaleDown))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(NodeIdleTimeBeforeScaleDown.Value);
