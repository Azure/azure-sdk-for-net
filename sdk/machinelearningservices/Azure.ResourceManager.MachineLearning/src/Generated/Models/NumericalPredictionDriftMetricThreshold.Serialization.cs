...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NumericalPredictionDriftMetricThreshold>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NumericalPredictionDriftMetricThreshold>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NumericalPredictionDriftMetricThreshold>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NumericalPredictionDriftMetricThreshold>)} interface");
            }
        ...
        string IPersistableModel<NumericalPredictionDriftMetricThreshold>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
