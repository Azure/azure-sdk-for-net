...
{
    public partial class RegistryPrivateEndpoint : IUtf8JsonSerializable, IJsonModel<RegistryPrivateEndpoint>, IPersistableModel<RegistryPrivateEndpoint>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegistryPrivateEndpoint>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RegistryPrivateEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RegistryPrivateEndpoint)} does not support '{format}' format.");
            }
