...
{
    public partial class MachineLearningEnvironmentContainerProperties : IUtf8JsonSerializable, IJsonModel<MachineLearningEnvironmentContainerProperties>, IPersistableModel<MachineLearningEnvironmentContainerProperties>
    {
        ...
        void IJsonModel<MachineLearningEnvironmentContainerProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningEnvironmentContainerProperties)} does not support '{format}' format.");
            }
