...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        internal static FeaturesetJob DeserializeFeaturesetJob(JsonElement element)
        {
            ...
            return new FeaturesetJob(Optional.ToNullable(createdDate), displayName.Value, Optional.ToNullable(duration), experimentId.Value, featureWindow.Value, jobId.Value, Optional.ToNullable(status), Optional.ToDictionary(tags), Optional.ToNullable(type));
        }
    }
}
