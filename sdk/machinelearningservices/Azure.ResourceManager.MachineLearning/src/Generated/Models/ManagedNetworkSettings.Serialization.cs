...
{
    public partial class ManagedNetworkSettings : IUtf8JsonSerializable, IJsonModel<ManagedNetworkSettings>, IPersistableModel<ManagedNetworkSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsolationMode))
            {
                ...
                builder.AppendLine($" '{IsolationMode.ToString()}'");
            }
