...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CreateMonitorAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CreateMonitorAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CreateMonitorAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CreateMonitorAction>)} interface");
            }
        ...
        string IPersistableModel<CreateMonitorAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
