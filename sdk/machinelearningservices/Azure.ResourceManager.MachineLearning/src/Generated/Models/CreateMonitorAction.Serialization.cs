...
{
    public partial class CreateMonitorAction : IUtf8JsonSerializable, IJsonModel<CreateMonitorAction>, IPersistableModel<CreateMonitorAction>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MonitorDefinition))
            {
                ...
                AppendChildObject(builder, MonitorDefinition, options, 2);
            }
