...
{
    public partial class FeaturestoreEntityVersionProperties : IUtf8JsonSerializable
    {
        ...
        internal static FeaturestoreEntityVersionProperties DeserializeFeaturestoreEntityVersionProperties(JsonElement element)
        {
            ...
            return new FeaturestoreEntityVersionProperties(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), autoDeleteSetting.Value, Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), Optional.ToList(indexColumns), Optional.ToNullable(provisioningState), stage.Value);
        }
    }
}
