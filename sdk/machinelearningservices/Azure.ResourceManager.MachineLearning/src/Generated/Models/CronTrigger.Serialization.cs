...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class CronTrigger : IUtf8JsonSerializable, IModelJsonSerializable<CronTrigger>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CronTrigger>(this, options.Format);
        ...
        internal static CronTrigger DeserializeCronTrigger(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CronTrigger(endTime.Value, startTime.Value, timeZone.Value, triggerType, expression, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="CronTrigger"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CronTrigger"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CronTrigger"/>. </summary>
