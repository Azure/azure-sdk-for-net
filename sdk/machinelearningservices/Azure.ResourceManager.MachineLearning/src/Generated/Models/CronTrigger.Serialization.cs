...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CronTrigger>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CronTrigger>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CronTrigger>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CronTrigger>)} interface");
            }
        ...
        string IPersistableModel<CronTrigger>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
