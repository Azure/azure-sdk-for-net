...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitoringTarget>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitoringTarget>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitoringTarget>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitoringTarget>)} interface");
            }
        ...
        string IPersistableModel<MonitoringTarget>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
