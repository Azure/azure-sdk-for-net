...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FeatureAttributionDriftMonitoringSignal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FeatureAttributionDriftMonitoringSignal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FeatureAttributionDriftMonitoringSignal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FeatureAttributionDriftMonitoringSignal>)} interface");
            }
        ...
        string IPersistableModel<FeatureAttributionDriftMonitoringSignal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
