...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FeatureAttributionDriftMonitoringSignal>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        FeatureAttributionDriftMonitoringSignal IJsonModel<FeatureAttributionDriftMonitoringSignal>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static FeatureAttributionDriftMonitoringSignal DeserializeFeatureAttributionDriftMonitoringSignal(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new FeatureAttributionDriftMonitoringSignal(Optional.ToNullable(mode), Optional.ToDictionary(properties), signalType, serializedAdditionalRawData, metricThreshold, productionData, referenceData);
        }

        BinaryData IModel<FeatureAttributionDriftMonitoringSignal>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        FeatureAttributionDriftMonitoringSignal IModel<FeatureAttributionDriftMonitoringSignal>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<FeatureAttributionDriftMonitoringSignal>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
