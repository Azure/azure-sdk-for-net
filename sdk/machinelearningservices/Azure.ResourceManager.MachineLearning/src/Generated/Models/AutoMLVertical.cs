...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownAutoMLVertical))]
    public abstract partial class AutoMLVertical
    {
        ...
        internal AutoMLVertical(MachineLearningLogVerbosity? logVerbosity, string targetColumnName, TaskType taskType, MachineLearningTableJobInput trainingData, Dictionary<string, BinaryData> rawData)
        {
