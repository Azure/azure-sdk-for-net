...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningUriFolderJobInput : MachineLearningJobInput
    {
        ...
        internal MachineLearningUriFolderJobInput(string description, JobInputType jobInputType, MachineLearningInputDeliveryMode? mode, Uri uri, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(description, jobInputType, serializedAdditionalRawData)
        {
            Mode = mode;
            Uri = uri;
