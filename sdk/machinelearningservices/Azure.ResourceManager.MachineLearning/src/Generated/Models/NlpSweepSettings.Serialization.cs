...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NlpSweepSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NlpSweepSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NlpSweepSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NlpSweepSettings>)} interface");
            }
        ...
        string IPersistableModel<NlpSweepSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
