...
{
    public partial class MachineLearningJobScheduleAction : IUtf8JsonSerializable, IJsonModel<MachineLearningJobScheduleAction>, IPersistableModel<MachineLearningJobScheduleAction>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(JobDefinition))
            {
                ...
                AppendChildObject(builder, JobDefinition, options, 2);
            }
