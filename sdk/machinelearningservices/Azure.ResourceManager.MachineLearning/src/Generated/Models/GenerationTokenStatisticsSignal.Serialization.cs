...
{
    public partial class GenerationTokenStatisticsSignal : IUtf8JsonSerializable, IJsonModel<GenerationTokenStatisticsSignal>, IPersistableModel<GenerationTokenStatisticsSignal>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProductionData))
            {
                ...
                AppendChildObject(builder, ProductionData, options, 2);
            }
