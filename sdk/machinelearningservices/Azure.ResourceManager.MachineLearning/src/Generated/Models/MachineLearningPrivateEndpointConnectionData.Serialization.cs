...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningPrivateEndpointConnectionData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningPrivateEndpointConnectionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningPrivateEndpointConnectionData>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningPrivateEndpointConnectionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
