...
{
    public partial class UriFileDataVersion : IUtf8JsonSerializable
    {
        ...
        internal static UriFileDataVersion DeserializeUriFileDataVersion(JsonElement element)
        {
            ...
            return new UriFileDataVersion(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), dataType, dataUri);
        }
    }
}
