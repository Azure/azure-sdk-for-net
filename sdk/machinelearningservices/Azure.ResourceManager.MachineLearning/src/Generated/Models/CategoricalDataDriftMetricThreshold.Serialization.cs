...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CategoricalDataDriftMetricThreshold>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CategoricalDataDriftMetricThreshold>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CategoricalDataDriftMetricThreshold>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CategoricalDataDriftMetricThreshold>)} interface");
            }
        ...
        string IPersistableModel<CategoricalDataDriftMetricThreshold>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
