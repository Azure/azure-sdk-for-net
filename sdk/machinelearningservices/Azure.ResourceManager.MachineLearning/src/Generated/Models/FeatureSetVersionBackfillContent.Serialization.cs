...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FeatureSetVersionBackfillContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FeatureSetVersionBackfillContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FeatureSetVersionBackfillContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FeatureSetVersionBackfillContent>)} interface");
            }
        ...
        string IPersistableModel<FeatureSetVersionBackfillContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
