...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class UnknownInferencingServer : IUtf8JsonSerializable, IJsonModel<InferencingServer>
    {
        ...
        void IJsonModel<InferencingServer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(InferencingServer)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<InferencingServer>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(InferencingServer)} does not support '{options.Format}' format.");
            }
        }
