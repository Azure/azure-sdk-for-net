...
{
    public partial class ComponentVersionProperties : IUtf8JsonSerializable
    {
        ...
        internal static ComponentVersionProperties DeserializeComponentVersionProperties(JsonElement element)
        {
            ...
            {
                if (property.NameEquals("componentSpec"))
                {
            ...
            return new ComponentVersionProperties(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), componentSpec.Value);
        }
    }
}
