...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningComputeInstanceDataMount>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningComputeInstanceDataMount>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningComputeInstanceDataMount>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningComputeInstanceDataMount>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningComputeInstanceDataMount>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
