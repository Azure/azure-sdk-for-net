...
{
    internal partial class UnknownMachineLearningDataVersionProperties : MachineLearningDataVersionProperties, IJsonModel<MachineLearningDataVersionProperties>
    {
        ...
        {
            return (MachineLearningDataVersionProperties)PersistableModelCreateCore(data, options);
        }
        ...
        {
            return (MachineLearningDataVersionProperties)JsonModelCreateCore(ref reader, options);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMachineLearningDataVersionProperties DeserializeUnknownMachineLearningDataVersionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
