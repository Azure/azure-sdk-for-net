...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class FeaturestoreEntityVersionResourceArmPaginatedResult : IUtf8JsonSerializable, IJsonModel<FeaturestoreEntityVersionResourceArmPaginatedResult>
    {
        ...
        void IJsonModel<FeaturestoreEntityVersionResourceArmPaginatedResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FeaturestoreEntityVersionResourceArmPaginatedResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FeaturestoreEntityVersionResourceArmPaginatedResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FeaturestoreEntityVersionResourceArmPaginatedResult)} does not support '{options.Format}' format.");
            }
        }
