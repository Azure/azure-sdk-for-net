...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FeaturestoreEntityVersionResourceArmPaginatedResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FeaturestoreEntityVersionResourceArmPaginatedResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FeaturestoreEntityVersionResourceArmPaginatedResult>)} interface");
            }
        ...
        string IPersistableModel<FeaturestoreEntityVersionResourceArmPaginatedResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
