...
{
    public partial class NlpFixedParameters : IUtf8JsonSerializable, IJsonModel<NlpFixedParameters>, IPersistableModel<NlpFixedParameters>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GradientAccumulationSteps))
            {
                builder.Append("  gradientAccumulationSteps:");
                builder.AppendLine($" '{GradientAccumulationSteps.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(WarmupRatio))
            {
                builder.Append("  warmupRatio:");
                builder.AppendLine($" '{WarmupRatio.Value.ToString()}'");
            }
