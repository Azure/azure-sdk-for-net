...
{
    public partial class EnvironmentVariable : IUtf8JsonSerializable, IJsonModel<EnvironmentVariable>, IPersistableModel<EnvironmentVariable>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{VariableType.ToString()}'");
            }
