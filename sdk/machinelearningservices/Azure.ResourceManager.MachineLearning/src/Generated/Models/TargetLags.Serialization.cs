...
{
    public partial class TargetLags : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TargetLags DeserializeTargetLags(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
