...
{
    public partial class MachineLearningOnlineRequestSettings : IUtf8JsonSerializable, IJsonModel<MachineLearningOnlineRequestSettings>, IPersistableModel<MachineLearningOnlineRequestSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxConcurrentRequestsPerInstance))
            {
                ...
                builder.AppendLine($" '{MaxConcurrentRequestsPerInstance.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxQueueWait))
            {
                builder.Append("  maxQueueWait:");
                var formattedTimeSpan = XmlConvert.ToString(MaxQueueWait.Value);
            ...
            if (Optional.IsDefined(RequestTimeout))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(RequestTimeout.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
