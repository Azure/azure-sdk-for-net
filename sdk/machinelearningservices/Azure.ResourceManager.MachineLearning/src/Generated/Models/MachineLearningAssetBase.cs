...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningAssetBase : MachineLearningResourceBase
    {
        ...
        internal MachineLearningAssetBase(string description, IDictionary<string, string> properties, IDictionary<string, string> tags, bool? isAnonymous, bool? isArchived, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(description, properties, tags, serializedAdditionalRawData)
        {
