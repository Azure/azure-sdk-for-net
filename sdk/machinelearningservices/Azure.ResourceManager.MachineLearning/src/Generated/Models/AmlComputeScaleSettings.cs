...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class AmlComputeScaleSettings
    {
        ...
        internal AmlComputeScaleSettings(int maxNodeCount, int? minNodeCount, TimeSpan? nodeIdleTimeBeforeScaleDown, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MaxNodeCount = maxNodeCount;
