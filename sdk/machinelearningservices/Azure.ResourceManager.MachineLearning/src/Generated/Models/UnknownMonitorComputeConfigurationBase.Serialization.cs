...
{
    internal partial class UnknownMonitorComputeConfigurationBase : MonitorComputeConfigurationBase, IJsonModel<MonitorComputeConfigurationBase>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMonitorComputeConfigurationBase DeserializeUnknownMonitorComputeConfigurationBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMonitorComputeConfigurationBase(computeType, additionalBinaryDataProperties);
        }
    }
}
