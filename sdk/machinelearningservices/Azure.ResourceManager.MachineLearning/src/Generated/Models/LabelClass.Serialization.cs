...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabelClass>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabelClass>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabelClass>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabelClass>)} interface");
            }
        ...
        string IPersistableModel<LabelClass>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
