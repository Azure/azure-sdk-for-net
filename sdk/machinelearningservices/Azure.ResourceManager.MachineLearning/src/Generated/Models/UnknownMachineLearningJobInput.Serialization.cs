...
{
    internal partial class UnknownMachineLearningJobInput : IUtf8JsonSerializable, IJsonModel<MachineLearningJobInput>
    {
        ...
        internal static UnknownMachineLearningJobInput DeserializeUnknownMachineLearningJobInput(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownMachineLearningJobInput(description, jobInputType, serializedAdditionalRawData);
        }
