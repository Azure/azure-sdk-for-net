...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CsvExportSummary>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<CsvExportSummary>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CsvExportSummary)} does not support writing '{format}' format.");
            }
        ...
        CsvExportSummary IJsonModel<CsvExportSummary>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CsvExportSummary)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CsvExportSummary>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CsvExportSummary)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CsvExportSummary IPersistableModel<CsvExportSummary>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CsvExportSummary)} does not support reading '{options.Format}' format.");
            }
        }
