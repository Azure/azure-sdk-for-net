...
{
    public partial class LakeHouseArtifact : IUtf8JsonSerializable
    {
        ...
        internal static LakeHouseArtifact DeserializeLakeHouseArtifact(JsonElement element)
        {
            ...
            return new LakeHouseArtifact(artifactName, artifactType);
        }
    }
}
