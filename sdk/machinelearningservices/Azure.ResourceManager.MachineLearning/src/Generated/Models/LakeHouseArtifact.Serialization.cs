...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LakeHouseArtifact>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LakeHouseArtifact>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LakeHouseArtifact>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LakeHouseArtifact>)} interface");
            }
        ...
        string IPersistableModel<LakeHouseArtifact>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
