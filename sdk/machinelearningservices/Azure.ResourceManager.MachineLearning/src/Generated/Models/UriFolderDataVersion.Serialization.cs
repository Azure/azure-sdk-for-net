...
{
    public partial class UriFolderDataVersion : IUtf8JsonSerializable
    {
        ...
        internal static UriFolderDataVersion DeserializeUriFolderDataVersion(JsonElement element)
        {
            ...
            return new UriFolderDataVersion(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), dataType, dataUri);
        }
    }
}
