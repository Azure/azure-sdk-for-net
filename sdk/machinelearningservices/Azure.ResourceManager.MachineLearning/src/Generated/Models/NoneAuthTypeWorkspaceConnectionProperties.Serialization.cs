...
{
    public partial class NoneAuthTypeWorkspaceConnectionProperties : IUtf8JsonSerializable
    {
        ...
        internal static NoneAuthTypeWorkspaceConnectionProperties DeserializeNoneAuthTypeWorkspaceConnectionProperties(JsonElement element)
        {
            ...
            return new NoneAuthTypeWorkspaceConnectionProperties(authType, Optional.ToNullable(category), target.Value, value.Value, Optional.ToNullable(valueFormat));
        }
    }
}
