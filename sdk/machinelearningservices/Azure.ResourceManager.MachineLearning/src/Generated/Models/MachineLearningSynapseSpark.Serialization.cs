...
{
    public partial class MachineLearningSynapseSpark : IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningSynapseSpark DeserializeMachineLearningSynapseSpark(JsonElement element)
        {
            ...
            return new MachineLearningSynapseSpark(computeType, computeLocation.Value, Optional.ToNullable(provisioningState), description.Value, Optional.ToNullable(createdOn), Optional.ToNullable(modifiedOn), resourceId.Value, Optional.ToList(provisioningErrors), Optional.ToNullable(isAttachedCompute), Optional.ToNullable(disableLocalAuth), properties.Value);
        }
    }
}
