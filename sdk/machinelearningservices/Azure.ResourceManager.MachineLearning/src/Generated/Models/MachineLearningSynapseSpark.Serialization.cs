...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningSynapseSpark>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningSynapseSpark>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningSynapseSpark>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MachineLearningSynapseSpark>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
