...
{
    public partial class MachineLearningSynapseSpark : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningSynapseSpark DeserializeMachineLearningSynapseSpark(JsonElement element)
        {
            ...
            Core.Optional<MachineLearningSynapseSparkProperties> properties = default;
            ...
            return new MachineLearningSynapseSpark(computeType, computeLocation.Value, Core.Optional.ToNullable(provisioningState), description.Value, Core.Optional.ToNullable(createdOn), Core.Optional.ToNullable(modifiedOn), resourceId.Value, Core.Optional.ToList(provisioningErrors), Core.Optional.ToNullable(isAttachedCompute), Core.Optional.ToNullable(disableLocalAuth), properties.Value);
        }
    }
}
