...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningSynapseSpark : IUtf8JsonSerializable, IJsonModel<MachineLearningSynapseSpark>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningSynapseSpark>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningSynapseSpark>)} interface");
            }
