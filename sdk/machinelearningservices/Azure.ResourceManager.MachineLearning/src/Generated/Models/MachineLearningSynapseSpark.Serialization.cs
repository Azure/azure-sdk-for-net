...
{
    public partial class MachineLearningSynapseSpark : IUtf8JsonSerializable, IJsonModel<MachineLearningSynapseSpark>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningSynapseSpark>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<MachineLearningSynapseSpark>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MachineLearningSynapseSpark>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningSynapseSpark)} does not support '{format}' format.");
            }
        ...
        MachineLearningSynapseSpark IJsonModel<MachineLearningSynapseSpark>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MachineLearningSynapseSpark>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static MachineLearningSynapseSpark DeserializeMachineLearningSynapseSpark(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = MachineLearningSynapseSparkProperties.DeserializeMachineLearningSynapseSparkProperties(property.Value, options);
                    continue;
                }
            ...
            return new MachineLearningSynapseSpark(computeType, computeLocation.Value, Optional.ToNullable(provisioningState), description.Value, Optional.ToNullable(createdOn), Optional.ToNullable(modifiedOn), resourceId.Value, provisioningErrors ?? new ChangeTrackingList<MachineLearningError>(), Optional.ToNullable(isAttachedCompute), Optional.ToNullable(disableLocalAuth), serializedAdditionalRawData, properties.Value);
        }
        ...
        BinaryData IPersistableModel<MachineLearningSynapseSpark>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MachineLearningSynapseSpark)} does not support '{options.Format}' format.");
            }
        }

        MachineLearningSynapseSpark IPersistableModel<MachineLearningSynapseSpark>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<MachineLearningSynapseSpark>)this).GetFormatFromOptions(options) : options.Format;
