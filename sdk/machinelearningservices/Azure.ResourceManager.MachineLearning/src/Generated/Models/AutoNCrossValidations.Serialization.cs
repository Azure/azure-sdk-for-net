...
{
    public partial class AutoNCrossValidations : IUtf8JsonSerializable, IJsonModel<AutoNCrossValidations>, IPersistableModel<AutoNCrossValidations>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoNCrossValidations>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AutoNCrossValidations>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AutoNCrossValidations)} does not support '{format}' format.");
            }
