...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class ScheduleProperties : IUtf8JsonSerializable
    {
        ...
        internal static ScheduleProperties DeserializeScheduleProperties(JsonElement element)
        {
            ...
            return new ScheduleProperties(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), action, displayName.Value, Optional.ToNullable(isEnabled), Optional.ToNullable(provisioningState), trigger);
        }
    }
}
