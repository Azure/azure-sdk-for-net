...
{
    public partial class CronSchedule : IUtf8JsonSerializable
    {
        ...
        internal static CronSchedule DeserializeCronSchedule(JsonElement element)
        {
            ...
            return new CronSchedule(Optional.ToNullable(endTime), Optional.ToNullable(scheduleStatus), scheduleType, Optional.ToNullable(startTime), timeZone.Value, expression);
        }
    }
}
