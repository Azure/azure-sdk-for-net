...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class KeyVaultProperties
    {
        ...
        public KeyVaultProperties(string keyIdentifier, string keyVaultArmId)
        {
        ...
        /// <param name="keyIdentifier"> KeyVault key identifier to encrypt the data. </param>
        /// <param name="keyVaultArmId"> KeyVault Arm Id that contains the data encryption key. </param>
        internal KeyVaultProperties(string identityClientId, string keyIdentifier, string keyVaultArmId)
        {
