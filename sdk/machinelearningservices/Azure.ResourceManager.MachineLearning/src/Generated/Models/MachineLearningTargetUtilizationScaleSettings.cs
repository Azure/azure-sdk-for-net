...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningTargetUtilizationScaleSettings : MachineLearningOnlineScaleSettings
    {
        ...
        internal MachineLearningTargetUtilizationScaleSettings(ScaleType scaleType, int? maxInstances, int? minInstances, TimeSpan? pollingInterval, int? targetUtilizationPercentage, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(scaleType, serializedAdditionalRawData)
        {
