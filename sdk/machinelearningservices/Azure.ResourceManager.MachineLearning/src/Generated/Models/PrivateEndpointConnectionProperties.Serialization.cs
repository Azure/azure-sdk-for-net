...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    internal partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            WorkspacePrivateEndpointResource privateEndpoint = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("privateEndpoint"u8))
                {
                    ...
                    privateEndpoint = WorkspacePrivateEndpointResource.DeserializeWorkspacePrivateEndpointResource(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("privateLinkServiceConnectionState"u8))
                {
                    ...
                    privateLinkServiceConnectionState = MachineLearningPrivateLinkServiceConnectionState.DeserializeMachineLearningPrivateLinkServiceConnectionState(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new MachineLearningPrivateEndpointConnectionProvisioningState(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
