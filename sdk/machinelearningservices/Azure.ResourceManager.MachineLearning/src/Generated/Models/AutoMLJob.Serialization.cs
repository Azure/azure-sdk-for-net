...
{
    public partial class AutoMLJob : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AutoMLJob DeserializeAutoMLJob(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
