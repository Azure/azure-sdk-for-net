...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningManagedIdentityAuthTypeWorkspaceConnection : MachineLearningWorkspaceConnectionProperties, IJsonModel<MachineLearningManagedIdentityAuthTypeWorkspaceConnection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningManagedIdentityAuthTypeWorkspaceConnection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningManagedIdentityAuthTypeWorkspaceConnection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningManagedIdentityAuthTypeWorkspaceConnection IPersistableModel<MachineLearningManagedIdentityAuthTypeWorkspaceConnection>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningManagedIdentityAuthTypeWorkspaceConnection)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningManagedIdentityAuthTypeWorkspaceConnection IJsonModel<MachineLearningManagedIdentityAuthTypeWorkspaceConnection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningManagedIdentityAuthTypeWorkspaceConnection)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningManagedIdentityAuthTypeWorkspaceConnection DeserializeMachineLearningManagedIdentityAuthTypeWorkspaceConnection(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("credentials"u8))
                {
                    ...
                    credentials = MachineLearningWorkspaceConnectionManagedIdentity.DeserializeMachineLearningWorkspaceConnectionManagedIdentity(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
