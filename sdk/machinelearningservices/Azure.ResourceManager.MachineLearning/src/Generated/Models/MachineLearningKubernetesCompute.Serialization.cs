...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningKubernetesCompute>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningKubernetesCompute>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningKubernetesCompute>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningKubernetesCompute>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningKubernetesCompute>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
