...
{
    public partial class MachineLearningKubernetesCompute : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningKubernetesCompute DeserializeMachineLearningKubernetesCompute(JsonElement element)
        {
            ...
            Core.Optional<MachineLearningKubernetesProperties> properties = default;
            ...
            return new MachineLearningKubernetesCompute(computeType, computeLocation.Value, Core.Optional.ToNullable(provisioningState), description.Value, Core.Optional.ToNullable(createdOn), Core.Optional.ToNullable(modifiedOn), resourceId.Value, Core.Optional.ToList(provisioningErrors), Core.Optional.ToNullable(isAttachedCompute), Core.Optional.ToNullable(disableLocalAuth), properties.Value);
        }
    }
}
