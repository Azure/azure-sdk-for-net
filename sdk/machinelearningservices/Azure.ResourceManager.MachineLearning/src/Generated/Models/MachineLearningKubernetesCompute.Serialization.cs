...
{
    public partial class MachineLearningKubernetesCompute : IUtf8JsonSerializable, IJsonModel<MachineLearningKubernetesCompute>, IPersistableModel<MachineLearningKubernetesCompute>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningKubernetesCompute>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MachineLearningKubernetesCompute>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningKubernetesCompute)} does not support '{format}' format.");
            }
