...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class CustomTargetLags : TargetLags
    {
        ...
        internal CustomTargetLags(TargetLagsMode mode, IList<int> values, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(mode, serializedAdditionalRawData)
        {
            Values = values;
            Mode = mode;
        }
