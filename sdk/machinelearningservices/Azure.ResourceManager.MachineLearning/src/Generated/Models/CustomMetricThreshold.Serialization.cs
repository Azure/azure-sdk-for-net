...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomMetricThreshold>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomMetricThreshold>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomMetricThreshold>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomMetricThreshold>)} interface");
            }
        ...
        string IPersistableModel<CustomMetricThreshold>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
