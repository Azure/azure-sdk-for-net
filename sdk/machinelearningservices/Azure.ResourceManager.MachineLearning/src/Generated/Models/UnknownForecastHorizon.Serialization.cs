...
{
    internal partial class UnknownForecastHorizon : ForecastHorizon, IJsonModel<ForecastHorizon>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownForecastHorizon DeserializeUnknownForecastHorizon(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownForecastHorizon(mode, additionalBinaryDataProperties);
        }
    }
}
