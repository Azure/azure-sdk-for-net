...
{
    public partial class UriFileJobInput : IUtf8JsonSerializable
    {
        ...
        internal static UriFileJobInput DeserializeUriFileJobInput(JsonElement element)
        {
            ...
            return new UriFileJobInput(description.Value, jobInputType, Optional.ToNullable(mode), uri);
        }
    }
}
