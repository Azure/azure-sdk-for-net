...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningDiagnoseResult
    {
        ...
        internal MachineLearningDiagnoseResult(string code, MachineLearningDiagnoseResultLevel? level, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Level = level;
            Message = message;
