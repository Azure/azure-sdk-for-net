...
{
    public partial class ImageSweepSettings : IUtf8JsonSerializable, IJsonModel<ImageSweepSettings>, IPersistableModel<ImageSweepSettings>
    {
        ...
        void IJsonModel<ImageSweepSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImageSweepSettings)} does not support '{format}' format.");
            }
