...
{
    public partial class MachineLearningFlowModelJobInput : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningFlowModelJobInput DeserializeMachineLearningFlowModelJobInput(JsonElement element)
        {
            ...
            return new MachineLearningFlowModelJobInput(description.Value, jobInputType, Core.Optional.ToNullable(mode), uri);
        }
    }
}
