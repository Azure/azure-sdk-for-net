...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class WorkspaceConnectionSharedAccessSignature : IUtf8JsonSerializable, IJsonModel<WorkspaceConnectionSharedAccessSignature>
    {
        ...
        void IJsonModel<WorkspaceConnectionSharedAccessSignature>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(WorkspaceConnectionSharedAccessSignature)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<WorkspaceConnectionSharedAccessSignature>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(WorkspaceConnectionSharedAccessSignature)} does not support '{options.Format}' format.");
            }
        }
