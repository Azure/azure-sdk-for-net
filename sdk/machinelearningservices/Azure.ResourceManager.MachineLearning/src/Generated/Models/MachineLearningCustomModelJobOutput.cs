...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningCustomModelJobOutput : MachineLearningJobOutput
    {
        ...
        internal MachineLearningCustomModelJobOutput(string description, JobOutputType jobOutputType, MachineLearningOutputDeliveryMode? mode, Uri uri, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(description, jobOutputType, serializedAdditionalRawData)
        {
            Mode = mode;
            Uri = uri;
