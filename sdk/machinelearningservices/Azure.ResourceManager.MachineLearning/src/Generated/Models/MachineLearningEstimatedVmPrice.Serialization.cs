...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningEstimatedVmPrice>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningEstimatedVmPrice>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningEstimatedVmPrice>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MachineLearningEstimatedVmPrice>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
