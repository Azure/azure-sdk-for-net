...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TargetLags>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TargetLags>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TargetLags>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TargetLags>)} interface");
            }
        ...
        string IPersistableModel<TargetLags>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
