...
{
    public partial class DataVersionBaseDetails : IUtf8JsonSerializable
    {
        ...
        internal static DataVersionBaseDetails DeserializeDataVersionBaseDetails(JsonElement element)
        {
            ...
            return new DataVersionBaseDetails(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), dataType, dataUri);
        }
    }
}
