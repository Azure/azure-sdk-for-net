...
{
    internal partial class UnknownSeasonality : ForecastingSeasonality, IJsonModel<ForecastingSeasonality>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ForecastingSeasonality>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ForecastingSeasonality>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSeasonality DeserializeUnknownSeasonality(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSeasonality(mode, additionalBinaryDataProperties);
        }
    }
}
