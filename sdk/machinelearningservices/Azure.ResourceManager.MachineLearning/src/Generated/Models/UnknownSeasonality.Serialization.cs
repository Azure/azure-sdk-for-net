...
{
    internal partial class UnknownSeasonality : IUtf8JsonSerializable, IJsonModel<ForecastingSeasonality>
    {
        ...
        void IJsonModel<ForecastingSeasonality>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ForecastingSeasonality)} does not support '{format}' format.");
            }
        ...
        internal static UnknownSeasonality DeserializeUnknownSeasonality(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownSeasonality(mode, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ForecastingSeasonality>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ForecastingSeasonality)} does not support '{options.Format}' format.");
            }
        }
