...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningAzureDataLakeGen1Datastore>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningAzureDataLakeGen1Datastore>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningAzureDataLakeGen1Datastore>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningAzureDataLakeGen1Datastore>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningAzureDataLakeGen1Datastore>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
