...
{
    public partial class MachineLearningAzureDataLakeGen1Datastore : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningAzureDataLakeGen1Datastore DeserializeMachineLearningAzureDataLakeGen1Datastore(JsonElement element)
        {
            ...
            return new MachineLearningAzureDataLakeGen1Datastore(description.Value, Core.Optional.ToDictionary(properties), Core.Optional.ToDictionary(tags), credentials, datastoreType, Core.Optional.ToNullable(isDefault), Core.Optional.ToNullable(serviceDataAccessAuthIdentity), storeName);
        }
    }
}
