...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NlpParameterSubspace>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NlpParameterSubspace>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NlpParameterSubspace>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NlpParameterSubspace>)} interface");
            }
        ...
        string IPersistableModel<NlpParameterSubspace>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
