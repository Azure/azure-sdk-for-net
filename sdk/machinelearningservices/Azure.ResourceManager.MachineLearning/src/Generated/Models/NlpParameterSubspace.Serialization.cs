...
{
    public partial class NlpParameterSubspace : IUtf8JsonSerializable, IJsonModel<NlpParameterSubspace>, IPersistableModel<NlpParameterSubspace>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GradientAccumulationSteps))
            {
                ...
                builder.AppendLine($" '{GradientAccumulationSteps}'");
            }
            ...
            if (Optional.IsDefined(WarmupRatio))
            {
                ...
                builder.AppendLine($" '{WarmupRatio}'");
            }
