...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabelingDataConfiguration>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<LabelingDataConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LabelingDataConfiguration)} does not support writing '{format}' format.");
            }
        ...
        LabelingDataConfiguration IJsonModel<LabelingDataConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LabelingDataConfiguration)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LabelingDataConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LabelingDataConfiguration)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        LabelingDataConfiguration IPersistableModel<LabelingDataConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LabelingDataConfiguration)} does not support reading '{options.Format}' format.");
            }
        }
