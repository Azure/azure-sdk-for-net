...
{
    public partial class JobScheduleAction : IUtf8JsonSerializable
    {
        ...
        internal static JobScheduleAction DeserializeJobScheduleAction(JsonElement element)
        {
            ...
            return new JobScheduleAction(actionType, jobDefinition);
        }
    }
}
