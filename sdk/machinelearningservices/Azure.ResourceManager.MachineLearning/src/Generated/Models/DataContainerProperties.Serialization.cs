...
{
    public partial class DataContainerProperties : IUtf8JsonSerializable
    {
        ...
        internal static DataContainerProperties DeserializeDataContainerProperties(JsonElement element)
        {
            ...
            return new DataContainerProperties(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isArchived), latestVersion.Value, nextVersion.Value, dataType);
        }
    }
}
