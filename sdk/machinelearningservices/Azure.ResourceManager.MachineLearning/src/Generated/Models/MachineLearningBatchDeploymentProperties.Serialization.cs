...
{
    public partial class MachineLearningBatchDeploymentProperties : IUtf8JsonSerializable, IJsonModel<MachineLearningBatchDeploymentProperties>, IPersistableModel<MachineLearningBatchDeploymentProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeploymentConfiguration))
            {
                ...
                AppendChildObject(builder, DeploymentConfiguration, options, 2);
            }

            if (Optional.IsDefined(ErrorThreshold))
            {
                builder.Append("  errorThreshold:");
                builder.AppendLine($" '{ErrorThreshold.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(MaxConcurrencyPerInstance))
            {
                ...
                builder.AppendLine($" '{MaxConcurrencyPerInstance.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Model))
            {
                ...
                AppendChildObject(builder, Model, options, 2);
            }

            if (Optional.IsDefined(OutputAction))
            {
                builder.Append("  outputAction:");
                builder.AppendLine($" '{OutputAction.ToString()}'");
            }
            ...
            if (Optional.IsDefined(RetrySettings))
            {
                ...
                AppendChildObject(builder, RetrySettings, options, 2);
            }
