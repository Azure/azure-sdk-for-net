...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningCommandJob : IUtf8JsonSerializable, IModelJsonSerializable<MachineLearningCommandJob>
    {
        ...
        internal static MachineLearningCommandJob DeserializeMachineLearningCommandJob(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MachineLearningCommandJob(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), componentId.Value, computeId.Value, displayName.Value, experimentName.Value, identity.Value, Optional.ToNullable(isArchived), jobType, Optional.ToDictionary(services), Optional.ToNullable(status), codeId.Value, command, distribution.Value, environmentId, Optional.ToDictionary(environmentVariables), Optional.ToDictionary(inputs), limits.Value, Optional.ToDictionary(outputs), parameters.Value, resources.Value, serializedAdditionalRawData);
        }
