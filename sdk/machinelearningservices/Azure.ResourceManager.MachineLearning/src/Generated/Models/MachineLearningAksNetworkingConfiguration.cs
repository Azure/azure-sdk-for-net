...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningAksNetworkingConfiguration
    {
        ...
        internal MachineLearningAksNetworkingConfiguration(ResourceIdentifier subnetId, string serviceCidr, string dnsServiceIP, string dockerBridgeCidr, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SubnetId = subnetId;
