...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningAksNetworkingConfiguration
    {
        ...
        internal MachineLearningAksNetworkingConfiguration(ResourceIdentifier subnetId, string serviceCidr, string dnsServiceIP, string dockerBridgeCidr, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SubnetId = subnetId;
