...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CategoricalPredictionDriftMetricThreshold>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CategoricalPredictionDriftMetricThreshold>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CategoricalPredictionDriftMetricThreshold>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CategoricalPredictionDriftMetricThreshold>)} interface");
            }
        ...
        string IPersistableModel<CategoricalPredictionDriftMetricThreshold>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
