...
{
    public partial class SynapseSparkProperties : IUtf8JsonSerializable
    {
        ...
        internal static SynapseSparkProperties DeserializeSynapseSparkProperties(JsonElement element)
        {
            Optional<AutoScaleProperties> autoScaleProperties = default;
            Optional<AutoPauseProperties> autoPauseProperties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("autoPauseProperties"))
                {
                    ...
                    autoPauseProperties = AutoPauseProperties.DeserializeAutoPauseProperties(property.Value);
                    continue;
                }
            ...
            return new SynapseSparkProperties(autoScaleProperties.Value, autoPauseProperties.Value, sparkVersion.Value, Optional.ToNullable(nodeCount), nodeSize.Value, nodeSizeFamily.Value, subscriptionId.Value, resourceGroup.Value, workspaceName.Value, poolName.Value);
        }
    }
}
