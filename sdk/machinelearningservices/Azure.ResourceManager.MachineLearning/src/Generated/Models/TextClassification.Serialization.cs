...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class TextClassification : IUtf8JsonSerializable, IModelJsonSerializable<TextClassification>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<TextClassification>(this, options.Format);
        ...
        internal static TextClassification DeserializeTextClassification(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new TextClassification(Optional.ToNullable(logVerbosity), targetColumnName.Value, taskType, trainingData, Optional.ToNullable(primaryMetric), featurizationSettings.Value, limitSettings.Value, validationData.Value, serializedAdditionalRawData);
        }
