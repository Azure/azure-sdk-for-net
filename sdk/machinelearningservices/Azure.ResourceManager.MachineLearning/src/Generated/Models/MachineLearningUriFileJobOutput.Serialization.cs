...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningUriFileJobOutput : MachineLearningJobOutput, IJsonModel<MachineLearningUriFileJobOutput>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningUriFileJobOutput>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningUriFileJobOutput>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningUriFileJobOutput IPersistableModel<MachineLearningUriFileJobOutput>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningUriFileJobOutput)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningUriFileJobOutput IJsonModel<MachineLearningUriFileJobOutput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningUriFileJobOutput)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningUriFileJobOutput DeserializeMachineLearningUriFileJobOutput(JsonElement element, ModelReaderWriterOptions options)
        {
