...
{
    public partial class MachineLearningUriFileJobOutput : IUtf8JsonSerializable, IJsonModel<MachineLearningUriFileJobOutput>, IPersistableModel<MachineLearningUriFileJobOutput>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningUriFileJobOutput>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MachineLearningUriFileJobOutput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningUriFileJobOutput)} does not support '{format}' format.");
            }
