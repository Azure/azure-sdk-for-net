...
{
    public partial class PackageInputPathVersion : IUtf8JsonSerializable, IJsonModel<PackageInputPathVersion>, IPersistableModel<PackageInputPathVersion>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResourceVersion))
            {
                ...
                builder.AppendLine($" '{ResourceVersion}'");
            }
