...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningAksComputeSecrets : MachineLearningComputeSecrets
    {
        ...
        internal MachineLearningAksComputeSecrets(ComputeType computeType, string userKubeConfig, string adminKubeConfig, string imagePullSecretName, Dictionary<string, BinaryData> rawData) : base(computeType, rawData)
        {
