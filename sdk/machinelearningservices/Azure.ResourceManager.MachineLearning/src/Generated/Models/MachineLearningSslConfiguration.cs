...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningSslConfiguration
    {
        ...
        internal MachineLearningSslConfiguration(MachineLearningSslConfigStatus? status, string cert, string key, string cname, string leafDomainLabel, bool? overwriteExistingDomain, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Cert = cert;
            Key = key;
