...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomInferencingServer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomInferencingServer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomInferencingServer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomInferencingServer>)} interface");
            }
        ...
        string IPersistableModel<CustomInferencingServer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
