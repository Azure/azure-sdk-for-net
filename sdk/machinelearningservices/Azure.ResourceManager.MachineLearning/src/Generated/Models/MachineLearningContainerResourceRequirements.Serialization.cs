...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningContainerResourceRequirements>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningContainerResourceRequirements>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningContainerResourceRequirements>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningContainerResourceRequirements>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
