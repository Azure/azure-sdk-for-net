...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningAccountKeyDatastoreSecrets : MachineLearningDatastoreSecrets
    {
        ...
        internal MachineLearningAccountKeyDatastoreSecrets(SecretsType secretsType, string key, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(secretsType, serializedAdditionalRawData)
        {
            Key = key;
