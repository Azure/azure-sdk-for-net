...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class Endpoint : IUtf8JsonSerializable
    {
        ...
        internal static Endpoint DeserializeEndpoint(JsonElement element)
        {
            ...
            Optional<Protocol> protocol = default;
            ...
            return new Endpoint(Optional.ToNullable(protocol), name.Value, Optional.ToNullable(target), Optional.ToNullable(published), hostIP.Value);
        }
    }
}
