...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningEncryptionKeyVaultProperties
    {
        ...
        internal MachineLearningEncryptionKeyVaultProperties(ResourceIdentifier keyVaultArmId, string keyIdentifier, string identityClientId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyVaultArmId = keyVaultArmId;
            KeyIdentifier = keyIdentifier;
