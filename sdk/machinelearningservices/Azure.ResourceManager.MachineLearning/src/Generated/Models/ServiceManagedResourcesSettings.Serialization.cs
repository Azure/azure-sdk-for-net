...
{
    internal partial class ServiceManagedResourcesSettings : IUtf8JsonSerializable, IJsonModel<ServiceManagedResourcesSettings>, IPersistableModel<ServiceManagedResourcesSettings>
    {
        ...
        void IJsonModel<ServiceManagedResourcesSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServiceManagedResourcesSettings)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CosmosDb))
            {
                ...
                AppendChildObject(builder, CosmosDb, options, 2);
            }
