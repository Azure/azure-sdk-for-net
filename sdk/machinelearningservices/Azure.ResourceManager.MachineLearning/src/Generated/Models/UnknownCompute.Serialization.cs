...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class UnknownCompute : IUtf8JsonSerializable, IJsonModel<MachineLearningComputeProperties>
    {
        ...
        internal static UnknownCompute DeserializeUnknownCompute(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownCompute(computeType, computeLocation.Value, Optional.ToNullable(provisioningState), description.Value, Optional.ToNullable(createdOn), Optional.ToNullable(modifiedOn), resourceId.Value, provisioningErrors ?? new ChangeTrackingList<MachineLearningError>(), Optional.ToNullable(isAttachedCompute), Optional.ToNullable(disableLocalAuth), serializedAdditionalRawData);
        }
