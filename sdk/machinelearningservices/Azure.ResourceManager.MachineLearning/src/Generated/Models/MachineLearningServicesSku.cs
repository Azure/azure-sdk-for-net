...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    {
        /// <summary> Initializes a new instance of MachineLearningServicesSku. </summary>
        ...
        internal MachineLearningServicesSku(string name, MachineLearningServicesSkuTier? tier, string size, string family, int? capacity)
        {
            Name = name;
            Tier = tier;
            Size = size;
