...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningTableJobOutput : MachineLearningJobOutput
    {
        ...
        internal MachineLearningTableJobOutput(string description, JobOutputType jobOutputType, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(description, jobOutputType, serializedAdditionalRawData)
        {
