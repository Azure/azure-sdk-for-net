...
{
    public partial class MachineLearningUriFolderJobOutput : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningUriFolderJobOutput DeserializeMachineLearningUriFolderJobOutput(JsonElement element)
        {
            ...
            return new MachineLearningUriFolderJobOutput(description.Value, jobOutputType, Core.Optional.ToNullable(mode), uri.Value);
        }
    }
}
