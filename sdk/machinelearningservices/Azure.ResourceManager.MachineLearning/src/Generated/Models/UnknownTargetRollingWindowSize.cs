...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    internal partial class UnknownTargetRollingWindowSize : TargetRollingWindowSize
    {
        ...
        internal UnknownTargetRollingWindowSize(TargetRollingWindowSizeMode mode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(mode, serializedAdditionalRawData)
        {
            Mode = mode;
        }
