...
{
    public partial class InstanceTypeSchemaResources : IUtf8JsonSerializable
    {
        ...
        internal static InstanceTypeSchemaResources DeserializeInstanceTypeSchemaResources(JsonElement element)
        {
            ...
            return new InstanceTypeSchemaResources(Optional.ToDictionary(requests), Optional.ToDictionary(limits));
        }
    }
}
