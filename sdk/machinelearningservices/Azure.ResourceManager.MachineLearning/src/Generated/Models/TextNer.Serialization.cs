...
{
    public partial class TextNer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TextNer DeserializeTextNer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
