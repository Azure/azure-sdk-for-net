...
{
    public partial class TextNer : Core.IUtf8JsonSerializable
    {
        ...
        internal static TextNer DeserializeTextNer(JsonElement element)
        {
            ...
            return new TextNer(Core.Optional.ToNullable(logVerbosity), targetColumnName.Value, taskType, trainingData, Core.Optional.ToNullable(primaryMetric), featurizationSettings.Value, limitSettings.Value, validationData.Value);
        }
    }
}
