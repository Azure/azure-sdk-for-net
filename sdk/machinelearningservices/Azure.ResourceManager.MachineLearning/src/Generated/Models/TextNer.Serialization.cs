...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class TextNer : IUtf8JsonSerializable, IModelJsonSerializable<TextNer>
    {
        ...
        internal static TextNer DeserializeTextNer(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new TextNer(Optional.ToNullable(logVerbosity), targetColumnName.Value, taskType, trainingData, Optional.ToNullable(primaryMetric), featurizationSettings.Value, limitSettings.Value, validationData.Value, serializedAdditionalRawData);
        }
