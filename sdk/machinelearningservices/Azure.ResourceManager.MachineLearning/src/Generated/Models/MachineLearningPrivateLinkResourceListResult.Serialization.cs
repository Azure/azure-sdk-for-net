...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class MachineLearningPrivateLinkResourceListResult : IUtf8JsonSerializable, IJsonModel<MachineLearningPrivateLinkResourceListResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningPrivateLinkResourceListResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningPrivateLinkResourceListResult>)} interface");
            }
