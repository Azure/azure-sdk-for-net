...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class MachineLearningPrivateLinkResourceListResult : IUtf8JsonSerializable, IJsonModel<MachineLearningPrivateLinkResourceListResult>
    {
        ...
        void IJsonModel<MachineLearningPrivateLinkResourceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MachineLearningPrivateLinkResourceListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MachineLearningPrivateLinkResourceListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MachineLearningPrivateLinkResourceListResult)} does not support '{options.Format}' format.");
            }
        }
