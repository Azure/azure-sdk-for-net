...
{
    internal partial class MachineLearningCmkIdentity : IUtf8JsonSerializable, IJsonModel<MachineLearningCmkIdentity>, IPersistableModel<MachineLearningCmkIdentity>
    {
        ...
        void IJsonModel<MachineLearningCmkIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningCmkIdentity)} does not support '{format}' format.");
            }
