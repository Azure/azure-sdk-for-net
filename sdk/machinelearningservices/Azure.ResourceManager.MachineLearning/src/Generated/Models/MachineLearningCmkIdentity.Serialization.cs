...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningCmkIdentity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningCmkIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningCmkIdentity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningCmkIdentity>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningCmkIdentity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
