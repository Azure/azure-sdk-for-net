...
{
    public partial class FeatureWindow : IUtf8JsonSerializable, IJsonModel<FeatureWindow>, IPersistableModel<FeatureWindow>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FeatureWindowEnd))
            {
                ...
                builder.AppendLine($" '{FeatureWindowEnd.Value.ToString()}'");
            }

            if (Optional.IsDefined(FeatureWindowStart))
            {
                builder.Append("  featureWindowStart:");
                builder.AppendLine($" '{FeatureWindowStart.Value.ToString()}'");
            }
