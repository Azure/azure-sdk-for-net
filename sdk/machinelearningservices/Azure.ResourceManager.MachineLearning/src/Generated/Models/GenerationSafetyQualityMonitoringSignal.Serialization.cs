...
{
    public partial class GenerationSafetyQualityMonitoringSignal : IUtf8JsonSerializable, IJsonModel<GenerationSafetyQualityMonitoringSignal>, IPersistableModel<GenerationSafetyQualityMonitoringSignal>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SamplingRate))
            {
                ...
                builder.AppendLine($" '{SamplingRate.ToString()}'");
            }

            if (Optional.IsDefined(WorkspaceConnectionId))
            {
                builder.Append("  workspaceConnectionId:");
                builder.AppendLine($" '{WorkspaceConnectionId}'");
            }
