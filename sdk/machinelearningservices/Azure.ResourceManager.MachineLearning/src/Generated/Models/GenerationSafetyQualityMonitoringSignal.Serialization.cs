...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GenerationSafetyQualityMonitoringSignal>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        GenerationSafetyQualityMonitoringSignal IJsonModel<GenerationSafetyQualityMonitoringSignal>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<GenerationSafetyQualityMonitoringSignal>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        GenerationSafetyQualityMonitoringSignal IModel<GenerationSafetyQualityMonitoringSignal>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<GenerationSafetyQualityMonitoringSignal>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
