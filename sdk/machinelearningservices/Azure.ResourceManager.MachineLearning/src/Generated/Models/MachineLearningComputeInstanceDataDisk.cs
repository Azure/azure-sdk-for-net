...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningComputeInstanceDataDisk
    {
        ...
        internal MachineLearningComputeInstanceDataDisk(MachineLearningCachingType? caching, int? diskSizeGB, int? lun, MachineLearningStorageAccountType? storageAccountType, Dictionary<string, BinaryData> rawData)
        {
            Caching = caching;
