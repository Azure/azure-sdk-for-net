...
{
    public partial class LiteralJobInput : IUtf8JsonSerializable
    {
        ...
        internal static LiteralJobInput DeserializeLiteralJobInput(JsonElement element)
        {
            ...
            return new LiteralJobInput(description.Value, jobInputType, value);
        }
    }
}
