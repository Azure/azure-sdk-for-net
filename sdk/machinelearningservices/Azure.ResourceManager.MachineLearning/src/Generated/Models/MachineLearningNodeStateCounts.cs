...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningNodeStateCounts
    {
        ...
        internal MachineLearningNodeStateCounts(int? idleNodeCount, int? runningNodeCount, int? preparingNodeCount, int? unusableNodeCount, int? leavingNodeCount, int? preemptedNodeCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
