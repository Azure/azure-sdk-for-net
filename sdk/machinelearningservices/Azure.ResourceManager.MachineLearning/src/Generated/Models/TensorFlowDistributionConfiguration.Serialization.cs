...
{
    public partial class TensorFlowDistributionConfiguration : IUtf8JsonSerializable, IJsonModel<TensorFlowDistributionConfiguration>, IPersistableModel<TensorFlowDistributionConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ParameterServerCount))
            {
                ...
                builder.AppendLine($" '{ParameterServerCount.Value.ToString()}'");
            }
