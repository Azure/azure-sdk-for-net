...
{
    public partial class TensorFlowDistributionConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TensorFlowDistributionConfiguration DeserializeTensorFlowDistributionConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
