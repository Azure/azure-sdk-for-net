...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    internal partial class UnknownJobInput : MachineLearningJobInput
    {
        ...
        internal UnknownJobInput(string description, JobInputType jobInputType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(description, jobInputType, serializedAdditionalRawData)
        {
