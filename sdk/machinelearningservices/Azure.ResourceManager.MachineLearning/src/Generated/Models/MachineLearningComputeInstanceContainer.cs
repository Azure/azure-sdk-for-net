...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningComputeInstanceContainer
    {
        ...
        internal MachineLearningComputeInstanceContainer(string name, MachineLearningComputeInstanceAutosave? autosave, string gpu, MachineLearningNetwork? network, MachineLearningComputeInstanceEnvironmentInfo environment, IReadOnlyList<BinaryData> services, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Autosave = autosave;
            Gpu = gpu;
