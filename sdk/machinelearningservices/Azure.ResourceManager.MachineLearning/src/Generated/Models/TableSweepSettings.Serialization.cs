...
{
    public partial class TableSweepSettings : IUtf8JsonSerializable
    {
        ...
        internal static TableSweepSettings DeserializeTableSweepSettings(JsonElement element)
        {
            ...
            return new TableSweepSettings(earlyTermination.Value, samplingAlgorithm);
        }
    }
}
