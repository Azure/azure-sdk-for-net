...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public abstract partial class MachineLearningJobInput : IJsonModel<MachineLearningJobInput>
    {
        ...
        protected virtual MachineLearningJobInput PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningJobInput IPersistableModel<MachineLearningJobInput>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningJobInput IJsonModel<MachineLearningJobInput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual MachineLearningJobInput JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningJobInput>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningJobInput DeserializeMachineLearningJobInput(JsonElement element, ModelReaderWriterOptions options)
        {
            if (element.ValueKind == JsonValueKind.Null)
            {
                return null;
            }
            if (element.TryGetProperty("jobInputType"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "uri_file":
                        return MachineLearningUriFileJobInput.DeserializeMachineLearningUriFileJobInput(element, options);
                    case "uri_folder":
                        return MachineLearningUriFolderJobInput.DeserializeMachineLearningUriFolderJobInput(element, options);
                }
            }
