...
{
    public partial class MachineLearningComponentContainerProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningComponentContainerProperties DeserializeMachineLearningComponentContainerProperties(JsonElement element)
        {
            ...
            return new MachineLearningComponentContainerProperties(description.Value, Core.Optional.ToDictionary(properties), Core.Optional.ToDictionary(tags), Core.Optional.ToNullable(isArchived), latestVersion.Value, nextVersion.Value);
        }
    }
}
