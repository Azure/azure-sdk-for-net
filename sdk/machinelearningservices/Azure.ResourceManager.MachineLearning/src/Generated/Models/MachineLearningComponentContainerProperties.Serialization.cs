...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningComponentContainerProperties : IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningComponentContainerProperties DeserializeMachineLearningComponentContainerProperties(JsonElement element)
        {
            ...
            return new MachineLearningComponentContainerProperties(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isArchived), latestVersion.Value, nextVersion.Value, Optional.ToNullable(provisioningState));
        }
    }
}
