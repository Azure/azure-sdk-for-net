...
{
    public partial class MachineLearningDatabricksCompute : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningDatabricksCompute DeserializeMachineLearningDatabricksCompute(JsonElement element)
        {
            ...
            Core.Optional<MachineLearningDatabricksProperties> properties = default;
            ...
            return new MachineLearningDatabricksCompute(computeType, computeLocation.Value, Core.Optional.ToNullable(provisioningState), description.Value, Core.Optional.ToNullable(createdOn), Core.Optional.ToNullable(modifiedOn), resourceId.Value, Core.Optional.ToList(provisioningErrors), Core.Optional.ToNullable(isAttachedCompute), Core.Optional.ToNullable(disableLocalAuth), properties.Value);
        }
    }
}
