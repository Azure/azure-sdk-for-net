...
{
    public partial class MachineLearningDatabricksCompute : IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningDatabricksCompute DeserializeMachineLearningDatabricksCompute(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = MachineLearningDatabricksProperties.DeserializeMachineLearningDatabricksProperties(property.Value);
                    continue;
                }
