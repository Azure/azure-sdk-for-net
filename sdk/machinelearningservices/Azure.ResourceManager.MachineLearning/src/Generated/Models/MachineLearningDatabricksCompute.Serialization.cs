...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningDatabricksCompute : MachineLearningComputeProperties, IJsonModel<MachineLearningDatabricksCompute>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningDatabricksCompute>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningDatabricksCompute>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningDatabricksCompute IPersistableModel<MachineLearningDatabricksCompute>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningDatabricksCompute)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningDatabricksCompute IJsonModel<MachineLearningDatabricksCompute>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningDatabricksCompute)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningDatabricksCompute DeserializeMachineLearningDatabricksCompute(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = MachineLearningDatabricksProperties.DeserializeMachineLearningDatabricksProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
