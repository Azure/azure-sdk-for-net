...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageClassificationMultilabel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageClassificationMultilabel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageClassificationMultilabel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageClassificationMultilabel>)} interface");
            }
        ...
        string IPersistableModel<ImageClassificationMultilabel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
