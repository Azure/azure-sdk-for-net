...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    /// </summary>
    public partial class ImageClassificationMultilabel : AutoMLVertical, IJsonModel<ImageClassificationMultilabel>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ImageClassificationMultilabel>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ImageClassificationMultilabel>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ImageClassificationMultilabel IPersistableModel<ImageClassificationMultilabel>.Create(BinaryData data, ModelReaderWriterOptions options) => (ImageClassificationMultilabel)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ImageClassificationMultilabel IJsonModel<ImageClassificationMultilabel>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ImageClassificationMultilabel)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ImageClassificationMultilabel DeserializeImageClassificationMultilabel(JsonElement element, ModelReaderWriterOptions options)
        {
