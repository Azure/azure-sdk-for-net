...
{
    public partial class ImageClassificationMultilabel : Core.IUtf8JsonSerializable
    {
        ...
        internal static ImageClassificationMultilabel DeserializeImageClassificationMultilabel(JsonElement element)
        {
            ...
            return new ImageClassificationMultilabel(Core.Optional.ToNullable(logVerbosity), targetColumnName.Value, taskType, trainingData, Core.Optional.ToNullable(primaryMetric), modelSettings.Value, Core.Optional.ToList(searchSpace), limitSettings, sweepSettings.Value, validationData.Value, Core.Optional.ToNullable(validationDataSize));
        }
    }
}
