...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TritonInferencingServer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TritonInferencingServer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TritonInferencingServer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TritonInferencingServer>)} interface");
            }
        ...
        string IPersistableModel<TritonInferencingServer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
