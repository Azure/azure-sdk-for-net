...
{
    public partial class TritonInferencingServer : IUtf8JsonSerializable, IJsonModel<TritonInferencingServer>, IPersistableModel<TritonInferencingServer>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InferenceConfiguration))
            {
                ...
                AppendChildObject(builder, InferenceConfiguration, options, 2);
            }
