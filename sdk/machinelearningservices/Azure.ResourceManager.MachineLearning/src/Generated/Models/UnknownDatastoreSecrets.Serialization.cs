...
{
    internal partial class UnknownDatastoreSecrets : IUtf8JsonSerializable, IJsonModel<MachineLearningDatastoreSecrets>
    {
        ...
        void IJsonModel<MachineLearningDatastoreSecrets>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MachineLearningDatastoreSecrets)} does not support '{format}' format.");
            }
        ...
        MachineLearningDatastoreSecrets IJsonModel<MachineLearningDatastoreSecrets>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeUnknownDatastoreSecrets(document.RootElement, options);
        }

        internal static UnknownDatastoreSecrets DeserializeUnknownDatastoreSecrets(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownDatastoreSecrets(secretsType, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MachineLearningDatastoreSecrets>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MachineLearningDatastoreSecrets)} does not support '{options.Format}' format.");
            }
        }
