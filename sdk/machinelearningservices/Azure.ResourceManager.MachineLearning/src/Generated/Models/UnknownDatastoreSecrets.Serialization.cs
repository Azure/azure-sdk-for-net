...
{
    internal partial class UnknownDatastoreSecrets : MachineLearningDatastoreSecrets, IJsonModel<MachineLearningDatastoreSecrets>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDatastoreSecrets DeserializeUnknownDatastoreSecrets(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDatastoreSecrets(secretsType, additionalBinaryDataProperties);
        }
    }
}
