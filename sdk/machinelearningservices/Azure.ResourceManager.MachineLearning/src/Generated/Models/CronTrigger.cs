...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class CronTrigger : MachineLearningTriggerBase
    {
        ...
        internal CronTrigger(string endTime, string startTime, string timeZone, MachineLearningTriggerType triggerType, string expression, Dictionary<string, BinaryData> rawData) : base(endTime, startTime, timeZone, triggerType, rawData)
        {
            Expression = expression;
