...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IndexColumn>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IndexColumn>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IndexColumn>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IndexColumn>)} interface");
            }
        ...
        string IPersistableModel<IndexColumn>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
