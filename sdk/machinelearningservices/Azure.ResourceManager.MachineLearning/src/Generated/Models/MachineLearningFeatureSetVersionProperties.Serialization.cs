...
{
    public partial class MachineLearningFeatureSetVersionProperties : IUtf8JsonSerializable, IJsonModel<MachineLearningFeatureSetVersionProperties>, IPersistableModel<MachineLearningFeatureSetVersionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaterializationSettings))
            {
                ...
                AppendChildObject(builder, MaterializationSettings, options, 2);
            }
