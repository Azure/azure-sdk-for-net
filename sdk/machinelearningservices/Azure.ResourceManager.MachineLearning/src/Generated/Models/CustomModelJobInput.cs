...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class CustomModelJobInput : JobInput
    {
        ...
        public CustomModelJobInput(string uri)
        {
            if (uri == null)
            {
        ...
        /// <param name="uri"> [Required] Input Asset URI. </param>
        internal CustomModelJobInput(string description, JobInputType jobInputType, InputDeliveryMode? mode, string uri) : base(description, jobInputType)
        {
            Mode = mode;
            Uri = uri;
