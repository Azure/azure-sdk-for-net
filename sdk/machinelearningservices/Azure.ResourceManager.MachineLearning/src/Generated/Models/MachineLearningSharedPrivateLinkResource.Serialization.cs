...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningSharedPrivateLinkResource : IUtf8JsonSerializable, IModelJsonSerializable<MachineLearningSharedPrivateLinkResource>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MachineLearningSharedPrivateLinkResource>(this, options.Format);
        ...
        internal static MachineLearningSharedPrivateLinkResource DeserializeMachineLearningSharedPrivateLinkResource(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MachineLearningSharedPrivateLinkResource(name.Value, privateLinkResourceId.Value, groupId.Value, requestMessage.Value, Optional.ToNullable(status), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="MachineLearningSharedPrivateLinkResource"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MachineLearningSharedPrivateLinkResource"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MachineLearningSharedPrivateLinkResource"/>. </summary>
