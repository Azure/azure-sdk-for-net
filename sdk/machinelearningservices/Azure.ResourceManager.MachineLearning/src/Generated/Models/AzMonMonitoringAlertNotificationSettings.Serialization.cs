...
{
    public partial class AzMonMonitoringAlertNotificationSettings : IUtf8JsonSerializable, IJsonModel<AzMonMonitoringAlertNotificationSettings>, IPersistableModel<AzMonMonitoringAlertNotificationSettings>
    {
        ...
        void IJsonModel<AzMonMonitoringAlertNotificationSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzMonMonitoringAlertNotificationSettings)} does not support '{format}' format.");
            }
