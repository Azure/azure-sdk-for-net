...
{
    public partial class LabelCategory : IUtf8JsonSerializable, IJsonModel<LabelCategory>, IPersistableModel<LabelCategory>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MultiSelect))
            {
                ...
                builder.AppendLine($" '{MultiSelect.ToString()}'");
            }
