...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningAccountKeyDatastoreCredentials>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningAccountKeyDatastoreCredentials>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningAccountKeyDatastoreCredentials>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningAccountKeyDatastoreCredentials>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
