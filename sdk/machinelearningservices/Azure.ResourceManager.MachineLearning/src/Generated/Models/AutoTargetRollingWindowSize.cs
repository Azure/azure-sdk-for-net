...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class AutoTargetRollingWindowSize : TargetRollingWindowSize
    {
        ...
        internal AutoTargetRollingWindowSize(TargetRollingWindowSizeMode mode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(mode, serializedAdditionalRawData)
        {
            Mode = mode;
        }
    }
