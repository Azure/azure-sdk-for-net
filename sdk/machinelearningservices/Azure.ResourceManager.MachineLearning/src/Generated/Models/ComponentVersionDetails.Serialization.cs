...
{
    public partial class ComponentVersionDetails : IUtf8JsonSerializable
    {
        ...
        internal static ComponentVersionDetails DeserializeComponentVersionDetails(JsonElement element)
        {
            ...
            return new ComponentVersionDetails(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), componentSpec.Value);
        }
    }
}
