...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        internal static MachineLearningSkuCapacity DeserializeMachineLearningSkuCapacity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
