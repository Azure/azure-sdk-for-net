...
{
    public partial class Docker : IUtf8JsonSerializable
    {
        ...
        internal static Docker DeserializeDocker(JsonElement element)
        {
            ...
            return new Docker(Optional.ToNullable(privileged), additionalProperties);
        }
    }
}
