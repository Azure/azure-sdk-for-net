...
{
    public partial class MachineLearningDataVersionData : IUtf8JsonSerializable, IJsonModel<MachineLearningDataVersionData>, IPersistableModel<MachineLearningDataVersionData>
    {
        ...
        void IJsonModel<MachineLearningDataVersionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MachineLearningDataVersionData)} does not support '{format}' format.");
            }
