...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningTable : IUtf8JsonSerializable, IModelJsonSerializable<MachineLearningTable>
    {
        ...
        internal static MachineLearningTable DeserializeMachineLearningTable(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MachineLearningTable(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), dataType, dataUri, Optional.ToList(referencedUris), serializedAdditionalRawData);
        }
