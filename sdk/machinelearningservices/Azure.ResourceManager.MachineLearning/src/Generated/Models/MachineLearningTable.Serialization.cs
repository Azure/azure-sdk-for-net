...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningTable>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningTable>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningTable>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningTable>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningTable>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
