...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningDatastoreCredentials>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningDatastoreCredentials>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningDatastoreCredentials>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningDatastoreCredentials>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningDatastoreCredentials>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
