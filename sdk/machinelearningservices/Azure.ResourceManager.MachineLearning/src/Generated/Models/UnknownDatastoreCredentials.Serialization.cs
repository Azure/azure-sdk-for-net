...
{
    internal partial class UnknownDatastoreCredentials : MachineLearningDatastoreCredentials, IJsonModel<MachineLearningDatastoreCredentials>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDatastoreCredentials DeserializeUnknownDatastoreCredentials(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDatastoreCredentials(credentialsType, additionalBinaryDataProperties);
        }
    }
}
