...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class UnknownDatastoreCredentials : IUtf8JsonSerializable, IJsonModel<MachineLearningDatastoreCredentials>
    {
        ...
        void IJsonModel<MachineLearningDatastoreCredentials>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MachineLearningDatastoreCredentials)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MachineLearningDatastoreCredentials>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MachineLearningDatastoreCredentials)} does not support '{options.Format}' format.");
            }
        }
