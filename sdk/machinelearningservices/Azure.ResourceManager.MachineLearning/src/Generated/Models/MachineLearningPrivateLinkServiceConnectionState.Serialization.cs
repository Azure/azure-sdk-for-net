...
{
    public partial class MachineLearningPrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningPrivateLinkServiceConnectionState DeserializeMachineLearningPrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            return new MachineLearningPrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
