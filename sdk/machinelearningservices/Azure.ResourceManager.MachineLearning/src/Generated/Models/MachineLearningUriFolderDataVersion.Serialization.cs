...
{
    public partial class MachineLearningUriFolderDataVersion : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningUriFolderDataVersion DeserializeMachineLearningUriFolderDataVersion(JsonElement element)
        {
            ...
            return new MachineLearningUriFolderDataVersion(description.Value, Core.Optional.ToDictionary(properties), Core.Optional.ToDictionary(tags), Core.Optional.ToNullable(isAnonymous), Core.Optional.ToNullable(isArchived), dataType, dataUri);
        }
    }
}
