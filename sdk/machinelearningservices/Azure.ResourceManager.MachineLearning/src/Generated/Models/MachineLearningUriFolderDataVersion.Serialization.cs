...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningUriFolderDataVersion : MachineLearningDataVersionProperties, IJsonModel<MachineLearningUriFolderDataVersion>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningUriFolderDataVersion>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningUriFolderDataVersion>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningUriFolderDataVersion IPersistableModel<MachineLearningUriFolderDataVersion>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningUriFolderDataVersion)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningUriFolderDataVersion IJsonModel<MachineLearningUriFolderDataVersion>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningUriFolderDataVersion)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningUriFolderDataVersion DeserializeMachineLearningUriFolderDataVersion(JsonElement element, ModelReaderWriterOptions options)
        {
