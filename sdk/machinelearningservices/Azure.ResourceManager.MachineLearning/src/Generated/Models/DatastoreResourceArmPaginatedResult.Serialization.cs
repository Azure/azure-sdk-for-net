...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatastoreResourceArmPaginatedResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatastoreResourceArmPaginatedResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatastoreResourceArmPaginatedResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatastoreResourceArmPaginatedResult>)} interface");
            }
        ...
        string IPersistableModel<DatastoreResourceArmPaginatedResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
