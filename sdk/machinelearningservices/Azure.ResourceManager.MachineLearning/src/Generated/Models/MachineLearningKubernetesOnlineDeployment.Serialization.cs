...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningKubernetesOnlineDeployment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningKubernetesOnlineDeployment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningKubernetesOnlineDeployment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningKubernetesOnlineDeployment>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningKubernetesOnlineDeployment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
