...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningPatAuthTypeWorkspaceConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningPatAuthTypeWorkspaceConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningPatAuthTypeWorkspaceConnection>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningPatAuthTypeWorkspaceConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
