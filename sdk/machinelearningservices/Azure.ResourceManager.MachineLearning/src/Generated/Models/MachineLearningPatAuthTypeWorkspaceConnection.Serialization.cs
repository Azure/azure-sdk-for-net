...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningPatAuthTypeWorkspaceConnection : MachineLearningWorkspaceConnectionProperties, IJsonModel<MachineLearningPatAuthTypeWorkspaceConnection>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningPatAuthTypeWorkspaceConnection>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningPatAuthTypeWorkspaceConnection>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningPatAuthTypeWorkspaceConnection IPersistableModel<MachineLearningPatAuthTypeWorkspaceConnection>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningPatAuthTypeWorkspaceConnection)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningPatAuthTypeWorkspaceConnection IJsonModel<MachineLearningPatAuthTypeWorkspaceConnection>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningPatAuthTypeWorkspaceConnection)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningPatAuthTypeWorkspaceConnection DeserializeMachineLearningPatAuthTypeWorkspaceConnection(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("credentials"u8))
                {
                    ...
                    credentials = WorkspaceConnectionPersonalAccessToken.DeserializeWorkspaceConnectionPersonalAccessToken(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
