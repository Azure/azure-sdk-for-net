...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MLFlowModelJobInput : JobInput
    {
        ...
        public MLFlowModelJobInput(string uri)
        {
            if (uri == null)
            {
        ...
        /// <param name="uri"> [Required] Input Asset URI. </param>
        internal MLFlowModelJobInput(string description, JobInputType jobInputType, InputDeliveryMode? mode, string uri) : base(description, jobInputType)
        {
            Mode = mode;
            Uri = uri;
