...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotificationSetting>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NotificationSetting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NotificationSetting>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NotificationSetting>)} interface");
            }
        ...
        string IPersistableModel<NotificationSetting>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
