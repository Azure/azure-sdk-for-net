...
{
    public partial class MachineLearningHDInsightCompute : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningHDInsightCompute DeserializeMachineLearningHDInsightCompute(JsonElement element)
        {
            ...
            Core.Optional<MachineLearningHDInsightProperties> properties = default;
            ...
            return new MachineLearningHDInsightCompute(computeType, computeLocation.Value, Core.Optional.ToNullable(provisioningState), description.Value, Core.Optional.ToNullable(createdOn), Core.Optional.ToNullable(modifiedOn), resourceId.Value, Core.Optional.ToList(provisioningErrors), Core.Optional.ToNullable(isAttachedCompute), Core.Optional.ToNullable(disableLocalAuth), properties.Value);
        }
    }
}
