...
{
    public partial class OnlineDeploymentData : IUtf8JsonSerializable
    {
        ...
        internal static OnlineDeploymentData DeserializeOnlineDeploymentData(JsonElement element)
        {
            ...
            return new OnlineDeploymentData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, kind.Value, properties, sku.Value);
        }
    }
}
