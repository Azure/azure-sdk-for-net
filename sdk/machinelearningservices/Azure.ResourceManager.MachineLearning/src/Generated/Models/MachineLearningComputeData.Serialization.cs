...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningComputeData>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MachineLearningComputeData IJsonModel<MachineLearningComputeData>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static MachineLearningComputeData DeserializeMachineLearningComputeData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new MachineLearningComputeData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, sku.Value, properties.Value, serializedAdditionalRawData);
        }

        BinaryData IModel<MachineLearningComputeData>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MachineLearningComputeData IModel<MachineLearningComputeData>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MachineLearningComputeData>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
