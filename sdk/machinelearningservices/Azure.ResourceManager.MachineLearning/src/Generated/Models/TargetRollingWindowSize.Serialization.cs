...
{
    public partial class TargetRollingWindowSize : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TargetRollingWindowSize DeserializeTargetRollingWindowSize(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
