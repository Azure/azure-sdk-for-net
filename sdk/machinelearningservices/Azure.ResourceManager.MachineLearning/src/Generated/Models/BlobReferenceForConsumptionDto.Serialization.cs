...
{
    public partial class BlobReferenceForConsumptionDto : IUtf8JsonSerializable, IJsonModel<BlobReferenceForConsumptionDto>, IPersistableModel<BlobReferenceForConsumptionDto>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Credential))
            {
                ...
                AppendChildObject(builder, Credential, options, 2);
            }
