...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobReferenceForConsumptionDto>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlobReferenceForConsumptionDto>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobReferenceForConsumptionDto>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BlobReferenceForConsumptionDto>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
