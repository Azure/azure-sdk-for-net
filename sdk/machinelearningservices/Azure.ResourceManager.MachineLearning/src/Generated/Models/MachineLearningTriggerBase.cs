...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public abstract partial class MachineLearningTriggerBase
    {
        ...
        internal MachineLearningTriggerBase(string endTime, string startTime, string timeZone, MachineLearningTriggerType triggerType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EndTime = endTime;
            StartTime = startTime;
            TimeZone = timeZone;
