...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkspaceConnectionPropertiesV2BasicResourceArmPaginatedResult>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        WorkspaceConnectionPropertiesV2BasicResourceArmPaginatedResult IJsonModel<WorkspaceConnectionPropertiesV2BasicResourceArmPaginatedResult>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<WorkspaceConnectionPropertiesV2BasicResourceArmPaginatedResult>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        WorkspaceConnectionPropertiesV2BasicResourceArmPaginatedResult IModel<WorkspaceConnectionPropertiesV2BasicResourceArmPaginatedResult>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<WorkspaceConnectionPropertiesV2BasicResourceArmPaginatedResult>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
