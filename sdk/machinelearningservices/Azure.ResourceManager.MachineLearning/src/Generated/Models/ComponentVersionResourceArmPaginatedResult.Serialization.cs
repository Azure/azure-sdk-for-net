...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class ComponentVersionResourceArmPaginatedResult
    {
        internal static ComponentVersionResourceArmPaginatedResult DeserializeComponentVersionResourceArmPaginatedResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<MachineLearningComponentVersionData>> value = default;
            ...
            return new ComponentVersionResourceArmPaginatedResult(nextLink.Value, Core.Optional.ToList(value));
        }
    }
}
