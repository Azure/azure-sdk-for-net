...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningVmSshCredentials
    {
        ...
        internal MachineLearningVmSshCredentials(string username, string password, string publicKeyData, string privateKeyData, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Username = username;
            Password = password;
