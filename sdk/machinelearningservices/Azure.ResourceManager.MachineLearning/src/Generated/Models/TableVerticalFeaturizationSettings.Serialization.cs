...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TableVerticalFeaturizationSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TableVerticalFeaturizationSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TableVerticalFeaturizationSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TableVerticalFeaturizationSettings>)} interface");
            }
        ...
        string IPersistableModel<TableVerticalFeaturizationSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
