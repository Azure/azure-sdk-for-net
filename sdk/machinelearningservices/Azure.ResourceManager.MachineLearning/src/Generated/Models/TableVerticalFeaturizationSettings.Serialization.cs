...
{
    public partial class TableVerticalFeaturizationSettings : IUtf8JsonSerializable, IJsonModel<TableVerticalFeaturizationSettings>, IPersistableModel<TableVerticalFeaturizationSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(TransformerParams))
            {
                ...
                foreach (var item in TransformerParams)
                {
                    ...
                    foreach (var item0 in item.Value)
                    {
                        AppendChildObject(builder, item0, options, 6);
                    }
                    builder.AppendLine("  ]");
                }
                builder.AppendLine("  }");
