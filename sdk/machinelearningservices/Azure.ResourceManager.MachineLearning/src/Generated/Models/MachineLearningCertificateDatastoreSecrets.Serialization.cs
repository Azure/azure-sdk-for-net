...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningCertificateDatastoreSecrets>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningCertificateDatastoreSecrets>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningCertificateDatastoreSecrets>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MachineLearningCertificateDatastoreSecrets>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
