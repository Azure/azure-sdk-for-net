...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningOnlineDeploymentPatch : MachineLearningResourcePatch
    {
        ...
        internal MachineLearningOnlineDeploymentPatch(IDictionary<string, string> tags, MachineLearningSkuPatch sku, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, serializedAdditionalRawData)
        {
            Sku = sku;
        }
