...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AccessKeyAuthTypeWorkspaceConnectionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AccessKeyAuthTypeWorkspaceConnectionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AccessKeyAuthTypeWorkspaceConnectionProperties>)} interface");
            }
        ...
        string IPersistableModel<AccessKeyAuthTypeWorkspaceConnectionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
