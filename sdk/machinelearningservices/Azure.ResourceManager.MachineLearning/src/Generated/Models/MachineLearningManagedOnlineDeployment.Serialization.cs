...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningManagedOnlineDeployment : MachineLearningOnlineDeploymentProperties, IJsonModel<MachineLearningManagedOnlineDeployment>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningManagedOnlineDeployment>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningManagedOnlineDeployment>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningManagedOnlineDeployment IPersistableModel<MachineLearningManagedOnlineDeployment>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningManagedOnlineDeployment)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningManagedOnlineDeployment IJsonModel<MachineLearningManagedOnlineDeployment>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningManagedOnlineDeployment)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningManagedOnlineDeployment DeserializeMachineLearningManagedOnlineDeployment(JsonElement element, ModelReaderWriterOptions options)
        {
