...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningManagedOnlineDeployment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningManagedOnlineDeployment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningManagedOnlineDeployment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningManagedOnlineDeployment>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningManagedOnlineDeployment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
