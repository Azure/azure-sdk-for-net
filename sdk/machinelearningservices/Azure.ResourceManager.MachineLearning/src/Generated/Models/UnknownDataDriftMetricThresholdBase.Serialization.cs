...
{
    internal partial class UnknownDataDriftMetricThresholdBase : DataDriftMetricThresholdBase, IJsonModel<DataDriftMetricThresholdBase>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownDataDriftMetricThresholdBase DeserializeUnknownDataDriftMetricThresholdBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDataDriftMetricThresholdBase(dataType, threshold, additionalBinaryDataProperties);
        }
    }
}
