...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BatchEndpointTrackedResourceArmPaginatedResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<BatchEndpointTrackedResourceArmPaginatedResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BatchEndpointTrackedResourceArmPaginatedResult>)} interface");
            }
        ...
        string IPersistableModel<BatchEndpointTrackedResourceArmPaginatedResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
