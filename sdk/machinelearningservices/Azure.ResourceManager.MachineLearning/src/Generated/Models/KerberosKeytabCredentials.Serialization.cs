...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KerberosKeytabCredentials>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static KerberosKeytabCredentials DeserializeKerberosKeytabCredentials(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new KerberosKeytabCredentials(credentialsType, serializedAdditionalRawData, secrets);
        }
