...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegressionModelPerformanceMetricThreshold>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<RegressionModelPerformanceMetricThreshold>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RegressionModelPerformanceMetricThreshold)} does not support writing '{format}' format.");
            }
        ...
        RegressionModelPerformanceMetricThreshold IJsonModel<RegressionModelPerformanceMetricThreshold>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RegressionModelPerformanceMetricThreshold)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RegressionModelPerformanceMetricThreshold>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RegressionModelPerformanceMetricThreshold)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        RegressionModelPerformanceMetricThreshold IPersistableModel<RegressionModelPerformanceMetricThreshold>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RegressionModelPerformanceMetricThreshold)} does not support reading '{options.Format}' format.");
            }
        }
