...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class RegressionModelPerformanceMetricThreshold : IUtf8JsonSerializable, IJsonModel<RegressionModelPerformanceMetricThreshold>
    {
        ...
        void IJsonModel<RegressionModelPerformanceMetricThreshold>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RegressionModelPerformanceMetricThreshold)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RegressionModelPerformanceMetricThreshold>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RegressionModelPerformanceMetricThreshold)} does not support '{options.Format}' format.");
            }
        }
