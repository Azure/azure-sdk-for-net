...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class RandomSamplingAlgorithm : SamplingAlgorithm
    {
        ...
        internal RandomSamplingAlgorithm(SamplingAlgorithmType samplingAlgorithmType, RandomSamplingAlgorithmRule? rule, int? seed, Dictionary<string, BinaryData> rawData) : base(samplingAlgorithmType, rawData)
        {
            Rule = rule;
            Seed = seed;
