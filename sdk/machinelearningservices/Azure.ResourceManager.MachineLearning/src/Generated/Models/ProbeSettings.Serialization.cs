...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class ProbeSettings : IUtf8JsonSerializable
    {
        ...
        internal static ProbeSettings DeserializeProbeSettings(JsonElement element)
        {
            ...
            return new ProbeSettings(Optional.ToNullable(failureThreshold), Optional.ToNullable(initialDelay), Optional.ToNullable(period), Optional.ToNullable(successThreshold), Optional.ToNullable(timeout));
        }
    }
}
