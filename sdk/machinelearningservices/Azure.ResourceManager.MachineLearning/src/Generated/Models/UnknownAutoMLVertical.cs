...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    internal partial class UnknownAutoMLVertical : AutoMLVertical
    {
        ...
        internal UnknownAutoMLVertical(MachineLearningLogVerbosity? logVerbosity, string targetColumnName, TaskType taskType, MachineLearningTableJobInput trainingData, Dictionary<string, BinaryData> rawData) : base(logVerbosity, targetColumnName, taskType, trainingData, rawData)
        {
            TaskType = taskType;
        }
