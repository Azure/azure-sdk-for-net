...
{
    public partial class BatchDeploymentData : IUtf8JsonSerializable
    {
        ...
        internal static BatchDeploymentData DeserializeBatchDeploymentData(JsonElement element)
        {
            ...
            return new BatchDeploymentData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, kind.Value, properties, sku.Value);
        }
    }
}
