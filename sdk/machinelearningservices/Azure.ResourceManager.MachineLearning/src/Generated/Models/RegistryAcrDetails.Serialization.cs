...
{
    public partial class RegistryAcrDetails : IUtf8JsonSerializable, IJsonModel<RegistryAcrDetails>, IPersistableModel<RegistryAcrDetails>
    {
        ...
        void IJsonModel<RegistryAcrDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RegistryAcrDetails)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SystemCreatedAcrAccount))
            {
                ...
                AppendChildObject(builder, SystemCreatedAcrAccount, options, 2);
            }

            if (Optional.IsDefined(UserCreatedAcrAccount))
            {
                builder.Append("  userCreatedAcrAccount:");
                AppendChildObject(builder, UserCreatedAcrAccount, options, 2);
            }
