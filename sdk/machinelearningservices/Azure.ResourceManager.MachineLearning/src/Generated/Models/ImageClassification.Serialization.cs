...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageClassification>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageClassification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageClassification>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageClassification>)} interface");
            }
        ...
        string IPersistableModel<ImageClassification>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
