...
{
    internal partial class UnknownWebhook : MachineLearningWebhook, IJsonModel<MachineLearningWebhook>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownWebhook DeserializeUnknownWebhook(JsonElement element, ModelReaderWriterOptions options)
        {
