...
{
    public partial class MachineLearningProbeSettings : IUtf8JsonSerializable, IJsonModel<MachineLearningProbeSettings>, IPersistableModel<MachineLearningProbeSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InitialDelay))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(InitialDelay.Value);
            ...
            if (Optional.IsDefined(Period))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(Period.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
