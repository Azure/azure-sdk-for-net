...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataQualityMonitoringSignal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataQualityMonitoringSignal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataQualityMonitoringSignal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataQualityMonitoringSignal>)} interface");
            }
        ...
        string IPersistableModel<DataQualityMonitoringSignal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
