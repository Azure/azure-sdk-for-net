...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TruncationSelectionPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TruncationSelectionPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TruncationSelectionPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TruncationSelectionPolicy>)} interface");
            }
        ...
        string IPersistableModel<TruncationSelectionPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
