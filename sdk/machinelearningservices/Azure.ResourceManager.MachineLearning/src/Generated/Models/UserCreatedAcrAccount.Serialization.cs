...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class UserCreatedAcrAccount : IUtf8JsonSerializable, IJsonModel<UserCreatedAcrAccount>
    {
        ...
        void IJsonModel<UserCreatedAcrAccount>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UserCreatedAcrAccount)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UserCreatedAcrAccount>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UserCreatedAcrAccount)} does not support '{options.Format}' format.");
            }
        }
