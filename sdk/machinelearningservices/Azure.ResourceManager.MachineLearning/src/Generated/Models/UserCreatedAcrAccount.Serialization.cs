...
{
    internal partial class UserCreatedAcrAccount : IUtf8JsonSerializable
    {
        ...
        internal static UserCreatedAcrAccount DeserializeUserCreatedAcrAccount(JsonElement element)
        {
            ...
            return new UserCreatedAcrAccount(armResourceId.Value);
        }
    }
}
