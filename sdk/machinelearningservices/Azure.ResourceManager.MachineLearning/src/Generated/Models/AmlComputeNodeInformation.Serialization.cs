...
{
    public partial class AmlComputeNodeInformation : IUtf8JsonSerializable, IJsonModel<AmlComputeNodeInformation>, IPersistableModel<AmlComputeNodeInformation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NodeState))
            {
                ...
                builder.AppendLine($" '{NodeState.ToString()}'");
            }
