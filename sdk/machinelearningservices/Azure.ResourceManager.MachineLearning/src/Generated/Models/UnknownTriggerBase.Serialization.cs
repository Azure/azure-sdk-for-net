...
{
    internal partial class UnknownTriggerBase : MachineLearningTriggerBase, IJsonModel<MachineLearningTriggerBase>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownTriggerBase DeserializeUnknownTriggerBase(JsonElement element, ModelReaderWriterOptions options)
        {
