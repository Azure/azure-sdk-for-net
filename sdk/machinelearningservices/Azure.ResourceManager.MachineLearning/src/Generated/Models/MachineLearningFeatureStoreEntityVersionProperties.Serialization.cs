...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningFeatureStoreEntityVersionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningFeatureStoreEntityVersionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningFeatureStoreEntityVersionProperties>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningFeatureStoreEntityVersionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
