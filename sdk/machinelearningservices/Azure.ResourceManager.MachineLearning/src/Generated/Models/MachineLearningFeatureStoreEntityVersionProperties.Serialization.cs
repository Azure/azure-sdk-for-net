...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningFeatureStoreEntityVersionProperties : MachineLearningAssetBase, IJsonModel<MachineLearningFeatureStoreEntityVersionProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningFeatureStoreEntityVersionProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningFeatureStoreEntityVersionProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningFeatureStoreEntityVersionProperties IPersistableModel<MachineLearningFeatureStoreEntityVersionProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningFeatureStoreEntityVersionProperties)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningFeatureStoreEntityVersionProperties IJsonModel<MachineLearningFeatureStoreEntityVersionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningFeatureStoreEntityVersionProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningFeatureStoreEntityVersionProperties DeserializeMachineLearningFeatureStoreEntityVersionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
