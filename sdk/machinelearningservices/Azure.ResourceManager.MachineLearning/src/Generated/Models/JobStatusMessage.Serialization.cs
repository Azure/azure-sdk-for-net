...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JobStatusMessage>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<JobStatusMessage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JobStatusMessage)} does not support writing '{format}' format.");
            }
        ...
        JobStatusMessage IJsonModel<JobStatusMessage>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JobStatusMessage)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<JobStatusMessage>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(JobStatusMessage)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        JobStatusMessage IPersistableModel<JobStatusMessage>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(JobStatusMessage)} does not support reading '{options.Format}' format.");
            }
        }
