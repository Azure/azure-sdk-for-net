...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningTableJobOutput : IUtf8JsonSerializable, IModelJsonSerializable<MachineLearningTableJobOutput>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MachineLearningTableJobOutput>(this, options.Format);
        ...
        internal static MachineLearningTableJobOutput DeserializeMachineLearningTableJobOutput(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MachineLearningTableJobOutput(description.Value, jobOutputType, Optional.ToNullable(mode), uri.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="MachineLearningTableJobOutput"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MachineLearningTableJobOutput"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MachineLearningTableJobOutput"/>. </summary>
