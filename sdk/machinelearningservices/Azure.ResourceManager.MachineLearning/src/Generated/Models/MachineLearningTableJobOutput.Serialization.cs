...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningTableJobOutput>)this).Write(writer, ModelSerializationExtensions.WireOptions);
...
<<<<<<< HEAD
            return new MachineLearningTableJobOutput(jobOutputType, description, serializedAdditionalRawData, uri, mode);
=======
            return new MachineLearningTableJobOutput(description, jobOutputType, serializedAdditionalRawData, mode, uri);
>>>>>>> 3f8cf30a3ebe61cfdd08f1bbe8fa5494eda0e9f7
        }
