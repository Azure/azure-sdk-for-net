...
{
    public partial class MachineLearningComputeInstance : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningComputeInstance DeserializeMachineLearningComputeInstance(JsonElement element)
        {
            ...
            Core.Optional<MachineLearningComputeInstanceProperties> properties = default;
            ...
            return new MachineLearningComputeInstance(computeType, computeLocation.Value, Core.Optional.ToNullable(provisioningState), description.Value, Core.Optional.ToNullable(createdOn), Core.Optional.ToNullable(modifiedOn), resourceId.Value, Core.Optional.ToList(provisioningErrors), Core.Optional.ToNullable(isAttachedCompute), Core.Optional.ToNullable(disableLocalAuth), properties.Value);
        }
    }
}
