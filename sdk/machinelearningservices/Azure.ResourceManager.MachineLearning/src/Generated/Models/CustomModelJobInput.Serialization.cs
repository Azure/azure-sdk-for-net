...
{
    public partial class CustomModelJobInput : IUtf8JsonSerializable
    {
        ...
        internal static CustomModelJobInput DeserializeCustomModelJobInput(JsonElement element)
        {
            ...
            return new CustomModelJobInput(description.Value, jobInputType, Optional.ToNullable(mode), uri);
        }
    }
}
