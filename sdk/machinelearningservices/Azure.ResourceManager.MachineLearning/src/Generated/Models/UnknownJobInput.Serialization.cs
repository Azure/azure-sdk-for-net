...
{
    internal partial class UnknownJobInput : MachineLearningJobInput, IJsonModel<MachineLearningJobInput>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningJobInput>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningJobInput>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownJobInput DeserializeUnknownJobInput(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownJobInput(description, jobInputType, additionalBinaryDataProperties);
        }
    }
}
