...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningJobInput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningJobInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningJobInput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningJobInput>)} interface");
            }
        ...
        internal static UnknownJobInput DeserializeUnknownJobInput(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownJobInput(description.Value, jobInputType, serializedAdditionalRawData);
        }
        ...
        string IPersistableModel<MachineLearningJobInput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
