...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class UnknownJobInput : IUtf8JsonSerializable, IJsonModel<MachineLearningJobInput>
    {
        ...
        void IJsonModel<MachineLearningJobInput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MachineLearningJobInput)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MachineLearningJobInput>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MachineLearningJobInput)} does not support '{options.Format}' format.");
            }
        }
