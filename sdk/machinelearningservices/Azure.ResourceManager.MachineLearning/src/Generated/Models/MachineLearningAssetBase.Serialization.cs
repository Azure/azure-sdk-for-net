...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningAssetBase : IUtf8JsonSerializable, IJsonModel<MachineLearningAssetBase>
    {
        ...
        void IJsonModel<MachineLearningAssetBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MachineLearningAssetBase)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MachineLearningAssetBase>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MachineLearningAssetBase)} does not support '{options.Format}' format.");
            }
        }
