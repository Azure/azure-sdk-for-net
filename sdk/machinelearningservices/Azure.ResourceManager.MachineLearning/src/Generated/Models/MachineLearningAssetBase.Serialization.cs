...
{
    public partial class MachineLearningAssetBase : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningAssetBase DeserializeMachineLearningAssetBase(JsonElement element)
        {
            ...
            return new MachineLearningAssetBase(description.Value, Core.Optional.ToDictionary(properties), Core.Optional.ToDictionary(tags), Core.Optional.ToNullable(isAnonymous), Core.Optional.ToNullable(isArchived));
        }
    }
}
