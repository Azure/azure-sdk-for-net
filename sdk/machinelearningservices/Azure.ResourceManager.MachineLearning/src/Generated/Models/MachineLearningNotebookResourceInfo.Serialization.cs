...
{
    public partial class MachineLearningNotebookResourceInfo : IUtf8JsonSerializable, IJsonModel<MachineLearningNotebookResourceInfo>, IPersistableModel<MachineLearningNotebookResourceInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NotebookPreparationError))
            {
                ...
                AppendChildObject(builder, NotebookPreparationError, options, 2);
            }
