...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningNotebookResourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningNotebookResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningNotebookResourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningNotebookResourceInfo>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningNotebookResourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
