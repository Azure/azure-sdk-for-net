...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MedianStoppingPolicy : MachineLearningEarlyTerminationPolicy
    {
        ...
        internal MedianStoppingPolicy(int? delayEvaluation, int? evaluationInterval, EarlyTerminationPolicyType policyType, Dictionary<string, BinaryData> rawData) : base(delayEvaluation, evaluationInterval, policyType, rawData)
        {
