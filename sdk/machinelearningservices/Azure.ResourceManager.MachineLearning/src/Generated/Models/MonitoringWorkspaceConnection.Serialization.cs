...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitoringWorkspaceConnection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitoringWorkspaceConnection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitoringWorkspaceConnection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitoringWorkspaceConnection>)} interface");
            }
        ...
        string IPersistableModel<MonitoringWorkspaceConnection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
