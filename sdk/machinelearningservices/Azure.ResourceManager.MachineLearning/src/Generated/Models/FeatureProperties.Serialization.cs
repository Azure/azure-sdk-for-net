...
{
    public partial class FeatureProperties : IUtf8JsonSerializable
    {
        ...
        internal static FeatureProperties DeserializeFeatureProperties(JsonElement element)
        {
            ...
            return new FeatureProperties(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(dataType), featureName.Value);
        }
    }
}
