...
{
    public partial class AmlToken : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AmlToken DeserializeAmlToken(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
