...
namespace Azure.ResourceManager.MachineLearningServices.Models
{
    ...
    internal partial class CodeVersionResourceArmPaginatedResult
    {
        ...
        {
            Value = new ChangeTrackingList<CodeVersionDataData>();
        }
        ...
        internal CodeVersionResourceArmPaginatedResult(string nextLink, IReadOnlyList<CodeVersionDataData> value)
        {
            NextLink = nextLink;
            Value = value;
        }
        ...
        public IReadOnlyList<CodeVersionDataData> Value { get; }
    }
}
