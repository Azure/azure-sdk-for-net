...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class CustomForecastHorizon : IUtf8JsonSerializable, IModelJsonSerializable<CustomForecastHorizon>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CustomForecastHorizon>(this, options.Format);
        ...
        internal static CustomForecastHorizon DeserializeCustomForecastHorizon(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CustomForecastHorizon(mode, value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="CustomForecastHorizon"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CustomForecastHorizon"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CustomForecastHorizon"/>. </summary>
