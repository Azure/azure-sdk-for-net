...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningDataPathAssetReference : MachineLearningAssetReferenceBase
    {
        ...
        internal MachineLearningDataPathAssetReference(ReferenceType referenceType, string datastoreId, string path, Dictionary<string, BinaryData> rawData) : base(referenceType, rawData)
        {
