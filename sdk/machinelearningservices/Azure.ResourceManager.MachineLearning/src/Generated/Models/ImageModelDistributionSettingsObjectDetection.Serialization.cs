...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageModelDistributionSettingsObjectDetection>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageModelDistributionSettingsObjectDetection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageModelDistributionSettingsObjectDetection>)} interface");
            }
        ...
        string IPersistableModel<ImageModelDistributionSettingsObjectDetection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
