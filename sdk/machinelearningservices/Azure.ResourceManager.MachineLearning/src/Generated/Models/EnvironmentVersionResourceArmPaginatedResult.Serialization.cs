...
{
    internal partial class EnvironmentVersionResourceArmPaginatedResult : IUtf8JsonSerializable, IJsonModel<EnvironmentVersionResourceArmPaginatedResult>, IPersistableModel<EnvironmentVersionResourceArmPaginatedResult>
    {
        ...
        void IJsonModel<EnvironmentVersionResourceArmPaginatedResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EnvironmentVersionResourceArmPaginatedResult)} does not support '{format}' format.");
            }
