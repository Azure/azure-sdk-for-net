...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class EnvironmentVersionResourceArmPaginatedResult
    {
        internal static EnvironmentVersionResourceArmPaginatedResult DeserializeEnvironmentVersionResourceArmPaginatedResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<MachineLearningEnvironmentVersionData>> value = default;
            ...
            return new EnvironmentVersionResourceArmPaginatedResult(nextLink.Value, Core.Optional.ToList(value));
        }
    }
}
