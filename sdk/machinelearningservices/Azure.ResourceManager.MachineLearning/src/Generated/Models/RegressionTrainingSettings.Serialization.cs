...
{
    public partial class RegressionTrainingSettings : Core.IUtf8JsonSerializable
    {
        ...
        internal static RegressionTrainingSettings DeserializeRegressionTrainingSettings(JsonElement element)
        {
            ...
            Core.Optional<IList<AutoMLVerticalRegressionModel>> allowedTrainingAlgorithms = default;
            Core.Optional<IList<AutoMLVerticalRegressionModel>> blockedTrainingAlgorithms = default;
            ...
            return new RegressionTrainingSettings(Core.Optional.ToNullable(enableDnnTraining), Core.Optional.ToNullable(enableModelExplainability), Core.Optional.ToNullable(enableOnnxCompatibleModels), Core.Optional.ToNullable(enableStackEnsemble), Core.Optional.ToNullable(enableVoteEnsemble), Core.Optional.ToNullable(ensembleModelDownloadTimeout), stackEnsembleSettings.Value, Core.Optional.ToList(allowedTrainingAlgorithms), Core.Optional.ToList(blockedTrainingAlgorithms));
        }
    }
}
