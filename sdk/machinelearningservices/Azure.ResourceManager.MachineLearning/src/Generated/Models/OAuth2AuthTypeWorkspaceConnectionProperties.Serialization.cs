...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class OAuth2AuthTypeWorkspaceConnectionProperties : MachineLearningWorkspaceConnectionProperties, IJsonModel<OAuth2AuthTypeWorkspaceConnectionProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<OAuth2AuthTypeWorkspaceConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<OAuth2AuthTypeWorkspaceConnectionProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        OAuth2AuthTypeWorkspaceConnectionProperties IPersistableModel<OAuth2AuthTypeWorkspaceConnectionProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (OAuth2AuthTypeWorkspaceConnectionProperties)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        OAuth2AuthTypeWorkspaceConnectionProperties IJsonModel<OAuth2AuthTypeWorkspaceConnectionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (OAuth2AuthTypeWorkspaceConnectionProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static OAuth2AuthTypeWorkspaceConnectionProperties DeserializeOAuth2AuthTypeWorkspaceConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("credentials"u8))
                {
                    ...
                    credentials = WorkspaceConnectionOAuth2.DeserializeWorkspaceConnectionOAuth2(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
