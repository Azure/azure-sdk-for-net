...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class LabelingJobImageProperties : IUtf8JsonSerializable, IJsonModel<LabelingJobImageProperties>
    {
        ...
        void IJsonModel<LabelingJobImageProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LabelingJobImageProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LabelingJobImageProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LabelingJobImageProperties)} does not support '{options.Format}' format.");
            }
        }
