...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class CustomForecastHorizon : ForecastHorizon
    {
        ...
        internal CustomForecastHorizon(ForecastHorizonMode mode, int value, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(mode, serializedAdditionalRawData)
        {
            Value = value;
            Mode = mode;
        }
