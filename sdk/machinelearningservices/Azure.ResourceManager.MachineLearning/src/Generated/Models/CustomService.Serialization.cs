...
{
    public partial class CustomService : IUtf8JsonSerializable, IJsonModel<CustomService>, IPersistableModel<CustomService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Docker))
            {
                ...
                AppendChildObject(builder, Docker, options, 2);
            }
