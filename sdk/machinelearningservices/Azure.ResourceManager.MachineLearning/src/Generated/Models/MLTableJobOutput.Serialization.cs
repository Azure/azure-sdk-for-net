...
{
    public partial class MLTableJobOutput : IUtf8JsonSerializable
    {
        ...
        internal static MLTableJobOutput DeserializeMLTableJobOutput(JsonElement element)
        {
            ...
            return new MLTableJobOutput(description.Value, jobOutputType, Optional.ToNullable(mode), uri.Value);
        }
    }
}
