...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningEndpointProperties
    {
        ...
        internal MachineLearningEndpointProperties(MachineLearningEndpointAuthMode authMode, string description, MachineLearningEndpointAuthKeys keys, IDictionary<string, string> properties, Uri scoringUri, Uri swaggerUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AuthMode = authMode;
