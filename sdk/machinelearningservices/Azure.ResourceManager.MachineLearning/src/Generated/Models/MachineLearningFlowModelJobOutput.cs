...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningFlowModelJobOutput : MachineLearningJobOutput
    {
        ...
        internal MachineLearningFlowModelJobOutput(string description, JobOutputType jobOutputType, MachineLearningOutputDeliveryMode? mode, Uri uri, Dictionary<string, BinaryData> rawData) : base(description, jobOutputType, rawData)
        {
            Mode = mode;
            Uri = uri;
