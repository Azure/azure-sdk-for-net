...
{
    public partial class MachineLearningWorkspaceConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningWorkspaceConnectionData DeserializeMachineLearningWorkspaceConnectionData(JsonElement element)
        {
            ...
            return new MachineLearningWorkspaceConnectionData(id, name, type, systemData.Value, properties);
        }
    }
}
