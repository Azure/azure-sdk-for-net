    ...
    public partial class ModelPackageResult : IUtf8JsonSerializable, IJsonModel<ModelPackageResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BaseEnvironmentSource))
            {
                ...
                AppendChildObject(builder, BaseEnvironmentSource, options, 2, false);
            }
            ...
            if (Optional.IsDefined(BuildState))
            {
                ...
                builder.AppendLine($" '{BuildState.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(InferencingServer))
            {
                ...
                AppendChildObject(builder, InferencingServer, options, 2, false);
            }
            ...
            if (Optional.IsDefined(ModelConfiguration))
            {
                ...
                AppendChildObject(builder, ModelConfiguration, options, 2, false);
            }

            if (Optional.IsDefined(TargetEnvironmentId))
            {
                builder.Append("  targetEnvironmentId:");
                if (TargetEnvironmentId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
