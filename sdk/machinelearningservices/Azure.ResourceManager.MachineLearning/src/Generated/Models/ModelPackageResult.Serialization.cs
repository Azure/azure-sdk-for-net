...
{
    public partial class ModelPackageResult : IUtf8JsonSerializable, IJsonModel<ModelPackageResult>, IPersistableModel<ModelPackageResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  baseEnvironmentSource:");
                AppendChildObject(builder, BaseEnvironmentSource, options, 2);
            }
            ...
            {
                builder.Append("  buildState:");
                builder.AppendLine($" '{BuildState.ToString()}'");
            }
            ...
            {
                builder.Append("  inferencingServer:");
                AppendChildObject(builder, InferencingServer, options, 2);
            }
            ...
            {
                builder.Append("  logUrl:");
                builder.AppendLine($" '{LogUri.AbsoluteUri}'");
            }

            if (Optional.IsDefined(ModelConfiguration))
            {
                builder.Append("  modelConfiguration:");
                AppendChildObject(builder, ModelConfiguration, options, 2);
            }
            ...
            if (Optional.IsDefined(TargetEnvironmentId))
            {
                ...
                builder.AppendLine($" '{TargetEnvironmentId}'");
            }
