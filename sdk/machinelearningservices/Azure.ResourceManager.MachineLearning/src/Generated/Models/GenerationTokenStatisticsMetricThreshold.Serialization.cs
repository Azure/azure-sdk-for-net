...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GenerationTokenStatisticsMetricThreshold>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        void IJsonModel<GenerationTokenStatisticsMetricThreshold>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GenerationTokenStatisticsMetricThreshold)} does not support writing '{format}' format.");
            }
        ...
        GenerationTokenStatisticsMetricThreshold IJsonModel<GenerationTokenStatisticsMetricThreshold>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GenerationTokenStatisticsMetricThreshold)} does not support reading '{format}' format.");
            }
        ...
        internal static GenerationTokenStatisticsMetricThreshold DeserializeGenerationTokenStatisticsMetricThreshold(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new GenerationTokenStatisticsMetricThreshold(metric, threshold, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<GenerationTokenStatisticsMetricThreshold>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GenerationTokenStatisticsMetricThreshold)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        GenerationTokenStatisticsMetricThreshold IPersistableModel<GenerationTokenStatisticsMetricThreshold>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GenerationTokenStatisticsMetricThreshold)} does not support reading '{options.Format}' format.");
            }
        }
