...
{
    internal partial class WorkspaceConnectionApiKey : IUtf8JsonSerializable, IJsonModel<WorkspaceConnectionApiKey>, IPersistableModel<WorkspaceConnectionApiKey>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkspaceConnectionApiKey>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WorkspaceConnectionApiKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WorkspaceConnectionApiKey)} does not support '{format}' format.");
            }
