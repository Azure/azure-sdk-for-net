...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkspaceConnectionApiKey>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkspaceConnectionApiKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkspaceConnectionApiKey>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkspaceConnectionApiKey>)} interface");
            }
        ...
        string IPersistableModel<WorkspaceConnectionApiKey>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
