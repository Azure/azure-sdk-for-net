...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningFlowModelJobOutput : MachineLearningJobOutput, IJsonModel<MachineLearningFlowModelJobOutput>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningFlowModelJobOutput>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningFlowModelJobOutput>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningFlowModelJobOutput IPersistableModel<MachineLearningFlowModelJobOutput>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningFlowModelJobOutput)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningFlowModelJobOutput IJsonModel<MachineLearningFlowModelJobOutput>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningFlowModelJobOutput)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningFlowModelJobOutput DeserializeMachineLearningFlowModelJobOutput(JsonElement element, ModelReaderWriterOptions options)
        {
