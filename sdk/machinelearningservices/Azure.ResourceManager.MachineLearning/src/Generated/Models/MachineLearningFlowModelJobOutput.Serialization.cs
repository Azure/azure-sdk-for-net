...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningFlowModelJobOutput : IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningFlowModelJobOutput DeserializeMachineLearningFlowModelJobOutput(JsonElement element)
        {
            ...
            return new MachineLearningFlowModelJobOutput(description.Value, jobOutputType, assetName.Value, assetVersion.Value, autoDeleteSetting.Value, Optional.ToNullable(mode), uri.Value);
        }
    }
}
