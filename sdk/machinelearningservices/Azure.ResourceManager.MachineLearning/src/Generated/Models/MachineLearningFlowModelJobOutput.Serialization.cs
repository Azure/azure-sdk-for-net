...
{
    public partial class MachineLearningFlowModelJobOutput : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningFlowModelJobOutput DeserializeMachineLearningFlowModelJobOutput(JsonElement element)
        {
            ...
            return new MachineLearningFlowModelJobOutput(description.Value, jobOutputType, Core.Optional.ToNullable(mode), uri.Value);
        }
    }
}
