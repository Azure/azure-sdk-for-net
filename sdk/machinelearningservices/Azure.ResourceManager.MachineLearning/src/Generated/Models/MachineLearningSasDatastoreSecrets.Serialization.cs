...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningSasDatastoreSecrets>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningSasDatastoreSecrets>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningSasDatastoreSecrets>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningSasDatastoreSecrets>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningSasDatastoreSecrets>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
