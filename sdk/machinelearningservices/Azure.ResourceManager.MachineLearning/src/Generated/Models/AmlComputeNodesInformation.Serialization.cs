...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AmlComputeNodesInformation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AmlComputeNodesInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AmlComputeNodesInformation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AmlComputeNodesInformation>)} interface");
            }
        ...
        string IPersistableModel<AmlComputeNodesInformation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
