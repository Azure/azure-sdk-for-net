...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PredictionDriftMonitoringSignal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PredictionDriftMonitoringSignal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PredictionDriftMonitoringSignal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PredictionDriftMonitoringSignal>)} interface");
            }
        ...
        string IPersistableModel<PredictionDriftMonitoringSignal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
