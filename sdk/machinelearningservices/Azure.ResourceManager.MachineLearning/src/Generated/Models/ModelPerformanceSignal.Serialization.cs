...
{
    public partial class ModelPerformanceSignal : IUtf8JsonSerializable, IJsonModel<ModelPerformanceSignal>, IPersistableModel<ModelPerformanceSignal>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataSegment))
            {
                builder.Append("  dataSegment:");
                AppendChildObject(builder, DataSegment, options, 2);
            }
