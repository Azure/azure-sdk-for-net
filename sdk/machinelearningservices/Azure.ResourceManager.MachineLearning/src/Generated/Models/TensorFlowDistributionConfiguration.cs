...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class TensorFlowDistributionConfiguration : MachineLearningDistributionConfiguration
    {
        ...
        internal TensorFlowDistributionConfiguration(DistributionType distributionType, int? parameterServerCount, int? workerCount, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(distributionType, serializedAdditionalRawData)
        {
