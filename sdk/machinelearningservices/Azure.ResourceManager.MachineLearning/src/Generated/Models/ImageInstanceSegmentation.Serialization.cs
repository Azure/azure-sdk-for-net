...
{
    public partial class ImageInstanceSegmentation : Core.IUtf8JsonSerializable
    {
        ...
        internal static ImageInstanceSegmentation DeserializeImageInstanceSegmentation(JsonElement element)
        {
            ...
            Core.Optional<InstanceSegmentationPrimaryMetric> primaryMetric = default;
            ...
            return new ImageInstanceSegmentation(Core.Optional.ToNullable(logVerbosity), targetColumnName.Value, taskType, trainingData, Core.Optional.ToNullable(primaryMetric), modelSettings.Value, Core.Optional.ToList(searchSpace), limitSettings, sweepSettings.Value, validationData.Value, Core.Optional.ToNullable(validationDataSize));
        }
    }
}
