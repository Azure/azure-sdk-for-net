...
{
    public partial class PrivateEndpointResource : IUtf8JsonSerializable
    {
        ...
        internal static PrivateEndpointResource DeserializePrivateEndpointResource(JsonElement element)
        {
            ...
            return new PrivateEndpointResource(id.Value, subnetArmId.Value);
        }
    }
}
