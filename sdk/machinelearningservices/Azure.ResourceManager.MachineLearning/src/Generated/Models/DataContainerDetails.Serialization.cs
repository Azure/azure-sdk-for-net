...
{
    public partial class DataContainerDetails : IUtf8JsonSerializable
    {
        ...
        internal static DataContainerDetails DeserializeDataContainerDetails(JsonElement element)
        {
            ...
            return new DataContainerDetails(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isArchived), latestVersion.Value, nextVersion.Value, dataType);
        }
    }
}
