...
{
    public partial class RayDistributionConfiguration : IUtf8JsonSerializable, IJsonModel<RayDistributionConfiguration>, IPersistableModel<RayDistributionConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DashboardPort))
            {
                builder.Append("  dashboardPort:");
                builder.AppendLine($" '{DashboardPort.Value.ToString()}'");
            }

            if (Optional.IsDefined(HeadNodeAdditionalArgs))
            {
                builder.Append("  headNodeAdditionalArgs:");
                builder.AppendLine($" '{HeadNodeAdditionalArgs}'");
            }

            if (Optional.IsDefined(IncludeDashboard))
            {
                builder.Append("  includeDashboard:");
                var boolValue = IncludeDashboard.Value == true ? "true" : "false";
            ...
            if (Optional.IsDefined(WorkerNodeAdditionalArgs))
            {
                builder.Append("  workerNodeAdditionalArgs:");
                builder.AppendLine($" '{WorkerNodeAdditionalArgs}'");
            }
