...
{
    public partial class AutoMLVertical : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AutoMLVertical DeserializeAutoMLVertical(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
