...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningWorkspaceQuotaUpdate
    {
        ...
        internal MachineLearningWorkspaceQuotaUpdate(string id, string updateWorkspaceQuotasType, long? limit, MachineLearningQuotaUnit? unit, MachineLearningWorkspaceQuotaStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
