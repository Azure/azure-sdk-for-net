...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningObjective>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningObjective>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningObjective>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningObjective>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningObjective>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
