...
{
    internal partial class NlpVerticalFeaturizationSettings : IUtf8JsonSerializable, IJsonModel<NlpVerticalFeaturizationSettings>, IPersistableModel<NlpVerticalFeaturizationSettings>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NlpVerticalFeaturizationSettings>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<NlpVerticalFeaturizationSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NlpVerticalFeaturizationSettings)} does not support '{format}' format.");
            }
