...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class NlpVerticalFeaturizationSettings : MachineLearningFeaturizationSettings, IJsonModel<NlpVerticalFeaturizationSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<NlpVerticalFeaturizationSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<NlpVerticalFeaturizationSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        NlpVerticalFeaturizationSettings IPersistableModel<NlpVerticalFeaturizationSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (NlpVerticalFeaturizationSettings)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NlpVerticalFeaturizationSettings IJsonModel<NlpVerticalFeaturizationSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (NlpVerticalFeaturizationSettings)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NlpVerticalFeaturizationSettings DeserializeNlpVerticalFeaturizationSettings(JsonElement element, ModelReaderWriterOptions options)
        {
