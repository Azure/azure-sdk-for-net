...
{
    public partial class MachineLearningDataVersionProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningDataVersionProperties DeserializeMachineLearningDataVersionProperties(JsonElement element)
        {
            ...
            return new MachineLearningDataVersionProperties(description.Value, Core.Optional.ToDictionary(properties), Core.Optional.ToDictionary(tags), Core.Optional.ToNullable(isAnonymous), Core.Optional.ToNullable(isArchived), dataType, dataUri);
        }
    }
}
