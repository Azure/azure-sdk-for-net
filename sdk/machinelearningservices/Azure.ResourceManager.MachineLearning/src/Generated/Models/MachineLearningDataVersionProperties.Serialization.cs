...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningDataVersionProperties : IUtf8JsonSerializable, IModelJsonSerializable<MachineLearningDataVersionProperties>
    {
        ...
        internal static MachineLearningDataVersionProperties DeserializeMachineLearningDataVersionProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownDataVersionBase(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), dataType, dataUri, serializedAdditionalRawData);
        }
