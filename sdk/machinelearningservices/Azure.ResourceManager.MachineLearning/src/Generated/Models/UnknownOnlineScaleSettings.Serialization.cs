...
{
    internal partial class UnknownOnlineScaleSettings : MachineLearningOnlineScaleSettings, IJsonModel<MachineLearningOnlineScaleSettings>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownOnlineScaleSettings DeserializeUnknownOnlineScaleSettings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownOnlineScaleSettings(scaleType, additionalBinaryDataProperties);
        }
    }
}
