...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ArmResourceId>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ArmResourceId>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ArmResourceId>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ArmResourceId>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
