...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningAzureDataLakeGen1Datastore : MachineLearningDatastoreProperties
    {
        ...
        internal MachineLearningAzureDataLakeGen1Datastore(string description, IDictionary<string, string> properties, IDictionary<string, string> tags, MachineLearningDatastoreCredentials credentials, DatastoreType datastoreType, bool? isDefault, MachineLearningServiceDataAccessAuthIdentity? serviceDataAccessAuthIdentity, string storeName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(description, properties, tags, credentials, datastoreType, isDefault, serializedAdditionalRawData)
        {
