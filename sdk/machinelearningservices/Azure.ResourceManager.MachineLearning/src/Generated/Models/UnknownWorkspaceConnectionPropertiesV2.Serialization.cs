...
{
    internal partial class UnknownWorkspaceConnectionPropertiesV2 : Core.IUtf8JsonSerializable
    {
        ...
        internal static UnknownWorkspaceConnectionPropertiesV2 DeserializeUnknownWorkspaceConnectionPropertiesV2(JsonElement element)
        {
            ...
            return new UnknownWorkspaceConnectionPropertiesV2(authType, Core.Optional.ToNullable(category), target.Value, value.Value, Core.Optional.ToNullable(valueFormat));
        }
    }
}
