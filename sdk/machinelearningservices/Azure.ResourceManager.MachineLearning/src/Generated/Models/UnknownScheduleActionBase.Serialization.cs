...
{
    internal partial class UnknownScheduleActionBase : MachineLearningScheduleAction, IJsonModel<MachineLearningScheduleAction>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownScheduleActionBase DeserializeUnknownScheduleActionBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownScheduleActionBase(actionType, additionalBinaryDataProperties);
        }
    }
}
