...
{
    public partial class BatchEndpointDetails : IUtf8JsonSerializable
    {
        ...
        internal static BatchEndpointDetails DeserializeBatchEndpointDetails(JsonElement element)
        {
            ...
            return new BatchEndpointDetails(authMode, description.Value, keys.Value, Optional.ToDictionary(properties), scoringUri.Value, swaggerUri.Value, defaults.Value, Optional.ToNullable(provisioningState));
        }
    }
}
