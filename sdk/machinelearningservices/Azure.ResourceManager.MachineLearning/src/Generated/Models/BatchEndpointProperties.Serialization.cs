...
{
    public partial class BatchEndpointProperties : IUtf8JsonSerializable
    {
        ...
        internal static BatchEndpointProperties DeserializeBatchEndpointProperties(JsonElement element)
        {
            ...
            return new BatchEndpointProperties(authMode, description.Value, keys.Value, Optional.ToDictionary(properties), scoringUri.Value, swaggerUri.Value, defaults.Value, Optional.ToNullable(provisioningState));
        }
    }
}
