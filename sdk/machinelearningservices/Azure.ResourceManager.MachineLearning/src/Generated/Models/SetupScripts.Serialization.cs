...
{
    internal partial class SetupScripts : IUtf8JsonSerializable, IJsonModel<SetupScripts>, IPersistableModel<SetupScripts>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Scripts))
            {
                ...
                AppendChildObject(builder, Scripts, options, 2);
            }
