    ...
    public partial class AccountKeyAuthTypeWorkspaceConnectionProperties : IUtf8JsonSerializable, IJsonModel<AccountKeyAuthTypeWorkspaceConnectionProperties>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Credentials))
            {
                ...
                ((IJsonModel<WorkspaceConnectionAccountKey>)Credentials).Write(writer, options);
            }
        }
        ...
        internal static AccountKeyAuthTypeWorkspaceConnectionProperties DeserializeAccountKeyAuthTypeWorkspaceConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credentials"u8))
                {
                    ...
                    credentials = ModelSerializationExtensions.JsonDeserialize<WorkspaceConnectionAccountKey>(property.Value);
                    continue;
                }
