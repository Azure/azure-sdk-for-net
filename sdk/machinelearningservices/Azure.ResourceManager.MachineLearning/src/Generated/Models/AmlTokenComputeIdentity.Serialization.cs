...
{
    public partial class AmlTokenComputeIdentity : IUtf8JsonSerializable, IJsonModel<AmlTokenComputeIdentity>, IPersistableModel<AmlTokenComputeIdentity>
    {
        ...
        void IJsonModel<AmlTokenComputeIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AmlTokenComputeIdentity)} does not support '{format}' format.");
            }
