...
{
    public partial class AmlTokenComputeIdentity : IUtf8JsonSerializable
    {
        ...
        internal static AmlTokenComputeIdentity DeserializeAmlTokenComputeIdentity(JsonElement element)
        {
            ...
            return new AmlTokenComputeIdentity(computeIdentityType);
        }
    }
}
