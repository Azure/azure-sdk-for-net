...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineLearningFeatureData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineLearningFeatureData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineLearningFeatureData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineLearningFeatureData>)} interface");
            }
        ...
        string IPersistableModel<MachineLearningFeatureData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
