...
{
    internal partial class UnknownMonitorComputeIdentityBase : MonitorComputeIdentityBase, IJsonModel<MonitorComputeIdentityBase>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownMonitorComputeIdentityBase DeserializeUnknownMonitorComputeIdentityBase(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownMonitorComputeIdentityBase(computeIdentityType, additionalBinaryDataProperties);
        }
    }
}
