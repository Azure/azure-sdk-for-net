...
{
    internal partial class UnknownMonitorComputeIdentityBase : IUtf8JsonSerializable, IJsonModel<MonitorComputeIdentityBase>, IPersistableModel<MonitorComputeIdentityBase>
    {
        ...
        void IJsonModel<MonitorComputeIdentityBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MonitorComputeIdentityBase)} does not support '{format}' format.");
            }
