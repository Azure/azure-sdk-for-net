...
{
    internal partial class UnknownPredictionDriftMetricThresholdBase : IUtf8JsonSerializable
    {
        ...
        internal static UnknownPredictionDriftMetricThresholdBase DeserializeUnknownPredictionDriftMetricThresholdBase(JsonElement element)
        {
            ...
            return new UnknownPredictionDriftMetricThresholdBase(dataType, threshold.Value);
        }
    }
}
