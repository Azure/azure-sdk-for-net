...
{
    internal partial class UnknownPredictionDriftMetricThresholdBase : PredictionDriftMetricThresholdBase, IJsonModel<PredictionDriftMetricThresholdBase>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownPredictionDriftMetricThresholdBase DeserializeUnknownPredictionDriftMetricThresholdBase(JsonElement element, ModelReaderWriterOptions options)
        {
