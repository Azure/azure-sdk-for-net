...
namespace Azure.ResourceManager.MachineLearning.Models
{
    internal partial class UnknownPredictionDriftMetricThresholdBase : IUtf8JsonSerializable, IJsonModel<PredictionDriftMetricThresholdBase>
    {
        ...
        void IJsonModel<PredictionDriftMetricThresholdBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PredictionDriftMetricThresholdBase)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PredictionDriftMetricThresholdBase>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PredictionDriftMetricThresholdBase)} does not support '{options.Format}' format.");
            }
        }
