...
{
    public partial class CodeVersionProperties : IUtf8JsonSerializable
    {
        ...
        internal static CodeVersionProperties DeserializeCodeVersionProperties(JsonElement element)
        {
            ...
            return new CodeVersionProperties(description.Value, Optional.ToDictionary(properties), Optional.ToDictionary(tags), Optional.ToNullable(isAnonymous), Optional.ToNullable(isArchived), codeUri.Value);
        }
    }
}
