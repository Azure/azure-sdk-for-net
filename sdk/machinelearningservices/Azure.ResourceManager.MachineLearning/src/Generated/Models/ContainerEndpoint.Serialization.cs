...
{
    public partial class ContainerEndpoint : IUtf8JsonSerializable, IJsonModel<ContainerEndpoint>, IPersistableModel<ContainerEndpoint>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Published))
            {
                ...
                builder.AppendLine($" '{Published.Value.ToString()}'");
            }
