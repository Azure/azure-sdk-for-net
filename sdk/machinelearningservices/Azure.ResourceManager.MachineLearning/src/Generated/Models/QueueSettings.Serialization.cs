...
{
    public partial class QueueSettings : IUtf8JsonSerializable
    {
        ...
        internal static QueueSettings DeserializeQueueSettings(JsonElement element)
        {
            ...
            return new QueueSettings(Optional.ToNullable(jobTier), Optional.ToNullable(priority));
        }
    }
}
