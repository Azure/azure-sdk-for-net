...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class RollingInputData : MonitoringInputDataBase, IJsonModel<RollingInputData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RollingInputData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RollingInputData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RollingInputData IPersistableModel<RollingInputData>.Create(BinaryData data, ModelReaderWriterOptions options) => (RollingInputData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RollingInputData IJsonModel<RollingInputData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RollingInputData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RollingInputData DeserializeRollingInputData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("windowOffset"u8))
                {
                    windowOffset = prop.Value.GetTimeSpan("P");
                    continue;
                }
