...
{
    public partial class AzureMLOnlineInferencingServer : IUtf8JsonSerializable
    {
        ...
        internal static AzureMLOnlineInferencingServer DeserializeAzureMLOnlineInferencingServer(JsonElement element)
        {
            ...
            return new AzureMLOnlineInferencingServer(serverType, codeConfiguration.Value);
        }
    }
}
