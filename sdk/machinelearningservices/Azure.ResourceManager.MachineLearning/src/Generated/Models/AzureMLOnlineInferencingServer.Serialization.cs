...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureMLOnlineInferencingServer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureMLOnlineInferencingServer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureMLOnlineInferencingServer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureMLOnlineInferencingServer>)} interface");
            }
        ...
        string IPersistableModel<AzureMLOnlineInferencingServer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
