...
{
    public partial class MLTableJobInput : IUtf8JsonSerializable
    {
        ...
        internal static MLTableJobInput DeserializeMLTableJobInput(JsonElement element)
        {
            ...
            return new MLTableJobInput(description.Value, jobInputType, Optional.ToNullable(mode), uri);
        }
    }
}
