...
{
    public partial class MachineLearningDataContainerProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static MachineLearningDataContainerProperties DeserializeMachineLearningDataContainerProperties(JsonElement element)
        {
            ...
            return new MachineLearningDataContainerProperties(description.Value, Core.Optional.ToDictionary(properties), Core.Optional.ToDictionary(tags), Core.Optional.ToNullable(isArchived), latestVersion.Value, nextVersion.Value, dataType);
        }
    }
}
