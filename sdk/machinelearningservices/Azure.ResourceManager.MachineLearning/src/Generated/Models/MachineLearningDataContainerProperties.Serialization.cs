...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningDataContainerProperties : MachineLearningAssetContainer, IJsonModel<MachineLearningDataContainerProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MachineLearningDataContainerProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MachineLearningDataContainerProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningDataContainerProperties IPersistableModel<MachineLearningDataContainerProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MachineLearningDataContainerProperties)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MachineLearningDataContainerProperties IJsonModel<MachineLearningDataContainerProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MachineLearningDataContainerProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MachineLearningDataContainerProperties DeserializeMachineLearningDataContainerProperties(JsonElement element, ModelReaderWriterOptions options)
        {
