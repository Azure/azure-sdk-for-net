...
{
    internal partial class UserCreatedStorageAccount : IUtf8JsonSerializable, IJsonModel<UserCreatedStorageAccount>, IPersistableModel<UserCreatedStorageAccount>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ArmResourceIdentifier))
            {
                ...
                AppendChildObject(builder, ArmResourceIdentifier, options, 2);
            }
