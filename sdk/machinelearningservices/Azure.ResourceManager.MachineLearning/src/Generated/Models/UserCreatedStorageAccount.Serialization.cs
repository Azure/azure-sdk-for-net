...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserCreatedStorageAccount>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UserCreatedStorageAccount>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UserCreatedStorageAccount>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<UserCreatedStorageAccount>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
