...
{
    /// <summary> The JobResourceConfiguration. </summary>
    public partial class JobResourceConfiguration : ResourceConfiguration
    {
        /// <summary> Initializes a new instance of JobResourceConfiguration. </summary>
        ...
        internal JobResourceConfiguration(int? instanceCount, string instanceType, IDictionary<string, BinaryData> properties, string dockerArgs, string shmSize) : base(instanceCount, instanceType, properties)
        {
