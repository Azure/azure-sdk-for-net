...
{
    public partial class JobQueueSettings : IUtf8JsonSerializable, IJsonModel<JobQueueSettings>, IPersistableModel<JobQueueSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(JobTier))
            {
                ...
                builder.AppendLine($" '{JobTier.ToString()}'");
            }
