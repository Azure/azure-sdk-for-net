...
{
    public partial class PyTorchDistributionConfiguration : Core.IUtf8JsonSerializable
    {
        ...
        internal static PyTorchDistributionConfiguration DeserializePyTorchDistributionConfiguration(JsonElement element)
        {
            ...
            return new PyTorchDistributionConfiguration(distributionType, Core.Optional.ToNullable(processCountPerInstance));
        }
    }
}
