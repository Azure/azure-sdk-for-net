...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningRegistryPatch
    {
        ...
        internal MachineLearningRegistryPatch(ManagedServiceIdentity identity, MachineLearningSkuPatch sku, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Identity = identity;
            Sku = sku;
            Tags = tags;
