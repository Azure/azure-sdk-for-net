...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class AmlComputeNodeInformation
    {
        ...
        internal AmlComputeNodeInformation(string nodeId, IPAddress privateIPAddress, IPAddress publicIPAddress, int? port, MachineLearningNodeState? nodeState, string runId, Dictionary<string, BinaryData> rawData)
        {
            NodeId = nodeId;
