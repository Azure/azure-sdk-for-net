...
namespace Azure.ResourceManager.MachineLearning.Models
{
    ...
    public partial class MachineLearningSweepJobLimits : MachineLearningJobLimits
    {
        ...
        internal MachineLearningSweepJobLimits(JobLimitsType jobLimitsType, TimeSpan? timeout, int? maxConcurrentTrials, int? maxTotalTrials, TimeSpan? trialTimeout, Dictionary<string, BinaryData> rawData) : base(jobLimitsType, timeout, rawData)
        {
