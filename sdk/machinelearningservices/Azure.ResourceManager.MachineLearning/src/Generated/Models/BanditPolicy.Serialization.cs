...
{
    public partial class BanditPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BanditPolicy DeserializeBanditPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
