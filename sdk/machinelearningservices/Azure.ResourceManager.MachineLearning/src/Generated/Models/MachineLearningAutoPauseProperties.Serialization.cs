...
namespace Azure.ResourceManager.MachineLearning.Models
{
    public partial class MachineLearningAutoPauseProperties : IUtf8JsonSerializable, IJsonModel<MachineLearningAutoPauseProperties>
    {
        ...
        void IJsonModel<MachineLearningAutoPauseProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MachineLearningAutoPauseProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MachineLearningAutoPauseProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MachineLearningAutoPauseProperties)} does not support '{options.Format}' format.");
            }
        }
