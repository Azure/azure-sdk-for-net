...
namespace Azure.ResourceManager.MachineLearning
{
    internal partial class PrivateLinkResources
    {
        ...
        internal HttpMessage CreateGetPrivateLinkResourcesRequest(string subscriptionId, string resourceGroupName, string workspaceName, RequestContext context)
        {
        ...
        internal HttpMessage CreateNextGetPrivateLinkResourcesRequest(Uri nextPage, string subscriptionId, string resourceGroupName, string workspaceName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
