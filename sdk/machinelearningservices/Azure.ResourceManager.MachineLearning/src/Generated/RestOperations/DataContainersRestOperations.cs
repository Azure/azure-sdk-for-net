...
namespace Azure.ResourceManager.MachineLearning
{
    internal partial class DataContainersRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string workspaceName, string name, MachineLearningDataContainerData data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string workspaceName, string name, MachineLearningDataContainerData data)
        {
            ...
            ((IJsonModel<MachineLearningDataContainerData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
