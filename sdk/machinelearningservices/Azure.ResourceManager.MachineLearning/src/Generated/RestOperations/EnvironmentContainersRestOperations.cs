...
namespace Azure.ResourceManager.MachineLearning
{
    internal partial class EnvironmentContainersRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string workspaceName, string name, MachineLearningEnvironmentContainerData data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string workspaceName, string name, MachineLearningEnvironmentContainerData data)
        {
            ...
            ((IJsonModel<MachineLearningEnvironmentContainerData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
