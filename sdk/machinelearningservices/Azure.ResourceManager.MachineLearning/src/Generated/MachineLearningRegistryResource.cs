...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningRegistryResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the MachineLearningRegistry.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/registries/{registryName}. </description>
        ...
        public virtual async Task<ArmOperation<MachineLearningRegistryResource>> UpdateAsync(WaitUntil waitUntil, MachineLearningRegistryData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _registriesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, MachineLearningRegistryData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                MachineLearningArmOperation<MachineLearningRegistryResource> operation = new MachineLearningArmOperation<MachineLearningRegistryResource>(
                    new MachineLearningRegistryResourceOperationSource(Client),
                    _registriesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<MachineLearningRegistryResource> Update(WaitUntil waitUntil, MachineLearningRegistryData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
