...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningOnlineDeploymentResource : ArmResource
    {
        ...
        internal MachineLearningOnlineDeploymentResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _onlineDeploymentsRestClient = new OnlineDeployments(_onlineDeploymentsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, machineLearningOnlineDeploymentApiVersion ?? "2026-07-01");
        ...
        /// <summary>
        /// Updates the MachineLearningOnlineDeployment.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/onlineEndpoints/{endpointName}/deployments/{deploymentName}. </description>
        ...
        public virtual async Task<ArmOperation<MachineLearningOnlineDeploymentResource>> UpdateAsync(WaitUntil waitUntil, MachineLearningOnlineDeploymentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _onlineDeploymentsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, MachineLearningOnlineDeploymentData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                MachineLearningArmOperation<MachineLearningOnlineDeploymentResource> operation = new MachineLearningArmOperation<MachineLearningOnlineDeploymentResource>(
                    new MachineLearningOnlineDeploymentResourceOperationSource(Client),
                    _onlineDeploymentsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<MachineLearningOnlineDeploymentResource> Update(WaitUntil waitUntil, MachineLearningOnlineDeploymentData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
