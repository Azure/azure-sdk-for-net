...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningEnvironmentContainerResource : ArmResource
    {
        ...
        internal MachineLearningEnvironmentContainerResource(ArmClient client, MachineLearningEnvironmentContainerData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
