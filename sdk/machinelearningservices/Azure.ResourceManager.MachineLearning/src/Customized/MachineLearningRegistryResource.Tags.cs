...
namespace Azure.ResourceManager.MachineLearning
{
    ...
    public partial class MachineLearningRegistryResource
    {
        ...
        public virtual Task<Response<MachineLearningRegistryResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        ...
        public virtual Task<Response<MachineLearningRegistryResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        ...
        public virtual Task<Response<MachineLearningRegistryResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
