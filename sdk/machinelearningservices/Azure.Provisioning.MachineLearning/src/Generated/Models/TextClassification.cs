...
namespace Azure.Provisioning.MachineLearning
{
    ...
    public partial class TextClassification : AutoMLVertical
    {
        ...
        /// <summary> Creates a new TextClassification. </summary>
        ...
        /// <summary> Define all the provisionable properties for TextClassification. </summary>
        protected override void DefineProvisionableProperties()
        {
            base.DefineProvisionableProperties();
            DefineProperty<string>("taskType", new string[] { "taskType" }, defaultValue: "TextClassification");
        ...
        /// <summary> Define additional provisionable properties for TextClassification that are not part of the generated code. </summary>
