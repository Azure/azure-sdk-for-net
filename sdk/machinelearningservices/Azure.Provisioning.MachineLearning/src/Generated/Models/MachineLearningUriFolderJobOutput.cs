...
namespace Azure.Provisioning.MachineLearning
{
    ...
    public partial class MachineLearningUriFolderJobOutput : MachineLearningJobOutput
    {
        ...
        /// <summary> Define all the provisionable properties for MachineLearningUriFolderJobOutput. </summary>
        protected override void DefineProvisionableProperties()
        {
            base.DefineProvisionableProperties();
            JobOutputType.Assign("uri_folder");
        ...
        /// <summary> Define additional provisionable properties for MachineLearningUriFolderJobOutput that are not part of the generated code. </summary>
