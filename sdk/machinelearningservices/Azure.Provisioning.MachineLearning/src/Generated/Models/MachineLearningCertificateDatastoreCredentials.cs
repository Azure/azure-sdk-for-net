...
namespace Azure.Provisioning.MachineLearning
{
    ...
    public partial class MachineLearningCertificateDatastoreCredentials : MachineLearningDatastoreCredentials
    {
        ...
        private MachineLearningCertificateDatastoreSecrets _secrets;
        private BicepValue<Guid> _tenantId;
        private BicepValue<string> _thumbprint;

        /// <summary> Creates a new MachineLearningCertificateDatastoreCredentials. </summary>
        ...
        internal MachineLearningCertificateDatastoreSecrets Secrets
        {
            get
            {
                Initialize();
        ...
        public BicepValue<string> SecretsCertificate
        {
            get
            {
                return Secrets is null ? default : Secrets.Certificate;
            }
            set
            {
                if (Secrets is null)
                {
                    Secrets = new MachineLearningCertificateDatastoreSecrets();
                }
                Secrets.Certificate = value;
            }
        }

        /// <summary> Define all the provisionable properties for MachineLearningCertificateDatastoreCredentials. </summary>
        protected override void DefineProvisionableProperties()
        {
            base.DefineProvisionableProperties();
            DefineProperty<string>("credentialsType", new string[] { "credentialsType" }, defaultValue: "Certificate");
            ...
            _secrets = DefineModelProperty<MachineLearningCertificateDatastoreSecrets>(nameof(Secrets), new string[] { "secrets" }, isRequired: true);
        ...
        /// <summary> Define additional provisionable properties for MachineLearningCertificateDatastoreCredentials that are not part of the generated code. </summary>
