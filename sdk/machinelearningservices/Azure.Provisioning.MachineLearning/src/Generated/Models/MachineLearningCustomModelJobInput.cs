...
namespace Azure.Provisioning.MachineLearning
{
    ...
    public partial class MachineLearningCustomModelJobInput : MachineLearningJobInput
    {
        ...
        /// <summary> Define all the provisionable properties for MachineLearningCustomModelJobInput. </summary>
        protected override void DefineProvisionableProperties()
        {
            base.DefineProvisionableProperties();
            JobInputType.Assign("custom_model");
        ...
        /// <summary> Define additional provisionable properties for MachineLearningCustomModelJobInput that are not part of the generated code. </summary>
