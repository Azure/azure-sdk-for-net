...
namespace Azure.Provisioning.MachineLearning
{
    ...
    public partial class MachineLearningRegistryModelContainer : ProvisionableResource
    {
        ...
        public MachineLearningRegistryModelContainer(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.MachineLearningServices/registries/models", resourceVersion ?? "2026-05-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for MachineLearningRegistryModelContainer. </summary>
        ...
        /// <summary> Creates a reference to an existing MachineLearningRegistryModelContainer. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static MachineLearningRegistryModelContainer FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            MachineLearningRegistryModelContainer result = new MachineLearningRegistryModelContainer(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for MachineLearningRegistryModelContainer that are not part of the generated code. </summary>
