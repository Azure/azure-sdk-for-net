...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    internal partial class ArmResourceExtensionClient : ArmResource
    {
        ...
        public virtual async Task<Response<SelfHelpNameAvailabilityResult>> PostCheckNameAvailabilityAsync(SelfHelpNameAvailabilityContent content = null, CancellationToken cancellationToken = default)
        {
            using var scope = CheckNameAvailabilityClientDiagnostics.CreateScope("ArmResourceExtensionClient.PostCheckNameAvailability");
            scope.Start();
            try
            {
        ...
        /// <param name="content"> The required parameters for availability check. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<SelfHelpNameAvailabilityResult> PostCheckNameAvailability(SelfHelpNameAvailabilityContent content = null, CancellationToken cancellationToken = default)
        {
            using var scope = CheckNameAvailabilityClientDiagnostics.CreateScope("ArmResourceExtensionClient.PostCheckNameAvailability");
            scope.Start();
            try
