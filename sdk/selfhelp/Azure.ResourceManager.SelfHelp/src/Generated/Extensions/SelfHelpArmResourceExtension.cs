...
namespace Azure.ResourceManager.SelfHelp.Testing
{
    /// <summary> A class to add extension methods to ArmResource. </summary>
    public partial class SelfHelpArmResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SelfHelpArmResourceExtension"/> class for mocking. </summary>
        protected SelfHelpArmResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SelfHelpArmResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SelfHelpArmResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = SelfHelpDiagnosticDiagnosticsClientDiagnostics.CreateScope("SelfHelpArmResourceExtension.CheckSelfHelpNameAvailability");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<SelfHelpSolutionMetadata> GetSelfHelpDiscoverySolutionsAsync(string filter = null, string skiptoken = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, SelfHelpSolutionMetadata.DeserializeSelfHelpSolutionMetadata, DiscoverySolutionClientDiagnostics, Pipeline, "SelfHelpArmResourceExtension.GetSelfHelpDiscoverySolutions", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<SelfHelpSolutionMetadata> GetSelfHelpDiscoverySolutions(string filter = null, string skiptoken = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DiscoverySolutionRestClient.CreateListRequest(Id, filter, skiptoken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DiscoverySolutionRestClient.CreateListNextPageRequest(nextLink, Id, filter, skiptoken);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, SelfHelpSolutionMetadata.DeserializeSelfHelpSolutionMetadata, DiscoverySolutionClientDiagnostics, Pipeline, "SelfHelpArmResourceExtension.GetSelfHelpDiscoverySolutions", "value", "nextLink", cancellationToken);
        }
    }
}
