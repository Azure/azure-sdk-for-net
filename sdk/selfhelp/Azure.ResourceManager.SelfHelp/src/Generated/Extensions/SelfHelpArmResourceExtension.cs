...
namespace Azure.ResourceManager.SelfHelp.Mock
{
    ...
    public partial class SelfHelpArmResourceExtension : ArmResource
    {
        ...
        public virtual AsyncPageable<SolutionMetadataResource> GetDiscoverySolutionsAsync(string filter = null, string skiptoken = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, SolutionMetadataResource.DeserializeSolutionMetadataResource, DiscoverySolutionClientDiagnostics, Pipeline, "SelfHelpArmResourceExtension.GetDiscoverySolutions", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<SolutionMetadataResource> GetDiscoverySolutions(string filter = null, string skiptoken = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DiscoverySolutionRestClient.CreateListRequest(Id, filter, skiptoken);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DiscoverySolutionRestClient.CreateListNextPageRequest(nextLink, Id, filter, skiptoken);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, SolutionMetadataResource.DeserializeSolutionMetadataResource, DiscoverySolutionClientDiagnostics, Pipeline, "SelfHelpArmResourceExtension.GetDiscoverySolutions", "value", "nextLink", cancellationToken);
        }
    }
}
