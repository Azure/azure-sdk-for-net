...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    public static partial class SelfHelpExtensions
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public static async Task<Response<SelfHelpCheckNameAvailabilityResult>> CheckSelfHelpNameAvailabilityAsync(this ArmClient client, ResourceIdentifier scope, SelfHelpCheckNameAvailabilityContent content = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="content"> The required parameters for availability check. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public static Response<SelfHelpCheckNameAvailabilityResult> CheckSelfHelpNameAvailability(this ArmClient client, ResourceIdentifier scope, SelfHelpCheckNameAvailabilityContent content = null, CancellationToken cancellationToken = default)
        {
