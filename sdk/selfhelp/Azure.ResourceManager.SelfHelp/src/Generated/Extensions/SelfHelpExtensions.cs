...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    public static partial class SelfHelpExtensions
    {
        ...
        {
            return GetArmResourceExtensionClient(client, scope).GetSolutionResources();
        }
        ...
        {
            return await client.GetSolutionResources(scope).GetAsync(solutionResourceName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return client.GetSolutionResources(scope).Get(solutionResourceName, cancellationToken);
        }
        ...
        {
            return GetArmResourceExtensionClient(client, scope).GetTroubleshooterResources();
        }
        ...
        {
            return await client.GetTroubleshooterResources(scope).GetAsync(troubleshooterName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return client.GetTroubleshooterResources(scope).Get(troubleshooterName, cancellationToken);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public static async Task<Response<SelfHelpNameAvailabilityResult>> PostCheckNameAvailabilityAsync(this ArmClient client, ResourceIdentifier scope, SelfHelpNameAvailabilityContent content = null, CancellationToken cancellationToken = default)
        {
            return await GetArmResourceExtensionClient(client, scope).PostCheckNameAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="content"> The required parameters for availability check. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public static Response<SelfHelpNameAvailabilityResult> PostCheckNameAvailability(this ArmClient client, ResourceIdentifier scope, SelfHelpNameAvailabilityContent content = null, CancellationToken cancellationToken = default)
        {
            return GetArmResourceExtensionClient(client, scope).PostCheckNameAvailability(content, cancellationToken);
        }
