...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    public static partial class SelfHelpExtensions
    {
        ...
        private static SelfHelpArmResourceMockingExtension GetSelfHelpArmResourceMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new SelfHelpArmResourceMockingExtension(client, resource.Id);
            });
        }
        ...
        /// <returns> An object representing collection of SelfHelpDiagnosticResources and their operations over a SelfHelpDiagnosticResource. </returns>
        public static SelfHelpDiagnosticCollection GetSelfHelpDiagnostics(this ArmResource armResource)
        {
            return GetSelfHelpArmResourceMockingExtension(armResource).GetSelfHelpDiagnostics();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticsResourceName"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<SelfHelpDiagnosticResource>> GetSelfHelpDiagnosticAsync(this ArmResource armResource, string diagnosticsResourceName, CancellationToken cancellationToken = default)
        {
            return await GetSelfHelpArmResourceMockingExtension(armResource).GetSelfHelpDiagnosticAsync(diagnosticsResourceName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticsResourceName"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<SelfHelpDiagnosticResource> GetSelfHelpDiagnostic(this ArmResource armResource, string diagnosticsResourceName, CancellationToken cancellationToken = default)
        {
            return GetSelfHelpArmResourceMockingExtension(armResource).GetSelfHelpDiagnostic(diagnosticsResourceName, cancellationToken);
        }
    }
}
