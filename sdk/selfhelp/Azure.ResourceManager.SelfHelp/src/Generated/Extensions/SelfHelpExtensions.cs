...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    public static partial class SelfHelpExtensions
    {
        ...
        /// <summary>
        /// Gets an object representing a <see cref="SelfHelpSimplifiedSolutionsResource"/> along with the instance operations that can be performed on it but with no data.
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableSelfHelpArmClient.GetSelfHelpSimplifiedSolutionsResource(ResourceIdentifier)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="id"> The resource ID of the resource to get. </param>
        ...
        public static SelfHelpSimplifiedSolutionsResource GetSelfHelpSimplifiedSolutionsResource(this ArmClient client, ResourceIdentifier id)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableSelfHelpArmClient(client).GetSelfHelpSimplifiedSolutionsResource(id);
        }

        /// <summary>
        /// Gets a collection of <see cref="SelfHelpSimplifiedSolutionsCollection"/> objects within the specified scope.
        /// <item>
        /// <term> Mocking. </term>
        ...
        public static SelfHelpSimplifiedSolutionsCollection GetSelfHelpSimplifiedSolutions(this ArmClient client, ResourceIdentifier scope)
        {
            Argument.AssertNotNull(client, nameof(client));
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableSelfHelpArmClient.GetSelfHelpSimplifiedSolutions(ResourceIdentifier, string, CancellationToken)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="scope"> The scope of the resource collection to get. </param>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="client"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<SelfHelpSimplifiedSolutionsResource> GetSelfHelpSimplifiedSolutions(this ArmClient client, ResourceIdentifier scope, string simplifiedSolutionsResourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(client, nameof(client));

            return GetMockableSelfHelpArmClient(client).GetSelfHelpSimplifiedSolutions(scope, simplifiedSolutionsResourceName, cancellationToken);
        }
        ...
        /// <item>
        /// <term> Mocking. </term>
        /// <description> To mock this method, please mock <see cref="MockableSelfHelpArmClient.GetSelfHelpSimplifiedSolutionsAsync(ResourceIdentifier, string, CancellationToken)"/> instead. </description>
        /// </item>
        /// </summary>
        /// <param name="client"> The <see cref="ArmClient"/> the method will execute against. </param>
        /// <param name="scope"> The scope of the resource collection to get. </param>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="client"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<SelfHelpSimplifiedSolutionsResource>> GetSelfHelpSimplifiedSolutionsAsync(this ArmClient client, ResourceIdentifier scope, string simplifiedSolutionsResourceName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(client, nameof(client));

            return await GetMockableSelfHelpArmClient(client).GetSelfHelpSimplifiedSolutionsAsync(scope, simplifiedSolutionsResourceName, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static async Task<Response<DiscoveryNlpResult>> DiscoverSolutionsNlpAsync(this SubscriptionResource subscriptionResource, DiscoveryNlpContent discoverSolutionRequest = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(subscriptionResource, nameof(subscriptionResource));

            return await GetMockableSelfHelpSubscriptionResource(subscriptionResource).DiscoverSolutionsNlpAsync(discoverSolutionRequest, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionResource"/> is null. </exception>
        public static Response<DiscoveryNlpResult> DiscoverSolutionsNlp(this SubscriptionResource subscriptionResource, DiscoveryNlpContent discoverSolutionRequest = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(subscriptionResource, nameof(subscriptionResource));

            return GetMockableSelfHelpSubscriptionResource(subscriptionResource).DiscoverSolutionsNlp(discoverSolutionRequest, cancellationToken);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tenantResource"/> is null. </exception>
        public static async Task<Response<DiscoveryNlpResult>> DiscoverSolutionsNlpAsync(this TenantResource tenantResource, DiscoveryNlpContent discoverSolutionRequest = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tenantResource, nameof(tenantResource));

            return await GetMockableSelfHelpTenantResource(tenantResource).DiscoverSolutionsNlpAsync(discoverSolutionRequest, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tenantResource"/> is null. </exception>
        public static Response<DiscoveryNlpResult> DiscoverSolutionsNlp(this TenantResource tenantResource, DiscoveryNlpContent discoverSolutionRequest = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tenantResource, nameof(tenantResource));

            return GetMockableSelfHelpTenantResource(tenantResource).DiscoverSolutionsNlp(discoverSolutionRequest, cancellationToken);
        }
