    ...
    public partial class MockableSelfHelpSubscriptionResource : ArmResource
    {
        ...
        public virtual async Task<Response<DiscoveryNlpResult>> DiscoverSolutionsNlpAsync(DiscoveryNlpContent discoverSolutionRequest = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = DiscoverySolutionNLPRestClient.CreateDiscoverSolutionsNlpRequest(Guid.Parse(Id.SubscriptionId), DiscoveryNlpContent.ToRequestContent(discoverSolutionRequest), context);
