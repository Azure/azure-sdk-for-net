...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    public partial class SelfHelpSolutionResultData : ResourceData, IJsonModel<SelfHelpSolutionResultData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SelfHelpSolutionResultData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SelfHelpSolutionResultData IJsonModel<SelfHelpSolutionResultData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SelfHelpSolutionResultData)JsonModelCreateCore(ref reader, options);
        ...
        protected virtual ResourceData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SelfHelpSolutionResultData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SelfHelpSolutionResultData DeserializeSelfHelpSolutionResultData(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SelfHelpSolutionResultData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SelfHelpSolutionResultData)} does not support writing '{options.Format}' format.");
            }
        }
