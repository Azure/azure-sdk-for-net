...
namespace Azure.ResourceManager.SelfHelp
{
    internal partial class DiscoverySolutionDiscoverSolutionsCollectionResultOfT : Pageable<SelfHelpSolutionMetadata>
    {
        ...
        public DiscoverySolutionDiscoverSolutionsCollectionResultOfT(DiscoverySolution client, string filter, string skiptoken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
