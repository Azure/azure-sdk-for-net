...
{
    internal partial class DiscoverySolutionDiscoverSolutionsAsyncCollectionResultOfT : AsyncPageable<SelfHelpSolutionMetadata>
    {
        ...
        /// <returns> The pages of DiscoverySolutionDiscoverSolutionsAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<SelfHelpSolutionMetadata>> AsPages(string continuationToken, int? pageSizeHint)
        {
