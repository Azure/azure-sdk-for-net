...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    public partial class SelfHelpSolutionResource : ArmResource
    {
        ...
        /// <param name="solutionPatchRequestBody"> The required request body for updating a solution resource. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<SelfHelpSolutionResource>> UpdateAsync(WaitUntil waitUntil, SelfHelpSolutionPatch solutionPatchRequestBody = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _solutionResourcesRestClient.CreateUpdateRequest(Id.Parent, Id.Name, SelfHelpSolutionPatch.ToRequestContent(solutionPatchRequestBody), context);
        ...
        /// <param name="solutionPatchRequestBody"> The required request body for updating a solution resource. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<SelfHelpSolutionResource> Update(WaitUntil waitUntil, SelfHelpSolutionPatch solutionPatchRequestBody = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _solutionResourcesClientDiagnostics.CreateScope("SelfHelpSolutionResource.Update");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> WarmUpAsync(SolutionWarmUpContent solutionWarmUpRequestBody = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _solutionResourcesRestClient.CreateWarmUpRequest(Id.Parent, Id.Name, SolutionWarmUpContent.ToRequestContent(solutionWarmUpRequestBody), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// <param name="solutionWarmUpRequestBody"> The required request body for warming up a solution resource. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response WarmUp(SolutionWarmUpContent solutionWarmUpRequestBody = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _solutionResourcesClientDiagnostics.CreateScope("SelfHelpSolutionResource.WarmUp");
            scope.Start();
            try
