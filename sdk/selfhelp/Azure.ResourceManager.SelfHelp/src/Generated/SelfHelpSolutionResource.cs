...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    public partial class SelfHelpSolutionResource : ArmResource
    {
        ...
        public virtual async Task<Response> WarmUpAsync(SolutionWarmUpRequestBody solutionWarmUpRequestBody = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _selfHelpSolutionSolutionResourcesRestClient.WarmUpAsync(Id.Parent, Id.Name, solutionWarmUpRequestBody, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response WarmUp(SolutionWarmUpRequestBody solutionWarmUpRequestBody = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _selfHelpSolutionSolutionResourcesRestClient.WarmUp(Id.Parent, Id.Name, solutionWarmUpRequestBody, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
