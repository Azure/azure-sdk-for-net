...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    public partial class SearchResult
    {
        ...
        internal SearchResult(string solutionId, string content, string title, Confidence? confidence, string source, ResultType? resultType, int? rank, string link, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
