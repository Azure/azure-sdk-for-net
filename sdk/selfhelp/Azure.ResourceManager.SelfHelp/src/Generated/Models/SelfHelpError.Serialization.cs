...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SelfHelpError>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SelfHelpError>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SelfHelpError>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SelfHelpError>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
