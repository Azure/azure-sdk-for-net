...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReplacementMaps>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReplacementMaps>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReplacementMaps>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReplacementMaps>)} interface");
            }
        ...
        string IPersistableModel<ReplacementMaps>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
