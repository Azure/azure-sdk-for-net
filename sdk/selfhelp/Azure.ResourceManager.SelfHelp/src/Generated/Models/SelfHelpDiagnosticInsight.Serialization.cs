...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    {
        internal static SelfHelpDiagnosticInsight DeserializeSelfHelpDiagnosticInsight(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
