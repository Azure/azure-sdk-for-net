...
{
    public partial class TriggerCriterion : IUtf8JsonSerializable, IJsonModel<TriggerCriterion>, IPersistableModel<TriggerCriterion>
    {
        ...
        void IJsonModel<TriggerCriterion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TriggerCriterion)} does not support '{format}' format.");
            }
