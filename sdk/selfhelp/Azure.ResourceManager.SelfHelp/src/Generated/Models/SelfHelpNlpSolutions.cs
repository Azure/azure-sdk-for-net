...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    internal partial class SelfHelpNlpSolutions
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SelfHelpNlpSolutions"/>. </summary>
        public SelfHelpNlpSolutions()
        {
        ...
        internal SelfHelpNlpSolutions(string problemTitle, string problemDescription, string serviceId, string problemClassificationId, IList<SolutionMetadataProperties> solutions, IList<ClassificationService> relatedServices, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
