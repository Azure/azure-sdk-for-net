...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SolutionsTroubleshooters>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SolutionsTroubleshooters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SolutionsTroubleshooters>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SolutionsTroubleshooters>)} interface");
            }
        ...
        string IPersistableModel<SolutionsTroubleshooters>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
