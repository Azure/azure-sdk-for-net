...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContinueRequestBody>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContinueRequestBody>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContinueRequestBody>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContinueRequestBody>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
