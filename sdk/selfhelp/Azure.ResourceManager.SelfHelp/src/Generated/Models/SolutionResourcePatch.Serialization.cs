...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SolutionResourcePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SolutionResourcePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SolutionResourcePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SolutionResourcePatch>)} interface");
            }
        ...
        string IPersistableModel<SolutionResourcePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
