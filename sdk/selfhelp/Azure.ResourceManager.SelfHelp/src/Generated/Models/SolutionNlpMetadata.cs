...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    public partial class SolutionNlpMetadata : ResourceData
    {
        ...
        internal SolutionNlpMetadata(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SelfHelpNlpSolutions properties) : base(id, name, resourceType, systemData)
        {
        ...
        internal SelfHelpNlpSolutions Properties { get; set; }
        ...
        public string ProblemTitle
        {
            ...
            set
            {
                ...
                {
                    Properties = new SelfHelpNlpSolutions();
                }
