...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    public partial class SelfHelpError
    {
        ...
        internal SelfHelpError(string code, string errorType, string message, IReadOnlyList<SelfHelpError> details, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            ErrorType = errorType;
            Message = message;
