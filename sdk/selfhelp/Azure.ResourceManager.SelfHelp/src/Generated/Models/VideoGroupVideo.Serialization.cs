...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VideoGroupVideo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VideoGroupVideo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VideoGroupVideo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VideoGroupVideo>)} interface");
            }
        ...
        string IPersistableModel<VideoGroupVideo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
