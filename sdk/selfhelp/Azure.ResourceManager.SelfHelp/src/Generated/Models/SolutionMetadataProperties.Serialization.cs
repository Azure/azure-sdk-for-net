...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SolutionMetadataProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SolutionMetadataProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SolutionMetadataProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SolutionMetadataProperties>)} interface");
            }
        ...
        string IPersistableModel<SolutionMetadataProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
