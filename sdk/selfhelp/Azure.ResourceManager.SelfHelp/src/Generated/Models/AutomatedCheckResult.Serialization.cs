...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutomatedCheckResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutomatedCheckResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutomatedCheckResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutomatedCheckResult>)} interface");
            }
        ...
        string IPersistableModel<AutomatedCheckResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
