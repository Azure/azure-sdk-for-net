...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    public partial class SelfHelpVideo : VideoGroupVideo
    {
        ...
        internal SelfHelpVideo(string src, string title, IDictionary<string, BinaryData> additionalBinaryDataProperties, string replacementKey) : base(src, title, additionalBinaryDataProperties)
        {
