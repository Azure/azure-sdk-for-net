...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    public partial class SelfHelpDiagnosticInsight
    {
        ...
        internal SelfHelpDiagnosticInsight(string id, string title, string results, SelfHelpImportanceLevel? insightImportanceLevel, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Title = title;
            Results = results;
