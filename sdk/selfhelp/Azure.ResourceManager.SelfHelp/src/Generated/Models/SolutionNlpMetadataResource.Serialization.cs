...
{
    public partial class SolutionNlpMetadataResource : IUtf8JsonSerializable, IJsonModel<SolutionNlpMetadataResource>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SolutionNlpMetadataResource>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<SolutionNlpMetadataResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SolutionNlpMetadataResource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SolutionNlpMetadataResource)} does not support writing '{format}' format.");
            }
        ...
        SolutionNlpMetadataResource IJsonModel<SolutionNlpMetadataResource>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SolutionNlpMetadataResource>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SolutionNlpMetadataResource)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeSolutionNlpMetadataResource(document.RootElement, options);
        }

        internal static SolutionNlpMetadataResource DeserializeSolutionNlpMetadataResource(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<SolutionNlpMetadataResource>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SolutionNlpMetadataResource>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SolutionNlpMetadataResource)} does not support writing '{options.Format}' format.");
            }
        }

        SolutionNlpMetadataResource IPersistableModel<SolutionNlpMetadataResource>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SolutionNlpMetadataResource>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SolutionNlpMetadataResource)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<SolutionNlpMetadataResource>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
