...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SelfHelpDiagnosticData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SelfHelpDiagnosticData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SelfHelpDiagnosticData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SelfHelpDiagnosticData>)} interface");
            }
        ...
        string IPersistableModel<SelfHelpDiagnosticData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
