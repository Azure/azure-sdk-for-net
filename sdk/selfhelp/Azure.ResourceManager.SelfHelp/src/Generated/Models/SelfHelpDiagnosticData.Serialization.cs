...
{
    public partial class SelfHelpDiagnosticData : IUtf8JsonSerializable, IJsonModel<SelfHelpDiagnosticData>, IPersistableModel<SelfHelpDiagnosticData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  acceptedAt:");
                builder.AppendLine($" '{AcceptedOn.Value.ToString()}'");
            }
