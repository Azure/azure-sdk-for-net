...
namespace Azure.ResourceManager.SelfHelp.Models
{
    ...
    public partial class Step
    {
        ...
        internal Step(string id, string title, string description, string guidance, ExecutionStatus? executionStatus, string executionStatusDescription, Type? type, bool? isLastStep, IReadOnlyList<StepInput> inputs, AutomatedCheckResult automatedCheckResults, IReadOnlyList<Insight> insights, ResponseError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Title = title;
