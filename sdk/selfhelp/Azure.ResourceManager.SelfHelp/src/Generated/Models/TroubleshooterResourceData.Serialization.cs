...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TroubleshooterResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TroubleshooterResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TroubleshooterResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TroubleshooterResourceData>)} interface");
            }
        ...
        string IPersistableModel<TroubleshooterResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
