...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SolutionResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SolutionResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SolutionResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SolutionResourceData>)} interface");
            }
        ...
        string IPersistableModel<SolutionResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
