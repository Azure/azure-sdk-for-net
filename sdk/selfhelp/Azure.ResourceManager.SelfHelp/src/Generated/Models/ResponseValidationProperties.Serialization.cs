...
{
    public partial class ResponseValidationProperties : IUtf8JsonSerializable, IJsonModel<ResponseValidationProperties>, IPersistableModel<ResponseValidationProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ValidationErrorMessage))
            {
                ...
                builder.AppendLine($" '{ValidationErrorMessage}'");
            }
