...
{
    public partial class RestartTroubleshooterResult : IUtf8JsonSerializable, IJsonModel<RestartTroubleshooterResult>, IPersistableModel<RestartTroubleshooterResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestartTroubleshooterResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RestartTroubleshooterResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RestartTroubleshooterResult)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  troubleshooterResourceName:");
                builder.AppendLine($" '{TroubleshooterResourceName}'");
            }
