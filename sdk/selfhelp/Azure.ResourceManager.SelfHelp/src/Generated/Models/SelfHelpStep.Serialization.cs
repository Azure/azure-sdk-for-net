...
{
    public partial class SelfHelpStep : IUtf8JsonSerializable, IJsonModel<SelfHelpStep>, IPersistableModel<SelfHelpStep>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AutomatedCheckResults))
            {
                ...
                AppendChildObject(builder, AutomatedCheckResults, options, 2);
            }
