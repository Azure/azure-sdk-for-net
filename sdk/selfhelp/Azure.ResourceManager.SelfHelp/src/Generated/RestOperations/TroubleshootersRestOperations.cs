...
namespace Azure.ResourceManager.SelfHelp
{
    internal partial class TroubleshootersRestOperations
    {
        ...
        internal HttpMessage CreateCreateRequest(string scope, string troubleshooterName, SelfHelpTroubleshooterData data)
        {
            ...
            ((IJsonModel<SelfHelpTroubleshooterData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateContinueRequest(string scope, string troubleshooterName, TroubleshooterContinueContent content)
        {
            ...
            if (content != null)
            {
                ...
                ((IJsonModel<TroubleshooterContinueContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
