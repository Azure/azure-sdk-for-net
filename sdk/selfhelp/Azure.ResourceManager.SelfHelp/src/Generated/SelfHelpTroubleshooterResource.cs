...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    public partial class SelfHelpTroubleshooterResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> ContinueAsync(TroubleshooterContinueContent continueRequestBody = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _troubleshooterResourcesRestClient.CreateContinueRequest(Id.Parent, Id.Name, TroubleshooterContinueContent.ToRequestContent(continueRequestBody), context);
        ...
        /// <param name="continueRequestBody"> The required request body for going to next step in Troubleshooter resource. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response Continue(TroubleshooterContinueContent continueRequestBody = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _troubleshooterResourcesClientDiagnostics.CreateScope("SelfHelpTroubleshooterResource.Continue");
            scope.Start();
            try
