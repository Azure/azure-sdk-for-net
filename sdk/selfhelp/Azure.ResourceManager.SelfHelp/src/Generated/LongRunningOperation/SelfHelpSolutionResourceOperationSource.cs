...
{
    /// <summary></summary>
    internal partial class SelfHelpSolutionResourceOperationSource : IOperationSource<SelfHelpSolutionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal SelfHelpSolutionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
