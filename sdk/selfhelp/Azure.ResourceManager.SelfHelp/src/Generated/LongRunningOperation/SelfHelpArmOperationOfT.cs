...
namespace Azure.ResourceManager.SelfHelp
{
    internal partial class SelfHelpArmOperation<T> : ArmOperation<T>
    {
        ...
        internal SelfHelpArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
