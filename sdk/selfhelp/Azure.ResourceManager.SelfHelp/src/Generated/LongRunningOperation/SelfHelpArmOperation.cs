...
{
    internal partial class SelfHelpArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of SelfHelpArmOperation for mocking. </summary>
        protected SelfHelpArmOperation()
        {
        }
        ...
        internal SelfHelpArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SelfHelpArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
