...
{
    /// <summary>
    /// A Class representing a SelfHelpDiagnosticResource along with the instance operations that can be performed on it.
    ...
    /// Otherwise you can get one from its parent resource <see cref="ArmResource" /> using the GetSelfHelpDiagnosticResource method.
    /// </summary>
    public partial class SelfHelpDiagnosticResource : ArmResource
    {
        ...
        private readonly SelfHelpDiagnosticResourceData _data;
        ...
        internal SelfHelpDiagnosticResource(ArmClient client, SelfHelpDiagnosticResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _selfHelpDiagnosticResourceDiagnosticsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SelfHelp", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string selfHelpDiagnosticResourceDiagnosticsApiVersion);
        ...
        public virtual SelfHelpDiagnosticResourceData Data
        {
            get
            {
                if (!HasData)
        ...
        {
            using var scope = _selfHelpDiagnosticResourceDiagnosticsClientDiagnostics.CreateScope("SelfHelpDiagnosticResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation<SelfHelpDiagnosticResource>> UpdateAsync(WaitUntil waitUntil, SelfHelpDiagnosticResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _selfHelpDiagnosticResourceDiagnosticsClientDiagnostics.CreateScope("SelfHelpDiagnosticResource.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<SelfHelpDiagnosticResource> Update(WaitUntil waitUntil, SelfHelpDiagnosticResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
