...
namespace Azure.ResourceManager.SelfHelp
{
    ...
    public partial class SelfHelpDiagnosticData : ResourceData
    {
        ...
        internal SelfHelpDiagnosticData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SelfHelpDiagnosticResourceProperties properties) : base(id, name, resourceType, systemData)
        {
        ...
        internal SelfHelpDiagnosticResourceProperties Properties { get; set; }
        ...
        public IDictionary<string, string> GlobalParameters
        {
            get
            {
                ...
                {
                    Properties = new SelfHelpDiagnosticResourceProperties();
                }
