...
| --- | --- | --- |
| `/providers/microsoft.help/selfhelp/{}` | `SelfHelpSolutionResult` | `TenantSolutionResourceSelfHelp` |
| `/{}/providers/microsoft.help/diagnostics/{}` | `SelfHelpDiagnostic` | `DiagnosticResource` |
| `/{}/providers/microsoft.help/simplifiedsolutions/{}` | `SelfHelpSimplifiedSolution` | `SimplifiedSolutionsResource` |
| `/{}/providers/microsoft.help/solutions/{}` | `SelfHelpSolution` | `SolutionResource` |
| `/{}/providers/microsoft.help/troubleshooters/{}` | `SelfHelpTroubleshooter` | `TroubleshooterResource` |
