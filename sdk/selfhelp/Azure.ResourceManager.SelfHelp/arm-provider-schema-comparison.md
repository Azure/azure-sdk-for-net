# ARM provider schema comparison: Azure.ResourceManager.SelfHelp
...
| --- | --- | --- |
| `/providers/Microsoft.Help/selfHelp/{solutionId}` | `SelfHelpSolutionResult` | `TenantSolutionResourceSelfHelp` |
| `/{scope}/providers/Microsoft.Help/diagnostics/{diagnosticsResourceName}` | `SelfHelpDiagnostic` | `DiagnosticResource` |
| `/{scope}/providers/Microsoft.Help/simplifiedSolutions/{simplifiedSolutionsResourceName}` | `SelfHelpSimplifiedSolution` | `SimplifiedSolutionsResource` |
| `/{scope}/providers/Microsoft.Help/solutions/{solutionResourceName}` | `SelfHelpSolution` | `SolutionResource` |
| `/{scope}/providers/Microsoft.Help/troubleshooters/{troubleshooterName}` | `SelfHelpTroubleshooter` | `TroubleshooterResource` |
