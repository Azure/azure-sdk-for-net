...
/// <summary> The data model for a Web PubSub shared private link resource. </summary>
[EditorBrowsable(EditorBrowsableState.Never)]
[Obsolete("This class is deprecated and it will be removed in a future version. Please use WebPubSubSharedPrivateLink instead.")]
public partial class WebPubSubSharedPrivateLinkData : ProvisionableConstruct
{
    ...
    public BicepValue<WebPubSubSharedPrivateLinkStatus> Status { get { Initialize(); return _status; } }
    ...
    /// <summary> Creates a new instance of <see cref="WebPubSubSharedPrivateLinkData"/>. </summary>
    ...
    protected override void DefineProvisionableProperties()
    {
        ...
        _status = DefineProperty<WebPubSubSharedPrivateLinkStatus>(nameof(Status), new string[] { "properties", "status" }, isOutput: true);
