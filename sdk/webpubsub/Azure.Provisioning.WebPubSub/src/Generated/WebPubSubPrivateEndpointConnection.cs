...
namespace Azure.Provisioning.WebPubSub
{
    ...
    public partial class WebPubSubPrivateEndpointConnection : ProvisionableResource
    {
        ...
        /// <summary> Creates a new WebPubSubPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public WebPubSubPrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.SignalRService/webPubSub/privateEndpointConnections", resourceVersion ?? "2025-01-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for WebPubSubPrivateEndpointConnection. </summary>
        ...
        /// <summary> Creates a reference to an existing WebPubSubPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static WebPubSubPrivateEndpointConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            WebPubSubPrivateEndpointConnection result = new WebPubSubPrivateEndpointConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for WebPubSubPrivateEndpointConnection that are not part of the generated code. </summary>
