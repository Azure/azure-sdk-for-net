namespace Azure.Messaging.WebPubSub
{
    ...
    public partial class WebPubSubServiceClient
    {
        ...
        public virtual Azure.Response<System.Uri> GenerateClientAccessUri(System.DateTimeOffset expiresAt, string userId = null, params string[] roles) { throw null; }
        ...
        public virtual System.Threading.Tasks.Task<Azure.Response<System.Uri>> GenerateClientAccessUriAsync(System.DateTimeOffset expiresAt, string userId = null, params string[] roles) { throw null; }
        public virtual Azure.Response GenerateClientToken(string userId = null, System.Collections.Generic.IEnumerable<string> role = null, int? minutesToExpire = default(int?), Azure.RequestOptions options = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Response> GenerateClientTokenAsync(string userId = null, System.Collections.Generic.IEnumerable<string> role = null, int? minutesToExpire = default(int?), Azure.RequestOptions options = null) { throw null; }
