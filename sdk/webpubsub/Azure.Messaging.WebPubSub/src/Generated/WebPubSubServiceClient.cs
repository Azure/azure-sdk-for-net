...
#pragma warning restore AZC0002
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateCloseAllConnectionsRequest(excluded, reason, options);
            RequestOptions.Apply(options, message);
...
#pragma warning restore AZC0002
        ...
        /// <summary> Create Request for <see cref="CloseAllConnections"/> and <see cref="CloseAllConnectionsAsync"/> operations. </summary>
        /// <param name="excluded"> Exclude these connectionIds when closing the connections in the hub. </param>
        /// <param name="reason"> The reason closing the client connection. </param>
        /// <param name="options"> The request options. </param>
        private HttpMessage CreateCloseAllConnectionsRequest(IEnumerable<string> excluded = null, string reason = null, RequestOptions options = null)
        {
            var message = Pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
...
#pragma warning restore AZC0002
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateCloseGroupConnectionsRequest(group, excluded, reason, options);
            RequestOptions.Apply(options, message);
...
#pragma warning restore AZC0002
        ...
        /// <summary> Create Request for <see cref="CloseGroupConnections"/> and <see cref="CloseGroupConnectionsAsync"/> operations. </summary>
        /// <param name="group"> Target group name, which length should be greater than 0 and less than 1025. </param>
        /// <param name="excluded"> Exclude these connectionIds when closing the connections in the group. </param>
        /// <param name="reason"> The reason closing the client connection. </param>
        /// <param name="options"> The request options. </param>
        private HttpMessage CreateCloseGroupConnectionsRequest(string group, IEnumerable<string> excluded = null, string reason = null, RequestOptions options = null)
        {
            var message = Pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
...
#pragma warning restore AZC0002
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateCloseUserConnectionsRequest(userId, excluded, reason, options);
            RequestOptions.Apply(options, message);
...
#pragma warning restore AZC0002
        ...
        /// <summary> Create Request for <see cref="CloseUserConnections"/> and <see cref="CloseUserConnectionsAsync"/> operations. </summary>
        /// <param name="userId"> The user Id. </param>
        /// <param name="excluded"> Exclude these connectionIds when closing the connections for the user. </param>
        /// <param name="reason"> The reason closing the client connection. </param>
        /// <param name="options"> The request options. </param>
        private HttpMessage CreateCloseUserConnectionsRequest(string userId, IEnumerable<string> excluded = null, string reason = null, RequestOptions options = null)
        {
            var message = Pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
