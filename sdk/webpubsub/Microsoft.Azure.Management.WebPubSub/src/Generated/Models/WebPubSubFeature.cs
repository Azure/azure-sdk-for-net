...
namespace Microsoft.Azure.Management.WebPubSub.Models
{
    ...
    /// </summary>
    public partial class WebPubSubFeature
    {
        /// <summary>
        /// Initializes a new instance of the WebPubSubFeature class.
        /// </summary>
        public WebPubSubFeature()
        {
            CustomInit();
        }
        ...
        /// trace feature.
        /// . Possible values include: 'EnableConnectivityLogs',
        ...
        /// feature.</param>
        public WebPubSubFeature(string flag, string value, IDictionary<string, string> properties = default(IDictionary<string, string>))
        {
            Flag = flag;
            Value = value;
