...
namespace Azure.Messaging.WebPubSub.Chat.Tests.Samples
{
    public class WebPubSubChatSamples
    {
        ...
        public void CreateUser()
        {
            ...
            ChatUser user = client.CreateOrReplaceUser(
                "user1",
                new HumanChatUser("Alice", ChatRoles.UserNormal)).Value;
            #endregion
        }
        ...
        public void AddRoomMember()
        {
            ...
            ChatRoomMember member = client.CreateOrReplaceRoomMember(
                "room1",
                "user1",
                new ChatRoomMember(ChatRoles.RoomMember)).Value;
            #endregion
        }
        ...
        public void ListRoomMembers()
        {
            ...
            foreach (ChatRoomMember roomMember in client.GetRoomMembers("room1"))
            {
        ...
        public async Task ManageRoomMembersAsync()
        {
            ...
            ChatRoom room = (await client.CreateOrReplaceRoomAsync("room1", new ChatRoom("General"))).Value;

            await foreach (ChatRoomMember roomMember in client.GetRoomMembersAsync("room1"))
            {
                Console.WriteLine($"{roomMember.UserId} -> {roomMember.RoleName}");
            }
            #endregion
        ...
        public void CreateCustomRole()
        {
            ...
            ChatRole created = client.CreateOrReplaceRole("room.contributor", role).Value;
            #endregion
        }
        ...
        public void ListRoles()
        {
            ...
            foreach (ChatRole role in client.GetRoles())
            {
        ...
        public void AssignCustomRole()
        {
            ...
            client.CreateOrReplaceRoomMember(
                "room1",
                "user1",
                new ChatRoomMember("room.contributor"));
            #endregion
        }
