...
namespace Azure.ResourceManager.WebPubSub.Samples
{
    public partial class Sample_WebPubSubHubCollection
    {
        ...
        public async Task GetIfExists_WebPubSubHubsGet()
        {
            ...
            // invoke the operation
            string hubName = "exampleHub";
            NullableResponse<WebPubSubHubResource> response = await collection.GetIfExistsAsync(hubName);
            WebPubSubHubResource result = response.HasValue ? response.Value : null;
