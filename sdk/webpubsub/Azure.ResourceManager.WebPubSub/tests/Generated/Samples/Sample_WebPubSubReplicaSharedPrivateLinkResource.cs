...
{
    public partial class Sample_WebPubSubReplicaSharedPrivateLinkResource
    {
        [Test]
        ...
        public async Task Get_WebPubSubReplicaSharedPrivateLinkResourcesGet()
        {
            ...
            // this example assumes you already have this WebPubSubReplicaSharedPrivateLinkResource created on azure
            // for more information of creating WebPubSubReplicaSharedPrivateLinkResource, please refer to the document of WebPubSubReplicaSharedPrivateLinkResource
            ...
            ResourceIdentifier webPubSubReplicaSharedPrivateLinkResourceId = WebPubSubReplicaSharedPrivateLinkResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, resourceName, replicaName, sharedPrivateLinkResourceName);
            WebPubSubReplicaSharedPrivateLinkResource webPubSubReplicaSharedPrivateLinkResource = client.GetWebPubSubReplicaSharedPrivateLinkResource(webPubSubReplicaSharedPrivateLinkResourceId);

            // invoke the operation
            WebPubSubReplicaSharedPrivateLinkResource result = await webPubSubReplicaSharedPrivateLinkResource.GetAsync();
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Update_WebPubSubReplicaSharedPrivateLinkResourcesCreateOrUpdate()
        {
            ...
            ArmOperation<WebPubSubReplicaSharedPrivateLinkResource> lro = await webPubSubReplicaSharedPrivateLinkResource.UpdateAsync(WaitUntil.Completed, data);
