...
{
    /// <summary> A class representing collection of PrivateEndpointConnection and their operations over a WebPubSubResource. </summary>
    public partial class PrivateEndpointConnectionContainer : ArmContainer
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly WebPubSubPrivateEndpointConnectionsRestOperations _restClient;
        ...
        internal PrivateEndpointConnectionContainer(ArmResource parent) : base(parent)
        {
            ...
            _restClient = new WebPubSubPrivateEndpointConnectionsRestOperations(_clientDiagnostics, Pipeline, ClientOptions, Id.SubscriptionId, BaseUri);
        }
