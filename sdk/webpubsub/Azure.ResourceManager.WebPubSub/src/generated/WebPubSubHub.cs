...
namespace Azure.ResourceManager.WebPubSub
{
    ...
    public partial class WebPubSubHub : ArmResource
    {
        ...
        public async virtual Task<Response<WebPubSubHub>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webPubSubHubsRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<WebPubSubHub> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webPubSubHubsRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<WebPubSubHubDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webPubSubHubsRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new WebPubSubHubDeleteOperation(_clientDiagnostics, Pipeline, _webPubSubHubsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual WebPubSubHubDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webPubSubHubsRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new WebPubSubHubDeleteOperation(_clientDiagnostics, Pipeline, _webPubSubHubsRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
