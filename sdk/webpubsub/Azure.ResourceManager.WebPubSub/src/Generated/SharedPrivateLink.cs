...
namespace Azure.ResourceManager.WebPubSub
{
    ...
    public partial class SharedPrivateLink : ArmResource
    {
        ...
        public async virtual Task<Response<SharedPrivateLink>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _sharedPrivateLinksRestClient.GetAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SharedPrivateLink> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _sharedPrivateLinksRestClient.Get(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<SharedPrivateLinkDeleteOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _sharedPrivateLinksRestClient.DeleteAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new SharedPrivateLinkDeleteOperation(_clientDiagnostics, Pipeline, _sharedPrivateLinksRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual SharedPrivateLinkDeleteOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _sharedPrivateLinksRestClient.Delete(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new SharedPrivateLinkDeleteOperation(_clientDiagnostics, Pipeline, _sharedPrivateLinksRestClient.CreateDeleteRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
