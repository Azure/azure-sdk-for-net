...
namespace Azure.ResourceManager.WebPubSub
{
    ...
    public partial class WebPubSubCustomCertificateData : ResourceData
    {
        ...
        internal WebPubSubCustomCertificateData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CustomCertificateProperties properties) : base(id, name, resourceType, systemData)
        {
