...
namespace Azure.ResourceManager.WebPubSub.Mocking
{
    ...
    internal partial class WebPubSubResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="WebPubSubResourceGroupMockingExtension"/> class for mocking. </summary>
        protected WebPubSubResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="WebPubSubResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal WebPubSubResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
