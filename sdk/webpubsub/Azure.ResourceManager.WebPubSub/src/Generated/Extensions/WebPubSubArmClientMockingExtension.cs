...
namespace Azure.ResourceManager.WebPubSub.Mocking
{
    ...
    internal partial class WebPubSubArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="WebPubSubArmClientMockingExtension"/> class for mocking. </summary>
        protected WebPubSubArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="WebPubSubArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal WebPubSubArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal WebPubSubArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
