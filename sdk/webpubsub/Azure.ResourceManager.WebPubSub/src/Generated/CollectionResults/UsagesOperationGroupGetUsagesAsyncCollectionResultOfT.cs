...
namespace Azure.ResourceManager.WebPubSub
{
    internal partial class UsagesOperationGroupGetUsagesAsyncCollectionResultOfT : AsyncPageable<SignalRServiceUsage>
    {
        ...
        public UsagesOperationGroupGetUsagesAsyncCollectionResultOfT(UsagesOperationGroup client, Guid subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
