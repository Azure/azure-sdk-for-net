...
{
    internal partial class UsagesOperationGroupGetUsagesAsyncCollectionResultOfT : AsyncPageable<SignalRServiceUsage>
    {
        ...
        public UsagesOperationGroupGetUsagesAsyncCollectionResultOfT(UsagesOperationGroup client, Guid subscriptionId, string location, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableWebPubSubSubscriptionResource.GetUsages");
            scope.Start();
            try
            {
