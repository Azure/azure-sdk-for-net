...
{
    internal partial class PrivateEndpointConnectionsGetAllAsyncCollectionResultOfT : AsyncPageable<WebPubSubPrivateEndpointConnectionData>
    {
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("WebPubSubPrivateEndpointConnectionCollection.GetAll");
            scope.Start();
            try
            {
