...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class WebPubSubKeys
    {
        ...
        internal WebPubSubKeys(string primaryKey, string secondaryKey, string primaryConnectionString, string secondaryConnectionString, Dictionary<string, BinaryData> rawData)
        {
