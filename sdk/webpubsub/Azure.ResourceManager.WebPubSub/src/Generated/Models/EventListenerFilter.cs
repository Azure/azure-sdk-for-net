...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    /// </summary>
    public abstract partial class EventListenerFilter
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="EventListenerFilter"/>. </summary>
        ...
        internal EventListenerFilter(EventListenerFilterDiscriminator eventListenerFilterType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EventListenerFilterType = eventListenerFilterType;
            _serializedAdditionalRawData = serializedAdditionalRawData;
        }

        /// <summary> Gets or sets the event listener filter type. </summary>
        internal EventListenerFilterDiscriminator EventListenerFilterType { get; set; }
    }
}
