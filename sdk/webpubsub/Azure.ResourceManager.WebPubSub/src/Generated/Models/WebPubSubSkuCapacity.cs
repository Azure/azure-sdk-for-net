...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class WebPubSubSkuCapacity
    {
        ...
        internal WebPubSubSkuCapacity(int? minimum, int? maximum, int? @default, IReadOnlyList<int> allowedValues, WebPubSubScaleType? scaleType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
