...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class WebPubSubSkuCapacity
    {
        ...
        internal WebPubSubSkuCapacity(int? minimum, int? maximum, int? @default, IReadOnlyList<int> allowedValues, WebPubSubScaleType? scaleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
