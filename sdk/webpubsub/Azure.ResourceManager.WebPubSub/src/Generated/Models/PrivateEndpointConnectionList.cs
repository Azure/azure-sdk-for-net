...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    internal partial class PrivateEndpointConnectionList
    {
        ...
        internal PrivateEndpointConnectionList(IEnumerable<WebPubSubPrivateEndpointConnectionData> value)
        {
            Value = value.ToList();
        }
        ...
        internal PrivateEndpointConnectionList(IList<WebPubSubPrivateEndpointConnectionData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<WebPubSubPrivateEndpointConnectionData> Value { get; }
