...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebPubSubRegenerateKeyContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebPubSubRegenerateKeyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebPubSubRegenerateKeyContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebPubSubRegenerateKeyContent>)} interface");
            }
        ...
        string IPersistableModel<WebPubSubRegenerateKeyContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
