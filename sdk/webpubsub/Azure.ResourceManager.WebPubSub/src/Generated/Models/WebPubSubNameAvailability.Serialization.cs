...
{
    public partial class WebPubSubNameAvailability : IUtf8JsonSerializable, IJsonModel<WebPubSubNameAvailability>, IPersistableModel<WebPubSubNameAvailability>
    {
        ...
        void IJsonModel<WebPubSubNameAvailability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WebPubSubNameAvailability)} does not support '{format}' format.");
            }
