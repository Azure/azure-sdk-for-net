...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebPubSubNameAvailability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebPubSubNameAvailability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebPubSubNameAvailability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebPubSubNameAvailability>)} interface");
            }
        ...
        string IPersistableModel<WebPubSubNameAvailability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
