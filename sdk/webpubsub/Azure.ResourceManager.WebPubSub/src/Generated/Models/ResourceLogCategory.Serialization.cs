...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceLogCategory>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceLogCategory>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceLogCategory>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceLogCategory>)} interface");
            }
        ...
        string IPersistableModel<ResourceLogCategory>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
