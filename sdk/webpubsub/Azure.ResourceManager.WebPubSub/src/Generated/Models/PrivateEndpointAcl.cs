...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class PrivateEndpointAcl : PublicNetworkAcls
    {
        ...
        internal PrivateEndpointAcl(IList<WebPubSubRequestType> allow, IList<WebPubSubRequestType> deny, string name, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(allow, deny, serializedAdditionalRawData)
        {
            Name = name;
        }
