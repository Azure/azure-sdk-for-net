...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class PrivateEndpointAcl : PublicNetworkAcls
    {
        ...
        /// <param name="name"> Name of the private endpoint connection. </param>
        internal PrivateEndpointAcl(IList<WebPubSubRequestType> allow, IList<WebPubSubRequestType> deny, IDictionary<string, BinaryData> additionalBinaryDataProperties, string name) : base(allow, deny, additionalBinaryDataProperties)
        {
            Name = name;
        }
