...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class PrivateEndpointAcl : PublicNetworkAcls
    {
        ...
        internal PrivateEndpointAcl(IList<WebPubSubRequestType> allow, IList<WebPubSubRequestType> deny, string name, Dictionary<string, BinaryData> rawData) : base(allow, deny, rawData)
        {
            Name = name;
        }
