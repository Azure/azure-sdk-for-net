...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class ThrottleByJwtCustomClaimRule : ClientConnectionCountRule
    {
        ...
        public ThrottleByJwtCustomClaimRule(string claimName)
        {
            ...
            ClaimName = claimName;
            ThrottleType = ClientConnectionCountRuleDiscriminator.ThrottleByJwtCustomClaimRule;
        }
        ...
        internal ThrottleByJwtCustomClaimRule(ClientConnectionCountRuleDiscriminator throttleType, IDictionary<string, BinaryData> serializedAdditionalRawData, string claimName, int? maxCount) : base(throttleType, serializedAdditionalRawData)
        {
            ClaimName = claimName;
            MaxCount = maxCount;
