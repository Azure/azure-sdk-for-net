...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class EventHubEndpoint : EventListenerEndpoint
    {
        ...
        public EventHubEndpoint(string fullyQualifiedNamespace, string eventHubName) : base(EventListenerEndpointDiscriminator.EventHub)
        {
        ...
        /// <param name="fullyQualifiedNamespace"> The fully qualified namespace name of the Event Hub resource. </param>
        /// <param name="eventHubName"> The name of the Event Hub. </param>
        internal EventHubEndpoint(EventListenerEndpointDiscriminator @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string fullyQualifiedNamespace, string eventHubName) : base(@type, additionalBinaryDataProperties)
        {
            FullyQualifiedNamespace = fullyQualifiedNamespace;
            EventHubName = eventHubName;
        }
