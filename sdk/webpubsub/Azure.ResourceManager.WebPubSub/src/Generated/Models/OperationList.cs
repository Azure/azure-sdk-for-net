...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    internal partial class OperationList
    {
        ...
        internal OperationList(IEnumerable<WebPubSubOperationDetail> value)
        {
            Value = value.ToList();
        }
        ...
        internal OperationList(IList<WebPubSubOperationDetail> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        [WirePath("value")]
        public IList<WebPubSubOperationDetail> Value { get; }
