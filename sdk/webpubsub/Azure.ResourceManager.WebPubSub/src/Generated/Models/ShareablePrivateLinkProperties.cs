...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class ShareablePrivateLinkProperties
    {
        ...
        internal ShareablePrivateLinkProperties(string description, string groupId, string shareablePrivateLinkPropertiesType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
