...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class WebPubSubEventHandler
    {
        ...
        internal WebPubSubEventHandler(string urlTemplate, string userEventPattern, IList<string> systemEvents, UpstreamAuthSettings auth, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UrlTemplate = urlTemplate;
