...
{
    public partial class WebPubSubEventHandler : IUtf8JsonSerializable, IJsonModel<WebPubSubEventHandler>, IPersistableModel<WebPubSubEventHandler>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  auth:");
                AppendChildObject(builder, Auth, options, 2);
            }
