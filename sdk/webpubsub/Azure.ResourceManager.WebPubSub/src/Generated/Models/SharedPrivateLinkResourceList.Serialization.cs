...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        internal static SharedPrivateLinkResourceList DeserializeSharedPrivateLinkResourceList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
