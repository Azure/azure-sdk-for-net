...
{
    public partial class WebPubSubNetworkAcls : IUtf8JsonSerializable, IJsonModel<WebPubSubNetworkAcls>, IPersistableModel<WebPubSubNetworkAcls>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PublicNetwork))
            {
                ...
                AppendChildObject(builder, PublicNetwork, options, 2);
            }
