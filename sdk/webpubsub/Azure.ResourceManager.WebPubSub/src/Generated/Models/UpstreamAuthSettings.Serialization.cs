...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpstreamAuthSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpstreamAuthSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpstreamAuthSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<UpstreamAuthSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
