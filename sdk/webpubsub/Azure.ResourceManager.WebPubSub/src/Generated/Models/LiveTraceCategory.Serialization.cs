...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LiveTraceCategory>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LiveTraceCategory>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LiveTraceCategory>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LiveTraceCategory>)} interface");
            }
        ...
        string IPersistableModel<LiveTraceCategory>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
