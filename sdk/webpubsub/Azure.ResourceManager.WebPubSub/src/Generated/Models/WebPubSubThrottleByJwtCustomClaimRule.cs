...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="WebPubSubThrottleByJwtCustomClaimRule"/>. </summary>
        ...
        public WebPubSubThrottleByJwtCustomClaimRule(string claimName) : base(ClientConnectionCountRuleDiscriminator.ThrottleByJwtCustomClaimRule)
        {
        ...
        internal WebPubSubThrottleByJwtCustomClaimRule(ClientConnectionCountRuleDiscriminator @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string claimName, int? maxCount) : base(@type, additionalBinaryDataProperties)
        {
            ClaimName = claimName;
            MaxCount = maxCount;
        }
