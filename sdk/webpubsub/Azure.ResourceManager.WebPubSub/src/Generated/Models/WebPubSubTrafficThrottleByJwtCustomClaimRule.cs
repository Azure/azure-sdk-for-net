...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="WebPubSubTrafficThrottleByJwtCustomClaimRule"/>. </summary>
        ...
        public WebPubSubTrafficThrottleByJwtCustomClaimRule(string claimName) : base(ClientTrafficControlRuleDiscriminator.TrafficThrottleByJwtCustomClaimRule)
        {
        ...
        internal WebPubSubTrafficThrottleByJwtCustomClaimRule(ClientTrafficControlRuleDiscriminator @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string claimName, long? maxInboundMessageBytes, int? aggregationWindowInSeconds) : base(@type, additionalBinaryDataProperties)
        {
            ClaimName = claimName;
