...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class EventNameFilter : EventListenerFilter
    {
        ...
        public EventNameFilter() : base(EventListenerFilterDiscriminator.EventName)
        {
        ...
        /// </param>
        internal EventNameFilter(EventListenerFilterDiscriminator @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, IList<string> systemEvents, string userEventPattern) : base(@type, additionalBinaryDataProperties)
        {
