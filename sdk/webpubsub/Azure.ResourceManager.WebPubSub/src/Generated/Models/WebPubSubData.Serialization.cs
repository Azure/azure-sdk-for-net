...
{
    public partial class WebPubSubData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebPubSubData DeserializeWebPubSubData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
