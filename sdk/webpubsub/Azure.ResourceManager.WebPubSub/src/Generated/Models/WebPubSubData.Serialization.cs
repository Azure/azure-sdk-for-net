...
{
    public partial class WebPubSubData : IUtf8JsonSerializable, IJsonModel<WebPubSubData>, IPersistableModel<WebPubSubData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PublicPort))
            {
                ...
                builder.AppendLine($" '{PublicPort.Value.ToString()}'");
            }
            ...
            {
                builder.Append("  tls:");
                AppendChildObject(builder, Tls, options, 2);
            }
            ...
            if (Optional.IsDefined(LiveTraceConfiguration))
            {
                ...
                AppendChildObject(builder, LiveTraceConfiguration, options, 2);
            }

            if (Optional.IsDefined(ResourceLogConfiguration))
            {
                builder.Append("  resourceLogConfiguration:");
                AppendChildObject(builder, ResourceLogConfiguration, options, 2);
            }
