...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebPubSubPrivateLink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebPubSubPrivateLink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebPubSubPrivateLink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebPubSubPrivateLink>)} interface");
            }
        ...
        WebPubSubPrivateLink IJsonModel<WebPubSubPrivateLink>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(WebPubSubPrivateLink)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<WebPubSubPrivateLink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
