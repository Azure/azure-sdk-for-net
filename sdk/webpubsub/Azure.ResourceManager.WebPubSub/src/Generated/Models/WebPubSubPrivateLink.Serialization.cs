...
{
    public partial class WebPubSubPrivateLink : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsCollectionDefined(ShareablePrivateLinkTypes))
            {
        ...
        internal static WebPubSubPrivateLink DeserializeWebPubSubPrivateLink(JsonElement element)
        {
            ...
            Core.Optional<IList<ShareablePrivateLinkType>> shareablePrivateLinkResourceTypes = default;
            ...
            return new WebPubSubPrivateLink(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames), Core.Optional.ToList(shareablePrivateLinkResourceTypes));
        }
    }
}
