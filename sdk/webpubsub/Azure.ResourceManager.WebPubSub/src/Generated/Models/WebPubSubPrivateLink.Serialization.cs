...
{
    public partial class WebPubSubPrivateLink : IUtf8JsonSerializable, IJsonModel<WebPubSubPrivateLink>, IPersistableModel<WebPubSubPrivateLink>
    {
        ...
        void IJsonModel<WebPubSubPrivateLink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WebPubSubPrivateLink)} does not support '{format}' format.");
            }
