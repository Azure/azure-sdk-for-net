...
namespace Azure.ResourceManager.WebPubSub.Models
{
    public partial class WebPubSubPrivateLink : IUtf8JsonSerializable, IJsonModel<WebPubSubPrivateLink>
    {
        ...
        void IJsonModel<WebPubSubPrivateLink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(WebPubSubPrivateLink)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<WebPubSubPrivateLink>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(WebPubSubPrivateLink)} does not support '{options.Format}' format.");
            }
        }
