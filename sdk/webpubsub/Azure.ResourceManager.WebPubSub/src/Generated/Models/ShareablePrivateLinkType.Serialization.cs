...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShareablePrivateLinkType>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ShareablePrivateLinkType>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ShareablePrivateLinkType>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ShareablePrivateLinkType>)} interface");
            }
        ...
        string IPersistableModel<ShareablePrivateLinkType>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
