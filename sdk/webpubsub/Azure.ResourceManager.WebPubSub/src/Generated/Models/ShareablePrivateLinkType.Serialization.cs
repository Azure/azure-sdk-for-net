...
{
    public partial class ShareablePrivateLinkType : IUtf8JsonSerializable, IJsonModel<ShareablePrivateLinkType>, IPersistableModel<ShareablePrivateLinkType>
    {
        ...
        void IJsonModel<ShareablePrivateLinkType>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ShareablePrivateLinkType)} does not support '{format}' format.");
            }
