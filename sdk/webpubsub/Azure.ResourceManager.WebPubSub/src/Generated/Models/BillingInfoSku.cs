...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class BillingInfoSku
    {
        ...
        internal BillingInfoSku(string name, WebPubSubSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Tier = tier;
            Size = size;
