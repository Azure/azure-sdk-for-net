...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="WebPubSubTrafficThrottleByJwtSignatureRule"/>. </summary>
        public WebPubSubTrafficThrottleByJwtSignatureRule() : base(ClientTrafficControlRuleDiscriminator.TrafficThrottleByJwtSignatureRule)
        {
        }
        ...
        internal WebPubSubTrafficThrottleByJwtSignatureRule(ClientTrafficControlRuleDiscriminator @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, long? maxInboundMessageBytes, int? aggregationWindowInSeconds) : base(@type, additionalBinaryDataProperties)
        {
