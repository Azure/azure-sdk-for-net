...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class WebPubSubPrivateLinkServiceConnectionState
    {
        ...
        internal WebPubSubPrivateLinkServiceConnectionState(WebPubSubPrivateLinkServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
