...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class WebPubSubPrivateLinkServiceConnectionState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="WebPubSubPrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal WebPubSubPrivateLinkServiceConnectionState(WebPubSubPrivateLinkServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
