...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SignalRServiceUsage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SignalRServiceUsage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SignalRServiceUsage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SignalRServiceUsage>)} interface");
            }
        ...
        string IPersistableModel<SignalRServiceUsage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
