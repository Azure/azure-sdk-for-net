...
namespace Azure.ResourceManager.WebPubSub.Models
{
    ...
    public partial class WebPubSubPrivateLink : ResourceData
    {
        ...
        internal WebPubSubPrivateLink(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string groupId, IList<string> requiredMembers, IList<string> requiredZoneNames, IList<ShareablePrivateLinkType> shareablePrivateLinkTypes, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            GroupId = groupId;
