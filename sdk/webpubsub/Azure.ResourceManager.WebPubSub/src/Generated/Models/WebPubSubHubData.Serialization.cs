...
namespace Azure.ResourceManager.WebPubSub
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebPubSubHubData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebPubSubHubData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebPubSubHubData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebPubSubHubData>)} interface");
            }
        ...
        string IPersistableModel<WebPubSubHubData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
