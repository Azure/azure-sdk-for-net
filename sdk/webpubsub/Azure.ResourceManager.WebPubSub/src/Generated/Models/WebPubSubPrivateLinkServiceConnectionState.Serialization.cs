...
{
    public partial class WebPubSubPrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static WebPubSubPrivateLinkServiceConnectionState DeserializeWebPubSubPrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            Core.Optional<WebPubSubPrivateLinkServiceConnectionStatus> status = default;
            ...
            return new WebPubSubPrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
