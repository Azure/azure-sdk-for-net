...
{
    public partial class WebPubSubPrivateLinkServiceConnectionState : IUtf8JsonSerializable
    {
        ...
        internal static WebPubSubPrivateLinkServiceConnectionState DeserializeWebPubSubPrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            return new WebPubSubPrivateLinkServiceConnectionState(Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
