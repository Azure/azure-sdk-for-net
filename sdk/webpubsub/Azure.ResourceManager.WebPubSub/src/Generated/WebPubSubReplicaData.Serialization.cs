...
{
    public partial class WebPubSubReplicaData : IUtf8JsonSerializable, IJsonModel<WebPubSubReplicaData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebPubSubReplicaData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<WebPubSubReplicaData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        WebPubSubReplicaData IJsonModel<WebPubSubReplicaData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WebPubSubReplicaData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static WebPubSubReplicaData DeserializeWebPubSubReplicaData(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<WebPubSubReplicaData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WebPubSubReplicaData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        WebPubSubReplicaData IPersistableModel<WebPubSubReplicaData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<WebPubSubReplicaData>)this).GetFormatFromOptions(options) : options.Format;
