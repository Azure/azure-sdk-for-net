...
namespace Azure.ResourceManager.WebPubSub
{
    ...
    public partial class WebPubSubSharedPrivateLinkData : ResourceData
    {
        ...
        internal WebPubSubSharedPrivateLinkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SharedPrivateLinkResourceProperties properties) : base(id, name, resourceType, systemData)
        {
        ...
        public WebPubSubSharedPrivateLinkStatus? Status
        {
            get
            {
