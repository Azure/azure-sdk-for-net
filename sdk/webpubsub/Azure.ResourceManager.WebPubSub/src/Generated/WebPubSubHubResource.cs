...
namespace Azure.ResourceManager.WebPubSub
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="WebPubSubHubResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="WebPubSubResource"/> using the GetWebPubSubHubs method.
    /// </summary>
    public partial class WebPubSubHubResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of WebPubSubHubResource for mocking. </summary>
        protected WebPubSubHubResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="WebPubSubHubResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/webPubSub/{resourceName}/hubs/{hubName}";
        ...
        {
            using DiagnosticScope scope = _webPubSubHubsClientDiagnostics.CreateScope("WebPubSubHubResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _webPubSubHubsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        {
            using DiagnosticScope scope = _webPubSubHubsClientDiagnostics.CreateScope("WebPubSubHubResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _webPubSubHubsRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                WebPubSubArmOperation operation = new WebPubSubArmOperation(_webPubSubHubsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<ArmOperation<WebPubSubHubResource>> UpdateAsync(WaitUntil waitUntil, WebPubSubHubData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _webPubSubHubsClientDiagnostics.CreateScope("WebPubSubHubResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
