...
namespace Azure.ResourceManager.WebPubSub
{
    ...
    public partial class WebPubSubHubResource : ArmResource
    {
        ...
        internal WebPubSubHubResource(ArmClient client, WebPubSubHubData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WebPubSubHubResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WebPubSubHubResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
