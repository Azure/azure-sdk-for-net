...
namespace Azure.ResourceManager.WebPubSub
{
    ...
    public partial class WebPubSubHub : ArmResource
    {
        ...
        internal WebPubSubHub(ArmClient armClient, WebPubSubHubData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal WebPubSubHub(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string webPubSubHubApiVersion);
