...
namespace Azure.ResourceManager.WebPubSub
{
    ...
    public partial class WebPubSubHub : ArmResource
    {
        ...
        public async virtual Task<Response<WebPubSubHub>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webPubSubHubsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<WebPubSubHub> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webPubSubHubsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("WebPubSubHub.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<WebPubSubHubDeleteOperation> DeleteAsync(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _webPubSubHubsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new WebPubSubHubDeleteOperation(_clientDiagnostics, Pipeline, _webPubSubHubsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual WebPubSubHubDeleteOperation Delete(bool waitForCompletion, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _webPubSubHubsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new WebPubSubHubDeleteOperation(_clientDiagnostics, Pipeline, _webPubSubHubsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
