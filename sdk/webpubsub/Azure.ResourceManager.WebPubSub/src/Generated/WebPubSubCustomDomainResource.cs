...
namespace Azure.ResourceManager.WebPubSub
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="WebPubSubCustomDomainResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="WebPubSubResource"/> using the GetWebPubSubCustomDomains method.
    /// </summary>
    public partial class WebPubSubCustomDomainResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of WebPubSubCustomDomainResource for mocking. </summary>
        protected WebPubSubCustomDomainResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="WebPubSubCustomDomainResource"/> class. </summary>
        ...
        internal WebPubSubCustomDomainResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _customDomainsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.WebPubSub", ResourceType.Namespace, Diagnostics);
        ...
        {
            using DiagnosticScope scope = _customDomainsClientDiagnostics.CreateScope("WebPubSubCustomDomainResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _customDomainsClientDiagnostics.CreateScope("WebPubSubCustomDomainResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                WebPubSubArmOperation operation = new WebPubSubArmOperation(_customDomainsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        /// <summary>
        /// Update a WebPubSubCustomDomain.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SignalRService/webPubSub/{resourceName}/customDomains/{name}. </description>
        ...
        public virtual async Task<ArmOperation<WebPubSubCustomDomainResource>> UpdateAsync(WaitUntil waitUntil, WebPubSubCustomDomainData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _customDomainsClientDiagnostics.CreateScope("WebPubSubCustomDomainResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
