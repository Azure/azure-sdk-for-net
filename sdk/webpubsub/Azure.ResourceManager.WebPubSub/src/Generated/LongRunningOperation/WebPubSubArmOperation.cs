...
namespace Azure.ResourceManager.WebPubSub
{
    internal partial class WebPubSubArmOperation : ArmOperation
    {
        ...
        internal WebPubSubArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
