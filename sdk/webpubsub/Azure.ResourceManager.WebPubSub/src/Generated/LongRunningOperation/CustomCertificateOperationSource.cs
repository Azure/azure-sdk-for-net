...
{
    /// <summary></summary>
    internal partial class CustomCertificateOperationSource : IOperationSource<CustomCertificateResource>
    {
        ...
        CustomCertificateResource IOperationSource<CustomCertificateResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CustomCertificateData data = CustomCertificateData.DeserializeCustomCertificateData(document.RootElement, ModelSerializationExtensions.WireOptions);
