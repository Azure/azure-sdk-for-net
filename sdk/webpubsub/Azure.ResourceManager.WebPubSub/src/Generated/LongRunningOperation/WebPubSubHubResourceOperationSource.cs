...
{
    /// <summary></summary>
    internal partial class WebPubSubHubResourceOperationSource : IOperationSource<WebPubSubHubResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal WebPubSubHubResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
