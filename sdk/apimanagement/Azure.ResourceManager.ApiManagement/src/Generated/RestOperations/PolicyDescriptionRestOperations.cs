...
{
    internal partial class PolicyDescriptionRestOperations
    {
        ...
        /// <summary> Initializes a new instance of PolicyDescriptionRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public PolicyDescriptionRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal HttpMessage CreateListByServiceRequest(string subscriptionId, string resourceGroupName, string serviceName, PolicyScopeContract? scope)
        {
            ...
            uri.AppendPath("/policyDescriptions", false);
            if (scope != null)
            {
                uri.AppendQuery("scope", scope.Value.ToSerialString(), true);
            }
        ...
        public async Task<Response<PolicyDescriptionListResult>> ListByServiceAsync(string subscriptionId, string resourceGroupName, string serviceName, PolicyScopeContract? scope = null, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateListByServiceRequest(subscriptionId, resourceGroupName, serviceName, scope);
