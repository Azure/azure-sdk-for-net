...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class NetworkStatusRestOperations
    {
        ...
        internal RequestUriBuilder CreateListByLocationRequestUri(string subscriptionId, string resourceGroupName, string serviceName, AzureLocation locationName)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
