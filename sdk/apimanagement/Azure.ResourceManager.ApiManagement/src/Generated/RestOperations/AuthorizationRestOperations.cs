...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class AuthorizationRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string serviceName, string authorizationProviderId, string authorizationId, AuthorizationContractData data, ETag? ifMatch)
        {
            ...
            ((IJsonModel<AuthorizationContractData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateConfirmConsentCodeRequest(string subscriptionId, string resourceGroupName, string serviceName, string authorizationProviderId, string authorizationId, AuthorizationConfirmConsentCodeContent content)
        {
            ...
            ((IJsonModel<AuthorizationConfirmConsentCodeContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
