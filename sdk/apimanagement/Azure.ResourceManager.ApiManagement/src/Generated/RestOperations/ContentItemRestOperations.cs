...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ContentItemRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string serviceName, string contentTypeId, string contentItemId, ApiManagementContentItem apiManagementContentItem, ETag? ifMatch)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
