...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class PortalRevisionContractData : ResourceData
    {
        ...
        internal PortalRevisionContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, string statusDetails, PortalRevisionStatus? status, bool? isCurrent, DateTimeOffset? createdOn, DateTimeOffset? updatedOn) : base(id, name, resourceType, systemData)
        {
