...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiPolicyCollection : ArmCollection, IEnumerable<ApiPolicyResource>, IAsyncEnumerable<ApiPolicyResource>
    {
        ...
        public virtual async Task<ArmOperation<ApiPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, PolicyIdName policyId, PolicyContractData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ApiPolicyResource> CreateOrUpdate(WaitUntil waitUntil, PolicyIdName policyId, PolicyContractData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ApiPolicyResource>> GetAsync(PolicyIdName policyId, PolicyExportFormat? format = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="format"> Policy Export Format. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ApiPolicyResource> Get(PolicyIdName policyId, PolicyExportFormat? format = null, CancellationToken cancellationToken = default)
        {
            using var scope = _apiPolicyClientDiagnostics.CreateScope("ApiPolicyCollection.Get");
            scope.Start();
            try
