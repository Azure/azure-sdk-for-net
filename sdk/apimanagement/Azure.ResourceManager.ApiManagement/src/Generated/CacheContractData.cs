...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class CacheContractData : Resource
    {
        ...
        internal CacheContractData(ResourceIdentifier id, string name, ResourceType type, string description, string connectionString, string useFromLocation, string resourceId) : base(id, name, type)
        {
