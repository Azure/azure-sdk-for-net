...
{
    /// <summary> A class representing the LoggerContract data model. </summary>
    public partial class LoggerContractData : ResourceData
    {
        /// <summary> Initializes a new instance of LoggerContractData. </summary>
        ...
        internal LoggerContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, LoggerType? loggerType, string description, IDictionary<string, string> credentials, bool? isBuffered, string resourceId) : base(id, name, resourceType, systemData)
        {
