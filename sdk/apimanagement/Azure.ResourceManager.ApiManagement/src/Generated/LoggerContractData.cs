...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class LoggerContractData : Resource
    {
        ...
        internal LoggerContractData(ResourceIdentifier id, string name, ResourceType type, LoggerType? loggerType, string description, IDictionary<string, string> credentials, bool? isBuffered, string resourceId) : base(id, name, type)
        {
