...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ResolverContractData : ResourceData
    {
        ...
        internal ResolverContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResolverEntityBaseContract properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
