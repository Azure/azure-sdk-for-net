...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class AuthorizationAccessPolicyContractResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AuthorizationAccessPolicyContractResource>> UpdateAsync(WaitUntil waitUntil, AuthorizationAccessPolicyContractData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<AuthorizationAccessPolicyContractResource> Update(WaitUntil waitUntil, AuthorizationAccessPolicyContractData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
