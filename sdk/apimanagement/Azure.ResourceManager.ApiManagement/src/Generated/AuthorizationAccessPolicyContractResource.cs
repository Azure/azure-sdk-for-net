    ...
    public partial class AuthorizationAccessPolicyContractResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AuthorizationAccessPolicyContractResource>> UpdateAsync(WaitUntil waitUntil, AuthorizationAccessPolicyContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ApiManagementArmOperation<AuthorizationAccessPolicyContractResource>(Response.FromValue(new AuthorizationAccessPolicyContractResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
