...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class IdentityProviderContractData : Resource
    {
        ...
        internal IdentityProviderContractData(ResourceIdentifier id, string name, ResourceType type, IdentityProviderType? typePropertiesType, string signinTenant, IList<string> allowedTenants, string authority, string signupPolicyName, string signinPolicyName, string profileEditingPolicyName, string passwordResetPolicyName, string clientId, string clientSecret) : base(id, name, type)
        {
