...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementNotificationResource : ArmResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<ApiManagementNotificationResource>> UpdateAsync(WaitUntil waitUntil, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="ifMatch"> ETag of the Entity. Not required when creating an entity, but required when updating an entity. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<ApiManagementNotificationResource> Update(WaitUntil waitUntil, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _apiManagementNotificationNotificationClientDiagnostics.CreateScope("ApiManagementNotificationResource.Update");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<RecipientUserContract> GetNotificationRecipientUsersAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _notificationRecipientUserClientDiagnostics.CreateScope("ApiManagementNotificationResource.GetNotificationRecipientUsers");
                scope.Start();
                try
                {
        ...
        public virtual AsyncPageable<RecipientEmailContract> GetNotificationRecipientEmailsAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _notificationRecipientEmailClientDiagnostics.CreateScope("ApiManagementNotificationResource.GetNotificationRecipientEmails");
                scope.Start();
                try
                {
