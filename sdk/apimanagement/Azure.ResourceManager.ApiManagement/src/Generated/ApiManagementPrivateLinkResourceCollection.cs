...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementPrivateLinkResourceCollection : ArmCollection, IEnumerable<ApiManagementPrivateLinkResource>, IAsyncEnumerable<ApiManagementPrivateLinkResource>
    {
        ...
        internal ApiManagementPrivateLinkResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateEndpointConnectionRestClient = new PrivateEndpointConnection(_privateEndpointConnectionClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementPrivateLinkResourceApiVersion ?? "2025-09-01-preview");
        ...
        public virtual AsyncPageable<ApiManagementPrivateLinkResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ApiManagementPrivateLinkResourceData, ApiManagementPrivateLinkResource>(new PrivateEndpointConnectionGetPrivateLinkResourcesAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "ApiManagementPrivateLinkResourceCollection.GetAll"), data => new ApiManagementPrivateLinkResource(Client, data));
        }
