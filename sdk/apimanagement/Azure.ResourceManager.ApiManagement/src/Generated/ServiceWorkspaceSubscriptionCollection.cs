...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspaceSubscriptionCollection : ArmCollection, IEnumerable<ServiceWorkspaceSubscriptionResource>, IAsyncEnumerable<ServiceWorkspaceSubscriptionResource>
    {
        ...
        public virtual async Task<ArmOperation<ServiceWorkspaceSubscriptionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sid, ApiManagementSubscriptionCreateOrUpdateContent content, bool? notify = null, string ifMatch = null, AppType? appType = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="sid"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="sid"/> or <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<ServiceWorkspaceSubscriptionResource> CreateOrUpdate(WaitUntil waitUntil, string sid, ApiManagementSubscriptionCreateOrUpdateContent content, bool? notify = null, string ifMatch = null, AppType? appType = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(sid, nameof(sid));
            Argument.AssertNotNull(content, nameof(content));
