...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class DiagnosticContractData : Resource
    {
        ...
        internal DiagnosticContractData(ResourceIdentifier id, string name, ResourceType type, AlwaysLog? alwaysLog, string loggerId, SamplingSettings sampling, PipelineDiagnosticSettings frontend, PipelineDiagnosticSettings backend, bool? logClientIp, HttpCorrelationProtocol? httpCorrelationProtocol, Verbosity? verbosity, OperationNameFormat? operationNameFormat) : base(id, name, type)
        {
            AlwaysLog = alwaysLog;
            LoggerId = loggerId;
            Sampling = sampling;
