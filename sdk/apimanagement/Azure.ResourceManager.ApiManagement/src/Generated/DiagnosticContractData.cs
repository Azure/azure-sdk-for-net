...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class DiagnosticContractData : ResourceData
    {
        ...
        internal DiagnosticContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DiagnosticContractProperties properties) : base(id, name, resourceType, systemData)
        {
