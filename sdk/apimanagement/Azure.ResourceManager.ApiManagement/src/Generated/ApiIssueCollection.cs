...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiIssueCollection : ArmCollection, IEnumerable<ApiIssueResource>, IAsyncEnumerable<ApiIssueResource>
    {
        ...
        internal ApiIssueCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _apiIssueRestClient = new ApiIssue(_apiIssueClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiIssueApiVersion ?? "2025-09-01-preview");
        ...
        public virtual AsyncPageable<ApiIssueResource> GetAllAsync(string filter = default, bool? expandCommentsAttachments = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<IssueContractData, ApiIssueResource>(new ApiIssueGetByServiceAsyncCollectionResultOfT(
                ...
                skip,
                context,
                "ApiIssueCollection.GetAll"), data => new ApiIssueResource(Client, data));
        }
