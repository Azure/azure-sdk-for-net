    ...
    public partial class ApiIssueCollection : ArmCollection, IEnumerable<ApiIssueResource>, IAsyncEnumerable<ApiIssueResource>
    {
        ...
        public virtual AsyncPageable<ApiIssueResource> GetAllAsync(ApiIssueCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<ApiIssueResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _apiIssueRestClient.ListByServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.ExpandCommentsAttachments, options.Top, options.Skip, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<ApiIssueResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _apiIssueRestClient.ListByServiceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.ExpandCommentsAttachments, options.Top, options.Skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiIssueResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<ApiIssueResource> GetAll(ApiIssueCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            Page<ApiIssueResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiIssueRestClient.ListByService(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.ExpandCommentsAttachments, options.Top, options.Skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiIssueResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<ApiIssueResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiIssueRestClient.ListByServiceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.ExpandCommentsAttachments, options.Top, options.Skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiIssueResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
