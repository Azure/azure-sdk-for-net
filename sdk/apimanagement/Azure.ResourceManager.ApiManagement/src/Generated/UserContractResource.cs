...
{
    /// <summary>
    /// A Class representing an UserContract along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct an <see cref="UserContractResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetUserContractResource method.
    /// Otherwise you can get one from its parent resource <see cref="ApiManagementServiceResource" /> using the GetUserContract method.
    /// </summary>
    public partial class UserContractResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="UserContractResource"/> instance. </summary>
        ...
        private readonly ClientDiagnostics _userContractUserClientDiagnostics;
        private readonly UserRestOperations _userContractUserRestClient;
        ...
        /// <summary> Initializes a new instance of the <see cref="UserContractResource"/> class for mocking. </summary>
        protected UserContractResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "UserContractResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal UserContractResource(ArmClient client, UserContractData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal UserContractResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _userContractUserClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string userContractUserApiVersion);
            _userContractUserRestClient = new UserRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, userContractUserApiVersion);
        ...
        /// <summary> Gets a collection of ServiceUserSubscriptionResources in the UserContract. </summary>
        /// <returns> An object representing collection of ServiceUserSubscriptionResources and their operations over a ServiceUserSubscriptionResource. </returns>
        public virtual ServiceUserSubscriptionCollection GetServiceUserSubscriptions()
        {
            return GetCachedClient(Client => new ServiceUserSubscriptionCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ServiceUserSubscriptionResource>> GetServiceUserSubscriptionAsync(string sid, CancellationToken cancellationToken = default)
        {
            return await GetServiceUserSubscriptions().GetAsync(sid, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="sid"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<ServiceUserSubscriptionResource> GetServiceUserSubscription(string sid, CancellationToken cancellationToken = default)
        {
            return GetServiceUserSubscriptions().Get(sid, cancellationToken);
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<UserContractResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _userContractUserClientDiagnostics.CreateScope("UserContractResource.Get");
            scope.Start();
            try
            {
                var response = await _userContractUserRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<UserContractResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _userContractUserClientDiagnostics.CreateScope("UserContractResource.Get");
            scope.Start();
            try
            {
                var response = _userContractUserRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new UserContractResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch, bool? deleteSubscriptions = null, bool? notify = null, AppType? appType = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _userContractUserClientDiagnostics.CreateScope("UserContractResource.Delete");
            scope.Start();
            try
            {
                var response = await _userContractUserRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, deleteSubscriptions, notify, appType, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, string ifMatch, bool? deleteSubscriptions = null, bool? notify = null, AppType? appType = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _userContractUserRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, deleteSubscriptions, notify, appType, cancellationToken);
                var operation = new ApiManagementArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<UserContractResource>> UpdateAsync(string ifMatch, UserContractPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(patch, nameof(patch));

            using var scope = _userContractUserClientDiagnostics.CreateScope("UserContractResource.Update");
            scope.Start();
            try
            {
                var response = await _userContractUserRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new UserContractResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ifMatch"/> or <paramref name="patch"/> is null. </exception>
        public virtual Response<UserContractResource> Update(string ifMatch, UserContractPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(patch, nameof(patch));
            ...
            try
            {
                var response = _userContractUserRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, patch, cancellationToken);
                return Response.FromValue(new UserContractResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _userContractUserClientDiagnostics.CreateScope("UserContractResource.GenerateSsoUrl");
            scope.Start();
            try
            {
                var response = await _userContractUserRestClient.GenerateSsoUrlAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<GenerateSsoUrlResult> GenerateSsoUrl(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _userContractUserRestClient.GenerateSsoUrl(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<UserTokenResult>> GetSharedAccessTokenAsync(UserTokenContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _userContractUserClientDiagnostics.CreateScope("UserContractResource.GetSharedAccessToken");
            scope.Start();
            try
            {
                var response = await _userContractUserRestClient.GetSharedAccessTokenAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<UserTokenResult> GetSharedAccessToken(UserTokenContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _userContractUserRestClient.GetSharedAccessToken(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual AsyncPageable<GroupContractResource> GetUserGroupsAsync(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            async Task<Page<GroupContractResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _userGroupClientDiagnostics.CreateScope("UserContractResource.GetUserGroups");
                scope.Start();
                try
                {
        ...
        public virtual Pageable<GroupContractResource> GetUserGroups(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
        ...
        public virtual AsyncPageable<UserIdentityContract> GetUserIdentitiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _userIdentitiesClientDiagnostics.CreateScope("UserContractResource.GetUserIdentities");
                scope.Start();
                try
                {
        ...
        {
            using var scope = _userConfirmationPasswordClientDiagnostics.CreateScope("UserContractResource.SendUserConfirmationPassword");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _userContractUserClientDiagnostics.CreateScope("UserContractResource.GetEntityTag");
            scope.Start();
            try
            {
                var response = await _userContractUserRestClient.GetEntityTagAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<bool> GetEntityTag(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _userContractUserRestClient.GetEntityTag(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
