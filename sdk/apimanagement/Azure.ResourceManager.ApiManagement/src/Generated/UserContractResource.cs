...
{
    /// <summary>
    /// A class representing a UserContract along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="UserContractResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ApiManagementServiceResource"/> using the GetUserContracts method.
    /// </summary>
    public partial class UserContractResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of UserContractResource for mocking. </summary>
        protected UserContractResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="UserContractResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal UserContractResource(ArmClient client, ApiManagementUserData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            TryGetApiVersion(ResourceType, out string userContractApiVersion);
            _userClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            _userRestClient = new User(_userClientDiagnostics, Pipeline, Endpoint, userContractApiVersion ?? "2025-09-01-preview");
            _userGroupClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            _userGroupRestClient = new UserGroup(_userGroupClientDiagnostics, Pipeline, Endpoint, userContractApiVersion ?? "2025-09-01-preview");
            ...
            _userConfirmationPasswordRestClient = new UserConfirmationPassword(_userConfirmationPasswordClientDiagnostics, Pipeline, Endpoint, userContractApiVersion ?? "2025-09-01-preview");
            ...
            _userIdentitiesRestClient = new UserIdentities(_userIdentitiesClientDiagnostics, Pipeline, Endpoint, userContractApiVersion ?? "2025-09-01-preview");
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="UserContractResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _userClientDiagnostics.CreateScope("UserContractResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<UserContractResource>> UpdateAsync(string ifMatch, ApiManagementUserPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(patch, nameof(patch));

            using DiagnosticScope scope = _userClientDiagnostics.CreateScope("UserContractResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="ifMatch"/> or <paramref name="patch"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="ifMatch"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<UserContractResource> Update(string ifMatch, ApiManagementUserPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(patch, nameof(patch));
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch, bool? deleteSubscriptions = default, bool? notify = default, AppType? appType = default, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _userClientDiagnostics.CreateScope("UserContractResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _userClientDiagnostics.CreateScope("UserContractResource.GenerateSsoUrl");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<Response<UserTokenResult>> GetSharedAccessTokenAsync(UserTokenContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _userClientDiagnostics.CreateScope("UserContractResource.GetSharedAccessToken");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _userConfirmationPasswordClientDiagnostics.CreateScope("UserContractResource.Send");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary> Gets a collection of ApiManagementUserSubscriptions in the <see cref="UserContractResource"/>. </summary>
