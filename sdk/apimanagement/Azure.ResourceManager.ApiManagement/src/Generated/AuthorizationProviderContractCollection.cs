...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// Each <see cref="AuthorizationProviderContractResource"/> in the collection will belong to the same instance of <see cref="SubscriptionResource"/>.
    /// To get a <see cref="AuthorizationProviderContractCollection"/> instance call the GetAuthorizationProviderContracts method from an instance of <see cref="SubscriptionResource"/>.
    /// </summary>
    public partial class AuthorizationProviderContractCollection : ArmCollection
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="serviceName"/>, <paramref name="authorizationProviderId"/> or <paramref name="data"/> is null. </exception>
        ...
        public virtual async Task<ArmOperation<AuthorizationProviderContractResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string serviceName, string authorizationProviderId, AuthorizationProviderContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _authorizationProviderRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, serviceName, authorizationProviderId, AuthorizationProviderContractData.ToRequestContent(data), ifMatch, context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="serviceName"/>, <paramref name="authorizationProviderId"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<AuthorizationProviderContractResource> CreateOrUpdate(WaitUntil waitUntil, string serviceName, string authorizationProviderId, AuthorizationProviderContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(serviceName, nameof(serviceName));
            Argument.AssertNotNullOrEmpty(authorizationProviderId, nameof(authorizationProviderId));
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <exception cref="ArgumentException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response<AuthorizationProviderContractResource>> GetAsync(string serviceName, string authorizationProviderId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(serviceName, nameof(serviceName));
            Argument.AssertNotNullOrEmpty(authorizationProviderId, nameof(authorizationProviderId));
            ...
            try
            {
                ...
                HttpMessage message = _authorizationProviderRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, serviceName, authorizationProviderId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AuthorizationProviderContractData> response = Response.FromValue(AuthorizationProviderContractData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<AuthorizationProviderContractResource> Get(string serviceName, string authorizationProviderId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(serviceName, nameof(serviceName));
            Argument.AssertNotNullOrEmpty(authorizationProviderId, nameof(authorizationProviderId));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response<bool>> ExistsAsync(string serviceName, string authorizationProviderId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(serviceName, nameof(serviceName));
            Argument.AssertNotNullOrEmpty(authorizationProviderId, nameof(authorizationProviderId));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<bool> Exists(string serviceName, string authorizationProviderId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(serviceName, nameof(serviceName));
            Argument.AssertNotNullOrEmpty(authorizationProviderId, nameof(authorizationProviderId));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<NullableResponse<AuthorizationProviderContractResource>> GetIfExistsAsync(string serviceName, string authorizationProviderId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(serviceName, nameof(serviceName));
            Argument.AssertNotNullOrEmpty(authorizationProviderId, nameof(authorizationProviderId));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="serviceName"/> or <paramref name="authorizationProviderId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual NullableResponse<AuthorizationProviderContractResource> GetIfExists(string serviceName, string authorizationProviderId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(serviceName, nameof(serviceName));
            Argument.AssertNotNullOrEmpty(authorizationProviderId, nameof(authorizationProviderId));
