...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementGatewayResource : ArmResource
    {
        ...
        public virtual AsyncPageable<GatewayApiData> GetGatewayApisByServiceAsync(ApiManagementGatewayResourceGetGatewayApisByServiceOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new ApiManagementGatewayResourceGetGatewayApisByServiceOptions();
            ...
            async Task<Page<GatewayApiData>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _gatewayApiRestClient.ListByServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<GatewayApiData>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _gatewayApiRestClient.ListByServiceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<GatewayApiData> GetGatewayApisByService(ApiManagementGatewayResourceGetGatewayApisByServiceOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new ApiManagementGatewayResourceGetGatewayApisByServiceOptions();
            ...
            Page<GatewayApiData> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _gatewayApiRestClient.ListByService(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<GatewayApiData> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _gatewayApiRestClient.ListByServiceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
