...
{
    /// <summary>
    /// A Class representing an ApiManagementSelfHostedGateway along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct an <see cref="ApiManagementSelfHostedGatewayResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetApiManagementSelfHostedGatewayResource method.
    /// Otherwise you can get one from its parent resource <see cref="ApiManagementServiceResource"/> using the GetApiManagementSelfHostedGateway method.
    /// </summary>
    public partial class ApiManagementSelfHostedGatewayResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="ApiManagementSelfHostedGatewayResource"/> instance. </summary>
        ...
        private readonly ClientDiagnostics _apiManagementSelfHostedGatewayGatewayClientDiagnostics;
        private readonly GatewayRestOperations _apiManagementSelfHostedGatewayGatewayRestClient;
        ...
        private readonly ApiManagementSelfHostedGatewayData _data;

        /// <summary> Gets the resource type for the operations. </summary>
        public static readonly ResourceType ResourceType = "Microsoft.ApiManagement/service/gateways";

        /// <summary> Initializes a new instance of the <see cref="ApiManagementSelfHostedGatewayResource"/> class for mocking. </summary>
        protected ApiManagementSelfHostedGatewayResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ApiManagementSelfHostedGatewayResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal ApiManagementSelfHostedGatewayResource(ArmClient client, ApiManagementSelfHostedGatewayData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ApiManagementSelfHostedGatewayResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _apiManagementSelfHostedGatewayGatewayClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string apiManagementSelfHostedGatewayGatewayApiVersion);
            _apiManagementSelfHostedGatewayGatewayRestClient = new GatewayRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementSelfHostedGatewayGatewayApiVersion);
        ...
        public virtual ApiManagementSelfHostedGatewayData Data
        {
            get
            {
                if (!HasData)
        ...
        /// <summary> Gets a collection of ApiManagementGatewayHostnameConfigurationResources in the ApiManagementSelfHostedGateway. </summary>
        ...
        /// <summary> Gets a collection of ApiManagementGatewayCertificateAuthorityResources in the ApiManagementSelfHostedGateway. </summary>
        ...
        /// <item>
        /// <term>Resource</term>
        /// <description><see cref="ApiManagementSelfHostedGatewayResource"/></description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ApiManagementSelfHostedGatewayResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _apiManagementSelfHostedGatewayGatewayClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.Get");
            scope.Start();
            try
            {
                var response = await _apiManagementSelfHostedGatewayGatewayRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ApiManagementSelfHostedGatewayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ApiManagementSelfHostedGatewayResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _apiManagementSelfHostedGatewayGatewayClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.Get");
            scope.Start();
            try
            {
                var response = _apiManagementSelfHostedGatewayGatewayRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ApiManagementSelfHostedGatewayResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _apiManagementSelfHostedGatewayGatewayClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.Delete");
            scope.Start();
            try
            {
                var response = await _apiManagementSelfHostedGatewayGatewayRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, cancellationToken).ConfigureAwait(false);
                var uri = _apiManagementSelfHostedGatewayGatewayRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, ETag ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementSelfHostedGatewayGatewayRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, cancellationToken);
                var uri = _apiManagementSelfHostedGatewayGatewayRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Delete, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new ApiManagementArmOperation(response, rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// </summary>
        /// <param name="ifMatch"> ETag of the Entity. ETag should match the current entity state from the header response of the GET request or it should be * for unconditional update. </param>
        /// <param name="data"> The <see cref="ApiManagementSelfHostedGatewayData"/> to use. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual async Task<Response<ApiManagementSelfHostedGatewayResource>> UpdateAsync(ETag ifMatch, ApiManagementSelfHostedGatewayData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _apiManagementSelfHostedGatewayGatewayClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.Update");
            scope.Start();
            try
            {
                var response = await _apiManagementSelfHostedGatewayGatewayRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, data, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new ApiManagementSelfHostedGatewayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<ApiManagementSelfHostedGatewayResource> Update(ETag ifMatch, ApiManagementSelfHostedGatewayData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _apiManagementSelfHostedGatewayGatewayRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, data, cancellationToken);
                return Response.FromValue(new ApiManagementSelfHostedGatewayResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _apiManagementSelfHostedGatewayGatewayClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.GetKeys");
            scope.Start();
            try
            {
                var response = await _apiManagementSelfHostedGatewayGatewayRestClient.ListKeysAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<GatewayKeysContract> GetKeys(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementSelfHostedGatewayGatewayRestClient.ListKeys(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response> RegenerateKeyAsync(GatewayKeyRegenerateContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _apiManagementSelfHostedGatewayGatewayClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.RegenerateKey");
            scope.Start();
            try
            {
                var response = await _apiManagementSelfHostedGatewayGatewayRestClient.RegenerateKeyAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response RegenerateKey(GatewayKeyRegenerateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementSelfHostedGatewayGatewayRestClient.RegenerateKey(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<GatewayTokenContract>> GenerateTokenAsync(GatewayTokenRequestContract gatewayTokenRequestContract, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _apiManagementSelfHostedGatewayGatewayClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.GenerateToken");
            scope.Start();
            try
            {
                var response = await _apiManagementSelfHostedGatewayGatewayRestClient.GenerateTokenAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayTokenRequestContract, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<GatewayTokenContract> GenerateToken(GatewayTokenRequestContract gatewayTokenRequestContract, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementSelfHostedGatewayGatewayRestClient.GenerateToken(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayTokenRequestContract, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        {
            using var scope = _apiManagementSelfHostedGatewayGatewayClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.InvalidateDebugCredentials");
            scope.Start();
            try
            {
                var response = await _apiManagementSelfHostedGatewayGatewayRestClient.InvalidateDebugCredentialsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response InvalidateDebugCredentials(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementSelfHostedGatewayGatewayRestClient.InvalidateDebugCredentials(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<GatewayDebugCredentialsContract>> GetDebugCredentialsAsync(GatewayListDebugCredentialsContract gatewayListDebugCredentialsContract, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _apiManagementSelfHostedGatewayGatewayClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.GetDebugCredentials");
            scope.Start();
            try
            {
                var response = await _apiManagementSelfHostedGatewayGatewayRestClient.ListDebugCredentialsAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayListDebugCredentialsContract, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<GatewayDebugCredentialsContract> GetDebugCredentials(GatewayListDebugCredentialsContract gatewayListDebugCredentialsContract, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementSelfHostedGatewayGatewayRestClient.ListDebugCredentials(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayListDebugCredentialsContract, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<IReadOnlyDictionary<string, BinaryData>>> GetTraceAsync(GatewayListTraceContract gatewayListTraceContract, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _apiManagementSelfHostedGatewayGatewayClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.GetTrace");
            scope.Start();
            try
            {
                var response = await _apiManagementSelfHostedGatewayGatewayRestClient.ListTraceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayListTraceContract, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<IReadOnlyDictionary<string, BinaryData>> GetTrace(GatewayListTraceContract gatewayListTraceContract, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementSelfHostedGatewayGatewayRestClient.ListTrace(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, gatewayListTraceContract, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual AsyncPageable<GatewayApiData> GetGatewayApisByServiceAsync(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => GatewayApiData.DeserializeGatewayApiData(e), _gatewayApiClientDiagnostics, Pipeline, "ApiManagementSelfHostedGatewayResource.GetGatewayApisByService", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<GatewayApiData> GetGatewayApisByService(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _gatewayApiRestClient.CreateListByServiceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _gatewayApiRestClient.CreateListByServiceNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => GatewayApiData.DeserializeGatewayApiData(e), _gatewayApiClientDiagnostics, Pipeline, "ApiManagementSelfHostedGatewayResource.GetGatewayApisByService", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> GetGatewayApiEntityTagAsync(string apiId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _gatewayApiClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.GetGatewayApiEntityTag");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<GatewayApiData>> CreateOrUpdateGatewayApiAsync(string apiId, AssociationContract associationContract = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _gatewayApiClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.CreateOrUpdateGatewayApi");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteGatewayApiAsync(string apiId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _gatewayApiClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.DeleteGatewayApi");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _apiManagementSelfHostedGatewayGatewayClientDiagnostics.CreateScope("ApiManagementSelfHostedGatewayResource.GetEntityTag");
            scope.Start();
            try
            {
                var response = await _apiManagementSelfHostedGatewayGatewayRestClient.GetEntityTagAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<bool> GetEntityTag(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementSelfHostedGatewayGatewayRestClient.GetEntityTag(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
