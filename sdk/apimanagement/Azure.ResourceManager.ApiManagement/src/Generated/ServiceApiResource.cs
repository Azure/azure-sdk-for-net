...
{
    /// <summary>
    /// A Class representing a ServiceApi along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ServiceApiResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetServiceApiResource method.
    /// Otherwise you can get one from its parent resource <see cref="ApiManagementServiceResource"/> using the GetServiceApi method.
    /// </summary>
    public partial class ServiceApiResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="ServiceApiResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="ServiceApiResource"/> class for mocking. </summary>
        protected ServiceApiResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceApiResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal ServiceApiResource(ArmClient client, ApiData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ServiceApiResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _serviceApiApiClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string serviceApiApiApiVersion);
        ...
        /// <summary> Gets a collection of ServiceApiReleaseResources in the ServiceApi. </summary>
        /// <returns> An object representing collection of ServiceApiReleaseResources and their operations over a ServiceApiReleaseResource. </returns>
        public virtual ServiceApiReleaseCollection GetServiceApiReleases()
        {
            return GetCachedClient(client => new ServiceApiReleaseCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ServiceApiReleaseResource>> GetServiceApiReleaseAsync(string releaseId, CancellationToken cancellationToken = default)
        {
            return await GetServiceApiReleases().GetAsync(releaseId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="releaseId"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ServiceApiReleaseResource> GetServiceApiRelease(string releaseId, CancellationToken cancellationToken = default)
        {
            return GetServiceApiReleases().Get(releaseId, cancellationToken);
        }

        /// <summary> Gets a collection of ServiceApiOperationResources in the ServiceApi. </summary>
        /// <returns> An object representing collection of ServiceApiOperationResources and their operations over a ServiceApiOperationResource. </returns>
        public virtual ServiceApiOperationCollection GetServiceApiOperations()
        {
            return GetCachedClient(client => new ServiceApiOperationCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ServiceApiOperationResource>> GetServiceApiOperationAsync(string operationId, CancellationToken cancellationToken = default)
        {
            return await GetServiceApiOperations().GetAsync(operationId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ServiceApiOperationResource> GetServiceApiOperation(string operationId, CancellationToken cancellationToken = default)
        {
            return GetServiceApiOperations().Get(operationId, cancellationToken);
        }

        /// <summary> Gets a collection of ApiPolicyResources in the ServiceApi. </summary>
        ...
        /// <summary> Gets a collection of ApiTagResources in the ServiceApi. </summary>
        ...
        /// <summary> Gets a collection of ResolverContractResources in the ServiceApi. </summary>
        ...
        /// <summary> Gets a collection of ServiceApiSchemaResources in the ServiceApi. </summary>
        /// <returns> An object representing collection of ServiceApiSchemaResources and their operations over a ServiceApiSchemaResource. </returns>
        public virtual ServiceApiSchemaCollection GetServiceApiSchemas()
        {
            return GetCachedClient(client => new ServiceApiSchemaCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ServiceApiSchemaResource>> GetServiceApiSchemaAsync(string schemaId, CancellationToken cancellationToken = default)
        {
            return await GetServiceApiSchemas().GetAsync(schemaId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="schemaId"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ServiceApiSchemaResource> GetServiceApiSchema(string schemaId, CancellationToken cancellationToken = default)
        {
            return GetServiceApiSchemas().Get(schemaId, cancellationToken);
        }

        /// <summary> Gets a collection of ApiDiagnosticResources in the ServiceApi. </summary>
        ...
        /// <summary> Gets a collection of ApiIssueResources in the ServiceApi. </summary>
        ...
        /// <summary> Gets a collection of ApiTagDescriptionResources in the ServiceApi. </summary>
        ...
        /// <summary> Gets an object representing a ServiceApiWikiResource along with the instance operations that can be performed on it in the ServiceApi. </summary>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ServiceApiResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _serviceApiApiClientDiagnostics.CreateScope("ServiceApiResource.Get");
            scope.Start();
            try
            {
                var response = await _serviceApiApiRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ServiceApiResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _serviceApiApiClientDiagnostics.CreateScope("ServiceApiResource.Get");
            scope.Start();
            try
            {
                var response = _serviceApiApiRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ServiceApiResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _serviceApiApiClientDiagnostics.CreateScope("ServiceApiResource.Delete");
            scope.Start();
            try
            {
                var response = await _serviceApiApiRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, deleteRevisions, cancellationToken).ConfigureAwait(false);
                var operation = new ApiManagementArmOperation(_serviceApiApiClientDiagnostics, Pipeline, _serviceApiApiRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, deleteRevisions).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual async Task<Response<ServiceApiResource>> UpdateAsync(ETag ifMatch, ApiUpdateContract apiUpdateContract, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(apiUpdateContract, nameof(apiUpdateContract));

            using var scope = _serviceApiApiClientDiagnostics.CreateScope("ServiceApiResource.Update");
            scope.Start();
            try
            {
                var response = await _serviceApiApiRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, apiUpdateContract, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new ServiceApiResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="apiUpdateContract"/> is null. </exception>
        public virtual Response<ServiceApiResource> Update(ETag ifMatch, ApiUpdateContract apiUpdateContract, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(apiUpdateContract, nameof(apiUpdateContract));
            ...
            try
            {
                var response = _serviceApiApiRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, apiUpdateContract, cancellationToken);
                return Response.FromValue(new ServiceApiResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual AsyncPageable<ApiRevisionContract> GetApiRevisionsByServiceAsync(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => ApiRevisionContract.DeserializeApiRevisionContract(e), _apiRevisionClientDiagnostics, Pipeline, "ServiceApiResource.GetApiRevisionsByService", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ApiRevisionContract> GetApiRevisionsByService(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _apiRevisionRestClient.CreateListByServiceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _apiRevisionRestClient.CreateListByServiceNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => ApiRevisionContract.DeserializeApiRevisionContract(e), _apiRevisionClientDiagnostics, Pipeline, "ServiceApiResource.GetApiRevisionsByService", "value", "nextLink", cancellationToken);
        }
        ...
        /// <param name="skip"> Number of records to skip. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> An async collection of <see cref="ApiManagementProductData"/> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<ApiManagementProductData> GetApiProductsAsync(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => ApiManagementProductData.DeserializeApiManagementProductData(e), _apiProductClientDiagnostics, Pipeline, "ServiceApiResource.GetApiProducts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ApiManagementProductData> GetApiProducts(string filter = null, int? top = null, int? skip = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _apiProductRestClient.CreateListByApisRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _apiProductRestClient.CreateListByApisNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => ApiManagementProductData.DeserializeApiManagementProductData(e), _apiProductClientDiagnostics, Pipeline, "ServiceApiResource.GetApiProducts", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<TagResourceContractDetails> GetOperationsByTagsAsync(string filter = null, int? top = null, int? skip = null, bool? includeNotTaggedOperations = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => TagResourceContractDetails.DeserializeTagResourceContractDetails(e), _operationClientDiagnostics, Pipeline, "ServiceApiResource.GetOperationsByTags", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<TagResourceContractDetails> GetOperationsByTags(string filter = null, int? top = null, int? skip = null, bool? includeNotTaggedOperations = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _operationRestClient.CreateListByTagsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip, includeNotTaggedOperations);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _operationRestClient.CreateListByTagsNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, filter, top, skip, includeNotTaggedOperations);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => TagResourceContractDetails.DeserializeTagResourceContractDetails(e), _operationClientDiagnostics, Pipeline, "ServiceApiResource.GetOperationsByTags", "value", "nextLink", cancellationToken);
        }
        ...
        {
            using var scope = _serviceApiApiClientDiagnostics.CreateScope("ServiceApiResource.GetEntityTag");
            scope.Start();
            try
            {
                var response = await _serviceApiApiRestClient.GetEntityTagAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<bool> GetEntityTag(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _serviceApiApiRestClient.GetEntityTag(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
