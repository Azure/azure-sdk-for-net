...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// To get a <see cref="ApiOperationCollection"/> instance call the GetApiOperations method from an instance of <see cref="ApiResource"/>.
    /// </summary>
    public partial class ApiOperationCollection : ArmCollection, IEnumerable<ApiOperationResource>, IAsyncEnumerable<ApiOperationResource>
    {
        ...
        /// <summary> Initializes a new instance of ApiOperationCollection for mocking. </summary>
        protected ApiOperationCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ApiOperationCollection"/> class. </summary>
        ...
        internal ApiOperationCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _apiOperationRestClient = new ApiOperation(_apiOperationClientDiagnostics, Pipeline, Endpoint, apiOperationApiVersion ?? "2025-03-01-preview");
            _apiOperationPolicyClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ApiOperationResource.ResourceType.Namespace, Diagnostics);
            _apiOperationPolicyRestClient = new ApiOperationPolicy(_apiOperationPolicyClientDiagnostics, Pipeline, Endpoint, apiOperationApiVersion ?? "2025-03-01-preview");
            _operationTagClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ApiOperationResource.ResourceType.Namespace, Diagnostics);
            _operationTagRestClient = new OperationTag(_operationTagClientDiagnostics, Pipeline, Endpoint, apiOperationApiVersion ?? "2025-03-01-preview");
        ...
        /// <description> OperationContracts_CreateOrUpdate. </description>
        /// </item>
        /// <item>
        ...
        public virtual async Task<ArmOperation<ApiOperationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string operationId, ApiOperationData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(operationId, nameof(operationId));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _apiOperationClientDiagnostics.CreateScope("ApiOperationCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _apiOperationRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, operationId, ApiOperationData.ToRequestContent(data), ifMatch, context);
                ...
                ApiManagementArmOperation<ApiOperationResource> operation = new ApiManagementArmOperation<ApiOperationResource>(Response.FromValue(new ApiOperationResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="operationId"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ApiOperationResource> CreateOrUpdate(WaitUntil waitUntil, string operationId, ApiOperationData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(operationId, nameof(operationId));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<ApiOperationResource>> GetAsync(string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiOperationClientDiagnostics.CreateScope("ApiOperationCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _apiOperationRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, operationId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiOperationData> response = Response.FromValue(ApiOperationData.FromResponse(result), result);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> OperationContracts_ListByApi. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-03-01-preview. </description>
        ...
        public virtual AsyncPageable<ApiOperationResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, string tags = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<ApiOperationData, ApiOperationResource>(new ApiOperationGetByApiAsyncCollectionResultOfT(
                ...
                skip,
                tags,
                context), data => new ApiOperationResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ApiOperationResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ApiOperationResource> GetAll(string filter = default, int? top = default, int? skip = default, string tags = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiOperationClientDiagnostics.CreateScope("ApiOperationCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ApiOperationResource>> GetIfExistsAsync(string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiOperationClientDiagnostics.CreateScope("ApiOperationCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
