...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        private static IJsonModel<ApiManagementPortalRevisionData> s_dataDeserializationInstance;

        private static IJsonModel<ApiManagementPortalRevisionData> DataDeserializationInstance => s_dataDeserializationInstance ??= new ApiManagementPortalRevisionData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiManagementPortalRevisionData IJsonModel<ApiManagementPortalRevisionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ApiManagementPortalRevisionData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
