...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class PolicyContractData : ResourceData
    {
        ...
        internal PolicyContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PolicyContractProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
