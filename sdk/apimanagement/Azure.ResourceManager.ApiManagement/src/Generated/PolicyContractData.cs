...
{
    /// <summary> A class representing the PolicyContract data model. </summary>
    public partial class PolicyContractData : Resource
    {
        ...
        internal PolicyContractData(ResourceIdentifier id, string name, ResourceType type, string value, PolicyContentFormat? format) : base(id, name, type)
        {
            Value = value;
            Format = format;
        }
