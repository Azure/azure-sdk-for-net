...
namespace Azure.ResourceManager.ApiManagement.Mocking
{
    ...
    public partial class ApiManagementSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ApiManagementSubscriptionMockingExtension"/> class for mocking. </summary>
        protected ApiManagementSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ApiManagementSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ApiManagementSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ApiManagementServiceNameAvailabilityResult>> CheckApiManagementServiceNameAvailabilityAsync(ApiManagementServiceNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ApiManagementServiceClientDiagnostics.CreateScope("ApiManagementSubscriptionMockingExtension.CheckApiManagementServiceNameAvailability");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ApiManagementServiceClientDiagnostics.CreateScope("ApiManagementSubscriptionMockingExtension.GetApiManagementServiceDomainOwnershipIdentifier");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ApiManagementSku> GetApiManagementSkusAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ApiManagementSku.DeserializeApiManagementSku, ApiManagementSkusClientDiagnostics, Pipeline, "ApiManagementSubscriptionMockingExtension.GetApiManagementSkus", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ApiManagementSku> GetApiManagementSkus(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ApiManagementSkusRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ApiManagementSkusRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ApiManagementSku.DeserializeApiManagementSku, ApiManagementSkusClientDiagnostics, Pipeline, "ApiManagementSubscriptionMockingExtension.GetApiManagementSkus", "value", "nextLink", cancellationToken);
        }
    }
}
