...
namespace Azure.ResourceManager.ApiManagement.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class ApiManagementSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ApiManagementSubscriptionResourceExtension"/> class for mocking. </summary>
        protected ApiManagementSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ApiManagementSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ApiManagementSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ApiManagementServiceNameAvailabilityResult>> CheckApiManagementServiceNameAvailabilityAsync(ApiManagementServiceNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ApiManagementServiceClientDiagnostics.CreateScope("ApiManagementSubscriptionResourceExtension.CheckApiManagementServiceNameAvailability");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ApiManagementServiceClientDiagnostics.CreateScope("ApiManagementSubscriptionResourceExtension.GetApiManagementServiceDomainOwnershipIdentifier");
            scope.Start();
            try
            {
        ...
        public virtual AsyncPageable<ApiManagementSku> GetApiManagementSkusAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, ApiManagementSku.DeserializeApiManagementSku, ApiManagementSkusClientDiagnostics, Pipeline, "ApiManagementSubscriptionResourceExtension.GetApiManagementSkus", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ApiManagementSku> GetApiManagementSkus(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ApiManagementSkusRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ApiManagementSkusRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, ApiManagementSku.DeserializeApiManagementSku, ApiManagementSkusClientDiagnostics, Pipeline, "ApiManagementSubscriptionResourceExtension.GetApiManagementSkus", "value", "nextLink", cancellationToken);
        }
    }
}
