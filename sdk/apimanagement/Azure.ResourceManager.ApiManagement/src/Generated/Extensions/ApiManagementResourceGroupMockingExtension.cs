...
namespace Azure.ResourceManager.ApiManagement.Mocking
{
    ...
    internal partial class ApiManagementResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ApiManagementResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ApiManagementResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ApiManagementResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ApiManagementResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
