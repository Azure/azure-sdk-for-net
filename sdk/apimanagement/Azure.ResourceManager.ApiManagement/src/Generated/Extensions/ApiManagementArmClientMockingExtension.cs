...
namespace Azure.ResourceManager.ApiManagement.Mocking
{
    ...
    internal partial class ApiManagementArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ApiManagementArmClientMockingExtension"/> class for mocking. </summary>
        protected ApiManagementArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ApiManagementArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ApiManagementArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ApiManagementArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
