...
namespace Azure.ResourceManager.ApiManagement.Mock
{
    ...
    public partial class ApiManagementServiceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ApiManagementServiceResourceExtension"/> class for mocking. </summary>
        protected ApiManagementServiceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ApiManagementServiceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ApiManagementServiceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ApiManagementServiceNameAvailabilityResult>> CheckApiManagementServiceNameAvailabilityAsync(ApiManagementServiceNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ApiManagementServiceClientDiagnostics.CreateScope("ApiManagementServiceResourceExtension.CheckApiManagementServiceNameAvailability");
            scope.Start();
            try
            {
        ...
        {
            using var scope = ApiManagementServiceClientDiagnostics.CreateScope("ApiManagementServiceResourceExtension.GetApiManagementServiceDomainOwnershipIdentifier");
            scope.Start();
            try
            {
