...
namespace Azure.ResourceManager.ApiManagement.Mock
{
    ...
    public partial class ApiManagementDeletedServiceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ApiManagementDeletedServiceResourceExtension"/> class for mocking. </summary>
        protected ApiManagementDeletedServiceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ApiManagementDeletedServiceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ApiManagementDeletedServiceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
