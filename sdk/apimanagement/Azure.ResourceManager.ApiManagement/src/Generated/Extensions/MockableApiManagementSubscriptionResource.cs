...
namespace Azure.ResourceManager.ApiManagement.Mocking
{
    ...
    {
        private ClientDiagnostics _apiManagementGatewayResourceApiGatewayClientDiagnostics;
        private ApiGatewayRestOperations _apiManagementGatewayResourceApiGatewayRestClient;
        ...
        private ClientDiagnostics ApiManagementGatewayResourceApiGatewayClientDiagnostics => _apiManagementGatewayResourceApiGatewayClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ApiManagementGatewayResource.ResourceType.Namespace, Diagnostics);
        private ApiGatewayRestOperations ApiManagementGatewayResourceApiGatewayRestClient => _apiManagementGatewayResourceApiGatewayRestClient ??= new ApiGatewayRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, GetApiVersionOrNull(ApiManagementGatewayResource.ResourceType));
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ApiManagementGatewayResourceApiGatewayRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ApiManagementGatewayResourceApiGatewayRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ApiManagementGatewayResource(Client, ApiManagementGatewayResourceData.DeserializeApiManagementGatewayResourceData(e)), ApiManagementGatewayResourceApiGatewayClientDiagnostics, Pipeline, "MockableApiManagementSubscriptionResource.GetApiManagementGatewayResources", "value", "nextLink", cancellationToken);
        }
