    ...
    public partial class ApiPolicyResource : PolicyContractResource
    {
        ...
        protected override async Task<Response<PolicyContractResource>> GetCoreAsync(PolicyExportFormat? format = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((PolicyContractResource)new ApiPolicyResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        protected override async Task<ArmOperation<PolicyContractResource>> UpdateCoreAsync(WaitUntil waitUntil, PolicyContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ApiManagementArmOperation<PolicyContractResource>(Response.FromValue((PolicyContractResource)new ApiPolicyResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual new async Task<ArmOperation<ApiPolicyResource>> UpdateAsync(WaitUntil waitUntil, PolicyContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            return new ApiManagementArmOperation<ApiPolicyResource>(Response.FromValue((ApiPolicyResource)result.Value, result.GetRawResponse()));
        }
