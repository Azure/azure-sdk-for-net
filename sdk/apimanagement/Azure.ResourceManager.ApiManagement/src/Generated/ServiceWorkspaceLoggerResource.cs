...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ServiceWorkspaceLoggerResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="WorkspaceContractResource"/> using the GetServiceWorkspaceLoggers method.
    /// </summary>
    public partial class ServiceWorkspaceLoggerResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ServiceWorkspaceLoggerResource for mocking. </summary>
        protected ServiceWorkspaceLoggerResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ServiceWorkspaceLoggerResource"/> class. </summary>
        ...
        public virtual async Task<Response<ServiceWorkspaceLoggerResource>> UpdateAsync(string ifMatch, ApiManagementLoggerPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workspaceLoggerRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ifMatch, ApiManagementLoggerPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiManagementLoggerData> response = Response.FromValue(ApiManagementLoggerData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <summary>
        /// Updates the ServiceWorkspaceLogger.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/workspaces/{workspaceId}/loggers/{loggerId}. </description>
        ...
        public virtual async Task<ArmOperation<ServiceWorkspaceLoggerResource>> UpdateAsync(WaitUntil waitUntil, ApiManagementLoggerData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workspaceLoggerRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ApiManagementLoggerData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiManagementLoggerData> response = Response.FromValue(ApiManagementLoggerData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ServiceWorkspaceLoggerResource> Update(WaitUntil waitUntil, ApiManagementLoggerData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
