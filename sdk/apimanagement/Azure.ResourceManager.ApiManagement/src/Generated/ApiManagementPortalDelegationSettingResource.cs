...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetApiManagementPortalDelegationSettings method.
    /// </summary>
    public partial class ApiManagementPortalDelegationSettingResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _apiManagementPortalDelegationSettingClientDiagnostics.CreateScope("ApiManagementPortalDelegationSettingResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> UpdateAsync(ETag ifMatch, ApiManagementPortalDelegationSettingData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiManagementPortalDelegationSettingClientDiagnostics.CreateScope("ApiManagementPortalDelegationSettingResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _apiManagementPortalDelegationSettingRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, ifMatch, ApiManagementPortalDelegationSettingData.ToRequestContent(data), context);
        ...
        {
            using DiagnosticScope scope = _apiManagementPortalDelegationSettingClientDiagnostics.CreateScope("ApiManagementPortalDelegationSettingResource.GetSecrets");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
