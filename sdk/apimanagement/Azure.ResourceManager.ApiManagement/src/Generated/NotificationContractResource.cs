...
{
    /// <summary>
    /// A Class representing a NotificationContract along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="NotificationContractResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetNotificationContractResource method.
    /// Otherwise you can get one from its parent resource <see cref="ApiManagementServiceResource" /> using the GetNotificationContract method.
    /// </summary>
    public partial class NotificationContractResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="NotificationContractResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="NotificationContractResource"/> class for mocking. </summary>
        protected NotificationContractResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "NotificationContractResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal NotificationContractResource(ArmClient client, NotificationContractData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal NotificationContractResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _notificationContractNotificationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string notificationContractNotificationApiVersion);
        ...
        public virtual async Task<Response<NotificationContractResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _notificationContractNotificationClientDiagnostics.CreateScope("NotificationContractResource.Get");
            scope.Start();
            try
            {
                var response = await _notificationContractNotificationRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<NotificationContractResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _notificationContractNotificationClientDiagnostics.CreateScope("NotificationContractResource.Get");
            scope.Start();
            try
            {
                var response = _notificationContractNotificationRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new NotificationContractResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<NotificationContractResource>> UpdateAsync(WaitUntil waitUntil, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _notificationContractNotificationClientDiagnostics.CreateScope("NotificationContractResource.Update");
            scope.Start();
            try
            {
                var response = await _notificationContractNotificationRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="ifMatch"> ETag of the Entity. Not required when creating an entity, but required when updating an entity. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<NotificationContractResource> Update(WaitUntil waitUntil, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            using var scope = _notificationContractNotificationClientDiagnostics.CreateScope("NotificationContractResource.Update");
            scope.Start();
            try
            {
                var response = _notificationContractNotificationRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, cancellationToken);
                var operation = new ApiManagementArmOperation<NotificationContractResource>(Response.FromValue(new NotificationContractResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
        ...
        {
            async Task<Page<RecipientUserContract>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _notificationRecipientUserClientDiagnostics.CreateScope("NotificationContractResource.GetNotificationRecipientUsers");
                scope.Start();
                try
                {
                    var response = await _notificationRecipientUserRestClient.ListByNotificationAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        {
            Page<RecipientUserContract> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _notificationRecipientUserClientDiagnostics.CreateScope("NotificationContractResource.GetNotificationRecipientUsers");
                scope.Start();
                try
                {
                    var response = _notificationRecipientUserRestClient.ListByNotification(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<bool>> CheckEntityExistsNotificationRecipientUserAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientUserClientDiagnostics.CreateScope("NotificationContractResource.CheckEntityExistsNotificationRecipientUser");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<RecipientUserContract>> CreateOrUpdateNotificationRecipientUserAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientUserClientDiagnostics.CreateScope("NotificationContractResource.CreateOrUpdateNotificationRecipientUser");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteNotificationRecipientUserAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientUserClientDiagnostics.CreateScope("NotificationContractResource.DeleteNotificationRecipientUser");
            scope.Start();
            try
            {
        ...
        {
            async Task<Page<RecipientEmailContract>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _notificationRecipientEmailClientDiagnostics.CreateScope("NotificationContractResource.GetNotificationRecipientEmails");
                scope.Start();
                try
                {
                    var response = await _notificationRecipientEmailRestClient.ListByNotificationAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<RecipientEmailContract> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _notificationRecipientEmailClientDiagnostics.CreateScope("NotificationContractResource.GetNotificationRecipientEmails");
                scope.Start();
                try
                {
                    var response = _notificationRecipientEmailRestClient.ListByNotification(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<bool>> CheckEntityExistsNotificationRecipientEmailAsync(string email, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientEmailClientDiagnostics.CreateScope("NotificationContractResource.CheckEntityExistsNotificationRecipientEmail");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<RecipientEmailContract>> CreateOrUpdateNotificationRecipientEmailAsync(string email, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientEmailClientDiagnostics.CreateScope("NotificationContractResource.CreateOrUpdateNotificationRecipientEmail");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response> DeleteNotificationRecipientEmailAsync(string email, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _notificationRecipientEmailClientDiagnostics.CreateScope("NotificationContractResource.DeleteNotificationRecipientEmail");
            scope.Start();
            try
            {
