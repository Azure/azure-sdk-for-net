...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementLoggerResource : ArmResource
    {
        ...
        public virtual async Task<Response<ApiManagementLoggerResource>> UpdateAsync(string ifMatch, LoggerUpdateContract loggerUpdateContract, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _loggerRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, LoggerUpdateContract.ToRequestContent(loggerUpdateContract), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiManagementLoggerData> response = Response.FromValue(ApiManagementLoggerData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="ifMatch"/> or <paramref name="loggerUpdateContract"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="ifMatch"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<ApiManagementLoggerResource> Update(string ifMatch, LoggerUpdateContract loggerUpdateContract, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(loggerUpdateContract, nameof(loggerUpdateContract));
