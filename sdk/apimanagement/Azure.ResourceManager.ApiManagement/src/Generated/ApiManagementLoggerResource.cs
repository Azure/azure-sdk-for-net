...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementLoggerResource : ArmResource
    {
        ...
        internal ApiManagementLoggerResource(ArmClient client, ApiManagementLoggerData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ApiManagementLoggerResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ApiManagementLoggerResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
