...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementDeletedServiceResource : ArmResource
    {
        ...
        internal ApiManagementDeletedServiceResource(ArmClient client, ApiManagementDeletedServiceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ApiManagementDeletedServiceResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ApiManagementDeletedServiceResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
