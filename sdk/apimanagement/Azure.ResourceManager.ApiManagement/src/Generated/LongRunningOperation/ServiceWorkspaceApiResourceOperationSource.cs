...
{
    /// <summary></summary>
    internal partial class ServiceWorkspaceApiResourceOperationSource : IOperationSource<ServiceWorkspaceApiResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ServiceWorkspaceApiResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
