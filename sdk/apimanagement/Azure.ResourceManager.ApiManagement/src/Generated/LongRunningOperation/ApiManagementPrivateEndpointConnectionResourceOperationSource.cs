...
{
    /// <summary></summary>
    internal partial class ApiManagementPrivateEndpointConnectionResourceOperationSource : IOperationSource<ApiManagementPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ApiManagementPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        ApiManagementPrivateEndpointConnectionResource IOperationSource<ApiManagementPrivateEndpointConnectionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ApiManagementPrivateEndpointConnectionData data = ApiManagementPrivateEndpointConnectionData.DeserializeApiManagementPrivateEndpointConnectionData(document.RootElement, ModelSerializationExtensions.WireOptions);
