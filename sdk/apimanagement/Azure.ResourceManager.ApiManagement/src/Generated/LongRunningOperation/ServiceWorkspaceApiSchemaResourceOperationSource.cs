...
{
    /// <summary></summary>
    internal partial class ServiceWorkspaceApiSchemaResourceOperationSource : IOperationSource<ServiceWorkspaceApiSchemaResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ServiceWorkspaceApiSchemaResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
