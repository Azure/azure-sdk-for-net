...
{
    /// <summary></summary>
    internal partial class ApiManagementGatewayOperationSource : IOperationSource<ApiManagementGatewayResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ApiManagementGatewayOperationSource(ArmClient client)
        {
            _client = client;
        }
