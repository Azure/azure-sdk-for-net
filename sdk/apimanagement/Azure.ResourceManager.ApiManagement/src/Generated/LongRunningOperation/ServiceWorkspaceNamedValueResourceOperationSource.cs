...
{
    /// <summary></summary>
    internal partial class ServiceWorkspaceNamedValueResourceOperationSource : IOperationSource<ServiceWorkspaceNamedValueResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ServiceWorkspaceNamedValueResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
