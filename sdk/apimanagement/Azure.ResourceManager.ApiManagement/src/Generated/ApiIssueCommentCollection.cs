...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// To get a <see cref="ApiIssueCommentCollection"/> instance call the GetApiIssueComments method from an instance of <see cref="ApiIssueResource"/>.
    /// </summary>
    public partial class ApiIssueCommentCollection : ArmCollection, IEnumerable<ApiIssueCommentResource>, IAsyncEnumerable<ApiIssueCommentResource>
    {
        ...
        /// <summary> Initializes a new instance of ApiIssueCommentCollection for mocking. </summary>
        protected ApiIssueCommentCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ApiIssueCommentCollection"/> class. </summary>
        ...
        public virtual async Task<ArmOperation<ApiIssueCommentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string commentId, ApiIssueCommentData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(commentId, nameof(commentId));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _apiIssueCommentClientDiagnostics.CreateScope("ApiIssueCommentCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _apiIssueCommentRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, commentId, ApiIssueCommentData.ToRequestContent(data), ifMatch, context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="commentId"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="commentId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ApiIssueCommentResource> CreateOrUpdate(WaitUntil waitUntil, string commentId, ApiIssueCommentData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(commentId, nameof(commentId));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<ApiIssueCommentResource>> GetAsync(string commentId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiIssueCommentClientDiagnostics.CreateScope("ApiIssueCommentCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _apiIssueCommentRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, commentId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiIssueCommentData> response = Response.FromValue(ApiIssueCommentData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<ApiIssueCommentResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<ApiIssueCommentData, ApiIssueCommentResource>(new ApiIssueCommentGetByServiceAsyncCollectionResultOfT(
                ...
                top,
                skip,
                context), data => new ApiIssueCommentResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ApiIssueCommentResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ApiIssueCommentResource> GetAll(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string commentId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiIssueCommentClientDiagnostics.CreateScope("ApiIssueCommentCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ApiIssueCommentResource>> GetIfExistsAsync(string commentId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiIssueCommentClientDiagnostics.CreateScope("ApiIssueCommentCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
