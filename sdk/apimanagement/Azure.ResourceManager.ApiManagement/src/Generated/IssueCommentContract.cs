...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class IssueCommentContract : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="IssueCommentContract"/> class for mocking. </summary>
        protected IssueCommentContract()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "IssueCommentContract"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="resource"> The resource that is the target of operations. </param>
        internal IssueCommentContract(ArmResource options, IssueCommentContractData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal IssueCommentContract(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _apiIssueCommentRestClient = new ApiIssueCommentRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal IssueCommentContract(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _apiIssueCommentRestClient = new ApiIssueCommentRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        }
        ...
        public async virtual Task<Response<IssueCommentContract>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("IssueCommentContract.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new IssueCommentContract(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Gets the details of the issue Comment for an API specified by its identifier. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<IssueCommentContract> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("IssueCommentContract.Get");
            scope.Start();
            try
        ...
        public async virtual Task<ApiIssueCommentDeleteOperation> DeleteAsync(string ifMatch, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (ifMatch == null)
            {
            ...
            using var scope = _clientDiagnostics.CreateScope("IssueCommentContract.Delete");
            scope.Start();
            try
            {
                ...
                var operation = new ApiIssueCommentDeleteOperation(response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ifMatch"/> is null. </exception>
        public virtual ApiIssueCommentDeleteOperation Delete(string ifMatch, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (ifMatch == null)
            {
                throw new ArgumentNullException(nameof(ifMatch));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("IssueCommentContract.GetEntityTag");
            scope.Start();
            try
            {
