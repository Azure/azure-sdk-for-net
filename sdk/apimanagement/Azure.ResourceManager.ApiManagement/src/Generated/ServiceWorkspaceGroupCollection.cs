...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspaceGroupCollection : ArmCollection, IEnumerable<ServiceWorkspaceGroupResource>, IAsyncEnumerable<ServiceWorkspaceGroupResource>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ServiceWorkspaceGroupCollection"/> class. </summary>
        ...
        public virtual async Task<ArmOperation<ServiceWorkspaceGroupResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string groupId, ApiManagementGroupCreateOrUpdateContent content, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workspaceGroupRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, groupId, ApiManagementGroupCreateOrUpdateContent.ToRequestContent(content), ifMatch, context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="groupId"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="groupId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ServiceWorkspaceGroupResource> CreateOrUpdate(WaitUntil waitUntil, string groupId, ApiManagementGroupCreateOrUpdateContent content, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(groupId, nameof(groupId));
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual AsyncPageable<ServiceWorkspaceGroupResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<ApiManagementGroupData, ServiceWorkspaceGroupResource>(new WorkspaceGroupGetByServiceAsyncCollectionResultOfT(
                ...
                skip,
                context,
                "ServiceWorkspaceGroupCollection.GetAll"), data => new ServiceWorkspaceGroupResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ServiceWorkspaceGroupResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ServiceWorkspaceGroupResource> GetAll(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
