...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class PolicyFragmentContractCollection : ArmCollection, IEnumerable<PolicyFragmentContractResource>, IAsyncEnumerable<PolicyFragmentContractResource>
    {
        ...
        public virtual async Task<ArmOperation<PolicyFragmentContractResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string id, PolicyFragmentContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="id"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="id"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<PolicyFragmentContractResource> CreateOrUpdate(WaitUntil waitUntil, string id, PolicyFragmentContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(id, nameof(id));
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <exception cref="ArgumentException"> <paramref name="id"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response<PolicyFragmentContractResource>> GetAsync(string id, PolicyFragmentContentFormat? format = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(id, nameof(id));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="id"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="id"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<PolicyFragmentContractResource> Get(string id, PolicyFragmentContentFormat? format = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(id, nameof(id));
        ...
        public virtual AsyncPageable<PolicyFragmentContractResource> GetAllAsync(string filter = default, string @orderby = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<PolicyFragmentContractData, PolicyFragmentContractResource>(new PolicyFragmentGetByServiceAsyncCollectionResultOfT(
                ...
                skip,
                context,
                "PolicyFragmentContractCollection.GetAll"), data => new PolicyFragmentContractResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="PolicyFragmentContractResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<PolicyFragmentContractResource> GetAll(string filter = default, string @orderby = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="id"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="id"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<NullableResponse<PolicyFragmentContractResource>> GetIfExistsAsync(string id, PolicyFragmentContentFormat? format = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(id, nameof(id));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="id"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="id"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual NullableResponse<PolicyFragmentContractResource> GetIfExists(string id, PolicyFragmentContentFormat? format = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(id, nameof(id));
