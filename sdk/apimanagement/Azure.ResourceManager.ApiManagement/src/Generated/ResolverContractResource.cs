...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ResolverContractResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ApiResource"/> using the GetResolverContracts method.
    /// </summary>
    public partial class ResolverContractResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ResolverContractResource for mocking. </summary>
        protected ResolverContractResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ResolverContractResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}/resolvers/{resolverId}";
        ...
        {
            using DiagnosticScope scope = _graphQLApiResolverClientDiagnostics.CreateScope("ResolverContractResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _graphQLApiResolverRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ResolverContracts_Update. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-09-01-preview. </description>
        ...
        public virtual async Task<Response<ResolverContractResource>> UpdateAsync(string ifMatch, ResolverContractPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(patch, nameof(patch));

            using DiagnosticScope scope = _graphQLApiResolverClientDiagnostics.CreateScope("ResolverContractResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _graphQLApiResolverRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ifMatch, ResolverContractPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ResolverContractData> response = Response.FromValue(ResolverContractData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="ifMatch"/> or <paramref name="patch"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="ifMatch"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<ResolverContractResource> Update(string ifMatch, ResolverContractPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(patch, nameof(patch));
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> ResolverContracts_Delete. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-09-01-preview. </description>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _graphQLApiResolverClientDiagnostics.CreateScope("ResolverContractResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _graphQLApiResolverRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ifMatch, context);
        ...
        public virtual async Task<ArmOperation<ResolverContractResource>> UpdateAsync(WaitUntil waitUntil, ResolverContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _graphQLApiResolverRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ResolverContractData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ResolverContractData> response = Response.FromValue(ResolverContractData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ResolverContractResource> Update(WaitUntil waitUntil, ResolverContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
