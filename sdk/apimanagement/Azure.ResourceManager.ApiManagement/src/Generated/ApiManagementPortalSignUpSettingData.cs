...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementPortalSignUpSettingData : ResourceData
    {
        ...
        internal ApiManagementPortalSignUpSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PortalSignupSettingsProperties properties) : base(id, name, resourceType, systemData)
        {
