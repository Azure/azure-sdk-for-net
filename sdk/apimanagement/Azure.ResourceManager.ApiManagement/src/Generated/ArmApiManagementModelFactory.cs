...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public static partial class ArmApiManagementModelFactory
    {
        ...
        {
            return new ApiManagementBackendData(id, name, resourceType, systemData, title, description, resourceUri, backendServiceFabricCluster != null ? new BackendProperties(backendServiceFabricCluster, new Dictionary<string, BinaryData>()) : null, credentials, proxy, tls, uri, protocol, serializedAdditionalRawData: null);
        }
        ...
        {
            return new ConnectivityCheckContent(source, destination, preferredIPVersion, protocol, protocolHttpConfiguration != null ? new ConnectivityCheckRequestProtocolConfiguration(protocolHttpConfiguration, new Dictionary<string, BinaryData>()) : null, serializedAdditionalRawData: null);
        }
        ...
        {
            return new AvailableApiManagementServiceSkuResult(resourceType, skuName != null ? new ResourceSku(skuName, new Dictionary<string, BinaryData>()) : null, capacity, serializedAdditionalRawData: null);
        }
