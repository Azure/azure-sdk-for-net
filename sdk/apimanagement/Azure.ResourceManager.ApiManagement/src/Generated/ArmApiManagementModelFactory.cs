...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public static partial class ArmApiManagementModelFactory
    {
        ...
        public static ApiData ApiData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, AuthenticationSettingsContract authenticationSettings = null, SubscriptionKeyParameterNamesContract subscriptionKeyParameterNames = null, ApiType? apiType = null, string apiRevision = null, string apiVersion = null, bool? isCurrent = null, bool? isOnline = null, string apiRevisionDescription = null, string apiVersionDescription = null, ResourceIdentifier apiVersionSetId = null, bool? isSubscriptionRequired = null, Uri termsOfServiceUri = null, ApiContactInformation contact = null, ApiLicenseInformation license = null, ResourceIdentifier sourceApiId = null, string displayName = null, Uri serviceUri = null, string path = null, IEnumerable<ApiOperationInvokableProtocol> protocols = null, ApiVersionSetContractDetails apiVersionSet = null)
        {
            ...
            return new ApiData(id, name, resourceType, systemData, description, authenticationSettings, subscriptionKeyParameterNames, apiType, apiRevision, apiVersion, isCurrent, isOnline, apiRevisionDescription, apiVersionDescription, apiVersionSetId, isSubscriptionRequired, termsOfServiceUri, contact, license, sourceApiId, displayName, serviceUri, path, protocols?.ToList(), apiVersionSet, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiEntityBaseContract(description, authenticationSettings, subscriptionKeyParameterNames, apiType, apiRevision, apiVersion, isCurrent, isOnline, apiRevisionDescription, apiVersionDescription, apiVersionSetId, isSubscriptionRequired, termsOfServiceUri, contact, license, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiCreateOrUpdateContent ApiCreateOrUpdateContent(string description = null, AuthenticationSettingsContract authenticationSettings = null, SubscriptionKeyParameterNamesContract subscriptionKeyParameterNames = null, ApiType? apiType = null, string apiRevision = null, string apiVersion = null, bool? isCurrent = null, bool? isOnline = null, string apiRevisionDescription = null, string apiVersionDescription = null, ResourceIdentifier apiVersionSetId = null, bool? isSubscriptionRequired = null, Uri termsOfServiceUri = null, ApiContactInformation contact = null, ApiLicenseInformation license = null, ResourceIdentifier sourceApiId = null, string displayName = null, Uri serviceUri = null, string path = null, IEnumerable<ApiOperationInvokableProtocol> protocols = null, ApiVersionSetContractDetails apiVersionSet = null, string value = null, ContentFormat? format = null, ApiCreateOrUpdatePropertiesWsdlSelector wsdlSelector = null, SoapApiType? soapApiType = null)
        {
            ...
            return new ApiCreateOrUpdateContent(description, authenticationSettings, subscriptionKeyParameterNames, apiType, apiRevision, apiVersion, isCurrent, isOnline, apiRevisionDescription, apiVersionDescription, apiVersionSetId, isSubscriptionRequired, termsOfServiceUri, contact, license, sourceApiId, displayName, serviceUri, path, protocols?.ToList(), apiVersionSet, value, format, wsdlSelector, soapApiType, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiPatch ApiPatch(string description = null, AuthenticationSettingsContract authenticationSettings = null, SubscriptionKeyParameterNamesContract subscriptionKeyParameterNames = null, ApiType? apiType = null, string apiRevision = null, string apiVersion = null, bool? isCurrent = null, bool? isOnline = null, string apiRevisionDescription = null, string apiVersionDescription = null, ResourceIdentifier apiVersionSetId = null, bool? isSubscriptionRequired = null, Uri termsOfServiceUri = null, ApiContactInformation contact = null, ApiLicenseInformation license = null, string displayName = null, Uri serviceUri = null, string path = null, IEnumerable<ApiOperationInvokableProtocol> protocols = null)
        {
            ...
            return new ApiPatch(description, authenticationSettings, subscriptionKeyParameterNames, apiType, apiRevision, apiVersion, isCurrent, isOnline, apiRevisionDescription, apiVersionDescription, apiVersionSetId, isSubscriptionRequired, termsOfServiceUri, contact, license, displayName, serviceUri, path, protocols?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiRevisionContract(apiId, apiRevision, createdOn, updatedOn, description, privateUriString, isOnline, isCurrent, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiReleaseData(id, name, resourceType, systemData, apiId, createdOn, updatedOn, notes, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiOperationData ApiOperationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<ParameterContract> templateParameters = null, string description = null, RequestContract request = null, IEnumerable<ResponseContract> responses = null, string policies = null, string displayName = null, string method = null, string uriTemplate = null)
        {
            ...
            return new ApiOperationData(id, name, resourceType, systemData, templateParameters?.ToList(), description, request, responses?.ToList(), policies, displayName, method, uriTemplate, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PolicyContractData(id, name, resourceType, systemData, value, format, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TagContractData(id, name, resourceType, systemData, displayName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementProductData(id, name, resourceType, systemData, description, terms, isSubscriptionRequired, isApprovalRequired, subscriptionsLimit, state, displayName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProductEntityBaseProperties(description, terms, isSubscriptionRequired, isApprovalRequired, subscriptionsLimit, state, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiSchemaData(id, name, resourceType, systemData, contentType, value, definitions, components, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DiagnosticContractData(id, name, resourceType, systemData, alwaysLog, loggerId, sampling, frontend, backend, isLogClientIPEnabled, httpCorrelationProtocol, verbosity, operationNameFormat, metrics, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new IssueContractData(id, name, resourceType, systemData, createdOn, state, apiId, title, description, userId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiIssueCommentData(id, name, resourceType, systemData, text, createdOn, userId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiIssueAttachmentData(id, name, resourceType, systemData, title, contentFormat, content, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiTagDescriptionData(id, name, resourceType, systemData, description, externalDocsUri, externalDocsDescription, tagId, displayName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TagResourceContractDetails(tag, api, operation, product, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AssociatedTagProperties(id, name, new Dictionary<string, BinaryData>());
        }
        ...
        public static AssociatedApiProperties AssociatedApiProperties(string description = null, AuthenticationSettingsContract authenticationSettings = null, SubscriptionKeyParameterNamesContract subscriptionKeyParameterNames = null, ApiType? apiType = null, string apiRevision = null, string apiVersion = null, bool? isCurrent = null, bool? isOnline = null, string apiRevisionDescription = null, string apiVersionDescription = null, ResourceIdentifier apiVersionSetId = null, bool? isSubscriptionRequired = null, Uri termsOfServiceUri = null, ApiContactInformation contact = null, ApiLicenseInformation license = null, string id = null, string name = null, Uri serviceUri = null, string path = null, IEnumerable<ApiOperationInvokableProtocol> protocols = null)
        {
            ...
            return new AssociatedApiProperties(description, authenticationSettings, subscriptionKeyParameterNames, apiType, apiRevision, apiVersion, isCurrent, isOnline, apiRevisionDescription, apiVersionDescription, apiVersionSetId, isSubscriptionRequired, termsOfServiceUri, contact, license, new Dictionary<string, BinaryData>(), id, name, serviceUri, path, protocols?.ToList());
        }
        ...
        {
            return new AssociatedOperationProperties(id, name, apiName, apiRevision, apiVersion, description, method, uriTemplate, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AssociatedProductProperties(description, terms, isSubscriptionRequired, isApprovalRequired, subscriptionsLimit, state, new Dictionary<string, BinaryData>(), id, name);
        }
        ...
        {
            return new ApiVersionSetData(id, name, resourceType, systemData, description, versionQueryName, versionHeaderName, displayName, versioningScheme, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AuthorizationServerSecretsContract(clientSecret, resourceOwnerUsername, resourceOwnerPassword, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementBackendData(id, name, resourceType, systemData, title, description, resourceUri, backendServiceFabricCluster != null ? new BackendProperties(backendServiceFabricCluster, new Dictionary<string, BinaryData>()) : null, credentials, proxy, tls, uri, protocol, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BackendReconnectContract(id, name, resourceType, systemData, after, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementCacheData(id, name, resourceType, systemData, description, connectionString, useFromLocation, resourceUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementCertificateData(id, name, resourceType, systemData, subject, thumbprint, expireOn, keyVaultDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ConnectivityCheckContent(source, destination, preferredIPVersion, protocol, protocolHttpConfiguration != null ? new ConnectivityCheckRequestProtocolConfiguration(protocolHttpConfiguration, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ConnectivityCheckRequestSource(region, instance, new Dictionary<string, BinaryData>());
        }
        ...
        public static ConnectivityCheckResult ConnectivityCheckResult(IEnumerable<ConnectivityHop> hops = null, ConnectionStatus? connectionStatus = null, long? avgLatencyInMs = null, long? minLatencyInMs = null, long? maxLatencyInMs = null, long? probesSent = null, long? probesFailed = null)
        {
            ...
            return new ConnectivityCheckResult(hops?.ToList(), connectionStatus, avgLatencyInMs, minLatencyInMs, maxLatencyInMs, probesSent, probesFailed, new Dictionary<string, BinaryData>());
        }
        ...
        public static ConnectivityHop ConnectivityHop(string connectivityHopType = null, string id = null, IPAddress address = null, ResourceIdentifier resourceId = null, IEnumerable<string> nextHopIds = null, IEnumerable<ConnectivityIssue> issues = null)
        {
            ...
            return new ConnectivityHop(connectivityHopType, id, address, resourceId, nextHopIds?.ToList(), issues?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ConnectivityIssue ConnectivityIssue(IssueOrigin? origin = null, IssueSeverity? severity = null, IssueType? issueType = null, IEnumerable<IDictionary<string, string>> context = null)
        {
            ...
            return new ConnectivityIssue(origin, severity, issueType, context?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementDeletedServiceData(id, name, resourceType, systemData, location, serviceId, scheduledPurgeOn, deletedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AvailableApiManagementServiceSkuResult(resourceType, skuName != null ? new ResourceSku(skuName, new Dictionary<string, BinaryData>()) : null, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementResourceSkuCapacity(minimum, maximum, @default, scaleType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementServiceBackupRestoreContent(storageAccount, containerName, backupName, accessType, accessKey, clientId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VirtualNetworkConfiguration(vnetId, subnetname, subnetResourceId, new Dictionary<string, BinaryData>());
        }
        ...
        public static AdditionalLocation AdditionalLocation(AzureLocation location = default, ApiManagementServiceSkuProperties sku = null, IEnumerable<string> zones = null, IEnumerable<IPAddress> publicIPAddresses = null, IEnumerable<IPAddress> privateIPAddresses = null, ResourceIdentifier publicIPAddressId = null, VirtualNetworkConfiguration virtualNetworkConfiguration = null, Uri gatewayRegionalUri = null, bool? disableGateway = null, PlatformVersion? platformVersion = null)
        {
            ...
            return new AdditionalLocation(location, sku, zones?.ToList(), publicIPAddresses?.ToList(), privateIPAddresses?.ToList(), publicIPAddressId, virtualNetworkConfiguration, gatewayRegionalUri, disableGateway, platformVersion, new Dictionary<string, BinaryData>());
        }
        ...
        public static RemotePrivateEndpointConnectionWrapper RemotePrivateEndpointConnectionWrapper(ResourceIdentifier id = null, string name = null, ResourceType? resourceType = null, ResourceIdentifier privateEndpointId = null, ApiManagementPrivateLinkServiceConnectionState privateLinkServiceConnectionState = null, string provisioningState = null, IEnumerable<string> groupIds = null)
        {
            ...
            return new RemotePrivateEndpointConnectionWrapper(id, name, resourceType, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, privateLinkServiceConnectionState, provisioningState, groupIds?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementServiceGetSsoTokenResult(redirectUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementServiceNameAvailabilityResult(isNameAvailable, message, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementServiceGetDomainOwnershipIdentifierResult(domainOwnershipIdentifier, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementEmailTemplateData ApiManagementEmailTemplateData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string subject = null, string body = null, string title = null, string description = null, bool? isDefault = null, IEnumerable<EmailTemplateParametersContractProperties> parameters = null)
        {
            ...
            return new ApiManagementEmailTemplateData(id, name, resourceType, systemData, subject, body, title, description, isDefault, parameters?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayData(id, name, resourceType, systemData, locationData, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GatewayKeysContract(primary, secondary, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GatewayTokenContract(value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayHostnameConfigurationData(id, name, resourceType, systemData, hostname, certificateId, isClientCertificateRequired, isTls10Enabled, isTls11Enabled, isHttp20Enabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AssociationContract(id, name, resourceType, systemData, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGatewayCertificateAuthorityData(id, name, resourceType, systemData, isTrusted, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGroupData(id, name, resourceType, systemData, displayName, description, isBuiltIn, groupType, externalId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GroupContractProperties(displayName, description, isBuiltIn, apiManagementGroupType, externalId, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementGroupUserData ApiManagementGroupUserData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ApiManagementUserState? state = null, string note = null, IEnumerable<UserIdentityContract> identities = null, string firstName = null, string lastName = null, string email = null, DateTimeOffset? registriesOn = null, IEnumerable<GroupContractProperties> groups = null)
        {
            ...
            return new ApiManagementGroupUserData(id, name, resourceType, systemData, state, note, identities?.ToList(), firstName, lastName, email, registriesOn, groups?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static UserContractData UserContractData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ApiManagementUserState? state = null, string note = null, IEnumerable<UserIdentityContract> identities = null, string firstName = null, string lastName = null, string email = null, DateTimeOffset? registriesOn = null, IEnumerable<GroupContractProperties> groups = null)
        {
            ...
            return new UserContractData(id, name, resourceType, systemData, state, note, identities?.ToList(), firstName, lastName, email, registriesOn, groups?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementIdentityProviderData ApiManagementIdentityProviderData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IdentityProviderType? identityProviderType = null, string signInTenant = null, IEnumerable<string> allowedTenants = null, string authority = null, string signUpPolicyName = null, string signInPolicyName = null, string profileEditingPolicyName = null, string passwordResetPolicyName = null, string clientId = null, string clientSecret = null)
        {
            ...
            return new ApiManagementIdentityProviderData(id, name, resourceType, systemData, identityProviderType, signInTenant, allowedTenants?.ToList(), authority, signUpPolicyName, signInPolicyName, profileEditingPolicyName, passwordResetPolicyName, clientId, clientSecret, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementIdentityProviderCreateOrUpdateContent ApiManagementIdentityProviderCreateOrUpdateContent(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IdentityProviderType? identityProviderType = null, string signInTenant = null, IEnumerable<string> allowedTenants = null, string authority = null, string signUpPolicyName = null, string signInPolicyName = null, string profileEditingPolicyName = null, string passwordResetPolicyName = null, string clientId = null, string clientSecret = null)
        {
            ...
            return new ApiManagementIdentityProviderCreateOrUpdateContent(id, name, resourceType, systemData, identityProviderType, signInTenant, allowedTenants?.ToList(), authority, signUpPolicyName, signInPolicyName, profileEditingPolicyName, passwordResetPolicyName, clientId, clientSecret, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ClientSecretContract(clientSecret, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementLoggerData ApiManagementLoggerData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, LoggerType? loggerType = null, string description = null, IDictionary<string, string> credentials = null, bool? isBuffered = null, ResourceIdentifier resourceId = null)
        {
            ...
            return new ApiManagementLoggerData(id, name, resourceType, systemData, loggerType, description, credentials, isBuffered, resourceId, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementNamedValueData ApiManagementNamedValueData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<string> tags = null, bool? isSecret = null, string displayName = null, string value = null, KeyVaultContractProperties keyVaultDetails = null)
        {
            ...
            return new ApiManagementNamedValueData(id, name, resourceType, systemData, tags?.ToList(), isSecret, displayName, value, keyVaultDetails, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementNamedValueCreateOrUpdateContent ApiManagementNamedValueCreateOrUpdateContent(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<string> tags = null, bool? isSecret = null, string displayName = null, string value = null, KeyVaultContractCreateProperties keyVault = null)
        {
            ...
            return new ApiManagementNamedValueCreateOrUpdateContent(id, name, resourceType, systemData, tags?.ToList(), isSecret, displayName, value, keyVault, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NamedValueSecretContract(value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NetworkStatusContractWithLocation(location, networkStatus, new Dictionary<string, BinaryData>());
        }
        ...
        public static NetworkStatusContract NetworkStatusContract(IEnumerable<string> dnsServers = null, IEnumerable<ConnectivityStatusContract> connectivityStatus = null)
        {
            ...
            return new NetworkStatusContract(dnsServers?.ToList(), connectivityStatus?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ConnectivityStatusContract(name, status, error, lastUpdatedOn, lastStatusChangedOn, resourceType, isOptional, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementNotificationData(id, name, resourceType, systemData, title, description, recipients, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecipientUserContract(id, name, resourceType, systemData, userId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecipientEmailContract(id, name, resourceType, systemData, email, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementOpenIdConnectProviderData(id, name, resourceType, systemData, displayName, description, metadataEndpoint, clientId, clientSecret, new Dictionary<string, BinaryData>());
        }
        ...
        public static EndpointDependency EndpointDependency(string domainName = null, IEnumerable<EndpointDetail> endpointDetails = null)
        {
            ...
            return new EndpointDependency(domainName, endpointDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EndpointDetail(port, region, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PolicyDescriptionContractData(id, name, resourceType, systemData, description, scope, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementPortalRevisionData(id, name, resourceType, systemData, description, statusDetails, status, isCurrent, createdOn, updatedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PortalSettingsContractData(id, name, resourceType, systemData, uri, validationKey, isSubscriptionDelegationEnabled != null ? new SubscriptionDelegationSettingProperties(isSubscriptionDelegationEnabled, new Dictionary<string, BinaryData>()) : null, isUserRegistrationDelegationEnabled != null ? new RegistrationDelegationSettingProperties(isUserRegistrationDelegationEnabled, new Dictionary<string, BinaryData>()) : null, isRedirectEnabled, termsOfService, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementPortalSignInSettingData(id, name, resourceType, systemData, isRedirectEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementPortalSignUpSettingData(id, name, resourceType, systemData, isSignUpDeveloperPortalEnabled, termsOfService, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementPortalDelegationSettingData(id, name, resourceType, systemData, uri, validationKey, isSubscriptionDelegationEnabled != null ? new SubscriptionDelegationSettingProperties(isSubscriptionDelegationEnabled, new Dictionary<string, BinaryData>()) : null, isUserRegistrationDelegationEnabled != null ? new RegistrationDelegationSettingProperties(isUserRegistrationDelegationEnabled, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PortalSettingValidationKeyContract(validationKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementPrivateLinkResourceData ApiManagementPrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new ApiManagementPrivateLinkResourceData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ProductGroupData(id, name, resourceType, systemData, displayName, description, isBuiltIn, groupType, externalId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SubscriptionContractData(id, name, resourceType, systemData, ownerId, scope, displayName, state, createdOn, startOn, expireOn, endOn, notifiesOn, primaryKey, secondaryKey, stateComment, allowTracing, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QuotaCounterContract(counterKey, periodKey, periodStartOn, periodEndOn, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QuotaCounterValueContractProperties(callsCount, kbTransferred, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RegionContract(name, isMasterRegion, isDeleted, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RequestReportRecordContract(apiId, operationId, productId, userId, method, uri, ipAddress, backendResponseCode, responseCode, responseSize, timestamp, cache, apiTime, serviceTime, apiRegion, subscriptionResourceId, requestId, requestSize, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementGlobalSchemaData(id, name, resourceType, systemData, schemaType, description, value, document, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementTenantSettingData ApiManagementTenantSettingData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> settings = null)
        {
            ...
            return new ApiManagementTenantSettingData(id, name, resourceType, systemData, settings, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementSku ApiManagementSku(string resourceType = null, string name = null, string tier = null, string size = null, string family = null, string kind = null, ApiManagementSkuCapacity capacity = null, IEnumerable<AzureLocation> locations = null, IEnumerable<ApiManagementSkuLocationInfo> locationInfo = null, IEnumerable<string> apiVersions = null, IEnumerable<ApiManagementSkuCosts> costs = null, IEnumerable<ApiManagementSkuCapabilities> capabilities = null, IEnumerable<ApiManagementSkuRestrictions> restrictions = null)
        {
            ...
            return new ApiManagementSku(resourceType, name, tier, size, family, kind, capacity, locations?.ToList(), locationInfo?.ToList(), apiVersions?.ToList(), costs?.ToList(), capabilities?.ToList(), restrictions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementSkuCapacity(minimum, maximum, @default, scaleType, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementSkuLocationInfo ApiManagementSkuLocationInfo(AzureLocation? location = null, IEnumerable<string> zones = null, IEnumerable<ApiManagementSkuZoneDetails> zoneDetails = null)
        {
            ...
            return new ApiManagementSkuLocationInfo(location, zones?.ToList(), zoneDetails?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementSkuZoneDetails ApiManagementSkuZoneDetails(IEnumerable<string> name = null, IEnumerable<ApiManagementSkuCapabilities> capabilities = null)
        {
            ...
            return new ApiManagementSkuZoneDetails(name?.ToList(), capabilities?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementSkuCapabilities(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ApiManagementSkuCosts(meterId, quantity, extendedUnit, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementSkuRestrictions ApiManagementSkuRestrictions(ApiManagementSkuRestrictionsType? restrictionsType = null, IEnumerable<string> values = null, ApiManagementSkuRestrictionInfo restrictionInfo = null, ApiManagementSkuRestrictionsReasonCode? reasonCode = null)
        {
            ...
            return new ApiManagementSkuRestrictions(restrictionsType, values?.ToList(), restrictionInfo, reasonCode, new Dictionary<string, BinaryData>());
        }
        ...
        public static ApiManagementSkuRestrictionInfo ApiManagementSkuRestrictionInfo(IEnumerable<AzureLocation> locations = null, IEnumerable<string> zones = null)
        {
            ...
            return new ApiManagementSkuRestrictionInfo(locations?.ToList(), zones?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SubscriptionKeysContract(primaryKey, secondaryKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TenantAccessInfoData(id, name, resourceType, systemData, accessInfoType, principalId, isDirectAccessEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TenantAccessInfoSecretsDetails(accessInfoType, principalId, primaryKey, secondaryKey, isDirectAccessEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        public static GitOperationResultContractData GitOperationResultContractData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string operationResultIdentifier = null, AsyncOperationStatus? status = null, DateTimeOffset? startedOn = null, DateTimeOffset? updatedOn = null, string resultInfo = null, ErrorResponseBody error = null, IEnumerable<OperationResultLogItemContract> actionLog = null)
        {
            ...
            return new GitOperationResultContractData(id, name, resourceType, systemData, operationResultIdentifier, status, startedOn, updatedOn, resultInfo, error, actionLog?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new OperationResultLogItemContract(objectType, action, objectKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TenantConfigurationSyncStateContract(id, name, resourceType, systemData, branch, commitId, isExported, isSynced, isGitEnabled, syncOn, configurationChangeOn, lastOperationId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GenerateSsoUriResult(value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UserTokenResult(value, new Dictionary<string, BinaryData>());
        }
    }
}
