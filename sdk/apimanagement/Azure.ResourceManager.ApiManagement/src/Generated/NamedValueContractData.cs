...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class NamedValueContractData : Resource
    {
        ...
        internal NamedValueContractData(ResourceIdentifier id, string name, ResourceType type, IList<string> tags, bool? secret, string displayName, string value, KeyVaultContractProperties keyVault) : base(id, name, type)
        {
            Tags = tags;
            Secret = secret;
