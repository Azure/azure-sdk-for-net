...
{
    /// <summary> A class representing the NamedValueContract data model. </summary>
    public partial class NamedValueContractData : ResourceData
    {
        /// <summary> Initializes a new instance of NamedValueContractData. </summary>
        ...
        internal NamedValueContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<string> tags, bool? secret, string displayName, string value, KeyVaultContractProperties keyVault) : base(id, name, resourceType, systemData)
        {
            Tags = tags;
            Secret = secret;
