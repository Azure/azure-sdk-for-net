...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ProductContractData : Resource
    {
        ...
        internal ProductContractData(ResourceIdentifier id, string name, ResourceType type, string description, string terms, bool? subscriptionRequired, bool? approvalRequired, int? subscriptionsLimit, ProductState? state, string displayName) : base(id, name, type)
        {
