...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementDiagnosticResource : ArmResource
    {
        ...
        internal ApiManagementDiagnosticResource(ArmClient client, ApiManagementDiagnosticData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ApiManagementDiagnosticResource>> UpdateAsync(string ifMatch, ApiManagementDiagnosticData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="ifMatch"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="ifMatch"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<ApiManagementDiagnosticResource> Update(string ifMatch, ApiManagementDiagnosticData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(data, nameof(data));
