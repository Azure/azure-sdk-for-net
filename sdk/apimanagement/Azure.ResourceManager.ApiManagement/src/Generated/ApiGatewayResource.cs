...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="SubscriptionResource"/> using the GetApiGateways method.
    /// </summary>
    public partial class ApiGatewayResource : ArmResource
    {
        ...
        internal ApiGatewayResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _gatewayApiRestClient = new GatewayApi(_gatewayApiClientDiagnostics, Pipeline, Endpoint, apiGatewayApiVersion ?? "2025-09-01-preview");
            ...
            _gatewayCertificateAuthorityRestClient = new GatewayCertificateAuthority(_gatewayCertificateAuthorityClientDiagnostics, Pipeline, Endpoint, apiGatewayApiVersion ?? "2025-09-01-preview");
            ...
            _gatewayHostnameConfigurationRestClient = new GatewayHostnameConfiguration(_gatewayHostnameConfigurationClientDiagnostics, Pipeline, Endpoint, apiGatewayApiVersion ?? "2025-09-01-preview");
        ...
        public virtual async Task<Response<ApiGatewayResource>> UpdateAsync(ETag ifMatch, ApiGatewayData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual Response<ApiGatewayResource> Update(ETag ifMatch, ApiGatewayData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<ApiData> GetByServiceAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            ...
            return new GatewayApiGetByServiceAsyncCollectionResultOfT(
                ...
                skip,
                context,
                "ApiGatewayResource.GetByService");
        }
