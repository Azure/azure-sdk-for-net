...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class AccessInformationContractData : Resource
    {
        ...
        internal AccessInformationContractData(ResourceIdentifier id, string name, ResourceType type, string idPropertiesId, string principalId, bool? enabled) : base(id, name, type)
        {
