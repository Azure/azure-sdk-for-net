...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementProductTagResource : TagContractResource
    {
        ...
        {
            using var scope = _apiManagementProductTagTagClientDiagnostics.CreateScope("ApiManagementProductTagResource.GetCore");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new async Task<Response<ApiManagementProductTagResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new Response<ApiManagementProductTagResource> Get(CancellationToken cancellationToken = default)
        {
