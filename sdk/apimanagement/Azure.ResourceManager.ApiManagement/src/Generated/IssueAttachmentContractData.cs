...
{
    /// <summary> A class representing the IssueAttachmentContract data model. </summary>
    public partial class IssueAttachmentContractData : ResourceData
    {
        /// <summary> Initializes a new instance of IssueAttachmentContractData. </summary>
        ...
        internal IssueAttachmentContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string title, string contentFormat, string content) : base(id, name, resourceType, systemData)
        {
            Title = title;
