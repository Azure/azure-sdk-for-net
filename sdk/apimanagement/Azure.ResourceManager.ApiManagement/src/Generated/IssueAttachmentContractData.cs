...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class IssueAttachmentContractData : Resource
    {
        ...
        internal IssueAttachmentContractData(ResourceIdentifier id, string name, ResourceType type, string title, string contentFormat, string content) : base(id, name, type)
        {
            Title = title;
