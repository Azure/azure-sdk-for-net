...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class PortalConfigContractResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the PortalConfigContract.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/portalconfigs/{portalConfigId}. </description>
        ...
        public virtual async Task<ArmOperation<PortalConfigContractResource>> UpdateAsync(WaitUntil waitUntil, string ifMatch, PortalConfigContractData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _portalConfigRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, PortalConfigContractData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<PortalConfigContractData> response = Response.FromValue(PortalConfigContractData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentException"> <paramref name="ifMatch"/> is an empty string, and was expected to be non-empty. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PortalConfigContractResource> Update(WaitUntil waitUntil, string ifMatch, PortalConfigContractData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(data, nameof(data));
