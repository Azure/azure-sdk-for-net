...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiReleaseContractData : ResourceData
    {
        ...
        internal ApiReleaseContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string apiId, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string notes) : base(id, name, resourceType, systemData)
        {
            ApiId = apiId;
            CreatedOn = createdOn;
            UpdatedOn = updatedOn;
