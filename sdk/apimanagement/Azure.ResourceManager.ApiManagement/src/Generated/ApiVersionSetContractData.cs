...
{
    /// <summary> A class representing the ApiVersionSetContract data model. </summary>
    public partial class ApiVersionSetContractData : ResourceData
    {
        /// <summary> Initializes a new instance of ApiVersionSetContractData. </summary>
        ...
        internal ApiVersionSetContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, string versionQueryName, string versionHeaderName, string displayName, VersioningScheme? versioningScheme) : base(id, name, resourceType, systemData)
        {
