...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiVersionSetContractData : Resource
    {
        ...
        internal ApiVersionSetContractData(ResourceIdentifier id, string name, ResourceType type, string description, string versionQueryName, string versionHeaderName, string displayName, VersioningScheme? versioningScheme) : base(id, name, type)
        {
