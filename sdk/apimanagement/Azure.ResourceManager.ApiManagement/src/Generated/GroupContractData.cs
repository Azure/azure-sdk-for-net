...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class GroupContractData : Resource
    {
        ...
        internal GroupContractData(ResourceIdentifier id, string name, ResourceType type, string displayName, string description, bool? builtIn, GroupType? typePropertiesType, string externalId) : base(id, name, type)
        {
