...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of ToolContractResources in the Api. </summary>
        /// <returns> An object representing collection of ToolContractResources and their operations over a ToolContractResource. </returns>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch, bool? deleteRevisions = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ApiManagementArmOperation(_apiClientDiagnostics, Pipeline, _apiRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, deleteRevisions).Request, response, OperationFinalStateVia.Location);
