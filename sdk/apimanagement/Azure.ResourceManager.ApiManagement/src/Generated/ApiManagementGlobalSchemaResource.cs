    ...
    public partial class ApiManagementGlobalSchemaResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _apiManagementGlobalSchemaGlobalSchemaRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch);
        ...
        public virtual async Task<ArmOperation<ApiManagementGlobalSchemaResource>> UpdateAsync(WaitUntil waitUntil, ApiManagementGlobalSchemaData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ApiManagementGlobalSchemaResource> Update(WaitUntil waitUntil, ApiManagementGlobalSchemaData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
