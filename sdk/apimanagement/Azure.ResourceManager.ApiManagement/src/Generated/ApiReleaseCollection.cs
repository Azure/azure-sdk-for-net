...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiReleaseCollection : ArmCollection, IEnumerable<ApiReleaseResource>, IAsyncEnumerable<ApiReleaseResource>
    {
        ...
        internal ApiReleaseCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _apiReleaseRestClient = new ApiRelease(_apiReleaseClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiReleaseApiVersion ?? "2025-09-01-preview");
        ...
        public virtual async Task<ArmOperation<ApiReleaseResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string releaseId, ApiReleaseData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiReleaseRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, releaseId, ApiReleaseData.ToRequestContent(data), ifMatch, context);
        ...
        public virtual async Task<Response<ApiReleaseResource>> GetAsync(string releaseId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiReleaseRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, releaseId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiReleaseData> response = Response.FromValue(ApiReleaseData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<ApiReleaseResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ApiReleaseData, ApiReleaseResource>(new ApiReleaseGetByServiceAsyncCollectionResultOfT(
                ...
                skip,
                context,
                "ApiReleaseCollection.GetAll"), data => new ApiReleaseResource(Client, data));
        }
