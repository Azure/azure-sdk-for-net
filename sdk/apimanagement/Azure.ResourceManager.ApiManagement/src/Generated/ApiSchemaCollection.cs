    ...
    public partial class ApiSchemaCollection : ArmCollection, IEnumerable<ApiSchemaResource>, IAsyncEnumerable<ApiSchemaResource>
    {
        ...
        public virtual async Task<ArmOperation<ApiSchemaResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string schemaId, ApiSchemaData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiSchemaRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, schemaId, ApiSchemaData.ToRequestContent(data), ifMatch, context);
        ...
        public virtual async Task<Response<ApiSchemaResource>> GetAsync(string schemaId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiSchemaRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, schemaId, context);
        ...
        public virtual AsyncPageable<ApiSchemaResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ApiSchemaData, ApiSchemaResource>(new ApiSchemaGetByApiAsyncCollectionResultOfT(
                ...
                skip,
                context,
                "ApiSchemaCollection.GetAll"), data => new ApiSchemaResource(Client, data));
        }
