...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementPortalRevisionCollection : ArmCollection, IEnumerable<ApiManagementPortalRevisionResource>, IAsyncEnumerable<ApiManagementPortalRevisionResource>
    {
        ...
        internal ApiManagementPortalRevisionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _portalRevisionRestClient = new PortalRevision(_portalRevisionClientDiagnostics, Pipeline, Endpoint, apiManagementPortalRevisionApiVersion ?? "2025-03-01-preview");
        ...
        public virtual async Task<ArmOperation<ApiManagementPortalRevisionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string portalRevisionId, ApiManagementPortalRevisionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _portalRevisionRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, portalRevisionId, ApiManagementPortalRevisionData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<ApiManagementPortalRevisionResource>> GetAsync(string portalRevisionId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _portalRevisionRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, portalRevisionId, context);
        ...
        public virtual AsyncPageable<ApiManagementPortalRevisionResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ApiManagementPortalRevisionData, ApiManagementPortalRevisionResource>(new PortalRevisionGetByServiceAsyncCollectionResultOfT(
                ...
                top,
                skip,
                context), data => new ApiManagementPortalRevisionResource(Client, data));
        }
