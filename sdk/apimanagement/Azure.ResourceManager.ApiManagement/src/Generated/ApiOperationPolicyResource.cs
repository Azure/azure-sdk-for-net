...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// </summary>
    public partial class ApiOperationPolicyResource : PolicyContractResource
    {
        ...
        internal ApiOperationPolicyResource(ArmClient client, PolicyContractData data) : base(client, data)
        {
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual async Task<Response<ApiOperationPolicyResource>> GetAsync(PolicyExportFormat? format = null, CancellationToken cancellationToken = default)
        {
            var value = await GetCoreAsync(format, cancellationToken).ConfigureAwait(false);
            return Response.FromValue((ApiOperationPolicyResource)value.Value, value.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public new virtual Response<ApiOperationPolicyResource> Get(PolicyExportFormat? format = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new virtual async Task<ArmOperation<ApiOperationPolicyResource>> UpdateAsync(WaitUntil waitUntil, PolicyContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            var value = await UpdateCoreAsync(waitUntil, data, ifMatch, cancellationToken).ConfigureAwait(false);
            return new ApiManagementArmOperation<ApiOperationPolicyResource>(Response.FromValue((ApiOperationPolicyResource)value.Value, value.GetRawResponse()));
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [ForwardsClientCalls]
        public new virtual ArmOperation<ApiOperationPolicyResource> Update(WaitUntil waitUntil, PolicyContractData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
