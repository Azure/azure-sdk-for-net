...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class PrivateLinkResourceData : Resource
    {
        ...
        internal PrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType type, string groupId, IReadOnlyList<string> requiredMembers, IList<string> requiredZoneNames) : base(id, name, type)
        {
            GroupId = groupId;
