...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// </summary>
    public partial class ApiManagementTagResource : TagContractResource
    {
        ...
        internal ApiManagementTagResource(ArmClient client, TagContractData data) : base(client, data)
        {
        ...
        protected override async Task<Response<TagContractResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((TagContractResource)new ApiManagementTagResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<ApiManagementTagResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((ApiManagementTagResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<ApiManagementTagResource> Get(CancellationToken cancellationToken = default)
        {
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/tags/{tagId}
        /// Operation Id: Tag_GetEntityState
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
