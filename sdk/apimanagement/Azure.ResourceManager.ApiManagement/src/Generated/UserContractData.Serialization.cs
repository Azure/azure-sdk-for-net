...
{
    public partial class UserContractData : IUtf8JsonSerializable, IJsonModel<UserContractData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserContractData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<UserContractData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static UserContractData DeserializeUserContractData(JsonElement element, ModelReaderWriterOptions options = null)
        {
