...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class CertificateContractData : ResourceData
    {
        ...
        internal CertificateContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string subject, string thumbprint, DateTimeOffset? expirationOn, KeyVaultContractProperties keyVault) : base(id, name, resourceType, systemData)
        {
            Subject = subject;
