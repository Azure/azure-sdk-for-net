...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceProductGroupLinkCollection : ArmCollection, IEnumerable<ServiceProductGroupLinkResource>, IAsyncEnumerable<ServiceProductGroupLinkResource>
    {
        ...
        /// <summary> Initializes a new instance of ServiceProductGroupLinkCollection for mocking. </summary>
        protected ServiceProductGroupLinkCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ServiceProductGroupLinkCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(ServiceProductGroupLinkResource.ResourceType, out string serviceProductGroupLinkApiVersion);
            _productGroupLinkClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ServiceProductGroupLinkResource.ResourceType.Namespace, Diagnostics);
            _productGroupLinkRestClient = new ProductGroupLink(_productGroupLinkClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, serviceProductGroupLinkApiVersion ?? "2025-09-01-preview");
        ...
        public virtual async Task<ArmOperation<ServiceProductGroupLinkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string groupLinkId, ProductGroupLinkContractData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _productGroupLinkClientDiagnostics.CreateScope("ServiceProductGroupLinkCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                ApiManagementArmOperation<ServiceProductGroupLinkResource> operation = new ApiManagementArmOperation<ServiceProductGroupLinkResource>(Response.FromValue(new ServiceProductGroupLinkResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
        ...
        public virtual async Task<Response<ServiceProductGroupLinkResource>> GetAsync(string groupLinkId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _productGroupLinkClientDiagnostics.CreateScope("ServiceProductGroupLinkCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<ServiceProductGroupLinkResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<ProductGroupLinkContractData, ServiceProductGroupLinkResource>(new ProductGroupLinkGetByProductAsyncCollectionResultOfT(
                ...
                skip,
                context,
                "ServiceProductGroupLinkCollection.GetAll"), data => new ServiceProductGroupLinkResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ServiceProductGroupLinkResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ServiceProductGroupLinkResource> GetAll(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string groupLinkId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _productGroupLinkClientDiagnostics.CreateScope("ServiceProductGroupLinkCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ServiceProductGroupLinkResource>> GetIfExistsAsync(string groupLinkId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _productGroupLinkClientDiagnostics.CreateScope("ServiceProductGroupLinkCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
