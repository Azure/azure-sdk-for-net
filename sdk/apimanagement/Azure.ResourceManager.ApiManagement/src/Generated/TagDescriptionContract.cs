...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class TagDescriptionContract : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="TagDescriptionContract"/> class for mocking. </summary>
        protected TagDescriptionContract()
        {
        }

        /// <summary> Initializes a new instance of the <see cref = "TagDescriptionContract"/> class. </summary>
        /// <param name="options"> The client parameters to use in these operations. </param>
        /// <param name="resource"> The resource that is the target of operations. </param>
        internal TagDescriptionContract(ArmResource options, TagDescriptionContractData resource) : base(options, resource.Id)
        {
            HasData = true;
            _data = resource;
        ...
        internal TagDescriptionContract(ArmResource options, ResourceIdentifier id) : base(options, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _apiTagDescriptionRestClient = new ApiTagDescriptionRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        }
        ...
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal TagDescriptionContract(ArmClientOptions clientOptions, TokenCredential credential, Uri uri, HttpPipeline pipeline, ResourceIdentifier id) : base(clientOptions, credential, uri, pipeline, id)
        {
            _clientDiagnostics = new ClientDiagnostics(ClientOptions);
            _apiTagDescriptionRestClient = new ApiTagDescriptionRestOperations(_clientDiagnostics, Pipeline, ClientOptions, BaseUri);
        }
        ...
        public async virtual Task<Response<TagDescriptionContract>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("TagDescriptionContract.Get");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(new TagDescriptionContract(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <summary> Get Tag description in scope of API. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<TagDescriptionContract> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("TagDescriptionContract.Get");
            scope.Start();
            try
        ...
        public async virtual Task<ApiTagDescriptionDeleteOperation> DeleteAsync(string ifMatch, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (ifMatch == null)
            {
            ...
            using var scope = _clientDiagnostics.CreateScope("TagDescriptionContract.Delete");
            scope.Start();
            try
            {
                ...
                var operation = new ApiTagDescriptionDeleteOperation(response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ifMatch"/> is null. </exception>
        public virtual ApiTagDescriptionDeleteOperation Delete(string ifMatch, bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            if (ifMatch == null)
            {
                throw new ArgumentNullException(nameof(ifMatch));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("TagDescriptionContract.GetEntityTag");
            scope.Start();
            try
            {
