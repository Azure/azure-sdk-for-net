...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementEmailTemplateData : ResourceData
    {
        ...
        internal ApiManagementEmailTemplateData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string subject, string body, string title, string description, bool? isDefault, IList<EmailTemplateParametersContractProperties> parameters, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Subject = subject;
            Body = body;
            Title = title;
