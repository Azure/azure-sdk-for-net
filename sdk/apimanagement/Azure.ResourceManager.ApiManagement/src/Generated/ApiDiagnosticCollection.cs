...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiDiagnosticCollection : ArmCollection, IEnumerable<ApiDiagnosticResource>, IAsyncEnumerable<ApiDiagnosticResource>
    {
        ...
        public virtual AsyncPageable<ApiDiagnosticResource> GetAllAsync(ApiDiagnosticCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new ApiDiagnosticCollectionGetAllOptions();
            ...
            async Task<Page<ApiDiagnosticResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _apiDiagnosticRestClient.ListByServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<ApiDiagnosticResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _apiDiagnosticRestClient.ListByServiceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiDiagnosticResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<ApiDiagnosticResource> GetAll(ApiDiagnosticCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new ApiDiagnosticCollectionGetAllOptions();
            ...
            Page<ApiDiagnosticResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiDiagnosticRestClient.ListByService(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiDiagnosticResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<ApiDiagnosticResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiDiagnosticRestClient.ListByServiceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiDiagnosticResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
