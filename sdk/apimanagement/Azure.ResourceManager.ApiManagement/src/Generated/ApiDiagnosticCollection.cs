...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiDiagnosticCollection : ArmCollection, IEnumerable<ApiDiagnosticResource>, IAsyncEnumerable<ApiDiagnosticResource>
    {
        ...
        internal ApiDiagnosticCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _apiDiagnosticRestClient = new ApiDiagnostic(_apiDiagnosticClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiDiagnosticApiVersion ?? "2025-09-01-preview");
        ...
        public virtual async Task<ArmOperation<ApiDiagnosticResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string diagnosticId, DiagnosticContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiDiagnosticRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, diagnosticId, DiagnosticContractData.ToRequestContent(data), ifMatch, context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="diagnosticId"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="diagnosticId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ApiDiagnosticResource> CreateOrUpdate(WaitUntil waitUntil, string diagnosticId, DiagnosticContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(diagnosticId, nameof(diagnosticId));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<ApiDiagnosticResource>> GetAsync(string diagnosticId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiDiagnosticRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, diagnosticId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DiagnosticContractData> response = Response.FromValue(DiagnosticContractData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<ApiDiagnosticResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DiagnosticContractData, ApiDiagnosticResource>(new ApiDiagnosticGetByServiceAsyncCollectionResultOfT(
                ...
                skip,
                context,
                "ApiDiagnosticCollection.GetAll"), data => new ApiDiagnosticResource(Client, data));
        }
        ...
        public virtual Pageable<ApiDiagnosticResource> GetAll(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<DiagnosticContractData, ApiDiagnosticResource>(new ApiDiagnosticGetByServiceCollectionResultOfT(
                _apiDiagnosticRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Name,
