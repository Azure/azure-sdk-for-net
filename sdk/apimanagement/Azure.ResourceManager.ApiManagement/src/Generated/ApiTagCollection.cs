...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiTagCollection : ArmCollection, IEnumerable<ApiTagResource>, IAsyncEnumerable<ApiTagResource>
    {
        ...
        internal ApiTagCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _apiTagRestClient = new ApiTag(_apiTagClientDiagnostics, Pipeline, Endpoint, apiTagApiVersion ?? "2025-03-01-preview");
        ...
        public virtual async Task<ArmOperation<ApiTagResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string tagId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiTagRestClient.CreateAssignToApiRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, tagId, context);
        ...
        public virtual async Task<Response<ApiTagResource>> GetAsync(string tagId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiTagRestClient.CreateGetByApiRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, tagId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<TagContractData> response = Response.FromValue(TagContractData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<ApiTagResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<TagContractData, ApiTagResource>(new ApiTagGetByApiAsyncCollectionResultOfT(
                ...
                top,
                skip,
                context), data => new ApiTagResource(Client, data));
        }
