...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// </summary>
    public partial class ApiOperationTagResource : TagContractResource
    {
        ...
        internal ApiOperationTagResource(ArmClient client, TagContractData data) : base(client, data)
        {
        ...
        protected override async Task<Response<TagContractResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((TagContractResource)new ApiOperationTagResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<ApiOperationTagResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((ApiOperationTagResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<ApiOperationTagResource> Get(CancellationToken cancellationToken = default)
        {
