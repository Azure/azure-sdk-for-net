...
{
    /// <summary>
    /// A class representing a ApiManagementGroup along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ApiManagementGroupResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ApiManagementServiceResource"/> using the GetApiManagementGroups method.
    /// </summary>
    public partial class ApiManagementGroupResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ApiManagementGroupResource for mocking. </summary>
        protected ApiManagementGroupResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ApiManagementGroupResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string apiManagementGroupApiVersion);
            ...
            _groupUserRestClient = new GroupUser(_groupUserClientDiagnostics, Pipeline, Endpoint, apiManagementGroupApiVersion ?? "2025-09-01-preview");
            ...
            _workspaceGroupUserRestClient = new WorkspaceGroupUser(_workspaceGroupUserClientDiagnostics, Pipeline, Endpoint, apiManagementGroupApiVersion ?? "2025-09-01-preview");
        ...
        {
            using DiagnosticScope scope = _groupClientDiagnostics.CreateScope("ApiManagementGroupResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _groupRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<Response<ApiManagementGroupResource>> UpdateAsync(string ifMatch, GroupPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(patch, nameof(patch));

            using DiagnosticScope scope = _groupClientDiagnostics.CreateScope("ApiManagementGroupResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _groupRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, GroupPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiManagementGroupData> response = Response.FromValue(ApiManagementGroupData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="ifMatch"/> or <paramref name="patch"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="ifMatch"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<ApiManagementGroupResource> Update(string ifMatch, GroupPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(patch, nameof(patch));
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _groupClientDiagnostics.CreateScope("ApiManagementGroupResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _groupRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, context);
        ...
        public virtual async Task<Response> CheckEntityExistsAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _groupUserClientDiagnostics.CreateScope("ApiManagementGroupResource.CheckEntityExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _groupUserRestClient.CreateCheckEntityExistsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, userId, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<ApiManagementUserResource>> CreateAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _groupUserClientDiagnostics.CreateScope("ApiManagementGroupResource.Create");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _groupUserRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, userId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response> DeleteAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _groupUserClientDiagnostics.CreateScope("ApiManagementGroupResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _groupUserRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, userId, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// <param name="userId"> User identifier. Must be unique in the current API Management service instance. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="workspaceId"/>, <paramref name="groupId"/> or <paramref name="userId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="workspaceId"/>, <paramref name="groupId"/> or <paramref name="userId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response> CheckEntityExistsAsync(string workspaceId, string groupId, string userId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workspaceId, nameof(workspaceId));
            Argument.AssertNotNullOrEmpty(groupId, nameof(groupId));
            Argument.AssertNotNullOrEmpty(userId, nameof(userId));

            using DiagnosticScope scope = _workspaceGroupUserClientDiagnostics.CreateScope("ApiManagementGroupResource.CheckEntityExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _workspaceGroupUserRestClient.CreateCheckEntityExistsRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, workspaceId, groupId, userId, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="workspaceId"/>, <paramref name="groupId"/> or <paramref name="userId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="workspaceId"/>, <paramref name="groupId"/> or <paramref name="userId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response CheckEntityExists(string workspaceId, string groupId, string userId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workspaceId, nameof(workspaceId));
            Argument.AssertNotNullOrEmpty(groupId, nameof(groupId));
            Argument.AssertNotNullOrEmpty(userId, nameof(userId));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="workspaceId"/>, <paramref name="groupId"/> or <paramref name="userId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="workspaceId"/>, <paramref name="groupId"/> or <paramref name="userId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response> DeleteAsync(string workspaceId, string groupId, string userId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workspaceId, nameof(workspaceId));
            Argument.AssertNotNullOrEmpty(groupId, nameof(groupId));
            Argument.AssertNotNullOrEmpty(userId, nameof(userId));

            using DiagnosticScope scope = _workspaceGroupUserClientDiagnostics.CreateScope("ApiManagementGroupResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _workspaceGroupUserRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, workspaceId, groupId, userId, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="workspaceId"/>, <paramref name="groupId"/> or <paramref name="userId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="workspaceId"/>, <paramref name="groupId"/> or <paramref name="userId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response Delete(string workspaceId, string groupId, string userId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workspaceId, nameof(workspaceId));
            Argument.AssertNotNullOrEmpty(groupId, nameof(groupId));
            Argument.AssertNotNullOrEmpty(userId, nameof(userId));
