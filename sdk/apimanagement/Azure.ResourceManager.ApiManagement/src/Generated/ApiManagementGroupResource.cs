...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementGroupResource : ArmResource
    {
        ...
        internal ApiManagementGroupResource(ArmClient client, ApiManagementGroupData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ApiManagementGroupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ApiManagementGroupResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
