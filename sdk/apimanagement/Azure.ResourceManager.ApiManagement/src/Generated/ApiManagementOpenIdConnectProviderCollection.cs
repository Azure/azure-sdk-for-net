...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementOpenIdConnectProviderCollection : ArmCollection, IEnumerable<ApiManagementOpenIdConnectProviderResource>, IAsyncEnumerable<ApiManagementOpenIdConnectProviderResource>
    {
        ...
        public virtual async Task<ArmOperation<ApiManagementOpenIdConnectProviderResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string opid, ApiManagementOpenIdConnectProviderData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _openIdConnectProviderRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, opid, ApiManagementOpenIdConnectProviderData.ToRequestContent(data), ifMatch, context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="opid"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="opid"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ApiManagementOpenIdConnectProviderResource> CreateOrUpdate(WaitUntil waitUntil, string opid, ApiManagementOpenIdConnectProviderData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(opid, nameof(opid));
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <exception cref="ArgumentException"> <paramref name="opid"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<Response<ApiManagementOpenIdConnectProviderResource>> GetAsync(string opid, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(opid, nameof(opid));
            ...
            try
            {
                ...
                HttpMessage message = _openIdConnectProviderRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, opid, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiManagementOpenIdConnectProviderData> response = Response.FromValue(ApiManagementOpenIdConnectProviderData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="opid"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="opid"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<ApiManagementOpenIdConnectProviderResource> Get(string opid, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(opid, nameof(opid));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="opid"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="opid"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual async Task<NullableResponse<ApiManagementOpenIdConnectProviderResource>> GetIfExistsAsync(string opid, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(opid, nameof(opid));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="opid"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="opid"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual NullableResponse<ApiManagementOpenIdConnectProviderResource> GetIfExists(string opid, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(opid, nameof(opid));
