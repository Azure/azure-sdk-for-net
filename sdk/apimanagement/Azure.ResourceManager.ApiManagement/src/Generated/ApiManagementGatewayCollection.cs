    ...
    public partial class ApiManagementGatewayCollection : ArmCollection, IEnumerable<ApiManagementGatewayResource>, IAsyncEnumerable<ApiManagementGatewayResource>
    {
        ...
        public virtual AsyncPageable<ApiManagementGatewayResource> GetAllAsync(ApiManagementGatewayCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<ApiManagementGatewayResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _apiManagementGatewayGatewayRestClient.ListByServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<ApiManagementGatewayResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _apiManagementGatewayGatewayRestClient.ListByServiceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementGatewayResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<ApiManagementGatewayResource> GetAll(ApiManagementGatewayCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            Page<ApiManagementGatewayResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiManagementGatewayGatewayRestClient.ListByService(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementGatewayResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<ApiManagementGatewayResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiManagementGatewayGatewayRestClient.ListByServiceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementGatewayResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
