...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// To get a <see cref="ApiManagementGatewayCollection"/> instance call the GetApiManagementGateways method from an instance of <see cref="ResourceGroupResource"/>.
    /// </summary>
    public partial class ApiManagementGatewayCollection : ArmCollection, IEnumerable<ApiManagementGatewayResource>, IAsyncEnumerable<ApiManagementGatewayResource>
    {
        ...
        public virtual async Task<ArmOperation<ApiManagementGatewayResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string gatewayName, ApiManagementGatewayData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(gatewayName, nameof(gatewayName));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _apiGatewayClientDiagnostics.CreateScope("ApiManagementGatewayCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _apiGatewayRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, gatewayName, ApiManagementGatewayData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="gatewayName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="gatewayName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ApiManagementGatewayResource> CreateOrUpdate(WaitUntil waitUntil, string gatewayName, ApiManagementGatewayData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(gatewayName, nameof(gatewayName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<ApiManagementGatewayResource>> GetAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiGatewayClientDiagnostics.CreateScope("ApiManagementGatewayCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<ApiManagementGatewayResource> GetAllAsync(int? top = default, string skipToken = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ApiManagementGatewayData, ApiManagementGatewayResource>(new ApiGatewayGetByResourceGroupAsyncCollectionResultOfT(
        ...
        public virtual Pageable<ApiManagementGatewayResource> GetAll(int? top = default, string skipToken = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ApiManagementGatewayData, ApiManagementGatewayResource>(new ApiGatewayGetByResourceGroupCollectionResultOfT(
                _apiGatewayRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                top,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiGatewayClientDiagnostics.CreateScope("ApiManagementGatewayCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ApiManagementGatewayResource>> GetIfExistsAsync(string gatewayName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiGatewayClientDiagnostics.CreateScope("ApiManagementGatewayCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
