...
{
    /// <summary>
    /// A class representing a ApiTagDescription along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ApiTagDescriptionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ApiResource"/> using the GetApiTagDescriptions method.
    /// </summary>
    public partial class ApiTagDescriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ApiTagDescriptionResource for mocking. </summary>
        protected ApiTagDescriptionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ApiTagDescriptionResource"/> class. </summary>
        ...
        {
            using DiagnosticScope scope = _apiTagDescriptionClientDiagnostics.CreateScope("ApiTagDescriptionResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _apiTagDescriptionRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiTagDescriptionClientDiagnostics.CreateScope("ApiTagDescriptionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _apiTagDescriptionRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ifMatch, context);
        ...
        public virtual async Task<ArmOperation<ApiTagDescriptionResource>> UpdateAsync(WaitUntil waitUntil, TagDescriptionCreateContent content, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _apiTagDescriptionClientDiagnostics.CreateScope("ApiTagDescriptionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _apiTagDescriptionRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, TagDescriptionCreateContent.ToRequestContent(content), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiTagDescriptionData> response = Response.FromValue(ApiTagDescriptionData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
