...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementDiagnosticCollection : ArmCollection, IEnumerable<ApiManagementDiagnosticResource>, IAsyncEnumerable<ApiManagementDiagnosticResource>
    {
        ...
        public virtual AsyncPageable<ApiManagementDiagnosticResource> GetAllAsync(ApiManagementDiagnosticGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new ApiManagementDiagnosticGetAllOptions();
        ...
        public virtual Pageable<ApiManagementDiagnosticResource> GetAll(ApiManagementDiagnosticGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new ApiManagementDiagnosticGetAllOptions();
