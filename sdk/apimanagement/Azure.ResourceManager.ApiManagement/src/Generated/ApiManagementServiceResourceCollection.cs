...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// To get an <see cref="ApiManagementServiceResourceCollection" /> instance call the GetApiManagementServiceResources method from an instance of <see cref="ResourceGroupResource" />.
    /// </summary>
    public partial class ApiManagementServiceResourceCollection : ArmCollection, IEnumerable<ApiManagementServiceResource>, IAsyncEnumerable<ApiManagementServiceResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ApiManagementServiceResourceCollection"/> class. </summary>
        ...
        {
            _apiManagementServiceResourceApiManagementServiceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ApiManagementServiceResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ApiManagementServiceResource.ResourceType, out string apiManagementServiceResourceApiManagementServiceApiVersion);
        ...
        /// Operation Id: ApiManagementService_CreateOrUpdate
        /// </summary>
        ...
        public virtual async Task<ArmOperation<ApiManagementServiceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string serviceName, ApiManagementServiceResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _apiManagementServiceResourceApiManagementServiceClientDiagnostics.CreateScope("ApiManagementServiceResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _apiManagementServiceResourceApiManagementServiceRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, serviceName, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ApiManagementServiceResource> CreateOrUpdate(WaitUntil waitUntil, string serviceName, ApiManagementServiceResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementServiceResourceApiManagementServiceRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, serviceName, data, cancellationToken);
                var operation = new ApiManagementArmOperation<ApiManagementServiceResource>(new ApiManagementServiceResourceOperationSource(Client), _apiManagementServiceResourceApiManagementServiceClientDiagnostics, Pipeline, _apiManagementServiceResourceApiManagementServiceRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, serviceName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<ApiManagementServiceResource>> GetAsync(string serviceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _apiManagementServiceResourceApiManagementServiceClientDiagnostics.CreateScope("ApiManagementServiceResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _apiManagementServiceResourceApiManagementServiceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, serviceName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<ApiManagementServiceResource> Get(string serviceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementServiceResourceApiManagementServiceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, serviceName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ApiManagementServiceResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service
        /// Operation Id: ApiManagementService_ListByResourceGroup
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        public virtual AsyncPageable<ApiManagementServiceResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _apiManagementServiceResourceApiManagementServiceClientDiagnostics.CreateScope("ApiManagementServiceResourceCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _apiManagementServiceResourceApiManagementServiceRestClient.ListByResourceGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<ApiManagementServiceResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _apiManagementServiceResourceApiManagementServiceRestClient.ListByResourceGroupNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementServiceResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<ApiManagementServiceResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<ApiManagementServiceResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiManagementServiceResourceApiManagementServiceRestClient.ListByResourceGroup(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementServiceResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<ApiManagementServiceResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiManagementServiceResourceApiManagementServiceRestClient.ListByResourceGroupNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementServiceResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string serviceName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _apiManagementServiceResourceApiManagementServiceClientDiagnostics.CreateScope("ApiManagementServiceResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _apiManagementServiceResourceApiManagementServiceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, serviceName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string serviceName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _apiManagementServiceResourceApiManagementServiceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, serviceName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
