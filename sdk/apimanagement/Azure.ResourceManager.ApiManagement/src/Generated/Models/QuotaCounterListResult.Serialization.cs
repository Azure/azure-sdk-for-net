...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaCounterListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QuotaCounterListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QuotaCounterListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QuotaCounterListResult>)} interface");
            }
        ...
        string IPersistableModel<QuotaCounterListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
