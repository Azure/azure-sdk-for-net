...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementSubscriptionCreateOrUpdateContent
    {
        ...
        internal ApiManagementSubscriptionCreateOrUpdateContent(string ownerId, string scope, string displayName, string primaryKey, string secondaryKey, SubscriptionState? state, bool? allowTracing, Dictionary<string, BinaryData> rawData)
        {
            OwnerId = ownerId;
            Scope = scope;
