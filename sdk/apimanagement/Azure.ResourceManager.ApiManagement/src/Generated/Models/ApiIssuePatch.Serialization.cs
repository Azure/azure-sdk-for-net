...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiIssuePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiIssuePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiIssuePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiIssuePatch>)} interface");
            }
        ...
        string IPersistableModel<ApiIssuePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
