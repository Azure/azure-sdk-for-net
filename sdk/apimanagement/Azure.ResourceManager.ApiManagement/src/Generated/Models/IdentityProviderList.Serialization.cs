...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IdentityProviderList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IdentityProviderList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IdentityProviderList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IdentityProviderList>)} interface");
            }
        ...
        string IPersistableModel<IdentityProviderList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
