...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class IdentityProviderList
    {
        internal static IdentityProviderList DeserializeIdentityProviderList(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ApiManagementIdentityProviderData>> value = default;
            ...
            return new IdentityProviderList(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
