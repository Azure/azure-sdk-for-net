...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class PipelineDiagnosticSettings
    {
        ...
        internal PipelineDiagnosticSettings(HttpMessageDiagnostic request, HttpMessageDiagnostic response, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Request = request;
            Response = response;
