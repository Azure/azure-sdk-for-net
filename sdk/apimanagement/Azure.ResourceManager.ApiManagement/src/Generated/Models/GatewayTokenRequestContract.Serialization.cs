...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GatewayTokenRequestContract>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GatewayTokenRequestContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GatewayTokenRequestContract>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GatewayTokenRequestContract>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
