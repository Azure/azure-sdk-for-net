...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceLocationDataContract>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceLocationDataContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceLocationDataContract>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceLocationDataContract>)} interface");
            }
        ...
        string IPersistableModel<ResourceLocationDataContract>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
