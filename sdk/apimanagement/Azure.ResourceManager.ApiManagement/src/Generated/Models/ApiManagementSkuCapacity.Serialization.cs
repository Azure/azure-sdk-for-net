...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static ApiManagementSkuCapacity DeserializeApiManagementSkuCapacity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
