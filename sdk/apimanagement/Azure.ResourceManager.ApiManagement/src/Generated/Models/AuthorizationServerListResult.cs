...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    internal partial class AuthorizationServerListResult
    {
        ...
        internal AuthorizationServerListResult(IReadOnlyList<ApiManagementAuthorizationServerData> value, long? count, string nextLink, Dictionary<string, BinaryData> rawData)
        {
            Value = value;
            Count = count;
            NextLink = nextLink;
