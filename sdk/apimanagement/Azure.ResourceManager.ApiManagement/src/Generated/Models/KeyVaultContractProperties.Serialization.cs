...
{
    public partial class KeyVaultContractProperties : IUtf8JsonSerializable, IJsonModel<KeyVaultContractProperties>, IPersistableModel<KeyVaultContractProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastStatus))
            {
                ...
                AppendChildObject(builder, LastStatus, options, 2);
            }
