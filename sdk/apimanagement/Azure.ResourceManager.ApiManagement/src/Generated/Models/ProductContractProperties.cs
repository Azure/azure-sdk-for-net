...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ProductContractProperties. </summary>
        /// <param name="displayName"> Product name. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="displayName"/> is null. </exception>
        internal ProductContractProperties(string displayName)
        {
            if (displayName == null)
            {
        ...
        /// <param name="displayName"> Product name. </param>
        internal ProductContractProperties(string description, string terms, bool? subscriptionRequired, bool? approvalRequired, int? subscriptionsLimit, ProductState? state, string displayName) : base(description, terms, subscriptionRequired, approvalRequired, subscriptionsLimit, state)
        {
            DisplayName = displayName;
        }
