...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackendReconnectContract>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackendReconnectContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackendReconnectContract>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackendReconnectContract>)} interface");
            }
        ...
        string IPersistableModel<BackendReconnectContract>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
