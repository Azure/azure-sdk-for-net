...
{
    public partial class BackendReconnectContract : IUtf8JsonSerializable, IJsonModel<BackendReconnectContract>, IPersistableModel<BackendReconnectContract>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(After))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(After.Value);
