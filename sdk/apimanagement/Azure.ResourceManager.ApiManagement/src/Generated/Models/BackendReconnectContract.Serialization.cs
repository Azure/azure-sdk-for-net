...
{
    public partial class BackendReconnectContract : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackendReconnectContract DeserializeBackendReconnectContract(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
