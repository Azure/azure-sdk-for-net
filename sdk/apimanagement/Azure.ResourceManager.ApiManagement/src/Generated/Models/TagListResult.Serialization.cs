...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TagListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TagListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TagListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TagListResult>)} interface");
            }
        ...
        string IPersistableModel<TagListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
