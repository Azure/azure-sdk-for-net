...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class TagListResult
    {
        internal static TagListResult DeserializeTagListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<TagContractData>> value = default;
            ...
            return new TagListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
