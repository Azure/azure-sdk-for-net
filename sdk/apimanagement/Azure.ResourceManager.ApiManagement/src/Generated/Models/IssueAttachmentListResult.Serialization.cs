...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IssueAttachmentListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IssueAttachmentListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IssueAttachmentListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IssueAttachmentListResult>)} interface");
            }
        ...
        string IPersistableModel<IssueAttachmentListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
