...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static RequestReportRecordContract DeserializeRequestReportRecordContract(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
