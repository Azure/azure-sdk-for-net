...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class GatewayListResult
    {
        internal static GatewayListResult DeserializeGatewayListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ApiManagementGatewayData>> value = default;
            ...
            return new GatewayListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
