    ...
    public partial class SchemaContractData : IUtf8JsonSerializable, IXmlSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(Definitions))
            {
                ...
                writer.WriteObjectValue(Definitions);
            }
        ...
        internal static SchemaContractData DeserializeSchemaContractData(JsonElement element)
        {
            ...
            Optional<object> definitions = default;
            Optional<object> components = default;
                        ...
                        if (property0.NameEquals("document"))
                        {
                            ...
                            foreach (var property1 in property0.Value.EnumerateObject())
                            {
                                ...
                                if (property1.NameEquals("definitions"))
                                {
                                    ...
                                    definitions = property1.Value.GetObject();
                                    continue;
                                }
                                if (property1.NameEquals("components"))
                                {
                                    ...
                                    components = property1.Value.GetObject();
                                    continue;
                                }
                            }
                            continue;
            ...
            return new SchemaContractData(id, name, type, contentType.Value, value.Value, definitions.Value, components.Value);
        }
        ...
        void IXmlSerializable.Write(XmlWriter writer, string nameHint)
        {
            ...
            if (Optional.IsDefined(Definitions))
            {
                writer.WriteObjectValue(Definitions, "definitions");
            }
            if (Optional.IsDefined(Components))
            {
                writer.WriteObjectValue(Components, "components");
            }
        ...
        internal static SchemaContractData DeserializeSchemaContractData(XElement element)
        {
            ...
            {
                definitions = definitionsElement.GetObjectValue(null);
            }
            if (element.Element("components") is XElement componentsElement)
            {
                components = componentsElement.GetObjectValue(null);
            }
            ...
            return new SchemaContractData(id, name, type, contentType, value, definitions, components);
        }
    }
}
