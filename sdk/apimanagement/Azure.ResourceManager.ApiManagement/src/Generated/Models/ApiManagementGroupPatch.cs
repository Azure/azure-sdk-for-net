...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementGroupPatch
    {
        ...
        internal ApiManagementGroupPatch(string displayName, string description, ApiManagementGroupType? apiManagementGroupType, string externalId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
