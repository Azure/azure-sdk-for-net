...
{
    public partial class ProductApiData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ProductApiData DeserializeProductApiData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
