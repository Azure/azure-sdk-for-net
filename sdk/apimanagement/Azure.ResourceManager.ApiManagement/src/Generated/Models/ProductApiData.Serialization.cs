...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductApiData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProductApiData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProductApiData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProductApiData>)} interface");
            }
        ...
        string IPersistableModel<ProductApiData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
