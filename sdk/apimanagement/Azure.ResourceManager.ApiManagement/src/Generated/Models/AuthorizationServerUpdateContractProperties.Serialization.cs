...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    internal partial class AuthorizationServerUpdateContractProperties : AuthorizationServerContractBaseProperties, IJsonModel<AuthorizationServerUpdateContractProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AuthorizationServerUpdateContractProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeAuthorizationServerUpdateContractProperties(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(AuthorizationServerUpdateContractProperties)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AuthorizationServerUpdateContractProperties)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AuthorizationServerUpdateContractProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AuthorizationServerUpdateContractProperties IPersistableModel<AuthorizationServerUpdateContractProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (AuthorizationServerUpdateContractProperties)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<AuthorizationServerUpdateContractProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<AuthorizationServerUpdateContractProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AuthorizationServerUpdateContractProperties)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AuthorizationServerUpdateContractProperties IJsonModel<AuthorizationServerUpdateContractProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AuthorizationServerUpdateContractProperties)JsonModelCreateCore(ref reader, options);
        ...
        protected override AuthorizationServerContractBaseProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AuthorizationServerUpdateContractProperties)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static AuthorizationServerUpdateContractProperties DeserializeAuthorizationServerUpdateContractProperties(JsonElement element, ModelReaderWriterOptions options)
        {
