...
{
    public partial class ApiData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApiData DeserializeApiData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
