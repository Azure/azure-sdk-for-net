...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementServiceApplyNetworkConfigurationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementServiceApplyNetworkConfigurationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementServiceApplyNetworkConfigurationContent>)} interface");
            }
        ...
        string IPersistableModel<ApiManagementServiceApplyNetworkConfigurationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
