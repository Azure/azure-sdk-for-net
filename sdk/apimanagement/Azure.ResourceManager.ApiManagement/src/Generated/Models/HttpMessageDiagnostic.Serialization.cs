...
{
    public partial class HttpMessageDiagnostic : IUtf8JsonSerializable, IJsonModel<HttpMessageDiagnostic>, IPersistableModel<HttpMessageDiagnostic>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  body:");
                AppendChildObject(builder, Body, options, 2);
            }

            if (Optional.IsDefined(DataMasking))
            {
                builder.Append("  dataMasking:");
                AppendChildObject(builder, DataMasking, options, 2);
            }
