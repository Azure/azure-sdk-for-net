...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserContractData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UserContractData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UserContractData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UserContractData>)} interface");
            }
        ...
        string IPersistableModel<UserContractData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
