...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class UserContractData : IUtf8JsonSerializable, IJsonModel<UserContractData>
    {
        ...
        void IJsonModel<UserContractData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UserContractData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UserContractData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UserContractData)} does not support '{options.Format}' format.");
            }
        }
