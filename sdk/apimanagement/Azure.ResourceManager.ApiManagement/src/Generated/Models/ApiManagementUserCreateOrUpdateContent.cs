...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementUserCreateOrUpdateContent
    {
        ...
        internal ApiManagementUserCreateOrUpdateContent(ApiManagementUserState? state, string note, IList<UserIdentityContract> identities, string email, string firstName, string lastName, string password, AppType? appType, ConfirmationEmailType? confirmation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
            Note = note;
