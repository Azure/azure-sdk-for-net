...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ResourceLocationDataContract
    {
        ...
        internal ResourceLocationDataContract(string name, string city, string district, string countryOrRegion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            City = city;
            District = district;
