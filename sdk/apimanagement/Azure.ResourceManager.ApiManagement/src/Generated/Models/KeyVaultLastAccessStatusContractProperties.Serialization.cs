...
{
    public partial class KeyVaultLastAccessStatusContractProperties : IUtf8JsonSerializable, IJsonModel<KeyVaultLastAccessStatusContractProperties>, IPersistableModel<KeyVaultLastAccessStatusContractProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TimeStampUtc))
            {
                ...
                builder.AppendLine($" '{TimeStampUtc.Value.ToString()}'");
            }
