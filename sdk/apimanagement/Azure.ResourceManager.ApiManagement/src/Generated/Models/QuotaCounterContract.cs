...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class QuotaCounterContract
    {
        ...
        internal QuotaCounterContract(string counterKey, string periodKey, DateTimeOffset periodStartOn, DateTimeOffset periodEndOn, QuotaCounterValueContractProperties value, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CounterKey = counterKey;
            PeriodKey = periodKey;
            PeriodStartOn = periodStartOn;
