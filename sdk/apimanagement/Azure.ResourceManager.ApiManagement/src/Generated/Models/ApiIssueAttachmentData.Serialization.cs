...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiIssueAttachmentData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiIssueAttachmentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiIssueAttachmentData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiIssueAttachmentData>)} interface");
            }
        ...
        string IPersistableModel<ApiIssueAttachmentData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
