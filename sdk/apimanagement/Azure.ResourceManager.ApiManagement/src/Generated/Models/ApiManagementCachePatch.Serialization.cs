...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementCachePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementCachePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementCachePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementCachePatch>)} interface");
            }
        ...
        string IPersistableModel<ApiManagementCachePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
