...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiReleaseListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiReleaseListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiReleaseListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiReleaseListResult>)} interface");
            }
        ...
        string IPersistableModel<ApiReleaseListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
