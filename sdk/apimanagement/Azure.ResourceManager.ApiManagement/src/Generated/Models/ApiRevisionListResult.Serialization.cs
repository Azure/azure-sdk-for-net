...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class ApiRevisionListResult
    {
        internal static ApiRevisionListResult DeserializeApiRevisionListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ApiRevisionContract>> value = default;
            ...
            return new ApiRevisionListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
