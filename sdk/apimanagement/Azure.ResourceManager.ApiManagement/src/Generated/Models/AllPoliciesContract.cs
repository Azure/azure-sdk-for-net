...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class AllPoliciesContract : ResourceData
    {
        ...
        internal AllPoliciesContract(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AllPoliciesContractProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
