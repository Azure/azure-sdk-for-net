...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataMaskingEntity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataMaskingEntity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataMaskingEntity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataMaskingEntity>)} interface");
            }
        ...
        string IPersistableModel<DataMaskingEntity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
