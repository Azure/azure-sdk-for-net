...
{
    internal partial class AuthorizationServerCollection
    {
        internal static AuthorizationServerCollection DeserializeAuthorizationServerCollection(JsonElement element)
        {
            ...
            return new AuthorizationServerCollection(Optional.ToList(value), Optional.ToNullable(count), nextLink.Value);
        }
    }
}
