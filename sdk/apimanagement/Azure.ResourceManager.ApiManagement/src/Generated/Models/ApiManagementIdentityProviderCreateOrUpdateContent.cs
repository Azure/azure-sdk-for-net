...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementIdentityProviderCreateOrUpdateContent : ResourceData
    {
        ...
        internal ApiManagementIdentityProviderCreateOrUpdateContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IdentityProviderCreateContractProperties properties) : base(id, name, resourceType, systemData)
        {
