...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static PolicyDescriptionListResult DeserializePolicyDescriptionListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
