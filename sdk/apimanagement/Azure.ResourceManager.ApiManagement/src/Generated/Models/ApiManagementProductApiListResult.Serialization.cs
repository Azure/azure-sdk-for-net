...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementProductApiListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiManagementProductApiListResult)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<ProductApiData>)item).Write(writer, options);
                }
        ...
        ApiManagementProductApiListResult IJsonModel<ApiManagementProductApiListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiManagementProductApiListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static ApiManagementProductApiListResult DeserializeApiManagementProductApiListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(ProductApiData.DeserializeProductApiData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new ApiManagementProductApiListResult(value ?? new ChangeTrackingList<ProductApiData>(), count, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ApiManagementProductApiListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApiManagementProductApiListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ApiManagementProductApiListResult IPersistableModel<ApiManagementProductApiListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ApiManagementProductApiListResult)} does not support reading '{options.Format}' format.");
            }
        }
