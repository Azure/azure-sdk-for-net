...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class ApiManagementProductApiListResult
    {
        internal static ApiManagementProductApiListResult DeserializeApiManagementProductApiListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ProductApiData>> value = default;
            ...
            return new ApiManagementProductApiListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
