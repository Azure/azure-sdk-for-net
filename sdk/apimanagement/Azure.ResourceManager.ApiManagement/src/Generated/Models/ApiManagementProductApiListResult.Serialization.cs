...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementProductApiListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementProductApiListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementProductApiListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementProductApiListResult>)} interface");
            }
        ...
        string IPersistableModel<ApiManagementProductApiListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
