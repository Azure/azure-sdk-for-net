...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ConnectivityHop
    {
        ...
        internal ConnectivityHop(string connectivityHopType, string id, IPAddress address, ResourceIdentifier resourceId, IReadOnlyList<string> nextHopIds, IReadOnlyList<ConnectivityIssue> issues, Dictionary<string, BinaryData> rawData)
        {
