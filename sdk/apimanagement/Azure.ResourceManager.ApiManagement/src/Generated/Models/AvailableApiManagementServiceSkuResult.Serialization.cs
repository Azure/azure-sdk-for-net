...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailableApiManagementServiceSkuResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvailableApiManagementServiceSkuResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailableApiManagementServiceSkuResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvailableApiManagementServiceSkuResult>)} interface");
            }
        ...
        string IPersistableModel<AvailableApiManagementServiceSkuResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
