...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class BackendListResult : IUtf8JsonSerializable, IJsonModel<BackendListResult>
    {
        ...
        void IJsonModel<BackendListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BackendListResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<ApiManagementBackendData> collection && collection.IsUndefined))
            {
        ...
        internal static BackendListResult DeserializeBackendListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new BackendListResult(value ?? new ChangeTrackingList<ApiManagementBackendData>(), Optional.ToNullable(count), nextLink.Value, serializedAdditionalRawData);
        }
