...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static PortalSettingsListResult DeserializePortalSettingsListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
