...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        /// <summary> Initializes a new instance of IdentityProviderCreateContract. </summary>
        ...
        internal IdentityProviderCreateContract(ResourceIdentifier id, string name, ResourceType type, IdentityProviderType? typePropertiesType, string signinTenant, IList<string> allowedTenants, string authority, string signupPolicyName, string signinPolicyName, string profileEditingPolicyName, string passwordResetPolicyName, string clientId, string clientSecret) : base(id, name, type)
        {
