...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class IdentityProviderCreateContract : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="IdentityProviderCreateContract"/>. </summary>
        ...
        internal IdentityProviderCreateContract(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IdentityProviderCreateContractProperties properties) : base(id, name, resourceType, systemData)
        {
