...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AccessInformationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AccessInformationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AccessInformationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AccessInformationListResult>)} interface");
            }
        ...
        string IPersistableModel<AccessInformationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
