...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ConnectivityStatusContract
    {
        ...
        internal ConnectivityStatusContract(string name, ConnectivityStatusType status, string error, DateTimeOffset lastUpdatedOn, DateTimeOffset lastStatusChangedOn, string resourceType, bool isOptional, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Status = status;
            Error = error;
