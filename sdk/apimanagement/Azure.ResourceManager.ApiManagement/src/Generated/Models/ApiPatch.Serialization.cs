...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiPatch>)} interface");
            }
        ...
        string IPersistableModel<ApiPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
