...
namespace Azure.ResourceManager.ApiManagement.Models
{
    public partial class ApiPatch : IUtf8JsonSerializable, IModelJsonSerializable<ApiPatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiPatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ApiPatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ApiPatch"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ApiPatch"/>. </summary>
