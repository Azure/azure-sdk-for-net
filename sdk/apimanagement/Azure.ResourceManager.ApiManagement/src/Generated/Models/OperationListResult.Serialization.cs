...
{
    internal partial class OperationListResult : IUtf8JsonSerializable, IJsonModel<OperationListResult>, IPersistableModel<OperationListResult>
    {
        ...
        void IJsonModel<OperationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OperationListResult)} does not support '{format}' format.");
            }
