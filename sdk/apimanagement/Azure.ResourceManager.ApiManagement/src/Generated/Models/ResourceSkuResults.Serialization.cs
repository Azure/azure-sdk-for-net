...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceSkuResults>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceSkuResults>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceSkuResults>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceSkuResults>)} interface");
            }
        ...
        string IPersistableModel<ResourceSkuResults>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
