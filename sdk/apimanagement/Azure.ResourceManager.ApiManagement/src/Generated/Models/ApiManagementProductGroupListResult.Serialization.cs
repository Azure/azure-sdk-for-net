...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class ApiManagementProductGroupListResult
    {
        internal static ApiManagementProductGroupListResult DeserializeApiManagementProductGroupListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ProductGroupData>> value = default;
            ...
            return new ApiManagementProductGroupListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
