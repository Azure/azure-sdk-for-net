        ...
        internal static ApiManagementServiceResourcePatch DeserializeApiManagementServiceResourcePatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = ApiManagementServiceUpdateProperties.DeserializeApiManagementServiceUpdateProperties(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("sku"u8))
                {
                    ...
                    sku = ApiManagementServiceSkuProperties.DeserializeApiManagementServiceSkuProperties(prop.Value, options);
                    continue;
                }
