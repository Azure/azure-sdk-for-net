...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class TagResourceListResult
    {
        internal static TagResourceListResult DeserializeTagResourceListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<TagResourceContractDetails>> value = default;
            ...
            return new TagResourceListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
