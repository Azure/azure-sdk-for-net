...
{
    public partial class SubscriptionContractData : IUtf8JsonSerializable, IJsonModel<SubscriptionContractData>, IPersistableModel<SubscriptionContractData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NotifiesOn))
            {
                ...
                builder.AppendLine($" '{NotifiesOn.Value.ToString()}'");
            }
