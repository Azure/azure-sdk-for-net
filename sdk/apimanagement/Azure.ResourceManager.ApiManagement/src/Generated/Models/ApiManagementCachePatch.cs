...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementCachePatch
    {
        ...
        internal ApiManagementCachePatch(string description, string connectionString, string useFromLocation, Uri resourceUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
