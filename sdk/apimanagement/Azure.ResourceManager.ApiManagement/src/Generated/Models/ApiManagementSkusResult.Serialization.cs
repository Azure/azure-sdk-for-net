...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementSkusResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementSkusResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementSkusResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementSkusResult>)} interface");
            }
        ...
        string IPersistableModel<ApiManagementSkusResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
