...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiEntityBaseContract
    {
        ...
        internal ApiEntityBaseContract(string description, AuthenticationSettingsContract authenticationSettings, SubscriptionKeyParameterNamesContract subscriptionKeyParameterNames, ApiType? apiType, string apiRevision, string apiVersion, bool? isCurrent, bool? isOnline, string apiRevisionDescription, string apiVersionDescription, string apiVersionSetId, bool? subscriptionRequired, string termsOfServiceUrl, ApiContactInformation contact, ApiLicenseInformation license)
        {
