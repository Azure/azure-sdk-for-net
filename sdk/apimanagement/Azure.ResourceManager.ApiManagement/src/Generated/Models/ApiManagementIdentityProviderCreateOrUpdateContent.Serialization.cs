...
{
    public partial class ApiManagementIdentityProviderCreateOrUpdateContent : IUtf8JsonSerializable, IModelJsonSerializable<ApiManagementIdentityProviderCreateOrUpdateContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ApiManagementIdentityProviderCreateOrUpdateContent>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ApiManagementIdentityProviderCreateOrUpdateContent>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiManagementIdentityProviderCreateOrUpdateContent>(this, options.Format);
        ...
        internal static ApiManagementIdentityProviderCreateOrUpdateContent DeserializeApiManagementIdentityProviderCreateOrUpdateContent(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        ApiManagementIdentityProviderCreateOrUpdateContent IModelJsonSerializable<ApiManagementIdentityProviderCreateOrUpdateContent>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiManagementIdentityProviderCreateOrUpdateContent>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeApiManagementIdentityProviderCreateOrUpdateContent(doc.RootElement, options);
        }

        BinaryData IModelSerializable<ApiManagementIdentityProviderCreateOrUpdateContent>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiManagementIdentityProviderCreateOrUpdateContent>(this, options.Format);
        ...
        ApiManagementIdentityProviderCreateOrUpdateContent IModelSerializable<ApiManagementIdentityProviderCreateOrUpdateContent>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiManagementIdentityProviderCreateOrUpdateContent>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ApiManagementIdentityProviderCreateOrUpdateContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ApiManagementIdentityProviderCreateOrUpdateContent"/> to convert. </param>
        public static implicit operator RequestContent(ApiManagementIdentityProviderCreateOrUpdateContent model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ApiManagementIdentityProviderCreateOrUpdateContent"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ApiManagementIdentityProviderCreateOrUpdateContent(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeApiManagementIdentityProviderCreateOrUpdateContent(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
