...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class KeyVaultLastAccessStatusContractProperties
    {
        ...
        internal KeyVaultLastAccessStatusContractProperties(string code, string message, DateTimeOffset? timeStampUtc, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
