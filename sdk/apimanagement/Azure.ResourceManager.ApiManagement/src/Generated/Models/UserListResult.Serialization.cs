...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class UserListResult : IUtf8JsonSerializable, IJsonModel<UserListResult>
    {
        ...
        void IJsonModel<UserListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UserListResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<UserContractData> collection && collection.IsUndefined))
            {
        ...
        internal static UserListResult DeserializeUserListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UserListResult(value ?? new ChangeTrackingList<UserContractData>(), Optional.ToNullable(count), nextLink.Value, serializedAdditionalRawData);
        }
