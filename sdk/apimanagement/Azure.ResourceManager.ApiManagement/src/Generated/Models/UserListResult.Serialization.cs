...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class UserListResult
    {
        internal static UserListResult DeserializeUserListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<UserContractData>> value = default;
            ...
            return new UserListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
