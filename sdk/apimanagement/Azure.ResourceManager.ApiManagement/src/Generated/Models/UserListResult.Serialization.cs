...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UserListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UserListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UserListResult>)} interface");
            }
        ...
        string IPersistableModel<UserListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
