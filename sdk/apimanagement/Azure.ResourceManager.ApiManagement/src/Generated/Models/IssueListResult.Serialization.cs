...
{
    internal partial class IssueListResult : IUtf8JsonSerializable, IJsonModel<IssueListResult>, IPersistableModel<IssueListResult>
    {
        ...
        void IJsonModel<IssueListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IssueListResult)} does not support '{format}' format.");
            }
