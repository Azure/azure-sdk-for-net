...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IssueListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IssueListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IssueListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IssueListResult>)} interface");
            }
        ...
        string IPersistableModel<IssueListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
