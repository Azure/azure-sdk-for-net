...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class HttpMessageDiagnostic
    {
        ...
        internal HttpMessageDiagnostic(IList<string> headers, BodyDiagnosticSettings body, DataMasking dataMasking, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Headers = headers;
            Body = body;
