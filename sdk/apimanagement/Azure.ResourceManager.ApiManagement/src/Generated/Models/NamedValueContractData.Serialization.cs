...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class NamedValueContractData : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        internal static NamedValueContractData DeserializeNamedValueContractData(JsonElement element)
        {
            ...
            return new NamedValueContractData(id, name, type, Optional.ToList(tags), Optional.ToNullable(secret), displayName.Value, value.Value, keyVault.Value);
        }
        ...
        internal static NamedValueContractData DeserializeNamedValueContractData(XElement element)
        {
            ...
            tags = array;
            return new NamedValueContractData(id, name, type, tags, secret, displayName, value, keyVault);
        }
    }
}
