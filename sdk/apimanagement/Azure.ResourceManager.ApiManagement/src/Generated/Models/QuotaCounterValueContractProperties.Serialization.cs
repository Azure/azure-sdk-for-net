...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QuotaCounterValueContractProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QuotaCounterValueContractProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QuotaCounterValueContractProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QuotaCounterValueContractProperties>)} interface");
            }
        ...
        string IPersistableModel<QuotaCounterValueContractProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
