...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    internal partial class SubscriptionUpdateParameterProperties
    {
        ...
        internal SubscriptionUpdateParameterProperties(string ownerId, string scope, DateTimeOffset? expirationOn, string displayName, string primaryKey, string secondaryKey, SubscriptionState? state, string stateComment, bool? allowTracing, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            OwnerId = ownerId;
            Scope = scope;
