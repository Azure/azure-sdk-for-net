...
{
    public partial class ApiManagementAuthorizationServerData : IUtf8JsonSerializable, IModelJsonSerializable<ApiManagementAuthorizationServerData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ApiManagementAuthorizationServerData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ApiManagementAuthorizationServerData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiManagementAuthorizationServerData>(this, options.Format);
        ...
        internal static ApiManagementAuthorizationServerData DeserializeApiManagementAuthorizationServerData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        ApiManagementAuthorizationServerData IModelJsonSerializable<ApiManagementAuthorizationServerData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiManagementAuthorizationServerData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeApiManagementAuthorizationServerData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<ApiManagementAuthorizationServerData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiManagementAuthorizationServerData>(this, options.Format);
        ...
        ApiManagementAuthorizationServerData IModelSerializable<ApiManagementAuthorizationServerData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiManagementAuthorizationServerData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ApiManagementAuthorizationServerData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ApiManagementAuthorizationServerData"/> to convert. </param>
        public static implicit operator RequestContent(ApiManagementAuthorizationServerData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ApiManagementAuthorizationServerData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ApiManagementAuthorizationServerData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeApiManagementAuthorizationServerData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
