...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementPortalDelegationSettingData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementPortalDelegationSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementPortalDelegationSettingData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementPortalDelegationSettingData>)} interface");
            }
        ...
        string IPersistableModel<ApiManagementPortalDelegationSettingData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
