...
{
    public partial class ApiManagementPortalDelegationSettingData : IUtf8JsonSerializable, IJsonModel<ApiManagementPortalDelegationSettingData>, IPersistableModel<ApiManagementPortalDelegationSettingData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Subscriptions))
            {
                ...
                AppendChildObject(builder, Subscriptions, options, 2);
            }

            if (Optional.IsDefined(UserRegistration))
            {
                builder.Append("  userRegistration:");
                AppendChildObject(builder, UserRegistration, options, 2);
            }
