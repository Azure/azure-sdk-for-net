...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class OperationResultContract : Resource
    {
        ...
        internal OperationResultContract(ResourceIdentifier id, string name, ResourceType type, string idPropertiesId, AsyncOperationStatus? status, DateTimeOffset? started, DateTimeOffset? updated, string resultInfo, ErrorResponseBody error, IReadOnlyList<OperationResultLogItemContract> actionLog) : base(id, name, type)
        {
