...
{
    /// <summary> A class representing the query and header parameters in GetReportsByTime method. </summary>
    public partial class ApiManagementServiceGetReportsByTimeOptions
    {
        /// <summary> Initializes a new instance of ApiManagementServiceGetReportsByTimeOptions. </summary>
        ...
        public ApiManagementServiceGetReportsByTimeOptions(string filter, TimeSpan interval)
        {
