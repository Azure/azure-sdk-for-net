...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class PortalSignupSettingsData : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        internal static PortalSignupSettingsData DeserializePortalSignupSettingsData(JsonElement element)
        {
            ...
            return new PortalSignupSettingsData(id, name, type, Optional.ToNullable(enabled), termsOfService.Value);
        }
        ...
        internal static PortalSignupSettingsData DeserializePortalSignupSettingsData(XElement element)
        {
            ...
            return new PortalSignupSettingsData(id, name, type, enabled, termsOfService);
        }
    }
}
