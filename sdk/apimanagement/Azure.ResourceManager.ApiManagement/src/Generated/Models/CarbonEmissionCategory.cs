...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public readonly partial struct CarbonEmissionCategory : IEquatable<CarbonEmissionCategory>
    {
        ...
        /// <summary> Converts a string to a <see cref="CarbonEmissionCategory"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator CarbonEmissionCategory(string value) => new CarbonEmissionCategory(value);

        /// <summary> Converts a string to a <see cref="CarbonEmissionCategory"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator CarbonEmissionCategory?(string value) => value == null ? null : new CarbonEmissionCategory(value);
