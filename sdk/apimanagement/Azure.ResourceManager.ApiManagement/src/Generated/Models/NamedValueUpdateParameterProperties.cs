...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    internal partial class NamedValueUpdateParameterProperties : NamedValueEntityBaseParameters
    {
        ...
        internal NamedValueUpdateParameterProperties(IList<string> tags, bool? secret, IDictionary<string, BinaryData> additionalBinaryDataProperties, string displayName, string value, KeyVaultContractCreateProperties keyVault) : base(tags, secret, additionalBinaryDataProperties)
        {
