...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static ConnectivityCheckResponse DeserializeConnectivityCheckResponse(JsonElement element)
        {
            ...
            return new ConnectivityCheckResponse(Optional.ToList(hops), Optional.ToNullable(connectionStatus), Optional.ToNullable(avgLatencyInMs), Optional.ToNullable(minLatencyInMs), Optional.ToNullable(maxLatencyInMs), Optional.ToNullable(probesSent), Optional.ToNullable(probesFailed));
        }
    }
}
