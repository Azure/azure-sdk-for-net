...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiRevisionContract
    {
        ...
        /// <param name="createdDateTime"> The time the API Revision was created. The date conforms to the following format: yyyy-MM-ddTHH:mm:ssZ as specified by the ISO 8601 standard. </param>
        /// <param name="updatedDateTime"> The time the API Revision were updated. The date conforms to the following format: yyyy-MM-ddTHH:mm:ssZ as specified by the ISO 8601 standard. </param>
        /// <param name="description"> Description of the API Revision. </param>
        /// <param name="privateUrl"> Gateway URL for accessing the non-current API Revision. </param>
        ...
        internal ApiRevisionContract(string apiId, string apiRevision, DateTimeOffset? createdDateTime, DateTimeOffset? updatedDateTime, string description, string privateUrl, bool? isOnline, bool? isCurrent)
        {
            ApiId = apiId;
