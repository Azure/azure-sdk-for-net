...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiRevisionContract
    {
        ...
        internal ApiRevisionContract(string apiId, string apiRevision, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string description, string privateUriString, bool? isOnline, bool? isCurrent, Dictionary<string, BinaryData> rawData)
        {
            ApiId = apiId;
