...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class IdentityProviderContractData : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        internal static IdentityProviderContractData DeserializeIdentityProviderContractData(JsonElement element)
        {
            ...
            return new IdentityProviderContractData(id, name, type, Optional.ToNullable(type0), signinTenant.Value, Optional.ToList(allowedTenants), authority.Value, signupPolicyName.Value, signinPolicyName.Value, profileEditingPolicyName.Value, passwordResetPolicyName.Value, clientId.Value, clientSecret.Value);
        }
        ...
        internal static IdentityProviderContractData DeserializeIdentityProviderContractData(XElement element)
        {
            ...
            allowedTenants = array;
            return new IdentityProviderContractData(id, name, type, typePropertiesType, signinTenant, allowedTenants, authority, signupPolicyName, signinPolicyName, profileEditingPolicyName, passwordResetPolicyName, clientId, clientSecret);
        }
    }
}
