...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    internal partial class GroupUpdateParametersProperties
    {
        ...
        internal GroupUpdateParametersProperties(string displayName, string description, ApiManagementGroupType? @type, string externalId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
