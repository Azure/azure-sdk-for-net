...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiVersionSetListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ApiVersionSetListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiVersionSetListResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<ApiVersionSetData> collection && collection.IsUndefined))
            {
        ...
        internal static ApiVersionSetListResult DeserializeApiVersionSetListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ApiVersionSetListResult(value ?? new ChangeTrackingList<ApiVersionSetData>(), Optional.ToNullable(count), nextLink.Value, serializedAdditionalRawData);
        }
