...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiIssuePatch
    {
        ...
        internal ApiIssuePatch(DateTimeOffset? createdOn, IssueState? state, ResourceIdentifier apiId, string title, string description, string userId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CreatedOn = createdOn;
            State = state;
            ApiId = apiId;
