...
{
    public partial class AuthenticationSettingsContract : IUtf8JsonSerializable, IJsonModel<AuthenticationSettingsContract>, IPersistableModel<AuthenticationSettingsContract>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OAuth2))
            {
                ...
                AppendChildObject(builder, OAuth2, options, 2);
            }

            if (Optional.IsDefined(OpenId))
            {
                builder.Append("  openid:");
                AppendChildObject(builder, OpenId, options, 2);
            }
