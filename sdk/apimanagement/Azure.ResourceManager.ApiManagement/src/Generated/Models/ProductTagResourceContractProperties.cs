...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ProductTagResourceContractProperties. </summary>
        ...
        /// <param name="name"> Product name. </param>
        internal ProductTagResourceContractProperties(string description, string terms, bool? isSubscriptionRequired, bool? isApprovalRequired, int? subscriptionsLimit, ApiManagementProductState? state, string id, string name) : base(description, terms, isSubscriptionRequired, isApprovalRequired, subscriptionsLimit, state)
        {
            Id = id;
            Name = name;
        }
