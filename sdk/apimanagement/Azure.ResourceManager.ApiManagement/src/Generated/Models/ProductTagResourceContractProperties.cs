...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ProductTagResourceContractProperties : ProductEntityBaseProperties
    {
        /// <summary> Initializes a new instance of <see cref="ProductTagResourceContractProperties"/>. </summary>
        /// <param name="name"> Product name. </param>
        internal ProductTagResourceContractProperties(string name)
        {
            Name = name;
        }
        ...
        /// <param name="name"> Product name. </param>
        internal ProductTagResourceContractProperties(string description, string terms, bool? subscriptionRequired, bool? approvalRequired, int? subscriptionsLimit, IList<ProductAuthType> authenticationType, ProductEntityBaseParametersApplication application, ApiManagementProductState? state, IDictionary<string, BinaryData> additionalBinaryDataProperties, string id, string name) : base(description, terms, subscriptionRequired, approvalRequired, subscriptionsLimit, authenticationType, application, state, additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
        }
