...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ProductTagResourceContractProperties : ProductEntityBaseParameters
    {
        ...
        /// <param name="name"> Product name. </param>
        internal ProductTagResourceContractProperties(string description, string terms, bool? subscriptionRequired, bool? approvalRequired, int? subscriptionsLimit, ProductState? state, string id, string name) : base(description, terms, subscriptionRequired, approvalRequired, subscriptionsLimit, state)
        {
            Id = id;
            Name = name;
        }
