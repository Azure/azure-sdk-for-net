...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementEmailTemplateCreateOrUpdateContent
    {
        ...
        internal ApiManagementEmailTemplateCreateOrUpdateContent(string subject, string title, string description, string body, IList<EmailTemplateParametersContractProperties> parameters, Dictionary<string, BinaryData> rawData)
        {
            Subject = subject;
            Title = title;
