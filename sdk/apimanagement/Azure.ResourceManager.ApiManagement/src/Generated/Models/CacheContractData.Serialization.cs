...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class CacheContractData : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        internal static CacheContractData DeserializeCacheContractData(JsonElement element)
        {
            ...
            return new CacheContractData(id, name, type, description.Value, connectionString.Value, useFromLocation.Value, resourceId.Value);
        }
        ...
        internal static CacheContractData DeserializeCacheContractData(XElement element)
        {
            ...
            return new CacheContractData(id, name, type, description, connectionString, useFromLocation, resourceId);
        }
    }
}
