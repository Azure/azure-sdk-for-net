...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OutboundEnvironmentEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OutboundEnvironmentEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OutboundEnvironmentEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OutboundEnvironmentEndpoint>)} interface");
            }
        ...
        string IPersistableModel<OutboundEnvironmentEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
