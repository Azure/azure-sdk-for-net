...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static DeletedServicesListResult DeserializeDeletedServicesListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
