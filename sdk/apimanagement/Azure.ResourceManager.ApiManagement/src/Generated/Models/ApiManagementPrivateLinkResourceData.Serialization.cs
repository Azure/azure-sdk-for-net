...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementPrivateLinkResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementPrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementPrivateLinkResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementPrivateLinkResourceData>)} interface");
            }
        ...
        string IPersistableModel<ApiManagementPrivateLinkResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
