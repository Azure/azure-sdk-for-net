...
{
    public partial class ApiManagementPrivateLinkResourceData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ApiManagementPrivateLinkResourceData DeserializeApiManagementPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new ApiManagementPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
