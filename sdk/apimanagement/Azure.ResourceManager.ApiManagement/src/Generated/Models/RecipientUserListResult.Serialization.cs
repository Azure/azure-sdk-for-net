...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecipientUserListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecipientUserListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecipientUserListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecipientUserListResult>)} interface");
            }
        ...
        string IPersistableModel<RecipientUserListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
