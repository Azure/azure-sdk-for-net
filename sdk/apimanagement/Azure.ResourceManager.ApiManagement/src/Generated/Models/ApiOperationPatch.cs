...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiOperationPatch
    {
        ...
        internal ApiOperationPatch(IList<ParameterContract> templateParameters, string description, RequestContract request, IList<ResponseContract> responses, string policies, string displayName, string method, string uriTemplate, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
