...
{
    public partial class ApiManagementGatewayResourcePatch : IUtf8JsonSerializable, IJsonModel<ApiManagementGatewayResourcePatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementGatewayResourcePatch>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ApiManagementGatewayResourcePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ApiManagementGatewayResourcePatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ApiManagementGatewayResourcePatch IJsonModel<ApiManagementGatewayResourcePatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ApiManagementGatewayResourcePatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ApiManagementGatewayResourcePatch DeserializeApiManagementGatewayResourcePatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<ApiManagementGatewayResourcePatch>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ApiManagementGatewayResourcePatch>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ApiManagementGatewayResourcePatch IPersistableModel<ApiManagementGatewayResourcePatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ApiManagementGatewayResourcePatch>)this).GetFormatFromOptions(options) : options.Format;
