...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OAuth2AuthenticationSettingsContract>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OAuth2AuthenticationSettingsContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OAuth2AuthenticationSettingsContract>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OAuth2AuthenticationSettingsContract>)} interface");
            }
        ...
        string IPersistableModel<OAuth2AuthenticationSettingsContract>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
