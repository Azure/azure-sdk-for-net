...
{
    public partial class HostnameConfiguration : IUtf8JsonSerializable, IJsonModel<HostnameConfiguration>, IPersistableModel<HostnameConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CertificateStatus))
            {
                ...
                builder.AppendLine($" '{CertificateStatus.ToString()}'");
            }
