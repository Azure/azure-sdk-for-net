...
{
    public partial class HostnameConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HostnameConfiguration DeserializeHostnameConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
