...
{
    public partial class ApiManagementServiceUpdateParameters : IUtf8JsonSerializable
    {
        ...
        internal static ApiManagementServiceUpdateParameters DeserializeApiManagementServiceUpdateParameters(JsonElement element)
        {
            Optional<ApiManagementServiceSkuProperties> sku = default;
            Optional<ApiManagementServiceIdentity> identity = default;
            ...
            Optional<string> gatewayUrl = default;
            Optional<string> gatewayRegionalUrl = default;
            Optional<string> portalUrl = default;
            Optional<string> managementApiUrl = default;
            Optional<string> scmUrl = default;
            Optional<string> developerPortalUrl = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("identity"))
                {
                    ...
                    identity = ApiManagementServiceIdentity.DeserializeApiManagementServiceIdentity(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            gatewayUrl = property0.Value.GetString();
                            continue;
                        }
                        if (property0.NameEquals("gatewayRegionalUrl"))
                        {
                            gatewayRegionalUrl = property0.Value.GetString();
                            continue;
                        }
                        if (property0.NameEquals("portalUrl"))
                        {
                            portalUrl = property0.Value.GetString();
                            continue;
                        }
                        if (property0.NameEquals("managementApiUrl"))
                        {
                            managementApiUrl = property0.Value.GetString();
                            continue;
                        }
                        if (property0.NameEquals("scmUrl"))
                        {
                            scmUrl = property0.Value.GetString();
                            continue;
                        }
                        if (property0.NameEquals("developerPortalUrl"))
                        {
                            developerPortalUrl = property0.Value.GetString();
                            continue;
                        }
            ...
            return new ApiManagementServiceUpdateParameters(id, name, type, Optional.ToDictionary(tags), sku.Value, identity.Value, etag.Value, Optional.ToList(zones), notificationSenderEmail.Value, provisioningState.Value, targetProvisioningState.Value, Optional.ToNullable(createdAtUtc), gatewayUrl.Value, gatewayRegionalUrl.Value, portalUrl.Value, managementApiUrl.Value, scmUrl.Value, developerPortalUrl.Value, Optional.ToList(hostnameConfigurations), Optional.ToList(publicIPAddresses), Optional.ToList(privateIPAddresses), publicIpAddressId.Value, Optional.ToNullable(publicNetworkAccess), virtualNetworkConfiguration.Value, Optional.ToList(additionalLocations), Optional.ToDictionary(customProperties), Optional.ToList(certificates), Optional.ToNullable(enableClientCertificate), Optional.ToNullable(disableGateway), Optional.ToNullable(virtualNetworkType), apiVersionConstraint.Value, Optional.ToNullable(restore), Optional.ToList(privateEndpointConnections), Optional.ToNullable(platformVersion), publisherEmail.Value, publisherName.Value);
        }
    }
}
