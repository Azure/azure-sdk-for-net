...
{
    internal partial class TenantSettingsListResult : IUtf8JsonSerializable, IJsonModel<TenantSettingsListResult>, IPersistableModel<TenantSettingsListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TenantSettingsListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TenantSettingsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TenantSettingsListResult)} does not support '{format}' format.");
            }
