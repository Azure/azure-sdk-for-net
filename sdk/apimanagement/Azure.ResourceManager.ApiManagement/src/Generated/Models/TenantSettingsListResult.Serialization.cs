...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TenantSettingsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TenantSettingsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TenantSettingsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TenantSettingsListResult>)} interface");
            }
        ...
        string IPersistableModel<TenantSettingsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
