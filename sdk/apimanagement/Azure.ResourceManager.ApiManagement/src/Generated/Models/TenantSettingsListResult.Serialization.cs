...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static TenantSettingsListResult DeserializeTenantSettingsListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
