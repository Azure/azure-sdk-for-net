...
{
    public partial class NetworkStatusContractWithLocation : IUtf8JsonSerializable, IJsonModel<NetworkStatusContractWithLocation>, IPersistableModel<NetworkStatusContractWithLocation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkStatus))
            {
                ...
                AppendChildObject(builder, NetworkStatus, options, 2);
            }
