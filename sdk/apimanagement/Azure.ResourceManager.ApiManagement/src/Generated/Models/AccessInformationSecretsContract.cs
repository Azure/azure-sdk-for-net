...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class AccessInformationSecretsContract
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AccessInformationSecretsContract"/>. </summary>
        ...
        internal AccessInformationSecretsContract(string id, string principalId, string primaryKey, string secondaryKey, bool? enabled, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
