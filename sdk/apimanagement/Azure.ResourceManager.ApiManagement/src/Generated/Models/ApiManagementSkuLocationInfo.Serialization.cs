...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementSkuLocationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementSkuLocationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementSkuLocationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ApiManagementSkuLocationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
