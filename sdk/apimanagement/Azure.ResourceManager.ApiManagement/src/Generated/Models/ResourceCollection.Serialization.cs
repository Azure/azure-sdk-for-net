...
{
    internal partial class ResourceCollection : IUtf8JsonSerializable, IJsonModel<ResourceCollection>
    {
        ...
        internal static ResourceCollection DeserializeResourceCollection(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ResourceCollection(value ?? new ChangeTrackingList<ResourceCollectionValueItem>(), count, nextLink, serializedAdditionalRawData);
        }
