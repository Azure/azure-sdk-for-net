...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementSkuCapacity
    {
        ...
        internal ApiManagementSkuCapacity(int? minimum, int? maximum, int? @default, ApiManagementSkuCapacityScaleType? scaleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
