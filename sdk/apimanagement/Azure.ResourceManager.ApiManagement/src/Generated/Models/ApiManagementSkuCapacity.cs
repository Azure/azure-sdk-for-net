...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementSkuCapacity
    {
        ...
        internal ApiManagementSkuCapacity(int? minimum, int? maximum, int? @default, ApiManagementSkuCapacityScaleType? scaleType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
