...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OpenIdConnectProviderListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OpenIdConnectProviderListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OpenIdConnectProviderListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OpenIdConnectProviderListResult>)} interface");
            }
        ...
        string IPersistableModel<OpenIdConnectProviderListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
