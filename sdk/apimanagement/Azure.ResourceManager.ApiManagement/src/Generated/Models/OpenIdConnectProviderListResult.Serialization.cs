...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class OpenIdConnectProviderListResult : IUtf8JsonSerializable, IJsonModel<OpenIdConnectProviderListResult>
    {
        ...
        void IJsonModel<OpenIdConnectProviderListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OpenIdConnectProviderListResult)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<ApiManagementOpenIdConnectProviderData> collection && collection.IsUndefined))
            {
        ...
        internal static OpenIdConnectProviderListResult DeserializeOpenIdConnectProviderListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new OpenIdConnectProviderListResult(value ?? new ChangeTrackingList<ApiManagementOpenIdConnectProviderData>(), Optional.ToNullable(count), nextLink.Value, serializedAdditionalRawData);
        }
