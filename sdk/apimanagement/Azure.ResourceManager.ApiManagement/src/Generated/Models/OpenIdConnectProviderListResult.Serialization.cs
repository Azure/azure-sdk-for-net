...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class OpenIdConnectProviderListResult
    {
        internal static OpenIdConnectProviderListResult DeserializeOpenIdConnectProviderListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ApiManagementOpenIdConnectProviderData>> value = default;
            ...
            return new OpenIdConnectProviderListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
