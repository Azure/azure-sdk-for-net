...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiReleaseData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiReleaseData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiReleaseData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiReleaseData>)} interface");
            }
        ...
        string IPersistableModel<ApiReleaseData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
