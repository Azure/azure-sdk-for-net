...
{
    public partial class ApiReleaseData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ApiReleaseData DeserializeApiReleaseData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
