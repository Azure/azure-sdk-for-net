...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TenantAccessInfoSecretsDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TenantAccessInfoSecretsDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TenantAccessInfoSecretsDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TenantAccessInfoSecretsDetails>)} interface");
            }
        ...
        string IPersistableModel<TenantAccessInfoSecretsDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
