...
{
    public partial class ApiManagementServiceSkuProperties : IUtf8JsonSerializable, IJsonModel<ApiManagementServiceSkuProperties>, IPersistableModel<ApiManagementServiceSkuProperties>
    {
        ...
        void IJsonModel<ApiManagementServiceSkuProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiManagementServiceSkuProperties)} does not support '{format}' format.");
            }
