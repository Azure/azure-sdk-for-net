...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class PolicyDescriptionContractData : ResourceData, IJsonModel<PolicyDescriptionContractData>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PolicyDescriptionContractData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PolicyDescriptionContractData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PolicyDescriptionContractData IPersistableModel<PolicyDescriptionContractData>.Create(BinaryData data, ModelReaderWriterOptions options) => (PolicyDescriptionContractData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PolicyDescriptionContractData IJsonModel<PolicyDescriptionContractData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PolicyDescriptionContractData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PolicyDescriptionContractData DeserializePolicyDescriptionContractData(JsonElement element, ModelReaderWriterOptions options)
        {
