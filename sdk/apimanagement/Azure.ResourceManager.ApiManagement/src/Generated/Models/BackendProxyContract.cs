...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class BackendProxyContract
    {
        ...
        /// <param name="url"> WebProxy Server AbsoluteUri property which includes the entire URI stored in the Uri instance, including all fragments and query strings. </param>
        ...
        internal BackendProxyContract(string url, string username, string password)
        {
            Url = url;
            Username = username;
            Password = password;
