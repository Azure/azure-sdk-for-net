...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementSubscriptionPatch
    {
        ...
        internal ApiManagementSubscriptionPatch(string ownerId, string scope, DateTimeOffset? expireOn, string displayName, string primaryKey, string secondaryKey, SubscriptionState? state, string stateComment, bool? allowTracing, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OwnerId = ownerId;
            Scope = scope;
            ExpireOn = expireOn;
