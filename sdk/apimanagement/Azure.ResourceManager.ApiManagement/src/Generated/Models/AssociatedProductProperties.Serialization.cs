...
namespace Azure.ResourceManager.ApiManagement.Models
{
    public partial class AssociatedProductProperties : IUtf8JsonSerializable, IModelJsonSerializable<AssociatedProductProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AssociatedProductProperties>(this, options.Format);
        ...
        internal static AssociatedProductProperties DeserializeAssociatedProductProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AssociatedProductProperties(description.Value, terms.Value, Optional.ToNullable(subscriptionRequired), Optional.ToNullable(approvalRequired), Optional.ToNullable(subscriptionsLimit), Optional.ToNullable(state), id.Value, name, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="AssociatedProductProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="AssociatedProductProperties"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="AssociatedProductProperties"/>. </summary>
