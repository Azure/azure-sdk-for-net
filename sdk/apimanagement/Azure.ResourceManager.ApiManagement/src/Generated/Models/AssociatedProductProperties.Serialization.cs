...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static AssociatedProductProperties DeserializeAssociatedProductProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
