...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TokenBodyParameterContract>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TokenBodyParameterContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TokenBodyParameterContract>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TokenBodyParameterContract>)} interface");
            }
        ...
        string IPersistableModel<TokenBodyParameterContract>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
