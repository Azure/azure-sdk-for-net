...
{
    public partial class TokenBodyParameterContract : IUtf8JsonSerializable, IJsonModel<TokenBodyParameterContract>, IPersistableModel<TokenBodyParameterContract>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TokenBodyParameterContract>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<TokenBodyParameterContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(TokenBodyParameterContract)} does not support '{format}' format.");
            }
