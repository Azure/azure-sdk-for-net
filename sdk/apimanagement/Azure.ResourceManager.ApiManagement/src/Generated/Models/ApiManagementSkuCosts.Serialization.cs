...
{
    public partial class ApiManagementSkuCosts : IUtf8JsonSerializable, IJsonModel<ApiManagementSkuCosts>, IPersistableModel<ApiManagementSkuCosts>
    {
        ...
        void IJsonModel<ApiManagementSkuCosts>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiManagementSkuCosts)} does not support '{format}' format.");
            }
