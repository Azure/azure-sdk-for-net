...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementSkuCosts>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementSkuCosts>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementSkuCosts>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ApiManagementSkuCosts>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
