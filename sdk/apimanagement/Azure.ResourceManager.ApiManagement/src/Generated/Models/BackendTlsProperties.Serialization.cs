...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackendTlsProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackendTlsProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackendTlsProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackendTlsProperties>)} interface");
            }
        ...
        string IPersistableModel<BackendTlsProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
