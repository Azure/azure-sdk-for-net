...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementUserPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementUserPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementUserPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementUserPatch>)} interface");
            }
        ...
        string IPersistableModel<ApiManagementUserPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
