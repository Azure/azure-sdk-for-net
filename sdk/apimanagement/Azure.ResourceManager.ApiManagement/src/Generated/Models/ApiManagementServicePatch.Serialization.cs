...
{
    public partial class ApiManagementServicePatch : IUtf8JsonSerializable, IModelJsonSerializable<ApiManagementServicePatch>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ApiManagementServicePatch>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ApiManagementServicePatch>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiManagementServicePatch>(this, options.Format);
        ...
        internal static ApiManagementServicePatch DeserializeApiManagementServicePatch(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        ApiManagementServicePatch IModelSerializable<ApiManagementServicePatch>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiManagementServicePatch>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ApiManagementServicePatch"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ApiManagementServicePatch"/> to convert. </param>
        public static implicit operator RequestContent(ApiManagementServicePatch model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ApiManagementServicePatch"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ApiManagementServicePatch(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeApiManagementServicePatch(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
