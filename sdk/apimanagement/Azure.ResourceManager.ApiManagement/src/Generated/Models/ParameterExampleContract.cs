...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ParameterExampleContract
    {
        ...
        internal ParameterExampleContract(string summary, string description, BinaryData value, string externalValue, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Summary = summary;
