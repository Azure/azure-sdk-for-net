...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ParameterExampleContract
    {
        ...
        internal ParameterExampleContract(string summary, string description, BinaryData value, string externalValue, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Summary = summary;
