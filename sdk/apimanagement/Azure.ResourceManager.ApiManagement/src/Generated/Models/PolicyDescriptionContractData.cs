...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class PolicyDescriptionContractData : ResourceData
    {
        ...
        internal PolicyDescriptionContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PolicyDescriptionContractProperties properties) : base(id, name, resourceType, systemData)
        {
