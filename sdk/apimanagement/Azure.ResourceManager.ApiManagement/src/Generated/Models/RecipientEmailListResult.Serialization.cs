...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecipientEmailListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecipientEmailListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecipientEmailListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecipientEmailListResult>)} interface");
            }
        ...
        string IPersistableModel<RecipientEmailListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
