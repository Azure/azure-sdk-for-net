...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static ProductUpdateProperties DeserializeProductUpdateProperties(JsonElement element)
        {
            ...
            return new ProductUpdateProperties(description.Value, terms.Value, Optional.ToNullable(subscriptionRequired), Optional.ToNullable(approvalRequired), Optional.ToNullable(subscriptionsLimit), Optional.ToNullable(state), displayName.Value);
        }

        internal static ProductUpdateProperties DeserializeProductUpdateProperties(XElement element)
        {
            ...
            return new ProductUpdateProperties(description, terms, subscriptionRequired, approvalRequired, subscriptionsLimit, state, displayName);
        }
    }
}
