...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static SubscriptionCollection DeserializeSubscriptionCollection(JsonElement element)
        {
            ...
            return new SubscriptionCollection(Optional.ToList(value), Optional.ToNullable(count), nextLink.Value);
        }
    }
}
