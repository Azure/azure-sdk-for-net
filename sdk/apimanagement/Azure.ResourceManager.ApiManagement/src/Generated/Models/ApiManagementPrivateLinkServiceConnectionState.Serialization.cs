...
{
    public partial class ApiManagementPrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static ApiManagementPrivateLinkServiceConnectionState DeserializeApiManagementPrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            Core.Optional<ApiManagementPrivateEndpointServiceConnectionStatus> status = default;
            ...
            return new ApiManagementPrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
