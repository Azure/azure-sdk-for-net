...
{
    public partial class ApiCreateOrUpdateContent : IUtf8JsonSerializable, IModelJsonSerializable<ApiCreateOrUpdateContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ApiCreateOrUpdateContent>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ApiCreateOrUpdateContent>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiCreateOrUpdateContent>(this, options.Format);
            ...
            if (Optional.IsDefined(WsdlSelector))
            {
                ...
                if (WsdlSelector is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<ApiCreateOrUpdatePropertiesWsdlSelector>)WsdlSelector).Serialize(writer, options);
                }
            }
        ...
        internal static ApiCreateOrUpdateContent DeserializeApiCreateOrUpdateContent(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ApiCreateOrUpdateContent(description.Value, authenticationSettings.Value, subscriptionKeyParameterNames.Value, Optional.ToNullable(type), apiRevision.Value, apiVersion.Value, Optional.ToNullable(isCurrent), Optional.ToNullable(isOnline), apiRevisionDescription.Value, apiVersionDescription.Value, apiVersionSetId.Value, Optional.ToNullable(subscriptionRequired), termsOfServiceUri.Value, contact.Value, license.Value, sourceApiId.Value, displayName.Value, serviceUri.Value, path.Value, Optional.ToList(protocols), apiVersionSet.Value, value.Value, Optional.ToNullable(format), wsdlSelector.Value, Optional.ToNullable(apiType), rawData);
        }

        ApiCreateOrUpdateContent IModelJsonSerializable<ApiCreateOrUpdateContent>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiCreateOrUpdateContent>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeApiCreateOrUpdateContent(doc.RootElement, options);
        }

        BinaryData IModelSerializable<ApiCreateOrUpdateContent>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiCreateOrUpdateContent>(this, options.Format);
        ...
        ApiCreateOrUpdateContent IModelSerializable<ApiCreateOrUpdateContent>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ApiCreateOrUpdateContent>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ApiCreateOrUpdateContent"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ApiCreateOrUpdateContent"/> to convert. </param>
        public static implicit operator RequestContent(ApiCreateOrUpdateContent model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ApiCreateOrUpdateContent"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ApiCreateOrUpdateContent(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeApiCreateOrUpdateContent(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
