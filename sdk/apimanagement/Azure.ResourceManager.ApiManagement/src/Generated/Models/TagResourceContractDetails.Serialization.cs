...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static TagResourceContractDetails DeserializeTagResourceContractDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
