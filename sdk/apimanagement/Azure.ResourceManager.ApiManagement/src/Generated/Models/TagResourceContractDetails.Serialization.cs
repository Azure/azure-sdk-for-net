...
{
    public partial class TagResourceContractDetails : IUtf8JsonSerializable, IJsonModel<TagResourceContractDetails>, IPersistableModel<TagResourceContractDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  tag:");
                AppendChildObject(builder, Tag, options, 2);
            }

            if (Optional.IsDefined(Api))
            {
                builder.Append("  api:");
                AppendChildObject(builder, Api, options, 2);
            }

            if (Optional.IsDefined(Operation))
            {
                builder.Append("  operation:");
                AppendChildObject(builder, Operation, options, 2);
            }

            if (Optional.IsDefined(Product))
            {
                builder.Append("  product:");
                AppendChildObject(builder, Product, options, 2);
            }
