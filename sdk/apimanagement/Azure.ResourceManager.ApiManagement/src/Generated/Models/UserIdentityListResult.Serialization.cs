...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class UserIdentityListResult
    {
        internal static UserIdentityListResult DeserializeUserIdentityListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<UserIdentityContract>> value = default;
            ...
            return new UserIdentityListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
