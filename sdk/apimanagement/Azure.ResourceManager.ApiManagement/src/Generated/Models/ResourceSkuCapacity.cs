...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ResourceSkuCapacity
    {
        ...
        internal ResourceSkuCapacity(int? minimum, int? maximum, int? @default, ResourceSkuCapacityScaleType? scaleType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
