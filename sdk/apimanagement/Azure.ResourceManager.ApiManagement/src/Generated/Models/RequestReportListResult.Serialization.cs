...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RequestReportListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RequestReportListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RequestReportListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RequestReportListResult>)} interface");
            }
        ...
        string IPersistableModel<RequestReportListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
