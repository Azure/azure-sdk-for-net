...
{
    public partial class PrivateLinkResourceData : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        {
            writer.WriteStartElement(nameHint ?? "PrivateLinkResource");
        ...
        internal static PrivateLinkResourceData DeserializePrivateLinkResourceData(XElement element)
        {
            ...
            return new PrivateLinkResourceData(id, name, type, groupId, requiredMembers, requiredZoneNames);
        }
    }
}
