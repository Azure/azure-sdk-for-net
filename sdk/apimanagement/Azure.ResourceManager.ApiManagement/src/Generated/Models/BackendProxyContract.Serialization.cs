...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class BackendProxyContract : IJsonModel<BackendProxyContract>
    {
        ...
        protected virtual BackendProxyContract PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<BackendProxyContract>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<BackendProxyContract>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        BackendProxyContract IPersistableModel<BackendProxyContract>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BackendProxyContract IJsonModel<BackendProxyContract>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual BackendProxyContract JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<BackendProxyContract>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static BackendProxyContract DeserializeBackendProxyContract(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new BackendProxyContract(uri, username, password, additionalBinaryDataProperties);
        }
    }
}
