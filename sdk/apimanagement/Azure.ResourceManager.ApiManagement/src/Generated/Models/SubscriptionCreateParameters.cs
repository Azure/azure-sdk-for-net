...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class SubscriptionCreateParameters
    {
        ...
        internal SubscriptionCreateParameters(string ownerId, string scope, string displayName, string primaryKey, string secondaryKey, SubscriptionState? state, bool? allowTracing, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OwnerId = ownerId;
            Scope = scope;
