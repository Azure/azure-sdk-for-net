...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class AssociationContract : ResourceData
    {
        ...
        internal AssociationContract(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AssociationEntityProvisioningState? provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
