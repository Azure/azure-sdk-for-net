...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static ApiCreateOrUpdateProperties DeserializeApiCreateOrUpdateProperties(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("format"))
                {
                    ...
                    format = new ContentFormat(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("wsdlSelector"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
                    ...
                    wsdlSelector = ApiCreateOrUpdatePropertiesWsdlSelector.DeserializeApiCreateOrUpdatePropertiesWsdlSelector(property.Value);
                    continue;
                }
                if (property.NameEquals("apiType"))
                {
                    ...
                    apiType = new SoapApiType(property.Value.GetString());
                    continue;
                }
        ...
        internal static ApiCreateOrUpdateProperties DeserializeApiCreateOrUpdateProperties(XElement element)
        {
            ...
            {
                format = new ContentFormat(formatElement.Value);
            }
            if (element.Element("wsdlSelector") is XElement wsdlSelectorElement)
            {
                wsdlSelector = ApiCreateOrUpdatePropertiesWsdlSelector.DeserializeApiCreateOrUpdatePropertiesWsdlSelector(wsdlSelectorElement);
            }
            if (element.Element("apiType") is XElement apiTypeElement)
            {
                soapApiType = new SoapApiType(apiTypeElement.Value);
            }
