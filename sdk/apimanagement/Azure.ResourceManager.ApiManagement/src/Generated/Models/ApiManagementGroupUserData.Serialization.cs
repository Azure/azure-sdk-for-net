...
{
    public partial class ApiManagementGroupUserData : IUtf8JsonSerializable, IJsonModel<ApiManagementGroupUserData>, IPersistableModel<ApiManagementGroupUserData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RegistriesOn))
            {
                ...
                builder.AppendLine($" '{RegistriesOn.Value.ToString()}'");
            }
