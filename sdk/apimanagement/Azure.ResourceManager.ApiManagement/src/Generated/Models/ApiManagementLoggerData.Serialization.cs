...
{
    public partial class ApiManagementLoggerData : IUtf8JsonSerializable, IJsonModel<ApiManagementLoggerData>, IPersistableModel<ApiManagementLoggerData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LoggerType))
            {
                ...
                builder.AppendLine($" '{LoggerType.ToString()}'");
            }
