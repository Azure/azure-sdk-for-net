...
{
    public partial class BackendCredentialsContract : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BackendCredentialsContract DeserializeBackendCredentialsContract(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
