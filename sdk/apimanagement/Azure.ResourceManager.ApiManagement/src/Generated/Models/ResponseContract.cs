...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ResponseContract
    {
        ...
        internal ResponseContract(int statusCode, string description, IList<RepresentationContract> representations, IList<ParameterContract> headers, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StatusCode = statusCode;
