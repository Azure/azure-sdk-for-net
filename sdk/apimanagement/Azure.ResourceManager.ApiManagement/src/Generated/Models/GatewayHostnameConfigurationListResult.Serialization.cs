...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GatewayHostnameConfigurationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GatewayHostnameConfigurationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GatewayHostnameConfigurationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GatewayHostnameConfigurationListResult>)} interface");
            }
        ...
        string IPersistableModel<GatewayHostnameConfigurationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
