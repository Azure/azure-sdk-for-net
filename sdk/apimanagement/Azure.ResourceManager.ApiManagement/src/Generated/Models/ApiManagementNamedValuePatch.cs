...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementNamedValuePatch
    {
        ...
        internal ApiManagementNamedValuePatch(IList<string> tags, bool? isSecret, string displayName, string value, KeyVaultContractCreateProperties keyVault, Dictionary<string, BinaryData> rawData)
        {
            Tags = tags;
            IsSecret = isSecret;
