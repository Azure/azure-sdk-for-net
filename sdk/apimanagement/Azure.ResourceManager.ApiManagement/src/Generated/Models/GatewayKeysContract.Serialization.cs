...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GatewayKeysContract>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GatewayKeysContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GatewayKeysContract>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GatewayKeysContract>)} interface");
            }
        ...
        string IPersistableModel<GatewayKeysContract>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
