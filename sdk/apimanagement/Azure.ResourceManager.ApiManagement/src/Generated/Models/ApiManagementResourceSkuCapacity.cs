...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementResourceSkuCapacity
    {
        ...
        internal ApiManagementResourceSkuCapacity(int? minimum, int? maximum, int? @default, ApiManagementResourceSkuCapacityScaleType? scaleType, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
