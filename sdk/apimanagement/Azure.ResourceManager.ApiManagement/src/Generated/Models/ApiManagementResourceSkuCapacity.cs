...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementResourceSkuCapacity
    {
        ...
        internal ApiManagementResourceSkuCapacity(int? minimum, int? maximum, int? @default, ApiManagementResourceSkuCapacityScaleType? scaleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
