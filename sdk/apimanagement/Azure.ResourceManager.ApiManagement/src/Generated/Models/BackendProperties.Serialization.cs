...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BackendProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BackendProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BackendProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BackendProperties>)} interface");
            }
        ...
        string IPersistableModel<BackendProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
