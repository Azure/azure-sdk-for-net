...
{
    internal partial class BackendProperties : IUtf8JsonSerializable, IJsonModel<BackendProperties>, IPersistableModel<BackendProperties>
    {
        ...
        void IJsonModel<BackendProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BackendProperties)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServiceFabricCluster))
            {
                ...
                AppendChildObject(builder, ServiceFabricCluster, options, 2);
            }
