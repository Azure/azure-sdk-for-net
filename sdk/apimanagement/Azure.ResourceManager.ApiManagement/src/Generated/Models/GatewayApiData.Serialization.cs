...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GatewayApiData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GatewayApiData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GatewayApiData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GatewayApiData>)} interface");
            }
        ...
        string IPersistableModel<GatewayApiData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
