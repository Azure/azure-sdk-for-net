...
{
    public partial class GatewayApiData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GatewayApiData DeserializeGatewayApiData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
