...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class RegionListResult
    {
        internal static RegionListResult DeserializeRegionListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<RegionContract>> value = default;
            ...
            return new RegionListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
