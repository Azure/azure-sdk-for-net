...
{
    public partial class PortalSettingsContractData : IUtf8JsonSerializable, IJsonModel<PortalSettingsContractData>, IPersistableModel<PortalSettingsContractData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsSubscriptions))
            {
                ...
                AppendChildObject(builder, IsSubscriptions, options, 2);
            }

            if (Optional.IsDefined(IsUserRegistration))
            {
                builder.Append("  userRegistration:");
                AppendChildObject(builder, IsUserRegistration, options, 2);
            }
