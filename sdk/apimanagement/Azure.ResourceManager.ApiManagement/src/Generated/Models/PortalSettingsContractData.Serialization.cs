...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PortalSettingsContractData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PortalSettingsContractData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PortalSettingsContractData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PortalSettingsContractData>)} interface");
            }
        ...
        string IPersistableModel<PortalSettingsContractData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
