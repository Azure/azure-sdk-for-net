...
namespace Azure.ResourceManager.ApiManagement.Models
{
    public partial class PortalSettingsContractData : IUtf8JsonSerializable, IModelJsonSerializable<PortalSettingsContractData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PortalSettingsContractData>(this, options.Format);
            ...
            if (Optional.IsDefined(IsSubscriptions))
            {
                ...
                {
                    ((IModelJsonSerializable<SubscriptionDelegationSettingProperties>)IsSubscriptions).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(IsUserRegistration))
            {
                ...
                {
                    ((IModelJsonSerializable<RegistrationDelegationSettingProperties>)IsUserRegistration).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="PortalSettingsContractData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PortalSettingsContractData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PortalSettingsContractData"/>. </summary>
