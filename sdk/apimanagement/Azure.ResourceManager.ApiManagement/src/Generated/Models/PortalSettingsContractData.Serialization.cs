...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class PortalSettingsContractData : ResourceData, IJsonModel<PortalSettingsContractData>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ResourceData PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PortalSettingsContractData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PortalSettingsContractData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PortalSettingsContractData IPersistableModel<PortalSettingsContractData>.Create(BinaryData data, ModelReaderWriterOptions options) => (PortalSettingsContractData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PortalSettingsContractData IJsonModel<PortalSettingsContractData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (PortalSettingsContractData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PortalSettingsContractData DeserializePortalSettingsContractData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            PortalSettingsContractProperties properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = PortalSettingsContractProperties.DeserializePortalSettingsContractProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
