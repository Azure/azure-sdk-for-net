...
{
    public partial class AssociatedTagProperties : IUtf8JsonSerializable, IJsonModel<AssociatedTagProperties>, IPersistableModel<AssociatedTagProperties>
    {
        ...
        void IJsonModel<AssociatedTagProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AssociatedTagProperties)} does not support '{format}' format.");
            }
