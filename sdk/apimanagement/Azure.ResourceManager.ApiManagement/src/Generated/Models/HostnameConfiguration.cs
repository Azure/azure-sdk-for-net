...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class HostnameConfiguration
    {
        ...
        /// <param name="enableDefaultSslBinding"> Specify true to setup the certificate associated with this Hostname as the Default SSL Certificate. If a client does not send the SNI header, then this will be the certificate that will be challenged. The property is useful if a service has multiple custom hostname enabled and it needs to decide on the default ssl certificate. The setting only applied to Proxy Hostname Type. </param>
        /// <param name="enableClientCertificateNegotiation"> Specify true to always negotiate client certificate on the hostname. Default Value is false. </param>
        ...
        internal HostnameConfiguration(HostnameType hostnameType, string hostName, Uri keyVaultSecretUri, string identityClientId, string encodedCertificate, string certificatePassword, bool? enableDefaultSslBinding, bool? enableClientCertificateNegotiation, CertificateInformation certificate, CertificateSource? certificateSource, CertificateStatus? certificateStatus)
        {
            HostnameType = hostnameType;
            HostName = hostName;
            ...
            EnableDefaultSslBinding = enableDefaultSslBinding;
            EnableClientCertificateNegotiation = enableClientCertificateNegotiation;
