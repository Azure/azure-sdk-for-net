...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class HostnameConfiguration
    {
        ...
        internal HostnameConfiguration(HostnameType hostnameType, string hostName, Uri keyVaultSecretUri, string identityClientId, string encodedCertificate, string certificatePassword, bool? defaultSslBinding, bool? negotiateClientCertificate, CertificateInformation certificate, CertificateSource? certificateSource, CertificateStatus? certificateStatus, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            HostnameType = hostnameType;
            HostName = hostName;
