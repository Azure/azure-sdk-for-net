...
{
    public partial class ApiManagementServiceGetDomainOwnershipIdentifierResult : IUtf8JsonSerializable, IJsonModel<ApiManagementServiceGetDomainOwnershipIdentifierResult>, IPersistableModel<ApiManagementServiceGetDomainOwnershipIdentifierResult>
    {
        ...
        void IJsonModel<ApiManagementServiceGetDomainOwnershipIdentifierResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ApiManagementServiceGetDomainOwnershipIdentifierResult)} does not support '{format}' format.");
            }
