...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IssueContractData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IssueContractData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IssueContractData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IssueContractData>)} interface");
            }
        ...
        string IPersistableModel<IssueContractData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
