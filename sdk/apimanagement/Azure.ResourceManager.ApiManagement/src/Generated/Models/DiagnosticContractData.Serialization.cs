...
{
    public partial class DiagnosticContractData : IUtf8JsonSerializable, IJsonModel<DiagnosticContractData>, IPersistableModel<DiagnosticContractData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AlwaysLog))
            {
                ...
                builder.AppendLine($" '{AlwaysLog.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Sampling))
            {
                ...
                AppendChildObject(builder, Sampling, options, 2);
            }

            if (Optional.IsDefined(Frontend))
            {
                builder.Append("  frontend:");
                AppendChildObject(builder, Frontend, options, 2);
            }

            if (Optional.IsDefined(Backend))
            {
                builder.Append("  backend:");
                AppendChildObject(builder, Backend, options, 2);
            }
            ...
            if (Optional.IsDefined(HttpCorrelationProtocol))
            {
                ...
                builder.AppendLine($" '{HttpCorrelationProtocol.ToString()}'");
            }

            if (Optional.IsDefined(Verbosity))
            {
                builder.Append("  verbosity:");
                builder.AppendLine($" '{Verbosity.ToString()}'");
            }

            if (Optional.IsDefined(OperationNameFormat))
            {
                builder.Append("  operationNameFormat:");
                builder.AppendLine($" '{OperationNameFormat.ToString()}'");
            }
