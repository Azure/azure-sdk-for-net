...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static ApiManagementSkuZoneDetails DeserializeApiManagementSkuZoneDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
