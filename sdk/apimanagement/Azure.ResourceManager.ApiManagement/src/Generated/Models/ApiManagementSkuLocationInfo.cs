...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementSkuLocationInfo
    {
        ...
        internal ApiManagementSkuLocationInfo(AzureLocation? location, IReadOnlyList<string> zones, IReadOnlyList<ApiManagementSkuZoneDetails> zoneDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Zones = zones;
