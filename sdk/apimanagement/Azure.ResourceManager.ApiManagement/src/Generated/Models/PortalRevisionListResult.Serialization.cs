...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static PortalRevisionListResult DeserializePortalRevisionListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
