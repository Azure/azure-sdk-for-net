...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PortalRevisionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PortalRevisionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PortalRevisionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PortalRevisionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
