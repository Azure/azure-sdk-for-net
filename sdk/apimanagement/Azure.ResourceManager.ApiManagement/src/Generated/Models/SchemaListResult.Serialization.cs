...
{
    internal partial class SchemaListResult : IUtf8JsonSerializable, IJsonModel<SchemaListResult>, IPersistableModel<SchemaListResult>
    {
        ...
        void IJsonModel<SchemaListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SchemaListResult)} does not support '{format}' format.");
            }
