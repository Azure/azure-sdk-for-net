...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SchemaListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SchemaListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SchemaListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SchemaListResult>)} interface");
            }
        ...
        string IPersistableModel<SchemaListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
