...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class NamedValueContractCreateOrUpdateContent : ResourceData
    {
        /// <summary> Initializes a new instance of NamedValueContractCreateOrUpdateContent. </summary>
        ...
        internal NamedValueContractCreateOrUpdateContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<string> tags, bool? secret, string displayName, string value, KeyVaultContractCreateProperties keyVault) : base(id, name, resourceType, systemData)
        {
            Tags = tags;
            Secret = secret;
