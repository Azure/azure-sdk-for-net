...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiVersionSetContractData : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        internal static ApiVersionSetContractData DeserializeApiVersionSetContractData(JsonElement element)
        {
            ...
            return new ApiVersionSetContractData(id, name, type, description.Value, versionQueryName.Value, versionHeaderName.Value, displayName.Value, Optional.ToNullable(versioningScheme));
        }
        ...
        internal static ApiVersionSetContractData DeserializeApiVersionSetContractData(XElement element)
        {
            ...
            return new ApiVersionSetContractData(id, name, type, description, versionQueryName, versionHeaderName, displayName, versioningScheme);
        }
    }
}
