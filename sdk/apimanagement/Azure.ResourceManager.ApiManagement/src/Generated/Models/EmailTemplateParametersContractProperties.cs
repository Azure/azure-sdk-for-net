...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class EmailTemplateParametersContractProperties
    {
        ...
        internal EmailTemplateParametersContractProperties(string name, string title, string description, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Title = title;
