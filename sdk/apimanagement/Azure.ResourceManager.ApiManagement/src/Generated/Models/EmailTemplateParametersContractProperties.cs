...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class EmailTemplateParametersContractProperties
    {
        ...
        internal EmailTemplateParametersContractProperties(string name, string title, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Title = title;
