...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RemotePrivateEndpointConnectionWrapper>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RemotePrivateEndpointConnectionWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RemotePrivateEndpointConnectionWrapper>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RemotePrivateEndpointConnectionWrapper>)} interface");
            }
        ...
        string IPersistableModel<RemotePrivateEndpointConnectionWrapper>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
