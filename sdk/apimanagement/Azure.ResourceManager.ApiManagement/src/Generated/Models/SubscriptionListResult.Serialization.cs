...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class SubscriptionListResult
    {
        internal static SubscriptionListResult DeserializeSubscriptionListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<SubscriptionContractData>> value = default;
            ...
            return new SubscriptionListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
