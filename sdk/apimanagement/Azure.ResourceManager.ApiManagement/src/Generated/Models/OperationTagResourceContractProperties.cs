...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class OperationTagResourceContractProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="OperationTagResourceContractProperties"/>. </summary>
        ...
        internal OperationTagResourceContractProperties(string id, string name, string apiName, string apiRevision, string apiVersion, string description, string @method, string urlTemplate, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            ApiName = apiName;
