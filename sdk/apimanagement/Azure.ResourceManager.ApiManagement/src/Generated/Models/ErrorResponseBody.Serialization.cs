...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ErrorResponseBody>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ErrorResponseBody>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ErrorResponseBody>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ErrorResponseBody>)} interface");
            }
        ...
        string IPersistableModel<ErrorResponseBody>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
