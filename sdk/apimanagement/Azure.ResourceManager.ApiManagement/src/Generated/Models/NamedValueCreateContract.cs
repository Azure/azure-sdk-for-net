...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        /// <summary> Initializes a new instance of NamedValueCreateContract. </summary>
        ...
        internal NamedValueCreateContract(ResourceIdentifier id, string name, ResourceType type, IList<string> tags, bool? secret, string displayName, string value, KeyVaultContractCreateProperties keyVault) : base(id, name, type)
        {
            Tags = tags;
            Secret = secret;
