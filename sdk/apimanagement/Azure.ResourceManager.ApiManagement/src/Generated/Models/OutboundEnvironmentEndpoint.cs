...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class OutboundEnvironmentEndpoint
    {
        ...
        internal OutboundEnvironmentEndpoint(string category, IReadOnlyList<EndpointDependency> endpoints, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Endpoints = endpoints;
