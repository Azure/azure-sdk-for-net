...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class OutboundEnvironmentEndpoint
    {
        ...
        internal OutboundEnvironmentEndpoint(string category, IReadOnlyList<EndpointDependency> endpoints, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Category = category;
            Endpoints = endpoints;
