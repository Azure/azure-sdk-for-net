...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IssueCommentListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IssueCommentListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IssueCommentListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IssueCommentListResult>)} interface");
            }
        ...
        string IPersistableModel<IssueCommentListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
