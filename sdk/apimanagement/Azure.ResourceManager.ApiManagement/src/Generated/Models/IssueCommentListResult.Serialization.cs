...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IssueCommentListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IssueCommentListResult)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<ApiIssueCommentData>)item).Write(writer, options);
                }
        ...
        IssueCommentListResult IJsonModel<IssueCommentListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IssueCommentListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static IssueCommentListResult DeserializeIssueCommentListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new IssueCommentListResult(value ?? new ChangeTrackingList<ApiIssueCommentData>(), count, nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<IssueCommentListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IssueCommentListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        IssueCommentListResult IPersistableModel<IssueCommentListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IssueCommentListResult)} does not support reading '{options.Format}' format.");
            }
        }
