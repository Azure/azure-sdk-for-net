...
namespace Azure.ResourceManager.ApiManagement.Models
{
    public partial class ApiManagementResourceSkuCapacity : IUtf8JsonSerializable, IJsonModel<ApiManagementResourceSkuCapacity>
    {
        ...
        void IJsonModel<ApiManagementResourceSkuCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ApiManagementResourceSkuCapacity)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ApiManagementResourceSkuCapacity>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ApiManagementResourceSkuCapacity)} does not support '{options.Format}' format.");
            }
        }
