...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementUserPatch
    {
        ...
        internal ApiManagementUserPatch(ApiManagementUserState? state, string note, IList<UserIdentityContract> identities, string email, string password, string firstName, string lastName, Dictionary<string, BinaryData> rawData)
        {
            State = state;
            Note = note;
