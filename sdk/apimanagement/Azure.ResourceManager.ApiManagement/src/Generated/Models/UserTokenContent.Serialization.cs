...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UserTokenContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UserTokenContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UserTokenContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UserTokenContent>)} interface");
            }
        ...
        string IPersistableModel<UserTokenContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
