...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ParameterContract
    {
        ...
        internal ParameterContract(string name, string description, string parameterContractType, string defaultValue, bool? isRequired, IList<string> values, string schemaId, string typeName, IDictionary<string, ParameterExampleContract> examples, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
