...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiCreateOrUpdatePropertiesWsdlSelector>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ApiCreateOrUpdatePropertiesWsdlSelector IJsonModel<ApiCreateOrUpdatePropertiesWsdlSelector>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ApiCreateOrUpdatePropertiesWsdlSelector>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ApiCreateOrUpdatePropertiesWsdlSelector IModel<ApiCreateOrUpdatePropertiesWsdlSelector>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ApiCreateOrUpdatePropertiesWsdlSelector>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
