...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class OperationContractData : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        internal static OperationContractData DeserializeOperationContractData(JsonElement element)
        {
            ...
            return new OperationContractData(id, name, type, Optional.ToList(templateParameters), description.Value, request.Value, Optional.ToList(responses), policies.Value, displayName.Value, method.Value, urlTemplate.Value);
        }
        ...
        internal static OperationContractData DeserializeOperationContractData(XElement element)
        {
            ...
            responses = array0;
            return new OperationContractData(id, name, type, templateParameters, description, request, responses, policies, displayName, method, urlTemplate);
        }
    }
}
