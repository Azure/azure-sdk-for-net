...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class KeyVaultContractCreateProperties : IJsonModel<KeyVaultContractCreateProperties>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual KeyVaultContractCreateProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<KeyVaultContractCreateProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<KeyVaultContractCreateProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        KeyVaultContractCreateProperties IPersistableModel<KeyVaultContractCreateProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        KeyVaultContractCreateProperties IJsonModel<KeyVaultContractCreateProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual KeyVaultContractCreateProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<KeyVaultContractCreateProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static KeyVaultContractCreateProperties DeserializeKeyVaultContractCreateProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new KeyVaultContractCreateProperties(secretIdentifier, identityClientId, additionalBinaryDataProperties);
        }
    }
}
