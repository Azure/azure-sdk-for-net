...
{
    public partial class KeyVaultContractCreateProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KeyVaultContractCreateProperties DeserializeKeyVaultContractCreateProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
