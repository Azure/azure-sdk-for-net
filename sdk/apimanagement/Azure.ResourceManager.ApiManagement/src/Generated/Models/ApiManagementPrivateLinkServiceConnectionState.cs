...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementPrivateLinkServiceConnectionState
    {
        ...
        internal ApiManagementPrivateLinkServiceConnectionState(ApiManagementPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
