...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementBackendPatch
    {
        ...
        internal ApiManagementBackendPatch(string title, string description, Uri resourceUri, BackendProperties properties, BackendCredentialsContract credentials, BackendProxyContract proxy, BackendTlsProperties tls, Uri uri, BackendProtocol? protocol, Dictionary<string, BinaryData> rawData)
        {
            Title = title;
