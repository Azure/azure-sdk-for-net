...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class TagResourceContractDetails
    {
        ...
        internal TagResourceContractDetails(AssociatedTagProperties tag, AssociatedApiProperties api, AssociatedOperationProperties operation, AssociatedProductProperties product, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tag = tag;
            Api = api;
            Operation = operation;
