...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class AssociatedOperationProperties
    {
        ...
        internal AssociatedOperationProperties(string id, string name, string apiName, string apiRevision, string apiVersion, string description, string method, string uriTemplate, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            ApiName = apiName;
