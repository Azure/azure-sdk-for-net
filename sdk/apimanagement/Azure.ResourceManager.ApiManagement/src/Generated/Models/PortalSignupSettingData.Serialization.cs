...
{
    public partial class PortalSignupSettingData : IUtf8JsonSerializable
    {
        ...
        internal static PortalSignupSettingData DeserializePortalSignupSettingData(JsonElement element)
        {
            ...
            return new PortalSignupSettingData(id, name, type, systemData.Value, Optional.ToNullable(enabled), termsOfService.Value);
        }
    }
}
