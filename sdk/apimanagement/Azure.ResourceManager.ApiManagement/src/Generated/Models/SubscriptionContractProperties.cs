...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    internal partial class SubscriptionContractProperties
    {
        ...
        internal SubscriptionContractProperties(string ownerId, string scope, string displayName, SubscriptionState state, DateTimeOffset? createdOn, DateTimeOffset? startsOn, DateTimeOffset? expireOn, DateTimeOffset? endsOn, DateTimeOffset? notifiesOn, string primaryKey, string secondaryKey, string stateComment, bool? allowTracing, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            OwnerId = ownerId;
            Scope = scope;
