...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    internal partial class SubscriptionContractProperties
    {
        ...
        /// <param name="startsOn"> Subscription activation date. The setting is for audit purposes only and the subscription is not automatically activated. The subscription lifecycle can be managed by using the `state` property. The date conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as specified by the ISO 8601 standard. </param>
        ...
        /// <param name="endsOn"> Date when subscription was cancelled or expired. The setting is for audit purposes only and the subscription is not automatically cancelled. The subscription lifecycle can be managed by using the `state` property. The date conforms to the following format: `yyyy-MM-ddTHH:mm:ssZ` as specified by the ISO 8601 standard. </param>
        ...
        internal SubscriptionContractProperties(string ownerId, string scope, string displayName, SubscriptionState state, DateTimeOffset? createdOn, DateTimeOffset? startsOn, DateTimeOffset? expiresOn, DateTimeOffset? endsOn, DateTimeOffset? notifiesOn, string primaryKey, string secondaryKey, string stateComment, bool? allowTracing, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            OwnerId = ownerId;
            Scope = scope;
