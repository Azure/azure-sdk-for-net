...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class ApiManagementPrivateEndpointConnectionListResult
    {
        internal static ApiManagementPrivateEndpointConnectionListResult DeserializeApiManagementPrivateEndpointConnectionListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ApiManagementPrivateEndpointConnectionData>> value = default;
            ...
            return new ApiManagementPrivateEndpointConnectionListResult(Core.Optional.ToList(value));
        }
    }
}
