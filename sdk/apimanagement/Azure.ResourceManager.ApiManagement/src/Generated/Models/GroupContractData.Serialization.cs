...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class GroupContractData : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        internal static GroupContractData DeserializeGroupContractData(JsonElement element)
        {
            ...
            return new GroupContractData(id, name, type, displayName.Value, description.Value, Optional.ToNullable(builtIn), Optional.ToNullable(type0), externalId.Value);
        }
        ...
        internal static GroupContractData DeserializeGroupContractData(XElement element)
        {
            ...
            return new GroupContractData(id, name, type, displayName, description, builtIn, typePropertiesType, externalId);
        }
    }
}
