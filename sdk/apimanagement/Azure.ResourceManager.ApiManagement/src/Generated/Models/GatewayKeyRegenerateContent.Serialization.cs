...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GatewayKeyRegenerateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GatewayKeyRegenerateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GatewayKeyRegenerateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GatewayKeyRegenerateContent>)} interface");
            }
        ...
        string IPersistableModel<GatewayKeyRegenerateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
