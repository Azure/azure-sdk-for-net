...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CertificateInformation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CertificateInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CertificateInformation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CertificateInformation>)} interface");
            }
        ...
        string IPersistableModel<CertificateInformation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
