...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ApiTagResourceContractProperties. </summary>
        ...
        /// <param name="serviceUrl"> Absolute URL of the backend service implementing this API. </param>
        ...
        internal ApiTagResourceContractProperties(string description, AuthenticationSettingsContract authenticationSettings, SubscriptionKeyParameterNamesContract subscriptionKeyParameterNames, ApiType? apiType, string apiRevision, string apiVersion, bool? isCurrent, bool? isOnline, string apiRevisionDescription, string apiVersionDescription, string apiVersionSetId, bool? subscriptionRequired, string termsOfServiceUrl, ApiContactInformation contact, ApiLicenseInformation license, string id, string name, string serviceUrl, string path, IReadOnlyList<Protocol> protocols) : base(description, authenticationSettings, subscriptionKeyParameterNames, apiType, apiRevision, apiVersion, isCurrent, isOnline, apiRevisionDescription, apiVersionDescription, apiVersionSetId, subscriptionRequired, termsOfServiceUrl, contact, license)
        {
            Id = id;
            Name = name;
