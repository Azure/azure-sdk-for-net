...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementGroupCreateOrUpdateContent
    {
        ...
        internal ApiManagementGroupCreateOrUpdateContent(string displayName, string description, ApiManagementGroupType? apiManagementGroupType, string externalId, Dictionary<string, BinaryData> rawData)
        {
