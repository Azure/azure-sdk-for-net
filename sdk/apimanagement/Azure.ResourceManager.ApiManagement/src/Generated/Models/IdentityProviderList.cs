...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    internal partial class IdentityProviderList
    {
        ...
        {
            Value = new ChangeTrackingList<IdentityProviderContractData>();
        }
        ...
        internal IdentityProviderList(IReadOnlyList<IdentityProviderContractData> value, long? count, string nextLink)
        {
            Value = value;
            Count = count;
            NextLink = nextLink;
        ...
        public IReadOnlyList<IdentityProviderContractData> Value { get; }
