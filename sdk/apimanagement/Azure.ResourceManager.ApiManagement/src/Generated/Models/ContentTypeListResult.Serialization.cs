...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentTypeListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContentTypeListResult)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<ApiManagementContentType>)item).Write(writer, options);
                }
        ...
        ContentTypeListResult IJsonModel<ContentTypeListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContentTypeListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static ContentTypeListResult DeserializeContentTypeListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ContentTypeListResult(value ?? new ChangeTrackingList<ApiManagementContentType>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<ContentTypeListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContentTypeListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ContentTypeListResult IPersistableModel<ContentTypeListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContentTypeListResult)} does not support reading '{options.Format}' format.");
            }
        }
