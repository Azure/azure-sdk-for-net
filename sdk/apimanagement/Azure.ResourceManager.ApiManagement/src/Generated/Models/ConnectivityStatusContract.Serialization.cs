...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static ConnectivityStatusContract DeserializeConnectivityStatusContract(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
