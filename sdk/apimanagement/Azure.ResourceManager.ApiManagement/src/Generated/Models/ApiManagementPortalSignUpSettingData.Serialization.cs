...
{
    public partial class ApiManagementPortalSignUpSettingData : IUtf8JsonSerializable, IJsonModel<ApiManagementPortalSignUpSettingData>, IPersistableModel<ApiManagementPortalSignUpSettingData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsSignUpDeveloperPortalEnabled))
            {
                ...
                var boolValue = IsSignUpDeveloperPortalEnabled.Value == true ? "true" : "false";
            ...
            if (Optional.IsDefined(TermsOfService))
            {
                ...
                AppendChildObject(builder, TermsOfService, options, 2);
            }
