...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AuthorizationServerContractProperties"/>. </summary>
        ...
        public AuthorizationServerContractProperties(string displayName, string clientRegistrationEndpoint, string authorizationEndpoint, IEnumerable<GrantType> grantTypes, string clientId)
        {
            Argument.AssertNotNull(displayName, nameof(displayName));
            Argument.AssertNotNull(clientRegistrationEndpoint, nameof(clientRegistrationEndpoint));
            Argument.AssertNotNull(authorizationEndpoint, nameof(authorizationEndpoint));
            Argument.AssertNotNull(grantTypes, nameof(grantTypes));
