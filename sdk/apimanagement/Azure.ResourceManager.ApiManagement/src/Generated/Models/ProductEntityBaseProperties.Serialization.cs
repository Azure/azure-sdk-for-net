...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static ProductEntityBaseProperties DeserializeProductEntityBaseProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
