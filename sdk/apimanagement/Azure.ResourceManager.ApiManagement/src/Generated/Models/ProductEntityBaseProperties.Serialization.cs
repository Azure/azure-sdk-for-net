...
{
    public partial class ProductEntityBaseProperties : IUtf8JsonSerializable, IJsonModel<ProductEntityBaseProperties>, IPersistableModel<ProductEntityBaseProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SubscriptionsLimit))
            {
                ...
                builder.AppendLine($" '{SubscriptionsLimit.Value.ToString()}'");
            }
