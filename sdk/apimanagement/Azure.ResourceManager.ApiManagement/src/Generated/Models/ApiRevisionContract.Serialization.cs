...
namespace Azure.ResourceManager.ApiManagement.Models
{
    public partial class ApiRevisionContract : IUtf8JsonSerializable, IModelJsonSerializable<ApiRevisionContract>
    {
        ...
        internal static ApiRevisionContract DeserializeApiRevisionContract(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ApiRevisionContract(apiId.Value, apiRevision.Value, Optional.ToNullable(createdDateTime), Optional.ToNullable(updatedDateTime), description.Value, privateUri.Value, Optional.ToNullable(isOnline), Optional.ToNullable(isCurrent), rawData);
        }
