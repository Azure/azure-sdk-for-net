...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class BackendCredentialsContract
    {
        ...
        internal BackendCredentialsContract(IList<string> certificateIds, IList<string> certificate, IDictionary<string, IList<string>> query, IDictionary<string, IList<string>> header, BackendAuthorizationHeaderCredentials authorization, Dictionary<string, BinaryData> rawData)
        {
