...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class RemotePrivateEndpointConnectionWrapper
    {
        ...
        internal RemotePrivateEndpointConnectionWrapper(ResourceIdentifier id, string name, ResourceType? resourceType, PrivateEndpointConnectionWrapperProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
