...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class RemotePrivateEndpointConnectionWrapper
    {
        ...
        internal RemotePrivateEndpointConnectionWrapper(string id, string name, string type, SubResource privateEndpoint, PrivateLinkServiceConnectionState privateLinkServiceConnectionState, string provisioningState, IReadOnlyList<string> groupIds)
        {
            Id = id;
            Name = name;
            Type = type;
