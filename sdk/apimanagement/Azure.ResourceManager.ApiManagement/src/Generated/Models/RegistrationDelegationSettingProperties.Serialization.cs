...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegistrationDelegationSettingProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RegistrationDelegationSettingProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RegistrationDelegationSettingProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RegistrationDelegationSettingProperties>)} interface");
            }
        ...
        string IPersistableModel<RegistrationDelegationSettingProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
