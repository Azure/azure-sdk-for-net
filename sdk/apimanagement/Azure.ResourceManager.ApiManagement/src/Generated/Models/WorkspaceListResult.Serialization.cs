    ...
    internal partial class WorkspaceListResult : IUtf8JsonSerializable, IJsonModel<WorkspaceListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<WorkspaceContractData>)item).Write(writer, options);
                }
        ...
        internal static WorkspaceListResult DeserializeWorkspaceListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<WorkspaceContractData> value = default;
            long? count = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    List<WorkspaceContractData> array = new List<WorkspaceContractData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(WorkspaceContractData.DeserializeWorkspaceContractData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new WorkspaceListResult(value ?? new ChangeTrackingList<WorkspaceContractData>(), count, nextLink, serializedAdditionalRawData);
        }
