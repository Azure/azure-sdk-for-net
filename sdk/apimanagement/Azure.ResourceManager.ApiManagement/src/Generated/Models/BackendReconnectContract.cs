...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class BackendReconnectContract : ResourceData
    {
        ...
        /// <param name="properties"> Reconnect request properties. </param>
        internal BackendReconnectContract(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, BackendReconnectProperties properties) : base(id, name, resourceType, systemData)
        {
        ...
        public TimeSpan? After
        {
            get
            {
                return Properties is null ? default : Properties.After;
            }
            set
            {
