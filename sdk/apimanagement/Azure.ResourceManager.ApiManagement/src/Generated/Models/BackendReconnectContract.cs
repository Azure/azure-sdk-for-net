...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class BackendReconnectContract : ResourceData
    {
        ...
        internal BackendReconnectContract(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TimeSpan? after, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            After = after;
