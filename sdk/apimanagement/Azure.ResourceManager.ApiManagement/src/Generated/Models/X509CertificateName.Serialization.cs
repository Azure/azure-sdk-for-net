...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<X509CertificateName>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<X509CertificateName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<X509CertificateName>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<X509CertificateName>)} interface");
            }
        ...
        string IPersistableModel<X509CertificateName>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
