...
namespace Azure.ResourceManager.ApiManagement.Models
{
    public partial class TenantConfigurationSyncStateContract : IUtf8JsonSerializable, IXmlSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(SyncDate))
            {
                writer.WritePropertyName("syncDate");
                writer.WriteStringValue(SyncDate.Value, "O");
            }
            if (Optional.IsDefined(ConfigurationChangeDate))
            {
                writer.WritePropertyName("configurationChangeDate");
                writer.WriteStringValue(ConfigurationChangeDate.Value, "O");
            }
        ...
        internal static TenantConfigurationSyncStateContract DeserializeTenantConfigurationSyncStateContract(JsonElement element)
        {
            ...
            return new TenantConfigurationSyncStateContract(id, name, type, branch.Value, commitId.Value, Optional.ToNullable(isExport), Optional.ToNullable(isSynced), Optional.ToNullable(isGitEnabled), Optional.ToNullable(syncDate), Optional.ToNullable(configurationChangeDate), lastOperationId.Value);
        }
        ...
        void IXmlSerializable.Write(XmlWriter writer, string nameHint)
        {
            ...
            if (Optional.IsDefined(SyncDate))
            {
                ...
                writer.WriteValue(SyncDate.Value, "O");
                writer.WriteEndElement();
            }
            if (Optional.IsDefined(ConfigurationChangeDate))
            {
                writer.WriteStartElement("configurationChangeDate");
                writer.WriteValue(ConfigurationChangeDate.Value, "O");
                writer.WriteEndElement();
            }
            if (Optional.IsDefined(LastOperationId))
            {
        ...
        internal static TenantConfigurationSyncStateContract DeserializeTenantConfigurationSyncStateContract(XElement element)
        {
            ...
            {
                syncDate = syncDateElement.GetDateTimeOffsetValue("O");
            }
            if (element.Element("configurationChangeDate") is XElement configurationChangeDateElement)
            {
                configurationChangeDate = configurationChangeDateElement.GetDateTimeOffsetValue("O");
            }
            ...
            return new TenantConfigurationSyncStateContract(id, name, type, branch, commitId, isExport, isSynced, isGitEnabled, syncDate, configurationChangeDate, lastOperationId);
        }
    }
}
