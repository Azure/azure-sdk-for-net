...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TenantConfigurationSyncStateContract>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TenantConfigurationSyncStateContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TenantConfigurationSyncStateContract>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TenantConfigurationSyncStateContract>)} interface");
            }
        ...
        string IPersistableModel<TenantConfigurationSyncStateContract>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
