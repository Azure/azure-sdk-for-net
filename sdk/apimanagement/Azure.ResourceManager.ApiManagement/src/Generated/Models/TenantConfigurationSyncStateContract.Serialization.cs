...
{
    public partial class TenantConfigurationSyncStateContract : IUtf8JsonSerializable, IJsonModel<TenantConfigurationSyncStateContract>, IPersistableModel<TenantConfigurationSyncStateContract>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SyncOn))
            {
                ...
                builder.AppendLine($" '{SyncOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(ConfigurationChangeOn))
            {
                builder.Append("  configurationChangeDate:");
                builder.AppendLine($" '{ConfigurationChangeOn.Value.ToString()}'");
            }
