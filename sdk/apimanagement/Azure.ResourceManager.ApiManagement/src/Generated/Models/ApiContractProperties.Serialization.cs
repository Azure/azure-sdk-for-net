...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        internal static ApiContractProperties DeserializeApiContractProperties(JsonElement element)
        {
            ...
            {
                if (property.NameEquals("sourceApiId"))
                {
                    sourceApiId = property.Value.GetString();
                    continue;
                }
                ...
                if (property.NameEquals("apiVersionSet"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
                    ...
                    apiVersionSet = ApiVersionSetContractDetails.DeserializeApiVersionSetContractDetails(property.Value);
                    continue;
                }
