...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class RepresentationContract
    {
        ...
        internal RepresentationContract(string contentType, string schemaId, string typeName, IList<ParameterContract> formParameters, IDictionary<string, ParameterExampleContract> examples, Dictionary<string, BinaryData> rawData)
        {
            ContentType = contentType;
            SchemaId = schemaId;
            TypeName = typeName;
