...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class RequestContract
    {
        ...
        internal RequestContract(string description, IList<ParameterContract> queryParameters, IList<ParameterContract> headers, IList<RepresentationContract> representations, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
