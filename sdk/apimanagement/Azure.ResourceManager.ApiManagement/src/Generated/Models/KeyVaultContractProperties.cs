...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class KeyVaultContractProperties : KeyVaultContractCreateProperties
    {
        ...
        internal KeyVaultContractProperties(string secretIdentifier, string identityClientId, KeyVaultLastAccessStatusContractProperties lastStatus, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(secretIdentifier, identityClientId, serializedAdditionalRawData)
        {
