...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ConnectivityCheckRequestHttpConfiguration
    {
        ...
        internal ConnectivityCheckRequestHttpConfiguration(HttpMethodConfiguration? method, IList<long> validStatusCodes, IList<HttpHeaderConfiguration> headers, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Method = method;
