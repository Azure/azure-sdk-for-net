...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class CertificateListResult
    {
        internal static CertificateListResult DeserializeCertificateListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ApiManagementCertificateData>> value = default;
            ...
            return new CertificateListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
