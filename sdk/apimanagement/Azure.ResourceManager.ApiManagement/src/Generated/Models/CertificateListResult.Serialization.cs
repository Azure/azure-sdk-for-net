...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CertificateListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CertificateListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CertificateListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CertificateListResult>)} interface");
            }
        ...
        string IPersistableModel<CertificateListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
