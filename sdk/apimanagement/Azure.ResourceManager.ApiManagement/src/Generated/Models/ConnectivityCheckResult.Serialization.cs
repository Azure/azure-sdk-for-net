...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectivityCheckResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectivityCheckResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectivityCheckResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectivityCheckResult>)} interface");
            }
        ...
        string IPersistableModel<ConnectivityCheckResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
