...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectivityCheckRequestProtocolConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectivityCheckRequestProtocolConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectivityCheckRequestProtocolConfiguration>)} interface");
            }
        ...
        string IPersistableModel<ConnectivityCheckRequestProtocolConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
