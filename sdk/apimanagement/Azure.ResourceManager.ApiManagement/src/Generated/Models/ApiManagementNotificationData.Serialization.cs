...
{
    public partial class ApiManagementNotificationData : IUtf8JsonSerializable, IJsonModel<ApiManagementNotificationData>, IPersistableModel<ApiManagementNotificationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Recipients))
            {
                ...
                AppendChildObject(builder, Recipients, options, 2);
            }
