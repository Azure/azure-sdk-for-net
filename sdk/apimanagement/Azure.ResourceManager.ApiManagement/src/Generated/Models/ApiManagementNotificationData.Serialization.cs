...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementNotificationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementNotificationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementNotificationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementNotificationData>)} interface");
            }
        ...
        string IPersistableModel<ApiManagementNotificationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
