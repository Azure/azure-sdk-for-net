...
{
    public partial class SubscriptionKeyParameterNamesContract : IUtf8JsonSerializable, IJsonModel<SubscriptionKeyParameterNamesContract>, IPersistableModel<SubscriptionKeyParameterNamesContract>
    {
        ...
        void IJsonModel<SubscriptionKeyParameterNamesContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SubscriptionKeyParameterNamesContract)} does not support '{format}' format.");
            }
