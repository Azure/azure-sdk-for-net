...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubscriptionKeyParameterNamesContract>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SubscriptionKeyParameterNamesContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SubscriptionKeyParameterNamesContract>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SubscriptionKeyParameterNamesContract>)} interface");
            }
        ...
        string IPersistableModel<SubscriptionKeyParameterNamesContract>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
