...
namespace Azure.ResourceManager.ApiManagement.Models
{
    public partial class PortalSettingsContract : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        internal static PortalSettingsContract DeserializePortalSettingsContract(JsonElement element)
        {
            ...
            return new PortalSettingsContract(id, name, type, url.Value, validationKey.Value, subscriptions.Value, userRegistration.Value, Optional.ToNullable(enabled), termsOfService.Value);
        }
        ...
        internal static PortalSettingsContract DeserializePortalSettingsContract(XElement element)
        {
            ...
            return new PortalSettingsContract(id, name, type, url, validationKey, subscriptions, userRegistration, enabled, termsOfService);
        }
    }
}
