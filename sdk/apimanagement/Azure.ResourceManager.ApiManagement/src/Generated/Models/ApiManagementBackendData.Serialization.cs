...
{
    public partial class ApiManagementBackendData : IUtf8JsonSerializable, IJsonModel<ApiManagementBackendData>, IPersistableModel<ApiManagementBackendData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Proxy))
            {
                ...
                AppendChildObject(builder, Proxy, options, 2);
            }
