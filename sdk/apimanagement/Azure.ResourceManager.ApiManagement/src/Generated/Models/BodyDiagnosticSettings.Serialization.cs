...
{
    internal partial class BodyDiagnosticSettings : IUtf8JsonSerializable, IJsonModel<BodyDiagnosticSettings>, IPersistableModel<BodyDiagnosticSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Bytes))
            {
                ...
                builder.AppendLine($" '{Bytes.Value.ToString()}'");
            }
