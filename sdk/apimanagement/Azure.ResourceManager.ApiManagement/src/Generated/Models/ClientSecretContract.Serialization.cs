...
{
    public partial class ClientSecretContract : IUtf8JsonSerializable, IJsonModel<ClientSecretContract>, IPersistableModel<ClientSecretContract>
    {
        ...
        void IJsonModel<ClientSecretContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClientSecretContract)} does not support '{format}' format.");
            }
