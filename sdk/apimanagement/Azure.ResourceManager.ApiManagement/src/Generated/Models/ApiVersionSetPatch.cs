...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiVersionSetPatch
    {
        ...
        internal ApiVersionSetPatch(string description, string versionQueryName, string versionHeaderName, string displayName, VersioningScheme? versioningScheme, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
