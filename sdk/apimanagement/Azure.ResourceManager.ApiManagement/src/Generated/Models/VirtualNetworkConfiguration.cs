...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class VirtualNetworkConfiguration
    {
        ...
        internal VirtualNetworkConfiguration(Guid? vnetId, string subnetname, ResourceIdentifier subnetResourceId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VnetId = vnetId;
