...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class CertificateContractData : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        internal static CertificateContractData DeserializeCertificateContractData(JsonElement element)
        {
            ...
            return new CertificateContractData(id, name, type, subject.Value, thumbprint.Value, Optional.ToNullable(expirationDate), keyVault.Value);
        }
        ...
        internal static CertificateContractData DeserializeCertificateContractData(XElement element)
        {
            ...
            return new CertificateContractData(id, name, type, subject, thumbprint, expirationDate, keyVault);
        }
    }
}
