...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class BackendContractData : IUtf8JsonSerializable, IXmlSerializable
    {
        ...
        internal static BackendContractData DeserializeBackendContractData(JsonElement element)
        {
            ...
            return new BackendContractData(id, name, type, title.Value, description.Value, resourceId.Value, properties.Value, credentials.Value, proxy.Value, tls.Value, url.Value, Optional.ToNullable(protocol));
        }
        ...
        internal static BackendContractData DeserializeBackendContractData(XElement element)
        {
            ...
            return new BackendContractData(id, name, type, title, description, resourceId, properties, credentials, proxy, tls, url, protocol);
        }
    }
}
