...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementProductPatch
    {
        ...
        internal ApiManagementProductPatch(string description, string terms, bool? isSubscriptionRequired, bool? isApprovalRequired, int? subscriptionsLimit, ApiManagementProductState? state, string displayName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
