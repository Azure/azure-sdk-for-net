...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiManagementEmailTemplatePatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ApiManagementEmailTemplatePatch"/>. </summary>
        public ApiManagementEmailTemplatePatch()
        {
        }
        ...
        internal ApiManagementEmailTemplatePatch(EmailTemplateUpdateParameterProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
