...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    internal partial class CacheUpdateProperties
    {
        ...
        internal CacheUpdateProperties(string description, string connectionString, string useFromLocation, Uri resourceUri, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
