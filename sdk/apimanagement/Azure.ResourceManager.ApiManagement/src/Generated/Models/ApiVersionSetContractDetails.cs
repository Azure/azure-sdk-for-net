...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ApiVersionSetContractDetails
    {
        ...
        internal ApiVersionSetContractDetails(string id, string name, string description, VersioningScheme? versioningScheme, string versionQueryName, string versionHeaderName, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Name = name;
