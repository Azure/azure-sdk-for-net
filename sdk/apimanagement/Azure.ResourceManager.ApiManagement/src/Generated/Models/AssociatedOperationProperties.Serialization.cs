...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssociatedOperationProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssociatedOperationProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssociatedOperationProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AssociatedOperationProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
