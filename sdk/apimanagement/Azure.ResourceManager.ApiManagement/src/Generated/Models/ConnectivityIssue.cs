...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class ConnectivityIssue
    {
        ...
        internal ConnectivityIssue(IssueOrigin? origin, IssueSeverity? severity, IssueType? issueType, IReadOnlyList<IDictionary<string, string>> context, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Origin = origin;
            Severity = severity;
            IssueType = issueType;
