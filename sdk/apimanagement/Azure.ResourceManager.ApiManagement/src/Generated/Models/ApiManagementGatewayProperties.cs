...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    internal partial class ApiManagementGatewayProperties : ApiManagementGatewayBaseProperties
    {
        ...
        internal ApiManagementGatewayProperties(string provisioningState, string targetProvisioningState, DateTimeOffset? createdAtUtc, FrontendConfiguration frontend, BackendConfiguration backend, GatewayConfigurationApi configurationApi, VirtualNetworkType? virtualNetworkType, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(provisioningState, targetProvisioningState, createdAtUtc, frontend, backend, configurationApi, virtualNetworkType, additionalBinaryDataProperties)
        {
        }
    }
}
