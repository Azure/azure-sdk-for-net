...
namespace Azure.ResourceManager.ApiManagement.Models
{
    internal partial class GroupListResult
    {
        internal static GroupListResult DeserializeGroupListResult(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<ApiManagementGroupData>> value = default;
            ...
            return new GroupListResult(Core.Optional.ToList(value), Core.Optional.ToNullable(count), nextLink.Value);
        }
    }
}
