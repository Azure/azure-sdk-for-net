...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public partial class GroupContractProperties
    {
        ...
        internal GroupContractProperties(string displayName, string description, bool? isBuiltIn, ApiManagementGroupType? apiManagementGroupType, string externalId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DisplayName = displayName;
