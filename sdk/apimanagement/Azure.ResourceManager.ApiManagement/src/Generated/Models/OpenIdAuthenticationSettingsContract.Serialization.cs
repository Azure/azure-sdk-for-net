...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OpenIdAuthenticationSettingsContract>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OpenIdAuthenticationSettingsContract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OpenIdAuthenticationSettingsContract>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OpenIdAuthenticationSettingsContract>)} interface");
            }
        ...
        string IPersistableModel<OpenIdAuthenticationSettingsContract>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
