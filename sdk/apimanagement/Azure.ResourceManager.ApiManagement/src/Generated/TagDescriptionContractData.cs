...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class TagDescriptionContractData : ResourceData
    {
        ...
        internal TagDescriptionContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, Uri externalDocsUri, string externalDocsDescription, string tagId, string displayName) : base(id, name, resourceType, systemData)
        {
