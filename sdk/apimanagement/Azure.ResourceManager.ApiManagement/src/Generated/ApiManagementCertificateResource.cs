...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementCertificateResource : ArmResource
    {
        ...
        private readonly ApiManagementCertificateCreateOrUpdateContentData _data;
        ...
        internal ApiManagementCertificateResource(ArmClient client, ApiManagementCertificateCreateOrUpdateContentData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual ApiManagementCertificateCreateOrUpdateContentData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, ETag ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _apiManagementCertificateCertificateRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch);
        ...
        public virtual async Task<ArmOperation<ApiManagementCertificateResource>> UpdateAsync(WaitUntil waitUntil, CertificateCreateOrUpdateContent content, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _apiManagementCertificateCertificateRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, ifMatch);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<ApiManagementCertificateResource> Update(WaitUntil waitUntil, CertificateCreateOrUpdateContent content, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
