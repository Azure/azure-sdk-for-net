...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiOperationPolicyCollection : ArmCollection, IEnumerable<ApiOperationPolicyResource>, IAsyncEnumerable<ApiOperationPolicyResource>
    {
        ...
        public virtual async Task<ArmOperation<ApiOperationPolicyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, PolicyIdName policyId, PolicyContractData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ApiOperationPolicyResource> CreateOrUpdate(WaitUntil waitUntil, PolicyIdName policyId, PolicyContractData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ApiOperationPolicyResource>> GetAsync(PolicyIdName policyId, PolicyExportFormat? format = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="format"> Policy Export Format. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ApiOperationPolicyResource> Get(PolicyIdName policyId, PolicyExportFormat? format = null, CancellationToken cancellationToken = default)
        {
            using var scope = _apiOperationPolicyClientDiagnostics.CreateScope("ApiOperationPolicyCollection.Get");
            scope.Start();
            try
        ...
        {
            async Task<Page<ApiOperationPolicyResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _apiOperationPolicyClientDiagnostics.CreateScope("ApiOperationPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _apiOperationPolicyRestClient.ListByOperationAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiOperationPolicyResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
        ...
        {
            Page<ApiOperationPolicyResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _apiOperationPolicyClientDiagnostics.CreateScope("ApiOperationPolicyCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _apiOperationPolicyRestClient.ListByOperation(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiOperationPolicyResource(Client, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
