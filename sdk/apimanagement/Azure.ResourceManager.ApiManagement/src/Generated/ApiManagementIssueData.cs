...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementIssueData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ApiManagementIssueData"/>. </summary>
        public ApiManagementIssueData()
        {
        }
        ...
        internal ApiManagementIssueData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IssueContractProperties properties) : base(id, name, resourceType, systemData)
        {
