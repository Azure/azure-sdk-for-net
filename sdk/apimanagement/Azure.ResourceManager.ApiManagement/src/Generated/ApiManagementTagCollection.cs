...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementTagCollection : ArmCollection, IEnumerable<ApiManagementTagResource>, IAsyncEnumerable<ApiManagementTagResource>
    {
        ...
        internal ApiManagementTagCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _apiManagementTagRestClient = new ApiManagementTag(_apiManagementTagClientDiagnostics, Pipeline, Endpoint, apiManagementTagApiVersion ?? "2025-03-01-preview");
        ...
        public virtual async Task<ArmOperation<ApiManagementTagResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string tagId, TagCreateUpdateContent content, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiManagementTagRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, tagId, TagCreateUpdateContent.ToRequestContent(content), ifMatch, context);
        ...
        public virtual async Task<Response<ApiManagementTagResource>> GetAsync(string tagId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiManagementTagRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, tagId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<TagContractData> response = Response.FromValue(TagContractData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<ApiManagementTagResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, string scope = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<TagContractData, ApiManagementTagResource>(new ApiManagementTagGetByServiceAsyncCollectionResultOfT(
                ...
                skip,
                scope,
                context), data => new ApiManagementTagResource(Client, data));
        }
