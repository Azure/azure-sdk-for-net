...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementTagCollection : ArmCollection, IEnumerable<ApiManagementTagResource>, IAsyncEnumerable<ApiManagementTagResource>
    {
        ...
        internal ApiManagementTagCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _tagClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ApiManagementTagResource.ResourceType.Namespace, Diagnostics);
            _tagRestClient = new Tag(_tagClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementTagApiVersion ?? "2025-09-01-preview");
        ...
        public virtual async Task<ArmOperation<ApiManagementTagResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string tagId, ApiManagementTagCreateOrUpdateContent content, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tagClientDiagnostics.CreateScope("ApiManagementTagCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _tagRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, tagId, ApiManagementTagCreateOrUpdateContent.ToRequestContent(content), ifMatch, context);
        ...
        public virtual async Task<Response<ApiManagementTagResource>> GetAsync(string tagId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tagClientDiagnostics.CreateScope("ApiManagementTagCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _tagRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, tagId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<TagContractData> response = Response.FromValue(TagContractData.FromResponse(result), result);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string tagId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tagClientDiagnostics.CreateScope("ApiManagementTagCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ApiManagementTagResource>> GetIfExistsAsync(string tagId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tagClientDiagnostics.CreateScope("ApiManagementTagCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
