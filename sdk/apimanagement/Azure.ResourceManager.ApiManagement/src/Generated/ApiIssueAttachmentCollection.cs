...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiIssueAttachmentCollection : ArmCollection, IEnumerable<ApiIssueAttachmentResource>, IAsyncEnumerable<ApiIssueAttachmentResource>
    {
        ...
        internal ApiIssueAttachmentCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _apiIssueAttachmentRestClient = new ApiIssueAttachment(_apiIssueAttachmentClientDiagnostics, Pipeline, Endpoint, apiIssueAttachmentApiVersion ?? "2025-03-01-preview");
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, ApiIssueResource.ResourceType), id);
            }
        }
        ...
        public virtual async Task<ArmOperation<ApiIssueAttachmentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string attachmentId, ApiIssueAttachmentData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiIssueAttachmentRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, attachmentId, ApiIssueAttachmentData.ToRequestContent(data), ifMatch, context);
        ...
        public virtual async Task<Response<ApiIssueAttachmentResource>> GetAsync(string attachmentId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiIssueAttachmentRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, attachmentId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiIssueAttachmentData> response = Response.FromValue(ApiIssueAttachmentData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<ApiIssueAttachmentResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ApiIssueAttachmentData, ApiIssueAttachmentResource>(new ApiIssueAttachmentGetByServiceAsyncCollectionResultOfT(
                ...
                top,
                skip,
                context), data => new ApiIssueAttachmentResource(Client, data));
        }
