...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ApiManagementServiceGetByResourceGroupCollectionResultOfT : Pageable<ApiManagementServiceData>
    {
        ...
        public ApiManagementServiceGetByResourceGroupCollectionResultOfT(ApiManagementService client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
