...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ApiManagementServiceGetByResourceGroupCollectionResultOfT : Pageable<ApiManagementServiceResourceData>
    {
        ...
        /// <summary> Initializes a new instance of ApiManagementServiceGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ApiManagementServiceGetByResourceGroupCollectionResultOfT(ApiManagementService client, string subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ApiManagementServiceGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
        ...
        private Response GetNextResponse(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("ApiManagementServiceResourceCollection.GetAll");
            scope.Start();
            try
            {
