...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ApiManagementServiceGetAllAsyncCollectionResultOfT : AsyncPageable<ApiManagementServiceResourceData>
    {
        ...
        public ApiManagementServiceGetAllAsyncCollectionResultOfT(ApiManagementService client, string subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
