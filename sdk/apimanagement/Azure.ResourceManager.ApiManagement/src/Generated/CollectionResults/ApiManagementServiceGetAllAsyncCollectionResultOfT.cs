...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ApiManagementServiceGetAllAsyncCollectionResultOfT : AsyncPageable<ApiManagementServiceData>
    {
        ...
        /// <summary> Initializes a new instance of ApiManagementServiceGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ApiManagementServiceGetAllAsyncCollectionResultOfT(ApiManagementService client, Guid subscriptionId, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ApiManagementServiceGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
