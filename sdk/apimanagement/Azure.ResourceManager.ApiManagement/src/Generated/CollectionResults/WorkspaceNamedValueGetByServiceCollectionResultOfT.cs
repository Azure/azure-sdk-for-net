...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class WorkspaceNamedValueGetByServiceCollectionResultOfT : Pageable<ApiManagementNamedValueData>
    {
        ...
        /// <returns> The pages of WorkspaceNamedValueGetByServiceCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ApiManagementNamedValueData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                NamedValueCollection result = NamedValueCollection.FromResponse(response);
