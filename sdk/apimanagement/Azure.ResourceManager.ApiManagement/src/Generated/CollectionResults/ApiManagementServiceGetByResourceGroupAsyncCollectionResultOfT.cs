...
{
    internal partial class ApiManagementServiceGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ApiManagementServiceResourceData>
    {
        ...
        /// <summary> Initializes a new instance of ApiManagementServiceGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ApiManagementServiceGetByResourceGroupAsyncCollectionResultOfT(ApiManagementService client, Guid subscriptionId, string resourceGroupName, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ApiManagementServiceGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ApiManagementServiceGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </returns>
