...
{
    internal partial class DeletedServicesGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<ApiManagementDeletedServiceData>
    {
        ...
        public DeletedServicesGetBySubscriptionAsyncCollectionResultOfT(DeletedServices client, string subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
