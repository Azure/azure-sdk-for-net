...
{
    internal partial class ServiceApiResolverPolicyGetByResolverCollectionResultOfT : Pageable<ApiManagementPolicyData>
    {
        ...
        /// <summary> Initializes a new instance of ServiceApiResolverPolicyGetByResolverCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ServiceApiResolverPolicyGetByResolverCollectionResultOfT(ServiceApiResolverPolicy client, Guid subscriptionId, string resourceGroupName, string serviceName, string apiId, string resolverId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ServiceApiResolverPolicyGetByResolverCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ServiceApiResolverPolicyGetByResolverCollectionResultOfT as an enumerable collection. </returns>
