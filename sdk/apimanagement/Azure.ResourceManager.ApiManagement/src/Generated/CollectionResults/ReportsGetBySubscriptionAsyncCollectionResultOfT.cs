...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ReportsGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<ReportRecordContract>
    {
        ...
        public ReportsGetBySubscriptionAsyncCollectionResultOfT(Reports client, string subscriptionId, string resourceGroupName, string serviceName, string filter, int? top, int? skip, string @orderby, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
