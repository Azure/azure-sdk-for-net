...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class WorkspacePolicyGetByApiAsyncCollectionResultOfT : AsyncPageable<ApiManagementPolicyData>
    {
        ...
        public WorkspacePolicyGetByApiAsyncCollectionResultOfT(WorkspacePolicy client, string subscriptionId, string resourceGroupName, string serviceName, string workspaceId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
