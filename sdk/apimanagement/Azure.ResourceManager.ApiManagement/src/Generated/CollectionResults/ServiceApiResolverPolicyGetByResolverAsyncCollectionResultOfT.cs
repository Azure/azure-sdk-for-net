...
{
    internal partial class ServiceApiResolverPolicyGetByResolverAsyncCollectionResultOfT : AsyncPageable<ApiManagementPolicyData>
    {
        private readonly ServiceApiResolverPolicy _client;
        ...
        /// <summary> Initializes a new instance of ServiceApiResolverPolicyGetByResolverAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The ServiceApiResolverPolicy client used to send requests. </param>
        ...
        public ServiceApiResolverPolicyGetByResolverAsyncCollectionResultOfT(ServiceApiResolverPolicy client, Guid subscriptionId, string resourceGroupName, string serviceName, string apiId, string resolverId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ServiceApiResolverPolicyGetByResolverAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ServiceApiResolverPolicyGetByResolverAsyncCollectionResultOfT as an enumerable collection. </returns>
