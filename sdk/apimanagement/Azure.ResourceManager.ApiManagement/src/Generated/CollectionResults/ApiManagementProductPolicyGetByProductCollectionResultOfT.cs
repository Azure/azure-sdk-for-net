...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ApiManagementProductPolicyGetByProductCollectionResultOfT : Pageable<ApiManagementPolicyData>
    {
        ...
        /// <summary> Initializes a new instance of ApiManagementProductPolicyGetByProductCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The ApiManagementProductPolicy client used to send requests. </param>
        ...
        public ApiManagementProductPolicyGetByProductCollectionResultOfT(ApiManagementProductPolicy client, Guid subscriptionId, string resourceGroupName, string serviceName, string productId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ApiManagementProductPolicyGetByProductCollectionResultOfT as an enumerable collection. </summary>
