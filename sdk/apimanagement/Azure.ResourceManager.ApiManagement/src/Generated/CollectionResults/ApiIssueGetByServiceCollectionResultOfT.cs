...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ApiIssueGetByServiceCollectionResultOfT : Pageable<ApiManagementIssueData>
    {
        ...
        private readonly bool? _expandCommentsAttachments;
        private readonly int? _top;
        private readonly int? _skip;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of ApiIssueGetByServiceCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The ApiIssue client used to send requests. </param>
        ...
        public ApiIssueGetByServiceCollectionResultOfT(ApiIssue client, string subscriptionId, string resourceGroupName, string serviceName, string apiId, string filter, bool? expandCommentsAttachments, int? top, int? skip, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            ...
            _apiId = apiId;
            _filter = filter;
            _expandCommentsAttachments = expandCommentsAttachments;
            _top = top;
            _skip = skip;
            _context = context;
        }

        /// <summary> Gets the pages of ApiIssueGetByServiceCollectionResultOfT as an enumerable collection. </summary>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetByServiceRequest(nextLink, _subscriptionId, _resourceGroupName, _serviceName, _apiId, _filter, _expandCommentsAttachments, _top, _skip, _context) : _client.CreateGetByServiceRequest(_subscriptionId, _resourceGroupName, _serviceName, _apiId, _filter, _expandCommentsAttachments, _top, _skip, _context);
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("ApiIssueCollection.GetAll");
            scope.Start();
            try
            {
