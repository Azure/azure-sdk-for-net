...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ApiIssueGetByServiceCollectionResultOfT : Pageable<IssueContractData>
    {
        ...
        public ApiIssueGetByServiceCollectionResultOfT(ApiIssue client, Guid subscriptionId, string resourceGroupName, string serviceName, string apiId, string filter, bool? expandCommentsAttachments, int? top, int? skip, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
