...
{
    internal partial class ReportsGetByTimeCollectionResultOfT : Pageable<ReportRecordContract>
    {
        ...
        /// <summary> Initializes a new instance of ReportsGetByTimeCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ReportsGetByTimeCollectionResultOfT(Reports client, Guid subscriptionId, string resourceGroupName, string serviceName, string filter, TimeSpan interval, int? top, int? skip, string @orderby, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ReportsGetByTimeCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ReportsGetByTimeCollectionResultOfT as an enumerable collection. </returns>
