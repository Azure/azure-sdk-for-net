...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ReportsGetByTimeCollectionResultOfT : Pageable<ReportRecordContract>
    {
        ...
        public ReportsGetByTimeCollectionResultOfT(Reports client, string subscriptionId, string resourceGroupName, string serviceName, string filter, TimeSpan interval, int? top, int? skip, string @orderby, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
