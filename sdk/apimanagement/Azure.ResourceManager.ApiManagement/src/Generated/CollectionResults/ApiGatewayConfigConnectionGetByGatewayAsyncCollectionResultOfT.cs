...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ApiGatewayConfigConnectionGetByGatewayAsyncCollectionResultOfT : AsyncPageable<ApiGatewayConfigConnectionData>
    {
        ...
        /// <summary> Initializes a new instance of ApiGatewayConfigConnectionGetByGatewayAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ApiGatewayConfigConnectionGetByGatewayAsyncCollectionResultOfT(ApiGatewayConfigConnection client, Guid subscriptionId, string resourceGroupName, string gatewayName, int? top, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ApiGatewayConfigConnectionGetByGatewayAsyncCollectionResultOfT as an enumerable collection. </summary>
