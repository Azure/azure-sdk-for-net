...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class ApiGatewayConfigConnectionGetByGatewayAsyncCollectionResultOfT : AsyncPageable<ApiManagementGatewayConfigConnectionResourceData>
    {
        ...
        public ApiGatewayConfigConnectionGetByGatewayAsyncCollectionResultOfT(ApiGatewayConfigConnection client, string subscriptionId, string resourceGroupName, string gatewayName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
