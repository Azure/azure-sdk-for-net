...
namespace Azure.ResourceManager.ApiManagement
{
    internal partial class IdentityProviderGetByServiceCollectionResultOfT : Pageable<ApiManagementIdentityProviderData>
    {
        ...
        /// <returns> The pages of IdentityProviderGetByServiceCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<ApiManagementIdentityProviderData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                IdentityProviderList result = IdentityProviderList.FromResponse(response);
                yield return Page<ApiManagementIdentityProviderData>.FromValues((IReadOnlyList<ApiManagementIdentityProviderData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
