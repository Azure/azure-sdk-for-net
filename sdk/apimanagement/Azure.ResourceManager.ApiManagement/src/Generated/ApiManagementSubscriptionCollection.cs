...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementSubscriptionCollection : ArmCollection, IEnumerable<ApiManagementSubscriptionResource>, IAsyncEnumerable<ApiManagementSubscriptionResource>
    {
        ...
        internal ApiManagementSubscriptionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _subscriptionRestClient = new Subscription(_subscriptionClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementSubscriptionApiVersion ?? "2025-09-01-preview");
        ...
        public virtual async Task<ArmOperation<ApiManagementSubscriptionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string sid, ApiManagementSubscriptionCreateOrUpdateContent content, bool? notify = default, ETag? ifMatch = default, AppType? appType = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _subscriptionRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, sid, ApiManagementSubscriptionCreateOrUpdateContent.ToRequestContent(content), notify, ifMatch, appType?.ToString(), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="sid"/> or <paramref name="content"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="sid"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ApiManagementSubscriptionResource> CreateOrUpdate(WaitUntil waitUntil, string sid, ApiManagementSubscriptionCreateOrUpdateContent content, bool? notify = default, ETag? ifMatch = default, AppType? appType = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(sid, nameof(sid));
            Argument.AssertNotNull(content, nameof(content));
