...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementPolicyData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ApiManagementPolicyData"/>. </summary>
        public ApiManagementPolicyData()
        {
        }
        ...
        /// <param name="properties"> Properties of the Policy. </param>
        internal ApiManagementPolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PolicyContractProperties properties) : base(id, name, resourceType, systemData)
        {
