...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementServiceResourceData : TrackedResourceData
    {
        ...
        public ApiManagementServiceResourceData(AzureLocation location, ApiManagementServiceSkuProperties sku, string publisherEmail, string publisherName) : base(location)
        {
            if (sku == null)
            {
