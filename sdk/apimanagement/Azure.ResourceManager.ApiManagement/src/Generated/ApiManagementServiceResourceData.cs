...
{
    /// <summary> A class representing the ApiManagementServiceResource data model. </summary>
    public partial class ApiManagementServiceResourceData : ApimResource
    {
        /// <summary> Initializes a new instance of ApiManagementServiceResourceData. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="sku"/>, <paramref name="location"/>, <paramref name="publisherEmail"/>, or <paramref name="publisherName"/> is null. </exception>
        public ApiManagementServiceResourceData(ApiManagementServiceSkuProperties sku, string location, string publisherEmail, string publisherName)
        {
            if (sku == null)
            {
