...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class PortalSigninSettingsData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PortalSigninSettingsData"/>. </summary>
        ...
        /// <param name="properties"> Sign-in settings contract properties. </param>
        internal PortalSigninSettingsData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PortalSigninSettingProperties properties) : base(id, name, resourceType, systemData)
        {
