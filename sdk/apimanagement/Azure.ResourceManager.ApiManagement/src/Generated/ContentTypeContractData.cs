...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ContentTypeContractData : Resource
    {
        ...
        internal ContentTypeContractData(ResourceIdentifier id, string name, ResourceType type, string idPropertiesId, string namePropertiesName, string description, object schema, string version) : base(id, name, type)
        {
