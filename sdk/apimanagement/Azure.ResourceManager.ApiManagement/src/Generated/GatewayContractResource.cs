...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class GatewayContractResource : ArmResource
    {
        ...
        public virtual async Task<Response<GatewayContractResource>> UpdateAsync(string ifMatch, ApiGatewayData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="ifMatch"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="ifMatch"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual Response<GatewayContractResource> Update(string ifMatch, ApiGatewayData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ifMatch, nameof(ifMatch));
            Argument.AssertNotNull(data, nameof(data));
