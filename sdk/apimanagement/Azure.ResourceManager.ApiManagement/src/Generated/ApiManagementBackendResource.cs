...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementBackendResource : ArmResource
    {
        ...
        internal ApiManagementBackendResource(ArmClient client, ApiManagementBackendData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ApiManagementBackendResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ApiManagementBackendResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
