...
{
    /// <summary> A class representing the EmailTemplateContract data model. </summary>
    public partial class EmailTemplateContractData : ResourceData
    {
        /// <summary> Initializes a new instance of EmailTemplateContractData. </summary>
        ...
        internal EmailTemplateContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string subject, string body, string title, string description, bool? isDefault, IList<EmailTemplateParametersContractProperties> parameters) : base(id, name, resourceType, systemData)
        {
            Subject = subject;
            Body = body;
            Title = title;
