...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class EmailTemplateContractData : Resource
    {
        ...
        internal EmailTemplateContractData(ResourceIdentifier id, string name, ResourceType type, string subject, string body, string title, string description, bool? isDefault, IList<EmailTemplateParametersContractProperties> parameters) : base(id, name, type)
        {
            Subject = subject;
            Body = body;
            Title = title;
