...
{
    /// <summary> A class representing the ApiContract data model. </summary>
    public partial class ApiContractData : Resource
    {
        /// <summary> Initializes a new instance of ApiContractData. </summary>
        ...
        internal ApiContractData(ResourceIdentifier id, string name, ResourceType type, string description, AuthenticationSettingsContract authenticationSettings, SubscriptionKeyParameterNamesContract subscriptionKeyParameterNames, ApiType? apiType, string apiRevision, string apiVersion, bool? isCurrent, bool? isOnline, string apiRevisionDescription, string apiVersionDescription, string apiVersionSetId, bool? subscriptionRequired, string termsOfServiceUrl, ApiContactInformation contact, ApiLicenseInformation license, string sourceApiId, string displayName, string serviceUrl, string path, IList<Protocol> protocols, ApiVersionSetContractDetails apiVersionSet) : base(id, name, type)
        {
