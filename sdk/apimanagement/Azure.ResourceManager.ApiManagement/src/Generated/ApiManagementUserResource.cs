    ...
    public partial class ApiManagementUserResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch, bool? deleteSubscriptions = default, bool? notify = default, AppType? appType = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _userRestClient.CreateDeleteRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, deleteSubscriptions, notify, appType?.ToString(), context);
        ...
        {
            using DiagnosticScope scope = _userClientDiagnostics.CreateScope("ApiManagementUserResource.GenerateSsoUri");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _userRestClient.CreateGenerateSsoUriRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response<UserTokenResult>> GetSharedAccessTokenAsync(UserTokenContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _userRestClient.CreateGetSharedAccessTokenRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, UserTokenContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual AsyncPageable<ApiManagementGroupData> GetAllAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ApiManagementGroupData"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ApiManagementGroupData> GetAll(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="appType"> Determines the type of application which send the create user request. Default is legacy publisher portal. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response> SendUserConfirmationPasswordAsync(AppType? appType = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _userConfirmationPasswordClientDiagnostics.CreateScope("ApiManagementUserResource.SendUserConfirmationPassword");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _userConfirmationPasswordRestClient.CreateSendUserConfirmationPasswordRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, appType?.ToString(), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// <param name="appType"> Determines the type of application which send the create user request. Default is legacy publisher portal. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response SendUserConfirmationPassword(AppType? appType = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _userConfirmationPasswordClientDiagnostics.CreateScope("ApiManagementUserResource.SendUserConfirmationPassword");
            scope.Start();
            try
        ...
        public virtual AsyncPageable<UserIdentityContract> GetUserIdentitiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new UserIdentitiesGetUserIdentitiesAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "ApiManagementUserResource.GetUserIdentities");
        }
        ...
        public virtual async Task<ArmOperation<ApiManagementUserResource>> UpdateAsync(WaitUntil waitUntil, ApiManagementUserCreateOrUpdateContent content, bool? notify = default, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
            ...
            try
            {
                ...
                HttpMessage message = _userRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ApiManagementUserCreateOrUpdateContent.ToRequestContent(content), notify, ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<UserContractData> response = Response.FromValue(UserContractData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ApiManagementUserResource> Update(WaitUntil waitUntil, ApiManagementUserCreateOrUpdateContent content, bool? notify = default, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
