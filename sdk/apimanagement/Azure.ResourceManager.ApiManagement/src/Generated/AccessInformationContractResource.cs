...
{
    /// <summary>
    /// A class representing a AccessInformationContract along with the instance operations that can be performed on it.
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="AccessInformationContractResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="ApiManagementServiceResource"/> using the GetAccessInformationContracts method.
    /// </summary>
    public partial class AccessInformationContractResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of AccessInformationContractResource for mocking. </summary>
        protected AccessInformationContractResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="AccessInformationContractResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="data"> The resource that is the target of operations. </param>
        internal AccessInformationContractResource(ArmClient client, TenantAccessInfoData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            TryGetApiVersion(ResourceType, out string accessInformationContractApiVersion);
            ...
            _tenantAccessGitRestClient = new TenantAccessGit(_tenantAccessGitClientDiagnostics, Pipeline, Endpoint, accessInformationContractApiVersion ?? "2025-09-01-preview");
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="AccessInformationContractResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _tenantAccessClientDiagnostics.CreateScope("AccessInformationContractResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _tenantAccessClientDiagnostics.CreateScope("AccessInformationContractResource.RegeneratePrimaryKey");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _tenantAccessClientDiagnostics.CreateScope("AccessInformationContractResource.RegenerateSecondaryKey");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _tenantAccessGitClientDiagnostics.CreateScope("AccessInformationContractResource.TenantAccessGitRegeneratePrimaryKey");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _tenantAccessGitClientDiagnostics.CreateScope("AccessInformationContractResource.TenantAccessGitRegenerateSecondaryKey");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
