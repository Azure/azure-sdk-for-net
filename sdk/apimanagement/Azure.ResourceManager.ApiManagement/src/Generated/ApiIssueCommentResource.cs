...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiIssueCommentResource : ArmResource
    {
        ...
        internal ApiIssueCommentResource(ArmClient client, ApiIssueCommentData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ApiIssueCommentResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new ApiIssueCommentResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<ArmOperation<ApiIssueCommentResource>> UpdateAsync(WaitUntil waitUntil, ApiIssueCommentData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ApiManagementArmOperation<ApiIssueCommentResource>(Response.FromValue(new ApiIssueCommentResource(Client, response.Value, response.Value.Id), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
