...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiOperationTagCollection : ArmCollection, IEnumerable<ApiOperationTagResource>, IAsyncEnumerable<ApiOperationTagResource>
    {
        ...
        internal ApiOperationTagCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _tagClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ApiOperationTagResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ApiOperationTagResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string tagId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tagClientDiagnostics.CreateScope("ApiOperationTagCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _tagRestClient.CreateAssignToOperationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, tagId, context);
        ...
        public virtual async Task<Response<ApiOperationTagResource>> GetAsync(string tagId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tagClientDiagnostics.CreateScope("ApiOperationTagCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _tagRestClient.CreateGetByOperationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, tagId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<TagContractData> response = Response.FromValue(TagContractData.FromResponse(result), result);
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string tagId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tagClientDiagnostics.CreateScope("ApiOperationTagCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ApiOperationTagResource>> GetIfExistsAsync(string tagId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tagClientDiagnostics.CreateScope("ApiOperationTagCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
