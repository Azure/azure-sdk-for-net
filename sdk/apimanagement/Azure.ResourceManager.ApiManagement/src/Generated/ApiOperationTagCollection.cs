...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// To get a <see cref="ApiOperationTagCollection"/> instance call the GetApiOperationTags method from an instance of <see cref="ApiOperationResource"/>.
    /// </summary>
    public partial class ApiOperationTagCollection : ArmCollection, IEnumerable<ApiOperationTagResource>, IAsyncEnumerable<ApiOperationTagResource>
    {
        ...
        /// <summary> Initializes a new instance of ApiOperationTagCollection for mocking. </summary>
        protected ApiOperationTagCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ApiOperationTagCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ApiOperationTagCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            TryGetApiVersion(ApiOperationTagResource.ResourceType, out string apiOperationTagApiVersion);
            _operationTagClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ApiOperationTagResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ApiOperationTagResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string tagId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _operationTagClientDiagnostics.CreateScope("ApiOperationTagCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _operationTagRestClient.CreateAssignToOperationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, tagId, context);
        ...
        public virtual async Task<Response<ApiOperationTagResource>> GetAsync(string tagId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _operationTagClientDiagnostics.CreateScope("ApiOperationTagCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _operationTagRestClient.CreateGetByOperationRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, tagId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<TagContractData> response = Response.FromValue(TagContractData.FromResponse(result), result);
        ...
        /// <item>
        /// <term> Operation Id. </term>
        /// <description> TagContracts_ListByOperation. </description>
        /// </item>
        /// <item>
        /// <term> Default Api Version. </term>
        /// <description> 2025-09-01-preview. </description>
        ...
        public virtual AsyncPageable<ApiOperationTagResource> GetAllAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new AsyncPageableWrapper<TagContractData, ApiOperationTagResource>(new OperationTagGetByOperationAsyncCollectionResultOfT(
                _operationTagRestClient,
                ...
                skip,
                context,
                "ApiOperationTagCollection.GetAll"), data => new ApiOperationTagResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ApiOperationTagResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ApiOperationTagResource> GetAll(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new PageableWrapper<TagContractData, ApiOperationTagResource>(new OperationTagGetByOperationCollectionResultOfT(
                _operationTagRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Parent.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string tagId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _operationTagClientDiagnostics.CreateScope("ApiOperationTagCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<ApiOperationTagResource>> GetIfExistsAsync(string tagId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _operationTagClientDiagnostics.CreateScope("ApiOperationTagCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
