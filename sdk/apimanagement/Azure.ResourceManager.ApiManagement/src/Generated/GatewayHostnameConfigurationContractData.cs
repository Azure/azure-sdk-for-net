...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class GatewayHostnameConfigurationContractData : Resource
    {
        ...
        internal GatewayHostnameConfigurationContractData(ResourceIdentifier id, string name, ResourceType type, string hostname, string certificateId, bool? negotiateClientCertificate, bool? tls10Enabled, bool? tls11Enabled, bool? http2Enabled) : base(id, name, type)
        {
            Hostname = hostname;
