    ...
    public partial class ApiManagementGlobalSchemaCollection : ArmCollection, IEnumerable<ApiManagementGlobalSchemaResource>, IAsyncEnumerable<ApiManagementGlobalSchemaResource>
    {
        ...
        public virtual AsyncPageable<ApiManagementGlobalSchemaResource> GetAllAsync(ApiManagementGlobalSchemaCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<ApiManagementGlobalSchemaResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _apiManagementGlobalSchemaGlobalSchemaRestClient.ListByServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<ApiManagementGlobalSchemaResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _apiManagementGlobalSchemaGlobalSchemaRestClient.ListByServiceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementGlobalSchemaResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<ApiManagementGlobalSchemaResource> GetAll(ApiManagementGlobalSchemaCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            Page<ApiManagementGlobalSchemaResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiManagementGlobalSchemaGlobalSchemaRestClient.ListByService(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementGlobalSchemaResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<ApiManagementGlobalSchemaResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiManagementGlobalSchemaGlobalSchemaRestClient.ListByServiceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementGlobalSchemaResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
