...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementNamedValueData : ResourceData
    {
        ...
        internal ApiManagementNamedValueData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<string> tags, bool? isSecret, string displayName, string value, KeyVaultContractProperties keyVaultDetails, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Tags = tags;
            IsSecret = isSecret;
