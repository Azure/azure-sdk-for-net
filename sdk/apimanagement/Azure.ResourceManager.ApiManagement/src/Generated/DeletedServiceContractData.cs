...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class DeletedServiceContractData : ResourceData
    {
        ...
        /// <param name="deletionOn"> UTC Timestamp when the service was soft-deleted. The date conforms to the following format: yyyy-MM-ddTHH:mm:ssZ as specified by the ISO 8601 standard. </param>
        internal DeletedServiceContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, string serviceId, DateTimeOffset? scheduledPurgeOn, DateTimeOffset? deletionOn) : base(id, name, resourceType, systemData)
        {
            Location = location;
            ServiceId = serviceId;
        ...
        public DateTimeOffset? DeletionOn { get; set; }
    }
}
