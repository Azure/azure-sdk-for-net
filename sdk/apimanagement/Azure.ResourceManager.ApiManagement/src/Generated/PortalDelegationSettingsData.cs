...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class PortalDelegationSettingsData : ResourceData
    {
        ...
        internal PortalDelegationSettingsData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Uri uri, string validationKey, SubscriptionsDelegationSettingsProperties subscriptions, RegistrationDelegationSettingsProperties userRegistration) : base(id, name, resourceType, systemData)
        {
            Uri = uri;
