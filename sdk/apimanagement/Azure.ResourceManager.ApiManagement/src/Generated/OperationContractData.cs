...
{
    /// <summary> A class representing the OperationContract data model. </summary>
    public partial class OperationContractData : Resource
    {
        /// <summary> Initializes a new instance of OperationContractData. </summary>
        ...
        internal OperationContractData(ResourceIdentifier id, string name, ResourceType type, IList<ParameterContract> templateParameters, string description, RequestContract request, IList<ResponseContract> responses, string policies, string displayName, string method, string urlTemplate) : base(id, name, type)
        {
