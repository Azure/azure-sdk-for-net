...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementUserCollection : ArmCollection, IEnumerable<ApiManagementUserResource>, IAsyncEnumerable<ApiManagementUserResource>
    {
        ...
        public virtual AsyncPageable<ApiManagementUserResource> GetAllAsync(ApiManagementUserGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new ApiManagementUserGetAllOptions();
        ...
        public virtual Pageable<ApiManagementUserResource> GetAll(ApiManagementUserGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new ApiManagementUserGetAllOptions();
