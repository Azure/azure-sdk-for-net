...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementUserCollection : ArmCollection, IEnumerable<ApiManagementUserResource>, IAsyncEnumerable<ApiManagementUserResource>
    {
        ...
        public virtual AsyncPageable<ApiManagementUserResource> GetAllAsync(ApiManagementUserCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new ApiManagementUserCollectionGetAllOptions();
            ...
            async Task<Page<ApiManagementUserResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _apiManagementUserUserRestClient.ListByServiceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, options.ExpandGroups, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<ApiManagementUserResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _apiManagementUserUserRestClient.ListByServiceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, options.ExpandGroups, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementUserResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<ApiManagementUserResource> GetAll(ApiManagementUserCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new ApiManagementUserCollectionGetAllOptions();
            ...
            Page<ApiManagementUserResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiManagementUserUserRestClient.ListByService(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, options.ExpandGroups, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementUserResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<ApiManagementUserResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _apiManagementUserUserRestClient.ListByServiceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Skip, options.ExpandGroups, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new ApiManagementUserResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
