...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementGatewayCertificateAuthorityResource : ArmResource
    {
        ...
        internal ApiManagementGatewayCertificateAuthorityResource(ArmClient client, ApiManagementGatewayCertificateAuthorityData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
