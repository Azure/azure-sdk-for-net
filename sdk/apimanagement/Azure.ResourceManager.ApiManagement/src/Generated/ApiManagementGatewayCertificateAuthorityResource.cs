...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementGatewayCertificateAuthorityResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ApiManagementGatewayCertificateAuthorityResource>> UpdateAsync(WaitUntil waitUntil, ApiManagementGatewayCertificateAuthorityData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ApiManagementGatewayCertificateAuthorityResource> Update(WaitUntil waitUntil, ApiManagementGatewayCertificateAuthorityData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
