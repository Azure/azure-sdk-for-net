...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class SubscriptionContractData : ResourceData
    {
        ...
        internal SubscriptionContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SubscriptionContractProperties properties) : base(id, name, resourceType, systemData)
        {
