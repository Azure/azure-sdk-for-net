...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class SubscriptionContractData : Resource
    {
        ...
        internal SubscriptionContractData(ResourceIdentifier id, string name, ResourceType type, string ownerId, string scope, string displayName, SubscriptionState? state, DateTimeOffset? createdDate, DateTimeOffset? startDate, DateTimeOffset? expirationDate, DateTimeOffset? endDate, DateTimeOffset? notificationDate, string primaryKey, string secondaryKey, string stateComment, bool? allowTracing) : base(id, name, type)
        {
            OwnerId = ownerId;
            Scope = scope;
