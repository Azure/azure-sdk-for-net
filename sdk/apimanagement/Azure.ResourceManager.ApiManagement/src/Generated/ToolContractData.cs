...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ToolContractData : ResourceData
    {
        ...
        internal ToolContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ToolContractProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
