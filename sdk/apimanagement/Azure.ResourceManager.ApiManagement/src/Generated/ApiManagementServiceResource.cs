...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementServiceResource : ArmResource
    {
        ...
        internal ApiManagementServiceResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _policyRestrictionValidationsRestClient = new PolicyRestrictionValidations(_policyRestrictionValidationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            ...
            _apiManagementServiceSkusRestClient = new ApiManagementServiceSkus(_apiManagementServiceSkusClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            _reportsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            _reportsRestClient = new Reports(_reportsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            ...
            _networkStatusRestClient = new NetworkStatus(_networkStatusClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            ...
            _allPoliciesRestClient = new AllPolicies(_allPoliciesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            _apiClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            _apiRestClient = new Api(_apiClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            ...
            _outboundNetworkDependenciesEndpointsRestClient = new OutboundNetworkDependenciesEndpoints(_outboundNetworkDependenciesEndpointsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            ...
            _apiManagementServiceResourcesRestClient = new ApiManagementServiceResources(_apiManagementServiceResourcesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            ...
            _policyDescriptionRestClient = new PolicyDescription(_policyDescriptionClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            ...
            _portalSettingsRestClient = new PortalSettings(_portalSettingsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            _productClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            _productRestClient = new Product(_productClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            ...
            _quotaByCounterKeysRestClient = new QuotaByCounterKeys(_quotaByCounterKeysClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            ...
            _quotaByPeriodKeysRestClient = new QuotaByPeriodKeys(_quotaByPeriodKeysClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            _regionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ApiManagement", ResourceType.Namespace, Diagnostics);
            _regionRestClient = new Region(_regionClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
            ...
            _tagResourceRestClient = new TagResource(_tagResourceClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, apiManagementServiceApiVersion ?? "2025-09-01-preview");
        ...
        /// <summary>
        /// Updates the ApiManagementService.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}. </description>
        ...
        public virtual async Task<ArmOperation<ApiManagementServiceResource>> UpdateAsync(WaitUntil waitUntil, ApiManagementServiceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _apiManagementServiceRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ApiManagementServiceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ApiManagementArmOperation<ApiManagementServiceResource> operation = new ApiManagementArmOperation<ApiManagementServiceResource>(
                    new ApiManagementServiceResourceOperationSource(Client),
                    _apiManagementServiceClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ApiManagementServiceResource> Update(WaitUntil waitUntil, ApiManagementServiceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
