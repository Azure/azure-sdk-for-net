...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementServiceResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of ApiManagementSelfHostedGatewayResources in the ApiManagementService. </summary>
        /// <returns> An object representing collection of ApiManagementSelfHostedGatewayResources and their operations over a ApiManagementSelfHostedGatewayResource. </returns>
        public virtual ApiManagementSelfHostedGatewayCollection GetApiManagementSelfHostedGateways()
        {
            return GetCachedClient(client => new ApiManagementSelfHostedGatewayCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ApiManagementSelfHostedGatewayResource>> GetApiManagementSelfHostedGatewayAsync(string gatewayId, CancellationToken cancellationToken = default)
        {
            return await GetApiManagementSelfHostedGateways().GetAsync(gatewayId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="gatewayId"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ApiManagementSelfHostedGatewayResource> GetApiManagementSelfHostedGateway(string gatewayId, CancellationToken cancellationToken = default)
        {
            return GetApiManagementSelfHostedGateways().Get(gatewayId, cancellationToken);
        }
