...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementEmailTemplateResource : IJsonModel<ApiManagementEmailTemplateData>
    {
        ...
        BinaryData IPersistableModel<ApiManagementEmailTemplateData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        ApiManagementEmailTemplateData IPersistableModel<ApiManagementEmailTemplateData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ApiManagementEmailTemplateData>(data, options);
