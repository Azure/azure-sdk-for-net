...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementDiagnosticResource : IJsonModel<DiagnosticContractData>
    {
        ...
        {
            return ModelReaderWriter.Read<DiagnosticContractData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<DiagnosticContractData>(data, options);
        }
