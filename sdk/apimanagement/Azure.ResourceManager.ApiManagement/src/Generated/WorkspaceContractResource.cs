...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class WorkspaceContractResource : ArmResource
    {
        ...
        internal WorkspaceContractResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workspaceRestClient = new Workspace(_workspaceClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, workspaceContractApiVersion ?? "2025-09-01-preview");
            ...
            _workspaceApiExportRestClient = new WorkspaceApiExport(_workspaceApiExportClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, workspaceContractApiVersion ?? "2025-09-01-preview");
        ...
        public virtual async Task<ArmOperation<WorkspaceContractResource>> UpdateAsync(WaitUntil waitUntil, WorkspaceContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _workspaceRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, WorkspaceContractData.ToRequestContent(data), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<WorkspaceContractData> response = Response.FromValue(WorkspaceContractData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<WorkspaceContractResource> Update(WaitUntil waitUntil, WorkspaceContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
