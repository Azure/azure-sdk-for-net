...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementNamedValueCollection : ArmCollection, IEnumerable<ApiManagementNamedValueResource>, IAsyncEnumerable<ApiManagementNamedValueResource>
    {
        ...
        public virtual async Task<ArmOperation<ApiManagementNamedValueResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string namedValueId, NamedValueCreateContract namedValueCreateContract, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="namedValueId"/> or <paramref name="namedValueCreateContract"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="namedValueId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ApiManagementNamedValueResource> CreateOrUpdate(WaitUntil waitUntil, string namedValueId, NamedValueCreateContract namedValueCreateContract, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(namedValueId, nameof(namedValueId));
            Argument.AssertNotNull(namedValueCreateContract, nameof(namedValueCreateContract));
