...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspacePolicyFragmentResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ServiceWorkspacePolicyFragmentResource>> UpdateAsync(WaitUntil waitUntil, PolicyFragmentContractData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ServiceWorkspacePolicyFragmentResource> Update(WaitUntil waitUntil, PolicyFragmentContractData data, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
