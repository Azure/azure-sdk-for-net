...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    {
        private static IJsonModel<ApiReleaseData> s_dataDeserializationInstance;

        private static IJsonModel<ApiReleaseData> DataDeserializationInstance => s_dataDeserializationInstance ??= new ApiReleaseData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiReleaseData IJsonModel<ApiReleaseData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<ApiReleaseData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
