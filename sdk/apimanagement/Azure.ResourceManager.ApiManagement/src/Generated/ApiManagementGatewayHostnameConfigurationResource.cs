    ...
    public partial class ApiManagementGatewayHostnameConfigurationResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<ApiManagementGatewayHostnameConfigurationResource>> UpdateAsync(WaitUntil waitUntil, ApiManagementGatewayHostnameConfigurationData data, ETag? ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ApiManagementArmOperation<ApiManagementGatewayHostnameConfigurationResource>(Response.FromValue(new ApiManagementGatewayHostnameConfigurationResource(Client, response), response.GetRawResponse()), operationId);
                if (waitUntil == WaitUntil.Completed)
