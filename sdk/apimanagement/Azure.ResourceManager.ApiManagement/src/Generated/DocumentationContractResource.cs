...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class DocumentationContractResource : ArmResource
    {
        ...
        internal DocumentationContractResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _documentationRestClient = new Documentation(_documentationClientDiagnostics, Pipeline, Endpoint, documentationContractApiVersion ?? "2025-03-01-preview");
        ...
        public virtual async Task<Response<DocumentationContractResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _documentationRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<Response<DocumentationContractResource>> UpdateAsync(string ifMatch, DocumentationContractPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _documentationRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, DocumentationContractPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DocumentationContractData> response = Response.FromValue(DocumentationContractData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string ifMatch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _documentationRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, ifMatch, context);
