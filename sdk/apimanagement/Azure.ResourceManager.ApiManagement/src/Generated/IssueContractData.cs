...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class IssueContractData : ResourceData
    {
        ...
        internal IssueContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? createdOn, IssueState? state, ResourceIdentifier apiId, string title, string description, ResourceIdentifier userId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            CreatedOn = createdOn;
            State = state;
            ApiId = apiId;
