...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class IssueContractData : ResourceData
    {
        ...
        internal IssueContractData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? createdOn, State? state, ResourceIdentifier apiId, string title, string description, ResourceIdentifier userId) : base(id, name, resourceType, systemData)
        {
            CreatedOn = createdOn;
            State = state;
            ApiId = apiId;
