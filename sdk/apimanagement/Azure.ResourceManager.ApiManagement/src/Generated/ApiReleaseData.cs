...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiReleaseData : ResourceData
    {
        ...
        internal ApiReleaseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceIdentifier apiId, DateTimeOffset? createdOn, DateTimeOffset? updatedOn, string notes, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            ApiId = apiId;
            CreatedOn = createdOn;
            UpdatedOn = updatedOn;
