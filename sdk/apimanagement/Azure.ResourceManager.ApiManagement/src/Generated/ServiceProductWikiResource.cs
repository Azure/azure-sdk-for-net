...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceProductWikiResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ServiceProductWikiResource for mocking. </summary>
        protected ServiceProductWikiResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ServiceProductWikiResource"/> class. </summary>
        ...
        internal ServiceProductWikiResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _productWikiRestClient = new ProductWiki(_productWikiClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, serviceProductWikiApiVersion ?? "2025-09-01-preview");
        ...
        public virtual async Task<ArmOperation<ServiceProductWikiResource>> CreateOrUpdateAsync(WaitUntil waitUntil, WikiContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                ApiManagementArmOperation<ServiceProductWikiResource> operation = new ApiManagementArmOperation<ServiceProductWikiResource>(Response.FromValue(new ServiceProductWikiResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<ServiceProductWikiResource> CreateOrUpdate(WaitUntil waitUntil, WikiContractData data, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
