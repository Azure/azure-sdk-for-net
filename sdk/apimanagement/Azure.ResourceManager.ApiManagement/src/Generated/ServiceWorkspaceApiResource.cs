...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspaceApiResource : ArmResource
    {
        ...
        internal ServiceWorkspaceApiResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workspaceApiRestClient = new WorkspaceApi(_workspaceApiClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, serviceWorkspaceApiApiVersion ?? "2025-09-01-preview");
            ...
            _workspaceApiRevisionRestClient = new WorkspaceApiRevision(_workspaceApiRevisionClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, serviceWorkspaceApiApiVersion ?? "2025-09-01-preview");
        ...
        /// <summary>
        /// Updates the ServiceWorkspaceApi.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/workspaces/{workspaceId}/apis/{apiId}. </description>
        ...
        public virtual async Task<ArmOperation<ServiceWorkspaceApiResource>> UpdateAsync(WaitUntil waitUntil, ApiCreateOrUpdateContent content, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workspaceApiRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ApiCreateOrUpdateContent.ToRequestContent(content), ifMatch, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ServiceWorkspaceApiResource> Update(WaitUntil waitUntil, ApiCreateOrUpdateContent content, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
