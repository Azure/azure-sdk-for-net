...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    public static partial class ApiManagementModelFactory
    {
        ...
        /// <returns> A new <see cref="Models.ApiManagementContentType"/> instance for mocking. </returns>
        public static ApiManagementContentType ApiManagementContentType(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string contentTypeIdentifier = null, string contentTypeName = null, string description = null, BinaryData schema = null, string version = null)
        {
            return new ApiManagementContentType(id, name, resourceType, systemData, contentTypeIdentifier, contentTypeName, description, schema, version);
        }
        ...
        /// <returns> A new <see cref="Models.ApiManagementContentItem"/> instance for mocking. </returns>
        public static ApiManagementContentItem ApiManagementContentItem(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, BinaryData> properties = null)
        {
            properties ??= new Dictionary<string, BinaryData>();

            return new ApiManagementContentItem(id, name, resourceType, systemData, properties);
        }
