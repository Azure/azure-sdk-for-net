...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementPrivateLinkResourceData : ResourceData
    {
        ...
        internal ApiManagementPrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ApiManagementPrivateLinkResourceProperties properties) : base(id, name, resourceType, systemData)
        {
        ...
        [WirePath("properties")]
        internal ApiManagementPrivateLinkResourceProperties Properties { get; set; }
        ...
        public IReadOnlyList<string> RequiredMembers
        {
            get
            {
                ...
                {
                    Properties = new ApiManagementPrivateLinkResourceProperties();
                }
