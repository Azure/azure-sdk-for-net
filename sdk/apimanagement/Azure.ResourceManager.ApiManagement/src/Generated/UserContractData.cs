...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class UserContractData : Resource
    {
        ...
        internal UserContractData(ResourceIdentifier id, string name, ResourceType type, UserState? state, string note, IList<UserIdentityContract> identities, string firstName, string lastName, string email, DateTimeOffset? registrationDate, IReadOnlyList<GroupContractProperties> groups) : base(id, name, type)
        {
            State = state;
            Note = note;
