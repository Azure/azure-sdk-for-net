...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class AuthorizationAccessPolicyContractResource : IJsonModel<AuthorizationAccessPolicyContractData>
    {
        ...
        BinaryData IPersistableModel<AuthorizationAccessPolicyContractData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        AuthorizationAccessPolicyContractData IPersistableModel<AuthorizationAccessPolicyContractData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<AuthorizationAccessPolicyContractData>(data, options);
