...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ServiceWorkspaceGroupResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="WorkspaceContractResource"/> using the GetServiceWorkspaceGroups method.
    /// </summary>
    public partial class ServiceWorkspaceGroupResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of ServiceWorkspaceGroupResource for mocking. </summary>
        protected ServiceWorkspaceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ServiceWorkspaceGroupResource"/> class. </summary>
        ...
        internal ServiceWorkspaceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _workspaceGroupUserRestClient = new WorkspaceGroupUser(_workspaceGroupUserClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, serviceWorkspaceGroupApiVersion ?? "2025-09-01-preview");
        ...
        public virtual async Task<Response<ApiManagementUserResource>> CreateWorkspaceGroupUserAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _workspaceGroupUserClientDiagnostics.CreateScope("ServiceWorkspaceGroupResource.CreateWorkspaceGroupUser");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _workspaceGroupUserRestClient.CreateCreateWorkspaceGroupUserRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, userId, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual AsyncPageable<ApiManagementUserResource> GetWorkspaceGroupUsersAsync(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            ...
            return new AsyncPageableWrapper<UserContractData, ApiManagementUserResource>(new WorkspaceGroupUserGetWorkspaceGroupUsersAsyncCollectionResultOfT(
                ...
                skip,
                context,
                "ServiceWorkspaceGroupResource.GetWorkspaceGroupUsers"), data => new ApiManagementUserResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="ApiManagementUserResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<ApiManagementUserResource> GetWorkspaceGroupUsers(string filter = default, int? top = default, int? skip = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response> DeleteWorkspaceGroupUserAsync(string userId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _workspaceGroupUserClientDiagnostics.CreateScope("ServiceWorkspaceGroupResource.DeleteWorkspaceGroupUser");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _workspaceGroupUserRestClient.CreateDeleteWorkspaceGroupUserRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, userId, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// <summary>
        /// Updates the ServiceWorkspaceGroup.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/workspaces/{workspaceId}/groups/{groupId}. </description>
        ...
        public virtual async Task<ArmOperation<ServiceWorkspaceGroupResource>> UpdateAsync(WaitUntil waitUntil, ApiManagementGroupCreateOrUpdateContent content, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _workspaceGroupRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, ApiManagementGroupCreateOrUpdateContent.ToRequestContent(content), ifMatch, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApiManagementGroupData> response = Response.FromValue(ApiManagementGroupData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
                RehydrationToken rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                ApiManagementArmOperation<ServiceWorkspaceGroupResource> operation = new ApiManagementArmOperation<ServiceWorkspaceGroupResource>(Response.FromValue(new ServiceWorkspaceGroupResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ServiceWorkspaceGroupResource> Update(WaitUntil waitUntil, ApiManagementGroupCreateOrUpdateContent content, ETag? ifMatch = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
