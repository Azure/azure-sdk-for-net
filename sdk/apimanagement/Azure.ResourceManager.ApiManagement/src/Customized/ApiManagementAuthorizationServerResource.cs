...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementAuthorizationServerResource
    {
        ...
        {
            using DiagnosticScope scope = _authorizationServerClientDiagnostics.CreateScope("ApiManagementAuthorizationServerResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _authorizationServerRestClient.CreateAuthorizationServerGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
