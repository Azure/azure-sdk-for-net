...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiIssueResource
    {
        ...
        {
            using DiagnosticScope scope = _apiIssueClientDiagnostics.CreateScope("ApiIssueResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiIssueRestClient.CreateApiIssueGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
