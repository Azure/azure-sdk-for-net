...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class WorkspaceContractResource
    {
        ...
        {
            using DiagnosticScope scope = _workspaceClientDiagnostics.CreateScope("WorkspaceContractResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspaceRestClient.CreateWorkspaceGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
