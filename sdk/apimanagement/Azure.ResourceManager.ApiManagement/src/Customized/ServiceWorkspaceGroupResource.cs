...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ServiceWorkspaceGroupResource
    {
        ...
        {
            using DiagnosticScope scope = _workspaceGroupClientDiagnostics.CreateScope("ServiceWorkspaceGroupResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspaceGroupRestClient.CreateWorkspaceGroupGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
