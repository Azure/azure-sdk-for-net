...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementUserResource
    {
        ...
        {
            using DiagnosticScope scope = _userClientDiagnostics.CreateScope("ApiManagementUserResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _userRestClient.CreateUserGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
