...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementContentType>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementContentType>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementContentType>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementContentType>)} interface");
            }
        ...
        string IPersistableModel<ApiManagementContentType>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
