...
namespace Azure.ResourceManager.ApiManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ApiManagementContentItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ApiManagementContentItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ApiManagementContentItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ApiManagementContentItem>)} interface");
            }
        ...
        ApiManagementContentItem IJsonModel<ApiManagementContentItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ApiManagementContentItem)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<ApiManagementContentItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
