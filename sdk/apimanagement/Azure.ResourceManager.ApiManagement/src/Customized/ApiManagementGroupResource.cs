...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementGroupResource
    {
        ...
        {
            using DiagnosticScope scope = _groupClientDiagnostics.CreateScope("ApiManagementGroupResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _groupRestClient.CreateGroupGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
