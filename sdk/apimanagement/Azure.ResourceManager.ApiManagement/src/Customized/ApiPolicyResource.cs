...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiPolicyResource
    {
        ...
        {
            using DiagnosticScope scope = _apiPolicyClientDiagnostics.CreateScope("ApiPolicyResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiPolicyRestClient.CreateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
