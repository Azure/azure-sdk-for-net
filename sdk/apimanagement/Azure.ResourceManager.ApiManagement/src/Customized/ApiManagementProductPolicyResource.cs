...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementProductPolicyResource
    {
        ...
        {
            using DiagnosticScope scope = _apiManagementProductPolicyClientDiagnostics.CreateScope("ApiManagementProductPolicyResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiManagementProductPolicyRestClient.CreateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
