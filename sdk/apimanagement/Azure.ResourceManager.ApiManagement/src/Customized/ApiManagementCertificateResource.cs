...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementCertificateResource
    {
        ...
        {
            using DiagnosticScope scope = _certificateClientDiagnostics.CreateScope("ApiManagementCertificateResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _certificateRestClient.CreateCertificateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
