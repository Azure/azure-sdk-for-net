...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiIssueAttachmentResource
    {
        ...
        {
            using DiagnosticScope scope = _apiIssueAttachmentClientDiagnostics.CreateScope("ApiIssueAttachmentResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiIssueAttachmentRestClient.CreateApiIssueAttachmentGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
