...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiSchemaResource
    {
        ...
        {
            using DiagnosticScope scope = _apiSchemaClientDiagnostics.CreateScope("ApiSchemaResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiSchemaRestClient.CreateApiSchemaGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
