...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspacePolicyFragmentResource
    {
        ...
        {
            using DiagnosticScope scope = _workspacePolicyFragmentClientDiagnostics.CreateScope("ServiceWorkspacePolicyFragmentResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspacePolicyFragmentRestClient.CreateWorkspacePolicyFragmentGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
