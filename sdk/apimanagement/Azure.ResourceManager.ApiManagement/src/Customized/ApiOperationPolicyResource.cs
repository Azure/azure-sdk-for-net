...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiOperationPolicyResource
    {
        ...
        {
            using DiagnosticScope scope = _apiOperationPolicyClientDiagnostics.CreateScope("ApiOperationPolicyResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiOperationPolicyRestClient.CreateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
