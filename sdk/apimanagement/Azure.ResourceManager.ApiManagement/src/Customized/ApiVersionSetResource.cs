...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiVersionSetResource
    {
        ...
        {
            using DiagnosticScope scope = _apiVersionSetClientDiagnostics.CreateScope("ApiVersionSetResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiVersionSetRestClient.CreateApiVersionSetGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
