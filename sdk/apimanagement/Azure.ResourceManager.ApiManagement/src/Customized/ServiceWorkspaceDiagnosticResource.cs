...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ServiceWorkspaceDiagnosticResource
    {
        ...
        {
            using DiagnosticScope scope = _workspaceDiagnosticClientDiagnostics.CreateScope("ServiceWorkspaceDiagnosticResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspaceDiagnosticRestClient.CreateWorkspaceDiagnosticGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
