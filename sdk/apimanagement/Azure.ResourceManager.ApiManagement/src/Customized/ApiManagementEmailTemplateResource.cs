...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementEmailTemplateResource
    {
        ...
        {
            using DiagnosticScope scope = _emailTemplateClientDiagnostics.CreateScope("ApiManagementEmailTemplateResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _emailTemplateRestClient.CreateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
