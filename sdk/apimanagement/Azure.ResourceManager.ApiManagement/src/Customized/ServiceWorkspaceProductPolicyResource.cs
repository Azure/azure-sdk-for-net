...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ServiceWorkspaceProductPolicyResource
    {
        ...
        {
            using DiagnosticScope scope = _workspaceProductPolicyClientDiagnostics.CreateScope("ServiceWorkspaceProductPolicyResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspaceProductPolicyRestClient.CreateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
