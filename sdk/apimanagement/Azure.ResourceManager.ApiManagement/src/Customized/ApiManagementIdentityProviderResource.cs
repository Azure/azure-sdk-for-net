...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementIdentityProviderResource
    {
        ...
        {
            using DiagnosticScope scope = _identityProviderClientDiagnostics.CreateScope("ApiManagementIdentityProviderResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _identityProviderRestClient.CreateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
