...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ResolverContractResource
    {
        ...
        {
            using DiagnosticScope scope = _graphQLApiResolverClientDiagnostics.CreateScope("ResolverContractResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _graphQLApiResolverRestClient.CreateGraphQLApiResolverGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
