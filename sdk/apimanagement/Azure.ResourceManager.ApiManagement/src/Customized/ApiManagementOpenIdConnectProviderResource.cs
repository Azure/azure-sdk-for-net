...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ApiManagementOpenIdConnectProviderResource
    {
        ...
        {
            using DiagnosticScope scope = _openIdConnectProviderClientDiagnostics.CreateScope("ApiManagementOpenIdConnectProviderResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _openIdConnectProviderRestClient.CreateOpenidConnectProviderGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
