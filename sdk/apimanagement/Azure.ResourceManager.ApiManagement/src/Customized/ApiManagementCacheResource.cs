...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementCacheResource
    {
        ...
        {
            using DiagnosticScope scope = _cacheClientDiagnostics.CreateScope("ApiManagementCacheResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _cacheRestClient.CreateCacheGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
