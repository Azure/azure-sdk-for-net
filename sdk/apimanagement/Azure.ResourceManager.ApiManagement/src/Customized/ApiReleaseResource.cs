...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiReleaseResource
    {
        ...
        {
            using DiagnosticScope scope = _apiReleaseClientDiagnostics.CreateScope("ApiReleaseResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiReleaseRestClient.CreateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
