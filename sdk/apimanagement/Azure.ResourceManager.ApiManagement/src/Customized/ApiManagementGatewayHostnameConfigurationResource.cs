...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementGatewayHostnameConfigurationResource
    {
        ...
        {
            using DiagnosticScope scope = _gatewayHostnameConfigurationClientDiagnostics.CreateScope("ApiManagementGatewayHostnameConfigurationResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _gatewayHostnameConfigurationRestClient.CreateGatewayHostnameConfigurationGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
