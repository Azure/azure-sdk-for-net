...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementPortalRevisionResource
    {
        ...
        {
            using DiagnosticScope scope = _portalRevisionClientDiagnostics.CreateScope("ApiManagementPortalRevisionResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _portalRevisionRestClient.CreatePortalRevisionGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
