...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiIssueCommentResource
    {
        ...
        {
            using DiagnosticScope scope = _apiIssueCommentClientDiagnostics.CreateScope("ApiIssueCommentResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiIssueCommentRestClient.CreateApiIssueCommentGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
