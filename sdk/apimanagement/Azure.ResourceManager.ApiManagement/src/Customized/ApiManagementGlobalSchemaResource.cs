...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementGlobalSchemaResource
    {
        ...
        {
            using DiagnosticScope scope = _globalSchemaClientDiagnostics.CreateScope("ApiManagementGlobalSchemaResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _globalSchemaRestClient.CreateGlobalSchemaGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
