...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceApiWikiResource
    {
        ...
        {
            using DiagnosticScope scope = _apiWikiClientDiagnostics.CreateScope("ServiceApiWikiResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiWikiRestClient.CreateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
