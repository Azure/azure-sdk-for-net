...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiTagDescriptionResource
    {
        ...
        {
            using DiagnosticScope scope = _apiTagDescriptionClientDiagnostics.CreateScope("ApiTagDescriptionResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiTagDescriptionRestClient.CreateApiTagDescriptionGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
