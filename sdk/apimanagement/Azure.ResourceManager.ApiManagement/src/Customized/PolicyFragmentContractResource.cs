...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class PolicyFragmentContractResource
    {
        ...
        {
            using DiagnosticScope scope = _policyFragmentClientDiagnostics.CreateScope("PolicyFragmentContractResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _policyFragmentRestClient.CreatePolicyFragmentGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
