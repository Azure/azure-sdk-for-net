...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementSubscriptionResource
    {
        ...
        {
            using DiagnosticScope scope = _subscriptionClientDiagnostics.CreateScope("ApiManagementSubscriptionResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _subscriptionRestClient.CreateSubscriptionGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
