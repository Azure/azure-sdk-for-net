...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspaceBackendResource
    {
        ...
        {
            using DiagnosticScope scope = _workspaceBackendClientDiagnostics.CreateScope("ServiceWorkspaceBackendResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspaceBackendRestClient.CreateWorkspaceBackendGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
