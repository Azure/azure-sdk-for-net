...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspaceLoggerResource
    {
        ...
        {
            using DiagnosticScope scope = _workspaceLoggerClientDiagnostics.CreateScope("ServiceWorkspaceLoggerResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspaceLoggerRestClient.CreateWorkspaceLoggerGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
