...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementBackendResource
    {
        ...
        {
            using DiagnosticScope scope = _backendClientDiagnostics.CreateScope("ApiManagementBackendResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _backendRestClient.CreateBackendGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
