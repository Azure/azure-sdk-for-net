...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ServiceWorkspaceSchemaResource
    {
        ...
        {
            using DiagnosticScope scope = _workspaceGlobalSchemaClientDiagnostics.CreateScope("ServiceWorkspaceSchemaResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspaceGlobalSchemaRestClient.CreateWorkspaceGlobalSchemaGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
