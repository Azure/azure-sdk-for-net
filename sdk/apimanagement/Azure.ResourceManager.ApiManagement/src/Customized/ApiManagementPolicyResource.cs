...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementPolicyResource
    {
        ...
        {
            using DiagnosticScope scope = _policyClientDiagnostics.CreateScope("ApiManagementPolicyResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _policyRestClient.CreateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
