...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ServiceWorkspacePolicyResource
    {
        ...
        {
            using DiagnosticScope scope = _workspacePolicyClientDiagnostics.CreateScope("ServiceWorkspacePolicyResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspacePolicyRestClient.CreateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
