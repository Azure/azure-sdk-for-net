...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ServiceProductWikiResource
    {
        ...
        {
            using DiagnosticScope scope = _productWikiClientDiagnostics.CreateScope("ServiceProductWikiResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _productWikiRestClient.CreateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, context);
