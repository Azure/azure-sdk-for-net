...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ServiceWorkspaceNamedValueResource
    {
        ...
        {
            using DiagnosticScope scope = _workspaceNamedValueClientDiagnostics.CreateScope("ServiceWorkspaceNamedValueResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspaceNamedValueRestClient.CreateWorkspaceNamedValueGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
