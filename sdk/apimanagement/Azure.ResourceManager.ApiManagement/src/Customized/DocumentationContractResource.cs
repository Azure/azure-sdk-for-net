...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class DocumentationContractResource
    {
        ...
        {
            using DiagnosticScope scope = _documentationClientDiagnostics.CreateScope("DocumentationContractResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _documentationRestClient.CreateDocumentationGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
