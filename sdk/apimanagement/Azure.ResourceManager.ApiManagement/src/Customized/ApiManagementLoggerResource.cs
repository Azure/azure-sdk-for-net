...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiManagementLoggerResource
    {
        ...
        {
            using DiagnosticScope scope = _loggerClientDiagnostics.CreateScope("ApiManagementLoggerResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _loggerRestClient.CreateLoggerGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
