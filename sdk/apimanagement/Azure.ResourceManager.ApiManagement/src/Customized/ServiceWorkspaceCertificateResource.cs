...
namespace Azure.ResourceManager.ApiManagement
{
    ...
    public partial class ServiceWorkspaceCertificateResource
    {
        ...
        {
            using DiagnosticScope scope = _workspaceCertificateClientDiagnostics.CreateScope("ServiceWorkspaceCertificateResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspaceCertificateRestClient.CreateWorkspaceCertificateGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
