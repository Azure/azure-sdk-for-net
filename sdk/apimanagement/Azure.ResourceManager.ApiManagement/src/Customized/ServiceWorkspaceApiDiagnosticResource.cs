...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ServiceWorkspaceApiDiagnosticResource
    {
        ...
        {
            using DiagnosticScope scope = _workspaceApiDiagnosticClientDiagnostics.CreateScope("ServiceWorkspaceApiDiagnosticResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _workspaceApiDiagnosticRestClient.CreateWorkspaceApiDiagnosticGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
