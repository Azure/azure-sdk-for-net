...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiDiagnosticResource
    {
        ...
        {
            using DiagnosticScope scope = _apiDiagnosticClientDiagnostics.CreateScope("ApiDiagnosticResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiDiagnosticRestClient.CreateApiDiagnosticGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
