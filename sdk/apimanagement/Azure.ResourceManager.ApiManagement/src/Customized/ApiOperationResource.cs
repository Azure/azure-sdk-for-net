...
namespace Azure.ResourceManager.ApiManagement
{
    public partial class ApiOperationResource
    {
        ...
        {
            using DiagnosticScope scope = _apiOperationClientDiagnostics.CreateScope("ApiOperationResource.GetEntityTag");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext { CancellationToken = cancellationToken };
                HttpMessage message = _apiOperationRestClient.CreateApiOperationGetEntityTagRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, context);
