...
namespace Azure.ResourceManager.ApiManagement.Tests
{
    public class ApiVersionSetTests : ApiManagementManagementTestBase
    {
        ...
        public async Task CRUD()
        {
            ...
            await versionSetContract.UpdateAsync(ETag.All.ToString(), versionSetUpdateParams);
            ...
            // now delete it
            await versionSetContract.DeleteAsync(WaitUntil.Completed, ETag.All.ToString());
