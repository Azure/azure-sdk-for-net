...
{
    public partial class Sample_ServiceTagOperationLinkCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_ApiManagementCreateTagOperationLink()
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/ApiManagement/preview/2025-03-01-preview/examples/ApiManagementCreateTagOperationLink.json
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/ApiManagement/preview/2025-03-01-preview/examples/ApiManagementGetTagOperationLink.json
            ...
            // invoke the operation
            string operationLinkId = "link1";
            ServiceTagOperationLinkResource result = await collection.GetAsync(operationLinkId);
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/ApiManagement/preview/2025-03-01-preview/examples/ApiManagementListTagOperationLinks.json
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_ApiManagementGetTagOperationLink()
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/ApiManagement/preview/2025-03-01-preview/examples/ApiManagementGetTagOperationLink.json
            // this example is just showing the usage of "TagOperationLink_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string operationLinkId = "link1";
            bool result = await collection.ExistsAsync(operationLinkId);
        ...
        public async Task GetIfExists_ApiManagementGetTagOperationLink()
        {
            ...
            // invoke the operation
            string operationLinkId = "link1";
            NullableResponse<ServiceTagOperationLinkResource> response = await collection.GetIfExistsAsync(operationLinkId);
            ServiceTagOperationLinkResource result = response.HasValue ? response.Value : null;
