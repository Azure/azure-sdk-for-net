...
{
    public partial class Sample_ServiceApiVersionSetCollection
    {
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementListApiVersionSets.json
            ...
            // get the collection of this ServiceApiVersionSetResource
            ServiceApiVersionSetCollection collection = apiManagementService.GetServiceApiVersionSets();

            // invoke the operation and iterate over the result
            await foreach (ServiceApiVersionSetResource item in collection.GetAllAsync())
            {
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementGetApiVersionSet.json
        ...
        public async Task GetIfExists_ApiManagementGetApiVersionSet()
        {
            ...
            // invoke the operation
            string versionSetId = "vs1";
            NullableResponse<ServiceApiVersionSetResource> response = await collection.GetIfExistsAsync(versionSetId);
            ServiceApiVersionSetResource result = response.HasValue ? response.Value : null;
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementCreateApiVersionSet.json
            ...
            ArmOperation<ServiceApiVersionSetResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, versionSetId, data);
            ServiceApiVersionSetResource result = lro.Value;
