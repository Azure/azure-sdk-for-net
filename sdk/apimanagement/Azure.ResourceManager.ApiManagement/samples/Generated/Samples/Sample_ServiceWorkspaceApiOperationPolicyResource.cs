...
namespace Azure.ResourceManager.ApiManagement.Samples
{
    public partial class Sample_ServiceWorkspaceApiOperationPolicyResource
    {
        ...
        public async Task Delete_ApiManagementDeleteWorkspaceApiOperationPolicy()
        {
            ...
            await serviceWorkspaceApiOperationPolicy.DeleteAsync(WaitUntil.Completed, ifMatch).ConfigureAwait(false);
        ...
        public async Task Update_ApiManagementCreateWorkspaceApiOperationPolicy()
        {
            ...
            ETag? ifMatch = new ETag("*");
            ArmOperation<ServiceWorkspaceApiOperationPolicyResource> lro = await serviceWorkspaceApiOperationPolicy.UpdateAsync(WaitUntil.Completed, data, ifMatch);
