...
namespace Azure.ResourceManager.ApiManagement.Samples
{
    public partial class Sample_ServiceApiOperationCollection
    {
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementListApiOperations.json
            ...
            // get the collection of this ServiceApiOperationResource
            ServiceApiOperationCollection collection = serviceApi.GetServiceApiOperations();

            // invoke the operation and iterate over the result
            await foreach (ServiceApiOperationResource item in collection.GetAllAsync())
            {
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementGetApiOperation.json
            ...
            ServiceApiOperationResource result = await collection.GetAsync(operationId);
        ...
        public async Task GetIfExists_ApiManagementGetApiOperation()
        {
            ...
            // invoke the operation
            string operationId = "57d2ef278aa04f0ad01d6cdc";
            NullableResponse<ServiceApiOperationResource> response = await collection.GetIfExistsAsync(operationId);
            ServiceApiOperationResource result = response.HasValue ? response.Value : null;
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementGetApiOperationPetStore.json
            // this example is just showing the usage of "ApiOperation_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-05-01-preview/examples/ApiManagementCreateApiOperation.json
...
Headers =
{
            ...
            ArmOperation<ServiceApiOperationResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, operationId, data);
            ServiceApiOperationResource result = lro.Value;
