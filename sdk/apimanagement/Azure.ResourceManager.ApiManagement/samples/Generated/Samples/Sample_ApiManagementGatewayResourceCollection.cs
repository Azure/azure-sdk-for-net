...
{
    public partial class Sample_ApiManagementGatewayResourceCollection
    {
        ...
        public async Task CreateOrUpdate_ApiManagementCreateStandardGateway()
        {
            ...
            ApiManagementGatewayResourceCollection collection = resourceGroupResource.GetApiManagementGatewayResources();
...
["Test"] = "User",
            ...
            ArmOperation<ApiManagementGatewayResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, gatewayName, data);
...
["Test"] = "User",
        ...
        public async Task Get_ApiManagementGatewayGetGateway()
        {
            ...
            ApiManagementGatewayResource result = await collection.GetAsync(gatewayName);
        ...
        public async Task GetIfExists_ApiManagementGatewayGetGateway()
        {
            ...
            // invoke the operation
            string gatewayName = "apimService1";
            NullableResponse<ApiManagementGatewayResource> response = await collection.GetIfExistsAsync(gatewayName);
