...
{
    public partial class Sample_ServiceBackendCollection
    {
        ...
        public async Task GetAll_ApiManagementListBackends()
        {
            ...
            // get the collection of this ServiceBackendResource
            ServiceBackendCollection collection = apiManagementService.GetServiceBackends();

            // invoke the operation and iterate over the result
            await foreach (ServiceBackendResource item in collection.GetAllAsync())
            {
        ...
        public async Task Get_ApiManagementGetBackend()
        {
            ...
            ServiceBackendResource result = await collection.GetAsync(backendId);
        ...
        public async Task GetIfExists_ApiManagementGetBackend()
        {
            ...
            // invoke the operation
            string backendId = "sfbackend";
            NullableResponse<ServiceBackendResource> response = await collection.GetIfExistsAsync(backendId);
            ServiceBackendResource result = response.HasValue ? response.Value : null;
...
"val1","val2"
            ...
            ArmOperation<ServiceBackendResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, backendId, data);
            ServiceBackendResource result = lro.Value;
