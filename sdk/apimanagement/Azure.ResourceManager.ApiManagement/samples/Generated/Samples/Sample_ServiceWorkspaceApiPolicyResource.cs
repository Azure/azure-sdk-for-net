...
namespace Azure.ResourceManager.ApiManagement.Samples
{
    public partial class Sample_ServiceWorkspaceApiPolicyResource
    {
        ...
        public async Task Delete_ApiManagementDeleteWorkspaceApiPolicy()
        {
            ...
            await serviceWorkspaceApiPolicy.DeleteAsync(WaitUntil.Completed, ifMatch).ConfigureAwait(false);
        ...
        public async Task Update_ApiManagementCreateWorkspaceApiPolicy()
        {
            ...
            ETag? ifMatch = new ETag("*");
            ArmOperation<ServiceWorkspaceApiPolicyResource> lro = await serviceWorkspaceApiPolicy.UpdateAsync(WaitUntil.Completed, data, ifMatch);
