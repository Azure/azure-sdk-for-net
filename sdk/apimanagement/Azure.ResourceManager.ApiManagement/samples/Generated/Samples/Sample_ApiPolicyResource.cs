...
namespace Azure.ResourceManager.ApiManagement.Samples
{
    public partial class Sample_ApiPolicyResource
    {
        ...
        public async Task Delete_ApiManagementDeleteApiPolicy()
        {
            ...
            await apiPolicy.DeleteAsync(WaitUntil.Completed, ifMatch).ConfigureAwait(false);
        ...
        public async Task Update_ApiManagementCreateApiPolicy()
        {
            ...
            ETag? ifMatch = new ETag("*");
            ArmOperation<ApiPolicyResource> lro = await apiPolicy.UpdateAsync(WaitUntil.Completed, data, ifMatch);
