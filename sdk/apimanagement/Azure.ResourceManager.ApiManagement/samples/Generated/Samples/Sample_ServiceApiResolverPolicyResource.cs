...
namespace Azure.ResourceManager.ApiManagement.Samples
{
    public partial class Sample_ServiceApiResolverPolicyResource
    {
        ...
        public async Task Delete_ApiManagementDeleteGraphQLApiResolverPolicy()
        {
            ...
            await serviceApiResolverPolicy.DeleteAsync(WaitUntil.Completed, ifMatch).ConfigureAwait(false);
        ...
        public async Task Update_ApiManagementCreateGraphQLApiResolverPolicy()
        {
            ...
            ETag? ifMatch = new ETag("*");
            ArmOperation<ServiceApiResolverPolicyResource> lro = await serviceApiResolverPolicy.UpdateAsync(WaitUntil.Completed, data, ifMatch);
