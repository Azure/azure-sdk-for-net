...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    internal partial class ApiExportOperations : IServiceOperations<ApiManagementClient>, IApiExportOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<ApiExportResult>> GetWithHttpMessagesAsync(string resourceGroupName, string serviceName, string apiId, string format, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
