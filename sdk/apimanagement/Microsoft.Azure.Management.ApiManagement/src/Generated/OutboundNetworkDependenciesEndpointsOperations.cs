...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    /// </summary>
    internal partial class OutboundNetworkDependenciesEndpointsOperations : IServiceOperations<ApiManagementClient>, IOutboundNetworkDependenciesEndpointsOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<OutboundEnvironmentEndpointList>> ListByServiceWithHttpMessagesAsync(string resourceGroupName, string serviceName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<OutboundEnvironmentEndpointList>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<OutboundEnvironmentEndpointList>(_responseContent, Client.DeserializationSettings);
                }
