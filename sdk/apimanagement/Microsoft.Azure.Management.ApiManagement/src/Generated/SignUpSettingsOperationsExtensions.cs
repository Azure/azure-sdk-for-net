...
namespace Microsoft.Azure.Management.ApiManagement
{
    ...
    public static partial class SignUpSettingsOperationsExtensions
    {
            ...
            /// </param>
            [System.Obsolete("This operation is deprecated. Please do not use it any longer.")]
            public static async Task<PortalSignupSettings> CreateOrUpdateAsync(this ISignUpSettingsOperations operations, string resourceGroupName, string serviceName, PortalSignupSettings parameters, string ifMatch = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
