...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class DocumentationUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DocumentationUpdateHeaders class.
        /// </summary>
        public DocumentationUpdateHeaders()
        {
            CustomInit();
        }
        ...
        public DocumentationUpdateHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
