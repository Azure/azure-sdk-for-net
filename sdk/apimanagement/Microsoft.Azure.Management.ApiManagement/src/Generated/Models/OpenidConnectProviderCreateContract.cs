...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    public partial class OpenidConnectProviderCreateContract : Resource
    {
        /// <summary>
        ...
        public OpenidConnectProviderCreateContract(string displayName, string metadataEndpoint, string clientId, string clientSecret, string id = default(string), string name = default(string), string type = default(string), string description = default(string))
            : base(id, name, type)
        {
