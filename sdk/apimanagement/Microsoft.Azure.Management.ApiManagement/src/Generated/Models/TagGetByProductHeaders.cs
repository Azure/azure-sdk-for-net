...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class TagGetByProductHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TagGetByProductHeaders class.
        /// </summary>
        public TagGetByProductHeaders()
        {
            CustomInit();
        }
        ...
        public TagGetByProductHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
