...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class ProductWikiUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ProductWikiUpdateHeaders class.
        /// </summary>
        public ProductWikiUpdateHeaders()
        {
            CustomInit();
        }
        ...
        public ProductWikiUpdateHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
