...
namespace Microsoft.Azure.Management.ApiManagement.Models
{
    ...
    /// </summary>
    public partial class PolicyFragmentGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PolicyFragmentGetHeaders class.
        /// </summary>
        public PolicyFragmentGetHeaders()
        {
            CustomInit();
        }
        ...
        public PolicyFragmentGetHeaders(string eTag = default(string))
        {
            ETag = eTag;
            CustomInit();
        }
