...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class ServiceWorkspaceApiDiagnostic : ProvisionableResource
    {
        private BicepValue<ResourceIdentifier> _id;
        private BicepValue<string> _name;
        private SystemData _systemData;
        private DiagnosticContractProperties _properties;
        private ResourceReference<ServiceWorkspaceApi> _parent;

        /// <summary> Creates a new ServiceWorkspaceApiDiagnostic. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ServiceWorkspaceApiDiagnostic(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/workspaces/apis/diagnostics", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        internal DiagnosticContractProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for ServiceWorkspaceApiDiagnostic. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<DiagnosticContractProperties>(nameof(Properties), new string[] { "properties" });
            _parent = DefineResource<ServiceWorkspaceApi>(nameof(Parent), new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing ServiceWorkspaceApiDiagnostic. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ServiceWorkspaceApiDiagnostic FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ServiceWorkspaceApiDiagnostic result = new ServiceWorkspaceApiDiagnostic(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ServiceWorkspaceApiDiagnostic that are not part of the generated code. </summary>
