...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class ApiDiagnostic : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ApiDiagnostic. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ApiDiagnostic(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/apis/diagnostics", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ApiDiagnostic. </summary>
        ...
        /// <summary> Creates a reference to an existing ApiDiagnostic. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ApiDiagnostic FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ApiDiagnostic result = new ApiDiagnostic(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ApiDiagnostic that are not part of the generated code. </summary>
