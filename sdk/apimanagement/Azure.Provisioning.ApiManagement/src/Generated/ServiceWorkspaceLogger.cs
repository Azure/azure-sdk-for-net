...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class ServiceWorkspaceLogger : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ServiceWorkspaceLogger. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ServiceWorkspaceLogger(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/workspaces/loggers", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ServiceWorkspaceLogger. </summary>
        ...
        /// <summary> Creates a reference to an existing ServiceWorkspaceLogger. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ServiceWorkspaceLogger FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ServiceWorkspaceLogger result = new ServiceWorkspaceLogger(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ServiceWorkspaceLogger that are not part of the generated code. </summary>
