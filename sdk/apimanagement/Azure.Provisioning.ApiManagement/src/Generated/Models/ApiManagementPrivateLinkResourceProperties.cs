...
namespace Azure.Provisioning.ApiManagement
{
    ...
    internal partial class ApiManagementPrivateLinkResourceProperties : ProvisionableConstruct
    {
        private BicepValue<string> _groupId;
        private BicepList<string> _requiredMembers;
        private BicepList<string> _requiredZoneNames;

        /// <summary> Creates a new ApiManagementPrivateLinkResourceProperties. </summary>
        public ApiManagementPrivateLinkResourceProperties()
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ApiManagementPrivateLinkResourceProperties. </summary>
        ...
        /// <summary> Define additional provisionable properties for ApiManagementPrivateLinkResourceProperties that are not part of the generated code. </summary>
