...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class ApiManagementDiagnostic : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ApiManagementDiagnostic. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ApiManagementDiagnostic(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/diagnostics", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ApiManagementDiagnostic. </summary>
        ...
        /// <summary> Creates a reference to an existing ApiManagementDiagnostic. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ApiManagementDiagnostic FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ApiManagementDiagnostic result = new ApiManagementDiagnostic(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ApiManagementDiagnostic that are not part of the generated code. </summary>
