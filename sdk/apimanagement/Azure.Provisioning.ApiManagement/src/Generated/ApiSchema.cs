...
public partial class ApiSchema : ProvisionableResource
{
    ...
    /// The the Bicep identifier name of the ApiSchema resource.  This can be
    /// used to refer to the resource in expressions, but is not the Azure
    /// name of the resource.  This value can contain letters, numbers, and
    /// underscores.
    /// </param>
    /// <param name="resourceVersion">Version of the ApiSchema.</param>
    public ApiSchema(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.ApiManagement/service/apis/schemas", resourceVersion ?? "2024-05-01")
    {
    }

    /// <summary>
    /// Define all the provisionable properties of ApiSchema.
    /// </summary>
    ...
    /// <summary>
    /// Creates a reference to an existing ApiSchema.
    /// </summary>
    /// <param name="bicepIdentifier">
    /// The the Bicep identifier name of the ApiSchema resource.  This can be
    /// used to refer to the resource in expressions, but is not the Azure
    ...
    /// </param>
    /// <param name="resourceVersion">Version of the ApiSchema.</param>
    /// <returns>The existing ApiSchema resource.</returns>
    public static ApiSchema FromExisting(string bicepIdentifier, string? resourceVersion = default) =>
