...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class AuthorizationProviderContract : ProvisionableResource
    {
        ...
        private AuthorizationProviderContractProperties _properties;
        private ResourceReference<ApiManagementService> _parent;

        /// <summary> Creates a new AuthorizationProviderContract. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public AuthorizationProviderContract(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/authorizationProviders", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        internal AuthorizationProviderContractProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for AuthorizationProviderContract. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<AuthorizationProviderContractProperties>(nameof(Properties), new string[] { "properties" });
            _parent = DefineResource<ApiManagementService>(nameof(Parent), new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing AuthorizationProviderContract. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static AuthorizationProviderContract FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            AuthorizationProviderContract result = new AuthorizationProviderContract(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for AuthorizationProviderContract that are not part of the generated code. </summary>
