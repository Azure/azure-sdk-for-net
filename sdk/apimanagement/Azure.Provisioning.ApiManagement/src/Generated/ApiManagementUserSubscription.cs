...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class ApiManagementUserSubscription : ProvisionableResource
    {
        ...
        private ResourceReference<ApiManagementUser> _parent;

        /// <summary> Creates a new ApiManagementUserSubscription. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ApiManagementUserSubscription(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/users/subscriptions", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        public ApiManagementUser Parent
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for ApiManagementUserSubscription. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _parent = DefineResource<ApiManagementUser>(nameof(Parent), new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing ApiManagementUserSubscription. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ApiManagementUserSubscription FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ApiManagementUserSubscription result = new ApiManagementUserSubscription(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ApiManagementUserSubscription that are not part of the generated code. </summary>
