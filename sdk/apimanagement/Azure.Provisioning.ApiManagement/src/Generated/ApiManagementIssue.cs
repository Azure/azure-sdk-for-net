...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class ApiManagementIssue : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ApiManagementIssue. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ApiManagementIssue(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/issues", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ApiManagementIssue. </summary>
        ...
        /// <summary> Creates a reference to an existing ApiManagementIssue. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ApiManagementIssue FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ApiManagementIssue result = new ApiManagementIssue(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ApiManagementIssue that are not part of the generated code. </summary>
