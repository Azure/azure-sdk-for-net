...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class ServiceWorkspaceProduct : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ServiceWorkspaceProduct. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ServiceWorkspaceProduct(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/workspaces/products", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ServiceWorkspaceProduct. </summary>
        ...
        /// <summary> Creates a reference to an existing ServiceWorkspaceProduct. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ServiceWorkspaceProduct FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ServiceWorkspaceProduct result = new ServiceWorkspaceProduct(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ServiceWorkspaceProduct that are not part of the generated code. </summary>
