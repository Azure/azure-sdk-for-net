...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class ServiceWorkspaceBackend : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ServiceWorkspaceBackend. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ServiceWorkspaceBackend(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/workspaces/backends", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ServiceWorkspaceBackend. </summary>
        ...
        /// <summary> Creates a reference to an existing ServiceWorkspaceBackend. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ServiceWorkspaceBackend FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ServiceWorkspaceBackend result = new ServiceWorkspaceBackend(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ServiceWorkspaceBackend that are not part of the generated code. </summary>
