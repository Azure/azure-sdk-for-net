...
public partial class ApiManagementLogger : ProvisionableResource
{
    ...
    /// <summary>
    /// Creates a new ApiManagementLogger.
    /// </summary>
    /// <param name="bicepIdentifier">
    /// The the Bicep identifier name of the ApiManagementLogger resource.
    /// This can be used to refer to the resource in expressions, but is not
    /// the Azure name of the resource.  This value can contain letters,
    /// numbers, and underscores.
    /// </param>
    /// <param name="resourceVersion">Version of the ApiManagementLogger.</param>
    public ApiManagementLogger(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.ApiManagement/service/loggers", resourceVersion ?? "2024-05-01")
    {
    }

    /// <summary>
    /// Define all the provisionable properties of ApiManagementLogger.
    /// </summary>
    ...
    /// <summary>
    /// Creates a reference to an existing ApiManagementLogger.
    /// </summary>
    /// <param name="bicepIdentifier">
    /// The the Bicep identifier name of the ApiManagementLogger resource.
    /// This can be used to refer to the resource in expressions, but is not
    ...
    /// </param>
    /// <param name="resourceVersion">Version of the ApiManagementLogger.</param>
    /// <returns>The existing ApiManagementLogger resource.</returns>
    public static ApiManagementLogger FromExisting(string bicepIdentifier, string? resourceVersion = default) =>
