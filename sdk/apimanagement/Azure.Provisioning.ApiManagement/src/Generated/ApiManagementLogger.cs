...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class ApiManagementLogger : ProvisionableResource
    {
        private BicepValue<ResourceIdentifier> _id;
        private BicepValue<string> _name;
        private SystemData _systemData;
        private LoggerContractProperties _properties;
        private ResourceReference<ApiManagementService> _parent;

        /// <summary> Creates a new ApiManagementLogger. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ApiManagementLogger(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/loggers", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        internal LoggerContractProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for ApiManagementLogger. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<LoggerContractProperties>(nameof(Properties), new string[] { "properties" });
            _parent = DefineResource<ApiManagementService>(nameof(Parent), new string[] { "parent" }, isRequired: true);
            DefineAdditionalProperties();
        }

        /// <summary> Creates a reference to an existing ApiManagementLogger. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ApiManagementLogger FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ApiManagementLogger result = new ApiManagementLogger(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ApiManagementLogger that are not part of the generated code. </summary>
