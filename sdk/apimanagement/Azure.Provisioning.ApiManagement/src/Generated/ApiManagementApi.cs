...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class ApiManagementApi : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ApiManagementApi. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ApiManagementApi(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/apis", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ApiManagementApi. </summary>
        ...
        /// <summary> Creates a reference to an existing ApiManagementApi. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ApiManagementApi FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ApiManagementApi result = new ApiManagementApi(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ApiManagementApi that are not part of the generated code. </summary>
