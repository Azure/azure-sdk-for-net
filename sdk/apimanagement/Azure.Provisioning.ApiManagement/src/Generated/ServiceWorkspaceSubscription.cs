...
namespace Azure.Provisioning.ApiManagement
{
    ...
    public partial class ServiceWorkspaceSubscription : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ServiceWorkspaceSubscription. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ServiceWorkspaceSubscription(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.ApiManagement/service/workspaces/subscriptions", resourceVersion ?? "2025-09-01-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ServiceWorkspaceSubscription. </summary>
        ...
        /// <summary> Creates a reference to an existing ServiceWorkspaceSubscription. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ServiceWorkspaceSubscription FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ServiceWorkspaceSubscription result = new ServiceWorkspaceSubscription(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ServiceWorkspaceSubscription that are not part of the generated code. </summary>
