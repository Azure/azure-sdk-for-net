...
namespace Microsoft.Azure.Management.DevOps
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<DevOpsClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(DevOpsClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.DevOps/operations").ToString();
