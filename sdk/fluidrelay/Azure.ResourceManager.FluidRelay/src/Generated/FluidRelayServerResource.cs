...
namespace Azure.ResourceManager.FluidRelay
{
    ...
    public partial class FluidRelayServerResource : ArmResource
    {
        ...
        internal FluidRelayServerResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _fluidRelayServerClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.FluidRelay", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string fluidRelayServerApiVersion);
        ...
        public virtual FluidRelayServerData Data
        {
            get
            {
                if (!HasData)
        ...
        /// <summary> Gets a collection of FluidRelayContainerResources in the FluidRelayServer. </summary>
        ...
        {
            return await GetFluidRelayContainers().GetAsync(fluidRelayContainerName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetFluidRelayContainers().Get(fluidRelayContainerName, cancellationToken);
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<FluidRelayServerResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _fluidRelayServerClientDiagnostics.CreateScope("FluidRelayServerResource.Get");
            scope.Start();
            try
            {
                var response = await _fluidRelayServerRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<FluidRelayServerResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _fluidRelayServerClientDiagnostics.CreateScope("FluidRelayServerResource.Get");
            scope.Start();
            try
            {
                var response = _fluidRelayServerRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new FluidRelayServerResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _fluidRelayServerClientDiagnostics.CreateScope("FluidRelayServerResource.Delete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<FluidRelayServerResource>> UpdateAsync(FluidRelayServerPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _fluidRelayServerRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new FluidRelayServerResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<FluidRelayServerResource> Update(FluidRelayServerPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _fluidRelayServerRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken);
                return Response.FromValue(new FluidRelayServerResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.FluidRelay/fluidRelayServers/{fluidRelayServerName}/regenerateKey</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        public virtual async Task<Response<FluidRelayServerKeys>> RegenerateKeysAsync(RegenerateKeyContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _fluidRelayServerRestClient.RegenerateKeyAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroup}/providers/Microsoft.FluidRelay/fluidRelayServers/{fluidRelayServerName}/listKeys</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        {
            using var scope = _fluidRelayServerClientDiagnostics.CreateScope("FluidRelayServerResource.GetKeys");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<FluidRelayServerResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _fluidRelayServerRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                    return Response.FromValue(new FluidRelayServerResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
                    var current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    var patch = new FluidRelayServerPatch();
        ...
        public virtual Response<FluidRelayServerResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _fluidRelayServerRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                    return Response.FromValue(new FluidRelayServerResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
