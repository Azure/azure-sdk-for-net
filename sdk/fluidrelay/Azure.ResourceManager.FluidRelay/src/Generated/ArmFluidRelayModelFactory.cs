...
namespace Azure.ResourceManager.FluidRelay.Models
{
    ...
    public static partial class ArmFluidRelayModelFactory
    {
        ...
        public static FluidRelayEndpoints FluidRelayEndpoints(IEnumerable<string> ordererEndpoints = null, IEnumerable<string> storageEndpoints = null, IEnumerable<string> serviceEndpoints = null)
        {
            ...
            return new FluidRelayEndpoints(ordererEndpoints?.ToList(), storageEndpoints?.ToList(), serviceEndpoints?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FluidRelayServerKeys(primaryKey, secondaryKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FluidRelayContainerData(id, name, resourceType, systemData, frsTenantId, frsContainerId, provisioningState, createdOn, lastAccessOn, new Dictionary<string, BinaryData>());
        }
    }
}
