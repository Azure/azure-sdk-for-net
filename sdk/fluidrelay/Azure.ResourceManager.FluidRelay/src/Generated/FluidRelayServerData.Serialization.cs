...
;
                ...
                if (property.NameEquals("systemData"u8))
                {
                    ...
                    systemData =
#if NET9_0_OR_GREATER
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.FluidRelay.ModelSerializationExtensions.WireOptions, AzureResourceManagerFluidRelayContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerFluidRelayContext.Default)
#endif
;
                    continue;
                }
