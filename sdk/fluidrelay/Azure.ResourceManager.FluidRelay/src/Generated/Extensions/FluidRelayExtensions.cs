...
using Azure.ResourceManager.FluidRelay.Testing;
...
namespace Azure.ResourceManager.FluidRelay
{
    ...
    public static partial class FluidRelayExtensions
    {
        ...
        private static FluidRelaySubscriptionResourceExtension GetFluidRelaySubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new FluidRelaySubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static FluidRelaySubscriptionResourceExtension GetFluidRelaySubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new FluidRelaySubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetFluidRelaySubscriptionResourceExtension(subscriptionResource).GetFluidRelayServersAsync(cancellationToken);
        }
        ...
        {
            return GetFluidRelaySubscriptionResourceExtension(subscriptionResource).GetFluidRelayServers(cancellationToken);
        }
    }
}
