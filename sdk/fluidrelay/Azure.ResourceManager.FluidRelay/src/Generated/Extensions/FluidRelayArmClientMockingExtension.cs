...
namespace Azure.ResourceManager.FluidRelay.Mocking
{
    ...
    internal partial class FluidRelayArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="FluidRelayArmClientMockingExtension"/> class for mocking. </summary>
        protected FluidRelayArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FluidRelayArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FluidRelayArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal FluidRelayArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
