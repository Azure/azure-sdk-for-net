...
namespace Azure.ResourceManager.FluidRelay.Mocking
{
    ...
    internal partial class FluidRelayResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="FluidRelayResourceGroupMockingExtension"/> class for mocking. </summary>
        protected FluidRelayResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="FluidRelayResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal FluidRelayResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
