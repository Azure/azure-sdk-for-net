...
namespace Azure.ResourceManager.FluidRelay.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegenerateKeyContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RegenerateKeyContent)} does not support writing '{format}' format.");
            }
        ...
        RegenerateKeyContent IJsonModel<RegenerateKeyContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RegenerateKeyContent)} does not support reading '{format}' format.");
            }
        ...
        RegenerateKeyContent IPersistableModel<RegenerateKeyContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(RegenerateKeyContent)} does not support reading '{options.Format}' format.");
            }
        }
