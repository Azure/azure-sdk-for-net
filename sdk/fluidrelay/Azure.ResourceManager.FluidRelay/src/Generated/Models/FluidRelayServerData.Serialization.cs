...
namespace Azure.ResourceManager.FluidRelay
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FluidRelayServerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FluidRelayServerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FluidRelayServerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FluidRelayServerData>)} interface");
            }
        ...
        string IPersistableModel<FluidRelayServerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
