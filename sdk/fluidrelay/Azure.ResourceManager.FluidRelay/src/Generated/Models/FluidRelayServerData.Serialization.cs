...
namespace Azure.ResourceManager.FluidRelay
{
    public partial class FluidRelayServerData : IUtf8JsonSerializable, IJsonModel<FluidRelayServerData>
    {
        ...
        void IJsonModel<FluidRelayServerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(FluidRelayServerData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<FluidRelayServerData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(FluidRelayServerData)} does not support '{options.Format}' format.");
            }
        }
