...
{
    public partial class CmkIdentity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CmkIdentity DeserializeCmkIdentity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
