...
{
    public partial class FluidRelayContainerData : IUtf8JsonSerializable, IJsonModel<FluidRelayContainerData>, IPersistableModel<FluidRelayContainerData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastAccessOn))
            {
                ...
                builder.AppendLine($" '{LastAccessOn.Value.ToString()}'");
            }
