...
{
    internal partial class EncryptionProperties : IUtf8JsonSerializable, IModelJsonSerializable<EncryptionProperties>
    {
        ...
        void IModelJsonSerializable<EncryptionProperties>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            ...
            if (Optional.IsDefined(CustomerManagedKeyEncryption))
            {
                ...
                {
                    ((IModelJsonSerializable<CmkEncryptionProperties>)CustomerManagedKeyEncryption).Serialize(writer, options);
                }
            }
        ...
        internal static EncryptionProperties DeserializeEncryptionProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new EncryptionProperties(customerManagedKeyEncryption.Value, rawData);
        }
