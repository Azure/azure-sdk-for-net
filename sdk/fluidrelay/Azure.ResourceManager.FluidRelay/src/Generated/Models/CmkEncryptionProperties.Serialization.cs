...
{
    public partial class CmkEncryptionProperties : IUtf8JsonSerializable, IJsonModel<CmkEncryptionProperties>, IPersistableModel<CmkEncryptionProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KeyEncryptionKeyIdentity))
            {
                ...
                AppendChildObject(builder, KeyEncryptionKeyIdentity, options, 2);
            }
