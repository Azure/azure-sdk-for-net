...
namespace Azure.ResourceManager.FluidRelay.Models
{
    ...
    public partial class FluidRelayEndpoints
    {
        ...
        internal FluidRelayEndpoints(IReadOnlyList<string> ordererEndpoints, IReadOnlyList<string> storageEndpoints, IReadOnlyList<string> serviceEndpoints, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
