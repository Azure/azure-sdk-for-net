...
namespace Azure.ResourceManager.FluidRelay.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FluidRelayServerPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FluidRelayServerPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FluidRelayServerPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FluidRelayServerPatch>)} interface");
            }
        ...
        string IPersistableModel<FluidRelayServerPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
