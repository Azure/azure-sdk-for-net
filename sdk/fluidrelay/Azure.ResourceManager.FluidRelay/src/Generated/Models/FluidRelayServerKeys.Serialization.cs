...
namespace Azure.ResourceManager.FluidRelay.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FluidRelayServerKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FluidRelayServerKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FluidRelayServerKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FluidRelayServerKeys>)} interface");
            }
        ...
        string IPersistableModel<FluidRelayServerKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
