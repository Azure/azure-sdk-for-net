...
namespace Azure.ResourceManager.StandbyPool.Models
{
    ...
    public partial class StandbyContainerGroupPoolPrediction : IJsonModel<StandbyContainerGroupPoolPrediction>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual StandbyContainerGroupPoolPrediction PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<StandbyContainerGroupPoolPrediction>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StandbyContainerGroupPoolPrediction>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        StandbyContainerGroupPoolPrediction IPersistableModel<StandbyContainerGroupPoolPrediction>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StandbyContainerGroupPoolPrediction IJsonModel<StandbyContainerGroupPoolPrediction>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual StandbyContainerGroupPoolPrediction JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<StandbyContainerGroupPoolPrediction>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StandbyContainerGroupPoolPrediction DeserializeStandbyContainerGroupPoolPrediction(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("forecastValues"u8))
                {
                ...
                {
                    forecastInfo = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new StandbyContainerGroupPoolPrediction(forecastValues, forecastStartsOn, forecastInfo, additionalBinaryDataProperties);
        }
    }
}
