...
namespace Azure.ResourceManager.StandbyPool.Models
{
    internal partial class StandbyVirtualMachineResourceListResult : IUtf8JsonSerializable, IJsonModel<StandbyVirtualMachineResourceListResult>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                ((IJsonModel<StandbyVirtualMachineData>)item).Write(writer, options);
            }
        ...
        StandbyVirtualMachineResourceListResult IJsonModel<StandbyVirtualMachineResourceListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StandbyVirtualMachineResourceListResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static StandbyVirtualMachineResourceListResult DeserializeStandbyVirtualMachineResourceListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new StandbyVirtualMachineResourceListResult(value, nextLink, serializedAdditionalRawData);
        }

        BinaryData IPersistableModel<StandbyVirtualMachineResourceListResult>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StandbyVirtualMachineResourceListResult>)this).GetFormatFromOptions(options) : options.Format;
        ...
        StandbyVirtualMachineResourceListResult IPersistableModel<StandbyVirtualMachineResourceListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StandbyVirtualMachineResourceListResult>)this).GetFormatFromOptions(options) : options.Format;
