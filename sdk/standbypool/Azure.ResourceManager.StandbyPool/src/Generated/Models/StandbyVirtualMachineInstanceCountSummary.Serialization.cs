...
namespace Azure.ResourceManager.StandbyPool.Models
{
    ...
    public partial class StandbyVirtualMachineInstanceCountSummary : IJsonModel<StandbyVirtualMachineInstanceCountSummary>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<StandbyVirtualMachineInstanceCountSummary>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            foreach (PoolVirtualMachineStateCount item in StandbyVirtualMachineInstanceCountsByState)
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StandbyVirtualMachineInstanceCountSummary IJsonModel<StandbyVirtualMachineInstanceCountSummary>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual StandbyVirtualMachineInstanceCountSummary JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<StandbyVirtualMachineInstanceCountSummary>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StandbyVirtualMachineInstanceCountSummary DeserializeStandbyVirtualMachineInstanceCountSummary(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            long? zone = default;
            IReadOnlyList<PoolVirtualMachineStateCount> standbyVirtualMachineInstanceCountsByState = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("instanceCountsByState"u8))
                {
                    ...
                    standbyVirtualMachineInstanceCountsByState = array;
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StandbyVirtualMachineInstanceCountSummary>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StandbyVirtualMachineInstanceCountSummary IPersistableModel<StandbyVirtualMachineInstanceCountSummary>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual StandbyVirtualMachineInstanceCountSummary PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<StandbyVirtualMachineInstanceCountSummary>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
