    ...
    public partial class StandbyContainerGroupPoolPatch : IUtf8JsonSerializable, IJsonModel<StandbyContainerGroupPoolPatch>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                ((IJsonModel<StandbyContainerGroupPoolUpdateProperties>)Properties).Write(writer, options);
            }
        ...
        internal static StandbyContainerGroupPoolPatch DeserializeStandbyContainerGroupPoolPatch(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ModelSerializationExtensions.JsonDeserialize<StandbyContainerGroupPoolUpdateProperties>(property.Value);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        StandbyContainerGroupPoolPatch IPersistableModel<StandbyContainerGroupPoolPatch>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<StandbyContainerGroupPoolPatch>)this).GetFormatFromOptions(options) : options.Format;
