...
namespace Azure.ResourceManager.StandbyPool.Models
{
    ...
    public partial class StandbyVirtualMachinePoolPrediction
    {
        ...
        internal StandbyVirtualMachinePoolPrediction(StandbyVirtualMachinePoolForecastValues forecastValues, DateTimeOffset forecastStartOn, string forecastInfo, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IReadOnlyList<long> ForecastValuesInstancesRequestedCount
        {
            get
            {
                if (ForecastValues is null)
                {
                    ForecastValues = new StandbyVirtualMachinePoolForecastValues();
                }
