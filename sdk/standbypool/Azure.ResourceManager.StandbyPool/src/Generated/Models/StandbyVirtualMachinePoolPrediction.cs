...
namespace Azure.ResourceManager.StandbyPool.Models
{
    ...
    public partial class StandbyVirtualMachinePoolPrediction
    {
        ...
        /// <summary> Initializes a new instance of <see cref="StandbyVirtualMachinePoolPrediction"/>. </summary>
        ...
        internal StandbyVirtualMachinePoolPrediction(StandbyVirtualMachinePoolForecastValues forecastValues, DateTimeOffset forecastStartOn, string forecastInfo)
        {
        ...
        internal StandbyVirtualMachinePoolPrediction(StandbyVirtualMachinePoolForecastValues forecastValues, DateTimeOffset forecastStartOn, string forecastInfo, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ForecastValues = forecastValues;
            ForecastStartOn = forecastStartOn;
            ForecastInfo = forecastInfo;
        ...
        /// <summary> Initializes a new instance of <see cref="StandbyVirtualMachinePoolPrediction"/> for deserialization. </summary>
        internal StandbyVirtualMachinePoolPrediction()
        {
        }

        /// <summary> Displays the forecast information of the standby pool. </summary>
        internal StandbyVirtualMachinePoolForecastValues ForecastValues { get; }
