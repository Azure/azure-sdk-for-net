...
{
    /// <summary>
    /// A Class representing a StandbyVirtualMachineResource along with the instance operations that can be performed on it.
    ...
    /// Otherwise you can get one from its parent resource <see cref="StandbyVirtualMachinePoolResource"/> using the GetStandbyVirtualMachineResource method.
    /// </summary>
    public partial class StandbyVirtualMachineResource : ArmResource
    {
        ...
        private readonly StandbyVirtualMachineResourceData _data;
        ...
        internal StandbyVirtualMachineResource(ArmClient client, StandbyVirtualMachineResourceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            _standbyVirtualMachineResourceStandbyVirtualMachinesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.StandbyPool", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string standbyVirtualMachineResourceStandbyVirtualMachinesApiVersion);
        ...
        public virtual StandbyVirtualMachineResourceData Data
        {
            get
            {
                if (!HasData)
        ...
        {
            using var scope = _standbyVirtualMachineResourceStandbyVirtualMachinesClientDiagnostics.CreateScope("StandbyVirtualMachineResource.Get");
            scope.Start();
            try
            {
                var response = await _standbyVirtualMachineResourceStandbyVirtualMachinesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<StandbyVirtualMachineResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _standbyVirtualMachineResourceStandbyVirtualMachinesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new StandbyVirtualMachineResource(Client, response.Value), response.GetRawResponse());
            }
