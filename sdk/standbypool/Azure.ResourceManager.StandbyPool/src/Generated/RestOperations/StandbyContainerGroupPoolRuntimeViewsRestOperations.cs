...
namespace Azure.ResourceManager.StandbyPool
{
    internal partial class StandbyContainerGroupPoolRuntimeViewsRestOperations
    {
        ...
        public async Task<Response<StandbyContainerGroupPoolRuntimeViewResourceData>> GetAsync(string subscriptionId, string resourceGroupName, string standbyContainerGroupPoolName, string runtimeView, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(standbyContainerGroupPoolName, nameof(standbyContainerGroupPoolName));
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        StandbyContainerGroupPoolRuntimeViewResourceData value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = StandbyContainerGroupPoolRuntimeViewResourceData.DeserializeStandbyContainerGroupPoolRuntimeViewResourceData(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                case 404:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="standbyContainerGroupPoolName"/> or <paramref name="runtimeView"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="standbyContainerGroupPoolName"/> or <paramref name="runtimeView"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<StandbyContainerGroupPoolRuntimeViewResourceData> Get(string subscriptionId, string resourceGroupName, string standbyContainerGroupPoolName, string runtimeView, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNullOrEmpty(resourceGroupName, nameof(resourceGroupName));
            Argument.AssertNotNullOrEmpty(standbyContainerGroupPoolName, nameof(standbyContainerGroupPoolName));
