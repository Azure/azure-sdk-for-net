...
{
    internal class StandbyVirtualMachinePoolResourceOperationSource : IOperationSource<StandbyVirtualMachinePoolResource>
    {
        private readonly ArmClient _client;

        internal StandbyVirtualMachinePoolResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        StandbyVirtualMachinePoolResource IOperationSource<StandbyVirtualMachinePoolResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            var data = StandbyVirtualMachinePoolResourceData.DeserializeStandbyVirtualMachinePoolResourceData(document.RootElement);
