...
#pragma warning disable SA1649 // File name should match first type name
    internal class StandbyPoolArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of StandbyPoolArmOperation for mocking. </summary>
        protected StandbyPoolArmOperation()
        {
        }

        internal StandbyPoolArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal StandbyPoolArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "StandbyPoolArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerStandbyPoolContext.Default).ToObjectFromJson<Dictionary<string, string>>();
