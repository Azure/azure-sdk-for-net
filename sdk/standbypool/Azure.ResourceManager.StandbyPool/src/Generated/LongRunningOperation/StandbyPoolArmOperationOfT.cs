...
namespace Azure.ResourceManager.StandbyPool
{
    internal partial class StandbyPoolArmOperation<T> : ArmOperation<T>
    {
        ...
        internal StandbyPoolArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
