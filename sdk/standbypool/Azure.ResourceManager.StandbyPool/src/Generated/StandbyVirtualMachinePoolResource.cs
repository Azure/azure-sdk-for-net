...
namespace Azure.ResourceManager.StandbyPool
{
    ...
    public partial class StandbyVirtualMachinePoolResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the StandbyVirtualMachinePool.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StandbyPool/standbyVirtualMachinePools/{standbyVirtualMachinePoolName}. </description>
        ...
        public virtual async Task<ArmOperation<StandbyVirtualMachinePoolResource>> UpdateAsync(WaitUntil waitUntil, StandbyVirtualMachinePoolData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _standbyVirtualMachinePoolsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, StandbyVirtualMachinePoolData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<StandbyVirtualMachinePoolResource> Update(WaitUntil waitUntil, StandbyVirtualMachinePoolData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
