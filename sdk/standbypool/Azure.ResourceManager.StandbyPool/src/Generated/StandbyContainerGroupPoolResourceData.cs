...
{
    /// <summary>
    /// A class representing the StandbyContainerGroupPoolResource data model.
    /// A StandbyContainerGroupPoolResource.
    /// </summary>
    public partial class StandbyContainerGroupPoolResourceData : TrackedResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="StandbyContainerGroupPoolResourceData"/>. </summary>
        /// <param name="location"> The location. </param>
        public StandbyContainerGroupPoolResourceData(AzureLocation location) : base(location)
        {
        }
        ...
        internal StandbyContainerGroupPoolResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, StandbyContainerGroupPoolElasticityProfile elasticityProfile, ContainerGroupProperties containerGroupProperties, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="StandbyContainerGroupPoolResourceData"/> for deserialization. </summary>
        internal StandbyContainerGroupPoolResourceData()
        {
        }
