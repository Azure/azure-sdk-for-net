...
namespace Azure.ResourceManager.StandbyPool
{
    ...
    public partial class StandbyContainerGroupPoolRuntimeViewData : ResourceData
    {
        ...
        internal StandbyContainerGroupPoolRuntimeViewData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, StandbyContainerGroupPoolRuntimeViewProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
