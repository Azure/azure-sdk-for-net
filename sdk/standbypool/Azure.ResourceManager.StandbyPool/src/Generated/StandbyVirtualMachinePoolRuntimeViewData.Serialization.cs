...
namespace Azure.ResourceManager.StandbyPool
{
    ...
    public partial class StandbyVirtualMachinePoolRuntimeViewData : ResourceData, IJsonModel<StandbyVirtualMachinePoolRuntimeViewData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        StandbyVirtualMachinePoolRuntimeViewData IJsonModel<StandbyVirtualMachinePoolRuntimeViewData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (StandbyVirtualMachinePoolRuntimeViewData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static StandbyVirtualMachinePoolRuntimeViewData DeserializeStandbyVirtualMachinePoolRuntimeViewData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = StandbyVirtualMachinePoolRuntimeViewProperties.DeserializeStandbyVirtualMachinePoolRuntimeViewProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<StandbyVirtualMachinePoolRuntimeViewData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
