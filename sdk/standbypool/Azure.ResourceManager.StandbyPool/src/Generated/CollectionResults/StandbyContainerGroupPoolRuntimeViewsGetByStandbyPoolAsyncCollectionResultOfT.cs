    ...
    internal partial class StandbyContainerGroupPoolRuntimeViewsGetByStandbyPoolAsyncCollectionResultOfT : AsyncPageable<StandbyContainerGroupPoolRuntimeViewData>
    {
        ...
        public override async IAsyncEnumerable<Page<StandbyContainerGroupPoolRuntimeViewData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<StandbyContainerGroupPoolRuntimeViewData>.FromValues((IReadOnlyList<StandbyContainerGroupPoolRuntimeViewData>)result.Value, nextPage?.AbsoluteUri, response);
