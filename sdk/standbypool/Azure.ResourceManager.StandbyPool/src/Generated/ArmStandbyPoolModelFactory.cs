...
namespace Azure.ResourceManager.StandbyPool.Models
{
    ...
    public static partial class ArmStandbyPoolModelFactory
    {
        ...
        public static StandbyVirtualMachinePoolPatch StandbyVirtualMachinePoolPatch(IDictionary<string, string> tags = default, StandbyVirtualMachinePoolResourceUpdateProperties properties = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        public static StandbyVirtualMachineInstanceCountSummary StandbyVirtualMachineInstanceCountSummary(long? zone = default, IEnumerable<PoolVirtualMachineStateCount> standbyVirtualMachineInstanceCountsByState = default)
        {
        ...
        public static StandbyContainerGroupPoolPatch StandbyContainerGroupPoolPatch(IDictionary<string, string> tags = default, StandbyContainerGroupPoolResourceUpdateProperties properties = default)
        {
            tags ??= new ChangeTrackingDictionary<string, string>();
        ...
        /// <param name="containerGroupProperties"> Specifies container group properties of standby container group pools. </param>
        /// <param name="zones"> Specifies zones of standby container group pools. </param>
        /// <returns> A new <see cref="Models.StandbyContainerGroupPoolResourceUpdateProperties"/> instance for mocking. </returns>
        public static StandbyContainerGroupPoolResourceUpdateProperties StandbyContainerGroupPoolResourceUpdateProperties(StandbyContainerGroupPoolElasticityProfile elasticityProfile = default, StandbyContainerGroupProperties containerGroupProperties = default, IEnumerable<string> zones = default)
        {
            zones ??= new ChangeTrackingList<string>();
