...
{
    /// <summary>
    /// A class representing the StandbyVirtualMachinePoolResource data model.
    /// A StandbyVirtualMachinePoolResource.
    /// </summary>
    public partial class StandbyVirtualMachinePoolResourceData : TrackedResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="StandbyVirtualMachinePoolResourceData"/>. </summary>
        /// <param name="location"> The location. </param>
        public StandbyVirtualMachinePoolResourceData(AzureLocation location) : base(location)
        {
        }
        ...
        internal StandbyVirtualMachinePoolResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, StandbyVirtualMachinePoolElasticityProfile elasticityProfile, VirtualMachineState? virtualMachineState, ResourceIdentifier attachedVirtualMachineScaleSetId, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="StandbyVirtualMachinePoolResourceData"/> for deserialization. </summary>
        internal StandbyVirtualMachinePoolResourceData()
        {
        }
