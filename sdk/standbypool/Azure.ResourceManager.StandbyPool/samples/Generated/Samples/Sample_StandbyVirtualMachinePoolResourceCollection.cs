...
{
    public partial class Sample_StandbyVirtualMachinePoolResourceCollection
    {
        // StandbyVirtualMachinePools_ListByResourceGroup - generated by [MaximumSet] rule
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_StandbyVirtualMachinePoolsListByResourceGroupGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/standbypool/resource-manager/Microsoft.StandbyPool/preview/2023-12-01-preview/examples/StandbyVirtualMachinePools_ListByResourceGroup_MaximumSet_Gen.json
            ...
            StandbyVirtualMachinePoolResourceCollection collection = resourceGroupResource.GetStandbyVirtualMachinePoolResources();
            ...
            await foreach (StandbyVirtualMachinePoolResource item in collection.GetAllAsync())
            {
                ...
                StandbyVirtualMachinePoolResourceData resourceData = item.Data;
        ...
        // StandbyVirtualMachinePools_ListByResourceGroup - generated by [MinimumSet] rule
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_StandbyVirtualMachinePoolsListByResourceGroupGeneratedByMinimumSetRule()
        {
        ...
        public async Task Get_StandbyVirtualMachinePoolsGetGeneratedByMaximumSetRule()
        {
            ...
            // but just for demo, we get its data from this resource instance
            StandbyVirtualMachinePoolResourceData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Exists_StandbyVirtualMachinePoolsGetGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/standbypool/resource-manager/Microsoft.StandbyPool/preview/2023-12-01-preview/examples/StandbyVirtualMachinePools_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "StandbyVirtualMachinePools_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_StandbyVirtualMachinePoolsGetGeneratedByMaximumSetRule()
        {
            // Generated from example definition: specification/standbypool/resource-manager/Microsoft.StandbyPool/preview/2023-12-01-preview/examples/StandbyVirtualMachinePools_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "StandbyVirtualMachinePools_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Exists_StandbyVirtualMachinePoolsGetGeneratedByMinimumSetRule()
        {
            // Generated from example definition: specification/standbypool/resource-manager/Microsoft.StandbyPool/preview/2023-12-01-preview/examples/StandbyVirtualMachinePools_Get_MinimumSet_Gen.json
            // this example is just showing the usage of "StandbyVirtualMachinePools_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_StandbyVirtualMachinePoolsGetGeneratedByMinimumSetRule()
        {
            // Generated from example definition: specification/standbypool/resource-manager/Microsoft.StandbyPool/preview/2023-12-01-preview/examples/StandbyVirtualMachinePools_Get_MinimumSet_Gen.json
            // this example is just showing the usage of "StandbyVirtualMachinePools_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_StandbyVirtualMachinePoolsCreateOrUpdateGeneratedByMaximumSetRule()
        {
            ...
            // invoke the operation
            string standbyVirtualMachinePoolName = "pool";
            StandbyVirtualMachinePoolResourceData data = new StandbyVirtualMachinePoolResourceData(new AzureLocation("West US"))
            {
                ...
                Tags =
{
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_StandbyVirtualMachinePoolsCreateOrUpdateGeneratedByMinimumSetRule()
        {
            // Generated from example definition: specification/standbypool/resource-manager/Microsoft.StandbyPool/preview/2023-12-01-preview/examples/StandbyVirtualMachinePools_CreateOrUpdate_MinimumSet_Gen.json
            // this example is just showing the usage of "StandbyVirtualMachinePools_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
