...
namespace Microsoft.Azure.Management.ManagedServices
{
    ...
    internal partial class RegistrationDefinitionsOperations : IServiceOperations<ManagedServicesClient>, IRegistrationDefinitionsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> DeleteWithHttpMessagesAsync(string registrationDefinitionId, string apiVersion, string scope, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (registrationDefinitionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "registrationDefinitionId");
        ...
        {
            // Send Request
            AzureOperationResponse<RegistrationDefinition> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(registrationDefinitionId, apiVersion, scope, requestBody, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<RegistrationDefinition>>> ListWithHttpMessagesAsync(string scope, string apiVersion, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (scope == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "scope");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<RegistrationDefinition>> BeginCreateOrUpdateWithHttpMessagesAsync(string registrationDefinitionId, string apiVersion, string scope, RegistrationDefinition requestBody, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (registrationDefinitionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "registrationDefinitionId");
