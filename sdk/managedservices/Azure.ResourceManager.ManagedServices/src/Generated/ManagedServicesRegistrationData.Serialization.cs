...
{
    public partial class ManagedServicesRegistrationData : IUtf8JsonSerializable, IJsonModel<ManagedServicesRegistrationData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedServicesRegistrationData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedServicesRegistrationData)} does not support writing '{format}' format.");
            }
        ...
        ManagedServicesRegistrationData IJsonModel<ManagedServicesRegistrationData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedServicesRegistrationData)} does not support reading '{format}' format.");
            }
        ...
        internal static ManagedServicesRegistrationData DeserializeManagedServicesRegistrationData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            ManagedServicesRegistrationProperties properties = default;
        ...
        ManagedServicesRegistrationData IPersistableModel<ManagedServicesRegistrationData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ManagedServicesRegistrationData)} does not support reading '{options.Format}' format.");
            }
        }
