...
namespace Azure.ResourceManager.ManagedServices
{
    ...
    public partial class ManagedServicesMarketplaceRegistrationResource : ArmResource
    {
        ...
        internal ManagedServicesMarketplaceRegistrationResource(ArmClient client, ManagedServicesMarketplaceRegistrationData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
