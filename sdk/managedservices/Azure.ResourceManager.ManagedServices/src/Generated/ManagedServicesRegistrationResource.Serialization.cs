...
namespace Azure.ResourceManager.ManagedServices
{
    public partial class ManagedServicesRegistrationResource : IJsonModel<ManagedServicesRegistrationData>
    {
        ...
        {
            return ModelReaderWriter.Read<ManagedServicesRegistrationData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<ManagedServicesRegistrationData>(data, options);
        }
