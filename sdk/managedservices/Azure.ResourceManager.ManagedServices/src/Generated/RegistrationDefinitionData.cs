...
{
    /// <summary> A class representing the RegistrationDefinition data model. </summary>
    public partial class RegistrationDefinitionData : ResourceData
    {
        ...
        internal RegistrationDefinitionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, RegistrationDefinitionProperties properties, ManagedServicesPlan plan) : base(id, name, resourceType, systemData)
        {
