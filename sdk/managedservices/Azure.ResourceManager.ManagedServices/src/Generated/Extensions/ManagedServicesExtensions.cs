...
namespace Azure.ResourceManager.ManagedServices
{
    ...
    public static partial class ManagedServicesExtensions
    {
        ...
        private static ManagedServicesArmResourceMockingExtension GetManagedServicesArmResourceMockingExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new ManagedServicesArmResourceMockingExtension(client, resource.Id);
            });
        }
        ...
        /// <returns> An object representing collection of ManagedServicesRegistrationResources and their operations over a ManagedServicesRegistrationResource. </returns>
        public static ManagedServicesRegistrationCollection GetManagedServicesRegistrations(this ArmResource armResource)
        {
            return GetManagedServicesArmResourceMockingExtension(armResource).GetManagedServicesRegistrations();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="registrationId"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<ManagedServicesRegistrationResource>> GetManagedServicesRegistrationAsync(this ArmResource armResource, string registrationId, CancellationToken cancellationToken = default)
        {
            return await GetManagedServicesArmResourceMockingExtension(armResource).GetManagedServicesRegistrationAsync(registrationId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="registrationId"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<ManagedServicesRegistrationResource> GetManagedServicesRegistration(this ArmResource armResource, string registrationId, CancellationToken cancellationToken = default)
        {
            return GetManagedServicesArmResourceMockingExtension(armResource).GetManagedServicesRegistration(registrationId, cancellationToken);
        }

        /// <summary> Gets a collection of ManagedServicesRegistrationAssignmentResources in the ArmResource. </summary>
        /// <param name="armResource"> The <see cref="ArmResource" /> instance the method will execute against. </param>
        /// <returns> An object representing collection of ManagedServicesRegistrationAssignmentResources and their operations over a ManagedServicesRegistrationAssignmentResource. </returns>
        public static ManagedServicesRegistrationAssignmentCollection GetManagedServicesRegistrationAssignments(this ArmResource armResource)
        {
            return GetManagedServicesArmResourceMockingExtension(armResource).GetManagedServicesRegistrationAssignments();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="registrationAssignmentId"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<ManagedServicesRegistrationAssignmentResource>> GetManagedServicesRegistrationAssignmentAsync(this ArmResource armResource, string registrationAssignmentId, bool? expandRegistrationDefinition = null, CancellationToken cancellationToken = default)
        {
            return await GetManagedServicesArmResourceMockingExtension(armResource).GetManagedServicesRegistrationAssignmentAsync(registrationAssignmentId, expandRegistrationDefinition, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="registrationAssignmentId"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<ManagedServicesRegistrationAssignmentResource> GetManagedServicesRegistrationAssignment(this ArmResource armResource, string registrationAssignmentId, bool? expandRegistrationDefinition = null, CancellationToken cancellationToken = default)
        {
            return GetManagedServicesArmResourceMockingExtension(armResource).GetManagedServicesRegistrationAssignment(registrationAssignmentId, expandRegistrationDefinition, cancellationToken);
        }

        /// <summary> Gets a collection of ManagedServicesMarketplaceRegistrationResources in the ArmResource. </summary>
        /// <param name="armResource"> The <see cref="ArmResource" /> instance the method will execute against. </param>
        /// <returns> An object representing collection of ManagedServicesMarketplaceRegistrationResources and their operations over a ManagedServicesMarketplaceRegistrationResource. </returns>
        public static ManagedServicesMarketplaceRegistrationCollection GetManagedServicesMarketplaceRegistrations(this ArmResource armResource)
        {
            return GetManagedServicesArmResourceMockingExtension(armResource).GetManagedServicesMarketplaceRegistrations();
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="marketplaceIdentifier"/> is null. </exception>
        [ForwardsClientCalls]
        public static async Task<Response<ManagedServicesMarketplaceRegistrationResource>> GetManagedServicesMarketplaceRegistrationAsync(this ArmResource armResource, string marketplaceIdentifier, CancellationToken cancellationToken = default)
        {
            return await GetManagedServicesArmResourceMockingExtension(armResource).GetManagedServicesMarketplaceRegistrationAsync(marketplaceIdentifier, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="marketplaceIdentifier"/> is null. </exception>
        [ForwardsClientCalls]
        public static Response<ManagedServicesMarketplaceRegistrationResource> GetManagedServicesMarketplaceRegistration(this ArmResource armResource, string marketplaceIdentifier, CancellationToken cancellationToken = default)
        {
            return GetManagedServicesArmResourceMockingExtension(armResource).GetManagedServicesMarketplaceRegistration(marketplaceIdentifier, cancellationToken);
        }
    }
}
