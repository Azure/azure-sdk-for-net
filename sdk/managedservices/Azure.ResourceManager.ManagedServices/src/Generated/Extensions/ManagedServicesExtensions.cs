...
namespace Azure.ResourceManager.ManagedServices
{
    ...
    public static partial class ManagedServicesExtensions
    {
        ...
        {
            return GetArmResourceExtension(client, scope).GetManagedServicesRegistrations();
        }
        ...
        {
            return GetArmResourceExtension(client, scope).GetManagedServicesRegistrationAssignments();
        }
        ...
        {
            return GetArmResourceExtension(client, scope).GetManagedServicesMarketplaceRegistrations();
        }
