...
namespace Azure.ResourceManager.ManagedServices.Testing
{
    /// <summary> A class to add extension methods to ArmResource. </summary>
    public partial class ManagedServicesArmResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ManagedServicesArmResourceExtension"/> class for mocking. </summary>
        protected ManagedServicesArmResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedServicesArmResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagedServicesArmResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
