...
namespace Azure.ResourceManager.ManagedServices
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedServicesRegistrationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedServicesRegistrationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedServicesRegistrationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedServicesRegistrationData>)} interface");
            }
        ...
        string IPersistableModel<ManagedServicesRegistrationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
