...
namespace Azure.ResourceManager.ManagedServices
{
    public partial class ManagedServicesRegistrationData : IUtf8JsonSerializable, IJsonModel<ManagedServicesRegistrationData>
    {
        ...
        void IJsonModel<ManagedServicesRegistrationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ManagedServicesRegistrationData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ManagedServicesRegistrationData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ManagedServicesRegistrationData)} does not support '{options.Format}' format.");
            }
        }
