...
{
    public partial class Authorization : IUtf8JsonSerializable
    {
        ...
        internal static Authorization DeserializeAuthorization(JsonElement element)
        {
            ...
            return new Authorization(principalId, principalIdDisplayName.Value, roleDefinitionId, Optional.ToList(delegatedRoleDefinitionIds));
        }
    }
}
