...
{
    public partial class ManagedServicesEligibleAuthorization : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ManagedServicesEligibleAuthorization DeserializeManagedServicesEligibleAuthorization(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
