...
namespace Azure.ResourceManager.ManagedServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedServicesJustInTimeAccessPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedServicesJustInTimeAccessPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedServicesJustInTimeAccessPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedServicesJustInTimeAccessPolicy>)} interface");
            }
        ...
        string IPersistableModel<ManagedServicesJustInTimeAccessPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
