...
{
    public partial class ManagedServicesJustInTimeAccessPolicy : IUtf8JsonSerializable, IJsonModel<ManagedServicesJustInTimeAccessPolicy>, IPersistableModel<ManagedServicesJustInTimeAccessPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MultiFactorAuthProvider))
            {
                builder.Append("  multiFactorAuthProvider:");
                builder.AppendLine($" '{MultiFactorAuthProvider.ToString()}'");
            }

            if (Optional.IsDefined(MaximumActivationDuration))
            {
                builder.Append("  maximumActivationDuration:");
                var formattedTimeSpan = XmlConvert.ToString(MaximumActivationDuration.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }

            if (Optional.IsCollectionDefined(ManagedByTenantApprovers))
            {
                builder.Append("  managedByTenantApprovers:");
                builder.AppendLine(" [");
                foreach (var item in ManagedByTenantApprovers)
                {
