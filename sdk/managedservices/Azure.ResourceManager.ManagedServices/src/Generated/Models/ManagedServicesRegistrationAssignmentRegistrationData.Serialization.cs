...
namespace Azure.ResourceManager.ManagedServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedServicesRegistrationAssignmentRegistrationData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedServicesRegistrationAssignmentRegistrationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ManagedServicesRegistrationAssignmentRegistrationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
