...
namespace Azure.ResourceManager.ManagedServices.Models
{
    ...
    public partial class ManagedServicesEligibleAuthorization
    {
        ...
        internal ManagedServicesEligibleAuthorization(Guid principalId, string principalIdDisplayName, string roleDefinitionId, ManagedServicesJustInTimeAccessPolicy justInTimeAccessPolicy, Dictionary<string, BinaryData> rawData)
        {
            PrincipalId = principalId;
