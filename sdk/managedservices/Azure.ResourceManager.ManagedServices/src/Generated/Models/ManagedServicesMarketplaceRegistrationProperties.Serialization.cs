...
namespace Azure.ResourceManager.ManagedServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedServicesMarketplaceRegistrationProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedServicesMarketplaceRegistrationProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedServicesMarketplaceRegistrationProperties>)} interface");
            }
        ...
        string IPersistableModel<ManagedServicesMarketplaceRegistrationProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
