...
namespace Azure.ResourceManager.ManagedServices.Models
{
    ...
    public partial class ManagedServicesAuthorization
    {
        ...
        internal ManagedServicesAuthorization(Guid principalId, string principalIdDisplayName, string roleDefinitionId, IList<Guid> delegatedRoleDefinitionIds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PrincipalId = principalId;
