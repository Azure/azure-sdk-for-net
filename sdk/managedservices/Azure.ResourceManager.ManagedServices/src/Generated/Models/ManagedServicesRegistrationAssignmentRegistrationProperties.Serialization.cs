...
namespace Azure.ResourceManager.ManagedServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedServicesRegistrationAssignmentRegistrationProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedServicesRegistrationAssignmentRegistrationProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedServicesRegistrationAssignmentRegistrationProperties>)} interface");
            }
        ...
        string IPersistableModel<ManagedServicesRegistrationAssignmentRegistrationProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
