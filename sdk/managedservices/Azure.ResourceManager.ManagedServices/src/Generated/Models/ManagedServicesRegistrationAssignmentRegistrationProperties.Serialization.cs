...
{
    public partial class ManagedServicesRegistrationAssignmentRegistrationProperties : IUtf8JsonSerializable, IJsonModel<ManagedServicesRegistrationAssignmentRegistrationProperties>, IPersistableModel<ManagedServicesRegistrationAssignmentRegistrationProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(EligibleAuthorizations))
            {
                builder.Append("  eligibleAuthorizations:");
                builder.AppendLine(" [");
                foreach (var item in EligibleAuthorizations)
                {
                    AppendChildObject(builder, item, options, 4);
            ...
            if (Optional.IsDefined(RegistrationDefinitionName))
            {
                builder.Append("  registrationDefinitionName:");
                builder.AppendLine($" '{RegistrationDefinitionName}'");
            }
            ...
            if (Optional.IsDefined(ManageeTenantId))
            {
                builder.Append("  manageeTenantId:");
                builder.AppendLine($" '{ManageeTenantId.Value.ToString()}'");
            }

            if (Optional.IsDefined(ManageeTenantName))
            {
                builder.Append("  manageeTenantName:");
                builder.AppendLine($" '{ManageeTenantName}'");
            }

            if (Optional.IsDefined(ManagedByTenantId))
            {
                builder.Append("  managedByTenantId:");
                builder.AppendLine($" '{ManagedByTenantId.Value.ToString()}'");
            }

            if (Optional.IsDefined(ManagedByTenantName))
            {
                builder.Append("  managedByTenantName:");
                builder.AppendLine($" '{ManagedByTenantName}'");
            }
