...
{
    public partial class EligibleApprover : IUtf8JsonSerializable
    {
        ...
        internal static EligibleApprover DeserializeEligibleApprover(JsonElement element)
        {
            ...
            return new EligibleApprover(principalId, principalIdDisplayName.Value);
        }
    }
}
