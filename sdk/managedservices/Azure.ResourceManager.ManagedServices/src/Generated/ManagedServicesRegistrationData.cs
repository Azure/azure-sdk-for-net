...
namespace Azure.ResourceManager.ManagedServices
{
    ...
    public partial class ManagedServicesRegistrationData : ResourceData
    {
        ...
        internal ManagedServicesRegistrationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ManagedServicesRegistrationProperties properties, ManagedServicesPlan plan, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
