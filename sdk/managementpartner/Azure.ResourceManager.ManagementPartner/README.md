# Azure Management Partner Management client library for .NET
...
Install the Azure Management Partner management library for .NET with [NuGet](https://www.nuget.org/):
