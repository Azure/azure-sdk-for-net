    ...
    public partial class PartnerResponseData : IUtf8JsonSerializable, IJsonModel<PartnerResponseData>
    {
        ...
        internal static PartnerResponseData DeserializePartnerResponseData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.ManagementPartner.ModelSerializationExtensions.WireOptions, AzureResourceManagerManagementPartnerContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerManagementPartnerContext.Default)
#endif
;
                    continue;
                }
