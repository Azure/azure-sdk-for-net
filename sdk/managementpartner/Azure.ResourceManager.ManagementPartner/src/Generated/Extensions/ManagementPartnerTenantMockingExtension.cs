...
namespace Azure.ResourceManager.ManagementPartner.Mocking
{
    ...
    public partial class ManagementPartnerTenantMockingExtension : ArmResource
    {
        private ClientDiagnostics _operationClientDiagnostics;
        private OperationRestOperations _operationRestClient;

        /// <summary> Initializes a new instance of the <see cref="ManagementPartnerTenantMockingExtension"/> class for mocking. </summary>
        protected ManagementPartnerTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagementPartnerTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ManagementPartnerTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<OperationResponse> GetOperationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, OperationResponse.DeserializeOperationResponse, OperationClientDiagnostics, Pipeline, "ManagementPartnerTenantMockingExtension.GetOperations", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<OperationResponse> GetOperations(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => OperationRestClient.CreateListRequest();
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => OperationRestClient.CreateListNextPageRequest(nextLink);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, OperationResponse.DeserializeOperationResponse, OperationClientDiagnostics, Pipeline, "ManagementPartnerTenantMockingExtension.GetOperations", "value", "nextLink", cancellationToken);
        }
    }
}
