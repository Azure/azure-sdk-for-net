...
namespace Azure.ResourceManager.ManagementPartner
{
    ...
    public static partial class ManagementPartnerExtensions
    {
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetPartnerResponses();
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetOperationsAsync(cancellationToken);
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetOperations(cancellationToken);
        }
    }
}
