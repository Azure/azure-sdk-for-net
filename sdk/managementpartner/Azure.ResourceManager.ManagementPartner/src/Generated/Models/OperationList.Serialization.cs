...
{
    internal partial class OperationList : IUtf8JsonSerializable, IJsonModel<OperationList>, IPersistableModel<OperationList>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<OperationList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OperationList)} does not support '{format}' format.");
            }
