...
namespace Azure.ResourceManager.ManagementPartner.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OperationList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OperationList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<OperationList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
