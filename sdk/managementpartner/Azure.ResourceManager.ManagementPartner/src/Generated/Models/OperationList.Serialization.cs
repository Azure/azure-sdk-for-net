...
namespace Azure.ResourceManager.ManagementPartner.Models
{
    internal partial class OperationList : IUtf8JsonSerializable, IJsonModel<OperationList>
    {
        ...
        void IJsonModel<OperationList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(OperationList)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OperationList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(OperationList)} does not support '{options.Format}' format.");
            }
        }
