...
namespace Azure.ResourceManager.ManagementPartner.Models
{
    public partial class OperationResponse : IUtf8JsonSerializable, IJsonModel<OperationResponse>
    {
        ...
        void IJsonModel<OperationResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(OperationResponse)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OperationResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(OperationResponse)} does not support '{options.Format}' format.");
            }
        }
