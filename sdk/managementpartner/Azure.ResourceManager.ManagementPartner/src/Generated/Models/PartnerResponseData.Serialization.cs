...
namespace Azure.ResourceManager.ManagementPartner
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartnerResponseData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartnerResponseData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartnerResponseData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartnerResponseData>)} interface");
            }
        ...
        string IPersistableModel<PartnerResponseData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
