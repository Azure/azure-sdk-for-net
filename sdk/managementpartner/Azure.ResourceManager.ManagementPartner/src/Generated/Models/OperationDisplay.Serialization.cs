...
namespace Azure.ResourceManager.ManagementPartner.Models
{
    public partial class OperationDisplay : IUtf8JsonSerializable, IJsonModel<OperationDisplay>
    {
        ...
        void IJsonModel<OperationDisplay>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(OperationDisplay)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<OperationDisplay>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(OperationDisplay)} does not support '{options.Format}' format.");
            }
        }
