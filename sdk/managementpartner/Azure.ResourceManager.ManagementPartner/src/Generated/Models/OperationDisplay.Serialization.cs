...
namespace Azure.ResourceManager.ManagementPartner.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationDisplay>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OperationDisplay>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OperationDisplay>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OperationDisplay>)} interface");
            }
        ...
        string IPersistableModel<OperationDisplay>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
