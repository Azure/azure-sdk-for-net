...
namespace Azure.ResourceManager.ManagementPartner.Models
{
    ...
    public partial class OperationDisplay
    {
        ...
        internal OperationDisplay(string provider, string resource, string operation, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Provider = provider;
            Resource = resource;
            Operation = operation;
