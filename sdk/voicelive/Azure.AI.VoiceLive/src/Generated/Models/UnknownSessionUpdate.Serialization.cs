...
{
    internal partial class UnknownSessionUpdate : SessionUpdate, IJsonModel<global::Azure.AI.VoiceLive.SessionUpdate>
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.AI.VoiceLive.UnknownSessionUpdate"/> for deserialization. </summary>
        internal UnknownSessionUpdate()
        {
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownSessionUpdate DeserializeUnknownSessionUpdate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownSessionUpdate(@type, eventId, additionalBinaryDataProperties);
        }
    }
}
