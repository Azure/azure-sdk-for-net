...
namespace Azure.AI.VoiceLive
{
    internal partial class ClientEventInputAudioBufferCommit : ClientEvent, IJsonModel<ClientEventInputAudioBufferCommit>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ClientEventInputAudioBufferCommit IJsonModel<ClientEventInputAudioBufferCommit>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ClientEventInputAudioBufferCommit)JsonModelCreateCore(ref reader, options);
