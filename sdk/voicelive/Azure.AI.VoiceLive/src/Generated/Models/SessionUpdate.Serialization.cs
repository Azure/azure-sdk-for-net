            ...
            if (element.TryGetProperty("type"u8, out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "rtc.call.sdp.created":
                        return ServerEventRtcCallSdpCreated.DeserializeServerEventRtcCallSdpCreated(element, options);
                    case "rtc.call.error":
                        return ServerEventRtcCallError.DeserializeServerEventRtcCallError(element, options);
                    case "output_audio_buffer.started":
                        return ServerEventOutputAudioBufferStarted.DeserializeServerEventOutputAudioBufferStarted(element, options);
                    case "output_audio_buffer.stopped":
                        return ServerEventOutputAudioBufferStopped.DeserializeServerEventOutputAudioBufferStopped(element, options);
                }
            }
