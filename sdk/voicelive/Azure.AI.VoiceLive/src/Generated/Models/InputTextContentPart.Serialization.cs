    ...
    public partial class InputTextContentPart : MessageContentPart, IJsonModel<InputTextContentPart>
    {
        ...
        protected override MessageContentPart PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InputTextContentPart)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputTextContentPart)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InputTextContentPart IJsonModel<InputTextContentPart>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (InputTextContentPart)JsonModelCreateCore(ref reader, options);
        ...
        protected override MessageContentPart JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InputTextContentPart)} does not support reading '{format}' format.");
            }
