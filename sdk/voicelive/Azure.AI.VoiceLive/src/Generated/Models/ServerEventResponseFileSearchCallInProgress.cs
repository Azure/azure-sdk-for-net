...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class ServerEventResponseFileSearchCallInProgress : SessionUpdate
    {
        ...
        internal ServerEventResponseFileSearchCallInProgress(string responseId, string itemId, int outputIndex, int sequenceNumber) : base(ServerEventType.ResponseFileSearchCallInProgress)
        {
        ...
        /// <param name="outputIndex"> The index of the output item in the response. </param>
        /// <param name="sequenceNumber"> The sequence number of the file search call. </param>
        internal ServerEventResponseFileSearchCallInProgress(ServerEventType @type, string eventId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string responseId, string itemId, int outputIndex, int sequenceNumber) : base(@type, eventId, additionalBinaryDataProperties)
        {
            ResponseId = responseId;
            ItemId = itemId;
            OutputIndex = outputIndex;
