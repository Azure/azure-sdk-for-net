...
namespace Azure.AI.VoiceLive
{
    ...
    public partial class SessionUpdateInputAudioBufferCleared : SessionUpdate, IJsonModel<SessionUpdateInputAudioBufferCleared>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SessionUpdateInputAudioBufferCleared>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    using (JsonDocument document = JsonDocument.Parse(data, ModelSerializationExtensions.JsonDocumentOptions))
                    {
                        return DeserializeSessionUpdateInputAudioBufferCleared(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(SessionUpdateInputAudioBufferCleared)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(SessionUpdateInputAudioBufferCleared)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SessionUpdateInputAudioBufferCleared)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SessionUpdateInputAudioBufferCleared IJsonModel<SessionUpdateInputAudioBufferCleared>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SessionUpdateInputAudioBufferCleared)JsonModelCreateCore(ref reader, options);
        ...
        protected override SessionUpdate JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SessionUpdateInputAudioBufferCleared)} does not support reading '{format}' format.");
            }
