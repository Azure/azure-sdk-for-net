...
namespace Azure.AI.VoiceLive
{
    internal partial class ClientEventConversationItemDelete : ClientEvent, IJsonModel<ClientEventConversationItemDelete>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ClientEventConversationItemDelete>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                ...
                default:
                    throw new FormatException($"The model {nameof(ClientEventConversationItemDelete)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClientEventConversationItemDelete)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ClientEventConversationItemDelete IJsonModel<ClientEventConversationItemDelete>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ClientEventConversationItemDelete)JsonModelCreateCore(ref reader, options);
        ...
        protected override ClientEvent JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ClientEventConversationItemDelete)} does not support reading '{format}' format.");
            }
