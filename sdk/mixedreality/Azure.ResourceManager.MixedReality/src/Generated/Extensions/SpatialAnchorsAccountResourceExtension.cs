...
namespace Azure.ResourceManager.MixedReality.Mock
{
    ...
    public partial class SpatialAnchorsAccountResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="SpatialAnchorsAccountResourceExtension"/> class for mocking. </summary>
        protected SpatialAnchorsAccountResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SpatialAnchorsAccountResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SpatialAnchorsAccountResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
