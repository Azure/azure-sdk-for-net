...
namespace Azure.ResourceManager.MixedReality.Mock
{
    ...
    public partial class RemoteRenderingAccountResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RemoteRenderingAccountResourceExtension"/> class for mocking. </summary>
        protected RemoteRenderingAccountResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="RemoteRenderingAccountResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal RemoteRenderingAccountResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
