...
namespace Azure.ResourceManager.MixedReality.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class MixedRealitySubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MixedRealitySubscriptionResourceExtension"/> class for mocking. </summary>
        protected MixedRealitySubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MixedRealitySubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MixedRealitySubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<MixedRealityNameAvailabilityResult>> CheckMixedRealityNameAvailabilityAsync(AzureLocation location, MixedRealityNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DefaultClientDiagnostics.CreateScope("MixedRealitySubscriptionResourceExtension.CheckMixedRealityNameAvailability");
            scope.Start();
            try
            {
