...
namespace Azure.ResourceManager.MixedReality.Mocking
{
    ...
    internal partial class MixedRealityResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MixedRealityResourceGroupMockingExtension"/> class for mocking. </summary>
        protected MixedRealityResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MixedRealityResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MixedRealityResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
