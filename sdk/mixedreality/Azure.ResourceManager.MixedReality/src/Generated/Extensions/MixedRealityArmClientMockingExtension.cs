...
namespace Azure.ResourceManager.MixedReality.Mocking
{
    ...
    internal partial class MixedRealityArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MixedRealityArmClientMockingExtension"/> class for mocking. </summary>
        protected MixedRealityArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MixedRealityArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MixedRealityArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MixedRealityArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
