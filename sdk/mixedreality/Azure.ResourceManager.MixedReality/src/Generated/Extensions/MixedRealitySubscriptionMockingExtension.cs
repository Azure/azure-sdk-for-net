...
namespace Azure.ResourceManager.MixedReality.Mocking
{
    ...
    internal partial class MixedRealitySubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MixedRealitySubscriptionMockingExtension"/> class for mocking. </summary>
        protected MixedRealitySubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MixedRealitySubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MixedRealitySubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = DefaultClientDiagnostics.CreateScope("MixedRealitySubscriptionMockingExtension.CheckMixedRealityNameAvailability");
            scope.Start();
            try
            {
