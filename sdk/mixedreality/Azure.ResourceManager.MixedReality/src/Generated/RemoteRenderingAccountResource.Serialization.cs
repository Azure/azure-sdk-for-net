...
namespace Azure.ResourceManager.MixedReality
{
    public partial class RemoteRenderingAccountResource : IJsonModel<RemoteRenderingAccountData>
    {
        ...
        {
            return ModelReaderWriter.Read<RemoteRenderingAccountData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<RemoteRenderingAccountData>(data, options);
        }
