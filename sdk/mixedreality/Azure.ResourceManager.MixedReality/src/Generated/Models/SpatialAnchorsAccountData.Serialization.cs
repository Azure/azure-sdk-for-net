...
namespace Azure.ResourceManager.MixedReality
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SpatialAnchorsAccountData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SpatialAnchorsAccountData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SpatialAnchorsAccountData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SpatialAnchorsAccountData>)} interface");
            }
        ...
        string IPersistableModel<SpatialAnchorsAccountData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
