...
namespace Azure.ResourceManager.MixedReality
{
    public partial class SpatialAnchorsAccountData : IUtf8JsonSerializable, IJsonModel<SpatialAnchorsAccountData>
    {
        ...
        void IJsonModel<SpatialAnchorsAccountData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SpatialAnchorsAccountData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SpatialAnchorsAccountData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SpatialAnchorsAccountData)} does not support '{options.Format}' format.");
            }
        }
