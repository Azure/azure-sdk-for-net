...
namespace Azure.ResourceManager.MixedReality
{
    public partial class ObjectAnchorsAccountData : IUtf8JsonSerializable
    {
        ...
        internal static ObjectAnchorsAccountData DeserializeObjectAnchorsAccountData(JsonElement element)
        {
            ...
            return new ObjectAnchorsAccountData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, plan, sku.Value, kind.Value, storageAccountName.Value, accountId.Value, accountDomain.Value);
        }
    }
}
