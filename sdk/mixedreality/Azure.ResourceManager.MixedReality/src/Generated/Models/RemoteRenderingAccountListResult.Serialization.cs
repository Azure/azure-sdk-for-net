...
{
    internal partial class RemoteRenderingAccountListResult : IUtf8JsonSerializable, IJsonModel<RemoteRenderingAccountListResult>, IPersistableModel<RemoteRenderingAccountListResult>
    {
        ...
        void IJsonModel<RemoteRenderingAccountListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RemoteRenderingAccountListResult)} does not support '{format}' format.");
            }
