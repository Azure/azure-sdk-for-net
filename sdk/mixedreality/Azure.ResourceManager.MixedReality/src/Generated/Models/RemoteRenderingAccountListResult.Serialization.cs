...
namespace Azure.ResourceManager.MixedReality.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RemoteRenderingAccountListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RemoteRenderingAccountListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RemoteRenderingAccountListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RemoteRenderingAccountListResult>)} interface");
            }
        ...
        string IPersistableModel<RemoteRenderingAccountListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
