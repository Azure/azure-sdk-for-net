...
namespace Azure.ResourceManager.MixedReality.Models
{
    ...
    public partial class MixedRealitySku
    {
        ...
        internal MixedRealitySku(string name, MixedRealitySkuTier? tier, string size, string family, int? capacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
