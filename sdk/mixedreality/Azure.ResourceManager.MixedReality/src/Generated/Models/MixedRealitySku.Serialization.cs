...
{
    public partial class MixedRealitySku : Core.IUtf8JsonSerializable
    {
        ...
        internal static MixedRealitySku DeserializeMixedRealitySku(JsonElement element)
        {
            ...
            string name = default;
            Core.Optional<MixedRealitySkuTier> tier = default;
            ...
            return new MixedRealitySku(name, Core.Optional.ToNullable(tier), size.Value, family.Value, Core.Optional.ToNullable(capacity));
        }
    }
}
