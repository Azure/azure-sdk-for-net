...
{
    public partial class MixedRealitySku : IUtf8JsonSerializable
    {
        ...
        internal static MixedRealitySku DeserializeMixedRealitySku(JsonElement element)
        {
            ...
            return new MixedRealitySku(name, Optional.ToNullable(tier), size.Value, family.Value, Optional.ToNullable(capacity));
        }
    }
}
