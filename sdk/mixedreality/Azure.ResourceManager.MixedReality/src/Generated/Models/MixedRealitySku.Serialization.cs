...
namespace Azure.ResourceManager.MixedReality.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MixedRealitySku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MixedRealitySku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MixedRealitySku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MixedRealitySku>)} interface");
            }
        ...
        string IPersistableModel<MixedRealitySku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
