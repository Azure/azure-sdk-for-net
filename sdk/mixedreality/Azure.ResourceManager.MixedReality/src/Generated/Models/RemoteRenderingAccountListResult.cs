...
namespace Azure.ResourceManager.MixedReality.Models
{
    ...
    internal partial class RemoteRenderingAccountListResult
    {
        ...
        internal RemoteRenderingAccountListResult(IReadOnlyList<RemoteRenderingAccountData> value, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
