...
namespace Azure.ResourceManager.MixedReality.Models
{
    ...
    public partial class MixedRealityNameAvailabilityResult
    {
        ...
        internal MixedRealityNameAvailabilityResult(bool isNameAvailable, MixedRealityNameUnavailableReason? reason, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IsNameAvailable = isNameAvailable;
            Reason = reason;
            Message = message;
