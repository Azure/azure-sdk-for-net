...
namespace Azure.ResourceManager.MixedReality.Models
{
    ...
    public partial class MixedRealityNameAvailabilityResult
    {
        ...
        internal MixedRealityNameAvailabilityResult(bool isNameAvailable, MixedRealityNameUnavailableReason? reason, string message, Dictionary<string, BinaryData> rawData)
        {
            IsNameAvailable = isNameAvailable;
            Reason = reason;
            Message = message;
