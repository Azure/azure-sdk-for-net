...
{
    public partial class RemoteRenderingAccountData : Core.IUtf8JsonSerializable
    {
        ...
        internal static RemoteRenderingAccountData DeserializeRemoteRenderingAccountData(JsonElement element)
        {
            ...
            return new RemoteRenderingAccountData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, identity, plan, sku.Value, kind.Value, storageAccountName.Value, Core.Optional.ToNullable(accountId), accountDomain.Value);
        }
    }
}
