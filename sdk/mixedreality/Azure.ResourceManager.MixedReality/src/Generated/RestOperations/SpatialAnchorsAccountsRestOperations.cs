...
namespace Azure.ResourceManager.MixedReality
{
    internal partial class SpatialAnchorsAccountsRestOperations
    {
        ...
        internal HttpMessage CreateUpdateRequest(string subscriptionId, string resourceGroupName, string accountName, SpatialAnchorsAccountData data)
        {
            ...
            ((IJsonModel<SpatialAnchorsAccountData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateRegenerateKeysRequest(string subscriptionId, string resourceGroupName, string accountName, MixedRealityAccountKeyRegenerateContent content)
        {
            ...
            ((IJsonModel<MixedRealityAccountKeyRegenerateContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
