...
namespace Microsoft.Azure.Management.MixedReality
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<MixedRealityClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(MixedRealityClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.MixedReality/operations").ToString();
