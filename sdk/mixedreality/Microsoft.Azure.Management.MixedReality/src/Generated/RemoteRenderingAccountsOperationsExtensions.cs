...
namespace Microsoft.Azure.Management.MixedReality
{
    ...
    public static partial class RemoteRenderingAccountsOperationsExtensions
    {
            ...
            /// Name of an Mixed Reality Account.
            /// </param>
            public static AccountKeys GetKeys(this IRemoteRenderingAccountsOperations operations, string resourceGroupName, string accountName)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<AccountKeys> GetKeysAsync(this IRemoteRenderingAccountsOperations operations, string resourceGroupName, string accountName, CancellationToken cancellationToken = default(CancellationToken))
            {
