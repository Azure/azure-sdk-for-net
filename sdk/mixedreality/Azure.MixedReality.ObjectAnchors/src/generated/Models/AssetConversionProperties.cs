...
namespace Azure.MixedReality.ObjectAnchors
{
    ...
    public partial class AssetConversionProperties
    {
        ...
        /// <param name="jobIdInternal"> Identifier for the AOA Ingestion Job. </param>
        ...
        /// <param name="accountIdInternal"> Identifier for the Account owning the AOA Ingestion Job. </param>
        /// <param name="conversionConfiguration"> Represents an ingestion configuration. </param>
        internal AssetConversionProperties(string clientErrorDetails, string serverErrorDetails, Guid? jobIdInternal, string outputModelUriString, AssetConversionStatus? conversionStatus, string assetFileTypeString, string inputAssetUriString, Guid? accountIdInternal, AssetConversionConfiguration conversionConfiguration)
        {
