...
{
    /// <summary> The result of obtaining the upload location for an asset. </summary>
    [CodeGenModel("UploadLocation")]
    public partial class AssetUploadUriResult
    {
        /// <summary> Initializes a new instance of GetAssetUploadUriResult. </summary>
        ...
        /// <summary> The blob upload URI in storage where a model should be uploaded to the service for conversion. </summary>
