...
namespace Azure.MixedReality.ObjectAnchors
{
    ...
    public partial class AssetConversionProperties
    {
        ...
        /// <summary> The Uri to the Asset to be ingested by the AOA Asset Conversion Service. This asset needs to have been uploaded to the service using an endpoint provided from a call to the GetUploadUri API. </summary>
        ...
        /// <summary> The status of the AOA asset conversion job </summary>
        [CodeGenMember("JobStatus")]
        public AssetConversionStatus? ConversionStatus { get; internal set; }
        /// <summary> The configuration of the AOA asset conversion job </summary>
