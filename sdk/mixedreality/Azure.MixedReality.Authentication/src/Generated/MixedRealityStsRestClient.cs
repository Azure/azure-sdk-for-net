...
namespace Azure.MixedReality.Authentication
{
    internal partial class MixedRealityStsRestClient
    {
        ...
        /// <param name="endpoint"> server parameter. The default is "https://sts.mixedreality.azure.com". </param>
        /// <param name="apiVersion"> Api Version. The default is "2019-02-28-preview". </param>
