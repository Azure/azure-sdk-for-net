...
{
    public partial class ConversionOutputSettings : IUtf8JsonSerializable
    {
        ...
        internal static ConversionOutputSettings DeserializeConversionOutputSettings(JsonElement element)
        {
            ...
            return new ConversionOutputSettings(storageContainerUri, storageContainerWriteSas.Value, blobPrefix.Value, outputAssetFilename.Value);
        }
    }
}
