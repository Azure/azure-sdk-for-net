...
namespace Azure.ResourceManager.IotCentral.Samples
{
    public partial class Sample_IotCentralPrivateLinkResourceCollection
    {
        ...
        public async Task Get_PrivateLinksGet()
        {
            ...
            IotCentralPrivateLinkResource result = await collection.GetAsync(groupId);
        ...
        public async Task GetAll_PrivateLinksList()
        {
            ...
            // this example is just showing the usage of "PrivateLinks_List" operation, for the dependent resources, they will have to be created separately.
            ...
            await foreach (IotCentralPrivateLinkResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                IotCentralPrivateLinkResourceData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
