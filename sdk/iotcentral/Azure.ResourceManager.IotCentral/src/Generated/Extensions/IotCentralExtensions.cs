...
using Azure.ResourceManager.IotCentral.Testing;
...
namespace Azure.ResourceManager.IotCentral
{
    ...
    {
        private static IotCentralResourceGroupResourceExtension GetIotCentralResourceGroupResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new IotCentralResourceGroupResourceExtension(client, resource.Id);
            });
        }

        private static IotCentralResourceGroupResourceExtension GetIotCentralResourceGroupResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new IotCentralResourceGroupResourceExtension(client, scope);
            });
        }

        private static IotCentralSubscriptionResourceExtension GetIotCentralSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new IotCentralSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static IotCentralSubscriptionResourceExtension GetIotCentralSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new IotCentralSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetIotCentralResourceGroupResourceExtension(resourceGroupResource).GetIotCentralApps();
        }
        ...
        {
            return GetIotCentralSubscriptionResourceExtension(subscriptionResource).GetIotCentralAppsAsync(cancellationToken);
        }
        ...
        {
            return GetIotCentralSubscriptionResourceExtension(subscriptionResource).GetIotCentralApps(cancellationToken);
        }
        ...
        public static async Task<Response<IotCentralAppNameAvailabilityResponse>> CheckIotCentralAppNameAvailabilityAsync(this SubscriptionResource subscriptionResource, IotCentralAppNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetIotCentralSubscriptionResourceExtension(subscriptionResource).CheckIotCentralAppNameAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<IotCentralAppNameAvailabilityResponse> CheckIotCentralAppNameAvailability(this SubscriptionResource subscriptionResource, IotCentralAppNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetIotCentralSubscriptionResourceExtension(subscriptionResource).CheckIotCentralAppNameAvailability(content, cancellationToken);
        }
        ...
        public static async Task<Response<IotCentralAppNameAvailabilityResponse>> CheckIotCentralAppSubdomainAvailabilityAsync(this SubscriptionResource subscriptionResource, IotCentralAppNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetIotCentralSubscriptionResourceExtension(subscriptionResource).CheckIotCentralAppSubdomainAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<IotCentralAppNameAvailabilityResponse> CheckIotCentralAppSubdomainAvailability(this SubscriptionResource subscriptionResource, IotCentralAppNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetIotCentralSubscriptionResourceExtension(subscriptionResource).CheckIotCentralAppSubdomainAvailability(content, cancellationToken);
        }
        ...
        {
            return GetIotCentralSubscriptionResourceExtension(subscriptionResource).GetTemplatesAppsAsync(cancellationToken);
        }
        ...
        {
            return GetIotCentralSubscriptionResourceExtension(subscriptionResource).GetTemplatesApps(cancellationToken);
        }
    }
}
