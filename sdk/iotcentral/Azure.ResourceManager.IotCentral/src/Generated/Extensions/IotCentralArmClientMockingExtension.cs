...
namespace Azure.ResourceManager.IotCentral.Mocking
{
    ...
    internal partial class IotCentralArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="IotCentralArmClientMockingExtension"/> class for mocking. </summary>
        protected IotCentralArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="IotCentralArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal IotCentralArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal IotCentralArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
