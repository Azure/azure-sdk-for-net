...
namespace Azure.ResourceManager.IotCentral.Mocking
{
    ...
    public partial class MockableIotCentralResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MockableIotCentralResourceGroupResource"/> class for mocking. </summary>
        protected MockableIotCentralResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MockableIotCentralResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableIotCentralResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
