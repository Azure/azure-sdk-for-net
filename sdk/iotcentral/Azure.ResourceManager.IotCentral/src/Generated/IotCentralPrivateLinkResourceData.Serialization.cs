    ...
    public partial class IotCentralPrivateLinkResourceData : IUtf8JsonSerializable, IJsonModel<IotCentralPrivateLinkResourceData>
    {
        ...
        internal static IotCentralPrivateLinkResourceData DeserializeIotCentralPrivateLinkResourceData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.IotCentral.ModelSerializationExtensions.WireOptions, AzureResourceManagerIotCentralContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerIotCentralContext.Default)
#endif
;
                    continue;
                }
