...
namespace Azure.ResourceManager.IotCentral
{
    ...
    public partial class IotCentralPrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal IotCentralPrivateEndpointConnectionResource(ArmClient client, IotCentralPrivateEndpointConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
