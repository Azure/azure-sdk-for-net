...
namespace Azure.ResourceManager.IotCentral.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotCentralAppTemplate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotCentralAppTemplate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotCentralAppTemplate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotCentralAppTemplate>)} interface");
            }
        ...
        string IPersistableModel<IotCentralAppTemplate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
