...
namespace Azure.ResourceManager.IotCentral
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotCentralPrivateLinkResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotCentralPrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotCentralPrivateLinkResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotCentralPrivateLinkResourceData>)} interface");
            }
        ...
        string IPersistableModel<IotCentralPrivateLinkResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
