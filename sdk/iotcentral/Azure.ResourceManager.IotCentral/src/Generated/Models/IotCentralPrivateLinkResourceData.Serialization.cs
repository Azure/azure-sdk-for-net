...
namespace Azure.ResourceManager.IotCentral
{
    public partial class IotCentralPrivateLinkResourceData : IUtf8JsonSerializable, IJsonModel<IotCentralPrivateLinkResourceData>
    {
        ...
        void IJsonModel<IotCentralPrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(IotCentralPrivateLinkResourceData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IotCentralPrivateLinkResourceData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(IotCentralPrivateLinkResourceData)} does not support '{options.Format}' format.");
            }
        }
