...
{
    public partial class IotCentralPrivateLinkResourceData : Core.IUtf8JsonSerializable
    {
        ...
        internal static IotCentralPrivateLinkResourceData DeserializeIotCentralPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new IotCentralPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
