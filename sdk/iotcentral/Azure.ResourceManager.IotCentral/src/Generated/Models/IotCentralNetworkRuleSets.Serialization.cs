...
{
    public partial class IotCentralNetworkRuleSets : IUtf8JsonSerializable, IJsonModel<IotCentralNetworkRuleSets>, IPersistableModel<IotCentralNetworkRuleSets>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ApplyToDevices))
            {
                builder.Append("  applyToDevices:");
                var boolValue = ApplyToDevices.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(ApplyToIotCentral))
            {
                builder.Append("  applyToIoTCentral:");
                var boolValue = ApplyToIotCentral.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
