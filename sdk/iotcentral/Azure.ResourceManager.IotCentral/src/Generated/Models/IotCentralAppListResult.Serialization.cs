...
{
    internal partial class IotCentralAppListResult : IUtf8JsonSerializable, IJsonModel<IotCentralAppListResult>, IPersistableModel<IotCentralAppListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotCentralAppListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<IotCentralAppListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IotCentralAppListResult)} does not support '{format}' format.");
            }
