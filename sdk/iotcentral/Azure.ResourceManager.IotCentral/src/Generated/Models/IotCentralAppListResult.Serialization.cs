...
namespace Azure.ResourceManager.IotCentral.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotCentralAppListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotCentralAppListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotCentralAppListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotCentralAppListResult>)} interface");
            }
        ...
        string IPersistableModel<IotCentralAppListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
