...
{
    public partial class IotCentralPrivateLinkServiceConnectionState : Core.IUtf8JsonSerializable
    {
        ...
        internal static IotCentralPrivateLinkServiceConnectionState DeserializeIotCentralPrivateLinkServiceConnectionState(JsonElement element)
        {
            ...
            Core.Optional<IotCentralPrivateEndpointServiceConnectionStatus> status = default;
            ...
            return new IotCentralPrivateLinkServiceConnectionState(Core.Optional.ToNullable(status), description.Value, actionsRequired.Value);
        }
    }
}
