...
namespace Azure.ResourceManager.IotCentral.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotCentralAppPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotCentralAppPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotCentralAppPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotCentralAppPatch>)} interface");
            }
        ...
        string IPersistableModel<IotCentralAppPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
