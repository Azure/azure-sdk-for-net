...
{
    public partial class IotCentralAppNameAvailabilityResponse : IUtf8JsonSerializable, IJsonModel<IotCentralAppNameAvailabilityResponse>, IPersistableModel<IotCentralAppNameAvailabilityResponse>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IotCentralAppNameUnavailableReason))
            {
                ...
                builder.AppendLine($" '{IotCentralAppNameUnavailableReason}'");
            }
