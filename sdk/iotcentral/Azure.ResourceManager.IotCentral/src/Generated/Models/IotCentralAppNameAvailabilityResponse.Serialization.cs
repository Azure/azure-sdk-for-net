...
namespace Azure.ResourceManager.IotCentral.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotCentralAppNameAvailabilityResponse>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        IotCentralAppNameAvailabilityResponse IJsonModel<IotCentralAppNameAvailabilityResponse>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<IotCentralAppNameAvailabilityResponse>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        IotCentralAppNameAvailabilityResponse IModel<IotCentralAppNameAvailabilityResponse>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<IotCentralAppNameAvailabilityResponse>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
