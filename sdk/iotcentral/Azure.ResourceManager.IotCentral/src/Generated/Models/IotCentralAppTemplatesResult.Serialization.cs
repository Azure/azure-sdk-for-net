...
namespace Azure.ResourceManager.IotCentral.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotCentralAppTemplatesResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotCentralAppTemplatesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotCentralAppTemplatesResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotCentralAppTemplatesResult>)} interface");
            }
        ...
        string IPersistableModel<IotCentralAppTemplatesResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
