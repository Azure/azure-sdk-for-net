...
namespace Azure.ResourceManager.IotCentral.Models
{
    ...
    {
        internal static IotCentralAppTemplatesResult DeserializeIotCentralAppTemplatesResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
