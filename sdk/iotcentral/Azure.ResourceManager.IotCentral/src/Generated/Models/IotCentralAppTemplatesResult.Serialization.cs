...
{
    internal partial class IotCentralAppTemplatesResult : IUtf8JsonSerializable, IJsonModel<IotCentralAppTemplatesResult>, IPersistableModel<IotCentralAppTemplatesResult>
    {
        ...
        void IJsonModel<IotCentralAppTemplatesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IotCentralAppTemplatesResult)} does not support '{format}' format.");
            }
