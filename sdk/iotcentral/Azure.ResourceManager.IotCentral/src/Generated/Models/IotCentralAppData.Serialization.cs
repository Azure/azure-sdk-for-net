...
namespace Azure.ResourceManager.IotCentral
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotCentralAppData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotCentralAppData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotCentralAppData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotCentralAppData>)} interface");
            }
        ...
        string IPersistableModel<IotCentralAppData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
