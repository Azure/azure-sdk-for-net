...
namespace Azure.ResourceManager.IotCentral.Models
{
    ...
    public partial class IotCentralPrivateLinkServiceConnectionState
    {
        ...
        internal IotCentralPrivateLinkServiceConnectionState(IotCentralPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
