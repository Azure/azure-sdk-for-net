...
namespace Azure.ResourceManager.IotCentral.Models
{
    ...
    {
        internal static IotCentralAppTemplateLocation DeserializeIotCentralAppTemplateLocation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
