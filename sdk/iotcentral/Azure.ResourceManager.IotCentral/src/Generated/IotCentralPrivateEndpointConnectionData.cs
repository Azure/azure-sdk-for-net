...
namespace Azure.ResourceManager.IotCentral
{
    ...
    public partial class IotCentralPrivateEndpointConnectionData : ResourceData
    {
        ...
        internal IotCentralPrivateEndpointConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IReadOnlyList<string> groupIds, SubResource privateEndpoint, IotCentralPrivateLinkServiceConnectionState connectionState, IotCentralPrivateEndpointConnectionProvisioningState? provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            GroupIds = groupIds;
