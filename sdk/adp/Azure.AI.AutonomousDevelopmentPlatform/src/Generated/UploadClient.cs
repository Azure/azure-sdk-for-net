...
{
    // Data plane generated client. The Upload service client.
    /// <summary> The Upload service client. </summary>
    public partial class UploadClient
    {
        ...
        /// <summary> Initializes a new instance of UploadClient for mocking. </summary>
        protected UploadClient()
        {
        }

        /// <summary> Initializes a new instance of UploadClient. </summary>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public UploadClient(TokenCredential credential) : this(credential, new AzureAIAutonomousDevelopmentPlatformClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public UploadClient(TokenCredential credential, AzureAIAutonomousDevelopmentPlatformClientOptions options)
        {
        ...
        /// <include file="Docs/UploadClient.xml" path="doc/members/member[@name='CreateOrReplaceAsync(String,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateOrReplaceAsync(string uploadId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("UploadClient.CreateOrReplace");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/UploadClient.xml" path="doc/members/member[@name='CreateOrReplace(String,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/UploadClient.xml" path="doc/members/member[@name='GetAsync(String,RequestContext)']/*" />
        public virtual async Task<Response> GetAsync(string uploadId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(uploadId, nameof(uploadId));

            using var scope = ClientDiagnostics.CreateScope("UploadClient.Get");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. Details of the response body schema are in the Remarks section below. </returns>
        /// <include file="Docs/UploadClient.xml" path="doc/members/member[@name='Get(String,RequestContext)']/*" />
        ...
        /// <include file="Docs/UploadClient.xml" path="doc/members/member[@name='CompleteAsync(WaitUntil,String,String,RequestContext)']/*" />
        public virtual async Task<Operation<BinaryData>> CompleteAsync(WaitUntil waitUntil, string uploadId, string operationId = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("UploadClient.Complete");
            scope.Start();
            try
            {
                using HttpMessage message = CreateCompleteRequest(uploadId, operationId, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "UploadClient.Complete", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation{T}"/> from the service that will contain a <see cref="BinaryData"/> object once the asynchronous operation on the service has completed. Details of the body schema for the operation's final value are in the Remarks section below. </returns>
        /// <include file="Docs/UploadClient.xml" path="doc/members/member[@name='Complete(WaitUntil,String,String,RequestContext)']/*" />
        public virtual Operation<BinaryData> Complete(WaitUntil waitUntil, string uploadId, string operationId = null, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateCompleteRequest(uploadId, operationId, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "UploadClient.Complete", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation{T}"/> from the service that will contain a <see cref="BinaryData"/> object once the asynchronous operation on the service has completed. Details of the body schema for the operation's final value are in the Remarks section below. </returns>
        /// <include file="Docs/UploadClient.xml" path="doc/members/member[@name='CancelAsync(WaitUntil,String,String,RequestContext)']/*" />
        public virtual async Task<Operation<BinaryData>> CancelAsync(WaitUntil waitUntil, string uploadId, string operationId = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("UploadClient.Cancel");
            scope.Start();
            try
            {
                using HttpMessage message = CreateCancelRequest(uploadId, operationId, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(_pipeline, message, ClientDiagnostics, "UploadClient.Cancel", OperationFinalStateVia.Location, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation{T}"/> from the service that will contain a <see cref="BinaryData"/> object once the asynchronous operation on the service has completed. Details of the body schema for the operation's final value are in the Remarks section below. </returns>
        /// <include file="Docs/UploadClient.xml" path="doc/members/member[@name='Cancel(WaitUntil,String,String,RequestContext)']/*" />
        public virtual Operation<BinaryData> Cancel(WaitUntil waitUntil, string uploadId, string operationId = null, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateCancelRequest(uploadId, operationId, context);
                return ProtocolOperationHelpers.ProcessMessage(_pipeline, message, ClientDiagnostics, "UploadClient.Cancel", OperationFinalStateVia.Location, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
