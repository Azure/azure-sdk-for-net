...
{
    // Data plane generated client. The UploadResultMeasurement service client.
    /// <summary> The UploadResultMeasurement service client. </summary>
    public partial class UploadResultMeasurementClient
    {
        ...
        /// <summary> Initializes a new instance of UploadResultMeasurementClient for mocking. </summary>
        protected UploadResultMeasurementClient()
        {
        }

        /// <summary> Initializes a new instance of UploadResultMeasurementClient. </summary>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public UploadResultMeasurementClient(TokenCredential credential) : this(credential, new AzureAIAutonomousDevelopmentPlatformClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public UploadResultMeasurementClient(TokenCredential credential, AzureAIAutonomousDevelopmentPlatformClientOptions options)
        {
        ...
        /// <include file="Docs/UploadResultMeasurementClient.xml" path="doc/members/member[@name='ListAsync(String,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> ListAsync(string uploadId, RequestContext context = null)
        {
            ...
            return ListImplementationAsync("UploadResultMeasurementClient.List", uploadId, context);
        }
        ...
        /// <include file="Docs/UploadResultMeasurementClient.xml" path="doc/members/member[@name='List(String,RequestContext)']/*" />
        public virtual Pageable<BinaryData> List(string uploadId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(uploadId, nameof(uploadId));

            return ListImplementation("UploadResultMeasurementClient.List", uploadId, context);
        }
