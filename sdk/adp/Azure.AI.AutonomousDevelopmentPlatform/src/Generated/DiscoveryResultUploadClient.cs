...
{
    // Data plane generated client. The DiscoveryResultUpload service client.
    /// <summary> The DiscoveryResultUpload service client. </summary>
    public partial class DiscoveryResultUploadClient
    {
        ...
        /// <summary> Initializes a new instance of DiscoveryResultUploadClient for mocking. </summary>
        protected DiscoveryResultUploadClient()
        {
        }

        /// <summary> Initializes a new instance of DiscoveryResultUploadClient. </summary>
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public DiscoveryResultUploadClient(TokenCredential credential) : this(credential, new AzureAIAutonomousDevelopmentPlatformClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="credential"/> is null. </exception>
        public DiscoveryResultUploadClient(TokenCredential credential, AzureAIAutonomousDevelopmentPlatformClientOptions options)
        {
        ...
        /// <include file="Docs/DiscoveryResultUploadClient.xml" path="doc/members/member[@name='ListAsync(String,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> ListAsync(string discoveryId, RequestContext context = null)
        {
            ...
            return ListImplementationAsync("DiscoveryResultUploadClient.List", discoveryId, context);
        }
        ...
        /// <include file="Docs/DiscoveryResultUploadClient.xml" path="doc/members/member[@name='List(String,RequestContext)']/*" />
        public virtual Pageable<BinaryData> List(string discoveryId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(discoveryId, nameof(discoveryId));

            return ListImplementation("DiscoveryResultUploadClient.List", discoveryId, context);
        }
