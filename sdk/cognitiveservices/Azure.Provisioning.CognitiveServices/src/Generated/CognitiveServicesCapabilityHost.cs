...
namespace Azure.Provisioning.CognitiveServices
{
    ...
    public partial class CognitiveServicesCapabilityHost : ProvisionableResource
    {
        ...
        /// <summary> Creates a new CognitiveServicesCapabilityHost. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public CognitiveServicesCapabilityHost(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.CognitiveServices/accounts/capabilityHosts", resourceVersion ?? "2026-05-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for CognitiveServicesCapabilityHost. </summary>
        ...
        /// <summary> Creates a reference to an existing CognitiveServicesCapabilityHost. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static CognitiveServicesCapabilityHost FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            CognitiveServicesCapabilityHost result = new CognitiveServicesCapabilityHost(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for CognitiveServicesCapabilityHost that are not part of the generated code. </summary>
