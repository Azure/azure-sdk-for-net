...
namespace Azure.Provisioning.CognitiveServices
{
    ...
    public partial class CognitiveServicesDeletedAccount : ProvisionableResource
    {
        ...
        /// <summary> Define all the provisionable properties for CognitiveServicesDeletedAccount. </summary>
        ...
        /// <summary> Creates a reference to an existing CognitiveServicesDeletedAccount. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static CognitiveServicesDeletedAccount FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            CognitiveServicesDeletedAccount result = new CognitiveServicesDeletedAccount(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for CognitiveServicesDeletedAccount that are not part of the generated code. </summary>
        ...
        /// <summary> Creates a role assignment for a user-assigned identity that grants access to this CognitiveServicesDeletedAccount. </summary>
        ...
        {
            string roleName = CognitiveServicesBuiltInRole.GetBuiltInRoleName(role);
        ...
        /// <summary> Creates a role assignment for a principal that grants access to this CognitiveServicesDeletedAccount. </summary>
        /// <param name="role"> The role to grant. </param>
        /// <param name="principalType"> The type of the principal to assign to. </param>
        /// <param name="principalId"> The principal to assign to. </param>
        /// <param name="bicepIdentifierSuffix"> Optional role assignment identifier name suffix. </param>
        /// <returns> The <see cref="RoleAssignment"/>. </returns>
        public RoleAssignment CreateRoleAssignment(CognitiveServicesBuiltInRole role, BicepValue<RoleManagementPrincipalType> principalType, BicepValue<Guid> principalId, string bicepIdentifierSuffix = null)
        {
            string roleName = CognitiveServicesBuiltInRole.GetBuiltInRoleName(role);
