...
public partial class BatchTranscription
{
    ...
    public virtual async Task<Response<TranscriptionJob>> SubmitTranscriptionAsync(TranscriptionJob resource, WaitUntil waitUntil, TimeSpan? pollingInterval = null, CancellationToken cancellationToken = default)
    {
    ...
    /// <param name="cancellationToken"> The cancellation token to use. </param>
    /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
    public virtual Response<TranscriptionJob> SubmitTranscription(TranscriptionJob resource, WaitUntil waitUntil, TimeSpan? pollingInterval = null, CancellationToken cancellationToken = default)
    {
        Argument.AssertNotNull(resource, nameof(resource));
    ...
    {
        var waitUntilStatus = waitUntil == WaitUntil.Started ? JobStatus.Running : JobStatus.Succeeded;
