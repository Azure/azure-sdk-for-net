...
namespace Azure.AI.Speech.Transcription
{
    ...
    public partial class SpeechToTextClient
    {
        ...
        public virtual BatchTranscription GetBatchTranscriptionClient(string apiVersion = "2024-11-15")
        {
            Argument.AssertNotNull(apiVersion, nameof(apiVersion));

            return new BatchTranscription(ClientDiagnostics, _pipeline, _keyCredential, _endpoint, apiVersion);
        }

        /// <summary> Initializes a new instance of FastTranscription. </summary>
        /// <param name="apiVersion"> The API version to use for this operation. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="apiVersion"/> is null. </exception>
        public virtual FastTranscription GetFastTranscriptionClient(string apiVersion = "2024-11-15")
        {
            Argument.AssertNotNull(apiVersion, nameof(apiVersion));

            return new FastTranscription(ClientDiagnostics, _pipeline, _keyCredential, _endpoint, apiVersion);
        }
    }
}
