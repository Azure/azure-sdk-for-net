...
namespace Azure.AI.Speech.Transcription
{
    ...
    public partial class TranscribeConfig
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="TranscribeConfig"/>. </summary>
        ...
        internal TranscribeConfig(IList<string> locales, IDictionary<string, Uri> models, ProfanityFilterMode? profanityFilterMode, TranscribeDiarizationProperties diarizationProperties, IList<int> activeChannels, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Locales = locales;
            Models = models;
        ...
        public TranscribeDiarizationProperties DiarizationProperties { get; set; }
