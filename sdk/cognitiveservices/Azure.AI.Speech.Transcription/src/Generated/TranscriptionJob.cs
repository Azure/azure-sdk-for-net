...
namespace Azure.AI.Speech.Transcription
{
    ...
    public partial class TranscriptionJob
    {
        ...
        internal TranscriptionJob(TranscriptionLinks links, TranscriptionProperties properties, string id, Uri self, EntityReference model, EntityReference dataset, IList<Uri> contents, Uri contentContainerUrl, string locale, string displayName, string description, IDictionary<string, string> customProperties, DateTimeOffset? lastActionDateTime, JobStatus status, DateTimeOffset? createdDateTime, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Links = links;
            Properties = properties;
            Id = id;
