...
namespace Microsoft.Azure.CognitiveServices.Search.LocalSearch
{
    ...
    /// Local operations.
    /// </summary>
    public partial interface ILocal
    {
        /// <summary>
        /// The Local Search API lets you send a search query to Bing and get
        /// back search results that include local businesses such as
        /// restaurants, hotels, retail stores, or other local businesses. The
        /// query can specify the name of the local business or it can ask for
        /// a list (for example, restaurants near me).
        /// </summary>
        /// <param name='query'>
        ...
        /// comma-delimiated list of business categories to search for.
        ...
        /// longitude and radius in meters. For example
        /// 47.61503,-122.1719,5000. Note that circular view should only be
        /// used to indicate a search around a point on the map, not as an
        /// approximation for a view port of a map rectangle.
        /// </param>
