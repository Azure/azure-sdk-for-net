...
namespace Microsoft.Azure.CognitiveServices.Search.LocalSearch.Models
{
    ...
    public partial class QueryContext
    {
        ...
        /// <param name="alterationDisplayQuery">AlteredQuery that is formatted
        /// for display purpose. The query string in the AlterationDisplayQuery
        /// can be html-escaped and can contain hit-highlighting
        /// characters</param>
        ...
        /// sellers".</param>
        public QueryContext(string originalQuery, string alteredQuery = default(string), string alterationDisplayQuery = default(string), string alterationOverrideQuery = default(string), bool? adultIntent = default(bool?), bool? askUserForLocation = default(bool?), bool? isTransactional = default(bool?))
        {
        ...
        /// <summary>
        /// Gets alteredQuery that is formatted for display purpose. The query
        /// string in the AlterationDisplayQuery can be html-escaped and can
        /// contain hit-highlighting characters
        /// </summary>
        [JsonProperty(PropertyName = "alterationDisplayQuery")]
        public string AlterationDisplayQuery { get; private set; }
