...
namespace InkRecognizerTestUWP
{
    ...
    public class UnitTest
    {
        ...
        public void TestSimpleDrawing()
        {
            ...
            var drawing = (InkDrawing) root.GetInkRecognitionUnits().ElementAt(0).Children.ElementAt(0);
        ...
        public void TestSimpleWriting()
        {
            ...
            var writingRegion = (RecognizedWritingRegion) root.GetInkRecognitionUnits().ElementAt(0).Children.ElementAt(0);
