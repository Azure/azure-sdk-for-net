...
namespace Microsoft.Azure.CognitiveServices.Vision.CustomVision.Training.Models
{
    ...
    public partial class ImageIdCreateBatch
    {
        ...
        public ImageIdCreateBatch(IList<ImageIdCreateEntry> images = default(IList<ImageIdCreateEntry>), IList<System.Guid> tagIds = default(IList<System.Guid>), IDictionary<string, string> metadata = default(IDictionary<string, string>))
        {
            Images = images;
            TagIds = tagIds;
            Metadata = metadata;
