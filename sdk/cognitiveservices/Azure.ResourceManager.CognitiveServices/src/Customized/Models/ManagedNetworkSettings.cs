...
// This customization works around a generator bug where ManagedNetworkSettings contains duplicate Status properties.
...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class ManagedNetworkSettings
    {
        ...
        internal ManagedNetworkProvisionStatus ProvisionStatus { get; set; }
        ...
        public ManagedNetworkStatus? Status
        {
            get
            {
                return ProvisionStatus is null ? default : ProvisionStatus.Status;
            }
            set
            {
                if (ProvisionStatus is null)
                {
                    ProvisionStatus = new ManagedNetworkProvisionStatus();
                }
