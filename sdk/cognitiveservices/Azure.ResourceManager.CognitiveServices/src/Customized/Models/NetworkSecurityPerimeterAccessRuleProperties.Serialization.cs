            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("subscriptions"u8))
                {
                    ...
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        ...
                        if (item.ValueKind != JsonValueKind.Null && item.TryGetProperty("id", out JsonElement idProperty) && idProperty.ValueKind != JsonValueKind.Null)
                        {
                            writableSubResource.Id = new ResourceIdentifier(idProperty.GetString());
                        }
