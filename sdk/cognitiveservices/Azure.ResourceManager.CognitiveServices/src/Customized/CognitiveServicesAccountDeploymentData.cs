...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class CognitiveServicesAccountDeploymentData : ResourceData
    {
        ...
        internal CognitiveServicesAccountDeploymentData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CognitiveServicesAccountDeploymentProperties properties, CognitiveServicesSku sku, string eTag, IDictionary<string, string> tags) : base(id is null ? null : new ResourceIdentifier(id), name, resourceType, systemData)
        {
