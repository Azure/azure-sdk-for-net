...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class CommitmentPlanAccountAssociationData : ResourceData
    {
        ...
        internal CommitmentPlanAccountAssociationData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CommitmentPlanAccountAssociationProperties properties, string eTag, IDictionary<string, string> tags) : base(id is null ? null : new ResourceIdentifier(id), name, resourceType, systemData)
        {
