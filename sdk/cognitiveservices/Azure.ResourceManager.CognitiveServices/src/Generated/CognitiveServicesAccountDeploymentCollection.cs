...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    /// Each <see cref="CognitiveServicesAccountDeploymentResource"/> in the collection will belong to the same instance of <see cref="AccountResource"/>.
    /// To get a <see cref="CognitiveServicesAccountDeploymentCollection"/> instance call the GetCognitiveServicesAccountDeployments method from an instance of <see cref="AccountResource"/>.
    /// </summary>
    public partial class CognitiveServicesAccountDeploymentCollection : ArmCollection, IEnumerable<CognitiveServicesAccountDeploymentResource>, IAsyncEnumerable<CognitiveServicesAccountDeploymentResource>
    {
        ...
        internal CognitiveServicesAccountDeploymentCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _deploymentsRestClient = new Deployments(_deploymentsClientDiagnostics, Pipeline, Endpoint, cognitiveServicesAccountDeploymentApiVersion ?? "2025-10-01-preview");
        ...
        public virtual AsyncPageable<CognitiveServicesAccountDeploymentResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<CognitiveServicesAccountDeploymentData, CognitiveServicesAccountDeploymentResource>(new DeploymentsGetAllAsyncCollectionResultOfT(_deploymentsRestClient, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context), data => new CognitiveServicesAccountDeploymentResource(Client, data));
        }
        ...
        public virtual Pageable<CognitiveServicesAccountDeploymentResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<CognitiveServicesAccountDeploymentData, CognitiveServicesAccountDeploymentResource>(new DeploymentsGetAllCollectionResultOfT(_deploymentsRestClient, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context), data => new CognitiveServicesAccountDeploymentResource(Client, data));
        }
