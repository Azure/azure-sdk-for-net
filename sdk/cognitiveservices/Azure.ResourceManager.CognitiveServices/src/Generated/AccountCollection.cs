...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class AccountCollection : ArmCollection, IEnumerable<AccountResource>, IAsyncEnumerable<AccountResource>
    {
        ...
        {
            _accountClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CognitiveServices", AccountResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<AccountResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string accountName, AccountData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CognitiveServicesArmOperation<AccountResource>(new AccountOperationSource(Client), _accountClientDiagnostics, Pipeline, _accountRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, accountName, data).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual AsyncPageable<AccountResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            async Task<Page<AccountResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _accountRestClient.ListByResourceGroupAsync(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<AccountResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _accountRestClient.ListByResourceGroupNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AccountResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<AccountResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<AccountResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _accountRestClient.ListByResourceGroup(Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AccountResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<AccountResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _accountRestClient.ListByResourceGroupNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AccountResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
