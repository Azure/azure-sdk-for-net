...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="AccountResource"/> using the GetNetworkSecurityPerimeterConfigurations method.
    /// </summary>
    public partial class NetworkSecurityPerimeterConfigurationResource : ArmResource
    {
        ...
        internal NetworkSecurityPerimeterConfigurationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _networkSecurityPerimeterConfigurationsRestClient = new NetworkSecurityPerimeterConfigurations(_networkSecurityPerimeterConfigurationsClientDiagnostics, Pipeline, Endpoint, networkSecurityPerimeterConfigurationApiVersion ?? "2025-10-01-preview");
