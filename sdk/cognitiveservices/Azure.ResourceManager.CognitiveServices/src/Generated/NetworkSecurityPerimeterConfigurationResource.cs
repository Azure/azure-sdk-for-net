...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class NetworkSecurityPerimeterConfigurationResource : ArmResource
    {
        ...
        internal NetworkSecurityPerimeterConfigurationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _networkSecurityPerimeterConfigurationsRestClient = new NetworkSecurityPerimeterConfigurations(_networkSecurityPerimeterConfigurationsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, networkSecurityPerimeterConfigurationApiVersion ?? "2026-09-01");
