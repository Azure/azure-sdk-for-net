    ...
    public partial class ManagedNetworkSettingsPropertiesBasicResourceData : ResourceData, IJsonModel<ManagedNetworkSettingsPropertiesBasicResourceData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                writer.WriteObjectValue<CognitiveServices.Models.ManagedNetworkSettingsProperties>(Properties, options);
            }
        }
        ...
        internal static ManagedNetworkSettingsPropertiesBasicResourceData DeserializeManagedNetworkSettingsPropertiesBasicResourceData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            CognitiveServices.Models.ManagedNetworkSettingsProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CognitiveServices.Models.ManagedNetworkSettingsProperties.DeserializeManagedNetworkSettingsProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
