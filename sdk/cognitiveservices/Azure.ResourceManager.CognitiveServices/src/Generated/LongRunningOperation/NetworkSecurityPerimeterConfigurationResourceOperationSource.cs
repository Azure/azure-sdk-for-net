...
{
    /// <summary></summary>
    internal partial class NetworkSecurityPerimeterConfigurationResourceOperationSource : IOperationSource<NetworkSecurityPerimeterConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal NetworkSecurityPerimeterConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
