...
{
    /// <summary></summary>
    internal partial class CognitiveServicesCapabilityHostResourceOperationSource : IOperationSource<CognitiveServicesCapabilityHostResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CognitiveServicesCapabilityHostResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
