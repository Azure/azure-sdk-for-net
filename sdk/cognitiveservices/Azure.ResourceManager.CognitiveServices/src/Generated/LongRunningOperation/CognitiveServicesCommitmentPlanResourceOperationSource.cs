...
{
    /// <summary></summary>
    internal partial class CognitiveServicesCommitmentPlanResourceOperationSource : IOperationSource<CognitiveServicesCommitmentPlanResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CognitiveServicesCommitmentPlanResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
