...
{
    /// <summary></summary>
    internal partial class CognitiveServicesAccountResourceOperationSource : IOperationSource<CognitiveServicesAccountResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CognitiveServicesAccountResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
