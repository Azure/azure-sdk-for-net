...
{
    /// <summary></summary>
    internal partial class CognitiveServicesAccountDeploymentResourceOperationSource : IOperationSource<CognitiveServicesAccountDeploymentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CognitiveServicesAccountDeploymentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
