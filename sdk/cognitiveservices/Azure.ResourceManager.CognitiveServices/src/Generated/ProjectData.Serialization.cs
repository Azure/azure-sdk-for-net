    ...
    public partial class ProjectData : ResourceData, IJsonModel<ProjectData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                writer.WriteObjectValue<CognitiveServices.Models.ProjectProperties>(Properties, options);
            }
        ...
        internal static ProjectData DeserializeProjectData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            CognitiveServices.Models.ProjectProperties properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CognitiveServices.Models.ProjectProperties.DeserializeProjectProperties(prop.Value, options);
                    continue;
                }
