    ...
    public partial class DeploymentData : ResourceData, IJsonModel<DeploymentData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                writer.WriteObjectValue<CognitiveServices.Models.DeploymentProperties>(Properties, options);
            }
        ...
        internal static DeploymentData DeserializeDeploymentData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            CognitiveServices.Models.DeploymentProperties properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CognitiveServices.Models.DeploymentProperties.DeserializeDeploymentProperties(prop.Value, options);
                    continue;
                }
