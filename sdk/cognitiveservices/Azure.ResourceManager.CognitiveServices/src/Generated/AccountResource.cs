...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class AccountResource : ArmResource
    {
        ...
        internal AccountResource(ArmClient client, CognitiveServicesAccountData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal AccountResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _deletedAccountsRestClient = new DeletedAccounts(_deletedAccountsClientDiagnostics, Pipeline, Endpoint, accountApiVersion ?? "2026-01-15-preview");
        ...
        public virtual async Task<ArmOperation<AccountResource>> UpdateAsync(WaitUntil waitUntil, CognitiveServicesAccountData data, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<AccountResource> Update(WaitUntil waitUntil, CognitiveServicesAccountData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<CognitiveServicesPrivateLinkResource> GetPrivateLinkResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AccountsGetPrivateLinkResourcesAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "AccountResource.GetPrivateLinkResources");
        }
        ...
        /// <summary> Gets a collection of CognitiveServicesPrivateEndpointConnections in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of CognitiveServicesAccountDeployments in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of CognitiveServicesEncryptionScopes in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of CognitiveServicesProjects in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of ConnectionPropertiesV2BasicResources in the <see cref="AccountResource"/>. </summary>
        /// <returns> An object representing collection of ConnectionPropertiesV2BasicResources and their operations over a ConnectionPropertiesV2BasicResource. </returns>
        public virtual ConnectionPropertiesV2BasicResourceCollection GetConnectionPropertiesV2BasicResources()
        {
            return GetCachedClient(client => new ConnectionPropertiesV2BasicResourceCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<ConnectionPropertiesV2BasicResource>> GetConnectionPropertiesV2BasicResourceAsync(string connectionName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(connectionName, nameof(connectionName));

            return await GetConnectionPropertiesV2BasicResources().GetAsync(connectionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="connectionName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<ConnectionPropertiesV2BasicResource> GetConnectionPropertiesV2BasicResource(string connectionName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(connectionName, nameof(connectionName));

            return GetConnectionPropertiesV2BasicResources().Get(connectionName, cancellationToken);
        }
        ...
        /// <summary> Gets a collection of CognitiveServicesManagedNetworkSettings in the <see cref="AccountResource"/>. </summary>
