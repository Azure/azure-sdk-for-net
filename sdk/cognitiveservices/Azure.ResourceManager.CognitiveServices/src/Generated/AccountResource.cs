...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class AccountResource : ArmResource
    {
        ...
        internal AccountResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _accountsRestClient = new Accounts(_accountsClientDiagnostics, Pipeline, Endpoint, accountApiVersion ?? "2026-01-15-preview");
            ...
            _testRaiExternalSafetyProviderRestClient = new TestRaiExternalSafetyProvider(_testRaiExternalSafetyProviderClientDiagnostics, Pipeline, Endpoint, accountApiVersion ?? "2026-01-15-preview");
            ...
            _privateLinkResourcesRestClient = new PrivateLinkResources(_privateLinkResourcesClientDiagnostics, Pipeline, Endpoint, accountApiVersion ?? "2026-01-15-preview");
        ...
        public virtual async Task<ArmOperation<AccountResource>> UpdateAsync(WaitUntil waitUntil, AccountData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _accountsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, AccountData.ToRequestContent(data), context);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CognitiveServices.Models.ApiKeys>> GetKeysAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<CognitiveServices.Models.ApiKeys> response = Response.FromValue(CognitiveServices.Models.ApiKeys.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CognitiveServices.Models.ApiKeys> GetKeys(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _accountsClientDiagnostics.CreateScope("AccountResource.GetKeys");
            scope.Start();
            try
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="CognitiveServices.Models.AccountModel"/> that may take multiple service requests to iterate over. </returns>
        public virtual AsyncPageable<CognitiveServices.Models.AccountModel> GetModelsAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="CognitiveServices.Models.AccountModel"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<CognitiveServices.Models.AccountModel> GetModels(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CognitiveServices.Models.AccountSkuListResult>> GetSkusAsync(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _accountsClientDiagnostics.CreateScope("AccountResource.GetSkus");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _accountsRestClient.CreateGetSkusRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<CognitiveServices.Models.AccountSkuListResult> response = Response.FromValue(CognitiveServices.Models.AccountSkuListResult.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CognitiveServices.Models.AccountSkuListResult> GetSkus(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _accountsClientDiagnostics.CreateScope("AccountResource.GetSkus");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CognitiveServices.Models.UsageListResult>> GetUsagesAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _accountsClientDiagnostics.CreateScope("AccountResource.GetUsages");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _accountsRestClient.CreateGetUsagesRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, filter, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<CognitiveServices.Models.UsageListResult> response = Response.FromValue(CognitiveServices.Models.UsageListResult.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        /// <param name="filter"> An OData filter expression that describes a subset of usages to return. The supported parameter is name.value (name of the metric, can have an or of multiple names). </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CognitiveServices.Models.UsageListResult> GetUsages(string filter = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _accountsClientDiagnostics.CreateScope("AccountResource.GetUsages");
            scope.Start();
            try
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CognitiveServices.Models.CognitiveServicesPrivateLinkResourceListResult>> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<CognitiveServices.Models.CognitiveServicesPrivateLinkResourceListResult> response = Response.FromValue(CognitiveServices.Models.CognitiveServicesPrivateLinkResourceListResult.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CognitiveServices.Models.CognitiveServicesPrivateLinkResourceListResult> GetAll(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _privateLinkResourcesClientDiagnostics.CreateScope("AccountResource.GetAll");
            scope.Start();
            try
        ...
        public virtual async Task<Response<CognitiveServices.Models.ApiKeys>> RegenerateKeyAsync(CognitiveServices.Models.RegenerateKeyParameters content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using DiagnosticScope scope = _accountsClientDiagnostics.CreateScope("AccountResource.RegenerateKey");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _accountsRestClient.CreateRegenerateKeyRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, CognitiveServices.Models.RegenerateKeyParameters.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<CognitiveServices.Models.ApiKeys> response = Response.FromValue(CognitiveServices.Models.ApiKeys.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<CognitiveServices.Models.ApiKeys> RegenerateKey(CognitiveServices.Models.RegenerateKeyParameters content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<Response<AccountResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    AccountData patch = new AccountData();
        ...
        /// <summary> Gets a collection of Deployments in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of CommitmentPlans in the <see cref="AccountResource"/>. </summary>
        ...
        {
            return this.GetCachedClient(client => new CommitmentPlanCollection(client, Id));
        }
        ...
        public virtual async Task<Response<CommitmentPlanResource>> GetCommitmentPlanAsync(string commitmentPlanName, CancellationToken cancellationToken = default)
        {
            ...
            return await this.GetCommitmentPlans().GetAsync(commitmentPlanName, cancellationToken).ConfigureAwait(false);
        }
        ...
        public virtual Response<CommitmentPlanResource> GetCommitmentPlan(string commitmentPlanName, CancellationToken cancellationToken = default)
        {
            ...
            return this.GetCommitmentPlans().Get(commitmentPlanName, cancellationToken);
        }
        ...
        /// <summary> Gets a collection of EncryptionScopes in the <see cref="AccountResource"/>. </summary>
        /// <returns> An object representing collection of EncryptionScopes and their operations over a EncryptionScopeResource. </returns>
        ...
        /// <summary> Gets a collection of RaiPolicies in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of SubscriptionRaiPolicies in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of RaiBlocklists in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of RaiTopics in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of RaiToolLabels in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of NetworkSecurityPerimeterConfigurations in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of DefenderForAISettings in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of Projects in the <see cref="AccountResource"/>. </summary>
        ...
        /// <summary> Gets a collection of CapabilityHosts in the <see cref="AccountResource"/>. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<CapabilityHostResource>> GetCapabilityHostAsync(string capabilityHostName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(capabilityHostName, nameof(capabilityHostName));

            return await GetCapabilityHosts().GetAsync(capabilityHostName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="capabilityHostName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<CapabilityHostResource> GetCapabilityHost(string capabilityHostName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(capabilityHostName, nameof(capabilityHostName));

            return GetCapabilityHosts().Get(capabilityHostName, cancellationToken);
        }

        /// <summary> Gets a collection of ManagedNetworkSettingsPropertiesBasicResources in the <see cref="AccountResource"/>. </summary>
