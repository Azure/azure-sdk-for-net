...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class AccountResource : ArmResource
    {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<AccountSkuListResult>> GetSkusAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<AccountSkuListResult> response = Response.FromValue(AccountSkuListResult.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<AccountSkuListResult> GetSkus(CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _accountsClientDiagnostics.CreateScope("AccountResource.GetSkus");
            scope.Start();
            try
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<UsageListResult>> GetUsagesAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<UsageListResult> response = Response.FromValue(UsageListResult.FromResponse(result), result);
                if (response.Value == null)
                {
                    throw new RequestFailedException(response.GetRawResponse());
                }
        ...
        /// <param name="filter"> An OData filter expression that describes a subset of usages to return. The supported parameter is name.value (name of the metric, can have an or of multiple names). </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<UsageListResult> GetUsages(string filter = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _accountsClientDiagnostics.CreateScope("AccountResource.GetUsages");
            scope.Start();
            try
        ...
        /// <summary> Gets a collection of CognitiveServicesCommitmentPlans in the <see cref="AccountResource"/>. </summary>
