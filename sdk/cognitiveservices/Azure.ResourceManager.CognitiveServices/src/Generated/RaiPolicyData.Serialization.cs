...
{
    public partial class RaiPolicyData : IUtf8JsonSerializable, IJsonModel<RaiPolicyData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RaiPolicyData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<RaiPolicyData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                ((IJsonModel<RaiPolicyProperties>)Properties).Write(writer, options);
            }
        }

        RaiPolicyData IJsonModel<RaiPolicyData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RaiPolicyData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static RaiPolicyData DeserializeRaiPolicyData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ModelSerializationExtensions.JsonDeserialize<RaiPolicyProperties>(property.Value);
                    continue;
                }
        ...
        BinaryData IPersistableModel<RaiPolicyData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RaiPolicyData>)this).GetFormatFromOptions(options) : options.Format;
        ...
        RaiPolicyData IPersistableModel<RaiPolicyData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<RaiPolicyData>)this).GetFormatFromOptions(options) : options.Format;
