    ...
    public partial class RaiPolicyData : ResourceData, IJsonModel<RaiPolicyData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                writer.WriteObjectValue<CognitiveServices.Models.RaiPolicyProperties>(Properties, options);
            }
        ...
        internal static RaiPolicyData DeserializeRaiPolicyData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            CognitiveServices.Models.RaiPolicyProperties properties = default;
            string eTag = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CognitiveServices.Models.RaiPolicyProperties.DeserializeRaiPolicyProperties(prop.Value, options);
                    continue;
                }
