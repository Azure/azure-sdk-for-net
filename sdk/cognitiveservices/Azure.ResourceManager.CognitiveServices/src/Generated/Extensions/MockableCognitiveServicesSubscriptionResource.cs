...
namespace Azure.ResourceManager.CognitiveServices.Mocking
{
    ...
    public partial class MockableCognitiveServicesSubscriptionResource : ArmResource
    {
        ...
        private Accounts AccountsRestClient => _accountsRestClient ??= new Accounts(AccountsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-07-15-preview");
        ...
        private CommitmentPlanOperationGroup CommitmentPlanOperationGroupRestClient => _commitmentPlanOperationGroupRestClient ??= new CommitmentPlanOperationGroup(CommitmentPlanOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-07-15-preview");
        ...
        private CognitiveServicesClient CognitiveServicesClientRestClient => _cognitiveServicesClientRestClient ??= new CognitiveServicesClient(CognitiveServicesClientClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-07-15-preview");
        ...
        private DeletedAccounts DeletedAccountsRestClient => _deletedAccountsRestClient ??= new DeletedAccounts(DeletedAccountsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-07-15-preview");
        ...
        private ManagedComputeUsagesOperationGroup ManagedComputeUsagesOperationGroupRestClient => _managedComputeUsagesOperationGroupRestClient ??= new ManagedComputeUsagesOperationGroup(ManagedComputeUsagesOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-07-15-preview");
        ...
        private ManagedComputeCapacities ManagedComputeCapacitiesRestClient => _managedComputeCapacitiesRestClient ??= new ManagedComputeCapacities(ManagedComputeCapacitiesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-07-15-preview");
        ...
        private ResourceSkusOperationGroup ResourceSkusOperationGroupRestClient => _resourceSkusOperationGroupRestClient ??= new ResourceSkusOperationGroup(ResourceSkusOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-07-15-preview");
        ...
        private UsagesOperationGroup UsagesOperationGroupRestClient => _usagesOperationGroupRestClient ??= new UsagesOperationGroup(UsagesOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-07-15-preview");
        ...
        private CommitmentTiersOperationGroup CommitmentTiersOperationGroupRestClient => _commitmentTiersOperationGroupRestClient ??= new CommitmentTiersOperationGroup(CommitmentTiersOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-07-15-preview");
        ...
        private ModelCapacitiesOperationGroup ModelCapacitiesOperationGroupRestClient => _modelCapacitiesOperationGroupRestClient ??= new ModelCapacitiesOperationGroup(ModelCapacitiesOperationGroupClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-07-15-preview");
        ...
        private CognitiveServicesModels CognitiveServicesModelsRestClient => _cognitiveServicesModelsRestClient ??= new CognitiveServicesModels(CognitiveServicesModelsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, "2026-07-15-preview");
        ...
        public virtual AsyncPageable<CognitiveServicesManagedComputeUsage> GetAllAsync(AzureLocation location, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="CognitiveServicesManagedComputeUsage"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<CognitiveServicesManagedComputeUsage> GetAll(AzureLocation location, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual AsyncPageable<CognitiveServicesManagedComputeCapacity> GetAllAsync(string offer, string acceleratorType = default, string deploymentId = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="offer"/> is an empty string, and was expected to be non-empty. </exception>
        /// <returns> A collection of <see cref="CognitiveServicesManagedComputeCapacity"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<CognitiveServicesManagedComputeCapacity> GetAll(string offer, string acceleratorType = default, string deploymentId = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(offer, nameof(offer));
