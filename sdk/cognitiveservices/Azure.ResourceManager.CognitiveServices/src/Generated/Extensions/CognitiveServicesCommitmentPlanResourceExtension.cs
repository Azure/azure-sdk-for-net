...
namespace Azure.ResourceManager.CognitiveServices.Mock
{
    ...
    public partial class CognitiveServicesCommitmentPlanResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CognitiveServicesCommitmentPlanResourceExtension"/> class for mocking. </summary>
        protected CognitiveServicesCommitmentPlanResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CognitiveServicesCommitmentPlanResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CognitiveServicesCommitmentPlanResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
