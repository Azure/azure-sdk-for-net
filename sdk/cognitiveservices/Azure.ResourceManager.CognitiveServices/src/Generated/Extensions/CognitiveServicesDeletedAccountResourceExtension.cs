...
namespace Azure.ResourceManager.CognitiveServices.Mock
{
    ...
    public partial class CognitiveServicesDeletedAccountResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CognitiveServicesDeletedAccountResourceExtension"/> class for mocking. </summary>
        protected CognitiveServicesDeletedAccountResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CognitiveServicesDeletedAccountResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CognitiveServicesDeletedAccountResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
