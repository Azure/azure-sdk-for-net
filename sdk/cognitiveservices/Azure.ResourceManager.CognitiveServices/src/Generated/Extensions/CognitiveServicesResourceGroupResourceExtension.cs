...
namespace Azure.ResourceManager.CognitiveServices.Mock
{
    ...
    public partial class CognitiveServicesResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="CognitiveServicesResourceGroupResourceExtension"/> class for mocking. </summary>
        protected CognitiveServicesResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CognitiveServicesResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CognitiveServicesResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
