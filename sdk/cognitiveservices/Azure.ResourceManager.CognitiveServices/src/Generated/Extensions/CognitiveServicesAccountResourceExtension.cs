...
namespace Azure.ResourceManager.CognitiveServices.Mock
{
    ...
    public partial class CognitiveServicesAccountResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CognitiveServicesAccountResourceExtension"/> class for mocking. </summary>
        protected CognitiveServicesAccountResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CognitiveServicesAccountResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CognitiveServicesAccountResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
