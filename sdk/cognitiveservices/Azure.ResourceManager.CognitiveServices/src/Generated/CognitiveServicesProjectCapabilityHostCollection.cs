...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class CognitiveServicesProjectCapabilityHostCollection : ArmCollection, IEnumerable<CognitiveServicesProjectCapabilityHostResource>, IAsyncEnumerable<CognitiveServicesProjectCapabilityHostResource>
    {
        ...
        /// <summary> Initializes a new instance of CognitiveServicesProjectCapabilityHostCollection for mocking. </summary>
        protected CognitiveServicesProjectCapabilityHostCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="CognitiveServicesProjectCapabilityHostCollection"/> class. </summary>
        ...
        public virtual async Task<ArmOperation<CognitiveServicesProjectCapabilityHostResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string capabilityHostName, CognitiveServicesProjectCapabilityHostData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _projectCapabilityHostsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, capabilityHostName, CognitiveServicesProjectCapabilityHostData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="capabilityHostName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="capabilityHostName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<CognitiveServicesProjectCapabilityHostResource> CreateOrUpdate(WaitUntil waitUntil, string capabilityHostName, CognitiveServicesProjectCapabilityHostData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(capabilityHostName, nameof(capabilityHostName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<CognitiveServicesProjectCapabilityHostResource>> GetAsync(string capabilityHostName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<CognitiveServicesProjectCapabilityHostData> response = Response.FromValue(CognitiveServicesProjectCapabilityHostData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<CognitiveServicesProjectCapabilityHostResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<CognitiveServicesProjectCapabilityHostData, CognitiveServicesProjectCapabilityHostResource>(new ProjectCapabilityHostsGetAllAsyncCollectionResultOfT(
        ...
        public virtual Pageable<CognitiveServicesProjectCapabilityHostResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<CognitiveServicesProjectCapabilityHostData, CognitiveServicesProjectCapabilityHostResource>(new ProjectCapabilityHostsGetAllCollectionResultOfT(
                _projectCapabilityHostsRestClient,
                Id.SubscriptionId,
                Id.ResourceGroupName,
                Id.Parent.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string capabilityHostName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<CognitiveServicesProjectCapabilityHostData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(CognitiveServicesProjectCapabilityHostData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((CognitiveServicesProjectCapabilityHostData)null, result);
                        break;
                    default:
