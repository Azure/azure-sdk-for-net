    ...
    public partial class RaiBlocklistData : ResourceData, IJsonModel<RaiBlocklistData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                writer.WriteObjectValue<CognitiveServices.Models.RaiBlocklistProperties>(Properties, options);
            }
        ...
        internal static RaiBlocklistData DeserializeRaiBlocklistData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            CognitiveServices.Models.RaiBlocklistProperties properties = default;
            string eTag = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CognitiveServices.Models.RaiBlocklistProperties.DeserializeRaiBlocklistProperties(prop.Value, options);
                    continue;
                }
