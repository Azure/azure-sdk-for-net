...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class ManagedNetworkSettingsPropertiesBasicResource : ArmResource
    {
        ...
        internal ManagedNetworkSettingsPropertiesBasicResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _managedNetworkSettingsRestClient = new ManagedNetworkSettings(_managedNetworkSettingsClientDiagnostics, Pipeline, Endpoint, managedNetworkSettingsPropertiesBasicResourceApiVersion ?? "2026-01-15-preview");
            ...
            _outboundRulesRestClient = new OutboundRules(_outboundRulesClientDiagnostics, Pipeline, Endpoint, managedNetworkSettingsPropertiesBasicResourceApiVersion ?? "2026-01-15-preview");
            ...
            _managedNetworkProvisionsRestClient = new ManagedNetworkProvisions(_managedNetworkProvisionsClientDiagnostics, Pipeline, Endpoint, managedNetworkSettingsPropertiesBasicResourceApiVersion ?? "2026-01-15-preview");
        ...
        {
            using DiagnosticScope scope = _managedNetworkSettingsClientDiagnostics.CreateScope("ManagedNetworkSettingsPropertiesBasicResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _managedNetworkSettingsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CognitiveServicesArmOperation operation = new CognitiveServicesArmOperation(_managedNetworkSettingsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
        ...
        public virtual async Task<ArmOperation<CognitiveServices.Models.OutboundRuleListResult>> PostAsync(WaitUntil waitUntil, CognitiveServices.Models.ManagedNetworkSettingsBasicResource body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _outboundRulesRestClient.CreatePostRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, CognitiveServices.Models.ManagedNetworkSettingsBasicResource.ToRequestContent(body), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CognitiveServicesArmOperation<CognitiveServices.Models.OutboundRuleListResult> operation = new CognitiveServicesArmOperation<CognitiveServices.Models.OutboundRuleListResult>(
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="body"/> is null. </exception>
        public virtual ArmOperation<CognitiveServices.Models.OutboundRuleListResult> Post(WaitUntil waitUntil, CognitiveServices.Models.ManagedNetworkSettingsBasicResource body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<CognitiveServices.Models.ManagedNetworkProvisionStatus>> ProvisionManagedNetworkAsync(WaitUntil waitUntil, CognitiveServices.Models.ManagedNetworkProvisionOptions content = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _managedNetworkProvisionsClientDiagnostics.CreateScope("ManagedNetworkSettingsPropertiesBasicResource.ProvisionManagedNetwork");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _managedNetworkProvisionsRestClient.CreateProvisionManagedNetworkRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, CognitiveServices.Models.ManagedNetworkProvisionOptions.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CognitiveServicesArmOperation<CognitiveServices.Models.ManagedNetworkProvisionStatus> operation = new CognitiveServicesArmOperation<CognitiveServices.Models.ManagedNetworkProvisionStatus>(
        ...
        /// <param name="content"> Managed Network Provisioning Options for a cognitive services account. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<CognitiveServices.Models.ManagedNetworkProvisionStatus> ProvisionManagedNetwork(WaitUntil waitUntil, CognitiveServices.Models.ManagedNetworkProvisionOptions content = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _managedNetworkProvisionsClientDiagnostics.CreateScope("ManagedNetworkSettingsPropertiesBasicResource.ProvisionManagedNetwork");
            scope.Start();
            try
