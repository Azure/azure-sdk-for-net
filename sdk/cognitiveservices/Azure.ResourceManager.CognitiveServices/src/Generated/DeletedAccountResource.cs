...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class DeletedAccountResource : ArmResource
    {
        ...
        internal DeletedAccountResource(ArmClient client, CognitiveServicesAccountData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        {
            using DiagnosticScope scope = _deletedAccountsClientDiagnostics.CreateScope("DeletedAccountResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
