...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class DefenderForAISettingData : ResourceData
    {
        ...
        internal DefenderForAISettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DefenderForAISettingProperties properties, ETag? eTag, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
