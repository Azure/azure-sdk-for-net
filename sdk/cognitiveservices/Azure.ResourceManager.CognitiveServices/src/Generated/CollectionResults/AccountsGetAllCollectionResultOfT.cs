...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class AccountsGetAllCollectionResultOfT : Pageable<CognitiveServicesAccountData>
    {
        ...
        public AccountsGetAllCollectionResultOfT(Accounts client, string subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
