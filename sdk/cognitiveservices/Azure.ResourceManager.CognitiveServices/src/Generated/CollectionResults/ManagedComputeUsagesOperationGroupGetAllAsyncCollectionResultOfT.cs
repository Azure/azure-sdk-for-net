...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class ManagedComputeUsagesOperationGroupGetAllAsyncCollectionResultOfT : AsyncPageable<ManagedComputeUsage>
    {
        ...
        /// <summary> Initializes a new instance of ManagedComputeUsagesOperationGroupGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ManagedComputeUsagesOperationGroupGetAllAsyncCollectionResultOfT(ManagedComputeUsagesOperationGroup client, string subscriptionId, AzureLocation location, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ManagedComputeUsagesOperationGroupGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
