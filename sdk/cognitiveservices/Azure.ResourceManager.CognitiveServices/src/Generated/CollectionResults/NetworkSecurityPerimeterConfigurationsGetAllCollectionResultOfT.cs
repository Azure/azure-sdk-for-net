...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class NetworkSecurityPerimeterConfigurationsGetAllCollectionResultOfT : Pageable<NetworkSecurityPerimeterConfigurationData>
    {
        ...
        public NetworkSecurityPerimeterConfigurationsGetAllCollectionResultOfT(NetworkSecurityPerimeterConfigurations client, string subscriptionId, string resourceGroupName, string accountName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<NetworkSecurityPerimeterConfigurationData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                CognitiveServices.Models.NetworkSecurityPerimeterConfigurationList result = CognitiveServices.Models.NetworkSecurityPerimeterConfigurationList.FromResponse(response);
