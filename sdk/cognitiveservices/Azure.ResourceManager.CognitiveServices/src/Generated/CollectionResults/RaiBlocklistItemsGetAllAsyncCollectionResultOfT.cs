...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class RaiBlocklistItemsGetAllAsyncCollectionResultOfT : AsyncPageable<RaiBlocklistItemData>
    {
        ...
        public RaiBlocklistItemsGetAllAsyncCollectionResultOfT(RaiBlocklistItems client, string subscriptionId, string resourceGroupName, string accountName, string raiBlocklistName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
