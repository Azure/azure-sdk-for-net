...
{
    internal partial class RaiBlocklistItemsGetAllAsyncCollectionResultOfT : AsyncPageable<RaiBlocklistItemData>
    {
        ...
        /// <summary> Initializes a new instance of RaiBlocklistItemsGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RaiBlocklistItemsGetAllAsyncCollectionResultOfT(RaiBlocklistItems client, string subscriptionId, string resourceGroupName, string accountName, string raiBlocklistName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of RaiBlocklistItemsGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of RaiBlocklistItemsGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
