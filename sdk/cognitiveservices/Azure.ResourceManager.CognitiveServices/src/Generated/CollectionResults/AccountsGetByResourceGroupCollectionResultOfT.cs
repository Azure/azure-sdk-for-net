...
{
    internal partial class AccountsGetByResourceGroupCollectionResultOfT : Pageable<CognitiveServicesAccountData>
    {
        ...
        /// <summary> Initializes a new instance of AccountsGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public AccountsGetByResourceGroupCollectionResultOfT(Accounts client, string subscriptionId, string resourceGroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AccountsGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
