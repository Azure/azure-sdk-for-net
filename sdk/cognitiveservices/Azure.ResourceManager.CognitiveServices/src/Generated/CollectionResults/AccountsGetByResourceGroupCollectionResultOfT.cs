...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class AccountsGetByResourceGroupCollectionResultOfT : Pageable<CognitiveServicesAccountData>
    {
        ...
        public AccountsGetByResourceGroupCollectionResultOfT(Accounts client, string subscriptionId, string resourceGroupName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
