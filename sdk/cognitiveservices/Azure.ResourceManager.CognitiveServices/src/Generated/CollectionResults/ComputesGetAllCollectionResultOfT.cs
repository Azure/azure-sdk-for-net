...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class ComputesGetAllCollectionResultOfT : Pageable<CognitiveServicesComputeData>
    {
        ...
        public ComputesGetAllCollectionResultOfT(Computes client, string subscriptionId, string resourceGroupName, string accountName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
