...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class WorkbenchesGetAllCollectionResultOfT : Pageable<CognitiveServicesWorkbenchData>
    {
        ...
        /// <summary> Initializes a new instance of WorkbenchesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public WorkbenchesGetAllCollectionResultOfT(Workbenches client, string subscriptionId, string resourceGroupName, string accountName, string projectName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of WorkbenchesGetAllCollectionResultOfT as an enumerable collection. </summary>
