...
{
    internal partial class DeletedAccountsGetAllCollectionResultOfT : Pageable<AccountData>
    {
        private readonly DeletedAccounts _client;
        private readonly string _subscriptionId;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of DeletedAccountsGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The DeletedAccounts client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        public DeletedAccountsGetAllCollectionResultOfT(DeletedAccounts client, string subscriptionId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DeletedAccountsGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DeletedAccountsGetAllCollectionResultOfT as an enumerable collection. </returns>
