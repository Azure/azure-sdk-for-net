...
{
    internal partial class AccountsGetAllAsyncCollectionResultOfT : AsyncPageable<CognitiveServicesAccountData>
    {
        ...
        public AccountsGetAllAsyncCollectionResultOfT(Accounts client, string subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
