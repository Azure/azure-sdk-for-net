...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class DeploymentData : ResourceData
    {
        ...
        internal DeploymentData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CognitiveServices.Models.DeploymentProperties properties, CognitiveServices.Models.CognitiveServicesSku sku, string eTag, IDictionary<string, string> tags) : base(id, name, resourceType, systemData)
        {
        ...
        public CognitiveServices.Models.DeploymentProperties Properties { get; set; }
