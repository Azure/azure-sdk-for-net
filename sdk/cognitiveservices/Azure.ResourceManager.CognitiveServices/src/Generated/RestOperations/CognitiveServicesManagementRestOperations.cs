...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class CognitiveServicesManagementRestOperations
    {
        ...
        internal HttpMessage CreateCheckSkuAvailabilityRequest(string subscriptionId, AzureLocation location, CognitiveServicesSkuAvailabilityContent content)
        {
            ...
            ((IJsonModel<CognitiveServicesSkuAvailabilityContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateCheckDomainAvailabilityRequest(string subscriptionId, CognitiveServicesDomainAvailabilityContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<CognitiveServicesDomainAvailabilityContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateCalculateModelCapacityRequest(string subscriptionId, CalculateModelCapacityContent content)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content0 = new Utf8JsonRequestContent();
            ((IJsonModel<CalculateModelCapacityContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content0;
            _userAgent.Apply(message);
            return message;
        }
