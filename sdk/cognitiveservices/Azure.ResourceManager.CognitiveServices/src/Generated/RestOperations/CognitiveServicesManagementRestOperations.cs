...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class CognitiveServicesManagementRestOperations
    {
        ...
        internal RequestUriBuilder CreateCalculateModelCapacityRequestUri(string subscriptionId, CalculateModelCapacityPatch patch)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCalculateModelCapacityRequest(string subscriptionId, CalculateModelCapacityPatch patch)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="patch"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public async Task<Response<CalculateModelCapacityResult>> CalculateModelCapacityAsync(string subscriptionId, CalculateModelCapacityPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(patch, nameof(patch));

            using var message = CreateCalculateModelCapacityRequest(subscriptionId, patch);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/> or <paramref name="patch"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="subscriptionId"/> is an empty string, and was expected to be non-empty. </exception>
        public Response<CalculateModelCapacityResult> CalculateModelCapacity(string subscriptionId, CalculateModelCapacityPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(subscriptionId, nameof(subscriptionId));
            Argument.AssertNotNull(patch, nameof(patch));
