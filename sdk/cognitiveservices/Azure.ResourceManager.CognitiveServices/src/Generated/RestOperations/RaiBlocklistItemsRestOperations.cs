...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class RaiBlocklistItems
    {
        ...
        internal RaiBlocklistItems(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(RaiBlocklistItems).Assembly, applicationId);
        }
