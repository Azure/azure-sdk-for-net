...
namespace Azure.ResourceManager.CognitiveServices
{
    internal partial class RaiPolicies
    {
        ...
        internal RaiPolicies(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(RaiPolicies).Assembly, applicationId);
        }
        ...
        internal HttpMessage CreateGetRequest(string subscriptionId, string resourceGroupName, string accountName, string raiPolicyName, RequestContext context)
        {
