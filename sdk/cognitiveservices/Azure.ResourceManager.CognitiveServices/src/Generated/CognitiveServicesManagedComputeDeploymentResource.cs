...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class CognitiveServicesManagedComputeDeploymentResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the CognitiveServicesManagedComputeDeployment.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CognitiveServices/accounts/{accountName}/managedComputeDeployments/{deploymentName}. </description>
        ...
        public virtual async Task<ArmOperation<CognitiveServicesManagedComputeDeploymentResource>> UpdateAsync(WaitUntil waitUntil, CognitiveServicesManagedComputeDeploymentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _managedComputeDeploymentsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, CognitiveServicesManagedComputeDeploymentData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CognitiveServicesArmOperation<CognitiveServicesManagedComputeDeploymentResource> operation = new CognitiveServicesArmOperation<CognitiveServicesManagedComputeDeploymentResource>(
                    new CognitiveServicesManagedComputeDeploymentResourceOperationSource(Client),
                    _managedComputeDeploymentsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<CognitiveServicesManagedComputeDeploymentResource> Update(WaitUntil waitUntil, CognitiveServicesManagedComputeDeploymentData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
