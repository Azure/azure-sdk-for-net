...
{
    /// <summary>
    /// A class representing the CognitiveServicesConnection data model.
    ...
    public partial class CognitiveServicesConnectionData : ResourceData
    {
        ...
        internal CognitiveServicesConnectionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, CognitiveServicesConnectionProperties properties, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
