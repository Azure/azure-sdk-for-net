...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class CognitiveServicesDeletedAccountResource : ArmResource
    {
        ...
        internal CognitiveServicesDeletedAccountResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _deletedAccountsRestClient = new DeletedAccounts(_deletedAccountsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, cognitiveServicesDeletedAccountApiVersion ?? "2026-09-01");
