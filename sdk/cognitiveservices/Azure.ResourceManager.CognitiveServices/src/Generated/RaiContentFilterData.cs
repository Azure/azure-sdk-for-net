...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class RaiContentFilterData : ResourceData
    {
        ...
        internal RaiContentFilterData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, RaiContentFilterProperties properties) : base(id, name, resourceType, systemData)
        {
