...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class RaiContentFilterData : ResourceData
    {
        ...
        internal RaiContentFilterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, RaiContentFilterProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
