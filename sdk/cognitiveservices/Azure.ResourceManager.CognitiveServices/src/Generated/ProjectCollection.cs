...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    /// Each <see cref="ProjectResource"/> in the collection will belong to the same instance of <see cref="CognitiveServicesAccountResource"/>.
    /// To get a <see cref="ProjectCollection"/> instance call the GetProjects method from an instance of <see cref="CognitiveServicesAccountResource"/>.
    /// </summary>
    public partial class ProjectCollection : ArmCollection, IEnumerable<ProjectResource>, IAsyncEnumerable<ProjectResource>
    {
        ...
        {
            _projectClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CognitiveServices", ProjectResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ProjectResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string projectName, ProjectData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _projectRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, projectName, data, cancellationToken).ConfigureAwait(false);
                var operation = new CognitiveServicesArmOperation<ProjectResource>(new ProjectOperationSource(Client), _projectClientDiagnostics, Pipeline, _projectRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, projectName, data).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation<ProjectResource> CreateOrUpdate(WaitUntil waitUntil, string projectName, ProjectData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _projectRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, projectName, data, cancellationToken);
                var operation = new CognitiveServicesArmOperation<ProjectResource>(new ProjectOperationSource(Client), _projectClientDiagnostics, Pipeline, _projectRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, projectName, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
