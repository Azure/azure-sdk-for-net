...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    /// Each <see cref="ProjectResource"/> in the collection will belong to the same instance of <see cref="AccountResource"/>.
    /// To get a <see cref="ProjectCollection"/> instance call the GetProjects method from an instance of <see cref="AccountResource"/>.
    /// </summary>
    public partial class ProjectCollection : ArmCollection, IEnumerable<ProjectResource>, IAsyncEnumerable<ProjectResource>
    {
        ...
        internal ProjectCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _projectsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CognitiveServices", ProjectResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ProjectResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string projectName, ProjectData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _projectsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, projectName, ProjectData.ToRequestContent(data), context);
        ...
        public virtual AsyncPageable<ProjectResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ProjectData, ProjectResource>(new ProjectsGetAllAsyncCollectionResultOfT(_projectsRestClient, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context), data => new ProjectResource(Client, data));
        }
        ...
        public virtual Pageable<ProjectResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ProjectData, ProjectResource>(new ProjectsGetAllCollectionResultOfT(_projectsRestClient, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context), data => new ProjectResource(Client, data));
        }
