...
namespace Azure.ResourceManager.CognitiveServices
{
    public partial class ProjectResource : IJsonModel<ProjectData>
    {
        ...
        BinaryData IPersistableModel<ProjectData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<ProjectData>(Data, options, AzureResourceManagerCognitiveServicesContext.Default);

        ProjectData IPersistableModel<ProjectData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ProjectData>(data, options, AzureResourceManagerCognitiveServicesContext.Default);
