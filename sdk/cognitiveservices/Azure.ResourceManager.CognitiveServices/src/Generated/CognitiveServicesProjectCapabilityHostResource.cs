...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="CognitiveServicesProjectCapabilityHostResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="CognitiveServicesProjectResource"/> using the GetCognitiveServicesProjectCapabilityHosts method.
    /// </summary>
    public partial class CognitiveServicesProjectCapabilityHostResource : ArmResource
    {
        ...
        private readonly CognitiveServicesProjectCapabilityHostData _data;
        ...
        internal CognitiveServicesProjectCapabilityHostResource(ArmClient client, CognitiveServicesProjectCapabilityHostData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual CognitiveServicesProjectCapabilityHostData Data
        {
            get
            {
                if (!HasData)
        ...
        /// <summary>
        /// Update a CognitiveServicesProjectCapabilityHost.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CognitiveServices/accounts/{accountName}/projects/{projectName}/capabilityHosts/{capabilityHostName}. </description>
        ...
        public virtual async Task<ArmOperation<CognitiveServicesProjectCapabilityHostResource>> UpdateAsync(WaitUntil waitUntil, CognitiveServicesProjectCapabilityHostData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _projectCapabilityHostsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, CognitiveServicesProjectCapabilityHostData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<CognitiveServicesProjectCapabilityHostResource> Update(WaitUntil waitUntil, CognitiveServicesProjectCapabilityHostData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
