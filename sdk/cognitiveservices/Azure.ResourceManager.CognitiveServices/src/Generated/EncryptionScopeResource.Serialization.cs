...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class EncryptionScopeResource : IJsonModel<EncryptionScopeData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EncryptionScopeData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<EncryptionScopeData>(Data, options, AzureResourceManagerCognitiveServicesContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EncryptionScopeData IPersistableModel<EncryptionScopeData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<EncryptionScopeData>(data, options, AzureResourceManagerCognitiveServicesContext.Default);
