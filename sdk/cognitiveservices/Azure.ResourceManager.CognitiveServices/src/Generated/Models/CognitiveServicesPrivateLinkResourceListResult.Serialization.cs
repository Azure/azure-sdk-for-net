...
{
    internal partial class CognitiveServicesPrivateLinkResourceListResult : IUtf8JsonSerializable, IJsonModel<CognitiveServicesPrivateLinkResourceListResult>, IPersistableModel<CognitiveServicesPrivateLinkResourceListResult>
    {
        ...
        void IJsonModel<CognitiveServicesPrivateLinkResourceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CognitiveServicesPrivateLinkResourceListResult)} does not support '{format}' format.");
            }
