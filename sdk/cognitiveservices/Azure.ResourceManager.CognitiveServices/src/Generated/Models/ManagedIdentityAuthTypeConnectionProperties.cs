...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class ManagedIdentityAuthTypeConnectionProperties : ConnectionPropertiesV2
    {
        ...
        internal ManagedIdentityAuthTypeConnectionProperties(ConnectionAuthType authType, ConnectionCategory? category, ResourceIdentifier createdByWorkspaceArmId, string error, DateTimeOffset? expiryOn, ConnectionGroup? group, bool? isSharedToAll, IDictionary<string, string> metadata, ManagedPERequirement? peRequirement, ManagedPEStatus? peStatus, IList<string> sharedUserList, string target, bool? useWorkspaceManagedIdentity, IDictionary<string, BinaryData> serializedAdditionalRawData, ConnectionManagedIdentity credentials) : base(authType, category, createdByWorkspaceArmId, error, expiryOn, group, isSharedToAll, metadata, peRequirement, peStatus, sharedUserList, target, useWorkspaceManagedIdentity, serializedAdditionalRawData)
        {
        ...
        public ConnectionManagedIdentity Credentials { get; set; }
    }
}
