...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    public partial class CognitiveServicesAccountProperties : IUtf8JsonSerializable, IModelJsonSerializable<CognitiveServicesAccountProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CognitiveServicesAccountProperties>(this, options.Format);
            ...
            if (Optional.IsDefined(NetworkAcls))
            {
                ...
                {
                    ((IModelJsonSerializable<CognitiveServicesNetworkRuleSet>)NetworkAcls).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(Encryption))
            {
                ...
                {
                    ((IModelJsonSerializable<ServiceAccountEncryptionProperties>)Encryption).Serialize(writer, options);
                }
            }
            if (Optional.IsCollectionDefined(UserOwnedStorage))
            {
                ...
                foreach (var item in UserOwnedStorage)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ServiceAccountUserOwnedStorage>)item).Serialize(writer, options);
                    }
                }
            ...
            if (Optional.IsDefined(ApiProperties))
            {
                ...
                {
                    ((IModelJsonSerializable<ServiceAccountApiProperties>)ApiProperties).Serialize(writer, options);
                }
            }
            ...
            if (Optional.IsDefined(Locations))
            {
                ...
                {
                    ((IModelJsonSerializable<CognitiveServicesMultiRegionSettings>)Locations).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="CognitiveServicesAccountProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CognitiveServicesAccountProperties"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CognitiveServicesAccountProperties"/>. </summary>
