...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CalculateModelCapacityPatch
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CalculateModelCapacityPatch"/>. </summary>
        ...
        internal CalculateModelCapacityPatch(CognitiveServicesAccountDeploymentModel model, string skuName, IList<ModelCapacityCalculatorWorkload> workloads, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Model = model;
            SkuName = skuName;
            Workloads = workloads;
