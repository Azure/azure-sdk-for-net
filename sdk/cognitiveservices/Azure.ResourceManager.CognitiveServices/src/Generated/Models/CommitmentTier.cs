...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CommitmentTier
    {
        ...
        internal CommitmentTier(string kind, string skuName, ServiceAccountHostingModel? hostingModel, string planType, string tier, int? maxCount, CommitmentQuota quota, CommitmentCost cost, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            SkuName = skuName;
