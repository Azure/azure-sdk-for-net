...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesModel
    {
        ...
        internal CognitiveServicesModel(CognitiveServicesAccountModel model, string kind, string skuName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Model = model;
            Kind = kind;
            SkuName = skuName;
