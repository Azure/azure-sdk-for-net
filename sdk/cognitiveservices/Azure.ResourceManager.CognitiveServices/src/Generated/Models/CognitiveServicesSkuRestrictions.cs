...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesSkuRestrictions
    {
        ...
        internal CognitiveServicesSkuRestrictions(CognitiveServicesSkuRestrictionsType? @type, IReadOnlyList<string> values, CognitiveServicesSkuRestrictionInfo restrictionInfo, CognitiveServicesSkuRestrictionReasonCode? reasonCode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
            Values = values;
        ...
        public CognitiveServicesSkuRestrictionsType? Type { get; }
