...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceAccountQuotaLimit>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceAccountQuotaLimit>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceAccountQuotaLimit>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceAccountQuotaLimit>)} interface");
            }
        ...
        string IPersistableModel<ServiceAccountQuotaLimit>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
