...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        internal static SkuAvailability DeserializeSkuAvailability(JsonElement element)
        {
            ...
            return new SkuAvailability(kind.Value, type.Value, skuName.Value, Optional.ToNullable(skuAvailable), reason.Value, message.Value);
        }
    }
}
