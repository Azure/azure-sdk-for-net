...
{
    public partial class CognitiveServicesAccountDeploymentScaleSettings : IUtf8JsonSerializable, IJsonModel<CognitiveServicesAccountDeploymentScaleSettings>, IPersistableModel<CognitiveServicesAccountDeploymentScaleSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActiveCapacity))
            {
                ...
                builder.AppendLine($" '{ActiveCapacity.Value.ToString()}'");
            }
