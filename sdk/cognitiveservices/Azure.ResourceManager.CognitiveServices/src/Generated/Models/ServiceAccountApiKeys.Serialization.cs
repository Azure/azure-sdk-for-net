...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceAccountApiKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceAccountApiKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceAccountApiKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ServiceAccountApiKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
