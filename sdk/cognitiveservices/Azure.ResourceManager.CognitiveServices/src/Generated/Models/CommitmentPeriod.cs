...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CommitmentPeriod
    {
        ...
        internal CommitmentPeriod(string tier, int? count, CommitmentQuota quota, DateTimeOffset? startOn, DateTimeOffset? endOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tier = tier;
            Count = count;
            Quota = quota;
