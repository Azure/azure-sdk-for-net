...
{
    public partial class AbusePenalty : IUtf8JsonSerializable, IJsonModel<AbusePenalty>, IPersistableModel<AbusePenalty>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Expiration))
            {
                ...
                builder.AppendLine($" '{Expiration.Value.ToString()}'");
            }
