...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceAccountUsageMetricName>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceAccountUsageMetricName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceAccountUsageMetricName>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceAccountUsageMetricName>)} interface");
            }
        ...
        string IPersistableModel<ServiceAccountUsageMetricName>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
