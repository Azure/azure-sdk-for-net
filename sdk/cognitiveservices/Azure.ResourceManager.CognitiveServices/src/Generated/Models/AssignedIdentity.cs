...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class AssignedIdentity
    {
        ...
        public AssignedIdentity(IdentityKind kind, IdentityManagementType @type, string clientId, string principalId, string tenantId)
        {
        ...
        internal AssignedIdentity(IdentityKind kind, IdentityManagementType @type, string clientId, string principalId, string tenantId, string subject, IdentityProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Kind = kind;
            Type = @type;
            ClientId = clientId;
