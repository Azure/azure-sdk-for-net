...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        internal static CommitmentPlanListResult DeserializeCommitmentPlanListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
