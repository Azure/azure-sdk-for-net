...
{
    public partial class CognitiveServicesSku : IUtf8JsonSerializable, IJsonModel<CognitiveServicesSku>, IPersistableModel<CognitiveServicesSku>
    {
        ...
        void IJsonModel<CognitiveServicesSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CognitiveServicesSku)} does not support '{format}' format.");
            }
