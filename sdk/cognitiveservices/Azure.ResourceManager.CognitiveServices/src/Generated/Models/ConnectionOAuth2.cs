...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    /// </summary>
    public partial class ConnectionOAuth2
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ConnectionOAuth2"/>. </summary>
        ...
        internal ConnectionOAuth2(Uri authUri, Guid? clientId, string clientSecret, string developerToken, string password, string refreshToken, Guid? tenantId, string username, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AuthUri = authUri;
            ClientId = clientId;
