...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesCommitmentPlanPatch : CognitiveServicesPatchResourceTags
    {
        ...
        internal CognitiveServicesCommitmentPlanPatch(IDictionary<string, string> tags, CognitiveServicesSku sku, Dictionary<string, BinaryData> rawData) : base(tags, rawData)
        {
            Sku = sku;
        }
