...
{
    public partial class AccountModel : IUtf8JsonSerializable
    {
        ...
        internal static AccountModel DeserializeAccountModel(JsonElement element)
        {
            Optional<DeploymentModel> baseModel = default;
            Optional<int> maxCapacity = default;
            Optional<IDictionary<string, string>> capabilities = default;
            Optional<ModelDeprecationInfo> deprecation = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("baseModel"))
                {
                    ...
                    baseModel = DeserializeDeploymentModel(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("deprecation"))
                {
                    ...
                    deprecation = ModelDeprecationInfo.DeserializeModelDeprecationInfo(property.Value);
                    continue;
                }
            ...
            return new AccountModel(format.Value, name.Value, version.Value, baseModel.Value, Optional.ToNullable(maxCapacity), Optional.ToDictionary(capabilities), deprecation.Value, systemData);
        }
    }
}
