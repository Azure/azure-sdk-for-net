...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class ServiceAccountQuotaLimit
    {
        ...
        internal ServiceAccountQuotaLimit(float? count, float? renewalPeriod, IReadOnlyList<ServiceAccountThrottlingRule> rules, Dictionary<string, BinaryData> rawData)
        {
            Count = count;
