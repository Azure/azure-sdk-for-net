...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        internal static CallRateLimit DeserializeCallRateLimit(JsonElement element)
        {
            ...
            return new CallRateLimit(Optional.ToNullable(count), Optional.ToNullable(renewalPeriod), Optional.ToList(rules));
        }
    }
}
