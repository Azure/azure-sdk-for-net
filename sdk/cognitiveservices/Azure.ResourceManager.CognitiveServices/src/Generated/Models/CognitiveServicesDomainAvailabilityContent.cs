...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesDomainAvailabilityContent
    {
        ...
        internal CognitiveServicesDomainAvailabilityContent(string subdomainName, ResourceType resourceType, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SubdomainName = subdomainName;
            ResourceType = resourceType;
            Kind = kind;
