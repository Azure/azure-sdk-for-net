...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class ServiceAccountCallRateLimit
    {
        ...
        internal ServiceAccountCallRateLimit(float? count, float? renewalPeriod, IReadOnlyList<ServiceAccountThrottlingRule> rules, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Count = count;
