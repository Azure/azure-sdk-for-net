...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class AbusePenalty
    {
        ...
        internal AbusePenalty(AbusePenaltyAction? action, float? rateLimitPercentage, DateTimeOffset? expiration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Action = action;
