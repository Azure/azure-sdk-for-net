...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class AvailableCognitiveServicesSku
    {
        ...
        internal AvailableCognitiveServicesSku(string resourceType, string name, string tier, string kind, IReadOnlyList<AzureLocation> locations, IReadOnlyList<CognitiveServicesSkuRestrictions> restrictions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
