...
{
    public partial class ManagedIdentityAuthTypeConnectionProperties : IUtf8JsonSerializable, IJsonModel<ManagedIdentityAuthTypeConnectionProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedIdentityAuthTypeConnectionProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedIdentityAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ManagedIdentityAuthTypeConnectionProperties IJsonModel<ManagedIdentityAuthTypeConnectionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedIdentityAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static ManagedIdentityAuthTypeConnectionProperties DeserializeManagedIdentityAuthTypeConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credentials"u8))
                {
                    ...
                    credentials = CognitiveServicesConnectionManagedIdentity.DeserializeCognitiveServicesConnectionManagedIdentity(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<ManagedIdentityAuthTypeConnectionProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedIdentityAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ManagedIdentityAuthTypeConnectionProperties IPersistableModel<ManagedIdentityAuthTypeConnectionProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ManagedIdentityAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
