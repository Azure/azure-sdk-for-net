...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesPrivateLinkResourceProperties
    {
        ...
        internal CognitiveServicesPrivateLinkResourceProperties(string groupId, IReadOnlyList<string> requiredMembers, IList<string> requiredZoneNames, string displayName, Dictionary<string, BinaryData> rawData)
        {
            GroupId = groupId;
