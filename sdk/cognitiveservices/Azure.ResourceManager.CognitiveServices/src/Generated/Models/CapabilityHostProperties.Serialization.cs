...
{
    public partial class CapabilityHostProperties : IUtf8JsonSerializable, IJsonModel<CapabilityHostProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CapabilityHostProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<CapabilityHostProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        CapabilityHostProperties IJsonModel<CapabilityHostProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CapabilityHostProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static CapabilityHostProperties DeserializeCapabilityHostProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<CapabilityHostProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CapabilityHostProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        CapabilityHostProperties IPersistableModel<CapabilityHostProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<CapabilityHostProperties>)this).GetFormatFromOptions(options) : options.Format;
