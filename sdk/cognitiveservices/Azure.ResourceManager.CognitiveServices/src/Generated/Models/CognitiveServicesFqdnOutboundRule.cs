...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesFqdnOutboundRule : CognitiveServicesOutboundRuleBasicProperties
    {
        ...
        internal CognitiveServicesFqdnOutboundRule(CognitiveServicesServiceTagOutboundRuleCategory? category, CognitiveServicesServiceTagOutboundRuleStatus? status, RuleType @type, string errorInformation, IReadOnlyList<string> parentRuleNames, IDictionary<string, BinaryData> additionalBinaryDataProperties, string destination) : base(category, status, @type, errorInformation, parentRuleNames, additionalBinaryDataProperties)
        {
