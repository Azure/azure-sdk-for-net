...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesVirtualNetworkRule
    {
        ...
        internal CognitiveServicesVirtualNetworkRule(ResourceIdentifier id, string state, bool? ignoreMissingVnetServiceEndpoint, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            State = state;
