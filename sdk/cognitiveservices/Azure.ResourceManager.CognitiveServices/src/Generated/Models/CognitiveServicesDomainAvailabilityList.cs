...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesDomainAvailabilityList
    {
        ...
        internal CognitiveServicesDomainAvailabilityList(bool? isSubdomainAvailable, string reason, string subdomainName, string domainAvailabilityType, string kind, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
