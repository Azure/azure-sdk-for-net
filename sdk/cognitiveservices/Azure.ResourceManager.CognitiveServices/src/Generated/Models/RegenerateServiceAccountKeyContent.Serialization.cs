...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegenerateServiceAccountKeyContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RegenerateServiceAccountKeyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RegenerateServiceAccountKeyContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RegenerateServiceAccountKeyContent>)} interface");
            }
        ...
        string IPersistableModel<RegenerateServiceAccountKeyContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
