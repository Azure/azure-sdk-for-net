...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    internal partial class AvailableCognitiveServicesSkuResult : IUtf8JsonSerializable, IJsonModel<AvailableCognitiveServicesSkuResult>
    {
        ...
        void IJsonModel<AvailableCognitiveServicesSkuResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AvailableCognitiveServicesSkuResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AvailableCognitiveServicesSkuResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AvailableCognitiveServicesSkuResult)} does not support '{options.Format}' format.");
            }
        }
