...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    internal partial class AvailableCognitiveServicesSkuResult : IUtf8JsonSerializable, IJsonModel<AvailableCognitiveServicesSkuResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailableCognitiveServicesSkuResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AvailableCognitiveServicesSkuResult>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
