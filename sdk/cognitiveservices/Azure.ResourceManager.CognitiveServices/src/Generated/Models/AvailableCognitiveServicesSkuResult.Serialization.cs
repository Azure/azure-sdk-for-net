...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AvailableCognitiveServicesSkuResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AvailableCognitiveServicesSkuResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AvailableCognitiveServicesSkuResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AvailableCognitiveServicesSkuResult>)} interface");
            }
        ...
        AvailableCognitiveServicesSkuResult IJsonModel<AvailableCognitiveServicesSkuResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            return DeserializeAvailableCognitiveServicesSkuResult(document.RootElement, options);
        }
        ...
        AvailableCognitiveServicesSkuResult IPersistableModel<AvailableCognitiveServicesSkuResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<AvailableCognitiveServicesSkuResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
