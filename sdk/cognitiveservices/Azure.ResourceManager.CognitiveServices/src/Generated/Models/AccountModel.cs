...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AccountModel. </summary>
        public AccountModel()
        {
        ...
        internal AccountModel(string format, string name, string version, DeploymentModel baseModel, int? maxCapacity, IDictionary<string, string> capabilities, ModelDeprecationInfo deprecation, SystemData systemData) : base(format, name, version)
        {
            BaseModel = baseModel;
