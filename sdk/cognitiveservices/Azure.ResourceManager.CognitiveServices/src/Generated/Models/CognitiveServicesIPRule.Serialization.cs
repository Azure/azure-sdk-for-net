...
{
    public partial class CognitiveServicesIPRule : IUtf8JsonSerializable, IJsonModel<CognitiveServicesIPRule>, IPersistableModel<CognitiveServicesIPRule>
    {
        ...
        void IJsonModel<CognitiveServicesIPRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CognitiveServicesIPRule)} does not support '{format}' format.");
            }
