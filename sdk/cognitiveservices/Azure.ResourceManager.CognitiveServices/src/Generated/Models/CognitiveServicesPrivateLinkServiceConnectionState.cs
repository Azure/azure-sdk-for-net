...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesPrivateLinkServiceConnectionState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CognitiveServicesPrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal CognitiveServicesPrivateLinkServiceConnectionState(CognitiveServicesPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
