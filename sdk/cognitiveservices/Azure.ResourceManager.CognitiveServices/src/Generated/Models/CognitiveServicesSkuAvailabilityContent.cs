...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesSkuAvailabilityContent
    {
        ...
        internal CognitiveServicesSkuAvailabilityContent(IList<string> skus, string kind, ResourceType resourceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Skus = skus;
            Kind = kind;
            ResourceType = resourceType;
