...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CognitiveServicesCommitmentPlanPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CognitiveServicesCommitmentPlanPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CognitiveServicesCommitmentPlanPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CognitiveServicesCommitmentPlanPatch>)} interface");
            }
        ...
        string IPersistableModel<CognitiveServicesCommitmentPlanPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
