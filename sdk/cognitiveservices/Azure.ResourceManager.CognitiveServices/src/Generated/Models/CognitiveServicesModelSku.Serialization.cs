...
{
    public partial class CognitiveServicesModelSku : IUtf8JsonSerializable, IJsonModel<CognitiveServicesModelSku>, IPersistableModel<CognitiveServicesModelSku>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeprecationOn))
            {
                ...
                builder.AppendLine($" '{DeprecationOn.Value.ToString()}'");
            }
