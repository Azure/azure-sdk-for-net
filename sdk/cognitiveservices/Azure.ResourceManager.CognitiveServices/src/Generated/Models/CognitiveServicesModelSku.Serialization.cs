...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    public partial class CognitiveServicesModelSku : IUtf8JsonSerializable, IModelJsonSerializable<CognitiveServicesModelSku>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CognitiveServicesModelSku>(this, options.Format);
            ...
            if (Optional.IsDefined(Capacity))
            {
                ...
                {
                    ((IModelJsonSerializable<CognitiveServicesCapacityConfig>)Capacity).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="CognitiveServicesModelSku"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CognitiveServicesModelSku"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CognitiveServicesModelSku"/>. </summary>
