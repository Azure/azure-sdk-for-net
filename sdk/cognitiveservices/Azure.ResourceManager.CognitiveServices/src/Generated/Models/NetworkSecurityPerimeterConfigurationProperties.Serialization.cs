        ...
        internal static NetworkSecurityPerimeterConfigurationProperties DeserializeNetworkSecurityPerimeterConfigurationProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("networkSecurityPerimeter"u8))
                {
                    ...
                    networkSecurityPerimeter = CognitiveServicesNetworkSecurityPerimeter.DeserializeCognitiveServicesNetworkSecurityPerimeter(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("resourceAssociation"u8))
                {
                    ...
                    resourceAssociation = NetworkSecurityPerimeterConfigurationAssociationInfo.DeserializeNetworkSecurityPerimeterConfigurationAssociationInfo(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("profile"u8))
                {
                    ...
                    profile = NetworkSecurityPerimeterProfileInfo.DeserializeNetworkSecurityPerimeterProfileInfo(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
