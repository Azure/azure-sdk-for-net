...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public abstract partial class CognitiveServicesApplicationAuthorizationPolicy
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CognitiveServicesApplicationAuthorizationPolicy"/>. </summary>
        /// <param name="type"> Authorization scheme type. </param>
        private protected CognitiveServicesApplicationAuthorizationPolicy(BuiltInAuthorizationScheme @type)
        {
            Type = @type;
        }
        ...
        internal CognitiveServicesApplicationAuthorizationPolicy(BuiltInAuthorizationScheme @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Type = @type;
