...
{
    public partial class ServiceAccountApiProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceAccountApiProperties DeserializeServiceAccountApiProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
