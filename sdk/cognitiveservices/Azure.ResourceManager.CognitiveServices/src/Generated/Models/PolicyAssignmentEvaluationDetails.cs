...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class PolicyAssignmentEvaluationDetails
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="PolicyAssignmentEvaluationDetails"/>. </summary>
        ...
        internal PolicyAssignmentEvaluationDetails(string assignmentId, string policyDefinitionId, string policySetDefinitionId, PolicyEvaluationOutcome? evaluationOutcome, string nonComplianceReason, string effect, IList<PolicyExpressionEvaluationDetails> expressionEvaluations, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<PolicyExpressionEvaluationDetails> ExpressionEvaluations { get; }
    }
}
