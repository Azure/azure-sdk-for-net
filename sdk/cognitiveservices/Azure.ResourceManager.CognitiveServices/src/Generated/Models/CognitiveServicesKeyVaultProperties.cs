...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesKeyVaultProperties
    {
        ...
        internal CognitiveServicesKeyVaultProperties(string keyName, string keyVersion, Uri keyVaultUri, Guid? identityClientId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
