...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CognitiveServicesAccountDeploymentProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CognitiveServicesAccountDeploymentProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CognitiveServicesAccountDeploymentProperties>)} interface");
            }
        ...
        string IPersistableModel<CognitiveServicesAccountDeploymentProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
