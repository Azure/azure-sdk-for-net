...
{
    public partial class CognitiveServicesAccountDeploymentProperties : IUtf8JsonSerializable, IJsonModel<CognitiveServicesAccountDeploymentProperties>, IPersistableModel<CognitiveServicesAccountDeploymentProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VersionUpgradeOption))
            {
                ...
                builder.AppendLine($" '{VersionUpgradeOption.ToString()}'");
            }
