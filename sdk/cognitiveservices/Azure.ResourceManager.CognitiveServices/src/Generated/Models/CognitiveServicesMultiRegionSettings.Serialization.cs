...
{
    public partial class CognitiveServicesMultiRegionSettings : IUtf8JsonSerializable, IJsonModel<CognitiveServicesMultiRegionSettings>, IPersistableModel<CognitiveServicesMultiRegionSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RoutingMethod))
            {
                ...
                builder.AppendLine($" '{RoutingMethod.ToString()}'");
            }
