...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class AgentReference : ResourceData
    {
        ...
        /// <param name="properties"> [Required] Additional attributes of the entity. </param>
        internal AgentReference(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AgentReferenceProperties properties) : base(id, name, resourceType, systemData)
        {
