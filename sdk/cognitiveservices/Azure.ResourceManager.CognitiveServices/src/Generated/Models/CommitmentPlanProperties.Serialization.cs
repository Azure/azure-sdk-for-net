...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommitmentPlanProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommitmentPlanProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommitmentPlanProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommitmentPlanProperties>)} interface");
            }
        ...
        string IPersistableModel<CommitmentPlanProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
