...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesSkuAvailabilityList
    {
        ...
        internal CognitiveServicesSkuAvailabilityList(string kind, string skuAvailabilityType, string skuName, bool? isSkuAvailable, string reason, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
