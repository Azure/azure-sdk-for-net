...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class TrafficRoutingRule
    {
        ...
        internal TrafficRoutingRule(string ruleId, string description, string deploymentId, int? trafficPercentage, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            RuleId = ruleId;
