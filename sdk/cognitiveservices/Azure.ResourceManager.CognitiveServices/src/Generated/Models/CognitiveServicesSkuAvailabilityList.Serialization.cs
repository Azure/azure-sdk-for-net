...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CognitiveServicesSkuAvailabilityList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CognitiveServicesSkuAvailabilityList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CognitiveServicesSkuAvailabilityList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CognitiveServicesSkuAvailabilityList>)} interface");
            }
        ...
        string IPersistableModel<CognitiveServicesSkuAvailabilityList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
