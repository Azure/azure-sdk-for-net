...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class WorkbenchProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="WorkbenchProperties"/>. </summary>
        ...
        internal WorkbenchProperties(string targetClusterId, string imageLink, string idleTimeBeforeShutdown, string datasetId, SshSettings sshSettings, ConnectivityEndpoints connectivityEndpoints, string webEndpoint, ComputeProvisioningState? provisioningState, IReadOnlyList<ResponseError> errors, DateTimeOffset? createdOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TargetClusterId = targetClusterId;
            ImageLink = imageLink;
