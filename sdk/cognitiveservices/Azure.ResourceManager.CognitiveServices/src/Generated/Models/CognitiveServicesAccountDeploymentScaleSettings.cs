...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesAccountDeploymentScaleSettings
    {
        ...
        internal CognitiveServicesAccountDeploymentScaleSettings(CognitiveServicesAccountDeploymentScaleType? scaleType, int? capacity, int? activeCapacity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ScaleType = scaleType;
            Capacity = capacity;
