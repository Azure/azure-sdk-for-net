...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesAccountDeploymentScaleSettings
    {
        ...
        internal CognitiveServicesAccountDeploymentScaleSettings(CognitiveServicesAccountDeploymentScaleType? scaleType, int? capacity, int? activeCapacity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ScaleType = scaleType;
            Capacity = capacity;
