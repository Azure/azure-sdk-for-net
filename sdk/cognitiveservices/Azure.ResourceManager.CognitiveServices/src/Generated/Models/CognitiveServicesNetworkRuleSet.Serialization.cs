...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CognitiveServicesNetworkRuleSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CognitiveServicesNetworkRuleSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CognitiveServicesNetworkRuleSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CognitiveServicesNetworkRuleSet>)} interface");
            }
        ...
        string IPersistableModel<CognitiveServicesNetworkRuleSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
