...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    /// </summary>
    public partial class ApiKeyAuthConnectionProperties : CognitiveServicesConnectionProperties, IJsonModel<ApiKeyAuthConnectionProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApiKeyAuthConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ApiKeyAuthConnectionProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiKeyAuthConnectionProperties IPersistableModel<ApiKeyAuthConnectionProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (ApiKeyAuthConnectionProperties)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApiKeyAuthConnectionProperties IJsonModel<ApiKeyAuthConnectionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ApiKeyAuthConnectionProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ApiKeyAuthConnectionProperties DeserializeApiKeyAuthConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("credentials"u8))
                {
                    ...
                    credentials = ConnectionApiKey.DeserializeConnectionApiKey(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
