...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommitmentTier>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommitmentTier>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommitmentTier>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommitmentTier>)} interface");
            }
        ...
        string IPersistableModel<CommitmentTier>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
