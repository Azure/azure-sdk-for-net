...
{
    public partial class ServiceAccountModelDeprecationInfo : IUtf8JsonSerializable, IJsonModel<ServiceAccountModelDeprecationInfo>, IPersistableModel<ServiceAccountModelDeprecationInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FineTuneOn))
            {
                ...
                builder.AppendLine($" '{FineTuneOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(InferenceOn))
            {
                builder.Append("  inference:");
                builder.AppendLine($" '{InferenceOn.Value.ToString()}'");
            }
