...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesModelSku
    {
        ...
        internal CognitiveServicesModelSku(string name, string usageName, DateTimeOffset? deprecationOn, CognitiveServicesCapacityConfig capacity, IReadOnlyList<ServiceAccountCallRateLimit> rateLimits, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UsageName = usageName;
