...
{
    public partial class SASAuthTypeConnectionProperties : IUtf8JsonSerializable, IJsonModel<SASAuthTypeConnectionProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SASAuthTypeConnectionProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<SASAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        SASAuthTypeConnectionProperties IJsonModel<SASAuthTypeConnectionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SASAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static SASAuthTypeConnectionProperties DeserializeSASAuthTypeConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credentials"u8))
                {
                    ...
                    credentials = ConnectionSharedAccessSignature.DeserializeConnectionSharedAccessSignature(property.Value, options);
                    continue;
                }
        ...
        BinaryData IPersistableModel<SASAuthTypeConnectionProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SASAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        SASAuthTypeConnectionProperties IPersistableModel<SASAuthTypeConnectionProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SASAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
