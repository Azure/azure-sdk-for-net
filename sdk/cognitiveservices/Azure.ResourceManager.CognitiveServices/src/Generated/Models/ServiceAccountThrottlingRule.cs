...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class ServiceAccountThrottlingRule
    {
        ...
        internal ServiceAccountThrottlingRule(string key, float? renewalPeriod, float? count, float? minCount, bool? isDynamicThrottlingEnabled, IReadOnlyList<ServiceAccountThrottlingMatchPattern> matchPatterns, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Key = key;
