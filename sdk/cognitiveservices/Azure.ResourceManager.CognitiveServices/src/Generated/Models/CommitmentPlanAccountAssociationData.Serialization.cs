...
{
    public partial class CommitmentPlanAccountAssociationData : IUtf8JsonSerializable, IJsonModel<CommitmentPlanAccountAssociationData>, IPersistableModel<CommitmentPlanAccountAssociationData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommitmentPlanAccountAssociationData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CommitmentPlanAccountAssociationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommitmentPlanAccountAssociationData)} does not support '{format}' format.");
            }
