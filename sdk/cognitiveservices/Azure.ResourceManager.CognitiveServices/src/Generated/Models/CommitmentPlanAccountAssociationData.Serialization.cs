...
namespace Azure.ResourceManager.CognitiveServices
{
    public partial class CommitmentPlanAccountAssociationData : IUtf8JsonSerializable, IJsonModel<CommitmentPlanAccountAssociationData>
    {
        ...
        void IJsonModel<CommitmentPlanAccountAssociationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CommitmentPlanAccountAssociationData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CommitmentPlanAccountAssociationData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CommitmentPlanAccountAssociationData)} does not support '{options.Format}' format.");
            }
        }
