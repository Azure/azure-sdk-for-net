...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class ProjectProperties
    {
        ...
        internal ProjectProperties(ServiceAccountProvisioningState? provisioningState, string displayName, string description, IReadOnlyDictionary<string, string> endpoints, bool? isDefault, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
