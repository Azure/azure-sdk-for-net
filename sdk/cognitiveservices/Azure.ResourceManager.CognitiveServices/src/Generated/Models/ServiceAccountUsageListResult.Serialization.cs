...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceAccountUsageListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceAccountUsageListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceAccountUsageListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceAccountUsageListResult>)} interface");
            }
        ...
        string IPersistableModel<ServiceAccountUsageListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
