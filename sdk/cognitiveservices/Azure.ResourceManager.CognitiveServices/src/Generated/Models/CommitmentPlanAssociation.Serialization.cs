...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    {
        internal static CommitmentPlanAssociation DeserializeCommitmentPlanAssociation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
