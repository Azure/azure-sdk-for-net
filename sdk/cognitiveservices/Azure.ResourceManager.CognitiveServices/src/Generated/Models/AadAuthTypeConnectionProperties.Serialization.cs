...
{
    public partial class AadAuthTypeConnectionProperties : IUtf8JsonSerializable, IJsonModel<AadAuthTypeConnectionProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AadAuthTypeConnectionProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AadAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AadAuthTypeConnectionProperties IJsonModel<AadAuthTypeConnectionProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AadAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AadAuthTypeConnectionProperties DeserializeAadAuthTypeConnectionProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<AadAuthTypeConnectionProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AadAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AadAuthTypeConnectionProperties IPersistableModel<AadAuthTypeConnectionProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AadAuthTypeConnectionProperties>)this).GetFormatFromOptions(options) : options.Format;
