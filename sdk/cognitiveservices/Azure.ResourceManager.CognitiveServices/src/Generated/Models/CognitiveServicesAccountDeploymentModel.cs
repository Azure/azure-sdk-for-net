...
namespace Azure.ResourceManager.CognitiveServices.Models
{
    ...
    public partial class CognitiveServicesAccountDeploymentModel
    {
        ...
        internal CognitiveServicesAccountDeploymentModel(string format, string name, string version, string source, ServiceAccountCallRateLimit callRateLimit, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Format = format;
            Name = name;
            Version = version;
