...
{
    public partial class ServiceAccountUserOwnedStorage : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceAccountUserOwnedStorage DeserializeServiceAccountUserOwnedStorage(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
