...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    /// Each <see cref="CommitmentPlanAccountAssociationResource"/> in the collection will belong to the same instance of <see cref="CommitmentPlanOperationGroupResource"/>.
    /// To get a <see cref="CommitmentPlanAccountAssociationCollection"/> instance call the GetCommitmentPlanAccountAssociations method from an instance of <see cref="CommitmentPlanOperationGroupResource"/>.
    /// </summary>
    public partial class CommitmentPlanAccountAssociationCollection : ArmCollection, IEnumerable<CommitmentPlanAccountAssociationResource>, IAsyncEnumerable<CommitmentPlanAccountAssociationResource>
    {
        ...
        {
            if (id.ResourceType != CommitmentPlanOperationGroupResource.ResourceType)
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, CommitmentPlanOperationGroupResource.ResourceType), nameof(id));
            }
        }
