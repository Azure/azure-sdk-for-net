...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    public partial class CommitmentPlanAccountAssociationCollection : ArmCollection, IEnumerable<CommitmentPlanAccountAssociationResource>, IAsyncEnumerable<CommitmentPlanAccountAssociationResource>
    {
        ...
        internal CommitmentPlanAccountAssociationCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _cognitiveServicesCommitmentPlanClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CognitiveServices", CommitmentPlanAccountAssociationResource.ResourceType.Namespace, Diagnostics);
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, CognitiveServicesCommitmentPlanOperationResource.ResourceType), id);
            }
        }
        ...
        public virtual async Task<ArmOperation<CommitmentPlanAccountAssociationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string commitmentPlanAssociationName, CommitmentPlanAccountAssociationData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _cognitiveServicesCommitmentPlanClientDiagnostics.CreateScope("CommitmentPlanAccountAssociationCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _cognitiveServicesCommitmentPlanRestClient.CreateCreateOrUpdateAssociationRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, commitmentPlanAssociationName, CommitmentPlanAccountAssociationData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<CommitmentPlanAccountAssociationResource>> GetAsync(string commitmentPlanAssociationName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _cognitiveServicesCommitmentPlanClientDiagnostics.CreateScope("CommitmentPlanAccountAssociationCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _cognitiveServicesCommitmentPlanRestClient.CreateGetAssociationRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, commitmentPlanAssociationName, context);
        ...
        public virtual AsyncPageable<CommitmentPlanAccountAssociationResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<CommitmentPlanAccountAssociationData, CommitmentPlanAccountAssociationResource>(new CognitiveServicesCommitmentPlanGetAssociationsAsyncCollectionResultOfT(_cognitiveServicesCommitmentPlanRestClient, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context), data => new CommitmentPlanAccountAssociationResource(Client, data));
        }
        ...
        public virtual Pageable<CommitmentPlanAccountAssociationResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<CommitmentPlanAccountAssociationData, CommitmentPlanAccountAssociationResource>(new CognitiveServicesCommitmentPlanGetAssociationsCollectionResultOfT(_cognitiveServicesCommitmentPlanRestClient, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context), data => new CommitmentPlanAccountAssociationResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string commitmentPlanAssociationName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _cognitiveServicesCommitmentPlanClientDiagnostics.CreateScope("CommitmentPlanAccountAssociationCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<NullableResponse<CommitmentPlanAccountAssociationResource>> GetIfExistsAsync(string commitmentPlanAssociationName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _cognitiveServicesCommitmentPlanClientDiagnostics.CreateScope("CommitmentPlanAccountAssociationCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
