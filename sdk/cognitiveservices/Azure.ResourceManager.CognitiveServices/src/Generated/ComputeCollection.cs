...
namespace Azure.ResourceManager.CognitiveServices
{
    ...
    /// Each <see cref="ComputeResource"/> in the collection will belong to the same instance of <see cref="CognitiveServicesAccountResource"/>.
    /// To get a <see cref="ComputeCollection"/> instance call the GetComputes method from an instance of <see cref="CognitiveServicesAccountResource"/>.
    /// </summary>
    public partial class ComputeCollection : ArmCollection, IEnumerable<ComputeResource>, IAsyncEnumerable<ComputeResource>
    {
        ...
        /// <summary> Initializes a new instance of ComputeCollection for mocking. </summary>
        protected ComputeCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ComputeCollection"/> class. </summary>
        ...
        internal ComputeCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _computesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CognitiveServices", ComputeResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ComputeResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string computeName, ComputeData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _computesClientDiagnostics.CreateScope("ComputeCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _computesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, computeName, ComputeData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<ComputeResource>> GetAsync(string computeName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _computesClientDiagnostics.CreateScope("ComputeCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual AsyncPageable<ComputeResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ComputeData, ComputeResource>(new ComputesGetAllAsyncCollectionResultOfT(
                _computesRestClient,
                Id.SubscriptionId,
                Id.ResourceGroupName,
                Id.Name,
                context,
                "ComputeCollection.GetAll"), data => new ComputeResource(Client, data));
        }
        ...
        public virtual Pageable<ComputeResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ComputeData, ComputeResource>(new ComputesGetAllCollectionResultOfT(
                _computesRestClient,
                Id.SubscriptionId,
                Id.ResourceGroupName,
                Id.Name,
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string computeName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _computesClientDiagnostics.CreateScope("ComputeCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<ComputeData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(ComputeData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((ComputeData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<ComputeResource>> GetIfExistsAsync(string computeName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _computesClientDiagnostics.CreateScope("ComputeCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
