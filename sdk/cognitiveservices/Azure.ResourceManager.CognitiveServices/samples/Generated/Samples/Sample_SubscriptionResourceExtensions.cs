...
"S0"
        ...
        public async Task CalculateModelCapacity_CalculateModelCapacity()
        {
            ...
            // invoke the operation
            CalculateModelCapacityPatch patch = new CalculateModelCapacityPatch()
            {
...
AvgGeneratedTokens = 20L,
            ...
            CalculateModelCapacityResult result = await subscriptionResource.CalculateModelCapacityAsync(patch);
