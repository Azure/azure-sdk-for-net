    ...
    public class FacePersonDirectoryTests : BaseTests
    {
        ...
        public void FacePersonDirectoryCreatePersonPositive()
        {
            using (MockContext context = MockContext.Start(this.GetType()))
            {
                ...
                var person = new EnrollmentRequest
                {
                    Name = "Person",
                    UserData = "UserData"
                };
        ...
        [Fact]
        public void FacePersonDirectoryCreatePersonPositive_Legacy()
        {
            using (MockContext context = MockContext.Start(this.GetType()))
            {
                HttpMockServer.Initialize(this.GetType(), "FacePersonDirectoryCreatePersonPositive_Legacy");
        ...
        public void FacePersonDirectoryCreateDynamicPersonGroupPositive()
        {
            using (MockContext context = MockContext.Start(this.GetType()))
            {
                ...
                var person1 = new EnrollmentRequest
                {
                    Name = "Person1",
                    UserData = "UserData1"
                };
                ...
                var person2 = new EnrollmentRequest
                {
                    Name = "Person2",
                    UserData = "UserData2"
                };
        ...
        [Fact]
        public void FacePersonDirectoryCreateDynamicPersonGroupPositive_Legacy()
        {
            using (MockContext context = MockContext.Start(this.GetType()))
            {
                HttpMockServer.Initialize(this.GetType(), "FacePersonDirectoryCreateDynamicPersonGroupPositive_Legacy");
