...
namespace Microsoft.Azure.CognitiveServices.Language.TextAnalytics.Models
{
    ...
    public partial class SentimentBatchResult
    {
        ...
        public SentimentBatchResult(IList<SentimentBatchResultItem> documents = default(IList<SentimentBatchResultItem>), IList<ErrorRecord> errors = default(IList<ErrorRecord>), RequestStatistics statistics = default(RequestStatistics))
        {
            Documents = documents;
            Errors = errors;
