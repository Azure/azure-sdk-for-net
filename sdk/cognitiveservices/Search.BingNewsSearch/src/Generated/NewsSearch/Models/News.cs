...
namespace Microsoft.Azure.CognitiveServices.Search.NewsSearch.Models
{
    ...
    public partial class News : SearchResultsAnswer
    {
        ...
        public News(IList<NewsArticle> value, string id = default(string), string webSearchUrl = default(string), IList<Query> followUpQueries = default(IList<Query>), long? totalEstimatedMatches = default(long?), string location = default(string))
            : base(id, webSearchUrl, followUpQueries, totalEstimatedMatches)
        {
            Value = value;
            Location = location;
            CustomInit();
