...
namespace Microsoft.Azure.CognitiveServices.Vision.ComputerVision
{
    ...
    public partial interface IComputerVisionClient : System.IDisposable
    {
        ...
        /// <param name='language'>
        /// The BCP-47 language code of the text to be detected in the image.
        /// In future versions, when language parameter is not passed, language
        /// detection will be used to determine the language. However, in the
        /// current version, missing language parameter will cause English to
        /// be used. To ensure that your document is always parsed in English
        /// without the use of language detection in the future, pass “en” in
        /// the language parameter. Possible values include: 'en', 'es', 'fr',
        /// 'de', 'it', 'nl', 'pt'
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
