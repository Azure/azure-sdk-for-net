...
namespace Microsoft.Azure.CognitiveServices.Vision.ComputerVision.Models
{
    ...
    /// </summary>
    public partial class BatchReadFileInStreamHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BatchReadFileInStreamHeaders
        /// class.
        /// </summary>
        public BatchReadFileInStreamHeaders()
        {
            CustomInit();
        }
        ...
        public BatchReadFileInStreamHeaders(string operationLocation = default(string))
        {
