...
namespace Microsoft.Azure.CognitiveServices.Language.LUIS.Authoring.Models
{
    ...
    public partial class NDepthEntityExtractor
    {
        ...
        /// name.</param>
        public NDepthEntityExtractor(System.Guid id, string readableType, string name = default(string), int? typeId = default(int?), bool? fuzzyMatchingEnabled = default(bool?), IList<EntityRole> roles = default(IList<EntityRole>), string customPrebuiltDomainName = default(string), string customPrebuiltModelName = default(string), IList<ChildEntity> children = default(IList<ChildEntity>))
        {
            Id = id;
            Name = name;
            TypeId = typeId;
