...
namespace Microsoft.Azure.CognitiveServices.Language.LUIS.Authoring.Models
{
    ...
    public partial class ClosedListModelCreateObject
    {
        ...
        public ClosedListModelCreateObject(IList<WordListObject> subLists = default(IList<WordListObject>), string name = default(string), bool? fuzzyMatchingEnabled = default(bool?))
        {
            SubLists = subLists;
            Name = name;
