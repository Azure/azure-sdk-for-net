...
namespace Microsoft.Azure.CognitiveServices.Language.LUIS.Authoring.Models
{
    ...
    /// Pattern rule
    /// </summary>
    public partial class PatternRuleInfo
    {
        /// <summary>
        ...
        /// to.</param>
        public PatternRuleInfo(System.Guid? id = default(System.Guid?), string pattern = default(string), string intent = default(string))
        {
            Id = id;
            Pattern = pattern;
            Intent = intent;
