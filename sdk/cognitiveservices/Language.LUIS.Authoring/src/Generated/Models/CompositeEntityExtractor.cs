...
namespace Microsoft.Azure.CognitiveServices.Language.LUIS.Authoring.Models
{
    ...
    public partial class CompositeEntityExtractor
    {
        ...
        public CompositeEntityExtractor(System.Guid id, string readableType, string name = default(string), int? typeId = default(int?), bool? fuzzyMatchingEnabled = default(bool?), IList<EntityRole> roles = default(IList<EntityRole>), IList<ChildEntity> children = default(IList<ChildEntity>))
        {
            Id = id;
            Name = name;
            TypeId = typeId;
