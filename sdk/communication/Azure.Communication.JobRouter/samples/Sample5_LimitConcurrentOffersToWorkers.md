...
## Using MaxConcurrentOffers on RouterWorker to limit number of offers sent to worker

```C# Snippet:Azure_Communication_JobRouter_Tests_Samples_Worker_LimitMaxConcurrentOffers
