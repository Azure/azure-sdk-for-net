...
{
    [CodeGenSuppress("AzureFunctionRuleCredential")]
    public partial class AzureFunctionRuleCredential
    {
        ...
        public AzureFunctionRuleCredential(string functionKey)
        {
        ...
        public AzureFunctionRuleCredential(string appKey, string clientId)
        {
