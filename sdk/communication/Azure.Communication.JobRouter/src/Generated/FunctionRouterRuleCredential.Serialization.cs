...
namespace Azure.Communication.JobRouter
{
    public partial class FunctionRouterRuleCredential : IUtf8JsonSerializable, IJsonModel<FunctionRouterRuleCredential>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FunctionRouterRuleCredential>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FunctionRouterRuleCredential>)} interface");
            }
        ...
        internal static FunctionRouterRuleCredential FromResponse(Response response)
        {
            ...
            return DeserializeFunctionRouterRuleCredential(document.RootElement, new ModelReaderWriterOptions("W"));
        }
