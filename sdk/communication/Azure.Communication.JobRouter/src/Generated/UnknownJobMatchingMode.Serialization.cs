...
{
    internal partial class UnknownJobMatchingMode : IUtf8JsonWriteable, IJsonModel<JobMatchingMode>
    {
        ...
        internal static new UnknownJobMatchingMode FromResponse(PipelineResponse response)
        {
