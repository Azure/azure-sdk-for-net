...
namespace Azure.Communication.JobRouter
{
    ...
    public abstract partial class DistributionMode
    {
        ...
        internal DistributionMode(DistributionModeKind kind, int minConcurrentOffers, int maxConcurrentOffers, bool? bypassSelectors, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
