...
{
    public partial class DeclineJobOfferOptions : IUtf8JsonWriteable, IJsonModel<DeclineJobOfferOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeclineJobOfferOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DeclineJobOfferOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeclineJobOfferOptions)} does not support '{format}' format.");
            }
        ...
        internal static DeclineJobOfferOptions FromResponse(PipelineResponse response)
        {
