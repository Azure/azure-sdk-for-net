...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloseJobOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloseJobOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloseJobOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloseJobOptions>)} interface");
            }
        ...
        string IPersistableModel<CloseJobOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static CloseJobOptions FromResponse(Response response)
        {
            ...
            return DeserializeCloseJobOptions(document.RootElement, ModelReaderWriterOptions.Wire);
        }
