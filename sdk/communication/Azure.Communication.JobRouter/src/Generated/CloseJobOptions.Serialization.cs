...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloseJobOptions>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        CloseJobOptions IJsonModel<CloseJobOptions>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static CloseJobOptions DeserializeCloseJobOptions(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new CloseJobOptions(assignmentId, dispositionCode.Value, closeAt, note.Value, serializedAdditionalRawData);
        }

        BinaryData IModel<CloseJobOptions>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        CloseJobOptions IModel<CloseJobOptions>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<CloseJobOptions>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static CloseJobOptions FromResponse(Response response)
        {
            ...
            return DeserializeCloseJobOptions(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
