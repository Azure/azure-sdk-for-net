...
namespace Azure.Communication.JobRouter
{
    public partial class CloseJobOptions : IUtf8JsonSerializable, IJsonModel<CloseJobOptions>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CloseJobOptions>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static CloseJobOptions FromResponse(Response response)
        {
            ...
            return DeserializeCloseJobOptions(document.RootElement, new ModelReaderWriterOptions("W"));
        }
