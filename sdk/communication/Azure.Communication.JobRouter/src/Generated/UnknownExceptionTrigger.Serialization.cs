...
{
    internal partial class UnknownExceptionTrigger : IUtf8JsonWriteable, IJsonModel<ExceptionTrigger>
    {
        ...
        internal static new UnknownExceptionTrigger FromResponse(PipelineResponse response)
        {
