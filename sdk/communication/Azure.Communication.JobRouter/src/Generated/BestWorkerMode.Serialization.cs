...
{
    public partial class BestWorkerMode : IUtf8JsonWriteable, IJsonModel<BestWorkerMode>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<BestWorkerMode>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new BestWorkerMode FromResponse(PipelineResponse response)
        {
