...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BestWorkerMode>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<BestWorkerMode>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BestWorkerMode>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new BestWorkerMode FromResponse(Response response)
        {
            ...
            return DeserializeBestWorkerMode(document.RootElement, new ModelReaderWriterOptions("W"));
        }
