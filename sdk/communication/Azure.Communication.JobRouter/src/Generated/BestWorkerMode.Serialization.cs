...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BestWorkerMode>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        BestWorkerMode IJsonModel<BestWorkerMode>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<BestWorkerMode>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        BestWorkerMode IModel<BestWorkerMode>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<BestWorkerMode>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static new BestWorkerMode FromResponse(Response response)
        {
            ...
            return DeserializeBestWorkerMode(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
