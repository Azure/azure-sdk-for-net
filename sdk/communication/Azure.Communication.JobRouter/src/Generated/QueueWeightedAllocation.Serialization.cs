...
{
    public partial class QueueWeightedAllocation : IUtf8JsonWriteable, IJsonModel<QueueWeightedAllocation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueueWeightedAllocation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<QueueWeightedAllocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(QueueWeightedAllocation)} does not support '{format}' format.");
            }
        ...
        internal static QueueWeightedAllocation FromResponse(PipelineResponse response)
        {
