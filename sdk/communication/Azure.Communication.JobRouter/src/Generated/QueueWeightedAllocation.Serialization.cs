...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueueWeightedAllocation>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        QueueWeightedAllocation IJsonModel<QueueWeightedAllocation>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<QueueWeightedAllocation>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        QueueWeightedAllocation IModel<QueueWeightedAllocation>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<QueueWeightedAllocation>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static QueueWeightedAllocation FromResponse(Response response)
        {
            ...
            return DeserializeQueueWeightedAllocation(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
