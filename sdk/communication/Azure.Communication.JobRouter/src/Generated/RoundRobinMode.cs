...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class RoundRobinMode : DistributionMode
    {
        ...
        internal RoundRobinMode(DistributionModeKind kind, int minConcurrentOffers, int maxConcurrentOffers, bool? bypassSelectors, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, minConcurrentOffers, maxConcurrentOffers, bypassSelectors, serializedAdditionalRawData)
        {
        }
    }
}
