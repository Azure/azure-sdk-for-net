...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class WeightedAllocationWorkerSelectorAttachment : WorkerSelectorAttachment
    {
        ...
        internal WeightedAllocationWorkerSelectorAttachment(string kind, IDictionary<string, BinaryData> serializedAdditionalRawData, IReadOnlyList<WorkerWeightedAllocation> allocations) : base(kind, serializedAdditionalRawData)
        {
