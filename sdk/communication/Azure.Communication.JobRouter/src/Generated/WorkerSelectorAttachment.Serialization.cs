...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class WorkerSelectorAttachment : IUtf8JsonSerializable, IJsonModel<WorkerSelectorAttachment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkerSelectorAttachment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static WorkerSelectorAttachment FromResponse(Response response)
        {
            ...
            return DeserializeWorkerSelectorAttachment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
