...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkerSelectorAttachment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WorkerSelectorAttachment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkerSelectorAttachment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WorkerSelectorAttachment>)} interface");
            }
        ...
        string IPersistableModel<WorkerSelectorAttachment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static WorkerSelectorAttachment FromResponse(Response response)
        {
            ...
            return DeserializeWorkerSelectorAttachment(document.RootElement, ModelReaderWriterOptions.Wire);
        }
