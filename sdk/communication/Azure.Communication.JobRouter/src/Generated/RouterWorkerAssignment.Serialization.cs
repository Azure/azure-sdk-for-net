...
namespace Azure.Communication.JobRouter
{
    public partial class RouterWorkerAssignment : IUtf8JsonSerializable, IJsonModel<RouterWorkerAssignment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RouterWorkerAssignment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static RouterWorkerAssignment FromResponse(Response response)
        {
            ...
            return DeserializeRouterWorkerAssignment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
