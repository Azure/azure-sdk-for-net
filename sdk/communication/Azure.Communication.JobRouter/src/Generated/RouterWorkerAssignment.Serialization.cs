...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouterWorkerAssignment>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        RouterWorkerAssignment IJsonModel<RouterWorkerAssignment>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<RouterWorkerAssignment>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        RouterWorkerAssignment IModel<RouterWorkerAssignment>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<RouterWorkerAssignment>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static RouterWorkerAssignment FromResponse(Response response)
        {
            ...
            return DeserializeRouterWorkerAssignment(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
