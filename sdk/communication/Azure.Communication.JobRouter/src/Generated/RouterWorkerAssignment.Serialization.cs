...
{
    public partial class RouterWorkerAssignment : IUtf8JsonWriteable, IJsonModel<RouterWorkerAssignment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouterWorkerAssignment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RouterWorkerAssignment FromResponse(PipelineResponse response)
        {
