...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PassThroughWorkerSelectorAttachment>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        PassThroughWorkerSelectorAttachment IJsonModel<PassThroughWorkerSelectorAttachment>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<PassThroughWorkerSelectorAttachment>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        PassThroughWorkerSelectorAttachment IModel<PassThroughWorkerSelectorAttachment>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<PassThroughWorkerSelectorAttachment>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static new PassThroughWorkerSelectorAttachment FromResponse(Response response)
        {
            ...
            return DeserializePassThroughWorkerSelectorAttachment(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
