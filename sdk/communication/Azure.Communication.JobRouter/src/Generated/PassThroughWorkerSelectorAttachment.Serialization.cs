...
{
    public partial class PassThroughWorkerSelectorAttachment : IUtf8JsonWriteable, IJsonModel<PassThroughWorkerSelectorAttachment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<PassThroughWorkerSelectorAttachment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new PassThroughWorkerSelectorAttachment FromResponse(PipelineResponse response)
        {
