...
{
    public partial class CancelJobOptions : IUtf8JsonWriteable, IJsonModel<CancelJobOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CancelJobOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static CancelJobOptions FromResponse(PipelineResponse response)
        {
