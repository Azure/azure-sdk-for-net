...
namespace Azure.Communication.JobRouter
{
    public partial class CancelJobOptions : IUtf8JsonSerializable, IJsonModel<CancelJobOptions>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CancelJobOptions>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static CancelJobOptions FromResponse(Response response)
        {
            ...
            return DeserializeCancelJobOptions(document.RootElement, new ModelReaderWriterOptions("W"));
        }
