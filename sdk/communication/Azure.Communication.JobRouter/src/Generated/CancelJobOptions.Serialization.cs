...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CancelJobOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CancelJobOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CancelJobOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CancelJobOptions>)} interface");
            }
        ...
        string IPersistableModel<CancelJobOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static CancelJobOptions FromResponse(Response response)
        {
            ...
            return DeserializeCancelJobOptions(document.RootElement, ModelReaderWriterOptions.Wire);
        }
