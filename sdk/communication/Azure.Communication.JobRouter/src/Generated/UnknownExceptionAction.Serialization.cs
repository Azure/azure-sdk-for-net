...
{
    internal partial class UnknownExceptionAction : IUtf8JsonWriteable, IJsonModel<ExceptionAction>
    {
        ...
        internal static new UnknownExceptionAction FromResponse(PipelineResponse response)
        {
