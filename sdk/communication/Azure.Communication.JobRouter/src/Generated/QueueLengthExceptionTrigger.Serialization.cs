...
{
    public partial class QueueLengthExceptionTrigger : IUtf8JsonWriteable, IJsonModel<QueueLengthExceptionTrigger>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<QueueLengthExceptionTrigger>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new QueueLengthExceptionTrigger FromResponse(PipelineResponse response)
        {
