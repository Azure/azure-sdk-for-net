...
{
    internal partial class JobRouterAdministrationClientGetQueuesAsyncCollectionResultOfT : AsyncPageable<global::Azure.Communication.JobRouter.RouterQueue>
    {
        ...
        /// <summary> Initializes a new instance of JobRouterAdministrationClientGetQueuesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public JobRouterAdministrationClientGetQueuesAsyncCollectionResultOfT(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of JobRouterAdministrationClientGetQueuesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of JobRouterAdministrationClientGetQueuesAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Communication.JobRouter.RouterQueue>> AsPages(string continuationToken, int? pageSizeHint)
        {
