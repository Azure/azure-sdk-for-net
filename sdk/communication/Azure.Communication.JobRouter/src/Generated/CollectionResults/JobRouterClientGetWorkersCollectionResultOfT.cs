...
{
    internal partial class JobRouterClientGetWorkersCollectionResultOfT : Pageable<global::Azure.Communication.JobRouter.RouterWorker>
    {
        ...
        public JobRouterClientGetWorkersCollectionResultOfT(JobRouterClient client, int? maxpagesize, string state, string channelId, string queueId, bool? hasCapacity, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Communication.JobRouter.RouterWorker>> AsPages(string continuationToken, int? pageSizeHint)
        {
