...
{
    internal partial class JobRouterClientGetJobsCollectionResultOfT : Pageable<global::Azure.Communication.JobRouter.RouterJob>
    {
        ...
        public JobRouterClientGetJobsCollectionResultOfT(JobRouterClient client, int? maxpagesize, string status, string queueId, string channelId, string classificationPolicyId, DateTimeOffset? scheduledBefore, DateTimeOffset? scheduledAfter, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Communication.JobRouter.RouterJob>> AsPages(string continuationToken, int? pageSizeHint)
        {
