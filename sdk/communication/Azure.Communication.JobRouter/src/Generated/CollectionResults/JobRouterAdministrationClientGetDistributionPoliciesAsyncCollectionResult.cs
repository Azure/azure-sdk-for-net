...
{
    internal partial class JobRouterAdministrationClientGetDistributionPoliciesAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public JobRouterAdministrationClientGetDistributionPoliciesAsyncCollectionResult(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
