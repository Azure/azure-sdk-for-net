...
{
    internal partial class JobRouterClientGetWorkersCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of JobRouterClientGetWorkersCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public JobRouterClientGetWorkersCollectionResult(JobRouterClient client, int? maxpagesize, string state, string channelId, string queueId, bool? hasCapacity, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of JobRouterClientGetWorkersCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of JobRouterClientGetWorkersCollectionResult as an enumerable collection. </returns>
