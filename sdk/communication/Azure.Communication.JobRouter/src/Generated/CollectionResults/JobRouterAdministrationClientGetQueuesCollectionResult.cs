...
{
    internal partial class JobRouterAdministrationClientGetQueuesCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of JobRouterAdministrationClientGetQueuesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public JobRouterAdministrationClientGetQueuesCollectionResult(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of JobRouterAdministrationClientGetQueuesCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of JobRouterAdministrationClientGetQueuesCollectionResult as an enumerable collection. </returns>
