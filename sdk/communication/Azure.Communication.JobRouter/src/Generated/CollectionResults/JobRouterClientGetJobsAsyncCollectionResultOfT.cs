...
{
    internal partial class JobRouterClientGetJobsAsyncCollectionResultOfT : AsyncPageable<global::Azure.Communication.JobRouter.RouterJob>
    {
        ...
        /// <summary> Initializes a new instance of JobRouterClientGetJobsAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public JobRouterClientGetJobsAsyncCollectionResultOfT(JobRouterClient client, int? maxpagesize, string status, string queueId, string channelId, string classificationPolicyId, DateTimeOffset? scheduledBefore, DateTimeOffset? scheduledAfter, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of JobRouterClientGetJobsAsyncCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Communication.JobRouter.RouterJob>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<RouterJob>.FromValues(((IReadOnlyList<global::Azure.Communication.JobRouter.RouterJob>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
