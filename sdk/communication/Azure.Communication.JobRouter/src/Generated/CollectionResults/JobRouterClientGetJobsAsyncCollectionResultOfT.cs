...
{
    internal partial class JobRouterClientGetJobsAsyncCollectionResultOfT : AsyncPageable<RouterJob>
    {
        ...
        public JobRouterClientGetJobsAsyncCollectionResultOfT(JobRouterClient client, int? maxpagesize, string status, string queueId, string channelId, string classificationPolicyId, DateTimeOffset? scheduledBefore, DateTimeOffset? scheduledAfter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
