...
{
    internal partial class JobRouterAdministrationClientGetExceptionPoliciesAsyncCollectionResultOfT : AsyncPageable<global::Azure.Communication.JobRouter.ExceptionPolicy>
    {
        ...
        public JobRouterAdministrationClientGetExceptionPoliciesAsyncCollectionResultOfT(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::Azure.Communication.JobRouter.ExceptionPolicy>> AsPages(string continuationToken, int? pageSizeHint)
        {
