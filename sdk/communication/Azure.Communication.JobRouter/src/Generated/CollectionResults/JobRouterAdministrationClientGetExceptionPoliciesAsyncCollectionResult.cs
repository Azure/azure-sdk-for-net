...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterAdministrationClientGetExceptionPoliciesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public JobRouterAdministrationClientGetExceptionPoliciesAsyncCollectionResult(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
