...
namespace Azure.Communication.JobRouter
{
    internal partial class JobRouterAdministrationClientGetQueuesCollectionResultOfT : Pageable<RouterQueue>
    {
        ...
        /// <summary> Initializes a new instance of JobRouterAdministrationClientGetQueuesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public JobRouterAdministrationClientGetQueuesCollectionResultOfT(JobRouterAdministrationClient client, int? maxpagesize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of JobRouterAdministrationClientGetQueuesCollectionResultOfT as an enumerable collection. </summary>
