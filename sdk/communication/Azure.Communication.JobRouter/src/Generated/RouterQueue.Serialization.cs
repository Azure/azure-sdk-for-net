...
namespace Azure.Communication.JobRouter
{
    public partial class RouterQueue : IUtf8JsonSerializable, IJsonModel<RouterQueue>
    {
        void IJsonModel<RouterQueue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RouterQueue)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RouterQueue>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RouterQueue)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static RouterQueue FromResponse(Response response)
        {
            ...
            return DeserializeRouterQueue(document.RootElement, new ModelReaderWriterOptions("W"));
        }
    }
}
