...
{
    public partial class RouterQueue : IUtf8JsonWriteable, IJsonModel<RouterQueue>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouterQueue>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RouterQueue DeserializeRouterQueue(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RouterQueue(
                ...
                labels ?? new OptionalDictionary<string, object>(),
                exceptionPolicyId,
        ...
        internal static RouterQueue FromResponse(PipelineResponse response)
        {
