...
namespace Azure.Communication.JobRouter
{
    public partial class RouterJob : IUtf8JsonSerializable, IJsonModel<RouterJob>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RouterJob>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static RouterJob FromResponse(Response response)
        {
            ...
            return DeserializeRouterJob(document.RootElement, new ModelReaderWriterOptions("W"));
        }
    }
}
