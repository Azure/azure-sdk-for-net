...
{
    public partial class RouterJob : IUtf8JsonWriteable, IJsonModel<RouterJob>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouterJob>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RouterJob FromResponse(PipelineResponse response)
        {
