...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouterJob>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RouterJob>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RouterJob>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RouterJob>)} interface");
            }
        ...
        string IPersistableModel<RouterJob>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static RouterJob FromResponse(Response response)
        {
            ...
            return DeserializeRouterJob(document.RootElement, ModelReaderWriterOptions.Wire);
        }
    }
}
