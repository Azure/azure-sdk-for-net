...
{
    public partial class WorkerWeightedAllocation : IUtf8JsonWriteable, IJsonModel<WorkerWeightedAllocation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<WorkerWeightedAllocation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static WorkerWeightedAllocation FromResponse(PipelineResponse response)
        {
