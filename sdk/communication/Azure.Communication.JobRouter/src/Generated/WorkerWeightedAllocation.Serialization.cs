...
namespace Azure.Communication.JobRouter
{
    public partial class WorkerWeightedAllocation : IUtf8JsonSerializable, IJsonModel<WorkerWeightedAllocation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<WorkerWeightedAllocation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static WorkerWeightedAllocation FromResponse(Response response)
        {
            ...
            return DeserializeWorkerWeightedAllocation(document.RootElement, new ModelReaderWriterOptions("W"));
        }
