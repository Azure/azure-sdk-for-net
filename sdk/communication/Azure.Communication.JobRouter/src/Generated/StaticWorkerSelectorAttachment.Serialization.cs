...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticWorkerSelectorAttachment>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StaticWorkerSelectorAttachment)} does not support writing '{format}' format.");
            }

            base.JsonModelWriteCore(writer, options);
            writer.WritePropertyName("workerSelector"u8);
            ((IJsonModel<RouterWorkerSelector>)WorkerSelector).Write(writer, options);
        }
        ...
        StaticWorkerSelectorAttachment IJsonModel<StaticWorkerSelectorAttachment>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StaticWorkerSelectorAttachment)} does not support reading '{format}' format.");
            }
        ...
        internal static StaticWorkerSelectorAttachment DeserializeStaticWorkerSelectorAttachment(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    workerSelector = ModelSerializationExtensions.JsonDeserialize<RouterWorkerSelector>(property.Value);
                    continue;
                }
        ...
        BinaryData IPersistableModel<StaticWorkerSelectorAttachment>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StaticWorkerSelectorAttachment)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        StaticWorkerSelectorAttachment IPersistableModel<StaticWorkerSelectorAttachment>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StaticWorkerSelectorAttachment)} does not support reading '{options.Format}' format.");
            }
        }
