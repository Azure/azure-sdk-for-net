...
{
    public partial class StaticWorkerSelectorAttachment : IUtf8JsonWriteable, IJsonModel<StaticWorkerSelectorAttachment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticWorkerSelectorAttachment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<StaticWorkerSelectorAttachment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StaticWorkerSelectorAttachment)} does not support '{format}' format.");
            }
        ...
        internal static new StaticWorkerSelectorAttachment FromResponse(PipelineResponse response)
        {
