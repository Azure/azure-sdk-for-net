...
namespace Azure.Communication.JobRouter
{
    public partial class StaticWorkerSelectorAttachment : IUtf8JsonSerializable, IJsonModel<StaticWorkerSelectorAttachment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticWorkerSelectorAttachment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new StaticWorkerSelectorAttachment FromResponse(Response response)
        {
            ...
            return DeserializeStaticWorkerSelectorAttachment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
