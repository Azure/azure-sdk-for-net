...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class PassThroughWorkerSelectorAttachment : WorkerSelectorAttachment
    {
        ...
        internal PassThroughWorkerSelectorAttachment(string kind, IDictionary<string, BinaryData> serializedAdditionalRawData, string key, LabelOperator labelOperator, double? expiresAfterSeconds) : base(kind, serializedAdditionalRawData)
        {
            Key = key;
            LabelOperator = labelOperator;
