...
{
    public partial class ConditionalWorkerSelectorAttachment : IUtf8JsonWriteable, IJsonModel<ConditionalWorkerSelectorAttachment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConditionalWorkerSelectorAttachment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ConditionalWorkerSelectorAttachment FromResponse(PipelineResponse response)
        {
