...
namespace Azure.Communication.JobRouter
{
    public partial class DistributionPolicy : IUtf8JsonSerializable, IJsonModel<DistributionPolicy>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DistributionPolicy>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DistributionPolicy FromResponse(Response response)
        {
            ...
            return DeserializeDistributionPolicy(document.RootElement, new ModelReaderWriterOptions("W"));
        }
    }
}
