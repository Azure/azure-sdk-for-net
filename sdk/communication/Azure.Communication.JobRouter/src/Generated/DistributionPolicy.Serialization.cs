...
{
    public partial class DistributionPolicy : IUtf8JsonWriteable, IJsonModel<DistributionPolicy>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DistributionPolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DistributionPolicy FromResponse(PipelineResponse response)
        {
