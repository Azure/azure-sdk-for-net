...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WeightedAllocationQueueSelectorAttachment>)this).Write(writer, ModelReaderWriterOptions.Wire);
