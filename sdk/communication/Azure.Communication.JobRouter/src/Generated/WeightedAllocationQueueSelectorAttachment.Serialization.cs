...
{
    public partial class WeightedAllocationQueueSelectorAttachment : IUtf8JsonWriteable, IJsonModel<WeightedAllocationQueueSelectorAttachment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<WeightedAllocationQueueSelectorAttachment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new WeightedAllocationQueueSelectorAttachment FromResponse(PipelineResponse response)
        {
