...
namespace Azure.Communication.JobRouter
{
    public partial class WeightedAllocationQueueSelectorAttachment : IUtf8JsonSerializable, IJsonModel<WeightedAllocationQueueSelectorAttachment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<WeightedAllocationQueueSelectorAttachment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new WeightedAllocationQueueSelectorAttachment FromResponse(Response response)
        {
            ...
            return DeserializeWeightedAllocationQueueSelectorAttachment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
