...
namespace Azure.Communication.JobRouter
{
    public partial class ScoringRuleOptions : IUtf8JsonSerializable, IJsonModel<ScoringRuleOptions>
    {
        ...
        void IJsonModel<ScoringRuleOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScoringRuleOptions>)} interface");
            }
        ...
        string IPersistableModel<ScoringRuleOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ScoringRuleOptions FromResponse(Response response)
        {
            ...
            return DeserializeScoringRuleOptions(document.RootElement, ModelReaderWriterOptions.Wire);
        }
