...
namespace Azure.Communication.JobRouter
{
    public partial class FunctionRouterRule : IUtf8JsonSerializable, IJsonModel<FunctionRouterRule>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<FunctionRouterRule>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new FunctionRouterRule FromResponse(Response response)
        {
            ...
            return DeserializeFunctionRouterRule(document.RootElement, new ModelReaderWriterOptions("W"));
        }
