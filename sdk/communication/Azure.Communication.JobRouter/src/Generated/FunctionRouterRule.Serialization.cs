...
{
    public partial class FunctionRouterRule : IUtf8JsonWriteable, IJsonModel<FunctionRouterRule>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<FunctionRouterRule>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new FunctionRouterRule FromResponse(PipelineResponse response)
        {
