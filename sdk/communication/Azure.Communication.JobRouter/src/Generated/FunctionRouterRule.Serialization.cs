...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FunctionRouterRule>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        FunctionRouterRule IJsonModel<FunctionRouterRule>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<FunctionRouterRule>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        FunctionRouterRule IModel<FunctionRouterRule>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<FunctionRouterRule>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static new FunctionRouterRule FromResponse(Response response)
        {
            ...
            return DeserializeFunctionRouterRule(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
