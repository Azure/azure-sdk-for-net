...
{
    public partial class RouterWorker : IUtf8JsonWriteable, IJsonModel<RouterWorker>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouterWorker>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RouterWorker DeserializeRouterWorker(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RouterWorker(
                ...
                capacity,
                labels ?? new OptionalDictionary<string, BinaryData>(),
                tags ?? new OptionalDictionary<string, BinaryData>(),
        ...
        internal static RouterWorker FromResponse(PipelineResponse response)
        {
