...
namespace Azure.Communication.JobRouter
{
    public partial class RouterJobNote : IUtf8JsonSerializable, IJsonModel<RouterJobNote>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RouterJobNote>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static RouterJobNote FromResponse(Response response)
        {
            ...
            return DeserializeRouterJobNote(document.RootElement, new ModelReaderWriterOptions("W"));
        }
