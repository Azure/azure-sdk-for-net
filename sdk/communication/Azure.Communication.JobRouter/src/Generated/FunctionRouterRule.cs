...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class FunctionRouterRule : RouterRule
    {
        ...
        internal FunctionRouterRule(string kind, IDictionary<string, BinaryData> serializedAdditionalRawData, Uri functionUri, FunctionRouterRuleCredential credential) : base(kind, serializedAdditionalRawData)
        {
