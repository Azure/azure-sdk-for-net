...
namespace Azure.Communication.JobRouter
{
    ...
    internal partial class UnknownDistributionMode : DistributionMode
    {
        ...
        internal UnknownDistributionMode(DistributionModeKind kind, int minConcurrentOffers, int maxConcurrentOffers, bool? bypassSelectors, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, minConcurrentOffers, maxConcurrentOffers, bypassSelectors, serializedAdditionalRawData)
        {
        }
