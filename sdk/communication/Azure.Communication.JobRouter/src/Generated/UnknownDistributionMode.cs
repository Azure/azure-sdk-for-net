...
namespace Azure.Communication.JobRouter
{
    ...
    internal partial class UnknownDistributionMode : DistributionMode
    {
        ...
        internal UnknownDistributionMode(int minConcurrentOffers, int maxConcurrentOffers, bool? bypassSelectors, DistributionModeKind kind) : base(minConcurrentOffers, maxConcurrentOffers, bypassSelectors, kind)
        {
        }
    }
}
