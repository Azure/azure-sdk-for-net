...
{
    [ModelReaderProxy(typeof(UnknownExceptionTrigger))]
    public partial class ExceptionTrigger : IUtf8JsonSerializable, IJsonModel<ExceptionTrigger>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExceptionTrigger>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ExceptionTrigger IJsonModel<ExceptionTrigger>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ExceptionTrigger>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ExceptionTrigger IModel<ExceptionTrigger>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ExceptionTrigger>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static ExceptionTrigger FromResponse(Response response)
        {
            ...
            return DeserializeExceptionTrigger(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
