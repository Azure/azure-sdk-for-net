...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class ExceptionTrigger : IUtf8JsonWriteable, IJsonModel<ExceptionTrigger>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExceptionTrigger>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ExceptionTrigger FromResponse(PipelineResponse response)
        {
