...
{
    public partial class ExceptionRule : IUtf8JsonWriteable, IJsonModel<ExceptionRule>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExceptionRule>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ExceptionRule FromResponse(PipelineResponse response)
        {
