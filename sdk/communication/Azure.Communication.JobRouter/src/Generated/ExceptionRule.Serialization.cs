...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExceptionRule>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ExceptionRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ExceptionRule)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ExceptionRule>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ExceptionRule)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static ExceptionRule FromResponse(Response response)
        {
            ...
            return DeserializeExceptionRule(document.RootElement, new ModelReaderWriterOptions("W"));
        }
