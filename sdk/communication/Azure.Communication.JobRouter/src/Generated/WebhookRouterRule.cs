...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class WebhookRouterRule : RouterRule
    {
        ...
        internal WebhookRouterRule(string kind, IDictionary<string, BinaryData> serializedAdditionalRawData, Uri authorizationServerUri, OAuth2WebhookClientCredential clientCredential, Uri webhookUri) : base(kind, serializedAdditionalRawData)
        {
