...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClassificationPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClassificationPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClassificationPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClassificationPolicy>)} interface");
            }
        ...
        string IPersistableModel<ClassificationPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ClassificationPolicy FromResponse(Response response)
        {
            ...
            return DeserializeClassificationPolicy(document.RootElement, ModelReaderWriterOptions.Wire);
        }
    }
}
