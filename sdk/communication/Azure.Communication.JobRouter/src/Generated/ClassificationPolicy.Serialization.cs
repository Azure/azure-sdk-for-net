...
namespace Azure.Communication.JobRouter
{
    public partial class ClassificationPolicy : IUtf8JsonSerializable, IJsonModel<ClassificationPolicy>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ClassificationPolicy>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ClassificationPolicy FromResponse(Response response)
        {
            ...
            return DeserializeClassificationPolicy(document.RootElement, new ModelReaderWriterOptions("W"));
        }
    }
}
