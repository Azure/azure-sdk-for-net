...
{
    public partial class ExceptionPolicy : IUtf8JsonWriteable, IJsonModel<ExceptionPolicy>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExceptionPolicy>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ExceptionPolicy FromResponse(PipelineResponse response)
        {
