...
namespace Azure.Communication.JobRouter
{
    public partial class ExceptionPolicy : IUtf8JsonSerializable, IJsonModel<ExceptionPolicy>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ExceptionPolicy>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExceptionPolicy>)} interface");
            }
        ...
        internal static ExceptionPolicy FromResponse(Response response)
        {
            ...
            return DeserializeExceptionPolicy(document.RootElement, new ModelReaderWriterOptions("W"));
        }
    }
}
