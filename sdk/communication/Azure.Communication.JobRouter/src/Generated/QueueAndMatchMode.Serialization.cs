...
namespace Azure.Communication.JobRouter
{
    public partial class QueueAndMatchMode : IUtf8JsonSerializable, IJsonModel<QueueAndMatchMode>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<QueueAndMatchMode>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QueueAndMatchMode>)} interface");
            }
        ...
        internal static new QueueAndMatchMode FromResponse(Response response)
        {
            ...
            return DeserializeQueueAndMatchMode(document.RootElement, new ModelReaderWriterOptions("W"));
        }
