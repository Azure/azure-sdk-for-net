...
{
    internal partial class UnknownDistributionMode : IUtf8JsonWriteable, IJsonModel<DistributionMode>
    {
        ...
        internal static new UnknownDistributionMode FromResponse(PipelineResponse response)
        {
