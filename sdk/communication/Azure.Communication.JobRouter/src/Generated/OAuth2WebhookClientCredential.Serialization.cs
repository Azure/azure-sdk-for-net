...
{
    public partial class OAuth2WebhookClientCredential : IUtf8JsonWriteable, IJsonModel<OAuth2WebhookClientCredential>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<OAuth2WebhookClientCredential>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static OAuth2WebhookClientCredential FromResponse(PipelineResponse response)
        {
