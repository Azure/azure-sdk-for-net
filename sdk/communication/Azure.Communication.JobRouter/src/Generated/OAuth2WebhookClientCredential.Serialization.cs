...
namespace Azure.Communication.JobRouter
{
    public partial class OAuth2WebhookClientCredential : IUtf8JsonSerializable, IJsonModel<OAuth2WebhookClientCredential>
    {
        ...
        string IPersistableModel<OAuth2WebhookClientCredential>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static OAuth2WebhookClientCredential FromResponse(Response response)
        {
            ...
            return DeserializeOAuth2WebhookClientCredential(document.RootElement, ModelReaderWriterOptions.Wire);
        }
