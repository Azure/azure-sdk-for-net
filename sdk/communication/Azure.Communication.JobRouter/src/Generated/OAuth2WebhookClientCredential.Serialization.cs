...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OAuth2WebhookClientCredential>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        OAuth2WebhookClientCredential IJsonModel<OAuth2WebhookClientCredential>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<OAuth2WebhookClientCredential>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        OAuth2WebhookClientCredential IModel<OAuth2WebhookClientCredential>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<OAuth2WebhookClientCredential>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static OAuth2WebhookClientCredential FromResponse(Response response)
        {
            ...
            return DeserializeOAuth2WebhookClientCredential(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
