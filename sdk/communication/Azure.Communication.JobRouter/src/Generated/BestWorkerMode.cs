...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class BestWorkerMode : DistributionMode
    {
        ...
        internal BestWorkerMode(DistributionModeKind kind, int minConcurrentOffers, int maxConcurrentOffers, bool? bypassSelectors, IDictionary<string, BinaryData> serializedAdditionalRawData, RouterRule scoringRule, ScoringRuleOptions scoringRuleOptions) : base(kind, minConcurrentOffers, maxConcurrentOffers, bypassSelectors, serializedAdditionalRawData)
        {
