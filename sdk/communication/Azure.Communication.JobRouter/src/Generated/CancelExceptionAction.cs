...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class CancelExceptionAction : ExceptionAction
    {
        ...
        internal CancelExceptionAction(string id, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData, string note, string dispositionCode) : base(id, kind, serializedAdditionalRawData)
        {
            Note = note;
