...
{
    public partial class WaitTimeExceptionTrigger : IUtf8JsonWriteable, IJsonModel<WaitTimeExceptionTrigger>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<WaitTimeExceptionTrigger>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WaitTimeExceptionTrigger>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WaitTimeExceptionTrigger)} does not support '{format}' format.");
            }
        ...
        internal static new WaitTimeExceptionTrigger FromResponse(PipelineResponse response)
        {
