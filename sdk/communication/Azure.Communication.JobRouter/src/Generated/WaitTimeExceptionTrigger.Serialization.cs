...
namespace Azure.Communication.JobRouter
{
    public partial class WaitTimeExceptionTrigger : IUtf8JsonSerializable, IJsonModel<WaitTimeExceptionTrigger>
    {
        ...
        void IJsonModel<WaitTimeExceptionTrigger>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WaitTimeExceptionTrigger>)} interface");
            }
        ...
        string IPersistableModel<WaitTimeExceptionTrigger>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static new WaitTimeExceptionTrigger FromResponse(Response response)
        {
            ...
            return DeserializeWaitTimeExceptionTrigger(document.RootElement, ModelReaderWriterOptions.Wire);
        }
