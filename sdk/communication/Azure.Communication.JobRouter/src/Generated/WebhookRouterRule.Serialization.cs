...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebhookRouterRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WebhookRouterRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WebhookRouterRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WebhookRouterRule>)} interface");
            }
        ...
        string IPersistableModel<WebhookRouterRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static new WebhookRouterRule FromResponse(Response response)
        {
            ...
            return DeserializeWebhookRouterRule(document.RootElement, ModelReaderWriterOptions.Wire);
        }
