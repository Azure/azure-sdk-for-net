...
{
    public partial class WebhookRouterRule : IUtf8JsonWriteable, IJsonModel<WebhookRouterRule>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<WebhookRouterRule>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new WebhookRouterRule FromResponse(PipelineResponse response)
        {
