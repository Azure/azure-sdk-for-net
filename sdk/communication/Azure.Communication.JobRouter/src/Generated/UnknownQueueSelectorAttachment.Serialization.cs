...
{
    internal partial class UnknownQueueSelectorAttachment : IUtf8JsonWriteable, IJsonModel<QueueSelectorAttachment>
    {
        ...
        internal static new UnknownQueueSelectorAttachment FromResponse(PipelineResponse response)
        {
