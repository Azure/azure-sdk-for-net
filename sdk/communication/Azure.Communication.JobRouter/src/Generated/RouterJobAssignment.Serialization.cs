...
namespace Azure.Communication.JobRouter
{
    public partial class RouterJobAssignment : IUtf8JsonSerializable, IJsonModel<RouterJobAssignment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RouterJobAssignment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static RouterJobAssignment FromResponse(Response response)
        {
            ...
            return DeserializeRouterJobAssignment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
