...
namespace Azure.Communication.JobRouter
{
    public partial class RouterJobPositionDetails : IUtf8JsonSerializable, IJsonModel<RouterJobPositionDetails>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RouterJobPositionDetails>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static RouterJobPositionDetails FromResponse(Response response)
        {
            ...
            return DeserializeRouterJobPositionDetails(document.RootElement, new ModelReaderWriterOptions("W"));
        }
