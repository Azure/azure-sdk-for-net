...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class QueueLengthExceptionTrigger : ExceptionTrigger
    {
        ...
        internal QueueLengthExceptionTrigger(string kind, IDictionary<string, BinaryData> serializedAdditionalRawData, int threshold) : base(kind, serializedAdditionalRawData)
        {
            Threshold = threshold;
        }
