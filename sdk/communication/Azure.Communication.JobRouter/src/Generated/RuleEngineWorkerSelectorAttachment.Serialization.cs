...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RuleEngineWorkerSelectorAttachment>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        RuleEngineWorkerSelectorAttachment IJsonModel<RuleEngineWorkerSelectorAttachment>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<RuleEngineWorkerSelectorAttachment>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        RuleEngineWorkerSelectorAttachment IModel<RuleEngineWorkerSelectorAttachment>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<RuleEngineWorkerSelectorAttachment>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static new RuleEngineWorkerSelectorAttachment FromResponse(Response response)
        {
            ...
            return DeserializeRuleEngineWorkerSelectorAttachment(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
