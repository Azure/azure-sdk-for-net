...
{
    public partial class RuleEngineWorkerSelectorAttachment : IUtf8JsonWriteable, IJsonModel<RuleEngineWorkerSelectorAttachment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RuleEngineWorkerSelectorAttachment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RuleEngineWorkerSelectorAttachment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RuleEngineWorkerSelectorAttachment)} does not support '{format}' format.");
            }
        ...
        internal static new RuleEngineWorkerSelectorAttachment FromResponse(PipelineResponse response)
        {
