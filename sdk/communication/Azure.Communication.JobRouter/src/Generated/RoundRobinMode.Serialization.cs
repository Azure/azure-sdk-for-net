...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoundRobinMode>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        RoundRobinMode IJsonModel<RoundRobinMode>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<RoundRobinMode>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        RoundRobinMode IModel<RoundRobinMode>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<RoundRobinMode>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
        ...
        internal static new RoundRobinMode FromResponse(Response response)
        {
            ...
            return DeserializeRoundRobinMode(document.RootElement, ModelReaderWriterOptions.DefaultWireOptions);
        }
