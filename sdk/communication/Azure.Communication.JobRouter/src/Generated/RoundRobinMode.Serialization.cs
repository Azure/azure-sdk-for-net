...
namespace Azure.Communication.JobRouter
{
    public partial class RoundRobinMode : IUtf8JsonSerializable, IJsonModel<RoundRobinMode>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RoundRobinMode>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new RoundRobinMode FromResponse(Response response)
        {
            ...
            return DeserializeRoundRobinMode(document.RootElement, new ModelReaderWriterOptions("W"));
        }
