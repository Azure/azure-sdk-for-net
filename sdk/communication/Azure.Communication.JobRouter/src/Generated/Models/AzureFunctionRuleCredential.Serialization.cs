...
{
    public partial class AzureFunctionRuleCredential : IUtf8JsonSerializable
    {
        ...
        internal static AzureFunctionRuleCredential DeserializeAzureFunctionRuleCredential(JsonElement element)
        {
            ...
            return new AzureFunctionRuleCredential(functionKey.Value, appKey.Value, clientId.Value);
        }
    }
}
