...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class QueueLengthExceptionTrigger : ExceptionTrigger
    {
        ...
        internal QueueLengthExceptionTrigger(string kind, int threshold, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Threshold = threshold;
