...
namespace Azure.Communication.JobRouter
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownWorkerSelectorAttachment))]
    public abstract partial class WorkerSelectorAttachment
    {
        ...
        internal WorkerSelectorAttachment(string kind, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
