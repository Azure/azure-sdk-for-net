...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class RoundRobinMode : DistributionMode
    {
        ...
        internal RoundRobinMode(int minConcurrentOffers, int maxConcurrentOffers, bool? bypassSelectors, DistributionModeKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(minConcurrentOffers, maxConcurrentOffers, bypassSelectors, kind, additionalBinaryDataProperties)
        {
        }
    }
}
