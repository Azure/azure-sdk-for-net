...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class RuleEngineWorkerSelectorAttachment : WorkerSelectorAttachment
    {
        ...
        internal RuleEngineWorkerSelectorAttachment(string kind, RouterRule rule, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Rule = rule;
