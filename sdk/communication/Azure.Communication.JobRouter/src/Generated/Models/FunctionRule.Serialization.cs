...
{
    public partial class FunctionRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FunctionRule DeserializeFunctionRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
