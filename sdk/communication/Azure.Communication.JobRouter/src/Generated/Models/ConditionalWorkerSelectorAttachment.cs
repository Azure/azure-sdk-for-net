...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class ConditionalWorkerSelectorAttachment : WorkerSelectorAttachment
    {
        ...
        internal ConditionalWorkerSelectorAttachment(string kind, RouterRule condition, IList<RouterWorkerSelector> workerSelectors, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Condition = condition;
