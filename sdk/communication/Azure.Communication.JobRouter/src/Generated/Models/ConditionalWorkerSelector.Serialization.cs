...
{
    public partial class ConditionalWorkerSelector : IUtf8JsonSerializable
    {
        ...
        internal static ConditionalWorkerSelector DeserializeConditionalWorkerSelector(JsonElement element)
        {
            ...
            return new ConditionalWorkerSelector(kind, condition, labelSelectors);
        }
    }
}
