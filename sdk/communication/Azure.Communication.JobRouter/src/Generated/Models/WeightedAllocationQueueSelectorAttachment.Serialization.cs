...
namespace Azure.Communication.JobRouter
{
    public partial class WeightedAllocationQueueSelectorAttachment : IUtf8JsonSerializable, IModelJsonSerializable<WeightedAllocationQueueSelectorAttachment>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<WeightedAllocationQueueSelectorAttachment>(this, options.Format);
            ...
            foreach (var item in Allocations)
            {
                ...
                {
                    ((IModelJsonSerializable<QueueWeightedAllocation>)item).Serialize(writer, options);
                }
            }
        ...
        internal static WeightedAllocationQueueSelectorAttachment DeserializeWeightedAllocationQueueSelectorAttachment(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new WeightedAllocationQueueSelectorAttachment(kind, allocations, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="WeightedAllocationQueueSelectorAttachment"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="WeightedAllocationQueueSelectorAttachment"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="WeightedAllocationQueueSelectorAttachment"/>. </summary>
