...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class WeightedAllocationQueueSelectorAttachment : QueueSelectorAttachment, IJsonModel<WeightedAllocationQueueSelectorAttachment>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<WeightedAllocationQueueSelectorAttachment>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<WeightedAllocationQueueSelectorAttachment>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        WeightedAllocationQueueSelectorAttachment IPersistableModel<WeightedAllocationQueueSelectorAttachment>.Create(BinaryData data, ModelReaderWriterOptions options) => (WeightedAllocationQueueSelectorAttachment)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WeightedAllocationQueueSelectorAttachment IJsonModel<WeightedAllocationQueueSelectorAttachment>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (WeightedAllocationQueueSelectorAttachment)JsonModelCreateCore(ref reader, options);
