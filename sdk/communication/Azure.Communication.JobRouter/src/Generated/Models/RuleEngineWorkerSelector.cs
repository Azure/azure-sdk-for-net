...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class RuleEngineWorkerSelector : WorkerSelectorAttachment
    {
        /// <summary> Initializes a new instance of RuleEngineWorkerSelector. </summary>
        /// <param name="rule">
        ...
        public RuleEngineWorkerSelector(RouterRule rule)
        {
            if (rule == null)
            {
        ...
        /// AzureFunctionRule: A rule providing a binding to an HTTP Triggered Azure Function.
        /// </param>
        internal RuleEngineWorkerSelector(string kind, RouterRule rule) : base(kind)
        {
            Rule = rule;
