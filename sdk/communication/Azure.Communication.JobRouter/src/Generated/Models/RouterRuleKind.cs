...
namespace Azure.Communication.JobRouter
{
    ...
    public readonly partial struct RouterRuleKind : IEquatable<global::Azure.Communication.JobRouter.RouterRuleKind>
    {
        ...
        /// <summary> Initializes a new instance of <see cref="global::Azure.Communication.JobRouter.RouterRuleKind"/>. </summary>
        ...
        /// <summary> Determines if two <see cref="global::Azure.Communication.JobRouter.RouterRuleKind"/> values are the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator ==(RouterRuleKind left, RouterRuleKind right) => left.Equals(right);

        /// <summary> Determines if two <see cref="global::Azure.Communication.JobRouter.RouterRuleKind"/> values are not the same. </summary>
        /// <param name="left"> The left value to compare. </param>
        /// <param name="right"> The right value to compare. </param>
        public static bool operator !=(RouterRuleKind left, RouterRuleKind right) => !left.Equals(right);

        /// <summary> Converts a string to a <see cref="global::Azure.Communication.JobRouter.RouterRuleKind"/>. </summary>
        /// <param name="value"> The value. </param>
        ...
        public override bool Equals(object obj) => ((obj is RouterRuleKind other) && this.Equals(other));

        /// <inheritdoc/>
        public bool Equals(RouterRuleKind other) => string.Equals(_value, other._value, global::System.StringComparison.InvariantCultureIgnoreCase);
