...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class PassThroughWorkerSelectorAttachment : WorkerSelectorAttachment
    {
        ...
        internal PassThroughWorkerSelectorAttachment(string kind, string key, LabelOperator labelOperator, double? expiresAfterSeconds, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Key = key;
            LabelOperator = labelOperator;
