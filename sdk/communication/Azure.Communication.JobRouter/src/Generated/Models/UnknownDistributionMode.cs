...
namespace Azure.Communication.JobRouter
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="global::Azure.Communication.JobRouter.UnknownDistributionMode"/>. </summary>
        ...
        internal UnknownDistributionMode(int minConcurrentOffers, int maxConcurrentOffers, bool? bypassSelectors, DistributionModeKind kind, IDictionary<string, global::System.BinaryData> additionalBinaryDataProperties) : base(minConcurrentOffers, maxConcurrentOffers, bypassSelectors, (kind != default) ? kind : "unknown", additionalBinaryDataProperties)
        {
        }
    }
}
