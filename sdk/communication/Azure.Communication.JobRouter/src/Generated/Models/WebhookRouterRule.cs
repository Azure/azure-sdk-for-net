...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class WebhookRouterRule : RouterRule
    {
        ...
        internal WebhookRouterRule(string kind, Uri authorizationServerUri, Oauth2ClientCredential clientCredential, Uri webhookUri, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
