...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class ReclassifyExceptionAction : ExceptionAction
    {
        ...
        internal ReclassifyExceptionAction(string kind, string classificationPolicyId, IDictionary<string, object> labelsToUpsert, Dictionary<string, BinaryData> rawData) : base(kind, rawData)
        {
