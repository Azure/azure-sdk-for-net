...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class ReclassifyExceptionAction : ExceptionAction
    {
        ...
        internal ReclassifyExceptionAction(string id, ExceptionActionKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, string classificationPolicyId, IDictionary<string, BinaryData> labelsToUpsert) : base(id, kind, additionalBinaryDataProperties)
        {
