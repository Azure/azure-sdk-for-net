...
namespace Azure.Communication.JobRouter.Models
{
    ...
    {
        internal static ExceptionPolicyCollection DeserializeExceptionPolicyCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
