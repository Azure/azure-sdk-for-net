...
namespace Azure.Communication.JobRouter
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownDistributionMode))]
    public abstract partial class DistributionMode
    {
        ...
        internal DistributionMode(string kind, int minConcurrentOffers, int maxConcurrentOffers, bool? bypassSelectors, Dictionary<string, BinaryData> rawData)
        {
            Kind = kind;
