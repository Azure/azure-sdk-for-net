...
namespace Azure.Communication.JobRouter.Models
{
    ...
    {
        internal static ClassificationPolicyItem DeserializeClassificationPolicyItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
