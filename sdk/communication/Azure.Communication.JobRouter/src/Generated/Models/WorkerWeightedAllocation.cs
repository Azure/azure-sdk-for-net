...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class WorkerWeightedAllocation
    {
        ...
        internal WorkerWeightedAllocation(double weight, IList<RouterWorkerSelector> workerSelectors, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Weight = weight;
