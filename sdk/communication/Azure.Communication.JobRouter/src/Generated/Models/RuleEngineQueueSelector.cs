...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class RuleEngineQueueSelector : QueueSelectorAttachment
    {
        /// <summary> Initializes a new instance of RuleEngineQueueSelector. </summary>
        /// <param name="rule">
        ...
        public RuleEngineQueueSelector(RouterRule rule)
        {
            if (rule == null)
            {
        ...
        /// AzureFunctionRule: A rule providing a binding to an HTTP Triggered Azure Function.
        /// </param>
        internal RuleEngineQueueSelector(string kind, RouterRule rule) : base(kind)
        {
            Rule = rule;
