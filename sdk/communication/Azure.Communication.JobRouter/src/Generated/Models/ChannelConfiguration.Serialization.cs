...
{
    public partial class ChannelConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ChannelConfiguration DeserializeChannelConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
