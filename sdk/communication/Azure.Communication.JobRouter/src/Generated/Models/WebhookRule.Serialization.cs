...
{
    public partial class WebhookRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static WebhookRule DeserializeWebhookRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
