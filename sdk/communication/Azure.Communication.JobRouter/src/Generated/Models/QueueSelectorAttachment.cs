...
namespace Azure.Communication.JobRouter
{
    ...
    /// </summary>
    [DeserializationProxy(typeof(UnknownQueueSelectorAttachment))]
    public abstract partial class QueueSelectorAttachment
    {
        ...
        internal QueueSelectorAttachment(string kind, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
