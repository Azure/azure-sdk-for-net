...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class WeightedAllocationWorkerSelectorAttachment : WorkerSelectorAttachment
    {
        ...
        internal WeightedAllocationWorkerSelectorAttachment(string kind, IList<WorkerWeightedAllocation> allocations, Dictionary<string, BinaryData> rawData) : base(kind, rawData)
        {
