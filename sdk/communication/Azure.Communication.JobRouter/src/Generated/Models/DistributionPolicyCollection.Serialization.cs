...
namespace Azure.Communication.JobRouter.Models
{
    ...
    {
        internal static DistributionPolicyCollection DeserializeDistributionPolicyCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
