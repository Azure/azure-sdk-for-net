...
{
    public partial class JobQueue : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static JobQueue DeserializeJobQueue(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
