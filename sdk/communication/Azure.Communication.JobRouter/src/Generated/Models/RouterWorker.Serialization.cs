...
{
    public partial class RouterWorker : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RouterWorker DeserializeRouterWorker(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
