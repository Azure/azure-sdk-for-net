...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class ConditionalQueueSelector : QueueSelectorAttachment
    {
        /// <summary> Initializes a new instance of ConditionalQueueSelector. </summary>
        ...
        public ConditionalQueueSelector(RouterRule condition, IEnumerable<QueueSelector> labelSelectors)
        {
            if (condition == null)
            {
        ...
        /// </param>
        /// <param name="labelSelectors"> The label selectors to attach. </param>
        internal ConditionalQueueSelector(string kind, RouterRule condition, IList<QueueSelector> labelSelectors) : base(kind)
        {
            Condition = condition;
