...
namespace Azure.Communication.JobRouter
{
    public partial class CancelExceptionAction : IUtf8JsonSerializable, IModelJsonSerializable<CancelExceptionAction>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CancelExceptionAction>(this, options.Format);
        ...
        internal static CancelExceptionAction DeserializeCancelExceptionAction(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CancelExceptionAction(kind, note.Value, dispositionCode.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="CancelExceptionAction"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CancelExceptionAction"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CancelExceptionAction"/>. </summary>
