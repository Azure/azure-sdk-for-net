...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class WaitTimeExceptionTrigger : ExceptionTrigger
    {
        ...
        internal WaitTimeExceptionTrigger(string kind, double thresholdSeconds, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
