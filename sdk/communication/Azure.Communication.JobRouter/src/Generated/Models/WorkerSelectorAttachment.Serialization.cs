...
{
    public partial class WorkerSelectorAttachment : IUtf8JsonSerializable, IModelJsonSerializable<WorkerSelectorAttachment>
    {
        ...
        internal static WorkerSelectorAttachment DeserializeWorkerSelectorAttachment(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new UnknownWorkerSelectorAttachment(kind, rawData);
        }
        ...
        /// <summary> Converts a <see cref="WorkerSelectorAttachment"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="WorkerSelectorAttachment"/> to convert. </param>
        public static implicit operator RequestContent(WorkerSelectorAttachment model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="WorkerSelectorAttachment"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator WorkerSelectorAttachment(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeWorkerSelectorAttachment(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
