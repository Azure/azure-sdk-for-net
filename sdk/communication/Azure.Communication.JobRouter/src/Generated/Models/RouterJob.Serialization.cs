...
{
    public partial class RouterJob : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RouterJob DeserializeRouterJob(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
