...
namespace Azure.Communication.JobRouter.Models
{
    ...
    public partial class WeightedAllocationLabelSelector : LabelSelectorAttachment
    {
        /// <summary> Initializes a new instance of WeightedAllocationLabelSelector. </summary>
        ...
        public WeightedAllocationLabelSelector(IEnumerable<WeightedAllocation> allocations)
        {
            if (allocations == null)
            {
        ...
        /// <param name="allocations"> A collection of percentage based weighted allocations. </param>
        internal WeightedAllocationLabelSelector(string kind, IList<WeightedAllocation> allocations) : base(kind)
        {
            Allocations = allocations;
            Kind = kind ?? "weighted-allocation";
        }

        /// <summary> A collection of percentage based weighted allocations. </summary>
        public IList<WeightedAllocation> Allocations { get; }
    }
}
