...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class PassThroughWorkerSelector : WorkerSelectorAttachment
    {
        /// <summary> Initializes a new instance of PassThroughWorkerSelector. </summary>
        ...
        public PassThroughWorkerSelector(string key, LabelOperator labelOperator)
        {
            if (key == null)
            {
        ...
        internal PassThroughWorkerSelector(string kind, string key, LabelOperator labelOperator, double? ttlSeconds) : base(kind)
        {
            Key = key;
            LabelOperator = labelOperator;
