...
{
    public partial class PassThroughWorkerSelector : IUtf8JsonSerializable
    {
        ...
        internal static PassThroughWorkerSelector DeserializePassThroughWorkerSelector(JsonElement element)
        {
            string key = default;
            ...
            return new PassThroughWorkerSelector(kind, key, labelOperator, Optional.ToNullable(ttlSeconds));
        }
    }
}
