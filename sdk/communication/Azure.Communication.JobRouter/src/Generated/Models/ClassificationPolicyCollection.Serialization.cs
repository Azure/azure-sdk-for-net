...
namespace Azure.Communication.JobRouter.Models
{
    ...
    {
        internal static ClassificationPolicyCollection DeserializeClassificationPolicyCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
