...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class ConditionalQueueSelectorAttachment : QueueSelectorAttachment
    {
        ...
        internal ConditionalQueueSelectorAttachment(string kind, RouterRule condition, IList<RouterQueueSelector> queueSelectors, Dictionary<string, BinaryData> rawData) : base(kind, rawData)
        {
            Condition = condition;
