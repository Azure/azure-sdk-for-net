...
namespace Azure.Communication.JobRouter.Models
{
    ...
    public partial class RouterWorkerAssignment
    {
        ...
        internal RouterWorkerAssignment(string assignmentId, string jobId, int capacityCost, DateTimeOffset assignedAt, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AssignmentId = assignmentId;
            JobId = jobId;
            CapacityCost = capacityCost;
