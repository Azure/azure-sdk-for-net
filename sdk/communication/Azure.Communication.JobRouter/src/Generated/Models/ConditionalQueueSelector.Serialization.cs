...
{
    public partial class ConditionalQueueSelector : IUtf8JsonSerializable
    {
        ...
        internal static ConditionalQueueSelector DeserializeConditionalQueueSelector(JsonElement element)
        {
            ...
            return new ConditionalQueueSelector(kind, condition, labelSelectors);
        }
    }
}
