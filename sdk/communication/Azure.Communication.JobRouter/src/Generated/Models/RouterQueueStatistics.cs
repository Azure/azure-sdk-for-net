...
namespace Azure.Communication.JobRouter.Models
{
    ...
    public partial class RouterQueueStatistics
    {
        ...
        internal RouterQueueStatistics(string queueId, int length, IReadOnlyDictionary<string, double> estimatedWaitTimeMinutes, double? longestJobWaitTimeMinutes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            QueueId = queueId;
            Length = length;
