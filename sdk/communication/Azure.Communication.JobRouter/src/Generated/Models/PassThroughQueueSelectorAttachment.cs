...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class PassThroughQueueSelectorAttachment : QueueSelectorAttachment
    {
        ...
        internal PassThroughQueueSelectorAttachment(QueueSelectorAttachmentKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, string key, LabelOperator labelOperator) : base(kind, additionalBinaryDataProperties)
        {
            Key = key;
