...
namespace Azure.Communication.JobRouter.Models
{
    ...
    public partial class RouterJobOffer
    {
        ...
        internal RouterJobOffer(string offerId, string jobId, int capacityCost, DateTimeOffset? offeredAt, DateTimeOffset? expiresAt, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OfferId = offerId;
            JobId = jobId;
            CapacityCost = capacityCost;
