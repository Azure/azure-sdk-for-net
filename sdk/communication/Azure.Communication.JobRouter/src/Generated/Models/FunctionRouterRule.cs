...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class FunctionRouterRule : RouterRule
    {
        ...
        internal FunctionRouterRule(string kind, Uri functionUri, FunctionRouterRuleCredential credential, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
