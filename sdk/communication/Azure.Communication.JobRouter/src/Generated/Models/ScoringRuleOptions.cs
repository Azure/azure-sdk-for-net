...
namespace Azure.Communication.JobRouter.Models
{
    ...
    public partial class ScoringRuleOptions
    {
        ...
        internal ScoringRuleOptions(int? batchSize, IList<ScoringRuleParameterSelector> scoringParameters, bool? allowScoringBatchOfWorkers, bool? descendingOrder, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            BatchSize = batchSize;
