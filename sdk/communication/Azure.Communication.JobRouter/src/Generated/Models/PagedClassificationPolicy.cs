...
{
    /// <summary> A classification policy returned from a pageable list. </summary>
    public partial class PagedClassificationPolicy
    {
        ...
        internal PagedClassificationPolicy(string id, string name, string fallbackQueueId, IReadOnlyList<QueueSelectorAttachment> queueSelectors, RouterRule prioritizationRule, IReadOnlyList<WorkerSelectorAttachment> workerSelectors)
        {
            Id = id;
            Name = name;
        ...
        public IReadOnlyList<QueueSelectorAttachment> QueueSelectors { get; }
        /// <summary>
        /// A rule of one of the following types:
        ///             
        /// StaticRule:  A rule providing static rules that always return the same result, regardless of input.
        ...
        public IReadOnlyList<WorkerSelectorAttachment> WorkerSelectors { get; }
    }
}
