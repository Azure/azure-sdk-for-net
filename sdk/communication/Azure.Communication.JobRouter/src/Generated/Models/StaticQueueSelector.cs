...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class StaticQueueSelector : QueueSelectorAttachment
    {
        /// <summary> Initializes a new instance of StaticQueueSelector. </summary>
        ...
        public StaticQueueSelector(QueueSelector labelSelector)
        {
        ...
        /// <param name="labelSelector"> Describes a condition that must be met against a set of labels for queue selection. </param>
        internal StaticQueueSelector(string kind, QueueSelector labelSelector) : base(kind)
        {
            LabelSelector = labelSelector;
            Kind = kind ?? "static";
        }
