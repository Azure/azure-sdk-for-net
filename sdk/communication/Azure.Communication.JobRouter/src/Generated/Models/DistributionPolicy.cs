...
namespace Azure.Communication.JobRouter.Models
{
    ...
    public partial class DistributionPolicy
    {
        ...
        internal DistributionPolicy(string id, string name, double? offerExpiresAfterSeconds, DistributionMode mode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
