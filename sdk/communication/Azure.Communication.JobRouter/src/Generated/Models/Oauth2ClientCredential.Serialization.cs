...
namespace Azure.Communication.JobRouter
{
    public partial class Oauth2ClientCredential : IUtf8JsonSerializable, IModelJsonSerializable<Oauth2ClientCredential>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<Oauth2ClientCredential>(this, options.Format);
        ...
        internal static Oauth2ClientCredential DeserializeOauth2ClientCredential(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new Oauth2ClientCredential(clientId.Value, clientSecret.Value, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="Oauth2ClientCredential"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="Oauth2ClientCredential"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="Oauth2ClientCredential"/>. </summary>
