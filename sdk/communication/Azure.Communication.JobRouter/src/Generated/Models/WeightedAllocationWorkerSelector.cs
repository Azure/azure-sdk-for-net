...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class WeightedAllocationWorkerSelector : WorkerSelectorAttachment
    {
        /// <summary> Initializes a new instance of WeightedAllocationWorkerSelector. </summary>
        ...
        public WeightedAllocationWorkerSelector(IEnumerable<WorkerWeightedAllocation> allocations)
        {
            if (allocations == null)
            {
        ...
        /// <param name="allocations"> A collection of percentage based weighted allocations. </param>
        internal WeightedAllocationWorkerSelector(string kind, IList<WorkerWeightedAllocation> allocations) : base(kind)
        {
