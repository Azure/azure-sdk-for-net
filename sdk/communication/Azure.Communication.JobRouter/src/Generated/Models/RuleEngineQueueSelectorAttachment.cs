...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class RuleEngineQueueSelectorAttachment : QueueSelectorAttachment
    {
        ...
        internal RuleEngineQueueSelectorAttachment(string kind, RouterRule rule, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Rule = rule;
