...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class ExpressionRouterRule : RouterRule
    {
        ...
        internal ExpressionRouterRule(string kind, string language, string expression, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Language = language;
