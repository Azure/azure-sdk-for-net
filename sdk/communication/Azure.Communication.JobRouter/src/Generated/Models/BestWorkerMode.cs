...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class BestWorkerMode : DistributionMode
    {
        ...
        internal BestWorkerMode(string kind, int minConcurrentOffers, int maxConcurrentOffers, bool? bypassSelectors, RouterRule scoringRule, ScoringRuleOptions scoringRuleOptions, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, minConcurrentOffers, maxConcurrentOffers, bypassSelectors, serializedAdditionalRawData)
        {
