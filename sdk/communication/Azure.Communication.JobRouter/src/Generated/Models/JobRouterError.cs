...
namespace Azure.Communication.JobRouter.Models
{
    ...
    public partial class JobRouterError
    {
        ...
        internal JobRouterError(string code, string message)
        {
            ...
            Code = code;
            Message = message;
            Details = new ChangeTrackingList<JobRouterError>();
        }
        ...
        internal JobRouterError(string code, string message, string target, IReadOnlyList<JobRouterError> details, JobRouterError innerError)
        {
            Code = code;
            Message = message;
            Target = target;
        ...
        public IReadOnlyList<JobRouterError> Details { get; }
        /// <summary> The inner error if any. </summary>
        public JobRouterError InnerError { get; }
    }
}
