...
namespace Azure.Communication.JobRouter
{
    public partial class PassThroughQueueSelectorAttachment : IUtf8JsonSerializable, IJsonModel<PassThroughQueueSelectorAttachment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PassThroughQueueSelectorAttachment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new PassThroughQueueSelectorAttachment FromResponse(Response response)
        {
            ...
            return DeserializePassThroughQueueSelectorAttachment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
