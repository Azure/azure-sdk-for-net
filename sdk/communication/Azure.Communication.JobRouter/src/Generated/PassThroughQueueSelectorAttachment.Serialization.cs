...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PassThroughQueueSelectorAttachment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PassThroughQueueSelectorAttachment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PassThroughQueueSelectorAttachment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PassThroughQueueSelectorAttachment>)} interface");
            }
        ...
        string IPersistableModel<PassThroughQueueSelectorAttachment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static new PassThroughQueueSelectorAttachment FromResponse(Response response)
        {
            ...
            return DeserializePassThroughQueueSelectorAttachment(document.RootElement, ModelReaderWriterOptions.Wire);
        }
