...
{
    public partial class PassThroughQueueSelectorAttachment : IUtf8JsonWriteable, IJsonModel<PassThroughQueueSelectorAttachment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<PassThroughQueueSelectorAttachment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new PassThroughQueueSelectorAttachment FromResponse(PipelineResponse response)
        {
