...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class PassThroughQueueSelectorAttachment : QueueSelectorAttachment
    {
        ...
        internal PassThroughQueueSelectorAttachment(string kind, IDictionary<string, BinaryData> serializedAdditionalRawData, string key, LabelOperator labelOperator) : base(kind, serializedAdditionalRawData)
        {
            Key = key;
