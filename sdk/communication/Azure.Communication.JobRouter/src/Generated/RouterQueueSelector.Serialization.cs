...
{
    public partial class RouterQueueSelector : IUtf8JsonWriteable, IJsonModel<RouterQueueSelector>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouterQueueSelector>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RouterQueueSelector FromResponse(PipelineResponse response)
        {
