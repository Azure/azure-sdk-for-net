...
namespace Azure.Communication.JobRouter
{
    public partial class CancelExceptionAction : IUtf8JsonSerializable, IJsonModel<CancelExceptionAction>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CancelExceptionAction>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new CancelExceptionAction FromResponse(Response response)
        {
            ...
            return DeserializeCancelExceptionAction(document.RootElement, new ModelReaderWriterOptions("W"));
        }
