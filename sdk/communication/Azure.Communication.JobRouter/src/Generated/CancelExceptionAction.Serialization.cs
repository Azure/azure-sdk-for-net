...
{
    public partial class CancelExceptionAction : IUtf8JsonWriteable, IJsonModel<CancelExceptionAction>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<CancelExceptionAction>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CancelExceptionAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CancelExceptionAction)} does not support '{format}' format.");
            }
        ...
        internal static new CancelExceptionAction FromResponse(PipelineResponse response)
        {
