...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManualReclassifyExceptionAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManualReclassifyExceptionAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManualReclassifyExceptionAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManualReclassifyExceptionAction>)} interface");
            }
        ...
        string IPersistableModel<ManualReclassifyExceptionAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static new ManualReclassifyExceptionAction FromResponse(Response response)
        {
            ...
            return DeserializeManualReclassifyExceptionAction(document.RootElement, ModelReaderWriterOptions.Wire);
        }
