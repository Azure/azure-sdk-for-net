...
namespace Azure.Communication.JobRouter
{
    public partial class ManualReclassifyExceptionAction : IUtf8JsonSerializable, IJsonModel<ManualReclassifyExceptionAction>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManualReclassifyExceptionAction>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new ManualReclassifyExceptionAction FromResponse(Response response)
        {
            ...
            return DeserializeManualReclassifyExceptionAction(document.RootElement, new ModelReaderWriterOptions("W"));
        }
