...
{
    public partial class UnassignJobResult : IUtf8JsonWriteable, IJsonModel<UnassignJobResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnassignJobResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static UnassignJobResult FromResponse(PipelineResponse response)
        {
