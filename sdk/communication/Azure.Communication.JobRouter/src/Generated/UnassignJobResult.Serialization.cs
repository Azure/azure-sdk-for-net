...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnassignJobResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UnassignJobResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UnassignJobResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UnassignJobResult>)} interface");
            }
        ...
        string IPersistableModel<UnassignJobResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static UnassignJobResult FromResponse(Response response)
        {
            ...
            return DeserializeUnassignJobResult(document.RootElement, ModelReaderWriterOptions.Wire);
        }
