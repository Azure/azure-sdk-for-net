...
namespace Azure.Communication.JobRouter
{
    public partial class UnassignJobResult : IUtf8JsonSerializable, IJsonModel<UnassignJobResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<UnassignJobResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static UnassignJobResult FromResponse(Response response)
        {
            ...
            return DeserializeUnassignJobResult(document.RootElement, new ModelReaderWriterOptions("W"));
        }
