...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnassignJobResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        UnassignJobResult IJsonModel<UnassignJobResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UnassignJobResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UnassignJobResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UnassignJobResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        UnassignJobResult IPersistableModel<UnassignJobResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UnassignJobResult)} does not support reading '{options.Format}' format.");
            }
        }
