...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class JobMatchingMode : IUtf8JsonSerializable, IJsonModel<JobMatchingMode>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<JobMatchingMode>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static JobMatchingMode FromResponse(Response response)
        {
            ...
            return DeserializeJobMatchingMode(document.RootElement, new ModelReaderWriterOptions("W"));
        }
