...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticRouterRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StaticRouterRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticRouterRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StaticRouterRule>)} interface");
            }
        ...
        string IPersistableModel<StaticRouterRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static new StaticRouterRule FromResponse(Response response)
        {
            ...
            return DeserializeStaticRouterRule(document.RootElement, ModelReaderWriterOptions.Wire);
        }
