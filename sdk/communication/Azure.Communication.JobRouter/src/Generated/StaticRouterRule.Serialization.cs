...
{
    public partial class StaticRouterRule : IUtf8JsonWriteable, IJsonModel<StaticRouterRule>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticRouterRule>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<StaticRouterRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StaticRouterRule)} does not support '{format}' format.");
            }
        ...
        internal static new StaticRouterRule FromResponse(PipelineResponse response)
        {
