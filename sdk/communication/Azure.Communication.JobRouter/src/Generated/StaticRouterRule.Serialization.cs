...
namespace Azure.Communication.JobRouter
{
    public partial class StaticRouterRule : IUtf8JsonSerializable, IJsonModel<StaticRouterRule>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticRouterRule>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new StaticRouterRule FromResponse(Response response)
        {
            ...
            return DeserializeStaticRouterRule(document.RootElement, new ModelReaderWriterOptions("W"));
        }
