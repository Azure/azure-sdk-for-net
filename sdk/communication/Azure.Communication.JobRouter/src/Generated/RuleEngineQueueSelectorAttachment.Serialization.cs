...
{
    public partial class RuleEngineQueueSelectorAttachment : IUtf8JsonWriteable, IJsonModel<RuleEngineQueueSelectorAttachment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RuleEngineQueueSelectorAttachment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new RuleEngineQueueSelectorAttachment FromResponse(PipelineResponse response)
        {
