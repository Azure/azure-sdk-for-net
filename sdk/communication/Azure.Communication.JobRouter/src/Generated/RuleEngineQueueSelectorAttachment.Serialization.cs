...
namespace Azure.Communication.JobRouter
{
    public partial class RuleEngineQueueSelectorAttachment : IUtf8JsonSerializable, IJsonModel<RuleEngineQueueSelectorAttachment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RuleEngineQueueSelectorAttachment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new RuleEngineQueueSelectorAttachment FromResponse(Response response)
        {
            ...
            return DeserializeRuleEngineQueueSelectorAttachment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
