...
{
    public partial class ConditionalQueueSelectorAttachment : IUtf8JsonWriteable, IJsonModel<ConditionalQueueSelectorAttachment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConditionalQueueSelectorAttachment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new ConditionalQueueSelectorAttachment FromResponse(PipelineResponse response)
        {
