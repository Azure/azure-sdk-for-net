...
{
    public partial class ReclassifyExceptionAction : IUtf8JsonWriteable, IJsonModel<ReclassifyExceptionAction>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReclassifyExceptionAction>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ReclassifyExceptionAction DeserializeReclassifyExceptionAction(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ReclassifyExceptionAction(id, kind, serializedAdditionalRawData, classificationPolicyId, labelsToUpsert ?? new OptionalDictionary<string, BinaryData>());
        }
        ...
        internal static new ReclassifyExceptionAction FromResponse(PipelineResponse response)
        {
