...
namespace Azure.Communication.JobRouter
{
    public partial class RouterWorkerSelector : IUtf8JsonSerializable, IJsonModel<RouterWorkerSelector>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RouterWorkerSelector>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static RouterWorkerSelector FromResponse(Response response)
        {
            ...
            return DeserializeRouterWorkerSelector(document.RootElement, new ModelReaderWriterOptions("W"));
        }
