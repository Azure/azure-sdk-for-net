...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouterQueueStatistics>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RouterQueueStatistics>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RouterQueueStatistics>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RouterQueueStatistics>)} interface");
            }
        ...
        string IPersistableModel<RouterQueueStatistics>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static RouterQueueStatistics FromResponse(Response response)
        {
            ...
            return DeserializeRouterQueueStatistics(document.RootElement, ModelReaderWriterOptions.Wire);
        }
