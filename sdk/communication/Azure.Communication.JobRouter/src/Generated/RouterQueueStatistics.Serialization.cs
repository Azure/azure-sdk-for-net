...
namespace Azure.Communication.JobRouter
{
    public partial class RouterQueueStatistics : IUtf8JsonSerializable, IJsonModel<RouterQueueStatistics>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RouterQueueStatistics>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static RouterQueueStatistics FromResponse(Response response)
        {
            ...
            return DeserializeRouterQueueStatistics(document.RootElement, new ModelReaderWriterOptions("W"));
        }
