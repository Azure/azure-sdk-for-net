...
{
    public partial class RouterQueueStatistics : IUtf8JsonWriteable, IJsonModel<RouterQueueStatistics>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<RouterQueueStatistics>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static RouterQueueStatistics DeserializeRouterQueueStatistics(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new RouterQueueStatistics(queueId, length, estimatedWaitTimeMinutes ?? new OptionalDictionary<int, TimeSpan>(), longestJobWaitTimeMinutes, serializedAdditionalRawData);
        }
        ...
        internal static RouterQueueStatistics FromResponse(PipelineResponse response)
        {
