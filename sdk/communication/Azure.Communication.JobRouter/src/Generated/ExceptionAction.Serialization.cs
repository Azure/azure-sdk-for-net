...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class ExceptionAction : IUtf8JsonSerializable, IJsonModel<ExceptionAction>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ExceptionAction>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ExceptionAction FromResponse(Response response)
        {
            ...
            return DeserializeExceptionAction(document.RootElement, new ModelReaderWriterOptions("W"));
        }
