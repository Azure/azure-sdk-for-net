...
namespace Azure.Communication.JobRouter
{
    public partial class LongestIdleMode : IUtf8JsonSerializable, IJsonModel<LongestIdleMode>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LongestIdleMode>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new LongestIdleMode FromResponse(Response response)
        {
            ...
            return DeserializeLongestIdleMode(document.RootElement, new ModelReaderWriterOptions("W"));
        }
