...
{
    public partial class LongestIdleMode : IUtf8JsonWriteable, IJsonModel<LongestIdleMode>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<LongestIdleMode>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new LongestIdleMode FromResponse(PipelineResponse response)
        {
