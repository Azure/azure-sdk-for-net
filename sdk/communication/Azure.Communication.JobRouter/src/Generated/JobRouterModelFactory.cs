...
namespace Azure.Communication.JobRouter
{
    ...
    public static partial class JobRouterModelFactory
    {
        ...
        {
            return new ExpressionRouterRule("expression-rule", new Dictionary<string, BinaryData>(), language, expression);
        }
        ...
        {
            return new FunctionRouterRule("azure-function-rule", new Dictionary<string, BinaryData>(), functionUri, credential);
        }
        ...
        {
            return new WebhookRouterRule("webhook-rule", new Dictionary<string, BinaryData>(), authorizationServerUri, clientCredential, webhookUri);
        }
        ...
        public static ConditionalQueueSelectorAttachment ConditionalQueueSelectorAttachment(RouterRule condition = null, IEnumerable<RouterQueueSelector> queueSelectors = null)
        {
            ...
            return new ConditionalQueueSelectorAttachment("conditional", new Dictionary<string, BinaryData>(), condition, queueSelectors?.ToList());
        }
        ...
        {
            return new PassThroughQueueSelectorAttachment("pass-through", new Dictionary<string, BinaryData>(), key, labelOperator);
        }
        ...
        {
            return new RuleEngineQueueSelectorAttachment("rule-engine", new Dictionary<string, BinaryData>(), rule);
        }
        ...
        {
            return new StaticQueueSelectorAttachment("static", new Dictionary<string, BinaryData>(), queueSelector);
        }
        ...
        public static WeightedAllocationQueueSelectorAttachment WeightedAllocationQueueSelectorAttachment(IEnumerable<QueueWeightedAllocation> allocations = null)
        {
            ...
            return new WeightedAllocationQueueSelectorAttachment("weighted-allocation-queue-selector", new Dictionary<string, BinaryData>(), allocations?.ToList());
        }
        ...
        public static QueueWeightedAllocation QueueWeightedAllocation(double weight = default, IEnumerable<RouterQueueSelector> queueSelectors = null)
        {
            ...
            return new QueueWeightedAllocation(weight, queueSelectors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ConditionalWorkerSelectorAttachment ConditionalWorkerSelectorAttachment(RouterRule condition = null, IEnumerable<RouterWorkerSelector> workerSelectors = null)
        {
            ...
            return new ConditionalWorkerSelectorAttachment("conditional", new Dictionary<string, BinaryData>(), condition, workerSelectors?.ToList());
        }
        ...
        {
            return new RuleEngineWorkerSelectorAttachment("rule-engine", new Dictionary<string, BinaryData>(), rule);
        }
        ...
        {
            return new StaticWorkerSelectorAttachment("static", new Dictionary<string, BinaryData>(), workerSelector);
        }
        ...
        public static WeightedAllocationWorkerSelectorAttachment WeightedAllocationWorkerSelectorAttachment(IEnumerable<WorkerWeightedAllocation> allocations = null)
        {
            ...
            return new WeightedAllocationWorkerSelectorAttachment("weighted-allocation-worker-selector", new Dictionary<string, BinaryData>(), allocations?.ToList());
        }
        ...
        public static WorkerWeightedAllocation WorkerWeightedAllocation(double weight = default, IEnumerable<RouterWorkerSelector> workerSelectors = null)
        {
            ...
            return new WorkerWeightedAllocation(weight, workerSelectors?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ExceptionRule ExceptionRule(string id = null, ExceptionTrigger trigger = null, IEnumerable<ExceptionAction> actions = null)
        {
            ...
            return new ExceptionRule(id, trigger, actions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new QueueLengthExceptionTrigger("queue-length", new Dictionary<string, BinaryData>(), threshold);
        }
        ...
        {
            return new UnknownExceptionAction(id, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CancelExceptionAction(id, "cancel", new Dictionary<string, BinaryData>(), note, dispositionCode);
        }
        ...
        public static ManualReclassifyExceptionAction ManualReclassifyExceptionAction(string id = null, string queueId = null, int? priority = null, IEnumerable<RouterWorkerSelector> workerSelectors = null)
        {
            ...
            return new ManualReclassifyExceptionAction(id, "manual-reclassify", new Dictionary<string, BinaryData>(), queueId, priority, workerSelectors?.ToList());
        }
        ...
        {
            return new RouterJobAssignment(assignmentId, workerId, assignedAt, completedAt, closedAt, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouterJobNote(message, addedAt, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ScheduleAndSuspendMode("schedule-and-suspend", new Dictionary<string, BinaryData>(), scheduleAt);
        }

        /// <summary> Initializes a new instance of <see cref="JobRouter.CompleteJobOptions"/>. </summary>
        ...
        public static CompleteJobOptions CompleteJobOptions(string assignmentId = null, string note = null)
        {
            return new CompleteJobOptions(assignmentId, note, new Dictionary<string, BinaryData>());
        }

        /// <summary> Initializes a new instance of <see cref="JobRouter.CloseJobOptions"/>. </summary>
        ...
        public static CloseJobOptions CloseJobOptions(string assignmentId = null, string dispositionCode = null, DateTimeOffset closeAt = default, string note = null)
        {
            return new CloseJobOptions(assignmentId, dispositionCode, closeAt, note, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnassignJobResult(jobId, unassignmentCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AcceptJobOfferResult(assignmentId, jobId, workerId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouterChannel(channelId, capacityCostPerJob, maxNumberOfJobs, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouterJobOffer(offerId, jobId, capacityCost, offeredAt, expiresAt, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RouterWorkerAssignment(assignmentId, jobId, capacityCost, assignedAt, new Dictionary<string, BinaryData>());
        }
    }
}
