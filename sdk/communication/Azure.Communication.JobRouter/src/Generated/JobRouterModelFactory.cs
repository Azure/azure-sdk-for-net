...
namespace Azure.Communication.JobRouter
{
    ...
    public static partial class JobRouterModelFactory
    {
        ...
        {
            return new ExpressionRouterRule(RouterRuleKind.Expression, new Dictionary<string, BinaryData>(), language, expression);
        }
        ...
        {
            return new FunctionRouterRule(RouterRuleKind.Function, new Dictionary<string, BinaryData>(), functionUri, credential);
        }
        ...
        {
            return new WebhookRouterRule(RouterRuleKind.Webhook, new Dictionary<string, BinaryData>(), authorizationServerUri, clientCredential, webhookUri);
        }
        ...
        public static ConditionalQueueSelectorAttachment ConditionalQueueSelectorAttachment(RouterRule condition = null, IEnumerable<RouterQueueSelector> queueSelectors = null)
        {
            ...
            return new ConditionalQueueSelectorAttachment(QueueSelectorAttachmentKind.Conditional, new Dictionary<string, BinaryData>(), condition, queueSelectors?.ToList());
        }
        ...
        {
            return new PassThroughQueueSelectorAttachment(QueueSelectorAttachmentKind.PassThrough, new Dictionary<string, BinaryData>(), key, labelOperator);
        }
        ...
        {
            return new RuleEngineQueueSelectorAttachment(QueueSelectorAttachmentKind.RuleEngine, new Dictionary<string, BinaryData>(), rule);
        }
        ...
        {
            return new StaticQueueSelectorAttachment(QueueSelectorAttachmentKind.Static, new Dictionary<string, BinaryData>(), queueSelector);
        }
        ...
        public static WeightedAllocationQueueSelectorAttachment WeightedAllocationQueueSelectorAttachment(IEnumerable<QueueWeightedAllocation> allocations = null)
        {
            ...
            return new WeightedAllocationQueueSelectorAttachment(QueueSelectorAttachmentKind.WeightedAllocation, new Dictionary<string, BinaryData>(), allocations?.ToList());
        }
        ...
        public static ConditionalWorkerSelectorAttachment ConditionalWorkerSelectorAttachment(RouterRule condition = null, IEnumerable<RouterWorkerSelector> workerSelectors = null)
        {
            ...
            return new ConditionalWorkerSelectorAttachment(WorkerSelectorAttachmentKind.Conditional, new Dictionary<string, BinaryData>(), condition, workerSelectors?.ToList());
        }
        ...
        {
            return new RuleEngineWorkerSelectorAttachment(WorkerSelectorAttachmentKind.RuleEngine, new Dictionary<string, BinaryData>(), rule);
        }
        ...
        {
            return new StaticWorkerSelectorAttachment(WorkerSelectorAttachmentKind.Static, new Dictionary<string, BinaryData>(), workerSelector);
        }
        ...
        public static WeightedAllocationWorkerSelectorAttachment WeightedAllocationWorkerSelectorAttachment(IEnumerable<WorkerWeightedAllocation> allocations = null)
        {
            ...
            return new WeightedAllocationWorkerSelectorAttachment(WorkerSelectorAttachmentKind.WeightedAllocation, new Dictionary<string, BinaryData>(), allocations?.ToList());
        }
        ...
        {
            return new QueueLengthExceptionTrigger(ExceptionTriggerKind.QueueLength, new Dictionary<string, BinaryData>(), threshold);
        }
        ...
        {
            return new CancelExceptionAction(id, ExceptionActionKind.Cancel, new Dictionary<string, BinaryData>(), note, dispositionCode);
        }
        ...
        public static ManualReclassifyExceptionAction ManualReclassifyExceptionAction(string id = null, string queueId = null, int? priority = null, IEnumerable<RouterWorkerSelector> workerSelectors = null)
        {
            ...
            return new ManualReclassifyExceptionAction(id, ExceptionActionKind.ManualReclassify, new Dictionary<string, BinaryData>(), queueId, priority, workerSelectors?.ToList());
        }
        ...
        {
            return new ScheduleAndSuspendMode(JobMatchingModeKind.ScheduleAndSuspend, new Dictionary<string, BinaryData>(), scheduleAt);
        }
