...
{
    public partial class StaticQueueSelectorAttachment : IUtf8JsonWriteable, IJsonModel<StaticQueueSelectorAttachment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<StaticQueueSelectorAttachment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new StaticQueueSelectorAttachment FromResponse(PipelineResponse response)
        {
