...
namespace Azure.Communication.JobRouter
{
    public partial class StaticQueueSelectorAttachment : IUtf8JsonSerializable, IJsonModel<StaticQueueSelectorAttachment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<StaticQueueSelectorAttachment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new StaticQueueSelectorAttachment FromResponse(Response response)
        {
            ...
            return DeserializeStaticQueueSelectorAttachment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
