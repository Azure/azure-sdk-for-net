...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class DistributionMode : IUtf8JsonWriteable, IJsonModel<DistributionMode>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DistributionMode>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DistributionMode FromResponse(PipelineResponse response)
        {
