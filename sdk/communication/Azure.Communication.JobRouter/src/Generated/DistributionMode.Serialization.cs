...
namespace Azure.Communication.JobRouter
{
    ...
    public partial class DistributionMode : IUtf8JsonSerializable, IJsonModel<DistributionMode>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DistributionMode>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static DistributionMode FromResponse(Response response)
        {
            ...
            return DeserializeDistributionMode(document.RootElement, new ModelReaderWriterOptions("W"));
        }
