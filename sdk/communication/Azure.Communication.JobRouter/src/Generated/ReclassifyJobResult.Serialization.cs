...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReclassifyJobResult>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<ReclassifyJobResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReclassifyJobResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ReclassifyJobResult FromResponse(Response response)
        {
            ...
            return DeserializeReclassifyJobResult(document.RootElement, new ModelReaderWriterOptions("W"));
        }
