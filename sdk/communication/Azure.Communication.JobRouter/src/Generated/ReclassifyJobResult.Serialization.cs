...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReclassifyJobResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReclassifyJobResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReclassifyJobResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReclassifyJobResult>)} interface");
            }
        ...
        string IPersistableModel<ReclassifyJobResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ReclassifyJobResult FromResponse(Response response)
        {
            ...
            return DeserializeReclassifyJobResult(document.RootElement, ModelReaderWriterOptions.Wire);
        }
