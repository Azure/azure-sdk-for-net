...
{
    internal partial class ReclassifyJobResult : IUtf8JsonWriteable, IJsonModel<ReclassifyJobResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReclassifyJobResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ReclassifyJobResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ReclassifyJobResult)} does not support '{format}' format.");
            }
        ...
        internal static ReclassifyJobResult FromResponse(PipelineResponse response)
        {
