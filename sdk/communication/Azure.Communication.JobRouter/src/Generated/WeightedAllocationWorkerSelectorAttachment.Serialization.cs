...
{
    public partial class WeightedAllocationWorkerSelectorAttachment : IUtf8JsonWriteable, IJsonModel<WeightedAllocationWorkerSelectorAttachment>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<WeightedAllocationWorkerSelectorAttachment>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<WeightedAllocationWorkerSelectorAttachment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WeightedAllocationWorkerSelectorAttachment)} does not support '{format}' format.");
            }
        ...
        internal static new WeightedAllocationWorkerSelectorAttachment FromResponse(PipelineResponse response)
        {
