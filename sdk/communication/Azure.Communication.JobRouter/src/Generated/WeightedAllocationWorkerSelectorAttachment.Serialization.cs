...
namespace Azure.Communication.JobRouter
{
    public partial class WeightedAllocationWorkerSelectorAttachment : IUtf8JsonSerializable, IJsonModel<WeightedAllocationWorkerSelectorAttachment>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<WeightedAllocationWorkerSelectorAttachment>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static new WeightedAllocationWorkerSelectorAttachment FromResponse(Response response)
        {
            ...
            return DeserializeWeightedAllocationWorkerSelectorAttachment(document.RootElement, new ModelReaderWriterOptions("W"));
        }
