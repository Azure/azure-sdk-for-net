...
namespace Azure.Communication.JobRouter
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReclassifyJobOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReclassifyJobOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReclassifyJobOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ReclassifyJobOptions>)} interface");
            }
        ...
        string IPersistableModel<ReclassifyJobOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
        ...
        internal static ReclassifyJobOptions FromResponse(Response response)
        {
            ...
            return DeserializeReclassifyJobOptions(document.RootElement, ModelReaderWriterOptions.Wire);
        }
