...
{
    internal partial class ReclassifyJobOptions : IUtf8JsonWriteable, IJsonModel<ReclassifyJobOptions>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReclassifyJobOptions>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ReclassifyJobOptions FromResponse(PipelineResponse response)
        {
