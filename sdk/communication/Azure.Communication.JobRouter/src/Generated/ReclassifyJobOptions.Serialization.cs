...
namespace Azure.Communication.JobRouter
{
    internal partial class ReclassifyJobOptions : IUtf8JsonSerializable, IJsonModel<ReclassifyJobOptions>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ReclassifyJobOptions>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
        ...
        internal static ReclassifyJobOptions FromResponse(Response response)
        {
            ...
            return DeserializeReclassifyJobOptions(document.RootElement, new ModelReaderWriterOptions("W"));
        }
