...
namespace Azure.Communication.Sms
{
    ...
    public partial class SmsSendResult
    {
        ...
        internal SmsSendResult(string to, string messageId, int httpStatusCode, SmsSendResponseItemRepeatabilityResult? repeatabilityResult, bool successful, string errorMessage, Dictionary<string, BinaryData> rawData)
        {
            To = to;
            MessageId = messageId;
            HttpStatusCode = httpStatusCode;
