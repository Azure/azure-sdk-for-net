...
namespace Azure.Communication.Sms.Models
{
    ...
    internal partial class SendMessageRequest
    {
        ...
        internal SendMessageRequest(string @from, IList<SmsRecipient> smsRecipients, string message, SmsSendOptions smsSendOptions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            From = @from;
