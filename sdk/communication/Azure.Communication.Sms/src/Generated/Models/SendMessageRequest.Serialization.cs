...
namespace Azure.Communication.Sms.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SendMessageRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SendMessageRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SendMessageRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SendMessageRequest>)} interface");
            }
        ...
        string IPersistableModel<SendMessageRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
