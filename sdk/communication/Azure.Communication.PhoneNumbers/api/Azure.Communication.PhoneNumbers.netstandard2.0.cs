...
namespace Azure.Communication.PhoneNumbers.Models
{
    ...
    {
        public PhoneNumberSearchOptions(string areaCode = null, int? quantity = default(int?)) { }
