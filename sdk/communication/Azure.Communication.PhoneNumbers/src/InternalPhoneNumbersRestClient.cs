...
namespace Azure.Communication.PhoneNumbers
{
    ...
    [CodeGenSuppress("ListAvailableLocalitiesAsync", typeof(string), typeof(int?), typeof(int?), typeof(string), typeof(string), typeof(CancellationToken))]
    [CodeGenSuppress("ListAvailableLocalities", typeof(string), typeof(int?), typeof(int?), typeof(string), typeof(string), typeof(CancellationToken))]
    ...
    [CodeGenSuppress("ListAvailableLocalitiesNextPageAsync", typeof(string), typeof(string), typeof(int?), typeof(int?), typeof(string), typeof(string), typeof(CancellationToken))]
    [CodeGenSuppress("ListAvailableLocalitiesNextPage", typeof(string), typeof(string), typeof(int?), typeof(int?), typeof(string), typeof(string), typeof(CancellationToken))]
