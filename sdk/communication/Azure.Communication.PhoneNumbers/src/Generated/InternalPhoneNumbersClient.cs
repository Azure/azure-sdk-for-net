...
namespace Azure.Communication.PhoneNumbers
{
    ...
    internal partial class InternalPhoneNumbersClient
    {
        ...
        internal InternalPhoneNumbersClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, string apiVersion = "2025-04-01")
        {
        ...
        public virtual async Task<InternalPhoneNumbersStartReservationPurchaseOperation> StartStartReservationPurchaseAsync(Guid reservationId, bool? agreeToNotResell = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return new InternalPhoneNumbersStartReservationPurchaseOperation(_clientDiagnostics, _pipeline, RestClient.CreateStartReservationPurchaseRequest(reservationId, agreeToNotResell).Request, originalResponse);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <remarks> Starts a long running operation to purchase all of the phone numbers in the reservation. Purchase can only be started for active reservations that at least one phone number. If any of the phone numbers in the reservation is from a country where reselling is not permitted, do not resell agreement is required. The response will include an 'Operation-Location' header that can be used to query the status of the operation. </remarks>
        public virtual InternalPhoneNumbersStartReservationPurchaseOperation StartStartReservationPurchase(Guid reservationId, bool? agreeToNotResell = null, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("InternalPhoneNumbersClient.StartStartReservationPurchase");
            scope.Start();
            try
