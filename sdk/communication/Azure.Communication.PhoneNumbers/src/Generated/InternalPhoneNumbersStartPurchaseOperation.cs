...
namespace Azure.Communication.PhoneNumbers
{
    ...
    internal partial class InternalPhoneNumbersStartPurchaseOperation : Operation
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of InternalPhoneNumbersStartPurchaseOperation for mocking. </summary>
        protected InternalPhoneNumbersStartPurchaseOperation()
        {
        }

        internal InternalPhoneNumbersStartPurchaseOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "InternalPhoneNumbersStartPurchaseOperation");
        }
