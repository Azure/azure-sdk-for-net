...
namespace Azure.Communication.PhoneNumbers
{
    ...
    public static partial class PhoneNumbersModelFactory
    {
        ...
        {
            return new PhoneNumberAreaCode(areaCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PhoneNumberCountry(localizedName, countryCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PhoneNumberLocality(localizedName, administrativeDivision, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PhoneNumberAdministrativeDivision(localizedName, abbreviatedName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PhoneNumberOffering(phoneNumberType, assignmentType, availableCapabilities, cost, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PhoneNumberCost(amount, isoCurrencySymbol, billingFrequency, new Dictionary<string, BinaryData>());
        }
        ...
        public static PhoneNumberSearchResult PhoneNumberSearchResult(string searchId = null, IEnumerable<string> phoneNumbers = null, PhoneNumberType phoneNumberType = default, PhoneNumberAssignmentType assignmentType = default, PhoneNumberCapabilities capabilities = null, PhoneNumberCost cost = null, DateTimeOffset searchExpiresOn = default, int? errorCode = null, PhoneNumberSearchResultError? error = null)
        {
            ...
            return new PhoneNumberSearchResult(searchId, phoneNumbers?.ToList(), phoneNumberType, assignmentType, capabilities, cost, searchExpiresOn, errorCode, error, new Dictionary<string, BinaryData>());
        }
    }
}
