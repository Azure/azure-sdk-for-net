...
namespace Azure.Communication.PhoneNumbers
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OfferingsResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OfferingsResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OfferingsResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OfferingsResponse>)} interface");
            }
        ...
        string IPersistableModel<OfferingsResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
