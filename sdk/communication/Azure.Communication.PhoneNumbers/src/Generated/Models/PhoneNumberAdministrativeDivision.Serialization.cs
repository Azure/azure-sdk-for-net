...
namespace Azure.Communication.PhoneNumbers
{
    ...
    {
        internal static PhoneNumberAdministrativeDivision DeserializePhoneNumberAdministrativeDivision(JsonElement element, SerializableOptions options = default)
        {
