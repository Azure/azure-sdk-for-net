...
namespace Azure.Communication.PhoneNumbers
{
    ...
    public partial class PhoneNumberCost
    {
        ...
        internal PhoneNumberCost(double amount, string isoCurrencySymbol, BillingFrequency billingFrequency, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Amount = amount;
            IsoCurrencySymbol = isoCurrencySymbol;
            BillingFrequency = billingFrequency;
