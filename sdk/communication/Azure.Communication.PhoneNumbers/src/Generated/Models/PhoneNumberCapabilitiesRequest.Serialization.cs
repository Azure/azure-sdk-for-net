...
namespace Azure.Communication.PhoneNumbers
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PhoneNumberCapabilitiesRequest>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        PhoneNumberCapabilitiesRequest IJsonModel<PhoneNumberCapabilitiesRequest>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(PhoneNumberCapabilitiesRequest)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<PhoneNumberCapabilitiesRequest>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        PhoneNumberCapabilitiesRequest IModel<PhoneNumberCapabilitiesRequest>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<PhoneNumberCapabilitiesRequest>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
