...
namespace Azure.Communication.PhoneNumbers
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PhoneNumberCapabilitiesRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PhoneNumberCapabilitiesRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PhoneNumberCapabilitiesRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PhoneNumberCapabilitiesRequest>)} interface");
            }
        ...
        string IPersistableModel<PhoneNumberCapabilitiesRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
