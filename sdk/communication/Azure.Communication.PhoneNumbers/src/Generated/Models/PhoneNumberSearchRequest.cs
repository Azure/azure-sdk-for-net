...
namespace Azure.Communication.PhoneNumbers
{
    ...
    internal partial class PhoneNumberSearchRequest
    {
        ...
        internal PhoneNumberSearchRequest(PhoneNumberType phoneNumberType, PhoneNumberAssignmentType assignmentType, PhoneNumberCapabilities capabilities, string areaCode, int? quantity, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PhoneNumberType = phoneNumberType;
            AssignmentType = assignmentType;
            Capabilities = capabilities;
