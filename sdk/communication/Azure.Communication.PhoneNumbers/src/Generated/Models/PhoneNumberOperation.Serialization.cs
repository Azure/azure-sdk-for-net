...
namespace Azure.Communication.PhoneNumbers
{
    internal partial class PhoneNumberOperation : IUtf8JsonSerializable, IJsonModel<PhoneNumberOperation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PhoneNumberOperation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PhoneNumberOperation>)} interface");
            }
