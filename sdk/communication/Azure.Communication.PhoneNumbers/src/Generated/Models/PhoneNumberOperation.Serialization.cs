...
namespace Azure.Communication.PhoneNumbers
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PhoneNumberOperation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PhoneNumberOperation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PhoneNumberOperation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PhoneNumberOperation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
