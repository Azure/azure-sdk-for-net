...
namespace Azure.Communication.PhoneNumbers
{
    ...
    public partial class PhoneNumberLocality
    {
        ...
        internal PhoneNumberLocality(string localizedName, PhoneNumberAdministrativeDivision administrativeDivision, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            LocalizedName = localizedName;
