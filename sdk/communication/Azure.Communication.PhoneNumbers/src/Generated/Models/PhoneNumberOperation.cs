...
namespace Azure.Communication.PhoneNumbers
{
    ...
    internal partial class PhoneNumberOperation
    {
        ...
        internal PhoneNumberOperation(PhoneNumberOperationType operationType, PhoneNumberOperationStatus status, string resourceLocation, DateTimeOffset createdDateTime, CommunicationError error, string id, DateTimeOffset? lastActionDateTime, Dictionary<string, BinaryData> rawData)
        {
