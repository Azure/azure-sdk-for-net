...
namespace Azure.Communication.Identity
{
    internal partial class CommunicationIdentityRestClient
    {
        ...
        public async Task<Response<CommunicationUserIdentifierAndTokenResult>> CreateAsync(IEnumerable<CommunicationTokenScope> createTokenWithScopes = null, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 201:
                    {
                        CommunicationUserIdentifierAndTokenResult value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = CommunicationUserIdentifierAndTokenResult.DeserializeCommunicationUserIdentifierAndTokenResult(document.RootElement);
        ...
        /// <param name="createTokenWithScopes"> Also create access token for the created identity. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<CommunicationUserIdentifierAndTokenResult> Create(IEnumerable<CommunicationTokenScope> createTokenWithScopes = null, CancellationToken cancellationToken = default)
        {
            using var message = CreateCreateRequest(createTokenWithScopes);
