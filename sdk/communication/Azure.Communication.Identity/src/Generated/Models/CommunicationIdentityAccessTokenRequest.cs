...
namespace Azure.Communication.Identity.Models
{
    ...
    internal partial class CommunicationIdentityAccessTokenRequest
    {
        ...
        internal CommunicationIdentityAccessTokenRequest(IList<CommunicationTokenScope> scopes, int? expiresInMinutes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Scopes = scopes;
