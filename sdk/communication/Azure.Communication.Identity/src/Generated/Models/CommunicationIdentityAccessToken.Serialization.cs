...
namespace Azure.Communication.Identity
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunicationIdentityAccessToken>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunicationIdentityAccessToken>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationIdentityAccessToken>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CommunicationIdentityAccessToken>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
