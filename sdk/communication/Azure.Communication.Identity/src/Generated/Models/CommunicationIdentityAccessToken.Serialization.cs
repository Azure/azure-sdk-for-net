...
namespace Azure.Communication.Identity
{
    ...
    {
        internal static CommunicationIdentityAccessToken DeserializeCommunicationIdentityAccessToken(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
