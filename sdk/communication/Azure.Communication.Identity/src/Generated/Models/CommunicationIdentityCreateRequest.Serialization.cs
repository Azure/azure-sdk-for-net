...
namespace Azure.Communication.Identity.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunicationIdentityCreateRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunicationIdentityCreateRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationIdentityCreateRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommunicationIdentityCreateRequest>)} interface");
            }
        ...
        string IPersistableModel<CommunicationIdentityCreateRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
