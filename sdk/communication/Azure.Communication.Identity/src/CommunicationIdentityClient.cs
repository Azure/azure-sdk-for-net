...
namespace Azure.Communication.Identity
{
    ...
    public class CommunicationIdentityClient
    {
        ...
        public virtual Response<CommunicationIdentity> GetUser(CommunicationUserIdentifier communicationUser, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return BuildGetResult(response);
            }
            catch (Exception ex)
            {
                scope.Failed(ex);
        ...
        /// <param name="cancellationToken">The cancellation token to use.</param>
        public virtual async Task<Response<CommunicationIdentity>> GetUserAsync(CommunicationUserIdentifier communicationUser, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(CommunicationIdentityClient)}.{nameof(GetUser)}");
            scope.Start();
            try
        ...
        /// <param name="externalId">External Id to be associated with the user.</param>"
        /// <param name="cancellationToken">The cancellation token to use.</param>
        public virtual Response<CommunicationUserIdentifier> CreateUser(string externalId, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(CommunicationIdentityClient)}.{nameof(CreateUser)}");
            scope.Start();
            try
            {
                Response<CommunicationUserIdentifierAndToken> response = RestClient.Create(externalId, Array.Empty<CommunicationTokenScope>(), cancellationToken: cancellationToken);
        ...
        /// <summary>Asynchronously creates a new <see cref="CommunicationUserIdentifier"/> if the externalId doesn't exist or get the user otherwise/>.</summary>
        /// <param name="externalId">External Id to be associated with the user.</param>
        /// <param name="cancellationToken">The cancellation token to use.</param>
        public virtual async Task<Response<CommunicationUserIdentifier>> CreateUserAsync(string externalId, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(CommunicationIdentityClient)}.{nameof(CreateUser)}");
            scope.Start();
            try
            {
                Response<CommunicationUserIdentifierAndToken> response = await RestClient.CreateAsync(externalId, Array.Empty<CommunicationTokenScope>(), cancellationToken: cancellationToken).ConfigureAwait(false);
                var id = response.Value.Identity.Id;
                return Response.FromValue(new CommunicationUserIdentifier(id), response.GetRawResponse());
            }
            catch (Exception ex)
        ...
        /// <param name="cancellationToken">The cancellation token to use.</param>
        public virtual Response<CommunicationUserIdentifierAndToken> CreateUserAndToken(string externalId, IEnumerable<CommunicationTokenScope> scopes, TimeSpan tokenExpiresIn, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return RestClient.Create(externalId, scopes, expiresIn, cancellationToken);
            }
            catch (Exception ex)
            {
                scope.Failed(ex);
        ...
        /// <param name="scopes">List of <see cref="CommunicationTokenScope"/> scopes for the token.</param>
        /// <param name="cancellationToken">The cancellation token to use.</param>
        public virtual Response<CommunicationUserIdentifierAndToken> CreateUserAndToken(string externalId, IEnumerable<CommunicationTokenScope> scopes, CancellationToken cancellationToken = default)
        {
            return CreateUserAndToken(externalId, scopes, default, cancellationToken);
        }
        ...
        /// <param name="tokenExpiresIn">Custom validity period of the token within [1,24] hours range.</param>
        /// <param name="cancellationToken">The cancellation token to use.</param>
        public virtual async Task<Response<CommunicationUserIdentifierAndToken>> CreateUserAndTokenAsync(string externalId, IEnumerable<CommunicationTokenScope> scopes, TimeSpan tokenExpiresIn, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(CommunicationIdentityClient)}.{nameof(CreateUserAndToken)}");
            scope.Start();
            try
            {
                ...
                return await RestClient.CreateAsync(externalId, scopes, expiresIn, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception ex)
            {
                scope.Failed(ex);
        ...
        /// <param name="scopes">List of <see cref="CommunicationTokenScope"/> scopes for the token.</param>
        /// <param name="cancellationToken">The cancellation token to use.</param>
        public virtual async Task<Response<CommunicationUserIdentifierAndToken>> CreateUserAndTokenAsync(string externalId, IEnumerable<CommunicationTokenScope> scopes, CancellationToken cancellationToken = default)
        {
            return await CreateUserAndTokenAsync(default, scopes, default, cancellationToken).ConfigureAwait(false);
        }
        ...
        private static Response<CommunicationIdentity> BuildGetResult(Response<CommunicationIdentity> response)
        {
            var externalId = response.Value.ExternalId;
