...
{
    public partial class TrafficDetails : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TrafficDetails DeserializeTrafficDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
