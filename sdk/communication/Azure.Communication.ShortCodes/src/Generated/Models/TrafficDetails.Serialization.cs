...
namespace Azure.Communication.ShortCodes.Models
{
    public partial class TrafficDetails : IUtf8JsonSerializable, IJsonModel<TrafficDetails>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TrafficDetails>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrafficDetails>)} interface");
            }
        ...
        TrafficDetails IJsonModel<TrafficDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(TrafficDetails)} does not support '{options.Format}' format.");
            }
