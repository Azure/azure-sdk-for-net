...
namespace Azure.Communication.ShortCodes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ShortCodeCost>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ShortCodeCost>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ShortCodeCost>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ShortCodeCost>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
