...
namespace Azure.Communication.ShortCodes.Models
{
    public partial class ProgramDetails : IUtf8JsonSerializable, IJsonModel<ProgramDetails>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ProgramDetails>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProgramDetails>)} interface");
            }
        ...
        ProgramDetails IJsonModel<ProgramDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(ProgramDetails)} does not support '{options.Format}' format.");
            }
