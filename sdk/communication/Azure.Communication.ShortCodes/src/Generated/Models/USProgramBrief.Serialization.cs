...
{
    public partial class USProgramBrief : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static USProgramBrief DeserializeUSProgramBrief(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
