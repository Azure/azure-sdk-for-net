...
namespace Azure.Communication.ShortCodes.Models
{
    ...
    internal partial class CommunicationIdentifierModel
    {
        ...
        internal CommunicationIdentifierModel(string rawId, CommunicationUserIdentifierModel communicationUser, PhoneNumberIdentifierModel phoneNumber, MicrosoftTeamsUserIdentifierModel microsoftTeamsUser, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RawId = rawId;
