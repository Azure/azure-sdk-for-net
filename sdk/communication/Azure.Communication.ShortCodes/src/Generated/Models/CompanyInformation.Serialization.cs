...
{
    public partial class CompanyInformation : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CompanyInformation DeserializeCompanyInformation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
