...
namespace Azure.Communication.ShortCodes.Models
{
    public partial class CompanyInformation : IUtf8JsonSerializable, IJsonModel<CompanyInformation>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CompanyInformation>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CompanyInformation>)} interface");
            }
