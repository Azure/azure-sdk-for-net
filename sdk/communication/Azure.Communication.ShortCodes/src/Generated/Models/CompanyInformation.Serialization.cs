...
namespace Azure.Communication.ShortCodes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CompanyInformation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CompanyInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CompanyInformation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CompanyInformation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
