...
namespace Azure.Communication.ShortCodes.Models
{
    public partial class ReviewNote : IUtf8JsonSerializable, IJsonModel<ReviewNote>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ReviewNote>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ReviewNote)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ReviewNote>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ReviewNote)} does not support '{options.Format}' format.");
            }
        }
