...
namespace Azure.Communication.ShortCodes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReviewNote>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ReviewNote>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ReviewNote>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ReviewNote>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
