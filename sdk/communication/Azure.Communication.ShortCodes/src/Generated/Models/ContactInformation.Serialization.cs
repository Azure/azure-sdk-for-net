...
namespace Azure.Communication.ShortCodes.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContactInformation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContactInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContactInformation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ContactInformation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
