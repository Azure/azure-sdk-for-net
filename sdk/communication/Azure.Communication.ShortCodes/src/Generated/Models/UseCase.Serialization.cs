...
{
    public partial class UseCase : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static UseCase DeserializeUseCase(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
