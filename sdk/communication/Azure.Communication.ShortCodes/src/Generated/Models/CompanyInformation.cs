...
namespace Azure.Communication.ShortCodes.Models
{
    ...
    public partial class CompanyInformation
    {
        ...
        internal CompanyInformation(string name, Uri url, string address, ContactInformation contactInformation, CustomerCareInformation customerCareInformation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Url = url;
            Address = address;
