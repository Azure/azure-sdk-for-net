...
namespace Azure.Communication.ShortCodes.Models
{
    public partial class MessageDetails : IUtf8JsonSerializable, IModelJsonSerializable<MessageDetails>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MessageDetails>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(UseCases))
            {
                ...
                foreach (var item in UseCases)
                {
                    ...
                    {
                        ((IModelJsonSerializable<UseCase>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
        ...
        /// <summary> Converts a <see cref="MessageDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MessageDetails"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MessageDetails"/>. </summary>
