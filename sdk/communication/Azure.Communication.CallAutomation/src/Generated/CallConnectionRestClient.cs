...
namespace Azure.Communication.CallAutomation
{
    internal partial class CallConnectionRestClient
    {
        ...
        internal HttpMessage CreateCancelAddParticipantRequest(string callConnectionId, CancelAddParticipantRequest cancelAddParticipantRequest, Guid? repeatabilityRequestID, DateTimeOffset? repeatabilityFirstSent)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        public async Task<Response<CancelAddParticipantResponse>> CancelAddParticipantAsync(string callConnectionId, CancelAddParticipantRequest cancelAddParticipantRequest, Guid? repeatabilityRequestID = null, DateTimeOffset? repeatabilityFirstSent = null, CancellationToken cancellationToken = default)
        {
            if (callConnectionId == null)
            {
                throw new ArgumentNullException(nameof(callConnectionId));
            ...
            using var message = CreateCancelAddParticipantRequest(callConnectionId, cancelAddParticipantRequest, repeatabilityRequestID, repeatabilityFirstSent);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 202:
                    {
                        CancelAddParticipantResponse value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = CancelAddParticipantResponse.DeserializeCancelAddParticipantResponse(document.RootElement);
                        return Response.FromValue(value, message.Response);
                    }
                default:
                    throw new RequestFailedException(message.Response);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="callConnectionId"/> or <paramref name="cancelAddParticipantRequest"/> is null. </exception>
        public Response<CancelAddParticipantResponse> CancelAddParticipant(string callConnectionId, CancelAddParticipantRequest cancelAddParticipantRequest, Guid? repeatabilityRequestID = null, DateTimeOffset? repeatabilityFirstSent = null, CancellationToken cancellationToken = default)
        {
            if (callConnectionId == null)
            {
                throw new ArgumentNullException(nameof(callConnectionId));
