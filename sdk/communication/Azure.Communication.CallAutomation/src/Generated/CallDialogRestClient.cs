...
namespace Azure.Communication.CallAutomation
{
    internal partial class CallDialogRestClient
    {
        ...
        public CallDialogRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, string apiVersion = "2023-01-15-preview")
        {
        ...
        internal HttpMessage CreateStartDialogRequest(string callConnectionId, Guid dialogId, StartDialogRequestInternal startDialogRequest)
        {
        ...
        public async Task<Response<DialogStateResponseInternal>> StartDialogAsync(string callConnectionId, Guid dialogId, StartDialogRequestInternal startDialogRequest, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="callConnectionId"/> or <paramref name="startDialogRequest"/> is null. </exception>
        /// <remarks> Start a dialog. </remarks>
        public Response<DialogStateResponseInternal> StartDialog(string callConnectionId, Guid dialogId, StartDialogRequestInternal startDialogRequest, CancellationToken cancellationToken = default)
        {
            if (callConnectionId == null)
            {
                throw new ArgumentNullException(nameof(callConnectionId));
        ...
        internal HttpMessage CreateStopDialogRequest(string callConnectionId, Guid dialogId)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        public async Task<Response> StopDialogAsync(string callConnectionId, Guid dialogId, CancellationToken cancellationToken = default)
        {
            if (callConnectionId == null)
            {
                throw new ArgumentNullException(nameof(callConnectionId));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="callConnectionId"/> is null. </exception>
        public Response StopDialog(string callConnectionId, Guid dialogId, CancellationToken cancellationToken = default)
        {
            if (callConnectionId == null)
            {
                throw new ArgumentNullException(nameof(callConnectionId));
