...
namespace Azure.Communication.CallAutomation
{
    internal partial class CallDialogRestClient
    {
        ...
        public async Task<Response<DialogStateResponse>> StartDialogAsync(string callConnectionId, Guid dialogId, StartDialogRequestInternal startDialogRequest, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="callConnectionId"/> or <paramref name="startDialogRequest"/> is null. </exception>
        /// <remarks> Start a dialog. </remarks>
        public Response<DialogStateResponse> StartDialog(string callConnectionId, Guid dialogId, StartDialogRequestInternal startDialogRequest, CancellationToken cancellationToken = default)
        {
            if (callConnectionId == null)
            {
                throw new ArgumentNullException(nameof(callConnectionId));
