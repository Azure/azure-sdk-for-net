...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class ContinuousDtmfRecognitionToneFailed
    {
        ...
        internal ContinuousDtmfRecognitionToneFailed(string callConnectionId, string serverCallId, string correlationId, ResultInformation resultInformation, string operationContext, Dictionary<string, BinaryData> rawData)
        {
