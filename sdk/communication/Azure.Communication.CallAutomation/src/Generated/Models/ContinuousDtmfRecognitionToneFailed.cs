...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class ContinuousDtmfRecognitionToneFailed
    {
        ...
        internal ContinuousDtmfRecognitionToneFailed(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation)
        {
