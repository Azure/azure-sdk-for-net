...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class PlayFailed
    {
        ...
        internal PlayFailed(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
