...
namespace Azure.Communication.CallAutomation
{
    internal partial class DialogFailedInternal
    {
        internal static DialogFailedInternal DeserializeDialogFailedInternal(JsonElement element)
        {
            ...
            return new DialogFailedInternal(operationContext.Value, resultInformation.Value, Optional.ToNullable(dialogInputType), dialogId.Value, callConnectionId.Value, serverCallId.Value, correlationId.Value);
        }
    }
}
