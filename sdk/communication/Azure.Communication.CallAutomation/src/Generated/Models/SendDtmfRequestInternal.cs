...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class SendDtmfRequestInternal
    {
        ...
        internal SendDtmfRequestInternal(IList<DtmfTone> tones, CommunicationIdentifierModel targetParticipant, string operationContext, string callbackUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tones = tones;
            TargetParticipant = targetParticipant;
