...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class PlayCanceled
    {
        ...
        internal PlayCanceled(string callConnectionId, string serverCallId, string correlationId, string operationContext, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
