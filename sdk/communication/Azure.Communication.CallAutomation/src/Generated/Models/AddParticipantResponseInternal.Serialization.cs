...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        internal static AddParticipantResponseInternal DeserializeAddParticipantResponseInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
