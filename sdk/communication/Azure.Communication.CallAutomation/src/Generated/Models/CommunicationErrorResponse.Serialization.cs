...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        internal static CommunicationErrorResponse DeserializeCommunicationErrorResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
