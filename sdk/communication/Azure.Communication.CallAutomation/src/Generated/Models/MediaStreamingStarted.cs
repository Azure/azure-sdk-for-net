...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class MediaStreamingStarted
    {
        ...
        internal MediaStreamingStarted(string operationContext, ResultInformation resultInformation, MediaStreamingUpdate mediaStreamingUpdate, string callConnectionId, string serverCallId, string correlationId)
        {
