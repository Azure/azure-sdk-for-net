...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class MediaStreamingStarted
    {
        ...
        internal MediaStreamingStarted(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, MediaStreamingUpdate mediaStreamingUpdateResult)
        {
