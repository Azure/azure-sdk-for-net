...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class MediaStreamingStarted
    {
        ...
        internal MediaStreamingStarted(MediaStreamingUpdated mediaStreamingUpdate, string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation)
        {
