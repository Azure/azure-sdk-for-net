...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        internal static AddParticipantSucceededInternal DeserializeAddParticipantSucceededInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
