...
namespace Azure.Communication.CallAutomation
{
    internal partial class AddParticipantSucceededInternal
    {
        internal static AddParticipantSucceededInternal DeserializeAddParticipantSucceededInternal(JsonElement element)
        {
            ...
            return new AddParticipantSucceededInternal(operationContext.Value, resultInformation.Value, participant.Value, callConnectionId.Value, serverCallId.Value, correlationId.Value);
        }
    }
}
