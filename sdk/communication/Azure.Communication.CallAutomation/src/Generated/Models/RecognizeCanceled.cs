...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class RecognizeCanceled
    {
        ...
        internal RecognizeCanceled(string callConnectionId, string serverCallId, string correlationId, string operationContext, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
