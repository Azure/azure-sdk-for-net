...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class RecognizeCanceled
    {
        ...
        internal RecognizeCanceled(string operationContext, string callConnectionId, string serverCallId, string correlationId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
