...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class AnswerCallRequestInternal
    {
        ...
        internal AnswerCallRequestInternal(string incomingCallContext, string callbackUri, string operationContext, MediaStreamingOptionsInternal mediaStreamingConfiguration, string azureCognitiveServicesEndpointUrl, CommunicationUserIdentifierModel answeredByIdentifier)
        {
            IncomingCallContext = incomingCallContext;
            CallbackUri = callbackUri;
