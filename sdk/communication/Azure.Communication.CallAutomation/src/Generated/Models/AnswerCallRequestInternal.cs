...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class AnswerCallRequestInternal
    {
        ...
        internal AnswerCallRequestInternal(string incomingCallContext, string callbackUri, string operationContext, MediaStreamingOptionsInternal mediaStreamingConfiguration, string azureCognitiveServicesEndpointUrl, CommunicationUserIdentifierModel answeredByIdentifier, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IncomingCallContext = incomingCallContext;
            CallbackUri = callbackUri;
