...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExternalStorageInternal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExternalStorageInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExternalStorageInternal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExternalStorageInternal>)} interface");
            }
        ...
        string IPersistableModel<ExternalStorageInternal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
