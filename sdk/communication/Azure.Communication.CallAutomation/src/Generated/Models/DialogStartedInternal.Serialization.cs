...
namespace Azure.Communication.CallAutomation.Models.Events
{
    internal partial class DialogStartedInternal
    {
        internal static DialogStartedInternal DeserializeDialogStartedInternal(JsonElement element)
        {
            ...
            return new DialogStartedInternal(callConnectionId.Value, serverCallId.Value, correlationId.Value, operationContext.Value, resultInformation.Value, Optional.ToNullable(dialogInputType), dialogId.Value);
        }
    }
}
