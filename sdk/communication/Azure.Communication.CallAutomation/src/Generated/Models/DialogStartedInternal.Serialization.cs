...
namespace Azure.Communication.CallAutomation.Models.Events
{
    internal partial class DialogStartedInternal : IUtf8JsonSerializable, IModelJsonSerializable<DialogStartedInternal>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DialogStartedInternal>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="DialogStartedInternal"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DialogStartedInternal"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DialogStartedInternal"/>. </summary>
