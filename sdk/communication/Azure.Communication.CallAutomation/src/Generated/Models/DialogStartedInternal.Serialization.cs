...
namespace Azure.Communication.CallAutomation
{
    internal partial class DialogStartedInternal
    {
        internal static DialogStartedInternal DeserializeDialogStartedInternal(JsonElement element)
        {
            ...
            return new DialogStartedInternal(operationContext.Value, resultInformation.Value, Optional.ToNullable(dialogInputType), dialogId.Value, callConnectionId.Value, serverCallId.Value, correlationId.Value);
        }
    }
}
