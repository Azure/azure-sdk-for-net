...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TranscriptionStopped>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<TranscriptionStopped>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<TranscriptionStopped>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TranscriptionStopped)} does not support '{format}' format.");
            }
        ...
        internal static TranscriptionStopped DeserializeTranscriptionStopped(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new TranscriptionStopped(operationContext.Value, resultInformation.Value, transcriptionUpdate.Value, callConnectionId.Value, serverCallId.Value, correlationId.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<TranscriptionStopped>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TranscriptionStopped)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<TranscriptionStopped>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
