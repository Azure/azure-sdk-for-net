...
namespace Azure.Communication.CallAutomation
{
    internal partial class CreateCallRequestInternal : IUtf8JsonSerializable, IModelJsonSerializable<CreateCallRequestInternal>
    {
        ...
        internal static CreateCallRequestInternal DeserializeCreateCallRequestInternal(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CreateCallRequestInternal(targets, sourceCallerIdNumber.Value, sourceDisplayName.Value, sourceIdentity.Value, operationContext.Value, callbackUri, mediaStreamingConfiguration.Value, azureCognitiveServicesEndpointUrl.Value, customContext.Value, serializedAdditionalRawData);
        }
