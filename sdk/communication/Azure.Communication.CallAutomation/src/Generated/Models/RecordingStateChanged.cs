...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class RecordingStateChanged
    {
        ...
        internal RecordingStateChanged(string callConnectionId, string serverCallId, string correlationId, string recordingId, RecordingState state, DateTimeOffset? startDateTime, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
