...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class TransferToParticipantRequestInternal
    {
        ...
        internal TransferToParticipantRequestInternal(CommunicationIdentifierModel targetParticipant, CustomCallingContextInternal customCallingContext, string operationContext, CommunicationIdentifierModel transferee, string operationCallbackUri, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TargetParticipant = targetParticipant;
