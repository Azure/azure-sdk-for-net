...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class SendDtmfTonesFailedInternal
    {
        ...
        internal SendDtmfTonesFailedInternal(string operationContext, ResultInformation resultInformation, string callConnectionId, string serverCallId, string correlationId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
