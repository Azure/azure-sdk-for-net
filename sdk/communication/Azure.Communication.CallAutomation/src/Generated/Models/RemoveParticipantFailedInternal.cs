...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class RemoveParticipantFailedInternal
    {
        ...
        internal RemoveParticipantFailedInternal(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, CommunicationIdentifierModel participant, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
