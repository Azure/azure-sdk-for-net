...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContinuousDtmfRecognitionToneReceived>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContinuousDtmfRecognitionToneReceived>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContinuousDtmfRecognitionToneReceived>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContinuousDtmfRecognitionToneReceived>)} interface");
            }
        ...
        string IPersistableModel<ContinuousDtmfRecognitionToneReceived>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
