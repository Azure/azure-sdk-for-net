...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class MediaStreamingFailed
    {
        ...
        internal MediaStreamingFailed(MediaStreamingUpdate mediaStreamingUpdate, string operationContext, ResultInformation resultInformation, string callConnectionId, string serverCallId, string correlationId)
        {
