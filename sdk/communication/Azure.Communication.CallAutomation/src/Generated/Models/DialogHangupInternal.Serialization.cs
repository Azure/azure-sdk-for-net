...
namespace Azure.Communication.CallAutomation
{
    internal partial class DialogHangupInternal
    {
        internal static DialogHangupInternal DeserializeDialogHangupInternal(JsonElement element)
        {
            ...
            return new DialogHangupInternal(
                callConnectionId,
                serverCallId,
                correlationId,
                operationContext,
        ...
        internal static DialogHangupInternal FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeDialogHangupInternal(document.RootElement);
        }
    }
}
