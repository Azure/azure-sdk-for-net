...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class DialogSensitivityUpdateInternal
    {
        ...
        internal DialogSensitivityUpdateInternal(bool? sensitiveMask, string operationContext, ResultInformation resultInformation, DialogInputType? dialogInputType, string dialogId, string callConnectionId, string serverCallId, string correlationId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
