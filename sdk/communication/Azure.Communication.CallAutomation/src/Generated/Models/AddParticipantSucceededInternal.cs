...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class AddParticipantSucceededInternal
    {
        ...
        internal AddParticipantSucceededInternal(string operationContext, ResultInformation resultInformation, CommunicationIdentifierModel participant, string callConnectionId, string serverCallId, string correlationId)
        {
