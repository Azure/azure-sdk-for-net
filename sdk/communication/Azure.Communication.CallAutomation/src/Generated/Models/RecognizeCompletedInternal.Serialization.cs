...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        internal static RecognizeCompletedInternal DeserializeRecognizeCompletedInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
