...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class StartDialogRequestInternal
    {
        ...
        internal StartDialogRequestInternal(DialogOptionsInternal dialogOptions, DialogInputType dialogInputType, string operationContext, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DialogOptions = dialogOptions;
            DialogInputType = dialogInputType;
