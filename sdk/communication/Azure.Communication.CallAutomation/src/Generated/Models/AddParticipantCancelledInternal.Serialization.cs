...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddParticipantCancelledInternal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AddParticipantCancelledInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AddParticipantCancelledInternal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AddParticipantCancelledInternal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
