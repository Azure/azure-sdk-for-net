...
namespace Azure.Communication.CallAutomation
{
    internal partial class AddParticipantCancelledInternal : IUtf8JsonSerializable, IJsonModel<AddParticipantCancelledInternal>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AddParticipantCancelledInternal>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AddParticipantCancelledInternal)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AddParticipantCancelledInternal>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AddParticipantCancelledInternal)} does not support '{options.Format}' format.");
            }
        }
