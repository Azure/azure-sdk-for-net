...
namespace Azure.Communication.CallAutomation.Models.Events
{
    ...
    internal partial class DialogConsentInternal
    {
        ...
        internal DialogConsentInternal(string callConnectionId, string serverCallId, string correlationId, DialogInputType? dialogInputType, string operationContext, ResultInformation resultInformation)
        {
