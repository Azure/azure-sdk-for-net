...
namespace Azure.Communication.CallAutomation.Models.Events
{
    ...
    internal partial class DialogConsentInternal
    {
        ...
        internal DialogConsentInternal(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, DialogInputType? dialogInputType, UserConsent userConsent, string dialogId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
