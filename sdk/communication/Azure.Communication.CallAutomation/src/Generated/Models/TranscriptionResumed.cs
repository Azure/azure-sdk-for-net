...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class TranscriptionResumed
    {
        ...
        internal TranscriptionResumed(string operationContext, ResultInformation resultInformation, TranscriptionUpdate transcriptionUpdate, string callConnectionId, string serverCallId, string correlationId)
        {
