...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TranscriptionFailed>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TranscriptionFailed>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TranscriptionFailed>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TranscriptionFailed>)} interface");
            }
        ...
        string IPersistableModel<TranscriptionFailed>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
