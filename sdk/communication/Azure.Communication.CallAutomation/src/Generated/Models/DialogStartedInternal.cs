...
namespace Azure.Communication.CallAutomation.Models.Events
{
    ...
    internal partial class DialogStartedInternal
    {
        ...
        internal DialogStartedInternal(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, DialogInputType? dialogInputType, string dialogId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
