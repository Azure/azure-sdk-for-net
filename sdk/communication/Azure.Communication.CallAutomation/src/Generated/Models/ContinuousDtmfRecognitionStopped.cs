...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class ContinuousDtmfRecognitionStopped
    {
        ...
        internal ContinuousDtmfRecognitionStopped(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
