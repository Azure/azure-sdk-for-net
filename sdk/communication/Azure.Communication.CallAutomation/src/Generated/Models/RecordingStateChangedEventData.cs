...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class RecordingStateChangedEventData
    {
        ...
        internal RecordingStateChangedEventData(string callConnectionId, string serverCallId, string correlationId, string recordingId, RecordingState state, DateTimeOffset? startDateTime)
        {
