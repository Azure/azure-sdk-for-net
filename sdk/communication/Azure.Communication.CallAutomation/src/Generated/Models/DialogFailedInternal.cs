...
namespace Azure.Communication.CallAutomation.Models.Events
{
    ...
    internal partial class DialogFailedInternal
    {
        ...
        internal DialogFailedInternal(string callConnectionId, string serverCallId, string correlationId, string dialogSessionId, string operationContext, ResultInformation resultInformation)
        {
