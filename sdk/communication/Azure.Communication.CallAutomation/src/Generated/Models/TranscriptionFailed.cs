...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class TranscriptionFailed
    {
        ...
        internal TranscriptionFailed(string operationContext, ResultInformation resultInformation, TranscriptionUpdate transcriptionUpdate, string callConnectionId, string serverCallId, string correlationId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
