...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class AddParticipantFailedInternal
    {
        ...
        internal AddParticipantFailedInternal(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, CommunicationIdentifierModel participant, Dictionary<string, BinaryData> rawData)
        {
