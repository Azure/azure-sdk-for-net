...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class MoveParticipantSucceededInternal
    {
        /// <summary> Initializes a new instance of <see cref="MoveParticipantSucceededInternal"/>. </summary>
        internal MoveParticipantSucceededInternal()
        {
        }
        ...
        internal MoveParticipantSucceededInternal(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, CommunicationIdentifierModel participant, string fromCall)
        {
