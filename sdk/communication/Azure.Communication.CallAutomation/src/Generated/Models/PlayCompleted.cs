...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class PlayCompleted
    {
        ...
        internal PlayCompleted(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
