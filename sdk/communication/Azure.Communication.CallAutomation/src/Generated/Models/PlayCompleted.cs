...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class PlayCompleted
    {
        ...
        internal PlayCompleted(ResultInformation resultInformation, string operationContext, string callConnectionId, string serverCallId, string correlationId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
