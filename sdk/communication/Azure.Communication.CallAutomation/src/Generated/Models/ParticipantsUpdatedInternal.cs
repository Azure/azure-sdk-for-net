...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class ParticipantsUpdatedInternal
    {
        ...
        internal ParticipantsUpdatedInternal(string callConnectionId, string serverCallId, string correlationId, int? sequenceNumber, IReadOnlyList<CallParticipantInternal> participants, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
