...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class TranscriptionStopped
    {
        ...
        internal TranscriptionStopped(string operationContext, ResultInformation resultInformation, TranscriptionUpdate transcriptionUpdateResult, string callConnectionId, string serverCallId, string correlationId)
        {
