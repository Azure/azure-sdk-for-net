...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class TranscriptionStopped
    {
        ...
        internal TranscriptionStopped(string operationContext, ResultInformation resultInformation, TranscriptionUpdate transcriptionUpdate, string callConnectionId, string serverCallId, string correlationId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
