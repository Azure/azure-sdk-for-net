...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class TranscriptionStopped
    {
        ...
        internal TranscriptionStopped(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, TranscriptionUpdated transcriptionUpdateResult)
        {
