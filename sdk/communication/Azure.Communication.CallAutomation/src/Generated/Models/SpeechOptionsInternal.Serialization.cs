...
namespace Azure.Communication.CallAutomation
{
    internal partial class SpeechOptionsInternal : IUtf8JsonSerializable, IJsonModel<SpeechOptionsInternal>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<SpeechOptionsInternal>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SpeechOptionsInternal>)} interface");
            }
