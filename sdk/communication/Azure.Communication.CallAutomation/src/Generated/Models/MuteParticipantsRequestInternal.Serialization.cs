...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MuteParticipantsRequestInternal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MuteParticipantsRequestInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MuteParticipantsRequestInternal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MuteParticipantsRequestInternal>)} interface");
            }
        ...
        string IPersistableModel<MuteParticipantsRequestInternal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
