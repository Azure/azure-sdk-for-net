...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class TranscriptionOptionsInternal
    {
        ...
        public TranscriptionOptionsInternal(string transportUrl, TranscriptionTransportInternal transportType, string locale, bool startTranscription)
        {
        ...
        internal TranscriptionOptionsInternal(string transportUrl, TranscriptionTransportInternal transportType, string locale, string speechRecognitionModelEndpointId, bool startTranscription, bool? enableIntermediateResults)
        {
            TransportUrl = transportUrl;
            TransportType = transportType;
            Locale = locale;
        ...
        public TranscriptionTransportInternal TransportType { get; }
