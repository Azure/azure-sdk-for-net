...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class DialogStateResponseInternal
    {
        ...
        internal DialogStateResponseInternal(string dialogId, DialogOptionsInternal dialogOptions, DialogInputType? dialogInputType, string operationContext, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DialogId = dialogId;
