...
namespace Azure.Communication.CallAutomation.Models.Events
{
    internal partial class DialogCompletedInternal
    {
        internal static DialogCompletedInternal DeserializeDialogCompletedInternal(JsonElement element)
        {
            ...
            return new DialogCompletedInternal(callConnectionId.Value, serverCallId.Value, correlationId.Value, operationContext.Value, resultInformation.Value, Core.Optional.ToNullable(dialogInputType), dialogId.Value);
        }
    }
}
