...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class MediaStreamingOptionsInternal
    {
        ...
        internal MediaStreamingOptionsInternal(string transportUrl, MediaStreamingTransport transportType, MediaStreamingContent contentType, MediaStreamingAudioChannel audioChannelType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TransportUrl = transportUrl;
            TransportType = transportType;
            ContentType = contentType;
