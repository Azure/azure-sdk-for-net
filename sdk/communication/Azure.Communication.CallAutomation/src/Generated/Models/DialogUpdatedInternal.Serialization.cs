...
namespace Azure.Communication.CallAutomation.Models.Events
{
    internal partial class DialogUpdatedInternal
    {
        internal static DialogUpdatedInternal DeserializeDialogUpdatedInternal(JsonElement element)
        {
            ...
            return new DialogUpdatedInternal(callConnectionId.Value, serverCallId.Value, correlationId.Value, operationContext.Value, resultInformation.Value, Optional.ToNullable(dialogInputType), dialogId.Value, ivrContext.Value);
        }
    }
}
