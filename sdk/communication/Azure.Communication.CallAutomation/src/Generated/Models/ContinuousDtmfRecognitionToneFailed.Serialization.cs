...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        internal static ContinuousDtmfRecognitionToneFailed DeserializeContinuousDtmfRecognitionToneFailed(JsonElement element, SerializableOptions options = default)
        {
