...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class DtmfOptionsInternal
    {
        ...
        internal DtmfOptionsInternal(int? interToneTimeoutInSeconds, int? maxTonesToCollect, IReadOnlyList<DtmfTone> stopTones, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
