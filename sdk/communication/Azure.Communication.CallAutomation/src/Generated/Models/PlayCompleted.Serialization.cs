...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PlayCompleted>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PlayCompleted>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PlayCompleted>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PlayCompleted>)} interface");
            }
        ...
        string IPersistableModel<PlayCompleted>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
