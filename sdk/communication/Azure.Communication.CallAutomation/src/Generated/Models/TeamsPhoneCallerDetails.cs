...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class TeamsPhoneCallerDetails
    {
        ...
        public TeamsPhoneCallerDetails(CommunicationIdentifierModel caller, string name, string phoneNumber)
        {
        ...
        internal TeamsPhoneCallerDetails(CommunicationIdentifierModel caller, string name, string phoneNumber, string recordId, string screenPopUrl, bool? isAuthenticated, IDictionary<string, string> additionalCallerInformation)
        {
            Caller = caller;
            Name = name;
            PhoneNumber = phoneNumber;
        ...
        public CommunicationIdentifierModel Caller { get; }
