...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class MoveParticipantFailedInternal
    {
        ...
        internal MoveParticipantFailedInternal(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, CommunicationIdentifierModel participant, string fromCall)
        {
