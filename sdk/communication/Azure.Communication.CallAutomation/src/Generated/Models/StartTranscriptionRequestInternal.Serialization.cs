...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StartTranscriptionRequestInternal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StartTranscriptionRequestInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StartTranscriptionRequestInternal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StartTranscriptionRequestInternal>)} interface");
            }
        ...
        string IPersistableModel<StartTranscriptionRequestInternal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
