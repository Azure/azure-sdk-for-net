...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class CancelAddParticipantFailedInternal
    {
        ...
        internal CancelAddParticipantFailedInternal(string operationContext, ResultInformation resultInformation, string invitationId, string callConnectionId, string serverCallId, string correlationId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
