...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class ContinuousDtmfRecognitionToneReceived
    {
        ...
        internal ContinuousDtmfRecognitionToneReceived(ToneInfo toneInfo, string callConnectionId, string serverCallId, string correlationId, ResultInformation resultInformation, string operationContext, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ToneInfo = toneInfo;
