...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class TextSourceInternal
    {
        ...
        internal TextSourceInternal(string text, string sourceLocale, GenderType? voiceGender, string voiceName, string customVoiceEndpointId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
