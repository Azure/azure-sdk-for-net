...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class TeamsComplianceRecordingStateChanged
    {
        ...
        internal TeamsComplianceRecordingStateChanged(string recordingId, RecordingState state, DateTimeOffset? startDateTime, RecordingType? recordingType, string callConnectionId, string serverCallId, string correlationId)
        {
