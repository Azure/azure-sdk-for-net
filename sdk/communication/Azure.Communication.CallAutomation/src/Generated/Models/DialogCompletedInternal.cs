...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class DialogCompletedInternal
    {
        ...
        internal DialogCompletedInternal(string operationContext, ResultInformation resultInformation, DialogInputType? dialogInputType, string dialogId, string callConnectionId, string serverCallId, string correlationId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
