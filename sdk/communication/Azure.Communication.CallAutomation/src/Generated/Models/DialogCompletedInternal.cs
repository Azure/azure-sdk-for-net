...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class DialogCompletedInternal
    {
        ...
        internal DialogCompletedInternal(DialogInputType? dialogInputType, string dialogId, string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation)
        {
