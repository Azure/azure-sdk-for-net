...
namespace Azure.Communication.CallAutomation.Models.Events
{
    ...
    internal partial class DialogCompletedInternal
    {
        ...
        internal DialogCompletedInternal(string callConnectionId, string serverCallId, string correlationId, DialogInputType? dialogInputType, string operationContext, ResultInformation resultInformation)
        {
