...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class SendDtmfCompleted
    {
        ...
        internal SendDtmfCompleted(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
