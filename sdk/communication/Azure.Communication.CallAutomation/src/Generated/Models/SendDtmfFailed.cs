...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class SendDtmfFailed
    {
        ...
        internal SendDtmfFailed(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
