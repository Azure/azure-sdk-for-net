...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class CallConnected
    {
        ...
        internal CallConnected(string callConnectionId, string serverCallId, string correlationId, string operationContext, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
