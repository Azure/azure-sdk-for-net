...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class TranscriptionUpdated
    {
        ...
        internal TranscriptionUpdated(TranscriptionUpdate transcriptionUpdate, string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation)
        {
