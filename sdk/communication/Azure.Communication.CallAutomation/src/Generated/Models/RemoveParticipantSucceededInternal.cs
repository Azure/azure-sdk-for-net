...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class RemoveParticipantSucceededInternal
    {
        ...
        internal RemoveParticipantSucceededInternal(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, CommunicationIdentifierModel participant, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
