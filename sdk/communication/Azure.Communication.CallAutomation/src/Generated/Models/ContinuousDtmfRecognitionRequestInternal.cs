...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class ContinuousDtmfRecognitionRequestInternal
    {
        ...
        internal ContinuousDtmfRecognitionRequestInternal(CommunicationIdentifierModel targetParticipant, string operationContext, string operationCallbackUri, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TargetParticipant = targetParticipant;
