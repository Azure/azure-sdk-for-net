...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class RecognizeRequestInternal
    {
        ...
        internal RecognizeRequestInternal(RecognizeInputType recognizeInputType, PlaySourceInternal playPrompt, bool? interruptCallMediaOperation, RecognizeOptionsInternal recognizeOptions, string operationContext, string callbackUri, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RecognizeInputType = recognizeInputType;
