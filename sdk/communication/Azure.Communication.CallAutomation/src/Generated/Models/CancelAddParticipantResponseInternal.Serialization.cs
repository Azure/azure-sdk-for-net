...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CancelAddParticipantResponseInternal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CancelAddParticipantResponseInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CancelAddParticipantResponseInternal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CancelAddParticipantResponseInternal>)} interface");
            }
        ...
        string IPersistableModel<CancelAddParticipantResponseInternal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
