...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class CallDisconnected
    {
        ...
        internal CallDisconnected(string callConnectionId, string serverCallId, string correlationId, string operationContext, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
