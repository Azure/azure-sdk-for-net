...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class CallDisconnected
    {
        ...
        internal CallDisconnected(string operationContext, string callConnectionId, string serverCallId, string correlationId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
