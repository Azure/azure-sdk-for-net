...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class CustomContextInternal
    {
        ...
        internal CustomContextInternal(IDictionary<string, string> voipHeaders, IDictionary<string, string> sipHeaders, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
