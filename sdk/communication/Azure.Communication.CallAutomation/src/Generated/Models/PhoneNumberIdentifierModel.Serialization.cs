...
namespace Azure.Communication
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PhoneNumberIdentifierModel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PhoneNumberIdentifierModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PhoneNumberIdentifierModel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PhoneNumberIdentifierModel>)} interface");
            }
        ...
        string IPersistableModel<PhoneNumberIdentifierModel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
