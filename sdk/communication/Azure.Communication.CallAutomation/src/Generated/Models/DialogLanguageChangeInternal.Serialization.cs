...
namespace Azure.Communication.CallAutomation.Models.Events
{
    internal partial class DialogLanguageChangeInternal
    {
        internal static DialogLanguageChangeInternal DeserializeDialogLanguageChangeInternal(JsonElement element)
        {
            ...
            Core.Optional<string> selectedLanguage = default;
            ...
            return new DialogLanguageChangeInternal(callConnectionId.Value, serverCallId.Value, correlationId.Value, operationContext.Value, resultInformation.Value, Core.Optional.ToNullable(dialogInputType), dialogId.Value, selectedLanguage.Value, ivrContext.Value);
        }
    }
}
