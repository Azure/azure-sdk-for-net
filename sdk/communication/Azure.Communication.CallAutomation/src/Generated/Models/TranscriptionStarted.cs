...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class TranscriptionStarted
    {
        ...
        internal TranscriptionStarted(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, TranscriptionUpdate transcriptionUpdateResult, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
