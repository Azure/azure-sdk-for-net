...
namespace Azure.Communication.CallAutomation.Models.Events
{
    ...
    {
        /// <summary> Initializes a new instance of DialogUpdatedInternal. </summary>
        ...
        internal DialogUpdatedInternal(string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation, DialogInputType? dialogInputType, string dialogId, object ivrContext)
        {
