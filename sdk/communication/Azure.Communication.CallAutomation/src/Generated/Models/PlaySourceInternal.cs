...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class PlaySourceInternal
    {
        ...
        internal PlaySourceInternal(PlaySourceTypeInternal sourceType, string playSourceId, FileSourceInternal fileSource, TextSourceInternal textSource, SsmlSourceInternal ssmlSource, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SourceType = sourceType;
