...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PlayCanceled>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PlayCanceled>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PlayCanceled>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PlayCanceled>)} interface");
            }
        ...
        string IPersistableModel<PlayCanceled>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
