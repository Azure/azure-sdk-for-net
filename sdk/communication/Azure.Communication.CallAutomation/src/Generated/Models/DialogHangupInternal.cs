...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class DialogHangupInternal
    {
        ...
        internal DialogHangupInternal(string operationContext, ResultInformation resultInformation, DialogInputType? dialogInputType, string dialogId, object ivrContext, string callConnectionId, string serverCallId, string correlationId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
