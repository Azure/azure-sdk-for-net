...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class DialogHangupInternal
    {
        ...
        internal DialogHangupInternal(DialogInputType? dialogInputType, string dialogId, object ivrContext, string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation)
        {
