...
namespace Azure.Communication.CallAutomation.Models.Events
{
    ...
    internal partial class DialogHangupInternal
    {
        ...
        internal DialogHangupInternal(string callConnectionId, string serverCallId, string correlationId, string dialogSessionId, string operationContext, ResultInformation resultInformation)
        {
