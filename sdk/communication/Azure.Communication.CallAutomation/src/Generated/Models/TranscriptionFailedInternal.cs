...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class TranscriptionFailedInternal
    {
        ...
        internal TranscriptionFailedInternal(TranscriptionUpdate transcriptionUpdate, string callConnectionId, string serverCallId, string correlationId, string operationContext, ResultInformation resultInformation)
        {
