...
namespace Azure.Communication.CallAutomation.Models.Events
{
    internal partial class DialogSensitivityUpdateInternal
    {
        internal static DialogSensitivityUpdateInternal DeserializeDialogSensitivityUpdateInternal(JsonElement element)
        {
            ...
            Core.Optional<bool> sensitiveMask = default;
            ...
            return new DialogSensitivityUpdateInternal(callConnectionId.Value, serverCallId.Value, correlationId.Value, operationContext.Value, resultInformation.Value, Core.Optional.ToNullable(dialogInputType), dialogId.Value, Core.Optional.ToNullable(sensitiveMask));
        }
    }
}
