...
namespace Azure.Communication.CallAutomation
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RejectCallRequestInternal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RejectCallRequestInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RejectCallRequestInternal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RejectCallRequestInternal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
