...
namespace Azure.Communication.CallAutomation
{
    internal partial class CallMediaRestClient
    {
        ...
        internal HttpMessage CreateStartTranscriptionRequest(string callConnectionId, StartTranscriptionRequestInternal startTranscriptionRequestInternal)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<StartTranscriptionRequestInternal>)startTranscriptionRequestInternal).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateStopTranscriptionRequest(string callConnectionId, StopTranscriptionRequestInternal stopTranscriptionRequestInternal)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<StopTranscriptionRequestInternal>)stopTranscriptionRequestInternal).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateStartContinuousDtmfRecognitionRequest(string callConnectionId, ContinuousDtmfRecognitionRequestInternal continuousDtmfRecognitionRequestInternal)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<ContinuousDtmfRecognitionRequestInternal>)continuousDtmfRecognitionRequestInternal).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateSendDtmfTonesRequest(string callConnectionId, SendDtmfTonesRequestInternal sendDtmfTonesRequestInternal)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<SendDtmfTonesRequestInternal>)sendDtmfTonesRequestInternal).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateUpdateTranscriptionRequest(string callConnectionId, UpdateTranscriptionRequestInternal updateTranscriptionRequestInternal)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<UpdateTranscriptionRequestInternal>)updateTranscriptionRequestInternal).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateHoldRequest(string callConnectionId, HoldRequestInternal holdRequestInternal)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<HoldRequestInternal>)holdRequestInternal).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateUnholdRequest(string callConnectionId, UnholdRequestInternal unholdRequestInternal)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<UnholdRequestInternal>)unholdRequestInternal).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateStartMediaStreamingRequest(string callConnectionId, StartMediaStreamingRequestInternal startMediaStreamingRequestInternal)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<StartMediaStreamingRequestInternal>)startMediaStreamingRequestInternal).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateStopMediaStreamingRequest(string callConnectionId, StopMediaStreamingRequestInternal stopMediaStreamingRequestInternal)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<StopMediaStreamingRequestInternal>)stopMediaStreamingRequestInternal).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
        ...
        internal HttpMessage CreateInterruptAudioAndAnnounceRequest(string callConnectionId, InterruptAudioAndAnnounceRequestInternal interruptRequest)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<InterruptAudioAndAnnounceRequestInternal>)interruptRequest).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            return message;
        }
