...
namespace Azure.Communication.CallAutomation
{
    internal partial class AzureCommunicationServicesRestClient
    {
        ...
        internal HttpMessage CreateAnswerCallPmaRequest(string callConnectionId, AnswerCallRequestInternal answerCallRequest, Guid? repeatabilityRequestID, string repeatabilityFirstSent)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
        ...
        public async Task<Response<CallConnectionPropertiesInternal>> AnswerCallPmaAsync(string callConnectionId, AnswerCallRequestInternal answerCallRequest, Guid? repeatabilityRequestID = null, string repeatabilityFirstSent = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="callConnectionId"/> or <paramref name="answerCallRequest"/> is null. </exception>
        /// <remarks> Answer a call using the call connection Id. </remarks>
        public Response<CallConnectionPropertiesInternal> AnswerCallPma(string callConnectionId, AnswerCallRequestInternal answerCallRequest, Guid? repeatabilityRequestID = null, string repeatabilityFirstSent = null, CancellationToken cancellationToken = default)
        {
            if (callConnectionId == null)
            {
                throw new ArgumentNullException(nameof(callConnectionId));
