...
namespace Azure.Communication.CallAutomation
{
    ...
    public class CallConnection
    {
        ...
        {
            TransferToParticipantRequestInternal request = new(CommunicationIdentifierSerializer_2025_03_15_preview.Serialize(options.Target))
            {
                ...
                Transferee = options.Transferee == default ? null : CommunicationIdentifierSerializer_2025_03_15_preview.Serialize(options.Transferee),
        ...
        private static AddParticipantRequestInternal CreateAddParticipantRequest(AddParticipantOptions options)
        {
            ...
            AddParticipantRequestInternal request = new(CommunicationIdentifierSerializer_2025_03_15_preview.Serialize(options.ParticipantToAdd.Target))
            {
                CustomCallingContext = new CustomCallingContextInternal(
        ...
        public virtual async Task<Response<RemoveParticipantResult>> RemoveParticipantAsync(RemoveParticipantOptions options, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                RemoveParticipantRequestInternal request = new(CommunicationIdentifierSerializer_2025_03_15_preview.Serialize(options.ParticipantToRemove));
        ...
        public virtual Response<MuteParticipantResult> MuteParticipant(CommunicationIdentifier targetParticipant, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                MuteParticipantsRequestInternal request = new(new List<CommunicationIdentifierModel>() { CommunicationIdentifierSerializer_2025_03_15_preview.Serialize(targetParticipant) });
        ...
        public virtual Response<MuteParticipantResult> MuteParticipant(MuteParticipantOptions options, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                MuteParticipantsRequestInternal request = new(new List<CommunicationIdentifierModel>() { CommunicationIdentifierSerializer_2025_03_15_preview.Serialize(options.TargetParticipant) });
