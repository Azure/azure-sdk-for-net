...
namespace Azure.Communication.CallAutomation
{
    ...
    public static partial class CallAutomationModelFactory
    {
        ...
        /// <returns> A new <see cref="CallAutomation.PlayFailed"/> instance for mocking. </returns>
        internal static PlayFailed PlayFailed(string callConnectionId = null, string serverCallId = null, string correlationId = null, string operationContext = null, ResultInformation resultInformation = null, int? failedPlaySourceIndex = null)
        {
        ...
        /// <param name="failedPlaySourceIndex"> Contains the index of the failed play source. </param>
        /// <returns> A new <see cref="CallAutomation.RecognizeFailed"/> instance for mocking. </returns>
        internal static RecognizeFailed RecognizeFailed(string callConnectionId = null, string serverCallId = null, string correlationId = null, string operationContext = null, ResultInformation resultInformation = null, int? failedPlaySourceIndex = null)
        {
