...
{
    /// <summary>The result from start continuous dtmf recognition result.</summary>
    public class StartContinuousDtmfRecognitionResult
    {
        private CallAutomationEventProcessor _evHandler;
        private string _callConnectionId;
        private string _operationContext;

        internal StartContinuousDtmfRecognitionResult()
        {
        }
        ...
        /// <returns>Returns <see cref="StartContinuousDtmfRecognitionEventResult"/> which contains either <see cref="RecognizeCompleted"/> event or <see cref="RecognizeFailed"/> event.</returns>
        public StartContinuousDtmfRecognitionEventResult WaitForEventProcessor(CancellationToken cancellationToken = default)
        {
