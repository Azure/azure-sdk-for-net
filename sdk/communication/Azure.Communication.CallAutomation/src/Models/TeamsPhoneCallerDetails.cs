...
namespace Azure.Communication.CallAutomation
{
    ...
    public class TeamsPhoneCallerDetails
    {
        ...
        internal TeamsPhoneCallerDetails(CommunicationIdentifier caller, string name, string phoneNumber)
        {
            Argument.AssertNotNull(caller, nameof(caller));
            Argument.AssertNotNull(name, nameof(name));
            Argument.AssertNotNull(phoneNumber, nameof(phoneNumber));

            Caller = CommunicationIdentifierSerializer.Serialize(caller);
            Name = name;
        ...
        internal CommunicationIdentifierModel Caller { get; set; }
