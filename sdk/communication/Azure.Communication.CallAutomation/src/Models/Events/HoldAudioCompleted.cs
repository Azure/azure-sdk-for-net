...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class HoldAudioCompleted : CallAutomationEventBase
    {
        /// <summary>
        /// Reason code.
        /// </summary>
        ...
        internal static HoldAudioCompleted DeserializeHoldAudioCompleted(JsonElement element)
        {
        ...
        internal static HoldAudioCompleted FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeHoldAudioCompleted(document.RootElement);
        }
    }
}
