...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class HoldAudioStarted : CallAutomationEventBase
    {
        ...
        internal HoldAudioStarted(string operationContext, ResultInformation resultInformation, string callConnectionId, string serverCallId, string correlationId)
        {
