...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class RecognizeCompleted : CallAutomationEventWithReasonCodeName
    {
        ...
        /// <param name="choiceResult"> Defines the result for Choice = Dtmf. </param>
        internal RecognizeCompleted(string callConnectionId, string serverCallId, string correlationId,
                                    string operationContext, ResultInformation resultInformation,
                                    CallMediaRecognitionType recognitionType, CollectTonesResult collectTonesResult,
