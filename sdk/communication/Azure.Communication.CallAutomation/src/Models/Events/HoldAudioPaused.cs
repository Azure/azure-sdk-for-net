...
namespace Azure.Communication.CallAutomation
{
    ...
    internal partial class HoldAudioPaused : CallAutomationEventBase
    {
        /// <summary>
        /// Reason code.
        /// </summary>
        ...
        internal static HoldAudioPaused DeserializeHoldAudioPaused(JsonElement element)
        {
        ...
        internal static HoldAudioPaused FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeHoldAudioPaused(document.RootElement);
        }
    }
}
