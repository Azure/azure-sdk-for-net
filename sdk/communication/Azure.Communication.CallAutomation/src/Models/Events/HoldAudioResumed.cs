...
namespace Azure.Communication.CallAutomation
{
    ...
    public partial class HoldAudioResumed : CallAutomationEventBase
    {
        ...
        internal HoldAudioResumed(string operationContext, ResultInformation resultInformation, string callConnectionId, string serverCallId, string correlationId)
        {
