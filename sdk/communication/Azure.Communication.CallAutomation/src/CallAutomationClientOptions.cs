...
namespace Azure.Communication.CallAutomation
{
    ...
    public class CallAutomationClientOptions : ClientOptions
    {
        ...
        internal CommunicationIdentifier SourceIdenty { get; }

        /// <summary>
        /// Initializes a new instance of the <see cref="CallAutomationClientOptions"/>.
        /// </summary>
        public CallAutomationClientOptions(ServiceVersion version = LatestVersion, CommunicationIdentifier sourceIdentity = null)
        {
