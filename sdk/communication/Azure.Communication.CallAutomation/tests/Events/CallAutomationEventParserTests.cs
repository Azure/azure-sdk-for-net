...
namespace Azure.Communication.CallAutomation.Tests.Events
{
    public class CallAutomationEventParserTests
    {
        ...
        [Test]
        public void IncomingCallEventParser_Test()
        {
            // arrange
        ...
        [Test]
        public void IncomingCallEventParser_NullCustomContext_Test()
        {
            // arrange
            var to = new CommunicationUserIdentifier("8:acs:12345");
            var from = new CommunicationUserIdentifier("8:acs:54321");
            ...
            var onBehalfOfCallee = from;
            var correlationId = "correlationId";
            var customContext = new CustomCallingContext(null, null);
            var @event = CallAutomationModelFactory.IncomingCall(to, from, callerDisplayName, serverCallId, customContext, incomingCallContext, onBehalfOfCallee, correlationId);
            ...
            if (parsedEvent is IncomingCall)
            {
                ...
                Assert.AreEqual(customContext.SipHeaders, IncomingCall.CustomContext.SipHeaders);
                Assert.AreEqual(customContext.VoipHeaders, IncomingCall.CustomContext.VoipHeaders);
