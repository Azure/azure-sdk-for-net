...
namespace Azure.Communication.Calling.Server
{
    ...
    internal partial class CreateCallRequestInternal
    {
        ...
        public CreateCallRequestInternal(CommunicationIdentifierModel source, IEnumerable<CommunicationIdentifierModel> targets, string callbackUri, IEnumerable<CallModality> requestedModalities, IEnumerable<EventSubscriptionType> requestedCallEvents)
        {
            if (source == null)
            {
