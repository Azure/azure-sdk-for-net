...
{
    /// <summary>
    /// Represents a long-running phone number search refresh operation.
    /// </summary>
    public class PhoneNumberSearchRefreshOperation : Operation<PhoneNumberSearch>
    {
        private PhoneNumberSearchOperation _searchOperation;

        /// <summary>
        /// Initializes a new <see cref="PhoneNumberSearchRefreshOperation"/> instance
        /// </summary>
