...
namespace Azure.Communication.Administration
{
    internal partial class CommunicationIdentityRestClient
    {
        ...
        /// <param name="endpoint"> Auth and Identity endpoint. </param>
        /// <param name="apiVersion"> Api Version. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="apiVersion"/> is null. </exception>
        public CommunicationIdentityRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string endpoint, string apiVersion = "2020-07-20-preview2")
        {
            if (endpoint == null)
            {
