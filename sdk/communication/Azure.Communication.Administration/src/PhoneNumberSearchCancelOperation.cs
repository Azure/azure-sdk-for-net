...
{
    /// <summary>
    /// Represent a long-running phone number search cancellation operation.
    /// </summary>
    public class PhoneNumberSearchCancelOperation : Operation<PhoneNumberSearch>
    {
        private PhoneNumberSearchOperation _searchOperation;

        /// <summary>
        /// Initializes a new <see cref="PhoneNumberSearchCancelOperation"/> instance
        /// </summary>
