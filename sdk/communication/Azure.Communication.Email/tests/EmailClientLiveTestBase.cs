...
namespace Azure.Communication.Email.Tests
{
    internal class EmailClientLiveTestBase : RecordedTestBase<EmailClientTestEnvironment>
    {
        ...
        public EmailClientLiveTestBase(bool isAsync) : base(isAsync)
        {
            ...
            UriRegexSanitizers.Add(new UriRegexSanitizer(URIRoomsIdReplacerRegEx) { SanitizedValue = "emails/operations/sanitizedId?api" });
            HeaderRegexSanitizers.Add(new HeaderRegexSanitizer("Operation-Location") { SanitizedValue = "https://sanitized.communication.azure.com/emails/operations/sanitizedId?api-version=2023-03-31" });
        }
