...
namespace Azure.Communication.Email
{
    ...
    public partial class EmailMessage
    {
        ...
        internal EmailMessage(IDictionary<string, string> headers, string senderAddress, EmailContent content, EmailRecipients recipients, IList<EmailAttachment> attachments, IList<EmailAddress> replyTo, bool? userEngagementTrackingDisabled, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Headers = headers;
