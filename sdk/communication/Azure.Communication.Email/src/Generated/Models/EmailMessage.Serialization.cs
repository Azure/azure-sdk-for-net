...
namespace Azure.Communication.Email
{
    public partial class EmailMessage : IUtf8JsonSerializable, IJsonModel<EmailMessage>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<EmailMessage>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EmailMessage>)} interface");
            }
        ...
        EmailMessage IJsonModel<EmailMessage>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(EmailMessage)} does not support '{options.Format}' format.");
            }
