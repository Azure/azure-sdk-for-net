...
namespace Azure.Communication.Email
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmailMessage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EmailMessage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EmailMessage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EmailMessage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
