...
namespace Azure.ResourceManager.Communication.Samples
{
    public partial class Sample_CommunicationServiceResource
    {
        ...
        public async Task Delete_DeleteResource()
        {
            ...
            // invoke the operation
            await communicationServiceResource.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
{
[new ResourceIdentifier("/user/assigned/resource/id")] = null
},
                },
                Tags =
{
...
["newTag"] = "newVal"
        ...
        public async Task LinkNotificationHub_LinkNotificationHub()
        {
            ...
            LinkedNotificationHub result = await communicationServiceResource.LinkNotificationHubAsync(content);
