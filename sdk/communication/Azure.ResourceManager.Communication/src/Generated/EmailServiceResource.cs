...
namespace Azure.ResourceManager.Communication
{
    ...
    public partial class EmailServiceResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the EmailServiceResource.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Communication/emailServices/{emailServiceName}. </description>
        ...
        public virtual async Task<ArmOperation<EmailServiceResource>> UpdateAsync(WaitUntil waitUntil, EmailServiceResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _emailServicesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, EmailServiceResourceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CommunicationArmOperation<EmailServiceResource> operation = new CommunicationArmOperation<EmailServiceResource>(
                    new EmailServiceResourceOperationSource(Client),
                    _emailServicesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<EmailServiceResource> Update(WaitUntil waitUntil, EmailServiceResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
