...
namespace Azure.ResourceManager.Communication.Mocking
{
    ...
    internal partial class CommunicationResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="CommunicationResourceGroupMockingExtension"/> class for mocking. </summary>
        protected CommunicationResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CommunicationResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CommunicationResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
