...
namespace Azure.ResourceManager.Communication.Mock
{
    ...
    public partial class CommunicationServiceResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CommunicationServiceResourceExtension"/> class for mocking. </summary>
        protected CommunicationServiceResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CommunicationServiceResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CommunicationServiceResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<CommunicationNameAvailabilityResult>> CheckCommunicationNameAvailabilityAsync(CommunicationServiceNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CommunicationServiceResourceCommunicationServicesClientDiagnostics.CreateScope("CommunicationServiceResourceExtension.CheckCommunicationNameAvailability");
            scope.Start();
            try
            {
