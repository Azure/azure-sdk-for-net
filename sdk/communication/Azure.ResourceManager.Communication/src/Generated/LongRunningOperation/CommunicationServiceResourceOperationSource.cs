...
{
    /// <summary></summary>
    internal partial class CommunicationServiceResourceOperationSource : IOperationSource<CommunicationServiceResource>
    {
        ...
        CommunicationServiceResource IOperationSource<CommunicationServiceResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CommunicationServiceResourceData data = CommunicationServiceResourceData.DeserializeCommunicationServiceResourceData(document.RootElement, ModelSerializationExtensions.WireOptions);
