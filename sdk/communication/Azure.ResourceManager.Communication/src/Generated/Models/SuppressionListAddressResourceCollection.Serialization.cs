...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SuppressionListAddressResourceCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SuppressionListAddressResourceCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SuppressionListAddressResourceCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SuppressionListAddressResourceCollection>)} interface");
            }
        ...
        string IPersistableModel<SuppressionListAddressResourceCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
