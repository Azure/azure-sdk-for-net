...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DomainsRecordVerificationContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DomainsRecordVerificationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DomainsRecordVerificationContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DomainsRecordVerificationContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
