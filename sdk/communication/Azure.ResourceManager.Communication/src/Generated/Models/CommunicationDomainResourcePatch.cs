...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    public partial class CommunicationDomainResourcePatch : CommunicationAcceptTags
    {
        ...
        internal CommunicationDomainResourcePatch(IDictionary<string, string> tags, UserEngagementTracking? userEngagementTracking, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tags, serializedAdditionalRawData)
        {
