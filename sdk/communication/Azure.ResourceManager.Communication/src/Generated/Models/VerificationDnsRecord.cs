...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    public partial class VerificationDnsRecord
    {
        ...
        internal VerificationDnsRecord(string dnsRecordType, string name, string value, int? timeToLiveInSeconds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
