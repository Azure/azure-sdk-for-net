...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunicationNameAvailabilityResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunicationNameAvailabilityResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationNameAvailabilityResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommunicationNameAvailabilityResult>)} interface");
            }
        ...
        string IPersistableModel<CommunicationNameAvailabilityResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
