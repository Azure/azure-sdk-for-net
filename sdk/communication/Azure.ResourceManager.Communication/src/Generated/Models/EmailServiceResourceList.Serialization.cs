...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        internal static EmailServiceResourceList DeserializeEmailServiceResourceList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
