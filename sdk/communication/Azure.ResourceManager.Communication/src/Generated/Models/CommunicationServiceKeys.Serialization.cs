...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunicationServiceKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunicationServiceKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationServiceKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommunicationServiceKeys>)} interface");
            }
        ...
        string IPersistableModel<CommunicationServiceKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
