...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        internal static CommunicationServiceKeys DeserializeCommunicationServiceKeys(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
