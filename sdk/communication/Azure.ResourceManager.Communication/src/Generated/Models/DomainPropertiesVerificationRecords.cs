...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    public partial class DomainPropertiesVerificationRecords
    {
        ...
        internal DomainPropertiesVerificationRecords(VerificationDnsRecord domain, VerificationDnsRecord spf, VerificationDnsRecord dkim, VerificationDnsRecord dkim2, VerificationDnsRecord dmarc, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Domain = domain;
            Spf = spf;
            Dkim = dkim;
