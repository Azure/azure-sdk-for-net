...
namespace Azure.ResourceManager.Communication
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunicationDomainResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunicationDomainResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationDomainResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommunicationDomainResourceData>)} interface");
            }
        ...
        string IPersistableModel<CommunicationDomainResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
