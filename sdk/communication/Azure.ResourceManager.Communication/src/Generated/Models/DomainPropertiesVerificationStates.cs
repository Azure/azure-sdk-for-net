...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    public partial class DomainPropertiesVerificationStates
    {
        ...
        internal DomainPropertiesVerificationStates(DomainVerificationStatusRecord domain, DomainVerificationStatusRecord spf, DomainVerificationStatusRecord dkim, DomainVerificationStatusRecord dkim2, DomainVerificationStatusRecord dmarc, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Domain = domain;
            Spf = spf;
            Dkim = dkim;
