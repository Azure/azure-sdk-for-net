...
namespace Azure.ResourceManager.Communication.Models
{
    internal partial class DomainResourceList : IUtf8JsonSerializable, IModelJsonSerializable<DomainResourceList>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DomainResourceList>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<CommunicationDomainResourceData>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="DomainResourceList"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DomainResourceList"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DomainResourceList"/>. </summary>
