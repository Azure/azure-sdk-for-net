...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    public partial class DomainVerificationStatusRecord
    {
        ...
        internal DomainVerificationStatusRecord(DomainRecordVerificationStatus? status, string errorCode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            ErrorCode = errorCode;
