...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RegenerateCommunicationServiceKeyContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RegenerateCommunicationServiceKeyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RegenerateCommunicationServiceKeyContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RegenerateCommunicationServiceKeyContent>)} interface");
            }
        ...
        string IPersistableModel<RegenerateCommunicationServiceKeyContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
