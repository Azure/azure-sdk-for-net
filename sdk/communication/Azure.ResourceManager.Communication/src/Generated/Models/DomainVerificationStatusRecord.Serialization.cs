...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DomainVerificationStatusRecord>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DomainVerificationStatusRecord>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DomainVerificationStatusRecord>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DomainVerificationStatusRecord>)} interface");
            }
        ...
        string IPersistableModel<DomainVerificationStatusRecord>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
