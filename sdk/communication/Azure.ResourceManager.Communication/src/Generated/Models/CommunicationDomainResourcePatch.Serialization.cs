...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunicationDomainResourcePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunicationDomainResourcePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationDomainResourcePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CommunicationDomainResourcePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
