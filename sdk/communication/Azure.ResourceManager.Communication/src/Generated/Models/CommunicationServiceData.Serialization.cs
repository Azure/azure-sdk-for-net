...
namespace Azure.ResourceManager.Communication
{
    public partial class CommunicationServiceData : IUtf8JsonSerializable
    {
        ...
        internal static CommunicationServiceData DeserializeCommunicationServiceData(JsonElement element)
        {
            ...
            return new CommunicationServiceData(id, name, type, systemData, Optional.ToNullable(provisioningState), hostName.Value, dataLocation.Value, notificationHubId.Value, version.Value, immutableResourceId.Value, location.Value);
        }
    }
}
