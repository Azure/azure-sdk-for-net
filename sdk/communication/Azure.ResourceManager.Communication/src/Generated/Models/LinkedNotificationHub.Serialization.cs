...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinkedNotificationHub>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinkedNotificationHub>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkedNotificationHub>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkedNotificationHub>)} interface");
            }
        ...
        string IPersistableModel<LinkedNotificationHub>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
