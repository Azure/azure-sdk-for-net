...
{
    public partial class LinkedNotificationHub : IUtf8JsonSerializable, IJsonModel<LinkedNotificationHub>, IPersistableModel<LinkedNotificationHub>
    {
        ...
        void IJsonModel<LinkedNotificationHub>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LinkedNotificationHub)} does not support '{format}' format.");
            }
