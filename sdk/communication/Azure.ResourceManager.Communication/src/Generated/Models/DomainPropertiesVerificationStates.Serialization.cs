    ...
    public partial class DomainPropertiesVerificationStates : IUtf8JsonSerializable, IJsonModel<DomainPropertiesVerificationStates>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Domain))
            {
                ...
                AppendChildObject(builder, Domain, options, 2, false);
            }

            if (Optional.IsDefined(Spf))
            {
                builder.Append("  SPF:");
                AppendChildObject(builder, Spf, options, 2, false);
            }

            if (Optional.IsDefined(Dkim))
            {
                builder.Append("  DKIM:");
                AppendChildObject(builder, Dkim, options, 2, false);
            }

            if (Optional.IsDefined(Dkim2))
            {
                builder.Append("  DKIM2:");
                AppendChildObject(builder, Dkim2, options, 2, false);
            }

            if (Optional.IsDefined(Dmarc))
            {
                builder.Append("  DMARC:");
                AppendChildObject(builder, Dmarc, options, 2, false);
            }
