...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DomainPropertiesVerificationStates>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DomainPropertiesVerificationStates>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DomainPropertiesVerificationStates>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DomainPropertiesVerificationStates>)} interface");
            }
        ...
        string IPersistableModel<DomainPropertiesVerificationStates>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
