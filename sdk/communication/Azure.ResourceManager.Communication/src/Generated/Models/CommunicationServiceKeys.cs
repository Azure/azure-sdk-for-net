...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    public partial class CommunicationServiceKeys
    {
        ...
        internal CommunicationServiceKeys(string primaryKey, string secondaryKey, string primaryConnectionString, string secondaryConnectionString, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
