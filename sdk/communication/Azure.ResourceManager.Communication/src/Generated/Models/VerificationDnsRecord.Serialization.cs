...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VerificationDnsRecord>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VerificationDnsRecord>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VerificationDnsRecord>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VerificationDnsRecord>)} interface");
            }
        ...
        string IPersistableModel<VerificationDnsRecord>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
