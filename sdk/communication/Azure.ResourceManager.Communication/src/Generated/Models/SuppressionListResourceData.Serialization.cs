...
namespace Azure.ResourceManager.Communication
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SuppressionListResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SuppressionListResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SuppressionListResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SuppressionListResourceData>)} interface");
            }
        ...
        string IPersistableModel<SuppressionListResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
