...
namespace Azure.ResourceManager.Communication.Models
{
    ...
    public static partial class ArmCommunicationModelFactory
    {
        ...
        {
            return new CommunicationNameAvailabilityResult(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LinkedNotificationHub(resourceId, new Dictionary<string, BinaryData>());
        }
        ...
        public static CommunicationServiceResourceData CommunicationServiceResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, CommunicationServicesProvisioningState? provisioningState = null, string hostName = null, string dataLocation = null, ResourceIdentifier notificationHubId = null, string version = null, Guid? immutableResourceId = null, IEnumerable<string> linkedDomains = null)
        {
            ...
            return new CommunicationServiceResourceData(id, name, resourceType, systemData, tags, location, identity, provisioningState, hostName, dataLocation, notificationHubId, version, immutableResourceId, linkedDomains?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CommunicationServiceKeys(primaryKey, secondaryKey, primaryConnectionString, secondaryConnectionString, new Dictionary<string, BinaryData>());
        }
        ...
        public static CommunicationDomainResourceData CommunicationDomainResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, DomainProvisioningState? provisioningState = null, string dataLocation = null, string fromSenderDomain = null, string mailFromSenderDomain = null, DomainManagement? domainManagement = null, DomainPropertiesVerificationStates verificationStates = null, DomainPropertiesVerificationRecords verificationRecords = null, UserEngagementTracking? userEngagementTracking = null)
        {
            ...
            return new CommunicationDomainResourceData(id, name, resourceType, systemData, tags, location, provisioningState, dataLocation, fromSenderDomain, mailFromSenderDomain, domainManagement, verificationStates, verificationRecords, userEngagementTracking, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DomainPropertiesVerificationStates(domain, spf, dkim, dkim2, dmarc, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DomainVerificationStatusRecord(status, errorCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DomainPropertiesVerificationRecords(domain, spf, dkim, dkim2, dmarc, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new VerificationDnsRecord(dnsRecordType, name, value, timeToLiveInSeconds, new Dictionary<string, BinaryData>());
        }
        ...
        public static EmailServiceResourceData EmailServiceResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, EmailServicesProvisioningState? provisioningState = null, string dataLocation = null)
        {
            ...
            return new EmailServiceResourceData(id, name, resourceType, systemData, tags, location, provisioningState, dataLocation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SenderUsernameResourceData(id, name, resourceType, systemData, dataLocation, username, displayName, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SuppressionListResourceData(id, name, resourceType, systemData, listName, lastUpdatedTimeStamp, createdTimeStamp, dataLocation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SuppressionListAddressResourceData(id, name, resourceType, systemData, email, firstName, lastName, notes, lastModified, dataLocation, new Dictionary<string, BinaryData>());
        }
    }
}
