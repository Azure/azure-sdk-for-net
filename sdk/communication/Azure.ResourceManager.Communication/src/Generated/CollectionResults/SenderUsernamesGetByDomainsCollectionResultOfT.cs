...
{
    internal partial class SenderUsernamesGetByDomainsCollectionResultOfT : Pageable<SenderUsernameResourceData>
    {
        private readonly SenderUsernames _client;
        ...
        /// <returns> The pages of SenderUsernamesGetByDomainsCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<SenderUsernameResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                SenderUsernameResourceListResult result = SenderUsernameResourceListResult.FromResponse(response);
                yield return Page<SenderUsernameResourceData>.FromValues((IReadOnlyList<SenderUsernameResourceData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
