...
namespace Azure.Communication.Chat
{
    ...
    /// </summary>
    public class CrossPlatformMessagingClient
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CrossPlatformMessagingClient"/>.</summary>
        ...
        public CrossPlatformMessagingClient(Uri endpoint, CommunicationTokenCredential communicationTokenCredential, ChatClientOptions options = default)
        {
        ...
        /// <summary>Initializes a new instance of <see cref="CrossPlatformMessagingClient"/> for mocking.</summary>
        protected CrossPlatformMessagingClient()
        {
        ...
        public virtual async Task<Response<SendNotificationResult>> SendNotificationAsync(SendNotificationOptions options, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(CrossPlatformMessagingClient)}.{nameof(SendNotification)}");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="RequestFailedException">The server returned an error. See <see cref="Exception.Message"/> for details returned from the server.</exception>
        public virtual Response<SendNotificationResult> SendNotification(SendNotificationOptions options, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(CrossPlatformMessagingClient)}.{nameof(SendNotification)}");
            scope.Start();
            try
