...
namespace Azure.Communication.Chat
{
    ...
    {
        internal ChatMessageReadReceipt(CommunicationIdentifier communicationIdentifier, string chatMessageId, DateTimeOffset readOn)
        {
            SenderCommunicationIdentifier = communicationIdentifier;
        ...
        {
            SenderCommunicationIdentifier = CommunicationIdentifierSerializer.Deserialize(chatMessageReadReceiptInternal.SenderCommunicationIdentifier);
        ...
        public CommunicationIdentifier SenderCommunicationIdentifier { get; }
