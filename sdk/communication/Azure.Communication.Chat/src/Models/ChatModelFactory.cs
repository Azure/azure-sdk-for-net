...
namespace Azure.Communication.Chat.Models
{
    ...
    public static class ChatModelFactory
    {
        ...
        public static ChatThreadInfo ChatThreadInfo(string id, string topic, bool? isDeleted, DateTimeOffset? deletedOn, DateTimeOffset? lastMessageReceivedOn)
            => new ChatThreadInfo(id, topic, isDeleted, deletedOn, lastMessageReceivedOn);
