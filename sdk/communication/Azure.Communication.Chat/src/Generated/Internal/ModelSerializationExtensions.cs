...
namespace Azure.Communication.Chat
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureCommunicationChatContext.Default) } };
