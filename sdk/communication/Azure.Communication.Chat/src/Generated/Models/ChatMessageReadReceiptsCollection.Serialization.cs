...
namespace Azure.Communication.Chat
{
    ...
    {
        internal static ChatMessageReadReceiptsCollection DeserializeChatMessageReadReceiptsCollection(JsonElement element, SerializableOptions options = default)
        {
