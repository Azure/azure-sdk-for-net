...
namespace Azure.Communication.Chat
{
    ...
    public partial class ChatThreadItem
    {
        ...
        internal ChatThreadItem(string id, string topic, DateTimeOffset? deletedOn, DateTimeOffset? lastMessageReceivedOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Topic = topic;
            DeletedOn = deletedOn;
