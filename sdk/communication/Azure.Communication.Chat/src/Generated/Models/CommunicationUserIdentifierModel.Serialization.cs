...
namespace Azure.Communication
{
    internal partial class CommunicationUserIdentifierModel : IUtf8JsonSerializable, IJsonModel<CommunicationUserIdentifierModel>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationUserIdentifierModel>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommunicationUserIdentifierModel>)} interface");
            }
