...
namespace Azure.Communication.Chat
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AddChatParticipantsResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AddChatParticipantsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AddChatParticipantsResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AddChatParticipantsResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
