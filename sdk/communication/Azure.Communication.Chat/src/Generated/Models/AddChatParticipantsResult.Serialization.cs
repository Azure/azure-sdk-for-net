...
namespace Azure.Communication.Chat
{
    public partial class AddChatParticipantsResult : IUtf8JsonSerializable, IJsonModel<AddChatParticipantsResult>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AddChatParticipantsResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AddChatParticipantsResult>)} interface");
            }
