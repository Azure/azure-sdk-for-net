...
namespace Azure.Communication.Chat
{
    ...
    internal partial class SendChatMessageRequest
    {
        ...
        internal SendChatMessageRequest(string content, string senderDisplayName, ChatMessageType? type, IDictionary<string, string> metadata, Dictionary<string, BinaryData> rawData)
        {
            Content = content;
