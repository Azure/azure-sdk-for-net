...
namespace Azure.Communication.Chat
{
    ...
    internal partial class ChatMessageContentInternal
    {
        ...
        internal ChatMessageContentInternal(string message, string topic, IReadOnlyList<ChatParticipantInternal> participants, CommunicationIdentifierModel initiatorCommunicationIdentifier, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Message = message;
            Topic = topic;
