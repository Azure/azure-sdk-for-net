...
namespace Azure.Communication.Chat
{
    ...
    internal partial class ChatParticipantInternal
    {
        ...
        internal ChatParticipantInternal(CommunicationIdentifierModel communicationIdentifier, string displayName, DateTimeOffset? shareHistoryTime, Dictionary<string, BinaryData> rawData)
        {
            CommunicationIdentifier = communicationIdentifier;
