...
namespace Azure.Communication.Chat
{
    ...
    internal partial class ChatThreadPropertiesInternal
    {
        ...
        internal ChatThreadPropertiesInternal(string id, string topic, DateTimeOffset createdOn, CommunicationIdentifierModel createdByCommunicationIdentifier, DateTimeOffset? deletedOn, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Topic = topic;
            CreatedOn = createdOn;
