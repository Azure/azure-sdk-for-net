...
namespace Azure.Communication.Chat
{
    ...
    {
        internal static ChatThreadPropertiesInternal DeserializeChatThreadPropertiesInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
