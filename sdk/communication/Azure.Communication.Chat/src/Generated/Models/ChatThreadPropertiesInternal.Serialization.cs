...
namespace Azure.Communication.Chat
{
    internal partial class ChatThreadPropertiesInternal
    {
        internal static ChatThreadPropertiesInternal DeserializeChatThreadPropertiesInternal(JsonElement element)
        {
            ...
            return new ChatThreadPropertiesInternal(id, topic, createdOn, createdByCommunicationIdentifier, Optional.ToNullable(deletedOn), Optional.ToDictionary(metadata), retentionPolicy.Value);
        }
    }
}
