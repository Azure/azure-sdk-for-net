...
namespace Azure.Communication.Chat
{
    ...
    {
        internal static ChatThreadsItemCollection DeserializeChatThreadsItemCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
