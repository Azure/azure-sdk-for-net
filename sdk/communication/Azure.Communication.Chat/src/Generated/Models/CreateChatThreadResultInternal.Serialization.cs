...
namespace Azure.Communication.Chat
{
    internal partial class CreateChatThreadResultInternal
    {
        internal static CreateChatThreadResultInternal DeserializeCreateChatThreadResultInternal(JsonElement element)
        {
            ...
            Core.Optional<ChatThreadPropertiesInternal> chatThread = default;
            Core.Optional<IReadOnlyList<ChatError>> invalidParticipants = default;
            ...
            return new CreateChatThreadResultInternal(chatThread.Value, Core.Optional.ToList(invalidParticipants));
        }
    }
}
