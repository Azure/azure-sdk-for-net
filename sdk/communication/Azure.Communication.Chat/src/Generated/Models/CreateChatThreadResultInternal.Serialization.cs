...
namespace Azure.Communication.Chat
{
    ...
    {
        internal static CreateChatThreadResultInternal DeserializeCreateChatThreadResultInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
