...
namespace Azure.Communication.Chat
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChatThreadItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ChatThreadItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ChatThreadItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ChatThreadItem>)} interface");
            }
        ...
        string IPersistableModel<ChatThreadItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
