...
namespace Azure.Communication.Chat
{
    public partial class ChatThreadItem
    {
        internal static ChatThreadItem DeserializeChatThreadItem(JsonElement element)
        {
            ...
            Core.Optional<DateTimeOffset> lastMessageReceivedOn = default;
            ...
            return new ChatThreadItem(id, topic, Core.Optional.ToNullable(deletedOn), Core.Optional.ToNullable(lastMessageReceivedOn));
        }
    }
}
