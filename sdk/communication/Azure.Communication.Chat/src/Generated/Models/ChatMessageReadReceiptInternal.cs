...
namespace Azure.Communication.Chat
{
    ...
    internal partial class ChatMessageReadReceiptInternal
    {
        ...
        internal ChatMessageReadReceiptInternal(CommunicationIdentifierModel senderCommunicationIdentifier, string chatMessageId, DateTimeOffset readOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SenderCommunicationIdentifier = senderCommunicationIdentifier;
            ChatMessageId = chatMessageId;
            ReadOn = readOn;
