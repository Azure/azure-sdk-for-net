...
namespace Azure.Communication.Chat
{
    ...
    {
        internal static ChatMessageReadReceiptInternal DeserializeChatMessageReadReceiptInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
