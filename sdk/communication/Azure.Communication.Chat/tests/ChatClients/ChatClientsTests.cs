    ...
    public class ChatClientsTests : ClientTestBase
    {
        ...
        public async Task OrderInGetReadReceiptsIteratorIsNotAltered()
        {
            ...
            await foreach (ChatMessageReadReceipt readReceipt in allReadReceipts)
            {
                ...
                Assert.AreEqual($"{baseSenderId}{idCounter}", readReceipt.Sender);
        ...
        public async Task CreateChatThreadShouldExposePartialErrors()
        {
            ...
            Assert.AreEqual("8:acs:46849534-eb08-4ab7-bde7-c36928cd1547_00000007-165c-9b10-b0b7-3a3a0d00076c", createChatThreadResult.ChatThread.CreatedBy);
