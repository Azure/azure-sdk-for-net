...
{
    public partial class MediaNotificationContent : IUtf8JsonWriteable, IJsonModel<MediaNotificationContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaNotificationContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new MediaNotificationContent FromResponse(PipelineResponse response)
        {
