...
{
    public partial class WhatsAppMessageTemplateBindingsButton : IUtf8JsonWriteable, IJsonModel<WhatsAppMessageTemplateBindingsButton>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<WhatsAppMessageTemplateBindingsButton>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static WhatsAppMessageTemplateBindingsButton FromResponse(PipelineResponse response)
        {
