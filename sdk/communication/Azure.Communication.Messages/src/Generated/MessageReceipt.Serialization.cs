...
{
    public partial class MessageReceipt : IUtf8JsonWriteable, IJsonModel<MessageReceipt>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageReceipt>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static MessageReceipt FromResponse(PipelineResponse response)
        {
