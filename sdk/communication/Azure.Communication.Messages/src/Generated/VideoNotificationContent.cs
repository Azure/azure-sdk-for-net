...
namespace Azure.Communication.Messages
{
    ...
    public partial class VideoNotificationContent : NotificationContent
    {
        ...
        public VideoNotificationContent(Guid channelRegistrationId, IEnumerable<string> to, Uri mediaUri) : base(channelRegistrationId, to)
        {
        ...
        /// <param name="mediaUri"> A media url for the file. Required if the type is one of the supported media types, e.g. image. </param>
        internal VideoNotificationContent(Guid channelRegistrationId, IList<string> to, CommunicationMessageKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, string caption, Uri mediaUri) : base(channelRegistrationId, to, kind, serializedAdditionalRawData)
        {
            Caption = caption;
            MediaUri = mediaUri;
        }
