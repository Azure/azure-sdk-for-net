...
{
    public partial class TextNotificationContent : IUtf8JsonWriteable, IJsonModel<TextNotificationContent>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<TextNotificationContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new TextNotificationContent FromResponse(PipelineResponse response)
        {
