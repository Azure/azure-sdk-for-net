...
{
    public partial class MessageTemplateDocument : IUtf8JsonWriteable, IJsonModel<MessageTemplateDocument>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTemplateDocument>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new MessageTemplateDocument FromResponse(PipelineResponse response)
        {
