...
{
    public partial class ImageNotificationContent : IUtf8JsonSerializable, IJsonModel<ImageNotificationContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageNotificationContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImageNotificationContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ImageNotificationContent IJsonModel<ImageNotificationContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImageNotificationContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<ImageNotificationContent>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImageNotificationContent>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ImageNotificationContent IPersistableModel<ImageNotificationContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ImageNotificationContent>)this).GetFormatFromOptions(options) : options.Format;
