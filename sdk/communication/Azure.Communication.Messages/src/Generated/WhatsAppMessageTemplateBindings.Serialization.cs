...
{
    public partial class WhatsAppMessageTemplateBindings : IUtf8JsonWriteable, IJsonModel<WhatsAppMessageTemplateBindings>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<WhatsAppMessageTemplateBindings>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new WhatsAppMessageTemplateBindings FromResponse(PipelineResponse response)
        {
