...
namespace Azure.Communication.Messages
{
    ...
    public partial class ImageConversationMessageContent : ConversationMessageContent
    {
        ...
        public ImageConversationMessageContent(Uri mediaUri)
        {
        ...
        /// <param name="mediaUri"> A media url for the file. Required if the type is one of the supported media types, e.g. image. </param>
        internal ImageConversationMessageContent(CommunicationMessageKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, string caption, Uri mediaUri) : base(kind, serializedAdditionalRawData)
        {
            Caption = caption;
            MediaUri = mediaUri;
        }

        /// <summary> Initializes a new instance of <see cref="ImageConversationMessageContent"/> for deserialization. </summary>
