...
{
    public partial class VideoNotificationContent : IUtf8JsonSerializable, IJsonModel<VideoNotificationContent>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VideoNotificationContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<VideoNotificationContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<VideoNotificationContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        VideoNotificationContent IJsonModel<VideoNotificationContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VideoNotificationContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<VideoNotificationContent>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VideoNotificationContent>)this).GetFormatFromOptions(options) : options.Format;
        ...
        VideoNotificationContent IPersistableModel<VideoNotificationContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<VideoNotificationContent>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<VideoNotificationContent>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
