...
namespace Azure.Communication.Messages
{
    ...
    public partial class ImageNotificationContent : NotificationContent
    {
        ...
        public ImageNotificationContent(Guid channelRegistrationId, IEnumerable<string> to, Uri mediaUri) : base(channelRegistrationId, to, CommunicationMessageKind.Image)
        {
        ...
        /// <param name="mediaUri"> A media url for the file. Required if the type is one of the supported media types, e.g. image. </param>
        internal ImageNotificationContent(Guid channelRegistrationId, IList<string> to, CommunicationMessageKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, string caption, Uri mediaUri) : base(channelRegistrationId, to, kind, additionalBinaryDataProperties)
        {
            Caption = caption;
            MediaUri = mediaUri;
        }
