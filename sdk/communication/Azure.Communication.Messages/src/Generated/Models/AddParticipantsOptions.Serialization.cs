...
namespace Azure.Communication.Messages
{
    ...
    public partial class AddParticipantsOptions : IJsonModel<AddParticipantsOptions>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AddParticipantsOptions>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AddParticipantsOptions>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AddParticipantsOptions IPersistableModel<AddParticipantsOptions>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<AddParticipantsOptions>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="addParticipantsOptions"> The <see cref="AddParticipantsOptions"/> to serialize into <see cref="RequestContent"/>. </param>
        public static implicit operator RequestContent(AddParticipantsOptions addParticipantsOptions)
        {
            ...
            return RequestContent.Create(addParticipantsOptions, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AddParticipantsOptions IJsonModel<AddParticipantsOptions>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
