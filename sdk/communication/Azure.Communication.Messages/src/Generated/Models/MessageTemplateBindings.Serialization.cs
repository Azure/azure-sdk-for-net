...
namespace Azure.Communication.Messages
{
    ...
    public abstract partial class MessageTemplateBindings : IJsonModel<MessageTemplateBindings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MessageTemplateBindings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MessageTemplateBindings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MessageTemplateBindings IPersistableModel<MessageTemplateBindings>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MessageTemplateBindings IJsonModel<MessageTemplateBindings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        internal static MessageTemplateBindings DeserializeMessageTemplateBindings(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            if (element.TryGetProperty("kind"u8, out JsonElement discriminator))
            {
                ...
                {
                    case "whatsApp":
                        return WhatsAppMessageTemplateBindings.DeserializeWhatsAppMessageTemplateBindings(element, options);
                }
            }
