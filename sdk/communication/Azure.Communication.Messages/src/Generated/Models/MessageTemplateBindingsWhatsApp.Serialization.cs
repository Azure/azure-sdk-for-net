...
namespace Azure.Communication.Messages
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTemplateBindingsWhatsApp>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MessageTemplateBindingsWhatsApp>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MessageTemplateBindingsWhatsApp>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MessageTemplateBindingsWhatsApp>)} interface");
            }
        ...
        string IPersistableModel<MessageTemplateBindingsWhatsApp>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
