...
namespace Azure.Communication.Messages
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTemplateBindingsWhatsApp>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MessageTemplateBindingsWhatsApp IJsonModel<MessageTemplateBindingsWhatsApp>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(MessageTemplateBindingsWhatsApp)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<MessageTemplateBindingsWhatsApp>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MessageTemplateBindingsWhatsApp IModel<MessageTemplateBindingsWhatsApp>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MessageTemplateBindingsWhatsApp>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
