...
namespace Azure.Communication.Messages
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TemplateResponseInternal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TemplateResponseInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TemplateResponseInternal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<TemplateResponseInternal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
