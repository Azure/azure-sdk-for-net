...
namespace Azure.Communication.Messages
{
    ...
    public partial class MessageTemplateDocument : MessageTemplateValue
    {
        ...
        public MessageTemplateDocument(string name, Uri uri) : base(name, MessageTemplateValueKind.Document)
        {
        ...
        internal MessageTemplateDocument(string name, MessageTemplateValueKind kind, IDictionary<string, BinaryData> additionalBinaryDataProperties, Uri uri, string caption, string fileName) : base(name, kind, additionalBinaryDataProperties)
        {
            Uri = uri;
            Caption = caption;
            FileName = fileName;
