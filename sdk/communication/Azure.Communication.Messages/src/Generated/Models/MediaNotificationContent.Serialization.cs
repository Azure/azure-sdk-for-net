...
namespace Azure.Communication.Messages
{
    ...
    public partial class MediaNotificationContent : NotificationContent, IJsonModel<MediaNotificationContent>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MediaNotificationContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MediaNotificationContent>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MediaNotificationContent IPersistableModel<MediaNotificationContent>.Create(BinaryData data, ModelReaderWriterOptions options) => (MediaNotificationContent)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MediaNotificationContent IJsonModel<MediaNotificationContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MediaNotificationContent)JsonModelCreateCore(ref reader, options);
