...
namespace Azure.Communication.Messages
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="VideoConversationMessageContent"/>. </summary>
        ...
        /// <param name="mediaUri"> A media url for the file. Required if the type is one of the supported media types, e.g. image. </param>
        internal VideoConversationMessageContent(CommunicationMessageKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, string caption, Uri mediaUri) : base(kind, serializedAdditionalRawData)
        {
            Caption = caption;
            MediaUri = mediaUri;
        }

        /// <summary> Initializes a new instance of <see cref="VideoConversationMessageContent"/> for deserialization. </summary>
        internal VideoConversationMessageContent()
        {
        }
