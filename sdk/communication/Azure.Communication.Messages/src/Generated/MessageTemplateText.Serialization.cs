...
{
    public partial class MessageTemplateText : IUtf8JsonWriteable, IJsonModel<MessageTemplateText>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTemplateText>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new MessageTemplateText FromResponse(PipelineResponse response)
        {
