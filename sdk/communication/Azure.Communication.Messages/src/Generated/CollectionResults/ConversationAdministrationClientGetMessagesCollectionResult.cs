...
namespace Azure.Communication.Messages
{
    internal partial class ConversationAdministrationClientGetMessagesCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of ConversationAdministrationClientGetMessagesCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConversationAdministrationClientGetMessagesCollectionResult(ConversationAdministrationClient client, string conversationId, int? maxPageSize, string participantId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ConversationAdministrationClientGetMessagesCollectionResult as an enumerable collection. </summary>
