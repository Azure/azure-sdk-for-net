...
namespace Azure.Communication.Messages
{
    internal partial class MessageTemplateClientGetTemplatesAsyncCollectionResultOfT : AsyncPageable<MessageTemplateItem>
    {
        ...
        public MessageTemplateClientGetTemplatesAsyncCollectionResultOfT(MessageTemplateClient client, Guid channelId, int? maxPageSize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
