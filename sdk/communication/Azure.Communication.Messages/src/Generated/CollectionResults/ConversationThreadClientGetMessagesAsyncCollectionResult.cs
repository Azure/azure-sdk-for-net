...
namespace Azure.Communication.Messages
{
    internal partial class ConversationThreadClientGetMessagesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public ConversationThreadClientGetMessagesAsyncCollectionResult(ConversationThreadClient client, string conversationId, int? maxPageSize, string participantId, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
