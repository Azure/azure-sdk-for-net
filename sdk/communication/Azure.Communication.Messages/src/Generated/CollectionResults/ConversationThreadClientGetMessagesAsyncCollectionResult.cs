...
{
    internal partial class ConversationThreadClientGetMessagesAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of ConversationThreadClientGetMessagesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConversationThreadClientGetMessagesAsyncCollectionResult(ConversationThreadClient client, string conversationId, int? maxPageSize, string participantId, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ConversationThreadClientGetMessagesAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ConversationThreadClientGetMessagesAsyncCollectionResult as an enumerable collection. </returns>
