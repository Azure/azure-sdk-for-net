...
{
    internal partial class ConversationAdministrationClientGetConversationsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of ConversationAdministrationClientGetConversationsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public ConversationAdministrationClientGetConversationsAsyncCollectionResult(ConversationAdministrationClient client, int? maxPageSize, string participantId, Guid? channelId, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ConversationAdministrationClientGetConversationsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ConversationAdministrationClientGetConversationsAsyncCollectionResult as an enumerable collection. </returns>
