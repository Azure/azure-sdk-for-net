...
namespace Azure.Communication.Messages
{
    internal partial class MessageTemplateClientGetTemplatesAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of MessageTemplateClientGetTemplatesAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public MessageTemplateClientGetTemplatesAsyncCollectionResult(MessageTemplateClient client, Guid channelId, int? maxPageSize, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of MessageTemplateClientGetTemplatesAsyncCollectionResult as an enumerable collection. </summary>
