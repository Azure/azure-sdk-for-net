...
{
    internal partial class UnknownMessageTemplateItem : IUtf8JsonWriteable, IJsonModel<MessageTemplateItem>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTemplateItem>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new UnknownMessageTemplateItem FromResponse(PipelineResponse response)
        {
