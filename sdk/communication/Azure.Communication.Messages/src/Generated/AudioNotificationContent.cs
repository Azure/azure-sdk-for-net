...
namespace Azure.Communication.Messages
{
    ...
    public partial class AudioNotificationContent : NotificationContent
    {
        ...
        public AudioNotificationContent(Guid channelRegistrationId, IEnumerable<string> to, Uri mediaUri) : base(channelRegistrationId, to)
        {
        ...
        /// <param name="mediaUri"> A media url for the file. Required if the type is one of the supported media types, e.g. image. </param>
        internal AudioNotificationContent(Guid channelRegistrationId, IList<string> to, CommunicationMessageKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, Uri mediaUri) : base(channelRegistrationId, to, kind, serializedAdditionalRawData)
        {
            MediaUri = mediaUri;
        }
