...
namespace Azure.Communication.Messages.Models.Channels
{
    ...
    public partial class WhatsAppMessageTemplateItem : MessageTemplateItem
    {
        ...
        internal WhatsAppMessageTemplateItem(CommunicationMessagesChannel kind, string name, string language, MessageTemplateStatus status, IDictionary<string, BinaryData> serializedAdditionalRawData, BinaryData content) : base(kind, name, language, status, serializedAdditionalRawData)
        {
            Content = content;
        }
