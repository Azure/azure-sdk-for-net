...
namespace Azure.Communication.Messages
{
    ...
    /// <summary> The ConversationMessages service client. </summary>
    public partial class ConversationMessagesClient
    {
        ...
        public ConversationMessagesClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new CommunicationMessagesClientOptions())
        {
        }
        ...
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ConversationMessagesClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new CommunicationMessagesClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ConversationMessagesClient(Uri endpoint, TokenCredential credential, CommunicationMessagesClientOptions options)
        {
        ...
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='AddParticipantsAsync(string,AddParticipantsRequest,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> or <paramref name="body"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='AddParticipants(string,AddParticipantsRequest,CancellationToken)']/*" />
        ...
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='AddParticipantsAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> AddParticipantsAsync(string conversationId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationMessagesClient.AddParticipants");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='AddParticipants(string,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> or <paramref name="body"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='RemoveParticipantsAsync(string,RemoveParticipantsRequest,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> or <paramref name="body"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='RemoveParticipants(string,RemoveParticipantsRequest,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='RemoveParticipantsAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> RemoveParticipantsAsync(string conversationId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationMessagesClient.RemoveParticipants");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='RemoveParticipants(string,RequestContent,RequestContext)']/*" />
        ...
        /// <param name="conversationId"> The conversation ID. </param>
        /// <param name="body"> Details of the conversation message to send. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> or <paramref name="body"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='SendMessageAsync(string,SendConversationMessageRequest,CancellationToken)']/*" />
        public virtual async Task<Response<SendConversationMessageResult>> SendMessageAsync(string conversationId, SendConversationMessageRequest body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> or <paramref name="body"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='SendMessage(string,SendConversationMessageRequest,CancellationToken)']/*" />
        public virtual Response<SendConversationMessageResult> SendMessage(string conversationId, SendConversationMessageRequest body, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            Argument.AssertNotNull(body, nameof(body));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="SendMessageAsync(string,SendConversationMessageRequest,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='SendMessageAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> SendMessageAsync(string conversationId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("ConversationMessagesClient.SendMessage");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="SendMessage(string,SendConversationMessageRequest,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='SendMessage(string,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='AnalyzeConversationAsync(string,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='AnalyzeConversation(string,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='AnalyzeConversationAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> AnalyzeConversationAsync(string conversationId, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));

            using var scope = ClientDiagnostics.CreateScope("ConversationMessagesClient.AnalyzeConversation");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='AnalyzeConversation(string,RequestContext)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='GetConversationsAsync(int?,string,Guid?,CancellationToken)']/*" />
        public virtual AsyncPageable<Conversation> GetConversationsAsync(int? maxpagesize = null, string participantId = null, Guid? channelId = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => Conversation.DeserializeConversation(e), ClientDiagnostics, _pipeline, "ConversationMessagesClient.GetConversations", "value", "nextLink", maxpagesize, context);
        }
        ...
        /// <param name="channelId"> The id of channel. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='GetConversations(int?,string,Guid?,CancellationToken)']/*" />
        public virtual Pageable<Conversation> GetConversations(int? maxpagesize = null, string participantId = null, Guid? channelId = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConversationsRequest(pageSizeHint, participantId, channelId, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConversationsNextPageRequest(nextLink, pageSizeHint, participantId, channelId, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => Conversation.DeserializeConversation(e), ClientDiagnostics, _pipeline, "ConversationMessagesClient.GetConversations", "value", "nextLink", maxpagesize, context);
        }
        ...
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='GetConversationsAsync(int?,string,Guid?,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetConversationsAsync(int? maxpagesize, string participantId, Guid? channelId, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConversationsRequest(pageSizeHint, participantId, channelId, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConversationsNextPageRequest(nextLink, pageSizeHint, participantId, channelId, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ConversationMessagesClient.GetConversations", "value", "nextLink", maxpagesize, context);
        }
        ...
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='GetConversations(int?,string,Guid?,RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetConversations(int? maxpagesize, string participantId, Guid? channelId, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetConversationsRequest(pageSizeHint, participantId, channelId, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetConversationsNextPageRequest(nextLink, pageSizeHint, participantId, channelId, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ConversationMessagesClient.GetConversations", "value", "nextLink", maxpagesize, context);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='GetMessagesAsync(string,int?,string,CancellationToken)']/*" />
        public virtual AsyncPageable<ConversationMessageItem> GetMessagesAsync(string conversationId, int? maxpagesize = null, string participantId = null, CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => ConversationMessageItem.DeserializeConversationMessageItem(e), ClientDiagnostics, _pipeline, "ConversationMessagesClient.GetMessages", "value", "nextLink", maxpagesize, context);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="conversationId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='GetMessages(string,int?,string,CancellationToken)']/*" />
        public virtual Pageable<ConversationMessageItem> GetMessages(string conversationId, int? maxpagesize = null, string participantId = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetMessagesRequest(conversationId, pageSizeHint, participantId, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetMessagesNextPageRequest(nextLink, conversationId, pageSizeHint, participantId, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => ConversationMessageItem.DeserializeConversationMessageItem(e), ClientDiagnostics, _pipeline, "ConversationMessagesClient.GetMessages", "value", "nextLink", maxpagesize, context);
        }
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="AsyncPageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='GetMessagesAsync(string,int?,string,RequestContext)']/*" />
        public virtual AsyncPageable<BinaryData> GetMessagesAsync(string conversationId, int? maxpagesize, string participantId, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetMessagesRequest(conversationId, pageSizeHint, participantId, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetMessagesNextPageRequest(nextLink, conversationId, pageSizeHint, participantId, context);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ConversationMessagesClient.GetMessages", "value", "nextLink", maxpagesize, context);
        }
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Pageable{T}"/> from the service containing a list of <see cref="BinaryData"/> objects. Details of the body schema for each item in the collection are in the Remarks section below. </returns>
        /// <include file="Docs/ConversationMessagesClient.xml" path="doc/members/member[@name='GetMessages(string,int?,string,RequestContext)']/*" />
        public virtual Pageable<BinaryData> GetMessages(string conversationId, int? maxpagesize, string participantId, RequestContext context)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetMessagesRequest(conversationId, pageSizeHint, participantId, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetMessagesNextPageRequest(nextLink, conversationId, pageSizeHint, participantId, context);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "ConversationMessagesClient.GetMessages", "value", "nextLink", maxpagesize, context);
        }
