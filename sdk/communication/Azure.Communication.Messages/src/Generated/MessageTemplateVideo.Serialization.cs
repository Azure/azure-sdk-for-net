...
{
    public partial class MessageTemplateVideo : IUtf8JsonWriteable, IJsonModel<MessageTemplateVideo>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTemplateVideo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new MessageTemplateVideo FromResponse(PipelineResponse response)
        {
