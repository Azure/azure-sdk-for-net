...
{
    public partial class ConversationMessageItem : IUtf8JsonSerializable, IJsonModel<ConversationMessageItem>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConversationMessageItem>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationMessageItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        ConversationMessageItem IJsonModel<ConversationMessageItem>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationMessageItem>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<ConversationMessageItem>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationMessageItem>)this).GetFormatFromOptions(options) : options.Format;
        ...
        ConversationMessageItem IPersistableModel<ConversationMessageItem>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ConversationMessageItem>)this).GetFormatFromOptions(options) : options.Format;
