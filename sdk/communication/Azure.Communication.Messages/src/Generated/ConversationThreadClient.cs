...
namespace Azure.Communication.Messages
{
    ...
    public partial class ConversationThreadClient
    {
        ...
        public ConversationThreadClient(global::System.Uri endpoint, TokenCredential credential) : this(endpoint, credential, new CommunicationMessagesClientOptions())
        {
        }
        ...
        internal ConversationThreadClient(HttpPipelinePolicy authenticationPolicy, global::System.Uri endpoint, CommunicationMessagesClientOptions options)
        {
        ...
        /// <param name="options"> The options for configuring the client. </param>
        /// <exception cref="global::System.ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ConversationThreadClient(global::System.Uri endpoint, TokenCredential credential, CommunicationMessagesClientOptions options) : this(new BearerTokenAuthenticationPolicy(credential, AuthorizationScopes), endpoint, options)
        {
        }
        ...
        public virtual Response SendMessage(string conversationId, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = this.CreateSendMessageRequest(conversationId, content, context);
                return Pipeline.ProcessMessage(message, context);
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="global::Azure.RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        public virtual async Task<global::Azure.Response> SendMessageAsync(string conversationId, RequestContent content, RequestContext context = null)
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ConversationThreadClient.SendMessage");
            scope.Start();
            try
        ...
        /// <exception cref="global::System.ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="global::Azure.RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual Response<global::Azure.Communication.Messages.SendConversationMessageResult> SendMessage(string conversationId, SendConversationMessageOptions options, CancellationToken cancellationToken = default)
        {
            global::Azure.Communication.Messages.Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            global::Azure.Communication.Messages.Argument.AssertNotNull(options, nameof(options));

            Response result = this.SendMessage(conversationId, options, cancellationToken.ToRequestContext());
            return global::Azure.Response.FromValue(((SendConversationMessageResult)result), result);
        }
        ...
        /// <exception cref="global::System.ArgumentException"> <paramref name="conversationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="global::Azure.RequestFailedException"> Service returned a non-success status code. </exception>
        public virtual async Task<global::Azure.Response<global::Azure.Communication.Messages.SendConversationMessageResult>> SendMessageAsync(string conversationId, SendConversationMessageOptions options, CancellationToken cancellationToken = default)
        {
            global::Azure.Communication.Messages.Argument.AssertNotNullOrEmpty(conversationId, nameof(conversationId));
            global::Azure.Communication.Messages.Argument.AssertNotNull(options, nameof(options));

            Response result = await this.SendMessageAsync(conversationId, options, cancellationToken.ToRequestContext()).ConfigureAwait(false);
            return global::Azure.Response.FromValue(((SendConversationMessageResult)result), result);
        }
