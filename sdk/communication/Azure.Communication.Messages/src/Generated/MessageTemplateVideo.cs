...
namespace Azure.Communication.Messages
{
    ...
    public partial class MessageTemplateVideo : MessageTemplateValue
    {
        ...
        internal MessageTemplateVideo(MessageTemplateValueKind kind, string name, IDictionary<string, BinaryData> serializedAdditionalRawData, Uri uri, string caption, string fileName) : base(kind, name, serializedAdditionalRawData)
        {
            Uri = uri;
            Caption = caption;
            FileName = fileName;
