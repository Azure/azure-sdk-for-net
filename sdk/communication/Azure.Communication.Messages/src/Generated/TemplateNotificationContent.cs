...
namespace Azure.Communication.Messages
{
    ...
    public partial class TemplateNotificationContent : NotificationContent
    {
        ...
        /// <param name="template"> The template object used to create templates. </param>
        internal TemplateNotificationContent(CommunicationMessageKind kind, Guid channelRegistrationId, IList<string> to, IDictionary<string, BinaryData> serializedAdditionalRawData, MessageTemplate template) : base(kind, channelRegistrationId, to, serializedAdditionalRawData)
        {
            Template = template;
        }
