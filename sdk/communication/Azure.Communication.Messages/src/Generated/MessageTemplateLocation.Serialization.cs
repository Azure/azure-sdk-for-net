...
{
    public partial class MessageTemplateLocation : IUtf8JsonWriteable, IJsonModel<MessageTemplateLocation>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTemplateLocation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MessageTemplateLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MessageTemplateLocation)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MessageTemplateLocation>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MessageTemplateLocation)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static new MessageTemplateLocation FromResponse(PipelineResponse response)
        {
