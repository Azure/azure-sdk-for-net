...
namespace Azure.Communication.Messages
{
    ...
    public partial class MessageTemplateClient
    {
        ...
        public MessageTemplateClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new AzureCommunicationMessagesServiceClientOptions())
        {
        }
        ...
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public MessageTemplateClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new AzureCommunicationMessagesServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public MessageTemplateClient(Uri endpoint, AzureKeyCredential credential, AzureCommunicationMessagesServiceClientOptions options)
        {
        ...
        /// <param name="options"> The options for configuring the client. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public MessageTemplateClient(Uri endpoint, TokenCredential credential, AzureCommunicationMessagesServiceClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new AzureCommunicationMessagesServiceClientOptions();
        ...
        public virtual AsyncPageable<MessageTemplateItem> GetTemplatesAsync(Guid channelId, int? maxpagesize = null, CancellationToken cancellationToken = default)
        {
            ...
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetTemplatesRequest(channelId, pageSizeHint, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetTemplatesNextPageRequest(nextLink, channelId, pageSizeHint, context);
