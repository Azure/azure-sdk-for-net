...
namespace Azure.Communication.Messages
{
    ...
    public partial class TextNotificationContent : NotificationContent
    {
        ...
        /// <param name="content"> Message content. </param>
        internal TextNotificationContent(CommunicationMessageKind kind, Guid channelRegistrationId, IList<string> to, IDictionary<string, BinaryData> serializedAdditionalRawData, string content) : base(kind, channelRegistrationId, to, serializedAdditionalRawData)
        {
            Content = content;
        }
