...
namespace Azure.Communication.Messages
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTemplateQuickAction>)this).Write(writer, ModelSerializationExtensions.WireOptions);
