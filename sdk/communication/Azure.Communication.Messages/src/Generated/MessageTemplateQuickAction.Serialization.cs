...
{
    public partial class MessageTemplateQuickAction : IUtf8JsonWriteable, IJsonModel<MessageTemplateQuickAction>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTemplateQuickAction>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new MessageTemplateQuickAction FromResponse(PipelineResponse response)
        {
