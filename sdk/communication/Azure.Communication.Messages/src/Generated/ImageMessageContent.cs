...
namespace Azure.Communication.Messages
{
    ...
    public partial class ImageMessageContent : MessageContent
    {
        ...
        public ImageMessageContent(Uri mediaUri)
        {
        ...
        /// <param name="mediaUri"> MediaUri of the media content. </param>
        internal ImageMessageContent(MessageContentKind kind, IDictionary<string, BinaryData> serializedAdditionalRawData, Uri mediaUri) : base(kind, serializedAdditionalRawData)
        {
            MediaUri = mediaUri;
        }
