...
namespace Azure.Communication.Messages
{
    ...
    public partial class NotificationMessagesClient
    {
        ...
        public NotificationMessagesClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new MessagesClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public NotificationMessagesClient(Uri endpoint, TokenCredential credential, MessagesClientOptions options)
        {
