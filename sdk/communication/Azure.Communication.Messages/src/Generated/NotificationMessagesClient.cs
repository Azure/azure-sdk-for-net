...
namespace Azure.Communication.Messages
{
    ...
    public partial class NotificationMessagesClient
    {
        ...
        public NotificationMessagesClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new AzureCommunicationMessagesServiceClientOptions())
        {
        }
        ...
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public NotificationMessagesClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new AzureCommunicationMessagesServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public NotificationMessagesClient(Uri endpoint, AzureKeyCredential credential, AzureCommunicationMessagesServiceClientOptions options)
        {
        ...
        /// <param name="options"> The options for configuring the client. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public NotificationMessagesClient(Uri endpoint, TokenCredential credential, AzureCommunicationMessagesServiceClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new AzureCommunicationMessagesServiceClientOptions();
