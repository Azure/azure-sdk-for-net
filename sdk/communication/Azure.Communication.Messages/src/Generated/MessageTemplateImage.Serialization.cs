...
{
    public partial class MessageTemplateImage : IUtf8JsonWriteable, IJsonModel<MessageTemplateImage>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<MessageTemplateImage>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static new MessageTemplateImage FromResponse(PipelineResponse response)
        {
