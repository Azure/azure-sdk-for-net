...
namespace Azure.Communication
{
    public class CommunicationIdentifierTest
    {
        ...
        public void EqualityOperatorOverrideDoesntThrow()
        {
            ...
            Assert.That(identifier == null as CommunicationIdentifier, Is.False);
            Assert.That(null as CommunicationIdentifier == identifier, Is.False);
            Assert.That(identifier != null as CommunicationIdentifier, Is.True);
            Assert.That(null as CommunicationIdentifier != identifier, Is.True);

            Assert.That(null == nullIdentifier, Is.True);
            Assert.That(nullIdentifier == identifier, Is.False);
...
#pragma warning restore CS1718 // Comparison made to same variable
            ...
            Assert.That(identifier == otherIdentifier, Is.False);
            Assert.That(identifier != otherIdentifier, Is.True);
            Assert.That(identifier == otherTypeIdentifier, Is.False);
            Assert.That(identifier != otherTypeIdentifier, Is.True);
        }
    }
}
