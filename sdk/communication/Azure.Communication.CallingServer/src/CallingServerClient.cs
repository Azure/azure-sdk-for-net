...
namespace Azure.Communication.CallingServer
{
    ...
    public class CallingServerClient
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CallConnection"/>.</summary>
        ...
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(CallingServerClient)}.{nameof(CreateCallConnectionAsync)}");
            scope.Start();
            try
            {
                ...
                var createCallResponse = await CallConnectionRestClient.CreateCallAsync(
                    ...
                    requestedMediaTypes: options.RequestedModalities,
        ...
        /// Join the call using call locator.
        /// <param name="callLocator">The locator to join the call.</param>
        /// <param name="source"> The source identity. </param>
        ...
        public virtual async Task<Response<CallConnection>> JoinCallConnectionAsync(CallLocator callLocator, CommunicationIdentifier source, JoinCallOptions callOptions, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _clientDiagnostics.CreateScope($"{nameof(CallingServerClient)}.{nameof(JoinCallConnectionAsync)}");
            scope.Start();
            try
            {
                ...
                return Response.FromValue(
                    new CallConnection(joinCallResponse.Value.CallLegId, CallConnectionRestClient, _clientDiagnostics),
        ...
        /// <exception cref="ArgumentNullException"><paramref name="callLocator"/> is null.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="callOptions"/> is null.</exception>
        public virtual Response<CallConnection> JoinCallConnection(CallLocator callLocator, CommunicationIdentifier source, JoinCallOptions callOptions, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="callLocator">The locator used for joining call.</param>
        /// <returns></returns>
        public virtual ServerCall InitializeServerCall(CallLocator callLocator)
        {
        ...
        private static string GetServerCallId(CallLocator callLocator)
        {
            string serverCallId = null;
            if (callLocator is ServerCallLocator serverCallLocator)
            {
                serverCallId = serverCallLocator.Id;
            }
            else if (callLocator is GroupCallLocator groupCallLocator)
            {
                serverCallId = groupCallLocator.GroupId;
            }
