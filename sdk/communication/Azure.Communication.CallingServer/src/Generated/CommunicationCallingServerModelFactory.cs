...
namespace Azure.Communication.CallingServer
{
    ...
    public static partial class CommunicationCallingServerModelFactory
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.DtmfOptionsInternal"/>. </summary>
        ...
        public static DtmfOptionsInternal DtmfOptionsInternal(int? interToneTimeoutInSeconds = null, int? maxTonesToCollect = null, IEnumerable<DtmfTone> stopTones = null)
        {
            ...
            return new DtmfOptionsInternal(interToneTimeoutInSeconds, maxTonesToCollect, stopTones?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RemoveParticipantsResult(operationContext, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecordingStateResult(recordingId, recordingState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CallConnected(eventSource, version, operationContext, resultInformation, callConnectionId, serverCallId, correlationId, publicEventType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CallDisconnected(eventSource, version, operationContext, resultInformation, callConnectionId, serverCallId, correlationId, publicEventType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CallTransferAccepted(eventSource, operationContext, resultInformation, version, callConnectionId, serverCallId, correlationId, publicEventType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CallTransferFailed(eventSource, operationContext, resultInformation, version, callConnectionId, serverCallId, correlationId, publicEventType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CallRecordingStateChanged(eventSource, recordingId, state, startDateTime, version, operationContext, resultInformation, callConnectionId, serverCallId, correlationId, publicEventType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PlayCompleted(operationContext, resultInformation, version, callConnectionId, serverCallId, correlationId, publicEventType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PlayFailed(eventSource, operationContext, resultInformation, version, callConnectionId, serverCallId, correlationId, publicEventType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecognizeCompleted(operationContext, resultInformation, recognitionType, collectTonesResult, version, callConnectionId, serverCallId, correlationId, publicEventType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RecognizeFailed(operationContext, resultInformation, version, callConnectionId, serverCallId, correlationId, publicEventType, new Dictionary<string, BinaryData>());
        }
    }
}
