...
namespace Azure.Communication.CallingServer
{
    ...
    public static partial class CommunicationCallingServerModelFactory
    {
        ...
        public static CallConnected CallConnected(string eventSource = null, string version = null, string operationContext = null, ResultInformation resultInformation = null, string publicEventType = null)
        {
            return new CallConnected(eventSource, version, operationContext, resultInformation, publicEventType);
        }
        ...
        public static CallDisconnected CallDisconnected(string eventSource = null, string version = null, string operationContext = null, ResultInformation resultInformation = null, string publicEventType = null)
        {
            return new CallDisconnected(eventSource, version, operationContext, resultInformation, publicEventType);
        }
        ...
        public static CallTransferAccepted CallTransferAccepted(string eventSource = null, string operationContext = null, ResultInformation resultInformation = null, string version = null, string publicEventType = null)
        {
            return new CallTransferAccepted(eventSource, operationContext, resultInformation, version, publicEventType);
        }
        ...
        public static CallTransferFailed CallTransferFailed(string eventSource = null, string operationContext = null, ResultInformation resultInformation = null, string version = null, string publicEventType = null)
        {
            return new CallTransferFailed(eventSource, operationContext, resultInformation, version, publicEventType);
        }
        ...
        public static CallRecordingStateChanged CallRecordingStateChanged(string eventSource = null, string recordingId = null, RecordingState state = default, DateTimeOffset? startDateTime = null, string version = null, string operationContext = null, ResultInformation resultInformation = null, string publicEventType = null)
        {
            return new CallRecordingStateChanged(eventSource, recordingId, state, startDateTime, version, operationContext, resultInformation, publicEventType);
        }
        ...
        public static PlayCompleted PlayCompleted(string operationContext = null, ResultInformation resultInformation = null, string version = null, string publicEventType = null)
        {
            return new PlayCompleted(operationContext, resultInformation, version, publicEventType);
        }
        ...
        public static PlayFailed PlayFailed(string eventSource = null, string operationContext = null, ResultInformation resultInformation = null, string version = null, string publicEventType = null)
        {
            return new PlayFailed(eventSource, operationContext, resultInformation, version, publicEventType);
        }
        ...
        public static RecognizeCompleted RecognizeCompleted(string operationContext = null, ResultInformation resultInformation = null, CallMediaRecognitionType recognitionType = default, CollectTonesResult collectTonesResult = null, string version = null, string publicEventType = null)
        {
            return new RecognizeCompleted(operationContext, resultInformation, recognitionType, collectTonesResult, version, publicEventType);
        }
        ...
        public static RecognizeFailed RecognizeFailed(string operationContext = null, ResultInformation resultInformation = null, string version = null, string publicEventType = null)
        {
            return new RecognizeFailed(operationContext, resultInformation, version, publicEventType);
        }
    }
}
