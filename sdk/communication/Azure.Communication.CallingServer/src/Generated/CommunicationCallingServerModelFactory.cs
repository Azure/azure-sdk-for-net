...
namespace Azure.Communication.CallingServer
{
    ...
    public static partial class CommunicationCallingServerModelFactory
    {
        ...
        public static DtmfOptionsInternal DtmfOptionsInternal(int? interToneTimeoutInSeconds = null, int? maxTonesToCollect = null, IEnumerable<DtmfTone> stopTones = null)
        {
            ...
            return new DtmfOptionsInternal(interToneTimeoutInSeconds, maxTonesToCollect, stopTones?.ToList(), default);
        }
        ...
        {
            return new RemoveParticipantsResult(operationContext, default);
        }
        ...
        {
            return new CallConnected(eventSource, version, operationContext, resultInformation, callConnectionId, serverCallId, correlationId, publicEventType, default);
        }
        ...
        {
            return new CallDisconnected(eventSource, version, operationContext, resultInformation, callConnectionId, serverCallId, correlationId, publicEventType, default);
        }
        ...
        {
            return new CallTransferAccepted(eventSource, operationContext, resultInformation, version, callConnectionId, serverCallId, correlationId, publicEventType, default);
        }
        ...
        {
            return new CallTransferFailed(eventSource, operationContext, resultInformation, version, callConnectionId, serverCallId, correlationId, publicEventType, default);
        }
        ...
        {
            return new CallRecordingStateChanged(eventSource, recordingId, state, startDateTime, version, operationContext, resultInformation, callConnectionId, serverCallId, correlationId, publicEventType, default);
        }
        ...
        {
            return new PlayCompleted(operationContext, resultInformation, version, callConnectionId, serverCallId, correlationId, publicEventType, default);
        }
        ...
        {
            return new PlayFailed(eventSource, operationContext, resultInformation, version, callConnectionId, serverCallId, correlationId, publicEventType, default);
        }
        ...
        {
            return new RecognizeCompleted(operationContext, resultInformation, recognitionType, collectTonesResult, version, callConnectionId, serverCallId, correlationId, publicEventType, default);
        }
        ...
        {
            return new RecognizeFailed(operationContext, resultInformation, version, callConnectionId, serverCallId, correlationId, publicEventType, default);
        }
    }
}
