...
namespace Azure.Communication.CallingServer
{
    internal partial class ServerCallingRestClient
    {
        ...
        public async Task<Response<AnswerCallResponse>> AnswerCallAsync(AnswerCallRequest answerCallRequest, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="answerCallRequest"/> is null. </exception>
        public Response<AnswerCallResponse> AnswerCall(AnswerCallRequest answerCallRequest, CancellationToken cancellationToken = default)
        {
            if (answerCallRequest == null)
            {
                throw new ArgumentNullException(nameof(answerCallRequest));
