...
namespace Azure.Communication
{
    ...
    internal partial class CommunicationIdentifierModel
    {
        ...
        internal CommunicationIdentifierModel(string rawId, CommunicationIdentifierModelKind? kind, CommunicationUserIdentifierModel communicationUser, PhoneNumberIdentifierModel phoneNumber, MicrosoftTeamsUserIdentifierModel microsoftTeamsUser, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RawId = rawId;
            Kind = kind;
