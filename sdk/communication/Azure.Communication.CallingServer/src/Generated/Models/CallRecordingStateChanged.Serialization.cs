...
namespace Azure.Communication.CallingServer
{
    ...
    {
        internal static CallRecordingStateChanged DeserializeCallRecordingStateChanged(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
