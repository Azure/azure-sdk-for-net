...
namespace Azure.Communication.CallingServer
{
    ...
    internal partial class CreateCallRequestInternal
    {
        ...
        internal CreateCallRequestInternal(IList<CommunicationIdentifierModel> targets, CallSourceInternal source, string subject, string callbackUri, MediaStreamingOptionsInternal mediaStreamingConfiguration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Targets = targets;
            Source = source;
            Subject = subject;
