...
namespace Azure.Communication.CallingServer
{
    ...
    internal partial class GetParticipantsResponseInternal
    {
        ...
        internal GetParticipantsResponseInternal(IReadOnlyList<AcsCallParticipantInternal> values, string nextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Values = values;
            NextLink = nextLink;
