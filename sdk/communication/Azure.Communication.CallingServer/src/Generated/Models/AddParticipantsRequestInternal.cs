...
namespace Azure.Communication.CallingServer
{
    ...
    internal partial class AddParticipantsRequestInternal
    {
        ...
        internal AddParticipantsRequestInternal(PhoneNumberIdentifierModel sourceCallerId, IList<CommunicationIdentifierModel> participantsToAdd, int? invitationTimeoutInSeconds, string operationContext, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
