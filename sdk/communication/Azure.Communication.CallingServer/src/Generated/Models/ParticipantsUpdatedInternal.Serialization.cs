...
namespace Azure.Communication.CallingServer
{
    ...
    {
        internal static ParticipantsUpdatedInternal DeserializeParticipantsUpdatedInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
