...
namespace Azure.Communication.CallingServer
{
    ...
    public partial class PlayResponse
    {
        ...
        internal PlayResponse(CallingOperationStatusDto status)
        {
            Status = status;
        }
        ...
        internal PlayResponse(string operationId, CallingOperationStatusDto status, string operationContext, CallingOperationResultDetailsDto resultDetails)
        {
