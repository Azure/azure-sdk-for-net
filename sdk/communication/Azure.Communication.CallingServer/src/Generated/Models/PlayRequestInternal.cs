...
namespace Azure.Communication.CallingServer
{
    ...
    internal partial class PlayRequestInternal
    {
        ...
        internal PlayRequestInternal(PlaySourceInternal playSourceInfo, IList<CommunicationIdentifierModel> playTo, PlayOptionsInternal playOptions, string operationContext, Dictionary<string, BinaryData> rawData)
        {
            PlaySourceInfo = playSourceInfo;
            PlayTo = playTo;
