...
namespace Azure.Communication.CallingServer
{
    ...
    {
        internal static AddParticipantsFailedInternal DeserializeAddParticipantsFailedInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
