...
namespace Azure.Communication.CallingServer
{
    internal partial class AddParticipantsFailedInternal
    {
        internal static AddParticipantsFailedInternal DeserializeAddParticipantsFailedInternal(JsonElement element)
        {
            ...
            return new AddParticipantsFailedInternal(eventSource.Value, operationContext.Value, resultInformation.Value, Core.Optional.ToList(participants), version.Value, callConnectionId.Value, serverCallId.Value, correlationId.Value, publicEventType.Value);
        }
    }
}
