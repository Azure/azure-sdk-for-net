...
namespace Azure.Communication.CallingServer
{
    ...
    public partial class RemoveParticipantsResponse
    {
        ...
        internal RemoveParticipantsResponse(CallingOperationStatus status)
        {
            Status = status;
        }
        ...
        internal RemoveParticipantsResponse(string operationId, CallingOperationStatus status, string operationContext, CallingOperationResultDetails resultDetails)
        {
