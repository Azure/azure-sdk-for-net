...
namespace Azure.Communication.CallingServer
{
    ...
    public partial class RemoveParticipantsResponse
    {
        ...
        internal RemoveParticipantsResponse(CallingOperationStatusDto status)
        {
            Status = status;
        }
        ...
        internal RemoveParticipantsResponse(string operationId, CallingOperationStatusDto status, string operationContext, CallingOperationResultDetailsDto resultDetails)
        {
