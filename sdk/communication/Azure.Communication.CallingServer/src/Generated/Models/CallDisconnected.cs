...
namespace Azure.Communication.CallingServer
{
    ...
    public partial class CallDisconnected
    {
        ...
        internal CallDisconnected(string eventSource, string version, string operationContext, ResultInformation resultInformation, string callConnectionId, string serverCallId, string correlationId, string publicEventType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
