...
{
    /// <summary> The response payload for start hold music operation. </summary>
    public partial class StopHoldMusicResult
    {
        /// <summary> Initializes a new instance of StopHoldMusicResult. </summary>
        /// <param name="status"> The status of the operation. </param>
        internal StopHoldMusicResult(OperationStatus status)
        {
            Status = status;
        }
        ...
        internal StopHoldMusicResult(string operationId, OperationStatus status, string operationContext, ResultInfo resultInfo)
        {
