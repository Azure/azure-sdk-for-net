...
namespace Azure.Communication.CallingServer
{
    ...
    {
        internal static AcsCallParticipantInternal DeserializeAcsCallParticipantInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
