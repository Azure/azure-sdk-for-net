...
{
    /// <summary> The response payload for transfer call operation. </summary>
    public partial class TransferCallResult
    {
        /// <summary> Initializes a new instance of TransferCallResult. </summary>
        /// <param name="status"> The status of the operation. </param>
        internal TransferCallResult(CallingOperationStatus status)
        {
            Status = status;
        }
        ...
        internal TransferCallResult(string operationId, CallingOperationStatus status, string operationContext, CallingOperationResultDetails resultDetails)
        {
