...
namespace Azure.Communication.CallingServer
{
    ...
    internal partial class RejectCallRequestInternal
    {
        ...
        internal RejectCallRequestInternal(string incomingCallContext, CallRejectReason? callRejectReason, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IncomingCallContext = incomingCallContext;
