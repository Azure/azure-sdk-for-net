...
namespace Azure.Communication
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunicationUserIdentifierModel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunicationUserIdentifierModel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationUserIdentifierModel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CommunicationUserIdentifierModel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
