...
namespace Azure.Communication.CallingServer
{
    ...
    internal partial class TransferToParticipantRequestInternal
    {
        ...
        internal TransferToParticipantRequestInternal(CommunicationIdentifierModel targetParticipant, PhoneNumberIdentifierModel transfereeCallerId, string userToUserInformation, string operationContext, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TargetParticipant = targetParticipant;
