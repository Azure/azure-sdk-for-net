...
namespace Azure.Communication.CallingServer
{
    ...
    {
        internal static StartHoldMusicResult DeserializeStartHoldMusicResult(JsonElement element)
        {
            ...
            return new StartHoldMusicResult(operationId.Value, status, operationContext.Value, resultInfo.Value);
        }
    }
}
