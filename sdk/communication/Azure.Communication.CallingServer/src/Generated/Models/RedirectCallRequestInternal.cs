...
namespace Azure.Communication.CallingServer
{
    ...
    internal partial class RedirectCallRequestInternal
    {
        ...
        internal RedirectCallRequestInternal(string incomingCallContext, CommunicationIdentifierModel target, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IncomingCallContext = incomingCallContext;
            Target = target;
