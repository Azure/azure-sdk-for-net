...
namespace Azure.Communication
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MicrosoftTeamsUserIdentifierModel>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        MicrosoftTeamsUserIdentifierModel IJsonModel<MicrosoftTeamsUserIdentifierModel>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<MicrosoftTeamsUserIdentifierModel>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        MicrosoftTeamsUserIdentifierModel IModel<MicrosoftTeamsUserIdentifierModel>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<MicrosoftTeamsUserIdentifierModel>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
