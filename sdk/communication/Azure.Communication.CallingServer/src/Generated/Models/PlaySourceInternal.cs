...
namespace Azure.Communication.CallingServer
{
    ...
    internal partial class PlaySourceInternal
    {
        ...
        internal PlaySourceInternal(PlaySourceTypeInternal sourceType, string playSourceId, FileSourceInternal fileSource, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SourceType = sourceType;
