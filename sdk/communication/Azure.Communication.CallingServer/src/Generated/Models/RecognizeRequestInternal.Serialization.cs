...
namespace Azure.Communication.CallingServer
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RecognizeRequestInternal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RecognizeRequestInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RecognizeRequestInternal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RecognizeRequestInternal>)} interface");
            }
        ...
        string IPersistableModel<RecognizeRequestInternal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
