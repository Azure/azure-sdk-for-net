...
namespace Azure.Communication.CallingServer
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransferToParticipantRequestInternal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TransferToParticipantRequestInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TransferToParticipantRequestInternal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TransferToParticipantRequestInternal>)} interface");
            }
        ...
        string IPersistableModel<TransferToParticipantRequestInternal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
