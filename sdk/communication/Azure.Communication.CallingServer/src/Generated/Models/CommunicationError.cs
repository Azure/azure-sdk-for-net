...
namespace Azure.Communication.CallingServer
{
    ...
    internal partial class CommunicationError
    {
        ...
        internal CommunicationError(string code, string message, string target, IReadOnlyList<CommunicationError> details, CommunicationError innererror, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Target = target;
