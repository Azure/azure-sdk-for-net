...
namespace Azure.Communication.CallingServer
{
    ...
    internal partial class HoldMeetingAudioWithCallLocatorRequest
    {
        /// <summary> Initializes a new instance of HoldMeetingAudioWithCallLocatorRequest. </summary>
        ...
        public HoldMeetingAudioWithCallLocatorRequest(CallLocatorModel callLocator, CommunicationIdentifierModel identifier)
        {
            if (callLocator == null)
            {
