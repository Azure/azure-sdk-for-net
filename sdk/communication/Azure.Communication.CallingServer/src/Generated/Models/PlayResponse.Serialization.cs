...
namespace Azure.Communication.CallingServer
{
    ...
    {
        internal static PlayResponse DeserializePlayResponse(JsonElement element)
        {
            ...
            return new PlayResponse(operationId.Value, status, operationContext.Value, resultDetails.Value);
        }
    }
}
