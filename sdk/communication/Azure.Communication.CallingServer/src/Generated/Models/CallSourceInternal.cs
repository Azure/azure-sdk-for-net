...
namespace Azure.Communication.CallingServer
{
    ...
    internal partial class CallSourceInternal
    {
        ...
        internal CallSourceInternal(PhoneNumberIdentifierModel callerId, string displayName, CommunicationIdentifierModel identifier, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CallerId = callerId;
