...
namespace Azure.Communication.CallingServer
{
    internal partial class AddParticipantsSucceededInternal
    {
        internal static AddParticipantsSucceededInternal DeserializeAddParticipantsSucceededInternal(JsonElement element)
        {
            ...
            return new AddParticipantsSucceededInternal(eventSource.Value, operationContext.Value, resultInformation.Value, participants ?? new ChangeTrackingList<CommunicationIdentifierModel>(), version.Value, callConnectionId.Value, serverCallId.Value, correlationId.Value, publicEventType.Value);
        }
    }
}
