...
namespace Azure.Communication.CallingServer
{
    ...
    {
        internal static AddParticipantsSucceededInternal DeserializeAddParticipantsSucceededInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
