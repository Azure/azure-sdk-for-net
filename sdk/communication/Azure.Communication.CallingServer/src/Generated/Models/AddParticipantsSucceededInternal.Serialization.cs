...
namespace Azure.Communication.CallingServer
{
    internal partial class AddParticipantsSucceededInternal
    {
        internal static AddParticipantsSucceededInternal DeserializeAddParticipantsSucceededInternal(JsonElement element)
        {
            ...
            return new AddParticipantsSucceededInternal(eventSource.Value, operationContext.Value, resultInformation.Value, Core.Optional.ToList(participants), version.Value, callConnectionId.Value, serverCallId.Value, correlationId.Value, publicEventType.Value);
        }
    }
}
