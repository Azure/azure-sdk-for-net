...
namespace Azure.Communication.CallingServer
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CallingServer.PlayAudioResult"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.ResultInfo"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.CancelAllMediaOperationsResult"/>. </summary>
        /// <param name="operationId"> The operation id. </param>
        /// <param name="status"> The status of the operation. </param>
        /// <param name="operationContext"> The operation context provided by client. </param>
        /// <param name="resultInfo"> The result info for the operation. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.AddParticipantResult"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.StartRecordingResult"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.CallRecordingProperties"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.CallConnectionStateChangedEvent"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.CallRecordingStateChangeEvent"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.AddParticipantResultEvent"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.PlayAudioResultEvent"/>. </summary>
        /// <param name="resultInfo"> The result details. </param>
        /// <param name="operationContext"> The operation context. </param>
        /// <param name="status"> The status of the operation. </param>
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.ToneReceivedEvent"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CallingServer.ToneInfo"/>. </summary>
