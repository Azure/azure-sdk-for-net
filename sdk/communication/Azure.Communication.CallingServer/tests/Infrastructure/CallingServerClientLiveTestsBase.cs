...
namespace Azure.Communication.CallingServer.Tests.Infrastructure
{
    internal class CallingServerClientLiveTestsBase : RecordedTestBase<CallingServerClientTestEnvironment>
    {
        ...
        public CallingServerClientLiveTestsBase(bool isAsync) : base(isAsync)
        {
        ...
        protected CallingServer.CallingServerClient CreateInstrumentedCallingServerClientWithConnectionString()
        {
            var connectionString = TestEnvironment.LiveTestStaticConnectionString;

            CallingServer.CallingServerClient callingServerClient;
