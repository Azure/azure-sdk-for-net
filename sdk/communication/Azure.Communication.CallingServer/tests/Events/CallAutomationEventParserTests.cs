...
namespace Azure.Communication.CallingServer.Tests.Events
{
    public class CallAutomationEventParserTests
    {
        ...
        public void EventParserShouldParseEventWithEventDataAndType()
        {
            ...
            CallConnected @event = CallingServerModelFactory.CallConnected(resultInformation: resultInformation, callConnectionId: callConnectionId, serverCallId: serverCallId, correlationId: correlationId);
        ...
        {
            CallRecordingStateChanged @event = CallingServerModelFactory.CallRecordingStateChanged(
        ...
        {
            PlayCompleted @event = CallingServerModelFactory.PlayCompleted(
        ...
        {
            PlayFailed @event = CallingServerModelFactory.PlayFailed(
                operationContext: "operationContext",
        ...
        {
            RecognizeCompleted @event = CallingServerModelFactory.RecognizeCompleted(
                operationContext: "operationContext",
        ...
        {
            RecognizeFailed @event = CallingServerModelFactory.RecognizeFailed(
                operationContext: "operationContext",
