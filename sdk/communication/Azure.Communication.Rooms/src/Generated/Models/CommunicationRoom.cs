...
namespace Azure.Communication.Rooms
{
    ...
    public partial class CommunicationRoom
    {
        ...
        internal CommunicationRoom(string id, DateTimeOffset createdAt, DateTimeOffset validFrom, DateTimeOffset validUntil, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            CreatedAt = createdAt;
            ValidFrom = validFrom;
