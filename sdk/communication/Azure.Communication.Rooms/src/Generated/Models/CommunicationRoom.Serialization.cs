...
namespace Azure.Communication.Rooms
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunicationRoom>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunicationRoom>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationRoom>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CommunicationRoom>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
