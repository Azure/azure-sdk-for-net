...
namespace Azure.Communication.Rooms
{
    public partial class CommunicationRoom : IUtf8JsonSerializable, IJsonModel<CommunicationRoom>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationRoom>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommunicationRoom>)} interface");
            }
