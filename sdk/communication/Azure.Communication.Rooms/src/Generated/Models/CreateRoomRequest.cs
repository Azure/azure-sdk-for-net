...
namespace Azure.Communication.Rooms
{
    ...
    internal partial class CreateRoomRequest
    {
        ...
        internal CreateRoomRequest(DateTimeOffset? validFrom, DateTimeOffset? validUntil, IDictionary<string, ParticipantProperties> participants, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ValidFrom = validFrom;
