...
namespace Azure.Communication.Rooms
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoomParticipant>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoomParticipant>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoomParticipant>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoomParticipant>)} interface");
            }
        ...
        string IPersistableModel<RoomParticipant>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
