...
namespace Azure.Communication.Rooms
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="Rooms.CommunicationRoom"/>. </summary>
        ...
        public static CommunicationRoom CommunicationRoom(string id = null, DateTimeOffset createdAt = default, DateTimeOffset validFrom = default, DateTimeOffset validUntil = default, bool pstnDialOutEnabled = default)
        {
            return new CommunicationRoom(id, createdAt, validFrom, validUntil, pstnDialOutEnabled, serializedAdditionalRawData: null);
        }
    }
}
