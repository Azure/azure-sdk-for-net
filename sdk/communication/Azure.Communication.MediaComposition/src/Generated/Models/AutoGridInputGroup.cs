...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class AutoGridInputGroup : InputGroup
    {
        ...
        internal AutoGridInputGroup(InputGroupType kind, InputPosition position, string width, string height, string layer, ScalingMode? scalingMode, IList<string> inputIds, Dictionary<string, BinaryData> rawData) : base(kind, position, width, height, layer, scalingMode, rawData)
        {
            InputIds = inputIds;
            Kind = kind;
        }
