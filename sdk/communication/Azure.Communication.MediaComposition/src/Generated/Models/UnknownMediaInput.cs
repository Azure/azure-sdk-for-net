...
namespace Azure.Communication.MediaComposition
{
    ...
    internal partial class UnknownMediaInput : MediaInput
    {
        ...
        internal UnknownMediaInput(MediaInputType kind, string placeholderImageUri, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, placeholderImageUri, serializedAdditionalRawData)
        {
            Kind = kind;
        }
