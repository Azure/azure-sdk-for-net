...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class SrtOutput : MediaOutput
    {
        ...
        internal SrtOutput(MediaOutputType kind, LayoutResolution resolution, string streamUrl, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Resolution = resolution;
            StreamUrl = streamUrl;
            Kind = kind;
