...
{
    public partial class ImageInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ImageInput DeserializeImageInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
