...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class MediaComposition
    {
        ...
        internal MediaComposition(string id, MediaCompositionLayout layout, IDictionary<string, MediaInput> inputs, IDictionary<string, MediaOutput> outputs, CompositionStreamState streamState, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Layout = layout;
            Inputs = inputs;
