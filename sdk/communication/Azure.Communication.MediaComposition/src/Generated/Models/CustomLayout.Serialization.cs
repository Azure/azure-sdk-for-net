...
{
    public partial class CustomLayout : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CustomLayout DeserializeCustomLayout(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
