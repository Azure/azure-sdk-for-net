...
namespace Azure.Communication.MediaComposition
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomLayout>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomLayout>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomLayout>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CustomLayout>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
