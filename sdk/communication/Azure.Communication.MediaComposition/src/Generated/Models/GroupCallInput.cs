...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class GroupCallInput : MediaInput
    {
        ...
        internal GroupCallInput(MediaInputType kind, string placeholderImageUri, string id, Dictionary<string, BinaryData> rawData) : base(kind, placeholderImageUri, rawData)
        {
            Id = id;
            Kind = kind;
        }
