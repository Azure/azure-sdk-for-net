...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class GroupCallInput : MediaInput
    {
        ...
        internal GroupCallInput(MediaInputType kind, string placeholderImageUri, string id, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, placeholderImageUri, serializedAdditionalRawData)
        {
            Id = id;
            Kind = kind;
        }
