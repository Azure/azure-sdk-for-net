...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class GridInputGroup : InputGroup
    {
        ...
        internal GridInputGroup(InputGroupType kind, InputPosition position, string width, string height, string layer, ScalingMode? scalingMode, IList<IList<string>> inputIds, int rows, int columns, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, position, width, height, layer, scalingMode, serializedAdditionalRawData)
        {
            InputIds = inputIds;
            Rows = rows;
            Columns = columns;
