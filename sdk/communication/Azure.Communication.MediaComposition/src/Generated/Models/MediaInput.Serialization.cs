...
namespace Azure.Communication.MediaComposition.Models
{
    public partial class MediaInput : IUtf8JsonSerializable
    {
        ...
        internal static MediaInput FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeMediaInput(document.RootElement);
        }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<MediaInput>(this);
            return content;
        }
    }
}
