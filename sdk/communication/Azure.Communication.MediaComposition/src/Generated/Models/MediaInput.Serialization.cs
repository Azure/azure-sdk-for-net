...
{
    public partial class MediaInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MediaInput DeserializeMediaInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
