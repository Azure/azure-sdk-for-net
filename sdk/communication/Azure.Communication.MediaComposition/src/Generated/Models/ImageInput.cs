...
namespace Azure.Communication.MediaComposition.Models
{
    ...
    public partial class ImageInput : MediaInput
    {
        ...
        internal ImageInput(MediaInputType kind, string placeholderImageUri, string uri, Dictionary<string, BinaryData> rawData) : base(kind, placeholderImageUri, rawData)
        {
            Uri = uri;
            Kind = kind;
        }
