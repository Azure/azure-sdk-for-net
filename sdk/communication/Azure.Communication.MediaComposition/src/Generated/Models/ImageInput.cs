...
namespace Azure.Communication.MediaComposition.Models
{
    ...
    public partial class ImageInput : MediaInput
    {
        ...
        internal ImageInput(MediaInputType kind, string placeholderImageUri, string uri, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, placeholderImageUri, serializedAdditionalRawData)
        {
            Uri = uri;
            Kind = kind;
        }
