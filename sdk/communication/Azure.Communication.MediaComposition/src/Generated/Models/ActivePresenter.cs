...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class ActivePresenter : MediaInput
    {
        ...
        internal ActivePresenter(MediaInputType kind, string placeholderImageUri, string call, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, placeholderImageUri, serializedAdditionalRawData)
        {
            Call = call;
            Kind = kind;
        }
