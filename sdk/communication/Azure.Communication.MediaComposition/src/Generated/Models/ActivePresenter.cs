...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class ActivePresenter : MediaInput
    {
        ...
        internal ActivePresenter(MediaInputType kind, string placeholderImageUri, string call, Dictionary<string, BinaryData> rawData) : base(kind, placeholderImageUri, rawData)
        {
            Call = call;
            Kind = kind;
        }
