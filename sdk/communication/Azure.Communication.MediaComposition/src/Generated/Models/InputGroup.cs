...
namespace Azure.Communication.MediaComposition
{
    ...
    public abstract partial class InputGroup
    {
        ...
        internal InputGroup(InputGroupType kind, InputPosition position, string width, string height, string layer, ScalingMode? scalingMode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Kind = kind;
            Position = position;
            Width = width;
