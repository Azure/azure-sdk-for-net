...
namespace Azure.Communication.MediaComposition
{
    public partial class GridInputGroup : IUtf8JsonSerializable, IModelJsonSerializable<GridInputGroup>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<GridInputGroup>(this, options.Format);
        ...
        internal static GridInputGroup DeserializeGridInputGroup(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new GridInputGroup(kind, position.Value, width.Value, height.Value, layer.Value, Optional.ToNullable(scalingMode), inputIds, rows, columns, rawData);
        }
