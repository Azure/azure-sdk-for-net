...
namespace Azure.Communication.MediaComposition
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GridInputGroup>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GridInputGroup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GridInputGroup>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GridInputGroup>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
