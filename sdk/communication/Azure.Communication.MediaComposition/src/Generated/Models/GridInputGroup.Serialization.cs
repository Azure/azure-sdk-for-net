...
namespace Azure.Communication.MediaComposition
{
    public partial class GridInputGroup : IUtf8JsonSerializable, IJsonModel<GridInputGroup>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<GridInputGroup>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GridInputGroup>)} interface");
            }
