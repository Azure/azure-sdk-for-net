...
{
    public partial class ActivePresenter : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ActivePresenter DeserializeActivePresenter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
