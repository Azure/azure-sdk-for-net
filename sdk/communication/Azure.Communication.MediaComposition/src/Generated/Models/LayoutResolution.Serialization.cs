...
namespace Azure.Communication.MediaComposition.Models
{
    public partial class LayoutResolution : IUtf8JsonSerializable, IJsonModel<LayoutResolution>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<LayoutResolution>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LayoutResolution)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LayoutResolution>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LayoutResolution)} does not support '{options.Format}' format.");
            }
        }
