...
namespace Azure.Communication.MediaComposition.Models
{
    public partial class LayoutResolution : IUtf8JsonSerializable
    {
        ...
        internal static LayoutResolution FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeLayoutResolution(document.RootElement);
        }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<LayoutResolution>(this);
            return content;
        }
    }
}
