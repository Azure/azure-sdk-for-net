...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class ScreenShare : MediaInput
    {
        ...
        internal ScreenShare(MediaInputType kind, string placeholderImageUri, string call, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, placeholderImageUri, serializedAdditionalRawData)
        {
            Call = call;
            Kind = kind;
        }
