...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class ScreenShare : MediaInput
    {
        ...
        internal ScreenShare(MediaInputType kind, string placeholderImageUri, string call, Dictionary<string, BinaryData> rawData) : base(kind, placeholderImageUri, rawData)
        {
            Call = call;
            Kind = kind;
        }
