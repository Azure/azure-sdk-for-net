...
namespace Azure.Communication.MediaComposition
{
    ...
    internal partial class UnknownInputGroup : InputGroup
    {
        ...
        internal UnknownInputGroup(InputGroupType kind, InputPosition position, string width, string height, string layer, ScalingMode? scalingMode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, position, width, height, layer, scalingMode, serializedAdditionalRawData)
        {
            Kind = kind;
        }

        /// <summary> Initializes a new instance of <see cref="UnknownInputGroup"/> for deserialization. </summary>
        internal UnknownInputGroup()
        {
        }
    }
}
