...
{
    public partial class RtmpInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RtmpInput DeserializeRtmpInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
