...
namespace Azure.Communication.MediaComposition
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PresenterLayout>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PresenterLayout>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PresenterLayout>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PresenterLayout>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
