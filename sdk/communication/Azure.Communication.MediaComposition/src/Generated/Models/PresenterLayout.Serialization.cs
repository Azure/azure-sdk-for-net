...
{
    public partial class PresenterLayout : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PresenterLayout DeserializePresenterLayout(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
