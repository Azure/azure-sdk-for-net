...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class RtmpOutput : MediaOutput
    {
        ...
        internal RtmpOutput(MediaOutputType kind, string streamKey, LayoutResolution resolution, string streamUrl, RtmpMode? mode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            StreamKey = streamKey;
            Resolution = resolution;
            StreamUrl = streamUrl;
