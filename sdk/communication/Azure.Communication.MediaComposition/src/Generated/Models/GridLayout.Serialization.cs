...
{
    public partial class GridLayout : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GridLayout DeserializeGridLayout(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
