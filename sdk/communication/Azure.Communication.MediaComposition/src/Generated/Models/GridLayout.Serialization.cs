...
namespace Azure.Communication.MediaComposition
{
    public partial class GridLayout : IUtf8JsonSerializable, IModelJsonSerializable<GridLayout>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GridLayout>(this, options.Format);
        ...
        internal static GridLayout DeserializeGridLayout(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new GridLayout(kind, resolution.Value, placeholderImageUri.Value, Optional.ToNullable(scalingMode), rows, columns, inputIds, serializedAdditionalRawData);
        }
