...
namespace Azure.Communication.MediaComposition
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GridLayout>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GridLayout>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GridLayout>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GridLayout>)} interface");
            }
        ...
        string IPersistableModel<GridLayout>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
