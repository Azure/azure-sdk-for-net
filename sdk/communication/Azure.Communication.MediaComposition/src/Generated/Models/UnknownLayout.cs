...
namespace Azure.Communication.MediaComposition
{
    ...
    internal partial class UnknownLayout : MediaCompositionLayout
    {
        ...
        internal UnknownLayout(LayoutType kind, LayoutResolution resolution, string placeholderImageUri, ScalingMode? scalingMode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, resolution, placeholderImageUri, scalingMode, serializedAdditionalRawData)
        {
            Kind = kind;
        }
