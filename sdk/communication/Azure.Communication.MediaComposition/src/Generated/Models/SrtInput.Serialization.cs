...
{
    public partial class SrtInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SrtInput DeserializeSrtInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
