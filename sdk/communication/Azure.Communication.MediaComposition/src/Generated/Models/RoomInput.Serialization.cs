...
{
    public partial class RoomInput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static RoomInput DeserializeRoomInput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
