...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class TeamsMeetingInput : MediaInput
    {
        ...
        internal TeamsMeetingInput(MediaInputType kind, string placeholderImageUri, string teamsJoinUrl, Dictionary<string, BinaryData> rawData) : base(kind, placeholderImageUri, rawData)
        {
            TeamsJoinUrl = teamsJoinUrl;
            Kind = kind;
        }
