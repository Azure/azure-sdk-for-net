...
namespace Azure.Communication.MediaComposition
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PresentationLayout>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PresentationLayout>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PresentationLayout>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PresentationLayout>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
