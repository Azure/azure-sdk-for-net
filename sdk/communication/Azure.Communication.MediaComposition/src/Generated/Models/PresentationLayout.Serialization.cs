...
namespace Azure.Communication.MediaComposition
{
    public partial class PresentationLayout : IUtf8JsonSerializable, IModelJsonSerializable<PresentationLayout>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PresentationLayout>(this, options.Format);
        ...
        internal static PresentationLayout DeserializePresentationLayout(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PresentationLayout(kind, resolution.Value, placeholderImageUri.Value, Optional.ToNullable(scalingMode), presenterId, audienceIds, Optional.ToNullable(audiencePosition), serializedAdditionalRawData);
        }
