...
namespace Azure.Communication.MediaComposition
{
    public partial class PresentationLayout : IUtf8JsonSerializable, IJsonModel<PresentationLayout>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<PresentationLayout>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PresentationLayout>)} interface");
            }
