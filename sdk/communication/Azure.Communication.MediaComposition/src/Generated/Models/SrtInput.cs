...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class SrtInput : MediaInput
    {
        ...
        internal SrtInput(MediaInputType kind, string placeholderImageUri, LayoutResolution resolution, string streamUrl, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, placeholderImageUri, serializedAdditionalRawData)
        {
            Resolution = resolution;
            StreamUrl = streamUrl;
            Kind = kind;
