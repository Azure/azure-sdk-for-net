...
namespace Azure.Communication.MediaComposition.Models
{
    ...
    public partial class ParticipantInput : MediaInput
    {
        ...
        internal ParticipantInput(MediaInputType kind, string placeholderImageUri, CommunicationIdentifierModel serviceId, string call, Dictionary<string, BinaryData> rawData) : base(kind, placeholderImageUri, rawData)
        {
            ServiceId = serviceId;
            Call = call;
            Kind = kind;
