...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class RtmpInput : MediaInput
    {
        ...
        internal RtmpInput(MediaInputType kind, string placeholderImageUri, string streamKey, LayoutResolution resolution, string streamUrl, RtmpMode? mode, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, placeholderImageUri, serializedAdditionalRawData)
        {
            StreamKey = streamKey;
            Resolution = resolution;
            StreamUrl = streamUrl;
