...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class RtmpInput : MediaInput
    {
        ...
        internal RtmpInput(MediaInputType kind, string placeholderImageUri, IDictionary<string, BinaryData> serializedAdditionalRawData, string streamKey, LayoutResolution resolution, string streamUrl, RtmpMode? mode) : base(kind, placeholderImageUri, serializedAdditionalRawData)
        {
            StreamKey = streamKey;
            Resolution = resolution;
            StreamUrl = streamUrl;
        ...
        /// <summary> Initializes a new instance of <see cref="RtmpInput"/> for deserialization. </summary>
        internal RtmpInput()
        {
        }
