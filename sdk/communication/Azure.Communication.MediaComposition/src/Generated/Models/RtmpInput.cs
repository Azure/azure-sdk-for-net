...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class RtmpInput : MediaInput
    {
        ...
        internal RtmpInput(MediaInputType kind, string placeholderImageUri, string streamKey, LayoutResolution resolution, string streamUrl, RtmpMode? mode, Dictionary<string, BinaryData> rawData) : base(kind, placeholderImageUri, rawData)
        {
            StreamKey = streamKey;
            Resolution = resolution;
            StreamUrl = streamUrl;
