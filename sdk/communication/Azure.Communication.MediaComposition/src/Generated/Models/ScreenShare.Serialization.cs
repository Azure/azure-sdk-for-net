...
namespace Azure.Communication.MediaComposition
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScreenShare>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScreenShare>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScreenShare>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScreenShare>)} interface");
            }
        ...
        string IPersistableModel<ScreenShare>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
