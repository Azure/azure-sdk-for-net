...
namespace Azure.Communication.MediaComposition
{
    public partial class ScreenShare : IUtf8JsonSerializable
    {
        ...
        internal static ScreenShare DeserializeScreenShare(JsonElement element)
        {
            ...
            return new ScreenShare(kind, placeholderImageUri, call);
        }

        /// <summary> Deserializes the model from a raw response. </summary>
        /// <param name="response"> The response to deserialize the model from. </param>
        internal static new ScreenShare FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeScreenShare(document.RootElement);
        }
        ...
        internal override RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<ScreenShare>(this);
            return content;
        }
    }
}
