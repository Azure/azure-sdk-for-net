...
{
    public partial class ScreenShare : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ScreenShare DeserializeScreenShare(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
