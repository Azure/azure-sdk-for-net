...
namespace Azure.Communication.MediaComposition.Models
{
    public partial class InputPosition : IUtf8JsonSerializable
    {
        ...
        internal static InputPosition FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeInputPosition(document.RootElement);
        }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<InputPosition>(this);
            return content;
        }
    }
}
