...
namespace Azure.Communication.MediaComposition.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InputPosition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InputPosition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InputPosition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InputPosition>)} interface");
            }
        ...
        string IPersistableModel<InputPosition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
