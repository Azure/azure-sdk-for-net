...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class GroupCallOutput : MediaOutput
    {
        ...
        internal GroupCallOutput(MediaOutputType kind, string id, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(kind, serializedAdditionalRawData)
        {
            Id = id;
            Kind = kind;
        }
