...
namespace Azure.Communication.MediaComposition
{
    ...
    public partial class RoomInput : MediaInput
    {
        ...
        internal RoomInput(MediaInputType kind, string placeholderImageUri, string id, Dictionary<string, BinaryData> rawData) : base(kind, placeholderImageUri, rawData)
        {
            Id = id;
            Kind = kind;
        }
