...
{
    public partial class SrtOutput : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SrtOutput DeserializeSrtOutput(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
