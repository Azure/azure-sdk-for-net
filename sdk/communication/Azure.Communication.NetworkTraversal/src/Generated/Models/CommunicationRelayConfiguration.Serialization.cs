...
namespace Azure.Communication.NetworkTraversal
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommunicationRelayConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommunicationRelayConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommunicationRelayConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CommunicationRelayConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
