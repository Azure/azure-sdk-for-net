...
namespace Microsoft.Azure.Management.Communication
{
    ...
    /// </summary>
    internal partial class OperationStatusesOperations : IServiceOperations<CommunicationServiceManagementClient>, IOperationStatusesOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal OperationStatusesOperations(CommunicationServiceManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<OperationStatus>> GetWithHttpMessagesAsync(string location, string operationId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Communication/locations/{location}/operationStatuses/{operationId}").ToString();
