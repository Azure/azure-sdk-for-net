        ...
        public static CommunicationIdentifier Deserialize(CommunicationIdentifierModel identifier)
        {
                 ...
                 && identifier.TeamsExtensionUser is not null)
            {
                ...
                return new TeamsExtensionUserIdentifier(
                      AssertNotNull(teamsExtensionUser.UserId, nameof(teamsExtensionUser.UserId), nameof(TeamsExtensionUserIdentifierModel)),
                      AssertNotNull(teamsExtensionUser.TenantId, nameof(teamsExtensionUser.TenantId), nameof(TeamsExtensionUserIdentifierModel)),
                      AssertNotNull(teamsExtensionUser.ResourceId, nameof(teamsExtensionUser.ResourceId), nameof(TeamsExtensionUserIdentifierModel)),
                      Deserialize(AssertNotNull(teamsExtensionUser.Cloud, nameof(teamsExtensionUser.Cloud), nameof(TeamsExtensionUserIdentifierModel))));
            }
