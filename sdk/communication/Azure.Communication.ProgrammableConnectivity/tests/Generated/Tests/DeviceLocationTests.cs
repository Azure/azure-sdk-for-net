...
{
    public partial class DeviceLocationTests : CommunicationProgrammableConnectivityTestBase
    {
        public DeviceLocationTests(bool isAsync) : base(isAsync)
        {
        }

        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task DeviceLocation_Verify_DeviceLocationVerify()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            DeviceLocation client = CreateProgrammableConnectivityClient(endpoint, credential).GetDeviceLocationClient(apiVersion: "2024-02-09-preview");
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task DeviceLocation_Verify_DeviceLocationVerify_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            DeviceLocation client = CreateProgrammableConnectivityClient(endpoint, credential).GetDeviceLocationClient(apiVersion: "2024-02-09-preview");
