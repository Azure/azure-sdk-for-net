...
{
    public partial class SimSwapTests : CommunicationProgrammableConnectivityTestBase
    {
        public SimSwapTests(bool isAsync) : base(isAsync)
        {
        }

        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task SimSwap_Retrieve_SimSwapRetrieve()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            SimSwap client = CreateProgrammableConnectivityClient(endpoint, credential).GetSimSwapClient(apiVersion: "2024-02-09-preview");
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task SimSwap_Retrieve_SimSwapRetrieve_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            SimSwap client = CreateProgrammableConnectivityClient(endpoint, credential).GetSimSwapClient(apiVersion: "2024-02-09-preview");
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task SimSwap_Verify_SimSwapVerify()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            SimSwap client = CreateProgrammableConnectivityClient(endpoint, credential).GetSimSwapClient(apiVersion: "2024-02-09-preview");
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task SimSwap_Verify_SimSwapVerify_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            TokenCredential credential = new DefaultAzureCredential();
            SimSwap client = CreateProgrammableConnectivityClient(endpoint, credential).GetSimSwapClient(apiVersion: "2024-02-09-preview");
