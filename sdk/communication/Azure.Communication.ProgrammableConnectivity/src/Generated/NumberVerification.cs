...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public partial class NumberVerification
    {
        ...
        /// <include file="Docs/NumberVerification.xml" path="doc/members/member[@name='VerifyWithoutCodeAsync(string,NumberVerificationWithoutCodeContent,CancellationToken)']/*" />
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="apcGatewayId"/> or <paramref name="numberVerificationWithoutCodeContent"/> is null. </exception>
        /// <include file="Docs/NumberVerification.xml" path="doc/members/member[@name='VerifyWithoutCode(string,NumberVerificationWithoutCodeContent,CancellationToken)']/*" />
        ...
        /// <include file="Docs/NumberVerification.xml" path="doc/members/member[@name='VerifyWithoutCodeAsync(string,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/NumberVerification.xml" path="doc/members/member[@name='VerifyWithoutCode(string,RequestContent,RequestContext)']/*" />
