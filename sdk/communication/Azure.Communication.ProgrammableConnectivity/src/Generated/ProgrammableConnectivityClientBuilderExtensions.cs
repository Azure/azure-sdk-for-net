...
namespace Microsoft.Extensions.Azure
{
    ...
    {
        /// <summary> Registers a <see cref="ProgrammableConnectivityClient"/> client with the specified <see cref="IAzureClientBuilder{TClient,TOptions}"/>. </summary>
            ...
            where TBuilder : IAzureClientFactoryBuilderWithCredential
        {
            ...
            return builder.RegisterClientFactory<ProgrammableConnectivityClient, ProgrammableConnectivityClientOptions>((options, credential) => new ProgrammableConnectivityClient(endpoint, credential, options));
        }
