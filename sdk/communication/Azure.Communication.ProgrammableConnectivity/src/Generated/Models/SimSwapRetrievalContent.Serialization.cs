...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public partial class SimSwapRetrievalContent : IJsonModel<SimSwapRetrievalContent>
    {
        ...
        protected virtual SimSwapRetrievalContent PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SimSwapRetrievalContent>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SimSwapRetrievalContent IJsonModel<SimSwapRetrievalContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SimSwapRetrievalContent JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SimSwapRetrievalContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SimSwapRetrievalContent DeserializeSimSwapRetrievalContent(JsonElement element, ModelReaderWriterOptions options)
        {
