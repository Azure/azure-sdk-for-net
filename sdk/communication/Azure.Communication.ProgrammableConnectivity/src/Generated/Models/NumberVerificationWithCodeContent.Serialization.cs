...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public partial class NumberVerificationWithCodeContent : IJsonModel<NumberVerificationWithCodeContent>
    {
        ...
        public static implicit operator RequestContent(NumberVerificationWithCodeContent numberVerificationWithCodeContent)
        {
            ...
            return RequestContent.Create(numberVerificationWithCodeContent, ModelSerializationExtensions.WireOptions);
        }
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NumberVerificationWithCodeContent)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        NumberVerificationWithCodeContent IJsonModel<NumberVerificationWithCodeContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual NumberVerificationWithCodeContent JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<NumberVerificationWithCodeContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NumberVerificationWithCodeContent)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static NumberVerificationWithCodeContent DeserializeNumberVerificationWithCodeContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            {
                if (prop.NameEquals("apcCode"u8))
                {
                    apcCode = prop.Value.GetString();
                    continue;
                }
                if (options.Format != "W")
                {
