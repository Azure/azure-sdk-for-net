...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public partial class SimSwapRetrievalResult : IJsonModel<SimSwapRetrievalResult>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SimSwapRetrievalResult IJsonModel<SimSwapRetrievalResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SimSwapRetrievalResult JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<SimSwapRetrievalResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SimSwapRetrievalResult DeserializeSimSwapRetrievalResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new SimSwapRetrievalResult(date, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SimSwapRetrievalResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
