...
namespace Azure.Communication.ProgrammableConnectivity
{
    ...
    public partial class DeviceLocationVerificationResult : IJsonModel<DeviceLocationVerificationResult>
    {
        /// <summary> Initializes a new instance of <see cref="DeviceLocationVerificationResult"/> for deserialization. </summary>
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DeviceLocationVerificationResult IJsonModel<DeviceLocationVerificationResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DeviceLocationVerificationResult JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DeviceLocationVerificationResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DeviceLocationVerificationResult DeserializeDeviceLocationVerificationResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new DeviceLocationVerificationResult(verificationResult, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DeviceLocationVerificationResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
