...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    public partial class RelationshipLinkResourceFormatResource : ArmResource
    {
        ...
        internal RelationshipLinkResourceFormatResource(ArmClient client, RelationshipLinkResourceFormatData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<RelationshipLinkResourceFormatResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RelationshipLinkResourceFormatResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
