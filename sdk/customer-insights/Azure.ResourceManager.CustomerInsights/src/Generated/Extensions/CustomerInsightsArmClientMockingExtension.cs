...
namespace Azure.ResourceManager.CustomerInsights.Mocking
{
    ...
    internal partial class CustomerInsightsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="CustomerInsightsArmClientMockingExtension"/> class for mocking. </summary>
        protected CustomerInsightsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CustomerInsightsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CustomerInsightsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal CustomerInsightsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
