...
namespace Azure.ResourceManager.CustomerInsights.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class CustomerInsightsSubscriptionResourceExtension : ArmResource
    {
        private ClientDiagnostics _hubClientDiagnostics;
        private HubsRestOperations _hubRestClient;

        /// <summary> Initializes a new instance of the <see cref="CustomerInsightsSubscriptionResourceExtension"/> class for mocking. </summary>
        protected CustomerInsightsSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CustomerInsightsSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CustomerInsightsSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<HubResource> GetHubsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new HubResource(Client, HubData.DeserializeHubData(e)), HubClientDiagnostics, Pipeline, "CustomerInsightsSubscriptionResourceExtension.GetHubs", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<HubResource> GetHubs(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => HubRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => HubRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new HubResource(Client, HubData.DeserializeHubData(e)), HubClientDiagnostics, Pipeline, "CustomerInsightsSubscriptionResourceExtension.GetHubs", "value", "nextLink", cancellationToken);
        }
    }
}
