...
using Azure.ResourceManager.CustomerInsights.Testing;
...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    public static partial class CustomerInsightsExtensions
    {
        ...
        private static CustomerInsightsSubscriptionResourceExtension GetCustomerInsightsSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new CustomerInsightsSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static CustomerInsightsSubscriptionResourceExtension GetCustomerInsightsSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new CustomerInsightsSubscriptionResourceExtension(client, scope);
            });
        }
        #region HubResource
        /// <summary>
        ...
        {
            return GetCustomerInsightsSubscriptionResourceExtension(subscriptionResource).GetHubsAsync(cancellationToken);
        }
        ...
        {
            return GetCustomerInsightsSubscriptionResourceExtension(subscriptionResource).GetHubs(cancellationToken);
        }
    }
}
