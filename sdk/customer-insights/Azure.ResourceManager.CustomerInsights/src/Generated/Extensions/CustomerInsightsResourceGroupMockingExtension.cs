...
namespace Azure.ResourceManager.CustomerInsights.Mocking
{
    ...
    internal partial class CustomerInsightsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="CustomerInsightsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected CustomerInsightsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CustomerInsightsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CustomerInsightsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
