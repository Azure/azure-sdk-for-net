...
namespace Azure.ResourceManager.CustomerInsights.Mocking
{
    ...
    public partial class CustomerInsightsSubscriptionMockingExtension : ArmResource
    {
        private ClientDiagnostics _hubClientDiagnostics;
        private HubsRestOperations _hubRestClient;

        /// <summary> Initializes a new instance of the <see cref="CustomerInsightsSubscriptionMockingExtension"/> class for mocking. </summary>
        protected CustomerInsightsSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CustomerInsightsSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CustomerInsightsSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<HubResource> GetHubsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new HubResource(Client, HubData.DeserializeHubData(e)), HubClientDiagnostics, Pipeline, "CustomerInsightsSubscriptionMockingExtension.GetHubs", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<HubResource> GetHubs(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => HubRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => HubRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new HubResource(Client, HubData.DeserializeHubData(e)), HubClientDiagnostics, Pipeline, "CustomerInsightsSubscriptionMockingExtension.GetHubs", "value", "nextLink", cancellationToken);
        }
    }
}
