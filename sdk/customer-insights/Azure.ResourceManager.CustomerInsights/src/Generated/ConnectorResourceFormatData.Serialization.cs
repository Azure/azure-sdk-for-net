...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectorResourceFormatData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
