...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    public partial class WidgetTypeResourceFormatResource : ArmResource
    {
        ...
        internal WidgetTypeResourceFormatResource(ArmClient client, WidgetTypeResourceFormatData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<WidgetTypeResourceFormatResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new WidgetTypeResourceFormatResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
