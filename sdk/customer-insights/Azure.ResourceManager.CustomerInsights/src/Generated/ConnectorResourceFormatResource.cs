...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    public partial class ConnectorResourceFormatResource : ArmResource
    {
        ...
        internal ConnectorResourceFormatResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _connectorResourceFormatConnectorsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CustomerInsights", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string connectorResourceFormatConnectorsApiVersion);
        ...
        public virtual ConnectorResourceFormatData Data
        {
            get
            {
                if (!HasData)
        ...
        /// <summary> Gets a collection of ConnectorMappingResourceFormatResources in the ConnectorResourceFormat. </summary>
        ...
        {
            return await GetConnectorMappingResourceFormats().GetAsync(mappingName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetConnectorMappingResourceFormats().Get(mappingName, cancellationToken);
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<ConnectorResourceFormatResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _connectorResourceFormatConnectorsClientDiagnostics.CreateScope("ConnectorResourceFormatResource.Get");
            scope.Start();
            try
            {
                var response = await _connectorResourceFormatConnectorsRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ConnectorResourceFormatResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _connectorResourceFormatConnectorsClientDiagnostics.CreateScope("ConnectorResourceFormatResource.Get");
            scope.Start();
            try
            {
                var response = _connectorResourceFormatConnectorsRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new ConnectorResourceFormatResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _connectorResourceFormatConnectorsClientDiagnostics.CreateScope("ConnectorResourceFormatResource.Delete");
            scope.Start();
            try
            {
                var response = await _connectorResourceFormatConnectorsRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new CustomerInsightsArmOperation(_connectorResourceFormatConnectorsClientDiagnostics, Pipeline, _connectorResourceFormatConnectorsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _connectorResourceFormatConnectorsRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new CustomerInsightsArmOperation(_connectorResourceFormatConnectorsClientDiagnostics, Pipeline, _connectorResourceFormatConnectorsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<ConnectorResourceFormatResource>> UpdateAsync(WaitUntil waitUntil, ConnectorResourceFormatData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _connectorResourceFormatConnectorsRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation<ConnectorResourceFormatResource> Update(WaitUntil waitUntil, ConnectorResourceFormatData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _connectorResourceFormatConnectorsRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data, cancellationToken);
                var operation = new CustomerInsightsArmOperation<ConnectorResourceFormatResource>(new ConnectorResourceFormatOperationSource(Client), _connectorResourceFormatConnectorsClientDiagnostics, Pipeline, _connectorResourceFormatConnectorsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
