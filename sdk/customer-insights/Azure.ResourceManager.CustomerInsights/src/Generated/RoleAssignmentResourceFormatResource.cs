...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    public partial class RoleAssignmentResourceFormatResource : ArmResource
    {
        ...
        internal RoleAssignmentResourceFormatResource(ArmClient client, RoleAssignmentResourceFormatData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<RoleAssignmentResourceFormatResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new RoleAssignmentResourceFormatResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
