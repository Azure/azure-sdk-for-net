...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    public partial class LinkResourceFormatData : ResourceData
    {
        ...
        internal LinkResourceFormatData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, Guid? tenantId, string linkName, EntityType? sourceEntityType, EntityType? targetEntityType, string sourceEntityTypeName, string targetEntityTypeName, IDictionary<string, string> displayName, IDictionary<string, string> description, IList<TypePropertiesMapping> mappings, IList<ParticipantPropertyReference> participantPropertyReferences, ProvisioningState? provisioningState, bool? referenceOnly, InstanceOperationType? operationType, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            TenantId = tenantId;
            LinkName = linkName;
