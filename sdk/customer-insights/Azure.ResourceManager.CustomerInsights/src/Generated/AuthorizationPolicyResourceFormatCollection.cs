...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    public partial class AuthorizationPolicyResourceFormatCollection : ArmCollection, IEnumerable<AuthorizationPolicyResourceFormatResource>, IAsyncEnumerable<AuthorizationPolicyResourceFormatResource>
    {
        ...
        /// Operation Id: AuthorizationPolicies_ListByHub
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        ...
        {
            async Task<Page<AuthorizationPolicyResourceFormatResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _authorizationPolicyResourceFormatAuthorizationPoliciesClientDiagnostics.CreateScope("AuthorizationPolicyResourceFormatCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _authorizationPolicyResourceFormatAuthorizationPoliciesRestClient.ListByHubAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationPolicyResourceFormatResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<AuthorizationPolicyResourceFormatResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _authorizationPolicyResourceFormatAuthorizationPoliciesClientDiagnostics.CreateScope("AuthorizationPolicyResourceFormatCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _authorizationPolicyResourceFormatAuthorizationPoliciesRestClient.ListByHubNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationPolicyResourceFormatResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<AuthorizationPolicyResourceFormatResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _authorizationPolicyResourceFormatAuthorizationPoliciesClientDiagnostics.CreateScope("AuthorizationPolicyResourceFormatCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _authorizationPolicyResourceFormatAuthorizationPoliciesRestClient.ListByHub(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationPolicyResourceFormatResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<AuthorizationPolicyResourceFormatResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _authorizationPolicyResourceFormatAuthorizationPoliciesClientDiagnostics.CreateScope("AuthorizationPolicyResourceFormatCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _authorizationPolicyResourceFormatAuthorizationPoliciesRestClient.ListByHubNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AuthorizationPolicyResourceFormatResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
