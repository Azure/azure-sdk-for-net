    ...
    public partial class ProfileResourceFormatResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, string localeCode = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new CustomerInsightsArmOperation(_profileResourceFormatProfilesClientDiagnostics, Pipeline, _profileResourceFormatProfilesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, localeCode).Request, response, OperationFinalStateVia.NotSpecified);
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.CustomerInsights/hubs/{hubName}/profiles/{profileName}/getEnrichingKpis
        /// Operation Id: Profiles_GetEnrichingKpis
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
