...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class ConnectorMappingFormat
    {
        ...
        internal ConnectorMappingFormat(FormatType formatType, string columnDelimiter, string acceptLanguage, string quoteCharacter, string quoteEscapeCharacter, string arraySeparator, Dictionary<string, BinaryData> rawData)
        {
