...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class Participant
    {
        ...
        internal Participant(string profileTypeName, IList<ParticipantPropertyReference> participantPropertyReferences, string participantName, IDictionary<string, string> displayName, IDictionary<string, string> description, string role, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProfileTypeName = profileTypeName;
