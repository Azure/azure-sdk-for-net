...
{
    public partial class HubBillingInfoFormat : IUtf8JsonSerializable, IJsonModel<HubBillingInfoFormat>, IPersistableModel<HubBillingInfoFormat>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinUnits))
            {
                builder.Append("  minUnits:");
                builder.AppendLine($" '{MinUnits.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxUnits))
            {
                builder.Append("  maxUnits:");
                builder.AppendLine($" '{MaxUnits.Value.ToString()}'");
            }
