...
{
    internal partial class InteractionListResult : IUtf8JsonSerializable, IJsonModel<InteractionListResult>, IPersistableModel<InteractionListResult>
    {
        ...
        void IJsonModel<InteractionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InteractionListResult)} does not support '{format}' format.");
            }
