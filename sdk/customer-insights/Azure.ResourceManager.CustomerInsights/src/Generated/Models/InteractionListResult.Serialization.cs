...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InteractionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InteractionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InteractionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InteractionListResult>)} interface");
            }
        ...
        string IPersistableModel<InteractionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
