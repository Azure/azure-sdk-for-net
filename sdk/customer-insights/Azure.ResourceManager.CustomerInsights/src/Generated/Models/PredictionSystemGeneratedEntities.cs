...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class PredictionSystemGeneratedEntities
    {
        ...
        internal PredictionSystemGeneratedEntities(IReadOnlyList<string> generatedInteractionTypes, IReadOnlyList<string> generatedLinks, IReadOnlyDictionary<string, string> generatedKpis, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
