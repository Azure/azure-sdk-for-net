...
{
    internal partial class PredictionListResult : IUtf8JsonSerializable, IJsonModel<PredictionListResult>, IPersistableModel<PredictionListResult>
    {
        ...
        void IJsonModel<PredictionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PredictionListResult)} does not support '{format}' format.");
            }
