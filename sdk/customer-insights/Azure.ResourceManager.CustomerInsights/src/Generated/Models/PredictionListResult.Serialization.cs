...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PredictionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PredictionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PredictionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PredictionListResult>)} interface");
            }
        ...
        string IPersistableModel<PredictionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
