...
{
    public partial class WidgetTypeResourceFormatData : IUtf8JsonSerializable, IJsonModel<WidgetTypeResourceFormatData>, IPersistableModel<WidgetTypeResourceFormatData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WidgetTypeName))
            {
                ...
                builder.AppendLine($" '{WidgetTypeName}'");
            }
            ...
            if (Optional.IsDefined(ImageUri))
            {
                ...
                builder.AppendLine($" '{ImageUri.AbsoluteUri}'");
            }
            ...
            if (Optional.IsDefined(WidgetVersion))
            {
                ...
                builder.AppendLine($" '{WidgetVersion}'");
            }

            if (Optional.IsDefined(Changed))
            {
                builder.Append("  changed:");
                builder.AppendLine($" '{Changed.Value.ToString()}'");
            }
