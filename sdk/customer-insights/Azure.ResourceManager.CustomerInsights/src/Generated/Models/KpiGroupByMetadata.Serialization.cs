...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KpiGroupByMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KpiGroupByMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KpiGroupByMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KpiGroupByMetadata>)} interface");
            }
        ...
        string IPersistableModel<KpiGroupByMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
