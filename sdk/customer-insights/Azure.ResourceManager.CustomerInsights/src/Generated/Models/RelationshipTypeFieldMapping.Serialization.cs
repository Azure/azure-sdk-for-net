...
{
    public partial class RelationshipTypeFieldMapping : IUtf8JsonSerializable, IJsonModel<RelationshipTypeFieldMapping>, IPersistableModel<RelationshipTypeFieldMapping>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProfileFieldName))
            {
                builder.Append("  profileFieldName:");
                builder.AppendLine($" '{ProfileFieldName}'");
            }

            if (Optional.IsDefined(RelatedProfileKeyProperty))
            {
                builder.Append("  relatedProfileKeyProperty:");
                builder.AppendLine($" '{RelatedProfileKeyProperty}'");
            }
