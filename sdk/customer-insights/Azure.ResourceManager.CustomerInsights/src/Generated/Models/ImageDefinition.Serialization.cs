...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageDefinition>)} interface");
            }
        ...
        string IPersistableModel<ImageDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
