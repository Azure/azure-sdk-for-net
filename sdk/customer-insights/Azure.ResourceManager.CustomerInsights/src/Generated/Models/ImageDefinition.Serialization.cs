...
{
    public partial class ImageDefinition : IUtf8JsonSerializable, IJsonModel<ImageDefinition>, IPersistableModel<ImageDefinition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ImageExists))
            {
                builder.Append("  imageExists:");
                var boolValue = ImageExists.Value == true ? "true" : "false";
