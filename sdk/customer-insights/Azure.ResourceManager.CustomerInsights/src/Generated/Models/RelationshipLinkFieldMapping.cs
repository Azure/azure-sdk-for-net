...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class RelationshipLinkFieldMapping
    {
        ...
        internal RelationshipLinkFieldMapping(string interactionFieldName, LinkType? linkType, string relationshipFieldName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            InteractionFieldName = interactionFieldName;
            LinkType = linkType;
            RelationshipFieldName = relationshipFieldName;
