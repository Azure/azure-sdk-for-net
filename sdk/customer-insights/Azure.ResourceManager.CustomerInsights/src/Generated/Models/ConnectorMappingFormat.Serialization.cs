    ...
    public partial class ConnectorMappingFormat : IUtf8JsonSerializable, IJsonModel<ConnectorMappingFormat>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ColumnDelimiter))
            {
                ...
                if (ColumnDelimiter.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ColumnDelimiter}'''");
                }
                else
                {
                    builder.AppendLine($" '{ColumnDelimiter}'");
            ...
            if (Optional.IsDefined(AcceptLanguage))
            {
                ...
                if (AcceptLanguage.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{AcceptLanguage}'''");
                }
                else
                {
                    builder.AppendLine($" '{AcceptLanguage}'");
            ...
            if (Optional.IsDefined(QuoteCharacter))
            {
                ...
                if (QuoteCharacter.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{QuoteCharacter}'''");
                }
                else
                {
                    builder.AppendLine($" '{QuoteCharacter}'");
            ...
            if (Optional.IsDefined(QuoteEscapeCharacter))
            {
                builder.Append("  quoteEscapeCharacter:");
                if (QuoteEscapeCharacter.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{QuoteEscapeCharacter}'''");
                }
                else
                {
                    builder.AppendLine($" '{QuoteEscapeCharacter}'");
            ...
            if (Optional.IsDefined(ArraySeparator))
            {
                ...
                if (ArraySeparator.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ArraySeparator}'''");
                }
                else
                {
                    builder.AppendLine($" '{ArraySeparator}'");
