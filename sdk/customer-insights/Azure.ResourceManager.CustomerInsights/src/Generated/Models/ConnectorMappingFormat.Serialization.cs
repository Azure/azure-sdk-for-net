...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectorMappingFormat>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectorMappingFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectorMappingFormat>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectorMappingFormat>)} interface");
            }
        ...
        string IPersistableModel<ConnectorMappingFormat>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
