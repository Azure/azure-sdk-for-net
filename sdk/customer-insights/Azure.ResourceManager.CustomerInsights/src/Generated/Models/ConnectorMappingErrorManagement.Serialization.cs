...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectorMappingErrorManagement>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectorMappingErrorManagement>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectorMappingErrorManagement>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectorMappingErrorManagement>)} interface");
            }
        ...
        string IPersistableModel<ConnectorMappingErrorManagement>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
