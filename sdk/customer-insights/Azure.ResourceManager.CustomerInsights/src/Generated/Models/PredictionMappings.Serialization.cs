...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PredictionMappings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PredictionMappings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PredictionMappings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PredictionMappings>)} interface");
            }
        ...
        string IPersistableModel<PredictionMappings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
