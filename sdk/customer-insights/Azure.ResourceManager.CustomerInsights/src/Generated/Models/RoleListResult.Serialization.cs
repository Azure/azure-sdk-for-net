...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleListResult>)} interface");
            }
        ...
        string IPersistableModel<RoleListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
