...
{
    public partial class KpiThresholds : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KpiThresholds DeserializeKpiThresholds(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
