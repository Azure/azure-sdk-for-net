...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KpiThresholds>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KpiThresholds>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KpiThresholds>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KpiThresholds>)} interface");
            }
        ...
        string IPersistableModel<KpiThresholds>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
