...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelationshipsLookup>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelationshipsLookup>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelationshipsLookup>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RelationshipsLookup>)} interface");
            }
        ...
        string IPersistableModel<RelationshipsLookup>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
