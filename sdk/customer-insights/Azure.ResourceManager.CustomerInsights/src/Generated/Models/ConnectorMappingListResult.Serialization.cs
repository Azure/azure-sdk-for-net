...
{
    internal partial class ConnectorMappingListResult : IUtf8JsonSerializable, IJsonModel<ConnectorMappingListResult>, IPersistableModel<ConnectorMappingListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectorMappingListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ConnectorMappingListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ConnectorMappingListResult)} does not support '{format}' format.");
            }
