...
{
    public partial class StrongId : IUtf8JsonSerializable, IJsonModel<StrongId>, IPersistableModel<StrongId>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(KeyPropertyNames))
            {
                builder.Append("  keyPropertyNames:");
                builder.AppendLine(" [");
                foreach (var item in KeyPropertyNames)
                {
                    if (item == null)
            ...
            if (Optional.IsDefined(StrongIdName))
            {
                builder.Append("  strongIdName:");
                builder.AppendLine($" '{StrongIdName}'");
            }
