...
{
    public partial class StrongId : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StrongId DeserializeStrongId(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
