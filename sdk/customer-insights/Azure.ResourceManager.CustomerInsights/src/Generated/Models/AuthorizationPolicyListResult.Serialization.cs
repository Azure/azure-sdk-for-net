...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuthorizationPolicyListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<AuthorizationPolicyResourceFormatData>)item).Write(writer, options);
                }
        ...
        AuthorizationPolicyListResult IJsonModel<AuthorizationPolicyListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AuthorizationPolicyListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static AuthorizationPolicyListResult DeserializeAuthorizationPolicyListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<AuthorizationPolicyResourceFormatData> value = default;
            ...
            return new AuthorizationPolicyListResult(value ?? new ChangeTrackingList<AuthorizationPolicyResourceFormatData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AuthorizationPolicyListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AuthorizationPolicyListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AuthorizationPolicyListResult IPersistableModel<AuthorizationPolicyListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AuthorizationPolicyListResult)} does not support reading '{options.Format}' format.");
            }
        }
