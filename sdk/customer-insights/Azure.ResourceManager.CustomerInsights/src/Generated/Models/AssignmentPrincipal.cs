...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class AssignmentPrincipal
    {
        ...
        internal AssignmentPrincipal(string principalId, string principalType, IDictionary<string, string> principalMetadata, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PrincipalId = principalId;
            PrincipalType = principalType;
