...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        internal static PredictionTrainingResults DeserializePredictionTrainingResults(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
