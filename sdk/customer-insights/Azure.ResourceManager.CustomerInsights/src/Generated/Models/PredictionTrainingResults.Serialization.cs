...
{
    public partial class PredictionTrainingResults : IUtf8JsonSerializable, IJsonModel<PredictionTrainingResults>, IPersistableModel<PredictionTrainingResults>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ScoreName))
            {
                ...
                builder.AppendLine($" '{ScoreName}'");
            }

            if (Optional.IsDefined(PredictionDistribution))
            {
                builder.Append("  predictionDistribution:");
                AppendChildObject(builder, PredictionDistribution, options, 2);
            }

            if (Optional.IsCollectionDefined(CanonicalProfiles))
            {
                builder.Append("  canonicalProfiles:");
                builder.AppendLine(" [");
                foreach (var item in CanonicalProfiles)
                {
            ...
            {
                builder.Append("  primaryProfileInstanceCount:");
                builder.AppendLine($" '{PrimaryProfileInstanceCount.Value.ToString()}'");
            }
