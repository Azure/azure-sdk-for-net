...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuthorizationPolicyResourceFormatData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AuthorizationPolicyResourceFormatData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AuthorizationPolicyResourceFormatData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AuthorizationPolicyResourceFormatData>)} interface");
            }
        ...
        string IPersistableModel<AuthorizationPolicyResourceFormatData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
