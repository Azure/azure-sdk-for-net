...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KpiExtract>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KpiExtract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KpiExtract>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<KpiExtract>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
