...
{
    public partial class KpiExtract : IUtf8JsonSerializable, IJsonModel<KpiExtract>, IPersistableModel<KpiExtract>
    {
        ...
        void IJsonModel<KpiExtract>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(KpiExtract)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExtractName))
            {
                builder.Append("  extractName:");
                builder.AppendLine($" '{ExtractName}'");
            }
