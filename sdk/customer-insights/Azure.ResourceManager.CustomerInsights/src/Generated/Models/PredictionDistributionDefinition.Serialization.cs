...
{
    public partial class PredictionDistributionDefinition : IUtf8JsonSerializable, IJsonModel<PredictionDistributionDefinition>, IPersistableModel<PredictionDistributionDefinition>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TotalPositives))
            {
                builder.Append("  totalPositives:");
                builder.AppendLine($" '{TotalPositives.Value.ToString()}'");
            }

            if (Optional.IsDefined(TotalNegatives))
            {
                builder.Append("  totalNegatives:");
                builder.AppendLine($" '{TotalNegatives.Value.ToString()}'");
            }

            if (Optional.IsCollectionDefined(Distributions))
            {
                builder.Append("  distributions:");
                builder.AppendLine(" [");
                foreach (var item in Distributions)
                {
