...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class TypePropertiesMapping
    {
        ...
        internal TypePropertiesMapping(string sourcePropertyName, string targetPropertyName, LinkType? linkType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SourcePropertyName = sourcePropertyName;
            TargetPropertyName = targetPropertyName;
            LinkType = linkType;
