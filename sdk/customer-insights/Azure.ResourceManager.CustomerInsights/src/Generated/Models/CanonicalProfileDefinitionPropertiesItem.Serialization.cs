...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CanonicalProfileDefinitionPropertiesItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CanonicalProfileDefinitionPropertiesItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CanonicalProfileDefinitionPropertiesItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CanonicalProfileDefinitionPropertiesItem>)} interface");
            }
        ...
        string IPersistableModel<CanonicalProfileDefinitionPropertiesItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
