...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class RoleResourceFormat : ResourceData
    {
        ...
        internal RoleResourceFormat(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string roleName, string description, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            RoleName = roleName;
