    ...
    public partial class RelationshipResourceFormatData : IUtf8JsonSerializable, IJsonModel<RelationshipResourceFormatData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Cardinality))
            {
                ...
                builder.AppendLine($" '{Cardinality.Value.ToSerialString()}'");
            }
            ...
            if (Optional.IsDefined(ExpiryDateTimeUtc))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(ExpiryDateTimeUtc.Value, "o");
            ...
            if (Optional.IsDefined(ProfileType))
            {
                ...
                if (ProfileType.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(RelationshipName))
            {
                ...
                if (RelationshipName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(RelatedProfileType))
            {
                ...
                if (RelatedProfileType.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(RelationshipGuidId))
            {
                ...
                if (RelationshipGuidId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
