...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KpiAlias>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KpiAlias>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KpiAlias>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KpiAlias>)} interface");
            }
        ...
        string IPersistableModel<KpiAlias>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
