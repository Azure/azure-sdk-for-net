...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        internal static CanonicalProfileDefinition DeserializeCanonicalProfileDefinition(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
