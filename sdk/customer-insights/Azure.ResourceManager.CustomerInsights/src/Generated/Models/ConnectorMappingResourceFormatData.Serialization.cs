...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectorMappingResourceFormatData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectorMappingResourceFormatData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectorMappingResourceFormatData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectorMappingResourceFormatData>)} interface");
            }
        ...
        string IPersistableModel<ConnectorMappingResourceFormatData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
