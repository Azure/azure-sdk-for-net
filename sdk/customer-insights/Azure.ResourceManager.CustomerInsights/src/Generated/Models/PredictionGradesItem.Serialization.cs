...
{
    public partial class PredictionGradesItem : IUtf8JsonSerializable, IJsonModel<PredictionGradesItem>, IPersistableModel<PredictionGradesItem>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinScoreThreshold))
            {
                ...
                builder.AppendLine($" '{MinScoreThreshold.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaxScoreThreshold))
            {
                builder.Append("  maxScoreThreshold:");
                builder.AppendLine($" '{MaxScoreThreshold.Value.ToString()}'");
            }
