...
{
    public partial class ConnectorMappingCompleteOperation : IUtf8JsonSerializable, IJsonModel<ConnectorMappingCompleteOperation>, IPersistableModel<ConnectorMappingCompleteOperation>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectorMappingCompleteOperation>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CompletionOperationType))
            {
                builder.Append("  completionOperationType:");
                builder.AppendLine($" '{CompletionOperationType.ToString()}'");
            }

            if (Optional.IsDefined(DestinationFolder))
            {
                builder.Append("  destinationFolder:");
                builder.AppendLine($" '{DestinationFolder}'");
            }
