...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class StrongId
    {
        ...
        internal StrongId(IList<string> keyPropertyNames, string strongIdName, IDictionary<string, string> displayName, IDictionary<string, string> description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
