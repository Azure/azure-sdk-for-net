...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TypePropertiesMapping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TypePropertiesMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TypePropertiesMapping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TypePropertiesMapping>)} interface");
            }
        ...
        string IPersistableModel<TypePropertiesMapping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
