...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ViewResourceFormatData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ViewResourceFormatData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ViewResourceFormatData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ViewResourceFormatData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
