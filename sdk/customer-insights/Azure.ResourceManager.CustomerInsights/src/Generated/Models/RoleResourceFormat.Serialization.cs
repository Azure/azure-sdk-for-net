...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleResourceFormat>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleResourceFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleResourceFormat>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RoleResourceFormat>)} interface");
            }
        ...
        string IPersistableModel<RoleResourceFormat>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
