...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class RelationshipTypeFieldMapping
    {
        ...
        internal RelationshipTypeFieldMapping(string profileFieldName, string relatedProfileKeyProperty, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ProfileFieldName = profileFieldName;
            RelatedProfileKeyProperty = relatedProfileKeyProperty;
