...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HubListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HubListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HubListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HubListResult>)} interface");
            }
        ...
        string IPersistableModel<HubListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
