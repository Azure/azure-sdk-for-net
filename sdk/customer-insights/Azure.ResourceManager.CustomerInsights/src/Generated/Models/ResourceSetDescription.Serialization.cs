...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceSetDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceSetDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceSetDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceSetDescription>)} interface");
            }
        ...
        string IPersistableModel<ResourceSetDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
