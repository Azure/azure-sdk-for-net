...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class ProfileEnumValidValuesFormat
    {
        ...
        internal ProfileEnumValidValuesFormat(int? value, IDictionary<string, string> localizedValueNames, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
