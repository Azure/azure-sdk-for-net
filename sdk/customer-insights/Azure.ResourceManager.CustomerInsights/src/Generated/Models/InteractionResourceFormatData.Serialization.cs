...
{
    public partial class InteractionResourceFormatData : IUtf8JsonSerializable, IJsonModel<InteractionResourceFormatData>, IPersistableModel<InteractionResourceFormatData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InstancesCount))
            {
                ...
                builder.AppendLine($" '{InstancesCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(LastChangedUtc))
            {
                builder.Append("  lastChangedUtc:");
                builder.AppendLine($" '{LastChangedUtc.Value.ToString()}'");
            }
            ...
            {
                builder.Append("  id:");
                builder.AppendLine($" '{IdPropertiesDefaultDataSourceId.Value.ToString()}'");
            }
