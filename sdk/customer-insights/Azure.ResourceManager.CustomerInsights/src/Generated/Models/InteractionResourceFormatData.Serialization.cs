...
namespace Azure.ResourceManager.CustomerInsights
{
    public partial class InteractionResourceFormatData : IUtf8JsonSerializable, IModelJsonSerializable<InteractionResourceFormatData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<InteractionResourceFormatData>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(ParticipantProfiles))
            {
                ...
                foreach (var item in ParticipantProfiles)
                {
                    ...
                    {
                        ((IModelJsonSerializable<Participant>)item).Serialize(writer, options);
                    }
                }
                writer.WriteEndArray();
            }
        ...
        /// <summary> Converts a <see cref="InteractionResourceFormatData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="InteractionResourceFormatData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="InteractionResourceFormatData"/>. </summary>
