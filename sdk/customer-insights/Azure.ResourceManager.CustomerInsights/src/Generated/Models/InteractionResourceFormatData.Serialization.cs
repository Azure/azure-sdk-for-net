    ...
    public partial class InteractionResourceFormatData : IUtf8JsonSerializable, IJsonModel<InteractionResourceFormatData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(LocalizedAttributes))
            {
                ...
                {
                    builder.Append("    localizedAttributes:");
                    builder.AppendLine(" {");
                    foreach (var item in LocalizedAttributes)
                    {
                        builder.Append($"        {item.Key}:");
            ...
            if (Optional.IsDefined(SmallImage))
            {
                ...
                if (SmallImage.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{SmallImage}'''");
                }
                else
                {
                    builder.AppendLine($" '{SmallImage}'");
            ...
            if (Optional.IsDefined(MediumImage))
            {
                ...
                if (MediumImage.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{MediumImage}'''");
                }
                else
                {
                    builder.AppendLine($" '{MediumImage}'");
            ...
            if (Optional.IsDefined(LargeImage))
            {
                ...
                if (LargeImage.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{LargeImage}'''");
                }
                else
                {
                    builder.AppendLine($" '{LargeImage}'");
            ...
            if (Optional.IsDefined(ApiEntitySetName))
            {
                builder.Append("    apiEntitySetName:");
                if (ApiEntitySetName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ApiEntitySetName}'''");
                }
                else
                {
                    builder.AppendLine($" '{ApiEntitySetName}'");
            ...
            if (Optional.IsDefined(InstancesCount))
            {
                builder.Append("    instancesCount:");
                builder.AppendLine($" {InstancesCount.Value}");
            }

            if (Optional.IsDefined(LastChangedUtc))
            {
                builder.Append("    lastChangedUtc:");
                var formattedDateTimeString = TypeFormatters.ToString(LastChangedUtc.Value, "o");
            ...
            if (Optional.IsDefined(SchemaItemTypeLink))
            {
                builder.Append("    schemaItemTypeLink:");
                if (SchemaItemTypeLink.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{SchemaItemTypeLink}'''");
                }
                else
                {
                    builder.AppendLine($" '{SchemaItemTypeLink}'");
            ...
            if (Optional.IsDefined(TimestampFieldName))
            {
                builder.Append("    timestampFieldName:");
                if (TimestampFieldName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{TimestampFieldName}'''");
                }
                else
                {
                    builder.AppendLine($" '{TimestampFieldName}'");
            ...
            if (Optional.IsCollectionDefined(IdPropertyNames))
            {
                ...
                {
                    builder.Append("    idPropertyNames:");
                    builder.AppendLine(" [");
                    foreach (var item in IdPropertyNames)
                    {
                        if (item == null)
            ...
            if (Optional.IsCollectionDefined(ParticipantProfiles))
            {
                if (ParticipantProfiles.Any())
                {
                    builder.Append("    participantProfiles:");
                    builder.AppendLine(" [");
                    foreach (var item in ParticipantProfiles)
                    {
                        AppendChildObject(builder, item, options, 6, true);
            ...
            if (Optional.IsDefined(PrimaryParticipantProfilePropertyName))
            {
                builder.Append("    primaryParticipantProfilePropertyName:");
                if (PrimaryParticipantProfilePropertyName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{PrimaryParticipantProfilePropertyName}'''");
                }
                else
                {
                    builder.AppendLine($" '{PrimaryParticipantProfilePropertyName}'");
            ...
            {
                if (DataSourcePrecedenceRules.Any())
                {
            ...
            if (Optional.IsDefined(IsActivity))
            {
                builder.Append("    isActivity:");
                var boolValue = IsActivity.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            builder.Append("    defaultDataSource:");
            builder.AppendLine(" {");
            if (Optional.IsDefined(NamePropertiesDefaultDataSourceName))
            {
                builder.Append("      name:");
                if (NamePropertiesDefaultDataSourceName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{NamePropertiesDefaultDataSourceName}'''");
                }
                else
                {
                    builder.AppendLine($" '{NamePropertiesDefaultDataSourceName}'");
            ...
            if (Optional.IsDefined(DataSourceType))
            {
                ...
                builder.AppendLine($" '{DataSourceType.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(IdPropertiesDefaultDataSourceId))
            {
                builder.Append("      id:");
                builder.AppendLine($" {IdPropertiesDefaultDataSourceId.Value}");
            }

            if (Optional.IsDefined(DataSourceReferenceId))
            {
                builder.Append("      dataSourceReferenceId:");
                if (DataSourceReferenceId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
