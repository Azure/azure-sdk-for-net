...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class ParticipantProfilePropertyReference
    {
        ...
        internal ParticipantProfilePropertyReference(string interactionPropertyName, string profilePropertyName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            InteractionPropertyName = interactionPropertyName;
            ProfilePropertyName = profilePropertyName;
