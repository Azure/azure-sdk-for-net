...
{
    public partial class SuggestRelationshipLinksResponse : IUtf8JsonSerializable, IJsonModel<SuggestRelationshipLinksResponse>, IPersistableModel<SuggestRelationshipLinksResponse>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InteractionName))
            {
                ...
                builder.AppendLine($" '{InteractionName}'");
            }

            if (Optional.IsCollectionDefined(SuggestedRelationships))
            {
                builder.Append("  suggestedRelationships:");
                builder.AppendLine(" [");
                foreach (var item in SuggestedRelationships)
                {
