...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssignmentPrincipal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssignmentPrincipal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssignmentPrincipal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssignmentPrincipal>)} interface");
            }
        ...
        string IPersistableModel<AssignmentPrincipal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
