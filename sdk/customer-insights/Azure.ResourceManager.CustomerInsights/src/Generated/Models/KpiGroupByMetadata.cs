...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class KpiGroupByMetadata
    {
        ...
        internal KpiGroupByMetadata(IReadOnlyDictionary<string, string> displayName, string fieldName, string fieldType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
