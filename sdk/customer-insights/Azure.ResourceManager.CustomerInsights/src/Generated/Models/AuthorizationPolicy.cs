...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class AuthorizationPolicy
    {
        ...
        internal AuthorizationPolicy(string policyName, IReadOnlyList<PermissionType> permissions, string primaryKey, string secondaryKey, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
