...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    public partial class ConnectorMappingStructure
    {
        ...
        internal ConnectorMappingStructure(string propertyName, string columnName, string customFormatSpecifier, bool? isEncrypted, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PropertyName = propertyName;
            ColumnName = columnName;
