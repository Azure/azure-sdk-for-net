...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectorListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectorListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectorListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectorListResult>)} interface");
            }
        ...
        string IPersistableModel<ConnectorListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
