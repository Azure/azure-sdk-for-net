...
{
    public partial class Participant : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Participant DeserializeParticipant(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
