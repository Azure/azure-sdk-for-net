...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KpiParticipantProfilesMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KpiParticipantProfilesMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KpiParticipantProfilesMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KpiParticipantProfilesMetadata>)} interface");
            }
        ...
        string IPersistableModel<KpiParticipantProfilesMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
