...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuthorizationPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AuthorizationPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AuthorizationPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AuthorizationPolicy>)} interface");
            }
        ...
        string IPersistableModel<AuthorizationPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
