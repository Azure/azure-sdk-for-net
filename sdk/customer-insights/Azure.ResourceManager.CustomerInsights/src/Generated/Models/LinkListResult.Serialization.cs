...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LinkListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LinkListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LinkListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LinkListResult>)} interface");
            }
        ...
        string IPersistableModel<LinkListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
