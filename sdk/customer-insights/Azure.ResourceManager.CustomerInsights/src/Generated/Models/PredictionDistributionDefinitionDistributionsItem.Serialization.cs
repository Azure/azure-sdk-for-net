...
{
    public partial class PredictionDistributionDefinitionDistributionsItem : IUtf8JsonSerializable, IJsonModel<PredictionDistributionDefinitionDistributionsItem>, IPersistableModel<PredictionDistributionDefinitionDistributionsItem>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ScoreThreshold))
            {
                builder.Append("  scoreThreshold:");
                builder.AppendLine($" '{ScoreThreshold.Value.ToString()}'");
            }

            if (Optional.IsDefined(Positives))
            {
                builder.Append("  positives:");
                builder.AppendLine($" '{Positives.Value.ToString()}'");
            }

            if (Optional.IsDefined(Negatives))
            {
                builder.Append("  negatives:");
                builder.AppendLine($" '{Negatives.Value.ToString()}'");
            }

            if (Optional.IsDefined(PositivesAboveThreshold))
            {
                builder.Append("  positivesAboveThreshold:");
                builder.AppendLine($" '{PositivesAboveThreshold.Value.ToString()}'");
            }

            if (Optional.IsDefined(NegativesAboveThreshold))
            {
                builder.Append("  negativesAboveThreshold:");
                builder.AppendLine($" '{NegativesAboveThreshold.Value.ToString()}'");
            }
