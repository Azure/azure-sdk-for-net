...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelationshipLinkListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelationshipLinkListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelationshipLinkListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RelationshipLinkListResult>)} interface");
            }
        ...
        string IPersistableModel<RelationshipLinkListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
