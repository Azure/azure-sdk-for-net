...
{
    public partial class ConnectorMappingProperties : IUtf8JsonSerializable, IJsonModel<ConnectorMappingProperties>, IPersistableModel<ConnectorMappingProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ErrorManagement))
            {
                ...
                AppendChildObject(builder, ErrorManagement, options, 2);
            }
            ...
            if (Optional.IsDefined(CompleteOperation))
            {
                ...
                AppendChildObject(builder, CompleteOperation, options, 2);
            }
