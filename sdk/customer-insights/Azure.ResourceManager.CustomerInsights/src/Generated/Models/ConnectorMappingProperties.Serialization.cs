...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConnectorMappingProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConnectorMappingProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConnectorMappingProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConnectorMappingProperties>)} interface");
            }
        ...
        string IPersistableModel<ConnectorMappingProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
