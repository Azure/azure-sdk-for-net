...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HubData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HubData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HubData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HubData>)} interface");
            }
        ...
        string IPersistableModel<HubData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
