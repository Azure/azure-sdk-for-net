...
{
    public partial class HubData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HubData DeserializeHubData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
