...
{
    public partial class ParticipantProfilePropertyReference : IUtf8JsonSerializable, IJsonModel<ParticipantProfilePropertyReference>, IPersistableModel<ParticipantProfilePropertyReference>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InteractionPropertyName))
            {
                builder.Append("  interactionPropertyName:");
                builder.AppendLine($" '{InteractionPropertyName}'");
            }

            if (Optional.IsDefined(ProfilePropertyName))
            {
                builder.Append("  profilePropertyName:");
                builder.AppendLine($" '{ProfilePropertyName}'");
            }
