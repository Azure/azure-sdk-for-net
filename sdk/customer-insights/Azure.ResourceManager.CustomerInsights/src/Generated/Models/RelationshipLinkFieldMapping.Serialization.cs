    ...
    public partial class RelationshipLinkFieldMapping : IUtf8JsonSerializable, IJsonModel<RelationshipLinkFieldMapping>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InteractionFieldName))
            {
                ...
                if (InteractionFieldName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(LinkType))
            {
                ...
                builder.AppendLine($" '{LinkType.Value.ToSerialString()}'");
            }

            if (Optional.IsDefined(RelationshipFieldName))
            {
                builder.Append("  relationshipFieldName:");
                if (RelationshipFieldName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
