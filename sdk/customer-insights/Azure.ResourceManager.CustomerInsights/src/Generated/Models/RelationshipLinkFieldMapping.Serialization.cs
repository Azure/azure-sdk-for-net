...
{
    public partial class RelationshipLinkFieldMapping : IUtf8JsonSerializable, IJsonModel<RelationshipLinkFieldMapping>, IPersistableModel<RelationshipLinkFieldMapping>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InteractionFieldName))
            {
                builder.Append("  interactionFieldName:");
                builder.AppendLine($" '{InteractionFieldName}'");
            }
            ...
            if (Optional.IsDefined(RelationshipFieldName))
            {
                builder.Append("  relationshipFieldName:");
                builder.AppendLine($" '{RelationshipFieldName}'");
            }
