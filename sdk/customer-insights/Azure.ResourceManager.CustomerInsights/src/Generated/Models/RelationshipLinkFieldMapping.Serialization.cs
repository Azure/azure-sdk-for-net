...
namespace Azure.ResourceManager.CustomerInsights.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelationshipLinkFieldMapping>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelationshipLinkFieldMapping>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelationshipLinkFieldMapping>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RelationshipLinkFieldMapping>)} interface");
            }
        ...
        string IPersistableModel<RelationshipLinkFieldMapping>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
