...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RelationshipLinkResourceFormatData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RelationshipLinkResourceFormatData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RelationshipLinkResourceFormatData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RelationshipLinkResourceFormatData>)} interface");
            }
        ...
        string IPersistableModel<RelationshipLinkResourceFormatData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
