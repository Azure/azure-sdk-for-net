...
{
    public partial class RelationshipLinkResourceFormatData : IUtf8JsonSerializable, IJsonModel<RelationshipLinkResourceFormatData>, IPersistableModel<RelationshipLinkResourceFormatData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InteractionType))
            {
                builder.Append("  interactionType:");
                builder.AppendLine($" '{InteractionType}'");
            }
