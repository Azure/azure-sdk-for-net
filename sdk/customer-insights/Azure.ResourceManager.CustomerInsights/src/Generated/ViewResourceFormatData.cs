...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    public partial class ViewResourceFormatData : ResourceData
    {
        ...
        internal ViewResourceFormatData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string viewName, string userId, Guid? tenantId, IDictionary<string, string> displayName, string definition, DateTimeOffset? changed, DateTimeOffset? created, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            ViewName = viewName;
            UserId = userId;
            TenantId = tenantId;
