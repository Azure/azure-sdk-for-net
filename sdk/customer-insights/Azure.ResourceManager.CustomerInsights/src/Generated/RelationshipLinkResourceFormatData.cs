...
namespace Azure.ResourceManager.CustomerInsights
{
    ...
    public partial class RelationshipLinkResourceFormatData : ResourceData
    {
        ...
        internal RelationshipLinkResourceFormatData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> displayName, IDictionary<string, string> description, string interactionType, string linkName, IList<RelationshipLinkFieldMapping> mappings, IList<ParticipantProfilePropertyReference> profilePropertyReferences, ProvisioningState? provisioningState, IList<ParticipantProfilePropertyReference> relatedProfilePropertyReferences, string relationshipName, string relationshipGuidId, Guid? tenantId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
