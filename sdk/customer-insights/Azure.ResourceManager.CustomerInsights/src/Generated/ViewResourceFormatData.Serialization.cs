    ...
    public partial class ViewResourceFormatData : IUtf8JsonSerializable, IJsonModel<ViewResourceFormatData>
    {
        ...
        internal static ViewResourceFormatData DeserializeViewResourceFormatData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.CustomerInsights.ModelSerializationExtensions.WireOptions, AzureResourceManagerCustomerInsightsContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerCustomerInsightsContext.Default)
#endif
;
                    continue;
                }
