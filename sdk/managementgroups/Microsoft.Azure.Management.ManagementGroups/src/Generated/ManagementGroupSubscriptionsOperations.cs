...
namespace Microsoft.Azure.Management.ManagementGroups
{
    ...
    internal partial class ManagementGroupSubscriptionsOperations : IServiceOperations<ManagementGroupsAPIClient>, IManagementGroupSubscriptionsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<SubscriptionUnderManagementGroup>>> GetSubscriptionsUnderManagementGroupWithHttpMessagesAsync(string groupId, string skiptoken = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (groupId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "groupId");
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page1<SubscriptionUnderManagementGroup>>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
