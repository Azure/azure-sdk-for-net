...
namespace Microsoft.Azure.Management.ManagementGroups.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ParentGroupBagInfo class.
        /// </summary>
        ...
        /// <param name="name">The name of the parent management group. For
        ...
        public ParentGroupBagInfo(string id = default(string), string name = default(string), string displayName = default(string))
        {
            Id = id;
            Name = name;
        ...
        /// <summary>
        /// Gets or sets the name of the parent management group. For example,
