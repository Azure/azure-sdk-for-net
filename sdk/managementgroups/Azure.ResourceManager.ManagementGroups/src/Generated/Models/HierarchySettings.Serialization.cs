...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    {
        internal static HierarchySettings DeserializeHierarchySettings(JsonElement element)
        {
            ...
            return new HierarchySettings(id.Value, type.Value, name.Value, tenantId.Value, Optional.ToNullable(requireAuthorizationForGroupCreation), defaultManagementGroup.Value);
        }
    }
}
