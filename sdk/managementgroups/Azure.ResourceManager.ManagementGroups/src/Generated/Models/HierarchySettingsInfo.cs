...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    public partial class HierarchySettingsInfo
    {
        ...
        internal HierarchySettingsInfo(string id, string type, string name, string tenantId, bool? requireAuthorizationForGroupCreation, string defaultManagementGroup)
        {
            Id = id;
            Type = type;
            Name = name;
