...
namespace Azure.ResourceManager.ManagementGroups.Models
{
    ...
    public readonly partial struct Enum0 : IEquatable<Enum0>
    {
        ...
        public static Enum0 Children { get; } = new Enum0(ChildrenValue);
        /// <summary> path. </summary>
        public static Enum0 Path { get; } = new Enum0(PathValue);
        /// <summary> ancestors. </summary>
        public static Enum0 Ancestors { get; } = new Enum0(AncestorsValue);
        /// <summary> Determines if two <see cref="Enum0"/> values are the same. </summary>
