...
namespace Azure.ResourceManager.ManagementGroups
{
    ...
    {
        private readonly ArmOperationHelpers<ManagementGroup> _operation;
        ...
        internal ManagementGroupsCreateOrUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ManagementGroup>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "ManagementGroupsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
        ...
        ManagementGroup IOperationSource<ManagementGroup>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return ManagementGroup.DeserializeManagementGroup(document.RootElement);
        }
