# Azure Management Management client library for .NET
...
Install the Azure Management management library for .NET with [NuGet](https://www.nuget.org/):

```PowerShell
Install-Package Azure.ResourceManager.ManagementGroups -Version 1.0.0-preview.1 
```
