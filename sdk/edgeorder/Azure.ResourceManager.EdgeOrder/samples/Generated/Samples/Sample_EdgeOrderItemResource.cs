...
namespace Azure.ResourceManager.EdgeOrder.Samples
{
    public partial class Sample_EdgeOrderItemResource
    {
        ...
        public async Task Delete_DeleteOrderItemByName()
        {
            ...
            // invoke the operation
            await edgeOrderItem.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["tiger"] = "animal"
        ...
        public async Task Cancel_CancelOrderItem()
        {
            ...
            await edgeOrderItem.CancelAsync(cancellationReason).ConfigureAwait(false);
        ...
        public async Task Return_ReturnOrderItem()
        {
            ...
            await edgeOrderItem.ReturnAsync(WaitUntil.Completed, content).ConfigureAwait(false);
