...
namespace Azure.ResourceManager.EdgeOrder.Tests.Tests
{
    ...
    public class ListAddressTests : EdgeOrderManagementClientBase
    {
        ...
        private async Task CreateAddress()
        {
            ...
            // Create
            EdgeOrderManagementCreateAddressOperation createAddressOperation = await _addressResourceCollection.CreateOrUpdateAsync(addressName,
                addressResourceData);
        ...
        {
            AsyncPageable<AddressResource> addresses = SubscriptionExtensions.GetAddressesAtSubscriptionLevelAsync(Subscription);
