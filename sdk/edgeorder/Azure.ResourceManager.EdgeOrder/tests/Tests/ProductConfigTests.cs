    ...
    public class ProductConfigTests : EdgeOrderManagementClientBase
    {
        ...
        public async Task TestListProductFamiliesMetadata()
        {
            AsyncPageable<ProductFamiliesMetadataDetails> productFamiliesMetadata =
                SubscriptionResourceExtensions.GetProductFamiliesMetadataAsync(Subscription);
        ...
        public async Task TestListProductFamilies()
        {
            ...
            AsyncPageable<ProductFamily> productFamilies = SubscriptionResourceExtensions.GetProductFamiliesAsync(Subscription, productFamiliesRequest);
        ...
        public async Task TestListConfigurations()
        {
            ...
            AsyncPageable<ProductConfiguration> configurations = SubscriptionResourceExtensions.GetConfigurationsAsync(Subscription,
