...
namespace Azure.ResourceManager.EdgeOrder.Tests.Tests
{
    ...
    public class ListOrderItemTests : EdgeOrderManagementClientBase
    {
        ...
        private async Task CreateOrderItem()
        {
            ...
            _orderItemResourceCollection = GetOrderItemResourceCollection(resourceGroupName);
            ...
            EdgeOrderManagementCreateOrderItemOperation createOrderItemOperation = await
                _orderItemResourceCollection.CreateOrUpdateAsync(_orderItemName, orderItemResourceData);
        ...
        {
            AsyncPageable<OrderItemResource> orderItems = SubscriptionExtensions.GetOrderItemsAtSubscriptionLevelAsync(Subscription);
