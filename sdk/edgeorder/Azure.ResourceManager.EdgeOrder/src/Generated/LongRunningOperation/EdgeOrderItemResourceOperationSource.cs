...
{
    /// <summary></summary>
    internal partial class EdgeOrderItemResourceOperationSource : IOperationSource<EdgeOrderItemResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal EdgeOrderItemResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
