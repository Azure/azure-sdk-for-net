...
namespace Azure.ResourceManager.EdgeOrder
{
    internal partial class EdgeOrderArmOperation<T> : ArmOperation<T>
    {
        ...
        internal EdgeOrderArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
