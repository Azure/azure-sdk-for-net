...
{
    internal partial class OrderItemResourcesGetByResourceGroupCollectionResultOfT : Pageable<EdgeOrderItemData>
    {
        ...
        /// <summary> Initializes a new instance of OrderItemResourcesGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public OrderItemResourcesGetByResourceGroupCollectionResultOfT(OrderItemResources client, Guid subscriptionId, string resourceGroupName, string filter, string expand, string skipToken, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of OrderItemResourcesGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of OrderItemResourcesGetByResourceGroupCollectionResultOfT as an enumerable collection. </returns>
