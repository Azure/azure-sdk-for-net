...
namespace Azure.ResourceManager.EdgeOrder
{
    internal partial class OrderItemResourcesGetByResourceGroupCollectionResultOfT : Pageable<EdgeOrderItemData>
    {
        ...
        public OrderItemResourcesGetByResourceGroupCollectionResultOfT(OrderItemResources client, Guid subscriptionId, string resourceGroupName, string filter, string expand, string skipToken, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
