...
namespace Azure.ResourceManager.EdgeOrder
{
    internal partial class OrderItemResourcesGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<EdgeOrderItemData>
    {
        ...
        public OrderItemResourcesGetBySubscriptionAsyncCollectionResultOfT(OrderItemResources client, Guid subscriptionId, string filter, string expand, string skipToken, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
