...
namespace Azure.ResourceManager.EdgeOrder
{
    internal partial class OrdersOperationGroup2GetEdgeOrdersAsyncCollectionResultOfT : AsyncPageable<EdgeOrderData>
    {
        ...
        public OrdersOperationGroup2GetEdgeOrdersAsyncCollectionResultOfT(OrdersOperationGroup2 client, Guid subscriptionId, string skipToken, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
