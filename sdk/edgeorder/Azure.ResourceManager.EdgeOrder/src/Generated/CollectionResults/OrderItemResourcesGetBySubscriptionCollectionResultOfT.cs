...
{
    internal partial class OrderItemResourcesGetBySubscriptionCollectionResultOfT : Pageable<EdgeOrderItemData>
    {
        ...
        /// <summary> Initializes a new instance of OrderItemResourcesGetBySubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public OrderItemResourcesGetBySubscriptionCollectionResultOfT(OrderItemResources client, Guid subscriptionId, string filter, string expand, string skipToken, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of OrderItemResourcesGetBySubscriptionCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of OrderItemResourcesGetBySubscriptionCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<EdgeOrderItemData>> AsPages(string continuationToken, int? pageSizeHint)
        {
