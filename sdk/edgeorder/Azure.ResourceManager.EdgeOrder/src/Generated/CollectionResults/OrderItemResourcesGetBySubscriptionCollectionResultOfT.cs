...
namespace Azure.ResourceManager.EdgeOrder
{
    internal partial class OrderItemResourcesGetBySubscriptionCollectionResultOfT : Pageable<EdgeOrderItemData>
    {
        ...
        public OrderItemResourcesGetBySubscriptionCollectionResultOfT(OrderItemResources client, Guid subscriptionId, string filter, string expand, string skipToken, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
