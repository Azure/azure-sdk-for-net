...
{
    internal partial class OrdersOperationGroupGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<EdgeOrderData>
    {
        ...
        /// <summary> Initializes a new instance of OrdersOperationGroupGetByResourceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public OrdersOperationGroupGetByResourceGroupAsyncCollectionResultOfT(OrdersOperationGroup client, Guid subscriptionId, string resourceGroupName, string skipToken, int? top, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of OrdersOperationGroupGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of OrdersOperationGroupGetByResourceGroupAsyncCollectionResultOfT as an enumerable collection. </returns>
