...
namespace Azure.ResourceManager.EdgeOrder
{
    ...
    public partial class EdgeOrderManagementDeleteOrderItemByNameOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of EdgeOrderManagementDeleteOrderItemByNameOperation for mocking. </summary>
        protected EdgeOrderManagementDeleteOrderItemByNameOperation()
        {
        }

        internal EdgeOrderManagementDeleteOrderItemByNameOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "EdgeOrderManagementDeleteOrderItemByNameOperation");
        }
        /// <inheritdoc />
