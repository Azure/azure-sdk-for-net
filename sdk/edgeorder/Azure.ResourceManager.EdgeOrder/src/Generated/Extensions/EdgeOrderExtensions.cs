...
namespace Azure.ResourceManager.EdgeOrder
{
    ...
    public static partial class EdgeOrderExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetEdgeOrderAddresses();
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetEdgeOrders();
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetEdgeOrderItems();
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetEdgeOrdersAsync(skipToken, cancellationToken);
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetEdgeOrders(skipToken, cancellationToken);
        }
        ...
        public static AsyncPageable<ProductFamily> GetProductFamiliesAsync(this SubscriptionResource subscriptionResource, ProductFamiliesContent content, string expand = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).GetProductFamiliesAsync(content, expand, skipToken, cancellationToken);
        }
        ...
        public static Pageable<ProductFamily> GetProductFamilies(this SubscriptionResource subscriptionResource, ProductFamiliesContent content, string expand = null, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).GetProductFamilies(content, expand, skipToken, cancellationToken);
        }
        ...
        public static AsyncPageable<ProductConfiguration> GetConfigurationsAsync(this SubscriptionResource subscriptionResource, ConfigurationsContent content, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).GetConfigurationsAsync(content, skipToken, cancellationToken);
        }
        ...
        public static Pageable<ProductConfiguration> GetConfigurations(this SubscriptionResource subscriptionResource, ConfigurationsContent content, string skipToken = null, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).GetConfigurations(content, skipToken, cancellationToken);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetProductFamiliesMetadataAsync(skipToken, cancellationToken);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetProductFamiliesMetadata(skipToken, cancellationToken);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetEdgeOrdersAsync(skipToken, cancellationToken);
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetEdgeOrders(skipToken, cancellationToken);
        }
