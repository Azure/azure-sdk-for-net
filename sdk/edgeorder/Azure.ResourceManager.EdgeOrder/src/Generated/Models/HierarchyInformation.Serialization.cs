...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class HierarchyInformation : IUtf8JsonSerializable, IJsonModel<HierarchyInformation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProductFamilyName))
            {
                builder.Append("  productFamilyName:");
                if (ProductFamilyName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ProductFamilyName}'''");
                }
                else
                {
                    builder.AppendLine($" '{ProductFamilyName}'");
            ...
            if (Optional.IsDefined(ProductLineName))
            {
                ...
                if (ProductLineName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ProductLineName}'''");
                }
                else
                {
                    builder.AppendLine($" '{ProductLineName}'");
            ...
            if (Optional.IsDefined(ConfigurationName))
            {
                ...
                if (ConfigurationName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ConfigurationName}'''");
                }
                else
                {
                    builder.AppendLine($" '{ConfigurationName}'");
