...
{
    public partial class EdgeOrderItemAddressDetails : IUtf8JsonSerializable, IJsonModel<EdgeOrderItemAddressDetails>, IPersistableModel<EdgeOrderItemAddressDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  forwardAddress:");
                AppendChildObject(builder, ForwardAddress, options, 2);
            }

            if (Optional.IsDefined(ReturnAddress))
            {
                builder.Append("  returnAddress:");
                AppendChildObject(builder, ReturnAddress, options, 2);
            }
