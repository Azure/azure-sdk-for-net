...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class Product : IUtf8JsonSerializable, IJsonModel<Product>
    {
        ...
        internal static Product DeserializeProduct(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<EdgeOrderConfiguration> configurations = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("configurations"u8))
                        {
                            ...
                            List<EdgeOrderConfiguration> array = new List<EdgeOrderConfiguration>();
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(EdgeOrderConfiguration.DeserializeEdgeOrderConfiguration(item, options));
                            }
            ...
            return new Product(configurations ?? new ChangeTrackingList<EdgeOrderConfiguration>(), serializedAdditionalRawData);
        }
