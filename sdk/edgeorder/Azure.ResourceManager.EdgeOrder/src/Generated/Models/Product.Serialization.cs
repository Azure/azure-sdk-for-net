...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class Product
    {
        internal static Product DeserializeProduct(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<Configuration>> configurations = default;
            ...
            return new Product(displayName.Value, description.Value, Optional.ToList(imageInformation), costInformation.Value, availabilityInformation.Value, hierarchyInformation.Value, Optional.ToList(filterableProperties), Optional.ToList(configurations));
        }
    }
}
