...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class PurchaseMeterDetails : EdgeOrderProductMeterDetails
    {
        ...
        internal PurchaseMeterDetails(BillingType billingType, double? multiplier, EdgeOrderProductChargingType? chargingType, string productId, string skuId, string termId, Dictionary<string, BinaryData> rawData) : base(billingType, multiplier, chargingType, rawData)
        {
            ProductId = productId;
            SkuId = skuId;
            TermId = termId;
