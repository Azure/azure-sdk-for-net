...
{
    public partial class EdgeOrder : IUtf8JsonSerializable
    {
        ...
        internal static EdgeOrder DeserializeEdgeOrder(JsonElement element)
        {
            ...
            return new EdgeOrder(id, name, type, systemData.Value, Optional.ToList(orderItemIds), currentStage.Value, Optional.ToList(orderStageHistory), Optional.ToNullable(orderMode));
        }
    }
}
