...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class EdgeOrderProductBillingMeterDetails
    {
        ...
        internal EdgeOrderProductBillingMeterDetails(string name, EdgeOrderProductMeterDetails meterDetails, MeteringType? meteringType, string frequency, TermTypeDetails termTypeDetails, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
