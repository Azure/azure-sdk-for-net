...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class EdgeOrderProductBillingMeterDetails
    {
        ...
        internal EdgeOrderProductBillingMeterDetails(string name, EdgeOrderProductMeterDetails meterDetails, EdgeOrderProductMeteringType? meteringType, string frequency, TermTypeDetails termTypeDetails)
        {
            Name = name;
