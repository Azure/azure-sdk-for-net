...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductLink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProductLink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProductLink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProductLink>)} interface");
            }
        ...
        string IPersistableModel<ProductLink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
