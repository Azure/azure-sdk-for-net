...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class EdgeOrderItemPatch
    {
        ...
        internal EdgeOrderItemPatch(IDictionary<string, string> tags, EdgeOrderItemAddressProperties forwardAddress, OrderItemPreferences preferences, IList<string> notificationEmailList, Dictionary<string, BinaryData> rawData)
        {
            Tags = tags;
