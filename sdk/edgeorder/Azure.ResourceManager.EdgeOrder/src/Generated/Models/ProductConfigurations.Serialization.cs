...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductConfigurations>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProductConfigurations>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProductConfigurations>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProductConfigurations>)} interface");
            }
        ...
        string IPersistableModel<ProductConfigurations>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
