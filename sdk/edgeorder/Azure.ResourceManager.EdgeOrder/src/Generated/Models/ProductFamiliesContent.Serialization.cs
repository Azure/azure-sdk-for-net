...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductFamiliesContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProductFamiliesContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProductFamiliesContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProductFamiliesContent>)} interface");
            }
        ...
        string IPersistableModel<ProductFamiliesContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
