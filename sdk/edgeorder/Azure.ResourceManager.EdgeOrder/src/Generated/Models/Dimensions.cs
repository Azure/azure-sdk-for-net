...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class Dimensions
    {
        ...
        internal Dimensions(double? length, double? height, double? width, LengthHeightUnit? lengthHeightUnit, double? weight, double? depth, WeightMeasurementUnit? weightUnit)
        {
            Length = length;
            Height = height;
            Width = width;
