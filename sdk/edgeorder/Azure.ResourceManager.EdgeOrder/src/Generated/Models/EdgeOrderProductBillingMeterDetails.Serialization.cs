...
{
    public partial class EdgeOrderProductBillingMeterDetails : IUtf8JsonSerializable, IJsonModel<EdgeOrderProductBillingMeterDetails>, IPersistableModel<EdgeOrderProductBillingMeterDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  meteringType:");
                builder.AppendLine($" '{MeteringType.ToString()}'");
            }
