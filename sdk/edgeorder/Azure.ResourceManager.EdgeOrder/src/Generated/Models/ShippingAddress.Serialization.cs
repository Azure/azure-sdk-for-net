...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class ShippingAddress : IUtf8JsonSerializable
    {
        ...
        internal static ShippingAddress DeserializeShippingAddress(JsonElement element)
        {
            ...
            return new ShippingAddress(streetAddress1, streetAddress2.Value, streetAddress3.Value, city.Value, stateOrProvince.Value, country, postalCode.Value, zipExtendedCode.Value, companyName.Value, Optional.ToNullable(addressType));
        }
    }
}
