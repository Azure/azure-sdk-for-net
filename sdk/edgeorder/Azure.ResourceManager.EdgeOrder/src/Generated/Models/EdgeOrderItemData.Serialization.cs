...
namespace Azure.ResourceManager.EdgeOrder
{
    public partial class EdgeOrderItemData : IUtf8JsonSerializable, IJsonModel<EdgeOrderItemData>
    {
        ...
        void IJsonModel<EdgeOrderItemData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EdgeOrderItemData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EdgeOrderItemData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EdgeOrderItemData)} does not support '{options.Format}' format.");
            }
        }
