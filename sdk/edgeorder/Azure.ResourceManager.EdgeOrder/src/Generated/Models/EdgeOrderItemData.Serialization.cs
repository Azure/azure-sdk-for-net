...
{
    public partial class EdgeOrderItemData : IUtf8JsonSerializable, IJsonModel<EdgeOrderItemData>, IPersistableModel<EdgeOrderItemData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  orderItemDetails:");
                AppendChildObject(builder, OrderItemDetails, options, 2);
            }

            if (Optional.IsDefined(AddressDetails))
            {
                builder.Append("  addressDetails:");
                AppendChildObject(builder, AddressDetails, options, 2);
            }
            ...
            if (Optional.IsDefined(OrderId))
            {
                ...
                builder.AppendLine($" '{OrderId.ToString()}'");
            }
