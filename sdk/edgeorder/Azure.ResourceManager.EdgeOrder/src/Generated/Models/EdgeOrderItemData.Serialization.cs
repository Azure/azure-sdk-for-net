...
namespace Azure.ResourceManager.EdgeOrder
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeOrderItemData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeOrderItemData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeOrderItemData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeOrderItemData>)} interface");
            }
        ...
        string IPersistableModel<EdgeOrderItemData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
