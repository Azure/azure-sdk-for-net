...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class ProductConfiguration : IUtf8JsonSerializable, IJsonModel<ProductConfiguration>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ProductConfiguration>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProductConfiguration>)} interface");
            }
