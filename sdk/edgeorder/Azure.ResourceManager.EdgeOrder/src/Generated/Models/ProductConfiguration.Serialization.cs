...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class ProductConfiguration : IUtf8JsonSerializable, IJsonModel<ProductConfiguration>
    {
        ...
        void IJsonModel<ProductConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ProductConfiguration)} does not support '{format}' format.");
            }
            ...
            if (options.Format != "W" && !(Specifications is ChangeTrackingList<ProductSpecification> collection1 && collection1.IsUndefined))
            {
            ...
            if (options.Format != "W" && Dimensions != null)
            {
        ...
        BinaryData IPersistableModel<ProductConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ProductConfiguration)} does not support '{options.Format}' format.");
            }
        }
