...
{
    public partial class EdgeOrderData : IUtf8JsonSerializable, IJsonModel<EdgeOrderData>, IPersistableModel<EdgeOrderData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CurrentStage))
            {
                ...
                AppendChildObject(builder, CurrentStage, options, 2);
            }

            if (Optional.IsCollectionDefined(OrderStageHistory))
            {
                builder.Append("  orderStageHistory:");
                builder.AppendLine(" [");
                foreach (var item in OrderStageHistory)
                {
