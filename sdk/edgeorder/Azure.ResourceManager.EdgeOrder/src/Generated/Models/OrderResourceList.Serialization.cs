...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrderResourceList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<EdgeOrderData>)item).Write(writer, options);
                }
        ...
        internal static OrderResourceList DeserializeOrderResourceList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new OrderResourceList(value ?? new ChangeTrackingList<EdgeOrderData>(), nextLink, serializedAdditionalRawData);
        }
