...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductFamiliesMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProductFamiliesMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProductFamiliesMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProductFamiliesMetadata>)} interface");
            }
        ...
        string IPersistableModel<ProductFamiliesMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
