...
{
    public partial class EdgeOrderProductCostInformation : IUtf8JsonSerializable, IJsonModel<EdgeOrderProductCostInformation>, IPersistableModel<EdgeOrderProductCostInformation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  billingMeterDetails:");
                builder.AppendLine(" [");
                foreach (var item in BillingMeterDetails)
                {
            ...
            {
                builder.Append("  billingInfoUrl:");
                builder.AppendLine($" '{BillingInfoUri.AbsoluteUri}'");
            }
