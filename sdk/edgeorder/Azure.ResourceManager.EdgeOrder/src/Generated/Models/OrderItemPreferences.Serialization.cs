...
{
    public partial class OrderItemPreferences : IUtf8JsonSerializable, IJsonModel<OrderItemPreferences>, IPersistableModel<OrderItemPreferences>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(NotificationPreferences))
            {
                builder.Append("  notificationPreferences:");
                builder.AppendLine(" [");
                foreach (var item in NotificationPreferences)
                {
            ...
            if (Optional.IsDefined(ManagementResourcePreferences))
            {
                builder.Append("  managementResourcePreferences:");
                AppendChildObject(builder, ManagementResourcePreferences, options, 2);
            }
