...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        internal static EdgeOrderProductMeterDetails DeserializeEdgeOrderProductMeterDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
