...
namespace Azure.ResourceManager.EdgeOrder
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeOrderAddressData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeOrderAddressData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeOrderAddressData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeOrderAddressData>)} interface");
            }
        ...
        string IPersistableModel<EdgeOrderAddressData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
