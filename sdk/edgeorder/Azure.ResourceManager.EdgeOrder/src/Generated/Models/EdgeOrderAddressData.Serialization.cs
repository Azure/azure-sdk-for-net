...
{
    public partial class EdgeOrderAddressData : IUtf8JsonSerializable, IJsonModel<EdgeOrderAddressData>, IPersistableModel<EdgeOrderAddressData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AddressValidationStatus))
            {
                ...
                builder.AppendLine($" '{AddressValidationStatus.ToString()}'");
            }
