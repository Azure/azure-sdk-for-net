...
{
    public partial class NotificationPreference : IUtf8JsonSerializable, IJsonModel<NotificationPreference>, IPersistableModel<NotificationPreference>
    {
        ...
        void IJsonModel<NotificationPreference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NotificationPreference)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsNotificationRequired))
            {
                builder.Append("  sendNotification:");
                var boolValue = IsNotificationRequired == true ? "true" : "false";
