...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotificationPreference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NotificationPreference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NotificationPreference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NotificationPreference>)} interface");
            }
        ...
        string IPersistableModel<NotificationPreference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
