...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class EdgeOrderAddressContactDetails
    {
        ...
        internal EdgeOrderAddressContactDetails(string contactName, string phone, string phoneExtension, string mobile, IList<string> emailList, Dictionary<string, BinaryData> rawData)
        {
            ContactName = contactName;
            Phone = phone;
