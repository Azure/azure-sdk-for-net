...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CustomerSubscriptionDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CustomerSubscriptionDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CustomerSubscriptionDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CustomerSubscriptionDetails>)} interface");
            }
        ...
        string IPersistableModel<CustomerSubscriptionDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
