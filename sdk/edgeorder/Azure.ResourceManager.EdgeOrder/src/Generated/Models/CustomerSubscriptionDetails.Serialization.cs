...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class CustomerSubscriptionDetails : IUtf8JsonSerializable, IModelJsonSerializable<CustomerSubscriptionDetails>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CustomerSubscriptionDetails>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(RegisteredFeatures))
            {
                ...
                foreach (var item in RegisteredFeatures)
                {
                    ...
                    {
                        ((IModelJsonSerializable<CustomerSubscriptionRegisteredFeatures>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="CustomerSubscriptionDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CustomerSubscriptionDetails"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CustomerSubscriptionDetails"/>. </summary>
