...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    internal partial class OperationListResult
    {
        ...
        {
            Value = new ChangeTrackingList<EdgeOrderOperation>();
        }

        /// <summary> Initializes a new instance of OperationListResult. </summary>
        /// <param name="value"> List of operations supported by the resource provider. </param>
        /// <param name="nextLink"> URL to get the next set of operation list results (if there are any). </param>
        internal OperationListResult(IReadOnlyList<EdgeOrderOperation> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<EdgeOrderOperation> Value { get; }
