...
{
    public partial class ProductDetails : IUtf8JsonSerializable, IJsonModel<ProductDetails>, IPersistableModel<ProductDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DisplayInfo))
            {
                ...
                AppendChildObject(builder, DisplayInfo, options, 2);
            }
            ...
            {
                builder.Append("  productDoubleEncryptionStatus:");
                builder.AppendLine($" '{ProductDoubleEncryptionStatus.ToString()}'");
            }
