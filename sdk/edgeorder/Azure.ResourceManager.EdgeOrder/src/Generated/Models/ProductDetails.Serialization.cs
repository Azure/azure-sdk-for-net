...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class ProductDetails : IUtf8JsonSerializable, IModelJsonSerializable<ProductDetails>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ProductDetails>(this, options.Format);
            ...
            if (Optional.IsDefined(DisplayInfo))
            {
                ...
                {
                    ((IModelJsonSerializable<ProductDisplayInfo>)DisplayInfo).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="ProductDetails"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ProductDetails"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ProductDetails"/>. </summary>
