...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeOrderAddressPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeOrderAddressPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeOrderAddressPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EdgeOrderAddressPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
