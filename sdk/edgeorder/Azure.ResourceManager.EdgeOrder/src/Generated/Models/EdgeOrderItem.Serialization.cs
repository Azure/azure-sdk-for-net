...
{
    public partial class EdgeOrderItem : IUtf8JsonSerializable
    {
        ...
        internal static EdgeOrderItem DeserializeEdgeOrderItem(JsonElement element)
        {
            ...
            return new EdgeOrderItem(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity, orderItemDetails, addressDetails.Value, Optional.ToNullable(startTime), orderId, Optional.ToNullable(provisioningState));
        }
    }
}
