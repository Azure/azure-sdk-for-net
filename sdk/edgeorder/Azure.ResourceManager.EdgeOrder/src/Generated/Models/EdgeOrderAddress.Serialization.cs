...
{
    public partial class EdgeOrderAddress : IUtf8JsonSerializable
    {
        ...
        internal static EdgeOrderAddress DeserializeEdgeOrderAddress(JsonElement element)
        {
            ...
            return new EdgeOrderAddress(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, shippingAddress.Value, contactDetails, Optional.ToNullable(addressValidationStatus), Optional.ToNullable(provisioningState));
        }
    }
}
