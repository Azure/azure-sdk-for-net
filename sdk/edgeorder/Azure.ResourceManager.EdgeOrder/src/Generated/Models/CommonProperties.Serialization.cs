...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    internal partial class CommonProperties : BasicInformation, IJsonModel<CommonProperties>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonProperties)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CommonProperties IJsonModel<CommonProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CommonProperties)JsonModelCreateCore(ref reader, options);
        ...
        protected override BasicInformation JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CommonProperties)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CommonProperties DeserializeCommonProperties(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CommonProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected override BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CommonProperties)} does not support writing '{options.Format}' format.");
            }
        }
