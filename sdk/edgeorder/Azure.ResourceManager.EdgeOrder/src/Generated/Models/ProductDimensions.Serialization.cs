...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductDimensions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProductDimensions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProductDimensions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProductDimensions>)} interface");
            }
        ...
        string IPersistableModel<ProductDimensions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
