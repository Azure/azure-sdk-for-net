...
{
    public partial class ProductDimensions : IUtf8JsonSerializable, IJsonModel<ProductDimensions>, IPersistableModel<ProductDimensions>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Height))
            {
                ...
                builder.AppendLine($" '{Height.Value.ToString()}'");
            }

            if (Optional.IsDefined(Width))
            {
                builder.Append("  width:");
                builder.AppendLine($" '{Width.Value.ToString()}'");
            }

            if (Optional.IsDefined(LengthHeightUnit))
            {
                builder.Append("  lengthHeightUnit:");
                builder.AppendLine($" '{LengthHeightUnit.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Depth))
            {
                ...
                builder.AppendLine($" '{Depth.Value.ToString()}'");
            }

            if (Optional.IsDefined(WeightUnit))
            {
                builder.Append("  weightUnit:");
                builder.AppendLine($" '{WeightUnit.ToString()}'");
            }
