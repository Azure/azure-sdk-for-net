...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class ProductFamily
    {
        internal static ProductFamily DeserializeProductFamily(JsonElement element)
        {
            ...
            return new ProductFamily(displayName.Value, description.Value, Core.Optional.ToList(imageInformation), costInformation.Value, availabilityInformation.Value, hierarchyInformation.Value, Core.Optional.ToList(filterableProperties), Core.Optional.ToList(productLines), Core.Optional.ToList(resourceProviderDetails));
        }
    }
}
