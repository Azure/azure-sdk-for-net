...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class ProductFamily
    {
        internal static ProductFamily DeserializeProductFamily(JsonElement element)
        {
            ...
            Optional<Description> description = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("description"))
                        {
                            ...
                            description = Description.DeserializeDescription(property0.Value);
                            continue;
                        }
            ...
            return new ProductFamily(displayName.Value, description.Value, Optional.ToList(imageInformation), costInformation.Value, availabilityInformation.Value, hierarchyInformation.Value, Optional.ToList(filterableProperties), Optional.ToList(productLines));
        }
    }
}
