...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductFamily>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Description))
            {
                ...
                AppendChildObject(builder, Description, options, 4, false);
            }

            if (Optional.IsCollectionDefined(ImageInformation))
            {
                if (ImageInformation.Any())
                {
            ...
            if (Optional.IsDefined(CostInformation))
            {
                ...
                AppendChildObject(builder, CostInformation, options, 4, false);
            }

            if (Optional.IsDefined(AvailabilityInformation))
            {
                builder.Append("    availabilityInformation:");
                AppendChildObject(builder, AvailabilityInformation, options, 4, false);
            }

            if (Optional.IsDefined(HierarchyInformation))
            {
                builder.Append("    hierarchyInformation:");
                AppendChildObject(builder, HierarchyInformation, options, 4, false);
            }
            ...
            if (Optional.IsCollectionDefined(ResourceProviderDetails))
            {
                if (ResourceProviderDetails.Any())
                {
                    builder.Append("    resourceProviderDetails:");
                    builder.AppendLine(" [");
                    foreach (var item in ResourceProviderDetails)
                    {
                        AppendChildObject(builder, item, options, 6, true);
