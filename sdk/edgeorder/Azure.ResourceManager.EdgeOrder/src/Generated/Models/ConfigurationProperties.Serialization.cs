...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    internal partial class ConfigurationProperties : CommonProperties, IJsonModel<ConfigurationProperties>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConfigurationProperties IJsonModel<ConfigurationProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (ConfigurationProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ConfigurationProperties IPersistableModel<ConfigurationProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (ConfigurationProperties)PersistableModelCreateCore(data, options);
