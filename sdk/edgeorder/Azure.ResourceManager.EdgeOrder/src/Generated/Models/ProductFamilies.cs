...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    internal partial class ProductFamilies
    {
        ...
        internal ProductFamilies(IEnumerable<EdgeOrderProductFamily> value)
        {
            Value = value.ToList();
        }
        ...
        internal ProductFamilies(IReadOnlyList<EdgeOrderProductFamily> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<EdgeOrderProductFamily> Value { get; }
