...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeOrderProductImageInformation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeOrderProductImageInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeOrderProductImageInformation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeOrderProductImageInformation>)} interface");
            }
        ...
        string IPersistableModel<EdgeOrderProductImageInformation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
