...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ForwardShippingDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ForwardShippingDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ForwardShippingDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ForwardShippingDetails>)} interface");
            }
        ...
        string IPersistableModel<ForwardShippingDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
