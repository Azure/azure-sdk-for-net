...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class ProductFamiliesMetadataDetails
    {
        internal static ProductFamiliesMetadataDetails DeserializeProductFamiliesMetadataDetails(JsonElement element)
        {
            ...
            return new ProductFamiliesMetadataDetails(displayName.Value, description.Value, Optional.ToList(imageInformation), costInformation.Value, availabilityInformation.Value, hierarchyInformation.Value, Optional.ToList(filterableProperties), Optional.ToList(productLines));
        }
    }
}
