...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EncryptionPreferences>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EncryptionPreferences>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EncryptionPreferences>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EncryptionPreferences>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
