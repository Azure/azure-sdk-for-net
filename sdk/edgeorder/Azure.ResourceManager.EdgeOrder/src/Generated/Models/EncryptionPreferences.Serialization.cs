...
{
    internal partial class EncryptionPreferences : IUtf8JsonSerializable, IJsonModel<EncryptionPreferences>, IPersistableModel<EncryptionPreferences>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DoubleEncryptionStatus))
            {
                builder.Append("  doubleEncryptionStatus:");
                builder.AppendLine($" '{DoubleEncryptionStatus.ToString()}'");
            }
