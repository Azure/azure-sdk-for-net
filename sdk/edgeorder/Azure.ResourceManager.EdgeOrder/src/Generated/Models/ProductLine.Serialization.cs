...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class ProductLine
    {
        internal static ProductLine DeserializeProductLine(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<EdgeOrderProduct>> products = default;
            ...
            return new ProductLine(displayName.Value, description.Value, Core.Optional.ToList(imageInformation), costInformation.Value, availabilityInformation.Value, hierarchyInformation.Value, Core.Optional.ToList(filterableProperties), Core.Optional.ToList(products));
        }
    }
}
