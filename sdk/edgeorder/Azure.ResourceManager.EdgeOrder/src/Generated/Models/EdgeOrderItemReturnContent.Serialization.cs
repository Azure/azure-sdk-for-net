...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeOrderItemReturnContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeOrderItemReturnContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeOrderItemReturnContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EdgeOrderItemReturnContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
