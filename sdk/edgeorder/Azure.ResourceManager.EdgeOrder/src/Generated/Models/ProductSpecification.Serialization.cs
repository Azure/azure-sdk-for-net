...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProductSpecification>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProductSpecification>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProductSpecification>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProductSpecification>)} interface");
            }
        ...
        string IPersistableModel<ProductSpecification>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
