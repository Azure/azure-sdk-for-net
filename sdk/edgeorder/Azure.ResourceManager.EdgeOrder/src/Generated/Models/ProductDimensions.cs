...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class ProductDimensions
    {
        ...
        internal ProductDimensions(double? length, double? height, double? width, ProductLengthHeightWidthUnit? lengthHeightUnit, double? weight, double? depth, ProductWeightMeasurementUnit? weightUnit, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Length = length;
            Height = height;
            Width = width;
