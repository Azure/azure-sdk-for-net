...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class ReverseShippingDetails
    {
        ...
        internal ReverseShippingDetails(string sasKeyForLabel, string carrierName, string carrierDisplayName, string trackingId, Uri trackingUri, Dictionary<string, BinaryData> rawData)
        {
