...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    public partial class Configuration
    {
        internal static Configuration DeserializeConfiguration(JsonElement element)
        {
            ...
            Optional<IReadOnlyList<Specification>> specifications = default;
            Optional<Dimensions> dimensions = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("specifications"))
                        {
                            ...
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(Specification.DeserializeSpecification(item));
                            }
                        ...
                        if (property0.NameEquals("dimensions"))
                        {
                            ...
                            dimensions = Dimensions.DeserializeDimensions(property0.Value);
                            continue;
                        }
                    }
                    continue;
            ...
            return new Configuration(displayName.Value, description.Value, Optional.ToList(imageInformation), costInformation.Value, availabilityInformation.Value, hierarchyInformation.Value, Optional.ToList(filterableProperties), Optional.ToList(specifications), dimensions.Value);
        }
    }
}
