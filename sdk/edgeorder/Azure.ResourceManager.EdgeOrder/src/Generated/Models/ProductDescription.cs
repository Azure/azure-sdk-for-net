...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    public partial class ProductDescription
    {
        ...
        internal ProductDescription(ProductDescriptionType? descriptionType, string shortDescription, string longDescription, IReadOnlyList<string> keywords, IReadOnlyList<string> attributes, IReadOnlyList<ProductLink> links, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
