...
namespace Azure.ResourceManager.EdgeOrder.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeOrderStageDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeOrderStageDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeOrderStageDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EdgeOrderStageDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
