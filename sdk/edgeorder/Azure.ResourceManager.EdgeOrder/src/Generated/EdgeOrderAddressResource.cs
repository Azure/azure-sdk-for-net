...
namespace Azure.ResourceManager.EdgeOrder
{
    ...
    public partial class EdgeOrderAddressResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<EdgeOrderAddressResource>> UpdateAsync(WaitUntil waitUntil, EdgeOrderAddressData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _addressResourcesRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, EdgeOrderAddressData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                EdgeOrderArmOperation<EdgeOrderAddressResource> operation = new EdgeOrderArmOperation<EdgeOrderAddressResource>(
                    new EdgeOrderAddressResourceOperationSource(Client),
                    _addressResourcesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<EdgeOrderAddressResource> Update(WaitUntil waitUntil, EdgeOrderAddressData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
