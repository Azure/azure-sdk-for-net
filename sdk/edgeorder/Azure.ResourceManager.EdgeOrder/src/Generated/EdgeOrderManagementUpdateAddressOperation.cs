...
namespace Azure.ResourceManager.EdgeOrder
{
    ...
    public partial class EdgeOrderManagementUpdateAddressOperation : Operation<AddressResource>, IOperationSource<AddressResource>
    {
        ...
        internal EdgeOrderManagementUpdateAddressOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<AddressResource>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "EdgeOrderManagementUpdateAddressOperation");
        }
        /// <inheritdoc />
