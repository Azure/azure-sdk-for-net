...
namespace Azure.ResourceManager.EdgeOrder
{
    ...
    public partial class EdgeOrderItemResource : ArmResource
    {
        ...
        {
            _edgeOrderItemOrderItemResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.EdgeOrder", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string edgeOrderItemOrderItemResourcesApiVersion);
        ...
        {
            using var scope = _edgeOrderItemOrderItemResourcesClientDiagnostics.CreateScope("EdgeOrderItemResource.Get");
            scope.Start();
            try
            {
                var response = await _edgeOrderItemOrderItemResourcesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, expand, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<EdgeOrderItemResource> Get(string expand = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _edgeOrderItemOrderItemResourcesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, expand, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new EdgeOrderItemResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>OrderItemResource_Delete</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-02-01</description>
        ...
        {
            using var scope = _edgeOrderItemOrderItemResourcesClientDiagnostics.CreateScope("EdgeOrderItemResource.Delete");
            scope.Start();
            try
            {
                var response = await _edgeOrderItemOrderItemResourcesRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new EdgeOrderArmOperation(_edgeOrderItemOrderItemResourcesClientDiagnostics, Pipeline, _edgeOrderItemOrderItemResourcesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _edgeOrderItemOrderItemResourcesRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new EdgeOrderArmOperation(_edgeOrderItemOrderItemResourcesClientDiagnostics, Pipeline, _edgeOrderItemOrderItemResourcesRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>OrderItemResource_Update</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-02-01</description>
        ...
        public virtual async Task<ArmOperation<EdgeOrderItemResource>> UpdateAsync(WaitUntil waitUntil, EdgeOrderItemPatch patch, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _edgeOrderItemOrderItemResourcesClientDiagnostics.CreateScope("EdgeOrderItemResource.Update");
            scope.Start();
            try
            {
                var response = await _edgeOrderItemOrderItemResourcesRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, ifMatch, cancellationToken).ConfigureAwait(false);
                var operation = new EdgeOrderArmOperation<EdgeOrderItemResource>(new EdgeOrderItemOperationSource(Client), _edgeOrderItemOrderItemResourcesClientDiagnostics, Pipeline, _edgeOrderItemOrderItemResourcesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, ifMatch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<EdgeOrderItemResource> Update(WaitUntil waitUntil, EdgeOrderItemPatch patch, string ifMatch = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _edgeOrderItemOrderItemResourcesRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, ifMatch, cancellationToken);
                var operation = new EdgeOrderArmOperation<EdgeOrderItemResource>(new EdgeOrderItemOperationSource(Client), _edgeOrderItemOrderItemResourcesClientDiagnostics, Pipeline, _edgeOrderItemOrderItemResourcesRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, ifMatch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response> CancelAsync(EdgeOrderItemCancellationReason cancellationReason, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _edgeOrderItemOrderItemResourcesClientDiagnostics.CreateScope("EdgeOrderItemResource.Cancel");
            scope.Start();
            try
            {
                var response = await _edgeOrderItemOrderItemResourcesRestClient.CancelAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationReason, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response Cancel(EdgeOrderItemCancellationReason cancellationReason, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _edgeOrderItemOrderItemResourcesRestClient.Cancel(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationReason, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>OrderItemResources_Return</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2024-02-01</description>
        ...
        public virtual async Task<ArmOperation<OkResponse>> ReturnAsync(WaitUntil waitUntil, EdgeOrderItemReturnContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));

            using var scope = _edgeOrderItemOrderItemResourcesClientDiagnostics.CreateScope("EdgeOrderItemResource.Return");
            scope.Start();
            try
            {
                ...
                var operation = new EdgeOrderArmOperation<OkResponse>(new OkResponseOperationSource(), _edgeOrderItemOrderItemResourcesClientDiagnostics, Pipeline, _edgeOrderItemOrderItemResourcesRestClient.CreateReturnRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<OkResponse> Return(WaitUntil waitUntil, EdgeOrderItemReturnContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<Response<EdgeOrderItemResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _edgeOrderItemOrderItemResourcesClientDiagnostics.CreateScope("EdgeOrderItemResource.AddTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _edgeOrderItemOrderItemResourcesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, null, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<EdgeOrderItemResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _edgeOrderItemOrderItemResourcesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, null, cancellationToken);
                    return Response.FromValue(new EdgeOrderItemResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
        ...
        public virtual async Task<Response<EdgeOrderItemResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _edgeOrderItemOrderItemResourcesClientDiagnostics.CreateScope("EdgeOrderItemResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<EdgeOrderItemResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _edgeOrderItemOrderItemResourcesClientDiagnostics.CreateScope("EdgeOrderItemResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
