...
namespace Azure.ResourceManager.EdgeOrder
{
    ...
    public partial class EdgeOrderManagementReturnOrderItemOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of EdgeOrderManagementReturnOrderItemOperation for mocking. </summary>
        protected EdgeOrderManagementReturnOrderItemOperation()
        {
        }

        internal EdgeOrderManagementReturnOrderItemOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "EdgeOrderManagementReturnOrderItemOperation");
        }
        /// <inheritdoc />
