...
{
    /// <summary></summary>
    internal partial class TrustedSigningAccountResourceOperationSource : IOperationSource<TrustedSigningAccountResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal TrustedSigningAccountResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
