...
namespace Azure.ResourceManager.TrustedSigning
{
    internal partial class TrustedSigningArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of TrustedSigningArmOperation for mocking. </summary>
        protected TrustedSigningArmOperation()
        {
        }
        ...
        internal TrustedSigningArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
