...
namespace Azure.ResourceManager.TrustedSigning
{
    internal partial class CertificateProfilesGetByCodeSigningAccountCollectionResultOfT : Pageable<TrustedSigningCertificateProfileData>
    {
        ...
        public CertificateProfilesGetByCodeSigningAccountCollectionResultOfT(CertificateProfiles client, Guid subscriptionId, string resourceGroupName, string accountName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
