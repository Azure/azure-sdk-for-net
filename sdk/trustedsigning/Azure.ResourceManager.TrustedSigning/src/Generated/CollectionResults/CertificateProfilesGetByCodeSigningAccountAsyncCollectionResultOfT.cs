...
{
    internal partial class CertificateProfilesGetByCodeSigningAccountAsyncCollectionResultOfT : AsyncPageable<TrustedSigningCertificateProfileData>
    {
        ...
        public override async IAsyncEnumerable<Page<TrustedSigningCertificateProfileData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("CertificateProfiles.GetByCodeSigningAccount");
            scope.Start();
            try
            {
