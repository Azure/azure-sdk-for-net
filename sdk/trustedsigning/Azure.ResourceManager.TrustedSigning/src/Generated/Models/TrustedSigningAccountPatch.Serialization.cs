...
namespace Azure.ResourceManager.TrustedSigning.Models
{
    ...
    public partial class TrustedSigningAccountPatch : IJsonModel<TrustedSigningAccountPatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        TrustedSigningAccountPatch IJsonModel<TrustedSigningAccountPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual TrustedSigningAccountPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<TrustedSigningAccountPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static TrustedSigningAccountPatch DeserializeTrustedSigningAccountPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            CodeSigningAccountPatchProperties properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CodeSigningAccountPatchProperties.DeserializeCodeSigningAccountPatchProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual TrustedSigningAccountPatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<TrustedSigningAccountPatch>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
