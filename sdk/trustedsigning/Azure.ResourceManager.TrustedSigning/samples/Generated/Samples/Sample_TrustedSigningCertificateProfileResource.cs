...
namespace Azure.ResourceManager.TrustedSigning.Samples
{
    public partial class Sample_TrustedSigningCertificateProfileResource
    {
        ...
        public async Task Delete_DeleteACertificateProfile()
        {
            ...
            // invoke the operation
            await trustedSigningCertificateProfile.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task RevokeCertificate_RevokeACertificateUnderACertificateProfile()
        {
            ...
            // invoke the operation
            RevokeCertificateContent content = new RevokeCertificateContent("xxxxxxxxxxxxxxxxxx", "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", default, "KeyCompromised")
            {
                Remarks = "test",
            };
            await trustedSigningCertificateProfile.RevokeCertificateAsync(content).ConfigureAwait(false);
