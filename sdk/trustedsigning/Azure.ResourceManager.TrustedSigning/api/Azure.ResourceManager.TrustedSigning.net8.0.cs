...
namespace Azure.ResourceManager.TrustedSigning.Models
{
    public static partial class ArmTrustedSigningModelFactory
    {
        ...
        public static Azure.ResourceManager.TrustedSigning.Models.TrustedSigningAccountNameAvailabilityContent TrustedSigningAccountNameAvailabilityContent(Azure.Core.ResourceType type = default(Azure.Core.ResourceType), string name = null) { throw null; }
    ...
    {
        public TrustedSigningAccountNameAvailabilityContent(Azure.Core.ResourceType type, string name) { }
