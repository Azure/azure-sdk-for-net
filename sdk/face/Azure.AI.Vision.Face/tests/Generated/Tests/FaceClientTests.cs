...
{
    public partial class FaceClientTests : AIVisionFaceTestBase
    {
        public FaceClientTests(bool isAsync) : base(isAsync)
        {
        }

        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_FindSimilar_FindSimilarAmongFaceIDs()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
...
"be386ab3-af91-4104-9e6d-4dae4c9fddb7"
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_FindSimilar_FindSimilarAmongFaceIDs_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_VerifyFaceToFace_VerifyFaceToFace()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_VerifyFaceToFace_VerifyFaceToFace_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_Group_GroupFaceIDs()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
...
"b64d5e15-8257-4af2-b20a-5a750f8940e7"
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_Group_GroupFaceIDs_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_FindSimilarFromLargeFaceList_FindSimilarFromLargeFaceList()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_FindSimilarFromLargeFaceList_FindSimilarFromLargeFaceList_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_IdentifyFromLargePersonGroup_IdentifyFromLargePersonGroup()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
...
"c5c24a82-6845-4031-9d5d-978df9175426"
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_IdentifyFromLargePersonGroup_IdentifyFromLargePersonGroup_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_VerifyFromLargePersonGroup_VerifyFromLargePersonGroup()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
        ...
        [Test]
        [Ignore("Please remove the Ignore attribute to let the test method run")]
        public async Task FaceClient_VerifyFromLargePersonGroup_VerifyFromLargePersonGroup_Convenience()
        {
            Uri endpoint = new Uri("<endpoint>");
            AzureKeyCredential credential = new AzureKeyCredential("<key>");
            FaceClient client = CreateFaceClient(endpoint, credential);
