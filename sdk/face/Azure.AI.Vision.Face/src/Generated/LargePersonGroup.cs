...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LargePersonGroup
    {
        ...
        /// <summary> Initializes a new instance of LargePersonGroup for mocking. </summary>
        protected LargePersonGroup()
        {
        }
        ...
        internal LargePersonGroup(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largePersonGroupId"/> or <paramref name="createCollectionOptions"/> is null. </exception>
        ...
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='CreateAsync(string,CreateCollectionOptions,CancellationToken)']/*" />
        public virtual async Task<Response> CreateAsync(string largePersonGroupId, CreateCollectionOptions createCollectionOptions, CancellationToken cancellationToken = default)
        {
            ...
            Response response = await CreateAsync(largePersonGroupId, content, context).ConfigureAwait(false);
            return response;
        }
        ...
        /// &gt;   * S0-tier subscription quota: 1,000,000 Large Person Groups.
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='Create(string,CreateCollectionOptions,CancellationToken)']/*" />
        public virtual Response Create(string largePersonGroupId, CreateCollectionOptions createCollectionOptions, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
            Argument.AssertNotNull(createCollectionOptions, nameof(createCollectionOptions));
            ...
            using RequestContent content = createCollectionOptions.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = Create(largePersonGroupId, content, context);
            return response;
        }
        ...
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='CreateAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateAsync(string largePersonGroupId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.Create");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='Create(string,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='DeleteAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> DeleteAsync(string largePersonGroupId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));

            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.Delete");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='Delete(string,RequestContext)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largePersonGroupId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largePersonGroupId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetLargePersonGroupAsync(string,bool?,CancellationToken)']/*" />
        public virtual async Task<Response<LargePersonGroupData>> GetLargePersonGroupAsync(string largePersonGroupId, bool? returnRecognitionModel = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetLargePersonGroupAsync(largePersonGroupId, returnRecognitionModel, context).ConfigureAwait(false);
            return Response.FromValue(LargePersonGroupData.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largePersonGroupId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largePersonGroupId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetLargePersonGroup(string,bool?,CancellationToken)']/*" />
        public virtual Response<LargePersonGroupData> GetLargePersonGroup(string largePersonGroupId, bool? returnRecognitionModel = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetLargePersonGroupAsync(string,bool?,RequestContext)']/*" />
        public virtual async Task<Response> GetLargePersonGroupAsync(string largePersonGroupId, bool? returnRecognitionModel, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.GetLargePersonGroup");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetLargePersonGroup(string,bool?,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='UpdateAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> UpdateAsync(string largePersonGroupId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.Update");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='Update(string,RequestContent,RequestContext)']/*" />
        ...
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetLargePersonGroupsAsync(string,int?,bool?,CancellationToken)']/*" />
        public virtual async Task<Response<IReadOnlyList<LargePersonGroupData>>> GetLargePersonGroupsAsync(string start = null, int? top = null, bool? returnRecognitionModel = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetLargePersonGroupsAsync(start, top, returnRecognitionModel, context).ConfigureAwait(false);
            IReadOnlyList<LargePersonGroupData> value = default;
            using var document = await JsonDocument.ParseAsync(response.ContentStream, default, cancellationToken).ConfigureAwait(false);
            List<LargePersonGroupData> array = new List<LargePersonGroupData>();
            foreach (var item in document.RootElement.EnumerateArray())
            {
                array.Add(LargePersonGroupData.DeserializeLargePersonGroupData(item));
            }
            value = array;
        ...
        /// &gt;   * "start=itemId2&amp;top=3" will return "itemId3", "itemId4", "itemId5".
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetLargePersonGroups(string,int?,bool?,CancellationToken)']/*" />
        public virtual Response<IReadOnlyList<LargePersonGroupData>> GetLargePersonGroups(string start = null, int? top = null, bool? returnRecognitionModel = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetLargePersonGroupsAsync(string,int?,bool?,RequestContext)']/*" />
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.GetLargePersonGroups");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetLargePersonGroups(string,int?,bool?,RequestContext)']/*" />
        ...
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetTrainingStatusAsync(string,CancellationToken)']/*" />
        public virtual async Task<Response<FaceCollectionTrainingResult>> GetTrainingStatusAsync(string largePersonGroupId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
        ...
        /// <exception cref="ArgumentException"> <paramref name="largePersonGroupId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <remarks> Training time depends on the number of person entries, and their faces in a Large Person Group. It could be in seconds, or up to half an hour for 1,000,000 persons. </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetTrainingStatus(string,CancellationToken)']/*" />
        public virtual Response<FaceCollectionTrainingResult> GetTrainingStatus(string largePersonGroupId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetTrainingStatusAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> GetTrainingStatusAsync(string largePersonGroupId, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));

            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.GetTrainingStatus");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetTrainingStatus(string,RequestContext)']/*" />
        ...
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='CreatePersonAsync(string,UserDefinedFields,CancellationToken)']/*" />
        public virtual async Task<Response<CreatePersonResult>> CreatePersonAsync(string largePersonGroupId, UserDefinedFields userDefinedFields, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
        ...
        /// &gt;     * 1,000,000,000 persons in all Large Person Groups.
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='CreatePerson(string,UserDefinedFields,CancellationToken)']/*" />
        public virtual Response<CreatePersonResult> CreatePerson(string largePersonGroupId, UserDefinedFields userDefinedFields, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
            Argument.AssertNotNull(userDefinedFields, nameof(userDefinedFields));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='CreatePersonAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreatePersonAsync(string largePersonGroupId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.CreatePerson");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='CreatePerson(string,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='DeletePersonAsync(string,Guid,RequestContext)']/*" />
        public virtual async Task<Response> DeletePersonAsync(string largePersonGroupId, Guid personId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));

            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.DeletePerson");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='DeletePerson(string,Guid,RequestContext)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largePersonGroupId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largePersonGroupId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetPersonAsync(string,Guid,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largePersonGroupId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largePersonGroupId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetPerson(string,Guid,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetPersonAsync(string,Guid,RequestContext)']/*" />
        public virtual async Task<Response> GetPersonAsync(string largePersonGroupId, Guid personId, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));

            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.GetPerson");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetPerson(string,Guid,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='UpdatePersonAsync(string,Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> UpdatePersonAsync(string largePersonGroupId, Guid personId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.UpdatePerson");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='UpdatePerson(string,Guid,RequestContent,RequestContext)']/*" />
        ...
        /// &gt;   * "start=itemId2&amp;top=3" will return "itemId3", "itemId4", "itemId5".
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetPersonsAsync(string,string,int?,CancellationToken)']/*" />
        ...
        /// &gt;   * "start=itemId2&amp;top=3" will return "itemId3", "itemId4", "itemId5".
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetPersons(string,string,int?,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetPersonsAsync(string,string,int?,RequestContext)']/*" />
        public virtual async Task<Response> GetPersonsAsync(string largePersonGroupId, string start, int? top, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));

            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.GetPersons");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetPersons(string,string,int?,RequestContext)']/*" />
        ...
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='AddFaceFromUrlAsync(string,Guid,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        public virtual async Task<Response<AddFaceResult>> AddFaceFromUrlAsync(string largePersonGroupId, Guid personId, BinaryData imageContent, IEnumerable<int> targetFace = null, FaceDetectionModel? detectionModel = null, string userData = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
        ...
        ///   * Different 'detectionModel' values can be provided. To use and compare different detection models, please refer to https://learn.microsoft.com/azure/ai-services/computer-vision/how-to/specify-detection-model
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='AddFaceFromUrl(string,Guid,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        public virtual Response<AddFaceResult> AddFaceFromUrl(string largePersonGroupId, Guid personId, BinaryData imageContent, IEnumerable<int> targetFace = null, FaceDetectionModel? detectionModel = null, string userData = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
            Argument.AssertNotNull(imageContent, nameof(imageContent));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='AddFaceFromUrlAsync(string,Guid,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        public virtual async Task<Response> AddFaceFromUrlAsync(string largePersonGroupId, Guid personId, RequestContent content, IEnumerable<int> targetFace = null, string detectionModel = null, string userData = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.AddFaceFromUrl");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='AddFaceFromUrl(string,Guid,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        ...
        ///   * Different 'detectionModel' values can be provided. To use and compare different detection models, please refer to https://learn.microsoft.com/azure/ai-services/computer-vision/how-to/specify-detection-model
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='AddFaceAsync(string,Guid,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        ...
        ///   * Different 'detectionModel' values can be provided. To use and compare different detection models, please refer to https://learn.microsoft.com/azure/ai-services/computer-vision/how-to/specify-detection-model
        /// </remarks>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='AddFace(string,Guid,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='AddFaceAsync(string,Guid,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        public virtual async Task<Response> AddFaceAsync(string largePersonGroupId, Guid personId, RequestContent content, IEnumerable<int> targetFace = null, string detectionModel = null, string userData = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.AddFace");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='AddFace(string,Guid,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='DeleteFaceAsync(string,Guid,Guid,RequestContext)']/*" />
        public virtual async Task<Response> DeleteFaceAsync(string largePersonGroupId, Guid personId, Guid persistedFaceId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.DeleteFace");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='DeleteFace(string,Guid,Guid,RequestContext)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largePersonGroupId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largePersonGroupId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetFaceAsync(string,Guid,Guid,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largePersonGroupId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largePersonGroupId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetFace(string,Guid,Guid,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetFaceAsync(string,Guid,Guid,RequestContext)']/*" />
        public virtual async Task<Response> GetFaceAsync(string largePersonGroupId, Guid personId, Guid persistedFaceId, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.GetFace");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='GetFace(string,Guid,Guid,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='UpdateFaceAsync(string,Guid,Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> UpdateFaceAsync(string largePersonGroupId, Guid personId, Guid persistedFaceId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.UpdateFace");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='UpdateFace(string,Guid,Guid,RequestContent,RequestContext)']/*" />
        ...
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='TrainAsync(WaitUntil,string,RequestContext)']/*" />
        public virtual async Task<Operation> TrainAsync(WaitUntil waitUntil, string largePersonGroupId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));

            using var scope = ClientDiagnostics.CreateScope("LargePersonGroup.Train");
            scope.Start();
            try
            {
                using HttpMessage message = CreateTrainRequest(largePersonGroupId, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "LargePersonGroup.Train", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        /// <include file="Docs/LargePersonGroup.xml" path="doc/members/member[@name='Train(WaitUntil,string,RequestContext)']/*" />
        public virtual Operation Train(WaitUntil waitUntil, string largePersonGroupId, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateTrainRequest(largePersonGroupId, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "LargePersonGroup.Train", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
