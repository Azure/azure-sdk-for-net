...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LargePersonGroupData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="LargePersonGroupData"/>. </summary>
        /// <param name="name"> User defined name, maximum length is 128. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        internal LargePersonGroupData(string name)
        {
        ...
        internal LargePersonGroupData(string name, string userData, FaceRecognitionModel? recognitionModel, string largePersonGroupId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
        ...
        /// <summary> Initializes a new instance of <see cref="LargePersonGroupData"/> for deserialization. </summary>
        internal LargePersonGroupData()
        {
        }
