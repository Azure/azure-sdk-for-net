...
{
    /// <summary> The CreateRequest2. </summary>
    internal partial class CreateRequest2
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CreateRequest2"/>. </summary>
        /// <param name="name"> User defined name, maximum length is 128. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        internal CreateRequest2(string name)
        {
        ...
        internal CreateRequest2(string name, string userData, FaceRecognitionModel? recognitionModel, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
        ...
        /// <summary> Initializes a new instance of <see cref="CreateRequest2"/> for deserialization. </summary>
        internal CreateRequest2()
        {
        }
