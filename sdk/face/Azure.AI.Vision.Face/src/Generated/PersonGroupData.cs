...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class PersonGroupData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="PersonGroupData"/>. </summary>
        /// <param name="name"> User defined name, maximum length is 128. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        internal PersonGroupData(string name)
        {
        ...
        internal PersonGroupData(string name, string userData, FaceRecognitionModel? recognitionModel, string personGroupId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
        ...
        /// <summary> Initializes a new instance of <see cref="PersonGroupData"/> for deserialization. </summary>
        internal PersonGroupData()
        {
        }
