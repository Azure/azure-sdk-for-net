...
{
    /// <summary> The CreateCollectionOptions. </summary>
    public partial class CreateCollectionOptions
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CreateCollectionOptions"/>. </summary>
        ...
        internal CreateCollectionOptions(string name, string userData, FaceRecognitionModel? recognitionModel, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
        ...
        /// <summary> Initializes a new instance of <see cref="CreateCollectionOptions"/> for deserialization. </summary>
        internal CreateCollectionOptions()
        {
        }
