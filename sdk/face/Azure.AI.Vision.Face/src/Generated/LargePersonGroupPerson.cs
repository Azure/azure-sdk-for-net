...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LargePersonGroupPerson
    {
        ...
        internal LargePersonGroupPerson(Guid personId, string name, string userData, IReadOnlyList<Guid> persistedFaceIds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PersonId = personId;
            Name = name;
            UserData = userData;
