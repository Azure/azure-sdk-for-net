...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class FaceIdentificationCandidate : IJsonModel<FaceIdentificationCandidate>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<FaceIdentificationCandidate>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FaceIdentificationCandidate IJsonModel<FaceIdentificationCandidate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual FaceIdentificationCandidate JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<FaceIdentificationCandidate>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static FaceIdentificationCandidate DeserializeFaceIdentificationCandidate(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new FaceIdentificationCandidate(personId, confidence, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<FaceIdentificationCandidate>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        FaceIdentificationCandidate IPersistableModel<FaceIdentificationCandidate>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual FaceIdentificationCandidate PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<FaceIdentificationCandidate>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
