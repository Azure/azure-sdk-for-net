...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LivenessSession
    {
        ...
        internal LivenessSession(string sessionId, string authToken, OperationState status, LivenessModel? modelVersion, LivenessSessionResults results, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            SessionId = sessionId;
            AuthToken = authToken;
            Status = status;
