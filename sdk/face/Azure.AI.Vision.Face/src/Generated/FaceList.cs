...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class FaceList
    {
        ...
        /// <summary> Initializes a new instance of FaceList for mocking. </summary>
        protected FaceList()
        {
        }
        ...
        internal FaceList(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="faceListId"/> or <paramref name="createCollectionOptions"/> is null. </exception>
        ...
        /// </remarks>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='CreateAsync(string,CreateCollectionOptions,CancellationToken)']/*" />
        public virtual async Task<Response> CreateAsync(string faceListId, CreateCollectionOptions createCollectionOptions, CancellationToken cancellationToken = default)
        {
            ...
            Response response = await CreateAsync(faceListId, content, context).ConfigureAwait(false);
            return response;
        }
        ...
        /// Please consider Large Face List when the face number is large. It can support up to 1,000,000 faces.
        /// </remarks>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='Create(string,CreateCollectionOptions,CancellationToken)']/*" />
        public virtual Response Create(string faceListId, CreateCollectionOptions createCollectionOptions, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(faceListId, nameof(faceListId));
            Argument.AssertNotNull(createCollectionOptions, nameof(createCollectionOptions));
            ...
            using RequestContent content = createCollectionOptions.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = Create(faceListId, content, context);
            return response;
        }
        ...
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='CreateAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateAsync(string faceListId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("FaceList.Create");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='Create(string,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='DeleteAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> DeleteAsync(string faceListId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(faceListId, nameof(faceListId));

            using var scope = ClientDiagnostics.CreateScope("FaceList.Delete");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='Delete(string,RequestContext)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="faceListId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="faceListId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='GetFaceListAsync(string,bool?,CancellationToken)']/*" />
        public virtual async Task<Response<FaceListData>> GetFaceListAsync(string faceListId, bool? returnRecognitionModel = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(faceListId, nameof(faceListId));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetFaceListAsync(faceListId, returnRecognitionModel, context).ConfigureAwait(false);
            return Response.FromValue(FaceListData.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="faceListId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="faceListId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='GetFaceList(string,bool?,CancellationToken)']/*" />
        public virtual Response<FaceListData> GetFaceList(string faceListId, bool? returnRecognitionModel = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(faceListId, nameof(faceListId));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='GetFaceListAsync(string,bool?,RequestContext)']/*" />
        public virtual async Task<Response> GetFaceListAsync(string faceListId, bool? returnRecognitionModel, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(faceListId, nameof(faceListId));

            using var scope = ClientDiagnostics.CreateScope("FaceList.GetFaceList");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='GetFaceList(string,bool?,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='UpdateAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> UpdateAsync(string faceListId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(faceListId, nameof(faceListId));
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("FaceList.Update");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='Update(string,RequestContent,RequestContext)']/*" />
        ...
        /// <param name="returnRecognitionModel"> Return 'recognitionModel' or not. The default value is false. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='GetFaceListsAsync(bool?,CancellationToken)']/*" />
        ...
        /// <param name="returnRecognitionModel"> Return 'recognitionModel' or not. The default value is false. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='GetFaceLists(bool?,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='GetFaceListsAsync(bool?,RequestContext)']/*" />
        public virtual async Task<Response> GetFaceListsAsync(bool? returnRecognitionModel, RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("FaceList.GetFaceLists");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='GetFaceLists(bool?,RequestContext)']/*" />
        ...
        /// </remarks>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='AddFaceFromUrlAsync(string,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        public virtual async Task<Response<AddFaceResult>> AddFaceFromUrlAsync(string faceListId, BinaryData imageContent, IEnumerable<int> targetFace = null, FaceDetectionModel? detectionModel = null, string userData = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(faceListId, nameof(faceListId));
        ...
        ///   * Different 'detectionModel' values can be provided. To use and compare different detection models, please refer to https://learn.microsoft.com/azure/ai-services/computer-vision/how-to/specify-detection-model
        /// </remarks>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='AddFaceFromUrl(string,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        public virtual Response<AddFaceResult> AddFaceFromUrl(string faceListId, BinaryData imageContent, IEnumerable<int> targetFace = null, FaceDetectionModel? detectionModel = null, string userData = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(faceListId, nameof(faceListId));
            Argument.AssertNotNull(imageContent, nameof(imageContent));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="AddFaceFromUrlAsync(string,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='AddFaceFromUrlAsync(string,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        public virtual async Task<Response> AddFaceFromUrlAsync(string faceListId, RequestContent content, IEnumerable<int> targetFace = null, string detectionModel = null, string userData = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("FaceList.AddFaceFromUrl");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="AddFaceFromUrl(string,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='AddFaceFromUrl(string,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        ...
        ///   * Different 'detectionModel' values can be provided. To use and compare different detection models, please refer to https://learn.microsoft.com/azure/ai-services/computer-vision/how-to/specify-detection-model
        /// </remarks>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='AddFaceAsync(string,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        ...
        ///   * Different 'detectionModel' values can be provided. To use and compare different detection models, please refer to https://learn.microsoft.com/azure/ai-services/computer-vision/how-to/specify-detection-model
        /// </remarks>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='AddFace(string,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='AddFaceAsync(string,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        public virtual async Task<Response> AddFaceAsync(string faceListId, RequestContent content, IEnumerable<int> targetFace = null, string detectionModel = null, string userData = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("FaceList.AddFace");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='AddFace(string,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='DeleteFaceAsync(string,Guid,RequestContext)']/*" />
        public virtual async Task<Response> DeleteFaceAsync(string faceListId, Guid persistedFaceId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(faceListId, nameof(faceListId));

            using var scope = ClientDiagnostics.CreateScope("FaceList.DeleteFace");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/FaceList.xml" path="doc/members/member[@name='DeleteFace(string,Guid,RequestContext)']/*" />
