...
{
    internal partial class DetectFromSessionImageRequest : IUtf8JsonSerializable, IJsonModel<DetectFromSessionImageRequest>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectFromSessionImageRequest>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DetectFromSessionImageRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        DetectFromSessionImageRequest IJsonModel<DetectFromSessionImageRequest>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DetectFromSessionImageRequest>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<DetectFromSessionImageRequest>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DetectFromSessionImageRequest>)this).GetFormatFromOptions(options) : options.Format;
        ...
        DetectFromSessionImageRequest IPersistableModel<DetectFromSessionImageRequest>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DetectFromSessionImageRequest>)this).GetFormatFromOptions(options) : options.Format;
