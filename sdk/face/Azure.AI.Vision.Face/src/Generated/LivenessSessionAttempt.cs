...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LivenessSessionAttempt
    {
        ...
        internal LivenessSessionAttempt(int attemptId, OperationState attemptStatus, LivenessResult result, LivenessError error, IReadOnlyList<ClientInformation> clientInformation, AbuseMonitoringResult abuseMonitoringResult, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AttemptId = attemptId;
            AttemptStatus = attemptStatus;
            Result = result;
        ...
        /// <summary> Initializes a new instance of <see cref="LivenessSessionAttempt"/> for deserialization. </summary>
