...
{
    /// <summary> The CreateRequest3. </summary>
    internal partial class CreateRequest3
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CreateRequest3"/>. </summary>
        /// <param name="name"> User defined name, maximum length is 128. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        internal CreateRequest3(string name)
        {
        ...
        internal CreateRequest3(string name, string userData, FaceRecognitionModel? recognitionModel, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
        ...
        /// <summary> Initializes a new instance of <see cref="CreateRequest3"/> for deserialization. </summary>
        internal CreateRequest3()
        {
        }
