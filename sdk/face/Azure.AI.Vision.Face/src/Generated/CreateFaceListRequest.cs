...
{
    /// <summary> The CreateFaceListRequest. </summary>
    internal partial class CreateFaceListRequest
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CreateFaceListRequest"/>. </summary>
        ...
        internal CreateFaceListRequest(string name, string userData, FaceRecognitionModel? recognitionModel, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
        ...
        /// <summary> Initializes a new instance of <see cref="CreateFaceListRequest"/> for deserialization. </summary>
        internal CreateFaceListRequest()
        {
        }
