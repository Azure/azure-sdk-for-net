...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class FaceListData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="FaceListData"/>. </summary>
        /// <param name="name"> User defined name, maximum length is 128. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        internal FaceListData(string name)
        {
        ...
        internal FaceListData(string name, string userData, FaceRecognitionModel? recognitionModel, string faceListId, IReadOnlyList<FaceListFace> persistedFaces, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
        ...
        /// <summary> Initializes a new instance of <see cref="FaceListData"/> for deserialization. </summary>
        internal FaceListData()
        {
        }
