...
namespace Azure.AI.Vision.Face
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="Face.CreateCollectionOptions"/>. </summary>
        ...
        /// <returns> A new <see cref="Face.CreateCollectionOptions"/> instance for mocking. </returns>
        public static CreateCollectionOptions CreateCollectionOptions(string name = null, string userData = null, FaceRecognitionModel? recognitionModel = null)
        {
            return new CreateCollectionOptions(name, userData, recognitionModel, serializedAdditionalRawData: null);
        }

        /// <summary> Initializes a new instance of <see cref="Face.FaceListData"/>. </summary>
        /// <param name="name"> User defined name, maximum length is 128. </param>
        /// <param name="userData"> Optional user defined data. Length should not exceed 16K. </param>
        ...
        /// <returns> A new <see cref="Face.FaceListData"/> instance for mocking. </returns>
        public static FaceListData FaceListData(string name = null, string userData = null, FaceRecognitionModel? recognitionModel = null, string faceListId = null, IEnumerable<FaceListFace> persistedFaces = null)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="Face.FaceLargeFaceListData"/>. </summary>
        /// <param name="name"> User defined name, maximum length is 128. </param>
        /// <param name="userData"> Optional user defined data. Length should not exceed 16K. </param>
        /// <param name="recognitionModel"> Name of recognition model. Recognition model is used when the face features are extracted and associated with detected faceIds. </param>
        /// <param name="largeFaceListId"> Valid character is letter in lower case or digit or '-' or '_', maximum length is 64. </param>
        /// <returns> A new <see cref="Face.FaceLargeFaceListData"/> instance for mocking. </returns>
        public static FaceLargeFaceListData FaceLargeFaceListData(string name = null, string userData = null, FaceRecognitionModel? recognitionModel = null, string largeFaceListId = null)
        {
            return new FaceLargeFaceListData(name, userData, recognitionModel, largeFaceListId, serializedAdditionalRawData: null);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="Face.PersonGroupData"/>. </summary>
        /// <param name="name"> User defined name, maximum length is 128. </param>
        /// <param name="userData"> Optional user defined data. Length should not exceed 16K. </param>
        /// <param name="recognitionModel"> Name of recognition model. Recognition model is used when the face features are extracted and associated with detected faceIds. </param>
        /// <param name="personGroupId"> ID of the container. </param>
        /// <returns> A new <see cref="Face.PersonGroupData"/> instance for mocking. </returns>
        public static PersonGroupData PersonGroupData(string name = null, string userData = null, FaceRecognitionModel? recognitionModel = null, string personGroupId = null)
        {
            return new PersonGroupData(name, userData, recognitionModel, personGroupId, serializedAdditionalRawData: null);
        }
        ...
        /// <summary> Initializes a new instance of <see cref="Face.LargePersonGroupData"/>. </summary>
        /// <param name="name"> User defined name, maximum length is 128. </param>
        /// <param name="userData"> Optional user defined data. Length should not exceed 16K. </param>
        /// <param name="recognitionModel"> Name of recognition model. Recognition model is used when the face features are extracted and associated with detected faceIds. </param>
        /// <param name="largePersonGroupId"> ID of the container. </param>
        /// <returns> A new <see cref="Face.LargePersonGroupData"/> instance for mocking. </returns>
        public static LargePersonGroupData LargePersonGroupData(string name = null, string userData = null, FaceRecognitionModel? recognitionModel = null, string largePersonGroupId = null)
        {
            return new LargePersonGroupData(name, userData, recognitionModel, largePersonGroupId, serializedAdditionalRawData: null);
        }
