...
namespace Azure.AI.Vision.Face
{
    ...
    internal partial class IdentifyFromPersonGroupRequest
    {
        ...
        public IdentifyFromPersonGroupRequest(IEnumerable<Guid> faceIds, string personGroupId)
        {
        ...
        internal IdentifyFromPersonGroupRequest(IList<Guid> faceIds, string personGroupId, int? maxNumOfCandidatesReturned, float? confidenceThreshold, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FaceIds = faceIds;
            PersonGroupId = personGroupId;
