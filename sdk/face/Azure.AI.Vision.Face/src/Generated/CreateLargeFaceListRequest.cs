...
{
    /// <summary> The CreateLargeFaceListRequest. </summary>
    internal partial class CreateLargeFaceListRequest
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CreateLargeFaceListRequest"/>. </summary>
        ...
        internal CreateLargeFaceListRequest(string name, string userData, FaceRecognitionModel? recognitionModel, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
        ...
        /// <summary> Initializes a new instance of <see cref="CreateLargeFaceListRequest"/> for deserialization. </summary>
        internal CreateLargeFaceListRequest()
        {
        }
