...
namespace Azure.AI.Vision.Face
{
    ...
    internal partial class IdentifyFromLargePersonGroupRequest
    {
        ...
        public IdentifyFromLargePersonGroupRequest(IEnumerable<Guid> faceIds, string largePersonGroupId)
        {
        ...
        internal IdentifyFromLargePersonGroupRequest(IList<Guid> faceIds, string largePersonGroupId, int? maxNumOfCandidatesReturned, float? confidenceThreshold, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FaceIds = faceIds;
            LargePersonGroupId = largePersonGroupId;
