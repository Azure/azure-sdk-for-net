...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LivenessWithVerifySessionAttempt
    {
        ...
        internal LivenessWithVerifySessionAttempt(int attemptId, AttemptStatus attemptStatus)
        {
            AttemptId = attemptId;
        ...
        internal LivenessWithVerifySessionAttempt(int attemptId, AttemptStatus attemptStatus, LivenessWithVerifyResult result, LivenessError error, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AttemptId = attemptId;
            AttemptStatus = attemptStatus;
            Result = result;
        ...
        public AttemptStatus AttemptStatus { get; }
