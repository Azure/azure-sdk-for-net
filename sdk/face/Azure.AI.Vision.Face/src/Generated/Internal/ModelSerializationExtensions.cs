...
namespace Azure.AI.Vision.Face
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureAIVisionFaceContext.Default) } };
