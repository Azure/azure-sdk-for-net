...
{
    /// <summary> Dedicated parameter model for multipart/form-data. </summary>
    internal partial class CreateLivenessSessionContentForMultipart
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CreateLivenessSessionContentForMultipart"/>. </summary>
        /// <param name="livenessOperationMode"> Type of liveness mode the client should follow. </param>
        public CreateLivenessSessionContentForMultipart(LivenessOperationMode livenessOperationMode)
        {
        ...
        internal CreateLivenessSessionContentForMultipart(LivenessOperationMode livenessOperationMode, bool? sendResultsToClient, bool? deviceCorrelationIdSetInClient, string deviceCorrelationId, int? authTokenTimeToLiveInSeconds, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            LivenessOperationMode = livenessOperationMode;
        ...
        /// <summary> Initializes a new instance of <see cref="CreateLivenessSessionContentForMultipart"/> for deserialization. </summary>
        internal CreateLivenessSessionContentForMultipart()
        {
        }
