...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LargeFaceList
    {
        ...
        /// <summary> Initializes a new instance of LargeFaceList for mocking. </summary>
        protected LargeFaceList()
        {
        }
        ...
        internal LargeFaceList(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, AzureKeyCredential keyCredential, TokenCredential tokenCredential, Uri endpoint, string apiVersion)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largeFaceListId"/> or <paramref name="createCollectionOptions"/> is null. </exception>
        ...
        /// </remarks>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='CreateAsync(string,CreateCollectionOptions,CancellationToken)']/*" />
        public virtual async Task<Response> CreateAsync(string largeFaceListId, CreateCollectionOptions createCollectionOptions, CancellationToken cancellationToken = default)
        {
            ...
            Response response = await CreateAsync(largeFaceListId, content, context).ConfigureAwait(false);
            return response;
        }
        ...
        /// &gt;   * S0-tier subscription quota: 1,000,000 Large Face Lists.
        /// </remarks>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='Create(string,CreateCollectionOptions,CancellationToken)']/*" />
        public virtual Response Create(string largeFaceListId, CreateCollectionOptions createCollectionOptions, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));
            Argument.AssertNotNull(createCollectionOptions, nameof(createCollectionOptions));
            ...
            using RequestContent content = createCollectionOptions.ToRequestContent();
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = Create(largeFaceListId, content, context);
            return response;
        }
        ...
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='CreateAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> CreateAsync(string largeFaceListId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.Create");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='Create(string,RequestContent,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='DeleteAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> DeleteAsync(string largeFaceListId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));

            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.Delete");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='Delete(string,RequestContext)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largeFaceListId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largeFaceListId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetLargeFaceListAsync(string,bool?,CancellationToken)']/*" />
        public virtual async Task<Response<FaceLargeFaceListData>> GetLargeFaceListAsync(string largeFaceListId, bool? returnRecognitionModel = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetLargeFaceListAsync(largeFaceListId, returnRecognitionModel, context).ConfigureAwait(false);
            return Response.FromValue(FaceLargeFaceListData.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largeFaceListId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largeFaceListId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetLargeFaceList(string,bool?,CancellationToken)']/*" />
        public virtual Response<FaceLargeFaceListData> GetLargeFaceList(string largeFaceListId, bool? returnRecognitionModel = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetLargeFaceListAsync(string,bool?,RequestContext)']/*" />
        public virtual async Task<Response> GetLargeFaceListAsync(string largeFaceListId, bool? returnRecognitionModel, RequestContext context)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.GetLargeFaceList");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetLargeFaceList(string,bool?,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='UpdateAsync(string,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> UpdateAsync(string largeFaceListId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));
            Argument.AssertNotNull(content, nameof(content));

            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.Update");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='Update(string,RequestContent,RequestContext)']/*" />
        ...
        /// </remarks>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetLargeFaceListsAsync(string,int?,bool?,CancellationToken)']/*" />
        public virtual async Task<Response<IReadOnlyList<FaceLargeFaceListData>>> GetLargeFaceListsAsync(string start = null, int? top = null, bool? returnRecognitionModel = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetLargeFaceListsAsync(start, top, returnRecognitionModel, context).ConfigureAwait(false);
            IReadOnlyList<FaceLargeFaceListData> value = default;
            using var document = await JsonDocument.ParseAsync(response.ContentStream, default, cancellationToken).ConfigureAwait(false);
            List<FaceLargeFaceListData> array = new List<FaceLargeFaceListData>();
            foreach (var item in document.RootElement.EnumerateArray())
            {
                array.Add(FaceLargeFaceListData.DeserializeFaceLargeFaceListData(item));
            }
            value = array;
        ...
        /// &gt;   * "start=itemId2&amp;top=3" will return "itemId3", "itemId4", "itemId5".
        /// </remarks>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetLargeFaceLists(string,int?,bool?,CancellationToken)']/*" />
        public virtual Response<IReadOnlyList<FaceLargeFaceListData>> GetLargeFaceLists(string start = null, int? top = null, bool? returnRecognitionModel = null, CancellationToken cancellationToken = default)
        {
            RequestContext context = FromCancellationToken(cancellationToken);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetLargeFaceListsAsync(string,int?,bool?,RequestContext)']/*" />
        ...
        {
            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.GetLargeFaceLists");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetLargeFaceLists(string,int?,bool?,RequestContext)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largeFaceListId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largeFaceListId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetTrainingStatusAsync(string,CancellationToken)']/*" />
        public virtual async Task<Response<FaceCollectionTrainingResult>> GetTrainingStatusAsync(string largeFaceListId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largeFaceListId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largeFaceListId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetTrainingStatus(string,CancellationToken)']/*" />
        public virtual Response<FaceCollectionTrainingResult> GetTrainingStatus(string largeFaceListId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetTrainingStatusAsync(string,RequestContext)']/*" />
        public virtual async Task<Response> GetTrainingStatusAsync(string largeFaceListId, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));

            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.GetTrainingStatus");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetTrainingStatus(string,RequestContext)']/*" />
        ...
        /// </remarks>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='AddFaceFromUrlAsync(string,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        public virtual async Task<Response<AddFaceResult>> AddFaceFromUrlAsync(string largeFaceListId, BinaryData imageContent, IEnumerable<int> targetFace = null, FaceDetectionModel? detectionModel = null, string userData = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));
        ...
        /// &gt;   * S0-tier subscription quota: 1,000,000 faces per Large Face List.
        /// </remarks>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='AddFaceFromUrl(string,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        public virtual Response<AddFaceResult> AddFaceFromUrl(string largeFaceListId, BinaryData imageContent, IEnumerable<int> targetFace = null, FaceDetectionModel? detectionModel = null, string userData = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));
            Argument.AssertNotNull(imageContent, nameof(imageContent));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='AddFaceFromUrlAsync(string,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        public virtual async Task<Response> AddFaceFromUrlAsync(string largeFaceListId, RequestContent content, IEnumerable<int> targetFace = null, string detectionModel = null, string userData = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.AddFaceFromUrl");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='AddFaceFromUrl(string,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        ...
        /// &gt;   * S0-tier subscription quota: 1,000,000 faces per Large Face List.
        /// </remarks>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='AddFaceAsync(string,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        ...
        /// &gt;   * S0-tier subscription quota: 1,000,000 faces per Large Face List.
        /// </remarks>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='AddFace(string,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='AddFaceAsync(string,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        public virtual async Task<Response> AddFaceAsync(string largeFaceListId, RequestContent content, IEnumerable<int> targetFace = null, string detectionModel = null, string userData = null, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.AddFace");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='AddFace(string,RequestContent,IEnumerable{int},string,string,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='DeleteFaceAsync(string,Guid,RequestContext)']/*" />
        public virtual async Task<Response> DeleteFaceAsync(string largeFaceListId, Guid persistedFaceId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.DeleteFace");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='DeleteFace(string,Guid,RequestContext)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largeFaceListId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largeFaceListId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetFaceAsync(string,Guid,CancellationToken)']/*" />
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="largeFaceListId"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="largeFaceListId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetFace(string,Guid,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetFaceAsync(string,Guid,RequestContext)']/*" />
        public virtual async Task<Response> GetFaceAsync(string largeFaceListId, Guid persistedFaceId, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));

            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.GetFace");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetFace(string,Guid,RequestContext)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='UpdateFaceAsync(string,Guid,RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> UpdateFaceAsync(string largeFaceListId, Guid persistedFaceId, RequestContent content, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.UpdateFace");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='UpdateFace(string,Guid,RequestContent,RequestContext)']/*" />
        ...
        /// &gt;   * "start=itemId2&amp;top=3" will return "itemId3", "itemId4", "itemId5".
        /// </remarks>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetFacesAsync(string,string,int?,CancellationToken)']/*" />
        ...
        /// &gt;   * "start=itemId2&amp;top=3" will return "itemId3", "itemId4", "itemId5".
        /// </remarks>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetFaces(string,string,int?,CancellationToken)']/*" />
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetFacesAsync(string,string,int?,RequestContext)']/*" />
        public virtual async Task<Response> GetFacesAsync(string largeFaceListId, string start, int? top, RequestContext context)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));

            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.GetFaces");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='GetFaces(string,string,int?,RequestContext)']/*" />
        ...
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='TrainAsync(WaitUntil,string,RequestContext)']/*" />
        public virtual async Task<Operation> TrainAsync(WaitUntil waitUntil, string largeFaceListId, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(largeFaceListId, nameof(largeFaceListId));

            using var scope = ClientDiagnostics.CreateScope("LargeFaceList.Train");
            scope.Start();
            try
            {
                using HttpMessage message = CreateTrainRequest(largeFaceListId, context);
                return await ProtocolOperationHelpers.ProcessMessageWithoutResponseValueAsync(_pipeline, message, ClientDiagnostics, "LargeFaceList.Train", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The <see cref="Operation"/> representing an asynchronous operation on the service. </returns>
        /// <include file="Docs/LargeFaceList.xml" path="doc/members/member[@name='Train(WaitUntil,string,RequestContext)']/*" />
        public virtual Operation Train(WaitUntil waitUntil, string largeFaceListId, RequestContext context = null)
        {
            ...
            {
                using HttpMessage message = CreateTrainRequest(largeFaceListId, context);
                return ProtocolOperationHelpers.ProcessMessageWithoutResponseValue(_pipeline, message, ClientDiagnostics, "LargeFaceList.Train", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
