...
{
    /// <summary> Face resource for person directory person. </summary>
    public partial class PersonDirectoryFace
    {
        ...
        internal PersonDirectoryFace(Guid persistedFaceId, string userData, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
