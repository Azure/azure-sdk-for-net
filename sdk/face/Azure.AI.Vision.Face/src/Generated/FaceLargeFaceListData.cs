...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class FaceLargeFaceListData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="FaceLargeFaceListData"/>. </summary>
        /// <param name="name"> User defined name, maximum length is 128. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        internal FaceLargeFaceListData(string name)
        {
        ...
        internal FaceLargeFaceListData(string name, string userData, FaceRecognitionModel? recognitionModel, string largeFaceListId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
        ...
        /// <summary> Initializes a new instance of <see cref="FaceLargeFaceListData"/> for deserialization. </summary>
        internal FaceLargeFaceListData()
        {
        }
