...
namespace Azure.AI.Vision.Face
{
    ...
    public partial class LargePersonGroupClient
    {
        ...
        public LargePersonGroupClient(Uri endpoint, AzureKeyCredential credential) : this(endpoint, credential, new AzureAIVisionFaceClientOptions())
        {
        }
        ...
        /// <param name="credential"> A credential used to authenticate to an Azure Service. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public LargePersonGroupClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new AzureAIVisionFaceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public LargePersonGroupClient(Uri endpoint, AzureKeyCredential credential, AzureAIVisionFaceClientOptions options)
        {
        ...
        /// <param name="options"> The options for configuring the client. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public LargePersonGroupClient(Uri endpoint, TokenCredential credential, AzureAIVisionFaceClientOptions options)
        {
            Argument.AssertNotNull(endpoint, nameof(endpoint));
            Argument.AssertNotNull(credential, nameof(credential));
            options ??= new AzureAIVisionFaceClientOptions();
        ...
        [ForwardsClientCalls]
        public virtual Task<Response<AddFaceResult>> AddFaceAsync(string largePersonGroupId, Guid personId, Uri uri, IEnumerable<int> targetFace = null, FaceDetectionModel? detectionModel = null, string userData = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
            Argument.AssertNotNull(uri, nameof(uri));

            return AddFaceFromUrlImplAsync(largePersonGroupId, personId, uri, targetFace, detectionModel, userData, cancellationToken);
        }
        ...
        /// <remarks> Please refer to https://learn.microsoft.com/rest/api/face/person-group-operations/add-large-person-group-person-face-from-url for more details. </remarks>
        [ForwardsClientCalls]
        public virtual Response<AddFaceResult> AddFace(string largePersonGroupId, Guid personId, Uri uri, IEnumerable<int> targetFace = null, FaceDetectionModel? detectionModel = null, string userData = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
            Argument.AssertNotNull(uri, nameof(uri));

            return AddFaceFromUrlImpl(largePersonGroupId, personId, uri, targetFace, detectionModel, userData, cancellationToken);
        }
        ...
        [ForwardsClientCalls]
        public virtual Task<Response<AddFaceResult>> AddFaceAsync(string largePersonGroupId, Guid personId, BinaryData imageContent, IEnumerable<int> targetFace = null, FaceDetectionModel? detectionModel = null, string userData = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
            Argument.AssertNotNull(imageContent, nameof(imageContent));

            return AddFaceImplAsync(largePersonGroupId, personId, imageContent, targetFace, detectionModel, userData, cancellationToken);
        }
        ...
        public virtual Response<AddFaceResult> AddFace(string largePersonGroupId, Guid personId, BinaryData imageContent, IEnumerable<int> targetFace = null, FaceDetectionModel? detectionModel = null, string userData = null, CancellationToken cancellationToken = default)
        {
            ...
            return AddFaceImpl(largePersonGroupId, personId, imageContent, targetFace, detectionModel, userData, cancellationToken);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the ser <see cref="AddFaceAsync(string,Guid,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        [ForwardsClientCalls]
        public virtual Task<Response> AddFaceAsync(string largePersonGroupId, Guid personId, RequestContent content, IEnumerable<int> targetFace = null, string detectionModel = null, string userData = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(largePersonGroupId, nameof(largePersonGroupId));
            Argument.AssertNotNull(content, nameof(content));

            return AddFaceImplAsync(largePersonGroupId, personId, content, targetFace, detectionModel, userData, context);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the ser <see cref="AddFace(string,Guid,BinaryData,IEnumerable{int},FaceDetectionModel?,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual Response AddFace(string largePersonGroupId, Guid personId, RequestContent content, IEnumerable<int> targetFace = null, string detectionModel = null, string userData = null, RequestContext context = null)
        {
            ...
            return AddFaceImpl(largePersonGroupId, personId, content, targetFace, detectionModel, userData, context);
        }
    }
}