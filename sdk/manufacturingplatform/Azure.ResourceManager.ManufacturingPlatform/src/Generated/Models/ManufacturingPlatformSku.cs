...
namespace Azure.ResourceManager.ManufacturingPlatform.Models
{
    ...
    public partial class ManufacturingPlatformSku
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="ManufacturingPlatformSku"/>. </summary>
        ...
        internal ManufacturingPlatformSku(string name, ManufacturingPlatformSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
            Size = size;
        ...
        /// <summary> Initializes a new instance of <see cref="ManufacturingPlatformSku"/> for deserialization. </summary>
        internal ManufacturingPlatformSku()
        {
        }
        ...
        public ManufacturingPlatformSkuTier? Tier { get; set; }
