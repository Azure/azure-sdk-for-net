...
namespace Azure.ResourceManager.ManufacturingPlatform.Models
{
    ...
    public partial class ManufacturingPlatformSku
    {
        ...
        internal ManufacturingPlatformSku(string name, ManufacturingPlatformSkuTier? tier, string size, string family, int? capacity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Tier = tier;
            Size = size;
