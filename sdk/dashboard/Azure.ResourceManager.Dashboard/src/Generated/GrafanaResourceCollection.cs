...
namespace Azure.ResourceManager.Dashboard
{
    ...
    public partial class GrafanaResourceCollection : ArmCollection, IEnumerable<GrafanaResource>, IAsyncEnumerable<GrafanaResource>
    {
        ...
        public virtual async Task<ArmOperation<GrafanaResource>> CreateOrUpdateAsync(bool waitForCompletion, string workspaceName, GrafanaResourceData body = null, CancellationToken cancellationToken = default)
        {
