...
namespace Azure.ResourceManager.Dashboard
{
    ...
    public partial class ManagedGrafanaResource : ArmResource
    {
        ...
        /// <summary> Gets a collection of DashboardPrivateEndpointConnectionResources in the ManagedGrafana. </summary>
        /// <returns> An object representing collection of DashboardPrivateEndpointConnectionResources and their operations over a DashboardPrivateEndpointConnectionResource. </returns>
        public virtual DashboardPrivateEndpointConnectionCollection GetDashboardPrivateEndpointConnections()
        {
            return GetCachedClient(Client => new DashboardPrivateEndpointConnectionCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<DashboardPrivateEndpointConnectionResource>> GetDashboardPrivateEndpointConnectionAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return await GetDashboardPrivateEndpointConnections().GetAsync(privateEndpointConnectionName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="privateEndpointConnectionName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<DashboardPrivateEndpointConnectionResource> GetDashboardPrivateEndpointConnection(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            return GetDashboardPrivateEndpointConnections().Get(privateEndpointConnectionName, cancellationToken);
        }

        /// <summary> Gets a collection of DashboardPrivateLinkResources in the ManagedGrafana. </summary>
        /// <returns> An object representing collection of DashboardPrivateLinkResources and their operations over a DashboardPrivateLinkResource. </returns>
        public virtual DashboardPrivateLinkResourceCollection GetDashboardPrivateLinkResources()
        {
            return GetCachedClient(Client => new DashboardPrivateLinkResourceCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<DashboardPrivateLinkResource>> GetDashboardPrivateLinkResourceAsync(string privateLinkResourceName, CancellationToken cancellationToken = default)
        {
            return await GetDashboardPrivateLinkResources().GetAsync(privateLinkResourceName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="privateLinkResourceName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<DashboardPrivateLinkResource> GetDashboardPrivateLinkResource(string privateLinkResourceName, CancellationToken cancellationToken = default)
        {
            return GetDashboardPrivateLinkResources().Get(privateLinkResourceName, cancellationToken);
        }
