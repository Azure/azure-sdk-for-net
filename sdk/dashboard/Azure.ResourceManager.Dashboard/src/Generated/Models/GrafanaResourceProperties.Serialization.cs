...
{
    public partial class GrafanaResourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static GrafanaResourceProperties DeserializeGrafanaResourceProperties(JsonElement element)
        {
            ...
            return new GrafanaResourceProperties(Optional.ToNullable(provisioningState), grafanaVersion.Value, endpoint.Value, Optional.ToNullable(zoneRedundancy));
        }
    }
}
