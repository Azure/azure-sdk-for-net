...
namespace Azure.ResourceManager.Dashboard.Models
{
    ...
    {
        /// <summary> Initializes a new instance of DashboardPrivateLinkServiceConnectionState. </summary>
        ...
        internal DashboardPrivateLinkServiceConnectionState(DashboardPrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired)
        {
            Status = status;
