...
namespace Microsoft.Azure.Management.Dashboard.Models
{
    ...
    public partial class OperationDisplay
    {
        ...
        /// provider name, i.e., Microsoft.Dashboard.</param>
        /// <param name="resource">The localized friendly name of the resource
        /// type related to this operation, e.g., 'grafana'.</param>
        /// <param name="operation">Operation type, e.g., read, write, delete,
        /// etc.</param>
        /// <param name="description">Description of the operation, e.g., 'Read
        /// grafana'.</param>
        ...
        /// this operation, e.g., 'grafana'.
        /// </summary>
        [JsonProperty(PropertyName = "resource")]
        public string Resource { get; private set; }

        /// <summary>
        /// Gets operation type, e.g., read, write, delete, etc.
        /// </summary>
        [JsonProperty(PropertyName = "operation")]
        public string Operation { get; private set; }

        /// <summary>
        /// Gets description of the operation, e.g., 'Read grafana'.
        /// </summary>
