...
{
    internal partial class EnclaveArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of EnclaveArmOperation for mocking. </summary>
        protected EnclaveArmOperation()
        {
        }
        ...
        internal EnclaveArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal EnclaveArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
