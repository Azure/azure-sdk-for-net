...
{
    /// <summary></summary>
    internal partial class VirtualEnclaveTransitHubResourceOperationSource : IOperationSource<VirtualEnclaveTransitHubResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualEnclaveTransitHubResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
