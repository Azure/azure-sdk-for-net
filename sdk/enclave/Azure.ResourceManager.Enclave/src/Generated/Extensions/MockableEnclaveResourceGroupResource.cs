...
namespace Azure.ResourceManager.Enclave.Mocking
{
    ...
    public partial class MockableEnclaveResourceGroupResource : ArmResource
    {
        /// <summary> Initializes a new instance of MockableEnclaveResourceGroupResource for mocking. </summary>
        protected MockableEnclaveResourceGroupResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableEnclaveResourceGroupResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableEnclaveResourceGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
