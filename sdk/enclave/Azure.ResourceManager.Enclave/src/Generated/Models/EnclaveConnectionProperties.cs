...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class EnclaveConnectionProperties
    {
        ...
        internal EnclaveConnectionProperties(EnclaveConnectionState? state, ResourceIdentifier communityResourceId, ResourceIdentifier sourceResourceId, string sourceCidr, ResourceIdentifier destinationEndpointId, EnclaveProvisioningState? provisioningState, IReadOnlyList<ResourceIdentifier> resourceCollection, EnclaveUpdateMode? updateMode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            State = state;
            CommunityResourceId = communityResourceId;
            SourceResourceId = sourceResourceId;
        ...
        public EnclaveUpdateMode? UpdateMode { get; }
    }
}
