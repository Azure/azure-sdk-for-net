...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class EnclaveApprovalSettings
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="EnclaveApprovalSettings"/>. </summary>
        ...
        internal EnclaveApprovalSettings(ApprovalSettingConfiguration enclaveEndpointUpdate, ApprovalSettingConfiguration connectionCreation, ApprovalSettingConfiguration connectionUpdate, ApprovalSettingConfiguration enclaveMaintenanceMode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
