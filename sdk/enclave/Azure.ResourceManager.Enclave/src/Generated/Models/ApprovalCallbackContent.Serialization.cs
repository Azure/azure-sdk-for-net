...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class ApprovalCallbackContent : IJsonModel<ApprovalCallbackContent>
    {
        ...
        internal static ApprovalCallbackContent DeserializeApprovalCallbackContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            EnclaveApprovalCallbackResourceAction resourceRequestAction = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    resourceRequestAction = new EnclaveApprovalCallbackResourceAction(prop.Value.GetString());
                    continue;
                }
                if (prop.NameEquals("approvalStatus"u8))
                {
                    approvalStatus = new ApprovalCallbackRequestApprovalStatus(prop.Value.GetString());
                    continue;
                }
