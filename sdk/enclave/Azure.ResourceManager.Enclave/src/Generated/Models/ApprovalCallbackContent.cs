...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class ApprovalCallbackContent
    {
        ...
        public ApprovalCallbackContent(ApprovalCallbackRequestResourceRequestAction resourceRequestAction, ApprovalCallbackRequestApprovalStatus approvalStatus)
        {
        ...
        internal ApprovalCallbackContent(ApprovalCallbackRequestResourceRequestAction resourceRequestAction, ApprovalCallbackRequestApprovalStatus approvalStatus, string approvalCallbackPayload, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ResourceRequestAction = resourceRequestAction;
            ApprovalStatus = approvalStatus;
