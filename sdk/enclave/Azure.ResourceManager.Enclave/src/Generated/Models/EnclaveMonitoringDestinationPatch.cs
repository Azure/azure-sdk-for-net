...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class EnclaveMonitoringDestinationPatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="EnclaveMonitoringDestinationPatch"/>. </summary>
        /// <param name="destinationType"> The type of monitoring workspace destination. </param>
        public EnclaveMonitoringDestinationPatch(EnclaveMonitoringDestinationType destinationType)
        {
        ...
        internal EnclaveMonitoringDestinationPatch(EnclaveMonitoringDestinationType destinationType, ResourceIdentifier customWorkspaceResourceId, string diagnosticSettingsName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DestinationType = destinationType;
        ...
        public EnclaveMonitoringDestinationType DestinationType { get; }
