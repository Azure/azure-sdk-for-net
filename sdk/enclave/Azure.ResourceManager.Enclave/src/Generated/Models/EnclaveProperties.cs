...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class EnclaveProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="EnclaveProperties"/>. </summary>
        ...
        public EnclaveProperties(EnclaveVirtualNetwork enclaveVirtualNetwork, ResourceIdentifier communityResourceId)
        {
        ...
        internal EnclaveProperties(EnclaveProvisioningState? provisioningState, EnclaveVirtualNetwork enclaveVirtualNetwork, EnclaveAddressSpaces enclaveAddressSpaces, ResourceIdentifier communityResourceId, IReadOnlyList<ResourceIdentifier> resourceCollection, string managedResourceGroupName, ManagedOnBehalfOfConfiguration managedOnBehalfOfConfiguration, bool? isBastionEnabled, EnclaveResourceVisibilityMode? workloadResourceVisibility, EnclaveRbacInheritanceMode? rbacInheritance, IList<EnclaveRoleAssignmentItem> enclaveRoleAssignments, IList<EnclaveRoleAssignmentItem> workloadRoleAssignments, IList<EnclaveGovernedService> governedServiceList, EnclaveDefaultSettings enclaveDefaultSettings, EnclaveMaintenanceModeConfiguration maintenanceModeConfiguration, ResourceIdentifier dedicatedHubResourceId, EnclaveApprovalSettings approvalSettings, EnclaveMonitoringSettings monitoringSettings, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public EnclaveApprovalSettings ApprovalSettings { get; set; }
