...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class EnclaveEndpointPatch
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="EnclaveEndpointPatch"/>. </summary>
        ...
        internal EnclaveEndpointPatch(EnclaveEndpointPatchProperties properties, IDictionary<string, string> tags, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
