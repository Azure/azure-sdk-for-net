...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class EnclaveMonitoringSettings
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="EnclaveMonitoringSettings"/>. </summary>
        ...
        internal EnclaveMonitoringSettings(IList<EnclaveMonitoringDestination> diagnosticDestinations, EnclaveMonitoringDestination flowLogDestination, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IList<EnclaveMonitoringDestination> DiagnosticDestinations { get; }

        /// <summary> Log Analytics workspace destination where virtual network flow logs will be stored. </summary>
        public EnclaveMonitoringDestination FlowLogDestination { get; set; }
    }
}
