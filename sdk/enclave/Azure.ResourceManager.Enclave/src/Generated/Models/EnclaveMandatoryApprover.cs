...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class EnclaveMandatoryApprover
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="EnclaveMandatoryApprover"/>. </summary>
        ...
        internal EnclaveMandatoryApprover(string approverEntraId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ApproverEntraId = approverEntraId;
