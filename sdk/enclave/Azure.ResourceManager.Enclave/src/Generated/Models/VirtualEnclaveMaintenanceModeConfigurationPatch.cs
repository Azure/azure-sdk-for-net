...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class VirtualEnclaveMaintenanceModeConfigurationPatch
    {
        ...
        public VirtualEnclaveMaintenanceModeConfigurationPatch(VirtualEnclaveMaintenanceModeConfigurationMode mode)
        {
            Mode = mode;
        ...
        internal VirtualEnclaveMaintenanceModeConfigurationPatch(VirtualEnclaveMaintenanceModeConfigurationMode mode, IList<VirtualEnclavePrincipal> principals, VirtualEnclaveMaintenanceModeJustification? justification, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Mode = mode;
        ...
        public VirtualEnclaveMaintenanceModeConfigurationMode Mode { get; }
