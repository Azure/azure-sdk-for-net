...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class VirtualEnclaveMaintenanceModeConfigurationPatch
    {
        ...
        public VirtualEnclaveMaintenanceModeConfigurationPatch(MaintenanceModeConfigurationModelMode mode)
        {
            Mode = mode;
        ...
        internal VirtualEnclaveMaintenanceModeConfigurationPatch(MaintenanceModeConfigurationModelMode mode, IList<VirtualEnclavePrincipal> principals, MaintenanceModeConfigurationModelJustification? justification, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Mode = mode;
