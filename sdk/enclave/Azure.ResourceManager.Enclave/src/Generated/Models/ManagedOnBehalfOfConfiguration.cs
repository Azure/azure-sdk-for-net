...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    internal partial class ManagedOnBehalfOfConfiguration
    {
        ...
        {
            MoboBrokerResources = new ChangeTrackingList<EnclaveManagedOnBehalfOfBroker>();
        }

        /// <summary> Initializes a new instance of <see cref="ManagedOnBehalfOfConfiguration"/>. </summary>
        /// <param name="moboBrokerResources"> Managed-On-Behalf-Of broker resources. </param>
        /// <param name="additionalBinaryDataProperties"> Keeps track of any properties unknown to the library. </param>
        internal ManagedOnBehalfOfConfiguration(IReadOnlyList<EnclaveManagedOnBehalfOfBroker> moboBrokerResources, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public IReadOnlyList<EnclaveManagedOnBehalfOfBroker> MoboBrokerResources { get; } = new ChangeTrackingList<EnclaveManagedOnBehalfOfBroker>();
    }
}
