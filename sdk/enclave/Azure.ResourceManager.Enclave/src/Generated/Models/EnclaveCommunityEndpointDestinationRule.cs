...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class EnclaveCommunityEndpointDestinationRule
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="EnclaveCommunityEndpointDestinationRule"/>. </summary>
        ...
        internal EnclaveCommunityEndpointDestinationRule(EnclaveCommunityEndpointDestinationType? destinationType, IList<EnclaveCommunityEndpointProtocol> protocols, ResourceIdentifier transitHubResourceId, string endpointRuleName, string destination, string ports, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
        ...
        public EnclaveCommunityEndpointDestinationType? DestinationType { get; set; }

        /// <summary> Protocols. Options specified by Endpoint Protocol Enum. </summary>
        public IList<EnclaveCommunityEndpointProtocol> Protocols { get; }
