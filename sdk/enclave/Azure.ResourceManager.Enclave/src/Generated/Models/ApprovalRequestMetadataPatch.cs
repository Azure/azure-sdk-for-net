...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class ApprovalRequestMetadataPatch
    {
        ...
        internal ApprovalRequestMetadataPatch(string resourceAction, string approvalCallbackRoute, string approvalCallbackPayload, EnclaveApprovalStatus? approvalStatus, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ResourceAction = resourceAction;
