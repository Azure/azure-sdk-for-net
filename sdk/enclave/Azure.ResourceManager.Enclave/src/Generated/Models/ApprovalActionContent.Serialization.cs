...
namespace Azure.ResourceManager.Enclave.Models
{
    ...
    public partial class ApprovalActionContent : IJsonModel<ApprovalActionContent>
    {
        ...
        protected virtual ApprovalActionContent PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        internal static RequestContent ToRequestContent(ApprovalActionContent approvalActionContent)
        {
            ...
            return RequestContent.Create(approvalActionContent, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ApprovalActionContent IJsonModel<ApprovalActionContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ApprovalActionContent JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ApprovalActionContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ApprovalActionContent DeserializeApprovalActionContent(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    approvalStatus = new ApprovalActionRequestApprovalStatus(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
