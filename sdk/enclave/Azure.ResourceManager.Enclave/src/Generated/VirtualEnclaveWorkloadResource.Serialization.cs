...
namespace Azure.ResourceManager.Enclave
{
    ...
    public partial class VirtualEnclaveWorkloadResource : IJsonModel<VirtualEnclaveWorkloadData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<VirtualEnclaveWorkloadData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<VirtualEnclaveWorkloadData>(Data, options, AzureResourceManagerEnclaveContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        VirtualEnclaveWorkloadData IPersistableModel<VirtualEnclaveWorkloadData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<VirtualEnclaveWorkloadData>(data, options, AzureResourceManagerEnclaveContext.Default);
