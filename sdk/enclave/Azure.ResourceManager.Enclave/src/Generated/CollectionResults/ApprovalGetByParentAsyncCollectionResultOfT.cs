...
namespace Azure.ResourceManager.Enclave
{
    internal partial class ApprovalGetByParentAsyncCollectionResultOfT : AsyncPageable<VirtualEnclaveApprovalData>
    {
        ...
        /// <summary> Initializes a new instance of ApprovalGetByParentAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ApprovalGetByParentAsyncCollectionResultOfT(Approval client, string resourceUri, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ApprovalGetByParentAsyncCollectionResultOfT as an enumerable collection. </summary>
