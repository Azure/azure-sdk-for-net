...
{
    public partial class Sample_ScVmmVirtualNetworkCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_CreateVirtualNetwork()
        {
            // Generated from example definition: specification/scvmm/resource-manager/Microsoft.ScVmm/stable/2023-10-07/examples/CreateVirtualNetwork.json
            ...
            // get the collection of this ScVmmVirtualNetworkResource
            ScVmmVirtualNetworkCollection collection = resourceGroupResource.GetScVmmVirtualNetworks();
            ...
            ArmOperation<ScVmmVirtualNetworkResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, virtualNetworkName, data);
        ...
        public async Task Get_GetVirtualNetwork()
        {
            ...
            // invoke the operation
            string virtualNetworkName = "HRVirtualNetwork";
            ScVmmVirtualNetworkResource result = await collection.GetAsync(virtualNetworkName);
        ...
        {
            // Generated from example definition: specification/scvmm/resource-manager/Microsoft.ScVmm/stable/2023-10-07/examples/ListVirtualNetworksByResourceGroup.json
            ...
            await foreach (ScVmmVirtualNetworkResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_GetVirtualNetwork()
        {
            ...
            // invoke the operation
            string virtualNetworkName = "HRVirtualNetwork";
            NullableResponse<ScVmmVirtualNetworkResource> response = await collection.GetIfExistsAsync(virtualNetworkName);
            ScVmmVirtualNetworkResource result = response.HasValue ? response.Value : null;
