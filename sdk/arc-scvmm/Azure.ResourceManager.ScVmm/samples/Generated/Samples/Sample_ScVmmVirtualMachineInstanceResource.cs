...
namespace Azure.ResourceManager.ScVmm.Samples
{
    public partial class Sample_ScVmmVirtualMachineInstanceResource
    {
        ...
        public async Task Delete_DeleteVirtualMachine()
        {
            ...
            // invoke the operation
            await scVmmVirtualMachineInstance.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Stop_StopVirtualMachine()
        {
            ...
            await scVmmVirtualMachineInstance.StopAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task Start_StartVirtualMachine()
        {
            ...
            // invoke the operation
            await scVmmVirtualMachineInstance.StartAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Restart_RestartVirtualMachine()
        {
            ...
            // invoke the operation
            await scVmmVirtualMachineInstance.RestartAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task CreateCheckpoint_CreateCheckpointVirtualMachine()
        {
            ...
            await scVmmVirtualMachineInstance.CreateCheckpointAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task DeleteCheckpoint_DeleteCheckpointVirtualMachine()
        {
            ...
            await scVmmVirtualMachineInstance.DeleteCheckpointAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task RestoreCheckpoint_RestoreCheckpointVirtualMachine()
        {
            ...
            await scVmmVirtualMachineInstance.RestoreCheckpointAsync(WaitUntil.Completed, content).ConfigureAwait(false);
