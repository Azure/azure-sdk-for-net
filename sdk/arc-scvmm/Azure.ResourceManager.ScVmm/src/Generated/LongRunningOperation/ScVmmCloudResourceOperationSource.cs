...
{
    /// <summary></summary>
    internal partial class ScVmmCloudResourceOperationSource : IOperationSource<ScVmmCloudResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ScVmmCloudResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        ScVmmCloudResource IOperationSource<ScVmmCloudResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ScVmmCloudData data = ScVmmCloudData.DeserializeScVmmCloudData(document.RootElement, ModelSerializationExtensions.WireOptions);
