...
{
    /// <summary></summary>
    internal partial class ScVmmVirtualMachineTemplateResourceOperationSource : IOperationSource<ScVmmVirtualMachineTemplateResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ScVmmVirtualMachineTemplateResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        ScVmmVirtualMachineTemplateResource IOperationSource<ScVmmVirtualMachineTemplateResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            ScVmmVirtualMachineTemplateData data = ScVmmVirtualMachineTemplateData.DeserializeScVmmVirtualMachineTemplateData(document.RootElement, ModelSerializationExtensions.WireOptions);
