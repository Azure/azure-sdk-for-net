...
namespace Azure.ResourceManager.ScVmm
{
    ...
    public partial class ScVmmAvailabilitySetResource : ArmResource
    {
        ...
        {
            _scVmmAvailabilitySetAvailabilitySetsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ScVmm", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, ScVmmForceDeletion? force = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ScVmmArmOperation(_scVmmAvailabilitySetAvailabilitySetsClientDiagnostics, Pipeline, _scVmmAvailabilitySetAvailabilitySetsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, force).Request, response, OperationFinalStateVia.Location);
