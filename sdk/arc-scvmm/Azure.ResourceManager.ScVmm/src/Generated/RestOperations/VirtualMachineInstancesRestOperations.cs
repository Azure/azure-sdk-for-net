...
namespace Azure.ResourceManager.ScVmm
{
    internal partial class VirtualMachineInstancesRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string resourceUri, ScVmmVirtualMachineInstanceData data)
        {
            ...
            ((IJsonModel<ScVmmVirtualMachineInstanceData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateUpdateRequest(string resourceUri, ScVmmVirtualMachineInstancePatch patch)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<ScVmmVirtualMachineInstancePatch>)patch).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateCreateCheckpointRequest(string resourceUri, VirtualMachineCreateCheckpointContent content)
        {
            ...
            if (content != null)
            {
                request.Headers.Add("Content-Type", "application/json");
                var content0 = new Utf8JsonRequestContent();
                ((IJsonModel<VirtualMachineCreateCheckpointContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
                request.Content = content0;
            }
            _userAgent.Apply(message);
            return message;
        ...
        internal HttpMessage CreateDeleteCheckpointRequest(string resourceUri, VirtualMachineDeleteCheckpointContent content)
        {
            ...
            if (content != null)
            {
                request.Headers.Add("Content-Type", "application/json");
                var content0 = new Utf8JsonRequestContent();
                ((IJsonModel<VirtualMachineDeleteCheckpointContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
                request.Content = content0;
            }
            _userAgent.Apply(message);
            return message;
        ...
        internal HttpMessage CreateRestoreCheckpointRequest(string resourceUri, VirtualMachineRestoreCheckpointContent content)
        {
            ...
            if (content != null)
            {
                request.Headers.Add("Content-Type", "application/json");
                var content0 = new Utf8JsonRequestContent();
                ((IJsonModel<VirtualMachineRestoreCheckpointContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
                request.Content = content0;
            }
            _userAgent.Apply(message);
            return message;
