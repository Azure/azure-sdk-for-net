...
{
    /// <summary>
    /// A class representing the ScVmmInventoryItem data model.
    ...
    public partial class ScVmmInventoryItemData : ResourceData
    {
        ...
        /// The available derived classes include <see cref="CloudInventoryItem"/>, <see cref="VirtualNetworkInventoryItem"/>, <see cref="VirtualMachineTemplateInventoryItem"/> and <see cref="VirtualMachineInventoryItem"/>.
        /// </param>
        ...
        internal ScVmmInventoryItemData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ScVmmInventoryItemProperties properties, string kind, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
            Kind = kind;
