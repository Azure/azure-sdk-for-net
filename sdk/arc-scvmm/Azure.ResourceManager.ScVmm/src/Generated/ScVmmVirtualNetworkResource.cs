...
namespace Azure.ResourceManager.ScVmm
{
    ...
    public partial class ScVmmVirtualNetworkResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the ScVmmVirtualNetwork.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ScVmm/virtualNetworks/{virtualNetworkName}. </description>
        ...
        public virtual async Task<ArmOperation<ScVmmVirtualNetworkResource>> UpdateAsync(WaitUntil waitUntil, ScVmmVirtualNetworkData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _virtualNetworksRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, ScVmmVirtualNetworkData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                ScVmmArmOperation<ScVmmVirtualNetworkResource> operation = new ScVmmArmOperation<ScVmmVirtualNetworkResource>(
                    new ScVmmVirtualNetworkResourceOperationSource(Client),
                    _virtualNetworksClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<ScVmmVirtualNetworkResource> Update(WaitUntil waitUntil, ScVmmVirtualNetworkData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
