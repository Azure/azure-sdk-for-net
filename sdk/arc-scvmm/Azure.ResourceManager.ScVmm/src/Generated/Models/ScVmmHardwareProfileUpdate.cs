...
namespace Azure.ResourceManager.ScVmm.Models
{
    ...
    public partial class ScVmmHardwareProfileUpdate
    {
        ...
        internal ScVmmHardwareProfileUpdate(int? memoryMB, int? cpuCount, LimitCpuForMigration? limitCpuForMigration, DynamicMemoryEnabled? dynamicMemoryEnabled, int? dynamicMemoryMaxMB, int? dynamicMemoryMinMB, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MemoryMB = memoryMB;
            CpuCount = cpuCount;
