...
namespace Azure.ResourceManager.ScVmm.Models
{
    internal partial class GuestAgentList : IUtf8JsonSerializable, IJsonModel<GuestAgentList>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                ((IJsonModel<ScVmmGuestAgentData>)item).Write(writer, options);
            }
        ...
        internal static GuestAgentList DeserializeGuestAgentList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<ScVmmGuestAgentData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<ScVmmGuestAgentData> array = new List<ScVmmGuestAgentData>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(ScVmmGuestAgentData.DeserializeScVmmGuestAgentData(item, options));
                    }
                    value = array;
                    continue;
                }
