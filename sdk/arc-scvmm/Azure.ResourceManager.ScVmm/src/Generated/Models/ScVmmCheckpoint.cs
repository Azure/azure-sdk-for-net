...
namespace Azure.ResourceManager.ScVmm.Models
{
    ...
    public partial class ScVmmCheckpoint
    {
        ...
        internal ScVmmCheckpoint(string parentCheckpointId, string checkpointId, string name, string description, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
