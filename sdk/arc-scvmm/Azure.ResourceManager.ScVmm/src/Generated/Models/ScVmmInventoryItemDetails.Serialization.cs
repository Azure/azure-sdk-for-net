...
namespace Azure.ResourceManager.ScVmm.Models
{
    ...
    public partial class ScVmmInventoryItemDetails : IJsonModel<ScVmmInventoryItemDetails>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ScVmmInventoryItemDetails PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ScVmmInventoryItemDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ScVmmInventoryItemDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ScVmmInventoryItemDetails IPersistableModel<ScVmmInventoryItemDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ScVmmInventoryItemDetails IJsonModel<ScVmmInventoryItemDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual ScVmmInventoryItemDetails JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<ScVmmInventoryItemDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static ScVmmInventoryItemDetails DeserializeScVmmInventoryItemDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new ScVmmInventoryItemDetails(inventoryItemId, inventoryItemName, additionalBinaryDataProperties);
        }
    }
}
