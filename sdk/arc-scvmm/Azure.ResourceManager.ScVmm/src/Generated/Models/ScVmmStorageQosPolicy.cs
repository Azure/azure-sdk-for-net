...
namespace Azure.ResourceManager.ScVmm.Models
{
    ...
    public partial class ScVmmStorageQosPolicy
    {
        ...
        internal ScVmmStorageQosPolicy(string name, string id, long? iopsMaximum, long? iopsMinimum, long? bandwidthLimit, string policyId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Id = id;
