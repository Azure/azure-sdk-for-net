...
namespace Azure.ResourceManager.ScVmm.Models
{
    ...
    public static partial class ArmScVmmModelFactory
    {
        ...
        public static Azure.ResourceManager.ScVmm.Models.OSProfileForVmInstance OSProfileForVmInstance(string adminUsername, string adminPassword, string computerName, Azure.ResourceManager.ScVmm.Models.ScVmmOSType? osType, string osSku, string osVersion, string domainName = null, string domainUsername = null, string domainPassword = null, string workgroup = null, string productKey = null, int? timezone = default(int?), string runOnceCommands = null) { throw null; }
        ...
        public static Azure.ResourceManager.ScVmm.ScVmmAvailabilitySetData ScVmmAvailabilitySetData(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, System.Collections.Generic.IDictionary<string, string> tags, Azure.Core.AzureLocation location, string availabilitySetName, Azure.Core.ResourceIdentifier vmmServerId, Azure.ResourceManager.ScVmm.Models.ScVmmProvisioningState? provisioningState, Azure.ResourceManager.Resources.Models.ExtendedLocation extendedLocation) { throw null; }
        ...
        public static Azure.ResourceManager.ScVmm.Models.ScVmmCloudCapacity ScVmmCloudCapacity(long? cpuCount, long? memoryMB, long? vmCount, long? storageGB) { throw null; }
        ...
        public static Azure.ResourceManager.ScVmm.ScVmmCloudData ScVmmCloudData(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, System.Collections.Generic.IDictionary<string, string> tags, Azure.Core.AzureLocation location, string inventoryItemId, string uuid, Azure.Core.ResourceIdentifier vmmServerId, string cloudName, Azure.ResourceManager.ScVmm.Models.ScVmmCloudCapacity cloudCapacity, System.Collections.Generic.IEnumerable<Azure.ResourceManager.ScVmm.Models.ScVmmStorageQosPolicy> storageQosPolicies, Azure.ResourceManager.ScVmm.Models.ScVmmProvisioningState? provisioningState, Azure.ResourceManager.Resources.Models.ExtendedLocation extendedLocation) { throw null; }
        public static Azure.ResourceManager.ScVmm.ScVmmGuestAgentData ScVmmGuestAgentData(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, string uuid, Azure.ResourceManager.ScVmm.Models.ScVmmGuestCredential credentials, Azure.ResourceManager.ScVmm.Models.ScVmmProvisioningAction? provisioningAction, string status, string customResourceName, Azure.ResourceManager.ScVmm.Models.ScVmmProvisioningState? provisioningState, Azure.Core.ResourceIdentifier privateLinkScopeResourceId, string httpsProxy) { throw null; }
        ...
        public static Azure.ResourceManager.ScVmm.ScVmmServerData ScVmmServerData(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, System.Collections.Generic.IDictionary<string, string> tags, Azure.Core.AzureLocation location, Azure.ResourceManager.ScVmm.Models.VmmCredential credentials, string fqdn, int? port, string connectionStatus, string errorMessage, string uuid, string version, Azure.ResourceManager.ScVmm.Models.ScVmmProvisioningState? provisioningState, Azure.ResourceManager.Resources.Models.ExtendedLocation extendedLocation) { throw null; }
        ...
        public static Azure.ResourceManager.ScVmm.ScVmmVirtualMachineInstanceData ScVmmVirtualMachineInstanceData(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, System.Collections.Generic.IEnumerable<Azure.ResourceManager.ScVmm.Models.ScVmmAvailabilitySetItem> availabilitySets, Azure.ResourceManager.ScVmm.Models.OSProfileForVmInstance osProfile, Azure.ResourceManager.ScVmm.Models.ScVmmHardwareProfile hardwareProfile, Azure.ResourceManager.ScVmm.Models.ScVmmInfrastructureProfile infrastructureProfile, string powerState, Azure.ResourceManager.ScVmm.Models.ScVmmProvisioningState? provisioningState, System.Collections.Generic.IEnumerable<Azure.ResourceManager.ScVmm.Models.ScVmmNetworkInterface> networkInterfaces, System.Collections.Generic.IEnumerable<Azure.ResourceManager.ScVmm.Models.ScVmmVirtualDisk> storageDisks, Azure.ResourceManager.Resources.Models.ExtendedLocation extendedLocation) { throw null; }
        ...
        public static Azure.ResourceManager.ScVmm.ScVmmVirtualMachineTemplateData ScVmmVirtualMachineTemplateData(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, System.Collections.Generic.IDictionary<string, string> tags, Azure.Core.AzureLocation location, string inventoryItemId, string uuid, Azure.Core.ResourceIdentifier vmmServerId, Azure.ResourceManager.ScVmm.Models.ScVmmOSType? osType, string osName, string computerName, int? memoryMB, int? cpuCount, Azure.ResourceManager.ScVmm.Models.LimitCpuForMigration? limitCpuForMigration, Azure.ResourceManager.ScVmm.Models.DynamicMemoryEnabled? dynamicMemoryEnabled, Azure.ResourceManager.ScVmm.Models.IsCustomizable? isCustomizable, int? dynamicMemoryMaxMB, int? dynamicMemoryMinMB, Azure.ResourceManager.ScVmm.Models.IsHighlyAvailable? isHighlyAvailable, int? generation, System.Collections.Generic.IEnumerable<Azure.ResourceManager.ScVmm.Models.ScVmmNetworkInterface> networkInterfaces, System.Collections.Generic.IEnumerable<Azure.ResourceManager.ScVmm.Models.ScVmmVirtualDisk> disks, Azure.ResourceManager.ScVmm.Models.ScVmmProvisioningState? provisioningState, Azure.ResourceManager.Resources.Models.ExtendedLocation extendedLocation) { throw null; }
        ...
        public static Azure.ResourceManager.ScVmm.ScVmmVirtualNetworkData ScVmmVirtualNetworkData(Azure.Core.ResourceIdentifier id, string name, Azure.Core.ResourceType resourceType, Azure.ResourceManager.Models.SystemData systemData, System.Collections.Generic.IDictionary<string, string> tags, Azure.Core.AzureLocation location, string inventoryItemId, string uuid, Azure.Core.ResourceIdentifier vmmServerId, string networkName, Azure.ResourceManager.ScVmm.Models.ScVmmProvisioningState? provisioningState, Azure.ResourceManager.Resources.Models.ExtendedLocation extendedLocation) { throw null; }
        ...
        public static Azure.ResourceManager.ScVmm.Models.VirtualMachineInventoryItem VirtualMachineInventoryItem(string managedResourceId, string uuid, string inventoryItemName, Azure.ResourceManager.ScVmm.Models.ScVmmProvisioningState? provisioningState, Azure.ResourceManager.ScVmm.Models.ScVmmOSType? osType, string osName, string osVersion, string powerState, long? generation, System.Collections.Generic.IEnumerable<string> ipAddresses, Azure.ResourceManager.ScVmm.Models.ScVmmInventoryItemDetails cloud, string biosGuid, Azure.Core.ResourceIdentifier managedMachineResourceId) { throw null; }
