...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    public static partial class ArcScVmmModelFactory
    {
        ...
        public static InventoryItemData InventoryItemData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string kind = null, InventoryType inventoryType = default, string managedResourceId = null, string uuid = null, string inventoryItemName = null, string provisioningState = null)
        {
            return new InventoryItemData(id, name, resourceType, systemData, kind, inventoryType, managedResourceId, uuid, inventoryItemName, provisioningState);
        }
    }
}
