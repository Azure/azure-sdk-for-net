...
namespace Azure.ResourceManager.ArcScVmm.Mock
{
    ...
    public partial class ScVmmVirtualMachineResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ScVmmVirtualMachineResourceExtension"/> class for mocking. </summary>
        protected ScVmmVirtualMachineResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ScVmmVirtualMachineResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ScVmmVirtualMachineResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
