...
namespace Azure.ResourceManager.ArcScVmm.Mock
{
    ...
    public partial class ScVmmVirtualNetworkResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ScVmmVirtualNetworkResourceExtension"/> class for mocking. </summary>
        protected ScVmmVirtualNetworkResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ScVmmVirtualNetworkResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ScVmmVirtualNetworkResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
