...
namespace Azure.ResourceManager.ArcScVmm.Mock
{
    ...
    public partial class ScVmmCloudResourceExtension : ArmResource
    {
        private ClientDiagnostics _scVmmCloudCloudsClientDiagnostics;
        private CloudsRestOperations _scVmmCloudCloudsRestClient;

        /// <summary> Initializes a new instance of the <see cref="ScVmmCloudResourceExtension"/> class for mocking. </summary>
        protected ScVmmCloudResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ScVmmCloudResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ScVmmCloudResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ScVmmCloudResource> GetScVmmCloudsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ScVmmCloudResource(Client, ScVmmCloudData.DeserializeScVmmCloudData(e)), ScVmmCloudCloudsClientDiagnostics, Pipeline, "ScVmmCloudResourceExtension.GetScVmmClouds", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ScVmmCloudResource> GetScVmmClouds(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ScVmmCloudCloudsRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ScVmmCloudCloudsRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ScVmmCloudResource(Client, ScVmmCloudData.DeserializeScVmmCloudData(e)), ScVmmCloudCloudsClientDiagnostics, Pipeline, "ScVmmCloudResourceExtension.GetScVmmClouds", "value", "nextLink", cancellationToken);
        }
    }
}
