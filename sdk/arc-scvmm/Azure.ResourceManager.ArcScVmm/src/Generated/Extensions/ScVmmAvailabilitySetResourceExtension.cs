...
namespace Azure.ResourceManager.ArcScVmm.Mock
{
    ...
    public partial class ScVmmAvailabilitySetResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ScVmmAvailabilitySetResourceExtension"/> class for mocking. </summary>
        protected ScVmmAvailabilitySetResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ScVmmAvailabilitySetResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ScVmmAvailabilitySetResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ScVmmAvailabilitySetResource> GetScVmmAvailabilitySetsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ScVmmAvailabilitySetResource(Client, ScVmmAvailabilitySetData.DeserializeScVmmAvailabilitySetData(e)), ScVmmAvailabilitySetAvailabilitySetsClientDiagnostics, Pipeline, "ScVmmAvailabilitySetResourceExtension.GetScVmmAvailabilitySets", "value", "nextLink", cancellationToken);
        }
