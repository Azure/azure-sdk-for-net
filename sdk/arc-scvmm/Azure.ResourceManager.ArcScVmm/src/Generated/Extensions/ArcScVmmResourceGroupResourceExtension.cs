...
namespace Azure.ResourceManager.ArcScVmm.Mock
{
    ...
    public partial class ArcScVmmResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ArcScVmmResourceGroupResourceExtension"/> class for mocking. </summary>
        protected ArcScVmmResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ArcScVmmResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ArcScVmmResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
