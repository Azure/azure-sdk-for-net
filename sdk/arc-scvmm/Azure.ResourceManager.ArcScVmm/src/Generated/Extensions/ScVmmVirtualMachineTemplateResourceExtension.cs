...
namespace Azure.ResourceManager.ArcScVmm.Mock
{
    ...
    public partial class ScVmmVirtualMachineTemplateResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="ScVmmVirtualMachineTemplateResourceExtension"/> class for mocking. </summary>
        protected ScVmmVirtualMachineTemplateResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ScVmmVirtualMachineTemplateResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ScVmmVirtualMachineTemplateResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
