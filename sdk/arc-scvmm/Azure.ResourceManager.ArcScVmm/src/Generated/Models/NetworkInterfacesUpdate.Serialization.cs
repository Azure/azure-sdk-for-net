...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    public partial class NetworkInterfacesUpdate : IUtf8JsonSerializable, IJsonModel<NetworkInterfacesUpdate>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<NetworkInterfacesUpdate>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NetworkInterfacesUpdate>)} interface");
            }
