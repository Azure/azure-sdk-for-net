...
namespace Azure.ResourceManager.ArcScVmm
{
    public partial class GuestAgentData : IUtf8JsonSerializable
    {
        ...
        internal static GuestAgentData DeserializeGuestAgentData(JsonElement element)
        {
            ...
            return new GuestAgentData(id, name, type, systemData.Value, uuid.Value, credentials.Value, httpProxyConfig.Value, Optional.ToNullable(provisioningAction), status.Value, customResourceName.Value, Optional.ToNullable(provisioningState));
        }
    }
}
