...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CloudCapacity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CloudCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CloudCapacity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CloudCapacity>)} interface");
            }
        ...
        string IPersistableModel<CloudCapacity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
