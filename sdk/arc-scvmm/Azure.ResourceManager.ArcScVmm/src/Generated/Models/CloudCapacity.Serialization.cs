...
{
    public partial class CloudCapacity : IUtf8JsonSerializable, IJsonModel<CloudCapacity>, IPersistableModel<CloudCapacity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VmCount))
            {
                builder.Append("  vmCount:");
                builder.AppendLine($" '{VmCount.Value.ToString()}'");
            }
