    ...
    public partial class NetworkInterfaces : IUtf8JsonSerializable, IJsonModel<NetworkInterfaces>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VirtualNetworkId))
            {
                ...
                if (VirtualNetworkId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(IPv4AddressType))
            {
                ...
                builder.AppendLine($" '{IPv4AddressType.Value.ToString()}'");
            }

            if (Optional.IsDefined(IPv6AddressType))
            {
                builder.Append("  ipv6AddressType:");
                builder.AppendLine($" '{IPv6AddressType.Value.ToString()}'");
            }

            if (Optional.IsDefined(MacAddressType))
            {
                builder.Append("  macAddressType:");
                builder.AppendLine($" '{MacAddressType.Value.ToString()}'");
            }
