...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    internal partial class AvailabilitySetListResult : IUtf8JsonSerializable, IModelJsonSerializable<AvailabilitySetListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<AvailabilitySetListResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<ScVmmAvailabilitySetData>)item).Serialize(writer, options);
                    }
                }
        ...
        internal static AvailabilitySetListResult DeserializeAvailabilitySetListResult(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new AvailabilitySetListResult(Optional.ToList(value), nextLink.Value, serializedAdditionalRawData);
        }
