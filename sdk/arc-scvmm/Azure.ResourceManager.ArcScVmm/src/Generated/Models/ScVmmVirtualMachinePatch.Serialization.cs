...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScVmmVirtualMachinePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScVmmVirtualMachinePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScVmmVirtualMachinePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScVmmVirtualMachinePatch>)} interface");
            }
        ...
        string IPersistableModel<ScVmmVirtualMachinePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
