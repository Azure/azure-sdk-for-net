...
namespace Azure.ResourceManager.ArcScVmm
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScVmmServerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScVmmServerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScVmmServerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScVmmServerData>)} interface");
            }
        ...
        string IPersistableModel<ScVmmServerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
