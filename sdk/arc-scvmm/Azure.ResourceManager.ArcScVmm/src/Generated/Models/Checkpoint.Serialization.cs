...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Checkpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Checkpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Checkpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Checkpoint>)} interface");
            }
        ...
        string IPersistableModel<Checkpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
