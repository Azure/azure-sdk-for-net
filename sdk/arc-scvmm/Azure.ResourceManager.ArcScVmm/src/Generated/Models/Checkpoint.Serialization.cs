...
{
    public partial class Checkpoint : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Checkpoint DeserializeCheckpoint(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
