...
{
    public partial class Checkpoint : IUtf8JsonSerializable, IJsonModel<Checkpoint>, IPersistableModel<Checkpoint>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ParentCheckpointId))
            {
                builder.Append("  parentCheckpointID:");
                builder.AppendLine($" '{ParentCheckpointId}'");
            }

            if (Optional.IsDefined(CheckpointId))
            {
                builder.Append("  checkpointID:");
                builder.AppendLine($" '{CheckpointId}'");
            }
