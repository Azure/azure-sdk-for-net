...
{
    public partial class VmInstanceHybridIdentityMetadataData : IUtf8JsonSerializable
    {
        ...
        internal static VmInstanceHybridIdentityMetadataData DeserializeVmInstanceHybridIdentityMetadataData(JsonElement element)
        {
            ...
            return new VmInstanceHybridIdentityMetadataData(id, name, type, systemData.Value, resourceUid.Value, publicKey.Value, Optional.ToNullable(provisioningState));
        }
    }
}
