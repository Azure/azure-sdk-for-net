...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    internal partial class UnknownInventoryItemProperties : InventoryItemProperties
    {
        ...
        internal UnknownInventoryItemProperties(InventoryType inventoryType, string managedResourceId, string uuid, string inventoryItemName, string provisioningState) : base(inventoryType, managedResourceId, uuid, inventoryItemName, provisioningState)
        {
