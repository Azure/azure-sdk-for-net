...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    public partial class NetworkInterfaceUpdate
    {
        ...
        internal NetworkInterfaceUpdate(string name, string macAddress, string virtualNetworkId, AllocationMethod? ipv4AddressType, AllocationMethod? ipv6AddressType, AllocationMethod? macAddressType, string nicId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
