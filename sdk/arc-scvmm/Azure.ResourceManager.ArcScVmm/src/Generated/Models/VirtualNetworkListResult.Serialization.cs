...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    {
        internal static VirtualNetworkListResult DeserializeVirtualNetworkListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
