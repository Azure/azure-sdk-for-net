...
{
    public partial class VirtualNetworkInventoryItem : IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetworkInventoryItem DeserializeVirtualNetworkInventoryItem(JsonElement element)
        {
            ...
            return new VirtualNetworkInventoryItem(inventoryType, managedResourceId.Value, uuid.Value, inventoryItemName.Value, provisioningState.Value);
        }
    }
}
