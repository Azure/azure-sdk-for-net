...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    public partial class NetworkInterfacesUpdate
    {
        ...
        internal NetworkInterfacesUpdate(string name, string macAddress, string virtualNetworkId, AllocationMethod? ipv4AddressType, AllocationMethod? ipv6AddressType, AllocationMethod? macAddressType, string nicId, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
