...
{
    public partial class CloudInventoryItem : IUtf8JsonSerializable
    {
        ...
        internal static CloudInventoryItem DeserializeCloudInventoryItem(JsonElement element)
        {
            ...
            return new CloudInventoryItem(inventoryType, managedResourceId.Value, uuid.Value, inventoryItemName.Value, provisioningState.Value);
        }
    }
}
