...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    public partial class StorageQoSPolicy
    {
        ...
        internal StorageQoSPolicy(string name, string id, long? iopsMaximum, long? iopsMinimum, long? bandwidthLimit, string policyId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Id = id;
