...
{
    public partial class VirtualDisk : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VirtualDisk DeserializeVirtualDisk(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
