...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    public partial class NetworkInterface : IUtf8JsonSerializable
    {
        ...
        internal static NetworkInterface DeserializeNetworkInterface(JsonElement element)
        {
            ...
            return new NetworkInterface(name.Value, displayName.Value, Optional.ToList(ipv4Addresses), Optional.ToList(ipv6Addresses), macAddress.Value, virtualNetworkId.Value, networkName.Value, Optional.ToNullable(ipv4AddressType), Optional.ToNullable(ipv6AddressType), Optional.ToNullable(macAddressType), nicId.Value);
        }
    }
}
