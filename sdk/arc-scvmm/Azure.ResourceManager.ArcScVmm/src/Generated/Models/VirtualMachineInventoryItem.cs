...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    public partial class VirtualMachineInventoryItem : InventoryItemProperties
    {
        ...
        internal VirtualMachineInventoryItem(InventoryType inventoryType, string managedResourceId, string uuid, string inventoryItemName, ProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData, OSType? osType, string osName, string osVersion, string powerState, IList<string> ipAddresses, InventoryItemDetails cloud, string biosGuid, ResourceIdentifier managedMachineResourceId) : base(inventoryType, managedResourceId, uuid, inventoryItemName, provisioningState, serializedAdditionalRawData)
        {
            OSType = osType;
            OSName = osName;
            OSVersion = osVersion;
