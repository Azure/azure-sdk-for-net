...
namespace Azure.ResourceManager.ArcScVmm
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScVmmVirtualMachineTemplateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScVmmVirtualMachineTemplateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScVmmVirtualMachineTemplateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScVmmVirtualMachineTemplateData>)} interface");
            }
        ...
        string IPersistableModel<ScVmmVirtualMachineTemplateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
