...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    public partial class HardwareProfile
    {
        ...
        internal HardwareProfile(int? memoryMB, int? cpuCount, LimitCpuForMigration? limitCpuForMigration, DynamicMemoryEnabled? dynamicMemoryEnabled, int? dynamicMemoryMaxMB, int? dynamicMemoryMinMB, string isHighlyAvailable, Dictionary<string, BinaryData> rawData)
        {
            MemoryMB = memoryMB;
            CpuCount = cpuCount;
