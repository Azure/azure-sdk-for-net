...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    public partial class NetworkInterfaces
    {
        ...
        {
            IPv4Ipv4Addresses = new ChangeTrackingList<string>();
            IPv6Ipv6Addresses = new ChangeTrackingList<string>();
        }
        ...
        /// <param name="iPv4Ipv4Addresses"> Gets or sets the nic ipv4 addresses. </param>
        /// <param name="iPv6Ipv6Addresses"> Gets or sets the nic ipv6 addresses. </param>
        ...
        /// <param name="iPv4Ipv4AddressType"> Gets or sets the ipv4 address type. </param>
        /// <param name="iPv6Ipv6AddressType"> Gets or sets the ipv6 address type. </param>
        /// <param name="macAddressType"> Gets or sets the mac address type. </param>
        /// <param name="nicId"> Gets or sets the nic id. </param>
        internal NetworkInterfaces(string name, string displayName, IReadOnlyList<string> iPv4Ipv4Addresses, IReadOnlyList<string> iPv6Ipv6Addresses, string macAddress, string virtualNetworkId, string networkName, AllocationMethod? iPv4Ipv4AddressType, AllocationMethod? iPv6Ipv6AddressType, AllocationMethod? macAddressType, string nicId)
        {
            Name = name;
            ...
            IPv4Ipv4AddressType = iPv4Ipv4AddressType;
            IPv6Ipv6AddressType = iPv6Ipv6AddressType;
        ...
        public IReadOnlyList<string> IPv4Ipv4Addresses { get; }
        /// <summary> Gets or sets the nic ipv6 addresses. </summary>
        public IReadOnlyList<string> IPv6Ipv6Addresses { get; }
