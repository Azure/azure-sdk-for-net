...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    public partial class HardwareProfileUpdate
    {
        ...
        internal HardwareProfileUpdate(int? memoryMB, int? cpuCount, LimitCpuForMigration? limitCpuForMigration, DynamicMemoryEnabled? dynamicMemoryEnabled, int? dynamicMemoryMaxMB, int? dynamicMemoryMinMB, Dictionary<string, BinaryData> rawData)
        {
            MemoryMB = memoryMB;
            CpuCount = cpuCount;
