...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    public partial class VirtualDiskUpdate
    {
        ...
        internal VirtualDiskUpdate(string name, string diskId, int? diskSizeGB, int? bus, int? lun, string busType, string vhdType, StorageQoSPolicyDetails storageQoSPolicy, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            DiskId = diskId;
