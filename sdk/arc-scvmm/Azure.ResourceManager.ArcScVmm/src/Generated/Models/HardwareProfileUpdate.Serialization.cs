...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HardwareProfileUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HardwareProfileUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HardwareProfileUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HardwareProfileUpdate>)} interface");
            }
        ...
        string IPersistableModel<HardwareProfileUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
