...
namespace Azure.ResourceManager.ArcScVmm
{
    public partial class ScVmmCloudData : IUtf8JsonSerializable, IJsonModel<ScVmmCloudData>
    {
        ...
        void IJsonModel<ScVmmCloudData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ScVmmCloudData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ScVmmCloudData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ScVmmCloudData)} does not support '{options.Format}' format.");
            }
        }
