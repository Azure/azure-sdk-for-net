...
namespace Azure.ResourceManager.ArcScVmm
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScVmmCloudData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScVmmCloudData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScVmmCloudData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScVmmCloudData>)} interface");
            }
        ...
        string IPersistableModel<ScVmmCloudData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
