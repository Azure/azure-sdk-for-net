...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageQoSPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageQoSPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageQoSPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageQoSPolicy>)} interface");
            }
        ...
        string IPersistableModel<StorageQoSPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
