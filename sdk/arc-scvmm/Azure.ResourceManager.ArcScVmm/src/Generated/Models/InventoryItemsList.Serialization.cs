...
{
    internal partial class InventoryItemsList : IUtf8JsonSerializable, IJsonModel<InventoryItemsList>, IPersistableModel<InventoryItemsList>
    {
        ...
        void IJsonModel<InventoryItemsList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InventoryItemsList)} does not support '{format}' format.");
            }
