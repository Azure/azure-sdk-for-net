...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    public partial class NetworkInterface
    {
        ...
        internal NetworkInterface(string name, string displayName, IReadOnlyList<string> ipv4Addresses, IReadOnlyList<string> ipv6Addresses, string macAddress, ResourceIdentifier virtualNetworkId, string networkName, AllocationMethod? ipv4AddressType, AllocationMethod? ipv6AddressType, AllocationMethod? macAddressType, string nicId)
        {
            Name = name;
