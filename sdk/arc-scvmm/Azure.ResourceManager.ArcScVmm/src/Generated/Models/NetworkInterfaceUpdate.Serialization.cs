...
namespace Azure.ResourceManager.ArcScVmm.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NetworkInterfaceUpdate>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<NetworkInterfaceUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<NetworkInterfaceUpdate>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkInterfaceUpdate)} does not support writing '{format}' format.");
            }
        ...
        NetworkInterfaceUpdate IJsonModel<NetworkInterfaceUpdate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NetworkInterfaceUpdate)} does not support reading '{format}' format.");
            }
        ...
        internal static NetworkInterfaceUpdate DeserializeNetworkInterfaceUpdate(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NetworkInterfaceUpdate(
                name,
                macAddress,
                virtualNetworkId,
                ipv4AddressType,
        ...
        BinaryData IPersistableModel<NetworkInterfaceUpdate>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkInterfaceUpdate)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        NetworkInterfaceUpdate IPersistableModel<NetworkInterfaceUpdate>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(NetworkInterfaceUpdate)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<NetworkInterfaceUpdate>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
