...
namespace Azure.ResourceManager.ArcScVmm
{
    ...
    public partial class ScVmmAvailabilitySetResource : ArmResource
    {
        ...
        internal ScVmmAvailabilitySetResource(ArmClient client, ScVmmAvailabilitySetData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<ScVmmAvailabilitySetResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new ScVmmAvailabilitySetResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
