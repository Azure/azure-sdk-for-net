...
namespace Azure.ResourceManager.ArcScVmm
{
    ...
    public partial class VirtualMachineInstanceResource : ArmResource
    {
        ...
        {
            _virtualMachineInstanceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ArcScVmm", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets an object representing a VmInstanceHybridIdentityMetadataResource along with the instance operations that can be performed on it in the VirtualMachineInstance. </summary>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, Force? force = null, DeleteFromHost? deleteFromHost = null, CancellationToken cancellationToken = default)
        {
            using var scope = _virtualMachineInstanceClientDiagnostics.CreateScope("VirtualMachineInstanceResource.Delete");
            scope.Start();
            try
            {
                var response = await _virtualMachineInstanceRestClient.DeleteAsync(Id.Parent, force, deleteFromHost, cancellationToken).ConfigureAwait(false);
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateDeleteRequest(Id.Parent, force, deleteFromHost).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        /// <param name="deleteFromHost"> Whether to disable the VM from azure and also delete it from VMM. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation Delete(WaitUntil waitUntil, Force? force = null, DeleteFromHost? deleteFromHost = null, CancellationToken cancellationToken = default)
        {
            using var scope = _virtualMachineInstanceClientDiagnostics.CreateScope("VirtualMachineInstanceResource.Delete");
            scope.Start();
            try
            {
                var response = _virtualMachineInstanceRestClient.Delete(Id.Parent, force, deleteFromHost, cancellationToken);
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateDeleteRequest(Id.Parent, force, deleteFromHost).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<VirtualMachineInstanceResource>> UpdateAsync(WaitUntil waitUntil, VirtualMachineInstancePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcScVmmArmOperation<VirtualMachineInstanceResource>(new VirtualMachineInstanceOperationSource(Client), _virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateUpdateRequest(Id.Parent, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<VirtualMachineInstanceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, VirtualMachineInstanceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcScVmmArmOperation<VirtualMachineInstanceResource>(new VirtualMachineInstanceOperationSource(Client), _virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateCreateOrUpdateRequest(Id.Parent, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation> StopAsync(WaitUntil waitUntil, StopVirtualMachineContent content = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _virtualMachineInstanceRestClient.StopAsync(Id.Parent, content, cancellationToken).ConfigureAwait(false);
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateStopRequest(Id.Parent, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual ArmOperation Stop(WaitUntil waitUntil, StopVirtualMachineContent content = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _virtualMachineInstanceRestClient.Stop(Id.Parent, content, cancellationToken);
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateStopRequest(Id.Parent, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
        ...
        public virtual async Task<ArmOperation> StartAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateStartRequest(Id.Parent).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation> RestartAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateRestartRequest(Id.Parent).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        {
            using var scope = _virtualMachineInstanceClientDiagnostics.CreateScope("VirtualMachineInstanceResource.CreateCheckpoint");
            scope.Start();
            try
            {
                var response = await _virtualMachineInstanceRestClient.CreateCheckpointAsync(Id.Parent, body, cancellationToken).ConfigureAwait(false);
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateCreateCheckpointRequest(Id.Parent, body).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual ArmOperation CreateCheckpoint(WaitUntil waitUntil, VirtualMachineCreateCheckpoint body = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _virtualMachineInstanceRestClient.CreateCheckpoint(Id.Parent, body, cancellationToken);
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateCreateCheckpointRequest(Id.Parent, body).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
        ...
        {
            using var scope = _virtualMachineInstanceClientDiagnostics.CreateScope("VirtualMachineInstanceResource.DeleteCheckpoint");
            scope.Start();
            try
            {
                var response = await _virtualMachineInstanceRestClient.DeleteCheckpointAsync(Id.Parent, body, cancellationToken).ConfigureAwait(false);
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateDeleteCheckpointRequest(Id.Parent, body).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual ArmOperation DeleteCheckpoint(WaitUntil waitUntil, VirtualMachineDeleteCheckpoint body = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _virtualMachineInstanceRestClient.DeleteCheckpoint(Id.Parent, body, cancellationToken);
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateDeleteCheckpointRequest(Id.Parent, body).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
        ...
        {
            using var scope = _virtualMachineInstanceClientDiagnostics.CreateScope("VirtualMachineInstanceResource.RestoreCheckpoint");
            scope.Start();
            try
            {
                var response = await _virtualMachineInstanceRestClient.RestoreCheckpointAsync(Id.Parent, body, cancellationToken).ConfigureAwait(false);
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateRestoreCheckpointRequest(Id.Parent, body).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual ArmOperation RestoreCheckpoint(WaitUntil waitUntil, VirtualMachineRestoreCheckpoint body = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _virtualMachineInstanceRestClient.RestoreCheckpoint(Id.Parent, body, cancellationToken);
                var operation = new ArcScVmmArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateRestoreCheckpointRequest(Id.Parent, body).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    operation.WaitForCompletionResponse(cancellationToken);
                return operation;
