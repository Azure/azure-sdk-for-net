...
namespace Azure.ResourceManager.ArcScVmm
{
    ...
    public partial class GuestAgentResource : ArmResource
    {
        ...
        {
            var resourceId = $"{resourceUri}/providers/Microsoft.ScVmm/virtualMachineInstances/default/guestAgents/default";
        ...
        {
            _guestAgentVmInstanceGuestAgentsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ArcScVmm", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcScVmmArmOperation(response);
        ...
        public virtual async Task<ArmOperation<GuestAgentResource>> CreateOrUpdateAsync(WaitUntil waitUntil, GuestAgentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ArcScVmmArmOperation<GuestAgentResource>(new GuestAgentOperationSource(Client), _guestAgentVmInstanceGuestAgentsClientDiagnostics, Pipeline, _guestAgentVmInstanceGuestAgentsRestClient.CreateCreateRequest(Id.Parent.Parent, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
