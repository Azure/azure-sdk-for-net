...
namespace Azure.ResourceManager.Arc.ScVmm
{
    ...
    public partial class VmMServerResource : ArmResource
    {
        ...
        {
            _vmMServerVmmServersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Arc.ScVmm", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string vmMServerVmmServersApiVersion);
        ...
        /// <summary> Gets a collection of InventoryItemResources in the VmMServer. </summary>
        ...
        {
            using var scope = _vmMServerVmmServersClientDiagnostics.CreateScope("VmMServerResource.Get");
            scope.Start();
            try
            {
                var response = await _vmMServerVmmServersRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<VmMServerResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _vmMServerVmmServersRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new VmMServerResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _vmMServerVmmServersClientDiagnostics.CreateScope("VmMServerResource.Delete");
            scope.Start();
            try
            {
                var response = await _vmMServerVmmServersRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, force, cancellationToken).ConfigureAwait(false);
                var operation = new ScVmmArmOperation(_vmMServerVmmServersClientDiagnostics, Pipeline, _vmMServerVmmServersRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, force).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, bool? force = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _vmMServerVmmServersRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, force, cancellationToken);
                var operation = new ScVmmArmOperation(_vmMServerVmmServersClientDiagnostics, Pipeline, _vmMServerVmmServersRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, force).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<VmMServerResource>> UpdateAsync(WaitUntil waitUntil, ResourcePatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));

            using var scope = _vmMServerVmmServersClientDiagnostics.CreateScope("VmMServerResource.Update");
            scope.Start();
            try
            {
                var response = await _vmMServerVmmServersRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                var operation = new ScVmmArmOperation<VmMServerResource>(new VmMServerOperationSource(Client), _vmMServerVmmServersClientDiagnostics, Pipeline, _vmMServerVmmServersRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<VmMServerResource> Update(WaitUntil waitUntil, ResourcePatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
            ...
            try
            {
                var response = _vmMServerVmmServersRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken);
                var operation = new ScVmmArmOperation<VmMServerResource>(new VmMServerOperationSource(Client), _vmMServerVmmServersClientDiagnostics, Pipeline, _vmMServerVmmServersRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<VmMServerResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _vmMServerVmmServersClientDiagnostics.CreateScope("VmMServerResource.AddTag");
            scope.Start();
            try
            {
                ...
                var originalResponse = await _vmMServerVmmServersRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<VmMServerResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _vmMServerVmmServersRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return Response.FromValue(new VmMServerResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<VmMServerResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _vmMServerVmmServersClientDiagnostics.CreateScope("VmMServerResource.SetTags");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<VmMServerResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _vmMServerVmmServersClientDiagnostics.CreateScope("VmMServerResource.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await GetTagResource().GetAsync(cancellationToken).ConfigureAwait(false);
