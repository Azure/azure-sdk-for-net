...
{
    /// <summary> A class representing the VmMServer data model. </summary>
    public partial class VmMServerData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of VmMServerData. </summary>
        ...
        public VmMServerData(AzureLocation location, ExtendedLocation extendedLocation, string fqdn) : base(location)
        {
