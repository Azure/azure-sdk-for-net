...
namespace Azure.ResourceManager.Arc.ScVmm
{
    ...
    /// Each <see cref="InventoryItemResource" /> in the collection will belong to the same instance of <see cref="VmMServerResource" />.
    /// To get an <see cref="InventoryItemCollection" /> instance call the GetInventoryItems method from an instance of <see cref="VmMServerResource" />.
    /// </summary>
    public partial class InventoryItemCollection : ArmCollection, IEnumerable<InventoryItemResource>, IAsyncEnumerable<InventoryItemResource>
    {
        ...
        {
            _inventoryItemClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Arc.ScVmm", InventoryItemResource.ResourceType.Namespace, Diagnostics);
