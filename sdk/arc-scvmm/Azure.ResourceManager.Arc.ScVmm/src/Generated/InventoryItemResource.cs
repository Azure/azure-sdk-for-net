...
namespace Azure.ResourceManager.Arc.ScVmm
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="VmMServerResource" /> using the GetInventoryItem method.
    /// </summary>
    public partial class InventoryItemResource : ArmResource
    {
        ...
        {
            _inventoryItemClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Arc.ScVmm", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<InventoryItemResource>> UpdateAsync(WaitUntil waitUntil, InventoryItemData data = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ScVmmArmOperation<InventoryItemResource>(Response.FromValue(new InventoryItemResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
