...
{
    /// <summary> A class representing the Cloud data model. </summary>
    public partial class CloudData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of CloudData. </summary>
        ...
        public CloudData(AzureLocation location, ExtendedLocation extendedLocation) : base(location)
        {
