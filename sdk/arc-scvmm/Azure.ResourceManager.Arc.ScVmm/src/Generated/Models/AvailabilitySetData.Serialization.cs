...
namespace Azure.ResourceManager.Arc.ScVmm
{
    public partial class AvailabilitySetData : IUtf8JsonSerializable
    {
        ...
        internal static AvailabilitySetData DeserializeAvailabilitySetData(JsonElement element)
        {
            ...
            return new AvailabilitySetData(id, name, type, systemData, tags, location, extendedLocation.Value, availabilitySetName.Value, vmmServerId.Value, provisioningState.Value);
        }
    }
}
