...
namespace Azure.ResourceManager.Arc.ScVmm
{
    public partial class VirtualMachineData : IUtf8JsonSerializable
    {
        ...
        internal static VirtualMachineData DeserializeVirtualMachineData(JsonElement element)
        {
            ...
            return new VirtualMachineData(id, name, type, systemData, tags, location, extendedLocation, inventoryItemId.Value, vmmServerId.Value, cloudId.Value, templateId.Value, checkpointType.Value, Optional.ToList(checkpoints), Optional.ToList(availabilitySets), osProfile.Value, hardwareProfile.Value, networkProfile.Value, storageProfile.Value, vmName.Value, uuid.Value, Optional.ToNullable(generation), powerState.Value, provisioningState.Value);
        }
    }
}
