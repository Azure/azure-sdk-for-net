...
namespace Azure.ResourceManager.Arc.ScVmm
{
    public partial class VirtualNetworkData : IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetworkData DeserializeVirtualNetworkData(JsonElement element)
        {
            ...
            return new VirtualNetworkData(id, name, type, systemData, tags, location, extendedLocation, inventoryItemId.Value, uuid.Value, vmmServerId.Value, networkName.Value, provisioningState.Value);
        }
    }
}
