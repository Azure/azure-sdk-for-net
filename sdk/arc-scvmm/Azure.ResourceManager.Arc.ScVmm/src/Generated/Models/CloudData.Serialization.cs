...
{
    public partial class CloudData : IUtf8JsonSerializable
    {
        ...
        internal static CloudData DeserializeCloudData(JsonElement element)
        {
            ...
            return new CloudData(id, name, type, systemData, tags, location, extendedLocation, inventoryItemId.Value, uuid.Value, vmmServerId.Value, cloudName.Value, cloudCapacity.Value, Optional.ToList(storageQoSPolicies), provisioningState.Value);
        }
    }
}
