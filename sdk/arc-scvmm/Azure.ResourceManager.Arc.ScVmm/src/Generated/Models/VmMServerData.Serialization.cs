...
{
    public partial class VmMServerData : IUtf8JsonSerializable
    {
        ...
        internal static VmMServerData DeserializeVmMServerData(JsonElement element)
        {
            ...
            return new VmMServerData(id, name, type, systemData, tags, location, extendedLocation, credentials.Value, fqdn, Optional.ToNullable(port), connectionStatus.Value, errorMessage.Value, uuid.Value, version.Value, provisioningState.Value);
        }
    }
}
