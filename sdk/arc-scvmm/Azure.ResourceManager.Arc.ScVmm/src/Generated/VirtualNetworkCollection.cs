...
namespace Azure.ResourceManager.Arc.ScVmm
{
    ...
    public partial class VirtualNetworkCollection : ArmCollection, IEnumerable<VirtualNetworkResource>, IAsyncEnumerable<VirtualNetworkResource>
    {
        ...
        {
            _virtualNetworkClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Arc.ScVmm", VirtualNetworkResource.ResourceType.Namespace, Diagnostics);
