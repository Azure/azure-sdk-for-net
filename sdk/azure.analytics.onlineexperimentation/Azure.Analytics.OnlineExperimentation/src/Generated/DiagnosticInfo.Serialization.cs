...
{
    public partial class DiagnosticInfo : IUtf8JsonSerializable, IJsonModel<DiagnosticInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiagnosticInfo>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<DiagnosticInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        DiagnosticInfo IJsonModel<DiagnosticInfo>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DiagnosticInfo>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<DiagnosticInfo>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DiagnosticInfo>)this).GetFormatFromOptions(options) : options.Format;
        ...
        DiagnosticInfo IPersistableModel<DiagnosticInfo>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<DiagnosticInfo>)this).GetFormatFromOptions(options) : options.Format;
