...
{
    public partial class AverageDefinition : IUtf8JsonSerializable, IJsonModel<AverageDefinition>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AverageDefinition>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<AverageDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<AverageDefinition>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        AverageDefinition IJsonModel<AverageDefinition>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AverageDefinition>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<AverageDefinition>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AverageDefinition>)this).GetFormatFromOptions(options) : options.Format;
        ...
        AverageDefinition IPersistableModel<AverageDefinition>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AverageDefinition>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<AverageDefinition>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
