...
namespace Azure.ResourceManager.SecurityDevOps
{
    ...
    public partial class GitHubConnectorResource : ArmResource
    {
        ...
        private readonly ClientDiagnostics _gitHubConnectorStatsClientDiagnostics;
        ...
        internal GitHubConnectorResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _gitHubConnectorClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SecurityDevOps", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string gitHubConnectorApiVersion);
            ...
            _gitHubConnectorStatsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SecurityDevOps", ProviderConstants.DefaultProviderNamespace, Diagnostics);
            _gitHubConnectorStatsRestClient = new GitHubConnectorStatsRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint);
#if DEBUG
        ...
        public virtual GitHubConnectorData Data
        {
            get
            {
                if (!HasData)
        ...
        /// <summary> Gets a collection of GitHubOwnerResources in the GitHubConnector. </summary>
        ...
        {
            return await GetGitHubOwners().GetAsync(gitHubOwnerName, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetGitHubOwners().Get(gitHubOwnerName, cancellationToken);
        }
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<GitHubConnectorResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _gitHubConnectorClientDiagnostics.CreateScope("GitHubConnectorResource.Get");
            scope.Start();
            try
            {
                var response = await _gitHubConnectorRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<GitHubConnectorResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _gitHubConnectorClientDiagnostics.CreateScope("GitHubConnectorResource.Get");
            scope.Start();
            try
            {
                var response = _gitHubConnectorRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new GitHubConnectorResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _gitHubConnectorClientDiagnostics.CreateScope("GitHubConnectorResource.Delete");
            scope.Start();
            try
            {
                var response = await _gitHubConnectorRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new SecurityDevOpsArmOperation(_gitHubConnectorClientDiagnostics, Pipeline, _gitHubConnectorRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _gitHubConnectorRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                var operation = new SecurityDevOpsArmOperation(_gitHubConnectorClientDiagnostics, Pipeline, _gitHubConnectorRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<GitHubConnectorResource>> UpdateAsync(WaitUntil waitUntil, GitHubConnectorData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _gitHubConnectorRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken).ConfigureAwait(false);
                var operation = new SecurityDevOpsArmOperation<GitHubConnectorResource>(new GitHubConnectorOperationSource(Client), _gitHubConnectorClientDiagnostics, Pipeline, _gitHubConnectorRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<GitHubConnectorResource> Update(WaitUntil waitUntil, GitHubConnectorData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _gitHubConnectorRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data, cancellationToken);
                var operation = new SecurityDevOpsArmOperation<GitHubConnectorResource>(new GitHubConnectorOperationSource(Client), _gitHubConnectorClientDiagnostics, Pipeline, _gitHubConnectorRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, data).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityDevOps/gitHubConnectors/{gitHubConnectorName}/repos</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityDevOps/gitHubConnectors/{gitHubConnectorName}/stats</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        public virtual async Task<Response<GitHubConnectorResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _gitHubConnectorRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                    return Response.FromValue(new GitHubConnectorResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
                    var current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    var patch = new GitHubConnectorData(current.Location);
        ...
        public virtual Response<GitHubConnectorResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _gitHubConnectorRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                    return Response.FromValue(new GitHubConnectorResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
