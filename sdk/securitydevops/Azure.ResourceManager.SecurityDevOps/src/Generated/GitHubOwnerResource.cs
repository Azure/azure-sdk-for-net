    ...
    public partial class GitHubOwnerResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<GitHubOwnerResource>> UpdateAsync(WaitUntil waitUntil, GitHubOwnerData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new SecurityDevOpsArmOperation<GitHubOwnerResource>(new GitHubOwnerOperationSource(Client), _gitHubOwnerClientDiagnostics, Pipeline, _gitHubOwnerRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, Core.OperationFinalStateVia.Location);
