...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    public static partial class ArmSecurityDevOpsModelFactory
    {
        ...
        public static AzureDevOpsConnectorData AzureDevOpsConnectorData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, AzureDevOpsConnectorProperties properties = null)
        {
            ...
            return new AzureDevOpsConnectorData(id, name, resourceType, systemData, tags, location, properties, default);
        }
        ...
        {
            return new AzureDevOpsRepoData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AzureDevOpsConnectorStats(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AzureDevOpsOrgData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new AzureDevOpsProjectData(id, name, resourceType, systemData, properties, default);
        }
        ...
        public static GitHubConnectorData GitHubConnectorData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, GitHubConnectorProperties properties = null)
        {
            ...
            return new GitHubConnectorData(id, name, resourceType, systemData, tags, location, properties, default);
        }
        ...
        {
            return new GitHubRepoData(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new GitHubConnectorStats(id, name, resourceType, systemData, properties, default);
        }
        ...
        {
            return new GitHubOwnerData(id, name, resourceType, systemData, properties, default);
        }
    }
}
