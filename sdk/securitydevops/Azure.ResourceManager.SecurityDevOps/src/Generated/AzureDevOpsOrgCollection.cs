...
namespace Azure.ResourceManager.SecurityDevOps
{
    ...
    public partial class AzureDevOpsOrgCollection : ArmCollection, IEnumerable<AzureDevOpsOrgResource>, IAsyncEnumerable<AzureDevOpsOrgResource>
    {
        ...
        {
            _azureDevOpsOrgClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SecurityDevOps", AzureDevOpsOrgResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(AzureDevOpsOrgResource.ResourceType, out string azureDevOpsOrgApiVersion);
            _azureDevOpsOrgRestClient = new AzureDevOpsOrgRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, azureDevOpsOrgApiVersion);
#if DEBUG
        ...
        {
            if (id.ResourceType != AzureDevOpsConnectorResource.ResourceType)
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, "Invalid resource type {0} expected {1}", id.ResourceType, AzureDevOpsConnectorResource.ResourceType), nameof(id));
        }
        ...
        /// <description>AzureDevOpsOrg_CreateOrUpdate</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response<AzureDevOpsOrgResource>> GetAsync(string azureDevOpsOrgName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _azureDevOpsOrgRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, azureDevOpsOrgName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AzureDevOpsOrgResource> Get(string azureDevOpsOrgName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _azureDevOpsOrgRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, azureDevOpsOrgName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new AzureDevOpsOrgResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.SecurityDevOps/azureDevOpsConnectors/{azureDevOpsConnectorName}/orgs</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>AzureDevOpsOrg_List</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
