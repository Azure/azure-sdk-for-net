...
namespace Azure.ResourceManager.SecurityDevOps
{
    ...
    public partial class AzureDevOpsProjectData : ResourceData
    {
        ...
        internal AzureDevOpsProjectData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureDevOpsProjectProperties properties, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
