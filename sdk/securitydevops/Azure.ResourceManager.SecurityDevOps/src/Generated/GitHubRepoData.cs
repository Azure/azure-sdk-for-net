...
namespace Azure.ResourceManager.SecurityDevOps
{
    ...
    public partial class GitHubRepoData : ResourceData
    {
        ...
        internal GitHubRepoData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, GitHubRepoProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
