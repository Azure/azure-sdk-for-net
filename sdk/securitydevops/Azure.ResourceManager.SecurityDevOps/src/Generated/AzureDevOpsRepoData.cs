...
namespace Azure.ResourceManager.SecurityDevOps
{
    ...
    public partial class AzureDevOpsRepoData : ResourceData
    {
        ...
        internal AzureDevOpsRepoData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureDevOpsRepoProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
