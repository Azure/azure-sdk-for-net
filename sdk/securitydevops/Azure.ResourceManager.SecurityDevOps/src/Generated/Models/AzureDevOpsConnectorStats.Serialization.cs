...
{
    public partial class AzureDevOpsConnectorStats : IUtf8JsonSerializable
    {
        ...
        internal static AzureDevOpsConnectorStats DeserializeAzureDevOpsConnectorStats(JsonElement element)
        {
            ...
            return new AzureDevOpsConnectorStats(id, name, type, systemData.Value, properties.Value);
        }
    }
}
