...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    public partial class AzureDevOpsOrgMetadata : IUtf8JsonSerializable, IJsonModel<AzureDevOpsOrgMetadata>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureDevOpsOrgMetadata>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureDevOpsOrgMetadata>)} interface");
            }
