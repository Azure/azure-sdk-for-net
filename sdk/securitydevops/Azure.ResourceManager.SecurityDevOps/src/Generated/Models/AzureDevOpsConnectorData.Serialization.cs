...
{
    public partial class AzureDevOpsConnectorData : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureDevOpsConnectorData DeserializeAzureDevOpsConnectorData(JsonElement element)
        {
            ...
            Core.Optional<AzureDevOpsConnectorProperties> properties = default;
            ...
            return new AzureDevOpsConnectorData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, properties.Value);
        }
    }
}
