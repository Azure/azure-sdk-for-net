...
namespace Azure.ResourceManager.SecurityDevOps
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDevOpsConnectorData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureDevOpsConnectorData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureDevOpsConnectorData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureDevOpsConnectorData>)} interface");
            }
        ...
        string IPersistableModel<AzureDevOpsConnectorData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
