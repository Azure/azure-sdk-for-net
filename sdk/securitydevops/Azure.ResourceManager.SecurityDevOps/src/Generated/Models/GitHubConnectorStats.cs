...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    public partial class GitHubConnectorStats : ResourceData
    {
        ...
        internal GitHubConnectorStats(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, GitHubConnectorStatsProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
