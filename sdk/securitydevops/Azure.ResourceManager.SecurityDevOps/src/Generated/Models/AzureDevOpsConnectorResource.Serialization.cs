...
namespace Azure.ResourceManager.SecurityDevOps
{
    public partial class AzureDevOpsConnectorResource : IJsonModel<AzureDevOpsConnectorData>
    {
        ...
        {
            return ModelReaderWriter.Read<AzureDevOpsConnectorData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AzureDevOpsConnectorData>(data, options);
        }
