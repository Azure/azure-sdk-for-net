...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    internal partial class AzureDevOpsConnectorListResponse : IUtf8JsonSerializable, IJsonModel<AzureDevOpsConnectorListResponse>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureDevOpsConnectorListResponse)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<AzureDevOpsConnectorData>)item).Write(writer, options);
                }
        ...
        AzureDevOpsConnectorListResponse IJsonModel<AzureDevOpsConnectorListResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureDevOpsConnectorListResponse)} does not support reading '{format}' format.");
            }
        ...
        internal static AzureDevOpsConnectorListResponse DeserializeAzureDevOpsConnectorListResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<AzureDevOpsConnectorData> value = default;
            ...
            return new AzureDevOpsConnectorListResponse(value ?? new ChangeTrackingList<AzureDevOpsConnectorData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AzureDevOpsConnectorListResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureDevOpsConnectorListResponse)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AzureDevOpsConnectorListResponse IPersistableModel<AzureDevOpsConnectorListResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureDevOpsConnectorListResponse)} does not support reading '{options.Format}' format.");
            }
        }
