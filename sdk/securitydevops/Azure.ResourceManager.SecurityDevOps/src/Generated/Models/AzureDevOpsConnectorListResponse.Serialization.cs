...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    {
        internal static AzureDevOpsConnectorListResponse DeserializeAzureDevOpsConnectorListResponse(JsonElement element)
        {
            ...
            return new AzureDevOpsConnectorListResponse(Optional.ToList(value), nextLink.Value);
        }
    }
}
