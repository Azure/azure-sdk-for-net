...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    public partial class AzureDevOpsRepoProperties
    {
        ...
        internal AzureDevOpsRepoProperties(ProvisioningState? provisioningState, string repoId, Uri repoUri, string orgName, string projectName, string visibility, ActionableRemediation actionableRemediation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
