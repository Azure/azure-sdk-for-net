...
{
    public partial class AzureDevOpsConnectorStatsProperties : IUtf8JsonSerializable, IJsonModel<AzureDevOpsConnectorStatsProperties>, IPersistableModel<AzureDevOpsConnectorStatsProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OrgsCount))
            {
                builder.Append("  orgsCount:");
                builder.AppendLine($" '{OrgsCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(ProjectsCount))
            {
                builder.Append("  projectsCount:");
                builder.AppendLine($" '{ProjectsCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(ReposCount))
            {
                builder.Append("  reposCount:");
                builder.AppendLine($" '{ReposCount.Value.ToString()}'");
            }
