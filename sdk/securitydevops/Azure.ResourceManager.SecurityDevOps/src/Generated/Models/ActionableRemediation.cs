...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    public partial class ActionableRemediation
    {
        ...
        internal ActionableRemediation(ActionableRemediationState? state, IList<string> severityLevels, IList<ActionableRemediationRuleCategory> categories, TargetBranchConfiguration branchConfiguration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
