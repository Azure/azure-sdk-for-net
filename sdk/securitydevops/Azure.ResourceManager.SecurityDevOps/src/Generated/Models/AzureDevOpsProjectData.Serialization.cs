...
namespace Azure.ResourceManager.SecurityDevOps
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDevOpsProjectData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AzureDevOpsProjectData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AzureDevOpsProjectData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AzureDevOpsProjectData>)} interface");
            }
        ...
        string IPersistableModel<AzureDevOpsProjectData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
