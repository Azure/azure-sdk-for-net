...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDevOpsConnectorStatsListResponse>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        AzureDevOpsConnectorStatsListResponse IJsonModel<AzureDevOpsConnectorStatsListResponse>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureDevOpsConnectorStatsListResponse)} does not support reading '{format}' format.");
            }
        ...
        internal static AzureDevOpsConnectorStatsListResponse DeserializeAzureDevOpsConnectorStatsListResponse(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AzureDevOpsConnectorStatsListResponse(value ?? new ChangeTrackingList<AzureDevOpsConnectorStats>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AzureDevOpsConnectorStatsListResponse>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureDevOpsConnectorStatsListResponse)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AzureDevOpsConnectorStatsListResponse IPersistableModel<AzureDevOpsConnectorStatsListResponse>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureDevOpsConnectorStatsListResponse)} does not support reading '{options.Format}' format.");
            }
        }
