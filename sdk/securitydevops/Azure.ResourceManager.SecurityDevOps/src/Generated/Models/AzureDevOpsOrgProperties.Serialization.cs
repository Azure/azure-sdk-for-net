...
{
    public partial class AzureDevOpsOrgProperties : Core.IUtf8JsonSerializable
    {
        ...
        internal static AzureDevOpsOrgProperties DeserializeAzureDevOpsOrgProperties(JsonElement element)
        {
            ...
            return new AzureDevOpsOrgProperties(Core.Optional.ToNullable(provisioningState), Core.Optional.ToNullable(autoDiscovery));
        }
    }
}
