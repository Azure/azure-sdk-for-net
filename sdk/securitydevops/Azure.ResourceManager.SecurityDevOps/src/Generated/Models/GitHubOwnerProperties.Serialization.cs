...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GitHubOwnerProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GitHubOwnerProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GitHubOwnerProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GitHubOwnerProperties>)} interface");
            }
        ...
        string IPersistableModel<GitHubOwnerProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
