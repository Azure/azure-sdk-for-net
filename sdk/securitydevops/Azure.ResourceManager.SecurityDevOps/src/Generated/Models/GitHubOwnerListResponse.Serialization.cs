...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GitHubOwnerListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GitHubOwnerListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GitHubOwnerListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GitHubOwnerListResponse>)} interface");
            }
        ...
        string IPersistableModel<GitHubOwnerListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
