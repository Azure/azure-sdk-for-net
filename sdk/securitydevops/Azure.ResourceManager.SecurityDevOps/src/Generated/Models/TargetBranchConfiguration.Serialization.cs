...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    internal partial class TargetBranchConfiguration : IUtf8JsonSerializable, IJsonModel<TargetBranchConfiguration>
    {
        ...
        void IJsonModel<TargetBranchConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(TargetBranchConfiguration)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<TargetBranchConfiguration>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(TargetBranchConfiguration)} does not support '{options.Format}' format.");
            }
        }
