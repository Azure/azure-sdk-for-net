...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GitHubConnectorProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GitHubConnectorProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GitHubConnectorProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GitHubConnectorProperties>)} interface");
            }
        ...
        string IPersistableModel<GitHubConnectorProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
