...
{
    public partial class GitHubConnectorProperties : IUtf8JsonSerializable, IJsonModel<GitHubConnectorProperties>, IPersistableModel<GitHubConnectorProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GitHubConnectorProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<GitHubConnectorProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GitHubConnectorProperties)} does not support '{format}' format.");
            }
