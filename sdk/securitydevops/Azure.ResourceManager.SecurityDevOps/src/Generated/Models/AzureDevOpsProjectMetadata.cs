...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    public partial class AzureDevOpsProjectMetadata
    {
        ...
        internal AzureDevOpsProjectMetadata(string name, AutoDiscovery? autoDiscovery, IList<string> repos, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
