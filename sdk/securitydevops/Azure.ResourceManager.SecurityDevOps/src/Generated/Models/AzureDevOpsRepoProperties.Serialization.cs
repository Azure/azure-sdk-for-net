...
{
    public partial class AzureDevOpsRepoProperties : IUtf8JsonSerializable, IJsonModel<AzureDevOpsRepoProperties>, IPersistableModel<AzureDevOpsRepoProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActionableRemediation))
            {
                ...
                AppendChildObject(builder, ActionableRemediation, options, 2);
            }
