...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GitHubConnectorStatsListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GitHubConnectorStatsListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GitHubConnectorStatsListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GitHubConnectorStatsListResponse>)} interface");
            }
        ...
        string IPersistableModel<GitHubConnectorStatsListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
