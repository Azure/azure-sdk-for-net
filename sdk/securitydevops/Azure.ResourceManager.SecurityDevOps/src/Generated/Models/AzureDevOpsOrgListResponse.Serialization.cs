...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    {
        internal static AzureDevOpsOrgListResponse DeserializeAzureDevOpsOrgListResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
