...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AuthorizationInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AuthorizationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AuthorizationInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AuthorizationInfo>)} interface");
            }
        ...
        string IPersistableModel<AuthorizationInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
