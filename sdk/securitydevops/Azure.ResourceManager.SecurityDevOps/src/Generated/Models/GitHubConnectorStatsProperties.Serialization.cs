...
{
    public partial class GitHubConnectorStatsProperties : IUtf8JsonSerializable, IJsonModel<GitHubConnectorStatsProperties>, IPersistableModel<GitHubConnectorStatsProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OwnersCount))
            {
                builder.Append("  ownersCount:");
                builder.AppendLine($" '{OwnersCount.Value.ToString()}'");
            }
