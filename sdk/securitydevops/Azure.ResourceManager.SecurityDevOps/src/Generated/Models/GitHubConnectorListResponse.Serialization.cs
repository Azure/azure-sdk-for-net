...
namespace Azure.ResourceManager.SecurityDevOps.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GitHubConnectorListResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GitHubConnectorListResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GitHubConnectorListResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GitHubConnectorListResponse>)} interface");
            }
        ...
        string IPersistableModel<GitHubConnectorListResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
