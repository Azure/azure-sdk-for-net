...
namespace Azure.ResourceManager.SecurityDevOps
{
    ...
    /// If you have a <see cref="ResourceIdentifier" /> you can construct an <see cref="AzureDevOpsRepoResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetAzureDevOpsRepoResource method.
    /// Otherwise you can get one from its parent resource <see cref="AzureDevOpsProjectResource" /> using the GetAzureDevOpsRepo method.
    /// </summary>
    public partial class AzureDevOpsRepoResource : ArmResource
    {
        ...
        internal AzureDevOpsRepoResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _azureDevOpsRepoClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.SecurityDevOps", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string azureDevOpsRepoApiVersion);
        ...
        public virtual AzureDevOpsRepoData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<AzureDevOpsRepoResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _azureDevOpsRepoClientDiagnostics.CreateScope("AzureDevOpsRepoResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<AzureDevOpsRepoResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _azureDevOpsRepoClientDiagnostics.CreateScope("AzureDevOpsRepoResource.Get");
            scope.Start();
            try
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>AzureDevOpsRepo_Update</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<ArmOperation<AzureDevOpsRepoResource>> UpdateAsync(WaitUntil waitUntil, AzureDevOpsRepoData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _azureDevOpsRepoClientDiagnostics.CreateScope("AzureDevOpsRepoResource.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<AzureDevOpsRepoResource> Update(WaitUntil waitUntil, AzureDevOpsRepoData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
