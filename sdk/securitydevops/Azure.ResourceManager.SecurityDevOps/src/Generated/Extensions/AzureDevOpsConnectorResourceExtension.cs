...
namespace Azure.ResourceManager.SecurityDevOps.Mock
{
    ...
    public partial class AzureDevOpsConnectorResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AzureDevOpsConnectorResourceExtension"/> class for mocking. </summary>
        protected AzureDevOpsConnectorResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AzureDevOpsConnectorResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AzureDevOpsConnectorResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AzureDevOpsConnectorResource> GetAzureDevOpsConnectorsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new AzureDevOpsConnectorResource(Client, AzureDevOpsConnectorData.DeserializeAzureDevOpsConnectorData(e)), AzureDevOpsConnectorClientDiagnostics, Pipeline, "AzureDevOpsConnectorResourceExtension.GetAzureDevOpsConnectors", "value", "nextLink", cancellationToken);
        }
