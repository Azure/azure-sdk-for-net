...
namespace Azure.ResourceManager.SecurityDevOps.Mocking
{
    ...
    internal partial class SecurityDevOpsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SecurityDevOpsArmClientMockingExtension"/> class for mocking. </summary>
        protected SecurityDevOpsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SecurityDevOpsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SecurityDevOpsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal SecurityDevOpsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
