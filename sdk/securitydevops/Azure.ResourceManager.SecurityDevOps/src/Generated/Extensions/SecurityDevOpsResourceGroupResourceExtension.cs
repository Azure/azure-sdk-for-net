...
namespace Azure.ResourceManager.SecurityDevOps.Mock
{
    ...
    public partial class SecurityDevOpsResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="SecurityDevOpsResourceGroupResourceExtension"/> class for mocking. </summary>
        protected SecurityDevOpsResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="SecurityDevOpsResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal SecurityDevOpsResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
