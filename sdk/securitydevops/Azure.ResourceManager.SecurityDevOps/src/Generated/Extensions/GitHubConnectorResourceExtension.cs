...
{
    /// <summary> A class to add extension methods to GitHubConnectorResource. </summary>
    public partial class GitHubConnectorResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="GitHubConnectorResourceExtension"/> class for mocking. </summary>
        protected GitHubConnectorResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="GitHubConnectorResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal GitHubConnectorResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics GitHubConnectorClientDiagnostics => _gitHubConnectorClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.SecurityDevOps.Mock", GitHubConnectorResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual AsyncPageable<GitHubConnectorResource> GetGitHubConnectorsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new GitHubConnectorResource(Client, GitHubConnectorData.DeserializeGitHubConnectorData(e)), GitHubConnectorClientDiagnostics, Pipeline, "GitHubConnectorResourceExtension.GetGitHubConnectors", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<GitHubConnectorResource> GetGitHubConnectors(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => GitHubConnectorRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => GitHubConnectorRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new GitHubConnectorResource(Client, GitHubConnectorData.DeserializeGitHubConnectorData(e)), GitHubConnectorClientDiagnostics, Pipeline, "GitHubConnectorResourceExtension.GetGitHubConnectors", "value", "nextLink", cancellationToken);
        }
    }
}
