...
namespace Azure.ResourceManager.SecurityDevOps
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDevOpsConnectorData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureDevOpsConnectorData)} does not support writing '{format}' format.");
            }
        ...
        AzureDevOpsConnectorData IJsonModel<AzureDevOpsConnectorData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureDevOpsConnectorData)} does not support reading '{format}' format.");
            }
        ...
        internal static AzureDevOpsConnectorData DeserializeAzureDevOpsConnectorData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            AzureDevOpsConnectorProperties properties = default;
        ...
        BinaryData IPersistableModel<AzureDevOpsConnectorData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureDevOpsConnectorData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AzureDevOpsConnectorData IPersistableModel<AzureDevOpsConnectorData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureDevOpsConnectorData)} does not support reading '{options.Format}' format.");
            }
        }
