...
namespace Azure.ResourceManager.SecurityDevOps
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AzureDevOpsRepoData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureDevOpsRepoData)} does not support writing '{format}' format.");
            }
        ...
        AzureDevOpsRepoData IJsonModel<AzureDevOpsRepoData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AzureDevOpsRepoData)} does not support reading '{format}' format.");
            }
        ...
        internal static AzureDevOpsRepoData DeserializeAzureDevOpsRepoData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            AzureDevOpsRepoProperties properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Models.SystemData>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(property.Value).ToArray()), global::Azure.ResourceManager.SecurityDevOps.ModelSerializationExtensions.WireOptions, AzureResourceManagerSecurityDevOpsContext.Default)
#else
                ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(property.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerSecurityDevOpsContext.Default)
#endif
;
                    continue;
                }
        ...
        BinaryData IPersistableModel<AzureDevOpsRepoData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureDevOpsRepoData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AzureDevOpsRepoData IPersistableModel<AzureDevOpsRepoData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AzureDevOpsRepoData)} does not support reading '{options.Format}' format.");
            }
        }
