...
namespace Azure.ResourceManager.SecurityDevOps
{
    public partial class AzureDevOpsProjectResource : IJsonModel<AzureDevOpsProjectData>
    {
        ...
        {
            return ModelReaderWriter.Read<AzureDevOpsProjectData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<AzureDevOpsProjectData>(data, options);
        }
