...
namespace Azure.ResourceManager.StoragePool.Mocking
{
    ...
    internal partial class StoragePoolResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="StoragePoolResourceGroupMockingExtension"/> class for mocking. </summary>
        protected StoragePoolResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="StoragePoolResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StoragePoolResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
