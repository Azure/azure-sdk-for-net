...
namespace Azure.ResourceManager.StoragePool.Mock
{
    ...
    public partial class DiskPoolResourceExtension : ArmResource
    {
        private ClientDiagnostics _diskPoolClientDiagnostics;
        private DiskPoolsRestOperations _diskPoolRestClient;

        /// <summary> Initializes a new instance of the <see cref="DiskPoolResourceExtension"/> class for mocking. </summary>
        protected DiskPoolResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DiskPoolResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DiskPoolResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<DiskPoolResource> GetDiskPoolsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DiskPoolResource(Client, DiskPoolData.DeserializeDiskPoolData(e)), DiskPoolClientDiagnostics, Pipeline, "DiskPoolResourceExtension.GetDiskPools", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DiskPoolResource> GetDiskPools(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => DiskPoolRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => DiskPoolRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DiskPoolResource(Client, DiskPoolData.DeserializeDiskPoolData(e)), DiskPoolClientDiagnostics, Pipeline, "DiskPoolResourceExtension.GetDiskPools", "value", "nextLink", cancellationToken);
        }
    }
}
