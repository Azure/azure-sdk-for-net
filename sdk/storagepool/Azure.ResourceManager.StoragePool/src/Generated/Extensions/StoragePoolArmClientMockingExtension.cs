...
namespace Azure.ResourceManager.StoragePool.Mocking
{
    ...
    internal partial class StoragePoolArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="StoragePoolArmClientMockingExtension"/> class for mocking. </summary>
        protected StoragePoolArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="StoragePoolArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal StoragePoolArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal StoragePoolArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
