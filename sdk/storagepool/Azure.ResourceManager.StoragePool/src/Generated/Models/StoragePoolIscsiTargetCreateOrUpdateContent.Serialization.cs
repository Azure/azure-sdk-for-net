...
{
    public partial class StoragePoolIscsiTargetCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static StoragePoolIscsiTargetCreateOrUpdateContent DeserializeStoragePoolIscsiTargetCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new StoragePoolIscsiTargetCreateOrUpdateContent(id, name, type, systemData.Value, managedBy.Value, Optional.ToList(managedByExtended), aclMode, targetIqn.Value, Optional.ToList(staticAcls), Optional.ToList(luns));
        }
    }
}
