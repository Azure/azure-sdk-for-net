...
{
    public partial class StoragePoolSkuLocationInfo : IUtf8JsonSerializable, IJsonModel<StoragePoolSkuLocationInfo>, IPersistableModel<StoragePoolSkuLocationInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StoragePoolSkuLocationInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<StoragePoolSkuLocationInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StoragePoolSkuLocationInfo)} does not support '{format}' format.");
            }
