...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        internal static StoragePoolSkuLocationInfo DeserializeStoragePoolSkuLocationInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
