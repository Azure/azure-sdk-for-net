...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class DiskPoolZoneInfo
    {
        ...
        internal DiskPoolZoneInfo(IReadOnlyList<string> availabilityZones, IReadOnlyList<string> additionalCapabilities, StoragePoolSku sku, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
