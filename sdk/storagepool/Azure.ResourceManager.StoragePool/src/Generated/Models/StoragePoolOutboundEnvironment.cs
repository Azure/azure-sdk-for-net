...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class StoragePoolOutboundEnvironment
    {
        ...
        internal StoragePoolOutboundEnvironment(string category, IReadOnlyList<OutboundEndpointDependency> endpoints, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
            Endpoints = endpoints;
