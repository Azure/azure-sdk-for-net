...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class StoragePoolIscsiTargetCreateOrUpdateContent : ResourceData
    {
        /// <summary> Initializes a new instance of StoragePoolIscsiTargetCreateOrUpdateContent. </summary>
        /// <param name="aclMode"> Mode for Target connectivity. </param>
        public StoragePoolIscsiTargetCreateOrUpdateContent(IscsiTargetAclMode aclMode)
        {
        ...
        internal StoragePoolIscsiTargetCreateOrUpdateContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string managedBy, IList<string> managedByExtended, IscsiTargetAclMode aclMode, string targetIqn, IList<Acl> staticAcls, IList<ManagedDiskIscsiLun> luns) : base(id, name, resourceType, systemData)
        {
            ManagedBy = managedBy;
