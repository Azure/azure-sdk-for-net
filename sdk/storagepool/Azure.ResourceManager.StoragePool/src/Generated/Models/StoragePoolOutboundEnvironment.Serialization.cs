...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StoragePoolOutboundEnvironment>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        StoragePoolOutboundEnvironment IJsonModel<StoragePoolOutboundEnvironment>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<StoragePoolOutboundEnvironment>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        StoragePoolOutboundEnvironment IModel<StoragePoolOutboundEnvironment>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<StoragePoolOutboundEnvironment>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
