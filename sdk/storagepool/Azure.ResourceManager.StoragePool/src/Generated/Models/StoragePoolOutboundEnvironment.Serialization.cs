...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StoragePoolOutboundEnvironment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StoragePoolOutboundEnvironment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StoragePoolOutboundEnvironment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StoragePoolOutboundEnvironment>)} interface");
            }
        ...
        string IPersistableModel<StoragePoolOutboundEnvironment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
