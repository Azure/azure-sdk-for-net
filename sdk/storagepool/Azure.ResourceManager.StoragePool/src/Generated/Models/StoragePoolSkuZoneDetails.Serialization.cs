...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        internal static StoragePoolSkuZoneDetails DeserializeStoragePoolSkuZoneDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
