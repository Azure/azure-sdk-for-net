...
namespace Azure.ResourceManager.StoragePool.Models
{
    public partial class StoragePoolSkuZoneDetails : IUtf8JsonSerializable, IJsonModel<StoragePoolSkuZoneDetails>
    {
        ...
        void IJsonModel<StoragePoolSkuZoneDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(StoragePoolSkuZoneDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StoragePoolSkuZoneDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(StoragePoolSkuZoneDetails)} does not support '{options.Format}' format.");
            }
        }
