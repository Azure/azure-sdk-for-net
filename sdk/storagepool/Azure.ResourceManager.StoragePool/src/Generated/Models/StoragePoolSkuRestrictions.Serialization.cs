...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        internal static StoragePoolSkuRestrictions DeserializeStoragePoolSkuRestrictions(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
