...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StoragePoolSkuRestrictionInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StoragePoolSkuRestrictionInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StoragePoolSkuRestrictionInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StoragePoolSkuRestrictionInfo>)} interface");
            }
        ...
        string IPersistableModel<StoragePoolSkuRestrictionInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
