...
{
    public partial class StoragePoolIscsiTargetData : IUtf8JsonSerializable
    {
        ...
        internal static StoragePoolIscsiTargetData DeserializeStoragePoolIscsiTargetData(JsonElement element)
        {
            ...
            return new StoragePoolIscsiTargetData(id, name, type, systemData.Value, managedBy.Value, Optional.ToList(managedByExtended), aclMode, Optional.ToList(staticAcls), Optional.ToList(luns), targetIqn, provisioningState, status, Optional.ToList(endpoints), Optional.ToNullable(port), Optional.ToList(sessions));
        }
    }
}
