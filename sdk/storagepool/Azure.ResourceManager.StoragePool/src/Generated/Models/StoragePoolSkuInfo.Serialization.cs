...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StoragePoolSkuInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StoragePoolSkuInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StoragePoolSkuInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StoragePoolSkuInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
