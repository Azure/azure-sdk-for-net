...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class StoragePoolSkuInfo
    {
        ...
        internal StoragePoolSkuInfo(string apiVersion, string resourceType, IReadOnlyList<StoragePoolSkuCapability> capabilities, StoragePoolSkuLocationInfo locationInfo, string name, string tier, IReadOnlyList<StoragePoolSkuRestrictions> restrictions, Dictionary<string, BinaryData> rawData)
        {
