...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class StoragePoolSkuZoneDetails
    {
        ...
        internal StoragePoolSkuZoneDetails(IReadOnlyList<string> name, IReadOnlyList<StoragePoolSkuCapability> capabilities, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
