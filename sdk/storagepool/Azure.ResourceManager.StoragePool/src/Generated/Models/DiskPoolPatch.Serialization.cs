...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskPoolPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskPoolPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskPoolPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiskPoolPatch>)} interface");
            }
        ...
        string IPersistableModel<DiskPoolPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
