...
{
    public partial class PatchableIscsiTargetData : IUtf8JsonSerializable
    {
        ...
        internal static PatchableIscsiTargetData DeserializePatchableIscsiTargetData(JsonElement element)
        {
            ...
            return new PatchableIscsiTargetData(id, name, type, systemData, managedBy.Value, Optional.ToList(managedByExtended), Optional.ToList(staticAcls), Optional.ToList(luns));
        }
    }
}
