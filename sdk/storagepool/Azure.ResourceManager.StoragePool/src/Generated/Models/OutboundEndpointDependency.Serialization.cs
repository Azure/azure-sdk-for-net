...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OutboundEndpointDependency>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OutboundEndpointDependency>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OutboundEndpointDependency>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OutboundEndpointDependency>)} interface");
            }
        ...
        string IPersistableModel<OutboundEndpointDependency>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
