...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        internal static OutboundEndpointDependency DeserializeOutboundEndpointDependency(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
