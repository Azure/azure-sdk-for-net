...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class DiskPoolCreateOrUpdateInfo : ResourceData
    {
        /// <summary> Initializes a new instance of DiskPoolCreateOrUpdateInfo. </summary>
        ...
        public DiskPoolCreateOrUpdateInfo(StoragePoolSku sku, string location, string subnetId)
        {
            if (sku == null)
            {
