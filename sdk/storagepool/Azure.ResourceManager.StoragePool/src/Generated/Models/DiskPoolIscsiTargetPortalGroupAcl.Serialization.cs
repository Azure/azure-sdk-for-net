...
{
    public partial class DiskPoolIscsiTargetPortalGroupAcl : IUtf8JsonSerializable, IJsonModel<DiskPoolIscsiTargetPortalGroupAcl>, IPersistableModel<DiskPoolIscsiTargetPortalGroupAcl>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InitiatorIqn))
            {
                builder.Append("  initiatorIqn:");
                builder.AppendLine($" '{InitiatorIqn}'");
            }

            if (Optional.IsCollectionDefined(MappedLuns))
            {
                builder.Append("  mappedLuns:");
                builder.AppendLine(" [");
                foreach (var item in MappedLuns)
                {
                    if (item == null)
