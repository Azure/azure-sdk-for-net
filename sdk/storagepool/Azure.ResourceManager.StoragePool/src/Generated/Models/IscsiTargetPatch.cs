...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class IscsiTargetPatch : ResourceData
    {
        ...
        internal IscsiTargetPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string managedBy, IList<string> managedByExtended, IList<Acl> staticAcls, IList<IscsiLun> luns) : base(id, name, resourceType, systemData)
        {
            ManagedBy = managedBy;
