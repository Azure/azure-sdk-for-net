...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class DiskPoolPatch
    {
        ...
        internal DiskPoolPatch(string managedBy, IList<string> managedByExtended, StoragePoolSku sku, IDictionary<string, string> tags, IList<WritableSubResource> disks, Dictionary<string, BinaryData> rawData)
        {
            ManagedBy = managedBy;
