...
{
    public partial class StoragePoolIscsiTargetPatch : IUtf8JsonSerializable
    {
        ...
        internal static StoragePoolIscsiTargetPatch DeserializeStoragePoolIscsiTargetPatch(JsonElement element)
        {
            ...
            return new StoragePoolIscsiTargetPatch(id, name, type, systemData.Value, managedBy.Value, Optional.ToList(managedByExtended), Optional.ToList(staticAcls), Optional.ToList(luns));
        }
    }
}
