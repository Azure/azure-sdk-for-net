...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class StoragePoolIscsiTargetPatch : ResourceData
    {
        /// <summary> Initializes a new instance of StoragePoolIscsiTargetPatch. </summary>
        public StoragePoolIscsiTargetPatch()
        {
        ...
        internal StoragePoolIscsiTargetPatch(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string managedBy, IList<string> managedByExtended, IList<Acl> staticAcls, IList<ManagedDiskIscsiLun> luns) : base(id, name, resourceType, systemData)
        {
            ManagedBy = managedBy;
