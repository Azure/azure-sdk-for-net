...
{
    public partial class IscsiTargetCreateOrUpdateInfo : IUtf8JsonSerializable
    {
        ...
        internal static IscsiTargetCreateOrUpdateInfo DeserializeIscsiTargetCreateOrUpdateInfo(JsonElement element)
        {
            ...
            return new IscsiTargetCreateOrUpdateInfo(id, name, type, systemData, managedBy.Value, Optional.ToList(managedByExtended), aclMode, targetIqn.Value, Optional.ToList(staticAcls), Optional.ToList(luns));
        }
    }
}
