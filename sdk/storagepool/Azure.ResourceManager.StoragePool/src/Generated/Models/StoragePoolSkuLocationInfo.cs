...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class StoragePoolSkuLocationInfo
    {
        ...
        internal StoragePoolSkuLocationInfo(AzureLocation? location, IReadOnlyList<string> zones, IReadOnlyList<StoragePoolSkuZoneDetails> zoneDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Zones = zones;
