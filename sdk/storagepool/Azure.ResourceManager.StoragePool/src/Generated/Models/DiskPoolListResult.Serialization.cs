...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskPoolListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DiskPoolListResult)} does not support writing '{format}' format.");
            }
            ...
            {
                ((IJsonModel<DiskPoolData>)item).Write(writer, options);
            }
        ...
        DiskPoolListResult IJsonModel<DiskPoolListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DiskPoolListResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DiskPoolListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DiskPoolListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        DiskPoolListResult IPersistableModel<DiskPoolListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DiskPoolListResult)} does not support reading '{options.Format}' format.");
            }
        }
