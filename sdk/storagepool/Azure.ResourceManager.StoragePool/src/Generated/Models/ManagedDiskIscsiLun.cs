...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class ManagedDiskIscsiLun
    {
        ...
        internal ManagedDiskIscsiLun(string name, ResourceIdentifier managedDiskAzureResourceId, int? lun, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            ManagedDiskAzureResourceId = managedDiskAzureResourceId;
            Lun = lun;
