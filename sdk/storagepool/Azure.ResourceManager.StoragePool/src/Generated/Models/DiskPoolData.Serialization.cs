...
{
    public partial class DiskPoolData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DiskPoolData DeserializeDiskPoolData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
