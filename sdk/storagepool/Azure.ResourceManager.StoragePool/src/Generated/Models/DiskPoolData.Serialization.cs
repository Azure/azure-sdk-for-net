...
namespace Azure.ResourceManager.StoragePool
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskPoolData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskPoolData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskPoolData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiskPoolData>)} interface");
            }
        ...
        string IPersistableModel<DiskPoolData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
