...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class IscsiTargetCreateOrUpdateInfo : ResourceData
    {
        /// <summary> Initializes a new instance of IscsiTargetCreateOrUpdateInfo. </summary>
        /// <param name="aclMode"> Mode for Target connectivity. </param>
        public IscsiTargetCreateOrUpdateInfo(IscsiTargetAclMode aclMode)
        {
        ...
        internal IscsiTargetCreateOrUpdateInfo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string managedBy, IList<string> managedByExtended, IscsiTargetAclMode aclMode, string targetIqn, IList<Acl> staticAcls, IList<IscsiLun> luns) : base(id, name, resourceType, systemData)
        {
            ManagedBy = managedBy;
