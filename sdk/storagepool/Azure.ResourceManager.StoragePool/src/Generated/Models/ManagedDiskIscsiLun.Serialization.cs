...
namespace Azure.ResourceManager.StoragePool.Models
{
    public partial class ManagedDiskIscsiLun : IUtf8JsonSerializable, IJsonModel<ManagedDiskIscsiLun>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedDiskIscsiLun)} does not support writing '{format}' format.");
            }
        ...
        ManagedDiskIscsiLun IJsonModel<ManagedDiskIscsiLun>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedDiskIscsiLun)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ManagedDiskIscsiLun>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ManagedDiskIscsiLun)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        ManagedDiskIscsiLun IPersistableModel<ManagedDiskIscsiLun>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ManagedDiskIscsiLun)} does not support reading '{options.Format}' format.");
            }
        }
