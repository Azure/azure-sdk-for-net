...
{
    public partial class ManagedDiskIscsiLun : IUtf8JsonSerializable, IJsonModel<ManagedDiskIscsiLun>, IPersistableModel<ManagedDiskIscsiLun>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ManagedDiskAzureResourceId))
            {
                builder.Append("  managedDiskAzureResourceId:");
                builder.AppendLine($" '{ManagedDiskAzureResourceId.ToString()}'");
            }
