...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedDiskIscsiLun>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedDiskIscsiLun>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedDiskIscsiLun>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedDiskIscsiLun>)} interface");
            }
        ...
        string IPersistableModel<ManagedDiskIscsiLun>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
