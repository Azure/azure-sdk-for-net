...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class OutboundEndpointDetail
    {
        ...
        internal OutboundEndpointDetail(IPAddress ipAddress, int? port, double? latencyInMs, bool? isAccessible, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IPAddress = ipAddress;
            Port = port;
