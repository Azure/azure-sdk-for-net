...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    public partial class OutboundEndpointDetail
    {
        ...
        internal OutboundEndpointDetail(IPAddress ipAddress, int? port, double? latencyInMs, bool? isAccessible, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IPAddress = ipAddress;
            Port = port;
