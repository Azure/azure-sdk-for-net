...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OutboundEndpointDetail>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OutboundEndpointDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OutboundEndpointDetail>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OutboundEndpointDetail>)} interface");
            }
        ...
        string IPersistableModel<OutboundEndpointDetail>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
