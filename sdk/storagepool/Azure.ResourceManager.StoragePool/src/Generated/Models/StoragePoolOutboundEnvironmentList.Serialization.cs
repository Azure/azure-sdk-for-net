...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StoragePoolOutboundEnvironmentList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StoragePoolOutboundEnvironmentList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StoragePoolOutboundEnvironmentList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StoragePoolOutboundEnvironmentList>)} interface");
            }
        ...
        string IPersistableModel<StoragePoolOutboundEnvironmentList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
