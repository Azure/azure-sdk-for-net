...
namespace Azure.ResourceManager.StoragePool.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiskPoolIscsiTargetPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiskPoolIscsiTargetPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiskPoolIscsiTargetPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiskPoolIscsiTargetPatch>)} interface");
            }
        ...
        string IPersistableModel<DiskPoolIscsiTargetPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
