...
{
    /// <summary> A class representing the StoragePoolIscsiTarget data model. </summary>
    public partial class StoragePoolIscsiTargetData : ResourceData
    {
        /// <summary> Initializes a new instance of StoragePoolIscsiTargetData. </summary>
        ...
        public StoragePoolIscsiTargetData(IscsiTargetAclMode aclMode, string targetIqn, ProvisioningState provisioningState, OperationalStatus status)
        {
            if (targetIqn == null)
            {
        ...
        internal StoragePoolIscsiTargetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string managedBy, IReadOnlyList<string> managedByExtended, IscsiTargetAclMode aclMode, IList<Acl> staticAcls, IList<ManagedDiskIscsiLun> luns, string targetIqn, ProvisioningState provisioningState, OperationalStatus status, IList<string> endpoints, int? port, IReadOnlyList<string> sessions) : base(id, name, resourceType, systemData)
        {
            ManagedBy = managedBy;
