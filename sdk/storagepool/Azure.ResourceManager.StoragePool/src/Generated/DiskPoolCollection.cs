...
namespace Azure.ResourceManager.StoragePool
{
    ...
    public partial class DiskPoolCollection : ArmCollection, IEnumerable<DiskPool>, IAsyncEnumerable<DiskPool>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="diskPoolName"/> is null or empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="diskPoolCreatePayload"/> is null. </exception>
        ...
        {
            if (string.IsNullOrEmpty(diskPoolName))
            {
                throw new ArgumentException($"Parameter {nameof(diskPoolName)} cannot be null or empty", nameof(diskPoolName));
            }
