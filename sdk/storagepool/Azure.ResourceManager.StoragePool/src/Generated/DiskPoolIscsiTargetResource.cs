...
namespace Azure.ResourceManager.StoragePool
{
    ...
    public partial class DiskPoolIscsiTargetResource : ArmResource
    {
        ...
        internal DiskPoolIscsiTargetResource(ArmClient client, DiskPoolIscsiTargetData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DiskPoolIscsiTargetResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DiskPoolIscsiTargetResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
