...
namespace Azure.ResourceManager.StoragePool
{
    ...
    public partial class IscsiTargetCollection : ArmCollection, IEnumerable<IscsiTargetResource>, IAsyncEnumerable<IscsiTargetResource>
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="iscsiTargetName"/> or <paramref name="info"/> is null. </exception>
        public virtual async Task<ArmOperation<IscsiTargetResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string iscsiTargetName, IscsiTargetCreateOrUpdateInfo info, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _iscsiTargetRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, iscsiTargetName, info, cancellationToken).ConfigureAwait(false);
                var operation = new StoragePoolArmOperation<IscsiTargetResource>(new IscsiTargetOperationSource(Client), _iscsiTargetClientDiagnostics, Pipeline, _iscsiTargetRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, iscsiTargetName, info).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        /// <exception cref="ArgumentException"> <paramref name="iscsiTargetName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="iscsiTargetName"/> or <paramref name="info"/> is null. </exception>
        public virtual ArmOperation<IscsiTargetResource> CreateOrUpdate(WaitUntil waitUntil, string iscsiTargetName, IscsiTargetCreateOrUpdateInfo info, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(iscsiTargetName, nameof(iscsiTargetName));
            Argument.AssertNotNull(info, nameof(info));
            ...
            try
            {
                var response = _iscsiTargetRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, iscsiTargetName, info, cancellationToken);
                var operation = new StoragePoolArmOperation<IscsiTargetResource>(new IscsiTargetOperationSource(Client), _iscsiTargetClientDiagnostics, Pipeline, _iscsiTargetRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, iscsiTargetName, info).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
