...
namespace Azure.ResourceManager.StoragePool.Tests
{
    public class IscsiTargetTests : StoragePoolTestBase
    {
        ...
        public async Task IscsiTargetCrudOperations()
        {
            ...
            var diskPoolCreate = new DiskPoolCreateOrUpdateInfo(sku, DefaultLocation, SubnetResourceId) { };
            ...
            var iscsiTargetCreate = new IscsiTargetCreateOrUpdateInfo(IscsiTargetAclMode.Dynamic);
