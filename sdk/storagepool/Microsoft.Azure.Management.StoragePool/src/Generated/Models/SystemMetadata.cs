...
namespace Microsoft.Azure.Management.StoragePool.Models
{
    ...
    public partial class SystemMetadata
    {
        ...
        public SystemMetadata(string createdBy = default(string), string createdByType = default(string), System.DateTime? createdAt = default(System.DateTime?), string lastModifiedBy = default(string), string lastModifiedByType = default(string), System.DateTime? lastModifiedAt = default(System.DateTime?))
        {
            CreatedBy = createdBy;
