...
{
    internal partial class ServerlessRuntimesGetByInformaticaOrganizationResourceAsyncCollectionResultOfT : AsyncPageable<InformaticaServerlessRuntimeData>
    {
        ...
        /// <summary> Initializes a new instance of ServerlessRuntimesGetByInformaticaOrganizationResourceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of ServerlessRuntimesGetByInformaticaOrganizationResourceAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ServerlessRuntimesGetByInformaticaOrganizationResourceAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<InformaticaServerlessRuntimeData>> AsPages(string continuationToken, int? pageSizeHint)
        {
