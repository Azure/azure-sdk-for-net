...
{
    internal partial class OrganizationsGetBySubscriptionCollectionResultOfT : Pageable<InformaticaOrganizationData>
    {
        ...
        public OrganizationsGetBySubscriptionCollectionResultOfT(Organizations client, string subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
