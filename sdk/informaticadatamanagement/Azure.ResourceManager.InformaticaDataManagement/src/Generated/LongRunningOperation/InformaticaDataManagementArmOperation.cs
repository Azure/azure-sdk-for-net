...
#pragma warning disable SA1649 // File name should match first type name
    internal class InformaticaDataManagementArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of InformaticaDataManagementArmOperation for mocking. </summary>
        protected InformaticaDataManagementArmOperation()
        {
        }

        internal InformaticaDataManagementArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal InformaticaDataManagementArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "InformaticaDataManagementArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerInformaticaDataManagementContext.Default).ToObjectFromJson<Dictionary<string, string>>();
