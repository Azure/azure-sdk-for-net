...
namespace Azure.ResourceManager.InformaticaDataManagement
{
    internal partial class InformaticaDataManagementArmOperation : ArmOperation
    {
        ...
        internal InformaticaDataManagementArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
