...
#pragma warning disable SA1649 // File name should match first type name
    internal class InformaticaDataManagementArmOperation<T> : ArmOperation<T>
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        internal InformaticaDataManagementArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal InformaticaDataManagementArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, Core.OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(NextLinkOperationImplementation.Create(source, nextLinkOperation), clientDiagnostics, response, "InformaticaDataManagementArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
