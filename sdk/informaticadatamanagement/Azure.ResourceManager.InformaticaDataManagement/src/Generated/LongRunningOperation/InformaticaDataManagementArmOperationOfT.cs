...
namespace Azure.ResourceManager.InformaticaDataManagement
{
    internal partial class InformaticaDataManagementArmOperation<T> : ArmOperation<T>
    {
        ...
        internal InformaticaDataManagementArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
