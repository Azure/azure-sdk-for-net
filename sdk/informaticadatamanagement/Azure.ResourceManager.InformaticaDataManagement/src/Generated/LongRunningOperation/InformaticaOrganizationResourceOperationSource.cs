...
{
    internal class InformaticaOrganizationResourceOperationSource : IOperationSource<InformaticaOrganizationResource>
    {
        private readonly ArmClient _client;

        internal InformaticaOrganizationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        InformaticaOrganizationResource IOperationSource<InformaticaOrganizationResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            var data = InformaticaOrganizationResourceData.DeserializeInformaticaOrganizationResourceData(document.RootElement);
