...
{
    public partial class InfaServerlessFetchConfigProperties : IUtf8JsonSerializable, IJsonModel<InfaServerlessFetchConfigProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InfaServerlessFetchConfigProperties>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<InfaServerlessFetchConfigProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InfaServerlessFetchConfigProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InfaServerlessFetchConfigProperties)} does not support writing '{format}' format.");
            }
        ...
        InfaServerlessFetchConfigProperties IJsonModel<InfaServerlessFetchConfigProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InfaServerlessFetchConfigProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(InfaServerlessFetchConfigProperties)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeInfaServerlessFetchConfigProperties(document.RootElement, options);
        }

        internal static InfaServerlessFetchConfigProperties DeserializeInfaServerlessFetchConfigProperties(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        BinaryData IPersistableModel<InfaServerlessFetchConfigProperties>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InfaServerlessFetchConfigProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InfaServerlessFetchConfigProperties)} does not support writing '{options.Format}' format.");
            }
        }

        InfaServerlessFetchConfigProperties IPersistableModel<InfaServerlessFetchConfigProperties>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<InfaServerlessFetchConfigProperties>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(InfaServerlessFetchConfigProperties)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<InfaServerlessFetchConfigProperties>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
