...
namespace Azure.ResourceManager.InformaticaDataManagement.Models
{
    ...
    public readonly partial struct MarketplaceSubscriptionStatus : IEquatable<MarketplaceSubscriptionStatus>
    {
        ...
        /// <summary> Marketplace subscription is activated. </summary>
        public static MarketplaceSubscriptionStatus Subscribe { get; } = new MarketplaceSubscriptionStatus(SubscribeValue);

        /// <summary> This state indicates that a customer's payment for the Marketplace service was not received. </summary>
        public static MarketplaceSubscriptionStatus Suspend { get; } = new MarketplaceSubscriptionStatus(SuspendValue);

        /// <summary> Customer has cancelled the subscription. </summary>
        public static MarketplaceSubscriptionStatus Unsubscribe { get; } = new MarketplaceSubscriptionStatus(UnsubscribeValue);
