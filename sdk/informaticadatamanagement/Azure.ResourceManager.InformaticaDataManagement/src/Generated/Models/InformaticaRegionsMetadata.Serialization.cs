...
namespace Azure.ResourceManager.InformaticaDataManagement.Models
{
    ...
    public partial class InformaticaRegionsMetadata : IJsonModel<InformaticaRegionsMetadata>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InformaticaRegionsMetadata IJsonModel<InformaticaRegionsMetadata>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InformaticaRegionsMetadata JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InformaticaRegionsMetadata>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InformaticaRegionsMetadata DeserializeInformaticaRegionsMetadata(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new InformaticaRegionsMetadata(id, name, additionalBinaryDataProperties);
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InformaticaRegionsMetadata>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
