...
namespace Azure.ResourceManager.InformaticaDataManagement.Models
{
    ...
    public partial class InformaticaOrganizationPatch : IJsonModel<InformaticaOrganizationPatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InformaticaOrganizationPatch>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        internal static RequestContent ToRequestContent(InformaticaOrganizationPatch informaticaOrganizationPatch)
        {
            ...
            return RequestContent.Create(informaticaOrganizationPatch, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InformaticaOrganizationPatch IJsonModel<InformaticaOrganizationPatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InformaticaOrganizationPatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InformaticaOrganizationPatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InformaticaOrganizationPatch DeserializeInformaticaOrganizationPatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = InformaticaOrganizationPropertiesUpdate.DeserializeInformaticaOrganizationPropertiesUpdate(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new InformaticaOrganizationPatch(identity, tags ?? new ChangeTrackingDictionary<string, string>(), properties, additionalBinaryDataProperties);
        }
    }
}
