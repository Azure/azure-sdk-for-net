...
namespace Azure.ResourceManager.InformaticaDataManagement.Models
{
    ...
    public partial class InformaticaCompanyDetailsUpdate
    {
        ...
        internal InformaticaCompanyDetailsUpdate(string companyName, string officeAddress, string country, string domain, string business, int? numberOfEmployees, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
