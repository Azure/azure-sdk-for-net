...
namespace Azure.ResourceManager.InformaticaDataManagement.Models
{
    ...
    public partial class CompanyDetails
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CompanyDetails"/>. </summary>
        ...
        internal CompanyDetails(string companyName, string officeAddress, string country, string domain, string business, int? numberOfEmployees, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
