...
namespace Azure.ResourceManager.InformaticaDataManagement.Models
{
    ...
    public partial class InformaticaMarketplaceDetails : IJsonModel<InformaticaMarketplaceDetails>
    {
        ...
        protected virtual InformaticaMarketplaceDetails PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InformaticaMarketplaceDetails>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InformaticaMarketplaceDetails>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InformaticaMarketplaceDetails IPersistableModel<InformaticaMarketplaceDetails>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InformaticaMarketplaceDetails IJsonModel<InformaticaMarketplaceDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InformaticaMarketplaceDetails JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InformaticaMarketplaceDetails>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InformaticaMarketplaceDetails DeserializeInformaticaMarketplaceDetails(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    offerDetails = InformaticaOfferDetails.DeserializeInformaticaOfferDetails(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new InformaticaMarketplaceDetails(marketplaceSubscriptionId, marketplaceSubscriptionStatus, offerDetails, additionalBinaryDataProperties);
        }
    }
}
