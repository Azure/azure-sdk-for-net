...
namespace Azure.ResourceManager.InformaticaDataManagement.Models
{
    ...
    public partial class InformaticaUserDetailsUpdate
    {
        ...
        internal InformaticaUserDetailsUpdate(string firstName, string lastName, string emailAddress, string upn, string phoneNumber, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            FirstName = firstName;
            LastName = lastName;
