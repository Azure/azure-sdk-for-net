...
namespace Azure.ResourceManager.InformaticaDataManagement
{
    ...
    public partial class InformaticaOrganizationResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the InformaticaOrganization.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Informatica.DataManagement/organizations/{organizationName}. </description>
        ...
        public virtual async Task<ArmOperation<InformaticaOrganizationResource>> UpdateAsync(WaitUntil waitUntil, InformaticaOrganizationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _organizationsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, InformaticaOrganizationData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<InformaticaOrganizationResource> Update(WaitUntil waitUntil, InformaticaOrganizationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
