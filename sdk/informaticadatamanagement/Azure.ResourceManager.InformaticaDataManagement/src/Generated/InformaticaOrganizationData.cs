...
namespace Azure.ResourceManager.InformaticaDataManagement
{
    ...
    public partial class InformaticaOrganizationData : TrackedResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="InformaticaOrganizationData"/>. </summary>
        /// <param name="location"> The geo-location where the resource lives. </param>
        public InformaticaOrganizationData(AzureLocation location) : base(location)
        {
        }
        ...
        internal InformaticaOrganizationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, InformaticaOrganizationProperties properties, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData, tags, location)
        {
