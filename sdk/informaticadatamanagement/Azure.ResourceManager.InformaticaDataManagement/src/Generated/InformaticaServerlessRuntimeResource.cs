...
namespace Azure.ResourceManager.InformaticaDataManagement
{
    ...
    public partial class InformaticaServerlessRuntimeResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the InformaticaServerlessRuntime.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Informatica.DataManagement/organizations/{organizationName}/serverlessRuntimes/{serverlessRuntimeName}. </description>
        ...
        public virtual async Task<ArmOperation<InformaticaServerlessRuntimeResource>> UpdateAsync(WaitUntil waitUntil, InformaticaServerlessRuntimeData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _serverlessRuntimesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, InformaticaServerlessRuntimeData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<InformaticaServerlessRuntimeResource> Update(WaitUntil waitUntil, InformaticaServerlessRuntimeData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
