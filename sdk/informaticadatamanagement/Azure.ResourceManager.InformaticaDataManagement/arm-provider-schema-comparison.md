# ARM provider schema comparison: Azure.ResourceManager.InformaticaDataManagement
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Informatica.DataManagement/organizations/{organizationName}` | `InformaticaOrganization` | `InformaticaOrganizationResource` |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Informatica.DataManagement/organizations/{organizationName}/serverlessRuntimes/{serverlessRuntimeName}` | `InformaticaServerlessRuntime` | `InformaticaServerlessRuntimeResource` |
