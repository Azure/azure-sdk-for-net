...
{
    public partial class ServerlessRuntimePropertiesCustomUpdate : IUtf8JsonSerializable, IJsonModel<ServerlessRuntimePropertiesCustomUpdate>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServerlessRuntimePropertiesCustomUpdate>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<ServerlessRuntimePropertiesCustomUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServerlessRuntimePropertiesCustomUpdate>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServerlessRuntimePropertiesCustomUpdate)} does not support writing '{format}' format.");
            }
        ...
        ServerlessRuntimePropertiesCustomUpdate IJsonModel<ServerlessRuntimePropertiesCustomUpdate>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServerlessRuntimePropertiesCustomUpdate>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ServerlessRuntimePropertiesCustomUpdate)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeServerlessRuntimePropertiesCustomUpdate(document.RootElement, options);
        }

        internal static ServerlessRuntimePropertiesCustomUpdate DeserializeServerlessRuntimePropertiesCustomUpdate(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new ServerlessRuntimePropertiesCustomUpdate(
                description,
                platform,
                applicationType,
                computeUnits,
        ...
        BinaryData IPersistableModel<ServerlessRuntimePropertiesCustomUpdate>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServerlessRuntimePropertiesCustomUpdate>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ServerlessRuntimePropertiesCustomUpdate)} does not support writing '{options.Format}' format.");
            }
        }

        ServerlessRuntimePropertiesCustomUpdate IPersistableModel<ServerlessRuntimePropertiesCustomUpdate>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<ServerlessRuntimePropertiesCustomUpdate>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ServerlessRuntimePropertiesCustomUpdate)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<ServerlessRuntimePropertiesCustomUpdate>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
