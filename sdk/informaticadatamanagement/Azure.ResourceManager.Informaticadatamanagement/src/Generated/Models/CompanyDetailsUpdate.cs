...
namespace Azure.ResourceManager.Informaticadatamanagement.Models
{
    ...
    public partial class CompanyDetailsUpdate
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CompanyDetailsUpdate"/>. </summary>
        ...
        internal CompanyDetailsUpdate(string companyName, string officeAddress, string country, string domain, string business, int? numberOfEmployees, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
