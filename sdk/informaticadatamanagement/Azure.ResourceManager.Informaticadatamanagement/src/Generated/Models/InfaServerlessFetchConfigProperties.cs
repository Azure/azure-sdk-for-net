...
namespace Azure.ResourceManager.Informaticadatamanagement.Models
{
    ...
    public partial class InfaServerlessFetchConfigProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="InfaServerlessFetchConfigProperties"/>. </summary>
        ...
        internal InfaServerlessFetchConfigProperties(string subnet, string applicationType, string resourceGroupName, string advancedCustomProperties, string supplementaryFileLocation, string platform, string tags, string vnet, string executionTimeout, string computeUnits, Guid? tenantId, string subscriptionId, string region, string serverlessArmResourceId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Subnet = subnet;
