...
namespace Azure.ResourceManager.Informaticadatamanagement.Models
{
    ...
    public partial class OfferDetailsUpdate
    {
        ...
        /// <summary> Initializes a new instance of <see cref="OfferDetailsUpdate"/>. </summary>
        ...
        internal OfferDetailsUpdate(string publisherId, string offerId, string planId, string planName, string termUnit, string termId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
