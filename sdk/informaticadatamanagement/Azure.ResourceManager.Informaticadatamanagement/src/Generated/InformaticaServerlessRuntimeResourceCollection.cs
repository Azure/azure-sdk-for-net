...
namespace Azure.ResourceManager.Informaticadatamanagement
{
    ...
    /// To get an <see cref="InformaticaServerlessRuntimeResourceCollection"/> instance call the GetInformaticaServerlessRuntimeResources method from an instance of <see cref="InformaticaOrganizationResource"/>.
    /// </summary>
    public partial class InformaticaServerlessRuntimeResourceCollection : ArmCollection, IEnumerable<InformaticaServerlessRuntimeResource>, IAsyncEnumerable<InformaticaServerlessRuntimeResource>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="InformaticaServerlessRuntimeResourceCollection"/> class for mocking. </summary>
        protected InformaticaServerlessRuntimeResourceCollection()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="InformaticaServerlessRuntimeResourceCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the parent resource that is the target of operations. </param>
        internal InformaticaServerlessRuntimeResourceCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _informaticaServerlessRuntimeResourceServerlessRuntimesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Informaticadatamanagement", InformaticaServerlessRuntimeResource.ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(InformaticaServerlessRuntimeResource.ResourceType, out string informaticaServerlessRuntimeResourceServerlessRuntimesApiVersion);
        ...
        public virtual async Task<ArmOperation<InformaticaServerlessRuntimeResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string serverlessRuntimeName, InformaticaServerlessRuntimeResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(serverlessRuntimeName, nameof(serverlessRuntimeName));
            Argument.AssertNotNull(data, nameof(data));

            using var scope = _informaticaServerlessRuntimeResourceServerlessRuntimesClientDiagnostics.CreateScope("InformaticaServerlessRuntimeResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                var response = await _informaticaServerlessRuntimeResourceServerlessRuntimesRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, serverlessRuntimeName, data, cancellationToken).ConfigureAwait(false);
                var operation = new InformaticadatamanagementArmOperation<InformaticaServerlessRuntimeResource>(new InformaticaServerlessRuntimeResourceOperationSource(Client), _informaticaServerlessRuntimeResourceServerlessRuntimesClientDiagnostics, Pipeline, _informaticaServerlessRuntimeResourceServerlessRuntimesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, serverlessRuntimeName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        /// <exception cref="ArgumentException"> <paramref name="serverlessRuntimeName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="serverlessRuntimeName"/> or <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<InformaticaServerlessRuntimeResource> CreateOrUpdate(WaitUntil waitUntil, string serverlessRuntimeName, InformaticaServerlessRuntimeResourceData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(serverlessRuntimeName, nameof(serverlessRuntimeName));
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                var response = _informaticaServerlessRuntimeResourceServerlessRuntimesRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, serverlessRuntimeName, data, cancellationToken);
                var operation = new InformaticadatamanagementArmOperation<InformaticaServerlessRuntimeResource>(new InformaticaServerlessRuntimeResourceOperationSource(Client), _informaticaServerlessRuntimeResourceServerlessRuntimesClientDiagnostics, Pipeline, _informaticaServerlessRuntimeResourceServerlessRuntimesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, serverlessRuntimeName, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<InformaticaServerlessRuntimeResource>> GetAsync(string serverlessRuntimeName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _informaticaServerlessRuntimeResourceServerlessRuntimesClientDiagnostics.CreateScope("InformaticaServerlessRuntimeResourceCollection.Get");
            scope.Start();
            try
            {
                var response = await _informaticaServerlessRuntimeResourceServerlessRuntimesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, serverlessRuntimeName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<InformaticaServerlessRuntimeResource> Get(string serverlessRuntimeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _informaticaServerlessRuntimeResourceServerlessRuntimesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, serverlessRuntimeName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new InformaticaServerlessRuntimeResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _informaticaServerlessRuntimeResourceServerlessRuntimesRestClient.CreateListByInformaticaOrganizationResourceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _informaticaServerlessRuntimeResourceServerlessRuntimesRestClient.CreateListByInformaticaOrganizationResourceNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new InformaticaServerlessRuntimeResource(Client, InformaticaServerlessRuntimeResourceData.DeserializeInformaticaServerlessRuntimeResourceData(e)), _informaticaServerlessRuntimeResourceServerlessRuntimesClientDiagnostics, Pipeline, "InformaticaServerlessRuntimeResourceCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string serverlessRuntimeName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _informaticaServerlessRuntimeResourceServerlessRuntimesClientDiagnostics.CreateScope("InformaticaServerlessRuntimeResourceCollection.Exists");
            scope.Start();
            try
            {
                var response = await _informaticaServerlessRuntimeResourceServerlessRuntimesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, serverlessRuntimeName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string serverlessRuntimeName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _informaticaServerlessRuntimeResourceServerlessRuntimesRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, serverlessRuntimeName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<NullableResponse<InformaticaServerlessRuntimeResource>> GetIfExistsAsync(string serverlessRuntimeName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _informaticaServerlessRuntimeResourceServerlessRuntimesClientDiagnostics.CreateScope("InformaticaServerlessRuntimeResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _informaticaServerlessRuntimeResourceServerlessRuntimesRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, serverlessRuntimeName, cancellationToken: cancellationToken).ConfigureAwait(false);
