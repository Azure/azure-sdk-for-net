...
namespace Microsoft.TestBase.Models
{
    ...
    /// </summary>
    public partial class PackagesDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PackagesDeleteHeaders class.
        /// </summary>
        public PackagesDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// operation.</param>
        public PackagesDeleteHeaders(string azureAsyncOperation = default(string), string location = default(string))
        {
