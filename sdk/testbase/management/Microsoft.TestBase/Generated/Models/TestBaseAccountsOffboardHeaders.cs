...
namespace Microsoft.TestBase.Models
{
    ...
    /// </summary>
    public partial class TestBaseAccountsOffboardHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TestBaseAccountsOffboardHeaders
        /// class.
        /// </summary>
        public TestBaseAccountsOffboardHeaders()
        {
            CustomInit();
        }
        ...
        /// operation.</param>
        public TestBaseAccountsOffboardHeaders(string azureAsyncOperation = default(string), string location = default(string))
        {
