...
namespace Microsoft.TestBase.Models
{
    ...
    /// </summary>
    public partial class PackagesHardDeleteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PackagesHardDeleteHeaders class.
        /// </summary>
        public PackagesHardDeleteHeaders()
        {
            CustomInit();
        }
        ...
        /// operation.</param>
        public PackagesHardDeleteHeaders(string azureAsyncOperation = default(string), string location = default(string))
        {
