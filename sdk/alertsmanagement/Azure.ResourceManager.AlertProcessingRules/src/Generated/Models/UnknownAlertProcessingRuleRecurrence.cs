...
namespace Azure.ResourceManager.AlertProcessingRules.Models
{
    internal partial class UnknownAlertProcessingRuleRecurrence : AlertProcessingRuleRecurrence
    {
        ...
        internal UnknownAlertProcessingRuleRecurrence(RecurrenceType recurrenceType, TimeSpan? startOn, TimeSpan? endOn, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(recurrenceType != default ? recurrenceType : "unknown", startOn, endOn, additionalBinaryDataProperties)
        {
        }
    }
}
