...
namespace Azure.ResourceManager.AlertProcessingRules
{
    ...
    public partial class AlertProcessingRuleData : TrackedResourceData
    {
        ...
        /// <summary> The name of the alert processing rule that needs to be fetched. </summary>
