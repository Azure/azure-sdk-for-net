...
{
    internal partial class AlertProcessingRulesArmOperation<T> : ArmOperation<T>
    {
        ...
        internal AlertProcessingRulesArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal AlertProcessingRulesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
