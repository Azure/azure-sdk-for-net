...
namespace Microsoft.Azure.Management.AlertsManagement.Models
{
    ...
    public partial class AzureResource : IResource
    {
        ...
        public AzureResource(string id = default(string), string type = default(string), string name = default(string), string location = default(string), object tags = default(object))
        {
            Id = id;
            Type = type;
            Name = name;
