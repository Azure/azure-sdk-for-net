...
namespace Microsoft.Azure.Management.AlertsManagement.Models
{
    ...
    public partial class AlertRulePatchObject
    {
        ...
        /// information.</param>
        public AlertRulePatchObject(string id = default(string), string type = default(string), string name = default(string), object tags = default(object), string description = default(string), string state = default(string), string severity = default(string), System.TimeSpan? frequency = default(System.TimeSpan?), ActionGroupsInformation actionGroups = default(ActionGroupsInformation), ThrottlingInformation throttling = default(ThrottlingInformation))
        {
            Id = id;
            Type = type;
            Name = name;
