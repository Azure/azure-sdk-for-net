...
namespace Azure.ResourceManager.AlertRuleRecommendations.Models
{
    ...
    public partial class AlertRuleRecommendation : ResourceData, IJsonModel<AlertRuleRecommendation>
    {
        ...
        internal static AlertRuleRecommendation DeserializeAlertRuleRecommendation(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            AlertRuleRecommendationProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerAlertRuleRecommendationsContext.Default);
                    continue;
                }
                if (prop.NameEquals("properties"u8))
                {
                    properties = AlertRuleRecommendationProperties.DeserializeAlertRuleRecommendationProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
