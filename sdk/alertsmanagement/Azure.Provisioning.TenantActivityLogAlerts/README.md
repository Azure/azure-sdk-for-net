# Azure Provisioning TenantActivityLogAlerts client library for .NET

Azure.Provisioning.TenantActivityLogAlerts simplifies declarative resource provisioning in .NET.
...
```dotnetcli
dotnet add package Azure.Provisioning.TenantActivityLogAlerts --prerelease
```
...
Tenant activity log alerts evaluate activity log events across management-group or tenant scopes and route matches to action groups.

## Examples

### Create a tenant activity log alert

```C# Snippet:TenantActivityLogAlertsBasic
