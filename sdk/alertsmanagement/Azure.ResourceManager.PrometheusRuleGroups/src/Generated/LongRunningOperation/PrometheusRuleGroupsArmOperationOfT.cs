...
{
    internal partial class PrometheusRuleGroupsArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of PrometheusRuleGroupsArmOperation for mocking. </summary>
        protected PrometheusRuleGroupsArmOperation()
        {
        }
        ...
        internal PrometheusRuleGroupsArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal PrometheusRuleGroupsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "PrometheusRuleGroupsArmOperation",
                null,
