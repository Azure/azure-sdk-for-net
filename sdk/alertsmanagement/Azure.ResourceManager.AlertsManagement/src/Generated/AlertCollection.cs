...
namespace Azure.ResourceManager.AlertsManagement
{
    ...
    /// Each <see cref="AlertResource" /> in the collection will belong to the same instance of <see cref="SubscriptionResource" />.
    /// To get an <see cref="AlertCollection" /> instance call the GetAlerts method from an instance of <see cref="SubscriptionResource" />.
    /// </summary>
    public partial class AlertCollection : ArmCollection, IEnumerable<AlertResource>, IAsyncEnumerable<AlertResource>
    {
        ...
        {
            _alertClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.AlertsManagement", AlertResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<AlertResource>> GetAsync(string alertId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _alertRestClient.GetByIdAsync(Id.SubscriptionId, alertId, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<AlertResource> Get(string alertId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _alertRestClient.GetById(Id.SubscriptionId, alertId, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new AlertResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual AsyncPageable<AlertResource> GetAllAsync(string targetResource = null, string targetResourceType = null, string targetResourceGroup = null, MonitorService? monitorService = null, MonitorCondition? monitorCondition = null, Severity? severity = null, AlertState? alertState = null, string alertRule = null, string smartGroupId = null, bool? includeContext = null, bool? includeEgressConfig = null, long? pageCount = null, AlertsSortByField? sortBy = null, SortOrder? sortOrder = null, string select = null, TimeRange? timeRange = null, string customTimeRange = null, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<AlertResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _alertRestClient.GetAllNextPageAsync(nextLink, Id.SubscriptionId, targetResource, targetResourceType, targetResourceGroup, monitorService, monitorCondition, severity, alertState, alertRule, smartGroupId, includeContext, includeEgressConfig, pageCount, sortBy, sortOrder, select, timeRange, customTimeRange, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new AlertResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<AlertResource> GetAll(string targetResource = null, string targetResourceType = null, string targetResourceGroup = null, MonitorService? monitorService = null, MonitorCondition? monitorCondition = null, Severity? severity = null, AlertState? alertState = null, string alertRule = null, string smartGroupId = null, bool? includeContext = null, bool? includeEgressConfig = null, long? pageCount = null, AlertsSortByField? sortBy = null, SortOrder? sortOrder = null, string select = null, TimeRange? timeRange = null, string customTimeRange = null, CancellationToken cancellationToken = default)
        {
            ...
            Page<AlertResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _alertRestClient.GetAllNextPage(nextLink, Id.SubscriptionId, targetResource, targetResourceType, targetResourceGroup, monitorService, monitorCondition, severity, alertState, alertRule, smartGroupId, includeContext, includeEgressConfig, pageCount, sortBy, sortOrder, select, timeRange, customTimeRange, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new AlertResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string alertId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _alertRestClient.GetByIdAsync(Id.SubscriptionId, alertId, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string alertId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _alertRestClient.GetById(Id.SubscriptionId, alertId, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
