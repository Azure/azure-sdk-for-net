...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SmartGroupModificationItemInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SmartGroupModificationItemInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SmartGroupModificationItemInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SmartGroupModificationItemInfo>)} interface");
            }
        ...
        string IPersistableModel<SmartGroupModificationItemInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
