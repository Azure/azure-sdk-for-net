...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    {
        /// <summary> Initializes a new instance of Essentials. </summary>
        public Essentials()
        {
        }
        ...
        /// <param name="lastModifiedUserName"> User who last modified the alert, in case of monitor service updates user would be &apos;system&apos;, otherwise name of the user. </param>
        /// <param name="actionStatus"> Action status. </param>
        /// <param name="description"> Alert description. </param>
        internal Essentials(Severity? severity, SignalType? signalType, AlertState? alertState, MonitorCondition? monitorCondition, string targetResource, string targetResourceName, string targetResourceGroup, string targetResourceType, MonitorService? monitorService, string alertRule, string sourceCreatedId, string smartGroupId, string smartGroupingReason, DateTimeOffset? startOn, DateTimeOffset? lastModifiedOn, DateTimeOffset? monitorConditionResolvedOn, string lastModifiedUserName, ActionStatus actionStatus, string description)
        {
            Severity = severity;
        ...
        internal ActionStatus ActionStatus { get; set; }
