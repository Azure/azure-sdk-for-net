...
{
    public partial class AlertProcessingRuleSchedule : IUtf8JsonSerializable, IJsonModel<AlertProcessingRuleSchedule>, IPersistableModel<AlertProcessingRuleSchedule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EffectiveFrom))
            {
                ...
                builder.AppendLine($" '{EffectiveFrom.Value.ToString()}'");
            }

            if (Optional.IsDefined(EffectiveUntil))
            {
                builder.Append("  effectiveUntil:");
                builder.AppendLine($" '{EffectiveUntil.Value.ToString()}'");
            }
