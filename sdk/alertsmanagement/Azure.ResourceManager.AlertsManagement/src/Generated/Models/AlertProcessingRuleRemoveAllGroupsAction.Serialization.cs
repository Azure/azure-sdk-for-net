...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlertProcessingRuleRemoveAllGroupsAction>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AlertProcessingRuleRemoveAllGroupsAction>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AlertProcessingRuleRemoveAllGroupsAction>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AlertProcessingRuleRemoveAllGroupsAction>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
