        ...
        internal static Condition DeserializeCondition(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("field"))
                {
                    ...
                    field = new Field(property.Value.GetString());
                    continue;
                }
            ...
            return new Condition(Optional.ToNullable(field), Optional.ToNullable(@operator), Optional.ToList(values));
        }
    }
}
