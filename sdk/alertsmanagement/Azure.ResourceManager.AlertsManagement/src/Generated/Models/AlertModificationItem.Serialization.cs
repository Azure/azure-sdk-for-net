...
{
    public partial class AlertModificationItem : IUtf8JsonSerializable
    {
        ...
        internal static AlertModificationItem DeserializeAlertModificationItem(JsonElement element)
        {
            Optional<AlertModificationEvent> modificationEvent = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("modificationEvent"))
                {
                    ...
                    modificationEvent = property.Value.GetString().ToAlertModificationEvent();
                    continue;
                }
            ...
            return new AlertModificationItem(Optional.ToNullable(modificationEvent), oldValue.Value, newValue.Value, modifiedAt.Value, modifiedBy.Value, comments.Value, description.Value);
        }
    }
}
