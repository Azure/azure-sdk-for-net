...
{
    public partial class Essentials : IUtf8JsonSerializable
    {
        ...
        internal static Essentials DeserializeEssentials(JsonElement element)
        {
            Optional<Severity> severity = default;
            Optional<SignalType> signalType = default;
            ...
            Optional<ActionStatus> actionStatus = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("signalType"))
                {
                    ...
                    signalType = new SignalType(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("actionStatus"))
                {
                    ...
                    actionStatus = ActionStatus.DeserializeActionStatus(property.Value);
                    continue;
                }
