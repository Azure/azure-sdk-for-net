...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    public partial class ServiceAlertModificationItemInfo
    {
        ...
        internal ServiceAlertModificationItemInfo(ServiceAlertModificationEvent? modificationEvent, string oldValue, string newValue, string modifiedAt, string modifiedBy, string comments, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
