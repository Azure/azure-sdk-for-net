...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    public partial class AlertProcessingRuleProperties
    {
        ...
        internal AlertProcessingRuleProperties(IList<string> scopes, IList<AlertProcessingRuleCondition> conditions, AlertProcessingRuleSchedule schedule, IList<AlertProcessingRuleAction> actions, string description, bool? isEnabled, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Scopes = scopes;
