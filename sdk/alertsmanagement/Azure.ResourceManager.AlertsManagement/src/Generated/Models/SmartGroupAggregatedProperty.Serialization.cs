...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SmartGroupAggregatedProperty>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SmartGroupAggregatedProperty>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SmartGroupAggregatedProperty>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SmartGroupAggregatedProperty>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
