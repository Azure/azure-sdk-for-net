...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceAlertActionStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceAlertActionStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceAlertActionStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ServiceAlertActionStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
