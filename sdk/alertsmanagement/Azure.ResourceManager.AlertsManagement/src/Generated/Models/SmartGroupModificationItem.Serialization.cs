...
{
    public partial class SmartGroupModificationItem : IUtf8JsonSerializable
    {
        ...
        internal static SmartGroupModificationItem DeserializeSmartGroupModificationItem(JsonElement element)
        {
            ...
            return new SmartGroupModificationItem(Optional.ToNullable(modificationEvent), oldValue.Value, newValue.Value, modifiedAt.Value, modifiedBy.Value, comments.Value, description.Value);
        }
    }
}
