...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    public partial class SmartGroupModificationItemInfo
    {
        ...
        internal SmartGroupModificationItemInfo(SmartGroupModificationEvent? modificationEvent, string oldValue, string newValue, DateTimeOffset? modifiedOn, string modifiedBy, string comments, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
