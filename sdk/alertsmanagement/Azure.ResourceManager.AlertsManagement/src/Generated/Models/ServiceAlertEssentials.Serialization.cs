...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceAlertEssentials>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceAlertEssentials>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceAlertEssentials>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceAlertEssentials>)} interface");
            }
        ...
        string IPersistableModel<ServiceAlertEssentials>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
