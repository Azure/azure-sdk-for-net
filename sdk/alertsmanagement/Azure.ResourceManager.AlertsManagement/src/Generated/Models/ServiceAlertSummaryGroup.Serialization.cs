...
{
    public partial class ServiceAlertSummaryGroup : IUtf8JsonSerializable, IJsonModel<ServiceAlertSummaryGroup>, IPersistableModel<ServiceAlertSummaryGroup>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SmartGroupsCount))
            {
                builder.Append("  smartGroupsCount:");
                builder.AppendLine($" '{SmartGroupsCount.Value.ToString()}'");
            }

            if (Optional.IsDefined(GroupedBy))
            {
                builder.Append("  groupedby:");
                builder.AppendLine($" '{GroupedBy}'");
            }
