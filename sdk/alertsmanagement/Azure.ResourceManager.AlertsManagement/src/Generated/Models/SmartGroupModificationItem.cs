...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SmartGroupModificationItem. </summary>
        ...
        internal SmartGroupModificationItem(SmartGroupModificationEvent? modificationEvent, string oldValue, string newValue, string modifiedAt, string modifiedBy, string comments, string description)
        {
