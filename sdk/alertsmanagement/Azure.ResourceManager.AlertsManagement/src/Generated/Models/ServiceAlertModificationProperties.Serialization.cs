...
{
    public partial class ServiceAlertModificationProperties : IUtf8JsonSerializable, IJsonModel<ServiceAlertModificationProperties>, IPersistableModel<ServiceAlertModificationProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AlertId))
            {
                ...
                builder.AppendLine($" '{AlertId.Value.ToString()}'");
            }
