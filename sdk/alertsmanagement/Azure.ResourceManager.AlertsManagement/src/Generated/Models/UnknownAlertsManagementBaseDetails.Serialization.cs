...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    internal partial class UnknownAlertsManagementBaseDetails : AlertsManagementBaseDetails, IJsonModel<AlertsManagementBaseDetails>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AlertsManagementBaseDetails IPersistableModel<AlertsManagementBaseDetails>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AlertsManagementBaseDetails IJsonModel<AlertsManagementBaseDetails>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
