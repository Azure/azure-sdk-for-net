...
{
    public partial class ServiceAlertProperties : IUtf8JsonSerializable, IJsonModel<ServiceAlertProperties>, IPersistableModel<ServiceAlertProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Essentials))
            {
                builder.Append("  essentials:");
                AppendChildObject(builder, Essentials, options, 2);
            }
            ...
            {
                builder.Append("  egressConfig:");
                builder.AppendLine($" '{EgressConfig.ToString()}'");
            }
