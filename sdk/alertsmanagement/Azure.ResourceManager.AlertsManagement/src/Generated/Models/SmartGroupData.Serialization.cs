...
namespace Azure.ResourceManager.AlertsManagement
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SmartGroupData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SmartGroupData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SmartGroupData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SmartGroupData>)} interface");
            }
        ...
        string IPersistableModel<SmartGroupData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
