...
{
    public partial class AlertProcessingRuleWeeklyRecurrence : Core.IUtf8JsonSerializable
    {
        ...
        internal static AlertProcessingRuleWeeklyRecurrence DeserializeAlertProcessingRuleWeeklyRecurrence(JsonElement element)
        {
            ...
            return new AlertProcessingRuleWeeklyRecurrence(recurrenceType, Core.Optional.ToNullable(startTime), Core.Optional.ToNullable(endTime), daysOfWeek);
        }
    }
}
