...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AlertModificationItem. </summary>
        ...
        internal AlertModificationItem(AlertModificationEvent? modificationEvent, string oldValue, string newValue, string modifiedAt, string modifiedBy, string comments, string description)
        {
