...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    public partial class MonitorServiceList : ServiceAlertMetadataProperties
    {
        ...
        internal MonitorServiceList(ServiceAlertMetadataIdentifier metadataIdentifier, IReadOnlyList<MonitorServiceDetails> data, Dictionary<string, BinaryData> rawData) : base(metadataIdentifier, rawData)
        {
            Data = data;
