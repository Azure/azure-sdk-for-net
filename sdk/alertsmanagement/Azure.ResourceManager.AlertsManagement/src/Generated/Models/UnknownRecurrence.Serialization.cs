...
{
    internal partial class UnknownRecurrence : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static UnknownRecurrence DeserializeUnknownRecurrence(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
