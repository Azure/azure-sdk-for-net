...
{
    internal partial class UnknownRecurrence : IUtf8JsonSerializable, IJsonModel<AlertProcessingRuleRecurrence>, IPersistableModel<AlertProcessingRuleRecurrence>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StartOn))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(StartOn.Value);
            ...
            if (Optional.IsDefined(EndOn))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(EndOn.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
