...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlertProcessingRuleRecurrence>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AlertProcessingRuleRecurrence>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AlertProcessingRuleRecurrence>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AlertProcessingRuleRecurrence>)} interface");
            }
        ...
        string IPersistableModel<AlertProcessingRuleRecurrence>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
