...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    public static partial class ArmAlertsManagementModelFactory
    {
        ...
        public static AlertProcessingRuleData AlertProcessingRuleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, AlertProcessingRuleProperties properties = null)
        {
            ...
            return new AlertProcessingRuleData(id, name, resourceType, systemData, tags, location, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceAlertMetadata(properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceAlertData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceAlertProperties(essentials, context, egressConfig, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceAlertEssentials(severity, signalType, alertState, monitorCondition, targetResource, targetResourceName, targetResourceGroup, targetResourceType, monitorService, alertRule, sourceCreatedId, smartGroupId, smartGroupingReason, startOn, lastModifiedOn, monitorConditionResolvedOn, lastModifiedBy, isSuppressed != null ? new ServiceAlertActionStatus(isSuppressed, new Dictionary<string, BinaryData>()) : null, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceAlertModification(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static ServiceAlertModificationProperties ServiceAlertModificationProperties(Guid? alertId = null, IEnumerable<ServiceAlertModificationItemInfo> modifications = null)
        {
            ...
            return new ServiceAlertModificationProperties(alertId, modifications?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ServiceAlertSummary(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SmartGroupModification(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static SmartGroupModificationProperties SmartGroupModificationProperties(Guid? smartGroupId = null, IEnumerable<SmartGroupModificationItemInfo> modifications = null, string nextLink = null)
        {
            ...
            return new SmartGroupModificationProperties(smartGroupId, modifications?.ToList(), nextLink, new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitorServiceList MonitorServiceList(IEnumerable<MonitorServiceDetails> data = null)
        {
            ...
            return new MonitorServiceList(ServiceAlertMetadataIdentifier.MonitorServiceList, new Dictionary<string, BinaryData>(), data?.ToList());
        }
        ...
        {
            return new MonitorServiceDetails(name, displayName, new Dictionary<string, BinaryData>());
        }
    }
}
