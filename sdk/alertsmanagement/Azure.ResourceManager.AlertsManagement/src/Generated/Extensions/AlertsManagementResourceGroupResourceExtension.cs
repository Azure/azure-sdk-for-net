...
namespace Azure.ResourceManager.AlertsManagement.Mock
{
    ...
    public partial class AlertsManagementResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AlertsManagementResourceGroupResourceExtension"/> class for mocking. </summary>
        protected AlertsManagementResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AlertsManagementResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AlertsManagementResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
