...
namespace Azure.ResourceManager.AlertsManagement.Testing
{
    ...
    public partial class AlertsManagementTenantResourceExtension : ArmResource
    {
        private ClientDiagnostics _serviceAlertAlertsClientDiagnostics;
        private AlertsRestOperations _serviceAlertAlertsRestClient;

        /// <summary> Initializes a new instance of the <see cref="AlertsManagementTenantResourceExtension"/> class for mocking. </summary>
        protected AlertsManagementTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AlertsManagementTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AlertsManagementTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = ServiceAlertAlertsClientDiagnostics.CreateScope("AlertsManagementTenantResourceExtension.GetServiceAlertMetadata");
            scope.Start();
            try
            {
