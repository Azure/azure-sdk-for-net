...
namespace Azure.ResourceManager.AlertsManagement
{
    ...
    public static partial class AlertsManagementExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetAlertProcessingRules();
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetServiceAlerts();
        }
        ...
        {
            return GetSubscriptionResourceExtension(subscriptionResource).GetSmartGroups();
        }
