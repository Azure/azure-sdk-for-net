...
namespace Azure.ResourceManager.AlertsManagement.Mock
{
    ...
    public partial class ServiceAlertResourceExtension : ArmResource
    {
        private ClientDiagnostics _serviceAlertAlertsClientDiagnostics;
        private AlertsRestOperations _serviceAlertAlertsRestClient;

        /// <summary> Initializes a new instance of the <see cref="ServiceAlertResourceExtension"/> class for mocking. </summary>
        protected ServiceAlertResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ServiceAlertResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ServiceAlertResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = ServiceAlertAlertsClientDiagnostics.CreateScope("ServiceAlertResourceExtension.GetServiceAlertMetadata");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<ServiceAlertSummary>> GetServiceAlertSummaryAsync(SubscriptionResourceGetServiceAlertSummaryOptions options, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ServiceAlertAlertsClientDiagnostics.CreateScope("ServiceAlertResourceExtension.GetServiceAlertSummary");
            scope.Start();
            try
            {
