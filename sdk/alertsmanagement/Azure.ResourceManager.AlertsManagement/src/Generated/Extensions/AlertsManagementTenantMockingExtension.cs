...
namespace Azure.ResourceManager.AlertsManagement.Mocking
{
    ...
    internal partial class AlertsManagementTenantMockingExtension : ArmResource
    {
        private ClientDiagnostics _serviceAlertAlertsClientDiagnostics;
        private AlertsRestOperations _serviceAlertAlertsRestClient;

        /// <summary> Initializes a new instance of the <see cref="AlertsManagementTenantMockingExtension"/> class for mocking. </summary>
        protected AlertsManagementTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AlertsManagementTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AlertsManagementTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = ServiceAlertAlertsClientDiagnostics.CreateScope("AlertsManagementTenantMockingExtension.GetServiceAlertMetadata");
            scope.Start();
            try
            {
