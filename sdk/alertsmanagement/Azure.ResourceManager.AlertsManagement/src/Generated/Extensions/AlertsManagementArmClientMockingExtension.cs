...
namespace Azure.ResourceManager.AlertsManagement.Mocking
{
    ...
    internal partial class AlertsManagementArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AlertsManagementArmClientMockingExtension"/> class for mocking. </summary>
        protected AlertsManagementArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AlertsManagementArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AlertsManagementArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal AlertsManagementArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
