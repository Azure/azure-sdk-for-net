...
namespace Azure.ResourceManager.AlertsManagement.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class AlertsManagementSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AlertsManagementSubscriptionResourceExtension"/> class for mocking. </summary>
        protected AlertsManagementSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AlertsManagementSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AlertsManagementSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<ServiceAlertSummary>> GetServiceAlertSummaryAsync(SubscriptionResourceGetServiceAlertSummaryOptions options, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = ServiceAlertAlertsClientDiagnostics.CreateScope("AlertsManagementSubscriptionResourceExtension.GetServiceAlertSummary");
            scope.Start();
            try
            {
