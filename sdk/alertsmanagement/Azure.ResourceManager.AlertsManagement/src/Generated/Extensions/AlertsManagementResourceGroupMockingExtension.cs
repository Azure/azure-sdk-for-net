...
namespace Azure.ResourceManager.AlertsManagement.Mocking
{
    ...
    internal partial class AlertsManagementResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="AlertsManagementResourceGroupMockingExtension"/> class for mocking. </summary>
        protected AlertsManagementResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AlertsManagementResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AlertsManagementResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
