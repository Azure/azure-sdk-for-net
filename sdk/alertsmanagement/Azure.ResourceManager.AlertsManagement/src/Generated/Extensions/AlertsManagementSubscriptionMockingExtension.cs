...
namespace Azure.ResourceManager.AlertsManagement.Mocking
{
    ...
    internal partial class AlertsManagementSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="AlertsManagementSubscriptionMockingExtension"/> class for mocking. </summary>
        protected AlertsManagementSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="AlertsManagementSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal AlertsManagementSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = ServiceAlertAlertsClientDiagnostics.CreateScope("AlertsManagementSubscriptionMockingExtension.GetServiceAlertSummary");
            scope.Start();
            try
            {
