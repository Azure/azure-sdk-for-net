...
namespace Azure.ResourceManager.AlertsManagement.Models
{
    ...
    public partial class ServiceAlertCollectionGetAllOptions
    {
        ...
        /// <summary> This filter allows the selection of the fields (comma separated) which would be part of the essential section. This would allow projecting only the required fields rather than getting the entire content. Default is to fetch all the fields in the essentials section. </summary>
