...
namespace Azure.ResourceManager.TenantActivityLogAlerts
{
    ...
    public partial class TenantActivityLogAlertResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the TenantActivityLogAlert.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /providers/Microsoft.Management/managementGroups/{managementGroupName}/providers/Microsoft.AlertsManagement/tenantActivityLogAlerts/{alertRuleName}. </description>
        ...
        public virtual async Task<ArmOperation<TenantActivityLogAlertResource>> UpdateAsync(WaitUntil waitUntil, TenantActivityLogAlertData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _tenantActivityLogAlertResourcesRestClient.CreateCreateOrUpdateRequest(Id.Parent.Name, Id.Name, TenantActivityLogAlertData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<TenantActivityLogAlertData> response = Response.FromValue(TenantActivityLogAlertData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<TenantActivityLogAlertResource> Update(WaitUntil waitUntil, TenantActivityLogAlertData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
