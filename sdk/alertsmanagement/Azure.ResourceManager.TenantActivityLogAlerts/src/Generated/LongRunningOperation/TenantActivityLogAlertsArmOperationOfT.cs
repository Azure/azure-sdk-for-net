...
{
    internal partial class TenantActivityLogAlertsArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of TenantActivityLogAlertsArmOperation for mocking. </summary>
        protected TenantActivityLogAlertsArmOperation()
        {
        }
        ...
        internal TenantActivityLogAlertsArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal TenantActivityLogAlertsArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal<T>(
                ...
                clientDiagnostics,
                response,
                "TenantActivityLogAlertsArmOperation",
                null,
