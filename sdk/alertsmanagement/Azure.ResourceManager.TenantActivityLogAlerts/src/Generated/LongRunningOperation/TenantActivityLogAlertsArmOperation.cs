...
{
    internal partial class TenantActivityLogAlertsArmOperation : ArmOperation
    {
        ...
        internal TenantActivityLogAlertsArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal TenantActivityLogAlertsArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
