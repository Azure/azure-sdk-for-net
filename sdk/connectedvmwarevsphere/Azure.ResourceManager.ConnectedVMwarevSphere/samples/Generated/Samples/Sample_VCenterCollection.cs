...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Samples
{
    public partial class Sample_VCenterCollection
    {
        ...
        {
            // Generated from example definition: specification/connectedvmware/resource-manager/Microsoft.ConnectedVMwarevSphere/preview/2020-10-01-preview/examples/CreateVCenter.json
            ...
            VCenterCollection collection = resourceGroupResource.GetVCenters();

            // invoke the operation
            string vcenterName = "ContosoVCenter";
            VCenterData data = new VCenterData(new AzureLocation("East US"), "ContosoVMware.contoso.com")
            {
            ...
            ArmOperation<VCenterResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, vcenterName, data);
        ...
        {
            // Generated from example definition: specification/connectedvmware/resource-manager/Microsoft.ConnectedVMwarevSphere/preview/2020-10-01-preview/examples/ListVCentersByResourceGroup.json
