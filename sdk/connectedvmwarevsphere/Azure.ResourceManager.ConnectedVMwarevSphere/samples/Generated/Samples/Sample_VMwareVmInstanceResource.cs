...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Samples
{
    public partial class Sample_VMwareVmInstanceResource
    {
        ...
        public async Task Delete_DeleteVirtualMachine()
        {
            ...
            // invoke the operation
            await vMwareVmInstance.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Stop_StopVirtualMachine()
        {
            ...
            await vMwareVmInstance.StopAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task Start_StartVirtualMachine()
        {
            ...
            // invoke the operation
            await vMwareVmInstance.StartAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Restart_RestartVirtualMachine()
        {
            ...
            // invoke the operation
            await vMwareVmInstance.RestartAsync(WaitUntil.Completed).ConfigureAwait(false);
