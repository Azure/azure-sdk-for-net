...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class VirtualMachineCreateOperation : Operation<VirtualMachine>, IOperationSource<VirtualMachine>
    {
        private readonly OperationInternals<VirtualMachine> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of VirtualMachineCreateOperation for mocking. </summary>
        protected VirtualMachineCreateOperation()
        {
        }

        internal VirtualMachineCreateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<VirtualMachine>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.AzureAsyncOperation, "VirtualMachineCreateOperation");
