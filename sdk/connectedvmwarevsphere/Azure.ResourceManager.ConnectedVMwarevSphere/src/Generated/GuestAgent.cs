...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class GuestAgent : ArmResource
    {
        ...
        internal GuestAgent(ArmClient armClient, GuestAgentData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal GuestAgent(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string guestAgentApiVersion);
        ...
        {
            using var scope = _guestAgentClientDiagnostics.CreateScope("GuestAgent.GetAvailableLocations");
            scope.Start();
            try
            {
