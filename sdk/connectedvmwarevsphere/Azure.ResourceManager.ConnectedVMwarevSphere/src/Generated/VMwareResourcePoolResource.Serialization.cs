...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    public partial class VMwareResourcePoolResource : IJsonModel<VMwareResourcePoolData>
    {
        ...
        {
            return ModelReaderWriter.Read<VMwareResourcePoolData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<VMwareResourcePoolData>(data, options);
        }
