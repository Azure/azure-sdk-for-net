...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class VMwareCluster : ArmResource
    {
        ...
        internal VMwareCluster(ArmClient armClient, VMwareClusterData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal VMwareCluster(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string vMwareClusterClustersApiVersion);
        ...
        {
            using var scope = _vMwareClusterClustersClientDiagnostics.CreateScope("VMwareCluster.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        public async virtual Task<Response<VMwareCluster>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VMwareCluster(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Response<VMwareCluster> Update(ResourcePatch body = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _vMwareClusterClustersRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, body, cancellationToken);
                return Response.FromValue(new VMwareCluster(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
