...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    public partial class VMwareVmTemplateData : IUtf8JsonSerializable, IJsonModel<VMwareVmTemplateData>
    {
        ...
        internal static VMwareVmTemplateData DeserializeVMwareVmTemplateData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VMwareVmTemplateData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation, kind.Value, uuid.Value, vCenterId.Value, moRefId.Value, inventoryItemId.Value, moName.Value, Optional.ToNullable(memorySizeMB), Optional.ToNullable(numCpus), Optional.ToNullable(numCoresPerSocket), Optional.ToNullable(osType), osName.Value, folderPath.Value, networkInterfaces ?? new ChangeTrackingList<VMwareNetworkInterface>(), disks ?? new ChangeTrackingList<VMwareVirtualDisk>(), customResourceName.Value, toolsVersionStatus.Value, toolsVersion.Value, Optional.ToNullable(firmwareType), statuses ?? new ChangeTrackingList<VMwareResourceStatus>(), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
