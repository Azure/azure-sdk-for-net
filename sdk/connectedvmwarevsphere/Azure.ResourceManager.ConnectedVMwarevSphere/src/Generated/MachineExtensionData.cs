...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class MachineExtensionData : TrackedResourceData
    {
        ...
        internal MachineExtensionData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string forceUpdateTag, string publisher, string typePropertiesType, string typeHandlerVersion, bool? autoUpgradeMinorVersion, BinaryData settings, BinaryData protectedSettings, string provisioningState, MachineExtensionPropertiesInstanceView instanceView) : base(id, name, type, systemData, tags, location)
        {
