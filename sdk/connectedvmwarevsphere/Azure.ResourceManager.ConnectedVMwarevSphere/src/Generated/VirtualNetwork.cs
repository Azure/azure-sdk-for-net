...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class VirtualNetwork : ArmResource
    {
        ...
        internal VirtualNetwork(ArmClient armClient, VirtualNetworkData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public async virtual Task<Response<VirtualNetwork>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new VirtualNetwork(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
