...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class InventoryItem : ArmResource
    {
        ...
        internal InventoryItem(ArmClient armClient, InventoryItemData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal InventoryItem(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string inventoryItemApiVersion);
        ...
        public async virtual Task<Response<InventoryItem>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new InventoryItem(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
