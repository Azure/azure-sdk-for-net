...
{
    public partial class ResourcePoolData : IUtf8JsonSerializable, IModelJsonSerializable<ResourcePoolData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<ResourcePoolData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<ResourcePoolData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ResourcePoolData>(this, options.Format);
        ...
        internal static ResourcePoolData DeserializeResourcePoolData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        ResourcePoolData IModelSerializable<ResourcePoolData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<ResourcePoolData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ResourcePoolData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ResourcePoolData"/> to convert. </param>
        public static implicit operator RequestContent(ResourcePoolData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ResourcePoolData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator ResourcePoolData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeResourcePoolData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
