...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourcePoolData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourcePoolData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourcePoolData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourcePoolData>)} interface");
            }
        ...
        string IPersistableModel<ResourcePoolData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
