...
{
    public partial class ResourcePoolData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ResourcePoolData DeserializeResourcePoolData(JsonElement element)
        {
            ...
            Core.Optional<string> cpuSharesLevel = default;
            Core.Optional<long> cpuReservationMHz = default;
            Core.Optional<long> cpuLimitMHz = default;
            Core.Optional<string> memSharesLevel = default;
            Core.Optional<long> memReservationMB = default;
            Core.Optional<long> memLimitMB = default;
            ...
            return new ResourcePoolData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, extendedLocation, kind.Value, uuid.Value, vCenterId.Value, moRefId.Value, inventoryItemId.Value, moName.Value, cpuSharesLevel.Value, Core.Optional.ToNullable(cpuReservationMHz), Core.Optional.ToNullable(cpuLimitMHz), memSharesLevel.Value, Core.Optional.ToNullable(memReservationMB), Core.Optional.ToNullable(memLimitMB), customResourceName.Value, Core.Optional.ToList(statuses), provisioningState.Value);
        }
    }
}
