...
{
    public partial class ResourcePoolData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ResourcePoolData DeserializeResourcePoolData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
