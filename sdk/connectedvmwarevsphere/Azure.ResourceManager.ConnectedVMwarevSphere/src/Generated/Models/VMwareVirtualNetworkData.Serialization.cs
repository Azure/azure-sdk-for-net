...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareVirtualNetworkData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareVirtualNetworkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareVirtualNetworkData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareVirtualNetworkData>)} interface");
            }
        ...
        string IPersistableModel<VMwareVirtualNetworkData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
