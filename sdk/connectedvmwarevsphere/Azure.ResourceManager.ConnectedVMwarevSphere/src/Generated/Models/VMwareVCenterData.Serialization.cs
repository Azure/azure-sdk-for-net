...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareVCenterData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareVCenterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareVCenterData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareVCenterData>)} interface");
            }
        ...
        string IPersistableModel<VMwareVCenterData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
