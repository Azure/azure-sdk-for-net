...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmInstanceHybridIdentityMetadataData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmInstanceHybridIdentityMetadataData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmInstanceHybridIdentityMetadataData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmInstanceHybridIdentityMetadataData>)} interface");
            }
        ...
        VmInstanceHybridIdentityMetadataData IJsonModel<VmInstanceHybridIdentityMetadataData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(VmInstanceHybridIdentityMetadataData)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<VmInstanceHybridIdentityMetadataData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
