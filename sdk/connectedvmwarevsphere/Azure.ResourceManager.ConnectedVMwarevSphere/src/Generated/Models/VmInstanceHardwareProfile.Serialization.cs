...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmInstanceHardwareProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmInstanceHardwareProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmInstanceHardwareProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmInstanceHardwareProfile>)} interface");
            }
        ...
        string IPersistableModel<VmInstanceHardwareProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
