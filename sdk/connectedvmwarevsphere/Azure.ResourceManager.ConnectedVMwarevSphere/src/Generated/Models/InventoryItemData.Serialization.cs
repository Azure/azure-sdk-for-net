...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<InventoryItemData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<InventoryItemData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<InventoryItemData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<InventoryItemData>)} interface");
            }
        ...
        string IPersistableModel<InventoryItemData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
