...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    public partial class GuestCredential : IUtf8JsonSerializable, IModelJsonSerializable<GuestCredential>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GuestCredential>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="GuestCredential"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="GuestCredential"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="GuestCredential"/>. </summary>
