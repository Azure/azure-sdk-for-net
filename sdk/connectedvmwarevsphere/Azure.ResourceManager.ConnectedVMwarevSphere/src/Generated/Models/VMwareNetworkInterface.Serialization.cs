...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareNetworkInterface>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareNetworkInterface>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareNetworkInterface>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareNetworkInterface>)} interface");
            }
        ...
        string IPersistableModel<VMwareNetworkInterface>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
