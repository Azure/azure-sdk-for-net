...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class VirtualMachinePatch
    {
        ...
        internal VirtualMachinePatch(IDictionary<string, string> tags, ManagedServiceIdentity identity, HardwareProfile hardwareProfile, StorageProfileUpdate storageProfile, NetworkProfileUpdate networkProfile, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Tags = tags;
            Identity = identity;
