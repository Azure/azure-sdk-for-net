...
{
    public partial class PlacementProfile : IUtf8JsonSerializable, IJsonModel<PlacementProfile>, IPersistableModel<PlacementProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResourcePoolId))
            {
                ...
                builder.AppendLine($" '{ResourcePoolId}'");
            }

            if (Optional.IsDefined(ClusterId))
            {
                builder.Append("  clusterId:");
                builder.AppendLine($" '{ClusterId}'");
            }
