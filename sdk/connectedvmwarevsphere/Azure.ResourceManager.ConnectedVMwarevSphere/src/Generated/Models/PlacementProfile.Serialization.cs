...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PlacementProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PlacementProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PlacementProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PlacementProfile>)} interface");
            }
        ...
        string IPersistableModel<PlacementProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
