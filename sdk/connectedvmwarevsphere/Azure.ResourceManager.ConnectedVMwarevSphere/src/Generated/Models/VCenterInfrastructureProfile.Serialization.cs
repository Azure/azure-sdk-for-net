...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VCenterInfrastructureProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VCenterInfrastructureProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VCenterInfrastructureProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VCenterInfrastructureProfile>)} interface");
            }
        ...
        string IPersistableModel<VCenterInfrastructureProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
