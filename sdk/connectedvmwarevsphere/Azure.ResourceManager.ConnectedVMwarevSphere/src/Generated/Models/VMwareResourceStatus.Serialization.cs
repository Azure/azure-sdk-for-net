...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareResourceStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareResourceStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareResourceStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VMwareResourceStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
