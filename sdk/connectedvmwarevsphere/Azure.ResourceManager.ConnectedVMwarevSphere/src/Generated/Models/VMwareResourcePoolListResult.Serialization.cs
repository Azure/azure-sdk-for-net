...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareResourcePoolListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareResourcePoolListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareResourcePoolListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareResourcePoolListResult>)} interface");
            }
        ...
        string IPersistableModel<VMwareResourcePoolListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
