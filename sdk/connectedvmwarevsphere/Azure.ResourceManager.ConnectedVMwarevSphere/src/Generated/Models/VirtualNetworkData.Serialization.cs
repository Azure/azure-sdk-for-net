...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    public partial class VirtualNetworkData : Core.IUtf8JsonSerializable
    {
        ...
        internal static VirtualNetworkData DeserializeVirtualNetworkData(JsonElement element)
        {
            ...
            return new VirtualNetworkData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, extendedLocation, kind.Value, uuid.Value, vCenterId.Value, moRefId.Value, inventoryItemId.Value, moName.Value, customResourceName.Value, Core.Optional.ToList(statuses), provisioningState.Value);
        }
    }
}
