...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    public partial class VirtualNetworkData : IUtf8JsonSerializable, IModelJsonSerializable<VirtualNetworkData>
    {
        ...
        internal static VirtualNetworkData DeserializeVirtualNetworkData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VirtualNetworkData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation, kind.Value, uuid.Value, vCenterId.Value, moRefId.Value, inventoryItemId.Value, moName.Value, customResourceName.Value, Optional.ToList(statuses), provisioningState.Value, rawData);
        }
