...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    public partial class InfrastructureProfile : IUtf8JsonSerializable
    {
        ...
        internal static InfrastructureProfile DeserializeInfrastructureProfile(JsonElement element)
        {
            ...
            return new InfrastructureProfile(templateId.Value, vCenterId.Value, moRefId.Value, inventoryItemId.Value, moName.Value, folderPath.Value, instanceUuid.Value, smbiosUuid.Value, Optional.ToNullable(firmwareType), customResourceName.Value);
        }
    }
}
