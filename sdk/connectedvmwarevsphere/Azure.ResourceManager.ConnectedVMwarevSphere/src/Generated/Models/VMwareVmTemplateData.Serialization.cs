...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareVmTemplateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareVmTemplateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareVmTemplateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareVmTemplateData>)} interface");
            }
        ...
        string IPersistableModel<VMwareVmTemplateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
