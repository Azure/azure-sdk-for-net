    ...
    public partial class VMwareVmTemplateData : IUtf8JsonSerializable, IJsonModel<VMwareVmTemplateData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ToolsVersionStatus))
            {
                ...
                if (ToolsVersionStatus.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ToolsVersion))
            {
                ...
                if (ToolsVersion.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
