...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageProfileUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageProfileUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageProfileUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        internal static StorageProfileUpdate DeserializeStorageProfileUpdate(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            Optional<IList<VMwareVirtualDiskUpdate>> disks = default;
        ...
        string IPersistableModel<StorageProfileUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
