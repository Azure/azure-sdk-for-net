...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    public partial class VMwareHostData : IUtf8JsonSerializable
    {
        ...
        internal static VMwareHostData DeserializeVMwareHostData(JsonElement element)
        {
            ...
            return new VMwareHostData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation.Value, kind.Value, uuid.Value, vCenterId.Value, moRefId.Value, inventoryItemId.Value, moName.Value, Optional.ToList(statuses), customResourceName.Value, provisioningState.Value);
        }
    }
}
