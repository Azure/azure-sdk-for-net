...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    public partial class VMwareHostData : IUtf8JsonSerializable, IJsonModel<VMwareHostData>
    {
        ...
        void IJsonModel<VMwareHostData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(VMwareHostData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<VMwareHostData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(VMwareHostData)} does not support '{options.Format}' format.");
            }
        }
