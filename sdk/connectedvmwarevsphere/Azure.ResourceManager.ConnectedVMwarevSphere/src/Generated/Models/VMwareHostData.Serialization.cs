...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareHostData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareHostData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareHostData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareHostData>)} interface");
            }
        ...
        string IPersistableModel<VMwareHostData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
