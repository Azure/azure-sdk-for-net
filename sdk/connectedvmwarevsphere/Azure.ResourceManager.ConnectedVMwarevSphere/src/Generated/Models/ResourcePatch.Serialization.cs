...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourcePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourcePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourcePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourcePatch>)} interface");
            }
        ...
        string IPersistableModel<ResourcePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
