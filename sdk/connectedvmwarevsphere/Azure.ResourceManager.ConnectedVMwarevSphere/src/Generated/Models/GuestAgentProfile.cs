...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class GuestAgentProfile
    {
        ...
        internal GuestAgentProfile(string vmUuid, StatusType? status, DateTimeOffset? lastStatusChange, string agentVersion, IReadOnlyList<ResponseError> errorDetails, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VmUuid = vmUuid;
            Status = status;
