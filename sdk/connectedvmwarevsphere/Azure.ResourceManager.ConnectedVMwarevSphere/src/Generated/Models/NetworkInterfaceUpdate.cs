...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class NetworkInterfaceUpdate
    {
        ...
        internal NetworkInterfaceUpdate(string name, string networkId, NICType? nicType, PowerOnBootOption? powerOnBoot, int? deviceKey, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            NetworkId = networkId;
            NicType = nicType;
