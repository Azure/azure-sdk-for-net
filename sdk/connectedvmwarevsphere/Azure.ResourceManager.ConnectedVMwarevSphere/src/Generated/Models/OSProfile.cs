...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class OSProfile
    {
        ...
        internal OSProfile(string computerName, string adminUsername, string adminPassword, OSType? osType, string osName, string toolsRunningStatus, string toolsVersionStatus, string toolsVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
