...
{
    public partial class VirtualMachineTemplateData : IUtf8JsonSerializable, IModelJsonSerializable<VirtualMachineTemplateData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<VirtualMachineTemplateData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<VirtualMachineTemplateData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualMachineTemplateData>(this, options.Format);
        ...
        internal static VirtualMachineTemplateData DeserializeVirtualMachineTemplateData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VirtualMachineTemplateData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation, kind.Value, uuid.Value, vCenterId.Value, moRefId.Value, inventoryItemId.Value, moName.Value, Optional.ToNullable(memorySizeMB), Optional.ToNullable(numCpus), Optional.ToNullable(numCoresPerSocket), Optional.ToNullable(osType), osName.Value, folderPath.Value, Optional.ToList(networkInterfaces), Optional.ToList(disks), customResourceName.Value, toolsVersionStatus.Value, toolsVersion.Value, Optional.ToNullable(firmwareType), Optional.ToList(statuses), provisioningState.Value, rawData);
        }

        VirtualMachineTemplateData IModelJsonSerializable<VirtualMachineTemplateData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualMachineTemplateData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeVirtualMachineTemplateData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<VirtualMachineTemplateData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualMachineTemplateData>(this, options.Format);
        ...
        VirtualMachineTemplateData IModelSerializable<VirtualMachineTemplateData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<VirtualMachineTemplateData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="VirtualMachineTemplateData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="VirtualMachineTemplateData"/> to convert. </param>
        public static implicit operator RequestContent(VirtualMachineTemplateData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="VirtualMachineTemplateData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator VirtualMachineTemplateData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeVirtualMachineTemplateData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
