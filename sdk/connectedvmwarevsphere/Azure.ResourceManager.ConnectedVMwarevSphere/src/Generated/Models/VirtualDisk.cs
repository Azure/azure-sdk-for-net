...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class VirtualDisk
    {
        ...
        internal VirtualDisk(string name, string label, string diskObjectId, int? diskSizeGB, int? deviceKey, DiskMode? diskMode, int? controllerKey, int? unitNumber, string deviceName, DiskType? diskType, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Label = label;
