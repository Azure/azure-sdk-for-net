...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareHostListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareHostListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareHostListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareHostListResult>)} interface");
            }
        ...
        VMwareHostListResult IJsonModel<VMwareHostListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(VMwareHostListResult)} does not support '{options.Format}' format.");
            }
        ...
        string IPersistableModel<VMwareHostListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
