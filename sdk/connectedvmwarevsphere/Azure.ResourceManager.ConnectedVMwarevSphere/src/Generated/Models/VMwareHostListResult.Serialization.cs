...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareHostListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VMwareHostListResult)} does not support writing '{format}' format.");
            }
            ...
            {
                ((IJsonModel<VMwareHostData>)item).Write(writer, options);
            }
        ...
        VMwareHostListResult IJsonModel<VMwareHostListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VMwareHostListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static VMwareHostListResult DeserializeVMwareHostListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VMwareHostListResult(nextLink, value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<VMwareHostListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VMwareHostListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        VMwareHostListResult IPersistableModel<VMwareHostListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(VMwareHostListResult)} does not support reading '{options.Format}' format.");
            }
        }
