...
{
    internal partial class VMwareHostListResult : IUtf8JsonSerializable, IJsonModel<VMwareHostListResult>, IPersistableModel<VMwareHostListResult>
    {
        ...
        void IJsonModel<VMwareHostListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VMwareHostListResult)} does not support '{format}' format.");
            }
