...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmInstanceGuestAgentListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmInstanceGuestAgentListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmInstanceGuestAgentListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmInstanceGuestAgentListResult>)} interface");
            }
        ...
        VmInstanceGuestAgentListResult IJsonModel<VmInstanceGuestAgentListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(VmInstanceGuestAgentListResult)} does not support '{options.Format}' format.");
            }
        ...
        internal static VmInstanceGuestAgentListResult DeserializeVmInstanceGuestAgentListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(VmInstanceGuestAgentData.DeserializeVmInstanceGuestAgentData(item));
                    }
                    value = array;
                    continue;
                }
            ...
            return new VmInstanceGuestAgentListResult(nextLink.Value, value, serializedAdditionalRawData);
        }
        ...
        string IPersistableModel<VmInstanceGuestAgentListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
