...
{
    internal partial class VmInstanceGuestAgentListResult : IUtf8JsonSerializable, IJsonModel<VmInstanceGuestAgentListResult>, IPersistableModel<VmInstanceGuestAgentListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmInstanceGuestAgentListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VmInstanceGuestAgentListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VmInstanceGuestAgentListResult)} does not support '{format}' format.");
            }
