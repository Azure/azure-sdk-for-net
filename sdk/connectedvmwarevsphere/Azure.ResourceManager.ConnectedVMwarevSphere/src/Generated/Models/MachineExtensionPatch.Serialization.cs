...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    public partial class MachineExtensionPatch : IUtf8JsonSerializable, IModelJsonSerializable<MachineExtensionPatch>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MachineExtensionPatch>(this, options.Format);
        ...
        internal static MachineExtensionPatch DeserializeMachineExtensionPatch(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MachineExtensionPatch(Optional.ToDictionary(tags), forceUpdateTag.Value, publisher.Value, type.Value, typeHandlerVersion.Value, Optional.ToNullable(autoUpgradeMinorVersion), settings.Value, protectedSettings.Value, serializedAdditionalRawData);
        }
