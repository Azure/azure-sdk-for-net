...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class VMwareVirtualDisk
    {
        ...
        internal VMwareVirtualDisk(string name, string label, string diskObjectId, int? diskSizeGB, int? deviceKey, VMwareDiskMode? diskMode, int? controllerKey, int? unitNumber, string deviceName, VMwareDiskType? diskType)
        {
            Name = name;
            Label = label;
