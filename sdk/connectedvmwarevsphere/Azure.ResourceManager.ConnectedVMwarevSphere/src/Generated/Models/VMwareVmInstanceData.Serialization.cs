...
{
    public partial class VMwareVmInstanceData : IUtf8JsonSerializable, IJsonModel<VMwareVmInstanceData>, IPersistableModel<VMwareVmInstanceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PlacementProfile))
            {
                builder.Append("  placementProfile:");
                AppendChildObject(builder, PlacementProfile, options, 2);
            }
            ...
            if (Optional.IsDefined(InfrastructureProfile))
            {
                builder.Append("  infrastructureProfile:");
                AppendChildObject(builder, InfrastructureProfile, options, 2);
            }
