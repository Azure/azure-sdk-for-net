...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    internal partial class VMwareNetworkProfileUpdate : IUtf8JsonSerializable, IJsonModel<VMwareNetworkProfileUpdate>
    {
        ...
        void IJsonModel<VMwareNetworkProfileUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VMwareNetworkProfileUpdate)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(NetworkInterfaces is ChangeTrackingList<VMwareNetworkInterfaceUpdate> collection && collection.IsUndefined))
            {
