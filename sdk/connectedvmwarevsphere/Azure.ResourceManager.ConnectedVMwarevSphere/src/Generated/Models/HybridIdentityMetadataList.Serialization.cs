...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HybridIdentityMetadataList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HybridIdentityMetadataList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HybridIdentityMetadataList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HybridIdentityMetadataList>)} interface");
            }
        ...
        string IPersistableModel<HybridIdentityMetadataList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
