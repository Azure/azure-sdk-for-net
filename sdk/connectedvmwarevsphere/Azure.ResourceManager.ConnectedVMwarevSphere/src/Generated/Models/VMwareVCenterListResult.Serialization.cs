...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareVCenterListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareVCenterListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareVCenterListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareVCenterListResult>)} interface");
            }
        ...
        VMwareVCenterListResult IJsonModel<VMwareVCenterListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(VMwareVCenterListResult)} does not support '{options.Format}' format.");
            }
        ...
        internal static VMwareVCenterListResult DeserializeVMwareVCenterListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new VMwareVCenterListResult(nextLink.Value, value, serializedAdditionalRawData);
        }
        ...
        string IPersistableModel<VMwareVCenterListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
