...
{
    internal partial class VMwareVCenterListResult : IUtf8JsonSerializable, IJsonModel<VMwareVCenterListResult>, IPersistableModel<VMwareVCenterListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareVCenterListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<VMwareVCenterListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(VMwareVCenterListResult)} does not support '{format}' format.");
            }
