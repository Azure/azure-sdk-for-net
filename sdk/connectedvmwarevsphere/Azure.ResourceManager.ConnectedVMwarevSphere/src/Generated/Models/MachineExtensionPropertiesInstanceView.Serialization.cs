...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineExtensionPropertiesInstanceView>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineExtensionPropertiesInstanceView>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineExtensionPropertiesInstanceView>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineExtensionPropertiesInstanceView>)} interface");
            }
        ...
        MachineExtensionPropertiesInstanceView IJsonModel<MachineExtensionPropertiesInstanceView>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IPersistableModel<MachineExtensionPropertiesInstanceView>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        MachineExtensionPropertiesInstanceView IPersistableModel<MachineExtensionPropertiesInstanceView>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<MachineExtensionPropertiesInstanceView>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
