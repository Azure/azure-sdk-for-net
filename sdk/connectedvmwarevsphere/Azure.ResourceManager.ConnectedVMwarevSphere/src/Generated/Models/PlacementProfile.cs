...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class PlacementProfile
    {
        ...
        internal PlacementProfile(string resourcePoolId, string clusterId, string hostId, string datastoreId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
