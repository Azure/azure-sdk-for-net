...
{
    public partial class VMwareClusterData : Core.IUtf8JsonSerializable
    {
        ...
        internal static VMwareClusterData DeserializeVMwareClusterData(JsonElement element)
        {
            ...
            Core.Optional<IReadOnlyList<string>> datastoreIds = default;
            Core.Optional<IReadOnlyList<string>> networkIds = default;
            ...
            return new VMwareClusterData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, extendedLocation, kind.Value, uuid.Value, vCenterId.Value, moRefId.Value, inventoryItemId.Value, moName.Value, Core.Optional.ToList(statuses), customResourceName.Value, Core.Optional.ToList(datastoreIds), Core.Optional.ToList(networkIds), provisioningState.Value);
        }
    }
}
