...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    public partial class VMwareClusterData : IUtf8JsonSerializable
    {
        ...
        internal static VMwareClusterData DeserializeVMwareClusterData(JsonElement element)
        {
            ...
            return new VMwareClusterData(id, name, type, tags, location, extendedLocation.Value, systemData, kind.Value, uuid.Value, vCenterId.Value, moRefId.Value, inventoryItemId.Value, moName.Value, Optional.ToList(statuses), customResourceName.Value, Optional.ToList(datastoreIds), Optional.ToList(networkIds), provisioningState.Value);
        }
    }
}
