...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class MachineExtensionInstanceView
    {
        ...
        internal MachineExtensionInstanceView(string name, string machineExtensionInstanceViewType, string typeHandlerVersion, MachineExtensionInstanceViewStatus status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
