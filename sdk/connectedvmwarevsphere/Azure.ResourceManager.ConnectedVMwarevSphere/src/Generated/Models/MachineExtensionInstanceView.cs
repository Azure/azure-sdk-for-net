...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class MachineExtensionInstanceView
    {
        ...
        /// <param name="viewType"> Specifies the type of the extension; an example is &quot;CustomScriptExtension&quot;. </param>
        /// <param name="typeHandlerVersion"> Specifies the version of the script handler. </param>
        /// <param name="status"> Instance view status. </param>
        internal MachineExtensionInstanceView(string name, string viewType, string typeHandlerVersion, MachineExtensionInstanceViewStatus status)
        {
            Name = name;
            ViewType = viewType;
