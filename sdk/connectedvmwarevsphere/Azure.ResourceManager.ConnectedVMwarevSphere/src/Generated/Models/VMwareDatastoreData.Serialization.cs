...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareDatastoreData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareDatastoreData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareDatastoreData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareDatastoreData>)} interface");
            }
        ...
        string IPersistableModel<VMwareDatastoreData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
