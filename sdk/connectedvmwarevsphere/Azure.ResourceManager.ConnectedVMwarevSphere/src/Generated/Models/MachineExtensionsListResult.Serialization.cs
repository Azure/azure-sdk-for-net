...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MachineExtensionsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MachineExtensionsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MachineExtensionsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MachineExtensionsListResult>)} interface");
            }
        ...
        string IPersistableModel<MachineExtensionsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
