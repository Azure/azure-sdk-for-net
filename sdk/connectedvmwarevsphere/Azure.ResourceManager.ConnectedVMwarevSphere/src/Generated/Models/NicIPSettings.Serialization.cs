...
{
    public partial class NicIPSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NicIPSettings DeserializeNicIPSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
