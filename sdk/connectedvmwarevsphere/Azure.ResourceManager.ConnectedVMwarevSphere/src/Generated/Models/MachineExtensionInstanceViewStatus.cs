...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public partial class MachineExtensionInstanceViewStatus
    {
        ...
        internal MachineExtensionInstanceViewStatus(string code, MachineExtensionStatusLevelType? level, string displayStatus, string message, DateTimeOffset? time, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Level = level;
