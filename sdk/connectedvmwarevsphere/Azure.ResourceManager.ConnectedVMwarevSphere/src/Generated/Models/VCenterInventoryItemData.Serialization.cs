...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VCenterInventoryItemData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VCenterInventoryItemData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VCenterInventoryItemData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VCenterInventoryItemData>)} interface");
            }
        ...
        string IPersistableModel<VCenterInventoryItemData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
