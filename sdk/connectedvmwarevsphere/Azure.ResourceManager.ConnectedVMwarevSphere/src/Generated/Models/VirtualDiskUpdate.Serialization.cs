...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualDiskUpdate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualDiskUpdate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualDiskUpdate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VirtualDiskUpdate>)} interface");
            }
        ...
        string IPersistableModel<VirtualDiskUpdate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
