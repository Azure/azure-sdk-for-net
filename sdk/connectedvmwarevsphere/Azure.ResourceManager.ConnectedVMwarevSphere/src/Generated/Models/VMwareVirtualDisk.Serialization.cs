...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareVirtualDisk>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareVirtualDisk>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareVirtualDisk>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareVirtualDisk>)} interface");
            }
        ...
        string IPersistableModel<VMwareVirtualDisk>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
