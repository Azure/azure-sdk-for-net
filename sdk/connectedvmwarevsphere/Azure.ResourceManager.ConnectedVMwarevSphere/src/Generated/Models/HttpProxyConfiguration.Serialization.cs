...
{
    internal partial class HttpProxyConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HttpProxyConfiguration DeserializeHttpProxyConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
