...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VMwareStorageProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VMwareStorageProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VMwareStorageProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VMwareStorageProfile>)} interface");
            }
        ...
        string IPersistableModel<VMwareStorageProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
