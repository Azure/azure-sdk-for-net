...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class VirtualMachineInstanceResource : ArmResource
    {
        ...
        {
            _virtualMachineInstanceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.ConnectedVMwarevSphere", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, bool? deleteFromHost = null, bool? force = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _virtualMachineInstanceRestClient.DeleteAsync(Id.Parent, deleteFromHost, force, cancellationToken).ConfigureAwait(false);
                var operation = new ConnectedVMwarevSphereArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateDeleteRequest(Id.Parent, deleteFromHost, force).Request, response, OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, bool? deleteFromHost = null, bool? force = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _virtualMachineInstanceRestClient.Delete(Id.Parent, deleteFromHost, force, cancellationToken);
                var operation = new ConnectedVMwarevSphereArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateDeleteRequest(Id.Parent, deleteFromHost, force).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<VirtualMachineInstanceResource>> UpdateAsync(WaitUntil waitUntil, VirtualMachineInstancePatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ConnectedVMwarevSphereArmOperation<VirtualMachineInstanceResource>(new VirtualMachineInstanceOperationSource(Client), _virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateUpdateRequest(Id.Parent, patch).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<VirtualMachineInstanceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, VirtualMachineInstanceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ConnectedVMwarevSphereArmOperation<VirtualMachineInstanceResource>(new VirtualMachineInstanceOperationSource(Client), _virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateCreateOrUpdateRequest(Id.Parent, data).Request, response, OperationFinalStateVia.AzureAsyncOperation);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation> StopAsync(WaitUntil waitUntil, StopVirtualMachineContent content = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ConnectedVMwarevSphereArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateStopRequest(Id.Parent, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation> StartAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ConnectedVMwarevSphereArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateStartRequest(Id.Parent).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        public virtual async Task<ArmOperation> RestartAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ConnectedVMwarevSphereArmOperation(_virtualMachineInstanceClientDiagnostics, Pipeline, _virtualMachineInstanceRestClient.CreateRestartRequest(Id.Parent).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
