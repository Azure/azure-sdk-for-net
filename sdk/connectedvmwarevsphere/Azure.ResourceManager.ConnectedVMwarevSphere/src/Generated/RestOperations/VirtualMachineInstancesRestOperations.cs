...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    internal partial class VirtualMachineInstancesRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string resourceUri, VMwareVmInstanceData data)
        {
            ...
            ((IJsonModel<VMwareVmInstanceData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateUpdateRequest(string resourceUri, VMwareVmInstancePatch patch)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<VMwareVmInstancePatch>)patch).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateStopRequest(string resourceUri, StopVirtualMachineContent content)
        {
            ...
            if (content != null)
            {
                ...
                ((IJsonModel<StopVirtualMachineContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
