...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class ResourcePoolCollection : ArmCollection, IEnumerable<ResourcePool>, IAsyncEnumerable<ResourcePool>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="resourcePoolName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(resourcePoolName))
            {
                throw new ArgumentException($"Parameter {nameof(resourcePoolName)} cannot be null or empty", nameof(resourcePoolName));
            }
