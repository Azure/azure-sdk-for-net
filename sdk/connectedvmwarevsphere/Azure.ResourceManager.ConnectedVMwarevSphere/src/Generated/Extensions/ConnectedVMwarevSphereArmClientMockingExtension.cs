...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Mocking
{
    ...
    internal partial class ConnectedVMwarevSphereArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ConnectedVMwarevSphereArmClientMockingExtension"/> class for mocking. </summary>
        protected ConnectedVMwarevSphereArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConnectedVMwarevSphereArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConnectedVMwarevSphereArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal ConnectedVMwarevSphereArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
