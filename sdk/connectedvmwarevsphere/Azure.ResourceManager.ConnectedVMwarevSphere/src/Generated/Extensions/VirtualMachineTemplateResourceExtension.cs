...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Mock
{
    ...
    public partial class VirtualMachineTemplateResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="VirtualMachineTemplateResourceExtension"/> class for mocking. </summary>
        protected VirtualMachineTemplateResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="VirtualMachineTemplateResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal VirtualMachineTemplateResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
