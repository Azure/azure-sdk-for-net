...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Mock
{
    ...
    public partial class ResourcePoolResourceExtension : ArmResource
    {
        private ClientDiagnostics _resourcePoolClientDiagnostics;
        private ResourcePoolsRestOperations _resourcePoolRestClient;

        /// <summary> Initializes a new instance of the <see cref="ResourcePoolResourceExtension"/> class for mocking. </summary>
        protected ResourcePoolResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ResourcePoolResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ResourcePoolResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<ResourcePoolResource> GetResourcePoolsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new ResourcePoolResource(Client, ResourcePoolData.DeserializeResourcePoolData(e)), ResourcePoolClientDiagnostics, Pipeline, "ResourcePoolResourceExtension.GetResourcePools", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<ResourcePoolResource> GetResourcePools(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => ResourcePoolRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => ResourcePoolRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new ResourcePoolResource(Client, ResourcePoolData.DeserializeResourcePoolData(e)), ResourcePoolClientDiagnostics, Pipeline, "ResourcePoolResourceExtension.GetResourcePools", "value", "nextLink", cancellationToken);
        }
    }
}
