...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Mocking
{
    ...
    internal partial class ConnectedVMwarevSphereResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="ConnectedVMwarevSphereResourceGroupMockingExtension"/> class for mocking. </summary>
        protected ConnectedVMwarevSphereResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ConnectedVMwarevSphereResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ConnectedVMwarevSphereResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
