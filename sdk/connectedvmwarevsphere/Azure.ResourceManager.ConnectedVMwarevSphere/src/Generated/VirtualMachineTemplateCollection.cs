...
namespace Azure.ResourceManager.ConnectedVMwarevSphere
{
    ...
    public partial class VirtualMachineTemplateCollection : ArmCollection, IEnumerable<VirtualMachineTemplate>, IAsyncEnumerable<VirtualMachineTemplate>
    {
        ...
        /// <exception cref="ArgumentException"> <paramref name="virtualMachineTemplateName"/> is null or empty. </exception>
        ...
        {
            if (string.IsNullOrEmpty(virtualMachineTemplateName))
            {
                throw new ArgumentException($"Parameter {nameof(virtualMachineTemplateName)} cannot be null or empty", nameof(virtualMachineTemplateName));
            }
