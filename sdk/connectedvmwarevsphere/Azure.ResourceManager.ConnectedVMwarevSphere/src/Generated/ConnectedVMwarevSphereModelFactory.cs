...
namespace Azure.ResourceManager.ConnectedVMwarevSphere.Models
{
    ...
    public static partial class ConnectedVMwarevSphereModelFactory
    {
        ...
        /// <param name="provisioningState"> Gets or sets the provisioning state. </param>
        /// <returns> A new <see cref="ConnectedVMwarevSphere.InventoryItemData"/> instance for mocking. </returns>
        public static InventoryItemData InventoryItemData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string kind = null, InventoryType inventoryType = default, string managedResourceId = null, string moRefId = null, string moName = null, string provisioningState = null)
        {
            return new InventoryItemData(id, name, resourceType, systemData, kind, inventoryType, managedResourceId, moRefId, moName, provisioningState);
        }
