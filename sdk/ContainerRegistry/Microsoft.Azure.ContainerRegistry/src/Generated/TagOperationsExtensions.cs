...
namespace Microsoft.Azure.ContainerRegistry
{
    ...
    public static partial class TagOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task UpdateAttributesAsync(this ITagOperations operations, string name, string reference, TagChangeableAttributes value = default(TagChangeableAttributes), CancellationToken cancellationToken = default(CancellationToken))
            {
