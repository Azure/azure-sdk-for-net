...
namespace Microsoft.Azure.ContainerRegistry
{
    ...
    public static partial class RepositoryOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task UpdateAttributesAsync(this IRepositoryOperations operations, string name, RepositoryChangeableAttributes value = default(RepositoryChangeableAttributes), CancellationToken cancellationToken = default(CancellationToken))
            {
