...
namespace Microsoft.Azure.ContainerRegistry
{
    ...
    public static partial class ManifestsOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task UpdateAttributesAsync(this IManifestsOperations operations, string name, string reference, ManifestChangeableAttributes value = default(ManifestChangeableAttributes), CancellationToken cancellationToken = default(CancellationToken))
            {
