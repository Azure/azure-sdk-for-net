...
namespace Microsoft.Azure.ContainerRegistry
{
    ...
    public partial interface IRepositoryOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> UpdateAttributesWithHttpMessagesAsync(string name, RepositoryChangeableAttributes value = default(RepositoryChangeableAttributes), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
