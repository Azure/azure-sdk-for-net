...
namespace Microsoft.Azure.ContainerRegistry
{
    ...
    internal partial class ManifestsOperations : IServiceOperations<AzureContainerRegistryClient>, IManifestsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> UpdateAttributesWithHttpMessagesAsync(string name, string reference, ManifestChangeableAttributes value = default(ManifestChangeableAttributes), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.LoginUri == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.LoginUri");
