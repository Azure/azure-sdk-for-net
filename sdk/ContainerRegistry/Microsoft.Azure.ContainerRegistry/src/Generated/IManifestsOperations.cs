...
namespace Microsoft.Azure.ContainerRegistry
{
    ...
    public partial interface IManifestsOperations
    {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse> UpdateAttributesWithHttpMessagesAsync(string name, string reference, ManifestChangeableAttributes value = default(ManifestChangeableAttributes), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
