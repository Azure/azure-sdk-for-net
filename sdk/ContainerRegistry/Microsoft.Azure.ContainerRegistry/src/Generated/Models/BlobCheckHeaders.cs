...
namespace Microsoft.Azure.ContainerRegistry.Models
{
    ...
    /// <summary>
    /// Defines headers for Check operation.
    /// </summary>
    public partial class BlobCheckHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BlobCheckHeaders class.
        /// </summary>
        ...
        /// accessible.</param>
        public BlobCheckHeaders(long? contentLength = default(long?), string dockerContentDigest = default(string), string location = default(string))
        {
