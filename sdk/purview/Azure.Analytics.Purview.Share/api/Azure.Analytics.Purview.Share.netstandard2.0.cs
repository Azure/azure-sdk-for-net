namespace Azure.Analytics.Purview.Share
{
    ...
    {
        public PurviewShareClientOptions(Azure.Analytics.Purview.Share.PurviewShareClientOptions.ServiceVersion version = Azure.Analytics.Purview.Share.PurviewShareClientOptions.ServiceVersion.V2023_02_15_Preview) { }
    ...
    public partial class ReceivedSharesClient
    {
        ...
        public virtual Azure.Operation<System.BinaryData> CreateOrUpdateReceivedShare(Azure.WaitUntil waitUntil, string receivedShareId, Azure.Core.RequestContent content, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Operation<System.BinaryData>> CreateOrUpdateReceivedShareAsync(Azure.WaitUntil waitUntil, string receivedShareId, Azure.Core.RequestContent content, Azure.RequestContext context = null) { throw null; }
        public virtual Azure.Operation DeleteReceivedShare(Azure.WaitUntil waitUntil, string receivedShareId, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Operation> DeleteReceivedShareAsync(Azure.WaitUntil waitUntil, string receivedShareId, Azure.RequestContext context = null) { throw null; }
    ...
    public partial class SentSharesClient
    {
        ...
        public virtual Azure.Core.Pipeline.HttpPipeline Pipeline { get { throw null; } }
        public virtual Azure.Operation<System.BinaryData> CreateSentShare(Azure.WaitUntil waitUntil, string sentShareId, Azure.Core.RequestContent content, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Operation<System.BinaryData>> CreateSentShareAsync(Azure.WaitUntil waitUntil, string sentShareId, Azure.Core.RequestContent content, Azure.RequestContext context = null) { throw null; }
        ...
        public virtual Azure.Operation DeleteSentShare(Azure.WaitUntil waitUntil, string sentShareId, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Operation> DeleteSentShareAsync(Azure.WaitUntil waitUntil, string sentShareId, Azure.RequestContext context = null) { throw null; }
        public virtual Azure.Operation DeleteSentShareInvitation(Azure.WaitUntil waitUntil, string sentShareId, string sentShareInvitationId, Azure.RequestContext context = null) { throw null; }
        public virtual System.Threading.Tasks.Task<Azure.Operation> DeleteSentShareInvitationAsync(Azure.WaitUntil waitUntil, string sentShareId, string sentShareInvitationId, Azure.RequestContext context = null) { throw null; }
