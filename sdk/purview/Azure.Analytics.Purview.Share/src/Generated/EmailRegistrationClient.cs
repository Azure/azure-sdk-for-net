...
namespace Azure.Analytics.Purview.Share
{
    ...
    public partial class EmailRegistrationClient
    {
        ...
        /// <include file="Docs/EmailRegistrationClient.xml" path="doc/members/member[@name='ActivateAsync(RequestContent,RequestContext)']/*" />
        public virtual async Task<Response> ActivateAsync(RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                using HttpMessage message = CreateActivateRequest(content, context);
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/EmailRegistrationClient.xml" path="doc/members/member[@name='Activate(RequestContent,RequestContext)']/*" />
        public virtual Response Activate(RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/EmailRegistrationClient.xml" path="doc/members/member[@name='RegisterAsync(RequestContext)']/*" />
        public virtual async Task<Response> RegisterAsync(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("EmailRegistrationClient.Register");
            scope.Start();
            try
            {
                using HttpMessage message = CreateRegisterRequest(context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/EmailRegistrationClient.xml" path="doc/members/member[@name='Register(RequestContext)']/*" />
        public virtual Response Register(RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("EmailRegistrationClient.Register");
            scope.Start();
            try
        ...
        internal HttpMessage CreateActivateRequest(RequestContent content, RequestContext context)
        {
        ...
        internal HttpMessage CreateRegisterRequest(RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Post;
