...
namespace Azure.Analytics.Purview.Administration.Models
{
    ...
    public static partial class PurviewAdministrationModelFactory
    {
        ...
        /// <returns> A new <see cref="Models.DecisionRule"/> instance for mocking. </returns>
        public static DecisionRule DecisionRule(Kind? kind = null, Decision? effect = null, IEnumerable<IList<AttributeMatcher>> dnfCondition = null)
        {
            dnfCondition ??= new List<IList<AttributeMatcher>>();

            return new DecisionRule(kind, effect, dnfCondition?.ToList());
        }
        ...
        /// <param name="dnfCondition"> The dnf Condition for a rule. </param>
        /// <returns> A new <see cref="Models.AttributeRule"/> instance for mocking. </returns>
        public static AttributeRule AttributeRule(Kind? kind = null, string id = null, string name = null, IEnumerable<IList<AttributeMatcher>> dnfCondition = null)
        {
            dnfCondition ??= new List<IList<AttributeMatcher>>();

            return new AttributeRule(kind, id, name, dnfCondition?.ToList());
        }
        ...
        /// <returns> A new <see cref="Models.CollectionReferenceAutoGenerated"/> instance for mocking. </returns>
        public static CollectionReferenceAutoGenerated CollectionReferenceAutoGenerated(string type = null, string referenceName = null)
        {
            return new CollectionReferenceAutoGenerated(type, referenceName);
        }
    }
}
