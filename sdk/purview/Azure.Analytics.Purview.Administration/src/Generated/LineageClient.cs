...
namespace Azure.Analytics.Purview.Administration
{
    ...
    public partial class LineageClient
    {
        ...
        public LineageClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewAccountClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public LineageClient(Uri endpoint, TokenCredential credential, PurviewAccountClientOptions options)
        {
        ...
        /// var client = new LineageClient(endpoint, credential);
        /// 
