...
{
    public partial class CollectionSystemData
    {
        internal static CollectionSystemData DeserializeCollectionSystemData(JsonElement element)
        {
            ...
            return new CollectionSystemData(Optional.ToNullable(createdAt), createdBy.Value, Optional.ToNullable(createdByType), Optional.ToNullable(lastModifiedAt), lastModifiedBy.Value, Optional.ToNullable(lastModifiedByType));
        }
    }
}
