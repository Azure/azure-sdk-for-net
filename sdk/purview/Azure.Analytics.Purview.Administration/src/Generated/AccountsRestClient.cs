...
namespace Azure.Analytics.Purview.Administration
{
    internal partial class AccountsRestClient
    {
        ...
        public AccountsRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint)
        {
        ...
        public async Task<Response<Account>> GetAccountPropertiesAsync(CancellationToken cancellationToken = default)
        {
                ...
                case 200:
                    {
                        ...
                        value = Account.DeserializeAccount(document.RootElement);
        ...
        /// <summary> Get an account. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response<Account> GetAccountProperties(CancellationToken cancellationToken = default)
        {
            using var message = CreateGetAccountPropertiesRequest();
        ...
        public async Task<Response<Account>> UpdateAccountPropertiesAsync(DataPlaneAccountUpdateParameters accountUpdateParameters, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="accountUpdateParameters"/> is null. </exception>
        public Response<Account> UpdateAccountProperties(DataPlaneAccountUpdateParameters accountUpdateParameters, CancellationToken cancellationToken = default)
        {
            if (accountUpdateParameters == null)
            {
                throw new ArgumentNullException(nameof(accountUpdateParameters));
