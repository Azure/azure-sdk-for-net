...
namespace Azure.Analytics.Purview.Administration
{
    ...
    public partial class ScanResultClient
    {
        ...
        public ScanResultClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewAccountClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public ScanResultClient(Uri endpoint, TokenCredential credential, PurviewAccountClientOptions options)
        {
        ...
        /// var client = new ScanResultClient(endpoint, credential);
        /// 
