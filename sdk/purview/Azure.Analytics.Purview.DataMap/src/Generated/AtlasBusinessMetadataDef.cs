...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class AtlasBusinessMetadataDef
    {
        ...
        internal AtlasBusinessMetadataDef(TypeCategory? category, DateTimeOffset? createTime, string createdBy, AtlasDateFormat dateFormatter, string description, string guid, string name, IDictionary<string, string> options, string serviceType, string typeVersion, DateTimeOffset? updateTime, string updatedBy, long? version, string lastModifiedTS, IList<AtlasAttributeDef> attributeDefs, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Category = category;
