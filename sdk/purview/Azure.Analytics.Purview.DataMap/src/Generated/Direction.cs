...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public readonly partial struct Direction : IEquatable<Direction>
    {
        ...
        public static Direction BOTH { get; } = new Direction(BOTHValue);
        /// <summary> input. </summary>
        public static Direction INPUT { get; } = new Direction(INPUTValue);
        /// <summary> output. </summary>
        public static Direction OUTPUT { get; } = new Direction(OUTPUTValue);
