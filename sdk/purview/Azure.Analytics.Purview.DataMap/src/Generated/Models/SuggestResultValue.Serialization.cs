...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class SuggestResultValue : IJsonModel<global::Azure.Analytics.Purview.DataMap.SuggestResultValue>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SuggestResultValue PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = (options.Format == "W") ? ((IPersistableModel<global::Azure.Analytics.Purview.DataMap.SuggestResultValue>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
                    ...
                    {
                        return global::Azure.Analytics.Purview.DataMap.SuggestResultValue.DeserializeSuggestResultValue(document.RootElement, options);
                    }
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Analytics.Purview.DataMap.SuggestResultValue)} does not support reading '{options.Format}' format.");
            }
        }
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(global::Azure.Analytics.Purview.DataMap.SuggestResultValue)} does not support writing '{options.Format}' format.");
            }
        }

        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<global::Azure.Analytics.Purview.DataMap.SuggestResultValue>.Write(ModelReaderWriterOptions options) => this.PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SuggestResultValue IPersistableModel<global::Azure.Analytics.Purview.DataMap.SuggestResultValue>.Create(BinaryData data, ModelReaderWriterOptions options) => this.PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<global::Azure.Analytics.Purview.DataMap.SuggestResultValue>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="writer"> The JSON writer. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<global::Azure.Analytics.Purview.DataMap.SuggestResultValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Analytics.Purview.DataMap.SuggestResultValue)} does not support writing '{format}' format.");
            }
            ...
            if (global::Azure.Analytics.Purview.DataMap.Optional.IsDefined(SearchText))
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SuggestResultValue IJsonModel<global::Azure.Analytics.Purview.DataMap.SuggestResultValue>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => this.JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual SuggestResultValue JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = (options.Format == "W") ? ((IPersistableModel<global::Azure.Analytics.Purview.DataMap.SuggestResultValue>)this).GetFormatFromOptions(options) : options.Format;
            if ((format != "J"))
            {
                throw new FormatException($"The model {nameof(global::Azure.Analytics.Purview.DataMap.SuggestResultValue)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SuggestResultValue DeserializeSuggestResultValue(JsonElement element, ModelReaderWriterOptions options)
        {
