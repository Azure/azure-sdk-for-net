...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class AtlasStruct
    {
        ...
        internal AtlasStruct(IDictionary<string, BinaryData> attributes, string typeName, string lastModifiedTS, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
