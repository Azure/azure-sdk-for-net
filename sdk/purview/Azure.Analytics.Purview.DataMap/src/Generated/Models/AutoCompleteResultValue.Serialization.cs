...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class AutoCompleteResultValue : IJsonModel<AutoCompleteResultValue>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AutoCompleteResultValue IJsonModel<AutoCompleteResultValue>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AutoCompleteResultValue>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
