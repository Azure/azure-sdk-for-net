...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class AtlasEntityDef : IJsonModel<AtlasEntityDef>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AtlasEntityDef>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AtlasEntityDef IJsonModel<AtlasEntityDef>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        public static explicit operator AtlasEntityDef(Response response)
        {
            ...
            return DeserializeAtlasEntityDef(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
