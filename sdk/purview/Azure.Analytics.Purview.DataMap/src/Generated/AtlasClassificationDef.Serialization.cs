...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AtlasClassificationDef : IUtf8JsonSerializable, IJsonModel<AtlasClassificationDef>
    {
        ...
        void IJsonModel<AtlasClassificationDef>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AtlasClassificationDef)} does not support '{format}' format.");
            }
        ...
        internal static AtlasClassificationDef DeserializeAtlasClassificationDef(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AtlasClassificationDef(Optional.ToNullable(category), Optional.ToNullable(createTime), createdBy.Value, dateFormatter.Value, description.Value, guid.Value, name.Value, Optional.ToDictionary(options0), serviceType.Value, typeVersion.Value, Optional.ToNullable(updateTime), updatedBy.Value, Optional.ToNullable(version), lastModifiedTS.Value, Optional.ToList(attributeDefs), Optional.ToList(entityTypes), Optional.ToList(subTypes), Optional.ToList(superTypes), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AtlasClassificationDef>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AtlasClassificationDef)} does not support '{options.Format}' format.");
            }
        }
