...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class AtlasClassification
    {
        ...
        internal AtlasClassification(IDictionary<string, BinaryData> attributes, string typeName, string lastModifiedTS, string entityGuid, Status? entityStatus, bool? removePropagationsOnEntityDelete, IList<TimeBoundary> validityPeriods)
        {
