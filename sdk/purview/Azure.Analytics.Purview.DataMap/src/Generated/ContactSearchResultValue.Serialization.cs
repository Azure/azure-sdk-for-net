...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContactSearchResultValue>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContactSearchResultValue>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContactSearchResultValue)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ContactSearchResultValue>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ContactSearchResultValue)} does not support '{options.Format}' format.");
            }
        }
