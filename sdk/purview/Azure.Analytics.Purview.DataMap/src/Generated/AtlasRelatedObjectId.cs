...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class AtlasRelatedObjectId
    {
        ...
        internal AtlasRelatedObjectId(string guid, string typeName, IDictionary<string, BinaryData> uniqueAttributes, string displayText, Status? entityStatus, string relationshipType, AtlasStruct relationshipAttributes, string relationshipGuid, StatusAtlasRelationship? relationshipStatus)
        {
            Guid = guid;
            TypeName = typeName;
