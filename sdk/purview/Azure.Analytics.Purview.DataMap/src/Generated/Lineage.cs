...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class Lineage
    {
        ...
        /// <include file="Docs/Lineage.xml" path="doc/members/member[@name='GetLineageAsync(string,Direction,int?,CancellationToken)']/*" />
        public virtual async Task<Response<AtlasLineageInfo>> GetLineageAsync(string guid, Direction direction, int? depth = null, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="guid"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Lineage.xml" path="doc/members/member[@name='GetLineage(string,Direction,int?,CancellationToken)']/*" />
        public virtual Response<AtlasLineageInfo> GetLineage(string guid, Direction direction, int? depth = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(guid, nameof(guid));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetLineageAsync(string,Direction,int?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetLineage(string,Direction,int?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="guid"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Lineage.xml" path="doc/members/member[@name='GetNextPageAsync(string,Direction,int?,int?,CancellationToken)']/*" />
        public virtual async Task<Response<AtlasLineageInfo>> GetNextPageAsync(string guid, Direction direction, int? offset = null, int? limit = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(guid, nameof(guid));
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="guid"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="guid"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Lineage.xml" path="doc/members/member[@name='GetNextPage(string,Direction,int?,int?,CancellationToken)']/*" />
        public virtual Response<AtlasLineageInfo> GetNextPage(string guid, Direction direction, int? offset = null, int? limit = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(guid, nameof(guid));
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetNextPageAsync(string,Direction,int?,int?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetNextPage(string,Direction,int?,int?,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <include file="Docs/Lineage.xml" path="doc/members/member[@name='GetByUniqueAttributeAsync(string,Direction,int?,string,CancellationToken)']/*" />
        public virtual async Task<Response<AtlasLineageInfo>> GetByUniqueAttributeAsync(string typeName, Direction direction, int? depth = null, string attr = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(typeName, nameof(typeName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = await GetByUniqueAttributeAsync(typeName, direction.ToString(), depth, attr, context).ConfigureAwait(false);
            return Response.FromValue(AtlasLineageInfo.FromResponse(response), response);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="typeName"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="typeName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <include file="Docs/Lineage.xml" path="doc/members/member[@name='GetByUniqueAttribute(string,Direction,int?,string,CancellationToken)']/*" />
        public virtual Response<AtlasLineageInfo> GetByUniqueAttribute(string typeName, Direction direction, int? depth = null, string attr = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(typeName, nameof(typeName));

            RequestContext context = FromCancellationToken(cancellationToken);
            Response response = GetByUniqueAttribute(typeName, direction.ToString(), depth, attr, context);
            return Response.FromValue(AtlasLineageInfo.FromResponse(response), response);
        }
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetByUniqueAttributeAsync(string,Direction,int?,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response> GetByUniqueAttributeAsync(string typeName, string direction, int? depth = null, string attr = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(typeName, nameof(typeName));
            Argument.AssertNotNull(direction, nameof(direction));
            ...
            try
            {
                using HttpMessage message = CreateGetByUniqueAttributeRequest(typeName, direction, depth, attr, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <description>
        /// Please try the simpler <see cref="GetByUniqueAttribute(string,Direction,int?,string,CancellationToken)"/> convenience overload with strongly typed models first.
        /// </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual Response GetByUniqueAttribute(string typeName, string direction, int? depth = null, string attr = null, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(typeName, nameof(typeName));
            Argument.AssertNotNull(direction, nameof(direction));
        ...
        internal HttpMessage CreateGetByUniqueAttributeRequest(string typeName, string direction, int? depth, string attr, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
