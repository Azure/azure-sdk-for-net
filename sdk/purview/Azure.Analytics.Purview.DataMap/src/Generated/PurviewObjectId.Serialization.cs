...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PurviewObjectId>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PurviewObjectId>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PurviewObjectId)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PurviewObjectId>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(PurviewObjectId)} does not support '{options.Format}' format.");
            }
        }
