...
{
    /// <summary> The DataMapLineage sub-client. </summary>
    public partial class DataMapLineage
    {
        private readonly Uri _endpoint;
        private readonly string _apiVersion;

        /// <summary> Initializes a new instance of DataMapLineage for mocking. </summary>
        ...
        internal DataMapLineage(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DataMapLineage.GetLineage");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DataMapLineage.GetNextPage");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(guid, nameof(guid));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DataMapLineage.GetByUniqueAttribute");
            scope.Start();
            try
            {
