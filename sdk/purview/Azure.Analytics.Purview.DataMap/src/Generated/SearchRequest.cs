...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class SearchRequest
    {
        ...
        internal SearchRequest(string keywords, int? limit, string continuationToken, IList<BinaryData> orderby, BinaryData filter, IList<SearchFacetItem> facets, SearchRequestTaxonomySetting taxonomySetting)
        {
            Keywords = keywords;
            Limit = limit;
