...
{
    /// <summary> The DataMapRelationship sub-client. </summary>
    public partial class DataMapRelationship
    {
        private readonly Uri _endpoint;

        /// <summary> Initializes a new instance of DataMapRelationship for mocking. </summary>
        ...
        internal DataMapRelationship(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DataMapRelationship.Create");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DataMapRelationship.Update");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DataMapRelationship.GetRelationship");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DataMapRelationship.Delete");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(guid, nameof(guid));
