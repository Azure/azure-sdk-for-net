...
{
    public partial class AtlasEntityDef : IUtf8JsonSerializable
    {
        ...
        internal static AtlasEntityDef DeserializeAtlasEntityDef(JsonElement element)
        {
            ...
            return new AtlasEntityDef(Optional.ToNullable(category), Optional.ToNullable(createTime), createdBy.Value, dateFormatter.Value, description.Value, guid.Value, name.Value, Optional.ToDictionary(options), serviceType.Value, typeVersion.Value, Optional.ToNullable(updateTime), updatedBy.Value, Optional.ToNullable(version), lastModifiedTS.Value, Optional.ToList(attributeDefs), Optional.ToList(subTypes), Optional.ToList(superTypes), Optional.ToList(relationshipAttributeDefs));
        }
