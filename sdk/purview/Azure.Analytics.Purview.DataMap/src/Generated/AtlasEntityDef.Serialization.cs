...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AtlasEntityDef : IUtf8JsonSerializable, IJsonModel<AtlasEntityDef>
    {
        ...
        void IJsonModel<AtlasEntityDef>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AtlasEntityDef)} does not support '{format}' format.");
            }
        ...
        internal static AtlasEntityDef DeserializeAtlasEntityDef(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AtlasEntityDef(Optional.ToNullable(category), Optional.ToNullable(createTime), createdBy.Value, dateFormatter.Value, description.Value, guid.Value, name.Value, Optional.ToDictionary(options0), serviceType.Value, typeVersion.Value, Optional.ToNullable(updateTime), updatedBy.Value, Optional.ToNullable(version), lastModifiedTS.Value, Optional.ToList(attributeDefs), Optional.ToList(subTypes), Optional.ToList(superTypes), Optional.ToList(relationshipAttributeDefs), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AtlasEntityDef>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AtlasEntityDef)} does not support '{options.Format}' format.");
            }
        }
