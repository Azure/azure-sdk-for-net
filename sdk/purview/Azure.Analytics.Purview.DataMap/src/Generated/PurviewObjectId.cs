...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    public partial class PurviewObjectId
    {
        ...
        internal PurviewObjectId(string guid, string typeName, IDictionary<string, BinaryData> uniqueAttributes, string name, string displayText, string itemPath, string resourceId, IDictionary<string, BinaryData> properties)
        {
            Guid = guid;
            TypeName = typeName;
