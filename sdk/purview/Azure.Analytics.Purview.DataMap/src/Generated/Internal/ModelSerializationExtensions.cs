...
namespace Azure.Analytics.Purview.DataMap
{
    internal static partial class ModelSerializationExtensions
    {
        ...
        public static Byte[] GetBytesFromBase64(this JsonElement element, string format)
        {
            ...
            {
                "U" => global::Azure.Analytics.Purview.DataMap.TypeFormatters.FromBase64UrlString(element.GetRequiredString()),
        ...
        public static DateTimeOffset GetDateTimeOffset(this JsonElement element, string format) => format switch
        {
            ...
            _ => global::Azure.Analytics.Purview.DataMap.TypeFormatters.ParseDateTimeOffset(element.GetString(), format)
        };

        public static TimeSpan GetTimeSpan(this JsonElement element, string format) => global::Azure.Analytics.Purview.DataMap.TypeFormatters.ParseTimeSpan(element.GetString(), format);
        ...
        {
            writer.WriteStringValue(global::Azure.Analytics.Purview.DataMap.TypeFormatters.ToString(value, format));
        }
        ...
        public static void WriteBase64StringValue(this Utf8JsonWriter writer, Byte[] value, string format)
        {
            ...
            {
                case "U":
                    writer.WriteStringValue(global::Azure.Analytics.Purview.DataMap.TypeFormatters.ToBase64UrlString(value));
                    break;
                case "D":
        ...
        public static void WriteObjectValue<T>(this Utf8JsonWriter writer, T value, ModelReaderWriterOptions options = ((ModelReaderWriterOptions)null))
        {
            switch (value)
            {
                ...
                case IJsonModel<T> jsonModel:
                    jsonModel.Write(writer, (options ?? global::Azure.Analytics.Purview.DataMap.ModelSerializationExtensions.WireOptions));
                    break;
                case Byte[] bytes:
