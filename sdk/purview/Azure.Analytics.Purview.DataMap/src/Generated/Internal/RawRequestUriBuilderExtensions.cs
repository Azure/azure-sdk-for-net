...
namespace Azure.Analytics.Purview.DataMap
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.Analytics.Purview.DataMap.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.Analytics.Purview.DataMap.TypeFormatters.ConvertToString(v, format));
