...
namespace Azure.Analytics.Purview.DataMap
{
    internal partial class MultiPartFormDataRequestContent : RequestContent
    {
        ...
        {
            _multipartContent = new MultipartFormDataContent(global::Azure.Analytics.Purview.DataMap.MultiPartFormDataRequestContent.CreateBoundary());
        }
        ...
        private void Add(HttpContent content, string name, string filename, string contentType)
        {
            if ((contentType != null))
            {
                global::Azure.Analytics.Purview.DataMap.Argument.AssertNotNullOrEmpty(contentType, nameof(contentType));
                global::Azure.Analytics.Purview.DataMap.MultiPartFormDataRequestContent.AddContentTypeHeader(content, contentType);
            }
            if ((filename != null))
            {
                global::Azure.Analytics.Purview.DataMap.Argument.AssertNotNullOrEmpty(filename, nameof(filename));
