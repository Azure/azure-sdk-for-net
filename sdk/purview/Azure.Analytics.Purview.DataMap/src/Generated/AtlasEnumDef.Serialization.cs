...
{
    public partial class AtlasEnumDef : IUtf8JsonSerializable, IJsonModel<AtlasEnumDef>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AtlasEnumDef>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        AtlasEnumDef IJsonModel<AtlasEnumDef>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AtlasEnumDef>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        internal static AtlasEnumDef DeserializeAtlasEnumDef(JsonElement element, ModelReaderWriterOptions options = null)
        {
        ...
        AtlasEnumDef IPersistableModel<AtlasEnumDef>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<AtlasEnumDef>)this).GetFormatFromOptions(options) : options.Format;
        ...
        internal static AtlasEnumDef FromResponse(Response response)
        {
