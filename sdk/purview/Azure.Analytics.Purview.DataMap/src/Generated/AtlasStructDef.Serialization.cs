...
namespace Azure.Analytics.Purview.DataMap
{
    public partial class AtlasStructDef : IUtf8JsonSerializable, IJsonModel<AtlasStructDef>
    {
        ...
        void IJsonModel<AtlasStructDef>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AtlasStructDef)} does not support '{format}' format.");
            }
        ...
        internal static AtlasStructDef DeserializeAtlasStructDef(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new AtlasStructDef(Optional.ToNullable(category), Optional.ToNullable(createTime), createdBy.Value, dateFormatter.Value, description.Value, guid.Value, name.Value, Optional.ToDictionary(options0), serviceType.Value, typeVersion.Value, Optional.ToNullable(updateTime), updatedBy.Value, Optional.ToNullable(version), lastModifiedTS.Value, Optional.ToList(attributeDefs), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<AtlasStructDef>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AtlasStructDef)} does not support '{options.Format}' format.");
            }
        }
