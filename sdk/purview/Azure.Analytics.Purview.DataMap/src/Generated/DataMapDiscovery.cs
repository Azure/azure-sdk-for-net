...
{
    /// <summary> The DataMapDiscovery sub-client. </summary>
    public partial class DataMapDiscovery
    {
        private readonly Uri _endpoint;
        private readonly string _apiVersion;

        /// <summary> Initializes a new instance of DataMapDiscovery for mocking. </summary>
        ...
        internal DataMapDiscovery(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DataMapDiscovery.Query");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DataMapDiscovery.Suggest");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("DataMapDiscovery.AutoComplete");
            scope.Start();
            try
            {
                Argument.AssertNotNull(content, nameof(content));
