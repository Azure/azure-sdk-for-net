...
namespace Azure.Analytics.Purview.DataMap.Samples
{
    public partial class Samples_Relationship
    {
        ...
        public void Example_Relationship_Create_ShortVersion()
        {
            ...
            Relationship client = new PurviewDataMapClient(endpoint, credential).GetRelationshipClient(apiVersion: "2023-09-01");
        ...
        public void Example_Relationship_Create_ShortVersion_Convenience()
        {
            ...
            Response<AtlasRelationship> response = client.Create(relationship);
        }
        ...
        public async Task Example_Relationship_Create_ShortVersion_Convenience_Async()
        {
            ...
            AtlasRelationship relationship = new AtlasRelationship();
            Response<AtlasRelationship> response = await client.CreateAsync(relationship);
        }
...
["key"] = BinaryData.FromObjectAsJson(new object())
        ...
        public void Example_Relationship_Update_ShortVersion_Convenience()
        {
            ...
            AtlasRelationship relationship = new AtlasRelationship();
            Response<AtlasRelationship> response = client.Update(relationship);
        }
        ...
        public async Task Example_Relationship_Update_ShortVersion_Convenience_Async()
        {
            ...
            AtlasRelationship relationship = new AtlasRelationship();
            Response<AtlasRelationship> response = await client.UpdateAsync(relationship);
        }
