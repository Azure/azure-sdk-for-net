...
"<assetTypes>"
            ...
            JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
            Console.WriteLine(result.GetProperty("searchCount").ToString());
            Console.WriteLine(result.GetProperty("searchCountApproximate").ToString());
            Console.WriteLine(result.GetProperty("continuationToken").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("entityType")[0].GetProperty("count").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("entityType")[0].GetProperty("value").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("assetType")[0].GetProperty("count").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("assetType")[0].GetProperty("value").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("classification")[0].GetProperty("count").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("classification")[0].GetProperty("value").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("term")[0].GetProperty("count").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("term")[0].GetProperty("value").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("contactId")[0].GetProperty("count").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("contactId")[0].GetProperty("value").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("contactType")[0].GetProperty("count").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("contactType")[0].GetProperty("value").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("label")[0].GetProperty("count").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("label")[0].GetProperty("value").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("glossaryType")[0].GetProperty("count").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("glossaryType")[0].GetProperty("value").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("termStatus")[0].GetProperty("count").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("termStatus")[0].GetProperty("value").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("termTemplate")[0].GetProperty("count").ToString());
            Console.WriteLine(result.GetProperty("searchFacets").GetProperty("termTemplate")[0].GetProperty("value").ToString());
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("searchScore").ToString());
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("searchHighlights").GetProperty("id")[0].ToString());
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("searchHighlights").GetProperty("qualifiedName")[0].ToString());
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("searchHighlights").GetProperty("name")[0].ToString());
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("searchHighlights").GetProperty("description")[0].ToString());
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("searchHighlights").GetProperty("entityType")[0].ToString());
...
Value = SearchSortOrder.Ascend,
        ...
        public void Example_Discovery_Suggest_AllParameters()
        {
            ...
            JsonElement result = JsonDocument.Parse(response.ContentStream).RootElement;
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("searchScore").ToString());
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("searchText").ToString());
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("objectType").ToString());
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("createTime").ToString());
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("updateTime").ToString());
            Console.WriteLine(result.GetProperty("value")[0].GetProperty("id").ToString());
