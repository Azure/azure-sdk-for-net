...
namespace Azure.Analytics.Purview.Workflows
{
    ...
    /// <summary> The WorkflowTask service client. </summary>
    public partial class WorkflowTaskClient
    {
        ...
        /// <summary> Initializes a new instance of WorkflowTaskClient for mocking. </summary>
        protected WorkflowTaskClient()
        {
        }

        /// <summary> Initializes a new instance of WorkflowTaskClient. </summary>
        ...
        public WorkflowTaskClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewWorkflowServiceClientOptions())
        {
        }
        ...
        /// <include file="Docs/WorkflowTaskClient.xml" path="doc/members/member[@name='GetWorkflowTaskAsync(Guid,RequestContext)']/*" />
        public virtual async Task<Response> GetWorkflowTaskAsync(Guid taskId, RequestContext context)
        {
            using var scope = ClientDiagnostics.CreateScope("WorkflowTaskClient.GetWorkflowTask");
            scope.Start();
            try
            {
        ...
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        /// <returns> The response returned from the service. </returns>
        /// <include file="Docs/WorkflowTaskClient.xml" path="doc/members/member[@name='GetWorkflowTask(Guid,RequestContext)']/*" />
        ...
        public virtual async Task<Response> ReassignAsync(Guid taskId, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                using HttpMessage message = CreateReassignRequest(taskId, content, context);
                return await _pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
            }
            catch (Exception e)
            {
