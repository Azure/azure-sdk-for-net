...
namespace Azure.Analytics.Purview.Workflows
{
    ...
    public partial class UserRequestsClient
    {
        ...
        public UserRequestsClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewWorkflowServiceClientOptions())
        {
        }
        ...
        internal RequestUriBuilder CreateSubmitRequestUri(RequestContent content, RequestContext context)
        {
