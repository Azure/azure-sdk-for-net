...
namespace Azure.Analytics.Purview.Administrator
{
    ...
    public partial class MetadataRolesClient
    {
        ...
        public MetadataRolesClient(string endpoint, TokenCredential credential, PurviewAdministratorClientOptions options = null)
        {
            if (endpoint == null)
            {
...
#pragma warning disable AZC0002
        public virtual async Task<Response> ListAsync(RequestOptions options = null)
#pragma warning restore AZC0002
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateListRequest();
            RequestOptions.Apply(options, message);
            using var scope = _clientDiagnostics.CreateScope("MetadataRolesClient.List");
            scope.Start();
            try
            {
        ...
        /// <param name="options"> The request options. </param>
#pragma warning disable AZC0002
        public virtual Response List(RequestOptions options = null)
#pragma warning restore AZC0002
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateListRequest();
        ...
        private HttpMessage CreateListRequest()
        {
