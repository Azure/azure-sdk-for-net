...
namespace Azure.Analytics.Purview.Administrator
{
    ...
    public partial class MetadataPolicyClient
    {
        ...
        public MetadataPolicyClient(string endpoint, string collectionName, TokenCredential credential, PurviewAdministratorClientOptions options = null)
        {
            if (endpoint == null)
            {
...
#pragma warning disable AZC0002
        public virtual async Task<Response> ListAllAsync(RequestOptions options = null)
#pragma warning restore AZC0002
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateListAllRequest();
            RequestOptions.Apply(options, message);
            using var scope = _clientDiagnostics.CreateScope("MetadataPolicyClient.ListAll");
            scope.Start();
            try
            {
        ...
        /// <param name="options"> The request options. </param>
#pragma warning disable AZC0002
        public virtual Response ListAll(RequestOptions options = null)
#pragma warning restore AZC0002
        {
            options ??= new RequestOptions();
            using HttpMessage message = CreateListAllRequest();
        ...
        private HttpMessage CreateListAllRequest()
        {
