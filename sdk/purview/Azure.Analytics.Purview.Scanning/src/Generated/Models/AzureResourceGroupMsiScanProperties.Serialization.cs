...
{
    public partial class AzureResourceGroupMsiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureResourceGroupMsiScanProperties DeserializeAzureResourceGroupMsiScanProperties(JsonElement element)
        {
            ...
            return new AzureResourceGroupMsiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
