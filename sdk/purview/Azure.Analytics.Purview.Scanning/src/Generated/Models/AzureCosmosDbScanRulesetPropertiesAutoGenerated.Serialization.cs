...
{
    public partial class AzureCosmosDbScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureCosmosDbScanRulesetPropertiesAutoGenerated DeserializeAzureCosmosDbScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureCosmosDbScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
