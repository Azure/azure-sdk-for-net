...
{
    public partial class AzureSynapseScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseScanRulesetProperties DeserializeAzureSynapseScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSynapseScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
