...
{
    public partial class AzureSqlDatabaseScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseScanRulesetPropertiesAutoGenerated DeserializeAzureSqlDatabaseScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
