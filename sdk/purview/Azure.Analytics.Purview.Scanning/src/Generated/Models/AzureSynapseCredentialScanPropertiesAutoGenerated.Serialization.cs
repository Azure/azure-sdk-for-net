...
{
    public partial class AzureSynapseCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseCredentialScanPropertiesAutoGenerated DeserializeAzureSynapseCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSynapseCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
