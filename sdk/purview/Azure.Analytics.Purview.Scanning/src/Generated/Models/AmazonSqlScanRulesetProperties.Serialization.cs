...
{
    public partial class AmazonSqlScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonSqlScanRulesetProperties DeserializeAmazonSqlScanRulesetProperties(JsonElement element)
        {
            ...
            return new AmazonSqlScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
