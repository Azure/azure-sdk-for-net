...
{
    public partial class AzureSynapseMsiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseMsiScanProperties DeserializeAzureSynapseMsiScanProperties(JsonElement element)
        {
            ...
            return new AzureSynapseMsiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
