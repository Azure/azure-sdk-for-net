...
{
    public partial class OracleScanRulesetPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static OracleScanRulesetPropertiesAutoGenerated DeserializeOracleScanRulesetPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new OracleScanRulesetPropertiesAutoGenerated(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
