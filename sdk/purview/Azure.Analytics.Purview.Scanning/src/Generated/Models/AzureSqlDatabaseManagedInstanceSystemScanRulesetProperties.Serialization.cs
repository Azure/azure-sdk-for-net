...
{
    public partial class AzureSqlDatabaseManagedInstanceSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseManagedInstanceSystemScanRulesetProperties DeserializeAzureSqlDatabaseManagedInstanceSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseManagedInstanceSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
