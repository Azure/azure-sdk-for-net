...
{
    public partial class AzureSubscriptionSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSubscriptionSystemScanRulesetProperties DeserializeAzureSubscriptionSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSubscriptionSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
