...
{
    public partial class AzureSqlDatabaseCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseCredentialScanPropertiesAutoGenerated DeserializeAzureSqlDatabaseCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            Optional<AzureSqlCredentialScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = AzureSqlCredentialScanPropertiesCredential.DeserializeAzureSqlCredentialScanPropertiesCredential(property.Value);
                    continue;
                }
            ...
            return new AzureSqlDatabaseCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value, credential.Value);
        }
    }
}
