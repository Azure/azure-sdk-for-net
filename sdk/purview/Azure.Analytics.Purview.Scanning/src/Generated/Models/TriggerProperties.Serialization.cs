...
namespace Azure.Analytics.Purview.Scanning.Models
{
    public partial class TriggerProperties : IUtf8JsonSerializable
    {
        ...
        internal static TriggerProperties DeserializeTriggerProperties(JsonElement element)
        {
            ...
            return new TriggerProperties(recurrence.Value, recurrenceInterval.Value, Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), Optional.ToNullable(lastScheduled), Optional.ToNullable(scanLevel), Optional.ToNullable(incrementalScanStartTime));
        }
    }
}
