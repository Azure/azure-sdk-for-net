...
{
    public partial class AzureStorageCredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageCredentialScanPropertiesCredential DeserializeAzureStorageCredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new AzureStorageCredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
