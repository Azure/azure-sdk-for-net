...
{
    public partial class AzurePostgreSqlCredentialScanPropertiesCredential : IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlCredentialScanPropertiesCredential DeserializeAzurePostgreSqlCredentialScanPropertiesCredential(JsonElement element)
        {
            ...
            return new AzurePostgreSqlCredentialScanPropertiesCredential(referenceName.Value, Optional.ToNullable(credentialType));
        }
    }
}
