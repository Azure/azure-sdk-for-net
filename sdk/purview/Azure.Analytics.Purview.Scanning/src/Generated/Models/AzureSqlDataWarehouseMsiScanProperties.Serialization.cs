...
{
    public partial class AzureSqlDataWarehouseMsiScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDataWarehouseMsiScanProperties DeserializeAzureSqlDataWarehouseMsiScanProperties(JsonElement element)
        {
            ...
            return new AzureSqlDataWarehouseMsiScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, serverEndpoint.Value, databaseName.Value);
        }
    }
}
