...
{
    public partial class AzureSqlDataWarehouseSystemScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDataWarehouseSystemScanRulesetProperties DeserializeAzureSqlDataWarehouseSystemScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSqlDataWarehouseSystemScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
