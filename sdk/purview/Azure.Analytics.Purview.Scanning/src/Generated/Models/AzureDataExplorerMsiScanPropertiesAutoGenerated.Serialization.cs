...
{
    public partial class AzureDataExplorerMsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureDataExplorerMsiScanPropertiesAutoGenerated DeserializeAzureDataExplorerMsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureDataExplorerMsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, database.Value);
        }
    }
}
