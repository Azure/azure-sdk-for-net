...
{
    public partial class AzurePostgreSqlDataSourceProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzurePostgreSqlDataSourceProperties DeserializeAzurePostgreSqlDataSourceProperties(JsonElement element)
        {
            ...
            return new AzurePostgreSqlDataSourceProperties(Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), collection.Value, resourceGroup.Value, subscriptionId.Value, location.Value, resourceName.Value, serverEndpoint.Value, Optional.ToNullable(port));
        }
    }
}
