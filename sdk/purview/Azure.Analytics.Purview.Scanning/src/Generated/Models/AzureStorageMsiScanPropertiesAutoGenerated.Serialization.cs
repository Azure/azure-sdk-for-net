...
{
    public partial class AzureStorageMsiScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureStorageMsiScanPropertiesAutoGenerated DeserializeAzureStorageMsiScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureStorageMsiScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value);
        }
    }
}
