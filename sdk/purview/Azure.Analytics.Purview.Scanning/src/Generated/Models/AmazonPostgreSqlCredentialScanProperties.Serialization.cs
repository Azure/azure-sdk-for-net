...
{
    public partial class AmazonPostgreSqlCredentialScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonPostgreSqlCredentialScanProperties DeserializeAmazonPostgreSqlCredentialScanProperties(JsonElement element)
        {
            Optional<AmazonPostgreSqlCredentialScanPropertiesCredential> credential = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("credential"))
                {
                    ...
                    credential = AmazonPostgreSqlCredentialScanPropertiesCredential.DeserializeAmazonPostgreSqlCredentialScanPropertiesCredential(property.Value);
                    continue;
                }
            ...
            return new AmazonPostgreSqlCredentialScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, credential.Value, serverEndpoint.Value, databaseName.Value, port.Value);
        }
    }
}
