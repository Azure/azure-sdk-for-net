...
{
    public partial class AzureSqlDatabaseManagedInstanceScanRulesetProperties : IUtf8JsonSerializable
    {
        ...
        internal static AzureSqlDatabaseManagedInstanceScanRulesetProperties DeserializeAzureSqlDatabaseManagedInstanceScanRulesetProperties(JsonElement element)
        {
            ...
            return new AzureSqlDatabaseManagedInstanceScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt));
        }
    }
}
