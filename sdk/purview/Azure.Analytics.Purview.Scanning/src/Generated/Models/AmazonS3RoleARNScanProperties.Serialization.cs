...
{
    public partial class AmazonS3RoleARNScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static AmazonS3RoleARNScanProperties DeserializeAmazonS3RoleARNScanProperties(JsonElement element)
        {
            ...
            return new AmazonS3RoleARNScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, roleARN.Value);
        }
    }
}
