...
{
    public partial class AzureSynapseWorkspaceCredentialScanPropertiesAutoGenerated : IUtf8JsonSerializable
    {
        ...
        internal static AzureSynapseWorkspaceCredentialScanPropertiesAutoGenerated DeserializeAzureSynapseWorkspaceCredentialScanPropertiesAutoGenerated(JsonElement element)
        {
            ...
            return new AzureSynapseWorkspaceCredentialScanPropertiesAutoGenerated(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value, resourceTypes.Value, credential.Value);
        }
    }
}
