...
{
    public partial class AzureStorageScanRulesetProperties : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            if (Optional.IsDefined(ScanningRule))
            {
                writer.WritePropertyName("scanningRule");
                writer.WriteObjectValue(ScanningRule);
            }
        ...
        internal static AzureStorageScanRulesetProperties DeserializeAzureStorageScanRulesetProperties(JsonElement element)
        {
            Optional<ScanningRuleScanRulesetPropertiesScanningRule> scanningRule = default;
            ...
            {
                if (property.NameEquals("scanningRule"))
                {
                    ...
                    scanningRule = ScanningRuleScanRulesetPropertiesScanningRule.DeserializeScanningRuleScanRulesetPropertiesScanningRule(property.Value);
                    continue;
                }
            ...
            return new AzureStorageScanRulesetProperties(Optional.ToNullable(createdAt), description.Value, Optional.ToList(excludedSystemClassifications), Optional.ToList(includedCustomClassificationRuleNames), Optional.ToNullable(lastModifiedAt), scanningRule.Value);
        }
    }
}
