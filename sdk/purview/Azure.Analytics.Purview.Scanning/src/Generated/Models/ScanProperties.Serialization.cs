...
namespace Azure.Analytics.Purview.Scanning.Models
{
    public partial class ScanProperties : IUtf8JsonSerializable
    {
        ...
        internal static ScanProperties DeserializeScanProperties(JsonElement element)
        {
            ...
            return new ScanProperties(scanRulesetName.Value, Optional.ToNullable(scanRulesetType), collection.Value, Optional.ToNullable(workers), Optional.ToNullable(createdAt), Optional.ToNullable(lastModifiedAt), connectedVia.Value);
        }
    }
}
