...
namespace Azure.Analytics.Purview.Scanning
{
    ...
    public partial class PurviewClassificationRuleClient
    {
        ...
        public virtual AsyncPageable<BinaryData> GetVersionsAsync(RequestContext context)
        {
            ...
            return Core.PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "PurviewClassificationRuleClient.GetVersions", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetVersions(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetVersionsRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetVersionsNextPageRequest(nextLink, context);
            return Core.PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "PurviewClassificationRuleClient.GetVersions", "value", "nextLink", context);
        }
