...
{
    // Data plane generated client. The MetadataPolicy service client.
    ...
    public partial class MetadataPolicyClient
    {
        ...
        public MetadataPolicyClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewScanningServiceClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public MetadataPolicyClient(Uri endpoint, TokenCredential credential, PurviewScanningServiceClientOptions options)
        {
        ...
        /// 
        /// </remarks>
        public virtual async Task<Response> UpdateAsync(string policyId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(policyId, nameof(policyId));

            using var scope = ClientDiagnostics.CreateScope("MetadataPolicyClient.Update");
            scope.Start();
            try
            {
                using HttpMessage message = CreateUpdateRequest(policyId, content, context);
        ...
        /// 
        /// </remarks>
        public virtual Response Update(string policyId, RequestContent content, RequestContext context = null)
        {
            Argument.AssertNotNullOrEmpty(policyId, nameof(policyId));
        ...
        public virtual async Task<Response> GetMetadataPolicyAsync(string policyId, RequestContext context = null)
        {
            ...
            using var scope = ClientDiagnostics.CreateScope("MetadataPolicyClient.GetMetadataPolicy");
            scope.Start();
            try
            {
        ...
        /// <param name="collectionName"> The name of an existing collection for which one policy needs to be fetched. </param>
        /// <param name="context"> The request context, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <exception cref="RequestFailedException"> Service returned a non-success status code. </exception>
        ...
        /// 
        /// </remarks>
        public virtual AsyncPageable<BinaryData> GetMetadataPoliciesAsync(string collectionName = null, RequestContext context = null)
        {
            return GetMetadataPoliciesImplementationAsync("MetadataPolicyClient.GetMetadataPolicies", collectionName, context);
        }

        private AsyncPageable<BinaryData> GetMetadataPoliciesImplementationAsync(string diagnosticsScopeName, string collectionName, RequestContext context)
        {
            ...
            async IAsyncEnumerable<Page<BinaryData>> CreateEnumerableAsync(string nextLink, int? pageSizeHint, [EnumeratorCancellation] CancellationToken cancellationToken = default)
            {
                do
                {
                    var message = string.IsNullOrEmpty(nextLink)
                        ? CreateGetMetadataPoliciesRequest(collectionName, context)
                        : CreateGetMetadataPoliciesNextPageRequest(nextLink, collectionName, context);
        ...
        /// 
        /// </remarks>
        public virtual Pageable<BinaryData> GetMetadataPolicies(string collectionName = null, RequestContext context = null)
        {
            return GetMetadataPoliciesImplementation("MetadataPolicyClient.GetMetadataPolicies", collectionName, context);
        }

        private Pageable<BinaryData> GetMetadataPoliciesImplementation(string diagnosticsScopeName, string collectionName, RequestContext context)
        {
        ...
        internal HttpMessage CreateGetMetadataPoliciesRequest(string collectionName, RequestContext context)
        {
            ...
            {
                uri.AppendQuery("collectionName", collectionName, true);
            }
        ...
        internal HttpMessage CreateUpdateRequest(string policyId, RequestContent content, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
        ...
        internal HttpMessage CreateGetMetadataPoliciesNextPageRequest(string nextLink, string collectionName, RequestContext context)
        {
            var message = _pipeline.CreateMessage(context, ResponseClassifier200);
            var request = message.Request;
            request.Method = RequestMethod.Get;
