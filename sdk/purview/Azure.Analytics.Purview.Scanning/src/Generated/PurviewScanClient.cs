...
namespace Azure.Analytics.Purview.Scanning
{
    ...
    public partial class PurviewScanClient
    {
        ...
        /// <summary> Creates an instance of a scan. </summary>
        /// <param name="content"> The content to send as the body of the request. The details of the content are below in the remarks.</param>
        /// <param name="context"> The request context, which can override default behaviors on the request on a per-call basis. </param>
        /// <returns cref="Response"> The details of the response are below in the remarks.</returns>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        ...
        ///<br/>
        /// This method takes one of the scan types below as a payload. Please select a scan type to view the schema for this type.<br/>
