...
namespace Azure.Analytics.Purview.Scanning
{
    ...
    public partial class PurviewDataSourceClient
    {
        ...
        internal RequestUriBuilder CreateGetScansRequestUri(RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/datasources/", false);
        ...
        internal RequestUriBuilder CreateGetScansNextPageRequestUri(string nextLink, RequestContext context)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
