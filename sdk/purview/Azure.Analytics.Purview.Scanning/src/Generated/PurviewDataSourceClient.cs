...
namespace Azure.Analytics.Purview.Scanning
{
    ...
    public partial class PurviewDataSourceClient
    {
        ...
        public virtual AsyncPageable<BinaryData> GetScansAsync(RequestContext context)
        {
            ...
            return Core.PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "PurviewDataSourceClient.GetScans", "value", "nextLink", context);
        }
        ...
        public virtual Pageable<BinaryData> GetScans(RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetScansRequest(context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetScansNextPageRequest(nextLink, context);
            return Core.PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => BinaryData.FromString(e.GetRawText()), ClientDiagnostics, _pipeline, "PurviewDataSourceClient.GetScans", "value", "nextLink", context);
        }
