...
"<includeUriPrefixes>"
        ...
        public void Example_CreateOrUpdate_AllParameters()
        {
            ...
            RequestContent content = RequestContent.Create(new Dictionary<string, object>()
            {
                ["properties"] = new Dictionary<string, object>()
                {
                    ["resourceTypes"] = new Dictionary<string, object>()
                    {
                        ["None"] = new Dictionary<string, object>()
                        {
                            ["scanRulesetName"] = "<scanRulesetName>",
                            ["scanRulesetType"] = "Custom",
                            ["resourceNameFilter"] = new Dictionary<string, object>()
                            {
...
"<resources>"
            ...
            ,
                        ["AzureCosmosDb"] = null
            ,
                        ["AzureDataExplorer"] = null
            ,
                        ["AzureFileService"] = null
            ,
                        ["AzureSqlDatabase"] = null
            ,
                        ["AmazonPostgreSql"] = null
            ,
                        ["AzurePostgreSql"] = null
            ,
                        ["SqlServerDatabase"] = null
            ,
                        ["AzureSqlDatabaseManagedInstance"] = null
            ,
                        ["AzureSqlDataWarehouse"] = null
            ,
                        ["AzureMySql"] = null
            ,
                        ["AzureStorage"] = null
            ...
            ,
                    ...
                    ["workers"] = 1234,
                    ["connectedVia"] = new Dictionary<string, object>()
                    {
                        ["referenceName"] = "<referenceName>",
                    },
                },
