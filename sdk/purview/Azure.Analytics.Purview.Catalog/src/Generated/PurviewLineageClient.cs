...
{
    /// <summary> The PurviewLineage service client. </summary>
    public partial class PurviewLineageClient
    {
        ...
        /// <summary> Initializes a new instance of PurviewLineageClient for mocking. </summary>
        protected PurviewLineageClient()
        {
        }

        /// <summary> Initializes a new instance of PurviewLineageClient. </summary>
        ...
        public PurviewLineageClient(Uri endpoint, TokenCredential credential, PurviewCatalogClientOptions options = null)
        {
            if (endpoint == null)
            {
...
#pragma warning restore AZC0002
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("PurviewLineageClient.GetLineageGraph");
            scope.Start();
            try
            {
...
#pragma warning restore AZC0002
        {
            ...
            RequestOptions.Apply(options, message);
            using var scope = _clientDiagnostics.CreateScope("PurviewLineageClient.NextPageLineage");
            scope.Start();
            try
            {
                await Pipeline.SendAsync(message, options.CancellationToken).ConfigureAwait(false);
