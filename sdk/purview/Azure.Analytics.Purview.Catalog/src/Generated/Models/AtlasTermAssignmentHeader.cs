...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AtlasTermAssignmentHeader. </summary>
        ...
        internal AtlasTermAssignmentHeader(int? confidence, string createdBy, string description, string displayText, string expression, string relationGuid, string source, AtlasTermAssignmentStatus? status, string steward, string termGuid)
        {
