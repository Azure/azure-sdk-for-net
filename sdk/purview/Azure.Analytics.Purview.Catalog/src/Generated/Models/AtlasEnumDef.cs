...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    public partial class AtlasEnumDef : AtlasBaseTypeDef
    {
        /// <summary> Initializes a new instance of AtlasEnumDef. </summary>
        public AtlasEnumDef()
        {
        ...
        internal AtlasEnumDef(TypeCategory? category, float? createTime, string createdBy, DateFormat dateFormatter, string description, string guid, string name, IDictionary<string, string> options, string serviceType, string typeVersion, float? updateTime, string updatedBy, float? version, string lastModifiedTS, string defaultValue, IList<AtlasEnumElementDef> elementDefs) : base(category, createTime, createdBy, dateFormatter, description, guid, name, options, serviceType, typeVersion, updateTime, updatedBy, version, lastModifiedTS)
        {
