...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    public partial class AtlasLineageInfo
    {
        ...
        internal AtlasLineageInfo(string baseEntityGuid, IReadOnlyDictionary<string, AtlasEntityHeader> guidEntityMap, IReadOnlyDictionary<string, IDictionary<string, object>> widthCounts, int? lineageDepth, int? lineageWidth, bool? includeParent, int? childrenCount, LineageDirection? lineageDirection, IReadOnlyList<ParentRelation> parentRelations, IReadOnlyList<LineageRelation> relations)
        {
        ...
        public IReadOnlyDictionary<string, IDictionary<string, object>> WidthCounts { get; }
