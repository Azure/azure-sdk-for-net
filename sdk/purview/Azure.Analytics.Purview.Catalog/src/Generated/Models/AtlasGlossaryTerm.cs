...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    public partial class AtlasGlossaryTerm : AtlasGlossaryBaseObject
    {
        /// <summary> Initializes a new instance of AtlasGlossaryTerm. </summary>
        public AtlasGlossaryTerm()
        {
            TemplateName = new ChangeTrackingList<object>();
            ...
            Attributes = new ChangeTrackingDictionary<string, IDictionary<string, object>>();
        ...
        internal AtlasGlossaryTerm(string guid, IList<AtlasClassification> classifications, string longDescription, string name, string qualifiedName, string shortDescription, string lastModifiedTS, string abbreviation, IList<object> templateName, AtlasGlossaryHeader anchor, IList<AtlasRelatedTermHeader> antonyms, float? createTime, string createdBy, float? updateTime, string updatedBy, TermStatus? status, IList<ResourceLink> resources, IDictionary<string, IList<ContactBasic>> contacts, IDictionary<string, IDictionary<string, object>> attributes, IList<AtlasRelatedObjectId> assignedEntities, IList<AtlasTermCategorizationHeader> categories, IList<AtlasRelatedTermHeader> classifies, IList<string> examples, IList<AtlasRelatedTermHeader> isA, IList<AtlasRelatedTermHeader> preferredTerms, IList<AtlasRelatedTermHeader> preferredToTerms, IList<AtlasRelatedTermHeader> replacedBy, IList<AtlasRelatedTermHeader> replacementTerms, IList<AtlasRelatedTermHeader> seeAlso, IList<AtlasRelatedTermHeader> synonyms, IList<AtlasRelatedTermHeader> translatedTerms, IList<AtlasRelatedTermHeader> translationTerms, string usage, IList<AtlasRelatedTermHeader> validValues, IList<AtlasRelatedTermHeader> validValuesFor) : base(guid, classifications, longDescription, name, qualifiedName, shortDescription, lastModifiedTS)
        {
        ...
        public IList<object> TemplateName { get; }
        ...
        /// The key of the first layer map is term template name.
        /// </summary>
        public IDictionary<string, IDictionary<string, object>> Attributes { get; }
