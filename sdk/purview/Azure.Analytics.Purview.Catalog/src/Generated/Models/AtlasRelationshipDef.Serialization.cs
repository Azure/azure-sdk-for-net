...
{
    public partial class AtlasRelationshipDef : IUtf8JsonSerializable
    {
        ...
        internal static AtlasRelationshipDef DeserializeAtlasRelationshipDef(JsonElement element)
        {
            ...
            return new AtlasRelationshipDef(Optional.ToNullable(category), Optional.ToNullable(createTime), createdBy.Value, dateFormatter.Value, description.Value, guid.Value, name.Value, Optional.ToDictionary(options), serviceType.Value, typeVersion.Value, Optional.ToNullable(updateTime), updatedBy.Value, Optional.ToNullable(version), lastModifiedTS.Value, Optional.ToList(attributeDefs), endDef1.Value, endDef2.Value, Optional.ToNullable(relationshipCategory), relationshipLabel.Value);
        }
    }
}
