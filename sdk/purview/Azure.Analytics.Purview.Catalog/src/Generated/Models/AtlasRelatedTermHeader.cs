...
namespace Azure.Analytics.Purview.Catalog.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AtlasRelatedTermHeader. </summary>
        ...
        internal AtlasRelatedTermHeader(string description, string displayText, string expression, string relationGuid, string source, AtlasTermRelationshipStatus? status, string steward, string termGuid)
        {
