...
{
    public partial class AtlasGlossaryCategory : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            {
                writer.WritePropertyName("childrenCategories");
            ...
            {
                writer.WritePropertyName("parentCategory");
        ...
        internal static AtlasGlossaryCategory DeserializeAtlasGlossaryCategory(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("childrenCategories"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
                ...
                if (property.NameEquals("parentCategory"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        property.ThrowNonNullablePropertyIsNull();
            ...
            return new AtlasGlossaryCategory(guid.Value, Optional.ToList(classifications), longDescription.Value, name.Value, qualifiedName.Value, shortDescription.Value, lastModifiedTS.Value, anchor.Value, Optional.ToList(childrenCategories), parentCategory.Value, Optional.ToList(terms));
        }
    }
}
