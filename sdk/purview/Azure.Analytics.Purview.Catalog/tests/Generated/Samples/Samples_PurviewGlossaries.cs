...
"<termGuids>"
        ...
        public void Example_ImportGlossaryTermsViaCsv_ShortVersion()
        {
            ...
            Operation<BinaryData> operation = client.ImportGlossaryTermsViaCsv(WaitUntil.Completed, "<glossaryGuid>", content, new ContentType("multipart/form-data"));
        ...
        public async Task Example_ImportGlossaryTermsViaCsv_ShortVersion_Async()
        {
            ...
            using RequestContent content = RequestContent.Create(File.OpenRead("<filePath>"));
            Operation<BinaryData> operation = await client.ImportGlossaryTermsViaCsvAsync(WaitUntil.Completed, "<glossaryGuid>", content, new ContentType("multipart/form-data"));
            BinaryData responseData = operation.Value;
        ...
        public void Example_ImportGlossaryTermsViaCsv_AllParameters()
        {
            ...
            using RequestContent content = RequestContent.Create(File.OpenRead("<filePath>"));
            Operation<BinaryData> operation = client.ImportGlossaryTermsViaCsv(WaitUntil.Completed, "<glossaryGuid>", content, new ContentType("multipart/form-data"), includeTermHierarchy: true);
            BinaryData responseData = operation.Value;
        ...
        public async Task Example_ImportGlossaryTermsViaCsv_AllParameters_Async()
        {
            ...
            using RequestContent content = RequestContent.Create(File.OpenRead("<filePath>"));
            Operation<BinaryData> operation = await client.ImportGlossaryTermsViaCsvAsync(WaitUntil.Completed, "<glossaryGuid>", content, new ContentType("multipart/form-data"), includeTermHierarchy: true);
            BinaryData responseData = operation.Value;
        ...
        public void Example_ImportGlossaryTermsViaCsvByGlossaryName_ShortVersion()
        {
            ...
            using RequestContent content = RequestContent.Create(File.OpenRead("<filePath>"));
            Operation<BinaryData> operation = client.ImportGlossaryTermsViaCsvByGlossaryName(WaitUntil.Completed, "<glossaryName>", content, new ContentType("multipart/form-data"));
            BinaryData responseData = operation.Value;
        ...
        public async Task Example_ImportGlossaryTermsViaCsvByGlossaryName_ShortVersion_Async()
        {
            ...
            using RequestContent content = RequestContent.Create(File.OpenRead("<filePath>"));
            Operation<BinaryData> operation = await client.ImportGlossaryTermsViaCsvByGlossaryNameAsync(WaitUntil.Completed, "<glossaryName>", content, new ContentType("multipart/form-data"));
            BinaryData responseData = operation.Value;
        ...
        public void Example_ImportGlossaryTermsViaCsvByGlossaryName_AllParameters()
        {
            ...
            using RequestContent content = RequestContent.Create(File.OpenRead("<filePath>"));
            Operation<BinaryData> operation = client.ImportGlossaryTermsViaCsvByGlossaryName(WaitUntil.Completed, "<glossaryName>", content, new ContentType("multipart/form-data"), includeTermHierarchy: true);
            BinaryData responseData = operation.Value;
        ...
        public async Task Example_ImportGlossaryTermsViaCsvByGlossaryName_AllParameters_Async()
        {
            ...
            using RequestContent content = RequestContent.Create(File.OpenRead("<filePath>"));
            Operation<BinaryData> operation = await client.ImportGlossaryTermsViaCsvByGlossaryNameAsync(WaitUntil.Completed, "<glossaryName>", content, new ContentType("multipart/form-data"), includeTermHierarchy: true);
            BinaryData responseData = operation.Value;
