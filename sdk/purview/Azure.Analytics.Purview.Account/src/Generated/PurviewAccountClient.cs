...
namespace Azure.Analytics.Purview.Account
{
    ...
    public partial class PurviewAccountClient
    {
        ...
        {
            return Volatile.Read(ref _cachedPurviewCollection) ?? Interlocked.CompareExchange(ref _cachedPurviewCollection, new PurviewCollection(ClientDiagnostics, _pipeline, _tokenCredential, _endpoint, _collectionName, _apiVersion), null) ?? _cachedPurviewCollection;
        }
