...
{
    public partial class AccountSystemData
    {
        internal static AccountSystemData DeserializeAccountSystemData(JsonElement element)
        {
            ...
            return new AccountSystemData(Optional.ToNullable(createdAt), createdBy.Value, Optional.ToNullable(createdByType), Optional.ToNullable(lastModifiedAt), lastModifiedBy.Value, Optional.ToNullable(lastModifiedByType));
        }
    }
}
