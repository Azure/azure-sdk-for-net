        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("privateEndpoint"))
                {
                    ...
                    privateEndpoint = PrivateEndpoint.DeserializePrivateEndpoint(property.Value);
                    continue;
                }
            ...
            return new PrivateEndpointConnectionProperties(privateEndpoint.Value, privateLinkServiceConnectionState.Value, provisioningState.Value);
        }
    }
}
