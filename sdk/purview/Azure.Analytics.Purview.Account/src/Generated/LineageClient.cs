...
namespace Azure.Analytics.Purview.Account
{
    ...
    public partial class LineageClient
    {
        ...
        public LineageClient(string endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewAccountClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public LineageClient(string endpoint, TokenCredential credential, PurviewAccountClientOptions options)
        {
        ...
        /// var client = new LineageClient("<https://my-service.azure.com>", credential);
        /// 
