namespace Azure.Analytics.Purview.Sharing
{
    ...
    {
        public PurviewShareClientOptions(Azure.Analytics.Purview.Sharing.PurviewShareClientOptions.ServiceVersion version = Azure.Analytics.Purview.Sharing.PurviewShareClientOptions.ServiceVersion.V2023_02_15_Preview) { }
    ...
    public partial class ReceivedSharesClient
    {
        ...
        public ReceivedSharesClient(string endpoint, Azure.Core.TokenCredential credential, Azure.Analytics.Purview.Sharing.PurviewShareClientOptions options) { }
        ...
        public virtual Azure.Pageable<System.BinaryData> GetAllAttachedReceivedShares(string referenceName, string skipToken, string filter, string orderby, Azure.RequestContext context) { throw null; }
        public virtual Azure.AsyncPageable<System.BinaryData> GetAllAttachedReceivedSharesAsync(string referenceName, string skipToken, string filter, string orderby, Azure.RequestContext context) { throw null; }
        public virtual Azure.Pageable<System.BinaryData> GetAllDetachedReceivedShares(string skipToken, string filter, string orderby, Azure.RequestContext context) { throw null; }
        public virtual Azure.AsyncPageable<System.BinaryData> GetAllDetachedReceivedSharesAsync(string skipToken, string filter, string orderby, Azure.RequestContext context) { throw null; }
    ...
    public partial class SentSharesClient
    {
        ...
        public SentSharesClient(string endpoint, Azure.Core.TokenCredential credential, Azure.Analytics.Purview.Sharing.PurviewShareClientOptions options) { }
        public virtual Azure.Core.Pipeline.HttpPipeline Pipeline { get { throw null; } }
        ...
        public virtual Azure.Pageable<System.BinaryData> GetAllSentShareInvitations(string sentShareId, string skipToken, string filter, string orderby, Azure.RequestContext context) { throw null; }
        public virtual Azure.AsyncPageable<System.BinaryData> GetAllSentShareInvitationsAsync(string sentShareId, string skipToken, string filter, string orderby, Azure.RequestContext context) { throw null; }
        public virtual Azure.Pageable<System.BinaryData> GetAllSentShares(string referenceName, string skipToken, string filter, string orderby, Azure.RequestContext context) { throw null; }
        public virtual Azure.AsyncPageable<System.BinaryData> GetAllSentSharesAsync(string referenceName, string skipToken, string filter, string orderby, Azure.RequestContext context) { throw null; }
