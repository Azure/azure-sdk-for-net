...
namespace Azure.Analytics.Purview.Sharing
{
    ...
    public partial class ReceivedSharesClient
    {
        ...
        public virtual AsyncPageable<BinaryData> GetAllAttachedReceivedSharesAsync(string referenceName, string skipToken, string filter, string orderby, RequestContext context)
        {
        ...
        public virtual Pageable<BinaryData> GetAllAttachedReceivedShares(string referenceName, string skipToken, string filter, string orderby, RequestContext context)
        {
            Argument.AssertNotNull(referenceName, nameof(referenceName));
        ...
        public virtual AsyncPageable<BinaryData> GetAllDetachedReceivedSharesAsync(string skipToken, string filter, string orderby, RequestContext context)
        {
        ...
        public virtual Pageable<BinaryData> GetAllDetachedReceivedShares(string skipToken, string filter, string orderby, RequestContext context)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CreateGetAllDetachedReceivedSharesRequest(skipToken, filter, orderby, context);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => CreateGetAllDetachedReceivedSharesNextPageRequest(nextLink, skipToken, filter, orderby, context);
