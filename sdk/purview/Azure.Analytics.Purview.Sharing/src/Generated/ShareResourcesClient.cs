...
namespace Azure.Analytics.Purview.Sharing
{
    ...
    public partial class ShareResourcesClient
    {
        ...
        /// <summary> Initializes a new instance of ShareResourcesClient for mocking. </summary>
        protected ShareResourcesClient()
        {
        }

        /// <summary> Initializes a new instance of ShareResourcesClient. </summary>
        ...
        public ShareResourcesClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new PurviewShareClientOptions())
        {
        }
        ...
        /// <summary>
        /// [Protocol Method] API operation to list ShareResources.
        /// <list type="bullet">
        /// <item>
        /// <description>
