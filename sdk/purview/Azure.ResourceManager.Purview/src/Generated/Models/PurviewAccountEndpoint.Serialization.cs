...
namespace Azure.ResourceManager.Purview.Models
{
    ...
    public partial class PurviewAccountEndpoint : IJsonModel<PurviewAccountEndpoint>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PurviewAccountEndpoint>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PurviewAccountEndpoint DeserializePurviewAccountEndpoint(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new PurviewAccountEndpoint(catalog, scan, additionalBinaryDataProperties);
        }
    }
}
