...
namespace Azure.ResourceManager.Purview.Models
{
    internal partial class UsageList : IUtf8JsonSerializable, IJsonModel<UsageList>
    {
        ...
        void IJsonModel<UsageList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(UsageList)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (options.Format != "W" && !(Value is ChangeTrackingList<PurviewUsage> collection && collection.IsUndefined))
            {
        ...
        internal static UsageList DeserializeUsageList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UsageList(Optional.ToList(value), nextLink.Value, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<UsageList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(UsageList)} does not support '{options.Format}' format.");
            }
        }
