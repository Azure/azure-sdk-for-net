...
namespace Azure.ResourceManager.Purview.Models
{
    ...
    {
        internal static PrivateEndpointConnectionList DeserializePrivateEndpointConnectionList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
