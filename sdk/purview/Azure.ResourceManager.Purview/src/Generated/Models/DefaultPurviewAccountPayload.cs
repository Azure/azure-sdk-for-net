...
namespace Azure.ResourceManager.Purview.Models
{
    ...
    public partial class DefaultPurviewAccountPayload
    {
        ...
        internal DefaultPurviewAccountPayload(string accountName, string resourceGroupName, string scope, Guid? scopeTenantId, PurviewAccountScopeType? scopeType, string subscriptionId, Dictionary<string, BinaryData> rawData)
        {
