...
namespace Azure.ResourceManager.Purview.Models
{
    ...
    internal partial class UsageList
    {
        ...
        internal UsageList(IEnumerable<PurviewUsage> value)
        {
            Value = value.ToList();
        }
        ...
        internal UsageList(IList<PurviewUsage> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<PurviewUsage> Value { get; }
