    ...
    public partial class PurviewAccountData : IUtf8JsonSerializable, IJsonModel<PurviewAccountData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AccountStatus))
            {
                ...
                AppendChildObject(builder, AccountStatus, options, 4, false);
            }

            if (Optional.IsDefined(CloudConnectors))
            {
                builder.Append("    cloudConnectors:");
                AppendChildObject(builder, CloudConnectors, options, 4, false);
            }
            ...
            {
                builder.Append("    createdByObjectId:");
                if (CreatedByObjectId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{CreatedByObjectId}'''");
                }
                else
                {
                    builder.AppendLine($" '{CreatedByObjectId}'");
            ...
            if (Optional.IsDefined(IngestionStorage))
            {
                builder.Append("    ingestionStorage:");
                AppendChildObject(builder, IngestionStorage, options, 4, false);
            }

            if (Optional.IsDefined(ManagedEventHubState))
            {
                builder.Append("    managedEventHubState:");
                builder.AppendLine($" '{ManagedEventHubState.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ManagedResources))
            {
                ...
                AppendChildObject(builder, ManagedResources, options, 4, false);
            }

            if (Optional.IsDefined(ManagedResourcesPublicNetworkAccess))
            {
                builder.Append("    managedResourcesPublicNetworkAccess:");
                builder.AppendLine($" '{ManagedResourcesPublicNetworkAccess.Value.ToString()}'");
            }
