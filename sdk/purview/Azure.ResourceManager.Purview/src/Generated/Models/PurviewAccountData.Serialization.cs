...
namespace Azure.ResourceManager.Purview
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PurviewAccountData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PurviewAccountData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PurviewAccountData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PurviewAccountData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
