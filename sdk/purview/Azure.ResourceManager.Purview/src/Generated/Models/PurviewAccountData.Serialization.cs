...
{
    public partial class PurviewAccountData : IUtf8JsonSerializable, IJsonModel<PurviewAccountData>, IPersistableModel<PurviewAccountData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CloudConnectors))
            {
                ...
                AppendChildObject(builder, CloudConnectors, options, 2);
            }
            ...
            if (Optional.IsDefined(ManagedResources))
            {
                ...
                AppendChildObject(builder, ManagedResources, options, 2);
            }
