...
{
    public partial class PurviewAccountAccessKey : IUtf8JsonSerializable, IJsonModel<PurviewAccountAccessKey>, IPersistableModel<PurviewAccountAccessKey>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AtlasKafkaPrimaryEndpoint))
            {
                builder.Append("  atlasKafkaPrimaryEndpoint:");
                builder.AppendLine($" '{AtlasKafkaPrimaryEndpoint}'");
            }

            if (Optional.IsDefined(AtlasKafkaSecondaryEndpoint))
            {
                builder.Append("  atlasKafkaSecondaryEndpoint:");
                builder.AppendLine($" '{AtlasKafkaSecondaryEndpoint}'");
            }
