...
namespace Azure.ResourceManager.Purview.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PurviewAccountPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PurviewAccountPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PurviewAccountPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PurviewAccountPatch>)} interface");
            }
        ...
        string IPersistableModel<PurviewAccountPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
