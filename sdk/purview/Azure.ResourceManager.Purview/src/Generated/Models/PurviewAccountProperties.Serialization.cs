...
namespace Azure.ResourceManager.Purview.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PurviewAccountProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PurviewAccountProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PurviewAccountProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PurviewAccountProperties>)} interface");
            }
        ...
        string IPersistableModel<PurviewAccountProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
