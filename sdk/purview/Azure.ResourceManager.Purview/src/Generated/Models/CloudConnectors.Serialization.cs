...
namespace Azure.ResourceManager.Purview.Models
{
    internal partial class CloudConnectors : IUtf8JsonSerializable, IJsonModel<CloudConnectors>
    {
        ...
        void IJsonModel<CloudConnectors>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CloudConnectors)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CloudConnectors>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CloudConnectors)} does not support '{options.Format}' format.");
            }
        }
