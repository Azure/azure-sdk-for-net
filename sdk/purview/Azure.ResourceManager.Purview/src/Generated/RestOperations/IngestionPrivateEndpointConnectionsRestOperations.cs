...
namespace Azure.ResourceManager.Purview
{
    internal partial class IngestionPrivateEndpointConnections
    {
        ...
        internal IngestionPrivateEndpointConnections(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(IngestionPrivateEndpointConnections).Assembly, applicationId);
        }
