...
namespace Azure.ResourceManager.Purview
{
    internal partial class Accounts
    {
        ...
        internal HttpMessage CreateAddRootCollectionAdminRequest(Guid subscriptionId, string resourceGroupName, string accountName, RequestContent content, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
