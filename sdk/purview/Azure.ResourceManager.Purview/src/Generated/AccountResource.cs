    ...
    public partial class AccountResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AccountResource>> UpdateAsync(WaitUntil waitUntil, AccountPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _accountsRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, AccountPatch.ToRequestContent(patch), context);
        ...
        public virtual async Task<Response<PurviewBatchFeatureStatus>> AccountGetAsync(PurviewBatchFeatureContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _featuresRestClient.CreateAccountGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, PurviewBatchFeatureContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        public virtual async Task<Response> AddRootCollectionAdminAsync(CollectionAdminUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _accountsRestClient.CreateAddRootCollectionAdminRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CollectionAdminUpdateContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        public virtual Pageable<PrivateEndpointConnectionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<PurviewPrivateEndpointConnectionData, PrivateEndpointConnectionResource>(new IngestionPrivateEndpointConnectionsGetAllCollectionResultOfT(_ingestionPrivateEndpointConnectionsRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new PrivateEndpointConnectionResource(Client, data));
        }
        ...
        public virtual async Task<Response<PrivateEndpointConnectionStatusUpdateResult>> UpdateStatusAsync(PrivateEndpointConnectionStatusUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _ingestionPrivateEndpointConnectionsRestClient.CreateUpdateStatusRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, PrivateEndpointConnectionStatusUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
