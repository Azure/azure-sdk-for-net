...
namespace Azure.ResourceManager.Purview.Mocking
{
    ...
    internal partial class PurviewResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PurviewResourceGroupMockingExtension"/> class for mocking. </summary>
        protected PurviewResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PurviewResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PurviewResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
