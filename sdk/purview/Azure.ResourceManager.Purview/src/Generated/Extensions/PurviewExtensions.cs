...
using Azure.ResourceManager.Purview.Testing;
...
namespace Azure.ResourceManager.Purview
{
    ...
    public static partial class PurviewExtensions
    {
        ...
        private static PurviewSubscriptionResourceExtension GetPurviewSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new PurviewSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static PurviewSubscriptionResourceExtension GetPurviewSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new PurviewSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetPurviewSubscriptionResourceExtension(subscriptionResource).GetPurviewAccountsAsync(skipToken, cancellationToken);
        }
        ...
        {
            return GetPurviewSubscriptionResourceExtension(subscriptionResource).GetPurviewAccounts(skipToken, cancellationToken);
        }
        ...
        public static async Task<Response<PurviewAccountNameAvailabilityResult>> CheckPurviewAccountNameAvailabilityAsync(this SubscriptionResource subscriptionResource, PurviewAccountNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetPurviewSubscriptionResourceExtension(subscriptionResource).CheckPurviewAccountNameAvailabilityAsync(content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<PurviewAccountNameAvailabilityResult> CheckPurviewAccountNameAvailability(this SubscriptionResource subscriptionResource, PurviewAccountNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetPurviewSubscriptionResourceExtension(subscriptionResource).CheckPurviewAccountNameAvailability(content, cancellationToken);
        }
