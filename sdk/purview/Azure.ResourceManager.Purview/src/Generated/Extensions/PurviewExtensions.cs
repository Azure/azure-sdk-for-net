...
namespace Azure.ResourceManager.Purview
{
    ...
    public static partial class PurviewExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetPurviewAccounts();
        }
        ...
        {
            return await GetTenantResourceExtension(tenantResource).GetDefaultAccountAsync(scopeTenantId, scopeType, scope, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetDefaultAccount(scopeTenantId, scopeType, scope, cancellationToken);
        }
        ...
        public static async Task<Response<DefaultPurviewAccountPayload>> SetDefaultAccountAsync(this TenantResource tenantResource, DefaultPurviewAccountPayload defaultAccountPayload, CancellationToken cancellationToken = default)
        {
            ...
            return await GetTenantResourceExtension(tenantResource).SetDefaultAccountAsync(defaultAccountPayload, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<DefaultPurviewAccountPayload> SetDefaultAccount(this TenantResource tenantResource, DefaultPurviewAccountPayload defaultAccountPayload, CancellationToken cancellationToken = default)
        {
            ...
            return GetTenantResourceExtension(tenantResource).SetDefaultAccount(defaultAccountPayload, cancellationToken);
        }
        ...
        {
            return await GetTenantResourceExtension(tenantResource).RemoveDefaultAccountAsync(scopeTenantId, scopeType, scope, cancellationToken).ConfigureAwait(false);
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).RemoveDefaultAccount(scopeTenantId, scopeType, scope, cancellationToken);
        }
    }
}
