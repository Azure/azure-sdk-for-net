...
namespace Azure.ResourceManager.Purview.Mocking
{
    ...
    internal partial class PurviewTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="PurviewTenantMockingExtension"/> class for mocking. </summary>
        protected PurviewTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PurviewTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PurviewTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope0 = DefaultAccountsClientDiagnostics.CreateScope("PurviewTenantMockingExtension.GetDefaultAccount");
            scope0.Start();
            try
            {
        ...
        {
            using var scope = DefaultAccountsClientDiagnostics.CreateScope("PurviewTenantMockingExtension.SetDefaultAccount");
            scope.Start();
            try
            {
        ...
        {
            using var scope0 = DefaultAccountsClientDiagnostics.CreateScope("PurviewTenantMockingExtension.RemoveDefaultAccount");
            scope0.Start();
            try
            {
