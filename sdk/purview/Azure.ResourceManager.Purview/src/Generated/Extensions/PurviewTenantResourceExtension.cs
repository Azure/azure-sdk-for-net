...
namespace Azure.ResourceManager.Purview.Mock
{
    ...
    public partial class PurviewTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="PurviewTenantResourceExtension"/> class for mocking. </summary>
        protected PurviewTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PurviewTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PurviewTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope0 = DefaultAccountsClientDiagnostics.CreateScope("PurviewTenantResourceExtension.GetDefaultAccount");
            scope0.Start();
            try
            {
        ...
        public virtual async Task<Response<DefaultPurviewAccountPayload>> SetDefaultAccountAsync(DefaultPurviewAccountPayload defaultAccountPayload, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DefaultAccountsClientDiagnostics.CreateScope("PurviewTenantResourceExtension.SetDefaultAccount");
            scope.Start();
            try
            {
        ...
        {
            using var scope0 = DefaultAccountsClientDiagnostics.CreateScope("PurviewTenantResourceExtension.RemoveDefaultAccount");
            scope0.Start();
            try
            {
