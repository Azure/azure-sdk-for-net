...
namespace Azure.ResourceManager.Purview.Mock
{
    ...
    public partial class TenantResourceExtension : ArmResource
    {
        ...
        {
            using var scope0 = DefaultAccountsClientDiagnostics.CreateScope("TenantResourceExtension.GetDefaultAccount");
            scope0.Start();
            try
            {
        ...
        public virtual async Task<Response<DefaultPurviewAccountPayload>> SetDefaultAccountAsync(DefaultPurviewAccountPayload defaultAccountPayload, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = DefaultAccountsClientDiagnostics.CreateScope("TenantResourceExtension.SetDefaultAccount");
            scope.Start();
            try
            {
        ...
        {
            using var scope0 = DefaultAccountsClientDiagnostics.CreateScope("TenantResourceExtension.RemoveDefaultAccount");
            scope0.Start();
            try
            {
