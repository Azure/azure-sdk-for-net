...
namespace Azure.ResourceManager.Purview.Models
{
    ...
    public static partial class ArmPurviewModelFactory
    {
        ...
        {
            return new PurviewAccountEndpoint(catalog, guardian, scan, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PurviewManagedResource(eventHubNamespace, resourceGroup, storageAccount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PurviewPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.WritableSubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PurviewAccountSku(capacity, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PurviewAccountAccessKey(atlasKafkaPrimaryEndpoint, atlasKafkaSecondaryEndpoint, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PurviewPrivateLinkResourceData(id, name, resourceType, systemData, properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static PurviewPrivateLinkResourceProperties PurviewPrivateLinkResourceProperties(string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new PurviewPrivateLinkResourceProperties(groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PurviewAccountNameAvailabilityResult(message, isNameAvailable, reason, new Dictionary<string, BinaryData>());
        }
    }
}
