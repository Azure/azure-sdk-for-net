...
namespace Azure.ResourceManager.Purview
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="PurviewPrivateLinkResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="PurviewAccountResource"/> using the GetPurviewPrivateLinkResources method.
    /// </summary>
    public partial class PurviewPrivateLinkResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of PurviewPrivateLinkResource for mocking. </summary>
        protected PurviewPrivateLinkResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="PurviewPrivateLinkResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Purview/accounts/{accountName}/privateLinkResources/{groupId}";
        ...
        {
            using DiagnosticScope scope = _privateLinkResourcesClientDiagnostics.CreateScope("PurviewPrivateLinkResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _privateLinkResourcesRestClient.CreateGetByGroupIdRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
