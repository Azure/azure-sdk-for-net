...
namespace Azure.ResourceManager.Purview
{
    ...
    public partial class PurviewPrivateLinkResource : ArmResource
    {
        ...
        internal PurviewPrivateLinkResource(ArmClient client, PurviewPrivateLinkResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<PurviewPrivateLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new PurviewPrivateLinkResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
