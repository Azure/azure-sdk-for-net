...
{
    internal partial class AccountsGetBySubscriptionCollectionResultOfT : Pageable<PurviewAccountData>
    {
        ...
        public AccountsGetBySubscriptionCollectionResultOfT(Accounts client, string subscriptionId, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
