...
namespace Azure.ResourceManager.Purview
{
    internal partial class IngestionPrivateEndpointConnectionsGetAllCollectionResultOfT : Pageable<PurviewPrivateEndpointConnectionData>
    {
        ...
        public IngestionPrivateEndpointConnectionsGetAllCollectionResultOfT(IngestionPrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string accountName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
