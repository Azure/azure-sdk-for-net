...
namespace Azure.ResourceManager.Purview
{
    internal partial class AccountsGetByResourceGroupCollectionResultOfT : Pageable<AccountData>
    {
        ...
        public AccountsGetByResourceGroupCollectionResultOfT(Accounts client, Guid subscriptionId, string resourceGroupName, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
