...
namespace Azure.ResourceManager.Purview
{
    internal partial class AccountsGetByResourceGroupCollectionResultOfT : Pageable<PurviewAccountData>
    {
        ...
        public AccountsGetByResourceGroupCollectionResultOfT(Accounts client, string subscriptionId, string resourceGroupName, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
