...
namespace Azure.ResourceManager.Purview
{
    internal partial class KafkaConfigurationsGetByAccountAsyncCollectionResultOfT : AsyncPageable<KafkaConfigurationData>
    {
        ...
        public KafkaConfigurationsGetByAccountAsyncCollectionResultOfT(KafkaConfigurations client, Guid subscriptionId, string resourceGroupName, string accountName, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
