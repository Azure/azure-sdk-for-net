...
namespace Azure.ResourceManager.Purview
{
    internal partial class KafkaConfigurationsGetByAccountAsyncCollectionResultOfT : AsyncPageable<PurviewKafkaConfigurationData>
    {
        ...
        public KafkaConfigurationsGetByAccountAsyncCollectionResultOfT(KafkaConfigurations client, string subscriptionId, string resourceGroupName, string accountName, string skipToken, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
