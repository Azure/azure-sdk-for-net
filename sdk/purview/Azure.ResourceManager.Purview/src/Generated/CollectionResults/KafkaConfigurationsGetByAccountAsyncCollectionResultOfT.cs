...
namespace Azure.ResourceManager.Purview
{
    internal partial class KafkaConfigurationsGetByAccountAsyncCollectionResultOfT : AsyncPageable<PurviewKafkaConfigurationData>
    {
        ...
        /// <summary> Initializes a new instance of KafkaConfigurationsGetByAccountAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public KafkaConfigurationsGetByAccountAsyncCollectionResultOfT(KafkaConfigurations client, string subscriptionId, string resourceGroupName, string accountName, string skipToken, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of KafkaConfigurationsGetByAccountAsyncCollectionResultOfT as an enumerable collection. </summary>
