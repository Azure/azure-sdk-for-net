...
{
    internal partial class UsagesGetUsagesAsyncCollectionResultOfT : AsyncPageable<PurviewUsage>
    {
        ...
        public UsagesGetUsagesAsyncCollectionResultOfT(Usages client, string subscriptionId, AzureLocation location, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<PurviewUsage>> AsPages(string continuationToken, int? pageSizeHint)
        {
