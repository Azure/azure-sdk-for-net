...
namespace Azure.ResourceManager.Purview
{
    internal partial class UsagesGetUsagesAsyncCollectionResultOfT : AsyncPageable<PurviewUsage>
    {
        ...
        public UsagesGetUsagesAsyncCollectionResultOfT(Usages client, string subscriptionId, string location, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
