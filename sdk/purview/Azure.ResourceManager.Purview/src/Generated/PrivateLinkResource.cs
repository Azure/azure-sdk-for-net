...
namespace Azure.ResourceManager.Purview
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="AccountResource"/> using the GetPrivateLinkResources method.
    /// </summary>
    public partial class PrivateLinkResource : ArmResource
    {
        ...
        internal PrivateLinkResource(ArmClient client, PurviewPrivateLinkResourceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<PrivateLinkResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _privateLinkResourcesRestClient.CreateGetByGroupIdRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
