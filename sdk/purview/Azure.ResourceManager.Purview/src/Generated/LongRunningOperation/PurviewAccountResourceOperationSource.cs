...
{
    /// <summary></summary>
    internal partial class PurviewAccountResourceOperationSource : IOperationSource<PurviewAccountResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PurviewAccountResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
