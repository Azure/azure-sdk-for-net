...
namespace Azure.ResourceManager.Purview
{
    internal partial class PurviewArmOperation<T> : ArmOperation<T>
    {
        ...
        internal PurviewArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
