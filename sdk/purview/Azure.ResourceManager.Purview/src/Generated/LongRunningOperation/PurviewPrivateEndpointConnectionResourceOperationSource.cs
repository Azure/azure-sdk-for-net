...
{
    /// <summary></summary>
    internal partial class PurviewPrivateEndpointConnectionResourceOperationSource : IOperationSource<PurviewPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PurviewPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
