...
namespace Azure.ResourceManager.Purview
{
    ...
    public partial class PurviewAccountResource : ArmResource
    {
        ...
        internal PurviewAccountResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _ingestionPrivateEndpointConnectionsRestClient = new IngestionPrivateEndpointConnections(_ingestionPrivateEndpointConnectionsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, purviewAccountApiVersion ?? "2024-04-01-preview");
        ...
        public virtual async Task<ArmOperation<PurviewAccountResource>> UpdateAsync(WaitUntil waitUntil, PurviewAccountData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _accountsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, PurviewAccountData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                PurviewArmOperation<PurviewAccountResource> operation = new PurviewArmOperation<PurviewAccountResource>(
                    new PurviewAccountResourceOperationSource(Client),
                    _accountsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<PurviewAccountResource> Update(WaitUntil waitUntil, PurviewAccountData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
