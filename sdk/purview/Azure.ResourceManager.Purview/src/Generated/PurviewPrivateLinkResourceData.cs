...
namespace Azure.ResourceManager.Purview
{
    ...
    public partial class PurviewPrivateLinkResourceData : ResourceData
    {
        ...
        internal PurviewPrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PurviewPrivateLinkResourceProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
