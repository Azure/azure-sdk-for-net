    ...
    public partial class PrivateLinkResourceCollection : ArmCollection, IEnumerable<PrivateLinkResource>, IAsyncEnumerable<PrivateLinkResource>
    {
        ...
        public virtual async Task<Response<PrivateLinkResource>> GetAsync(string groupId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _privateLinkResourcesRestClient.CreateGetByGroupIdRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, groupId, context);
        ...
        public virtual AsyncPageable<PrivateLinkResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<PurviewPrivateLinkResourceData, PrivateLinkResource>(new PrivateLinkResourcesGetByAccountAsyncCollectionResultOfT(_privateLinkResourcesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new PrivateLinkResource(Client, data));
        }
        ...
        public virtual Pageable<PrivateLinkResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<PurviewPrivateLinkResourceData, PrivateLinkResource>(new PrivateLinkResourcesGetByAccountCollectionResultOfT(_privateLinkResourcesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new PrivateLinkResource(Client, data));
        }
