...
namespace Azure.ResourceManager.Purview
{
    ...
    public partial class AccountData : TrackedResourceData
    {
        ...
        internal AccountData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, AccountSku sku, CloudConnectors cloudConnectors, DateTimeOffset? createdOn, string createdBy, string createdByObjectId, AccountPropertiesEndpoints endpoints, string friendlyName, string managedResourceGroupName, AccountPropertiesManagedResources managedResources, IReadOnlyList<PurviewPrivateEndpointConnectionData> privateEndpointConnections, ProvisioningState? provisioningState, PublicNetworkAccess? publicNetworkAccess, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData, tags, location)
        {
            Sku = sku;
