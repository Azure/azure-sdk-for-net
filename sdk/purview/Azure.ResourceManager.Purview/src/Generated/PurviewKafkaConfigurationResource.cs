    ...
    public partial class PurviewKafkaConfigurationResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _purviewKafkaConfigurationKafkaConfigurationsRestClient.CreateDeleteRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Delete, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new PurviewArmOperation(response, rehydrationToken);
        ...
        public virtual async Task<ArmOperation<PurviewKafkaConfigurationResource>> UpdateAsync(WaitUntil waitUntil, PurviewKafkaConfigurationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _purviewKafkaConfigurationKafkaConfigurationsRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data);
