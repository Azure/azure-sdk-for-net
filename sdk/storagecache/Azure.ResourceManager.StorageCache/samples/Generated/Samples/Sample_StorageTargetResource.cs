...
namespace Azure.ResourceManager.StorageCache.Samples
{
    public partial class Sample_StorageTargetResource
    {
        ...
        public async Task Delete_StorageTargetsDelete()
        {
            ...
            // invoke the operation
            await storageTarget.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
NamespacePath = "/blobnfs",
        ...
        public async Task RefreshDns_CachesDnsRefresh()
        {
            ...
            // invoke the operation
            await storageTarget.RefreshDnsAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Flush_StorageTargetsFlush()
        {
            ...
            // invoke the operation
            await storageTarget.FlushAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Suspend_StorageTargetsSuspend()
        {
            ...
            // invoke the operation
            await storageTarget.SuspendAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Resume_StorageTargetsResume()
        {
            ...
            // invoke the operation
            await storageTarget.ResumeAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Invalidate_StorageTargetsInvalidate()
        {
            ...
            // invoke the operation
            await storageTarget.InvalidateAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task RestoreDefaults_StorageTargetsRestoreDefaults()
        {
            ...
            // invoke the operation
            await storageTarget.RestoreDefaultsAsync(WaitUntil.Completed).ConfigureAwait(false);
