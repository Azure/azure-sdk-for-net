...
namespace Azure.ResourceManager.StorageCache.Samples
{
    public partial class Sample_StorageCacheResource
    {
        ...
        public async Task Delete_CachesDelete()
        {
            ...
            // invoke the operation
            await storageCache.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["Dept"] = "Contoso"
        ...
        public async Task EnableDebugInfo_CachesDebugInfo()
        {
            ...
            // invoke the operation
            await storageCache.EnableDebugInfoAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Flush_CachesFlush()
        {
            ...
            // invoke the operation
            await storageCache.FlushAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Start_CachesStart()
        {
            ...
            // invoke the operation
            await storageCache.StartAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task Stop_CachesStop()
        {
            ...
            // invoke the operation
            await storageCache.StopAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task StartPrimingJob_StartPrimingJob()
        {
            ...
            await storageCache.StartPrimingJobAsync(WaitUntil.Completed, primingjob).ConfigureAwait(false);
        ...
        public async Task StopPrimingJob_StopPrimingJob()
        {
            ...
            await storageCache.StopPrimingJobAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task PausePrimingJob_PausePrimingJob()
        {
            ...
            // invoke the operation
            PrimingJobContent content = new PrimingJobContent("00000000000_0000000000");
            await storageCache.PausePrimingJobAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task ResumePrimingJob_ResumePrimingJob()
        {
            ...
            // invoke the operation
            PrimingJobContent content = new PrimingJobContent("00000000000_0000000000");
            await storageCache.ResumePrimingJobAsync(WaitUntil.Completed, content).ConfigureAwait(false);
        ...
        public async Task UpgradeFirmware_CachesUpgradeFirmware()
        {
            ...
            // invoke the operation
            await storageCache.UpgradeFirmwareAsync(WaitUntil.Completed).ConfigureAwait(false);
...
AllocationPercentage = 25,
            ...
            await storageCache.UpdateSpaceAllocationAsync(WaitUntil.Completed, spaceAllocation).ConfigureAwait(false);
