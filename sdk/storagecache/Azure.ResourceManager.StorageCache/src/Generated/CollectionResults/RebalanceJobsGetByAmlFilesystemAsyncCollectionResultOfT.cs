...
namespace Azure.ResourceManager.StorageCache
{
    internal partial class RebalanceJobsGetByAmlFilesystemAsyncCollectionResultOfT : AsyncPageable<StorageCacheRebalanceJobData>
    {
        ...
        /// <summary> Initializes a new instance of RebalanceJobsGetByAmlFilesystemAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public RebalanceJobsGetByAmlFilesystemAsyncCollectionResultOfT(RebalanceJobs client, string subscriptionId, string resourceGroupName, string amlFilesystemName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of RebalanceJobsGetByAmlFilesystemAsyncCollectionResultOfT as an enumerable collection. </summary>
