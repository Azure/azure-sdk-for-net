...
{
    internal partial class ImportJobsGetByAmlFilesystemAsyncCollectionResultOfT : AsyncPageable<StorageCacheImportJobData>
    {
        ...
        /// <summary> Initializes a new instance of ImportJobsGetByAmlFilesystemAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ImportJobsGetByAmlFilesystemAsyncCollectionResultOfT(ImportJobs client, string subscriptionId, string resourceGroupName, string amlFileSystemName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ImportJobsGetByAmlFilesystemAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ImportJobsGetByAmlFilesystemAsyncCollectionResultOfT as an enumerable collection. </returns>
