...
namespace Azure.ResourceManager.StorageCache
{
    internal partial class ExpansionJobsGetByAmlFilesystemCollectionResultOfT : Pageable<ExpansionJobData>
    {
        ...
        /// <summary> Initializes a new instance of ExpansionJobsGetByAmlFilesystemCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ExpansionJobsGetByAmlFilesystemCollectionResultOfT(ExpansionJobs client, string subscriptionId, string resourceGroupName, string amlFilesystemName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ExpansionJobsGetByAmlFilesystemCollectionResultOfT as an enumerable collection. </summary>
