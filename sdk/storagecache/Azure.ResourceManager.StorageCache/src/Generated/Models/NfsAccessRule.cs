...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public partial class NfsAccessRule
    {
        ...
        internal NfsAccessRule(NfsAccessRuleScope scope, string filter, NfsAccessRuleAccess access, bool? allowSuid, bool? allowSubmountAccess, bool? enableRootSquash, string anonymousUID, string anonymousGID, Dictionary<string, BinaryData> rawData)
        {
            Scope = scope;
            Filter = filter;
            Access = access;
