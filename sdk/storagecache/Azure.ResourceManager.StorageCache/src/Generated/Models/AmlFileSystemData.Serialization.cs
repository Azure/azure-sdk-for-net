...
{
    public partial class AmlFileSystemData : IUtf8JsonSerializable, IJsonModel<AmlFileSystemData>, IPersistableModel<AmlFileSystemData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClientInfo))
            {
                ...
                AppendChildObject(builder, ClientInfo, options, 2);
            }

            if (Optional.IsDefined(ThroughputProvisionedMBps))
            {
                builder.Append("  throughputProvisionedMBps:");
                builder.AppendLine($" '{ThroughputProvisionedMBps.Value.ToString()}'");
            }
            ...
            {
                builder.Append("  hsm:");
                AppendChildObject(builder, Hsm, options, 2);
            }

            if (Optional.IsDefined(RootSquashSettings))
            {
                builder.Append("  rootSquashSettings:");
                AppendChildObject(builder, RootSquashSettings, options, 2);
            }
