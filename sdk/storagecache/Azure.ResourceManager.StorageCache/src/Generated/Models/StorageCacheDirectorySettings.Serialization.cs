...
{
    public partial class StorageCacheDirectorySettings : IUtf8JsonSerializable, IJsonModel<StorageCacheDirectorySettings>, IPersistableModel<StorageCacheDirectorySettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActiveDirectory))
            {
                ...
                AppendChildObject(builder, ActiveDirectory, options, 2);
            }

            if (Optional.IsDefined(UsernameDownload))
            {
                builder.Append("  usernameDownload:");
                AppendChildObject(builder, UsernameDownload, options, 2);
            }
