...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageCachesResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageCachesResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageCachesResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageCachesResult>)} interface");
            }
        ...
        string IPersistableModel<StorageCachesResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
