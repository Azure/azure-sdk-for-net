...
namespace Azure.ResourceManager.StorageCache.Models
{
    public partial class StorageCacheHealth : IUtf8JsonSerializable, IModelJsonSerializable<StorageCacheHealth>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<StorageCacheHealth>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="StorageCacheHealth"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StorageCacheHealth"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StorageCacheHealth"/>. </summary>
