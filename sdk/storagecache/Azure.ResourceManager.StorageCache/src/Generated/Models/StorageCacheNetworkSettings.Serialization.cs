...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageCacheNetworkSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageCacheNetworkSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageCacheNetworkSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageCacheNetworkSettings>)} interface");
            }
        ...
        string IPersistableModel<StorageCacheNetworkSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
