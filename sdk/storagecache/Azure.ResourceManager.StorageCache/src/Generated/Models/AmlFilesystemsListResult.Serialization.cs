...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AmlFilesystemsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AmlFilesystemsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AmlFilesystemsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AmlFilesystemsListResult>)} interface");
            }
        ...
        string IPersistableModel<AmlFilesystemsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
