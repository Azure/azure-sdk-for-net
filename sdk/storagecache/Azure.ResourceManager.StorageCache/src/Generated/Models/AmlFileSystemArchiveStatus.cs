...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public partial class AmlFileSystemArchiveStatus
    {
        ...
        internal AmlFileSystemArchiveStatus(ArchiveStatusType? state, DateTimeOffset? lastCompletionOn, DateTimeOffset? lastStartedOn, int? percentComplete, string errorCode, string errorMessage, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            State = state;
