...
{
    public partial class AmlFileSystemHealth : IUtf8JsonSerializable, IJsonModel<AmlFileSystemHealth>, IPersistableModel<AmlFileSystemHealth>
    {
        ...
        void IJsonModel<AmlFileSystemHealth>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AmlFileSystemHealth)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StatusDescription))
            {
                ...
                builder.AppendLine($" '{StatusDescription}'");
            }
