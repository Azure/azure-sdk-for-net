...
{
    public partial class Nfs3Target : Core.IUtf8JsonSerializable
    {
        ...
        internal static Nfs3Target DeserializeNfs3Target(JsonElement element)
        {
            ...
            return new Nfs3Target(target.Value, usageModel.Value, Core.Optional.ToNullable(verificationTimer), Core.Optional.ToNullable(writeBackTimer));
        }
    }
}
