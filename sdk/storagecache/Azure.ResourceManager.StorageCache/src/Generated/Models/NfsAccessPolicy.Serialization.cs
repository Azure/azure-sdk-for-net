...
{
    public partial class NfsAccessPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NfsAccessPolicy DeserializeNfsAccessPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
