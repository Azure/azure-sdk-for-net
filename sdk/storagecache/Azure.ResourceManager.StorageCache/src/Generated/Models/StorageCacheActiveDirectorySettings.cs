...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public partial class StorageCacheActiveDirectorySettings
    {
        ...
        internal StorageCacheActiveDirectorySettings(IPAddress primaryDnsIPAddress, IPAddress secondaryDnsIPAddress, string domainName, string domainNetBiosName, string cacheNetBiosName, DomainJoinedType? domainJoined, StorageCacheActiveDirectorySettingsCredentials credentials, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PrimaryDnsIPAddress = primaryDnsIPAddress;
