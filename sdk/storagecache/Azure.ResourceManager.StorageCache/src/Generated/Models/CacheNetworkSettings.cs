...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        /// <summary> Initializes a new instance of CacheNetworkSettings. </summary>
        public CacheNetworkSettings()
        {
            UtilityAddresses = new ChangeTrackingList<string>();
        ...
        internal CacheNetworkSettings(int? mtu, IReadOnlyList<string> utilityAddresses, IList<string> dnsServers, string dnsSearchDomain, string ntpServer)
        {
            Mtu = mtu;
        ...
        public IReadOnlyList<string> UtilityAddresses { get; }
