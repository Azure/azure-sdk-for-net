...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public partial class NamespaceJunction
    {
        ...
        internal NamespaceJunction(string namespacePath, string targetPath, string nfsExport, string nfsAccessPolicy, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
