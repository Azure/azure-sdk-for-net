...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public partial class PrimingJob
    {
        ...
        internal PrimingJob(string primingJobName, Uri primingManifestUri, string primingJobId, PrimingJobState? primingJobState, string primingJobStatus, string primingJobDetails, double? primingJobPercentComplete, Dictionary<string, BinaryData> rawData)
        {
            PrimingJobName = primingJobName;
            PrimingManifestUri = primingManifestUri;
