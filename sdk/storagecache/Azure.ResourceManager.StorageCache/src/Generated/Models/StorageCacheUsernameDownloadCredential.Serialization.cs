...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageCacheUsernameDownloadCredential>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageCacheUsernameDownloadCredential>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageCacheUsernameDownloadCredential>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StorageCacheUsernameDownloadCredential>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
