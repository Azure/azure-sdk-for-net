...
{
    public partial class StorageCacheUsernameDownloadCredential : IUtf8JsonSerializable, IJsonModel<StorageCacheUsernameDownloadCredential>, IPersistableModel<StorageCacheUsernameDownloadCredential>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BindDistinguishedName))
            {
                ...
                builder.AppendLine($" '{BindDistinguishedName}'");
            }

            if (Optional.IsDefined(BindPassword))
            {
                builder.Append("  bindPassword:");
                builder.AppendLine($" '{BindPassword}'");
            }
