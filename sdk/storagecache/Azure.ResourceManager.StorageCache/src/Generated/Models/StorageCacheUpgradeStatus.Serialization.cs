...
{
    public partial class StorageCacheUpgradeStatus : IUtf8JsonSerializable, IJsonModel<StorageCacheUpgradeStatus>, IPersistableModel<StorageCacheUpgradeStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FirmwareUpdateStatus))
            {
                ...
                builder.AppendLine($" '{FirmwareUpdateStatus.ToString()}'");
            }

            if (Optional.IsDefined(FirmwareUpdateDeadline))
            {
                builder.Append("  firmwareUpdateDeadline:");
                builder.AppendLine($" '{FirmwareUpdateDeadline.Value.ToString()}'");
            }

            if (Optional.IsDefined(LastFirmwareUpdate))
            {
                builder.Append("  lastFirmwareUpdate:");
                builder.AppendLine($" '{LastFirmwareUpdate.Value.ToString()}'");
            }
