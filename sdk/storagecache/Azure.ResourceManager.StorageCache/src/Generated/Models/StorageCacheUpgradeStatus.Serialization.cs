...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        internal static StorageCacheUpgradeStatus DeserializeStorageCacheUpgradeStatus(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
