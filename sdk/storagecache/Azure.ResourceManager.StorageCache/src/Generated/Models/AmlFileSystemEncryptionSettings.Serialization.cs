...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AmlFileSystemEncryptionSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AmlFileSystemEncryptionSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AmlFileSystemEncryptionSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AmlFileSystemEncryptionSettings>)} interface");
            }
        ...
        string IPersistableModel<AmlFileSystemEncryptionSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
