...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public partial class BlobNfsTarget
    {
        ...
        internal BlobNfsTarget(ResourceIdentifier target, string usageModel, int? verificationDelayInSeconds, int? writeBackDelayInSeconds, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Target = target;
