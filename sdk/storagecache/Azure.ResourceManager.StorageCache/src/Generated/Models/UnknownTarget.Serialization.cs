...
namespace Azure.ResourceManager.StorageCache.Models
{
    internal partial class UnknownTarget : IUtf8JsonSerializable, IJsonModel<UnknownTarget>
    {
        ...
        void IJsonModel<UnknownTarget>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(UnknownTarget)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<UnknownTarget>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(UnknownTarget)} does not support '{options.Format}' format.");
            }
        }
