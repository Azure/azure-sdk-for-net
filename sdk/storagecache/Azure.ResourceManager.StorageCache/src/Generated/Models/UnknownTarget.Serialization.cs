...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnknownTarget>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UnknownTarget>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UnknownTarget>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<UnknownTarget>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
