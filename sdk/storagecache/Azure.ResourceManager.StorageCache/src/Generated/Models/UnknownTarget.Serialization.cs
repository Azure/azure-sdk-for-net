...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UnknownTarget>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static UnknownTarget DeserializeUnknownTarget(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownTarget(attributes ?? new ChangeTrackingDictionary<string, string>(), serializedAdditionalRawData);
        }
