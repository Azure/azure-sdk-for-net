...
{
    public partial class StorageCacheEncryptionSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StorageCacheEncryptionSettings DeserializeStorageCacheEncryptionSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
