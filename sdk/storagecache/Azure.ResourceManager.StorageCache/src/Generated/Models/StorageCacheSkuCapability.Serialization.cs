...
{
    public partial class StorageCacheSkuCapability : IUtf8JsonSerializable, IJsonModel<StorageCacheSkuCapability>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageCacheSkuCapability>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        internal static StorageCacheSkuCapability DeserializeStorageCacheSkuCapability(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new StorageCacheSkuCapability(name, value, serializedAdditionalRawData);
        }
