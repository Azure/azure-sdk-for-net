...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageCacheSkuCapability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageCacheSkuCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageCacheSkuCapability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageCacheSkuCapability>)} interface");
            }
        ...
        string IPersistableModel<StorageCacheSkuCapability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
