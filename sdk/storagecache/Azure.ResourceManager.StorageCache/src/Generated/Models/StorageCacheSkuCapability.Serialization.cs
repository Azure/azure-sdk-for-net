...
namespace Azure.ResourceManager.StorageCache.Models
{
    public partial class StorageCacheSkuCapability : IUtf8JsonSerializable, IJsonModel<StorageCacheSkuCapability>
    {
        ...
        void IJsonModel<StorageCacheSkuCapability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(StorageCacheSkuCapability)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StorageCacheSkuCapability>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(StorageCacheSkuCapability)} does not support '{options.Format}' format.");
            }
        }
