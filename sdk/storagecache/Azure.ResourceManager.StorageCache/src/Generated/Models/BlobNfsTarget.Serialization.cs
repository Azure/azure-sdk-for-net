...
{
    public partial class BlobNfsTarget : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BlobNfsTarget DeserializeBlobNfsTarget(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
