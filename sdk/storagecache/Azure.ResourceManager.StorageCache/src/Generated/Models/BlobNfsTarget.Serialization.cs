...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BlobNfsTarget>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BlobNfsTarget>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BlobNfsTarget>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BlobNfsTarget>)} interface");
            }
        ...
        string IPersistableModel<BlobNfsTarget>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
