...
{
    public partial class AmlFileSystemPropertiesMaintenanceWindow : IUtf8JsonSerializable, IJsonModel<AmlFileSystemPropertiesMaintenanceWindow>, IPersistableModel<AmlFileSystemPropertiesMaintenanceWindow>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TimeOfDayUTC))
            {
                builder.Append("  timeOfDayUTC:");
                builder.AppendLine($" '{TimeOfDayUTC}'");
            }
