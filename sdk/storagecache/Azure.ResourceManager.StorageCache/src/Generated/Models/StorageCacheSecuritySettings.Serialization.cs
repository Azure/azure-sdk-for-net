...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageCacheSecuritySettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageCacheSecuritySettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageCacheSecuritySettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StorageCacheSecuritySettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
