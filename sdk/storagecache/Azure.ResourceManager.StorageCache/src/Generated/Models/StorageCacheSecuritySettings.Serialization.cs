...
{
    internal partial class StorageCacheSecuritySettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static StorageCacheSecuritySettings DeserializeStorageCacheSecuritySettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
