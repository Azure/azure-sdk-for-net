...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageCacheSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageCacheSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageCacheSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageCacheSku>)} interface");
            }
        ...
        string IPersistableModel<StorageCacheSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
