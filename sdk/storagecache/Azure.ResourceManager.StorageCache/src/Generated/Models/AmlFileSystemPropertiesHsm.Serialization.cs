...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AmlFileSystemPropertiesHsm>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        void IJsonModel<AmlFileSystemPropertiesHsm>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                if (Optional.IsCollectionDefined(ArchiveStatus))
                {
        ...
        AmlFileSystemPropertiesHsm IJsonModel<AmlFileSystemPropertiesHsm>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<AmlFileSystemPropertiesHsm>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        AmlFileSystemPropertiesHsm IModel<AmlFileSystemPropertiesHsm>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<AmlFileSystemPropertiesHsm>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
