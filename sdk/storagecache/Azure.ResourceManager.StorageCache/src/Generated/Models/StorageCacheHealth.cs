...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public partial class StorageCacheHealth
    {
        ...
        internal StorageCacheHealth(StorageCacheHealthStateType? state, string statusDescription, IReadOnlyList<OutstandingCondition> conditions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            State = state;
