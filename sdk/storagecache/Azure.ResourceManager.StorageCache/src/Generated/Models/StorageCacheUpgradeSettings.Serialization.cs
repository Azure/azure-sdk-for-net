...
{
    public partial class StorageCacheUpgradeSettings : IUtf8JsonSerializable, IJsonModel<StorageCacheUpgradeSettings>, IPersistableModel<StorageCacheUpgradeSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ScheduledOn))
            {
                ...
                builder.AppendLine($" '{ScheduledOn.Value.ToString()}'");
            }
