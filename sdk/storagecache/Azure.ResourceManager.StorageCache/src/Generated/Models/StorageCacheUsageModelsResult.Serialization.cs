...
namespace Azure.ResourceManager.StorageCache.Models
{
    internal partial class StorageCacheUsageModelsResult : IUtf8JsonSerializable, IModelJsonSerializable<StorageCacheUsageModelsResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<StorageCacheUsageModelsResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<StorageCacheUsageModel>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="StorageCacheUsageModelsResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StorageCacheUsageModelsResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StorageCacheUsageModelsResult"/>. </summary>
