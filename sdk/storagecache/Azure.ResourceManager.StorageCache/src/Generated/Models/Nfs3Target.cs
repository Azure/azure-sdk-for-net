...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public partial class Nfs3Target
    {
        ...
        internal Nfs3Target(string target, string usageModel, int? verificationDelayInSeconds, int? writeBackDelayInSeconds, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Target = target;
