...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AmlFileSystemArchiveStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AmlFileSystemArchiveStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AmlFileSystemArchiveStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AmlFileSystemArchiveStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
