...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageCacheActiveDirectorySettingsCredentials>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        StorageCacheActiveDirectorySettingsCredentials IJsonModel<StorageCacheActiveDirectorySettingsCredentials>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<StorageCacheActiveDirectorySettingsCredentials>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        StorageCacheActiveDirectorySettingsCredentials IModel<StorageCacheActiveDirectorySettingsCredentials>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<StorageCacheActiveDirectorySettingsCredentials>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
