...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageCacheActiveDirectorySettingsCredentials>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageCacheActiveDirectorySettingsCredentials>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageCacheActiveDirectorySettingsCredentials>)} interface");
            }
        ...
        string IPersistableModel<StorageCacheActiveDirectorySettingsCredentials>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
