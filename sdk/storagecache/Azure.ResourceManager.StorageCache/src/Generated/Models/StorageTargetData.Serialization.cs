...
namespace Azure.ResourceManager.StorageCache
{
    public partial class StorageTargetData : IUtf8JsonSerializable, IJsonModel<StorageTargetData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("    nfs3:");
                AppendChildObject(builder, Nfs3, options, 4, false);
            }

            if (Optional.IsDefined(Clfs))
            {
                builder.Append("    clfs:");
                AppendChildObject(builder, Clfs, options, 4, false);
            }

            if (Optional.IsDefined(Unknown))
            {
                builder.Append("    unknown:");
                AppendChildObject(builder, Unknown, options, 4, false);
            }

            if (Optional.IsDefined(BlobNfs))
            {
                builder.Append("    blobNfs:");
                AppendChildObject(builder, BlobNfs, options, 4, false);
            }
