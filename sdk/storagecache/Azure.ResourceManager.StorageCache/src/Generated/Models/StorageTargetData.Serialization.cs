...
namespace Azure.ResourceManager.StorageCache
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageTargetData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageTargetData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageTargetData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageTargetData>)} interface");
            }
        ...
        string IPersistableModel<StorageTargetData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
