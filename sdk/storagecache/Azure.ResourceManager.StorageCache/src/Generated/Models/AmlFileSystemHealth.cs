...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public partial class AmlFileSystemHealth
    {
        ...
        internal AmlFileSystemHealth(AmlFileSystemHealthStateType? state, string statusCode, string statusDescription, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            State = state;
