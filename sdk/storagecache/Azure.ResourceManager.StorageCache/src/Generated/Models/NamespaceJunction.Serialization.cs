...
namespace Azure.ResourceManager.StorageCache.Models
{
    public partial class NamespaceJunction : IUtf8JsonSerializable, IJsonModel<NamespaceJunction>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NamespacePath))
            {
                builder.Append("  namespacePath:");
                if (NamespacePath.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{NamespacePath}'''");
                }
                else
                {
                    builder.AppendLine($" '{NamespacePath}'");
            ...
            if (Optional.IsDefined(TargetPath))
            {
                ...
                if (TargetPath.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(NfsExport))
            {
                builder.Append("  nfsExport:");
                if (NfsExport.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{NfsExport}'''");
                }
                else
                {
                    builder.AppendLine($" '{NfsExport}'");
            ...
            if (Optional.IsDefined(NfsAccessPolicy))
            {
                builder.Append("  nfsAccessPolicy:");
                if (NfsAccessPolicy.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{NfsAccessPolicy}'''");
                }
                else
                {
                    builder.AppendLine($" '{NfsAccessPolicy}'");
