...
namespace Azure.ResourceManager.StorageCache.Models
{
    public partial class NamespaceJunction : IUtf8JsonSerializable, IModelJsonSerializable<NamespaceJunction>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<NamespaceJunction>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="NamespaceJunction"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="NamespaceJunction"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="NamespaceJunction"/>. </summary>
