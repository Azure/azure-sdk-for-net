...
namespace Azure.ResourceManager.StorageCache.Models
{
    public partial class AmlFileSystemPatch : IUtf8JsonSerializable, IJsonModel<AmlFileSystemPatch>
    {
        ...
        void IJsonModel<AmlFileSystemPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AmlFileSystemPatch)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AmlFileSystemPatch>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AmlFileSystemPatch)} does not support '{options.Format}' format.");
            }
        }
