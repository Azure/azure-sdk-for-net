...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RequiredAmlFileSystemSubnetsSizeContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RequiredAmlFileSystemSubnetsSizeContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(RequiredAmlFileSystemSubnetsSizeContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<RequiredAmlFileSystemSubnetsSizeContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(RequiredAmlFileSystemSubnetsSizeContent)} does not support '{options.Format}' format.");
            }
        }
