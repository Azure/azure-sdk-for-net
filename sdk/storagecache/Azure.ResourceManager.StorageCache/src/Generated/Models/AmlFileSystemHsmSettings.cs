...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public partial class AmlFileSystemHsmSettings
    {
        ...
        internal AmlFileSystemHsmSettings(string container, string loggingContainer, string importPrefix, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Container = container;
            LoggingContainer = loggingContainer;
