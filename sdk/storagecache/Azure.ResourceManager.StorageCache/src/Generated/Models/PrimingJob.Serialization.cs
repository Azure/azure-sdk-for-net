...
{
    public partial class PrimingJob : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PrimingJob DeserializePrimingJob(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
