...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public partial class StorageCacheNetworkSettings
    {
        ...
        internal StorageCacheNetworkSettings(int? mtu, IReadOnlyList<IPAddress> utilityAddresses, IList<IPAddress> dnsServers, string dnsSearchDomain, string ntpServer, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Mtu = mtu;
