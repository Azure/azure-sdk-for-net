...
namespace Azure.ResourceManager.StorageCache
{
    public partial class CacheData : IUtf8JsonSerializable
    {
        ...
        internal static CacheData DeserializeCacheData(JsonElement element)
        {
            ...
            Optional<CacheUpgradeSettings> upgradeSettings = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("upgradeSettings"))
                        {
                            ...
                            upgradeSettings = CacheUpgradeSettings.DeserializeCacheUpgradeSettings(property0.Value);
                            continue;
                        }
