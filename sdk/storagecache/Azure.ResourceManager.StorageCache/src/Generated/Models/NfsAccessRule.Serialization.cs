...
{
    public partial class NfsAccessRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NfsAccessRule DeserializeNfsAccessRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
