...
namespace Azure.ResourceManager.StorageCache
{
    ...
    public partial class AutoExportJobResource : ArmResource
    {
        ...
        internal AutoExportJobResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _autoExportJobsRestClient = new AutoExportJobs(_autoExportJobsClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, autoExportJobApiVersion ?? "2026-08-01");
        ...
        public virtual async Task<ArmOperation<AutoExportJobResource>> UpdateAsync(WaitUntil waitUntil, AutoExportJobData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _autoExportJobsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, AutoExportJobData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                StorageCacheArmOperation<AutoExportJobResource> operation = new StorageCacheArmOperation<AutoExportJobResource>(
                    new AutoExportJobResourceOperationSource(Client),
                    _autoExportJobsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AutoExportJobResource> Update(WaitUntil waitUntil, AutoExportJobData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
