...
namespace Azure.ResourceManager.StorageCache.Models
{
    ...
    public static partial class ArmStorageCacheModelFactory
    {
        ...
        public static AmlFileSystemData AmlFileSystemData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, string skuName = null, IEnumerable<string> zones = null, float? storageCapacityTiB = null, AmlFileSystemHealth health = null, AmlFileSystemProvisioningStateType? provisioningState = null, string filesystemSubnet = null, AmlFileSystemClientInfo clientInfo = null, int? throughputProvisionedMBps = null, StorageCacheEncryptionKeyVaultKeyReference keyEncryptionKey = null, AmlFileSystemPropertiesMaintenanceWindow maintenanceWindow = null, AmlFileSystemPropertiesHsm hsm = null)
        {
            ...
            return new AmlFileSystemData(id, name, resourceType, systemData, tags, location, identity, skuName != null ? new StorageCacheSkuName(skuName, new Dictionary<string, BinaryData>()) : null, zones?.ToList(), storageCapacityTiB, health, provisioningState, filesystemSubnet, clientInfo, throughputProvisionedMBps, keyEncryptionKey != null ? new AmlFileSystemEncryptionSettings(keyEncryptionKey, new Dictionary<string, BinaryData>()) : null, maintenanceWindow, hsm, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AmlFileSystemHealth(state, statusCode, statusDescription, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AmlFileSystemClientInfo(mgsAddress, mountCommand, lustreVersion, containerStorageInterface, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AmlFileSystemContainerStorageInterface(persistentVolumeClaim, persistentVolume, storageClass, new Dictionary<string, BinaryData>());
        }
        ...
        public static AmlFileSystemPropertiesHsm AmlFileSystemPropertiesHsm(AmlFileSystemHsmSettings settings = null, IEnumerable<AmlFileSystemArchive> archiveStatus = null)
        {
            ...
            return new AmlFileSystemPropertiesHsm(settings, archiveStatus?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AmlFileSystemArchive(filesystemPath, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AmlFileSystemArchiveStatus(state, lastCompletionOn, lastStartedOn, percentComplete, errorCode, errorMessage, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RequiredAmlFileSystemSubnetsSize(filesystemSubnetSize, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageCacheSku StorageCacheSku(string resourceType = null, IEnumerable<StorageCacheSkuCapability> capabilities = null, IEnumerable<string> locations = null, IEnumerable<StorageCacheSkuLocationInfo> locationInfo = null, string name = null, IEnumerable<StorageCacheRestriction> restrictions = null)
        {
            ...
            return new StorageCacheSku(resourceType, capabilities?.ToList(), locations?.ToList(), locationInfo?.ToList(), name, restrictions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageCacheSkuCapability(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageCacheSkuLocationInfo StorageCacheSkuLocationInfo(AzureLocation? location = null, IEnumerable<string> zones = null)
        {
            ...
            return new StorageCacheSkuLocationInfo(location, zones?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageCacheRestriction StorageCacheRestriction(string restrictionType = null, IEnumerable<string> values = null, StorageCacheRestrictionReasonCode? reasonCode = null)
        {
            ...
            return new StorageCacheRestriction(restrictionType, values?.ToList(), reasonCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageCacheUsageModel(displayDescription != null ? new StorageCacheUsageModelDisplay(displayDescription, new Dictionary<string, BinaryData>()) : null, modelName, targetType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageCacheUsage(limit, unit, currentValue, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageCacheUsageName(value, localizedValue, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageCacheData StorageCacheData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, string skuName = null, int? cacheSizeGB = null, StorageCacheHealth health = null, IEnumerable<IPAddress> mountAddresses = null, StorageCacheProvisioningStateType? provisioningState = null, ResourceIdentifier subnet = null, StorageCacheUpgradeStatus upgradeStatus = null, StorageCacheUpgradeSettings upgradeSettings = null, StorageCacheNetworkSettings networkSettings = null, StorageCacheEncryptionSettings encryptionSettings = null, IEnumerable<NfsAccessPolicy> securityAccessPolicies = null, StorageCacheDirectorySettings directoryServicesSettings = null, IEnumerable<string> zones = null, IEnumerable<PrimingJob> primingJobs = null, IEnumerable<StorageTargetSpaceAllocation> spaceAllocation = null)
        {
            ...
            return new StorageCacheData(id, name, resourceType, systemData, tags, location, identity, skuName != null ? new StorageCacheSkuInfo(skuName, new Dictionary<string, BinaryData>()) : null, cacheSizeGB, health, mountAddresses?.ToList(), provisioningState, subnet, upgradeStatus, upgradeSettings, networkSettings, encryptionSettings, securityAccessPolicies != null ? new StorageCacheSecuritySettings(securityAccessPolicies?.ToList(), new Dictionary<string, BinaryData>()) : null, directoryServicesSettings, zones?.ToList(), primingJobs?.ToList(), spaceAllocation?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageCacheHealth StorageCacheHealth(StorageCacheHealthStateType? state = null, string statusDescription = null, IEnumerable<OutstandingCondition> conditions = null)
        {
            ...
            return new StorageCacheHealth(state, statusDescription, conditions?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new OutstandingCondition(timestamp, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageCacheUpgradeStatus(currentFirmwareVersion, firmwareUpdateStatus, firmwareUpdateDeadline, lastFirmwareUpdate, pendingFirmwareVersion, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageCacheNetworkSettings StorageCacheNetworkSettings(int? mtu = null, IEnumerable<IPAddress> utilityAddresses = null, IEnumerable<IPAddress> dnsServers = null, string dnsSearchDomain = null, string ntpServer = null)
        {
            ...
            return new StorageCacheNetworkSettings(mtu, utilityAddresses?.ToList(), dnsServers?.ToList(), dnsSearchDomain, ntpServer, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageCacheActiveDirectorySettings(primaryDnsIPAddress, secondaryDnsIPAddress, domainName, domainNetBiosName, cacheNetBiosName, domainJoined, credentials, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageCacheUsernameDownloadSettings(enableExtendedGroups, usernameSource, groupFileUri, userFileUri, ldapServer, ldapBaseDN, encryptLdapConnection, requireValidCertificate, autoDownloadCertificate, caCertificateUri, usernameDownloaded, credentials, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PrimingJob(primingJobName, primingManifestUri, primingJobId, primingJobState, primingJobStatus, primingJobDetails, primingJobPercentComplete, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageTargetData StorageTargetData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<NamespaceJunction> junctions = null, StorageTargetType? targetType = null, StorageCacheProvisioningStateType? provisioningState = null, StorageTargetOperationalStateType? state = null, Nfs3Target nfs3 = null, ResourceIdentifier clfsTarget = null, IDictionary<string, string> unknownAttributes = null, BlobNfsTarget blobNfs = null, int? allocationPercentage = null, AzureLocation? location = null)
        {
            ...
            return new StorageTargetData(id, name, resourceType, systemData, junctions?.ToList(), targetType, provisioningState, state, nfs3, clfsTarget != null ? new ClfsTarget(clfsTarget, new Dictionary<string, BinaryData>()) : null, unknownAttributes != null ? new UnknownTarget(unknownAttributes, new Dictionary<string, BinaryData>()) : null, blobNfs, allocationPercentage, location, new Dictionary<string, BinaryData>());
        }
    }
}
