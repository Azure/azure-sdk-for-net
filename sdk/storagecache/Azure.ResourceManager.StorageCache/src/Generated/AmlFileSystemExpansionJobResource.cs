...
namespace Azure.ResourceManager.StorageCache
{
    ...
    public partial class AmlFileSystemExpansionJobResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the AmlFileSystemExpansionJob.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageCache/amlFilesystems/{amlFilesystemName}/expansionJobs/{expansionJobName}. </description>
        ...
        public virtual async Task<ArmOperation<AmlFileSystemExpansionJobResource>> UpdateAsync(WaitUntil waitUntil, AmlFileSystemExpansionJobData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _expansionJobsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, AmlFileSystemExpansionJobData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                StorageCacheArmOperation<AmlFileSystemExpansionJobResource> operation = new StorageCacheArmOperation<AmlFileSystemExpansionJobResource>(
                    new AmlFileSystemExpansionJobResourceOperationSource(Client),
                    _expansionJobsClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<AmlFileSystemExpansionJobResource> Update(WaitUntil waitUntil, AmlFileSystemExpansionJobData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
