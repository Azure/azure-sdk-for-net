...
namespace Azure.ResourceManager.StorageCache
{
    ...
    public partial class AmlFileSystemData : TrackedResourceData
    {
        ...
        {
            AmlFileSystemData amlFSData = new AmlFileSystemData(id, name, resourceType, systemData, tags, location, identity, sku, zones, storageCapacityTiB, null, null, health, provisioningState, filesystemSubnet, clientInfo, throughputProvisionedMBps, encryptionSettings, maintenanceWindow, hsm, null, null);
        }
    }
}
