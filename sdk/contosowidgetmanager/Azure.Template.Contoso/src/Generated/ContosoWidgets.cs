...
namespace Azure.Template.Contoso
{
    ...
    public partial class ContosoWidgets
    {
        ...
        internal ContosoWidgets(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string apiVersion)
        {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ContosoWidgets.GetWidget");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ContosoWidgets.GetWidgetOperationStatus");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ContosoWidgets.CreateOrUpdateWidget");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "ContosoWidgets.CreateOrUpdateWidget", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation<BinaryData>> CreateOrUpdateWidgetAsync(WaitUntil waitUntil, string widgetName, RequestContent content, RequestContext context = null)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateCreateOrUpdateWidgetRequest(widgetName, content, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "ContosoWidgets.CreateOrUpdateWidgetAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            using DiagnosticScope scope = ClientDiagnostics.CreateScope("ContosoWidgets.DeleteWidget");
            scope.Start();
            try
            {
                Argument.AssertNotNullOrEmpty(widgetName, nameof(widgetName));
                ...
                return ProtocolOperationHelpers.ProcessMessage(Pipeline, message, ClientDiagnostics, "ContosoWidgets.DeleteWidget", OperationFinalStateVia.OperationLocation, context, waitUntil);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Operation<BinaryData>> DeleteWidgetAsync(WaitUntil waitUntil, string widgetName, RequestContext context)
        {
            ...
            try
            {
                ...
                using HttpMessage message = CreateDeleteWidgetRequest(widgetName, context);
                return await ProtocolOperationHelpers.ProcessMessageAsync(Pipeline, message, ClientDiagnostics, "ContosoWidgets.DeleteWidgetAsync", OperationFinalStateVia.OperationLocation, context, waitUntil).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Operation<WidgetSuite> DeleteWidget(WaitUntil waitUntil, string widgetName, CancellationToken cancellationToken = default)
        {
            ...
            return ProtocolOperationHelpers.Convert(result, response => WidgetSuite.FromLroResponse(response), ClientDiagnostics, "ContosoWidgets.DeleteWidget");
        }
        ...
        public virtual async Task<Operation<WidgetSuite>> DeleteWidgetAsync(WaitUntil waitUntil, string widgetName, CancellationToken cancellationToken = default)
        {
            ...
            return ProtocolOperationHelpers.Convert(result, response => WidgetSuite.FromLroResponse(response), ClientDiagnostics, "ContosoWidgets.DeleteWidgetAsync");
        }
        ...
        {
            return new ContosoWidgetsGetWidgetsCollectionResult(this, context, "ContosoWidgets.GetWidgets");
        }
        ...
        {
            return new ContosoWidgetsGetWidgetsAsyncCollectionResult(this, context, "ContosoWidgets.GetWidgets");
        }
        ...
        {
            return new ContosoWidgetsGetWidgetsCollectionResultOfT(this, cancellationToken.ToRequestContext(), "ContosoWidgets.GetWidgets");
        }
        ...
        {
            return new ContosoWidgetsGetWidgetsAsyncCollectionResultOfT(this, cancellationToken.ToRequestContext(), "ContosoWidgets.GetWidgets");
        }
    }
}
