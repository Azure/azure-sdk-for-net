...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class IoTSecuritySolutionAnalyticsModelData : ResourceData
    {
        ...
        internal IoTSecuritySolutionAnalyticsModelData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IoTSecuritySolutionAnalyticsModelProperties properties) : base(id, name, resourceType, systemData)
        {
