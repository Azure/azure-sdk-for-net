...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class DiscoveredSecuritySolutionCollection : ArmCollection
    {
        ...
        internal DiscoveredSecuritySolutionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _discoveredSecuritySolutionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", DiscoveredSecuritySolutionResource.ResourceType.Namespace, Diagnostics);
