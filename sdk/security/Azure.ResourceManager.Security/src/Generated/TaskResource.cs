...
namespace Azure.ResourceManager.Security
{
    ...
    /// If you have a <see cref="Core.ResourceIdentifier"/> you can construct a <see cref="TaskResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="AscLocationResource"/> using the GetTasks method.
    /// </summary>
    public partial class TaskResource : ArmResource
    {
        ...
        internal TaskResource(ArmClient client, SecurityTaskData data) : this(client, data.Id)
        {
            this.HasData = true;
            _data = data;
        }
        ...
        internal TaskResource(ArmClient client, Core.ResourceIdentifier id) : base(client, id)
        {
            this.TryGetApiVersion(ResourceType, out string taskApiVersion);
            _tasksClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", ResourceType.Namespace, Diagnostics);
        ...
        public static Core.ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string ascLocation, string taskName)
        {
        ...
        {
            using DiagnosticScope scope = _tasksClientDiagnostics.CreateScope("TaskResource.UpdateSubscriptionLevelTaskState");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
