...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class IoTSecurityAggregatedAlertResource : IJsonModel<IoTSecurityAggregatedAlertData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<IoTSecurityAggregatedAlertData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<IoTSecurityAggregatedAlertData>(Data, options, AzureResourceManagerSecurityContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        IoTSecurityAggregatedAlertData IPersistableModel<IoTSecurityAggregatedAlertData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<IoTSecurityAggregatedAlertData>(data, options, AzureResourceManagerSecurityContext.Default);
