...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class SecuritySubAssessmentResource : IJsonModel<SecuritySubAssessmentData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SecuritySubAssessmentData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<SecuritySubAssessmentData>(Data, options, AzureResourceManagerSecurityContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SecuritySubAssessmentData IPersistableModel<SecuritySubAssessmentData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<SecuritySubAssessmentData>(data, options, AzureResourceManagerSecurityContext.Default);
