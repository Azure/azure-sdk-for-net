...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class AdvancedThreatProtectionSettingData : ResourceData
    {
        ...
        internal AdvancedThreatProtectionSettingData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AdvancedThreatProtectionProperties properties) : base(id, name, resourceType, systemData)
        {
