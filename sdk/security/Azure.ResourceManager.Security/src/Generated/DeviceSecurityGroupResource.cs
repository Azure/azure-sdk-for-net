...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class DeviceSecurityGroupResource : ArmResource
    {
        ...
        internal DeviceSecurityGroupResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _deviceSecurityGroupsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<DeviceSecurityGroupResource>> UpdateAsync(WaitUntil waitUntil, DeviceSecurityGroupData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                SecurityArmOperation<DeviceSecurityGroupResource> operation = new SecurityArmOperation<DeviceSecurityGroupResource>(Response.FromValue(new DeviceSecurityGroupResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
                if (waitUntil == WaitUntil.Completed)
                {
