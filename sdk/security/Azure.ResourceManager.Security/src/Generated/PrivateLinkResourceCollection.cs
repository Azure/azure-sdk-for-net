...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class PrivateLinkResourceCollection : ArmCollection, IEnumerable<PrivateLinkResource>, IAsyncEnumerable<PrivateLinkResource>
    {
        ...
        internal PrivateLinkResourceCollection(ArmClient client, Core.ResourceIdentifier id) : base(client, id)
        {
            TryGetApiVersion(PrivateLinkResource.ResourceType, out string privateLinkResourceApiVersion);
            _privateLinksClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", PrivateLinkResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<PrivateLinkResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SecurityPrivateLinkResourceData data, PrivateLinkParameters privateLinkName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _privateLinksRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, privateLinkName, SecurityPrivateLinkResourceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                SecurityArmOperation<PrivateLinkResource> operation = new SecurityArmOperation<PrivateLinkResource>(
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> or <paramref name="privateLinkName"/> is null. </exception>
        public virtual ArmOperation<PrivateLinkResource> CreateOrUpdate(WaitUntil waitUntil, SecurityPrivateLinkResourceData data, PrivateLinkParameters privateLinkName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            Argument.AssertNotNull(privateLinkName, nameof(privateLinkName));
        ...
        public virtual AsyncPageable<PrivateLinkResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityPrivateLinkResourceData, PrivateLinkResource>(new PrivateLinksGetAllAsyncCollectionResultOfT(_privateLinksRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context, "PrivateLinkResourceCollection.GetAll"), data => new PrivateLinkResource(Client, data));
        }
        ...
        public virtual Pageable<PrivateLinkResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<SecurityPrivateLinkResourceData, PrivateLinkResource>(new PrivateLinksGetAllCollectionResultOfT(_privateLinksRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context, "PrivateLinkResourceCollection.GetAll"), data => new PrivateLinkResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(PrivateLinkParameters privateLinkName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response<SecurityPrivateLinkResourceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(SecurityPrivateLinkResourceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((SecurityPrivateLinkResourceData)null, result);
                        break;
                    default:
