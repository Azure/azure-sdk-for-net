...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class SecurityConnectorApplicationCollection : ArmCollection, IEnumerable<SecurityConnectorApplicationResource>, IAsyncEnumerable<SecurityConnectorApplicationResource>
    {
        ...
        internal SecurityConnectorApplicationCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _securityConnectorApplicationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", SecurityConnectorApplicationResource.ResourceType.Namespace, Diagnostics);
            ...
            _securityConnectorApplicationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", SecurityConnectorApplicationResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SecurityConnectorApplicationResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string applicationId, ApplicationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _securityConnectorApplicationRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, applicationId, ApplicationData.ToRequestContent(data), context);
                ...
                SecurityArmOperation<SecurityConnectorApplicationResource> operation = new SecurityArmOperation<SecurityConnectorApplicationResource>(Response.FromValue(new SecurityConnectorApplicationResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="applicationId"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="applicationId"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<SecurityConnectorApplicationResource> CreateOrUpdate(WaitUntil waitUntil, string applicationId, ApplicationData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(applicationId, nameof(applicationId));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual AsyncPageable<SecurityConnectorApplicationResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ApplicationData, SecurityConnectorApplicationResource>(new SecurityConnectorApplicationsGetAllAsyncCollectionResultOfT(
        ...
        public virtual Pageable<SecurityConnectorApplicationResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ApplicationData, SecurityConnectorApplicationResource>(new SecurityConnectorApplicationsGetAllCollectionResultOfT(
                _securityConnectorApplicationsRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.ResourceGroupName,
                Id.Name,
