...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class SecurityContactCollection : ArmCollection, IEnumerable<SecurityContactResource>, IAsyncEnumerable<SecurityContactResource>
    {
        ...
        internal SecurityContactCollection(ArmClient client, Core.ResourceIdentifier id) : base(client, id)
        {
            TryGetApiVersion(SecurityContactResource.ResourceType, out string securityContactApiVersion);
            _securityContactsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", SecurityContactResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SecurityContactResource>> CreateOrUpdateAsync(WaitUntil waitUntil, SecurityContactName securityContactName, SecurityContactData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                SecurityArmOperation<SecurityContactResource> operation = new SecurityArmOperation<SecurityContactResource>(Response.FromValue(new SecurityContactResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
