...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class DefenderForStorageSettingResource : IJsonModel<DefenderForStorageSettingData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DefenderForStorageSettingData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<DefenderForStorageSettingData>(Data, options, AzureResourceManagerSecurityContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DefenderForStorageSettingData IPersistableModel<DefenderForStorageSettingData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<DefenderForStorageSettingData>(data, options, AzureResourceManagerSecurityContext.Default);
