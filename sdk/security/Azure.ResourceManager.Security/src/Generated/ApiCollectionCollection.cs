...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class ApiCollectionCollection : ArmCollection, IEnumerable<ApiCollectionResource>, IAsyncEnumerable<ApiCollectionResource>
    {
        ...
        internal ApiCollectionCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _apiCollectionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", ApiCollectionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<ApiCollectionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string apiId, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                SecurityArmOperation<ApiCollectionResource> operation = new SecurityArmOperation<ApiCollectionResource>(
