...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class AlertData : ResourceData
    {
        ...
        internal AlertData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AlertProperties properties) : base(id, name, resourceType, systemData)
        {
