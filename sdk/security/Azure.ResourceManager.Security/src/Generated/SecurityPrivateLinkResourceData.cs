...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class SecurityPrivateLinkResourceData : TrackedResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SecurityPrivateLinkResourceData"/>. </summary>
        /// <param name="location"> The geo-location where the resource lives. </param>
        public SecurityPrivateLinkResourceData(AzureLocation location) : base(location)
        {
        ...
        internal SecurityPrivateLinkResourceData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, PrivateLinkProperties properties) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public IReadOnlyList<SecurityPrivateEndpointConnectionData> PrivateEndpointConnections
        {
            get
            {
