...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class GitLabGroupCollection : ArmCollection, IEnumerable<GitLabGroupResource>, IAsyncEnumerable<GitLabGroupResource>
    {
        ...
        internal GitLabGroupCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _gitLabGroupsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", GitLabGroupResource.ResourceType.Namespace, Diagnostics);
            ...
            _gitLabSubgroupsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", GitLabGroupResource.ResourceType.Namespace, Diagnostics);
