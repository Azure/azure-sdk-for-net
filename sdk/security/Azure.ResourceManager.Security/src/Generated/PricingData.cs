...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class PricingData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="PricingData"/>. </summary>
        public PricingData()
        {
        }
        ...
        internal PricingData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PricingProperties properties) : base(id, name, resourceType, systemData)
        {
