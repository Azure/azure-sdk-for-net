...
{
    /// <summary>
    /// A class representing a AscLocation along with the instance operations that can be performed on it.
    /// If you have a <see cref="Core.ResourceIdentifier"/> you can construct a <see cref="AscLocationResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="SubscriptionResource"/> using the GetAscLocations method.
    /// </summary>
    public partial class AscLocationResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of AscLocationResource for mocking. </summary>
        protected AscLocationResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="AscLocationResource"/> class. </summary>
        ...
        internal AscLocationResource(ArmClient client, Core.ResourceIdentifier id) : base(client, id)
        {
            TryGetApiVersion(ResourceType, out string ascLocationApiVersion);
            _locationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", ResourceType.Namespace, Diagnostics);
            ...
            _operationResultsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", ResourceType.Namespace, Diagnostics);
            ...
            _operationStatusesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", ResourceType.Namespace, Diagnostics);
            ...
            _securitySolutionsReferenceDataClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", ResourceType.Namespace, Diagnostics);
        ...
        /// <item>
        /// <term> Resource. </term>
        /// <description> <see cref="AscLocationResource"/>. </description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using DiagnosticScope scope = _locationsClientDiagnostics.CreateScope("AscLocationResource.Get");
            scope.Start();
            try
            {
        ...
        public virtual async Task<ArmOperation> SimulateAsync(WaitUntil waitUntil, AlertSimulatorRequestBody alertSimulatorRequestBody, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _alertsClientDiagnostics.CreateScope("AscLocationResource.Simulate");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                SecurityArmOperation operation = new SecurityArmOperation(_alertsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.OriginalUri);
        ...
        public virtual async Task<Response> GetOperationResultAsync(string operationId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _operationResultsClientDiagnostics.CreateScope("AscLocationResource.GetOperationResult");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        {
            using DiagnosticScope scope = _securitySolutionsReferenceDataClientDiagnostics.CreateScope("AscLocationResource.GetByHomeRegion");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary> Gets a collection of Alerts in the <see cref="AscLocationResource"/>. </summary>
        ...
        /// <summary> Gets a collection of Tasks in the <see cref="AscLocationResource"/>. </summary>
