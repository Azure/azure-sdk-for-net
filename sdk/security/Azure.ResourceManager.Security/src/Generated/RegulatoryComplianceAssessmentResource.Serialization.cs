...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class RegulatoryComplianceAssessmentResource : IJsonModel<RegulatoryComplianceAssessmentData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RegulatoryComplianceAssessmentData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<RegulatoryComplianceAssessmentData>(Data, options, AzureResourceManagerSecurityContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RegulatoryComplianceAssessmentData IPersistableModel<RegulatoryComplianceAssessmentData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<RegulatoryComplianceAssessmentData>(data, options, AzureResourceManagerSecurityContext.Default);
