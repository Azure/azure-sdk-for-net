...
namespace Azure.ResourceManager.Security
{
    ...
    /// Each <see cref="TaskResource"/> in the collection will belong to the same instance of <see cref="AscLocationResource"/>.
    /// To get a <see cref="TaskCollection"/> instance call the GetTasks method from an instance of <see cref="AscLocationResource"/>.
    /// </summary>
    public partial class TaskCollection : ArmCollection, IEnumerable<TaskResource>, IAsyncEnumerable<TaskResource>
    {
        ...
        internal TaskCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _tasksClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", TaskResource.ResourceType.Namespace, Diagnostics);
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, AscLocationResource.ResourceType), nameof(id));
            }
        }
        ...
        public virtual AsyncPageable<TaskResource> GetAllAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityTaskData, TaskResource>(new TasksGetByHomeRegionAsyncCollectionResultOfT(
                _tasksRestClient,
        ...
        public virtual Pageable<TaskResource> GetAll(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<SecurityTaskData, TaskResource>(new TasksGetByHomeRegionCollectionResultOfT(
                _tasksRestClient,
                Guid.Parse(Id.SubscriptionId),
                Id.Name,
                filter,
