...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class JitNetworkAccessPolicyCollection : ArmCollection, IEnumerable<JitNetworkAccessPolicyResource>, IAsyncEnumerable<JitNetworkAccessPolicyResource>
    {
        ...
        internal JitNetworkAccessPolicyCollection(ArmClient client, ResourceIdentifier id, string ascLocation) : base(client, id)
        {
            ...
            _jitNetworkAccessPoliciesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", JitNetworkAccessPolicyResource.ResourceType.Namespace, Diagnostics);
