...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class ComplianceData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ComplianceData"/>. </summary>
        internal ComplianceData()
        {
        }
        ...
        internal ComplianceData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ComplianceProperties properties) : base(id, name, resourceType, systemData)
        {
