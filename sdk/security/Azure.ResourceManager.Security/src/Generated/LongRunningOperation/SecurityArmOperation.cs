...
{
    internal partial class SecurityArmOperation : ArmOperation
    {
        ...
        internal SecurityArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SecurityArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
