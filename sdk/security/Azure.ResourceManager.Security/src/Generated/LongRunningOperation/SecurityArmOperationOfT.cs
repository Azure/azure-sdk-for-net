...
{
    internal partial class SecurityArmOperation<T> : ArmOperation<T>
    {
        ...
        /// <summary> Initializes a new instance of SecurityArmOperation for mocking. </summary>
        protected SecurityArmOperation()
        {
        }
        ...
        internal SecurityArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SecurityArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
