...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class PrivateEndpointConnectionProperties
    {
        ...
        public PrivateEndpointConnectionProperties(SecurityPrivateLinkServiceConnectionState privateLinkServiceConnectionState)
        {
        ...
        internal PrivateEndpointConnectionProperties(IReadOnlyList<string> groupIds, PrivateEndpoint privateEndpoint, SecurityPrivateLinkServiceConnectionState privateLinkServiceConnectionState, SecurityPrivateEndpointConnectionProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            GroupIds = groupIds;
        ...
        public SecurityPrivateLinkServiceConnectionState PrivateLinkServiceConnectionState { get; set; }

        /// <summary> The provisioning state of the private endpoint connection resource. </summary>
        public SecurityPrivateEndpointConnectionProvisioningState? ProvisioningState { get; }
