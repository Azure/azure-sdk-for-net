...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class OnPremiseSqlResourceDetails : OnPremiseResourceDetails
    {
        ...
        public OnPremiseSqlResourceDetails(string workspaceId, string vmuuid, string sourceComputerId, string machineName, string serverName, string databaseName) : base("OnPremiseSql", workspaceId, vmuuid, sourceComputerId, machineName)
        {
        ...
        /// <param name="serverName"> The Sql server name installed on the machine. </param>
        /// <param name="databaseName"> The Sql database name installed on the machine. </param>
        internal OnPremiseSqlResourceDetails(Source? source, string id, string connectorId, IDictionary<string, BinaryData> additionalBinaryDataProperties, string workspaceId, string vmuuid, string sourceComputerId, string machineName, string serverName, string databaseName) : base(source, id, connectorId, additionalBinaryDataProperties, workspaceId, vmuuid, sourceComputerId, machineName)
        {
            ServerName = serverName;
            DatabaseName = databaseName;
        }
