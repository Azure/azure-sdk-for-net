...
namespace Azure.ResourceManager.Security.Models
{
    ...
    internal partial class GovernanceRuleProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GovernanceRuleProperties"/>. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="displayName"/>, <paramref name="conditionSets"/> or <paramref name="ownerSource"/> is null. </exception>
        public GovernanceRuleProperties(string displayName, int rulePriority, GovernanceRuleType ruleType, GovernanceRuleSourceResourceType sourceResourceType, IEnumerable<BinaryData> conditionSets, GovernanceRuleOwnerSource ownerSource)
        {
            Argument.AssertNotNull(displayName, nameof(displayName));
            Argument.AssertNotNull(conditionSets, nameof(conditionSets));
            Argument.AssertNotNull(ownerSource, nameof(ownerSource));
