...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class SecurityAssessmentMetadataProperties
    {
        ...
        internal SecurityAssessmentMetadataProperties(string displayName, string policyDefinitionId, string description, string remediationDescription, IList<Categories> categories, Severity severity, UserImpact? userImpact, ImplementationEffort? implementationEffort, IList<Threats> threats, bool? preview, AssessmentType assessmentType, SecurityAssessmentMetadataPartnerData partnerData, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DisplayName = displayName;
        ...
        public IList<Categories> Categories { get; } = new ChangeTrackingList<Categories>();
        ...
        public IList<Threats> Threats { get; } = new ChangeTrackingList<Threats>();
