...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class GovernanceRuleMetadata
    {
        ...
        internal GovernanceRuleMetadata(string createdBy, DateTimeOffset? createdOn, string updatedBy, DateTimeOffset? updatedOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            CreatedBy = createdBy;
            CreatedOn = createdOn;
            UpdatedBy = updatedBy;
