...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class DefenderForServersAwsOfferingMdeAutoProvisioning
    {
        ...
        internal DefenderForServersAwsOfferingMdeAutoProvisioning(bool? enabled, BinaryData configuration, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Enabled = enabled;
