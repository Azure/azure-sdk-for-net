...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class CspmMonitorGitLabOffering : CloudOffering, IJsonModel<CspmMonitorGitLabOffering>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CspmMonitorGitLabOffering>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CspmMonitorGitLabOffering>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CspmMonitorGitLabOffering IPersistableModel<CspmMonitorGitLabOffering>.Create(BinaryData data, ModelReaderWriterOptions options) => (CspmMonitorGitLabOffering)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CspmMonitorGitLabOffering IJsonModel<CspmMonitorGitLabOffering>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CspmMonitorGitLabOffering)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CspmMonitorGitLabOffering DeserializeCspmMonitorGitLabOffering(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new CspmMonitorGitLabOffering(offeringType, description, additionalBinaryDataProperties);
        }
    }
}
