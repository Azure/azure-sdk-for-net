...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class JitNetworkAccessPortRule
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="maxRequestAccessDuration"/> is null. </exception>
        public JitNetworkAccessPortRule(int number, Protocol protocol, string maxRequestAccessDuration)
        {
            Argument.AssertNotNull(maxRequestAccessDuration, nameof(maxRequestAccessDuration));
        ...
        internal JitNetworkAccessPortRule(int number, Protocol protocol, string allowedSourceAddressPrefix, IList<string> allowedSourceAddressPrefixes, string maxRequestAccessDuration, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Number = number;
            Protocol = protocol;
