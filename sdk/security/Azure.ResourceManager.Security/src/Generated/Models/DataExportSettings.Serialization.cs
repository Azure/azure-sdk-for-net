...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class DataExportSettings : SettingData, IJsonModel<DataExportSettings>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DataExportSettings>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DataExportSettings>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DataExportSettings IPersistableModel<DataExportSettings>.Create(BinaryData data, ModelReaderWriterOptions options) => (DataExportSettings)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataExportSettings IJsonModel<DataExportSettings>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DataExportSettings)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DataExportSettings DeserializeDataExportSettings(JsonElement element, ModelReaderWriterOptions options)
        {
