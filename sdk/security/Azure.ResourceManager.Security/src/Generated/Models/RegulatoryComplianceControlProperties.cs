...
namespace Azure.ResourceManager.Security.Models
{
    ...
    internal partial class RegulatoryComplianceControlProperties
    {
        ...
        internal RegulatoryComplianceControlProperties(string description, State? state, int? passedAssessments, int? failedAssessments, int? skippedAssessments, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
