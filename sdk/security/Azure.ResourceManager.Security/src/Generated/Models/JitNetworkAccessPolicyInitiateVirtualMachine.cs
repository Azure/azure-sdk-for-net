...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class JitNetworkAccessPolicyInitiateVirtualMachine
    {
        ...
        internal JitNetworkAccessPolicyInitiateVirtualMachine(string id, IList<JitNetworkAccessPolicyInitiatePort> ports, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Ports = ports;
