...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class RulesResults
    {
        ...
        {
            Value = new ChangeTrackingList<RuleResultsData>();
        }
        ...
        internal RulesResults(IList<RuleResultsData> value, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<RuleResultsData> Value { get; }
