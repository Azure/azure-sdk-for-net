...
namespace Azure.ResourceManager.Security.Models
{
    ...
    internal partial class IoTSecuritySolutionsList : IJsonModel<IoTSecuritySolutionsList>
    {
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            foreach (IoTSecuritySolutionModelData item in Value)
            {
        ...
        internal static IoTSecuritySolutionsList DeserializeIoTSecuritySolutionsList(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<IoTSecuritySolutionModelData> value = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(IoTSecuritySolutionModelData.DeserializeIoTSecuritySolutionModelData(item, options));
                    }
                    value = array;
                    continue;
                }
