...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class AzureResourceIdentifier : ResourceIdentifier
    {
        ...
        internal AzureResourceIdentifier(ResourceIdentifierType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string azureResourceId) : base(@type, additionalBinaryDataProperties)
        {
