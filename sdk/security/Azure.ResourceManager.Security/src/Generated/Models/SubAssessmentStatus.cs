...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class SubAssessmentStatus
    {
        ...
        internal SubAssessmentStatus(SubAssessmentStatusCode? code, string cause, string description, Severity? severity, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Code = code;
            Cause = cause;
