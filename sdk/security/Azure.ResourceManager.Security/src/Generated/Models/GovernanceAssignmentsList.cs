...
namespace Azure.ResourceManager.Security.Models
{
    ...
    internal partial class GovernanceAssignmentsList
    {
        ...
        internal GovernanceAssignmentsList(IReadOnlyList<GovernanceAssignmentData> value, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
