...
namespace Azure.ResourceManager.Security.Models
{
    ...
    internal partial class IoTSecuritySolutionsList
    {
        ...
        internal IoTSecuritySolutionsList(IList<IoTSecuritySolutionModelData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<IoTSecuritySolutionModelData> Value { get; }
