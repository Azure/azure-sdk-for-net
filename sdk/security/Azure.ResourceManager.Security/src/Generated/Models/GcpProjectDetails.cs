...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class GcpProjectDetails
    {
        ...
        internal GcpProjectDetails(string projectNumber, string projectId, string workloadIdentityPoolId, string projectName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
