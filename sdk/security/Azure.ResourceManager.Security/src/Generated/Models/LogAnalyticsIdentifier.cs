...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class LogAnalyticsIdentifier : ResourceIdentifier
    {
        ...
        internal LogAnalyticsIdentifier(ResourceIdentifierType @type, IDictionary<string, BinaryData> additionalBinaryDataProperties, string workspaceId, string workspaceSubscriptionId, string workspaceResourceGroup, string agentId) : base(@type, additionalBinaryDataProperties)
        {
