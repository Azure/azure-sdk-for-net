...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class SecuritySolutionsReferenceData
    {
        ...
        internal SecuritySolutionsReferenceData(Core.ResourceIdentifier id, string name, ResourceType? @type, SystemData systemData, string location, SecuritySolutionsReferenceDataProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Type = @type;
