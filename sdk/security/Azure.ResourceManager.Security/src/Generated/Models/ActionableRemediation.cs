...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class ActionableRemediation
    {
        ...
        internal ActionableRemediation(ActionableRemediationState? state, IList<CategoryConfiguration> categoryConfigurations, TargetBranchConfiguration branchConfiguration, InheritFromParentState? inheritFromParentState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            State = state;
