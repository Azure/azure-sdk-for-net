...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class DefenderForContainersDockerHubOffering : CloudOffering
    {
        ...
        internal DefenderForContainersDockerHubOffering(OfferingType offeringType, string description, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(offeringType, description, additionalBinaryDataProperties)
        {
        }
    }
}
