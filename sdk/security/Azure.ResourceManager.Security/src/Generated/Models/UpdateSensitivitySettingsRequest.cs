...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class UpdateSensitivitySettingsRequest
    {
        ...
        /// <summary> Initializes a new instance of <see cref="UpdateSensitivitySettingsRequest"/>. </summary>
        ...
        public UpdateSensitivitySettingsRequest(IEnumerable<Guid> sensitiveInfoTypesIds)
        {
        ...
        internal UpdateSensitivitySettingsRequest(IList<Guid> sensitiveInfoTypesIds, float? sensitivityThresholdLabelOrder, string sensitivityThresholdLabelId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
