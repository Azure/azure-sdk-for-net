...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public readonly partial struct SecuritySolutionStatus : IEquatable<SecuritySolutionStatus>
    {
        ...
        /// <summary> Converts a string to a <see cref="SecuritySolutionStatus"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator SecuritySolutionStatus(string value) => new SecuritySolutionStatus(value);

        /// <summary> Converts a string to a <see cref="SecuritySolutionStatus"/>. </summary>
        /// <param name="value"> The value. </param>
        public static implicit operator SecuritySolutionStatus?(string value) => value == null ? null : new SecuritySolutionStatus(value);
