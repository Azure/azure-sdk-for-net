...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class DefenderCspmGcpOfferingDataSensitivityDiscovery
    {
        ...
        internal DefenderCspmGcpOfferingDataSensitivityDiscovery(bool? enabled, string workloadIdentityProviderId, string serviceAccountEmailAddress, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Enabled = enabled;
