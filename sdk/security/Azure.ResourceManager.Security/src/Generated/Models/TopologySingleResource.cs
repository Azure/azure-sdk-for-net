...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class TopologySingleResource
    {
        ...
        internal TopologySingleResource(string resourceId, string severity, bool? recommendationsExist, string networkZones, int? topologyScore, string location, IReadOnlyList<TopologySingleResourceParent> parents, IReadOnlyList<TopologySingleResourceChild> children, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
