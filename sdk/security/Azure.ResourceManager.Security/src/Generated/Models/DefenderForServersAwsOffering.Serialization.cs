...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class DefenderForServersAwsOffering : CloudOffering, IJsonModel<DefenderForServersAwsOffering>
    {
        ...
        internal static DefenderForServersAwsOffering DeserializeDefenderForServersAwsOffering(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            DefenderForServersAwsOfferingVaAutoProvisioning vaAutoProvisioning = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("vaAutoProvisioning"u8))
                {
                    ...
                    vaAutoProvisioning = DefenderForServersAwsOfferingVaAutoProvisioning.DeserializeDefenderForServersAwsOfferingVaAutoProvisioning(prop.Value, options);
                    continue;
                }
