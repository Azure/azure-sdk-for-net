...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class DefenderForServersGcpOfferingDefenderForServers
    {
        ...
        /// <summary> Initializes a new instance of <see cref="DefenderForServersGcpOfferingDefenderForServers"/>. </summary>
        ...
        internal DefenderForServersGcpOfferingDefenderForServers(string workloadIdentityProviderId, string serviceAccountEmailAddress, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
