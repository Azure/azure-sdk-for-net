...
namespace Azure.ResourceManager.Security.Models
{
    ...
    internal partial class RegulatoryComplianceStandardProperties
    {
        ...
        internal RegulatoryComplianceStandardProperties(State? state, int? passedControls, int? failedControls, int? skippedControls, int? unsupportedControls, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            State = state;
