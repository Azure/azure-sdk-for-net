...
namespace Azure.ResourceManager.Security.Models
{
    ...
    public partial class DefenderForServersGcpOffering : CloudOffering, IJsonModel<DefenderForServersGcpOffering>
    {
        ...
        internal static DefenderForServersGcpOffering DeserializeDefenderForServersGcpOffering(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            DefenderForServersGcpOfferingDefenderForServers defenderForServers = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("defenderForServers"u8))
                {
                    ...
                    defenderForServers = DefenderForServersGcpOfferingDefenderForServers.DeserializeDefenderForServersGcpOfferingDefenderForServers(prop.Value, options);
                    continue;
                }
