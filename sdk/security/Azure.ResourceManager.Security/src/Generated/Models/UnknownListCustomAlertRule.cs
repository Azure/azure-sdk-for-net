...
namespace Azure.ResourceManager.Security.Models
{
    internal partial class UnknownListCustomAlertRule : ListCustomAlertRule
    {
        ...
        internal UnknownListCustomAlertRule(string displayName, string description, bool isEnabled, string ruleType, IDictionary<string, BinaryData> additionalBinaryDataProperties, ValueType? valueType) : base(displayName, description, isEnabled, ruleType ?? "unknown", additionalBinaryDataProperties, valueType)
        {
        }
    }
}
