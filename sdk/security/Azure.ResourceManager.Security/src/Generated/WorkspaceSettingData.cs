...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class WorkspaceSettingData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="WorkspaceSettingData"/>. </summary>
        ...
        internal WorkspaceSettingData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, WorkspaceSettingProperties properties) : base(id, name, resourceType, systemData)
        {
