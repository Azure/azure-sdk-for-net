...
namespace Azure.ResourceManager.Security.Mocking
{
    ...
    public partial class MockableSecuritySubscriptionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of MockableSecuritySubscriptionResource for mocking. </summary>
        protected MockableSecuritySubscriptionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="MockableSecuritySubscriptionResource"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MockableSecuritySubscriptionResource(ArmClient client, Core.ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics AutomationsClientDiagnostics => _automationsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics SecurityConnectorsClientDiagnostics => _securityConnectorsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics DiscoveredSecuritySolutionsClientDiagnostics => _discoveredSecuritySolutionsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics ExternalSecuritySolutionsClientDiagnostics => _externalSecuritySolutionsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics StandardsClientDiagnostics => _standardsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics AssignmentsClientDiagnostics => _assignmentsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics IotSecuritySolutionClientDiagnostics => _iotSecuritySolutionClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics AllowedConnectionsClientDiagnostics => _allowedConnectionsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics TopologyClientDiagnostics => _topologyClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics SecuritySolutionsClientDiagnostics => _securitySolutionsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics TasksClientDiagnostics => _tasksClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);

        private Tasks TasksRestClient => _tasksRestClient ??= new Tasks(TasksClientDiagnostics, Pipeline, Endpoint, "2015-06-01-preview");

        private ClientDiagnostics SecureScoreControlsClientDiagnostics => _secureScoreControlsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        private ClientDiagnostics SecuritySolutionsReferenceDataClientDiagnostics => _securitySolutionsReferenceDataClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Security.Mocking", ProviderConstants.DefaultProviderNamespace, Diagnostics);
        ...
        /// <summary> Gets a collection of AlertsSuppressionRules in the <see cref="SubscriptionResource"/>. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<AlertsSuppressionRuleResource>> GetAlertsSuppressionRuleAsync(string alertsSuppressionRuleName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(alertsSuppressionRuleName, nameof(alertsSuppressionRuleName));

            return await GetAlertsSuppressionRules().GetAsync(alertsSuppressionRuleName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="alertsSuppressionRuleName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<AlertsSuppressionRuleResource> GetAlertsSuppressionRule(string alertsSuppressionRuleName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(alertsSuppressionRuleName, nameof(alertsSuppressionRuleName));

            return GetAlertsSuppressionRules().Get(alertsSuppressionRuleName, cancellationToken);
        }
        ...
        /// <summary> Gets a collection of WorkspaceSettings in the <see cref="SubscriptionResource"/>. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<WorkspaceSettingResource>> GetWorkspaceSettingAsync(string workspaceSettingName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workspaceSettingName, nameof(workspaceSettingName));

            return await GetWorkspaceSettings().GetAsync(workspaceSettingName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="workspaceSettingName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<WorkspaceSettingResource> GetWorkspaceSetting(string workspaceSettingName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(workspaceSettingName, nameof(workspaceSettingName));

            return GetWorkspaceSettings().Get(workspaceSettingName, cancellationToken);
        }
        ...
        /// <summary> Gets a collection of Settings in the <see cref="SubscriptionResource"/>. </summary>
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual async Task<Response<SettingResource>> GetSettingAsync(SettingName settingName, CancellationToken cancellationToken = default)
        {
            return await GetSettings().GetAsync(settingName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual Response<SettingResource> GetSetting(SettingName settingName, CancellationToken cancellationToken = default)
        {
            return GetSettings().Get(settingName, cancellationToken);
        }
        ...
        /// <summary> Gets a collection of AscLocations in the <see cref="SubscriptionResource"/>. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<AscLocationResource>> GetAscLocationAsync(string ascLocation, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ascLocation, nameof(ascLocation));

            return await GetAscLocations().GetAsync(ascLocation, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="ascLocation"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<AscLocationResource> GetAscLocation(string ascLocation, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(ascLocation, nameof(ascLocation));

            return GetAscLocations().Get(ascLocation, cancellationToken);
        }

        /// <summary> Gets a collection of SecureScoreItems in the <see cref="SubscriptionResource"/>. </summary>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<SecureScoreItemResource>> GetSecureScoreItemAsync(string secureScoreName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(secureScoreName, nameof(secureScoreName));

            return await GetSecureScoreItems().GetAsync(secureScoreName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="secureScoreName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<SecureScoreItemResource> GetSecureScoreItem(string secureScoreName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(secureScoreName, nameof(secureScoreName));

            return GetSecureScoreItems().Get(secureScoreName, cancellationToken);
        }
        ...
        public virtual AsyncPageable<AutomationResource> GetAutomationsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<AutomationData, AutomationResource>(new AutomationsGetAllAsyncCollectionResultOfT(AutomationsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetAutomations"), data => new AutomationResource(Client, data));
        }
        ...
        public virtual Pageable<AutomationResource> GetAutomations(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<AutomationData, AutomationResource>(new AutomationsGetAllCollectionResultOfT(AutomationsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetAutomations"), data => new AutomationResource(Client, data));
        }
        ...
        public virtual AsyncPageable<SecurityConnectorResource> GetSecurityConnectorsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityConnectorData, SecurityConnectorResource>(new SecurityConnectorsGetAllAsyncCollectionResultOfT(SecurityConnectorsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetSecurityConnectors"), data => new SecurityConnectorResource(Client, data));
        }
        ...
        public virtual Pageable<SecurityConnectorResource> GetSecurityConnectors(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<SecurityConnectorData, SecurityConnectorResource>(new SecurityConnectorsGetAllCollectionResultOfT(SecurityConnectorsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetSecurityConnectors"), data => new SecurityConnectorResource(Client, data));
        }
        ...
        public virtual AsyncPageable<DiscoveredSecuritySolutionResource> GetDiscoveredSecuritySolutionsAsync(string ascLocation, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DiscoveredSecuritySolutionData, DiscoveredSecuritySolutionResource>(new DiscoveredSecuritySolutionsGetByHomeRegionAsyncCollectionResultOfT(DiscoveredSecuritySolutionsRestClient, Guid.Parse(Id.SubscriptionId), ascLocation, context, "MockableSecuritySubscriptionResource.GetDiscoveredSecuritySolutions"), data => new DiscoveredSecuritySolutionResource(Client, data));
        }
        ...
        public virtual Pageable<JitNetworkAccessPolicyResource> GetJitNetworkAccessPolicies(string ascLocation, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<JitNetworkAccessPolicyData, JitNetworkAccessPolicyResource>(new JitNetworkAccessPoliciesGetByRegionCollectionResultOfT(JitNetworkAccessPoliciesRestClient, Guid.Parse(Id.SubscriptionId), ascLocation, context, "MockableSecuritySubscriptionResource.GetJitNetworkAccessPolicies"), data => new JitNetworkAccessPolicyResource(Client, data));
        }
        ...
        public virtual AsyncPageable<StandardResource> GetStandardsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<StandardData, StandardResource>(new StandardsGetBySubscriptionAsyncCollectionResultOfT(StandardsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetStandards"), data => new StandardResource(Client, data));
        }
        ...
        public virtual Pageable<StandardResource> GetStandards(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<StandardData, StandardResource>(new StandardsGetBySubscriptionCollectionResultOfT(StandardsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetStandards"), data => new StandardResource(Client, data));
        }
        ...
        public virtual AsyncPageable<AssignmentResource> GetAssignmentsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<AssignmentData, AssignmentResource>(new AssignmentsGetBySubscriptionAsyncCollectionResultOfT(AssignmentsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetAssignments"), data => new AssignmentResource(Client, data));
        }
        ...
        public virtual Pageable<AssignmentResource> GetAssignments(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<AssignmentData, AssignmentResource>(new AssignmentsGetBySubscriptionCollectionResultOfT(AssignmentsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetAssignments"), data => new AssignmentResource(Client, data));
        }
        ...
        public virtual AsyncPageable<ApiCollectionResource> GetApiCollectionsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ApiCollectionData, ApiCollectionResource>(new APICollectionsGetBySubscriptionAsyncCollectionResultOfT(APICollectionsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetApiCollections"), data => new ApiCollectionResource(Client, data));
        }
        ...
        public virtual Pageable<ApiCollectionResource> GetApiCollections(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<ApiCollectionData, ApiCollectionResource>(new APICollectionsGetBySubscriptionCollectionResultOfT(APICollectionsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetApiCollections"), data => new ApiCollectionResource(Client, data));
        }
        ...
        public virtual AsyncPageable<IoTSecuritySolutionModelResource> GetIoTSecuritySolutionModelsAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new AsyncPageableWrapper<IoTSecuritySolutionModelData, IoTSecuritySolutionModelResource>(new IotSecuritySolutionGetBySubscriptionAsyncCollectionResultOfT(IotSecuritySolutionRestClient, Guid.Parse(Id.SubscriptionId), filter, context, "MockableSecuritySubscriptionResource.GetIoTSecuritySolutionModels"), data => new IoTSecuritySolutionModelResource(Client, data));
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="IoTSecuritySolutionModelResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<IoTSecuritySolutionModelResource> GetIoTSecuritySolutionModels(string filter = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new PageableWrapper<IoTSecuritySolutionModelData, IoTSecuritySolutionModelResource>(new IotSecuritySolutionGetBySubscriptionCollectionResultOfT(IotSecuritySolutionRestClient, Guid.Parse(Id.SubscriptionId), filter, context, "MockableSecuritySubscriptionResource.GetIoTSecuritySolutionModels"), data => new IoTSecuritySolutionModelResource(Client, data));
        }
        ...
        public virtual AsyncPageable<PrivateLinkResource> GetPrivateLinkResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecurityPrivateLinkResourceData, PrivateLinkResource>(new PrivateLinksGetBySubscriptionAsyncCollectionResultOfT(PrivateLinksRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetPrivateLinkResources"), data => new PrivateLinkResource(Client, data));
        }
        ...
        public virtual Pageable<PrivateLinkResource> GetPrivateLinkResources(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<SecurityPrivateLinkResourceData, PrivateLinkResource>(new PrivateLinksGetBySubscriptionCollectionResultOfT(PrivateLinksRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetPrivateLinkResources"), data => new PrivateLinkResource(Client, data));
        }
        ...
        public virtual AsyncPageable<AllowedConnectionsResource> GetAllowedConnectionsResourcesAsync(string ascLocation, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<AllowedConnectionsResourceData, AllowedConnectionsResource>(new AllowedConnectionsGetByHomeRegionAsyncCollectionResultOfT(AllowedConnectionsRestClient, Guid.Parse(Id.SubscriptionId), ascLocation, context, "MockableSecuritySubscriptionResource.GetAllowedConnectionsResources"), data => new AllowedConnectionsResource(Client, data));
        }
        ...
        public virtual Pageable<AllowedConnectionsResource> GetAllowedConnectionsResources(string ascLocation, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<AllowedConnectionsResourceData, AllowedConnectionsResource>(new AllowedConnectionsGetByHomeRegionCollectionResultOfT(AllowedConnectionsRestClient, Guid.Parse(Id.SubscriptionId), ascLocation, context, "MockableSecuritySubscriptionResource.GetAllowedConnectionsResources"), data => new AllowedConnectionsResource(Client, data));
        }
        ...
        public virtual AsyncPageable<TopologyResource> GetTopologyResourcesAsync(string ascLocation, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<TopologyResourceData, TopologyResource>(new TopologyGetByHomeRegionAsyncCollectionResultOfT(TopologyRestClient, Guid.Parse(Id.SubscriptionId), ascLocation, context, "MockableSecuritySubscriptionResource.GetTopologyResources"), data => new TopologyResource(Client, data));
        }
        ...
        public virtual Pageable<TopologyResource> GetTopologyResources(string ascLocation, CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<TopologyResourceData, TopologyResource>(new TopologyGetByHomeRegionCollectionResultOfT(TopologyRestClient, Guid.Parse(Id.SubscriptionId), ascLocation, context, "MockableSecuritySubscriptionResource.GetTopologyResources"), data => new TopologyResource(Client, data));
        }
        ...
        public virtual AsyncPageable<AlertData> GetAllAsync(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new AlertsGetAllAsyncCollectionResultOfT(AlertsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetAll");
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="AlertData"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<AlertData> GetAll(CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
            };
            return new AlertsGetAllCollectionResultOfT(AlertsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetAll");
        }
        ...
        public virtual Pageable<DiscoveredSecuritySolutionResource> GetDiscoveredSecuritySolutions(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<DiscoveredSecuritySolutionData, DiscoveredSecuritySolutionResource>(new DiscoveredSecuritySolutionsGetDiscoveredSecuritySolutionsCollectionResultOfT(DiscoveredSecuritySolutionsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetDiscoveredSecuritySolutions"), data => new DiscoveredSecuritySolutionResource(Client, data));
        }
        ...
        public virtual AsyncPageable<ExternalSecuritySolutionResource> GetExternalSecuritySolutionsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ExternalSecuritySolutionData, ExternalSecuritySolutionResource>(new ExternalSecuritySolutionsGetExternalSecuritySolutionsAsyncCollectionResultOfT(ExternalSecuritySolutionsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetExternalSecuritySolutions"), data => new ExternalSecuritySolutionResource(Client, data));
        }
        ...
        public virtual AsyncPageable<SecuritySolutionResource> GetSecuritySolutionsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<SecuritySolutionData, SecuritySolutionResource>(new SecuritySolutionsGetSecuritySolutionsAsyncCollectionResultOfT(SecuritySolutionsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetSecuritySolutions"), data => new SecuritySolutionResource(Client, data));
        }
        ...
        public virtual Pageable<SecuritySolutionResource> GetSecuritySolutions(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<SecuritySolutionData, SecuritySolutionResource>(new SecuritySolutionsGetSecuritySolutionsCollectionResultOfT(SecuritySolutionsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetSecuritySolutions"), data => new SecuritySolutionResource(Client, data));
        }
        ...
        public virtual AsyncPageable<SecurityTaskData> GetAllAsync(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new TasksGetAllAsyncCollectionResultOfT(TasksRestClient, Guid.Parse(Id.SubscriptionId), filter, context, "MockableSecuritySubscriptionResource.GetAll");
        }
        ...
        public virtual Pageable<SecurityTaskData> GetAll(string filter = default, CancellationToken cancellationToken = default)
        {
            ...
            return new TasksGetAllCollectionResultOfT(TasksRestClient, Guid.Parse(Id.SubscriptionId), filter, context, "MockableSecuritySubscriptionResource.GetAll");
        }
        ...
        public virtual AsyncPageable<SecureScoreControlDetails> GetAllAsync(ExpandControlsEnum? expand = default, CancellationToken cancellationToken = default)
        {
            ...
            return new SecureScoreControlsGetAllAsyncCollectionResultOfT(SecureScoreControlsRestClient, Guid.Parse(Id.SubscriptionId), expand?.ToString(), context, "MockableSecuritySubscriptionResource.GetAll");
        }
        ...
        public virtual Pageable<SecureScoreControlDetails> GetAll(ExpandControlsEnum? expand = default, CancellationToken cancellationToken = default)
        {
            ...
            return new SecureScoreControlsGetAllCollectionResultOfT(SecureScoreControlsRestClient, Guid.Parse(Id.SubscriptionId), expand?.ToString(), context, "MockableSecuritySubscriptionResource.GetAll");
        }
        ...
        public virtual AsyncPageable<SecureScoreControlDefinitionItem> GetBySubscriptionAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new SecureScoreControlDefinitionsGetBySubscriptionAsyncCollectionResultOfT(SecureScoreControlDefinitionsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetBySubscription");
        }
        ...
        public virtual Pageable<SecureScoreControlDefinitionItem> GetBySubscription(CancellationToken cancellationToken = default)
        {
            ...
            return new SecureScoreControlDefinitionsGetBySubscriptionCollectionResultOfT(SecureScoreControlDefinitionsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetBySubscription");
        }
        ...
        public virtual Pageable<AllowedConnectionsResource> GetAllowedConnections(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<AllowedConnectionsResourceData, AllowedConnectionsResource>(new AllowedConnectionsGetAllowedConnectionsCollectionResultOfT(AllowedConnectionsRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetAllowedConnections"), data => new AllowedConnectionsResource(Client, data));
        }
        ...
        public virtual AsyncPageable<TopologyResource> GetTopologiesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<TopologyResourceData, TopologyResource>(new TopologyGetTopologiesAsyncCollectionResultOfT(TopologyRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetTopologies"), data => new TopologyResource(Client, data));
        }
        ...
        public virtual Pageable<TopologyResource> GetTopologies(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<TopologyResourceData, TopologyResource>(new TopologyGetTopologiesCollectionResultOfT(TopologyRestClient, Guid.Parse(Id.SubscriptionId), context, "MockableSecuritySubscriptionResource.GetTopologies"), data => new TopologyResource(Client, data));
        }
        ...
        {
            using DiagnosticScope scope = SecuritySolutionsReferenceDataClientDiagnostics.CreateScope("MockableSecuritySubscriptionResource.GetSecuritySolutionsReferenceData");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
