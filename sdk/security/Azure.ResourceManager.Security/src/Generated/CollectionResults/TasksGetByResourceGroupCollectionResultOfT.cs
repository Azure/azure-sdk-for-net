...
{
    internal partial class TasksGetByResourceGroupCollectionResultOfT : Pageable<SecurityTaskData>
    {
        ...
        /// <summary> Initializes a new instance of TasksGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TasksGetByResourceGroupCollectionResultOfT(Tasks client, Guid subscriptionId, string resourceGroupName, string ascLocation, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TasksGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TasksGetByResourceGroupCollectionResultOfT as an enumerable collection. </returns>
