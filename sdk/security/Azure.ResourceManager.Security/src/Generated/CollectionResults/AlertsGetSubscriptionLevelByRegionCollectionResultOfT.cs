...
{
    internal partial class AlertsGetSubscriptionLevelByRegionCollectionResultOfT : Pageable<AlertData>
    {
        ...
        public AlertsGetSubscriptionLevelByRegionCollectionResultOfT(Alerts client, Guid subscriptionId, string ascLocation, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of AlertsGetSubscriptionLevelByRegionCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override IEnumerable<Page<AlertData>> AsPages(string continuationToken, int? pageSizeHint)
        {
