...
{
    internal partial class TasksGetByHomeRegionCollectionResultOfT : Pageable<SecurityTaskData>
    {
        ...
        /// <summary> Initializes a new instance of TasksGetByHomeRegionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public TasksGetByHomeRegionCollectionResultOfT(Tasks client, Guid subscriptionId, string ascLocation, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TasksGetByHomeRegionCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of TasksGetByHomeRegionCollectionResultOfT as an enumerable collection. </returns>
