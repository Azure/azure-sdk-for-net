...
{
    internal partial class TopologyGetTopologiesCollectionResultOfT : Pageable<TopologyResourceData>
    {
        ...
        /// <summary> Initializes a new instance of TopologyGetTopologiesCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The Topology client used to send requests. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. The value must be an UUID. </param>
        /// <param name="context"> The request options, which can override default behaviors of the client pipeline on a per-call basis. </param>
        /// <param name="diagnosticScope"> The diagnostic scope name. </param>
        public TopologyGetTopologiesCollectionResultOfT(Topology client, Guid subscriptionId, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of TopologyGetTopologiesCollectionResultOfT as an enumerable collection. </summary>
