...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class PrivateLinkGroupResource : IJsonModel<PrivateLinkGroupResourceData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PrivateLinkGroupResourceData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<PrivateLinkGroupResourceData>(Data, options, AzureResourceManagerSecurityContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        PrivateLinkGroupResourceData IPersistableModel<PrivateLinkGroupResourceData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<PrivateLinkGroupResourceData>(data, options, AzureResourceManagerSecurityContext.Default);
