...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class AutomationData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AutomationData"/>. </summary>
        ...
        internal AutomationData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AutomationProperties properties, IDictionary<string, string> tags, string location, string kind, string eTag) : base(id, name, resourceType, systemData)
        {
