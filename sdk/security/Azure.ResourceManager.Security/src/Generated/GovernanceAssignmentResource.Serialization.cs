...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class GovernanceAssignmentResource : IJsonModel<GovernanceAssignmentData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GovernanceAssignmentData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<GovernanceAssignmentData>(Data, options, AzureResourceManagerSecurityContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GovernanceAssignmentData IPersistableModel<GovernanceAssignmentData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<GovernanceAssignmentData>(data, options, AzureResourceManagerSecurityContext.Default);
