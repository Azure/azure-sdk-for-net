...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class SecurityConnectorApplicationResource : ArmResource
    {
        ...
        internal SecurityConnectorApplicationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _securityConnectorApplicationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", ResourceType.Namespace, Diagnostics);
            ...
            _securityConnectorApplicationsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<SecurityConnectorApplicationResource>> UpdateAsync(WaitUntil waitUntil, ApplicationData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _securityConnectorApplicationRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, ApplicationData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<ApplicationData> response = Response.FromValue(ApplicationData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
