...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class AzureDevOpsOrgData : ResourceData
    {
        ...
        internal AzureDevOpsOrgData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureDevOpsOrgProperties properties) : base(id, name, resourceType, systemData)
        {
