...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class SecurityConnectorData : ResourceData
    {
        ...
        internal SecurityConnectorData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SecurityConnectorProperties properties, IDictionary<string, string> tags, string location, string kind, string eTag) : base(id, name, resourceType, systemData)
        {
        ...
        public IList<CloudOffering> Offerings
        {
            get
            {
                if (Properties is null)
