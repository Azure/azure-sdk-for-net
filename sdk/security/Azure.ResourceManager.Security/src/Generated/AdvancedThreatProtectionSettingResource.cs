...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class AdvancedThreatProtectionSettingResource : ArmResource
    {
        ...
        internal AdvancedThreatProtectionSettingResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _advancedThreatProtectionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<AdvancedThreatProtectionSettingResource>> CreateOrUpdateAsync(WaitUntil waitUntil, AdvancedThreatProtectionSettingData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                SecurityArmOperation<AdvancedThreatProtectionSettingResource> operation = new SecurityArmOperation<AdvancedThreatProtectionSettingResource>(Response.FromValue(new AdvancedThreatProtectionSettingResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
