...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class IoTSecurityAggregatedAlertResource : ArmResource
    {
        ...
        internal IoTSecurityAggregatedAlertResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _iotSecuritySolutionsAnalyticsAggregatedAlertClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Security", ResourceType.Namespace, Diagnostics);
