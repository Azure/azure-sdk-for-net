...
namespace Azure.ResourceManager.Security
{
    ...
    public partial class SecurityAssessmentResponseData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SecurityAssessmentResponseData"/>. </summary>
        internal SecurityAssessmentResponseData()
        {
        }
        ...
        internal SecurityAssessmentResponseData(Core.ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SecurityAssessmentPropertiesResponse properties) : base(id, name, resourceType, systemData)
        {
