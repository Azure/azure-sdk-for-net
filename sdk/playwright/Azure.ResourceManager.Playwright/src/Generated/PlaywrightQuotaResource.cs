...
namespace Azure.ResourceManager.Playwright
{
    ...
    public partial class PlaywrightQuotaResource : ArmResource
    {
        ...
        internal PlaywrightQuotaResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _playwrightQuotasClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Playwright", ResourceType.Namespace, Diagnostics);
            _playwrightQuotasRestClient = new PlaywrightQuotas(_playwrightQuotasClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, playwrightQuotaApiVersion ?? "2026-08-01-preview");
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/providers/Microsoft.LoadTestService/locations/{location}/playwrightQuotas/{playwrightQuotaName}";
