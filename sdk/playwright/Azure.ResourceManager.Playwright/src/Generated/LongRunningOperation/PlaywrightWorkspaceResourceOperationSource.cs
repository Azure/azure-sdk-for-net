...
{
    /// <summary></summary>
    internal partial class PlaywrightWorkspaceResourceOperationSource : IOperationSource<PlaywrightWorkspaceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PlaywrightWorkspaceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
