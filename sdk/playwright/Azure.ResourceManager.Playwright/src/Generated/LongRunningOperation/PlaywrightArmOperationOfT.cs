...
namespace Azure.ResourceManager.Playwright
{
    internal partial class PlaywrightArmOperation<T> : ArmOperation<T>
    {
        ...
        internal PlaywrightArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
