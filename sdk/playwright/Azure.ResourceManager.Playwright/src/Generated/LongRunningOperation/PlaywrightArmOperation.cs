...
namespace Azure.ResourceManager.Playwright
{
    internal partial class PlaywrightArmOperation : ArmOperation
    {
        ...
        internal PlaywrightArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
