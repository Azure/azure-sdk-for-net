...
namespace Azure.ResourceManager.Playwright
{
    ...
    public partial class PlaywrightWorkspaceQuotaData : ResourceData
    {
        ...
        internal PlaywrightWorkspaceQuotaData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PlaywrightWorkspaceQuotaProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
