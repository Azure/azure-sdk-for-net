...
namespace Azure.ResourceManager.Playwright
{
    ...
    public partial class PlaywrightWorkspaceQuotaData : ResourceData
    {
        ...
        internal PlaywrightWorkspaceQuotaData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PlaywrightWorkspaceQuotaProperties properties) : base(id, name, resourceType, systemData)
        {
