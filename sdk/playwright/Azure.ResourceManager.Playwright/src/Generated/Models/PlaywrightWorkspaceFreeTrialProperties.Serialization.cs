...
namespace Azure.ResourceManager.Playwright.Models
{
    ...
    public partial class PlaywrightWorkspaceFreeTrialProperties : IJsonModel<PlaywrightWorkspaceFreeTrialProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<PlaywrightWorkspaceFreeTrialProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PlaywrightWorkspaceFreeTrialProperties IJsonModel<PlaywrightWorkspaceFreeTrialProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PlaywrightWorkspaceFreeTrialProperties JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PlaywrightWorkspaceFreeTrialProperties>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static PlaywrightWorkspaceFreeTrialProperties DeserializePlaywrightWorkspaceFreeTrialProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("expiryAt"u8))
                {
                    expiryOn = prop.Value.GetDateTimeOffset("O");
                    continue;
                }
                if (prop.NameEquals("allocatedValue"u8))
                {
                    allocatedValue = prop.Value.GetInt32();
                    continue;
                }
                if (prop.NameEquals("usedValue"u8))
                {
                    usedValue = prop.Value.GetSingle();
                    continue;
                }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<PlaywrightWorkspaceFreeTrialProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        PlaywrightWorkspaceFreeTrialProperties IPersistableModel<PlaywrightWorkspaceFreeTrialProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual PlaywrightWorkspaceFreeTrialProperties PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<PlaywrightWorkspaceFreeTrialProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
