...
namespace Azure.ResourceManager.Playwright
{
    ...
    public partial class PlaywrightWorkspaceQuotaResource : ArmResource
    {
        ...
        internal PlaywrightWorkspaceQuotaResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _playwrightWorkspaceQuotasRestClient = new PlaywrightWorkspaceQuotas(_playwrightWorkspaceQuotasClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, playwrightWorkspaceQuotaApiVersion ?? "2026-08-01-preview");
