...
namespace Microsoft.Azure.Management.MariaDB
{
    ...
    /// </summary>
    internal partial class ServerParametersOperations : IServiceOperations<MariaDBManagementClient>, IServerParametersOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal ServerParametersOperations(MariaDBManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<ConfigurationListResult>> BeginListUpdateConfigurationsWithHttpMessagesAsync(string resourceGroupName, string serverName, ConfigurationListResult value, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMariaDB/servers/{serverName}/updateConfigurations").ToString();
