...
namespace Microsoft.Azure.Management.MariaDB.Models
{
    ...
    public partial class ServerPropertiesForGeoRestore : ServerPropertiesForCreate
    {
        ...
        public ServerPropertiesForGeoRestore(string sourceServerId, string version = default(string), SslEnforcementEnum? sslEnforcement = default(SslEnforcementEnum?), string minimalTlsVersion = default(string), string publicNetworkAccess = default(string), StorageProfile storageProfile = default(StorageProfile))
            : base(version, sslEnforcement, minimalTlsVersion, publicNetworkAccess, storageProfile)
        {
