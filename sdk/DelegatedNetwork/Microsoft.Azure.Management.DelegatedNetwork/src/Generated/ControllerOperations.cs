...
namespace Microsoft.Azure.Management.DelegatedNetwork
{
    ...
    internal partial class ControllerOperations : IServiceOperations<DNCClient>, IControllerOperations
    {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<DelegatedController>> CreateWithHttpMessagesAsync(string resourceGroupName, string resourceName, ControllerTypeParameters controllerParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<DelegatedController> _response = await BeginCreateWithHttpMessagesAsync(resourceGroupName, resourceName, controllerParameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<DelegatedController>> PatchWithHttpMessagesAsync(string resourceGroupName, string resourceName, ControllerTypeParameters controllerParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<DelegatedController>> BeginCreateWithHttpMessagesAsync(string resourceGroupName, string resourceName, ControllerTypeParameters controllerParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
