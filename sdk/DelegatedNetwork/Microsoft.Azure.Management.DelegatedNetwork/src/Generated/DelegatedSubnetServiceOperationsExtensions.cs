...
namespace Microsoft.Azure.Management.DelegatedNetwork
{
    ...
    public static partial class DelegatedSubnetServiceOperationsExtensions
    {
            ...
            /// maximum of 63.
            /// </param>
            public static void DeleteDetails(this IDelegatedSubnetServiceOperations operations, string resourceGroupName, string resourceName)
            {
                operations.DeleteDetailsAsync(resourceGroupName, resourceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task DeleteDetailsAsync(this IDelegatedSubnetServiceOperations operations, string resourceGroupName, string resourceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.DeleteDetailsWithHttpMessagesAsync(resourceGroupName, resourceName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
            ...
            /// maximum of 63.
            /// </param>
            public static void BeginDeleteDetails(this IDelegatedSubnetServiceOperations operations, string resourceGroupName, string resourceName)
            {
                operations.BeginDeleteDetailsAsync(resourceGroupName, resourceName).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task BeginDeleteDetailsAsync(this IDelegatedSubnetServiceOperations operations, string resourceGroupName, string resourceName, CancellationToken cancellationToken = default(CancellationToken))
            {
                (await operations.BeginDeleteDetailsWithHttpMessagesAsync(resourceGroupName, resourceName, null, cancellationToken).ConfigureAwait(false)).Dispose();
            }
