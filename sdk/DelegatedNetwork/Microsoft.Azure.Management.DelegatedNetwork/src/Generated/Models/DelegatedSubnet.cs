...
namespace Microsoft.Azure.Management.DelegatedNetwork.Models
{
    ...
    public partial class DelegatedSubnet : DelegatedSubnetResource
    {
        ...
        /// 'Provisioning'</param>
        /// <param name="resourceGuid">Guid for the resource(delegatedSubnet)
        /// created</param>
        public DelegatedSubnet(string id = default(string), string name = default(string), string type = default(string), string location = default(string), string state = default(string), string resourceGuid = default(string))
        ...
        /// <summary>
        /// Gets or sets guid for the resource(delegatedSubnet) created
        /// </summary>
