...
namespace Microsoft.Azure.Management.DelegatedNetwork.Models
{
    ...
    public partial class ControllerResource : IResource
    {
        ...
        public ControllerResource(string id = default(string), string name = default(string), string type = default(string), string location = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>))
        {
            Id = id;
            Name = name;
            Type = type;
