...
namespace Microsoft.Azure.Management.DelegatedNetwork
{
    ...
    internal partial class DelegatedSubnetServiceOperations : IServiceOperations<DNCClient>, IDelegatedSubnetServiceOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<DelegatedSubnet>> GetDetailsWithHttpMessagesAsync(string resourceGroupName, string resourceName, string vnetName, string subnetName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<DelegatedSubnet>> PutDetailsWithHttpMessagesAsync(string resourceGroupName, string resourceName, string vnetName, string subnetName, DelegatedSubnetParameters delegatedSubnetParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<DelegatedSubnet> _response = await BeginPutDetailsWithHttpMessagesAsync(resourceGroupName, resourceName, vnetName, subnetName, delegatedSubnetParameters, customHeaders, cancellationToken).ConfigureAwait(false);
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<DelegatedSubnet>> PatchDetailsWithHttpMessagesAsync(string resourceGroupName, string resourceName, string vnetName, string subnetName, DelegatedSubnetParameters delegatedSubnetParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<DelegatedSubnet> _response = await BeginPatchDetailsWithHttpMessagesAsync(resourceGroupName, resourceName, vnetName, subnetName, delegatedSubnetParameters, customHeaders, cancellationToken).ConfigureAwait(false);
            return await Client.GetPutOrPatchOperationResultAsync(_response, customHeaders, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse> DeleteDetailsWithHttpMessagesAsync(string resourceGroupName, string resourceName, string vnetName, string subnetName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send request
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<DelegatedSubnetList>> ListBySubscriptionWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
            ...
            // Create Result
            var _result = new AzureOperationResponse<DelegatedSubnetList>();
            _result.Request = _httpRequest;
            _result.Response = _httpResponse;
            if (_httpResponse.Headers.Contains("x-ms-request-id"))
            {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<DelegatedSubnetList>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<DelegatedSubnetList>> ListByResourceGroupWithHttpMessagesAsync(string resourceGroupName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.ApiVersion == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.ApiVersion");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<DelegatedSubnet>> BeginPutDetailsWithHttpMessagesAsync(string resourceGroupName, string resourceName, string vnetName, string subnetName, DelegatedSubnetParameters delegatedSubnetParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<DelegatedSubnet>> BeginPatchDetailsWithHttpMessagesAsync(string resourceGroupName, string resourceName, string vnetName, string subnetName, DelegatedSubnetParameters delegatedSubnetParameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse> BeginDeleteDetailsWithHttpMessagesAsync(string resourceGroupName, string resourceName, string vnetName, string subnetName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (resourceGroupName == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "resourceGroupName");
