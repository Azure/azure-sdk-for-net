...
{
    public partial class Sample_TransitHubResource
    {
        [Test]
        ...
        public async Task Get_TransitHubGet()
        {
            ...
            // this example assumes you already have this TransitHubResource created on azure
            // for more information of creating TransitHubResource, please refer to the document of TransitHubResource
            ...
            ResourceIdentifier transitHubResourceId = TransitHubResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, communityName, transitHubName);
            TransitHubResource transitHubResource = client.GetTransitHubResource(transitHubResourceId);

            // invoke the operation
            TransitHubResource result = await transitHubResource.GetAsync();
        ...
        public async Task Delete_TransitHubDelete()
        {
            ...
            // invoke the operation
            await transitHubResource.DeleteAsync(WaitUntil.Completed);
        ...
        public async Task Update_TransitHubUpdate()
        {
            ...
            // invoke the operation
            TransitHubResourcePatch patch = new TransitHubResourcePatch
            {
                Properties = new TransitHubPatchProperties
                {
...
["key4278"] = "hjoxhwofxcshowbnafdrrzq"
            ...
            ArmOperation<TransitHubResource> lro = await transitHubResource.UpdateAsync(WaitUntil.Completed, patch);
