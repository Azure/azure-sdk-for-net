...
["sampletag"] = "samplevalue"
        ...
        public async Task HandleApprovalCreation_EnclaveConnectionHandleApprovalCreation()
        {
            ...
            // invoke the operation
            ApprovalCallbackContent content = new ApprovalCallbackContent(PostActionResourceActionType.Create, PostActionCallbackApprovalStatus.Approved)
            {
        ...
        public async Task HandleApprovalDeletion_EnclaveConnectionHandleApprovalDeletion()
        {
            ...
            // invoke the operation
            ApprovalDeletionCallbackContent content = new ApprovalDeletionCallbackContent(PostActionDeletionResourceActionType.Create);
