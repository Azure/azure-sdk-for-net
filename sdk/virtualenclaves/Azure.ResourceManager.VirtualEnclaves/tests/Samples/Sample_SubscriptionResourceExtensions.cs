...
namespace Azure.ResourceManager.VirtualEnclaves.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetDedicatedHubResources_DedicatedHubListBySubscription()
        {
            // Generated from example definition: 2026-03-01-preview/DedicatedHub_ListBySubscription.json
            // this example is just showing the usage of "DedicatedHub_ListBySubscription" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation and iterate over the result
            string communityName = "TestMyCommunity";
            await foreach (DedicatedHubResource item in subscriptionResource.GetDedicatedHubResourcesAsync(communityName))
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
