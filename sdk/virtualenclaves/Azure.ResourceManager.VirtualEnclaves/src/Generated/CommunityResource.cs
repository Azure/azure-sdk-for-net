...
namespace Azure.ResourceManager.VirtualEnclaves
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="CommunityResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetCommunityResource method.
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetCommunityResource method.
    /// </summary>
    public partial class CommunityResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="CommunityResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="CommunityResource"/> class for mocking. </summary>
        public CommunityResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CommunityResource"/> class. </summary>
        ...
        /// <summary> Gets a collection of TransitHubResources in the CommunityResource. </summary>
        /// <returns> An object representing collection of TransitHubResources and their operations over a TransitHubResource. </returns>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<TransitHubResource>> GetTransitHubResourceAsync(string transitHubName, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="transitHubName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<TransitHubResource> GetTransitHubResource(string transitHubName, CancellationToken cancellationToken = default)
        {
            return GetTransitHubResources().Get(transitHubName, cancellationToken);
        }

        /// <summary> Gets a collection of CommunityEndpointResources in the CommunityResource. </summary>
        /// <returns> An object representing collection of CommunityEndpointResources and their operations over a CommunityEndpointResource. </returns>
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<CommunityEndpointResource>> GetCommunityEndpointResourceAsync(string communityEndpointName, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="communityEndpointName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<CommunityEndpointResource> GetCommunityEndpointResource(string communityEndpointName, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CommunityResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<CommunityResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _communityResourceCommunityClientDiagnostics.CreateScope("CommunityResource.Get");
            scope.Start();
            try
        ...
        public virtual async Task<ArmOperation<CommunityResource>> UpdateAsync(WaitUntil waitUntil, CommunityResourcePatch patch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<CommunityResource> Update(WaitUntil waitUntil, CommunityResourcePatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
        ...
        public virtual async Task<Response<CheckAddressSpaceAvailabilityResponse>> CheckAddressSpaceAvailabilityAsync(CheckAddressSpaceAvailabilityContent content, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual Response<CheckAddressSpaceAvailabilityResponse> CheckAddressSpaceAvailability(CheckAddressSpaceAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
        ...
        public virtual async Task<Response<CommunityResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Response<CommunityResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));
        ...
        public virtual async Task<Response<CommunityResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tags"/> is null. </exception>
        public virtual Response<CommunityResource> SetTags(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));
        ...
        public virtual async Task<Response<CommunityResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Response<CommunityResource> RemoveTag(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
