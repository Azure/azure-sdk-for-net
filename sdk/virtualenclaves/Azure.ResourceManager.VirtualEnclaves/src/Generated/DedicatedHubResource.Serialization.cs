...
namespace Azure.ResourceManager.VirtualEnclaves
{
    ...
    public partial class DedicatedHubResource : IJsonModel<DedicatedHubResourceData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DedicatedHubResourceData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<DedicatedHubResourceData>(Data, options, AzureResourceManagerVirtualEnclavesContext.Default);

        /// <param name="data"> The binary data to be processed. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DedicatedHubResourceData IPersistableModel<DedicatedHubResourceData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<DedicatedHubResourceData>(data, options, AzureResourceManagerVirtualEnclavesContext.Default);
