...
namespace Azure.ResourceManager.VirtualEnclaves.Models
{
    ...
    public partial class SubnetConfiguration
    {
        ...
        /// <summary> Initializes a new instance of <see cref="SubnetConfiguration"/>. </summary>
        ...
        public SubnetConfiguration(string subnetName, int networkPrefixSize)
        {
        ...
        internal SubnetConfiguration(string subnetName, ResourceIdentifier subnetResourceId, int networkPrefixSize, string subnetDelegation, string addressPrefix, ResourceIdentifier networkSecurityGroupResourceId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SubnetName = subnetName;
        ...
        /// <summary> Initializes a new instance of <see cref="SubnetConfiguration"/> for deserialization. </summary>
        internal SubnetConfiguration()
        {
        }
