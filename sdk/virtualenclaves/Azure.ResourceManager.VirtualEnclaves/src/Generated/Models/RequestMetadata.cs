...
namespace Azure.ResourceManager.VirtualEnclaves.Models
{
    ...
    public partial class RequestMetadata
    {
        ...
        public RequestMetadata(string resourceAction)
        {
        ...
        internal RequestMetadata(string resourceAction, string approvalCallbackRoute, string approvalCallbackPayload, ApprovalStatus? approvalStatus, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ResourceAction = resourceAction;
