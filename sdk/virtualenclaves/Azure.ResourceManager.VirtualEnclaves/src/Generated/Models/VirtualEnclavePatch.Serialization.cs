...
namespace Azure.ResourceManager.VirtualEnclaves.Models
{
    ...
    public partial class VirtualEnclavePatch : IJsonModel<VirtualEnclavePatch>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        VirtualEnclavePatch IJsonModel<VirtualEnclavePatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual VirtualEnclavePatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<VirtualEnclavePatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static VirtualEnclavePatch DeserializeVirtualEnclavePatch(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = VirtualEnclavePatchProperties.DeserializeVirtualEnclavePatchProperties(prop.Value, options);
                    continue;
                }
