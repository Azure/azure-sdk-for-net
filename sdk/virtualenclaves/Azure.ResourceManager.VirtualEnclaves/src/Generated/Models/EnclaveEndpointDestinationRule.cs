...
namespace Azure.ResourceManager.VirtualEnclaves.Models
{
    ...
    public partial class EnclaveEndpointDestinationRule
    {
        ...
        internal EnclaveEndpointDestinationRule(IList<EnclaveEndpointProtocol> protocols, string endpointRuleName, string destination, string ports, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Protocols = protocols;
