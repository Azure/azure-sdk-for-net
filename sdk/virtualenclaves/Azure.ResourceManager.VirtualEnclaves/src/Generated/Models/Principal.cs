...
namespace Azure.ResourceManager.VirtualEnclaves.Models
{
    ...
    public partial class Principal
    {
        ...
        public Principal(string id, PrincipalType type)
        {
        ...
        internal Principal(string id, PrincipalType type, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Type = type;
        ...
        /// <summary> Initializes a new instance of <see cref="Principal"/> for deserialization. </summary>
        internal Principal()
        {
        }
