...
namespace Azure.ResourceManager.VirtualEnclaves
{
    internal partial class TransitHubGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<VirtualEnclaveTransitHubData>
    {
        ...
        public TransitHubGetBySubscriptionAsyncCollectionResultOfT(TransitHub client, Guid subscriptionId, string communityName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
