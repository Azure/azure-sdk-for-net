...
namespace Azure.ResourceManager.VirtualEnclaves
{
    internal partial class CommunityEndpointsGetByCommunityResourceAsyncCollectionResultOfT : AsyncPageable<VirtualEnclaveCommunityEndpointData>
    {
        ...
        public CommunityEndpointsGetByCommunityResourceAsyncCollectionResultOfT(CommunityEndpoints client, Guid subscriptionId, string resourceGroupName, string communityName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
