...
namespace Azure.ResourceManager.VirtualEnclaves
{
    ...
    public partial class DedicatedHubResource : ArmResource
    {
        ...
        internal DedicatedHubResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _dedicatedHubClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.VirtualEnclaves", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                VirtualEnclavesArmOperation operation = new VirtualEnclavesArmOperation(_dedicatedHubClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                {
