...
namespace Azure.ResourceManager.VirtualEnclaves
{
    internal partial class VirtualEnclavesArmOperation<T> : ArmOperation<T>
    {
        ...
        internal VirtualEnclavesArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
