...
{
    /// <summary></summary>
    internal partial class VirtualEnclaveCommunityResourceOperationSource : IOperationSource<VirtualEnclaveCommunityResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal VirtualEnclaveCommunityResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
