...
namespace Azure.ResourceManager.VirtualEnclaves
{
    internal partial class VirtualEnclavesArmOperation : ArmOperation
    {
        ...
        internal VirtualEnclavesArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
