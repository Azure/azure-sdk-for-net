...
{
    internal partial class AppLinkArmOperation<T> : ArmOperation<T>
    {
        ...
        internal AppLinkArmOperation(Response<T> response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal AppLinkArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
