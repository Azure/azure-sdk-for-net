...
{
    internal partial class AppLinkArmOperation : ArmOperation
    {
        ...
        /// <summary> Initializes a new instance of AppLinkArmOperation for mocking. </summary>
        protected AppLinkArmOperation()
        {
        }
        ...
        internal AppLinkArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal AppLinkArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
