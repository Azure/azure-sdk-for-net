...
namespace Azure.ResourceManager.AppLink
{
    ...
    public partial class AppLinkMemberData : TrackedResourceData, IJsonModel<AppLinkMemberData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AppLinkMemberData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AppLinkMemberData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AppLinkMemberData IPersistableModel<AppLinkMemberData>.Create(BinaryData data, ModelReaderWriterOptions options) => (AppLinkMemberData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<AppLinkMemberData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="appLinkMemberData"> The <see cref="AppLinkMemberData"/> to serialize into <see cref="RequestContent"/>. </param>
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="AppLinkMemberData"/> from. </param>
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<AppLinkMemberData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AppLinkMemberData IJsonModel<AppLinkMemberData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AppLinkMemberData)JsonModelCreateCore(ref reader, options);
        ...
        internal static AppLinkMemberData DeserializeAppLinkMemberData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerAppLinkContext.Default);
                    continue;
                }
