...
namespace Azure.ResourceManager.AppLink
{
    ...
    public partial class AppLinkResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AppLinkResource>> UpdateAsync(WaitUntil waitUntil, AppLinkPatch patch, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual ArmOperation<AppLinkResource> Update(WaitUntil waitUntil, AppLinkPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
