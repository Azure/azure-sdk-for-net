...
namespace Azure.ResourceManager.AppLink
{
    ...
    public partial class AppLinkData : TrackedResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="AppLinkData"/>. </summary>
        ...
        internal AppLinkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, AppLinkProperties properties, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData, tags, location)
        {
