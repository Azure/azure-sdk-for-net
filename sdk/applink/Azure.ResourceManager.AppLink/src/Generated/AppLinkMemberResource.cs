...
namespace Azure.ResourceManager.AppLink
{
    ...
    public partial class AppLinkMemberResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<AppLinkMemberResource>> UpdateAsync(WaitUntil waitUntil, AppLinkMemberData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _appLinkMembersRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, AppLinkMemberData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                AppLinkArmOperation<AppLinkMemberResource> operation = new AppLinkArmOperation<AppLinkMemberResource>(
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        public virtual ArmOperation<AppLinkMemberResource> Update(WaitUntil waitUntil, AppLinkMemberData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<AppLinkMemberResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    AppLinkMemberData patch = new AppLinkMemberData();
