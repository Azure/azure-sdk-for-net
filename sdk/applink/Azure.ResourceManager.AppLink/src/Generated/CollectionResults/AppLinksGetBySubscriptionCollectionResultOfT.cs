...
{
    internal partial class AppLinksGetBySubscriptionCollectionResultOfT : Pageable<AppLinkData>
    {
        private readonly AppLinks _client;
        private readonly Guid _subscriptionId;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of AppLinksGetBySubscriptionCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of AppLinksGetBySubscriptionCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AppLinksGetBySubscriptionCollectionResultOfT as an enumerable collection. </returns>
