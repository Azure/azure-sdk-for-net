...
{
    internal partial class AppLinksGetByResourceGroupCollectionResultOfT : Pageable<AppLinkData>
    {
        ...
        /// <summary> Initializes a new instance of AppLinksGetByResourceGroupCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of AppLinksGetByResourceGroupCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AppLinksGetByResourceGroupCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<AppLinkData>> AsPages(string continuationToken, int? pageSizeHint)
        {
