...
{
    internal partial class AppLinksGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<AppLinkData>
    {
        private readonly AppLinks _client;
        private readonly Guid _subscriptionId;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of AppLinksGetBySubscriptionAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        /// <param name="client"> The AppLinks client used to send requests. </param>
        ...
        /// <summary> Gets the pages of AppLinksGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of AppLinksGetBySubscriptionAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<AppLinkData>> AsPages(string continuationToken, int? pageSizeHint)
        {
