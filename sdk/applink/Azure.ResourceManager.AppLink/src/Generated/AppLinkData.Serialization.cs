...
namespace Azure.ResourceManager.AppLink
{
    ...
    public partial class AppLinkData : TrackedResourceData, IJsonModel<AppLinkData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<AppLinkData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<AppLinkData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        AppLinkData IPersistableModel<AppLinkData>.Create(BinaryData data, ModelReaderWriterOptions options) => (AppLinkData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<AppLinkData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="appLinkData"> The <see cref="AppLinkData"/> to serialize into <see cref="RequestContent"/>. </param>
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="AppLinkData"/> from. </param>
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        void IJsonModel<AppLinkData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        AppLinkData IJsonModel<AppLinkData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (AppLinkData)JsonModelCreateCore(ref reader, options);
        ...
        internal static AppLinkData DeserializeAppLinkData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("identity"u8))
                {
                    ...
                    identity = ModelReaderWriter.Read<ManagedServiceIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), options.Format == "W" ? ModelSerializationExtensions.WireV3Options : ModelSerializationExtensions.JsonV3Options, AzureResourceManagerAppLinkContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
