...
{
    public partial class AutoScaleConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AutoScaleConfiguration DeserializeAutoScaleConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
