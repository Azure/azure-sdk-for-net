...
{
    internal partial class ContainerRegistryProperties : IUtf8JsonSerializable, IJsonModel<ContainerRegistryProperties>, IPersistableModel<ContainerRegistryProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContainerRegistryProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContainerRegistryProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContainerRegistryProperties)} does not support '{format}' format.");
            }
