...
{
    public partial class ErrorResponseWrapper : IUtf8JsonSerializable, IJsonModel<ErrorResponseWrapper>, IPersistableModel<ErrorResponseWrapper>
    {
        ...
        void IJsonModel<ErrorResponseWrapper>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ErrorResponseWrapper)} does not support '{format}' format.");
            }
