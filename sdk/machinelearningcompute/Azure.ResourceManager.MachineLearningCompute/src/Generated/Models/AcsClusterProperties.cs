...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    public partial class AcsClusterProperties
    {
        ...
        internal AcsClusterProperties(string clusterFqdn, OrchestratorType orchestratorType, KubernetesClusterProperties orchestratorProperties, IList<SystemService> systemServices, int? masterCount, int? agentCount, AgentVmSizeType? agentVmSize, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
