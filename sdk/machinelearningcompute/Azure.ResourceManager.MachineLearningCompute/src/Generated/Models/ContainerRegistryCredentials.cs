...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    public partial class ContainerRegistryCredentials
    {
        ...
        internal ContainerRegistryCredentials(string loginServer, string password, string password2, string username, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
