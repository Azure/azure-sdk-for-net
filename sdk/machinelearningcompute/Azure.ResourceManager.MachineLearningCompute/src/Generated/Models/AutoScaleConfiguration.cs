...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    public partial class AutoScaleConfiguration
    {
        ...
        internal AutoScaleConfiguration(Status? status, int? minReplicas, int? maxReplicas, float? targetUtilization, int? refreshPeriodInSeconds, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
