...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    public partial class ResourceOperationDisplay
    {
        ...
        internal ResourceOperationDisplay(string provider, string resource, string operation, string description, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Provider = provider;
            Resource = resource;
            Operation = operation;
