...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceAuthConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceAuthConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceAuthConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceAuthConfiguration>)} interface");
            }
        ...
        string IPersistableModel<ServiceAuthConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
