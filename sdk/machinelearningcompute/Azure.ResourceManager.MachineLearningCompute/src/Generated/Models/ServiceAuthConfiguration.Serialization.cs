...
{
    public partial class ServiceAuthConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ServiceAuthConfiguration DeserializeServiceAuthConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
