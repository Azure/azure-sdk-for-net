...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    public partial class ServiceAuthConfiguration : IUtf8JsonSerializable, IModelJsonSerializable<ServiceAuthConfiguration>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ServiceAuthConfiguration>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="ServiceAuthConfiguration"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ServiceAuthConfiguration"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ServiceAuthConfiguration"/>. </summary>
