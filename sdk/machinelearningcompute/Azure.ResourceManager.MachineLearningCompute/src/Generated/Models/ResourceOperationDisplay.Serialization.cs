...
{
    public partial class ResourceOperationDisplay : IUtf8JsonSerializable, IJsonModel<ResourceOperationDisplay>, IPersistableModel<ResourceOperationDisplay>
    {
        ...
        void IJsonModel<ResourceOperationDisplay>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ResourceOperationDisplay)} does not support '{format}' format.");
            }
