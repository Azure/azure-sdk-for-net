...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SystemService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SystemService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SystemService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SystemService>)} interface");
            }
        ...
        string IPersistableModel<SystemService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
