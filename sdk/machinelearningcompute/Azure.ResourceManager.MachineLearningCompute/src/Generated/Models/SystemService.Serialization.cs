...
{
    public partial class SystemService : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SystemService DeserializeSystemService(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
