...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CheckSystemServicesUpdatesAvailableResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CheckSystemServicesUpdatesAvailableResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CheckSystemServicesUpdatesAvailableResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CheckSystemServicesUpdatesAvailableResponse>)} interface");
            }
        ...
        string IPersistableModel<CheckSystemServicesUpdatesAvailableResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
