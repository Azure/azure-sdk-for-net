...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsClusterProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsClusterProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsClusterProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsClusterProperties>)} interface");
            }
        ...
        string IPersistableModel<AcsClusterProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
