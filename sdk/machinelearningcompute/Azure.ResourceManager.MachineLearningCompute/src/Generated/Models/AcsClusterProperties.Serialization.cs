...
{
    public partial class AcsClusterProperties : IUtf8JsonSerializable, IJsonModel<AcsClusterProperties>, IPersistableModel<AcsClusterProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  orchestratorType:");
                builder.AppendLine($" '{OrchestratorType.ToString()}'");
            }

            if (Optional.IsDefined(OrchestratorProperties))
            {
                builder.Append("  orchestratorProperties:");
                AppendChildObject(builder, OrchestratorProperties, options, 2);
            }
            ...
            if (Optional.IsDefined(MasterCount))
            {
                builder.Append("  masterCount:");
                builder.AppendLine($" '{MasterCount.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(AgentVmSize))
            {
                ...
                builder.AppendLine($" '{AgentVmSize.ToString()}'");
            }
