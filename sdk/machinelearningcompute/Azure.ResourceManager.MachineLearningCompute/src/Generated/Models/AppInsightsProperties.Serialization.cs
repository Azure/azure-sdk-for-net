...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppInsightsProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppInsightsProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppInsightsProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppInsightsProperties>)} interface");
            }
        ...
        string IPersistableModel<AppInsightsProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
