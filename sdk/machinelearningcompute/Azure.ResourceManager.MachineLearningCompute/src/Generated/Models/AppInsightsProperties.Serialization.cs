...
{
    internal partial class AppInsightsProperties : IUtf8JsonSerializable, IJsonModel<AppInsightsProperties>, IPersistableModel<AppInsightsProperties>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppInsightsProperties>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<AppInsightsProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppInsightsProperties)} does not support '{format}' format.");
            }
