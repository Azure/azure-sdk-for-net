...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PaginatedOperationalizationClustersList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PaginatedOperationalizationClustersList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PaginatedOperationalizationClustersList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PaginatedOperationalizationClustersList>)} interface");
            }
        ...
        string IPersistableModel<PaginatedOperationalizationClustersList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
