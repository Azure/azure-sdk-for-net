...
{
    public partial class ContainerServiceCredentials : IUtf8JsonSerializable, IJsonModel<ContainerServiceCredentials>, IPersistableModel<ContainerServiceCredentials>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServicePrincipalConfiguration))
            {
                ...
                AppendChildObject(builder, ServicePrincipalConfiguration, options, 2);
            }
