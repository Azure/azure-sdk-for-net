...
namespace Azure.ResourceManager.MachineLearningCompute
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OperationalizationClusterData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OperationalizationClusterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OperationalizationClusterData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OperationalizationClusterData>)} interface");
            }
        ...
        string IPersistableModel<OperationalizationClusterData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
