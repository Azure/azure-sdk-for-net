...
{
    public partial class UpdateSystemServicesResponse : IUtf8JsonSerializable, IJsonModel<UpdateSystemServicesResponse>, IPersistableModel<UpdateSystemServicesResponse>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  updateStartedOn:");
                builder.AppendLine($" '{UpdateStartedOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(UpdateCompletedOn))
            {
                builder.Append("  updateCompletedOn:");
                builder.AppendLine($" '{UpdateCompletedOn.Value.ToString()}'");
            }
