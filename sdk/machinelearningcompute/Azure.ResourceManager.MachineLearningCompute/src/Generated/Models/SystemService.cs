...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    public partial class SystemService
    {
        ...
        internal SystemService(SystemServiceType systemServiceType, string publicIPAddress, string version, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SystemServiceType = systemServiceType;
