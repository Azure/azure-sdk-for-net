...
namespace Azure.ResourceManager.MachineLearningCompute
{
    ...
    public partial class OperationalizationClusterResource : ArmResource
    {
        ...
        internal OperationalizationClusterResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _operationalizationClusterClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.MachineLearningCompute", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string operationalizationClusterApiVersion);
        ...
        public virtual async Task<Response<OperationalizationClusterResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _operationalizationClusterClientDiagnostics.CreateScope("OperationalizationClusterResource.Get");
            scope.Start();
            try
            {
                var response = await _operationalizationClusterRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<OperationalizationClusterResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _operationalizationClusterClientDiagnostics.CreateScope("OperationalizationClusterResource.Get");
            scope.Start();
            try
            {
                var response = _operationalizationClusterRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new OperationalizationClusterResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, bool? deleteAll = null, CancellationToken cancellationToken = default)
        {
            using var scope = _operationalizationClusterClientDiagnostics.CreateScope("OperationalizationClusterResource.Delete");
            scope.Start();
            try
            {
        ...
        /// <param name="deleteAll"> If true, deletes all resources associated with this cluster. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation Delete(WaitUntil waitUntil, bool? deleteAll = null, CancellationToken cancellationToken = default)
        {
            using var scope = _operationalizationClusterClientDiagnostics.CreateScope("OperationalizationClusterResource.Delete");
            scope.Start();
            try
        ...
        public virtual async Task<Response<OperationalizationClusterResource>> UpdateAsync(OperationalizationClusterPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _operationalizationClusterRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new OperationalizationClusterResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual Response<OperationalizationClusterResource> Update(OperationalizationClusterPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _operationalizationClusterRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, patch, cancellationToken);
                return Response.FromValue(new OperationalizationClusterResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningCompute/operationalizationClusters/{clusterName}/listKeys</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<OperationalizationClusterCredentials>> GetKeysAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _operationalizationClusterClientDiagnostics.CreateScope("OperationalizationClusterResource.GetKeys");
            scope.Start();
            try
            {
                var response = await _operationalizationClusterRestClient.ListKeysAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<OperationalizationClusterCredentials> GetKeys(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _operationalizationClusterRestClient.ListKeys(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningCompute/operationalizationClusters/{clusterName}/checkSystemServicesUpdatesAvailable</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<CheckSystemServicesUpdatesAvailableResponse>> CheckSystemServicesUpdatesAvailableAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _operationalizationClusterClientDiagnostics.CreateScope("OperationalizationClusterResource.CheckSystemServicesUpdatesAvailable");
            scope.Start();
            try
            {
                var response = await _operationalizationClusterRestClient.CheckSystemServicesUpdatesAvailableAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<CheckSystemServicesUpdatesAvailableResponse> CheckSystemServicesUpdatesAvailable(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _operationalizationClusterRestClient.CheckSystemServicesUpdatesAvailable(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningCompute/operationalizationClusters/{clusterName}/updateSystemServices</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<ArmOperation<UpdateSystemServicesResponse>> UpdateSystemServicesAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using var scope = _operationalizationClusterClientDiagnostics.CreateScope("OperationalizationClusterResource.UpdateSystemServices");
            scope.Start();
            try
            {
        ...
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual ArmOperation<UpdateSystemServicesResponse> UpdateSystemServices(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            using var scope = _operationalizationClusterClientDiagnostics.CreateScope("OperationalizationClusterResource.UpdateSystemServices");
            scope.Start();
            try
        ...
        public virtual async Task<Response<OperationalizationClusterResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _operationalizationClusterRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                    return Response.FromValue(new OperationalizationClusterResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
                    var current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    var patch = new OperationalizationClusterPatch();
        ...
        public virtual Response<OperationalizationClusterResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _operationalizationClusterRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                    return Response.FromValue(new OperationalizationClusterResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
