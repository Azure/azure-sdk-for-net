...
namespace Azure.ResourceManager.MachineLearningCompute
{
    ...
    public partial class OperationalizationClusterResource : ArmResource
    {
        ...
        internal OperationalizationClusterResource(ArmClient client, OperationalizationClusterData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<OperationalizationClusterResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new OperationalizationClusterResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
