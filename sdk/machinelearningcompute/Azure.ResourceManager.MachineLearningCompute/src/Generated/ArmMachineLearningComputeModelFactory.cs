...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    public static partial class ArmMachineLearningComputeModelFactory
    {
        ...
        {
            return new ErrorResponseWrapper(error, new Dictionary<string, BinaryData>());
        }
        ...
        public static ErrorResponse ErrorResponse(string code = null, string message = null, IEnumerable<ErrorDetail> details = null)
        {
            ...
            return new ErrorResponse(code, message, details?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ErrorDetail(code, message, new Dictionary<string, BinaryData>());
        }
        ...
        public static AcsClusterProperties AcsClusterProperties(string clusterFqdn = null, OrchestratorType orchestratorType = default, ServicePrincipalProperties orchestratorServicePrincipal = null, IEnumerable<SystemService> systemServices = null, int? masterCount = null, int? agentCount = null, AgentVmSizeType? agentVmSize = null)
        {
            ...
            return new AcsClusterProperties(clusterFqdn, orchestratorType, orchestratorServicePrincipal != null ? new KubernetesClusterProperties(orchestratorServicePrincipal, new Dictionary<string, BinaryData>()) : null, systemServices?.ToList(), masterCount, agentCount, agentVmSize, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SystemService(systemServiceType, publicIPAddress, version, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new OperationalizationClusterCredentials(storageAccount, containerRegistry, containerService, appInsights, serviceAuthConfiguration, sslConfiguration, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StorageAccountCredentials(resourceId, primaryKey, secondaryKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerRegistryCredentials(loginServer, password, password2, username, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContainerServiceCredentials(acsKubeConfig, servicePrincipalConfiguration, imagePullSecretName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppInsightsCredentials(appId, instrumentationKey, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new CheckSystemServicesUpdatesAvailableResponse(updatesAvailable, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UpdateSystemServicesResponse(updateStatus, updateStartedOn, updateCompletedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceOperation(name, display, origin, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ResourceOperationDisplay(provider, resource, operation, description, new Dictionary<string, BinaryData>());
        }
    }
}
