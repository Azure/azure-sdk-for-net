...
namespace Azure.ResourceManager.MachineLearningCompute.Models
{
    ...
    public static partial class ArmMachineLearningComputeModelFactory
    {
        ...
        {
            return new ErrorResponseWrapper(error, default);
        }
        ...
        public static ErrorResponse ErrorResponse(string code = null, string message = null, IEnumerable<ErrorDetail> details = null)
        {
            ...
            return new ErrorResponse(code, message, details?.ToList(), default);
        }
        ...
        {
            return new ErrorDetail(code, message, default);
        }
        ...
        public static AcsClusterProperties AcsClusterProperties(string clusterFqdn = null, OrchestratorType orchestratorType = default, ServicePrincipalProperties orchestratorServicePrincipal = null, IEnumerable<SystemService> systemServices = null, int? masterCount = null, int? agentCount = null, AgentVmSizeType? agentVmSize = null)
        {
            ...
            return new AcsClusterProperties(clusterFqdn, orchestratorType, orchestratorServicePrincipal != null ? new KubernetesClusterProperties(orchestratorServicePrincipal, new Dictionary<string, BinaryData>()) : null, systemServices?.ToList(), masterCount, agentCount, agentVmSize, default);
        }
        ...
        {
            return new SystemService(systemServiceType, publicIPAddress, version, default);
        }
        ...
        {
            return new OperationalizationClusterCredentials(storageAccount, containerRegistry, containerService, appInsights, serviceAuthConfiguration, sslConfiguration, default);
        }
        ...
        {
            return new StorageAccountCredentials(resourceId, primaryKey, secondaryKey, default);
        }
        ...
        {
            return new ContainerRegistryCredentials(loginServer, password, password2, username, default);
        }
        ...
        {
            return new ContainerServiceCredentials(acsKubeConfig, servicePrincipalConfiguration, imagePullSecretName, default);
        }
        ...
        {
            return new AppInsightsCredentials(appId, instrumentationKey, default);
        }
        ...
        {
            return new CheckSystemServicesUpdatesAvailableResponse(updatesAvailable, default);
        }
        ...
        {
            return new UpdateSystemServicesResponse(updateStatus, updateStartedOn, updateCompletedOn, default);
        }
        ...
        {
            return new ResourceOperation(name, display, origin, default);
        }
        ...
        {
            return new ResourceOperationDisplay(provider, resource, operation, description, default);
        }
    }
}
