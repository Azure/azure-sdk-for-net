...
namespace Azure.ResourceManager.MachineLearningCompute.Testing
{
    ...
    public partial class MachineLearningComputeSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MachineLearningComputeSubscriptionResourceExtension"/> class for mocking. </summary>
        protected MachineLearningComputeSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MachineLearningComputeSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MachineLearningComputeSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
