...
{
    /// <summary> A class to add extension methods to OperationalizationClusterResource. </summary>
    public partial class OperationalizationClusterResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="OperationalizationClusterResourceExtension"/> class for mocking. </summary>
        protected OperationalizationClusterResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="OperationalizationClusterResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal OperationalizationClusterResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics OperationalizationClusterClientDiagnostics => _operationalizationClusterClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.MachineLearningCompute.Mock", OperationalizationClusterResource.ResourceType.Namespace, Diagnostics);
