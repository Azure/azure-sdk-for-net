...
namespace Azure.ResourceManager.MachineLearningCompute.Mock
{
    ...
    public partial class MachineLearningComputeResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MachineLearningComputeResourceGroupResourceExtension"/> class for mocking. </summary>
        protected MachineLearningComputeResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MachineLearningComputeResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MachineLearningComputeResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
