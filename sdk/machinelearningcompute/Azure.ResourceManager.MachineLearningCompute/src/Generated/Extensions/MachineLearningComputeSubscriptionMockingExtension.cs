...
namespace Azure.ResourceManager.MachineLearningCompute.Mocking
{
    ...
    internal partial class MachineLearningComputeSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MachineLearningComputeSubscriptionMockingExtension"/> class for mocking. </summary>
        protected MachineLearningComputeSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MachineLearningComputeSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MachineLearningComputeSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
