...
namespace Azure.ResourceManager.MachineLearningCompute
{
    ...
    public static partial class MachineLearningComputeExtensions
    {
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetOperationalizationClusters();
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetAvailableOperationsMachineLearningComputesAsync(cancellationToken);
        }
        ...
        {
            return GetTenantResourceExtension(tenantResource).GetAvailableOperationsMachineLearningComputes(cancellationToken);
        }
    }
}
