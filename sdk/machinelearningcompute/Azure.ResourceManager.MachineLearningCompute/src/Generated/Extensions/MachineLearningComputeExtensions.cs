...
using Azure.ResourceManager.MachineLearningCompute.Testing;
...
namespace Azure.ResourceManager.MachineLearningCompute
{
    ...
    public static partial class MachineLearningComputeExtensions
    {
        ...
        private static MachineLearningComputeSubscriptionResourceExtension GetMachineLearningComputeSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new MachineLearningComputeSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static MachineLearningComputeSubscriptionResourceExtension GetMachineLearningComputeSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new MachineLearningComputeSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetMachineLearningComputeSubscriptionResourceExtension(subscriptionResource).GetOperationalizationClustersAsync(skiptoken, cancellationToken);
        }
        ...
        {
            return GetMachineLearningComputeSubscriptionResourceExtension(subscriptionResource).GetOperationalizationClusters(skiptoken, cancellationToken);
        }
