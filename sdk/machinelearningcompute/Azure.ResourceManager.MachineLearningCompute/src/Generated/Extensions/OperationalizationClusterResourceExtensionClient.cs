...
namespace Azure.ResourceManager.MachineLearningCompute.Mock
{
    ...
    public partial class OperationalizationClusterResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="OperationalizationClusterResourceExtensionClient"/> class for mocking. </summary>
        protected OperationalizationClusterResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="OperationalizationClusterResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal OperationalizationClusterResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
