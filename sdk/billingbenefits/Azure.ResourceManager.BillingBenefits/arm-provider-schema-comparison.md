...
| --- | --- | --- |
| `/providers/microsoft.billingbenefits/reservationorderaliases/{}` | `BillingBenefitsReservationOrderAlias` | `ReservationOrderAliasResponse` |
| `/providers/microsoft.billingbenefits/savingsplanorderaliases/{}` | `BillingBenefitsSavingsPlanOrderAlias` | `SavingsPlanOrderAliasModel` |
| `/providers/microsoft.billingbenefits/savingsplanorders/{}` | `BillingBenefitsSavingsPlanOrder` | `SavingsPlanOrderModel` |
| `/providers/microsoft.billingbenefits/savingsplanorders/{}/savingsplans/{}` | `BillingBenefitsSavingsPlan` | `SavingsPlanModel` |
