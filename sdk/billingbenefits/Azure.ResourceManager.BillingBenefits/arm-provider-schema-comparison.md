# ARM provider schema comparison: Azure.ResourceManager.BillingBenefits
...
| --- | --- | --- |
| `/providers/Microsoft.BillingBenefits/reservationOrderAliases/{reservationOrderAliasName}` | `BillingBenefitsReservationOrderAlias` | `ReservationOrderAliasResponse` |
| `/providers/Microsoft.BillingBenefits/savingsPlanOrderAliases/{savingsPlanOrderAliasName}` | `BillingBenefitsSavingsPlanOrderAlias` | `SavingsPlanOrderAliasModel` |
| `/providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}` | `BillingBenefitsSavingsPlanOrder` | `SavingsPlanOrderModel` |
| `/providers/Microsoft.BillingBenefits/savingsPlanOrders/{savingsPlanOrderId}/savingsPlans/{savingsPlanId}` | `BillingBenefitsSavingsPlan` | `SavingsPlanModel` |
