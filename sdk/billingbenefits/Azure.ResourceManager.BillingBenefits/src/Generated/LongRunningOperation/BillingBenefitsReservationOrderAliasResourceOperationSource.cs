...
{
    /// <summary></summary>
    internal partial class BillingBenefitsReservationOrderAliasResourceOperationSource : IOperationSource<BillingBenefitsReservationOrderAliasResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BillingBenefitsReservationOrderAliasResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
