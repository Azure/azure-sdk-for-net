...
namespace Azure.ResourceManager.BillingBenefits
{
    ...
    public partial class CreditData : TrackedResourceData
    {
        ...
        internal CreditData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, CreditProperties properties, string managedBy, string kind, string eTag, ResourceManager.Models.ManagedServiceIdentity identity, BillingBenefitsSku sku, BillingBenefitsPlan plan) : base(id, name, resourceType, systemData, tags, location)
        {
