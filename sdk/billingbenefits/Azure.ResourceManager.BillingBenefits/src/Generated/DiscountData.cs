...
namespace Azure.ResourceManager.BillingBenefits
{
    ...
    public partial class DiscountData : TrackedResourceData
    {
        ...
        internal DiscountData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, BillingBenefitsDiscountProperties properties, string managedBy, string kind, string eTag, BillingBenefitsManagedServiceIdentity identity, BillingBenefitsSku sku, BillingBenefitsPlan plan, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData, tags, location)
        {
