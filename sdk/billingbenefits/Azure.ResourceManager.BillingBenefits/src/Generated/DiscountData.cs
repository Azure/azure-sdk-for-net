...
namespace Azure.ResourceManager.BillingBenefits
{
    ...
    public partial class DiscountData : TrackedResourceData
    {
        ...
        internal DiscountData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, DiscountProperties properties, string managedBy, string kind, string eTag, BillingBenefitsManagedServiceIdentity identity, BillingBenefitsSku sku, BillingBenefitsPlan plan) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        public DiscountProperties Properties { get; set; }
