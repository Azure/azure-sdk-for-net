...
{
    internal partial class SavingsPlanGetAllAsyncCollectionResultOfT : AsyncPageable<SavingsPlanModelData>
    {
        ...
        public SavingsPlanGetAllAsyncCollectionResultOfT(SavingsPlan client, string filter, string @orderby, string refreshSummary, float? skiptoken, string selectedState, float? take, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _filter = filter;
            _orderby = @orderby;
        ...
        public override async IAsyncEnumerable<Page<SavingsPlanModelData>> AsPages(string continuationToken, int? pageSizeHint)
        {
