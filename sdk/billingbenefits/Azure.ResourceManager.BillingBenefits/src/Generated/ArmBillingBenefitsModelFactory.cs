...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    public static partial class ArmBillingBenefitsModelFactory
    {
        ...
        {
            return new BillingBenefitsSavingsPlanOrderAliasData(id, name, resourceType, systemData, skuName != null ? new BillingBenefitsSku(skuName, new Dictionary<string, BinaryData>()) : null, kind, displayName, savingsPlanOrderId, provisioningState, billingScopeId, term, billingPlan, appliedScopeType, appliedScopeProperties, commitment, new Dictionary<string, BinaryData>());
        }
        ...
        public static BillingBenefitsSavingsPlanOrderData BillingBenefitsSavingsPlanOrderData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string skuName = null, string displayName = null, BillingBenefitsProvisioningState? provisioningState = null, ResourceIdentifier billingScopeId = null, ResourceIdentifier billingProfileId = null, string customerId = null, ResourceIdentifier billingAccountId = null, BillingBenefitsTerm? term = null, BillingBenefitsBillingPlan? billingPlan = null, DateTimeOffset? expireOn = null, DateTimeOffset? benefitStartOn = null, BillingPlanInformation planInformation = null, IEnumerable<string> savingsPlans = null, BillingBenefitsExtendedStatusInfo extendedStatusInfo = null)
        {
            ...
            return new BillingBenefitsSavingsPlanOrderData(id, name, resourceType, systemData, skuName != null ? new BillingBenefitsSku(skuName, new Dictionary<string, BinaryData>()) : null, displayName, provisioningState, billingScopeId, billingProfileId, customerId, billingAccountId, term, billingPlan, expireOn, benefitStartOn, planInformation, savingsPlans?.ToList(), extendedStatusInfo, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SavingsPlanOrderPaymentDetail(dueOn, payOn, pricingCurrencyTotal, billingCurrencyTotal, status, extendedStatusInfo, billingAccount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BillingBenefitsExtendedStatusInfo(statusCode, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BillingBenefitsRoleAssignmentEntity(id, name, principalId, roleDefinitionId, scope, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BillingBenefitsSavingsPlanData(id, name, resourceType, systemData, skuName != null ? new BillingBenefitsSku(skuName, new Dictionary<string, BinaryData>()) : null, displayName, provisioningState, displayProvisioningState, billingScopeId, billingProfileId, customerId, billingAccountId, term, billingPlan, appliedScopeType, userFriendlyAppliedScopeType, appliedScopeProperties, commitment, effectOn, expireOn, purchaseOn, benefitStartOn, extendedStatusInfo, isRenewed, utilization, renewSource, renewDestination, renewPurchaseProperties != null ? new RenewProperties(renewPurchaseProperties, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        public static BillingBenefitsSavingsPlanUtilization BillingBenefitsSavingsPlanUtilization(string trend = null, IEnumerable<BillingBenefitsSavingsPlanUtilizationAggregate> aggregates = null)
        {
            ...
            return new BillingBenefitsSavingsPlanUtilization(trend, aggregates?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BillingBenefitsSavingsPlanUtilizationAggregate(grain, grainUnit, value, valueUnit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BillingBenefitsPurchaseContent(skuName != null ? new BillingBenefitsSku(skuName, new Dictionary<string, BinaryData>()) : null, displayName, billingScopeId, term, billingPlan, appliedScopeType, commitment, effectOn, isRenewed, appliedScopeProperties, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SavingsPlanValidateResult(isValid, reasonCode, reason, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BillingBenefitsReservationOrderAliasCreateOrUpdateContent(id, name, resourceType, systemData, skuName != null ? new BillingBenefitsSku(skuName, new Dictionary<string, BinaryData>()) : null, location, displayName, billingScopeId, term, billingPlan, appliedScopeType, appliedScopeProperties, quantity, isRenewed, reservedResourceType, reviewOn, reservedResourceInstanceFlexibility != null ? new ReservationOrderAliasRequestPropertiesReservedResourceProperties(reservedResourceInstanceFlexibility, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BillingBenefitsReservationOrderAliasData(id, name, resourceType, systemData, skuName != null ? new BillingBenefitsSku(skuName, new Dictionary<string, BinaryData>()) : null, location, displayName, reservationOrderId, provisioningState, billingScopeId, term, billingPlan, appliedScopeType, appliedScopeProperties, quantity, isRenewed, reservedResourceType, reviewOn, reservedResourceInstanceFlexibility != null ? new ReservationOrderAliasResponsePropertiesReservedResourceProperties(reservedResourceInstanceFlexibility, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
    }
}
