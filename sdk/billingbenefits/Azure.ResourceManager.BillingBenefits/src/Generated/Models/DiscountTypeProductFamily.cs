...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    public partial class DiscountTypeProductFamily : DiscountTypeProperties
    {
        /// <summary> Initializes a new instance of <see cref="DiscountTypeProductFamily"/>. </summary>
        ...
        public DiscountTypeProductFamily(ApplyDiscountOn applyDiscountOn) : base(DiscountType.ProductFamily, applyDiscountOn)
        {
        }
        ...
        internal DiscountTypeProductFamily(DiscountType discountType, ApplyDiscountOn applyDiscountOn, double? discountPercentage, DiscountCombinationRule? discountCombinationRule, PriceGuaranteeProperties priceGuaranteeProperties, IList<ConditionsItem> conditions, IDictionary<string, BinaryData> additionalBinaryDataProperties, string productFamilyName) : base(discountType, applyDiscountOn, discountPercentage, discountCombinationRule, priceGuaranteeProperties, conditions, additionalBinaryDataProperties)
        {
