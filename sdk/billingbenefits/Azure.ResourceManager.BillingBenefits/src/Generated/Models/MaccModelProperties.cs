...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    internal partial class MaccModelProperties
    {
        ...
        internal MaccModelProperties(string provisioningState, MaccStatus? status, MaccEntityType entityType, string displayName, string productCode, ResourceIdentifier billingAccountResourceId, Commitment commitment, DateTimeOffset? startOn, DateTimeOffset? endOn, string systemId, EnablementMode? automaticShortfall, AutomaticShortfallSuppressReason automaticShortfallSuppressReason, Shortfall shortfall, IList<MaccMilestone> milestones, ResourceIdentifier resourceId, bool? allowContributors, ResourceIdentifier primaryResourceId, ResourceIdentifier primaryBillingAccountResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
