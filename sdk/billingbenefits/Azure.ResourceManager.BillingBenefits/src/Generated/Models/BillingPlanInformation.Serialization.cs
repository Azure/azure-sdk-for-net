        ...
        internal static BillingPlanInformation DeserializeBillingPlanInformation(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                if (prop.NameEquals("pricingCurrencyTotal"u8))
                {
                    ...
                    pricingCurrencyTotal = Price.DeserializePrice(prop.Value, options);
                    continue;
                }
            ...
            return new BillingPlanInformation(pricingCurrencyTotal, startOn, nextPaymentDueOn, transactions ?? new ChangeTrackingList<PaymentDetail>(), additionalBinaryDataProperties);
        }
    }
}
