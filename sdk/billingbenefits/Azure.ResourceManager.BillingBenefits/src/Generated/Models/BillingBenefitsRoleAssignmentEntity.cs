...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    public partial class BillingBenefitsRoleAssignmentEntity
    {
        ...
        internal BillingBenefitsRoleAssignmentEntity(ResourceIdentifier id, string name, string principalId, ResourceIdentifier roleDefinitionId, ResourceIdentifier scope, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
