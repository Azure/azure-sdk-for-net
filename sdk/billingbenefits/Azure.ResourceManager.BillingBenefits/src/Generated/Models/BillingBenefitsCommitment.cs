...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    public partial class BillingBenefitsCommitment : BillingBenefitsPrice
    {
        ...
        internal BillingBenefitsCommitment(string currencyCode, double? amount, BillingBenefitsCommitmentGrain? grain, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(currencyCode, amount, serializedAdditionalRawData)
        {
            Grain = grain;
        }
