...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    {
        internal static SavingsPlanModelListResult DeserializeSavingsPlanModelListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
