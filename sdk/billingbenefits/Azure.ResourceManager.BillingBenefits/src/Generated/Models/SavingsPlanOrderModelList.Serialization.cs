...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    {
        internal static SavingsPlanOrderModelList DeserializeSavingsPlanOrderModelList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
