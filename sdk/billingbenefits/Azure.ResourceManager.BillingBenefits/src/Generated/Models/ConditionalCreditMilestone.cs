...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    public partial class ConditionalCreditMilestone : ConditionalCreditMilestoneBase
    {
        ...
        internal ConditionalCreditMilestone(string milestoneId, string name, MilestoneStatus? status, DateTimeOffset? endsOn, BillingBenefitsPrice spendTarget, Award award, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(milestoneId, name, status, endsOn, spendTarget, award, additionalBinaryDataProperties)
        {
        }
    }
}
