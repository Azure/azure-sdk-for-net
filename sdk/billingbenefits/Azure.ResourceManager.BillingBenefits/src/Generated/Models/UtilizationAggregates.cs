...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    public partial class UtilizationAggregates
    {
        ...
        /// <summary> Initializes a new instance of <see cref="UtilizationAggregates"/>. </summary>
        ...
        internal UtilizationAggregates(float? grain, string grainUnit, float? value, string valueUnit, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Grain = grain;
            GrainUnit = grainUnit;
            Value = value;
