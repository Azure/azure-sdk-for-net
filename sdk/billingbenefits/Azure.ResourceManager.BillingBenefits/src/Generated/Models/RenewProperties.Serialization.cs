...
{
    internal partial class RenewProperties : IUtf8JsonSerializable, IJsonModel<RenewProperties>, IPersistableModel<RenewProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PurchaseProperties))
            {
                ...
                AppendChildObject(builder, PurchaseProperties, options, 2);
            }
