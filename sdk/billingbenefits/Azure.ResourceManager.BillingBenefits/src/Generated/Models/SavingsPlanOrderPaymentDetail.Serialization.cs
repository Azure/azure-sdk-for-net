...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SavingsPlanOrderPaymentDetail>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SavingsPlanOrderPaymentDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SavingsPlanOrderPaymentDetail>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SavingsPlanOrderPaymentDetail>)} interface");
            }
        ...
        string IPersistableModel<SavingsPlanOrderPaymentDetail>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
