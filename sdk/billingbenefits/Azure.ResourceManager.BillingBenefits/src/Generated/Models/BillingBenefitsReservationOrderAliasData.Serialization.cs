...
{
    public partial class BillingBenefitsReservationOrderAliasData : IUtf8JsonSerializable, IJsonModel<BillingBenefitsReservationOrderAliasData>, IPersistableModel<BillingBenefitsReservationOrderAliasData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReservationOrderId))
            {
                ...
                builder.AppendLine($" '{ReservationOrderId.ToString()}'");
            }
