...
namespace Azure.ResourceManager.BillingBenefits
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingBenefitsSavingsPlanOrderAliasData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BillingBenefitsSavingsPlanOrderAliasData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BillingBenefitsSavingsPlanOrderAliasData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BillingBenefitsSavingsPlanOrderAliasData>)} interface");
            }
        ...
        string IPersistableModel<BillingBenefitsSavingsPlanOrderAliasData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
