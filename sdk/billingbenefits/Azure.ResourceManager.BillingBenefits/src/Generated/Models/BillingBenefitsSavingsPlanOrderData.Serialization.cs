...
namespace Azure.ResourceManager.BillingBenefits
{
    public partial class BillingBenefitsSavingsPlanOrderData : IUtf8JsonSerializable, IModelJsonSerializable<BillingBenefitsSavingsPlanOrderData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<BillingBenefitsSavingsPlanOrderData>(this, options.Format);
            ...
            if (Optional.IsDefined(PlanInformation))
            {
                ...
                {
                    ((IModelJsonSerializable<BillingPlanInformation>)PlanInformation).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="BillingBenefitsSavingsPlanOrderData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="BillingBenefitsSavingsPlanOrderData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="BillingBenefitsSavingsPlanOrderData"/>. </summary>
