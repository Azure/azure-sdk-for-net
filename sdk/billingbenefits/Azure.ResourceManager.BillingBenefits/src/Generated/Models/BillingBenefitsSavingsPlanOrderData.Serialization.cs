...
namespace Azure.ResourceManager.BillingBenefits
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingBenefitsSavingsPlanOrderData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BillingBenefitsSavingsPlanOrderData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BillingBenefitsSavingsPlanOrderData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BillingBenefitsSavingsPlanOrderData>)} interface");
            }
        ...
        string IPersistableModel<BillingBenefitsSavingsPlanOrderData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
