...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    public partial class BillingBenefitsSavingsPlanUtilizationAggregate
    {
        ...
        internal BillingBenefitsSavingsPlanUtilizationAggregate(float? grain, string grainUnit, float? value, string valueUnit, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Grain = grain;
            GrainUnit = grainUnit;
            Value = value;
