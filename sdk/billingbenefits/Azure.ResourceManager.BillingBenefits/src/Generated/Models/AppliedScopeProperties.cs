...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    public partial class AppliedScopeProperties
    {
        ...
        internal AppliedScopeProperties(string tenantId, string managementGroupId, string subscriptionId, string resourceGroupId, string displayName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TenantId = tenantId;
