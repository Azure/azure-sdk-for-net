...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingBenefitsSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BillingBenefitsSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BillingBenefitsSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BillingBenefitsSku>)} interface");
            }
        ...
        string IPersistableModel<BillingBenefitsSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
