...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    /// </summary>
    public abstract partial class ConditionalCreditProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ConditionalCreditProperties"/>. </summary>
        /// <param name="entityType"> Type of conditional credit entity. </param>
        private protected ConditionalCreditProperties(ConditionalCreditEntityType entityType)
        {
