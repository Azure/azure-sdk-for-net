            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("userAssignedIdentities"u8))
                {
                    ...
                    foreach (var prop0 in prop.Value.EnumerateObject())
                    {
                        ...
                        {
                            dictionary.Add(prop0.Name, ModelReaderWriter.Read<UserAssignedIdentity>(new BinaryData(Encoding.UTF8.GetBytes(prop0.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerBillingBenefitsContext.Default));
                        }
                    }
