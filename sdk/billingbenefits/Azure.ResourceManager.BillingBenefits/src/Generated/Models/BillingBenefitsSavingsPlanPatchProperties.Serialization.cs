...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingBenefitsSavingsPlanPatchProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BillingBenefitsSavingsPlanPatchProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BillingBenefitsSavingsPlanPatchProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BillingBenefitsSavingsPlanPatchProperties>)} interface");
            }
        ...
        string IPersistableModel<BillingBenefitsSavingsPlanPatchProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
