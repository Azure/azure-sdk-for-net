...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    internal partial class SavingsPlanSummaryCount
    {
        ...
        internal SavingsPlanSummaryCount(float? succeededCount, float? failedCount, float? expiringCount, float? expiredCount, float? pendingCount, float? cancelledCount, float? processingCount, float? noBenefitCount, float? warningCount, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
