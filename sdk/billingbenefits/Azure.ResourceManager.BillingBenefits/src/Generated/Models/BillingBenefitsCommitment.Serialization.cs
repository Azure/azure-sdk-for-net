...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BillingBenefitsCommitment>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BillingBenefitsCommitment>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BillingBenefitsCommitment>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BillingBenefitsCommitment>)} interface");
            }
        ...
        string IPersistableModel<BillingBenefitsCommitment>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
