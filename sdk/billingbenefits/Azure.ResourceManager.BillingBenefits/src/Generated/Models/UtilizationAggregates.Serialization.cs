...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    {
        internal static UtilizationAggregates DeserializeUtilizationAggregates(JsonElement element)
        {
            ...
            return new UtilizationAggregates(Optional.ToNullable(grain), grainUnit.Value, Optional.ToNullable(value), valueUnit.Value);
        }
    }
}
