...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SavingsPlanValidateResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SavingsPlanValidateResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SavingsPlanValidateResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SavingsPlanValidateResponse>)} interface");
            }
        ...
        string IPersistableModel<SavingsPlanValidateResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
