...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    {
        internal static SavingsPlanValidateResult DeserializeSavingsPlanValidateResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
