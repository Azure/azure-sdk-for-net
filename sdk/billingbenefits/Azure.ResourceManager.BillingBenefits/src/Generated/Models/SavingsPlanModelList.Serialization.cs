...
namespace Azure.ResourceManager.BillingBenefits.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SavingsPlanModelList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SavingsPlanModelList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SavingsPlanModelList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SavingsPlanModelList>)} interface");
            }
        ...
        string IPersistableModel<SavingsPlanModelList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
