...
{
    internal partial class SavingsPlanModelList : IUtf8JsonSerializable, IJsonModel<SavingsPlanModelList>, IPersistableModel<SavingsPlanModelList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SavingsPlanModelList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SavingsPlanModelList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SavingsPlanModelList)} does not support '{format}' format.");
            }
