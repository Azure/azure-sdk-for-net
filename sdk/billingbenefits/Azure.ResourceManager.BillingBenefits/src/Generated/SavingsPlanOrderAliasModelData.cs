...
{
    /// <summary> A class representing the SavingsPlanOrderAliasModel data model. </summary>
    public partial class SavingsPlanOrderAliasModelData : ResourceData
    {
        /// <summary> Initializes a new instance of SavingsPlanOrderAliasModelData. </summary>
        /// <param name="sku"> Savings plan SKU. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="sku"/> is null. </exception>
        public SavingsPlanOrderAliasModelData(BillingBenefitsSku sku)
        {
