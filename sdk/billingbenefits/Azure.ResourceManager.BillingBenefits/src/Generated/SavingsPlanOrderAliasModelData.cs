...
namespace Azure.ResourceManager.BillingBenefits
{
    ...
    public partial class SavingsPlanOrderAliasModelData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SavingsPlanOrderAliasModelData"/>. </summary>
        ...
        internal SavingsPlanOrderAliasModelData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, SavingsPlanOrderAliasProperties properties, ResourceSku sku, string kind) : base(id, name, resourceType, systemData)
        {
