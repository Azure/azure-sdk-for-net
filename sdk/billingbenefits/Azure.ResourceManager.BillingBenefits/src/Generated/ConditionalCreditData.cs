...
namespace Azure.ResourceManager.BillingBenefits
{
    ...
    public partial class ConditionalCreditData : TrackedResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="ConditionalCreditData"/>. </summary>
        /// <param name="location"> The geo-location where the resource lives. </param>
        public ConditionalCreditData(AzureLocation location) : base(location)
        {
        }
        ...
        internal ConditionalCreditData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, IDictionary<string, string> tags, AzureLocation location, ConditionalCreditProperties properties, string managedBy, string kind, string eTag, ManagedServiceIdentity identity, BillingBenefitsSku sku, BillingBenefitsPlan plan) : base(id, name, resourceType, systemData, tags, location)
        {
