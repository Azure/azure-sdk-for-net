...
{
    public partial class Sample_DataBoxEdgeShareCollection
    {
        [Test]
        ...
        public async Task Get_ShareGet()
        {
            ...
            // invoke the operation
            string name = "smbshare";
            DataBoxEdgeShareResource result = await collection.GetAsync(name);
        ...
        {
            // Generated from example definition: specification/databoxedge/resource-manager/Microsoft.DataBoxEdge/stable/2022-03-01/examples/ShareGetAllInDevice.json
            ...
            await foreach (DataBoxEdgeShareResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DataBoxEdgeShareData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
        ...
        public async Task GetIfExists_ShareGet()
        {
            ...
            // invoke the operation
            string name = "smbshare";
            NullableResponse<DataBoxEdgeShareResource> response = await collection.GetIfExistsAsync(name);
            DataBoxEdgeShareResource result = response.HasValue ? response.Value : null;
