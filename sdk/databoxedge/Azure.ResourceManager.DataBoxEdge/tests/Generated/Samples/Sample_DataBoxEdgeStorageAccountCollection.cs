...
{
    public partial class Sample_DataBoxEdgeStorageAccountCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_StorageAccountPut()
        {
            // Generated from example definition: specification/databoxedge/resource-manager/Microsoft.DataBoxEdge/DataBoxEdge/stable/2023-12-01/examples/StorageAccountPut.json
        ...
        {
            // Generated from example definition: specification/databoxedge/resource-manager/Microsoft.DataBoxEdge/DataBoxEdge/stable/2023-12-01/examples/StorageAccountGet.json
            ...
            // invoke the operation
            string storageAccountName = "blobstorageaccount1";
            DataBoxEdgeStorageAccountResource result = await collection.GetAsync(storageAccountName);
        ...
        {
            // Generated from example definition: specification/databoxedge/resource-manager/Microsoft.DataBoxEdge/DataBoxEdge/stable/2023-12-01/examples/StorageAccountGetAllInDevice.json
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_StorageAccountGet()
        {
            // Generated from example definition: specification/databoxedge/resource-manager/Microsoft.DataBoxEdge/DataBoxEdge/stable/2023-12-01/examples/StorageAccountGet.json
            // this example is just showing the usage of "StorageAccounts_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_StorageAccountGet()
        {
            // Generated from example definition: specification/databoxedge/resource-manager/Microsoft.DataBoxEdge/DataBoxEdge/stable/2023-12-01/examples/StorageAccountGet.json
            // this example is just showing the usage of "StorageAccounts_Get" operation, for the dependent resources, they will have to be created separately.
