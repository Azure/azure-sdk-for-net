...
namespace Azure.ResourceManager.DataBoxEdge.Mock
{
    ...
    public partial class DataBoxEdgeDeviceResourceExtensionClient : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataBoxEdgeDeviceResourceExtensionClient"/> class for mocking. </summary>
        protected DataBoxEdgeDeviceResourceExtensionClient()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataBoxEdgeDeviceResourceExtensionClient"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataBoxEdgeDeviceResourceExtensionClient(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics DataBoxEdgeDeviceDevicesClientDiagnostics => _dataBoxEdgeDeviceDevicesClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.DataBoxEdge.Mock", DataBoxEdgeDeviceResource.ResourceType.Namespace, Diagnostics);
