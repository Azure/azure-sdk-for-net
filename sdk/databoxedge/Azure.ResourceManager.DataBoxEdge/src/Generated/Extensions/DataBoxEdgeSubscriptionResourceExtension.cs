...
namespace Azure.ResourceManager.DataBoxEdge.Testing
{
    /// <summary> A class to add extension methods to SubscriptionResource. </summary>
    public partial class DataBoxEdgeSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="DataBoxEdgeSubscriptionResourceExtension"/> class for mocking. </summary>
        protected DataBoxEdgeSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DataBoxEdgeSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DataBoxEdgeSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<AvailableDataBoxEdgeSku> GetAvailableSkusAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, AvailableDataBoxEdgeSku.DeserializeAvailableDataBoxEdgeSku, AvailableSkusClientDiagnostics, Pipeline, "DataBoxEdgeSubscriptionResourceExtension.GetAvailableSkus", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<AvailableDataBoxEdgeSku> GetAvailableSkus(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => AvailableSkusRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => AvailableSkusRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, AvailableDataBoxEdgeSku.DeserializeAvailableDataBoxEdgeSku, AvailableSkusClientDiagnostics, Pipeline, "DataBoxEdgeSubscriptionResourceExtension.GetAvailableSkus", "value", "nextLink", cancellationToken);
        }
