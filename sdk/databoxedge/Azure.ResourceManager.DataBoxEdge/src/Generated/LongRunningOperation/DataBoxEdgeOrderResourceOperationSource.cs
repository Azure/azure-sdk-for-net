...
{
    /// <summary></summary>
    internal partial class DataBoxEdgeOrderResourceOperationSource : IOperationSource<DataBoxEdgeOrderResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataBoxEdgeOrderResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
