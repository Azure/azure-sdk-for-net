...
{
    /// <summary></summary>
    internal partial class DataBoxEdgeUserResourceOperationSource : IOperationSource<DataBoxEdgeUserResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataBoxEdgeUserResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
