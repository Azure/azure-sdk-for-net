...
{
    /// <summary></summary>
    internal partial class DataBoxEdgeRoleAddonResourceOperationSource : IOperationSource<DataBoxEdgeRoleAddonResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataBoxEdgeRoleAddonResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
