...
{
    /// <summary></summary>
    internal partial class BandwidthScheduleResourceOperationSource : IOperationSource<BandwidthScheduleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal BandwidthScheduleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
