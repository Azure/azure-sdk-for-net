...
{
    /// <summary></summary>
    internal partial class DiagnosticProactiveLogCollectionSettingResourceOperationSource : IOperationSource<DiagnosticProactiveLogCollectionSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DiagnosticProactiveLogCollectionSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
