...
{
    /// <summary></summary>
    internal partial class DataBoxEdgeShareResourceOperationSource : IOperationSource<DataBoxEdgeShareResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataBoxEdgeShareResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
