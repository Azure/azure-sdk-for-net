...
{
    /// <summary></summary>
    internal partial class DataBoxEdgeTriggerResourceOperationSource : IOperationSource<DataBoxEdgeTriggerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataBoxEdgeTriggerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
