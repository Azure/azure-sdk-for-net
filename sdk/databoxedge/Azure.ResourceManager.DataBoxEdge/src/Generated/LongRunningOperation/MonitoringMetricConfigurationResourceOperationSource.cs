...
{
    /// <summary></summary>
    internal partial class MonitoringMetricConfigurationResourceOperationSource : IOperationSource<MonitoringMetricConfigurationResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MonitoringMetricConfigurationResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
