...
{
    /// <summary></summary>
    internal partial class DataBoxEdgeStorageContainerResourceOperationSource : IOperationSource<DataBoxEdgeStorageContainerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataBoxEdgeStorageContainerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
