...
{
    /// <summary></summary>
    internal partial class DataBoxEdgeRoleResourceOperationSource : IOperationSource<DataBoxEdgeRoleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataBoxEdgeRoleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
