...
{
    /// <summary></summary>
    internal partial class DataBoxEdgeStorageAccountResourceOperationSource : IOperationSource<DataBoxEdgeStorageAccountResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataBoxEdgeStorageAccountResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
