...
{
    /// <summary></summary>
    internal partial class DataBoxEdgeStorageAccountCredentialResourceOperationSource : IOperationSource<DataBoxEdgeStorageAccountCredentialResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DataBoxEdgeStorageAccountCredentialResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
