...
{
    /// <summary></summary>
    internal partial class DiagnosticRemoteSupportSettingResourceOperationSource : IOperationSource<DiagnosticRemoteSupportSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DiagnosticRemoteSupportSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        DiagnosticRemoteSupportSettingResource IOperationSource<DiagnosticRemoteSupportSettingResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            DiagnosticRemoteSupportSettingData data = DiagnosticRemoteSupportSettingData.DeserializeDiagnosticRemoteSupportSettingData(document.RootElement, ModelSerializationExtensions.WireOptions);
