...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    public partial class DataBoxEdgeStorageAccountCredentialResource : ArmResource
    {
        ...
        internal DataBoxEdgeStorageAccountCredentialResource(ArmClient client, DataBoxEdgeStorageAccountCredentialData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DataBoxEdgeStorageAccountCredentialResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DataBoxEdgeStorageAccountCredentialResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
