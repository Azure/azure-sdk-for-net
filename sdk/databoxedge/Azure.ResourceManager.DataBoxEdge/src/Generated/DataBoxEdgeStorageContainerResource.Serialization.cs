...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    {
        private static IJsonModel<DataBoxEdgeStorageContainerData> s_dataDeserializationInstance;

        private static IJsonModel<DataBoxEdgeStorageContainerData> DataDeserializationInstance => s_dataDeserializationInstance ??= new DataBoxEdgeStorageContainerData();
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DataBoxEdgeStorageContainerData IJsonModel<DataBoxEdgeStorageContainerData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => DataDeserializationInstance.Create(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<DataBoxEdgeStorageContainerData>.GetFormatFromOptions(ModelReaderWriterOptions options) => DataDeserializationInstance.GetFormatFromOptions(options);
    }
}
