...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    public partial class DiagnosticProactiveLogCollectionSettingData : ResourceData
    {
        ...
        internal DiagnosticProactiveLogCollectionSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ProactiveLogCollectionSettingsProperties properties, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(id, name, resourceType, systemData)
        {
