...
namespace Azure.ResourceManager.DataBoxEdge
{
    internal partial class BandwidthSchedulesRestOperations
    {
        ...
        internal RequestUriBuilder CreateCreateOrUpdateRequestUri(string subscriptionId, string resourceGroupName, string deviceName, string name, BandwidthScheduleData data)
        {
            var uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string deviceName, string name, BandwidthScheduleData data)
        {
            ...
            ((IJsonModel<BandwidthScheduleData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
