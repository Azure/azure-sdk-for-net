...
{
    internal partial class DeviceCapacityInfoRestOperations
    {
        ...
        /// <summary> Initializes a new instance of DeviceCapacityInfoRestOperations. </summary>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="applicationId"> The application id to use for user agent. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="pipeline"/> or <paramref name="apiVersion"/> is null. </exception>
        public DeviceCapacityInfoRestOperations(HttpPipeline pipeline, string applicationId, Uri endpoint = null, string apiVersion = default)
        {
        ...
        internal HttpMessage CreateGetDeviceCapacityInfoRequest(string subscriptionId, string resourceGroupName, string deviceName)
        {
            ...
            uri.AppendPath("/deviceCapacityInfo/default", false);
        ...
        public async Task<Response<DataBoxEdgeDeviceCapacityInfo>> GetDeviceCapacityInfoAsync(string subscriptionId, string resourceGroupName, string deviceName, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateGetDeviceCapacityInfoRequest(subscriptionId, resourceGroupName, deviceName);
