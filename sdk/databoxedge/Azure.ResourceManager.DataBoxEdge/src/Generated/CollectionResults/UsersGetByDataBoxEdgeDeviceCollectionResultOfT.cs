...
{
    internal partial class UsersGetByDataBoxEdgeDeviceCollectionResultOfT : Pageable<DataBoxEdgeUserData>
    {
        ...
        /// <returns> The pages of UsersGetByDataBoxEdgeDeviceCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<DataBoxEdgeUserData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<DataBoxEdgeUserData>.FromValues(result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
