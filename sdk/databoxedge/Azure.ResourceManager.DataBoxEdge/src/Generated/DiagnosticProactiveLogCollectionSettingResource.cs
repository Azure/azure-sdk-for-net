...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    public partial class DiagnosticProactiveLogCollectionSettingResource : ArmResource
    {
        ...
        internal DiagnosticProactiveLogCollectionSettingResource(ArmClient client, DiagnosticProactiveLogCollectionSettingData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DiagnosticProactiveLogCollectionSettingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DiagnosticProactiveLogCollectionSettingResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
