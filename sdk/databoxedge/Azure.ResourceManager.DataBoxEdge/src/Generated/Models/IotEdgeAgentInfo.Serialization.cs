...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IotEdgeAgentInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IotEdgeAgentInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IotEdgeAgentInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IotEdgeAgentInfo>)} interface");
            }
        ...
        string IPersistableModel<IotEdgeAgentInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
