...
{
    public partial class IotEdgeAgentInfo : IUtf8JsonSerializable, IJsonModel<IotEdgeAgentInfo>, IPersistableModel<IotEdgeAgentInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ImageRepository))
            {
                ...
                AppendChildObject(builder, ImageRepository, options, 2);
            }
