...
{
    public partial class HostCapacity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HostCapacity DeserializeHostCapacity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
