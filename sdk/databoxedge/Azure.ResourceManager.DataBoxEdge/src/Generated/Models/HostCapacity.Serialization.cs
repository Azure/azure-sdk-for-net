...
{
    public partial class HostCapacity : IUtf8JsonSerializable, IJsonModel<HostCapacity>, IPersistableModel<HostCapacity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AvailableGpuCount))
            {
                ...
                builder.AppendLine($" '{AvailableGpuCount.Value.ToString()}'");
            }
