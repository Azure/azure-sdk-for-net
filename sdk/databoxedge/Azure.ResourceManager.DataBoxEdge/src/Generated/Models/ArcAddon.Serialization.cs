...
{
    public partial class ArcAddon : IUtf8JsonSerializable
    {
        ...
        internal static ArcAddon DeserializeArcAddon(JsonElement element)
        {
            ...
            return new ArcAddon(id, name, type, systemData.Value, kind, subscriptionId, resourceGroupName, resourceName, resourceLocation, version.Value, Optional.ToNullable(hostPlatform), Optional.ToNullable(hostPlatformType), Optional.ToNullable(provisioningState));
        }
    }
}
