...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class ImageRepositoryCredential
    {
        ...
        internal ImageRepositoryCredential(Uri imageRepositoryUri, string userName, AsymmetricEncryptedSecret password, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ImageRepositoryUri = imageRepositoryUri;
            UserName = userName;
            Password = password;
