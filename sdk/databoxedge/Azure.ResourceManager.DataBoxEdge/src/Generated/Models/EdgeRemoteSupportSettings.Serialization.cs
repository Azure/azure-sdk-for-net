...
{
    public partial class EdgeRemoteSupportSettings : IUtf8JsonSerializable, IJsonModel<EdgeRemoteSupportSettings>, IPersistableModel<EdgeRemoteSupportSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RemoteApplicationType))
            {
                builder.Append("  remoteApplicationType:");
                builder.AppendLine($" '{RemoteApplicationType.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ExpireOn))
            {
                builder.Append("  expirationTimeStampInUTC:");
