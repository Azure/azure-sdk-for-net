...
{
    public partial class DataBoxEdgeStorageAccountCredentialData : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeStorageAccountCredentialData>, IPersistableModel<DataBoxEdgeStorageAccountCredentialData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxEdgeStorageAccountCredentialData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DataBoxEdgeStorageAccountCredentialData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataBoxEdgeStorageAccountCredentialData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AccountKey))
            {
                ...
                AppendChildObject(builder, AccountKey, options, 2);
            }
            ...
            if (Optional.IsDefined(SslStatus))
            {
                builder.Append("  sslStatus:");
                builder.AppendLine($" '{SslStatus.ToString()}'");
            }

            if (Optional.IsDefined(BlobDomainName))
            {
                builder.Append("  blobDomainName:");
                builder.AppendLine($" '{BlobDomainName}'");
            }
