...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    public partial class EdgeIotAddon : IUtf8JsonSerializable, IModelJsonSerializable<EdgeIotAddon>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<EdgeIotAddon>(this, options.Format);
        ...
        internal static EdgeIotAddon DeserializeEdgeIotAddon(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new EdgeIotAddon(id, name, type, systemData.Value, kind, iotDeviceDetails, iotEdgeDeviceDetails, version.Value, Optional.ToNullable(hostPlatform), Optional.ToNullable(hostPlatformType), Optional.ToNullable(provisioningState), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="EdgeIotAddon"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="EdgeIotAddon"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="EdgeIotAddon"/>. </summary>
