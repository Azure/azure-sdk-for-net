...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeIotAddon>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeIotAddon>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeIotAddon>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeIotAddon>)} interface");
            }
        ...
        string IPersistableModel<EdgeIotAddon>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
