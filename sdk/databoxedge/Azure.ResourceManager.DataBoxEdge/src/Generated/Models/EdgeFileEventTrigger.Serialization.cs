    ...
    public partial class EdgeFileEventTrigger : IUtf8JsonSerializable
    {
        ...
        internal static EdgeFileEventTrigger DeserializeEdgeFileEventTrigger(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    properties = FileTriggerProperties.DeserializeFileTriggerProperties(property.Value);
                    continue;
                }
            ...
            return new EdgeFileEventTrigger(id, name, type, systemData.Value, kind, properties);
        }
    }
}
