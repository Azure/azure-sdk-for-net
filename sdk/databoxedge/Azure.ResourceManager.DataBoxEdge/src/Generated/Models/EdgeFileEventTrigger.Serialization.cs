...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class EdgeFileEventTrigger : DataBoxEdgeTriggerData, IJsonModel<EdgeFileEventTrigger>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<EdgeFileEventTrigger>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EdgeFileEventTrigger>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeFileEventTrigger IPersistableModel<EdgeFileEventTrigger>.Create(BinaryData data, ModelReaderWriterOptions options) => (EdgeFileEventTrigger)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeFileEventTrigger IJsonModel<EdgeFileEventTrigger>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (EdgeFileEventTrigger)JsonModelCreateCore(ref reader, options);
