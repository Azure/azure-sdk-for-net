...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        internal static DataBoxEdgeUpdateDetails DeserializeDataBoxEdgeUpdateDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
