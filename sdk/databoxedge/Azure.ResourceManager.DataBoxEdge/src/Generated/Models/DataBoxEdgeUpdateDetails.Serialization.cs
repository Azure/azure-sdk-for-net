...
{
    public partial class DataBoxEdgeUpdateDetails : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeUpdateDetails>, IPersistableModel<DataBoxEdgeUpdateDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EstimatedInstallTimeInMins))
            {
                ...
                builder.AppendLine($" '{EstimatedInstallTimeInMins.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(InstallationImpact))
            {
                ...
                builder.AppendLine($" '{InstallationImpact.ToString()}'");
            }
