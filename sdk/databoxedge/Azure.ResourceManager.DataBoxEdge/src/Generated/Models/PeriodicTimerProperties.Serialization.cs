...
{
    public partial class PeriodicTimerProperties : IUtf8JsonSerializable
    {
        ...
        internal static PeriodicTimerProperties DeserializePeriodicTimerProperties(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    sourceInfo = PeriodicTimerSourceInfo.DeserializePeriodicTimerSourceInfo(property.Value);
                    continue;
                }
            ...
            return new PeriodicTimerProperties(sourceInfo, sinkInfo, customContextTag.Value);
        }
    }
}
