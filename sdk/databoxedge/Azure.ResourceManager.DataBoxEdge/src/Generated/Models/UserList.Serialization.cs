...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    internal partial class UserList : IJsonModel<UserList>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="UserList"/> from. </param>
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W")
            {
                ...
                foreach (DataBoxEdgeUserData item in Value)
                {
