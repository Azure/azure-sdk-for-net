...
namespace Azure.ResourceManager.DataBoxEdge
{
    public partial class DataBoxEdgeDeviceData : IUtf8JsonSerializable
    {
        ...
        internal static DataBoxEdgeDeviceData DeserializeDataBoxEdgeDeviceData(JsonElement element)
        {
            ...
            Optional<DataBoxEdgeDeviceProperties> properties = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = DataBoxEdgeDeviceProperties.DeserializeDataBoxEdgeDeviceProperties(property.Value);
                    continue;
                }
            ...
            return new DataBoxEdgeDeviceData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, sku.Value, Optional.ToNullable(etag), identity, Optional.ToNullable(kind), properties.Value);
        }
    }
}
