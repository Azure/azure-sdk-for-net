    ...
    public partial class DataBoxEdgeDeviceData : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeDeviceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DataBoxEdgeDeviceStatus))
            {
                ...
                builder.AppendLine($" '{DataBoxEdgeDeviceStatus.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ModelDescription))
            {
                ...
                if (ModelDescription.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(DeviceType))
            {
                ...
                builder.AppendLine($" '{DeviceType.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Culture))
            {
                ...
                if (Culture.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(DeviceSoftwareVersion))
            {
                ...
                if (DeviceSoftwareVersion.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(DeviceHcsVersion))
            {
                ...
                if (DeviceHcsVersion.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
