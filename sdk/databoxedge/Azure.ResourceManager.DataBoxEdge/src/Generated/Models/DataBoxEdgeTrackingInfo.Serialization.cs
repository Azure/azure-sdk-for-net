...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    public partial class DataBoxEdgeTrackingInfo : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeTrackingInfo>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxEdgeTrackingInfo>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxEdgeTrackingInfo>)} interface");
            }
