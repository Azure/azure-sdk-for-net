...
namespace Azure.ResourceManager.DataBoxEdge
{
    public partial class AlertData : IUtf8JsonSerializable
    {
        ...
        internal static AlertData DeserializeAlertData(JsonElement element)
        {
            ...
            return new AlertData(id, name, type, systemData.Value, title.Value, alertType.Value, Optional.ToNullable(appearedAtDateTime), recommendation.Value, Optional.ToNullable(severity), errorDetails.Value, Optional.ToDictionary(detailedInformation));
        }
    }
}
