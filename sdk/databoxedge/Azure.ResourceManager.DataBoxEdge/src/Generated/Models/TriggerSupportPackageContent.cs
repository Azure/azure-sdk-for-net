...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class TriggerSupportPackageContent : ResourceData
    {
        ...
        internal TriggerSupportPackageContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? minimumTimeStamp, DateTimeOffset? maximumTimeStamp, string include, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
