...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    internal partial class AlertList
    {
        ...
        internal AlertList(IEnumerable<DataBoxEdgeAlertData> value)
        {
            Value = value.ToList();
        }
        ...
        internal AlertList(IReadOnlyList<DataBoxEdgeAlertData> value, Uri nextLink, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            NextLink = nextLink;
        ...
        /// <summary> Initializes a new instance of <see cref="AlertList"/> for deserialization. </summary>
        internal AlertList()
        {
        }
