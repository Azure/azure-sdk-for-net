...
{
    public partial class EdgeKubernetesRoleStorageClassInfo : IUtf8JsonSerializable, IJsonModel<EdgeKubernetesRoleStorageClassInfo>, IPersistableModel<EdgeKubernetesRoleStorageClassInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{KubernetesRoleStorageClassInfoType}'");
            }

            if (Optional.IsDefined(PosixCompliant))
            {
                builder.Append("  posixCompliant:");
                builder.AppendLine($" '{PosixCompliant.ToString()}'");
            }
