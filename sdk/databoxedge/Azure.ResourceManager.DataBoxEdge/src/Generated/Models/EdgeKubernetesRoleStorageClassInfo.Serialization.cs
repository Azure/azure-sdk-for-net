...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeKubernetesRoleStorageClassInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeKubernetesRoleStorageClassInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeKubernetesRoleStorageClassInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeKubernetesRoleStorageClassInfo>)} interface");
            }
        ...
        string IPersistableModel<EdgeKubernetesRoleStorageClassInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
