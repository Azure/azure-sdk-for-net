...
{
    public partial class EdgeKubernetesRoleNetwork : IUtf8JsonSerializable, IJsonModel<EdgeKubernetesRoleNetwork>, IPersistableModel<EdgeKubernetesRoleNetwork>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CniConfig))
            {
                ...
                AppendChildObject(builder, CniConfig, options, 2);
            }

            if (Optional.IsDefined(LoadBalancerConfig))
            {
                builder.Append("  loadBalancerConfig:");
                AppendChildObject(builder, LoadBalancerConfig, options, 2);
            }
