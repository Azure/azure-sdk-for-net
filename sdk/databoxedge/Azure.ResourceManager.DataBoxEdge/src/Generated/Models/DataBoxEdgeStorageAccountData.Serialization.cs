...
{
    public partial class DataBoxEdgeStorageAccountData : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeStorageAccountData>, IPersistableModel<DataBoxEdgeStorageAccountData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StorageAccountStatus))
            {
                ...
                builder.AppendLine($" '{StorageAccountStatus.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ContainerCount))
            {
                ...
                builder.AppendLine($" '{ContainerCount.Value.ToString()}'");
            }
