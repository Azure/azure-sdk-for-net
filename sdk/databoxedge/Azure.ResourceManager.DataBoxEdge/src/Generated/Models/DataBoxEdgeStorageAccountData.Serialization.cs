...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxEdgeStorageAccountData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxEdgeStorageAccountData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxEdgeStorageAccountData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxEdgeStorageAccountData>)} interface");
            }
        ...
        string IPersistableModel<DataBoxEdgeStorageAccountData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
