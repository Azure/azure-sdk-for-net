...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UploadCertificateContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UploadCertificateContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UploadCertificateContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UploadCertificateContent>)} interface");
            }
        ...
        string IPersistableModel<UploadCertificateContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
