...
{
    public partial class EdgeClusterCapacityViewInfo : IUtf8JsonSerializable, IJsonModel<EdgeClusterCapacityViewInfo>, IPersistableModel<EdgeClusterCapacityViewInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(GpuCapacity))
            {
                builder.Append("  gpuCapacity:");
                AppendChildObject(builder, GpuCapacity, options, 2);
            }

            if (Optional.IsDefined(MemoryCapacity))
            {
                builder.Append("  memoryCapacity:");
                AppendChildObject(builder, MemoryCapacity, options, 2);
            }

            if (Optional.IsDefined(LastRefreshedOn))
            {
                builder.Append("  lastRefreshedTime:");
                builder.AppendLine($" '{LastRefreshedOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(TotalProvisionedNonHpnCores))
            {
                builder.Append("  totalProvisionedNonHpnCores:");
                builder.AppendLine($" '{TotalProvisionedNonHpnCores.Value.ToString()}'");
            }
