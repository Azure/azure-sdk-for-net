...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        internal static DataBoxEdgeNetworkAdapter DeserializeDataBoxEdgeNetworkAdapter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
