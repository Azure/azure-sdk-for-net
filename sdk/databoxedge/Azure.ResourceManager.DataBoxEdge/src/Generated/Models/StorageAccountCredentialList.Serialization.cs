...
{
    internal partial class StorageAccountCredentialList : IUtf8JsonSerializable, IJsonModel<StorageAccountCredentialList>, IPersistableModel<StorageAccountCredentialList>
    {
        ...
        void IJsonModel<StorageAccountCredentialList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageAccountCredentialList)} does not support '{format}' format.");
            }
