...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageAccountCredentialList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageAccountCredentialList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageAccountCredentialList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageAccountCredentialList>)} interface");
            }
        ...
        string IPersistableModel<StorageAccountCredentialList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
