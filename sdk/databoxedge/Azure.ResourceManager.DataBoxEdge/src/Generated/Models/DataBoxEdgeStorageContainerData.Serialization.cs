...
{
    public partial class DataBoxEdgeStorageContainerData : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeStorageContainerData>, IPersistableModel<DataBoxEdgeStorageContainerData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  containerStatus:");
                builder.AppendLine($" '{ContainerStatus.ToString()}'");
            }
            ...
            if (Optional.IsDefined(RefreshDetails))
            {
                ...
                AppendChildObject(builder, RefreshDetails, options, 2);
            }
