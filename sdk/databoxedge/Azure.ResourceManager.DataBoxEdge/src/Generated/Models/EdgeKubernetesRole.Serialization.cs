...
{
    public partial class EdgeKubernetesRole : IUtf8JsonSerializable, IJsonModel<EdgeKubernetesRole>, IPersistableModel<EdgeKubernetesRole>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KubernetesClusterInfo))
            {
                ...
                AppendChildObject(builder, KubernetesClusterInfo, options, 2);
            }

            if (Optional.IsDefined(KubernetesRoleResources))
            {
                builder.Append("  kubernetesRoleResources:");
                AppendChildObject(builder, KubernetesRoleResources, options, 2);
            }
