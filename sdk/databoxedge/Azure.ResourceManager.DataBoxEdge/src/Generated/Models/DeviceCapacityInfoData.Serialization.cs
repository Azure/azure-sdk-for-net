...
{
    public partial class DeviceCapacityInfoData : IUtf8JsonSerializable
    {
        ...
        internal static DeviceCapacityInfoData DeserializeDeviceCapacityInfoData(JsonElement element)
        {
            ...
            return new DeviceCapacityInfoData(id, name, type, systemData.Value, Optional.ToNullable(timeStamp), clusterStorageCapacityInfo.Value, clusterComputeCapacityInfo.Value, Optional.ToDictionary(nodeCapacityInfos));
        }
    }
}
