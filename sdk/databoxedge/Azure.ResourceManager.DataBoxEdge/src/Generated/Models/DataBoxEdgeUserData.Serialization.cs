...
{
    public partial class DataBoxEdgeUserData : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeUserData>, IPersistableModel<DataBoxEdgeUserData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EncryptedPassword))
            {
                ...
                AppendChildObject(builder, EncryptedPassword, options, 2);
            }

            if (Optional.IsCollectionDefined(ShareAccessRights))
            {
                builder.Append("  shareAccessRights:");
                builder.AppendLine(" [");
                foreach (var item in ShareAccessRights)
                {
