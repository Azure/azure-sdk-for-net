...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TriggerList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TriggerList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TriggerList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TriggerList>)} interface");
            }
        ...
        string IPersistableModel<TriggerList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
