...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeKubernetesNodeInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeKubernetesNodeInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeKubernetesNodeInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeKubernetesNodeInfo>)} interface");
            }
        ...
        string IPersistableModel<EdgeKubernetesNodeInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
