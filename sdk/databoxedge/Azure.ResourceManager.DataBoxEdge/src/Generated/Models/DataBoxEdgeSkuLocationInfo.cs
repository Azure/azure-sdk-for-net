...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class DataBoxEdgeSkuLocationInfo
    {
        ...
        internal DataBoxEdgeSkuLocationInfo(AzureLocation? location, IReadOnlyList<string> zones, IReadOnlyList<string> sites, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Zones = zones;
            Sites = sites;
