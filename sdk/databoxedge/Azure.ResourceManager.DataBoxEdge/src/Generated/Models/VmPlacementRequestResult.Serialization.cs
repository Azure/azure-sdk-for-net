...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VmPlacementRequestResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VmPlacementRequestResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VmPlacementRequestResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VmPlacementRequestResult>)} interface");
            }
        ...
        string IPersistableModel<VmPlacementRequestResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
