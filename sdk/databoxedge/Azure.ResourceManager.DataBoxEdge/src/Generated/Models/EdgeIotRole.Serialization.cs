...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    public partial class EdgeIotRole : IUtf8JsonSerializable, IModelJsonSerializable<EdgeIotRole>
    {
        ...
        internal static EdgeIotRole DeserializeEdgeIotRole(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new EdgeIotRole(id, name, type, systemData.Value, kind, Optional.ToNullable(hostPlatform), iotDeviceDetails.Value, iotEdgeDeviceDetails.Value, Optional.ToList(shareMappings), iotEdgeAgentInfo.Value, Optional.ToNullable(hostPlatformType), computeResource.Value, Optional.ToNullable(roleStatus), serializedAdditionalRawData);
        }
