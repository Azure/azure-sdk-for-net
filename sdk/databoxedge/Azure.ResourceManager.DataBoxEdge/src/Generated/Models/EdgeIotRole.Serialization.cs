...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class EdgeIotRole : DataBoxEdgeRoleData, IJsonModel<EdgeIotRole>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static EdgeIotRole DeserializeEdgeIotRole(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IoTRoleProperties properties = default;
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = IoTRoleProperties.DeserializeIoTRoleProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
