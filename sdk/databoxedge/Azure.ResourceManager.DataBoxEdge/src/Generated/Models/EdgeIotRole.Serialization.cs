...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeIotRole>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeIotRole>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeIotRole>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeIotRole>)} interface");
            }
        ...
        string IPersistableModel<EdgeIotRole>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
