...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxEdgeStorageContainerInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxEdgeStorageContainerInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxEdgeStorageContainerInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxEdgeStorageContainerInfo>)} interface");
            }
        ...
        string IPersistableModel<DataBoxEdgeStorageContainerInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
