...
{
    public partial class DataBoxEdgeContactDetails : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeContactDetails>, IPersistableModel<DataBoxEdgeContactDetails>
    {
        ...
        void IJsonModel<DataBoxEdgeContactDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataBoxEdgeContactDetails)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ContactPerson))
            {
                builder.Append("  contactPerson:");
                builder.AppendLine($" '{ContactPerson}'");
            }
