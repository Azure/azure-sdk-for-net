...
{
    internal partial class Authentication : IUtf8JsonSerializable, IJsonModel<Authentication>, IPersistableModel<Authentication>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SymmetricKey))
            {
                ...
                AppendChildObject(builder, SymmetricKey, options, 2);
            }
