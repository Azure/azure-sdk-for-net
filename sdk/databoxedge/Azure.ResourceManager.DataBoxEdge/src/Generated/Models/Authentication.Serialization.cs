...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Authentication>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Authentication>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Authentication>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<Authentication>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
