...
{
    internal partial class MonitoringMetricConfigurationList : IUtf8JsonSerializable, IJsonModel<MonitoringMetricConfigurationList>, IPersistableModel<MonitoringMetricConfigurationList>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitoringMetricConfigurationList>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MonitoringMetricConfigurationList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MonitoringMetricConfigurationList)} does not support '{format}' format.");
            }
