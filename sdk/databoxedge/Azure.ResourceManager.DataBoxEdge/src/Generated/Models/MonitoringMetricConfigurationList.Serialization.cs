...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitoringMetricConfigurationList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitoringMetricConfigurationList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitoringMetricConfigurationList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitoringMetricConfigurationList>)} interface");
            }
        ...
        string IPersistableModel<MonitoringMetricConfigurationList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
