...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class UpdateInstallProgress
    {
        ...
        internal UpdateInstallProgress(int? percentComplete, int? numberOfUpdatesToInstall, int? numberOfUpdatesInstalled, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
