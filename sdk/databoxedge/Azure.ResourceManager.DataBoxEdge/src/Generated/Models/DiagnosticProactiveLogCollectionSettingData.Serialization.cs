...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiagnosticProactiveLogCollectionSettingData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiagnosticProactiveLogCollectionSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiagnosticProactiveLogCollectionSettingData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiagnosticProactiveLogCollectionSettingData>)} interface");
            }
        ...
        string IPersistableModel<DiagnosticProactiveLogCollectionSettingData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
