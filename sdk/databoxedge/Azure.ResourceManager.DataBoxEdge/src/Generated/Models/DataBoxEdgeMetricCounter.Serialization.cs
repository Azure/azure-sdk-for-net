...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    public partial class DataBoxEdgeMetricCounter : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeMetricCounter>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxEdgeMetricCounter>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DataBoxEdgeMetricCounter>)} interface");
            }
