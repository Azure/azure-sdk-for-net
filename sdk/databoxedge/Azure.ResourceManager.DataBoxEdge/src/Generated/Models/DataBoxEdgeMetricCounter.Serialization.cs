    ...
    public partial class DataBoxEdgeMetricCounter : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeMetricCounter>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Instance))
            {
                ...
                if (Instance.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsCollectionDefined(DimensionFilter))
            {
                if (DimensionFilter.Any())
                {
                    builder.Append("  dimensionFilter:");
                    builder.AppendLine(" [");
                    foreach (var item in DimensionFilter)
                    {
            ...
            if (Optional.IsCollectionDefined(AdditionalDimensions))
            {
                if (AdditionalDimensions.Any())
                {
                    builder.Append("  additionalDimensions:");
                    builder.AppendLine(" [");
                    foreach (var item in AdditionalDimensions)
                    {
                        AppendChildObject(builder, item, options, 4, true);
