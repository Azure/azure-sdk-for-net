...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeProfileSubscription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeProfileSubscription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeProfileSubscription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeProfileSubscription>)} interface");
            }
        ...
        string IPersistableModel<EdgeProfileSubscription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
