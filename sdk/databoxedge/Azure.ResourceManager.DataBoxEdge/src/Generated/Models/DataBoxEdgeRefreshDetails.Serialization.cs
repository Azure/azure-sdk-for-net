...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxEdgeRefreshDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DataBoxEdgeRefreshDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DataBoxEdgeRefreshDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DataBoxEdgeRefreshDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
