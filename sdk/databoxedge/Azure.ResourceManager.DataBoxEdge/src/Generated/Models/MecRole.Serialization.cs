...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    public partial class MecRole : IUtf8JsonSerializable, IModelJsonSerializable<MecRole>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<MecRole>(this, options.Format);
        ...
        internal static MecRole DeserializeMecRole(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MecRole(id, name, type, systemData.Value, kind, connectionString.Value, controllerEndpoint.Value, resourceUniqueId.Value, Optional.ToNullable(roleStatus), serializedAdditionalRawData);
        }
