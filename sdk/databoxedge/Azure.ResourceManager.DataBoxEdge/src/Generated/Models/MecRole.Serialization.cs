...
{
    public partial class MecRole : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MecRole DeserializeMecRole(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
