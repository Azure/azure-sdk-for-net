...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MecRole>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MecRole>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MecRole>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MecRole>)} interface");
            }
        ...
        string IPersistableModel<MecRole>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
