...
{
    internal partial class DataResidency : IUtf8JsonSerializable, IJsonModel<DataResidency>, IPersistableModel<DataResidency>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{ResidencyType.ToString()}'");
            }
