...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DataBoxEdgeNetworkAdapterPosition>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        void IJsonModel<DataBoxEdgeNetworkAdapterPosition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            {
                if (Optional.IsDefined(NetworkGroup))
                {
        ...
        DataBoxEdgeNetworkAdapterPosition IJsonModel<DataBoxEdgeNetworkAdapterPosition>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<DataBoxEdgeNetworkAdapterPosition>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        DataBoxEdgeNetworkAdapterPosition IModel<DataBoxEdgeNetworkAdapterPosition>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<DataBoxEdgeNetworkAdapterPosition>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
