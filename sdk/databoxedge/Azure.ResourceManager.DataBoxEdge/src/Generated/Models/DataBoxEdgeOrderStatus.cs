...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class DataBoxEdgeOrderStatus
    {
        ...
        internal DataBoxEdgeOrderStatus(DataBoxEdgeOrderState status, DateTimeOffset? updateOn, string comments, DataBoxEdgeTrackingInfo trackingInformation, IReadOnlyDictionary<string, string> additionalOrderDetails, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
            UpdateOn = updateOn;
            Comments = comments;
