...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class HostCapacity
    {
        ...
        internal HostCapacity(string hostName, long? effectiveAvailableMemoryInMBOnHost, int? availableGpuCount, IDictionary<string, DataBoxEdgeVmMemory> vmUsedMemory, string gpuType, IList<NumaNodeInfo> numaNodesData, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            HostName = hostName;
