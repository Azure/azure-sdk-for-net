...
{
    public partial class MetricConfiguration : IUtf8JsonSerializable
    {
        ...
        internal static MetricConfiguration DeserializeMetricConfiguration(JsonElement element)
        {
            string resourceId = default;
            Optional<string> mdmAccount = default;
            Optional<string> metricNameSpace = default;
            IList<MetricCounterSet> counterSets = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    List<MetricCounterSet> array = new List<MetricCounterSet>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(MetricCounterSet.DeserializeMetricCounterSet(item));
                    }
                    counterSets = array;
                    continue;
                }
            }
            return new MetricConfiguration(resourceId, mdmAccount.Value, metricNameSpace.Value, counterSets);
        }
    }
}
