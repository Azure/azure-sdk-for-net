...
{
    public partial class DataBoxEdgeMetricCounterSet : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeMetricCounterSet>, IPersistableModel<DataBoxEdgeMetricCounterSet>
    {
        ...
        void IJsonModel<DataBoxEdgeMetricCounterSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DataBoxEdgeMetricCounterSet)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Counters))
            {
