...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class DataBoxEdgeAlertErrorDetails
    {
        ...
        internal DataBoxEdgeAlertErrorDetails(string errorCode, string errorMessage, int? occurrences, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ErrorCode = errorCode;
