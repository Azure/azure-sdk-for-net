...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class VmPlacementRequestResult
    {
        ...
        internal VmPlacementRequestResult(IList<string> vmSize, bool? isFeasible, string messageCode, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            VmSize = vmSize;
