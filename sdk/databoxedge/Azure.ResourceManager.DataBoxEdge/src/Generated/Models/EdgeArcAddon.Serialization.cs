...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeArcAddon>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeArcAddon>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeArcAddon>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeArcAddon>)} interface");
            }
        ...
        string IPersistableModel<EdgeArcAddon>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
