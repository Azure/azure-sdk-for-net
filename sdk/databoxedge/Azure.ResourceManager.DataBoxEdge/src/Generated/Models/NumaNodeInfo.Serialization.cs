...
{
    public partial class NumaNodeInfo : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static NumaNodeInfo DeserializeNumaNodeInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
