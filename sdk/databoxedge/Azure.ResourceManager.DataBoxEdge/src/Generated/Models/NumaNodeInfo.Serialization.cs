...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NumaNodeInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NumaNodeInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NumaNodeInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<NumaNodeInfo>)} interface");
            }
        ...
        string IPersistableModel<NumaNodeInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
