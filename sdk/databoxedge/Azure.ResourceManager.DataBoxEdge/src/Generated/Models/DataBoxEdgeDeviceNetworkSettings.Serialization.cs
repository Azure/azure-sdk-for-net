...
{
    public partial class DataBoxEdgeDeviceNetworkSettings : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeDeviceNetworkSettings>, IPersistableModel<DataBoxEdgeDeviceNetworkSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  networkAdapters:");
                builder.AppendLine(" [");
                foreach (var item in NetworkAdapters)
                {
