...
{
    public partial class DataBoxEdgeDeviceCapacityInfo : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeDeviceCapacityInfo>, IPersistableModel<DataBoxEdgeDeviceCapacityInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClusterStorageCapacityInfo))
            {
                builder.Append("  clusterStorageCapacityInfo:");
                AppendChildObject(builder, ClusterStorageCapacityInfo, options, 2);
            }

            if (Optional.IsDefined(ClusterComputeCapacityInfo))
            {
                builder.Append("  clusterComputeCapacityInfo:");
                AppendChildObject(builder, ClusterComputeCapacityInfo, options, 2);
            }

            if (Optional.IsCollectionDefined(NodeCapacityInfos))
            {
                builder.Append("  nodeCapacityInfos:");
                builder.AppendLine(" {");
                foreach (var item in NodeCapacityInfos)
                {
