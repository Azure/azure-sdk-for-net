...
{
    public partial class DataBoxEdgeAlertErrorDetails : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeAlertErrorDetails>, IPersistableModel<DataBoxEdgeAlertErrorDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Occurrences))
            {
                ...
                builder.AppendLine($" '{Occurrences.Value.ToString()}'");
            }
