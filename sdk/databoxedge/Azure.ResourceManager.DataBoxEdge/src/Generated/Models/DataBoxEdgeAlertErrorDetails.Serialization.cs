...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        internal static DataBoxEdgeAlertErrorDetails DeserializeDataBoxEdgeAlertErrorDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
