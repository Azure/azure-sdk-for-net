...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class ArcAddon : AddonData
    {
        /// <summary> Initializes a new instance of ArcAddon. </summary>
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="subscriptionId"/>, <paramref name="resourceGroupName"/>, <paramref name="resourceName"/> or <paramref name="resourceLocation"/> is null. </exception>
        ...
        internal ArcAddon(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AddonType kind, string subscriptionId, string resourceGroupName, string resourceName, string resourceLocation, string version, PlatformType? hostPlatform, HostPlatformType? hostPlatformType, AddonState? provisioningState) : base(id, name, resourceType, systemData, kind)
        {
            SubscriptionId = subscriptionId;
            ResourceGroupName = resourceGroupName;
            ResourceName = resourceName;
