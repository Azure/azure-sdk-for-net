...
{
    public partial class SkuMapping : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(CatalogPlanId))
            {
                ...
                {
                    writer.WriteNull("catalogPlanId");
                }
            }
            if (Optional.IsDefined(MarketplaceSkuId))
            {
                ...
                {
                    writer.WriteNull("marketplaceSkuId");
                }
            }
            if (Optional.IsCollectionDefined(MarketplaceSkuVersions))
            {
                ...
                {
                    writer.WriteNull("marketplaceSkuVersions");
                }
            }
            writer.WriteEndObject();
        }

        internal static SkuMapping DeserializeSkuMapping(JsonElement element)
        {
            ...
            return new SkuMapping(catalogPlanId.Value, marketplaceSkuId.Value, Optional.ToList(marketplaceSkuVersions));
        }
    }
}
