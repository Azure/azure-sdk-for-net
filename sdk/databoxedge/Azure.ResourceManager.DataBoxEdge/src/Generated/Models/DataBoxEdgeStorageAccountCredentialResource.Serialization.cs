...
namespace Azure.ResourceManager.DataBoxEdge
{
    public partial class DataBoxEdgeStorageAccountCredentialResource : IJsonModel<DataBoxEdgeStorageAccountCredentialData>
    {
        ...
        {
            return ModelReaderWriter.Read<DataBoxEdgeStorageAccountCredentialData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<DataBoxEdgeStorageAccountCredentialData>(data, options);
        }
