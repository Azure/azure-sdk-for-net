...
{
    public partial class EdgeClusterMemoryCapacity : IUtf8JsonSerializable, IJsonModel<EdgeClusterMemoryCapacity>, IPersistableModel<EdgeClusterMemoryCapacity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClusterFreeMemoryInMB))
            {
                builder.Append("  clusterFreeMemoryMb:");
                builder.AppendLine($" '{ClusterFreeMemoryInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(ClusterUsedMemoryInMB))
            {
                builder.Append("  clusterUsedMemoryMb:");
                builder.AppendLine($" '{ClusterUsedMemoryInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(ClusterFailoverMemoryInMB))
            {
                builder.Append("  clusterFailoverMemoryMb:");
                builder.AppendLine($" '{ClusterFailoverMemoryInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(ClusterFragmentationMemoryInMB))
            {
                builder.Append("  clusterFragmentationMemoryMb:");
                builder.AppendLine($" '{ClusterFragmentationMemoryInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(ClusterHyperVReserveMemoryMb))
            {
                builder.Append("  clusterHypervReserveMemoryMb:");
                builder.AppendLine($" '{ClusterHyperVReserveMemoryMb.Value.ToString()}'");
            }

            if (Optional.IsDefined(ClusterInfraVmMemoryInMB))
            {
                builder.Append("  clusterInfraVmMemoryMb:");
                builder.AppendLine($" '{ClusterInfraVmMemoryInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(ClusterTotalMemoryInMB))
            {
                builder.Append("  clusterTotalMemoryMb:");
                builder.AppendLine($" '{ClusterTotalMemoryInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(ClusterNonFailoverVmInMB))
            {
                builder.Append("  clusterNonFailoverVmMb:");
                builder.AppendLine($" '{ClusterNonFailoverVmInMB.Value.ToString()}'");
            }

            if (Optional.IsDefined(ClusterMemoryUsedByVmsInMB))
            {
                builder.Append("  clusterMemoryUsedByVmsMb:");
                builder.AppendLine($" '{ClusterMemoryUsedByVmsInMB.Value.ToString()}'");
            }
