...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeFileSourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeFileSourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeFileSourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeFileSourceInfo>)} interface");
            }
        ...
        string IPersistableModel<EdgeFileSourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
