...
{
    public partial class EdgeFileSourceInfo : IUtf8JsonSerializable, IJsonModel<EdgeFileSourceInfo>, IPersistableModel<EdgeFileSourceInfo>
    {
        ...
        void IJsonModel<EdgeFileSourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EdgeFileSourceInfo)} does not support '{format}' format.");
            }
