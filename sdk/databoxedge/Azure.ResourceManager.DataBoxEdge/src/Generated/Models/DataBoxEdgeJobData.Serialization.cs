...
{
    public partial class DataBoxEdgeJobData : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeJobData>, IPersistableModel<DataBoxEdgeJobData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DownloadProgress))
            {
                ...
                AppendChildObject(builder, DownloadProgress, options, 2);
            }

            if (Optional.IsDefined(InstallProgress))
            {
                builder.Append("  installProgress:");
                AppendChildObject(builder, InstallProgress, options, 2);
            }

            if (Optional.IsDefined(TotalRefreshErrors))
            {
                builder.Append("  totalRefreshErrors:");
                builder.AppendLine($" '{TotalRefreshErrors.Value.ToString()}'");
            }
