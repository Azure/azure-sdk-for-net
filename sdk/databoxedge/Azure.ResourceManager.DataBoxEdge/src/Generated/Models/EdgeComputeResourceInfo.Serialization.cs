...
{
    public partial class EdgeComputeResourceInfo : IUtf8JsonSerializable, IJsonModel<EdgeComputeResourceInfo>, IPersistableModel<EdgeComputeResourceInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ProcessorCount))
            {
                ...
                builder.AppendLine($" '{ProcessorCount.ToString()}'");
            }

            if (Optional.IsDefined(MemoryInGB))
            {
                builder.Append("  memoryInGB:");
                builder.AppendLine($" '{MemoryInGB.ToString()}'");
            }
