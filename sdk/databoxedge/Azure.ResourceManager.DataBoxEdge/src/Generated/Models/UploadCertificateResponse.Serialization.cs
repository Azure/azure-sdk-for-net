...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        internal static UploadCertificateResponse DeserializeUploadCertificateResponse(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
