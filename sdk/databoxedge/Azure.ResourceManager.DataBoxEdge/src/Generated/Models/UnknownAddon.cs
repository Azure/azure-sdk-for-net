...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    internal partial class UnknownAddon : DataBoxEdgeRoleAddonData
    {
        ...
        internal UnknownAddon(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AddonType kind) : base(id, name, resourceType, systemData, kind)
        {
            Kind = kind;
        }
    }
