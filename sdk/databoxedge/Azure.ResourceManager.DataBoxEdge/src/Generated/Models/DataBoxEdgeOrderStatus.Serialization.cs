...
{
    public partial class DataBoxEdgeOrderStatus : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeOrderStatus>, IPersistableModel<DataBoxEdgeOrderStatus>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UpdateOn))
            {
                ...
                builder.AppendLine($" '{UpdateOn.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(TrackingInformation))
            {
                ...
                AppendChildObject(builder, TrackingInformation, options, 2);
            }
