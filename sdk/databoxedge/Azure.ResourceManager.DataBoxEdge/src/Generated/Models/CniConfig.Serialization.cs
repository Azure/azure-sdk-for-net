...
{
    public partial class CniConfig : IUtf8JsonSerializable, IJsonModel<CniConfig>, IPersistableModel<CniConfig>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{CniConfigType}'");
            }
            ...
            {
                builder.Append("  podSubnet:");
                builder.AppendLine($" '{PodSubnet}'");
            }

            if (Optional.IsDefined(ServiceSubnet))
            {
                builder.Append("  serviceSubnet:");
                builder.AppendLine($" '{ServiceSubnet}'");
            }
