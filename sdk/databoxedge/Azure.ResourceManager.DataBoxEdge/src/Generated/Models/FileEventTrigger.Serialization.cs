...
{
    public partial class FileEventTrigger : IUtf8JsonSerializable
    {
        ...
        internal static FileEventTrigger DeserializeFileEventTrigger(JsonElement element)
        {
            ...
            FileSourceInfo sourceInfo = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            sourceInfo = FileSourceInfo.DeserializeFileSourceInfo(property0.Value);
                            continue;
                        }
            ...
            return new FileEventTrigger(id, name, type, systemData.Value, kind, sourceInfo, sinkInfo, customContextTag.Value);
        }
    }
}
