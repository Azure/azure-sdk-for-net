...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MonitoringMetricConfigurationData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MonitoringMetricConfigurationData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MonitoringMetricConfigurationData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MonitoringMetricConfigurationData>)} interface");
            }
        ...
        string IPersistableModel<MonitoringMetricConfigurationData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
