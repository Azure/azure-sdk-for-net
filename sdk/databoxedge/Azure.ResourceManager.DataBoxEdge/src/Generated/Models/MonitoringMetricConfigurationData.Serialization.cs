...
{
    public partial class MonitoringMetricConfigurationData : IUtf8JsonSerializable, IJsonModel<MonitoringMetricConfigurationData>, IPersistableModel<MonitoringMetricConfigurationData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(MetricConfigurations))
            {
                builder.Append("  metricConfigurations:");
                builder.AppendLine(" [");
                foreach (var item in MetricConfigurations)
                {
