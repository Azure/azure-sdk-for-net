...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class EdgeKubernetesNodeInfo
    {
        ...
        internal EdgeKubernetesNodeInfo(string name, EdgeKubernetesNodeType? nodeType, IReadOnlyList<EdgeKubernetesIPConfiguration> ipConfiguration, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            NodeType = nodeType;
