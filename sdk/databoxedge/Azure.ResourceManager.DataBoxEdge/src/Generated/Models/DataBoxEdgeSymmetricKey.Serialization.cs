...
{
    internal partial class DataBoxEdgeSymmetricKey : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeSymmetricKey>, IPersistableModel<DataBoxEdgeSymmetricKey>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConnectionString))
            {
                ...
                AppendChildObject(builder, ConnectionString, options, 2);
            }
