...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeviceCapacityRequestContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeviceCapacityRequestContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeviceCapacityRequestContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeviceCapacityRequestContent>)} interface");
            }
        ...
        string IPersistableModel<DeviceCapacityRequestContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
