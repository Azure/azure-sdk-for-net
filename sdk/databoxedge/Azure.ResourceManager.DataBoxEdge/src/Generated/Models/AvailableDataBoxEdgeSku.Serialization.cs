        ...
        void IJsonModel<AvailableDataBoxEdgeSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(LocationInfo))
            {
                ...
                foreach (var item in LocationInfo)
                {
                    if (item != null)
                    {
                        ((IJsonModel<DataBoxEdgeSkuLocationInfo>)item).Write(writer, options);
                    }
                    else
                    {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Costs))
            {
                ...
                foreach (var item in Costs)
                {
                    if (item != null)
                    {
                        ((IJsonModel<DataBoxEdgeSkuCost>)item).Write(writer, options);
                    }
                    else
                    {
                        writer.WriteNullValue();
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Capabilities))
            {
                ...
                foreach (var item in Capabilities)
                {
                    if (item != null)
                    {
                        ((IJsonModel<DataBoxEdgeSkuCapability>)item).Write(writer, options);
                    }
                    else
                    {
                        writer.WriteNullValue();
