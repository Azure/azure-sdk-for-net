...
{
    public partial class AvailableDataBoxEdgeSku : IUtf8JsonSerializable, IJsonModel<AvailableDataBoxEdgeSku>, IPersistableModel<AvailableDataBoxEdgeSku>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  signupOption:");
                builder.AppendLine($" '{SignupOption.ToString()}'");
            }
