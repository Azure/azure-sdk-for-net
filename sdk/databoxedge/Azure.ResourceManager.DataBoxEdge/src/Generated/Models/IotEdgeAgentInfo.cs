...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class IotEdgeAgentInfo
    {
        ...
        internal IotEdgeAgentInfo(string imageName, string tag, ImageRepositoryCredential imageRepository, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ImageName = imageName;
            Tag = tag;
