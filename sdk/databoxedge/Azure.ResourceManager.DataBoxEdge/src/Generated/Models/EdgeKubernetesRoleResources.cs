...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class EdgeKubernetesRoleResources
    {
        ...
        internal EdgeKubernetesRoleResources(EdgeKubernetesRoleStorage storage, EdgeKubernetesRoleCompute compute, EdgeKubernetesRoleNetwork network, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Storage = storage;
            Compute = compute;
            Network = network;
