...
{
    public partial class EdgeIotDeviceInfo : IUtf8JsonSerializable, IJsonModel<EdgeIotDeviceInfo>, IPersistableModel<EdgeIotDeviceInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IotHostHub))
            {
                builder.Append("  ioTHostHub:");
                builder.AppendLine($" '{IotHostHub}'");
            }

            if (Optional.IsDefined(IotHostHubId))
            {
                builder.Append("  ioTHostHubId:");
                builder.AppendLine($" '{IotHostHubId.ToString()}'");
            }

            if (Optional.IsDefined(Authentication))
            {
                builder.Append("  authentication:");
                AppendChildObject(builder, Authentication, options, 2);
            }
