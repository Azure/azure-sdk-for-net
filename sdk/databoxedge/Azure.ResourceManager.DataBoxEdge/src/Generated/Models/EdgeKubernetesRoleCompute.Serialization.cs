...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class EdgeKubernetesRoleCompute : IJsonModel<EdgeKubernetesRoleCompute>
    {
        ...
        protected virtual EdgeKubernetesRoleCompute PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EdgeKubernetesRoleCompute>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EdgeKubernetesRoleCompute>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeKubernetesRoleCompute IPersistableModel<EdgeKubernetesRoleCompute>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeKubernetesRoleCompute IJsonModel<EdgeKubernetesRoleCompute>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual EdgeKubernetesRoleCompute JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<EdgeKubernetesRoleCompute>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static EdgeKubernetesRoleCompute DeserializeEdgeKubernetesRoleCompute(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    vmProfile = prop.Value.GetString();
                    continue;
                }
            ...
            return new EdgeKubernetesRoleCompute(vmProfile, memoryInBytes, processorCount, additionalBinaryDataProperties);
        }
    }
}
