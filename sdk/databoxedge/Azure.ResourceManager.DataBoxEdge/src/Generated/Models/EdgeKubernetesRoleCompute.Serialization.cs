...
{
    public partial class EdgeKubernetesRoleCompute : IUtf8JsonSerializable, IJsonModel<EdgeKubernetesRoleCompute>, IPersistableModel<EdgeKubernetesRoleCompute>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  vmProfile:");
                builder.AppendLine($" '{VmProfile}'");
            }

            if (Optional.IsDefined(MemoryInBytes))
            {
                builder.Append("  memoryInBytes:");
                builder.AppendLine($" '{MemoryInBytes.Value.ToString()}'");
            }

            if (Optional.IsDefined(ProcessorCount))
            {
                builder.Append("  processorCount:");
                builder.AppendLine($" '{ProcessorCount.Value.ToString()}'");
            }
