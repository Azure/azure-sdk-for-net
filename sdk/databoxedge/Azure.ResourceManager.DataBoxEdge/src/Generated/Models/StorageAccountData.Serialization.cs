...
namespace Azure.ResourceManager.DataBoxEdge
{
    public partial class StorageAccountData : IUtf8JsonSerializable
    {
        ...
        internal static StorageAccountData DeserializeStorageAccountData(JsonElement element)
        {
            ...
            Optional<string> storageAccountCredentialId = default;
            ...
            return new StorageAccountData(id, name, type, systemData.Value, description.Value, Optional.ToNullable(storageAccountStatus), dataPolicy, storageAccountCredentialId.Value, blobEndpoint.Value, Optional.ToNullable(containerCount));
        }
    }
}
