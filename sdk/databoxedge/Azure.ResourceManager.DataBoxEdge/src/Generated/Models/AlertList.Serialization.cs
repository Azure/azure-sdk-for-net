...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlertList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AlertList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AlertList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AlertList>)} interface");
            }
        ...
        string IPersistableModel<AlertList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
