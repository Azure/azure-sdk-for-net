...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class DataBoxEdgeMetricConfiguration
    {
        ...
        internal DataBoxEdgeMetricConfiguration(ResourceIdentifier resourceId, string mdmAccount, string metricNameSpace, IList<DataBoxEdgeMetricCounterSet> counterSets, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ResourceId = resourceId;
