...
{
    internal partial class EdgeProfile : IUtf8JsonSerializable, IJsonModel<EdgeProfile>, IPersistableModel<EdgeProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Subscription))
            {
                ...
                AppendChildObject(builder, Subscription, options, 2);
            }
