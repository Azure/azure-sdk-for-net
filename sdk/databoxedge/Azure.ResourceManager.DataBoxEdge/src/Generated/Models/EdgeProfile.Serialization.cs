...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeProfile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeProfile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeProfile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeProfile>)} interface");
            }
        ...
        string IPersistableModel<EdgeProfile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
