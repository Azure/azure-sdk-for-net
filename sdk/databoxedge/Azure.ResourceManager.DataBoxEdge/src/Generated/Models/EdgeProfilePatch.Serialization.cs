...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeProfilePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeProfilePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeProfilePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeProfilePatch>)} interface");
            }
        ...
        string IPersistableModel<EdgeProfilePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
