...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class EdgeClusterGpuCapacity
    {
        ...
        internal EdgeClusterGpuCapacity(string gpuType, int? gpuUsedUnitsCount, int? gpuFreeUnitsCount, int? gpuReservedForFailoverUnitsCount, int? gpuTotalUnitsCount, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            GpuType = gpuType;
