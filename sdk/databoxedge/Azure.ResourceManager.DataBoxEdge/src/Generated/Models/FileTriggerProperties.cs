...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        /// <summary> Initializes a new instance of FileTriggerProperties. </summary>
        /// <param name="sourceInfo"> File source details. </param>
        ...
        public FileTriggerProperties(EdgeFileSourceInfo sourceInfo, DataBoxEdgeRoleSinkInfo sinkInfo)
        {
        ...
        internal FileTriggerProperties(EdgeFileSourceInfo sourceInfo, DataBoxEdgeRoleSinkInfo sinkInfo, string customContextTag)
        {
            SourceInfo = sourceInfo;
            SinkInfo = sinkInfo;
