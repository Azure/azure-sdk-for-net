    ...
    public partial class PeriodicTimerEventTrigger : IUtf8JsonSerializable
    {
        ...
        internal static PeriodicTimerEventTrigger DeserializePeriodicTimerEventTrigger(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    properties = PeriodicTimerProperties.DeserializePeriodicTimerProperties(property.Value);
                    continue;
                }
            ...
            return new PeriodicTimerEventTrigger(id, name, type, systemData.Value, kind, properties);
        }
    }
}
