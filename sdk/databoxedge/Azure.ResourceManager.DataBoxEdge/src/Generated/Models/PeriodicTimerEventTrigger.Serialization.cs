    ...
    public partial class PeriodicTimerEventTrigger : IUtf8JsonSerializable, IJsonModel<PeriodicTimerEventTrigger>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceInfo))
            {
                ...
                AppendChildObject(builder, SourceInfo, options, 4, false);
            }

            if (Optional.IsDefined(SinkInfo))
            {
                builder.Append("    sinkInfo:");
                AppendChildObject(builder, SinkInfo, options, 4, false);
            }

            if (Optional.IsDefined(CustomContextTag))
            {
                builder.Append("    customContextTag:");
                if (CustomContextTag.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
