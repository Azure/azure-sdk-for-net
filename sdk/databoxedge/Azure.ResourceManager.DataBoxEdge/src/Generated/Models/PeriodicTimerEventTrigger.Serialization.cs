...
{
    public partial class PeriodicTimerEventTrigger : IUtf8JsonSerializable, IJsonModel<PeriodicTimerEventTrigger>, IPersistableModel<PeriodicTimerEventTrigger>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceInfo))
            {
                ...
                AppendChildObject(builder, SourceInfo, options, 2);
            }

            if (Optional.IsDefined(SinkInfo))
            {
                builder.Append("  sinkInfo:");
                AppendChildObject(builder, SinkInfo, options, 2);
            }

            if (Optional.IsDefined(CustomContextTag))
            {
                builder.Append("  customContextTag:");
                builder.AppendLine($" '{CustomContextTag}'");
            }
