...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageRepositoryCredential>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ImageRepositoryCredential>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ImageRepositoryCredential>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ImageRepositoryCredential>)} interface");
            }
        ...
        string IPersistableModel<ImageRepositoryCredential>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
