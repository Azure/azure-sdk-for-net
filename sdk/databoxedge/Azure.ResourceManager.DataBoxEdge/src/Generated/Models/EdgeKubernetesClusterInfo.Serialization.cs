...
{
    public partial class EdgeKubernetesClusterInfo : IUtf8JsonSerializable, IJsonModel<EdgeKubernetesClusterInfo>, IPersistableModel<EdgeKubernetesClusterInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EtcdInfo))
            {
                ...
                AppendChildObject(builder, EtcdInfo, options, 2);
            }
