...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiagnosticRemoteSupportSettingData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DiagnosticRemoteSupportSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DiagnosticRemoteSupportSettingData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DiagnosticRemoteSupportSettingData>)} interface");
            }
        ...
        string IPersistableModel<DiagnosticRemoteSupportSettingData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
