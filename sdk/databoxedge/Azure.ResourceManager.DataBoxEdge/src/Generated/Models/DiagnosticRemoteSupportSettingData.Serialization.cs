...
{
    public partial class DiagnosticRemoteSupportSettingData : IUtf8JsonSerializable, IJsonModel<DiagnosticRemoteSupportSettingData>, IPersistableModel<DiagnosticRemoteSupportSettingData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(RemoteSupportSettingsList))
            {
                builder.Append("  remoteSupportSettingsList:");
                builder.AppendLine(" [");
                foreach (var item in RemoteSupportSettingsList)
                {
