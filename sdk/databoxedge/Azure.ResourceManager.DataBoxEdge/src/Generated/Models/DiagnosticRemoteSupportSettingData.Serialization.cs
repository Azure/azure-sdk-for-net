...
namespace Azure.ResourceManager.DataBoxEdge
{
    public partial class DiagnosticRemoteSupportSettingData : IUtf8JsonSerializable, IJsonModel<DiagnosticRemoteSupportSettingData>
    {
        ...
        void IJsonModel<DiagnosticRemoteSupportSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DiagnosticRemoteSupportSettingData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DiagnosticRemoteSupportSettingData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DiagnosticRemoteSupportSettingData)} does not support '{options.Format}' format.");
            }
        }
