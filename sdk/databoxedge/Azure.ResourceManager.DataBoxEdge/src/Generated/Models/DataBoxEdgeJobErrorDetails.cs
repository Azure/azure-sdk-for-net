...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class DataBoxEdgeJobErrorDetails
    {
        ...
        internal DataBoxEdgeJobErrorDetails(IReadOnlyList<DataBoxEdgeJobErrorItem> errorDetails, string code, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
