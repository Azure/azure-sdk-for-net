...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class DataBoxEdgeContactDetails
    {
        ...
        internal DataBoxEdgeContactDetails(string contactPerson, string companyName, string phone, IList<string> emailList, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ContactPerson = contactPerson;
            CompanyName = companyName;
            Phone = phone;
