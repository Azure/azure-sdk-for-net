...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class DataBoxEdgeContactDetails
    {
        ...
        internal DataBoxEdgeContactDetails(string contactPerson, string companyName, string phone, IList<string> emailList, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            ContactPerson = contactPerson;
            CompanyName = companyName;
            Phone = phone;
