...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OrderList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OrderList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OrderList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OrderList>)} interface");
            }
        ...
        string IPersistableModel<OrderList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
