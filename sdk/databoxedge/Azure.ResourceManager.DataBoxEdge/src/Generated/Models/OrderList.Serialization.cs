...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    internal partial class OrderList : IUtf8JsonSerializable, IJsonModel<OrderList>
    {
        ...
        void IJsonModel<OrderList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OrderList)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (options.Format != "W" && !(Value is ChangeTrackingList<DataBoxEdgeOrderData> collection && collection.IsUndefined))
            {
        ...
        internal static OrderList DeserializeOrderList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new OrderList(value ?? new ChangeTrackingList<DataBoxEdgeOrderData>(), nextLink.Value, serializedAdditionalRawData);
        }
