...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BandwidthScheduleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BandwidthScheduleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BandwidthScheduleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BandwidthScheduleData>)} interface");
            }
        ...
        string IPersistableModel<BandwidthScheduleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
