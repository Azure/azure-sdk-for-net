...
{
    public partial class BandwidthScheduleData : IUtf8JsonSerializable, IJsonModel<BandwidthScheduleData>, IPersistableModel<BandwidthScheduleData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BandwidthScheduleData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BandwidthScheduleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BandwidthScheduleData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StartOn))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(StartOn);
            ...
            {
                builder.Append("  stop:");
                var formattedTimeSpan = XmlConvert.ToString(StopOn);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }

            if (Optional.IsDefined(RateInMbps))
            {
                builder.Append("  rateInMbps:");
                builder.AppendLine($" '{RateInMbps.ToString()}'");
            }
