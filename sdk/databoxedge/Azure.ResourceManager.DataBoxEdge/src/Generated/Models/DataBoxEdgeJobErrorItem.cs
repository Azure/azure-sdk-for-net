...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class DataBoxEdgeJobErrorItem
    {
        ...
        internal DataBoxEdgeJobErrorItem(IReadOnlyList<string> recommendations, string code, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
