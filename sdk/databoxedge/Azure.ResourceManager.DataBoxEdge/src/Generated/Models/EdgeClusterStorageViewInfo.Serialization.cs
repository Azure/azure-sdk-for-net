...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdgeClusterStorageViewInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdgeClusterStorageViewInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdgeClusterStorageViewInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdgeClusterStorageViewInfo>)} interface");
            }
        ...
        string IPersistableModel<EdgeClusterStorageViewInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
