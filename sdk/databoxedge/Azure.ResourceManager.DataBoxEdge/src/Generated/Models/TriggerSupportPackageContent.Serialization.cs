...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TriggerSupportPackageContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TriggerSupportPackageContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TriggerSupportPackageContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TriggerSupportPackageContent>)} interface");
            }
        ...
        string IPersistableModel<TriggerSupportPackageContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
