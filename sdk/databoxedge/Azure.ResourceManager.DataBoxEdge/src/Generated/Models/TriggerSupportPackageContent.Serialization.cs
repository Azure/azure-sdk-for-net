...
{
    public partial class TriggerSupportPackageContent : IUtf8JsonSerializable, IJsonModel<TriggerSupportPackageContent>, IPersistableModel<TriggerSupportPackageContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MinimumTimeStamp))
            {
                builder.Append("  minimumTimeStamp:");
                builder.AppendLine($" '{MinimumTimeStamp.Value.ToString()}'");
            }

            if (Optional.IsDefined(MaximumTimeStamp))
            {
                builder.Append("  maximumTimeStamp:");
                builder.AppendLine($" '{MaximumTimeStamp.Value.ToString()}'");
            }
