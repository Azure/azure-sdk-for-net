...
namespace Azure.ResourceManager.DataBoxEdge
{
    public partial class StorageAccountCredentialData : IUtf8JsonSerializable
    {
        ...
        internal static StorageAccountCredentialData DeserializeStorageAccountCredentialData(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            sslStatus = new SSLStatus(property0.Value.GetString());
                            continue;
                        }
            ...
            return new StorageAccountCredentialData(id, name, type, systemData.Value, @alias, userName.Value, accountKey.Value, connectionString.Value, sslStatus, blobDomainName.Value, accountType, storageAccountId.Value);
        }
    }
}
