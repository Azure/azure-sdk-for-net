...
{
    public partial class DataBoxEdgeNode : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DataBoxEdgeNode DeserializeDataBoxEdgeNode(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
