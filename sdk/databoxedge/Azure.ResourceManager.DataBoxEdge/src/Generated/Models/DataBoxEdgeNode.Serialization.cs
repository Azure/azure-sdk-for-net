...
{
    public partial class DataBoxEdgeNode : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeNode>, IPersistableModel<DataBoxEdgeNode>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NodeStatus))
            {
                ...
                builder.AppendLine($" '{NodeStatus.ToString()}'");
            }
