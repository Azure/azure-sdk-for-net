...
{
    public partial class DataBoxEdgeMetricConfiguration : IUtf8JsonSerializable, IJsonModel<DataBoxEdgeMetricConfiguration>, IPersistableModel<DataBoxEdgeMetricConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MdmAccount))
            {
                builder.Append("  mdmAccount:");
                builder.AppendLine($" '{MdmAccount}'");
            }
            ...
            if (Optional.IsCollectionDefined(CounterSets))
            {
                builder.Append("  counterSets:");
                builder.AppendLine(" [");
                foreach (var item in CounterSets)
                {
