...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class ContactDetails
    {
        ...
        public ContactDetails(string contactPerson, string companyName, string phone, IEnumerable<string> emailList)
        {
        ...
        /// <param name="phone"> The phone number. </param>
        /// <param name="emailList"> The email list. </param>
        internal ContactDetails(string contactPerson, string companyName, string phone, IList<string> emailList)
        {
            ContactPerson = contactPerson;
            CompanyName = companyName;
            Phone = phone;
