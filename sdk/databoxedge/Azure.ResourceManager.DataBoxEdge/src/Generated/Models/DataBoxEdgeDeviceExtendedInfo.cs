...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public partial class DataBoxEdgeDeviceExtendedInfo : ResourceData
    {
        ...
        internal DataBoxEdgeDeviceExtendedInfo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DataBoxEdgeDeviceExtendedInfoProperties properties) : base(id, name, resourceType, systemData)
        {
