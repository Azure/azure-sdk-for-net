...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    public partial class DataBoxEdgeAlertData : ResourceData
    {
        ...
        internal DataBoxEdgeAlertData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string title, string alertType, DateTimeOffset? appearedOn, string recommendation, DataBoxEdgeAlertSeverity? severity, DataBoxEdgeAlertErrorDetails errorDetails, IReadOnlyDictionary<string, string> detailedInformation, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Title = title;
            AlertType = alertType;
