...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DiagnosticProactiveLogCollectionSettingData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DiagnosticProactiveLogCollectionSettingData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DiagnosticProactiveLogCollectionSettingData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DiagnosticProactiveLogCollectionSettingData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DiagnosticProactiveLogCollectionSettingData)} does not support '{options.Format}' format.");
            }
        }
