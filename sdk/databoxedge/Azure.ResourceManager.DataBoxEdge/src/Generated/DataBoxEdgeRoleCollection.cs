    ...
    public partial class DataBoxEdgeRoleCollection : ArmCollection, IEnumerable<DataBoxEdgeRoleResource>, IAsyncEnumerable<DataBoxEdgeRoleResource>
    {
        ...
        public virtual async Task<ArmOperation<DataBoxEdgeRoleResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, DataBoxEdgeRoleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataBoxEdgeArmOperation<DataBoxEdgeRoleResource>(new DataBoxEdgeRoleOperationSource(Client), _dataBoxEdgeRoleRolesClientDiagnostics, Pipeline, _dataBoxEdgeRoleRolesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, data).Request, response, Core.OperationFinalStateVia.Location);
        ...
        public virtual AsyncPageable<DataBoxEdgeRoleResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return Core.PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new DataBoxEdgeRoleResource(Client, DataBoxEdgeRoleData.DeserializeDataBoxEdgeRoleData(e)), _dataBoxEdgeRoleRolesClientDiagnostics, Pipeline, "DataBoxEdgeRoleCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<DataBoxEdgeRoleResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _dataBoxEdgeRoleRolesRestClient.CreateListByDataBoxEdgeDeviceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _dataBoxEdgeRoleRolesRestClient.CreateListByDataBoxEdgeDeviceNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return Core.PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new DataBoxEdgeRoleResource(Client, DataBoxEdgeRoleData.DeserializeDataBoxEdgeRoleData(e)), _dataBoxEdgeRoleRolesClientDiagnostics, Pipeline, "DataBoxEdgeRoleCollection.GetAll", "value", "nextLink", cancellationToken);
        }
