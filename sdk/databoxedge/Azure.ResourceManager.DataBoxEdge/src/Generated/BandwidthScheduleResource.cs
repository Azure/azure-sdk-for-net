...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    public partial class BandwidthScheduleResource : ArmResource
    {
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/bandwidthSchedules/{name}
        /// Operation Id: BandwidthSchedules_Delete
        /// </summary>
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataBoxEdgeArmOperation(_bandwidthScheduleClientDiagnostics, Pipeline, _bandwidthScheduleRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.NotSpecified);
        ...
        public virtual async Task<ArmOperation<BandwidthScheduleResource>> UpdateAsync(WaitUntil waitUntil, BandwidthScheduleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataBoxEdgeArmOperation<BandwidthScheduleResource>(new BandwidthScheduleOperationSource(Client), _bandwidthScheduleClientDiagnostics, Pipeline, _bandwidthScheduleRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, data).Request, response, OperationFinalStateVia.NotSpecified);
                if (waitUntil == WaitUntil.Completed)
