...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    public partial class MonitoringMetricConfigurationData : ResourceData
    {
        ...
        internal MonitoringMetricConfigurationData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<DataBoxEdgeMetricConfiguration> metricConfigurations, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
