...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    public partial class DiagnosticRemoteSupportSettingData : ResourceData
    {
        ...
        internal DiagnosticRemoteSupportSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IList<EdgeRemoteSupportSettings> remoteSupportSettingsList, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
