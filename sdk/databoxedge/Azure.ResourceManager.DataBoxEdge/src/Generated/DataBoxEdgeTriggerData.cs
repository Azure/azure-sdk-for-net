...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    public partial class DataBoxEdgeTriggerData : ResourceData
    {
        ...
        internal DataBoxEdgeTriggerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TriggerEventType kind, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Kind = kind;
