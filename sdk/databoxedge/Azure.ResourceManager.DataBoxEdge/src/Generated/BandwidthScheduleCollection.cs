    ...
    public partial class BandwidthScheduleCollection : ArmCollection, IEnumerable<BandwidthScheduleResource>, IAsyncEnumerable<BandwidthScheduleResource>
    {
        ...
        public virtual async Task<ArmOperation<BandwidthScheduleResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, BandwidthScheduleData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataBoxEdgeArmOperation<BandwidthScheduleResource>(new BandwidthScheduleOperationSource(Client), _bandwidthScheduleClientDiagnostics, Pipeline, _bandwidthScheduleRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, data).Request, response, OperationFinalStateVia.NotSpecified);
        ...
        {
            async Task<Page<BandwidthScheduleResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _bandwidthScheduleClientDiagnostics.CreateScope("BandwidthScheduleCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _bandwidthScheduleRestClient.ListByDataBoxEdgeDeviceAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new BandwidthScheduleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<BandwidthScheduleResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _bandwidthScheduleClientDiagnostics.CreateScope("BandwidthScheduleCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _bandwidthScheduleRestClient.ListByDataBoxEdgeDeviceNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new BandwidthScheduleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<BandwidthScheduleResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _bandwidthScheduleClientDiagnostics.CreateScope("BandwidthScheduleCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _bandwidthScheduleRestClient.ListByDataBoxEdgeDevice(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new BandwidthScheduleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<BandwidthScheduleResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _bandwidthScheduleClientDiagnostics.CreateScope("BandwidthScheduleCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _bandwidthScheduleRestClient.ListByDataBoxEdgeDeviceNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new BandwidthScheduleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
