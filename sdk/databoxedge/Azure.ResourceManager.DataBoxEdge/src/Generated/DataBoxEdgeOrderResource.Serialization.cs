...
namespace Azure.ResourceManager.DataBoxEdge
{
    public partial class DataBoxEdgeOrderResource : IJsonModel<DataBoxEdgeOrderData>
    {
        ...
        BinaryData IPersistableModel<DataBoxEdgeOrderData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write(Data, options);

        DataBoxEdgeOrderData IPersistableModel<DataBoxEdgeOrderData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<DataBoxEdgeOrderData>(data, options);
