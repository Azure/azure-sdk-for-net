...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    public partial class DiagnosticRemoteSupportSettingResource : ArmResource
    {
        ...
        internal DiagnosticRemoteSupportSettingResource(ArmClient client, DiagnosticRemoteSupportSettingData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DiagnosticRemoteSupportSettingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new DiagnosticRemoteSupportSettingResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
