...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public static partial class ArmDataBoxEdgeModelFactory
    {
        ...
        public static AvailableDataBoxEdgeSku AvailableDataBoxEdgeSku(string resourceType = null, DataBoxEdgeSkuName? name = null, string kind = null, DataBoxEdgeSkuTier? tier = null, string size = null, string family = null, IEnumerable<AzureLocation> locations = null, IEnumerable<string> apiVersions = null, IEnumerable<DataBoxEdgeSkuLocationInfo> locationInfo = null, IEnumerable<DataBoxEdgeSkuCost> costs = null, DataBoxEdgeSkuSignupOption? signupOption = null, DataBoxEdgeSkuVersion? version = null, DataBoxEdgeSkuAvailability? availability = null, IEnumerable<DataBoxEdgeShipmentType> shipmentTypes = null, IEnumerable<DataBoxEdgeSkuCapability> capabilities = null)
        {
            ...
            return new AvailableDataBoxEdgeSku(resourceType, name, kind, tier, size, family, locations?.ToList(), apiVersions?.ToList(), locationInfo?.ToList(), costs?.ToList(), signupOption, version, availability, shipmentTypes?.ToList(), capabilities?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static DataBoxEdgeSkuLocationInfo DataBoxEdgeSkuLocationInfo(AzureLocation? location = null, IEnumerable<string> zones = null, IEnumerable<string> sites = null)
        {
            ...
            return new DataBoxEdgeSkuLocationInfo(location, zones?.ToList(), sites?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeSkuCost(meterId, quantity, extendedUnit, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeSkuCapability(name, value, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeResourceMoveDetails(operationInProgress, operationInProgressLockTimeoutInUtc, new Dictionary<string, BinaryData>());
        }
        ...
        public static EdgeProfileSubscription EdgeProfileSubscription(Guid? registrationId = null, ResourceIdentifier id = null, DataBoxEdgeSubscriptionState? state = null, string registrationDate = null, string subscriptionId = null, Guid? tenantId = null, string locationPlacementId = null, string quotaId = null, string serializedDetails = null, IEnumerable<SubscriptionRegisteredFeatures> registeredFeatures = null)
        {
            ...
            return new EdgeProfileSubscription(registrationId, id, state, registrationDate, subscriptionId, tenantId, locationPlacementId, quotaId, serializedDetails, registeredFeatures?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SubscriptionRegisteredFeatures(name, state, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataBoxEdgeAlertData DataBoxEdgeAlertData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string title = null, string alertType = null, DateTimeOffset? appearedOn = null, string recommendation = null, DataBoxEdgeAlertSeverity? severity = null, DataBoxEdgeAlertErrorDetails errorDetails = null, IReadOnlyDictionary<string, string> detailedInformation = null)
        {
            ...
            return new DataBoxEdgeAlertData(id, name, resourceType, systemData, title, alertType, appearedOn, recommendation, severity, errorDetails, detailedInformation, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeAlertErrorDetails(errorCode, errorMessage, occurrences, new Dictionary<string, BinaryData>());
        }
        ...
        public static BandwidthScheduleData BandwidthScheduleData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, TimeSpan startOn = default, TimeSpan stopOn = default, int rateInMbps = default, IEnumerable<DataBoxEdgeDayOfWeek> days = null)
        {
            ...
            return new BandwidthScheduleData(id, name, resourceType, systemData, startOn, stopOn, rateInMbps, days?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static DataBoxEdgeDeviceCapacityInfo DataBoxEdgeDeviceCapacityInfo(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? timeStamp = null, EdgeClusterStorageViewInfo clusterStorageCapacityInfo = null, EdgeClusterCapacityViewInfo clusterComputeCapacityInfo = null, IDictionary<string, HostCapacity> nodeCapacityInfos = null)
        {
            ...
            return new DataBoxEdgeDeviceCapacityInfo(id, name, resourceType, systemData, timeStamp, clusterStorageCapacityInfo, clusterComputeCapacityInfo, nodeCapacityInfos, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DiagnosticProactiveLogCollectionSettingData(id, name, resourceType, systemData, userConsent, new Dictionary<string, BinaryData>());
        }
        ...
        public static DiagnosticRemoteSupportSettingData DiagnosticRemoteSupportSettingData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<EdgeRemoteSupportSettings> remoteSupportSettingsList = null)
        {
            ...
            return new DiagnosticRemoteSupportSettingData(id, name, resourceType, systemData, remoteSupportSettingsList?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GenerateCertResult(publicKey, privateKey, expireOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeDeviceSecret(encryptedSecret, keyVaultId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeJobData(id, name, resourceType, systemData, status, startOn, endOn, percentComplete, error, jobType, currentStage, downloadProgress, installProgress, totalRefreshErrors, errorManifestFile, refreshedEntityId, folder, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataBoxEdgeJobErrorDetails DataBoxEdgeJobErrorDetails(IEnumerable<DataBoxEdgeJobErrorItem> errorDetails = null, string code = null, string message = null)
        {
            ...
            return new DataBoxEdgeJobErrorDetails(errorDetails?.ToList(), code, message, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataBoxEdgeJobErrorItem DataBoxEdgeJobErrorItem(IEnumerable<string> recommendations = null, string code = null, string message = null)
        {
            ...
            return new DataBoxEdgeJobErrorItem(recommendations?.ToList(), code, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UpdateDownloadProgress(downloadPhase, percentComplete, totalBytesToDownload, totalBytesDownloaded, numberOfUpdatesToDownload, numberOfUpdatesDownloaded, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UpdateInstallProgress(percentComplete, numberOfUpdatesToInstall, numberOfUpdatesInstalled, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataBoxEdgeDeviceNetworkSettings DataBoxEdgeDeviceNetworkSettings(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<DataBoxEdgeNetworkAdapter> networkAdapters = null)
        {
            ...
            return new DataBoxEdgeDeviceNetworkSettings(id, name, resourceType, systemData, networkAdapters?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static DataBoxEdgeNetworkAdapter DataBoxEdgeNetworkAdapter(string adapterId = null, DataBoxEdgeNetworkAdapterPosition adapterPosition = null, int? index = null, Guid? nodeId = null, string networkAdapterName = null, string label = null, string macAddress = null, long? linkSpeed = null, DataBoxEdgeNetworkAdapterStatus? status = null, DataBoxEdgeNetworkAdapterRdmaStatus? rdmaStatus = null, DataBoxEdgeNetworkAdapterDhcpStatus? dhcpStatus = null, DataBoxEdgeIPv4Config ipv4Configuration = null, DataBoxEdgeIPv6Config ipv6Configuration = null, string ipv6LinkLocalAddress = null, IEnumerable<string> dnsServers = null)
        {
            ...
            return new DataBoxEdgeNetworkAdapter(adapterId, adapterPosition, index, nodeId, networkAdapterName, label, macAddress, linkSpeed, status, rdmaStatus, dhcpStatus, ipv4Configuration, ipv6Configuration, ipv6LinkLocalAddress, dnsServers?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeNetworkAdapterPosition(networkGroup, port, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeIPv4Config(ipAddress, subnet, gateway, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeIPv6Config(ipAddress, prefixLength, gateway, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeNode(id, name, resourceType, systemData, nodeStatus, nodeChassisSerialNumber, nodeSerialNumber, nodeDisplayName, nodeFriendlySoftwareVersion, nodeHcsVersion, nodeInstanceId, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataBoxEdgeOrderData DataBoxEdgeOrderData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string kind = null, string orderId = null, DataBoxEdgeContactDetails contactInformation = null, DataBoxEdgeShippingAddress shippingAddress = null, DataBoxEdgeOrderStatus currentStatus = null, IEnumerable<DataBoxEdgeOrderStatus> orderHistory = null, string serialNumber = null, IEnumerable<DataBoxEdgeTrackingInfo> deliveryTrackingInfo = null, IEnumerable<DataBoxEdgeTrackingInfo> returnTrackingInfo = null, DataBoxEdgeShipmentType? shipmentType = null)
        {
            ...
            return new DataBoxEdgeOrderData(id, name, resourceType, systemData, kind, orderId, contactInformation, shippingAddress, currentStatus, orderHistory?.ToList(), serialNumber, deliveryTrackingInfo?.ToList(), returnTrackingInfo?.ToList(), shipmentType, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataBoxEdgeOrderStatus DataBoxEdgeOrderStatus(DataBoxEdgeOrderState status = default, DateTimeOffset? updateOn = null, string comments = null, DataBoxEdgeTrackingInfo trackingInformation = null, IReadOnlyDictionary<string, string> additionalOrderDetails = null)
        {
            ...
            return new DataBoxEdgeOrderStatus(status, updateOn, comments, trackingInformation, additionalOrderDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeTrackingInfo(serialNumber, carrierName, trackingId, trackingUri, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeDataCenterAccessCode(authCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeRoleData(id, name, resourceType, systemData, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeRoleAddonData(id, name, resourceType, systemData, kind, new Dictionary<string, BinaryData>());
        }
        ...
        public static MonitoringMetricConfigurationData MonitoringMetricConfigurationData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IEnumerable<DataBoxEdgeMetricConfiguration> metricConfigurations = null)
        {
            ...
            return new MonitoringMetricConfigurationData(id, name, resourceType, systemData, metricConfigurations?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeSecuritySettings(id, name, resourceType, systemData, deviceAdminPassword, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataBoxEdgeShareData DataBoxEdgeShareData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, ShareStatus shareStatus = default, DataBoxEdgeShareMonitoringStatus monitoringStatus = default, DataBoxEdgeStorageContainerInfo azureContainerInfo = null, ShareAccessProtocol accessProtocol = default, IEnumerable<UserAccessRight> userAccessRights = null, IEnumerable<ClientAccessRight> clientAccessRights = null, DataBoxEdgeRefreshDetails refreshDetails = null, IEnumerable<DataBoxEdgeMountPointMap> shareMappings = null, DataBoxEdgeDataPolicy? dataPolicy = null)
        {
            ...
            return new DataBoxEdgeShareData(id, name, resourceType, systemData, description, shareStatus, monitoringStatus, azureContainerInfo, accessProtocol, userAccessRights?.ToList(), clientAccessRights?.ToList(), refreshDetails, shareMappings?.ToList(), dataPolicy, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeMountPointMap(shareId, roleId, mountPoint, mountType, roleType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeStorageAccountCredentialData(id, name, resourceType, systemData, @alias, userName, accountKey, connectionString, sslStatus, blobDomainName, accountType, storageAccountId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeStorageAccountData(id, name, resourceType, systemData, description, storageAccountStatus, dataPolicy, storageAccountCredentialId, blobEndpoint, containerCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeStorageContainerData(id, name, resourceType, systemData, containerStatus, dataFormat, refreshDetails, createdOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeTriggerData(id, name, resourceType, systemData, kind, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TriggerSupportPackageContent(id, name, resourceType, systemData, minimumTimeStamp, maximumTimeStamp, include, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeUpdateDetails(updateTitle, updateSizeInBytes, updateType, targetVersion, friendlyVersionNumber, estimatedInstallTimeInMins, rebootBehavior, installationImpact, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UploadCertificateContent(authenticationType, certificate, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UploadCertificateResponse(authType, resourceId, aadAuthority, aadTenantId, servicePrincipalClientId, servicePrincipalObjectId, azureManagementEndpointAudience, aadAudience, new Dictionary<string, BinaryData>());
        }
        ...
        public static DataBoxEdgeUserData DataBoxEdgeUserData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AsymmetricEncryptedSecret encryptedPassword = null, IEnumerable<ShareAccessRight> shareAccessRights = null, DataBoxEdgeUserType userType = default)
        {
            ...
            return new DataBoxEdgeUserData(id, name, resourceType, systemData, encryptedPassword, shareAccessRights?.ToList(), userType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ShareAccessRight(shareId, accessType, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EdgeArcAddon(id, name, resourceType, systemData, AddonType.ArcForKubernetes, new Dictionary<string, BinaryData>(), subscriptionId, resourceGroupName, resourceName, resourceLocation, version, hostPlatform, hostPlatformType, provisioningState);
        }
        ...
        {
            return new CloudEdgeManagementRole(id, name, resourceType, systemData, DataBoxEdgeRoleType.CloudEdgeManagement, new Dictionary<string, BinaryData>(), localManagementStatus, edgeSubscription != null ? new EdgeProfile(edgeSubscription, new Dictionary<string, BinaryData>()) : null, roleStatus);
        }
        ...
        {
            return new CniConfig(cniConfigType, version, podSubnet, serviceSubnet, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeEtcdInfo(etcdInfoType, version, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EdgeFileEventTrigger(id, name, resourceType, systemData, TriggerEventType.FileEvent, new Dictionary<string, BinaryData>(), sourceInfoShareId != null ? new EdgeFileSourceInfo(sourceInfoShareId, new Dictionary<string, BinaryData>()) : null, sinkInfoRoleId != null ? new DataBoxEdgeRoleSinkInfo(sinkInfoRoleId, new Dictionary<string, BinaryData>()) : null, customContextTag);
        }
        ...
        {
            return new EdgeIotAddon(id, name, resourceType, systemData, AddonType.IotEdge, new Dictionary<string, BinaryData>(), iotDeviceDetails, iotEdgeDeviceDetails, version, hostPlatform, hostPlatformType, provisioningState);
        }
        ...
        public static EdgeIotRole EdgeIotRole(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DataBoxEdgeOSPlatformType? hostPlatform = null, EdgeIotDeviceInfo iotDeviceDetails = null, EdgeIotDeviceInfo iotEdgeDeviceDetails = null, IEnumerable<DataBoxEdgeMountPointMap> shareMappings = null, IotEdgeAgentInfo iotEdgeAgentInfo = null, HostPlatformType? hostPlatformType = null, EdgeComputeResourceInfo computeResource = null, DataBoxEdgeRoleStatus? roleStatus = null)
        {
            ...
            return new EdgeIotRole(id, name, resourceType, systemData, DataBoxEdgeRoleType.IoT, new Dictionary<string, BinaryData>(), hostPlatform, iotDeviceDetails, iotEdgeDeviceDetails, shareMappings?.ToList(), iotEdgeAgentInfo, hostPlatformType, computeResource, roleStatus);
        }
        ...
        public static EdgeKubernetesClusterInfo EdgeKubernetesClusterInfo(DataBoxEdgeEtcdInfo etcdInfo = null, IEnumerable<EdgeKubernetesNodeInfo> nodes = null, string version = null)
        {
            ...
            return new EdgeKubernetesClusterInfo(etcdInfo, nodes?.ToList(), version, new Dictionary<string, BinaryData>());
        }
        ...
        public static EdgeKubernetesNodeInfo EdgeKubernetesNodeInfo(string name = null, EdgeKubernetesNodeType? nodeType = null, IEnumerable<EdgeKubernetesIPConfiguration> ipConfiguration = null)
        {
            ...
            return new EdgeKubernetesNodeInfo(name, nodeType, ipConfiguration?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EdgeKubernetesIPConfiguration(port, ipAddress, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EdgeKubernetesRole(id, name, resourceType, systemData, DataBoxEdgeRoleType.Kubernetes, new Dictionary<string, BinaryData>(), hostPlatform, provisioningState, hostPlatformType, kubernetesClusterInfo, kubernetesRoleResources, roleStatus);
        }
        ...
        {
            return new EdgeKubernetesRoleResources(storage, compute, network, new Dictionary<string, BinaryData>());
        }
        ...
        public static EdgeKubernetesRoleStorage EdgeKubernetesRoleStorage(IEnumerable<EdgeKubernetesRoleStorageClassInfo> storageClasses = null, IEnumerable<DataBoxEdgeMountPointMap> endpoints = null)
        {
            ...
            return new EdgeKubernetesRoleStorage(storageClasses?.ToList(), endpoints?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EdgeKubernetesRoleStorageClassInfo(name, kubernetesRoleStorageClassInfoType, posixCompliant, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EdgeKubernetesRoleCompute(vmProfile, memoryInBytes, processorCount, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EdgeKubernetesRoleNetwork(cniConfig, loadBalancerConfig, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DataBoxEdgeLoadBalancerConfig(loadBalancerConfigType, version, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MecRole(id, name, resourceType, systemData, DataBoxEdgeRoleType.Mec, new Dictionary<string, BinaryData>(), connectionString, controllerEndpoint, resourceUniqueId, roleStatus);
        }
        ...
        {
            return new PeriodicTimerEventTrigger(id, name, resourceType, systemData, TriggerEventType.PeriodicTimerEvent, new Dictionary<string, BinaryData>(), sourceInfo, sinkInfoRoleId != null ? new DataBoxEdgeRoleSinkInfo(sinkInfoRoleId, new Dictionary<string, BinaryData>()) : null, customContextTag);
        }
    }
}
