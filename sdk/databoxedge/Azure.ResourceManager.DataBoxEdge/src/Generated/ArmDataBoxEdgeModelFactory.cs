...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    public static partial class ArmDataBoxEdgeModelFactory
    {
        ...
        {
            return new CloudEdgeManagementRole(id, name, resourceType, systemData, DataBoxEdgeRoleType.CloudEdgeManagement, serializedAdditionalRawData: null, localManagementStatus, edgeSubscription != null ? new EdgeProfile(edgeSubscription, new Dictionary<string, BinaryData>()) : null, roleStatus);
        }
        ...
        {
            return new PeriodicTimerEventTrigger(id, name, resourceType, systemData, TriggerEventType.PeriodicTimerEvent, serializedAdditionalRawData: null, sourceInfo, sinkInfoRoleId != null ? new DataBoxEdgeRoleSinkInfo(sinkInfoRoleId, new Dictionary<string, BinaryData>()) : null, customContextTag);
        }
    }
}
