...
namespace Azure.ResourceManager.DataBoxEdge
{
    ...
    {
        /// <summary> Generate the resource identifier of a <see cref="MonitoringMetricConfigurationResource"/> instance. </summary>
        public static ResourceIdentifier CreateResourceIdentifier(string subscriptionId, string resourceGroupName, string deviceName, string roleName)
        {
            var resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/roles/{roleName}/monitoringConfig/default";
            return new ResourceIdentifier(resourceId);
        }

        private readonly ClientDiagnostics _monitoringMetricConfigurationMonitoringConfigClientDiagnostics;
        ...
        internal MonitoringMetricConfigurationResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _monitoringMetricConfigurationMonitoringConfigClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DataBoxEdge", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string monitoringMetricConfigurationMonitoringConfigApiVersion);
            _monitoringMetricConfigurationMonitoringConfigRestClient = new MonitoringConfigRestOperations(Pipeline, Diagnostics.ApplicationId, Endpoint, monitoringMetricConfigurationMonitoringConfigApiVersion);
#if DEBUG
        ...
        public virtual MonitoringMetricConfigurationData Data
        {
            get
            {
                if (!HasData)
        ...
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DataBoxEdge/dataBoxEdgeDevices/{deviceName}/roles/{roleName}/monitoringConfig/default</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>MonitoringConfig_Get</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<MonitoringMetricConfigurationResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _monitoringMetricConfigurationMonitoringConfigClientDiagnostics.CreateScope("MonitoringMetricConfigurationResource.Get");
            scope.Start();
            try
            {
                var response = await _monitoringMetricConfigurationMonitoringConfigRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new MonitoringMetricConfigurationResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<MonitoringMetricConfigurationResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _monitoringMetricConfigurationMonitoringConfigClientDiagnostics.CreateScope("MonitoringMetricConfigurationResource.Get");
            scope.Start();
            try
            {
                var response = _monitoringMetricConfigurationMonitoringConfigRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new MonitoringMetricConfigurationResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>MonitoringConfig_Delete</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using var scope = _monitoringMetricConfigurationMonitoringConfigClientDiagnostics.CreateScope("MonitoringMetricConfigurationResource.Delete");
            scope.Start();
            try
            {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>MonitoringConfig_CreateOrUpdate</description>
        /// </item>
        /// </list>
        /// </summary>
        /// <param name="waitUntil"> <see cref="WaitUntil.Completed"/> if the method should wait to return until the long-running operation has completed on the service; <see cref="WaitUntil.Started"/> if it should return after starting the operation. For more information on long-running operations, please see <see href="https://github.com/Azure/azure-sdk-for-net/blob/main/sdk/core/Azure.Core/samples/LongRunningOperations.md"> Azure.Core Long-Running Operation samples</see>. </param>
