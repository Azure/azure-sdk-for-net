...
namespace Azure.ResourceManager.DataBoxEdge.Models
{
    ...
    {
        internal static CloudEdgeManagementRole DeserializeCloudEdgeManagementRole(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CloudEdgeManagementRoleProperties.DeserializeCloudEdgeManagementRoleProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
