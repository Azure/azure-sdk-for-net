...
{
    public partial class UnknownDataBoxEdgeTrigger
    {
        internal static UnknownDataBoxEdgeTrigger DeserializeUnknownDataBoxEdgeTrigger(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownDataBoxEdgeTrigger(
                id,
                name,
                resourceType,
                systemData,
