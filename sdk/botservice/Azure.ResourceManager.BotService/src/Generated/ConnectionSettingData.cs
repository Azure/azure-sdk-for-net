...
{
    /// <summary> A class representing the ConnectionSetting data model. </summary>
    public partial class ConnectionSettingData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ConnectionSettingData. </summary>
        /// <param name="location"> The location. </param>
        public ConnectionSettingData(AzureLocation location) : base(location)
        {
        ...
        internal ConnectionSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ConnectionSettingProperties properties, BotServiceSku sku, BotServiceKind? kind, ETag? etag, IReadOnlyList<string> zones) : base(id, name, resourceType, systemData, tags, location)
        {
