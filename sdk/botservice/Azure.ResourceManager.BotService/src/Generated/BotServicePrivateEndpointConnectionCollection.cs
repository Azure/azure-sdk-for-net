...
namespace Azure.ResourceManager.BotService
{
    ...
    public partial class BotServicePrivateEndpointConnectionCollection : ArmCollection, IEnumerable<BotServicePrivateEndpointConnectionResource>, IAsyncEnumerable<BotServicePrivateEndpointConnectionResource>
    {
        ...
        /// <summary> Initializes a new instance of BotServicePrivateEndpointConnectionCollection for mocking. </summary>
        protected BotServicePrivateEndpointConnectionCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="BotServicePrivateEndpointConnectionCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(BotServicePrivateEndpointConnectionResource.ResourceType, out string botServicePrivateEndpointConnectionApiVersion);
            _privateEndpointConnectionsClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.BotService", BotServicePrivateEndpointConnectionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<BotServicePrivateEndpointConnectionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string privateEndpointConnectionName, BotServicePrivateEndpointConnectionData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("BotServicePrivateEndpointConnectionCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _privateEndpointConnectionsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, privateEndpointConnectionName, BotServicePrivateEndpointConnectionData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BotServicePrivateEndpointConnectionData> response = Response.FromValue(BotServicePrivateEndpointConnectionData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
                RehydrationToken rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                BotServiceArmOperation<BotServicePrivateEndpointConnectionResource> operation = new BotServiceArmOperation<BotServicePrivateEndpointConnectionResource>(Response.FromValue(new BotServicePrivateEndpointConnectionResource(Client, response.Value), response.GetRawResponse()), rehydrationToken);
        ...
        public virtual async Task<Response<BotServicePrivateEndpointConnectionResource>> GetAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("BotServicePrivateEndpointConnectionCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual Pageable<BotServicePrivateEndpointConnectionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<BotServicePrivateEndpointConnectionData, BotServicePrivateEndpointConnectionResource>(new PrivateEndpointConnectionsGetAllCollectionResultOfT(_privateEndpointConnectionsRestClient, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context), data => new BotServicePrivateEndpointConnectionResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("BotServicePrivateEndpointConnectionCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<BotServicePrivateEndpointConnectionData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(BotServicePrivateEndpointConnectionData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((BotServicePrivateEndpointConnectionData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<BotServicePrivateEndpointConnectionResource>> GetIfExistsAsync(string privateEndpointConnectionName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _privateEndpointConnectionsClientDiagnostics.CreateScope("BotServicePrivateEndpointConnectionCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
