...
namespace Azure.ResourceManager.BotService
{
    internal partial class BotServiceArmOperation<T> : ArmOperation<T>
    {
        ...
        internal BotServiceArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
