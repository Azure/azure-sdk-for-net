...
namespace Azure.ResourceManager.BotService
{
    internal class NetworkSecurityPerimeterConfigurationOperationSource : IOperationSource<NetworkSecurityPerimeterConfigurationResource>
    {
        ...
        {
            var data = ModelReaderWriter.Read<NetworkSecurityPerimeterConfigurationData>(response.Content, ModelReaderWriterOptions.Json, AzureResourceManagerBotServiceContext.Default);
