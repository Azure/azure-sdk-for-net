...
namespace Azure.ResourceManager.BotService
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="BotResource"/> using the GetNetworkSecurityPerimeterConfiguration method.
    /// </summary>
    public partial class NetworkSecurityPerimeterConfigurationResource : ArmResource
    {
        ...
        {
            var resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BotService/botServices/{resourceName}/networkSecurityPerimeterConfigurations/{networkSecurityPerimeterConfigurationName}";
        ...
        {
            _networkSecurityPerimeterConfigurationClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.BotService", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<ArmOperation<NetworkSecurityPerimeterConfigurationResource>> ReconcileAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new BotServiceArmOperation<NetworkSecurityPerimeterConfigurationResource>(new NetworkSecurityPerimeterConfigurationOperationSource(Client), _networkSecurityPerimeterConfigurationClientDiagnostics, Pipeline, _networkSecurityPerimeterConfigurationRestClient.CreateReconcileRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
