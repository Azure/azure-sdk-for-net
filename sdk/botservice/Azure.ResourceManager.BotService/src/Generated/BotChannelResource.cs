...
namespace Azure.ResourceManager.BotService
{
    ...
    public partial class BotChannelResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<BotChannelResource>> UpdateAsync(WaitUntil waitUntil, BotChannelData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _botChannelsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, BotChannelData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BotChannelData> response = Response.FromValue(BotChannelData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<BotChannelResource> Update(WaitUntil waitUntil, BotChannelData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
