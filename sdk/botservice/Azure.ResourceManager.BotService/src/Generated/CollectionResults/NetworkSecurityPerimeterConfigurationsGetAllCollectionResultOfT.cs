...
namespace Azure.ResourceManager.BotService
{
    internal partial class NetworkSecurityPerimeterConfigurationsGetAllCollectionResultOfT : Pageable<BotServiceNetworkSecurityPerimeterConfigurationData>
    {
        ...
        public NetworkSecurityPerimeterConfigurationsGetAllCollectionResultOfT(NetworkSecurityPerimeterConfigurations client, string subscriptionId, string resourceGroupName, string resourceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
