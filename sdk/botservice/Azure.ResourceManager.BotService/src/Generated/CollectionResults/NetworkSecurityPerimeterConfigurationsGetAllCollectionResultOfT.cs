...
{
    internal partial class NetworkSecurityPerimeterConfigurationsGetAllCollectionResultOfT : Pageable<BotServiceNetworkSecurityPerimeterConfigurationData>
    {
        ...
        public NetworkSecurityPerimeterConfigurationsGetAllCollectionResultOfT(NetworkSecurityPerimeterConfigurations client, string subscriptionId, string resourceGroupName, string resourceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<BotServiceNetworkSecurityPerimeterConfigurationData>> AsPages(string continuationToken, int? pageSizeHint)
        {
