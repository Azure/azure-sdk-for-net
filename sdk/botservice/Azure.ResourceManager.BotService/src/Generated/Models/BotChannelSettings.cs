...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class BotChannelSettings
    {
        ...
        internal BotChannelSettings(string extensionKey1, string extensionKey2, IList<BotChannelSite> sites, string channelId, string channelDisplayName, string botId, Uri botIconUri, bool? isEnabled, bool? disableLocalAuth, bool? requireTermsAgreement, Dictionary<string, BinaryData> rawData)
        {
