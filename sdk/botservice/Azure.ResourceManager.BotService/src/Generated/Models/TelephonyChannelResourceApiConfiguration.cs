...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class TelephonyChannelResourceApiConfiguration
    {
        ...
        internal TelephonyChannelResourceApiConfiguration(string id, string providerName, string cognitiveServiceSubscriptionKey, string cognitiveServiceRegion, ResourceIdentifier cognitiveServiceResourceId, string defaultLocale, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
