...
{
    public partial class WebChatChannelProperties : IUtf8JsonSerializable, IJsonModel<WebChatChannelProperties>, IPersistableModel<WebChatChannelProperties>
    {
        ...
        void IJsonModel<WebChatChannelProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(WebChatChannelProperties)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  webChatEmbedCode:");
                builder.AppendLine($" '{WebChatEmbedCode}'");
            }
