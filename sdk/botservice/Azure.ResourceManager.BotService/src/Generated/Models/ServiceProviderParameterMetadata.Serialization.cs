...
{
    internal partial class ServiceProviderParameterMetadata : IUtf8JsonSerializable, IJsonModel<ServiceProviderParameterMetadata>, IPersistableModel<ServiceProviderParameterMetadata>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Constraints))
            {
                ...
                AppendChildObject(builder, Constraints, options, 2);
            }
