...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceProviderParameterMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceProviderParameterMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceProviderParameterMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceProviderParameterMetadata>)} interface");
            }
        ...
        ServiceProviderParameterMetadata IJsonModel<ServiceProviderParameterMetadata>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        ServiceProviderParameterMetadata IPersistableModel<ServiceProviderParameterMetadata>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<ServiceProviderParameterMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
