...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DirectLineSpeechChannelProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DirectLineSpeechChannelProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DirectLineSpeechChannelProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DirectLineSpeechChannelProperties>)} interface");
            }
        ...
        string IPersistableModel<DirectLineSpeechChannelProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
