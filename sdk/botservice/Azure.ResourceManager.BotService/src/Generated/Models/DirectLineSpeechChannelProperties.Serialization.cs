...
{
    public partial class DirectLineSpeechChannelProperties : IUtf8JsonSerializable, IJsonModel<DirectLineSpeechChannelProperties>, IPersistableModel<DirectLineSpeechChannelProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CustomVoiceDeploymentId))
            {
                builder.Append("  customVoiceDeploymentId:");
                builder.AppendLine($" '{CustomVoiceDeploymentId}'");
            }

            if (Optional.IsDefined(CustomSpeechModelId))
            {
                builder.Append("  customSpeechModelId:");
                builder.AppendLine($" '{CustomSpeechModelId}'");
            }

            if (Optional.IsDefined(IsDefaultBotForCogSvcAccount))
            {
                builder.Append("  isDefaultBotForCogSvcAccount:");
                var boolValue = IsDefaultBotForCogSvcAccount.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
