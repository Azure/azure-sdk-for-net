...
{
    public partial class DirectLineChannelProperties : IUtf8JsonSerializable, IJsonModel<DirectLineChannelProperties>, IPersistableModel<DirectLineChannelProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DirectLineEmbedCode))
            {
                builder.Append("  DirectLineEmbedCode:");
                builder.AppendLine($" '{DirectLineEmbedCode}'");
            }
