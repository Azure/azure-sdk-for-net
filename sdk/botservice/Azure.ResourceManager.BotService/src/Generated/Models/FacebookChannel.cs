...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class FacebookChannel : BotChannelProperties
    {
        ...
        internal FacebookChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, FacebookChannelProperties properties, Dictionary<string, BinaryData> rawData) : base(channelName, etag, provisioningState, location, rawData)
        {
