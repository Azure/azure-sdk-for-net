...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TelephonyPhoneNumbers>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TelephonyPhoneNumbers>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TelephonyPhoneNumbers>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TelephonyPhoneNumbers>)} interface");
            }
        ...
        string IPersistableModel<TelephonyPhoneNumbers>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
