...
{
    public partial class FacebookChannel : IUtf8JsonSerializable
    {
        ...
        internal static FacebookChannel DeserializeFacebookChannel(JsonElement element)
        {
            ...
            return new FacebookChannel(channelName, Optional.ToNullable(etag), provisioningState.Value, Optional.ToNullable(location), properties.Value);
        }
    }
}
