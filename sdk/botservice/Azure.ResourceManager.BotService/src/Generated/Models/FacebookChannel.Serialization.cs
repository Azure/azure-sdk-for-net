...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FacebookChannel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FacebookChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FacebookChannel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FacebookChannel>)} interface");
            }
        ...
        string IPersistableModel<FacebookChannel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
