...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class AlexaChannelProperties
    {
        ...
        internal AlexaChannelProperties(string alexaSkillId, string uriFragment, Uri serviceEndpointUri, bool isEnabled, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AlexaSkillId = alexaSkillId;
