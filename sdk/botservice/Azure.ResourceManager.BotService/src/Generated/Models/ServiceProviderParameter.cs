...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class ServiceProviderParameter
    {
        ...
        internal ServiceProviderParameter(string name, string serviceProviderParameterType, string displayName, string description, Uri helpUri, string @default, ServiceProviderParameterMetadata metadata)
        {
            Name = name;
