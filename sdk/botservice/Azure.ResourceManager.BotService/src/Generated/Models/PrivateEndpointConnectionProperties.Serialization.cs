    ...
    internal partial class PrivateEndpointConnectionProperties : IJsonModel<PrivateEndpointConnectionProperties>
    {
        ...
        internal static PrivateEndpointConnectionProperties DeserializePrivateEndpointConnectionProperties(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    connectionState = BotServicePrivateLinkServiceConnectionState.DeserializeBotServicePrivateLinkServiceConnectionState(prop.Value, options);
                    continue;
                }
                if (prop.NameEquals("provisioningState"u8))
                {
                    ...
                    provisioningState = new BotServicePrivateEndpointConnectionProvisioningState(prop.Value.GetString());
                    continue;
                }
            ...
            return new PrivateEndpointConnectionProperties(privateEndpoint, connectionState, provisioningState, groupIds ?? new ChangeTrackingList<string>(), additionalBinaryDataProperties);
        }
    }
}
