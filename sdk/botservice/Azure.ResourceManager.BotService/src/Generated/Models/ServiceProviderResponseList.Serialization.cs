...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ServiceProviderResponseList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ServiceProviderResponseList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ServiceProviderResponseList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ServiceProviderResponseList>)} interface");
            }
        ...
        string IPersistableModel<ServiceProviderResponseList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
