...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        internal static ServiceProviderResponseList DeserializeServiceProviderResponseList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
