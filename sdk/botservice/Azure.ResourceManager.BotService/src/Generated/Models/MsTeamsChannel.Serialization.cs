...
{
    public partial class MsTeamsChannel : IUtf8JsonSerializable, IJsonModel<MsTeamsChannel>, IPersistableModel<MsTeamsChannel>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MsTeamsChannel>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MsTeamsChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MsTeamsChannel)} does not support '{format}' format.");
            }
