...
{
    public partial class MsTeamsChannel : Core.IUtf8JsonSerializable
    {
        ...
        internal static MsTeamsChannel DeserializeMsTeamsChannel(JsonElement element)
        {
            ...
            Core.Optional<MsTeamsChannelProperties> properties = default;
            ...
            return new MsTeamsChannel(channelName, Core.Optional.ToNullable(etag), provisioningState.Value, Core.Optional.ToNullable(location), properties.Value);
        }
    }
}
