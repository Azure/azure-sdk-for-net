...
{
    public partial class SlackChannel : Core.IUtf8JsonSerializable
    {
        ...
        internal static SlackChannel DeserializeSlackChannel(JsonElement element)
        {
            ...
            Core.Optional<SlackChannelProperties> properties = default;
            ...
            return new SlackChannel(channelName, Core.Optional.ToNullable(etag), provisioningState.Value, Core.Optional.ToNullable(location), properties.Value);
        }
    }
}
