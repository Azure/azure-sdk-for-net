...
{
    public partial class SlackChannel : IUtf8JsonSerializable
    {
        ...
        internal static SlackChannel DeserializeSlackChannel(JsonElement element)
        {
            ...
            return new SlackChannel(channelName, Optional.ToNullable(etag), provisioningState.Value, Optional.ToNullable(location), properties.Value);
        }
    }
}
