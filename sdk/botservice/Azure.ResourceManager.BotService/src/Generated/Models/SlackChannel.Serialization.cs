...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SlackChannel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SlackChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SlackChannel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SlackChannel>)} interface");
            }
        ...
        string IPersistableModel<SlackChannel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
