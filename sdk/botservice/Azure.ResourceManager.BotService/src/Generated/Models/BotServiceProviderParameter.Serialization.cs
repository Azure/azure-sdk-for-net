...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        internal static BotServiceProviderParameter DeserializeBotServiceProviderParameter(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
