...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class OutlookChannel : BotChannelProperties
    {
        ...
        internal OutlookChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, Dictionary<string, BinaryData> rawData) : base(channelName, etag, provisioningState, location, rawData)
        {
