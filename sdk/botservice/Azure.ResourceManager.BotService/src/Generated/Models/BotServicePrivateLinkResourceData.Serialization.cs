...
{
    public partial class BotServicePrivateLinkResourceData : IUtf8JsonSerializable, IJsonModel<BotServicePrivateLinkResourceData>, IPersistableModel<BotServicePrivateLinkResourceData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BotServicePrivateLinkResourceData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<BotServicePrivateLinkResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(BotServicePrivateLinkResourceData)} does not support '{format}' format.");
            }
