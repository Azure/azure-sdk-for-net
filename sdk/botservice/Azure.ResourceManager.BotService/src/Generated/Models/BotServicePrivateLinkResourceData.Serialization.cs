...
{
    public partial class BotServicePrivateLinkResourceData : Core.IUtf8JsonSerializable
    {
        ...
        internal static BotServicePrivateLinkResourceData DeserializeBotServicePrivateLinkResourceData(JsonElement element)
        {
            ...
            return new BotServicePrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
