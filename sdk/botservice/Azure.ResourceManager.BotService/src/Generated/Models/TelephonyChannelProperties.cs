...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class TelephonyChannelProperties
    {
        ...
        internal TelephonyChannelProperties(IList<TelephonyPhoneNumbers> phoneNumbers, IList<TelephonyChannelResourceApiConfiguration> apiConfigurations, string cognitiveServiceSubscriptionKey, string cognitiveServiceRegion, string defaultLocale, string premiumSku, bool? isEnabled, Dictionary<string, BinaryData> rawData)
        {
