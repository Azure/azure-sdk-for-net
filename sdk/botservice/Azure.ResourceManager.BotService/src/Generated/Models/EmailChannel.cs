...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class EmailChannel : BotChannelProperties
    {
        ...
        internal EmailChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, EmailChannelProperties properties, Dictionary<string, BinaryData> rawData) : base(channelName, etag, provisioningState, location, rawData)
        {
