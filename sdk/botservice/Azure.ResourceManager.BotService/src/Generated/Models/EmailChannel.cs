...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class EmailChannel : BotChannelProperties
    {
        ...
        internal EmailChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, EmailChannelProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
