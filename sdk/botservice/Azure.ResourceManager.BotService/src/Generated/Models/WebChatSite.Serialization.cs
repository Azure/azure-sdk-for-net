...
namespace Azure.ResourceManager.BotService.Models
{
    public partial class WebChatSite : IUtf8JsonSerializable, IModelJsonSerializable<WebChatSite>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<WebChatSite>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="WebChatSite"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="WebChatSite"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="WebChatSite"/>. </summary>
