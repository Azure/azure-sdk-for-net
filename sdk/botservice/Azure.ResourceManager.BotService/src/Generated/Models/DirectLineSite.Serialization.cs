...
{
    public partial class DirectLineSite : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DirectLineSite DeserializeDirectLineSite(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
