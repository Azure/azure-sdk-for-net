...
{
    public partial class LineChannelProperties : IUtf8JsonSerializable, IJsonModel<LineChannelProperties>, IPersistableModel<LineChannelProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(LineRegistrations))
            {
                builder.Append("  lineRegistrations:");
                builder.AppendLine(" [");
                foreach (var item in LineRegistrations)
                {
