...
namespace Azure.ResourceManager.BotService.Models
{
    public partial class SkypeChannel : IUtf8JsonSerializable, IModelJsonSerializable<SkypeChannel>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<SkypeChannel>(this, options.Format);
        ...
        internal static SkypeChannel DeserializeSkypeChannel(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new SkypeChannel(channelName, Optional.ToNullable(etag), provisioningState.Value, Optional.ToNullable(location), properties.Value, serializedAdditionalRawData);
        }
