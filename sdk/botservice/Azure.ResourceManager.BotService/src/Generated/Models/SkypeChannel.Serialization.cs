...
namespace Azure.ResourceManager.BotService.Models
{
    public partial class SkypeChannel : IUtf8JsonSerializable, IJsonModel<SkypeChannel>
    {
        ...
        void IJsonModel<SkypeChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SkypeChannel)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SkypeChannel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SkypeChannel)} does not support '{options.Format}' format.");
            }
        }
