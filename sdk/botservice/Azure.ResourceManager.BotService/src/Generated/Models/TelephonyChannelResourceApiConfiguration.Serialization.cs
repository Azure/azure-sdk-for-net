...
namespace Azure.ResourceManager.BotService.Models
{
    public partial class TelephonyChannelResourceApiConfiguration : IUtf8JsonSerializable, IJsonModel<TelephonyChannelResourceApiConfiguration>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<TelephonyChannelResourceApiConfiguration>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TelephonyChannelResourceApiConfiguration>)} interface");
            }
