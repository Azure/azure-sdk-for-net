...
{
    public partial class TelephonyChannelResourceApiConfiguration : IUtf8JsonSerializable, IJsonModel<TelephonyChannelResourceApiConfiguration>, IPersistableModel<TelephonyChannelResourceApiConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CognitiveServiceResourceId))
            {
                builder.Append("  cognitiveServiceResourceId:");
                builder.AppendLine($" '{CognitiveServiceResourceId.ToString()}'");
            }
