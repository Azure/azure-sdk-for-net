...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TelephonyChannel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TelephonyChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TelephonyChannel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TelephonyChannel>)} interface");
            }
        ...
        string IPersistableModel<TelephonyChannel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
