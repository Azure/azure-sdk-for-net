...
{
    public partial class SearchAssistant : Core.IUtf8JsonSerializable
    {
        ...
        internal static SearchAssistant DeserializeSearchAssistant(JsonElement element)
        {
            ...
            return new SearchAssistant(channelName, Core.Optional.ToNullable(etag), provisioningState.Value, Core.Optional.ToNullable(location));
        }
    }
}
