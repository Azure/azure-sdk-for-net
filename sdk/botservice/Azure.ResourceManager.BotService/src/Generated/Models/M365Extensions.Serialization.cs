...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<M365Extensions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<M365Extensions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<M365Extensions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<M365Extensions>)} interface");
            }
        ...
        string IPersistableModel<M365Extensions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
