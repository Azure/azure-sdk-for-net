...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class KikChannel : BotChannelProperties
    {
        ...
        internal KikChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, KikChannelProperties properties, Dictionary<string, BinaryData> rawData) : base(channelName, etag, provisioningState, location, rawData)
        {
