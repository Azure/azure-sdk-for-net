...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class KikChannel : BotChannelProperties
    {
        ...
        public KikChannel() : base("KikChannel")
        {
        }
        ...
        internal KikChannel(string channelName, ETag? eTag, string provisioningState, AzureLocation? location, IDictionary<string, BinaryData> additionalBinaryDataProperties, KikChannelProperties properties) : base(channelName, eTag, provisioningState, location, additionalBinaryDataProperties)
        {
