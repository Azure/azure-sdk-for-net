...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class KikChannel : BotChannelProperties
    {
        ...
        internal KikChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, IDictionary<string, BinaryData> serializedAdditionalRawData, KikChannelProperties properties) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
