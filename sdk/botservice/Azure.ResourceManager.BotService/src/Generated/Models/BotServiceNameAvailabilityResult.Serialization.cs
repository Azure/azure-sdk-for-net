...
{
    public partial class BotServiceNameAvailabilityResult : IUtf8JsonSerializable, IJsonModel<BotServiceNameAvailabilityResult>, IPersistableModel<BotServiceNameAvailabilityResult>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AbsCode))
            {
                builder.Append("  absCode:");
                builder.AppendLine($" '{AbsCode}'");
            }
