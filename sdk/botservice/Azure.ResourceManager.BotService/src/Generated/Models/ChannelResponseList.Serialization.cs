...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ChannelResponseList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ChannelResponseList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ChannelResponseList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ChannelResponseList>)} interface");
            }
        ...
        string IPersistableModel<ChannelResponseList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
