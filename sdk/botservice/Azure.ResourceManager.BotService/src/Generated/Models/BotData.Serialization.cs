...
{
    public partial class BotData : Core.IUtf8JsonSerializable
    {
        ...
        internal static BotData DeserializeBotData(JsonElement element)
        {
            ...
            Core.Optional<BotProperties> properties = default;
            ...
            return new BotData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, properties.Value, sku.Value, Core.Optional.ToNullable(kind), Core.Optional.ToNullable(etag), Core.Optional.ToList(zones));
        }
    }
}
