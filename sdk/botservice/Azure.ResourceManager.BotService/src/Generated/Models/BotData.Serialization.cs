...
{
    public partial class BotData : IUtf8JsonSerializable
    {
        ...
        internal static BotData DeserializeBotData(JsonElement element)
        {
            ...
            return new BotData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties.Value, sku.Value, Optional.ToNullable(kind), Optional.ToNullable(etag), Optional.ToList(zones));
        }
    }
}
