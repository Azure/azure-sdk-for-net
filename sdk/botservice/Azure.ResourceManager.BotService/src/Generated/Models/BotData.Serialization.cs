...
namespace Azure.ResourceManager.BotService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BotData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BotData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BotData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BotData>)} interface");
            }
        ...
        string IPersistableModel<BotData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
