...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    internal partial class UnknownChannel : BotChannelProperties
    {
        ...
        internal UnknownChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, Dictionary<string, BinaryData> rawData) : base(channelName, etag, provisioningState, location, rawData)
        {
