...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class BotConnectionSettingProperties
    {
        ...
        internal BotConnectionSettingProperties(string clientId, string settingId, string clientSecret, string scopes, string serviceProviderId, string serviceProviderDisplayName, IList<BotConnectionSettingParameter> parameters, string provisioningState, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ClientId = clientId;
            SettingId = settingId;
