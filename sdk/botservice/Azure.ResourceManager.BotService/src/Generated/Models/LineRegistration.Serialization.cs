...
{
    public partial class LineRegistration : IUtf8JsonSerializable, IJsonModel<LineRegistration>, IPersistableModel<LineRegistration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ChannelSecret))
            {
                builder.Append("  channelSecret:");
                builder.AppendLine($" '{ChannelSecret}'");
            }

            if (Optional.IsDefined(ChannelAccessToken))
            {
                builder.Append("  channelAccessToken:");
                builder.AppendLine($" '{ChannelAccessToken}'");
            }
