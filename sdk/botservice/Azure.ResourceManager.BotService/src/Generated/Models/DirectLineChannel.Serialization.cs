...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DirectLineChannel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DirectLineChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DirectLineChannel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DirectLineChannel>)} interface");
            }
        ...
        string IPersistableModel<DirectLineChannel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
