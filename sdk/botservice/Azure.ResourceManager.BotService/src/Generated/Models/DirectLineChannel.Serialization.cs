...
{
    public partial class DirectLineChannel : Core.IUtf8JsonSerializable
    {
        ...
        internal static DirectLineChannel DeserializeDirectLineChannel(JsonElement element)
        {
            ...
            Core.Optional<DirectLineChannelProperties> properties = default;
            ...
            return new DirectLineChannel(channelName, Core.Optional.ToNullable(etag), provisioningState.Value, Core.Optional.ToNullable(location), properties.Value);
        }
    }
}
