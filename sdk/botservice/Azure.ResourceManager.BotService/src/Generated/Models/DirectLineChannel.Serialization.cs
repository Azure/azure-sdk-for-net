...
{
    public partial class DirectLineChannel : IUtf8JsonSerializable, IJsonModel<DirectLineChannel>, IPersistableModel<DirectLineChannel>
    {
        ...
        void IJsonModel<DirectLineChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DirectLineChannel)} does not support '{format}' format.");
            }
