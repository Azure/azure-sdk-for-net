...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        internal static HostSettingsResponse DeserializeHostSettingsResponse(JsonElement element)
        {
            ...
            return new HostSettingsResponse(oAuthUrl.Value, toBotFromChannelOpenIdMetadataUrl.Value, toBotFromChannelTokenIssuer.Value, toBotFromEmulatorOpenIdMetadataUrl.Value, toChannelFromBotLoginUrl.Value, toChannelFromBotOAuthScope.Value, Optional.ToNullable(validateAuthority), botOpenIdMetadata.Value);
        }
    }
}
