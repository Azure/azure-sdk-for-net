...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class SearchAssistant : BotChannelProperties
    {
        ...
        internal SearchAssistant(string channelName, ETag? etag, string provisioningState, AzureLocation? location, Dictionary<string, BinaryData> rawData) : base(channelName, etag, provisioningState, location, rawData)
        {
