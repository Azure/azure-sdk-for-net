...
namespace Azure.ResourceManager.BotService.Models
{
    public partial class SmsChannelProperties : IUtf8JsonSerializable, IJsonModel<SmsChannelProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AccountSID))
            {
                builder.Append("  accountSID:");
                if (AccountSID.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{AccountSID}'''");
                }
                else
                {
                    builder.AppendLine($" '{AccountSID}'");
            ...
            if (Optional.IsDefined(AuthToken))
            {
                ...
                if (AuthToken.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{AuthToken}'''");
                }
                else
                {
                    builder.AppendLine($" '{AuthToken}'");
