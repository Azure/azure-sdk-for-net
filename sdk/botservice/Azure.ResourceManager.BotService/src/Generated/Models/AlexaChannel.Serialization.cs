...
{
    public partial class AlexaChannel : IUtf8JsonSerializable, IJsonModel<AlexaChannel>, IPersistableModel<AlexaChannel>
    {
        ...
        void IJsonModel<AlexaChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AlexaChannel)} does not support '{format}' format.");
            }
