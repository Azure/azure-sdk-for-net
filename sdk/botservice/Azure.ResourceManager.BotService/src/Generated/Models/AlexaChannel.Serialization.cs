...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AlexaChannel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AlexaChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AlexaChannel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AlexaChannel>)} interface");
            }
        ...
        string IPersistableModel<AlexaChannel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
