...
{
    public partial class TelegramChannel : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TelegramChannel DeserializeTelegramChannel(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
