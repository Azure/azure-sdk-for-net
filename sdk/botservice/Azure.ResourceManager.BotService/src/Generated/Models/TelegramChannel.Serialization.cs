...
{
    public partial class TelegramChannel : Core.IUtf8JsonSerializable
    {
        ...
        internal static TelegramChannel DeserializeTelegramChannel(JsonElement element)
        {
            ...
            Core.Optional<TelegramChannelProperties> properties = default;
            ...
            return new TelegramChannel(channelName, Core.Optional.ToNullable(etag), provisioningState.Value, Core.Optional.ToNullable(location), properties.Value);
        }
    }
}
