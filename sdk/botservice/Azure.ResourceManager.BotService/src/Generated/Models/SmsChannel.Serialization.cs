...
{
    public partial class SmsChannel : IUtf8JsonSerializable
    {
        ...
        internal static SmsChannel DeserializeSmsChannel(JsonElement element)
        {
            ...
            return new SmsChannel(channelName, Optional.ToNullable(etag), provisioningState.Value, Optional.ToNullable(location), properties.Value);
        }
    }
}
