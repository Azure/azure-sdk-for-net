...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SmsChannel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SmsChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SmsChannel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SmsChannel>)} interface");
            }
        ...
        string IPersistableModel<SmsChannel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
