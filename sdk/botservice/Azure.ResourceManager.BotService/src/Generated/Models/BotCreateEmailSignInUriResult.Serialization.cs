...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        internal static BotCreateEmailSignInUriResult DeserializeBotCreateEmailSignInUriResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
