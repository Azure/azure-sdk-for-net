...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BotCreateEmailSignInUriResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BotCreateEmailSignInUriResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BotCreateEmailSignInUriResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BotCreateEmailSignInUriResult>)} interface");
            }
        ...
        string IPersistableModel<BotCreateEmailSignInUriResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
