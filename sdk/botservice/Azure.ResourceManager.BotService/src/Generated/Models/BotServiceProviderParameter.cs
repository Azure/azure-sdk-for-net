...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class BotServiceProviderParameter
    {
        ...
        internal BotServiceProviderParameter(string name, string serviceProviderParameterType, string displayName, string description, Uri helpUri, string @default, ServiceProviderParameterMetadata metadata, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
