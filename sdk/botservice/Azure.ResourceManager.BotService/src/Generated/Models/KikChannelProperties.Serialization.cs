...
{
    public partial class KikChannelProperties : IUtf8JsonSerializable, IJsonModel<KikChannelProperties>, IPersistableModel<KikChannelProperties>
    {
        ...
        void IJsonModel<KikChannelProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(KikChannelProperties)} does not support '{format}' format.");
            }
