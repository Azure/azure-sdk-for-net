...
namespace Azure.ResourceManager.BotService.Models
{
    public partial class EmailChannel : IUtf8JsonSerializable, IJsonModel<EmailChannel>
    {
        ...
        void IJsonModel<EmailChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(EmailChannel)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<EmailChannel>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(EmailChannel)} does not support '{options.Format}' format.");
            }
        }
