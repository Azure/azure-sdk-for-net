...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EmailChannel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EmailChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EmailChannel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EmailChannel>)} interface");
            }
        ...
        string IPersistableModel<EmailChannel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
