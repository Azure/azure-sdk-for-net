...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class BotServiceProviderProperties
    {
        ...
        internal BotServiceProviderProperties(string id, string displayName, string serviceProviderName, Uri devPortalUri, Uri iconUri, IReadOnlyList<BotServiceProviderParameter> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
