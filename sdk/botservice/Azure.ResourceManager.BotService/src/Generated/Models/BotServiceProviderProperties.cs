...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class BotServiceProviderProperties
    {
        ...
        internal BotServiceProviderProperties(string id, string displayName, string serviceProviderName, Uri devPortalUri, Uri iconUri, IReadOnlyList<BotServiceProviderParameter> parameters, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
