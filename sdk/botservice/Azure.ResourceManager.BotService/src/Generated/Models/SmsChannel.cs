...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class SmsChannel : BotChannelProperties
    {
        ...
        internal SmsChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, SmsChannelProperties properties, Dictionary<string, BinaryData> rawData) : base(channelName, etag, provisioningState, location, rawData)
        {
