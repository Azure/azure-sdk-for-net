...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class SlackChannel : BotChannelProperties
    {
        ...
        internal SlackChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, SlackChannelProperties properties, Dictionary<string, BinaryData> rawData) : base(channelName, etag, provisioningState, location, rawData)
        {
