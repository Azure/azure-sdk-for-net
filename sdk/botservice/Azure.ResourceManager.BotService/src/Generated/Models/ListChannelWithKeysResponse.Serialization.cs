...
{
    public partial class ListChannelWithKeysResponse : IUtf8JsonSerializable
    {
        ...
        internal static ListChannelWithKeysResponse DeserializeListChannelWithKeysResponse(JsonElement element)
        {
            Optional<Channel> resource = default;
            Optional<ChannelSettings> setting = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("resource"))
                {
                    ...
                    resource = Channel.DeserializeChannel(property.Value);
                    continue;
                }
                if (property.NameEquals("setting"))
                {
                    ...
                    setting = ChannelSettings.DeserializeChannelSettings(property.Value);
                    continue;
                }
                ...
                if (property.NameEquals("entityTag"))
                {
            ...
            return new ListChannelWithKeysResponse(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource.Value, setting.Value, provisioningState.Value, entityTag.Value, changedTime.Value, properties.Value, sku.Value, Optional.ToNullable(kind), Optional.ToNullable(etag), Optional.ToList(zones));
        }
    }
}
