...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class DirectLineChannelProperties
    {
        ...
        internal DirectLineChannelProperties(IList<DirectLineSite> sites, string extensionKey1, string extensionKey2, string directLineEmbedCode, Dictionary<string, BinaryData> rawData)
        {
            Sites = sites;
