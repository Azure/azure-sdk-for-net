...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class FacebookChannelProperties
    {
        ...
        internal FacebookChannelProperties(string verifyToken, IList<FacebookPage> pages, string appId, string appSecret, Uri callbackUri, bool isEnabled, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
