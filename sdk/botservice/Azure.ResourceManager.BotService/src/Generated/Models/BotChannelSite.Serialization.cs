...
{
    public partial class BotChannelSite : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BotChannelSite DeserializeBotChannelSite(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
