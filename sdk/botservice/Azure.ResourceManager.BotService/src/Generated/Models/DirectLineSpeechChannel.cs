...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class DirectLineSpeechChannel : BotChannelProperties
    {
        ...
        internal DirectLineSpeechChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, DirectLineSpeechChannelProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
