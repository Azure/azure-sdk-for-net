...
{
    public partial class SkypeChannelProperties : IUtf8JsonSerializable, IJsonModel<SkypeChannelProperties>, IPersistableModel<SkypeChannelProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsMessagingEnabled))
            {
                builder.Append("  enableMessaging:");
                var boolValue = IsMessagingEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsMediaCardsEnabled))
            {
                builder.Append("  enableMediaCards:");
                var boolValue = IsMediaCardsEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsVideoEnabled))
            {
                builder.Append("  enableVideo:");
                var boolValue = IsVideoEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
            ...
            if (Optional.IsDefined(IsScreenSharingEnabled))
            {
                builder.Append("  enableScreenSharing:");
                var boolValue = IsScreenSharingEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsGroupsEnabled))
            {
                builder.Append("  enableGroups:");
                var boolValue = IsGroupsEnabled.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(GroupsMode))
            {
                builder.Append("  groupsMode:");
                builder.AppendLine($" '{GroupsMode}'");
            }
