...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class SkypeChannel : BotChannelProperties
    {
        ...
        internal SkypeChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, SkypeChannelProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
