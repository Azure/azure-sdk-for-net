...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class GetBotServiceQnAMakerEndpointKeyResult
    {
        ...
        internal GetBotServiceQnAMakerEndpointKeyResult(string primaryEndpointKey, string secondaryEndpointKey, string installedVersion, string lastStableVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
