...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BotServiceProviderProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BotServiceProviderProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BotServiceProviderProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BotServiceProviderProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
