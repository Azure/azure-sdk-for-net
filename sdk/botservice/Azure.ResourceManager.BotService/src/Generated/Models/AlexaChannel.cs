...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class AlexaChannel : BotChannelProperties
    {
        ...
        internal AlexaChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, AlexaChannelProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
