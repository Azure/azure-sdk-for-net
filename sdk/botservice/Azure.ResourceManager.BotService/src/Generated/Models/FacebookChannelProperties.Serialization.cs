...
namespace Azure.ResourceManager.BotService.Models
{
    public partial class FacebookChannelProperties : IUtf8JsonSerializable, IModelJsonSerializable<FacebookChannelProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<FacebookChannelProperties>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Pages))
            {
                ...
                foreach (var item in Pages)
                {
                    ...
                    {
                        ((IModelJsonSerializable<FacebookPage>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="FacebookChannelProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FacebookChannelProperties"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FacebookChannelProperties"/>. </summary>
