...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TelephonyChannelProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TelephonyChannelProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TelephonyChannelProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TelephonyChannelProperties>)} interface");
            }
        ...
        string IPersistableModel<TelephonyChannelProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
