...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class MsTeamsChannel : BotChannelProperties
    {
        ...
        internal MsTeamsChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, MsTeamsChannelProperties properties, Dictionary<string, BinaryData> rawData) : base(channelName, etag, provisioningState, location, rawData)
        {
