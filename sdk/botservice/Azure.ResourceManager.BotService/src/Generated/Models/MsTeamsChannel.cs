...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class MsTeamsChannel : BotChannelProperties
    {
        ...
        internal MsTeamsChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, MsTeamsChannelProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
