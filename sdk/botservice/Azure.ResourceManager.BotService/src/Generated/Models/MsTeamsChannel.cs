...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class MsTeamsChannel : BotChannelProperties
    {
        ...
        public MsTeamsChannel() : base("MsTeamsChannel")
        {
        }
        ...
        internal MsTeamsChannel(string channelName, ETag? eTag, string provisioningState, AzureLocation? location, IDictionary<string, BinaryData> additionalBinaryDataProperties, MsTeamsChannelProperties properties) : base(channelName, eTag, provisioningState, location, additionalBinaryDataProperties)
        {
