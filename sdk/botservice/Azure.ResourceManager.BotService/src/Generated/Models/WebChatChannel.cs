...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class WebChatChannel : BotChannelProperties
    {
        ...
        internal WebChatChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, WebChatChannelProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
