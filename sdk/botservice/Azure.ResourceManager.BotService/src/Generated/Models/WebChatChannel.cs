...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class WebChatChannel : BotChannelProperties
    {
        ...
        public WebChatChannel() : base("WebChatChannel")
        {
        }
        ...
        internal WebChatChannel(string channelName, ETag? eTag, string provisioningState, AzureLocation? location, IDictionary<string, BinaryData> additionalBinaryDataProperties, WebChatChannelProperties properties) : base(channelName, eTag, provisioningState, location, additionalBinaryDataProperties)
        {
