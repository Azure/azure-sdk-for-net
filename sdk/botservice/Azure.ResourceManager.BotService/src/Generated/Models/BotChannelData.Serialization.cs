...
{
    public partial class BotChannelData : Core.IUtf8JsonSerializable
    {
        ...
        internal static BotChannelData DeserializeBotChannelData(JsonElement element)
        {
            ...
            return new BotChannelData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, properties.Value, sku.Value, Core.Optional.ToNullable(kind), Core.Optional.ToNullable(etag), Core.Optional.ToList(zones));
        }
    }
}
