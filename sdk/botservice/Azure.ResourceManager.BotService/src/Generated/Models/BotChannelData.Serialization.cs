...
namespace Azure.ResourceManager.BotService
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BotChannelData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BotChannelData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BotChannelData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BotChannelData>)} interface");
            }
        ...
        string IPersistableModel<BotChannelData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
