...
namespace Azure.ResourceManager.BotService
{
    public partial class BotChannelData : IUtf8JsonSerializable, IJsonModel<BotChannelData>
    {
        ...
        void IJsonModel<BotChannelData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(BotChannelData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BotChannelData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BotChannelData)} does not support '{options.Format}' format.");
            }
        }
