...
{
    public partial class KikChannel : IUtf8JsonSerializable, IJsonModel<KikChannel>, IPersistableModel<KikChannel>
    {
        ...
        void IJsonModel<KikChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(KikChannel)} does not support '{format}' format.");
            }
