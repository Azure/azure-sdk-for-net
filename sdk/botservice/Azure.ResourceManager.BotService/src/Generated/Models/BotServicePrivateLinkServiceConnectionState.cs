...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class BotServicePrivateLinkServiceConnectionState
    {
        ...
        /// <summary> Initializes a new instance of <see cref="BotServicePrivateLinkServiceConnectionState"/>. </summary>
        ...
        internal BotServicePrivateLinkServiceConnectionState(BotServicePrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
