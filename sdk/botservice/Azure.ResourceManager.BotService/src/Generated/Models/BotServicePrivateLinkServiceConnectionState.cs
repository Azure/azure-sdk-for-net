...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class BotServicePrivateLinkServiceConnectionState
    {
        ...
        internal BotServicePrivateLinkServiceConnectionState(BotServicePrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired)
        {
            Status = status;
        ...
        public BotServicePrivateEndpointServiceConnectionStatus? Status { get; set; }
