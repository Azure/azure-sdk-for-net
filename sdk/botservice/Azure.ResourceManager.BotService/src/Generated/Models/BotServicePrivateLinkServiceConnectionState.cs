...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class BotServicePrivateLinkServiceConnectionState
    {
        ...
        internal BotServicePrivateLinkServiceConnectionState(BotServicePrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
