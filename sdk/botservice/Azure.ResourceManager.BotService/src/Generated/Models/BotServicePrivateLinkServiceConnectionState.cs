...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class BotServicePrivateLinkServiceConnectionState
    {
        ...
        internal BotServicePrivateLinkServiceConnectionState(BotServicePrivateEndpointServiceConnectionStatus? status, string description, string actionsRequired, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
