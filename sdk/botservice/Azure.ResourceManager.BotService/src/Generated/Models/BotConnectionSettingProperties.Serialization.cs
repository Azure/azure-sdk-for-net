...
{
    public partial class BotConnectionSettingProperties : IUtf8JsonSerializable, IJsonModel<BotConnectionSettingProperties>, IPersistableModel<BotConnectionSettingProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServiceProviderId))
            {
                ...
                builder.AppendLine($" '{ServiceProviderId}'");
            }

            if (Optional.IsDefined(ServiceProviderDisplayName))
            {
                builder.Append("  serviceProviderDisplayName:");
                builder.AppendLine($" '{ServiceProviderDisplayName}'");
            }
