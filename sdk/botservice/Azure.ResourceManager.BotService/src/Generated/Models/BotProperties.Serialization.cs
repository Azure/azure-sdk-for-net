...
{
    public partial class BotProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static BotProperties DeserializeBotProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
