...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BotProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BotProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BotProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BotProperties>)} interface");
            }
        ...
        string IPersistableModel<BotProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
