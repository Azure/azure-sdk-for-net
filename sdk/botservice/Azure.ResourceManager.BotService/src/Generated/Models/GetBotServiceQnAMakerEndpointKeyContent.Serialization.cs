...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetBotServiceQnAMakerEndpointKeyContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GetBotServiceQnAMakerEndpointKeyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GetBotServiceQnAMakerEndpointKeyContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GetBotServiceQnAMakerEndpointKeyContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
