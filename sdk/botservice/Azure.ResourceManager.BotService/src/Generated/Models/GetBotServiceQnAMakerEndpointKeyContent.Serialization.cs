...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetBotServiceQnAMakerEndpointKeyContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        GetBotServiceQnAMakerEndpointKeyContent IJsonModel<GetBotServiceQnAMakerEndpointKeyContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<GetBotServiceQnAMakerEndpointKeyContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        GetBotServiceQnAMakerEndpointKeyContent IModel<GetBotServiceQnAMakerEndpointKeyContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<GetBotServiceQnAMakerEndpointKeyContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
