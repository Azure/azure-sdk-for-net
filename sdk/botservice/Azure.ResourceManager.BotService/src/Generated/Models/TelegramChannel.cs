...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public partial class TelegramChannel : BotChannelProperties
    {
        ...
        internal TelegramChannel(string channelName, ETag? etag, string provisioningState, AzureLocation? location, TelegramChannelProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(channelName, etag, provisioningState, location, serializedAdditionalRawData)
        {
