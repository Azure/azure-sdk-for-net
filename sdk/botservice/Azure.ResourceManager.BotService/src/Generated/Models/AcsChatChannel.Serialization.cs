...
{
    public partial class AcsChatChannel : IUtf8JsonSerializable, IJsonModel<AcsChatChannel>, IPersistableModel<AcsChatChannel>
    {
        ...
        void IJsonModel<AcsChatChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AcsChatChannel)} does not support '{format}' format.");
            }
