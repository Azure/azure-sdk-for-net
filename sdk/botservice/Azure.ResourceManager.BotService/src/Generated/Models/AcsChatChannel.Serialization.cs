...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AcsChatChannel>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AcsChatChannel>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AcsChatChannel>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AcsChatChannel>)} interface");
            }
        ...
        string IPersistableModel<AcsChatChannel>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
