...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BotServiceSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BotServiceSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BotServiceSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<BotServiceSku>)} interface");
            }
        ...
        string IPersistableModel<BotServiceSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
