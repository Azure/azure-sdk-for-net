...
namespace Azure.ResourceManager.BotService.Models
{
    ...
    public static partial class ArmBotServiceModelFactory
    {
        ...
        public static BotData BotData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, BotProperties properties = null, BotServiceSku sku = null, BotServiceKind? kind = null, ETag? etag = null, IEnumerable<string> zones = null)
        {
            ...
            return new BotData(id, name, resourceType, systemData, tags, location, properties, sku, kind, etag, zones?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static BotServicePrivateEndpointConnectionData BotServicePrivateEndpointConnectionData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, ResourceIdentifier privateEndpointId = null, BotServicePrivateLinkServiceConnectionState connectionState = null, BotServicePrivateEndpointConnectionProvisioningState? provisioningState = null, IEnumerable<string> groupIds = null)
        {
            ...
            return new BotServicePrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, groupIds?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BotServiceSku(name, tier, new Dictionary<string, BinaryData>());
        }
        ...
        public static BotChannelData BotChannelData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, BotChannelProperties properties = null, BotServiceSku sku = null, BotServiceKind? kind = null, ETag? etag = null, IEnumerable<string> zones = null)
        {
            ...
            return new BotChannelData(id, name, resourceType, systemData, tags, location, properties, sku, kind, etag, zones?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownChannel(channelName, etag, provisioningState, location, new Dictionary<string, BinaryData>());
        }
        ...
        public static BotChannelGetWithKeysResult BotChannelGetWithKeysResult(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, BotChannelProperties resource = null, BotChannelSettings setting = null, string provisioningState = null, string entityTag = null, string changedTime = null, BotChannelProperties properties = null, BotServiceSku sku = null, BotServiceKind? kind = null, ETag? etag = null, IEnumerable<string> zones = null)
        {
            ...
            return new BotChannelGetWithKeysResult(id, name, resourceType, systemData, tags, location, resource, setting, provisioningState, entityTag, changedTime, properties, sku, kind, etag, zones?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BotCreateEmailSignInUriResult(id, location, createEmailSignInUrlResponseUri != null ? new CreateEmailSignInUrlResponseProperties(createEmailSignInUrlResponseUri, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BotServiceNameAvailabilityResult(isValid, message, absCode, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BotServiceProvider(properties, new Dictionary<string, BinaryData>());
        }
        ...
        public static BotServiceProviderProperties BotServiceProviderProperties(string id = null, string displayName = null, string serviceProviderName = null, Uri devPortalUri = null, Uri iconUri = null, IEnumerable<BotServiceProviderParameter> parameters = null)
        {
            ...
            return new BotServiceProviderProperties(id, displayName, serviceProviderName, devPortalUri, iconUri, parameters?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BotServiceProviderParameter(name, serviceProviderParameterType, displayName, description, helpUri, @default, isRequired != null ? new ServiceProviderParameterMetadata(new ServiceProviderParameterMetadataConstraints(isRequired, new Dictionary<string, BinaryData>()), new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GetBotServiceQnAMakerEndpointKeyResult(primaryEndpointKey, secondaryEndpointKey, installedVersion, lastStableVersion, new Dictionary<string, BinaryData>());
        }
        ...
        public static BotConnectionSettingData BotConnectionSettingData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, BotConnectionSettingProperties properties = null, BotServiceSku sku = null, BotServiceKind? kind = null, ETag? etag = null, IEnumerable<string> zones = null)
        {
            ...
            return new BotConnectionSettingData(id, name, resourceType, systemData, tags, location, properties, sku, kind, etag, zones?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static BotConnectionSettingProperties BotConnectionSettingProperties(string clientId = null, string settingId = null, string clientSecret = null, string scopes = null, string serviceProviderId = null, string serviceProviderDisplayName = null, IEnumerable<BotConnectionSettingParameter> parameters = null, string provisioningState = null)
        {
            ...
            return new BotConnectionSettingProperties(clientId, settingId, clientSecret, scopes, serviceProviderId, serviceProviderDisplayName, parameters?.ToList(), provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new BotServiceHostSettingsResult(oAuthUri, toBotFromChannelOpenIdMetadataUri, toBotFromChannelTokenIssuer, toBotFromEmulatorOpenIdMetadataUri, toChannelFromBotLoginUri, toChannelFromBotOAuthScope, validateAuthority, botOpenIdMetadata, new Dictionary<string, BinaryData>());
        }
        ...
        public static BotServicePrivateLinkResourceData BotServicePrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new BotServicePrivateLinkResourceData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AlexaChannel("AlexaChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new AlexaChannelProperties(alexaSkillId, uriFragment, serviceEndpointUri, isEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FacebookChannel("FacebookChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        public static FacebookChannelProperties FacebookChannelProperties(string verifyToken = null, IEnumerable<FacebookPage> pages = null, string appId = null, string appSecret = null, Uri callbackUri = null, bool isEnabled = default)
        {
            ...
            return new FacebookChannelProperties(verifyToken, pages?.ToList(), appId, appSecret, callbackUri, isEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EmailChannel("EmailChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new OutlookChannel("OutlookChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MsTeamsChannel("MsTeamsChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new SkypeChannel("SkypeChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new KikChannel("KikChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new WebChatChannel("WebChatChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        public static WebChatChannelProperties WebChatChannelProperties(string webChatEmbedCode = null, IEnumerable<WebChatSite> sites = null)
        {
            ...
            return new WebChatChannelProperties(webChatEmbedCode, sites?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DirectLineChannel("DirectLineChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new TelegramChannel("TelegramChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new SmsChannel("SmsChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new SlackChannel("SlackChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new SlackChannelProperties(clientId, clientSecret, verificationToken, scopes, landingPageUri, redirectAction, lastSubmissionId, registerBeforeOAuthFlow, isValidated, signingSecret, isEnabled, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LineChannel("LineChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        public static LineChannelProperties LineChannelProperties(IEnumerable<LineRegistration> lineRegistrations = null, Uri callbackUri = null, bool? isValidated = null)
        {
            ...
            return new LineChannelProperties(lineRegistrations?.ToList(), callbackUri, isValidated, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LineRegistration(generatedId, channelSecret, channelAccessToken, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new DirectLineSpeechChannel("DirectLineSpeechChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new Omnichannel("Omnichannel", etag, provisioningState, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new TelephonyChannel("TelephonyChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>(), properties);
        }
        ...
        {
            return new AcsChatChannel("AcsChatChannel", etag, provisioningState, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new SearchAssistant("SearchAssistant", etag, provisioningState, location, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new M365Extensions("M365Extensions", etag, provisioningState, location, new Dictionary<string, BinaryData>());
        }
    }
}
