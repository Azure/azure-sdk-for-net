...
namespace Azure.ResourceManager.BotService.Mocking
{
    ...
    internal partial class BotServiceArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="BotServiceArmClientMockingExtension"/> class for mocking. </summary>
        protected BotServiceArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="BotServiceArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal BotServiceArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal BotServiceArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
