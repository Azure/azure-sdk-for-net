...
namespace Azure.ResourceManager.BotService.Testing
{
    ...
    public partial class BotServiceTenantResourceExtension : ArmResource
    {
        private ClientDiagnostics _botClientDiagnostics;
        private BotsRestOperations _botRestClient;

        /// <summary> Initializes a new instance of the <see cref="BotServiceTenantResourceExtension"/> class for mocking. </summary>
        protected BotServiceTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="BotServiceTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal BotServiceTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<BotServiceNameAvailabilityResult>> CheckBotServiceNameAvailabilityAsync(BotServiceNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = BotClientDiagnostics.CreateScope("BotServiceTenantResourceExtension.CheckBotServiceNameAvailability");
            scope.Start();
            try
            {
