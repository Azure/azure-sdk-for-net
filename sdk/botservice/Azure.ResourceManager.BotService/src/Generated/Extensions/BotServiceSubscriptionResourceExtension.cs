...
namespace Azure.ResourceManager.BotService.Testing
{
    ...
    public partial class BotServiceSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="BotServiceSubscriptionResourceExtension"/> class for mocking. </summary>
        protected BotServiceSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="BotServiceSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal BotServiceSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<BotResource> GetBotsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new BotResource(Client, BotData.DeserializeBotData(e)), BotClientDiagnostics, Pipeline, "BotServiceSubscriptionResourceExtension.GetBots", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<BotResource> GetBots(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => BotRestClient.CreateListRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => BotRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new BotResource(Client, BotData.DeserializeBotData(e)), BotClientDiagnostics, Pipeline, "BotServiceSubscriptionResourceExtension.GetBots", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<BotServiceProvider> GetBotConnectionServiceProvidersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, BotServiceProvider.DeserializeBotServiceProvider, BotConnectionSettingBotConnectionClientDiagnostics, Pipeline, "BotServiceSubscriptionResourceExtension.GetBotConnectionServiceProviders", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => BotConnectionSettingBotConnectionRestClient.CreateListServiceProvidersRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, BotServiceProvider.DeserializeBotServiceProvider, BotConnectionSettingBotConnectionClientDiagnostics, Pipeline, "BotServiceSubscriptionResourceExtension.GetBotConnectionServiceProviders", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<GetBotServiceQnAMakerEndpointKeyResult>> GetBotServiceQnAMakerEndpointKeyAsync(GetBotServiceQnAMakerEndpointKeyContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = QnAMakerEndpointKeysClientDiagnostics.CreateScope("BotServiceSubscriptionResourceExtension.GetBotServiceQnAMakerEndpointKey");
            scope.Start();
            try
            {
        ...
        {
            using var scope = HostSettingsClientDiagnostics.CreateScope("BotServiceSubscriptionResourceExtension.GetBotServiceHostSettings");
            scope.Start();
            try
            {
