...
namespace Azure.ResourceManager.BotService.Mock
{
    ...
    public partial class SubscriptionResourceExtension : ArmResource
    {
        ...
        public virtual async Task<Response<GetBotServiceQnAMakerEndpointKeyResult>> GetBotServiceQnAMakerEndpointKeyAsync(GetBotServiceQnAMakerEndpointKeyContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = QnAMakerEndpointKeysClientDiagnostics.CreateScope("SubscriptionResourceExtension.GetBotServiceQnAMakerEndpointKey");
            scope.Start();
            try
            {
        ...
        {
            using var scope = HostSettingsClientDiagnostics.CreateScope("SubscriptionResourceExtension.GetBotServiceHostSettings");
            scope.Start();
            try
            {
