...
namespace Azure.ResourceManager.BotService.Mocking
{
    ...
    internal partial class BotServiceTenantMockingExtension : ArmResource
    {
        private ClientDiagnostics _botClientDiagnostics;
        private BotsRestOperations _botRestClient;

        /// <summary> Initializes a new instance of the <see cref="BotServiceTenantMockingExtension"/> class for mocking. </summary>
        protected BotServiceTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="BotServiceTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal BotServiceTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = BotClientDiagnostics.CreateScope("BotServiceTenantMockingExtension.CheckBotServiceNameAvailability");
            scope.Start();
            try
            {
