...
namespace Azure.ResourceManager.BotService.Mock
{
    ...
    public partial class BotConnectionSettingResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="BotConnectionSettingResourceExtension"/> class for mocking. </summary>
        protected BotConnectionSettingResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="BotConnectionSettingResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal BotConnectionSettingResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<BotServiceProvider> GetBotConnectionServiceProvidersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, BotServiceProvider.DeserializeBotServiceProvider, BotConnectionSettingBotConnectionClientDiagnostics, Pipeline, "BotConnectionSettingResourceExtension.GetBotConnectionServiceProviders", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => BotConnectionSettingBotConnectionRestClient.CreateListServiceProvidersRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, BotServiceProvider.DeserializeBotServiceProvider, BotConnectionSettingBotConnectionClientDiagnostics, Pipeline, "BotConnectionSettingResourceExtension.GetBotConnectionServiceProviders", "value", null, cancellationToken);
        }
    }
}
