...
namespace Azure.ResourceManager.BotService
{
    public partial class BotData : IUtf8JsonSerializable, IJsonModel<BotData>
    {
        ...
        internal static BotData DeserializeBotData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new BotData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties.Value, sku.Value, Optional.ToNullable(kind), Optional.ToNullable(etag), zones ?? new ChangeTrackingList<string>(), serializedAdditionalRawData);
        }
