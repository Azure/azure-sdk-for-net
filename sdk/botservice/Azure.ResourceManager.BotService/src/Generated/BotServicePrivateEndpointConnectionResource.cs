...
namespace Azure.ResourceManager.BotService
{
    ...
    public partial class BotServicePrivateEndpointConnectionResource : ArmResource
    {
        ...
        internal BotServicePrivateEndpointConnectionResource(ArmClient client, BotServicePrivateEndpointConnectionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
