    ...
    public partial class BotServicePrivateEndpointConnectionData : IUtf8JsonSerializable, IJsonModel<BotServicePrivateEndpointConnectionData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ConnectionState))
            {
                ...
                ((IJsonModel<BotServicePrivateLinkServiceConnectionState>)ConnectionState).Write(writer, options);
            }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("privateLinkServiceConnectionState"u8))
                        {
                            ...
                            privateLinkServiceConnectionState = ModelSerializationExtensions.JsonDeserialize<BotServicePrivateLinkServiceConnectionState>(property0.Value);
                            continue;
                        }
