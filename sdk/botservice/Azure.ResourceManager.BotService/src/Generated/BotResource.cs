...
namespace Azure.ResourceManager.BotService
{
    ...
    public partial class BotResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<BotResource>> UpdateAsync(WaitUntil waitUntil, BotData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
            ...
            try
            {
                ...
                HttpMessage message = _botsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, BotData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<BotData> response = Response.FromValue(BotData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<BotResource> Update(WaitUntil waitUntil, BotData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
