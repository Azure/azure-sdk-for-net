...
namespace Azure.ResourceManager.BotService
{
    ...
    public partial class BotResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Bots_CreateEmailSignInUri</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-09-15-preview</description>
        ...
        {
            using var scope = _botClientDiagnostics.CreateScope("BotResource.CreateEmailSignInUri");
            scope.Start();
            try
            {
                var response = await _botRestClient.CreateEmailSignInUriAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<BotCreateEmailSignInUriResult> CreateEmailSignInUri(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _botRestClient.CreateEmailSignInUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Bots_GetPrivateLinkResourcesByBotResource</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-09-15-preview</description>
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _botRestClient.CreateGetPrivateLinkResourcesByBotResourceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => BotServicePrivateLinkResourceData.DeserializeBotServicePrivateLinkResourceData(e), _botClientDiagnostics, Pipeline, "BotResource.GetPrivateLinkResourcesByBotResource", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _botRestClient.CreateGetPrivateLinkResourcesByBotResourceRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, null, e => BotServicePrivateLinkResourceData.DeserializeBotServicePrivateLinkResourceData(e), _botClientDiagnostics, Pipeline, "BotResource.GetPrivateLinkResourcesByBotResource", "value", null, cancellationToken);
        }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>BotChannels_GetBotChannelWithRegenerateKeys</description>
        /// </item>
        /// <item>
        /// <term>Default Api Version</term>
        /// <description>2023-09-15-preview</description>
        ...
        public virtual async Task<Response<BotChannelResource>> GetBotChannelWithRegenerateKeysAsync(RegenerateKeysBotChannelName channelName, BotChannelRegenerateKeysContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _botChannelClientDiagnostics.CreateScope("BotResource.GetBotChannelWithRegenerateKeys");
            scope.Start();
            try
            {
                var response = await _botChannelRestClient.GetBotChannelWithRegenerateKeysAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, channelName, content, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<BotChannelResource> GetBotChannelWithRegenerateKeys(RegenerateKeysBotChannelName channelName, BotChannelRegenerateKeysContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _botChannelRestClient.GetBotChannelWithRegenerateKeys(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, channelName, content, cancellationToken);
                return Response.FromValue(new BotChannelResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
