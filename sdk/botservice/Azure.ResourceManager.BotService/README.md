# Azure Bot Service Management client library for .NET
...
Install the Azure Bot Service management library for .NET with [NuGet](https://www.nuget.org/):

```dotnetcli
dotnet add package Azure.ResourceManager.BotService --prerelease
```
