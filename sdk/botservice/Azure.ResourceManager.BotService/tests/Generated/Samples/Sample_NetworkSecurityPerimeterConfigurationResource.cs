...
namespace Azure.ResourceManager.BotService.Samples
{
    public partial class Sample_NetworkSecurityPerimeterConfigurationResource
    {
        ...
        public async Task Get_GetNetworkSecurityPerimeterConfiguration()
        {
            ...
            ResourceIdentifier networkSecurityPerimeterConfigurationResourceId = NetworkSecurityPerimeterConfigurationResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, resourceName, networkSecurityPerimeterConfigurationName);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Reconcile_ReconcileNetworkSecurityPerimeterConfiguration()
        {
            // Generated from example definition: specification/botservice/resource-manager/Microsoft.BotService/preview/2023-09-15-preview/examples/ReconcileNetworkSecurityPerimeterConfiguration.json
