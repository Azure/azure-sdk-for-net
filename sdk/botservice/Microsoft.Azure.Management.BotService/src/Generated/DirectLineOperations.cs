...
namespace Microsoft.Azure.Management.BotService
{
    ...
    /// </summary>
    internal partial class DirectLineOperations : IServiceOperations<AzureBotServiceClient>, IDirectLineOperations
    {
        /// <summary>
        /// Initializes a new instance of the DirectLineOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal DirectLineOperations(AzureBotServiceClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<BotChannel>> RegenerateKeysWithHttpMessagesAsync(string resourceGroupName, string resourceName, RegenerateKeysChannelName channelName, SiteInfo parameters, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.BotService/botServices/{resourceName}/channels/{channelName}/regeneratekeys").ToString();
