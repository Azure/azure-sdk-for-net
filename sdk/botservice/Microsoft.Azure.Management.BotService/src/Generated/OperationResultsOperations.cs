...
namespace Microsoft.Azure.Management.BotService
{
    ...
    /// </summary>
    internal partial class OperationResultsOperations : IServiceOperations<AzureBotServiceClient>, IOperationResultsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal OperationResultsOperations(AzureBotServiceClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<OperationResultsDescription>> BeginGetWithHttpMessagesAsync(string operationResultId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/providers/Microsoft.BotService/operationresults/{operationResultId}").ToString();
