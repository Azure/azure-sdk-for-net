...
namespace Microsoft.Azure.Management.BotService
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<AzureBotServiceClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(AzureBotServiceClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<OperationEntity>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.BotService/operations").ToString();
