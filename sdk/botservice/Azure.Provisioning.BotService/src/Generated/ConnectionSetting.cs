...
namespace Azure.Provisioning.BotService
{
    ...
    public partial class ConnectionSetting : ProvisionableResource
    {
        ...
        /// <summary> Creates a new ConnectionSetting. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public ConnectionSetting(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.BotService/botServices/connections", resourceVersion ?? "2023-09-15-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for ConnectionSetting. </summary>
        ...
        /// <summary> Creates a reference to an existing ConnectionSetting. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static ConnectionSetting FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            ConnectionSetting result = new ConnectionSetting(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for ConnectionSetting that are not part of the generated code. </summary>
