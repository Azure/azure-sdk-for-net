...
namespace Azure.Provisioning.BotService
{
    ...
    public partial class BotServicePrivateEndpointConnection : ProvisionableResource
    {
        ...
        public BotServicePrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.BotService/botServices/privateEndpointConnections", resourceVersion ?? "2023-09-15-preview")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for BotServicePrivateEndpointConnection. </summary>
        ...
        /// <summary> Creates a reference to an existing BotServicePrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static BotServicePrivateEndpointConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            BotServicePrivateEndpointConnection result = new BotServicePrivateEndpointConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for BotServicePrivateEndpointConnection that are not part of the generated code. </summary>
