...
namespace Azure.Provisioning.BotService
{
    ...
    public partial class BotChannel : ProvisionableResource
    {
        ...
        private BotChannelProperties _properties;
        ...
        /// <summary> Define all the provisionable properties for BotChannel. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<BotChannelProperties>(nameof(Properties), new string[] { "properties" });
        ...
        /// <summary> Creates a reference to an existing BotChannel. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static BotChannel FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            BotChannel result = new BotChannel(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for BotChannel that are not part of the generated code. </summary>
