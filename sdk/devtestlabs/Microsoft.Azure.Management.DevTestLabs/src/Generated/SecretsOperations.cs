...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    internal partial class SecretsOperations : IServiceOperations<DevTestLabsClient>, ISecretsOperations
    {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<Secret>> GetWithHttpMessagesAsync(string resourceGroupName, string labName, string userName, string name, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
        ...
        /// The cancellation token.
        /// </param>
        public async Task<AzureOperationResponse<Secret>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string labName, string userName, string name, Secret secret, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            // Send Request
            AzureOperationResponse<Secret> _response = await BeginCreateOrUpdateWithHttpMessagesAsync(resourceGroupName, labName, userName, name, secret, customHeaders, cancellationToken).ConfigureAwait(false);
