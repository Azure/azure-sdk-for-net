...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    public static partial class ArtifactsOperationsExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<Artifact> GetAsync(this IArtifactsOperations operations, string resourceGroupName, string labName, string artifactSourceName, string name, CancellationToken cancellationToken = default(CancellationToken))
            {
