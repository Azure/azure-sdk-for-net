...
namespace Microsoft.Azure.Management.DevTestLabs
{
    ...
    internal partial class PolicySetsOperations : IServiceOperations<DevTestLabsClient>, IPolicySetsOperations
    {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<PolicySet>>> ListWithHttpMessagesAsync(string resourceGroupName, string labName, ODataQuery<PolicySet> odataQuery = default(ODataQuery<PolicySet>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/policysets").ToString();
            ...
            // Create Result
            var _result = new AzureOperationResponse<IPage<PolicySet>>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<PolicySet>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<IPage<PolicySet>>> ListNextWithHttpMessagesAsync(string nextPageLink, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
