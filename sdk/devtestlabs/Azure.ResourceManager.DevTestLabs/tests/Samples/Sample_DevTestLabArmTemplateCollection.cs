...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_DevTestLabArmTemplateCollection
    {
        ...
        public async Task Get_ArmTemplatesGet()
        {
            ...
            DevTestLabArmTemplateResource result = await collection.GetAsync(name);
        ...
        public async Task GetAll_ArmTemplatesList()
        {
            ...
            await foreach (DevTestLabArmTemplateResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                DevTestLabArmTemplateData resourceData = item.Data;
                // for demo we just print out the id
                Console.WriteLine($"Succeeded on id: {resourceData.Id}");
            }
