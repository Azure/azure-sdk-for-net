...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_DevTestLabServiceFabricScheduleResource
    {
        ...
        public async Task Get_ServiceFabricSchedulesGet()
        {
            ...
            DevTestLabServiceFabricScheduleResource labUserServicefabricSchedule = client.GetDevTestLabServiceFabricScheduleResource(DevTestLabServiceFabricScheduleResourceId);

            // invoke the operation
            DevTestLabServiceFabricScheduleResource result = await labUserServicefabricSchedule.GetAsync();
...
["tagName1"] = "tagValue1"
            ...
            DevTestLabServiceFabricScheduleResource result = await labUserServicefabricSchedule.UpdateAsync(patch);
