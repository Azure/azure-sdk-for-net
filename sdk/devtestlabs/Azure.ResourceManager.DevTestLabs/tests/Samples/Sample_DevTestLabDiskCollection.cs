...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_DevTestLabDiskCollection
    {
        ...
        public async Task Get_DisksGet()
        {
            ...
            // invoke the operation
            string name = "{diskName}";
            DevTestLabDiskResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_DisksGet()
        {
            ...
            // invoke the operation
            string name = "{diskName}";
            NullableResponse<DevTestLabDiskResource> response = await collection.GetIfExistsAsync(name);
            DevTestLabDiskResource result = response.HasValue ? response.Value : null;
