...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_ScheduleResource
    {
        ...
        public async Task Get_GlobalSchedulesGet()
        {
            ...
            ResourceIdentifier scheduleResourceId = DevTestLabGlobalScheduleResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, name);
            DevTestLabGlobalScheduleResource schedule = client.GetDevTestLabGlobalScheduleResource(scheduleResourceId);

            // invoke the operation
            DevTestLabGlobalScheduleResource result = await schedule.GetAsync();
...
["tagName1"] = "tagValue1"
            ...
            DevTestLabGlobalScheduleResource result = await schedule.UpdateAsync(patch);
