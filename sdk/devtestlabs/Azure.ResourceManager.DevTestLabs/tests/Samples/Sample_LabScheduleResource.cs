...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_LabScheduleResource
    {
        ...
        public async Task Get_SchedulesGet()
        {
            ...
            ResourceIdentifier labScheduleResourceId = DevTestLabScheduleResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, labName, name);
            DevTestLabScheduleResource labSchedule = client.GetDevTestLabScheduleResource(labScheduleResourceId);

            // invoke the operation
            DevTestLabScheduleResource result = await labSchedule.GetAsync();
...
["tagName1"] = "tagValue1"
            ...
            DevTestLabScheduleResource result = await labSchedule.UpdateAsync(patch);
