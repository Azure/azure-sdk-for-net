...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_ArtifactSourceCollection
    {
        ...
        public async Task CreateOrUpdate_ArtifactSourcesCreateOrUpdate()
        {
            ...
            ArtifactSourceCollection collection = lab.GetArtifactSources();

            // invoke the operation
            string name = "{artifactSourceName}";
            ArtifactSourceData data = new ArtifactSourceData(default)
            {
                Tags =
{
["tagName1"] = "tagValue1"
            ...
            ArmOperation<ArtifactSourceResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
        ...
        public async Task Get_ArtifactSourcesGet()
        {
            ...
            // invoke the operation
            string name = "{artifactSourceName}";
            ArtifactSourceResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_ArtifactSourcesGet()
        {
            ...
            // invoke the operation
            string name = "{artifactSourceName}";
            NullableResponse<ArtifactSourceResource> response = await collection.GetIfExistsAsync(name);
