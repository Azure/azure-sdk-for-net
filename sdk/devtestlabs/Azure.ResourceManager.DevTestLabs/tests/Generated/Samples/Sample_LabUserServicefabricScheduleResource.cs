...
["tagName1"] = "tagValue1"
            ...
            LabUserServicefabricScheduleResource result = await labUserServicefabricSchedule.UpdateAsync(schedule);
        ...
        public async Task Execute_ServiceFabricSchedulesExecute()
        {
            ...
            // invoke the operation
            ArmOperation<OkResponse> lro = await labUserServicefabricSchedule.ExecuteAsync(WaitUntil.Completed);
