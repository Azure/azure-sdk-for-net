...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_PolicyCollection
    {
        ...
        public async Task CreateOrUpdate_PoliciesCreateOrUpdate()
        {
            ...
            PolicyCollection collection = lab.GetPolicies(policySetName);

            // invoke the operation
            string name = "{policyName}";
            PolicyData data = new PolicyData(new AzureLocation("{location}"))
            {
                Tags =
{
["tagName1"] = "tagValue1"
            ...
            ArmOperation<PolicyResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
        ...
        public async Task Get_PoliciesGet()
        {
            ...
            // invoke the operation
            string name = "{policyName}";
            PolicyResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_PoliciesGet()
        {
            ...
            // invoke the operation
            string name = "{policyName}";
            NullableResponse<PolicyResource> response = await collection.GetIfExistsAsync(name);
