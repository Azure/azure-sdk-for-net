...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        public async Task GetLabs_LabsListBySubscription()
        {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetOperation_OperationsGet()
        {
            // Generated from example definition: 2018-09-15/Operations_Get.json
            // this example is just showing the usage of "Operations_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            OperationResult result = await subscriptionResource.GetOperationAsync(locationName, name);
