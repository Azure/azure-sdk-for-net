...
["tagName1"] = "tagValue1"
        ...
        public async Task GetIfExists_VirtualNetworksGet()
        {
            ...
            // invoke the operation
            string name = "{virtualNetworkName}";
            NullableResponse<DevTestLabVirtualNetworkResource> response = await collection.GetIfExistsAsync(name);
            DevTestLabVirtualNetworkResource result = response.HasValue ? response.Value : null;
