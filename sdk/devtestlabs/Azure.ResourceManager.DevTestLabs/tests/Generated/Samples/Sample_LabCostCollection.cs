...
{
    public partial class Sample_LabCostCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_CostsCreateOrUpdate()
        {
            ...
            // get the collection of this LabCostResource
            LabCostCollection collection = lab.GetLabCosts();

            // invoke the operation
            string name = "targetCost";
            LabCostData data = new LabCostData(default);
            ArmOperation<LabCostResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
        ...
        public async Task Get_CostsGet()
        {
            ...
            // invoke the operation
            string name = "targetCost";
            LabCostResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_CostsGet()
        {
            ...
            // invoke the operation
            string name = "targetCost";
            NullableResponse<LabCostResource> response = await collection.GetIfExistsAsync(name);
            LabCostResource result = response.HasValue ? response.Value : null;
