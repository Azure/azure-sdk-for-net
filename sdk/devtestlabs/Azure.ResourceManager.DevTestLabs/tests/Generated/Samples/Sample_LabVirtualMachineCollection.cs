...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_LabVirtualMachineCollection
    {
        ...
        public async Task CreateOrUpdate_VirtualMachinesCreateOrUpdate()
        {
            ...
            string name = "{vmName}";
            LabVirtualMachineData data = new LabVirtualMachineData(new AzureLocation("{location}"))
            {
                Tags =
{
["tagName1"] = "tagValue1"
            ...
            ArmOperation<LabVirtualMachineResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
            LabVirtualMachineResource result = lro.Value;
        ...
        public async Task Get_VirtualMachinesGet()
        {
            ...
            // invoke the operation
            string name = "{vmName}";
            LabVirtualMachineResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_VirtualMachinesGet()
        {
            ...
            // invoke the operation
            string name = "{vmName}";
            NullableResponse<LabVirtualMachineResource> response = await collection.GetIfExistsAsync(name);
            LabVirtualMachineResource result = response.HasValue ? response.Value : null;
