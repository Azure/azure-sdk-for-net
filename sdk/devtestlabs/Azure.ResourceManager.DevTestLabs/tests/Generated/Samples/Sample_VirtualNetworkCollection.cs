...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_VirtualNetworkCollection
    {
        ...
        public async Task CreateOrUpdate_VirtualNetworksCreateOrUpdate()
        {
            ...
            VirtualNetworkCollection collection = lab.GetVirtualNetworks();

            // invoke the operation
            string name = "{virtualNetworkName}";
            VirtualNetworkData data = new VirtualNetworkData(new AzureLocation("{location}"))
            {
                Tags =
{
["tagName1"] = "tagValue1"
            ...
            ArmOperation<VirtualNetworkResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
        ...
        public async Task Get_VirtualNetworksGet()
        {
            ...
            // invoke the operation
            string name = "{virtualNetworkName}";
            VirtualNetworkResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_VirtualNetworksGet()
        {
            ...
            // invoke the operation
            string name = "{virtualNetworkName}";
            NullableResponse<VirtualNetworkResource> response = await collection.GetIfExistsAsync(name);
