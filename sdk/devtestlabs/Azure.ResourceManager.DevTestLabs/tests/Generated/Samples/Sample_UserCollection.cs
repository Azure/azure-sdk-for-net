...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_UserCollection
    {
        ...
        public async Task CreateOrUpdate_UsersCreateOrUpdate()
        {
            ...
            UserCollection collection = lab.GetUsers();

            // invoke the operation
            string name = "{userName}";
            UserData data = new UserData(new AzureLocation("{location}"))
            {
                Tags =
{
["tagName1"] = "tagValue1"
            ...
            ArmOperation<UserResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
        ...
        public async Task Get_UsersGet()
        {
            ...
            // invoke the operation
            string name = "{userName}";
            UserResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_UsersGet()
        {
            ...
            // invoke the operation
            string name = "{userName}";
            NullableResponse<UserResource> response = await collection.GetIfExistsAsync(name);
