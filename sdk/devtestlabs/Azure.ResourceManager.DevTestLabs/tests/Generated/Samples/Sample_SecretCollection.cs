...
namespace Azure.ResourceManager.DevTestLabs.Samples
{
    public partial class Sample_SecretCollection
    {
        ...
        public async Task CreateOrUpdate_SecretsCreateOrUpdate()
        {
            ...
            SecretCollection collection = user.GetSecrets();

            // invoke the operation
            string name = "{secretName}";
            SecretData data = new SecretData(default);
            ArmOperation<SecretResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
        ...
        public async Task Get_SecretsGet()
        {
            ...
            // invoke the operation
            string name = "{secretName}";
            SecretResource result = await collection.GetAsync(name);
        ...
        public async Task GetIfExists_SecretsGet()
        {
            ...
            // invoke the operation
            string name = "{secretName}";
            NullableResponse<SecretResource> response = await collection.GetIfExistsAsync(name);
            SecretResource result = response.HasValue ? response.Value : null;
