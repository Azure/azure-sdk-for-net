    ...
    public partial class DevTestLabArtifactSourceCollection : ArmCollection, IEnumerable<DevTestLabArtifactSourceResource>, IAsyncEnumerable<DevTestLabArtifactSourceResource>
    {
        ...
        public virtual AsyncPageable<DevTestLabArtifactSourceResource> GetAllAsync(DevTestLabArtifactSourceCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<DevTestLabArtifactSourceResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _devTestLabArtifactSourceArtifactSourcesRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<DevTestLabArtifactSourceResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _devTestLabArtifactSourceArtifactSourcesRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabArtifactSourceResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<DevTestLabArtifactSourceResource> GetAll(DevTestLabArtifactSourceCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            Page<DevTestLabArtifactSourceResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _devTestLabArtifactSourceArtifactSourcesRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabArtifactSourceResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<DevTestLabArtifactSourceResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _devTestLabArtifactSourceArtifactSourcesRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabArtifactSourceResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
