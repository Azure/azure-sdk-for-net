    ...
    public partial class DevTestLabArtifactSourceCollection : ArmCollection, IEnumerable<DevTestLabArtifactSourceResource>, IAsyncEnumerable<DevTestLabArtifactSourceResource>
    {
        ...
        public virtual async Task<ArmOperation<DevTestLabArtifactSourceResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, DevTestLabArtifactSourceData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _artifactSourcesRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, DevTestLabArtifactSourceData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<DevTestLabArtifactSourceResource>> GetAsync(string name, string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _artifactSourcesRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, expand, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DevTestLabArtifactSourceData> response = Response.FromValue(DevTestLabArtifactSourceData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<DevTestLabArtifactSourceResource> GetAllAsync(string expand = default, string filter = default, int? top = default, string @orderby = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DevTestLabArtifactSourceData, DevTestLabArtifactSourceResource>(new ArtifactSourcesGetAllAsyncCollectionResultOfT(
                ...
                @orderby,
                context,
                "DevTestLabArtifactSourceCollection.GetAll"), data => new DevTestLabArtifactSourceResource(Client, data));
        }
