...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabEnvironmentResource : ArmResource
    {
        ...
        internal DevTestLabEnvironmentResource(ArmClient client, DevTestLabEnvironmentData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DevTestLabEnvironmentResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new DevTestLabEnvironmentResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
