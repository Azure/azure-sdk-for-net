...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabEnvironmentResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the DevTestLabEnvironment.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/users/{userName}/environments/{name}. </description>
        ...
        public virtual async Task<ArmOperation<DevTestLabEnvironmentResource>> UpdateAsync(WaitUntil waitUntil, DevTestLabEnvironmentData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _environmentsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, DevTestLabEnvironmentData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DevTestLabEnvironmentResource> Update(WaitUntil waitUntil, DevTestLabEnvironmentData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
