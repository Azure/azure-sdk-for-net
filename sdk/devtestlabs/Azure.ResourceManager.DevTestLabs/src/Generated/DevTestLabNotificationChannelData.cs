...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabNotificationChannelData : ResourceData
    {
        ...
        internal DevTestLabNotificationChannelData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, NotificationChannelProperties properties, IDictionary<string, string> tags, string location) : base(id, name, resourceType, systemData)
        {
