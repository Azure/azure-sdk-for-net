...
{
    public partial class LabCostData : IUtf8JsonSerializable, IJsonModel<LabCostData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabCostData>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<LabCostData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<LabCostData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LabCostData)} does not support writing '{format}' format.");
            }
        ...
        LabCostData IJsonModel<LabCostData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<LabCostData>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LabCostData)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeLabCostData(document.RootElement, options);
        }

        internal static LabCostData DeserializeLabCostData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            TargetCostProperties targetCost = default;
            LabCostSummaryProperties labCostSummary = default;
            IReadOnlyList<LabCostDetailsProperties> labCostDetails = default;
            IReadOnlyList<LabResourceCostProperties> resourceCosts = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("targetCost"u8))
                        {
                            ...
                            targetCost = TargetCostProperties.DeserializeTargetCostProperties(property0.Value, options);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("labCostDetails"u8))
                        {
                            ...
                            {
                                array.Add(LabCostDetailsProperties.DeserializeLabCostDetailsProperties(item, options));
                            }
                        ...
                        if (property0.NameEquals("resourceCosts"u8))
                        {
                            ...
                            foreach (var item in property0.Value.EnumerateArray())
                            {
                                array.Add(LabResourceCostProperties.DeserializeLabResourceCostProperties(item, options));
                            }
                            resourceCosts = array;
                            continue;
                        }
        ...
        BinaryData IPersistableModel<LabCostData>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<LabCostData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LabCostData)} does not support writing '{options.Format}' format.");
            }
        }

        LabCostData IPersistableModel<LabCostData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<LabCostData>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LabCostData)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<LabCostData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
