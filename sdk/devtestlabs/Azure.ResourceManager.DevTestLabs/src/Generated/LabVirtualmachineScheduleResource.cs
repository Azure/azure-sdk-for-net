...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class LabVirtualmachineScheduleResource : ArmResource
    {
        ...
        internal LabVirtualmachineScheduleResource(ArmClient client, ScheduleData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<LabVirtualmachineScheduleResource>> UpdateAsync(ScheduleFragment schedule, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="schedule"/> is null. </exception>
        public virtual Response<LabVirtualmachineScheduleResource> Update(ScheduleFragment schedule, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(schedule, nameof(schedule));
        ...
        public virtual async Task<ArmOperation> ExecuteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DevTestLabsArmOperation(_labVirtualmachineScheduleVirtualMachineSchedulesClientDiagnostics, Pipeline, _labVirtualmachineScheduleVirtualMachineSchedulesRestClient.CreateExecuteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.NotSpecified);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionResponseAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
