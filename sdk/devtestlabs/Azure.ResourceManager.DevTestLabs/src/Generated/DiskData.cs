...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DiskData : TrackedResourceData
    {
        ...
        internal DiskData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, StorageType? diskType, int? diskSizeGiB, string leasedByLabVmId, string diskBlobName, string diskUri, string storageAccountId, DateTimeOffset? createdOn, string hostCaching, string managedDiskId, string provisioningState, string uniqueIdentifier, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            DiskType = diskType;
