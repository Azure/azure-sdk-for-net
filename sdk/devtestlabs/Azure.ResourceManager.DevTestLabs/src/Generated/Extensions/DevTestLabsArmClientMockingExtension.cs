...
namespace Azure.ResourceManager.DevTestLabs.Mocking
{
    ...
    internal partial class DevTestLabsArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DevTestLabsArmClientMockingExtension"/> class for mocking. </summary>
        protected DevTestLabsArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DevTestLabsArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DevTestLabsArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal DevTestLabsArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
