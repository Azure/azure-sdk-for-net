...
namespace Azure.ResourceManager.DevTestLabs.Mocking
{
    ...
    internal partial class DevTestLabsResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DevTestLabsResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DevTestLabsResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DevTestLabsResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DevTestLabsResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
