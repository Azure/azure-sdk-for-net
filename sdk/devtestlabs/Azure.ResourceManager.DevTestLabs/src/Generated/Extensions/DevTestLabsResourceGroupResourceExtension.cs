...
namespace Azure.ResourceManager.DevTestLabs.Mock
{
    ...
    public partial class DevTestLabsResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DevTestLabsResourceGroupResourceExtension"/> class for mocking. </summary>
        protected DevTestLabsResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DevTestLabsResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DevTestLabsResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
