...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabCostData : ResourceData
    {
        ...
        internal DevTestLabCostData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, LabCostProperties properties, IDictionary<string, string> tags, string location) : base(id, name, resourceType, systemData)
        {
