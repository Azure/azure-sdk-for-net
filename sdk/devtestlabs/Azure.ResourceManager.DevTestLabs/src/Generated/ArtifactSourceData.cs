...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class ArtifactSourceData : TrackedResourceData
    {
        ...
        internal ArtifactSourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string displayName, string uri, SourceControlType? sourceType, string folderPath, string armTemplateFolderPath, string branchRef, string securityToken, EnableStatus? status, DateTimeOffset? createdOn, string provisioningState, string uniqueIdentifier, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
