...
namespace Azure.ResourceManager.DevTestLabs
{
    public partial class LabData : IUtf8JsonSerializable, IJsonModel<LabData>
    {
        ...
        internal static LabData DeserializeLabData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            StorageType? labStorageType = default;
            IList<string> mandatoryArtifactsResourceIdsLinux = default;
            IList<string> mandatoryArtifactsResourceIdsWindows = default;
            DateTimeOffset? createdDate = default;
            PremiumDataDisk? premiumDataDisks = default;
            EnvironmentPermission? environmentPermission = default;
            LabAnnouncementProperties announcement = default;
            LabSupportProperties support = default;
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("announcement"u8))
                        {
                            ...
                            announcement = LabAnnouncementProperties.DeserializeLabAnnouncementProperties(property0.Value, options);
                            continue;
                        }
                        if (property0.NameEquals("support"u8))
                        {
                            ...
                            support = LabSupportProperties.DeserializeLabSupportProperties(property0.Value, options);
                            continue;
                        }
