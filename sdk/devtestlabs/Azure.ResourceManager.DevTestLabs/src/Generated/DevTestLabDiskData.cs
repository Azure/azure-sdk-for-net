...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabDiskData : ResourceData
    {
        ...
        internal DevTestLabDiskData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DiskProperties properties, IDictionary<string, string> tags, string location) : base(id, name, resourceType, systemData)
        {
