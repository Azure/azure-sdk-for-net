...
{
    /// <summary> A class representing the ArmTemplate data model. </summary>
    public partial class ArmTemplateData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ArmTemplateData. </summary>
        /// <param name="location"> The location. </param>
        public ArmTemplateData(AzureLocation location) : base(location)
        {
