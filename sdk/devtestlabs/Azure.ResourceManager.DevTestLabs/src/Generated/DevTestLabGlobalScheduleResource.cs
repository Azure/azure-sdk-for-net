...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabGlobalScheduleResource : ArmResource
    {
        ...
        internal DevTestLabGlobalScheduleResource(ArmClient client, DevTestLabScheduleData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DevTestLabGlobalScheduleResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new DevTestLabGlobalScheduleResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
