...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabArtifactSourceData : ResourceData
    {
        ...
        internal DevTestLabArtifactSourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ArtifactSourceProperties properties, IDictionary<string, string> tags, string location) : base(id, name, resourceType, systemData)
        {
