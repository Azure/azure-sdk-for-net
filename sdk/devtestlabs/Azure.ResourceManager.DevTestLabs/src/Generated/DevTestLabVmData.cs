...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabVmData : ResourceData
    {
        ...
        internal DevTestLabVmData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, LabVirtualMachineProperties properties, IDictionary<string, string> tags, string location) : base(id, name, resourceType, systemData)
        {
