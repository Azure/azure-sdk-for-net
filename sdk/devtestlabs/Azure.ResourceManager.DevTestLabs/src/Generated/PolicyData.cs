...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class PolicyData : TrackedResourceData
    {
        ...
        internal PolicyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string description, PolicyStatus? status, PolicyFactName? factName, string factData, string threshold, PolicyEvaluatorType? evaluatorType, DateTimeOffset? createdOn, string provisioningState, string uniqueIdentifier, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
