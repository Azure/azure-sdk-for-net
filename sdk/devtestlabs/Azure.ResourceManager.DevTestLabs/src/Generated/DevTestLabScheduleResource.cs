...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabScheduleResource : ArmResource
    {
        ...
        internal DevTestLabScheduleResource(ArmClient client, DevTestLabScheduleData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DevTestLabScheduleResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new DevTestLabScheduleResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
