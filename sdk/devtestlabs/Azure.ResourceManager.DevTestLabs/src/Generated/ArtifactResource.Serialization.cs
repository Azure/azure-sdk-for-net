...
namespace Azure.ResourceManager.DevTestLabs
{
    public partial class ArtifactResource : IJsonModel<ArtifactData>
    {
        ...
        BinaryData IPersistableModel<ArtifactData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<ArtifactData>(Data, options, AzureResourceManagerDevTestLabsContext.Default);

        ArtifactData IPersistableModel<ArtifactData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<ArtifactData>(data, options, AzureResourceManagerDevTestLabsContext.Default);
