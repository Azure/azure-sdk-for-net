...
namespace Azure.ResourceManager.DevTestLabs
{
    public partial class DevTestLabCostResource : IJsonModel<DevTestLabCostData>
    {
        ...
        {
            return ModelReaderWriter.Read<DevTestLabCostData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<DevTestLabCostData>(data, options);
        }
