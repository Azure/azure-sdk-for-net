...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabUserResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DevTestLabUserResource>> UpdateAsync(WaitUntil waitUntil, DevTestLabUserData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _usersRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, DevTestLabUserData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DevTestLabsArmOperation<DevTestLabUserResource> operation = new DevTestLabsArmOperation<DevTestLabUserResource>(
                    new DevTestLabUserResourceOperationSource(Client),
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DevTestLabUserResource> Update(WaitUntil waitUntil, DevTestLabUserData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
