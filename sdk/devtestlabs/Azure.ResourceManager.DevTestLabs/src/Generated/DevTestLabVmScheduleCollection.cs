...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabVmScheduleCollection : ArmCollection, IEnumerable<DevTestLabVmScheduleResource>, IAsyncEnumerable<DevTestLabVmScheduleResource>
    {
        ...
        public virtual AsyncPageable<DevTestLabVmScheduleResource> GetAllAsync(DevTestLabVmScheduleCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new DevTestLabVmScheduleCollectionGetAllOptions();
            ...
            async Task<Page<DevTestLabVmScheduleResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _devTestLabVmScheduleVmSchedulesRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<DevTestLabVmScheduleResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _devTestLabVmScheduleVmSchedulesRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabVmScheduleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<DevTestLabVmScheduleResource> GetAll(DevTestLabVmScheduleCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new DevTestLabVmScheduleCollectionGetAllOptions();
            ...
            Page<DevTestLabVmScheduleResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _devTestLabVmScheduleVmSchedulesRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabVmScheduleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<DevTestLabVmScheduleResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _devTestLabVmScheduleVmSchedulesRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabVmScheduleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
