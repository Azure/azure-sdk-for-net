...
{
    /// <summary> A class representing the Artifact data model. </summary>
    public partial class ArtifactData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of ArtifactData. </summary>
        /// <param name="location"> The location. </param>
        public ArtifactData(AzureLocation location) : base(location)
        {
        }
