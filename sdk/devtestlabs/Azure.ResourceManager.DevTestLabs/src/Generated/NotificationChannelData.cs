...
{
    /// <summary>
    /// A class representing the NotificationChannel data model.
    /// A notification.
    /// </summary>
    public partial class NotificationChannelData : TrackedResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="NotificationChannelData"/>. </summary>
        ...
        internal NotificationChannelData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string webHookUri, string emailRecipient, string notificationLocale, string description, IList<Event> events, DateTimeOffset? createdOn, string provisioningState, string uniqueIdentifier, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="NotificationChannelData"/> for deserialization. </summary>
        internal NotificationChannelData()
        {
        }
