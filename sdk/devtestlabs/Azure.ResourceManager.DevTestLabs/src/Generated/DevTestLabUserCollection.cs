...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    /// Each <see cref="DevTestLabUserResource"/> in the collection will belong to the same instance of <see cref="ResourceGroupResource"/>.
    /// To get a <see cref="DevTestLabUserCollection"/> instance call the GetDevTestLabUsers method from an instance of <see cref="ResourceGroupResource"/>.
    /// </summary>
    public partial class DevTestLabUserCollection : ArmCollection, IEnumerable<DevTestLabUserResource>, IAsyncEnumerable<DevTestLabUserResource>
    {
        ...
        internal DevTestLabUserCollection(ArmClient client, ResourceIdentifier id, string labName) : base(client, id)
        {
        ...
        public virtual async Task<ArmOperation<DevTestLabUserResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, DevTestLabUserData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _usersRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, _labName, name, DevTestLabUserData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<DevTestLabUserResource>> GetAsync(string name, string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _usersRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, _labName, name, expand, context);
