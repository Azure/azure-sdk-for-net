...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabFormulaCollection : ArmCollection, IEnumerable<DevTestLabFormulaResource>, IAsyncEnumerable<DevTestLabFormulaResource>
    {
        ...
        public virtual AsyncPageable<DevTestLabFormulaResource> GetAllAsync(DevTestLabFormulaCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new DevTestLabFormulaCollectionGetAllOptions();
            ...
            async Task<Page<DevTestLabFormulaResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _devTestLabFormulaFormulasRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<DevTestLabFormulaResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _devTestLabFormulaFormulasRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabFormulaResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<DevTestLabFormulaResource> GetAll(DevTestLabFormulaCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new DevTestLabFormulaCollectionGetAllOptions();
            ...
            Page<DevTestLabFormulaResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _devTestLabFormulaFormulasRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabFormulaResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<DevTestLabFormulaResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _devTestLabFormulaFormulasRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabFormulaResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
