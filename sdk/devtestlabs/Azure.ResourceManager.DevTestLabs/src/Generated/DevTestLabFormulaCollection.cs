...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    /// Each <see cref="DevTestLabFormulaResource"/> in the collection will belong to the same instance of <see cref="ResourceGroupResource"/>.
    /// To get a <see cref="DevTestLabFormulaCollection"/> instance call the GetDevTestLabFormulas method from an instance of <see cref="ResourceGroupResource"/>.
    /// </summary>
    public partial class DevTestLabFormulaCollection : ArmCollection, IEnumerable<DevTestLabFormulaResource>, IAsyncEnumerable<DevTestLabFormulaResource>
    {
        ...
        internal DevTestLabFormulaCollection(ArmClient client, ResourceIdentifier id, string labName) : base(client, id)
        {
        ...
        public virtual async Task<ArmOperation<DevTestLabFormulaResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, DevTestLabFormulaData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _formulasRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, _labName, name, DevTestLabFormulaData.ToRequestContent(data), context);
        ...
        public virtual async Task<Response<DevTestLabFormulaResource>> GetAsync(string name, string expand = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _formulasRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, _labName, name, expand, context);
