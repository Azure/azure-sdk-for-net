...
namespace Azure.ResourceManager.DevTestLabs
{
    internal partial class DevTestLabSchedulesGetApplicableCollectionResultOfT : Pageable<DevTestLabScheduleData>
    {
        ...
        public DevTestLabSchedulesGetApplicableCollectionResultOfT(DevTestLabSchedules client, string subscriptionId, string resourceGroupName, string labName, string name, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
