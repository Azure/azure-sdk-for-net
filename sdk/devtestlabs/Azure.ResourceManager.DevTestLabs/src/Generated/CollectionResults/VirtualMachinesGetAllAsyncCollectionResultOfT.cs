...
{
    internal partial class VirtualMachinesGetAllAsyncCollectionResultOfT : AsyncPageable<DevTestLabVmData>
    {
        ...
        public VirtualMachinesGetAllAsyncCollectionResultOfT(VirtualMachines client, string subscriptionId, string resourceGroupName, string labName, string expand, string filter, int? top, string @orderby, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<DevTestLabVmData>> AsPages(string continuationToken, int? pageSizeHint)
        {
        ...
        private async ValueTask<Response> GetNextResponseAsync(int? pageSizeHint, Uri nextLink)
        {
            ...
            using DiagnosticScope scope = _client.ClientDiagnostics.CreateScope("MockableDevTestLabsResourceGroupResource.GetDevTestLabVms");
            scope.Start();
            try
            {
