...
namespace Azure.ResourceManager.DevTestLabs
{
    internal partial class VirtualMachinesGetAllAsyncCollectionResultOfT : AsyncPageable<DevTestLabVmData>
    {
        ...
        public VirtualMachinesGetAllAsyncCollectionResultOfT(VirtualMachines client, string subscriptionId, string resourceGroupName, string labName, string expand, string filter, int? top, string @orderby, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
