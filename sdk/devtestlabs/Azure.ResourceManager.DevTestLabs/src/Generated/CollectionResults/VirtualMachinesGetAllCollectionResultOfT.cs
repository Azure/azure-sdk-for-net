...
namespace Azure.ResourceManager.DevTestLabs
{
    internal partial class VirtualMachinesGetAllCollectionResultOfT : Pageable<DevTestLabVmData>
    {
        ...
        public VirtualMachinesGetAllCollectionResultOfT(VirtualMachines client, string subscriptionId, string resourceGroupName, string labName, string expand, string filter, int? top, string @orderby, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
