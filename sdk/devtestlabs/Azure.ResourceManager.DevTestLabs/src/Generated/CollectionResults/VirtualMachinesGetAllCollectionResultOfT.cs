...
{
    internal partial class VirtualMachinesGetAllCollectionResultOfT : Pageable<DevTestLabVmData>
    {
        ...
        public VirtualMachinesGetAllCollectionResultOfT(VirtualMachines client, string subscriptionId, string resourceGroupName, string labName, string expand, string filter, int? top, string @orderby, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<DevTestLabVmData>> AsPages(string continuationToken, int? pageSizeHint)
        {
