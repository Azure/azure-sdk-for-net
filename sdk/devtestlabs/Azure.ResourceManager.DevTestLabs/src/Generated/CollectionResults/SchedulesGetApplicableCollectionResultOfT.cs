...
{
    internal partial class SchedulesGetApplicableCollectionResultOfT : Pageable<DevTestLabScheduleData>
    {
        ...
        /// <summary> Initializes a new instance of SchedulesGetApplicableCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public SchedulesGetApplicableCollectionResultOfT(Schedules client, string subscriptionId, string resourceGroupName, string labName, string name, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of SchedulesGetApplicableCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SchedulesGetApplicableCollectionResultOfT as an enumerable collection. </returns>
