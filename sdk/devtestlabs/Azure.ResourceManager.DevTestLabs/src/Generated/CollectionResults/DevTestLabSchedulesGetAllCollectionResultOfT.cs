...
{
    internal partial class DevTestLabSchedulesGetAllCollectionResultOfT : Pageable<DevTestLabScheduleData>
    {
        ...
        /// <summary> Initializes a new instance of DevTestLabSchedulesGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public DevTestLabSchedulesGetAllCollectionResultOfT(DevTestLabSchedules client, string subscriptionId, string resourceGroupName, string labName, string expand, string filter, int? top, string @orderby, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of DevTestLabSchedulesGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of DevTestLabSchedulesGetAllCollectionResultOfT as an enumerable collection. </returns>
