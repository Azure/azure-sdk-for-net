...
namespace Azure.ResourceManager.DevTestLabs
{
    internal partial class SecretsGetAllAsyncCollectionResultOfT : AsyncPageable<DevTestLabSecretData>
    {
        ...
        public SecretsGetAllAsyncCollectionResultOfT(Secrets client, string subscriptionId, string resourceGroupName, string labName, string userName, string expand, string filter, int? top, string @orderby, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
