...
{
    internal partial class SecretsGetAllCollectionResultOfT : Pageable<DevTestLabSecretData>
    {
        ...
        public SecretsGetAllCollectionResultOfT(Secrets client, string subscriptionId, string resourceGroupName, string labName, string userName, string expand, string filter, int? top, string @orderby, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<DevTestLabSecretData>> AsPages(string continuationToken, int? pageSizeHint)
        {
