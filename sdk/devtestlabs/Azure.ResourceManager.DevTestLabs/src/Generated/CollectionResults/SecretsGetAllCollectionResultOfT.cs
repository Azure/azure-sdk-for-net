...
namespace Azure.ResourceManager.DevTestLabs
{
    internal partial class SecretsGetAllCollectionResultOfT : Pageable<DevTestLabSecretData>
    {
        ...
        public SecretsGetAllCollectionResultOfT(Secrets client, string subscriptionId, string resourceGroupName, string labName, string userName, string expand, string filter, int? top, string @orderby, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
