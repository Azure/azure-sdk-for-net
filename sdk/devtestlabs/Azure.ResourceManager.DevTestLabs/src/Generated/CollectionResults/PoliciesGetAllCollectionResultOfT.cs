...
namespace Azure.ResourceManager.DevTestLabs
{
    internal partial class PoliciesGetAllCollectionResultOfT : Pageable<DevTestLabPolicyData>
    {
        ...
        public PoliciesGetAllCollectionResultOfT(Policies client, string subscriptionId, string resourceGroupName, string labName, string policySetName, string expand, string filter, int? top, string @orderby, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
