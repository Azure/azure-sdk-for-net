...
namespace Azure.ResourceManager.DevTestLabs
{
    internal partial class DevTestLabGlobalSchedulesGetBySubscriptionAsyncCollectionResultOfT : AsyncPageable<DevTestLabScheduleData>
    {
        ...
        public DevTestLabGlobalSchedulesGetBySubscriptionAsyncCollectionResultOfT(DevTestLabGlobalSchedules client, string subscriptionId, string expand, string filter, int? top, string @orderby, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
