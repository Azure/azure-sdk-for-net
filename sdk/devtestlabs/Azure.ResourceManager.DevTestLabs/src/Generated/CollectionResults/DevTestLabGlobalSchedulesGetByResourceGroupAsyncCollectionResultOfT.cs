...
namespace Azure.ResourceManager.DevTestLabs
{
    internal partial class DevTestLabGlobalSchedulesGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<DevTestLabScheduleData>
    {
        ...
        public DevTestLabGlobalSchedulesGetByResourceGroupAsyncCollectionResultOfT(DevTestLabGlobalSchedules client, string subscriptionId, string resourceGroupName, string expand, string filter, int? top, string @orderby, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
