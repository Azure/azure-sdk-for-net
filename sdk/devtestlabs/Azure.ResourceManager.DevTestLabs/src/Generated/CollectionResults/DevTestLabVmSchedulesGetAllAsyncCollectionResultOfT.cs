...
namespace Azure.ResourceManager.DevTestLabs
{
    internal partial class DevTestLabVmSchedulesGetAllAsyncCollectionResultOfT : AsyncPageable<DevTestLabScheduleData>
    {
        ...
        public DevTestLabVmSchedulesGetAllAsyncCollectionResultOfT(DevTestLabVmSchedules client, string subscriptionId, string resourceGroupName, string labName, string virtualMachineName, string expand, string filter, int? top, string @orderby, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
