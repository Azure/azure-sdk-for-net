...
{
    /// <summary>
    /// A class representing the CustomImage data model.
    /// A custom image.
    /// </summary>
    public partial class CustomImageData : TrackedResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CustomImageData"/>. </summary>
        ...
        internal CustomImageData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, CustomImagePropertiesFromVm vm, CustomImagePropertiesCustom vhd, string description, string author, DateTimeOffset? createdOn, string managedImageId, string managedSnapshotId, IList<DataDiskStorageTypeInfo> dataDiskStorageInfo, CustomImagePropertiesFromPlan customImagePlan, bool? isPlanAuthorized, string provisioningState, string uniqueIdentifier, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
            Vm = vm;
            Vhd = vhd;
        ...
        /// <summary> Initializes a new instance of <see cref="CustomImageData"/> for deserialization. </summary>
        internal CustomImageData()
        {
        }
