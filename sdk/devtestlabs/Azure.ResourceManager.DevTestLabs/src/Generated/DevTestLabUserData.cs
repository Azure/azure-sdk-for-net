...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabUserData : ResourceData
    {
        ...
        internal DevTestLabUserData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, UserProperties properties, IDictionary<string, string> tags, string location) : base(id, name, resourceType, systemData)
        {
