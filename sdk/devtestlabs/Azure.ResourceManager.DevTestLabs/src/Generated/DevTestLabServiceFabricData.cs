...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabServiceFabricData : ResourceData
    {
        ...
        internal DevTestLabServiceFabricData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ServiceFabricProperties properties, IDictionary<string, string> tags, string location) : base(id, name, resourceType, systemData)
        {
