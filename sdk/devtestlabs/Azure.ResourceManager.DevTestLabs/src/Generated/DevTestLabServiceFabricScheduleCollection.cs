    ...
    public partial class DevTestLabServiceFabricScheduleCollection : ArmCollection, IEnumerable<DevTestLabServiceFabricScheduleResource>, IAsyncEnumerable<DevTestLabServiceFabricScheduleResource>
    {
        ...
        public virtual AsyncPageable<DevTestLabServiceFabricScheduleResource> GetAllAsync(DevTestLabServiceFabricScheduleGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<DevTestLabServiceFabricScheduleResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _devTestLabServiceFabricScheduleServiceFabricSchedulesRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<DevTestLabServiceFabricScheduleResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _devTestLabServiceFabricScheduleServiceFabricSchedulesRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabServiceFabricScheduleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<DevTestLabServiceFabricScheduleResource> GetAll(DevTestLabServiceFabricScheduleGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            Page<DevTestLabServiceFabricScheduleResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _devTestLabServiceFabricScheduleServiceFabricSchedulesRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabServiceFabricScheduleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<DevTestLabServiceFabricScheduleResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _devTestLabServiceFabricScheduleServiceFabricSchedulesRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabServiceFabricScheduleResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
