...
{
    /// <summary>
    /// A class representing the LabCost data model.
    /// A cost item.
    /// </summary>
    public partial class LabCostData : TrackedResourceData
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="LabCostData"/>. </summary>
        /// <param name="location"> The location. </param>
        public LabCostData(AzureLocation location) : base(location)
        {
        ...
        internal LabCostData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, TargetCostProperties targetCost, LabCostSummaryProperties labCostSummary, IReadOnlyList<LabCostDetailsProperties> labCostDetails, IReadOnlyList<LabResourceCostProperties> resourceCosts, string currencyCode, DateTimeOffset? startOn, DateTimeOffset? endOn, DateTimeOffset? createdOn, string provisioningState, string uniqueIdentifier, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData, tags, location)
        {
        ...
        /// <summary> Initializes a new instance of <see cref="LabCostData"/> for deserialization. </summary>
        internal LabCostData()
        {
        }
