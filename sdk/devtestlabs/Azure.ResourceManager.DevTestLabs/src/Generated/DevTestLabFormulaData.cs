...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabFormulaData : ResourceData
    {
        ...
        internal DevTestLabFormulaData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, FormulaProperties properties, IDictionary<string, string> tags, string location) : base(id, name, resourceType, systemData)
        {
