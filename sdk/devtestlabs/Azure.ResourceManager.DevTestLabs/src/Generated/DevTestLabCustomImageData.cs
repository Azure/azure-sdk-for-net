...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabCustomImageData : ResourceData
    {
        ...
        internal DevTestLabCustomImageData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CustomImageProperties properties, IDictionary<string, string> tags, string location) : base(id, name, resourceType, systemData)
        {
