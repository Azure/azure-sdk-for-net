    ...
    public partial class NotificationChannelCollection : ArmCollection, IEnumerable<NotificationChannelResource>, IAsyncEnumerable<NotificationChannelResource>
    {
        ...
        public virtual async Task<ArmOperation<NotificationChannelResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string name, NotificationChannelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var uri = _notificationChannelRestClient.CreateCreateOrUpdateRequestUri(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, data);
                var rehydrationToken = NextLinkOperationImplementation.GetRehydrationToken(RequestMethod.Put, uri.ToUri(), uri.ToString(), "None", null, OperationFinalStateVia.OriginalUri.ToString());
                var operation = new DevTestLabsArmOperation<NotificationChannelResource>(Response.FromValue(new NotificationChannelResource(Client, response), response.GetRawResponse()), rehydrationToken);
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _notificationChannelRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, expand, filter, top, orderby);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _notificationChannelRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, expand, filter, top, orderby);
            return GeneratorPageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new NotificationChannelResource(Client, NotificationChannelData.DeserializeNotificationChannelData(e)), _notificationChannelClientDiagnostics, Pipeline, "NotificationChannelCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<NotificationChannelResource> GetAll(string expand = null, string filter = null, int? top = null, string orderby = null, CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _notificationChannelRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, expand, filter, top, orderby);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _notificationChannelRestClient.CreateListNextPageRequest(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, expand, filter, top, orderby);
            return GeneratorPageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new NotificationChannelResource(Client, NotificationChannelData.DeserializeNotificationChannelData(e)), _notificationChannelClientDiagnostics, Pipeline, "NotificationChannelCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        public virtual async Task<NullableResponse<NotificationChannelResource>> GetIfExistsAsync(string name, string expand = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));

            using var scope = _notificationChannelClientDiagnostics.CreateScope("NotificationChannelCollection.GetIfExists");
            scope.Start();
            try
            {
                var response = await _notificationChannelRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, name, expand, cancellationToken: cancellationToken).ConfigureAwait(false);
                if (response.Value == null)
                    return new NoValueResponse<NotificationChannelResource>(response.GetRawResponse());
                return Response.FromValue(new NotificationChannelResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <exception cref="ArgumentException"> <paramref name="name"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="name"/> is null. </exception>
        public virtual NullableResponse<NotificationChannelResource> GetIfExists(string name, string expand = null, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(name, nameof(name));
