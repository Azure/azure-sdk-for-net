...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="UserResource"/> using the GetDisk method.
    /// </summary>
    public partial class DiskResource : ArmResource
    {
        ...
        {
            _diskClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.DevTestLabs", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<DiskResource>> GetAsync(string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _diskClientDiagnostics.CreateScope("DiskResource.Get");
            scope.Start();
            try
            {
                var response = await _diskRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, expand, cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="expand"> Specify the $expand query. Example: 'properties($select=diskType)'. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DiskResource> Get(string expand = null, CancellationToken cancellationToken = default)
        {
            using var scope = _diskClientDiagnostics.CreateScope("DiskResource.Get");
            scope.Start();
            try
            {
                var response = _diskRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, expand, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DiskResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response<DiskResource>> UpdateAsync(DiskPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _diskRestClient.UpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new DiskResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="patch"/> is null. </exception>
        public virtual Response<DiskResource> Update(DiskPatch patch, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(patch, nameof(patch));
            ...
            try
            {
                var response = _diskRestClient.Update(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch, cancellationToken);
                return Response.FromValue(new DiskResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<ArmOperation<OkResponse>> AttachAsync(WaitUntil waitUntil, AttachDiskProperties attachDiskProperties, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(attachDiskProperties, nameof(attachDiskProperties));

            using var scope = _diskClientDiagnostics.CreateScope("DiskResource.Attach");
            scope.Start();
            try
            {
                ...
                var operation = new DevTestLabsArmOperation<OkResponse>(new OkResponseOperationSource(), _diskClientDiagnostics, Pipeline, _diskRestClient.CreateAttachRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, attachDiskProperties).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="attachDiskProperties"/> is null. </exception>
        public virtual ArmOperation<OkResponse> Attach(WaitUntil waitUntil, AttachDiskProperties attachDiskProperties, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(attachDiskProperties, nameof(attachDiskProperties));
        ...
        public virtual async Task<ArmOperation<OkResponse>> DetachAsync(WaitUntil waitUntil, DetachDiskProperties detachDiskProperties, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(detachDiskProperties, nameof(detachDiskProperties));

            using var scope = _diskClientDiagnostics.CreateScope("DiskResource.Detach");
            scope.Start();
            try
            {
                ...
                var operation = new DevTestLabsArmOperation<OkResponse>(new OkResponseOperationSource(), _diskClientDiagnostics, Pipeline, _diskRestClient.CreateDetachRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, detachDiskProperties).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
                    await operation.WaitForCompletionAsync(cancellationToken).ConfigureAwait(false);
                return operation;
            }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="detachDiskProperties"/> is null. </exception>
        public virtual ArmOperation<OkResponse> Detach(WaitUntil waitUntil, DetachDiskProperties detachDiskProperties, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(detachDiskProperties, nameof(detachDiskProperties));
        ...
        public virtual async Task<Response<DiskResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _diskRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, null, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DiskResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _diskRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, null, cancellationToken);
                    return Response.FromValue(new DiskResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
