...
{
    /// <summary></summary>
    internal partial class DevTestLabCustomImageResourceOperationSource : IOperationSource<DevTestLabCustomImageResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevTestLabCustomImageResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        DevTestLabCustomImageResource IOperationSource<DevTestLabCustomImageResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            DevTestLabCustomImageData data = DevTestLabCustomImageData.DeserializeDevTestLabCustomImageData(document.RootElement, ModelSerializationExtensions.WireOptions);
