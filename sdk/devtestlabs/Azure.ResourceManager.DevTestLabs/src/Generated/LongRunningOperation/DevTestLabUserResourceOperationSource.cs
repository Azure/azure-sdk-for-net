...
{
    /// <summary></summary>
    internal partial class DevTestLabUserResourceOperationSource : IOperationSource<DevTestLabUserResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevTestLabUserResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
