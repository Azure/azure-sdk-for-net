...
{
    /// <summary></summary>
    internal partial class DevTestLabVirtualNetworkResourceOperationSource : IOperationSource<DevTestLabVirtualNetworkResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevTestLabVirtualNetworkResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
