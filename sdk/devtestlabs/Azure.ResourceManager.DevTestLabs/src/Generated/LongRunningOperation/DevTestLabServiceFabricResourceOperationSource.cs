...
{
    /// <summary></summary>
    internal partial class DevTestLabServiceFabricResourceOperationSource : IOperationSource<DevTestLabServiceFabricResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevTestLabServiceFabricResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
