...
{
    /// <summary></summary>
    internal partial class DevTestLabDiskResourceOperationSource : IOperationSource<DevTestLabDiskResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevTestLabDiskResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
