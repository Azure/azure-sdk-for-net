...
{
    /// <summary></summary>
    internal partial class DevTestLabFormulaResourceOperationSource : IOperationSource<DevTestLabFormulaResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevTestLabFormulaResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
