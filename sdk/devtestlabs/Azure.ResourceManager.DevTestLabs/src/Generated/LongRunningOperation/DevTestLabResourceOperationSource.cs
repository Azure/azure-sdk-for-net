...
{
    /// <summary></summary>
    internal partial class DevTestLabResourceOperationSource : IOperationSource<DevTestLabResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevTestLabResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
