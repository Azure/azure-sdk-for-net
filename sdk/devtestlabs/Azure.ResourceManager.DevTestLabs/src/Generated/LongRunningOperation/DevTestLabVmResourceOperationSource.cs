...
{
    /// <summary></summary>
    internal partial class DevTestLabVmResourceOperationSource : IOperationSource<DevTestLabVmResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevTestLabVmResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
