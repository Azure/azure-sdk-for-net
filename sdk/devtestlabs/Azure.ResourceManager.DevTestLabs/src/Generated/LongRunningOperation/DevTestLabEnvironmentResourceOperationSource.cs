...
{
    /// <summary></summary>
    internal partial class DevTestLabEnvironmentResourceOperationSource : IOperationSource<DevTestLabEnvironmentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevTestLabEnvironmentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
