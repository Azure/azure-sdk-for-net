...
{
    /// <summary></summary>
    internal partial class DevTestLabSecretResourceOperationSource : IOperationSource<DevTestLabSecretResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DevTestLabSecretResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
