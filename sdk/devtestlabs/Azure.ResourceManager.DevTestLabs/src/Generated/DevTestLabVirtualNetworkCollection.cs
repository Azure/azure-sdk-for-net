...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabVirtualNetworkCollection : ArmCollection, IEnumerable<DevTestLabVirtualNetworkResource>, IAsyncEnumerable<DevTestLabVirtualNetworkResource>
    {
        ...
        public virtual AsyncPageable<DevTestLabVirtualNetworkResource> GetAllAsync(DevTestLabVirtualNetworkCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new DevTestLabVirtualNetworkCollectionGetAllOptions();
            ...
            async Task<Page<DevTestLabVirtualNetworkResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _devTestLabVirtualNetworkVirtualNetworksRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<DevTestLabVirtualNetworkResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _devTestLabVirtualNetworkVirtualNetworksRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabVirtualNetworkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<DevTestLabVirtualNetworkResource> GetAll(DevTestLabVirtualNetworkCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            options ??= new DevTestLabVirtualNetworkCollectionGetAllOptions();
            ...
            Page<DevTestLabVirtualNetworkResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _devTestLabVirtualNetworkVirtualNetworksRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabVirtualNetworkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<DevTestLabVirtualNetworkResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _devTestLabVirtualNetworkVirtualNetworksRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Expand, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new DevTestLabVirtualNetworkResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
