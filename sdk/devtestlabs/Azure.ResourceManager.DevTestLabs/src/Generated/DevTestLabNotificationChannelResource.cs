...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    public partial class DevTestLabNotificationChannelResource : ArmResource
    {
        ...
        internal DevTestLabNotificationChannelResource(ArmClient client, DevTestLabNotificationChannelData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DevTestLabNotificationChannelResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new DevTestLabNotificationChannelResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
