...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="DevTestLabNotificationChannelResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="DevTestLabResource"/> using the GetDevTestLabNotificationChannels method.
    /// </summary>
    public partial class DevTestLabNotificationChannelResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of DevTestLabNotificationChannelResource for mocking. </summary>
        protected DevTestLabNotificationChannelResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DevTestLabNotificationChannelResource"/> class. </summary>
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/notificationchannels/{name}";
        ...
        public virtual async Task<Response<DevTestLabNotificationChannelResource>> GetAsync(string expand = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _notificationChannelsClientDiagnostics.CreateScope("DevTestLabNotificationChannelResource.Get");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _notificationChannelsRestClient.CreateGetRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, expand, context);
        ...
        /// <param name="expand"> Specify the $expand query. Example: 'properties($select=webHookUrl)'. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<DevTestLabNotificationChannelResource> Get(string expand = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _notificationChannelsClientDiagnostics.CreateScope("DevTestLabNotificationChannelResource.Get");
            scope.Start();
            try
        ...
        public virtual async Task<Response<DevTestLabNotificationChannelResource>> UpdateAsync(DevTestLabNotificationChannelPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _notificationChannelsClientDiagnostics.CreateScope("DevTestLabNotificationChannelResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _notificationChannelsRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, DevTestLabNotificationChannelPatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DevTestLabNotificationChannelData> response = Response.FromValue(DevTestLabNotificationChannelData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        {
            using DiagnosticScope scope = _notificationChannelsClientDiagnostics.CreateScope("DevTestLabNotificationChannelResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _notificationChannelsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, context);
        ...
        public virtual async Task<Response> NotifyAsync(DevTestLabNotificationChannelNotifyContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _notificationChannelsClientDiagnostics.CreateScope("DevTestLabNotificationChannelResource.Notify");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _notificationChannelsRestClient.CreateNotifyRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, DevTestLabNotificationChannelNotifyContent.ToRequestContent(content), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
        ...
        /// <summary>
        /// Updates the DevTestLabNotificationChannel.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DevTestLab/labs/{labName}/notificationchannels/{name}. </description>
        ...
        public virtual async Task<ArmOperation<DevTestLabNotificationChannelResource>> UpdateAsync(WaitUntil waitUntil, DevTestLabNotificationChannelData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _notificationChannelsRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, DevTestLabNotificationChannelData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<DevTestLabNotificationChannelData> response = Response.FromValue(DevTestLabNotificationChannelData.FromResponse(result), result);
                RequestUriBuilder uri = message.Request.Uri;
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DevTestLabNotificationChannelResource> Update(WaitUntil waitUntil, DevTestLabNotificationChannelData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<DevTestLabNotificationChannelResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _notificationChannelsClientDiagnostics.CreateScope("DevTestLabNotificationChannelResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    DevTestLabNotificationChannelData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    Response<DevTestLabNotificationChannelResource> result = await UpdateAsync(patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DevTestLabNotificationChannelResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    DevTestLabNotificationChannelData current = Get(cancellationToken: cancellationToken).Value.Data;
                    DevTestLabNotificationChannelPatch patch = new DevTestLabNotificationChannelPatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    Response<DevTestLabNotificationChannelResource> result = Update(patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<DevTestLabNotificationChannelResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _notificationChannelsClientDiagnostics.CreateScope("DevTestLabNotificationChannelResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<DevTestLabNotificationChannelResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _notificationChannelsClientDiagnostics.CreateScope("DevTestLabNotificationChannelResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
