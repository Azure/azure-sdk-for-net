...
{
    public partial class DevTestLabArtifactSourceData : IUtf8JsonSerializable, IJsonModel<DevTestLabArtifactSourceData>, IPersistableModel<DevTestLabArtifactSourceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ArmTemplateFolderPath))
            {
                builder.Append("  armTemplateFolderPath:");
                builder.AppendLine($" '{ArmTemplateFolderPath}'");
            }

            if (Optional.IsDefined(BranchRef))
            {
                builder.Append("  branchRef:");
                builder.AppendLine($" '{BranchRef}'");
            }
