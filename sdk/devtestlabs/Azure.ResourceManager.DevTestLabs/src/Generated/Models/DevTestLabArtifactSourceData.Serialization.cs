...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabArtifactSourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabArtifactSourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabArtifactSourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabArtifactSourceData>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabArtifactSourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
