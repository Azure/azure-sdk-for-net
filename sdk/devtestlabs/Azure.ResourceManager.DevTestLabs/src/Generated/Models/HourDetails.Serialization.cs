...
{
    internal partial class HourDetails : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HourDetails DeserializeHourDetails(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
