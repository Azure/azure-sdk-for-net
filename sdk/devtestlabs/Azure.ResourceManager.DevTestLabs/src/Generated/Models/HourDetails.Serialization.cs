...
{
    internal partial class HourDetails : IUtf8JsonSerializable, IJsonModel<HourDetails>, IPersistableModel<HourDetails>
    {
        ...
        void IJsonModel<HourDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(HourDetails)} does not support '{format}' format.");
            }
