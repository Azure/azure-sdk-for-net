...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class WeekDetails
    {
        ...
        /// <summary> Initializes a new instance of <see cref="WeekDetails"/>. </summary>
        public WeekDetails()
        {
        ...
        internal WeekDetails(IList<string> weekdays, string time, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Weekdays = weekdays;
            Time = time;
