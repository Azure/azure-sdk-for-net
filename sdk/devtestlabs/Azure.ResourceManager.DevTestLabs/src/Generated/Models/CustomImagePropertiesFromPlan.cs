...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class CustomImagePropertiesFromPlan
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CustomImagePropertiesFromPlan"/>. </summary>
        ...
        internal CustomImagePropertiesFromPlan(string id, string publisher, string offer, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Publisher = publisher;
            Offer = offer;
