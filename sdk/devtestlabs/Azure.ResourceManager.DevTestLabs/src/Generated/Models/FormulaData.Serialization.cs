...
{
    public partial class FormulaData : IUtf8JsonSerializable
    {
        ...
        internal static FormulaData DeserializeFormulaData(JsonElement element)
        {
            ...
            return new FormulaData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, description.Value, author.Value, osType.Value, Optional.ToNullable(creationDate), formulaContent.Value, vm.Value, provisioningState.Value, uniqueIdentifier.Value);
        }
    }
}
