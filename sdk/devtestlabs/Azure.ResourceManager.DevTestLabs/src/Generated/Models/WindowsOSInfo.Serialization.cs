...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<WindowsOSInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<WindowsOSInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<WindowsOSInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<WindowsOSInfo>)} interface");
            }
        ...
        string IPersistableModel<WindowsOSInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
