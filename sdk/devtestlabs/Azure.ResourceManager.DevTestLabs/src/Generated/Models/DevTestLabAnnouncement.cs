...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class DevTestLabAnnouncement
    {
        ...
        internal DevTestLabAnnouncement(string title, string markdown, DevTestLabEnableStatus? enabled, DateTimeOffset? expireOn, bool? isExpired, string provisioningState, Guid? uniqueIdentifier, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
            Markdown = markdown;
            Enabled = enabled;
