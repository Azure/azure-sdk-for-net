...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ComputeVmProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ComputeVmProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ComputeVmProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ComputeVmProperties>)} interface");
            }
        ...
        string IPersistableModel<ComputeVmProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
