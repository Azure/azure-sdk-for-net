...
{
    public partial class DevTestLabArtifactData : Core.IUtf8JsonSerializable
    {
        ...
        internal static DevTestLabArtifactData DeserializeDevTestLabArtifactData(JsonElement element)
        {
            ...
            Core.Optional<string> targetOSType = default;
            ...
            return new DevTestLabArtifactData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, title.Value, description.Value, publisher.Value, filePath.Value, icon.Value, targetOSType.Value, parameters.Value, Core.Optional.ToNullable(createdDate));
        }
    }
}
