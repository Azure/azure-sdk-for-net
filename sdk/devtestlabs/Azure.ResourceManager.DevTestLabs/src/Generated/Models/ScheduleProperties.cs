...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    internal partial class ScheduleProperties
    {
        ...
        internal ScheduleProperties(DevTestLabEnableStatus? status, string taskType, DevTestLabWeekDetails weeklyRecurrence, DayDetails dailyRecurrence, HourDetails hourlyRecurrence, string timeZoneId, DevTestLabNotificationSettings notificationSettings, DateTimeOffset? createdOn, string targetResourceId, string provisioningState, Guid? uniqueIdentifier, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
            TaskType = taskType;
