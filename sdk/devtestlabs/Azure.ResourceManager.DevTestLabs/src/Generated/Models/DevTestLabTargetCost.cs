...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class DevTestLabTargetCost
    {
        ...
        internal DevTestLabTargetCost(DevTestLabTargetCostStatus? status, int? target, IList<DevTestLabCostThreshold> costThresholds, DateTimeOffset? cycleStartOn, DateTimeOffset? cycleEndOn, DevTestLabReportingCycleType? cycleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Target = target;
