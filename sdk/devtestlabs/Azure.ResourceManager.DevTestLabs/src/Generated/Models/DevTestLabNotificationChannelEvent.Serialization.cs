...
{
    public partial class DevTestLabNotificationChannelEvent : Core.IUtf8JsonSerializable
    {
        ...
        internal static DevTestLabNotificationChannelEvent DeserializeDevTestLabNotificationChannelEvent(JsonElement element)
        {
            ...
            Core.Optional<DevTestLabNotificationChannelEventType> eventName = default;
            ...
            return new DevTestLabNotificationChannelEvent(Core.Optional.ToNullable(eventName));
        }
    }
}
