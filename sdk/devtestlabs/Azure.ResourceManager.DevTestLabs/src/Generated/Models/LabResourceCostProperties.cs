...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class LabResourceCostProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LabResourceCostProperties"/>. </summary>
        ...
        internal LabResourceCostProperties(string resourcename, string resourceUId, double? resourceCost, string resourceType, string resourceOwner, string resourcePricingTier, string resourceStatus, string resourceId, string externalResourceId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
