...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabParameter>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<DevTestLabParameter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabParameter>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
