...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabPolicyViolation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabPolicyViolation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabPolicyViolation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabPolicyViolation>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabPolicyViolation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
