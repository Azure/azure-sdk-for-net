...
{
    public partial class DevTestLabTargetCost : IUtf8JsonSerializable, IJsonModel<DevTestLabTargetCost>, IPersistableModel<DevTestLabTargetCost>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CycleStartOn))
            {
                builder.Append("  cycleStartDateTime:");
                builder.AppendLine($" '{CycleStartOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(CycleEndOn))
            {
                builder.Append("  cycleEndDateTime:");
                builder.AppendLine($" '{CycleEndOn.Value.ToString()}'");
            }

            if (Optional.IsDefined(CycleType))
            {
                builder.Append("  cycleType:");
                builder.AppendLine($" '{CycleType.ToString()}'");
            }
