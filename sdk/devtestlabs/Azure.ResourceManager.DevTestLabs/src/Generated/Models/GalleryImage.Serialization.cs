...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    public partial class GalleryImage : IUtf8JsonSerializable
    {
        ...
        internal static GalleryImage DeserializeGalleryImage(JsonElement element)
        {
            ...
            Optional<GalleryImageReference> imageReference = default;
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("imageReference"))
                        {
                            ...
                            imageReference = GalleryImageReference.DeserializeGalleryImageReference(property0.Value);
                            continue;
                        }
            ...
            return new GalleryImage(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, author.Value, Optional.ToNullable(createdDate), description.Value, imageReference.Value, icon.Value, Optional.ToNullable(enabled), planId.Value, Optional.ToNullable(isPlanAuthorized));
        }
    }
}
