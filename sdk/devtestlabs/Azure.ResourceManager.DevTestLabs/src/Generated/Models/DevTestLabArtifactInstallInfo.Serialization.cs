    ...
    public partial class DevTestLabArtifactInstallInfo : IUtf8JsonSerializable, IJsonModel<DevTestLabArtifactInstallInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ArtifactId))
            {
                ...
                if (ArtifactId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(ArtifactTitle))
            {
                ...
                if (ArtifactTitle.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(DeploymentStatusMessage))
            {
                ...
                if (DeploymentStatusMessage.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(VmExtensionStatusMessage))
            {
                ...
                if (VmExtensionStatusMessage.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(InstallOn))
            {
                ...
                var formattedDateTimeString = TypeFormatters.ToString(InstallOn.Value, "o");
