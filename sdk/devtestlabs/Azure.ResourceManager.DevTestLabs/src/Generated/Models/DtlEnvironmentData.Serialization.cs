...
{
    public partial class DtlEnvironmentData : IUtf8JsonSerializable
    {
        ...
        internal static DtlEnvironmentData DeserializeDtlEnvironmentData(JsonElement element)
        {
            ...
            return new DtlEnvironmentData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, deploymentProperties.Value, armTemplateDisplayName.Value, resourceGroupId.Value, createdByUser.Value, provisioningState.Value, uniqueIdentifier.Value);
        }
    }
}
