    ...
    public partial class DevTestLabResourceCost : IUtf8JsonSerializable, IJsonModel<DevTestLabResourceCost>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ResourceCost))
            {
                ...
                builder.AppendLine($" '{ResourceCost.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ResourceOwner))
            {
                ...
                if (ResourceOwner.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ResourceOwner}'''");
                }
                else
                {
                    builder.AppendLine($" '{ResourceOwner}'");
            ...
            if (Optional.IsDefined(ResourcePricingTier))
            {
                builder.Append("  resourcePricingTier:");
                if (ResourcePricingTier.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ResourcePricingTier}'''");
                }
                else
                {
                    builder.AppendLine($" '{ResourcePricingTier}'");
            ...
            if (Optional.IsDefined(ResourceStatus))
            {
                ...
                if (ResourceStatus.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ResourceStatus}'''");
                }
                else
                {
                    builder.AppendLine($" '{ResourceStatus}'");
            ...
            if (Optional.IsDefined(ExternalResourceId))
            {
                builder.Append("  externalResourceId:");
                if (ExternalResourceId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ExternalResourceId}'''");
                }
                else
                {
                    builder.AppendLine($" '{ExternalResourceId}'");
