...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabGlobalScheduleRetargetContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabGlobalScheduleRetargetContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabGlobalScheduleRetargetContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabGlobalScheduleRetargetContent>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabGlobalScheduleRetargetContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
