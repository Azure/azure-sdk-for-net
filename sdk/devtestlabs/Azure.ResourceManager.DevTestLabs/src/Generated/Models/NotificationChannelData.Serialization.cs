...
{
    public partial class NotificationChannelData : IUtf8JsonSerializable
    {
        ...
        internal static NotificationChannelData DeserializeNotificationChannelData(JsonElement element)
        {
            ...
            return new NotificationChannelData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, webHookUrl.Value, emailRecipient.Value, notificationLocale.Value, description.Value, Optional.ToList(events), Optional.ToNullable(createdDate), provisioningState.Value, uniqueIdentifier.Value);
        }
    }
}
