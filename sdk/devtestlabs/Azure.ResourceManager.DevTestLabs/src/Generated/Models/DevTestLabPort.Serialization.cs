...
{
    public partial class DevTestLabPort : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DevTestLabPort DeserializeDevTestLabPort(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
