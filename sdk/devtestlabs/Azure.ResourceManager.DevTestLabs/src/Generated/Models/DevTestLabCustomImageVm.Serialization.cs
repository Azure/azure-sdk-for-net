...
{
    public partial class DevTestLabCustomImageVm : IUtf8JsonSerializable, IJsonModel<DevTestLabCustomImageVm>, IPersistableModel<DevTestLabCustomImageVm>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WindowsOSInfo))
            {
                ...
                AppendChildObject(builder, WindowsOSInfo, options, 2);
            }

            if (Optional.IsDefined(LinuxOSInfo))
            {
                builder.Append("  linuxOsInfo:");
                AppendChildObject(builder, LinuxOSInfo, options, 2);
            }
