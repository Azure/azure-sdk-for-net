...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class NotificationSettings
    {
        ...
        internal NotificationSettings(EnableStatus? status, int? timeInMinutes, string webhookUri, string emailRecipient, string notificationLocale, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
