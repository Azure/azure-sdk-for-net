...
{
    public partial class DevTestLabDiskData : IUtf8JsonSerializable, IJsonModel<DevTestLabDiskData>, IPersistableModel<DevTestLabDiskData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LeasedByLabVmId))
            {
                builder.Append("  leasedByLabVmId:");
                builder.AppendLine($" '{LeasedByLabVmId.ToString()}'");
            }

            if (Optional.IsDefined(DiskBlobName))
            {
                builder.Append("  diskBlobName:");
                builder.AppendLine($" '{DiskBlobName}'");
            }
            ...
            if (Optional.IsDefined(HostCaching))
            {
                ...
                builder.AppendLine($" '{HostCaching}'");
            }

            if (Optional.IsDefined(ManagedDiskId))
            {
                builder.Append("  managedDiskId:");
                builder.AppendLine($" '{ManagedDiskId.ToString()}'");
            }
