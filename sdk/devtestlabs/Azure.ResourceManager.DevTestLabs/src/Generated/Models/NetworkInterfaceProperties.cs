...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class NetworkInterfaceProperties
    {
        ...
        internal NetworkInterfaceProperties(string virtualNetworkId, string subnetId, string publicIPAddressId, string publicIPAddress, string privateIPAddress, string dnsName, string rdpAuthority, string sshAuthority, SharedPublicIPAddressConfiguration sharedPublicIPAddressConfiguration, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
