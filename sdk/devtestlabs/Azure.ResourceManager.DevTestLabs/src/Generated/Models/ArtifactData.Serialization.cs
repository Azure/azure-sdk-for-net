...
namespace Azure.ResourceManager.DevTestLabs
{
    public partial class ArtifactData : IUtf8JsonSerializable
    {
        ...
        internal static ArtifactData DeserializeArtifactData(JsonElement element)
        {
            ...
            return new ArtifactData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, title.Value, description.Value, publisher.Value, filePath.Value, icon.Value, targetOSType.Value, parameters.Value, Optional.ToNullable(createdDate));
        }
    }
}
