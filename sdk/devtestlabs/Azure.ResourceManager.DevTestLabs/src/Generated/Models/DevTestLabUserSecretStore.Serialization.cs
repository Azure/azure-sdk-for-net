...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabUserSecretStore>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabUserSecretStore>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabUserSecretStore>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabUserSecretStore>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabUserSecretStore>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
