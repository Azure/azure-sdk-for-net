...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabVhdList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LabVhdList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabVhdList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LabVhdList>)} interface");
            }
        ...
        string IPersistableModel<LabVhdList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
