    ...
    internal partial class LabVhdList : IUtf8JsonSerializable, IJsonModel<LabVhdList>
    {
        ...
        internal static LabVhdList DeserializeLabVhdList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
				...
				global::System.ClientModel.Primitives.ModelReaderWriter.Read<global::Azure.ResourceManager.Resources.Models.SubResource>(new global::System.BinaryData(global::System.Runtime.InteropServices.JsonMarshal.GetRawUtf8Value(item).ToArray()), options, AzureResourceManagerDevTestLabsContext.Default)
#else
                ModelReaderWriter.Read<SubResource>(new BinaryData(Encoding.UTF8.GetBytes(item.GetRawText())), options, AzureResourceManagerDevTestLabsContext.Default)
#endif
);
                    }
                    value = array;
