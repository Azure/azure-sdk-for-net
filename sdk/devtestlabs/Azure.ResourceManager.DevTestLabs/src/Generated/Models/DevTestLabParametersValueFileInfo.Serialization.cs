...
{
    public partial class DevTestLabParametersValueFileInfo : IUtf8JsonSerializable, IJsonModel<DevTestLabParametersValueFileInfo>, IPersistableModel<DevTestLabParametersValueFileInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ParametersValueInfo))
            {
                builder.Append("  parametersValueInfo:");
                builder.AppendLine($" '{ParametersValueInfo.ToString()}'");
            }
