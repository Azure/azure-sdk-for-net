...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class DevTestLabEvaluatePolicy
    {
        ...
        internal DevTestLabEvaluatePolicy(string factName, string factData, string valueOffset, string userObjectId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FactName = factName;
            FactData = factData;
