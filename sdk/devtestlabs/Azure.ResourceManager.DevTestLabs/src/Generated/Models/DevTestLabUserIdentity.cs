...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class DevTestLabUserIdentity
    {
        ...
        internal DevTestLabUserIdentity(string principalName, string principalId, Guid? tenantId, string objectId, string appId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
