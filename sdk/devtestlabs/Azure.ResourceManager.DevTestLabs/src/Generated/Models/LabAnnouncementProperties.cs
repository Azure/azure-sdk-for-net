...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class LabAnnouncementProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="LabAnnouncementProperties"/>. </summary>
        ...
        internal LabAnnouncementProperties(string title, string markdown, EnableStatus? enabled, DateTimeOffset? expireOn, bool? expired, string provisioningState, string uniqueIdentifier, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Title = title;
            Markdown = markdown;
            Enabled = enabled;
