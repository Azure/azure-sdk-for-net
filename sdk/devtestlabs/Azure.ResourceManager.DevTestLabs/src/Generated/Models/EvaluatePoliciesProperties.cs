...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class EvaluatePoliciesProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="EvaluatePoliciesProperties"/>. </summary>
        ...
        internal EvaluatePoliciesProperties(string factName, string factData, string valueOffset, string userObjectId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            FactName = factName;
            FactData = factData;
