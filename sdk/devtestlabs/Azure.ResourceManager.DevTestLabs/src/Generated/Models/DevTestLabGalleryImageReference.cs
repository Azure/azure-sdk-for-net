...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class DevTestLabGalleryImageReference
    {
        ...
        internal DevTestLabGalleryImageReference(string offer, string publisher, string sku, string osType, string version, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Offer = offer;
            Publisher = publisher;
            Sku = sku;
