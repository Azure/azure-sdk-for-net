...
{
    public partial class ComputeDataDisk : IUtf8JsonSerializable, IJsonModel<ComputeDataDisk>, IPersistableModel<ComputeDataDisk>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ManagedDiskId))
            {
                builder.Append("  managedDiskId:");
                builder.AppendLine($" '{ManagedDiskId}'");
            }

            if (Optional.IsDefined(DiskSizeGiB))
            {
                builder.Append("  diskSizeGiB:");
                builder.AppendLine($" '{DiskSizeGiB.Value.ToString()}'");
            }
