...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    public partial class ComputeDataDisk : IUtf8JsonSerializable, IJsonModel<ComputeDataDisk>
    {
        ...
        void IJsonModel<ComputeDataDisk>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ComputeDataDisk)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ComputeDataDisk>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ComputeDataDisk)} does not support '{options.Format}' format.");
            }
        }
