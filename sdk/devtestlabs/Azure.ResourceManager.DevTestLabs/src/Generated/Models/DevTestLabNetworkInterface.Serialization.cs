...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabNetworkInterface>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabNetworkInterface>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabNetworkInterface>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabNetworkInterface>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabNetworkInterface>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
