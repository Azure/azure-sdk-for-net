...
{
    internal partial class PercentageCostThresholdProperties : IUtf8JsonSerializable, IJsonModel<PercentageCostThresholdProperties>, IPersistableModel<PercentageCostThresholdProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ThresholdValue))
            {
                ...
                builder.AppendLine($" '{ThresholdValue.Value.ToString()}'");
            }
