...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PercentageCostThresholdProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PercentageCostThresholdProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PercentageCostThresholdProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PercentageCostThresholdProperties>)} interface");
            }
        ...
        string IPersistableModel<PercentageCostThresholdProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
