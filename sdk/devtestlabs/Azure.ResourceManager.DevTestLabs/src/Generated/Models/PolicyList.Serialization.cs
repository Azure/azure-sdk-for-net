...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PolicyList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PolicyList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PolicyList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PolicyList>)} interface");
            }
        ...
        string IPersistableModel<PolicyList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
