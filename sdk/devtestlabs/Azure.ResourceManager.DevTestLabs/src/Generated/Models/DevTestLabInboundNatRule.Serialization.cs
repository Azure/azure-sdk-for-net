...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    public partial class DevTestLabInboundNatRule : IUtf8JsonSerializable, IJsonModel<DevTestLabInboundNatRule>
    {
        ...
        void IJsonModel<DevTestLabInboundNatRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DevTestLabInboundNatRule)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DevTestLabInboundNatRule>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DevTestLabInboundNatRule)} does not support '{options.Format}' format.");
            }
        }
