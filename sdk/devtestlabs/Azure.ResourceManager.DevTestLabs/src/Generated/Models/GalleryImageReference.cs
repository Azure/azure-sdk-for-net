...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class GalleryImageReference
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GalleryImageReference"/>. </summary>
        ...
        internal GalleryImageReference(string offer, string publisher, string sku, string osType, string version, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Offer = offer;
            Publisher = publisher;
            Sku = sku;
