...
namespace Azure.ResourceManager.DevTestLabs
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabNotificationChannelData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabNotificationChannelData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabNotificationChannelData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabNotificationChannelData>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabNotificationChannelData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
