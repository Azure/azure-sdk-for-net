...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabGenerateUploadUriResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabGenerateUploadUriResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabGenerateUploadUriResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabGenerateUploadUriResult>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabGenerateUploadUriResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
