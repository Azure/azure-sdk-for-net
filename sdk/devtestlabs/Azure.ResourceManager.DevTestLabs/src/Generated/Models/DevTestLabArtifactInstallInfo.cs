...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class DevTestLabArtifactInstallInfo
    {
        ...
        internal DevTestLabArtifactInstallInfo(string artifactId, string artifactTitle, IList<DevTestLabArtifactParameter> parameters, string status, string deploymentStatusMessage, string vmExtensionStatusMessage, DateTimeOffset? installOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
