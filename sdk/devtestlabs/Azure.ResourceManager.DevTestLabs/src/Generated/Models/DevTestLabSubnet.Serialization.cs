...
{
    public partial class DevTestLabSubnet : IUtf8JsonSerializable, IJsonModel<DevTestLabSubnet>, IPersistableModel<DevTestLabSubnet>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AllowPublicIP))
            {
                ...
                builder.AppendLine($" '{AllowPublicIP.ToString()}'");
            }
