...
{
    public partial class DevTestLabSubnet : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DevTestLabSubnet DeserializeDevTestLabSubnet(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
