...
{
    public partial class DevTestLabVmData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DevTestLabVmData DeserializeDevTestLabVmData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
