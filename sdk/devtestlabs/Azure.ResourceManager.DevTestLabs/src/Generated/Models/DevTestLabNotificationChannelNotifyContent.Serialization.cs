...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabNotificationChannelNotifyContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabNotificationChannelNotifyContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabNotificationChannelNotifyContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabNotificationChannelNotifyContent>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabNotificationChannelNotifyContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
