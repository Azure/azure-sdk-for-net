...
{
    internal partial class LinuxOSInfo : IUtf8JsonSerializable, IJsonModel<LinuxOSInfo>, IPersistableModel<LinuxOSInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LinuxOSState))
            {
                builder.Append("  linuxOsState:");
                builder.AppendLine($" '{LinuxOSState.ToString()}'");
            }
