...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    internal partial class LabVmList : IUtf8JsonSerializable, IJsonModel<LabVmList>
    {
        ...
        void IJsonModel<LabVmList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LabVmList)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<DevTestLabVmData> collection && collection.IsUndefined))
            {
        ...
        internal static LabVmList DeserializeLabVmList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new LabVmList(value ?? new ChangeTrackingList<DevTestLabVmData>(), nextLink.Value, serializedAdditionalRawData);
        }
