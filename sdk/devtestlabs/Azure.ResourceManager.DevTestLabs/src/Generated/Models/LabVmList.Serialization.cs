...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabVmList>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<LabVmList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LabVmList>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
