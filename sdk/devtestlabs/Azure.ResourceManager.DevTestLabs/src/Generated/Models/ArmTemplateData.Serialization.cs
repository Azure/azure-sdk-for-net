...
{
    public partial class ArmTemplateData : IUtf8JsonSerializable
    {
        ...
        internal static ArmTemplateData DeserializeArmTemplateData(JsonElement element)
        {
            ...
            return new ArmTemplateData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, displayName.Value, description.Value, publisher.Value, icon.Value, contents.Value, Optional.ToNullable(createdDate), Optional.ToList(parametersValueFilesInfo), Optional.ToNullable(enabled));
        }
    }
}
