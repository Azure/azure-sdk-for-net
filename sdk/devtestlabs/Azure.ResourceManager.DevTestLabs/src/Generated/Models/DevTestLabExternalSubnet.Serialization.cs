...
{
    public partial class DevTestLabExternalSubnet : IUtf8JsonSerializable, IJsonModel<DevTestLabExternalSubnet>, IPersistableModel<DevTestLabExternalSubnet>
    {
        ...
        void IJsonModel<DevTestLabExternalSubnet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DevTestLabExternalSubnet)} does not support '{format}' format.");
            }
