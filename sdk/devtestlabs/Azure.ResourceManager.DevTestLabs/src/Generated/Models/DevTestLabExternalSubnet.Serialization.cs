...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabExternalSubnet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabExternalSubnet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabExternalSubnet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabExternalSubnet>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabExternalSubnet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
