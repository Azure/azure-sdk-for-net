...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    public partial class DevTestLabCostDetails : IUtf8JsonSerializable, IJsonModel<DevTestLabCostDetails>
    {
        ...
        void IJsonModel<DevTestLabCostDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DevTestLabCostDetails)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DevTestLabCostDetails>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DevTestLabCostDetails)} does not support '{options.Format}' format.");
            }
        }
