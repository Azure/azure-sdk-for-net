...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabCostDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabCostDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabCostDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabCostDetails>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabCostDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
