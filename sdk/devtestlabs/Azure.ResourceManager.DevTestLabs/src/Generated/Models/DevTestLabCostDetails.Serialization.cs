...
{
    public partial class DevTestLabCostDetails : IUtf8JsonSerializable, IJsonModel<DevTestLabCostDetails>, IPersistableModel<DevTestLabCostDetails>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CostType))
            {
                ...
                builder.AppendLine($" '{CostType.ToString()}'");
            }
