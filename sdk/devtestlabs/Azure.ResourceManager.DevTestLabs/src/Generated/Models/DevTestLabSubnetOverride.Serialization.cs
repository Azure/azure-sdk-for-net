...
{
    public partial class DevTestLabSubnetOverride : IUtf8JsonSerializable, IJsonModel<DevTestLabSubnetOverride>, IPersistableModel<DevTestLabSubnetOverride>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(UseInVmCreationPermission))
            {
                builder.Append("  useInVmCreationPermission:");
                builder.AppendLine($" '{UseInVmCreationPermission.ToString()}'");
            }

            if (Optional.IsDefined(UsePublicIPAddressPermission))
            {
                builder.Append("  usePublicIpAddressPermission:");
                builder.AppendLine($" '{UsePublicIPAddressPermission.ToString()}'");
            }
            ...
            if (Optional.IsDefined(VirtualNetworkPoolName))
            {
                builder.Append("  virtualNetworkPoolName:");
                builder.AppendLine($" '{VirtualNetworkPoolName}'");
            }
