...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabSubnetOverride>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabSubnetOverride>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabSubnetOverride>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabSubnetOverride>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabSubnetOverride>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
