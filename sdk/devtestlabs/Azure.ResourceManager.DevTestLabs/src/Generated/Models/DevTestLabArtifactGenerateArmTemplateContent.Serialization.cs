...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabArtifactGenerateArmTemplateContent>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        DevTestLabArtifactGenerateArmTemplateContent IJsonModel<DevTestLabArtifactGenerateArmTemplateContent>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<DevTestLabArtifactGenerateArmTemplateContent>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        DevTestLabArtifactGenerateArmTemplateContent IModel<DevTestLabArtifactGenerateArmTemplateContent>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<DevTestLabArtifactGenerateArmTemplateContent>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
