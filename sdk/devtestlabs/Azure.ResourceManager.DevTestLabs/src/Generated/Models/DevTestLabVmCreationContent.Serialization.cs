    ...
    public partial class DevTestLabVmCreationContent : IUtf8JsonSerializable, IJsonModel<DevTestLabVmCreationContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BulkCreationParameters))
            {
                ...
                AppendChildObject(builder, BulkCreationParameters, options, 4, false);
            }
            ...
            if (Optional.IsDefined(OwnerObjectId))
            {
                ...
                if (OwnerObjectId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(OwnerUserPrincipalName))
            {
                ...
                if (OwnerUserPrincipalName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(CustomImageId))
            {
                ...
                if (CustomImageId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(SshKey))
            {
                ...
                if (SshKey.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
