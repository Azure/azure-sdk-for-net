...
{
    public partial class DevTestLabData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DevTestLabData DeserializeDevTestLabData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
