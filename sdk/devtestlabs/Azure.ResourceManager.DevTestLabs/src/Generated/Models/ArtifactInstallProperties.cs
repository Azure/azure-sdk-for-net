...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class ArtifactInstallProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ArtifactInstallProperties"/>. </summary>
        ...
        internal ArtifactInstallProperties(string artifactId, string artifactTitle, IList<ArtifactParameterProperties> parameters, string status, string deploymentStatusMessage, string vmExtensionStatusMessage, DateTimeOffset? installOn, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
