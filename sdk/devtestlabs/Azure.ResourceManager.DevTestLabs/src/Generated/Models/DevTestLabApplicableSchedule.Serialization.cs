...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class DevTestLabApplicableSchedule : TrackedResourceData, IJsonModel<DevTestLabApplicableSchedule>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<DevTestLabApplicableSchedule>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DevTestLabApplicableSchedule IJsonModel<DevTestLabApplicableSchedule>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (DevTestLabApplicableSchedule)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DevTestLabApplicableSchedule DeserializeDevTestLabApplicableSchedule(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    properties = ApplicableScheduleProperties.DeserializeApplicableScheduleProperties(prop.Value, options);
                    continue;
                }
                if (options.Format != "W")
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DevTestLabApplicableSchedule>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DevTestLabApplicableSchedule IPersistableModel<DevTestLabApplicableSchedule>.Create(BinaryData data, ModelReaderWriterOptions options) => (DevTestLabApplicableSchedule)PersistableModelCreateCore(data, options);
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="DevTestLabApplicableSchedule"/> from. </param>
        internal static DevTestLabApplicableSchedule FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeDevTestLabApplicableSchedule(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
    }
}
