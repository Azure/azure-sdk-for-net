...
{
    public partial class DevTestLabApplicableSchedule : IUtf8JsonSerializable, IJsonModel<DevTestLabApplicableSchedule>, IPersistableModel<DevTestLabApplicableSchedule>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LabVmsShutdown))
            {
                builder.Append("  labVmsShutdown:");
                AppendChildObject(builder, LabVmsShutdown, options, 2);
            }

            if (Optional.IsDefined(LabVmsStartup))
            {
                builder.Append("  labVmsStartup:");
                AppendChildObject(builder, LabVmsStartup, options, 2);
            }
