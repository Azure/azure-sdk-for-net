...
{
    public partial class DevTestLabVirtualNetworkData : IUtf8JsonSerializable, IJsonModel<DevTestLabVirtualNetworkData>, IPersistableModel<DevTestLabVirtualNetworkData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ExternalProviderResourceId))
            {
                builder.Append("  externalProviderResourceId:");
                builder.AppendLine($" '{ExternalProviderResourceId}'");
            }

            if (Optional.IsCollectionDefined(ExternalSubnets))
            {
                builder.Append("  externalSubnets:");
                builder.AppendLine(" [");
                foreach (var item in ExternalSubnets)
                {
                    AppendChildObject(builder, item, options, 4);
            ...
            if (Optional.IsCollectionDefined(SubnetOverrides))
            {
                builder.Append("  subnetOverrides:");
                builder.AppendLine(" [");
                foreach (var item in SubnetOverrides)
                {
                    AppendChildObject(builder, item, options, 4);
