...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class GenerateArmTemplateContent
    {
        ...
        /// <summary> Initializes a new instance of <see cref="GenerateArmTemplateContent"/>. </summary>
        ...
        /// <summary> Initializes a new instance of <see cref="GenerateArmTemplateContent"/>. </summary>
        /// <param name="virtualMachineName"> The resource name of the virtual machine. </param>
        ...
        internal GenerateArmTemplateContent(string virtualMachineName, IList<ParameterInfo> parameters, string location, FileUploadOption? fileUploadOptions, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
