...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class UserIdentity
    {
        ...
        internal UserIdentity(string principalName, string principalId, string tenantId, string objectId, string appId, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
