...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    internal partial class DiskList
    {
        ...
        internal DiskList(IEnumerable<DevTestLabDiskData> value)
        {
            Value = value.ToList();
        }
        ...
        internal DiskList(IList<DevTestLabDiskData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<DevTestLabDiskData> Value { get; }
