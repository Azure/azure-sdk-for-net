...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DayDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DayDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DayDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DayDetails>)} interface");
            }
        ...
        string IPersistableModel<DayDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
