...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabSchedulePatch>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<DevTestLabSchedulePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabSchedulePatch>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
