...
{
    public partial class DevTestLabDataDiskProperties : IUtf8JsonSerializable, IJsonModel<DevTestLabDataDiskProperties>, IPersistableModel<DevTestLabDataDiskProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AttachNewDataDiskOptions))
            {
                builder.Append("  attachNewDataDiskOptions:");
                AppendChildObject(builder, AttachNewDataDiskOptions, options, 2);
            }

            if (Optional.IsDefined(ExistingLabDiskId))
            {
                builder.Append("  existingLabDiskId:");
                builder.AppendLine($" '{ExistingLabDiskId.ToString()}'");
            }
