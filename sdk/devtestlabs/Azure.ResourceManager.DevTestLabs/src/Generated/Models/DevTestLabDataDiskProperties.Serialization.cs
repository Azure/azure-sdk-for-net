...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabDataDiskProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabDataDiskProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabDataDiskProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabDataDiskProperties>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabDataDiskProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
