    ...
    public partial class DevTestLabScheduleData : IUtf8JsonSerializable, IJsonModel<DevTestLabScheduleData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WeeklyRecurrence))
            {
                ...
                AppendChildObject(builder, WeeklyRecurrence, options, 4, false);
            }

            if (Optional.IsDefined(DailyRecurrence))
            {
                builder.Append("    dailyRecurrence:");
                AppendChildObject(builder, DailyRecurrence, options, 4, false);
            }

            if (Optional.IsDefined(HourlyRecurrence))
            {
                builder.Append("    hourlyRecurrence:");
                AppendChildObject(builder, HourlyRecurrence, options, 4, false);
            }
            ...
            if (Optional.IsDefined(NotificationSettings))
            {
                ...
                AppendChildObject(builder, NotificationSettings, options, 4, false);
            }
