...
{
    public partial class DevTestLabScheduleData : IUtf8JsonSerializable, IJsonModel<DevTestLabScheduleData>, IPersistableModel<DevTestLabScheduleData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(WeeklyRecurrence))
            {
                builder.Append("  weeklyRecurrence:");
                AppendChildObject(builder, WeeklyRecurrence, options, 2);
            }

            if (Optional.IsDefined(DailyRecurrence))
            {
                builder.Append("  dailyRecurrence:");
                AppendChildObject(builder, DailyRecurrence, options, 2);
            }

            if (Optional.IsDefined(HourlyRecurrence))
            {
                builder.Append("  hourlyRecurrence:");
                AppendChildObject(builder, HourlyRecurrence, options, 2);
            }
            ...
            if (Optional.IsDefined(NotificationSettings))
            {
                ...
                AppendChildObject(builder, NotificationSettings, options, 2);
            }
