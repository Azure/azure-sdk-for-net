...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        internal static LabCostSummaryProperties DeserializeLabCostSummaryProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
