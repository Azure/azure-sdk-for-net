...
{
    public partial class DevTestLabFormulaData : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Core.Optional.IsDefined(FormulaContent))
            {
        ...
        internal static DevTestLabFormulaData DeserializeDevTestLabFormulaData(JsonElement element)
        {
            ...
            Core.Optional<DevTestLabVmCreationContent> formulaContent = default;
            Core.Optional<FormulaPropertiesFromVm> vm = default;
            ...
            return new DevTestLabFormulaData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, description.Value, author.Value, osType.Value, Core.Optional.ToNullable(creationDate), formulaContent.Value, vm.Value, provisioningState.Value, Core.Optional.ToNullable(uniqueIdentifier));
        }
    }
}
