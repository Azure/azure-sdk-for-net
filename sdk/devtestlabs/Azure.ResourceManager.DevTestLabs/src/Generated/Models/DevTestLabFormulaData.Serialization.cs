...
namespace Azure.ResourceManager.DevTestLabs
{
    public partial class DevTestLabFormulaData : IUtf8JsonSerializable, IJsonModel<DevTestLabFormulaData>
    {
        ...
        void IJsonModel<DevTestLabFormulaData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DevTestLabFormulaData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DevTestLabFormulaData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DevTestLabFormulaData)} does not support '{options.Format}' format.");
            }
        }
