...
{
    public partial class DevTestLabFormulaData : IUtf8JsonSerializable, IJsonModel<DevTestLabFormulaData>, IPersistableModel<DevTestLabFormulaData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FormulaContent))
            {
                builder.Append("  formulaContent:");
                AppendChildObject(builder, FormulaContent, options, 2);
            }
