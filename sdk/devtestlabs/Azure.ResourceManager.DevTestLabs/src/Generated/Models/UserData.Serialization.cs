...
namespace Azure.ResourceManager.DevTestLabs
{
    public partial class UserData : IUtf8JsonSerializable
    {
        ...
        internal static UserData DeserializeUserData(JsonElement element)
        {
            ...
            return new UserData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity.Value, secretStore.Value, Optional.ToNullable(createdDate), provisioningState.Value, uniqueIdentifier.Value);
        }
    }
}
