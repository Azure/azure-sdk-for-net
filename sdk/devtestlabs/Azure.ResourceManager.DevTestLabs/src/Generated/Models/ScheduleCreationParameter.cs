...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class ScheduleCreationParameter
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ScheduleCreationParameter"/>. </summary>
        ...
        internal ScheduleCreationParameter(EnableStatus? status, string taskType, WeekDetails weeklyRecurrence, DayDetails dailyRecurrence, HourDetails hourlyRecurrence, string timeZoneId, NotificationSettings notificationSettings, string targetResourceId, string name, string location, IDictionary<string, string> tags, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            TaskType = taskType;
