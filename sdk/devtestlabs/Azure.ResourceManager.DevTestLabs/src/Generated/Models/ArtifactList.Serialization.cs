...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    internal partial class ArtifactList : IUtf8JsonSerializable, IJsonModel<ArtifactList>
    {
        ...
        void IJsonModel<ArtifactList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ArtifactList)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ArtifactList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ArtifactList)} does not support '{options.Format}' format.");
            }
        }
