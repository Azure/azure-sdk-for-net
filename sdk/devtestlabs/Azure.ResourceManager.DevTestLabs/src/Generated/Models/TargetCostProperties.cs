...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    public partial class TargetCostProperties
    {
        ...
        /// <summary> Initializes a new instance of <see cref="TargetCostProperties"/>. </summary>
        ...
        internal TargetCostProperties(TargetCostStatus? status, int? target, IList<CostThresholdProperties> costThresholds, DateTimeOffset? cycleStartOn, DateTimeOffset? cycleEndOn, ReportingCycleType? cycleType, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Target = target;
