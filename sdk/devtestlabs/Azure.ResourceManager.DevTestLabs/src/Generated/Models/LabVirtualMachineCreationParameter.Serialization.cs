...
{
    public partial class LabVirtualMachineCreationParameter : IUtf8JsonSerializable, IJsonModel<LabVirtualMachineCreationParameter>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LabVirtualMachineCreationParameter>)this).Write(writer, ModelSerializationExtensions.WireOptions);

        void IJsonModel<LabVirtualMachineCreationParameter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<LabVirtualMachineCreationParameter>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LabVirtualMachineCreationParameter)} does not support writing '{format}' format.");
            }
        ...
        LabVirtualMachineCreationParameter IJsonModel<LabVirtualMachineCreationParameter>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<LabVirtualMachineCreationParameter>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LabVirtualMachineCreationParameter)} does not support reading '{format}' format.");
            }

            using JsonDocument document = JsonDocument.ParseValue(ref reader);
            return DeserializeLabVirtualMachineCreationParameter(document.RootElement, options);
        }

        internal static LabVirtualMachineCreationParameter DeserializeLabVirtualMachineCreationParameter(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new LabVirtualMachineCreationParameter(
        ...
        BinaryData IPersistableModel<LabVirtualMachineCreationParameter>.Write(ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<LabVirtualMachineCreationParameter>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LabVirtualMachineCreationParameter)} does not support writing '{options.Format}' format.");
            }
        }

        LabVirtualMachineCreationParameter IPersistableModel<LabVirtualMachineCreationParameter>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<LabVirtualMachineCreationParameter>)this).GetFormatFromOptions(options) : options.Format;
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LabVirtualMachineCreationParameter)} does not support reading '{options.Format}' format.");
            }
        }

        string IPersistableModel<LabVirtualMachineCreationParameter>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
