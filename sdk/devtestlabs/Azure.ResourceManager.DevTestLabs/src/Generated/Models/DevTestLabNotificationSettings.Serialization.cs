...
{
    public partial class DevTestLabNotificationSettings : IUtf8JsonSerializable, IJsonModel<DevTestLabNotificationSettings>, IPersistableModel<DevTestLabNotificationSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TimeInMinutes))
            {
                ...
                builder.AppendLine($" '{TimeInMinutes.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(EmailRecipient))
            {
                builder.Append("  emailRecipient:");
                builder.AppendLine($" '{EmailRecipient}'");
            }

            if (Optional.IsDefined(NotificationLocale))
            {
                builder.Append("  notificationLocale:");
                builder.AppendLine($" '{NotificationLocale}'");
            }
