...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    internal partial class NotificationChannelList : IUtf8JsonSerializable, IJsonModel<NotificationChannelList>
    {
        ...
        void IJsonModel<NotificationChannelList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NotificationChannelList)} does not support '{format}' format.");
            }

            writer.WriteStartObject();
            if (!(Value is ChangeTrackingList<DevTestLabNotificationChannelData> collection && collection.IsUndefined))
            {
        ...
        internal static NotificationChannelList DeserializeNotificationChannelList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NotificationChannelList(value ?? new ChangeTrackingList<DevTestLabNotificationChannelData>(), nextLink.Value, serializedAdditionalRawData);
        }
