...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotificationChannelList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<NotificationChannelList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<NotificationChannelList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<NotificationChannelList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
