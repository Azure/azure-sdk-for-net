...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<NotificationChannelList>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<NotificationChannelList>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<DevTestLabNotificationChannelData>)item).Write(writer, options);
                }
        ...
        internal static NotificationChannelList DeserializeNotificationChannelList(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new NotificationChannelList(value ?? new ChangeTrackingList<DevTestLabNotificationChannelData>(), nextLink, serializedAdditionalRawData);
        }
