...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ScheduleList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ScheduleList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ScheduleList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ScheduleList>)} interface");
            }
        ...
        string IPersistableModel<ScheduleList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
