...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    internal partial class PolicyList
    {
        ...
        internal PolicyList(IEnumerable<DevTestLabPolicyData> value)
        {
            Value = value.ToList();
        }
        ...
        internal PolicyList(IList<DevTestLabPolicyData> value, Uri nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IList<DevTestLabPolicyData> Value { get; }
