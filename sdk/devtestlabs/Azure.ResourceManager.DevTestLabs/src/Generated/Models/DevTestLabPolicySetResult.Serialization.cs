...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    public partial class DevTestLabPolicySetResult : IUtf8JsonSerializable, IModelJsonSerializable<DevTestLabPolicySetResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<DevTestLabPolicySetResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(PolicyViolations))
            {
                ...
                foreach (var item in PolicyViolations)
                {
                    ...
                    {
                        ((IModelJsonSerializable<DevTestLabPolicyViolation>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="DevTestLabPolicySetResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="DevTestLabPolicySetResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="DevTestLabPolicySetResult"/>. </summary>
