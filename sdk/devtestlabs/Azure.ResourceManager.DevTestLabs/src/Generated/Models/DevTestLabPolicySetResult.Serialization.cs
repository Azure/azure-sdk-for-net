...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        internal static DevTestLabPolicySetResult DeserializeDevTestLabPolicySetResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
