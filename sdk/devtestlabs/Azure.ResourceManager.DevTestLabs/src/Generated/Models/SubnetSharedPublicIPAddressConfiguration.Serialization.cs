...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SubnetSharedPublicIPAddressConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SubnetSharedPublicIPAddressConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SubnetSharedPublicIPAddressConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SubnetSharedPublicIPAddressConfiguration>)} interface");
            }
        ...
        string IPersistableModel<SubnetSharedPublicIPAddressConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
