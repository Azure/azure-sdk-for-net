...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DevTestLabArmTemplateInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DevTestLabArmTemplateInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DevTestLabArmTemplateInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DevTestLabArmTemplateInfo>)} interface");
            }
        ...
        string IPersistableModel<DevTestLabArmTemplateInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
