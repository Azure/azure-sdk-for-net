...
namespace Azure.ResourceManager.DevTestLabs.Models
{
    ...
    {
        internal static DevTestLabArmTemplateInfo DeserializeDevTestLabArmTemplateInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
