...
{
    public partial class ApplicableSchedule : IUtf8JsonSerializable
    {
        ...
        internal static ApplicableSchedule DeserializeApplicableSchedule(JsonElement element)
        {
            ...
            return new ApplicableSchedule(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, labVmsShutdown.Value, labVmsStartup.Value);
        }
    }
}
