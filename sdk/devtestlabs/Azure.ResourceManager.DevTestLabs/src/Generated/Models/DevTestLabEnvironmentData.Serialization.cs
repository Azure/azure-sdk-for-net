...
namespace Azure.ResourceManager.DevTestLabs
{
    public partial class DevTestLabEnvironmentData : IUtf8JsonSerializable, IJsonModel<DevTestLabEnvironmentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeploymentProperties))
            {
                builder.Append("    deploymentProperties:");
                AppendChildObject(builder, DeploymentProperties, options, 4, false);
            }

            if (Optional.IsDefined(ArmTemplateDisplayName))
            {
                builder.Append("    armTemplateDisplayName:");
                if (ArmTemplateDisplayName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ArmTemplateDisplayName}'''");
                }
                else
                {
                    builder.AppendLine($" '{ArmTemplateDisplayName}'");
            ...
            if (Optional.IsDefined(ResourceGroupId))
            {
                ...
                if (ResourceGroupId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{ResourceGroupId}'''");
                }
                else
                {
                    builder.AppendLine($" '{ResourceGroupId}'");
            ...
            if (Optional.IsDefined(CreatedByUser))
            {
                ...
                if (CreatedByUser.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
