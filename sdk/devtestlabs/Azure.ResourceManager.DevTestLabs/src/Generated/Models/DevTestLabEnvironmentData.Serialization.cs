...
{
    public partial class DevTestLabEnvironmentData : IUtf8JsonSerializable, IJsonModel<DevTestLabEnvironmentData>, IPersistableModel<DevTestLabEnvironmentData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DeploymentProperties))
            {
                ...
                AppendChildObject(builder, DeploymentProperties, options, 2);
            }
