...
{
    public partial class ServiceFabricData : IUtf8JsonSerializable
    {
        ...
        internal static ServiceFabricData DeserializeServiceFabricData(JsonElement element)
        {
            ...
            return new ServiceFabricData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, externalServiceFabricId.Value, environmentId.Value, applicableSchedule.Value, provisioningState.Value, uniqueIdentifier.Value);
        }
    }
}
