...
namespace Microsoft.Azure.Management.MachineLearningExperimentation
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<MLTeamAccountManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(MLTeamAccountManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IEnumerable<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.MachineLearningExperimentation/operations").ToString();
