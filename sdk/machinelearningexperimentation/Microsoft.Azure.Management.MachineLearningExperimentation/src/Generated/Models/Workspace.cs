...
namespace Microsoft.Azure.Management.MachineLearningExperimentation.Models
{
    ...
    public partial class Workspace : Resource
    {
        ...
        /// contains this workspace.</param>
        /// <param name="workspaceId">The immutable id of this
        /// workspace.</param>
        ...
        /// team account workspace resource. The provisioningState is to
        /// indicate states for resource provisioning. Possible values include:
        /// 'Creating', 'Succeeded', 'Updating', 'Deleting', 'Failed'</param>
        public Workspace(string location, string friendlyName, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string description = default(string), string accountId = default(string), string workspaceId = default(string), System.DateTime? creationDate = default(System.DateTime?), ProvisioningState? provisioningState = default(ProvisioningState?))
        ...
        /// <summary>
        /// Gets the immutable id of this workspace.
        /// </summary>
        ...
        /// <summary>
        /// Gets the creation date of the machine learning workspace in ISO8601
        /// format.
        /// </summary>
        ...
        /// <summary>
        /// Gets the current deployment state of team account workspace
