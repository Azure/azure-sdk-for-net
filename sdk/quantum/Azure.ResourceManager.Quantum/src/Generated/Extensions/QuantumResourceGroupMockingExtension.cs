...
namespace Azure.ResourceManager.Quantum.Mocking
{
    ...
    internal partial class QuantumResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="QuantumResourceGroupMockingExtension"/> class for mocking. </summary>
        protected QuantumResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="QuantumResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal QuantumResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
