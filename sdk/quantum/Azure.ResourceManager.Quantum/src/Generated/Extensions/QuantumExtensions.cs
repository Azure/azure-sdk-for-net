...
namespace Azure.ResourceManager.Quantum
{
    ...
    {
        private static QuantumWorkspaceResourceExtensionClient GetQuantumWorkspaceResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new QuantumWorkspaceResourceExtensionClient(client, resource.Id);
            });
        }

        private static QuantumWorkspaceResourceExtensionClient GetQuantumWorkspaceResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new QuantumWorkspaceResourceExtensionClient(client, scope);
            });
        }
        ...
        {
            return GetQuantumWorkspaceResourceExtensionClient(subscriptionResource).GetQuantumWorkspacesAsync(cancellationToken);
        }
        ...
        {
            return GetQuantumWorkspaceResourceExtensionClient(subscriptionResource).GetQuantumWorkspaces(cancellationToken);
        }
