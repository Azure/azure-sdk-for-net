...
using Azure.ResourceManager.Quantum.Mock;
...
namespace Azure.ResourceManager.Quantum
{
    ...
    {
        private static QuantumWorkspaceResourceExtension GetQuantumWorkspaceResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new QuantumWorkspaceResourceExtension(client, resource.Id);
            });
        }

        private static QuantumWorkspaceResourceExtension GetQuantumWorkspaceResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new QuantumWorkspaceResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetResourceGroupResourceExtension(resourceGroupResource).GetQuantumWorkspaces();
        }
        ...
        {
            return GetQuantumWorkspaceResourceExtension(subscriptionResource).GetQuantumWorkspacesAsync(cancellationToken);
        }
        ...
        {
            return GetQuantumWorkspaceResourceExtension(subscriptionResource).GetQuantumWorkspaces(cancellationToken);
        }
        ...
        public static AsyncPageable<ProviderDescription> GetOfferingsAsync(this SubscriptionResource subscriptionResource, string locationName, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).GetOfferingsAsync(locationName, cancellationToken);
        }
        ...
        public static Pageable<ProviderDescription> GetOfferings(this SubscriptionResource subscriptionResource, string locationName, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).GetOfferings(locationName, cancellationToken);
        }
        ...
        public static async Task<Response<CheckNameAvailabilityResult>> CheckNameAvailabilityWorkspaceAsync(this SubscriptionResource subscriptionResource, string locationName, CheckNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return await GetSubscriptionResourceExtension(subscriptionResource).CheckNameAvailabilityWorkspaceAsync(locationName, content, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response<CheckNameAvailabilityResult> CheckNameAvailabilityWorkspace(this SubscriptionResource subscriptionResource, string locationName, CheckNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            return GetSubscriptionResourceExtension(subscriptionResource).CheckNameAvailabilityWorkspace(locationName, content, cancellationToken);
        }
    }
}
