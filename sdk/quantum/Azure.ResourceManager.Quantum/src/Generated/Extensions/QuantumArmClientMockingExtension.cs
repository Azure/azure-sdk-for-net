...
namespace Azure.ResourceManager.Quantum.Mocking
{
    ...
    internal partial class QuantumArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="QuantumArmClientMockingExtension"/> class for mocking. </summary>
        protected QuantumArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="QuantumArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal QuantumArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal QuantumArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
