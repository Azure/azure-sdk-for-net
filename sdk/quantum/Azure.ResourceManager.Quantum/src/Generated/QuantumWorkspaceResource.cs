...
namespace Azure.ResourceManager.Quantum
{
    ...
    public partial class QuantumWorkspaceResource : ArmResource
    {
        ...
        internal QuantumWorkspaceResource(ArmClient client, QuantumWorkspaceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<QuantumWorkspaceResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new QuantumWorkspaceResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
