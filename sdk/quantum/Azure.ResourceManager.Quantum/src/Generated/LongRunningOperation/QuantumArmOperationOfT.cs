...
namespace Azure.ResourceManager.Quantum
{
    internal partial class QuantumArmOperation<T> : ArmOperation<T>
    {
        ...
        internal QuantumArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
