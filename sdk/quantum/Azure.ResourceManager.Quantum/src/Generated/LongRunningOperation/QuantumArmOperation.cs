...
namespace Azure.ResourceManager.Quantum
{
    internal partial class QuantumArmOperation : ArmOperation
    {
        ...
        internal QuantumArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
