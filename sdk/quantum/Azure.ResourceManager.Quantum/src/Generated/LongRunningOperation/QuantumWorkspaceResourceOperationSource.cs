...
{
    /// <summary></summary>
    internal partial class QuantumWorkspaceResourceOperationSource : IOperationSource<QuantumWorkspaceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal QuantumWorkspaceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
