...
namespace Azure.ResourceManager.Quantum.Models
{
    ...
    public partial class TargetDescription
    {
        ...
        internal TargetDescription(string id, string name, string description, IReadOnlyList<string> acceptedDataFormats, IReadOnlyList<string> acceptedContentEncodings, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
