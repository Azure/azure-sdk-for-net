...
namespace Azure.ResourceManager.Quantum.Models
{
    ...
    public partial class WorkspaceNameAvailabilityContent : IJsonModel<WorkspaceNameAvailabilityContent>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual WorkspaceNameAvailabilityContent PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        internal static RequestContent ToRequestContent(WorkspaceNameAvailabilityContent workspaceNameAvailabilityContent)
        {
            ...
            return RequestContent.Create(workspaceNameAvailabilityContent, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        WorkspaceNameAvailabilityContent IJsonModel<WorkspaceNameAvailabilityContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual WorkspaceNameAvailabilityContent JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<WorkspaceNameAvailabilityContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static WorkspaceNameAvailabilityContent DeserializeWorkspaceNameAvailabilityContent(JsonElement element, ModelReaderWriterOptions options)
        {
