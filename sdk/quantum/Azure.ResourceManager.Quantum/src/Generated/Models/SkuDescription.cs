...
namespace Azure.ResourceManager.Quantum.Models
{
    ...
    public partial class SkuDescription
    {
        ...
        internal SkuDescription(string id, string name, string version, string description, Uri restrictedAccessUri, bool? autoAdd, IReadOnlyList<string> targets, IReadOnlyList<QuotaDimension> quotaDimensions, IReadOnlyList<PricingDetail> pricingDetails, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            Name = name;
            Version = version;
