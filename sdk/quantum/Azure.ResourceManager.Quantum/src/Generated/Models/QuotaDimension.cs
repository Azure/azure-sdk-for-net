...
namespace Azure.ResourceManager.Quantum.Models
{
    ...
    public partial class QuotaDimension
    {
        ...
        internal QuotaDimension(string id, string scope, string period, float? quota, string name, string description, string unit, string unitPlural, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Scope = scope;
            Period = period;
