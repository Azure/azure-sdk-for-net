...
{
    public partial class QuantumWorkspaceData : IUtf8JsonSerializable, IJsonModel<QuantumWorkspaceData>, IPersistableModel<QuantumWorkspaceData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Usable))
            {
                ...
                builder.AppendLine($" '{Usable.ToString()}'");
            }
