...
namespace Azure.ResourceManager.Quantum.Models
{
    ...
    public partial class ProviderProperties
    {
        ...
        internal ProviderProperties(string description, string providerType, string company, string defaultEndpoint, ProviderPropertiesAad aad, ProviderPropertiesManagedApplication managedApplication, IReadOnlyList<TargetDescription> targets, IReadOnlyList<SkuDescription> skus, IReadOnlyList<QuotaDimension> quotaDimensions, IReadOnlyList<PricingDimension> pricingDimensions, Dictionary<string, BinaryData> rawData)
        {
