...
namespace Azure.ResourceManager.Quantum.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OfferingsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OfferingsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OfferingsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<OfferingsListResult>)} interface");
            }
        ...
        string IPersistableModel<OfferingsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
