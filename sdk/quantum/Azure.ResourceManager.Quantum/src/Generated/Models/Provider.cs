...
namespace Azure.ResourceManager.Quantum.Models
{
    ...
    public partial class Provider
    {
        ...
        internal Provider(string providerId, string providerSku, Uri instanceUri, string applicationName, Status? provisioningState, string resourceUsageId, Dictionary<string, BinaryData> rawData)
        {
