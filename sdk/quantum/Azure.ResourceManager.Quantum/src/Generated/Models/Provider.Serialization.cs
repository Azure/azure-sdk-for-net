...
namespace Azure.ResourceManager.Quantum.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Provider>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Provider>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Provider>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Provider>)} interface");
            }
        ...
        string IPersistableModel<Provider>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
