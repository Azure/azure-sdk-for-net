...
{
    public partial class Provider : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Provider DeserializeProvider(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
