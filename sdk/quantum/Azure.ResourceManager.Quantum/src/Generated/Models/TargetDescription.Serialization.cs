...
{
    public partial class TargetDescription : IUtf8JsonSerializable, IJsonModel<TargetDescription>, IPersistableModel<TargetDescription>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(AcceptedDataFormats))
            {
                builder.Append("  acceptedDataFormats:");
                builder.AppendLine(" [");
                foreach (var item in AcceptedDataFormats)
                {
                    if (item == null)
            ...
            if (Optional.IsCollectionDefined(AcceptedContentEncodings))
            {
                builder.Append("  acceptedContentEncodings:");
                builder.AppendLine(" [");
                foreach (var item in AcceptedContentEncodings)
                {
                    if (item == null)
