...
namespace Azure.ResourceManager.Quantum.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TargetDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TargetDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TargetDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TargetDescription>)} interface");
            }
        ...
        string IPersistableModel<TargetDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
