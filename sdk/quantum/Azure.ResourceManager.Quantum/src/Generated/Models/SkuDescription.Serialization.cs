...
namespace Azure.ResourceManager.Quantum.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SkuDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SkuDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SkuDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SkuDescription>)} interface");
            }
        ...
        string IPersistableModel<SkuDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
