...
namespace Azure.ResourceManager.Quantum.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProviderDescription>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProviderDescription>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProviderDescription>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProviderDescription>)} interface");
            }
        ...
        string IPersistableModel<ProviderDescription>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
