...
namespace Azure.ResourceManager.Quantum
{
    internal partial class OfferingsGetProviderOfferingsCollectionResultOfT : Pageable<QuantumProviderOffer>
    {
        ...
        public OfferingsGetProviderOfferingsCollectionResultOfT(Offerings client, Guid subscriptionId, AzureLocation locationName, string filter, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
