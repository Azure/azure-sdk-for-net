...
namespace Microsoft.Azure.Management.Quantum
{
    ...
    /// </summary>
    internal partial class Operations : IServiceOperations<QuantumManagementClient>, IOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal Operations(QuantumManagementClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Operation>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Quantum/operations").ToString();
