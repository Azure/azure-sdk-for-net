namespace Azure.Quantum.Jobs
{
    public partial class MiniSecretClient
    {
        ...
        public MiniSecretClient(System.Uri endpoint, Azure.Core.TokenCredential credential, Azure.Quantum.Jobs.MiniSecretClientOptions options) { }
    ...
    {
        public MiniSecretClientOptions(Azure.Quantum.Jobs.MiniSecretClientOptions.ServiceVersion version = Azure.Quantum.Jobs.MiniSecretClientOptions.ServiceVersion.V7_0) { }
