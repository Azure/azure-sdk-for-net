...
namespace Azure.Quantum.Jobs
{
    ...
    public class QuantumClient
    {
        ...
        // <summary>
        // Initializes a new instance of the <see cref="QuantumClient"/>.
        // </summary>
//TODO         public QuantumClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new MiniSecretClientOptions())
//         {
//         }
        ...
        // Initializes a new instance of the <see cref="QuantumClient"/>.
        // </summary>
//TODO         public QuantumClient(Uri endpoint, TokenCredential credential, MiniSecretClientOptions options) : this(
...
//         }
        ...
        /// <summary> Initializes a new instance of QuantumClient for mocking. </summary>
        protected QuantumClient()
        {
        }
        ...
        internal QuantumClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, string resourceGroupName, string workspaceName, Uri endpoint = null)
        {
