...
namespace Azure.Quantum.Jobs
{
    internal partial class QuotasRestClient
    {
        ...
        public QuotasRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string subscriptionId, string resourceGroupName, string workspaceName)
        {
