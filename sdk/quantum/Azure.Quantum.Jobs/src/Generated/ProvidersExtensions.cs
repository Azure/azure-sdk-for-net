...
namespace Azure.Quantum.Jobs
{
    ...
    public static partial class ProvidersExtensions
    {
            ...
            /// </param>
            public static ProviderStatusList GetStatus(this IProviders operations)
            {
            ...
            /// </param>
            public static async Task<ProviderStatusList> GetStatusAsync(this IProviders operations, CancellationToken cancellationToken = default(CancellationToken))
            {
