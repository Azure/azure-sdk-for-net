...
namespace Azure.Quantum.Jobs
{
    internal partial class ProvidersRestClient
    {
        ...
        public ProvidersRestClient(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Uri endpoint, string subscriptionId, string resourceGroupName, string workspaceName)
        {
