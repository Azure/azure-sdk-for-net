...
namespace Azure.Quantum.Jobs.Models
{
    ...
    public partial class TargetStatus
    {
        ...
        internal TargetStatus(string id, TargetAvailability? currentAvailability, long? averageQueueTime, string statusPage, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
