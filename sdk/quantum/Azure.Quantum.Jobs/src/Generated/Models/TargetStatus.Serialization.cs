...
namespace Azure.Quantum.Jobs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TargetStatus>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TargetStatus>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TargetStatus>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TargetStatus>)} interface");
            }
        ...
        string IPersistableModel<TargetStatus>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
