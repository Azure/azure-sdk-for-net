...
namespace Azure.Quantum.Jobs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JobDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JobDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JobDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JobDetails>)} interface");
            }
        ...
        string IPersistableModel<JobDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
