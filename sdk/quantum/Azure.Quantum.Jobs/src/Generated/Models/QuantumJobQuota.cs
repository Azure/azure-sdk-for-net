...
namespace Azure.Quantum.Jobs.Models
{
    ...
    public partial class QuantumJobQuota
    {
        ...
        internal QuantumJobQuota(string dimension, DimensionScope? scope, string providerId, float? utilization, float? holds, float? limit, MeterPeriod? period, Dictionary<string, BinaryData> rawData)
        {
            Dimension = dimension;
            Scope = scope;
