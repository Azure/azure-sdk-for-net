...
namespace Azure.Quantum.Jobs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ProviderStatusList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ProviderStatusList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ProviderStatusList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ProviderStatusList>)} interface");
            }
        ...
        string IPersistableModel<ProviderStatusList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
