...
namespace Azure.Quantum.Jobs.Models
{
    ...
    public partial class UsageEvent
    {
        ...
        internal UsageEvent(string dimensionId, string dimensionName, string measureUnit, float? amountBilled, float? amountConsumed, float? unitPrice, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
