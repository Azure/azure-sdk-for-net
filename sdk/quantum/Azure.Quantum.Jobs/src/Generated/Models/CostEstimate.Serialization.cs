...
namespace Azure.Quantum.Jobs.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CostEstimate>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CostEstimate>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CostEstimate>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CostEstimate>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
