...
namespace Microsoft.Azure.Quantum.Client
{
    ...
    /// </summary>
    internal partial class QuotasOperations : IServiceOperations<QuantumClient>, IQuotasOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<Quota>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
