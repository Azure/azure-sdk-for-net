...
namespace Microsoft.Azure.AppConfiguration.Models
{
    ...
    /// </summary>
    public partial class PutKeyValueHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PutKeyValueHeaders class.
        /// </summary>
        public PutKeyValueHeaders()
        {
            CustomInit();
        }
        ...
        /// the resource.</param>
        public PutKeyValueHeaders(string syncToken = default(string), string eTag = default(string))
        {
            SyncToken = syncToken;
            ETag = eTag;
            CustomInit();
