...
namespace Azure.Security.KeyVault.Storage.Models
{
    public partial class StorageAccountAttributes : IUtf8JsonSerializable
    {
        ...
        internal static StorageAccountAttributes FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeStorageAccountAttributes(document.RootElement);
        }
        ...
        internal virtual RequestContent ToRequestContent()
        {
            ...
            content.JsonWriter.WriteObjectValue<StorageAccountAttributes>(this);
            return content;
        }
    }
}
