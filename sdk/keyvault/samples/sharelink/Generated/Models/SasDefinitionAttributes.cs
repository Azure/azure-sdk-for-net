...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    public partial class SasDefinitionAttributes
    {
        ...
        internal SasDefinitionAttributes(bool? enabled, DateTimeOffset? created, DateTimeOffset? updated, int? recoverableDays, DeletionRecoveryLevel? recoveryLevel, Dictionary<string, BinaryData> rawData)
        {
            Enabled = enabled;
            Created = created;
            Updated = updated;
