...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeletedStorageBundle>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeletedStorageBundle>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeletedStorageBundle>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DeletedStorageBundle>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
