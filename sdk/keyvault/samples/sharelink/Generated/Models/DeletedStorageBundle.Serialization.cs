...
namespace Azure.Security.KeyVault.Storage.Models
{
    public partial class DeletedStorageBundle : IUtf8JsonSerializable, IJsonModel<DeletedStorageBundle>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DeletedStorageBundle>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeletedStorageBundle>)} interface");
            }
        ...
        DeletedStorageBundle IJsonModel<DeletedStorageBundle>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(DeletedStorageBundle)} does not support '{options.Format}' format.");
            }
