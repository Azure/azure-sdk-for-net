...
namespace Azure.Security.KeyVault.Storage.Models
{
    public partial class DeletedSasDefinitionBundle : IUtf8JsonSerializable, IJsonModel<DeletedSasDefinitionBundle>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<DeletedSasDefinitionBundle>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeletedSasDefinitionBundle>)} interface");
            }
        ...
        DeletedSasDefinitionBundle IJsonModel<DeletedSasDefinitionBundle>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(DeletedSasDefinitionBundle)} does not support '{options.Format}' format.");
            }
