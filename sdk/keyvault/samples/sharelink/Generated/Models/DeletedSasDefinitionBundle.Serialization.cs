...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    {
        internal static DeletedSasDefinitionBundle DeserializeDeletedSasDefinitionBundle(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
