...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeletedSasDefinitionBundle>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeletedSasDefinitionBundle>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeletedSasDefinitionBundle>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DeletedSasDefinitionBundle>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
