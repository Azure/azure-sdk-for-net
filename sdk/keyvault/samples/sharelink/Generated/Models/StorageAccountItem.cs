...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    public partial class StorageAccountItem
    {
        ...
        internal StorageAccountItem(string id, string resourceId, StorageAccountAttributes attributes, IReadOnlyDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
