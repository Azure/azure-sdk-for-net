...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    public partial class DeletedSasDefinitionBundle : SasDefinitionBundle
    {
        ...
        internal DeletedSasDefinitionBundle(string id, string secretId, string templateUri, SasTokenType? sasType, string validityPeriod, SasDefinitionAttributes attributes, IReadOnlyDictionary<string, string> tags, string recoveryId, DateTimeOffset? scheduledPurgeDate, DateTimeOffset? deletedDate, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, secretId, templateUri, sasType, validityPeriod, attributes, tags, serializedAdditionalRawData)
        {
