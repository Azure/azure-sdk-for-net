...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    {
        internal static DeletedSasDefinitionItem DeserializeDeletedSasDefinitionItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
