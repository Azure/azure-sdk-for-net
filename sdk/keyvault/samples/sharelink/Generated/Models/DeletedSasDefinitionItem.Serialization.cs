...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeletedSasDefinitionItem>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DeletedSasDefinitionItem>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DeletedSasDefinitionItem>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DeletedSasDefinitionItem>)} interface");
            }
        ...
        string IPersistableModel<DeletedSasDefinitionItem>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
