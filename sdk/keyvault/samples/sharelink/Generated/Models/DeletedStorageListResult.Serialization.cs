...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    {
        internal static DeletedStorageListResult DeserializeDeletedStorageListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
