...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    internal partial class SasDefinitionCreateParameters
    {
        ...
        internal SasDefinitionCreateParameters(string templateUri, SasTokenType sasType, string validityPeriod, SasDefinitionAttributes sasDefinitionAttributes, IDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TemplateUri = templateUri;
            SasType = sasType;
            ValidityPeriod = validityPeriod;
