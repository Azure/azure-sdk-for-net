...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    public partial class SasDefinitionItem
    {
        ...
        internal SasDefinitionItem(string id, string secretId, SasDefinitionAttributes attributes, IReadOnlyDictionary<string, string> tags, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            SecretId = secretId;
