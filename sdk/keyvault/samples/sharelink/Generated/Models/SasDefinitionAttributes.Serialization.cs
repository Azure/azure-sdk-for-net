...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SasDefinitionAttributes>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<SasDefinitionAttributes>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<SasDefinitionAttributes>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SasDefinitionAttributes)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SasDefinitionAttributes>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SasDefinitionAttributes)} does not support '{options.Format}' format.");
            }
        }
        ...
        string IPersistableModel<SasDefinitionAttributes>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
