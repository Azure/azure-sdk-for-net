...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    public partial class StorageAccountAttributes
    {
        ...
        internal StorageAccountAttributes(bool? enabled, DateTimeOffset? created, DateTimeOffset? updated, int? recoverableDays, DeletionRecoveryLevel? recoveryLevel, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
            Created = created;
            Updated = updated;
