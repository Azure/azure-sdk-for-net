...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    public partial class SasDefinitionBundle
    {
        ...
        internal SasDefinitionBundle(string id, string secretId, string templateUri, SasTokenType? sasType, string validityPeriod, SasDefinitionAttributes attributes, IReadOnlyDictionary<string, string> tags, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            SecretId = secretId;
