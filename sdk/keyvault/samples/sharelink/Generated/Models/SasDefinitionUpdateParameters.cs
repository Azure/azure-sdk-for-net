...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    internal partial class SasDefinitionUpdateParameters
    {
        ...
        internal SasDefinitionUpdateParameters(string templateUri, SasTokenType? sasType, string validityPeriod, SasDefinitionAttributes sasDefinitionAttributes, IDictionary<string, string> tags, Dictionary<string, BinaryData> rawData)
        {
