...
namespace Azure.Security.KeyVault.Storage.Models
{
    ...
    {
        internal static DeletedStorageAccountItem DeserializeDeletedStorageAccountItem(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
