...
namespace Azure.Security.KeyVault.Storage.Models
{
    public partial class DeletedStorageAccountItem
    {
        internal static DeletedStorageAccountItem DeserializeDeletedStorageAccountItem(JsonElement element)
        {
            ...
            return new DeletedStorageAccountItem(id.Value, resourceId.Value, attributes.Value, Core.Optional.ToDictionary(tags), recoveryId.Value, Core.Optional.ToNullable(scheduledPurgeDate), Core.Optional.ToNullable(deletedDate));
        }
    }
}
