...
{
    public class KeyResolverTests : KeysTestBase
    {
        public KeyResolverTests(bool isAsync) : base(isAsync)
        {
        }
        ...
        {
            Assert.ThrowsAsync<ArgumentNullException>(() => Resolver.ResolveAsync(null));
        }
