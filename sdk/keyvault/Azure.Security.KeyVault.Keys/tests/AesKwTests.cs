...
namespace Azure.Security.KeyVault.Keys.Tests
{
    public class AesKwTests
    {
        ...
        public void AesKw128()
        {
            ...
            AssertWrapAndUnwrap(KEK, CEK, EK);
        }
        ...
        [Test]
        public void AesKw128WithExcessKeyMaterial()
        {
            // Arrange
            byte[] KEK = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F };
            byte[] CEK = { 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF };
        ...
        [Test]
        public void AesKw192WithExcessKeyMaterial()
        {
            // Arrange
            byte[] KEK = { 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x1A, 0x1B, 0x1C, 0x1D, 0x1E, 0x1F };
            byte[] CEK = { 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF };
        ...
        [Test]
        public void AesKw256WithExcessKeyMaterial()
        {
            // Arrange
        ...
        private void AssertWrapAndUnwrap(byte[] KEK, byte[] CEK, byte[] EK)
        {
            using (var encryptor = AesKw.CreateEncryptor(KEK))
            {
            ...
            using (var decryptor = AesKw.CreateDecryptor(KEK))
            {
