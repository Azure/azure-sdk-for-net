...
namespace Azure.Security.KeyVault.Keys.Tests
{
    public class KeyResolverLiveTests : KeysTestBase
    {
        ...
        public KeyResolver GetResolver(TestRecording recording = null)
        {
            ...
            return InstrumentClient(new KeyResolver(recording.Credential, options));
        }
        ...
        public SecretClient GetSecretClient(TestRecording recording = null)
        {
            ...
            return InstrumentClient(new SecretClient(VaultUri, recording.Credential, recording.InstrumentClientOptions(new SecretClientOptions())));
        }
