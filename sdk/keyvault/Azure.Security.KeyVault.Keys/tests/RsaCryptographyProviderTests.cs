...
namespace Azure.Security.KeyVault.Keys.Tests
{
    public class RsaCryptographyProviderTests
    {
        ...
        public void EncryptBeforeValidDate()
        {
            ...
            InvalidOperationException ex = Assert.Throws<InvalidOperationException>(() => provider.Encrypt(EncryptionAlgorithm.RsaOaep256, new EncryptOptions(plaintext), default));
