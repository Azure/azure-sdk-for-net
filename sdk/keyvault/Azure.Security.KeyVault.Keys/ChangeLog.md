...
using that library would require code changes to use `Azure.Secutiry.KeyVault.Keys`.
This package's
...
only).
- Asynchronous and synchronous API in the `Azure.Secutiry.KeyVault.Keys` package.
