...
namespace Azure.Security.KeyVault.Keys
{
    ...
    public readonly struct KeyOperation : IEquatable<KeyOperation>
    {
        ...
        /// <summary>
        /// Gets a value that indicates the key can be exported using the <see cref="KeyClient.ExportKeyAsync(string, string, string, System.Threading.CancellationToken)"/> or <see cref="KeyClient.ExportKey(string, string, string, System.Threading.CancellationToken)"/> methods.
        /// </summary>
