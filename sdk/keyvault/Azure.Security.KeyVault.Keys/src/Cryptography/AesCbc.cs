...
namespace Azure.Security.KeyVault.Keys.Cryptography
{
    ...
    internal class AesCbc
    {
        ...
        public static readonly AesCbc CKM_AES_KEY_WRAP = new AesCbc("CKM_AES_KEY_WRAP", 256, PaddingMode.Zeros);
        ...
        public static readonly AesCbc CKM_AES_KEY_WRAP_PAD = new AesCbc("CKM_AES_KEY_WRAP_PAD", 256, PaddingMode.PKCS7);
