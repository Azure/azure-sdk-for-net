...
namespace Azure.Security.KeyVault.Keys.Cryptography
{
    ...
    public class EncryptParameters : IJsonSerializable
    {
        ...
        /// <summary>
        /// Creates an instance of the <see cref="EncryptParameters"/> class for the <see cref="EncryptionAlgorithm.CkmAesKeyWrap"/> encryption algorithm.
        /// </summary>
        /// <param name="plaintext">The plaintext to encrypt.</param>
        /// <param name="iv">Optional initialization vector. If null, a cryptographically random initialization vector will be generated using <see cref="RandomNumberGenerator"/>.</param>
        ...
        /// <summary>
        /// Creates an instance of the <see cref="EncryptParameters"/> class for the <see cref="EncryptionAlgorithm.CkmAesKeyWrapPad"/> encryption algorithm with PKCS#7 padding.
        /// </summary>
        /// <param name="plaintext">The plaintext to encrypt.</param>
        /// <param name="iv">Optional initialization vector. If null, a cryptographically random initialization vector will be generated using <see cref="RandomNumberGenerator"/>.</param>
