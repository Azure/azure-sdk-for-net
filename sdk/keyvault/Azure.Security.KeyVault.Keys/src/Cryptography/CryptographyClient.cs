...
namespace Azure.Security.KeyVault.Keys.Cryptography
{
    ...
    public class CryptographyClient : IKeyEncryptionKey
    {
        ...
        {
            using DiagnosticScope scope = _pipeline.CreateScope("CryptographyClient.Encrypt");
        ...
        {
            using DiagnosticScope scope = _pipeline.CreateScope("CryptographyClient.Decrypt");
            scope.AddAttribute("key", _keyId);
            scope.Start();
        ...
        {
            using DiagnosticScope scope = _pipeline.CreateScope("CryptographyClient.WrapKey");
            scope.AddAttribute("key", _keyId);
            scope.Start();
        ...
        {
            using DiagnosticScope scope = _pipeline.CreateScope("CryptographyClient.UnwrapKey");
            scope.AddAttribute("key", _keyId);
            scope.Start();
        ...
        {
            using DiagnosticScope scope = _pipeline.CreateScope("CryptographyClient.Sign");
            scope.AddAttribute("key", _keyId);
            scope.Start();
        ...
        {
            using DiagnosticScope scope = _pipeline.CreateScope("CryptographyClient.Verify");
            scope.AddAttribute("key", _keyId);
            scope.Start();
        ...
        public virtual async Task<SignResult> SignDataAsync(SignatureAlgorithm algorithm, byte[] data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _pipeline.CreateScope("CryptographyClient.SignData");
            scope.AddAttribute("key", _keyId);
            scope.Start();
        ...
        public virtual async Task<VerifyResult> VerifyDataAsync(SignatureAlgorithm algorithm, byte[] data, byte[] signature, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _pipeline.CreateScope("CryptographyClient.VerifyData");
            scope.AddAttribute("key", _keyId);
            scope.Start();
        ...
        private async Task InitializeAsync(string operation, CancellationToken cancellationToken)
        {
            ...
            using DiagnosticScope scope = _pipeline.CreateScope("CryptographyClient.Initialize");
            scope.AddAttribute("key", _keyId);
            scope.Start();
