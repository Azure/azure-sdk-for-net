...
namespace Microsoft.Azure.Management.KeyVault.Models
{
    ...
    /// <summary>
    /// A set of rules governing the network accessibility of a managed hsm
    /// pool.
    /// </summary>
    public partial class MHSMNetworkRuleSet
    {
        ...
        /// rules.</param>
        public MHSMNetworkRuleSet(string bypass = default(string), string defaultAction = default(string), IList<MHSMIPRule> ipRules = default(IList<MHSMIPRule>), IList<MHSMVirtualNetworkRule> virtualNetworkRules = default(IList<MHSMVirtualNetworkRule>))
        {
            Bypass = bypass;
        ...
        public IList<MHSMIPRule> IpRules { get; set; }

        /// <summary>
        /// Gets or sets the list of virtual network rules.
        /// </summary>
        [JsonProperty(PropertyName = "virtualNetworkRules")]
        public IList<MHSMVirtualNetworkRule> VirtualNetworkRules { get; set; }
