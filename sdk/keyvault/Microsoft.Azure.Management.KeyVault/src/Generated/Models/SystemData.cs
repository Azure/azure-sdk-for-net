...
namespace Microsoft.Azure.Management.KeyVault.Models
{
    ...
    public partial class SystemData
    {
        ...
        /// Initializes a new instance of the SystemData class.
        /// </summary>
        /// <param name="createdBy">The identity that created the key vault
        /// resource.</param>
        /// <param name="createdByType">The type of identity that created the
        /// key vault resource. Possible values include: 'User', 'Application',
        /// 'ManagedIdentity', 'Key'</param>
        /// <param name="createdAt">The timestamp of the key vault resource
        /// creation (UTC).</param>
        /// <param name="lastModifiedBy">The identity that last modified the
        /// key vault resource.</param>
        /// <param name="lastModifiedByType">The type of identity that last
        /// modified the key vault resource. Possible values include: 'User',
        /// 'Application', 'ManagedIdentity', 'Key'</param>
        /// <param name="lastModifiedAt">The timestamp of the key vault
        /// resource last modification (UTC).</param>
        ...
        /// <summary>
        /// Gets or sets the identity that created the key vault resource.
        /// </summary>
        [JsonProperty(PropertyName = "createdBy")]
        public string CreatedBy { get; set; }

        /// <summary>
        /// Gets or sets the type of identity that created the key vault
        ...
        /// <summary>
        /// Gets or sets the timestamp of the key vault resource creation
        /// (UTC).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the identity that last modified the key vault
        /// resource.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the type of identity that last modified the key vault
        /// resource. Possible values include: 'User', 'Application',
        /// 'ManagedIdentity', 'Key'
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the timestamp of the key vault resource last
        /// modification (UTC).
        /// </summary>
