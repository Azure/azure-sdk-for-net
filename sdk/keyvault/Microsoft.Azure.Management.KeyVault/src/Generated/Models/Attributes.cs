...
namespace Microsoft.Azure.Management.KeyVault.Models
{
    ...
    public partial class Attributes
    {
        ...
        public Attributes(bool? enabled = default(bool?), long? notBefore = default(long?), long? expires = default(long?), long? created = default(long?), long? updated = default(long?), string recoveryLevel = default(string))
        {
            Enabled = enabled;
            NotBefore = notBefore;
            Expires = expires;
