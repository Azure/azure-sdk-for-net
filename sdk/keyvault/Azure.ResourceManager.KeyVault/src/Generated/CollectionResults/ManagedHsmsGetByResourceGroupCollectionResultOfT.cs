...
namespace Azure.ResourceManager.KeyVault
{
    internal partial class ManagedHsmsGetByResourceGroupCollectionResultOfT : Pageable<ManagedHsmData>
    {
        ...
        public ManagedHsmsGetByResourceGroupCollectionResultOfT(ManagedHsms client, Guid subscriptionId, string resourceGroupName, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
