...
{
    internal partial class ManagedHsmsGetMHSMRegionsByResourceAsyncCollectionResultOfT : AsyncPageable<ManagedHsmGeoReplicatedRegion>
    {
        ...
        /// <summary> Initializes a new instance of ManagedHsmsGetMHSMRegionsByResourceAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public ManagedHsmsGetMHSMRegionsByResourceAsyncCollectionResultOfT(ManagedHsms client, Guid subscriptionId, string resourceGroupName, string name, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of ManagedHsmsGetMHSMRegionsByResourceAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of ManagedHsmsGetMHSMRegionsByResourceAsyncCollectionResultOfT as an enumerable collection. </returns>
