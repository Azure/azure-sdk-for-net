...
namespace Azure.ResourceManager.KeyVault
{
    internal partial class ManagedHsmsGetMHSMRegionsByResourceAsyncCollectionResultOfT : AsyncPageable<ManagedHsmGeoReplicatedRegion>
    {
        ...
        public ManagedHsmsGetMHSMRegionsByResourceAsyncCollectionResultOfT(ManagedHsms client, Guid subscriptionId, string resourceGroupName, string name, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
