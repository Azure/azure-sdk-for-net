...
namespace Azure.ResourceManager.KeyVault
{
    internal partial class MhsmPrivateEndpointConnectionsGetByResourceCollectionResultOfT : Pageable<ManagedHsmPrivateEndpointConnectionData>
    {
        ...
        public MhsmPrivateEndpointConnectionsGetByResourceCollectionResultOfT(MhsmPrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string name, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
