...
namespace Azure.ResourceManager.KeyVault
{
    internal partial class PrivateEndpointConnectionsGetByResourceCollectionResultOfT : Pageable<KeyVaultPrivateEndpointConnectionData>
    {
        ...
        public PrivateEndpointConnectionsGetByResourceCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string vaultName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
