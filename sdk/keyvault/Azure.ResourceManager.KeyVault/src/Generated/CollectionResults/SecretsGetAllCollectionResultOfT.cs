...
namespace Azure.ResourceManager.KeyVault
{
    internal partial class SecretsGetAllCollectionResultOfT : Pageable<KeyVaultSecretData>
    {
        ...
        public SecretsGetAllCollectionResultOfT(Secrets client, Guid subscriptionId, string resourceGroupName, string vaultName, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
