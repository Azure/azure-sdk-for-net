...
namespace Azure.ResourceManager.KeyVault
{
    internal partial class ManagedHsmsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<ManagedHsmData>
    {
        ...
        public ManagedHsmsGetByResourceGroupAsyncCollectionResultOfT(ManagedHsms client, Guid subscriptionId, string resourceGroupName, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
