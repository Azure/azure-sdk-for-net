...
namespace Azure.ResourceManager.KeyVault
{
    internal partial class VaultsGetByResourceGroupAsyncCollectionResultOfT : AsyncPageable<KeyVaultData>
    {
        ...
        public VaultsGetByResourceGroupAsyncCollectionResultOfT(Vaults client, Guid subscriptionId, string resourceGroupName, int? top, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<KeyVaultData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<KeyVaultData>.FromValues((IReadOnlyList<KeyVaultData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
