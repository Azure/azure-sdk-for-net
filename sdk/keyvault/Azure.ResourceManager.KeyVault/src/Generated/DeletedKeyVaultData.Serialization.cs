...
{
    public partial class DeletedKeyVaultData : IUtf8JsonSerializable, IJsonModel<DeletedKeyVaultData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeletedKeyVaultData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Properties))
            {
                ...
                ((IJsonModel<DeletedKeyVaultProperties>)Properties).Write(writer, options);
            }
        }
        ...
        internal static DeletedKeyVaultData DeserializeDeletedKeyVaultData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("properties"u8))
                {
                    ...
                    properties = ModelSerializationExtensions.JsonDeserialize<DeletedKeyVaultProperties>(property.Value);
                    continue;
                }
