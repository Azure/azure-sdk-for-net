...
namespace Azure.ResourceManager.KeyVault
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DeletedKeyVaultData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DeletedKeyVaultData DeserializeDeletedKeyVaultData(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new DeletedKeyVaultData(id, name, type, systemData.Value, properties.Value, serializedAdditionalRawData);
        }
