...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class KeyVaultKeyData : ResourceData
    {
        ...
        internal KeyVaultKeyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, IReadOnlyDictionary<string, string> tags, KeyAttributes attributes, JsonWebKeyType? keyType, IList<JsonWebKeyOperation> keyOps, int? keySize, JsonWebKeyCurveName? curveName, Uri keyUri, string keyUriWithVersion, RotationPolicy rotationPolicy, KeyReleasePolicy releasePolicy, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Tags = tags;
