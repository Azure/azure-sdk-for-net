...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class DeletedVaultOperations : ResourceOperationsBase<SubscriptionResourceIdentifier, DeletedVault>
    {
        ...
        protected internal DeletedVaultOperations(OperationsBase options, SubscriptionResourceIdentifier id) : base(options, id)
        {
        ...
        /// <inheritdoc />
        public async override Task<Response<DeletedVault>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <inheritdoc />
        public override Response<DeletedVault> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeletedVaultOperations.Get");
            scope.Start();
            try
        ...
        public async Task<Response> PurgeAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Permanently deletes the specified vault. aka Purges the deleted Azure key vault. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public Response Purge(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeletedVaultOperations.Purge");
            scope.Start();
            try
        ...
        /// <summary> Permanently deletes the specified vault. aka Purges the deleted Azure key vault. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async Task<DeletedVaultsPurgeOperation> StartPurgeAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <summary> Permanently deletes the specified vault. aka Purges the deleted Azure key vault. </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public DeletedVaultsPurgeOperation StartPurge(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("DeletedVaultOperations.StartPurge");
            scope.Start();
            try
