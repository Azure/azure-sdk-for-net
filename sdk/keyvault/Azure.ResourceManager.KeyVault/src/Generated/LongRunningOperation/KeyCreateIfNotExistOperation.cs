...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class KeyCreateIfNotExistOperation : Operation<VaultKey>
    {
        private readonly OperationOrResponseInternals<VaultKey> _operation;

        /// <summary> Initializes a new instance of KeyCreateIfNotExistOperation for mocking. </summary>
        protected KeyCreateIfNotExistOperation()
        {
        }

        internal KeyCreateIfNotExistOperation(ArmResource operationsBase, Response<KeyData> response)
        {
