...
{
    /// <summary></summary>
    internal partial class KeyVaultPrivateEndpointConnectionResourceOperationSource : IOperationSource<KeyVaultPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal KeyVaultPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
