...
{
    /// <summary></summary>
    internal partial class ManagedHsmPrivateEndpointConnectionResourceOperationSource : IOperationSource<ManagedHsmPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedHsmPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
