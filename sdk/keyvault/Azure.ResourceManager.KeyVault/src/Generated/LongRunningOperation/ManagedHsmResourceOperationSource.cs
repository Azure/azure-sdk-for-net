...
{
    /// <summary></summary>
    internal partial class ManagedHsmResourceOperationSource : IOperationSource<ManagedHsmResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ManagedHsmResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
