...
namespace Azure.ResourceManager.KeyVault
{
    internal partial class KeyVaultArmOperation<T> : ArmOperation<T>
    {
        ...
        internal KeyVaultArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
