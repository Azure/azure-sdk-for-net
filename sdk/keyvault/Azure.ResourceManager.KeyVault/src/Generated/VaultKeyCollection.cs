...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class VaultKeyCollection : ArmCollection, IEnumerable<VaultKeyResource>, IAsyncEnumerable<VaultKeyResource>
    {
        ...
        public virtual async Task<ArmOperation<VaultKeyResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string keyName, VaultKeyCreateOrUpdateInfo info, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _vaultKeyKeysRestClient.CreateIfNotExistAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, keyName, info, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentException"> <paramref name="keyName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="keyName"/> or <paramref name="info"/> is null. </exception>
        public virtual ArmOperation<VaultKeyResource> CreateOrUpdate(WaitUntil waitUntil, string keyName, VaultKeyCreateOrUpdateInfo info, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(keyName, nameof(keyName));
            Argument.AssertNotNull(info, nameof(info));
            ...
            try
            {
                var response = _vaultKeyKeysRestClient.CreateIfNotExist(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, keyName, info, cancellationToken);
                var operation = new KeyVaultArmOperation<VaultKeyResource>(Response.FromValue(new VaultKeyResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
