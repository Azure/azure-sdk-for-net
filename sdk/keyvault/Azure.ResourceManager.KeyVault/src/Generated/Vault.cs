...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public class Vault : VaultOperations
    {
        ...
        internal Vault(ResourceOperationsBase options, VaultData resource) : base(options, resource.Id)
        {
            Data = resource;
        }
        ...
        /// <inheritdoc />
        protected override Vault GetResource(CancellationToken cancellation = default)
        {
            return this;
        }

        /// <inheritdoc />
        protected override Task<Vault> GetResourceAsync(CancellationToken cancellation = default)
        {
