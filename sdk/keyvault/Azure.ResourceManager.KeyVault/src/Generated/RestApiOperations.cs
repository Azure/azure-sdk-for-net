...
namespace KeyVaultManagementClient
{
    ...
    public partial class RestApiOperations : ResourceOperationsBase<ResourceGroupResourceIdentifier, RestApi>
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="RestApiOperations"/> class for mocking. </summary>
        ...
        protected internal RestApiOperations(ResourceOperationsBase options, ResourceGroupResourceIdentifier id) : base(options, id)
        {
        ...
        /// <inheritdoc />
        public async override Task<Response<RestApi>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RestApiOperations.Get");
            scope.Start();
            try
            {
                var response = await _restClient.GetAsync(Id.ResourceGroupName, Id.Name, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new RestApi(this, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <inheritdoc />
        public override Response<RestApi> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("RestApiOperations.Get");
            scope.Start();
            try
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RestApiOperations.Delete");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RestApiOperations.StartDelete");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<RestApiData>> UpdateAsync(VaultPatchParameters parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
            ...
            using var scope = _clientDiagnostics.CreateScope("RestApiOperations.Update");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="parameters"/> is null. </exception>
        public virtual Response<RestApiData> Update(VaultPatchParameters parameters, CancellationToken cancellationToken = default)
        {
            if (parameters == null)
            {
                throw new ArgumentNullException(nameof(parameters));
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RestApiOperations.GetDeleted");
            scope.Start();
            try
            {
        ...
        public virtual async Task<Response<CheckNameAvailabilityResult>> CheckNameAvailabilityAsync(VaultCheckNameAvailabilityParameters vaultName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _clientDiagnostics.CreateScope("RestApiOperations.CheckNameAvailability");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RestApiOperations.ListPrivateLinkResourcesByVault");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RestApiOperations.PurgeDeleted");
            scope.Start();
            try
            {
        ...
        {
            using var scope = _clientDiagnostics.CreateScope("RestApiOperations.StartPurgeDeleted");
            scope.Start();
            try
            {
        ...
        /// <summary> Gets a list of PrivateEndpointConnections in the RestApi. </summary>
        /// <returns> An object representing collection of PrivateEndpointConnections and their operations over a RestApi. </returns>
