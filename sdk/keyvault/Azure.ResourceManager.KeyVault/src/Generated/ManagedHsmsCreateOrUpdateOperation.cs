...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class ManagedHsmsCreateOrUpdateOperation : Operation<ManagedHsm>, IOperationSource<ManagedHsm>
    {
        ...
        internal ManagedHsmsCreateOrUpdateOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ManagedHsm>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "ManagedHsmsCreateOrUpdateOperation");
        }
        /// <inheritdoc />
