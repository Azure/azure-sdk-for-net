...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class DeletedKeyVaultResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> PurgeDeletedAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _deletedKeyVaultVaultsRestClient.CreatePurgeDeletedRequest(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name);
                var response = await _deletedKeyVaultVaultsRestClient.PurgeDeletedAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new KeyVaultArmOperation(_deletedKeyVaultVaultsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation PurgeDeleted(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _deletedKeyVaultVaultsRestClient.CreatePurgeDeletedRequest(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name);
                var response = _deletedKeyVaultVaultsRestClient.PurgeDeleted(message, cancellationToken);
                var operation = new KeyVaultArmOperation(_deletedKeyVaultVaultsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
