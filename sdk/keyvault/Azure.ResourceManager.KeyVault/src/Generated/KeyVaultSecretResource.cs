...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class KeyVaultSecretResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<KeyVaultSecretResource>> UpdateAsync(WaitUntil waitUntil, KeyVaultSecretCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _secretsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, KeyVaultSecretCreateOrUpdateContent.ToRequestContent(content), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<KeyVaultSecretData> response = Response.FromValue(KeyVaultSecretData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<KeyVaultSecretResource> Update(WaitUntil waitUntil, KeyVaultSecretCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
