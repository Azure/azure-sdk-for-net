...
{
    internal partial class PrivateEndpointConnectionsGetByResourceCollectionResultOfT : Pageable<KeyVaultPrivateEndpointConnectionData>
    {
        ...
        /// <summary> Initializes a new instance of PrivateEndpointConnectionsGetByResourceCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrivateEndpointConnectionsGetByResourceCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string vaultName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of PrivateEndpointConnectionsGetByResourceCollectionResultOfT as an enumerable collection. </summary>
        ...
        public override IEnumerable<Page<KeyVaultPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
