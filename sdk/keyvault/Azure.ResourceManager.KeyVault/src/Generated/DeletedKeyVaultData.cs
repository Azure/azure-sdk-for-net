...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class DeletedKeyVaultData : ResourceData
    {
        ...
        internal DeletedKeyVaultData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, DeletedKeyVaultProperties properties) : base(id, name, resourceType, systemData)
        {
