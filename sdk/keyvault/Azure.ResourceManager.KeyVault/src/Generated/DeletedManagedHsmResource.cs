...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class DeletedManagedHsmResource : ArmResource
    {
        ...
        {
            _deletedManagedHsmClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.KeyVault", ResourceType.Namespace, Diagnostics);
        ...
        {
            using var scope = _deletedManagedHsmClientDiagnostics.CreateScope("DeletedManagedHsmResource.Get");
            scope.Start();
            try
            {
                var response = await _deletedManagedHsmRestClient.GetDeletedAsync(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DeletedManagedHsmResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _deletedManagedHsmRestClient.GetDeleted(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DeletedManagedHsmResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            using var scope = _deletedManagedHsmClientDiagnostics.CreateScope("DeletedManagedHsmResource.PurgeDeleted");
            scope.Start();
            try
            {
                var response = await _deletedManagedHsmRestClient.PurgeDeletedAsync(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new KeyVaultArmOperation(_deletedManagedHsmClientDiagnostics, Pipeline, _deletedManagedHsmRestClient.CreatePurgeDeletedRequest(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation PurgeDeleted(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _deletedManagedHsmRestClient.PurgeDeleted(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name, cancellationToken);
                var operation = new KeyVaultArmOperation(_deletedManagedHsmClientDiagnostics, Pipeline, _deletedManagedHsmRestClient.CreatePurgeDeletedRequest(Id.SubscriptionId, new AzureLocation(Id.Parent.Name), Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
