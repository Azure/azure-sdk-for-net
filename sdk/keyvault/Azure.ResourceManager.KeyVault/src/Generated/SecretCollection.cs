...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class SecretCollection : ArmCollection, IEnumerable<SecretResource>, IAsyncEnumerable<SecretResource>
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="secretName"/> or <paramref name="info"/> is null. </exception>
        public virtual async Task<ArmOperation<SecretResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string secretName, SecretCreateOrUpdateInfo info, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _secretRestClient.CreateOrUpdateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, secretName, info, cancellationToken).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentException"> <paramref name="secretName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="secretName"/> or <paramref name="info"/> is null. </exception>
        public virtual ArmOperation<SecretResource> CreateOrUpdate(WaitUntil waitUntil, string secretName, SecretCreateOrUpdateInfo info, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(secretName, nameof(secretName));
            Argument.AssertNotNull(info, nameof(info));
            ...
            try
            {
                var response = _secretRestClient.CreateOrUpdate(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, secretName, info, cancellationToken);
                var operation = new KeyVaultArmOperation<SecretResource>(Response.FromValue(new SecretResource(Client, response), response.GetRawResponse()));
                if (waitUntil == WaitUntil.Completed)
