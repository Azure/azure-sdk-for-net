...
{
    internal partial class ManagedHsmPrivateEndpointConnectionsListResult : IUtf8JsonSerializable, IJsonModel<ManagedHsmPrivateEndpointConnectionsListResult>, IPersistableModel<ManagedHsmPrivateEndpointConnectionsListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedHsmPrivateEndpointConnectionsListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ManagedHsmPrivateEndpointConnectionsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedHsmPrivateEndpointConnectionsListResult)} does not support '{format}' format.");
            }
