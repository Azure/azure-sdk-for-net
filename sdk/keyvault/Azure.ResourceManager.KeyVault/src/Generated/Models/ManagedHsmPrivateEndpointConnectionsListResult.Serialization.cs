...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedHsmPrivateEndpointConnectionsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedHsmPrivateEndpointConnectionsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedHsmPrivateEndpointConnectionsListResult>)} interface");
            }
        ...
        string IPersistableModel<ManagedHsmPrivateEndpointConnectionsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
