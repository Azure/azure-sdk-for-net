...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedHsmIPRule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedHsmIPRule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedHsmIPRule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedHsmIPRule>)} interface");
            }
        ...
        string IPersistableModel<ManagedHsmIPRule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
