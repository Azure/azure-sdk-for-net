...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    internal partial class MhsmPrivateEndpointConnectionsListResult
    {
        ...
        {
            Value = new ChangeTrackingList<MhsmPrivateEndpointConnection>();
        }
        ...
        internal MhsmPrivateEndpointConnectionsListResult(IReadOnlyList<MhsmPrivateEndpointConnection> value, string nextLink)
        {
            Value = value;
            NextLink = nextLink;
        }
        ...
        public IReadOnlyList<MhsmPrivateEndpointConnection> Value { get; }
