...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedHsmGeoReplicatedRegion>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedHsmGeoReplicatedRegion>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedHsmGeoReplicatedRegion>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedHsmGeoReplicatedRegion>)} interface");
            }
        ...
        string IPersistableModel<ManagedHsmGeoReplicatedRegion>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
