...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        internal static DeletedManagedHsmProperties DeserializeDeletedManagedHsmProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
