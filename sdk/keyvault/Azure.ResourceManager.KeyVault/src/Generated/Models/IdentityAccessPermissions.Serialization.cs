...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IdentityAccessPermissions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IdentityAccessPermissions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IdentityAccessPermissions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IdentityAccessPermissions>)} interface");
            }
        ...
        string IPersistableModel<IdentityAccessPermissions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
