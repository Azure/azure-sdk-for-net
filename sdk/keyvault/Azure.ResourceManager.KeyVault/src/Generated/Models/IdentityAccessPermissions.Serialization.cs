...
{
    public partial class IdentityAccessPermissions : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static IdentityAccessPermissions DeserializeIdentityAccessPermissions(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
