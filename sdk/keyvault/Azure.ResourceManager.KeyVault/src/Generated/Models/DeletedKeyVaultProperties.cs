...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class DeletedKeyVaultProperties
    {
        ...
        internal DeletedKeyVaultProperties(ResourceIdentifier vaultId, AzureLocation? location, DateTimeOffset? deletedOn, DateTimeOffset? scheduledPurgeOn, IReadOnlyDictionary<string, string> tags, bool? purgeProtectionEnabled, Dictionary<string, BinaryData> rawData)
        {
            VaultId = vaultId;
            Location = location;
            DeletedOn = deletedOn;
