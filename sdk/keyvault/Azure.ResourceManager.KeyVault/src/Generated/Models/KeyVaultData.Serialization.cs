...
{
    public partial class KeyVaultData : Core.IUtf8JsonSerializable
    {
        ...
        internal static KeyVaultData DeserializeKeyVaultData(JsonElement element)
        {
            ...
            return new KeyVaultData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, properties);
        }
    }
}
