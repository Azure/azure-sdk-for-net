...
namespace Azure.ResourceManager.KeyVault
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyVaultData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyVaultData>)} interface");
            }
        ...
        string IPersistableModel<KeyVaultData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
