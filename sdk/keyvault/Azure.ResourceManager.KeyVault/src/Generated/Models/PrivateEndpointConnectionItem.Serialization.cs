...
namespace Azure.ResourceManager.KeyVault.Models
{
    public partial class PrivateEndpointConnectionItem
    {
        internal static PrivateEndpointConnectionItem DeserializePrivateEndpointConnectionItem(JsonElement element)
        {
            ...
            return new PrivateEndpointConnectionItem(id.Value, etag.Value, privateEndpoint.Value, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
