...
{
    /// <summary> The ManagedHsmKeyRotationPolicyAttributes. </summary>
    public partial class ManagedHsmKeyRotationPolicyAttributes
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ManagedHsmKeyRotationPolicyAttributes"/>. </summary>
        ...
        internal ManagedHsmKeyRotationPolicyAttributes(long? created, long? updated, string expiryTime, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Created = created;
            Updated = updated;
        ...
        /// <summary> The expiration time for the new key version. It should be in ISO8601 format. Eg: 'P90D', 'P1Y'. </summary>
        [WirePath("expiryTime")]
