...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultNameAvailabilityContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyVaultNameAvailabilityContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultNameAvailabilityContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyVaultNameAvailabilityContent>)} interface");
            }
        ...
        string IPersistableModel<KeyVaultNameAvailabilityContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
