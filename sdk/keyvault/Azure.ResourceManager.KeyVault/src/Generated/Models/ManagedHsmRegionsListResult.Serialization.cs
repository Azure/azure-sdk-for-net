...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        internal static ManagedHsmRegionsListResult DeserializeManagedHsmRegionsListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
