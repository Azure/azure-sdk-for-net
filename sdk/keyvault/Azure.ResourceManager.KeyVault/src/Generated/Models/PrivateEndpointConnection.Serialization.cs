...
namespace Azure.ResourceManager.KeyVault.Models
{
    public partial class PrivateEndpointConnection : IUtf8JsonSerializable
    {
        ...
        internal static PrivateEndpointConnection DeserializePrivateEndpointConnection(JsonElement element)
        {
            ...
            return new PrivateEndpointConnection(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, location.HasValue ? location.Value : null, new ChangeTrackingDictionary<string, string>(tags), privateEndpoint.HasValue ? privateEndpoint.Value : null, privateLinkServiceConnectionState.HasValue ? privateLinkServiceConnectionState.Value : null, provisioningState.HasValue ? provisioningState.Value : (PrivateEndpointConnectionProvisioningState?)null);
        }
    }
}
