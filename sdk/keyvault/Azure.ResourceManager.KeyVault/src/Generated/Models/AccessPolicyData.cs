...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AccessPolicyData. </summary>
        ...
        public AccessPolicyData(Guid tenantId, string objectId, IdentityAccessPermissions permissions)
        {
            if (objectId == null)
            {
        ...
        /// <param name="permissions"> Permissions the identity has for keys, secrets and certificates. </param>
        internal AccessPolicyData(Guid tenantId, string objectId, Guid? applicationId, IdentityAccessPermissions permissions)
        {
            TenantId = tenantId;
            ObjectId = objectId;
