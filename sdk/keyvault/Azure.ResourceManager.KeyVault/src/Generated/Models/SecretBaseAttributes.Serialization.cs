...
{
    public partial class SecretBaseAttributes : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecretBaseAttributes DeserializeSecretBaseAttributes(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
