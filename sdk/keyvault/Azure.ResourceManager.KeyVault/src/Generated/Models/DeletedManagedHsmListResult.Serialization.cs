...
{
    internal partial class DeletedManagedHsmListResult : IUtf8JsonSerializable, IJsonModel<DeletedManagedHsmListResult>, IPersistableModel<DeletedManagedHsmListResult>
    {
        ...
        void IJsonModel<DeletedManagedHsmListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeletedManagedHsmListResult)} does not support '{format}' format.");
            }
