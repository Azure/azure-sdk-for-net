...
{
    public partial class SecretProperties : IUtf8JsonSerializable, IJsonModel<SecretProperties>, IPersistableModel<SecretProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Attributes))
            {
                ...
                AppendChildObject(builder, Attributes, options, 2);
            }
