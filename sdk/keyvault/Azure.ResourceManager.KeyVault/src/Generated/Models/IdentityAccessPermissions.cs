...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class IdentityAccessPermissions
    {
        ...
        internal IdentityAccessPermissions(IList<IdentityAccessKeyPermission> keys, IList<IdentityAccessSecretPermission> secrets, IList<IdentityAccessCertificatePermission> certificates, IList<IdentityAccessStoragePermission> storage, Dictionary<string, BinaryData> rawData)
        {
            Keys = keys;
            Secrets = secrets;
