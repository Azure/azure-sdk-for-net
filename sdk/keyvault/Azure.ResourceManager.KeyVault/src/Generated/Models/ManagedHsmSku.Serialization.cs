...
{
    public partial class ManagedHsmSku : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ManagedHsmSku DeserializeManagedHsmSku(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
