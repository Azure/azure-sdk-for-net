...
{
    public partial class ManagedHsmSku : IUtf8JsonSerializable, IJsonModel<ManagedHsmSku>, IPersistableModel<ManagedHsmSku>
    {
        ...
        void IJsonModel<ManagedHsmSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ManagedHsmSku)} does not support '{format}' format.");
            }
