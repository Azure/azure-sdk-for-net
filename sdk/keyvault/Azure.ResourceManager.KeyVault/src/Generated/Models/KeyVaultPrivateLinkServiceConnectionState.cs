...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class KeyVaultPrivateLinkServiceConnectionState
    {
        ...
        internal KeyVaultPrivateLinkServiceConnectionState(KeyVaultPrivateEndpointServiceConnectionStatus? status, string description, VaultActionsRequiredMessage? actionsRequired)
        {
            Status = status;
