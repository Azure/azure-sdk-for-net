...
{
    /// <summary> The ManagedHsmTrigger. </summary>
    public partial class ManagedHsmTrigger
    {
        ...
        /// <summary> Initializes a new instance of <see cref="ManagedHsmTrigger"/>. </summary>
        ...
        internal ManagedHsmTrigger(string timeAfterCreate, string timeBeforeExpiry, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
