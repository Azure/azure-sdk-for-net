...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class KeyVaultCreateOrUpdateContent
    {
        ...
        internal KeyVaultCreateOrUpdateContent(AzureLocation location, IDictionary<string, string> tags, KeyVaultProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Location = location;
            Tags = tags;
            Properties = properties;
