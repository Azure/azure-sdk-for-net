...
{
    internal partial class DeletedVaultListResult : IUtf8JsonSerializable, IJsonModel<DeletedVaultListResult>, IPersistableModel<DeletedVaultListResult>
    {
        ...
        void IJsonModel<DeletedVaultListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DeletedVaultListResult)} does not support '{format}' format.");
            }
