...
namespace KeyVaultManagementClient.Models
{
    ...
    public partial class RestApiData : Resource<ResourceGroupResourceIdentifier>
    {
        /// <summary> Initializes a new instance of RestApiData. </summary>
        /// <param name="properties"> Properties of the vault. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="properties"/> is null. </exception>
        internal RestApiData(VaultProperties properties)
        {
            if (properties == null)
            {
        ...
        /// <param name="properties"> Properties of the vault. </param>
        internal RestApiData(ResourceGroupResourceIdentifier id, string name, ResourceType type, string location, IReadOnlyDictionary<string, string> tags, SystemData systemData, VaultProperties properties) : base(id, name, type)
        {
            Location = location;
            Tags = tags;
