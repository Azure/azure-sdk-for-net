...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class SecretBaseAttributes
    {
        ...
        internal SecretBaseAttributes(bool? enabled, DateTimeOffset? notBefore, DateTimeOffset? expires, DateTimeOffset? created, DateTimeOffset? updated, Dictionary<string, BinaryData> rawData)
        {
            Enabled = enabled;
            NotBefore = notBefore;
            Expires = expires;
