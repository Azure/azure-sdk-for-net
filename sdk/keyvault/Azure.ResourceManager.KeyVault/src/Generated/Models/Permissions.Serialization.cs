...
namespace Azure.ResourceManager.KeyVault.Models
{
    public partial class Permissions : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            if (Optional.IsDefined(Certificates))
            {
        ...
        internal static Permissions DeserializePermissions(JsonElement element)
        {
            ...
            return new Permissions(new ChangeTrackingList<KeyPermissions>(keys), new ChangeTrackingList<SecretPermissions>(secrets), new ChangeTrackingList<CertificatePermissions>(certificates), new ChangeTrackingList<StoragePermissions>(storage));
        }
    }
}
