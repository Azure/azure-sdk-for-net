...
namespace Azure.ResourceManager.KeyVault.Models
{
    public partial class KeyVaultSku : IUtf8JsonSerializable, IJsonModel<KeyVaultSku>
    {
        ...
        void IJsonModel<KeyVaultSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(KeyVaultSku)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<KeyVaultSku>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(KeyVaultSku)} does not support '{options.Format}' format.");
            }
        }
