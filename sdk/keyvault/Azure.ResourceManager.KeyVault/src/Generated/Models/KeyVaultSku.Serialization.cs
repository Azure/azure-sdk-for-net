...
{
    public partial class KeyVaultSku : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KeyVaultSku DeserializeKeyVaultSku(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
