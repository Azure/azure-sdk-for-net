...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class KeyVaultAccessPolicyParameters : ResourceData
    {
        ...
        internal KeyVaultAccessPolicyParameters(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, KeyVaultAccessPolicyProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Location = location;
            Properties = properties;
