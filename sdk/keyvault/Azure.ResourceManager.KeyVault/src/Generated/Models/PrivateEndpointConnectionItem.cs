...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class PrivateEndpointConnectionItem
    {
        ...
        internal PrivateEndpointConnectionItem(string id, string etag, PrivateEndpoint privateEndpoint, PrivateLinkServiceConnectionState privateLinkServiceConnectionState, PrivateEndpointConnectionProvisioningState? provisioningState)
        {
            Id = id;
            Etag = etag;
