...
namespace Azure.ResourceManager.KeyVault
{
    public partial class KeyVaultPrivateEndpointConnectionData : IUtf8JsonSerializable
    {
        ...
        internal static KeyVaultPrivateEndpointConnectionData DeserializeKeyVaultPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            return new KeyVaultPrivateEndpointConnectionData(id, name, type, systemData, Optional.ToNullable(etag), privateEndpoint, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(location), Optional.ToDictionary(tags));
        }
    }
}
