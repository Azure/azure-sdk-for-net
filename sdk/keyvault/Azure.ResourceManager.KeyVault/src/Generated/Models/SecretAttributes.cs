...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class SecretAttributes : SecretBaseAttributes
    {
        ...
        internal SecretAttributes(bool? enabled, DateTimeOffset? notBefore, DateTimeOffset? expires, DateTimeOffset? created, DateTimeOffset? updated, Dictionary<string, BinaryData> rawData) : base(enabled, notBefore, expires, created, updated, rawData)
        {
        }
    }
}
