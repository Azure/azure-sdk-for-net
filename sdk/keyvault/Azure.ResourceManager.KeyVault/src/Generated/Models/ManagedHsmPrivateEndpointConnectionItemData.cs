...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class ManagedHsmPrivateEndpointConnectionItemData
    {
        ...
        internal ManagedHsmPrivateEndpointConnectionItemData(ResourceIdentifier id, ETag? etag, SubResource privateEndpoint, ManagedHsmPrivateLinkServiceConnectionState privateLinkServiceConnectionState, ManagedHsmPrivateEndpointConnectionProvisioningState? provisioningState, Dictionary<string, BinaryData> rawData)
        {
            Id = id;
            ETag = etag;
