...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class ManagedHsmKeyAttributes
    {
        ...
        internal ManagedHsmKeyAttributes(bool? enabled, long? notBefore, long? expires, long? created, long? updated, DeletionRecoveryLevel? recoveryLevel, bool? exportable, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Enabled = enabled;
            NotBefore = notBefore;
            Expires = expires;
