...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class MhsmPrivateLinkResource : ManagedHsmResource
    {
        ...
        internal MhsmPrivateLinkResource(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ManagedHsmSku sku, string groupId, IReadOnlyList<string> requiredMembers, IList<string> requiredZoneNames) : base(id, name, type, systemData, tags, location, sku)
        {
            GroupId = groupId;
