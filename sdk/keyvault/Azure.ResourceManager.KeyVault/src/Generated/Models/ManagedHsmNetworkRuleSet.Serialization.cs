...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ManagedHsmNetworkRuleSet>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ManagedHsmNetworkRuleSet>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ManagedHsmNetworkRuleSet>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ManagedHsmNetworkRuleSet>)} interface");
            }
        ...
        string IPersistableModel<ManagedHsmNetworkRuleSet>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
