...
{
    public partial class MhsmPrivateEndpointConnection : IUtf8JsonSerializable
    {
        ...
        internal static MhsmPrivateEndpointConnection DeserializeMhsmPrivateEndpointConnection(JsonElement element)
        {
            ...
            return new MhsmPrivateEndpointConnection(id.Value, name.Value, type.Value, location.Value, sku.Value, Optional.ToDictionary(tags), systemData.Value, etag.Value, privateEndpoint.Value, privateLinkServiceConnectionState.Value, Optional.ToNullable(provisioningState));
        }
    }
}
