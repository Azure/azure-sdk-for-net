...
{
    public partial class ManagedHSMSecurityDomainProperties : IUtf8JsonSerializable, IJsonModel<ManagedHSMSecurityDomainProperties>, IPersistableModel<ManagedHSMSecurityDomainProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ActivationStatus))
            {
                ...
                builder.AppendLine($" '{ActivationStatus.ToString()}'");
            }
