...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultVirtualNetworkRule>)this).Write(writer, ModelSerializationExtensions.WireOptions);
