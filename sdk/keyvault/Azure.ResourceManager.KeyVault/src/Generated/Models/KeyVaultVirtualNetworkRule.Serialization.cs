...
{
    public partial class KeyVaultVirtualNetworkRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KeyVaultVirtualNetworkRule DeserializeKeyVaultVirtualNetworkRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
