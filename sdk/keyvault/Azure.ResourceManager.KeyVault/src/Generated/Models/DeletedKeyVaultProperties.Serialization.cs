...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        internal static DeletedKeyVaultProperties DeserializeDeletedKeyVaultProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
