...
namespace Azure.ResourceManager.KeyVault.Models
{
    internal partial class SecretListResult : IUtf8JsonSerializable, IJsonModel<SecretListResult>
    {
        ...
        void IJsonModel<SecretListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SecretListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SecretListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SecretListResult)} does not support '{options.Format}' format.");
            }
        }
