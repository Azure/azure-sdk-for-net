...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SecretListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SecretListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SecretListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SecretListResult>)} interface");
            }
        ...
        string IPersistableModel<SecretListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
