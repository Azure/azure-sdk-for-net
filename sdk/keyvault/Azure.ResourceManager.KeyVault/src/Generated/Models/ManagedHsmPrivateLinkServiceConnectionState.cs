...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    public partial class ManagedHsmPrivateLinkServiceConnectionState
    {
        ...
        internal ManagedHsmPrivateLinkServiceConnectionState(ManagedHsmPrivateEndpointServiceConnectionStatus? status, string description, ManagedHsmActionsRequiredMessage? actionsRequired, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
