...
namespace Azure.ResourceManager.KeyVault.Models
{
    public partial class KeyVaultNameAvailabilityResult
    {
        internal static KeyVaultNameAvailabilityResult DeserializeKeyVaultNameAvailabilityResult(JsonElement element)
        {
            ...
            Core.Optional<KeyVaultNameUnavailableReason> reason = default;
            ...
            return new KeyVaultNameAvailabilityResult(Core.Optional.ToNullable(nameAvailable), Core.Optional.ToNullable(reason), message.Value);
        }
    }
}
