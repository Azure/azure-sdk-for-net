...
namespace Azure.ResourceManager.KeyVault.Models
{
    ...
    {
        internal static KeyVaultNameAvailabilityResult DeserializeKeyVaultNameAvailabilityResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
