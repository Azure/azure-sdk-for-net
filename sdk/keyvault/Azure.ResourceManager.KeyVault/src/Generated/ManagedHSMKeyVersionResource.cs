...
namespace Azure.ResourceManager.KeyVault
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="ManagedHSMKeyVersionResource"/>
    /// from an instance of <see cref="ArmClient"/> using the GetManagedHSMKeyVersionResource method.
    /// Otherwise you can get one from its parent resource <see cref="ManagedHSMKeyResource"/> using the GetManagedHSMKeyVersion method.
    /// </summary>
    public partial class ManagedHSMKeyVersionResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="ManagedHSMKeyVersionResource"/> instance. </summary>
        ...
        /// <summary> Initializes a new instance of the <see cref="ManagedHSMKeyVersionResource"/> class for mocking. </summary>
        protected ManagedHSMKeyVersionResource()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="ManagedHSMKeyVersionResource"/> class. </summary>
        ...
        public virtual async Task<Response<ManagedHSMKeyVersionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<ManagedHSMKeyVersionResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _managedHSMKeyVersionManagedHsmKeysClientDiagnostics.CreateScope("ManagedHSMKeyVersionResource.Get");
            scope.Start();
            try
