...
{
    internal partial class PrivateEndpointConnectionsGetByResourceAsyncCollectionResultOfT : AsyncPageable<KeyVaultPrivateEndpointConnectionData>
    {
        ...
        public PrivateEndpointConnectionsGetByResourceAsyncCollectionResultOfT(PrivateEndpointConnections client, Guid subscriptionId, string resourceGroupName, string vaultName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        public override async IAsyncEnumerable<Page<KeyVaultPrivateEndpointConnectionData>> AsPages(string continuationToken, int? pageSizeHint)
        {
