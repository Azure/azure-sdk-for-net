...
namespace Azure.ResourceManager.KeyVault
{
    ...
    public partial class DeletedVaultResource : ArmResource
    {
        ...
        public virtual async Task<Response<DeletedVaultResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _deletedVaultVaultsRestClient.GetDeletedAsync(Id.SubscriptionId, AzureLocation.Parse(Id.Parent.Name), Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<DeletedVaultResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _deletedVaultVaultsRestClient.GetDeleted(Id.SubscriptionId, AzureLocation.Parse(Id.Parent.Name), Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new DeletedVaultResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation> PurgeDeletedAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _deletedVaultVaultsRestClient.PurgeDeletedAsync(Id.SubscriptionId, AzureLocation.Parse(Id.Parent.Name), Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new KeyVaultArmOperation(_deletedVaultVaultsClientDiagnostics, Pipeline, _deletedVaultVaultsRestClient.CreatePurgeDeletedRequest(Id.SubscriptionId, AzureLocation.Parse(Id.Parent.Name), Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation PurgeDeleted(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _deletedVaultVaultsRestClient.PurgeDeleted(Id.SubscriptionId, AzureLocation.Parse(Id.Parent.Name), Id.Name, cancellationToken);
                var operation = new KeyVaultArmOperation(_deletedVaultVaultsClientDiagnostics, Pipeline, _deletedVaultVaultsRestClient.CreatePurgeDeletedRequest(Id.SubscriptionId, AzureLocation.Parse(Id.Parent.Name), Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
