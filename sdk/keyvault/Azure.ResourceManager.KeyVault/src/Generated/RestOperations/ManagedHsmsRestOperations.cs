...
namespace Azure.ResourceManager.KeyVault
{
    internal partial class ManagedHsmsRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string name, ManagedHsmData data)
        {
            ...
            ((IJsonModel<ManagedHsmData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateCheckManagedHsmNameAvailabilityRequest(string subscriptionId, ManagedHsmNameAvailabilityContent content)
        {
            ...
            ((IJsonModel<ManagedHsmNameAvailabilityContent>)content).Write(content0.JsonWriter, ModelSerializationExtensions.WireOptions);
