...
VaultCreateOrUpdateInfo parameters = new VaultCreateOrUpdateInfo(AzureLocation.WestUS2, new VaultProperties(Guid.NewGuid(), new KeyVaultSku(KeyVaultSkuFamily.A, KeyVaultSkuName.Standard)));
...
VaultCreateOrUpdateInfo parameters = new VaultCreateOrUpdateInfo(AzureLocation.WestUS2, properties);
```
