...
namespace Azure.Security.KeyVault.Models
{
    ...
    {
        internal static DeletedSecretBundle DeserializeDeletedSecretBundle(JsonElement element)
        {
            ...
            return new DeletedSecretBundle(value, id, contentType, attributes, tags, kid, managed, recoveryId, scheduledPurgeDate, deletedDate);
        }
    }
}
