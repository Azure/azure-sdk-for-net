...
namespace Azure.Security.KeyVault.Models
{
    ...
    {
        internal static DeletedSecretItem DeserializeDeletedSecretItem(JsonElement element)
        {
            ...
            return new DeletedSecretItem(id, attributes, tags, contentType, managed, recoveryId, scheduledPurgeDate, deletedDate);
        }
    }
}
