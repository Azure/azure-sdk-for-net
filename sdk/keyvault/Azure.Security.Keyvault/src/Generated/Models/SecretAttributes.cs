...
namespace Azure.Security.KeyVault.Models
{
    ...
    public partial class SecretAttributes : Attributes
    {
        ...
        internal SecretAttributes(bool? enabled, DateTimeOffset? notBefore, DateTimeOffset? expires, DateTimeOffset? created, DateTimeOffset? updated, int? recoverableDays, DeletionRecoveryLevel? recoveryLevel) : base(enabled, notBefore, expires, created, updated)
        {
