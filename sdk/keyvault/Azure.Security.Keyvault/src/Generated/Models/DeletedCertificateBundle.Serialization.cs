...
namespace Azure.Security.KeyVault.Models
{
    ...
    {
        internal static DeletedCertificateBundle DeserializeDeletedCertificateBundle(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("policy"))
                {
                    ...
                    policy = CertificatePolicy.DeserializeCertificatePolicy(property.Value);
                    continue;
                }
                if (property.NameEquals("cer"))
                {
                    if (property.Value.ValueKind == JsonValueKind.Null)
                    {
                        continue;
                    }
                    cer = property.Value.GetBytesFromBase64();
                    continue;
                }
            ...
            return new DeletedCertificateBundle(id, kid, sid, x5t, policy, cer, contentType, attributes, tags, recoveryId, scheduledPurgeDate, deletedDate);
        }
    }
}
