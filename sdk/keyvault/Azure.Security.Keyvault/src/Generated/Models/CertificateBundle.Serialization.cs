...
namespace Azure.Security.KeyVault.Models
{
    ...
    {
        internal static CertificateBundle DeserializeCertificateBundle(JsonElement element)
        {
            string id = default;
            string kid = default;
            string sid = default;
            ...
            return new CertificateBundle(id, kid, sid, x5t, policy, cer, contentType, attributes, tags);
        }
    }
}
