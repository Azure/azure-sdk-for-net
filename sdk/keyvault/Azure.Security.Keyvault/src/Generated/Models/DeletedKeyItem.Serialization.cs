...
namespace Azure.Security.KeyVault.Models
{
    ...
    {
        internal static DeletedKeyItem DeserializeDeletedKeyItem(JsonElement element)
        {
            ...
            return new DeletedKeyItem(kid, attributes, tags, managed, recoveryId, scheduledPurgeDate, deletedDate);
        }
    }
}
