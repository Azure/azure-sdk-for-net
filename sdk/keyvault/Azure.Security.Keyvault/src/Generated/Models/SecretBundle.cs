...
namespace Azure.Security.KeyVault.Models
{
    ...
    public partial class SecretBundle
    {
        ...
        internal SecretBundle(string value, string id, string contentType, SecretAttributes attributes, IReadOnlyDictionary<string, string> tags, string kid, bool? managed)
        {
            Value = value;
            Id = id;
