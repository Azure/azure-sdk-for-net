...
#pragma warning restore CA1707 // Identifiers should not contain underscores
        ...
        /// is one slot rather than a per-URI map, alternating calls such as <c>GetSecret("a")</c> →
        /// <c>GetSecret("b")</c> → <c>GetSecret("a")</c> will each drive a fresh credential invocation. That is
        /// inherent to binding a token to a request line; MSAL has its own inner cache, but callers enabling
        /// this should be aware they are trading throughput for cryptographic binding.
        /// </para>
        /// </remarks>
