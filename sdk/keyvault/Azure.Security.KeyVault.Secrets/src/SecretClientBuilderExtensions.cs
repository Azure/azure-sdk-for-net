...
namespace Azure.Security.KeyVault.Secrets
{
    ...
    {
        public static IAzureClientBuilder<SecretClient, SecretClientOptions> AddKeyVaultSecrets<TBuilder>(this TBuilder builder, Uri vaultUri)
        ...
        public static IAzureClientBuilder<SecretClient, SecretClientOptions> AddKeyVaultSecrets<TBuilder, TConfiguration>(this TBuilder builder, TConfiguration configuration)
