...
namespace Azure.Security.KeyVault.Secrets
{
    ...
    public partial class KeyVaultSecretsClientOptions : ClientOptions
    {
        ...
        /// <summary> Initializes a new instance of KeyVaultSecretsClientOptions. </summary>
        /// <param name="version"> The service version. </param>
        public KeyVaultSecretsClientOptions(ServiceVersion version = LatestVersion)
        {
        ...
        /// <summary> Initializes a new instance of KeyVaultSecretsClientOptions from configuration. </summary>
        /// <param name="section"> The configuration section. </param>
        [Experimental("SCME0002")]
        internal KeyVaultSecretsClientOptions(IConfigurationSection section) : base(section, null)
        {
