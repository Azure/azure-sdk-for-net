    ...
    internal static class SecretMapper
    {
        ...
        public static System.IO.Stream WriteUpdateBody(SecretProperties properties)
        {
            ...
            using (var writer = new System.Text.Json.Utf8JsonWriter(ms))
            {
                ...
                // Tags is non-null only when the customer touched it. We send
                // even an empty dictionary so the service replaces existing tags
                // — matching the legacy SecretClient behavior.
                var tagsField = typeof(SecretProperties).GetField("_tags",
                    System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic);
                var existingTags = tagsField?.GetValue(properties) as IDictionary<string, string>;
