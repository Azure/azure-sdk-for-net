...
namespace Azure.Security.KeyVault.Cryptography.Defaults
{
    ...
    public class CryptoProviderDefaults : IKeyVaultDefault
    {
        ...
        /// 
        /// </summary>
        public string KeyWrapAlgorithm { get; private set; }
        ...
        public CryptoProviderDefaults(string encryptionAlgorithm, string keyWrapAlgorithm, string signatureAlgorithm, string defaultCategoryName) : this()
        {
