...
namespace Azure.Provisioning.KeyVault
{
    public partial class KeyVaultSecret
    {
        ...
        //
        // KeyVaultSecret shares the same version history as KeyVaultService because vaults
        // and secrets are part of the same resource provider (Microsoft.KeyVault).
        public static partial class ResourceVersions
        {
            ...
            /// <summary> API version "2018-02-14". </summary>
