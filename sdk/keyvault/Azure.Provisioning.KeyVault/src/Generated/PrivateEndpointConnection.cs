...
namespace Azure.Provisioning.KeyVault
{
    ...
    public partial class PrivateEndpointConnection : ProvisionableResource
    {
        ...
        private ResourceReference<Vault> _parent;

        /// <summary> Creates a new PrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public PrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.KeyVault/vaults/privateEndpointConnections", resourceVersion ?? "2025-05-01")
        {
        }
        ...
        protected override void DefineProvisionableProperties()
        {
            ...
            _parent = DefineResource<Vault>("Parent", new string[] { "parent" }, isRequired: true);
