...
namespace Azure.Provisioning.KeyVault
{
    ...
    public partial class Vault : ProvisionableResource
    {
        ...
        public Vault(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.KeyVault/vaults", resourceVersion ?? "2025-05-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for Vault. </summary>
        ...
        /// <summary> Creates a reference to an existing Vault. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static Vault FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            Vault result = new Vault(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for Vault that are not part of the generated code. </summary>
        ...
        /// <summary> Creates a role assignment for a user-assigned identity that grants access to this Vault. </summary>
        ...
        /// <summary> Creates a role assignment for a principal that grants access to this Vault. </summary>
        /// <param name="role"> The role to grant. </param>
