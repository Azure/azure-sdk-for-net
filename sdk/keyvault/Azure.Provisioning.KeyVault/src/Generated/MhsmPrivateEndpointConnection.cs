...
namespace Azure.Provisioning.KeyVault
{
    ...
    public partial class MhsmPrivateEndpointConnection : ProvisionableResource
    {
        ...
        /// <summary> Creates a new MhsmPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public MhsmPrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.KeyVault/managedHSMs/privateEndpointConnections", resourceVersion ?? "2025-05-01")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for MhsmPrivateEndpointConnection. </summary>
        ...
        /// <summary> Creates a reference to an existing MhsmPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static MhsmPrivateEndpointConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            MhsmPrivateEndpointConnection result = new MhsmPrivateEndpointConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for MhsmPrivateEndpointConnection that are not part of the generated code. </summary>
