...
{
    /// <summary>
    /// An Azure Key Vault based <see cref="ConfigurationProvider"/>.
    /// </summary>
    internal class KeyVaultConfigurationProvider : ConfigurationProvider, IDisposable
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="KeyVaultConfigurationProvider"/>.
        /// </summary>
        ...
        /// <exception cref="ArgumentNullException">When either <paramref name="client"/> or <see cref="KeyVaultConfigurationOptions.Manager"/> is <code>null</code>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">When either <see cref="KeyVaultConfigurationOptions.ReloadInterval"/> is not positive or <code>null</code>.</exception>
        public KeyVaultConfigurationProvider(SecretClient client, KeyVaultConfigurationOptions options = null)
        {
            options ??= new KeyVaultConfigurationOptions();
        ...
        /// <summary>
        /// Frees resources held by the <see cref="KeyVaultConfigurationProvider"/> object.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
