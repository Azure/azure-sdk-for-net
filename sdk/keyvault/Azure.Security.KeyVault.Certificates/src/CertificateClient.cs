...
#pragma warning disable AZC0015 // Unexpected client method return type.
        ...
        public virtual Response<X509Certificate2> DownloadCertificate(DownloadCertificateOptions options, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    var requestUri = _pipeline.CompleteUriWithQueryParams(certificate.SecretId, ("outContentType", options.OutContentType.ToString()));
        ...
        [CallerShouldAudit(CallerShouldAuditReason)]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public virtual async Task<Response<X509Certificate2>> DownloadCertificateAsync(string certificateName, string version, CancellationToken cancellationToken = default) =>
