...
{
    internal partial class IssuerBundle
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="IssuerBundle"/>. </summary>
        ...
        internal IssuerBundle(string id, string provider, IssuerCredentials credentials, OrganizationDetails organizationDetails, IssuerAttributes attributes, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Provider = provider;
