...
{
    internal partial class CertificateAttributesBundle
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CertificateAttributesBundle"/>. </summary>
        public CertificateAttributesBundle()
        {
        }
        ...
        internal CertificateAttributesBundle(bool? enabled, DateTimeOffset? notBefore, DateTimeOffset? expires, DateTimeOffset? created, DateTimeOffset? updated, int? recoverableDays, DeletionRecoveryLevel? recoveryLevel, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Enabled = enabled;
            NotBefore = notBefore;
            Expires = expires;
