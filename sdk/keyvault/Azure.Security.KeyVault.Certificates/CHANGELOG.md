...
- Added an experimental `PlatformManaged` property on `CertificatePolicy` for Azure Key Vault internal usage only. Any calls using this property will fail and it is not recommended to be used at this point.
