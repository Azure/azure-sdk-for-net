...
namespace Azure.Security.KeyVault.Administration.Models
{
    ...
    internal partial class SelectiveKeyRestoreDetailsInternal
    {
        public SelectiveKeyRestoreDetailsInternal(RestoreDetailsInternal restoreDetails) :
            this(restoreDetails.Status, restoreDetails.StatusDetails, restoreDetails.Error, restoreDetails.JobId, restoreDetails.StartOn, restoreDetails.EndOn, new Dictionary<string, BinaryData>())
        { }
    }
}
