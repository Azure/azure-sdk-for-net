...
namespace Azure.Security.KeyVault.Administration
{
    ...
    {
        private readonly RestoreOperationInternal<AzureSecurityKeyVaultAdministrationSelectiveKeyRestoreOperationHeaders, KeyVaultSelectiveKeyRestoreResult, SelectiveKeyRestoreDetailsInternal> _operationInternal;
        ...
        internal KeyVaultSelectiveKeyRestoreOperation(KeyVaultBackupClient client, ResponseWithHeaders<AzureSecurityKeyVaultAdministrationSelectiveKeyRestoreOperationHeaders> response)
        {
            _operationInternal = new RestoreOperationInternal<AzureSecurityKeyVaultAdministrationSelectiveKeyRestoreOperationHeaders, KeyVaultSelectiveKeyRestoreResult, SelectiveKeyRestoreDetailsInternal>(client, response);
        }
        ...
        internal KeyVaultSelectiveKeyRestoreOperation(SelectiveKeyRestoreDetailsInternal value, Response response, KeyVaultBackupClient client)
        {
            _operationInternal = new RestoreOperationInternal<AzureSecurityKeyVaultAdministrationSelectiveKeyRestoreOperationHeaders, KeyVaultSelectiveKeyRestoreResult, SelectiveKeyRestoreDetailsInternal>(value, response, client);
        }

        /// <summary> Initializes a new instance of <see cref="KeyVaultSelectiveKeyRestoreOperation" /> for mocking. </summary>
        ...
        /// <inheritdoc/>
        public override KeyVaultSelectiveKeyRestoreResult Value => _operationInternal.Value;
        ...
        /// <inheritdoc/>
        public override ValueTask<Response<KeyVaultSelectiveKeyRestoreResult>> WaitForCompletionAsync(CancellationToken cancellationToken = default) =>
            _operationInternal.WaitForCompletionAsync(cancellationToken);

        /// <inheritdoc/>
        public override ValueTask<Response<KeyVaultSelectiveKeyRestoreResult>> WaitForCompletionAsync(TimeSpan pollingInterval, CancellationToken cancellationToken) =>
