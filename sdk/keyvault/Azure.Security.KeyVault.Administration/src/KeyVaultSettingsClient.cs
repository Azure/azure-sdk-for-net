...
namespace Azure.Security.KeyVault.Administration
{
    ...
    public class KeyVaultSettingsClient
    {
        ...
        public virtual Response<KeyVaultSetting> UpdateSetting(KeyVaultSetting setting, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                return _restClient.UpdateSetting(VaultUri.AbsoluteUri, setting.Name, setting.Value.Serialize(), cancellationToken);
            }
            catch (Exception ex)
            {
                scope.Failed(ex);
        ...
        public virtual async Task<Response<KeyVaultSetting>> UpdateSettingAsync(KeyVaultSetting setting, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                return await _restClient.UpdateSettingAsync(VaultUri.AbsoluteUri, setting.Name, setting.Value.Serialize(), cancellationToken).ConfigureAwait(false);
            }
            catch (Exception ex)
            {
                scope.Failed(ex);
