...
namespace Azure.Security.KeyVault.Administration
{
    internal partial class KeyVaultAccessControlRestClientGetRoleAssignmentsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        public KeyVaultAccessControlRestClientGetRoleAssignmentsAsyncCollectionResult(KeyVaultAccessControlRestClient client, Uri nextPage, string scope, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
