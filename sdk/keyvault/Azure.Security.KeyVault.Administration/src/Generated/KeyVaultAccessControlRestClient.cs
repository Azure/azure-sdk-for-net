...
{
    /// <summary> The KeyVaultAccessControlRestClient. </summary>
    public partial class KeyVaultAccessControlRestClient
    {
        ...
        public KeyVaultAccessControlRestClient(Uri endpoint, TokenCredential credential) : this(endpoint, credential, new KeyVaultAdministrationClientOptions())
        {
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="endpoint"/> or <paramref name="credential"/> is null. </exception>
        public KeyVaultAccessControlRestClient(Uri endpoint, TokenCredential credential, KeyVaultAdministrationClientOptions options)
        {
        ...
        {
            Response result = DeleteRoleDefinition(scope, roleDefinitionName, cancellationToken.ToRequestContext());
        ...
        {
            Response result = await DeleteRoleDefinitionAsync(scope, roleDefinitionName, cancellationToken.ToRequestContext()).ConfigureAwait(false);
            return Response.FromValue((RoleDefinition)result, result);
        }
        ...
        {
            Response result = CreateOrUpdateRoleDefinition(scope, roleDefinitionName, parameters, cancellationToken.ToRequestContext());
            return Response.FromValue((RoleDefinition)result, result);
        }
        ...
        {
            Response result = await CreateOrUpdateRoleDefinitionAsync(scope, roleDefinitionName, parameters, cancellationToken.ToRequestContext()).ConfigureAwait(false);
            return Response.FromValue((RoleDefinition)result, result);
        }
        ...
        {
            Response result = await GetRoleDefinitionAsync(scope, roleDefinitionName, cancellationToken.ToRequestContext()).ConfigureAwait(false);
            return Response.FromValue((RoleDefinition)result, result);
        }
        ...
        {
            return new KeyVaultAccessControlRestClientGetRoleDefinitionsCollectionResult(this, scope, filter, context);
        }
        ...
        {
            return new KeyVaultAccessControlRestClientGetRoleDefinitionsAsyncCollectionResult(this, scope, filter, context);
        }
        ...
        {
            return new KeyVaultAccessControlRestClientGetRoleDefinitionsCollectionResultOfT(this, scope, filter, cancellationToken.ToRequestContext());
        }
        ...
        {
            return new KeyVaultAccessControlRestClientGetRoleDefinitionsAsyncCollectionResultOfT(this, scope, filter, cancellationToken.ToRequestContext());
        }
        ...
        {
            Response result = DeleteRoleAssignment(scope, roleAssignmentName, cancellationToken.ToRequestContext());
        ...
        {
            Response result = await DeleteRoleAssignmentAsync(scope, roleAssignmentName, cancellationToken.ToRequestContext()).ConfigureAwait(false);
            return Response.FromValue((RoleAssignment)result, result);
        }
        ...
        {
            Response result = CreateRoleAssignment(scope, roleAssignmentName, parameters, cancellationToken.ToRequestContext());
            return Response.FromValue((RoleAssignment)result, result);
        }
        ...
        {
            Response result = await CreateRoleAssignmentAsync(scope, roleAssignmentName, parameters, cancellationToken.ToRequestContext()).ConfigureAwait(false);
            return Response.FromValue((RoleAssignment)result, result);
        }
        ...
        {
            Response result = GetRoleAssignment(scope, roleAssignmentName, cancellationToken.ToRequestContext());
            return Response.FromValue((RoleAssignment)result, result);
        }
        ...
        {
            Response result = await GetRoleAssignmentAsync(scope, roleAssignmentName, cancellationToken.ToRequestContext()).ConfigureAwait(false);
            return Response.FromValue((RoleAssignment)result, result);
        }
        ...
        {
            return new KeyVaultAccessControlRestClientGetRoleAssignmentsCollectionResult(this, scope, filter, context);
        }
        ...
        {
            return new KeyVaultAccessControlRestClientGetRoleAssignmentsAsyncCollectionResult(this, scope, filter, context);
        }
        ...
        {
            return new KeyVaultAccessControlRestClientGetRoleAssignmentsCollectionResultOfT(this, scope, filter, cancellationToken.ToRequestContext());
        }
        ...
        {
            return new KeyVaultAccessControlRestClientGetRoleAssignmentsAsyncCollectionResultOfT(this, scope, filter, cancellationToken.ToRequestContext());
        }
    }
}
