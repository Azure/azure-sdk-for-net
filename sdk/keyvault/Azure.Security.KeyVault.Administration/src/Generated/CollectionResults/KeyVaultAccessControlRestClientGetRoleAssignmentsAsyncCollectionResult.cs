...
{
    internal partial class KeyVaultAccessControlRestClientGetRoleAssignmentsAsyncCollectionResult : AsyncPageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of KeyVaultAccessControlRestClientGetRoleAssignmentsAsyncCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public KeyVaultAccessControlRestClientGetRoleAssignmentsAsyncCollectionResult(KeyVaultAccessControlRestClient client, string scope, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scope = scope;
            _filter = filter;
        ...
        /// <summary> Gets the pages of KeyVaultAccessControlRestClientGetRoleAssignmentsAsyncCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of KeyVaultAccessControlRestClientGetRoleAssignmentsAsyncCollectionResult as an enumerable collection. </returns>
