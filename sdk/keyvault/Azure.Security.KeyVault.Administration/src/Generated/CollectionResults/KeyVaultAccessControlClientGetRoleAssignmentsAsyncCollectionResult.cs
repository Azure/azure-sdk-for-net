...
{
    internal partial class KeyVaultAccessControlClientGetRoleAssignmentsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public KeyVaultAccessControlClientGetRoleAssignmentsAsyncCollectionResult(KeyVaultAccessControlClient client, string scope, string filter, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _scope = scope;
            _filter = filter;
        ...
        public override async IAsyncEnumerable<global::Azure.Page<global::System.BinaryData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                {
                    items.Add(global::System.ClientModel.Primitives.ModelReaderWriter.Write(item, global::Azure.Security.KeyVault.Administration.ModelSerializationExtensions.WireOptions, global::Azure.Security.KeyVault.Administration.AzureSecurityKeyVaultAdministrationContext.Default));
                }
