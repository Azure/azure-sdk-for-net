...
namespace Azure.Security.KeyVault.Administration
{
    internal partial class KeyVaultAccessControlRestClientGetRoleAssignmentsCollectionResultOfT : Pageable<RoleAssignment>
    {
        ...
        public KeyVaultAccessControlRestClientGetRoleAssignmentsCollectionResultOfT(KeyVaultAccessControlRestClient client, string scope, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scope = scope;
            _filter = filter;
        ...
        public override IEnumerable<Page<RoleAssignment>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<RoleAssignment>.FromValues((IReadOnlyList<RoleAssignment>)result.Value, nextPage?.AbsoluteUri, response);
