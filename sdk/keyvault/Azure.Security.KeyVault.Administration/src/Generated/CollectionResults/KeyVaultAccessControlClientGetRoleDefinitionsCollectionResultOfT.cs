...
{
    internal partial class KeyVaultAccessControlClientGetRoleDefinitionsCollectionResultOfT : Pageable<global::Azure.Security.KeyVault.Administration.KeyVaultRoleDefinition>
    {
        ...
        public KeyVaultAccessControlClientGetRoleDefinitionsCollectionResultOfT(KeyVaultAccessControlClient client, string scope, string filter, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _scope = scope;
            _filter = filter;
        ...
        public override IEnumerable<global::Azure.Page<global::Azure.Security.KeyVault.Administration.KeyVaultRoleDefinition>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return global::Azure.Page<KeyVaultRoleDefinition>.FromValues(((IReadOnlyList<global::Azure.Security.KeyVault.Administration.KeyVaultRoleDefinition>)result.Value), (nextPage?.IsAbsoluteUri == true) ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
