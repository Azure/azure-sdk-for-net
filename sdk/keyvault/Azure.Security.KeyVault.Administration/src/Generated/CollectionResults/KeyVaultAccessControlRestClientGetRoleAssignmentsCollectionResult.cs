...
namespace Azure.Security.KeyVault.Administration
{
    internal partial class KeyVaultAccessControlRestClientGetRoleAssignmentsCollectionResult : Pageable<BinaryData>
    {
        ...
        public KeyVaultAccessControlRestClientGetRoleAssignmentsCollectionResult(KeyVaultAccessControlRestClient client, string scope, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scope = scope;
            _filter = filter;
