...
namespace Azure.Security.KeyVault.Administration
{
    internal partial class KeyVaultAccessControlRestClientGetRoleDefinitionsCollectionResultOfT : Pageable<RoleDefinition>
    {
        ...
        public KeyVaultAccessControlRestClientGetRoleDefinitionsCollectionResultOfT(KeyVaultAccessControlRestClient client, string scope, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
            _scope = scope;
            _filter = filter;
        ...
        public override IEnumerable<Page<RoleDefinition>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                yield return Page<RoleDefinition>.FromValues((IReadOnlyList<RoleDefinition>)result.Value, nextPage?.AbsoluteUri, response);
