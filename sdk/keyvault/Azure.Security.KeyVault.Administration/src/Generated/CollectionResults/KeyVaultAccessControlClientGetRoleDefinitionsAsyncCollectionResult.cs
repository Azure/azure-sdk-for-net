...
{
    internal partial class KeyVaultAccessControlClientGetRoleDefinitionsAsyncCollectionResult : AsyncPageable<global::System.BinaryData>
    {
        ...
        public KeyVaultAccessControlClientGetRoleDefinitionsAsyncCollectionResult(KeyVaultAccessControlClient client, string scope, string filter, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _scope = scope;
            _filter = filter;
