...
{
    internal partial class KeyVaultAccessControlClientGetRoleAssignmentsCollectionResult : Pageable<global::System.BinaryData>
    {
        ...
        public KeyVaultAccessControlClientGetRoleAssignmentsCollectionResult(KeyVaultAccessControlClient client, string scope, string filter, RequestContext context, string diagnosticScope) : base((context?.CancellationToken ?? default))
        {
            _client = client;
            _scope = scope;
            _filter = filter;
