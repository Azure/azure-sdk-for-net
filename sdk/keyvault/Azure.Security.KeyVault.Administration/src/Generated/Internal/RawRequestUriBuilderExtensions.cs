...
namespace Azure.Security.KeyVault.Administration
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.Security.KeyVault.Administration.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.Security.KeyVault.Administration.TypeFormatters.ConvertToString(v, format));
