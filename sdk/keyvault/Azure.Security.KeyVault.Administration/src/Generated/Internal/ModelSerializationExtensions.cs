...
namespace Azure.Security.KeyVault.Administration
{
    internal static partial class ModelSerializationExtensions
    {
        ...
        public static Byte[] GetBytesFromBase64(this JsonElement element, string format)
        {
            ...
            {
                "U" => global::Azure.Security.KeyVault.Administration.TypeFormatters.FromBase64UrlString(element.GetRequiredString()),
        ...
        public static DateTimeOffset GetDateTimeOffset(this JsonElement element, string format) => format switch
        {
            ...
            _ => global::Azure.Security.KeyVault.Administration.TypeFormatters.ParseDateTimeOffset(element.GetString(), format)
        };

        public static TimeSpan GetTimeSpan(this JsonElement element, string format) => global::Azure.Security.KeyVault.Administration.TypeFormatters.ParseTimeSpan(element.GetString(), format);
        ...
        {
            writer.WriteStringValue(global::Azure.Security.KeyVault.Administration.TypeFormatters.ToString(value, format));
        }
        ...
        public static void WriteBase64StringValue(this Utf8JsonWriter writer, Byte[] value, string format)
        {
            ...
            {
                case "U":
                    writer.WriteStringValue(global::Azure.Security.KeyVault.Administration.TypeFormatters.ToBase64UrlString(value));
                    break;
                case "D":
        ...
        public static void WriteObjectValue<T>(this Utf8JsonWriter writer, T value, ModelReaderWriterOptions options = ((ModelReaderWriterOptions)null))
        {
            switch (value)
            {
                ...
                case IJsonModel<T> jsonModel:
                    jsonModel.Write(writer, (options ?? global::Azure.Security.KeyVault.Administration.ModelSerializationExtensions.WireOptions));
                    break;
                case Byte[] bytes:
