...
{
    internal partial class KeyVaultAccessControlRestClientGetRoleDefinitionsCollectionResult : Pageable<BinaryData>
    {
        ...
        /// <summary> Initializes a new instance of KeyVaultAccessControlRestClientGetRoleDefinitionsCollectionResult, which is used to iterate over the pages of a collection. </summary>
        ...
        public KeyVaultAccessControlRestClientGetRoleDefinitionsCollectionResult(KeyVaultAccessControlRestClient client, Uri nextPage, string scope, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of KeyVaultAccessControlRestClientGetRoleDefinitionsCollectionResult as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of KeyVaultAccessControlRestClientGetRoleDefinitionsCollectionResult as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = _client.CreateListRoleDefinitionsRequest(nextLink, _scope, _$filter, _context);
