...
namespace Azure.Security.KeyVault.Administration
{
    ...
    public partial class KeyVaultRoleAssignment
    {
        ...
        internal KeyVaultRoleAssignment(string id, string name, string type, KeyVaultRoleAssignmentProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            Name = name;
            Type = type;
