...
namespace Azure.Security.KeyVault.Administration
{
    ...
    {
        internal static KeyVaultRoleAssignmentProperties DeserializeKeyVaultRoleAssignmentProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
