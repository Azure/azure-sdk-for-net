...
namespace Azure.Security.KeyVault.Administration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RoleDefinitionProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RoleDefinitionProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RoleDefinitionProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RoleDefinitionProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
