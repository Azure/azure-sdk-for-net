...
namespace Azure.Security.KeyVault.Administration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultRoleDefinition>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<KeyVaultRoleDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultRoleDefinition>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
