...
namespace Azure.Security.KeyVault.Administration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultRoleAssignmentPropertiesInternal>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyVaultRoleAssignmentPropertiesInternal>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultRoleAssignmentPropertiesInternal>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<KeyVaultRoleAssignmentPropertiesInternal>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
