...
namespace Azure.Security.KeyVault.Administration.Models
{
    ...
    {
        internal static FullBackupDetailsInternal DeserializeFullBackupDetailsInternal(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
