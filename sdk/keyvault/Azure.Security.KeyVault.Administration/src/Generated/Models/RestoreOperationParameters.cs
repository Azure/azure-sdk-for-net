...
namespace Azure.Security.KeyVault.Administration.Models
{
    ...
    internal partial class RestoreOperationParameters
    {
        ...
        internal RestoreOperationParameters(SASTokenParameter sasTokenParameters, string folderToRestore, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SasTokenParameters = sasTokenParameters;
            FolderToRestore = folderToRestore;
