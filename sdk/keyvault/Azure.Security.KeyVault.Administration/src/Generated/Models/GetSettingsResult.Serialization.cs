...
namespace Azure.Security.KeyVault.Administration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetSettingsResult>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<GetSettingsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GetSettingsResult>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
