...
namespace Azure.Security.KeyVault.Administration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GetSettingsResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GetSettingsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GetSettingsResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GetSettingsResult>)} interface");
            }
        ...
        string IPersistableModel<GetSettingsResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
