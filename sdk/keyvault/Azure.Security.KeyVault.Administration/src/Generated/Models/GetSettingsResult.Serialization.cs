...
namespace Azure.Security.KeyVault.Administration
{
    public partial class GetSettingsResult : IUtf8JsonSerializable, IModelJsonSerializable<GetSettingsResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GetSettingsResult>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="GetSettingsResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="GetSettingsResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="GetSettingsResult"/>. </summary>
