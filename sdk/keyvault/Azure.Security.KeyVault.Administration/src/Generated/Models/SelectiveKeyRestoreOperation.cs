...
{
    internal partial class SelectiveKeyRestoreOperation
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SelectiveKeyRestoreOperation"/>. </summary>
        internal SelectiveKeyRestoreOperation()
        {
        }
        ...
        internal SelectiveKeyRestoreOperation(OperationStatus? status, string statusDetails, KeyVaultErrorError error, string jobId, DateTimeOffset? startTime, DateTimeOffset? endTime, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
