...
namespace Azure.Security.KeyVault.Administration.Models
{
    internal partial class SelectiveKeyRestoreDetailsInternal
    {
        ...
        internal SelectiveKeyRestoreDetailsInternal(OperationStatus? status, string statusDetails, KeyVaultServiceError error, string jobId, DateTimeOffset? startOn, DateTimeOffset? endOn, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
