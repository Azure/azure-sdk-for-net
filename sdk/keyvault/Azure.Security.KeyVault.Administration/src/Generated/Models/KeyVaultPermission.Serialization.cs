...
{
    public partial class KeyVaultPermission : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static KeyVaultPermission DeserializeKeyVaultPermission(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
