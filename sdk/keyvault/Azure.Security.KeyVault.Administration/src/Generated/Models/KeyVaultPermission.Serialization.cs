...
namespace Azure.Security.KeyVault.Administration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultPermission>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyVaultPermission>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultPermission>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyVaultPermission>)} interface");
            }
        ...
        string IPersistableModel<KeyVaultPermission>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
