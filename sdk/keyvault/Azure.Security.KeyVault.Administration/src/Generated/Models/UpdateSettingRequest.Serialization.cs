...
namespace Azure.Security.KeyVault.Administration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateSettingRequest>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<UpdateSettingRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateSettingRequest>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<UpdateSettingRequest>)} interface");
            }
        ...
        string IPersistableModel<UpdateSettingRequest>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
