...
namespace Azure.Security.KeyVault.Administration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<UpdateSettingRequest>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<UpdateSettingRequest>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<UpdateSettingRequest>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
