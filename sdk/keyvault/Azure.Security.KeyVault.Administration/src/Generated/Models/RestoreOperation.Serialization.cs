...
namespace Azure.Security.KeyVault.Administration.Models
{
    internal partial class RestoreOperation : IJsonModel<RestoreOperation>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="RestoreOperation"/> from. </param>
        public static explicit operator RestoreOperation(Response response)
        {
