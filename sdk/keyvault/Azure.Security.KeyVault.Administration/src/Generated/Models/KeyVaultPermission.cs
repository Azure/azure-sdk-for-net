...
namespace Azure.Security.KeyVault.Administration
{
    ...
    public partial class KeyVaultPermission
    {
        ...
        internal KeyVaultPermission(IList<string> actions, IList<string> notActions, IList<KeyVaultDataAction> dataActions, IList<KeyVaultDataAction> notDataActions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Actions = actions;
