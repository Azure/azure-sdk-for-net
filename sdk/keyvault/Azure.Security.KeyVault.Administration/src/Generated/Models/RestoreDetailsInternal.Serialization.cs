...
namespace Azure.Security.KeyVault.Administration.Models
{
    internal partial class RestoreDetailsInternal
    {
        internal static RestoreDetailsInternal DeserializeRestoreDetailsInternal(JsonElement element)
        {
            ...
            return new RestoreDetailsInternal(status.Value, statusDetails.Value, error.Value, jobId.Value, Core.Optional.ToNullable(startTime), Core.Optional.ToNullable(endTime));
        }
    }
}
