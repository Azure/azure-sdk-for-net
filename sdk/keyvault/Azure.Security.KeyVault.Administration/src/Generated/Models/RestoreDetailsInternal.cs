...
namespace Azure.Security.KeyVault.Administration.Models
{
    ...
    internal partial class RestoreDetailsInternal
    {
        ...
        internal RestoreDetailsInternal(string status, string statusDetails, KeyVaultServiceError error, string jobId, DateTimeOffset? startTime, DateTimeOffset? endTime, Dictionary<string, BinaryData> rawData)
        {
            Status = status;
