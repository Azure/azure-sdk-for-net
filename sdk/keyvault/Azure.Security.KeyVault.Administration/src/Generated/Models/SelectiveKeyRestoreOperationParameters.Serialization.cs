...
namespace Azure.Security.KeyVault.Administration.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SelectiveKeyRestoreOperationParameters>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        SelectiveKeyRestoreOperationParameters IJsonModel<SelectiveKeyRestoreOperationParameters>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
                throw new FormatException($"The model {nameof(SelectiveKeyRestoreOperationParameters)} does not support '{options.Format}' format.");
            }
        ...
        BinaryData IModel<SelectiveKeyRestoreOperationParameters>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        SelectiveKeyRestoreOperationParameters IModel<SelectiveKeyRestoreOperationParameters>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<SelectiveKeyRestoreOperationParameters>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
