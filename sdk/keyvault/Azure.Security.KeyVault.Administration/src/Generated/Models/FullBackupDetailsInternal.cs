...
namespace Azure.Security.KeyVault.Administration.Models
{
    internal partial class FullBackupDetailsInternal
    {
        ...
        /// <param name="startOn"> The start time of the backup operation in UTC. </param>
        /// <param name="endOn"> The end time of the backup operation in UTC. </param>
        ...
        internal FullBackupDetailsInternal(OperationStatus? status, string statusDetails, KeyVaultServiceError error, DateTimeOffset? startOn, DateTimeOffset? endOn, string jobId, string azureStorageBlobContainerUri, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Status = status;
