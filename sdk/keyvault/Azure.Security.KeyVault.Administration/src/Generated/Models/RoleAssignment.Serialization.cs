...
namespace Azure.Security.KeyVault.Administration.Models
{
    internal partial class RoleAssignment : IJsonModel<RoleAssignment>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="RoleAssignment"/> from. </param>
        public static explicit operator RoleAssignment(Response response)
        {
