...
namespace Azure.Security.KeyVault.Administration.Models
{
    public partial class RoleAssignment
    {
        internal static RoleAssignment DeserializeRoleAssignment(JsonElement element)
        {
            ...
            return new RoleAssignment(id.HasValue ? id.Value : null, name.HasValue ? name.Value : null, type.HasValue ? type.Value : null, properties.HasValue ? properties.Value : null);
        }
    }
}
