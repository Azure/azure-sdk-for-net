...
namespace Azure.Security.KeyVault.Administration
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<KeyVaultSetting>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<KeyVaultSetting>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<KeyVaultSetting>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<KeyVaultSetting>)} interface");
            }
        ...
        string IPersistableModel<KeyVaultSetting>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
