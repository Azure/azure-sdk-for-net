...
namespace Azure.Security.KeyVault.Administration.Models
{
    internal partial class SelectiveKeyRestoreOperation : IJsonModel<SelectiveKeyRestoreOperation>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="SelectiveKeyRestoreOperation"/> from. </param>
        public static explicit operator SelectiveKeyRestoreOperation(Response response)
        {
