...
namespace Azure.Security.KeyVault.Administration
{
    internal partial class KeyVaultAccessControlRestClientGetRoleDefinitionsAsyncCollectionResultOfT : AsyncPageable<RoleDefinition>
    {
        ...
        public KeyVaultAccessControlRestClientGetRoleDefinitionsAsyncCollectionResultOfT(KeyVaultAccessControlRestClient client, Uri nextPage, string scope, string filter, RequestContext context) : base(context?.CancellationToken ?? default)
        {
