...
namespace Azure.Security.KeyVault.Administration.Tests
{
    ...
    public class SelectiveKeyRestoreOperationTests
    {
        ...
        public void UpdateStatusThrowsOnError()
        {
            ...
            var operation = new KeyVaultSelectiveRestoreOperation(mockClient.Object, JobId);

            Assert.ThrowsAsync<RequestFailedException>(async () => await operation.UpdateStatusAsync(default));

            operation = new KeyVaultSelectiveRestoreOperation(mockClient.Object, JobId);
        ...
        public void ValueThrowsOnError()
        {
            ...
            Assert.Throws<RequestFailedException>(() => { KeyVaultSelectiveRestoreResult x = operation.Value; });
        ...
        public void ValueThrowsWhenOperationIsNotComplete()
        {
            ...
            var operation = new KeyVaultSelectiveRestoreOperation(incompleteRestore, Mock.Of<Response>(), Mock.Of<KeyVaultBackupClient>());

            Assert.Throws<InvalidOperationException>(() => { KeyVaultSelectiveRestoreResult x = operation.Value; });
