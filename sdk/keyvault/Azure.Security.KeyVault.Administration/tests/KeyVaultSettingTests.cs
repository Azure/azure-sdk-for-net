...
namespace Azure.Security.KeyVault.Administration.Tests
{
    public class KeyVaultSettingTests
    {
        ...
        {
            ArgumentException ex = Assert.Throws<ArgumentNullException>(() => new KeyVaultSetting("test", null, new KeyVaultSettingType("string"), new Dictionary<string, BinaryData>()));
