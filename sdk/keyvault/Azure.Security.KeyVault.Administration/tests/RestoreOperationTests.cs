...
namespace Azure.Security.KeyVault.Administration.Tests
{
    ...
    public class RestoreOperationTests
    {
        ...
        public void ValueThrowsOnError()
        {
            ...
            Assert.That(operation.StartTime, Is.EqualTo(failedRestore.StartOn));
            Assert.That(operation.EndTime, Is.EqualTo(failedRestore.EndOn));
        }
        ...
        public void ValueThrowsWhenOperationIsNotComplete()
        {
            ...
            Assert.That(operation.StartTime, Is.EqualTo(incompleteRestore.StartOn));
            Assert.That(operation.EndTime, Is.EqualTo(incompleteRestore.EndOn));
        }
