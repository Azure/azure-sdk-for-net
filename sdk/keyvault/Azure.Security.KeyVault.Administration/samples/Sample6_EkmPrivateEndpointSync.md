# Managing EKM proxy private endpoints (Sync)

This sample demonstrates how to create, inspect, list, and delete an External Key Manager (EKM) proxy private endpoint on an Azure Managed HSM using `KeyVaultEkmClient` synchronously.
...
```C# Snippet:CreateEkmPrivateEndpointSync
...
```C# Snippet:GetEkmPrivateEndpointSync
...
```C# Snippet:GetEkmPrivateEndpointsSync
...
```C# Snippet:DeleteEkmPrivateEndpointSync
