...
namespace Azure.ResourceManager.SiteManager
{
    ...
    public partial class EdgeSiteData : ResourceData
    {
        ...
        internal EdgeSiteData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, EdgeSiteProperties properties) : base(id, name, resourceType, systemData)
        {
