...
namespace Azure.ResourceManager.SiteManager
{
    ...
    public partial class EdgeSiteData : ResourceData, IJsonModel<EdgeSiteData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        EdgeSiteData IJsonModel<EdgeSiteData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (EdgeSiteData)JsonModelCreateCore(ref reader, options);
        ...
        internal static EdgeSiteData DeserializeEdgeSiteData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("systemData"u8))
                {
                    ...
                    systemData = ModelReaderWriter.Read<SystemData>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), ModelSerializationExtensions.WireOptions, AzureResourceManagerSiteManagerContext.Default);
                    continue;
                }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<EdgeSiteData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="edgeSiteData"> The <see cref="EdgeSiteData"/> to serialize into <see cref="RequestContent"/>. </param>
