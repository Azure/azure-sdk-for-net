...
namespace Azure.ResourceManager.SiteManager
{
    internal partial class ServiceGroupEdgeSite
    {
        ...
        internal ServiceGroupEdgeSite(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(ServiceGroupEdgeSite).Assembly, applicationId);
        }
