...
namespace Azure.ResourceManager.SiteManager
{
    internal partial class ServiceGroupEdgeSiteGetByServiceGroupAsyncCollectionResultOfT : AsyncPageable<EdgeSiteData>
    {
        ...
        public ServiceGroupEdgeSiteGetByServiceGroupAsyncCollectionResultOfT(ServiceGroupEdgeSite client, string servicegroupName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
