...
{
    internal partial class SitesByServiceGroupGetByServiceGroupAsyncCollectionResultOfT : AsyncPageable<EdgeSiteData>
    {
        private readonly SitesByServiceGroup _client;
        private readonly string _servicegroupName;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of SitesByServiceGroupGetByServiceGroupAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of SitesByServiceGroupGetByServiceGroupAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SitesByServiceGroupGetByServiceGroupAsyncCollectionResultOfT as an enumerable collection. </returns>
