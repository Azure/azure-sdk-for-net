...
{
    internal partial class SitesBySubscriptionGetAllCollectionResultOfT : Pageable<EdgeSiteData>
    {
        private readonly SitesBySubscription _client;
        private readonly Guid _subscriptionId;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of SitesBySubscriptionGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of SitesBySubscriptionGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of SitesBySubscriptionGetAllCollectionResultOfT as an enumerable collection. </returns>
