...
namespace Azure.ResourceManager.SiteManager
{
    public partial class SiteResource : IJsonModel<SiteData>
    {
        ...
        BinaryData IPersistableModel<SiteData>.Write(ModelReaderWriterOptions options) => ModelReaderWriter.Write<SiteData>(Data, options, AzureResourceManagerSiteManagerContext.Default);

        SiteData IPersistableModel<SiteData>.Create(BinaryData data, ModelReaderWriterOptions options) => ModelReaderWriter.Read<SiteData>(data, options, AzureResourceManagerSiteManagerContext.Default);
