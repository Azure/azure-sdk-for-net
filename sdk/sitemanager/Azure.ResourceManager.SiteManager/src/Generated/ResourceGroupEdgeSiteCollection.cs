...
namespace Azure.ResourceManager.SiteManager
{
    ...
    public partial class ResourceGroupEdgeSiteCollection : ArmCollection, IEnumerable<ResourceGroupEdgeSiteResource>, IAsyncEnumerable<ResourceGroupEdgeSiteResource>
    {
        ...
        public virtual AsyncPageable<ResourceGroupEdgeSiteResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<EdgeSiteData, ResourceGroupEdgeSiteResource>(new ResourceGroupEdgeSiteGetAllAsyncCollectionResultOfT(_resourceGroupEdgeSiteRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new ResourceGroupEdgeSiteResource(Client, data));
        }
        ...
        public virtual Pageable<ResourceGroupEdgeSiteResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<EdgeSiteData, ResourceGroupEdgeSiteResource>(new ResourceGroupEdgeSiteGetAllCollectionResultOfT(_resourceGroupEdgeSiteRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, context), data => new ResourceGroupEdgeSiteResource(Client, data));
        }
