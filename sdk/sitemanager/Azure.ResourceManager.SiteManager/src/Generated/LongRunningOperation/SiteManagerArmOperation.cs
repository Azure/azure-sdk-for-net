...
#pragma warning disable SA1649 // File name should match first type name
    internal class SiteManagerArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        ...
        /// <summary> Initializes a new instance of SiteManagerArmOperation for mocking. </summary>
        protected SiteManagerArmOperation()
        {
        }

        internal SiteManagerArmOperation(Response response, RehydrationToken? rehydrationToken = null)
        {
        ...
        internal SiteManagerArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "SiteManagerArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
        ...
        private string GetOperationId(RehydrationToken? rehydrationToken)
        {
            ...
            var lroDetails = ModelReaderWriter.Write(rehydrationToken, ModelReaderWriterOptions.Json, AzureResourceManagerSiteManagerContext.Default).ToObjectFromJson<Dictionary<string, string>>();
