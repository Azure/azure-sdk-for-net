...
{
    /// <summary></summary>
    internal partial class ResourceGroupEdgeSiteResourceOperationSource : IOperationSource<ResourceGroupEdgeSiteResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ResourceGroupEdgeSiteResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
