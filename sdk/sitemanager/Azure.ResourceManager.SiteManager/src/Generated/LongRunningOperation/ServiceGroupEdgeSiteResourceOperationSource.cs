...
{
    /// <summary></summary>
    internal partial class ServiceGroupEdgeSiteResourceOperationSource : IOperationSource<ServiceGroupEdgeSiteResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal ServiceGroupEdgeSiteResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
