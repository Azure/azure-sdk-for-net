...
namespace Azure.ResourceManager.SiteManager
{
    internal partial class SiteManagerArmOperation<T> : ArmOperation<T>
    {
        ...
        internal SiteManagerArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
