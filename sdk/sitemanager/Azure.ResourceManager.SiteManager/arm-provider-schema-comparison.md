# ARM provider schema comparison: Azure.ResourceManager.SiteManager
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Edge/sites/{siteName}` | `ResourceGroupEdgeSite` | `ResourceGroupSite` |
