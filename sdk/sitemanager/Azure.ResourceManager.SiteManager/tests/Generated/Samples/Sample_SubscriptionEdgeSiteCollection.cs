...
{
    public partial class Sample_SubscriptionEdgeSiteCollection
    {
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task CreateOrUpdate_CreateSiteSubscriptionGeneratedByMaximumSetRule()
        {
            ...
            // get the collection of this SubscriptionEdgeSiteResource
            SubscriptionEdgeSiteCollection collection = subscriptionResource.GetSubscriptionEdgeSites();
...
["key8188"] = "mcgnu"
            ...
            ArmOperation<SubscriptionEdgeSiteResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, siteName, data);
            SubscriptionEdgeSiteResource result = lro.Value;
        ...
        public async Task Get_GetSiteSubscriptionGeneratedByMaximumSetRule()
        {
            ...
            // invoke the operation
            string siteName = "string";
            SubscriptionEdgeSiteResource result = await collection.GetAsync(siteName);
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetAll_ListBySubscriptionGeneratedByMaximumSetRule()
        {
            ...
            await foreach (SubscriptionEdgeSiteResource item in collection.GetAllAsync())
            {
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task Exists_GetSiteSubscriptionGeneratedByMaximumSetRule()
        {
            // Generated from example definition: 2025-06-01/SitesBySubscription_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "Site_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_GetSiteSubscriptionGeneratedByMaximumSetRule()
        {
            // Generated from example definition: 2025-06-01/SitesBySubscription_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "Site_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string siteName = "string";
            NullableResponse<SubscriptionEdgeSiteResource> response = await collection.GetIfExistsAsync(siteName);
            SubscriptionEdgeSiteResource result = response.HasValue ? response.Value : null;
