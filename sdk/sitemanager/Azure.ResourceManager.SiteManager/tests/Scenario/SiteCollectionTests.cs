...
namespace Azure.ResourceManager.SiteManager.Tests
{
    ...
    public class SiteCollectionTests : SiteManagerManagementTestBase
    {
        ...
        public async Task TestSiteCRUDOperations()
        {
            ...
            var siteCollection = resourceGroup.GetSites();
            ...
            // Get
            SiteResource siteResourceFromGet = await siteCollection.GetAsync(siteName);
            ...
            await foreach (SiteResource siteResourceFromCollection in siteCollection)
            {
