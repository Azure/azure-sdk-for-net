...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class IntegrationAccountSchemaCollection : ArmCollection, IEnumerable<IntegrationAccountSchemaResource>, IAsyncEnumerable<IntegrationAccountSchemaResource>
    {
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/schemas
        /// Operation Id: IntegrationAccountSchemas_List
        /// </summary>
        ...
        {
            async Task<Page<IntegrationAccountSchemaResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _integrationAccountSchemaClientDiagnostics.CreateScope("IntegrationAccountSchemaCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _integrationAccountSchemaRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountSchemaResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<IntegrationAccountSchemaResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _integrationAccountSchemaClientDiagnostics.CreateScope("IntegrationAccountSchemaCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _integrationAccountSchemaRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountSchemaResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<IntegrationAccountSchemaResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _integrationAccountSchemaClientDiagnostics.CreateScope("IntegrationAccountSchemaCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _integrationAccountSchemaRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountSchemaResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<IntegrationAccountSchemaResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _integrationAccountSchemaClientDiagnostics.CreateScope("IntegrationAccountSchemaCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _integrationAccountSchemaRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountSchemaResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
