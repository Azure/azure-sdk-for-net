...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class IntegrationAccountAssemblyDefinitionResource : ArmResource
    {
        ...
        internal IntegrationAccountAssemblyDefinitionResource(ArmClient client, IntegrationAccountAssemblyDefinitionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<IntegrationAccountAssemblyDefinitionResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new IntegrationAccountAssemblyDefinitionResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
