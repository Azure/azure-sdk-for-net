...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class WorkflowRunActionCollection : ArmCollection, IEnumerable<WorkflowRunActionResource>, IAsyncEnumerable<WorkflowRunActionResource>
    {
        ...
        {
            _workflowRunActionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Logic", WorkflowRunActionResource.ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<WorkflowRunActionResource>> GetAsync(string actionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _workflowRunActionRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, actionName, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<WorkflowRunActionResource> Get(string actionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _workflowRunActionRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, actionName, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new WorkflowRunActionResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        {
            async Task<Page<WorkflowRunActionResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _workflowRunActionClientDiagnostics.CreateScope("WorkflowRunActionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _workflowRunActionRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, top, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new WorkflowRunActionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<WorkflowRunActionResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _workflowRunActionClientDiagnostics.CreateScope("WorkflowRunActionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _workflowRunActionRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, top, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new WorkflowRunActionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<WorkflowRunActionResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _workflowRunActionClientDiagnostics.CreateScope("WorkflowRunActionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _workflowRunActionRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, top, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new WorkflowRunActionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<WorkflowRunActionResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _workflowRunActionClientDiagnostics.CreateScope("WorkflowRunActionCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _workflowRunActionRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, top, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new WorkflowRunActionResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string actionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _workflowRunActionRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, actionName, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<bool> Exists(string actionName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _workflowRunActionRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, actionName, cancellationToken: cancellationToken);
                return Response.FromValue(response.Value != null, response.GetRawResponse());
            }
            catch (Exception e)
            {
