...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class LogicWorkflowRunOperationResource : ArmResource
    {
        ...
        internal LogicWorkflowRunOperationResource(ArmClient client, LogicWorkflowRunData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<LogicWorkflowRunOperationResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new LogicWorkflowRunOperationResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
