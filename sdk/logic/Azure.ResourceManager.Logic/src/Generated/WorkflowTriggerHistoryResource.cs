...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class WorkflowTriggerHistoryResource : ArmResource
    {
        ...
        {
            _workflowTriggerHistoryClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Logic", ResourceType.Namespace, Diagnostics);
        ...
        public virtual async Task<Response<WorkflowTriggerHistoryResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _workflowTriggerHistoryRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<WorkflowTriggerHistoryResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _workflowTriggerHistoryRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new WorkflowTriggerHistoryResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response> ResubmitAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _workflowTriggerHistoryRestClient.ResubmitAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response Resubmit(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _workflowTriggerHistoryRestClient.Resubmit(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
