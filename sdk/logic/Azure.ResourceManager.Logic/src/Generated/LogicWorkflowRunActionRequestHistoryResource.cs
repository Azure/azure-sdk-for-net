    ...
    public partial class LogicWorkflowRunActionRequestHistoryResource : LogicWorkflowRequestHistoryResource
    {
        ...
        protected override async Task<Response<LogicWorkflowRequestHistoryResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((LogicWorkflowRequestHistoryResource)new LogicWorkflowRunActionRequestHistoryResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<LogicWorkflowRunActionRequestHistoryResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((LogicWorkflowRunActionRequestHistoryResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<LogicWorkflowRunActionRequestHistoryResource> Get(CancellationToken cancellationToken = default)
        {
