...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class IntegrationAccountSchemaResource : ArmResource
    {
        ...
        internal IntegrationAccountSchemaResource(ArmClient client, IntegrationAccountSchemaData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<IntegrationAccountSchemaResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new IntegrationAccountSchemaResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
