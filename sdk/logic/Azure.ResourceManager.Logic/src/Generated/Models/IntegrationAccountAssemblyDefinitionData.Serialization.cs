...
{
    public partial class IntegrationAccountAssemblyDefinitionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static IntegrationAccountAssemblyDefinitionData DeserializeIntegrationAccountAssemblyDefinitionData(JsonElement element)
        {
            ...
            return new IntegrationAccountAssemblyDefinitionData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, properties);
        }
    }
}
