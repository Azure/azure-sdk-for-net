...
{
    public partial class IntegrationAccountBatchConfigurationData : IUtf8JsonSerializable
    {
        ...
        internal static IntegrationAccountBatchConfigurationData DeserializeIntegrationAccountBatchConfigurationData(JsonElement element)
        {
            ...
            return new IntegrationAccountBatchConfigurationData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties);
        }
    }
}
