...
{
    public partial class LogicAppWorkflowData : IUtf8JsonSerializable
    {
        ...
        internal static LogicAppWorkflowData DeserializeLogicAppWorkflowData(JsonElement element)
        {
                ...
                if (property.NameEquals("properties"))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("sku"))
                        {
                            ...
                            sku = LogicAppSku.DeserializeLogicAppSku(property0.Value);
                            continue;
                        }
                        ...
                        if (property0.NameEquals("parameters"))
                        {
                            ...
                            Dictionary<string, LogicAppWorkflowParameterInfo> dictionary = new Dictionary<string, LogicAppWorkflowParameterInfo>();
                            foreach (var property1 in property0.Value.EnumerateObject())
                            {
                                dictionary.Add(property1.Name, LogicAppWorkflowParameterInfo.DeserializeLogicAppWorkflowParameterInfo(property1.Value));
                            }
            ...
            return new LogicAppWorkflowData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, identity.Value, Optional.ToNullable(provisioningState), Optional.ToNullable(createdTime), Optional.ToNullable(changedTime), Optional.ToNullable(state), version.Value, accessEndpoint.Value, endpointsConfiguration.Value, accessControl.Value, sku.Value, integrationAccount.Value, integrationServiceEnvironment.Value, definition.Value, Optional.ToDictionary(parameters));
        }
    }
}
