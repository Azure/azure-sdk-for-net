...
{
    public partial class LogicAppWorkflowParameterInfo : IUtf8JsonSerializable
    {
        ...
        internal static LogicAppWorkflowParameterInfo DeserializeLogicAppWorkflowParameterInfo(JsonElement element)
        {
            ...
            return new LogicAppWorkflowParameterInfo(Optional.ToNullable(type), value.Value, metadata.Value, description.Value);
        }
    }
}
