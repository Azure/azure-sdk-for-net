...
{
    public partial class X12OneWayAgreement : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static X12OneWayAgreement DeserializeX12OneWayAgreement(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
