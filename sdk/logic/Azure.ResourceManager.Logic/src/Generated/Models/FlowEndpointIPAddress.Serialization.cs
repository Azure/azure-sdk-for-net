...
{
    public partial class FlowEndpointIPAddress : IUtf8JsonSerializable, IJsonModel<FlowEndpointIPAddress>, IPersistableModel<FlowEndpointIPAddress>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CidrAddress))
            {
                ...
                builder.AppendLine($" '{CidrAddress}'");
            }
