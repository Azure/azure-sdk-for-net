...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<X12SecuritySettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<X12SecuritySettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<X12SecuritySettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<X12SecuritySettings>)} interface");
            }
        ...
        string IPersistableModel<X12SecuritySettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
