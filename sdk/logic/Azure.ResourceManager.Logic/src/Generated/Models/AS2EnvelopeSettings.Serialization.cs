...
{
    public partial class AS2EnvelopeSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AS2EnvelopeSettings DeserializeAS2EnvelopeSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
