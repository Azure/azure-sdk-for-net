...
{
    public partial class AS2AgreementContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AS2AgreementContent DeserializeAS2AgreementContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
