...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AS2AgreementContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AS2AgreementContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AS2AgreementContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AS2AgreementContent>)} interface");
            }
        ...
        string IPersistableModel<AS2AgreementContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
