...
{
    public partial class AS2AgreementContent : IUtf8JsonSerializable, IJsonModel<AS2AgreementContent>, IPersistableModel<AS2AgreementContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ReceiveAgreement))
            {
                ...
                AppendChildObject(builder, ReceiveAgreement, options, 2);
            }

            if (Optional.IsDefined(SendAgreement))
            {
                builder.Append("  sendAgreement:");
                AppendChildObject(builder, SendAgreement, options, 2);
            }
