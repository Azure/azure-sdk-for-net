...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<X12ValidationOverride>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<X12ValidationOverride>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<X12ValidationOverride>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<X12ValidationOverride>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
