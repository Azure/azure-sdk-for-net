...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationServiceEnvironmentNetworkDependencyHealth>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<IntegrationServiceEnvironmentNetworkDependencyHealth>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<IntegrationServiceEnvironmentNetworkDependencyHealth>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
