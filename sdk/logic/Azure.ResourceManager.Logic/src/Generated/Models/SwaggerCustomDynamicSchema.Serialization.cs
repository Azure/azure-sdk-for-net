...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwaggerCustomDynamicSchema>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SwaggerCustomDynamicSchema>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SwaggerCustomDynamicSchema>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SwaggerCustomDynamicSchema>)} interface");
            }
        ...
        string IPersistableModel<SwaggerCustomDynamicSchema>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
