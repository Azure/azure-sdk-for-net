...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class FlowAccessControlConfiguration
    {
        ...
        internal FlowAccessControlConfiguration(FlowAccessControlConfigurationPolicy triggers, FlowAccessControlConfigurationPolicy contents, FlowAccessControlConfigurationPolicy actions, FlowAccessControlConfigurationPolicy workflowManagement, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Triggers = triggers;
            Contents = contents;
            Actions = actions;
