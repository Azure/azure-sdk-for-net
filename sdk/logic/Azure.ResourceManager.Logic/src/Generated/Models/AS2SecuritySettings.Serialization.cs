...
{
    public partial class AS2SecuritySettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AS2SecuritySettings DeserializeAS2SecuritySettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
