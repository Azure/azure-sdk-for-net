...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicErrorResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogicErrorResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogicErrorResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogicErrorResponse>)} interface");
            }
        ...
        string IPersistableModel<LogicErrorResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
