...
{
    public partial class LogicWorkflowResponse : IUtf8JsonSerializable, IJsonModel<LogicWorkflowResponse>, IPersistableModel<LogicWorkflowResponse>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BodyLink))
            {
                ...
                AppendChildObject(builder, BodyLink, options, 2);
            }
