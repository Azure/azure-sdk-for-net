...
{
    public partial class LogicAppWorkflowOutputParameterInfo : IUtf8JsonSerializable
    {
        ...
        internal static LogicAppWorkflowOutputParameterInfo DeserializeLogicAppWorkflowOutputParameterInfo(JsonElement element)
        {
            ...
            return new LogicAppWorkflowOutputParameterInfo(Optional.ToNullable(type), value.Value, metadata.Value, description.Value, error.Value);
        }
    }
}
