...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwaggerCustomDynamicTreeParameterInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SwaggerCustomDynamicTreeParameterInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SwaggerCustomDynamicTreeParameterInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SwaggerCustomDynamicTreeParameterInfo>)} interface");
            }
        ...
        string IPersistableModel<SwaggerCustomDynamicTreeParameterInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
