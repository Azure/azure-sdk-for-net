...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class IntegrationServiceEnvironmenEncryptionKeyReference
    {
        ...
        internal IntegrationServiceEnvironmenEncryptionKeyReference(LogicResourceReference keyVault, string keyName, string keyVersion, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyVault = keyVault;
            KeyName = keyName;
