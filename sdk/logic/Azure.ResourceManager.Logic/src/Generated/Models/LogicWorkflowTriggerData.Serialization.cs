...
namespace Azure.ResourceManager.Logic
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicWorkflowTriggerData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogicWorkflowTriggerData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogicWorkflowTriggerData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogicWorkflowTriggerData>)} interface");
            }
        ...
        string IPersistableModel<LogicWorkflowTriggerData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
