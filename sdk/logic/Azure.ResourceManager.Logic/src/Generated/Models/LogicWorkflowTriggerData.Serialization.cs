...
namespace Azure.ResourceManager.Logic
{
    ...
    {
        internal static LogicWorkflowTriggerData DeserializeLogicWorkflowTriggerData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
