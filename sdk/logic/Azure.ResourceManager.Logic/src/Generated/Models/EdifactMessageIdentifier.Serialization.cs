...
{
    public partial class EdifactMessageIdentifier : IUtf8JsonSerializable, IJsonModel<EdifactMessageIdentifier>, IPersistableModel<EdifactMessageIdentifier>
    {
        ...
        void IJsonModel<EdifactMessageIdentifier>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EdifactMessageIdentifier)} does not support '{format}' format.");
            }
