...
namespace Azure.ResourceManager.Logic
{
    ...
    {
        internal static LogicWorkflowTriggerHistoryData DeserializeLogicWorkflowTriggerHistoryData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
