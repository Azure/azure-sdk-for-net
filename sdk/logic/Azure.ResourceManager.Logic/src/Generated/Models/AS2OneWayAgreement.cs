...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class AS2OneWayAgreement
    {
        ...
        internal AS2OneWayAgreement(IntegrationAccountBusinessIdentity senderBusinessIdentity, IntegrationAccountBusinessIdentity receiverBusinessIdentity, AS2ProtocolSettings protocolSettings, Dictionary<string, BinaryData> rawData)
        {
            SenderBusinessIdentity = senderBusinessIdentity;
            ReceiverBusinessIdentity = receiverBusinessIdentity;
            ProtocolSettings = protocolSettings;
