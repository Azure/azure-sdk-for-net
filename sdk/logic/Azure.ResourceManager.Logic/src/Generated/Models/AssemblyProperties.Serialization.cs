...
{
    public partial class AssemblyProperties : IUtf8JsonSerializable
    {
        ...
        internal static AssemblyProperties DeserializeAssemblyProperties(JsonElement element)
        {
            ...
            return new AssemblyProperties(Optional.ToNullable(createdTime), Optional.ToNullable(changedTime), metadata.Value, content.Value, contentType.Value, contentLink.Value, assemblyName, assemblyVersion.Value, assemblyCulture.Value, assemblyPublicKeyToken.Value);
        }
    }
}
