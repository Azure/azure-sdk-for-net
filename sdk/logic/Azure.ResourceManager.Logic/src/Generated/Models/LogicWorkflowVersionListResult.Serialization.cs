...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static LogicWorkflowVersionListResult DeserializeLogicWorkflowVersionListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
