...
{
    public partial class AS2OneWayAgreement : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AS2OneWayAgreement DeserializeAS2OneWayAgreement(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
