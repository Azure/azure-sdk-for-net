...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class SwaggerXml
    {
        ...
        internal SwaggerXml(string name, string @namespace, string prefix, bool? isAttribute, bool? isWrapped, IDictionary<string, BinaryData> extensions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Namespace = @namespace;
            Prefix = prefix;
