...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class X12FramingSettings
    {
        ...
        internal X12FramingSettings(int dataElementSeparator, int componentSeparator, bool replaceSeparatorsInPayload, int replaceCharacter, int segmentTerminator, X12CharacterSet characterSet, SegmentTerminatorSuffix segmentTerminatorSuffix, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            DataElementSeparator = dataElementSeparator;
            ComponentSeparator = componentSeparator;
            ReplaceSeparatorsInPayload = replaceSeparatorsInPayload;
