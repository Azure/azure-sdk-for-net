...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationServiceEnvironmentSkuCapacity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IntegrationServiceEnvironmentSkuCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IntegrationServiceEnvironmentSkuCapacity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IntegrationServiceEnvironmentSkuCapacity>)} interface");
            }
        ...
        string IPersistableModel<IntegrationServiceEnvironmentSkuCapacity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
