...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static ListOperationCallbackUri DeserializeListOperationCallbackUri(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
