...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class IntegrationServiceEnvironmentSkuDefinitionSku
    {
        ...
        internal IntegrationServiceEnvironmentSkuDefinitionSku(IntegrationServiceEnvironmentSkuName? name, string tier, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            Tier = tier;
