...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdifactDelimiterOverride>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdifactDelimiterOverride>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdifactDelimiterOverride>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdifactDelimiterOverride>)} interface");
            }
        ...
        string IPersistableModel<EdifactDelimiterOverride>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
