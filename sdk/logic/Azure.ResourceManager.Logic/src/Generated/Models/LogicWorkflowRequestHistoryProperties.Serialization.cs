...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicWorkflowRequestHistoryProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogicWorkflowRequestHistoryProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogicWorkflowRequestHistoryProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogicWorkflowRequestHistoryProperties>)} interface");
            }
        ...
        string IPersistableModel<LogicWorkflowRequestHistoryProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
