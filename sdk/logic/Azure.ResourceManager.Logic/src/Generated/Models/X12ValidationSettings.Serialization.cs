...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<X12ValidationSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<X12ValidationSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<X12ValidationSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<X12ValidationSettings>)} interface");
            }
        ...
        string IPersistableModel<X12ValidationSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
