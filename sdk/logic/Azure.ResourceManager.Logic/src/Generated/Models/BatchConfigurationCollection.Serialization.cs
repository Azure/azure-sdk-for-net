...
namespace Azure.ResourceManager.Logic.Models
{
    internal partial class BatchConfigurationCollection : IUtf8JsonSerializable, IJsonModel<BatchConfigurationCollection>
    {
        ...
        void IJsonModel<BatchConfigurationCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(BatchConfigurationCollection)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<BatchConfigurationCollection>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(BatchConfigurationCollection)} does not support '{options.Format}' format.");
            }
        }
