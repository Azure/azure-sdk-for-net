...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static BatchConfigurationCollection DeserializeBatchConfigurationCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
