...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class IntegrationServiceEnvironmentSkuCapacity
    {
        ...
        internal IntegrationServiceEnvironmentSkuCapacity(int? minimum, int? maximum, int? @default, IntegrationServiceEnvironmentSkuScaleType? scaleType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Minimum = minimum;
            Maximum = maximum;
            Default = @default;
