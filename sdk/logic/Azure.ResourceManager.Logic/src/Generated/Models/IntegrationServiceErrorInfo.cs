...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class IntegrationServiceErrorInfo
    {
        ...
        internal IntegrationServiceErrorInfo(IntegrationServiceErrorCode code, string message, IReadOnlyList<IntegrationServiceErrorInfo> details, BinaryData innerError, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Code = code;
            Message = message;
            Details = details;
