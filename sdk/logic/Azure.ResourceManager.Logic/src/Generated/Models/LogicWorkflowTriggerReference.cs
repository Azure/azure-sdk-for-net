...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicWorkflowTriggerReference : LogicResourceReference
    {
        ...
        internal LogicWorkflowTriggerReference(ResourceIdentifier id, string name, ResourceType? resourceType, string flowName, string triggerName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, serializedAdditionalRawData)
        {
            FlowName = flowName;
