...
namespace Azure.ResourceManager.Logic
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicWorkflowData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogicWorkflowData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogicWorkflowData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogicWorkflowData>)} interface");
            }
        ...
        string IPersistableModel<LogicWorkflowData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
