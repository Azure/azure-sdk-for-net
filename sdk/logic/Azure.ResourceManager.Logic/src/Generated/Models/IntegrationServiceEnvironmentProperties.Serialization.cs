...
{
    public partial class IntegrationServiceEnvironmentProperties : IUtf8JsonSerializable, IJsonModel<IntegrationServiceEnvironmentProperties>, IPersistableModel<IntegrationServiceEnvironmentProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IntegrationServiceEnvironmentId))
            {
                builder.Append("  integrationServiceEnvironmentId:");
                builder.AppendLine($" '{IntegrationServiceEnvironmentId}'");
            }
            ...
            if (Optional.IsDefined(EncryptionConfiguration))
            {
                builder.Append("  encryptionConfiguration:");
                AppendChildObject(builder, EncryptionConfiguration, options, 2);
            }
