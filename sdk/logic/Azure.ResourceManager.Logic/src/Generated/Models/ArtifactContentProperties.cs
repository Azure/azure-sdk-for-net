...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class ArtifactContentProperties : ArtifactProperties
    {
        ...
        internal ArtifactContentProperties(DateTimeOffset? createdOn, DateTimeOffset? changedOn, BinaryData metadata, BinaryData content, ContentType? contentType, LogicContentLink contentLink, Dictionary<string, BinaryData> rawData) : base(createdOn, changedOn, metadata, rawData)
        {
            Content = content;
