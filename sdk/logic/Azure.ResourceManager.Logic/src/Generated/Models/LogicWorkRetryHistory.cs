...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicWorkRetryHistory
    {
        ...
        internal LogicWorkRetryHistory(DateTimeOffset? startOn, DateTimeOffset? endOn, string code, string clientRequestId, string serviceRequestId, LogicErrorResponse error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartOn = startOn;
            EndOn = endOn;
            Code = code;
