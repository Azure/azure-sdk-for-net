...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicWorkflowRecurrenceSchedule
    {
        ...
        internal LogicWorkflowRecurrenceSchedule(IList<int> minutes, IList<int> hours, IList<LogicWorkflowDayOfWeek> weekDays, IList<int> monthDays, IList<LogicWorkflowRecurrenceScheduleOccurrence> monthlyOccurrences, Dictionary<string, BinaryData> rawData)
        {
            Minutes = minutes;
            Hours = hours;
            WeekDays = weekDays;
