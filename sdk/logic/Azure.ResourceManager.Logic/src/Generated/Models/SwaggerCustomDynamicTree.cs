...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class SwaggerCustomDynamicTree
    {
        ...
        internal SwaggerCustomDynamicTree(SwaggerCustomDynamicTreeSettings settings, SwaggerCustomDynamicTreeCommand open, SwaggerCustomDynamicTreeCommand browse, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Settings = settings;
            Open = open;
            Browse = browse;
