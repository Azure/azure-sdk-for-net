...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static LogicApiResourcePolicies DeserializeLogicApiResourcePolicies(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
