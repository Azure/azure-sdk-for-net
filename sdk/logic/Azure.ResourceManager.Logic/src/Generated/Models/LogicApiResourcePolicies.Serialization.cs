...
{
    public partial class LogicApiResourcePolicies : IUtf8JsonSerializable, IJsonModel<LogicApiResourcePolicies>, IPersistableModel<LogicApiResourcePolicies>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ContentLink))
            {
                ...
                builder.AppendLine($" '{ContentLink}'");
            }
