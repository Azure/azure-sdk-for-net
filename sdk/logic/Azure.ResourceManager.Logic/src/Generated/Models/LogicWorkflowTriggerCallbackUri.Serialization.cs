...
{
    public partial class LogicWorkflowTriggerCallbackUri : IUtf8JsonSerializable, IJsonModel<LogicWorkflowTriggerCallbackUri>, IPersistableModel<LogicWorkflowTriggerCallbackUri>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Queries))
            {
                ...
                AppendChildObject(builder, Queries, options, 2);
            }
