...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static LogicWorkflowTriggerCallbackUri DeserializeLogicWorkflowTriggerCallbackUri(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
