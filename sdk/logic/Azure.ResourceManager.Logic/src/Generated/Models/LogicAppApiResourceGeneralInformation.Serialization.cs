...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static LogicAppApiResourceGeneralInformation DeserializeLogicAppApiResourceGeneralInformation(JsonElement element)
        {
            ...
            Optional<LogicAppApiTier> tier = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("tier"))
                {
                    ...
                    tier = new LogicAppApiTier(property.Value.GetString());
                    continue;
                }
            }
            return new LogicAppApiResourceGeneralInformation(iconUrl.Value, displayName.Value, description.Value, termsOfUseUrl.Value, releaseTag.Value, Optional.ToNullable(tier));
        }
    }
}
