...
{
    public partial class LogicWorkflowTriggerReference : IUtf8JsonSerializable, IJsonModel<LogicWorkflowTriggerReference>, IPersistableModel<LogicWorkflowTriggerReference>
    {
        ...
        void IJsonModel<LogicWorkflowTriggerReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LogicWorkflowTriggerReference)} does not support '{format}' format.");
            }
