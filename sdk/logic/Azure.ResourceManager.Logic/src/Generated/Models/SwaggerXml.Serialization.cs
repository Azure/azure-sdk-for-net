...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwaggerXml>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SwaggerXml>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SwaggerXml>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SwaggerXml>)} interface");
            }
        ...
        string IPersistableModel<SwaggerXml>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
