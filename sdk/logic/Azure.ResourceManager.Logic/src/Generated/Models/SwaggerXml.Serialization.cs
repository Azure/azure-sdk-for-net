...
{
    public partial class SwaggerXml : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SwaggerXml DeserializeSwaggerXml(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
