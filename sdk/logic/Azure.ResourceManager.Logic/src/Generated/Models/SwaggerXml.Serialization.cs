...
{
    public partial class SwaggerXml : IUtf8JsonSerializable, IJsonModel<SwaggerXml>, IPersistableModel<SwaggerXml>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsAttribute))
            {
                ...
                var boolValue = IsAttribute.Value == true ? "true" : "false";
            ...
            if (Optional.IsDefined(IsWrapped))
            {
                ...
                var boolValue = IsWrapped.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
