...
{
    public partial class LogicWorkflowReference : IUtf8JsonSerializable, IJsonModel<LogicWorkflowReference>, IPersistableModel<LogicWorkflowReference>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicWorkflowReference>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<LogicWorkflowReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LogicWorkflowReference)} does not support '{format}' format.");
            }
