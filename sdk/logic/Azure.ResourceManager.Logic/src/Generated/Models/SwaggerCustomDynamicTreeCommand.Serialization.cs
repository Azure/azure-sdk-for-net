...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwaggerCustomDynamicTreeCommand>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SwaggerCustomDynamicTreeCommand>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SwaggerCustomDynamicTreeCommand>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SwaggerCustomDynamicTreeCommand>)} interface");
            }
        ...
        string IPersistableModel<SwaggerCustomDynamicTreeCommand>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
