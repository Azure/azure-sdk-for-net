...
{
    public partial class OpenAuthenticationAccessPolicy : IUtf8JsonSerializable, IJsonModel<OpenAuthenticationAccessPolicy>, IPersistableModel<OpenAuthenticationAccessPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{ProviderType.ToString()}'");
            }
