...
namespace Azure.ResourceManager.Logic.Models
{
    public partial class IntegrationServiceEnvironmenEncryptionKeyReference : IUtf8JsonSerializable, IModelJsonSerializable<IntegrationServiceEnvironmenEncryptionKeyReference>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<IntegrationServiceEnvironmenEncryptionKeyReference>(this, options.Format);
            ...
            if (Optional.IsDefined(KeyVault))
            {
                ...
                {
                    ((IModelJsonSerializable<LogicResourceReference>)KeyVault).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="IntegrationServiceEnvironmenEncryptionKeyReference"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="IntegrationServiceEnvironmenEncryptionKeyReference"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="IntegrationServiceEnvironmenEncryptionKeyReference"/>. </summary>
