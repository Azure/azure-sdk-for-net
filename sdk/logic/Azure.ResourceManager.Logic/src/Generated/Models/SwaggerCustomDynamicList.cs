...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class SwaggerCustomDynamicList
    {
        ...
        internal SwaggerCustomDynamicList(string operationId, string builtInOperation, string itemsPath, string itemValuePath, string itemTitlePath, IDictionary<string, SwaggerCustomDynamicProperties> parameters, Dictionary<string, BinaryData> rawData)
        {
