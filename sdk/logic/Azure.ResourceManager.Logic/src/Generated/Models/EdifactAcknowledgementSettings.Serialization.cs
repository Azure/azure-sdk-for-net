...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdifactAcknowledgementSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdifactAcknowledgementSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdifactAcknowledgementSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdifactAcknowledgementSettings>)} interface");
            }
        ...
        string IPersistableModel<EdifactAcknowledgementSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
