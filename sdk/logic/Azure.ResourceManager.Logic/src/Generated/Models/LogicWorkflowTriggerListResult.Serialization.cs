...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicWorkflowTriggerListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LogicWorkflowTriggerListResult)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<LogicWorkflowTriggerData>)item).Write(writer, options);
                }
        ...
        LogicWorkflowTriggerListResult IJsonModel<LogicWorkflowTriggerListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LogicWorkflowTriggerListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static LogicWorkflowTriggerListResult DeserializeLogicWorkflowTriggerListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<LogicWorkflowTriggerData> value = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("value"u8))
                {
                    ...
                    {
                        array.Add(LogicWorkflowTriggerData.DeserializeLogicWorkflowTriggerData(item, options));
                    }
                    value = array;
                    continue;
                }
            ...
            return new LogicWorkflowTriggerListResult(value ?? new ChangeTrackingList<LogicWorkflowTriggerData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<LogicWorkflowTriggerListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LogicWorkflowTriggerListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        LogicWorkflowTriggerListResult IPersistableModel<LogicWorkflowTriggerListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LogicWorkflowTriggerListResult)} does not support reading '{options.Format}' format.");
            }
        }
