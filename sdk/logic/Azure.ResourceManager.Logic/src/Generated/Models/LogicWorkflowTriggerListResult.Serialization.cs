...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicWorkflowTriggerListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogicWorkflowTriggerListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogicWorkflowTriggerListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogicWorkflowTriggerListResult>)} interface");
            }
        ...
        string IPersistableModel<LogicWorkflowTriggerListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
