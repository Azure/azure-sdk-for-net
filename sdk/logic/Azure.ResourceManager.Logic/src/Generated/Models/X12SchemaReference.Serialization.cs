...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<X12SchemaReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<X12SchemaReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<X12SchemaReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<X12SchemaReference>)} interface");
            }
        ...
        string IPersistableModel<X12SchemaReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
