...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationServiceEnvironmentNetworkDependency>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<IntegrationServiceEnvironmentNetworkDependency>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IntegrationServiceEnvironmentNetworkDependency>)} interface");
            }
        ...
        string IPersistableModel<IntegrationServiceEnvironmentNetworkDependency>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
