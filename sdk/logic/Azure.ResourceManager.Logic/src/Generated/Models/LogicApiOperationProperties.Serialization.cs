...
{
    public partial class LogicApiOperationProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LogicApiOperationProperties DeserializeLogicApiOperationProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
