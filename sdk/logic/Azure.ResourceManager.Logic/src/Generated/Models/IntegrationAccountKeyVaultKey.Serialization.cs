...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static IntegrationAccountKeyVaultKey DeserializeIntegrationAccountKeyVaultKey(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
