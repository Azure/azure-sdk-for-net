...
{
    public partial class AS2ProtocolSettings : IUtf8JsonSerializable, IJsonModel<AS2ProtocolSettings>, IPersistableModel<AS2ProtocolSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MessageConnectionSettings))
            {
                ...
                AppendChildObject(builder, MessageConnectionSettings, options, 2);
            }

            if (Optional.IsDefined(AcknowledgementConnectionSettings))
            {
                builder.Append("  acknowledgementConnectionSettings:");
                AppendChildObject(builder, AcknowledgementConnectionSettings, options, 2);
            }

            if (Optional.IsDefined(MdnSettings))
            {
                builder.Append("  mdnSettings:");
                AppendChildObject(builder, MdnSettings, options, 2);
            }
            ...
            if (Optional.IsDefined(ErrorSettings))
            {
                ...
                AppendChildObject(builder, ErrorSettings, options, 2);
            }
