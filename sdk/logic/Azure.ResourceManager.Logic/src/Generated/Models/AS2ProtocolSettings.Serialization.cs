...
{
    public partial class AS2ProtocolSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AS2ProtocolSettings DeserializeAS2ProtocolSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
