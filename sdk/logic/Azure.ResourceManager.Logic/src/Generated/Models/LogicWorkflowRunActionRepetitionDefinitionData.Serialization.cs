...
namespace Azure.ResourceManager.Logic
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicWorkflowRunActionRepetitionDefinitionData>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LogicWorkflowRunActionRepetitionDefinitionData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogicWorkflowRunActionRepetitionDefinitionData>)} interface");
            }
        ...
        string IPersistableModel<LogicWorkflowRunActionRepetitionDefinitionData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
