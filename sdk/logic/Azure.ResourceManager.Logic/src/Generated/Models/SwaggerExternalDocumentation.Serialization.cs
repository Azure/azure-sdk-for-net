...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwaggerExternalDocumentation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SwaggerExternalDocumentation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SwaggerExternalDocumentation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SwaggerExternalDocumentation>)} interface");
            }
        ...
        string IPersistableModel<SwaggerExternalDocumentation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
