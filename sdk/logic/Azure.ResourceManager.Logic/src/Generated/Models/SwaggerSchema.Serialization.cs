...
{
    public partial class SwaggerSchema : IUtf8JsonSerializable, IJsonModel<SwaggerSchema>, IPersistableModel<SwaggerSchema>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Items))
            {
                ...
                AppendChildObject(builder, Items, options, 2);
            }
            ...
            if (Optional.IsDefined(MaxProperties))
            {
                ...
                builder.AppendLine($" '{MaxProperties.Value.ToString()}'");
            }

            if (Optional.IsDefined(MinProperties))
            {
                builder.Append("  minProperties:");
                builder.AppendLine($" '{MinProperties.Value.ToString()}'");
            }
            ...
            {
                builder.Append("  xml:");
                AppendChildObject(builder, Xml, options, 2);
            }

            if (Optional.IsDefined(ExternalDocs))
            {
                builder.Append("  externalDocs:");
                AppendChildObject(builder, ExternalDocs, options, 2);
            }
            ...
            if (Optional.IsDefined(DynamicSchemaOld))
            {
                ...
                AppendChildObject(builder, DynamicSchemaOld, options, 2);
            }

            if (Optional.IsDefined(DynamicSchemaNew))
            {
                builder.Append("  dynamicSchemaNew:");
                AppendChildObject(builder, DynamicSchemaNew, options, 2);
            }

            if (Optional.IsDefined(DynamicListNew))
            {
                builder.Append("  dynamicListNew:");
                AppendChildObject(builder, DynamicListNew, options, 2);
            }

            if (Optional.IsDefined(DynamicTree))
            {
                builder.Append("  dynamicTree:");
                AppendChildObject(builder, DynamicTree, options, 2);
            }
