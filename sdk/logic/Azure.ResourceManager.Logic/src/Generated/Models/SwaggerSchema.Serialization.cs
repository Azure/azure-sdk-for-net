...
{
    public partial class SwaggerSchema : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SwaggerSchema DeserializeSwaggerSchema(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
