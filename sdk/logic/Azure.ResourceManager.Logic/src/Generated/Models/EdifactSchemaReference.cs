...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class EdifactSchemaReference
    {
        ...
        internal EdifactSchemaReference(string messageId, string messageVersion, string messageRelease, string senderApplicationId, string senderApplicationQualifier, string associationAssignedCode, string schemaName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MessageId = messageId;
            MessageVersion = messageVersion;
            MessageRelease = messageRelease;
