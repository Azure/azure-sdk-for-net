...
{
    public partial class OpenAuthenticationPolicyClaim : IUtf8JsonSerializable, IJsonModel<OpenAuthenticationPolicyClaim>, IPersistableModel<OpenAuthenticationPolicyClaim>
    {
        ...
        void IJsonModel<OpenAuthenticationPolicyClaim>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(OpenAuthenticationPolicyClaim)} does not support '{format}' format.");
            }
