...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class IntegrationServiceEnvironmentNetworkDependencyHealth
    {
        ...
        internal IntegrationServiceEnvironmentNetworkDependencyHealth(IntegrationServiceErrorInfo error, IntegrationServiceEnvironmentNetworkDependencyHealthState? state, Dictionary<string, BinaryData> rawData)
        {
            Error = error;
            State = state;
            _rawData = rawData;
