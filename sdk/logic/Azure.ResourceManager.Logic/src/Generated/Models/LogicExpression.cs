...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicExpression
    {
        ...
        internal LogicExpression(string text, BinaryData value, IReadOnlyList<LogicExpression> subexpressions, LogicExpressionErrorInfo error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Text = text;
            Value = value;
