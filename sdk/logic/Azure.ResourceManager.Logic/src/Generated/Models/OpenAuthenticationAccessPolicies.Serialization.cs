...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<OpenAuthenticationAccessPolicies>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<OpenAuthenticationAccessPolicies>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<OpenAuthenticationAccessPolicies>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<OpenAuthenticationAccessPolicies>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
