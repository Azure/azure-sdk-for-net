...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static LogicAppWorkflowRunTrigger DeserializeLogicAppWorkflowRunTrigger(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("status"))
                {
                    ...
                    status = new LogicAppWorkflowStatus(property.Value.GetString());
                    continue;
                }
