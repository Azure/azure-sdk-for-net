...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static LogicApiOperationListResult DeserializeLogicApiOperationListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
