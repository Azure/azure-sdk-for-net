...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicApiOperationListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogicApiOperationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogicApiOperationListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<LogicApiOperationListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
