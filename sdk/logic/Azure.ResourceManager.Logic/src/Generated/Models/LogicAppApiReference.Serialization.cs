...
{
    public partial class LogicAppApiReference : IUtf8JsonSerializable
    {
        ...
        internal static LogicAppApiReference DeserializeLogicAppApiReference(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("category"))
                {
                    ...
                    category = new LogicAppApiTier(property.Value.GetString());
                    continue;
                }
                if (property.NameEquals("integrationServiceEnvironment"))
                {
                    ...
                    integrationServiceEnvironment = DeserializeLogicAppResourceReference(property.Value);
                    continue;
                }
            ...
            return new LogicAppApiReference(id.Value, name.Value, Optional.ToNullable(type), displayName.Value, description.Value, iconUri.Value, swagger.Value, brandColor.Value, Optional.ToNullable(category), integrationServiceEnvironment.Value);
        }
    }
}
