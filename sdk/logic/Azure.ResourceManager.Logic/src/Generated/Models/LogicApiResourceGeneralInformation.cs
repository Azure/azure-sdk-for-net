...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicApiResourceGeneralInformation
    {
        ...
        internal LogicApiResourceGeneralInformation(Uri iconUri, string displayName, string description, Uri termsOfUseUri, string releaseTag, LogicApiTier? tier, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IconUri = iconUri;
