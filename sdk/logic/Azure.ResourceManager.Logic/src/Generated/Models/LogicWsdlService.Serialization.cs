...
{
    public partial class LogicWsdlService : IUtf8JsonSerializable, IJsonModel<LogicWsdlService>, IPersistableModel<LogicWsdlService>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(EndpointQualifiedNames))
            {
                builder.Append("  EndpointQualifiedNames:");
                builder.AppendLine(" [");
                foreach (var item in EndpointQualifiedNames)
                {
                    if (item == null)
