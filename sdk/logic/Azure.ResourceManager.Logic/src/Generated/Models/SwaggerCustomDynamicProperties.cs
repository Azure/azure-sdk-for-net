...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class SwaggerCustomDynamicProperties
    {
        ...
        internal SwaggerCustomDynamicProperties(string operationId, string valuePath, IDictionary<string, SwaggerCustomDynamicProperties> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
