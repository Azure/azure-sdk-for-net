...
{
    public partial class FlowEndpointsConfiguration : IUtf8JsonSerializable, IJsonModel<FlowEndpointsConfiguration>, IPersistableModel<FlowEndpointsConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Connector))
            {
                ...
                AppendChildObject(builder, Connector, options, 2);
            }
