...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdifactEnvelopeOverride>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdifactEnvelopeOverride>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdifactEnvelopeOverride>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdifactEnvelopeOverride>)} interface");
            }
        ...
        string IPersistableModel<EdifactEnvelopeOverride>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
