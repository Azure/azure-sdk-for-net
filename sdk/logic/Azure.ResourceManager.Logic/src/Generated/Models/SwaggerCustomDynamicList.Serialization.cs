...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwaggerCustomDynamicList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SwaggerCustomDynamicList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SwaggerCustomDynamicList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<SwaggerCustomDynamicList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
