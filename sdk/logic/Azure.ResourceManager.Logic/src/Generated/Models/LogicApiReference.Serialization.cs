...
{
    public partial class LogicApiReference : IUtf8JsonSerializable, IJsonModel<LogicApiReference>, IPersistableModel<LogicApiReference>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Swagger))
            {
                ...
                builder.AppendLine($" '{Swagger.ToString()}'");
            }
            ...
            if (Optional.IsDefined(IntegrationServiceEnvironment))
            {
                ...
                AppendChildObject(builder, IntegrationServiceEnvironment, options, 2);
            }
