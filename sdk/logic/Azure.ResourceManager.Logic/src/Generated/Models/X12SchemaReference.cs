...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class X12SchemaReference
    {
        ...
        internal X12SchemaReference(string messageId, string senderApplicationId, string schemaVersion, string schemaName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MessageId = messageId;
