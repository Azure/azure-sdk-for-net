...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicExpressionRoot>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogicExpressionRoot>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogicExpressionRoot>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogicExpressionRoot>)} interface");
            }
        ...
        string IPersistableModel<LogicExpressionRoot>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
