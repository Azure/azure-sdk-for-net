...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicWorkflowTriggerCallbackQueryParameterInfo
    {
        ...
        internal LogicWorkflowTriggerCallbackQueryParameterInfo(string apiVersion, string sp, string sv, string sig, string se, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
