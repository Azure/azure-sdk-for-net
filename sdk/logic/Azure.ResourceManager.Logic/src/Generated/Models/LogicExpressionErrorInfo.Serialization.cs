...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static LogicExpressionErrorInfo DeserializeLogicExpressionErrorInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
