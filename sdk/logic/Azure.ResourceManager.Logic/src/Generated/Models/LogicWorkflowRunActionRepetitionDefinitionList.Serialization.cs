...
namespace Azure.ResourceManager.Logic.Models
{
    internal partial class LogicWorkflowRunActionRepetitionDefinitionList : IUtf8JsonSerializable, IJsonModel<LogicWorkflowRunActionRepetitionDefinitionList>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<LogicWorkflowRunActionRepetitionDefinitionList>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogicWorkflowRunActionRepetitionDefinitionList>)} interface");
            }
