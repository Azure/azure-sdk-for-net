...
namespace Azure.ResourceManager.Logic.Models
{
    internal partial class LogicWorkflowRunActionRepetitionDefinitionList : IUtf8JsonSerializable, IJsonModel<LogicWorkflowRunActionRepetitionDefinitionList>
    {
        ...
        void IJsonModel<LogicWorkflowRunActionRepetitionDefinitionList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LogicWorkflowRunActionRepetitionDefinitionList)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LogicWorkflowRunActionRepetitionDefinitionList>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LogicWorkflowRunActionRepetitionDefinitionList)} does not support '{options.Format}' format.");
            }
        }
