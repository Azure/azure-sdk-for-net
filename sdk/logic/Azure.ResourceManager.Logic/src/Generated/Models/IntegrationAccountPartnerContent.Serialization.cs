...
{
    public partial class IntegrationAccountPartnerContent : IUtf8JsonSerializable, IJsonModel<IntegrationAccountPartnerContent>, IPersistableModel<IntegrationAccountPartnerContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  b2b:");
                AppendChildObject(builder, B2B, options, 2);
            }
