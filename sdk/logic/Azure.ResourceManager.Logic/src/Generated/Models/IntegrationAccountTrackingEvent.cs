...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class IntegrationAccountTrackingEvent
    {
        ...
        internal IntegrationAccountTrackingEvent(IntegrationAccountEventLevel eventLevel, DateTimeOffset eventOn, IntegrationAccountTrackingRecordType recordType, BinaryData record, IntegrationAccountTrackingEventErrorInfo error, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            EventLevel = eventLevel;
            EventOn = eventOn;
            RecordType = recordType;
