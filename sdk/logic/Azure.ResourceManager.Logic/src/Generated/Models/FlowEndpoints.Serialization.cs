...
{
    public partial class FlowEndpoints : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FlowEndpoints DeserializeFlowEndpoints(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
