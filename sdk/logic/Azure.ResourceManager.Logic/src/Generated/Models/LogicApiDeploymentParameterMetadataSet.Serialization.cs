...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static LogicApiDeploymentParameterMetadataSet DeserializeLogicApiDeploymentParameterMetadataSet(JsonElement element, SerializableOptions options = default)
        {
