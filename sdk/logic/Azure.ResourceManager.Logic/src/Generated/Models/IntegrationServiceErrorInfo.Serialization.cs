...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationServiceErrorInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IntegrationServiceErrorInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IntegrationServiceErrorInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IntegrationServiceErrorInfo>)} interface");
            }
        ...
        string IPersistableModel<IntegrationServiceErrorInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
