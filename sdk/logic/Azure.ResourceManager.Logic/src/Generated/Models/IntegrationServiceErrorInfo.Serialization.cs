...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static IntegrationServiceErrorInfo DeserializeIntegrationServiceErrorInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
