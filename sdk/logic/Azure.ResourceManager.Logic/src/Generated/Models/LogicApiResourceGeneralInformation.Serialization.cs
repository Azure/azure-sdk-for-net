...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicApiResourceGeneralInformation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogicApiResourceGeneralInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogicApiResourceGeneralInformation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogicApiResourceGeneralInformation>)} interface");
            }
        ...
        string IPersistableModel<LogicApiResourceGeneralInformation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
