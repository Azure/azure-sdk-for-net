...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<X12EnvelopeSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<X12EnvelopeSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<X12EnvelopeSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<X12EnvelopeSettings>)} interface");
            }
        ...
        string IPersistableModel<X12EnvelopeSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
