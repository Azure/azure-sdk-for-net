...
{
    public partial class AgreementContent : IUtf8JsonSerializable
    {
        ...
        internal static AgreementContent DeserializeAgreementContent(JsonElement element)
        {
            ...
            return new AgreementContent(aS2.Value, x12.Value, edifact.Value);
        }
    }
}
