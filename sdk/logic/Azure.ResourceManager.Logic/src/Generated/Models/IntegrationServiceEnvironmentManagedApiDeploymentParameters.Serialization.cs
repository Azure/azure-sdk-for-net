...
namespace Azure.ResourceManager.Logic.Models
{
    internal partial class IntegrationServiceEnvironmentManagedApiDeploymentParameters : IUtf8JsonSerializable, IModelJsonSerializable<IntegrationServiceEnvironmentManagedApiDeploymentParameters>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<IntegrationServiceEnvironmentManagedApiDeploymentParameters>(this, options.Format);

            writer.WriteStartObject();
            if (Optional.IsDefined(ContentLinkDefinition))
            {
                writer.WritePropertyName("contentLinkDefinition"u8);
                if (ContentLinkDefinition is null)
                {
                    writer.WriteNullValue();
                }
                else
                {
                    ((IModelJsonSerializable<LogicContentLink>)ContentLinkDefinition).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="IntegrationServiceEnvironmentManagedApiDeploymentParameters"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="IntegrationServiceEnvironmentManagedApiDeploymentParameters"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="IntegrationServiceEnvironmentManagedApiDeploymentParameters"/>. </summary>
