...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationServiceEnvironmentManagedApiDeploymentParameters>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        IntegrationServiceEnvironmentManagedApiDeploymentParameters IJsonModel<IntegrationServiceEnvironmentManagedApiDeploymentParameters>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<IntegrationServiceEnvironmentManagedApiDeploymentParameters>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        IntegrationServiceEnvironmentManagedApiDeploymentParameters IModel<IntegrationServiceEnvironmentManagedApiDeploymentParameters>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<IntegrationServiceEnvironmentManagedApiDeploymentParameters>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
