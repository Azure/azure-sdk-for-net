...
{
    internal partial class IntegrationServiceEnvironmentManagedApiDeploymentParameters : IUtf8JsonSerializable, IJsonModel<IntegrationServiceEnvironmentManagedApiDeploymentParameters>, IPersistableModel<IntegrationServiceEnvironmentManagedApiDeploymentParameters>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ContentLinkDefinition))
            {
                builder.Append("  contentLinkDefinition:");
                AppendChildObject(builder, ContentLinkDefinition, options, 2);
            }
