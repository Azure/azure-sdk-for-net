...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationAccountCertificateListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntegrationAccountCertificateListResult)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<IntegrationAccountCertificateData>)item).Write(writer, options);
                }
        ...
        IntegrationAccountCertificateListResult IJsonModel<IntegrationAccountCertificateListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntegrationAccountCertificateListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static IntegrationAccountCertificateListResult DeserializeIntegrationAccountCertificateListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new IntegrationAccountCertificateListResult(value ?? new ChangeTrackingList<IntegrationAccountCertificateData>(), nextLink, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<IntegrationAccountCertificateListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IntegrationAccountCertificateListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        IntegrationAccountCertificateListResult IPersistableModel<IntegrationAccountCertificateListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IntegrationAccountCertificateListResult)} does not support reading '{options.Format}' format.");
            }
        }
