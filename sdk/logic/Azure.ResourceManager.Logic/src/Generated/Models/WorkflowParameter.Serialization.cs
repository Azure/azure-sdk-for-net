...
{
    public partial class WorkflowParameter : IUtf8JsonSerializable
    {
        ...
        internal static WorkflowParameter DeserializeWorkflowParameter(JsonElement element)
        {
            ...
            return new WorkflowParameter(Optional.ToNullable(type), value.Value, metadata.Value, description.Value);
        }
    }
}
