...
namespace Azure.ResourceManager.Logic
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationAccountCertificateData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IntegrationAccountCertificateData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IntegrationAccountCertificateData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IntegrationAccountCertificateData>)} interface");
            }
        ...
        string IPersistableModel<IntegrationAccountCertificateData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
