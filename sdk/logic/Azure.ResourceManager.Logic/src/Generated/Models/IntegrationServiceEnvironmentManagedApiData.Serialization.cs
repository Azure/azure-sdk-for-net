...
{
    public partial class IntegrationServiceEnvironmentManagedApiData : IUtf8JsonSerializable, IJsonModel<IntegrationServiceEnvironmentManagedApiData>, IPersistableModel<IntegrationServiceEnvironmentManagedApiData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  generalInformation:");
                AppendChildObject(builder, GeneralInformation, options, 2);
            }
            ...
            {
                builder.Append("  backendService:");
                AppendChildObject(builder, BackendService, options, 2);
            }

            if (Optional.IsDefined(Policies))
            {
                builder.Append("  policies:");
                AppendChildObject(builder, Policies, options, 2);
            }

            if (Optional.IsDefined(ApiDefinitionUri))
            {
                builder.Append("  apiDefinitionUrl:");
                builder.AppendLine($" '{ApiDefinitionUri.AbsoluteUri}'");
            }

            if (Optional.IsDefined(ApiDefinitions))
            {
                builder.Append("  apiDefinitions:");
                AppendChildObject(builder, ApiDefinitions, options, 2);
            }
