...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicWorkflowOutputParameterInfo : LogicWorkflowParameterInfo
    {
        ...
        internal LogicWorkflowOutputParameterInfo(LogicWorkflowParameterType? parameterType, BinaryData value, BinaryData metadata, string description, BinaryData error, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(parameterType, value, metadata, description, serializedAdditionalRawData)
        {
            Error = error;
        }
