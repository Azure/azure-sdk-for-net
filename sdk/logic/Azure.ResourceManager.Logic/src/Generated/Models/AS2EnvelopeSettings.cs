...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class AS2EnvelopeSettings
    {
        ...
        internal AS2EnvelopeSettings(ContentType messageContentType, bool transmitFileNameInMimeHeader, string fileNameTemplate, bool suspendMessageOnFileNameGenerationError, bool autoGenerateFileName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MessageContentType = messageContentType;
            TransmitFileNameInMimeHeader = transmitFileNameInMimeHeader;
            FileNameTemplate = fileNameTemplate;
