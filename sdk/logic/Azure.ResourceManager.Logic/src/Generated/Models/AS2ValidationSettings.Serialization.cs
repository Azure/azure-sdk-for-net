...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AS2ValidationSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AS2ValidationSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AS2ValidationSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AS2ValidationSettings>)} interface");
            }
        ...
        string IPersistableModel<AS2ValidationSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
