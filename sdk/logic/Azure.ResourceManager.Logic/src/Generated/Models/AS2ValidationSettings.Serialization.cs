...
{
    public partial class AS2ValidationSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AS2ValidationSettings DeserializeAS2ValidationSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
