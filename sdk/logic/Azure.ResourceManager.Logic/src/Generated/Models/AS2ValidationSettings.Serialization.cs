...
{
    public partial class AS2ValidationSettings : IUtf8JsonSerializable, IJsonModel<AS2ValidationSettings>, IPersistableModel<AS2ValidationSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InterchangeDuplicatesValidityDays))
            {
                ...
                builder.AppendLine($" '{InterchangeDuplicatesValidityDays.ToString()}'");
            }
