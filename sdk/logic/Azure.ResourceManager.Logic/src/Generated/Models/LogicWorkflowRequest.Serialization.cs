...
{
    public partial class LogicWorkflowRequest : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LogicWorkflowRequest DeserializeLogicWorkflowRequest(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
