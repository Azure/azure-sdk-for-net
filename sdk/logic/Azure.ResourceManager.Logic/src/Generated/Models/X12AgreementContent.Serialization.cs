...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<X12AgreementContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<X12AgreementContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<X12AgreementContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<X12AgreementContent>)} interface");
            }
        ...
        string IPersistableModel<X12AgreementContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
