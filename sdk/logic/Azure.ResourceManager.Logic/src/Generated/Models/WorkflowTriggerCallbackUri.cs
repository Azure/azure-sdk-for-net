...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        /// <summary> Initializes a new instance of WorkflowTriggerCallbackUri. </summary>
        ...
        internal WorkflowTriggerCallbackUri(string value, string method, string basePath, string relativePath, IReadOnlyList<string> relativePathParameters, WorkflowTriggerListCallbackUrlQueries queries)
        {
            Value = value;
            Method = method;
            BasePath = basePath;
