...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicApiOperationAnnotation
    {
        ...
        internal LogicApiOperationAnnotation(LogicApiOperationAnnotationStatus? status, string family, int? revision, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
            Family = family;
            Revision = revision;
