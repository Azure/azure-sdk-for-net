...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdifactProtocolSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdifactProtocolSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdifactProtocolSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdifactProtocolSettings>)} interface");
            }
        ...
        string IPersistableModel<EdifactProtocolSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
