...
namespace Azure.ResourceManager.Logic.Models
{
    public partial class EdifactOneWayAgreement : IUtf8JsonSerializable, IModelJsonSerializable<EdifactOneWayAgreement>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<EdifactOneWayAgreement>(this, options.Format);
            ...
            {
                ((IModelJsonSerializable<EdifactProtocolSettings>)ProtocolSettings).Serialize(writer, options);
            }
        ...
        /// <summary> Converts a <see cref="EdifactOneWayAgreement"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="EdifactOneWayAgreement"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="EdifactOneWayAgreement"/>. </summary>
