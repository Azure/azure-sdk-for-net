...
namespace Azure.ResourceManager.Logic.Models
{
    public partial class X12ProcessingSettings : IUtf8JsonSerializable, IJsonModel<X12ProcessingSettings>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<X12ProcessingSettings>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<X12ProcessingSettings>)} interface");
            }
