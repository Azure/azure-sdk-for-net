...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdifactValidationOverride>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdifactValidationOverride>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdifactValidationOverride>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdifactValidationOverride>)} interface");
            }
        ...
        string IPersistableModel<EdifactValidationOverride>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
