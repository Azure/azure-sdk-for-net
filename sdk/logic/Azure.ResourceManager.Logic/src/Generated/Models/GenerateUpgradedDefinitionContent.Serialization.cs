...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GenerateUpgradedDefinitionContent>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GenerateUpgradedDefinitionContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GenerateUpgradedDefinitionContent>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GenerateUpgradedDefinitionContent>)} interface");
            }
        ...
        string IPersistableModel<GenerateUpgradedDefinitionContent>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
