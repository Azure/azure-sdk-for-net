...
{
    public partial class AS2ErrorSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AS2ErrorSettings DeserializeAS2ErrorSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
