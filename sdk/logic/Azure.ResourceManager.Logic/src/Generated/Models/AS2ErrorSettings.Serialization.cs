...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AS2ErrorSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AS2ErrorSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AS2ErrorSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AS2ErrorSettings>)} interface");
            }
        ...
        string IPersistableModel<AS2ErrorSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
