...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SwaggerCustomDynamicProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SwaggerCustomDynamicProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SwaggerCustomDynamicProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SwaggerCustomDynamicProperties>)} interface");
            }
        ...
        string IPersistableModel<SwaggerCustomDynamicProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
