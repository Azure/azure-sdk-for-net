...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class SwaggerCustomDynamicTreeCommand
    {
        ...
        internal SwaggerCustomDynamicTreeCommand(string operationId, string itemsPath, string itemValuePath, string itemTitlePath, string itemFullTitlePath, string itemIsParent, string selectableFilter, IDictionary<string, SwaggerCustomDynamicTreeParameterInfo> parameters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
