...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LogicApiResourceMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LogicApiResourceMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LogicApiResourceMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LogicApiResourceMetadata>)} interface");
            }
        ...
        string IPersistableModel<LogicApiResourceMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
