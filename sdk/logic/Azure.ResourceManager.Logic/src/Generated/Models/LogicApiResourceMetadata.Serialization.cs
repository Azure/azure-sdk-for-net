...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static LogicApiResourceMetadata DeserializeLogicApiResourceMetadata(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
