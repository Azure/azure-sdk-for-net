...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdifactMessageFilter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdifactMessageFilter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdifactMessageFilter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<EdifactMessageFilter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
