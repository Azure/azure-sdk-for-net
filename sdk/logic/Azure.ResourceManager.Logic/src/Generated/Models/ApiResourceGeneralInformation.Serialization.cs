...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static ApiResourceGeneralInformation DeserializeApiResourceGeneralInformation(JsonElement element)
        {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("tier"))
                {
                    ...
                    tier = new ApiTier(property.Value.GetString());
                    continue;
                }
            }
            return new ApiResourceGeneralInformation(iconUrl.Value, displayName.Value, description.Value, termsOfUseUrl.Value, releaseTag.Value, Optional.ToNullable(tier));
        }
    }
}
