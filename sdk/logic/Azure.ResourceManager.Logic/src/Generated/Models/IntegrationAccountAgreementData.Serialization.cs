...
{
    public partial class IntegrationAccountAgreementData : IUtf8JsonSerializable, IJsonModel<IntegrationAccountAgreementData>, IPersistableModel<IntegrationAccountAgreementData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(HostIdentity))
            {
                ...
                AppendChildObject(builder, HostIdentity, options, 2);
            }

            if (Optional.IsDefined(GuestIdentity))
            {
                builder.Append("  guestIdentity:");
                AppendChildObject(builder, GuestIdentity, options, 2);
            }
