...
{
    public partial class ArtifactContentPropertiesDefinition : IUtf8JsonSerializable
    {
        ...
        internal static ArtifactContentPropertiesDefinition DeserializeArtifactContentPropertiesDefinition(JsonElement element)
        {
            ...
            return new ArtifactContentPropertiesDefinition(Optional.ToNullable(createdTime), Optional.ToNullable(changedTime), metadata.Value, content.Value, contentType.Value, contentLink.Value);
        }
    }
}
