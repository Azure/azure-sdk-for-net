...
{
    public partial class RetryHistory : IUtf8JsonSerializable
    {
        ...
        internal static RetryHistory DeserializeRetryHistory(JsonElement element)
        {
            ...
            return new RetryHistory(Optional.ToNullable(startTime), Optional.ToNullable(endTime), code.Value, clientRequestId.Value, serviceRequestId.Value, error.Value);
        }
    }
}
