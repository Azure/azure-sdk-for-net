...
namespace Azure.ResourceManager.Logic.Models
{
    public partial class IntegrationAccountBatchReleaseCriteria : IUtf8JsonSerializable, IJsonModel<IntegrationAccountBatchReleaseCriteria>
    {
        ...
        void IJsonModel<IntegrationAccountBatchReleaseCriteria>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(IntegrationAccountBatchReleaseCriteria)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IntegrationAccountBatchReleaseCriteria>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(IntegrationAccountBatchReleaseCriteria)} does not support '{options.Format}' format.");
            }
        }
