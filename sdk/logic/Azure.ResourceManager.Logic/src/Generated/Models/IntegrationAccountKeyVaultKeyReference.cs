...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class IntegrationAccountKeyVaultKeyReference
    {
        ...
        internal IntegrationAccountKeyVaultKeyReference(string keyName, string keyVersion, ResourceIdentifier resourceId, string resourceName, ResourceType? resourceType, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            KeyName = keyName;
