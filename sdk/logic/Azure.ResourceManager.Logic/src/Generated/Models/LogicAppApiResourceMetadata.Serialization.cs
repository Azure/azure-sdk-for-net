...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static LogicAppApiResourceMetadata DeserializeLogicAppApiResourceMetadata(JsonElement element)
        {
            Optional<string> source = default;
            Optional<string> brandColor = default;
            Optional<string> hideKey = default;
            Optional<IReadOnlyDictionary<string, string>> tags = default;
            Optional<LogicAppApiType> apiType = default;
            ...
            Optional<LogicAppApiDeploymentParameterMetadataSet> deploymentParameters = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("ApiType"))
                {
                    ...
                    apiType = new LogicAppApiType(property.Value.GetString());
                    continue;
                }
                ...
                if (property.NameEquals("deploymentParameters"))
                {
                    ...
                    deploymentParameters = LogicAppApiDeploymentParameterMetadataSet.DeserializeLogicAppApiDeploymentParameterMetadataSet(property.Value);
                    continue;
                }
            }
            return new LogicAppApiResourceMetadata(source.Value, brandColor.Value, hideKey.Value, Optional.ToDictionary(tags), Optional.ToNullable(apiType), wsdlService.Value, Optional.ToNullable(wsdlImportMethod), connectionType.Value, Optional.ToNullable(provisioningState), deploymentParameters.Value);
        }
    }
}
