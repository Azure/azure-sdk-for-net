...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class X12OneWayAgreement
    {
        ...
        internal X12OneWayAgreement(IntegrationAccountBusinessIdentity senderBusinessIdentity, IntegrationAccountBusinessIdentity receiverBusinessIdentity, X12ProtocolSettings protocolSettings, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            SenderBusinessIdentity = senderBusinessIdentity;
            ReceiverBusinessIdentity = receiverBusinessIdentity;
            ProtocolSettings = protocolSettings;
