...
{
    public partial class EdifactValidationSettings : IUtf8JsonSerializable, IJsonModel<EdifactValidationSettings>, IPersistableModel<EdifactValidationSettings>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdifactValidationSettings>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<EdifactValidationSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EdifactValidationSettings)} does not support '{format}' format.");
            }
