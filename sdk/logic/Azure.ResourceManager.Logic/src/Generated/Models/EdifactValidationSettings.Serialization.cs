...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdifactValidationSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdifactValidationSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdifactValidationSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdifactValidationSettings>)} interface");
            }
        ...
        string IPersistableModel<EdifactValidationSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
