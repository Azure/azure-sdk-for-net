...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicWorkflowRequestHistoryProperties
    {
        ...
        internal LogicWorkflowRequestHistoryProperties(DateTimeOffset? startOn, DateTimeOffset? endOn, LogicWorkflowRequest request, LogicWorkflowResponse response, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartOn = startOn;
            EndOn = endOn;
            Request = request;
