...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicExpressionErrorInfo : LogicErrorInfo
    {
        ...
        internal LogicExpressionErrorInfo(string code, string message, IReadOnlyList<LogicExpressionErrorInfo> details, Dictionary<string, BinaryData> rawData) : base(code, rawData)
        {
            Message = message;
            Details = details;
        }
