...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicWorkflowTriggerCallbackUri
    {
        ...
        internal LogicWorkflowTriggerCallbackUri(string value, RequestMethod? method, string basePath, string relativePath, IReadOnlyList<string> relativePathParameters, LogicWorkflowTriggerCallbackQueryParameterInfo queries, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
            Method = method;
            BasePath = basePath;
