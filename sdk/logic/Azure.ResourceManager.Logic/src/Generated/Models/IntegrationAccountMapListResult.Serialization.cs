...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static IntegrationAccountMapListResult DeserializeIntegrationAccountMapListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
