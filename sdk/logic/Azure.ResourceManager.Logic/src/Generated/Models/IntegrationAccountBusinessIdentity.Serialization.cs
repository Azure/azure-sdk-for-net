...
{
    public partial class IntegrationAccountBusinessIdentity : IUtf8JsonSerializable, IJsonModel<IntegrationAccountBusinessIdentity>, IPersistableModel<IntegrationAccountBusinessIdentity>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationAccountBusinessIdentity>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<IntegrationAccountBusinessIdentity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntegrationAccountBusinessIdentity)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Qualifier))
            {
