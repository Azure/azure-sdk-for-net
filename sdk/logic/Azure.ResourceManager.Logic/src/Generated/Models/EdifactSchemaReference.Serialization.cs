...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EdifactSchemaReference>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EdifactSchemaReference>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EdifactSchemaReference>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EdifactSchemaReference>)} interface");
            }
        ...
        string IPersistableModel<EdifactSchemaReference>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
