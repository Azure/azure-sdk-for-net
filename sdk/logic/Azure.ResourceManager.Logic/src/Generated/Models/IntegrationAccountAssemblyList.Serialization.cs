...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    {
        internal static IntegrationAccountAssemblyList DeserializeIntegrationAccountAssemblyList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
