...
{
    public partial class LogicAppApiOperationProperties : IUtf8JsonSerializable
    {
        ...
        internal static LogicAppApiOperationProperties DeserializeLogicAppApiOperationProperties(JsonElement element)
        {
            ...
            Optional<LogicAppApiOperationAnnotation> annotation = default;
            Optional<LogicAppApiReference> api = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("annotation"))
                {
                    ...
                    annotation = LogicAppApiOperationAnnotation.DeserializeLogicAppApiOperationAnnotation(property.Value);
                    continue;
                }
                if (property.NameEquals("api"))
                {
                    ...
                    api = LogicAppApiReference.DeserializeLogicAppApiReference(property.Value);
                    continue;
                }
            ...
            return new LogicAppApiOperationProperties(summary.Value, description.Value, visibility.Value, trigger.Value, triggerHint.Value, Optional.ToNullable(pageable), annotation.Value, api.Value, inputsDefinition.Value, Optional.ToDictionary(responsesDefinition), Optional.ToNullable(isWebhook), Optional.ToNullable(isNotification));
        }
    }
}
