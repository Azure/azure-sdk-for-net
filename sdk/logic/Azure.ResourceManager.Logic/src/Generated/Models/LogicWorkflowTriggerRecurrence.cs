...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicWorkflowTriggerRecurrence
    {
        ...
        internal LogicWorkflowTriggerRecurrence(LogicWorkflowRecurrenceFrequency? frequency, int? interval, DateTimeOffset? startOn, DateTimeOffset? endOn, string timeZone, LogicWorkflowRecurrenceSchedule schedule, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Frequency = frequency;
            Interval = interval;
            StartOn = startOn;
