...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public partial class LogicWorkflowRunActionCorrelation : LogicWorkflowRunCorrelation
    {
        ...
        internal LogicWorkflowRunActionCorrelation(string clientTrackingId, IList<string> clientKeywords, Guid? actionTrackingId, Dictionary<string, BinaryData> rawData) : base(clientTrackingId, clientKeywords, rawData)
        {
