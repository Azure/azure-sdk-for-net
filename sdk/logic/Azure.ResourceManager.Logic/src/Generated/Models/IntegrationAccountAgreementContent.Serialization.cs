...
{
    public partial class IntegrationAccountAgreementContent : IUtf8JsonSerializable, IJsonModel<IntegrationAccountAgreementContent>, IPersistableModel<IntegrationAccountAgreementContent>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  aS2:");
                AppendChildObject(builder, AS2, options, 2);
            }

            if (Optional.IsDefined(X12))
            {
                builder.Append("  x12:");
                AppendChildObject(builder, X12, options, 2);
            }

            if (Optional.IsDefined(Edifact))
            {
                builder.Append("  edifact:");
                AppendChildObject(builder, Edifact, options, 2);
            }
