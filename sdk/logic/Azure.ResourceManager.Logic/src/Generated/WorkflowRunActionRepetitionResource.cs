...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class WorkflowRunActionRepetitionResource : ArmResource
    {
        ...
        {
            _workflowRunActionRepetitionClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Logic", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of WorkflowRunActionRepetitionRequestHistoryResources in the WorkflowRunActionRepetition. </summary>
        /// <returns> An object representing collection of WorkflowRunActionRepetitionRequestHistoryResources and their operations over a WorkflowRunActionRepetitionRequestHistoryResource. </returns>
        public virtual WorkflowRunActionRepetitionRequestHistoryCollection GetWorkflowRunActionRepetitionRequestHistories()
        {
            return GetCachedClient(Client => new WorkflowRunActionRepetitionRequestHistoryCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<WorkflowRunActionRepetitionRequestHistoryResource>> GetWorkflowRunActionRepetitionRequestHistoryAsync(string requestHistoryName, CancellationToken cancellationToken = default)
        {
            return await GetWorkflowRunActionRepetitionRequestHistories().GetAsync(requestHistoryName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="requestHistoryName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<WorkflowRunActionRepetitionRequestHistoryResource> GetWorkflowRunActionRepetitionRequestHistory(string requestHistoryName, CancellationToken cancellationToken = default)
        {
            return GetWorkflowRunActionRepetitionRequestHistories().Get(requestHistoryName, cancellationToken);
        }
        ...
        public virtual async Task<Response<WorkflowRunActionRepetitionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _workflowRunActionRepetitionRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<WorkflowRunActionRepetitionResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _workflowRunActionRepetitionRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new WorkflowRunActionRepetitionResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual AsyncPageable<ExpressionRoot> GetExpressionTracesAsync(CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _workflowRunActionRepetitionClientDiagnostics.CreateScope("WorkflowRunActionRepetitionResource.GetExpressionTraces");
                scope.Start();
                try
                {
                    var response = await _workflowRunActionRepetitionRestClient.ListExpressionTracesAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Pageable<ExpressionRoot> GetExpressionTraces(CancellationToken cancellationToken = default)
        {
            Page<ExpressionRoot> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _workflowRunActionRepetitionRestClient.ListExpressionTraces(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Inputs, null, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual async Task<Response<WorkflowRunActionRepetitionResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));

            using var scope = _workflowRunActionRepetitionClientDiagnostics.CreateScope("WorkflowRunActionRepetitionResource.AddTag");
            scope.Start();
            try
            {
                ...
                var originalResponse = await _workflowRunActionRepetitionRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return Response.FromValue(new WorkflowRunActionRepetitionResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> or <paramref name="value"/> is null. </exception>
        public virtual Response<WorkflowRunActionRepetitionResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
            Argument.AssertNotNull(value, nameof(value));
            ...
            try
            {
                ...
                var originalResponse = _workflowRunActionRepetitionRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                return Response.FromValue(new WorkflowRunActionRepetitionResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        public virtual async Task<Response<WorkflowRunActionRepetitionResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));

            using var scope = _workflowRunActionRepetitionClientDiagnostics.CreateScope("WorkflowRunActionRepetitionResource.SetTags");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="tags"/> is null. </exception>
        public virtual Response<WorkflowRunActionRepetitionResource> SetTags(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(tags, nameof(tags));
        ...
        public virtual async Task<Response<WorkflowRunActionRepetitionResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));

            using var scope = _workflowRunActionRepetitionClientDiagnostics.CreateScope("WorkflowRunActionRepetitionResource.RemoveTag");
            scope.Start();
            try
            {
                var originalTags = await GetTagResource().GetAsync(cancellationToken).ConfigureAwait(false);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="key"/> is null. </exception>
        public virtual Response<WorkflowRunActionRepetitionResource> RemoveTag(string key, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(key, nameof(key));
