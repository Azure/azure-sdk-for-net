...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class LogicWorkflowRunActionRepetitionRequestHistoryResource : ArmResource
    {
        ...
        internal LogicWorkflowRunActionRepetitionRequestHistoryResource(ArmClient client, LogicWorkflowRequestHistoryData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
