...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class LogicWorkflowRunResource : BaseLogicWorkflowRunResource
    {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<LogicWorkflowRunResource>> GetAsync(CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<LogicWorkflowRunResource> Get(CancellationToken cancellationToken = default)
        {
