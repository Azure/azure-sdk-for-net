...
namespace Azure.ResourceManager.Logic.Models
{
    ...
    public static partial class ArmLogicModelFactory
    {
        ...
        {
            return new LogicWorkflowRunTrigger(name, inputs, inputsLink, outputs, outputsLink, scheduledOn, startOn, endOn, trackingId, correlationClientTrackingId != null ? new Correlation(correlationClientTrackingId, new Dictionary<string, BinaryData>()) : null, code, status, error, trackedProperties, serializedAdditionalRawData: null);
        }
        ...
        public static IntegrationAccountData IntegrationAccountData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, IntegrationAccountSkuName? skuName = null, LogicResourceReference integrationServiceEnvironment = null, LogicWorkflowState? state = null)
        {
            ...
            return new IntegrationAccountData(id, name, resourceType, systemData, tags, location, skuName.HasValue ? new IntegrationAccountSku(skuName.Value, new Dictionary<string, BinaryData>()) : null, integrationServiceEnvironment, state, serializedAdditionalRawData: null);
        }
