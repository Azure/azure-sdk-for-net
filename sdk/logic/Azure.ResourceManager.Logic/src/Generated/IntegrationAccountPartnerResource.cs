...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class IntegrationAccountPartnerResource : ArmResource
    {
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>IntegrationAccountPartners_Delete</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        /// <item>
        /// <term>Request Path</term>
        /// <description>/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/partners/{partnerName}/listContentCallbackUrl</description>
        /// </item>
        /// <item>
        /// <term>Operation Id</term>
        /// <description>IntegrationAccountPartners_ListContentCallbackUrl</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        public virtual async Task<Response<LogicWorkflowTriggerCallbackUri>> GetContentCallbackUrlAsync(ListOperationCallbackUrlParameterInfo info, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _integrationAccountPartnerRestClient.ListContentCallbackUrlAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, info, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response<LogicWorkflowTriggerCallbackUri> GetContentCallbackUrl(ListOperationCallbackUrlParameterInfo info, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _integrationAccountPartnerRestClient.ListContentCallbackUrl(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, info, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
