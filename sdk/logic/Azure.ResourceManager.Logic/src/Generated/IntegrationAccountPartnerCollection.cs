...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class IntegrationAccountPartnerCollection : ArmCollection, IEnumerable<IntegrationAccountPartnerResource>, IAsyncEnumerable<IntegrationAccountPartnerResource>
    {
        ...
        /// Request Path: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/partners
        /// Operation Id: IntegrationAccountPartners_List
        /// </summary>
        ...
        {
            async Task<Page<IntegrationAccountPartnerResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _integrationAccountPartnerClientDiagnostics.CreateScope("IntegrationAccountPartnerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _integrationAccountPartnerRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountPartnerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<IntegrationAccountPartnerResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _integrationAccountPartnerClientDiagnostics.CreateScope("IntegrationAccountPartnerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _integrationAccountPartnerRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountPartnerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<IntegrationAccountPartnerResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _integrationAccountPartnerClientDiagnostics.CreateScope("IntegrationAccountPartnerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _integrationAccountPartnerRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountPartnerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<IntegrationAccountPartnerResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _integrationAccountPartnerClientDiagnostics.CreateScope("IntegrationAccountPartnerCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _integrationAccountPartnerRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountPartnerResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
