...
namespace Azure.ResourceManager.Logic
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IntegrationAccountPartnerData>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntegrationAccountPartnerData)} does not support writing '{format}' format.");
            }
        ...
        IntegrationAccountPartnerData IJsonModel<IntegrationAccountPartnerData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(IntegrationAccountPartnerData)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<IntegrationAccountPartnerData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IntegrationAccountPartnerData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        IntegrationAccountPartnerData IPersistableModel<IntegrationAccountPartnerData>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(IntegrationAccountPartnerData)} does not support reading '{options.Format}' format.");
            }
        }
