...
namespace Azure.ResourceManager.Logic
{
    ...
    {
        private static IntegrationAccountResourceExtensionClient GetIntegrationAccountResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new IntegrationAccountResourceExtensionClient(client, resource.Id);
            });
        }

        private static IntegrationAccountResourceExtensionClient GetIntegrationAccountResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new IntegrationAccountResourceExtensionClient(client, scope);
            });
        }

        private static IntegrationServiceEnvironmentResourceExtensionClient GetIntegrationServiceEnvironmentResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new IntegrationServiceEnvironmentResourceExtensionClient(client, resource.Id);
            });
        }

        private static IntegrationServiceEnvironmentResourceExtensionClient GetIntegrationServiceEnvironmentResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new IntegrationServiceEnvironmentResourceExtensionClient(client, scope);
            });
        }

        private static LogicWorkflowResourceExtensionClient GetLogicWorkflowResourceExtensionClient(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new LogicWorkflowResourceExtensionClient(client, resource.Id);
            });
        }

        private static LogicWorkflowResourceExtensionClient GetLogicWorkflowResourceExtensionClient(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new LogicWorkflowResourceExtensionClient(client, scope);
            });
        }
        ...
        public static async Task<Response> ValidateByLocationWorkflowAsync(this ResourceGroupResource resourceGroupResource, AzureLocation location, string workflowName, LogicWorkflowData data, CancellationToken cancellationToken = default)
        {
            ...
            return await GetLogicWorkflowResourceExtensionClient(resourceGroupResource).ValidateByLocationWorkflowAsync(location, workflowName, data, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response ValidateByLocationWorkflow(this ResourceGroupResource resourceGroupResource, AzureLocation location, string workflowName, LogicWorkflowData data, CancellationToken cancellationToken = default)
        {
            ...
            return GetLogicWorkflowResourceExtensionClient(resourceGroupResource).ValidateByLocationWorkflow(location, workflowName, data, cancellationToken);
        }
        ...
        {
            return GetLogicWorkflowResourceExtensionClient(subscriptionResource).GetLogicWorkflowsAsync(top, filter, cancellationToken);
        }
        ...
        {
            return GetLogicWorkflowResourceExtensionClient(subscriptionResource).GetLogicWorkflows(top, filter, cancellationToken);
        }
        ...
        {
            return GetIntegrationAccountResourceExtensionClient(subscriptionResource).GetIntegrationAccountsAsync(top, cancellationToken);
        }
        ...
        {
            return GetIntegrationAccountResourceExtensionClient(subscriptionResource).GetIntegrationAccounts(top, cancellationToken);
        }
        ...
        {
            return GetIntegrationServiceEnvironmentResourceExtensionClient(subscriptionResource).GetIntegrationServiceEnvironmentsAsync(top, cancellationToken);
        }
        ...
        {
            return GetIntegrationServiceEnvironmentResourceExtensionClient(subscriptionResource).GetIntegrationServiceEnvironments(top, cancellationToken);
        }
    }
}
