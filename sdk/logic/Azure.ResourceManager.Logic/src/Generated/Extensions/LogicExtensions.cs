...
using Azure.ResourceManager.Logic.Testing;
...
namespace Azure.ResourceManager.Logic
{
    ...
    public static partial class LogicExtensions
    {
        ...
        private static LogicSubscriptionResourceExtension GetLogicSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new LogicSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static LogicSubscriptionResourceExtension GetLogicSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new LogicSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        public static async Task<Response> ValidateByLocationWorkflowAsync(this ResourceGroupResource resourceGroupResource, AzureLocation location, string workflowName, LogicWorkflowData data, CancellationToken cancellationToken = default)
        {
            ...
            return await GetLogicResourceGroupResourceExtension(resourceGroupResource).ValidateByLocationWorkflowAsync(location, workflowName, data, cancellationToken).ConfigureAwait(false);
        }
        ...
        public static Response ValidateByLocationWorkflow(this ResourceGroupResource resourceGroupResource, AzureLocation location, string workflowName, LogicWorkflowData data, CancellationToken cancellationToken = default)
        {
            ...
            return GetLogicResourceGroupResourceExtension(resourceGroupResource).ValidateByLocationWorkflow(location, workflowName, data, cancellationToken);
        }
        ...
        {
            return GetLogicSubscriptionResourceExtension(subscriptionResource).GetLogicWorkflowsAsync(top, filter, cancellationToken);
        }
        ...
        {
            return GetLogicSubscriptionResourceExtension(subscriptionResource).GetLogicWorkflows(top, filter, cancellationToken);
        }
        ...
        {
            return GetLogicSubscriptionResourceExtension(subscriptionResource).GetIntegrationAccountsAsync(top, cancellationToken);
        }
        ...
        {
            return GetLogicSubscriptionResourceExtension(subscriptionResource).GetIntegrationAccounts(top, cancellationToken);
        }
        ...
        {
            return GetLogicSubscriptionResourceExtension(subscriptionResource).GetIntegrationServiceEnvironmentsAsync(top, cancellationToken);
        }
        ...
        {
            return GetLogicSubscriptionResourceExtension(subscriptionResource).GetIntegrationServiceEnvironments(top, cancellationToken);
        }
    }
}
