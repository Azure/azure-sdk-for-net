...
namespace Azure.ResourceManager.Logic.Mock
{
    ...
    public partial class IntegrationServiceEnvironmentResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="IntegrationServiceEnvironmentResourceExtension"/> class for mocking. </summary>
        protected IntegrationServiceEnvironmentResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="IntegrationServiceEnvironmentResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal IntegrationServiceEnvironmentResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<IntegrationServiceEnvironmentResource> GetIntegrationServiceEnvironmentsAsync(int? top = null, CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new IntegrationServiceEnvironmentResource(Client, IntegrationServiceEnvironmentData.DeserializeIntegrationServiceEnvironmentData(e)), IntegrationServiceEnvironmentClientDiagnostics, Pipeline, "IntegrationServiceEnvironmentResourceExtension.GetIntegrationServiceEnvironments", "value", "nextLink", cancellationToken);
        }
