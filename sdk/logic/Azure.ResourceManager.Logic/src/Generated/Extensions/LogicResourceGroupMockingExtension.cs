...
namespace Azure.ResourceManager.Logic.Mocking
{
    ...
    internal partial class LogicResourceGroupMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="LogicResourceGroupMockingExtension"/> class for mocking. </summary>
        protected LogicResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="LogicResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LogicResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = LogicWorkflowWorkflowsClientDiagnostics.CreateScope("LogicResourceGroupMockingExtension.ValidateByLocationWorkflow");
            scope.Start();
            try
            {
