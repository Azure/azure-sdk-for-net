...
namespace Azure.ResourceManager.Logic.Mocking
{
    ...
    internal partial class LogicArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="LogicArmClientMockingExtension"/> class for mocking. </summary>
        protected LogicArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="LogicArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal LogicArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal LogicArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
