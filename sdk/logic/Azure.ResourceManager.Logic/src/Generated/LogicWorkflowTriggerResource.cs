...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class LogicWorkflowTriggerResource : ArmResource
    {
        ...
        internal LogicWorkflowTriggerResource(ArmClient client, LogicWorkflowTriggerData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<LogicWorkflowTriggerResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new LogicWorkflowTriggerResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
