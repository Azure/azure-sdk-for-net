...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class IntegrationAccountAgreementCollection : ArmCollection, IEnumerable<IntegrationAccountAgreementResource>, IAsyncEnumerable<IntegrationAccountAgreementResource>
    {
        ...
        /// Operation Id: IntegrationAccountAgreements_List
        /// </summary>
        ...
        {
            async Task<Page<IntegrationAccountAgreementResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _integrationAccountAgreementClientDiagnostics.CreateScope("IntegrationAccountAgreementCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _integrationAccountAgreementRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountAgreementResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<IntegrationAccountAgreementResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _integrationAccountAgreementClientDiagnostics.CreateScope("IntegrationAccountAgreementCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _integrationAccountAgreementRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountAgreementResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<IntegrationAccountAgreementResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _integrationAccountAgreementClientDiagnostics.CreateScope("IntegrationAccountAgreementCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _integrationAccountAgreementRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountAgreementResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<IntegrationAccountAgreementResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _integrationAccountAgreementClientDiagnostics.CreateScope("IntegrationAccountAgreementCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _integrationAccountAgreementRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, top, filter, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new IntegrationAccountAgreementResource(Client, value)), response.Value.NextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
