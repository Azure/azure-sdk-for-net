...
namespace Azure.ResourceManager.Logic
{
    public partial class IntegrationAccountCertificateResource : IJsonModel<IntegrationAccountCertificateData>
    {
        ...
        {
            return ModelReaderWriter.Read<IntegrationAccountCertificateData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<IntegrationAccountCertificateData>(data, options);
        }
