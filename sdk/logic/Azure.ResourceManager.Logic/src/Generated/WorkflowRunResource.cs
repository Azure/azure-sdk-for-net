...
namespace Azure.ResourceManager.Logic
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="WorkflowResource" /> using the GetWorkflowRun method.
    /// </summary>
    public partial class WorkflowRunResource : ArmResource
    {
        ...
        {
            _workflowRunClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Logic", ResourceType.Namespace, Diagnostics);
        ...
        /// <summary> Gets a collection of WorkflowRunOperationResources in the WorkflowRun. </summary>
        /// <returns> An object representing collection of WorkflowRunOperationResources and their operations over a WorkflowRunOperationResource. </returns>
        public virtual WorkflowRunOperationCollection GetWorkflowRunOperations()
        {
            return GetCachedClient(Client => new WorkflowRunOperationCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<WorkflowRunOperationResource>> GetWorkflowRunOperationAsync(string operationId, CancellationToken cancellationToken = default)
        {
            return await GetWorkflowRunOperations().GetAsync(operationId, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="operationId"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<WorkflowRunOperationResource> GetWorkflowRunOperation(string operationId, CancellationToken cancellationToken = default)
        {
            return GetWorkflowRunOperations().Get(operationId, cancellationToken);
        }
        ...
        public virtual async Task<Response<WorkflowRunResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _workflowRunRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<WorkflowRunResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _workflowRunRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new WorkflowRunResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<Response> CancelAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _workflowRunRestClient.CancelAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                return response;
            }
            catch (Exception e)
            {
        ...
        public virtual Response Cancel(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _workflowRunRestClient.Cancel(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return response;
            }
            catch (Exception e)
            {
