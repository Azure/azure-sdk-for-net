    ...
    public partial class LogicWorkflowRunActionScopeRepetitionResource : LogicWorkflowRunActionRepetitionDefinitionResource
    {
        ...
        protected override async Task<Response<LogicWorkflowRunActionRepetitionDefinitionResource>> GetCoreAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue((LogicWorkflowRunActionRepetitionDefinitionResource)new LogicWorkflowRunActionScopeRepetitionResource(Client, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new async Task<Response<LogicWorkflowRunActionScopeRepetitionResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            var result = await GetCoreAsync(cancellationToken).ConfigureAwait(false);
            return Response.FromValue((LogicWorkflowRunActionScopeRepetitionResource)result.Value, result.GetRawResponse());
        }
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        [ForwardsClientCalls]
        public virtual new Response<LogicWorkflowRunActionScopeRepetitionResource> Get(CancellationToken cancellationToken = default)
        {
