...
namespace Azure.ResourceManager.Logic
{
    ...
    public partial class LogicWorkflowRunActionScopeRepetitionResource : ArmResource
    {
        ...
        internal LogicWorkflowRunActionScopeRepetitionResource(ArmClient client, LogicWorkflowRunActionRepetitionDefinitionData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
