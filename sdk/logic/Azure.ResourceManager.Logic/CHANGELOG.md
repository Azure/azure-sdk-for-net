...
- Prepended `Logic` prefix to all single / simple model names.
...
The package name has been changed from `Microsoft.Azure.Management.Logic` to `Azure.ResourceManager.Logic`.
