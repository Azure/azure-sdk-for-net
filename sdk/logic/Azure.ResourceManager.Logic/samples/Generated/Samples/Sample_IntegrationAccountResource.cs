...
namespace Azure.ResourceManager.Logic.Samples
{
    public partial class Sample_IntegrationAccountResource
    {
        ...
        public async Task Delete_DeleteAnIntegrationAccount()
        {
            ...
            // invoke the operation
            await integrationAccount.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task LogTrackingEvents_LogATrackedEvent()
        {
            ...
            {
new IntegrationAccountTrackingEvent(IntegrationAccountEventLevel.Informational, default, IntegrationAccountTrackingRecordType.AS2Message)
{
...
Code = "NotFound",
            ...
            await integrationAccount.LogTrackingEventsAsync(content).ConfigureAwait(false);
