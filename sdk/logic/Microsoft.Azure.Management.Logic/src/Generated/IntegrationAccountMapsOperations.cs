...
namespace Microsoft.Azure.Management.Logic
{
    ...
    internal partial class IntegrationAccountMapsOperations : IServiceOperations<LogicManagementClient>, IIntegrationAccountMapsOperations
    {
        ...
        public async Task<AzureOperationResponse<WorkflowTriggerCallbackUrl>> ListContentCallbackUrlWithHttpMessagesAsync(string resourceGroupName, string integrationAccountName, string mapName, GetCallbackUrlParameters listContentCallbackUrl, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Logic/integrationAccounts/{integrationAccountName}/maps/{mapName}/listContentCallbackUrl").ToString();
            _url = _url.Replace("{subscriptionId}", System.Uri.EscapeDataString(Client.SubscriptionId));
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(resourceGroupName));
            _url = _url.Replace("{integrationAccountName}", System.Uri.EscapeDataString(integrationAccountName));
            _url = _url.Replace("{mapName}", System.Uri.EscapeDataString(mapName));
