...
namespace Microsoft.Azure.Management.Logic
{
    ...
    internal partial class IntegrationAccountPartnersOperations : IServiceOperations<LogicManagementClient>, IIntegrationAccountPartnersOperations
    {
        ...
        public async Task<AzureOperationResponse<WorkflowTriggerCallbackUrl>> ListContentCallbackUrlWithHttpMessagesAsync(string resourceGroupName, string integrationAccountName, string partnerName, GetCallbackUrlParameters listContentCallbackUrl, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "listContentCallbackUrl");
            }
            // Tracing
            bool _shouldTrace = ServiceClientTracing.IsEnabled;
            string _invocationId = null;
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(_invocationId, this, "ListContentCallbackUrl", tracingParameters);
            }
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            ...
            if(listContentCallbackUrl != null)
            {
                _requestContent = Rest.Serialization.SafeJsonConvert.SerializeObject(listContentCallbackUrl, Client.SerializationSettings);
                _httpRequest.Content = new StringContent(_requestContent, System.Text.Encoding.UTF8);
                _httpRequest.Content.Headers.ContentType =System.Net.Http.Headers.MediaTypeHeaderValue.Parse("application/json; charset=utf-8");
            }
            // Set Credentials
