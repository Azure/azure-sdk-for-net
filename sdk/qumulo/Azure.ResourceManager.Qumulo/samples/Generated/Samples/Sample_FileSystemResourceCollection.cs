...
{
    public partial class Sample_FileSystemResourceCollection
    {
        [Test]
        ...
        public async Task CreateOrUpdate_FileSystemsCreateOrUpdate()
        {
            ...
            // get the collection of this FileSystemResource
            FileSystemResourceCollection collection = resourceGroupResource.GetFileSystemResources();

            // invoke the operation
            string fileSystemName = "hfcmtgaes";
            FileSystemResourceData data = new FileSystemResourceData(new AzureLocation("pnb"))
            {
                Properties = new FileSystemResourceProperties(new MarketplaceDetails("fwtpz", "s")
                {
                    MarketplaceSubscriptionId = "xaqtkloiyovmexqhn",
                    PublisherId = "czxcfrwodazyaft",
                    TermUnit = "cfwwczmygsimcyvoclcw",
                }, "yhyzby", new UserDetails("aqsnzyroo"), "jykmxrf", "fakeTestSecretPlaceholder")
                {
...
["key7090"] = "rurrdiaqp"
            ...
            ArmOperation<FileSystemResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, fileSystemName, data);
            FileSystemResource result = lro.Value;
        ...
        public async Task CreateOrUpdate_FileSystemsCreateOrUpdateMinimumSetGen()
        {
            ...
            FileSystemResourceData data = new FileSystemResourceData(new AzureLocation("aaaaaaaaaaaaaaaaaaaaaaaaa"))
            {
                Properties = new FileSystemResourceProperties(new MarketplaceDetails("aaaaaa", "aaaaaaaaaaaaaaaaaaaaaaaaa")
                {
                    MarketplaceSubscriptionId = "aaaaaaaaaaaaa",
                }, "Standard", new UserDetails("viptslwulnpaupfljvnjeq"), "aaaaaaaaaa", "fakeTestSecretPlaceholder"),
            };
            ArmOperation<FileSystemResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, fileSystemName, data);
            FileSystemResource result = lro.Value;
        ...
        public async Task Get_FileSystemsGet()
        {
            ...
            FileSystemResource result = await collection.GetAsync(fileSystemName);
        ...
        public async Task GetAll_FileSystemsListByResourceGroup()
        {
            ...
            await foreach (FileSystemResource item in collection.GetAllAsync())
            {
        ...
        public async Task GetIfExists_FileSystemsGet()
        {
            ...
            // invoke the operation
            string fileSystemName = "sihbehcisdqtqqyfiewiiaphgh";
            NullableResponse<FileSystemResource> response = await collection.GetIfExistsAsync(fileSystemName);
            FileSystemResource result = response.HasValue ? response.Value : null;
