...
namespace Azure.ResourceManager.Qumulo.Samples
{
    public partial class Sample_SubscriptionResourceExtensions
    {
        ...
        public async Task GetFileSystemResources_FileSystemsListBySubscription()
        {
            ...
            await foreach (FileSystemResource item in subscriptionResource.GetFileSystemResourcesAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                FileSystemResourceData resourceData = item.Data;
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetFileSystemResources_FileSystemsListBySubscriptionMinimumSetGen()
        {
