# ARM provider schema comparison: Azure.ResourceManager.Qumulo
...
| --- | --- | --- |
| `/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Qumulo.Storage/fileSystems/{fileSystemName}` | `QumuloFileSystemResource` | `FileSystemResource` |
