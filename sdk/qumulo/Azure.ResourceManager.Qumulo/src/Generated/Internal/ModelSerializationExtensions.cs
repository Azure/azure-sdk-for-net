...
namespace Azure.ResourceManager.Qumulo
{
    internal static class ModelSerializationExtensions
    {
        ...
        internal static readonly JsonSerializerOptions Options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureResourceManagerQumuloContext.Default) } };
        internal static readonly JsonSerializerOptions OptionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureResourceManagerQumuloContext.Default), new ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
