...
namespace Azure.ResourceManager.Qumulo.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QumuloUserDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QumuloUserDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QumuloUserDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QumuloUserDetails>)} interface");
            }
        ...
        string IPersistableModel<QumuloUserDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
