...
namespace Azure.ResourceManager.Qumulo.Models
{
    ...
    public partial class QumuloFileSystemResourcePatch : IJsonModel<QumuloFileSystemResourcePatch>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual QumuloFileSystemResourcePatch PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
        ...
        internal static RequestContent ToRequestContent(QumuloFileSystemResourcePatch qumuloFileSystemResourcePatch)
        {
            ...
            return RequestContent.Create(qumuloFileSystemResourcePatch, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        QumuloFileSystemResourcePatch IJsonModel<QumuloFileSystemResourcePatch>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual QumuloFileSystemResourcePatch JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<QumuloFileSystemResourcePatch>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static QumuloFileSystemResourcePatch DeserializeQumuloFileSystemResourcePatch(JsonElement element, ModelReaderWriterOptions options)
        {
