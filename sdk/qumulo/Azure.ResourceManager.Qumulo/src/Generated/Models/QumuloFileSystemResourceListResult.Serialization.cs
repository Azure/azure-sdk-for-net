...
namespace Azure.ResourceManager.Qumulo.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QumuloFileSystemResourceListResult>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        QumuloFileSystemResourceListResult IJsonModel<QumuloFileSystemResourceListResult>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        internal static QumuloFileSystemResourceListResult DeserializeQumuloFileSystemResourceListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new QumuloFileSystemResourceListResult(value, nextLink.Value, serializedAdditionalRawData);
        }

        BinaryData IModel<QumuloFileSystemResourceListResult>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        QumuloFileSystemResourceListResult IModel<QumuloFileSystemResourceListResult>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<QumuloFileSystemResourceListResult>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
