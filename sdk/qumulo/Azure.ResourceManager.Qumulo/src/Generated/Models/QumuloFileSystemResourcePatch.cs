...
namespace Azure.ResourceManager.Qumulo.Models
{
    ...
    public partial class QumuloFileSystemResourcePatch
    {
        ...
        internal QumuloFileSystemResourcePatch(ManagedServiceIdentity identity, IDictionary<string, string> tags, FileSystemResourceUpdateProperties properties, Dictionary<string, BinaryData> rawData)
        {
            Identity = identity;
            Tags = tags;
