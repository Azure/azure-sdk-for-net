...
namespace Azure.ResourceManager.Qumulo.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MarketplaceDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MarketplaceDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MarketplaceDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MarketplaceDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
