...
namespace Azure.ResourceManager.Qumulo
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<QumuloFileSystemResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<QumuloFileSystemResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<QumuloFileSystemResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<QumuloFileSystemResourceData>)} interface");
            }
        ...
        string IPersistableModel<QumuloFileSystemResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
