...
namespace Azure.ResourceManager.Qumulo.Models
{
    ...
    public partial class MarketplaceDetails
    {
        ...
        internal MarketplaceDetails(string marketplaceSubscriptionId, string planId, string offerId, string publisherId, MarketplaceSubscriptionStatus? marketplaceSubscriptionStatus, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
