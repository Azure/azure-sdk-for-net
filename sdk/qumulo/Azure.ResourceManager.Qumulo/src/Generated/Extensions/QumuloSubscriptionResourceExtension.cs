...
namespace Azure.ResourceManager.Qumulo.Testing
{
    ...
    public partial class QumuloSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="QumuloSubscriptionResourceExtension"/> class for mocking. </summary>
        protected QumuloSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="QumuloSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal QumuloSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
