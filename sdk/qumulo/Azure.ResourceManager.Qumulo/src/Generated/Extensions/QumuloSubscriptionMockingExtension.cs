...
namespace Azure.ResourceManager.Qumulo.Mocking
{
    ...
    internal partial class QumuloSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="QumuloSubscriptionMockingExtension"/> class for mocking. </summary>
        protected QumuloSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="QumuloSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal QumuloSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
