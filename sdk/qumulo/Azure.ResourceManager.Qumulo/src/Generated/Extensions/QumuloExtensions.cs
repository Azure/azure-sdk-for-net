...
using Azure.ResourceManager.Qumulo.Testing;
...
namespace Azure.ResourceManager.Qumulo
{
    ...
    public static partial class QumuloExtensions
    {
        ...
        private static QumuloSubscriptionResourceExtension GetQumuloSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new QumuloSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static QumuloSubscriptionResourceExtension GetQumuloSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new QumuloSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetQumuloSubscriptionResourceExtension(subscriptionResource).GetQumuloFileSystemResourcesAsync(cancellationToken);
        }
        ...
        {
            return GetQumuloSubscriptionResourceExtension(subscriptionResource).GetQumuloFileSystemResources(cancellationToken);
        }
    }
}
