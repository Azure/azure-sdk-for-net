...
namespace Azure.ResourceManager.Qumulo.Mocking
{
    ...
    internal partial class QumuloArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="QumuloArmClientMockingExtension"/> class for mocking. </summary>
        protected QumuloArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="QumuloArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal QumuloArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal QumuloArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
