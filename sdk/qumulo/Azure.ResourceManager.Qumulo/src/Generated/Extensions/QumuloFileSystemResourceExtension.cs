...
{
    /// <summary> A class to add extension methods to QumuloFileSystemResource. </summary>
    public partial class QumuloFileSystemResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="QumuloFileSystemResourceExtension"/> class for mocking. </summary>
        protected QumuloFileSystemResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="QumuloFileSystemResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal QumuloFileSystemResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        private ClientDiagnostics QumuloFileSystemResourceFileSystemsClientDiagnostics => _qumuloFileSystemResourceFileSystemsClientDiagnostics ??= new ClientDiagnostics("Azure.ResourceManager.Qumulo.Mock", QumuloFileSystemResource.ResourceType.Namespace, Diagnostics);
