...
{
    // Retained for the public compatibility APIs that use MarketplaceSubscriptionStatus.
    // The current service API uses QumuloMarketplaceSubscriptionStatus, so this conversion is no longer generated.
