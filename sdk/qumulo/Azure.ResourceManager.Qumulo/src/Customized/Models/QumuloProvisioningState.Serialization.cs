...
{
    // Retained for the public compatibility APIs that use QumuloProvisioningState.
    // The current service API uses QumuloArmProvisioningState, so this conversion is no longer generated.
