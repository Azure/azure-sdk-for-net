...
#pragma warning disable SA1649 // File name should match first type name
    internal class ao5gcArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of ao5gcArmOperation for mocking. </summary>
        protected ao5gcArmOperation()
        {
        }

        internal ao5gcArmOperation(Response response)
        {
            _operation = OperationInternal.Succeeded(response);
        }

        internal ao5gcArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
            ...
            _operation = new OperationInternal(nextLinkOperation, clientDiagnostics, response, "ao5gcArmOperation", fallbackStrategy: new SequentialDelayStrategy());
        }
