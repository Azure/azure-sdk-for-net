...
{
    public partial class Sample_NetworkFunctionResourceCollection
    {
        // NetworkFunctions_ListByResourceGroup
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetAll_NetworkFunctionsListByResourceGroup()
        {
            // Generated from example definition: specification/mpcnetworkfunction/resource-manager/Microsoft.MobilePacketCore/preview/2023-05-15-preview/examples/NetworkFunctions_ListByResourceGroup.json
            ...
            NetworkFunctionResourceCollection collection = resourceGroupResource.GetNetworkFunctionResources();
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task Exists_NetworkFunctionsGet()
        {
            // Generated from example definition: specification/mpcnetworkfunction/resource-manager/Microsoft.MobilePacketCore/preview/2023-05-15-preview/examples/NetworkFunctions_Get.json
            // this example is just showing the usage of "NetworkFunctions_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task GetIfExists_NetworkFunctionsGet()
        {
            // Generated from example definition: specification/mpcnetworkfunction/resource-manager/Microsoft.MobilePacketCore/preview/2023-05-15-preview/examples/NetworkFunctions_Get.json
            // this example is just showing the usage of "NetworkFunctions_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [NUnit.Framework.Test]
        [NUnit.Framework.Ignore("Only verifying that the sample builds")]
        public async Task CreateOrUpdate_NetworkFunctionsCreateOrUpdate()
        {
            // Generated from example definition: specification/mpcnetworkfunction/resource-manager/Microsoft.MobilePacketCore/preview/2023-05-15-preview/examples/NetworkFunctions_CreateOrUpdate.json
            ...
            // invoke the operation
            string networkFunctionName = "nf1";
            NetworkFunctionResourceData data = new NetworkFunctionResourceData(new AzureLocation("eastus"))
            {
                Sku = SkuDefinition.NexusProduction,
                NetworkFunctionType = NetworkFunctionType.SMF,
                NetworkFunctionAdministrativeState = NetworkFunctionAdministrativeState.Commissioned,
                Capacity = 100000,
