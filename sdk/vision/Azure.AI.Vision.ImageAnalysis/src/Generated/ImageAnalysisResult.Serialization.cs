...
{
    public partial class ImageAnalysisResult : IUtf8JsonWriteable, IJsonModel<ImageAnalysisResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageAnalysisResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ImageAnalysisResult FromResponse(PipelineResponse response)
        {
