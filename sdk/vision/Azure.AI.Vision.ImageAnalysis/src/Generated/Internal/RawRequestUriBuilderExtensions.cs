...
namespace Azure.AI.Vision.ImageAnalysis
{
    ...
    {
        public static void AppendQueryDelimited<T>(this RawRequestUriBuilder builder, string name, IEnumerable<T> value, string delimiter, SerializationFormat format = global::Azure.AI.Vision.ImageAnalysis.SerializationFormat.Default, bool escape = true)
        {
            delimiter ??= ",";
            IEnumerable<string> stringValues = value.Select(v => global::Azure.AI.Vision.ImageAnalysis.TypeFormatters.ConvertToString(v, format));
