...
{
    public partial class DetectedTag : IUtf8JsonWriteable, IJsonModel<DetectedTag>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectedTag>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DetectedTag FromResponse(PipelineResponse response)
        {
