...
{
    public partial class DetectedTextWord : IUtf8JsonWriteable, IJsonModel<DetectedTextWord>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectedTextWord>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DetectedTextWord FromResponse(PipelineResponse response)
        {
