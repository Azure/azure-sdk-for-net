...
{
    public partial class ImageBoundingBox : IUtf8JsonWriteable, IJsonModel<ImageBoundingBox>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageBoundingBox>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ImageBoundingBox FromResponse(PipelineResponse response)
        {
