...
{
    public partial class DetectedTextLine : IUtf8JsonWriteable, IJsonModel<DetectedTextLine>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectedTextLine>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DetectedTextLine FromResponse(PipelineResponse response)
        {
