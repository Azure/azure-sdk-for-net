...
{
    public partial class ImageMetadata : IUtf8JsonWriteable, IJsonModel<ImageMetadata>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageMetadata>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ImageMetadata FromResponse(PipelineResponse response)
        {
