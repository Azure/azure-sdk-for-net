...
{
    public partial class DenseCaptionsResult : IUtf8JsonWriteable, IJsonModel<DenseCaptionsResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DenseCaptionsResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DenseCaptionsResult FromResponse(PipelineResponse response)
        {
