...
{
    public partial class DenseCaption : IUtf8JsonWriteable, IJsonModel<DenseCaption>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DenseCaption>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DenseCaption FromResponse(PipelineResponse response)
        {
