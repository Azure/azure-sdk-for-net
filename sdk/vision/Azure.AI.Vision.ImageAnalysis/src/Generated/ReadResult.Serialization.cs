...
{
    public partial class ReadResult : IUtf8JsonWriteable, IJsonModel<ReadResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ReadResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ReadResult FromResponse(PipelineResponse response)
        {
