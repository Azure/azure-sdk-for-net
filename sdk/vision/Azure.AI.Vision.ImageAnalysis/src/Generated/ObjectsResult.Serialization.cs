...
{
    public partial class ObjectsResult : IUtf8JsonWriteable, IJsonModel<ObjectsResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ObjectsResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static ObjectsResult FromResponse(PipelineResponse response)
        {
