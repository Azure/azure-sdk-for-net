            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("details"u8))
                {
                    ...
                    foreach (var item in prop.Value.EnumerateArray())
                    {
                        ...
                        {
                            array.Add(ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(item.GetRawText())), options, AzureAIVisionImageAnalysisContext.Default));
                        }
                    }
                    details = array;
                    continue;
