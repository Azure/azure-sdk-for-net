    ...
    public partial class ErrorResult : IJsonModel<ErrorResult>
    {
        ...
        internal static ErrorResult DeserializeErrorResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                {
                    error = ModelReaderWriter.Read<ResponseError>(new BinaryData(Encoding.UTF8.GetBytes(prop.Value.GetRawText())), options, AzureAIVisionImageAnalysisContext.Default);
                    continue;
                }
                if (options.Format != "W")
                {
