...
namespace Azure.AI.Vision.ImageAnalysis
{
    ...
    public partial class ObjectsResult : IJsonModel<ObjectsResult>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<ObjectsResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<ObjectsResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        ObjectsResult IPersistableModel<ObjectsResult>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        ObjectsResult IJsonModel<ObjectsResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);
        ...
        internal static ObjectsResult DeserializeObjectsResult(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            IList<DetectedObject> values = default;
