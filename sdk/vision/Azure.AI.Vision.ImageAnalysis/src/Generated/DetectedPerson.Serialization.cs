...
{
    public partial class DetectedPerson : IUtf8JsonWriteable, IJsonModel<DetectedPerson>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectedPerson>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<DetectedPerson>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DetectedPerson)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DetectedPerson>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(DetectedPerson)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static DetectedPerson FromResponse(PipelineResponse response)
        {
