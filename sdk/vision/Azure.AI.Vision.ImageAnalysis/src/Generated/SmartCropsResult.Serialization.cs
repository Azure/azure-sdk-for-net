...
{
    public partial class SmartCropsResult : IUtf8JsonWriteable, IJsonModel<SmartCropsResult>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<SmartCropsResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static SmartCropsResult FromResponse(PipelineResponse response)
        {
