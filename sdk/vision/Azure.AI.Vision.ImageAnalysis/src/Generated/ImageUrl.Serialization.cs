...
{
    internal partial class ImageUrl : IUtf8JsonWriteable, IJsonModel<ImageUrl>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<ImageUrl>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ImageUrl>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ImageUrl)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ImageUrl>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ImageUrl)} does not support '{options.Format}' format.");
            }
        }
        ...
        internal static ImageUrl FromResponse(PipelineResponse response)
        {
