...
{
    public partial class DetectedObject : IUtf8JsonWriteable, IJsonModel<DetectedObject>
    {
        void IUtf8JsonWriteable.Write(Utf8JsonWriter writer) => ((IJsonModel<DetectedObject>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        internal static DetectedObject FromResponse(PipelineResponse response)
        {
