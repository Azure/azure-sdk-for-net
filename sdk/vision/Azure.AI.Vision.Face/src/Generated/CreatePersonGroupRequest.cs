...
{
    /// <summary> The CreatePersonGroupRequest. </summary>
    internal partial class CreatePersonGroupRequest
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CreatePersonGroupRequest"/>. </summary>
        ...
        internal CreatePersonGroupRequest(string name, string userData, FaceRecognitionModel? recognitionModel, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
        ...
        /// <summary> Initializes a new instance of <see cref="CreatePersonGroupRequest"/> for deserialization. </summary>
        internal CreatePersonGroupRequest()
        {
        }
