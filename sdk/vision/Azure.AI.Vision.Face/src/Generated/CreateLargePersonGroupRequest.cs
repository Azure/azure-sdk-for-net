...
{
    /// <summary> The CreateLargePersonGroupRequest. </summary>
    internal partial class CreateLargePersonGroupRequest
    {
        /// <summary>
        ...
        /// <summary> Initializes a new instance of <see cref="CreateLargePersonGroupRequest"/>. </summary>
        ...
        internal CreateLargePersonGroupRequest(string name, string userData, FaceRecognitionModel? recognitionModel, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            UserData = userData;
        ...
        /// <summary> Initializes a new instance of <see cref="CreateLargePersonGroupRequest"/> for deserialization. </summary>
        internal CreateLargePersonGroupRequest()
        {
        }
