...
{
    public partial class MediaGraphFrameRateFilterProcessor : IUtf8JsonSerializable
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            writer.WriteStartObject();
            if (Optional.IsDefined(MaximumFps))
            {
                writer.WritePropertyName("maximumFps");
                writer.WriteStringValue(MaximumFps);
            }
