...
{
    public partial class MediaGraphHttpExtension : IUtf8JsonSerializable
    {
        ...
        internal static MediaGraphHttpExtension DeserializeMediaGraphHttpExtension(JsonElement element)
        {
            ...
            return new MediaGraphHttpExtension(type, name, inputs, endpoint, image, samplingOptions.Value);
        }
    }
}
