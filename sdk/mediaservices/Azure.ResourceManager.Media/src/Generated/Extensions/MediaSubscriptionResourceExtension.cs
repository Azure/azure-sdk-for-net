...
namespace Azure.ResourceManager.Media.Testing
{
    ...
    public partial class MediaSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MediaSubscriptionResourceExtension"/> class for mocking. </summary>
        protected MediaSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MediaSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MediaSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<MediaServicesNameAvailabilityResult>> CheckMediaServicesNameAvailabilityAsync(AzureLocation locationName, MediaServicesNameAvailabilityContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = LocationsClientDiagnostics.CreateScope("MediaSubscriptionResourceExtension.CheckMediaServicesNameAvailability");
            scope.Start();
            try
            {
