...
namespace Azure.ResourceManager.Media.Mock
{
    ...
    public partial class MediaServicesAccountResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MediaServicesAccountResourceExtension"/> class for mocking. </summary>
        protected MediaServicesAccountResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MediaServicesAccountResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MediaServicesAccountResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
