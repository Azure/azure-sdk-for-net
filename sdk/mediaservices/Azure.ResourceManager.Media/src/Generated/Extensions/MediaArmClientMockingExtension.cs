...
namespace Azure.ResourceManager.Media.Mocking
{
    ...
    internal partial class MediaArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="MediaArmClientMockingExtension"/> class for mocking. </summary>
        protected MediaArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MediaArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MediaArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal MediaArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
