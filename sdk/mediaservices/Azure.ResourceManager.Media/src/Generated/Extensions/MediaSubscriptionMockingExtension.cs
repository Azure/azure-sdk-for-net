...
namespace Azure.ResourceManager.Media.Mocking
{
    ...
    internal partial class MediaSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="MediaSubscriptionMockingExtension"/> class for mocking. </summary>
        protected MediaSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="MediaSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal MediaSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = LocationsClientDiagnostics.CreateScope("MediaSubscriptionMockingExtension.CheckMediaServicesNameAvailability");
            scope.Start();
            try
            {
