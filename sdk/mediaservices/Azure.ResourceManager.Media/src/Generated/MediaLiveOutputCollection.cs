    ...
    public partial class MediaLiveOutputCollection : ArmCollection, IEnumerable<MediaLiveOutputResource>, IAsyncEnumerable<MediaLiveOutputResource>
    {
        ...
        public virtual async Task<ArmOperation<MediaLiveOutputResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string liveOutputName, MediaLiveOutputData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MediaArmOperation<MediaLiveOutputResource>(new MediaLiveOutputOperationSource(Client), _mediaLiveOutputLiveOutputsClientDiagnostics, Pipeline, _mediaLiveOutputLiveOutputsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, liveOutputName, data).Request, response, OperationFinalStateVia.NotSpecified);
        ...
        {
            async Task<Page<MediaLiveOutputResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _mediaLiveOutputLiveOutputsClientDiagnostics.CreateScope("MediaLiveOutputCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _mediaLiveOutputLiveOutputsRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MediaLiveOutputResource(Client, value)), response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<MediaLiveOutputResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _mediaLiveOutputLiveOutputsClientDiagnostics.CreateScope("MediaLiveOutputCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _mediaLiveOutputLiveOutputsRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MediaLiveOutputResource(Client, value)), response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<MediaLiveOutputResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _mediaLiveOutputLiveOutputsClientDiagnostics.CreateScope("MediaLiveOutputCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _mediaLiveOutputLiveOutputsRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MediaLiveOutputResource(Client, value)), response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<MediaLiveOutputResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _mediaLiveOutputLiveOutputsClientDiagnostics.CreateScope("MediaLiveOutputCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _mediaLiveOutputLiveOutputsRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MediaLiveOutputResource(Client, value)), response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
