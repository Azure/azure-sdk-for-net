    ...
    public partial class StreamingPolicyCollection : ArmCollection, IEnumerable<StreamingPolicyResource>, IAsyncEnumerable<StreamingPolicyResource>
    {
        ...
        public virtual AsyncPageable<StreamingPolicyResource> GetAllAsync(StreamingPolicyCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            async Task<Page<StreamingPolicyResource>> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _streamingPolicyRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
            ...
            async Task<Page<StreamingPolicyResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = await _streamingPolicyRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new StreamingPolicyResource(Client, value)), response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        public virtual Pageable<StreamingPolicyResource> GetAll(StreamingPolicyCollectionGetAllOptions options, CancellationToken cancellationToken = default)
        {
            ...
            Page<StreamingPolicyResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _streamingPolicyRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new StreamingPolicyResource(Client, value)), response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<StreamingPolicyResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                ...
                try
                {
                    var response = _streamingPolicyRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Name, options.Filter, options.Top, options.Orderby, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new StreamingPolicyResource(Client, value)), response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
