...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public static partial class ArmMediaModelFactory
    {
        ...
        public static MediaServicesAccountFilterData MediaServicesAccountFilterData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, PresentationTimeRange presentationTimeRange = null, int? firstQualityBitrate = null, IEnumerable<FilterTrackSelection> tracks = null)
        {
            ...
            return new MediaServicesAccountFilterData(id, name, resourceType, systemData, presentationTimeRange, firstQualityBitrate.HasValue ? new FirstQuality(firstQualityBitrate.Value, new Dictionary<string, BinaryData>()) : null, tracks?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        public static MediaAssetFilterData MediaAssetFilterData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, PresentationTimeRange presentationTimeRange = null, int? firstQualityBitrate = null, IEnumerable<FilterTrackSelection> tracks = null)
        {
            ...
            return new MediaAssetFilterData(id, name, resourceType, systemData, presentationTimeRange, firstQualityBitrate.HasValue ? new FirstQuality(firstQualityBitrate.Value, new Dictionary<string, BinaryData>()) : null, tracks?.ToList(), serializedAdditionalRawData: null);
        }
        ...
        {
            return new StreamingEndpointSkuInfo(resourceType, capacity, skuName != null ? new StreamingEndpointSku(skuName, new Dictionary<string, BinaryData>()) : null, serializedAdditionalRawData: null);
        }
        ...
        {
            return new AudioTrack("#Microsoft.Media.AudioTrack", serializedAdditionalRawData: null, fileName, displayName, languageCode, hlsSettings, dashRole != null ? new TrackDashSettings(dashRole, new Dictionary<string, BinaryData>()) : null, mpeg4TrackId, bitRate);
        }
