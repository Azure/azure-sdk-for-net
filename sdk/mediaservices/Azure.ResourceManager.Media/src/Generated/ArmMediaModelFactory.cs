...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public static partial class ArmMediaModelFactory
    {
        ...
        public static MediaServicesAccountFilterData MediaServicesAccountFilterData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, PresentationTimeRange presentationTimeRange = null, int? firstQualityBitrate = null, IEnumerable<FilterTrackSelection> tracks = null)
        {
            ...
            return new MediaServicesAccountFilterData(id, name, resourceType, systemData, presentationTimeRange, firstQualityBitrate.HasValue ? new FirstQuality(firstQualityBitrate.Value, new Dictionary<string, BinaryData>()) : null, tracks?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaServicesStorageAccount(id, accountType, identity, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AccountEncryption(keyType, keyVaultProperties, identity, status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new KeyVaultProperties(keyIdentifier, currentKeyIdentifier, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaServicesPrivateEndpointConnectionData(id, name, resourceType, systemData, privateEndpointId != null ? ResourceManagerModelFactory.SubResource(privateEndpointId) : null, connectionState, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaServicesEdgePolicies(usageDataCollectionPolicy, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EdgeUsageDataCollectionPolicy(dataCollectionFrequency, dataReportingFrequency, maxAllowedUnreportedUsageDuration, eventHubDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new EdgeUsageDataEventHub(name, @namespace, token, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaServicesPrivateLinkResourceData MediaServicesPrivateLinkResourceData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string groupId = null, IEnumerable<string> requiredMembers = null, IEnumerable<string> requiredZoneNames = null)
        {
            ...
            return new MediaServicesPrivateLinkResourceData(id, name, resourceType, systemData, groupId, requiredMembers?.ToList(), requiredZoneNames?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaServicesNameAvailabilityResult(isNameAvailable, reason, message, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaAssetData(id, name, resourceType, systemData, assetId, createdOn, lastModifiedOn, alternateId, description, container, storageAccountName, storageEncryptionFormat, encryptionScope, new Dictionary<string, BinaryData>());
        }
        ...
        public static StorageEncryptedAssetDecryptionInfo StorageEncryptedAssetDecryptionInfo(byte[] key = null, IEnumerable<MediaAssetFileEncryptionMetadata> assetFileEncryptionMetadata = null)
        {
            ...
            return new StorageEncryptedAssetDecryptionInfo(key, assetFileEncryptionMetadata?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaAssetFileEncryptionMetadata(initializationVector, assetFileName, assetFileId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaAssetStreamingLocator(name, assetName, createdOn, startOn, endOn, streamingLocatorId, streamingPolicyName, defaultContentKeyPolicyName, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaAssetFilterData MediaAssetFilterData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, PresentationTimeRange presentationTimeRange = null, int? firstQualityBitrate = null, IEnumerable<FilterTrackSelection> tracks = null)
        {
            ...
            return new MediaAssetFilterData(id, name, resourceType, systemData, presentationTimeRange, firstQualityBitrate.HasValue ? new FirstQuality(firstQualityBitrate.Value, new Dictionary<string, BinaryData>()) : null, tracks?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaAssetTrackData(id, name, resourceType, systemData, track, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static ContentKeyPolicyData ContentKeyPolicyData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, Guid? policyId = null, DateTimeOffset? createdOn = null, DateTimeOffset? lastModifiedOn = null, string description = null, IEnumerable<ContentKeyPolicyOption> options = null)
        {
            ...
            return new ContentKeyPolicyData(id, name, resourceType, systemData, policyId, createdOn, lastModifiedOn, description, options?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static ContentKeyPolicyProperties ContentKeyPolicyProperties(Guid? policyId = null, DateTimeOffset? createdOn = null, DateTimeOffset? lastModifiedOn = null, string description = null, IEnumerable<ContentKeyPolicyOption> options = null)
        {
            ...
            return new ContentKeyPolicyProperties(policyId, createdOn, lastModifiedOn, description, options?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new ContentKeyPolicyOption(policyOptionId, name, configuration, restriction, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaTransformData MediaTransformData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? createdOn = null, string description = null, DateTimeOffset? lastModifiedOn = null, IEnumerable<MediaTransformOutput> outputs = null)
        {
            ...
            return new MediaTransformData(id, name, resourceType, systemData, createdOn, description, lastModifiedOn, outputs?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobData MediaJobData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, DateTimeOffset? createdOn = null, MediaJobState? state = null, string description = null, MediaJobInputBasicProperties input = null, DateTimeOffset? lastModifiedOn = null, IEnumerable<MediaJobOutput> outputs = null, MediaJobPriority? priority = null, IDictionary<string, string> correlationData = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null)
        {
            ...
            return new MediaJobData(id, name, resourceType, systemData, createdOn, state, description, input, lastModifiedOn, outputs?.ToList(), priority, correlationData, startOn, endOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new UnknownJobOutput(odataType, error, presetOverride, state, progress, label, startOn, endOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaJobError MediaJobError(MediaJobErrorCode? code = null, string message = null, MediaJobErrorCategory? category = null, MediaJobRetry? retry = null, IEnumerable<MediaJobErrorDetail> details = null)
        {
            ...
            return new MediaJobError(code, message, category, retry, details?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaJobErrorDetail(code, message, new Dictionary<string, BinaryData>());
        }
        ...
        public static StreamingLocatorData StreamingLocatorData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string assetName = null, DateTimeOffset? createdOn = null, DateTimeOffset? startOn = null, DateTimeOffset? endOn = null, Guid? streamingLocatorId = null, string streamingPolicyName = null, string defaultContentKeyPolicyName = null, IEnumerable<StreamingLocatorContentKey> contentKeys = null, string alternativeMediaId = null, IEnumerable<string> filters = null)
        {
            ...
            return new StreamingLocatorData(id, name, resourceType, systemData, assetName, createdOn, startOn, endOn, streamingLocatorId, streamingPolicyName, defaultContentKeyPolicyName, contentKeys?.ToList(), alternativeMediaId, filters?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static StreamingLocatorContentKey StreamingLocatorContentKey(Guid id = default, StreamingLocatorContentKeyType? keyType = null, string labelReferenceInStreamingPolicy = null, string value = null, string policyName = null, IEnumerable<MediaTrackSelection> tracks = null)
        {
            ...
            return new StreamingLocatorContentKey(id, keyType, labelReferenceInStreamingPolicy, value, policyName, tracks?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static StreamingPathsResult StreamingPathsResult(IEnumerable<StreamingPath> streamingPaths = null, IEnumerable<string> downloadPaths = null)
        {
            ...
            return new StreamingPathsResult(streamingPaths?.ToList(), downloadPaths?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static StreamingPath StreamingPath(StreamingPolicyStreamingProtocol streamingProtocol = default, StreamingPathEncryptionScheme encryptionScheme = default, IEnumerable<string> paths = null)
        {
            ...
            return new StreamingPath(streamingProtocol, encryptionScheme, paths?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        public static MediaLiveEventData MediaLiveEventData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, string description = null, LiveEventInput input = null, LiveEventPreview preview = null, LiveEventEncoding encoding = null, IEnumerable<LiveEventTranscription> transcriptions = null, string provisioningState = null, LiveEventResourceState? resourceState = null, CrossSiteAccessPolicies crossSiteAccessPolicies = null, bool? useStaticHostname = null, string hostnamePrefix = null, IEnumerable<StreamOptionsFlag> streamOptions = null, DateTimeOffset? createdOn = null, DateTimeOffset? lastModifiedOn = null)
        {
            ...
            return new MediaLiveEventData(id, name, resourceType, systemData, tags, location, description, input, preview, encoding, transcriptions?.ToList(), provisioningState, resourceState, crossSiteAccessPolicies, useStaticHostname, hostnamePrefix, streamOptions?.ToList(), createdOn, lastModifiedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new MediaLiveOutputData(id, name, resourceType, systemData, description, assetName, archiveWindowLength, rewindWindowLength, manifestName, hlsFragmentsPerTsSegment != null ? new Hls(hlsFragmentsPerTsSegment, new Dictionary<string, BinaryData>()) : null, outputSnapTime, createdOn, lastModifiedOn, provisioningState, resourceState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StreamingEndpointCurrentSku(name, capacity, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StreamingEndpointSkuInfo(resourceType, capacity, skuName != null ? new StreamingEndpointSku(skuName, new Dictionary<string, BinaryData>()) : null, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new StreamingEndpointCapacity(scaleType, @default, minimum, maximum, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AudioTrack("#Microsoft.Media.AudioTrack", new Dictionary<string, BinaryData>(), fileName, displayName, languageCode, hlsSettings, dashRole != null ? new TrackDashSettings(dashRole, new Dictionary<string, BinaryData>()) : null, mpeg4TrackId, bitRate);
        }
        ...
        {
            return new TextTrack("#Microsoft.Media.TextTrack", new Dictionary<string, BinaryData>(), fileName, displayName, languageCode, playerVisibility, hlsSettings);
        }
        ...
        {
            return new MediaJobOutputAsset("#Microsoft.Media.JobOutputAsset", error, presetOverride, state, progress, label, startOn, endOn, new Dictionary<string, BinaryData>(), assetName);
        }
    }
}
