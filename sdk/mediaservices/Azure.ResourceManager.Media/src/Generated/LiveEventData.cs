...
{
    /// <summary> A class representing the LiveEvent data model. </summary>
    public partial class LiveEventData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of LiveEventData. </summary>
        /// <param name="location"> The location. </param>
        public LiveEventData(AzureLocation location) : base(location)
        {
