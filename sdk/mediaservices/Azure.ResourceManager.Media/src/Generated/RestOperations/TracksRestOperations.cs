    ...
    internal partial class TracksRestOperations
    {
        ...
        public async Task<Response<AssetTrackCollection>> ListAsync(string subscriptionId, string resourceGroupName, string accountName, string assetName, CancellationToken cancellationToken = default)
        {
            ...
            switch (message.Response.Status)
            {
                case 200:
                    {
                        AssetTrackCollection value = default;
                        using var document = await JsonDocument.ParseAsync(message.Response.ContentStream, default, cancellationToken).ConfigureAwait(false);
                        value = AssetTrackCollection.DeserializeAssetTrackCollection(document.RootElement);
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string accountName, string assetName, string trackName, AssetTrackData data)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
        ...
        internal HttpMessage CreateUpdateRequest(string subscriptionId, string resourceGroupName, string accountName, string assetName, string trackName, AssetTrackData data)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
