...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TrackPropertyCondition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TrackPropertyCondition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TrackPropertyCondition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TrackPropertyCondition>)} interface");
            }
        ...
        string IPersistableModel<TrackPropertyCondition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
