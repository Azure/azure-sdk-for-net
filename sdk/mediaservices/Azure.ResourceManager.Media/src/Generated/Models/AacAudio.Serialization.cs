...
{
    public partial class AacAudio : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AacAudio DeserializeAacAudio(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
