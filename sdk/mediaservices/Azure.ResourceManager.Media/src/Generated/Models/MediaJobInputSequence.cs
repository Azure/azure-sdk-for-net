...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaJobInputSequence : MediaJobInputBasicProperties
    {
        ...
        internal MediaJobInputSequence(string odataType, IList<MediaJobInputClip> inputs, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            Inputs = inputs;
