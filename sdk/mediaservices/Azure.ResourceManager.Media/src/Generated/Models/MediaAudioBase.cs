...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaAudioBase : MediaCodecBase
    {
        ...
        internal MediaAudioBase(string odataType, string label, int? channels, int? samplingRate, int? bitrate, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, label, serializedAdditionalRawData)
        {
            Channels = channels;
