...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaAudioBase : MediaCodecBase
    {
        ...
        internal MediaAudioBase(string odataType, string label, int? channels, int? samplingRate, int? bitrate, Dictionary<string, BinaryData> rawData) : base(odataType, label, rawData)
        {
            Channels = channels;
