...
{
    public partial class ImageBasicProperties : IUtf8JsonSerializable
    {
        ...
        internal static ImageBasicProperties DeserializeImageBasicProperties(JsonElement element)
        {
            ...
            return new ImageBasicProperties(odataType, label.Value, Optional.ToNullable(keyFrameInterval), Optional.ToNullable(stretchMode), Optional.ToNullable(syncMode), start, step.Value, range.Value);
        }
    }
}
