...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class H265Video : InputVideoEncodingProperties
    {
        ...
        /// <param name="sceneChangeDetection"> Specifies whether or not the encoder should insert key frames at scene changes. If not specified, the default is false. This flag should be set to true only when the encoder is being configured to produce a single output video. </param>
        ...
        internal H265Video(string odataType, string label, TimeSpan? keyFrameInterval, StretchMode? stretchMode, VideoSyncMode? syncMode, bool? sceneChangeDetection, H265Complexity? complexity, IList<H265Layer> layers) : base(odataType, label, keyFrameInterval, stretchMode, syncMode)
        {
