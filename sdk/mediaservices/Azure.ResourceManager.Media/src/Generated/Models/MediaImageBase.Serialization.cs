...
namespace Azure.ResourceManager.Media.Models
{
    public partial class MediaImageBase : IUtf8JsonSerializable, IJsonModel<MediaImageBase>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaImageBase>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaImageBase>)} interface");
            }
