...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaImageBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaImageBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaImageBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MediaImageBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
