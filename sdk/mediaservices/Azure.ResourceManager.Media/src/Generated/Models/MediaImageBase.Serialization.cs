...
{
    public partial class MediaImageBase : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MediaImageBase DeserializeMediaImageBase(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
