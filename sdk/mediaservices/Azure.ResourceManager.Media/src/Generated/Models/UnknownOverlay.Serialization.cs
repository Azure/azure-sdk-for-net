    ...
    internal partial class UnknownOverlay : IUtf8JsonSerializable, IJsonModel<MediaOverlayBase>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InputLabel))
            {
                ...
                if (InputLabel.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(Start))
            {
                ...
                var formattedTimeSpan = TypeFormatters.ToString(Start.Value, "P");
            ...
            {
                builder.Append("  end:");
                var formattedTimeSpan = TypeFormatters.ToString(End.Value, "P");
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
            ...
            if (Optional.IsDefined(FadeInDuration))
            {
                ...
                var formattedTimeSpan = TypeFormatters.ToString(FadeInDuration.Value, "P");
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
            ...
            if (Optional.IsDefined(FadeOutDuration))
            {
                ...
                var formattedTimeSpan = TypeFormatters.ToString(FadeOutDuration.Value, "P");
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
