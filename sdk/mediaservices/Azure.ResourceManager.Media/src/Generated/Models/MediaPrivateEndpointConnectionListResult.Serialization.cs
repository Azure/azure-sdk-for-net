...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static MediaPrivateEndpointConnectionListResult DeserializeMediaPrivateEndpointConnectionListResult(JsonElement element, SerializableOptions options = default)
        {
