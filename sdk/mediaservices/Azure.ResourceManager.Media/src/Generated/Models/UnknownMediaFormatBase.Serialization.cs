...
{
    internal partial class UnknownMediaFormatBase : IUtf8JsonSerializable, IJsonModel<MediaFormatBase>
    {
        ...
        internal static UnknownMediaFormatBase DeserializeUnknownMediaFormatBase(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownMediaFormatBase(odataType, filenamePattern, serializedAdditionalRawData);
        }
