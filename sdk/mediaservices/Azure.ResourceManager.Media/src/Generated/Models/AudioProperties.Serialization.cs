...
{
    public partial class AudioProperties : IUtf8JsonSerializable
    {
        ...
        internal static AudioProperties DeserializeAudioProperties(JsonElement element)
        {
            ...
            return new AudioProperties(odataType, label.Value, Optional.ToNullable(channels), Optional.ToNullable(samplingRate), Optional.ToNullable(bitrate));
        }
    }
}
