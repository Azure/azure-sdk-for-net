...
{
    public partial class AudioOverlay : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AudioOverlay DeserializeAudioOverlay(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
