...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioOverlay>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AudioOverlay>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AudioOverlay>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AudioOverlay>)} interface");
            }
        ...
        string IPersistableModel<AudioOverlay>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
