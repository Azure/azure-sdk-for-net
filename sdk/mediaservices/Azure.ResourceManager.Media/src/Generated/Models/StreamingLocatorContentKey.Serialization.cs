...
{
    public partial class StreamingLocatorContentKey : IUtf8JsonSerializable, IJsonModel<StreamingLocatorContentKey>, IPersistableModel<StreamingLocatorContentKey>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LabelReferenceInStreamingPolicy))
            {
                builder.Append("  labelReferenceInStreamingPolicy:");
                builder.AppendLine($" '{LabelReferenceInStreamingPolicy}'");
            }
