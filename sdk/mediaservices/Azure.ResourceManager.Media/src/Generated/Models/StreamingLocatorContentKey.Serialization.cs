...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingLocatorContentKey>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingLocatorContentKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingLocatorContentKey>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingLocatorContentKey>)} interface");
            }
        ...
        string IPersistableModel<StreamingLocatorContentKey>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
