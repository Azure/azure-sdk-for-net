...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaJobInputDefinition>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaJobInputDefinition>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaJobInputDefinition>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaJobInputDefinition>)} interface");
            }
        ...
        string IPersistableModel<MediaJobInputDefinition>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
