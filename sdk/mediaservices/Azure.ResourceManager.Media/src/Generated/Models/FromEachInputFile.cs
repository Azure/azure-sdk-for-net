...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class FromEachInputFile : MediaJobInputDefinition
    {
        ...
        internal FromEachInputFile(string odataType, IList<TrackDescriptor> includedTracks, Dictionary<string, BinaryData> rawData) : base(odataType, includedTracks, rawData)
        {
