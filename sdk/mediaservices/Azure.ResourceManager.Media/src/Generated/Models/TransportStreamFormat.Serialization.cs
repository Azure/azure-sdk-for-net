...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<TransportStreamFormat>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<TransportStreamFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<TransportStreamFormat>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<TransportStreamFormat>)} interface");
            }
        ...
        string IPersistableModel<TransportStreamFormat>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
