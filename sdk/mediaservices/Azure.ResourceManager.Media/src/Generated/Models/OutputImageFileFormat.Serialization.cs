...
namespace Azure.ResourceManager.Media.Models
{
    public partial class OutputImageFileFormat : IUtf8JsonSerializable, IModelJsonSerializable<OutputImageFileFormat>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<OutputImageFileFormat>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="OutputImageFileFormat"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="OutputImageFileFormat"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="OutputImageFileFormat"/>. </summary>
