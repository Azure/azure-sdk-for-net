...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier : ContentKeyPolicyPlayReadyContentKeyLocation
    {
        ...
        internal ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier(string odataType, Guid? keyId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            KeyId = keyId;
