...
namespace Azure.ResourceManager.Media.Models
{
    ...
    /// Please note <see cref="AudioProperties"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="AacAudio"/>.
    /// </summary>
    public partial class AudioProperties : CodecProperties
    {
        /// <summary> Initializes a new instance of AudioProperties. </summary>
        ...
        internal AudioProperties(string odataType, string label, int? channels, int? samplingRate, int? bitrate) : base(odataType, label)
        {
            Channels = channels;
