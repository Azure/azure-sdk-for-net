...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaAssetTrackListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaAssetTrackListResult)} does not support writing '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<MediaAssetTrackData>)item).Write(writer, options);
                }
        ...
        MediaAssetTrackListResult IJsonModel<MediaAssetTrackListResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaAssetTrackListResult)} does not support reading '{format}' format.");
            }
        ...
        internal static MediaAssetTrackListResult DeserializeMediaAssetTrackListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<MediaAssetTrackData> value = default;
            ...
            return new MediaAssetTrackListResult(value ?? new ChangeTrackingList<MediaAssetTrackData>(), serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<MediaAssetTrackListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaAssetTrackListResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        MediaAssetTrackListResult IPersistableModel<MediaAssetTrackListResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(MediaAssetTrackListResult)} does not support reading '{options.Format}' format.");
            }
        }
