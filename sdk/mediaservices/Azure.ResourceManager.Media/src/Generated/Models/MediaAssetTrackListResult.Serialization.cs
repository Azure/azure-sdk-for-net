...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaAssetTrackListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaAssetTrackListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaAssetTrackListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaAssetTrackListResult>)} interface");
            }
        ...
        string IPersistableModel<MediaAssetTrackListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
