...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class VideoLayer : MediaLayerBase
    {
        ...
        internal VideoLayer(string width, string height, string label, int bitrate, int? maxBitrate, int? bFrames, string frameRate, int? slices, bool? useAdaptiveBFrame, Dictionary<string, BinaryData> rawData) : base(width, height, label, rawData)
        {
            Bitrate = bitrate;
