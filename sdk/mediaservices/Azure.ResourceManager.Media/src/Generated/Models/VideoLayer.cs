...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="VideoLayer"/>. </summary>
        ...
        internal VideoLayer(string width, string height, string label, IDictionary<string, BinaryData> serializedAdditionalRawData, int bitrate, int? maxBitrate, int? bFrames, string frameRate, int? slices, bool? useAdaptiveBFrame) : base(width, height, label, serializedAdditionalRawData)
        {
            Bitrate = bitrate;
        ...
        /// <summary> Initializes a new instance of <see cref="VideoLayer"/> for deserialization. </summary>
        internal VideoLayer()
        {
        }
