...
{
    public partial class MultiBitrateFormat : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MultiBitrateFormat DeserializeMultiBitrateFormat(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
