...
{
    public partial class MediaEnabledProtocols : IUtf8JsonSerializable, IJsonModel<MediaEnabledProtocols>, IPersistableModel<MediaEnabledProtocols>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsDownloadEnabled))
            {
                builder.Append("  download:");
                var boolValue = IsDownloadEnabled == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsDashEnabled))
            {
                builder.Append("  dash:");
                var boolValue = IsDashEnabled == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsHlsEnabled))
            {
                builder.Append("  hls:");
                var boolValue = IsHlsEnabled == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }

            if (Optional.IsDefined(IsSmoothStreamingEnabled))
            {
                builder.Append("  smoothStreaming:");
                var boolValue = IsSmoothStreamingEnabled == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
