...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LiveEventListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LiveEventListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LiveEventListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LiveEventListResult>)} interface");
            }
        ...
        string IPersistableModel<LiveEventListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
