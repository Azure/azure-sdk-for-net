...
{
    /// <summary> The UnknownOverlayBasicProperties. </summary>
    internal partial class UnknownOverlayBasicProperties : OverlayBasicProperties
    {
        /// <summary> Initializes a new instance of UnknownOverlayBasicProperties. </summary>
        ...
        internal UnknownOverlayBasicProperties(string odataType, string inputLabel, TimeSpan? start, TimeSpan? end, TimeSpan? fadeInDuration, TimeSpan? fadeOutDuration, double? audioGainLevel) : base(odataType, inputLabel, start, end, fadeInDuration, fadeOutDuration, audioGainLevel)
        {
