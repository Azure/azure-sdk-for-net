...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class DDAudio : MediaAudioBase
    {
        ...
        internal DDAudio(string odataType, string label, int? channels, int? samplingRate, int? bitrate, Dictionary<string, BinaryData> rawData) : base(odataType, label, channels, samplingRate, bitrate, rawData)
        {
