...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of DDAudio. </summary>
        public DDAudio()
        {
        ...
        internal DDAudio(string odataType, string label, int? channels, int? samplingRate, int? bitrate) : base(odataType, label, channels, samplingRate, bitrate)
        {
