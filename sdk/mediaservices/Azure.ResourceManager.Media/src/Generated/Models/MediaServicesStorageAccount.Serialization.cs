...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaServicesStorageAccount>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaServicesStorageAccount>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaServicesStorageAccount>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaServicesStorageAccount>)} interface");
            }
        ...
        string IPersistableModel<MediaServicesStorageAccount>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
