...
{
    public partial class InputFile : IUtf8JsonSerializable
    {
        ...
        internal static InputFile DeserializeInputFile(JsonElement element)
        {
            ...
            return new InputFile(odataType, Optional.ToList(includedTracks), filename.Value);
        }
    }
}
