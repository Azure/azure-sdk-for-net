    ...
    public partial class LiveEventPreview : IUtf8JsonSerializable, IJsonModel<LiveEventPreview>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AccessControl))
            {
                ...
                AppendChildObject(builder, AccessControl, options, 2, false);
            }

            if (Optional.IsDefined(PreviewLocator))
            {
                builder.Append("  previewLocator:");
                if (PreviewLocator.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(StreamingPolicyName))
            {
                ...
                if (StreamingPolicyName.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(AlternativeMediaId))
            {
                ...
                if (AlternativeMediaId.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
