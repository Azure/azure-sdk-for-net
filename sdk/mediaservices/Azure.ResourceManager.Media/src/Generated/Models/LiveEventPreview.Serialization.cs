...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LiveEventPreview>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LiveEventPreview>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LiveEventPreview>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LiveEventPreview>)} interface");
            }
        ...
        string IPersistableModel<LiveEventPreview>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
