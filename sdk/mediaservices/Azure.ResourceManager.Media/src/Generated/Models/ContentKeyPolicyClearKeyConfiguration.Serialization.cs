...
{
    public partial class ContentKeyPolicyClearKeyConfiguration : IUtf8JsonSerializable, IJsonModel<ContentKeyPolicyClearKeyConfiguration>, IPersistableModel<ContentKeyPolicyClearKeyConfiguration>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentKeyPolicyClearKeyConfiguration>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<ContentKeyPolicyClearKeyConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContentKeyPolicyClearKeyConfiguration)} does not support '{format}' format.");
            }
