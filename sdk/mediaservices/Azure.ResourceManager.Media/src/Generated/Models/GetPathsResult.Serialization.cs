...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static GetPathsResult DeserializeGetPathsResult(JsonElement element)
        {
            ...
            return new GetPathsResult(Optional.ToList(streamingPaths), Optional.ToList(downloadPaths));
        }
    }
}
