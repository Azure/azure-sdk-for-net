...
{
    public partial class MediaJobInputHttp : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MediaJobInputHttp DeserializeMediaJobInputHttp(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
