...
{
    public partial class MediaServicesAccountData : IUtf8JsonSerializable, IModelJsonSerializable<MediaServicesAccountData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<MediaServicesAccountData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<MediaServicesAccountData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MediaServicesAccountData>(this, options.Format);
        ...
        internal static MediaServicesAccountData DeserializeMediaServicesAccountData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        MediaServicesAccountData IModelJsonSerializable<MediaServicesAccountData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MediaServicesAccountData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializeMediaServicesAccountData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<MediaServicesAccountData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MediaServicesAccountData>(this, options.Format);
        ...
        MediaServicesAccountData IModelSerializable<MediaServicesAccountData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<MediaServicesAccountData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="MediaServicesAccountData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="MediaServicesAccountData"/> to convert. </param>
        public static implicit operator RequestContent(MediaServicesAccountData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="MediaServicesAccountData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator MediaServicesAccountData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializeMediaServicesAccountData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
