...
{
    public partial class MediaServicesAccountData : IUtf8JsonSerializable, IJsonModel<MediaServicesAccountData>, IPersistableModel<MediaServicesAccountData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  mediaServiceId:");
                builder.AppendLine($" '{MediaServicesAccountId.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(StorageAuthentication))
            {
                builder.Append("  storageAuthentication:");
                builder.AppendLine($" '{StorageAuthentication.ToString()}'");
            }
            ...
            if (Optional.IsDefined(KeyDelivery))
            {
                builder.Append("  keyDelivery:");
                AppendChildObject(builder, KeyDelivery, options, 2);
            }
