...
namespace Azure.ResourceManager.Media
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaServicesAccountData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaServicesAccountData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaServicesAccountData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaServicesAccountData>)} interface");
            }
        ...
        string IPersistableModel<MediaServicesAccountData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
