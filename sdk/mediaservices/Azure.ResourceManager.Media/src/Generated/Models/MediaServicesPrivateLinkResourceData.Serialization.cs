...
{
    public partial class MediaServicesPrivateLinkResourceData : Core.IUtf8JsonSerializable
    {
        ...
        internal static MediaServicesPrivateLinkResourceData DeserializeMediaServicesPrivateLinkResourceData(JsonElement element)
        {
            ...
            return new MediaServicesPrivateLinkResourceData(id, name, type, systemData.Value, groupId.Value, Core.Optional.ToList(requiredMembers), Core.Optional.ToList(requiredZoneNames));
        }
    }
}
