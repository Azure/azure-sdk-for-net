...
{
    public partial class MediaTransformJobOutputAsset : IUtf8JsonSerializable
    {
        ...
        internal static MediaTransformJobOutputAsset DeserializeMediaTransformJobOutputAsset(JsonElement element)
        {
            ...
            return new MediaTransformJobOutputAsset(odataType, error.Value, presetOverride.Value, Optional.ToNullable(state), Optional.ToNullable(progress), label.Value, Optional.ToNullable(startTime), Optional.ToNullable(endTime), assetName);
        }
    }
}
