...
namespace Azure.ResourceManager.Media.Models
{
    public partial class StorageEncryptedAssetDecryptionInfo : IUtf8JsonSerializable, IJsonModel<StorageEncryptedAssetDecryptionInfo>
    {
        ...
        void IJsonModel<StorageEncryptedAssetDecryptionInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(StorageEncryptedAssetDecryptionInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StorageEncryptedAssetDecryptionInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(StorageEncryptedAssetDecryptionInfo)} does not support '{options.Format}' format.");
            }
        }
