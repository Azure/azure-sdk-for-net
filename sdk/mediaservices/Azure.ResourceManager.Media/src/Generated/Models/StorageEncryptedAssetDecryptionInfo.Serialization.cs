...
{
    public partial class StorageEncryptedAssetDecryptionInfo : IUtf8JsonSerializable, IJsonModel<StorageEncryptedAssetDecryptionInfo>, IPersistableModel<StorageEncryptedAssetDecryptionInfo>
    {
        ...
        void IJsonModel<StorageEncryptedAssetDecryptionInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StorageEncryptedAssetDecryptionInfo)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(AssetFileEncryptionMetadata))
            {
                builder.Append("  assetFileEncryptionMetadata:");
                builder.AppendLine(" [");
                foreach (var item in AssetFileEncryptionMetadata)
                {
