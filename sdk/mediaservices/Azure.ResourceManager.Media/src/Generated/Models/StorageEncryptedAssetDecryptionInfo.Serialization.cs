...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StorageEncryptedAssetDecryptionInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StorageEncryptedAssetDecryptionInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageEncryptedAssetDecryptionInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<StorageEncryptedAssetDecryptionInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
