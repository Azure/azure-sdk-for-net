...
namespace Azure.ResourceManager.Media.Models
{
    public partial class StorageEncryptedAssetDecryptionInfo : IUtf8JsonSerializable, IJsonModel<StorageEncryptedAssetDecryptionInfo>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<StorageEncryptedAssetDecryptionInfo>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StorageEncryptedAssetDecryptionInfo>)} interface");
            }
