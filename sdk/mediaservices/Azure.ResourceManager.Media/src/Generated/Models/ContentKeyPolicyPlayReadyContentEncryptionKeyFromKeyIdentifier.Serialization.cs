...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier IJsonModel<ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier IModel<ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
