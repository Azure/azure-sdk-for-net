...
{
    public partial class ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier : IUtf8JsonSerializable, IJsonModel<ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier>, IPersistableModel<ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(KeyId))
            {
                ...
                builder.AppendLine($" '{KeyId.Value.ToString()}'");
            }
