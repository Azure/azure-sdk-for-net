...
namespace Azure.ResourceManager.Media.Models
{
    public partial class ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier : IUtf8JsonSerializable, IModelJsonSerializable<ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier>(this, options.Format);
        ...
        internal static ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier DeserializeContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier(odataType, keyId, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="ContentKeyPolicyPlayReadyContentEncryptionKeyFromKeyIdentifier"/>. </summary>
