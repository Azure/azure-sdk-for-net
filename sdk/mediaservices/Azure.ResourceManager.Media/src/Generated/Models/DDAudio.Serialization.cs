...
{
    public partial class DDAudio : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DDAudio DeserializeDDAudio(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
