...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class H264Layer : VideoLayer
    {
        ...
        internal H264Layer(string width, string height, string label, int bitrate, int? maxBitrate, int? bFrames, string frameRate, int? slices, bool? adaptiveBFrame, H264VideoProfile? profile, string level, TimeSpan? bufferWindow, float? crf, int? referenceFrames, EntropyMode? entropyMode) : base(width, height, label, bitrate, maxBitrate, bFrames, frameRate, slices, adaptiveBFrame)
        {
            Profile = profile;
            Level = level;
