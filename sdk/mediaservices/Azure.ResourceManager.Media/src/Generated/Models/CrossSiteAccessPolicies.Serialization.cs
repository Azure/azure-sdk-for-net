...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CrossSiteAccessPolicies>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CrossSiteAccessPolicies>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CrossSiteAccessPolicies>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CrossSiteAccessPolicies>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
