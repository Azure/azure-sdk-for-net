...
{
    public partial class CrossSiteAccessPolicies : IUtf8JsonSerializable, IJsonModel<CrossSiteAccessPolicies>, IPersistableModel<CrossSiteAccessPolicies>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ClientAccessPolicy))
            {
                builder.Append("  clientAccessPolicy:");
                builder.AppendLine($" '{ClientAccessPolicy}'");
            }

            if (Optional.IsDefined(CrossDomainPolicy))
            {
                builder.Append("  crossDomainPolicy:");
                builder.AppendLine($" '{CrossDomainPolicy}'");
            }
