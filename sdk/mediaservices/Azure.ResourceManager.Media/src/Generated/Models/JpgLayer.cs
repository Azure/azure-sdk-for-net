...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class JpgLayer : MediaLayerBase
    {
        ...
        internal JpgLayer(string width, string height, string label, int? quality, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(width, height, label, serializedAdditionalRawData)
        {
            Quality = quality;
        }
