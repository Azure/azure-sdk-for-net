...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class LiveEventPreview
    {
        ...
        internal LiveEventPreview(IList<LiveEventEndpoint> endpoints, LiveEventPreviewAccessControl accessControl, string previewLocator, string streamingPolicyName, string alternativeMediaId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Endpoints = endpoints;
