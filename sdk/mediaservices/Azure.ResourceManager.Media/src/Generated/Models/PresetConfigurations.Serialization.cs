...
{
    public partial class PresetConfigurations : IUtf8JsonSerializable
    {
        ...
        internal static PresetConfigurations DeserializePresetConfigurations(JsonElement element)
        {
            Optional<ComplexitySetting> complexity = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                if (property.NameEquals("complexity"))
                {
                    ...
                    complexity = new ComplexitySetting(property.Value.GetString());
                    continue;
                }
            ...
            return new PresetConfigurations(Optional.ToNullable(complexity), Optional.ToNullable(interleaveOutput), Optional.ToNullable(keyFrameIntervalInSeconds), Optional.ToNullable(maxBitrateBps), Optional.ToNullable(maxHeight), Optional.ToNullable(maxLayers), Optional.ToNullable(minBitrateBps), Optional.ToNullable(minHeight));
        }
    }
}
