...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaAssetStreamingLocator
    {
        ...
        internal MediaAssetStreamingLocator(string name, string assetName, DateTimeOffset? createdOn, DateTimeOffset? startOn, DateTimeOffset? endOn, Guid? streamingLocatorId, string streamingPolicyName, string defaultContentKeyPolicyName, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            AssetName = assetName;
            CreatedOn = createdOn;
