...
{
    public partial class AudioTrack : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static AudioTrack DeserializeAudioTrack(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
