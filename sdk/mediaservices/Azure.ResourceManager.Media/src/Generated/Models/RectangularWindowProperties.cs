...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of RectangularWindowProperties. </summary>
        ...
        internal RectangularWindowProperties(string left, string top, string width, string height)
        {
            Left = left;
            Top = top;
            Width = width;
