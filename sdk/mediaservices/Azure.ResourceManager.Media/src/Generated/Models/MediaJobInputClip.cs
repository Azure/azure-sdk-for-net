...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaJobInputClip : MediaJobInputBasicProperties
    {
        ...
        internal MediaJobInputClip(string odataType, IList<string> files, ClipTime start, ClipTime end, string label, IList<MediaJobInputDefinition> inputDefinitions, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            Files = files;
            Start = start;
            End = end;
