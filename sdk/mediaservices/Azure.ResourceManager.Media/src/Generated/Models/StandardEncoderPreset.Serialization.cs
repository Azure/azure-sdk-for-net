...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StandardEncoderPreset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StandardEncoderPreset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StandardEncoderPreset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StandardEncoderPreset>)} interface");
            }
        ...
        string IPersistableModel<StandardEncoderPreset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
