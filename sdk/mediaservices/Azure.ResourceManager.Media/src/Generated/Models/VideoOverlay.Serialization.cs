...
{
    public partial class VideoOverlay : IUtf8JsonSerializable, IJsonModel<VideoOverlay>, IPersistableModel<VideoOverlay>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Position))
            {
                ...
                AppendChildObject(builder, Position, options, 2);
            }

            if (Optional.IsDefined(Opacity))
            {
                builder.Append("  opacity:");
                builder.AppendLine($" '{Opacity.Value.ToString()}'");
            }

            if (Optional.IsDefined(CropRectangle))
            {
                builder.Append("  cropRectangle:");
                AppendChildObject(builder, CropRectangle, options, 2);
            }
