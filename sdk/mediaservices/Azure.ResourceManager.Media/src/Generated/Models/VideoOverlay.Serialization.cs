...
{
    public partial class VideoOverlay : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VideoOverlay DeserializeVideoOverlay(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
