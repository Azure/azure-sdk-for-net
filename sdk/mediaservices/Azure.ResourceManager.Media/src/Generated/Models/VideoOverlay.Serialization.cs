...
namespace Azure.ResourceManager.Media.Models
{
    public partial class VideoOverlay : IUtf8JsonSerializable, IModelJsonSerializable<VideoOverlay>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<VideoOverlay>(this, options.Format);
        ...
        internal static VideoOverlay DeserializeVideoOverlay(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new VideoOverlay(odataType, inputLabel, Optional.ToNullable(start), Optional.ToNullable(end), Optional.ToNullable(fadeInDuration), Optional.ToNullable(fadeOutDuration), Optional.ToNullable(audioGainLevel), position.Value, Optional.ToNullable(opacity), cropRectangle.Value, serializedAdditionalRawData);
        }
