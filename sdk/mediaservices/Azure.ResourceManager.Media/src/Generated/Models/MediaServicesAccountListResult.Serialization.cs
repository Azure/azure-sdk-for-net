...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaServicesAccountListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaServicesAccountListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaServicesAccountListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaServicesAccountListResult>)} interface");
            }
        ...
        string IPersistableModel<MediaServicesAccountListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
