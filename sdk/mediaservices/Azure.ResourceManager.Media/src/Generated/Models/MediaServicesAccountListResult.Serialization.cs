...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static MediaServicesAccountListResult DeserializeMediaServicesAccountListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
