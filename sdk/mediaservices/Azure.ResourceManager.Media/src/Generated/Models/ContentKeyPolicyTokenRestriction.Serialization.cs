...
{
    public partial class ContentKeyPolicyTokenRestriction : IUtf8JsonSerializable, IJsonModel<ContentKeyPolicyTokenRestriction>, IPersistableModel<ContentKeyPolicyTokenRestriction>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PrimaryVerificationKey))
            {
                builder.Append("  primaryVerificationKey:");
                AppendChildObject(builder, PrimaryVerificationKey, options, 2);
            }

            if (Optional.IsCollectionDefined(AlternateVerificationKeys))
            {
                builder.Append("  alternateVerificationKeys:");
                builder.AppendLine(" [");
                foreach (var item in AlternateVerificationKeys)
                {
            ...
            if (Optional.IsDefined(RestrictionTokenType))
            {
                builder.Append("  restrictionTokenType:");
                builder.AppendLine($" '{RestrictionTokenType.ToString()}'");
            }

            if (Optional.IsDefined(OpenIdConnectDiscoveryDocument))
            {
                builder.Append("  openIdConnectDiscoveryDocument:");
                builder.AppendLine($" '{OpenIdConnectDiscoveryDocument}'");
            }
