...
namespace Azure.ResourceManager.Media.Models
{
    public partial class MediaJobInputFile : IUtf8JsonSerializable, IJsonModel<MediaJobInputFile>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaJobInputFile>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaJobInputFile>)} interface");
            }
