...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaJobInputFile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaJobInputFile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaJobInputFile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MediaJobInputFile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
