...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AssetContainerSas>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AssetContainerSas>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AssetContainerSas>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AssetContainerSas>)} interface");
            }
        ...
        string IPersistableModel<AssetContainerSas>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
