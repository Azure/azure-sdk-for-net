...
{
    public partial class MediaTransformJobInputClip : IUtf8JsonSerializable
    {
        ...
        internal static MediaTransformJobInputClip DeserializeMediaTransformJobInputClip(JsonElement element)
        {
            ...
            return new MediaTransformJobInputClip(odataType, Optional.ToList(files), start.Value, end.Value, label.Value, Optional.ToList(inputDefinitions));
        }
    }
}
