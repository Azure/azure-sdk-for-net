...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LiveEventOutputTranscriptionTrack>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LiveEventOutputTranscriptionTrack>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LiveEventOutputTranscriptionTrack>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LiveEventOutputTranscriptionTrack>)} interface");
            }
        ...
        string IPersistableModel<LiveEventOutputTranscriptionTrack>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
