...
namespace Azure.ResourceManager.Media
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaLiveEventData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaLiveEventData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaLiveEventData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaLiveEventData>)} interface");
            }
        ...
        string IPersistableModel<MediaLiveEventData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
