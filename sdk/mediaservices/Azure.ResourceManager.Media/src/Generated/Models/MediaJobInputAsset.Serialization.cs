...
{
    public partial class MediaJobInputAsset : Core.IUtf8JsonSerializable
    {
        ...
        internal static MediaJobInputAsset DeserializeMediaJobInputAsset(JsonElement element)
        {
            ...
            return new MediaJobInputAsset(odataType, Core.Optional.ToList(files), start.Value, end.Value, label.Value, Core.Optional.ToList(inputDefinitions), assetName);
        }
    }
}
