...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class StreamingPolicyContentKey
    {
        ...
        internal StreamingPolicyContentKey(string label, string policyName, IList<MediaTrackSelection> tracks, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Label = label;
