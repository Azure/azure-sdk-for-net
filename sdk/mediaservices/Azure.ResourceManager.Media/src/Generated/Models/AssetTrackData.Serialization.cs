...
{
    public partial class AssetTrackData : IUtf8JsonSerializable
    {
        ...
        internal static AssetTrackData DeserializeAssetTrackData(JsonElement element)
        {
            ...
            return new AssetTrackData(id, name, type, systemData.Value, track.Value, Optional.ToNullable(provisioningState));
        }
    }
}
