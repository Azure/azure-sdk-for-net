...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaAccessControl>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaAccessControl>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaAccessControl>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaAccessControl>)} interface");
            }
        ...
        string IPersistableModel<MediaAccessControl>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
