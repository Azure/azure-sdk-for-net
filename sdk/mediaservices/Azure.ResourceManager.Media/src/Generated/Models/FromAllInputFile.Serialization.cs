...
{
    public partial class FromAllInputFile : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FromAllInputFile DeserializeFromAllInputFile(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
