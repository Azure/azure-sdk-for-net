...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FromAllInputFile>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FromAllInputFile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FromAllInputFile>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<FromAllInputFile>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
