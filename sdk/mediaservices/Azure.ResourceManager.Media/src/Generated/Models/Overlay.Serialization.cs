...
{
    public partial class Overlay : IUtf8JsonSerializable
    {
        ...
        internal static Overlay DeserializeOverlay(JsonElement element)
        {
            ...
            return new Overlay(odataType, inputLabel, Optional.ToNullable(start), Optional.ToNullable(end), Optional.ToNullable(fadeInDuration), Optional.ToNullable(fadeOutDuration), Optional.ToNullable(audioGainLevel));
        }
    }
}
