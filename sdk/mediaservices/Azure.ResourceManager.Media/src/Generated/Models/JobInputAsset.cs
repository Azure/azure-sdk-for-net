...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of JobInputAsset. </summary>
        ...
        /// </param>
        /// <param name="assetName"> The name of the input Asset. </param>
        internal JobInputAsset(string odataType, IList<string> files, ClipTime start, ClipTime end, string label, IList<InputDefinition> inputDefinitions, string assetName) : base(odataType, files, start, end, label, inputDefinitions)
        {
            AssetName = assetName;
