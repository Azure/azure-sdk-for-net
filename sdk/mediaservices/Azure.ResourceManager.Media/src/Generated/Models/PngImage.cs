...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="PngImage"/>. </summary>
        ...
        internal PngImage(string odataType, string label, TimeSpan? keyFrameInterval, InputVideoStretchMode? stretchMode, VideoSyncMode? syncMode, string start, string step, string range, IList<PngLayer> layers, Dictionary<string, BinaryData> rawData) : base(odataType, label, keyFrameInterval, stretchMode, syncMode, start, step, range, rawData)
        {
            Layers = layers;
            OdataType = odataType ?? "#Microsoft.Media.PngImage";
        }

        /// <summary> Initializes a new instance of <see cref="PngImage"/> for deserialization. </summary>
        internal PngImage()
        {
        }
