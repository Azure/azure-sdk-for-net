...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class PngImage : ImageBasicProperties
    {
        ...
        internal PngImage(string odataType, string label, TimeSpan? keyFrameInterval, StretchMode? stretchMode, VideoSyncMode? syncMode, string start, string step, string range, IList<PngLayer> layers) : base(odataType, label, keyFrameInterval, stretchMode, syncMode, start, step, range)
        {
            Layers = layers;
