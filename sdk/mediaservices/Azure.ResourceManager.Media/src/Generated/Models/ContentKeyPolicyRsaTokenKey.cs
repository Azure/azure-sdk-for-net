...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class ContentKeyPolicyRsaTokenKey : ContentKeyPolicyRestrictionTokenKey
    {
        ...
        internal ContentKeyPolicyRsaTokenKey(string odataType, byte[] exponent, byte[] modulus, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            Exponent = exponent;
            Modulus = modulus;
