...
{
    public partial class AccountFilterData : IUtf8JsonSerializable
    {
        ...
        internal static AccountFilterData DeserializeAccountFilterData(JsonElement element)
        {
            ...
            return new AccountFilterData(id, name, type, systemData.Value, presentationTimeRange.Value, firstQuality.Value, Optional.ToList(tracks));
        }
    }
}
