...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaImageBase : MediaVideoBase
    {
        ...
        internal MediaImageBase(string odataType, string label, TimeSpan? keyFrameInterval, InputVideoStretchMode? stretchMode, VideoSyncMode? syncMode, string start, string step, string range, Dictionary<string, BinaryData> rawData) : base(odataType, label, keyFrameInterval, stretchMode, syncMode, rawData)
        {
            Start = start;
            Step = step;
            Range = range;
        ...
        /// <summary> Initializes a new instance of <see cref="MediaImageBase"/> for deserialization. </summary>
        internal MediaImageBase()
        {
        }
