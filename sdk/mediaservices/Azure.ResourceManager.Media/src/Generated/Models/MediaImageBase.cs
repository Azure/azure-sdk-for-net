...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaImageBase : MediaVideoBase
    {
        ...
        internal MediaImageBase(string odataType, string label, IDictionary<string, BinaryData> serializedAdditionalRawData, TimeSpan? keyFrameInterval, InputVideoStretchMode? stretchMode, VideoSyncMode? syncMode, string start, string step, string range) : base(odataType, label, serializedAdditionalRawData, keyFrameInterval, stretchMode, syncMode)
        {
            Start = start;
            Step = step;
            Range = range;
