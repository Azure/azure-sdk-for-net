...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaImageBase : MediaVideoBase
    {
        ...
        internal MediaImageBase(string odataType, string label, TimeSpan? keyFrameInterval, InputVideoStretchMode? stretchMode, VideoSyncMode? syncMode, string start, string step, string range) : base(odataType, label, keyFrameInterval, stretchMode, syncMode)
        {
            Start = start;
            Step = step;
            Range = range;
