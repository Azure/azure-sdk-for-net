...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaJobInputs : MediaJobInputBasicProperties
    {
        ...
        internal MediaJobInputs(string odataType, IList<MediaJobInputBasicProperties> inputs, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            Inputs = inputs;
