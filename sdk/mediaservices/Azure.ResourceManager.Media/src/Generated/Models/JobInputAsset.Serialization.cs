...
{
    public partial class JobInputAsset : IUtf8JsonSerializable
    {
        ...
        internal static JobInputAsset DeserializeJobInputAsset(JsonElement element)
        {
            ...
            return new JobInputAsset(odataType, Optional.ToList(files), start.Value, end.Value, label.Value, Optional.ToList(inputDefinitions), assetName);
        }
    }
}
