...
{
    public partial class ContentKeyPolicyOption : IUtf8JsonSerializable, IJsonModel<ContentKeyPolicyOption>, IPersistableModel<ContentKeyPolicyOption>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  policyOptionId:");
                builder.AppendLine($" '{PolicyOptionId.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(Restriction))
            {
                builder.Append("  restriction:");
                AppendChildObject(builder, Restriction, options, 2);
            }
