...
{
    public partial class CodecProperties : IUtf8JsonSerializable
    {
        ...
        internal static CodecProperties DeserializeCodecProperties(JsonElement element)
        {
            if (element.TryGetProperty("@odata.type", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "#Microsoft.Media.Audio": return AudioProperties.DeserializeAudioProperties(element);
            ...
            return new CodecProperties(odataType, label.Value);
        }
    }
}
