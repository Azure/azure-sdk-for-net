...
{
    internal partial class IPAccessControl : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static IPAccessControl DeserializeIPAccessControl(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
