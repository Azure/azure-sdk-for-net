...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPAccessControl>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPAccessControl>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPAccessControl>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPAccessControl>)} interface");
            }
        ...
        string IPersistableModel<IPAccessControl>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
