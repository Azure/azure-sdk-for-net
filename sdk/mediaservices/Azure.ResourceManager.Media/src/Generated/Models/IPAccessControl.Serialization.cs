...
namespace Azure.ResourceManager.Media.Models
{
    internal partial class IPAccessControl : IUtf8JsonSerializable, IModelJsonSerializable<IPAccessControl>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<IPAccessControl>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(AllowedIPs))
            {
                ...
                foreach (var item in AllowedIPs)
                {
                    ...
                    {
                        ((IModelJsonSerializable<IPRange>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="IPAccessControl"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="IPAccessControl"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="IPAccessControl"/>. </summary>
