...
{
    public partial class MediaTrackSelection : IUtf8JsonSerializable, IJsonModel<MediaTrackSelection>, IPersistableModel<MediaTrackSelection>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(TrackSelections))
            {
                builder.Append("  trackSelections:");
                builder.AppendLine(" [");
                foreach (var item in TrackSelections)
                {
