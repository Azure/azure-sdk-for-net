...
{
    public partial class TextTrack : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static TextTrack DeserializeTextTrack(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
