    ...
    public partial class TextTrack : IUtf8JsonSerializable, IJsonModel<TextTrack>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LanguageCode))
            {
                ...
                if (LanguageCode.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(PlayerVisibility))
            {
                builder.Append("  playerVisibility:");
                builder.AppendLine($" '{PlayerVisibility.Value.ToString()}'");
            }

            if (Optional.IsDefined(HlsSettings))
            {
                builder.Append("  hlsSettings:");
                AppendChildObject(builder, HlsSettings, options, 2, false);
            }
