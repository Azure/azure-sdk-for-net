...
namespace Azure.ResourceManager.Media.Models
{
    ...
    /// Please note <see cref="AudioBase"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="AacAudio"/>.
    /// </summary>
    public partial class AudioBase : CodecBase
    {
        /// <summary> Initializes a new instance of AudioBase. </summary>
        public AudioBase()
        {
        ...
        internal AudioBase(string odataType, string label, int? channels, int? samplingRate, int? bitrate) : base(odataType, label)
        {
            Channels = channels;
