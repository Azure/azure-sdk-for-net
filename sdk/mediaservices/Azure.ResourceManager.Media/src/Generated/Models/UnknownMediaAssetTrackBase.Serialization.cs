...
{
    internal partial class UnknownMediaAssetTrackBase : IUtf8JsonSerializable, IJsonModel<MediaAssetTrackBase>
    {
        ...
        internal static UnknownMediaAssetTrackBase DeserializeUnknownMediaAssetTrackBase(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownMediaAssetTrackBase(odataType, serializedAdditionalRawData);
        }
