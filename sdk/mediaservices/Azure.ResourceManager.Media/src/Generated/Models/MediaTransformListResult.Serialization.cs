...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static MediaTransformListResult DeserializeMediaTransformListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
