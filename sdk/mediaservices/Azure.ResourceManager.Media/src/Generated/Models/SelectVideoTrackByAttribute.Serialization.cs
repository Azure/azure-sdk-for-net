...
{
    public partial class SelectVideoTrackByAttribute : IUtf8JsonSerializable, IJsonModel<SelectVideoTrackByAttribute>, IPersistableModel<SelectVideoTrackByAttribute>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FilterValue))
            {
                ...
                builder.AppendLine($" '{FilterValue}'");
            }
