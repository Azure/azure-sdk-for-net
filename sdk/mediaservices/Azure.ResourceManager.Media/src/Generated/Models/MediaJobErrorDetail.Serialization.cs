...
{
    public partial class MediaJobErrorDetail : IUtf8JsonSerializable, IJsonModel<MediaJobErrorDetail>, IPersistableModel<MediaJobErrorDetail>
    {
        ...
        void IJsonModel<MediaJobErrorDetail>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaJobErrorDetail)} does not support '{format}' format.");
            }
