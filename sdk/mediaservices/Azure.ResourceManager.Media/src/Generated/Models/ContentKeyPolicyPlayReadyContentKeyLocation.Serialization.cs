...
{
    [ModelReaderProxy(typeof(UnknownContentKeyPolicyPlayReadyContentKeyLocation))]
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentKeyPolicyPlayReadyContentKeyLocation>)this).Write(writer, ModelReaderWriterOptions.DefaultWireOptions);
        ...
        ContentKeyPolicyPlayReadyContentKeyLocation IJsonModel<ContentKeyPolicyPlayReadyContentKeyLocation>.Read(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        BinaryData IModel<ContentKeyPolicyPlayReadyContentKeyLocation>.Write(ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ContentKeyPolicyPlayReadyContentKeyLocation IModel<ContentKeyPolicyPlayReadyContentKeyLocation>.Read(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == ModelReaderWriterFormat.Json || options.Format == ModelReaderWriterFormat.Wire;
            if (!isValid)
            {
        ...
        ModelReaderWriterFormat IModel<ContentKeyPolicyPlayReadyContentKeyLocation>.GetWireFormat(ModelReaderWriterOptions options) => ModelReaderWriterFormat.Json;
    }
}
