...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonEncryptionCenc>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommonEncryptionCenc>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommonEncryptionCenc>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommonEncryptionCenc>)} interface");
            }
        ...
        string IPersistableModel<CommonEncryptionCenc>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
