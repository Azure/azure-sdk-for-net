...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of ArmStreamingEndpointCapacity. </summary>
        ...
        internal ArmStreamingEndpointCapacity(string scaleType, int? @default, int? minimum, int? maximum)
        {
            ScaleType = scaleType;
            Default = @default;
            Minimum = minimum;
