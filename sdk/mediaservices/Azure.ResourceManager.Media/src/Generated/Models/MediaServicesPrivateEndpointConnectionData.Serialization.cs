...
{
    public partial class MediaServicesPrivateEndpointConnectionData : Core.IUtf8JsonSerializable
    {
        ...
        internal static MediaServicesPrivateEndpointConnectionData DeserializeMediaServicesPrivateEndpointConnectionData(JsonElement element)
        {
            ...
            Core.Optional<MediaPrivateLinkServiceConnectionState> privateLinkServiceConnectionState = default;
            Core.Optional<MediaPrivateEndpointConnectionProvisioningState> provisioningState = default;
            ...
            return new MediaServicesPrivateEndpointConnectionData(id, name, type, systemData.Value, privateEndpoint, privateLinkServiceConnectionState.Value, Core.Optional.ToNullable(provisioningState));
        }
    }
}
