...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaJobInputFile : MediaJobInputDefinition
    {
        ...
        internal MediaJobInputFile(string odataType, IList<TrackDescriptor> includedTracks, string filename, Dictionary<string, BinaryData> rawData) : base(odataType, includedTracks, rawData)
        {
            Filename = filename;
