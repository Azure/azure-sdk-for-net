...
{
    public partial class StreamingEndpointAccessControl : IUtf8JsonSerializable, IJsonModel<StreamingEndpointAccessControl>, IPersistableModel<StreamingEndpointAccessControl>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Akamai))
            {
                builder.Append("  akamai:");
                AppendChildObject(builder, Akamai, options, 2);
            }

            if (Optional.IsDefined(IPs))
            {
                builder.Append("  ip:");
                AppendChildObject(builder, IPs, options, 2);
            }
