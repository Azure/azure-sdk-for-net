...
{
    public partial class ContentKeyPolicyRsaTokenKey : IUtf8JsonSerializable, IJsonModel<ContentKeyPolicyRsaTokenKey>, IPersistableModel<ContentKeyPolicyRsaTokenKey>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Exponent))
            {
                builder.Append("  exponent:");
                builder.AppendLine($" '{Exponent.ToString()}'");
            }

            if (Optional.IsDefined(Modulus))
            {
                builder.Append("  modulus:");
                builder.AppendLine($" '{Modulus.ToString()}'");
            }
