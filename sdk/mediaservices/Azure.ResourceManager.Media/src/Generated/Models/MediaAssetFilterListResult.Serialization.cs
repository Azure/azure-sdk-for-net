...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static MediaAssetFilterListResult DeserializeMediaAssetFilterListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
