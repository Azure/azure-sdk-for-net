...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaAssetFilterListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaAssetFilterListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaAssetFilterListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaAssetFilterListResult>)} interface");
            }
        ...
        string IPersistableModel<MediaAssetFilterListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
