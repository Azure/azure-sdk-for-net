...
namespace Azure.ResourceManager.Media.Models
{
    ...
    internal partial class UnknownCodec : MediaCodecBase
    {
        ...
        internal UnknownCodec(string odataType, string label, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, label, serializedAdditionalRawData)
        {
