...
{
    public partial class VideoLayer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VideoLayer DeserializeVideoLayer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
