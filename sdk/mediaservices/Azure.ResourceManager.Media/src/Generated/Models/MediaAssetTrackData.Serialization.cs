...
{
    public partial class MediaAssetTrackData : IUtf8JsonSerializable, IJsonModel<MediaAssetTrackData>, IPersistableModel<MediaAssetTrackData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Track))
            {
                ...
                AppendChildObject(builder, Track, options, 2);
            }
