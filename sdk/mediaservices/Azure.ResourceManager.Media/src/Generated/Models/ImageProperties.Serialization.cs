...
namespace Azure.ResourceManager.Media.Models
{
    public partial class ImageProperties : IUtf8JsonSerializable
    {
        ...
        internal static ImageProperties DeserializeImageProperties(JsonElement element)
        {
            ...
            return new ImageProperties(odataType, label.Value, Optional.ToNullable(keyFrameInterval), Optional.ToNullable(stretchMode), Optional.ToNullable(syncMode), start, step.Value, range.Value);
        }
    }
}
