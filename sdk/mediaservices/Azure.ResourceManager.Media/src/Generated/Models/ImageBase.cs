...
namespace Azure.ResourceManager.Media.Models
{
    ...
    /// Please note <see cref="ImageBase"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="JpgImage"/> and <see cref="PngImage"/>.
    /// </summary>
    public partial class ImageBase : VideoBase
    {
        /// <summary> Initializes a new instance of ImageBase. </summary>
        ...
        internal ImageBase(string odataType, string label, TimeSpan? keyFrameInterval, InputVideoStretchMode? stretchMode, VideoSyncMode? syncMode, string start, string step, string range) : base(odataType, label, keyFrameInterval, stretchMode, syncMode)
        {
            Start = start;
            Step = step;
            Range = range;
