...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LiveEventEndpoint>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LiveEventEndpoint>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LiveEventEndpoint>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LiveEventEndpoint>)} interface");
            }
        ...
        string IPersistableModel<LiveEventEndpoint>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
