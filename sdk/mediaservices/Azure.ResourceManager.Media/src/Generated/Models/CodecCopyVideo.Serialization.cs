...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CodecCopyVideo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CodecCopyVideo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CodecCopyVideo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CodecCopyVideo>)} interface");
            }
        ...
        string IPersistableModel<CodecCopyVideo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
