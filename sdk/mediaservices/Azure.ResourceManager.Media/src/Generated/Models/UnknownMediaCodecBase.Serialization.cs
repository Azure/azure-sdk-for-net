...
{
    internal partial class UnknownMediaCodecBase : IUtf8JsonSerializable, IJsonModel<MediaCodecBase>
    {
        ...
        internal static UnknownMediaCodecBase DeserializeUnknownMediaCodecBase(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownMediaCodecBase(odataType, label, serializedAdditionalRawData);
        }
