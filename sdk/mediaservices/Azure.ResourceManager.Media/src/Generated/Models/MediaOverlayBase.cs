...
namespace Azure.ResourceManager.Media.Models
{
    ...
    /// </summary>
    [AbstractTypeDeserializer(typeof(UnknownOverlay))]
    public abstract partial class MediaOverlayBase
    {
        ...
        internal MediaOverlayBase(string odataType, string inputLabel, TimeSpan? start, TimeSpan? end, TimeSpan? fadeInDuration, TimeSpan? fadeOutDuration, double? audioGainLevel, Dictionary<string, BinaryData> rawData)
        {
            OdataType = odataType;
            InputLabel = inputLabel;
            Start = start;
