...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class PngLayer : MediaLayerBase
    {
        ...
        internal PngLayer(string width, string height, string label, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(width, height, label, serializedAdditionalRawData)
        {
        }
    }
}
