...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JpgFormat>)this).Write(writer, new ModelReaderWriterOptions("W"));

        void IJsonModel<JpgFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JpgFormat>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
