...
{
    public partial class JpgFormat : IUtf8JsonSerializable, IJsonModel<JpgFormat>, IPersistableModel<JpgFormat>
    {
        ...
        void IJsonModel<JpgFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(JpgFormat)} does not support '{format}' format.");
            }
