...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of MediaNameAvailabilityResult. </summary>
        /// <param name="isNameAvailable"> Specifies if the name is available. </param>
        internal MediaNameAvailabilityResult(bool isNameAvailable)
        {
        ...
        internal MediaNameAvailabilityResult(bool isNameAvailable, string reason, string message)
        {
            IsNameAvailable = isNameAvailable;
            Reason = reason;
            Message = message;
