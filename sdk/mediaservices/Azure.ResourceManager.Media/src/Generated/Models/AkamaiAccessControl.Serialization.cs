...
{
    internal partial class AkamaiAccessControl : IUtf8JsonSerializable, IJsonModel<AkamaiAccessControl>, IPersistableModel<AkamaiAccessControl>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(AkamaiSignatureHeaderAuthenticationKeyList))
            {
                builder.Append("  akamaiSignatureHeaderAuthenticationKeyList:");
                builder.AppendLine(" [");
                foreach (var item in AkamaiSignatureHeaderAuthenticationKeyList)
                {
