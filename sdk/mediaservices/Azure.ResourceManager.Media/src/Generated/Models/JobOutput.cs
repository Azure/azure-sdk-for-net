...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class JobOutput
    {
        ...
        internal JobOutput(string odataType, JobError error, MediaPreset presetOverride, JobState? state, int? progress, string label, DateTimeOffset? startOn, DateTimeOffset? endOn)
        {
            OdataType = odataType;
            Error = error;
