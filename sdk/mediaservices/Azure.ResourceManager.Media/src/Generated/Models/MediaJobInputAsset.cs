...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaJobInputAsset : MediaJobInputClip
    {
        ...
        internal MediaJobInputAsset(string odataType, IList<string> files, ClipTime start, ClipTime end, string label, IList<MediaJobInputDefinition> inputDefinitions, string assetName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, files, start, end, label, inputDefinitions, serializedAdditionalRawData)
        {
            AssetName = assetName;
