...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="AudioOverlay"/>. </summary>
        ...
        internal AudioOverlay(string odataType, string inputLabel, TimeSpan? start, TimeSpan? end, TimeSpan? fadeInDuration, TimeSpan? fadeOutDuration, double? audioGainLevel, Dictionary<string, BinaryData> rawData) : base(odataType, inputLabel, start, end, fadeInDuration, fadeOutDuration, audioGainLevel, rawData)
        {
