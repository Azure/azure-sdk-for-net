...
namespace Azure.ResourceManager.Media.Models
{
    internal partial class NoEncryption : IUtf8JsonSerializable, IJsonModel<NoEncryption>
    {
        ...
        void IJsonModel<NoEncryption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(NoEncryption)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<NoEncryption>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(NoEncryption)} does not support '{options.Format}' format.");
            }
        }
