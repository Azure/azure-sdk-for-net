...
{
    internal partial class NoEncryption : IUtf8JsonSerializable, IJsonModel<NoEncryption>, IPersistableModel<NoEncryption>
    {
        ...
        void IJsonModel<NoEncryption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(NoEncryption)} does not support '{format}' format.");
            }
