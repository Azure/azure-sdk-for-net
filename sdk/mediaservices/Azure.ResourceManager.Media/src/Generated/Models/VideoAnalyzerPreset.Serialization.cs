...
{
    public partial class VideoAnalyzerPreset : IUtf8JsonSerializable, IJsonModel<VideoAnalyzerPreset>, IPersistableModel<VideoAnalyzerPreset>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InsightsToExtract))
            {
                builder.Append("  insightsToExtract:");
                builder.AppendLine($" '{InsightsToExtract.ToString()}'");
            }
