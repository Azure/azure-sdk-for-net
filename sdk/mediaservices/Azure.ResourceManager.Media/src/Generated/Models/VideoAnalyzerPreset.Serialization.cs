...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VideoAnalyzerPreset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VideoAnalyzerPreset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VideoAnalyzerPreset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VideoAnalyzerPreset>)} interface");
            }
        ...
        string IPersistableModel<VideoAnalyzerPreset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
