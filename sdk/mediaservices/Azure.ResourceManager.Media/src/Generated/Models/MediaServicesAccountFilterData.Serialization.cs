...
{
    public partial class MediaServicesAccountFilterData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MediaServicesAccountFilterData DeserializeMediaServicesAccountFilterData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
