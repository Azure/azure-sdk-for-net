...
namespace Azure.ResourceManager.Media
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaServicesAccountFilterData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaServicesAccountFilterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaServicesAccountFilterData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaServicesAccountFilterData>)} interface");
            }
        ...
        string IPersistableModel<MediaServicesAccountFilterData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
