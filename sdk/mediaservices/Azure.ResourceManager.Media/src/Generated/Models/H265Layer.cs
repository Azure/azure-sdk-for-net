...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class H265Layer : H265VideoLayer
    {
        ...
        /// <param name="adaptiveBFrame"> Specifies whether or not adaptive B-frames are to be used when encoding this layer. If not specified, the encoder will turn it on whenever the video profile permits its use. </param>
