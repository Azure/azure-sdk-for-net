...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class H265Layer : H265VideoLayer
    {
        ...
        internal H265Layer(string width, string height, string label, int bitrate, int? maxBitrate, int? bFrames, string frameRate, int? slices, bool? useAdaptiveBFrame, H265VideoProfile? profile, string level, TimeSpan? bufferWindow, float? crf, int? referenceFrames, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(width, height, label, bitrate, maxBitrate, bFrames, frameRate, slices, useAdaptiveBFrame, serializedAdditionalRawData)
        {
            Profile = profile;
            Level = level;
