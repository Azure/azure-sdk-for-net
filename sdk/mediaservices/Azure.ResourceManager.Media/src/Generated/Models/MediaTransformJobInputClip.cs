...
namespace Azure.ResourceManager.Media.Models
{
    ...
    /// </summary>
    public partial class MediaTransformJobInputClip : MediaTransformJobInputBasicProperties
    {
        /// <summary> Initializes a new instance of MediaTransformJobInputClip. </summary>
        public MediaTransformJobInputClip()
        {
            Files = new ChangeTrackingList<string>();
            InputDefinitions = new ChangeTrackingList<MediaTransformJobInputDefinition>();
        ...
        /// </param>
        internal MediaTransformJobInputClip(string odataType, IList<string> files, ClipTime start, ClipTime end, string label, IList<MediaTransformJobInputDefinition> inputDefinitions) : base(odataType)
        {
            Files = files;
            Start = start;
            End = end;
        ...
        /// The available derived classes include <see cref="FromAllInputFile"/>, <see cref="FromEachInputFile"/> and <see cref="MediaTransformJobInputFile"/>.
        /// </summary>
        public IList<MediaTransformJobInputDefinition> InputDefinitions { get; }
    }
}
