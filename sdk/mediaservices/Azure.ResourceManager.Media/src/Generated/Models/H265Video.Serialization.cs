...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<H265Video>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<H265Video>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<H265Video>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<H265Video>)} interface");
            }
        ...
        string IPersistableModel<H265Video>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
