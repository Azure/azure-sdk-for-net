...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class AkamaiSignatureHeaderAuthenticationKey
    {
        ...
        /// <param name="expiresOn"> The expiration time of the authentication key. </param>
        internal AkamaiSignatureHeaderAuthenticationKey(string identifier, string base64Key, DateTimeOffset? expiresOn)
        {
