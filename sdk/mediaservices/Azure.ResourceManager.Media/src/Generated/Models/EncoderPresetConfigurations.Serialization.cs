...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EncoderPresetConfigurations>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EncoderPresetConfigurations>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EncoderPresetConfigurations>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EncoderPresetConfigurations>)} interface");
            }
        ...
        string IPersistableModel<EncoderPresetConfigurations>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
