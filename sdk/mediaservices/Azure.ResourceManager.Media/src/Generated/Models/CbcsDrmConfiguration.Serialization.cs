...
{
    public partial class CbcsDrmConfiguration : IUtf8JsonSerializable, IJsonModel<CbcsDrmConfiguration>, IPersistableModel<CbcsDrmConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FairPlay))
            {
                builder.Append("  fairPlay:");
                AppendChildObject(builder, FairPlay, options, 2);
            }

            if (Optional.IsDefined(PlayReady))
            {
                builder.Append("  playReady:");
                AppendChildObject(builder, PlayReady, options, 2);
            }

            if (Optional.IsDefined(Widevine))
            {
                builder.Append("  widevine:");
                AppendChildObject(builder, Widevine, options, 2);
            }
