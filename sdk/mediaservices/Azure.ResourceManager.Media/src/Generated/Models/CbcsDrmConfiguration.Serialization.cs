    ...
    public partial class CbcsDrmConfiguration : IUtf8JsonSerializable, IJsonModel<CbcsDrmConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FairPlay))
            {
                ...
                AppendChildObject(builder, FairPlay, options, 2, false);
            }

            if (Optional.IsDefined(PlayReady))
            {
                builder.Append("  playReady:");
                AppendChildObject(builder, PlayReady, options, 2, false);
            }

            if (Optional.IsDefined(Widevine))
            {
                builder.Append("  widevine:");
                AppendChildObject(builder, Widevine, options, 2, false);
            }
