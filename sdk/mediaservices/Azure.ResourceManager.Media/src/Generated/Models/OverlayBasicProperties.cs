...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public abstract partial class OverlayBasicProperties
    {
        ...
        internal OverlayBasicProperties(string odataType, string inputLabel, TimeSpan? start, TimeSpan? end, TimeSpan? fadeInDuration, TimeSpan? fadeOutDuration, double? audioGainLevel)
        {
            OdataType = odataType;
            InputLabel = inputLabel;
            Start = start;
