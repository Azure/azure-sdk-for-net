...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static StreamingLocatorListResult DeserializeStreamingLocatorListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
