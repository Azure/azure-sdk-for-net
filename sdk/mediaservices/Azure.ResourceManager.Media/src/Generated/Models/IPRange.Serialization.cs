...
{
    public partial class IPRange : IUtf8JsonSerializable, IJsonModel<IPRange>, IPersistableModel<IPRange>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SubnetPrefixLength))
            {
                builder.Append("  subnetPrefixLength:");
                builder.AppendLine($" '{SubnetPrefixLength.Value.ToString()}'");
            }
