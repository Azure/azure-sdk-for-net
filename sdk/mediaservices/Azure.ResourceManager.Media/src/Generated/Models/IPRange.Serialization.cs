...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPRange>)} interface");
            }
        ...
        string IPersistableModel<IPRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
