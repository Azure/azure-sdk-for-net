...
{
    public partial class IPRange : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static IPRange DeserializeIPRange(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
