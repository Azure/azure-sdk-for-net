...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class AbsoluteClipTime : ClipTime
    {
        ...
        internal AbsoluteClipTime(string odataType, TimeSpan time, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            Time = time;
