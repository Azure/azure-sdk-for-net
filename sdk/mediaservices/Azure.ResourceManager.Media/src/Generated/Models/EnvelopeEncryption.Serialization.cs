...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<EnvelopeEncryption>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<EnvelopeEncryption>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<EnvelopeEncryption>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<EnvelopeEncryption>)} interface");
            }
        ...
        string IPersistableModel<EnvelopeEncryption>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
