...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static MediaAssetStreamingLocator DeserializeMediaAssetStreamingLocator(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
