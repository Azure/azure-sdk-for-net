...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static ContentKeyPolicyListResult DeserializeContentKeyPolicyListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
