...
{
    public partial class FadeOptions : IUtf8JsonSerializable, IJsonModel<FadeOptions>, IPersistableModel<FadeOptions>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FadeColor))
            {
                builder.Append("  fadeColor:");
                builder.AppendLine($" '{FadeColor}'");
            }
