...
{
    public partial class FadeOptions : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FadeOptions DeserializeFadeOptions(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
