...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaTransformJobInputAsset : MediaTransformJobInputClip
    {
        /// <summary> Initializes a new instance of MediaTransformJobInputAsset. </summary>
        ...
        /// </param>
        /// <param name="assetName"> The name of the input Asset. </param>
        internal MediaTransformJobInputAsset(string odataType, IList<string> files, ClipTime start, ClipTime end, string label, IList<MediaTransformJobInputDefinition> inputDefinitions, string assetName) : base(odataType, files, start, end, label, inputDefinitions)
        {
            AssetName = assetName;
