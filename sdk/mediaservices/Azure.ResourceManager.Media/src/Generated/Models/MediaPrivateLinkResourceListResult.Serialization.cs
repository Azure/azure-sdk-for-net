...
{
    internal partial class MediaPrivateLinkResourceListResult : IUtf8JsonSerializable, IJsonModel<MediaPrivateLinkResourceListResult>, IPersistableModel<MediaPrivateLinkResourceListResult>
    {
        ...
        void IJsonModel<MediaPrivateLinkResourceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaPrivateLinkResourceListResult)} does not support '{format}' format.");
            }
