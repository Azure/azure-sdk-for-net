...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContentKeyPolicyPlayReadyPlayRight>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContentKeyPolicyPlayReadyPlayRight>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContentKeyPolicyPlayReadyPlayRight>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContentKeyPolicyPlayReadyPlayRight>)} interface");
            }
        ...
        string IPersistableModel<ContentKeyPolicyPlayReadyPlayRight>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
