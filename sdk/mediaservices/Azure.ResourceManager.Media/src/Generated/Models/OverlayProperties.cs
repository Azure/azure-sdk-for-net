...
namespace Azure.ResourceManager.Media.Models
{
    ...
    /// Please note <see cref="OverlayProperties"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    ...
    {
        /// <summary> Initializes a new instance of OverlayProperties. </summary>
        ...
        internal OverlayProperties(string odataType, string inputLabel, TimeSpan? start, TimeSpan? end, TimeSpan? fadeInDuration, TimeSpan? fadeOutDuration, double? audioGainLevel)
        {
            OdataType = odataType;
            InputLabel = inputLabel;
            Start = start;
