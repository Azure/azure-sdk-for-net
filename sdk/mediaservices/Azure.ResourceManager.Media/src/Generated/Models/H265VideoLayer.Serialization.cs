...
namespace Azure.ResourceManager.Media.Models
{
    public partial class H265VideoLayer : IUtf8JsonSerializable, IJsonModel<H265VideoLayer>
    {
        ...
        void IJsonModel<H265VideoLayer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(H265VideoLayer)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<H265VideoLayer>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(H265VideoLayer)} does not support '{options.Format}' format.");
            }
        }
