...
namespace Azure.ResourceManager.Media.Models
{
    public partial class H265VideoLayer : IUtf8JsonSerializable, IJsonModel<H265VideoLayer>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<H265VideoLayer>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<H265VideoLayer>)} interface");
            }
