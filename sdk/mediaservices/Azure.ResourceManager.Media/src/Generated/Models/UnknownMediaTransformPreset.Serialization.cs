...
{
    internal partial class UnknownMediaTransformPreset : IUtf8JsonSerializable, IJsonModel<MediaTransformPreset>
    {
        ...
        internal static UnknownMediaTransformPreset DeserializeUnknownMediaTransformPreset(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownMediaTransformPreset(odataType, serializedAdditionalRawData);
        }
