...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class AudioTrack : MediaAssetTrackBase
    {
        ...
        internal AudioTrack(string odataType, string fileName, string displayName, string languageCode, HlsSettings hlsSettings, TrackDashSettings dashSettings, int? mpeg4TrackId, int? bitRate, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            FileName = fileName;
