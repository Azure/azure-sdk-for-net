...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaTransformJobInputFile : MediaTransformJobInputDefinition
    {
        /// <summary> Initializes a new instance of MediaTransformJobInputFile. </summary>
        ...
        internal MediaTransformJobInputFile(string odataType, IList<TrackDescriptor> includedTracks, string filename) : base(odataType, includedTracks)
        {
            Filename = filename;
