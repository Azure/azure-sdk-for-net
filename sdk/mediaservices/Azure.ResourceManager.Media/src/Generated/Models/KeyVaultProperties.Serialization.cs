...
namespace Azure.ResourceManager.Media.Models
{
    public partial class KeyVaultProperties : IUtf8JsonSerializable, IJsonModel<KeyVaultProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CurrentKeyIdentifier))
            {
                builder.Append("  currentKeyIdentifier:");
                if (CurrentKeyIdentifier.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
                    builder.AppendLine($"{CurrentKeyIdentifier}'''");
                }
                else
                {
                    builder.AppendLine($" '{CurrentKeyIdentifier}'");
