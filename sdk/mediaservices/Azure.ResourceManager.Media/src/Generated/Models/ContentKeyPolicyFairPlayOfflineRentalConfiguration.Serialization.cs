...
{
    public partial class ContentKeyPolicyFairPlayOfflineRentalConfiguration : IUtf8JsonSerializable, IJsonModel<ContentKeyPolicyFairPlayOfflineRentalConfiguration>, IPersistableModel<ContentKeyPolicyFairPlayOfflineRentalConfiguration>
    {
        ...
        void IJsonModel<ContentKeyPolicyFairPlayOfflineRentalConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ContentKeyPolicyFairPlayOfflineRentalConfiguration)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PlaybackDurationInSeconds))
            {
                builder.Append("  playbackDurationSeconds:");
                builder.AppendLine($" '{PlaybackDurationInSeconds.ToString()}'");
            }

            if (Optional.IsDefined(StorageDurationInSeconds))
            {
                builder.Append("  storageDurationSeconds:");
                builder.AppendLine($" '{StorageDurationInSeconds.ToString()}'");
            }
