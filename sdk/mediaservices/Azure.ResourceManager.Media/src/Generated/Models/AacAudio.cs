...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class AacAudio : MediaAudioBase
    {
        ...
        internal AacAudio(string odataType, string label, int? channels, int? samplingRate, int? bitrate, AacAudioProfile? profile, Dictionary<string, BinaryData> rawData) : base(odataType, label, channels, samplingRate, bitrate, rawData)
        {
            Profile = profile;
