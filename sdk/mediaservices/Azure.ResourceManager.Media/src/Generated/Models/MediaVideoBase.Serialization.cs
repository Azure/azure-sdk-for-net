...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaVideoBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaVideoBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaVideoBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaVideoBase>)} interface");
            }
        ...
        string IPersistableModel<MediaVideoBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
