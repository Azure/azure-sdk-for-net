...
namespace Azure.ResourceManager.Media.Models
{
    public partial class MediaVideoBase : IUtf8JsonSerializable, IModelJsonSerializable<MediaVideoBase>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<MediaVideoBase>(this, options.Format);
        ...
        internal static MediaVideoBase DeserializeMediaVideoBase(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new MediaVideoBase(odataType, label.Value, Optional.ToNullable(keyFrameInterval), Optional.ToNullable(stretchMode), Optional.ToNullable(syncMode), rawData);
        }
