...
{
    public partial class MediaVideoBase : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MediaVideoBase DeserializeMediaVideoBase(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
