...
{
    public partial class MediaAssetData : IUtf8JsonSerializable, IJsonModel<MediaAssetData>, IPersistableModel<MediaAssetData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AssetId))
            {
                ...
                builder.AppendLine($" '{AssetId.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(AlternateId))
            {
                ...
                builder.AppendLine($" '{AlternateId}'");
            }
            ...
            {
                builder.Append("  storageEncryptionFormat:");
                builder.AppendLine($" '{StorageEncryptionFormat.ToString()}'");
            }

            if (Optional.IsDefined(EncryptionScope))
            {
                builder.Append("  encryptionScope:");
                builder.AppendLine($" '{EncryptionScope}'");
            }
