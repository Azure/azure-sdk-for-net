...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class StandardEncoderPreset : MediaTransformPreset
    {
        ...
        internal StandardEncoderPreset(string odataType, IDictionary<string, string> experimentalOptions, FilteringOperations filters, IList<MediaCodecBase> codecs, IList<MediaFormatBase> formats, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
