...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class TextTrack : MediaAssetTrackBase
    {
        ...
        internal TextTrack(string odataType, string fileName, string displayName, string languageCode, PlayerVisibility? playerVisibility, HlsSettings hlsSettings, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            FileName = fileName;
