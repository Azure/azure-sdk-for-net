...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class LiveEventTranscription
    {
        ...
        internal LiveEventTranscription(string language, IList<LiveEventInputTrackSelection> inputTrackSelection, LiveEventOutputTranscriptionTrack outputTranscriptionTrack, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Language = language;
