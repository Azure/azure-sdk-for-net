...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MultiBitrateFormat : MediaFormatBase
    {
        ...
        internal MultiBitrateFormat(string odataType, string filenamePattern, IList<MediaOutputFile> outputFiles, Dictionary<string, BinaryData> rawData) : base(odataType, filenamePattern, rawData)
        {
