...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class Mp4Format : MultiBitrateFormat
    {
        ...
        internal Mp4Format(string odataType, string filenamePattern, IList<MediaOutputFile> outputFiles, Dictionary<string, BinaryData> rawData) : base(odataType, filenamePattern, outputFiles, rawData)
        {
