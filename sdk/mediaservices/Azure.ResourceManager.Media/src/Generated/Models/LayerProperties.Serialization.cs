...
{
    public partial class LayerProperties : IUtf8JsonSerializable
    {
        ...
        internal static LayerProperties DeserializeLayerProperties(JsonElement element)
        {
            ...
            return new LayerProperties(width.Value, height.Value, label.Value);
        }
    }
}
