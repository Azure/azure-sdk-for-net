...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="VideoAnalyzerPreset"/>. </summary>
        ...
        internal VideoAnalyzerPreset(string odataType, string audioLanguage, AudioAnalysisMode? mode, IDictionary<string, string> experimentalOptions, InsightsType? insightsToExtract, Dictionary<string, BinaryData> rawData) : base(odataType, audioLanguage, mode, experimentalOptions, rawData)
        {
