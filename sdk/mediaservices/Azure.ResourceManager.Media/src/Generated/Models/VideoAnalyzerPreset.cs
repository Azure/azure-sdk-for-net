...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class VideoAnalyzerPreset : AudioAnalyzerPreset
    {
        ...
        internal VideoAnalyzerPreset(string odataType, string audioLanguage, AudioAnalysisMode? mode, IDictionary<string, string> experimentalOptions, InsightsType? insightsToExtract, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, audioLanguage, mode, experimentalOptions, serializedAdditionalRawData)
        {
