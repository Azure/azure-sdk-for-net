...
namespace Azure.ResourceManager.Media
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingLocatorData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingLocatorData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingLocatorData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingLocatorData>)} interface");
            }
        ...
        string IPersistableModel<StreamingLocatorData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
