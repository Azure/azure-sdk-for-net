...
namespace Azure.ResourceManager.Media.Models
{
    public partial class CommonEncryptionCbcs : IUtf8JsonSerializable, IJsonModel<CommonEncryptionCbcs>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CommonEncryptionCbcs>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CommonEncryptionCbcs>)} interface");
            }
