...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CommonEncryptionCbcs>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CommonEncryptionCbcs>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CommonEncryptionCbcs>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CommonEncryptionCbcs>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
