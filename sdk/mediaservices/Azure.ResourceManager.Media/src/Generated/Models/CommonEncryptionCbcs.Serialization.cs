...
{
    public partial class CommonEncryptionCbcs : Core.IUtf8JsonSerializable
    {
        ...
        internal static CommonEncryptionCbcs DeserializeCommonEncryptionCbcs(JsonElement element)
        {
            ...
            Core.Optional<CbcsDrmConfiguration> drm = default;
            ...
            return new CommonEncryptionCbcs(enabledProtocols.Value, Core.Optional.ToList(clearTracks), contentKeys.Value, drm.Value, clearKeyEncryptionConfiguration.Value);
        }
    }
}
