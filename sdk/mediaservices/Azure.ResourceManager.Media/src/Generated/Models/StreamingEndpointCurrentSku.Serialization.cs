...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingEndpointCurrentSku>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingEndpointCurrentSku>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingEndpointCurrentSku>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingEndpointCurrentSku>)} interface");
            }
        ...
        string IPersistableModel<StreamingEndpointCurrentSku>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
