...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingEndpointCurrentSku>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StreamingEndpointCurrentSku)} does not support writing '{format}' format.");
            }
        ...
        StreamingEndpointCurrentSku IJsonModel<StreamingEndpointCurrentSku>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StreamingEndpointCurrentSku)} does not support reading '{format}' format.");
            }
        ...
        internal static StreamingEndpointCurrentSku DeserializeStreamingEndpointCurrentSku(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new StreamingEndpointCurrentSku(name, capacity, serializedAdditionalRawData);
        }
        ...
        BinaryData IPersistableModel<StreamingEndpointCurrentSku>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StreamingEndpointCurrentSku)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        StreamingEndpointCurrentSku IPersistableModel<StreamingEndpointCurrentSku>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StreamingEndpointCurrentSku)} does not support reading '{options.Format}' format.");
            }
        }
