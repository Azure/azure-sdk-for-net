...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PngFormat>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PngFormat>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PngFormat>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PngFormat>)} interface");
            }
        ...
        string IPersistableModel<PngFormat>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
