...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static StreamingEndpointListResult DeserializeStreamingEndpointListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
