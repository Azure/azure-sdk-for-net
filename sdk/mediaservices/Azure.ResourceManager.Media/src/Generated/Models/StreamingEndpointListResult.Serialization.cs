...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingEndpointListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingEndpointListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingEndpointListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingEndpointListResult>)} interface");
            }
        ...
        string IPersistableModel<StreamingEndpointListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
