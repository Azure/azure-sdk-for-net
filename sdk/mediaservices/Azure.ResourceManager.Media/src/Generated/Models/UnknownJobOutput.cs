...
namespace Azure.ResourceManager.Media.Models
{
    ...
    internal partial class UnknownJobOutput : MediaJobOutput
    {
        ...
        internal UnknownJobOutput(string odataType, MediaJobError error, MediaTransformPreset presetOverride, MediaJobState? state, int? progress, string label, DateTimeOffset? startOn, DateTimeOffset? endOn, Dictionary<string, BinaryData> rawData) : base(odataType, error, presetOverride, state, progress, label, startOn, endOn, rawData)
        {
