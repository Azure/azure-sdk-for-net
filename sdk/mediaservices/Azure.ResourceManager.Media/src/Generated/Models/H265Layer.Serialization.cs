...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<H265Layer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<H265Layer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<H265Layer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<H265Layer>)} interface");
            }
        ...
        string IPersistableModel<H265Layer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
