...
{
    public partial class MediaAssetFilterData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MediaAssetFilterData DeserializeMediaAssetFilterData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
