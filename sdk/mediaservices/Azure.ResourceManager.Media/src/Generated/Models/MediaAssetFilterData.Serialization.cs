...
namespace Azure.ResourceManager.Media
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaAssetFilterData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaAssetFilterData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaAssetFilterData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaAssetFilterData>)} interface");
            }
        ...
        string IPersistableModel<MediaAssetFilterData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
