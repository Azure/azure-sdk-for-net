...
{
    public partial class SelectVideoTrackById : IUtf8JsonSerializable, IJsonModel<SelectVideoTrackById>, IPersistableModel<SelectVideoTrackById>
    {
        ...
        void IJsonModel<SelectVideoTrackById>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(SelectVideoTrackById)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TrackId))
            {
                builder.Append("  trackId:");
                builder.AppendLine($" '{TrackId.ToString()}'");
            }
