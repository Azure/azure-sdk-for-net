...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaJobError
    {
        ...
        internal MediaJobError(MediaJobErrorCode? code, string message, MediaJobErrorCategory? category, MediaJobRetry? retry, IReadOnlyList<MediaJobErrorDetail> details, Dictionary<string, BinaryData> rawData)
        {
            Code = code;
            Message = message;
            Category = category;
