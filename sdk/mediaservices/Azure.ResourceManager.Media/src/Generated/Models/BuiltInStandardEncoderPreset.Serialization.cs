...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<BuiltInStandardEncoderPreset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<BuiltInStandardEncoderPreset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<BuiltInStandardEncoderPreset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<BuiltInStandardEncoderPreset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
