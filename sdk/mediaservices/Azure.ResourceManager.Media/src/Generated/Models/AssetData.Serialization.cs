...
{
    public partial class AssetData : IUtf8JsonSerializable
    {
        ...
        internal static AssetData DeserializeAssetData(JsonElement element)
        {
            ...
            return new AssetData(id, name, type, systemData.Value, Optional.ToNullable(assetId), Optional.ToNullable(created), Optional.ToNullable(lastModified), alternateId.Value, description.Value, container.Value, storageAccountName.Value, Optional.ToNullable(storageEncryptionFormat));
        }
    }
}
