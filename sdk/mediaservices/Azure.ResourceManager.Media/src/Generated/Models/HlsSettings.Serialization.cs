...
{
    public partial class HlsSettings : IUtf8JsonSerializable, IJsonModel<HlsSettings>, IPersistableModel<HlsSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IsForced))
            {
                ...
                var boolValue = IsForced.Value == true ? "true" : "false";
                builder.AppendLine($" {boolValue}");
            }
