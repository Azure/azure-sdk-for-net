...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<HlsSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<HlsSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<HlsSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<HlsSettings>)} interface");
            }
        ...
        string IPersistableModel<HlsSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
