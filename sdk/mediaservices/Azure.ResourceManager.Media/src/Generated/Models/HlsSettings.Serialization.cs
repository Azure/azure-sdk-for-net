...
{
    public partial class HlsSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static HlsSettings DeserializeHlsSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
