...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaAssetListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaAssetListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaAssetListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaAssetListResult>)} interface");
            }
        ...
        string IPersistableModel<MediaAssetListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
