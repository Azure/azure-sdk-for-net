...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class H265VideoLayer : LayerProperties
    {
        ...
        internal H265VideoLayer(string width, string height, string label, int bitrate, int? maxBitrate, int? bFrames, string frameRate, int? slices, bool? adaptiveBFrame) : base(width, height, label)
        {
            Bitrate = bitrate;
