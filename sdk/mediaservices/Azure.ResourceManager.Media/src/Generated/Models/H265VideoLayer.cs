...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="H265VideoLayer"/>. </summary>
        ...
        internal H265VideoLayer(string width, string height, string label, int bitrate, int? maxBitrate, int? bFrames, string frameRate, int? slices, bool? useAdaptiveBFrame, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(width, height, label, serializedAdditionalRawData)
        {
            Bitrate = bitrate;
        ...
        /// <summary> Initializes a new instance of <see cref="H265VideoLayer"/> for deserialization. </summary>
        internal H265VideoLayer()
        {
        }
