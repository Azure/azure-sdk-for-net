...
namespace Azure.ResourceManager.Media.Models
{
    internal partial class StreamingPolicyListResult : IUtf8JsonSerializable, IModelJsonSerializable<StreamingPolicyListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<StreamingPolicyListResult>(this, options.Format);
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                foreach (var item in Value)
                {
                    ...
                    {
                        ((IModelJsonSerializable<StreamingPolicyData>)item).Serialize(writer, options);
                    }
                }
        ...
        /// <summary> Converts a <see cref="StreamingPolicyListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="StreamingPolicyListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="StreamingPolicyListResult"/>. </summary>
