...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingPolicyListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingPolicyListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingPolicyListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingPolicyListResult>)} interface");
            }
        ...
        string IPersistableModel<StreamingPolicyListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
