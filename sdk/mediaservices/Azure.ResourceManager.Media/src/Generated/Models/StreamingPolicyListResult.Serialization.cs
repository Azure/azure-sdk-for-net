...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static StreamingPolicyListResult DeserializeStreamingPolicyListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
