...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaVideoBase : MediaCodecBase
    {
        ...
        internal MediaVideoBase(string odataType, string label, TimeSpan? keyFrameInterval, InputVideoStretchMode? stretchMode, VideoSyncMode? syncMode, Dictionary<string, BinaryData> rawData) : base(odataType, label, rawData)
        {
