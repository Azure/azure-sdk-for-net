...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClearKeyEncryptionConfiguration>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClearKeyEncryptionConfiguration>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClearKeyEncryptionConfiguration>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ClearKeyEncryptionConfiguration>)} interface");
            }
        ...
        string IPersistableModel<ClearKeyEncryptionConfiguration>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
