...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class JpgImage : ImageProperties
    {
        ...
        internal JpgImage(string odataType, string label, TimeSpan? keyFrameInterval, StretchMode? stretchMode, VideoSyncMode? syncMode, string start, string step, string range, IList<JpgLayer> layers, int? spriteColumn) : base(odataType, label, keyFrameInterval, stretchMode, syncMode, start, step, range)
        {
            Layers = layers;
