...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static StreamingEndpointSkuInfo DeserializeStreamingEndpointSkuInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
