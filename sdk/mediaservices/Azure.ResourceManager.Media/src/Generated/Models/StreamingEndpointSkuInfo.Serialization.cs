...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingEndpointSkuInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingEndpointSkuInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingEndpointSkuInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingEndpointSkuInfo>)} interface");
            }
        ...
        string IPersistableModel<StreamingEndpointSkuInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
