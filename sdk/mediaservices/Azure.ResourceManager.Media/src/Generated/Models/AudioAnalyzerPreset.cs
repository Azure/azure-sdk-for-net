...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class AudioAnalyzerPreset : MediaTransformPreset
    {
        ...
        internal AudioAnalyzerPreset(string odataType, string audioLanguage, AudioAnalysisMode? mode, IDictionary<string, string> experimentalOptions, Dictionary<string, BinaryData> rawData) : base(odataType, rawData)
        {
