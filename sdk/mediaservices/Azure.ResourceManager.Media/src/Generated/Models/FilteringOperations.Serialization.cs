...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FilteringOperations>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FilteringOperations>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FilteringOperations>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FilteringOperations>)} interface");
            }
        ...
        string IPersistableModel<FilteringOperations>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
