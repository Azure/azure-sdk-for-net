...
{
    public partial class Codec : IUtf8JsonSerializable
    {
        ...
        internal static Codec DeserializeCodec(JsonElement element)
        {
            if (element.TryGetProperty("@odata.type", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "#Microsoft.Media.Audio": return Audio.DeserializeAudio(element);
                    ...
                    case "#Microsoft.Media.Video": return Video.DeserializeVideo(element);
                }
            }
            ...
            return new Codec(odataType, label.Value);
        }
    }
}
