...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaServicesStorageAccount
    {
        ...
        internal MediaServicesStorageAccount(ResourceIdentifier id, MediaServicesStorageAccountType accountType, ResourceIdentity identity, string status, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            AccountType = accountType;
            Identity = identity;
