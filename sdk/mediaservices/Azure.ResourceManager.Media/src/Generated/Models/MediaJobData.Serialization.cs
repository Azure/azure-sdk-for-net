...
{
    public partial class MediaJobData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MediaJobData DeserializeMediaJobData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
