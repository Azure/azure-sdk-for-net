...
namespace Azure.ResourceManager.Media.Models
{
    ...
    /// Please note <see cref="Video"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="H264Video"/>, <see cref="H265Video"/>, <see cref="Image"/>, <see cref="JpgImage"/> and <see cref="PngImage"/>.
    /// </summary>
    public partial class Video : Codec
    {
        ...
        internal Video(string odataType, string label, TimeSpan? keyFrameInterval, StretchMode? stretchMode, VideoSyncMode? syncMode) : base(odataType, label)
        {
