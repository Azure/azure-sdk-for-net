...
namespace Azure.ResourceManager.Media.Models
{
    public partial class AbsoluteClipTime : IUtf8JsonSerializable, IJsonModel<AbsoluteClipTime>
    {
        ...
        void IJsonModel<AbsoluteClipTime>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(AbsoluteClipTime)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AbsoluteClipTime>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(AbsoluteClipTime)} does not support '{options.Format}' format.");
            }
        }
