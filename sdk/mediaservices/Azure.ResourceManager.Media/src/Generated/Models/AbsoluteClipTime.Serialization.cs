...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AbsoluteClipTime>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AbsoluteClipTime>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AbsoluteClipTime>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AbsoluteClipTime>)} interface");
            }
        ...
        string IPersistableModel<AbsoluteClipTime>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
