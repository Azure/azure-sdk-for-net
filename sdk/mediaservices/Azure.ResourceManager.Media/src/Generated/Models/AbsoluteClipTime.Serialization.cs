...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AbsoluteClipTime>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AbsoluteClipTime)} does not support writing '{format}' format.");
            }
        ...
        AbsoluteClipTime IJsonModel<AbsoluteClipTime>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AbsoluteClipTime)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<AbsoluteClipTime>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AbsoluteClipTime)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        AbsoluteClipTime IPersistableModel<AbsoluteClipTime>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(AbsoluteClipTime)} does not support reading '{options.Format}' format.");
            }
        }
