...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class ContentKeyPolicyProperties
    {
        ...
        internal ContentKeyPolicyProperties(Guid? policyId, DateTimeOffset? createdOn, DateTimeOffset? lastModifiedOn, string description, IReadOnlyList<ContentKeyPolicyOption> options, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            PolicyId = policyId;
            CreatedOn = createdOn;
