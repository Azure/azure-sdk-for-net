...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class EncoderPresetConfigurations
    {
        ...
        internal EncoderPresetConfigurations(EncodingComplexity? complexity, InterleaveOutput? interleaveOutput, float? keyFrameIntervalInSeconds, int? maxBitrateBps, int? maxHeight, int? maxLayers, int? minBitrateBps, int? minHeight, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
