...
{
    public partial class CencDrmConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CencDrmConfiguration DeserializeCencDrmConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
