...
namespace Azure.ResourceManager.Media.Models
{
    ...
    internal partial class UnknownMediaJobOutput : MediaJobOutput
    {
        ...
        internal UnknownMediaJobOutput(string odataType, MediaJobError error, MediaTransformPreset presetOverride, JobState? state, int? progress, string label, DateTimeOffset? startOn, DateTimeOffset? endOn) : base(odataType, error, presetOverride, state, progress, label, startOn, endOn)
        {
