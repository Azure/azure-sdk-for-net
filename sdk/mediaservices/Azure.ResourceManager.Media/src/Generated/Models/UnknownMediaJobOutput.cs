...
namespace Azure.ResourceManager.Media.Models
{
    ...
    internal partial class UnknownMediaJobOutput : MediaJobOutput
    {
        ...
        internal UnknownMediaJobOutput(string odataType, MediaJobError error, MediaTransformPreset presetOverride, MediaJobState? state, int? progress, string label, DateTimeOffset? startOn, DateTimeOffset? endOn, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, error, presetOverride, state, progress, label, startOn, endOn, serializedAdditionalRawData)
        {
