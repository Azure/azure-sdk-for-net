...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of JobError. </summary>
        internal JobError()
        {
            Details = new ChangeTrackingList<JobErrorDetail>();
        }
        ...
        internal JobError(JobErrorCode? code, string message, JobErrorCategory? category, JobRetry? retry, IReadOnlyList<JobErrorDetail> details)
        {
            Code = code;
            Message = message;
            Category = category;
        ...
        public JobErrorCategory? Category { get; }
