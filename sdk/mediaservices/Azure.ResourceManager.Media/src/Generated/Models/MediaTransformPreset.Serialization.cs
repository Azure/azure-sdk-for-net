...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaTransformPreset : IUtf8JsonSerializable, IJsonModel<MediaTransformPreset>
    {
        ...
        void IJsonModel<MediaTransformPreset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MediaTransformPreset)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MediaTransformPreset>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MediaTransformPreset)} does not support '{options.Format}' format.");
            }
        }
