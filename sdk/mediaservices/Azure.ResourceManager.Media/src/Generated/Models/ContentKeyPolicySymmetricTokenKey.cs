...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class ContentKeyPolicySymmetricTokenKey : ContentKeyPolicyRestrictionTokenKey
    {
        ...
        internal ContentKeyPolicySymmetricTokenKey(string odataType, byte[] keyValue, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            KeyValue = keyValue;
