...
namespace Azure.ResourceManager.Media.Models
{
    public partial class SelectAudioTrackByAttribute : IUtf8JsonSerializable, IJsonModel<SelectAudioTrackByAttribute>
    {
        ...
        void IJsonModel<SelectAudioTrackByAttribute>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SelectAudioTrackByAttribute)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SelectAudioTrackByAttribute>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SelectAudioTrackByAttribute)} does not support '{options.Format}' format.");
            }
        }
