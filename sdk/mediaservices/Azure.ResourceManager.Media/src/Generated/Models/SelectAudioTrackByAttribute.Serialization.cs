...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SelectAudioTrackByAttribute>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SelectAudioTrackByAttribute>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SelectAudioTrackByAttribute>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SelectAudioTrackByAttribute>)} interface");
            }
        ...
        string IPersistableModel<SelectAudioTrackByAttribute>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
