...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class AccountEncryption
    {
        ...
        internal AccountEncryption(AccountEncryptionKeyType keyType, KeyVaultProperties keyVaultProperties, ResourceIdentity identity, string status, Dictionary<string, BinaryData> rawData)
        {
            KeyType = keyType;
