...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public readonly partial struct StretchMode : IEquatable<StretchMode>
    {
        private readonly string _value;

        /// <summary> Initializes a new instance of <see cref="StretchMode"/>. </summary>
        /// <exception cref="ArgumentNullException"> <paramref name="value"/> is null. </exception>
        public StretchMode(string value)
        {
        ...
        public static StretchMode None { get; } = new StretchMode(NoneValue);
        ...
        public static StretchMode AutoSize { get; } = new StretchMode(AutoSizeValue);
        ...
        public static StretchMode AutoFit { get; } = new StretchMode(AutoFitValue);
        /// <summary> Determines if two <see cref="StretchMode"/> values are the same. </summary>
        public static bool operator ==(StretchMode left, StretchMode right) => left.Equals(right);
        /// <summary> Determines if two <see cref="StretchMode"/> values are not the same. </summary>
        public static bool operator !=(StretchMode left, StretchMode right) => !left.Equals(right);
        /// <summary> Converts a string to a <see cref="StretchMode"/>. </summary>
        public static implicit operator StretchMode(string value) => new StretchMode(value);

        /// <inheritdoc />
        [EditorBrowsable(EditorBrowsableState.Never)]
        public override bool Equals(object obj) => obj is StretchMode other && Equals(other);
        /// <inheritdoc />
        public bool Equals(StretchMode other) => string.Equals(_value, other._value, StringComparison.InvariantCultureIgnoreCase);
