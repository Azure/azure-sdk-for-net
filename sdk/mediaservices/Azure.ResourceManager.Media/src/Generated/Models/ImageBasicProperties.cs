...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class ImageBasicProperties : InputVideoEncodingProperties
    {
        ...
        internal ImageBasicProperties(string odataType, string label, TimeSpan? keyFrameInterval, StretchMode? stretchMode, VideoSyncMode? syncMode, string start, string step, string range) : base(odataType, label, keyFrameInterval, stretchMode, syncMode)
        {
            Start = start;
            Step = step;
            Range = range;
