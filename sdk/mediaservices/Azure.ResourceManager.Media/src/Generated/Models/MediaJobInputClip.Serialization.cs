...
namespace Azure.ResourceManager.Media.Models
{
    public partial class MediaJobInputClip : IUtf8JsonSerializable, IJsonModel<MediaJobInputClip>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaJobInputClip>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaJobInputClip>)} interface");
            }
