...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaJobInputClip>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaJobInputClip>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaJobInputClip>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<MediaJobInputClip>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
