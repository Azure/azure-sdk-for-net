...
{
    public partial class StreamingEndpointData : IUtf8JsonSerializable, IJsonModel<StreamingEndpointData>, IPersistableModel<StreamingEndpointData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FreeTrialEndOn))
            {
                ...
                builder.AppendLine($" '{FreeTrialEndOn.Value.ToString()}'");
            }
