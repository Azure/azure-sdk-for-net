...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<Mp4Format>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<Mp4Format>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<Mp4Format>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<Mp4Format>)} interface");
            }
        ...
        string IPersistableModel<Mp4Format>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
