...
{
    public partial class Mp4Format : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static Mp4Format DeserializeMp4Format(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
