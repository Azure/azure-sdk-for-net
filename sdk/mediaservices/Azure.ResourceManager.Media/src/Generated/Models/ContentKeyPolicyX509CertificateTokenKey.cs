...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class ContentKeyPolicyX509CertificateTokenKey : ContentKeyPolicyRestrictionTokenKey
    {
        ...
        internal ContentKeyPolicyX509CertificateTokenKey(string odataType, byte[] rawBody, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            RawBody = rawBody;
