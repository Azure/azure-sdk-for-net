...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListContentKeysResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListContentKeysResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListContentKeysResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListContentKeysResponse>)} interface");
            }
        ...
        string IPersistableModel<ListContentKeysResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
