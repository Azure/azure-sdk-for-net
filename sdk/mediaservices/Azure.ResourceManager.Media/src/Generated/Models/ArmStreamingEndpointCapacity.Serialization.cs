...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static ArmStreamingEndpointCapacity DeserializeArmStreamingEndpointCapacity(JsonElement element)
        {
            ...
            return new ArmStreamingEndpointCapacity(scaleType.Value, Optional.ToNullable(@default), Optional.ToNullable(minimum), Optional.ToNullable(maximum));
        }
    }
}
