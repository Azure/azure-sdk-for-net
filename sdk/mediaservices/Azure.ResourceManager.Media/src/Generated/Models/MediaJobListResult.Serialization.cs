...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaJobListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaJobListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaJobListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaJobListResult>)} interface");
            }
        ...
        string IPersistableModel<MediaJobListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
