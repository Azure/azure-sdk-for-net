...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static ListPathsResponse DeserializeListPathsResponse(JsonElement element)
        {
            ...
            return new ListPathsResponse(Optional.ToList(streamingPaths), Optional.ToList(downloadPaths));
        }
    }
}
