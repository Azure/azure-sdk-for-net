...
namespace Azure.ResourceManager.Media.Models
{
    ...
    /// Please note <see cref="VideoBase"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    /// The available derived classes include <see cref="H264Video"/>, <see cref="H265Video"/>, <see cref="ImageBase"/>, <see cref="JpgImage"/> and <see cref="PngImage"/>.
    /// </summary>
    public partial class VideoBase : CodecBase
    {
        /// <summary> Initializes a new instance of VideoBase. </summary>
        public VideoBase()
        {
        ...
        internal VideoBase(string odataType, string label, TimeSpan? keyFrameInterval, InputVideoStretchMode? stretchMode, VideoSyncMode? syncMode) : base(odataType, label)
        {
