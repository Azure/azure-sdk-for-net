...
{
    public partial class FilterOperations : IUtf8JsonSerializable
    {
        ...
        internal static FilterOperations DeserializeFilterOperations(JsonElement element)
        {
            ...
            Optional<IList<OverlayProperties>> overlays = default;
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("overlays"))
                {
                    ...
                    List<OverlayProperties> array = new List<OverlayProperties>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(OverlayProperties.DeserializeOverlayProperties(item));
                    }
                    overlays = array;
                    continue;
                }
            }
            return new FilterOperations(deinterlace.Value, Optional.ToNullable(rotation), crop.Value, Optional.ToList(overlays));
        }
    }
}
