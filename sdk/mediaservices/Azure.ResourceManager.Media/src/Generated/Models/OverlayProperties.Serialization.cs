...
{
    public partial class OverlayProperties : IUtf8JsonSerializable
    {
        ...
        internal static OverlayProperties DeserializeOverlayProperties(JsonElement element)
        {
            ...
            return new OverlayProperties(odataType, inputLabel, Optional.ToNullable(start), Optional.ToNullable(end), Optional.ToNullable(fadeInDuration), Optional.ToNullable(fadeOutDuration), Optional.ToNullable(audioGainLevel));
        }
    }
}
