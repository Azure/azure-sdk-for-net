...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CodecCopyVideo"/>. </summary>
        ...
        internal CodecCopyVideo(string odataType, string label, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, label, serializedAdditionalRawData)
        {
