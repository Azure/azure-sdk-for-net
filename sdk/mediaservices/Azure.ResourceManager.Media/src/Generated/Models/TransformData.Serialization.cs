...
{
    public partial class TransformData : IUtf8JsonSerializable
    {
        ...
        internal static TransformData DeserializeTransformData(JsonElement element)
        {
            ...
            return new TransformData(id, name, type, systemData.Value, Optional.ToNullable(created), description.Value, Optional.ToNullable(lastModified), Optional.ToList(outputs));
        }
    }
}
