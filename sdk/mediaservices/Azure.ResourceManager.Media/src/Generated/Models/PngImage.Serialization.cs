...
namespace Azure.ResourceManager.Media.Models
{
    public partial class PngImage : IUtf8JsonSerializable, IModelJsonSerializable<PngImage>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<PngImage>(this, options.Format);
        ...
        internal static PngImage DeserializePngImage(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PngImage(odataType, label.Value, Optional.ToNullable(keyFrameInterval), Optional.ToNullable(stretchMode), Optional.ToNullable(syncMode), start, step.Value, range.Value, Optional.ToList(layers), rawData);
        }
