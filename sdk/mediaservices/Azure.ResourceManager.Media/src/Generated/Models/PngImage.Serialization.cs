...
{
    public partial class PngImage : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PngImage DeserializePngImage(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
