...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PngImage>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PngImage>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PngImage>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PngImage>)} interface");
            }
        ...
        string IPersistableModel<PngImage>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
