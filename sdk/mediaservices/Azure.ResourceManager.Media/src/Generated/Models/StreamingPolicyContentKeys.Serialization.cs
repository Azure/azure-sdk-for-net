...
{
    public partial class StreamingPolicyContentKeys : IUtf8JsonSerializable, IJsonModel<StreamingPolicyContentKeys>, IPersistableModel<StreamingPolicyContentKeys>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DefaultKey))
            {
                ...
                AppendChildObject(builder, DefaultKey, options, 2);
            }

            if (Optional.IsCollectionDefined(KeyToTrackMappings))
            {
                builder.Append("  keyToTrackMappings:");
                builder.AppendLine(" [");
                foreach (var item in KeyToTrackMappings)
                {
