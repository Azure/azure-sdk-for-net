...
{
    /// <summary> The UnknownMediaJobInputDefinition. </summary>
    internal partial class UnknownMediaJobInputDefinition : MediaJobInputDefinition
    {
        /// <summary> Initializes a new instance of UnknownMediaJobInputDefinition. </summary>
        ...
        /// </param>
        internal UnknownMediaJobInputDefinition(string odataType, IList<TrackDescriptor> includedTracks) : base(odataType, includedTracks)
        {
