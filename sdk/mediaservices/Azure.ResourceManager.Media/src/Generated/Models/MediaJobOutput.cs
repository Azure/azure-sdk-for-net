...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public abstract partial class MediaJobOutput
    {
        ...
        internal MediaJobOutput(string odataType, MediaJobError error, MediaTransformPreset presetOverride, JobState? state, int? progress, string label, DateTimeOffset? startOn, DateTimeOffset? endOn)
        {
            OdataType = odataType;
            Error = error;
