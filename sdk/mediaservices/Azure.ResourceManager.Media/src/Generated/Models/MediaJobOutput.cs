...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public abstract partial class MediaJobOutput
    {
        ...
        internal MediaJobOutput(string odataType, MediaJobError error, MediaTransformPreset presetOverride, MediaJobState? state, int? progress, string label, DateTimeOffset? startOn, DateTimeOffset? endOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            OdataType = odataType;
            Error = error;
