...
{
    internal partial class Hls : IUtf8JsonSerializable, IJsonModel<Hls>, IPersistableModel<Hls>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FragmentsPerTsSegment))
            {
                builder.Append("  fragmentsPerTsSegment:");
                builder.AppendLine($" '{FragmentsPerTsSegment.Value.ToString()}'");
            }
