...
{
    public partial class InputDefinition : IUtf8JsonSerializable
    {
        ...
        internal static InputDefinition DeserializeInputDefinition(JsonElement element)
        {
            if (element.TryGetProperty("@odata.type", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    ...
                    case "#Microsoft.Media.InputFile": return InputFile.DeserializeInputFile(element);
                }
            }
            ...
            return new InputDefinition(odataType, Optional.ToList(includedTracks));
        }
    }
}
