...
namespace Azure.ResourceManager.Media.Models
{
    ...
    internal partial class UnknownFormat : MediaFormatBase
    {
        ...
        internal UnknownFormat(string odataType, string filenamePattern, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, filenamePattern, serializedAdditionalRawData)
        {
            OdataType = odataType ?? "Unknown";
        }

        /// <summary> Initializes a new instance of <see cref="UnknownFormat"/> for deserialization. </summary>
        internal UnknownFormat()
        {
        }
    }
}
