...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static MediaServicesEdgePolicies DeserializeMediaServicesEdgePolicies(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
