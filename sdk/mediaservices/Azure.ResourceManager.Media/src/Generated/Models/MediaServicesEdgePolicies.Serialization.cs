...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaServicesEdgePolicies>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaServicesEdgePolicies>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaServicesEdgePolicies>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaServicesEdgePolicies>)} interface");
            }
        ...
        string IPersistableModel<MediaServicesEdgePolicies>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
