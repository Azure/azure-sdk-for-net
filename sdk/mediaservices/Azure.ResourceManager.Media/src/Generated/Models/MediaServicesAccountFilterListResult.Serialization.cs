...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaServicesAccountFilterListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaServicesAccountFilterListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaServicesAccountFilterListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaServicesAccountFilterListResult>)} interface");
            }
        ...
        string IPersistableModel<MediaServicesAccountFilterListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
