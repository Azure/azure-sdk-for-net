...
{
    internal partial class MediaServicesAccountFilterListResult : IUtf8JsonSerializable, IJsonModel<MediaServicesAccountFilterListResult>, IPersistableModel<MediaServicesAccountFilterListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaServicesAccountFilterListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MediaServicesAccountFilterListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaServicesAccountFilterListResult)} does not support '{format}' format.");
            }
