...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class ContentKeyPolicyFairPlayConfiguration : ContentKeyPolicyConfiguration
    {
        ...
        /// <param name="fairPlayApplicationSecretKey"> The key that must be used as FairPlay Application Secret key. </param>
        ...
        public ContentKeyPolicyFairPlayConfiguration(byte[] fairPlayApplicationSecretKey, string fairPlayPfxPassword, string fairPlayPfx, ContentKeyPolicyFairPlayRentalAndLeaseKeyType rentalAndLeaseKeyType, long rentalDuration)
        {
            FairPlayApplicationSecretKey = fairPlayApplicationSecretKey;
        ...
        internal ContentKeyPolicyFairPlayConfiguration(string odataType, byte[] fairPlayApplicationSecretKey, string fairPlayPfxPassword, string fairPlayPfx, ContentKeyPolicyFairPlayRentalAndLeaseKeyType rentalAndLeaseKeyType, long rentalDuration, ContentKeyPolicyFairPlayOfflineRentalConfiguration offlineRentalConfiguration) : base(odataType)
        {
            FairPlayApplicationSecretKey = fairPlayApplicationSecretKey;
            FairPlayPfxPassword = fairPlayPfxPassword;
            FairPlayPfx = fairPlayPfx;
        ...
        public byte[] FairPlayApplicationSecretKey { get; set; }
