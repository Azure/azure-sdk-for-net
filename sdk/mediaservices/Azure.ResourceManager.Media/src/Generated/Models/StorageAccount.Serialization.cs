...
namespace Azure.ResourceManager.Media.Models
{
    public partial class StorageAccount : IUtf8JsonSerializable
    {
        ...
        internal static StorageAccount DeserializeStorageAccount(JsonElement element)
        {
            ...
            StorageAccountType type = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                {
                    type = new StorageAccountType(property.Value.GetString());
                    continue;
                }
            ...
            return new StorageAccount(id.Value, type, identity.Value, status.Value);
        }
    }
}
