...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SyncStorageKeysContent>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<SyncStorageKeysContent>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(SyncStorageKeysContent)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<SyncStorageKeysContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(SyncStorageKeysContent)} does not support '{options.Format}' format.");
            }
        }
