...
{
    public partial class ContentKeyPolicyX509CertificateTokenKey : IUtf8JsonSerializable, IJsonModel<ContentKeyPolicyX509CertificateTokenKey>, IPersistableModel<ContentKeyPolicyX509CertificateTokenKey>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(RawBody))
            {
                builder.Append("  rawBody:");
                builder.AppendLine($" '{RawBody.ToString()}'");
            }
