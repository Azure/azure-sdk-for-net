...
namespace Azure.ResourceManager.Media.Models
{
    ...
    /// Please note <see cref="Audio"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    ...
    public partial class Audio : Codec
    {
        ...
        internal Audio(string odataType, string label, int? channels, int? samplingRate, int? bitrate) : base(odataType, label)
        {
            Channels = channels;
