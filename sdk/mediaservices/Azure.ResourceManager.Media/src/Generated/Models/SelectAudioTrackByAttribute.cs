...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class SelectAudioTrackByAttribute : AudioTrackDescriptor
    {
        ...
        internal SelectAudioTrackByAttribute(string odataType, ChannelMapping? channelMapping, TrackAttribute attribute, TrackAttributeFilter filter, string filterValue, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, channelMapping, serializedAdditionalRawData)
        {
            Attribute = attribute;
            Filter = filter;
