...
{
    public partial class FromEachInputFile : IUtf8JsonSerializable, IJsonModel<FromEachInputFile>, IPersistableModel<FromEachInputFile>
    {
        ...
        void IJsonModel<FromEachInputFile>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(FromEachInputFile)} does not support '{format}' format.");
            }
