...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of InputFile. </summary>
        public InputFile()
        {
        ...
        internal InputFile(string odataType, IList<TrackDescriptor> includedTracks, string filename) : base(odataType, includedTracks)
        {
            Filename = filename;
