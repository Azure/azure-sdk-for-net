...
namespace Azure.ResourceManager.Media.Models
{
    ...
    /// Please note <see cref="Image"/> is the base class. According to the scenario, a derived class of the base class might need to be assigned here, or this property needs to be casted to one of the possible derived classes.
    ...
    public partial class Image : Video
    {
        ...
        internal Image(string odataType, string label, TimeSpan? keyFrameInterval, StretchMode? stretchMode, VideoSyncMode? syncMode, string start, string step, string range) : base(odataType, label, keyFrameInterval, stretchMode, syncMode)
        {
            Start = start;
            Step = step;
            Range = range;
