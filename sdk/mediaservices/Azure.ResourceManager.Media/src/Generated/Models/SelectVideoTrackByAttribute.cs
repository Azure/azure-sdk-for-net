...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class SelectVideoTrackByAttribute : VideoTrackDescriptor
    {
        ...
        public SelectVideoTrackByAttribute(TrackAttribute attribute, AttributeFilter filter)
        {
            Attribute = attribute;
            Filter = filter;
        ...
        internal SelectVideoTrackByAttribute(string odataType, TrackAttribute attribute, AttributeFilter filter, string filterValue) : base(odataType)
        {
            Attribute = attribute;
            Filter = filter;
