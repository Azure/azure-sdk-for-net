...
namespace Azure.ResourceManager.Media.Models
{
    ...
    internal partial class StreamingLocatorListResult
    {
        ...
        internal StreamingLocatorListResult(IReadOnlyList<StreamingLocatorData> value, string odataNextLink, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Value = value;
