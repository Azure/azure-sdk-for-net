...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingPath>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingPath>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingPath>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingPath>)} interface");
            }
        ...
        string IPersistableModel<StreamingPath>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
