...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingPath>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StreamingPath)} does not support writing '{format}' format.");
            }
        ...
        StreamingPath IJsonModel<StreamingPath>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(StreamingPath)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<StreamingPath>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StreamingPath)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        StreamingPath IPersistableModel<StreamingPath>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(StreamingPath)} does not support reading '{options.Format}' format.");
            }
        }
