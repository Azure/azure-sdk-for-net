...
{
    internal partial class UnknownMediaJobInputDefinition : IUtf8JsonSerializable, IJsonModel<MediaJobInputDefinition>
    {
        ...
        internal static UnknownMediaJobInputDefinition DeserializeUnknownMediaJobInputDefinition(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            return new UnknownMediaJobInputDefinition(odataType, includedTracks ?? new ChangeTrackingList<TrackDescriptor>(), serializedAdditionalRawData);
        }
