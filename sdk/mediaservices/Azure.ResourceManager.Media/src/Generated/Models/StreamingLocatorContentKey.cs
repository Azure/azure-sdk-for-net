...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class StreamingLocatorContentKey
    {
        ...
        internal StreamingLocatorContentKey(Guid id, StreamingLocatorContentKeyType? keyType, string labelReferenceInStreamingPolicy, string value, string policyName, IReadOnlyList<MediaTrackSelection> tracks, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
            KeyType = keyType;
