...
{
    public partial class Audio : IUtf8JsonSerializable
    {
        ...
        internal static Audio DeserializeAudio(JsonElement element)
        {
            ...
            return new Audio(odataType, label.Value, Optional.ToNullable(channels), Optional.ToNullable(samplingRate), Optional.ToNullable(bitrate));
        }
    }
}
