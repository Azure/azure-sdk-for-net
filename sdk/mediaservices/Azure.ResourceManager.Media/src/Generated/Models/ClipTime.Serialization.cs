...
{
    public partial class ClipTime : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ClipTime DeserializeClipTime(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
