...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ClipTime>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ClipTime>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ClipTime>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<ClipTime>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
