...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of PresetConfigurations. </summary>
        ...
        internal PresetConfigurations(ComplexitySetting? complexity, InterleaveOutput? interleaveOutput, float? keyFrameIntervalInSeconds, int? maxBitrateBps, int? maxHeight, int? maxLayers, int? minBitrateBps, int? minHeight)
        {
        ...
        public ComplexitySetting? Complexity { get; set; }
