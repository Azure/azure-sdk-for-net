...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class PresetConfigurations
    {
        ...
        internal PresetConfigurations(Complexity? complexity, InterleaveOutput? interleaveOutput, float? keyFrameIntervalInSeconds, int? maxBitrateBps, int? maxHeight, int? maxLayers, int? minBitrateBps, int? minHeight)
        {
