...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaTransformJobInputHttp : MediaTransformJobInputClip
    {
        /// <summary> Initializes a new instance of MediaTransformJobInputHttp. </summary>
        ...
        internal MediaTransformJobInputHttp(string odataType, IList<string> files, ClipTime start, ClipTime end, string label, IList<MediaTransformJobInputDefinition> inputDefinitions, Uri baseUri) : base(odataType, files, start, end, label, inputDefinitions)
        {
            BaseUri = baseUri;
