...
namespace Azure.ResourceManager.Media
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaLiveOutputData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaLiveOutputData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaLiveOutputData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaLiveOutputData>)} interface");
            }
        ...
        string IPersistableModel<MediaLiveOutputData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
