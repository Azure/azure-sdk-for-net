...
{
    public partial class MediaLiveOutputData : IUtf8JsonSerializable, IJsonModel<MediaLiveOutputData>, IPersistableModel<MediaLiveOutputData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ArchiveWindowLength))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(ArchiveWindowLength.Value);
            ...
            if (Optional.IsDefined(RewindWindowLength))
            {
                ...
                var formattedTimeSpan = XmlConvert.ToString(RewindWindowLength.Value);
                builder.AppendLine($" '{formattedTimeSpan}'");
            }
            ...
            {
                builder.Append("  hls:");
                AppendChildObject(builder, Hls, options, 2);
            }
