...
namespace Azure.ResourceManager.Media.Models
{
    ...
    internal partial class AssetFilterCollection
    {
        /// <summary> Initializes a new instance of AssetFilterCollection. </summary>
        internal AssetFilterCollection()
        {
            Value = new ChangeTrackingList<AssetFilterData>();
        }
        ...
        internal AssetFilterCollection(IReadOnlyList<AssetFilterData> value, string odataNextLink)
        {
            Value = value;
        ...
        /// <summary> A collection of AssetFilter items. </summary>
        public IReadOnlyList<AssetFilterData> Value { get; }
