...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of JobInputClip. </summary>
        public JobInputClip()
        {
            Files = new ChangeTrackingList<string>();
            InputDefinitions = new ChangeTrackingList<InputDefinition>();
        ...
        /// </param>
        internal JobInputClip(string odataType, IList<string> files, ClipTime start, ClipTime end, string label, IList<InputDefinition> inputDefinitions) : base(odataType)
        {
            Files = files;
            Start = start;
            End = end;
        ...
        /// The available derived classes include <see cref="FromAllInputFile"/>, <see cref="FromEachInputFile"/> and <see cref="InputFile"/>.
        /// </summary>
        public IList<InputDefinition> InputDefinitions { get; }
    }
}
