...
namespace Azure.ResourceManager.Media.Models
{
    public partial class MediaJobInputs : IUtf8JsonSerializable, IJsonModel<MediaJobInputs>
    {
        ...
        void IJsonModel<MediaJobInputs>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MediaJobInputs)} does not support '{format}' format.");
            }
            ...
            if (Optional.IsCollectionDefined(Inputs))
            {
                ...
                foreach (var item in Inputs)
                {
                    if (item != null)
                    {
                        ((IJsonModel<MediaJobInputBasicProperties>)item).Write(writer, options);
                    }
                    else
                    {
