...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaJobInputs>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaJobInputs>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaJobInputs>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaJobInputs>)} interface");
            }
        ...
        string IPersistableModel<MediaJobInputs>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
