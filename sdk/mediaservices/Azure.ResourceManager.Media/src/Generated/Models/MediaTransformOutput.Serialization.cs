...
{
    public partial class MediaTransformOutput : IUtf8JsonSerializable, IJsonModel<MediaTransformOutput>, IPersistableModel<MediaTransformOutput>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OnError))
            {
                ...
                builder.AppendLine($" '{OnError.ToString()}'");
            }

            if (Optional.IsDefined(RelativePriority))
            {
                builder.Append("  relativePriority:");
                builder.AppendLine($" '{RelativePriority.ToString()}'");
            }

            if (Optional.IsDefined(Preset))
            {
                builder.Append("  preset:");
                AppendChildObject(builder, Preset, options, 2);
            }
