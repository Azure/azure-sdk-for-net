...
namespace Azure.ResourceManager.Media.Models
{
    public partial class Image : IUtf8JsonSerializable
    {
        ...
        internal static Image DeserializeImage(JsonElement element)
        {
            ...
            return new Image(odataType, label.Value, Optional.ToNullable(keyFrameInterval), Optional.ToNullable(stretchMode), Optional.ToNullable(syncMode), start, step.Value, range.Value);
        }
    }
}
