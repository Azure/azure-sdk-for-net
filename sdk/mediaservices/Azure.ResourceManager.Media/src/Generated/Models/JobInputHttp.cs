...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of JobInputHttp. </summary>
        public JobInputHttp()
        {
        ...
        internal JobInputHttp(string odataType, IList<string> files, ClipTime start, ClipTime end, string label, IList<InputDefinition> inputDefinitions, Uri baseUri) : base(odataType, files, start, end, label, inputDefinitions)
        {
            BaseUri = baseUri;
