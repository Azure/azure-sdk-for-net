...
{
    public partial class AudioAnalyzerPreset : IUtf8JsonSerializable, IJsonModel<AudioAnalyzerPreset>, IPersistableModel<AudioAnalyzerPreset>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AudioLanguage))
            {
                builder.Append("  audioLanguage:");
                builder.AppendLine($" '{AudioLanguage}'");
            }
