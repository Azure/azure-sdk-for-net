...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AudioAnalyzerPreset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AudioAnalyzerPreset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AudioAnalyzerPreset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AudioAnalyzerPreset>)} interface");
            }
        ...
        string IPersistableModel<AudioAnalyzerPreset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
