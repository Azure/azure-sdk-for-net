...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        /// <summary> Initializes a new instance of AssetFileEncryptionMetadata. </summary>
        /// <param name="assetFileId"> The Asset File Id. </param>
        internal AssetFileEncryptionMetadata(Guid assetFileId)
        {
        ...
        /// <param name="assetFileId"> The Asset File Id. </param>
        internal AssetFileEncryptionMetadata(string initializationVector, string assetFileName, Guid assetFileId)
        {
