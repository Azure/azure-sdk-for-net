...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SelectAudioTrackById>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SelectAudioTrackById>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SelectAudioTrackById>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SelectAudioTrackById>)} interface");
            }
        ...
        string IPersistableModel<SelectAudioTrackById>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
