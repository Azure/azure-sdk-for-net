...
namespace Azure.ResourceManager.Media.Models
{
    internal partial class UnknownJobInput : IUtf8JsonSerializable, IJsonModel<MediaJobInputBasicProperties>
    {
        ...
        void IJsonModel<MediaJobInputBasicProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(MediaJobInputBasicProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<MediaJobInputBasicProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(MediaJobInputBasicProperties)} does not support '{options.Format}' format.");
            }
        }
