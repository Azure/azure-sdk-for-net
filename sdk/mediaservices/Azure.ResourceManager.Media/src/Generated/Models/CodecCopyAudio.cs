...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class CodecCopyAudio : MediaCodecBase
    {
        ...
        internal CodecCopyAudio(string odataType, string label, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, label, serializedAdditionalRawData)
        {
