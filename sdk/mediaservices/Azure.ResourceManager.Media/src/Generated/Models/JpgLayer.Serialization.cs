...
{
    public partial class JpgLayer : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static JpgLayer DeserializeJpgLayer(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
