...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<JpgLayer>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<JpgLayer>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<JpgLayer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<JpgLayer>)} interface");
            }
        ...
        string IPersistableModel<JpgLayer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
