...
{
    public partial class MediaTransformJobOutput : IUtf8JsonSerializable
    {
        ...
        internal static MediaTransformJobOutput DeserializeMediaTransformJobOutput(JsonElement element)
        {
            if (element.TryGetProperty("@odata.type", out JsonElement discriminator))
            {
                switch (discriminator.GetString())
                {
                    case "#Microsoft.Media.JobOutputAsset": return MediaTransformJobOutputAsset.DeserializeMediaTransformJobOutputAsset(element);
                }
            }
