...
{
    public partial class StreamingPolicyData : IUtf8JsonSerializable, IJsonModel<StreamingPolicyData>, IPersistableModel<StreamingPolicyData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EnvelopeEncryption))
            {
                builder.Append("  envelopeEncryption:");
                AppendChildObject(builder, EnvelopeEncryption, options, 2);
            }

            if (Optional.IsDefined(CommonEncryptionCenc))
            {
                builder.Append("  commonEncryptionCenc:");
                AppendChildObject(builder, CommonEncryptionCenc, options, 2);
            }

            if (Optional.IsDefined(CommonEncryptionCbcs))
            {
                builder.Append("  commonEncryptionCbcs:");
                AppendChildObject(builder, CommonEncryptionCbcs, options, 2);
            }

            if (Optional.IsDefined(NoEncryption))
            {
                builder.Append("  noEncryption:");
                AppendChildObject(builder, NoEncryption, options, 2);
            }
