...
namespace Azure.ResourceManager.Media.Models
{
    ...
    internal partial class UnknownMediaTransformJobOutput : MediaTransformJobOutput
    {
        ...
        internal UnknownMediaTransformJobOutput(string odataType, MediaTransformJobError error, MediaTransformPreset presetOverride, JobState? state, int? progress, string label, DateTimeOffset? startsOn, DateTimeOffset? endsOn) : base(odataType, error, presetOverride, state, progress, label, startsOn, endsOn)
        {
