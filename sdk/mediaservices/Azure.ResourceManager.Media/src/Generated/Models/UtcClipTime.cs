...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class UtcClipTime : ClipTime
    {
        ...
        internal UtcClipTime(string odataType, DateTimeOffset time, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            Time = time;
