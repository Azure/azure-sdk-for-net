...
{
    public partial class Format : IUtf8JsonSerializable
    {
        ...
        internal static Format DeserializeFormat(JsonElement element)
        {
            ...
            return new Format(odataType, filenamePattern);
        }
    }
}
