...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class TransportStreamFormat : MultiBitrateFormat
    {
        ...
        internal TransportStreamFormat(string odataType, string filenamePattern, IList<MediaOutputFile> outputFiles, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, filenamePattern, outputFiles, serializedAdditionalRawData)
        {
