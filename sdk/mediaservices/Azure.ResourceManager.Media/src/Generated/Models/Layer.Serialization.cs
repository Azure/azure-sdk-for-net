...
{
    public partial class Layer : IUtf8JsonSerializable
    {
        ...
        internal static Layer DeserializeLayer(JsonElement element)
        {
            ...
            return new Layer(width.Value, height.Value, label.Value);
        }
    }
}
