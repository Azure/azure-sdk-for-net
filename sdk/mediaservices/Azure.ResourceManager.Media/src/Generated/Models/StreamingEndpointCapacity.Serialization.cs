...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        internal static StreamingEndpointCapacity DeserializeStreamingEndpointCapacity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
