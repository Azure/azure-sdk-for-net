...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VideoTrackDescriptor>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VideoTrackDescriptor>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VideoTrackDescriptor>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<VideoTrackDescriptor>)} interface");
            }
        ...
        string IPersistableModel<VideoTrackDescriptor>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
