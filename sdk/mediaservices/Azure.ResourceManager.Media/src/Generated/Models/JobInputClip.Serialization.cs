...
{
    public partial class JobInputClip : IUtf8JsonSerializable
    {
        ...
        internal static JobInputClip DeserializeJobInputClip(JsonElement element)
        {
            ...
            return new JobInputClip(odataType, Optional.ToList(files), start.Value, end.Value, label.Value, Optional.ToList(inputDefinitions));
        }
    }
}
