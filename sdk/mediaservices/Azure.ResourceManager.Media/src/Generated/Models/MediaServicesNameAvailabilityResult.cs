...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class MediaServicesNameAvailabilityResult
    {
        ...
        internal MediaServicesNameAvailabilityResult(bool isNameAvailable, string reason, string message, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IsNameAvailable = isNameAvailable;
            Reason = reason;
            Message = message;
