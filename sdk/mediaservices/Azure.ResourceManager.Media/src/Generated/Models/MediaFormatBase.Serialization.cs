...
{
    public partial class MediaFormatBase : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MediaFormatBase DeserializeMediaFormatBase(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
