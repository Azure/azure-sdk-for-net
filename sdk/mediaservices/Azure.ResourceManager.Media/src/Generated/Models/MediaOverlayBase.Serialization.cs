...
{
    public partial class MediaOverlayBase : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MediaOverlayBase DeserializeMediaOverlayBase(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
