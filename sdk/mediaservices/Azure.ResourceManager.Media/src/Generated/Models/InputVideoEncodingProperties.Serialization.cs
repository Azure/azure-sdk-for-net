...
{
    public partial class InputVideoEncodingProperties : IUtf8JsonSerializable
    {
        ...
        internal static InputVideoEncodingProperties DeserializeInputVideoEncodingProperties(JsonElement element)
        {
            ...
            return new InputVideoEncodingProperties(odataType, label.Value, Optional.ToNullable(keyFrameInterval), Optional.ToNullable(stretchMode), Optional.ToNullable(syncMode));
        }
    }
}
