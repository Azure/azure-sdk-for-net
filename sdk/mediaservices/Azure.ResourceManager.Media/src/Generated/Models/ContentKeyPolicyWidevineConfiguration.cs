...
namespace Azure.ResourceManager.Media.Models
{
    ...
    public partial class ContentKeyPolicyWidevineConfiguration : ContentKeyPolicyConfiguration
    {
        ...
        internal ContentKeyPolicyWidevineConfiguration(string odataType, string widevineTemplate, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(odataType, serializedAdditionalRawData)
        {
            WidevineTemplate = widevineTemplate;
