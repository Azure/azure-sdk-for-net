...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<StreamingPolicyContentKey>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<StreamingPolicyContentKey>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<StreamingPolicyContentKey>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<StreamingPolicyContentKey>)} interface");
            }
        ...
        string IPersistableModel<StreamingPolicyContentKey>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
