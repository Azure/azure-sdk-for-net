...
{
    public partial class MediaLayerBase : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MediaLayerBase DeserializeMediaLayerBase(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
