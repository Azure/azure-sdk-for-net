...
namespace Azure.ResourceManager.Media.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MediaLayerBase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MediaLayerBase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MediaLayerBase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MediaLayerBase>)} interface");
            }
        ...
        string IPersistableModel<MediaLayerBase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
