...
{
    public partial class JpgImage : IUtf8JsonSerializable, IJsonModel<JpgImage>, IPersistableModel<JpgImage>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SpriteColumn))
            {
                builder.Append("  spriteColumn:");
                builder.AppendLine($" '{SpriteColumn.Value.ToString()}'");
            }
