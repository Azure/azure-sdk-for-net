...
{
    public partial class JpgImage : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static JpgImage DeserializeJpgImage(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
