...
namespace Azure.ResourceManager.Media
{
    ...
    public partial class MediaServicesOperationResultCollection : ArmCollection
    {
        ...
        public virtual async Task<Response<MediaServicesOperationResultResource>> GetAsync(string locationName, string operationId, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="locationName"/> or <paramref name="operationId"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="locationName"/> or <paramref name="operationId"/> is null. </exception>
        public virtual Response<MediaServicesOperationResultResource> Get(string locationName, string operationId, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(locationName, nameof(locationName));
            Argument.AssertNotNullOrEmpty(operationId, nameof(operationId));
