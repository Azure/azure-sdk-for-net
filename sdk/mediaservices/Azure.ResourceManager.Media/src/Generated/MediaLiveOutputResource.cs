...
namespace Azure.ResourceManager.Media
{
    ...
    public partial class MediaLiveOutputResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _mediaLiveOutputLiveOutputsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = await _mediaLiveOutputLiveOutputsRestClient.DeleteAsync(message, cancellationToken).ConfigureAwait(false);
                var operation = new MediaArmOperation(_mediaLiveOutputLiveOutputsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var message = _mediaLiveOutputLiveOutputsRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name);
                var response = _mediaLiveOutputLiveOutputsRestClient.Delete(message, cancellationToken);
                var operation = new MediaArmOperation(_mediaLiveOutputLiveOutputsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<MediaLiveOutputResource>> UpdateAsync(WaitUntil waitUntil, MediaLiveOutputData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                using var message = _mediaLiveOutputLiveOutputsRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, data);
