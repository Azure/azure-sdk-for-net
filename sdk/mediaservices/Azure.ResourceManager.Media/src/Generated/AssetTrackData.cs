...
namespace Azure.ResourceManager.Media
{
    ...
    public partial class AssetTrackData : ResourceData
    {
        ...
        internal AssetTrackData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TrackBase track, ProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
            Track = track;
