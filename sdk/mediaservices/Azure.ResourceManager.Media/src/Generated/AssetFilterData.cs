...
{
    /// <summary> A class representing the AssetFilter data model. </summary>
    public partial class AssetFilterData : ResourceData
    {
        /// <summary> Initializes a new instance of AssetFilterData. </summary>
        ...
        internal AssetFilterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, PresentationTimeRange presentationTimeRange, FirstQuality firstQuality, IList<FilterTrackSelection> tracks) : base(id, name, resourceType, systemData)
        {
