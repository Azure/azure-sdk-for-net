...
namespace Azure.ResourceManager.Media
{
    ...
    /// If you have a <see cref="ResourceIdentifier" /> you can construct a <see cref="MediaServicesAccountFilterResource" />
    /// from an instance of <see cref="ArmClient" /> using the GetMediaServicesAccountFilterResource method.
    /// Otherwise you can get one from its parent resource <see cref="MediaServicesAccountResource" /> using the GetMediaServicesAccountFilter method.
    /// </summary>
    public partial class MediaServicesAccountFilterResource : ArmResource
    {
        /// <summary> Generate the resource identifier of a <see cref="MediaServicesAccountFilterResource"/> instance. </summary>
        ...
        private readonly MediaServicesAccountFilterData _data;

        /// <summary> Initializes a new instance of the <see cref="MediaServicesAccountFilterResource"/> class for mocking. </summary>
        ...
        internal MediaServicesAccountFilterResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            _mediaServicesAccountFilterAccountFiltersClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.Media", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string mediaServicesAccountFilterAccountFiltersApiVersion);
        ...
        public virtual MediaServicesAccountFilterData Data
        {
            get
            {
                if (!HasData)
        ...
        public virtual async Task<Response<MediaServicesAccountFilterResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            using var scope = _mediaServicesAccountFilterAccountFiltersClientDiagnostics.CreateScope("MediaServicesAccountFilterResource.Get");
            scope.Start();
            try
            {
        ...
        /// </summary>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<MediaServicesAccountFilterResource> Get(CancellationToken cancellationToken = default)
        {
            using var scope = _mediaServicesAccountFilterAccountFiltersClientDiagnostics.CreateScope("MediaServicesAccountFilterResource.Get");
            scope.Start();
            try
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>AccountFilters_Delete</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using var scope = _mediaServicesAccountFilterAccountFiltersClientDiagnostics.CreateScope("MediaServicesAccountFilterResource.Delete");
            scope.Start();
            try
            {
                var response = await _mediaServicesAccountFilterAccountFiltersRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _mediaServicesAccountFilterAccountFiltersRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new MediaArmOperation(response);
                if (waitUntil == WaitUntil.Completed)
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>AccountFilters_Update</description>
        /// </item>
        /// </list>
        /// </summary>
