...
#pragma warning disable SA1649 // File name should match first type name
    internal class MediaArmOperation : ArmOperation
#pragma warning restore SA1649 // File name should match first type name
    {
        private readonly OperationInternal _operation;

        /// <summary> Initializes a new instance of MediaArmOperation for mocking. </summary>
        protected MediaArmOperation()
        {
        }
        ...
        internal MediaArmOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = false, string apiVersionOverrideValue = null)
        {
