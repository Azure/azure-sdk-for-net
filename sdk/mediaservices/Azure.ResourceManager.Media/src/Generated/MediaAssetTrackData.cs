...
namespace Azure.ResourceManager.Media
{
    ...
    public partial class MediaAssetTrackData : ResourceData
    {
        ...
        /// <summary> Initializes a new instance of <see cref="MediaAssetTrackData"/>. </summary>
        ...
        internal MediaAssetTrackData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, MediaAssetTrackBase track, MediaServicesProvisioningState? provisioningState, IDictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Track = track;
