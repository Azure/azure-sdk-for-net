...
namespace Azure.ResourceManager.Media
{
    ...
    public partial class MediaAssetTrackData : ResourceData
    {
        ...
        internal MediaAssetTrackData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, TrackBase track, MediaServicesProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
            Track = track;
