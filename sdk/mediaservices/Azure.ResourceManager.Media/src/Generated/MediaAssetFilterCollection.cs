...
namespace Azure.ResourceManager.Media
{
    ...
    public partial class MediaAssetFilterCollection : ArmCollection, IEnumerable<MediaAssetFilterResource>, IAsyncEnumerable<MediaAssetFilterResource>
    {
        ...
        {
            async Task<Page<MediaAssetFilterResource>> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _mediaAssetFilterAssetFiltersClientDiagnostics.CreateScope("MediaAssetFilterCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _mediaAssetFilterAssetFiltersRestClient.ListAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MediaAssetFilterResource(Client, value)), response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
            ...
            async Task<Page<MediaAssetFilterResource>> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _mediaAssetFilterAssetFiltersClientDiagnostics.CreateScope("MediaAssetFilterCollection.GetAll");
                scope.Start();
                try
                {
                    var response = await _mediaAssetFilterAssetFiltersRestClient.ListNextPageAsync(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken).ConfigureAwait(false);
                    return Page.FromValues(response.Value.Value.Select(value => new MediaAssetFilterResource(Client, value)), response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
        ...
        {
            Page<MediaAssetFilterResource> FirstPageFunc(int? pageSizeHint)
            {
                using var scope = _mediaAssetFilterAssetFiltersClientDiagnostics.CreateScope("MediaAssetFilterCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _mediaAssetFilterAssetFiltersRestClient.List(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MediaAssetFilterResource(Client, value)), response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
            ...
            Page<MediaAssetFilterResource> NextPageFunc(string nextLink, int? pageSizeHint)
            {
                using var scope = _mediaAssetFilterAssetFiltersClientDiagnostics.CreateScope("MediaAssetFilterCollection.GetAll");
                scope.Start();
                try
                {
                    var response = _mediaAssetFilterAssetFiltersRestClient.ListNextPage(nextLink, Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken: cancellationToken);
                    return Page.FromValues(response.Value.Value.Select(value => new MediaAssetFilterResource(Client, value)), response.Value.OdataNextLink, response.GetRawResponse());
                }
                catch (Exception e)
                {
