...
namespace Azure.ResourceManager.Media
{
    ...
    public partial class JobData : ResourceData
    {
        ...
        /// <param name="created"> The UTC date and time when the customer has created the Job, in &apos;YYYY-MM-DDThh:mm:ssZ&apos; format. </param>
        ...
        /// </param>
        /// <param name="lastModified"> The UTC date and time when the customer has last updated the Job, in &apos;YYYY-MM-DDThh:mm:ssZ&apos; format. </param>
        /// <param name="outputs">
        ...
        internal JobData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DateTimeOffset? created, JobState? state, string description, JobInput input, DateTimeOffset? lastModified, IList<JobOutput> outputs, Priority? priority, IDictionary<string, string> correlationData, DateTimeOffset? startOn, DateTimeOffset? endOn) : base(id, name, resourceType, systemData)
        {
            Created = created;
            State = state;
