...
{
    /// <summary> A class representing the LiveOutput data model. </summary>
    public partial class LiveOutputData : ResourceData
    {
        /// <summary> Initializes a new instance of LiveOutputData. </summary>
        ...
        internal LiveOutputData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, string assetName, TimeSpan? archiveWindowLength, TimeSpan? rewindWindowLength, string manifestName, Hls httpLiveStreaming, long? outputSnapTime, DateTimeOffset? createdOn, DateTimeOffset? lastModifiedOn, string provisioningState, LiveOutputResourceState? resourceState) : base(id, name, resourceType, systemData)
        {
