...
namespace Azure.Media.Analytics.Edge.Models
{
    ...
    public partial class ExtensionProcessorBase : Processor
    {
        ...
        public ExtensionProcessorBase(string name, IEnumerable<NodeInput> inputs, Endpoint endpoint, Image image) : base(name, inputs)
        {
            if (name == null)
            {
        ...
        internal ExtensionProcessorBase(string type, string name, IList<NodeInput> inputs, Endpoint endpoint, Image image, SamplingOptions samplingOptions) : base(type, name, inputs)
        {
            Endpoint = endpoint;
            Image = image;
