...
namespace Azure.Media.Analytics.Edge.Models
{
    ...
    {
        /// <summary> Initializes a new instance of Processor. </summary>
        ...
        public Processor(string name, IEnumerable<NodeInput> inputs)
        {
            if (name == null)
            {
        ...
        /// <param name="name"> The name for this processor node. </param>
        /// <param name="inputs"> An array of the names of the other nodes in the topology, the outputs of which are used as input for this processor node. </param>
        internal Processor(string type, string name, IList<NodeInput> inputs)
        {
            Type = type;
            Name = name;
            Inputs = inputs;
