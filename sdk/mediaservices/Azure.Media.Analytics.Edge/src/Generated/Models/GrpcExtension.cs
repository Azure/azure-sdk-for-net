...
namespace Azure.Media.Analytics.Edge.Models
{
    ...
    public partial class GrpcExtension : ExtensionProcessorBase
    {
        ...
        public GrpcExtension(string name, IEnumerable<NodeInput> inputs, Endpoint endpoint, Image image, GrpcExtensionDataTransfer dataTransfer) : base(name, inputs, endpoint, image)
        {
            if (name == null)
            {
        ...
        internal GrpcExtension(string type, string name, IList<NodeInput> inputs, Endpoint endpoint, Image image, SamplingOptions samplingOptions, GrpcExtensionDataTransfer dataTransfer, string extensionConfiguration) : base(type, name, inputs, endpoint, image, samplingOptions)
        {
            DataTransfer = dataTransfer;
