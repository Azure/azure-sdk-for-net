...
{
    public partial class CognitiveServicesVisionExtension : IUtf8JsonSerializable
    {
        ...
        internal static CognitiveServicesVisionExtension DeserializeCognitiveServicesVisionExtension(JsonElement element)
        {
            ...
            return new CognitiveServicesVisionExtension(type, name, inputs, endpoint, image, samplingOptions.Value, extensionConfiguration.Value);
        }
    }
}
