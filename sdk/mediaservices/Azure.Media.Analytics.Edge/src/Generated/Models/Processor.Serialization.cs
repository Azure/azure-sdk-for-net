...
{
    public partial class Processor : IUtf8JsonSerializable
    {
        ...
        internal static Processor DeserializeProcessor(JsonElement element)
        {
            ...
            return new Processor(type, name, inputs);
        }
    }
}
