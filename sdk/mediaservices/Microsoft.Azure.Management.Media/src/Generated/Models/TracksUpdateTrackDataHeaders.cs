...
namespace Microsoft.Azure.Management.Media.Models
{
    ...
    /// </summary>
    public partial class TracksUpdateTrackDataHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TracksUpdateTrackDataHeaders
        /// class.
        /// </summary>
        ...
        /// status.</param>
        public TracksUpdateTrackDataHeaders(int? retryAfter = default(int?), string location = default(string), string azureAsyncOperation = default(string))
        {
