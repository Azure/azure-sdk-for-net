...
namespace Microsoft.Azure.Management.Media.Models
{
    ...
    /// </summary>
    public partial class TracksCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the TracksCreateOrUpdateHeaders
        /// class.
        /// </summary>
        public TracksCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public TracksCreateOrUpdateHeaders(int? retryAfter = default(int?), string location = default(string), string azureAsyncOperation = default(string))
        {
