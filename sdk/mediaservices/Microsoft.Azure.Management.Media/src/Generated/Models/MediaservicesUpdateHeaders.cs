...
namespace Microsoft.Azure.Management.Media.Models
{
    ...
    /// </summary>
    public partial class MediaservicesUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the MediaservicesUpdateHeaders class.
        /// </summary>
        public MediaservicesUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public MediaservicesUpdateHeaders(int? retryAfter = default(int?), string location = default(string), string azureAsyncOperation = default(string))
        {
