...
namespace Microsoft.Azure.Management.Media.Models
{
    ...
    public partial class PrivateLinkServiceConnectionState
    {
        ...
        public PrivateLinkServiceConnectionState(PrivateEndpointServiceConnectionStatus? status = default(PrivateEndpointServiceConnectionStatus?), string description = default(string), string actionsRequired = default(string))
        {
            Status = status;
