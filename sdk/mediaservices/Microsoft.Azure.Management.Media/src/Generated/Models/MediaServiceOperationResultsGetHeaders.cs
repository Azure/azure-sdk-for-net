...
namespace Microsoft.Azure.Management.Media.Models
{
    ...
    /// </summary>
    public partial class MediaServiceOperationResultsGetHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// MediaServiceOperationResultsGetHeaders class.
        /// </summary>
        public MediaServiceOperationResultsGetHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public MediaServiceOperationResultsGetHeaders(int? retryAfter = default(int?), string location = default(string), string azureAsyncOperation = default(string))
        {
