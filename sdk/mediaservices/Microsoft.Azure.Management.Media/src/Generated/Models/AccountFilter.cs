...
namespace Microsoft.Azure.Management.Media.Models
{
    ...
    public partial class AccountFilter : ProxyResource
    {
        ...
        public AccountFilter(string id = default(string), string name = default(string), string type = default(string), PresentationTimeRange presentationTimeRange = default(PresentationTimeRange), FirstQuality firstQuality = default(FirstQuality), IList<FilterTrackSelection> tracks = default(IList<FilterTrackSelection>))
            : base(id, name, type)
        {
