...
namespace Microsoft.Azure.Management.Media.Models
{
    ...
    /// </summary>
    public partial class MediaservicesCreateOrUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// MediaservicesCreateOrUpdateHeaders class.
        /// </summary>
        public MediaservicesCreateOrUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// status.</param>
        public MediaservicesCreateOrUpdateHeaders(int? retryAfter = default(int?), string location = default(string), string azureAsyncOperation = default(string))
        {
