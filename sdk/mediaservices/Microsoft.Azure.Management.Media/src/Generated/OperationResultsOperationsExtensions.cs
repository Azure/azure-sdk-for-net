...
namespace Microsoft.Azure.Management.Media
{
    ...
    public static partial class OperationResultsOperationsExtensions
    {
            ...
            /// Operation Id.
            /// </param>
            public static AssetTrack Get(this IOperationResultsOperations operations, string resourceGroupName, string accountName, string assetName, string trackName, string operationId)
            {
            ...
            /// </param>
            public static async Task<AssetTrack> GetAsync(this IOperationResultsOperations operations, string resourceGroupName, string accountName, string assetName, string trackName, string operationId, CancellationToken cancellationToken = default(CancellationToken))
            {
