...
namespace Microsoft.Azure.Management.DnsResolver.Models
{
    ...
    public partial class DnsResolverModel : TrackedResource
    {
        ...
        public DnsResolverModel(string location, SubResource virtualNetwork, string id = default(string), string name = default(string), string type = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), string etag = default(string), string dnsResolverState = default(string), string provisioningState = default(string), string resourceGuid = default(string), SystemData systemData = default(SystemData))
