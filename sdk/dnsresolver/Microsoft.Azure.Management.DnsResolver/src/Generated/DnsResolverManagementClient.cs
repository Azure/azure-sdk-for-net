...
namespace Microsoft.Azure.Management.DnsResolver
{
    ...
    public partial class DnsResolverManagementClient : ServiceClient<DnsResolverManagementClient>, IDnsResolverManagementClient, IAzureClient
    {
        ...
        /// </summary>
        public virtual IOutboundEndpointsOperations OutboundEndpoints { get; private set; }

        /// <summary>
        /// Gets the IDnsForwardingRulesetsOperations.
        /// </summary>
        public virtual IDnsForwardingRulesetsOperations DnsForwardingRulesets { get; private set; }

        /// <summary>
        /// Gets the IForwardingRulesOperations.
        /// </summary>
        public virtual IForwardingRulesOperations ForwardingRules { get; private set; }
        ...
        protected DnsResolverManagementClient(HttpClient httpClient, bool disposeHttpClient) : base(httpClient, disposeHttpClient)
        {
            Initialize();
        }
        ...
        /// </param>
        protected DnsResolverManagementClient(params DelegatingHandler[] handlers) : base(handlers)
        {
            Initialize();
        }
        ...
        /// Optional. The delegating handlers to add to the http client pipeline.
        /// </param>
        protected DnsResolverManagementClient(HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : base(rootHandler, handlers)
        {
            Initialize();
        }
        ...
        /// </exception>
        protected DnsResolverManagementClient(System.Uri baseUri, params DelegatingHandler[] handlers) : this(handlers)
        {
            if (baseUri == null)
            {
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        protected DnsResolverManagementClient(System.Uri baseUri, HttpClientHandler rootHandler, params DelegatingHandler[] handlers) : this(rootHandler, handlers)
        {
            if (baseUri == null)
            {
                throw new System.ArgumentNullException("baseUri");
        ...
        private void Initialize()
        {
            ...
            OutboundEndpoints = new OutboundEndpointsOperations(this);
            DnsForwardingRulesets = new DnsForwardingRulesetsOperations(this);
            ForwardingRules = new ForwardingRulesOperations(this);
