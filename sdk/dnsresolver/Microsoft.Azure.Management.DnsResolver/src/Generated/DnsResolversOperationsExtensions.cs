...
namespace Microsoft.Azure.Management.DnsResolver
{
    ...
    public static partial class DnsResolversOperationsExtensions
    {
            ...
            /// 100 results.
            /// </param>
            public static IPage<SubResource> ListByVirtualNetwork(this IDnsResolversOperations operations, string resourceGroupName, string virtualNetworkName, int? top = default(int?))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<SubResource>> ListByVirtualNetworkAsync(this IDnsResolversOperations operations, string resourceGroupName, string virtualNetworkName, int? top = default(int?), CancellationToken cancellationToken = default(CancellationToken))
            {
            ...
            /// The NextLink from the previous successful call to List operation.
            /// </param>
            public static IPage<SubResource> ListByVirtualNetworkNext(this IDnsResolversOperations operations, string nextPageLink)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IPage<SubResource>> ListByVirtualNetworkNextAsync(this IDnsResolversOperations operations, string nextPageLink, CancellationToken cancellationToken = default(CancellationToken))
            {
