...
namespace Microsoft.Azure.Management.DnsResolver
{
    ...
    public partial interface IInboundEndpointsOperations
    {
        ...
        /// </exception>
        Task<AzureOperationResponse<InboundEndpoint>> CreateOrUpdateWithHttpMessagesAsync(string resourceGroupName, string dnsResolverName, string inboundEndpointName, InboundEndpoint parameters, string ifMatch = default(string), string ifNoneMatch = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<InboundEndpoint>> UpdateWithHttpMessagesAsync(string resourceGroupName, string dnsResolverName, string inboundEndpointName, string ifMatch = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        ...
        /// Thrown when a required parameter is null
        /// </exception>
        Task<AzureOperationResponse<InboundEndpoint>> BeginUpdateWithHttpMessagesAsync(string resourceGroupName, string dnsResolverName, string inboundEndpointName, string ifMatch = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Deletes an inbound endpoint for a DNS resolver. WARNING: This
        /// operation cannot be undone.
        /// </summary>
