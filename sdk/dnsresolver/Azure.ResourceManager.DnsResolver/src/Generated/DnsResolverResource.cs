...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    public partial class DnsResolverResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DnsResolverResource>> UpdateAsync(WaitUntil waitUntil, DnsResolverData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dnsResolversRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, DnsResolverData.ToRequestContent(data), matchConditions, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DnsResolverArmOperation<DnsResolverResource> operation = new DnsResolverArmOperation<DnsResolverResource>(
                    new DnsResolverResourceOperationSource(Client),
                    _dnsResolversClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DnsResolverResource> Update(WaitUntil waitUntil, DnsResolverData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
