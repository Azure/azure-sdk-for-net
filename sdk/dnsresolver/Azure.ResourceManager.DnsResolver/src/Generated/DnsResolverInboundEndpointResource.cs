...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    public partial class DnsResolverInboundEndpointResource : ArmResource
    {
        ...
        internal DnsResolverInboundEndpointResource(ArmClient client, DnsResolverInboundEndpointData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<DnsResolverInboundEndpointResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new DnsResolverInboundEndpointResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
