...
{
    /// <summary></summary>
    internal partial class DnsSecurityRuleResourceOperationSource : IOperationSource<DnsSecurityRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DnsSecurityRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
