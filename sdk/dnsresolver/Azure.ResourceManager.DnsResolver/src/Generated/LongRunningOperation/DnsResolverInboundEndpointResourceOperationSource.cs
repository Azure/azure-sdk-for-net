...
{
    /// <summary></summary>
    internal partial class DnsResolverInboundEndpointResourceOperationSource : IOperationSource<DnsResolverInboundEndpointResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DnsResolverInboundEndpointResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
