...
{
    /// <summary></summary>
    internal partial class DnsResolverResourceOperationSource : IOperationSource<DnsResolverResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DnsResolverResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
