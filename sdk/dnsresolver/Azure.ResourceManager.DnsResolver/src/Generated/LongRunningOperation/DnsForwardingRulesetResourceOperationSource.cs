...
{
    /// <summary></summary>
    internal partial class DnsForwardingRulesetResourceOperationSource : IOperationSource<DnsForwardingRulesetResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DnsForwardingRulesetResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
