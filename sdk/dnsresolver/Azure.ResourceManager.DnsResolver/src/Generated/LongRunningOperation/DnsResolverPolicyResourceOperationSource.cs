...
{
    /// <summary></summary>
    internal partial class DnsResolverPolicyResourceOperationSource : IOperationSource<DnsResolverPolicyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DnsResolverPolicyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
