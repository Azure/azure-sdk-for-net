...
{
    /// <summary></summary>
    internal partial class DnsResolverDomainListResourceOperationSource : IOperationSource<DnsResolverDomainListResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DnsResolverDomainListResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
