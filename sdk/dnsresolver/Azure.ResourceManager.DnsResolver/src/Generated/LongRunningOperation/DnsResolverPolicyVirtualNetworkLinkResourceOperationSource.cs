...
{
    /// <summary></summary>
    internal partial class DnsResolverPolicyVirtualNetworkLinkResourceOperationSource : IOperationSource<DnsResolverPolicyVirtualNetworkLinkResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal DnsResolverPolicyVirtualNetworkLinkResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
