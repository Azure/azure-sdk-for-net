...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    public partial class DnsForwardingRulesetVirtualNetworkLinkResource : ArmResource
    {
        ...
        internal DnsForwardingRulesetVirtualNetworkLinkResource(ArmClient client, DnsForwardingRulesetVirtualNetworkLinkData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
