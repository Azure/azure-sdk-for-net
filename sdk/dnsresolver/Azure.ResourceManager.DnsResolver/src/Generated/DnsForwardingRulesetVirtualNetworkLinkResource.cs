...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    public partial class DnsForwardingRulesetVirtualNetworkLinkResource : ArmResource
    {
        ...
        /// <summary>
        /// Updates the DnsForwardingRulesetVirtualNetworkLink.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/dnsForwardingRulesets/{dnsForwardingRulesetName}/virtualNetworkLinks/{virtualNetworkLinkName}. </description>
        ...
        public virtual async Task<ArmOperation<DnsForwardingRulesetVirtualNetworkLinkResource>> UpdateAsync(WaitUntil waitUntil, DnsForwardingRulesetVirtualNetworkLinkData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _virtualNetworkLinksRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, DnsForwardingRulesetVirtualNetworkLinkData.ToRequestContent(data), matchConditions, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DnsResolverArmOperation<DnsForwardingRulesetVirtualNetworkLinkResource> operation = new DnsResolverArmOperation<DnsForwardingRulesetVirtualNetworkLinkResource>(
                    new DnsForwardingRulesetVirtualNetworkLinkResourceOperationSource(Client),
                    _virtualNetworkLinksClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DnsForwardingRulesetVirtualNetworkLinkResource> Update(WaitUntil waitUntil, DnsForwardingRulesetVirtualNetworkLinkData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
