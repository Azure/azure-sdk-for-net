...
namespace Azure.ResourceManager.DnsResolver.Models
{
    ...
    {
        internal static OutboundEndpointListResult DeserializeOutboundEndpointListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
