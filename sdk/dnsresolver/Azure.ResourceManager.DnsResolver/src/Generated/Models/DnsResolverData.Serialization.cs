...
namespace Azure.ResourceManager.DnsResolver
{
    public partial class DnsResolverData : IUtf8JsonSerializable, IJsonModel<DnsResolverData>
    {
        ...
        void IJsonModel<DnsResolverData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DnsResolverData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DnsResolverData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DnsResolverData)} does not support '{options.Format}' format.");
            }
        }
