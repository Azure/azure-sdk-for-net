...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsResolverData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsResolverData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsResolverData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<DnsResolverData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
