...
namespace Azure.ResourceManager.DnsResolver
{
    public partial class DnsResolverData : IUtf8JsonSerializable
    {
        ...
        internal static DnsResolverData DeserializeDnsResolverData(JsonElement element)
        {
            ...
            return new DnsResolverData(id, name, type, systemData, tags, location, Optional.ToNullable(etag), virtualNetwork, Optional.ToNullable(dnsResolverState), Optional.ToNullable(provisioningState), resourceGuid.Value);
        }
    }
}
