...
namespace Azure.ResourceManager.DnsResolver.Models
{
    ...
    {
        internal static ForwardingRuleListResult DeserializeForwardingRuleListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
