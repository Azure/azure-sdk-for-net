...
{
    public partial class DnsForwardingRulesetData : IUtf8JsonSerializable, IJsonModel<DnsForwardingRulesetData>, IPersistableModel<DnsForwardingRulesetData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  dnsResolverOutboundEndpoints:");
                builder.AppendLine(" [");
                foreach (var item in DnsResolverOutboundEndpoints)
                {
