...
{
    public partial class DnsForwardingRulesetData : Core.IUtf8JsonSerializable
    {
        ...
        internal static DnsForwardingRulesetData DeserializeDnsForwardingRulesetData(JsonElement element)
        {
            ...
            return new DnsForwardingRulesetData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, Core.Optional.ToNullable(etag), dnsResolverOutboundEndpoints, Core.Optional.ToNullable(provisioningState), Core.Optional.ToNullable(resourceGuid));
        }
    }
}
