...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsForwardingRulesetData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsForwardingRulesetData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsForwardingRulesetData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DnsForwardingRulesetData>)} interface");
            }
        ...
        string IPersistableModel<DnsForwardingRulesetData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
