...
namespace Azure.ResourceManager.DnsResolver
{
    public partial class DnsForwardingRulesetData : IUtf8JsonSerializable
    {
        ...
        internal static DnsForwardingRulesetData DeserializeDnsForwardingRulesetData(JsonElement element)
        {
            ...
            return new DnsForwardingRulesetData(id, name, type, systemData, tags, location, Optional.ToNullable(etag), Optional.ToList(dnsResolverOutboundEndpoints), Optional.ToNullable(provisioningState), resourceGuid.Value);
        }
    }
}
