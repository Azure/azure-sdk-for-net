...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsResolverInboundEndpointData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsResolverInboundEndpointData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsResolverInboundEndpointData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DnsResolverInboundEndpointData>)} interface");
            }
        ...
        string IPersistableModel<DnsResolverInboundEndpointData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
