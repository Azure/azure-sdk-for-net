...
namespace Azure.ResourceManager.DnsResolver.Models
{
    ...
    {
        internal static VirtualNetworkLinkListResult DeserializeVirtualNetworkLinkListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
