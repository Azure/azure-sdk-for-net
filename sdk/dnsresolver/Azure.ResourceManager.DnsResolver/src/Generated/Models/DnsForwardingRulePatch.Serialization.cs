...
namespace Azure.ResourceManager.DnsResolver.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsForwardingRulePatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsForwardingRulePatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsForwardingRulePatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DnsForwardingRulePatch>)} interface");
            }
        ...
        string IPersistableModel<DnsForwardingRulePatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
