...
namespace Azure.ResourceManager.DnsResolver.Models
{
    ...
    public partial class DnsForwardingRulesetPatch
    {
        ...
        internal DnsForwardingRulesetPatch(IList<WritableSubResource> dnsResolverOutboundEndpoints, IDictionary<string, string> tags, Dictionary<string, BinaryData> rawData)
        {
