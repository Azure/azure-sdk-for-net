...
namespace Azure.ResourceManager.DnsResolver
{
    public partial class InboundEndpointData : IUtf8JsonSerializable
    {
        ...
        internal static InboundEndpointData DeserializeInboundEndpointData(JsonElement element)
        {
            ...
            return new InboundEndpointData(id, name, type, systemData, tags, location, Optional.ToNullable(etag), Optional.ToList(ipConfigurations), Optional.ToNullable(provisioningState), resourceGuid.Value);
        }
    }
}
