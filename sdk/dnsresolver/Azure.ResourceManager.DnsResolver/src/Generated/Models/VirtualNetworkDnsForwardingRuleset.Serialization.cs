...
namespace Azure.ResourceManager.DnsResolver.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<VirtualNetworkDnsForwardingRuleset>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<VirtualNetworkDnsForwardingRuleset>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<VirtualNetworkDnsForwardingRuleset>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<VirtualNetworkDnsForwardingRuleset>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
