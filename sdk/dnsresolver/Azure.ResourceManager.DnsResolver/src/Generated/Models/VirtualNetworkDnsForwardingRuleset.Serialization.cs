...
{
    public partial class VirtualNetworkDnsForwardingRuleset : IUtf8JsonSerializable, IJsonModel<VirtualNetworkDnsForwardingRuleset>, IPersistableModel<VirtualNetworkDnsForwardingRuleset>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VirtualNetworkLink))
            {
                builder.Append("  virtualNetworkLink:");
                AppendChildObject(builder, VirtualNetworkLink, options, 2);
            }
