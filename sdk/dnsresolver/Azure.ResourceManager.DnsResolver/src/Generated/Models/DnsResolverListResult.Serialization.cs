...
namespace Azure.ResourceManager.DnsResolver.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsResolverListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsResolverListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsResolverListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DnsResolverListResult>)} interface");
            }
        ...
        string IPersistableModel<DnsResolverListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
