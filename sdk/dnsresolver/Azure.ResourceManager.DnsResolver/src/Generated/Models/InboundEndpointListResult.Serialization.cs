...
namespace Azure.ResourceManager.DnsResolver.Models
{
    ...
    {
        internal static InboundEndpointListResult DeserializeInboundEndpointListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
