...
namespace Azure.ResourceManager.DnsResolver.Models
{
    ...
    public partial class InboundEndpointIPConfiguration : IJsonModel<InboundEndpointIPConfiguration>
    {
        ...
        protected virtual InboundEndpointIPConfiguration PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InboundEndpointIPConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<InboundEndpointIPConfiguration>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        InboundEndpointIPConfiguration IPersistableModel<InboundEndpointIPConfiguration>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        InboundEndpointIPConfiguration IJsonModel<InboundEndpointIPConfiguration>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual InboundEndpointIPConfiguration JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<InboundEndpointIPConfiguration>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static InboundEndpointIPConfiguration DeserializeInboundEndpointIPConfiguration(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("privateIpAllocationMethod"u8))
                {
                    ...
                    privateIPAllocationMethod = new InboundEndpointIPAllocationMethod(prop.Value.GetString());
                    continue;
                }
                if (options.Format != "W")
                {
            ...
            return new InboundEndpointIPConfiguration(subnet, privateIPAddress, privateIPAllocationMethod, additionalBinaryDataProperties);
        }
    }
}
