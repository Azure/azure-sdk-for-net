...
namespace Azure.ResourceManager.DnsResolver.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DnsForwardingRulesetPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DnsForwardingRulesetPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DnsForwardingRulesetPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DnsForwardingRulesetPatch>)} interface");
            }
        ...
        string IPersistableModel<DnsForwardingRulesetPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
