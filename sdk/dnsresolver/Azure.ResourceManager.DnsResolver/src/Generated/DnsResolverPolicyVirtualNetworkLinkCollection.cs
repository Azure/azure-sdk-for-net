...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    public partial class DnsResolverPolicyVirtualNetworkLinkCollection : ArmCollection, IEnumerable<DnsResolverPolicyVirtualNetworkLinkResource>, IAsyncEnumerable<DnsResolverPolicyVirtualNetworkLinkResource>
    {
        ...
        internal static void ValidateResourceId(ResourceIdentifier id)
        {
            ...
            {
                throw new ArgumentException(string.Format("Invalid resource type {0} expected {1}", id.ResourceType, DnsResolverPolicyResource.ResourceType), id);
            }
        }
        ...
        public virtual AsyncPageable<DnsResolverPolicyVirtualNetworkLinkResource> GetAllAsync(int? top = default, CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<DnsResolverPolicyVirtualNetworkLinkData, DnsResolverPolicyVirtualNetworkLinkResource>(new DnsResolverPolicyVirtualNetworkLinksGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                top,
                context), data => new DnsResolverPolicyVirtualNetworkLinkResource(Client, data));
        }
