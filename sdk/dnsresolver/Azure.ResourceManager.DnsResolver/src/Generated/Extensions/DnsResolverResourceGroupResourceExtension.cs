...
namespace Azure.ResourceManager.DnsResolver.Mock
{
    ...
    public partial class DnsResolverResourceGroupResourceExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DnsResolverResourceGroupResourceExtension"/> class for mocking. </summary>
        protected DnsResolverResourceGroupResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DnsResolverResourceGroupResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DnsResolverResourceGroupResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
