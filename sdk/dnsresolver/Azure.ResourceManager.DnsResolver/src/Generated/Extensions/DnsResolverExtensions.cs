...
using Azure.ResourceManager.DnsResolver.Testing;
...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    public static partial class DnsResolverExtensions
    {
        ...
        private static DnsResolverSubscriptionResourceExtension GetDnsResolverSubscriptionResourceExtension(ArmResource resource)
        {
            return resource.GetCachedClient(client =>
            {
                return new DnsResolverSubscriptionResourceExtension(client, resource.Id);
            });
        }

        private static DnsResolverSubscriptionResourceExtension GetDnsResolverSubscriptionResourceExtension(ArmClient client, ResourceIdentifier scope)
        {
            return client.GetResourceClient(() =>
            {
                return new DnsResolverSubscriptionResourceExtension(client, scope);
            });
        }
        ...
        {
            return GetDnsResolverSubscriptionResourceExtension(subscriptionResource).GetDnsResolversAsync(top, cancellationToken);
        }
        ...
        {
            return GetDnsResolverSubscriptionResourceExtension(subscriptionResource).GetDnsResolvers(top, cancellationToken);
        }
        ...
        {
            return GetDnsResolverSubscriptionResourceExtension(subscriptionResource).GetDnsForwardingRulesetsAsync(top, cancellationToken);
        }
        ...
        {
            return GetDnsResolverSubscriptionResourceExtension(subscriptionResource).GetDnsForwardingRulesets(top, cancellationToken);
        }
    }
}
