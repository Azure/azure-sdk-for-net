...
namespace Azure.ResourceManager.DnsResolver.Mocking
{
    ...
    internal partial class DnsResolverResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="DnsResolverResourceGroupMockingExtension"/> class for mocking. </summary>
        protected DnsResolverResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="DnsResolverResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal DnsResolverResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
