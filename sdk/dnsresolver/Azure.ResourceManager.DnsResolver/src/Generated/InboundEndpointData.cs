...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    public partial class InboundEndpointData : TrackedResourceData
    {
        ...
        /// <param name="location"> The location. </param>
        /// <param name="eTagEtag"> ETag of the inbound endpoint. </param>
