...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    public partial class DnsForwardingRulesetData : TrackedResourceData
    {
        ...
        /// <param name="location"> The location. </param>
        /// <param name="eTagEtag"> ETag of the DNS forwarding ruleset. </param>
        ...
        internal DnsForwardingRulesetData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, string eTagEtag, IList<WritableSubResource> dnsResolverOutboundEndpoints, ProvisioningState? provisioningState, string resourceGuid) : base(id, name, resourceType, systemData, tags, location)
        {
            ETagEtag = eTagEtag;
