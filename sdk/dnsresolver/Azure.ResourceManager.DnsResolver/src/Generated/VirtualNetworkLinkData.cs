...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    public partial class VirtualNetworkLinkData : ResourceData
    {
        ...
        /// <param name="eTagEtag"> ETag of the virtual network link. </param>
        ...
        internal VirtualNetworkLinkData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string eTagEtag, WritableSubResource virtualNetwork, IDictionary<string, string> metadata, ProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
            ETagEtag = eTagEtag;
