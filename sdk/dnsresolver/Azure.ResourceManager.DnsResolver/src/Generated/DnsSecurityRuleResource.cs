...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    public partial class DnsSecurityRuleResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<DnsSecurityRuleResource>> UpdateAsync(WaitUntil waitUntil, DnsSecurityRuleData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _dnsSecurityRulesRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, DnsSecurityRuleData.ToRequestContent(data), matchConditions, context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                DnsResolverArmOperation<DnsSecurityRuleResource> operation = new DnsResolverArmOperation<DnsSecurityRuleResource>(
                    new DnsSecurityRuleResourceOperationSource(Client),
                    _dnsSecurityRulesClientDiagnostics,
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DnsSecurityRuleResource> Update(WaitUntil waitUntil, DnsSecurityRuleData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
