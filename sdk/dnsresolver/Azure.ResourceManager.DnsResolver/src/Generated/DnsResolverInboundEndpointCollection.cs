...
namespace Azure.ResourceManager.DnsResolver
{
    ...
    public partial class DnsResolverInboundEndpointCollection : ArmCollection, IEnumerable<DnsResolverInboundEndpointResource>, IAsyncEnumerable<DnsResolverInboundEndpointResource>
    {
        ...
        /// <summary> Initializes a new instance of DnsResolverInboundEndpointCollection for mocking. </summary>
        protected DnsResolverInboundEndpointCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="DnsResolverInboundEndpointCollection"/> class. </summary>
        ...
        public virtual async Task<ArmOperation<DnsResolverInboundEndpointResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string inboundEndpointName, DnsResolverInboundEndpointData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(inboundEndpointName, nameof(inboundEndpointName));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _inboundEndpointsClientDiagnostics.CreateScope("DnsResolverInboundEndpointCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _inboundEndpointsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, inboundEndpointName, DnsResolverInboundEndpointData.ToRequestContent(data), matchConditions, context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="inboundEndpointName"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="inboundEndpointName"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<DnsResolverInboundEndpointResource> CreateOrUpdate(WaitUntil waitUntil, string inboundEndpointName, DnsResolverInboundEndpointData data, MatchConditions matchConditions = default, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(inboundEndpointName, nameof(inboundEndpointName));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<DnsResolverInboundEndpointResource>> GetAsync(string inboundEndpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _inboundEndpointsClientDiagnostics.CreateScope("DnsResolverInboundEndpointCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _inboundEndpointsRestClient.CreateGetRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, inboundEndpointName, context);
        ...
        public virtual AsyncPageable<DnsResolverInboundEndpointResource> GetAllAsync(int? top = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <returns> A collection of <see cref="DnsResolverInboundEndpointResource"/> that may take multiple service requests to iterate over. </returns>
        public virtual Pageable<DnsResolverInboundEndpointResource> GetAll(int? top = default, CancellationToken cancellationToken = default)
        {
            RequestContext context = new RequestContext
            {
                CancellationToken = cancellationToken
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string inboundEndpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _inboundEndpointsClientDiagnostics.CreateScope("DnsResolverInboundEndpointCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<DnsResolverInboundEndpointData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(DnsResolverInboundEndpointData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((DnsResolverInboundEndpointData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<DnsResolverInboundEndpointResource>> GetIfExistsAsync(string inboundEndpointName, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _inboundEndpointsClientDiagnostics.CreateScope("DnsResolverInboundEndpointCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
