...
namespace Azure.ResourceManager.DnsResolver
{
    internal partial class DnsResolverDomainListsRestOperations
    {
        ...
        internal HttpMessage CreateCreateOrUpdateRequest(string subscriptionId, string resourceGroupName, string dnsResolverDomainListName, DnsResolverDomainListData data, string ifMatch, string ifNoneMatch)
        {
            ...
            ((IJsonModel<DnsResolverDomainListData>)data).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
        ...
        internal HttpMessage CreateUpdateRequest(string subscriptionId, string resourceGroupName, string dnsResolverDomainListName, DnsResolverDomainListPatch patch, string ifMatch)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DnsResolverDomainListPatch>)patch).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
        ...
        internal HttpMessage CreateBulkRequest(string subscriptionId, string resourceGroupName, string dnsResolverDomainListName, DnsResolverDomainListBulk dnsResolverDomainListBulk, string ifMatch, string ifNoneMatch)
        {
            ...
            request.Headers.Add("Content-Type", "application/json");
            var content = new Utf8JsonRequestContent();
            ((IJsonModel<DnsResolverDomainListBulk>)dnsResolverDomainListBulk).Write(content.JsonWriter, ModelSerializationExtensions.WireOptions);
            request.Content = content;
            _userAgent.Apply(message);
            return message;
        }
