...
{
    public partial class DnsResolverResource
    {
        ...
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DnsResolverResource> Update(WaitUntil waitUntil, DnsResolverPatch patch, string ifMatch, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<ArmOperation<DnsResolverResource>> UpdateAsync(WaitUntil waitUntil, DnsResolverPatch patch, string ifMatch, CancellationToken cancellationToken = default)
        {
