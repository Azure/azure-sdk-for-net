...
{
    public partial class DnsResolverOutboundEndpointResource
    {
        ...
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<DnsResolverOutboundEndpointResource> Update(WaitUntil waitUntil, DnsResolverOutboundEndpointPatch patch, string ifMatch, CancellationToken cancellationToken = default)
        {
        ...
        /// </summary>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual async Task<ArmOperation<DnsResolverOutboundEndpointResource>> UpdateAsync(WaitUntil waitUntil, DnsResolverOutboundEndpointPatch patch, string ifMatch, CancellationToken cancellationToken = default)
        {
