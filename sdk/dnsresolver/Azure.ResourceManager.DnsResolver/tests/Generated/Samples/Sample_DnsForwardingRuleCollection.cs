...
namespace Azure.ResourceManager.DnsResolver.Samples
{
    public partial class Sample_DnsForwardingRuleCollection
    {
        ...
        {
            // Generated from example definition: 2025-05-01/ForwardingRule_Put.json
            // this example is just showing the usage of "ForwardingRule_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
            ...
            DnsForwardingRuleData data = new DnsForwardingRuleData(null, null);
        ...
        {
            // Generated from example definition: 2025-05-01/ForwardingRule_List.json
            // this example is just showing the usage of "ForwardingRule_List" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_RetrieveForwardingRuleInADNSForwardingRuleset()
        {
            // Generated from example definition: 2025-05-01/ForwardingRule_Get.json
            // this example is just showing the usage of "ForwardingRule_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string forwardingRuleName = "sampleForwardingRule";
            NullableResponse<DnsForwardingRuleResource> response = await collection.GetIfExistsAsync(forwardingRuleName);
            DnsForwardingRuleResource result = response.HasValue ? response.Value : null;
