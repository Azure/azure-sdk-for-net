...
namespace Azure.ResourceManager.DnsResolver.Samples
{
    public partial class Sample_DnsResolverInboundEndpointCollection
    {
        ...
        {
            // Generated from example definition: 2025-05-01/InboundEndpoint_Put.json
            // this example is just showing the usage of "InboundEndpoint_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
            ...
            DnsResolverInboundEndpointData data = new DnsResolverInboundEndpointData(new AzureLocation("westus2"), null)
            {
                Tags =
{
["key1"] = "value1"
        ...
        {
            // Generated from example definition: 2025-05-01/InboundEndpoint_List.json
            // this example is just showing the usage of "InboundEndpoint_List" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_RetrieveInboundEndpointForDNSResolver()
        {
            // Generated from example definition: 2025-05-01/InboundEndpoint_Get.json
            // this example is just showing the usage of "InboundEndpoint_Get" operation, for the dependent resources, they will have to be created separately.
            ...
            // invoke the operation
            string inboundEndpointName = "sampleInboundEndpoint";
            NullableResponse<DnsResolverInboundEndpointResource> response = await collection.GetIfExistsAsync(inboundEndpointName);
            DnsResolverInboundEndpointResource result = response.HasValue ? response.Value : null;
