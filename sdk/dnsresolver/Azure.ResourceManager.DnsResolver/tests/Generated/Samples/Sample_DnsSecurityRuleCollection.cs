...
namespace Azure.ResourceManager.DnsResolver.Samples
{
    public partial class Sample_DnsSecurityRuleCollection
    {
        ...
        {
            // Generated from example definition: 2025-05-01/DnsSecurityRule_Put.json
            // this example is just showing the usage of "DnsSecurityRule_CreateOrUpdate" operation, for the dependent resources, they will have to be created separately.
            ...
            DnsSecurityRuleData data = new DnsSecurityRuleData(new AzureLocation("westus2"), default, null, null)
            {
                Tags =
{
["key1"] = "value1"
        ...
        {
            // Generated from example definition: 2025-05-01/DnsSecurityRule_List.json
            // this example is just showing the usage of "DnsSecurityRule_List" operation, for the dependent resources, they will have to be created separately.
