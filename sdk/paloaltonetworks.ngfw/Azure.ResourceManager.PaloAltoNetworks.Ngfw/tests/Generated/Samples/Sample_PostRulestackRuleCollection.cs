...
{
    public partial class Sample_PostRulestackRuleCollection
    {
        [Test]
        ...
        public async Task Get_PostRulesGetMaximumSetGen()
        {
            ...
            // invoke the operation
            string priority = "1";
            PostRulestackRuleResource result = await collection.GetAsync(priority);
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/preview/2025-07-07-preview/examples/PostRules_List_MaximumSet_Gen.json
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/preview/2025-07-07-preview/examples/PostRules_List_MinimumSet_Gen.json
            // this example is just showing the usage of "PostRules_List" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_PostRulesGetMaximumSetGen()
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/preview/2025-07-07-preview/examples/PostRules_Get_MaximumSet_Gen.json
            // this example is just showing the usage of "PostRules_Get" operation, for the dependent resources, they will have to be created separately.
        ...
        [Test]
        [Ignore("Only validating compilation of examples")]
        public async Task GetIfExists_PostRulesGetMinimumSetGen()
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/preview/2025-07-07-preview/examples/PostRules_Get_MinimumSet_Gen.json
            // this example is just showing the usage of "PostRules_Get" operation, for the dependent resources, they will have to be created separately.
