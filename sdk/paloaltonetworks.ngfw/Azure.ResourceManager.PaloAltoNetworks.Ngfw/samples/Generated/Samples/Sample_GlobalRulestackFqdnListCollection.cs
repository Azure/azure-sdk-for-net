...
{
    public partial class Sample_GlobalRulestackFqdnListCollection
    {
        ...
        public async Task GetAll_FqdnListGlobalRulestackListMaximumSetGen()
        {
            ...
            // get the collection of this GlobalRulestackFqdnListResource
            GlobalRulestackFqdnListCollection collection = globalRulestack.GetGlobalRulestackFqdnLists();

            // invoke the operation and iterate over the result
            await foreach (GlobalRulestackFqdnListResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                GlobalRulestackFqdnListData resourceData = item.Data;
        ...
        public async Task Get_FqdnListGlobalRulestackGetMaximumSetGen()
        {
            ...
            string name = "armid1";
            GlobalRulestackFqdnListResource result = await collection.GetAsync(name);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            GlobalRulestackFqdnListData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        public async Task CreateOrUpdate_FqdnListGlobalRulestackCreateOrUpdateMaximumSetGen()
        {
            ...
            // invoke the operation
            string name = "armid1";
            GlobalRulestackFqdnListData data = new GlobalRulestackFqdnListData(new string[]
            {
"string1","string2"
            })
            {
            ...
            ArmOperation<GlobalRulestackFqdnListResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
            GlobalRulestackFqdnListResource result = lro.Value;
