...
{
    public partial class Sample_LocalRulestackRuleListCollection
    {
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/stable/2022-08-29/examples/LocalRules_ListByLocalRulestacks_MaximumSet_Gen.json
            ...
            // get the collection of this LocalRulestackRuleListResource
            LocalRulestackRuleListCollection collection = localRulestack.GetLocalRulestackRuleLists();

            // invoke the operation and iterate over the result
            await foreach (LocalRulestackRuleListResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                LocalRulestackRuleListData resourceData = item.Data;
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/stable/2022-08-29/examples/LocalRules_ListByLocalRulestacks_MinimumSet_Gen.json
            // this example is just showing the usage of "LocalRules_ListByLocalRulestacks" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task Get_LocalRulesGetMaximumSetGen()
        {
            ...
            string priority = "1";
            LocalRulestackRuleListResource result = await collection.GetAsync(priority);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            LocalRulestackRuleListData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        public async Task CreateOrUpdate_LocalRulesCreateOrUpdateMaximumSetGen()
        {
            ...
            // invoke the operation
            string priority = "1";
            LocalRulestackRuleListData data = new LocalRulestackRuleListData("localRule1")
            {
...
new RulestackTagInfo("keyName","value")
            ...
            ArmOperation<LocalRulestackRuleListResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, priority, data);
            LocalRulestackRuleListResource result = lro.Value;
