...
{
    public partial class Sample_GlobalRulestackPrefixListCollection
    {
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/stable/2022-08-29/examples/PrefixListGlobalRulestack_List_MaximumSet_Gen.json
            ...
            // get the collection of this GlobalRulestackPrefixListResource
            GlobalRulestackPrefixListCollection collection = globalRulestack.GetGlobalRulestackPrefixLists();

            // invoke the operation and iterate over the result
            await foreach (GlobalRulestackPrefixListResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                GlobalRulestackPrefixListData resourceData = item.Data;
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/stable/2022-08-29/examples/PrefixListGlobalRulestack_List_MinimumSet_Gen.json
            // this example is just showing the usage of "PrefixListGlobalRulestack_List" operation, for the dependent resources, they will have to be created separately.
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/stable/2022-08-29/examples/PrefixListGlobalRulestack_Get_MaximumSet_Gen.json
            ...
            string name = "armid1";
            GlobalRulestackPrefixListResource result = await collection.GetAsync(name);

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            GlobalRulestackPrefixListData resourceData = result.Data;
            // for demo we just print out the id
            Console.WriteLine($"Succeeded on id: {resourceData.Id}");
        }
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/stable/2022-08-29/examples/PrefixListGlobalRulestack_CreateOrUpdate_MaximumSet_Gen.json
            ...
            // invoke the operation
            string name = "armid1";
            GlobalRulestackPrefixListData data = new GlobalRulestackPrefixListData(new string[]
            {
"1.0.0.0/24"
            })
            {
            ...
            ArmOperation<GlobalRulestackPrefixListResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
            GlobalRulestackPrefixListResource result = lro.Value;
