...
{
    public partial class Sample_PreRulestackRuleListCollection
    {
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/stable/2022-08-29/examples/PreRules_List_MaximumSet_Gen.json
            ...
            // get the collection of this PreRulestackRuleListResource
            PreRulestackRuleListCollection collection = globalRulestack.GetPreRulestackRuleLists();

            // invoke the operation and iterate over the result
            await foreach (PreRulestackRuleListResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PreRulestackRuleListData resourceData = item.Data;
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/stable/2022-08-29/examples/PreRules_List_MinimumSet_Gen.json
            // this example is just showing the usage of "PreRules_List" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task Get_PreRulesGetMaximumSetGen()
        {
            ...
            string priority = "1";
            PreRulestackRuleListResource result = await collection.GetAsync(priority);
...
new RulestackTagInfo("keyName","value")
            ...
            ArmOperation<PreRulestackRuleListResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, priority, data);
