...
{
    public partial class Sample_PostRulestackRuleListCollection
    {
        ...
        public async Task GetAll_PostRulesListMaximumSetGen()
        {
            ...
            // get the collection of this PostRulestackRuleListResource
            PostRulestackRuleListCollection collection = globalRulestack.GetPostRulestackRuleLists();

            // invoke the operation and iterate over the result
            await foreach (PostRulestackRuleListResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                PostRulestackRuleListData resourceData = item.Data;
        ...
        public async Task Get_PostRulesGetMaximumSetGen()
        {
            ...
            string priority = "1";
            PostRulestackRuleListResource result = await collection.GetAsync(priority);
...
new RulestackTagInfo("keyName","value")
            ...
            ArmOperation<PostRulestackRuleListResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, priority, data);
