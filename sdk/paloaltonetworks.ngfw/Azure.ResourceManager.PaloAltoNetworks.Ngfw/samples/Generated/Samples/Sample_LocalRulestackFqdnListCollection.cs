...
{
    public partial class Sample_LocalRulestackFqdnListCollection
    {
        ...
        public async Task GetAll_FqdnListLocalRulestackListByLocalRulestacksMaximumSetGen()
        {
            ...
            // get the collection of this LocalRulestackFqdnListResource
            LocalRulestackFqdnListCollection collection = localRulestack.GetLocalRulestackFqdnLists();

            // invoke the operation and iterate over the result
            await foreach (LocalRulestackFqdnListResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                LocalRulestackFqdnListData resourceData = item.Data;
        ...
        public async Task Get_FqdnListLocalRulestackGetMaximumSetGen()
        {
            ...
            string name = "armid1";
            LocalRulestackFqdnListResource result = await collection.GetAsync(name);
...
"string1","string2"
            ...
            ArmOperation<LocalRulestackFqdnListResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
