...
{
    public partial class Sample_GlobalRulestackFqdnListResource
    {
        ...
        public async Task Get_FqdnListGlobalRulestackGetMaximumSetGen()
        {
            ...
            // this example assumes you already have this GlobalRulestackFqdnListResource created on azure
            // for more information of creating GlobalRulestackFqdnListResource, please refer to the document of GlobalRulestackFqdnListResource
            string globalRulestackName = "praval";
            string name = "armid1";
            ResourceIdentifier globalRulestackFqdnListResourceId = GlobalRulestackFqdnListResource.CreateResourceIdentifier(globalRulestackName, name);
            GlobalRulestackFqdnListResource globalRulestackFqdnList = client.GetGlobalRulestackFqdnListResource(globalRulestackFqdnListResourceId);

            // invoke the operation
            GlobalRulestackFqdnListResource result = await globalRulestackFqdnList.GetAsync();
...
"string1","string2"
            ...
            ArmOperation<GlobalRulestackFqdnListResource> lro = await globalRulestackFqdnList.UpdateAsync(WaitUntil.Completed, data);
...
"string1","string2"
        ...
        public async Task Delete_FqdnListGlobalRulestackDeleteMaximumSetGen()
        {
            ...
            // invoke the operation
            await globalRulestackFqdnList.DeleteAsync(WaitUntil.Completed);
