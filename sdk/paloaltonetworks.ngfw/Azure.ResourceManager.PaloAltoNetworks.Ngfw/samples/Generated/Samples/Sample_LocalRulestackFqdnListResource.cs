...
{
    public partial class Sample_LocalRulestackFqdnListResource
    {
        ...
        public async Task Get_FqdnListLocalRulestackGetMaximumSetGen()
        {
            ...
            // this example assumes you already have this LocalRulestackFqdnListResource created on azure
            // for more information of creating LocalRulestackFqdnListResource, please refer to the document of LocalRulestackFqdnListResource
            string subscriptionId = "2bf4a339-294d-4c25-b0b2-ef649e9f5c27";
            string resourceGroupName = "rgopenapi";
            string localRulestackName = "lrs1";
            string name = "armid1";
            ResourceIdentifier localRulestackFqdnListResourceId = LocalRulestackFqdnListResource.CreateResourceIdentifier(subscriptionId, resourceGroupName, localRulestackName, name);
            LocalRulestackFqdnListResource localRulestackFqdnList = client.GetLocalRulestackFqdnListResource(localRulestackFqdnListResourceId);

            // invoke the operation
            LocalRulestackFqdnListResource result = await localRulestackFqdnList.GetAsync();

            // the variable result is a resource, you could call other operations on this instance as well
            // but just for demo, we get its data from this resource instance
            LocalRulestackFqdnListData resourceData = result.Data;
        ...
        public async Task Update_FqdnListLocalRulestackCreateOrUpdateMaximumSetGen()
        {
            ...
            // invoke the operation
            LocalRulestackFqdnListData data = new LocalRulestackFqdnListData(new string[]
            {
"string1","string2"
            })
            {
            ...
            ArmOperation<LocalRulestackFqdnListResource> lro = await localRulestackFqdnList.UpdateAsync(WaitUntil.Completed, data);
            LocalRulestackFqdnListResource result = lro.Value;
...
"string1","string2"
        ...
        public async Task Delete_FqdnListLocalRulestackDeleteMaximumSetGen()
        {
            ...
            // invoke the operation
            await localRulestackFqdnList.DeleteAsync(WaitUntil.Completed);
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/stable/2022-08-29/examples/FqdnListLocalRulestack_Delete_MinimumSet_Gen.json
            // this example is just showing the usage of "FqdnListLocalRulestack_Delete" operation, for the dependent resources, they will have to be created separately.
