...
{
    public partial class Sample_CertificateObjectLocalRulestackResourceCollection
    {
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/preview/2022-08-29-preview/examples/CertificateObjectLocalRulestack_ListByLocalRulestacks_MaximumSet_Gen.json
            ...
            // get the collection of this CertificateObjectLocalRulestackResource
            CertificateObjectLocalRulestackResourceCollection collection = localRulestackResource.GetCertificateObjectLocalRulestackResources();

            // invoke the operation and iterate over the result
            await foreach (CertificateObjectLocalRulestackResource item in collection.GetAllAsync())
            {
                // the variable item is a resource, you could call other operations on this instance as well
                // but just for demo, we get its data from this resource instance
                CertificateObjectLocalRulestackResourceData resourceData = item.Data;
        ...
        {
            // Generated from example definition: specification/paloaltonetworks/resource-manager/PaloAltoNetworks.Cloudngfw/preview/2022-08-29-preview/examples/CertificateObjectLocalRulestack_ListByLocalRulestacks_MinimumSet_Gen.json
            // this example is just showing the usage of "CertificateObjectLocalRulestack_ListByLocalRulestacks" operation, for the dependent resources, they will have to be created separately.
        ...
        public async Task Get_CertificateObjectLocalRulestackGetMaximumSetGen()
        {
            ...
            string name = "armid1";
            CertificateObjectLocalRulestackResource result = await collection.GetAsync(name);
        ...
        public async Task CreateOrUpdate_CertificateObjectLocalRulestackCreateOrUpdateMaximumSetGen()
        {
            ...
            ArmOperation<CertificateObjectLocalRulestackResource> lro = await collection.CreateOrUpdateAsync(WaitUntil.Completed, name, data);
