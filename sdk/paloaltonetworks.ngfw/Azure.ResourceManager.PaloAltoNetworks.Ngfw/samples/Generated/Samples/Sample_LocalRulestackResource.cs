...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Samples
{
    public partial class Sample_LocalRulestackResource
    {
        ...
        public async Task Delete_LocalRulestacksDeleteMaximumSetGen()
        {
            ...
            // invoke the operation
            await localRulestack.DeleteAsync(WaitUntil.Completed).ConfigureAwait(false);
...
["tagName"] = "value"
        ...
        public async Task Commit_LocalRulestacksCommitMaximumSetGen()
        {
            ...
            // invoke the operation
            await localRulestack.CommitAsync(WaitUntil.Completed).ConfigureAwait(false);
        ...
        public async Task GetSupportInfo_LocalRulestacksGetSupportInfoMaximumSetGen()
        {
            ...
            FirewallSupportInfo result = await localRulestack.GetSupportInfoAsync(email);
        ...
        public async Task GetAdvancedSecurityObjects_LocalRulestacksListAdvancedSecurityObjectsMaximumSetGen()
        {
            ...
            string skip = "a6a321";
            int? top = 20;
            AdvancedSecurityObjectListResult result = await localRulestack.GetAdvancedSecurityObjectsAsync(type, skip, top);
        ...
        public async Task GetAppIds_LocalRulestacksListAppIdsMaximumSetGen()
        {
            ...
            string skip = "a6a321";
            int? top = 20;
            await foreach (string item in localRulestack.GetAppIdsAsync(appIdVersion, appPrefix, skip, top))
            {
        ...
        public async Task GetCountries_LocalRulestacksListCountriesMaximumSetGen()
        {
            ...
            string skip = "a6a321";
            int? top = 20;
            await foreach (RulestackCountry item in localRulestack.GetCountriesAsync(skip, top))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task GetPredefinedUrlCategories_LocalRulestacksListPredefinedUrlCategoriesMaximumSetGen()
        {
            ...
            string skip = "a6a321";
            int? top = 20;
            await foreach (PredefinedUrlCategory item in localRulestack.GetPredefinedUrlCategoriesAsync(skip, top))
            {
                Console.WriteLine($"Succeeded: {item}");
            }
        ...
        public async Task GetSecurityServices_LocalRulestacksListSecurityServicesMaximumSetGen()
        {
            ...
            string skip = "a6a321";
            int? top = 20;
            RulestackSecurityServiceListResult result = await localRulestack.GetSecurityServicesAsync(type, skip, top);
        ...
        public async Task Revert_LocalRulestacksRevertMaximumSetGen()
        {
            ...
            // invoke the operation
            await localRulestack.RevertAsync().ConfigureAwait(false);
