...
{
    /// <summary>
    /// A class representing the LocalRulestackFqdnList data model.
    /// LocalRulestack fqdnList
    /// </summary>
    public partial class LocalRulestackFqdnListData : ResourceData
    {
        ...
        public LocalRulestackFqdnListData(IEnumerable<string> fqdnList)
        {
        ...
        internal LocalRulestackFqdnListData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, IList<string> fqdnList, ETag? etag, string auditComment, FirewallProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
