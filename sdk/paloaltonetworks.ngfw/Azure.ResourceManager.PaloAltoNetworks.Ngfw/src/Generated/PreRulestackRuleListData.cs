...
{
    /// <summary>
    /// A class representing the PreRulestackRuleList data model.
    /// PreRulestack rule list
    /// </summary>
    public partial class PreRulestackRuleListData : ResourceData
    {
        /// <summary> Initializes a new instance of PreRulestackRuleListData. </summary>
        /// <param name="ruleName"> rule name. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ruleName"/> is null. </exception>
        public PreRulestackRuleListData(string ruleName)
        {
