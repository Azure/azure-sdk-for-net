...
{
    /// <summary>
    /// A class representing the PostRulestackRuleList data model.
    /// PostRulestack rule list
    /// </summary>
    public partial class PostRulestackRuleListData : ResourceData
    {
        /// <summary> Initializes a new instance of PostRulestackRuleListData. </summary>
        /// <param name="ruleName"> rule name. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="ruleName"/> is null. </exception>
        public PostRulestackRuleListData(string ruleName)
        {
