...
{
    /// <summary>
    /// A class representing the PrefixListGlobalRulestackResource data model.
    /// GlobalRulestack prefixList
    /// </summary>
    public partial class PrefixListGlobalRulestackResourceData : ResourceData
    {
        ...
        public PrefixListGlobalRulestackResourceData(IEnumerable<string> prefixList)
        {
        ...
        internal PrefixListGlobalRulestackResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, IList<string> prefixList, ETag? etag, string auditComment, ProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
