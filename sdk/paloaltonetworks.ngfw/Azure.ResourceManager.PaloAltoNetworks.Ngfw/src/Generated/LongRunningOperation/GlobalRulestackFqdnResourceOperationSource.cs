...
{
    /// <summary></summary>
    internal partial class GlobalRulestackFqdnResourceOperationSource : IOperationSource<GlobalRulestackFqdnResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal GlobalRulestackFqdnResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
