...
{
    /// <summary></summary>
    internal partial class PaloAltoNetworksFirewallResourceOperationSource : IOperationSource<PaloAltoNetworksFirewallResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PaloAltoNetworksFirewallResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
