...
{
    /// <summary></summary>
    internal partial class LocalRulestackPrefixResourceOperationSource : IOperationSource<LocalRulestackPrefixResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal LocalRulestackPrefixResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
