...
{
    /// <summary></summary>
    internal partial class LocalRulestackRuleResourceOperationSource : IOperationSource<LocalRulestackRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal LocalRulestackRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
