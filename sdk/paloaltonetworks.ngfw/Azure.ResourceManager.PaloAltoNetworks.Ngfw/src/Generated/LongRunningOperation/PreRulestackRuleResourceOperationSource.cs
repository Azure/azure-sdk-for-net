...
{
    /// <summary></summary>
    internal partial class PreRulestackRuleResourceOperationSource : IOperationSource<PreRulestackRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PreRulestackRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
