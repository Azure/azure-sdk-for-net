...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    internal partial class NgfwArmOperation<T> : ArmOperation<T>
    {
        ...
        internal NgfwArmOperation(IOperationSource<T> source, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response, OperationFinalStateVia finalStateVia, bool skipApiVersionOverride = true, string apiVersionOverrideValue = null)
        {
