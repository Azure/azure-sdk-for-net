...
{
    /// <summary></summary>
    internal partial class LocalRulestackResourceOperationSource : IOperationSource<LocalRulestackResource>
    {
        ...
        LocalRulestackResource IOperationSource<LocalRulestackResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            LocalRulestackData data = LocalRulestackData.DeserializeLocalRulestackData(document.RootElement, ModelSerializationExtensions.WireOptions);
