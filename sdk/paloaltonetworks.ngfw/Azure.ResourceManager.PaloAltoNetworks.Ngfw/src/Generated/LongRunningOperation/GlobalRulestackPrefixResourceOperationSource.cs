...
{
    /// <summary></summary>
    internal partial class GlobalRulestackPrefixResourceOperationSource : IOperationSource<GlobalRulestackPrefixResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal GlobalRulestackPrefixResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
