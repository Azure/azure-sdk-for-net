...
{
    /// <summary></summary>
    internal partial class PostRulestackRuleResourceOperationSource : IOperationSource<PostRulestackRuleResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal PostRulestackRuleResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
