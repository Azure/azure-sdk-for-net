...
{
    /// <summary></summary>
    internal partial class GlobalRulestackCertificateObjectResourceOperationSource : IOperationSource<GlobalRulestackCertificateObjectResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal GlobalRulestackCertificateObjectResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
