...
{
    /// <summary>
    /// A class representing the GlobalRulestackFqdnList data model.
    /// GlobalRulestack fqdnList
    /// </summary>
    public partial class GlobalRulestackFqdnListData : ResourceData
    {
        /// <summary> Initializes a new instance of GlobalRulestackFqdnListData. </summary>
        /// <param name="fqdnList"> fqdn list. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="fqdnList"/> is null. </exception>
        public GlobalRulestackFqdnListData(IEnumerable<string> fqdnList)
        {
        ...
        internal GlobalRulestackFqdnListData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, IList<string> fqdnList, ETag? etag, string auditComment, FirewallProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
