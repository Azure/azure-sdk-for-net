...
{
    /// <summary>
    /// A class representing the LocalRulestackPrefixList data model.
    /// LocalRulestack prefixList
    /// </summary>
    public partial class LocalRulestackPrefixListData : ResourceData
    {
        ...
        public LocalRulestackPrefixListData(IEnumerable<string> prefixList)
        {
        ...
        internal LocalRulestackPrefixListData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, IList<string> prefixList, ETag? etag, string auditComment, FirewallProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
