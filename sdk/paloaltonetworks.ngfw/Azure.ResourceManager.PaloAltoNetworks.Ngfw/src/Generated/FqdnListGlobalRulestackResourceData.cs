...
{
    /// <summary>
    /// A class representing the FqdnListGlobalRulestackResource data model.
    /// GlobalRulestack fqdnList
    /// </summary>
    public partial class FqdnListGlobalRulestackResourceData : ResourceData
    {
        ...
        public FqdnListGlobalRulestackResourceData(IEnumerable<string> fqdnList)
        {
        ...
        internal FqdnListGlobalRulestackResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, IList<string> fqdnList, ETag? etag, string auditComment, ProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
