    ...
    public partial class GlobalRulestackCollection : ArmCollection, IEnumerable<GlobalRulestackResource>, IAsyncEnumerable<GlobalRulestackResource>
    {
        ...
        public virtual async Task<ArmOperation<GlobalRulestackResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string globalRulestackName, GlobalRulestackData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new NgfwArmOperation<GlobalRulestackResource>(new GlobalRulestackOperationSource(Client), _globalRulestackClientDiagnostics, Pipeline, _globalRulestackRestClient.CreateCreateOrUpdateRequest(globalRulestackName, data).Request, response, Core.OperationFinalStateVia.AzureAsyncOperation);
        ...
        public virtual AsyncPageable<GlobalRulestackResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return Core.PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new GlobalRulestackResource(Client, GlobalRulestackData.DeserializeGlobalRulestackData(e)), _globalRulestackClientDiagnostics, Pipeline, "GlobalRulestackCollection.GetAll", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<GlobalRulestackResource> GetAll(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _globalRulestackRestClient.CreateListRequest();
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => _globalRulestackRestClient.CreateListNextPageRequest(nextLink);
            return Core.PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new GlobalRulestackResource(Client, GlobalRulestackData.DeserializeGlobalRulestackData(e)), _globalRulestackClientDiagnostics, Pipeline, "GlobalRulestackCollection.GetAll", "value", "nextLink", cancellationToken);
        }
