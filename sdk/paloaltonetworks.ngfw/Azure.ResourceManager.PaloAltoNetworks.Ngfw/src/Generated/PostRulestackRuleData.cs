...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    public partial class PostRulestackRuleData : ResourceData
    {
        ...
        internal PostRulestackRuleData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, RuleEntry properties) : base(id, name, resourceType, systemData)
        {
