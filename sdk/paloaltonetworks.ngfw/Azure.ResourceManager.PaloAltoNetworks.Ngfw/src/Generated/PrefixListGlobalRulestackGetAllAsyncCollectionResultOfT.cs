...
{
    internal partial class PrefixListGlobalRulestackGetAllAsyncCollectionResultOfT : AsyncPageable<GlobalRulestackPrefixData>
    {
        private readonly PrefixListGlobalRulestack _client;
        private readonly string _globalRulestackName;
        private readonly RequestContext _context;

        /// <summary> Initializes a new instance of PrefixListGlobalRulestackGetAllAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public PrefixListGlobalRulestackGetAllAsyncCollectionResultOfT(PrefixListGlobalRulestack client, string globalRulestackName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
        ...
        /// <summary> Gets the pages of PrefixListGlobalRulestackGetAllAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of PrefixListGlobalRulestackGetAllAsyncCollectionResultOfT as an enumerable collection. </returns>
        public override async IAsyncEnumerable<Page<GlobalRulestackPrefixData>> AsPages(string continuationToken, int? pageSizeHint)
        {
