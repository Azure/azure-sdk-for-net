...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Mocking
{
    ...
    internal partial class NgfwTenantMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NgfwTenantMockingExtension"/> class for mocking. </summary>
        protected NgfwTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NgfwTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NgfwTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
