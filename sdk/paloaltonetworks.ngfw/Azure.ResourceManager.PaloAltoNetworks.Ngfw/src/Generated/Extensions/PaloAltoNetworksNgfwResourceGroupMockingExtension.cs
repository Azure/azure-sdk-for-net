...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Mocking
{
    ...
    public partial class PaloAltoNetworksNgfwResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PaloAltoNetworksNgfwResourceGroupMockingExtension"/> class for mocking. </summary>
        protected PaloAltoNetworksNgfwResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PaloAltoNetworksNgfwResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PaloAltoNetworksNgfwResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
