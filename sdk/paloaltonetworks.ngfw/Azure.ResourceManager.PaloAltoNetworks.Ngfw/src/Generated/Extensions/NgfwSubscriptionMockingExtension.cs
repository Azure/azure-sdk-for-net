...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Mocking
{
    ...
    internal partial class NgfwSubscriptionMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NgfwSubscriptionMockingExtension"/> class for mocking. </summary>
        protected NgfwSubscriptionMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NgfwSubscriptionMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NgfwSubscriptionMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<LocalRulestackResource> GetLocalRulestacksAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new LocalRulestackResource(Client, LocalRulestackData.DeserializeLocalRulestackData(e)), LocalRulestackClientDiagnostics, Pipeline, "NgfwSubscriptionMockingExtension.GetLocalRulestacks", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<LocalRulestackResource> GetLocalRulestacks(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => LocalRulestackRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => LocalRulestackRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new LocalRulestackResource(Client, LocalRulestackData.DeserializeLocalRulestackData(e)), LocalRulestackClientDiagnostics, Pipeline, "NgfwSubscriptionMockingExtension.GetLocalRulestacks", "value", "nextLink", cancellationToken);
        }
    }
}
