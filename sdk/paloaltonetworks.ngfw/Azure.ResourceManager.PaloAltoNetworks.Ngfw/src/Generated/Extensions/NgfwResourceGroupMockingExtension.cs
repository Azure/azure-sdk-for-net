...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Mocking
{
    ...
    internal partial class NgfwResourceGroupMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NgfwResourceGroupMockingExtension"/> class for mocking. </summary>
        protected NgfwResourceGroupMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NgfwResourceGroupMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NgfwResourceGroupMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
