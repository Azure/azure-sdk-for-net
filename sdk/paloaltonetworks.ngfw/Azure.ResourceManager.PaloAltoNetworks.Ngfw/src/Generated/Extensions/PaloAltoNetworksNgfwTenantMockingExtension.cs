...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Mocking
{
    ...
    public partial class PaloAltoNetworksNgfwTenantMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PaloAltoNetworksNgfwTenantMockingExtension"/> class for mocking. </summary>
        protected PaloAltoNetworksNgfwTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PaloAltoNetworksNgfwTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PaloAltoNetworksNgfwTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
