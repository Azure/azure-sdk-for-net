...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Testing
{
    ...
    public partial class NgfwSubscriptionResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="NgfwSubscriptionResourceExtension"/> class for mocking. </summary>
        protected NgfwSubscriptionResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NgfwSubscriptionResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NgfwSubscriptionResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<FirewallResource> GetFirewallResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new FirewallResource(Client, FirewallResourceData.DeserializeFirewallResourceData(e)), FirewallResourceFirewallsClientDiagnostics, Pipeline, "NgfwSubscriptionResourceExtension.GetFirewallResources", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual Pageable<FirewallResource> GetFirewallResources(CancellationToken cancellationToken = default)
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => FirewallResourceFirewallsRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            HttpMessage NextPageRequest(int? pageSizeHint, string nextLink) => FirewallResourceFirewallsRestClient.CreateListBySubscriptionNextPageRequest(nextLink, Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, NextPageRequest, e => new FirewallResource(Client, FirewallResourceData.DeserializeFirewallResourceData(e)), FirewallResourceFirewallsClientDiagnostics, Pipeline, "NgfwSubscriptionResourceExtension.GetFirewallResources", "value", "nextLink", cancellationToken);
        }
        ...
        public virtual AsyncPageable<LocalRulestackResource> GetLocalRulestackResourcesAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, NextPageRequest, e => new LocalRulestackResource(Client, LocalRulestackResourceData.DeserializeLocalRulestackResourceData(e)), LocalRulestackResourceLocalRulestacksClientDiagnostics, Pipeline, "NgfwSubscriptionResourceExtension.GetLocalRulestackResources", "value", "nextLink", cancellationToken);
        }
