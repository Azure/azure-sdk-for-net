...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Mocking
{
    ...
    public partial class PaloAltoNetworksNgfwArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="PaloAltoNetworksNgfwArmClientMockingExtension"/> class for mocking. </summary>
        protected PaloAltoNetworksNgfwArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="PaloAltoNetworksNgfwArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal PaloAltoNetworksNgfwArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal PaloAltoNetworksNgfwArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
