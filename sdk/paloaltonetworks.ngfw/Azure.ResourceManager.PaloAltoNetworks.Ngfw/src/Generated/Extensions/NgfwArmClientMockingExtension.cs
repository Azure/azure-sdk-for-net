...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Mocking
{
    ...
    internal partial class NgfwArmClientMockingExtension : ArmResource
    {
        /// <summary> Initializes a new instance of the <see cref="NgfwArmClientMockingExtension"/> class for mocking. </summary>
        protected NgfwArmClientMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="NgfwArmClientMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal NgfwArmClientMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }

        internal NgfwArmClientMockingExtension(ArmClient client) : this(client, ResourceIdentifier.Root)
        {
        }
