...
{
    /// <summary>
    /// A class representing the GlobalRulestackPrefixList data model.
    /// GlobalRulestack prefixList
    /// </summary>
    public partial class GlobalRulestackPrefixListData : ResourceData
    {
        ...
        public GlobalRulestackPrefixListData(IEnumerable<string> prefixList)
        {
        ...
        internal GlobalRulestackPrefixListData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string description, IList<string> prefixList, ETag? etag, string auditComment, FirewallProvisioningState? provisioningState) : base(id, name, resourceType, systemData)
        {
