...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    public partial class LocalRulestackPrefixData : ResourceData
    {
        ...
        internal LocalRulestackPrefixData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, PrefixObject properties) : base(id, name, resourceType, systemData)
        {
