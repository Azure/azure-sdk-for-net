...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    public partial class LocalRulestackFqdnData : ResourceData
    {
        ...
        internal LocalRulestackFqdnData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, FqdnObject properties) : base(id, name, resourceType, systemData)
        {
