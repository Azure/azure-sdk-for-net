...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    public partial class MetricsObjectFirewallResource : ArmResource
    {
        ...
        internal MetricsObjectFirewallResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _metricsObjectFirewallRestClient = new MetricsObjectFirewall(_metricsObjectFirewallClientDiagnostics, Pipeline, Endpoint, metricsObjectFirewallApiVersion ?? "2026-05-11-preview");
