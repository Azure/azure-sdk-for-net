...
{
    public partial class FirewallNetworkProfile : IUtf8JsonSerializable, IJsonModel<FirewallNetworkProfile>, IPersistableModel<FirewallNetworkProfile>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VwanConfiguration))
            {
                builder.Append("  vwanConfiguration:");
                AppendChildObject(builder, VwanConfiguration, options, 2);
            }

            if (Optional.IsDefined(NetworkType))
            {
                builder.Append("  networkType:");
                builder.AppendLine($" '{NetworkType.ToString()}'");
            }
            ...
            if (Optional.IsDefined(EnableEgressNat))
            {
                builder.Append("  enableEgressNat:");
                builder.AppendLine($" '{EnableEgressNat.ToString()}'");
            }

            if (Optional.IsCollectionDefined(EgressNatIP))
            {
                builder.Append("  egressNatIp:");
                builder.AppendLine(" [");
                foreach (var item in EgressNatIP)
                {
                    AppendChildObject(builder, item, options, 4);
