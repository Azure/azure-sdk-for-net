...
{
    public partial class LocalRulesResourceData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static LocalRulesResourceData DeserializeLocalRulesResourceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
