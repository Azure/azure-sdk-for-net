...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirewallLogDestination>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FirewallLogDestination>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FirewallLogDestination>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirewallLogDestination>)} interface");
            }
        ...
        string IPersistableModel<FirewallLogDestination>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
