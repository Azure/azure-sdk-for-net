...
{
    public partial class FirewallLogDestination : IUtf8JsonSerializable, IJsonModel<FirewallLogDestination>, IPersistableModel<FirewallLogDestination>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(StorageConfiguration))
            {
                builder.Append("  storageConfigurations:");
                AppendChildObject(builder, StorageConfiguration, options, 2);
            }

            if (Optional.IsDefined(EventHubConfiguration))
            {
                builder.Append("  eventHubConfigurations:");
                AppendChildObject(builder, EventHubConfiguration, options, 2);
            }

            if (Optional.IsDefined(MonitorConfiguration))
            {
                builder.Append("  monitorConfigurations:");
                AppendChildObject(builder, MonitorConfiguration, options, 2);
            }
