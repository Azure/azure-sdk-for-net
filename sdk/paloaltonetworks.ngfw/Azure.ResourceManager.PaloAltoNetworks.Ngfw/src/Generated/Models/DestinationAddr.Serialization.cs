...
{
    public partial class DestinationAddr : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DestinationAddr DeserializeDestinationAddr(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
