...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdvancedSecurityObject>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdvancedSecurityObject>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdvancedSecurityObject>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AdvancedSecurityObject>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
