...
{
    public partial class AdvancedSecurityObject : IUtf8JsonSerializable, IJsonModel<AdvancedSecurityObject>, IPersistableModel<AdvancedSecurityObject>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{AdvSecurityObjectModelType}'");
            }
