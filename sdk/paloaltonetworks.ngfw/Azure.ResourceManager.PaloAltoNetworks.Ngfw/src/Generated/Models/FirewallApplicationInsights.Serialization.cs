...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirewallApplicationInsights>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FirewallApplicationInsights>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FirewallApplicationInsights>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<FirewallApplicationInsights>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
