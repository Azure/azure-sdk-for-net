...
{
    public partial class VwanConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VwanConfiguration DeserializeVwanConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
