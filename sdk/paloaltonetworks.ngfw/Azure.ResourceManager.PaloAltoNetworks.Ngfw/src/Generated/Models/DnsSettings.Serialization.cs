...
{
    public partial class DnsSettings : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static DnsSettings DeserializeDnsSettings(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
