...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    internal partial class PrefixObject
    {
        ...
        internal PrefixObject(string description, IList<string> prefixList, ETag? eTag, string auditComment, FirewallProvisioningState? provisioningState, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
