...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        internal static GlobalRulestackResourceListResult DeserializeGlobalRulestackResourceListResult(JsonElement element, SerializableOptions options = default)
        {
