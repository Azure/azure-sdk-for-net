...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RulestackSecurityServiceTypeList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RulestackSecurityServiceTypeList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RulestackSecurityServiceTypeList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RulestackSecurityServiceTypeList>)} interface");
            }
        ...
        string IPersistableModel<RulestackSecurityServiceTypeList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
