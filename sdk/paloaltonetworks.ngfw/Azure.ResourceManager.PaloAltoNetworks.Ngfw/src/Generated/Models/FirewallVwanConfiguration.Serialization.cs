...
{
    public partial class FirewallVwanConfiguration : IUtf8JsonSerializable, IJsonModel<FirewallVwanConfiguration>, IPersistableModel<FirewallVwanConfiguration>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(NetworkVirtualApplianceId))
            {
                builder.Append("  networkVirtualApplianceId:");
                builder.AppendLine($" '{NetworkVirtualApplianceId}'");
            }

            if (Optional.IsDefined(Vhub))
            {
                builder.Append("  vHub:");
                AppendChildObject(builder, Vhub, options, 2);
            }
