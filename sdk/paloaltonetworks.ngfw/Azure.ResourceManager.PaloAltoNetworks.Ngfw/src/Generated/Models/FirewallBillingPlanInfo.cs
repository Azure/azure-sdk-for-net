...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class FirewallBillingPlanInfo
    {
        ...
        internal FirewallBillingPlanInfo(FirewallBillingPlanUsageType? usageType, FirewallBillingCycle billingCycle, string planId, DateTimeOffset? effectiveOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UsageType = usageType;
            BillingCycle = billingCycle;
            PlanId = planId;
