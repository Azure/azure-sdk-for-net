    ...
    public partial class RulestackSecurityServices : IUtf8JsonSerializable, IJsonModel<RulestackSecurityServices>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(VulnerabilityProfile))
            {
                ...
                if (VulnerabilityProfile.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(AntiSpywareProfile))
            {
                ...
                if (AntiSpywareProfile.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(AntiVirusProfile))
            {
                ...
                if (AntiVirusProfile.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(UrlFilteringProfile))
            {
                ...
                if (UrlFilteringProfile.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(FileBlockingProfile))
            {
                ...
                if (FileBlockingProfile.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(DnsSubscription))
            {
                ...
                if (DnsSubscription.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(OutboundUnTrustCertificate))
            {
                ...
                if (OutboundUnTrustCertificate.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(OutboundTrustCertificate))
            {
                ...
                if (OutboundTrustCertificate.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
