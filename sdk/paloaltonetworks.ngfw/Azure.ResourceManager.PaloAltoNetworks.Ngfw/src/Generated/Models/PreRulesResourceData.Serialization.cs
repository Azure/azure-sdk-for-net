...
{
    public partial class PreRulesResourceData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PreRulesResourceData DeserializePreRulesResourceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
