...
{
    public partial class PaloAltoNetworksFirewallStatusData : IUtf8JsonSerializable, IJsonModel<PaloAltoNetworksFirewallStatusData>, IPersistableModel<PaloAltoNetworksFirewallStatusData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PaloAltoNetworksFirewallStatusData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  isPanoramaManaged:");
                builder.AppendLine($" '{IsPanoramaManaged.ToString()}'");
            }
            ...
            {
                builder.Append("  healthReason:");
                builder.AppendLine($" '{HealthReason}'");
            }

            if (Optional.IsDefined(PanoramaStatus))
            {
                builder.Append("  panoramaStatus:");
                AppendChildObject(builder, PanoramaStatus, options, 2);
            }
