...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PaloAltoNetworksFirewallStatusData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PaloAltoNetworksFirewallStatusData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PaloAltoNetworksFirewallStatusData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PaloAltoNetworksFirewallStatusData>)} interface");
            }
        ...
        string IPersistableModel<PaloAltoNetworksFirewallStatusData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
