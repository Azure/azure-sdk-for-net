...
{
    public partial class PostRulestackRuleData : IUtf8JsonSerializable, IJsonModel<PostRulestackRuleData>, IPersistableModel<PostRulestackRuleData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostRulestackRuleData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PostRulestackRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PostRulestackRuleData)} does not support '{format}' format.");
            }
