...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PostRulestackRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PostRulestackRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PostRulestackRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PostRulestackRuleData>)} interface");
            }
        ...
        string IPersistableModel<PostRulestackRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
