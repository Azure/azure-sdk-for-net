...
{
    public partial class PostRulestackRuleData : IUtf8JsonSerializable, IModelJsonSerializable<PostRulestackRuleData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IModelJsonSerializable<PostRulestackRuleData>)this).Serialize(writer, ModelSerializerOptions.DefaultWireOptions);

        void IModelJsonSerializable<PostRulestackRuleData>.Serialize(Utf8JsonWriter writer, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostRulestackRuleData>(this, options.Format);
        ...
        internal static PostRulestackRuleData DeserializePostRulestackRuleData(JsonElement element, ModelSerializerOptions options = default)
        {
        ...
        PostRulestackRuleData IModelJsonSerializable<PostRulestackRuleData>.Deserialize(ref Utf8JsonReader reader, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostRulestackRuleData>(this, options.Format);

            using var doc = JsonDocument.ParseValue(ref reader);
            return DeserializePostRulestackRuleData(doc.RootElement, options);
        }

        BinaryData IModelSerializable<PostRulestackRuleData>.Serialize(ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostRulestackRuleData>(this, options.Format);
        ...
        PostRulestackRuleData IModelSerializable<PostRulestackRuleData>.Deserialize(BinaryData data, ModelSerializerOptions options)
        {
            Core.ModelSerializerHelper.ValidateFormat<PostRulestackRuleData>(this, options.Format);
        ...
        /// <summary> Converts a <see cref="PostRulestackRuleData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PostRulestackRuleData"/> to convert. </param>
        public static implicit operator RequestContent(PostRulestackRuleData model)
        {
            if (model is null)
            {
                return null;
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PostRulestackRuleData"/>. </summary>
        /// <param name="response"> The <see cref="Response"/> to convert. </param>
        public static explicit operator PostRulestackRuleData(Response response)
        {
            if (response is null)
            {
                return null;
            ...
            return DeserializePostRulestackRuleData(doc.RootElement, ModelSerializerOptions.DefaultWireOptions);
        }
    }
}
