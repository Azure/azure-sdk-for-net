...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class StorageAccountConfiguration
    {
        ...
        internal StorageAccountConfiguration(ResourceIdentifier id, string subscriptionId, string accountName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
