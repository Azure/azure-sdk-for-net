...
{
    public partial class GlobalRulestackInfo : IUtf8JsonSerializable, IJsonModel<GlobalRulestackInfo>, IPersistableModel<GlobalRulestackInfo>
    {
        ...
        void IJsonModel<GlobalRulestackInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GlobalRulestackInfo)} does not support '{format}' format.");
            }
