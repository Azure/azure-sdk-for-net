...
{
    public partial class RulestackTagInfo : IUtf8JsonSerializable, IJsonModel<RulestackTagInfo>, IPersistableModel<RulestackTagInfo>
    {
        ...
        void IJsonModel<RulestackTagInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RulestackTagInfo)} does not support '{format}' format.");
            }
