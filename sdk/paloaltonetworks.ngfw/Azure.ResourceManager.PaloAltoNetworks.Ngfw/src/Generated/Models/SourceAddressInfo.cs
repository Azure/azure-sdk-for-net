...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class SourceAddressInfo
    {
        ...
        internal SourceAddressInfo(IList<string> cidrs, IList<string> countries, IList<string> feeds, IList<string> prefixLists, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Cidrs = cidrs;
            Countries = countries;
            Feeds = feeds;
