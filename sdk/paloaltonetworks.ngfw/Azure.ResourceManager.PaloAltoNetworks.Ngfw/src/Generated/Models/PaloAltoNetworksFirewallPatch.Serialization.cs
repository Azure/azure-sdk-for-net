...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PaloAltoNetworksFirewallPatch>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PaloAltoNetworksFirewallPatch>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PaloAltoNetworksFirewallPatch>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PaloAltoNetworksFirewallPatch>)} interface");
            }
        ...
        string IPersistableModel<PaloAltoNetworksFirewallPatch>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
