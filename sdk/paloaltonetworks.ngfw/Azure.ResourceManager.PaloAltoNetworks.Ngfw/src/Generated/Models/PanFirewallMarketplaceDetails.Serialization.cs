...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PanFirewallMarketplaceDetails>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PanFirewallMarketplaceDetails>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PanFirewallMarketplaceDetails>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PanFirewallMarketplaceDetails>)} interface");
            }
        ...
        string IPersistableModel<PanFirewallMarketplaceDetails>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
