...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class FirewallVnetConfiguration
    {
        ...
        internal FirewallVnetConfiguration(IPAddressSpaceInfo vnet, IPAddressSpaceInfo trustSubnet, IPAddressSpaceInfo unTrustSubnet, IPAddressInfo ipOfTrustSubnetForUdr, Dictionary<string, BinaryData> rawData)
        {
            Vnet = vnet;
            TrustSubnet = trustSubnet;
            UnTrustSubnet = unTrustSubnet;
