...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AdvancedSecurityObjectListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AdvancedSecurityObjectListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AdvancedSecurityObjectListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AdvancedSecurityObjectListResult>)} interface");
            }
        ...
        string IPersistableModel<AdvancedSecurityObjectListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
