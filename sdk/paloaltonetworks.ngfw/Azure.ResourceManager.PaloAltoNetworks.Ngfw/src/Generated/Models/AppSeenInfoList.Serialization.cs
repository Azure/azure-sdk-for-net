...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AppSeenInfoList>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AppSeenInfoList>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AppSeenInfoList>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AppSeenInfoList>)} interface");
            }
        ...
        string IPersistableModel<AppSeenInfoList>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
