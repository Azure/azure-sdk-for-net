...
{
    public partial class AppSeenInfoList : IUtf8JsonSerializable, IJsonModel<AppSeenInfoList>, IPersistableModel<AppSeenInfoList>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(AppSeenList))
            {
                builder.Append("  appSeenList:");
                builder.AppendLine(" [");
                foreach (var item in AppSeenList)
                {
