...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PredefinedUrlCategory>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PredefinedUrlCategory>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PredefinedUrlCategory>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PredefinedUrlCategory>)} interface");
            }
        ...
        string IPersistableModel<PredefinedUrlCategory>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
