...
{
    public partial class LocalRulestackPrefixData : IUtf8JsonSerializable, IJsonModel<LocalRulestackPrefixData>, IPersistableModel<LocalRulestackPrefixData>
    {
        ...
        void IJsonModel<LocalRulestackPrefixData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LocalRulestackPrefixData)} does not support '{format}' format.");
            }
