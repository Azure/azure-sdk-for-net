...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalRulestackPrefixData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LocalRulestackPrefixData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LocalRulestackPrefixData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocalRulestackPrefixData>)} interface");
            }
        ...
        string IPersistableModel<LocalRulestackPrefixData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
