...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RulestackChangelog>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RulestackChangelog>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RulestackChangelog>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RulestackChangelog>)} interface");
            }
        ...
        string IPersistableModel<RulestackChangelog>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
