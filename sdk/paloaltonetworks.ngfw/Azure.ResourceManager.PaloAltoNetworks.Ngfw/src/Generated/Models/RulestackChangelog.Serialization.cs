...
{
    public partial class RulestackChangelog : IUtf8JsonSerializable, IJsonModel<RulestackChangelog>, IPersistableModel<RulestackChangelog>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(LastCommittedOn))
            {
                ...
                builder.AppendLine($" '{LastCommittedOn.Value.ToString()}'");
            }
