...
{
    public partial class MonitorLog : IUtf8JsonSerializable
    {
        ...
        internal static MonitorLog DeserializeMonitorLog(JsonElement element)
        {
            ...
            return new MonitorLog(id.Value, subscriptionId.Value, workspace.Value, primaryKey.Value, secondaryKey.Value);
        }
    }
}
