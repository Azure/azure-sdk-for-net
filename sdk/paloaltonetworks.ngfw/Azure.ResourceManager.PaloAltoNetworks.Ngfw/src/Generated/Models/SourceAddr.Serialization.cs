...
{
    public partial class SourceAddr : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SourceAddr DeserializeSourceAddr(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
