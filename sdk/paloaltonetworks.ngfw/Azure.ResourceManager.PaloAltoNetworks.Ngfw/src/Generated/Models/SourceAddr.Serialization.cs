...
{
    public partial class SourceAddr : IUtf8JsonSerializable
    {
        ...
        internal static SourceAddr DeserializeSourceAddr(JsonElement element)
        {
            ...
            return new SourceAddr(Optional.ToList(cidrs), Optional.ToList(countries), Optional.ToList(feeds), Optional.ToList(prefixLists));
        }
    }
}
