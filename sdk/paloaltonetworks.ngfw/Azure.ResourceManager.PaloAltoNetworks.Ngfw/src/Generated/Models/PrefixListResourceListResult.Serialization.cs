...
{
    internal partial class PrefixListResourceListResult : IUtf8JsonSerializable, IJsonModel<PrefixListResourceListResult>, IPersistableModel<PrefixListResourceListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PrefixListResourceListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<PrefixListResourceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(PrefixListResourceListResult)} does not support '{format}' format.");
            }
