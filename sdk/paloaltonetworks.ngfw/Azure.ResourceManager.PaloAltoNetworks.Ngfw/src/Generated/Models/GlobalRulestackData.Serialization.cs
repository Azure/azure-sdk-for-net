...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GlobalRulestackData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GlobalRulestackData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GlobalRulestackData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GlobalRulestackData>)} interface");
            }
        ...
        string IPersistableModel<GlobalRulestackData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
