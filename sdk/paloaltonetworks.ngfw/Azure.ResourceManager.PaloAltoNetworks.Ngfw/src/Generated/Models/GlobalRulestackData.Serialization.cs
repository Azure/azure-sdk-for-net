...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    public partial class GlobalRulestackData : IUtf8JsonSerializable, IJsonModel<GlobalRulestackData>
    {
        ...
        void IJsonModel<GlobalRulestackData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GlobalRulestackData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GlobalRulestackData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GlobalRulestackData)} does not support '{options.Format}' format.");
            }
        }
