...
{
    public partial class FirewallResourceData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FirewallResourceData DeserializeFirewallResourceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
