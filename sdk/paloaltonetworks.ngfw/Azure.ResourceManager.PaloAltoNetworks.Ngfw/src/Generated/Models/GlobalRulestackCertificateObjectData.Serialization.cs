...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    public partial class GlobalRulestackCertificateObjectData : IUtf8JsonSerializable, IJsonModel<GlobalRulestackCertificateObjectData>
    {
        ...
        void IJsonModel<GlobalRulestackCertificateObjectData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GlobalRulestackCertificateObjectData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GlobalRulestackCertificateObjectData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GlobalRulestackCertificateObjectData)} does not support '{options.Format}' format.");
            }
        }
