...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalRulestackCertificateObjectData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LocalRulestackCertificateObjectData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LocalRulestackCertificateObjectData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocalRulestackCertificateObjectData>)} interface");
            }
        ...
        string IPersistableModel<LocalRulestackCertificateObjectData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
