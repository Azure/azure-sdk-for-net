...
{
    public partial class LocalRulestackCertificateObjectData : Core.IUtf8JsonSerializable
    {
        ...
        internal static LocalRulestackCertificateObjectData DeserializeLocalRulestackCertificateObjectData(JsonElement element)
        {
            ...
            return new LocalRulestackCertificateObjectData(id, name, type, systemData.Value, certificateSignerResourceId.Value, certificateSelfSigned, auditComment.Value, description.Value, Core.Optional.ToNullable(etag), Core.Optional.ToNullable(provisioningState));
        }
    }
}
