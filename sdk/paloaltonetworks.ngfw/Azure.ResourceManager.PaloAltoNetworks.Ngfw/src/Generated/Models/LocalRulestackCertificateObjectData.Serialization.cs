...
{
    public partial class LocalRulestackCertificateObjectData : IUtf8JsonSerializable, IJsonModel<LocalRulestackCertificateObjectData>, IPersistableModel<LocalRulestackCertificateObjectData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(CertificateSignerResourceId))
            {
                builder.Append("  certificateSignerResourceId:");
                builder.AppendLine($" '{CertificateSignerResourceId}'");
            }

            if (Optional.IsDefined(CertificateSelfSigned))
            {
                builder.Append("  certificateSelfSigned:");
                builder.AppendLine($" '{CertificateSelfSigned.ToString()}'");
            }
