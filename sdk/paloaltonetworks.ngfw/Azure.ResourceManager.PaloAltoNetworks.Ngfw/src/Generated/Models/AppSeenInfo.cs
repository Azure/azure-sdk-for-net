...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class AppSeenInfo
    {
        ...
        internal AppSeenInfo(string title, string category, string subCategory, string risk, string tag, string technology, string standardPorts, Dictionary<string, BinaryData> rawData)
        {
            Title = title;
            Category = category;
            SubCategory = subCategory;
