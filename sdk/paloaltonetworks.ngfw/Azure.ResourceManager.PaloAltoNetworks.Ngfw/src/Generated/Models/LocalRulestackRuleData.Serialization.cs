...
{
    public partial class LocalRulestackRuleData : Core.IUtf8JsonSerializable
    {
        ...
        internal static LocalRulestackRuleData DeserializeLocalRulestackRuleData(JsonElement element)
        {
