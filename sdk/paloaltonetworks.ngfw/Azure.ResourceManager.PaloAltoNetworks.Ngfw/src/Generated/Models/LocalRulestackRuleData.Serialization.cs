...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalRulestackRuleData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LocalRulestackRuleData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LocalRulestackRuleData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocalRulestackRuleData>)} interface");
            }
        ...
        string IPersistableModel<LocalRulestackRuleData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
