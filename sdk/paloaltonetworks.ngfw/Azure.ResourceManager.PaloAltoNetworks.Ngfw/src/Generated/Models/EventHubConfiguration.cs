...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class EventHubConfiguration
    {
        ...
        internal EventHubConfiguration(ResourceIdentifier id, string subscriptionId, string name, string nameSpace, string policyName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
