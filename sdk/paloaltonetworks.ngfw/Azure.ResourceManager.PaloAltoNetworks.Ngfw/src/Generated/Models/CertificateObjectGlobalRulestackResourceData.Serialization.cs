...
{
    public partial class CertificateObjectGlobalRulestackResourceData : IUtf8JsonSerializable
    {
        ...
        internal static CertificateObjectGlobalRulestackResourceData DeserializeCertificateObjectGlobalRulestackResourceData(JsonElement element)
        {
            ...
            return new CertificateObjectGlobalRulestackResourceData(id, name, type, systemData.Value, certificateSignerResourceId.Value, certificateSelfSigned, auditComment.Value, description.Value, Optional.ToNullable(etag), Optional.ToNullable(provisioningState));
        }
    }
}
