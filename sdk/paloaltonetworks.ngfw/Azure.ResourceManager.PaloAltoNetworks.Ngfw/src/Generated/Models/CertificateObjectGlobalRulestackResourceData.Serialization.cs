...
{
    public partial class CertificateObjectGlobalRulestackResourceData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CertificateObjectGlobalRulestackResourceData DeserializeCertificateObjectGlobalRulestackResourceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
