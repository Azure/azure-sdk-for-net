...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class MonitorLogConfiguration
    {
        ...
        internal MonitorLogConfiguration(ResourceIdentifier id, string subscriptionId, string workspace, string primaryKey, string secondaryKey, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
