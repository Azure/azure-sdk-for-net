...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class MonitorLogConfiguration
    {
        ...
        internal MonitorLogConfiguration(ResourceIdentifier id, string subscriptionId, string workspace, string primaryKey, string secondaryKey, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
