...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class RulestackChangelog
    {
        ...
        internal RulestackChangelog(IReadOnlyList<string> changes, DateTimeOffset? lastCommittedOn, DateTimeOffset? lastModifiedOn, Dictionary<string, BinaryData> rawData)
        {
            Changes = changes;
