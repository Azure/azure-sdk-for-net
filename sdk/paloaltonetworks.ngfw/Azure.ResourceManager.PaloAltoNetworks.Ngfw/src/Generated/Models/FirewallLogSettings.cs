...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class FirewallLogSettings
    {
        ...
        internal FirewallLogSettings(FirewallLogType? logType, FirewallLogOption? logOption, FirewallApplicationInsights applicationInsights, FirewallLogDestination commonDestination, FirewallLogDestination trafficLogDestination, FirewallLogDestination threatLogDestination, FirewallLogDestination decryptLogDestination, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            LogType = logType;
            LogOption = logOption;
