...
{
    public partial class FrontendSetting : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static FrontendSetting DeserializeFrontendSetting(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
