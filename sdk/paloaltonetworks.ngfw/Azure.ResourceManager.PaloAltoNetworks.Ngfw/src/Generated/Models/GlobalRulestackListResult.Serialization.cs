...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GlobalRulestackListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GlobalRulestackListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GlobalRulestackListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GlobalRulestackListResult>)} interface");
            }
        ...
        string IPersistableModel<GlobalRulestackListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
