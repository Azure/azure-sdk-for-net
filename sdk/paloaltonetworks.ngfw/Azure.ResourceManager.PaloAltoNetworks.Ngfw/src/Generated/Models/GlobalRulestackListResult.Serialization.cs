...
{
    internal partial class GlobalRulestackListResult : IUtf8JsonSerializable, IJsonModel<GlobalRulestackListResult>, IPersistableModel<GlobalRulestackListResult>
    {
        ...
        void IJsonModel<GlobalRulestackListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GlobalRulestackListResult)} does not support '{format}' format.");
            }
