...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    public partial class AppSeenInfo : IUtf8JsonSerializable, IJsonModel<AppSeenInfo>
    {
        ...
        void IJsonModel<AppSeenInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(AppSeenInfo)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SubCategory))
            {
                ...
                if (SubCategory.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            {
                builder.Append("  risk:");
                if (Risk.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(Technology))
            {
                ...
                if (Technology.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
            ...
            if (Optional.IsDefined(StandardPorts))
            {
                ...
                if (StandardPorts.Contains(Environment.NewLine))
                {
                    builder.AppendLine(" '''");
