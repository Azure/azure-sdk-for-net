...
{
    public partial class FirewallDnsSettings : IUtf8JsonSerializable, IJsonModel<FirewallDnsSettings>, IPersistableModel<FirewallDnsSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(EnableDnsProxy))
            {
                builder.Append("  enableDnsProxy:");
                builder.AppendLine($" '{EnableDnsProxy.ToString()}'");
            }

            if (Optional.IsDefined(EnabledDnsType))
            {
                builder.Append("  enabledDnsType:");
                builder.AppendLine($" '{EnabledDnsType.ToString()}'");
            }
