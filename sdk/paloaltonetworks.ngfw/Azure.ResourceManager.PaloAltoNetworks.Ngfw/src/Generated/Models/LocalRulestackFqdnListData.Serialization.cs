...
{
    public partial class LocalRulestackFqdnListData : IUtf8JsonSerializable
    {
        ...
        internal static LocalRulestackFqdnListData DeserializeLocalRulestackFqdnListData(JsonElement element)
        {
            ...
            return new LocalRulestackFqdnListData(id, name, type, systemData.Value, description.Value, fqdnList, Optional.ToNullable(etag), auditComment.Value, Optional.ToNullable(provisioningState));
        }
    }
}
