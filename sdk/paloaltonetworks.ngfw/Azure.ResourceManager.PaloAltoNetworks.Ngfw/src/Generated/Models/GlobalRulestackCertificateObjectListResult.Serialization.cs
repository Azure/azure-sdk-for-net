...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GlobalRulestackCertificateObjectListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GlobalRulestackCertificateObjectListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GlobalRulestackCertificateObjectListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GlobalRulestackCertificateObjectListResult>)} interface");
            }
        ...
        string IPersistableModel<GlobalRulestackCertificateObjectListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
