...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    internal partial class GlobalRulestackCertificateObjectListResult : IUtf8JsonSerializable, IModelJsonSerializable<GlobalRulestackCertificateObjectListResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<GlobalRulestackCertificateObjectListResult>(this, options.Format);
            ...
            foreach (var item in Value)
            {
                ...
                {
                    ((IModelJsonSerializable<GlobalRulestackCertificateObjectData>)item).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="GlobalRulestackCertificateObjectListResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="GlobalRulestackCertificateObjectListResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="GlobalRulestackCertificateObjectListResult"/>. </summary>
