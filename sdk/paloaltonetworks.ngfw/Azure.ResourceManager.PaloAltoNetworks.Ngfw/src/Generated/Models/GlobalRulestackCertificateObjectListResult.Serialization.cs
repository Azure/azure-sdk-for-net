...
{
    internal partial class GlobalRulestackCertificateObjectListResult : IUtf8JsonSerializable, IJsonModel<GlobalRulestackCertificateObjectListResult>, IPersistableModel<GlobalRulestackCertificateObjectListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GlobalRulestackCertificateObjectListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<GlobalRulestackCertificateObjectListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GlobalRulestackCertificateObjectListResult)} does not support '{format}' format.");
            }
