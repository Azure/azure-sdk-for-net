...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SourceAddressInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SourceAddressInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SourceAddressInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SourceAddressInfo>)} interface");
            }
        ...
        string IPersistableModel<SourceAddressInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
