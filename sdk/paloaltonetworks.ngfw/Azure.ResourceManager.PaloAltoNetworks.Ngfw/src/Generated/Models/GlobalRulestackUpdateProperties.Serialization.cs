...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GlobalRulestackUpdateProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GlobalRulestackUpdateProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GlobalRulestackUpdateProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<GlobalRulestackUpdateProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
