...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    public partial class GlobalRulestackUpdateProperties : IUtf8JsonSerializable, IJsonModel<GlobalRulestackUpdateProperties>
    {
        ...
        void IJsonModel<GlobalRulestackUpdateProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(GlobalRulestackUpdateProperties)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<GlobalRulestackUpdateProperties>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(GlobalRulestackUpdateProperties)} does not support '{options.Format}' format.");
            }
        }
