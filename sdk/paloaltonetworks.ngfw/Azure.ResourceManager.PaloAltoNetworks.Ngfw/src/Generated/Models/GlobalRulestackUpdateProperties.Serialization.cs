...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    public partial class GlobalRulestackUpdateProperties : IUtf8JsonSerializable, IJsonModel<GlobalRulestackUpdateProperties>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<GlobalRulestackUpdateProperties>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GlobalRulestackUpdateProperties>)} interface");
            }
