...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<IPAddressSpaceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<IPAddressSpaceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<IPAddressSpaceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<IPAddressSpaceInfo>)} interface");
            }
        ...
        string IPersistableModel<IPAddressSpaceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
