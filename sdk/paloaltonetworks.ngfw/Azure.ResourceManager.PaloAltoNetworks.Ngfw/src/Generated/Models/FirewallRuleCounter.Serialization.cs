...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<FirewallRuleCounter>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<FirewallRuleCounter>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<FirewallRuleCounter>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<FirewallRuleCounter>)} interface");
            }
        ...
        string IPersistableModel<FirewallRuleCounter>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
