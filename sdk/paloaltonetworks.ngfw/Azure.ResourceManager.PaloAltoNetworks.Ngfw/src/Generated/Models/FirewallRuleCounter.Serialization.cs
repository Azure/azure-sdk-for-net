...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class FirewallRuleCounter : IJsonModel<FirewallRuleCounter>
    {
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="FirewallRuleCounter"/> from. </param>
        internal static FirewallRuleCounter FromResponse(Response response)
        {
