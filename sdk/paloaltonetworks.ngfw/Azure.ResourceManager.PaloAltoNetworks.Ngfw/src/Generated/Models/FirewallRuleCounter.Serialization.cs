...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    public partial class FirewallRuleCounter : IUtf8JsonSerializable, IModelJsonSerializable<FirewallRuleCounter>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<FirewallRuleCounter>(this, options.Format);
            ...
            if (Optional.IsDefined(AppSeen))
            {
                ...
                {
                    ((IModelJsonSerializable<AppSeenInfoList>)AppSeen).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="FirewallRuleCounter"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="FirewallRuleCounter"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="FirewallRuleCounter"/>. </summary>
