...
{
    public partial class FirewallFrontendSetting : IUtf8JsonSerializable, IJsonModel<FirewallFrontendSetting>, IPersistableModel<FirewallFrontendSetting>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FrontendConfiguration))
            {
                builder.Append("  frontendConfiguration:");
                AppendChildObject(builder, FrontendConfiguration, options, 2);
            }

            if (Optional.IsDefined(BackendConfiguration))
            {
                builder.Append("  backendConfiguration:");
                AppendChildObject(builder, BackendConfiguration, options, 2);
            }
