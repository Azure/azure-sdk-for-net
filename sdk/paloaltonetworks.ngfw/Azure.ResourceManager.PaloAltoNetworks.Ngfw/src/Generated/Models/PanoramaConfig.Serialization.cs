...
{
    public partial class PanoramaConfig : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PanoramaConfig DeserializePanoramaConfig(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
