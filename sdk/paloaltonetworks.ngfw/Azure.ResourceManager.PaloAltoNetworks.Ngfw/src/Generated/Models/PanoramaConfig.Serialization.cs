...
{
    public partial class PanoramaConfig : IUtf8JsonSerializable
    {
        ...
        internal static PanoramaConfig DeserializePanoramaConfig(JsonElement element)
        {
            ...
            return new PanoramaConfig(configString, vmAuthKey.Value, panoramaServer.Value, panoramaServer2.Value, dgName.Value, tplName.Value, cgName.Value, hostName.Value);
        }
    }
}
