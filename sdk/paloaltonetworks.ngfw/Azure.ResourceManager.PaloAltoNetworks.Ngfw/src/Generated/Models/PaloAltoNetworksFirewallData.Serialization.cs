...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PaloAltoNetworksFirewallData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PaloAltoNetworksFirewallData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PaloAltoNetworksFirewallData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PaloAltoNetworksFirewallData>)} interface");
            }
        ...
        string IPersistableModel<PaloAltoNetworksFirewallData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
