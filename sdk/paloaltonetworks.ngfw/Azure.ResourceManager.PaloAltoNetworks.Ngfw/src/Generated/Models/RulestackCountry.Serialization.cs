...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RulestackCountry>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RulestackCountry>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RulestackCountry>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<RulestackCountry>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
