...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class FirewallRuleResetConter
    {
        ...
        internal FirewallRuleResetConter(string priority, string ruleStackName, string ruleListName, string firewallName, string ruleName, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Priority = priority;
