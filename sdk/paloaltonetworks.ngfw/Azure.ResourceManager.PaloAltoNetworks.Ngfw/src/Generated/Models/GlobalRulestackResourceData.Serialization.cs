...
{
    public partial class GlobalRulestackResourceData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static GlobalRulestackResourceData DeserializeGlobalRulestackResourceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
