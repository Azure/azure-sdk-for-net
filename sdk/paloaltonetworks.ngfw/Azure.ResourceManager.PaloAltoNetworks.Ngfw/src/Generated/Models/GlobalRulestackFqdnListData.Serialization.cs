...
{
    public partial class GlobalRulestackFqdnListData : IUtf8JsonSerializable
    {
        ...
        internal static GlobalRulestackFqdnListData DeserializeGlobalRulestackFqdnListData(JsonElement element)
        {
            ...
            return new GlobalRulestackFqdnListData(id, name, type, systemData.Value, description.Value, fqdnList, Optional.ToNullable(etag), auditComment.Value, Optional.ToNullable(provisioningState));
        }
    }
}
