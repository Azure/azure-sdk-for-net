...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RulestackSecurityServiceListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RulestackSecurityServiceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RulestackSecurityServiceListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RulestackSecurityServiceListResult>)} interface");
            }
        ...
        string IPersistableModel<RulestackSecurityServiceListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
