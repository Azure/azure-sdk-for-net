...
{
    public partial class PostRulesResourceData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PostRulesResourceData DeserializePostRulesResourceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
