...
{
    public partial class SecurityServices : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static SecurityServices DeserializeSecurityServices(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
