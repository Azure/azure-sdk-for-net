...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class GlobalRulestackUpdateProperties
    {
        ...
        internal GlobalRulestackUpdateProperties(string panEtag, string panLocation, RulestackScopeType? scope, IList<string> associatedSubscriptions, string description, RuleCreationDefaultMode? defaultMode, string minAppIdVersion, RulestackSecurityServices securityServices, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            PanEtag = panEtag;
