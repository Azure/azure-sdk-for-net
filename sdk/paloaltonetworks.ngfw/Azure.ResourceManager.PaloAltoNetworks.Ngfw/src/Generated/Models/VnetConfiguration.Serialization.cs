...
{
    public partial class VnetConfiguration : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static VnetConfiguration DeserializeVnetConfiguration(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
