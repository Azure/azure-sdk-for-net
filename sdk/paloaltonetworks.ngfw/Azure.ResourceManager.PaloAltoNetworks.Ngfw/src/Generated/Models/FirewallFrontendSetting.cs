...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public partial class FirewallFrontendSetting
    {
        ...
        internal FirewallFrontendSetting(string name, FirewallProtocolType protocol, FirewallEndpointConfiguration frontendConfiguration, FirewallEndpointConfiguration backendConfiguration, Dictionary<string, BinaryData> rawData)
        {
            Name = name;
            Protocol = protocol;
            FrontendConfiguration = frontendConfiguration;
