...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GlobalRulestackFqdnData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GlobalRulestackFqdnData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GlobalRulestackFqdnData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GlobalRulestackFqdnData>)} interface");
            }
        ...
        string IPersistableModel<GlobalRulestackFqdnData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
