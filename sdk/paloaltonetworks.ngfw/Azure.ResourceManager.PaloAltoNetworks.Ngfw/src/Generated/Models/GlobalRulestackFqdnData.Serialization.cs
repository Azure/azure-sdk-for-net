...
{
    public partial class GlobalRulestackFqdnData : IUtf8JsonSerializable
    {
        ...
        internal static GlobalRulestackFqdnData DeserializeGlobalRulestackFqdnData(JsonElement element)
        {
            ...
            return new GlobalRulestackFqdnData(id, name, type, systemData.Value, description.Value, fqdnList, Optional.ToNullable(etag), auditComment.Value, Optional.ToNullable(provisioningState));
        }
    }
}
