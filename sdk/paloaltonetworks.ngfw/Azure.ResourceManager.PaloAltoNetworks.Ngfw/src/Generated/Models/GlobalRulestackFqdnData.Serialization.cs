...
{
    public partial class GlobalRulestackFqdnData : Core.IUtf8JsonSerializable
    {
        ...
        internal static GlobalRulestackFqdnData DeserializeGlobalRulestackFqdnData(JsonElement element)
        {
            ...
            return new GlobalRulestackFqdnData(id, name, type, systemData.Value, description.Value, fqdnList, Core.Optional.ToNullable(etag), auditComment.Value, Core.Optional.ToNullable(provisioningState));
        }
    }
}
