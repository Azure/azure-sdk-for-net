...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    {
        internal static FirewallRuleResetConter DeserializeFirewallRuleResetConter(JsonElement element)
        {
            ...
            return new FirewallRuleResetConter(priority.Value, ruleStackName.Value, ruleListName.Value, firewallName.Value, ruleName.Value);
        }
    }
}
