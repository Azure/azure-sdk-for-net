...
{
    public partial class EdlMatchCategory : IUtf8JsonSerializable, IJsonModel<EdlMatchCategory>, IPersistableModel<EdlMatchCategory>
    {
        ...
        void IJsonModel<EdlMatchCategory>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(EdlMatchCategory)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(UrlCustom))
            {
                builder.Append("  urlCustom:");
                builder.AppendLine(" [");
                foreach (var item in UrlCustom)
                {
                    if (item == null)
