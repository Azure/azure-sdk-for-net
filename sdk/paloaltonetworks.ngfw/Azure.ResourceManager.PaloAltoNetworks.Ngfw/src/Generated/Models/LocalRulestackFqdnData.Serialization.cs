...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<LocalRulestackFqdnData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<LocalRulestackFqdnData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<LocalRulestackFqdnData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<LocalRulestackFqdnData>)} interface");
            }
        ...
        string IPersistableModel<LocalRulestackFqdnData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
