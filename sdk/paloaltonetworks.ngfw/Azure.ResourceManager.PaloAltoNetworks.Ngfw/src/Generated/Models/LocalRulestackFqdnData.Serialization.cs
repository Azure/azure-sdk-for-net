...
{
    public partial class LocalRulestackFqdnData : IUtf8JsonSerializable, IJsonModel<LocalRulestackFqdnData>, IPersistableModel<LocalRulestackFqdnData>
    {
        ...
        void IJsonModel<LocalRulestackFqdnData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LocalRulestackFqdnData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(FqdnList))
            {
                builder.Append("  fqdnList:");
                builder.AppendLine(" [");
                foreach (var item in FqdnList)
                {
                    if (item == null)
