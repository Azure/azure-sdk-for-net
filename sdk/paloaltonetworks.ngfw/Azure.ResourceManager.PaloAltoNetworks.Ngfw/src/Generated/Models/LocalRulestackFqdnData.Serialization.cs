...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    public partial class LocalRulestackFqdnData : IUtf8JsonSerializable, IJsonModel<LocalRulestackFqdnData>
    {
        ...
        void IJsonModel<LocalRulestackFqdnData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(LocalRulestackFqdnData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<LocalRulestackFqdnData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(LocalRulestackFqdnData)} does not support '{options.Format}' format.");
            }
        }
