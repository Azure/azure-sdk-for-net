...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    public partial class LocalRulestackResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<LocalRulestackResource>> UpdateAsync(WaitUntil waitUntil, LocalRulestackData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _localRulestacksRestClient.CreateCreateOrUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, LocalRulestackData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<LocalRulestackResource> Update(WaitUntil waitUntil, LocalRulestackData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
