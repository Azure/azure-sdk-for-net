...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    public partial class LocalRulestackResource : ArmResource
    {
        ...
        {
            using DiagnosticScope scope = _localRulestacksClientDiagnostics.CreateScope("LocalRulestackResource.GetFirewalls");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _localRulestacksRestClient.CreateGetFirewallsRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
