...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    public partial class GlobalRulestackResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<GlobalRulestackResource>> UpdateAsync(WaitUntil waitUntil, GlobalRulestackData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _globalRulestackRestClient.CreateCreateOrUpdateRequest(Id.Name, GlobalRulestackData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<GlobalRulestackResource> Update(WaitUntil waitUntil, GlobalRulestackData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
