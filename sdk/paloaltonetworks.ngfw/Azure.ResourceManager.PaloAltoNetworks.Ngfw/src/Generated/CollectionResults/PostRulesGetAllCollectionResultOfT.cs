...
{
    internal partial class PostRulesGetAllCollectionResultOfT : Pageable<PostRulestackRuleData>
    {
        ...
        /// <returns> The pages of PostRulesGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<PostRulestackRuleData>> AsPages(string continuationToken, int? pageSizeHint)
        {
            ...
            while (true)
            {
                ...
                PostRulesResourceListResult result = PostRulesResourceListResult.FromResponse(response);
                yield return Page<PostRulestackRuleData>.FromValues((IReadOnlyList<PostRulestackRuleData>)result.Value, nextPage?.IsAbsoluteUri == true ? nextPage.AbsoluteUri : nextPage?.OriginalString, response);
