...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    internal partial class LocalRulestacksGetPredefinedUrlCategoriesCollectionResultOfT : Pageable<PredefinedUrlCategory>
    {
        ...
        public LocalRulestacksGetPredefinedUrlCategoriesCollectionResultOfT(LocalRulestacks client, string subscriptionId, string resourceGroupName, string localRulestackName, string skip, int? maxCount, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
