...
{
    /// <summary>
    /// A class representing the LocalRulestackResource data model.
    /// PaloAltoNetworks LocalRulestack
    /// </summary>
    public partial class LocalRulestackResourceData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of LocalRulestackResourceData. </summary>
        /// <param name="location"> The location. </param>
        public LocalRulestackResourceData(AzureLocation location) : base(location)
        {
