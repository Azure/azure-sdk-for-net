...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw.Models
{
    ...
    public static partial class ArmPaloAltoNetworksNgfwModelFactory
    {
        ...
        public static GlobalRulestackData GlobalRulestackData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, AzureLocation location = default, ManagedServiceIdentity identity = null, ETag? panETag = null, AzureLocation? panLocation = null, RulestackScopeType? scope = null, IEnumerable<string> associatedSubscriptions = null, string description = null, RuleCreationDefaultMode? defaultMode = null, string minAppIdVersion = null, FirewallProvisioningState? provisioningState = null, RulestackSecurityServices securityServices = null)
        {
            ...
            return new GlobalRulestackData(id, name, resourceType, systemData, location, identity, panETag, panLocation, scope, associatedSubscriptions?.ToList(), description, defaultMode, minAppIdVersion, provisioningState, securityServices, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GlobalRulestackCertificateObjectData(id, name, resourceType, systemData, certificateSignerResourceId, certificateSelfSigned, auditComment, description, etag, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static GlobalRulestackFqdnData GlobalRulestackFqdnData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, IEnumerable<string> fqdnList = null, ETag? etag = null, string auditComment = null, FirewallProvisioningState? provisioningState = null)
        {
            ...
            return new GlobalRulestackFqdnData(id, name, resourceType, systemData, description, fqdnList?.ToList(), etag, auditComment, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static RulestackChangelog RulestackChangelog(IEnumerable<string> changes = null, DateTimeOffset? lastCommittedOn = null, DateTimeOffset? lastModifiedOn = null)
        {
            ...
            return new RulestackChangelog(changes?.ToList(), lastCommittedOn, lastModifiedOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AdvancedSecurityObjectListResult(value, nextLink, new Dictionary<string, BinaryData>());
        }
        ...
        public static AdvancedSecurityObject AdvancedSecurityObject(string advSecurityObjectModelType = null, IEnumerable<NameDescriptionObject> entry = null)
        {
            ...
            return new AdvancedSecurityObject(advSecurityObjectModelType, entry?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new NameDescriptionObject(name, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RulestackCountry(code, description, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PredefinedUrlCategory(action, name, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new RulestackSecurityServiceListResult(value, nextLink, new Dictionary<string, BinaryData>());
        }
        ...
        public static RulestackSecurityServiceTypeList RulestackSecurityServiceTypeList(string securityServicesTypeListType = null, IEnumerable<NameDescriptionObject> entry = null)
        {
            ...
            return new RulestackSecurityServiceTypeList(securityServicesTypeListType, entry?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirewallRuleCounter(priority, ruleStackName, ruleListName, firewallName, ruleName, hitCount, appSeen, responseOn, requestOn, lastUpdatedOn, new Dictionary<string, BinaryData>());
        }
        ...
        public static AppSeenInfoList AppSeenInfoList(int count = default, IEnumerable<AppSeenInfo> appSeenList = null)
        {
            ...
            return new AppSeenInfoList(count, appSeenList?.ToList(), new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new AppSeenInfo(title, category, subCategory, risk, tag, technology, standardPorts, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirewallRuleResetConter(priority, ruleStackName, ruleListName, firewallName, ruleName, new Dictionary<string, BinaryData>());
        }
        ...
        public static GlobalRulestackPrefixData GlobalRulestackPrefixData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, IEnumerable<string> prefixList = null, ETag? etag = null, string auditComment = null, FirewallProvisioningState? provisioningState = null)
        {
            ...
            return new GlobalRulestackPrefixData(id, name, resourceType, systemData, description, prefixList?.ToList(), etag, auditComment, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static PaloAltoNetworksFirewallData PaloAltoNetworksFirewallData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, ETag? panETag = null, FirewallNetworkProfile networkProfile = null, FirewallBooleanType? isPanoramaManaged = null, FirewallPanoramaConfiguration panoramaConfig = null, RulestackDetails associatedRulestack = null, FirewallDnsSettings dnsSettings = null, IEnumerable<FirewallFrontendSetting> frontEndSettings = null, FirewallProvisioningState? provisioningState = null, FirewallBillingPlanInfo planData = null, PanFirewallMarketplaceDetails marketplaceDetails = null)
        {
            ...
            return new PaloAltoNetworksFirewallData(id, name, resourceType, systemData, tags, location, identity, panETag, networkProfile, isPanoramaManaged, panoramaConfig, associatedRulestack, dnsSettings, frontEndSettings?.ToList(), provisioningState, planData, marketplaceDetails, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirewallPanoramaConfiguration(configString, vmAuthKey, panoramaServer, panoramaServer2, dgName, tplName, cgName, hostName, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirewallBillingPlanInfo(usageType, billingCycle, planId, effectiveOn, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PanFirewallMarketplaceDetails(marketplaceSubscriptionId, offerId, publisherId, marketplaceSubscriptionStatus, new Dictionary<string, BinaryData>());
        }
        ...
        public static LocalRulestackData LocalRulestackData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, IDictionary<string, string> tags = null, AzureLocation location = default, ManagedServiceIdentity identity = null, ETag? panETag = null, AzureLocation? panLocation = null, RulestackScopeType? scope = null, IEnumerable<string> associatedSubscriptions = null, string description = null, RuleCreationDefaultMode? defaultMode = null, string minAppIdVersion = null, FirewallProvisioningState? provisioningState = null, RulestackSecurityServices securityServices = null)
        {
            ...
            return new LocalRulestackData(id, name, resourceType, systemData, tags, location, identity, panETag, panLocation, scope, associatedSubscriptions?.ToList(), description, defaultMode, minAppIdVersion, provisioningState, securityServices, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new GlobalRulestackInfo(azureId, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirewallSupportInfo(productSku, productSerial, accountRegistered, accountId, userDomainSupported, userRegistered, freeTrial, freeTrialDaysLeft, freeTrialCreditLeft, helpURL, supportURL, registerURL, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new PaloAltoNetworksFirewallStatusData(id, name, resourceType, systemData, isPanoramaManaged, healthStatus, healthReason, panoramaStatus, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new FirewallPanoramaStatus(panoramaServerStatus, panoramaServer2Status, new Dictionary<string, BinaryData>());
        }
        ...
        {
            return new LocalRulestackCertificateObjectData(id, name, resourceType, systemData, certificateSignerResourceId, certificateSelfSigned, auditComment, description, etag, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static LocalRulestackFqdnData LocalRulestackFqdnData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, IEnumerable<string> fqdnList = null, ETag? etag = null, string auditComment = null, FirewallProvisioningState? provisioningState = null)
        {
            ...
            return new LocalRulestackFqdnData(id, name, resourceType, systemData, description, fqdnList?.ToList(), etag, auditComment, provisioningState, new Dictionary<string, BinaryData>());
        }
        ...
        public static LocalRulestackPrefixData LocalRulestackPrefixData(ResourceIdentifier id = null, string name = null, ResourceType resourceType = default, SystemData systemData = null, string description = null, IEnumerable<string> prefixList = null, ETag? etag = null, string auditComment = null, FirewallProvisioningState? provisioningState = null)
        {
            ...
            return new LocalRulestackPrefixData(id, name, resourceType, systemData, description, prefixList?.ToList(), etag, auditComment, provisioningState, new Dictionary<string, BinaryData>());
        }
    }
}
