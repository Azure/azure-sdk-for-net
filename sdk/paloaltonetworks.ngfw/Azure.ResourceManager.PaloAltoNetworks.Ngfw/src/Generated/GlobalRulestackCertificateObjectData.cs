...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    public partial class GlobalRulestackCertificateObjectData : ResourceData
    {
        ...
        internal GlobalRulestackCertificateObjectData(string id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CertificateObject properties) : base(id, name, resourceType, systemData)
        {
