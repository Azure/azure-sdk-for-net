...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    public partial class GlobalRulestackFqdnData : ResourceData
    {
        ...
        internal GlobalRulestackFqdnData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, FqdnObject properties) : base(id, name, resourceType, systemData)
        {
