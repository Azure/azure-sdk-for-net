...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    public partial class LocalRulestackRuleData : ResourceData, IJsonModel<LocalRulestackRuleData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LocalRulestackRuleData)} does not support writing '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        LocalRulestackRuleData IJsonModel<LocalRulestackRuleData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (LocalRulestackRuleData)JsonModelCreateCore(ref reader, options);
        ...
        protected virtual ResourceData JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(LocalRulestackRuleData)} does not support reading '{format}' format.");
            }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static LocalRulestackRuleData DeserializeLocalRulestackRuleData(JsonElement element, ModelReaderWriterOptions options)
        {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<LocalRulestackRuleData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        protected virtual BinaryData PersistableModelWriteCore(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(LocalRulestackRuleData)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        /// <param name="localRulestackRuleData"> The <see cref="LocalRulestackRuleData"/> to serialize into <see cref="RequestContent"/>. </param>
        internal static RequestContent ToRequestContent(LocalRulestackRuleData localRulestackRuleData)
        {
            if (localRulestackRuleData == null)
            {
                return null;
            }
        ...
        /// <param name="result"> The <see cref="Response"/> to deserialize the <see cref="LocalRulestackRuleData"/> from. </param>
        internal static LocalRulestackRuleData FromResponse(Response result)
        {
