...
namespace Azure.ResourceManager.PaloAltoNetworks.Ngfw
{
    ...
    public partial class PostRulestackRuleData : ResourceData, IJsonModel<PostRulestackRuleData>
    {
        ...
        internal static RequestContent ToRequestContent(PostRulestackRuleData postRulestackRuleData)
        {
            ...
            return RequestContent.Create(postRulestackRuleData, ModelSerializationExtensions.WireOptions);
        }

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="PostRulestackRuleData"/> from. </param>
        internal static PostRulestackRuleData FromResponse(Response response)
        {
