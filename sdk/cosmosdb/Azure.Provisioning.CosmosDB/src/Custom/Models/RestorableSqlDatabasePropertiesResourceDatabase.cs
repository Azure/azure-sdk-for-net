...
public partial class RestorableSqlDatabasePropertiesResourceDatabase : CosmosDBSqlDatabaseResourceInfo
{
    ...
    /// <summary> Creates a new RestorableSqlDatabasePropertiesResourceDatabase. </summary>
    ...
    protected override void DefineProvisionableProperties()
    {
        ...
        _colls = DefineProperty<string>(nameof(Colls), new string[] { "_colls" }, isOutput: true);
        _users = DefineProperty<string>(nameof(Users), new string[] { "_users" }, isOutput: true);
