...
public partial class GremlinGraph : ProvisionableResource
{
    ...
    private GremlinGraphResourceInfo? _resource;
    ...
    public GremlinGraph(string bicepIdentifier, string? resourceVersion = default)
        : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/gremlinDatabases/graphs", resourceVersion ?? "2025-04-15")
    {
    }

    /// <summary>
    /// Define all the provisionable properties of GremlinGraph.
    /// </summary>
    protected override void DefineProvisionableProperties()
    {
        _name = DefineProperty<string>("Name", ["name"], isRequired: true);
        _location = DefineProperty<AzureLocation>("Location", ["location"], isRequired: true);
        _resource = DefineModelProperty<GremlinGraphResourceInfo>("Resource", ["properties", "resource"], isRequired: true);
        ...
        _parent = DefineResource<GremlinDatabase>("Parent", ["parent"], isRequired: true);
    }
