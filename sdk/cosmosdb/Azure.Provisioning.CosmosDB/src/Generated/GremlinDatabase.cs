...
namespace Azure.Provisioning.CosmosDB
{
    ...
    public partial class GremlinDatabase : ProvisionableResource
    {
        ...
        private GremlinDatabaseProperties _properties;
        private ManagedServiceIdentity _identity;
        private ResourceReference<CosmosDBAccount> _parent;

        /// <summary> Creates a new GremlinDatabase. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public GremlinDatabase(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/gremlinDatabases", resourceVersion ?? "2026-03-15")
        {
        }
        ...
        internal GremlinDatabaseProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for GremlinDatabase. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<GremlinDatabaseProperties>(nameof(Properties), new string[] { "properties" });
        ...
        /// <summary> Creates a reference to an existing GremlinDatabase. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static GremlinDatabase FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            GremlinDatabase result = new GremlinDatabase(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for GremlinDatabase that are not part of the generated code. </summary>
