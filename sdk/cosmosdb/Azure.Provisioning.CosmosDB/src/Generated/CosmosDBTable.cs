...
namespace Azure.Provisioning.CosmosDB
{
    ...
    public partial class CosmosDBTable : ProvisionableResource
    {
        ...
        private CosmosDBTableProperties _properties;
        private ManagedServiceIdentity _identity;
        private ResourceReference<CosmosDBAccount> _parent;

        /// <summary> Creates a new CosmosDBTable. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public CosmosDBTable(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/tables", resourceVersion ?? "2026-03-15")
        {
        }
        ...
        internal CosmosDBTableProperties Properties
        {
            get
            {
                Initialize();
        ...
        public CosmosDBTablePropertiesResource Resource
        {
            ...
            set
            {
                ...
                {
                    Properties = new CosmosDBTableProperties();
                }
        ...
        /// <summary> Define all the provisionable properties for CosmosDBTable. </summary>
        ...
        /// <summary> Creates a reference to an existing CosmosDBTable. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static CosmosDBTable FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            CosmosDBTable result = new CosmosDBTable(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for CosmosDBTable that are not part of the generated code. </summary>
