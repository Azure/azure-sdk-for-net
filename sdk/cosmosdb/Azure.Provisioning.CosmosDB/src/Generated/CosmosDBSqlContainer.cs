...
namespace Azure.Provisioning.CosmosDB
{
    ...
    public partial class CosmosDBSqlContainer : ProvisionableResource
    {
        ...
        private CosmosDBSqlContainerProperties _properties;
        private ManagedServiceIdentity _identity;
        private ResourceReference<CosmosDBSqlDatabase> _parent;

        /// <summary> Creates a new CosmosDBSqlContainer. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public CosmosDBSqlContainer(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/sqlDatabases/containers", resourceVersion ?? "2026-03-15")
        {
        }
        ...
        internal CosmosDBSqlContainerProperties Properties
        {
            get
            {
                Initialize();
        ...
        /// <summary> Define all the provisionable properties for CosmosDBSqlContainer. </summary>
        protected override void DefineProvisionableProperties()
        {
            ...
            _properties = DefineModelProperty<CosmosDBSqlContainerProperties>(nameof(Properties), new string[] { "properties" });
        ...
        /// <summary> Creates a reference to an existing CosmosDBSqlContainer. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static CosmosDBSqlContainer FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            CosmosDBSqlContainer result = new CosmosDBSqlContainer(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for CosmosDBSqlContainer that are not part of the generated code. </summary>
