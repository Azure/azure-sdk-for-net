...
namespace Azure.Provisioning.CosmosDB
{
    ...
    public partial class CosmosDBRegionalService : ProvisionableConstruct
    {
        private BicepValue<string> _name;
        private BicepValue<AzureLocation> _location;
        private BicepValue<CosmosDBServiceStatus> _status;

        /// <summary> Creates a new CosmosDBRegionalService. </summary>
        ...
        /// <summary> Define all the provisionable properties for CosmosDBRegionalService. </summary>
        ...
        /// <summary> Define additional provisionable properties for CosmosDBRegionalService that are not part of the generated code. </summary>
