...
namespace Azure.Provisioning.CosmosDB
{
    ...
    public partial class CosmosDBBaseConfig : ProvisionableConstruct
    {
        private BicepValue<int> _throughput;
        private AutoscaleSettings _autoscaleSettings;

        /// <summary> Creates a new CosmosDBBaseConfig. </summary>
        ...
        /// <summary> Define all the provisionable properties for CosmosDBBaseConfig. </summary>
        ...
        /// <summary> Define additional provisionable properties for CosmosDBBaseConfig that are not part of the generated code. </summary>
