...
namespace Azure.Provisioning.CosmosDB
{
    ...
    public partial class CosmosDBPrivateEndpointConnection : ProvisionableResource
    {
        ...
        /// <summary> Creates a new CosmosDBPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public CosmosDBPrivateEndpointConnection(string bicepIdentifier, string resourceVersion = null) : base(bicepIdentifier, "Microsoft.DocumentDB/databaseAccounts/privateEndpointConnections", resourceVersion ?? "2026-03-15")
        {
        }
        ...
        /// <summary> Define all the provisionable properties for CosmosDBPrivateEndpointConnection. </summary>
        ...
        /// <summary> Creates a reference to an existing CosmosDBPrivateEndpointConnection. </summary>
        /// <param name="bicepIdentifier"> The bicep identifier name. </param>
        /// <param name="resourceVersion"> The resource API version. </param>
        public static CosmosDBPrivateEndpointConnection FromExisting(string bicepIdentifier, string resourceVersion = null)
        {
            CosmosDBPrivateEndpointConnection result = new CosmosDBPrivateEndpointConnection(bicepIdentifier, resourceVersion);
            result.IsExistingResource = true;
            return result;
        }

        /// <summary> Define additional provisionable properties for CosmosDBPrivateEndpointConnection that are not part of the generated code. </summary>
