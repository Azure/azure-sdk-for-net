...
namespace Azure.ResourceManager.CosmosDB.Tests
{
    public class GremlinGraphTests : CosmosDBManagementClientBase
    {
        ...
        public async Task GremlinGraphCreateAndUpdate()
        {
            ...
            grpah = await (await GremlinGraphContainer.CreateOrUpdateAsync(true, _graphName, parameters)).WaitForCompletionAsync();
            Assert.AreEqual(_graphName, grpah.Data.Resource.Id);
            VerifyGremlinGraphCreation(grpah, parameters);
            // Seems bug in swagger definition
        ...
        public async Task GremlinGraphThroughput()
        {
            ...
            DatabaseAccountGremlinDatabaseGraphThroughputSetting throughput2 = await throughput.CreateOrUpdate(true, new ThroughputSettingsUpdateOptions(AzureLocation.WestUS,
        ...
        public async Task GremlinGraphMigrateToAutoscale()
        {
            ...
            ThroughputSettingsData throughputData = await throughput.MigrateGremlinGraphToAutoscale(true).WaitForCompletionAsync();
        ...
        public async Task GremlinGraphMigrateToManual()
        {
            ...
            ThroughputSettingsData throughputData = await throughput.MigrateGremlinGraphToManualThroughput(true).WaitForCompletionAsync();
