...
namespace Azure.ResourceManager.CosmosDB.Tests
{
    public class MongoDBCollectionTests : CosmosDBManagementClientBase
    {
        ...
        public async Task MongoDBCollectionCreateAndUpdate()
        {
            ...
            collection = await (await MongoDBCollectionCollection.CreateOrUpdateAsync(true, _collectionName, updateOptions)).WaitForCompletionAsync();
            Assert.AreEqual(_collectionName, collection.Data.Resource.Id);
        ...
        public async Task MongoDBCollectionThroughput()
        {
            ...
            DatabaseAccountMongodbDatabaseCollectionThroughputSetting throughput2 = await throughput.CreateOrUpdate(true, new ThroughputSettingsUpdateOptions(AzureLocation.WestUS,
        ...
        public async Task MongoDBCollectionMigrateToAutoscale()
        {
            ...
            ThroughputSettingsData throughputData = await throughput.MigrateMongoDBCollectionToAutoscale(true).WaitForCompletionAsync();
        ...
        public async Task MongoDBCollectionMigrateToManual()
        {
            ...
            ThroughputSettingsData throughputData = await throughput.MigrateMongoDBCollectionToManualThroughput(true).WaitForCompletionAsync();
