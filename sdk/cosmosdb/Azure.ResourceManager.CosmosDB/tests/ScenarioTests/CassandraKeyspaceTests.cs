...
namespace Azure.ResourceManager.CosmosDB.Tests
{
    public class CassandraKeyspaceTests : CosmosDBManagementClientBase
    {
        ...
        public async Task CassandraKeyspaceCreateAndUpdate()
        {
            ...
            keyspace = await (await CassandraKeyspaceCollection.CreateOrUpdateAsync(true, _keyspaceName, updateOptions)).WaitForCompletionAsync();
            Assert.AreEqual(_keyspaceName, keyspace.Data.Resource.Id);
        ...
        public async Task CassandraKeyspaceThroughput()
        {
            ...
            DatabaseAccountCassandraKeyspaceThroughputSetting throughput2 = await throughput.CreateOrUpdate(true, new ThroughputSettingsUpdateOptions(AzureLocation.WestUS,
        ...
        public async Task CassandraKeyspaceMigrateToAutoscale()
        {
            ...
            ThroughputSettingsData throughputData = await throughput.MigrateCassandraKeyspaceToAutoscale(true).WaitForCompletionAsync();
        ...
        public async Task CassandraKeyspaceMigrateToManual()
        {
            ...
            ThroughputSettingsData throughputData = await throughput.MigrateCassandraKeyspaceToManualThroughput(true).WaitForCompletionAsync();
