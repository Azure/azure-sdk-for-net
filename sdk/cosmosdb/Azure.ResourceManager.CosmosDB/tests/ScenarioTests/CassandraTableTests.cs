...
namespace Azure.ResourceManager.CosmosDB.Tests
{
    public class CassandraTableTests : CosmosDBManagementClientBase
    {
        ...
        public async Task CassandraTableCreateAndUpdate()
        {
            ...
            table = await (await CassandraTableCollection.CreateOrUpdateAsync(true, _tableName, parameters)).WaitForCompletionAsync();
            Assert.AreEqual(_tableName, table.Data.Resource.Id);
            VerifyCassandraTableCreation(table, parameters);
            // Seems bug in swagger definition
        ...
        public async Task CassandraTableThroughput()
        {
            ...
            DatabaseAccountCassandraKeyspaceTableThroughputSetting throughput2 = await throughput.CreateOrUpdate(true, new ThroughputSettingsUpdateOptions(AzureLocation.WestUS,
        ...
        public async Task CassandraTableMigrateToAutoscale()
        {
            ...
            ThroughputSettingsData throughputData = await throughput.MigrateCassandraTableToAutoscale(true).WaitForCompletionAsync();
        ...
        public async Task CassandraTableMigrateToManual()
        {
            ...
            ThroughputSettingsData throughputData = await throughput.MigrateCassandraTableToManualThroughput(true).WaitForCompletionAsync();
