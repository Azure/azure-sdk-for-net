...
namespace Azure.ResourceManager.CosmosDB.Tests
{
    public class MongoDBDatabaseTests : CosmosDBManagementClientBase
    {
        ...
        public async Task MongoDBDatabaseCreateAndUpdate()
        {
            ...
            database = await (await MongoDBDatabaseCollection.CreateOrUpdateAsync(true, _databaseName, updateOptions)).WaitForCompletionAsync();
            Assert.AreEqual(_databaseName, database.Data.Resource.Id);
        ...
        public async Task MongoDBDatabaseThroughput()
        {
            ...
            DatabaseAccountMongodbDatabaseThroughputSetting throughput2 = await throughput.CreateOrUpdate(true, new ThroughputSettingsUpdateOptions(AzureLocation.WestUS,
        ...
        public async Task MongoDBDatabaseMigrateToAutoscale()
        {
            ...
            ThroughputSettingsData throughputData = await throughput.MigrateMongoDBDatabaseToAutoscale(true).WaitForCompletionAsync();
        ...
        public async Task MongoDBDatabaseMigrateToManual()
        {
            ...
            ThroughputSettingsData throughputData = await throughput.MigrateMongoDBDatabaseToManualThroughput(true).WaitForCompletionAsync();
