...
namespace Azure.ResourceManager.CosmosDB.Tests
{
    public class MongoDBDatabaseTests : CosmosDBManagementClientBase
    {
        ...
        public async Task MongoDBDatabaseCreateAndUpdate()
        {
            ...
            MongoDBDatabaseCreateUpdateParameters updateParameters = new MongoDBDatabaseCreateUpdateParameters(database.Id, _databaseName, database.Data.Type,
            ...
            database = await (await MongoDBDatabaseCollection.CreateOrUpdateAsync(_databaseName, updateParameters)).WaitForCompletionAsync();
            Assert.AreEqual(_databaseName, database.Data.Resource.Id);
        ...
        {
            var database = await CreateMongoDBDatabase(null);
            ThroughputSettings throughput = await database.GetMongoDBDatabaseThroughputAsync();

            Assert.AreEqual(TestThroughput1, throughput.Resource.Throughput);

            ThroughputSettings throughput2 = await database.UpdateMongoDBDatabaseThroughput(new ThroughputSettingsUpdateParameters(Resources.Models.Location.WestUS2,
        ...
        public async Task MongoDBDatabaseMigrateToAutoscale()
        {
            ...
            throughput = await (await database.MigrateMongoDBDatabaseToAutoscaleAsync()).WaitForCompletionAsync();
        ...
        public async Task MongoDBDatabaseMigrateToManual()
        {
            ...
            throughput = await database.MigrateMongoDBDatabaseToManualThroughput().WaitForCompletionAsync();
            AssertManualThroughput(throughput);
        }
        ...
        {
            MongoDBDatabaseCreateUpdateParameters mongoDBDatabaseCreateUpdateParameters = new MongoDBDatabaseCreateUpdateParameters(Resources.Models.Location.WestUS2,
