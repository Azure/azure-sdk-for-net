...
{
    internal partial class SqlResourcesGetSqlStoredProceduresAsyncCollectionResultOfT : AsyncPageable<SqlStoredProcedureGetResultsData>
    {
        ...
        public SqlResourcesGetSqlStoredProceduresAsyncCollectionResultOfT(SqlResources client, Guid subscriptionId, string resourceGroupName, string accountName, string databaseName, string containerName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override async IAsyncEnumerable<Page<SqlStoredProcedureGetResultsData>> AsPages(string continuationToken, int? pageSizeHint)
        {
