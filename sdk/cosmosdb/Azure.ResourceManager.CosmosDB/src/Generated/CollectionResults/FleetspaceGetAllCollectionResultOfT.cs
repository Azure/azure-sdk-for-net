...
{
    internal partial class FleetspaceGetAllCollectionResultOfT : Pageable<FleetspaceResourceData>
    {
        ...
        public FleetspaceGetAllCollectionResultOfT(Fleetspace client, Guid subscriptionId, string resourceGroupName, string fleetName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<FleetspaceResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
