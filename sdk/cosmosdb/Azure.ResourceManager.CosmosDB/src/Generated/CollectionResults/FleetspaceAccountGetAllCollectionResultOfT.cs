...
{
    internal partial class FleetspaceAccountGetAllCollectionResultOfT : Pageable<CosmosDBFleetspaceAccountData>
    {
        ...
        /// <summary> Initializes a new instance of FleetspaceAccountGetAllCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        public FleetspaceAccountGetAllCollectionResultOfT(FleetspaceAccount client, Guid subscriptionId, string resourceGroupName, string fleetName, string fleetspaceName, RequestContext context, string diagnosticScope) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        /// <summary> Gets the pages of FleetspaceAccountGetAllCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of FleetspaceAccountGetAllCollectionResultOfT as an enumerable collection. </returns>
        public override IEnumerable<Page<CosmosDBFleetspaceAccountData>> AsPages(string continuationToken, int? pageSizeHint)
        {
