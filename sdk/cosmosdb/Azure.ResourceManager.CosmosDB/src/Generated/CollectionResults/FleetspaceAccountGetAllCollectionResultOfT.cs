...
{
    internal partial class FleetspaceAccountGetAllCollectionResultOfT : Pageable<FleetspaceAccountResourceData>
    {
        ...
        public FleetspaceAccountGetAllCollectionResultOfT(FleetspaceAccount client, Guid subscriptionId, string resourceGroupName, string fleetName, string fleetspaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<FleetspaceAccountResourceData>> AsPages(string continuationToken, int? pageSizeHint)
        {
