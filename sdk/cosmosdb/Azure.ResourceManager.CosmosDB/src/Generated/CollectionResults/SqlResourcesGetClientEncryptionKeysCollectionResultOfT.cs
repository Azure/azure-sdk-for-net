...
{
    internal partial class SqlResourcesGetClientEncryptionKeysCollectionResultOfT : Pageable<ClientEncryptionKeyGetResultsData>
    {
        ...
        public SqlResourcesGetClientEncryptionKeysCollectionResultOfT(SqlResources client, Guid subscriptionId, string resourceGroupName, string accountName, string databaseName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<ClientEncryptionKeyGetResultsData>> AsPages(string continuationToken, int? pageSizeHint)
        {
