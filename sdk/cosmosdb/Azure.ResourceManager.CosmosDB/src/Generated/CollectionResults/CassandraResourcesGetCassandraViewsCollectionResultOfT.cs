...
{
    internal partial class CassandraResourcesGetCassandraViewsCollectionResultOfT : Pageable<CassandraViewGetResultsData>
    {
        ...
        public CassandraResourcesGetCassandraViewsCollectionResultOfT(CassandraResources client, Guid subscriptionId, string resourceGroupName, string accountName, string keyspaceName, RequestContext context) : base(context?.CancellationToken ?? default)
        {
            _client = client;
        ...
        public override IEnumerable<Page<CassandraViewGetResultsData>> AsPages(string continuationToken, int? pageSizeHint)
        {
