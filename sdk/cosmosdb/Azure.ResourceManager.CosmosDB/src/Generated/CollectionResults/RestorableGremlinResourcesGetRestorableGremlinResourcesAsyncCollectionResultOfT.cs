...
{
    internal partial class RestorableGremlinResourcesGetRestorableGremlinResourcesAsyncCollectionResultOfT : AsyncPageable<RestorableGremlinResourceData>
    {
        ...
        /// <summary> Initializes a new instance of RestorableGremlinResourcesGetRestorableGremlinResourcesAsyncCollectionResultOfT, which is used to iterate over the pages of a collection. </summary>
        ...
        /// <summary> Gets the pages of RestorableGremlinResourcesGetRestorableGremlinResourcesAsyncCollectionResultOfT as an enumerable collection. </summary>
        /// <param name="continuationToken"> A continuation token indicating where to resume paging. </param>
        /// <param name="pageSizeHint"> The number of items per page. </param>
        /// <returns> The pages of RestorableGremlinResourcesGetRestorableGremlinResourcesAsyncCollectionResultOfT as an enumerable collection. </returns>
        ...
        {
            HttpMessage message = nextLink != null ? _client.CreateNextGetRestorableGremlinResourcesRequest(nextLink, _subscriptionId, _location, _instanceId, _restoreLocation, _restoreTimestampInUtc, _context) : _client.CreateGetRestorableGremlinResourcesRequest(_subscriptionId, _location, _instanceId, _restoreLocation, _restoreTimestampInUtc, _context);
