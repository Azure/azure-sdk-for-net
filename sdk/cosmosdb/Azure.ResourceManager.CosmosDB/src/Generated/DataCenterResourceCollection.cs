...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class DataCenterResourceCollection : ArmCollection, IEnumerable<DataCenterResource>, IAsyncEnumerable<DataCenterResource>
    {
        ...
        internal DataCenterResourceCollection(ArmResource parent) : base(parent)
        {
            ...
            ArmClient.TryGetApiVersion(DataCenterResource.ResourceType, out string dataCenterResourceCassandraDataCentersApiVersion);
        ...
        public virtual DataCenterResourceCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string dataCenterName, DataCenterResourceData body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new DataCenterResourceCreateOrUpdateOperation(ArmClient, _dataCenterResourceCassandraDataCentersClientDiagnostics, Pipeline, _dataCenterResourceCassandraDataCentersRestClient.CreateCreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, dataCenterName, body).Request, response);
        ...
        public virtual Pageable<DataCenterResource> GetAll(CancellationToken cancellationToken = default)
        {
            Page<DataCenterResource> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new DataCenterResource(ArmClient, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
