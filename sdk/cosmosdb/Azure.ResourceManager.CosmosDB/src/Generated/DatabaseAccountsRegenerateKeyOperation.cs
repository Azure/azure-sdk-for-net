...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class DatabaseAccountsRegenerateKeyOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of DatabaseAccountsRegenerateKeyOperation for mocking. </summary>
        protected DatabaseAccountsRegenerateKeyOperation()
        {
        }

        internal DatabaseAccountsRegenerateKeyOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DatabaseAccountsRegenerateKeyOperation");
        }
        /// <inheritdoc />
