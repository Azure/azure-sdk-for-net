...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinDatabaseThroughputSettingResource : ThroughputSettingResource
    {
        ...
        {
            using var scope = _gremlinDatabaseThroughputSettingGremlinResourcesClientDiagnostics.CreateScope("GremlinDatabaseThroughputSettingResource.GetCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<ArmOperation<ThroughputSettingResource>> CreateOrUpdateCoreAsync(WaitUntil waitUntil, ThroughputSettingsUpdateData data, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _gremlinDatabaseThroughputSettingGremlinResourcesClientDiagnostics.CreateScope("GremlinDatabaseThroughputSettingResource.CreateOrUpdateCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<Response<ThroughputSettingResource>> AddTagCoreAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _gremlinDatabaseThroughputSettingGremlinResourcesClientDiagnostics.CreateScope("GremlinDatabaseThroughputSettingResource.AddTagCore");
            scope.Start();
            try
            {
        ...
        protected override async Task<Response<ThroughputSettingResource>> SetTagsCoreAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _gremlinDatabaseThroughputSettingGremlinResourcesClientDiagnostics.CreateScope("GremlinDatabaseThroughputSettingResource.SetTagsCore");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
        ...
        protected override async Task<Response<ThroughputSettingResource>> RemoveTagCoreAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _gremlinDatabaseThroughputSettingGremlinResourcesClientDiagnostics.CreateScope("GremlinDatabaseThroughputSettingResource.RemoveTagCore");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
