...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBFirewallRuleData : ResourceData
    {
        ...
        internal CosmosDBFirewallRuleData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, CosmosDBProvisioningState? provisioningState, string startIPAddress, string endIPAddress, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
