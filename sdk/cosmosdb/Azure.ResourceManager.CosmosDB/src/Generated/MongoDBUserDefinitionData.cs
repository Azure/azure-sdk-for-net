...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBUserDefinitionData : ResourceData
    {
        ...
        internal MongoDBUserDefinitionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, MongoUserDefinitionResource properties) : base(id, name, resourceType, systemData)
        {
