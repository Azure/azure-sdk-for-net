...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraResourcesUpdateCassandraTableThroughputOperation : Operation<ThroughputSettingsGetResults>, IOperationSource<ThroughputSettingsGetResults>
    {
        private readonly ArmOperationHelpers<ThroughputSettingsGetResults> _operation;

        /// <summary> Initializes a new instance of CassandraResourcesUpdateCassandraTableThroughputOperation for mocking. </summary>
        ...
        {
            _operation = new ArmOperationHelpers<ThroughputSettingsGetResults>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CassandraResourcesUpdateCassandraTableThroughputOperation");
        }
        /// <inheritdoc />
