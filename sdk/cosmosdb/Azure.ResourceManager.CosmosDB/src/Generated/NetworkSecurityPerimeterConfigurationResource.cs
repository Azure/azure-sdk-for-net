...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class NetworkSecurityPerimeterConfigurationResource : ArmResource
    {
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/networkSecurityPerimeterConfigurations/{networkSecurityPerimeterConfigurationName}";
        ...
        public virtual async Task<ArmOperation> ReconcileAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                CosmosDBArmOperation operation = new CosmosDBArmOperation(_networkSecurityPerimeterConfigurationsClientDiagnostics, Pipeline, message.Request, response, OperationFinalStateVia.Location);
