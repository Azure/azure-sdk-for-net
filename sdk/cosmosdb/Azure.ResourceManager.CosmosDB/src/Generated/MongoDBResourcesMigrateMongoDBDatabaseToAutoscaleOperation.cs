...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBResourcesMigrateMongoDBDatabaseToAutoscaleOperation : Operation<ThroughputSettingsGetResults>, IOperationSource<ThroughputSettingsGetResults>
    {
        private readonly ArmOperationHelpers<ThroughputSettingsGetResults> _operation;

        /// <summary> Initializes a new instance of MongoDBResourcesMigrateMongoDBDatabaseToAutoscaleOperation for mocking. </summary>
        protected MongoDBResourcesMigrateMongoDBDatabaseToAutoscaleOperation()
        {
        }

        internal MongoDBResourcesMigrateMongoDBDatabaseToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ThroughputSettingsGetResults>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBResourcesMigrateMongoDBDatabaseToAutoscaleOperation");
        }
        /// <inheritdoc />
