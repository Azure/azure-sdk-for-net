...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlDatabaseData : ResourceData
    {
        ...
        internal CosmosDBSqlDatabaseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CosmosDBSqlDatabaseProperties properties, IDictionary<string, string> tags, string location, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
