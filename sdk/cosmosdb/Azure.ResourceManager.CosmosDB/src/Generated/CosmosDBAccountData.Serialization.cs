...
namespace Azure.ResourceManager.CosmosDB
{
    public partial class CosmosDBAccountData : IUtf8JsonSerializable, IJsonModel<CosmosDBAccountData>
    {
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        if (property0.NameEquals("keyVaultKeyUriVersion"u8))
                        {
                            keyVaultKeyUriVersion = property0.Value.GetString();
                            continue;
                        }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(KeyVaultKeyUriVersion), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("    keyVaultKeyUriVersion: ");
                builder.AppendLine(propertyOverride);
            }
            else
            {
                if (Optional.IsDefined(KeyVaultKeyUriVersion))
                {
                    builder.Append("    keyVaultKeyUriVersion: ");
                    if (KeyVaultKeyUriVersion.Contains(Environment.NewLine))
                    {
                        builder.AppendLine("'''");
                        builder.AppendLine($"{KeyVaultKeyUriVersion}'''");
                    }
                    else
                    {
                        builder.AppendLine($"'{KeyVaultKeyUriVersion}'");
