...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosTable : ArmResource
    {
        ...
        internal CosmosTable(ArmClient armClient, CosmosTableData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal CosmosTable(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string cosmosTableTableResourcesApiVersion);
        ...
        public async virtual Task<Response<CosmosTable>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CosmosTable(ArmClient, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        {
            return new DatabaseAccountTableThroughputSetting(ArmClient, new ResourceIdentifier(Id.ToString() + "/throughputSettings/default"));
        }
        #endregion
    }
}
