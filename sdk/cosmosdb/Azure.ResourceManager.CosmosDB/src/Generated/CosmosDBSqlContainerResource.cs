...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlContainerResource : ArmResource
    {
        ...
        public virtual async Task<Response<CosmosDBSqlContainerResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ArmOperation<CosmosDBSqlContainerResource> result = await this.UpdateAsync(WaitUntil.Completed, current, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CosmosDBSqlContainerResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    current.Tags[key] = value;
                    ArmOperation<CosmosDBSqlContainerResource> result = this.Update(WaitUntil.Completed, current, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        /// <summary> Gets an object representing a <see cref="SqlResource"/> along with the instance operations that can be performed on it in the <see cref="CosmosDBSqlContainerResource"/>. </summary>
