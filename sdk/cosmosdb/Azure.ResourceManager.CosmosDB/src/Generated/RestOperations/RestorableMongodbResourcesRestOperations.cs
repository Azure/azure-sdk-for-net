...
namespace Azure.ResourceManager.CosmosDB
{
    internal partial class RestorableMongodbResources
    {
        ...
        internal RestorableMongodbResources(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(RestorableMongodbResources).Assembly, applicationId);
        }
