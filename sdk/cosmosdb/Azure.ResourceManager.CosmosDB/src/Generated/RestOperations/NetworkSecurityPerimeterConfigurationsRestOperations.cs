...
namespace Azure.ResourceManager.CosmosDB
{
    internal partial class NetworkSecurityPerimeterConfigurations
    {
        ...
        internal HttpMessage CreateGetRequest(Guid subscriptionId, string resourceGroupName, string accountName, string networkSecurityPerimeterConfigurationName, RequestContext context)
        {
        ...
        internal HttpMessage CreateReconcileRequest(Guid subscriptionId, string resourceGroupName, string accountName, string networkSecurityPerimeterConfigurationName, RequestContext context)
        {
            RawRequestUriBuilder uri = new RawRequestUriBuilder();
            uri.Reset(_endpoint);
            uri.AppendPath("/subscriptions/", false);
