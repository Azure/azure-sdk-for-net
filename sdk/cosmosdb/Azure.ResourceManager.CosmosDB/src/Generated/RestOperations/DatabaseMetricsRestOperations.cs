...
{
    internal partial class DatabaseMetricsRestOperations
    {
        ...
        /// <summary> Initializes a new instance of DatabaseMetricsRestOperations. </summary>
        ...
        public DatabaseMetricsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-15")
        {
        ...
        public async Task<Response<MetricList>> GetAllAsync(string resourceGroupName, string accountName, string databaseRid, string filter, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="accountName"/>, <paramref name="databaseRid"/>, or <paramref name="filter"/> is null. </exception>
        public Response<MetricList> GetAll(string resourceGroupName, string accountName, string databaseRid, string filter, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
