...
{
    internal partial class PercentileTargetMetricsRestOperations
    {
        ...
        /// <summary> Initializes a new instance of PercentileTargetMetricsRestOperations. </summary>
        ...
        public PercentileTargetMetricsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, ClientOptions options, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-15")
        {
        ...
        internal HttpMessage CreateGetAllRequest(string resourceGroupName, string accountName, string targetRegion, string filter)
        {
        ...
        public async Task<Response<PercentileMetricList>> GetAllAsync(string resourceGroupName, string accountName, string targetRegion, string filter, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateGetAllRequest(resourceGroupName, accountName, targetRegion, filter);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="accountName"/>, <paramref name="targetRegion"/>, or <paramref name="filter"/> is null. </exception>
        public Response<PercentileMetricList> GetAll(string resourceGroupName, string accountName, string targetRegion, string filter, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
