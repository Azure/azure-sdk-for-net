...
namespace Azure.ResourceManager.CosmosDB
{
    internal partial class Database
    {
        ...
        /// <summary> Initializes a new instance of Database for mocking. </summary>
        protected Database()
        {
        }
        ...
        internal Database(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(Database).Assembly, applicationId);
        }
