...
namespace Azure.ResourceManager.CosmosDB
{
    internal partial class RestorableMongodbCollections
    {
        ...
        internal RestorableMongodbCollections(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string applicationId, Uri endpoint, string apiVersion)
        {
            ClientDiagnostics = clientDiagnostics;
            _endpoint = endpoint;
            Pipeline = pipeline;
            _apiVersion = apiVersion;
            _userAgent = new TelemetryDetails(typeof(RestorableMongodbCollections).Assembly, applicationId);
        }
