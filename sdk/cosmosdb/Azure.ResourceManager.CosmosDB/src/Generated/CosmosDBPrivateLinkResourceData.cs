...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBPrivateLinkResourceData : ResourceData
    {
        ...
        internal CosmosDBPrivateLinkResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CosmosDBPrivateLinkResourceProperties properties) : base(id, name, resourceType, systemData)
        {
