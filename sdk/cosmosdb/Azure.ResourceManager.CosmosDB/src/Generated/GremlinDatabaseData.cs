...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinDatabaseData : ResourceData
    {
        ...
        internal GremlinDatabaseData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, GremlinDatabaseProperties properties, IDictionary<string, string> tags, string location, Models.ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
