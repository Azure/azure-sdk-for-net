...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class NotebookWorkspacesDeleteOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of NotebookWorkspacesDeleteOperation for mocking. </summary>
        protected NotebookWorkspacesDeleteOperation()
        {
        }

        internal NotebookWorkspacesDeleteOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NotebookWorkspacesDeleteOperation");
        }
        /// <inheritdoc />
