...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="DatabaseAccountGetResultsResource"/> using the GetPrivateLinkResources method.
    /// </summary>
    public partial class PrivateLinkResource : ArmResource
    {
        ...
        internal PrivateLinkResource(ArmClient client, CosmosDBPrivateLinkResourceData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal PrivateLinkResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _privateLinkResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CosmosDB", ResourceType.Namespace, Diagnostics);
        ...
        {
            string resourceId = $"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/privateLinkResources/{groupName}";
