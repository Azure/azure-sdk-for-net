...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class SqlResourcesDeleteSqlRoleDefinitionOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of SqlResourcesDeleteSqlRoleDefinitionOperation for mocking. </summary>
        protected SqlResourcesDeleteSqlRoleDefinitionOperation()
        {
        }
        ...
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlResourcesDeleteSqlRoleDefinitionOperation");
        }
        /// <inheritdoc />
