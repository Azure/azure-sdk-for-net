...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class NotebookWorkspacesRegenerateAuthTokenOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of NotebookWorkspacesRegenerateAuthTokenOperation for mocking. </summary>
        protected NotebookWorkspacesRegenerateAuthTokenOperation()
        {
        }

        internal NotebookWorkspacesRegenerateAuthTokenOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NotebookWorkspacesRegenerateAuthTokenOperation");
        }
        /// <inheritdoc />
