...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinResourcesDeleteGremlinGraphOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of GremlinResourcesDeleteGremlinGraphOperation for mocking. </summary>
        protected GremlinResourcesDeleteGremlinGraphOperation()
        {
        }

        internal GremlinResourcesDeleteGremlinGraphOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "GremlinResourcesDeleteGremlinGraphOperation");
        }
        /// <inheritdoc />
