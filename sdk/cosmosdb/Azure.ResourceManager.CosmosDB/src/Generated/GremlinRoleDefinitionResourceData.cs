...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinRoleDefinitionResourceData : ResourceData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GremlinRoleDefinitionResourceData"/>. </summary>
        public GremlinRoleDefinitionResourceData()
        {
        }
        ...
        /// <param name="properties"> Properties to create and update an Azure Cosmos DB Gremlin Role Definition. </param>
        internal GremlinRoleDefinitionResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, GremlinRoleDefinitionResourceProperties properties) : base(id, name, resourceType, systemData)
        {
