...
namespace Azure.ResourceManager.CosmosDB.Mocking
{
    ...
    public partial class MockableCosmosDBResourceGroupResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<CosmosDBAccountResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string accountName, CosmosDBAccountCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = DatabaseAccountsClientDiagnostics.CreateScope("MockableCosmosDBResourceGroupResource.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = DatabaseAccountsRestClient.CreateCreateOrUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, accountName, CosmosDBAccountCreateOrUpdateContent.ToRequestContent(content), context);
