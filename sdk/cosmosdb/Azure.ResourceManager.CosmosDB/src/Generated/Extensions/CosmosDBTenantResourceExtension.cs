...
namespace Azure.ResourceManager.CosmosDB.Testing
{
    /// <summary> A class to add extension methods to TenantResource. </summary>
    public partial class CosmosDBTenantResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CosmosDBTenantResourceExtension"/> class for mocking. </summary>
        protected CosmosDBTenantResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CosmosDBTenantResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CosmosDBTenantResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual async Task<Response<bool>> CheckNameExistsDatabaseAccountAsync(string accountName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CosmosDBAccountDatabaseAccountsClientDiagnostics.CreateScope("CosmosDBTenantResourceExtension.CheckNameExistsDatabaseAccount");
            scope.Start();
            try
            {
