...
namespace Azure.ResourceManager.CosmosDB.Mock
{
    ...
    public partial class CassandraClusterResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CassandraClusterResourceExtension"/> class for mocking. </summary>
        protected CassandraClusterResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CassandraClusterResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CassandraClusterResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<CassandraClusterResource> GetCassandraClustersAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new CassandraClusterResource(Client, CassandraClusterData.DeserializeCassandraClusterData(e)), CassandraClusterClientDiagnostics, Pipeline, "CassandraClusterResourceExtension.GetCassandraClusters", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CassandraClusterRestClient.CreateListBySubscriptionRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new CassandraClusterResource(Client, CassandraClusterData.DeserializeCassandraClusterData(e)), CassandraClusterClientDiagnostics, Pipeline, "CassandraClusterResourceExtension.GetCassandraClusters", "value", null, cancellationToken);
        }
    }
}
