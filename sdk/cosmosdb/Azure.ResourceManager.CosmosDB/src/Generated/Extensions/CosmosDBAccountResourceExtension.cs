...
namespace Azure.ResourceManager.CosmosDB.Mock
{
    ...
    public partial class CosmosDBAccountResourceExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CosmosDBAccountResourceExtension"/> class for mocking. </summary>
        protected CosmosDBAccountResourceExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CosmosDBAccountResourceExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CosmosDBAccountResourceExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        public virtual AsyncPageable<CosmosDBAccountResource> GetCosmosDBAccountsAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => new CosmosDBAccountResource(Client, CosmosDBAccountData.DeserializeCosmosDBAccountData(e)), CosmosDBAccountDatabaseAccountsClientDiagnostics, Pipeline, "CosmosDBAccountResourceExtension.GetCosmosDBAccounts", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => CosmosDBAccountDatabaseAccountsRestClient.CreateListRequest(Id.SubscriptionId);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => new CosmosDBAccountResource(Client, CosmosDBAccountData.DeserializeCosmosDBAccountData(e)), CosmosDBAccountDatabaseAccountsClientDiagnostics, Pipeline, "CosmosDBAccountResourceExtension.GetCosmosDBAccounts", "value", null, cancellationToken);
        }
        ...
        public virtual async Task<Response<bool>> CheckNameExistsDatabaseAccountAsync(string accountName, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = CosmosDBAccountDatabaseAccountsClientDiagnostics.CreateScope("CosmosDBAccountResourceExtension.CheckNameExistsDatabaseAccount");
            scope.Start();
            try
            {
