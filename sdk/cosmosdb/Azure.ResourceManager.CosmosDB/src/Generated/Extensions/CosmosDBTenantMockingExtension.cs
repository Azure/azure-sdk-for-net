...
namespace Azure.ResourceManager.CosmosDB.Mocking
{
    ...
    internal partial class CosmosDBTenantMockingExtension : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of the <see cref="CosmosDBTenantMockingExtension"/> class for mocking. </summary>
        protected CosmosDBTenantMockingExtension()
        {
        }

        /// <summary> Initializes a new instance of the <see cref="CosmosDBTenantMockingExtension"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal CosmosDBTenantMockingExtension(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        }
        ...
        {
            using var scope = CosmosDBAccountDatabaseAccountsClientDiagnostics.CreateScope("CosmosDBTenantMockingExtension.CheckNameExistsDatabaseAccount");
            scope.Start();
            try
            {
