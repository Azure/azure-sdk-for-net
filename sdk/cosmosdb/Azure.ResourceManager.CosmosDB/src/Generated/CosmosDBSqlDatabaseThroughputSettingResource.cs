...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlDatabaseThroughputSettingResource : ArmResource
    {
        ...
        internal CosmosDBSqlDatabaseThroughputSettingResource(ArmClient client, ThroughputSettingData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CosmosDBSqlDatabaseThroughputSettingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CosmosDBSqlDatabaseThroughputSettingResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Response<CosmosDBSqlDatabaseThroughputSettingResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new CosmosDBSqlDatabaseThroughputSettingResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
