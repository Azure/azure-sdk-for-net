...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraClusterBackupResource : ArmResource
    {
        ...
        internal CassandraClusterBackupResource(ArmClient client, CassandraClusterBackupResourceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CassandraClusterBackupResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CassandraClusterBackupResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
