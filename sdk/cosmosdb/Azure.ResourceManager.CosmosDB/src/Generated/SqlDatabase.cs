...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class SqlDatabase : ArmResource
    {
        ...
        public virtual async Task<Response<SqlContainer>> GetSqlContainerAsync(string containerName, CancellationToken cancellationToken = default)
        {
        ...
        /// <exception cref="ArgumentException"> <paramref name="containerName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> is null. </exception>
        public virtual Response<SqlContainer> GetSqlContainer(string containerName, CancellationToken cancellationToken = default)
        {
