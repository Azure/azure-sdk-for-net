...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class SqlDatabase : ArmResource
    {
        ...
        internal SqlDatabase(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string sqlDatabaseSqlResourcesApiVersion);
        ...
        {
            using var scope = _sqlDatabaseSqlResourcesClientDiagnostics.CreateScope("SqlDatabase.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            return new DatabaseAccountSqlDatabaseThroughputSetting(ArmClient, new ResourceIdentifier(Id.ToString() + "/throughputSettings/default"));
        }
        #endregion
