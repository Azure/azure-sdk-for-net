...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class NotebookWorkspacesOperations
    {
        ...
        internal NotebookWorkspacesOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-15")
        {
            RestClient = new NotebookWorkspacesRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
