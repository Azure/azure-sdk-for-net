...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class RestorableCosmosDBAccountData : ResourceData
    {
        ...
        internal RestorableCosmosDBAccountData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, AzureLocation? location, string accountName, DateTimeOffset? createdOn, DateTimeOffset? deletedOn, CosmosDBApiType? apiType, IReadOnlyList<RestorableLocationResourceInfo> restorableLocations) : base(id, name, resourceType, systemData)
        {
            Location = location;
