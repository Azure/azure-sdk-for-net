...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraKeyspaceThroughputSettingResource : ArmResource
    {
        ...
        internal CassandraKeyspaceThroughputSettingResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _cassandraResourcesRestClient = new CassandraResources(_cassandraResourcesClientDiagnostics, Pipeline, Endpoint, cassandraKeyspaceThroughputSettingApiVersion ?? "2025-11-01-preview");
        ...
        public virtual async Task<ArmOperation<CassandraKeyspaceThroughputSettingResource>> CreateOrUpdateAsync(WaitUntil waitUntil, ThroughputSettingsUpdateData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                CosmosDBArmOperation<CassandraKeyspaceThroughputSettingResource> operation = new CosmosDBArmOperation<CassandraKeyspaceThroughputSettingResource>(
                    new CassandraKeyspaceThroughputSettingOperationSource(Client),
        ...
        public virtual async Task<Response<CassandraKeyspaceThroughputSettingResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ArmOperation<CassandraKeyspaceThroughputSettingResource> result = await this.UpdateAsync(WaitUntil.Completed, current, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CassandraKeyspaceThroughputSettingResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    current.Tags[key] = value;
                    ArmOperation<CassandraKeyspaceThroughputSettingResource> result = this.Update(WaitUntil.Completed, current, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
