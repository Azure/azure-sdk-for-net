...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinGraphData : TrackedResource
    {
        ...
        internal GremlinGraphData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, GremlinGraphPropertiesResource resource, GremlinGraphPropertiesOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
