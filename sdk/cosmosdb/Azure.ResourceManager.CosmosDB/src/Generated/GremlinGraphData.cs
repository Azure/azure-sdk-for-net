...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinGraphData : ResourceData
    {
        ...
        internal GremlinGraphData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, GremlinGraphProperties properties, IDictionary<string, string> tags, string location, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
