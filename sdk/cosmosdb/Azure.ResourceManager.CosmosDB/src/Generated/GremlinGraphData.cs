...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinGraphData : ResourceData
    {
        ...
        /// <param name="properties"> The properties of an Azure Cosmos DB Gremlin graph. </param>
        /// <param name="tags"> Resource tags. </param>
        /// <param name="location"> The geo-location where the resource lives. </param>
        /// <param name="identity"> Identity for the resource. </param>
        internal GremlinGraphData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, GremlinGraphProperties properties, IDictionary<string, string> tags, string location, Models.ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
        ...
        internal GremlinGraphProperties Properties { get; }
