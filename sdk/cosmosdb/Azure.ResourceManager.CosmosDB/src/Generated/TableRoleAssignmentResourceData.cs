...
{
    /// <summary> Parameters to create and update an Azure Cosmos DB Table Role Assignment. </summary>
    public partial class TableRoleAssignmentResourceData : ResourceData
    {
        ...
        /// <param name="properties"> Properties to create and update an Azure Cosmos DB Table Role Assignment. </param>
        internal TableRoleAssignmentResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, TableRoleAssignmentResourceProperties properties) : base(id, name, resourceType, systemData)
        {
        ...
        public string RoleDefinitionId
        {
            ...
            set
            {
                ...
                {
                    Properties = new TableRoleAssignmentResourceProperties();
                }
