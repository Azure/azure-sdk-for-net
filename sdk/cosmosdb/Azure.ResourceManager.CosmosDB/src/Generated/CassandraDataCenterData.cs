...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraDataCenterData : ResourceData
    {
        ...
        internal CassandraDataCenterData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, CassandraDataCenterProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
