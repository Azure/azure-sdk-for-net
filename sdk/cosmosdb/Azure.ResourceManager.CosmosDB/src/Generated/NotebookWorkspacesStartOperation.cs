...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class NotebookWorkspacesStartOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of NotebookWorkspacesStartOperation for mocking. </summary>
        protected NotebookWorkspacesStartOperation()
        {
        }

        internal NotebookWorkspacesStartOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "NotebookWorkspacesStartOperation");
        }
        /// <inheritdoc />
