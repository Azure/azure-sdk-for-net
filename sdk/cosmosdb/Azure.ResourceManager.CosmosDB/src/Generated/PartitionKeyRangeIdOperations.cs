...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class PartitionKeyRangeIdOperations
    {
        ...
        internal PartitionKeyRangeIdOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-15")
        {
            RestClient = new PartitionKeyRangeIdRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
