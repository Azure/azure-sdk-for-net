...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBResourcesMigrateMongoDBDatabaseToManualThroughputOperation : Operation<ThroughputSettingsGetResults>, IOperationSource<ThroughputSettingsGetResults>
    {
        private readonly ArmOperationHelpers<ThroughputSettingsGetResults> _operation;

        /// <summary> Initializes a new instance of MongoDBResourcesMigrateMongoDBDatabaseToManualThroughputOperation for mocking. </summary>
        protected MongoDBResourcesMigrateMongoDBDatabaseToManualThroughputOperation()
        {
        }

        internal MongoDBResourcesMigrateMongoDBDatabaseToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ThroughputSettingsGetResults>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBResourcesMigrateMongoDBDatabaseToManualThroughputOperation");
        }
        /// <inheritdoc />
