...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBAccountResource : ArmResource
    {
        ...
        public virtual CosmosDBServiceResourceCollection GetCosmosDBServiceResources()
        {
            return GetCachedClient(Client => new CosmosDBServiceResourceCollection(Client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<CosmosDBServiceResource>> GetCosmosDBServiceResourceAsync(string serviceName, CancellationToken cancellationToken = default)
        {
            return await GetCosmosDBServiceResources().GetAsync(serviceName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="serviceName"/> is null. </exception>
        [ForwardsClientCalls]
        public virtual Response<CosmosDBServiceResource> GetCosmosDBServiceResource(string serviceName, CancellationToken cancellationToken = default)
        {
            return GetCosmosDBServiceResources().Get(serviceName, cancellationToken);
        }
