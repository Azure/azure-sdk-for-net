...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBTableRoleDefinitionResource : ArmResource
    {
        ...
        internal CosmosDBTableRoleDefinitionResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _tableResourcesRestClient = new TableResources(_tableResourcesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, cosmosDBTableRoleDefinitionApiVersion ?? "2026-03-15");
        ...
        public virtual async Task<ArmOperation<CosmosDBTableRoleDefinitionResource>> UpdateAsync(WaitUntil waitUntil, CosmosDBTableRoleDefinitionData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                CosmosDBArmOperation<CosmosDBTableRoleDefinitionResource> operation = new CosmosDBArmOperation<CosmosDBTableRoleDefinitionResource>(
                    new CosmosDBTableRoleDefinitionResourceOperationSource(Client),
