...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class SqlStoredProcedure : ArmResource
    {
        ...
        public async virtual Task<Response<SqlStoredProcedure>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _restClient.GetSqlStoredProcedureAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SqlStoredProcedure> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _restClient.GetSqlStoredProcedure(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public async virtual Task<SqlStoredProcedureDeleteSqlStoredProcedureOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SqlStoredProcedure.Delete");
            scope.Start();
            try
            {
                var response = await _restClient.DeleteSqlStoredProcedureAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new SqlStoredProcedureDeleteSqlStoredProcedureOperation(_clientDiagnostics, Pipeline, _restClient.CreateDeleteSqlStoredProcedureRequest(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
        ...
        /// <param name="waitForCompletion"> Waits for the completion of the long running operations. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual SqlStoredProcedureDeleteSqlStoredProcedureOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("SqlStoredProcedure.Delete");
            scope.Start();
            try
            {
                var response = _restClient.DeleteSqlStoredProcedure(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new SqlStoredProcedureDeleteSqlStoredProcedureOperation(_clientDiagnostics, Pipeline, _restClient.CreateDeleteSqlStoredProcedureRequest(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<SqlStoredProcedure>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = await _restClient.GetSqlStoredProcedureAsync(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<SqlStoredProcedure> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _restClient.GetSqlStoredProcedure(Id.ResourceGroupName, Id.Parent.Parent.Parent.Name, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                return Response.FromValue(new SqlStoredProcedure(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
