...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinGraphThroughputSettingResource : ArmResource
    {
        ...
        internal GremlinGraphThroughputSettingResource(ArmClient client, ThroughputSettingData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<GremlinGraphThroughputSettingResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new GremlinGraphThroughputSettingResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Response<GremlinGraphThroughputSettingResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    return Response.FromValue(new GremlinGraphThroughputSettingResource(Client, originalResponse.Value, originalResponse.Value.Id), originalResponse.GetRawResponse());
                }
                else
                {
