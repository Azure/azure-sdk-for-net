...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlClientEncryptionKeyData : ResourceData
    {
        ...
        /// <param name="properties"> The properties of a ClientEncryptionKey. </param>
        internal CosmosDBSqlClientEncryptionKeyData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ClientEncryptionKeyGetProperties properties) : base(id, name, resourceType, systemData)
        {
