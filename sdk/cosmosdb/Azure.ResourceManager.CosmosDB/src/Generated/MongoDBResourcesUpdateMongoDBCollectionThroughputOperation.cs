...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBResourcesUpdateMongoDBCollectionThroughputOperation : Operation<ThroughputSettingsGetResults>, IOperationSource<ThroughputSettingsGetResults>
    {
        private readonly ArmOperationHelpers<ThroughputSettingsGetResults> _operation;

        /// <summary> Initializes a new instance of MongoDBResourcesUpdateMongoDBCollectionThroughputOperation for mocking. </summary>
        protected MongoDBResourcesUpdateMongoDBCollectionThroughputOperation()
        {
        }

        internal MongoDBResourcesUpdateMongoDBCollectionThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ThroughputSettingsGetResults>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBResourcesUpdateMongoDBCollectionThroughputOperation");
        }
        /// <inheritdoc />
