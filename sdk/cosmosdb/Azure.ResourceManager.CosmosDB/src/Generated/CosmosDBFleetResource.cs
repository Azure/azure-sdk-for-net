...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBFleetResource : ArmResource
    {
        ...
        public virtual async Task<ArmOperation<CosmosDBFleetResource>> UpdateAsync(WaitUntil waitUntil, CosmosDBFleetData data, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _fleetRestClient.CreateCreateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, CosmosDBFleetData.ToRequestContent(data), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<CosmosDBFleetData> response = Response.FromValue(CosmosDBFleetData.FromResponse(result), result);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="data"/> is null. </exception>
        [EditorBrowsable(EditorBrowsableState.Never)]
        public virtual ArmOperation<CosmosDBFleetResource> Update(WaitUntil waitUntil, CosmosDBFleetData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(data, nameof(data));
