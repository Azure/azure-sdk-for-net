...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class ThroughputSettingData : TrackedResourceData
    {
        ...
        internal ThroughputSettingData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, ExtendedThroughputSettingsResourceInfo resource, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Identity = identity;
        }
