    ...
    public partial class GremlinDatabaseData : IUtf8JsonSerializable, IJsonModel<GremlinDatabaseData>
    {
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Resource))
            {
                ...
                ((IJsonModel<ExtendedGremlinDatabaseResourceInfo>)Resource).Write(writer, options);
            }
            if (Optional.IsDefined(Options))
            {
                writer.WritePropertyName("options"u8);
                ((IJsonModel<GremlinDatabasePropertiesConfig>)Options).Write(writer, options);
            }
            writer.WriteEndObject();
        }
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        if (property0.NameEquals("resource"u8))
                        {
                            ...
                            resource = ModelSerializationExtensions.JsonDeserialize<ExtendedGremlinDatabaseResourceInfo>(property0.Value);
                            continue;
                        }
                        if (property0.NameEquals("options"u8))
                        {
                            ...
                            options0 = ModelSerializationExtensions.JsonDeserialize<GremlinDatabasePropertiesConfig>(property0.Value);
                            continue;
                        }
                    }
                    continue;
