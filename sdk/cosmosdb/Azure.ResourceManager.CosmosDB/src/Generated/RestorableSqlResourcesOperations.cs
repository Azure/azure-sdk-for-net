...
{
    /// <summary> The RestorableSqlResources service client. </summary>
    public partial class RestorableSqlResourcesOperations
    {
        private readonly ClientDiagnostics _clientDiagnostics;
        private readonly HttpPipeline _pipeline;
        internal RestorableSqlResourcesRestOperations RestClient { get; }

        /// <summary> Initializes a new instance of RestorableSqlResourcesOperations for mocking. </summary>
        protected RestorableSqlResourcesOperations()
        {
        }

        /// <summary> Initializes a new instance of RestorableSqlResourcesOperations. </summary>
        /// <param name="clientDiagnostics"> The handler for diagnostic messaging in the client. </param>
        /// <param name="pipeline"> The HTTP pipeline for sending and receiving REST requests and responses. </param>
        /// <param name="subscriptionId"> The ID of the target subscription. </param>
        /// <param name="endpoint"> server parameter. </param>
        /// <param name="apiVersion"> Api Version. </param>
        internal RestorableSqlResourcesOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-15")
        {
            RestClient = new RestorableSqlResourcesRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
        ...
        public virtual AsyncPageable<DatabaseRestoreResource> ListAsync(string location, string instanceId, string restoreLocation = null, string restoreTimestampInUtc = null, CancellationToken cancellationToken = default)
        {
            ...
            {
                using var scope = _clientDiagnostics.CreateScope("RestorableSqlResourcesOperations.List");
                scope.Start();
                try
                {
