...
namespace Azure.ResourceManager.CosmosDB
{
    public partial class CosmosDBSqlContainerResource : IJsonModel<CosmosDBSqlContainerData>
    {
        ...
        {
            return ModelReaderWriter.Read<CosmosDBSqlContainerData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<CosmosDBSqlContainerData>(data, options);
        }
