...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraTableThroughputSettingResource : ArmResource
    {
        ...
        internal CassandraTableThroughputSettingResource(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
            ...
            _cassandraResourcesRestClient = new CassandraResources(_cassandraResourcesClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, cassandraTableThroughputSettingApiVersion ?? "2026-04-01-preview");
