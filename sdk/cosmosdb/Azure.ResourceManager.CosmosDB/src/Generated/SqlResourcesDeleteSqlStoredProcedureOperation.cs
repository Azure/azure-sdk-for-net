...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class SqlResourcesDeleteSqlStoredProcedureOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of SqlResourcesDeleteSqlStoredProcedureOperation for mocking. </summary>
        protected SqlResourcesDeleteSqlStoredProcedureOperation()
        {
        }

        internal SqlResourcesDeleteSqlStoredProcedureOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlResourcesDeleteSqlStoredProcedureOperation");
        }
        /// <inheritdoc />
