...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="TableRoleDefinitionResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="DatabaseAccountGetResultsResource"/> using the GetTableRoleDefinitionResources method.
    /// </summary>
    public partial class TableRoleDefinitionResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of TableRoleDefinitionResource for mocking. </summary>
        protected TableRoleDefinitionResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="TableRoleDefinitionResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string tableRoleDefinitionResourceApiVersion);
        ...
        {
            using DiagnosticScope scope = _tableResourcesClientDiagnostics.CreateScope("TableRoleDefinitionResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _tableResourcesClientDiagnostics.CreateScope("TableRoleDefinitionResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        /// <summary>
        /// Update a TableRoleDefinitionResource.
        /// <list type="bullet">
        /// <item>
        /// <term> Request Path. </term>
        /// <description> /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DocumentDB/databaseAccounts/{accountName}/tableRoleDefinitions/{roleDefinitionId}. </description>
        ...
        public virtual async Task<ArmOperation<TableRoleDefinitionResource>> UpdateAsync(WaitUntil waitUntil, TableRoleDefinitionResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tableResourcesClientDiagnostics.CreateScope("TableRoleDefinitionResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _tableResourcesRestClient.CreateCreateUpdateTableRoleDefinitionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Name, Id.Name, TableRoleDefinitionResourceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
