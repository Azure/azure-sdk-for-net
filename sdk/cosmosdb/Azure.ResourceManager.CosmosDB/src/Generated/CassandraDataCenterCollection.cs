...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraDataCenterCollection : ArmCollection, IEnumerable<CassandraDataCenterResource>, IAsyncEnumerable<CassandraDataCenterResource>
    {
        ...
        public virtual AsyncPageable<CassandraDataCenterResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return PageableHelpers.CreateAsyncPageable(FirstPageRequest, null, e => { var data = CassandraDataCenterData.DeserializeCassandraDataCenterData(e); return new CassandraDataCenterResource(Client, data, data.Id); }, _cassandraDataCenterClientDiagnostics, Pipeline, "CassandraDataCenterCollection.GetAll", "value", null, cancellationToken);
        }
        ...
        {
            HttpMessage FirstPageRequest(int? pageSizeHint) => _cassandraDataCenterRestClient.CreateListRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name);
            return PageableHelpers.CreatePageable(FirstPageRequest, null, e => { var data = CassandraDataCenterData.DeserializeCassandraDataCenterData(e); return new CassandraDataCenterResource(Client, data, data.Id); }, _cassandraDataCenterClientDiagnostics, Pipeline, "CassandraDataCenterCollection.GetAll", "value", null, cancellationToken);
        }
