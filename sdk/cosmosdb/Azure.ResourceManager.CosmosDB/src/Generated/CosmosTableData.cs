...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosTableData : TrackedResource
    {
        ...
        internal CosmosTableData(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, CosmosTablePropertiesResource resource, CosmosTablePropertiesOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
