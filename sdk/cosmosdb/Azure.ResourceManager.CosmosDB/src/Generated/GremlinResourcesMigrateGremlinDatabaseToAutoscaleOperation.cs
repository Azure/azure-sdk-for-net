...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinResourcesMigrateGremlinDatabaseToAutoscaleOperation : Operation<ThroughputSettingsGetResults>, IOperationSource<ThroughputSettingsGetResults>
    {
        private readonly ArmOperationHelpers<ThroughputSettingsGetResults> _operation;

        /// <summary> Initializes a new instance of GremlinResourcesMigrateGremlinDatabaseToAutoscaleOperation for mocking. </summary>
        protected GremlinResourcesMigrateGremlinDatabaseToAutoscaleOperation()
        {
        }

        internal GremlinResourcesMigrateGremlinDatabaseToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ThroughputSettingsGetResults>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "GremlinResourcesMigrateGremlinDatabaseToAutoscaleOperation");
        }
        /// <inheritdoc />
