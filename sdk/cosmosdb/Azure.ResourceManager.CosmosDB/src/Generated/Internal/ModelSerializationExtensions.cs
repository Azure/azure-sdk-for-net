...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    {
        private static readonly JsonSerializerOptions s_options = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureResourceManagerCosmosDBContext.Default) } };
        private static readonly JsonSerializerOptions s_optionsUseManagedServiceIdentityV3 = new JsonSerializerOptions { Converters = { new JsonModelConverter(WireOptions, AzureResourceManagerCosmosDBContext.Default), new ResourceManager.Models.ManagedServiceIdentityTypeV3Converter() } };
