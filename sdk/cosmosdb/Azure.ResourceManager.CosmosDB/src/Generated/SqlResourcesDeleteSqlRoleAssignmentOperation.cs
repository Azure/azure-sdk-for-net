...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class SqlResourcesDeleteSqlRoleAssignmentOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of SqlResourcesDeleteSqlRoleAssignmentOperation for mocking. </summary>
        protected SqlResourcesDeleteSqlRoleAssignmentOperation()
        {
        }

        internal SqlResourcesDeleteSqlRoleAssignmentOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlResourcesDeleteSqlRoleAssignmentOperation");
        }
        /// <inheritdoc />
