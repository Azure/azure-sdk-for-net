...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBResourcesDeleteMongoDBCollectionOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of MongoDBResourcesDeleteMongoDBCollectionOperation for mocking. </summary>
        protected MongoDBResourcesDeleteMongoDBCollectionOperation()
        {
        }

        internal MongoDBResourcesDeleteMongoDBCollectionOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBResourcesDeleteMongoDBCollectionOperation");
        }
        /// <inheritdoc />
