...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class ServiceResourceData : ResourceData
    {
        ...
        internal ServiceResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ServiceResourceProperties properties) : base(id, name, resourceType, systemData)
        {
