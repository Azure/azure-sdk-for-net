...
{
    /// <summary> A Class representing a DatabaseAccountCassandraKeyspaceThroughputSettingResource along with the instance operations that can be performed on it. </summary>
