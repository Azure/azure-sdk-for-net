...
namespace Azure.ResourceManager.CosmosDB
{
    internal partial class RestorableMongodbCollectionsRestOperations
    {
        ...
        public RestorableMongodbCollectionsRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-15")
        {
        ...
        public async Task<Response<RestorableMongodbCollectionsListResult>> ListAsync(string location, string instanceId, string restorableMongodbDatabaseRid = null, CancellationToken cancellationToken = default)
        {
            if (location == null)
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="location"/> or <paramref name="instanceId"/> is null. </exception>
        public Response<RestorableMongodbCollectionsListResult> List(string location, string instanceId, string restorableMongodbDatabaseRid = null, CancellationToken cancellationToken = default)
        {
            if (location == null)
            {
                throw new ArgumentNullException(nameof(location));
