...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class SqlTriggerCollection : ArmCollection, IEnumerable<SqlTriggerResource>, IAsyncEnumerable<SqlTriggerResource>
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="triggerName"/> or <paramref name="info"/> is null. </exception>
        public virtual async Task<ArmOperation<SqlTriggerResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string triggerName, SqlTriggerCreateOrUpdateInfo info, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _sqlTriggerSqlResourcesRestClient.CreateUpdateSqlTriggerAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, triggerName, info, cancellationToken).ConfigureAwait(false);
                var operation = new CosmosDBArmOperation<SqlTriggerResource>(new SqlTriggerOperationSource(Client), _sqlTriggerSqlResourcesClientDiagnostics, Pipeline, _sqlTriggerSqlResourcesRestClient.CreateCreateUpdateSqlTriggerRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, triggerName, info).Request, response, OperationFinalStateVia.Location);
        ...
        /// <exception cref="ArgumentException"> <paramref name="triggerName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="triggerName"/> or <paramref name="info"/> is null. </exception>
        public virtual ArmOperation<SqlTriggerResource> CreateOrUpdate(WaitUntil waitUntil, string triggerName, SqlTriggerCreateOrUpdateInfo info, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(triggerName, nameof(triggerName));
            Argument.AssertNotNull(info, nameof(info));
            ...
            try
            {
                var response = _sqlTriggerSqlResourcesRestClient.CreateUpdateSqlTrigger(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, triggerName, info, cancellationToken);
                var operation = new CosmosDBArmOperation<SqlTriggerResource>(new SqlTriggerOperationSource(Client), _sqlTriggerSqlResourcesClientDiagnostics, Pipeline, _sqlTriggerSqlResourcesRestClient.CreateCreateUpdateSqlTriggerRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, triggerName, info).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
