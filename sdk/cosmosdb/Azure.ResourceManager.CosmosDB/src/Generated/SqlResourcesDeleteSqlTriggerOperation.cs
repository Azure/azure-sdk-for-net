...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class SqlResourcesDeleteSqlTriggerOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of SqlResourcesDeleteSqlTriggerOperation for mocking. </summary>
        protected SqlResourcesDeleteSqlTriggerOperation()
        {
        }

        internal SqlResourcesDeleteSqlTriggerOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlResourcesDeleteSqlTriggerOperation");
        }
        /// <inheritdoc />
