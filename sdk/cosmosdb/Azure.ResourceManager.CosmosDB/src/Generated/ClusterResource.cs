...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class ClusterResource : ArmResource
    {
        ...
        internal ClusterResource(ArmClient armClient, ClusterResourceData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal ClusterResource(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string clusterResourceCassandraClustersApiVersion);
        ...
        public async virtual Task<ClusterResourceUpdateOperation> UpdateAsync(bool waitForCompletion, ClusterResourceData body, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new ClusterResourceUpdateOperation(ArmClient, _clusterResourceCassandraClustersClientDiagnostics, Pipeline, _clusterResourceCassandraClustersRestClient.CreateUpdateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, body).Request, response);
                if (waitForCompletion)
        ...
        {
            return new DataCenterResourceCollection(this);
        }
        #endregion
    }
}
