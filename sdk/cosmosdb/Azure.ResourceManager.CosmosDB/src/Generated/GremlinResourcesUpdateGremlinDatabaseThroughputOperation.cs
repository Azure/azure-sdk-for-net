...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinResourcesUpdateGremlinDatabaseThroughputOperation : Operation<ThroughputSettingsGetResults>, IOperationSource<ThroughputSettingsGetResults>
    {
        private readonly ArmOperationHelpers<ThroughputSettingsGetResults> _operation;

        /// <summary> Initializes a new instance of GremlinResourcesUpdateGremlinDatabaseThroughputOperation for mocking. </summary>
        protected GremlinResourcesUpdateGremlinDatabaseThroughputOperation()
        {
        }

        internal GremlinResourcesUpdateGremlinDatabaseThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<ThroughputSettingsGetResults>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "GremlinResourcesUpdateGremlinDatabaseThroughputOperation");
        }
        /// <inheritdoc />
