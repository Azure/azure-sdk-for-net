...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBUsagesResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBUsagesResult)} does not support writing '{format}' format.");
            }
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<CosmosDBBaseUsage>)item).Write(writer, options);
                }
        ...
        CosmosDBUsagesResult IJsonModel<CosmosDBUsagesResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBUsagesResult)} does not support reading '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CosmosDBUsagesResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CosmosDBUsagesResult)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CosmosDBUsagesResult IPersistableModel<CosmosDBUsagesResult>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CosmosDBUsagesResult)} does not support reading '{options.Format}' format.");
            }
        }
