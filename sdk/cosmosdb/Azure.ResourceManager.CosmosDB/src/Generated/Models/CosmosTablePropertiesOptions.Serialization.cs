...
{
    public partial class CosmosTablePropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static CosmosTablePropertiesOptions DeserializeCosmosTablePropertiesOptions(JsonElement element)
        {
            ...
            return new CosmosTablePropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
