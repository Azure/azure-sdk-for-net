...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlUserDefinedFunctionCreateOrUpdateInfo : TrackedResourceData
    {
        /// <summary> Initializes a new instance of SqlUserDefinedFunctionCreateOrUpdateInfo. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a userDefinedFunction. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public SqlUserDefinedFunctionCreateOrUpdateInfo(AzureLocation location, SqlUserDefinedFunctionResource resource) : base(location)
        {
            if (resource == null)
            {
