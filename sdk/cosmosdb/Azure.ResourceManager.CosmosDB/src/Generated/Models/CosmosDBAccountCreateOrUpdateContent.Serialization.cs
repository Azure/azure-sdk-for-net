...
{
    public partial class CosmosDBAccountCreateOrUpdateContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CosmosDBAccountCreateOrUpdateContent DeserializeCosmosDBAccountCreateOrUpdateContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
