...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class CosmosDBAccountCreateOrUpdateContent : IUtf8JsonSerializable, IJsonModel<CosmosDBAccountCreateOrUpdateContent>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBAccountCreateOrUpdateContent>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBAccountCreateOrUpdateContent>)} interface");
            }
