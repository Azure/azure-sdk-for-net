...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    internal partial class GremlinRoleDefinitionResourceProperties
    {
        ...
        internal GremlinRoleDefinitionResourceProperties(string id, string roleName, RoleDefinitionType? @type, IList<string> assignableScopes, IList<Permission> permissions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            RoleName = roleName;
            Type = @type;
