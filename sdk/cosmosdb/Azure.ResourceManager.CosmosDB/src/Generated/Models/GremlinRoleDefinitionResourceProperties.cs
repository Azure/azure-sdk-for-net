...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    internal partial class GremlinRoleDefinitionResourceProperties
    {
        ...
        internal GremlinRoleDefinitionResourceProperties(string id, string roleName, CosmosDBSqlRoleDefinitionType? @type, IList<string> assignableScopes, IList<CosmosDBSqlRolePermission> permissions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            RoleName = roleName;
            Type = @type;
