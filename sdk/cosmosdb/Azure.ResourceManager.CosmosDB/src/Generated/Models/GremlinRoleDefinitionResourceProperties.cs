...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    internal partial class GremlinRoleDefinitionResourceProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GremlinRoleDefinitionResourceProperties"/>. </summary>
        ...
        internal GremlinRoleDefinitionResourceProperties(string roleDefinitionId, string roleName, CosmosDBSqlRoleDefinitionType? @type, IList<string> assignableScopes, IList<CosmosDBSqlRolePermission> permissions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
