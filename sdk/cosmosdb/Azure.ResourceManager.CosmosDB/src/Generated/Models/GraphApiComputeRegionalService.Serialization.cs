...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GraphApiComputeRegionalService>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GraphApiComputeRegionalService>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GraphApiComputeRegionalService>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GraphApiComputeRegionalService>)} interface");
            }
        ...
        string IPersistableModel<GraphApiComputeRegionalService>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
