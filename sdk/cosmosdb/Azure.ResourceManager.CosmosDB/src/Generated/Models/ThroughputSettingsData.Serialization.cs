...
{
    public partial class ThroughputSettingsData : IUtf8JsonSerializable
    {
        ...
        internal static ThroughputSettingsData DeserializeThroughputSettingsData(JsonElement element)
        {
            ...
            return new ThroughputSettingsData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource.Value);
        }
    }
}
