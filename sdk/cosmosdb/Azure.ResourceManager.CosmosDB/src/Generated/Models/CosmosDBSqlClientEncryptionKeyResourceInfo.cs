...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBSqlClientEncryptionKeyResourceInfo
    {
        ...
        internal CosmosDBSqlClientEncryptionKeyResourceInfo(string id, string encryptionAlgorithm, byte[] wrappedDataEncryptionKey, CosmosDBKeyWrapMetadata keyWrapMetadata, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
