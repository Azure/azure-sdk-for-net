...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class TableGetResults : ARMResourceProperties
    {
        ...
        internal TableGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, TableGetPropertiesResource resource, OptionsResource options) : base(id, name, type, location, tags)
        {
            Resource = resource;
            Options = options;
        }
