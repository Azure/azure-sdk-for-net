...
{
    public partial class CosmosDBSqlContainerPropertiesConfig : Core.IUtf8JsonSerializable
    {
        ...
        internal static CosmosDBSqlContainerPropertiesConfig DeserializeCosmosDBSqlContainerPropertiesConfig(JsonElement element)
        {
            ...
            return new CosmosDBSqlContainerPropertiesConfig(Core.Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
