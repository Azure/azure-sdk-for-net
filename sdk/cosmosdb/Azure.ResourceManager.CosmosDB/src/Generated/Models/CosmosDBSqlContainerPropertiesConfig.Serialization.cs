...
{
    public partial class CosmosDBSqlContainerPropertiesConfig : IUtf8JsonSerializable
    {
        ...
        internal static CosmosDBSqlContainerPropertiesConfig DeserializeCosmosDBSqlContainerPropertiesConfig(JsonElement element)
        {
            ...
            return new CosmosDBSqlContainerPropertiesConfig(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
