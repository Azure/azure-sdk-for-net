...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableGremlinDatabasePropertiesResource
    {
        ...
        /// <summary> Initializes a new instance of <see cref="RestorableGremlinDatabasePropertiesResource"/>. </summary>
        ...
        internal RestorableGremlinDatabasePropertiesResource(string rid, CosmosDBOperationType? operationType, string canUndelete, string canUndeleteReason, string eventTimestamp, string ownerId, string ownerResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Rid = rid;
