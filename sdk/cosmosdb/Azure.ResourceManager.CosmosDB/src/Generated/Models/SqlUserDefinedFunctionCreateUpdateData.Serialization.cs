...
{
    public partial class SqlUserDefinedFunctionCreateUpdateData : IUtf8JsonSerializable
    {
        ...
        internal static SqlUserDefinedFunctionCreateUpdateData DeserializeSqlUserDefinedFunctionCreateUpdateData(JsonElement element)
        {
            ...
            return new SqlUserDefinedFunctionCreateUpdateData(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
