...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBMongoVCoreCollectionInfo
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CosmosDBMongoVCoreCollectionInfo"/>. </summary>
        ...
        public CosmosDBMongoVCoreCollectionInfo(string databaseName, string collectionName)
        {
        ...
        internal CosmosDBMongoVCoreCollectionInfo(string databaseName, string collectionName, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            DatabaseName = databaseName;
            CollectionName = collectionName;
