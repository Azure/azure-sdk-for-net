...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GremlinDatabaseResourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GremlinDatabaseResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GremlinDatabaseResourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GremlinDatabaseResourceInfo>)} interface");
            }
        ...
        string IPersistableModel<GremlinDatabaseResourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
