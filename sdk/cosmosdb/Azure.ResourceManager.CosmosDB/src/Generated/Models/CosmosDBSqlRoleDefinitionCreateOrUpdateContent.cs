...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBSqlRoleDefinitionCreateOrUpdateContent
    {
        ...
        internal CosmosDBSqlRoleDefinitionCreateOrUpdateContent(string roleName, CosmosDBSqlRoleDefinitionType? roleDefinitionType, IList<string> assignableScopes, IList<CosmosDBSqlRolePermission> permissions, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RoleName = roleName;
