...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraTablePropertiesConfig : CosmosDBBaseConfig, IJsonModel<CassandraTablePropertiesConfig>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CassandraTablePropertiesConfig>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CassandraTablePropertiesConfig>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CassandraTablePropertiesConfig IPersistableModel<CassandraTablePropertiesConfig>.Create(BinaryData data, ModelReaderWriterOptions options) => (CassandraTablePropertiesConfig)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CassandraTablePropertiesConfig IJsonModel<CassandraTablePropertiesConfig>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CassandraTablePropertiesConfig)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CassandraTablePropertiesConfig DeserializeCassandraTablePropertiesConfig(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new CassandraTablePropertiesConfig(throughput, autoscaleSettings, additionalBinaryDataProperties);
        }
    }
}
