...
{
    public partial class CassandraTablePropertiesConfig : Core.IUtf8JsonSerializable
    {
        ...
        internal static CassandraTablePropertiesConfig DeserializeCassandraTablePropertiesConfig(JsonElement element)
        {
            ...
            return new CassandraTablePropertiesConfig(Core.Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
