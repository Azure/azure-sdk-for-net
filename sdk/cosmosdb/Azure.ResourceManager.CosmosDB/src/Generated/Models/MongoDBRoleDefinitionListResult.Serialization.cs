...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBRoleDefinitionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBRoleDefinitionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBRoleDefinitionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBRoleDefinitionListResult>)} interface");
            }
        ...
        string IPersistableModel<MongoDBRoleDefinitionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
