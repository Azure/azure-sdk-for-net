...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableMongoDBResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableMongoDBResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableMongoDBResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableMongoDBResourceData>)} interface");
            }
        ...
        string IPersistableModel<RestorableMongoDBResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
