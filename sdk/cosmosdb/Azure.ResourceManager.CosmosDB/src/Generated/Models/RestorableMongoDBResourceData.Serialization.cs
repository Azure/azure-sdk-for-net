...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableMongoDBResourceData : ResourceData, IJsonModel<RestorableMongoDBResourceData>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RestorableMongoDBResourceData IPersistableModel<RestorableMongoDBResourceData>.Create(BinaryData data, ModelReaderWriterOptions options) => (RestorableMongoDBResourceData)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RestorableMongoDBResourceData IJsonModel<RestorableMongoDBResourceData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RestorableMongoDBResourceData)JsonModelCreateCore(ref reader, options);
