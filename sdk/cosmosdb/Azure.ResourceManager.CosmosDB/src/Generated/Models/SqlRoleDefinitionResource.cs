...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    internal partial class SqlRoleDefinitionResource
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SqlRoleDefinitionResource"/>. </summary>
        ...
        internal SqlRoleDefinitionResource(string roleName, CosmosDBSqlRoleDefinitionType? roleDefinitionType, IList<string> assignableScopes, IList<CosmosDBSqlRolePermission> permissions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            RoleName = roleName;
