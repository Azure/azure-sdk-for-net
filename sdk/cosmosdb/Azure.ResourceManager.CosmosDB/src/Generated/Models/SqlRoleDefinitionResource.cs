...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    internal partial class SqlRoleDefinitionResource
    {
        ...
        internal SqlRoleDefinitionResource(string roleName, RoleDefinitionType? @type, IList<string> assignableScopes, IList<Permission> permissions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            RoleName = roleName;
            Type = @type;
