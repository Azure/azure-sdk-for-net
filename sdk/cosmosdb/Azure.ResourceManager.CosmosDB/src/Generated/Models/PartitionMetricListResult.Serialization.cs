...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static PartitionMetricListResult DeserializePartitionMetricListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
