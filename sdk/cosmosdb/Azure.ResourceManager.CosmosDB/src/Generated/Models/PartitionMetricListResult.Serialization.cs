...
namespace Azure.ResourceManager.CosmosDB.Models
{
    internal partial class PartitionMetricListResult : IUtf8JsonSerializable, IJsonModel<PartitionMetricListResult>
    {
        ...
        void IJsonModel<PartitionMetricListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(PartitionMetricListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<PartitionMetricListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(PartitionMetricListResult)} does not support '{options.Format}' format.");
            }
        }
