...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PartitionMetricListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PartitionMetricListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PartitionMetricListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PartitionMetricListResult>)} interface");
            }
        ...
        string IPersistableModel<PartitionMetricListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
