...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static CosmosDBMetricListResult DeserializeCosmosDBMetricListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
