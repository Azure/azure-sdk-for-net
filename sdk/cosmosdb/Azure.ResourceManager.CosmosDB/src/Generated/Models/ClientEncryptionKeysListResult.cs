...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    internal partial class ClientEncryptionKeysListResult
    {
        ...
        {
            Value = new ChangeTrackingList<ClientEncryptionKeyGetResultsData>();
        }
        ...
        internal ClientEncryptionKeysListResult(IReadOnlyList<ClientEncryptionKeyGetResultsData> value, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<ClientEncryptionKeyGetResultsData> Value { get; }
