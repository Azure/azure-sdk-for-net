...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static DatabaseAccountKeysMetadata DeserializeDatabaseAccountKeysMetadata(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
