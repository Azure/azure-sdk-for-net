...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class CassandraViewGetPropertiesResource : IUtf8JsonSerializable, IModelJsonSerializable<CassandraViewGetPropertiesResource>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CassandraViewGetPropertiesResource>(this, options.Format);
        ...
        internal static CassandraViewGetPropertiesResource DeserializeCassandraViewGetPropertiesResource(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CassandraViewGetPropertiesResource(id, viewDefinition, rid.Value, Optional.ToNullable(ts), Optional.ToNullable(etag), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="CassandraViewGetPropertiesResource"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CassandraViewGetPropertiesResource"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CassandraViewGetPropertiesResource"/>. </summary>
