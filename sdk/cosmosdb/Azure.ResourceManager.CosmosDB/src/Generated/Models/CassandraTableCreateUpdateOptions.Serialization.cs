...
{
    public partial class CassandraTableCreateUpdateOptions : IUtf8JsonSerializable
    {
        ...
        internal static CassandraTableCreateUpdateOptions DeserializeCassandraTableCreateUpdateOptions(JsonElement element)
        {
            ...
            return new CassandraTableCreateUpdateOptions(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
