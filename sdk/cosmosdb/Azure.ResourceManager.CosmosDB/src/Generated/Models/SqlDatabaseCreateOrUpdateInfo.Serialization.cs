...
{
    public partial class SqlDatabaseCreateOrUpdateInfo : IUtf8JsonSerializable
    {
        ...
        internal static SqlDatabaseCreateOrUpdateInfo DeserializeSqlDatabaseCreateOrUpdateInfo(JsonElement element)
        {
            ...
            return new SqlDatabaseCreateOrUpdateInfo(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
