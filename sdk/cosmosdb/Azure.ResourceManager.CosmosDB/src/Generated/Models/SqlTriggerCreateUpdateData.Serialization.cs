...
{
    public partial class SqlTriggerCreateUpdateData : IUtf8JsonSerializable
    {
        ...
        internal static SqlTriggerCreateUpdateData DeserializeSqlTriggerCreateUpdateData(JsonElement element)
        {
            ...
            return new SqlTriggerCreateUpdateData(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
