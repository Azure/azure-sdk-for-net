...
{
    public partial class ExtendedGremlinDatabaseResourceInfo : Core.IUtf8JsonSerializable
    {
        ...
        internal static ExtendedGremlinDatabaseResourceInfo DeserializeExtendedGremlinDatabaseResourceInfo(JsonElement element)
        {
            ...
            return new ExtendedGremlinDatabaseResourceInfo(id, restoreParameters.Value, Core.Optional.ToNullable(createMode), rid.Value, Core.Optional.ToNullable(ts), Core.Optional.ToNullable(etag));
        }
    }
}
