...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class ExtendedGremlinDatabaseResourceInfo : IUtf8JsonSerializable, IJsonModel<ExtendedGremlinDatabaseResourceInfo>
    {
        ...
        void IJsonModel<ExtendedGremlinDatabaseResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(ExtendedGremlinDatabaseResourceInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ExtendedGremlinDatabaseResourceInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(ExtendedGremlinDatabaseResourceInfo)} does not support '{options.Format}' format.");
            }
        }
