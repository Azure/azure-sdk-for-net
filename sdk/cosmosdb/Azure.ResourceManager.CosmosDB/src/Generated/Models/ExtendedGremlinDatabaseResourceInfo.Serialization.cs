...
{
    public partial class ExtendedGremlinDatabaseResourceInfo : IUtf8JsonSerializable
    {
        ...
        internal static ExtendedGremlinDatabaseResourceInfo DeserializeExtendedGremlinDatabaseResourceInfo(JsonElement element)
        {
            ...
            return new ExtendedGremlinDatabaseResourceInfo(id, restoreParameters.Value, Optional.ToNullable(createMode), rid.Value, Optional.ToNullable(ts), Optional.ToNullable(etag));
        }
    }
}
