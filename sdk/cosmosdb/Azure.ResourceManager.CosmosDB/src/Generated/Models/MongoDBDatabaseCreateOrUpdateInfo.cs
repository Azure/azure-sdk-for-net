...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBDatabaseCreateOrUpdateInfo : TrackedResourceData
    {
        /// <summary> Initializes a new instance of MongoDBDatabaseCreateOrUpdateInfo. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a MongoDB database. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public MongoDBDatabaseCreateOrUpdateInfo(AzureLocation location, MongoDBDatabaseResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal MongoDBDatabaseCreateOrUpdateInfo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, MongoDBDatabaseResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
