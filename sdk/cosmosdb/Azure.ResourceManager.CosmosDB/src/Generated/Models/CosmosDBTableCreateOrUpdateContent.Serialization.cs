...
{
    public partial class CosmosDBTableCreateOrUpdateContent : Core.IUtf8JsonSerializable
    {
        ...
        internal static CosmosDBTableCreateOrUpdateContent DeserializeCosmosDBTableCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new CosmosDBTableCreateOrUpdateContent(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
