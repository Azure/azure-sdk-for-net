...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    internal partial class GremlinDatabaseListResult
    {
        ...
        {
            Value = new ChangeTrackingList<GremlinDatabaseGetResultsData>();
        }
        ...
        internal GremlinDatabaseListResult(IReadOnlyList<GremlinDatabaseGetResultsData> value, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<GremlinDatabaseGetResultsData> Value { get; }
