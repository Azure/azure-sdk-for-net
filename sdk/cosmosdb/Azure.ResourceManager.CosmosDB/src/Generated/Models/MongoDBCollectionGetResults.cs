...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionGetResults : ARMResourceProperties
    {
        ...
        internal MongoDBCollectionGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, MongoDBCollectionGetPropertiesResource resource, MongoDBCollectionGetPropertiesOptions options) : base(id, name, type, location, tags)
        {
            Resource = resource;
            Options = options;
        }
