...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContinuousBackupRestoreLocation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContinuousBackupRestoreLocation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContinuousBackupRestoreLocation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContinuousBackupRestoreLocation>)} interface");
            }
        ...
        string IPersistableModel<ContinuousBackupRestoreLocation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
