...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraTableCreateOrUpdateContent : ARMResourceProperties
    {
        ...
        public CassandraTableCreateOrUpdateContent(CassandraTableResourceInfo resource)
        {
        ...
        internal CassandraTableCreateOrUpdateContent(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, CassandraTableCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
