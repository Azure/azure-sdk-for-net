...
{
    public partial class CassandraClusterProperties : IUtf8JsonSerializable, IJsonModel<CassandraClusterProperties>, IPersistableModel<CassandraClusterProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(AuthenticationMethod))
            {
                ...
                builder.AppendLine($" '{AuthenticationMethod.ToString()}'");
            }
            ...
            if (Optional.IsDefined(PrometheusEndpoint))
            {
                ...
                AppendChildObject(builder, PrometheusEndpoint, options, 2);
            }
            ...
            if (Optional.IsDefined(HoursBetweenBackups))
            {
                ...
                builder.AppendLine($" '{HoursBetweenBackups.Value.ToString()}'");
            }
