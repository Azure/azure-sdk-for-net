...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static CassandraConnectionError DeserializeCassandraConnectionError(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
