...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CommandPublicResource
    {
        ...
        internal CommandPublicResource(string command, string commandId, BinaryData arguments, string host, bool? isAdmin, bool? cassandraStopStart, bool? readWrite, string result, CommandStatus? status, string outputFile, IDictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Command = command;
            CommandId = commandId;
            Arguments = arguments;
