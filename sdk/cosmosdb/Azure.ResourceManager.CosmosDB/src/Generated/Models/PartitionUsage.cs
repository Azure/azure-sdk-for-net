...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class PartitionUsage : CosmosDBBaseUsage
    {
        ...
        internal PartitionUsage(CosmosDBMetricUnitType? unit, CosmosDBMetricName name, string quotaPeriod, long? limit, long? currentValue, Guid? partitionId, string partitionKeyRangeId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(unit, name, quotaPeriod, limit, currentValue, serializedAdditionalRawData)
        {
