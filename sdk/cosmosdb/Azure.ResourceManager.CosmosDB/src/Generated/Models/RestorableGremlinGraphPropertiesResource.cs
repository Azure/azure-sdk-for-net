...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableGremlinGraphPropertiesResource
    {
        ...
        /// <summary> Initializes a new instance of <see cref="RestorableGremlinGraphPropertiesResource"/>. </summary>
        ...
        internal RestorableGremlinGraphPropertiesResource(string rid, CosmosDBOperationType? operationType, string canUndelete, string canUndeleteReason, string eventTimestamp, string ownerId, string ownerResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Rid = rid;
