...
{
    public partial class CosmosDBBaseConfig : IUtf8JsonSerializable, IJsonModel<CosmosDBBaseConfig>, IPersistableModel<CosmosDBBaseConfig>
    {
        ...
        void IJsonModel<CosmosDBBaseConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBBaseConfig)} does not support '{format}' format.");
            }
