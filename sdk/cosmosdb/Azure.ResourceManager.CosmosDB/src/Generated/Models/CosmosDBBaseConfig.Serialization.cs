...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBBaseConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBBaseConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBBaseConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBBaseConfig>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBBaseConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
