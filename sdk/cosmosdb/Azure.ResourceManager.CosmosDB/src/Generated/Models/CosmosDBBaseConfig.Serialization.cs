...
{
    public partial class CosmosDBBaseConfig : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CosmosDBBaseConfig DeserializeCosmosDBBaseConfig(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
