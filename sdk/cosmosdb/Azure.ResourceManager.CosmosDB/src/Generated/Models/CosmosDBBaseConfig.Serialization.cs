...
{
    public partial class CosmosDBBaseConfig : Core.IUtf8JsonSerializable
    {
        ...
        internal static CosmosDBBaseConfig DeserializeCosmosDBBaseConfig(JsonElement element)
        {
            ...
            return new CosmosDBBaseConfig(Core.Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
