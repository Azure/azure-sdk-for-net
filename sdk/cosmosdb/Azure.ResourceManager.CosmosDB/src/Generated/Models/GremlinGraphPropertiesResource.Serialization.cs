...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class GremlinGraphPropertiesResource : IUtf8JsonSerializable
    {
        ...
        internal static GremlinGraphPropertiesResource DeserializeGremlinGraphPropertiesResource(JsonElement element)
        {
            ...
            return new GremlinGraphPropertiesResource(id, indexingPolicy.Value, partitionKey.Value, Optional.ToNullable(defaultTtl), uniqueKeyPolicy.Value, conflictResolutionPolicy.Value, rid.Value, Optional.ToNullable(ts), etag.Value);
        }
    }
}
