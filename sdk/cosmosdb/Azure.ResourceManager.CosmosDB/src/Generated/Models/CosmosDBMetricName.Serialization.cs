...
{
    public partial class CosmosDBMetricName : IUtf8JsonSerializable, IJsonModel<CosmosDBMetricName>, IPersistableModel<CosmosDBMetricName>
    {
        ...
        void IJsonModel<CosmosDBMetricName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBMetricName)} does not support '{format}' format.");
            }
