...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBMetricName>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBMetricName>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBMetricName>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBMetricName>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBMetricName>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
