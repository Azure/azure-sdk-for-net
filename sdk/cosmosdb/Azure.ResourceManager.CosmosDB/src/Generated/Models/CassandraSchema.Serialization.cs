...
{
    public partial class CassandraSchema : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CassandraSchema DeserializeCassandraSchema(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
