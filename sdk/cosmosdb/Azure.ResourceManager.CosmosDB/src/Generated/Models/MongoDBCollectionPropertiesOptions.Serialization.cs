...
{
    public partial class MongoDBCollectionPropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static MongoDBCollectionPropertiesOptions DeserializeMongoDBCollectionPropertiesOptions(JsonElement element)
        {
            ...
            return new MongoDBCollectionPropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
