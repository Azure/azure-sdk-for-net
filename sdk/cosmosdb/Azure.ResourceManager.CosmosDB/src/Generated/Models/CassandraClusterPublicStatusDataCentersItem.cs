...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraClusterPublicStatusDataCentersItem
    {
        ...
        internal CassandraClusterPublicStatusDataCentersItem(string name, IReadOnlyList<string> seedNodes, IReadOnlyList<CassandraClusterDataCenterNodeItem> nodes, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
            SeedNodes = seedNodes;
            Nodes = nodes;
