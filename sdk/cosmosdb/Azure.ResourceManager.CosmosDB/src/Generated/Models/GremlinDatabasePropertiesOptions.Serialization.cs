...
{
    public partial class GremlinDatabasePropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static GremlinDatabasePropertiesOptions DeserializeGremlinDatabasePropertiesOptions(JsonElement element)
        {
            ...
            return new GremlinDatabasePropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
