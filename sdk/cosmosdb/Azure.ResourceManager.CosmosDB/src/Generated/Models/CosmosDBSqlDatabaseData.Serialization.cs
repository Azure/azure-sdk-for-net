...
namespace Azure.ResourceManager.CosmosDB
{
    public partial class CosmosDBSqlDatabaseData : IUtf8JsonSerializable, IModelJsonSerializable<CosmosDBSqlDatabaseData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CosmosDBSqlDatabaseData>(this, options.Format);
            ...
            if (Optional.IsDefined(Resource))
            {
                ...
                {
                    ((IModelJsonSerializable<ExtendedCosmosDBSqlDatabaseResourceInfo>)Resource).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(Options))
            {
                ...
                {
                    ((IModelJsonSerializable<CosmosDBSqlDatabasePropertiesConfig>)Options).Serialize(writer, options);
                }
            }
            writer.WriteEndObject();
        ...
        internal static CosmosDBSqlDatabaseData DeserializeCosmosDBSqlDatabaseData(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CosmosDBSqlDatabaseData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource.Value, options.Value, identity, serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="CosmosDBSqlDatabaseData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CosmosDBSqlDatabaseData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CosmosDBSqlDatabaseData"/>. </summary>
