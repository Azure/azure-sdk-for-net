...
{
    public partial class CosmosDBSqlDatabaseData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CosmosDBSqlDatabaseData DeserializeCosmosDBSqlDatabaseData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
