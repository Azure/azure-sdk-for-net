...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static CassandraKeyspaceListResult DeserializeCassandraKeyspaceListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
