...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CassandraKeyspaceListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CassandraKeyspaceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CassandraKeyspaceListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CassandraKeyspaceListResult>)} interface");
            }
        ...
        string IPersistableModel<CassandraKeyspaceListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
