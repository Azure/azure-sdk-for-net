...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="CassandraKeyspaceCreateUpdateParameters"/>. </summary>
        /// <param name="resourceId"> Name of the Cosmos DB Cassandra keyspace. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceId"/> is null. </exception>
        public CassandraKeyspaceCreateUpdateParameters(string resourceId)
        {
            Argument.AssertNotNull(resourceId, nameof(resourceId));

            Properties = new CassandraKeyspaceCreateUpdateProperties(resourceId);
        }
        ...
        internal CassandraKeyspaceCreateUpdateParameters(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, CassandraKeyspaceCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
