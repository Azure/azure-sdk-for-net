...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class NodeGroupSpec : IUtf8JsonSerializable, IModelJsonSerializable<NodeGroupSpec>
    {
        ...
        {
            ModelSerializerHelper.ValidateFormat<NodeGroupSpec>(this, options.Format);
        ...
        internal static NodeGroupSpec DeserializeNodeGroupSpec(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new NodeGroupSpec(sku.Value, Optional.ToNullable(diskSizeGB), Optional.ToNullable(enableHa), Optional.ToNullable(kind), Optional.ToNullable(nodeCount), rawData);
        }
