...
{
    public partial class CosmosDBTablePropertiesOptions : Core.IUtf8JsonSerializable
    {
        ...
        internal static CosmosDBTablePropertiesOptions DeserializeCosmosDBTablePropertiesOptions(JsonElement element)
        {
            ...
            return new CosmosDBTablePropertiesOptions(Core.Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
