...
{
    public partial class ExtendedCosmosDBSqlStoredProcedureResourceInfo : Core.IUtf8JsonSerializable
    {
        ...
        internal static ExtendedCosmosDBSqlStoredProcedureResourceInfo DeserializeExtendedCosmosDBSqlStoredProcedureResourceInfo(JsonElement element)
        {
            ...
            return new ExtendedCosmosDBSqlStoredProcedureResourceInfo(id, body.Value, rid.Value, Core.Optional.ToNullable(ts), Core.Optional.ToNullable(etag));
        }
    }
}
