...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MaterializedViewsBuilderRegionalService : CosmosDBRegionalService
    {
        ...
        internal MaterializedViewsBuilderRegionalService(string name, AzureLocation? location, CosmosDBServiceStatus? status, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(name, location, status, serializedAdditionalRawData)
        {
        }
    }
}
