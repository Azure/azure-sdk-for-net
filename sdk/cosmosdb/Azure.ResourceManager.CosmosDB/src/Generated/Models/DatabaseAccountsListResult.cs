...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    internal partial class DatabaseAccountsListResult
    {
        ...
        {
            Value = new ChangeTrackingList<DatabaseAccountGetResultsData>();
        }
        ...
        internal DatabaseAccountsListResult(IReadOnlyList<DatabaseAccountGetResultsData> value, string nextLink, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Value = value;
            NextLink = nextLink;
        ...
        public IReadOnlyList<DatabaseAccountGetResultsData> Value { get; }
