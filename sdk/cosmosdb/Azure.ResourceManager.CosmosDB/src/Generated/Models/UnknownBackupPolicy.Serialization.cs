...
{
    internal partial class UnknownBackupPolicy : CosmosDBAccountBackupPolicy, IJsonModel<CosmosDBAccountBackupPolicy>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static UnknownBackupPolicy DeserializeUnknownBackupPolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new UnknownBackupPolicy(backupPolicyType, migrationState, additionalBinaryDataProperties);
        }
    }
}
