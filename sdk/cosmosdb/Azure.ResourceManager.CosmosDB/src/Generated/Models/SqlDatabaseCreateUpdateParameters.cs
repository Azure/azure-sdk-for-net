...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlDatabaseCreateUpdateParameters : ARMResourceProperties
    {
        ...
        public SqlDatabaseCreateUpdateParameters(SqlDatabaseResource resource, CreateUpdateOptions options)
        {
            if (resource == null)
            {
        ...
        /// <param name="resource"> The standard JSON format of a SQL database. </param>
        /// <param name="options"> A key-value pair of options to be applied for the request. This corresponds to the headers sent with the request. </param>
        internal SqlDatabaseCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, SqlDatabaseResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags)
        {
            Resource = resource;
            Options = options;
        }
