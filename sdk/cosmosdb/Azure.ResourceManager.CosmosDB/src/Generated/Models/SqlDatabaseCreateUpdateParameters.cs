...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlDatabaseCreateUpdateParameters : TrackedResource
    {
        ...
        public SqlDatabaseCreateUpdateParameters(Resources.Models.Location location, SqlDatabaseResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal SqlDatabaseCreateUpdateParameters(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Resources.Models.Location location, SqlDatabaseResource resource, CreateUpdateOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
