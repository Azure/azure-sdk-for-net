...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBMaterializedViewDefinition
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CosmosDBMaterializedViewDefinition"/>. </summary>
        ...
        public CosmosDBMaterializedViewDefinition(string sourceCollectionId, string definition)
        {
        ...
        internal CosmosDBMaterializedViewDefinition(string sourceCollectionRid, string sourceCollectionId, string definition, int? throughputBucketForBuild, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
