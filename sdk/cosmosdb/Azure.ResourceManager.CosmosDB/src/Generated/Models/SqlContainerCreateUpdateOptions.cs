...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlContainerCreateUpdateOptions : TrackedResource
    {
        ...
        internal SqlContainerCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, SqlContainerResource resource, CreateUpdateOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
