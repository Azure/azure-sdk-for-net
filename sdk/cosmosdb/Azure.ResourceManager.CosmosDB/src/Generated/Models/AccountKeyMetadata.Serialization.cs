...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AccountKeyMetadata>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AccountKeyMetadata>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AccountKeyMetadata>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<AccountKeyMetadata>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
