...
{
    public partial class SqlDatabaseCreateUpdateOptions : IUtf8JsonSerializable
    {
        ...
        internal static SqlDatabaseCreateUpdateOptions DeserializeSqlDatabaseCreateUpdateOptions(JsonElement element)
        {
            ...
            return new SqlDatabaseCreateUpdateOptions(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
