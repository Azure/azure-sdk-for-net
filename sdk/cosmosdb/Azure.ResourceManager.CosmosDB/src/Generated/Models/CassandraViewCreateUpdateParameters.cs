...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraViewCreateUpdateParameters : ARMResourceProperties
    {
        ...
        internal CassandraViewCreateUpdateParameters(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, CassandraViewCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
