...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class PhysicalPartitionThroughputInfoResult : IUtf8JsonSerializable, IModelJsonSerializable<PhysicalPartitionThroughputInfoResult>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PhysicalPartitionThroughputInfoResult>(this, options.Format);
            ...
            if (Optional.IsDefined(Resource))
            {
                ...
                {
                    ((IModelJsonSerializable<PhysicalPartitionThroughputInfoResultPropertiesResource>)Resource).Serialize(writer, options);
                }
            }
            writer.WriteEndObject();
        ...
        /// <summary> Converts a <see cref="PhysicalPartitionThroughputInfoResult"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="PhysicalPartitionThroughputInfoResult"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="PhysicalPartitionThroughputInfoResult"/>. </summary>
