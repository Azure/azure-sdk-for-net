...
{
    public partial class CosmosDBSqlDedicatedGatewayServiceProperties : IUtf8JsonSerializable
    {
        ...
        internal static CosmosDBSqlDedicatedGatewayServiceProperties DeserializeCosmosDBSqlDedicatedGatewayServiceProperties(JsonElement element)
        {
            Optional<string> sqlDedicatedGatewayEndpoint = default;
            Optional<IReadOnlyList<CosmosDBSqlDedicatedGatewayRegionalServiceInfo>> locations = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("locations"))
                {
                    ...
                    List<CosmosDBSqlDedicatedGatewayRegionalServiceInfo> array = new List<CosmosDBSqlDedicatedGatewayRegionalServiceInfo>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(CosmosDBSqlDedicatedGatewayRegionalServiceInfo.DeserializeCosmosDBSqlDedicatedGatewayRegionalServiceInfo(item));
                    }
                    locations = array;
                    continue;
                }
            ...
            return new CosmosDBSqlDedicatedGatewayServiceProperties(Optional.ToNullable(creationTime), Optional.ToNullable(instanceSize), Optional.ToNullable(instanceCount), serviceType, Optional.ToNullable(status), additionalProperties, sqlDedicatedGatewayEndpoint.Value, Optional.ToList(locations));
        }
    }
}
