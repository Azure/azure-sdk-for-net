...
{
    public partial class BaseConfig : IUtf8JsonSerializable
    {
        ...
        internal static BaseConfig DeserializeBaseConfig(JsonElement element)
        {
            ...
            return new BaseConfig(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
