...
{
    public partial class SqlRoleDefinitionGetResults : IUtf8JsonSerializable
    {
        ...
        internal static SqlRoleDefinitionGetResults DeserializeSqlRoleDefinitionGetResults(JsonElement element)
        {
            ...
            return new SqlRoleDefinitionGetResults(id.Value, name.Value, type.Value, roleName.Value, Optional.ToNullable(type0), Optional.ToList(assignableScopes), Optional.ToList(permissions));
        }
    }
}
