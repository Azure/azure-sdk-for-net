...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class GremlinDatabasePropertiesConfig : IUtf8JsonSerializable, IJsonModel<GremlinDatabasePropertiesConfig>
    {
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<GremlinDatabasePropertiesConfig>)this).GetFormatFromOptions(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GremlinDatabasePropertiesConfig>)} interface");
            }
