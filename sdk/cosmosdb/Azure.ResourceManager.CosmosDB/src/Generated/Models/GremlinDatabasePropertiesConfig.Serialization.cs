...
{
    public partial class GremlinDatabasePropertiesConfig : Core.IUtf8JsonSerializable
    {
        ...
        internal static GremlinDatabasePropertiesConfig DeserializeGremlinDatabasePropertiesConfig(JsonElement element)
        {
            ...
            return new GremlinDatabasePropertiesConfig(Core.Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
