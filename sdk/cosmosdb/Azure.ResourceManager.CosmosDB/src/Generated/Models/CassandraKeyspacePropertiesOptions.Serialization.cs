...
{
    public partial class CassandraKeyspacePropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static CassandraKeyspacePropertiesOptions DeserializeCassandraKeyspacePropertiesOptions(JsonElement element)
        {
            ...
            return new CassandraKeyspacePropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
