...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBSqlTriggerCreateUpdateData : ARMResourceProperties
    {
        /// <summary> Initializes a new instance of <see cref="CosmosDBSqlTriggerCreateUpdateData"/>. </summary>
        /// <param name="resource"> The standard JSON format of a trigger. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public CosmosDBSqlTriggerCreateUpdateData(CosmosDBSqlTriggerResourceInfo resource)
        {
        ...
        internal CosmosDBSqlTriggerCreateUpdateData(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, SqlTriggerCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
