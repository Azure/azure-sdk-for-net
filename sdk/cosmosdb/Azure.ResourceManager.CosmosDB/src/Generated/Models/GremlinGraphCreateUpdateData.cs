...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinGraphCreateUpdateData : ARMResourceProperties
    {
        /// <summary> Initializes a new instance of <see cref="GremlinGraphCreateUpdateData"/>. </summary>
        /// <param name="resource"> The standard JSON format of a Gremlin graph. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public GremlinGraphCreateUpdateData(GremlinGraphResourceInfo resource)
        {
        ...
        internal GremlinGraphCreateUpdateData(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, GremlinGraphCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
            Properties = properties;
        }

        /// <summary> Properties to create and update Azure Cosmos DB Gremlin graph. </summary>
        internal GremlinGraphCreateUpdateProperties Properties { get; }
