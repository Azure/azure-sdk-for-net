...
{
    public partial class MongoUserDefinitionGetResultData : IUtf8JsonSerializable
    {
        ...
        internal static MongoUserDefinitionGetResultData DeserializeMongoUserDefinitionGetResultData(JsonElement element)
        {
            ...
            return new MongoUserDefinitionGetResultData(id, name, type, systemData.Value, userName.Value, password.Value, databaseName.Value, customData.Value, Optional.ToList(roles), mechanisms.Value);
        }
    }
}
