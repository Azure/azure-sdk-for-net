...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosSqlDataTransferDataSourceSink>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosSqlDataTransferDataSourceSink>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosSqlDataTransferDataSourceSink>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosSqlDataTransferDataSourceSink>)} interface");
            }
        ...
        string IPersistableModel<CosmosSqlDataTransferDataSourceSink>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
