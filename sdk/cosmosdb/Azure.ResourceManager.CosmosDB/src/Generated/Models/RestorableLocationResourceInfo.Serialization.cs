...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static RestorableLocationResourceInfo DeserializeRestorableLocationResourceInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
