...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CommandPostBody
    {
        ...
        /// <summary> Initializes a new instance of <see cref="CommandPostBody"/>. </summary>
        ...
        internal CommandPostBody(string command, IDictionary<string, string> arguments, string host, bool? cassandraStopStart, bool? readwrite, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Command = command;
            Arguments = arguments;
            Host = host;
