...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBMetricValue
    {
        ...
        internal CosmosDBMetricValue(int? count, double? average, double? maximum, double? minimum, DateTimeOffset? timestamp, double? total, Dictionary<string, BinaryData> rawData)
        {
            Count = count;
            Average = average;
            Maximum = maximum;
