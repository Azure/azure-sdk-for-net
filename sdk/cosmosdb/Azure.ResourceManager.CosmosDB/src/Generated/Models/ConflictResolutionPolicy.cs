...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ConflictResolutionPolicy
    {
        ...
        internal ConflictResolutionPolicy(ConflictResolutionMode? mode, string conflictResolutionPath, string conflictResolutionProcedure, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Mode = mode;
