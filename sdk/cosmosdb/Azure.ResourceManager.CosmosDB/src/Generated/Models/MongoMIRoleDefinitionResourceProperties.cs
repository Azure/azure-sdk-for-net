...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    internal partial class MongoMIRoleDefinitionResourceProperties
    {
        ...
        internal MongoMIRoleDefinitionResourceProperties(string id, string roleName, RoleDefinitionType? @type, IList<string> assignableScopes, IList<Permission> permissions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            RoleName = roleName;
            Type = @type;
