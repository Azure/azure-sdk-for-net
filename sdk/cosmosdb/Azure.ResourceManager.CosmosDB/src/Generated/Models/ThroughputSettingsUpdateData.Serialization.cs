...
{
    public partial class ThroughputSettingsUpdateData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ThroughputSettingsUpdateData DeserializeThroughputSettingsUpdateData(JsonElement element)
        {
            ...
            return new ThroughputSettingsUpdateData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, resource, identity);
        }
    }
}
