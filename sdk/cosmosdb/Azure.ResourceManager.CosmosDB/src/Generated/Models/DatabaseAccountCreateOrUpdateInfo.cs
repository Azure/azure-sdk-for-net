...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DatabaseAccountCreateOrUpdateInfo : TrackedResourceData
    {
        /// <summary> Initializes a new instance of DatabaseAccountCreateOrUpdateInfo. </summary>
        ...
        public DatabaseAccountCreateOrUpdateInfo(AzureLocation location, IEnumerable<DatabaseAccountLocation> locations) : base(location)
        {
            if (locations == null)
            {
