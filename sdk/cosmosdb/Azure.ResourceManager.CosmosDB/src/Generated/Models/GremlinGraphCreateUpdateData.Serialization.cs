...
{
    public partial class GremlinGraphCreateUpdateData : IUtf8JsonSerializable
    {
        ...
        internal static GremlinGraphCreateUpdateData DeserializeGremlinGraphCreateUpdateData(JsonElement element)
        {
            ...
            return new GremlinGraphCreateUpdateData(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
