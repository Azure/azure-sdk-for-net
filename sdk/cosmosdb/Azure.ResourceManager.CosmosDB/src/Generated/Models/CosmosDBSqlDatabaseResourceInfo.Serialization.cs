...
{
    public partial class CosmosDBSqlDatabaseResourceInfo : Core.IUtf8JsonSerializable
    {
        ...
        internal static CosmosDBSqlDatabaseResourceInfo DeserializeCosmosDBSqlDatabaseResourceInfo(JsonElement element)
        {
            ...
            return new CosmosDBSqlDatabaseResourceInfo(id, restoreParameters.Value, Core.Optional.ToNullable(createMode));
        }
    }
}
