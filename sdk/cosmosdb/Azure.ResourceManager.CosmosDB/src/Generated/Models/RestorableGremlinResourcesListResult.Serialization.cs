...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableGremlinResourcesListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableGremlinResourcesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableGremlinResourcesListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableGremlinResourcesListResult>)} interface");
            }
        ...
        string IPersistableModel<RestorableGremlinResourcesListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
