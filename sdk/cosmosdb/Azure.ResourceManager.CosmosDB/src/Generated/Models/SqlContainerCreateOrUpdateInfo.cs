...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlContainerCreateOrUpdateInfo : TrackedResourceData
    {
        /// <summary> Initializes a new instance of SqlContainerCreateOrUpdateInfo. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a container. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public SqlContainerCreateOrUpdateInfo(AzureLocation location, SqlContainerResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal SqlContainerCreateOrUpdateInfo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SqlContainerResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
