...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContinuousModeProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContinuousModeProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContinuousModeProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContinuousModeProperties>)} interface");
            }
        ...
        string IPersistableModel<ContinuousModeProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
