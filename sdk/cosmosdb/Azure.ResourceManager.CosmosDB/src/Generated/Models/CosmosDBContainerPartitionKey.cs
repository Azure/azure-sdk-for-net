...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBContainerPartitionKey
    {
        ...
        internal CosmosDBContainerPartitionKey(IList<string> paths, CosmosDBPartitionKind? kind, int? version, bool? isSystemKey, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Paths = paths;
            Kind = kind;
            Version = version;
