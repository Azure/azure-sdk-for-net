...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBSqlStoredProcedureCreateUpdateData : ARMResourceProperties
    {
        /// <summary> Initializes a new instance of <see cref="CosmosDBSqlStoredProcedureCreateUpdateData"/>. </summary>
        /// <param name="resource"> The standard JSON format of a storedProcedure. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public CosmosDBSqlStoredProcedureCreateUpdateData(CosmosDBSqlStoredProcedureResourceInfo resource)
        {
        ...
        internal CosmosDBSqlStoredProcedureCreateUpdateData(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, SqlStoredProcedureCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
