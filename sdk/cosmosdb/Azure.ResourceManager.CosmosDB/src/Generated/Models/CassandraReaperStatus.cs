...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraReaperStatus
    {
        ...
        internal CassandraReaperStatus(bool? isHealthy, IReadOnlyDictionary<string, string> repairRunIds, IReadOnlyDictionary<string, string> repairSchedules, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            IsHealthy = isHealthy;
