...
{
    public partial class CosmosDBClientEncryptionPolicy : IUtf8JsonSerializable, IJsonModel<CosmosDBClientEncryptionPolicy>, IPersistableModel<CosmosDBClientEncryptionPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PolicyFormatVersion))
            {
                ...
                builder.AppendLine($" '{PolicyFormatVersion.ToString()}'");
            }
