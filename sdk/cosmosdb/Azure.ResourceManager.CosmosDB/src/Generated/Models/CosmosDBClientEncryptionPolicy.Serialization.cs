...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBClientEncryptionPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBClientEncryptionPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBClientEncryptionPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBClientEncryptionPolicy>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBClientEncryptionPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
