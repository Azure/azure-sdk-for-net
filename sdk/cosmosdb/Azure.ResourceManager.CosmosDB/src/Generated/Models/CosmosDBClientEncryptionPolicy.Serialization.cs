...
{
    public partial class CosmosDBClientEncryptionPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CosmosDBClientEncryptionPolicy DeserializeCosmosDBClientEncryptionPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
