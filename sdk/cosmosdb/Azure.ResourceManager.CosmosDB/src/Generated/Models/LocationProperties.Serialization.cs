...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class LocationProperties : IUtf8JsonSerializable
    {
        ...
        internal static LocationProperties DeserializeLocationProperties(JsonElement element)
        {
            ...
            return new LocationProperties(Optional.ToNullable(supportsAvailabilityZone), Optional.ToNullable(isResidencyRestricted), Optional.ToList(backupStorageRedundancies));
        }
    }
}
