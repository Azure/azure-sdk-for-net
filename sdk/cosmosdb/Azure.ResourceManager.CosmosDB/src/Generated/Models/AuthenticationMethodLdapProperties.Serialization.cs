...
{
    public partial class AuthenticationMethodLdapProperties : IUtf8JsonSerializable, IJsonModel<AuthenticationMethodLdapProperties>, IPersistableModel<AuthenticationMethodLdapProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ServerPort))
            {
                ...
                builder.AppendLine($" '{ServerPort.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(ConnectionTimeoutInMs))
            {
                ...
                builder.AppendLine($" '{ConnectionTimeoutInMs.Value.ToString()}'");
            }
