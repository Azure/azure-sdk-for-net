...
{
    public partial class CosmosDBServiceProperties : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CosmosDBServiceProperties DeserializeCosmosDBServiceProperties(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
