...
{
    public partial class AutoscaleSettingsResourceInfo : IUtf8JsonSerializable, IJsonModel<AutoscaleSettingsResourceInfo>, IPersistableModel<AutoscaleSettingsResourceInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxThroughput))
            {
                ...
                builder.AppendLine($" '{MaxThroughput.ToString()}'");
            }

            if (Optional.IsDefined(AutoUpgradePolicy))
            {
                builder.Append("  autoUpgradePolicy:");
                AppendChildObject(builder, AutoUpgradePolicy, options, 2);
            }

            if (Optional.IsDefined(TargetMaxThroughput))
            {
                builder.Append("  targetMaxThroughput:");
                builder.AppendLine($" '{TargetMaxThroughput.Value.ToString()}'");
            }
