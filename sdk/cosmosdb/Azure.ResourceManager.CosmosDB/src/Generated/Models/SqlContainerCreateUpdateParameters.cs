...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlContainerCreateUpdateParameters : TrackedResource
    {
        /// <summary> Initializes a new instance of SqlContainerCreateUpdateParameters. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a container. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public SqlContainerCreateUpdateParameters(Resources.Models.Location location, SqlContainerResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal SqlContainerCreateUpdateParameters(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Resources.Models.Location location, SqlContainerResource resource, CreateUpdateOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
