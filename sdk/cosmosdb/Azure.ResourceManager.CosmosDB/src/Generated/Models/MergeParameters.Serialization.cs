...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class MergeParameters : IUtf8JsonSerializable, IJsonModel<MergeParameters>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            hasPropertyOverride = hasObjectOverride && propertyOverrides.TryGetValue(nameof(IsDryRun), out propertyOverride);
            if (hasPropertyOverride)
            {
                builder.Append("  isDryRun: ");
            ...
            else
            {
                ...
                {
                    builder.Append("  isDryRun: ");
                    var boolValue = IsDryRun.Value == true ? "true" : "false";
