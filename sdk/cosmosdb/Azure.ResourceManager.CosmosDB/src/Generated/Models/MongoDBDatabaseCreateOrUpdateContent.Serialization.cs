...
{
    public partial class MongoDBDatabaseCreateOrUpdateContent : Core.IUtf8JsonSerializable
    {
        ...
        internal static MongoDBDatabaseCreateOrUpdateContent DeserializeMongoDBDatabaseCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new MongoDBDatabaseCreateOrUpdateContent(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
