...
{
    public partial class MongoDBDatabaseCreateOrUpdateContent : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBDatabaseCreateOrUpdateContent DeserializeMongoDBDatabaseCreateOrUpdateContent(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
