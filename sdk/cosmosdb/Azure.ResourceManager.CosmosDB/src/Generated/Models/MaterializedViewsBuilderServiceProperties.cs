...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MaterializedViewsBuilderServiceProperties : CosmosDBServiceProperties
    {
        ...
        internal MaterializedViewsBuilderServiceProperties(DateTimeOffset? creationOn, CosmosDBServiceSize? instanceSize, int? instanceCount, CosmosDBServiceType serviceType, CosmosDBServiceStatus? status, IDictionary<string, BinaryData> additionalProperties, IReadOnlyList<MaterializedViewsBuilderRegionalService> locations) : base(creationOn, instanceSize, instanceCount, serviceType, status, additionalProperties)
        {
            Locations = locations;
        }
