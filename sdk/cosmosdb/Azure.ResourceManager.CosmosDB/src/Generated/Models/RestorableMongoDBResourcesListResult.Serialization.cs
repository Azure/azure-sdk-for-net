...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableMongoDBResourcesListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableMongoDBResourcesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableMongoDBResourcesListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableMongoDBResourcesListResult>)} interface");
            }
        ...
        string IPersistableModel<RestorableMongoDBResourcesListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
