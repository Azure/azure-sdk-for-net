...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionCreateUpdateOptions : TrackedResourceData
    {
        ...
        public MongoDBCollectionCreateUpdateOptions(AzureLocation location, MongoDBCollectionResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal MongoDBCollectionCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, MongoDBCollectionResource resource, CreateUpdateOptions options) : base(id, name, type, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
