...
{
    public partial class CosmosDBSqlDatabasePropertiesConfig : Core.IUtf8JsonSerializable
    {
        ...
        internal static CosmosDBSqlDatabasePropertiesConfig DeserializeCosmosDBSqlDatabasePropertiesConfig(JsonElement element)
        {
            ...
            return new CosmosDBSqlDatabasePropertiesConfig(Core.Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
