...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlDedicatedGatewayRegionalService : CosmosDBRegionalService
    {
        ...
        internal SqlDedicatedGatewayRegionalService(string name, string location, CosmosDBServiceStatus? status, IDictionary<string, BinaryData> additionalBinaryDataProperties, string sqlDedicatedGatewayEndpoint) : base(name, location, status, additionalBinaryDataProperties)
        {
