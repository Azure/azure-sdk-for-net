...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DataCenterResourceProperties
    {
        ...
        internal DataCenterResourceProperties(ManagedCassandraProvisioningState? provisioningState, string dataCenterLocation, ResourceIdentifier delegatedSubnetId, int? nodeCount, IReadOnlyList<SeedNode> seedNodes, string base64EncodedCassandraYamlFragment, Uri managedDiskCustomerKeyUri, Uri backupStorageCustomerKeyUri, string sku, string diskSku, int? diskCapacity, bool? availabilityZone)
        {
