...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class AutoscaleSettingsResourceInfo
    {
        ...
        internal AutoscaleSettingsResourceInfo(int maxThroughput, AutoUpgradePolicyResourceInfo autoUpgradePolicy, int? targetMaxThroughput, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            MaxThroughput = maxThroughput;
