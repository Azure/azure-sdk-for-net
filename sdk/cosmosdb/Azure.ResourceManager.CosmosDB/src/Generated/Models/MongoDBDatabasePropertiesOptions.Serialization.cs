...
{
    public partial class MongoDBDatabasePropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static MongoDBDatabasePropertiesOptions DeserializeMongoDBDatabasePropertiesOptions(JsonElement element)
        {
            ...
            return new MongoDBDatabasePropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
