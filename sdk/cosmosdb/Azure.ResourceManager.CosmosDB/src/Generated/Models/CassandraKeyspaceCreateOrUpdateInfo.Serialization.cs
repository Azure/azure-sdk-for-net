...
{
    public partial class CassandraKeyspaceCreateOrUpdateInfo : IUtf8JsonSerializable
    {
        ...
        internal static CassandraKeyspaceCreateOrUpdateInfo DeserializeCassandraKeyspaceCreateOrUpdateInfo(JsonElement element)
        {
            ...
            return new CassandraKeyspaceCreateOrUpdateInfo(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
