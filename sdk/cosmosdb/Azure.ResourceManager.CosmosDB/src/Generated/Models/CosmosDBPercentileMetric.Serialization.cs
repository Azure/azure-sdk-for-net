...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBPercentileMetric>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBPercentileMetric>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBPercentileMetric>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBPercentileMetric>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBPercentileMetric>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
