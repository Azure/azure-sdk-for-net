...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ContinuousModeBackupPolicy : CosmosDBAccountBackupPolicy
    {
        ...
        internal ContinuousModeBackupPolicy(BackupPolicyType backupPolicyType, BackupPolicyMigrationState migrationState, ContinuousModeProperties continuousModeProperties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(backupPolicyType, migrationState, serializedAdditionalRawData)
        {
