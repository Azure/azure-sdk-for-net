...
{
    public partial class SqlDatabasePropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static SqlDatabasePropertiesOptions DeserializeSqlDatabasePropertiesOptions(JsonElement element)
        {
            ...
            return new SqlDatabasePropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
