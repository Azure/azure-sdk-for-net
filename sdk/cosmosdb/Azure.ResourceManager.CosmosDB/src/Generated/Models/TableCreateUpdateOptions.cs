...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class TableCreateUpdateOptions : TrackedResource
    {
        ...
        public TableCreateUpdateOptions(Location location, TableResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal TableCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, TableResource resource, CreateUpdateOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
