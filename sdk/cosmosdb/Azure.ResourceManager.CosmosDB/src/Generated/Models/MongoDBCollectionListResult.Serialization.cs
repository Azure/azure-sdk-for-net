...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static MongoDBCollectionListResult DeserializeMongoDBCollectionListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
