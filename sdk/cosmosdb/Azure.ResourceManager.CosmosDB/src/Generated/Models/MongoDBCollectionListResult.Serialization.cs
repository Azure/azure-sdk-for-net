...
{
    internal partial class MongoDBCollectionListResult : IUtf8JsonSerializable, IJsonModel<MongoDBCollectionListResult>, IPersistableModel<MongoDBCollectionListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBCollectionListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<MongoDBCollectionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(MongoDBCollectionListResult)} does not support '{format}' format.");
            }
