...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBCollectionListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBCollectionListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBCollectionListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBCollectionListResult>)} interface");
            }
        ...
        string IPersistableModel<MongoDBCollectionListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
