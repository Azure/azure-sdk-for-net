...
{
    public partial class GremlinGraphPropertiesConfig : Core.IUtf8JsonSerializable
    {
        ...
        internal static GremlinGraphPropertiesConfig DeserializeGremlinGraphPropertiesConfig(JsonElement element)
        {
            ...
            return new GremlinGraphPropertiesConfig(Core.Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
