...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinGraphPropertiesConfig : CosmosDBBaseConfig, IJsonModel<GremlinGraphPropertiesConfig>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<GremlinGraphPropertiesConfig>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<GremlinGraphPropertiesConfig>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        GremlinGraphPropertiesConfig IPersistableModel<GremlinGraphPropertiesConfig>.Create(BinaryData data, ModelReaderWriterOptions options) => (GremlinGraphPropertiesConfig)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        GremlinGraphPropertiesConfig IJsonModel<GremlinGraphPropertiesConfig>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (GremlinGraphPropertiesConfig)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static GremlinGraphPropertiesConfig DeserializeGremlinGraphPropertiesConfig(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new GremlinGraphPropertiesConfig(throughput, autoscaleSettings, additionalBinaryDataProperties);
        }
    }
}
