...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class BackupPolicyMigrationState
    {
        ...
        internal BackupPolicyMigrationState(BackupPolicyMigrationStatus? status, BackupPolicyType? targetType, DateTimeOffset? startOn, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Status = status;
