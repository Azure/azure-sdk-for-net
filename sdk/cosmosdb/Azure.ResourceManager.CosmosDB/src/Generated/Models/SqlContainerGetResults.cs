...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlContainerGetResults : ARMResourceProperties
    {
        ...
        internal SqlContainerGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, SqlContainerGetPropertiesResource resource, OptionsResource options) : base(id, name, type, location, tags)
        {
            Resource = resource;
            Options = options;
        }
