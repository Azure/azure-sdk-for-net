...
{
    internal partial class AutoUpgradePolicyResourceInfo : IUtf8JsonSerializable, IJsonModel<AutoUpgradePolicyResourceInfo>, IPersistableModel<AutoUpgradePolicyResourceInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ThroughputPolicy))
            {
                ...
                AppendChildObject(builder, ThroughputPolicy, options, 2);
            }
