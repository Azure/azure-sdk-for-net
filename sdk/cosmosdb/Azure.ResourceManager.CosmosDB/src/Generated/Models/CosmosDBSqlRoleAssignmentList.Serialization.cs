...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static CosmosDBSqlRoleAssignmentList DeserializeCosmosDBSqlRoleAssignmentList(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
