...
{
    public partial class ExtendedThroughputSettingsResourceInfo : Core.IUtf8JsonSerializable
    {
        ...
        internal static ExtendedThroughputSettingsResourceInfo DeserializeExtendedThroughputSettingsResourceInfo(JsonElement element)
        {
            ...
            return new ExtendedThroughputSettingsResourceInfo(Core.Optional.ToNullable(throughput), autoscaleSettings.Value, minimumThroughput.Value, offerReplacePending.Value, rid.Value, Core.Optional.ToNullable(ts), Core.Optional.ToNullable(etag));
        }
    }
}
