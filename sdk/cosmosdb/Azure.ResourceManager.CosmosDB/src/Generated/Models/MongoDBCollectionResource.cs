...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionResource
    {
        ...
        internal MongoDBCollectionResource(string id, IDictionary<string, string> shardKey, IList<MongoIndex> indexes, int? analyticalStorageTtl, ResourceRestoreParameters restoreParameters, CosmosDBAccountCreateMode? createMode, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            ShardKey = shardKey;
            Indexes = indexes;
