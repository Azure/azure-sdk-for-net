...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    internal partial class SqlStoredProcedureCreateUpdateProperties
    {
        ...
        public SqlStoredProcedureCreateUpdateProperties(CosmosDBSqlStoredProcedureResourceInfo resource)
        {
        ...
        internal SqlStoredProcedureCreateUpdateProperties(CosmosDBSqlStoredProcedureResourceInfo resource, CosmosDBCreateUpdateConfig options, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Resource = resource;
            Options = options;
