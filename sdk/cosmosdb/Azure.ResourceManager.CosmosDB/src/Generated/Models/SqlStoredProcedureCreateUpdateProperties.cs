...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    internal partial class SqlStoredProcedureCreateUpdateProperties
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="SqlStoredProcedureCreateUpdateProperties"/>. </summary>
        /// <param name="resource"> The standard JSON format of a storedProcedure. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public SqlStoredProcedureCreateUpdateProperties(SqlStoredProcedureResource resource)
        {
        ...
        internal SqlStoredProcedureCreateUpdateProperties(SqlStoredProcedureResource resource, CreateUpdateOptions options, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Resource = resource;
            Options = options;
        ...
        public SqlStoredProcedureResource Resource { get; }
