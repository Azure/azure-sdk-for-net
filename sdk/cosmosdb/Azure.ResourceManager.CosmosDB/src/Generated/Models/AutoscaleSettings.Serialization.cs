...
{
    internal partial class AutoscaleSettings : IUtf8JsonSerializable, IJsonModel<AutoscaleSettings>, IPersistableModel<AutoscaleSettings>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxThroughput))
            {
                ...
                builder.AppendLine($" '{MaxThroughput.Value.ToString()}'");
            }
