...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<AutoscaleSettings>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<AutoscaleSettings>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<AutoscaleSettings>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<AutoscaleSettings>)} interface");
            }
        ...
        string IPersistableModel<AutoscaleSettings>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
