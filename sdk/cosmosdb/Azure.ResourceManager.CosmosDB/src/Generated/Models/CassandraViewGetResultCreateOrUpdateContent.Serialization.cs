...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CassandraViewGetResultCreateOrUpdateContent>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CassandraViewGetResultCreateOrUpdateContent)} does not support writing '{format}' format.");
            }
            ...
            ((IJsonModel<CassandraViewResource>)Resource).Write(writer, options);
        ...
        CassandraViewGetResultCreateOrUpdateContent IJsonModel<CassandraViewGetResultCreateOrUpdateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CassandraViewGetResultCreateOrUpdateContent)} does not support reading '{format}' format.");
            }
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("properties"u8))
                {
                    ...
                    foreach (var property0 in property.Value.EnumerateObject())
                    {
                        ...
                        {
                            resource = ModelSerializationExtensions.JsonDeserialize<CassandraViewResource>(property0.Value);
                            continue;
                        }
        ...
        BinaryData IPersistableModel<CassandraViewGetResultCreateOrUpdateContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CassandraViewGetResultCreateOrUpdateContent)} does not support writing '{options.Format}' format.");
            }
        }
        ...
        CassandraViewGetResultCreateOrUpdateContent IPersistableModel<CassandraViewGetResultCreateOrUpdateContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CassandraViewGetResultCreateOrUpdateContent)} does not support reading '{options.Format}' format.");
            }
        }
