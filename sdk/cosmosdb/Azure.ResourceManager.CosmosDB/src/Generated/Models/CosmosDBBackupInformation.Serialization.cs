...
{
    public partial class CosmosDBBackupInformation : IUtf8JsonSerializable, IJsonModel<CosmosDBBackupInformation>, IPersistableModel<CosmosDBBackupInformation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ContinuousBackupInformation))
            {
                ...
                AppendChildObject(builder, ContinuousBackupInformation, options, 2);
            }
