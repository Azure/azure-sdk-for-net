...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static CosmosDBBackupInformation DeserializeCosmosDBBackupInformation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
