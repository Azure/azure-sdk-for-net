...
{
    public partial class ClusterResourceData : IUtf8JsonSerializable
    {
        ...
        internal static ClusterResourceData DeserializeClusterResourceData(JsonElement element)
        {
            ...
            return new ClusterResourceData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, properties.Value, identity);
        }
    }
}
