...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableSqlResourceData : ResourceData
    {
        ...
        internal RestorableSqlResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string databaseName, IReadOnlyList<string> collectionNames, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
