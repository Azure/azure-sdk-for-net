...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class SqlContainerPropertiesResource : IUtf8JsonSerializable
    {
        ...
        internal static SqlContainerPropertiesResource DeserializeSqlContainerPropertiesResource(JsonElement element)
        {
            ...
            return new SqlContainerPropertiesResource(id, indexingPolicy.Value, partitionKey.Value, Optional.ToNullable(defaultTtl), uniqueKeyPolicy.Value, conflictResolutionPolicy.Value, Optional.ToNullable(analyticalStorageTtl), rid.Value, Optional.ToNullable(ts), Optional.ToNullable(etag));
        }
    }
}
