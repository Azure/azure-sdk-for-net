...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableTableResourcesGetResult
    {
        ...
        /// <summary> Initializes a new instance of <see cref="RestorableTableResourcesGetResult"/>. </summary>
        ...
        internal RestorableTableResourcesGetResult(string id, string name, string @type, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            Name = name;
            Type = @type;
