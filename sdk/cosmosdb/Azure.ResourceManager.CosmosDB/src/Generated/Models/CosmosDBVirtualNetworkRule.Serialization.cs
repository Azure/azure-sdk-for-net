...
{
    public partial class CosmosDBVirtualNetworkRule : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CosmosDBVirtualNetworkRule DeserializeCosmosDBVirtualNetworkRule(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
