...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBAccountConnectionString>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBAccountConnectionString>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBAccountConnectionString>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CosmosDBAccountConnectionString>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
