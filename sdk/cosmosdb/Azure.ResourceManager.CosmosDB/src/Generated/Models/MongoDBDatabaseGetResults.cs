...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBDatabaseGetResults : ARMResourceProperties
    {
        ...
        internal MongoDBDatabaseGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, MongoDBDatabaseGetPropertiesResource resource, OptionsResource options) : base(id, name, type, location, tags)
        {
            Resource = resource;
            Options = options;
        }
