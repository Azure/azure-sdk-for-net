...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MaterializedViewsBuilderServiceProperties : CosmosDBServiceProperties, IJsonModel<MaterializedViewsBuilderServiceProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<MaterializedViewsBuilderServiceProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<MaterializedViewsBuilderServiceProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        MaterializedViewsBuilderServiceProperties IPersistableModel<MaterializedViewsBuilderServiceProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (MaterializedViewsBuilderServiceProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Locations))
            {
                ...
                foreach (MaterializedViewsBuilderRegionalService item in Locations)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        MaterializedViewsBuilderServiceProperties IJsonModel<MaterializedViewsBuilderServiceProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (MaterializedViewsBuilderServiceProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static MaterializedViewsBuilderServiceProperties DeserializeMaterializedViewsBuilderServiceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
