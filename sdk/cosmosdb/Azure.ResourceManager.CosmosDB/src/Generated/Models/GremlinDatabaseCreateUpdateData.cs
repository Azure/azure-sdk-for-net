...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinDatabaseCreateUpdateData : TrackedResourceData
    {
        ...
        internal GremlinDatabaseCreateUpdateData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, GremlinDatabaseResource resource, CreateUpdateOptions options) : base(id, name, type, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
