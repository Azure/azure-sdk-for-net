...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinDatabaseCreateUpdateData : ARMResourceProperties
    {
        /// <summary> Initializes a new instance of <see cref="GremlinDatabaseCreateUpdateData"/>. </summary>
        /// <param name="resource"> The standard JSON format of a Gremlin database. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public GremlinDatabaseCreateUpdateData(GremlinDatabaseResourceInfo resource)
        {
        ...
        internal GremlinDatabaseCreateUpdateData(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, GremlinDatabaseCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
