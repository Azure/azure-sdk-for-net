...
{
    public partial class MongoDBDatabaseData : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBDatabaseData DeserializeMongoDBDatabaseData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
