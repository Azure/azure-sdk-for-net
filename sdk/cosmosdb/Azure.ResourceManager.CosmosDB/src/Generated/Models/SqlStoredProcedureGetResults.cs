...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SqlStoredProcedureGetResults. </summary>
        ...
        internal SqlStoredProcedureGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, SqlStoredProcedureGetPropertiesResource resource) : base(id, name, type, location, tags)
        {
            Resource = resource;
        }
