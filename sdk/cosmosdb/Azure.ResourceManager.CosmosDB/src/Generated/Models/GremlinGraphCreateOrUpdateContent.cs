...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinGraphCreateOrUpdateContent : ARMResourceProperties
    {
        ...
        internal GremlinGraphCreateOrUpdateContent(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, GremlinGraphCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
