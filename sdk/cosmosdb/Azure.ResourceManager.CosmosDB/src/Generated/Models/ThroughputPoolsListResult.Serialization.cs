...
namespace Azure.ResourceManager.CosmosDB.Models
{
    internal partial class ThroughputPoolsListResult : IUtf8JsonSerializable, IJsonModel<ThroughputPoolsListResult>
    {
        ...
        void IJsonModel<ThroughputPoolsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(ThroughputPoolsListResult)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<ThroughputPoolsListResult>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(ThroughputPoolsListResult)} does not support '{options.Format}' format.");
            }
        }
