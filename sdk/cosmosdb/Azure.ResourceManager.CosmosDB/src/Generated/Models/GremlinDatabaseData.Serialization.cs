...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GremlinDatabaseData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GremlinDatabaseData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GremlinDatabaseData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GremlinDatabaseData>)} interface");
            }
        ...
        string IPersistableModel<GremlinDatabaseData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
