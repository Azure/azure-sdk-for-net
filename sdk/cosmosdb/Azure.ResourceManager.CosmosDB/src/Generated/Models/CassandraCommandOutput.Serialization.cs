...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CassandraCommandOutput>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CassandraCommandOutput>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CassandraCommandOutput>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CassandraCommandOutput>)} interface");
            }
        ...
        string IPersistableModel<CassandraCommandOutput>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
