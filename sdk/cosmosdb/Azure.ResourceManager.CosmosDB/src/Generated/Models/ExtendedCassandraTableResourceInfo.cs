...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedCassandraTableResourceInfo : CassandraTableResourceInfo
    {
        ...
        internal ExtendedCassandraTableResourceInfo(string tableName, int? defaultTtl, CassandraSchema schema, int? analyticalStorageTtl, string rid, float? timestamp, ETag? etag, Dictionary<string, BinaryData> rawData) : base(tableName, defaultTtl, schema, analyticalStorageTtl, rawData)
        {
            Rid = rid;
            Timestamp = timestamp;
            ETag = etag;
