...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosMongoDataTransferDataSourceSink : DataTransferDataSourceSink
    {
        ...
        internal CosmosMongoDataTransferDataSourceSink(DataTransferComponent component, string databaseName, string collectionName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(component, serializedAdditionalRawData)
        {
            DatabaseName = databaseName;
            CollectionName = collectionName;
            Component = component;
