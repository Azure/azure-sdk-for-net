...
namespace Azure.ResourceManager.CosmosDB
{
    public partial class DataTransferJobGetResultData : IUtf8JsonSerializable, IJsonModel<DataTransferJobGetResultData>
    {
        ...
        void IJsonModel<DataTransferJobGetResultData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(DataTransferJobGetResultData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<DataTransferJobGetResultData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(DataTransferJobGetResultData)} does not support '{options.Format}' format.");
            }
        }
