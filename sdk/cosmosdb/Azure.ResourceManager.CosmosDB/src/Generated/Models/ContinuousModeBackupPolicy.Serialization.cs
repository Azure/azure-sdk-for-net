...
{
    public partial class ContinuousModeBackupPolicy : IUtf8JsonSerializable, IJsonModel<ContinuousModeBackupPolicy>, IPersistableModel<ContinuousModeBackupPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(ContinuousModeProperties))
            {
                ...
                AppendChildObject(builder, ContinuousModeProperties, options, 2);
            }
            ...
            if (Optional.IsDefined(MigrationState))
            {
                ...
                AppendChildObject(builder, MigrationState, options, 2);
            }
