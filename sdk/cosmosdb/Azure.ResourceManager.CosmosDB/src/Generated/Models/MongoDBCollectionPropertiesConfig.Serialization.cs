...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBCollectionPropertiesConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBCollectionPropertiesConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBCollectionPropertiesConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBCollectionPropertiesConfig>)} interface");
            }
        ...
        string IPersistableModel<MongoDBCollectionPropertiesConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
