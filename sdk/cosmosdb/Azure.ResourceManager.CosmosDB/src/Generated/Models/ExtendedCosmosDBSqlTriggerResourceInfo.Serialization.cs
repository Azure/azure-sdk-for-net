...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtendedCosmosDBSqlTriggerResourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ExtendedCosmosDBSqlTriggerResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtendedCosmosDBSqlTriggerResourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtendedCosmosDBSqlTriggerResourceInfo>)} interface");
            }
        ...
        string IPersistableModel<ExtendedCosmosDBSqlTriggerResourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
