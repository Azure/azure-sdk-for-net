...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedRestorableSqlDatabaseResourceInfo
    {
        ...
        internal ExtendedRestorableSqlDatabaseResourceInfo(string rid, CosmosDBOperationType? operationType, string eventTimestamp, string databaseName, string databaseId, RestorableSqlDatabasePropertiesResourceDatabase database, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Rid = rid;
