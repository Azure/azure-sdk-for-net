...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlDedicatedGatewayServiceProperties : CosmosDBServiceProperties, IJsonModel<SqlDedicatedGatewayServiceProperties>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<SqlDedicatedGatewayServiceProperties>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<SqlDedicatedGatewayServiceProperties>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlDedicatedGatewayServiceProperties IPersistableModel<SqlDedicatedGatewayServiceProperties>.Create(BinaryData data, ModelReaderWriterOptions options) => (SqlDedicatedGatewayServiceProperties)PersistableModelCreateCore(data, options);
        ...
        protected override void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (options.Format != "W" && Optional.IsCollectionDefined(Locations))
            {
                ...
                foreach (SqlDedicatedGatewayRegionalService item in Locations)
                {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        SqlDedicatedGatewayServiceProperties IJsonModel<SqlDedicatedGatewayServiceProperties>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (SqlDedicatedGatewayServiceProperties)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static SqlDedicatedGatewayServiceProperties DeserializeSqlDedicatedGatewayServiceProperties(JsonElement element, ModelReaderWriterOptions options)
        {
