...
{
    public partial class SqlDedicatedGatewayServiceProperties : IUtf8JsonSerializable, IJsonModel<SqlDedicatedGatewayServiceProperties>, IPersistableModel<SqlDedicatedGatewayServiceProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(InstanceSize))
            {
                ...
                builder.AppendLine($" '{InstanceSize.ToString()}'");
            }
