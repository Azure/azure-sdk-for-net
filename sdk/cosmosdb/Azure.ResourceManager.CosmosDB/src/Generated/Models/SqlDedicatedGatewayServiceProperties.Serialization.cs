...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<SqlDedicatedGatewayServiceProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<SqlDedicatedGatewayServiceProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<SqlDedicatedGatewayServiceProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<SqlDedicatedGatewayServiceProperties>)} interface");
            }
        ...
        string IPersistableModel<SqlDedicatedGatewayServiceProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
