...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBServiceListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBServiceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBServiceListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CosmosDBServiceListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
