...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableSqlContainerPropertiesResource
    {
        ...
        internal RestorableSqlContainerPropertiesResource(string rid, CosmosDBOperationType? operationType, string canUndelete, string canUndeleteReason, string eventTimestamp, string ownerId, string ownerResourceId, RestorableSqlContainerPropertiesResourceContainer container, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Rid = rid;
