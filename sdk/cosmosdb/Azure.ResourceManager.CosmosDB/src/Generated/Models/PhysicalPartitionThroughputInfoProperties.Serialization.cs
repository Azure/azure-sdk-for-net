...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PhysicalPartitionThroughputInfoProperties>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PhysicalPartitionThroughputInfoProperties>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PhysicalPartitionThroughputInfoProperties>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<PhysicalPartitionThroughputInfoProperties>)} interface");
            }
        ...
        string IPersistableModel<PhysicalPartitionThroughputInfoProperties>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
