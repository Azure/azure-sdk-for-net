...
{
    public partial class CassandraTableCreateOrUpdateContent : Core.IUtf8JsonSerializable
    {
        ...
        internal static CassandraTableCreateOrUpdateContent DeserializeCassandraTableCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new CassandraTableCreateOrUpdateContent(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
