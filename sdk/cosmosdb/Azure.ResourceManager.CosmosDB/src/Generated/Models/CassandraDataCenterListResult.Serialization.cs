...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static CassandraDataCenterListResult DeserializeCassandraDataCenterListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
