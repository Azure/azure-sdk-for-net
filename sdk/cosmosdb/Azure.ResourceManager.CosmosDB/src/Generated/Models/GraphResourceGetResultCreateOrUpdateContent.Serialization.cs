...
{
    public partial class GraphResourceGetResultCreateOrUpdateContent : IUtf8JsonSerializable, IJsonModel<GraphResourceGetResultCreateOrUpdateContent>, IPersistableModel<GraphResourceGetResultCreateOrUpdateContent>
    {
        ...
        {
            var format = options.Format == "W" ? ((IPersistableModel<GraphResourceGetResultCreateOrUpdateContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GraphResourceGetResultCreateOrUpdateContent)} does not support '{format}' format.");
            }
        ...
        GraphResourceGetResultCreateOrUpdateContent IJsonModel<GraphResourceGetResultCreateOrUpdateContent>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GraphResourceGetResultCreateOrUpdateContent>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        BinaryData IPersistableModel<GraphResourceGetResultCreateOrUpdateContent>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(GraphResourceGetResultCreateOrUpdateContent)} does not support '{options.Format}' format.");
            }
        }

        GraphResourceGetResultCreateOrUpdateContent IPersistableModel<GraphResourceGetResultCreateOrUpdateContent>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            var format = options.Format == "W" ? ((IPersistableModel<GraphResourceGetResultCreateOrUpdateContent>)this).GetFormatFromOptions(options) : options.Format;
        ...
        string IPersistableModel<GraphResourceGetResultCreateOrUpdateContent>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";
    }
}
