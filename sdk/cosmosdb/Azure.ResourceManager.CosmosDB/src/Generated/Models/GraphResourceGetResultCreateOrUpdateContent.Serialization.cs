...
{
    public partial class GraphResourceGetResultCreateOrUpdateContent : Core.IUtf8JsonSerializable
    {
        void Core.IUtf8JsonSerializable.Write(Utf8JsonWriter writer)
        {
            ...
            JsonSerializer.Serialize(writer, Resource); if (Core.Optional.IsDefined(Options))
            {
        ...
        internal static GraphResourceGetResultCreateOrUpdateContent DeserializeGraphResourceGetResultCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new GraphResourceGetResultCreateOrUpdateContent(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
