...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static BaseUsage DeserializeBaseUsage(JsonElement element)
        {
            ...
            return new BaseUsage(Optional.ToNullable(unit), name.Value, quotaPeriod.Value, Optional.ToNullable(limit), Optional.ToNullable(currentValue));
        }
    }
}
