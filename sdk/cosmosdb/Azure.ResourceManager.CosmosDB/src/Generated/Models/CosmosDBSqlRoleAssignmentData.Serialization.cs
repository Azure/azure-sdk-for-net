...
{
    public partial class CosmosDBSqlRoleAssignmentData : IUtf8JsonSerializable, IJsonModel<CosmosDBSqlRoleAssignmentData>, IPersistableModel<CosmosDBSqlRoleAssignmentData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBSqlRoleAssignmentData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CosmosDBSqlRoleAssignmentData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBSqlRoleAssignmentData)} does not support '{format}' format.");
            }
