...
{
    public partial class PeriodicModeBackupPolicy : IUtf8JsonSerializable, IJsonModel<PeriodicModeBackupPolicy>, IPersistableModel<PeriodicModeBackupPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(PeriodicModeProperties))
            {
                ...
                AppendChildObject(builder, PeriodicModeProperties, options, 2);
            }
