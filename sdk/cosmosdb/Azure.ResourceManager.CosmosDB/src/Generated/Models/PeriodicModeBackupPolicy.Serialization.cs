...
{
    public partial class PeriodicModeBackupPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static PeriodicModeBackupPolicy DeserializePeriodicModeBackupPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
