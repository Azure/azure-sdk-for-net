...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBRoleDefinitionCreateOrUpdateContent
    {
        ...
        internal MongoDBRoleDefinitionCreateOrUpdateContent(string roleName, MongoDBRoleDefinitionType? definitionType, string databaseName, IList<MongoDBPrivilege> privileges, IList<MongoDBRole> roles, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            RoleName = roleName;
