...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RetrieveThroughputParameters>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RetrieveThroughputParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RetrieveThroughputParameters>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RetrieveThroughputParameters>)} interface");
            }
        ...
        RetrieveThroughputParameters IJsonModel<RetrieveThroughputParameters>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
        ...
        RetrieveThroughputParameters IPersistableModel<RetrieveThroughputParameters>.Create(BinaryData data, ModelReaderWriterOptions options)
        {
            bool isValid = options.Format == "J" || options.Format == "W";
            if (!isValid)
            {
        ...
        string IPersistableModel<RetrieveThroughputParameters>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
