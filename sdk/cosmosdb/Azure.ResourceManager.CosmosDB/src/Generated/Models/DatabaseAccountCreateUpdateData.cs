...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DatabaseAccountCreateUpdateData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of DatabaseAccountCreateUpdateData. </summary>
        ...
        public DatabaseAccountCreateUpdateData(AzureLocation location, IEnumerable<DatabaseAccountLocation> locations) : base(location)
        {
            if (locations == null)
            {
