...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBDatabaseCreateUpdateOptions : TrackedResource
    {
        ...
        public MongoDBDatabaseCreateUpdateOptions(Location location, MongoDBDatabaseResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal MongoDBDatabaseCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Location location, MongoDBDatabaseResource resource, CreateUpdateOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
