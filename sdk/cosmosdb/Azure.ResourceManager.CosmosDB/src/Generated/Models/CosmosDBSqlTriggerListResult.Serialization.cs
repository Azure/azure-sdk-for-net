...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static CosmosDBSqlTriggerListResult DeserializeCosmosDBSqlTriggerListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
