...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static CosmosDBSqlContainerListResult DeserializeCosmosDBSqlContainerListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
