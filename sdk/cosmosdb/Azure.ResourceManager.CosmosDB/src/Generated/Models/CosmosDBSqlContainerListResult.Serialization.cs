...
{
    internal partial class CosmosDBSqlContainerListResult : IUtf8JsonSerializable, IJsonModel<CosmosDBSqlContainerListResult>, IPersistableModel<CosmosDBSqlContainerListResult>
    {
        ...
        void IJsonModel<CosmosDBSqlContainerListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBSqlContainerListResult)} does not support '{format}' format.");
            }
