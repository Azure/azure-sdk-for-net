...
{
    public partial class CreateUpdateConfig : IUtf8JsonSerializable
    {
        ...
        internal static CreateUpdateConfig DeserializeCreateUpdateConfig(JsonElement element)
        {
            ...
            return new CreateUpdateConfig(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
