...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraAsyncCommandContent
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CassandraAsyncCommandContent"/>. </summary>
        ...
        public CassandraAsyncCommandContent(string command, string host)
        {
        ...
        internal CassandraAsyncCommandContent(string command, BinaryData arguments, string host, bool? cassandraStopStart, bool? isReadWrite, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Command = command;
            Arguments = arguments;
            Host = host;
