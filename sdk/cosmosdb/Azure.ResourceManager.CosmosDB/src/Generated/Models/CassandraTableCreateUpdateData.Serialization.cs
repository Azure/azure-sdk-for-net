...
{
    public partial class CassandraTableCreateUpdateData : IUtf8JsonSerializable
    {
        ...
        internal static CassandraTableCreateUpdateData DeserializeCassandraTableCreateUpdateData(JsonElement element)
        {
            ...
            return new CassandraTableCreateUpdateData(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
