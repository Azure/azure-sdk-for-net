...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class KeyWrapMetadata
    {
        ...
        /// <summary> Initializes a new instance of <see cref="KeyWrapMetadata"/>. </summary>
        ...
        internal KeyWrapMetadata(string name, string @type, string value, string algorithm, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Name = name;
            Type = @type;
            Value = value;
