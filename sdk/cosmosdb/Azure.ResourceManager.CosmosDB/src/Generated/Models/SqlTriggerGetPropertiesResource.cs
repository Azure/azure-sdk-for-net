...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlTriggerGetPropertiesResource : SqlTriggerResource
    {
        ...
        internal SqlTriggerGetPropertiesResource(string id, string body, TriggerType? triggerType, TriggerOperation? triggerOperation, string rid, float? ts, string etag) : base(id, body, triggerType, triggerOperation)
        {
            Rid = rid;
            Ts = ts;
            Etag = etag;
