...
{
    public partial class CosmosDBSqlUserDefinedFunctionResourceInfo : IUtf8JsonSerializable, IJsonModel<CosmosDBSqlUserDefinedFunctionResourceInfo>, IPersistableModel<CosmosDBSqlUserDefinedFunctionResourceInfo>
    {
        ...
        void IJsonModel<CosmosDBSqlUserDefinedFunctionResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBSqlUserDefinedFunctionResourceInfo)} does not support '{format}' format.");
            }
