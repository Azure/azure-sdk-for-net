...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBSqlDatabaseCreateOrUpdateContent : TrackedResourceData
    {
        ...
        public CosmosDBSqlDatabaseCreateOrUpdateContent(AzureLocation location, WritableSubResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal CosmosDBSqlDatabaseCreateOrUpdateContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, WritableSubResource resource, CreateUpdateConfig options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
