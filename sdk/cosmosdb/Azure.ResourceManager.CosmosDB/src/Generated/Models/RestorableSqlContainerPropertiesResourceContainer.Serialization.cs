...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableSqlContainerPropertiesResourceContainer>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableSqlContainerPropertiesResourceContainer>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableSqlContainerPropertiesResourceContainer>)} interface");
            }
        ...
        string IPersistableModel<RestorableSqlContainerPropertiesResourceContainer>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
