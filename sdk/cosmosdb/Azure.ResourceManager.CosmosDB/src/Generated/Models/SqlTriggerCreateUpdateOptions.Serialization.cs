...
{
    public partial class SqlTriggerCreateUpdateOptions : IUtf8JsonSerializable
    {
        ...
        internal static SqlTriggerCreateUpdateOptions DeserializeSqlTriggerCreateUpdateOptions(JsonElement element)
        {
            ...
            return new SqlTriggerCreateUpdateOptions(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
