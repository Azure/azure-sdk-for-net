...
{
    public partial class PeriodicModeProperties : IUtf8JsonSerializable, IJsonModel<PeriodicModeProperties>, IPersistableModel<PeriodicModeProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BackupIntervalInMinutes))
            {
                ...
                builder.AppendLine($" '{BackupIntervalInMinutes.Value.ToString()}'");
            }

            if (Optional.IsDefined(BackupRetentionIntervalInHours))
            {
                builder.Append("  backupRetentionIntervalInHours:");
                builder.AppendLine($" '{BackupRetentionIntervalInHours.Value.ToString()}'");
            }
