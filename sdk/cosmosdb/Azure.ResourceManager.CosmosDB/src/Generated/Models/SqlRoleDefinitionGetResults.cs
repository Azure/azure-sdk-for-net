...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of SqlRoleDefinitionGetResults. </summary>
        ...
        internal SqlRoleDefinitionGetResults(string id, string name, string type, string roleName, RoleDefinitionType? typePropertiesType, IList<string> assignableScopes, IList<Permission> permissions) : base(id, name, type)
        {
            RoleName = roleName;
