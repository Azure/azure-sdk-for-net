...
{
    public partial class CassandraTableCreateOrUpdateInfo : IUtf8JsonSerializable
    {
        ...
        internal static CassandraTableCreateOrUpdateInfo DeserializeCassandraTableCreateOrUpdateInfo(JsonElement element)
        {
            ...
            return new CassandraTableCreateOrUpdateInfo(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
