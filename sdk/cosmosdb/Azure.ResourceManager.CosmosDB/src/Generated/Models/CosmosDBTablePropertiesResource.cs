...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBTablePropertiesResource : CosmosDBTableResourceInfo
    {
        ...
        internal CosmosDBTablePropertiesResource(string tableName, ResourceRestoreParameters restoreParameters, CosmosDBAccountCreateMode? createMode, string rid, float? timestamp, ETag? etag, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(tableName, restoreParameters, createMode, serializedAdditionalRawData)
        {
            Rid = rid;
            Timestamp = timestamp;
            ETag = etag;
