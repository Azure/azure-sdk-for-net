...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ClusterResourceProperties
    {
        ...
        internal ClusterResourceProperties(ManagedCassandraProvisioningState? provisioningState, string restoreFromBackupId, string delegatedManagementSubnetId, string cassandraVersion, string clusterNameOverride, CassandraAuthenticationMethod? authenticationMethod, string initialCassandraAdminPassword, SeedNode prometheusEndpoint, bool? repairEnabled, CassandraAutoReplicateForm? autoReplicate, IList<CassandraCertificate> clientCertificates, IList<CassandraCertificate> externalGossipCertificates, IReadOnlyList<CassandraCertificate> gossipCertificates, IList<SeedNode> externalSeedNodes, IReadOnlyList<SeedNode> seedNodes, IList<string> externalDataCenters, int? hoursBetweenBackups, bool? deallocated, bool? cassandraAuditLoggingEnabled, ClusterType? clusterType, CassandraError provisionError, IList<string> extensions, IList<CassandraClusterBackupSchedule> backupSchedules, ScheduledEventStrategy? scheduledEventStrategy, AzureConnectionType? azureConnectionMethod, ResourceIdentifier privateLinkResourceId, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
