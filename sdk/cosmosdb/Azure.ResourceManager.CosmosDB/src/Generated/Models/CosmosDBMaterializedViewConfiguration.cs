...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBMaterializedViewConfiguration
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="CosmosDBMaterializedViewConfiguration"/>. </summary>
        ...
        public CosmosDBMaterializedViewConfiguration(string sourceCollectionId, string definition)
        {
        ...
        internal CosmosDBMaterializedViewConfiguration(string sourceCollectionRid, string sourceCollectionId, string definition, int? throughputBucketForBuild, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
