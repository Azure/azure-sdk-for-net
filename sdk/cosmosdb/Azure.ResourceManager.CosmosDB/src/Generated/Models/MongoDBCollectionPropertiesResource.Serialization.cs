...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class MongoDBCollectionPropertiesResource : IUtf8JsonSerializable
    {
        ...
        internal static MongoDBCollectionPropertiesResource DeserializeMongoDBCollectionPropertiesResource(JsonElement element)
        {
            ...
            return new MongoDBCollectionPropertiesResource(id, Optional.ToDictionary(shardKey), Optional.ToList(indexes), Optional.ToNullable(analyticalStorageTtl), rid.Value, Optional.ToNullable(ts), etag.Value);
        }
    }
}
