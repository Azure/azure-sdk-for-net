...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinGraphCreateOrUpdateInfo : TrackedResourceData
    {
        /// <summary> Initializes a new instance of GremlinGraphCreateOrUpdateInfo. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a Gremlin graph. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public GremlinGraphCreateOrUpdateInfo(AzureLocation location, GremlinGraphResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal GremlinGraphCreateOrUpdateInfo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, GremlinGraphResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
