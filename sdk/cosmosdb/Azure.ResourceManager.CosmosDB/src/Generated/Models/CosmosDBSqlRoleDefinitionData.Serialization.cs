...
{
    public partial class CosmosDBSqlRoleDefinitionData : IUtf8JsonSerializable, IJsonModel<CosmosDBSqlRoleDefinitionData>, IPersistableModel<CosmosDBSqlRoleDefinitionData>
    {
        ...
        void IJsonModel<CosmosDBSqlRoleDefinitionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBSqlRoleDefinitionData)} does not support '{format}' format.");
            }
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            {
                builder.Append("  type:");
                builder.AppendLine($" '{RoleDefinitionType.ToString()}'");
            }
