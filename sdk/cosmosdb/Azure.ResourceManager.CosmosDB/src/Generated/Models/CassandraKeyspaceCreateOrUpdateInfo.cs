...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraKeyspaceCreateOrUpdateInfo : TrackedResourceData
    {
        /// <summary> Initializes a new instance of CassandraKeyspaceCreateOrUpdateInfo. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a Cassandra keyspace. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public CassandraKeyspaceCreateOrUpdateInfo(AzureLocation location, CassandraKeyspaceResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal CassandraKeyspaceCreateOrUpdateInfo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, CassandraKeyspaceResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
