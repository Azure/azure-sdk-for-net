...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBSqlRolePermission
    {
        ...
        internal CosmosDBSqlRolePermission(string id, IList<string> dataActions, IList<string> notDataActions, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
