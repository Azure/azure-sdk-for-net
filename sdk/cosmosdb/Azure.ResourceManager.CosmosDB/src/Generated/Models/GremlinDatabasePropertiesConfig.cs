...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="GremlinDatabasePropertiesConfig"/>. </summary>
        internal GremlinDatabasePropertiesConfig()
        {
        }
        ...
        internal GremlinDatabasePropertiesConfig(int? throughput, AutoscaleSettings autoscaleSettings, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(throughput, autoscaleSettings, additionalBinaryDataProperties)
        {
        }
    }
}
