...
{
    internal partial class CosmosDBAccountCapacity : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CosmosDBAccountCapacity DeserializeCosmosDBAccountCapacity(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
