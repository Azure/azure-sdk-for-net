...
{
    internal partial class CosmosDBAccountCapacity : IUtf8JsonSerializable, IJsonModel<CosmosDBAccountCapacity>, IPersistableModel<CosmosDBAccountCapacity>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(TotalThroughputLimit))
            {
                ...
                builder.AppendLine($" '{TotalThroughputLimit.Value.ToString()}'");
            }
