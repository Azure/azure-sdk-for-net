...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBAccountCapacity>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBAccountCapacity>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBAccountCapacity>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBAccountCapacity>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBAccountCapacity>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
