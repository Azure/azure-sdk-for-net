...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableSqlDatabasePropertiesResourceDatabase : CosmosDBSqlDatabaseResourceInfo
    {
        ...
        internal RestorableSqlDatabasePropertiesResourceDatabase(string databaseName, ResourceRestoreParameters restoreParameters, CosmosDBAccountCreateMode? createMode, string colls, string users, string self, string rid, float? timestamp, ETag? etag, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(databaseName, restoreParameters, createMode, serializedAdditionalRawData)
        {
            Colls = colls;
            Users = users;
            Self = self;
