...
{
    public partial class TablePropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static TablePropertiesOptions DeserializeTablePropertiesOptions(JsonElement element)
        {
            ...
            return new TablePropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
