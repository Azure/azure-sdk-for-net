...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CheckCosmosDBNameAvailabilityResponse>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CheckCosmosDBNameAvailabilityResponse>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CheckCosmosDBNameAvailabilityResponse>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CheckCosmosDBNameAvailabilityResponse>)} interface");
            }
        ...
        string IPersistableModel<CheckCosmosDBNameAvailabilityResponse>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
