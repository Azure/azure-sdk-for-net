...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBFailoverPolicy : IJsonModel<CosmosDBFailoverPolicy>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual CosmosDBFailoverPolicy PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<CosmosDBFailoverPolicy>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CosmosDBFailoverPolicy>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CosmosDBFailoverPolicy IPersistableModel<CosmosDBFailoverPolicy>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CosmosDBFailoverPolicy IJsonModel<CosmosDBFailoverPolicy>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual CosmosDBFailoverPolicy JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<CosmosDBFailoverPolicy>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CosmosDBFailoverPolicy DeserializeCosmosDBFailoverPolicy(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new CosmosDBFailoverPolicy(id, locationName, failoverPriority, additionalBinaryDataProperties);
        }
    }
}
