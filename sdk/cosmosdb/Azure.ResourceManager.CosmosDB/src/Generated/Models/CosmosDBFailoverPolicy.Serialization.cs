...
{
    public partial class CosmosDBFailoverPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CosmosDBFailoverPolicy DeserializeCosmosDBFailoverPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
