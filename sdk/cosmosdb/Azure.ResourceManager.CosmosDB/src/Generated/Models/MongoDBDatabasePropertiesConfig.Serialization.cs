...
{
    public partial class MongoDBDatabasePropertiesConfig : Core.IUtf8JsonSerializable
    {
        ...
        internal static MongoDBDatabasePropertiesConfig DeserializeMongoDBDatabasePropertiesConfig(JsonElement element)
        {
            ...
            return new MongoDBDatabasePropertiesConfig(Core.Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
