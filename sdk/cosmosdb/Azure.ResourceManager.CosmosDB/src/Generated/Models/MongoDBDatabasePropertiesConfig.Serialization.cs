...
{
    public partial class MongoDBDatabasePropertiesConfig : IUtf8JsonSerializable
    {
        ...
        internal static MongoDBDatabasePropertiesConfig DeserializeMongoDBDatabasePropertiesConfig(JsonElement element)
        {
            ...
            return new MongoDBDatabasePropertiesConfig(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
