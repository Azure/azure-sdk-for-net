...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlStoredProcedureCreateOrUpdateContent : TrackedResourceData
    {
        ...
        public SqlStoredProcedureCreateOrUpdateContent(AzureLocation location, SqlStoredProcedureResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal SqlStoredProcedureCreateOrUpdateContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SqlStoredProcedureResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
