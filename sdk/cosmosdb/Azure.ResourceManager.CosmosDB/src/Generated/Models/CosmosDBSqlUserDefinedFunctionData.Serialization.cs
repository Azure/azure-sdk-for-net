...
{
    public partial class CosmosDBSqlUserDefinedFunctionData : IUtf8JsonSerializable, IJsonModel<CosmosDBSqlUserDefinedFunctionData>, IPersistableModel<CosmosDBSqlUserDefinedFunctionData>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBSqlUserDefinedFunctionData>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CosmosDBSqlUserDefinedFunctionData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBSqlUserDefinedFunctionData)} does not support '{format}' format.");
            }
