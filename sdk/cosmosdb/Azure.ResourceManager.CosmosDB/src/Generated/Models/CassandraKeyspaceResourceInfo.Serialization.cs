...
{
    public partial class CassandraKeyspaceResourceInfo : IUtf8JsonSerializable, IJsonModel<CassandraKeyspaceResourceInfo>, IPersistableModel<CassandraKeyspaceResourceInfo>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CassandraKeyspaceResourceInfo>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CassandraKeyspaceResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CassandraKeyspaceResourceInfo)} does not support '{format}' format.");
            }
