...
{
    public partial class ThroughputSettings : IUtf8JsonSerializable
    {
        ...
        internal static ThroughputSettings DeserializeThroughputSettings(JsonElement element)
        {
            ...
            return new ThroughputSettings(id, name, type, tags, location, resource.Value);
        }
    }
}
