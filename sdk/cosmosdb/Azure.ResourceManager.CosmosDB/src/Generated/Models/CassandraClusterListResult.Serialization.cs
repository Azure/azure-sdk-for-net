...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CassandraClusterListResult>)this).Write(writer, ModelSerializationExtensions.WireOptions);
        ...
        protected virtual void JsonModelWriteCore(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsCollectionDefined(Value))
            {
                ...
                {
                    ((IJsonModel<CassandraClusterData>)item).Write(writer, options);
                }
        ...
        internal static CassandraClusterListResult DeserializeCassandraClusterListResult(JsonElement element, ModelReaderWriterOptions options = null)
        {
            ...
            IReadOnlyList<CassandraClusterData> value = default;
            ...
            return new CassandraClusterListResult(value ?? new ChangeTrackingList<CassandraClusterData>(), serializedAdditionalRawData);
        }
