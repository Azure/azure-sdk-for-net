...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static CassandraClusterListResult DeserializeCassandraClusterListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
