...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CassandraClusterListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CassandraClusterListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CassandraClusterListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CassandraClusterListResult>)} interface");
            }
        ...
        string IPersistableModel<CassandraClusterListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
