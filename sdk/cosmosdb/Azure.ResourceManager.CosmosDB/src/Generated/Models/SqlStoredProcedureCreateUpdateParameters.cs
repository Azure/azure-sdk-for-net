...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlStoredProcedureCreateUpdateParameters : TrackedResource
    {
        ...
        public SqlStoredProcedureCreateUpdateParameters(Resources.Models.Location location, SqlStoredProcedureResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal SqlStoredProcedureCreateUpdateParameters(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Resources.Models.Location location, SqlStoredProcedureResource resource, CreateUpdateOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
