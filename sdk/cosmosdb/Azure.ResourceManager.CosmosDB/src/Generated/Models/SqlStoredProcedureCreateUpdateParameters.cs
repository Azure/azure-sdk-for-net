...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="SqlStoredProcedureCreateUpdateParameters"/>. </summary>
        ...
        internal SqlStoredProcedureCreateUpdateParameters(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, SqlStoredProcedureCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
            Properties = properties;
        }

        /// <summary> Properties to create and update Azure Cosmos DB storedProcedure. </summary>
        internal SqlStoredProcedureCreateUpdateProperties Properties { get; }
