...
{
    public partial class TableCreateUpdateData : IUtf8JsonSerializable
    {
        ...
        internal static TableCreateUpdateData DeserializeTableCreateUpdateData(JsonElement element)
        {
            ...
            return new TableCreateUpdateData(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
