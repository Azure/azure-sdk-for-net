...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class AzureBlobDataTransferDataSourceSink : DataTransferDataSourceSink
    {
        ...
        internal AzureBlobDataTransferDataSourceSink(DataTransferComponent component, string containerName, Uri endpointUri, Dictionary<string, BinaryData> rawData) : base(component, rawData)
        {
            ContainerName = containerName;
