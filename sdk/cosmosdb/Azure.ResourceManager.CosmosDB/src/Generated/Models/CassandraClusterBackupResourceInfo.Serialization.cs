...
{
    public partial class CassandraClusterBackupResourceInfo : IUtf8JsonSerializable, IJsonModel<CassandraClusterBackupResourceInfo>, IPersistableModel<CassandraClusterBackupResourceInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(BackupState))
            {
                ...
                builder.AppendLine($" '{BackupState.ToString()}'");
            }

            if (Optional.IsDefined(BackupStartTimestamp))
            {
                builder.Append("  backupStartTimestamp:");
                builder.AppendLine($" '{BackupStartTimestamp.Value.ToString()}'");
            }

            if (Optional.IsDefined(BackupStopTimestamp))
            {
                builder.Append("  backupStopTimestamp:");
                builder.AppendLine($" '{BackupStopTimestamp.Value.ToString()}'");
            }

            if (Optional.IsDefined(BackupExpiryTimestamp))
            {
                builder.Append("  backupExpiryTimestamp:");
                builder.AppendLine($" '{BackupExpiryTimestamp.Value.ToString()}'");
            }
