...
{
    public partial class SqlContainerPropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static SqlContainerPropertiesOptions DeserializeSqlContainerPropertiesOptions(JsonElement element)
        {
            ...
            return new SqlContainerPropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
