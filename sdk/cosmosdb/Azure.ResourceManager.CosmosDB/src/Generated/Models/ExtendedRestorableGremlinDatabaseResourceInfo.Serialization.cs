...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ExtendedRestorableGremlinDatabaseResourceInfo>)this).Write(writer, ModelReaderWriterOptions.Wire);
        ...
        {
            if ((options.Format != "W" || ((IPersistableModel<ExtendedRestorableGremlinDatabaseResourceInfo>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ExtendedRestorableGremlinDatabaseResourceInfo>)} interface");
            }
        ...
        string IPersistableModel<ExtendedRestorableGremlinDatabaseResourceInfo>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
