...
{
    public partial class SqlTriggerCreateOrUpdateInfo : IUtf8JsonSerializable
    {
        ...
        internal static SqlTriggerCreateOrUpdateInfo DeserializeSqlTriggerCreateOrUpdateInfo(JsonElement element)
        {
            ...
            return new SqlTriggerCreateOrUpdateInfo(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
