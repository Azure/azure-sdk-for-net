...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class Location
    {
        ...
        internal Location(string id, string locationName, string documentEndpoint, string provisioningState, int? failoverPriority, bool? isZoneRedundant, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
