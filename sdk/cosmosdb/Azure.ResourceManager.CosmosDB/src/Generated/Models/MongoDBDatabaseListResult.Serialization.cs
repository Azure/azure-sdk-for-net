...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static MongoDBDatabaseListResult DeserializeMongoDBDatabaseListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
