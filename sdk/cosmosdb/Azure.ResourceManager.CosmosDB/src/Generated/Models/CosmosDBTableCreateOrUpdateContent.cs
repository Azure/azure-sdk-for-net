...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBTableCreateOrUpdateContent : ARMResourceProperties
    {
        ...
        internal CosmosDBTableCreateOrUpdateContent(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, TableCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
