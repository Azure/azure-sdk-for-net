...
{
    public partial class SqlDatabaseCreateUpdateData : IUtf8JsonSerializable
    {
        ...
        internal static SqlDatabaseCreateUpdateData DeserializeSqlDatabaseCreateUpdateData(JsonElement element)
        {
            ...
            return new SqlDatabaseCreateUpdateData(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
