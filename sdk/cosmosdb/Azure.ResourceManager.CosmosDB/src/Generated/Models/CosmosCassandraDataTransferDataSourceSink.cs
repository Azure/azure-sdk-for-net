...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosCassandraDataTransferDataSourceSink : DataTransferDataSourceSink
    {
        ...
        internal CosmosCassandraDataTransferDataSourceSink(DataTransferComponent component, string keyspaceName, string tableName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(component, serializedAdditionalRawData)
        {
            KeyspaceName = keyspaceName;
            TableName = tableName;
            Component = component;
