...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class BaseMetric
    {
        ...
        internal BaseMetric(DateTimeOffset? startTime, DateTimeOffset? endTime, string timeGrain, UnitType? unit, MetricName name, IReadOnlyList<MetricValue> metricValues)
        {
            StartTime = startTime;
            EndTime = endTime;
            TimeGrain = timeGrain;
