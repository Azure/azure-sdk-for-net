...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraTableResourceInfo
    {
        ...
        internal CassandraTableResourceInfo(string tableName, int? defaultTtl, CassandraSchema schema, int? analyticalStorageTtl, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TableName = tableName;
