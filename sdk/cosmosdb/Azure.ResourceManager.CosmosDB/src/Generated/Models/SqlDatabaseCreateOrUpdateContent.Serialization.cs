...
{
    public partial class SqlDatabaseCreateOrUpdateContent : IUtf8JsonSerializable
    {
        ...
        internal static SqlDatabaseCreateOrUpdateContent DeserializeSqlDatabaseCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new SqlDatabaseCreateOrUpdateContent(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource, options.Value);
        }
    }
}
