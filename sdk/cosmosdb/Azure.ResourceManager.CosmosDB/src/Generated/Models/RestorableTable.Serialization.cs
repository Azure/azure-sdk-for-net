...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableTable>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableTable>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableTable>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableTable>)} interface");
            }
        ...
        string IPersistableModel<RestorableTable>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
