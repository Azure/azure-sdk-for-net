...
{
    /// <summary> The RestorableTable. </summary>
    public partial class RestorableTable : ResourceData, IJsonModel<RestorableTable>
    {
        ...
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RestorableTable IPersistableModel<RestorableTable>.Create(BinaryData data, ModelReaderWriterOptions options) => (RestorableTable)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RestorableTable IJsonModel<RestorableTable>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RestorableTable)JsonModelCreateCore(ref reader, options);
