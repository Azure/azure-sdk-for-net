...
{
    public partial class RestorableTable : IUtf8JsonSerializable, IJsonModel<RestorableTable>, IPersistableModel<RestorableTable>
    {
        ...
        void IJsonModel<RestorableTable>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RestorableTable)} does not support '{format}' format.");
            }
