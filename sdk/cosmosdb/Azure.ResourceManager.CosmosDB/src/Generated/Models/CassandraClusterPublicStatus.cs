...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraClusterPublicStatus
    {
        ...
        internal CassandraClusterPublicStatus(ETag? etag, CassandraReaperStatus reaperStatus, IReadOnlyList<CassandraConnectionError> connectionErrors, IReadOnlyList<CassandraError> errors, IReadOnlyList<CassandraClusterPublicStatusDataCentersItem> dataCenters, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            ETag = etag;
