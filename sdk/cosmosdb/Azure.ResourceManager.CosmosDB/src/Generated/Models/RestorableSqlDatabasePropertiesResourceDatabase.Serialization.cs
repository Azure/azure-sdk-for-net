...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableSqlDatabasePropertiesResourceDatabase : CosmosDBSqlDatabaseResourceInfo, IJsonModel<RestorableSqlDatabasePropertiesResourceDatabase>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<RestorableSqlDatabasePropertiesResourceDatabase>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RestorableSqlDatabasePropertiesResourceDatabase>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        RestorableSqlDatabasePropertiesResourceDatabase IPersistableModel<RestorableSqlDatabasePropertiesResourceDatabase>.Create(BinaryData data, ModelReaderWriterOptions options) => (RestorableSqlDatabasePropertiesResourceDatabase)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        RestorableSqlDatabasePropertiesResourceDatabase IJsonModel<RestorableSqlDatabasePropertiesResourceDatabase>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (RestorableSqlDatabasePropertiesResourceDatabase)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RestorableSqlDatabasePropertiesResourceDatabase DeserializeRestorableSqlDatabasePropertiesResourceDatabase(JsonElement element, ModelReaderWriterOptions options)
        {
