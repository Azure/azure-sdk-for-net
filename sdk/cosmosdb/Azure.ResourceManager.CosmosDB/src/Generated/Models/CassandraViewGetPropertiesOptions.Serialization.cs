...
{
    public partial class CassandraViewGetPropertiesOptions : IUtf8JsonSerializable, IJsonModel<CassandraViewGetPropertiesOptions>, IPersistableModel<CassandraViewGetPropertiesOptions>
    {
        ...
        void IJsonModel<CassandraViewGetPropertiesOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CassandraViewGetPropertiesOptions)} does not support '{format}' format.");
            }
