...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraViewGetPropertiesOptions : CosmosDBBaseConfig, IJsonModel<CassandraViewGetPropertiesOptions>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CassandraViewGetPropertiesOptions>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CassandraViewGetPropertiesOptions>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CassandraViewGetPropertiesOptions IPersistableModel<CassandraViewGetPropertiesOptions>.Create(BinaryData data, ModelReaderWriterOptions options) => (CassandraViewGetPropertiesOptions)PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CassandraViewGetPropertiesOptions IJsonModel<CassandraViewGetPropertiesOptions>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CassandraViewGetPropertiesOptions)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CassandraViewGetPropertiesOptions DeserializeCassandraViewGetPropertiesOptions(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new CassandraViewGetPropertiesOptions(throughput, autoscaleSettings, additionalBinaryDataProperties);
        }
    }
}
