...
{
    public partial class CassandraViewGetPropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static CassandraViewGetPropertiesOptions DeserializeCassandraViewGetPropertiesOptions(JsonElement element)
        {
            ...
            return new CassandraViewGetPropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
