...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static GremlinDatabaseListResult DeserializeGremlinDatabaseListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
