...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<GraphResourceGetPropertiesOptions>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<GraphResourceGetPropertiesOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<GraphResourceGetPropertiesOptions>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<GraphResourceGetPropertiesOptions>)} interface");
            }
        ...
        string IPersistableModel<GraphResourceGetPropertiesOptions>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
