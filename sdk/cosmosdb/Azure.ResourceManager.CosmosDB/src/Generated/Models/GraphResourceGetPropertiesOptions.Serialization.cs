...
{
    public partial class GraphResourceGetPropertiesOptions : IUtf8JsonSerializable, IJsonModel<GraphResourceGetPropertiesOptions>, IPersistableModel<GraphResourceGetPropertiesOptions>
    {
        ...
        void IJsonModel<GraphResourceGetPropertiesOptions>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(GraphResourceGetPropertiesOptions)} does not support '{format}' format.");
            }
