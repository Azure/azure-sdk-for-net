...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBClientEncryptionIncludedPath>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBClientEncryptionIncludedPath>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBClientEncryptionIncludedPath>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBClientEncryptionIncludedPath>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBClientEncryptionIncludedPath>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
