...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedRestorableGremlinDatabaseResourceInfo
    {
        ...
        internal ExtendedRestorableGremlinDatabaseResourceInfo(string rid, CosmosDBOperationType? operationType, string eventTimestamp, string databaseName, string databaseId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Rid = rid;
