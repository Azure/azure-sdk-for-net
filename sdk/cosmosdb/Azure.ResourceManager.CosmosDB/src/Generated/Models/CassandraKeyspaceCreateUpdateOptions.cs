...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraKeyspaceCreateUpdateOptions : TrackedResource
    {
        ...
        internal CassandraKeyspaceCreateUpdateOptions(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, AzureLocation location, CassandraKeyspaceResource resource, CreateUpdateOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
