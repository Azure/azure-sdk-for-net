...
{
    public partial class GremlinGraphPropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static GremlinGraphPropertiesOptions DeserializeGremlinGraphPropertiesOptions(JsonElement element)
        {
            ...
            return new GremlinGraphPropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
