...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBSqlDatabaseCreateUpdateData : ARMResourceProperties
    {
        /// <summary> Initializes a new instance of <see cref="CosmosDBSqlDatabaseCreateUpdateData"/>. </summary>
        /// <param name="resource"> The standard JSON format of a SQL database. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public CosmosDBSqlDatabaseCreateUpdateData(CosmosDBSqlDatabaseResourceInfo resource)
        {
        ...
        internal CosmosDBSqlDatabaseCreateUpdateData(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, SqlDatabaseCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
