...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBSqlClientEncryptionKeyData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBSqlClientEncryptionKeyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBSqlClientEncryptionKeyData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBSqlClientEncryptionKeyData>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBSqlClientEncryptionKeyData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
