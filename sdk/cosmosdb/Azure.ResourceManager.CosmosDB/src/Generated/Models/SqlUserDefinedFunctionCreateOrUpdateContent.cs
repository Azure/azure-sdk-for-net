...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlUserDefinedFunctionCreateOrUpdateContent : TrackedResourceData
    {
        ...
        public SqlUserDefinedFunctionCreateOrUpdateContent(AzureLocation location, SqlUserDefinedFunctionResource resource) : base(location)
        {
            if (resource == null)
            {
