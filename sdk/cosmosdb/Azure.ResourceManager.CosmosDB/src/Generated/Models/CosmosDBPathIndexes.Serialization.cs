...
{
    public partial class CosmosDBPathIndexes : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CosmosDBPathIndexes DeserializeCosmosDBPathIndexes(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
