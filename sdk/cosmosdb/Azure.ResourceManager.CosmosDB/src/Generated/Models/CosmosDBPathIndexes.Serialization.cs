...
{
    public partial class CosmosDBPathIndexes : IUtf8JsonSerializable, IJsonModel<CosmosDBPathIndexes>, IPersistableModel<CosmosDBPathIndexes>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(Precision))
            {
                ...
                builder.AppendLine($" '{Precision.Value.ToString()}'");
            }
