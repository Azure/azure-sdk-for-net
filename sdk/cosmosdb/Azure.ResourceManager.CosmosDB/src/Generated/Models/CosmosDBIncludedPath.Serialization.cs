...
{
    public partial class CosmosDBIncludedPath : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CosmosDBIncludedPath DeserializeCosmosDBIncludedPath(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
