...
{
    public partial class MongoDBIndexConfig : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBIndexConfig DeserializeMongoDBIndexConfig(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
