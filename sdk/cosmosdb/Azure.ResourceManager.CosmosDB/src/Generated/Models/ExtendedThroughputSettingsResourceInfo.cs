...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedThroughputSettingsResourceInfo : ThroughputSettingsResourceInfo
    {
        ...
        internal ExtendedThroughputSettingsResourceInfo(int? throughput, AutoscaleSettingsResourceInfo autoscaleSettings, string minimumThroughput, string offerReplacePending, string rid, float? timestamp, ETag? etag, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(throughput, autoscaleSettings, minimumThroughput, offerReplacePending, serializedAdditionalRawData)
        {
            Rid = rid;
            Timestamp = timestamp;
            ETag = etag;
