...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GraphApiComputeRegionalService : CosmosDBRegionalService
    {
        ...
        internal GraphApiComputeRegionalService(string name, AzureLocation? location, CosmosDBServiceStatus? status, string graphApiComputeEndpoint, Dictionary<string, BinaryData> rawData) : base(name, location, status, rawData)
        {
