...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBUserDefinitionCreateOrUpdateContent
    {
        ...
        internal MongoDBUserDefinitionCreateOrUpdateContent(string userName, string password, string databaseName, string customData, IList<MongoDBRole> roles, string mechanisms, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            UserName = userName;
            Password = password;
