...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedCosmosDBSqlDatabaseResourceInfo : CosmosDBSqlDatabaseResourceInfo
    {
        ...
        internal ExtendedCosmosDBSqlDatabaseResourceInfo(string databaseName, ResourceRestoreParameters restoreParameters, CosmosDBAccountCreateMode? createMode, string colls, string users, string rid, float? timestamp, ETag? etag, Dictionary<string, BinaryData> rawData) : base(databaseName, restoreParameters, createMode, rawData)
        {
            Colls = colls;
            Users = users;
            Rid = rid;
