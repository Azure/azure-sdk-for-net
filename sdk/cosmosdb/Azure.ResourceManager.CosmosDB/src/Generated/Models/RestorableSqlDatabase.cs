...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableSqlDatabase : ResourceData
    {
        ...
        internal RestorableSqlDatabase(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ExtendedRestorableSqlDatabaseResourceInfo resource, Dictionary<string, BinaryData> rawData) : base(id, name, resourceType, systemData)
        {
            Resource = resource;
            _rawData = rawData;
        }
