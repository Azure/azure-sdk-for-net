...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosTableCreateOrUpdateInfo : TrackedResourceData
    {
        /// <summary> Initializes a new instance of CosmosTableCreateOrUpdateInfo. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a Table. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public CosmosTableCreateOrUpdateInfo(AzureLocation location, TableResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal CosmosTableCreateOrUpdateInfo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, TableResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
