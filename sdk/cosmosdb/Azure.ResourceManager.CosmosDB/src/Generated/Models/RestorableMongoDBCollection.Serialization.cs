...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static RestorableMongoDBCollection DeserializeRestorableMongoDBCollection(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
