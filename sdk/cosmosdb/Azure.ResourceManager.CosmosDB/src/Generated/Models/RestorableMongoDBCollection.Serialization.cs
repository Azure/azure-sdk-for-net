...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableMongoDBCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableMongoDBCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableMongoDBCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableMongoDBCollection>)} interface");
            }
        ...
        string IPersistableModel<RestorableMongoDBCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
