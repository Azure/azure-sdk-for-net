...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CassandraViewResource>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CassandraViewResource>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CassandraViewResource>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CassandraViewResource>)} interface");
            }
        ...
        string IPersistableModel<CassandraViewResource>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
