...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DataTransferRegionalService : CosmosDBRegionalService
    {
        ...
        internal DataTransferRegionalService(string name, AzureLocation? location, CosmosDBServiceStatus? status, Dictionary<string, BinaryData> rawData) : base(name, location, status, rawData)
        {
        }
    }
}
