...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DataTransferRegionalService : CosmosDBRegionalService
    {
        ...
        internal DataTransferRegionalService(string name, AzureLocation? location, CosmosDBServiceStatus? status, IDictionary<string, BinaryData> additionalBinaryDataProperties) : base(name, location, status, additionalBinaryDataProperties)
        {
        }
    }
}
