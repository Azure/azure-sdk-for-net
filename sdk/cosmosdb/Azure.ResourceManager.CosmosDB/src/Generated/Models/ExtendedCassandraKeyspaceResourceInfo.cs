...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedCassandraKeyspaceResourceInfo : CassandraKeyspaceResourceInfo
    {
        ...
        internal ExtendedCassandraKeyspaceResourceInfo(string keyspaceName, string rid, float? timestamp, ETag? etag, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(keyspaceName, serializedAdditionalRawData)
        {
            Rid = rid;
            Timestamp = timestamp;
            ETag = etag;
