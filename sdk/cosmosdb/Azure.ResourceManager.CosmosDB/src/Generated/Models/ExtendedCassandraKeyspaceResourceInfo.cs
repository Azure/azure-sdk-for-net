...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedCassandraKeyspaceResourceInfo : CassandraKeyspaceResourceInfo
    {
        ...
        internal ExtendedCassandraKeyspaceResourceInfo(string keyspaceName, string rid, float? timestamp, ETag? etag, Dictionary<string, BinaryData> rawData) : base(keyspaceName, rawData)
        {
            Rid = rid;
            Timestamp = timestamp;
            ETag = etag;
