...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static DataTransferJobFeedResults DeserializeDataTransferJobFeedResults(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
