...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static BaseMetric DeserializeBaseMetric(JsonElement element)
        {
            ...
            return new BaseMetric(Optional.ToNullable(startTime), Optional.ToNullable(endTime), timeGrain.Value, Optional.ToNullable(unit), name.Value, Optional.ToList(metricValues));
        }
    }
}
