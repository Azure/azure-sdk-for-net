...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraKeyspaceGetResults : ARMResourceProperties
    {
        ...
        internal CassandraKeyspaceGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, CassandraKeyspaceGetPropertiesResource resource, OptionsResource options) : base(id, name, type, location, tags)
        {
            Resource = resource;
            Options = options;
        }
