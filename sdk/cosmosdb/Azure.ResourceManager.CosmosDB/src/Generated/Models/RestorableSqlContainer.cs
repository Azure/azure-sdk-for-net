...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableSqlContainer : ResourceData
    {
        ...
        internal RestorableSqlContainer(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ExtendedRestorableSqlContainerResourceInfo resource, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Resource = resource;
