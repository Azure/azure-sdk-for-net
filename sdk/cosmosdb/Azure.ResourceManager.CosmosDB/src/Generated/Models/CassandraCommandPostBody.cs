...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraCommandPostBody
    {
        ...
        internal CassandraCommandPostBody(string command, IDictionary<string, string> arguments, string host, bool? cassandraStopStart, bool? allowWrite, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Command = command;
            Arguments = arguments;
            Host = host;
