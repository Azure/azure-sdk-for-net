...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedMongoDBCollectionResourceInfo : MongoDBCollectionResourceInfo
    {
        ...
        internal ExtendedMongoDBCollectionResourceInfo(string collectionName, IDictionary<string, string> shardKey, IList<MongoIndex> indexes, int? analyticalStorageTtl, string rid, float? timestamp, ETag? etag) : base(collectionName, shardKey, indexes, analyticalStorageTtl)
        {
            Rid = rid;
            Timestamp = timestamp;
            ETag = etag;
