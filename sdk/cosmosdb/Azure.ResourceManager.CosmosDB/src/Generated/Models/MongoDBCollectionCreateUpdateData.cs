...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionCreateUpdateData : ARMResourceProperties
    {
        /// <summary> Initializes a new instance of <see cref="MongoDBCollectionCreateUpdateData"/>. </summary>
        /// <param name="resource"> The standard JSON format of a MongoDB collection. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public MongoDBCollectionCreateUpdateData(MongoDBCollectionResourceInfo resource)
        {
        ...
        internal MongoDBCollectionCreateUpdateData(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, MongoDBCollectionCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
