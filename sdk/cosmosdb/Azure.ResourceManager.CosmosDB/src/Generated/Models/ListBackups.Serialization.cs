...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ListBackups>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ListBackups>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ListBackups>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ListBackups>)} interface");
            }
        ...
        string IPersistableModel<ListBackups>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
