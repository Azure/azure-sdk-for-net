...
{
    public partial class GremlinDatabaseCreateUpdateData : IUtf8JsonSerializable
    {
        ...
        internal static GremlinDatabaseCreateUpdateData DeserializeGremlinDatabaseCreateUpdateData(JsonElement element)
        {
            ...
            return new GremlinDatabaseCreateUpdateData(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
