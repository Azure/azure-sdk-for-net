...
{
    /// <summary> An Azure Cosmos DB Cassandra table. </summary>
    public partial class CassandraTableGetResults : ARMResourceProperties
    {
        /// <summary> Initializes a new instance of CassandraTableGetResults. </summary>
        ...
        internal CassandraTableGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, CassandraTableGetPropertiesResource resource, CassandraTableGetPropertiesOptions options) : base(id, name, type, location, tags)
        {
            Resource = resource;
            Options = options;
        }
