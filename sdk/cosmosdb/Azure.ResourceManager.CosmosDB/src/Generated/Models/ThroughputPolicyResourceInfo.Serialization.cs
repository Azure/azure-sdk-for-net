...
{
    public partial class ThroughputPolicyResourceInfo : IUtf8JsonSerializable, IJsonModel<ThroughputPolicyResourceInfo>, IPersistableModel<ThroughputPolicyResourceInfo>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(IncrementPercent))
            {
                ...
                builder.AppendLine($" '{IncrementPercent.Value.ToString()}'");
            }
