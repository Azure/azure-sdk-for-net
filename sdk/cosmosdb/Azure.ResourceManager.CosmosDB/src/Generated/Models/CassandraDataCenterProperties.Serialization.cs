...
{
    public partial class CassandraDataCenterProperties : IUtf8JsonSerializable, IJsonModel<CassandraDataCenterProperties>, IPersistableModel<CassandraDataCenterProperties>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(DiskCapacity))
            {
                ...
                builder.AppendLine($" '{DiskCapacity.Value.ToString()}'");
            }
            ...
            if (Optional.IsDefined(AuthenticationMethodLdapProperties))
            {
                ...
                AppendChildObject(builder, AuthenticationMethodLdapProperties, options, 2);
            }
            ...
            if (Optional.IsDefined(ProvisionError))
            {
                ...
                AppendChildObject(builder, ProvisionError, options, 2);
            }
