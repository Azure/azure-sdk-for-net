...
{
    public partial class GremlinGraphData : Core.IUtf8JsonSerializable
    {
        ...
        internal static GremlinGraphData DeserializeGremlinGraphData(JsonElement element)
        {
            ...
            Core.Optional<ExtendedGremlinGraphResourceInfo> resource = default;
            Core.Optional<GremlinGraphPropertiesConfig> options = default;
            ...
            return new GremlinGraphData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, resource.Value, options.Value, identity);
        }
    }
}
