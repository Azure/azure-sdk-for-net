...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<PhysicalPartitionStorageInfoCollection>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<PhysicalPartitionStorageInfoCollection>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<PhysicalPartitionStorageInfoCollection>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<PhysicalPartitionStorageInfoCollection>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
