...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static DataTransferRegionalService DeserializeDataTransferRegionalService(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
