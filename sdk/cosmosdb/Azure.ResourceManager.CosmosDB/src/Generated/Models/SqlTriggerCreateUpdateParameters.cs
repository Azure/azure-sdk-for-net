...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlTriggerCreateUpdateParameters : TrackedResource
    {
        ...
        public SqlTriggerCreateUpdateParameters(Resources.Models.Location location, SqlTriggerResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal SqlTriggerCreateUpdateParameters(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Resources.Models.Location location, SqlTriggerResource resource, CreateUpdateOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
