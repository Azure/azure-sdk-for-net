...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class TableCreateUpdateParameters : TrackedResource
    {
        ...
        public TableCreateUpdateParameters(Resources.Models.Location location, TableResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal TableCreateUpdateParameters(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Resources.Models.Location location, TableResource resource, CreateUpdateOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
