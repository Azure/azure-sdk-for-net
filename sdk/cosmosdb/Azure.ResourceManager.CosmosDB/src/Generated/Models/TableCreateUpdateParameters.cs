...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class TableCreateUpdateParameters : ARMResourceProperties
    {
        ...
        public TableCreateUpdateParameters(TableResource resource, CreateUpdateOptions options)
        {
            if (resource == null)
            {
        ...
        /// <param name="resource"> The standard JSON format of a Table. </param>
        /// <param name="options"> A key-value pair of options to be applied for the request. This corresponds to the headers sent with the request. </param>
        internal TableCreateUpdateParameters(string id, string name, string type, string location, IDictionary<string, string> tags, TableResource resource, CreateUpdateOptions options) : base(id, name, type, location, tags)
        {
            Resource = resource;
            Options = options;
        }
