...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionCreateOrUpdateInfo : TrackedResourceData
    {
        /// <summary> Initializes a new instance of MongoDBCollectionCreateOrUpdateInfo. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a MongoDB collection. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public MongoDBCollectionCreateOrUpdateInfo(AzureLocation location, MongoDBCollectionResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal MongoDBCollectionCreateOrUpdateInfo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, MongoDBCollectionResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
