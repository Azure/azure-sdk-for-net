...
{
    public partial class SqlContainerData : IUtf8JsonSerializable
    {
        ...
        internal static SqlContainerData DeserializeSqlContainerData(JsonElement element)
        {
            ...
            return new SqlContainerData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, resource.Value, options.Value);
        }
    }
}
