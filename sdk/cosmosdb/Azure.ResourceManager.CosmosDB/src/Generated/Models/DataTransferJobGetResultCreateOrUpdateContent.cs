...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DataTransferJobGetResultCreateOrUpdateContent : ResourceData
    {
        ...
        internal DataTransferJobGetResultCreateOrUpdateContent(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, DataTransferJobProperties properties, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
            Properties = properties;
