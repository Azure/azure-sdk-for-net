...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableGremlinResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableGremlinResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableGremlinResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableGremlinResourceData>)} interface");
            }
        ...
        string IPersistableModel<RestorableGremlinResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
