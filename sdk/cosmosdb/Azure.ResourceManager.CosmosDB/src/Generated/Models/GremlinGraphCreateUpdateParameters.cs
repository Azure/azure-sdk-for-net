...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinGraphCreateUpdateParameters : TrackedResource
    {
        ...
        public GremlinGraphCreateUpdateParameters(Resources.Models.Location location, GremlinGraphResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal GremlinGraphCreateUpdateParameters(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Resources.Models.Location location, GremlinGraphResource resource, CreateUpdateOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
