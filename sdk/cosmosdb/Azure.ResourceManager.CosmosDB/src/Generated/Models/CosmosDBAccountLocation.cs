...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBAccountLocation
    {
        ...
        internal CosmosDBAccountLocation(string id, AzureLocation? locationName, string documentEndpoint, string provisioningState, int? failoverPriority, bool? isZoneRedundant, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Id = id;
