...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CorsPolicy
    {
        ...
        internal CorsPolicy(string allowedOrigins, string allowedMethods, string allowedHeaders, string exposedHeaders, long? maxAgeInSeconds, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            AllowedOrigins = allowedOrigins;
