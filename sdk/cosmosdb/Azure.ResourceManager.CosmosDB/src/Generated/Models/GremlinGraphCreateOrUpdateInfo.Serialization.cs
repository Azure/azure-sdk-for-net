...
{
    public partial class GremlinGraphCreateOrUpdateInfo : IUtf8JsonSerializable
    {
        ...
        internal static GremlinGraphCreateOrUpdateInfo DeserializeGremlinGraphCreateOrUpdateInfo(JsonElement element)
        {
            ...
            return new GremlinGraphCreateOrUpdateInfo(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
