...
{
    public partial class MongoDBIndex : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBIndex DeserializeMongoDBIndex(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
