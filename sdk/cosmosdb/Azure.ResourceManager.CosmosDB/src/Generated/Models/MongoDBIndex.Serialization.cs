...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoDBIndex>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoDBIndex>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoDBIndex>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoDBIndex>)} interface");
            }
        ...
        string IPersistableModel<MongoDBIndex>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
