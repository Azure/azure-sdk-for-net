...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class CosmosDBSqlClientEncryptionKeyResourceInfo : IUtf8JsonSerializable, IJsonModel<CosmosDBSqlClientEncryptionKeyResourceInfo>
    {
        ...
        void IJsonModel<CosmosDBSqlClientEncryptionKeyResourceInfo>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new InvalidOperationException($"The model {nameof(CosmosDBSqlClientEncryptionKeyResourceInfo)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CosmosDBSqlClientEncryptionKeyResourceInfo>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new InvalidOperationException($"The model {nameof(CosmosDBSqlClientEncryptionKeyResourceInfo)} does not support '{options.Format}' format.");
            }
        }
