...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinDatabaseGetResults : ARMResourceProperties
    {
        ...
        internal GremlinDatabaseGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, GremlinDatabaseGetPropertiesResource resource, GremlinDatabaseGetPropertiesOptions options) : base(id, name, type, location, tags)
        {
            Resource = resource;
            Options = options;
        }
