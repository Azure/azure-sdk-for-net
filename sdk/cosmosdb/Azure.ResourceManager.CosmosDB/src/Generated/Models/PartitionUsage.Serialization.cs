...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class PartitionUsage : IUtf8JsonSerializable, IModelJsonSerializable<PartitionUsage>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<PartitionUsage>(this, options.Format);
        ...
        internal static PartitionUsage DeserializePartitionUsage(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new PartitionUsage(Optional.ToNullable(unit), name.Value, quotaPeriod.Value, Optional.ToNullable(limit), Optional.ToNullable(currentValue), Optional.ToNullable(partitionId), partitionKeyRangeId.Value, serializedAdditionalRawData);
        }
