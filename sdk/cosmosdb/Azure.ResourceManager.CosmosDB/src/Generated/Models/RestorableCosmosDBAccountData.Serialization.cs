...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableCosmosDBAccountData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableCosmosDBAccountData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableCosmosDBAccountData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableCosmosDBAccountData>)} interface");
            }
        ...
        string IPersistableModel<RestorableCosmosDBAccountData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
