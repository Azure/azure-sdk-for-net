...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    {
        internal static RestorableCosmosDBAccountData DeserializeRestorableCosmosDBAccountData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
