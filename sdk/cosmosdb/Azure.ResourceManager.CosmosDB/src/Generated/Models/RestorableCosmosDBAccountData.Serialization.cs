...
{
    public partial class RestorableCosmosDBAccountData : IUtf8JsonSerializable, IJsonModel<RestorableCosmosDBAccountData>, IPersistableModel<RestorableCosmosDBAccountData>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(OldestRestorableOn))
            {
                ...
                builder.AppendLine($" '{OldestRestorableOn.Value.ToString()}'");
            }
