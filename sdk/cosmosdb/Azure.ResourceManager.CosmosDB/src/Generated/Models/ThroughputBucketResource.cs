...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ThroughputBucketResource
    {
        ...
        internal ThroughputBucketResource(int id, int maxThroughputPercentage, bool? isDefaultBucket, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Id = id;
            MaxThroughputPercentage = maxThroughputPercentage;
