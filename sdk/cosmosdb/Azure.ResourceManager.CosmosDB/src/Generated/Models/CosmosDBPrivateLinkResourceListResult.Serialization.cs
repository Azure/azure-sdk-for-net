...
{
    internal partial class CosmosDBPrivateLinkResourceListResult : IUtf8JsonSerializable, IJsonModel<CosmosDBPrivateLinkResourceListResult>, IPersistableModel<CosmosDBPrivateLinkResourceListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBPrivateLinkResourceListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CosmosDBPrivateLinkResourceListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBPrivateLinkResourceListResult)} does not support '{format}' format.");
            }
