...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ThroughputSettingsResource
    {
        ...
        internal ThroughputSettingsResource(int? throughput, AutoscaleSettingsResource autoscaleSettings, string minimumThroughput, string offerReplacePending, string instantMaximumThroughput, string softAllowedMaximumThroughput, IList<ThroughputBucketResource> throughputBuckets, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
