...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBBaseMetric>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBBaseMetric>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBBaseMetric>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBBaseMetric>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBBaseMetric>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
