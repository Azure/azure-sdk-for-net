...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class CosmosDBBaseMetric
    {
        internal static CosmosDBBaseMetric DeserializeCosmosDBBaseMetric(JsonElement element)
        {
            ...
            return new CosmosDBBaseMetric(Core.Optional.ToNullable(startTime), Core.Optional.ToNullable(endTime), timeGrain.Value, Core.Optional.ToNullable(unit), name.Value, Core.Optional.ToList(metricValues));
        }
    }
}
