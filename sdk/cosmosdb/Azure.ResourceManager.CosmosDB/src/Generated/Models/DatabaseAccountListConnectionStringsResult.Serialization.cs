...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DatabaseAccountListConnectionStringsResult : IJsonModel<DatabaseAccountListConnectionStringsResult>
    {
        ...
        protected virtual DatabaseAccountListConnectionStringsResult PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DatabaseAccountListConnectionStringsResult>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<DatabaseAccountListConnectionStringsResult>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        DatabaseAccountListConnectionStringsResult IPersistableModel<DatabaseAccountListConnectionStringsResult>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="DatabaseAccountListConnectionStringsResult"/> from. </param>
        internal static DatabaseAccountListConnectionStringsResult FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeDatabaseAccountListConnectionStringsResult(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        DatabaseAccountListConnectionStringsResult IJsonModel<DatabaseAccountListConnectionStringsResult>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual DatabaseAccountListConnectionStringsResult JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<DatabaseAccountListConnectionStringsResult>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static DatabaseAccountListConnectionStringsResult DeserializeDatabaseAccountListConnectionStringsResult(JsonElement element, ModelReaderWriterOptions options)
        {
