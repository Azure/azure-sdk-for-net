...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<DatabaseAccountListConnectionStringsResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<DatabaseAccountListConnectionStringsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<DatabaseAccountListConnectionStringsResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<DatabaseAccountListConnectionStringsResult>)} interface");
            }
        ...
        string IPersistableModel<DatabaseAccountListConnectionStringsResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
