...
{
    internal partial class DatabaseAccountListConnectionStringsResult : IUtf8JsonSerializable, IJsonModel<DatabaseAccountListConnectionStringsResult>, IPersistableModel<DatabaseAccountListConnectionStringsResult>
    {
        ...
        void IJsonModel<DatabaseAccountListConnectionStringsResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(DatabaseAccountListConnectionStringsResult)} does not support '{format}' format.");
            }
