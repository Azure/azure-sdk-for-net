...
{
    public partial class GremlinDatabaseCreateOrUpdateInfo : IUtf8JsonSerializable
    {
        ...
        internal static GremlinDatabaseCreateOrUpdateInfo DeserializeGremlinDatabaseCreateOrUpdateInfo(JsonElement element)
        {
            ...
            return new GremlinDatabaseCreateOrUpdateInfo(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
