...
{
    public partial class ConsistencyPolicy : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static ConsistencyPolicy DeserializeConsistencyPolicy(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
