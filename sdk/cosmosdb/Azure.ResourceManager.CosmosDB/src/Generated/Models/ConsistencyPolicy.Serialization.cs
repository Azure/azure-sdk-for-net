...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConsistencyPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConsistencyPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConsistencyPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConsistencyPolicy>)} interface");
            }
        ...
        string IPersistableModel<ConsistencyPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
