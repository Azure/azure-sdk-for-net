...
{
    public partial class ConsistencyPolicy : IUtf8JsonSerializable, IJsonModel<ConsistencyPolicy>, IPersistableModel<ConsistencyPolicy>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(MaxIntervalInSeconds))
            {
                ...
                builder.AppendLine($" '{MaxIntervalInSeconds.Value.ToString()}'");
            }
