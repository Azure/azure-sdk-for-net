...
namespace Azure.ResourceManager.CosmosDB
{
    public partial class CosmosDBPrivateEndpointConnectionData : IUtf8JsonSerializable, IModelJsonSerializable<CosmosDBPrivateEndpointConnectionData>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CosmosDBPrivateEndpointConnectionData>(this, options.Format);
            ...
            if (Optional.IsDefined(PrivateEndpoint))
            {
                ...
                {
                    ((IModelJsonSerializable<PrivateEndpointProperty>)PrivateEndpoint).Serialize(writer, options);
                }
            }
            if (Optional.IsDefined(ConnectionState))
            {
                ...
                {
                    ((IModelJsonSerializable<CosmosDBPrivateLinkServiceConnectionStateProperty>)ConnectionState).Serialize(writer, options);
                }
            }
        ...
        /// <summary> Converts a <see cref="CosmosDBPrivateEndpointConnectionData"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CosmosDBPrivateEndpointConnectionData"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CosmosDBPrivateEndpointConnectionData"/>. </summary>
