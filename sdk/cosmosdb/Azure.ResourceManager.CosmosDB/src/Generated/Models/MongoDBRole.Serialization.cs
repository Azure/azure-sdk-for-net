...
{
    public partial class MongoDBRole : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static MongoDBRole DeserializeMongoDBRole(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
