...
{
    public partial class CosmosDBSqlDatabaseCreateOrUpdateContent : Core.IUtf8JsonSerializable
    {
        ...
        internal static CosmosDBSqlDatabaseCreateOrUpdateContent DeserializeCosmosDBSqlDatabaseCreateOrUpdateContent(JsonElement element)
        {
            ...
            return new CosmosDBSqlDatabaseCreateOrUpdateContent(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, resource, options.Value, identity);
        }
    }
}
