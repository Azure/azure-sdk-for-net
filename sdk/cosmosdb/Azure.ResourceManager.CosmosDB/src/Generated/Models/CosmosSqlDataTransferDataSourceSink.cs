...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosSqlDataTransferDataSourceSink : DataTransferDataSourceSink
    {
        ...
        internal CosmosSqlDataTransferDataSourceSink(DataTransferComponent component, string databaseName, string containerName, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(component, serializedAdditionalRawData)
        {
            DatabaseName = databaseName;
            ContainerName = containerName;
            Component = component;
