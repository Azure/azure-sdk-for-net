...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedCosmosDBSqlUserDefinedFunctionResourceInfo : CosmosDBSqlUserDefinedFunctionResourceInfo
    {
        ...
        internal ExtendedCosmosDBSqlUserDefinedFunctionResourceInfo(string functionName, string body, string rid, float? timestamp, ETag? etag, Dictionary<string, BinaryData> rawData) : base(functionName, body, rawData)
        {
            Rid = rid;
            Timestamp = timestamp;
            ETag = etag;
