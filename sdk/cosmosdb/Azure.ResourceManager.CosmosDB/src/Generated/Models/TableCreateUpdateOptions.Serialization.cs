...
{
    public partial class TableCreateUpdateOptions : IUtf8JsonSerializable
    {
        ...
        internal static TableCreateUpdateOptions DeserializeTableCreateUpdateOptions(JsonElement element)
        {
            ...
            return new TableCreateUpdateOptions(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
