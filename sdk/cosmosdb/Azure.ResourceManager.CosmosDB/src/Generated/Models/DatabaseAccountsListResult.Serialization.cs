...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static DatabaseAccountsListResult DeserializeDatabaseAccountsListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
