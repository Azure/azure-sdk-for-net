...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinDatabaseCreateUpdateParameters : TrackedResource
    {
        /// <summary> Initializes a new instance of GremlinDatabaseCreateUpdateParameters. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a Gremlin database. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public GremlinDatabaseCreateUpdateParameters(Resources.Models.Location location, GremlinDatabaseResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal GremlinDatabaseCreateUpdateParameters(ResourceIdentifier id, string name, ResourceType type, IDictionary<string, string> tags, Resources.Models.Location location, GremlinDatabaseResource resource, CreateUpdateOptions options) : base(id, name, type, tags, location)
        {
            Resource = resource;
            Options = options;
        }
