...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedCosmosDBSqlStoredProcedureResourceInfo : CosmosDBSqlStoredProcedureResourceInfo
    {
        ...
        internal ExtendedCosmosDBSqlStoredProcedureResourceInfo(string storedProcedureName, string body, string rid, float? timestamp, ETag? etag, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(storedProcedureName, body, serializedAdditionalRawData)
        {
            Rid = rid;
            Timestamp = timestamp;
            ETag = etag;
