...
{
    public partial class CassandraTablePropertiesOptions : IUtf8JsonSerializable
    {
        ...
        internal static CassandraTablePropertiesOptions DeserializeCassandraTablePropertiesOptions(JsonElement element)
        {
            ...
            return new CassandraTablePropertiesOptions(Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
