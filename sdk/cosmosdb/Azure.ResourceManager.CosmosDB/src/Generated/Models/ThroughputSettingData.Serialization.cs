...
{
    public partial class ThroughputSettingData : Core.IUtf8JsonSerializable
    {
        ...
        internal static ThroughputSettingData DeserializeThroughputSettingData(JsonElement element)
        {
            ...
            Core.Optional<ExtendedThroughputSettingsResourceInfo> resource = default;
            ...
            return new ThroughputSettingData(id, name, type, systemData.Value, Core.Optional.ToDictionary(tags), location, resource.Value, identity);
        }
    }
}
