...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBBaseMetric
    {
        ...
        internal CosmosDBBaseMetric(DateTimeOffset? startOn, DateTimeOffset? endOn, string timeGrain, CosmosDBMetricUnitType? unit, CosmosDBMetricName name, IReadOnlyList<CosmosDBMetricValue> metricValues, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            StartOn = startOn;
            EndOn = endOn;
            TimeGrain = timeGrain;
