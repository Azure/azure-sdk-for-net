...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ConflictResolutionPolicy>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ConflictResolutionPolicy>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ConflictResolutionPolicy>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ConflictResolutionPolicy>)} interface");
            }
        ...
        string IPersistableModel<ConflictResolutionPolicy>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
