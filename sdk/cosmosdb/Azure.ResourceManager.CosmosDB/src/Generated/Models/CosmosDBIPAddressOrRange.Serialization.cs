...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBIPAddressOrRange>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBIPAddressOrRange>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBIPAddressOrRange>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CosmosDBIPAddressOrRange>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
