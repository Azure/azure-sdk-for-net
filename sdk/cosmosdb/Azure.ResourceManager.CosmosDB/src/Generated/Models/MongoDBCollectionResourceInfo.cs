...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionResourceInfo
    {
        ...
        internal MongoDBCollectionResourceInfo(string collectionName, IDictionary<string, string> shardKey, IList<MongoDBIndex> indexes, int? analyticalStorageTtl, ResourceRestoreParameters restoreParameters, CosmosDBAccountCreateMode? createMode, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            CollectionName = collectionName;
            ShardKey = shardKey;
            Indexes = indexes;
