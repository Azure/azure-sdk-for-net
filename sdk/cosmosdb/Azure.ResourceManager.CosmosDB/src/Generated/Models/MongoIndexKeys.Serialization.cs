...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoIndexKeys>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoIndexKeys>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoIndexKeys>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoIndexKeys>)} interface");
            }
        ...
        string IPersistableModel<MongoIndexKeys>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
