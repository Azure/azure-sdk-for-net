...
{
    public partial class SqlUserDefinedFunctionCreateOrUpdateInfo : IUtf8JsonSerializable
    {
        ...
        internal static SqlUserDefinedFunctionCreateOrUpdateInfo DeserializeSqlUserDefinedFunctionCreateOrUpdateInfo(JsonElement element)
        {
            ...
            return new SqlUserDefinedFunctionCreateOrUpdateInfo(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
