...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedGremlinDatabaseResourceInfo : GremlinDatabaseResourceInfo
    {
        ...
        internal ExtendedGremlinDatabaseResourceInfo(string databaseName, IDictionary<string, BinaryData> serializedAdditionalRawData, string rid, float? timestamp, ETag? etag) : base(databaseName, serializedAdditionalRawData)
        {
            Rid = rid;
            Timestamp = timestamp;
            ETag = etag;
