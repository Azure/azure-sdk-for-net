...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBClientEncryptionIncludedPath
    {
        ...
        internal CosmosDBClientEncryptionIncludedPath(string path, string clientEncryptionKeyId, string encryptionType, string encryptionAlgorithm, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Path = path;
            ClientEncryptionKeyId = clientEncryptionKeyId;
            EncryptionType = encryptionType;
