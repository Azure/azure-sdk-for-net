...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBClientEncryptionIncludedPath
    {
        ...
        internal CosmosDBClientEncryptionIncludedPath(string path, string clientEncryptionKeyId, string encryptionType, string encryptionAlgorithm, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            Path = path;
            ClientEncryptionKeyId = clientEncryptionKeyId;
            EncryptionType = encryptionType;
