...
namespace Azure.ResourceManager.CosmosDB
{
    public partial class CosmosDBPrivateEndpointConnectionResource : IJsonModel<CosmosDBPrivateEndpointConnectionData>
    {
        ...
        {
            return ModelReaderWriter.Read<CosmosDBPrivateEndpointConnectionData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<CosmosDBPrivateEndpointConnectionData>(data, options);
        }
