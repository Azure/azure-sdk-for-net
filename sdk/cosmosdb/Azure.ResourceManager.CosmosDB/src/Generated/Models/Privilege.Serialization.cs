...
{
    public partial class Privilege : IUtf8JsonSerializable
    {
        ...
        internal static Privilege DeserializePrivilege(JsonElement element)
        {
            ...
            return new Privilege(resource.Value, Optional.ToList(actions));
        }
    }
}
