...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ContinuousBackupInformation>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ContinuousBackupInformation>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ContinuousBackupInformation>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ContinuousBackupInformation>)} interface");
            }
        ...
        string IPersistableModel<ContinuousBackupInformation>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
