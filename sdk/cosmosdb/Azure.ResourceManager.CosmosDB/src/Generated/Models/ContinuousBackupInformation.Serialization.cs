...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static ContinuousBackupInformation DeserializeContinuousBackupInformation(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
