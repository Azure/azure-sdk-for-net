...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlStoredProcedureCreateUpdateData : TrackedResourceData
    {
        /// <summary> Initializes a new instance of SqlStoredProcedureCreateUpdateData. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a storedProcedure. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public SqlStoredProcedureCreateUpdateData(AzureLocation location, SqlStoredProcedureResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal SqlStoredProcedureCreateUpdateData(ResourceIdentifier id, string name, ResourceType type, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SqlStoredProcedureResource resource, CreateUpdateOptions options) : base(id, name, type, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
