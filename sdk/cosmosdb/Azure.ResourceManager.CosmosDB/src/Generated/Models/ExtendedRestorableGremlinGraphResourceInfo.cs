...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedRestorableGremlinGraphResourceInfo
    {
        ...
        internal ExtendedRestorableGremlinGraphResourceInfo(string rid, CosmosDBOperationType? operationType, string eventTimestamp, string graphName, string graphId, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Rid = rid;
