...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableMongoDBResourcesGetResult : ResourceData
    {
        /// <summary> Initializes a new instance of RestorableMongoDBResourcesGetResult. </summary>
        internal RestorableMongoDBResourcesGetResult()
        {
        ...
        internal RestorableMongoDBResourcesGetResult(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, string databaseName, IReadOnlyList<string> collectionNames) : base(id, name, resourceType, systemData)
        {
