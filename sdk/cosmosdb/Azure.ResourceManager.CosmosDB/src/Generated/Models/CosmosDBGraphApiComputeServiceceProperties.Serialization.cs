...
{
    public partial class CosmosDBGraphApiComputeServiceceProperties : IUtf8JsonSerializable
    {
        ...
        internal static CosmosDBGraphApiComputeServiceceProperties DeserializeCosmosDBGraphApiComputeServiceceProperties(JsonElement element)
        {
            Optional<string> graphApiComputeEndpoint = default;
            Optional<IReadOnlyList<CosmosDBGraphApiComputeRegionalServiceInfo>> locations = default;
            ...
            foreach (var property in element.EnumerateObject())
            {
                ...
                if (property.NameEquals("locations"))
                {
                    ...
                    List<CosmosDBGraphApiComputeRegionalServiceInfo> array = new List<CosmosDBGraphApiComputeRegionalServiceInfo>();
                    foreach (var item in property.Value.EnumerateArray())
                    {
                        array.Add(CosmosDBGraphApiComputeRegionalServiceInfo.DeserializeCosmosDBGraphApiComputeRegionalServiceInfo(item));
                    }
                    locations = array;
                    continue;
                }
            ...
            return new CosmosDBGraphApiComputeServiceceProperties(Optional.ToNullable(creationTime), Optional.ToNullable(instanceSize), Optional.ToNullable(instanceCount), serviceType, Optional.ToNullable(status), additionalProperties, graphApiComputeEndpoint.Value, Optional.ToList(locations));
        }
    }
}
