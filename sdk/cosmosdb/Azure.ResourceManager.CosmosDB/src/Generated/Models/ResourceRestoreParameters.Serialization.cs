...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<ResourceRestoreParameters>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<ResourceRestoreParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<ResourceRestoreParameters>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<ResourceRestoreParameters>)} interface");
            }
        ...
        string IPersistableModel<ResourceRestoreParameters>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
