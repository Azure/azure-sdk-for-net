...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<MongoClusterRestoreParameters>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<MongoClusterRestoreParameters>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<MongoClusterRestoreParameters>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<MongoClusterRestoreParameters>)} interface");
            }
        ...
        string IPersistableModel<MongoClusterRestoreParameters>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
