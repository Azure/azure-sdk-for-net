...
{
    public partial class MongoClusterRestoreParameters : IUtf8JsonSerializable, IJsonModel<MongoClusterRestoreParameters>, IPersistableModel<MongoClusterRestoreParameters>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(SourceResourceId))
            {
                ...
                builder.AppendLine($" '{SourceResourceId}'");
            }
