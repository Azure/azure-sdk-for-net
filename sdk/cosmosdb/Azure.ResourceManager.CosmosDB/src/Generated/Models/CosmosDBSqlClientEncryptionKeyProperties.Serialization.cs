...
namespace Azure.ResourceManager.CosmosDB.Models
{
    public partial class CosmosDBSqlClientEncryptionKeyProperties : IUtf8JsonSerializable, IModelJsonSerializable<CosmosDBSqlClientEncryptionKeyProperties>
    {
        ...
        {
            Core.ModelSerializerHelper.ValidateFormat<CosmosDBSqlClientEncryptionKeyProperties>(this, options.Format);
        ...
        internal static CosmosDBSqlClientEncryptionKeyProperties DeserializeCosmosDBSqlClientEncryptionKeyProperties(JsonElement element, ModelSerializerOptions options = default)
        {
            ...
            return new CosmosDBSqlClientEncryptionKeyProperties(id.Value, encryptionAlgorithm.Value, wrappedDataEncryptionKey.Value, keyWrapMetadata.Value, rid.Value, Optional.ToNullable(ts), Optional.ToNullable(etag), serializedAdditionalRawData);
        }
        ...
        /// <summary> Converts a <see cref="CosmosDBSqlClientEncryptionKeyProperties"/> into a <see cref="RequestContent"/>. </summary>
        /// <param name="model"> The <see cref="CosmosDBSqlClientEncryptionKeyProperties"/> to convert. </param>
        ...
        /// <summary> Converts a <see cref="Response"/> into a <see cref="CosmosDBSqlClientEncryptionKeyProperties"/>. </summary>
