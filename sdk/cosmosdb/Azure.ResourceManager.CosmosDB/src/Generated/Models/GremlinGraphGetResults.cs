...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinGraphGetResults : ARMResourceProperties
    {
        ...
        internal GremlinGraphGetResults(string id, string name, string type, string location, IDictionary<string, string> tags, GremlinGraphGetPropertiesResource resource, OptionsResource options) : base(id, name, type, location, tags)
        {
            Resource = resource;
            Options = options;
        }
