...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static PhysicalPartitionStorageInfo DeserializePhysicalPartitionStorageInfo(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
