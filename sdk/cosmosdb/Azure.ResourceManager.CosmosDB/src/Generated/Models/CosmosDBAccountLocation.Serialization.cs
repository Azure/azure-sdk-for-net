...
{
    public partial class CosmosDBAccountLocation : IUtf8JsonSerializable, IJsonModel<CosmosDBAccountLocation>, IPersistableModel<CosmosDBAccountLocation>
    {
        ...
        private BinaryData SerializeBicep(ModelReaderWriterOptions options)
        {
            ...
            if (Optional.IsDefined(FailoverPriority))
            {
                ...
                builder.AppendLine($" '{FailoverPriority.Value.ToString()}'");
            }
