...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class NodeGroupSpec : NodeGroupProperties
    {
        ...
        internal NodeGroupSpec(string sku, long? diskSizeInGB, bool? enableHa, NodeKind? kind, int? nodeCount, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(sku, diskSizeInGB, enableHa, serializedAdditionalRawData)
        {
            Kind = kind;
            NodeCount = nodeCount;
        }
