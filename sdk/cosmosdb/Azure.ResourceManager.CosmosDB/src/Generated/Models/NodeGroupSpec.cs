...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class NodeGroupSpec : NodeGroupProperties
    {
        ...
        internal NodeGroupSpec(string sku, long? diskSizeInGB, bool? enableHa, NodeKind? kind, int? nodeCount, Dictionary<string, BinaryData> rawData) : base(sku, diskSizeInGB, enableHa, rawData)
        {
            Kind = kind;
            NodeCount = nodeCount;
        }
