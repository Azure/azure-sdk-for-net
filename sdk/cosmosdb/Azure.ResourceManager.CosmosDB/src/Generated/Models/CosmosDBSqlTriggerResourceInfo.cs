...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBSqlTriggerResourceInfo
    {
        ...
        internal CosmosDBSqlTriggerResourceInfo(string triggerName, string body, CosmosDBSqlTriggerType? triggerType, CosmosDBSqlTriggerOperation? triggerOperation, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            TriggerName = triggerName;
            Body = body;
