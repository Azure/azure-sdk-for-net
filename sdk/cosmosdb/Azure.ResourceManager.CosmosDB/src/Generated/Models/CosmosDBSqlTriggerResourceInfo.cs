...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBSqlTriggerResourceInfo
    {
        ...
        internal CosmosDBSqlTriggerResourceInfo(string triggerName, string body, CosmosDBSqlTriggerType? triggerType, CosmosDBSqlTriggerOperation? triggerOperation, IDictionary<string, BinaryData> additionalBinaryDataProperties)
        {
            TriggerName = triggerName;
            Body = body;
