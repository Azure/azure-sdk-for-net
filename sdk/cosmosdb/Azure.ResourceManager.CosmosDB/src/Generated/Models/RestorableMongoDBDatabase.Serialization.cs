...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableMongoDBDatabase>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableMongoDBDatabase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableMongoDBDatabase>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableMongoDBDatabase>)} interface");
            }
        ...
        string IPersistableModel<RestorableMongoDBDatabase>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
