...
{
    public partial class RestorableMongoDBDatabase : IUtf8JsonSerializable, IJsonModel<RestorableMongoDBDatabase>, IPersistableModel<RestorableMongoDBDatabase>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableMongoDBDatabase>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<RestorableMongoDBDatabase>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(RestorableMongoDBDatabase)} does not support '{format}' format.");
            }
