...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class ExtendedMongoDBDatabaseResourceInfo : MongoDBDatabaseResourceInfo
    {
        ...
        internal ExtendedMongoDBDatabaseResourceInfo(string databaseName, ResourceRestoreParameters restoreParameters, CosmosDBAccountCreateMode? createMode, string rid, float? timestamp, ETag? etag, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(databaseName, restoreParameters, createMode, serializedAdditionalRawData)
        {
            Rid = rid;
            Timestamp = timestamp;
            ETag = etag;
