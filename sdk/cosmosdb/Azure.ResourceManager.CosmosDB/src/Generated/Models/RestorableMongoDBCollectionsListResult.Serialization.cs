...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableMongoDBCollectionsListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableMongoDBCollectionsListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableMongoDBCollectionsListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableMongoDBCollectionsListResult>)} interface");
            }
        ...
        string IPersistableModel<RestorableMongoDBCollectionsListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
