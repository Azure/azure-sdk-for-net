...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="RestoreParameters"/>. </summary>
        ...
        internal RestoreParameters(string restoreSource, DateTimeOffset? restoreTimestampInUtc, bool? restoreWithTtlDisabled, IDictionary<string, BinaryData> additionalBinaryDataProperties, RestoreMode? restoreMode, IList<DatabaseRestoreResourceInfo> databasesToRestore, IList<GremlinDatabaseRestoreResource> gremlinDatabasesToRestore, IList<string> tablesToRestore, string sourceBackupLocation) : base(restoreSource, restoreTimestampInUtc, restoreWithTtlDisabled, additionalBinaryDataProperties)
        {
