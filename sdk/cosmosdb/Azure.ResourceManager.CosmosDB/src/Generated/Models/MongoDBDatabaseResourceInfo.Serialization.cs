...
{
    public partial class MongoDBDatabaseResourceInfo : Core.IUtf8JsonSerializable
    {
        ...
        internal static MongoDBDatabaseResourceInfo DeserializeMongoDBDatabaseResourceInfo(JsonElement element)
        {
            ...
            return new MongoDBDatabaseResourceInfo(id, restoreParameters.Value, Core.Optional.ToNullable(createMode));
        }
    }
}
