...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlTriggerCreateOrUpdateInfo : TrackedResourceData
    {
        /// <summary> Initializes a new instance of SqlTriggerCreateOrUpdateInfo. </summary>
        /// <param name="location"> The location. </param>
        /// <param name="resource"> The standard JSON format of a trigger. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public SqlTriggerCreateOrUpdateInfo(AzureLocation location, SqlTriggerResource resource) : base(location)
        {
            if (resource == null)
            {
        ...
        internal SqlTriggerCreateOrUpdateInfo(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, string> tags, AzureLocation location, SqlTriggerResource resource, CreateUpdateOptions options) : base(id, name, resourceType, systemData, tags, location)
        {
            Resource = resource;
            Options = options;
        }
