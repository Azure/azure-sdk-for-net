...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBKeyWrapMetadata
    {
        ...
        internal CosmosDBKeyWrapMetadata(string name, string cosmosDBKeyWrapMetadataType, string value, string algorithm, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            Name = name;
