...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBMetricAvailability>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBMetricAvailability>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBMetricAvailability>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
        ...
        string IPersistableModel<CosmosDBMetricAvailability>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
