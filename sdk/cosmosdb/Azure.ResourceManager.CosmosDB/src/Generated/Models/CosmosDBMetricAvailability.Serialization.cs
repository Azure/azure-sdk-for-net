...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static CosmosDBMetricAvailability DeserializeCosmosDBMetricAvailability(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
