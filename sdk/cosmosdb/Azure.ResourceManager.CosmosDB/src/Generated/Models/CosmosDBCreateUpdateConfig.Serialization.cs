...
{
    public partial class CosmosDBCreateUpdateConfig : IUtf8JsonSerializable, Core.IModelSerializable
    {
        ...
        internal static CosmosDBCreateUpdateConfig DeserializeCosmosDBCreateUpdateConfig(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
