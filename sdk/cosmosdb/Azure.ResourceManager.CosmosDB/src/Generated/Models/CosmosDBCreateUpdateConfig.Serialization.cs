...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBCreateUpdateConfig : IJsonModel<CosmosDBCreateUpdateConfig>
    {
        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual CosmosDBCreateUpdateConfig PersistableModelCreateCore(BinaryData data, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<CosmosDBCreateUpdateConfig>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CosmosDBCreateUpdateConfig>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CosmosDBCreateUpdateConfig IPersistableModel<CosmosDBCreateUpdateConfig>.Create(BinaryData data, ModelReaderWriterOptions options) => PersistableModelCreateCore(data, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CosmosDBCreateUpdateConfig IJsonModel<CosmosDBCreateUpdateConfig>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => JsonModelCreateCore(ref reader, options);

        /// <param name="reader"> The JSON reader. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        protected virtual CosmosDBCreateUpdateConfig JsonModelCreateCore(ref Utf8JsonReader reader, ModelReaderWriterOptions options)
        {
            string format = options.Format == "W" ? ((IPersistableModel<CosmosDBCreateUpdateConfig>)this).GetFormatFromOptions(options) : options.Format;
            if (format != "J")
            {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CosmosDBCreateUpdateConfig DeserializeCosmosDBCreateUpdateConfig(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            return new CosmosDBCreateUpdateConfig(throughput, autoscaleSettings, additionalBinaryDataProperties);
        }
    }
}
