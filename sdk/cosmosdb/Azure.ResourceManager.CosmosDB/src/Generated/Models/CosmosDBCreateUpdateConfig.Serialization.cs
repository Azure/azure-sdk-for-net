...
{
    public partial class CosmosDBCreateUpdateConfig : Core.IUtf8JsonSerializable
    {
        ...
        internal static CosmosDBCreateUpdateConfig DeserializeCosmosDBCreateUpdateConfig(JsonElement element)
        {
            ...
            return new CosmosDBCreateUpdateConfig(Core.Optional.ToNullable(throughput), autoscaleSettings.Value);
        }
    }
}
