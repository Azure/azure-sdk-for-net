...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBCreateUpdateConfig>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CosmosDBCreateUpdateConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CosmosDBCreateUpdateConfig>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CosmosDBCreateUpdateConfig>)} interface");
            }
        ...
        string IPersistableModel<CosmosDBCreateUpdateConfig>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
