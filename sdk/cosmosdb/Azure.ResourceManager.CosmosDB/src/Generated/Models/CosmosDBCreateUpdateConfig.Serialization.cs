...
{
    public partial class CosmosDBCreateUpdateConfig : IUtf8JsonSerializable, IJsonModel<CosmosDBCreateUpdateConfig>, IPersistableModel<CosmosDBCreateUpdateConfig>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBCreateUpdateConfig>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CosmosDBCreateUpdateConfig>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBCreateUpdateConfig)} does not support '{format}' format.");
            }
