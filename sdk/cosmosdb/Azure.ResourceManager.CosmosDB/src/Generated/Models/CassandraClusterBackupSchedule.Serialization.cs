...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CassandraClusterBackupSchedule>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<CassandraClusterBackupSchedule>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<CassandraClusterBackupSchedule>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<CassandraClusterBackupSchedule>)} interface");
            }
        ...
        string IPersistableModel<CassandraClusterBackupSchedule>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
