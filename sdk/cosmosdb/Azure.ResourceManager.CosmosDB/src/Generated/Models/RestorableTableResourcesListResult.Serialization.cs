...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableTableResourcesListResult>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableTableResourcesListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableTableResourcesListResult>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableTableResourcesListResult>)} interface");
            }
        ...
        string IPersistableModel<RestorableTableResourcesListResult>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
