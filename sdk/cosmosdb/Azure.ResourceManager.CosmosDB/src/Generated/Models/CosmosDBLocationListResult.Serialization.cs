...
{
    internal partial class CosmosDBLocationListResult : IUtf8JsonSerializable, IJsonModel<CosmosDBLocationListResult>, IPersistableModel<CosmosDBLocationListResult>
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<CosmosDBLocationListResult>)this).Write(writer, new ModelReaderWriterOptions("W"));
        ...
        void IJsonModel<CosmosDBLocationListResult>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBLocationListResult)} does not support '{format}' format.");
            }
