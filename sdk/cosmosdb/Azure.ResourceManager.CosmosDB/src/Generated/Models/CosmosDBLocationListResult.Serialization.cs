...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static CosmosDBLocationListResult DeserializeCosmosDBLocationListResult(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
