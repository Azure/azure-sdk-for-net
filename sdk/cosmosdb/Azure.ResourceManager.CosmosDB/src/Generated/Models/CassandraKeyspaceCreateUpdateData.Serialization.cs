...
{
    public partial class CassandraKeyspaceCreateUpdateData : IUtf8JsonSerializable
    {
        ...
        internal static CassandraKeyspaceCreateUpdateData DeserializeCassandraKeyspaceCreateUpdateData(JsonElement element)
        {
            ...
            return new CassandraKeyspaceCreateUpdateData(id, name, type, systemData, tags, location, resource, options.Value);
        }
    }
}
