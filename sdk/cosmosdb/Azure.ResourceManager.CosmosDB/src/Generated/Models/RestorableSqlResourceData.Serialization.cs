...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        internal static RestorableSqlResourceData DeserializeRestorableSqlResourceData(JsonElement element, Core.Serialization.SerializableOptions options = default)
        {
