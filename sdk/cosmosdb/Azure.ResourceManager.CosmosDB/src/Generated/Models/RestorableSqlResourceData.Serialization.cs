...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        void IUtf8JsonSerializable.Write(Utf8JsonWriter writer) => ((IJsonModel<RestorableSqlResourceData>)this).Write(writer, ModelReaderWriterOptions.Wire);

        void IJsonModel<RestorableSqlResourceData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            if ((options.Format != "W" || ((IPersistableModel<RestorableSqlResourceData>)this).GetWireFormat(options) != "J") && options.Format != "J")
            {
                throw new InvalidOperationException($"Must use 'J' format when calling the {nameof(IJsonModel<RestorableSqlResourceData>)} interface");
            }
        ...
        string IPersistableModel<RestorableSqlResourceData>.GetWireFormat(ModelReaderWriterOptions options) => "J";
    }
}
