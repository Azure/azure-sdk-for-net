...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class RestorableSqlResourceData : IJsonModel<RestorableSqlResourceData>
    {
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<RestorableSqlResourceData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static RestorableSqlResourceData DeserializeRestorableSqlResourceData(JsonElement element, ModelReaderWriterOptions options)
        {
