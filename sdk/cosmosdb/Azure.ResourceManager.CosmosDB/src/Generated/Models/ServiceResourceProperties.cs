...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    /// </summary>
    public abstract partial class ServiceResourceProperties
    {
        ...
        private protected ServiceResourceProperties(CosmosDBServiceType serviceType)
        {
        ...
        internal ServiceResourceProperties(DateTimeOffset? createdOn, CosmosDBServiceSize? instanceSize, int? instanceCount, CosmosDBServiceType serviceType, ServiceStatus? status, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            CreatedOn = createdOn;
