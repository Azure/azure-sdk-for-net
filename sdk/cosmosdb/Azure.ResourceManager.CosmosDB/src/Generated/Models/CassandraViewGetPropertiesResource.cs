...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraViewGetPropertiesResource : CassandraViewResource
    {
        ...
        internal CassandraViewGetPropertiesResource(string id, string viewDefinition, string rid, float? timestamp, ETag? etag, Dictionary<string, BinaryData> rawData) : base(id, viewDefinition, rawData)
        {
            Rid = rid;
            Timestamp = timestamp;
            ETag = etag;
