...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CosmosDBAccountCorsPolicy
    {
        ...
        internal CosmosDBAccountCorsPolicy(string allowedOrigins, string allowedMethods, string allowedHeaders, string exposedHeaders, long? maxAgeInSeconds, Dictionary<string, BinaryData> serializedAdditionalRawData)
        {
            AllowedOrigins = allowedOrigins;
