...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="MongoDBDatabaseCreateUpdateParameters"/>. </summary>
        /// <param name="resource"> The standard JSON format of a MongoDB database. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resource"/> is null. </exception>
        public MongoDBDatabaseCreateUpdateParameters(MongoDBDatabaseResource resource)
        {
            Argument.AssertNotNull(resource, nameof(resource));

            Properties = new MongoDBDatabaseCreateUpdateProperties(resource);
        }
        ...
        /// <param name="properties"> Properties to create and update Azure Cosmos DB MongoDB database. </param>
        internal MongoDBDatabaseCreateUpdateParameters(string id, string name, string @type, string location, IDictionary<string, string> tags, ManagedServiceIdentity identity, IDictionary<string, BinaryData> additionalBinaryDataProperties, MongoDBDatabaseCreateUpdateProperties properties) : base(id, name, @type, location, tags, identity, additionalBinaryDataProperties)
        {
            Properties = properties;
        }

        /// <summary> Properties to create and update Azure Cosmos DB MongoDB database. </summary>
        internal MongoDBDatabaseCreateUpdateProperties Properties { get; }
