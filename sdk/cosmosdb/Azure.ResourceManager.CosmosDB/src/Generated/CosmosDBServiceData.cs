...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBServiceData : ResourceData
    {
        ...
        internal CosmosDBServiceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CosmosDBServiceProperties properties) : base(id, name, resourceType, systemData)
        {
