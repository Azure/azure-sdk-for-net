...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlTriggerData : ResourceData
    {
        ...
        internal CosmosDBSqlTriggerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CosmosDBSqlTriggerProperties properties, IDictionary<string, string> tags, string location, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
