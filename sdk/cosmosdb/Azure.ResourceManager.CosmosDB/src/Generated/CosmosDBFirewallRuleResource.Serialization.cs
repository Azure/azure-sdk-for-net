...
namespace Azure.ResourceManager.CosmosDB
{
    public partial class CosmosDBFirewallRuleResource : IJsonModel<CosmosDBFirewallRuleData>
    {
        ...
        {
            return ModelReaderWriter.Read<CosmosDBFirewallRuleData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<CosmosDBFirewallRuleData>(data, options);
        }
