...
namespace Azure.ResourceManager.CosmosDB
{
    internal partial class PercentileTargetRestOperations
    {
        ...
        public PercentileTargetRestOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-15")
        {
        ...
        internal HttpMessage CreateListMetricsRequest(string resourceGroupName, string accountName, string targetRegion, string filter)
        {
        ...
        public async Task<Response<PercentileMetricListResult>> ListMetricsAsync(string resourceGroupName, string accountName, string targetRegion, string filter, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateListMetricsRequest(resourceGroupName, accountName, targetRegion, filter);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="resourceGroupName"/>, <paramref name="accountName"/>, <paramref name="targetRegion"/>, or <paramref name="filter"/> is null. </exception>
        public Response<PercentileMetricListResult> ListMetrics(string resourceGroupName, string accountName, string targetRegion, string filter, CancellationToken cancellationToken = default)
        {
            if (resourceGroupName == null)
            {
                throw new ArgumentNullException(nameof(resourceGroupName));
