...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class GremlinDatabase : ArmResource
    {
        ...
        public async virtual Task<Response<GremlinDatabase>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _gremlinResourcesRestClient.GetGremlinDatabaseAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GremlinDatabase> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _gremlinResourcesRestClient.GetGremlinDatabase(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
        ...
        public async virtual Task<GremlinResourceDeleteGremlinDatabaseOperation> DeleteAsync(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _gremlinResourcesRestClient.DeleteGremlinDatabaseAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new GremlinResourceDeleteGremlinDatabaseOperation(_clientDiagnostics, Pipeline, _gremlinResourcesRestClient.CreateDeleteGremlinDatabaseRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
        ...
        public virtual GremlinResourceDeleteGremlinDatabaseOperation Delete(bool waitForCompletion = true, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _gremlinResourcesRestClient.DeleteGremlinDatabase(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new GremlinResourceDeleteGremlinDatabaseOperation(_clientDiagnostics, Pipeline, _gremlinResourcesRestClient.CreateDeleteGremlinDatabaseRequest(Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response);
                if (waitForCompletion)
        ...
        public async virtual Task<Response<GremlinDatabase>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = await _gremlinResourcesRestClient.GetGremlinDatabaseAsync(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<GremlinDatabase> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var originalResponse = _gremlinResourcesRestClient.GetGremlinDatabase(Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                return Response.FromValue(new GremlinDatabase(this, originalResponse.Value), originalResponse.GetRawResponse());
            }
            catch (Exception e)
            {
        ...
        {
            return new DatabaseAccountGremlinDatabaseThroughputSetting(this, Id + "/throughputSettings/default");
        }
        #endregion
