...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class SqlContainerCollection : ArmCollection, IEnumerable<SqlContainerResource>, IAsyncEnumerable<SqlContainerResource>
    {
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> or <paramref name="info"/> is null. </exception>
        public virtual async Task<ArmOperation<SqlContainerResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string containerName, SqlContainerCreateOrUpdateInfo info, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _sqlContainerSqlResourcesRestClient.CreateUpdateSqlContainerAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, containerName, info, cancellationToken).ConfigureAwait(false);
                var operation = new CosmosDBArmOperation<SqlContainerResource>(new SqlContainerOperationSource(Client), _sqlContainerSqlResourcesClientDiagnostics, Pipeline, _sqlContainerSqlResourcesRestClient.CreateCreateUpdateSqlContainerRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, containerName, info).Request, response, OperationFinalStateVia.Location);
        ...
        /// <exception cref="ArgumentException"> <paramref name="containerName"/> is an empty string, and was expected to be non-empty. </exception>
        /// <exception cref="ArgumentNullException"> <paramref name="containerName"/> or <paramref name="info"/> is null. </exception>
        public virtual ArmOperation<SqlContainerResource> CreateOrUpdate(WaitUntil waitUntil, string containerName, SqlContainerCreateOrUpdateInfo info, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(containerName, nameof(containerName));
            Argument.AssertNotNull(info, nameof(info));
            ...
            try
            {
                var response = _sqlContainerSqlResourcesRestClient.CreateUpdateSqlContainer(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, containerName, info, cancellationToken);
                var operation = new CosmosDBArmOperation<SqlContainerResource>(new SqlContainerOperationSource(Client), _sqlContainerSqlResourcesClientDiagnostics, Pipeline, _sqlContainerSqlResourcesRestClient.CreateCreateUpdateSqlContainerRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, containerName, info).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
