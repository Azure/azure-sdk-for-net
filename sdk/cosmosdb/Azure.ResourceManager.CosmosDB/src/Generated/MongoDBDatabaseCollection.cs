...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBDatabaseCollection : ArmCollection, IEnumerable<MongoDBDatabase>, IAsyncEnumerable<MongoDBDatabase>
    {
        ...
        internal MongoDBDatabaseCollection(ArmResource parent) : base(parent)
        {
            ...
            ArmClient.TryGetApiVersion(MongoDBDatabase.ResourceType, out string mongoDBDatabaseMongoDBResourcesApiVersion);
        ...
        public virtual MongoDBDatabaseCreateOrUpdateOperation CreateOrUpdate(bool waitForCompletion, string databaseName, MongoDBDatabaseCreateUpdateOptions createUpdateMongoDBDatabaseParameters, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                var operation = new MongoDBDatabaseCreateOrUpdateOperation(ArmClient, _mongoDBDatabaseMongoDBResourcesClientDiagnostics, Pipeline, _mongoDBDatabaseMongoDBResourcesRestClient.CreateCreateUpdateMongoDBDatabaseRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Name, databaseName, createUpdateMongoDBDatabaseParameters).Request, response);
        ...
        public virtual Response<MongoDBDatabase> Get(string databaseName, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new MongoDBDatabase(ArmClient, response.Value), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual Pageable<MongoDBDatabase> GetAll(CancellationToken cancellationToken = default)
        {
            Page<MongoDBDatabase> FirstPageFunc(int? pageSizeHint)
            {
                ...
                try
                {
                    ...
                    return Page.FromValues(response.Value.Value.Select(value => new MongoDBDatabase(ArmClient, value)), null, response.GetRawResponse());
                }
                catch (Exception e)
                {
                    scope.Failed(e);
