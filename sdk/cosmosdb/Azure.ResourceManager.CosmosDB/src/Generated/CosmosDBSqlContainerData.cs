...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlContainerData : ResourceData
    {
        ...
        internal CosmosDBSqlContainerData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CosmosDBSqlContainerProperties properties, IDictionary<string, string> tags, string location, Models.ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
        ...
        internal CosmosDBSqlContainerProperties Properties { get; }
