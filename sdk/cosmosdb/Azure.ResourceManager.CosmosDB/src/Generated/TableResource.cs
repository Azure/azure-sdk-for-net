...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="TableGetResultsResource"/> using the GetTableResource method.
    /// </summary>
    public partial class TableResource : ArmResource
    {
        ...
        internal TableResource(ArmClient client, ThroughputSettingsGetResultsData data) : this(client, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        /// <param name="content"> The parameters to provide for the RUs per second of the current Table. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual async Task<ArmOperation<TableResource>> CreateOrUpdateAsync(WaitUntil waitUntil, ThroughputSettingsUpdateParameters content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                HttpMessage message = _tableResourcesRestClient.CreateUpdateTableThroughputRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Parent.Parent.Name, Id.Parent.Name, ThroughputSettingsUpdateParameters.ToRequestContent(content), context);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <exception cref="ArgumentNullException"> <paramref name="content"/> is null. </exception>
        public virtual ArmOperation<TableResource> CreateOrUpdate(WaitUntil waitUntil, ThroughputSettingsUpdateParameters content, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNull(content, nameof(content));
