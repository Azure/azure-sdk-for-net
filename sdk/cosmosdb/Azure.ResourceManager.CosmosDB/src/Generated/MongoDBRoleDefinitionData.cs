...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBRoleDefinitionData : ResourceData
    {
        ...
        internal MongoDBRoleDefinitionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, MongoRoleDefinitionResource properties) : base(id, name, resourceType, systemData)
        {
