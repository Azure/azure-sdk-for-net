...
namespace Azure.ResourceManager.CosmosDB
{
    public partial class GremlinDatabaseResource : IJsonModel<GremlinDatabaseData>
    {
        ...
        {
            return ModelReaderWriter.Read<GremlinDatabaseData>(new BinaryData(reader.ValueSequence), options);
        }
        ...
        {
            return ModelReaderWriter.Read<GremlinDatabaseData>(data, options);
        }
