...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class ClusterResourceData : ResourceData
    {
        ...
        internal ClusterResourceData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, ClusterResourceProperties properties, IDictionary<string, string> tags, string location, ManagedCassandraManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
