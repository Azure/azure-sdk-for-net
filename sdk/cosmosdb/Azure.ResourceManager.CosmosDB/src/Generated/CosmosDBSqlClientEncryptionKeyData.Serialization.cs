...
namespace Azure.ResourceManager.CosmosDB
{
    public partial class CosmosDBSqlClientEncryptionKeyData : IUtf8JsonSerializable, IJsonModel<CosmosDBSqlClientEncryptionKeyData>
    {
        ...
        void IJsonModel<CosmosDBSqlClientEncryptionKeyData>.Write(Utf8JsonWriter writer, ModelReaderWriterOptions options)
        {
            ...
            if (format != "J")
            {
                throw new FormatException($"The model {nameof(CosmosDBSqlClientEncryptionKeyData)} does not support '{format}' format.");
            }
        ...
        BinaryData IPersistableModel<CosmosDBSqlClientEncryptionKeyData>.Write(ModelReaderWriterOptions options)
        {
            ...
            switch (format)
            {
                ...
                default:
                    throw new FormatException($"The model {nameof(CosmosDBSqlClientEncryptionKeyData)} does not support '{options.Format}' format.");
            }
        }
