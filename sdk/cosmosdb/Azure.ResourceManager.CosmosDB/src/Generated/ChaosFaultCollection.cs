...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    /// To get a <see cref="ChaosFaultCollection"/> instance call the GetChaosFaults method from an instance of <see cref="CosmosDBAccountResource"/>.
    /// </summary>
    public partial class ChaosFaultCollection : ArmCollection, IEnumerable<ChaosFaultResource>, IAsyncEnumerable<ChaosFaultResource>
    {
        private readonly ClientDiagnostics _chaosFaultClientDiagnostics;
        private readonly ChaosFault _chaosFaultRestClient;

        /// <summary> Initializes a new instance of ChaosFaultCollection for mocking. </summary>
        protected ChaosFaultCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="ChaosFaultCollection"/> class. </summary>
        /// <param name="client"> The client parameters to use in these operations. </param>
        /// <param name="id"> The identifier of the resource that is the target of operations. </param>
        internal ChaosFaultCollection(ArmClient client, ResourceIdentifier id) : base(client, id)
        {
        ...
        public virtual async Task<ArmOperation<ChaosFaultResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string chaosFault, ChaosFaultData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(chaosFault, nameof(chaosFault));
            Argument.AssertNotNull(data, nameof(data));

            using DiagnosticScope scope = _chaosFaultClientDiagnostics.CreateScope("ChaosFaultCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _chaosFaultRestClient.CreateEnableDisableRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, chaosFault, ChaosFaultData.ToRequestContent(data), context);
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="chaosFault"/> or <paramref name="data"/> is null. </exception>
        /// <exception cref="ArgumentException"> <paramref name="chaosFault"/> is an empty string, and was expected to be non-empty. </exception>
        public virtual ArmOperation<ChaosFaultResource> CreateOrUpdate(WaitUntil waitUntil, string chaosFault, ChaosFaultData data, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(chaosFault, nameof(chaosFault));
            Argument.AssertNotNull(data, nameof(data));
        ...
        public virtual async Task<Response<ChaosFaultResource>> GetAsync(string chaosFault, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _chaosFaultClientDiagnostics.CreateScope("ChaosFaultCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<ChaosFaultData> response = Response.FromValue(ChaosFaultData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<ChaosFaultResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<ChaosFaultData, ChaosFaultResource>(new ChaosFaultGetAllAsyncCollectionResultOfT(
                ...
                Id.Name,
                context,
                "ChaosFaultCollection.GetAll"), data => new ChaosFaultResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string chaosFault, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _chaosFaultClientDiagnostics.CreateScope("ChaosFaultCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<ChaosFaultData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(ChaosFaultData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((ChaosFaultData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<ChaosFaultResource>> GetIfExistsAsync(string chaosFault, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _chaosFaultClientDiagnostics.CreateScope("ChaosFaultCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
