...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlUserDefinedFunctionData : TrackedResourceData, IJsonModel<CosmosDBSqlUserDefinedFunctionData>
    {
        ...
        {
            string format = options.Format == "W" ? ((IPersistableModel<CosmosDBSqlUserDefinedFunctionData>)this).GetFormatFromOptions(options) : options.Format;
            switch (format)
            {
                case "J":
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        BinaryData IPersistableModel<CosmosDBSqlUserDefinedFunctionData>.Write(ModelReaderWriterOptions options) => PersistableModelWriteCore(options);

        /// <param name="data"> The data to parse. </param>
        /// <param name="options"> The client options for reading and writing models. </param>
        CosmosDBSqlUserDefinedFunctionData IPersistableModel<CosmosDBSqlUserDefinedFunctionData>.Create(BinaryData data, ModelReaderWriterOptions options) => (CosmosDBSqlUserDefinedFunctionData)PersistableModelCreateCore(data, options);

        /// <param name="options"> The client options for reading and writing models. </param>
        string IPersistableModel<CosmosDBSqlUserDefinedFunctionData>.GetFormatFromOptions(ModelReaderWriterOptions options) => "J";

        /// <param name="response"> The <see cref="Response"/> to deserialize the <see cref="CosmosDBSqlUserDefinedFunctionData"/> from. </param>
        internal static CosmosDBSqlUserDefinedFunctionData FromResponse(Response response)
        {
            using JsonDocument document = JsonDocument.Parse(response.Content, ModelSerializationExtensions.JsonDocumentOptions);
            return DeserializeCosmosDBSqlUserDefinedFunctionData(document.RootElement, ModelSerializationExtensions.WireOptions);
        }
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        CosmosDBSqlUserDefinedFunctionData IJsonModel<CosmosDBSqlUserDefinedFunctionData>.Create(ref Utf8JsonReader reader, ModelReaderWriterOptions options) => (CosmosDBSqlUserDefinedFunctionData)JsonModelCreateCore(ref reader, options);
        ...
        /// <param name="options"> The client options for reading and writing models. </param>
        internal static CosmosDBSqlUserDefinedFunctionData DeserializeCosmosDBSqlUserDefinedFunctionData(JsonElement element, ModelReaderWriterOptions options)
        {
            ...
            CosmosDBSqlUserDefinedFunctionProperties properties = default;
            ...
            foreach (var prop in element.EnumerateObject())
            {
                ...
                if (prop.NameEquals("properties"u8))
                {
                    ...
                    properties = CosmosDBSqlUserDefinedFunctionProperties.DeserializeCosmosDBSqlUserDefinedFunctionProperties(prop.Value, options);
                    continue;
                }
