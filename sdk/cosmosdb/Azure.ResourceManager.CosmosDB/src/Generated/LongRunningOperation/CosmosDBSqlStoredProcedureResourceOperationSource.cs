...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlStoredProcedureResourceOperationSource : IOperationSource<CosmosDBSqlStoredProcedureResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBSqlStoredProcedureResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
