...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DatabaseAccountTableThroughputSettingMigrateTableToManualThroughputOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of DatabaseAccountTableThroughputSettingMigrateTableToManualThroughputOperation for mocking. </summary>
        protected DatabaseAccountTableThroughputSettingMigrateTableToManualThroughputOperation()
        {
        }

        internal DatabaseAccountTableThroughputSettingMigrateTableToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DatabaseAccountTableThroughputSettingMigrateTableToManualThroughputOperation");
        }
