...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlResourceMigrateSqlDatabaseToAutoscaleOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of SqlResourceMigrateSqlDatabaseToAutoscaleOperation for mocking. </summary>
        protected SqlResourceMigrateSqlDatabaseToAutoscaleOperation()
        {
        }

        internal SqlResourceMigrateSqlDatabaseToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlResourceMigrateSqlDatabaseToAutoscaleOperation");
        }
