...
{
    /// <summary></summary>
    internal partial class CosmosDBTableRoleAssignmentOperationSource : IOperationSource<CosmosDBTableRoleAssignmentResource>
    {
        ...
        CosmosDBTableRoleAssignmentResource IOperationSource<CosmosDBTableRoleAssignmentResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CosmosDBTableRoleAssignmentData data = CosmosDBTableRoleAssignmentData.DeserializeCosmosDBTableRoleAssignmentData(document.RootElement, ModelSerializationExtensions.WireOptions);
