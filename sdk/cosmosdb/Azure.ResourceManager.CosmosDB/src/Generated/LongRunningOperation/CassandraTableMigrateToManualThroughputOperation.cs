...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraTableMigrateToManualThroughputOperation : Operation<ThroughputSettings>, IOperationSource<ThroughputSettings>
    {
        private readonly OperationInternals<ThroughputSettings> _operation;

        /// <summary> Initializes a new instance of CassandraTableMigrateToManualThroughputOperation for mocking. </summary>
        protected CassandraTableMigrateToManualThroughputOperation()
        {
        }

        internal CassandraTableMigrateToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettings>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CassandraTableMigrateToManualThroughputOperation");
        }
