...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DatabaseAccountSqlDatabaseContainerThroughputSettingMigrateSqlContainerToAutoscaleOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of DatabaseAccountSqlDatabaseContainerThroughputSettingMigrateSqlContainerToAutoscaleOperation for mocking. </summary>
        protected DatabaseAccountSqlDatabaseContainerThroughputSettingMigrateSqlContainerToAutoscaleOperation()
        {
        }

        internal DatabaseAccountSqlDatabaseContainerThroughputSettingMigrateSqlContainerToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DatabaseAccountSqlDatabaseContainerThroughputSettingMigrateSqlContainerToAutoscaleOperation");
        }
