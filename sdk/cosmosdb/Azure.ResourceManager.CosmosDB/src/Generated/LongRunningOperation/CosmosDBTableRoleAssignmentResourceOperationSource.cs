...
{
    /// <summary></summary>
    internal partial class CosmosDBTableRoleAssignmentResourceOperationSource : IOperationSource<CosmosDBTableRoleAssignmentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBTableRoleAssignmentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
