...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class TableResourceMigrateTableToManualThroughputOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of TableResourceMigrateTableToManualThroughputOperation for mocking. </summary>
        protected TableResourceMigrateTableToManualThroughputOperation()
        {
        }

        internal TableResourceMigrateTableToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "TableResourceMigrateTableToManualThroughputOperation");
        }
