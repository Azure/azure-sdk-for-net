...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinResourceMigrateGremlinDatabaseToAutoscaleOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of GremlinResourceMigrateGremlinDatabaseToAutoscaleOperation for mocking. </summary>
        protected GremlinResourceMigrateGremlinDatabaseToAutoscaleOperation()
        {
        }

        internal GremlinResourceMigrateGremlinDatabaseToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "GremlinResourceMigrateGremlinDatabaseToAutoscaleOperation");
        }
