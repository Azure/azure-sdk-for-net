...
{
    /// <summary></summary>
    internal partial class GremlinDatabaseResourceOperationSource : IOperationSource<GremlinDatabaseResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal GremlinDatabaseResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
