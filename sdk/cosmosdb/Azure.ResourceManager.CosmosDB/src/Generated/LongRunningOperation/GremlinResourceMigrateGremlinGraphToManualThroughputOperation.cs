...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinResourceMigrateGremlinGraphToManualThroughputOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of GremlinResourceMigrateGremlinGraphToManualThroughputOperation for mocking. </summary>
        protected GremlinResourceMigrateGremlinGraphToManualThroughputOperation()
        {
        }

        internal GremlinResourceMigrateGremlinGraphToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "GremlinResourceMigrateGremlinGraphToManualThroughputOperation");
        }
