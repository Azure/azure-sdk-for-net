...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlStoredProcedureOperationSource : IOperationSource<CosmosDBSqlStoredProcedureResource>
    {
        ...
        CosmosDBSqlStoredProcedureResource IOperationSource<CosmosDBSqlStoredProcedureResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CosmosDBSqlStoredProcedureData data = CosmosDBSqlStoredProcedureData.DeserializeCosmosDBSqlStoredProcedureData(document.RootElement, ModelSerializationExtensions.WireOptions);
