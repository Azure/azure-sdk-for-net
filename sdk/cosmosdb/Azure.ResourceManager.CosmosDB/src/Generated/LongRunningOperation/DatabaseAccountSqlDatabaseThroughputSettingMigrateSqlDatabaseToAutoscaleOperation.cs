...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DatabaseAccountSqlDatabaseThroughputSettingMigrateSqlDatabaseToAutoscaleOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of DatabaseAccountSqlDatabaseThroughputSettingMigrateSqlDatabaseToAutoscaleOperation for mocking. </summary>
        protected DatabaseAccountSqlDatabaseThroughputSettingMigrateSqlDatabaseToAutoscaleOperation()
        {
        }

        internal DatabaseAccountSqlDatabaseThroughputSettingMigrateSqlDatabaseToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DatabaseAccountSqlDatabaseThroughputSettingMigrateSqlDatabaseToAutoscaleOperation");
        }
