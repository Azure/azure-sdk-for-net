...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlResourceMigrateSqlContainerToManualThroughputOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of SqlResourceMigrateSqlContainerToManualThroughputOperation for mocking. </summary>
        protected SqlResourceMigrateSqlContainerToManualThroughputOperation()
        {
        }

        internal SqlResourceMigrateSqlContainerToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlResourceMigrateSqlContainerToManualThroughputOperation");
        }
