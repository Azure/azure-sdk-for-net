...
{
    /// <summary></summary>
    internal partial class CassandraTableResourceOperationSource : IOperationSource<CassandraTableResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CassandraTableResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        CassandraTableResource IOperationSource<CassandraTableResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CassandraTableData data = CassandraTableData.DeserializeCassandraTableData(document.RootElement, ModelSerializationExtensions.WireOptions);
