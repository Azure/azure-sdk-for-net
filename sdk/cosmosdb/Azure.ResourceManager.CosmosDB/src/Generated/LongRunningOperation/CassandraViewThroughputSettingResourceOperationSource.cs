...
{
    /// <summary></summary>
    internal partial class CassandraViewThroughputSettingResourceOperationSource : IOperationSource<CassandraViewThroughputSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CassandraViewThroughputSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
