...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraResourceMigrateCassandraKeyspaceToAutoscaleOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of CassandraResourceMigrateCassandraKeyspaceToAutoscaleOperation for mocking. </summary>
        protected CassandraResourceMigrateCassandraKeyspaceToAutoscaleOperation()
        {
        }

        internal CassandraResourceMigrateCassandraKeyspaceToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CassandraResourceMigrateCassandraKeyspaceToAutoscaleOperation");
        }
