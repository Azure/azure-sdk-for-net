...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBResourceMigrateMongoDBDatabaseToManualThroughputOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of MongoDBResourceMigrateMongoDBDatabaseToManualThroughputOperation for mocking. </summary>
        protected MongoDBResourceMigrateMongoDBDatabaseToManualThroughputOperation()
        {
        }

        internal MongoDBResourceMigrateMongoDBDatabaseToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBResourceMigrateMongoDBDatabaseToManualThroughputOperation");
        }
