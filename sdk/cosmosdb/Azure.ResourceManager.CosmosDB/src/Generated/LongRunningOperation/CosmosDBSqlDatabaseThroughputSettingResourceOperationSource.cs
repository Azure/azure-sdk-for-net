...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlDatabaseThroughputSettingResourceOperationSource : IOperationSource<CosmosDBSqlDatabaseThroughputSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBSqlDatabaseThroughputSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
