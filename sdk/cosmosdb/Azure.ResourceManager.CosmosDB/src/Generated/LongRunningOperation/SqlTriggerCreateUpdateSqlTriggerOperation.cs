...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlTriggerCreateUpdateSqlTriggerOperation : Operation<SqlTrigger>, IOperationSource<SqlTrigger>
    {
        private readonly OperationInternals<SqlTrigger> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of SqlTriggerCreateUpdateSqlTriggerOperation for mocking. </summary>
        protected SqlTriggerCreateUpdateSqlTriggerOperation()
        {
        }

        internal SqlTriggerCreateUpdateSqlTriggerOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SqlTrigger>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlTriggerCreateUpdateSqlTriggerOperation");
