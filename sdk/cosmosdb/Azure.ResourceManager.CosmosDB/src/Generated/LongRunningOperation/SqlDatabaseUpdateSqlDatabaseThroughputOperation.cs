...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlDatabaseUpdateSqlDatabaseThroughputOperation : Operation<ThroughputSettings>, IOperationSource<ThroughputSettings>
    {
        private readonly OperationInternals<ThroughputSettings> _operation;

        /// <summary> Initializes a new instance of SqlDatabaseUpdateSqlDatabaseThroughputOperation for mocking. </summary>
        protected SqlDatabaseUpdateSqlDatabaseThroughputOperation()
        {
        }

        internal SqlDatabaseUpdateSqlDatabaseThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettings>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlDatabaseUpdateSqlDatabaseThroughputOperation");
        }
