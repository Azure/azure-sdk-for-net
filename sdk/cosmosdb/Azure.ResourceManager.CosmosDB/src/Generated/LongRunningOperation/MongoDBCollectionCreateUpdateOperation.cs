...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionCreateUpdateOperation : Operation<MongoDBCollection>, IOperationSource<MongoDBCollection>
    {
        private readonly OperationInternals<MongoDBCollection> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of MongoDBCollectionCreateUpdateOperation for mocking. </summary>
        protected MongoDBCollectionCreateUpdateOperation()
        {
        }

        internal MongoDBCollectionCreateUpdateOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<MongoDBCollection>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBCollectionCreateUpdateOperation");
