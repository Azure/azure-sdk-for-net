...
{
    /// <summary></summary>
    internal partial class CosmosDBTableRoleDefinitionOperationSource : IOperationSource<CosmosDBTableRoleDefinitionResource>
    {
        ...
        CosmosDBTableRoleDefinitionResource IOperationSource<CosmosDBTableRoleDefinitionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CosmosDBTableRoleDefinitionData data = CosmosDBTableRoleDefinitionData.DeserializeCosmosDBTableRoleDefinitionData(document.RootElement, ModelSerializationExtensions.WireOptions);
