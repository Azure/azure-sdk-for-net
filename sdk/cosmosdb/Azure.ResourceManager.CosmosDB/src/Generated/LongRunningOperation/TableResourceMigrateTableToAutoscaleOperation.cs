...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class TableResourceMigrateTableToAutoscaleOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of TableResourceMigrateTableToAutoscaleOperation for mocking. </summary>
        protected TableResourceMigrateTableToAutoscaleOperation()
        {
        }

        internal TableResourceMigrateTableToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "TableResourceMigrateTableToAutoscaleOperation");
        }
