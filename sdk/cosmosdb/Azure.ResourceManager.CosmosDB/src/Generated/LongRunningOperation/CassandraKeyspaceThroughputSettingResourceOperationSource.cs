...
{
    /// <summary></summary>
    internal partial class CassandraKeyspaceThroughputSettingResourceOperationSource : IOperationSource<CassandraKeyspaceThroughputSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CassandraKeyspaceThroughputSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
