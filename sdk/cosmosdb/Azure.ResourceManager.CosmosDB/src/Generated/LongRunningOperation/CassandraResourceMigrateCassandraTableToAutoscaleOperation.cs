...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraResourceMigrateCassandraTableToAutoscaleOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of CassandraResourceMigrateCassandraTableToAutoscaleOperation for mocking. </summary>
        protected CassandraResourceMigrateCassandraTableToAutoscaleOperation()
        {
        }

        internal CassandraResourceMigrateCassandraTableToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CassandraResourceMigrateCassandraTableToAutoscaleOperation");
        }
