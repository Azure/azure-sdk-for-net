...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlContainerMigrateSqlContainerToAutoscaleOperation : Operation<ThroughputSettings>, IOperationSource<ThroughputSettings>
    {
        private readonly OperationInternals<ThroughputSettings> _operation;

        /// <summary> Initializes a new instance of SqlContainerMigrateSqlContainerToAutoscaleOperation for mocking. </summary>
        protected SqlContainerMigrateSqlContainerToAutoscaleOperation()
        {
        }

        internal SqlContainerMigrateSqlContainerToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettings>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlContainerMigrateSqlContainerToAutoscaleOperation");
        }
