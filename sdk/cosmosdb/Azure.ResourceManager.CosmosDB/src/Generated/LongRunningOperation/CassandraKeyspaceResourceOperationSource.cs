...
{
    /// <summary></summary>
    internal partial class CassandraKeyspaceResourceOperationSource : IOperationSource<CassandraKeyspaceResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CassandraKeyspaceResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        CassandraKeyspaceResource IOperationSource<CassandraKeyspaceResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CassandraKeyspaceData data = CassandraKeyspaceData.DeserializeCassandraKeyspaceData(document.RootElement, ModelSerializationExtensions.WireOptions);
