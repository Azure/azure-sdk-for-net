...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlDatabaseMigrateSqlDatabaseToManualThroughputOperation : Operation<ThroughputSettings>, IOperationSource<ThroughputSettings>
    {
        private readonly OperationInternals<ThroughputSettings> _operation;

        /// <summary> Initializes a new instance of SqlDatabaseMigrateSqlDatabaseToManualThroughputOperation for mocking. </summary>
        protected SqlDatabaseMigrateSqlDatabaseToManualThroughputOperation()
        {
        }

        internal SqlDatabaseMigrateSqlDatabaseToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettings>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlDatabaseMigrateSqlDatabaseToManualThroughputOperation");
        }
