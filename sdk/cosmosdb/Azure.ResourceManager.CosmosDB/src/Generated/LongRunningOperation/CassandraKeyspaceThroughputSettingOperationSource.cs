...
namespace Azure.ResourceManager.CosmosDB
{
    internal class CassandraKeyspaceThroughputSettingOperationSource : IOperationSource<CassandraKeyspaceThroughputSettingResource>
    {
        ...
        {
            if (data.Id.ResourceType == CassandraKeyspaceThroughputSettingResource.ResourceType)
                return data;

            var newId = CassandraKeyspaceThroughputSettingResource.CreateResourceIdentifier(
