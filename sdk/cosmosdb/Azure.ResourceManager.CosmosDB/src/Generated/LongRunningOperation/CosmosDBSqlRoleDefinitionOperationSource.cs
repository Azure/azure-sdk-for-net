...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlRoleDefinitionOperationSource : IOperationSource<CosmosDBSqlRoleDefinitionResource>
    {
        ...
        CosmosDBSqlRoleDefinitionResource IOperationSource<CosmosDBSqlRoleDefinitionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CosmosDBSqlRoleDefinitionData data = CosmosDBSqlRoleDefinitionData.DeserializeCosmosDBSqlRoleDefinitionData(document.RootElement, ModelSerializationExtensions.WireOptions);
