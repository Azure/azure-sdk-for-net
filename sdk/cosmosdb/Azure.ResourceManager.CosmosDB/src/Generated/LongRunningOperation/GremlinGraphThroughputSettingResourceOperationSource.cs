...
{
    /// <summary></summary>
    internal partial class GremlinGraphThroughputSettingResourceOperationSource : IOperationSource<GremlinGraphThroughputSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal GremlinGraphThroughputSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
