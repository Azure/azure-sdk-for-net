...
{
    /// <summary></summary>
    internal partial class CassandraDataCenterResourceOperationSource : IOperationSource<CassandraDataCenterResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CassandraDataCenterResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
