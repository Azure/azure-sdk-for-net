...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlClientEncryptionKeyResourceOperationSource : IOperationSource<CosmosDBSqlClientEncryptionKeyResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBSqlClientEncryptionKeyResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
