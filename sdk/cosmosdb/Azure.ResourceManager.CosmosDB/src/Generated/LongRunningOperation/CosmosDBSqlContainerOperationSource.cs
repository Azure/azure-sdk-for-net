...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlContainerOperationSource : IOperationSource<CosmosDBSqlContainerResource>
    {
        ...
        CosmosDBSqlContainerResource IOperationSource<CosmosDBSqlContainerResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CosmosDBSqlContainerData data = CosmosDBSqlContainerData.DeserializeCosmosDBSqlContainerData(document.RootElement, ModelSerializationExtensions.WireOptions);
