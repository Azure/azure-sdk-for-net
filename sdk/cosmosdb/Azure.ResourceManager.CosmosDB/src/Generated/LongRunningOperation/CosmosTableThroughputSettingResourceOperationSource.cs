...
{
    /// <summary></summary>
    internal partial class CosmosTableThroughputSettingResourceOperationSource : IOperationSource<CosmosTableThroughputSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosTableThroughputSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
