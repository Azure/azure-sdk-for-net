...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlDatabaseResourceOperationSource : IOperationSource<CosmosDBSqlDatabaseResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBSqlDatabaseResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        CosmosDBSqlDatabaseResource IOperationSource<CosmosDBSqlDatabaseResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CosmosDBSqlDatabaseData data = CosmosDBSqlDatabaseData.DeserializeCosmosDBSqlDatabaseData(document.RootElement, ModelSerializationExtensions.WireOptions);
