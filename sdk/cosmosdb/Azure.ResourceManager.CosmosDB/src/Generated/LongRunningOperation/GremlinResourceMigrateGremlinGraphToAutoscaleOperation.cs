...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinResourceMigrateGremlinGraphToAutoscaleOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of GremlinResourceMigrateGremlinGraphToAutoscaleOperation for mocking. </summary>
        protected GremlinResourceMigrateGremlinGraphToAutoscaleOperation()
        {
        }

        internal GremlinResourceMigrateGremlinGraphToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "GremlinResourceMigrateGremlinGraphToAutoscaleOperation");
        }
