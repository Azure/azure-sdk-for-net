...
{
    /// <summary></summary>
    internal partial class MongoDBUserDefinitionResourceOperationSource : IOperationSource<MongoDBUserDefinitionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MongoDBUserDefinitionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
