...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBResourceUpdateMongoDBDatabaseThroughputOperation : Operation<ThroughputSettings>, IOperationSource<ThroughputSettings>
    {
        ...
        internal MongoDBResourceUpdateMongoDBDatabaseThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettings>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBResourceUpdateMongoDBDatabaseThroughputOperation");
        }
