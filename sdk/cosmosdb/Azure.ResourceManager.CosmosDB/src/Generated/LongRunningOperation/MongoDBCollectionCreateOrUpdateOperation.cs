...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionCreateOrUpdateOperation : Operation<MongoDBCollection>, IOperationSource<MongoDBCollection>
    {
        private readonly OperationInternals<MongoDBCollection> _operation;

        private readonly ArmClient _armClient;

        /// <summary> Initializes a new instance of MongoDBCollectionCreateOrUpdateOperation for mocking. </summary>
        protected MongoDBCollectionCreateOrUpdateOperation()
        {
        }

        internal MongoDBCollectionCreateOrUpdateOperation(ArmClient armClient, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<MongoDBCollection>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBCollectionCreateOrUpdateOperation");
        ...
        MongoDBCollection IOperationSource<MongoDBCollection>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            return new MongoDBCollection(_armClient, data);
        }
