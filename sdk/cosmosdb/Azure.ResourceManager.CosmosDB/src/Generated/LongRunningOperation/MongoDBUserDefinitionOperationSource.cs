...
{
    /// <summary></summary>
    internal partial class MongoDBUserDefinitionOperationSource : IOperationSource<MongoDBUserDefinitionResource>
    {
        ...
        MongoDBUserDefinitionResource IOperationSource<MongoDBUserDefinitionResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            MongoDBUserDefinitionData data = MongoDBUserDefinitionData.DeserializeMongoDBUserDefinitionData(document.RootElement, ModelSerializationExtensions.WireOptions);
