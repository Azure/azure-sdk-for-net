...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlContainerResourceOperationSource : IOperationSource<CosmosDBSqlContainerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBSqlContainerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
