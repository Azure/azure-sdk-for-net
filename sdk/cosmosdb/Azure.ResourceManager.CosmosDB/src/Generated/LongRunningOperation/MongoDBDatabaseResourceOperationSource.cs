...
{
    /// <summary></summary>
    internal partial class MongoDBDatabaseResourceOperationSource : IOperationSource<MongoDBDatabaseResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MongoDBDatabaseResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
