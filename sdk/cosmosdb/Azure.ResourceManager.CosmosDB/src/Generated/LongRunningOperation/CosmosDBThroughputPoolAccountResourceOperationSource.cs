...
{
    /// <summary></summary>
    internal partial class CosmosDBThroughputPoolAccountResourceOperationSource : IOperationSource<CosmosDBThroughputPoolAccountResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBThroughputPoolAccountResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
