...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlContainerThroughputSettingResourceOperationSource : IOperationSource<CosmosDBSqlContainerThroughputSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBSqlContainerThroughputSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
