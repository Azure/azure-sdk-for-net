...
{
    /// <summary></summary>
    internal partial class CosmosDBPrivateEndpointConnectionResourceOperationSource : IOperationSource<CosmosDBPrivateEndpointConnectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBPrivateEndpointConnectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
