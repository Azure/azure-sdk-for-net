...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraResourceMigrateCassandraTableToManualThroughputOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of CassandraResourceMigrateCassandraTableToManualThroughputOperation for mocking. </summary>
        protected CassandraResourceMigrateCassandraTableToManualThroughputOperation()
        {
        }

        internal CassandraResourceMigrateCassandraTableToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CassandraResourceMigrateCassandraTableToManualThroughputOperation");
        }
