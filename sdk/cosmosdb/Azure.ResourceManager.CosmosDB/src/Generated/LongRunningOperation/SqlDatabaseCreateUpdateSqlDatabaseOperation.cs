...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlDatabaseCreateUpdateSqlDatabaseOperation : Operation<SqlDatabase>, IOperationSource<SqlDatabase>
    {
        private readonly OperationInternals<SqlDatabase> _operation;

        private readonly ArmResource _operationBase;

        /// <summary> Initializes a new instance of SqlDatabaseCreateUpdateSqlDatabaseOperation for mocking. </summary>
        protected SqlDatabaseCreateUpdateSqlDatabaseOperation()
        {
        }

        internal SqlDatabaseCreateUpdateSqlDatabaseOperation(ArmResource operationsBase, ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<SqlDatabase>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlDatabaseCreateUpdateSqlDatabaseOperation");
