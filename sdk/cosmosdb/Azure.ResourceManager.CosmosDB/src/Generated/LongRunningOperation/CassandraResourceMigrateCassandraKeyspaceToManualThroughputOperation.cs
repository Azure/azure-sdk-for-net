...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class CassandraResourceMigrateCassandraKeyspaceToManualThroughputOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of CassandraResourceMigrateCassandraKeyspaceToManualThroughputOperation for mocking. </summary>
        protected CassandraResourceMigrateCassandraKeyspaceToManualThroughputOperation()
        {
        }

        internal CassandraResourceMigrateCassandraKeyspaceToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "CassandraResourceMigrateCassandraKeyspaceToManualThroughputOperation");
        }
