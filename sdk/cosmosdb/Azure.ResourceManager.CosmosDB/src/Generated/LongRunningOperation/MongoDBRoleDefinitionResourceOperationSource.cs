...
{
    /// <summary></summary>
    internal partial class MongoDBRoleDefinitionResourceOperationSource : IOperationSource<MongoDBRoleDefinitionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MongoDBRoleDefinitionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
