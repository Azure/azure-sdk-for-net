...
{
    /// <summary></summary>
    internal partial class CosmosDBAccountResourceOperationSource : IOperationSource<CosmosDBAccountResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBAccountResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
