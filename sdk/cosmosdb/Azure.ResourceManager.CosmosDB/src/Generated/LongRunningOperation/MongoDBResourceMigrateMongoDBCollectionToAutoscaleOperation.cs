...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBResourceMigrateMongoDBCollectionToAutoscaleOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of MongoDBResourceMigrateMongoDBCollectionToAutoscaleOperation for mocking. </summary>
        protected MongoDBResourceMigrateMongoDBCollectionToAutoscaleOperation()
        {
        }

        internal MongoDBResourceMigrateMongoDBCollectionToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBResourceMigrateMongoDBCollectionToAutoscaleOperation");
        }
