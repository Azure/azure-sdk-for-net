...
{
    /// <summary></summary>
    internal partial class GremlinDatabaseThroughputSettingResourceOperationSource : IOperationSource<GremlinDatabaseThroughputSettingResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal GremlinDatabaseThroughputSettingResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
