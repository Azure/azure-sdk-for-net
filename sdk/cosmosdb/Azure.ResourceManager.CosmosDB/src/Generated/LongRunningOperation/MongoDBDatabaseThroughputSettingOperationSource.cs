...
{
    internal class MongoDBDatabaseThroughputSettingOperationSource : IOperationSource<MongoDBDatabaseThroughputSettingResource>
    {
        ...
        internal MongoDBDatabaseThroughputSettingOperationSource(ArmClient client)
        {
            _client = client;
        }
        ...
        private ThroughputSettingData ScrubId(ThroughputSettingData data)
        {
            ...
            var newId = MongoDBDatabaseThroughputSettingResource.CreateResourceIdentifier(
