...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlResourceMigrateSqlDatabaseToManualThroughputOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of SqlResourceMigrateSqlDatabaseToManualThroughputOperation for mocking. </summary>
        protected SqlResourceMigrateSqlDatabaseToManualThroughputOperation()
        {
        }

        internal SqlResourceMigrateSqlDatabaseToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlResourceMigrateSqlDatabaseToManualThroughputOperation");
        }
