...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlDatabaseMigrateSqlDatabaseToAutoscaleOperation : Operation<ThroughputSettings>, IOperationSource<ThroughputSettings>
    {
        private readonly OperationInternals<ThroughputSettings> _operation;

        /// <summary> Initializes a new instance of SqlDatabaseMigrateSqlDatabaseToAutoscaleOperation for mocking. </summary>
        protected SqlDatabaseMigrateSqlDatabaseToAutoscaleOperation()
        {
        }

        internal SqlDatabaseMigrateSqlDatabaseToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettings>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlDatabaseMigrateSqlDatabaseToAutoscaleOperation");
        }
