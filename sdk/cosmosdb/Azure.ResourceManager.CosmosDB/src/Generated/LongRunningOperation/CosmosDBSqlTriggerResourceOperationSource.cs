...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlTriggerResourceOperationSource : IOperationSource<CosmosDBSqlTriggerResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBSqlTriggerResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
