...
{
    /// <summary></summary>
    internal partial class CosmosDBThroughputPoolResourceOperationSource : IOperationSource<CosmosDBThroughputPoolResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBThroughputPoolResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
