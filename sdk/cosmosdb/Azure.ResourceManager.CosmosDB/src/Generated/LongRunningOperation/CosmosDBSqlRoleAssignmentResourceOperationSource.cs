...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlRoleAssignmentResourceOperationSource : IOperationSource<CosmosDBSqlRoleAssignmentResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBSqlRoleAssignmentResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
