...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlContainerUpdateSqlContainerThroughputOperation : Operation<ThroughputSettings>, IOperationSource<ThroughputSettings>
    {
        private readonly OperationInternals<ThroughputSettings> _operation;

        /// <summary> Initializes a new instance of SqlContainerUpdateSqlContainerThroughputOperation for mocking. </summary>
        protected SqlContainerUpdateSqlContainerThroughputOperation()
        {
        }

        internal SqlContainerUpdateSqlContainerThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettings>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlContainerUpdateSqlContainerThroughputOperation");
        }
