...
{
    /// <summary></summary>
    internal partial class CosmosDBTableResourceOperationSource : IOperationSource<CosmosDBTableResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBTableResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
