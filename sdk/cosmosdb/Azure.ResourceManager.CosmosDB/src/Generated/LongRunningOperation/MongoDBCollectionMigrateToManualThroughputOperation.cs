...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionMigrateToManualThroughputOperation : Operation<ThroughputSettings>, IOperationSource<ThroughputSettings>
    {
        private readonly OperationInternals<ThroughputSettings> _operation;

        /// <summary> Initializes a new instance of MongoDBCollectionMigrateToManualThroughputOperation for mocking. </summary>
        protected MongoDBCollectionMigrateToManualThroughputOperation()
        {
        }

        internal MongoDBCollectionMigrateToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettings>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBCollectionMigrateToManualThroughputOperation");
        }
