...
{
    /// <summary></summary>
    internal partial class CosmosDBTableRoleDefinitionResourceOperationSource : IOperationSource<CosmosDBTableRoleDefinitionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBTableRoleDefinitionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
