...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class DatabaseAccountTableThroughputSettingMigrateTableToAutoscaleOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of DatabaseAccountTableThroughputSettingMigrateTableToAutoscaleOperation for mocking. </summary>
        protected DatabaseAccountTableThroughputSettingMigrateTableToAutoscaleOperation()
        {
        }

        internal DatabaseAccountTableThroughputSettingMigrateTableToAutoscaleOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "DatabaseAccountTableThroughputSettingMigrateTableToAutoscaleOperation");
        }
