...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlRoleDefinitionResourceOperationSource : IOperationSource<CosmosDBSqlRoleDefinitionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBSqlRoleDefinitionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
