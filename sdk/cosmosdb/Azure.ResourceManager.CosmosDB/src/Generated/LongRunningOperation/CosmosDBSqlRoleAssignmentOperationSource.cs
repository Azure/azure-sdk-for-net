...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlRoleAssignmentOperationSource : IOperationSource<CosmosDBSqlRoleAssignmentResource>
    {
        ...
        CosmosDBSqlRoleAssignmentResource IOperationSource<CosmosDBSqlRoleAssignmentResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CosmosDBSqlRoleAssignmentData data = CosmosDBSqlRoleAssignmentData.DeserializeCosmosDBSqlRoleAssignmentData(document.RootElement, ModelSerializationExtensions.WireOptions);
