...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class GremlinResourceUpdateGremlinDatabaseThroughputOperation : Operation<ThroughputSettings>, IOperationSource<ThroughputSettings>
    {
        ...
        internal GremlinResourceUpdateGremlinDatabaseThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettings>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "GremlinResourceUpdateGremlinDatabaseThroughputOperation");
        }
