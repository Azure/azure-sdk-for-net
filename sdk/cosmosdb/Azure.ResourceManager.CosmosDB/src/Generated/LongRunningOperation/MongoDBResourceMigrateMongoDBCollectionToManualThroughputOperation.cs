...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBResourceMigrateMongoDBCollectionToManualThroughputOperation : Operation<ThroughputSettingsData>, IOperationSource<ThroughputSettingsData>
    {
        private readonly OperationInternals<ThroughputSettingsData> _operation;

        /// <summary> Initializes a new instance of MongoDBResourceMigrateMongoDBCollectionToManualThroughputOperation for mocking. </summary>
        protected MongoDBResourceMigrateMongoDBCollectionToManualThroughputOperation()
        {
        }

        internal MongoDBResourceMigrateMongoDBCollectionToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettingsData>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBResourceMigrateMongoDBCollectionToManualThroughputOperation");
        }
