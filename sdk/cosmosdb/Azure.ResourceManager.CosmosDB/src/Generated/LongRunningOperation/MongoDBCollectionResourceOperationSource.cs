...
{
    /// <summary></summary>
    internal partial class MongoDBCollectionResourceOperationSource : IOperationSource<MongoDBCollectionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal MongoDBCollectionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
