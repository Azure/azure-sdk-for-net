...
{
    /// <summary></summary>
    internal partial class CosmosDBSqlUserDefinedFunctionResourceOperationSource : IOperationSource<CosmosDBSqlUserDefinedFunctionResource>
    {
        private readonly ArmClient _client;

        /// <summary></summary>
        /// <param name="client"></param>
        internal CosmosDBSqlUserDefinedFunctionResourceOperationSource(ArmClient client)
        {
            _client = client;
        }
