...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class MongoDBCollectionUpdateThroughputOperation : Operation<ThroughputSettings>, IOperationSource<ThroughputSettings>
    {
        private readonly OperationInternals<ThroughputSettings> _operation;

        /// <summary> Initializes a new instance of MongoDBCollectionUpdateThroughputOperation for mocking. </summary>
        protected MongoDBCollectionUpdateThroughputOperation()
        {
        }

        internal MongoDBCollectionUpdateThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettings>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "MongoDBCollectionUpdateThroughputOperation");
        }
