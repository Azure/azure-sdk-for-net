...
{
    /// <summary></summary>
    internal partial class CosmosDBServiceResourceOperationSource : IOperationSource<CosmosDBServiceResource>
    {
        ...
        CosmosDBServiceResource IOperationSource<CosmosDBServiceResource>.CreateResult(Response response, CancellationToken cancellationToken)
        {
            ...
            CosmosDBServiceData data = CosmosDBServiceData.DeserializeCosmosDBServiceData(document.RootElement, ModelSerializationExtensions.WireOptions);
