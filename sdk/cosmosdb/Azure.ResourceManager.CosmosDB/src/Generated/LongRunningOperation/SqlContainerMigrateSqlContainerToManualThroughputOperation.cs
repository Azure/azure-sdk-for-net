...
namespace Azure.ResourceManager.CosmosDB.Models
{
    ...
    public partial class SqlContainerMigrateSqlContainerToManualThroughputOperation : Operation<ThroughputSettings>, IOperationSource<ThroughputSettings>
    {
        private readonly OperationInternals<ThroughputSettings> _operation;

        /// <summary> Initializes a new instance of SqlContainerMigrateSqlContainerToManualThroughputOperation for mocking. </summary>
        protected SqlContainerMigrateSqlContainerToManualThroughputOperation()
        {
        }

        internal SqlContainerMigrateSqlContainerToManualThroughputOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new OperationInternals<ThroughputSettings>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "SqlContainerMigrateSqlContainerToManualThroughputOperation");
        }
