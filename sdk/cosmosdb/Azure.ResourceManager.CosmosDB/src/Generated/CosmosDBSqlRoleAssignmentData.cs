...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlRoleAssignmentData : ResourceData
    {
        ...
        internal CosmosDBSqlRoleAssignmentData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, ResourceIdentifier roleDefinitionId, string scope, Guid? principalId, Dictionary<string, BinaryData> serializedAdditionalRawData) : base(id, name, resourceType, systemData)
        {
