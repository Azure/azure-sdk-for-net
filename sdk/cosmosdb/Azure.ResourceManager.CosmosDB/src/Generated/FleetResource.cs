...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    /// Otherwise you can get one from its parent resource <see cref="ResourceGroupResource"/> using the GetFleetResources method.
    /// </summary>
    public partial class FleetResource : ArmResource
    {
        ...
        {
            TryGetApiVersion(ResourceType, out string fleetResourceApiVersion);
        ...
        {
            using DiagnosticScope scope = _fleetClientDiagnostics.CreateScope("FleetResource.Get");
            scope.Start();
            try
            {
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual async Task<Response<FleetResource>> UpdateAsync(FleetResourcePatch patch = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _fleetClientDiagnostics.CreateScope("FleetResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                HttpMessage message = _fleetRestClient.CreateUpdateRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, FleetResourcePatch.ToRequestContent(patch), context);
                Response result = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                Response<FleetResourceData> response = Response.FromValue(FleetResourceData.FromResponse(result), result);
                if (response.Value == null)
                {
        ...
        /// <param name="patch"> The parameters to provide for the current fleet. </param>
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        public virtual Response<FleetResource> Update(FleetResourcePatch patch = default, CancellationToken cancellationToken = default)
        {
            using DiagnosticScope scope = _fleetClientDiagnostics.CreateScope("FleetResource.Update");
            scope.Start();
            try
        ...
        {
            using DiagnosticScope scope = _fleetClientDiagnostics.CreateScope("FleetResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<Response<FleetResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _fleetClientDiagnostics.CreateScope("FleetResource.AddTag");
            scope.Start();
            try
            {
                ...
                {
                    FleetResourceData current = (await GetAsync(cancellationToken: cancellationToken).ConfigureAwait(false)).Value.Data;
                    ...
                    Response<FleetResource> result = await UpdateAsync(patch, cancellationToken: cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<FleetResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                {
                    FleetResourceData current = Get(cancellationToken: cancellationToken).Value.Data;
                    FleetResourcePatch patch = new FleetResourcePatch();
                    foreach (KeyValuePair<string, string> tag in current.Tags)
                    {
                        patch.Tags.Add(tag);
                    ...
                    patch.Tags[key] = value;
                    Response<FleetResource> result = Update(patch, cancellationToken: cancellationToken);
                    return Response.FromValue(result.Value, result.GetRawResponse());
                }
            }
            catch (Exception e)
        ...
        public virtual async Task<Response<FleetResource>> SetTagsAsync(IDictionary<string, string> tags, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _fleetClientDiagnostics.CreateScope("FleetResource.SetTags");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        public virtual async Task<Response<FleetResource>> RemoveTagAsync(string key, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _fleetClientDiagnostics.CreateScope("FleetResource.RemoveTag");
            scope.Start();
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken).ConfigureAwait(false))
        ...
        /// <summary> Gets a collection of FleetAnalyticsResources in the <see cref="FleetResource"/>. </summary>
        /// <returns> An object representing collection of FleetAnalyticsResources and their operations over a FleetAnalyticsResource. </returns>
        public virtual FleetAnalyticsResourceCollection GetFleetAnalyticsResources()
        {
            return GetCachedClient(client => new FleetAnalyticsResourceCollection(client, Id));
        }
        ...
        [ForwardsClientCalls]
        public virtual async Task<Response<FleetAnalyticsResource>> GetFleetAnalyticsResourceAsync(string fleetAnalyticsName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(fleetAnalyticsName, nameof(fleetAnalyticsName));

            return await GetFleetAnalyticsResources().GetAsync(fleetAnalyticsName, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <exception cref="ArgumentException"> <paramref name="fleetAnalyticsName"/> is an empty string, and was expected to be non-empty. </exception>
        [ForwardsClientCalls]
        public virtual Response<FleetAnalyticsResource> GetFleetAnalyticsResource(string fleetAnalyticsName, CancellationToken cancellationToken = default)
        {
            Argument.AssertNotNullOrEmpty(fleetAnalyticsName, nameof(fleetAnalyticsName));

            return GetFleetAnalyticsResources().Get(fleetAnalyticsName, cancellationToken);
        }

        /// <summary> Gets a collection of FleetspaceResources in the <see cref="FleetResource"/>. </summary>
