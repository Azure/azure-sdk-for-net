...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraDataCenterResource : ArmResource
    {
        ...
        internal CassandraDataCenterResource(ArmClient client, CassandraDataCenterData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CassandraDataCenterResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CassandraDataCenterResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
