...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class TableResourcesDeleteTableOperation : Operation<Response>, IOperationSource<Response>
    {
        private readonly ArmOperationHelpers<Response> _operation;

        /// <summary> Initializes a new instance of TableResourcesDeleteTableOperation for mocking. </summary>
        protected TableResourcesDeleteTableOperation()
        {
        }

        internal TableResourcesDeleteTableOperation(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, Request request, Response response)
        {
            _operation = new ArmOperationHelpers<Response>(this, clientDiagnostics, pipeline, request, response, OperationFinalStateVia.Location, "TableResourcesDeleteTableOperation");
        }
        /// <inheritdoc />
