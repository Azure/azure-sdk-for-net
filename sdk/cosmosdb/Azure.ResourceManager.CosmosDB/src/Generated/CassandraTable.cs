...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CassandraTable : ArmResource
    {
        ...
        internal CassandraTable(ArmClient armClient, CassandraTableData data) : this(armClient, data.Id)
        {
            HasData = true;
            _data = data;
        }
        ...
        internal CassandraTable(ArmClient armClient, ResourceIdentifier id) : base(armClient, id)
        {
            ...
            ArmClient.TryGetApiVersion(ResourceType, out string cassandraTableCassandraResourcesApiVersion);
        ...
        {
            using var scope = _cassandraTableCassandraResourcesClientDiagnostics.CreateScope("CassandraTable.GetAvailableLocations");
            scope.Start();
            try
            {
        ...
        {
            return new DatabaseAccountCassandraKeyspaceTableThroughputSetting(ArmClient, new ResourceIdentifier(Id.ToString() + "/throughputSettings/default"));
        }
        #endregion
    }
}
