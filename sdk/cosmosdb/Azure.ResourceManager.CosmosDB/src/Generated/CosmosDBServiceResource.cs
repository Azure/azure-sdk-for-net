...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBServiceResource : ArmResource
    {
        ...
        private readonly CosmosDBServiceData _data;
        ...
        {
            _cosmosDBServiceServiceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CosmosDB", ResourceType.Namespace, Diagnostics);
            TryGetApiVersion(ResourceType, out string cosmosDBServiceServiceApiVersion);
        ...
        public virtual CosmosDBServiceData Data
        {
            get
            {
                if (!HasData)
        ...
        {
            using var scope = _cosmosDBServiceServiceClientDiagnostics.CreateScope("CosmosDBServiceResource.Get");
            scope.Start();
            try
            {
                var response = await _cosmosDBServiceServiceRestClient.GetAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<CosmosDBServiceResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _cosmosDBServiceServiceRestClient.Get(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new CosmosDBServiceResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        /// <item>
        /// <term>Operation Id</term>
        /// <description>Service_Delete</description>
        /// </item>
        /// </list>
        /// </summary>
        ...
        {
            using var scope = _cosmosDBServiceServiceClientDiagnostics.CreateScope("CosmosDBServiceResource.Delete");
            scope.Start();
            try
            {
                var response = await _cosmosDBServiceServiceRestClient.DeleteAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new CosmosDBArmOperation(_cosmosDBServiceServiceClientDiagnostics, Pipeline, _cosmosDBServiceServiceRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _cosmosDBServiceServiceRestClient.Delete(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new CosmosDBArmOperation(_cosmosDBServiceServiceClientDiagnostics, Pipeline, _cosmosDBServiceServiceRestClient.CreateDeleteRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<CosmosDBServiceResource>> UpdateAsync(WaitUntil waitUntil, CosmosDBServiceCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            using var scope = _cosmosDBServiceServiceClientDiagnostics.CreateScope("CosmosDBServiceResource.Update");
            scope.Start();
            try
            {
                var response = await _cosmosDBServiceServiceRestClient.CreateAsync(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken).ConfigureAwait(false);
                var operation = new CosmosDBArmOperation<CosmosDBServiceResource>(new CosmosDBServiceOperationSource(Client), _cosmosDBServiceServiceClientDiagnostics, Pipeline, _cosmosDBServiceServiceRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<CosmosDBServiceResource> Update(WaitUntil waitUntil, CosmosDBServiceCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _cosmosDBServiceServiceRestClient.Create(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content, cancellationToken);
                var operation = new CosmosDBArmOperation<CosmosDBServiceResource>(new CosmosDBServiceOperationSource(Client), _cosmosDBServiceServiceClientDiagnostics, Pipeline, _cosmosDBServiceServiceRestClient.CreateCreateRequest(Id.SubscriptionId, Id.ResourceGroupName, Id.Parent.Name, Id.Name, content).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
