...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBServiceResource : ArmResource
    {
        ...
        internal CosmosDBServiceResource(ArmClient client, CosmosDBServiceData data, ResourceIdentifier id) : this(client, id)
        {
            HasData = true;
            _data = data;
        }
        ...
        public virtual async Task<Response<CosmosDBServiceResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                return Response.FromValue(new CosmosDBServiceResource(Client, response.Value, response.Value.Id), response.GetRawResponse());
            }
            catch (Exception e)
            {
                scope.Failed(e);
