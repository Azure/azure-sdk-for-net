...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    /// If you have a <see cref="ResourceIdentifier"/> you can construct a <see cref="CosmosDBServiceResource"/> from an instance of <see cref="ArmClient"/> using the GetResource method.
    /// Otherwise you can get one from its parent resource <see cref="CosmosDBAccountResource"/> using the GetCosmosDBServices method.
    /// </summary>
    public partial class CosmosDBServiceResource : ArmResource
    {
        ...
        /// <summary> Initializes a new instance of CosmosDBServiceResource for mocking. </summary>
        protected CosmosDBServiceResource()
        {
        }

        /// <summary> Initializes a new instance of <see cref="CosmosDBServiceResource"/> class. </summary>
        ...
        {
            TryGetApiVersion(ResourceType, out string cosmosDBServiceApiVersion);
            _serviceClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CosmosDB", ResourceType.Namespace, Diagnostics);
            _serviceRestClient = new Service(_serviceClientDiagnostics, Pipeline, Diagnostics.ApplicationId, Endpoint, cosmosDBServiceApiVersion ?? "2026-03-15");
        ...
        {
            using DiagnosticScope scope = _serviceClientDiagnostics.CreateScope("CosmosDBServiceResource.Get");
            scope.Start();
            try
            {
        ...
        {
            using DiagnosticScope scope = _serviceClientDiagnostics.CreateScope("CosmosDBServiceResource.Delete");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
        ...
        public virtual async Task<ArmOperation<CosmosDBServiceResource>> UpdateAsync(WaitUntil waitUntil, CosmosDBServiceCreateOrUpdateContent content, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _serviceClientDiagnostics.CreateScope("CosmosDBServiceResource.Update");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
