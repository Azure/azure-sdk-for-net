...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class MongoDBResourcesOperations
    {
        ...
        internal MongoDBResourcesOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-15")
        {
            RestClient = new MongoDBResourcesRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
