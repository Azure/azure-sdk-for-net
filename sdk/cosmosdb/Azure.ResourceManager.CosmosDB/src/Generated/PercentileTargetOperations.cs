...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class PercentileTargetOperations
    {
        ...
        internal PercentileTargetOperations(ClientDiagnostics clientDiagnostics, HttpPipeline pipeline, string subscriptionId, Uri endpoint = null, string apiVersion = "2021-06-15")
        {
            RestClient = new PercentileTargetRestOperations(clientDiagnostics, pipeline, subscriptionId, endpoint, apiVersion);
