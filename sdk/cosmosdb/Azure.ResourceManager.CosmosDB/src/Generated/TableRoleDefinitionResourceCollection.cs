...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    /// Each <see cref="TableRoleDefinitionResource"/> in the collection will belong to the same instance of <see cref="DatabaseAccountGetResultsResource"/>.
    /// To get a <see cref="TableRoleDefinitionResourceCollection"/> instance call the GetTableRoleDefinitionResources method from an instance of <see cref="DatabaseAccountGetResultsResource"/>.
    /// </summary>
    public partial class TableRoleDefinitionResourceCollection : ArmCollection, IEnumerable<TableRoleDefinitionResource>, IAsyncEnumerable<TableRoleDefinitionResource>
    {
        ...
        /// <summary> Initializes a new instance of TableRoleDefinitionResourceCollection for mocking. </summary>
        protected TableRoleDefinitionResourceCollection()
        {
        }

        /// <summary> Initializes a new instance of <see cref="TableRoleDefinitionResourceCollection"/> class. </summary>
        ...
        {
            TryGetApiVersion(TableRoleDefinitionResource.ResourceType, out string tableRoleDefinitionResourceApiVersion);
            _tableResourcesClientDiagnostics = new ClientDiagnostics("Azure.ResourceManager.CosmosDB", TableRoleDefinitionResource.ResourceType.Namespace, Diagnostics);
            _tableResourcesRestClient = new TableResources(_tableResourcesClientDiagnostics, Pipeline, Endpoint, tableRoleDefinitionResourceApiVersion ?? "2025-11-01-preview");
        ...
        public virtual async Task<ArmOperation<TableRoleDefinitionResource>> CreateOrUpdateAsync(WaitUntil waitUntil, string roleDefinitionId, TableRoleDefinitionResourceData data, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tableResourcesClientDiagnostics.CreateScope("TableRoleDefinitionResourceCollection.CreateOrUpdate");
            scope.Start();
            try
            {
                ...
                HttpMessage message = _tableResourcesRestClient.CreateCreateUpdateTableRoleDefinitionRequest(Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, roleDefinitionId, TableRoleDefinitionResourceData.ToRequestContent(data), context);
                Response response = await Pipeline.ProcessMessageAsync(message, context).ConfigureAwait(false);
                CosmosDBArmOperation<TableRoleDefinitionResource> operation = new CosmosDBArmOperation<TableRoleDefinitionResource>(
                    new TableRoleDefinitionResourceOperationSource(Client),
        ...
        public virtual async Task<Response<TableRoleDefinitionResource>> GetAsync(string roleDefinitionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tableResourcesClientDiagnostics.CreateScope("TableRoleDefinitionResourceCollection.Get");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<TableRoleDefinitionResourceData> response = Response.FromValue(TableRoleDefinitionResourceData.FromResponse(result), result);
        ...
        public virtual AsyncPageable<TableRoleDefinitionResource> GetAllAsync(CancellationToken cancellationToken = default)
        {
            ...
            return new AsyncPageableWrapper<TableRoleDefinitionResourceData, TableRoleDefinitionResource>(new TableResourcesGetTableRoleDefinitionsAsyncCollectionResultOfT(_tableResourcesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new TableRoleDefinitionResource(Client, data));
        }
        ...
        public virtual Pageable<TableRoleDefinitionResource> GetAll(CancellationToken cancellationToken = default)
        {
            ...
            return new PageableWrapper<TableRoleDefinitionResourceData, TableRoleDefinitionResource>(new TableResourcesGetTableRoleDefinitionsCollectionResultOfT(_tableResourcesRestClient, Guid.Parse(Id.SubscriptionId), Id.ResourceGroupName, Id.Name, context), data => new TableRoleDefinitionResource(Client, data));
        }
        ...
        public virtual async Task<Response<bool>> ExistsAsync(string roleDefinitionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tableResourcesClientDiagnostics.CreateScope("TableRoleDefinitionResourceCollection.Exists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
                ...
                Response<TableRoleDefinitionResourceData> response = default;
                switch (result.Status)
                {
                    case 200:
                        response = Response.FromValue(TableRoleDefinitionResourceData.FromResponse(result), result);
                        break;
                    case 404:
                        response = Response.FromValue((TableRoleDefinitionResourceData)null, result);
                        break;
                    default:
        ...
        public virtual async Task<NullableResponse<TableRoleDefinitionResource>> GetIfExistsAsync(string roleDefinitionId, CancellationToken cancellationToken = default)
        {
            ...
            using DiagnosticScope scope = _tableResourcesClientDiagnostics.CreateScope("TableRoleDefinitionResourceCollection.GetIfExists");
            scope.Start();
            try
            {
                RequestContext context = new RequestContext
