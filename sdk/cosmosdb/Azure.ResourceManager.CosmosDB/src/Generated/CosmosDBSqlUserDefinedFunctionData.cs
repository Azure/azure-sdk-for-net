...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlUserDefinedFunctionData : ResourceData
    {
        ...
        /// <param name="properties"> The properties of an Azure Cosmos DB userDefinedFunction. </param>
        /// <param name="tags"> Resource tags. </param>
        /// <param name="location"> The geo-location where the resource lives. </param>
        /// <param name="identity"> Identity for the resource. </param>
        internal CosmosDBSqlUserDefinedFunctionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CosmosDBSqlUserDefinedFunctionProperties properties, IDictionary<string, string> tags, string location, Models.ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
        ...
        internal CosmosDBSqlUserDefinedFunctionProperties Properties { get; }
