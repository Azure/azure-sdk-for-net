...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlUserDefinedFunctionData : TrackedResourceData
    {
        ...
        internal CosmosDBSqlUserDefinedFunctionData(AzureLocation location) : base(location)
        {
        }
        ...
        internal CosmosDBSqlUserDefinedFunctionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, AzureLocation location, CosmosDBSqlUserDefinedFunctionProperties properties, IDictionary<string, string> tags, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData, tags, location)
        {
