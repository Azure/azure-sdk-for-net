...
namespace Azure.ResourceManager.CosmosDB
{
    ...
    public partial class CosmosDBSqlUserDefinedFunctionData : ResourceData
    {
        ...
        internal CosmosDBSqlUserDefinedFunctionData(ResourceIdentifier id, string name, ResourceType resourceType, SystemData systemData, IDictionary<string, BinaryData> additionalBinaryDataProperties, CosmosDBSqlUserDefinedFunctionProperties properties, IDictionary<string, string> tags, string location, ManagedServiceIdentity identity) : base(id, name, resourceType, systemData)
        {
